...
struct DolphinMemoryLayout {
    DVDDiskID disk;
    u32 nintendoBootCode; /* Nintendo Standard Boot Code. */
    u32 field_0x24;         /* 	Version (set by apploader) */
    u32 memorySize;        /* Memory Size (Physical) 24MB */
    u32 field_0x2c;         /* Production Board Model */
    u32 arenaLow;          /* 	Arena Low */
    u32 arenaHigh;         /* 	Arena High */

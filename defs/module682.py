...
SYMBOLS = [
	...
	{'addr':0x80D319E4,'size':32,'pad':0,'label':"l_daObjWchain_Method",'name':"l_daObjWchain_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D31A04,'size':48,'pad':0,'label':"g_profile_Obj_Wchain",'name':"g_profile_Obj_Wchain",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

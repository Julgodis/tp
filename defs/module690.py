...
SYMBOLS = [
	...
	{'addr':0x80D39D48,'size':32,'pad':0,'label':"l_daObjWPndlm_Method",'name':"l_daObjWPndlm_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D39D68,'size':48,'pad':0,'label':"g_profile_Obj_WoodPendulum",'name':"g_profile_Obj_WoodPendulum",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

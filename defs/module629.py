...
SYMBOLS = [
	...
	{'addr':0x80CE429C,'size':4,'pad':0,'label':"modeWait__12daSpinLift_cFv",'name':"modeWait__12daSpinLift_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80CE4A9C,'size':4,'pad':0,'label':"modeMoveEnd__12daSpinLift_cFv",'name':"modeMoveEnd__12daSpinLift_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80CE4C10,'size':92,'pad':0,'label':"__dt__16daSpinLift_HIO_cFv",'name':"__dt__16daSpinLift_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CE4DFC,'size':48,'pad':0,'label':"data_80CE4DFC",'name':"mode_proc$3748",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80CE4E2C,'size':32,'pad':0,'label':"l_daSpinLift_Method",'name':"l_daSpinLift_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80CE4E4C,'size':48,'pad':0,'label':"g_profile_Obj_SpinLift",'name':"g_profile_Obj_SpinLift",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

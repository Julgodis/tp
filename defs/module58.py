...
SYMBOLS = [
	...
	{'addr':0x804D5B8C,'size':8,'pad':0,'label':"daAlldie_Draw__FP10daAlldie_c",'name':"daAlldie_Draw__FP10daAlldie_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x804D5BB8,'size':8,'pad':0,'label':"daAlldie_IsDelete__FP10daAlldie_c",'name':"daAlldie_IsDelete__FP10daAlldie_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x804D5D24,'size':32,'pad':0,'label':"l_daAlldie_Method",'name':"l_daAlldie_Method",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x804D5D44,'size':48,'pad':0,'label':"g_profile_ALLDIE",'name':"g_profile_ALLDIE",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
]

...
SYMBOLS = [
	...
	{'addr':0x804D57F8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':0,'section':0,'r':[2,7,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x804D5830,'size':8,'pad':0,'label':"actionWait__10daAlldie_cFv",'name':"actionWait__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x804D5B8C,'size':8,'pad':0,'label':"daAlldie_Draw__FP10daAlldie_c",'name':"daAlldie_Draw__FP10daAlldie_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5B94,'size':36,'pad':0,'label':"daAlldie_Execute__FP10daAlldie_c",'name':"daAlldie_Execute__FP10daAlldie_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5BB8,'size':8,'pad':0,'label':"daAlldie_IsDelete__FP10daAlldie_c",'name':"daAlldie_IsDelete__FP10daAlldie_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5BC0,'size':48,'pad':0,'label':"daAlldie_Delete__FP10daAlldie_c",'name':"daAlldie_Delete__FP10daAlldie_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5BF0,'size':300,'pad':0,'label':"daAlldie_Create__FP10fopAc_ac_c",'name':"daAlldie_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5D1C,'size':4,'pad':0,'label':"data_804D5D1C",'name':None,'lib':-1,'tu':1,'section':1,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x804D5D20,'size':4,'pad':0,'label':"data_804D5D20",'name':None,'lib':-1,'tu':2,'section':2,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x804D5D24,'size':32,'pad':0,'label':"l_daAlldie_Method",'name':"l_daAlldie_Method",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x804D5D44,'size':48,'pad':0,'label':"g_profile_ALLDIE",'name':"g_profile_ALLDIE",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
]

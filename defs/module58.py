...
SYMBOLS = [
	...
	{'addr':0x804D5818,'size':12,'pad':0,'label':"getEventNo__10daAlldie_cFv",'name':"getEventNo__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5824,'size':12,'pad':0,'label':"getSwbit__10daAlldie_cFv",'name':"getSwbit__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5830,'size':8,'pad':0,'label':"actionWait__10daAlldie_cFv",'name':"actionWait__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x804D5838,'size':80,'pad':0,'label':"actionCheck__10daAlldie_cFv",'name':"actionCheck__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5888,'size':176,'pad':0,'label':"actionTimer__10daAlldie_cFv",'name':"actionTimer__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5938,'size':104,'pad':0,'label':"actionOrder__10daAlldie_cFv",'name':"actionOrder__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D59A0,'size':164,'pad':0,'label':"actionEvent__10daAlldie_cFv",'name':"actionEvent__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5A44,'size':204,'pad':0,'label':"actionNext__10daAlldie_cFv",'name':"actionNext__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x804D5B10,'size':124,'pad':0,'label':"execute__10daAlldie_cFv",'name':"execute__10daAlldie_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},

...
# Symbols
SYMBOLS = [
	{'addr':0x80D0D480,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':0,'section':0,'r':[0,0,3],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0D4AC,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':0,'section':0,'r':[0,0,4],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0D4D8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':0,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0D4F8,'size':164,'pad':0,'label':"checkPlayerPos__FP13daObjThDoor_c",'name':"checkPlayerPos__FP13daObjThDoor_c",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D0D618,'size':60,'pad':0,'label':"initBaseMtx__13daObjThDoor_cFv",'name':"initBaseMtx__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0D654,'size':100,'pad':0,'label':"setBaseMtx__13daObjThDoor_cFv",'name':"setBaseMtx__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D0D868,'size':128,'pad':0,'label':"create1st__13daObjThDoor_cFv",'name':"create1st__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D0D9B4,'size':276,'pad':0,'label':"set_cyl__13daObjThDoor_cFv",'name':"set_cyl__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0DAC8,'size':200,'pad':0,'label':"action__13daObjThDoor_cFv",'name':"action__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0DB90,'size':188,'pad':0,'label':"event_proc_call__13daObjThDoor_cFv",'name':"event_proc_call__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D0DE34,'size':568,'pad':0,'label':"demoProc__13daObjThDoor_cFv",'name':"demoProc__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,11],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0E06C,'size':228,'pad':0,'label':"checkArea__13daObjThDoor_cFv",'name':"checkArea__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D0E150,'size':164,'pad':0,'label':"Draw__13daObjThDoor_cFv",'name':"Draw__13daObjThDoor_cFv",'lib':-1,'tu':4,'section':0,'r':[1,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D0E5D4,'size':28,'pad':0,'label':"func_80D0E5D4",'name':"cLib_calcTimer<Uc>__FPUc",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D0E600,'size':4,'pad':0,'label':"lit_3765",'name':"@3765",'lib':-1,'tu':4,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80D0E604,'size':4,'pad':0,'label':"lit_3766",'name':"@3766",'lib':-1,'tu':4,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80D0E678,'size':4,'pad':0,'label':"l_arcName",'name':"l_arcName",'lib':-1,'tu':4,'section':5,'r':[3,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D0E67C,'size':4,'pad':0,'label':"l_evName",'name':"l_evName",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80D0E6C8,'size':12,'pad':0,'label':"lit_3829",'name':"@3829",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D0E6D4,'size':12,'pad':0,'label':"lit_3830",'name':"@3830",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D0E6E0,'size':12,'pad':0,'label':"lit_3831",'name':"@3831",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D0E6EC,'size':12,'pad':0,'label':"lit_3832",'name':"@3832",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80D0E728,'size':12,'pad':0,'label':"data_80D0E728",'name':"action_table$3895",'lib':-1,'tu':4,'section':5,'r':[1,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80D0E784,'size':12,'pad':0,'label':"__vt__10cCcD_GStts",'name':"__vt__10cCcD_GStts",'lib':-1,'tu':4,'section':5,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80D0E790,'size':12,'pad':0,'label':"__vt__10dCcD_GStts",'name':"__vt__10dCcD_GStts",'lib':-1,'tu':4,'section':5,'r':[1,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80D0E79C,'size':12,'pad':0,'label':"__vt__8cM3dGAab",'name':"__vt__8cM3dGAab",'lib':-1,'tu':4,'section':5,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80D0E7A8,'size':12,'pad':0,'label':"__vt__8cM3dGCyl",'name':"__vt__8cM3dGCyl",'lib':-1,'tu':4,'section':5,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80D0E7B4,'size':40,'pad':0,'label':"__vt__13daObjThDoor_c",'name':"__vt__13daObjThDoor_c",'lib':-1,'tu':4,'section':5,'r':[1,0,0],'sh':[0,0,0],'type':"VirtualTable"},

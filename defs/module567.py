...
SYMBOLS = [
	...
	{'addr':0x80C8FD98,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C8FE0C,'size':24,'pad':0,'label':"__ct__16daObj_Maki_HIO_cFv",'name':"__ct__16daObj_Maki_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},

...
SYMBOLS = [
	...
	{'addr':0x80C8FEDC,'size':1180,'pad':0,'label':"daObj_Maki_Execute__FP14obj_maki_class",'name':"daObj_Maki_Execute__FP14obj_maki_class",'lib':-1,'tu':2,'section':0,'r':[2,1,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C90378,'size':8,'pad':0,'label':"daObj_Maki_IsDelete__FP14obj_maki_class",'name':"daObj_Maki_IsDelete__FP14obj_maki_class",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C90948,'size':4,'pad':0,'label':"lit_3933",'name':"@3933",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80C90A14,'size':12,'pad':0,'label':"__vt__8cM3dGSph",'name':"__vt__8cM3dGSph",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C90A20,'size':12,'pad':0,'label':"__vt__8cM3dGAab",'name':"__vt__8cM3dGAab",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C90A2C,'size':12,'pad':0,'label':"__vt__12J3DFrameCtrl",'name':"__vt__12J3DFrameCtrl",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C90A38,'size':12,'pad':0,'label':"__vt__16daObj_Maki_HIO_c",'name':"__vt__16daObj_Maki_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},

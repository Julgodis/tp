...
SYMBOLS = [
	...
	{'addr':0x8057F458,'size':108,'pad':0,'label':"__dt__14daGpTaru_HIO_cFv",'name':"__dt__14daGpTaru_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8057F7A4,'size':32,'pad':0,'label':"l_daGpTaru_Method",'name':"l_daGpTaru_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8057F7C4,'size':48,'pad':0,'label':"g_profile_Obj_GpTaru",'name':"g_profile_Obj_GpTaru",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80498850,'size':8,'pad':0,'label':"daVrbox_Execute__FP11vrbox_class",'name':"daVrbox_Execute__FP11vrbox_class",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80498858,'size':8,'pad':0,'label':"daVrbox_IsDelete__FP11vrbox_class",'name':"daVrbox_IsDelete__FP11vrbox_class",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80498860,'size':8,'pad':0,'label':"daVrbox_Delete__FP11vrbox_class",'name':"daVrbox_Delete__FP11vrbox_class",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},

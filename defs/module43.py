...
SYMBOLS = [
	...
	{'addr':0x80498850,'size':8,'pad':0,'label':"daVrbox_Execute__FP11vrbox_class",'name':"daVrbox_Execute__FP11vrbox_class",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80498858,'size':8,'pad':0,'label':"daVrbox_IsDelete__FP11vrbox_class",'name':"daVrbox_IsDelete__FP11vrbox_class",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80498860,'size':8,'pad':0,'label':"daVrbox_Delete__FP11vrbox_class",'name':"daVrbox_Delete__FP11vrbox_class",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x804989A8,'size':32,'pad':0,'label':"l_daVrbox_Method",'name':"l_daVrbox_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x804989C8,'size':48,'pad':0,'label':"g_profile_VRBOX",'name':"g_profile_VRBOX",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
]

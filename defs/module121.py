...
SYMBOLS = [
	...
	{'addr':0x805A2480,'size':92,'pad':0,'label':"__dt__17daTagCstaSw_HIO_cFv",'name':"__dt__17daTagCstaSw_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x805A2550,'size':32,'pad':0,'label':"l_daTagCstaSw_Method",'name':"l_daTagCstaSw_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x805A2570,'size':48,'pad':0,'label':"g_profile_Tag_CstaSw",'name':"g_profile_Tag_CstaSw",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

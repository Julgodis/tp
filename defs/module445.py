...
SYMBOLS = [
	...
	{'addr':0x80BE7F24,'size':92,'pad':0,'label':"__dt__16daFireWood_HIO_cFv",'name':"__dt__16daFireWood_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BE80AC,'size':32,'pad':0,'label':"l_daFireWood_Method",'name':"l_daFireWood_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80BE80CC,'size':48,'pad':0,'label':"g_profile_Obj_FireWood",'name':"g_profile_Obj_FireWood",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80BE75B8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BE762C,'size':60,'pad':0,'label':"__ct__16daFireWood_HIO_cFv",'name':"__ct__16daFireWood_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BE76B0,'size':88,'pad':0,'label':"setBaseMtx__12daFireWood_cFv",'name':"setBaseMtx__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BE7708,'size':520,'pad':0,'label':"create__12daFireWood_cFv",'name':"create__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BE79A0,'size':116,'pad':0,'label':"lightInit__12daFireWood_cFv",'name':"lightInit__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BE7A14,'size':36,'pad':0,'label':"setLight__12daFireWood_cFv",'name':"setLight__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BE7A38,'size':1084,'pad':0,'label':"Execute__12daFireWood_cFv",'name':"Execute__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BE7E74,'size':8,'pad':0,'label':"Draw__12daFireWood_cFv",'name':"Draw__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80BE7E7C,'size':40,'pad':0,'label':"Delete__12daFireWood_cFv",'name':"Delete__12daFireWood_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BE8008,'size':4,'pad':0,'label':"lit_3626",'name':"@3626",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80BE80FC,'size':12,'pad':0,'label':"__vt__8cM3dGCyl",'name':"__vt__8cM3dGCyl",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BE8108,'size':12,'pad':0,'label':"__vt__8cM3dGAab",'name':"__vt__8cM3dGAab",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BE8114,'size':12,'pad':0,'label':"__vt__16daFireWood_HIO_c",'name':"__vt__16daFireWood_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BE8120,'size':12,'pad':0,'label':"__vt__14mDoHIO_entry_c",'name':"__vt__14mDoHIO_entry_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},

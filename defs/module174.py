...
SYMBOLS = [
	...
	{'addr':0x80685798,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8068580C,'size':80,'pad':0,'label':"__ct__12daE_BG_HIO_cFv",'name':"__ct__12daE_BG_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8068585C,'size':236,'pad':0,'label':"ctrlJoint__8daE_BG_cFP8J3DJointP8J3DModel",'name':"ctrlJoint__8daE_BG_cFP8J3DJointP8J3DModel",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80685994,'size':444,'pad':0,'label':"draw__8daE_BG_cFv",'name':"draw__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80685B70,'size':164,'pad':0,'label':"setBck__8daE_BG_cFiUcff",'name':"setBck__8daE_BG_cFiUcff",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80685C14,'size':24,'pad':0,'label':"setActionMode__8daE_BG_cFii",'name':"setActionMode__8daE_BG_cFii",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80685C2C,'size':400,'pad':0,'label':"damage_check__8daE_BG_cFv",'name':"damage_check__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80685DBC,'size':328,'pad':0,'label':"setSparkEffect__8daE_BG_cFv",'name':"setSparkEffect__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80685F04,'size':132,'pad':0,'label':"search_esa__8daE_BG_cFv",'name':"search_esa__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80685F88,'size':648,'pad':0,'label':"executeBorn__8daE_BG_cFv",'name':"executeBorn__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80686210,'size':2688,'pad':0,'label':"executeSwim__8daE_BG_cFv",'name':"executeSwim__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80687B38,'size':416,'pad':0,'label':"executeDamage__8daE_BG_cFv",'name':"executeDamage__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80687CD8,'size':276,'pad':0,'label':"setBombCarry__8daE_BG_cFi",'name':"setBombCarry__8daE_BG_cFi",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80687DEC,'size':472,'pad':0,'label':"executeBomb__8daE_BG_cFv",'name':"executeBomb__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80687FC4,'size':968,'pad':0,'label':"executeBirth__8daE_BG_cFv",'name':"executeBirth__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8068838C,'size':68,'pad':0,'label':"executeHook__8daE_BG_cFv",'name':"executeHook__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806883D0,'size':3480,'pad':0,'label':"executeEat__8daE_BG_cFv",'name':"executeEat__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,13],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80689544,'size':296,'pad':0,'label':"mtx_set__8daE_BG_cFv",'name':"mtx_set__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8068966C,'size':384,'pad':0,'label':"cc_set__8daE_BG_cFv",'name':"cc_set__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806897EC,'size':356,'pad':0,'label':"execute__8daE_BG_cFv",'name':"execute__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80689978,'size':116,'pad':0,'label':"_delete__8daE_BG_cFv",'name':"_delete__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80689A0C,'size':452,'pad':0,'label':"CreateHeap__8daE_BG_cFv",'name':"CreateHeap__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80689C38,'size':1092,'pad':0,'label':"create__8daE_BG_cFv",'name':"create__8daE_BG_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8068A10C,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8068A250,'size':4,'pad':0,'label':"lit_3771",'name':"@3771",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x8068A254,'size':4,'pad':0,'label':"lit_3772",'name':"@3772",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x8068A264,'size':4,'pad':0,'label':"lit_3890",'name':"@3890",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x8068A270,'size':4,'pad':0,'label':"lit_4007",'name':"@4007",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},

...
SYMBOLS = [
	...
	{'addr':0x80456C38,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':0,'section':0,'r':[2,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80456C7C,'size':4,'pad':0,'label':"data_80456C7C",'name':None,'lib':-1,'tu':1,'section':1,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80456C80,'size':4,'pad':0,'label':"data_80456C80",'name':None,'lib':-1,'tu':2,'section':2,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80456C84,'size':3172,'pad':0,'label':"g_fpcPfLst_ProfileList",'name':"g_fpcPfLst_ProfileList",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
]

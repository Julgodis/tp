...
SYMBOLS = [
	...
	{'addr':0x80456C58,'size':20,'pad':0,'label':"ModuleProlog",'name':"ModuleProlog",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80456C6C,'size':16,'pad':0,'label':"ModuleEpilog",'name':"ModuleEpilog",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},

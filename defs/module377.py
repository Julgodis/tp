...
SYMBOLS = [
	...
	{'addr':0x80B2EDD0,'size':8,'pad':0,'label':"daNPC_WORM_IsDelete__FP14npc_worm_class",'name':"daNPC_WORM_IsDelete__FP14npc_worm_class",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80B2F12C,'size':32,'pad':0,'label':"l_daNPC_WORM_Method",'name':"l_daNPC_WORM_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80B2F14C,'size':48,'pad':0,'label':"g_profile_NPC_WORM",'name':"g_profile_NPC_WORM",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

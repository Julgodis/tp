...
SYMBOLS = [
	...
	{'addr':0x805A4AC8,'size':8,'pad':0,'label':"daTagHstop_Draw__FP12daTagHstop_c",'name':"daTagHstop_Draw__FP12daTagHstop_c",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x805A4B24,'size':32,'pad':0,'label':"l_daTagHstop_Method",'name':"l_daTagHstop_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x805A4B44,'size':48,'pad':0,'label':"g_profile_Tag_Hstop",'name':"g_profile_Tag_Hstop",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

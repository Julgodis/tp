...
SYMBOLS = [
	...
	{'addr':0x8058CEA8,'size':92,'pad':0,'label':"__dt__16daKtOnFire_HIO_cFv",'name':"__dt__16daKtOnFire_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8058D038,'size':32,'pad':0,'label':"l_daKtOnFire_Method",'name':"l_daKtOnFire_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8058D058,'size':48,'pad':0,'label':"g_profile_Tag_KtOnFire",'name':"g_profile_Tag_KtOnFire",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x8058C598,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8058C60C,'size':36,'pad':0,'label':"__ct__16daKtOnFire_HIO_cFv",'name':"__ct__16daKtOnFire_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8058C678,'size':88,'pad':0,'label':"setBaseMtx__12daKtOnFire_cFv",'name':"setBaseMtx__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058C6D0,'size':512,'pad':0,'label':"create__12daKtOnFire_cFv",'name':"create__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,4],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058C8D0,'size':72,'pad':0,'label':"__dt__8cM3dGCylFv",'name':"__dt__8cM3dGCylFv",'lib':-1,'tu':2,'section':0,'r':[1,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058C918,'size':72,'pad':0,'label':"__dt__8cM3dGAabFv",'name':"__dt__8cM3dGAabFv",'lib':-1,'tu':2,'section':0,'r':[1,0,2],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058C960,'size':116,'pad':0,'label':"lightInit__12daKtOnFire_cFv",'name':"lightInit__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058C9D4,'size':36,'pad':0,'label':"setLight__12daKtOnFire_cFv",'name':"setLight__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058C9F8,'size':36,'pad':0,'label':"cutLight__12daKtOnFire_cFv",'name':"cutLight__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058CA1C,'size':988,'pad':0,'label':"Execute__12daKtOnFire_cFv",'name':"Execute__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,3],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058CDF8,'size':8,'pad':0,'label':"Draw__12daKtOnFire_cFv",'name':"Draw__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x8058CE00,'size':40,'pad':0,'label':"Delete__12daKtOnFire_cFv",'name':"Delete__12daKtOnFire_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8058CF04,'size':112,'pad':0,'label':"__sinit_d_a_obj_ktOnFire_cpp",'name':"__sinit_d_a_obj_ktOnFire_cpp",'lib':-1,'tu':2,'section':0,'r':[0,1,3],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058CF74,'size':8,'pad':0,'label':"data_8058CF74",'name':None,'lib':-1,'tu':1,'section':1,'r':[0,1,3],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x8058CF80,'size':8,'pad':0,'label':"pad_8058CF80",'name':None,'lib':1,'tu':3,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x8058CFB8,'size':4,'pad':4,'label':"lit_3710",'name':"@3710",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x8058D088,'size':12,'pad':0,'label':"__vt__8cM3dGCyl",'name':"__vt__8cM3dGCyl",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x8058D094,'size':12,'pad':0,'label':"__vt__8cM3dGAab",'name':"__vt__8cM3dGAab",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x8058D0A0,'size':12,'pad':0,'label':"__vt__16daKtOnFire_HIO_c",'name':"__vt__16daKtOnFire_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x8058D0AC,'size':12,'pad':0,'label':"__vt__14mDoHIO_entry_c",'name':"__vt__14mDoHIO_entry_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},

...
SYMBOLS = [
	...
	{'addr':0x80C90C70,'size':296,'pad':0,'label':"CreateHeap__18daObjMasterSword_cFv",'name':"CreateHeap__18daObjMasterSword_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C90DB8,'size':436,'pad':0,'label':"create__18daObjMasterSword_cFv",'name':"create__18daObjMasterSword_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C90F6C,'size':672,'pad':0,'label':"create_init__18daObjMasterSword_cFv",'name':"create_init__18daObjMasterSword_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C9120C,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':4,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C91448,'size':416,'pad':0,'label':"__dt__18daObjMasterSword_cFv",'name':"__dt__18daObjMasterSword_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C91714,'size':384,'pad':0,'label':"draw__18daObjMasterSword_cFv",'name':"draw__18daObjMasterSword_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C91894,'size':8,'pad':0,'label':"daObjMasterSword_IsDelete__FP18daObjMasterSword_c",'name':"daObjMasterSword_IsDelete__FP18daObjMasterSword_c",'lib':-1,'tu':4,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},

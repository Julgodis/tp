...
SYMBOLS = [
	...
	{'addr':0x80D4EB8C,'size':320,'pad':0,'label':"checkArea_sub__11daSwLBall_cFP10fopAc_ac_c",'name':"checkArea_sub__11daSwLBall_cFP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'r':[0,0,6],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D4ECCC,'size':180,'pad':0,'label':"checkArea__11daSwLBall_cFv",'name':"checkArea__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,4],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D4ED80,'size':300,'pad':0,'label':"search_lb__11daSwLBall_cFv",'name':"search_lb__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D4EEAC,'size':76,'pad':0,'label':"Create__11daSwLBall_cFv",'name':"Create__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D4EEF8,'size':104,'pad':0,'label':"create__11daSwLBall_cFv",'name':"create__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D4EF60,'size':168,'pad':0,'label':"execute__11daSwLBall_cFv",'name':"execute__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D4F224,'size':544,'pad':0,'label':"PutCrrPos__11daSwLBall_cFv",'name':"PutCrrPos__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,6],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D4F444,'size':8,'pad':0,'label':"_delete__11daSwLBall_cFv",'name':"_delete__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80D4F4AC,'size':28,'pad':0,'label':"func_80D4F4AC",'name':"cLib_calcTimer<Uc>__FPUc",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D4F4DC,'size':4,'pad':0,'label':"lit_3726",'name':"@3726",'lib':-1,'tu':3,'section':3,'r':[0,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x80D4F504,'size':12,'pad':0,'label':"lit_3835",'name':"@3835",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D4F510,'size':12,'pad':0,'label':"lit_3836",'name':"@3836",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D4F51C,'size':12,'pad':0,'label':"lit_3837",'name':"@3837",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80D4F56C,'size':48,'pad':0,'label':"g_profile_SwLBall",'name':"g_profile_SwLBall",'lib':-1,'tu':3,'section':4,'r':[0,0,2],'sh':[0,0,0],'type':"ReferenceArray"},

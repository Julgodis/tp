...
SYMBOLS = [
	...
	{'addr':0x80D4F220,'size':4,'pad':0,'label':"actionStop__11daSwLBall_cFv",'name':"actionStop__11daSwLBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80D4F528,'size':36,'pad':0,'label':"data_80D4F528",'name':"l_func$3834",'lib':-1,'tu':3,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80D4F54C,'size':32,'pad':0,'label':"l_daSwLBall_Method",'name':"l_daSwLBall_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D4F56C,'size':48,'pad':0,'label':"g_profile_SwLBall",'name':"g_profile_SwLBall",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80C288DC,'size':8,'pad':0,'label':"daObjIta_IsDelete__FP10daObjIta_c",'name':"daObjIta_IsDelete__FP10daObjIta_c",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C29184,'size':72,'pad':0,'label':"__dt__15daObj_ITA_HIO_cFv",'name':"__dt__15daObj_ITA_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C292E8,'size':48,'pad':0,'label':"stringBase0",'name':"@stringBase0",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"StringBase"},
	{'addr':0x80C29318,'size':4,'pad':0,'label':"l_arcName",'name':"l_arcName",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C2931C,'size':32,'pad':0,'label':"l_daObjIta_Method",'name':"l_daObjIta_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C2933C,'size':48,'pad':0,'label':"g_profile_Obj_ITA",'name':"g_profile_Obj_ITA",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

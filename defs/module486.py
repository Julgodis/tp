...
SYMBOLS = [
	...
	{'addr':0x80C288DC,'size':8,'pad':0,'label':"daObjIta_IsDelete__FP10daObjIta_c",'name':"daObjIta_IsDelete__FP10daObjIta_c",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},

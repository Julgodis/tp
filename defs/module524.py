...
SYMBOLS = [
	...
	{'addr':0x80C5D3D8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5D44C,'size':36,'pad':0,'label':"__ct__20dalv4CandleTag_HIO_cFv",'name':"__ct__20dalv4CandleTag_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C5D470,'size':72,'pad':0,'label':"__dt__14mDoHIO_entry_cFv",'name':"__dt__14mDoHIO_entry_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,15],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C5D4B8,'size':56,'pad':0,'label':"setBaseMtx__16dalv4CandleTag_cFv",'name':"setBaseMtx__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,12],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C5D4F0,'size':228,'pad':0,'label':"create__16dalv4CandleTag_cFv",'name':"create__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,15],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C5D5D4,'size':68,'pad':0,'label':"Execute__16dalv4CandleTag_cFv",'name':"Execute__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,3],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C5D618,'size':188,'pad':0,'label':"procMain__16dalv4CandleTag_cFv",'name':"procMain__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,12],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C5D6D4,'size':12,'pad':0,'label':"init_modeWatch__16dalv4CandleTag_cFv",'name':"init_modeWatch__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5D78C,'size':136,'pad':0,'label':"init_modeNG__16dalv4CandleTag_cFv",'name':"init_modeNG__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5D8A0,'size':12,'pad':0,'label':"init_modeNGWait__16dalv4CandleTag_cFv",'name':"init_modeNGWait__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5D8FC,'size':12,'pad':0,'label':"init_modeEnd__16dalv4CandleTag_cFv",'name':"init_modeEnd__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5D930,'size':8,'pad':0,'label':"Draw__16dalv4CandleTag_cFv",'name':"Draw__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C5D938,'size':8,'pad':0,'label':"Delete__16dalv4CandleTag_cFv",'name':"Delete__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C5DB84,'size':12,'pad':0,'label':"lit_3686",'name':"@3686",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5DB90,'size':12,'pad':0,'label':"lit_3687",'name':"@3687",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5DB9C,'size':12,'pad':0,'label':"lit_3688",'name':"@3688",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5DBA8,'size':12,'pad':0,'label':"lit_3689",'name':"@3689",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80C5DC34,'size':40,'pad':0,'label':"__vt__16dalv4CandleTag_c",'name':"__vt__16dalv4CandleTag_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5DC5C,'size':24,'pad':0,'label':"__vt__17dEvLib_callback_c",'name':"__vt__17dEvLib_callback_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5DC74,'size':12,'pad':0,'label':"__vt__20dalv4CandleTag_HIO_c",'name':"__vt__20dalv4CandleTag_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5DC80,'size':12,'pad':0,'label':"__vt__14mDoHIO_entry_c",'name':"__vt__14mDoHIO_entry_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},

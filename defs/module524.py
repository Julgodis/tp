...
SYMBOLS = [
	...
	{'addr':0x80C5D908,'size':4,'pad':0,'label':"modeEnd__16dalv4CandleTag_cFv",'name':"modeEnd__16dalv4CandleTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C5D9C0,'size':92,'pad':0,'label':"__dt__20dalv4CandleTag_HIO_cFv",'name':"__dt__20dalv4CandleTag_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5DAB0,'size':8,'pad':0,'label':"eventRun__17dEvLib_callback_cFv",'name':"eventRun__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C5DAB8,'size':8,'pad':0,'label':"eventEnd__17dEvLib_callback_cFv",'name':"eventEnd__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C5DAC0,'size':8,'pad':0,'label':"eventStart__17dEvLib_callback_cFv",'name':"eventStart__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C5DBB4,'size':48,'pad':0,'label':"data_80C5DBB4",'name':"mode_proc$3685",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C5DBE4,'size':32,'pad':0,'label':"l_dalv4CandleTag_Method",'name':"l_dalv4CandleTag_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5DC04,'size':48,'pad':0,'label':"g_profile_Tag_Lv4Candle",'name':"g_profile_Tag_Lv4Candle",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x8046B358,'size':8,'pad':0,'label':"daHitobj_Draw__FP12hitobj_class",'name':"daHitobj_Draw__FP12hitobj_class",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8046B3C8,'size':8,'pad':0,'label':"daHitobj_IsDelete__FP12hitobj_class",'name':"daHitobj_IsDelete__FP12hitobj_class",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8046B66C,'size':12,'pad':0,'label':"__vt__8cM3dGSph",'name':"__vt__8cM3dGSph",'lib':-1,'tu':3,'section':4,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x8046B678,'size':12,'pad':0,'label':"__vt__8cM3dGAab",'name':"__vt__8cM3dGAab",'lib':-1,'tu':3,'section':4,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
]

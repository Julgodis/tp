...
SYMBOLS = [
	...
	{'addr':0x80A0CC18,'size':176,'pad':0,'label':"anm_init__FP14npc_inko_classifUcf",'name':"anm_init__FP14npc_inko_classifUcf",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},

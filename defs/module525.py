...
SYMBOLS = [
	...
	{'addr':0x80C5E590,'size':4,'pad':0,'label':"modeEnd__16daLv4EdShutter_cFv",'name':"modeEnd__16daLv4EdShutter_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C5E72C,'size':92,'pad':0,'label':"__dt__20daLv4EdShutter_HIO_cFv",'name':"__dt__20daLv4EdShutter_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C5E81C,'size':8,'pad':0,'label':"eventStart__17dEvLib_callback_cFv",'name':"eventStart__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C5E824,'size':8,'pad':0,'label':"eventRun__17dEvLib_callback_cFv",'name':"eventRun__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C5E82C,'size':8,'pad':0,'label':"eventEnd__17dEvLib_callback_cFv",'name':"eventEnd__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C5E984,'size':32,'pad':0,'label':"l_daLv4EdShutter_Method",'name':"l_daLv4EdShutter_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5E9A4,'size':48,'pad':0,'label':"g_profile_Obj_Lv4EdShutter",'name':"g_profile_Obj_Lv4EdShutter",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80C58758,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C587CC,'size':36,'pad':0,'label':"__ct__16daLv3Water_HIO_cFv",'name':"__ct__16daLv3Water_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C58838,'size':228,'pad':0,'label':"setBaseMtx__12daLv3Water_cFv",'name':"setBaseMtx__12daLv3Water_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C58ABC,'size':612,'pad':0,'label':"create__12daLv3Water_cFv",'name':"create__12daLv3Water_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C59754,'size':168,'pad':0,'label':"mode_init_levelCtrl__12daLv3Water_cFv",'name':"mode_init_levelCtrl__12daLv3Water_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C59C90,'size':128,'pad':0,'label':"__sinit_d_a_obj_lv3Water_cpp",'name':"__sinit_d_a_obj_lv3Water_cpp",'lib':-1,'tu':2,'section':0,'r':[0,1,11],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C59D10,'size':8,'pad':0,'label':"func_80C59D10",'name':"@1448@eventStart__12daLv3Water_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,4],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C59D18,'size':8,'pad':0,'label':"func_80C59D18",'name':"@1448@__dt__12daLv3Water_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C59D20,'size':72,'pad':0,'label':"__dt__17dEvLib_callback_cFv",'name':"__dt__17dEvLib_callback_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,6],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C59E5C,'size':8,'pad':0,'label':"data_80C59E5C",'name':None,'lib':-1,'tu':1,'section':1,'r':[0,1,5],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80C59F18,'size':84,'pad':0,'label':"l_btkIdx",'name':"l_btkIdx",'lib':-1,'tu':2,'section':2,'r':[0,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C59F6C,'size':84,'pad':0,'label':"l_bmdIdrIdx",'name':"l_bmdIdrIdx",'lib':-1,'tu':2,'section':2,'r':[0,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C59FC0,'size':84,'pad':0,'label':"l_btkIdrIdx",'name':"l_btkIdrIdx",'lib':-1,'tu':2,'section':2,'r':[0,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C5A014,'size':4,'pad':0,'label':"lit_3737",'name':"@3737",'lib':-1,'tu':2,'section':2,'r':[3,0,1],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80C5A018,'size':42,'pad':6,'label':"data_80C5A018",'name':"estimateSizeTbl$3746",'lib':-1,'tu':2,'section':2,'r':[1,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C5A048,'size':8,'pad':0,'label':"lit_3812",'name':"@3812",'lib':-1,'tu':2,'section':2,'r':[1,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C5A050,'size':4,'pad':4,'label':"lit_4068",'name':"@4068",'lib':-1,'tu':2,'section':2,'r':[1,0,1],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80C5A058,'size':8,'pad':0,'label':"lit_4080",'name':"@4080",'lib':-1,'tu':2,'section':2,'r':[1,0,1],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x80C5A0E0,'size':20,'pad':0,'label':"struct_80C5A0E0",'name':None,'lib':-1,'tu':2,'section':2,'r':[1,0,1],'sh':[0,0,0],'type':"Structure"},
	...
	{'addr':0x80C5A1B0,'size':12,'pad':0,'label':"lit_3830",'name':"@3830",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5A1BC,'size':12,'pad':0,'label':"lit_3831",'name':"@3831",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C5A1C8,'size':24,'pad':0,'label':"l_mode_func",'name':"l_mode_func",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x80C5A278,'size':12,'pad':0,'label':"__vt__12J3DFrameCtrl",'name':"__vt__12J3DFrameCtrl",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5A284,'size':24,'pad':0,'label':"__vt__17dEvLib_callback_c",'name':"__vt__17dEvLib_callback_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5A29C,'size':72,'pad':0,'label':"__vt__12daLv3Water_c",'name':"__vt__12daLv3Water_c",'lib':-1,'tu':2,'section':3,'r':[2,0,1],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5A2E4,'size':12,'pad':0,'label':"__vt__16daLv3Water_HIO_c",'name':"__vt__16daLv3Water_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C5A2F0,'size':12,'pad':0,'label':"__vt__14mDoHIO_entry_c",'name':"__vt__14mDoHIO_entry_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},

...
SYMBOLS = [
	...
	{'addr':0x80C9EDB8,'size':8,'pad':0,'label':"daObj_Myogan_IsDelete__FP16obj_myogan_class",'name':"daObj_Myogan_IsDelete__FP16obj_myogan_class",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},

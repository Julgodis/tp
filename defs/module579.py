...
SYMBOLS = [
	...
	{'addr':0x80C9EB38,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C9EBAC,'size':48,'pad':0,'label':"__ct__18daObj_Myogan_HIO_cFv",'name':"__ct__18daObj_Myogan_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C9EC70,'size':236,'pad':0,'label':"action__FP16obj_myogan_class",'name':"action__FP16obj_myogan_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C9F2F8,'size':12,'pad':0,'label':"__vt__12J3DFrameCtrl",'name':"__vt__12J3DFrameCtrl",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C9F304,'size':12,'pad':0,'label':"__vt__18daObj_Myogan_HIO_c",'name':"__vt__18daObj_Myogan_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},

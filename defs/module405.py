...
SYMBOLS = [
	...
	{'addr':0x80BAD5F8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BAD790,'size':624,'pad':0,'label':"create__11daObj_Bed_cFv",'name':"create__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BADB00,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADB70,'size':272,'pad':0,'label':"CreateHeap__11daObj_Bed_cFv",'name':"CreateHeap__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADC80,'size':52,'pad':0,'label':"Delete__11daObj_Bed_cFv",'name':"Delete__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADCB4,'size':320,'pad':0,'label':"Execute__11daObj_Bed_cFv",'name':"Execute__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADDF4,'size':196,'pad':0,'label':"Draw__11daObj_Bed_cFv",'name':"Draw__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BADED8,'size':8,'pad':0,'label':"getType__11daObj_Bed_cFv",'name':"getType__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80BADEE0,'size':16,'pad':0,'label':"getResName__11daObj_Bed_cFv",'name':"getResName__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADEF0,'size':68,'pad':0,'label':"isDelete__11daObj_Bed_cFv",'name':"isDelete__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADF34,'size':92,'pad':0,'label':"setEnvTevColor__11daObj_Bed_cFv",'name':"setEnvTevColor__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADF90,'size':64,'pad':0,'label':"setRoomNo__11daObj_Bed_cFv",'name':"setRoomNo__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80BADFD0,'size':100,'pad':0,'label':"setMtx__11daObj_Bed_cFv",'name':"setMtx__11daObj_Bed_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BAE184,'size':4,'pad':0,'label':"lit_3905",'name':"@3905",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80BAE1EC,'size':36,'pad':0,'label':"__vt__12dBgS_ObjAcch",'name':"__vt__12dBgS_ObjAcch",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BAE210,'size':12,'pad':0,'label':"__vt__12dBgS_AcchCir",'name':"__vt__12dBgS_AcchCir",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BAE21C,'size':12,'pad':0,'label':"__vt__8cM3dGCyl",'name':"__vt__8cM3dGCyl",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BAE228,'size':12,'pad':0,'label':"__vt__8cM3dGLin",'name':"__vt__8cM3dGLin",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BAE234,'size':12,'pad':0,'label':"__vt__11daObj_Bed_c",'name':"__vt__11daObj_Bed_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80BAE240,'size':12,'pad':0,'label':"__vt__17daObj_Bed_Param_c",'name':"__vt__17daObj_Bed_Param_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},

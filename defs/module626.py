...
SYMBOLS = [
	...
	{'addr':0x80CDF038,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CDF0AC,'size':56,'pad':0,'label':"__ct__18daSnowEffTag_HIO_cFv",'name':"__ct__18daSnowEffTag_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CDF12C,'size':88,'pad':0,'label':"setBaseMtx__14daSnowEffTag_cFv",'name':"setBaseMtx__14daSnowEffTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CDF184,'size':308,'pad':0,'label':"create__14daSnowEffTag_cFv",'name':"create__14daSnowEffTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CDF2B8,'size':480,'pad':0,'label':"playerAreaCheck__14daSnowEffTag_cFv",'name':"playerAreaCheck__14daSnowEffTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CDF498,'size':332,'pad':0,'label':"Execute__14daSnowEffTag_cFv",'name':"Execute__14daSnowEffTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CDF5E4,'size':8,'pad':0,'label':"Draw__14daSnowEffTag_cFv",'name':"Draw__14daSnowEffTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80CDF5EC,'size':8,'pad':0,'label':"Delete__14daSnowEffTag_cFv",'name':"Delete__14daSnowEffTag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80CDF7A8,'size':12,'pad':0,'label':"__vt__18daSnowEffTag_HIO_c",'name':"__vt__18daSnowEffTag_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80CDF7B4,'size':12,'pad':0,'label':"__vt__14mDoHIO_entry_c",'name':"__vt__14mDoHIO_entry_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},

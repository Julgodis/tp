...
SYMBOLS = [
	...
	{'addr':0x80CDF674,'size':92,'pad':0,'label':"__dt__18daSnowEffTag_HIO_cFv",'name':"__dt__18daSnowEffTag_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CDF758,'size':32,'pad':0,'label':"l_daSnowEffTag_Method",'name':"l_daSnowEffTag_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80CDF778,'size':48,'pad':0,'label':"g_profile_Tag_SnowEff",'name':"g_profile_Tag_SnowEff",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

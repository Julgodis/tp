...
SYMBOLS = [
	...
	{'addr':0x80C2E060,'size':8,'pad':0,'label':"daObjKABUTO_IsDelete__FP13daObjKABUTO_c",'name':"daObjKABUTO_IsDelete__FP13daObjKABUTO_c",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C2E068,'size':72,'pad':0,'label':"__dt__14daObj_KabHIO_cFv",'name':"__dt__14daObj_KabHIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C2E228,'size':32,'pad':0,'label':"l_daObjKABUTO_Method",'name':"l_daObjKABUTO_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C2E248,'size':48,'pad':0,'label':"g_profile_Obj_Kabuto",'name':"g_profile_Obj_Kabuto",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

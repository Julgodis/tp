...
SYMBOLS = [
	...
	{'addr':0x80BC6A50,'size':4,'pad':0,'label':"lit_3731",'name':"@3731",'lib':-1,'tu':2,'section':2,'r':[4,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80BC6A54,'size':4,'pad':0,'label':"lit_3732",'name':"@3732",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},

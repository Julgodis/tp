...
SYMBOLS = [
	...
	{'addr':0x80BC6868,'size':8,'pad':0,'label':"Draw__11daObjCBlk_cFv",'name':"Draw__11daObjCBlk_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80BC6B9C,'size':32,'pad':0,'label':"l_daObjCBlk_Method",'name':"l_daObjCBlk_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80BC6BBC,'size':48,'pad':0,'label':"g_profile_Obj_ChainBlock",'name':"g_profile_Obj_ChainBlock",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

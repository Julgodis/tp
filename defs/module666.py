...
SYMBOLS = [
	...
	{'addr':0x80D1B610,'size':8,'pad':0,'label':"daObjTOMBO_IsDelete__FP12daObjTOMBO_c",'name':"daObjTOMBO_IsDelete__FP12daObjTOMBO_c",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80D1B618,'size':72,'pad':0,'label':"__dt__14daObj_TomHIO_cFv",'name':"__dt__14daObj_TomHIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D1B7F8,'size':32,'pad':0,'label':"l_daObjTOMBO_Method",'name':"l_daObjTOMBO_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D1B818,'size':48,'pad':0,'label':"g_profile_Obj_Tombo",'name':"g_profile_Obj_Tombo",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

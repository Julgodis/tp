...
SYMBOLS = [
	...
	{'addr':0x80CBF5BC,'size':92,'pad':0,'label':"__dt__17daRotBridge_HIO_cFv",'name':"__dt__17daRotBridge_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CBF6E4,'size':32,'pad':0,'label':"l_daRotBridge_Method",'name':"l_daRotBridge_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80CBF704,'size':48,'pad':0,'label':"g_profile_Obj_RotBridge",'name':"g_profile_Obj_RotBridge",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

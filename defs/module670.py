...
SYMBOLS = [
	...
	{'addr':0x80D1F7AC,'size':4,'pad':0,'label':"__ct__5csXyzFv",'name':"__ct__5csXyzFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D1F8F8,'size':32,'pad':0,'label':"daTreeSh_METHODS",'name':"daTreeSh_METHODS",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D1F918,'size':48,'pad':0,'label':"g_profile_TREESH",'name':"g_profile_TREESH",'lib':-1,'tu':2,'section':3,'r':[1,0,1],'sh':[0,0,0],'type':"ReferenceArray"},

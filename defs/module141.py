...
SYMBOLS = [
	...
	{'addr':0x805CACAC,'size':8,'pad':0,'label':"daB_DRE_IsDelete__FP9daB_DRE_c",'name':"daB_DRE_IsDelete__FP9daB_DRE_c",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x805CAD60,'size':4,'pad':0,'label':"lit_3862",'name':"@3862",'lib':-1,'tu':2,'section':2,'r':[5,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

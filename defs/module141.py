...
SYMBOLS = [
	...
	{'addr':0x805CACAC,'size':8,'pad':0,'label':"daB_DRE_IsDelete__FP9daB_DRE_c",'name':"daB_DRE_IsDelete__FP9daB_DRE_c",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x805CAFB4,'size':32,'pad':0,'label':"l_daB_DRE_Method",'name':"l_daB_DRE_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x805CAFD4,'size':48,'pad':0,'label':"g_profile_B_DRE",'name':"g_profile_B_DRE",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

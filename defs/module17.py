...
SYMBOLS = [
	...
	{'addr':0x8046EF30,'size':12,'pad':0,'label':"__vt__8cM3dGCyl",'name':"__vt__8cM3dGCyl",'lib':-1,'tu':3,'section':4,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x8046EF3C,'size':12,'pad':0,'label':"__vt__8cM3dGAab",'name':"__vt__8cM3dGAab",'lib':-1,'tu':3,'section':4,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x8046EF48,'size':40,'pad':0,'label':"__vt__14daObjBurnBox_c",'name':"__vt__14daObjBurnBox_c",'lib':-1,'tu':3,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"VirtualTable"},
]

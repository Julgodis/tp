...
SYMBOLS = [
	...
	{'addr':0x8046EEA4,'size':10,'pad':2,'label':"data_8046EEA4",'name':"particle_id$3649",'lib':-1,'tu':3,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x8046EEE0,'size':32,'pad':0,'label':"daObjBurnBox_METHODS",'name':"daObjBurnBox_METHODS",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8046EF00,'size':48,'pad':0,'label':"g_profile_Obj_BurnBox",'name':"g_profile_Obj_BurnBox",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80CC4C6C,'size':8,'pad':0,'label':"daObjSakuita_IsDelete__FP14daObjSakuita_c",'name':"daObjSakuita_IsDelete__FP14daObjSakuita_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80CC5114,'size':24,'pad':0,'label':"stringBase0",'name':"@stringBase0",'lib':-1,'tu':3,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"StringBase"},
	{'addr':0x80CC512C,'size':4,'pad':0,'label':"l_arcName",'name':"l_arcName",'lib':-1,'tu':3,'section':4,'r':[4,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80CC5130,'size':32,'pad':0,'label':"l_daObjSakuita_Method",'name':"l_daObjSakuita_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80CC5150,'size':48,'pad':0,'label':"g_profile_Obj_Sakuita",'name':"g_profile_Obj_Sakuita",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80CC46F8,'size':256,'pad':0,'label':"create_init__14daObjSakuita_cFv",'name':"create_init__14daObjSakuita_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CC47F8,'size':32,'pad':0,'label':"initBaseMtx__14daObjSakuita_cFv",'name':"initBaseMtx__14daObjSakuita_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CC4818,'size':132,'pad':0,'label':"setBaseMtx__14daObjSakuita_cFv",'name':"setBaseMtx__14daObjSakuita_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CC489C,'size':508,'pad':0,'label':"setPlatePos__14daObjSakuita_cFv",'name':"setPlatePos__14daObjSakuita_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CC4A98,'size':196,'pad':0,'label':"calcAngle__14daObjSakuita_cFv",'name':"calcAngle__14daObjSakuita_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CC4C9C,'size':420,'pad':0,'label':"__dt__14daObjSakuita_cFv",'name':"__dt__14daObjSakuita_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},

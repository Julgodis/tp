...
SYMBOLS = [
	...
	{'addr':0x8067EC78,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8067ECEC,'size':68,'pad':0,'label':"__ct__12daE_BA_HIO_cFv",'name':"__ct__12daE_BA_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067ED30,'size':96,'pad':0,'label':"ba_disappear__FP10fopAc_ac_c",'name':"ba_disappear__FP10fopAc_ac_c",'lib':-1,'tu':2,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067ED90,'size':168,'pad':0,'label':"anm_init__FP10e_ba_classifUcf",'name':"anm_init__FP10e_ba_classifUcf",'lib':-1,'tu':2,'section':0,'r':[0,0,30],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067EE38,'size':112,'pad':0,'label':"daE_BA_Draw__FP10e_ba_class",'name':"daE_BA_Draw__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[1,0,21],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067EEA8,'size':120,'pad':0,'label':"shot_b_sub__FPvPv",'name':"shot_b_sub__FPvPv",'lib':-1,'tu':2,'section':0,'r':[1,0,13],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067EF20,'size':216,'pad':0,'label':"other_bg_check__FP10e_ba_classP10fopAc_ac_c",'name':"other_bg_check__FP10e_ba_classP10fopAc_ac_c",'lib':-1,'tu':2,'section':0,'r':[0,0,14],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067EFF8,'size':180,'pad':0,'label':"pl_check__FP10e_ba_classfs",'name':"pl_check__FP10e_ba_classfs",'lib':-1,'tu':2,'section':0,'r':[0,0,2],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067F0AC,'size':560,'pad':0,'label':"damage_check__FP10e_ba_class",'name':"damage_check__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,24],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067F2DC,'size':616,'pad':0,'label':"path_check__FP10e_ba_class",'name':"path_check__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,8],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067F544,'size':400,'pad':0,'label':"fly_move__FP10e_ba_class",'name':"fly_move__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067F6D4,'size':328,'pad':0,'label':"e_ba_roof__FP10e_ba_class",'name':"e_ba_roof__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067F81C,'size':452,'pad':0,'label':"e_ba_fight_fly__FP10e_ba_class",'name':"e_ba_fight_fly__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067F9E0,'size':904,'pad':0,'label':"e_ba_fight__FP10e_ba_class",'name':"e_ba_fight__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067FD68,'size':504,'pad':0,'label':"e_ba_attack__FP10e_ba_class",'name':"e_ba_attack__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8067FF60,'size':556,'pad':0,'label':"e_ba_fly__FP10e_ba_class",'name':"e_ba_fly__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8068018C,'size':528,'pad':0,'label':"e_ba_return__FP10e_ba_class",'name':"e_ba_return__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8068039C,'size':792,'pad':0,'label':"e_ba_path_fly__FP10e_ba_class",'name':"e_ba_path_fly__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806806B4,'size':504,'pad':0,'label':"e_ba_chance__FP10e_ba_class",'name':"e_ba_chance__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806808AC,'size':584,'pad':0,'label':"e_ba_wolfbite__FP10e_ba_class",'name':"e_ba_wolfbite__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80680AF4,'size':420,'pad':0,'label':"e_ba_wind__FP10e_ba_class",'name':"e_ba_wind__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80680C98,'size':308,'pad':0,'label':"e_ba_appear__FP10e_ba_class",'name':"e_ba_appear__FP10e_ba_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80681DD8,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80681F94,'size':1044,'pad':0,'label':"setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz",'name':"setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806823C0,'size':4,'pad':0,'label':"lit_3948",'name':"@3948",'lib':-1,'tu':2,'section':2,'r':[17,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x806823C4,'size':4,'pad':4,'label':"lit_3949",'name':"@3949",'lib':-1,'tu':2,'section':2,'r':[18,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80682414,'size':4,'pad':0,'label':"lit_4276",'name':"@4276",'lib':-1,'tu':2,'section':2,'r':[4,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80682418,'size':4,'pad':0,'label':"lit_4277",'name':"@4277",'lib':-1,'tu':2,'section':2,'r':[6,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80682428,'size':4,'pad':0,'label':"lit_4377",'name':"@4377",'lib':-1,'tu':2,'section':2,'r':[6,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x8068246C,'size':4,'pad':0,'label':"lit_4747",'name':"@4747",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x806824BC,'size':8,'pad':0,'label':"data_806824BC",'name':"e_prim$3826",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x806824C4,'size':8,'pad':0,'label':"data_806824C4",'name':"e_env$3827",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x806824CC,'size':6,'pad':2,'label':"data_806824CC",'name':"eff_id$3835",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

...
SYMBOLS = [
	...
	{'addr':0x806F7204,'size':8,'pad':0,'label':"daE_IS_IsDelete__FP10e_is_class",'name':"daE_IS_IsDelete__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x806F7AC4,'size':72,'pad':0,'label':"__dt__12daE_IS_HIO_cFv",'name':"__dt__12daE_IS_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F7D00,'size':32,'pad':0,'label':"l_daE_IS_Method",'name':"l_daE_IS_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x806F7D20,'size':48,'pad':0,'label':"g_profile_E_IS",'name':"g_profile_E_IS",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

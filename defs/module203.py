...
SYMBOLS = [
	...
	{'addr':0x806F59D8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F5A4C,'size':72,'pad':0,'label':"__ct__12daE_IS_HIO_cFv",'name':"__ct__12daE_IS_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F5A94,'size':172,'pad':0,'label':"anm_init__FP10e_is_classifUcf",'name':"anm_init__FP10e_is_classifUcf",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F5E38,'size':124,'pad':0,'label':"pl_check__FP10e_is_classfs",'name':"pl_check__FP10e_is_classfs",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F5F3C,'size':504,'pad':0,'label':"damage_check__FP10e_is_class",'name':"damage_check__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F6134,'size':492,'pad':0,'label':"e_is_wait__FP10e_is_class",'name':"e_is_wait__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F6320,'size':220,'pad':0,'label':"e_is_move__FP10e_is_class",'name':"e_is_move__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F63FC,'size':448,'pad':0,'label':"e_is_attack__FP10e_is_class",'name':"e_is_attack__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F65BC,'size':500,'pad':0,'label':"e_is_trap__FP10e_is_class",'name':"e_is_trap__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F67B0,'size':364,'pad':0,'label':"e_is_poweroff__FP10e_is_class",'name':"e_is_poweroff__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F691C,'size':284,'pad':0,'label':"e_is_damage__FP10e_is_class",'name':"e_is_damage__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F6A38,'size':304,'pad':0,'label':"e_is_break__FP10e_is_class",'name':"e_is_break__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F6B68,'size':20,'pad':0,'label':"e_is_sekizou__FP10e_is_class",'name':"e_is_sekizou__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F6B7C,'size':532,'pad':0,'label':"action__FP10e_is_class",'name':"action__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x806F6D90,'size':200,'pad':0,'label':"anm_se_set__FP10e_is_class",'name':"anm_se_set__FP10e_is_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F76B4,'size':436,'pad':0,'label':"__ct__10e_is_classFv",'name':"__ct__10e_is_classFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F799C,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x806F7BC0,'size':4,'pad':0,'label':"lit_3967",'name':"@3967",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x806F7BC4,'size':4,'pad':0,'label':"lit_3968",'name':"@3968",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x806F7BC8,'size':4,'pad':0,'label':"lit_3969",'name':"@3969",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x806F7BCC,'size':4,'pad':0,'label':"lit_3970",'name':"@3970",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x806F7C3C,'size':64,'pad':0,'label':"data_806F7C3C",'name':"at_sph_src$4258",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x806F7C7C,'size':68,'pad':0,'label':"data_806F7C7C",'name':"cc_cyl_src$4259",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x806F7CC0,'size':64,'pad':0,'label':"data_806F7CC0",'name':"core_sph_src$4260",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

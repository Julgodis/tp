...
SYMBOLS = [
	...
	{'addr':0x80C62E30,'size':4,'pad':0,'label':"mode_dead__13daObjLv4Brg_cFv",'name':"mode_dead__13daObjLv4Brg_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C630AC,'size':8,'pad':0,'label':"eventStart__17dEvLib_callback_cFv",'name':"eventStart__17dEvLib_callback_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C630B4,'size':8,'pad':0,'label':"eventRun__17dEvLib_callback_cFv",'name':"eventRun__17dEvLib_callback_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80C630BC,'size':8,'pad':0,'label':"eventEnd__17dEvLib_callback_cFv",'name':"eventEnd__17dEvLib_callback_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80C631E4,'size':36,'pad':0,'label':"data_80C631E4",'name':"l_func$3701",'lib':-1,'tu':4,'section':5,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C63208,'size':32,'pad':0,'label':"daObjLv4Brg_METHODS",'name':"daObjLv4Brg_METHODS",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C63228,'size':48,'pad':0,'label':"g_profile_Obj_Lv4Bridge",'name':"g_profile_Obj_Lv4Bridge",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80C62E30,'size':4,'pad':0,'label':"mode_dead__13daObjLv4Brg_cFv",'name':"mode_dead__13daObjLv4Brg_cFv",'lib':-1,'tu':4,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C630AC,'size':8,'pad':0,'label':"eventStart__17dEvLib_callback_cFv",'name':"eventStart__17dEvLib_callback_cFv",'lib':-1,'tu':4,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C630B4,'size':8,'pad':0,'label':"eventRun__17dEvLib_callback_cFv",'name':"eventRun__17dEvLib_callback_cFv",'lib':-1,'tu':4,'section':0,'r':[2,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C630BC,'size':8,'pad':0,'label':"eventEnd__17dEvLib_callback_cFv",'name':"eventEnd__17dEvLib_callback_cFv",'lib':-1,'tu':4,'section':0,'r':[2,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C6317C,'size':4,'pad':0,'label':"lit_3676",'name':"@3676",'lib':-1,'tu':4,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80C63180,'size':4,'pad':0,'label':"lit_3740",'name':"@3740",'lib':-1,'tu':4,'section':4,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80C631C0,'size':12,'pad':0,'label':"lit_3702",'name':"@3702",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C631CC,'size':12,'pad':0,'label':"lit_3703",'name':"@3703",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C631D8,'size':12,'pad':0,'label':"lit_3704",'name':"@3704",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80C63258,'size':24,'pad':0,'label':"__vt__17dEvLib_callback_c",'name':"__vt__17dEvLib_callback_c",'lib':-1,'tu':4,'section':5,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80C63270,'size':72,'pad':0,'label':"__vt__13daObjLv4Brg_c",'name':"__vt__13daObjLv4Brg_c",'lib':-1,'tu':4,'section':5,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},

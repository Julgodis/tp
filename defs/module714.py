...
SYMBOLS = [
	...
	{'addr':0x80D55D60,'size':32,'pad':0,'label':"l_daTagArena_Method",'name':"l_daTagArena_Method",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D55D80,'size':48,'pad':0,'label':"g_profile_Tag_Arena",'name':"g_profile_Tag_Arena",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
]

...
SYMBOLS = [
	...
	{'addr':0x80CA37A4,'size':8,'pad':0,'label':"daObj_Ndoor_IsDelete__FP15obj_ndoor_class",'name':"daObj_Ndoor_IsDelete__FP15obj_ndoor_class",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80CA3A78,'size':64,'pad':0,'label':"data_80CA3A78",'name':"cc_sph_src$3869",'lib':-1,'tu':3,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80CA3AB8,'size':32,'pad':0,'label':"l_daObj_Ndoor_Method",'name':"l_daObj_Ndoor_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80CA3AD8,'size':48,'pad':0,'label':"g_profile_OBJ_NDOOR",'name':"g_profile_OBJ_NDOOR",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80D603D8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':0,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D603F8,'size':148,'pad':0,'label':"Create__14daTagRestart_cFv",'name':"Create__14daTagRestart_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D6048C,'size':148,'pad':0,'label':"create__14daTagRestart_cFv",'name':"create__14daTagRestart_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D60560,'size':484,'pad':0,'label':"execute__14daTagRestart_cFv",'name':"execute__14daTagRestart_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D60744,'size':8,'pad':0,'label':"_delete__14daTagRestart_cFv",'name':"_delete__14daTagRestart_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},

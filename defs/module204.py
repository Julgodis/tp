...
SYMBOLS = [
	...
	{'addr':0x806F97A8,'size':8,'pad':0,'label':"daE_KG_IsDelete__FP10e_kg_class",'name':"daE_KG_IsDelete__FP10e_kg_class",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},

...
SYMBOLS = [
	...
	{'addr':0x8057CF80,'size':32,'pad':0,'label':"l_daObj_Fmobj_Method",'name':"l_daObj_Fmobj_Method",'lib':-1,'tu':3,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8057CFA0,'size':48,'pad':0,'label':"g_profile_OBJ_FMOBJ",'name':"g_profile_OBJ_FMOBJ",'lib':-1,'tu':3,'section':4,'r':[0,0,1],'sh':[0,0,0],'type':"ReferenceArray"},
]

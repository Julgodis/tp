...
SYMBOLS = [
	...
	{'addr':0x8078E2D8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8078E34C,'size':104,'pad':0,'label':"__ct__12daE_SH_HIO_cFv",'name':"__ct__12daE_SH_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078E3B4,'size':172,'pad':0,'label':"anm_init__FP10e_sh_classifUcf",'name':"anm_init__FP10e_sh_classifUcf",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8078E868,'size':496,'pad':0,'label':"damage_check__FP10e_sh_class",'name':"damage_check__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078EA58,'size':428,'pad':0,'label':"e_sh_stop__FP10e_sh_class",'name':"e_sh_stop__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078EC04,'size':200,'pad':0,'label':"e_sh_appear__FP10e_sh_class",'name':"e_sh_appear__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078ECCC,'size':2652,'pad':0,'label':"e_sh_move__FP10e_sh_class",'name':"e_sh_move__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078F728,'size':784,'pad':0,'label':"e_sh_attack__FP10e_sh_class",'name':"e_sh_attack__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078FA38,'size':400,'pad':0,'label':"e_sh_disappear__FP10e_sh_class",'name':"e_sh_disappear__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078FBC8,'size':248,'pad':0,'label':"e_sh_damage__FP10e_sh_class",'name':"e_sh_damage__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8078FCC0,'size':240,'pad':0,'label':"e_sh_dead__FP10e_sh_class",'name':"e_sh_dead__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80790278,'size':544,'pad':0,'label':"eff_set__FP10e_sh_class",'name':"eff_set__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80790498,'size':1208,'pad':0,'label':"anm_se_set__FP10e_sh_class",'name':"anm_se_set__FP10e_sh_class",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8079178C,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80791948,'size':1044,'pad':0,'label':"setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz",'name':"setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80791D74,'size':4,'pad':0,'label':"lit_3903",'name':"@3903",'lib':-1,'tu':2,'section':2,'r':[12,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80791D78,'size':4,'pad':4,'label':"lit_3904",'name':"@3904",'lib':-1,'tu':2,'section':2,'r':[14,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80791DA0,'size':4,'pad':0,'label':"lit_3924",'name':"@3924",'lib':-1,'tu':2,'section':2,'r':[7,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80791E20,'size':4,'pad':0,'label':"lit_4633",'name':"@4633",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80791E24,'size':4,'pad':0,'label':"lit_4634",'name':"@4634",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80791E28,'size':4,'pad':0,'label':"lit_4635",'name':"@4635",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80791E2C,'size':4,'pad':0,'label':"lit_4636",'name':"@4636",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80791EE8,'size':8,'pad':0,'label':"data_80791EE8",'name':"e_prim$3781",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80791EF0,'size':8,'pad':0,'label':"data_80791EF0",'name':"e_env$3782",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80791EF8,'size':6,'pad':2,'label':"data_80791EF8",'name':"eff_id$3790",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

...
SYMBOLS = [
	...
	{'addr':0x80C31A78,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C31D5C,'size':928,'pad':0,'label':"create__12daObj_Kago_cFv",'name':"create__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C32360,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C323D0,'size':224,'pad':0,'label':"CreateHeap__12daObj_Kago_cFv",'name':"CreateHeap__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C324B0,'size':52,'pad':0,'label':"Delete__12daObj_Kago_cFv",'name':"Delete__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C324E4,'size':3564,'pad':0,'label':"Execute__12daObj_Kago_cFv",'name':"Execute__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C332D0,'size':288,'pad':0,'label':"Draw__12daObj_Kago_cFv",'name':"Draw__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C33410,'size':164,'pad':0,'label':"isDelete__12daObj_Kago_cFv",'name':"isDelete__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C334B4,'size':92,'pad':0,'label':"setEnvTevColor__12daObj_Kago_cFv",'name':"setEnvTevColor__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C33510,'size':68,'pad':0,'label':"setRoomNo__12daObj_Kago_cFv",'name':"setRoomNo__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C33554,'size':72,'pad':0,'label':"reset__12daObj_Kago_cFv",'name':"reset__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C3359C,'size':132,'pad':0,'label':"setMtx__12daObj_Kago_cFv",'name':"setMtx__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C33620,'size':400,'pad':0,'label':"getWallAngle__12daObj_Kago_cFsPs",'name':"getWallAngle__12daObj_Kago_cFsPs",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C337B0,'size':288,'pad':0,'label':"setGoalPosAndAngle__12daObj_Kago_cFv",'name':"setGoalPosAndAngle__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C338D0,'size':136,'pad':0,'label':"setSmokePrtcl__12daObj_Kago_cFv",'name':"setSmokePrtcl__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C33958,'size':256,'pad':0,'label':"setWaterPrtcl__12daObj_Kago_cFv",'name':"setWaterPrtcl__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80C33A58,'size':92,'pad':0,'label':"setHamonPrtcl__12daObj_Kago_cFv",'name':"setHamonPrtcl__12daObj_Kago_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C33B84,'size':28,'pad':0,'label':"func_80C33B84",'name':"cLib_calcTimer<i>__FPi",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C33CDC,'size':20,'pad':0,'label':"data_80C33CDC",'name':"heapSize$3870",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x80C33DD0,'size':8,'pad':0,'label':"l_resNameList",'name':"l_resNameList",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80C33F6C,'size':2,'pad':2,'label':"data_80C33F6C",'name':"angle$4689",'lib':-1,'tu':2,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

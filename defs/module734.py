...
SYMBOLS = [
	...
	{'addr':0x80D5EC40,'size':8,'pad':0,'label':"daTagQs_IsDelete__FP9daTagQs_c",'name':"daTagQs_IsDelete__FP9daTagQs_c",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},

...
SYMBOLS = [
	...
	{'addr':0x80D5EC40,'size':8,'pad':0,'label':"daTagQs_IsDelete__FP9daTagQs_c",'name':"daTagQs_IsDelete__FP9daTagQs_c",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80D5ED88,'size':32,'pad':0,'label':"l_daTagQs_Method",'name':"l_daTagQs_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D5EDA8,'size':48,'pad':0,'label':"g_profile_TAG_QS",'name':"g_profile_TAG_QS",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

...
SYMBOLS = [
	...
	{'addr':0x80708A14,'size':4,'pad':0,'label':"lit_3765",'name':"@3765",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80708A18,'size':4,'pad':0,'label':"lit_3766",'name':"@3766",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80708A1C,'size':4,'pad':0,'label':"lit_3767",'name':"@3767",'lib':-1,'tu':2,'section':2,'r':[4,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	...
	{'addr':0x80708C64,'size':12,'pad':0,'label':"L_pos1",'name':"L_pos1",'lib':-1,'tu':2,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708C70,'size':12,'pad':0,'label':"lit_3825",'name':"@3825",'lib':-1,'tu':2,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708C7C,'size':12,'pad':0,'label':"L_pos2",'name':"L_pos2",'lib':-1,'tu':2,'section':4,'r':[2,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708C88,'size':12,'pad':0,'label':"lit_3826",'name':"@3826",'lib':-1,'tu':2,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708C94,'size':12,'pad':0,'label':"L_Hpos",'name':"L_Hpos",'lib':-1,'tu':2,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708CA0,'size':12,'pad':0,'label':"lit_3827",'name':"@3827",'lib':-1,'tu':2,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708CAC,'size':12,'pad':0,'label':"R_pos1",'name':"R_pos1",'lib':-1,'tu':2,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708CB8,'size':12,'pad':0,'label':"lit_3828",'name':"@3828",'lib':-1,'tu':2,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708CC4,'size':12,'pad':0,'label':"R_pos2",'name':"R_pos2",'lib':-1,'tu':2,'section':4,'r':[3,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708CD0,'size':12,'pad':0,'label':"lit_3829",'name':"@3829",'lib':-1,'tu':2,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80708CDC,'size':12,'pad':0,'label':"R_Hpos",'name':"R_Hpos",'lib':-1,'tu':2,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

...
SYMBOLS = [
	...
	{'addr':0x80708148,'size':8,'pad':0,'label':"daE_MB_IsDelete__FP10e_mb_class",'name':"daE_MB_IsDelete__FP10e_mb_class",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ReturnFunction"},

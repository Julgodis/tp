...
SYMBOLS = [
	...
	{'addr':0x80C76584,'size':92,'pad':0,'label':"__dt__17daLv6SzGate_HIO_cFv",'name':"__dt__17daLv6SzGate_HIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80C766E8,'size':72,'pad':0,'label':"data_80C766E8",'name':"mode_proc$3798",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80C76730,'size':32,'pad':0,'label':"l_daLv6SzGate_Method",'name':"l_daLv6SzGate_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80C76750,'size':48,'pad':0,'label':"g_profile_Obj_Lv6SzGate",'name':"g_profile_Obj_Lv6SzGate",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

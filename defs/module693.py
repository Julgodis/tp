...
SYMBOLS = [
	...
	{'addr':0x80D3C078,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D3C0EC,'size':276,'pad':0,'label':"__ct__12daObj_YBag_cFv",'name':"__ct__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D3C398,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3C408,'size':520,'pad':0,'label':"__dt__12daObj_YBag_cFv",'name':"__dt__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,15],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3C610,'size':648,'pad':0,'label':"create__12daObj_YBag_cFv",'name':"create__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3C898,'size':164,'pad':0,'label':"CreateHeap__12daObj_YBag_cFv",'name':"CreateHeap__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3C93C,'size':52,'pad':0,'label':"Delete__12daObj_YBag_cFv",'name':"Delete__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3C970,'size':2492,'pad':0,'label':"Execute__12daObj_YBag_cFv",'name':"Execute__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D32C,'size':268,'pad':0,'label':"Draw__12daObj_YBag_cFv",'name':"Draw__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D3D458,'size':8,'pad':0,'label':"getTypeFromParam__12daObj_YBag_cFv",'name':"getTypeFromParam__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80D3D460,'size':8,'pad':0,'label':"isDelete__12daObj_YBag_cFv",'name':"isDelete__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80D3D468,'size':92,'pad':0,'label':"setEnvTevColor__12daObj_YBag_cFv",'name':"setEnvTevColor__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D4C4,'size':68,'pad':0,'label':"setRoomNo__12daObj_YBag_cFv",'name':"setRoomNo__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D508,'size':192,'pad':0,'label':"reset__12daObj_YBag_cFv",'name':"reset__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D5C8,'size':212,'pad':0,'label':"setMtx__12daObj_YBag_cFv",'name':"setMtx__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D69C,'size':160,'pad':0,'label':"calcRollAngle__12daObj_YBag_cFsi",'name':"calcRollAngle__12daObj_YBag_cFsi",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D73C,'size':400,'pad':0,'label':"getWallAngle__12daObj_YBag_cFsPs",'name':"getWallAngle__12daObj_YBag_cFsPs",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D8CC,'size':124,'pad':0,'label':"setSmokePrtcl__12daObj_YBag_cFv",'name':"setSmokePrtcl__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3D948,'size':296,'pad':0,'label':"setWaterPrtcl__12daObj_YBag_cFv",'name':"setWaterPrtcl__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80D3DA70,'size':80,'pad':0,'label':"setHamonPrtcl__12daObj_YBag_cFv",'name':"setHamonPrtcl__12daObj_YBag_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D3DB90,'size':28,'pad':0,'label':"func_80D3DB90",'name':"cLib_calcTimer<i>__FPi",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80D3DCF8,'size':4,'pad':0,'label':"lit_4312",'name':"@4312",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

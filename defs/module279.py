...
SYMBOLS = [
	...
	{'addr':0x80870C90,'size':4,'pad':0,'label':"__ct__4cXyzFv",'name':"__ct__4cXyzFv",'lib':-1,'tu':3,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80872598,'size':4,'pad':0,'label':"lit_3945",'name':"@3945",'lib':-1,'tu':3,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"ArbitraryData"},

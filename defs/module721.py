...
SYMBOLS = [
	...
	{'addr':0x80D59720,'size':32,'pad':0,'label':"l_daTagGra_Method",'name':"l_daTagGra_Method",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D59740,'size':48,'pad':0,'label':"g_profile_TAG_GRA",'name':"g_profile_TAG_GRA",'lib':-1,'tu':3,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
]

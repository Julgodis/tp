...
SYMBOLS = [
	...
	{'addr':0x80585DD8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80586048,'size':936,'pad':0,'label':"create__15daObj_KBacket_cFv",'name':"create__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80586594,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80586604,'size':256,'pad':0,'label':"CreateHeap__15daObj_KBacket_cFv",'name':"CreateHeap__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80586704,'size':52,'pad':0,'label':"Delete__15daObj_KBacket_cFv",'name':"Delete__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80586738,'size':3316,'pad':0,'label':"Execute__15daObj_KBacket_cFv",'name':"Execute__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058742C,'size':300,'pad':0,'label':"Draw__15daObj_KBacket_cFv",'name':"Draw__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x805875C0,'size':92,'pad':0,'label':"setEnvTevColor__15daObj_KBacket_cFv",'name':"setEnvTevColor__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8058761C,'size':68,'pad':0,'label':"setRoomNo__15daObj_KBacket_cFv",'name':"setRoomNo__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80587660,'size':52,'pad':0,'label':"reset__15daObj_KBacket_cFv",'name':"reset__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80587694,'size':304,'pad':0,'label':"setMtx__15daObj_KBacket_cFv",'name':"setMtx__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x805877C4,'size':160,'pad':0,'label':"calcRollAngle__15daObj_KBacket_cFsi",'name':"calcRollAngle__15daObj_KBacket_cFsi",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80587864,'size':400,'pad':0,'label':"getWallAngle__15daObj_KBacket_cFsPs",'name':"getWallAngle__15daObj_KBacket_cFsPs",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x805879F4,'size':124,'pad':0,'label':"setSmokePrtcl__15daObj_KBacket_cFv",'name':"setSmokePrtcl__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80587A70,'size':248,'pad':0,'label':"setWaterPrtcl__15daObj_KBacket_cFv",'name':"setWaterPrtcl__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80587B68,'size':80,'pad':0,'label':"setHamonPrtcl__15daObj_KBacket_cFv",'name':"setHamonPrtcl__15daObj_KBacket_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80587C88,'size':28,'pad':0,'label':"func_80587C88",'name':"cLib_calcTimer<i>__FPi",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80587EA8,'size':4,'pad':0,'label':"l_resNameList",'name':"l_resNameList",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

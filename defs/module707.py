...
SYMBOLS = [
	...
	{'addr':0x80D4E6C4,'size':4,'pad':0,'label':"actionStop__10daSwBall_cFv",'name':"actionStop__10daSwBall_cFv",'lib':-1,'tu':3,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	...
	{'addr':0x80D4E9E4,'size':24,'pad':0,'label':"data_80D4E9E4",'name':"l_func$3846",'lib':-1,'tu':3,'section':4,'r':[1,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80D4E9FC,'size':32,'pad':0,'label':"l_daSwBall_Method",'name':"l_daSwBall_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D4EA1C,'size':48,'pad':0,'label':"g_profile_SwBall",'name':"g_profile_SwBall",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

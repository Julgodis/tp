...
SYMBOLS = [
	...
	{'addr':0x80CB9B9C,'size':40,'pad':0,'label':"__vt__10daRfHole_c",'name':"__vt__10daRfHole_c",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80CB9BC4,'size':12,'pad':0,'label':"__vt__14daRfHole_HIO_c",'name':"__vt__14daRfHole_HIO_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80CB9BD0,'size':12,'pad':0,'label':"__vt__14mDoHIO_entry_c",'name':"__vt__14mDoHIO_entry_c",'lib':-1,'tu':2,'section':3,'r':[3,0,0],'sh':[0,0,0],'type':"VirtualTable"},

...
SYMBOLS = [
	...
	{'addr':0x8071FE98,'size':776,'pad':0,'label':"damage_check__FP10e_mm_class",'name':"damage_check__FP10e_mm_class",'lib':-1,'tu':2,'section':0,'r':[2,1,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80722C40,'size':4,'pad':0,'label':"lit_3790",'name':"@3790",'lib':-1,'tu':2,'section':2,'r':[6,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80722C44,'size':4,'pad':4,'label':"lit_3791",'name':"@3791",'lib':-1,'tu':2,'section':2,'r':[6,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80722C7C,'size':4,'pad':0,'label':"lit_3815",'name':"@3815",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80722C80,'size':4,'pad':0,'label':"lit_3816",'name':"@3816",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80722C84,'size':4,'pad':0,'label':"lit_3830",'name':"@3830",'lib':-1,'tu':2,'section':2,'r':[2,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80722C88,'size':4,'pad':0,'label':"lit_3860",'name':"@3860",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80722C8C,'size':4,'pad':0,'label':"lit_3909",'name':"@3909",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	{'addr':0x80722C90,'size':4,'pad':0,'label':"lit_3910",'name':"@3910",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},
	...
	{'addr':0x80722CA8,'size':4,'pad':0,'label':"lit_4141",'name':"@4141",'lib':-1,'tu':2,'section':2,'r':[1,0,0],'sh':[0,0,0],'type':"Integer"},

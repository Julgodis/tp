...
SYMBOLS = [
	...
	{'addr':0x80BDC2E8,'size':8,'pad':0,'label':"daObjDAN_IsDelete__FP10daObjDAN_c",'name':"daObjDAN_IsDelete__FP10daObjDAN_c",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x80BDC2F0,'size':72,'pad':0,'label':"__dt__14daObj_DanHIO_cFv",'name':"__dt__14daObj_DanHIO_cFv",'lib':-1,'tu':2,'section':0,'r':[1,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80BDC47C,'size':32,'pad':0,'label':"l_daObjDAN_Method",'name':"l_daObjDAN_Method",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80BDC49C,'size':48,'pad':0,'label':"g_profile_Obj_Dan",'name':"g_profile_Obj_Dan",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

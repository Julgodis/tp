...
# Symbols
SYMBOLS = [
	{'addr':0x80CCDB20,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':0,'section':0,'r':[0,0,3],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CCDB4C,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':0,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CCDB78,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':0,'section':0,'r':[0,0,2],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CCDB98,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':3,'section':0,'r':[0,0,2],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CCDBB4,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':3,'section':0,'r':[2,0,7],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CCDC0C,'size':244,'pad':0,'label':"create__14daObj_Sekizo_cFv",'name':"create__14daObj_Sekizo_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CCDE3C,'size':184,'pad':0,'label':"Execute__14daObj_Sekizo_cFPPA3_A4_f",'name':"Execute__14daObj_Sekizo_cFPPA3_A4_f",'lib':-1,'tu':2,'section':0,'r':[1,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CCDFA4,'size':60,'pad':0,'label':"initBaseMtx__14daObj_Sekizo_cFv",'name':"initBaseMtx__14daObj_Sekizo_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x80CCDFE0,'size':100,'pad':0,'label':"setBaseMtx__14daObj_Sekizo_cFv",'name':"setBaseMtx__14daObj_Sekizo_cFv",'lib':-1,'tu':2,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x80CCE19C,'size':8,'pad':0,'label':"l_bmdData",'name':"l_bmdData",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80CCE1A4,'size':8,'pad':0,'label':"l_dzbData",'name':"l_dzbData",'lib':-1,'tu':2,'section':3,'r':[0,0,0],'sh':[0,0,0],'type':"ArbitraryData"},
	{'addr':0x80CCE1AC,'size':8,'pad':0,'label':"l_resNameList",'name':"l_resNameList",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x80CCE204,'size':40,'pad':0,'label':"__vt__14daObj_Sekizo_c",'name':"__vt__14daObj_Sekizo_c",'lib':-1,'tu':2,'section':3,'r':[1,0,0],'sh':[0,0,0],'type':"VirtualTable"},
	{'addr':0x80CCE22C,'size':12,'pad':0,'label':"__vt__20daObj_Sekizo_Param_c",'name':"__vt__20daObj_Sekizo_Param_c",'lib':-1,'tu':2,'section':3,'r':[2,0,0],'sh':[0,0,0],'type':"VirtualTable"},

...
SYMBOLS = [
	...
	{'addr':0x8059E158,'size':32,'pad':0,'label':"initBaseMtx__10daScExit_cFv",'name':"initBaseMtx__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E178,'size':56,'pad':0,'label':"setBaseMtx__10daScExit_cFv",'name':"setBaseMtx__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E1B0,'size':128,'pad':0,'label':"Create__10daScExit_cFv",'name':"Create__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E230,'size':144,'pad':0,'label':"create__10daScExit_cFv",'name':"create__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E2C0,'size':36,'pad':0,'label':"execute__10daScExit_cFv",'name':"execute__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E2E4,'size':188,'pad':0,'label':"event_proc_call__10daScExit_cFv",'name':"event_proc_call__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8059E508,'size':452,'pad':0,'label':"demoProc__10daScExit_cFv",'name':"demoProc__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,1],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E6CC,'size':72,'pad':0,'label':"checkArea__10daScExit_cFv",'name':"checkArea__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	{'addr':0x8059E714,'size':8,'pad':0,'label':"draw__10daScExit_cFv",'name':"draw__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ReturnFunction"},
	{'addr':0x8059E71C,'size':52,'pad':0,'label':"_delete__10daScExit_cFv",'name':"_delete__10daScExit_cFv",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8059E7D0,'size':28,'pad':0,'label':"func_8059E7D0",'name':"cLib_calcTimer<Uc>__FPUc",'lib':-1,'tu':4,'section':0,'r':[0,0,0],'sh':[0,0,0],'type':"ASMFunction"},
	...
	{'addr':0x8059E860,'size':12,'pad':0,'label':"lit_3699",'name':"@3699",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8059E86C,'size':12,'pad':0,'label':"lit_3700",'name':"@3700",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8059E878,'size':12,'pad':0,'label':"lit_3701",'name':"@3701",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x8059E884,'size':12,'pad':0,'label':"lit_3702",'name':"@3702",'lib':-1,'tu':4,'section':5,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	...
	{'addr':0x8059E8C0,'size':12,'pad':0,'label':"data_8059E8C0",'name':"action_table$3745",'lib':-1,'tu':4,'section':5,'r':[1,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

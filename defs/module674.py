...
SYMBOLS = [
	...
	{'addr':0x80D21A28,'size':32,'pad':0,'label':"l_daObjVGnd_Method",'name':"l_daObjVGnd_Method",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},
	{'addr':0x80D21A48,'size':48,'pad':0,'label':"g_profile_Obj_VolcGnd",'name':"g_profile_Obj_VolcGnd",'lib':-1,'tu':3,'section':4,'r':[0,0,0],'sh':[0,0,0],'type':"ReferenceArray"},

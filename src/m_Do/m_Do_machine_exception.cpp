...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void dispConsoleToTerminal__Fv() {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void exception_addition__FP10JUTConsole() {
	nofralloc

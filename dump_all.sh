...
powerpc-linux-gnu-objdump -j .init -d build/dolzel2/main.elf > main_init.dump
powerpc-linux-gnu-objdump -j .text -d build/dolzel2/main.elf > main_text.dump
...
powerpc-linux-gnu-objdump -j .init -d test.elf > test_init.dump
...
powerpc-linux-gnu-objdump -j .init -d expected/build/dolzel2/main.elf > base_init.dump
powerpc-linux-gnu-objdump -j .text -d expected/build/dolzel2/main.elf > base_text.dump

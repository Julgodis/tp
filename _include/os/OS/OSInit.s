...
/* 80339F88 00000028  3C 60 80 3D */	lis r3, OS__LIT_1@ha
/* 80339F8C 0000002C  3B C3 F2 88 */	addi r30, r3, OS__LIT_1@l
...
/* 80339FF0 00000090  3C 80 80 00 */	lis r4, 0x8000 /* 800000F4@ha */
/* 80339FF4 00000094  90 0D 90 84 */	stw r0, BI2DebugFlag(r13)
/* 80339FF8 00000098  90 8D 90 80 */	stw r4, OS__BootInfo(r13)
...
/* 8033A064 00000004  80 6D 90 80 */	lwz r3, OS__BootInfo(r13)
...
/* 8033A078 00000018  3C 60 80 46 */	lis r3, 0x8046 /* 80459BE0@ha */
/* 8033A07C 0000001C  38 63 9B E0 */	addi r3, r3, 0x9BE0 /* 80459BE0@l */
/* 8033A080 00000020  48 00 00 04 */	b lbl_8033A084
lbl_8033A084:
/* 8033A084 00000000  48 00 12 21 */	bl OSSetArenaLo
/* 8033A088 00000004  80 6D 90 80 */	lwz r3, OS__BootInfo(r13)
...
/* 8033A0B0 0000002C  3C 60 80 45 */	lis r3, 0x8045 /* 80457BC8@ha */
/* 8033A0B4 00000030  38 63 7B C8 */	addi r3, r3, 0x7BC8 /* 80457BC8@l */
...
lbl_8033A0C4:
/* 8033A0C4 00000000  80 6D 90 80 */	lwz r3, OS__BootInfo(r13)
...
/* 8033A0D4 00000010  3C 60 81 70 */	lis r3, 0x8170 /* 81700000@ha */
/* 8033A0D8 00000014  38 63 00 00 */	addi r3, r3, 0x0000 /* 81700000@l */
...
/* 8033A16C 0000002C  80 6D 90 80 */	lwz r3, OS__BootInfo(r13)
...
lbl_8033A184:
/* 8033A184 00000000  3C 60 10 00 */	lis r3, 0x1000 /* 10000002@ha */
/* 8033A188 00000004  38 83 00 02 */	addi r4, r3, 0x0002 /* 10000002@l */
...
lbl_8033A1D0:
/* 8033A1D0 00000000  3C 60 10 00 */	lis r3, 0x1000 /* 10000002@ha */
/* 8033A1D4 00000004  54 85 01 3E */	clrlwi r5, r4, 4
/* 8033A1D8 00000008  38 03 00 02 */	addi r0, r3, 0x0002 /* 10000002@l */
...
/* 8033A268 00000004  38 6D 84 04 */	addi r3, r13, 0x80450984-0x80458580 /* OS__LIT_116-_SDA_BASE_ */
/* 8033A26C 00000008  4B CC C8 51 */	bl OSReport
lbl_8033A270:
/* 8033A270 00000000  80 8D 90 80 */	lwz r4, OS__BootInfo(r13)
...
/* 8033A3F0 00000020  3C 60 00 01 */	lis r3, 0x0001 /* 00009000@ha */
/* 8033A3F4 00000024  38 03 90 00 */	addi r0, r3, 0x9000 /* 00009000@l */
/* 8033A3F8 00000028  3C 60 80 00 */	lis r3, 0x8000 /* 800030E6@ha */

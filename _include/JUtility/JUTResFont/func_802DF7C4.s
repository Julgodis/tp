...
/* 802DF7D8 00000014  DB C1 00 90 */	stfd f30, 0x90(r1)
/* 802DF7DC 00000018  F3 C1 00 98 */	psq_st f30, 152(r1), 0, 0 /* qr0 */
/* 802DF7E0 0000001C  DB A1 00 80 */	stfd f29, 0x80(r1)
/* 802DF7E4 00000020  F3 A1 00 88 */	psq_st f29, 136(r1), 0, 0 /* qr0 */
/* 802DF7E8 00000024  DB 81 00 70 */	stfd f28, 0x70(r1)
/* 802DF7EC 00000028  F3 81 00 78 */	psq_st f28, 120(r1), 0, 0 /* qr0 */
/* 802DF7F0 0000002C  DB 61 00 60 */	stfd f27, 0x60(r1)
/* 802DF7F4 00000030  F3 61 00 68 */	psq_st f27, 104(r1), 0, 0 /* qr0 */
/* 802DF7F8 00000034  DB 41 00 50 */	stfd f26, 0x50(r1)
/* 802DF7FC 00000038  F3 41 00 58 */	psq_st f26, 88(r1), 0, 0 /* qr0 */
/* 802DF800 0000003C  39 61 00 50 */	addi r11, r1, 0x50
/* 802DF804 00000040  48 08 29 D1 */	bl func_803621D4
/* 802DF808 00000044  7C 7E 1B 78 */	mr r30, r3
/* 802DF80C 00000048  FF 40 08 90 */	fmr f26, f1
/* 802DF810 0000004C  FF 60 10 90 */	fmr f27, f2
/* 802DF814 00000050  FF C0 18 90 */	fmr f30, f3
/* 802DF818 00000054  FF 80 20 90 */	fmr f28, f4
/* 802DF81C 00000058  7C BB 2B 78 */	mr r27, r5
/* 802DF820 0000005C  38 A0 00 00 */	li r5, 0
/* 802DF824 00000060  38 C1 00 08 */	addi r6, r1, 8
/* 802DF828 00000064  48 00 03 C1 */	bl func_802DFBE8
/* 802DF82C 00000068  88 1E 00 05 */	lbz r0, 5(r30)
/* 802DF830 0000006C  28 00 00 00 */	cmplwi r0, 0
/* 802DF834 00000070  40 82 00 0C */	bne lbl_802DF840
/* 802DF838 00000074  57 60 06 3F */	clrlwi. r0, r27, 0x18
/* 802DF83C 00000078  40 82 00 0C */	bne lbl_802DF848
lbl_802DF840:
...
/* 802DFAEC 00000140  48 07 BA D9 */	bl func_8035B5C4
/* 802DFAF0 00000144  38 60 00 80 */	li r3, 0x80
/* 802DFAF4 00000148  38 80 00 00 */	li r4, 0
/* 802DFAF8 0000014C  38 A0 00 04 */	li r5, 4
/* 802DFAFC 00000150  48 07 CC 69 */	bl func_8035C764
/* 802DFB00 00000154  3C 60 CC 01 */	lis r3, 0xcc01
...
/* 802DFB98 000001EC  48 07 BA 2D */	bl func_8035B5C4
/* 802DFB9C 000001F0  FC 20 E8 90 */	fmr f1, f29
/* 802DFBA0 000001F4  E3 E1 00 A8 */	psq_l f31, 168(r1), 0, 0 /* qr0 */
/* 802DFBA4 000001F8  CB E1 00 A0 */	lfd f31, 0xa0(r1)
/* 802DFBA8 000001FC  E3 C1 00 98 */	psq_l f30, 152(r1), 0, 0 /* qr0 */
/* 802DFBAC 00000200  CB C1 00 90 */	lfd f30, 0x90(r1)
/* 802DFBB0 00000204  E3 A1 00 88 */	psq_l f29, 136(r1), 0, 0 /* qr0 */
/* 802DFBB4 00000208  CB A1 00 80 */	lfd f29, 0x80(r1)
/* 802DFBB8 0000020C  E3 81 00 78 */	psq_l f28, 120(r1), 0, 0 /* qr0 */
/* 802DFBBC 00000210  CB 81 00 70 */	lfd f28, 0x70(r1)
/* 802DFBC0 00000214  E3 61 00 68 */	psq_l f27, 104(r1), 0, 0 /* qr0 */
/* 802DFBC4 00000218  CB 61 00 60 */	lfd f27, 0x60(r1)
/* 802DFBC8 0000021C  E3 41 00 58 */	psq_l f26, 88(r1), 0, 0 /* qr0 */
/* 802DFBCC 00000220  CB 41 00 50 */	lfd f26, 0x50(r1)
/* 802DFBD0 00000224  39 61 00 50 */	addi r11, r1, 0x50
/* 802DFBD4 00000228  48 08 26 4D */	bl func_80362220
/* 802DFBD8 0000022C  80 01 00 B4 */	lwz r0, 0xb4(r1)
/* 802DFBDC 00000230  7C 08 03 A6 */	mtlr r0
/* 802DFBE0 00000234  38 21 00 B0 */	addi r1, r1, 0xb0
/* 802DFBE4 00000238  4E 80 00 20 */	blr 

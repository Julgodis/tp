...
/* 802A8CFC 00000020  3C 60 00 01 */	lis r3, 0x0001 /* 0000FFFF@ha */
/* 802A8D00 00000024  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0000FFFF@l */
...
lbl_802A8D58:
/* 802A8D58 00000000  3C E0 01 00 */	lis r7, 0x0100 /* 00FFFFFF@ha */
/* 802A8D5C 00000004  38 07 FF FF */	addi r0, r7, 0xFFFF /* 00FFFFFF@l */
...
/* 802A8DA8 00000008  3C E0 01 00 */	lis r7, 0x0100 /* 00FFFFFF@ha */
/* 802A8DAC 0000000C  38 07 FF FF */	addi r0, r7, 0xFFFF /* 00FFFFFF@l */
...
lbl_802A8DDC:
/* 802A8DDC 00000000  3C 60 00 01 */	lis r3, 0x0001 /* 0000FFFF@ha */
/* 802A8DE0 00000004  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0000FFFF@l */
...
/* 802A8E04 00000010  3C 60 00 01 */	lis r3, 0x0001 /* 0000FFFF@ha */
/* 802A8E08 00000014  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0000FFFF@l */
/* 802A8E0C 00000018  48 00 00 9C */	b lbl_802A8EA8
lbl_802A8E10:
/* 802A8E10 00000000  80 63 00 18 */	lwz r3, 0x18(r3)
/* 802A8E14 00000004  A0 03 00 08 */	lhz r0, 8(r3)
...
/* 802A8E24 00000014  88 03 00 0A */	lbz r0, 0xa(r3)
...
lbl_802A8E58:
/* 802A8E58 00000000  3C 60 00 01 */	lis r3, 0x0001 /* 0000FFFF@ha */
/* 802A8E5C 00000004  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0000FFFF@l */
...
/* 802A8E8C 00000008  3C 60 00 01 */	lis r3, 0x0001 /* 0000FFFF@ha */
/* 802A8E90 0000000C  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0000FFFF@l */

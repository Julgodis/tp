...
/* 8027ACB4 0000001C  40 80 00 18 */	bge lbl_8027ACCC
/* 8027ACB8 00000020  C0 25 00 34 */	lfs f1, 0x34(r5)
/* 8027ACBC 00000024  C0 03 00 04 */	lfs f0, 4(r3)
/* 8027ACC0 00000028  EC 03 00 32 */	fmuls f0, f3, f0
/* 8027ACC4 0000002C  EC A1 00 2A */	fadds f5, f1, f0
/* 8027ACC8 00000030  48 00 00 2C */	b lbl_8027ACF4
lbl_8027ACCC:
/* 8027ACCC 00000000  C0 05 00 30 */	lfs f0, 0x30(r5)
/* 8027ACD0 00000004  FC 03 00 40 */	fcmpo cr0, f3, f0
/* 8027ACD4 00000008  40 81 00 1C */	ble lbl_8027ACF0
/* 8027ACD8 0000000C  C0 45 00 38 */	lfs f2, 0x38(r5)
/* 8027ACDC 00000010  EC 23 00 28 */	fsubs f1, f3, f0
/* 8027ACE0 00000014  C0 03 00 08 */	lfs f0, 8(r3)
/* 8027ACE4 00000018  EC 01 00 32 */	fmuls f0, f1, f0
/* 8027ACE8 0000001C  EC A2 00 2A */	fadds f5, f2, f0
/* 8027ACEC 00000020  48 00 00 08 */	b lbl_8027ACF4
lbl_8027ACF0:
...
/* 8027AD44 00000050  3C 60 80 44 */	lis r3, 0x8044
/* 8027AD48 00000054  38 63 9A 20 */	addi r3, r3, -26080
...
/* 8027AD78 00000084  88 01 00 08 */	lbz r0, 8(r1)
/* 8027AD7C 00000088  98 04 00 96 */	stb r0, 0x96(r4)
/* 8027AD80 0000008C  38 21 00 20 */	addi r1, r1, 0x20
/* 8027AD84 00000090  4E 80 00 20 */	blr 

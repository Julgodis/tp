...
/* 803694C4 00000014  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 803694C8 00000018  F3 C1 00 38 */	psq_st f30, 56(r1), 0, 0 /* qr0 */
/* 803694CC 0000001C  DB A1 00 20 */	stfd f29, 0x20(r1)
/* 803694D0 00000020  F3 A1 00 28 */	psq_st f29, 40(r1), 0, 0 /* qr0 */
/* 803694D4 00000024  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 803694D8 00000028  93 C1 00 18 */	stw r30, 0x18(r1)
/* 803694DC 0000002C  D8 21 00 08 */	stfd f1, 8(r1)
/* 803694E0 00000030  3C 00 3F F0 */	lis r0, 0x3ff0
/* 803694E4 00000034  83 E1 00 08 */	lwz r31, 8(r1)
/* 803694E8 00000038  57 FE 00 7E */	clrlwi r30, r31, 1
/* 803694EC 0000003C  7C 1E 00 00 */	cmpw r30, r0
/* 803694F0 00000040  41 80 00 34 */	blt lbl_80369524
/* 803694F4 00000044  80 01 00 0C */	lwz r0, 0xc(r1)
/* 803694F8 00000048  3C 7E C0 10 */	addis r3, r30, 0xc010
/* 803694FC 0000004C  7C 60 03 79 */	or. r0, r3, r0
/* 80369500 00000050  40 82 00 18 */	bne lbl_80369518
/* 80369504 00000054  C8 02 CD 08 */	lfd f0, Math_Double_precision_e_asin__LIT_95(r2)
/* 80369508 00000058  C8 42 CD 00 */	lfd f2, Math_Double_precision_e_asin__LIT_94(r2)
/* 8036950C 0000005C  FC 00 00 72 */	fmul f0, f0, f1
/* 80369510 00000060  FC 22 00 7A */	fmadd f1, f2, f1, f0
/* 80369514 00000064  48 00 01 A4 */	b lbl_803696B8
lbl_80369518:
/* 80369518 00000000  3C 60 80 45 */	lis r3, 0x8045
/* 8036951C 00000004  C0 23 0A E0 */	lfs f1, 0xae0(r3)
...
/* 8036954C 00000028  40 81 00 0C */	ble lbl_80369558
/* 80369550 0000002C  48 00 01 68 */	b lbl_803696B8
lbl_80369554:
...
/* 8036962C 0000006C  48 00 34 29 */	bl func_8036CA54
/* 80369630 00000070  3C 60 3F EF */	lis r3, 0x3fef
/* 80369634 00000074  38 03 33 33 */	addi r0, r3, 0x3333
...
/* 803696BC 00000004  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 803696C0 00000008  E3 C1 00 38 */	psq_l f30, 56(r1), 0, 0 /* qr0 */
/* 803696C4 0000000C  CB C1 00 30 */	lfd f30, 0x30(r1)
/* 803696C8 00000010  E3 A1 00 28 */	psq_l f29, 40(r1), 0, 0 /* qr0 */
/* 803696CC 00000014  CB A1 00 20 */	lfd f29, 0x20(r1)
/* 803696D0 00000018  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 803696D4 0000001C  80 01 00 54 */	lwz r0, 0x54(r1)
/* 803696D8 00000020  83 C1 00 18 */	lwz r30, 0x18(r1)
/* 803696DC 00000024  7C 08 03 A6 */	mtlr r0
/* 803696E0 00000028  38 21 00 50 */	addi r1, r1, 0x50
/* 803696E4 0000002C  4E 80 00 20 */	blr 

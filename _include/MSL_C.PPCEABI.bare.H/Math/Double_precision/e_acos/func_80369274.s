...
/* 80369288 00000014  D8 21 00 08 */	stfd f1, 8(r1)
/* 8036928C 00000018  3C 00 3F F0 */	lis r0, 0x3ff0
/* 80369290 0000001C  80 81 00 08 */	lwz r4, 8(r1)
/* 80369294 00000020  54 83 00 7E */	clrlwi r3, r4, 1
/* 80369298 00000024  7C 03 00 00 */	cmpw r3, r0
/* 8036929C 00000028  41 80 00 38 */	blt lbl_803692D4
/* 803692A0 0000002C  80 01 00 0C */	lwz r0, 0xc(r1)
/* 803692A4 00000030  3C 63 C0 10 */	addis r3, r3, 0xc010
/* 803692A8 00000034  7C 60 03 79 */	or. r0, r3, r0
/* 803692AC 00000038  40 82 00 1C */	bne lbl_803692C8
/* 803692B0 0000003C  2C 04 00 00 */	cmpwi r4, 0
/* 803692B4 00000040  40 81 00 0C */	ble lbl_803692C0
/* 803692B8 00000044  C8 22 CC 78 */	lfd f1, Math_Double_precision_e_acos__LIT_83(r2)
/* 803692BC 00000048  48 00 01 DC */	b lbl_80369498
lbl_803692C0:
/* 803692C0 00000000  C8 22 CC 80 */	lfd f1, Math_Double_precision_e_acos__LIT_84(r2)
/* 803692C4 00000004  48 00 01 D4 */	b lbl_80369498
lbl_803692C8:
/* 803692C8 00000000  3C 60 80 45 */	lis r3, 0x8045
/* 803692CC 00000004  C0 23 0A E0 */	lfs f1, 0xae0(r3)
...
/* 80369384 0000001C  48 00 36 D1 */	bl func_8036CA54
...
/* 80369410 00000014  48 00 36 45 */	bl func_8036CA54
...
/* 8036949C 00000004  80 01 00 34 */	lwz r0, 0x34(r1)
/* 803694A0 00000008  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 803694A4 0000000C  7C 08 03 A6 */	mtlr r0
/* 803694A8 00000010  38 21 00 30 */	addi r1, r1, 0x30
/* 803694AC 00000014  4E 80 00 20 */	blr 

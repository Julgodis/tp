...
/* 8000A618 00000014  DB C1 03 C0 */	stfd f30, 0x3c0(r1)
/* 8000A61C 00000018  F3 C1 03 C8 */	psq_st f30, 968(r1), 0, 0 /* qr0 */
/* 8000A620 0000001C  39 61 03 C0 */	addi r11, r1, 0x3c0
/* 8000A624 00000020  48 35 7B 99 */	bl _savegpr_21
/* 8000A628 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8000A62C 00000028  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l
/* 8000A630 0000002C  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)
/* 8000A634 00000030  28 03 00 00 */	cmplwi r3, 0
/* 8000A638 00000034  41 82 00 08 */	beq lbl_8000A640
/* 8000A63C 00000038  48 04 1A F9 */	bl calcMenu__13dPa_control_cFv
lbl_8000A640:
...
/* 8000A8D8 000000C0  48 19 B7 E5 */	bl dKy_setLight(void)
...
/* 8000AA64 00000054  4B FF F8 2D */	bl motionBlure(view_class*)
...
/* 8000AA8C 0000007C  4B FF DB A5 */	bl drawDepth2(view_class*, view_port_class*, int)
...
/* 8000AC00 00000018  4B FF F5 61 */	bl retry_captue_frame(view_class*, view_port_class*, int)
...
/* 8000ACA8 00000050  4B FF F4 B9 */	bl retry_captue_frame(view_class*, view_port_class*, int)
lbl_8000ACAC:
...
/* 8000AD28 0000007C  48 00 19 E9 */	bl mDoMtx_lookAt(f32 [][4], const Vec*, const Vec*, const Vec*, s16)
...
/* 8000ADE8 00000018  4B FF F3 79 */	bl retry_captue_frame(view_class*, view_port_class*, int)
lbl_8000ADEC:
...
/* 8000AEC8 00000008  4B FF E2 F9 */	bl trimming(view_class*, view_port_class*)
...
/* 8000AEE8 00000028  88 0D 86 66 */	lbz r0, merged_80450BE4+2(r13)
...
/* 8000B004 00000020  4B FF F5 89 */	bl drawItem3D(void)
...
/* 8000B088 00000024  88 0D 86 66 */	lbz r0, merged_80450BE4+2(r13)
...
/* 8000B0F4 00000044  CB E1 03 D0 */	lfd f31, 0x3d0(r1)
/* 8000B0F8 00000048  E3 C1 03 C8 */	psq_l f30, 968(r1), 0, 0 /* qr0 */
/* 8000B0FC 0000004C  CB C1 03 C0 */	lfd f30, 0x3c0(r1)
/* 8000B100 00000050  39 61 03 C0 */	addi r11, r1, 0x3c0
/* 8000B104 00000054  48 35 71 05 */	bl _restgpr_21
/* 8000B108 00000058  80 01 03 E4 */	lwz r0, 0x3e4(r1)
/* 8000B10C 0000005C  7C 08 03 A6 */	mtlr r0
/* 8000B110 00000060  38 21 03 E0 */	addi r1, r1, 0x3e0
/* 8000B114 00000064  4E 80 00 20 */	blr 

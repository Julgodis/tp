...
/* 8032A9A4 00000014  C0 02 CA 34 */	lfs f0, J3DAnimation__LIT_853(r2)
/* 8032A9A8 00000018  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8032A9AC 0000001C  40 80 00 48 */	bge lbl_8032A9F4
/* 8032A9B0 00000020  80 C3 00 2C */	lwz r6, 0x2c(r3)
/* 8032A9B4 00000024  A0 04 00 02 */	lhz r0, 2(r4)
/* 8032A9B8 00000028  7C 06 00 AE */	lbzx r0, r6, r0
/* 8032A9BC 0000002C  98 05 00 00 */	stb r0, 0(r5)
/* 8032A9C0 00000030  80 C3 00 30 */	lwz r6, 0x30(r3)
/* 8032A9C4 00000034  A0 04 00 06 */	lhz r0, 6(r4)
/* 8032A9C8 00000038  7C 06 00 AE */	lbzx r0, r6, r0
/* 8032A9CC 0000003C  98 05 00 01 */	stb r0, 1(r5)
/* 8032A9D0 00000040  80 C3 00 34 */	lwz r6, 0x34(r3)
/* 8032A9D4 00000044  A0 04 00 0A */	lhz r0, 0xa(r4)
/* 8032A9D8 00000048  7C 06 00 AE */	lbzx r0, r6, r0
/* 8032A9DC 0000004C  98 05 00 02 */	stb r0, 2(r5)
/* 8032A9E0 00000050  80 63 00 38 */	lwz r3, 0x38(r3)
/* 8032A9E4 00000054  A0 04 00 0E */	lhz r0, 0xe(r4)
/* 8032A9E8 00000058  7C 03 00 AE */	lbzx r0, r3, r0
/* 8032A9EC 0000005C  98 05 00 03 */	stb r0, 3(r5)
/* 8032A9F0 00000060  48 00 01 08 */	b lbl_8032AAF8
lbl_8032A9F4:

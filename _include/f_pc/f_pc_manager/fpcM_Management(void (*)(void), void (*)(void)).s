...
/* 80022174 0000001C  48 24 EC D9 */	bl MtxInit(void)
...
/* 80022198 00000040  88 0D 87 B9 */	lbz r0, merged_80450D38+1(r13)
...
/* 800221A8 00000050  98 0D 87 B8 */	stb r0, merged_80450D38+0(r13)
/* 800221AC 00000054  38 00 00 01 */	li r0, 1
/* 800221B0 00000058  98 0D 87 B9 */	stb r0, merged_80450D38+1(r13)
lbl_800221B4:
...
/* 800221C0 0000000C  88 0D 87 B8 */	lbz r0, merged_80450D38+0(r13)
...
/* 800221E0 0000002C  98 0D 87 B8 */	stb r0, merged_80450D38+0(r13)
lbl_800221E4:
/* 800221E4 00000000  48 24 10 E5 */	bl cAPIGph_Painter(void)
...
/* 800221F4 00000010  4B FF EE E1 */	bl fpcDt_Handler(void)
...
lbl_80022204:
/* 80022204 00000000  48 00 12 25 */	bl fpcPi_Handler(void)
/* 80022208 00000004  4B FF ED 09 */	bl fpcCt_Handler(void)
...
lbl_80022220:
/* 80022220 00000000  3C 60 80 02 */	lis r3, fpcM_Execute(void*)@ha
/* 80022224 00000004  38 63 20 F8 */	addi r3, r3, fpcM_Execute(void*)@l
/* 80022228 00000008  4B FF F3 41 */	bl fpcEx_Handler(int (*)(void*, void*))
/* 8002222C 0000000C  3C 60 80 02 */	lis r3, fpcM_DrawIterater(int (*)(void*, void*))@ha
/* 80022230 00000010  38 63 20 C0 */	addi r3, r3, fpcM_DrawIterater(int (*)(void*, void*))@l
/* 80022234 00000014  3C 80 80 02 */	lis r4, fpcM_Draw(void*)@ha
/* 80022238 00000018  38 84 20 A0 */	addi r4, r4, fpcM_Draw(void*)@l
/* 8002223C 0000001C  48 00 17 B9 */	bl fpcDw_Handler(int (*)(int (*)(void*, void*)), int (*)(void*, void*))
...
lbl_80022268:
/* 80022268 00000000  88 0D 87 B8 */	lbz r0, merged_80450D38+0(r13)
...
/* 8002229C 00000034  98 0D 87 B8 */	stb r0, merged_80450D38+0(r13)
lbl_800222A0:

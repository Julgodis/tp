...
/* 80020DE0 00000030  48 00 00 A5 */	bl fpcCtTg_Init(create_tag*, void*)
/* 80020DE4 00000034  38 7F 00 18 */	addi r3, r31, 0x18
/* 80020DE8 00000038  3C 80 80 02 */	lis r4, fpcCtRq_Cancel(create_request*)@ha
/* 80020DEC 0000003C  38 84 0C 14 */	addi r4, r4, fpcCtRq_Cancel(create_request*)@l
/* 80020DF0 00000040  7F E5 FB 78 */	mr r5, r31
/* 80020DF4 00000044  48 00 2A 05 */	bl fpcMtdTg_Init(process_method_tag_class*, int (*)(void*), void*)
/* 80020DF8 00000048  93 BF 00 44 */	stw r29, 0x44(r31)
/* 80020DFC 0000004C  93 DF 00 34 */	stw r30, 0x34(r31)
/* 80020E00 00000050  4B FF F8 9D */	bl fpcBs_MakeOfId(void)
...
/* 80020E18 00000068  4B FF FD 45 */	bl fpcCtRq_ToCreateQ(create_request*)
lbl_80020E1C:

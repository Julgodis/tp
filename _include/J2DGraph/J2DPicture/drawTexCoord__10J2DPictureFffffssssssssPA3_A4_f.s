...
/* 802FE39C 0000001C  DB A1 00 90 */	stfd f29, 0x90(r1)
/* 802FE3A0 00000020  F3 A1 00 98 */	psq_st f29, 152(r1), 0, 0 /* qr0 */
/* 802FE3A4 00000024  DB 81 00 80 */	stfd f28, 0x80(r1)
/* 802FE3A8 00000028  F3 81 00 88 */	psq_st f28, 136(r1), 0, 0 /* qr0 */
/* 802FE3AC 0000002C  39 61 00 80 */	addi r11, r1, 0x80
/* 802FE3B0 00000030  48 06 3E 0D */	bl _savegpr_21
/* 802FE3B4 00000034  7C 75 1B 78 */	mr r21, r3
/* 802FE3B8 00000038  FF 80 08 90 */	fmr f28, f1
/* 802FE3BC 0000003C  FF A0 10 90 */	fmr f29, f2
/* 802FE3C0 00000040  FF E0 18 90 */	fmr f31, f3
/* 802FE3C4 00000044  FF C0 20 90 */	fmr f30, f4
/* 802FE3C8 00000048  7C 96 23 78 */	mr r22, r4
/* 802FE3CC 0000004C  7C B7 2B 78 */	mr r23, r5
/* 802FE3D0 00000050  7C D8 33 78 */	mr r24, r6
/* 802FE3D4 00000054  7C F9 3B 78 */	mr r25, r7
/* 802FE3D8 00000058  7D 1A 43 78 */	mr r26, r8
/* 802FE3DC 0000005C  7D 3B 4B 78 */	mr r27, r9
/* 802FE3E0 00000060  7D 5C 53 78 */	mr r28, r10
/* 802FE3E4 00000064  AB A1 00 CA */	lha r29, 0xca(r1)
/* 802FE3E8 00000068  83 C1 00 CC */	lwz r30, 0xcc(r1)
/* 802FE3EC 0000006C  88 03 01 08 */	lbz r0, 0x108(r3)
/* 802FE3F0 00000070  28 00 00 00 */	cmplwi r0, 0
/* 802FE3F4 00000074  41 82 01 A4 */	beq lbl_802FE598
/* 802FE3F8 00000078  3B E0 00 00 */	li r31, 0
/* 802FE3FC 0000007C  48 00 00 20 */	b lbl_802FE41C
lbl_802FE400:
...
/* 802FE4E4 000000C8  3C 60 CC 01 */	lis r3, 0xCC01 /* CC008000@ha */
...
/* 802FE59C 00000004  CB E1 00 B0 */	lfd f31, 0xb0(r1)
/* 802FE5A0 00000008  E3 C1 00 A8 */	psq_l f30, 168(r1), 0, 0 /* qr0 */
/* 802FE5A4 0000000C  CB C1 00 A0 */	lfd f30, 0xa0(r1)
/* 802FE5A8 00000010  E3 A1 00 98 */	psq_l f29, 152(r1), 0, 0 /* qr0 */
/* 802FE5AC 00000014  CB A1 00 90 */	lfd f29, 0x90(r1)
/* 802FE5B0 00000018  E3 81 00 88 */	psq_l f28, 136(r1), 0, 0 /* qr0 */
/* 802FE5B4 0000001C  CB 81 00 80 */	lfd f28, 0x80(r1)
/* 802FE5B8 00000020  39 61 00 80 */	addi r11, r1, 0x80
/* 802FE5BC 00000024  48 06 3C 4D */	bl _restgpr_21
/* 802FE5C0 00000028  80 01 00 C4 */	lwz r0, 0xc4(r1)
/* 802FE5C4 0000002C  7C 08 03 A6 */	mtlr r0
/* 802FE5C8 00000030  38 21 00 C0 */	addi r1, r1, 0xc0
/* 802FE5CC 00000034  4E 80 00 20 */	blr 

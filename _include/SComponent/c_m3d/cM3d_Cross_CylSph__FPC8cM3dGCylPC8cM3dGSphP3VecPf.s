...
/* 8026BA9C 00000054  40 81 00 58 */	ble lbl_8026BAF4
/* 8026BAA0 00000058  FC 00 08 34 */	frsqrte f0, f1
/* 8026BAA4 0000005C  C8 82 B7 20 */	lfd f4, c_m3d__LIT_2257(r2)
/* 8026BAA8 00000060  FC 44 00 32 */	fmul f2, f4, f0
/* 8026BAAC 00000064  C8 62 B7 28 */	lfd f3, c_m3d__LIT_2258(r2)
/* 8026BAB0 00000068  FC 00 00 32 */	fmul f0, f0, f0
/* 8026BAB4 0000006C  FC 01 00 32 */	fmul f0, f1, f0
/* 8026BAB8 00000070  FC 03 00 28 */	fsub f0, f3, f0
/* 8026BABC 00000074  FC 02 00 32 */	fmul f0, f2, f0
/* 8026BAC0 00000078  FC 44 00 32 */	fmul f2, f4, f0
/* 8026BAC4 0000007C  FC 00 00 32 */	fmul f0, f0, f0
/* 8026BAC8 00000080  FC 01 00 32 */	fmul f0, f1, f0
/* 8026BACC 00000084  FC 03 00 28 */	fsub f0, f3, f0
/* 8026BAD0 00000088  FC 02 00 32 */	fmul f0, f2, f0
/* 8026BAD4 0000008C  FC 44 00 32 */	fmul f2, f4, f0
/* 8026BAD8 00000090  FC 00 00 32 */	fmul f0, f0, f0
/* 8026BADC 00000094  FC 01 00 32 */	fmul f0, f1, f0
/* 8026BAE0 00000098  FC 03 00 28 */	fsub f0, f3, f0
/* 8026BAE4 0000009C  FC 02 00 32 */	fmul f0, f2, f0
/* 8026BAE8 000000A0  FC 21 00 32 */	fmul f1, f1, f0
/* 8026BAEC 000000A4  FC 20 08 18 */	frsp f1, f1
/* 8026BAF0 000000A8  48 00 00 88 */	b lbl_8026BB78
lbl_8026BAF4:
/* 8026BAF4 00000000  C8 02 B7 30 */	lfd f0, c_m3d__LIT_2259(r2)
/* 8026BAF8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8026BAFC 00000008  40 80 00 10 */	bge lbl_8026BB0C
/* 8026BB00 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8026BB04 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
/* 8026BB08 00000014  48 00 00 70 */	b lbl_8026BB78
lbl_8026BB0C:
...
/* 8026BB7C 00000004  40 80 00 0C */	bge lbl_8026BB88
/* 8026BB80 00000008  38 60 00 00 */	li r3, 0
/* 8026BB84 0000000C  48 00 00 D8 */	b lbl_8026BC5C
lbl_8026BB88:
...
/* 8026BB9C 00000014  4C 41 13 82 */	cror 2, 1, 2
/* 8026BBA0 00000018  40 82 00 B8 */	bne lbl_8026BC58
/* 8026BBA4 0000001C  EC 44 10 28 */	fsubs f2, f4, f2
/* 8026BBA8 00000020  C0 1E 00 10 */	lfs f0, 0x10(r30)
/* 8026BBAC 00000024  EC 03 00 2A */	fadds f0, f3, f0
/* 8026BBB0 00000028  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8026BBB4 0000002C  4C 40 13 82 */	cror 2, 0, 2
/* 8026BBB8 00000030  40 82 00 A0 */	bne lbl_8026BC58
/* 8026BBBC 00000034  EC 1F 08 28 */	fsubs f0, f31, f1
/* 8026BBC0 00000038  D0 1D 00 00 */	stfs f0, 0(r29)
/* 8026BBC4 0000003C  FC 00 0A 10 */	fabs f0, f1
/* 8026BBC8 00000040  FC 40 00 18 */	frsp f2, f0
/* 8026BBCC 00000044  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)
/* 8026BBD0 00000048  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8026BBD4 0000004C  41 80 00 68 */	blt lbl_8026BC3C
/* 8026BBD8 00000050  C0 1E 00 0C */	lfs f0, 0xc(r30)
/* 8026BBDC 00000054  EF E0 08 24 */	fdivs f31, f0, f1
/* 8026BBE0 00000058  C0 02 B7 38 */	lfs f0, LIT_2273(r2)
/* 8026BBE4 0000005C  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 8026BBE8 00000060  4C 40 13 82 */	cror 2, 0, 2
/* 8026BBEC 00000064  40 82 00 38 */	bne lbl_8026BC24
/* 8026BBF0 00000068  7F E3 FB 78 */	mr r3, r31
/* 8026BBF4 0000006C  7F C4 F3 78 */	mr r4, r30
/* 8026BBF8 00000070  38 A1 00 0C */	addi r5, r1, 0xc
/* 8026BBFC 00000074  48 0D B4 B9 */	bl PSVECSubtract
/* 8026BC00 00000078  38 61 00 0C */	addi r3, r1, 0xc
/* 8026BC04 0000007C  7C 64 1B 78 */	mr r4, r3
/* 8026BC08 00000080  FC 20 F8 90 */	fmr f1, f31
/* 8026BC0C 00000084  48 0D B4 CD */	bl PSVECScale
/* 8026BC10 00000088  38 61 00 0C */	addi r3, r1, 0xc
/* 8026BC14 0000008C  7F C4 F3 78 */	mr r4, r30
/* 8026BC18 00000090  7F 85 E3 78 */	mr r5, r28
/* 8026BC1C 00000094  48 0D B4 75 */	bl PSVECAdd
/* 8026BC20 00000098  48 00 00 30 */	b lbl_8026BC50
lbl_8026BC24:
...
/* 8026BC60 00000004  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 8026BC64 00000008  39 61 00 30 */	addi r11, r1, 0x30
/* 8026BC68 0000000C  48 0F 65 BD */	bl _restgpr_28
/* 8026BC6C 00000010  80 01 00 44 */	lwz r0, 0x44(r1)
/* 8026BC70 00000014  7C 08 03 A6 */	mtlr r0
/* 8026BC74 00000018  38 21 00 40 */	addi r1, r1, 0x40
/* 8026BC78 0000001C  4E 80 00 20 */	blr 

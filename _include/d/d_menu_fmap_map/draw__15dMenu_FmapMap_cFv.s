...
/* 801CEEC0 0000002C  C8 42 A7 A8 */	lfd f2, d_d_menu_fmap_map__LIT_4108(r2)
...
/* 801CEEFC 00000004  C8 42 A7 A8 */	lfd f2, d_d_menu_fmap_map__LIT_4108(r2)
...
/* 801CEF34 00000004  C0 02 A7 84 */	lfs f0, d_d_menu_fmap_map__LIT_3711(r2)
...
/* 801CEF60 00000030  C8 22 A7 78 */	lfd f1, d_d_menu_fmap_map__LIT_3689(r2)
...
/* 801CEF78 00000048  C8 22 A7 A8 */	lfd f1, d_d_menu_fmap_map__LIT_4108(r2)
...
/* 801CEF94 00000064  C0 42 A7 98 */	lfs f2, d_d_menu_fmap_map__LIT_4104(r2)
/* 801CEF98 00000068  C0 02 A7 9C */	lfs f0, d_d_menu_fmap_map__LIT_4105(r2)
/* 801CEF9C 0000006C  EC 20 00 72 */	fmuls f1, f0, f1
/* 801CEFA0 00000070  C0 02 A7 A0 */	lfs f0, d_d_menu_fmap_map__LIT_4106(r2)
...
/* 801CF00C 000000DC  C8 22 A7 78 */	lfd f1, d_d_menu_fmap_map__LIT_3689(r2)
...
/* 801CF024 000000F4  C8 22 A7 A8 */	lfd f1, d_d_menu_fmap_map__LIT_4108(r2)
...
/* 801CF048 00000118  C0 42 A7 98 */	lfs f2, d_d_menu_fmap_map__LIT_4104(r2)
/* 801CF04C 0000011C  C0 02 A7 9C */	lfs f0, d_d_menu_fmap_map__LIT_4105(r2)
/* 801CF050 00000120  EC 20 00 72 */	fmuls f1, f0, f1
/* 801CF054 00000124  C0 02 A7 A0 */	lfs f0, d_d_menu_fmap_map__LIT_4106(r2)

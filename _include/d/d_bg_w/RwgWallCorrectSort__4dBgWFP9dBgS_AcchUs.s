...
/* 8007C51C 00000050  C0 02 8C F8 */	lfs f0, d_d_bg_w__LIT_3717(r2)
/* 8007C520 00000054  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 8007C524 00000058  40 81 00 0C */	ble lbl_8007C530
/* 8007C528 0000005C  FC 00 10 34 */	frsqrte f0, f2
/* 8007C52C 00000060  EC 40 00 B2 */	fmuls f2, f0, f2
lbl_8007C530:
...
/* 8007C540 00000010  40 80 00 18 */	bge lbl_8007C558
/* 8007C544 00000014  7C 1E FA 2E */	lhzx r0, r30, r31
/* 8007C548 00000018  28 00 FF FF */	cmplwi r0, 0xffff
/* 8007C54C 0000001C  41 82 01 B0 */	beq lbl_8007C6FC
/* 8007C550 00000020  7C 1D 03 78 */	mr r29, r0
/* 8007C554 00000024  4B FF FF 78 */	b lbl_8007C4CC
lbl_8007C558:
...
/* 8007C580 00000028  C0 02 8D 04 */	lfs f0, d_d_bg_w__LIT_3937(r2)
...
/* 8007C5BC 00000064  3C 60 80 42 */	lis r3, d_d_bg_w__l_wcsbuf@ha
/* 8007C5C0 00000068  38 03 4B 80 */	addi r0, r3, d_d_bg_w__l_wcsbuf@l
...
/* 8007C600 00000018  40 81 00 3C */	ble lbl_8007C63C
/* 8007C604 0000001C  80 CD 8A 04 */	lwz r6, l_wcsbuf_num(r13)
/* 8007C608 00000020  2C 06 00 54 */	cmpwi r6, 0x54
/* 8007C60C 00000024  40 80 00 DC */	bge lbl_8007C6E8
/* 8007C610 00000028  1C 86 00 0C */	mulli r4, r6, 0xc
/* 8007C614 0000002C  3C 60 80 42 */	lis r3, d_d_bg_w__l_wcsbuf@ha
/* 8007C618 00000030  38 03 4B 80 */	addi r0, r3, d_d_bg_w__l_wcsbuf@l
/* 8007C61C 00000034  7C 60 22 14 */	add r3, r0, r4
/* 8007C620 00000038  D0 23 00 00 */	stfs f1, 0(r3)
/* 8007C624 0000003C  B3 A3 00 04 */	sth r29, 4(r3)
/* 8007C628 00000040  90 A3 00 08 */	stw r5, 8(r3)
/* 8007C62C 00000044  90 6D 8A 00 */	stw r3, l_start(r13)
/* 8007C630 00000048  38 06 00 01 */	addi r0, r6, 1
/* 8007C634 0000004C  90 0D 8A 04 */	stw r0, l_wcsbuf_num(r13)
/* 8007C638 00000050  48 00 00 B0 */	b lbl_8007C6E8
lbl_8007C63C:
...
/* 8007C658 0000001C  3C 60 80 42 */	lis r3, d_d_bg_w__l_wcsbuf@ha
/* 8007C65C 00000020  38 03 4B 80 */	addi r0, r3, d_d_bg_w__l_wcsbuf@l
...
/* 8007C69C 00000014  40 81 00 44 */	ble lbl_8007C6E0
/* 8007C6A0 00000018  80 0D 8A 04 */	lwz r0, l_wcsbuf_num(r13)
/* 8007C6A4 0000001C  2C 00 00 54 */	cmpwi r0, 0x54
/* 8007C6A8 00000020  40 80 00 40 */	bge lbl_8007C6E8
/* 8007C6AC 00000024  1C 80 00 0C */	mulli r4, r0, 0xc
/* 8007C6B0 00000028  3C 60 80 42 */	lis r3, d_d_bg_w__l_wcsbuf@ha
/* 8007C6B4 0000002C  38 03 4B 80 */	addi r0, r3, d_d_bg_w__l_wcsbuf@l
/* 8007C6B8 00000030  7C 60 22 14 */	add r3, r0, r4
/* 8007C6BC 00000034  D0 23 00 00 */	stfs f1, 0(r3)
/* 8007C6C0 00000038  B3 A3 00 04 */	sth r29, 4(r3)
/* 8007C6C4 0000003C  80 05 00 08 */	lwz r0, 8(r5)
/* 8007C6C8 00000040  90 03 00 08 */	stw r0, 8(r3)
/* 8007C6CC 00000044  90 65 00 08 */	stw r3, 8(r5)
/* 8007C6D0 00000048  80 6D 8A 04 */	lwz r3, l_wcsbuf_num(r13)
/* 8007C6D4 0000004C  38 03 00 01 */	addi r0, r3, 1
/* 8007C6D8 00000050  90 0D 8A 04 */	stw r0, l_wcsbuf_num(r13)
/* 8007C6DC 00000054  48 00 00 0C */	b lbl_8007C6E8
lbl_8007C6E0:

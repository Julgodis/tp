...
/* 8022089C 00000014  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 802208A0 00000018  F3 C1 00 58 */	psq_st f30, 88(r1), 0, 0 /* qr0 */
/* 802208A4 0000001C  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 802208A8 00000020  F3 A1 00 48 */	psq_st f29, 72(r1), 0, 0 /* qr0 */
/* 802208AC 00000024  DB 81 00 30 */	stfd f28, 0x30(r1)
/* 802208B0 00000028  F3 81 00 38 */	psq_st f28, 56(r1), 0, 0 /* qr0 */
/* 802208B4 0000002C  39 61 00 30 */	addi r11, r1, 0x30
/* 802208B8 00000030  48 14 19 1D */	bl _savegpr_27
/* 802208BC 00000034  7C 7B 1B 78 */	mr r27, r3
/* 802208C0 00000038  3B A0 00 00 */	li r29, 0
/* 802208C4 0000003C  3B 80 00 00 */	li r28, 0
/* 802208C8 00000040  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 802208CC 00000044  38 63 EB C8 */	addi r3, r3, g_drawHIO@l
/* 802208D0 00000048  88 03 0F 24 */	lbz r0, 0xf24(r3)
/* 802208D4 0000004C  28 00 00 00 */	cmplwi r0, 0
/* 802208D8 00000050  41 82 00 34 */	beq lbl_8022090C
/* 802208DC 00000054  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 802208E0 00000058  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 802208E4 0000005C  38 64 01 14 */	addi r3, r4, 0x114
/* 802208E8 00000060  88 84 4E 0C */	lbz r4, 0x4e0c(r4)
/* 802208EC 00000064  4B E1 3A 55 */	bl getLightDropNum__16dSv_light_drop_cCFUc
/* 802208F0 00000068  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 802208F4 0000006C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 802208F8 00000070  88 84 5E A1 */	lbz r4, 0x5ea1(r4)
/* 802208FC 00000074  54 60 06 3E */	clrlwi r0, r3, 0x18
/* 80220900 00000078  7C 04 00 40 */	cmplw r4, r0
/* 80220904 0000007C  40 82 00 08 */	bne lbl_8022090C
/* 80220908 00000080  3B 80 00 02 */	li r28, 2
lbl_8022090C:
...
/* 80220978 0000006C  C0 22 AF CC */	lfs f1, d_d_meter2__LIT_4663(r2)
/* 8022097C 00000070  FC 40 08 90 */	fmr f2, f1
/* 80220980 00000074  C0 62 AF D0 */	lfs f3, d_d_meter2__LIT_4837(r2)
...
/* 802209D0 0000003C  C0 22 AF CC */	lfs f1, d_d_meter2__LIT_4663(r2)
/* 802209D4 00000040  FC 40 08 90 */	fmr f2, f1
/* 802209D8 00000044  C0 62 AF D0 */	lfs f3, d_d_meter2__LIT_4837(r2)
...
/* 80220AC4 00000014  C0 42 AF CC */	lfs f2, d_d_meter2__LIT_4663(r2)
...
/* 80220AEC 0000003C  40 80 00 08 */	bge lbl_80220AF4
/* 80220AF0 00000040  D3 BB 04 20 */	stfs f29, 0x420(r27)
lbl_80220AF4:
...
/* 80220B08 00000014  C0 42 AF CC */	lfs f2, d_d_meter2__LIT_4663(r2)
...
/* 80220B30 0000003C  40 80 00 08 */	bge lbl_80220B38
/* 80220B34 00000040  D3 9B 04 24 */	stfs f28, 0x424(r27)
lbl_80220B38:
...
/* 80220B50 00000018  C0 62 AF CC */	lfs f3, d_d_meter2__LIT_4663(r2)
...
/* 80220B74 0000003C  40 80 00 08 */	bge lbl_80220B7C
/* 80220B78 00000040  D3 FB 04 28 */	stfs f31, 0x428(r27)
lbl_80220B7C:
...
/* 80220B94 00000018  C0 62 AF CC */	lfs f3, d_d_meter2__LIT_4663(r2)
...
/* 80220BB8 0000003C  40 80 00 08 */	bge lbl_80220BC0
/* 80220BBC 00000040  D3 DB 04 2C */	stfs f30, 0x42c(r27)
lbl_80220BC0:
...
/* 80220BFC 0000000C  CB E1 00 60 */	lfd f31, 0x60(r1)
/* 80220C00 00000010  E3 C1 00 58 */	psq_l f30, 88(r1), 0, 0 /* qr0 */
/* 80220C04 00000014  CB C1 00 50 */	lfd f30, 0x50(r1)
/* 80220C08 00000018  E3 A1 00 48 */	psq_l f29, 72(r1), 0, 0 /* qr0 */
/* 80220C0C 0000001C  CB A1 00 40 */	lfd f29, 0x40(r1)
/* 80220C10 00000020  E3 81 00 38 */	psq_l f28, 56(r1), 0, 0 /* qr0 */
/* 80220C14 00000024  CB 81 00 30 */	lfd f28, 0x30(r1)
/* 80220C18 00000028  39 61 00 30 */	addi r11, r1, 0x30
/* 80220C1C 0000002C  48 14 16 05 */	bl _restgpr_27
/* 80220C20 00000030  80 01 00 74 */	lwz r0, 0x74(r1)
/* 80220C24 00000034  7C 08 03 A6 */	mtlr r0
/* 80220C28 00000038  38 21 00 70 */	addi r1, r1, 0x70
/* 80220C2C 0000003C  4E 80 00 20 */	blr 

...
/* 8023DEA0 00000014  DB C1 00 70 */	stfd f30, 0x70(r1)
/* 8023DEA4 00000018  F3 C1 00 78 */	psq_st f30, 120(r1), 0, 0 /* qr0 */
/* 8023DEA8 0000001C  DB A1 00 60 */	stfd f29, 0x60(r1)
/* 8023DEAC 00000020  F3 A1 00 68 */	psq_st f29, 104(r1), 0, 0 /* qr0 */
/* 8023DEB0 00000024  93 E1 00 5C */	stw r31, 0x5c(r1)
/* 8023DEB4 00000028  7C 7F 1B 78 */	mr r31, r3
/* 8023DEB8 0000002C  38 00 00 00 */	li r0, 0
/* 8023DEBC 00000030  98 01 00 10 */	stb r0, 0x10(r1)
/* 8023DEC0 00000034  98 01 00 08 */	stb r0, 8(r1)
/* 8023DEC4 00000038  98 01 00 2C */	stb r0, 0x2c(r1)
/* 8023DEC8 0000003C  98 01 00 19 */	stb r0, 0x19(r1)
/* 8023DECC 00000040  88 03 00 66 */	lbz r0, 0x66(r3)
/* 8023DED0 00000044  28 00 00 04 */	cmplwi r0, 4
/* 8023DED4 00000048  40 82 00 38 */	bne lbl_8023DF0C
/* 8023DED8 0000004C  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 8023DEDC 00000050  38 63 01 88 */	addi r3, r3, g_meter2_info@l
/* 8023DEE0 00000054  38 80 04 B0 */	li r4, 0x4b0
/* 8023DEE4 00000058  38 A1 00 10 */	addi r5, r1, 0x10
/* 8023DEE8 0000005C  38 C0 00 00 */	li r6, 0
/* 8023DEEC 00000060  4B FD E3 65 */	bl getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c
/* 8023DEF0 00000064  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 8023DEF4 00000068  38 63 01 88 */	addi r3, r3, g_meter2_info@l
/* 8023DEF8 0000006C  38 80 04 B1 */	li r4, 0x4b1
/* 8023DEFC 00000070  38 A1 00 08 */	addi r5, r1, 8
/* 8023DF00 00000074  38 C0 00 00 */	li r6, 0
/* 8023DF04 00000078  4B FD E3 4D */	bl getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c
/* 8023DF08 0000007C  48 00 00 34 */	b lbl_8023DF3C
lbl_8023DF0C:
...
/* 8023DFB8 0000007C  40 80 00 0C */	bge lbl_8023DFC4
/* 8023DFBC 00000080  FF E0 F0 90 */	fmr f31, f30
/* 8023DFC0 00000084  48 00 00 08 */	b lbl_8023DFC8
lbl_8023DFC4:
...
/* 8023DFD4 0000000C  40 80 00 10 */	bge lbl_8023DFE4
/* 8023DFD8 00000010  80 7F 00 38 */	lwz r3, 0x38(r31)
/* 8023DFDC 00000014  4B FF C9 59 */	bl getTextBoxWidth__17dMsgScrn3Select_cFv
/* 8023DFE0 00000018  FF E0 08 90 */	fmr f31, f1
lbl_8023DFE4:
/* 8023DFE4 00000000  38 61 00 2C */	addi r3, r1, 0x2c
/* 8023DFE8 00000004  38 80 00 14 */	li r4, 0x14
/* 8023DFEC 00000008  3C A0 80 3A */	lis r5, d_d_msg_scrn_explain__stringBase0@ha
/* 8023DFF0 0000000C  38 A5 99 10 */	addi r5, r5, d_d_msg_scrn_explain__stringBase0@l
/* 8023DFF4 00000010  38 A5 00 74 */	addi r5, r5, 0x74
/* 8023DFF8 00000014  C0 22 B1 E8 */	lfs f1, d_d_msg_scrn_explain__LIT_4294(r2)
...
/* 8023E02C 00000048  3C A0 80 3A */	lis r5, d_d_msg_scrn_explain__stringBase0@ha
/* 8023E030 0000004C  38 A5 99 10 */	addi r5, r5, d_d_msg_scrn_explain__stringBase0@l
/* 8023E034 00000050  38 A5 00 74 */	addi r5, r5, 0x74
/* 8023E038 00000054  C0 22 B1 E8 */	lfs f1, d_d_msg_scrn_explain__LIT_4294(r2)
...
/* 8023E068 00000084  3C 80 80 3A */	lis r4, d_d_msg_scrn_explain__stringBase0@ha
/* 8023E06C 00000088  38 84 99 10 */	addi r4, r4, d_d_msg_scrn_explain__stringBase0@l
...
/* 8023E084 000000A0  3C 80 80 3A */	lis r4, d_d_msg_scrn_explain__stringBase0@ha
/* 8023E088 000000A4  38 84 99 10 */	addi r4, r4, d_d_msg_scrn_explain__stringBase0@l
...
/* 8023E0CC 000000E8  CB E1 00 80 */	lfd f31, 0x80(r1)
/* 8023E0D0 000000EC  E3 C1 00 78 */	psq_l f30, 120(r1), 0, 0 /* qr0 */
/* 8023E0D4 000000F0  CB C1 00 70 */	lfd f30, 0x70(r1)
/* 8023E0D8 000000F4  E3 A1 00 68 */	psq_l f29, 104(r1), 0, 0 /* qr0 */
/* 8023E0DC 000000F8  CB A1 00 60 */	lfd f29, 0x60(r1)
/* 8023E0E0 000000FC  83 E1 00 5C */	lwz r31, 0x5c(r1)
/* 8023E0E4 00000100  80 01 00 94 */	lwz r0, 0x94(r1)
/* 8023E0E8 00000104  7C 08 03 A6 */	mtlr r0
/* 8023E0EC 00000108  38 21 00 90 */	addi r1, r1, 0x90
/* 8023E0F0 0000010C  4E 80 00 20 */	blr 

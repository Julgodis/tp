...
/* 80026D54 0000001C  48 00 86 E1 */	bl dComIfG_getStageRes(const s8*)
...
/* 80026D64 0000002C  4B FF FD F5 */	bl dStage_dt_c_stageLoader(void*, dStage_dt_c*)
...
/* 80026D74 0000003C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)
/* 80026D78 00000040  7C 03 07 75 */	extsb. r3, r0
/* 80026D7C 00000044  41 80 00 08 */	blt lbl_80026D84
/* 80026D80 00000048  4B FF DF 91 */	bl dStage_roomInit(int)
lbl_80026D84:
...
/* 80026D90 0000000C  4B FF FB 09 */	bl dKankyo_create(void)
...
/* 80026DA0 0000001C  48 00 86 95 */	bl dComIfG_getStageRes(const s8*)
...
/* 80026DC0 0000003C  4B FF CF D5 */	bl fpcSCtRq_Request(layer_class*, s16, int (*)(void*, void*), void*, void*)
...
/* 80026DD8 00000054  4B FF CF BD */	bl fpcSCtRq_Request(layer_class*, s16, int (*)(void*, void*), void*, void*)
lbl_80026DDC:

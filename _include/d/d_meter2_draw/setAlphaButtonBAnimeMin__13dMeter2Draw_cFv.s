...
/* 80219338 00000014  39 61 00 20 */	addi r11, r1, 0x20
/* 8021933C 00000018  48 14 8E 99 */	bl _savegpr_27
/* 80219340 0000001C  7C 7B 1B 78 */	mr r27, r3
/* 80219344 00000020  80 63 03 04 */	lwz r3, 0x304(r3)
/* 80219348 00000024  48 03 C4 E1 */	bl getAlphaRate__13CPaneMgrAlphaFv
/* 8021934C 00000028  C0 02 AE 80 */	lfs f0, d_d_meter2_draw__LIT_4182(r2)
/* 80219350 0000002C  FC 00 08 00 */	fcmpu cr0, f0, f1
/* 80219354 00000030  41 82 00 64 */	beq lbl_802193B8
/* 80219358 00000034  80 7B 03 04 */	lwz r3, 0x304(r27)
/* 8021935C 00000038  3C 80 80 43 */	lis r4, g_drawHIO@ha
/* 80219360 0000003C  3B C4 EB C8 */	addi r30, r4, g_drawHIO@l
/* 80219364 00000040  C0 5E 00 F0 */	lfs f2, 0xf0(r30)
/* 80219368 00000044  C0 3E 00 18 */	lfs f1, 0x18(r30)
/* 8021936C 00000048  C0 1E 00 84 */	lfs f0, 0x84(r30)
/* 80219370 0000004C  EC 01 00 32 */	fmuls f0, f1, f0
/* 80219374 00000050  EC 22 00 32 */	fmuls f1, f2, f0
/* 80219378 00000054  48 03 C4 59 */	bl setAlphaRate__13CPaneMgrAlphaFf
/* 8021937C 00000058  7F 63 DB 78 */	mr r3, r27
/* 80219380 0000005C  80 9B 03 04 */	lwz r4, 0x304(r27)
/* 80219384 00000060  38 A0 00 05 */	li r5, 5
/* 80219388 00000064  48 00 16 41 */	bl setAlphaAnimeMin__13dMeter2Draw_cFP13CPaneMgrAlphas
/* 8021938C 00000068  80 7B 03 18 */	lwz r3, 0x318(r27)
/* 80219390 0000006C  C0 5E 00 F0 */	lfs f2, 0xf0(r30)
/* 80219394 00000070  C0 3E 00 18 */	lfs f1, 0x18(r30)
/* 80219398 00000074  C0 1E 00 84 */	lfs f0, 0x84(r30)
/* 8021939C 00000078  EC 01 00 32 */	fmuls f0, f1, f0
/* 802193A0 0000007C  EC 22 00 32 */	fmuls f1, f2, f0
/* 802193A4 00000080  48 03 C4 2D */	bl setAlphaRate__13CPaneMgrAlphaFf
/* 802193A8 00000084  7F 63 DB 78 */	mr r3, r27
/* 802193AC 00000088  80 9B 03 18 */	lwz r4, 0x318(r27)
/* 802193B0 0000008C  38 A0 00 05 */	li r5, 5
/* 802193B4 00000090  48 00 16 15 */	bl setAlphaAnimeMin__13dMeter2Draw_cFP13CPaneMgrAlphas
lbl_802193B8:
/* 802193B8 00000000  80 7B 03 28 */	lwz r3, 0x328(r27)
/* 802193BC 00000004  48 03 C4 6D */	bl getAlphaRate__13CPaneMgrAlphaFv
/* 802193C0 00000008  C0 02 AE 80 */	lfs f0, d_d_meter2_draw__LIT_4182(r2)
...
/* 80219408 00000010  C3 E2 AE 80 */	lfs f31, d_d_meter2_draw__LIT_4182(r2)
lbl_8021940C:
...
/* 80219458 00000014  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 8021945C 00000018  39 61 00 20 */	addi r11, r1, 0x20
/* 80219460 0000001C  48 14 8D C1 */	bl _restgpr_27
/* 80219464 00000020  80 01 00 34 */	lwz r0, 0x34(r1)
/* 80219468 00000024  7C 08 03 A6 */	mtlr r0
/* 8021946C 00000028  38 21 00 30 */	addi r1, r1, 0x30
/* 80219470 0000002C  4E 80 00 20 */	blr 

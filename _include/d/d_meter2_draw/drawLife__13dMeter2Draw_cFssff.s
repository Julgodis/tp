...
/* 80214A10 0000001C  39 61 00 20 */	addi r11, r1, 0x20
/* 80214A14 00000020  48 14 D7 BD */	bl _savegpr_26
/* 80214A18 00000024  7C 7F 1B 78 */	mr r31, r3
/* 80214A1C 00000028  FF C0 08 90 */	fmr f30, f1
/* 80214A20 0000002C  FF E0 10 90 */	fmr f31, f2
/* 80214A24 00000030  7C 83 07 34 */	extsh r3, r4
/* 80214A28 00000034  38 00 00 05 */	li r0, 5
/* 80214A2C 00000038  7C 03 03 D6 */	divw r0, r3, r0
/* 80214A30 0000003C  7C 1C 07 34 */	extsh r28, r0
/* 80214A34 00000040  7C A4 07 34 */	extsh r4, r5
/* 80214A38 00000044  7C 80 16 70 */	srawi r0, r4, 2
/* 80214A3C 00000048  7C 00 01 94 */	addze r0, r0
/* 80214A40 0000004C  7C 1D 07 34 */	extsh r29, r0
/* 80214A44 00000050  54 80 F0 02 */	slwi r0, r4, 0x1e
/* 80214A48 00000054  54 83 0F FE */	srwi r3, r4, 0x1f
/* 80214A4C 00000058  7C 03 00 50 */	subf r0, r3, r0
/* 80214A50 0000005C  54 00 10 3E */	rotlwi r0, r0, 2
/* 80214A54 00000060  7C 00 1A 14 */	add r0, r0, r3
/* 80214A58 00000064  7C 1B 07 34 */	extsh r27, r0
/* 80214A5C 00000068  57 80 10 3A */	slwi r0, r28, 2
/* 80214A60 0000006C  7C 04 00 00 */	cmpw r4, r0
/* 80214A64 00000070  40 82 00 08 */	bne lbl_80214A6C
/* 80214A68 00000074  3B 60 00 00 */	li r27, 0
lbl_80214A6C:
...
/* 80214BFC 00000044  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 80214C00 00000048  E3 C1 00 28 */	psq_l f30, 40(r1), 0, 0 /* qr0 */
/* 80214C04 0000004C  CB C1 00 20 */	lfd f30, 0x20(r1)
/* 80214C08 00000050  39 61 00 20 */	addi r11, r1, 0x20
/* 80214C0C 00000054  48 14 D6 11 */	bl _restgpr_26
/* 80214C10 00000058  80 01 00 44 */	lwz r0, 0x44(r1)
/* 80214C14 0000005C  7C 08 03 A6 */	mtlr r0
/* 80214C18 00000060  38 21 00 40 */	addi r1, r1, 0x40
/* 80214C1C 00000064  4E 80 00 20 */	blr 

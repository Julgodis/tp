...
/* 80215B34 0000001C  DB A1 00 50 */	stfd f29, 0x50(r1)
/* 80215B38 00000020  F3 A1 00 58 */	psq_st f29, 88(r1), 0, 0 /* qr0 */
/* 80215B3C 00000024  DB 81 00 40 */	stfd f28, 0x40(r1)
/* 80215B40 00000028  F3 81 00 48 */	psq_st f28, 72(r1), 0, 0 /* qr0 */
/* 80215B44 0000002C  39 61 00 40 */	addi r11, r1, 0x40
/* 80215B48 00000030  48 14 C6 85 */	bl _savegpr_25
/* 80215B4C 00000034  7C 7A 1B 78 */	mr r26, r3
/* 80215B50 00000038  FF C0 08 90 */	fmr f30, f1
/* 80215B54 0000003C  FF E0 10 90 */	fmr f31, f2
/* 80215B58 00000040  FF 80 18 90 */	fmr f28, f3
/* 80215B5C 00000044  FF A0 20 90 */	fmr f29, f4
/* 80215B60 00000048  7C DB 33 78 */	mr r27, r6
/* 80215B64 0000004C  3B 80 00 00 */	li r28, 0
/* 80215B68 00000050  3B 20 00 00 */	li r25, 0
/* 80215B6C 00000054  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 80215B70 00000058  3B E3 EB C8 */	addi r31, r3, g_drawHIO@l
/* 80215B74 0000005C  54 9D 06 3E */	clrlwi r29, r4, 0x18
lbl_80215B78:
...
/* 80215CD8 00000028  C0 22 AE 80 */	lfs f1, d_d_meter2_draw__LIT_4182(r2)
...
/* 80215CF0 00000040  C0 02 AE 98 */	lfs f0, d_d_meter2_draw__LIT_4923(r2)
...
/* 80215D10 00000018  C0 22 AE 80 */	lfs f1, d_d_meter2_draw__LIT_4182(r2)
...
/* 80215D20 00000028  C0 02 AE 98 */	lfs f0, d_d_meter2_draw__LIT_4923(r2)
...
/* 80215D70 00000048  CB E1 00 70 */	lfd f31, 0x70(r1)
/* 80215D74 0000004C  E3 C1 00 68 */	psq_l f30, 104(r1), 0, 0 /* qr0 */
/* 80215D78 00000050  CB C1 00 60 */	lfd f30, 0x60(r1)
/* 80215D7C 00000054  E3 A1 00 58 */	psq_l f29, 88(r1), 0, 0 /* qr0 */
/* 80215D80 00000058  CB A1 00 50 */	lfd f29, 0x50(r1)
/* 80215D84 0000005C  E3 81 00 48 */	psq_l f28, 72(r1), 0, 0 /* qr0 */
/* 80215D88 00000060  CB 81 00 40 */	lfd f28, 0x40(r1)
/* 80215D8C 00000064  39 61 00 40 */	addi r11, r1, 0x40
/* 80215D90 00000068  48 14 C4 89 */	bl _restgpr_25
/* 80215D94 0000006C  80 01 00 84 */	lwz r0, 0x84(r1)
/* 80215D98 00000070  7C 08 03 A6 */	mtlr r0
/* 80215D9C 00000074  38 21 00 80 */	addi r1, r1, 0x80
/* 80215DA0 00000078  4E 80 00 20 */	blr 

...
/* 80215F9C 00000014  39 61 00 50 */	addi r11, r1, 0x50
/* 80215FA0 00000018  48 14 C2 2D */	bl _savegpr_25
/* 80215FA4 0000001C  7C 7D 1B 78 */	mr r29, r3
/* 80215FA8 00000020  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 80215FAC 00000024  38 63 EB C8 */	addi r3, r3, g_drawHIO@l
/* 80215FB0 00000028  C0 23 00 18 */	lfs f1, 0x18(r3)
/* 80215FB4 0000002C  C0 1D 06 FC */	lfs f0, 0x6fc(r29)
/* 80215FB8 00000030  EF E1 00 32 */	fmuls f31, f1, f0
/* 80215FBC 00000034  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 80215FC0 00000038  38 63 01 88 */	addi r3, r3, g_meter2_info@l
/* 80215FC4 0000003C  3B C3 00 E3 */	addi r30, r3, 0xe3
/* 80215FC8 00000040  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80215FCC 00000044  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80215FD0 00000048  88 1F 4E 0C */	lbz r0, 0x4e0c(r31)
/* 80215FD4 0000004C  7C 00 07 74 */	extsb r0, r0
/* 80215FD8 00000050  7C 1E 00 AE */	lbzx r0, r30, r0
/* 80215FDC 00000054  28 00 00 01 */	cmplwi r0, 1
/* 80215FE0 00000058  40 81 01 A4 */	ble lbl_80216184
/* 80215FE4 0000005C  28 00 00 FF */	cmplwi r0, 0xff
/* 80215FE8 00000060  41 82 01 9C */	beq lbl_80216184
/* 80215FEC 00000064  80 7D 01 E0 */	lwz r3, 0x1e0(r29)
/* 80215FF0 00000068  A8 03 00 16 */	lha r0, 0x16(r3)
/* 80215FF4 0000006C  7C 00 07 35 */	extsh. r0, r0
/* 80215FF8 00000070  40 82 00 38 */	bne lbl_80216030
/* 80215FFC 00000074  38 00 00 C5 */	li r0, 0xc5
/* 80216000 00000078  90 01 00 08 */	stw r0, 8(r1)
/* 80216004 0000007C  80 6D 8D E8 */	lwz r3, mAudioMgrPtr__10Z2AudioMgr(r13)
/* 80216008 00000080  38 81 00 08 */	addi r4, r1, 8
/* 8021600C 00000084  38 A0 00 00 */	li r5, 0
/* 80216010 00000088  38 C0 00 00 */	li r6, 0
/* 80216014 0000008C  38 E0 00 00 */	li r7, 0
/* 80216018 00000090  C0 22 AE 84 */	lfs f1, d_d_meter2_draw__LIT_4183(r2)
/* 8021601C 00000094  FC 40 08 90 */	fmr f2, f1
/* 80216020 00000098  C0 62 AE B0 */	lfs f3, LIT_5786(r2)
/* 80216024 0000009C  FC 80 18 90 */	fmr f4, f3
/* 80216028 000000A0  39 00 00 00 */	li r8, 0
/* 8021602C 000000A4  48 09 59 59 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80216030:
...
/* 802160C0 0000001C  C0 82 AE 84 */	lfs f4, d_d_meter2_draw__LIT_4183(r2)
...
lbl_80216128:
/* 80216128 00000000  C0 02 AE 84 */	lfs f0, d_d_meter2_draw__LIT_4183(r2)
...
/* 80216310 00000014  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 80216314 00000018  39 61 00 50 */	addi r11, r1, 0x50
/* 80216318 0000001C  48 14 BF 01 */	bl _restgpr_25
/* 8021631C 00000020  80 01 00 64 */	lwz r0, 0x64(r1)
/* 80216320 00000024  7C 08 03 A6 */	mtlr r0
/* 80216324 00000028  38 21 00 60 */	addi r1, r1, 0x60
/* 80216328 0000002C  4E 80 00 20 */	blr 

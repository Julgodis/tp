...
/* 800C4528 00000014  93 E1 00 3C */	stw r31, 0x3c(r1)
/* 800C452C 00000018  93 C1 00 38 */	stw r30, 0x38(r1)
/* 800C4530 0000001C  7C 7E 1B 78 */	mr r30, r3
/* 800C4534 00000020  3C 80 80 3A */	lis r4, __vt__8cM3dGPla@ha
/* 800C4538 00000024  38 04 37 C0 */	addi r0, r4, __vt__8cM3dGPla@l
/* 800C453C 00000028  90 01 00 18 */	stw r0, 0x18(r1)
/* 800C4540 0000002C  38 81 00 08 */	addi r4, r1, 8
/* 800C4544 00000030  4B FE DA 95 */	bl getSlidePolygon__9daAlink_cFP8cM3dGPla
/* 800C4548 00000034  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800C454C 00000038  41 82 02 24 */	beq lbl_800C4770
/* 800C4550 0000003C  38 61 00 08 */	addi r3, r1, 8
/* 800C4554 00000040  48 1A 2B D5 */	bl atan2sX_Z__4cXyzCFv
/* 800C4558 00000044  7C 7F 1B 78 */	mr r31, r3
/* 800C455C 00000048  80 1E 31 98 */	lwz r0, 0x3198(r30)
/* 800C4560 0000004C  2C 00 00 00 */	cmpwi r0, 0
/* 800C4564 00000050  41 82 00 DC */	beq lbl_800C4640
/* 800C4568 00000054  A8 7E 04 E6 */	lha r3, 0x4e6(r30)
/* 800C456C 00000058  A8 1E 2F E2 */	lha r0, 0x2fe2(r30)
/* 800C4570 0000005C  7C 03 00 50 */	subf r0, r3, r0
/* 800C4574 00000060  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 800C4578 00000064  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 800C457C 00000068  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 800C4580 0000006C  7C 23 04 2E */	lfsx f1, r3, r0
/* 800C4584 00000070  C0 1E 33 A8 */	lfs f0, 0x33a8(r30)
/* 800C4588 00000074  EF E0 00 72 */	fmuls f31, f0, f1
/* 800C458C 00000078  C0 3E 33 AC */	lfs f1, 0x33ac(r30)
/* 800C4590 0000007C  C0 02 92 A4 */	lfs f0, LIT_6021(r2)
/* 800C4594 00000080  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800C4598 00000084  40 81 00 68 */	ble lbl_800C4600
/* 800C459C 00000088  A8 1E 30 0C */	lha r0, 0x300c(r30)
/* 800C45A0 0000008C  C8 22 92 B0 */	lfd f1, LIT_6025(r2)
/* 800C45A4 00000090  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800C45A8 00000094  90 01 00 24 */	stw r0, 0x24(r1)
/* 800C45AC 00000098  3C 00 43 30 */	lis r0, 0x4330
/* 800C45B0 0000009C  90 01 00 20 */	stw r0, 0x20(r1)
/* 800C45B4 000000A0  C8 01 00 20 */	lfd f0, 0x20(r1)
/* 800C45B8 000000A4  EC 20 08 28 */	fsubs f1, f0, f1
/* 800C45BC 000000A8  C0 02 94 FC */	lfs f0, LIT_20400(r2)
/* 800C45C0 000000AC  EC 00 07 F2 */	fmuls f0, f0, f31
/* 800C45C4 000000B0  EC 01 00 2A */	fadds f0, f1, f0
/* 800C45C8 000000B4  FC 00 00 1E */	fctiwz f0, f0
/* 800C45CC 000000B8  D8 01 00 28 */	stfd f0, 0x28(r1)
/* 800C45D0 000000BC  80 61 00 2C */	lwz r3, 0x2c(r1)
/* 800C45D4 000000C0  7C 60 07 34 */	extsh r0, r3
/* 800C45D8 000000C4  2C 00 F0 00 */	cmpwi r0, -4096
/* 800C45DC 000000C8  40 80 00 0C */	bge lbl_800C45E8
/* 800C45E0 000000CC  38 00 F0 00 */	li r0, -4096
/* 800C45E4 000000D0  48 00 00 14 */	b lbl_800C45F8
lbl_800C45E8:
...
/* 800C46B8 0000002C  40 81 00 C4 */	ble lbl_800C477C
lbl_800C46BC:
...
/* 800C4704 00000020  C0 42 92 B8 */	lfs f2, d_d_a_alink__LIT_6040(r2)
...
/* 800C4734 00000050  40 81 00 08 */	ble lbl_800C473C
/* 800C4738 00000054  D0 DE 33 98 */	stfs f6, 0x3398(r30)
lbl_800C473C:
...
/* 800C4748 0000000C  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
...
/* 800C4760 00000004  3C 80 00 03 */	lis r4, 0x0003 /* 00030017@ha */
/* 800C4764 00000008  38 84 00 17 */	addi r4, r4, 0x0017 /* 00030017@l */
...
/* 800C4790 00000014  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 800C4794 00000018  83 E1 00 3C */	lwz r31, 0x3c(r1)
/* 800C4798 0000001C  83 C1 00 38 */	lwz r30, 0x38(r1)
/* 800C479C 00000020  80 01 00 54 */	lwz r0, 0x54(r1)
/* 800C47A0 00000024  7C 08 03 A6 */	mtlr r0
/* 800C47A4 00000028  38 21 00 50 */	addi r1, r1, 0x50
/* 800C47A8 0000002C  4E 80 00 20 */	blr 

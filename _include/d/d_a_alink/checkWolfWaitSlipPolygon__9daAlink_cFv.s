...
/* 8012C090 00000048  40 80 00 18 */	bge lbl_8012C0A8
/* 8012C094 0000004C  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha
/* 8012C098 00000050  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8012C09C 00000054  90 01 00 28 */	stw r0, 0x28(r1)
/* 8012C0A0 00000058  38 60 00 01 */	li r3, 1
/* 8012C0A4 0000005C  48 00 01 38 */	b lbl_8012C1DC
lbl_8012C0A8:
...
/* 8012C0D0 00000028  40 81 00 58 */	ble lbl_8012C128
/* 8012C0D4 0000002C  FC 00 08 34 */	frsqrte f0, f1
/* 8012C0D8 00000030  C8 82 92 E8 */	lfd f4, d_d_a_alink__LIT_6846(r2)
/* 8012C0DC 00000034  FC 44 00 32 */	fmul f2, f4, f0
/* 8012C0E0 00000038  C8 62 92 F0 */	lfd f3, LIT_6847(r2)
/* 8012C0E4 0000003C  FC 00 00 32 */	fmul f0, f0, f0
/* 8012C0E8 00000040  FC 01 00 32 */	fmul f0, f1, f0
/* 8012C0EC 00000044  FC 03 00 28 */	fsub f0, f3, f0
/* 8012C0F0 00000048  FC 02 00 32 */	fmul f0, f2, f0
/* 8012C0F4 0000004C  FC 44 00 32 */	fmul f2, f4, f0
/* 8012C0F8 00000050  FC 00 00 32 */	fmul f0, f0, f0
/* 8012C0FC 00000054  FC 01 00 32 */	fmul f0, f1, f0
/* 8012C100 00000058  FC 03 00 28 */	fsub f0, f3, f0
/* 8012C104 0000005C  FC 02 00 32 */	fmul f0, f2, f0
/* 8012C108 00000060  FC 44 00 32 */	fmul f2, f4, f0
/* 8012C10C 00000064  FC 00 00 32 */	fmul f0, f0, f0
/* 8012C110 00000068  FC 01 00 32 */	fmul f0, f1, f0
/* 8012C114 0000006C  FC 03 00 28 */	fsub f0, f3, f0
/* 8012C118 00000070  FC 02 00 32 */	fmul f0, f2, f0
/* 8012C11C 00000074  FC 21 00 32 */	fmul f1, f1, f0
/* 8012C120 00000078  FC 20 08 18 */	frsp f1, f1
/* 8012C124 0000007C  48 00 00 88 */	b lbl_8012C1AC
lbl_8012C128:
/* 8012C128 00000000  C8 02 92 F8 */	lfd f0, LIT_6848(r2)
/* 8012C12C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8012C130 00000008  40 80 00 10 */	bge lbl_8012C140
/* 8012C134 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8012C138 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
/* 8012C13C 00000014  48 00 00 70 */	b lbl_8012C1AC
lbl_8012C140:

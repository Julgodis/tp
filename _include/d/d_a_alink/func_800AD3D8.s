...
/* 800AD3EC 00000014  DB C1 00 50 */	stfd f30, 0x50(r1)
/* 800AD3F0 00000018  F3 C1 00 58 */	psq_st f30, 88(r1), 0, 0 /* qr0 */
/* 800AD3F4 0000001C  DB A1 00 40 */	stfd f29, 0x40(r1)
/* 800AD3F8 00000020  F3 A1 00 48 */	psq_st f29, 72(r1), 0, 0 /* qr0 */
/* 800AD3FC 00000024  DB 81 00 30 */	stfd f28, 0x30(r1)
/* 800AD400 00000028  F3 81 00 38 */	psq_st f28, 56(r1), 0, 0 /* qr0 */
/* 800AD404 0000002C  39 61 00 30 */	addi r11, r1, 0x30
/* 800AD408 00000030  48 2B 4D C5 */	bl func_803621CC
/* 800AD40C 00000034  7C 7A 1B 78 */	mr r26, r3
/* 800AD410 00000038  7C 9B 23 78 */	mr r27, r4
/* 800AD414 0000003C  7C BC 2B 78 */	mr r28, r5
/* 800AD418 00000040  FF 80 08 90 */	fmr f28, f1
/* 800AD41C 00000044  FF A0 10 90 */	fmr f29, f2
/* 800AD420 00000048  7C DD 33 78 */	mr r29, r6
/* 800AD424 0000004C  FF C0 18 90 */	fmr f30, f3
/* 800AD428 00000050  3B E0 00 00 */	li r31, 0
/* 800AD42C 00000054  2C 1C 00 02 */	cmpwi r28, 2
/* 800AD430 00000058  40 82 00 54 */	bne lbl_800AD484
/* 800AD434 0000005C  48 00 28 89 */	bl func_800AFCBC
/* 800AD438 00000060  80 9A 05 74 */	lwz r4, 0x574(r26)
/* 800AD43C 00000064  3C 60 EB E9 */	lis r3, 0xebe9
/* 800AD440 00000068  38 03 FF B5 */	addi r0, r3, -75
/* 800AD444 0000006C  7C 80 00 38 */	and r0, r4, r0
/* 800AD448 00000070  90 1A 05 74 */	stw r0, 0x574(r26)
/* 800AD44C 00000074  7F 43 D3 78 */	mr r3, r26
/* 800AD450 00000078  38 80 00 00 */	li r4, 0
/* 800AD454 0000007C  48 00 9D 3D */	bl func_800B7190
/* 800AD458 00000080  38 60 00 00 */	li r3, 0
/* 800AD45C 00000084  A0 1A 1F BC */	lhz r0, 0x1fbc(r26)
/* 800AD460 00000088  28 00 00 62 */	cmplwi r0, 0x62
/* 800AD464 0000008C  41 82 00 10 */	beq lbl_800AD474
/* 800AD468 00000090  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 800AD46C 00000094  28 00 02 A0 */	cmplwi r0, 0x2a0
/* 800AD470 00000098  40 82 00 08 */	bne lbl_800AD478
lbl_800AD474:
...
/* 800AD4B4 00000018  4B FF 68 59 */	bl func_800A3D0C
...
/* 800AD4D8 0000000C  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
...
/* 800AD4FC 00000008  40 80 00 28 */	bge lbl_800AD524
/* 800AD500 0000000C  7F A0 07 34 */	extsh r0, r29
/* 800AD504 00000010  C8 22 92 B0 */	lfd f1, LIT_6025(r2)
/* 800AD508 00000014  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 800AD50C 00000018  90 01 00 0C */	stw r0, 0xc(r1)
/* 800AD510 0000001C  3C 00 43 30 */	lis r0, 0x4330
/* 800AD514 00000020  90 01 00 08 */	stw r0, 8(r1)
/* 800AD518 00000024  C8 01 00 08 */	lfd f0, 8(r1)
/* 800AD51C 00000028  EF E0 08 28 */	fsubs f31, f0, f1
/* 800AD520 0000002C  48 00 00 08 */	b lbl_800AD528
lbl_800AD524:
/* 800AD524 00000000  FF E0 E8 90 */	fmr f31, f29
lbl_800AD528:
/* 800AD528 00000000  7F 43 D3 78 */	mr r3, r26
/* 800AD52C 00000004  48 01 28 85 */	bl func_800BFDB0
...
/* 800AD53C 00000014  48 00 BE 05 */	bl func_800B9340
...
/* 800AD54C 00000024  48 02 39 81 */	bl func_800D0ECC
...
lbl_800AD56C:
/* 800AD56C 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800AD570 00000004  38 63 E7 F4 */	addi r3, r3, -6156
/* 800AD574 00000008  C0 43 00 28 */	lfs f2, 0x28(r3)
/* 800AD578 0000000C  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
...
/* 800AD5B8 0000002C  4B FF ED DD */	bl func_800AC394
...
/* 800AD5C8 0000003C  4B FF FD 11 */	bl func_800AD2D8
/* 800AD5CC 00000040  7F 43 D3 78 */	mr r3, r26
/* 800AD5D0 00000044  48 03 14 19 */	bl func_800DE9E8
...
/* 800AD5E0 00000054  48 03 26 91 */	bl func_800DFC70
/* 800AD5E4 00000058  7F 43 D3 78 */	mr r3, r26
/* 800AD5E8 0000005C  48 03 14 FD */	bl func_800DEAE4
lbl_800AD5EC:
/* 800AD5EC 00000000  7F 43 D3 78 */	mr r3, r26
/* 800AD5F0 00000004  48 03 66 AD */	bl func_800E3C9C
...
/* 800AD628 0000000C  48 03 75 AD */	bl func_800E4BD4
lbl_800AD62C:
...
/* 800AD664 00000018  48 08 B5 A1 */	bl func_80138C04
lbl_800AD668:
...
/* 800AD6A4 00000014  48 0B 16 59 */	bl func_8015ECFC
lbl_800AD6A8:
...
/* 800AD6BC 00000014  CB E1 00 60 */	lfd f31, 0x60(r1)
/* 800AD6C0 00000018  E3 C1 00 58 */	psq_l f30, 88(r1), 0, 0 /* qr0 */
/* 800AD6C4 0000001C  CB C1 00 50 */	lfd f30, 0x50(r1)
/* 800AD6C8 00000020  E3 A1 00 48 */	psq_l f29, 72(r1), 0, 0 /* qr0 */
/* 800AD6CC 00000024  CB A1 00 40 */	lfd f29, 0x40(r1)
/* 800AD6D0 00000028  E3 81 00 38 */	psq_l f28, 56(r1), 0, 0 /* qr0 */
/* 800AD6D4 0000002C  CB 81 00 30 */	lfd f28, 0x30(r1)
/* 800AD6D8 00000030  39 61 00 30 */	addi r11, r1, 0x30
/* 800AD6DC 00000034  48 2B 4B 3D */	bl func_80362218
/* 800AD6E0 00000038  80 01 00 74 */	lwz r0, 0x74(r1)
/* 800AD6E4 0000003C  7C 08 03 A6 */	mtlr r0
/* 800AD6E8 00000040  38 21 00 70 */	addi r1, r1, 0x70
/* 800AD6EC 00000044  4E 80 00 20 */	blr 

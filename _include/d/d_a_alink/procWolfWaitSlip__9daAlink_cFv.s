...
/* 801302A8 00000040  40 81 00 CC */	ble lbl_80130374
/* 801302AC 00000044  4B FF BC FD */	bl checkWolfWaitSlipPolygon__9daAlink_cFv
/* 801302B0 00000048  2C 03 00 00 */	cmpwi r3, 0
/* 801302B4 0000004C  41 82 00 C0 */	beq lbl_80130374
/* 801302B8 00000050  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha
/* 801302BC 00000054  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 801302C0 00000058  90 01 00 18 */	stw r0, 0x18(r1)
/* 801302C4 0000005C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 801302C8 00000060  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 801302CC 00000064  38 63 0F 38 */	addi r3, r3, 0xf38
/* 801302D0 00000068  38 9F 1A 60 */	addi r4, r31, 0x1a60
/* 801302D4 0000006C  38 A1 00 08 */	addi r5, r1, 8
/* 801302D8 00000070  4B F4 44 6D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 801302DC 00000074  38 61 00 08 */	addi r3, r1, 8
/* 801302E0 00000078  48 13 6E 49 */	bl atan2sX_Z__4cXyzCFv
/* 801302E4 0000007C  7C 7E 1B 78 */	mr r30, r3
/* 801302E8 00000080  7F E3 FB 78 */	mr r3, r31
/* 801302EC 00000084  38 9F 1A 60 */	addi r4, r31, 0x1a60
/* 801302F0 00000088  A8 BF 2F E2 */	lha r5, 0x2fe2(r31)
/* 801302F4 0000008C  4B F7 FD A5 */	bl getGroundAngle__9daAlink_cFP13cBgS_PolyInfos
/* 801302F8 00000090  7C 63 07 34 */	extsh r3, r3
/* 801302FC 00000094  A8 1F 31 22 */	lha r0, 0x3122(r31)
/* 80130300 00000098  7C 00 00 D0 */	neg r0, r0
/* 80130304 0000009C  7C 03 00 00 */	cmpw r3, r0
/* 80130308 000000A0  40 80 00 60 */	bge lbl_80130368
/* 8013030C 000000A4  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 80130310 000000A8  7C 00 F0 50 */	subf r0, r0, r30
/* 80130314 000000AC  7C 03 07 34 */	extsh r3, r0
/* 80130318 000000B0  48 23 4D B9 */	bl abs
/* 8013031C 000000B4  2C 03 60 00 */	cmpwi r3, 0x6000
/* 80130320 000000B8  41 80 00 20 */	blt lbl_80130340
/* 80130324 000000BC  7F E3 FB 78 */	mr r3, r31
/* 80130328 000000C0  38 80 00 00 */	li r4, 0
/* 8013032C 000000C4  48 00 01 15 */	bl procWolfSlopeStartInit__9daAlink_cFi
/* 80130330 000000C8  3C 80 80 3A */	lis r4, __vt__8cM3dGPla@ha
/* 80130334 000000CC  38 04 37 C0 */	addi r0, r4, __vt__8cM3dGPla@l
/* 80130338 000000D0  90 01 00 18 */	stw r0, 0x18(r1)
/* 8013033C 000000D4  48 00 00 E4 */	b lbl_80130420
lbl_80130340:
...
/* 8013039C 00000028  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
...
/* 801303BC 00000048  40 81 00 08 */	ble lbl_801303C4
/* 801303C0 0000004C  D0 3F 33 98 */	stfs f1, 0x3398(r31)
lbl_801303C4:
...
/* 80130410 0000001C  3C 80 00 03 */	lis r4, 0x0003 /* 00030018@ha */
/* 80130414 00000020  38 84 00 18 */	addi r4, r4, 0x0018 /* 00030018@l */
...
/* 80130424 00000004  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 80130428 00000008  83 E1 00 2C */	lwz r31, 0x2c(r1)
/* 8013042C 0000000C  83 C1 00 28 */	lwz r30, 0x28(r1)
/* 80130430 00000010  80 01 00 44 */	lwz r0, 0x44(r1)
/* 80130434 00000014  7C 08 03 A6 */	mtlr r0
/* 80130438 00000018  38 21 00 40 */	addi r1, r1, 0x40
/* 8013043C 0000001C  4E 80 00 20 */	blr 

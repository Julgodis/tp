...
/* 800D5C9C 00000014  93 E1 00 3C */	stw r31, 0x3c(r1)
/* 800D5CA0 00000018  93 C1 00 38 */	stw r30, 0x38(r1)
/* 800D5CA4 0000001C  7C 7F 1B 78 */	mr r31, r3
/* 800D5CA8 00000020  83 C3 27 EC */	lwz r30, 0x27ec(r3)
/* 800D5CAC 00000024  80 03 06 14 */	lwz r0, 0x614(r3)
/* 800D5CB0 00000028  28 00 00 53 */	cmplwi r0, 0x53
/* 800D5CB4 0000002C  40 82 00 20 */	bne lbl_800D5CD4
/* 800D5CB8 00000030  A0 1F 2F E8 */	lhz r0, 0x2fe8(r31)
/* 800D5CBC 00000034  28 00 00 2D */	cmplwi r0, 0x2d
/* 800D5CC0 00000038  41 82 00 0C */	beq lbl_800D5CCC
/* 800D5CC4 0000003C  28 00 00 2E */	cmplwi r0, 0x2e
/* 800D5CC8 00000040  40 82 00 0C */	bne lbl_800D5CD4
lbl_800D5CCC:
...
/* 800D5CDC 00000008  4B FE C2 91 */	bl func_800C1F6C
/* 800D5CE0 0000000C  7F E3 FB 78 */	mr r3, r31
/* 800D5CE4 00000010  38 80 00 01 */	li r4, 1
/* 800D5CE8 00000014  4B FF B7 49 */	bl func_800D1430
/* 800D5CEC 00000018  7F E3 FB 78 */	mr r3, r31
/* 800D5CF0 0000001C  38 80 00 7C */	li r4, 0x7c
/* 800D5CF4 00000020  3C A0 80 39 */	lis r5, 0x8039
/* 800D5CF8 00000024  38 A5 DD B8 */	addi r5, r5, -8776
/* 800D5CFC 00000028  4B FD 73 F9 */	bl func_800AD0F4
/* 800D5D00 0000002C  7F E3 FB 78 */	mr r3, r31
/* 800D5D04 00000030  3C 80 80 39 */	lis r4, 0x8039
/* 800D5D08 00000034  38 84 DD B8 */	addi r4, r4, -8776
...
/* 800D5D18 00000044  4B FE 5A 59 */	bl func_800BB770
...
/* 800D5D30 0000005C  48 19 0E 05 */	bl func_80266B34
...
/* 800D5D54 00000080  48 08 8F 65 */	bl func_8015ECB8
/* 800D5D58 00000084  48 00 00 40 */	b lbl_800D5D98
lbl_800D5D5C:
/* 800D5D5C 00000000  3C 60 80 44 */	lis r3, 0x8044
/* 800D5D60 00000004  38 83 9A 20 */	addi r4, r3, -26080
...
/* 800D5D94 00000038  48 08 8F 69 */	bl func_8015ECFC
lbl_800D5D98:
/* 800D5D98 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800D5D9C 00000004  38 63 DD B8 */	addi r3, r3, -8776
...
/* 800D5DB0 00000018  40 80 00 08 */	bge lbl_800D5DB8
/* 800D5DB4 0000001C  48 00 00 18 */	b lbl_800D5DCC
lbl_800D5DB8:
/* 800D5DB8 00000000  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 800D5DBC 00000004  40 81 00 0C */	ble lbl_800D5DC8
/* 800D5DC0 00000008  FC 40 08 90 */	fmr f2, f1
/* 800D5DC4 0000000C  48 00 00 08 */	b lbl_800D5DCC
lbl_800D5DC8:
...
/* 800D5DE4 00000018  40 81 00 0C */	ble lbl_800D5DF0
/* 800D5DE8 0000001C  FC 00 F8 34 */	frsqrte f0, f31
/* 800D5DEC 00000020  EF E0 07 F2 */	fmuls f31, f0, f31
lbl_800D5DF0:
...
/* 800D5E18 00000028  48 27 13 21 */	bl func_80347138
/* 800D5E1C 0000002C  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 800D5E20 00000030  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D5E24 00000034  40 81 00 58 */	ble lbl_800D5E7C
/* 800D5E28 00000038  FC 00 08 34 */	frsqrte f0, f1
/* 800D5E2C 0000003C  C8 82 92 E8 */	lfd f4, d_d_a_alink__LIT_6846(r2)
/* 800D5E30 00000040  FC 44 00 32 */	fmul f2, f4, f0
/* 800D5E34 00000044  C8 62 92 F0 */	lfd f3, LIT_6847(r2)
/* 800D5E38 00000048  FC 00 00 32 */	fmul f0, f0, f0
/* 800D5E3C 0000004C  FC 01 00 32 */	fmul f0, f1, f0
/* 800D5E40 00000050  FC 03 00 28 */	fsub f0, f3, f0
/* 800D5E44 00000054  FC 02 00 32 */	fmul f0, f2, f0
/* 800D5E48 00000058  FC 44 00 32 */	fmul f2, f4, f0
/* 800D5E4C 0000005C  FC 00 00 32 */	fmul f0, f0, f0
/* 800D5E50 00000060  FC 01 00 32 */	fmul f0, f1, f0
/* 800D5E54 00000064  FC 03 00 28 */	fsub f0, f3, f0
/* 800D5E58 00000068  FC 02 00 32 */	fmul f0, f2, f0
/* 800D5E5C 0000006C  FC 44 00 32 */	fmul f2, f4, f0
/* 800D5E60 00000070  FC 00 00 32 */	fmul f0, f0, f0
/* 800D5E64 00000074  FC 01 00 32 */	fmul f0, f1, f0
/* 800D5E68 00000078  FC 03 00 28 */	fsub f0, f3, f0
/* 800D5E6C 0000007C  FC 02 00 32 */	fmul f0, f2, f0
/* 800D5E70 00000080  FC 21 00 32 */	fmul f1, f1, f0
/* 800D5E74 00000084  FC 20 08 18 */	frsp f1, f1
/* 800D5E78 00000088  48 00 00 88 */	b lbl_800D5F00
lbl_800D5E7C:
/* 800D5E7C 00000000  C8 02 92 F8 */	lfd f0, LIT_6848(r2)
/* 800D5E80 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D5E84 00000008  40 80 00 10 */	bge lbl_800D5E94
/* 800D5E88 0000000C  3C 60 80 45 */	lis r3, 0x8045
/* 800D5E8C 00000010  C0 23 0A E0 */	lfs f1, 0xae0(r3)
/* 800D5E90 00000014  48 00 00 70 */	b lbl_800D5F00
lbl_800D5E94:
...
/* 800D5EF8 00000008  3C 60 80 45 */	lis r3, 0x8045
/* 800D5EFC 0000000C  C0 23 0A E0 */	lfs f1, 0xae0(r3)
lbl_800D5F00:
/* 800D5F00 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800D5F04 00000004  38 63 DD B8 */	addi r3, r3, -8776
/* 800D5F08 00000008  C0 03 00 44 */	lfs f0, 0x44(r3)
/* 800D5F0C 0000000C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D5F10 00000010  40 81 00 08 */	ble lbl_800D5F18
/* 800D5F14 00000014  FC 20 00 90 */	fmr f1, f0
lbl_800D5F18:
...
/* 800D5F50 00000038  48 19 11 D9 */	bl func_80267128
...
/* 800D5F64 0000004C  3C 80 00 01 */	lis r4, 1
/* 800D5F68 00000050  38 84 00 98 */	addi r4, r4, 0x98
/* 800D5F6C 00000054  4B FF C3 19 */	bl func_800D2284
...
/* 800D5F84 0000006C  3D 00 80 39 */	lis r8, 0x8039
/* 800D5F88 00000070  39 08 DD B8 */	addi r8, r8, -8776
/* 800D5F8C 00000074  C0 28 00 5C */	lfs f1, 0x5c(r8)
/* 800D5F90 00000078  C0 48 00 58 */	lfs f2, 0x58(r8)
/* 800D5F94 0000007C  4B FF B6 F5 */	bl func_800D1688
/* 800D5F98 00000080  7F E3 FB 78 */	mr r3, r31
/* 800D5F9C 00000084  38 80 00 05 */	li r4, 5
/* 800D5FA0 00000088  4B FF B5 8D */	bl func_800D152C
/* 800D5FA4 0000008C  38 60 00 01 */	li r3, 1
lbl_800D5FA8:
/* 800D5FA8 00000000  E3 E1 00 48 */	psq_l f31, 72(r1), 0, 0 /* qr0 */
/* 800D5FAC 00000004  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 800D5FB0 00000008  83 E1 00 3C */	lwz r31, 0x3c(r1)
/* 800D5FB4 0000000C  83 C1 00 38 */	lwz r30, 0x38(r1)
/* 800D5FB8 00000010  80 01 00 54 */	lwz r0, 0x54(r1)
/* 800D5FBC 00000014  7C 08 03 A6 */	mtlr r0
/* 800D5FC0 00000018  38 21 00 50 */	addi r1, r1, 0x50
/* 800D5FC4 0000001C  4E 80 00 20 */	blr 

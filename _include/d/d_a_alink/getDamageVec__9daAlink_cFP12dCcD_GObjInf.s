...
/* 800D755C 00000068  C0 42 93 9C */	lfs f2, d_d_a_alink__LIT_9053(r2)
...
/* 800D7598 00000008  40 80 01 04 */	bge lbl_800D769C
/* 800D759C 0000000C  38 7E 00 9C */	addi r3, r30, 0x9c
/* 800D75A0 00000010  4B FA C0 E9 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 800D75A4 00000014  28 03 00 00 */	cmplwi r3, 0
/* 800D75A8 00000018  41 82 00 3C */	beq lbl_800D75E4
/* 800D75AC 0000001C  38 7E 00 9C */	addi r3, r30, 0x9c
/* 800D75B0 00000020  4B FA C0 D9 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 800D75B4 00000024  7C 65 1B 78 */	mr r5, r3
/* 800D75B8 00000028  38 61 00 20 */	addi r3, r1, 0x20
/* 800D75BC 0000002C  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 800D75C0 00000030  38 A5 04 D0 */	addi r5, r5, 0x4d0
/* 800D75C4 00000034  48 18 F5 71 */	bl __mi__4cXyzCFRC3Vec
/* 800D75C8 00000038  C0 01 00 20 */	lfs f0, 0x20(r1)
/* 800D75CC 0000003C  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 800D75D0 00000040  C0 01 00 24 */	lfs f0, 0x24(r1)
/* 800D75D4 00000044  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 800D75D8 00000048  C0 01 00 28 */	lfs f0, 0x28(r1)
/* 800D75DC 0000004C  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 800D75E0 00000050  48 00 00 2C */	b lbl_800D760C
lbl_800D75E4:
...
/* 800D761C 00000010  40 80 00 40 */	bge lbl_800D765C
/* 800D7620 00000014  A8 1D 04 E6 */	lha r0, 0x4e6(r29)
/* 800D7624 00000018  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 800D7628 0000001C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 800D762C 00000020  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 800D7630 00000024  7C 03 04 2E */	lfsx f0, r3, r0
/* 800D7634 00000028  C0 22 93 9C */	lfs f1, d_d_a_alink__LIT_9053(r2)
/* 800D7638 0000002C  EC 01 00 32 */	fmuls f0, f1, f0
/* 800D763C 00000030  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 800D7640 00000034  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 800D7644 00000038  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 800D7648 0000003C  7C 63 02 14 */	add r3, r3, r0
/* 800D764C 00000040  C0 03 00 04 */	lfs f0, 4(r3)
/* 800D7650 00000044  EC 01 00 32 */	fmuls f0, f1, f0
/* 800D7654 00000048  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 800D7658 0000004C  48 00 00 2C */	b lbl_800D7684
lbl_800D765C:
/* 800D765C 00000000  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 800D7660 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D7664 00000008  40 81 00 0C */	ble lbl_800D7670
/* 800D7668 0000000C  FC 00 08 34 */	frsqrte f0, f1
/* 800D766C 00000010  EC 20 00 72 */	fmuls f1, f0, f1
lbl_800D7670:
/* 800D7670 00000000  38 61 00 2C */	addi r3, r1, 0x2c
/* 800D7674 00000004  7C 64 1B 78 */	mr r4, r3
/* 800D7678 00000008  C0 02 93 30 */	lfs f0, d_d_a_alink__LIT_7625(r2)

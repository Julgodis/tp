...
/* 800D38F4 00000028  4C 41 13 82 */	cror 2, 1, 2
/* 800D38F8 0000002C  40 82 00 14 */	bne lbl_800D390C
/* 800D38FC 00000030  80 1E 31 A0 */	lwz r0, 0x31a0(r30)
/* 800D3900 00000034  60 00 01 00 */	ori r0, r0, 0x100
/* 800D3904 00000038  90 1E 31 A0 */	stw r0, 0x31a0(r30)
/* 800D3908 0000003C  48 00 00 34 */	b lbl_800D393C
lbl_800D390C:
...
/* 800D3928 0000001C  4C 41 13 82 */	cror 2, 1, 2
/* 800D392C 00000020  40 82 00 10 */	bne lbl_800D393C
/* 800D3930 00000024  80 1E 31 A0 */	lwz r0, 0x31a0(r30)
/* 800D3934 00000028  54 00 06 2C */	rlwinm r0, r0, 0, 0x18, 0x16
/* 800D3938 0000002C  90 1E 31 A0 */	stw r0, 0x31a0(r30)
lbl_800D393C:
...
/* 800D3970 00000034  40 81 00 18 */	ble lbl_800D3988
/* 800D3974 00000038  7F C3 F3 78 */	mr r3, r30
/* 800D3978 0000003C  38 80 00 03 */	li r4, 3
/* 800D397C 00000040  4B FF ED E5 */	bl checkCutCancelNextMode__9daAlink_cFi
/* 800D3980 00000044  2C 03 00 00 */	cmpwi r3, 0
/* 800D3984 00000048  40 82 01 3C */	bne lbl_800D3AC0
lbl_800D3988:
...
/* 800D39F0 0000000C  40 81 00 18 */	ble lbl_800D3A08
/* 800D39F4 00000010  7F C3 F3 78 */	mr r3, r30
/* 800D39F8 00000014  38 80 00 03 */	li r4, 3
/* 800D39FC 00000018  4B FF ED 65 */	bl checkCutCancelNextMode__9daAlink_cFi
/* 800D3A00 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 800D3A04 00000020  40 82 00 BC */	bne lbl_800D3AC0
lbl_800D3A08:
...
/* 800D3A14 0000000C  40 81 00 10 */	ble lbl_800D3A24
/* 800D3A18 00000010  7F C3 F3 78 */	mr r3, r30
/* 800D3A1C 00000014  38 80 00 01 */	li r4, 1
/* 800D3A20 00000018  4B FF DA 11 */	bl resetCombo__9daAlink_cFi
lbl_800D3A24:
...
/* 800D3A80 00000014  4C 41 13 82 */	cror 2, 1, 2
/* 800D3A84 00000018  40 82 00 3C */	bne lbl_800D3AC0
/* 800D3A88 0000001C  C0 1E 34 7C */	lfs f0, 0x347c(r30)
/* 800D3A8C 00000020  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D3A90 00000024  40 80 00 30 */	bge lbl_800D3AC0
/* 800D3A94 00000028  80 1E 05 70 */	lwz r0, 0x570(r30)
/* 800D3A98 0000002C  54 00 06 73 */	rlwinm. r0, r0, 0, 0x19, 0x19
/* 800D3A9C 00000030  40 82 00 18 */	bne lbl_800D3AB4
/* 800D3AA0 00000034  7F C3 F3 78 */	mr r3, r30
/* 800D3AA4 00000038  80 9E 32 D0 */	lwz r4, 0x32d0(r30)
/* 800D3AA8 0000003C  4B FE B6 45 */	bl seStartSwordCut__9daAlink_cFUl
/* 800D3AAC 00000040  C0 1E 34 80 */	lfs f0, 0x3480(r30)
/* 800D3AB0 00000044  D0 1E 33 98 */	stfs f0, 0x3398(r30)
lbl_800D3AB4:

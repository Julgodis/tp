...
/* 8010F9A4 00000038  C0 22 92 BC */	lfs f1, d_d_a_alink__LIT_6041(r2)
...
/* 8010F9E0 00000030  40 81 00 10 */	ble lbl_8010F9F0
/* 8010F9E4 00000034  38 00 00 00 */	li r0, 0
/* 8010F9E8 00000038  B0 1E 30 0E */	sth r0, 0x300e(r30)
/* 8010F9EC 0000003C  48 00 02 30 */	b lbl_8010FC1C
lbl_8010F9F0:
...
/* 8010FA98 0000000C  4C 41 13 82 */	cror 2, 1, 2
/* 8010FA9C 00000010  40 82 01 80 */	bne lbl_8010FC1C
/* 8010FAA0 00000014  38 00 00 05 */	li r0, 5
/* 8010FAA4 00000018  98 1E 2F 93 */	stb r0, 0x2f93(r30)
/* 8010FAA8 0000001C  48 00 01 74 */	b lbl_8010FC1C
lbl_8010FAAC:
...
/* 8010FB3C 00000060  3C 80 00 02 */	lis r4, 0x0002 /* 0002004E@ha */
/* 8010FB40 00000064  38 84 00 4E */	addi r4, r4, 0x004E /* 0002004E@l */
...
/* 8010FB64 0000000C  40 81 00 1C */	ble lbl_8010FB80
/* 8010FB68 00000010  C0 02 95 58 */	lfs f0, LIT_24323(r2)
/* 8010FB6C 00000014  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8010FB70 00000018  40 80 00 10 */	bge lbl_8010FB80
/* 8010FB74 0000001C  38 00 00 01 */	li r0, 1
/* 8010FB78 00000020  B0 1E 30 10 */	sth r0, 0x3010(r30)
/* 8010FB7C 00000024  48 00 00 0C */	b lbl_8010FB88
lbl_8010FB80:
...
/* 8010FB98 00000010  C0 02 92 9C */	lfs f0, d_d_a_alink__LIT_5944(r2)
/* 8010FB9C 00000014  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8010FBA0 00000018  4C 41 13 82 */	cror 2, 1, 2
/* 8010FBA4 0000001C  40 82 00 78 */	bne lbl_8010FC1C
/* 8010FBA8 00000020  80 1E 32 CC */	lwz r0, 0x32cc(r30)
/* 8010FBAC 00000024  90 01 00 08 */	stw r0, 8(r1)
/* 8010FBB0 00000028  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8010FBB4 0000002C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8010FBB8 00000030  38 81 00 08 */	addi r4, r1, 8
/* 8010FBBC 00000034  4B F0 9C 3D */	bl fopAcIt_Judge__FPFPvPv_PvPv
/* 8010FBC0 00000038  7C 7F 1B 79 */	or. r31, r3, r3
/* 8010FBC4 0000003C  41 82 00 58 */	beq lbl_8010FC1C
/* 8010FBC8 00000040  38 00 00 00 */	li r0, 0
/* 8010FBCC 00000044  90 1E 07 0C */	stw r0, 0x70c(r30)
/* 8010FBD0 00000048  38 00 00 01 */	li r0, 1
/* 8010FBD4 0000004C  B0 1E 30 08 */	sth r0, 0x3008(r30)
/* 8010FBD8 00000050  80 7E 07 08 */	lwz r3, 0x708(r30)
/* 8010FBDC 00000054  38 63 00 24 */	addi r3, r3, 0x24
/* 8010FBE0 00000058  3C 80 80 39 */	lis r4, data_80391A14@ha
/* 8010FBE4 0000005C  38 84 1A 14 */	addi r4, r4, data_80391A14@l
/* 8010FBE8 00000060  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8010FBEC 00000064  48 23 71 81 */	bl PSMTXMultVec
/* 8010FBF0 00000068  80 1F 04 9C */	lwz r0, 0x49c(r31)
/* 8010FBF4 0000006C  60 00 08 00 */	ori r0, r0, 0x800
/* 8010FBF8 00000070  90 1F 04 9C */	stw r0, 0x49c(r31)
/* 8010FBFC 00000074  A8 1E 30 0A */	lha r0, 0x300a(r30)
/* 8010FC00 00000078  2C 00 00 00 */	cmpwi r0, 0
/* 8010FC04 0000007C  41 82 00 18 */	beq lbl_8010FC1C
/* 8010FC08 00000080  7F E3 FB 78 */	mr r3, r31
/* 8010FC0C 00000084  81 9F 05 68 */	lwz r12, 0x568(r31)
/* 8010FC10 00000088  81 8C 00 08 */	lwz r12, 8(r12)
/* 8010FC14 0000008C  7D 89 03 A6 */	mtctr r12
/* 8010FC18 00000090  4E 80 04 21 */	bctrl 
lbl_8010FC1C:

...
lbl_800B7784:
/* 800B7784 00000000  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
...
/* 800B780C 00000010  41 81 00 34 */	bgt lbl_800B7840
/* 800B7810 00000014  83 DF 27 E0 */	lwz r30, 0x27e0(r31)
/* 800B7814 00000018  3B A0 00 01 */	li r29, 1
/* 800B7818 0000001C  7F C3 F3 78 */	mr r3, r30
/* 800B781C 00000020  4B FB BF C9 */	bl LockonTruth__12dAttention_cFv
/* 800B7820 00000024  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800B7824 00000028  40 82 00 14 */	bne lbl_800B7838
/* 800B7828 0000002C  80 1E 03 34 */	lwz r0, 0x334(r30)
/* 800B782C 00000030  54 00 00 85 */	rlwinm. r0, r0, 0, 2, 2
/* 800B7830 00000034  40 82 00 08 */	bne lbl_800B7838
/* 800B7834 00000038  3B A0 00 00 */	li r29, 0
lbl_800B7838:
...
/* 800B794C 0000000C  40 81 00 38 */	ble lbl_800B7984
/* 800B7950 00000010  A8 7F 30 7C */	lha r3, 0x307c(r31)
/* 800B7954 00000014  A8 1F 2F E0 */	lha r0, 0x2fe0(r31)
/* 800B7958 00000018  7C 03 00 50 */	subf r0, r3, r0
/* 800B795C 0000001C  7C 03 07 34 */	extsh r3, r0
/* 800B7960 00000020  48 2A D7 71 */	bl abs
/* 800B7964 00000024  2C 03 10 00 */	cmpwi r3, 0x1000
/* 800B7968 00000028  40 81 00 1C */	ble lbl_800B7984
/* 800B796C 0000002C  3C 60 80 39 */	lis r3, m__23daAlinkHIO_damCaught_c0@ha
/* 800B7970 00000030  38 63 E4 9C */	addi r3, r3, m__23daAlinkHIO_damCaught_c0@l
/* 800B7974 00000034  A8 63 00 16 */	lha r3, 0x16(r3)
/* 800B7978 00000038  A8 1F 30 F6 */	lha r0, 0x30f6(r31)
/* 800B797C 0000003C  7C 03 00 50 */	subf r0, r3, r0
/* 800B7980 00000040  B0 1F 30 F6 */	sth r0, 0x30f6(r31)
lbl_800B7984:
...
/* 800B79A0 00000004  3C 80 00 01 */	lis r4, 0x0001 /* 00010009@ha */
/* 800B79A4 00000008  38 84 00 09 */	addi r4, r4, 0x0009 /* 00010009@l */
...
/* 800B79E8 00000004  3C 80 00 01 */	lis r4, 0x0001 /* 0001001E@ha */
/* 800B79EC 00000008  38 84 00 1E */	addi r4, r4, 0x001E /* 0001001E@l */

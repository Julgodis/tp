...
/* 8013D45C 0000002C  3C 80 00 01 */	lis r4, 0x0001 /* 00010046@ha */
/* 8013D460 00000030  38 84 00 46 */	addi r4, r4, 0x0046 /* 00010046@l */
...
/* 8013D480 0000000C  4C 41 13 82 */	cror 2, 1, 2
/* 8013D484 00000010  40 82 00 0C */	bne lbl_8013D490
/* 8013D488 00000014  38 00 00 01 */	li r0, 1
/* 8013D48C 00000018  B0 1D 30 0E */	sth r0, 0x300e(r29)
lbl_8013D490:
...
/* 8013D4DC 0000004C  C0 62 92 BC */	lfs f3, d_d_a_alink__LIT_6041(r2)
...
/* 8013D500 0000000C  40 81 00 6C */	ble lbl_8013D56C
/* 8013D504 00000010  7F A3 EB 78 */	mr r3, r29
/* 8013D508 00000014  A0 9D 1F 58 */	lhz r4, 0x1f58(r29)
/* 8013D50C 00000018  38 A0 00 02 */	li r5, 2
/* 8013D510 0000001C  C0 22 92 C0 */	lfs f1, LIT_6108(r2)
/* 8013D514 00000020  A8 1E 00 08 */	lha r0, 8(r30)
/* 8013D518 00000024  C8 42 92 B0 */	lfd f2, LIT_6025(r2)
/* 8013D51C 00000028  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 8013D520 0000002C  90 01 00 0C */	stw r0, 0xc(r1)
/* 8013D524 00000030  3C 00 43 30 */	lis r0, 0x4330
/* 8013D528 00000034  90 01 00 08 */	stw r0, 8(r1)
/* 8013D52C 00000038  C8 01 00 08 */	lfd f0, 8(r1)
/* 8013D530 0000003C  EC 40 10 28 */	fsubs f2, f0, f2
/* 8013D534 00000040  C0 02 93 E4 */	lfs f0, LIT_12328(r2)
/* 8013D538 00000044  EC 42 00 28 */	fsubs f2, f2, f0
/* 8013D53C 00000048  38 C0 FF FF */	li r6, -1
/* 8013D540 0000004C  C0 62 92 BC */	lfs f3, d_d_a_alink__LIT_6041(r2)
/* 8013D544 00000050  4B F6 FE 95 */	bl setUpperAnime__9daAlink_cFUsQ29daAlink_c13daAlink_UPPERffsf
/* 8013D548 00000054  7F A3 EB 78 */	mr r3, r29
/* 8013D54C 00000058  38 80 00 01 */	li r4, 1
/* 8013D550 0000005C  4B FE C5 F5 */	bl checkNextActionWolf__9daAlink_cFi
/* 8013D554 00000060  2C 03 00 00 */	cmpwi r3, 0
/* 8013D558 00000064  40 82 00 14 */	bne lbl_8013D56C
/* 8013D55C 00000068  7F A3 EB 78 */	mr r3, r29
/* 8013D560 0000006C  38 80 00 02 */	li r4, 2
/* 8013D564 00000070  C0 22 92 BC */	lfs f1, d_d_a_alink__LIT_6041(r2)
/* 8013D568 00000074  4B F7 01 BD */	bl resetUpperAnime__9daAlink_cFQ29daAlink_c13daAlink_UPPERf
lbl_8013D56C:

...
/* 800E8590 00000014  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800E8594 00000018  93 C1 00 08 */	stw r30, 8(r1)
/* 800E8598 0000001C  7C 7F 1B 78 */	mr r31, r3
/* 800E859C 00000020  A8 03 30 10 */	lha r0, 0x3010(r3)
/* 800E85A0 00000024  2C 00 00 00 */	cmpwi r0, 0
/* 800E85A4 00000028  40 82 00 10 */	bne lbl_800E85B4
/* 800E85A8 0000002C  38 80 00 15 */	li r4, 0x15
/* 800E85AC 00000030  38 A0 00 02 */	li r5, 2
/* 800E85B0 00000034  4B FF F9 21 */	bl setWallGrabStatus__9daAlink_cFUcUc
lbl_800E85B4:
...
/* 800E8620 0000003C  C0 62 93 30 */	lfs f3, d_d_a_alink__LIT_7625(r2)
/* 800E8624 00000040  C0 82 92 B8 */	lfs f4, d_d_a_alink__LIT_6040(r2)
...
/* 800E863C 00000058  C0 62 93 30 */	lfs f3, d_d_a_alink__LIT_7625(r2)
/* 800E8640 0000005C  C0 82 92 B8 */	lfs f4, d_d_a_alink__LIT_6040(r2)
...
/* 800E8654 00000070  C0 02 93 3C */	lfs f0, d_d_a_alink__LIT_7808(r2)
/* 800E8658 00000074  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800E865C 00000078  40 80 00 2C */	bge lbl_800E8688
/* 800E8660 0000007C  7F E3 FB 78 */	mr r3, r31
/* 800E8664 00000080  4B FD 0B F1 */	bl checkNoUpperAnime__9daAlink_cCFv
/* 800E8668 00000084  2C 03 00 00 */	cmpwi r3, 0
/* 800E866C 00000088  41 82 00 1C */	beq lbl_800E8688
/* 800E8670 0000008C  C0 1F 37 C8 */	lfs f0, 0x37c8(r31)
/* 800E8674 00000090  D0 1F 04 D0 */	stfs f0, 0x4d0(r31)
/* 800E8678 00000094  C0 1F 37 D0 */	lfs f0, 0x37d0(r31)
/* 800E867C 00000098  D0 1F 04 D8 */	stfs f0, 0x4d8(r31)
/* 800E8680 0000009C  38 00 00 00 */	li r0, 0
/* 800E8684 000000A0  90 1F 31 98 */	stw r0, 0x3198(r31)
lbl_800E8688:
...
/* 800E86C0 0000000C  40 81 00 78 */	ble lbl_800E8738
/* 800E86C4 00000010  A8 7F 04 E6 */	lha r3, 0x4e6(r31)
/* 800E86C8 00000014  A8 1F 2F E2 */	lha r0, 0x2fe2(r31)
/* 800E86CC 00000018  7C 03 00 50 */	subf r0, r3, r0
/* 800E86D0 0000001C  7C 03 07 34 */	extsh r3, r0
/* 800E86D4 00000020  4B FC AD C1 */	bl getDirectionFromAngle__9daAlink_cFs
/* 800E86D8 00000024  2C 03 00 00 */	cmpwi r3, 0
/* 800E86DC 00000028  40 82 00 30 */	bne lbl_800E870C
/* 800E86E0 0000002C  38 7F 1E 1C */	addi r3, r31, 0x1e1c
/* 800E86E4 00000030  38 80 00 01 */	li r4, 1
/* 800E86E8 00000034  4B FB 9A F9 */	bl getMoveBGActorName__9daAlink_cFR13cBgS_PolyInfoi
/* 800E86EC 00000038  7C 60 07 34 */	extsh r0, r3
/* 800E86F0 0000003C  20 00 00 DF */	subfic r0, r0, 0xdf
/* 800E86F4 00000040  7C 00 00 34 */	cntlzw r0, r0
/* 800E86F8 00000044  54 05 DE 3E */	rlwinm r5, r0, 0x1b, 0x18, 0x1f
/* 800E86FC 00000048  7F E3 FB 78 */	mr r3, r31
/* 800E8700 0000004C  38 80 00 00 */	li r4, 0
/* 800E8704 00000050  48 00 00 59 */	bl procCoPushMoveInit__9daAlink_cFii
/* 800E8708 00000054  48 00 00 30 */	b lbl_800E8738
lbl_800E870C:
...
/* 800E8740 00000008  CB E1 00 10 */	lfd f31, 0x10(r1)
/* 800E8744 0000000C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 800E8748 00000010  83 C1 00 08 */	lwz r30, 8(r1)
/* 800E874C 00000014  80 01 00 24 */	lwz r0, 0x24(r1)
/* 800E8750 00000018  7C 08 03 A6 */	mtlr r0
/* 800E8754 0000001C  38 21 00 20 */	addi r1, r1, 0x20
/* 800E8758 00000020  4E 80 00 20 */	blr 

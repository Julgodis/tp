...
/* 800BB658 00000014  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800BB65C 00000018  93 C1 00 08 */	stw r30, 8(r1)
/* 800BB660 0000001C  7C 7E 1B 78 */	mr r30, r3
/* 800BB664 00000020  3C 80 80 39 */	lis r4, d_d_a_alink__LIT_3757@ha
/* 800BB668 00000024  3B E4 D6 58 */	addi r31, r4, d_d_a_alink__LIT_3757@l
/* 800BB66C 00000028  80 03 05 74 */	lwz r0, 0x574(r3)
/* 800BB670 0000002C  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6
/* 800BB674 00000030  41 82 00 5C */	beq lbl_800BB6D0
/* 800BB678 00000034  80 1E 31 A0 */	lwz r0, 0x31a0(r30)
/* 800BB67C 00000038  54 00 03 5B */	rlwinm. r0, r0, 0, 0xd, 0xd
/* 800BB680 0000003C  41 82 00 40 */	beq lbl_800BB6C0
/* 800BB684 00000040  38 80 00 01 */	li r4, 1
/* 800BB688 00000044  38 A0 00 01 */	li r5, 1
/* 800BB68C 00000048  4B FF FE 2D */	bl checkHeavyStateOn__9daAlink_cFii
/* 800BB690 0000004C  2C 03 00 00 */	cmpwi r3, 0
/* 800BB694 00000050  41 82 00 18 */	beq lbl_800BB6AC
/* 800BB698 00000054  38 7F 22 5C */	addi r3, r31, 0x225c
/* 800BB69C 00000058  C0 03 00 9C */	lfs f0, 0x9c(r3)
/* 800BB6A0 0000005C  FC 20 00 50 */	fneg f1, f0
/* 800BB6A4 00000060  C3 E3 00 A0 */	lfs f31, 0xa0(r3)
/* 800BB6A8 00000064  48 00 00 98 */	b lbl_800BB740
lbl_800BB6AC:
...
/* 800BB754 00000014  CB E1 00 10 */	lfd f31, 0x10(r1)
/* 800BB758 00000018  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 800BB75C 0000001C  83 C1 00 08 */	lwz r30, 8(r1)
/* 800BB760 00000020  80 01 00 24 */	lwz r0, 0x24(r1)
/* 800BB764 00000024  7C 08 03 A6 */	mtlr r0
/* 800BB768 00000028  38 21 00 20 */	addi r1, r1, 0x20
/* 800BB76C 0000002C  4E 80 00 20 */	blr 

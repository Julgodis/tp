...
/* 800D19DC 00000014  39 61 00 80 */	addi r11, r1, 0x80
/* 800D19E0 00000018  48 29 07 F9 */	bl _savegpr_28
/* 800D19E4 0000001C  7C 7E 1B 78 */	mr r30, r3
/* 800D19E8 00000020  7C 9F 23 78 */	mr r31, r4
/* 800D19EC 00000024  38 9E 12 2C */	addi r4, r30, 0x122c
/* 800D19F0 00000028  4B FF FF 89 */	bl checkCutReverseAt__9daAlink_cFP12dCcD_GObjInf
/* 800D19F4 0000002C  2C 03 00 00 */	cmpwi r3, 0
/* 800D19F8 00000030  40 82 00 38 */	bne lbl_800D1A30
/* 800D19FC 00000034  A0 1E 2F DC */	lhz r0, 0x2fdc(r30)
/* 800D1A00 00000038  28 00 00 46 */	cmplwi r0, 0x46
/* 800D1A04 0000003C  41 82 00 3C */	beq lbl_800D1A40
/* 800D1A08 00000040  7F C3 F3 78 */	mr r3, r30
/* 800D1A0C 00000044  38 9E 13 70 */	addi r4, r30, 0x1370
/* 800D1A10 00000048  4B FF FF 69 */	bl checkCutReverseAt__9daAlink_cFP12dCcD_GObjInf
/* 800D1A14 0000004C  2C 03 00 00 */	cmpwi r3, 0
/* 800D1A18 00000050  40 82 00 18 */	bne lbl_800D1A30
/* 800D1A1C 00000054  7F C3 F3 78 */	mr r3, r30
/* 800D1A20 00000058  38 9E 14 B4 */	addi r4, r30, 0x14b4
/* 800D1A24 0000005C  4B FF FF 55 */	bl checkCutReverseAt__9daAlink_cFP12dCcD_GObjInf
/* 800D1A28 00000060  2C 03 00 00 */	cmpwi r3, 0
/* 800D1A2C 00000064  41 82 00 14 */	beq lbl_800D1A40
lbl_800D1A30:
...
/* 800D1BD8 00000028  40 81 00 58 */	ble lbl_800D1C30
/* 800D1BDC 0000002C  FC 00 08 34 */	frsqrte f0, f1
/* 800D1BE0 00000030  C8 82 92 E8 */	lfd f4, d_d_a_alink__LIT_6846(r2)
/* 800D1BE4 00000034  FC 44 00 32 */	fmul f2, f4, f0
/* 800D1BE8 00000038  C8 62 92 F0 */	lfd f3, LIT_6847(r2)
/* 800D1BEC 0000003C  FC 00 00 32 */	fmul f0, f0, f0
/* 800D1BF0 00000040  FC 01 00 32 */	fmul f0, f1, f0
/* 800D1BF4 00000044  FC 03 00 28 */	fsub f0, f3, f0
/* 800D1BF8 00000048  FC 02 00 32 */	fmul f0, f2, f0
/* 800D1BFC 0000004C  FC 44 00 32 */	fmul f2, f4, f0
/* 800D1C00 00000050  FC 00 00 32 */	fmul f0, f0, f0
/* 800D1C04 00000054  FC 01 00 32 */	fmul f0, f1, f0
/* 800D1C08 00000058  FC 03 00 28 */	fsub f0, f3, f0
/* 800D1C0C 0000005C  FC 02 00 32 */	fmul f0, f2, f0
/* 800D1C10 00000060  FC 44 00 32 */	fmul f2, f4, f0
/* 800D1C14 00000064  FC 00 00 32 */	fmul f0, f0, f0
/* 800D1C18 00000068  FC 01 00 32 */	fmul f0, f1, f0
/* 800D1C1C 0000006C  FC 03 00 28 */	fsub f0, f3, f0
/* 800D1C20 00000070  FC 02 00 32 */	fmul f0, f2, f0
/* 800D1C24 00000074  FF E1 00 32 */	fmul f31, f1, f0
/* 800D1C28 00000078  FF E0 F8 18 */	frsp f31, f31
/* 800D1C2C 0000007C  48 00 00 90 */	b lbl_800D1CBC
lbl_800D1C30:
/* 800D1C30 00000000  C8 02 92 F8 */	lfd f0, LIT_6848(r2)
/* 800D1C34 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D1C38 00000008  40 80 00 10 */	bge lbl_800D1C48
/* 800D1C3C 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 800D1C40 00000010  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
/* 800D1C44 00000014  48 00 00 78 */	b lbl_800D1CBC
lbl_800D1C48:
...
/* 800D1D88 00000044  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
...
/* 800D1DC8 00000018  C0 22 92 BC */	lfs f1, d_d_a_alink__LIT_6041(r2)
...
/* 800D1E00 00000004  CB E1 00 80 */	lfd f31, 0x80(r1)
/* 800D1E04 00000008  39 61 00 80 */	addi r11, r1, 0x80
/* 800D1E08 0000000C  48 29 04 1D */	bl _restgpr_28
/* 800D1E0C 00000010  80 01 00 94 */	lwz r0, 0x94(r1)
/* 800D1E10 00000014  7C 08 03 A6 */	mtlr r0
/* 800D1E14 00000018  38 21 00 90 */	addi r1, r1, 0x90
/* 800D1E18 0000001C  4E 80 00 20 */	blr 

...
/* 800B3938 00000014  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 800B393C 00000018  F3 C1 00 48 */	psq_st f30, 72(r1), 0, 0 /* qr0 */
/* 800B3940 0000001C  DB A1 00 30 */	stfd f29, 0x30(r1)
/* 800B3944 00000020  F3 A1 00 38 */	psq_st f29, 56(r1), 0, 0 /* qr0 */
/* 800B3948 00000024  93 E1 00 2C */	stw r31, 0x2c(r1)
/* 800B394C 00000028  93 C1 00 28 */	stw r30, 0x28(r1)
/* 800B3950 0000002C  7C 7E 1B 78 */	mr r30, r3
/* 800B3954 00000030  FF A0 08 90 */	fmr f29, f1
/* 800B3958 00000034  FF C0 10 90 */	fmr f30, f2
/* 800B395C 00000038  3C 60 80 39 */	lis r3, d_d_a_alink__LIT_3757@ha
/* 800B3960 0000003C  3B E3 D6 58 */	addi r31, r3, d_d_a_alink__LIT_3757@l
/* 800B3964 00000040  38 00 00 00 */	li r0, 0
/* 800B3968 00000044  88 7E 05 6A */	lbz r3, 0x56a(r30)
/* 800B396C 00000048  28 03 00 00 */	cmplwi r3, 0
/* 800B3970 0000004C  41 82 00 10 */	beq lbl_800B3980
/* 800B3974 00000050  28 03 00 26 */	cmplwi r3, 0x26
/* 800B3978 00000054  40 80 00 08 */	bge lbl_800B3980
/* 800B397C 00000058  38 00 00 01 */	li r0, 1
lbl_800B3980:
...
/* 800B3A6C 00000018  40 80 00 54 */	bge lbl_800B3AC0
lbl_800B3A70:
...
/* 800B3AB8 00000014  40 81 00 08 */	ble lbl_800B3AC0
/* 800B3ABC 00000018  FF E0 00 90 */	fmr f31, f0
lbl_800B3AC0:
...
/* 800B3AD8 00000018  40 80 00 1C */	bge lbl_800B3AF4
/* 800B3ADC 0000001C  C0 22 92 98 */	lfs f1, LIT_5943(r2)
/* 800B3AE0 00000020  C0 1E 05 94 */	lfs f0, 0x594(r30)
/* 800B3AE4 00000024  EC 01 00 32 */	fmuls f0, f1, f0
/* 800B3AE8 00000028  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 800B3AEC 0000002C  40 81 00 08 */	ble lbl_800B3AF4
/* 800B3AF0 00000030  FF E0 00 90 */	fmr f31, f0
lbl_800B3AF4:
...
/* 800B3B48 00000014  40 80 00 08 */	bge lbl_800B3B50
/* 800B3B4C 00000018  48 00 00 18 */	b lbl_800B3B64
lbl_800B3B50:
/* 800B3B50 00000000  C0 62 92 B8 */	lfs f3, d_d_a_alink__LIT_6040(r2)
/* 800B3B54 00000004  FC 00 18 40 */	fcmpo cr0, f0, f3
/* 800B3B58 00000008  40 81 00 08 */	ble lbl_800B3B60
/* 800B3B5C 0000000C  48 00 00 08 */	b lbl_800B3B64
lbl_800B3B60:
/* 800B3B60 00000000  FC 60 00 90 */	fmr f3, f0
lbl_800B3B64:
/* 800B3B64 00000000  C0 5E 05 94 */	lfs f2, 0x594(r30)
/* 800B3B68 00000004  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
...
/* 800B3B80 0000001C  40 81 00 08 */	ble lbl_800B3B88
/* 800B3B84 00000020  FF E0 00 90 */	fmr f31, f0
lbl_800B3B88:
...
/* 800B3C08 00000030  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
/* 800B3C0C 00000034  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 800B3C10 00000038  41 81 00 34 */	bgt lbl_800B3C44
/* 800B3C14 0000003C  C0 1E 34 30 */	lfs f0, 0x3430(r30)
/* 800B3C18 00000040  FC 00 02 10 */	fabs f0, f0
/* 800B3C1C 00000044  FC 00 00 18 */	frsp f0, f0
/* 800B3C20 00000048  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 800B3C24 0000004C  41 81 00 20 */	bgt lbl_800B3C44
/* 800B3C28 00000050  A0 1E 30 FC */	lhz r0, 0x30fc(r30)
/* 800B3C2C 00000054  28 00 00 00 */	cmplwi r0, 0
/* 800B3C30 00000058  41 82 01 80 */	beq lbl_800B3DB0
/* 800B3C34 0000005C  7F E3 FB 78 */	mr r3, r31
/* 800B3C38 00000060  48 2B 14 99 */	bl abs
/* 800B3C3C 00000064  2C 03 40 00 */	cmpwi r3, 0x4000
/* 800B3C40 00000068  40 80 01 70 */	bge lbl_800B3DB0
lbl_800B3C44:
...
/* 800B3CC8 0000000C  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
/* 800B3CCC 00000010  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 800B3CD0 00000014  41 81 00 18 */	bgt lbl_800B3CE8
/* 800B3CD4 00000018  C0 1E 34 30 */	lfs f0, 0x3430(r30)
/* 800B3CD8 0000001C  FC 00 02 10 */	fabs f0, f0
/* 800B3CDC 00000020  FC 00 00 18 */	frsp f0, f0
/* 800B3CE0 00000024  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 800B3CE4 00000028  40 81 00 38 */	ble lbl_800B3D1C
lbl_800B3CE8:
...
/* 800B3D40 00000024  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
/* 800B3D44 00000028  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B3D48 0000002C  40 80 00 28 */	bge lbl_800B3D70
/* 800B3D4C 00000030  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 800B3D50 00000034  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 800B3D54 00000038  38 63 0F 38 */	addi r3, r3, 0xf38
/* 800B3D58 0000003C  38 9E 1E 4C */	addi r4, r30, 0x1e4c
/* 800B3D5C 00000040  4B FC 09 05 */	bl ChkPolySafe__4cBgSFRC13cBgS_PolyInfo
/* 800B3D60 00000044  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800B3D64 00000048  41 82 00 0C */	beq lbl_800B3D70
/* 800B3D68 0000004C  38 00 00 03 */	li r0, 3
/* 800B3D6C 00000050  B0 1E 30 FC */	sth r0, 0x30fc(r30)
lbl_800B3D70:
...
/* 800B3D90 00000008  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
...
/* 800B3DF0 00000040  C0 42 92 B8 */	lfs f2, d_d_a_alink__LIT_6040(r2)
/* 800B3DF4 00000044  C0 22 94 08 */	lfs f1, d_d_a_alink__LIT_14064(r2)
...
lbl_800B3E2C:
/* 800B3E2C 00000000  C0 22 92 B8 */	lfs f1, d_d_a_alink__LIT_6040(r2)
...
/* 800B3E78 00000008  41 80 00 10 */	blt lbl_800B3E88
/* 800B3E7C 0000000C  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 800B3E80 00000010  FC 00 F8 00 */	fcmpu cr0, f0, f31
/* 800B3E84 00000014  40 82 00 28 */	bne lbl_800B3EAC
lbl_800B3E88:
/* 800B3E88 00000000  EC 01 F8 28 */	fsubs f0, f1, f31
/* 800B3E8C 00000004  FC 00 F0 40 */	fcmpo cr0, f0, f30
/* 800B3E90 00000008  40 81 00 0C */	ble lbl_800B3E9C
/* 800B3E94 0000000C  FC 40 F0 90 */	fmr f2, f30
/* 800B3E98 00000010  48 00 00 08 */	b lbl_800B3EA0
lbl_800B3E9C:
...
/* 800B3EC4 00000010  41 80 00 24 */	blt lbl_800B3EE8
/* 800B3EC8 00000014  C0 1E 33 98 */	lfs f0, 0x3398(r30)
/* 800B3ECC 00000018  EC 00 E8 2A */	fadds f0, f0, f29
/* 800B3ED0 0000001C  D0 1E 33 98 */	stfs f0, 0x3398(r30)
/* 800B3ED4 00000020  C0 1E 33 98 */	lfs f0, 0x3398(r30)
/* 800B3ED8 00000024  FC 00 F8 40 */	fcmpo cr0, f0, f31
/* 800B3EDC 00000028  40 81 00 14 */	ble lbl_800B3EF0
/* 800B3EE0 0000002C  D3 FE 33 98 */	stfs f31, 0x3398(r30)
/* 800B3EE4 00000030  48 00 00 0C */	b lbl_800B3EF0
lbl_800B3EE8:
...
/* 800B3F00 00000004  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 800B3F04 00000008  E3 C1 00 48 */	psq_l f30, 72(r1), 0, 0 /* qr0 */
/* 800B3F08 0000000C  CB C1 00 40 */	lfd f30, 0x40(r1)
/* 800B3F0C 00000010  E3 A1 00 38 */	psq_l f29, 56(r1), 0, 0 /* qr0 */
/* 800B3F10 00000014  CB A1 00 30 */	lfd f29, 0x30(r1)
/* 800B3F14 00000018  83 E1 00 2C */	lwz r31, 0x2c(r1)
/* 800B3F18 0000001C  83 C1 00 28 */	lwz r30, 0x28(r1)
/* 800B3F1C 00000020  80 01 00 64 */	lwz r0, 0x64(r1)
/* 800B3F20 00000024  7C 08 03 A6 */	mtlr r0
/* 800B3F24 00000028  38 21 00 60 */	addi r1, r1, 0x60
/* 800B3F28 0000002C  4E 80 00 20 */	blr 

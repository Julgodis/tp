...
/* 8013E820 00000014  39 61 00 90 */	addi r11, r1, 0x90
/* 8013E824 00000018  48 22 39 B9 */	bl _savegpr_29
/* 8013E828 0000001C  7C 7D 1B 78 */	mr r29, r3
/* 8013E82C 00000020  83 E3 28 10 */	lwz r31, 0x2810(r3)
/* 8013E830 00000024  28 1F 00 00 */	cmplwi r31, 0
/* 8013E834 00000028  41 82 00 20 */	beq lbl_8013E854
/* 8013E838 0000002C  A8 9D 30 08 */	lha r4, 0x3008(r29)
/* 8013E83C 00000030  3C 60 80 39 */	lis r3, m__21daAlinkHIO_wlChain_c0@ha
/* 8013E840 00000034  38 63 F8 58 */	addi r3, r3, m__21daAlinkHIO_wlChain_c0@l
/* 8013E844 00000038  A8 03 00 3E */	lha r0, 0x3e(r3)
/* 8013E848 0000003C  7C 00 00 D0 */	neg r0, r0
/* 8013E84C 00000040  7C 04 00 00 */	cmpw r4, r0
/* 8013E850 00000044  41 81 01 40 */	bgt lbl_8013E990
lbl_8013E854:
...
/* 8013E87C 00000028  40 81 00 58 */	ble lbl_8013E8D4
/* 8013E880 0000002C  FC 00 08 34 */	frsqrte f0, f1
/* 8013E884 00000030  C8 82 92 E8 */	lfd f4, d_d_a_alink__LIT_6846(r2)
/* 8013E888 00000034  FC 44 00 32 */	fmul f2, f4, f0
/* 8013E88C 00000038  C8 62 92 F0 */	lfd f3, LIT_6847(r2)
/* 8013E890 0000003C  FC 00 00 32 */	fmul f0, f0, f0
/* 8013E894 00000040  FC 01 00 32 */	fmul f0, f1, f0
/* 8013E898 00000044  FC 03 00 28 */	fsub f0, f3, f0
/* 8013E89C 00000048  FC 02 00 32 */	fmul f0, f2, f0
/* 8013E8A0 0000004C  FC 44 00 32 */	fmul f2, f4, f0
/* 8013E8A4 00000050  FC 00 00 32 */	fmul f0, f0, f0
/* 8013E8A8 00000054  FC 01 00 32 */	fmul f0, f1, f0
/* 8013E8AC 00000058  FC 03 00 28 */	fsub f0, f3, f0
/* 8013E8B0 0000005C  FC 02 00 32 */	fmul f0, f2, f0
/* 8013E8B4 00000060  FC 44 00 32 */	fmul f2, f4, f0
/* 8013E8B8 00000064  FC 00 00 32 */	fmul f0, f0, f0
/* 8013E8BC 00000068  FC 01 00 32 */	fmul f0, f1, f0
/* 8013E8C0 0000006C  FC 03 00 28 */	fsub f0, f3, f0
/* 8013E8C4 00000070  FC 02 00 32 */	fmul f0, f2, f0
/* 8013E8C8 00000074  FC 21 00 32 */	fmul f1, f1, f0
/* 8013E8CC 00000078  FC 20 08 18 */	frsp f1, f1
/* 8013E8D0 0000007C  48 00 00 88 */	b lbl_8013E958
lbl_8013E8D4:
/* 8013E8D4 00000000  C8 02 92 F8 */	lfd f0, LIT_6848(r2)
/* 8013E8D8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8013E8DC 00000008  40 80 00 10 */	bge lbl_8013E8EC
/* 8013E8E0 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8013E8E4 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
/* 8013E8E8 00000014  48 00 00 70 */	b lbl_8013E958
lbl_8013E8EC:
...
/* 8013E9CC 0000001C  40 81 00 DC */	ble lbl_8013EAA8
/* 8013E9D0 00000020  38 00 00 01 */	li r0, 1
/* 8013E9D4 00000024  98 1F 07 75 */	stb r0, 0x775(r31)
/* 8013E9D8 00000028  98 1F 07 7B */	stb r0, 0x77b(r31)
/* 8013E9DC 0000002C  B0 1D 30 10 */	sth r0, 0x3010(r29)
/* 8013E9E0 00000030  C0 22 92 C0 */	lfs f1, LIT_6108(r2)
/* 8013E9E4 00000034  D0 21 00 60 */	stfs f1, 0x60(r1)
/* 8013E9E8 00000038  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
/* 8013E9EC 0000003C  D0 01 00 64 */	stfs f0, 0x64(r1)
/* 8013E9F0 00000040  D0 21 00 68 */	stfs f1, 0x68(r1)
/* 8013E9F4 00000044  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8013E9F8 00000048  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8013E9FC 0000004C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8013EA00 00000050  38 80 00 07 */	li r4, 7
/* 8013EA04 00000054  38 A0 00 03 */	li r5, 3
/* 8013EA08 00000058  38 C1 00 60 */	addi r6, r1, 0x60
/* 8013EA0C 0000005C  4B F3 10 19 */	bl StartShock__12dVibration_cFii4cXyz
/* 8013EA10 00000060  48 00 00 98 */	b lbl_8013EAA8
lbl_8013EA14:
...
/* 8013EADC 00000034  40 81 00 3C */	ble lbl_8013EB18
/* 8013EAE0 00000038  A8 1D 2F E2 */	lha r0, 0x2fe2(r29)
/* 8013EAE4 0000003C  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8013EAE8 00000040  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8013EAEC 00000044  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 8013EAF0 00000048  7C 03 04 2E */	lfsx f0, r3, r0
/* 8013EAF4 0000004C  C0 3D 33 A8 */	lfs f1, 0x33a8(r29)
/* 8013EAF8 00000050  EC 01 00 32 */	fmuls f0, f1, f0
/* 8013EAFC 00000054  EC 03 00 2A */	fadds f0, f3, f0
/* 8013EB00 00000058  D0 01 00 6C */	stfs f0, 0x6c(r1)
/* 8013EB04 0000005C  7C 63 02 14 */	add r3, r3, r0
/* 8013EB08 00000060  C0 03 00 04 */	lfs f0, 4(r3)
/* 8013EB0C 00000064  EC 01 00 32 */	fmuls f0, f1, f0
/* 8013EB10 00000068  EC 02 00 2A */	fadds f0, f2, f0
/* 8013EB14 0000006C  D0 01 00 74 */	stfs f0, 0x74(r1)
lbl_8013EB18:
...
/* 8013EC1C 00000104  40 81 00 0C */	ble lbl_8013EC28
/* 8013EC20 00000108  FC 00 10 34 */	frsqrte f0, f2
/* 8013EC24 0000010C  EC 40 00 B2 */	fmuls f2, f0, f2
lbl_8013EC28:
...
/* 8013EC68 0000000C  40 81 00 1C */	ble lbl_8013EC84
/* 8013EC6C 00000010  38 80 00 59 */	li r4, 0x59
/* 8013EC70 00000014  3C 60 80 39 */	lis r3, m__21daAlinkHIO_wlChain_c0@ha
/* 8013EC74 00000018  38 63 F8 58 */	addi r3, r3, m__21daAlinkHIO_wlChain_c0@l
/* 8013EC78 0000001C  C0 23 00 40 */	lfs f1, 0x40(r3)
/* 8013EC7C 00000020  C0 43 00 44 */	lfs f2, 0x44(r3)
/* 8013EC80 00000024  48 00 00 18 */	b lbl_8013EC98
lbl_8013EC84:
...
/* 8013ED28 00000004  CB E1 00 90 */	lfd f31, 0x90(r1)
/* 8013ED2C 00000008  39 61 00 90 */	addi r11, r1, 0x90
/* 8013ED30 0000000C  48 22 34 F9 */	bl _restgpr_29
/* 8013ED34 00000010  80 01 00 A4 */	lwz r0, 0xa4(r1)
/* 8013ED38 00000014  7C 08 03 A6 */	mtlr r0
/* 8013ED3C 00000018  38 21 00 A0 */	addi r1, r1, 0xa0
/* 8013ED40 0000001C  4E 80 00 20 */	blr 

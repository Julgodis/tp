...
/* 800FFF60 00000014  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800FFF64 00000018  93 C1 00 08 */	stw r30, 8(r1)
/* 800FFF68 0000001C  7C 7E 1B 78 */	mr r30, r3
/* 800FFF6C 00000020  C3 E3 04 D4 */	lfs f31, 0x4d4(r3)
/* 800FFF70 00000024  4B FF E8 F9 */	bl setMoveBGClimbCorrect__9daAlink_cFv
/* 800FFF74 00000028  2C 03 00 00 */	cmpwi r3, 0
/* 800FFF78 0000002C  41 82 00 0C */	beq lbl_800FFF84
/* 800FFF7C 00000030  38 60 00 01 */	li r3, 1
/* 800FFF80 00000034  48 00 01 58 */	b lbl_801000D8
lbl_800FFF84:
...
/* 8010006C 00000014  40 81 00 68 */	ble lbl_801000D4
/* 80100070 00000018  7F C3 F3 78 */	mr r3, r30
/* 80100074 0000001C  4B FF DF C1 */	bl getClimbMoveSideAnmSpeed__9daAlink_cFv
/* 80100078 00000020  C0 5F 00 0C */	lfs f2, 0xc(r31)
/* 8010007C 00000024  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 80100080 00000028  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 80100084 0000002C  40 80 00 0C */	bge lbl_80100090
/* 80100088 00000030  C0 02 92 BC */	lfs f0, d_d_a_alink__LIT_6041(r2)
/* 8010008C 00000034  EC 21 00 32 */	fmuls f1, f1, f0
lbl_80100090:
...
/* 801000C8 00000038  40 80 00 0C */	bge lbl_801000D4
lbl_801000CC:
...
/* 801000DC 00000004  CB E1 00 10 */	lfd f31, 0x10(r1)
/* 801000E0 00000008  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 801000E4 0000000C  83 C1 00 08 */	lwz r30, 8(r1)
/* 801000E8 00000010  80 01 00 24 */	lwz r0, 0x24(r1)
/* 801000EC 00000014  7C 08 03 A6 */	mtlr r0
/* 801000F0 00000018  38 21 00 20 */	addi r1, r1, 0x20
/* 801000F4 0000001C  4E 80 00 20 */	blr 

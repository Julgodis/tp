...
/* 800F1C1C 00000014  40 81 00 80 */	ble lbl_800F1C9C
/* 800F1C20 00000018  7F C3 F3 78 */	mr r3, r30
/* 800F1C24 0000001C  38 80 00 01 */	li r4, 1
/* 800F1C28 00000020  4B FC 5F D1 */	bl orderTalk__9daAlink_cFi
/* 800F1C2C 00000024  2C 03 00 00 */	cmpwi r3, 0
/* 800F1C30 00000028  41 82 00 0C */	beq lbl_800F1C3C
/* 800F1C34 0000002C  38 60 00 01 */	li r3, 1
/* 800F1C38 00000030  48 00 00 C8 */	b lbl_800F1D00
lbl_800F1C3C:
...
/* 800F1C74 0000000C  40 81 00 28 */	ble lbl_800F1C9C
/* 800F1C78 00000010  7F C3 F3 78 */	mr r3, r30
/* 800F1C7C 00000014  4B FF ED 05 */	bl procHorseWaitInit__9daAlink_cFv
/* 800F1C80 00000018  80 7E 20 60 */	lwz r3, 0x2060(r30)
/* 800F1C84 0000001C  C0 22 93 24 */	lfs f1, LIT_7450(r2)
/* 800F1C88 00000020  38 80 00 00 */	li r4, 0
/* 800F1C8C 00000024  38 A0 00 23 */	li r5, 0x23
/* 800F1C90 00000028  4B F1 DB B9 */	bl initOldFrameMorf__22mDoExt_MtxCalcOldFrameFfUsUs
/* 800F1C94 0000002C  38 60 00 01 */	li r3, 1
/* 800F1C98 00000030  48 00 00 68 */	b lbl_800F1D00
lbl_800F1C9C:
...
/* 800F1CB0 00000014  4C 41 13 82 */	cror 2, 1, 2
/* 800F1CB4 00000018  40 82 00 48 */	bne lbl_800F1CFC
/* 800F1CB8 0000001C  C0 03 00 4C */	lfs f0, 0x4c(r3)
/* 800F1CBC 00000020  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800F1CC0 00000024  40 80 00 3C */	bge lbl_800F1CFC
/* 800F1CC4 00000028  80 1E 05 70 */	lwz r0, 0x570(r30)
/* 800F1CC8 0000002C  54 00 06 73 */	rlwinm. r0, r0, 0, 0x19, 0x19
/* 800F1CCC 00000030  40 82 00 14 */	bne lbl_800F1CE0
/* 800F1CD0 00000034  7F C3 F3 78 */	mr r3, r30
/* 800F1CD4 00000038  3C 80 00 02 */	lis r4, 0x0002 /* 00020005@ha */
/* 800F1CD8 0000003C  38 84 00 05 */	addi r4, r4, 0x0005 /* 00020005@l */
/* 800F1CDC 00000040  4B FC D4 11 */	bl seStartSwordCut__9daAlink_cFUl
lbl_800F1CE0:

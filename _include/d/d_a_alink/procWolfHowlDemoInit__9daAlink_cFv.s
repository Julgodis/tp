...
/* 80130714 00000014  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 80130718 00000018  F3 C1 00 38 */	psq_st f30, 56(r1), 0, 0 /* qr0 */
/* 8013071C 0000001C  93 E1 00 2C */	stw r31, 0x2c(r1)
/* 80130720 00000020  93 C1 00 28 */	stw r30, 0x28(r1)
/* 80130724 00000024  7C 7E 1B 78 */	mr r30, r3
/* 80130728 00000028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8013072C 0000002C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80130730 00000030  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80130734 00000034  7F C4 F3 78 */	mr r4, r30
/* 80130738 00000038  38 A0 00 00 */	li r5, 0
/* 8013073C 0000003C  3C C0 00 01 */	lis r6, 0x0001 /* 0000FFFF@ha */
/* 80130740 00000040  38 C6 FF FF */	addi r6, r6, 0xFFFF /* 0000FFFF@l */
/* 80130744 00000044  4B F1 2A 29 */	bl compulsory__14dEvt_control_cFPvPCcUs
/* 80130748 00000048  2C 03 00 00 */	cmpwi r3, 0
/* 8013074C 0000004C  40 82 00 0C */	bne lbl_80130758
/* 80130750 00000050  38 60 00 00 */	li r3, 0
/* 80130754 00000054  48 00 04 48 */	b lbl_80130B9C
lbl_80130758:
...
/* 80130A94 00000058  C0 02 92 BC */	lfs f0, d_d_a_alink__LIT_6041(r2)
/* 80130A98 0000005C  D0 1E 34 7C */	stfs f0, 0x347c(r30)
/* 80130A9C 00000060  48 00 00 50 */	b lbl_80130AEC
lbl_80130AA0:
/* 80130AA0 00000000  C0 02 93 30 */	lfs f0, d_d_a_alink__LIT_7625(r2)
...
/* 80130B44 00000044  3C 60 80 39 */	lis r3, d_d_a_alink__stringBase0@ha
/* 80130B48 00000048  38 63 20 94 */	addi r3, r3, d_d_a_alink__stringBase0@l
...
/* 80130BA0 00000004  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 80130BA4 00000008  E3 C1 00 38 */	psq_l f30, 56(r1), 0, 0 /* qr0 */
/* 80130BA8 0000000C  CB C1 00 30 */	lfd f30, 0x30(r1)
/* 80130BAC 00000010  83 E1 00 2C */	lwz r31, 0x2c(r1)
/* 80130BB0 00000014  83 C1 00 28 */	lwz r30, 0x28(r1)
/* 80130BB4 00000018  80 01 00 54 */	lwz r0, 0x54(r1)
/* 80130BB8 0000001C  7C 08 03 A6 */	mtlr r0
/* 80130BBC 00000020  38 21 00 50 */	addi r1, r1, 0x50
/* 80130BC0 00000024  4E 80 00 20 */	blr 

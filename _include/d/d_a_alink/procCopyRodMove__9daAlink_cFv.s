...
/* 800E2010 00000014  93 E1 00 0C */	stw r31, 0xc(r1)
/* 800E2014 00000018  7C 7F 1B 78 */	mr r31, r3
/* 800E2018 0000001C  4B FD 52 CD */	bl checkItemActorPointer__9daAlink_cFv
/* 800E201C 00000020  2C 03 00 00 */	cmpwi r3, 0
/* 800E2020 00000024  40 82 00 0C */	bne lbl_800E202C
/* 800E2024 00000028  38 60 00 01 */	li r3, 1
/* 800E2028 0000002C  48 00 00 84 */	b lbl_800E20AC
lbl_800E202C:
...
/* 800E2040 00000014  C3 E2 92 BC */	lfs f31, d_d_a_alink__LIT_6041(r2)
...
/* 800E20B0 00000004  CB E1 00 10 */	lfd f31, 0x10(r1)
/* 800E20B4 00000008  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 800E20B8 0000000C  80 01 00 24 */	lwz r0, 0x24(r1)
/* 800E20BC 00000010  7C 08 03 A6 */	mtlr r0
/* 800E20C0 00000014  38 21 00 20 */	addi r1, r1, 0x20
/* 800E20C4 00000018  4E 80 00 20 */	blr 

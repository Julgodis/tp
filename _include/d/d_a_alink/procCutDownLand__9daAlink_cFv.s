...
/* 800D5BEC 00000018  4C 41 13 82 */	cror 2, 1, 2
/* 800D5BF0 0000001C  40 82 00 10 */	bne lbl_800D5C00
/* 800D5BF4 00000020  38 00 00 00 */	li r0, 0
/* 800D5BF8 00000024  B0 1F 30 10 */	sth r0, 0x3010(r31)
/* 800D5BFC 00000028  48 00 00 1C */	b lbl_800D5C18
lbl_800D5C00:
/* 800D5C00 00000000  C0 02 92 E0 */	lfs f0, LIT_6845(r2)
/* 800D5C04 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D5C08 00000008  4C 41 13 82 */	cror 2, 1, 2
/* 800D5C0C 0000000C  40 82 00 0C */	bne lbl_800D5C18
/* 800D5C10 00000010  38 00 00 FE */	li r0, 0xfe
/* 800D5C14 00000014  B0 1F 30 10 */	sth r0, 0x3010(r31)
lbl_800D5C18:
...
/* 800D5C30 00000018  3C 80 00 04 */	lis r4, 0x0004 /* 00040019@ha */
/* 800D5C34 0000001C  38 84 00 19 */	addi r4, r4, 0x0019 /* 00040019@l */
...
/* 800D5C50 00000014  40 81 00 1C */	ble lbl_800D5C6C
/* 800D5C54 00000018  80 1F 31 A0 */	lwz r0, 0x31a0(r31)
/* 800D5C58 0000001C  60 00 00 04 */	ori r0, r0, 4
/* 800D5C5C 00000020  90 1F 31 A0 */	stw r0, 0x31a0(r31)
/* 800D5C60 00000024  7F E3 FB 78 */	mr r3, r31
/* 800D5C64 00000028  38 80 00 01 */	li r4, 1
/* 800D5C68 0000002C  4B FE 44 69 */	bl checkNextAction__9daAlink_cFi
lbl_800D5C6C:

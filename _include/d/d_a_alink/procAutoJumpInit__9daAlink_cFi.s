...
/* 800C5EAC 00000044  C0 22 92 BC */	lfs f1, d_d_a_alink__LIT_6041(r2)
...
/* 800C5F60 00000014  C0 45 00 6C */	lfs f2, 0x6c(r5)
...
/* 800C5FE4 00000008  AB C3 00 52 */	lha r30, 0x52(r3)
/* 800C5FE8 0000000C  3B A0 00 00 */	li r29, 0
/* 800C5FEC 00000010  C0 02 93 9C */	lfs f0, d_d_a_alink__LIT_9053(r2)
...
lbl_800C6040:
/* 800C6040 00000000  3C 60 80 39 */	lis r3, d_d_a_alink__stringBase0@ha
/* 800C6044 00000004  38 63 20 94 */	addi r3, r3, d_d_a_alink__stringBase0@l
...
/* 800C6058 00000018  C0 02 93 38 */	lfs f0, d_d_a_alink__LIT_7807(r2)
/* 800C605C 0000001C  D0 1B 05 94 */	stfs f0, 0x594(r27)
/* 800C6060 00000020  C0 02 93 9C */	lfs f0, d_d_a_alink__LIT_9053(r2)
...
/* 800C6074 00000008  C0 03 00 A8 */	lfs f0, 0xa8(r3)
/* 800C6078 0000000C  D0 1B 05 94 */	stfs f0, 0x594(r27)
/* 800C607C 00000010  C0 03 00 AC */	lfs f0, 0xac(r3)
...
/* 800C608C 00000008  AB C3 00 58 */	lha r30, 0x58(r3)
...
/* 800C60C4 00000008  C0 22 94 AC */	lfs f1, d_d_a_alink__LIT_16641(r2)
...
/* 800C60E4 0000000C  41 81 00 20 */	bgt lbl_800C6104
/* 800C60E8 00000010  2C 1C 00 00 */	cmpwi r28, 0
/* 800C60EC 00000014  40 82 00 18 */	bne lbl_800C6104
/* 800C60F0 00000018  3C 60 80 39 */	lis r3, m__22daAlinkHIO_autoJump_c0@ha
/* 800C60F4 0000001C  38 63 E0 68 */	addi r3, r3, m__22daAlinkHIO_autoJump_c0@l
/* 800C60F8 00000020  88 03 00 50 */	lbz r0, 0x50(r3)
/* 800C60FC 00000024  28 00 00 01 */	cmplwi r0, 1
/* 800C6100 00000028  40 82 00 0C */	bne lbl_800C610C
lbl_800C6104:
...
/* 800C6114 00000008  40 80 00 08 */	bge lbl_800C611C
/* 800C6118 0000000C  D0 1B 05 2C */	stfs f0, 0x52c(r27)
lbl_800C611C:
...
/* 800C6128 0000000C  C0 04 00 64 */	lfs f0, 0x64(r4)
...
/* 800C6180 0000000C  C0 03 00 04 */	lfs f0, 4(r3)
/* 800C6184 00000010  D0 1B 35 8C */	stfs f0, 0x358c(r27)
/* 800C6188 00000014  C0 03 00 08 */	lfs f0, 8(r3)
/* 800C618C 00000018  D0 1B 35 90 */	stfs f0, 0x3590(r27)
/* 800C6190 0000001C  7F 63 DB 78 */	mr r3, r27
/* 800C6194 00000020  3C 80 00 01 */	lis r4, 0x0001 /* 00010006@ha */
/* 800C6198 00000024  38 84 00 06 */	addi r4, r4, 0x0006 /* 00010006@l */

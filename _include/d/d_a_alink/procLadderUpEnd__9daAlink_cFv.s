...
/* 800FD94C 00000014  40 81 00 18 */	ble lbl_800FD964
/* 800FD950 00000018  7F C3 F3 78 */	mr r3, r30
/* 800FD954 0000001C  38 80 00 01 */	li r4, 1
/* 800FD958 00000020  4B FB C7 79 */	bl checkNextAction__9daAlink_cFi
/* 800FD95C 00000024  2C 03 00 00 */	cmpwi r3, 0
/* 800FD960 00000028  40 82 00 50 */	bne lbl_800FD9B0
lbl_800FD964:
...
/* 800FD970 0000000C  4C 41 13 82 */	cror 2, 1, 2
/* 800FD974 00000010  40 82 00 14 */	bne lbl_800FD988
/* 800FD978 00000014  38 00 00 00 */	li r0, 0
/* 800FD97C 00000018  B0 1E 30 0C */	sth r0, 0x300c(r30)
/* 800FD980 0000001C  B0 1E 30 10 */	sth r0, 0x3010(r30)
/* 800FD984 00000020  48 00 00 24 */	b lbl_800FD9A8
lbl_800FD988:
/* 800FD988 00000000  C0 02 94 B4 */	lfs f0, LIT_17382(r2)
/* 800FD98C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800FD990 00000008  4C 41 13 82 */	cror 2, 1, 2
/* 800FD994 0000000C  40 82 00 14 */	bne lbl_800FD9A8
/* 800FD998 00000010  38 00 00 00 */	li r0, 0
/* 800FD99C 00000014  B0 1E 30 A0 */	sth r0, 0x30a0(r30)
/* 800FD9A0 00000018  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 800FD9A4 0000001C  D0 1E 33 F4 */	stfs f0, 0x33f4(r30)
lbl_800FD9A8:

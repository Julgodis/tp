...
/* 80138014 00000014  93 E1 00 0C */	stw r31, 0xc(r1)
/* 80138018 00000018  93 C1 00 08 */	stw r30, 8(r1)
/* 8013801C 0000001C  7C 7F 1B 78 */	mr r31, r3
/* 80138020 00000020  80 03 05 74 */	lwz r0, 0x574(r3)
/* 80138024 00000024  54 00 02 53 */	rlwinm. r0, r0, 0, 9, 9
/* 80138028 00000028  41 82 00 18 */	beq lbl_80138040
/* 8013802C 0000002C  3C 60 80 39 */	lis r3, m__20daAlinkHIO_wlSwim_c0@ha
/* 80138030 00000030  38 63 F8 B4 */	addi r3, r3, m__20daAlinkHIO_wlSwim_c0@l
/* 80138034 00000034  C0 03 00 50 */	lfs f0, 0x50(r3)
/* 80138038 00000038  D0 1F 05 94 */	stfs f0, 0x594(r31)
/* 8013803C 0000003C  48 00 00 14 */	b lbl_80138050
lbl_80138040:
...
/* 8013805C 0000000C  40 81 00 5C */	ble lbl_801380B8
/* 80138060 00000010  AB DF 04 DE */	lha r30, 0x4de(r31)
/* 80138064 00000014  38 7F 04 DE */	addi r3, r31, 0x4de
/* 80138068 00000018  A8 9F 2F E2 */	lha r4, 0x2fe2(r31)
/* 8013806C 0000001C  3C A0 80 39 */	lis r5, m__20daAlinkHIO_wlSwim_c0@ha
/* 80138070 00000020  38 E5 F8 B4 */	addi r7, r5, m__20daAlinkHIO_wlSwim_c0@l
/* 80138074 00000024  A8 A7 00 3C */	lha r5, 0x3c(r7)
/* 80138078 00000028  A8 C7 00 40 */	lha r6, 0x40(r7)
/* 8013807C 0000002C  A8 E7 00 3E */	lha r7, 0x3e(r7)
/* 80138080 00000030  48 13 84 C1 */	bl cLib_addCalcAngleS__FPsssss
/* 80138084 00000034  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80138088 00000038  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 8013808C 0000003C  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80138090 00000040  7C 1E 20 50 */	subf r0, r30, r4
/* 80138094 00000044  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80138098 00000048  7C 63 02 14 */	add r3, r3, r0
/* 8013809C 0000004C  C0 43 00 04 */	lfs f2, 4(r3)
/* 801380A0 00000050  C0 22 92 C4 */	lfs f1, LIT_6109(r2)
/* 801380A4 00000054  C0 1F 33 A8 */	lfs f0, 0x33a8(r31)
/* 801380A8 00000058  EC 01 00 32 */	fmuls f0, f1, f0
/* 801380AC 0000005C  EF E0 00 B2 */	fmuls f31, f0, f2
/* 801380B0 00000060  B0 9F 04 E6 */	sth r4, 0x4e6(r31)
/* 801380B4 00000064  48 00 00 08 */	b lbl_801380BC
lbl_801380B8:
...
/* 8013816C 00000004  CB E1 00 10 */	lfd f31, 0x10(r1)
/* 80138170 00000008  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80138174 0000000C  83 C1 00 08 */	lwz r30, 8(r1)
/* 80138178 00000010  80 01 00 24 */	lwz r0, 0x24(r1)
/* 8013817C 00000014  7C 08 03 A6 */	mtlr r0
/* 80138180 00000018  38 21 00 20 */	addi r1, r1, 0x20
/* 80138184 0000001C  4E 80 00 20 */	blr 

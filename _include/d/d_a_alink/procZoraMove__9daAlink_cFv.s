...
/* 8011DC88 000000EC  40 80 01 24 */	bge lbl_8011DDAC
/* 8011DC8C 000000F0  C0 01 00 24 */	lfs f0, 0x24(r1)
/* 8011DC90 000000F4  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8011DC94 000000F8  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 8011DC98 000000FC  C0 01 00 2C */	lfs f0, 0x2c(r1)
/* 8011DC9C 00000100  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8011DCA0 00000104  38 61 00 0C */	addi r3, r1, 0xc
/* 8011DCA4 00000108  48 22 94 95 */	bl PSVECSquareMag
/* 8011DCA8 0000010C  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 8011DCAC 00000110  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8011DCB0 00000114  40 81 00 58 */	ble lbl_8011DD08
/* 8011DCB4 00000118  FC 00 08 34 */	frsqrte f0, f1
/* 8011DCB8 0000011C  C8 82 92 E8 */	lfd f4, d_d_a_alink__LIT_6846(r2)
/* 8011DCBC 00000120  FC 44 00 32 */	fmul f2, f4, f0
/* 8011DCC0 00000124  C8 62 92 F0 */	lfd f3, LIT_6847(r2)
/* 8011DCC4 00000128  FC 00 00 32 */	fmul f0, f0, f0
/* 8011DCC8 0000012C  FC 01 00 32 */	fmul f0, f1, f0
/* 8011DCCC 00000130  FC 03 00 28 */	fsub f0, f3, f0
/* 8011DCD0 00000134  FC 02 00 32 */	fmul f0, f2, f0
/* 8011DCD4 00000138  FC 44 00 32 */	fmul f2, f4, f0
/* 8011DCD8 0000013C  FC 00 00 32 */	fmul f0, f0, f0
/* 8011DCDC 00000140  FC 01 00 32 */	fmul f0, f1, f0
/* 8011DCE0 00000144  FC 03 00 28 */	fsub f0, f3, f0
/* 8011DCE4 00000148  FC 02 00 32 */	fmul f0, f2, f0
/* 8011DCE8 0000014C  FC 44 00 32 */	fmul f2, f4, f0
/* 8011DCEC 00000150  FC 00 00 32 */	fmul f0, f0, f0
/* 8011DCF0 00000154  FC 01 00 32 */	fmul f0, f1, f0
/* 8011DCF4 00000158  FC 03 00 28 */	fsub f0, f3, f0
/* 8011DCF8 0000015C  FC 02 00 32 */	fmul f0, f2, f0
/* 8011DCFC 00000160  FC 41 00 32 */	fmul f2, f1, f0
/* 8011DD00 00000164  FC 40 10 18 */	frsp f2, f2
/* 8011DD04 00000168  48 00 00 90 */	b lbl_8011DD94
lbl_8011DD08:
/* 8011DD08 00000000  C8 02 92 F8 */	lfd f0, LIT_6848(r2)
/* 8011DD0C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8011DD10 00000008  40 80 00 10 */	bge lbl_8011DD20
/* 8011DD14 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8011DD18 00000010  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 8011DD1C 00000014  48 00 00 78 */	b lbl_8011DD94
lbl_8011DD20:

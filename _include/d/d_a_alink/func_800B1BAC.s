...
/* 800B1BC0 00000014  DB C1 00 30 */	stfd f30, 0x30(r1)
/* 800B1BC4 00000018  F3 C1 00 38 */	psq_st f30, 56(r1), 0, 0 /* qr0 */
/* 800B1BC8 0000001C  DB A1 00 20 */	stfd f29, 0x20(r1)
/* 800B1BCC 00000020  F3 A1 00 28 */	psq_st f29, 40(r1), 0, 0 /* qr0 */
/* 800B1BD0 00000024  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 800B1BD4 00000028  93 C1 00 18 */	stw r30, 0x18(r1)
/* 800B1BD8 0000002C  7C 7E 1B 78 */	mr r30, r3
/* 800B1BDC 00000030  C3 C2 92 C0 */	lfs f30, LIT_6108(r2)
/* 800B1BE0 00000034  FF A0 F0 90 */	fmr f29, f30
/* 800B1BE4 00000038  C3 E3 2B A8 */	lfs f31, 0x2ba8(r3)
/* 800B1BE8 0000003C  48 06 40 39 */	bl func_80115C20
/* 800B1BEC 00000040  7C 7F 1B 78 */	mr r31, r3
/* 800B1BF0 00000044  80 1E 19 9C */	lwz r0, 0x199c(r30)
/* 800B1BF4 00000048  54 00 06 B5 */	rlwinm. r0, r0, 0, 0x1a, 0x1a
/* 800B1BF8 0000004C  41 82 01 EC */	beq lbl_800B1DE4
/* 800B1BFC 00000050  88 1E 2F BB */	lbz r0, 0x2fbb(r30)
/* 800B1C00 00000054  28 00 00 03 */	cmplwi r0, 3
/* 800B1C04 00000058  41 82 00 14 */	beq lbl_800B1C18
/* 800B1C08 0000005C  7F C3 F3 78 */	mr r3, r30
/* 800B1C0C 00000060  48 05 3E 8D */	bl func_80105A98
/* 800B1C10 00000064  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 800B1C14 00000068  41 82 01 D0 */	beq lbl_800B1DE4
lbl_800B1C18:
...
/* 800B1C38 00000020  48 05 3E 61 */	bl func_80105A98
...
/* 800B1C48 00000030  48 00 1C BD */	bl func_800B3904
...
lbl_800B1C60:
/* 800B1C60 00000000  C3 A2 92 B8 */	lfs f29, d_d_a_alink__LIT_6040(r2)
...
/* 800B1C84 0000000C  40 81 00 08 */	ble lbl_800B1C8C
/* 800B1C88 00000010  C3 A2 93 30 */	lfs f29, d_d_a_alink__LIT_7625(r2)
lbl_800B1C8C:
...
/* 800B1CA0 0000000C  C3 C2 92 A0 */	lfs f30, d_d_a_alink__LIT_5945(r2)
...
/* 800B1CB0 0000001C  40 81 00 0C */	ble lbl_800B1CBC
/* 800B1CB4 00000020  C3 A2 93 30 */	lfs f29, d_d_a_alink__LIT_7625(r2)
/* 800B1CB8 00000024  48 00 01 34 */	b lbl_800B1DEC
lbl_800B1CBC:
/* 800B1CBC 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800B1CC0 00000004  38 63 D6 64 */	addi r3, r3, -10652
...
/* 800B1CF8 00000018  40 81 00 0C */	ble lbl_800B1D04
/* 800B1CFC 0000001C  C3 A2 93 30 */	lfs f29, d_d_a_alink__LIT_7625(r2)
/* 800B1D00 00000020  48 00 00 EC */	b lbl_800B1DEC
lbl_800B1D04:
/* 800B1D04 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800B1D08 00000004  38 63 D6 64 */	addi r3, r3, -10652
...
/* 800B1D3C 00000014  40 80 00 44 */	bge lbl_800B1D80
/* 800B1D40 00000018  C3 DE 34 58 */	lfs f30, 0x3458(r30)
/* 800B1D44 0000001C  C0 3E 2B A8 */	lfs f1, 0x2ba8(r30)
/* 800B1D48 00000020  C0 02 94 34 */	lfs f0, LIT_14624(r2)
/* 800B1D4C 00000024  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B1D50 00000028  40 81 00 0C */	ble lbl_800B1D5C
/* 800B1D54 0000002C  C3 A2 93 30 */	lfs f29, d_d_a_alink__LIT_7625(r2)
/* 800B1D58 00000030  48 00 00 10 */	b lbl_800B1D68
lbl_800B1D5C:
/* 800B1D5C 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800B1D60 00000004  38 63 D6 64 */	addi r3, r3, -10652
...
/* 800B1D84 00000004  3C 60 80 39 */	lis r3, 0x8039
/* 800B1D88 00000008  38 63 D6 64 */	addi r3, r3, -10652
...
/* 800B1DA0 0000000C  40 80 00 14 */	bge lbl_800B1DB4
/* 800B1DA4 00000010  C0 3E 2B A8 */	lfs f1, 0x2ba8(r30)
/* 800B1DA8 00000014  C0 02 94 34 */	lfs f0, LIT_14624(r2)
/* 800B1DAC 00000018  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800B1DB0 0000001C  41 80 00 3C */	blt lbl_800B1DEC
lbl_800B1DB4:
...
/* 800B1DC0 0000000C  40 80 00 14 */	bge lbl_800B1DD4
/* 800B1DC4 00000010  3C 60 80 39 */	lis r3, 0x8039
/* 800B1DC8 00000014  38 63 D6 64 */	addi r3, r3, -10652
/* 800B1DCC 00000018  C3 A3 00 4C */	lfs f29, 0x4c(r3)
/* 800B1DD0 0000001C  48 00 00 1C */	b lbl_800B1DEC
lbl_800B1DD4:
/* 800B1DD4 00000000  3C 60 80 39 */	lis r3, 0x8039
/* 800B1DD8 00000004  38 63 D6 64 */	addi r3, r3, -10652
...
/* 800B1DE8 00000004  C3 A2 93 30 */	lfs f29, d_d_a_alink__LIT_7625(r2)
lbl_800B1DEC:
/* 800B1DEC 00000000  C0 02 92 C0 */	lfs f0, LIT_6108(r2)
/* 800B1DF0 00000004  FC 1D 00 40 */	fcmpo cr0, f29, f0
/* 800B1DF4 00000008  40 81 00 14 */	ble lbl_800B1E08
/* 800B1DF8 0000000C  38 7E 2B A8 */	addi r3, r30, 0x2ba8
/* 800B1DFC 00000010  FC 20 F0 90 */	fmr f1, f30
/* 800B1E00 00000014  FC 40 E8 90 */	fmr f2, f29
/* 800B1E04 00000018  48 1B E9 3D */	bl func_80270740
lbl_800B1E08:
...
/* 800B1E14 0000000C  40 80 00 E8 */	bge lbl_800B1EFC
/* 800B1E18 00000010  88 1E 2F BB */	lbz r0, 0x2fbb(r30)
/* 800B1E1C 00000014  98 1E 2F C9 */	stb r0, 0x2fc9(r30)
/* 800B1E20 00000018  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)
/* 800B1E24 0000001C  28 00 01 55 */	cmplwi r0, 0x155
/* 800B1E28 00000020  40 82 00 0C */	bne lbl_800B1E34
/* 800B1E2C 00000024  38 00 00 7F */	li r0, 0x7f
/* 800B1E30 00000028  48 00 00 58 */	b lbl_800B1E88
lbl_800B1E34:
...
/* 800B1E50 0000001C  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
...
/* 800B1E90 00000008  48 21 1B D5 */	bl func_802C3A64
...
/* 800B1EAC 00000024  40 81 00 A8 */	ble lbl_800B1F54
/* 800B1EB0 00000028  88 1E 2F BB */	lbz r0, 0x2fbb(r30)
/* 800B1EB4 0000002C  28 00 00 0D */	cmplwi r0, 0xd
/* 800B1EB8 00000030  40 82 00 24 */	bne lbl_800B1EDC
/* 800B1EBC 00000034  7F C3 F3 78 */	mr r3, r30
/* 800B1EC0 00000038  3C 80 00 02 */	lis r4, 2
/* 800B1EC4 0000003C  38 84 00 73 */	addi r4, r4, 0x73
/* 800B1EC8 00000040  81 9E 06 28 */	lwz r12, 0x628(r30)
/* 800B1ECC 00000044  81 8C 01 1C */	lwz r12, 0x11c(r12)
/* 800B1ED0 00000048  7D 89 03 A6 */	mtctr r12
/* 800B1ED4 0000004C  4E 80 04 21 */	bctrl 
/* 800B1ED8 00000050  48 00 00 7C */	b lbl_800B1F54
lbl_800B1EDC:
/* 800B1EDC 00000000  7F C3 F3 78 */	mr r3, r30
/* 800B1EE0 00000004  3C 80 00 02 */	lis r4, 2
/* 800B1EE4 00000008  38 84 00 70 */	addi r4, r4, 0x70
...
/* 800B1F14 00000018  3C 80 00 02 */	lis r4, 2
/* 800B1F18 0000001C  38 84 00 74 */	addi r4, r4, 0x74
...
/* 800B1F34 00000004  3C 80 00 02 */	lis r4, 2
/* 800B1F38 00000008  38 84 00 71 */	addi r4, r4, 0x71
...
/* 800B1F74 00000020  40 80 00 14 */	bge lbl_800B1F88
/* 800B1F78 00000024  80 6D 8A 98 */	lwz r3, data_80451018(r13)
/* 800B1F7C 00000028  80 03 08 98 */	lwz r0, 0x898(r3)
/* 800B1F80 0000002C  60 00 00 08 */	ori r0, r0, 8
/* 800B1F84 00000030  90 03 08 98 */	stw r0, 0x898(r3)
lbl_800B1F88:
/* 800B1F88 00000000  E3 E1 00 48 */	psq_l f31, 72(r1), 0, 0 /* qr0 */
/* 800B1F8C 00000004  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 800B1F90 00000008  E3 C1 00 38 */	psq_l f30, 56(r1), 0, 0 /* qr0 */
/* 800B1F94 0000000C  CB C1 00 30 */	lfd f30, 0x30(r1)
/* 800B1F98 00000010  E3 A1 00 28 */	psq_l f29, 40(r1), 0, 0 /* qr0 */
/* 800B1F9C 00000014  CB A1 00 20 */	lfd f29, 0x20(r1)
/* 800B1FA0 00000018  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 800B1FA4 0000001C  83 C1 00 18 */	lwz r30, 0x18(r1)
/* 800B1FA8 00000020  80 01 00 54 */	lwz r0, 0x54(r1)
/* 800B1FAC 00000024  7C 08 03 A6 */	mtlr r0
/* 800B1FB0 00000028  38 21 00 50 */	addi r1, r1, 0x50
/* 800B1FB4 0000002C  4E 80 00 20 */	blr 

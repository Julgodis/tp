...
/* 800D53DC 00000014  93 E1 00 3C */	stw r31, 0x3c(r1)
/* 800D53E0 00000018  7C 7F 1B 78 */	mr r31, r3
/* 800D53E4 0000001C  80 03 06 14 */	lwz r0, 0x614(r3)
/* 800D53E8 00000020  28 00 00 51 */	cmplwi r0, 0x51
/* 800D53EC 00000024  40 82 00 20 */	bne lbl_800D540C
/* 800D53F0 00000028  A0 1F 2F E8 */	lhz r0, 0x2fe8(r31)
/* 800D53F4 0000002C  28 00 00 2B */	cmplwi r0, 0x2b
/* 800D53F8 00000030  41 82 00 0C */	beq lbl_800D5404
/* 800D53FC 00000034  28 00 00 2C */	cmplwi r0, 0x2c
/* 800D5400 00000038  40 82 00 0C */	bne lbl_800D540C
lbl_800D5404:
...
/* 800D55CC 00000090  40 81 00 58 */	ble lbl_800D5624
/* 800D55D0 00000094  FC 00 08 34 */	frsqrte f0, f1
/* 800D55D4 00000098  C8 82 92 E8 */	lfd f4, d_d_a_alink__LIT_6846(r2)
/* 800D55D8 0000009C  FC 44 00 32 */	fmul f2, f4, f0
/* 800D55DC 000000A0  C8 62 92 F0 */	lfd f3, LIT_6847(r2)
/* 800D55E0 000000A4  FC 00 00 32 */	fmul f0, f0, f0
/* 800D55E4 000000A8  FC 01 00 32 */	fmul f0, f1, f0
/* 800D55E8 000000AC  FC 03 00 28 */	fsub f0, f3, f0
/* 800D55EC 000000B0  FC 02 00 32 */	fmul f0, f2, f0
/* 800D55F0 000000B4  FC 44 00 32 */	fmul f2, f4, f0
/* 800D55F4 000000B8  FC 00 00 32 */	fmul f0, f0, f0
/* 800D55F8 000000BC  FC 01 00 32 */	fmul f0, f1, f0
/* 800D55FC 000000C0  FC 03 00 28 */	fsub f0, f3, f0
/* 800D5600 000000C4  FC 02 00 32 */	fmul f0, f2, f0
/* 800D5604 000000C8  FC 44 00 32 */	fmul f2, f4, f0
/* 800D5608 000000CC  FC 00 00 32 */	fmul f0, f0, f0
/* 800D560C 000000D0  FC 01 00 32 */	fmul f0, f1, f0
/* 800D5610 000000D4  FC 03 00 28 */	fsub f0, f3, f0
/* 800D5614 000000D8  FC 02 00 32 */	fmul f0, f2, f0
/* 800D5618 000000DC  FC 21 00 32 */	fmul f1, f1, f0
/* 800D561C 000000E0  FC 20 08 18 */	frsp f1, f1
/* 800D5620 000000E4  48 00 00 88 */	b lbl_800D56A8
lbl_800D5624:
/* 800D5624 00000000  C8 02 92 F8 */	lfd f0, LIT_6848(r2)
/* 800D5628 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 800D562C 00000008  40 80 00 10 */	bge lbl_800D563C
/* 800D5630 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 800D5634 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
/* 800D5638 00000014  48 00 00 70 */	b lbl_800D56A8
lbl_800D563C:
...
/* 800D56B4 0000000C  40 81 00 08 */	ble lbl_800D56BC
/* 800D56B8 00000010  FF E0 00 90 */	fmr f31, f0
lbl_800D56BC:
...
/* 800D5720 0000001C  C0 02 93 2C */	lfs f0, d_d_a_alink__LIT_7624(r2)
...
/* 800D5738 0000000C  C0 02 92 B8 */	lfs f0, d_d_a_alink__LIT_6040(r2)
...
/* 800D5768 0000003C  40 81 00 08 */	ble lbl_800D5770
/* 800D576C 00000040  FC 20 00 90 */	fmr f1, f0
lbl_800D5770:
...
/* 800D5784 00000014  40 81 00 0C */	ble lbl_800D5790
/* 800D5788 00000018  FC 00 08 34 */	frsqrte f0, f1
/* 800D578C 0000001C  EC 20 00 72 */	fmuls f1, f0, f1
lbl_800D5790:
...
/* 800D57AC 00000004  3C 80 00 01 */	lis r4, 0x0001 /* 00010094@ha */
/* 800D57B0 00000008  38 84 00 94 */	addi r4, r4, 0x0094 /* 00010094@l */
...
/* 800D57E0 00000004  CB E1 00 40 */	lfd f31, 0x40(r1)
/* 800D57E4 00000008  83 E1 00 3C */	lwz r31, 0x3c(r1)
/* 800D57E8 0000000C  80 01 00 54 */	lwz r0, 0x54(r1)
/* 800D57EC 00000010  7C 08 03 A6 */	mtlr r0
/* 800D57F0 00000014  38 21 00 50 */	addi r1, r1, 0x50
/* 800D57F4 00000018  4E 80 00 20 */	blr 

...
/* 8020C48C 00000030  3C A0 6E 61 */	lis r5, 0x6E61 /* 6E616C6C@ha */
/* 8020C490 00000034  38 C5 6C 6C */	addi r6, r5, 0x6C6C /* 6E616C6C@l */
/* 8020C494 00000038  3C A0 68 61 */	lis r5, 0x6861 /* 68616B75@ha */
/* 8020C498 0000003C  38 A5 6B 75 */	addi r5, r5, 0x6B75 /* 68616B75@l */
...
/* 8020C4D0 00000008  3C 80 80 3A */	lis r4, d_d_meter_hakusha__stringBase0@ha
/* 8020C4D4 0000000C  38 84 81 B0 */	addi r4, r4, d_d_meter_hakusha__stringBase0@l
...
/* 8020C508 00000040  3C A0 6B 75 */	lis r5, 0x6B75 /* 6B755F6E@ha */
/* 8020C50C 00000044  38 C5 5F 6E */	addi r6, r5, 0x5F6E /* 6B755F6E@l */
...
/* 8020C53C 00000018  3C A0 5F 62 */	lis r5, 0x5F62 /* 5F625F6E@ha */
/* 8020C540 0000001C  38 C5 5F 6E */	addi r6, r5, 0x5F6E /* 5F625F6E@l */
/* 8020C544 00000020  3C A0 68 61 */	lis r5, 0x6861 /* 68616B75@ha */
/* 8020C548 00000024  38 A5 6B 75 */	addi r5, r5, 0x6B75 /* 68616B75@l */
...
/* 8020C564 00000008  C0 22 AE 00 */	lfs f1, d_d_meter_hakusha__LIT_3793(r2)
/* 8020C568 0000000C  48 04 92 69 */	bl setAlphaRate__13CPaneMgrAlphaFf
/* 8020C56C 00000010  80 7F 00 30 */	lwz r3, 0x30(r31)
/* 8020C570 00000014  C0 22 AE 00 */	lfs f1, d_d_meter_hakusha__LIT_3793(r2)
...
/* 8020C594 00000038  C0 02 AE 00 */	lfs f0, d_d_meter_hakusha__LIT_3793(r2)
...
/* 8020C604 00000008  3C 80 80 3A */	lis r4, d_d_meter_hakusha__stringBase0@ha
/* 8020C608 0000000C  38 84 81 B0 */	addi r4, r4, d_d_meter_hakusha__stringBase0@l
...
/* 8020C638 0000003C  3C A0 74 6E */	lis r5, 0x746E /* 746E5F6E@ha */
/* 8020C63C 00000040  38 C5 5F 6E */	addi r6, r5, 0x5F6E /* 746E5F6E@l */
...
/* 8020C664 00000010  C0 22 AE 00 */	lfs f1, d_d_meter_hakusha__LIT_3793(r2)
/* 8020C668 00000014  48 04 91 69 */	bl setAlphaRate__13CPaneMgrAlphaFf
/* 8020C66C 00000018  80 7F 00 0C */	lwz r3, 0xc(r31)
/* 8020C670 0000001C  3C 80 66 6F */	lis r4, 0x666F /* 666F5F6E@ha */
/* 8020C674 00000020  38 C4 5F 6E */	addi r6, r4, 0x5F6E /* 666F5F6E@l */
...
/* 8020C68C 00000038  C0 02 AE 00 */	lfs f0, d_d_meter_hakusha__LIT_3793(r2)
...
/* 8020C6CC 00000078  3C 80 80 3A */	lis r4, d_d_meter_hakusha__stringBase0@ha
/* 8020C6D0 0000007C  38 84 81 B0 */	addi r4, r4, d_d_meter_hakusha__stringBase0@l
...
/* 8020C6E8 00000094  C0 22 AE 04 */	lfs f1, d_d_meter_hakusha__LIT_3794(r2)
...
/* 8020C7E0 000000C0  C0 02 AE 00 */	lfs f0, d_d_meter_hakusha__LIT_3793(r2)

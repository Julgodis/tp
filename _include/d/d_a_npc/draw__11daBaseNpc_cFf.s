...
/* 8014EC64 00000014  39 61 00 20 */	addi r11, r1, 0x20
/* 8014EC68 00000018  48 21 35 71 */	bl _savegpr_28
/* 8014EC6C 0000001C  7C 7D 1B 78 */	mr r29, r3
/* 8014EC70 00000020  FF E0 08 90 */	fmr f31, f1
/* 8014EC74 00000024  80 63 07 54 */	lwz r3, 0x754(r3)
/* 8014EC78 00000028  83 E3 00 04 */	lwz r31, 4(r3)
/* 8014EC7C 0000002C  83 DF 00 04 */	lwz r30, 4(r31)
/* 8014EC80 00000030  48 05 D8 FD */	bl dKy_darkworld_check__Fv
/* 8014EC84 00000034  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8014EC88 00000038  41 82 00 20 */	beq lbl_8014ECA8
/* 8014EC8C 0000003C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8014EC90 00000040  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8014EC94 00000044  38 80 00 04 */	li r4, 4
/* 8014EC98 00000048  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8014EC9C 0000004C  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8014ECA0 00000050  48 05 4B 25 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8014ECA4 00000054  48 00 00 1C */	b lbl_8014ECC0
lbl_8014ECA8:
...
/* 8014EDF0 0000002C  C0 A2 99 DC */	lfs f5, d_d_a_npc__LIT_4140(r2)
...
/* 8014EE20 00000004  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 8014EE24 00000008  39 61 00 20 */	addi r11, r1, 0x20
/* 8014EE28 0000000C  48 21 33 FD */	bl _restgpr_28
/* 8014EE2C 00000010  80 01 00 34 */	lwz r0, 0x34(r1)
/* 8014EE30 00000014  7C 08 03 A6 */	mtlr r0
/* 8014EE34 00000018  38 21 00 30 */	addi r1, r1, 0x30
/* 8014EE38 0000001C  4E 80 00 20 */	blr 

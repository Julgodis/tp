...
/* 801A9D80 00000020  48 1B 84 3D */	bl _savegpr_21
...
/* 801A9D94 00000034  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A9D98 00000038  3B 83 CA 54 */	addi r28, r3, g_env_light@l
/* 801A9D9C 0000003C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 801A9DA0 00000040  3A A3 61 C0 */	addi r21, r3, g_dComIfG_gameInfo@l
...
/* 801A9DC0 00000060  3C 80 80 39 */	lis r4, d_d_kankyo__stringBase0@ha
/* 801A9DC4 00000064  38 84 4C 6C */	addi r4, r4, d_d_kankyo__stringBase0@l
/* 801A9DC8 00000068  38 84 02 49 */	addi r4, r4, 0x249
/* 801A9DCC 0000006C  48 1B EB C9 */	bl strcmp
/* 801A9DD0 00000070  2C 03 00 00 */	cmpwi r3, 0
/* 801A9DD4 00000074  41 82 00 58 */	beq lbl_801A9E2C
/* 801A9DD8 00000078  88 8D 87 E4 */	lbz r4, merged_80450D64+0(r13)
...
/* 801A9DE8 00000088  4B E7 A5 9D */	bl getStatusRoomDt__20dStage_roomControl_cFi
...
/* 801A9F84 0000002C  3C 80 80 39 */	lis r4, d_d_kankyo__stringBase0@ha
/* 801A9F88 00000030  38 84 4C 6C */	addi r4, r4, d_d_kankyo__stringBase0@l
...
/* 801AA024 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 801AA028 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 801AA12C 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 801AA130 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 801AA1B4 00000010  48 19 D1 E9 */	bl PSVECSquareDistance
...
/* 801AA224 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 801AA228 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 801AA320 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 801AA324 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 801AA3A8 00000010  48 19 CF F5 */	bl PSVECSquareDistance
...
/* 801AA418 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 801AA41C 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 801AA53C 0000000C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 801AA540 00000010  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 801AA650 00000014  48 1B 7B B9 */	bl _restgpr_21

...
/* 8019D2E0 0000001C  C0 02 A2 0C */	lfs f0, d_d_kankyo__LIT_4409(r2)
/* 8019D2E4 00000020  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8019D2E8 00000024  4C 40 13 82 */	cror 2, 0, 2
/* 8019D2EC 00000028  41 82 00 10 */	beq lbl_8019D2FC
/* 8019D2F0 0000002C  C0 02 A2 2C */	lfs f0, d_d_kankyo__LIT_4442(r2)
/* 8019D2F4 00000030  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8019D2F8 00000034  40 81 00 08 */	ble lbl_8019D300
lbl_8019D2FC:
/* 8019D2FC 00000000  3B E0 00 00 */	li r31, 0
lbl_8019D300:
/* 8019D300 00000000  C0 02 A2 3C */	lfs f0, d_d_kankyo__LIT_4502(r2)
/* 8019D304 00000004  EC 20 00 72 */	fmuls f1, f0, f1
/* 8019D308 00000008  C0 02 A2 40 */	lfs f0, d_d_kankyo__LIT_4503(r2)
/* 8019D30C 0000000C  EC 21 00 24 */	fdivs f1, f1, f0
/* 8019D310 00000010  48 1C ED 19 */	bl func_8036C028
...
/* 8019D324 00000024  3C 60 80 3C */	lis r3, 0x803c
/* 8019D328 00000028  38 63 BF 3C */	addi r3, r3, -16580
...
/* 8019D33C 0000003C  C0 02 A2 44 */	lfs f0, d_d_kankyo__LIT_4504(r2)
/* 8019D340 00000040  EC C0 01 32 */	fmuls f6, f0, f4
/* 8019D344 00000044  C0 22 A1 E0 */	lfs f1, d_d_kankyo__LIT_4353(r2)
/* 8019D348 00000048  C0 02 A2 0C */	lfs f0, d_d_kankyo__LIT_4409(r2)
/* 8019D34C 0000004C  48 00 00 DC */	b lbl_8019D428
/* 8019D350 00000050  FC 20 20 50 */	fneg f1, f4
/* 8019D354 00000054  C0 02 A2 48 */	lfs f0, d_d_kankyo__LIT_4505(r2)
...
/* 8019D364 00000064  C0 02 A2 0C */	lfs f0, d_d_kankyo__LIT_4409(r2)
/* 8019D368 00000068  48 00 00 C0 */	b lbl_8019D428
/* 8019D36C 0000006C  C0 C2 A2 0C */	lfs f6, d_d_kankyo__LIT_4409(r2)
/* 8019D370 00000070  FC 20 20 50 */	fneg f1, f4
/* 8019D374 00000074  C0 02 A2 48 */	lfs f0, d_d_kankyo__LIT_4505(r2)
...
/* 8019D388 00000088  C0 02 A2 48 */	lfs f0, d_d_kankyo__LIT_4505(r2)
/* 8019D38C 0000008C  EC 00 20 28 */	fsubs f0, f0, f4
/* 8019D390 00000090  EC 40 00 32 */	fmuls f2, f0, f0
/* 8019D394 00000094  C0 22 A2 4C */	lfs f1, d_d_kankyo__LIT_4506(r2)
...
/* 8019D3E4 000000E4  C0 22 A2 48 */	lfs f1, d_d_kankyo__LIT_4505(r2)
/* 8019D3E8 000000E8  EC 01 20 28 */	fsubs f0, f1, f4
/* 8019D3EC 000000EC  EC 40 00 32 */	fmuls f2, f0, f0
/* 8019D3F0 000000F0  C0 02 A2 4C */	lfs f0, d_d_kankyo__LIT_4506(r2)
...
/* 8019D404 00000104  C0 02 A2 58 */	lfs f0, d_d_kankyo__LIT_4509(r2)
/* 8019D408 00000108  EC 00 01 32 */	fmuls f0, f0, f4
/* 8019D40C 0000010C  EC 20 10 24 */	fdivs f1, f0, f2
/* 8019D410 00000110  C0 02 A2 5C */	lfs f0, d_d_kankyo__LIT_4510(r2)
/* 8019D414 00000114  EC 00 10 24 */	fdivs f0, f0, f2
/* 8019D418 00000118  48 00 00 10 */	b lbl_8019D428
lbl_8019D41C:
/* 8019D41C 00000000  C0 C2 A2 48 */	lfs f6, d_d_kankyo__LIT_4505(r2)
/* 8019D420 00000004  C0 22 A2 0C */	lfs f1, d_d_kankyo__LIT_4409(r2)

...
/* 8019ED30 00000098  48 00 91 59 */	bl dKy_actor_addcol_set(s16, s16, s16, f32)
...
/* 8019ED40 000000A8  48 00 93 91 */	bl dKy_fog_startendz_set(f32, f32, f32)
...
/* 8019ED54 000000BC  48 00 93 0D */	bl dKy_vrbox_addcol_set(s16, s16, s16, f32)
...
/* 8019ED94 000000FC  4B EB 7C 91 */	bl dKyd_xfog_table_set(u8)
...
/* 8019EE78 00000020  4B FF FD 59 */	bl dKy_light_size_get(const s8*)
...
/* 8019EEDC 00000084  4B EB 7B 3D */	bl dKyd_schejule_boss_getp(void)
...
lbl_8019EEF0:
/* 8019EEF0 00000000  4B EB 7B 1D */	bl dKyd_schejule_getp(void)
...
/* 8019F048 00000048  48 0C 89 0D */	bl cM_rndF(f32)
...
lbl_8019F0D4:
/* 8019F0D4 00000000  4B EB 79 21 */	bl dKyd_dmenvr_getp(void)
...
lbl_8019F0FC:
/* 8019F0FC 00000000  4B EB 78 E1 */	bl dKyd_dmpalet_getp(void)
...
lbl_8019F124:
/* 8019F124 00000000  4B EB 78 C5 */	bl dKyd_dmpselect_getp(void)
...
lbl_8019F14C:
/* 8019F14C 00000000  4B EB 78 B5 */	bl dKyd_dmvrbox_getp(void)
...
lbl_8019F15C:
/* 8019F15C 00000000  4B FF F5 39 */	bl plight_init(void)
/* 8019F160 00000004  4B FF F5 D5 */	bl plight_set(void)
/* 8019F164 00000008  4B FF F5 A5 */	bl darkmist_init(void)
/* 8019F168 0000000C  4B FF F6 ED */	bl bgparts_activelight_init(void)
...
/* 8019F19C 00000040  4B FF F9 05 */	bl undwater_init(void)
/* 8019F1A0 00000044  38 60 00 00 */	li r3, 0
/* 8019F1A4 00000048  4B E9 08 4D */	bl dComIfGs_PolyDamageOff_Set(s8)

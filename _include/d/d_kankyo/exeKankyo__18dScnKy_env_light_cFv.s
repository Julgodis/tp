...
/* 801A52F4 00000018  88 85 12 CE */	lbz r4, 0x12ce(r5)
/* 801A52F8 0000001C  98 85 12 CD */	stb r4, 0x12cd(r5)
/* 801A52FC 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 801A5300 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 801A5304 00000028  88 03 4F AD */	lbz r0, 0x4fad(r3)
...
/* 801A5324 00000048  98 05 12 CE */	stb r0, 0x12ce(r5)
/* 801A5328 0000004C  48 00 00 0C */	b lbl_801A5334
lbl_801A532C:
/* 801A532C 00000000  38 04 00 01 */	addi r0, r4, 1
/* 801A5330 00000004  98 05 12 CE */	stb r0, 0x12ce(r5)
lbl_801A5334:
/* 801A5334 00000000  88 05 12 CD */	lbz r0, 0x12cd(r5)
...
/* 801A5348 00000014  88 03 12 C4 */	lbz r0, 0x12c4(r3)
/* 801A534C 00000018  28 00 00 FF */	cmplwi r0, 0xff
/* 801A5350 0000001C  41 82 00 1C */	beq lbl_801A536C
/* 801A5354 00000020  98 03 12 C2 */	stb r0, 0x12c2(r3)
/* 801A5358 00000024  88 05 12 CE */	lbz r0, 0x12ce(r5)
...
/* 801A5394 00000028  98 03 12 C5 */	stb r0, 0x12c5(r3)
lbl_801A5398:
/* 801A5398 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A539C 00000004  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 801A53A0 00000008  C0 23 11 E0 */	lfs f1, 0x11e0(r3)
/* 801A53A4 0000000C  C0 02 A2 0C */	lfs f0, d_d_kankyo__LIT_4409(r2)
/* 801A53A8 00000010  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801A53AC 00000014  4C 41 13 82 */	cror 2, 1, 2
/* 801A53B0 00000018  40 82 00 9C */	bne lbl_801A544C
/* 801A53B4 0000001C  D0 23 11 DC */	stfs f1, 0x11dc(r3)
/* 801A53B8 00000020  88 05 12 CE */	lbz r0, 0x12ce(r5)
/* 801A53BC 00000024  28 00 00 00 */	cmplwi r0, 0
/* 801A53C0 00000028  40 82 00 8C */	bne lbl_801A544C
/* 801A53C4 0000002C  C0 02 A2 50 */	lfs f0, d_d_kankyo__LIT_4507(r2)
/* 801A53C8 00000030  D0 03 11 E0 */	stfs f0, 0x11e0(r3)
/* 801A53CC 00000034  48 00 00 80 */	b lbl_801A544C
lbl_801A53D0:
/* 801A53D0 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A53D4 00000004  38 83 CA 54 */	addi r4, r3, g_env_light@l
/* 801A53D8 00000008  88 64 12 C2 */	lbz r3, 0x12c2(r4)
/* 801A53DC 0000000C  88 04 12 C3 */	lbz r0, 0x12c3(r4)
/* 801A53E0 00000010  7C 03 00 40 */	cmplw r3, r0
/* 801A53E4 00000014  40 82 00 68 */	bne lbl_801A544C
/* 801A53E8 00000018  88 04 12 C4 */	lbz r0, 0x12c4(r4)
/* 801A53EC 0000001C  28 00 00 FF */	cmplwi r0, 0xff
/* 801A53F0 00000020  41 82 00 10 */	beq lbl_801A5400
/* 801A53F4 00000024  98 04 12 C2 */	stb r0, 0x12c2(r4)
/* 801A53F8 00000028  38 00 00 FF */	li r0, 0xff
/* 801A53FC 0000002C  98 04 12 C4 */	stb r0, 0x12c4(r4)
lbl_801A5400:
/* 801A5400 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A5404 00000004  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 801A5408 00000008  88 A3 12 C5 */	lbz r5, 0x12c5(r3)
/* 801A540C 0000000C  28 05 00 FF */	cmplwi r5, 0xff
/* 801A5410 00000010  41 82 00 14 */	beq lbl_801A5424
/* 801A5414 00000014  98 A4 12 C3 */	stb r5, 0x12c3(r4)
/* 801A5418 00000018  38 00 00 FF */	li r0, 0xff
/* 801A541C 0000001C  98 03 12 C5 */	stb r0, 0x12c5(r3)
/* 801A5420 00000020  98 A3 12 C8 */	stb r5, 0x12c8(r3)
lbl_801A5424:
/* 801A5424 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A5428 00000004  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 801A542C 00000008  C0 23 11 E0 */	lfs f1, 0x11e0(r3)
/* 801A5430 0000000C  C0 02 A2 0C */	lfs f0, d_d_kankyo__LIT_4409(r2)
/* 801A5434 00000010  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 801A5438 00000014  4C 41 13 82 */	cror 2, 1, 2
/* 801A543C 00000018  40 82 00 10 */	bne lbl_801A544C
/* 801A5440 0000001C  D0 23 11 DC */	stfs f1, 0x11dc(r3)
/* 801A5444 00000020  C0 02 A2 50 */	lfs f0, d_d_kankyo__LIT_4507(r2)
/* 801A5448 00000024  D0 03 11 E0 */	stfs f0, 0x11e0(r3)
lbl_801A544C:
/* 801A544C 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A5450 00000004  3B 23 CA 54 */	addi r25, r3, g_env_light@l
/* 801A5454 00000008  C0 19 12 2C */	lfs f0, 0x122c(r25)
/* 801A5458 0000000C  D0 19 12 10 */	stfs f0, 0x1210(r25)
/* 801A545C 00000010  38 79 11 F8 */	addi r3, r25, 0x11f8
/* 801A5460 00000014  C0 39 12 14 */	lfs f1, 0x1214(r25)
/* 801A5464 00000018  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A5468 0000001C  C0 62 A2 EC */	lfs f3, LIT_6033(r2)
/* 801A546C 00000020  C0 82 A2 68 */	lfs f4, d_d_kankyo__LIT_4731(r2)
...
/* 801A5480 00000034  C0 3A 12 18 */	lfs f1, 0x1218(r26)
/* 801A5484 00000038  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A5488 0000003C  C0 62 A2 EC */	lfs f3, LIT_6033(r2)
/* 801A548C 00000040  C0 82 A2 68 */	lfs f4, d_d_kankyo__LIT_4731(r2)
...
/* 801A54A0 00000054  C0 3B 12 1C */	lfs f1, 0x121c(r27)
/* 801A54A4 00000058  C0 19 12 10 */	lfs f0, 0x1210(r25)
/* 801A54A8 0000005C  EC 21 00 32 */	fmuls f1, f1, f0
/* 801A54AC 00000060  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A54B0 00000064  C0 62 A2 EC */	lfs f3, LIT_6033(r2)
/* 801A54B4 00000068  C0 82 A2 68 */	lfs f4, d_d_kankyo__LIT_4731(r2)
...
/* 801A54C8 0000007C  C0 3C 12 20 */	lfs f1, 0x1220(r28)
/* 801A54CC 00000080  C0 19 12 10 */	lfs f0, 0x1210(r25)
/* 801A54D0 00000084  EC 21 00 32 */	fmuls f1, f1, f0
/* 801A54D4 00000088  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A54D8 0000008C  C0 62 A2 EC */	lfs f3, LIT_6033(r2)
/* 801A54DC 00000090  C0 82 A2 68 */	lfs f4, d_d_kankyo__LIT_4731(r2)
...
/* 801A54F0 000000A4  C0 3D 12 24 */	lfs f1, 0x1224(r29)
/* 801A54F4 000000A8  C0 19 12 10 */	lfs f0, 0x1210(r25)
/* 801A54F8 000000AC  EC 21 00 32 */	fmuls f1, f1, f0
/* 801A54FC 000000B0  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A5500 000000B4  C0 62 A2 EC */	lfs f3, LIT_6033(r2)
/* 801A5504 000000B8  C0 82 A2 68 */	lfs f4, d_d_kankyo__LIT_4731(r2)
...
/* 801A5518 000000CC  C0 3E 12 28 */	lfs f1, 0x1228(r30)
/* 801A551C 000000D0  C0 19 12 10 */	lfs f0, 0x1210(r25)
/* 801A5520 000000D4  EC 21 00 32 */	fmuls f1, f1, f0
/* 801A5524 000000D8  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A5528 000000DC  C0 62 A2 EC */	lfs f3, LIT_6033(r2)
/* 801A552C 000000E0  C0 82 A2 68 */	lfs f4, d_d_kankyo__LIT_4731(r2)
/* 801A5530 000000E4  48 0C A4 4D */	bl cLib_addCalc__FPfffff
/* 801A5534 000000E8  C0 02 A2 48 */	lfs f0, d_d_kankyo__LIT_4505(r2)
/* 801A5538 000000EC  D0 19 12 14 */	stfs f0, 0x1214(r25)
/* 801A553C 000000F0  D0 1A 12 18 */	stfs f0, 0x1218(r26)
/* 801A5540 000000F4  D0 1B 12 1C */	stfs f0, 0x121c(r27)
/* 801A5544 000000F8  D0 1C 12 20 */	stfs f0, 0x1220(r28)
/* 801A5548 000000FC  D0 1D 12 24 */	stfs f0, 0x1224(r29)
/* 801A554C 00000100  D0 1E 12 28 */	stfs f0, 0x1228(r30)
/* 801A5550 00000104  D0 19 12 2C */	stfs f0, 0x122c(r25)
/* 801A5554 00000108  3C 60 80 43 */	lis r3, g_env_light@ha
/* 801A5558 0000010C  38 C3 CA 54 */	addi r6, r3, g_env_light@l
/* 801A555C 00000110  C0 06 12 68 */	lfs f0, 0x1268(r6)
/* 801A5560 00000114  D0 06 12 6C */	stfs f0, 0x126c(r6)
/* 801A5564 00000118  C0 02 A2 A8 */	lfs f0, d_d_kankyo__LIT_5346(r2)
/* 801A5568 0000011C  D0 06 12 68 */	stfs f0, 0x1268(r6)
...
/* 801A5598 0000001C  98 03 13 0B */	stb r0, 0x130b(r3)
...
/* 801A55C8 0000004C  80 63 5D AC */	lwz r3, 0x5dac(r3)
...
/* 801A55F8 0000007C  D0 04 10 A0 */	stfs f0, 0x10a0(r4)
/* 801A55FC 00000080  C0 03 00 04 */	lfs f0, 4(r3)
/* 801A5600 00000084  D0 04 10 A4 */	stfs f0, 0x10a4(r4)
/* 801A5604 00000088  C0 03 00 08 */	lfs f0, 8(r3)
/* 801A5608 0000008C  D0 04 10 A8 */	stfs f0, 0x10a8(r4)
...
/* 801A563C 0000000C  3C 80 80 39 */	lis r4, d_d_kankyo__stringBase0@ha
/* 801A5640 00000010  38 84 4C 6C */	addi r4, r4, d_d_kankyo__stringBase0@l
...
lbl_801A5674:
/* 801A5674 00000000  88 1E 4F AD */	lbz r0, 0x4fad(r30)
...
/* 801A568C 00000018  C0 22 A2 0C */	lfs f1, d_d_kankyo__LIT_4409(r2)
/* 801A5690 0000001C  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A5694 00000020  C0 62 A2 64 */	lfs f3, d_d_kankyo__LIT_4730(r2)
...
/* 801A56B0 0000000C  C0 22 A2 A0 */	lfs f1, d_d_kankyo__LIT_5344(r2)
/* 801A56B4 00000010  C0 42 A2 60 */	lfs f2, d_d_kankyo__LIT_4529(r2)
/* 801A56B8 00000014  C0 62 A2 64 */	lfs f3, d_d_kankyo__LIT_4730(r2)

...
/* 801D5914 0000001C  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 801D5918 00000020  7C 7F 1B 78 */	mr r31, r3
/* 801D591C 00000024  FF C0 08 90 */	fmr f30, f1
/* 801D5920 00000028  FF E0 10 90 */	fmr f31, f2
/* 801D5924 0000002C  C0 02 A7 D0 */	lfs f0, d_d_menu_fmap2D__LIT_3970(r2)
/* 801D5928 00000030  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 801D592C 00000034  D0 01 00 08 */	stfs f0, 8(r1)
/* 801D5930 00000038  28 05 00 00 */	cmplwi r5, 0
/* 801D5934 0000003C  41 82 00 14 */	beq lbl_801D5948
/* 801D5938 00000040  38 C1 00 0C */	addi r6, r1, 0xc
/* 801D593C 00000044  38 E1 00 08 */	addi r7, r1, 8
/* 801D5940 00000048  4B FF D3 89 */	bl calcOffset__18dMenu_Fmap2DBack_cFUcPCcPfPf
/* 801D5944 0000004C  48 00 00 34 */	b lbl_801D5978
lbl_801D5948:
/* 801D5948 00000000  C0 42 A7 E8 */	lfs f2, d_d_menu_fmap2D__LIT_4202(r2)
...
/* 801D5990 00000018  C0 02 A7 D0 */	lfs f0, d_d_menu_fmap2D__LIT_3970(r2)
...
/* 801D59A0 00000028  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 801D59A4 0000002C  E3 C1 00 28 */	psq_l f30, 40(r1), 0, 0 /* qr0 */
/* 801D59A8 00000030  CB C1 00 20 */	lfd f30, 0x20(r1)
/* 801D59AC 00000034  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 801D59B0 00000038  80 01 00 44 */	lwz r0, 0x44(r1)
/* 801D59B4 0000003C  7C 08 03 A6 */	mtlr r0
/* 801D59B8 00000040  38 21 00 40 */	addi r1, r1, 0x40
/* 801D59BC 00000044  4E 80 00 20 */	blr 

...
/* 80231DE0 00000020  C0 42 B0 5C */	lfs f2, d_d_msg_class__LIT_4026(r2)
/* 80231DE4 00000024  C0 02 B0 64 */	lfs f0, d_d_msg_class__LIT_4028(r2)
...
/* 80231E34 00000074  3C A0 80 3A */	lis r5, d_d_msg_class__stringBase0@ha
/* 80231E38 00000078  38 A5 96 10 */	addi r5, r5, d_d_msg_class__stringBase0@l
...
lbl_80231E54:
/* 80231E54 00000000  C0 02 B0 64 */	lfs f0, d_d_msg_class__LIT_4028(r2)
/* 80231E58 00000004  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 80231E5C 00000008  4C 41 13 82 */	cror 2, 1, 2
/* 80231E60 0000000C  40 82 00 74 */	bne lbl_80231ED4
/* 80231E64 00000010  C0 5F 00 4C */	lfs f2, 0x4c(r31)
/* 80231E68 00000014  FC 00 F8 1E */	fctiwz f0, f31
/* 80231E6C 00000018  D8 01 00 18 */	stfd f0, 0x18(r1)
/* 80231E70 0000001C  80 C1 00 1C */	lwz r6, 0x1c(r1)
/* 80231E74 00000020  C8 22 B0 70 */	lfd f1, d_d_msg_class__LIT_4198(r2)
/* 80231E78 00000024  6C C0 80 00 */	xoris r0, r6, 0x8000
/* 80231E7C 00000028  90 01 00 24 */	stw r0, 0x24(r1)
/* 80231E80 0000002C  3C 00 43 30 */	lis r0, 0x4330
/* 80231E84 00000030  90 01 00 20 */	stw r0, 0x20(r1)
/* 80231E88 00000034  C8 01 00 20 */	lfd f0, 0x20(r1)
/* 80231E8C 00000038  EC 00 08 28 */	fsubs f0, f0, f1
/* 80231E90 0000003C  EC 02 00 2A */	fadds f0, f2, f0
/* 80231E94 00000040  D0 1F 00 4C */	stfs f0, 0x4c(r31)
/* 80231E98 00000044  80 7F 00 38 */	lwz r3, 0x38(r31)
/* 80231E9C 00000048  80 63 00 08 */	lwz r3, 8(r3)
/* 80231EA0 0000004C  88 03 01 30 */	lbz r0, 0x130(r3)
/* 80231EA4 00000050  54 00 F7 BF */	rlwinm. r0, r0, 0x1e, 0x1e, 0x1f
/* 80231EA8 00000054  41 82 00 2C */	beq lbl_80231ED4
/* 80231EAC 00000058  38 61 00 08 */	addi r3, r1, 8
/* 80231EB0 0000005C  38 80 00 0F */	li r4, 0xf
/* 80231EB4 00000060  3C A0 80 3A */	lis r5, d_d_msg_class__stringBase0@ha
/* 80231EB8 00000064  38 A5 96 10 */	addi r5, r5, d_d_msg_class__stringBase0@l
/* 80231EBC 00000068  38 A5 00 08 */	addi r5, r5, 8
/* 80231EC0 0000006C  4C C6 31 82 */	crclr 6
/* 80231EC4 00000070  48 13 46 F9 */	bl snprintf
/* 80231EC8 00000074  7F E3 FB 78 */	mr r3, r31
/* 80231ECC 00000078  38 81 00 08 */	addi r4, r1, 8
/* 80231ED0 0000007C  48 00 01 75 */	bl do_strcat__35jmessage_string_tRenderingProcessorFPc
lbl_80231ED4:
/* 80231ED4 00000000  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */
/* 80231ED8 00000004  CB E1 00 30 */	lfd f31, 0x30(r1)
/* 80231EDC 00000008  83 E1 00 2C */	lwz r31, 0x2c(r1)
/* 80231EE0 0000000C  80 01 00 44 */	lwz r0, 0x44(r1)
/* 80231EE4 00000010  7C 08 03 A6 */	mtlr r0
/* 80231EE8 00000014  38 21 00 40 */	addi r1, r1, 0x40
/* 80231EEC 00000018  4E 80 00 20 */	blr 

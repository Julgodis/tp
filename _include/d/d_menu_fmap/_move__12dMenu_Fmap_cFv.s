...
/* 801C74E4 0000003C  3C 80 80 3C */	lis r4, d_d_menu_fmap__move_process@ha
/* 801C74E8 00000040  38 04 D4 D4 */	addi r0, r4, d_d_menu_fmap__move_process@l
...
/* 801C7568 000000C0  3C 80 80 3C */	lis r4, d_d_menu_fmap__init_process@ha
/* 801C756C 000000C4  38 04 D2 04 */	addi r0, r4, d_d_menu_fmap__init_process@l
...
lbl_801C75E8:
/* 801C75E8 00000000  C0 22 A7 24 */	lfs f1, d_d_menu_fmap__LIT_3995(r2)
...
/* 801C75FC 00000014  C0 42 A7 48 */	lfs f2, d_d_menu_fmap__LIT_4397(r2)
/* 801C7600 00000018  C0 62 A7 4C */	lfs f3, d_d_menu_fmap__LIT_4398(r2)
/* 801C7604 0000001C  48 0A 84 39 */	bl cLib_addCalc2__FPffff
/* 801C7608 00000020  C0 1F 01 A8 */	lfs f0, 0x1a8(r31)
/* 801C760C 00000024  C0 22 A7 24 */	lfs f1, d_d_menu_fmap__LIT_3995(r2)
...
/* 801C761C 00000034  C0 02 A7 50 */	lfs f0, d_d_menu_fmap__LIT_4399(r2)
/* 801C7620 00000038  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 801C7624 0000003C  40 80 00 08 */	bge lbl_801C762C
/* 801C7628 00000040  D0 3F 01 A8 */	stfs f1, 0x1a8(r31)
lbl_801C762C:

...
/* 80159724 0000001C  4B EB F5 BD */	bl fopAc_IsActor(void*)
...
/* 80159744 0000003C  4B EC 0F CD */	bl fopAcM_searchActorAngleY(const fopAc_ac_c*, const fopAc_ac_c*)
/* 80159748 00000040  7C 64 1B 78 */	mr r4, r3
/* 8015974C 00000044  A8 6D 8A 8C */	lha r3, wolfAngle(r13)
/* 80159750 00000048  48 11 76 D5 */	bl cLib_distanceAngleS(s16, s16)
...
/* 80159768 00000060  4B EC 13 2D */	bl fopAcM_searchActorDistanceXZ2(const fopAc_ac_c*, const fopAc_ac_c*)
...
/* 8015978C 00000010  4B EC 13 09 */	bl fopAcM_searchActorDistanceXZ2(const fopAc_ac_c*, const fopAc_ac_c*)
/* 80159790 00000014  C0 0D 8A 88 */	lfs f0, targetWay(r13)
/* 80159794 00000018  FC 00 08 40 */	fcmpo cr0, f0, f1
/* 80159798 0000001C  40 81 00 0C */	ble lbl_801597A4
/* 8015979C 00000020  D0 2D 8A 88 */	stfs f1, targetWay(r13)
/* 801597A0 00000024  93 CD 8A 84 */	stw r30, target(r13)
lbl_801597A4:

...
/* 8006D030 00000014  DB C1 01 D0 */	stfd f30, 0x1d0(r1)
/* 8006D034 00000018  F3 C1 01 D8 */	psq_st f30, 472(r1), 0, 0 /* qr0 */
/* 8006D038 0000001C  DB A1 01 C0 */	stfd f29, 0x1c0(r1)
/* 8006D03C 00000020  F3 A1 01 C8 */	psq_st f29, 456(r1), 0, 0 /* qr0 */
/* 8006D040 00000024  DB 81 01 B0 */	stfd f28, 0x1b0(r1)
/* 8006D044 00000028  F3 81 01 B8 */	psq_st f28, 440(r1), 0, 0 /* qr0 */
/* 8006D048 0000002C  DB 61 01 A0 */	stfd f27, 0x1a0(r1)
/* 8006D04C 00000030  F3 61 01 A8 */	psq_st f27, 424(r1), 0, 0 /* qr0 */
/* 8006D050 00000034  DB 41 01 90 */	stfd f26, 0x190(r1)
/* 8006D054 00000038  F3 41 01 98 */	psq_st f26, 408(r1), 0, 0 /* qr0 */
/* 8006D058 0000003C  DB 21 01 80 */	stfd f25, 0x180(r1)
/* 8006D05C 00000040  F3 21 01 88 */	psq_st f25, 392(r1), 0, 0 /* qr0 */
/* 8006D060 00000044  DB 01 01 70 */	stfd f24, 0x170(r1)
/* 8006D064 00000048  F3 01 01 78 */	psq_st f24, 376(r1), 0, 0 /* qr0 */
/* 8006D068 0000004C  39 61 01 70 */	addi r11, r1, 0x170
/* 8006D06C 00000050  48 2F 51 61 */	bl _savegpr_25
/* 8006D070 00000054  7C 7A 1B 78 */	mr r26, r3
/* 8006D074 00000058  7C 9B 23 78 */	mr r27, r4
/* 8006D078 0000005C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8006D07C 00000060  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8006D080 00000064  83 E3 10 4C */	lwz r31, 0x104c(r3)
/* 8006D084 00000068  83 C3 0E 74 */	lwz r30, 0xe74(r3)
/* 8006D088 0000006C  88 0D 89 BC */	lbz r0, data_80450F3C(r13)
/* 8006D08C 00000070  7C 00 07 75 */	extsb. r0, r0
/* 8006D090 00000074  40 82 00 14 */	bne lbl_8006D0A4
/* 8006D094 00000078  C0 02 87 B8 */	lfs f0, d_d_kankyo_rain__LIT_3954(r2)
/* 8006D098 0000007C  D0 0D 89 B8 */	stfs f0, data_80450F38(r13)
/* 8006D09C 00000080  38 00 00 01 */	li r0, 1
/* 8006D0A0 00000084  98 0D 89 BC */	stb r0, data_80450F3C(r13)
lbl_8006D0A4:
/* 8006D0A4 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8006D0A8 00000004  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8006D0AC 00000008  AB A3 11 16 */	lha r29, 0x1116(r3)
/* 8006D0B0 0000000C  83 83 0E 78 */	lwz r28, 0xe78(r3)
...
/* 8006D0D4 00000030  A8 03 13 00 */	lha r0, 0x1300(r3)
...
/* 8006D0F0 0000000C  A8 05 11 10 */	lha r0, 0x1110(r5)
/* 8006D0F4 00000010  C8 22 87 C8 */	lfd f1, d_d_kankyo_rain__LIT_3995(r2)
...
/* 8006D120 0000003C  A8 65 11 12 */	lha r3, 0x1112(r5)
...
/* 8006D148 00000064  A8 85 11 14 */	lha r4, 0x1114(r5)
...
/* 8006D1B8 00000018  C8 82 87 C8 */	lfd f4, d_d_kankyo_rain__LIT_3995(r2)
...
/* 8006D200 00000060  A8 A5 13 02 */	lha r5, 0x1302(r5)
...
/* 8006D23C 0000009C  40 81 00 48 */	ble lbl_8006D284
/* 8006D240 000000A0  C0 22 88 14 */	lfs f1, d_d_kankyo_rain__LIT_4354(r2)
/* 8006D244 000000A4  C0 5C 00 98 */	lfs f2, 0x98(r28)
/* 8006D248 000000A8  EC 02 00 B2 */	fmuls f0, f2, f2
/* 8006D24C 000000AC  EC 02 00 32 */	fmuls f0, f2, f0
/* 8006D250 000000B0  EC 01 00 28 */	fsubs f0, f1, f0
/* 8006D254 000000B4  EC 03 00 32 */	fmuls f0, f3, f0
/* 8006D258 000000B8  EC 01 00 28 */	fsubs f0, f1, f0
/* 8006D25C 000000BC  EC 1A 00 32 */	fmuls f0, f26, f0
/* 8006D260 000000C0  FC 00 00 1E */	fctiwz f0, f0
/* 8006D264 000000C4  D8 01 01 18 */	stfd f0, 0x118(r1)
/* 8006D268 000000C8  80 A1 01 1C */	lwz r5, 0x11c(r1)
/* 8006D26C 000000CC  54 A5 06 3E */	clrlwi r5, r5, 0x18
/* 8006D270 000000D0  C8 22 88 70 */	lfd f1, d_d_kankyo_rain__LIT_4379(r2)
/* 8006D274 000000D4  90 A1 01 14 */	stw r5, 0x114(r1)
/* 8006D278 000000D8  90 C1 01 10 */	stw r6, 0x110(r1)
/* 8006D27C 000000DC  C8 01 01 10 */	lfd f0, 0x110(r1)
/* 8006D280 000000E0  EF 40 08 28 */	fsubs f26, f0, f1
lbl_8006D284:
/* 8006D284 00000000  C0 42 88 3C */	lfs f2, d_d_kankyo_rain__LIT_4364(r2)
/* 8006D288 00000004  C8 22 87 C8 */	lfd f1, d_d_kankyo_rain__LIT_3995(r2)
...
/* 8006D31C 00000098  3C 80 80 38 */	lis r4, d_d_kankyo_rain__stringBase0@ha
/* 8006D320 0000009C  38 84 A5 78 */	addi r4, r4, d_d_kankyo_rain__stringBase0@l
...
/* 8006D334 000000B0  C0 22 88 14 */	lfs f1, d_d_kankyo_rain__LIT_4354(r2)
...
/* 8006D37C 000000F8  C8 02 88 70 */	lfd f0, d_d_kankyo_rain__LIT_4379(r2)
...
/* 8006D4EC 00000008  80 63 61 B0 */	lwz r3, 0x61b0(r3)
...
/* 8006D514 00000008  88 19 12 D8 */	lbz r0, 0x12d8(r25)
...
/* 8006D538 0000002C  C3 E2 87 B8 */	lfs f31, d_d_kankyo_rain__LIT_3954(r2)
...
/* 8006D550 00000044  4B FE E4 D5 */	bl dKyr_set_btitex(_GXTexObj*, ResTIMG*)
...
/* 8006D654 00000148  88 19 12 D8 */	lbz r0, 0x12d8(r25)
...
/* 8006D694 00000010  4B FF 54 49 */	bl dKr_cullVtx_Set(void)
...
/* 8006D764 00000088  48 1F 9E 81 */	bl cM_rad2s(f32)
...
/* 8006D784 000000A8  48 1F 9E 61 */	bl cM_rad2s(f32)
...
/* 8006D814 00000138  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D818 0000013C  C0 01 00 4C */	lfs f0, 0x4c(r1)
/* 8006D81C 00000140  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D820 00000144  C0 01 00 50 */	lfs f0, 0x50(r1)
/* 8006D824 00000148  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D828 0000014C  38 60 00 00 */	li r3, 0
/* 8006D82C 00000150  B0 7C 80 00 */	sth r3, -0x8000(r28)
/* 8006D830 00000154  B0 7C 80 00 */	sth r3, -0x8000(r28)
/* 8006D834 00000158  C0 01 00 54 */	lfs f0, 0x54(r1)
/* 8006D838 0000015C  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D83C 00000160  C0 01 00 58 */	lfs f0, 0x58(r1)
/* 8006D840 00000164  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D844 00000168  C0 01 00 5C */	lfs f0, 0x5c(r1)
/* 8006D848 0000016C  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D84C 00000170  38 00 00 FF */	li r0, 0xff
/* 8006D850 00000174  B0 1C 80 00 */	sth r0, -0x8000(r28)
/* 8006D854 00000178  B0 7C 80 00 */	sth r3, -0x8000(r28)
/* 8006D858 0000017C  C0 01 00 60 */	lfs f0, 0x60(r1)
/* 8006D85C 00000180  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D860 00000184  C0 01 00 64 */	lfs f0, 0x64(r1)
/* 8006D864 00000188  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D868 0000018C  C0 01 00 68 */	lfs f0, 0x68(r1)
/* 8006D86C 00000190  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D870 00000194  B0 1C 80 00 */	sth r0, -0x8000(r28)
/* 8006D874 00000198  B0 1C 80 00 */	sth r0, -0x8000(r28)
/* 8006D878 0000019C  C0 01 00 6C */	lfs f0, 0x6c(r1)
/* 8006D87C 000001A0  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D880 000001A4  C0 01 00 70 */	lfs f0, 0x70(r1)
/* 8006D884 000001A8  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D888 000001AC  C0 01 00 74 */	lfs f0, 0x74(r1)
/* 8006D88C 000001B0  D0 1C 80 00 */	stfs f0, -0x8000(r28)
/* 8006D890 000001B4  B0 7C 80 00 */	sth r3, -0x8000(r28)
/* 8006D894 000001B8  B0 1C 80 00 */	sth r0, -0x8000(r28)
...
/* 8006D8C0 00000004  CB E1 01 E0 */	lfd f31, 0x1e0(r1)
/* 8006D8C4 00000008  E3 C1 01 D8 */	psq_l f30, 472(r1), 0, 0 /* qr0 */
/* 8006D8C8 0000000C  CB C1 01 D0 */	lfd f30, 0x1d0(r1)
/* 8006D8CC 00000010  E3 A1 01 C8 */	psq_l f29, 456(r1), 0, 0 /* qr0 */
/* 8006D8D0 00000014  CB A1 01 C0 */	lfd f29, 0x1c0(r1)
/* 8006D8D4 00000018  E3 81 01 B8 */	psq_l f28, 440(r1), 0, 0 /* qr0 */
/* 8006D8D8 0000001C  CB 81 01 B0 */	lfd f28, 0x1b0(r1)
/* 8006D8DC 00000020  E3 61 01 A8 */	psq_l f27, 424(r1), 0, 0 /* qr0 */
/* 8006D8E0 00000024  CB 61 01 A0 */	lfd f27, 0x1a0(r1)
/* 8006D8E4 00000028  E3 41 01 98 */	psq_l f26, 408(r1), 0, 0 /* qr0 */
/* 8006D8E8 0000002C  CB 41 01 90 */	lfd f26, 0x190(r1)
/* 8006D8EC 00000030  E3 21 01 88 */	psq_l f25, 392(r1), 0, 0 /* qr0 */
/* 8006D8F0 00000034  CB 21 01 80 */	lfd f25, 0x180(r1)
/* 8006D8F4 00000038  E3 01 01 78 */	psq_l f24, 376(r1), 0, 0 /* qr0 */
/* 8006D8F8 0000003C  CB 01 01 70 */	lfd f24, 0x170(r1)
/* 8006D8FC 00000040  39 61 01 70 */	addi r11, r1, 0x170
/* 8006D900 00000044  48 2F 49 19 */	bl _restgpr_25
/* 8006D904 00000048  80 01 01 F4 */	lwz r0, 0x1f4(r1)
/* 8006D908 0000004C  7C 08 03 A6 */	mtlr r0
/* 8006D90C 00000050  38 21 01 F0 */	addi r1, r1, 0x1f0
/* 8006D910 00000054  4E 80 00 20 */	blr 

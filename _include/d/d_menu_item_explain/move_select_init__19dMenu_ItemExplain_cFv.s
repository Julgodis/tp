...
/* 801DBCC8 00000014  DB C1 00 70 */	stfd f30, 0x70(r1)
/* 801DBCCC 00000018  F3 C1 00 78 */	psq_st f30, 120(r1), 0, 0 /* qr0 */
/* 801DBCD0 0000001C  DB A1 00 60 */	stfd f29, 0x60(r1)
/* 801DBCD4 00000020  F3 A1 00 68 */	psq_st f29, 104(r1), 0, 0 /* qr0 */
/* 801DBCD8 00000024  93 E1 00 5C */	stw r31, 0x5c(r1)
/* 801DBCDC 00000028  7C 7F 1B 78 */	mr r31, r3
/* 801DBCE0 0000002C  38 00 00 00 */	li r0, 0
/* 801DBCE4 00000030  98 01 00 10 */	stb r0, 0x10(r1)
/* 801DBCE8 00000034  98 01 00 08 */	stb r0, 8(r1)
/* 801DBCEC 00000038  98 01 00 2C */	stb r0, 0x2c(r1)
/* 801DBCF0 0000003C  98 01 00 19 */	stb r0, 0x19(r1)
/* 801DBCF4 00000040  48 00 0E 61 */	bl getWarpMarkFlag__19dMenu_ItemExplain_cFv
/* 801DBCF8 00000044  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 801DBCFC 00000048  40 82 00 48 */	bne lbl_801DBD44
/* 801DBD00 0000004C  38 00 05 17 */	li r0, 0x517
/* 801DBD04 00000050  90 1F 00 C8 */	stw r0, 0xc8(r31)
/* 801DBD08 00000054  38 00 00 00 */	li r0, 0
/* 801DBD0C 00000058  98 1F 00 E2 */	stb r0, 0xe2(r31)
/* 801DBD10 0000005C  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 801DBD14 00000060  38 63 01 88 */	addi r3, r3, g_meter2_info@l
/* 801DBD18 00000064  38 80 05 18 */	li r4, 0x518
/* 801DBD1C 00000068  38 A1 00 10 */	addi r5, r1, 0x10
/* 801DBD20 0000006C  38 C0 00 00 */	li r6, 0
/* 801DBD24 00000070  48 04 05 2D */	bl getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c
/* 801DBD28 00000074  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 801DBD2C 00000078  38 63 01 88 */	addi r3, r3, g_meter2_info@l
/* 801DBD30 0000007C  38 80 05 19 */	li r4, 0x519
/* 801DBD34 00000080  38 A1 00 08 */	addi r5, r1, 8
/* 801DBD38 00000084  38 C0 00 00 */	li r6, 0
/* 801DBD3C 00000088  48 04 05 15 */	bl getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c
/* 801DBD40 0000008C  48 00 00 44 */	b lbl_801DBD84
lbl_801DBD44:
...
/* 801DBE00 0000007C  40 80 00 0C */	bge lbl_801DBE0C
/* 801DBE04 00000080  FF E0 F0 90 */	fmr f31, f30
/* 801DBE08 00000084  48 00 00 08 */	b lbl_801DBE10
lbl_801DBE0C:
...
/* 801DBE1C 0000000C  40 80 00 10 */	bge lbl_801DBE2C
/* 801DBE20 00000010  80 7F 00 9C */	lwz r3, 0x9c(r31)
/* 801DBE24 00000014  48 05 EB 11 */	bl getTextBoxWidth__17dMsgScrn3Select_cFv
/* 801DBE28 00000018  FF E0 08 90 */	fmr f31, f1
lbl_801DBE2C:
/* 801DBE2C 00000000  38 61 00 2C */	addi r3, r1, 0x2c
/* 801DBE30 00000004  38 80 00 14 */	li r4, 0x14
/* 801DBE34 00000008  3C A0 80 39 */	lis r5, d_d_menu_item_explain__stringBase0@ha
/* 801DBE38 0000000C  38 A5 69 90 */	addi r5, r5, d_d_menu_item_explain__stringBase0@l
/* 801DBE3C 00000010  38 A5 00 2C */	addi r5, r5, 0x2c
/* 801DBE40 00000014  C0 22 A8 94 */	lfs f1, d_d_menu_item_explain__LIT_4065(r2)
...
/* 801DBE74 00000048  3C A0 80 39 */	lis r5, d_d_menu_item_explain__stringBase0@ha
/* 801DBE78 0000004C  38 A5 69 90 */	addi r5, r5, d_d_menu_item_explain__stringBase0@l
/* 801DBE7C 00000050  38 A5 00 2C */	addi r5, r5, 0x2c
/* 801DBE80 00000054  C0 22 A8 94 */	lfs f1, d_d_menu_item_explain__LIT_4065(r2)
...
/* 801DBEB0 00000084  3C 80 80 39 */	lis r4, d_d_menu_item_explain__stringBase0@ha
/* 801DBEB4 00000088  38 84 69 90 */	addi r4, r4, d_d_menu_item_explain__stringBase0@l
...
/* 801DBECC 000000A0  3C 80 80 39 */	lis r4, d_d_menu_item_explain__stringBase0@ha
/* 801DBED0 000000A4  38 84 69 90 */	addi r4, r4, d_d_menu_item_explain__stringBase0@l
...
/* 801DBF1C 00000004  CB E1 00 80 */	lfd f31, 0x80(r1)
/* 801DBF20 00000008  E3 C1 00 78 */	psq_l f30, 120(r1), 0, 0 /* qr0 */
/* 801DBF24 0000000C  CB C1 00 70 */	lfd f30, 0x70(r1)
/* 801DBF28 00000010  E3 A1 00 68 */	psq_l f29, 104(r1), 0, 0 /* qr0 */
/* 801DBF2C 00000014  CB A1 00 60 */	lfd f29, 0x60(r1)
/* 801DBF30 00000018  83 E1 00 5C */	lwz r31, 0x5c(r1)
/* 801DBF34 0000001C  80 01 00 94 */	lwz r0, 0x94(r1)
/* 801DBF38 00000020  7C 08 03 A6 */	mtlr r0
/* 801DBF3C 00000024  38 21 00 90 */	addi r1, r1, 0x90
/* 801DBF40 00000028  4E 80 00 20 */	blr 

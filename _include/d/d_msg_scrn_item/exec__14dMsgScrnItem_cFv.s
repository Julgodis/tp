...
/* 8023F89C 00000014  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 8023F8A0 00000018  7C 7F 1B 78 */	mr r31, r3
/* 8023F8A4 0000001C  C3 E3 01 3C */	lfs f31, 0x13c(r3)
/* 8023F8A8 00000020  88 03 01 9D */	lbz r0, 0x19d(r3)
/* 8023F8AC 00000024  28 00 00 00 */	cmplwi r0, 0
/* 8023F8B0 00000028  40 82 00 2C */	bne lbl_8023F8DC
/* 8023F8B4 0000002C  80 9F 01 18 */	lwz r4, 0x118(r31)
/* 8023F8B8 00000030  48 00 0E 95 */	bl setBtk0Animation__14dMsgScrnItem_cFP19J2DAnmTextureSRTKey
/* 8023F8BC 00000034  7F E3 FB 78 */	mr r3, r31
/* 8023F8C0 00000038  80 9F 01 2C */	lwz r4, 0x12c(r31)
/* 8023F8C4 0000003C  48 00 0F 25 */	bl setBpk0Animation__14dMsgScrnItem_cFP11J2DAnmColor
/* 8023F8C8 00000040  7F E3 FB 78 */	mr r3, r31
/* 8023F8CC 00000044  80 9F 01 30 */	lwz r4, 0x130(r31)
/* 8023F8D0 00000048  48 00 0F 75 */	bl setBpk1Animation__14dMsgScrnItem_cFP11J2DAnmColor
/* 8023F8D4 0000004C  38 00 00 01 */	li r0, 1
/* 8023F8D8 00000050  98 1F 01 9D */	stb r0, 0x19d(r31)
lbl_8023F8DC:
...
/* 8023F920 00000044  4C 41 13 82 */	cror 2, 1, 2
/* 8023F924 00000048  40 82 00 1C */	bne lbl_8023F940
/* 8023F928 0000004C  90 61 00 0C */	stw r3, 0xc(r1)
/* 8023F92C 00000050  90 01 00 08 */	stw r0, 8(r1)
/* 8023F930 00000054  C8 01 00 08 */	lfd f0, 8(r1)
/* 8023F934 00000058  EC 00 08 28 */	fsubs f0, f0, f1
/* 8023F938 0000005C  EC 02 00 28 */	fsubs f0, f2, f0
/* 8023F93C 00000060  D0 1F 01 40 */	stfs f0, 0x140(r31)
lbl_8023F940:
...
/* 8023F998 00000038  4C 41 13 82 */	cror 2, 1, 2
/* 8023F99C 0000003C  40 82 00 20 */	bne lbl_8023F9BC
/* 8023F9A0 00000040  90 01 00 0C */	stw r0, 0xc(r1)
/* 8023F9A4 00000044  3C 00 43 30 */	lis r0, 0x4330
/* 8023F9A8 00000048  90 01 00 08 */	stw r0, 8(r1)
/* 8023F9AC 0000004C  C8 01 00 08 */	lfd f0, 8(r1)
/* 8023F9B0 00000050  EC 00 08 28 */	fsubs f0, f0, f1
/* 8023F9B4 00000054  EC 02 00 28 */	fsubs f0, f2, f0
/* 8023F9B8 00000058  D0 07 01 54 */	stfs f0, 0x154(r7)
lbl_8023F9BC:
...
/* 8023F9EC 00000030  C0 22 B1 FC */	lfs f1, d_d_msg_scrn_item__LIT_4193(r2)
...
/* 8023FB0C 000000A8  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 8023FB10 000000AC  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 8023FB14 000000B0  80 01 00 34 */	lwz r0, 0x34(r1)
/* 8023FB18 000000B4  7C 08 03 A6 */	mtlr r0
/* 8023FB1C 000000B8  38 21 00 30 */	addi r1, r1, 0x30
/* 8023FB20 000000BC  4E 80 00 20 */	blr 

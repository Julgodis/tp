...
/* 8020B52C 00000014  DB C1 00 10 */	stfd f30, 0x10(r1)
/* 8020B530 00000018  F3 C1 00 18 */	psq_st f30, 24(r1), 0, 0 /* qr0 */
/* 8020B534 0000001C  93 E1 00 0C */	stw r31, 0xc(r1)
/* 8020B538 00000020  93 C1 00 08 */	stw r30, 8(r1)
/* 8020B53C 00000024  7C 7E 1B 78 */	mr r30, r3
/* 8020B540 00000028  C3 E2 AD C0 */	lfs f31, d_d_meter_haihai__LIT_3893(r2)
/* 8020B544 0000002C  C3 C2 AD C4 */	lfs f30, d_d_meter_haihai__LIT_3894(r2)
/* 8020B548 00000030  88 03 00 28 */	lbz r0, 0x28(r3)
/* 8020B54C 00000034  28 00 00 01 */	cmplwi r0, 1
/* 8020B550 00000038  40 82 00 30 */	bne lbl_8020B580
/* 8020B554 0000003C  C0 22 AD D8 */	lfs f1, d_d_meter_haihai__LIT_3940(r2)
/* 8020B558 00000040  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 8020B55C 00000044  38 63 EB C8 */	addi r3, r3, g_drawHIO@l
/* 8020B560 00000048  C0 03 05 1C */	lfs f0, 0x51c(r3)
/* 8020B564 0000004C  EC 01 00 2A */	fadds f0, f1, f0
/* 8020B568 00000050  EF FF 00 2A */	fadds f31, f31, f0
/* 8020B56C 00000054  C0 23 05 20 */	lfs f1, 0x520(r3)
/* 8020B570 00000058  C0 02 AD DC */	lfs f0, d_d_meter_haihai__LIT_3941(r2)
/* 8020B574 0000005C  EC 01 00 28 */	fsubs f0, f1, f0
/* 8020B578 00000060  EF DE 00 2A */	fadds f30, f30, f0
/* 8020B57C 00000064  48 00 00 1C */	b lbl_8020B598
lbl_8020B580:
...
/* 8020B5D0 00000010  C0 02 AD B4 */	lfs f0, d_d_meter_haihai__LIT_3890(r2)
...
/* 8020B5E0 00000020  C0 02 AD B8 */	lfs f0, d_d_meter_haihai__LIT_3891(r2)
...
/* 8020B610 00000004  C0 42 AD E0 */	lfs f2, d_d_meter_haihai__LIT_3942(r2)
...
/* 8020B620 00000014  C0 02 AD BC */	lfs f0, d_d_meter_haihai__LIT_3892(r2)
...
/* 8020B668 00000010  C0 02 AD B4 */	lfs f0, d_d_meter_haihai__LIT_3890(r2)
/* 8020B66C 00000014  EC 01 00 28 */	fsubs f0, f1, f0
/* 8020B670 00000018  EC 3F 00 2A */	fadds f1, f31, f0
/* 8020B674 0000001C  C0 62 AD E4 */	lfs f3, d_d_meter_haihai__LIT_3943(r2)
/* 8020B678 00000020  C0 44 05 14 */	lfs f2, 0x514(r4)
/* 8020B67C 00000024  C0 02 AD B8 */	lfs f0, d_d_meter_haihai__LIT_3891(r2)
...
/* 8020B6BC 00000010  C0 02 AD BC */	lfs f0, d_d_meter_haihai__LIT_3892(r2)
/* 8020B6C0 00000014  EC 01 00 28 */	fsubs f0, f1, f0
/* 8020B6C4 00000018  EC 3F 00 28 */	fsubs f1, f31, f0
/* 8020B6C8 0000001C  C0 02 AD E0 */	lfs f0, d_d_meter_haihai__LIT_3942(r2)
...
/* 8020B740 00000004  C0 22 AD E0 */	lfs f1, d_d_meter_haihai__LIT_3942(r2)
...
/* 8020B794 00000014  C0 42 AD E4 */	lfs f2, d_d_meter_haihai__LIT_3943(r2)
...
/* 8020B7D8 00000014  C0 02 AD E0 */	lfs f0, d_d_meter_haihai__LIT_3942(r2)
...
/* 8020B7F0 00000004  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 8020B7F4 00000008  E3 C1 00 18 */	psq_l f30, 24(r1), 0, 0 /* qr0 */
/* 8020B7F8 0000000C  CB C1 00 10 */	lfd f30, 0x10(r1)
/* 8020B7FC 00000010  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 8020B800 00000014  83 C1 00 08 */	lwz r30, 8(r1)
/* 8020B804 00000018  80 01 00 34 */	lwz r0, 0x34(r1)
/* 8020B808 0000001C  7C 08 03 A6 */	mtlr r0
/* 8020B80C 00000020  38 21 00 30 */	addi r1, r1, 0x30
/* 8020B810 00000024  4E 80 00 20 */	blr 

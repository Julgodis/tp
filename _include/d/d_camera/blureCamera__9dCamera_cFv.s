...
/* 80181294 00000014  93 E1 00 5C */	stw r31, 0x5c(r1)
/* 80181298 00000018  93 C1 00 58 */	stw r30, 0x58(r1)
/* 8018129C 0000001C  7C 7F 1B 78 */	mr r31, r3
/* 801812A0 00000020  80 03 07 04 */	lwz r0, 0x704(r3)
/* 801812A4 00000024  2C 00 00 00 */	cmpwi r0, 0
/* 801812A8 00000028  40 81 01 B8 */	ble lbl_80181460
/* 801812AC 0000002C  80 1F 07 10 */	lwz r0, 0x710(r31)
/* 801812B0 00000030  28 00 00 00 */	cmplwi r0, 0
/* 801812B4 00000034  41 82 00 8C */	beq lbl_80181340
/* 801812B8 00000038  80 7F 00 00 */	lwz r3, 0(r31)
/* 801812BC 0000003C  4B E9 D0 4D */	bl fopCamM_GetParam__FP12camera_class
/* 801812C0 00000040  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 801812C4 00000044  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 801812C8 00000048  1C 03 00 38 */	mulli r0, r3, 0x38
/* 801812CC 0000004C  7C 64 02 14 */	add r3, r4, r0
/* 801812D0 00000050  88 03 5D 78 */	lbz r0, 0x5d78(r3)
/* 801812D4 00000054  7C 00 07 74 */	extsb r0, r0
/* 801812D8 00000058  1C 00 00 2C */	mulli r0, r0, 0x2c
/* 801812DC 0000005C  7C 64 02 14 */	add r3, r4, r0
/* 801812E0 00000060  3B C3 5D 60 */	addi r30, r3, 0x5d60
/* 801812E4 00000064  38 61 00 08 */	addi r3, r1, 8
/* 801812E8 00000068  7F E4 FB 78 */	mr r4, r31
/* 801812EC 0000006C  80 BF 07 10 */	lwz r5, 0x710(r31)
/* 801812F0 00000070  4B F1 64 9D */	bl eyePos__9dCamera_cFP10fopAc_ac_c
/* 801812F4 00000074  C0 01 00 08 */	lfs f0, 8(r1)
/* 801812F8 00000078  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 801812FC 0000007C  C0 01 00 0C */	lfs f0, 0xc(r1)
/* 80181300 00000080  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80181304 00000084  C0 01 00 10 */	lfs f0, 0x10(r1)
/* 80181308 00000088  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 8018130C 0000008C  38 61 00 2C */	addi r3, r1, 0x2c
/* 80181310 00000090  38 81 00 20 */	addi r4, r1, 0x20
/* 80181314 00000094  4B E9 3F FD */	bl mDoLib_project__FP3VecP3Vec
/* 80181318 00000098  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 8018131C 0000009C  C0 1E 00 08 */	lfs f0, 8(r30)
/* 80181320 000000A0  EC 01 00 24 */	fdivs f0, f1, f0
/* 80181324 000000A4  D0 1F 07 18 */	stfs f0, 0x718(r31)
/* 80181328 000000A8  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 8018132C 000000AC  C0 1E 00 0C */	lfs f0, 0xc(r30)
/* 80181330 000000B0  EC 01 00 24 */	fdivs f0, f1, f0
/* 80181334 000000B4  D0 1F 07 1C */	stfs f0, 0x71c(r31)
/* 80181338 000000B8  C0 02 9C A0 */	lfs f0, LIT_5656(r2)
/* 8018133C 000000BC  D0 1F 07 20 */	stfs f0, 0x720(r31)
lbl_80181340:
...
/* 80181458 00000118  9B CD 86 65 */	stb r30, merged_80450BE4+1(r13)
/* 8018145C 0000011C  48 00 00 10 */	b lbl_8018146C
lbl_80181460:
/* 80181460 00000000  38 00 00 00 */	li r0, 0
/* 80181464 00000004  98 0D 86 64 */	stb r0, merged_80450BE4+0(r13)
...
/* 80181474 00000008  CB E1 00 60 */	lfd f31, 0x60(r1)
/* 80181478 0000000C  83 E1 00 5C */	lwz r31, 0x5c(r1)
/* 8018147C 00000010  83 C1 00 58 */	lwz r30, 0x58(r1)
/* 80181480 00000014  80 01 00 74 */	lwz r0, 0x74(r1)
/* 80181484 00000018  7C 08 03 A6 */	mtlr r0
/* 80181488 0000001C  38 21 00 70 */	addi r1, r1, 0x70
/* 8018148C 00000020  4E 80 00 20 */	blr 

...
/* 80058BA0 00000014  39 61 00 20 */	addi r11, r1, 0x20
/* 80058BA4 00000018  48 30 96 39 */	bl _savegpr_29
/* 80058BA8 0000001C  3B C0 00 00 */	li r30, 0
/* 80058BAC 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80058BB0 00000024  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l
/* 80058BB4 00000028  3B FD 4E 00 */	addi r31, r29, 0x4e00
/* 80058BB8 0000002C  7F E3 FB 78 */	mr r3, r31
/* 80058BBC 00000030  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058BC0 00000034  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
/* 80058BC4 00000038  38 84 00 17 */	addi r4, r4, 0x17
/* 80058BC8 0000003C  48 30 FD CD */	bl strcmp
/* 80058BCC 00000040  2C 03 00 00 */	cmpwi r3, 0
/* 80058BD0 00000044  41 82 03 28 */	beq lbl_80058EF8
/* 80058BD4 00000048  7F E3 FB 78 */	mr r3, r31
/* 80058BD8 0000004C  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058BDC 00000050  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
/* 80058BE0 00000054  38 84 00 1E */	addi r4, r4, 0x1e
/* 80058BE4 00000058  48 30 FD B1 */	bl strcmp
/* 80058BE8 0000005C  2C 03 00 00 */	cmpwi r3, 0
/* 80058BEC 00000060  40 82 00 08 */	bne lbl_80058BF4
/* 80058BF0 00000064  48 00 03 08 */	b lbl_80058EF8
lbl_80058BF4:
...
/* 80058C20 00000004  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058C24 00000008  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 80058C58 00000020  88 8D 87 E4 */	lbz r4, merged_80450D64+0(r13)
...
/* 80058C84 00000004  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058C88 00000008  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 80058CA8 00000008  48 15 38 D5 */	bl dKy_darkworld_check(void)
...
/* 80058CC4 00000024  C0 82 87 00 */	lfs f4, d_d_kankyo_wether__LIT_4761(r2)
/* 80058CC8 00000028  FC 01 20 40 */	fcmpo cr0, f1, f4
/* 80058CCC 0000002C  4C 41 13 82 */	cror 2, 1, 2
/* 80058CD0 00000030  41 82 00 10 */	beq lbl_80058CE0
/* 80058CD4 00000034  C0 02 87 04 */	lfs f0, d_d_kankyo_wether__LIT_4762(r2)
/* 80058CD8 00000038  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80058CDC 0000003C  40 80 00 0C */	bge lbl_80058CE8
lbl_80058CE0:
/* 80058CE0 00000000  C3 E2 86 E4 */	lfs f31, d_d_kankyo_wether__LIT_4379(r2)
/* 80058CE4 00000004  48 00 00 48 */	b lbl_80058D2C
lbl_80058CE8:
/* 80058CE8 00000000  C0 02 87 08 */	lfs f0, d_d_kankyo_wether__LIT_4763(r2)
/* 80058CEC 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80058CF0 00000008  40 81 00 1C */	ble lbl_80058D0C
/* 80058CF4 0000000C  C0 62 86 E4 */	lfs f3, d_d_kankyo_wether__LIT_4379(r2)
/* 80058CF8 00000010  C0 42 87 0C */	lfs f2, d_d_kankyo_wether__LIT_4764(r2)
/* 80058CFC 00000014  EC 04 08 28 */	fsubs f0, f4, f1
/* 80058D00 00000018  EC 02 00 32 */	fmuls f0, f2, f0
/* 80058D04 0000001C  EF E3 00 28 */	fsubs f31, f3, f0
/* 80058D08 00000020  48 00 00 24 */	b lbl_80058D2C
lbl_80058D0C:
/* 80058D0C 00000000  C0 02 87 10 */	lfs f0, d_d_kankyo_wether__LIT_4765(r2)
/* 80058D10 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80058D14 00000008  40 80 00 14 */	bge lbl_80058D28
/* 80058D18 0000000C  C0 42 87 14 */	lfs f2, d_d_kankyo_wether__LIT_4766(r2)
/* 80058D1C 00000010  EC 00 08 28 */	fsubs f0, f0, f1
/* 80058D20 00000014  EF E2 00 32 */	fmuls f31, f2, f0
/* 80058D24 00000018  48 00 00 08 */	b lbl_80058D2C
lbl_80058D28:
...
/* 80058D5C 00000018  C0 02 87 18 */	lfs f0, d_d_kankyo_wether__LIT_4767(r2)
/* 80058D60 0000001C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80058D64 00000020  40 81 00 08 */	ble lbl_80058D6C
/* 80058D68 00000024  C3 E2 86 E0 */	lfs f31, LIT_4378(r2)
lbl_80058D6C:
/* 80058D6C 00000000  7F E3 FB 78 */	mr r3, r31
/* 80058D70 00000004  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058D74 00000008  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 80058D88 0000001C  C3 E2 86 E4 */	lfs f31, d_d_kankyo_wether__LIT_4379(r2)
lbl_80058D8C:
...
/* 80058DA0 00000014  C0 42 87 1C */	lfs f2, d_d_kankyo_wether__LIT_4768(r2)
/* 80058DA4 00000018  C0 62 87 20 */	lfs f3, d_d_kankyo_wether__LIT_4769(r2)
/* 80058DA8 0000001C  C0 82 87 24 */	lfs f4, d_d_kankyo_wether__LIT_4770(r2)
/* 80058DAC 00000020  48 21 6B D1 */	bl cLib_addCalc(f32*, f32, f32, f32, f32)
/* 80058DB0 00000024  C0 22 87 28 */	lfs f1, d_d_kankyo_wether__LIT_4771(r2)
...
/* 80058DDC 00000050  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058DE0 00000054  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 80058DF8 0000006C  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058DFC 00000070  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 80058E14 00000088  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 80058E18 0000008C  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
lbl_80058E2C:
/* 80058E2C 00000000  C0 22 87 2C */	lfs f1, d_d_kankyo_wether__LIT_4772(r2)
...
/* 80058E7C 0000000C  48 00 84 A9 */	bl dKyr_star_init(void)
...
/* 80058E98 00000028  48 00 85 75 */	bl dKyr_star_move(void)
...
lbl_80058EAC:
/* 80058EAC 00000000  48 00 85 61 */	bl dKyr_star_move(void)
...
/* 80058EFC 00000004  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 80058F00 00000008  39 61 00 20 */	addi r11, r1, 0x20
/* 80058F04 0000000C  48 30 93 25 */	bl _restgpr_29
/* 80058F08 00000010  80 01 00 34 */	lwz r0, 0x34(r1)
/* 80058F0C 00000014  7C 08 03 A6 */	mtlr r0
/* 80058F10 00000018  38 21 00 30 */	addi r1, r1, 0x30
/* 80058F14 0000001C  4E 80 00 20 */	blr 

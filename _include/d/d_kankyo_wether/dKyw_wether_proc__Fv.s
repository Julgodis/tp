...
/* 8005A364 00000024  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 8005A368 00000028  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 8005A380 00000040  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 8005A384 00000044  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 8005A39C 0000005C  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 8005A3A0 00000060  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 8005A3DC 00000010  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 8005A3E0 00000014  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 8005A400 00000034  C0 02 87 10 */	lfs f0, d_d_kankyo_wether__LIT_4765(r2)
/* 8005A404 00000038  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8005A408 0000003C  4C 41 13 82 */	cror 2, 1, 2
/* 8005A40C 00000040  40 82 00 14 */	bne lbl_8005A420
/* 8005A410 00000044  C0 02 87 64 */	lfs f0, LIT_5361(r2)
/* 8005A414 00000048  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8005A418 0000004C  4C 40 13 82 */	cror 2, 0, 2
/* 8005A41C 00000050  41 82 00 40 */	beq lbl_8005A45C
lbl_8005A420:
/* 8005A420 00000000  7F E3 FB 78 */	mr r3, r31
/* 8005A424 00000004  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 8005A428 00000008  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l
...
/* 8005A468 0000000C  C0 22 86 E4 */	lfs f1, d_d_kankyo_wether__LIT_4379(r2)
/* 8005A46C 00000010  C0 42 87 68 */	lfs f2, LIT_5362(r2)
/* 8005A470 00000014  C0 62 87 6C */	lfs f3, LIT_5363(r2)
/* 8005A474 00000018  C0 82 87 24 */	lfs f4, d_d_kankyo_wether__LIT_4770(r2)
...
/* 8005A4C0 00000028  C0 02 87 20 */	lfs f0, d_d_kankyo_wether__LIT_4769(r2)
/* 8005A4C4 0000002C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8005A4C8 00000030  4C 40 13 82 */	cror 2, 0, 2
/* 8005A4CC 00000034  40 82 00 20 */	bne lbl_8005A4EC
/* 8005A4D0 00000038  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8005A4D4 0000003C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8005A4D8 00000040  80 03 0E B8 */	lwz r0, 0xeb8(r3)
/* 8005A4DC 00000044  2C 00 00 31 */	cmpwi r0, 0x31
/* 8005A4E0 00000048  40 82 00 0C */	bne lbl_8005A4EC
/* 8005A4E4 0000004C  38 00 00 00 */	li r0, 0
/* 8005A4E8 00000050  90 03 0E B8 */	stw r0, 0xeb8(r3)
lbl_8005A4EC:
/* 8005A4EC 00000000  7F E3 FB 78 */	mr r3, r31
/* 8005A4F0 00000004  3C 80 80 38 */	lis r4, d_d_kankyo_wether__stringBase0@ha
/* 8005A4F4 00000008  38 84 A3 68 */	addi r4, r4, d_d_kankyo_wether__stringBase0@l

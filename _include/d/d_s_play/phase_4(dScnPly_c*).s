...
lbl_8025A6F8:
/* 8025A6F8 00000000  4B DD 42 F9 */	bl dComIfGp_calcNowRegion(void)
...
/* 8025A7A0 00000018  C0 22 B5 28 */	lfs f1, d_d_s_play__LIT_4068(r2)
/* 8025A7A4 0000001C  FC 40 08 90 */	fmr f2, f1
/* 8025A7A8 00000020  C0 62 B5 30 */	lfs f3, d_d_s_play__LIT_4804(r2)
/* 8025A7AC 00000024  C0 82 B5 34 */	lfs f4, d_d_s_play__LIT_4805(r2)
/* 8025A7B0 00000028  FC A0 08 90 */	fmr f5, f1
/* 8025A7B4 0000002C  C0 C2 B5 38 */	lfs f6, d_d_s_play__LIT_4806(r2)
/* 8025A7B8 00000030  4B DF 73 09 */	bl setViewPort__14dDlst_window_cFffffff
/* 8025A7BC 00000034  7F 83 E3 78 */	mr r3, r28
/* 8025A7C0 00000038  C0 22 B5 28 */	lfs f1, d_d_s_play__LIT_4068(r2)
/* 8025A7C4 0000003C  FC 40 08 90 */	fmr f2, f1
/* 8025A7C8 00000040  C0 62 B5 30 */	lfs f3, d_d_s_play__LIT_4804(r2)
/* 8025A7CC 00000044  C0 82 B5 34 */	lfs f4, d_d_s_play__LIT_4805(r2)
...
/* 8025A810 00000088  3C 60 00 0C */	lis r3, 0x000C /* 000BB800@ha */
/* 8025A814 0000008C  38 63 B8 00 */	addi r3, r3, 0xB800 /* 000BB800@l */
/* 8025A818 00000090  38 80 00 00 */	li r4, 0
/* 8025A81C 00000094  4B DC 5B 81 */	bl fopMsgM_createExpHeap(u32, JKRHeap*)
...
/* 8025A82C 000000A4  3C 60 00 01 */	lis r3, 0x0001 /* 0000A800@ha */
/* 8025A830 000000A8  38 63 A8 00 */	addi r3, r3, 0xA800 /* 0000A800@l */
/* 8025A834 000000AC  38 80 00 00 */	li r4, 0
/* 8025A838 000000B0  4B DC 5B 65 */	bl fopMsgM_createExpHeap(u32, JKRHeap*)
...
/* 8025A870 000000E8  4B DB F5 29 */	bl fopAcM_create(s16, u32, const cXyz*, int, const csXyz*, const cXyz*, s8)
...
/* 8025A8A0 00000118  4B FC 3C 11 */	bl dMeter2Info_setCloth(u8, bool)
/* 8025A8A4 0000011C  38 60 00 28 */	li r3, 0x28
/* 8025A8A8 00000120  38 80 00 00 */	li r4, 0
/* 8025A8AC 00000124  4B FC 3C 85 */	bl dMeter2Info_setSword(u8, bool)
/* 8025A8B0 00000128  38 60 00 2C */	li r3, 0x2c
/* 8025A8B4 0000012C  38 80 00 00 */	li r4, 0
/* 8025A8B8 00000130  4B FC 3D 1D */	bl dMeter2Info_setShield(u8, bool)
...
/* 8025A8D8 00000008  4B DC C4 61 */	bl dStage_Create(void)
...
/* 8025A8EC 0000001C  3C 60 80 00 */	lis r3, 0x8000 /* 800000F8@ha */
...
/* 8025A94C 00000010  98 AD 88 0C */	stb r5, merged_80450D8C+0(r13)
/* 8025A950 00000014  38 80 00 01 */	li r4, 1
/* 8025A954 00000018  98 8D 88 0D */	stb r4, merged_80450D8C+1(r13)
/* 8025A958 0000001C  38 00 00 FF */	li r0, 0xff
/* 8025A95C 00000020  98 0D 88 0E */	stb r0, merged_80450D8C+2(r13)
...
/* 8025A970 00000034  98 AD 86 66 */	stb r5, merged_80450BE4+2(r13)
/* 8025A974 00000038  98 8D 86 3A */	stb r4, merged_80450BB8+2(r13)
/* 8025A978 0000003C  98 AD 8B A4 */	stb r5, merged_80451124+0(r13)
/* 8025A97C 00000040  98 AD 8B A5 */	stb r5, merged_80451124+1(r13)
/* 8025A980 00000044  38 00 FF FF */	li r0, -1
/* 8025A984 00000048  98 0D 81 E4 */	stb r0, merged_80450764+0(r13)
/* 8025A988 0000004C  88 0D 81 E5 */	lbz r0, merged_80450764+1(r13)
...
/* 8025A9B4 00000078  9B 8D 81 E4 */	stb r28, merged_80450764+0(r13)
lbl_8025A9B8:
/* 8025A9B8 00000000  88 0D 81 E4 */	lbz r0, merged_80450764+0(r13)

...
/* 8002CC7C 00000028  98 03 4E 1C */	stb r0, 0x4e1c(r3)
/* 8002CC80 0000002C  3C 60 80 38 */	lis r3, d_d_com_inf_game__stringBase0@ha
/* 8002CC84 00000030  38 63 8F 38 */	addi r3, r3, d_d_com_inf_game__stringBase0@l
...
/* 8002CC98 00000044  48 00 08 BD */	bl dComIfGp_setNextStage(const s8*, s16, s8, s8)
...
/* 8002CCA8 00000054  88 05 4E 18 */	lbz r0, 0x4e18(r5)
/* 8002CCAC 00000058  7C 04 07 74 */	extsb r4, r0
/* 8002CCB0 0000005C  88 05 4E 19 */	lbz r0, 0x4e19(r5)
/* 8002CCB4 00000060  7C 05 07 74 */	extsb r5, r0
/* 8002CCB8 00000064  4B FD A5 05 */	bl mDoAud_setSceneName(const s8*, s32, s32)
...
/* 8002CCC8 00000074  90 03 0D C8 */	stw r0, 0xdc8(r3)
...
/* 8002CD18 00000010  4B FF 1F C9 */	bl fopScnM_ChangeReq(scene_class*, s16, s16, u16)
/* 8002CD1C 00000014  7F E3 FB 78 */	mr r3, r31
/* 8002CD20 00000018  38 80 00 00 */	li r4, 0
/* 8002CD24 0000001C  4B FF 20 A9 */	bl fopScnM_ReRequest(s16, u32)

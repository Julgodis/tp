...
/* 802B679C 00000014  93 E1 00 0C */	stw r31, 0xc(r1)
/* 802B67A0 00000018  7C 7F 1B 78 */	mr r31, r3
/* 802B67A4 0000001C  FF E0 08 90 */	fmr f31, f1
/* 802B67A8 00000020  C0 42 C0 1C */	lfs f2, LIT_3396(r2)
/* 802B67AC 00000024  FC 02 F8 00 */	fcmpu cr0, f2, f31
/* 802B67B0 00000028  40 82 00 18 */	bne lbl_802B67C8
/* 802B67B4 0000002C  D0 5F 00 1C */	stfs f2, 0x1c(r31)
/* 802B67B8 00000030  80 6D 85 C0 */	lwz r3, data_80450B40(r13)
/* 802B67BC 00000034  38 80 00 00 */	li r4, 0
/* 802B67C0 00000038  48 00 46 89 */	bl setUnderWaterFx__11Z2FxLineMgrFb
/* 802B67C4 0000003C  48 00 00 5C */	b lbl_802B6820
lbl_802B67C8:
...
/* 802B67E8 00000020  4C 41 13 82 */	cror 2, 1, 2
/* 802B67EC 00000024  40 82 00 10 */	bne lbl_802B67FC
/* 802B67F0 00000028  C0 02 C0 20 */	lfs f0, LIT_3467(r2)
/* 802B67F4 0000002C  D0 1F 00 1C */	stfs f0, 0x1c(r31)
/* 802B67F8 00000030  48 00 00 1C */	b lbl_802B6814
lbl_802B67FC:
...
/* 802B6828 00000008  CB E1 00 10 */	lfd f31, 0x10(r1)
/* 802B682C 0000000C  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 802B6830 00000010  80 01 00 24 */	lwz r0, 0x24(r1)
/* 802B6834 00000014  7C 08 03 A6 */	mtlr r0
/* 802B6838 00000018  38 21 00 20 */	addi r1, r1, 0x20
/* 802B683C 0000001C  4E 80 00 20 */	blr 

...
/* 802C6AD4 00000014  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 802C6AD8 00000018  7C 7F 1B 78 */	mr r31, r3
/* 802C6ADC 0000001C  FF E0 08 90 */	fmr f31, f1
/* 802C6AE0 00000020  C0 02 C3 74 */	lfs f0, Z2EnvSeMgr__LIT_3705(r2)
/* 802C6AE4 00000024  D0 03 00 60 */	stfs f0, 0x60(r3)
/* 802C6AE8 00000028  FC 00 F8 00 */	fcmpu cr0, f0, f31
/* 802C6AEC 0000002C  41 82 01 14 */	beq lbl_802C6C00
/* 802C6AF0 00000030  C0 02 C3 F0 */	lfs f0, Z2EnvSeMgr__LIT_3963(r2)
/* 802C6AF4 00000034  EC 00 07 F2 */	fmuls f0, f0, f31
/* 802C6AF8 00000038  FC 00 00 1E */	fctiwz f0, f0
/* 802C6AFC 0000003C  D8 01 00 08 */	stfd f0, 8(r1)
/* 802C6B00 00000040  80 C1 00 0C */	lwz r6, 0xc(r1)
/* 802C6B04 00000044  38 E0 00 00 */	li r7, 0
/* 802C6B08 00000048  2C 04 00 21 */	cmpwi r4, 0x21
/* 802C6B0C 0000004C  41 82 00 D4 */	beq lbl_802C6BE0
/* 802C6B10 00000050  40 80 00 1C */	bge lbl_802C6B2C
/* 802C6B14 00000054  2C 04 00 1F */	cmpwi r4, 0x1f
/* 802C6B18 00000058  41 82 00 7C */	beq lbl_802C6B94
/* 802C6B1C 0000005C  40 80 00 B0 */	bge lbl_802C6BCC
/* 802C6B20 00000060  2C 04 00 1E */	cmpwi r4, 0x1e
/* 802C6B24 00000064  40 80 00 20 */	bge lbl_802C6B44
/* 802C6B28 00000068  48 00 00 B8 */	b lbl_802C6BE0
lbl_802C6B2C:
...
/* 802C6C04 00000004  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 802C6C08 00000008  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 802C6C0C 0000000C  80 01 00 34 */	lwz r0, 0x34(r1)
/* 802C6C10 00000010  7C 08 03 A6 */	mtlr r0
/* 802C6C14 00000014  38 21 00 30 */	addi r1, r1, 0x30
/* 802C6C18 00000018  4E 80 00 20 */	blr 

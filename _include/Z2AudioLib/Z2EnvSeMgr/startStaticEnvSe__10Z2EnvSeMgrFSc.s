...
/* 802C70EC 00000024  DB 81 00 D0 */	stfd f28, 0xd0(r1)
/* 802C70F0 00000028  F3 81 00 D8 */	psq_st f28, 216(r1), 0, 0 /* qr0 */
/* 802C70F4 0000002C  DB 61 00 C0 */	stfd f27, 0xc0(r1)
/* 802C70F8 00000030  F3 61 00 C8 */	psq_st f27, 200(r1), 0, 0 /* qr0 */
/* 802C70FC 00000034  39 61 00 C0 */	addi r11, r1, 0xc0
/* 802C7100 00000038  48 09 B0 D9 */	bl _savegpr_28
/* 802C7104 0000003C  7C 7F 1B 78 */	mr r31, r3
/* 802C7108 00000040  38 00 00 64 */	li r0, 0x64
/* 802C710C 00000044  98 03 01 B8 */	stb r0, 0x1b8(r3)
/* 802C7110 00000048  7C 80 07 74 */	extsb r0, r4
/* 802C7114 0000004C  C8 22 C4 20 */	lfd f1, Z2EnvSeMgr__LIT_4271(r2)
/* 802C7118 00000050  6C 00 80 00 */	xoris r0, r0, 0x8000
/* 802C711C 00000054  90 01 00 8C */	stw r0, 0x8c(r1)
/* 802C7120 00000058  3C 00 43 30 */	lis r0, 0x4330
/* 802C7124 0000005C  90 01 00 88 */	stw r0, 0x88(r1)
/* 802C7128 00000060  C8 01 00 88 */	lfd f0, 0x88(r1)
/* 802C712C 00000064  EC 20 08 28 */	fsubs f1, f0, f1
/* 802C7130 00000068  C0 02 C3 F4 */	lfs f0, Z2EnvSeMgr__LIT_4260(r2)
/* 802C7134 0000006C  EF E1 00 24 */	fdivs f31, f1, f0
/* 802C7138 00000070  88 03 00 39 */	lbz r0, 0x39(r3)
/* 802C713C 00000074  28 00 00 00 */	cmplwi r0, 0
/* 802C7140 00000078  41 82 00 5C */	beq lbl_802C719C
/* 802C7144 0000007C  C0 3F 00 48 */	lfs f1, 0x48(r31)
/* 802C7148 00000080  C0 1F 00 54 */	lfs f0, 0x54(r31)
/* 802C714C 00000084  EC 01 00 2A */	fadds f0, f1, f0
/* 802C7150 00000088  D0 1F 00 48 */	stfs f0, 0x48(r31)
/* 802C7154 0000008C  C0 3F 00 4C */	lfs f1, 0x4c(r31)
/* 802C7158 00000090  C0 1F 00 58 */	lfs f0, 0x58(r31)
/* 802C715C 00000094  EC 01 00 2A */	fadds f0, f1, f0
/* 802C7160 00000098  D0 1F 00 4C */	stfs f0, 0x4c(r31)
/* 802C7164 0000009C  C0 3F 00 50 */	lfs f1, 0x50(r31)
/* 802C7168 000000A0  C0 1F 00 5C */	lfs f0, 0x5c(r31)
/* 802C716C 000000A4  EC 01 00 2A */	fadds f0, f1, f0
/* 802C7170 000000A8  D0 1F 00 50 */	stfs f0, 0x50(r31)
/* 802C7174 000000AC  88 7F 00 39 */	lbz r3, 0x39(r31)
/* 802C7178 000000B0  38 03 FF FF */	addi r0, r3, -1
/* 802C717C 000000B4  98 1F 00 39 */	stb r0, 0x39(r31)
/* 802C7180 000000B8  88 1F 00 39 */	lbz r0, 0x39(r31)
/* 802C7184 000000BC  28 00 00 00 */	cmplwi r0, 0
/* 802C7188 000000C0  40 82 00 14 */	bne lbl_802C719C
/* 802C718C 000000C4  C0 02 C3 48 */	lfs f0, LIT_3503(r2)
/* 802C7190 000000C8  D0 1F 00 54 */	stfs f0, 0x54(r31)
/* 802C7194 000000CC  D0 1F 00 58 */	stfs f0, 0x58(r31)
/* 802C7198 000000D0  D0 1F 00 5C */	stfs f0, 0x5c(r31)
lbl_802C719C:
...
/* 802C7248 00000060  3C 60 00 09 */	lis r3, 0x0009 /* 0009001F@ha */
/* 802C724C 00000064  38 03 00 1F */	addi r0, r3, 0x001F /* 0009001F@l */
...
lbl_802C7270:
/* 802C7270 00000000  3C 60 00 09 */	lis r3, 0x0009 /* 00090020@ha */
/* 802C7274 00000004  38 03 00 20 */	addi r0, r3, 0x0020 /* 00090020@l */
...
lbl_802C72A8:
/* 802C72A8 00000000  3C 60 00 09 */	lis r3, 0x0009 /* 00090010@ha */
/* 802C72AC 00000004  38 03 00 10 */	addi r0, r3, 0x0010 /* 00090010@l */
...
/* 802C72CC 00000024  3C 60 00 09 */	lis r3, 0x0009 /* 00090010@ha */
/* 802C72D0 00000028  38 03 00 10 */	addi r0, r3, 0x0010 /* 00090010@l */
...
/* 802C72E8 00000040  3C 60 00 09 */	lis r3, 0x0009 /* 00090032@ha */
/* 802C72EC 00000044  38 03 00 32 */	addi r0, r3, 0x0032 /* 00090032@l */
...
/* 802C7534 00000114  3C 60 00 09 */	lis r3, 0x0009 /* 0009001A@ha */
/* 802C7538 00000118  38 03 00 1A */	addi r0, r3, 0x001A /* 0009001A@l */
...
lbl_802C7584:
/* 802C7584 00000000  3C 60 00 09 */	lis r3, 0x0009 /* 00090009@ha */
/* 802C7588 00000004  38 03 00 09 */	addi r0, r3, 0x0009 /* 00090009@l */
...
lbl_802C75D0:
/* 802C75D0 00000000  3C 60 00 09 */	lis r3, 0x0009 /* 00090009@ha */
/* 802C75D4 00000004  38 03 00 09 */	addi r0, r3, 0x0009 /* 00090009@l */
...
/* 802C7600 00000030  3C 60 00 09 */	lis r3, 0x0009 /* 0009001A@ha */
/* 802C7604 00000034  38 03 00 1A */	addi r0, r3, 0x001A /* 0009001A@l */
...
/* 802C7620 00000050  3C 60 00 09 */	lis r3, 0x0009 /* 00090014@ha */
/* 802C7624 00000054  38 03 00 14 */	addi r0, r3, 0x0014 /* 00090014@l */
...
/* 802C7640 00000070  3C 60 00 09 */	lis r3, 0x0009 /* 0009003F@ha */
/* 802C7644 00000074  38 03 00 3F */	addi r0, r3, 0x003F /* 0009003F@l */
...
/* 802C77D0 00000004  CB E1 01 00 */	lfd f31, 0x100(r1)
/* 802C77D4 00000008  E3 C1 00 F8 */	psq_l f30, 248(r1), 0, 0 /* qr0 */
/* 802C77D8 0000000C  CB C1 00 F0 */	lfd f30, 0xf0(r1)
/* 802C77DC 00000010  E3 A1 00 E8 */	psq_l f29, 232(r1), 0, 0 /* qr0 */
/* 802C77E0 00000014  CB A1 00 E0 */	lfd f29, 0xe0(r1)
/* 802C77E4 00000018  E3 81 00 D8 */	psq_l f28, 216(r1), 0, 0 /* qr0 */
/* 802C77E8 0000001C  CB 81 00 D0 */	lfd f28, 0xd0(r1)
/* 802C77EC 00000020  E3 61 00 C8 */	psq_l f27, 200(r1), 0, 0 /* qr0 */
/* 802C77F0 00000024  CB 61 00 C0 */	lfd f27, 0xc0(r1)
/* 802C77F4 00000028  39 61 00 C0 */	addi r11, r1, 0xc0
/* 802C77F8 0000002C  48 09 AA 2D */	bl _restgpr_28
/* 802C77FC 00000030  80 01 01 14 */	lwz r0, 0x114(r1)
/* 802C7800 00000034  7C 08 03 A6 */	mtlr r0
/* 802C7804 00000038  38 21 01 10 */	addi r1, r1, 0x110
/* 802C7808 0000003C  4E 80 00 20 */	blr 

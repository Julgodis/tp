...
/* 802C1380 00000014  DB C1 00 40 */	stfd f30, 0x40(r1)
/* 802C1384 00000018  F3 C1 00 48 */	psq_st f30, 72(r1), 0, 0 /* qr0 */
/* 802C1388 0000001C  39 61 00 40 */	addi r11, r1, 0x40
/* 802C138C 00000020  48 0A 0E 4D */	bl _savegpr_28
/* 802C1390 00000024  7C 7C 1B 78 */	mr r28, r3
/* 802C1394 00000028  7C 9D 23 78 */	mr r29, r4
/* 802C1398 0000002C  7C BE 2B 78 */	mr r30, r5
/* 802C139C 00000030  80 64 00 00 */	lwz r3, 0(r4)
/* 802C13A0 00000034  3C 03 FF F9 */	addis r0, r3, 0xfff9
/* 802C13A4 00000038  28 00 FF FF */	cmplwi r0, 0xffff
/* 802C13A8 0000003C  40 82 00 7C */	bne lbl_802C1424
/* 802C13AC 00000040  80 6D 85 C4 */	lwz r3, data_80450B44(r13)
/* 802C13B0 00000044  80 9C 00 04 */	lwz r4, 4(r28)
/* 802C13B4 00000048  38 A1 00 0C */	addi r5, r1, 0xc
/* 802C13B8 0000004C  38 C0 00 00 */	li r6, 0
/* 802C13BC 00000050  4B FF C5 71 */	bl convertAbsToRel__10Z2AudienceFR3VecP3Veci
/* 802C13C0 00000054  80 6D 85 C4 */	lwz r3, data_80450B44(r13)
/* 802C13C4 00000058  38 81 00 0C */	addi r4, r1, 0xc
/* 802C13C8 0000005C  C0 22 C2 50 */	lfs f1, Z2Creature__LIT_4187(r2)
/* 802C13CC 00000060  38 A0 00 00 */	li r5, 0
/* 802C13D0 00000064  4B FF C5 8D */	bl calcRelPosVolume__10Z2AudienceFRC3Vecfi
/* 802C13D4 00000068  FF E0 08 90 */	fmr f31, f1
/* 802C13D8 0000006C  80 6D 85 C4 */	lwz r3, data_80450B44(r13)
/* 802C13DC 00000070  38 81 00 0C */	addi r4, r1, 0xc
/* 802C13E0 00000074  38 A0 00 00 */	li r5, 0
/* 802C13E4 00000078  4B FF C6 61 */	bl calcRelPosPan__10Z2AudienceFRC3Veci
/* 802C13E8 0000007C  FF C0 08 90 */	fmr f30, f1
/* 802C13EC 00000080  80 6D 85 C4 */	lwz r3, data_80450B44(r13)
/* 802C13F0 00000084  38 81 00 0C */	addi r4, r1, 0xc
/* 802C13F4 00000088  38 A0 00 00 */	li r5, 0
/* 802C13F8 0000008C  4B FF C7 4D */	bl calcRelPosDolby__10Z2AudienceFRC3Veci
/* 802C13FC 00000090  FC 60 08 90 */	fmr f3, f1
/* 802C1400 00000094  80 6D 86 04 */	lwz r3, data_80450B84(r13)
/* 802C1404 00000098  7C 64 1B 78 */	mr r4, r3
/* 802C1408 0000009C  38 A0 00 07 */	li r5, 7
/* 802C140C 000000A0  FC 20 F8 90 */	fmr f1, f31
/* 802C1410 000000A4  38 C0 00 00 */	li r6, 0
/* 802C1414 000000A8  FC 40 F0 90 */	fmr f2, f30
/* 802C1418 000000AC  4B FF 2B D5 */	bl setChildTrackVolume__8Z2SeqMgrFP14JAISoundHandleifUlff
/* 802C141C 000000B0  38 60 00 00 */	li r3, 0
/* 802C1420 000000B4  48 00 02 44 */	b lbl_802C1664
lbl_802C1424:
...
/* 802C1668 00000004  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 802C166C 00000008  E3 C1 00 48 */	psq_l f30, 72(r1), 0, 0 /* qr0 */
/* 802C1670 0000000C  CB C1 00 40 */	lfd f30, 0x40(r1)
/* 802C1674 00000010  39 61 00 40 */	addi r11, r1, 0x40
/* 802C1678 00000014  48 0A 0B AD */	bl _restgpr_28
/* 802C167C 00000018  80 01 00 64 */	lwz r0, 0x64(r1)
/* 802C1680 0000001C  7C 08 03 A6 */	mtlr r0
/* 802C1684 00000020  38 21 00 60 */	addi r1, r1, 0x60
/* 802C1688 00000024  4E 80 00 20 */	blr 

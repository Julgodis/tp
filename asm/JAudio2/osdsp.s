...
/* ###################################################################################### */
.section .text, "ax"
/* 8029EA00 003C .text      DSPAddTask                     DSPAddTask                     */
.global DSPAddTask
DSPAddTask:
...
/* 8029EA18 0029B958  80 0D 8D 8C */	lwz r0, DSP_prior_task-_SDA_BASE_(r13)
/* 8029EA1C 0029B95C  28 00 00 00 */	cmplwi r0, 0
/* 8029EA20 0029B960  40 82 00 1C */	bne func_8029EA3C
/* 8029EA24 0029B964  3C 60 80 3A */	lis r3, osdsp__LIT_81@ha
/* 8029EA28 0029B968  38 63 B8 B8 */	addi r3, r3, osdsp__LIT_81@l
/* 8029EA2C 0029B96C  4C C6 31 82 */	crclr 6
/* 8029EA30 0029B970  4B D6 80 8D */	bl OSReport
/* 8029EA34 0029B974  38 60 00 00 */	li r3, 0
/* 8029EA38 0029B978  48 00 00 34 */	b func_8029EA6C

/* 8029EA3C 0030 .text      func_8029EA3C                  func_8029EA3C                  */
.global func_8029EA3C
func_8029EA3C:
/* 8029EA3C 0029B97C  48 09 EC B9 */	bl OSDisableInterrupts
...
/* 8029EA6C 0034 .text      func_8029EA6C                  func_8029EA6C                  */
.global func_8029EA6C
func_8029EA6C:
...
/* 8029EAA0 0038 .text      DSPAddPriorTask__FP15STRUCT_DSP_TASK DSPAddPriorTask__FP15STRUCT_DSP_TASK */
...
/* 8029EAB8 0029B9F8  80 0D 8D 8C */	lwz r0, DSP_prior_task-_SDA_BASE_(r13)
/* 8029EABC 0029B9FC  28 00 00 00 */	cmplwi r0, 0
/* 8029EAC0 0029BA00  41 82 00 18 */	beq func_8029EAD8
/* 8029EAC4 0029BA04  3C 60 80 3A */	lis r3, osdsp__LIT_88@ha
/* 8029EAC8 0029BA08  38 63 B8 D4 */	addi r3, r3, osdsp__LIT_88@l
/* 8029EACC 0029BA0C  4C C6 31 82 */	crclr 6
/* 8029EAD0 0029BA10  4B D6 7F ED */	bl OSReport
/* 8029EAD4 0029BA14  48 00 00 30 */	b func_8029EB04

/* 8029EAD8 002C .text      func_8029EAD8                  func_8029EAD8                  */
.global func_8029EAD8
func_8029EAD8:
/* 8029EAD8 0029BA18  48 09 EC 1D */	bl OSDisableInterrupts
/* 8029EADC 0029BA1C  93 CD 8D 8C */	stw r30, DSP_prior_task-_SDA_BASE_(r13)
...
/* 8029EB04 001C .text      func_8029EB04                  func_8029EB04                  */
.global func_8029EB04
func_8029EB04:
...
/* ###################################################################################### */
.section .rodata, "a"
/* 8039B8B8 001A .rodata    osdsp__LIT_81                  @81                            */
.global osdsp__LIT_81
osdsp__LIT_81:
.byte 0x50, 0x72, 0x69, 0x6f, 0x72, 0x20, 0x54, 0x61, 0x73, 0x6b, 0x20, 0x69, 0x73, 0x20, 0x6e, 0x6f /* baserom.dol+0x3988b8 */
.byte 0x74, 0x20, 0x69, 0x6e, 0x69, 0x74, 0x65, 0x64, 0x0a, 0x00 /* baserom.dol+0x3988c8 */
.byte 0x00, 0x00 /* baserom.dol+0x3988d2 */

/* 8039B8D4 001F .rodata    osdsp__LIT_88                  @88                            */
.global osdsp__LIT_88
osdsp__LIT_88:
.byte 0x41, 0x6c, 0x72, 0x65, 0x61, 0x64, 0x79, 0x20, 0x69, 0x6e, 0x69, 0x74, 0x65, 0x64, 0x20, 0x70 /* baserom.dol+0x3988d4 */
.byte 0x72, 0x69, 0x6f, 0x72, 0x20, 0x44, 0x53, 0x50, 0x20, 0x74, 0x61, 0x73, 0x6b, 0x0a, 0x00 /* baserom.dol+0x3988e4 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3988f3 */

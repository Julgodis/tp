...
lbl_80297A78:
/* 80297A78 002949B8  88 0D 8C E2 */	lbz r0, data_80451262-_SDA_BASE_(r13)
/* 80297A7C 002949BC  7C 00 07 75 */	extsb. r0, r0
/* 80297A80 002949C0  40 82 00 34 */	bne lbl_80297AB4
/* 80297A84 002949C4  3C 60 80 43 */	lis r3, data_80431B34@ha
/* 80297A88 002949C8  38 63 1B 34 */	addi r3, r3, data_80431B34@l
/* 80297A8C 002949CC  4B FF 8D BD */	bl __ct__17JASGenericMemPoolFv
/* 80297A90 002949D0  3C 60 80 43 */	lis r3, data_80431B34@ha
/* 80297A94 002949D4  38 63 1B 34 */	addi r3, r3, data_80431B34@l
...
/* 80297AB0 002949F0  98 0D 8C E2 */	stb r0, data_80451262-_SDA_BASE_(r13)
lbl_80297AB4:
/* 80297AB4 002949F4  48 0A 5C 41 */	bl OSDisableInterrupts
/* 80297AB8 002949F8  90 61 00 08 */	stw r3, 8(r1)
/* 80297ABC 002949FC  3C 60 80 43 */	lis r3, data_80431B34@ha
/* 80297AC0 00294A00  38 63 1B 34 */	addi r3, r3, data_80431B34@l
...
/* 80297C6C 00294BAC  88 0D 8C E2 */	lbz r0, data_80451262-_SDA_BASE_(r13)
/* 80297C70 00294BB0  7C 00 07 75 */	extsb. r0, r0
/* 80297C74 00294BB4  40 82 00 34 */	bne lbl_80297CA8
/* 80297C78 00294BB8  3C 60 80 43 */	lis r3, data_80431B34@ha
/* 80297C7C 00294BBC  38 63 1B 34 */	addi r3, r3, data_80431B34@l
/* 80297C80 00294BC0  4B FF 8B C9 */	bl __ct__17JASGenericMemPoolFv
/* 80297C84 00294BC4  3C 60 80 43 */	lis r3, data_80431B34@ha
/* 80297C88 00294BC8  38 63 1B 34 */	addi r3, r3, data_80431B34@l
...
/* 80297CA4 00294BE4  98 0D 8C E2 */	stb r0, data_80451262-_SDA_BASE_(r13)
lbl_80297CA8:
/* 80297CA8 00294BE8  48 0A 5A 4D */	bl OSDisableInterrupts
/* 80297CAC 00294BEC  90 61 00 08 */	stw r3, 8(r1)
/* 80297CB0 00294BF0  3C 60 80 43 */	lis r3, data_80431B34@ha
/* 80297CB4 00294BF4  38 63 1B 34 */	addi r3, r3, data_80431B34@l
...
/* 80297D38 00294C78  3C A0 80 3A */	lis r5, data_8039B19C@ha
/* 80297D3C 00294C7C  38 A5 B1 9C */	addi r5, r5, data_8039B19C@l
...
/* ###################################################################################### */
.section .rodata, "a"
/* 8039B190 000C .rodata    OSC_RELEASE_TABLE$260          data_8039B190                  */
.global data_8039B190
data_8039B190:
.byte 0x00, 0x01, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398190 */

/* 8039B19C 0018 .rodata    OSC_ENV$261                    data_8039B19C                  */
.global data_8039B19C
data_8039B19C:
...
/* ###################################################################################### */
.section .bss, "aw"
/* 80431B48 000C .bss       @156                           JASBank__LIT_156               */
...
/* ###################################################################################### */
.section .sdata2, "a"
/* 80455630 0004 .sdata2    @248                           LIT_248                        */
.global LIT_248
LIT_248:
.byte 0x3f, 0x80, 0x00, 0x00 /* baserom.dol+0x3d4490 */

/* 80455634 0004 .sdata2    @249                           LIT_249                        */
.global LIT_249
LIT_249:
.byte 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3d4494 */

/* 80455638 0004 .sdata2    @250                           LIT_250                        */
.global LIT_250
LIT_250:
.byte 0x3f, 0x00, 0x00, 0x00 /* baserom.dol+0x3d4498 */

/* 8045563C 0004 .sdata2    @290                           JASBank__LIT_290               */

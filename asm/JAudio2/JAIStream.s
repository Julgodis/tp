...
/* 802A3104 0098 .text      __ct__9JAIStreamFP12JAIStreamMgrP31JAISoundStrategyMgr<9JAIStream> "__ct__9JAIStreamFP12JAIStreamMgrP31JAISoundStrategyMgr<9JAIStream>" */
.global "__ct__9JAIStreamFP12JAIStreamMgrP31JAISoundStrategyMgr<9JAIStream>"
...
/* 802A319C 0094 .text      JAIStreamMgr_startID___9JAIStreamF10JAISoundIDlPCQ29JGeometry8TVec3<f>P11JAIAudiencei "JAIStreamMgr_startID___9JAIStreamF10JAISoundIDlPCQ29JGeometry8TVec3<f>P11JAIAudiencei" */
.global "JAIStreamMgr_startID___9JAIStreamF10JAISoundIDlPCQ29JGeometry8TVec3<f>P11JAIAudiencei"
...
/* 802A3754 002A0694  88 0D 8D 98 */	lbz r0, data_80451318-_SDA_BASE_(r13)
/* 802A3758 002A0698  7C 00 07 75 */	extsb. r0, r0
/* 802A375C 002A069C  40 82 00 34 */	bne lbl_802A3790
/* 802A3760 002A06A0  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3764 002A06A4  38 63 40 B0 */	addi r3, r3, data_804340B0@l
/* 802A3768 002A06A8  4B FE D0 E1 */	bl __ct__17JASGenericMemPoolFv
/* 802A376C 002A06AC  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3770 002A06B0  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
/* 802A378C 002A06CC  98 0D 8D 98 */	stb r0, data_80451318-_SDA_BASE_(r13)
lbl_802A3790:
/* 802A3790 002A06D0  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3794 002A06D4  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
/* 802A3978 002A08B8  88 0D 8D 98 */	lbz r0, data_80451318-_SDA_BASE_(r13)
/* 802A397C 002A08BC  7C 00 07 75 */	extsb. r0, r0
/* 802A3980 002A08C0  40 82 00 34 */	bne lbl_802A39B4
/* 802A3984 002A08C4  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3988 002A08C8  38 63 40 B0 */	addi r3, r3, data_804340B0@l
/* 802A398C 002A08CC  4B FE CE BD */	bl __ct__17JASGenericMemPoolFv
/* 802A3990 002A08D0  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3994 002A08D4  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
/* 802A39B0 002A08F0  98 0D 8D 98 */	stb r0, data_80451318-_SDA_BASE_(r13)
lbl_802A39B4:
/* 802A39B4 002A08F4  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A39B8 002A08F8  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
/* 802A3A4C 002A098C  88 0D 8D 98 */	lbz r0, data_80451318-_SDA_BASE_(r13)
/* 802A3A50 002A0990  7C 00 07 75 */	extsb. r0, r0
/* 802A3A54 002A0994  40 82 00 34 */	bne lbl_802A3A88
/* 802A3A58 002A0998  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3A5C 002A099C  38 63 40 B0 */	addi r3, r3, data_804340B0@l
/* 802A3A60 002A09A0  4B FE CD E9 */	bl __ct__17JASGenericMemPoolFv
/* 802A3A64 002A09A4  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3A68 002A09A8  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
/* 802A3A84 002A09C4  98 0D 8D 98 */	stb r0, data_80451318-_SDA_BASE_(r13)
lbl_802A3A88:
/* 802A3A88 002A09C8  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A3A8C 002A09CC  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
.4byte 0x00000000
.4byte 0x00000000
.4byte getNumChild__9JAIStreamCFv
.4byte getChild__9JAIStreamFi
.4byte releaseChild__9JAIStreamFi
.4byte asSe__8JAISoundFv
.4byte asSeq__8JAISoundFv
.4byte asStream__9JAIStreamFv
.4byte getTrack__9JAIStreamFv
.4byte getChildTrack__9JAIStreamFi
.4byte getTempoMgr__9JAIStreamFv
.4byte JAISound_tryDie___9JAIStreamFv

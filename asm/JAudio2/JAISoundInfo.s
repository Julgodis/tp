...
/* ###################################################################################### */
.section .text, "ax"
/* 802A2D34 000C .text      __ct__12JAISoundInfoFb         __ct__12JAISoundInfoFb         */
.global __ct__12JAISoundInfoFb
__ct__12JAISoundInfoFb:
/* 802A2D34 0029FC74  54 80 06 3F */	clrlwi. r0, r4, 0x18
/* 802A2D38 0029FC78  41 82 00 08 */	beq func_802A2D40
/* 802A2D3C 0029FC7C  90 6D 85 DC */	stw r3, sInstance__33JASGlobalInstance_SUB_012JAISoundInfo_SUB_1-_SDA_BASE_(r13)

/* 802A2D40 0010 .text      func_802A2D40                  func_802A2D40                  */
.global func_802A2D40
func_802A2D40:
...
/* 802A2D50 003C .text      __dt__12JAISoundInfoFv         __dt__12JAISoundInfoFv         */
...
/* 802A2D64 0029FCA4  41 82 00 38 */	beq func_802A2D9C
...
/* 802A2D74 0029FCB4  41 82 00 18 */	beq func_802A2D8C
/* 802A2D78 0029FCB8  80 0D 85 DC */	lwz r0, sInstance__33JASGlobalInstance_SUB_012JAISoundInfo_SUB_1-_SDA_BASE_(r13)
/* 802A2D7C 0029FCBC  7C 00 F8 40 */	cmplw r0, r31
/* 802A2D80 0029FCC0  40 82 00 0C */	bne func_802A2D8C
/* 802A2D84 0029FCC4  38 00 00 00 */	li r0, 0
/* 802A2D88 0029FCC8  90 0D 85 DC */	stw r0, sInstance__33JASGlobalInstance_SUB_012JAISoundInfo_SUB_1-_SDA_BASE_(r13)

/* 802A2D8C 0010 .text      func_802A2D8C                  func_802A2D8C                  */
.global func_802A2D8C
func_802A2D8C:
/* 802A2D8C 0029FCCC  7C 80 07 35 */	extsh. r0, r4
/* 802A2D90 0029FCD0  40 81 00 0C */	ble func_802A2D9C
/* 802A2D94 0029FCD4  7F E3 FB 78 */	mr r3, r31
/* 802A2D98 0029FCD8  48 02 BF A5 */	bl __dl__FPv

/* 802A2D9C 0018 .text      func_802A2D9C                  func_802A2D9C                  */
.global func_802A2D9C
func_802A2D9C:

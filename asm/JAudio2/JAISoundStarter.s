...
/* ###################################################################################### */
.section .text, "ax"
/* 802A2F6C 000C .text      __ct__15JAISoundStarterFb      __ct__15JAISoundStarterFb      */
.global __ct__15JAISoundStarterFb
__ct__15JAISoundStarterFb:
/* 802A2F6C 0029FEAC  54 80 06 3F */	clrlwi. r0, r4, 0x18
/* 802A2F70 0029FEB0  41 82 00 08 */	beq func_802A2F78
/* 802A2F74 0029FEB4  90 6D 85 F8 */	stw r3, sInstance__36JASGlobalInstance_SUB_015JAISoundStarter_SUB_1-_SDA_BASE_(r13)

/* 802A2F78 0010 .text      func_802A2F78                  func_802A2F78                  */
.global func_802A2F78
func_802A2F78:
...
/* 802A2F88 003C .text      __dt__15JAISoundStarterFv      __dt__15JAISoundStarterFv      */
...
/* 802A2F9C 0029FEDC  41 82 00 38 */	beq func_802A2FD4
...
/* 802A2FAC 0029FEEC  41 82 00 18 */	beq func_802A2FC4
/* 802A2FB0 0029FEF0  80 0D 85 F8 */	lwz r0, sInstance__36JASGlobalInstance_SUB_015JAISoundStarter_SUB_1-_SDA_BASE_(r13)
/* 802A2FB4 0029FEF4  7C 00 F8 40 */	cmplw r0, r31
/* 802A2FB8 0029FEF8  40 82 00 0C */	bne func_802A2FC4
/* 802A2FBC 0029FEFC  38 00 00 00 */	li r0, 0
/* 802A2FC0 0029FF00  90 0D 85 F8 */	stw r0, sInstance__36JASGlobalInstance_SUB_015JAISoundStarter_SUB_1-_SDA_BASE_(r13)

/* 802A2FC4 0010 .text      func_802A2FC4                  func_802A2FC4                  */
.global func_802A2FC4
func_802A2FC4:
/* 802A2FC4 0029FF04  7C 80 07 35 */	extsh. r0, r4
/* 802A2FC8 0029FF08  40 81 00 0C */	ble func_802A2FD4
/* 802A2FCC 0029FF0C  7F E3 FB 78 */	mr r3, r31
/* 802A2FD0 0029FF10  48 02 BD 6D */	bl __dl__FPv

/* 802A2FD4 0018 .text      func_802A2FD4                  func_802A2FD4                  */
.global func_802A2FD4
func_802A2FD4:
...
/* 802A2FEC 0048 .text      "startLevelSound__15JAISoundStarterF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f>" startLevelSound__15JAISoundStarterF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f> */
.global startLevelSound__15JAISoundStarterF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3_SUB_0f_SUB_1
startLevelSound__15JAISoundStarterF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3_SUB_0f_SUB_1:
...
/* 802A3008 0029FF48  41 82 00 64 */	beq func_802A306C
...
/* 802A301C 0029FF5C  40 82 00 50 */	bne func_802A306C
/* 802A3020 0029FF60  80 07 00 10 */	lwz r0, 0x10(r7)
/* 802A3024 0029FF64  28 00 00 01 */	cmplwi r0, 1
/* 802A3028 0029FF68  40 80 00 0C */	bge func_802A3034
/* 802A302C 0029FF6C  38 00 00 01 */	li r0, 1
/* 802A3030 0029FF70  90 07 00 10 */	stw r0, 0x10(r7)

/* 802A3034 0030 .text      func_802A3034                  func_802A3034                  */
.global func_802A3034
func_802A3034:
/* 802A3034 0029FF74  28 06 00 00 */	cmplwi r6, 0
/* 802A3038 0029FF78  41 82 00 2C */	beq func_802A3064
...
/* 802A3048 0029FF88  41 82 00 1C */	beq func_802A3064
...
/* 802A3064 0008 .text      func_802A3064                  func_802A3064                  */
.global func_802A3064
func_802A3064:
/* 802A3064 0029FFA4  38 60 00 01 */	li r3, 1
/* 802A3068 0029FFA8  48 00 00 58 */	b func_802A30C0

/* 802A306C 0054 .text      func_802A306C                  func_802A306C                  */
.global func_802A306C
func_802A306C:
...
/* 802A3090 0029FFD0  41 82 00 30 */	beq func_802A30C0
/* 802A3094 0029FFD4  80 BF 00 00 */	lwz r5, 0(r31)
/* 802A3098 0029FFD8  28 05 00 00 */	cmplwi r5, 0
/* 802A309C 0029FFDC  41 82 00 24 */	beq func_802A30C0
...
/* 802A30C0 0014 .text      func_802A30C0                  func_802A30C0                  */
.global func_802A30C0
func_802A30C0:

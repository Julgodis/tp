...
/* 802A4BA8 002A1AE8  88 0D 8C B1 */	lbz r0, data_80451231-_SDA_BASE_(r13)
/* 802A4BAC 002A1AEC  7C 00 07 75 */	extsb. r0, r0
/* 802A4BB0 002A1AF0  40 82 00 34 */	bne lbl_802A4BE4
/* 802A4BB4 002A1AF4  3C 60 80 43 */	lis r3, data_80431B04@ha
/* 802A4BB8 002A1AF8  38 63 1B 04 */	addi r3, r3, data_80431B04@l
/* 802A4BBC 002A1AFC  4B FE BC 8D */	bl __ct__17JASGenericMemPoolFv
/* 802A4BC0 002A1B00  3C 60 80 43 */	lis r3, data_80431B04@ha
/* 802A4BC4 002A1B04  38 63 1B 04 */	addi r3, r3, data_80431B04@l
...
/* 802A4BE0 002A1B20  98 0D 8C B1 */	stb r0, data_80451231-_SDA_BASE_(r13)
lbl_802A4BE4:
/* 802A4BE4 002A1B24  48 09 8B 11 */	bl OSDisableInterrupts
/* 802A4BE8 002A1B28  90 61 00 0C */	stw r3, 0xc(r1)
/* 802A4BEC 002A1B2C  3C 60 80 43 */	lis r3, data_80431B04@ha
/* 802A4BF0 002A1B30  38 63 1B 04 */	addi r3, r3, data_80431B04@l
...
/* 802A4C14 002A1B54  88 0D 8C B0 */	lbz r0, data_80451230-_SDA_BASE_(r13)
/* 802A4C18 002A1B58  7C 00 07 75 */	extsb. r0, r0
/* 802A4C1C 002A1B5C  40 82 00 34 */	bne lbl_802A4C50
/* 802A4C20 002A1B60  3C 60 80 43 */	lis r3, data_80431AF4@ha
/* 802A4C24 002A1B64  38 63 1A F4 */	addi r3, r3, data_80431AF4@l
/* 802A4C28 002A1B68  4B FE BC 21 */	bl __ct__17JASGenericMemPoolFv
/* 802A4C2C 002A1B6C  3C 60 80 43 */	lis r3, data_80431AF4@ha
/* 802A4C30 002A1B70  38 63 1A F4 */	addi r3, r3, data_80431AF4@l
...
/* 802A4C4C 002A1B8C  98 0D 8C B0 */	stb r0, data_80451230-_SDA_BASE_(r13)
lbl_802A4C50:
/* 802A4C50 002A1B90  48 09 8A A5 */	bl OSDisableInterrupts
/* 802A4C54 002A1B94  90 61 00 08 */	stw r3, 8(r1)
/* 802A4C58 002A1B98  3C 60 80 43 */	lis r3, data_80431AF4@ha
/* 802A4C5C 002A1B9C  38 63 1A F4 */	addi r3, r3, data_80431AF4@l
...
/* 802A4D8C 002A1CCC  88 0D 8D A8 */	lbz r0, data_80451328-_SDA_BASE_(r13)
/* 802A4D90 002A1CD0  7C 00 07 75 */	extsb. r0, r0
/* 802A4D94 002A1CD4  40 82 00 30 */	bne lbl_802A4DC4
/* 802A4D98 002A1CD8  3C 60 80 43 */	lis r3, data_804340FC@ha
/* 802A4D9C 002A1CDC  38 63 40 FC */	addi r3, r3, data_804340FC@l
/* 802A4DA0 002A1CE0  4B FE BA A9 */	bl __ct__17JASGenericMemPoolFv
/* 802A4DA4 002A1CE4  3C 60 80 43 */	lis r3, data_804340FC@ha
/* 802A4DA8 002A1CE8  38 63 40 FC */	addi r3, r3, data_804340FC@l
...
/* 802A4DC0 002A1D00  98 0D 8D A8 */	stb r0, data_80451328-_SDA_BASE_(r13)
lbl_802A4DC4:
/* 802A4DC4 002A1D04  3C 60 80 43 */	lis r3, data_804340FC@ha
/* 802A4DC8 002A1D08  38 63 40 FC */	addi r3, r3, data_804340FC@l
...
/* 802A4DDC 002A1D1C  88 0D 8D A0 */	lbz r0, data_80451320-_SDA_BASE_(r13)
/* 802A4DE0 002A1D20  7C 00 07 75 */	extsb. r0, r0
/* 802A4DE4 002A1D24  40 82 00 30 */	bne lbl_802A4E14
/* 802A4DE8 002A1D28  3C 60 80 43 */	lis r3, data_804340CC@ha
/* 802A4DEC 002A1D2C  38 63 40 CC */	addi r3, r3, data_804340CC@l
/* 802A4DF0 002A1D30  4B FE BA 59 */	bl __ct__17JASGenericMemPoolFv
/* 802A4DF4 002A1D34  3C 60 80 43 */	lis r3, data_804340CC@ha
/* 802A4DF8 002A1D38  38 63 40 CC */	addi r3, r3, data_804340CC@l
...
/* 802A4E10 002A1D50  98 0D 8D A0 */	stb r0, data_80451320-_SDA_BASE_(r13)
lbl_802A4E14:
/* 802A4E14 002A1D54  3C 60 80 43 */	lis r3, data_804340CC@ha
/* 802A4E18 002A1D58  38 63 40 CC */	addi r3, r3, data_804340CC@l
...
/* 802A4E2C 002A1D6C  88 0D 8D 90 */	lbz r0, data_80451310-_SDA_BASE_(r13)
/* 802A4E30 002A1D70  7C 00 07 75 */	extsb. r0, r0
/* 802A4E34 002A1D74  40 82 00 30 */	bne lbl_802A4E64
/* 802A4E38 002A1D78  3C 60 80 43 */	lis r3, data_80434084@ha
/* 802A4E3C 002A1D7C  38 63 40 84 */	addi r3, r3, data_80434084@l
/* 802A4E40 002A1D80  4B FE BA 09 */	bl __ct__17JASGenericMemPoolFv
/* 802A4E44 002A1D84  3C 60 80 43 */	lis r3, data_80434084@ha
/* 802A4E48 002A1D88  38 63 40 84 */	addi r3, r3, data_80434084@l
...
/* 802A4E60 002A1DA0  98 0D 8D 90 */	stb r0, data_80451310-_SDA_BASE_(r13)
lbl_802A4E64:
/* 802A4E64 002A1DA4  3C 60 80 43 */	lis r3, data_80434084@ha
/* 802A4E68 002A1DA8  38 63 40 84 */	addi r3, r3, data_80434084@l
...
/* 802A4E7C 002A1DBC  88 0D 8D 98 */	lbz r0, data_80451318-_SDA_BASE_(r13)
/* 802A4E80 002A1DC0  7C 00 07 75 */	extsb. r0, r0
/* 802A4E84 002A1DC4  40 82 00 30 */	bne lbl_802A4EB4
/* 802A4E88 002A1DC8  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A4E8C 002A1DCC  38 63 40 B0 */	addi r3, r3, data_804340B0@l
/* 802A4E90 002A1DD0  4B FE B9 B9 */	bl __ct__17JASGenericMemPoolFv
/* 802A4E94 002A1DD4  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A4E98 002A1DD8  38 63 40 B0 */	addi r3, r3, data_804340B0@l
...
/* 802A4EB0 002A1DF0  98 0D 8D 98 */	stb r0, data_80451318-_SDA_BASE_(r13)
lbl_802A4EB4:
/* 802A4EB4 002A1DF4  3C 60 80 43 */	lis r3, data_804340B0@ha
/* 802A4EB8 002A1DF8  38 63 40 B0 */	addi r3, r3, data_804340B0@l

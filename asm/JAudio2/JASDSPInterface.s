...
/* 8029DA10 0029A950  D0 2D 8D 70 */	stfs f1, sDSPVolume__6JASDsp-_SDA_BASE_(r13)
...
/* 8029DA78 0029A9B8  80 6D 8D 68 */	lwz r3, CH_BUF__6JASDsp-_SDA_BASE_(r13)
/* 8029DA7C 0029A9BC  38 80 60 00 */	li r4, 0x6000
/* 8029DA80 0029A9C0  48 09 DB 2D */	bl DCFlushRange
/* 8029DA84 0029A9C4  80 6D 8D 6C */	lwz r3, FX_BUF__6JASDsp-_SDA_BASE_(r13)
...
/* 8029DAAC 0029A9EC  80 6D 8D 68 */	lwz r3, CH_BUF__6JASDsp-_SDA_BASE_(r13)
...
/* 8029DADC 0029AA1C  80 8D 8C 90 */	lwz r4, JASDram-_SDA_BASE_(r13)
/* 8029DAE0 0029AA20  38 A0 00 20 */	li r5, 0x20
/* 8029DAE4 0029AA24  48 03 12 2D */	bl __nwa__FUlP7JKRHeapi
/* 8029DAE8 0029AA28  90 6D 8D 68 */	stw r3, CH_BUF__6JASDsp-_SDA_BASE_(r13)
/* 8029DAEC 0029AA2C  38 60 00 80 */	li r3, 0x80
/* 8029DAF0 0029AA30  80 8D 8C 90 */	lwz r4, JASDram-_SDA_BASE_(r13)
/* 8029DAF4 0029AA34  38 A0 00 20 */	li r5, 0x20
/* 8029DAF8 0029AA38  48 03 12 19 */	bl __nwa__FUlP7JKRHeapi
/* 8029DAFC 0029AA3C  90 6D 8D 6C */	stw r3, FX_BUF__6JASDsp-_SDA_BASE_(r13)
/* 8029DB00 0029AA40  80 6D 8D 68 */	lwz r3, CH_BUF__6JASDsp-_SDA_BASE_(r13)
/* 8029DB04 0029AA44  38 80 60 00 */	li r4, 0x6000
/* 8029DB08 0029AA48  4B FF 19 79 */	bl bzero__7JASCalcFPvUl
/* 8029DB0C 0029AA4C  80 6D 8D 6C */	lwz r3, FX_BUF__6JASDsp-_SDA_BASE_(r13)
...
/* 8029DB4C 0029AA8C  38 A5 B3 A0 */	addi r5, r5, DSPRES_FILTER__6JASDsp@l
/* 8029DB50 0029AA90  3C C0 80 3A */	lis r6, DSPADPCM_FILTER__6JASDsp@ha
/* 8029DB54 0029AA94  38 C6 B3 60 */	addi r6, r6, DSPADPCM_FILTER__6JASDsp@l
/* 8029DB58 0029AA98  80 ED 8D 6C */	lwz r7, FX_BUF__6JASDsp-_SDA_BASE_(r13)
...
/* 8029DB94 0029AAD4  80 8D 8D 6C */	lwz r4, FX_BUF__6JASDsp-_SDA_BASE_(r13)
...
/* 8029DBC8 0029AB08  3C 60 80 3C */	lis r3, SEND_TABLE__6JASDsp@ha
/* 8029DBCC 0029AB0C  38 63 78 F0 */	addi r3, r3, SEND_TABLE__6JASDsp@l
...
/* 8029E0D4 0029B014  80 8D 8D 68 */	lwz r4, CH_BUF__6JASDsp-_SDA_BASE_(r13)
...
.byte 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x04, 0x00, 0x04, 0x00 /* baserom.dol+0x398360 */
.byte 0x10, 0x00, 0xf8, 0x00, 0x0e, 0x00, 0xfa, 0x00, 0x0c, 0x00, 0xfc, 0x00, 0x12, 0x00, 0xf6, 0x00 /* baserom.dol+0x398370 */
.byte 0x10, 0x68, 0xf7, 0x38, 0x12, 0xc0, 0xf7, 0x04, 0x14, 0x00, 0xf4, 0x00, 0x08, 0x00, 0xf8, 0x00 /* baserom.dol+0x398380 */
.byte 0x04, 0x00, 0xfc, 0x00, 0xfc, 0x00, 0x04, 0x00, 0xfc, 0x00, 0x00, 0x00, 0xf8, 0x00, 0x00, 0x00 /* baserom.dol+0x398390 */

/* 8039B3A0 0500 .rodata DSPRES_FILTER__6JASDsp DSPRES_FILTER__6JASDsp */
.global DSPRES_FILTER__6JASDsp
DSPRES_FILTER__6JASDsp:
.byte 0x0c, 0x39, 0x66, 0xad, 0x0d, 0x46, 0xff, 0xdf, 0x0b, 0x39, 0x66, 0x96, 0x0e, 0x5f, 0xff, 0xd8 /* baserom.dol+0x3983a0 */
.byte 0x0a, 0x44, 0x66, 0x69, 0x0f, 0x83, 0xff, 0xd0, 0x09, 0x5a, 0x66, 0x26, 0x10, 0xb4, 0xff, 0xc8 /* baserom.dol+0x3983b0 */
.byte 0x08, 0x7d, 0x65, 0xcd, 0x11, 0xf0, 0xff, 0xbf, 0x07, 0xab, 0x65, 0x5e, 0x13, 0x38, 0xff, 0xb6 /* baserom.dol+0x3983c0 */
.byte 0x06, 0xe4, 0x64, 0xd9, 0x14, 0x8c, 0xff, 0xac, 0x06, 0x28, 0x64, 0x3f, 0x15, 0xeb, 0xff, 0xa1 /* baserom.dol+0x3983d0 */
.byte 0x05, 0x77, 0x63, 0x8f, 0x17, 0x56, 0xff, 0x96, 0x04, 0xd1, 0x62, 0xcb, 0x18, 0xcb, 0xff, 0x8a /* baserom.dol+0x3983e0 */
.byte 0x04, 0x35, 0x61, 0xf3, 0x1a, 0x4c, 0xff, 0x7e, 0x03, 0xa4, 0x61, 0x06, 0x1b, 0xd7, 0xff, 0x71 /* baserom.dol+0x3983f0 */
.byte 0x03, 0x1c, 0x60, 0x07, 0x1d, 0x6c, 0xff, 0x64, 0x02, 0x9f, 0x5e, 0xf5, 0x1f, 0x0b, 0xff, 0x56 /* baserom.dol+0x398400 */
.byte 0x02, 0x2a, 0x5d, 0xd0, 0x20, 0xb3, 0xff, 0x48, 0x01, 0xbe, 0x5c, 0x9a, 0x22, 0x64, 0xff, 0x3a /* baserom.dol+0x398410 */
.byte 0x01, 0x5b, 0x5b, 0x53, 0x24, 0x1e, 0xff, 0x2c, 0x01, 0x01, 0x59, 0xfc, 0x25, 0xe0, 0xff, 0x1e /* baserom.dol+0x398420 */
.byte 0x00, 0xae, 0x58, 0x96, 0x27, 0xa9, 0xff, 0x10, 0x00, 0x63, 0x57, 0x20, 0x29, 0x7a, 0xff, 0x02 /* baserom.dol+0x398430 */
.byte 0x00, 0x1f, 0x55, 0x9d, 0x2b, 0x50, 0xfe, 0xf4, 0xff, 0xe2, 0x54, 0x0d, 0x2d, 0x2c, 0xfe, 0xe8 /* baserom.dol+0x398440 */
.byte 0xff, 0xac, 0x52, 0x70, 0x2f, 0x0d, 0xfe, 0xdb, 0xff, 0x7c, 0x50, 0xc7, 0x30, 0xf3, 0xfe, 0xd0 /* baserom.dol+0x398450 */
.byte 0xff, 0x53, 0x4f, 0x14, 0x32, 0xdc, 0xfe, 0xc6, 0xff, 0x2e, 0x4d, 0x57, 0x34, 0xc8, 0xfe, 0xbd /* baserom.dol+0x398460 */
.byte 0xff, 0x0f, 0x4b, 0x91, 0x36, 0xb6, 0xfe, 0xb6, 0xfe, 0xf5, 0x49, 0xc2, 0x38, 0xa5, 0xfe, 0xb0 /* baserom.dol+0x398470 */
.byte 0xfe, 0xdf, 0x47, 0xed, 0x3a, 0x95, 0xfe, 0xac, 0xfe, 0xce, 0x46, 0x11, 0x3c, 0x85, 0xfe, 0xab /* baserom.dol+0x398480 */
.byte 0xfe, 0xc0, 0x44, 0x30, 0x3e, 0x74, 0xfe, 0xac, 0xfe, 0xb6, 0x42, 0x4a, 0x40, 0x60, 0xfe, 0xaf /* baserom.dol+0x398490 */
.byte 0xfe, 0xaf, 0x40, 0x60, 0x42, 0x4a, 0xfe, 0xb6, 0xfe, 0xac, 0x3e, 0x74, 0x44, 0x30, 0xfe, 0xc0 /* baserom.dol+0x3984a0 */
.byte 0xfe, 0xab, 0x3c, 0x85, 0x46, 0x11, 0xfe, 0xce, 0xfe, 0xac, 0x3a, 0x95, 0x47, 0xed, 0xfe, 0xdf /* baserom.dol+0x3984b0 */
.byte 0xfe, 0xb0, 0x38, 0xa5, 0x49, 0xc2, 0xfe, 0xf5, 0xfe, 0xb6, 0x36, 0xb6, 0x4b, 0x91, 0xff, 0x0f /* baserom.dol+0x3984c0 */
.byte 0xfe, 0xbd, 0x34, 0xc8, 0x4d, 0x57, 0xff, 0x2e, 0xfe, 0xc6, 0x32, 0xdc, 0x4f, 0x14, 0xff, 0x53 /* baserom.dol+0x3984d0 */
.byte 0xfe, 0xd0, 0x30, 0xf3, 0x50, 0xc7, 0xff, 0x7c, 0xfe, 0xdb, 0x2f, 0x0d, 0x52, 0x70, 0xff, 0xac /* baserom.dol+0x3984e0 */
.byte 0xfe, 0xe8, 0x2d, 0x2c, 0x54, 0x0d, 0xff, 0xe2, 0xfe, 0xf4, 0x2b, 0x50, 0x55, 0x9d, 0x00, 0x1f /* baserom.dol+0x3984f0 */
.byte 0xff, 0x02, 0x29, 0x7a, 0x57, 0x20, 0x00, 0x63, 0xff, 0x10, 0x27, 0xa9, 0x58, 0x96, 0x00, 0xae /* baserom.dol+0x398500 */
.byte 0xff, 0x1e, 0x25, 0xe0, 0x59, 0xfc, 0x01, 0x01, 0xff, 0x2c, 0x24, 0x1e, 0x5b, 0x53, 0x01, 0x5b /* baserom.dol+0x398510 */
.byte 0xff, 0x3a, 0x22, 0x64, 0x5c, 0x9a, 0x01, 0xbe, 0xff, 0x48, 0x20, 0xb3, 0x5d, 0xd0, 0x02, 0x2a /* baserom.dol+0x398520 */
.byte 0xff, 0x56, 0x1f, 0x0b, 0x5e, 0xf5, 0x02, 0x9f, 0xff, 0x64, 0x1d, 0x6c, 0x60, 0x07, 0x03, 0x1c /* baserom.dol+0x398530 */
.byte 0xff, 0x71, 0x1b, 0xd7, 0x61, 0x06, 0x03, 0xa4, 0xff, 0x7e, 0x1a, 0x4c, 0x61, 0xf3, 0x04, 0x35 /* baserom.dol+0x398540 */
.byte 0xff, 0x8a, 0x18, 0xcb, 0x62, 0xcb, 0x04, 0xd1, 0xff, 0x96, 0x17, 0x56, 0x63, 0x8f, 0x05, 0x77 /* baserom.dol+0x398550 */
.byte 0xff, 0xa1, 0x15, 0xeb, 0x64, 0x3f, 0x06, 0x28, 0xff, 0xac, 0x14, 0x8c, 0x64, 0xd9, 0x06, 0xe4 /* baserom.dol+0x398560 */
.byte 0xff, 0xb6, 0x13, 0x38, 0x65, 0x5e, 0x07, 0xab, 0xff, 0xbf, 0x11, 0xf0, 0x65, 0xcd, 0x08, 0x7d /* baserom.dol+0x398570 */
.byte 0xff, 0xc8, 0x10, 0xb4, 0x66, 0x26, 0x09, 0x5a, 0xff, 0xd0, 0x0f, 0x83, 0x66, 0x69, 0x0a, 0x44 /* baserom.dol+0x398580 */
.byte 0xff, 0xd8, 0x0e, 0x5f, 0x66, 0x96, 0x0b, 0x39, 0xff, 0xdf, 0x0d, 0x46, 0x66, 0xad, 0x0c, 0x39 /* baserom.dol+0x398590 */
.byte 0x00, 0x00, 0x0c, 0x8b, 0x18, 0xf8, 0x25, 0x27, 0x30, 0xfb, 0x3c, 0x56, 0x47, 0x1c, 0x51, 0x33 /* baserom.dol+0x3985a0 */
.byte 0x5a, 0x82, 0x62, 0xf1, 0x6a, 0x6d, 0x70, 0xe2, 0x76, 0x41, 0x7a, 0x7c, 0x7d, 0x89, 0x7f, 0x61 /* baserom.dol+0x3985b0 */
.byte 0x7f, 0xff, 0x7f, 0x61, 0x7d, 0x89, 0x7a, 0x7c, 0x76, 0x41, 0x70, 0xe2, 0x6a, 0x6d, 0x62, 0xf1 /* baserom.dol+0x3985c0 */
.byte 0x5a, 0x82, 0x51, 0x33, 0x47, 0x1c, 0x3c, 0x56, 0x30, 0xfb, 0x25, 0x27, 0x18, 0xf8, 0x0c, 0x8b /* baserom.dol+0x3985d0 */
.byte 0x00, 0x00, 0xf3, 0x75, 0xe7, 0x08, 0xda, 0xd9, 0xcf, 0x05, 0xc3, 0xaa, 0xb8, 0xe4, 0xae, 0xcd /* baserom.dol+0x3985e0 */
.byte 0xa5, 0x7e, 0x9d, 0x0f, 0x95, 0x93, 0x8f, 0x1e, 0x89, 0xbf, 0x85, 0x84, 0x82, 0x77, 0x80, 0x9f /* baserom.dol+0x3985f0 */
.byte 0x80, 0x01, 0x80, 0x9f, 0x82, 0x77, 0x85, 0x84, 0x89, 0xbf, 0x8f, 0x1e, 0x95, 0x93, 0x9d, 0x0f /* baserom.dol+0x398600 */
.byte 0xa5, 0x7e, 0xae, 0xcd, 0xb8, 0xe4, 0xc3, 0xaa, 0xcf, 0x05, 0xda, 0xd9, 0xe7, 0x08, 0xf3, 0x75 /* baserom.dol+0x398610 */
.byte 0x00, 0x00, 0x07, 0xff, 0x0f, 0xff, 0x17, 0xff, 0x1f, 0xff, 0x27, 0xff, 0x2f, 0xff, 0x37, 0xff /* baserom.dol+0x398620 */
.byte 0x3f, 0xff, 0x47, 0xff, 0x4f, 0xff, 0x57, 0xff, 0x5f, 0xff, 0x67, 0xff, 0x6f, 0xff, 0x77, 0xff /* baserom.dol+0x398630 */
.byte 0x7f, 0xff, 0x78, 0x00, 0x70, 0x00, 0x68, 0x00, 0x60, 0x00, 0x58, 0x00, 0x50, 0x00, 0x48, 0x00 /* baserom.dol+0x398640 */
.byte 0x40, 0x00, 0x38, 0x00, 0x30, 0x00, 0x28, 0x00, 0x20, 0x00, 0x18, 0x00, 0x10, 0x00, 0x08, 0x00 /* baserom.dol+0x398650 */
.byte 0x00, 0x00, 0xf8, 0x01, 0xf0, 0x01, 0xe8, 0x01, 0xe0, 0x01, 0xd8, 0x01, 0xd0, 0x01, 0xc8, 0x01 /* baserom.dol+0x398660 */
.byte 0xc0, 0x01, 0xb8, 0x01, 0xb0, 0x01, 0xa8, 0x01, 0xa0, 0x01, 0x98, 0x01, 0x90, 0x01, 0x88, 0x01 /* baserom.dol+0x398670 */
.byte 0x80, 0x01, 0x88, 0x00, 0x90, 0x00, 0x98, 0x00, 0xa0, 0x00, 0xa8, 0x00, 0xb0, 0x00, 0xb8, 0x00 /* baserom.dol+0x398680 */
.byte 0xc0, 0x00, 0xc8, 0x00, 0xd0, 0x00, 0xd8, 0x00, 0xe0, 0x00, 0xe8, 0x00, 0xf0, 0x00, 0xf8, 0x00 /* baserom.dol+0x398690 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3986a0 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3986b0 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3986c0 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3986d0 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3986e0 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3986f0 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398700 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1f, 0xff, 0x3f, 0xff /* baserom.dol+0x398710 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398720 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398730 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398740 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398750 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398760 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398770 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x398780 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xc0, 0x01 /* baserom.dol+0x398790 */
.byte 0x00, 0x00, 0x01, 0x92, 0x03, 0x24, 0x04, 0xb6, 0x06, 0x47, 0x07, 0xd9, 0x09, 0x6a, 0x0a, 0xfb /* baserom.dol+0x3987a0 */
.byte 0x0c, 0x8b, 0x0e, 0x1b, 0x0f, 0xab, 0x11, 0x39, 0x12, 0xc7, 0x14, 0x55, 0x15, 0xe1, 0x17, 0x6d /* baserom.dol+0x3987b0 */
.byte 0x18, 0xf8, 0x1a, 0x82, 0x1c, 0x0b, 0x1d, 0x93, 0x1f, 0x19, 0x20, 0x9f, 0x22, 0x23, 0x23, 0xa6 /* baserom.dol+0x3987c0 */
.byte 0x25, 0x27, 0x26, 0xa7, 0x28, 0x26, 0x29, 0xa3, 0x2b, 0x1f, 0x2c, 0x98, 0x2e, 0x10, 0x2f, 0x87 /* baserom.dol+0x3987d0 */
.byte 0x30, 0xfb, 0x32, 0x6e, 0x33, 0xde, 0x35, 0x4d, 0x36, 0xb9, 0x38, 0x24, 0x39, 0x8c, 0x3a, 0xf2 /* baserom.dol+0x3987e0 */
.byte 0x3c, 0x56, 0x3d, 0xb7, 0x3f, 0x17, 0x40, 0x73, 0x41, 0xcd, 0x43, 0x25, 0x44, 0x7a, 0x45, 0xcc /* baserom.dol+0x3987f0 */
.byte 0x47, 0x1c, 0x48, 0x69, 0x49, 0xb3, 0x4a, 0xfb, 0x4c, 0x3f, 0x4d, 0x81, 0x4e, 0xbf, 0x4f, 0xfb /* baserom.dol+0x398800 */
.byte 0x51, 0x33, 0x52, 0x68, 0x53, 0x9a, 0x54, 0xc9, 0x55, 0xf5, 0x57, 0x1d, 0x58, 0x42, 0x59, 0x64 /* baserom.dol+0x398810 */
.byte 0x5a, 0x82, 0x5b, 0x9c, 0x5c, 0xb3, 0x5d, 0xc7, 0x5e, 0xd7, 0x5f, 0xe3, 0x60, 0xeb, 0x61, 0xf0 /* baserom.dol+0x398820 */
.byte 0x62, 0xf1, 0x63, 0xee, 0x64, 0xe8, 0x65, 0xdd, 0x66, 0xcf, 0x67, 0xbc, 0x68, 0xa6, 0x69, 0x8b /* baserom.dol+0x398830 */
.byte 0x6a, 0x6d, 0x6b, 0x4a, 0x6c, 0x23, 0x6c, 0xf8, 0x6d, 0xc9, 0x6e, 0x96, 0x6f, 0x5e, 0x70, 0x22 /* baserom.dol+0x398840 */
.byte 0x70, 0xe2, 0x71, 0x9d, 0x72, 0x54, 0x73, 0x07, 0x73, 0xb5, 0x74, 0x5f, 0x75, 0x04, 0x75, 0xa5 /* baserom.dol+0x398850 */
.byte 0x76, 0x41, 0x76, 0xd8, 0x77, 0x6b, 0x77, 0xfa, 0x78, 0x84, 0x79, 0x09, 0x79, 0x89, 0x7a, 0x05 /* baserom.dol+0x398860 */
.byte 0x7a, 0x7c, 0x7a, 0xee, 0x7b, 0x5c, 0x7b, 0xc5, 0x7c, 0x29, 0x7c, 0x88, 0x7c, 0xe3, 0x7d, 0x39 /* baserom.dol+0x398870 */
...
/* 8039B8A0 0018 .rodata lbl_8039B8A0 connect_table$463 */
.global lbl_8039B8A0
lbl_8039B8A0:
...
/* 804512F4 0001 .sbss lbl_804512F4 lbl_804512F4 */
.global lbl_804512F4
lbl_804512F4:
.skip 0x1

/* 804512F5 0003 .sbss lbl_804512F5 lbl_804512F5 */
.global lbl_804512F5
lbl_804512F5:
.skip 0x3
...
.section .sdata2, "a"
/* 80455748 0004 .sdata2 lbl_80455748 @176 */
.global lbl_80455748
lbl_80455748:
.byte 0x40, 0x80, 0x00, 0x00 /* baserom.dol+0x3d45a8 */

/* 8045574C 0008 .sdata2 lbl_8045574C COMP_BLOCKSAMPLES$331 */
.global lbl_8045574C
lbl_8045574C:
.byte 0x10, 0x10, 0x01, 0x01, 0x01, 0x10, 0x10, 0x01 /* baserom.dol+0x3d45ac */

/* 80455754 0008 .sdata2 lbl_80455754 COMP_BLOCKBYTES$332 */
.global lbl_80455754
lbl_80455754:

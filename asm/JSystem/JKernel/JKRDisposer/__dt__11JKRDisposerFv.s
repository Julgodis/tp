...
/* 802D1500  41 82 00 4C */	beq lbl_802D154C                         /* constant-address: 802D154C, symbol: lbl_802D154C */
/* 802D1504  3C 60 80 3D */	lis r3, __vt__11JKRDisposer@ha          
/* 802D1508  38 03 C0 F0 */	addi r0, r3, __vt__11JKRDisposer@l       /* constant-address: 803CC0F0, symbol: __vt__11JKRDisposer */
/* 802D150C  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802D1510  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 802D1514  28 03 00 00 */	cmplwi r3, 0                            
/* 802D1518  41 82 00 10 */	beq lbl_802D1528                         /* constant-address: 802D1528, symbol: lbl_802D1528 */
/* 802D151C  38 63 00 5C */	addi r3, r3, 0x5c                       
/* 802D1520  38 9E 00 08 */	addi r4, r30, 8                         
/* 802D1524  48 00 AC 39 */	bl remove__10JSUPtrListFP10JSUPtrLink    /* constant-address: 802DC15C, symbol: remove__10JSUPtrListFP10JSUPtrLink */
lbl_802D1528:
/* 802D1528  34 1E 00 08 */	addic. r0, r30, 8                       
/* 802D152C  41 82 00 10 */	beq lbl_802D153C                         /* constant-address: 802D153C, symbol: lbl_802D153C */
/* 802D1530  38 7E 00 08 */	addi r3, r30, 8                         
/* 802D1534  38 80 00 00 */	li r4, 0                                
/* 802D1538  48 00 A8 DD */	bl __dt__10JSUPtrLinkFv                  /* constant-address: 802DBE14, symbol: __dt__10JSUPtrLinkFv */
lbl_802D153C:
/* 802D153C  7F E0 07 35 */	extsh. r0, r31                          
/* 802D1540  40 81 00 0C */	ble lbl_802D154C                         /* constant-address: 802D154C, symbol: lbl_802D154C */
/* 802D1544  7F C3 F3 78 */	mr r3, r30                              
/* 802D1548  4B FF D7 F5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802D154C:

...
/* 802D0C04  48 09 15 D9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802D0C18  41 82 00 7C */	beq lbl_802D0C94                         /* constant-address: 802D0C94, symbol: lbl_802D0C94 */
/* 802D0C1C  38 7D 00 18 */	addi r3, r29, 0x18                      
/* 802D0C20  48 06 E4 21 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
...
/* 802D0C4C  4B FF DA 39 */	bl resize__7JKRHeapFPvUl                 /* constant-address: 802CE684, symbol: resize__7JKRHeapFPvUl */
/* 802D0C50  2C 03 FF FF */	cmpwi r3, -1                            
/* 802D0C54  41 82 00 30 */	beq lbl_802D0C84                         /* constant-address: 802D0C84, symbol: lbl_802D0C84 */
...
/* 802D0C88  48 06 E4 95 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 802D0C8C  7F E3 FB 78 */	mr r3, r31                              
/* 802D0C90  48 00 00 08 */	b lbl_802D0C98                           /* constant-address: 802D0C98, symbol: lbl_802D0C98 */
lbl_802D0C94:
/* 802D0C94  38 60 FF FF */	li r3, -1                               
lbl_802D0C98:
/* 802D0C98  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802D0C9C  48 09 15 8D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

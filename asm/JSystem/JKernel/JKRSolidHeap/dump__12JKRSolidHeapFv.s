...
/* 802D110C  48 09 10 D1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802D112C  48 06 DF 15 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
...
/* 802D1150  38 63 CE 50 */	addi r3, r3, JKRSolidHeap__stringBase0@l /* constant-address: 8039CE50, symbol: JKRSolidHeap__stringBase0 */
/* 802D1154  38 63 01 17 */	addi r3, r3, 0x117                       /* constant-address: 8039CF67, symbol: None */
/* 802D1158  4C C6 31 82 */	crclr 6                                 
/* 802D115C  48 01 74 6D */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 802D1160  80 9E 00 74 */	lwz r4, 0x74(r30)                       
/* 802D1164  3C 60 80 3A */	lis r3, JKRSolidHeap__stringBase0@ha    
/* 802D1168  38 63 CE 50 */	addi r3, r3, JKRSolidHeap__stringBase0@l /* constant-address: 8039CE50, symbol: JKRSolidHeap__stringBase0 */
/* 802D116C  38 63 01 28 */	addi r3, r3, 0x128                       /* constant-address: 8039CF78, symbol: None */
/* 802D1170  80 1E 00 34 */	lwz r0, 0x34(r30)                       
/* 802D1174  7C A4 00 50 */	subf r5, r4, r0                         
/* 802D1178  4C C6 31 82 */	crclr 6                                 
/* 802D117C  48 01 74 4D */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 802D1180  80 BE 00 38 */	lwz r5, 0x38(r30)                       
/* 802D1184  3C 60 80 3A */	lis r3, JKRSolidHeap__stringBase0@ha    
/* 802D1188  38 63 CE 50 */	addi r3, r3, JKRSolidHeap__stringBase0@l /* constant-address: 8039CE50, symbol: JKRSolidHeap__stringBase0 */
/* 802D118C  38 63 01 39 */	addi r3, r3, 0x139                       /* constant-address: 8039CF89, symbol: None */
/* 802D1190  7F A4 EB 78 */	mr r4, r29                              
/* 802D1194  C0 62 C5 A8 */	lfs f3, lit_693(r2)                      /* constant-address: 80455FA8, symbol: lit_693 */
/* 802D1198  C8 22 C5 B0 */	lfd f1, lit_695(r2)                      /* constant-address: 80455FB0, symbol: lit_695 */
...
/* 802D11B4  C8 22 C5 B8 */	lfd f1, lit_697(r2)                      /* constant-address: 80455FB8, symbol: lit_697 */
...
/* 802D11D4  48 01 73 F5 */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 802D11D8  38 7E 00 18 */	addi r3, r30, 0x18                      
/* 802D11DC  48 06 DF 41 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 802D11E0  7F E3 FB 78 */	mr r3, r31                              
/* 802D11E4  39 61 00 30 */	addi r11, r1, 0x30                      
/* 802D11E8  48 09 10 41 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

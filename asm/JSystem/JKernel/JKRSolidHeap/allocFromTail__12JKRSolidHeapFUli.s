...
/* 802D0E30  48 09 13 A9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802D0E68  41 81 00 20 */	bgt lbl_802D0E88                         /* constant-address: 802D0E88, symbol: lbl_802D0E88 */
...
/* 802D0E84  48 00 00 44 */	b lbl_802D0EC8                           /* constant-address: 802D0EC8, symbol: lbl_802D0EC8 */
lbl_802D0E88:
/* 802D0E88  3C 60 80 3A */	lis r3, JKRSolidHeap__stringBase0@ha    
/* 802D0E8C  38 63 CE 50 */	addi r3, r3, JKRSolidHeap__stringBase0@l /* constant-address: 8039CE50, symbol: JKRSolidHeap__stringBase0 */
/* 802D0E90  38 63 00 31 */	addi r3, r3, 0x31                        /* constant-address: 8039CE81, symbol: None */
/* 802D0E94  4C C6 31 82 */	crclr 6                                 
/* 802D0E98  48 01 77 E5 */	bl JUTWarningConsole_f                   /* constant-address: 802E867C, symbol: JUTWarningConsole_f */
/* 802D0E9C  88 1F 00 68 */	lbz r0, 0x68(r31)                       
/* 802D0EA0  28 00 00 01 */	cmplwi r0, 1                            
/* 802D0EA4  40 82 00 24 */	bne lbl_802D0EC8                         /* constant-address: 802D0EC8, symbol: lbl_802D0EC8 */
/* 802D0EA8  81 8D 8D FC */	lwz r12, mErrorHandler__7JKRHeap(r13)    /* constant-address: 8045137C, symbol: mErrorHandler__7JKRHeap */
/* 802D0EAC  28 0C 00 00 */	cmplwi r12, 0                           
/* 802D0EB0  41 82 00 18 */	beq lbl_802D0EC8                         /* constant-address: 802D0EC8, symbol: lbl_802D0EC8 */
...
/* 802D0ED0  48 09 13 55 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

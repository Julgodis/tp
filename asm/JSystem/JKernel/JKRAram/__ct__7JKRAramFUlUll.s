...
/* 802D2050  48 09 01 89 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802D2068  4B FF F5 01 */	bl __ct__9JKRThreadFUlii                 /* constant-address: 802D1568, symbol: __ct__9JKRThreadFUlii */
/* 802D206C  3C 60 80 3D */	lis r3, __vt__7JKRAram@ha               
/* 802D2070  38 03 C1 58 */	addi r0, r3, __vt__7JKRAram@l            /* constant-address: 803CC158, symbol: __vt__7JKRAram */
/* 802D2074  90 1C 00 00 */	stw r0, 0(r28)                          
/* 802D2078  38 7C 00 98 */	addi r3, r28, 0x98                      
/* 802D207C  38 80 00 03 */	li r4, 3                                
/* 802D2080  48 07 E6 AD */	bl ARInit                                /* constant-address: 8035072C, symbol: ARInit */
/* 802D2084  7C 7F 1B 78 */	mr r31, r3                              
/* 802D2088  48 08 01 DD */	bl ARQInit                               /* constant-address: 80352264, symbol: ARQInit */
/* 802D208C  48 07 E7 65 */	bl ARGetSize                             /* constant-address: 803507F0, symbol: ARGetSize */
/* 802D2090  93 BC 00 80 */	stw r29, 0x80(r28)                      
/* 802D2094  3C 1E 00 01 */	addis r0, r30, 1                        
/* 802D2098  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 802D209C  40 82 00 1C */	bne lbl_802D20B8                         /* constant-address: 802D20B8, symbol: lbl_802D20B8 */
...
/* 802D20B4  48 00 00 18 */	b lbl_802D20CC                           /* constant-address: 802D20CC, symbol: lbl_802D20CC */
lbl_802D20B8:
...
/* 802D20D0  48 07 E5 F5 */	bl ARAlloc                               /* constant-address: 803506C4, symbol: ARAlloc */
/* 802D20D4  90 7C 00 7C */	stw r3, 0x7c(r28)                       
/* 802D20D8  80 7C 00 88 */	lwz r3, 0x88(r28)                       
/* 802D20DC  48 07 E5 E9 */	bl ARAlloc                               /* constant-address: 803506C4, symbol: ARAlloc */
/* 802D20E0  90 7C 00 84 */	stw r3, 0x84(r28)                       
/* 802D20E4  80 7C 00 90 */	lwz r3, 0x90(r28)                       
/* 802D20E8  28 03 00 00 */	cmplwi r3, 0                            
/* 802D20EC  41 82 00 10 */	beq lbl_802D20FC                         /* constant-address: 802D20FC, symbol: lbl_802D20FC */
/* 802D20F0  48 07 E5 D5 */	bl ARAlloc                               /* constant-address: 803506C4, symbol: ARAlloc */
/* 802D20F4  90 7C 00 8C */	stw r3, 0x8c(r28)                       
/* 802D20F8  48 00 00 0C */	b lbl_802D2104                           /* constant-address: 802D2104, symbol: lbl_802D2104 */
lbl_802D20FC:
/* 802D20FC  38 00 00 00 */	li r0, 0                                
/* 802D2100  90 1C 00 8C */	stw r0, 0x8c(r28)                       
lbl_802D2104:
/* 802D2104  38 60 00 44 */	li r3, 0x44                             
/* 802D2108  80 8D 8D F0 */	lwz r4, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802D210C  38 A0 00 00 */	li r5, 0                                
/* 802D2110  4B FF CB 89 */	bl __nw__FUlP7JKRHeapi                   /* constant-address: 802CEC98, symbol: __nw__FUlP7JKRHeapi */
/* 802D2114  7C 60 1B 79 */	or. r0, r3, r3                          
/* 802D2118  41 82 00 14 */	beq lbl_802D212C                         /* constant-address: 802D212C, symbol: lbl_802D212C */
/* 802D211C  80 9C 00 84 */	lwz r4, 0x84(r28)                       
/* 802D2120  80 BC 00 88 */	lwz r5, 0x88(r28)                       
/* 802D2124  48 00 0D 21 */	bl __ct__11JKRAramHeapFUlUl              /* constant-address: 802D2E44, symbol: __ct__11JKRAramHeapFUlUl */
...
/* 802D2138  48 09 00 ED */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 802D6C0C  40 82 00 4C */	bne lbl_802D6C58                         /* constant-address: 802D6C58, symbol: lbl_802D6C58 */
...
/* 802D6C38  48 00 30 1D */	bl loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl /* constant-address: 802D9C54, symbol: loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl */
/* 802D6C3C  90 7F 00 64 */	stw r3, 0x64(r31)                       
/* 802D6C40  80 7F 00 64 */	lwz r3, 0x64(r31)                       
/* 802D6C44  28 03 00 00 */	cmplwi r3, 0                            
/* 802D6C48  41 82 00 54 */	beq lbl_802D6C9C                         /* constant-address: 802D6C9C, symbol: lbl_802D6C9C */
/* 802D6C4C  80 81 00 14 */	lwz r4, 0x14(r1)                        
/* 802D6C50  48 06 49 31 */	bl DCInvalidateRange                     /* constant-address: 8033B580, symbol: DCInvalidateRange */
/* 802D6C54  48 00 00 48 */	b lbl_802D6C9C                           /* constant-address: 802D6C9C, symbol: lbl_802D6C9C */
lbl_802D6C58:
...
/* 802D6C80  48 00 2F D5 */	bl loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl /* constant-address: 802D9C54, symbol: loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl */
/* 802D6C84  90 7F 00 64 */	stw r3, 0x64(r31)                       
/* 802D6C88  80 7F 00 64 */	lwz r3, 0x64(r31)                       
/* 802D6C8C  28 03 00 00 */	cmplwi r3, 0                            
/* 802D6C90  41 82 00 0C */	beq lbl_802D6C9C                         /* constant-address: 802D6C9C, symbol: lbl_802D6C9C */
/* 802D6C94  80 81 00 10 */	lwz r4, 0x10(r1)                        
/* 802D6C98  48 06 48 E9 */	bl DCInvalidateRange                     /* constant-address: 8033B580, symbol: DCInvalidateRange */
lbl_802D6C9C:
/* 802D6C9C  80 7F 00 64 */	lwz r3, 0x64(r31)                       
/* 802D6CA0  28 03 00 00 */	cmplwi r3, 0                            
/* 802D6CA4  40 82 00 10 */	bne lbl_802D6CB4                         /* constant-address: 802D6CB4, symbol: lbl_802D6CB4 */
/* 802D6CA8  38 00 00 00 */	li r0, 0                                
/* 802D6CAC  98 1F 00 3C */	stb r0, 0x3c(r31)                       
/* 802D6CB0  48 00 00 60 */	b lbl_802D6D10                           /* constant-address: 802D6D10, symbol: lbl_802D6D10 */
lbl_802D6CB4:

...
/* 802D6E20  48 08 B3 BD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802D6E38  40 81 00 08 */	ble lbl_802D6E40                         /* constant-address: 802D6E40, symbol: lbl_802D6E40 */
/* 802D6E3C  7D 1F 43 78 */	mr r31, r8                              
lbl_802D6E40:
/* 802D6E40  80 86 00 10 */	lwz r4, 0x10(r6)                        
/* 802D6E44  28 04 00 00 */	cmplwi r4, 0                            
/* 802D6E48  41 82 00 14 */	beq lbl_802D6E5C                         /* constant-address: 802D6E5C, symbol: lbl_802D6E5C */
/* 802D6E4C  7F A3 EB 78 */	mr r3, r29                              
/* 802D6E50  7F E5 FB 78 */	mr r5, r31                              
/* 802D6E54  4B D2 C6 ED */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
/* 802D6E58  48 00 00 50 */	b lbl_802D6EA8                           /* constant-address: 802D6EA8, symbol: lbl_802D6EA8 */
lbl_802D6E5C:
/* 802D6E5C  80 06 00 04 */	lwz r0, 4(r6)                           
/* 802D6E60  54 04 46 3E */	srwi r4, r0, 0x18                       
/* 802D6E64  54 00 47 7B */	rlwinm. r0, r0, 8, 0x1d, 0x1d           
/* 802D6E68  40 82 00 0C */	bne lbl_802D6E74                         /* constant-address: 802D6E74, symbol: lbl_802D6E74 */
/* 802D6E6C  38 E0 00 00 */	li r7, 0                                
/* 802D6E70  48 00 00 18 */	b lbl_802D6E88                           /* constant-address: 802D6E88, symbol: lbl_802D6E88 */
lbl_802D6E74:
/* 802D6E74  54 80 06 31 */	rlwinm. r0, r4, 0, 0x18, 0x18           
/* 802D6E78  41 82 00 0C */	beq lbl_802D6E84                         /* constant-address: 802D6E84, symbol: lbl_802D6E84 */
/* 802D6E7C  38 E0 00 02 */	li r7, 2                                
/* 802D6E80  48 00 00 08 */	b lbl_802D6E88                           /* constant-address: 802D6E88, symbol: lbl_802D6E88 */
lbl_802D6E84:
...
/* 802D6EA0  48 00 00 BD */	bl fetchResource_subroutine__13JKRMemArchiveFPUcUlPUcUli /* constant-address: 802D6F5C, symbol: fetchResource_subroutine__13JKRMemArchiveFPUcUlPUcUli */
/* 802D6EA4  7C 7F 1B 78 */	mr r31, r3                              
lbl_802D6EA8:
/* 802D6EA8  28 1E 00 00 */	cmplwi r30, 0                           
/* 802D6EAC  41 82 00 08 */	beq lbl_802D6EB4                         /* constant-address: 802D6EB4, symbol: lbl_802D6EB4 */
/* 802D6EB0  93 FE 00 00 */	stw r31, 0(r30)                         
lbl_802D6EB4:
/* 802D6EB4  7F A3 EB 78 */	mr r3, r29                              
/* 802D6EB8  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802D6EBC  48 08 B3 6D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 802D7DC4  48 08 A4 15 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802D7DEC  80 8D 8D F0 */	lwz r4, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802D7DF0  38 A0 00 00 */	li r5, 0                                
/* 802D7DF4  4B FF 6E A5 */	bl __nw__FUlP7JKRHeapi                   /* constant-address: 802CEC98, symbol: __nw__FUlP7JKRHeapi */
/* 802D7DF8  7C 60 1B 79 */	or. r0, r3, r3                          
/* 802D7DFC  41 82 00 10 */	beq lbl_802D7E0C                         /* constant-address: 802D7E0C, symbol: lbl_802D7E0C */
/* 802D7E00  7F 84 E3 78 */	mr r4, r28                              
/* 802D7E04  48 00 18 9D */	bl __ct__10JKRDvdFileFl                  /* constant-address: 802D96A0, symbol: __ct__10JKRDvdFileFl */
...
/* 802D7E18  40 82 00 14 */	bne lbl_802D7E2C                         /* constant-address: 802D7E2C, symbol: lbl_802D7E2C */
/* 802D7E1C  38 00 00 00 */	li r0, 0                                
/* 802D7E20  98 1D 00 3C */	stb r0, 0x3c(r29)                       
/* 802D7E24  38 60 00 00 */	li r3, 0                                
/* 802D7E28  48 00 02 10 */	b lbl_802D8038                           /* constant-address: 802D8038, symbol: lbl_802D8038 */
lbl_802D7E2C:
/* 802D7E2C  80 6D 8D F0 */	lwz r3, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802D7E30  38 80 00 20 */	li r4, 0x20                             
/* 802D7E34  38 A0 00 20 */	li r5, 0x20                             
/* 802D7E38  4B FF 66 9D */	bl alloc__7JKRHeapFUli                   /* constant-address: 802CE4D4, symbol: alloc__7JKRHeapFUli */
/* 802D7E3C  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 802D7E40  40 82 00 10 */	bne lbl_802D7E50                         /* constant-address: 802D7E50, symbol: lbl_802D7E50 */
/* 802D7E44  38 00 00 00 */	li r0, 0                                
/* 802D7E48  98 1D 00 3C */	stb r0, 0x3c(r29)                       
/* 802D7E4C  48 00 01 9C */	b lbl_802D7FE8                           /* constant-address: 802D7FE8, symbol: lbl_802D7FE8 */
lbl_802D7E50:
...
/* 802D7E78  48 00 1D DD */	bl loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl /* constant-address: 802D9C54, symbol: loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl */
/* 802D7E7C  7F C3 F3 78 */	mr r3, r30                              
/* 802D7E80  38 80 00 20 */	li r4, 0x20                             
/* 802D7E84  48 06 36 FD */	bl DCInvalidateRange                     /* constant-address: 8033B580, symbol: DCInvalidateRange */
/* 802D7E88  80 1D 00 60 */	lwz r0, 0x60(r29)                       
/* 802D7E8C  2C 00 00 01 */	cmpwi r0, 1                             
/* 802D7E90  3B E0 FF E0 */	li r31, -32                             
/* 802D7E94  40 82 00 08 */	bne lbl_802D7E9C                         /* constant-address: 802D7E9C, symbol: lbl_802D7E9C */
...
/* 802D7EA8  4B FF 65 CD */	bl alloc__7JKRHeapFUliP7JKRHeap          /* constant-address: 802CE474, symbol: alloc__7JKRHeapFUliP7JKRHeap */
/* 802D7EAC  90 7D 00 44 */	stw r3, 0x44(r29)                       
/* 802D7EB0  80 9D 00 44 */	lwz r4, 0x44(r29)                       
/* 802D7EB4  28 04 00 00 */	cmplwi r4, 0                            
/* 802D7EB8  40 82 00 10 */	bne lbl_802D7EC8                         /* constant-address: 802D7EC8, symbol: lbl_802D7EC8 */
/* 802D7EBC  38 00 00 00 */	li r0, 0                                
/* 802D7EC0  98 1D 00 3C */	stb r0, 0x3c(r29)                       
/* 802D7EC4  48 00 01 24 */	b lbl_802D7FE8                           /* constant-address: 802D7FE8, symbol: lbl_802D7FE8 */
lbl_802D7EC8:
...
/* 802D7EEC  48 00 1D 69 */	bl loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl /* constant-address: 802D9C54, symbol: loadToMainRAM__12JKRDvdRipperFlPUc15JKRExpandSwitchUlP7JKRHeapQ212JKRDvdRipper15EAllocDirectionUlPiPUl */
/* 802D7EF0  80 7D 00 44 */	lwz r3, 0x44(r29)                       
/* 802D7EF4  80 9E 00 0C */	lwz r4, 0xc(r30)                        
/* 802D7EF8  48 06 36 89 */	bl DCInvalidateRange                     /* constant-address: 8033B580, symbol: DCInvalidateRange */
...
/* 802D7F4C  40 81 00 28 */	ble lbl_802D7F74                         /* constant-address: 802D7F74, symbol: lbl_802D7F74 */
lbl_802D7F50:
/* 802D7F50  80 05 00 04 */	lwz r0, 4(r5)                           
/* 802D7F54  54 03 46 3E */	srwi r3, r0, 0x18                       
/* 802D7F58  54 00 47 FF */	rlwinm. r0, r0, 8, 0x1f, 0x1f           
/* 802D7F5C  41 82 00 10 */	beq lbl_802D7F6C                         /* constant-address: 802D7F6C, symbol: lbl_802D7F6C */
...
/* 802D7F70  42 00 FF E0 */	bdnz lbl_802D7F50                        /* constant-address: 802D7F50, symbol: lbl_802D7F50 */
lbl_802D7F74:
/* 802D7F74  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 802D7F78  41 82 00 60 */	beq lbl_802D7FD8                         /* constant-address: 802D7FD8, symbol: lbl_802D7FD8 */
/* 802D7F7C  7F E3 FB 78 */	mr r3, r31                              
/* 802D7F80  48 08 D1 51 */	bl abs                                   /* constant-address: 803650D0, symbol: abs */
...
/* 802D7F98  4B FF 64 DD */	bl alloc__7JKRHeapFUliP7JKRHeap          /* constant-address: 802CE474, symbol: alloc__7JKRHeapFUliP7JKRHeap */
/* 802D7F9C  90 7D 00 50 */	stw r3, 0x50(r29)                       
/* 802D7FA0  80 7D 00 50 */	lwz r3, 0x50(r29)                       
/* 802D7FA4  28 03 00 00 */	cmplwi r3, 0                            
/* 802D7FA8  40 82 00 1C */	bne lbl_802D7FC4                         /* constant-address: 802D7FC4, symbol: lbl_802D7FC4 */
/* 802D7FAC  80 6D 8D F0 */	lwz r3, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802D7FB0  80 9D 00 44 */	lwz r4, 0x44(r29)                       
/* 802D7FB4  4B FF 65 95 */	bl free__7JKRHeapFPv                     /* constant-address: 802CE548, symbol: free__7JKRHeapFPv */
/* 802D7FB8  38 00 00 00 */	li r0, 0                                
/* 802D7FBC  98 1D 00 3C */	stb r0, 0x3c(r29)                       
/* 802D7FC0  48 00 00 28 */	b lbl_802D7FE8                           /* constant-address: 802D7FE8, symbol: lbl_802D7FE8 */
lbl_802D7FC4:
...
/* 802D7FD4  4B D2 B4 85 */	bl memset                                /* constant-address: 80003458, symbol: memset */
lbl_802D7FD8:
...
/* 802D7FEC  41 82 00 10 */	beq lbl_802D7FFC                         /* constant-address: 802D7FFC, symbol: lbl_802D7FFC */
/* 802D7FF0  80 6D 8D F0 */	lwz r3, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802D7FF4  7F C4 F3 78 */	mr r4, r30                              
/* 802D7FF8  4B FF 65 51 */	bl free__7JKRHeapFPv                     /* constant-address: 802CE548, symbol: free__7JKRHeapFPv */
lbl_802D7FFC:
/* 802D7FFC  88 1D 00 3C */	lbz r0, 0x3c(r29)                       
/* 802D8000  28 00 00 00 */	cmplwi r0, 0                            
/* 802D8004  40 82 00 30 */	bne lbl_802D8034                         /* constant-address: 802D8034, symbol: lbl_802D8034 */
/* 802D8008  80 7D 00 68 */	lwz r3, 0x68(r29)                       
/* 802D800C  28 03 00 00 */	cmplwi r3, 0                            
/* 802D8010  41 82 00 1C */	beq lbl_802D802C                         /* constant-address: 802D802C, symbol: lbl_802D802C */
/* 802D8014  41 82 00 18 */	beq lbl_802D802C                         /* constant-address: 802D802C, symbol: lbl_802D802C */
...
/* 802D8030  48 00 00 08 */	b lbl_802D8038                           /* constant-address: 802D8038, symbol: lbl_802D8038 */
lbl_802D8034:
/* 802D8034  38 60 00 01 */	li r3, 1                                
lbl_802D8038:
/* 802D8038  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802D803C  48 08 A1 E9 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 802D7C00  48 08 A5 DD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802D7C04  7C 7D 1B 78 */	mr r29, r3                              
/* 802D7C08  7C 9E 23 78 */	mr r30, r4                              
/* 802D7C0C  7C BF 2B 78 */	mr r31, r5                              
/* 802D7C10  38 A0 00 03 */	li r5, 3                                
/* 802D7C14  4B FF E6 81 */	bl __ct__10JKRArchiveFlQ210JKRArchive10EMountMode /* constant-address: 802D6294, symbol: __ct__10JKRArchiveFlQ210JKRArchive10EMountMode */
/* 802D7C18  3C 60 80 3D */	lis r3, __vt__13JKRDvdArchive@ha        
/* 802D7C1C  38 03 C3 98 */	addi r0, r3, __vt__13JKRDvdArchive@l     /* constant-address: 803CC398, symbol: __vt__13JKRDvdArchive */
...
/* 802D7C30  48 00 01 85 */	bl open__13JKRDvdArchiveFl               /* constant-address: 802D7DB4, symbol: open__13JKRDvdArchiveFl */
/* 802D7C34  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802D7C38  40 82 00 0C */	bne lbl_802D7C44                         /* constant-address: 802D7C44, symbol: lbl_802D7C44 */
/* 802D7C3C  7F A3 EB 78 */	mr r3, r29                              
/* 802D7C40  48 00 00 40 */	b lbl_802D7C80                           /* constant-address: 802D7C80, symbol: lbl_802D7C80 */
lbl_802D7C44:
/* 802D7C44  3C 60 52 41 */	lis r3, 0x5241 /* 0x52415243@ha */      
/* 802D7C48  38 03 52 43 */	addi r0, r3, 0x5243 /* 0x52415243@l */   /* constant-address: 52415243 */
...
/* 802D7C68  38 63 43 54 */	addi r3, r3, sVolumeList__13JKRFileLoader@l /* constant-address: 80434354, symbol: sVolumeList__13JKRFileLoader */
/* 802D7C6C  38 9D 00 18 */	addi r4, r29, 0x18                      
/* 802D7C70  48 00 43 81 */	bl prepend__10JSUPtrListFP10JSUPtrLink   /* constant-address: 802DBFF0, symbol: prepend__10JSUPtrListFP10JSUPtrLink */
...
/* 802D7C84  48 08 A5 A5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

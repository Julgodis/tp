...
/* 802D3C24  41 82 00 28 */	beq lbl_802D3C4C                         /* constant-address: 802D3C4C, symbol: lbl_802D3C4C */
/* 802D3C28  3C 80 80 3D */	lis r4, __vt__13JKRAramStream@ha        
/* 802D3C2C  38 04 C1 B8 */	addi r0, r4, __vt__13JKRAramStream@l     /* constant-address: 803CC1B8, symbol: __vt__13JKRAramStream */
/* 802D3C30  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802D3C34  38 80 00 00 */	li r4, 0                                
/* 802D3C38  4B FF DB 21 */	bl __dt__9JKRThreadFv                    /* constant-address: 802D1758, symbol: __dt__9JKRThreadFv */
/* 802D3C3C  7F E0 07 35 */	extsh. r0, r31                          
/* 802D3C40  40 81 00 0C */	ble lbl_802D3C4C                         /* constant-address: 802D3C4C, symbol: lbl_802D3C4C */
/* 802D3C44  7F C3 F3 78 */	mr r3, r30                              
/* 802D3C48  4B FF B0 F5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802D3C4C:

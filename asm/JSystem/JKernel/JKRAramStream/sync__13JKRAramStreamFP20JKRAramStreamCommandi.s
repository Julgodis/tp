...
/* 802D3FB8  40 82 00 30 */	bne lbl_802D3FE8                         /* constant-address: 802D3FE8, symbol: lbl_802D3FE8 */
/* 802D3FBC  38 7F 00 30 */	addi r3, r31, 0x30                      
/* 802D3FC0  38 81 00 08 */	addi r4, r1, 8                          
/* 802D3FC4  38 A0 00 01 */	li r5, 1                                
/* 802D3FC8  48 06 AA F5 */	bl OSReceiveMessage                      /* constant-address: 8033EABC, symbol: OSReceiveMessage */
/* 802D3FCC  80 01 00 08 */	lwz r0, 8(r1)                           
/* 802D3FD0  28 00 00 00 */	cmplwi r0, 0                            
/* 802D3FD4  40 82 00 0C */	bne lbl_802D3FE0                         /* constant-address: 802D3FE0, symbol: lbl_802D3FE0 */
/* 802D3FD8  38 60 00 00 */	li r3, 0                                
/* 802D3FDC  48 00 00 44 */	b lbl_802D4020                           /* constant-address: 802D4020, symbol: lbl_802D4020 */
lbl_802D3FE0:
/* 802D3FE0  7F E3 FB 78 */	mr r3, r31                              
/* 802D3FE4  48 00 00 3C */	b lbl_802D4020                           /* constant-address: 802D4020, symbol: lbl_802D4020 */
lbl_802D3FE8:
/* 802D3FE8  38 7F 00 30 */	addi r3, r31, 0x30                      
/* 802D3FEC  38 81 00 08 */	addi r4, r1, 8                          
/* 802D3FF0  38 A0 00 00 */	li r5, 0                                
/* 802D3FF4  48 06 AA C9 */	bl OSReceiveMessage                      /* constant-address: 8033EABC, symbol: OSReceiveMessage */
/* 802D3FF8  2C 03 00 00 */	cmpwi r3, 0                             
/* 802D3FFC  40 82 00 0C */	bne lbl_802D4008                         /* constant-address: 802D4008, symbol: lbl_802D4008 */
/* 802D4000  38 60 00 00 */	li r3, 0                                
/* 802D4004  48 00 00 1C */	b lbl_802D4020                           /* constant-address: 802D4020, symbol: lbl_802D4020 */
lbl_802D4008:
/* 802D4008  80 01 00 08 */	lwz r0, 8(r1)                           
/* 802D400C  28 00 00 00 */	cmplwi r0, 0                            
/* 802D4010  40 82 00 0C */	bne lbl_802D401C                         /* constant-address: 802D401C, symbol: lbl_802D401C */
/* 802D4014  38 60 00 00 */	li r3, 0                                
/* 802D4018  48 00 00 08 */	b lbl_802D4020                           /* constant-address: 802D4020, symbol: lbl_802D4020 */
lbl_802D401C:

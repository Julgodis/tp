...
/* 802D0948  48 09 18 95 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802D0960  41 81 00 14 */	bgt lbl_802D0974                         /* constant-address: 802D0974, symbol: lbl_802D0974 */
/* 802D0964  57 E4 06 3E */	clrlwi r4, r31, 0x18                    
/* 802D0968  4B FF F3 81 */	bl getUsedSize__10JKRExpHeapCFUc         /* constant-address: 802CFCE8, symbol: getUsedSize__10JKRExpHeapCFUc */
/* 802D096C  90 7E 00 00 */	stw r3, 0(r30)                          
/* 802D0970  48 00 00 14 */	b lbl_802D0984                           /* constant-address: 802D0984, symbol: lbl_802D0984 */
lbl_802D0974:
/* 802D0974  4B FF DE 11 */	bl getTotalFreeSize__7JKRHeapFv          /* constant-address: 802CE784, symbol: getTotalFreeSize__7JKRHeapFv */
...
/* 802D098C  48 00 00 30 */	b lbl_802D09BC                           /* constant-address: 802D09BC, symbol: lbl_802D09BC */
lbl_802D0990:
/* 802D0990  28 1F 00 FF */	cmplwi r31, 0xff                        
/* 802D0994  41 81 00 1C */	bgt lbl_802D09B0                         /* constant-address: 802D09B0, symbol: lbl_802D09B0 */
/* 802D0998  88 04 00 03 */	lbz r0, 3(r4)                           
/* 802D099C  7C 00 F8 40 */	cmplw r0, r31                           
/* 802D09A0  40 82 00 18 */	bne lbl_802D09B8                         /* constant-address: 802D09B8, symbol: lbl_802D09B8 */
/* 802D09A4  1C 04 00 03 */	mulli r0, r4, 3                         
/* 802D09A8  7C 63 02 14 */	add r3, r3, r0                          
/* 802D09AC  48 00 00 0C */	b lbl_802D09B8                           /* constant-address: 802D09B8, symbol: lbl_802D09B8 */
lbl_802D09B0:
...
/* 802D09C0  40 82 FF D0 */	bne lbl_802D0990                         /* constant-address: 802D0990, symbol: lbl_802D0990 */
/* 802D09C4  90 7E 00 04 */	stw r3, 4(r30)                          
/* 802D09C8  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802D09CC  48 09 18 5D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

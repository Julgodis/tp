lbl_802D03B8:
/* 802D03B8 00000000  94 21 FF C0 */	stwu r1, -0x40(r1)
/* 802D03BC 00000004  7C 08 02 A6 */	mflr r0
/* 802D03C0 00000008  90 01 00 44 */	stw r0, 0x44(r1)
/* 802D03C4 0000000C  39 61 00 40 */	addi r11, r1, 0x40
/* 802D03C8 00000010  48 09 1E 05 */	bl _savegpr_25
/* 802D03CC 00000014  7C 7A 1B 78 */	mr r26, r3
/* 802D03D0 00000018  38 7A 00 18 */	addi r3, r26, 0x18
/* 802D03D4 0000001C  48 06 EC 6D */	bl OSLockMutex
/* 802D03D8 00000020  7F 43 D3 78 */	mr r3, r26
/* 802D03DC 00000024  81 9A 00 00 */	lwz r12, 0(r26)
/* 802D03E0 00000028  81 8C 00 14 */	lwz r12, 0x14(r12)
/* 802D03E4 0000002C  7D 89 03 A6 */	mtctr r12
/* 802D03E8 00000030  4E 80 04 21 */	bctrl 
/* 802D03EC 00000034  7C 7F 1B 78 */	mr r31, r3
...
/* 802D0468 00000020  48 01 81 61 */	bl JUTReportConsole_f
/* 802D046C 00000024  48 00 00 6C */	b lbl_802D04D8
lbl_802D0470:
/* 802D0470 00000000  88 1B 00 02 */	lbz r0, 2(r27)
/* 802D0474 00000004  54 08 06 7E */	clrlwi r8, r0, 0x19
/* 802D0478 00000008  38 BB 00 10 */	addi r5, r27, 0x10
/* 802D047C 0000000C  38 79 02 24 */	addi r3, r25, 0x224
...
/* 802D049C 00000004  88 FB 00 03 */	lbz r7, 3(r27)
/* 802D04A0 00000008  81 3B 00 08 */	lwz r9, 8(r27)
/* 802D04A4 0000000C  81 5B 00 0C */	lwz r10, 0xc(r27)
/* 802D04A8 00000010  4C C6 31 82 */	crclr 6
/* 802D04AC 00000014  48 01 81 1D */	bl JUTReportConsole_f
/* 802D04B0 00000018  80 7B 00 04 */	lwz r3, 4(r27)
/* 802D04B4 0000001C  88 1B 00 02 */	lbz r0, 2(r27)
/* 802D04B8 00000020  54 00 06 7E */	clrlwi r0, r0, 0x19
/* 802D04BC 00000024  7C 03 02 14 */	add r0, r3, r0
/* 802D04C0 00000028  7F C0 F2 14 */	add r30, r0, r30
/* 802D04C4 0000002C  83 7B 00 0C */	lwz r27, 0xc(r27)
/* 802D04C8 00000030  3B DE 00 10 */	addi r30, r30, 0x10
/* 802D04CC 00000034  3B BD 00 01 */	addi r29, r29, 1
lbl_802D04D0:
...
/* 802D0518 00000004  38 9B 02 64 */	addi r4, r27, 0x264
/* 802D051C 00000008  38 B9 00 10 */	addi r5, r25, 0x10
/* 802D0520 0000000C  80 D9 00 04 */	lwz r6, 4(r25)
/* 802D0524 00000010  88 F9 00 03 */	lbz r7, 3(r25)
/* 802D0528 00000014  88 19 00 02 */	lbz r0, 2(r25)
/* 802D052C 00000018  54 08 06 7E */	clrlwi r8, r0, 0x19
/* 802D0530 0000001C  81 39 00 08 */	lwz r9, 8(r25)
/* 802D0534 00000020  81 59 00 0C */	lwz r10, 0xc(r25)
/* 802D0538 00000024  4C C6 31 82 */	crclr 6
/* 802D053C 00000028  48 01 80 8D */	bl JUTReportConsole_f
/* 802D0540 0000002C  83 39 00 0C */	lwz r25, 0xc(r25)
/* 802D0544 00000030  3B 9C 00 01 */	addi r28, r28, 1
lbl_802D0548:
...
/* 802D0574 0000002C  90 01 00 08 */	stw r0, 8(r1)
/* 802D0578 00000030  C8 01 00 08 */	lfd f0, 8(r1)
/* 802D057C 00000034  EC 20 10 28 */	fsubs f1, f0, f2
/* 802D0580 00000038  90 A1 00 14 */	stw r5, 0x14(r1)
/* 802D0584 0000003C  90 01 00 10 */	stw r0, 0x10(r1)
/* 802D0588 00000040  C8 01 00 10 */	lfd f0, 0x10(r1)
/* 802D058C 00000044  EC 00 10 28 */	fsubs f0, f0, f2
/* 802D0590 00000048  EC 01 00 24 */	fdivs f0, f1, f0
/* 802D0594 0000004C  EC 23 00 32 */	fmuls f1, f3, f0
/* 802D0598 00000050  7F A6 EB 78 */	mr r6, r29
/* 802D059C 00000054  7F 87 E3 78 */	mr r7, r28
/* 802D05A0 00000058  4C C6 32 42 */	crset 6
/* 802D05A4 0000005C  48 01 80 25 */	bl JUTReportConsole_f
/* 802D05A8 00000060  38 7A 00 18 */	addi r3, r26, 0x18
/* 802D05AC 00000064  48 06 EB 71 */	bl OSUnlockMutex
/* 802D05B0 00000068  7F E3 FB 78 */	mr r3, r31
/* 802D05B4 0000006C  39 61 00 40 */	addi r11, r1, 0x40
/* 802D05B8 00000070  48 09 1C 61 */	bl _restgpr_25
/* 802D05BC 00000074  80 01 00 44 */	lwz r0, 0x44(r1)
/* 802D05C0 00000078  7C 08 03 A6 */	mtlr r0
/* 802D05C4 0000007C  38 21 00 40 */	addi r1, r1, 0x40
/* 802D05C8 00000080  4E 80 00 20 */	blr 

...
/* 802D90D0  48 08 91 01 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 802D9104  40 82 00 0C */	bne lbl_802D9110                         /* constant-address: 802D9110, symbol: lbl_802D9110 */
/* 802D9108  39 00 00 00 */	li r8, 0                                
/* 802D910C  48 00 00 18 */	b lbl_802D9124                           /* constant-address: 802D9124, symbol: lbl_802D9124 */
lbl_802D9110:
/* 802D9110  54 60 06 31 */	rlwinm. r0, r3, 0, 0x18, 0x18           
/* 802D9114  41 82 00 0C */	beq lbl_802D9120                         /* constant-address: 802D9120, symbol: lbl_802D9120 */
/* 802D9118  39 00 00 02 */	li r8, 2                                
/* 802D911C  48 00 00 08 */	b lbl_802D9124                           /* constant-address: 802D9124, symbol: lbl_802D9124 */
lbl_802D9120:
/* 802D9120  39 00 00 01 */	li r8, 1                                
lbl_802D9124:
/* 802D9124  80 1E 00 10 */	lwz r0, 0x10(r30)                       
/* 802D9128  28 00 00 00 */	cmplwi r0, 0                            
/* 802D912C  41 82 00 54 */	beq lbl_802D9180                         /* constant-address: 802D9180, symbol: lbl_802D9180 */
/* 802D9130  2C 08 00 02 */	cmpwi r8, 2                             
/* 802D9134  40 82 00 28 */	bne lbl_802D915C                         /* constant-address: 802D915C, symbol: lbl_802D915C */
...
/* 802D9154  41 82 00 08 */	beq lbl_802D915C                         /* constant-address: 802D915C, symbol: lbl_802D915C */
/* 802D9158  7C 7A 1B 78 */	mr r26, r3                              
lbl_802D915C:
/* 802D915C  7C 1A E8 40 */	cmplw r26, r29                          
/* 802D9160  40 81 00 08 */	ble lbl_802D9168                         /* constant-address: 802D9168, symbol: lbl_802D9168 */
...
/* 802D9174  4B FF 59 A5 */	bl copyMemory__7JKRHeapFPvPvUl           /* constant-address: 802CEB18, symbol: copyMemory__7JKRHeapFPvPvUl */
/* 802D9178  7F 5B D3 78 */	mr r27, r26                             
/* 802D917C  48 00 00 BC */	b lbl_802D9238                           /* constant-address: 802D9238, symbol: lbl_802D9238 */
lbl_802D9180:
/* 802D9180  54 60 06 F7 */	rlwinm. r0, r3, 0, 0x1b, 0x1b           
/* 802D9184  41 82 00 2C */	beq lbl_802D91B0                         /* constant-address: 802D91B0, symbol: lbl_802D91B0 */
...
/* 802D91A4  4B FF DD B9 */	bl fetchResource_subroutine__13JKRMemArchiveFPUcUlPUcUli /* constant-address: 802D6F5C, symbol: fetchResource_subroutine__13JKRMemArchiveFPUcUlPUcUli */
/* 802D91A8  7C 7B 1B 78 */	mr r27, r3                              
/* 802D91AC  48 00 00 8C */	b lbl_802D9238                           /* constant-address: 802D9238, symbol: lbl_802D9238 */
lbl_802D91B0:
/* 802D91B0  54 60 06 B5 */	rlwinm. r0, r3, 0, 0x1a, 0x1a           
/* 802D91B4  41 82 00 38 */	beq lbl_802D91EC                         /* constant-address: 802D91EC, symbol: lbl_802D91EC */
...
/* 802D91E0  4B FF E6 79 */	bl fetchResource_subroutine__14JKRAramArchiveFUlUlPUcUli /* constant-address: 802D7858, symbol: fetchResource_subroutine__14JKRAramArchiveFUlUlPUcUli */
/* 802D91E4  7C 7B 1B 78 */	mr r27, r3                              
/* 802D91E8  48 00 00 50 */	b lbl_802D9238                           /* constant-address: 802D9238, symbol: lbl_802D9238 */
lbl_802D91EC:
/* 802D91EC  54 60 06 73 */	rlwinm. r0, r3, 0, 0x19, 0x19           
/* 802D91F0  41 82 00 2C */	beq lbl_802D921C                         /* constant-address: 802D921C, symbol: lbl_802D921C */
...
/* 802D9210  4B FF F0 5D */	bl fetchResource_subroutine__13JKRDvdArchiveFlUlUlPUcUlii /* constant-address: 802D826C, symbol: fetchResource_subroutine__13JKRDvdArchiveFlUlUlPUcUlii */
/* 802D9214  7C 7B 1B 78 */	mr r27, r3                              
/* 802D9218  48 00 00 20 */	b lbl_802D9238                           /* constant-address: 802D9238, symbol: lbl_802D9238 */
lbl_802D921C:
/* 802D921C  3C 60 80 3A */	lis r3, JKRCompArchive__stringBase0@ha  
/* 802D9220  38 63 D2 20 */	addi r3, r3, JKRCompArchive__stringBase0@l /* constant-address: 8039D220, symbol: JKRCompArchive__stringBase0 */
/* 802D9224  38 80 03 08 */	li r4, 0x308                            
/* 802D9228  38 A3 00 13 */	addi r5, r3, 0x13                        /* constant-address: 8039D233, symbol: None */
/* 802D922C  38 C3 00 16 */	addi r6, r3, 0x16                        /* constant-address: 8039D236, symbol: None */
/* 802D9230  4C C6 31 82 */	crclr 6                                 
/* 802D9234  48 00 8F C9 */	bl panic_f__12JUTExceptionFPCciPCce      /* constant-address: 802E21FC, symbol: panic_f__12JUTExceptionFPCciPCce */
lbl_802D9238:
/* 802D9238  28 1F 00 00 */	cmplwi r31, 0                           
/* 802D923C  41 82 00 08 */	beq lbl_802D9244                         /* constant-address: 802D9244, symbol: lbl_802D9244 */
/* 802D9240  93 7F 00 00 */	stw r27, 0(r31)                         
lbl_802D9244:
/* 802D9244  7F 83 E3 78 */	mr r3, r28                              
/* 802D9248  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802D924C  48 08 8F D1 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

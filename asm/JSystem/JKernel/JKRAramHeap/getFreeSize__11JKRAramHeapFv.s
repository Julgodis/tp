...
/* 802D3154  48 06 BE ED */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 802D3158  3C 60 80 43 */	lis r3, sAramList__11JKRAramHeap@ha     
/* 802D315C  38 63 43 0C */	addi r3, r3, sAramList__11JKRAramHeap@l  /* constant-address: 8043430C, symbol: sAramList__11JKRAramHeap */
/* 802D3160  80 63 00 00 */	lwz r3, 0(r3)                            /* constant-address: 8043430C, symbol: sAramList__11JKRAramHeap */
/* 802D3164  48 00 00 1C */	b lbl_802D3180                           /* constant-address: 802D3180, symbol: lbl_802D3180 */
lbl_802D3168:
/* 802D3168  80 83 00 00 */	lwz r4, 0(r3)                           
/* 802D316C  80 04 00 1C */	lwz r0, 0x1c(r4)                        
/* 802D3170  7C 00 F8 40 */	cmplw r0, r31                           
/* 802D3174  40 81 00 08 */	ble lbl_802D317C                         /* constant-address: 802D317C, symbol: lbl_802D317C */
/* 802D3178  7C 1F 03 78 */	mr r31, r0                              
lbl_802D317C:
/* 802D317C  80 63 00 0C */	lwz r3, 0xc(r3)                         
lbl_802D3180:
/* 802D3180  28 03 00 00 */	cmplwi r3, 0                            
/* 802D3184  40 82 FF E4 */	bne lbl_802D3168                         /* constant-address: 802D3168, symbol: lbl_802D3168 */
/* 802D3188  38 7E 00 18 */	addi r3, r30, 0x18                      
/* 802D318C  48 06 BF 91 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */

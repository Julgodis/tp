...
/* 802D5C04  40 82 00 18 */	bne lbl_802D5C1C                         /* constant-address: 802D5C1C, symbol: lbl_802D5C1C */
/* 802D5C08  38 84 00 01 */	addi r4, r4, 1                          
/* 802D5C0C  38 A0 00 00 */	li r5, 0                                
/* 802D5C10  48 00 09 95 */	bl findFsResource__10JKRArchiveCFPCcUl   /* constant-address: 802D65A4, symbol: findFsResource__10JKRArchiveCFPCcUl */
/* 802D5C14  7C 64 1B 78 */	mr r4, r3                               
/* 802D5C18  48 00 00 10 */	b lbl_802D5C28                           /* constant-address: 802D5C28, symbol: lbl_802D5C28 */
lbl_802D5C1C:
/* 802D5C1C  80 AD 8E A0 */	lwz r5, sCurrentDirID__10JKRArchive(r13) /* constant-address: 80451420, symbol: sCurrentDirID__10JKRArchive */
/* 802D5C20  48 00 09 85 */	bl findFsResource__10JKRArchiveCFPCcUl   /* constant-address: 802D65A4, symbol: findFsResource__10JKRArchiveCFPCcUl */
/* 802D5C24  7C 64 1B 78 */	mr r4, r3                               
lbl_802D5C28:
/* 802D5C28  28 04 00 00 */	cmplwi r4, 0                            
/* 802D5C2C  41 82 00 20 */	beq lbl_802D5C4C                         /* constant-address: 802D5C4C, symbol: lbl_802D5C4C */
...
/* 802D5C48  48 00 00 08 */	b lbl_802D5C50                           /* constant-address: 802D5C50, symbol: lbl_802D5C50 */
lbl_802D5C4C:

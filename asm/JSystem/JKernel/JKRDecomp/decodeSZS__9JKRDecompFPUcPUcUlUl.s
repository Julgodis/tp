...
/* 802DBC40  40 82 00 10 */	bne lbl_802DBC50                         /* constant-address: 802DBC50, symbol: lbl_802DBC50 */
...
/* 802DBC54  41 82 00 30 */	beq lbl_802DBC84                         /* constant-address: 802DBC84, symbol: lbl_802DBC84 */
/* 802DBC58  28 06 00 00 */	cmplwi r6, 0                            
/* 802DBC5C  40 82 00 1C */	bne lbl_802DBC78                         /* constant-address: 802DBC78, symbol: lbl_802DBC78 */
...
/* 802DBC70  40 82 00 0C */	bne lbl_802DBC7C                         /* constant-address: 802DBC7C, symbol: lbl_802DBC7C */
/* 802DBC74  4E 80 00 20 */	blr                                     
lbl_802DBC78:
/* 802DBC78  38 C6 FF FF */	addi r6, r6, -1                         
lbl_802DBC7C:
/* 802DBC7C  39 6B 00 01 */	addi r11, r11, 1                        
/* 802DBC80  48 00 00 64 */	b lbl_802DBCE4                           /* constant-address: 802DBCE4, symbol: lbl_802DBCE4 */
lbl_802DBC84:
...
/* 802DBC9C  40 82 00 14 */	bne lbl_802DBCB0                         /* constant-address: 802DBCB0, symbol: lbl_802DBCB0 */
/* 802DBCA0  88 6B 00 00 */	lbz r3, 0(r11)                          
/* 802DBCA4  38 63 00 12 */	addi r3, r3, 0x12                       
/* 802DBCA8  39 6B 00 01 */	addi r11, r11, 1                        
/* 802DBCAC  48 00 00 08 */	b lbl_802DBCB4                           /* constant-address: 802DBCB4, symbol: lbl_802DBCB4 */
lbl_802DBCB0:
/* 802DBCB0  38 63 00 02 */	addi r3, r3, 2                          
lbl_802DBCB4:
/* 802DBCB4  28 06 00 00 */	cmplwi r6, 0                            
/* 802DBCB8  40 82 00 1C */	bne lbl_802DBCD4                         /* constant-address: 802DBCD4, symbol: lbl_802DBCD4 */
...
/* 802DBCCC  40 82 00 0C */	bne lbl_802DBCD8                         /* constant-address: 802DBCD8, symbol: lbl_802DBCD8 */
...
/* 802DBCE0  40 82 FF D4 */	bne lbl_802DBCB4                         /* constant-address: 802DBCB4, symbol: lbl_802DBCB4 */
lbl_802DBCE4:
/* 802DBCE4  55 4A 08 3C */	slwi r10, r10, 1                        
/* 802DBCE8  7C 04 38 40 */	cmplw r4, r7                            
/* 802DBCEC  39 29 FF FF */	addi r9, r9, -1                         
/* 802DBCF0  40 82 FF 4C */	bne lbl_802DBC3C                         /* constant-address: 802DBC3C, symbol: lbl_802DBC3C */

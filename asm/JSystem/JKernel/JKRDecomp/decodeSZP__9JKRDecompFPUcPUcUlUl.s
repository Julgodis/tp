...
/* 802DBA68  48 08 67 6D */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 802DBADC  41 82 01 20 */	beq lbl_802DBBFC                         /* constant-address: 802DBBFC, symbol: lbl_802DBBFC */
/* 802DBAE0  7C 06 00 40 */	cmplw r6, r0                            
/* 802DBAE4  41 81 01 18 */	bgt lbl_802DBBFC                         /* constant-address: 802DBBFC, symbol: lbl_802DBBFC */
/* 802DBAE8  7C 9F 23 78 */	mr r31, r4                              
/* 802DBAEC  7D 83 62 14 */	add r12, r3, r12                        
lbl_802DBAF0:
/* 802DBAF0  28 0A 00 00 */	cmplwi r10, 0                           
/* 802DBAF4  40 82 00 30 */	bne lbl_802DBB24                         /* constant-address: 802DBB24, symbol: lbl_802DBB24 */
...
/* 802DBB20  38 E7 00 04 */	addi r7, r7, 4                           /* constant-address: 00000014 */
lbl_802DBB24:
/* 802DBB24  55 7D 00 01 */	rlwinm. r29, r11, 0, 0, 0               
/* 802DBB28  41 82 00 34 */	beq lbl_802DBB5C                         /* constant-address: 802DBB5C, symbol: lbl_802DBB5C */
/* 802DBB2C  28 06 00 00 */	cmplwi r6, 0                            
/* 802DBB30  40 82 00 18 */	bne lbl_802DBB48                         /* constant-address: 802DBB48, symbol: lbl_802DBB48 */
/* 802DBB34  8B AC 00 00 */	lbz r29, 0(r12)                         
/* 802DBB38  9B BF 00 00 */	stb r29, 0(r31)                         
/* 802DBB3C  34 A5 FF FF */	addic. r5, r5, -1                       
/* 802DBB40  40 82 00 0C */	bne lbl_802DBB4C                         /* constant-address: 802DBB4C, symbol: lbl_802DBB4C */
/* 802DBB44  48 00 00 B8 */	b lbl_802DBBFC                           /* constant-address: 802DBBFC, symbol: lbl_802DBBFC */
lbl_802DBB48:
/* 802DBB48  38 C6 FF FF */	addi r6, r6, -1                         
lbl_802DBB4C:
/* 802DBB4C  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000001 */
/* 802DBB50  3B FF 00 01 */	addi r31, r31, 1                        
/* 802DBB54  39 8C 00 01 */	addi r12, r12, 1                        
/* 802DBB58  48 00 00 94 */	b lbl_802DBBEC                           /* constant-address: 802DBBEC, symbol: lbl_802DBBEC */
lbl_802DBB5C:
...
/* 802DBB7C  40 82 00 14 */	bne lbl_802DBB90                         /* constant-address: 802DBB90, symbol: lbl_802DBB90 */
/* 802DBB80  8B AC 00 00 */	lbz r29, 0(r12)                         
/* 802DBB84  3B 9D 00 12 */	addi r28, r29, 0x12                     
/* 802DBB88  39 8C 00 01 */	addi r12, r12, 1                        
/* 802DBB8C  48 00 00 08 */	b lbl_802DBB94                           /* constant-address: 802DBB94, symbol: lbl_802DBB94 */
lbl_802DBB90:
/* 802DBB90  3B 9C 00 02 */	addi r28, r28, 2                        
lbl_802DBB94:
/* 802DBB94  7F A8 00 50 */	subf r29, r8, r0                        
/* 802DBB98  7C 1C E8 00 */	cmpw r28, r29                           
/* 802DBB9C  40 81 00 08 */	ble lbl_802DBBA4                         /* constant-address: 802DBBA4, symbol: lbl_802DBBA4 */
...
/* 802DBBB0  40 81 00 3C */	ble lbl_802DBBEC                         /* constant-address: 802DBBEC, symbol: lbl_802DBBEC */
lbl_802DBBB4:
/* 802DBBB4  28 06 00 00 */	cmplwi r6, 0                            
/* 802DBBB8  40 82 00 1C */	bne lbl_802DBBD4                         /* constant-address: 802DBBD4, symbol: lbl_802DBBD4 */
...
/* 802DBBCC  40 82 00 0C */	bne lbl_802DBBD8                         /* constant-address: 802DBBD8, symbol: lbl_802DBBD8 */
/* 802DBBD0  48 00 00 2C */	b lbl_802DBBFC                           /* constant-address: 802DBBFC, symbol: lbl_802DBBFC */
lbl_802DBBD4:
...
/* 802DBBE8  42 00 FF CC */	bdnz lbl_802DBBB4                        /* constant-address: 802DBBB4, symbol: lbl_802DBBB4 */
lbl_802DBBEC:
/* 802DBBEC  55 6B 08 3C */	slwi r11, r11, 1                        
/* 802DBBF0  7C 08 00 00 */	cmpw r8, r0                             
/* 802DBBF4  39 4A FF FF */	addi r10, r10, -1                       
/* 802DBBF8  41 80 FE F8 */	blt lbl_802DBAF0                         /* constant-address: 802DBAF0, symbol: lbl_802DBAF0 */
lbl_802DBBFC:
/* 802DBBFC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802DBC00  48 08 66 21 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

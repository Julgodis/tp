...
/* 802D4810  41 82 00 48 */	beq lbl_802D4858                         /* constant-address: 802D4858, symbol: lbl_802D4858 */
/* 802D4814  3C 60 80 3D */	lis r3, __vt__12JKRDvdFinder@ha         
/* 802D4818  38 03 C2 08 */	addi r0, r3, __vt__12JKRDvdFinder@l      /* constant-address: 803CC208, symbol: __vt__12JKRDvdFinder */
/* 802D481C  90 1E 00 0C */	stw r0, 0xc(r30)                        
/* 802D4820  88 1E 00 20 */	lbz r0, 0x20(r30)                       
/* 802D4824  28 00 00 00 */	cmplwi r0, 0                            
/* 802D4828  41 82 00 0C */	beq lbl_802D4834                         /* constant-address: 802D4834, symbol: lbl_802D4834 */
/* 802D482C  38 7E 00 14 */	addi r3, r30, 0x14                      
/* 802D4830  48 07 48 B5 */	bl DVDCloseDir                           /* constant-address: 803490E4, symbol: DVDCloseDir */
lbl_802D4834:
/* 802D4834  28 1E 00 00 */	cmplwi r30, 0                           
/* 802D4838  41 82 00 10 */	beq lbl_802D4848                         /* constant-address: 802D4848, symbol: lbl_802D4848 */
/* 802D483C  3C 60 80 3D */	lis r3, __vt__13JKRFileFinder@ha        
/* 802D4840  38 03 C2 28 */	addi r0, r3, __vt__13JKRFileFinder@l     /* constant-address: 803CC228, symbol: __vt__13JKRFileFinder */
/* 802D4844  90 1E 00 0C */	stw r0, 0xc(r30)                        
lbl_802D4848:
/* 802D4848  7F E0 07 35 */	extsh. r0, r31                          
/* 802D484C  40 81 00 0C */	ble lbl_802D4858                         /* constant-address: 802D4858, symbol: lbl_802D4858 */
/* 802D4850  7F C3 F3 78 */	mr r3, r30                              
/* 802D4854  4B FF A4 E9 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802D4858:

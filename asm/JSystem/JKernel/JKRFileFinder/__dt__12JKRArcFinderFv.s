...
/* 802D496C  41 82 00 30 */	beq lbl_802D499C                         /* constant-address: 802D499C, symbol: lbl_802D499C */
/* 802D4970  3C 60 80 3D */	lis r3, __vt__12JKRArcFinder@ha         
/* 802D4974  38 03 C2 18 */	addi r0, r3, __vt__12JKRArcFinder@l      /* constant-address: 803CC218, symbol: __vt__12JKRArcFinder */
/* 802D4978  90 1F 00 0C */	stw r0, 0xc(r31)                        
/* 802D497C  41 82 00 10 */	beq lbl_802D498C                         /* constant-address: 802D498C, symbol: lbl_802D498C */
/* 802D4980  3C 60 80 3D */	lis r3, __vt__13JKRFileFinder@ha        
/* 802D4984  38 03 C2 28 */	addi r0, r3, __vt__13JKRFileFinder@l     /* constant-address: 803CC228, symbol: __vt__13JKRFileFinder */
/* 802D4988  90 1F 00 0C */	stw r0, 0xc(r31)                        
lbl_802D498C:
/* 802D498C  7C 80 07 35 */	extsh. r0, r4                           
/* 802D4990  40 81 00 0C */	ble lbl_802D499C                         /* constant-address: 802D499C, symbol: lbl_802D499C */
/* 802D4994  7F E3 FB 78 */	mr r3, r31                              
/* 802D4998  4B FF A3 A5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802D499C:

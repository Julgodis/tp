...
/* 802D642C  48 08 BD A9 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 802D6430  7C 7B 1B 78 */	mr r27, r3                              
/* 802D6434  7C BD 2B 78 */	mr r29, r5                              
/* 802D6438  28 04 00 00 */	cmplwi r4, 0                            
/* 802D643C  40 82 00 14 */	bne lbl_802D6450                         /* constant-address: 802D6450, symbol: lbl_802D6450 */
/* 802D6440  80 7B 00 48 */	lwz r3, 0x48(r27)                       
/* 802D6444  57 A0 20 36 */	slwi r0, r29, 4                         
/* 802D6448  7C 63 02 14 */	add r3, r3, r0                          
/* 802D644C  48 00 00 90 */	b lbl_802D64DC                           /* constant-address: 802D64DC, symbol: lbl_802D64DC */
lbl_802D6450:
/* 802D6450  38 61 00 08 */	addi r3, r1, 8                          
/* 802D6454  38 A0 00 2F */	li r5, 0x2f                             
/* 802D6458  48 00 04 2D */	bl store__Q210JKRArchive8CArcNameFPCcc   /* constant-address: 802D6884, symbol: store__Q210JKRArchive8CArcNameFPCcc */
...
/* 802D6480  48 00 00 4C */	b lbl_802D64CC                           /* constant-address: 802D64CC, symbol: lbl_802D64CC */
lbl_802D6484:
...
/* 802D6498  4B FF FE FD */	bl isSameName__10JKRArchiveCFRQ210JKRArchive8CArcNameUlUs /* constant-address: 802D6394, symbol: isSameName__10JKRArchiveCFRQ210JKRArchive8CArcNameUlUs */
/* 802D649C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802D64A0  41 82 00 24 */	beq lbl_802D64C4                         /* constant-address: 802D64C4, symbol: lbl_802D64C4 */
/* 802D64A4  80 1E 00 04 */	lwz r0, 4(r30)                          
/* 802D64A8  54 00 47 BD */	rlwinm. r0, r0, 8, 0x1e, 0x1e           
/* 802D64AC  41 82 00 2C */	beq lbl_802D64D8                         /* constant-address: 802D64D8, symbol: lbl_802D64D8 */
/* 802D64B0  7F 63 DB 78 */	mr r3, r27                              
/* 802D64B4  7F 84 E3 78 */	mr r4, r28                              
/* 802D64B8  80 BE 00 08 */	lwz r5, 8(r30)                          
/* 802D64BC  4B FF FF 61 */	bl findDirectory__10JKRArchiveCFPCcUl    /* constant-address: 802D641C, symbol: findDirectory__10JKRArchiveCFPCcUl */
/* 802D64C0  48 00 00 1C */	b lbl_802D64DC                           /* constant-address: 802D64DC, symbol: lbl_802D64DC */
lbl_802D64C4:
/* 802D64C4  3B DE 00 14 */	addi r30, r30, 0x14                     
/* 802D64C8  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
lbl_802D64CC:
/* 802D64CC  A0 1F 00 0A */	lhz r0, 0xa(r31)                        
/* 802D64D0  7C 1D 00 00 */	cmpw r29, r0                            
/* 802D64D4  41 80 FF B0 */	blt lbl_802D6484                         /* constant-address: 802D6484, symbol: lbl_802D6484 */
lbl_802D64D8:
/* 802D64D8  38 60 00 00 */	li r3, 0                                
lbl_802D64DC:
/* 802D64DC  39 61 01 30 */	addi r11, r1, 0x130                     
/* 802D64E0  48 08 BD 41 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

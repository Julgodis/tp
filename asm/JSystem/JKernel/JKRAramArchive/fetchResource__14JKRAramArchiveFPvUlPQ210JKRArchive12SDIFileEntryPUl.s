...
/* 802D7704  48 08 AA D1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 802D7720  40 81 00 08 */	ble lbl_802D7728                         /* constant-address: 802D7728, symbol: lbl_802D7728 */
...
/* 802D7734  40 82 00 0C */	bne lbl_802D7740                         /* constant-address: 802D7740, symbol: lbl_802D7740 */
/* 802D7738  38 E0 00 00 */	li r7, 0                                
/* 802D773C  48 00 00 18 */	b lbl_802D7754                           /* constant-address: 802D7754, symbol: lbl_802D7754 */
lbl_802D7740:
/* 802D7740  54 80 06 31 */	rlwinm. r0, r4, 0, 0x18, 0x18           
/* 802D7744  41 82 00 0C */	beq lbl_802D7750                         /* constant-address: 802D7750, symbol: lbl_802D7750 */
/* 802D7748  38 E0 00 02 */	li r7, 2                                
/* 802D774C  48 00 00 08 */	b lbl_802D7754                           /* constant-address: 802D7754, symbol: lbl_802D7754 */
lbl_802D7750:
/* 802D7750  38 E0 00 01 */	li r7, 1                                
lbl_802D7754:
/* 802D7754  80 1D 00 10 */	lwz r0, 0x10(r29)                       
/* 802D7758  28 00 00 00 */	cmplwi r0, 0                            
/* 802D775C  40 82 00 30 */	bne lbl_802D778C                         /* constant-address: 802D778C, symbol: lbl_802D778C */
...
/* 802D7780  48 00 00 D9 */	bl fetchResource_subroutine__14JKRAramArchiveFUlUlPUcUli /* constant-address: 802D7858, symbol: fetchResource_subroutine__14JKRAramArchiveFUlUlPUcUli */
/* 802D7784  7C 7F 1B 78 */	mr r31, r3                              
/* 802D7788  48 00 00 48 */	b lbl_802D77D0                           /* constant-address: 802D77D0, symbol: lbl_802D77D0 */
lbl_802D778C:
/* 802D778C  2C 07 00 02 */	cmpwi r7, 2                             
/* 802D7790  40 82 00 24 */	bne lbl_802D77B4                         /* constant-address: 802D77B4, symbol: lbl_802D77B4 */
...
/* 802D77AC  41 82 00 08 */	beq lbl_802D77B4                         /* constant-address: 802D77B4, symbol: lbl_802D77B4 */
/* 802D77B0  7C 7F 1B 78 */	mr r31, r3                              
lbl_802D77B4:
/* 802D77B4  7C 1F E0 40 */	cmplw r31, r28                          
/* 802D77B8  40 81 00 08 */	ble lbl_802D77C0                         /* constant-address: 802D77C0, symbol: lbl_802D77C0 */
...
/* 802D77CC  4B FF 73 4D */	bl copyMemory__7JKRHeapFPvPvUl           /* constant-address: 802CEB18, symbol: copyMemory__7JKRHeapFPvPvUl */
lbl_802D77D0:
/* 802D77D0  28 1E 00 00 */	cmplwi r30, 0                           
/* 802D77D4  41 82 00 08 */	beq lbl_802D77DC                         /* constant-address: 802D77DC, symbol: lbl_802D77DC */
/* 802D77D8  93 FE 00 00 */	stw r31, 0(r30)                         
lbl_802D77DC:
/* 802D77DC  7F 63 DB 78 */	mr r3, r27                              
/* 802D77E0  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802D77E4  48 08 AA 3D */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 803351E0  48 02 CF F9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 803351F8  48 00 15 3D */	bl func_80336734                         /* constant-address: 80336734, symbol: func_80336734 */
/* 803351FC  90 7F 00 14 */	stw r3, 0x14(r31)                       
/* 80335200  7F C3 F3 78 */	mr r3, r30                              
/* 80335204  80 9E 00 0C */	lwz r4, 0xc(r30)                        
/* 80335208  48 00 15 15 */	bl func_8033671C                         /* constant-address: 8033671C, symbol: func_8033671C */
/* 8033520C  90 7F 00 18 */	stw r3, 0x18(r31)                       
/* 80335210  7F C3 F3 78 */	mr r3, r30                              
/* 80335214  80 9E 00 10 */	lwz r4, 0x10(r30)                       
/* 80335218  48 00 15 05 */	bl func_8033671C                         /* constant-address: 8033671C, symbol: func_8033671C */
/* 8033521C  90 7F 00 1C */	stw r3, 0x1c(r31)                       
/* 80335220  7F C3 F3 78 */	mr r3, r30                              
/* 80335224  80 9E 00 14 */	lwz r4, 0x14(r30)                       
/* 80335228  48 00 14 F5 */	bl func_8033671C                         /* constant-address: 8033671C, symbol: func_8033671C */
...
/* 80335244  48 00 14 D9 */	bl func_8033671C                         /* constant-address: 8033671C, symbol: func_8033671C */
...
/* 8033525C  41 80 FF DC */	blt lbl_80335238                         /* constant-address: 80335238, symbol: lbl_80335238 */
...
/* 80335274  48 00 14 A9 */	bl func_8033671C                         /* constant-address: 8033671C, symbol: func_8033671C */
...
/* 8033528C  41 80 FF DC */	blt lbl_80335268                         /* constant-address: 80335268, symbol: lbl_80335268 */
/* 80335290  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 80335294  38 80 00 0A */	li r4, 0xa                              
/* 80335298  4B FF FF 0D */	bl getFmtType__FP17_GXVtxAttrFmtList7_GXAttr /* constant-address: 803351A4, symbol: getFmtType__FP17_GXVtxAttrFmtList7_GXAttr */
/* 8033529C  2C 03 00 04 */	cmpwi r3, 4                             
/* 803352A0  38 80 00 06 */	li r4, 6                                
/* 803352A4  40 82 00 08 */	bne lbl_803352AC                         /* constant-address: 803352AC, symbol: lbl_803352AC */
...
/* 803352B8  41 82 00 0C */	beq lbl_803352C4                         /* constant-address: 803352C4, symbol: lbl_803352C4 */
/* 803352BC  7C 03 03 78 */	mr r3, r0                               
/* 803352C0  48 00 00 28 */	b lbl_803352E8                           /* constant-address: 803352E8, symbol: lbl_803352E8 */
lbl_803352C4:
/* 803352C4  80 1F 00 24 */	lwz r0, 0x24(r31)                       
/* 803352C8  28 00 00 00 */	cmplwi r0, 0                            
/* 803352CC  41 82 00 0C */	beq lbl_803352D8                         /* constant-address: 803352D8, symbol: lbl_803352D8 */
/* 803352D0  7C 03 03 78 */	mr r3, r0                               
/* 803352D4  48 00 00 14 */	b lbl_803352E8                           /* constant-address: 803352E8, symbol: lbl_803352E8 */
lbl_803352D8:
/* 803352D8  80 1F 00 2C */	lwz r0, 0x2c(r31)                       
/* 803352DC  28 00 00 00 */	cmplwi r0, 0                            
/* 803352E0  41 82 00 08 */	beq lbl_803352E8                         /* constant-address: 803352E8, symbol: lbl_803352E8 */
/* 803352E4  7C 03 03 78 */	mr r3, r0                               
lbl_803352E8:
/* 803352E8  80 1F 00 1C */	lwz r0, 0x1c(r31)                       
/* 803352EC  28 00 00 00 */	cmplwi r0, 0                            
/* 803352F0  40 82 00 10 */	bne lbl_80335300                         /* constant-address: 80335300, symbol: lbl_80335300 */
/* 803352F4  38 00 00 00 */	li r0, 0                                
/* 803352F8  90 1F 00 04 */	stw r0, 4(r31)                          
/* 803352FC  48 00 00 38 */	b lbl_80335334                           /* constant-address: 80335334, symbol: lbl_80335334 */
lbl_80335300:
/* 80335300  28 03 00 00 */	cmplwi r3, 0                            
/* 80335304  41 82 00 18 */	beq lbl_8033531C                         /* constant-address: 8033531C, symbol: lbl_8033531C */
...
/* 80335318  48 00 00 1C */	b lbl_80335334                           /* constant-address: 80335334, symbol: lbl_80335334 */
lbl_8033531C:
...
/* 80335340  41 82 00 0C */	beq lbl_8033534C                         /* constant-address: 8033534C, symbol: lbl_8033534C */
/* 80335344  7C 03 03 78 */	mr r3, r0                               
/* 80335348  48 00 00 14 */	b lbl_8033535C                           /* constant-address: 8033535C, symbol: lbl_8033535C */
lbl_8033534C:
/* 8033534C  80 1F 00 2C */	lwz r0, 0x2c(r31)                       
/* 80335350  28 00 00 00 */	cmplwi r0, 0                            
/* 80335354  41 82 00 08 */	beq lbl_8033535C                         /* constant-address: 8033535C, symbol: lbl_8033535C */
/* 80335358  7C 03 03 78 */	mr r3, r0                               
lbl_8033535C:
/* 8033535C  80 1F 00 24 */	lwz r0, 0x24(r31)                       
/* 80335360  28 00 00 00 */	cmplwi r0, 0                            
/* 80335364  40 82 00 10 */	bne lbl_80335374                         /* constant-address: 80335374, symbol: lbl_80335374 */
/* 80335368  38 00 00 00 */	li r0, 0                                
/* 8033536C  90 1F 00 08 */	stw r0, 8(r31)                          
/* 80335370  48 00 00 38 */	b lbl_803353A8                           /* constant-address: 803353A8, symbol: lbl_803353A8 */
lbl_80335374:
/* 80335374  28 03 00 00 */	cmplwi r3, 0                            
/* 80335378  41 82 00 18 */	beq lbl_80335390                         /* constant-address: 80335390, symbol: lbl_80335390 */
...
/* 8033538C  48 00 00 1C */	b lbl_803353A8                           /* constant-address: 803353A8, symbol: lbl_803353A8 */
lbl_80335390:
...
/* 803353B0  40 82 00 10 */	bne lbl_803353C0                         /* constant-address: 803353C0, symbol: lbl_803353C0 */
/* 803353B4  38 00 00 00 */	li r0, 0                                
/* 803353B8  90 1F 00 0C */	stw r0, 0xc(r31)                        
/* 803353BC  48 00 00 1C */	b lbl_803353D8                           /* constant-address: 803353D8, symbol: lbl_803353D8 */
lbl_803353C0:
...
/* 803353DC  48 02 CE 49 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

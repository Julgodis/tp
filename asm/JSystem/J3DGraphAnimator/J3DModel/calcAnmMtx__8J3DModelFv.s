...
/* 80327BE8  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 80327BEC  90 C3 00 38 */	stw r6, 0x38(r3)                         /* constant-address: 80434B00, symbol: None */
/* 80327BF0  80 06 00 08 */	lwz r0, 8(r6)                           
/* 80327BF4  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 80327BF8  41 82 00 30 */	beq lbl_80327C28                         /* constant-address: 80327C28, symbol: lbl_80327C28 */
/* 80327BFC  80 66 00 04 */	lwz r3, 4(r6)                           
/* 80327C00  80 86 00 84 */	lwz r4, 0x84(r6)                        
/* 80327C04  3C A0 80 3A */	lis r5, j3dDefaultScale@ha              
/* 80327C08  38 A5 1E 50 */	addi r5, r5, j3dDefaultScale@l           /* constant-address: 803A1E50, symbol: j3dDefaultScale */
/* 80327C0C  3C C0 80 3A */	lis r6, j3dDefaultMtx@ha                
/* 80327C10  38 C6 1E 5C */	addi r6, r6, j3dDefaultMtx@l             /* constant-address: 803A1E5C, symbol: j3dDefaultMtx */
...
/* 80327C24  48 00 00 24 */	b lbl_80327C48                           /* constant-address: 80327C48, symbol: lbl_80327C48 */
lbl_80327C28:

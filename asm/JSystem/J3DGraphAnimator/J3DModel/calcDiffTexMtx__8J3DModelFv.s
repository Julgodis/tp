...
/* 80327868  48 03 A9 65 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 8032786C  7C 7D 1B 78 */	mr r29, r3                              
/* 80327870  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 80327874  3B E3 4A C8 */	addi r31, r3, j3dSys@l                   /* constant-address: 80434AC8, symbol: j3dSys */
/* 80327878  93 BF 00 38 */	stw r29, 0x38(r31)                       /* constant-address: 80434B00, symbol: None */
/* 8032787C  80 7D 00 04 */	lwz r3, 4(r29)                          
/* 80327880  A3 83 00 5C */	lhz r28, 0x5c(r3)                       
/* 80327884  3B C0 00 00 */	li r30, 0                               
/* 80327888  48 00 00 50 */	b lbl_803278D8                           /* constant-address: 803278D8, symbol: lbl_803278D8 */
lbl_8032788C:
/* 8032788C  80 7D 00 C0 */	lwz r3, 0xc0(r29)                       
/* 80327890  57 C0 32 B2 */	rlwinm r0, r30, 6, 0xa, 0x19            
/* 80327894  7C 03 02 14 */	add r0, r3, r0                          
/* 80327898  90 1F 00 3C */	stw r0, 0x3c(r31)                        /* constant-address: 80434B04, symbol: None */
...
/* 803278D4  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_803278D8:
/* 803278D8  57 C0 04 3E */	clrlwi r0, r30, 0x10                    
/* 803278DC  7C 00 E0 40 */	cmplw r0, r28                           
/* 803278E0  41 80 FF AC */	blt lbl_8032788C                         /* constant-address: 8032788C, symbol: lbl_8032788C */
/* 803278E4  80 7D 00 04 */	lwz r3, 4(r29)                          
/* 803278E8  A3 E3 00 7C */	lhz r31, 0x7c(r3)                       
/* 803278EC  3B C0 00 00 */	li r30, 0                               
/* 803278F0  48 00 00 8C */	b lbl_8032797C                           /* constant-address: 8032797C, symbol: lbl_8032797C */
lbl_803278F4:
...
/* 80327920  48 00 00 4C */	b lbl_8032796C                           /* constant-address: 8032796C, symbol: lbl_8032796C */
lbl_80327924:
...
/* 80327948  41 82 00 20 */	beq lbl_80327968                         /* constant-address: 80327968, symbol: lbl_80327968 */
/* 8032794C  28 04 00 00 */	cmplwi r4, 0                            
/* 80327950  41 82 00 18 */	beq lbl_80327968                         /* constant-address: 80327968, symbol: lbl_80327968 */
...
/* 80327964  48 01 EB 4D */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
lbl_80327968:
/* 80327968  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
lbl_8032796C:
/* 8032796C  57 20 04 3E */	clrlwi r0, r25, 0x10                    
/* 80327970  2C 00 00 08 */	cmpwi r0, 8                             
/* 80327974  41 80 FF B0 */	blt lbl_80327924                         /* constant-address: 80327924, symbol: lbl_80327924 */
/* 80327978  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_8032797C:
/* 8032797C  57 C0 04 3E */	clrlwi r0, r30, 0x10                    
/* 80327980  7C 00 F8 40 */	cmplw r0, r31                           
/* 80327984  41 80 FF 70 */	blt lbl_803278F4                         /* constant-address: 803278F4, symbol: lbl_803278F4 */
/* 80327988  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8032798C  48 03 A8 8D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 8032BADC  40 80 00 0C */	bge lbl_8032BAE8                         /* constant-address: 8032BAE8, symbol: lbl_8032BAE8 */
/* 8032BAE0  C0 24 00 04 */	lfs f1, 4(r4)                           
/* 8032BAE4  4E 80 00 20 */	blr                                     
lbl_8032BAE8:
/* 8032BAE8  A0 03 00 04 */	lhz r0, 4(r3)                           
/* 8032BAEC  28 00 00 00 */	cmplwi r0, 0                            
/* 8032BAF0  40 82 00 B4 */	bne lbl_8032BBA4                         /* constant-address: 8032BBA4, symbol: lbl_8032BBA4 */
...
/* 8032BB0C  40 82 00 40 */	bne lbl_8032BB4C                         /* constant-address: 8032BB4C, symbol: lbl_8032BB4C */
/* 8032BB10  7C 64 02 14 */	add r3, r4, r0                          
/* 8032BB14  C0 23 00 04 */	lfs f1, 4(r3)                           
/* 8032BB18  4E 80 00 20 */	blr                                     
/* 8032BB1C  48 00 00 30 */	b lbl_8032BB4C                           /* constant-address: 8032BB4C, symbol: lbl_8032BB4C */
lbl_8032BB20:
...
/* 8032BB38  40 82 00 10 */	bne lbl_8032BB48                         /* constant-address: 8032BB48, symbol: lbl_8032BB48 */
/* 8032BB3C  7C 84 02 14 */	add r4, r4, r0                          
/* 8032BB40  7C 65 18 50 */	subf r3, r5, r3                         
/* 8032BB44  48 00 00 08 */	b lbl_8032BB4C                           /* constant-address: 8032BB4C, symbol: lbl_8032BB4C */
lbl_8032BB48:
/* 8032BB48  7C A3 2B 78 */	mr r3, r5                               
lbl_8032BB4C:
/* 8032BB4C  28 03 00 01 */	cmplwi r3, 1                            
/* 8032BB50  41 81 FF D0 */	bgt lbl_8032BB20                         /* constant-address: 8032BB20, symbol: lbl_8032BB20 */
...
/* 8032BBBC  40 82 00 3C */	bne lbl_8032BBF8                         /* constant-address: 8032BBF8, symbol: lbl_8032BBF8 */
/* 8032BBC0  7C 64 02 14 */	add r3, r4, r0                          
/* 8032BBC4  C0 23 00 04 */	lfs f1, 4(r3)                           
/* 8032BBC8  4E 80 00 20 */	blr                                     
/* 8032BBCC  48 00 00 2C */	b lbl_8032BBF8                           /* constant-address: 8032BBF8, symbol: lbl_8032BBF8 */
lbl_8032BBD0:
...
/* 8032BBE4  40 82 00 10 */	bne lbl_8032BBF4                         /* constant-address: 8032BBF4, symbol: lbl_8032BBF4 */
/* 8032BBE8  7C 84 02 14 */	add r4, r4, r0                          
/* 8032BBEC  7C 65 18 50 */	subf r3, r5, r3                         
/* 8032BBF0  48 00 00 08 */	b lbl_8032BBF8                           /* constant-address: 8032BBF8, symbol: lbl_8032BBF8 */
lbl_8032BBF4:
/* 8032BBF4  7C A3 2B 78 */	mr r3, r5                               
lbl_8032BBF8:
/* 8032BBF8  28 03 00 01 */	cmplwi r3, 1                            
/* 8032BBFC  41 81 FF D4 */	bgt lbl_8032BBD0                         /* constant-address: 8032BBD0, symbol: lbl_8032BBD0 */

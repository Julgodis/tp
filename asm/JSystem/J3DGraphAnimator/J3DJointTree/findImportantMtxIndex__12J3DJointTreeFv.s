...
/* 80325C20  48 00 00 18 */	b lbl_80325C38                           /* constant-address: 80325C38, symbol: lbl_80325C38 */
lbl_80325C24:
...
/* 80325C34  39 8C 00 01 */	addi r12, r12, 1                         /* constant-address: 00000001 */
lbl_80325C38:
/* 80325C38  55 86 04 3E */	clrlwi r6, r12, 0x10                    
/* 80325C3C  7C 06 00 40 */	cmplw r6, r0                            
/* 80325C40  41 80 FF E4 */	blt lbl_80325C24                         /* constant-address: 80325C24, symbol: lbl_80325C24 */
/* 80325C44  39 60 00 00 */	li r11, 0                               
/* 80325C48  48 00 00 58 */	b lbl_80325CA0                           /* constant-address: 80325CA0, symbol: lbl_80325CA0 */
lbl_80325C4C:
...
/* 80325C5C  C0 22 CA 18 */	lfs f1, lit_903(r2)                      /* constant-address: 80456418, symbol: lit_903 */
/* 80325C60  7C 09 03 A6 */	mtctr r0                                
/* 80325C64  2C 00 00 00 */	cmpwi r0, 0                             
/* 80325C68  40 81 00 24 */	ble lbl_80325C8C                         /* constant-address: 80325C8C, symbol: lbl_80325C8C */
lbl_80325C6C:
/* 80325C6C  7C 09 2C 2E */	lfsx f0, r9, r5                         
/* 80325C70  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80325C74  40 80 00 0C */	bge lbl_80325C80                         /* constant-address: 80325C80, symbol: lbl_80325C80 */
...
/* 80325C88  42 00 FF E4 */	bdnz lbl_80325C6C                        /* constant-address: 80325C6C, symbol: lbl_80325C6C */
lbl_80325C8C:
...
/* 80325C9C  39 6B 00 01 */	addi r11, r11, 1                         /* constant-address: 00000001 */
lbl_80325CA0:
/* 80325CA0  7C 0B 38 00 */	cmpw r11, r7                            
/* 80325CA4  41 80 FF A8 */	blt lbl_80325C4C                         /* constant-address: 80325C4C, symbol: lbl_80325C4C */

...
/* 8032F1A4  38 84 1E 30 */	addi r4, r4, j3dDefaultTransformInfo@l   /* constant-address: 803A1E30, symbol: j3dDefaultTransformInfo */
/* 8032F1A8  38 A4 FF FC */	addi r5, r4, -4                          /* constant-address: 803A1E2C, symbol: None */
...
/* 8032F1C4  42 00 FF F0 */	bdnz lbl_8032F1B4                        /* constant-address: 8032F1B4, symbol: lbl_8032F1B4 */
/* 8032F1C8  C0 02 CA A4 */	lfs f0, lit_1220(r2)                     /* constant-address: 804564A4, symbol: lit_1220 */
...
/* 8032F1E0  38 A4 20 80 */	addi r5, r4, lit_1257@l                  /* constant-address: 803A2080, symbol: lit_1257 */
/* 8032F1E4  80 85 00 00 */	lwz r4, 0(r5)                            /* constant-address: 803A2080, symbol: lit_1257 */
/* 8032F1E8  80 05 00 04 */	lwz r0, 4(r5)                            /* constant-address: 803A2084, symbol: None */
/* 8032F1EC  90 81 00 14 */	stw r4, 0x14(r1)                        
/* 8032F1F0  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 8032F1F4  80 05 00 08 */	lwz r0, 8(r5)                            /* constant-address: 803A2088, symbol: None */
...
/* 8032F218  38 A4 20 8C */	addi r5, r4, lit_1259@l                  /* constant-address: 803A208C, symbol: lit_1259 */
/* 8032F21C  80 85 00 00 */	lwz r4, 0(r5)                            /* constant-address: 803A208C, symbol: lit_1259 */
/* 8032F220  80 05 00 04 */	lwz r0, 4(r5)                            /* constant-address: 803A2090, symbol: None */
/* 8032F224  90 81 00 08 */	stw r4, 8(r1)                           
/* 8032F228  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 8032F22C  80 05 00 08 */	lwz r0, 8(r5)                            /* constant-address: 803A2094, symbol: None */

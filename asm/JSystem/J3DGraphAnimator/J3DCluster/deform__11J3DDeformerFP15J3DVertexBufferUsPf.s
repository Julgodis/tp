...
/* 8032EAC4  48 03 37 11 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8032EADC  41 82 00 D8 */	beq lbl_8032EBB4                         /* constant-address: 8032EBB4, symbol: lbl_8032EBB4 */
/* 8032EAE0  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 8032EAE4  80 03 00 50 */	lwz r0, 0x50(r3)                        
/* 8032EAE8  2C 00 00 04 */	cmpwi r0, 4                             
/* 8032EAEC  40 82 00 C8 */	bne lbl_8032EBB4                         /* constant-address: 8032EBB4, symbol: lbl_8032EBB4 */
...
/* 8032EB0C  48 00 00 24 */	b lbl_8032EB30                           /* constant-address: 8032EB30, symbol: lbl_8032EB30 */
lbl_8032EB10:
...
/* 8032EB2C  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000001 */
lbl_8032EB30:
/* 8032EB30  55 00 04 3E */	clrlwi r0, r8, 0x10                     
/* 8032EB34  7C 00 20 40 */	cmplw r0, r4                            
/* 8032EB38  41 80 FF D8 */	blt lbl_8032EB10                         /* constant-address: 8032EB10, symbol: lbl_8032EB10 */
...
/* 8032EB58  48 00 00 75 */	bl normalizeWeight__11J3DDeformerFiPf    /* constant-address: 8032EBCC, symbol: normalizeWeight__11J3DDeformerFiPf */
...
/* 8032EB70  4B FF F9 35 */	bl deform_VtxPosF32__11J3DDeformerFP15J3DVertexBufferP10J3DClusterP13J3DClusterKeyPf /* constant-address: 8032E4A4, symbol: deform_VtxPosF32__11J3DDeformerFP15J3DVertexBufferP10J3DClusterP13J3DClusterKeyPf */
/* 8032EB74  80 1D 00 10 */	lwz r0, 0x10(r29)                       
/* 8032EB78  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 8032EB7C  41 82 00 38 */	beq lbl_8032EBB4                         /* constant-address: 8032EBB4, symbol: lbl_8032EBB4 */
/* 8032EB80  88 1C 00 0C */	lbz r0, 0xc(r28)                        
/* 8032EB84  28 00 00 00 */	cmplwi r0, 0                            
/* 8032EB88  41 82 00 2C */	beq lbl_8032EBB4                         /* constant-address: 8032EBB4, symbol: lbl_8032EBB4 */
/* 8032EB8C  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 8032EB90  80 03 00 58 */	lwz r0, 0x58(r3)                        
/* 8032EB94  2C 00 00 04 */	cmpwi r0, 4                             
/* 8032EB98  40 82 00 1C */	bne lbl_8032EBB4                         /* constant-address: 8032EBB4, symbol: lbl_8032EBB4 */
...
/* 8032EBB0  4B FF FA 5D */	bl deform_VtxNrmF32__11J3DDeformerFP15J3DVertexBufferP10J3DClusterP13J3DClusterKeyPf /* constant-address: 8032E60C, symbol: deform_VtxNrmF32__11J3DDeformerFP15J3DVertexBufferP10J3DClusterP13J3DClusterKeyPf */
lbl_8032EBB4:
/* 8032EBB4  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8032EBB8  48 03 36 69 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

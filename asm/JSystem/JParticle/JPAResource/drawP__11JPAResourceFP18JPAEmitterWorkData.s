...
/* 80275B84  48 0E C6 51 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 80275BE8  40 82 00 18 */	bne lbl_80275C00                         /* constant-address: 80275C00, symbol: lbl_80275C00 */
/* 80275BEC  C0 3F 01 44 */	lfs f1, 0x144(r31)                      
/* 80275BF0  C0 02 B8 90 */	lfs f0, lit_3189(r2)                     /* constant-address: 80455290, symbol: lit_3189 */
/* 80275BF4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 80275BF8  D0 1F 01 44 */	stfs f0, 0x144(r31)                     
/* 80275BFC  48 00 00 2C */	b lbl_80275C28                           /* constant-address: 80275C28, symbol: lbl_80275C28 */
lbl_80275C00:
/* 80275C00  28 00 00 01 */	cmplwi r0, 1                            
/* 80275C04  40 82 00 24 */	bne lbl_80275C28                         /* constant-address: 80275C28, symbol: lbl_80275C28 */
/* 80275C08  C0 3F 01 44 */	lfs f1, 0x144(r31)                      
/* 80275C0C  C0 02 B8 90 */	lfs f0, lit_3189(r2)                     /* constant-address: 80455290, symbol: lit_3189 */
/* 80275C10  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 80275C14  D0 1F 01 44 */	stfs f0, 0x144(r31)                     
/* 80275C18  C0 3F 01 48 */	lfs f1, 0x148(r31)                      
/* 80275C1C  C0 02 B8 94 */	lfs f0, lit_3190(r2)                     /* constant-address: 80455294, symbol: lit_3190 */
...
/* 80275C30  41 82 00 68 */	beq lbl_80275C98                         /* constant-address: 80275C98, symbol: lbl_80275C98 */
/* 80275C34  80 63 00 00 */	lwz r3, 0(r3)                           
/* 80275C38  80 63 00 08 */	lwz r3, 8(r3)                           
/* 80275C3C  54 60 07 FF */	clrlwi. r0, r3, 0x1f                    
/* 80275C40  41 82 00 58 */	beq lbl_80275C98                         /* constant-address: 80275C98, symbol: lbl_80275C98 */
/* 80275C44  54 60 A7 BE */	rlwinm r0, r3, 0x14, 0x1e, 0x1f         
/* 80275C48  C8 42 B8 A0 */	lfd f2, lit_3194(r2)                     /* constant-address: 804552A0, symbol: lit_3194 */
...
/* 80275C60  C0 22 B8 98 */	lfs f1, lit_3191(r2)                     /* constant-address: 80455298, symbol: lit_3191 */
...
/* 80275C94  48 00 00 10 */	b lbl_80275CA4                           /* constant-address: 80275CA4, symbol: lbl_80275CA4 */
lbl_80275C98:
/* 80275C98  C0 02 B8 9C */	lfs f0, lit_3192(r2)                     /* constant-address: 8045529C, symbol: lit_3192 */
...
/* 80275CE4  41 82 00 10 */	beq lbl_80275CF4                         /* constant-address: 80275CF4, symbol: lbl_80275CF4 */
/* 80275CE8  28 00 00 08 */	cmplwi r0, 8                            
/* 80275CEC  41 82 00 08 */	beq lbl_80275CF4                         /* constant-address: 80275CF4, symbol: lbl_80275CF4 */
...
/* 80275D04  41 82 00 0C */	beq lbl_80275D10                         /* constant-address: 80275D10, symbol: lbl_80275D10 */
/* 80275D08  38 00 00 02 */	li r0, 2                                
/* 80275D0C  48 00 00 14 */	b lbl_80275D20                           /* constant-address: 80275D20, symbol: lbl_80275D20 */
lbl_80275D10:
...
/* 80275D34  41 82 00 10 */	beq lbl_80275D44                         /* constant-address: 80275D44, symbol: lbl_80275D44 */
/* 80275D38  54 63 47 FE */	rlwinm r3, r3, 8, 0x1f, 0x1f            
/* 80275D3C  38 03 00 01 */	addi r0, r3, 1                          
/* 80275D40  48 00 00 08 */	b lbl_80275D48                           /* constant-address: 80275D48, symbol: lbl_80275D48 */
lbl_80275D44:
...
/* 80275D5C  48 00 04 4D */	bl setPTev__11JPAResourceFv              /* constant-address: 802761A8, symbol: setPTev__11JPAResourceFv */
/* 80275D60  88 7E 00 42 */	lbz r3, 0x42(r30)                       
/* 80275D64  3B 83 FF FF */	addi r28, r3, -1                        
/* 80275D68  57 9D 10 3A */	slwi r29, r28, 2                        
/* 80275D6C  48 00 00 20 */	b lbl_80275D8C                           /* constant-address: 80275D8C, symbol: lbl_80275D8C */
lbl_80275D70:
...
/* 80275D90  40 80 FF E0 */	bge lbl_80275D70                         /* constant-address: 80275D70, symbol: lbl_80275D70 */
...
/* 80275DA4  41 82 00 68 */	beq lbl_80275E0C                         /* constant-address: 80275E0C, symbol: lbl_80275E0C */
/* 80275DA8  80 7F 00 00 */	lwz r3, 0(r31)                          
/* 80275DAC  83 83 00 CC */	lwz r28, 0xcc(r3)                       
/* 80275DB0  48 00 00 50 */	b lbl_80275E00                           /* constant-address: 80275E00, symbol: lbl_80275E00 */
lbl_80275DB4:
/* 80275DB4  93 9F 01 E8 */	stw r28, 0x1e8(r31)                     
/* 80275DB8  80 1E 00 10 */	lwz r0, 0x10(r30)                       
/* 80275DBC  28 00 00 00 */	cmplwi r0, 0                            
/* 80275DC0  41 82 00 3C */	beq lbl_80275DFC                         /* constant-address: 80275DFC, symbol: lbl_80275DFC */
/* 80275DC4  88 7E 00 45 */	lbz r3, 0x45(r30)                       
/* 80275DC8  3B 63 FF FF */	addi r27, r3, -1                        
/* 80275DCC  57 7D 10 3A */	slwi r29, r27, 2                        
/* 80275DD0  48 00 00 24 */	b lbl_80275DF4                           /* constant-address: 80275DF4, symbol: lbl_80275DF4 */
lbl_80275DD4:
...
/* 80275DF8  40 80 FF DC */	bge lbl_80275DD4                         /* constant-address: 80275DD4, symbol: lbl_80275DD4 */
lbl_80275DFC:
/* 80275DFC  83 9C 00 00 */	lwz r28, 0(r28)                         
lbl_80275E00:
/* 80275E00  28 1C 00 00 */	cmplwi r28, 0                           
/* 80275E04  40 82 FF B0 */	bne lbl_80275DB4                         /* constant-address: 80275DB4, symbol: lbl_80275DB4 */
/* 80275E08  48 00 00 64 */	b lbl_80275E6C                           /* constant-address: 80275E6C, symbol: lbl_80275E6C */
lbl_80275E0C:
/* 80275E0C  80 7F 00 00 */	lwz r3, 0(r31)                          
/* 80275E10  83 63 00 C8 */	lwz r27, 0xc8(r3)                       
/* 80275E14  48 00 00 50 */	b lbl_80275E64                           /* constant-address: 80275E64, symbol: lbl_80275E64 */
lbl_80275E18:
/* 80275E18  93 7F 01 E8 */	stw r27, 0x1e8(r31)                     
/* 80275E1C  80 1E 00 10 */	lwz r0, 0x10(r30)                       
/* 80275E20  28 00 00 00 */	cmplwi r0, 0                            
/* 80275E24  41 82 00 3C */	beq lbl_80275E60                         /* constant-address: 80275E60, symbol: lbl_80275E60 */
/* 80275E28  88 7E 00 45 */	lbz r3, 0x45(r30)                       
/* 80275E2C  3B 83 FF FF */	addi r28, r3, -1                        
/* 80275E30  57 9D 10 3A */	slwi r29, r28, 2                        
/* 80275E34  48 00 00 24 */	b lbl_80275E58                           /* constant-address: 80275E58, symbol: lbl_80275E58 */
lbl_80275E38:
...
/* 80275E5C  40 80 FF DC */	bge lbl_80275E38                         /* constant-address: 80275E38, symbol: lbl_80275E38 */
lbl_80275E60:
/* 80275E60  83 7B 00 04 */	lwz r27, 4(r27)                         
lbl_80275E64:
/* 80275E64  28 1B 00 00 */	cmplwi r27, 0                           
/* 80275E68  40 82 FF B0 */	bne lbl_80275E18                         /* constant-address: 80275E18, symbol: lbl_80275E18 */
lbl_80275E6C:
/* 80275E6C  38 60 00 01 */	li r3, 1                                
/* 80275E70  38 80 00 00 */	li r4, 0                                
/* 80275E74  48 0E 5F C5 */	bl GXSetMisc                             /* constant-address: 8035BE38, symbol: GXSetMisc */
/* 80275E78  80 9F 00 00 */	lwz r4, 0(r31)                          
/* 80275E7C  80 64 00 EC */	lwz r3, 0xec(r4)                        
/* 80275E80  28 03 00 00 */	cmplwi r3, 0                            
/* 80275E84  41 82 00 14 */	beq lbl_80275E98                         /* constant-address: 80275E98, symbol: lbl_80275E98 */
...
/* 80275E9C  48 0E C3 85 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

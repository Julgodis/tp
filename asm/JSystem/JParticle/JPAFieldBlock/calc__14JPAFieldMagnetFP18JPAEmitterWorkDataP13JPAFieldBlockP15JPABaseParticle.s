...
/* 8027C2E0  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C2E4  3C 80 80 45 */	lis r4, __float_epsilon@ha              
/* 8027C2E8  C0 04 0A EC */	lfs f0, __float_epsilon@l(r4)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C2EC  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C2F0  FC 06 00 40 */	fcmpo cr0, f6, f0                       
/* 8027C2F4  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C2F8  41 82 00 58 */	beq lbl_8027C350                         /* constant-address: 8027C350, symbol: lbl_8027C350 */
/* 8027C2FC  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C300  FC 06 00 40 */	fcmpo cr0, f6, f0                       
/* 8027C304  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C308  40 82 00 08 */	bne lbl_8027C310                         /* constant-address: 8027C310, symbol: lbl_8027C310 */
/* 8027C30C  48 00 00 28 */	b lbl_8027C334                           /* constant-address: 8027C334, symbol: lbl_8027C334 */
lbl_8027C310:
/* 8027C310  FC 60 30 34 */	frsqrte f3, f6                          
/* 8027C314  FC 60 18 18 */	frsp f3, f3                             
/* 8027C318  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C31C  EC 40 00 F2 */	fmuls f2, f0, f3                        
/* 8027C320  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C358  4B FF FA 95 */	bl calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle /* constant-address: 8027BDEC, symbol: calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle */

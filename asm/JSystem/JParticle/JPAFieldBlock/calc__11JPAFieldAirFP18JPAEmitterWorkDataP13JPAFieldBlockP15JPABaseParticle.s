...
/* 8027C1E4  4B FF FC 09 */	bl calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle /* constant-address: 8027BDEC, symbol: calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle */
/* 8027C1E8  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 8027C1EC  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8027C1F0  54 00 87 7B */	rlwinm. r0, r0, 0x10, 0x1d, 0x1d        
/* 8027C1F4  41 82 00 38 */	beq lbl_8027C22C                         /* constant-address: 8027C22C, symbol: lbl_8027C22C */
/* 8027C1F8  38 7F 00 30 */	addi r3, r31, 0x30                      
/* 8027C1FC  48 0C AF 55 */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
/* 8027C200  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 8027C204  C0 03 00 28 */	lfs f0, 0x28(r3)                        
/* 8027C208  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8027C20C  40 81 00 20 */	ble lbl_8027C22C                         /* constant-address: 8027C22C, symbol: lbl_8027C22C */

...
/* 8027C854  48 0E 59 89 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8027C870  48 0C A9 45 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8027C874  38 7F 00 1C */	addi r3, r31, 0x1c                      
/* 8027C878  38 81 00 08 */	addi r4, r1, 8                          
/* 8027C87C  38 A1 00 14 */	addi r5, r1, 0x14                       
/* 8027C880  48 0C A9 35 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8027C884  38 7E 00 A8 */	addi r3, r30, 0xa8                      
/* 8027C888  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8027C88C  38 BD 00 10 */	addi r5, r29, 0x10                      
/* 8027C890  48 0C A5 BD */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
/* 8027C894  38 7E 00 A8 */	addi r3, r30, 0xa8                      
/* 8027C898  38 9F 00 1C */	addi r4, r31, 0x1c                      
/* 8027C89C  38 BD 00 1C */	addi r5, r29, 0x1c                      
/* 8027C8A0  48 0C A5 AD */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
/* 8027C8A4  38 7E 00 A8 */	addi r3, r30, 0xa8                      
/* 8027C8A8  38 81 00 08 */	addi r4, r1, 8                          
/* 8027C8AC  38 BD 00 28 */	addi r5, r29, 0x28                      
/* 8027C8B0  48 0C A5 9D */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
...
/* 8027C8C8  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C8CC  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8027C8D0  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C8D4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C8D8  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C8DC  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C8E0  41 82 00 5C */	beq lbl_8027C93C                         /* constant-address: 8027C93C, symbol: lbl_8027C93C */
/* 8027C8E4  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C8E8  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C8EC  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C8F0  40 82 00 0C */	bne lbl_8027C8FC                         /* constant-address: 8027C8FC, symbol: lbl_8027C8FC */
/* 8027C8F4  FF 60 20 90 */	fmr f27, f4                             
/* 8027C8F8  48 00 00 2C */	b lbl_8027C924                           /* constant-address: 8027C924, symbol: lbl_8027C924 */
lbl_8027C8FC:
/* 8027C8FC  FC 60 20 34 */	frsqrte f3, f4                          
/* 8027C900  FC 60 18 18 */	frsp f3, f3                             
/* 8027C904  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C908  EC 40 00 F2 */	fmuls f2, f0, f3                        
/* 8027C90C  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C950  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C954  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8027C958  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C95C  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C960  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C964  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C968  41 82 00 5C */	beq lbl_8027C9C4                         /* constant-address: 8027C9C4, symbol: lbl_8027C9C4 */
/* 8027C96C  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C970  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C974  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C978  40 82 00 0C */	bne lbl_8027C984                         /* constant-address: 8027C984, symbol: lbl_8027C984 */
/* 8027C97C  FF E0 20 90 */	fmr f31, f4                             
/* 8027C980  48 00 00 2C */	b lbl_8027C9AC                           /* constant-address: 8027C9AC, symbol: lbl_8027C9AC */
lbl_8027C984:
/* 8027C984  FC 60 20 34 */	frsqrte f3, f4                          
/* 8027C988  FC 60 18 18 */	frsp f3, f3                             
/* 8027C98C  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C990  EC 40 00 F2 */	fmuls f2, f0, f3                        
/* 8027C994  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C9D8  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C9DC  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8027C9E0  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C9E4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C9E8  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C9EC  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C9F0  41 82 00 5C */	beq lbl_8027CA4C                         /* constant-address: 8027CA4C, symbol: lbl_8027CA4C */
/* 8027C9F4  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C9F8  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C9FC  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027CA00  40 82 00 0C */	bne lbl_8027CA0C                         /* constant-address: 8027CA0C, symbol: lbl_8027CA0C */
/* 8027CA04  FF C0 20 90 */	fmr f30, f4                             
/* 8027CA08  48 00 00 2C */	b lbl_8027CA34                           /* constant-address: 8027CA34, symbol: lbl_8027CA34 */
lbl_8027CA0C:
/* 8027CA0C  FC 60 20 34 */	frsqrte f3, f4                          
/* 8027CA10  FC 60 18 18 */	frsp f3, f3                             
/* 8027CA14  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027CA18  EC 40 00 F2 */	fmuls f2, f0, f3                        
/* 8027CA1C  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027CA80  48 0E 57 A9 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 8027C5A4  48 0C A8 A9 */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
...
/* 8027C5BC  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C5C0  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8027C5C4  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C5C8  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C5CC  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C5D0  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C5D4  41 82 00 5C */	beq lbl_8027C630                         /* constant-address: 8027C630, symbol: lbl_8027C630 */
/* 8027C5D8  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C5DC  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8027C5E0  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C5E4  40 82 00 0C */	bne lbl_8027C5F0                         /* constant-address: 8027C5F0, symbol: lbl_8027C5F0 */
/* 8027C5E8  FF E0 20 90 */	fmr f31, f4                             
/* 8027C5EC  48 00 00 2C */	b lbl_8027C618                           /* constant-address: 8027C618, symbol: lbl_8027C618 */
lbl_8027C5F0:
/* 8027C5F0  FC 60 20 34 */	frsqrte f3, f4                          
/* 8027C5F4  FC 60 18 18 */	frsp f3, f3                             
/* 8027C5F8  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C5FC  EC 40 00 F2 */	fmuls f2, f0, f3                        
/* 8027C600  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C63C  C0 22 B9 38 */	lfs f1, lit_2353(r2)                     /* constant-address: 80455338, symbol: lit_2353 */

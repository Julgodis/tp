...
/* 8027C68C  48 0E 5B 51 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8027C6FC  40 81 00 10 */	ble lbl_8027C70C                         /* constant-address: 8027C70C, symbol: lbl_8027C70C */
/* 8027C700  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 8027C704  C3 E3 00 28 */	lfs f31, 0x28(r3)                       
/* 8027C708  48 00 00 2C */	b lbl_8027C734                           /* constant-address: 8027C734, symbol: lbl_8027C734 */
lbl_8027C70C:
/* 8027C70C  C0 1D 00 20 */	lfs f0, 0x20(r29)                       
/* 8027C710  EF FF 00 32 */	fmuls f31, f31, f0                      
/* 8027C714  C0 02 B9 38 */	lfs f0, lit_2353(r2)                     /* constant-address: 80455338, symbol: lit_2353 */
...
/* 8027C748  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C74C  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8027C750  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C754  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C758  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 8027C75C  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C760  41 82 00 5C */	beq lbl_8027C7BC                         /* constant-address: 8027C7BC, symbol: lbl_8027C7BC */
/* 8027C764  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C768  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 8027C76C  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C770  40 82 00 0C */	bne lbl_8027C77C                         /* constant-address: 8027C77C, symbol: lbl_8027C77C */
/* 8027C774  FC 80 28 90 */	fmr f4, f5                              
/* 8027C778  48 00 00 2C */	b lbl_8027C7A4                           /* constant-address: 8027C7A4, symbol: lbl_8027C7A4 */
lbl_8027C77C:
/* 8027C77C  FC 60 28 34 */	frsqrte f3, f5                          
/* 8027C780  FC 60 18 18 */	frsp f3, f3                             
/* 8027C784  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C788  EC 40 00 F2 */	fmuls f2, f0, f3                        
/* 8027C78C  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C7C8  48 0C A9 ED */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
...
/* 8027C7F0  4B FF F5 FD */	bl calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle /* constant-address: 8027BDEC, symbol: calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle */
/* 8027C7F4  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */       
/* 8027C7F8  CB E1 00 30 */	lfd f31, 0x30(r1)                       
/* 8027C7FC  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8027C800  48 0E 5A 29 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

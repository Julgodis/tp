...
/* 8027C0B4  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C0B8  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8027C0BC  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C0C0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C0C4  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 8027C0C8  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C0CC  40 82 00 18 */	bne lbl_8027C0E4                         /* constant-address: 8027C0E4, symbol: lbl_8027C0E4 */
/* 8027C0D0  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C0D4  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 8027C0D8  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 8027C0DC  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 8027C0E0  48 00 00 5C */	b lbl_8027C13C                           /* constant-address: 8027C13C, symbol: lbl_8027C13C */
lbl_8027C0E4:
/* 8027C0E4  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C0E8  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 8027C0EC  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C0F0  40 82 00 0C */	bne lbl_8027C0FC                         /* constant-address: 8027C0FC, symbol: lbl_8027C0FC */
/* 8027C0F4  FC 60 28 90 */	fmr f3, f5                              
/* 8027C0F8  48 00 00 2C */	b lbl_8027C124                           /* constant-address: 8027C124, symbol: lbl_8027C124 */
lbl_8027C0FC:
/* 8027C0FC  FC 80 28 34 */	frsqrte f4, f5                          
/* 8027C100  FC 80 20 18 */	frsp f4, f4                             
/* 8027C104  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C108  EC 40 01 32 */	fmuls f2, f0, f4                        
/* 8027C10C  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C148  41 82 00 24 */	beq lbl_8027C16C                         /* constant-address: 8027C16C, symbol: lbl_8027C16C */
...
/* 8027C168  48 00 00 30 */	b lbl_8027C198                           /* constant-address: 8027C198, symbol: lbl_8027C198 */
lbl_8027C16C:
/* 8027C16C  38 64 00 78 */	addi r3, r4, 0x78                       
/* 8027C170  38 81 00 08 */	addi r4, r1, 8                          
/* 8027C174  38 BE 00 04 */	addi r5, r30, 4                         
/* 8027C178  48 0C AC D5 */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */

...
/* 8027C428  40 81 00 9C */	ble lbl_8027C4C4                         /* constant-address: 8027C4C4, symbol: lbl_8027C4C4 */
/* 8027C42C  C0 22 B9 4C */	lfs f1, lit_2656(r2)                     /* constant-address: 8045534C, symbol: lit_2656 */
...
/* 8027C450  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C454  3C 80 80 45 */	lis r4, __float_epsilon@ha              
/* 8027C458  C0 04 0A EC */	lfs f0, __float_epsilon@l(r4)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C45C  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C460  FC 06 00 40 */	fcmpo cr0, f6, f0                       
/* 8027C464  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C468  41 82 00 E8 */	beq lbl_8027C550                         /* constant-address: 8027C550, symbol: lbl_8027C550 */
/* 8027C46C  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C470  FC 06 00 40 */	fcmpo cr0, f6, f0                       
/* 8027C474  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C478  40 82 00 08 */	bne lbl_8027C480                         /* constant-address: 8027C480, symbol: lbl_8027C480 */
/* 8027C47C  48 00 00 28 */	b lbl_8027C4A4                           /* constant-address: 8027C4A4, symbol: lbl_8027C4A4 */
lbl_8027C480:
/* 8027C480  FC 80 30 34 */	frsqrte f4, f6                          
/* 8027C484  FC 80 20 18 */	frsp f4, f4                             
/* 8027C488  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C48C  EC 40 01 32 */	fmuls f2, f0, f4                        
/* 8027C490  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C4C0  48 00 00 90 */	b lbl_8027C550                           /* constant-address: 8027C550, symbol: lbl_8027C550 */
lbl_8027C4C4:
/* 8027C4C4  C0 22 B9 4C */	lfs f1, lit_2656(r2)                     /* constant-address: 8045534C, symbol: lit_2656 */
...
/* 8027C4E0  C0 22 B9 40 */	lfs f1, lit_2459(r2)                     /* constant-address: 80455340, symbol: lit_2459 */
/* 8027C4E4  3C 80 80 45 */	lis r4, __float_epsilon@ha              
/* 8027C4E8  C0 04 0A EC */	lfs f0, __float_epsilon@l(r4)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027C4EC  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027C4F0  FC 06 00 40 */	fcmpo cr0, f6, f0                       
/* 8027C4F4  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C4F8  41 82 00 58 */	beq lbl_8027C550                         /* constant-address: 8027C550, symbol: lbl_8027C550 */
/* 8027C4FC  C0 02 B9 3C */	lfs f0, lit_2354(r2)                     /* constant-address: 8045533C, symbol: lit_2354 */
/* 8027C500  FC 06 00 40 */	fcmpo cr0, f6, f0                       
/* 8027C504  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027C508  40 82 00 08 */	bne lbl_8027C510                         /* constant-address: 8027C510, symbol: lbl_8027C510 */
/* 8027C50C  48 00 00 28 */	b lbl_8027C534                           /* constant-address: 8027C534, symbol: lbl_8027C534 */
lbl_8027C510:
/* 8027C510  FC 80 30 34 */	frsqrte f4, f6                          
/* 8027C514  FC 80 20 18 */	frsp f4, f4                             
/* 8027C518  C0 02 B9 44 */	lfs f0, lit_2460(r2)                     /* constant-address: 80455344, symbol: lit_2460 */
/* 8027C51C  EC 40 01 32 */	fmuls f2, f0, f4                        
/* 8027C520  C0 22 B9 48 */	lfs f1, lit_2461(r2)                     /* constant-address: 80455348, symbol: lit_2461 */
...
/* 8027C558  4B FF F8 95 */	bl calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle /* constant-address: 8027BDEC, symbol: calcAffect__12JPAFieldBaseFP13JPAFieldBlockP15JPABaseParticle */

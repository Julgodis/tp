...
/* 8027A7F8  48 0E 79 E1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8027A7FC  7C 7C 1B 78 */	mr r28, r3                              
/* 8027A800  3C 60 80 3C */	lis r3, jpa_dl@ha                       
/* 8027A804  3B E3 42 E0 */	addi r31, r3, jpa_dl@l                   /* constant-address: 803C42E0, symbol: jpa_dl */
/* 8027A808  80 9C 00 00 */	lwz r4, 0(r28)                          
/* 8027A80C  80 64 00 08 */	lwz r3, 8(r4)                           
/* 8027A810  54 60 AE 76 */	rlwinm r0, r3, 0x15, 0x19, 0x1b         
/* 8027A814  3B DF 01 24 */	addi r30, r31, 0x124                     /* constant-address: 803C4404, symbol: st_ca__12JPABaseShape */
/* 8027A818  7F DE 02 14 */	add r30, r30, r0                        
/* 8027A81C  54 60 96 F6 */	rlwinm r0, r3, 0x12, 0x1b, 0x1b         
/* 8027A820  3B BF 01 84 */	addi r29, r31, 0x184                     /* constant-address: 803C4464, symbol: st_aa__12JPABaseShape */
/* 8027A824  7F BD 02 14 */	add r29, r29, r0                        
/* 8027A828  A0 C4 00 18 */	lhz r6, 0x18(r4)                        
/* 8027A82C  54 C0 17 3A */	rlwinm r0, r6, 2, 0x1c, 0x1d            
/* 8027A830  38 7F 00 80 */	addi r3, r31, 0x80                       /* constant-address: 803C4360, symbol: st_bm__12JPABaseShape */
/* 8027A834  7C 63 00 2E */	lwzx r3, r3, r0                         
/* 8027A838  54 C0 06 BA */	rlwinm r0, r6, 0, 0x1a, 0x1d            
/* 8027A83C  38 BF 00 8C */	addi r5, r31, 0x8c                       /* constant-address: 803C436C, symbol: st_bf__12JPABaseShape */
...
/* 8027A850  38 DF 00 B4 */	addi r6, r31, 0xb4                       /* constant-address: 803C4394, symbol: st_lo__12JPABaseShape */
/* 8027A854  7C C6 00 2E */	lwzx r6, r6, r0                         
/* 8027A858  48 0E 53 99 */	bl GXSetBlendMode                        /* constant-address: 8035FBF0, symbol: GXSetBlendMode */
...
/* 8027A86C  38 9F 00 F4 */	addi r4, r31, 0xf4                       /* constant-address: 803C43D4, symbol: st_c__12JPABaseShape */
/* 8027A870  7C 84 00 2E */	lwzx r4, r4, r0                         
/* 8027A874  54 A5 E7 FE */	rlwinm r5, r5, 0x1c, 0x1f, 0x1f         
/* 8027A878  48 0E 54 25 */	bl GXSetZMode                            /* constant-address: 8035FC9C, symbol: GXSetZMode */
/* 8027A87C  80 FC 00 00 */	lwz r7, 0(r28)                          
/* 8027A880  89 07 00 1A */	lbz r8, 0x1a(r7)                        
/* 8027A884  55 00 16 FA */	rlwinm r0, r8, 2, 0x1b, 0x1d            
/* 8027A888  38 DF 00 F4 */	addi r6, r31, 0xf4                       /* constant-address: 803C43D4, symbol: st_c__12JPABaseShape */
/* 8027A88C  7C 66 00 2E */	lwzx r3, r6, r0                         
/* 8027A890  88 87 00 1B */	lbz r4, 0x1b(r7)                        
/* 8027A894  55 00 FF 3A */	rlwinm r0, r8, 0x1f, 0x1c, 0x1d         
/* 8027A898  38 BF 01 14 */	addi r5, r31, 0x114                      /* constant-address: 803C43F4, symbol: st_ao__12JPABaseShape */
...
/* 8027A8AC  48 0E 4D 79 */	bl GXSetAlphaCompare                     /* constant-address: 8035F624, symbol: GXSetAlphaCompare */
...
/* 8027A8C4  48 0E 49 61 */	bl GXSetTevColorIn                       /* constant-address: 8035F224, symbol: GXSetTevColorIn */
...
/* 8027A8DC  48 0E 49 8D */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
/* 8027A8E0  38 60 00 00 */	li r3, 0                                
/* 8027A8E4  48 0E 48 15 */	bl GXSetTevDirect                        /* constant-address: 8035F0F8, symbol: GXSetTevDirect */
/* 8027A8E8  38 60 00 01 */	li r3, 1                                
/* 8027A8EC  48 0E 48 0D */	bl GXSetTevDirect                        /* constant-address: 8035F0F8, symbol: GXSetTevDirect */
/* 8027A8F0  80 7C 00 00 */	lwz r3, 0(r28)                          
/* 8027A8F4  88 03 00 1D */	lbz r0, 0x1d(r3)                        
/* 8027A8F8  54 03 DF FE */	rlwinm r3, r0, 0x1b, 0x1f, 0x1f         
/* 8027A8FC  48 0E 53 D5 */	bl GXSetZCompLoc                         /* constant-address: 8035FCD0, symbol: GXSetZCompLoc */
/* 8027A900  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8027A904  48 0E 79 21 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

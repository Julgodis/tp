...
/* 802789B8 00000000  DB 81 00 D0 */	stfd f28, 0xd0(r1)
/* 802789BC 00000028  F3 81 00 D8 */	psq_st f28, 216(r1), 0, 0 /* qr0 */
/* 802789C0 00000000  DB 61 00 C0 */	stfd f27, 0xc0(r1)
/* 802789C4 00000030  F3 61 00 C8 */	psq_st f27, 200(r1), 0, 0 /* qr0 */
/* 802789C8 00000000  DB 41 00 B0 */	stfd f26, 0xb0(r1)
/* 802789CC 00000004  F3 41 00 B8 */	psq_st f26, 184(r1), 0, 0 /* qr0 */
/* 802789D0 00000008  DB 21 00 A0 */	stfd f25, 0xa0(r1)
/* 802789D4 00000040  F3 21 00 A8 */	psq_st f25, 168(r1), 0, 0 /* qr0 */
/* 802789D8 00000000  DB 01 00 90 */	stfd f24, 0x90(r1)
/* 802789DC 00000048  F3 01 00 98 */	psq_st f24, 152(r1), 0, 0 /* qr0 */
/* 802789E0 00000000  39 61 00 90 */	addi r11, r1, 0x90
/* 802789E4 00000004  48 0E 97 F9 */	bl _savegpr_29
/* 802789E8 00000008  7C 7D 1B 78 */	mr r29, r3
/* 802789EC 0000000C  7C 9E 23 78 */	mr r30, r4
/* 802789F0 00000010  3C A0 80 3C */	lis r5, jpa_dl@ha
/* 802789F4 00000014  3B E5 42 E0 */	addi r31, r5, jpa_dl@l
/* 802789F8 00000018  80 04 00 7C */	lwz r0, 0x7c(r4)
/* 802789FC 0000001C  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c
/* 80278A00 00000020  40 82 03 50 */	bne lbl_80278D50
/* 80278A04 00000024  A0 1E 00 88 */	lhz r0, 0x88(r30)
/* 80278A08 00000028  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80278A0C 0000002C  3C A0 80 44 */	lis r5, sincosTable___5JMath@ha
/* 80278A10 00000030  38 A5 9A 20 */	addi r5, r5, sincosTable___5JMath@l
/* 80278A14 00000034  7F 65 04 2E */	lfsx f27, r5, r0
/* 80278A18 00000038  7C A5 02 14 */	add r5, r5, r0
/* 80278A1C 0000003C  C3 45 00 04 */	lfs f26, 4(r5)
/* 80278A20 00000040  38 A1 00 14 */	addi r5, r1, 0x14
/* 80278A24 00000044  80 1D 02 00 */	lwz r0, 0x200(r29)
/* 80278A28 00000048  54 00 10 3A */	slwi r0, r0, 2
/* 80278A2C 0000004C  38 DF 00 4C */	addi r6, r31, 0x4c
/* 80278A30 00000050  7D 86 00 2E */	lwzx r12, r6, r0
/* 80278A34 00000054  7D 89 03 A6 */	mtctr r12
/* 80278A38 00000058  4E 80 04 21 */	bctrl 
/* 80278A3C 000000A8  E0 01 00 14 */	psq_l f0, 20(r1), 0, 0 /* qr0 */
/* 80278A40 000000AC  10 00 00 32 */	ps_mul f0, f0, f0
/* 80278A44 00000000  C3 01 00 1C */	lfs f24, 0x1c(r1)
/* 80278A48 000000B4  10 58 06 3A */	ps_madd f2, f24, f24, f0
/* 80278A4C 000000B8  10 42 00 14 */	ps_sum0 f2, f2, f0, f0
/* 80278A50 00000000  C0 22 B8 D8 */	lfs f1, lit_3281(r2)
/* 80278A54 00000004  3C 60 80 45 */	lis r3, __float_epsilon@ha
/* 80278A58 00000008  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)
/* 80278A5C 0000000C  EC 01 00 32 */	fmuls f0, f1, f0
/* 80278A60 000000CC  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 80278A64 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278A68 00000004  41 82 02 E8 */	beq lbl_80278D50
...
/* 80278A80 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278A84 00000004  41 82 00 5C */	beq lbl_80278AE0
/* 80278A88 00000008  C0 02 B8 C0 */	lfs f0, lit_2742(r2)
/* 80278A8C 000000F8  FC 04 00 40 */	fcmpo cr0, f4, f0
/* 80278A90 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278A94 00000004  40 82 00 0C */	bne lbl_80278AA0
/* 80278A98 00000008  FF 20 20 90 */	fmr f25, f4
/* 80278A9C 0000000C  48 00 00 2C */	b lbl_80278AC8
lbl_80278AA0:
...
/* 80278AD4 00000000  F0 01 00 14 */	psq_st f0, 20(r1), 0, 0 /* qr0 */
...
/* 80278AF8 00000000  C3 A1 00 10 */	lfs f29, 0x10(r1)
/* 80278AFC 0000001C  10 5D 07 7A */	ps_madd f2, f29, f29, f0
/* 80278B00 00000020  10 42 00 14 */	ps_sum0 f2, f2, f0, f0
/* 80278B04 00000000  C0 22 B8 D8 */	lfs f1, lit_3281(r2)
/* 80278B08 00000004  3C 60 80 45 */	lis r3, __float_epsilon@ha
/* 80278B0C 00000008  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)
/* 80278B10 0000000C  EC 01 00 32 */	fmuls f0, f1, f0
/* 80278B14 00000034  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 80278B18 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278B1C 00000004  41 82 02 34 */	beq lbl_80278D50
...
/* 80278B34 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278B38 00000004  41 82 00 5C */	beq lbl_80278B94
/* 80278B3C 00000008  C0 02 B8 C0 */	lfs f0, lit_2742(r2)
/* 80278B40 00000060  FC 04 00 40 */	fcmpo cr0, f4, f0
/* 80278B44 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278B48 00000004  40 82 00 0C */	bne lbl_80278B54
/* 80278B4C 00000008  FF E0 20 90 */	fmr f31, f4
/* 80278B50 0000000C  48 00 00 2C */	b lbl_80278B7C
lbl_80278B54:
...
/* 80278B90 00000000  F0 01 80 10 */	psq_st f0, 16(r1), 1, 0 /* qr0 */
lbl_80278B94:
...
/* 80278BAC 00000000  C3 9E 00 5C */	lfs f28, 0x5c(r30)
/* 80278BB0 0000001C  10 9C 07 3A */	ps_madd f4, f28, f28, f0
/* 80278BB4 00000020  10 84 00 14 */	ps_sum0 f4, f4, f0, f0
/* 80278BB8 00000000  C0 22 B8 D8 */	lfs f1, lit_3281(r2)
/* 80278BBC 00000004  3C 60 80 45 */	lis r3, __float_epsilon@ha
/* 80278BC0 00000008  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)
/* 80278BC4 0000000C  EC 01 00 32 */	fmuls f0, f1, f0
/* 80278BC8 00000034  FC 04 00 40 */	fcmpo cr0, f4, f0
/* 80278BCC 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278BD0 00000004  41 82 00 5C */	beq lbl_80278C2C
/* 80278BD4 00000008  C0 02 B8 C0 */	lfs f0, lit_2742(r2)
/* 80278BD8 00000044  FC 04 00 40 */	fcmpo cr0, f4, f0
/* 80278BDC 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 80278BE0 00000004  40 82 00 0C */	bne lbl_80278BEC
/* 80278BE4 00000008  FF C0 20 90 */	fmr f30, f4
/* 80278BE8 0000000C  48 00 00 2C */	b lbl_80278C14
lbl_80278BEC:
...
/* 80278C20 00000000  F0 1E 00 54 */	psq_st f0, 84(r30), 0, 0 /* qr0 */
...
/* 80278D54 00000000  CB E1 01 00 */	lfd f31, 0x100(r1)
/* 80278D58 00000008  E3 C1 00 F8 */	psq_l f30, 248(r1), 0, 0 /* qr0 */
/* 80278D5C 00000000  CB C1 00 F0 */	lfd f30, 0xf0(r1)
/* 80278D60 00000010  E3 A1 00 E8 */	psq_l f29, 232(r1), 0, 0 /* qr0 */
/* 80278D64 00000000  CB A1 00 E0 */	lfd f29, 0xe0(r1)
/* 80278D68 00000018  E3 81 00 D8 */	psq_l f28, 216(r1), 0, 0 /* qr0 */
/* 80278D6C 00000000  CB 81 00 D0 */	lfd f28, 0xd0(r1)
/* 80278D70 00000020  E3 61 00 C8 */	psq_l f27, 200(r1), 0, 0 /* qr0 */
/* 80278D74 00000000  CB 61 00 C0 */	lfd f27, 0xc0(r1)
/* 80278D78 00000028  E3 41 00 B8 */	psq_l f26, 184(r1), 0, 0 /* qr0 */
/* 80278D7C 00000000  CB 41 00 B0 */	lfd f26, 0xb0(r1)
/* 80278D80 00000030  E3 21 00 A8 */	psq_l f25, 168(r1), 0, 0 /* qr0 */
/* 80278D84 00000000  CB 21 00 A0 */	lfd f25, 0xa0(r1)
/* 80278D88 00000038  E3 01 00 98 */	psq_l f24, 152(r1), 0, 0 /* qr0 */
/* 80278D8C 00000000  CB 01 00 90 */	lfd f24, 0x90(r1)
/* 80278D90 00000004  39 61 00 90 */	addi r11, r1, 0x90
/* 80278D94 00000008  48 0E 94 95 */	bl _restgpr_29
/* 80278D98 0000000C  80 01 01 14 */	lwz r0, 0x114(r1)
/* 80278D9C 00000010  7C 08 03 A6 */	mtlr r0
/* 80278DA0 00000014  38 21 01 10 */	addi r1, r1, 0x110
/* 80278DA4 00000018  4E 80 00 20 */	blr 

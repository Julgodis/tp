lbl_8027ADBC:
/* 8027ADBC  C0 02 B9 00 */	lfs f0, lit_2503(r2)                     /* constant-address: 80455300, symbol: lit_2503 */
/* 8027ADC0  80 83 00 00 */	lwz r4, 0(r3)                           
/* 8027ADC4  C0 44 00 2C */	lfs f2, 0x2c(r4)                        
/* 8027ADC8  FC 00 10 00 */	fcmpu cr0, f0, f2                       
/* 8027ADCC  41 82 00 18 */	beq lbl_8027ADE4                         /* constant-address: 8027ADE4, symbol: lbl_8027ADE4 */
...
/* 8027ADE0  48 00 00 08 */	b lbl_8027ADE8                           /* constant-address: 8027ADE8, symbol: lbl_8027ADE8 */
lbl_8027ADE4:
/* 8027ADE4  C0 02 B8 E0 */	lfs f0, lit_2270(r2)                     /* constant-address: 804552E0, symbol: lit_2270 */
lbl_8027ADE8:
/* 8027ADE8  D0 03 00 04 */	stfs f0, 4(r3)                          
/* 8027ADEC  C0 42 B8 E0 */	lfs f2, lit_2270(r2)                     /* constant-address: 804552E0, symbol: lit_2270 */
/* 8027ADF0  80 83 00 00 */	lwz r4, 0(r3)                           
/* 8027ADF4  C0 64 00 30 */	lfs f3, 0x30(r4)                        
/* 8027ADF8  FC 02 18 00 */	fcmpu cr0, f2, f3                       
/* 8027ADFC  41 82 00 18 */	beq lbl_8027AE14                         /* constant-address: 8027AE14, symbol: lbl_8027AE14 */
...
/* 8027AE18  C0 02 B9 00 */	lfs f0, lit_2503(r2)                     /* constant-address: 80455300, symbol: lit_2503 */
/* 8027AE1C  80 83 00 00 */	lwz r4, 0(r3)                           
/* 8027AE20  C0 44 00 0C */	lfs f2, 0xc(r4)                         
/* 8027AE24  FC 00 10 00 */	fcmpu cr0, f0, f2                       
/* 8027AE28  41 82 00 34 */	beq lbl_8027AE5C                         /* constant-address: 8027AE5C, symbol: lbl_8027AE5C */
/* 8027AE2C  C0 22 B8 E0 */	lfs f1, lit_2270(r2)                     /* constant-address: 804552E0, symbol: lit_2270 */
...
/* 8027AE58  48 00 00 10 */	b lbl_8027AE68                           /* constant-address: 8027AE68, symbol: lbl_8027AE68 */
lbl_8027AE5C:
/* 8027AE5C  C0 02 B8 E0 */	lfs f0, lit_2270(r2)                     /* constant-address: 804552E0, symbol: lit_2270 */
/* 8027AE60  D0 03 00 10 */	stfs f0, 0x10(r3)                       
/* 8027AE64  D0 03 00 0C */	stfs f0, 0xc(r3)                        
lbl_8027AE68:
/* 8027AE68  C0 42 B8 E0 */	lfs f2, lit_2270(r2)                     /* constant-address: 804552E0, symbol: lit_2270 */
/* 8027AE6C  80 83 00 00 */	lwz r4, 0(r3)                           
/* 8027AE70  C0 64 00 10 */	lfs f3, 0x10(r4)                        
/* 8027AE74  FC 02 18 00 */	fcmpu cr0, f2, f3                       
/* 8027AE78  41 82 00 38 */	beq lbl_8027AEB0                         /* constant-address: 8027AEB0, symbol: lbl_8027AEB0 */

...
/* 8027E404  C0 42 B9 58 */	lfs f2, lit_2632(r2)                     /* constant-address: 80455358, symbol: lit_2632 */
...
/* 8027E424  C0 22 B9 5C */	lfs f1, lit_2633(r2)                     /* constant-address: 8045535C, symbol: lit_2633 */
/* 8027E428  3C 80 80 45 */	lis r4, __float_epsilon@ha              
/* 8027E42C  C0 04 0A EC */	lfs f0, __float_epsilon@l(r4)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8027E430  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8027E434  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 8027E438  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027E43C  41 82 00 58 */	beq lbl_8027E494                         /* constant-address: 8027E494, symbol: lbl_8027E494 */
/* 8027E440  FC 05 10 40 */	fcmpo cr0, f5, f2                       
/* 8027E444  4C 40 13 82 */	cror 2, 0, 2                            
/* 8027E448  40 82 00 0C */	bne lbl_8027E454                         /* constant-address: 8027E454, symbol: lbl_8027E454 */
/* 8027E44C  FC 60 28 90 */	fmr f3, f5                              
/* 8027E450  48 00 00 2C */	b lbl_8027E47C                           /* constant-address: 8027E47C, symbol: lbl_8027E47C */
lbl_8027E454:
/* 8027E454  FC 80 28 34 */	frsqrte f4, f5                          
/* 8027E458  FC 80 20 18 */	frsp f4, f4                             
/* 8027E45C  C0 02 B9 60 */	lfs f0, lit_2634(r2)                     /* constant-address: 80455360, symbol: lit_2634 */
/* 8027E460  EC 40 01 32 */	fmuls f2, f0, f4                        
/* 8027E464  C0 22 B9 64 */	lfs f1, lit_2635(r2)                     /* constant-address: 80455364, symbol: lit_2635 */
...
lbl_8027E494:
/* 8027E494  C0 02 B9 68 */	lfs f0, lit_2636(r2)                     /* constant-address: 80455368, symbol: lit_2636 */
/* 8027E498  80 83 00 20 */	lwz r4, 0x20(r3)                        
/* 8027E49C  D0 04 01 54 */	stfs f0, 0x154(r4)                      
/* 8027E4A0  C0 62 B9 58 */	lfs f3, lit_2632(r2)                     /* constant-address: 80455358, symbol: lit_2632 */

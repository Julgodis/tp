...
/* 80273320  80 AD 8F C0 */	lwz r5, sVideoInterval__8JUTVideo(r13)   /* constant-address: 80451540, symbol: sVideoInterval__8JUTVideo */
/* 80273324  80 C3 00 30 */	lwz r6, 0x30(r3)                        
/* 80273328  54 C0 08 3C */	slwi r0, r6, 1                          
/* 8027332C  7C A7 2B 78 */	mr r7, r5                               
/* 80273330  48 00 00 08 */	b lbl_80273338                           /* constant-address: 80273338, symbol: lbl_80273338 */
lbl_80273334:
/* 80273334  7C E7 2A 14 */	add r7, r7, r5                          
lbl_80273338:
/* 80273338  7C 07 00 00 */	cmpw r7, r0                             
/* 8027333C  41 80 FF F8 */	blt lbl_80273334                         /* constant-address: 80273334, symbol: lbl_80273334 */
/* 80273340  80 83 00 34 */	lwz r4, 0x34(r3)                        
/* 80273344  7C 00 38 50 */	subf r0, r0, r7                         
/* 80273348  7C 04 00 51 */	subf. r0, r4, r0                        
/* 8027334C  40 80 00 08 */	bge lbl_80273354                         /* constant-address: 80273354, symbol: lbl_80273354 */
/* 80273350  7C 00 2A 14 */	add r0, r0, r5                          
lbl_80273354:
/* 80273354  C8 22 B8 68 */	lfd f1, lit_2933(r2)                     /* constant-address: 80455268, symbol: lit_2933 */
...
/* 80273370  C8 22 B8 60 */	lfd f1, lit_2500(r2)                     /* constant-address: 80455260, symbol: lit_2500 */
...
/* 80273390  C0 02 B8 58 */	lfs f0, lit_2498(r2)                     /* constant-address: 80455258, symbol: lit_2498 */
/* 80273394  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80273398  40 81 00 08 */	ble lbl_802733A0                         /* constant-address: 802733A0, symbol: lbl_802733A0 */

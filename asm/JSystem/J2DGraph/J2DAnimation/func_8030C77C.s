...
/* 8030C784  C8 42 C9 20 */	lfd f2, lit_2379(r2)                     /* constant-address: 80456320, symbol: lit_2379 */
...
/* 8030C7A4  40 80 00 20 */	bge lbl_8030C7C4                         /* constant-address: 8030C7C4, symbol: lbl_8030C7C4 */
...
/* 8030C7C0  48 00 01 E8 */	b lbl_8030C9A8                           /* constant-address: 8030C9A8, symbol: lbl_8030C9A8 */
lbl_8030C7C4:
/* 8030C7C4  A0 03 00 04 */	lhz r0, 4(r3)                           
/* 8030C7C8  28 00 00 00 */	cmplwi r0, 0                            
/* 8030C7CC  40 82 00 F4 */	bne lbl_8030C8C0                         /* constant-address: 8030C8C0, symbol: lbl_8030C8C0 */
...
/* 8030C7FC  40 82 00 68 */	bne lbl_8030C864                         /* constant-address: 8030C864, symbol: lbl_8030C864 */
...
/* 8030C81C  48 00 01 8C */	b lbl_8030C9A8                           /* constant-address: 8030C9A8, symbol: lbl_8030C9A8 */
/* 8030C820  48 00 00 44 */	b lbl_8030C864                           /* constant-address: 8030C864, symbol: lbl_8030C864 */
lbl_8030C824:
...
/* 8030C850  40 82 00 10 */	bne lbl_8030C860                         /* constant-address: 8030C860, symbol: lbl_8030C860 */
/* 8030C854  7C 84 1A 14 */	add r4, r4, r3                          
/* 8030C858  7C C7 30 50 */	subf r6, r7, r6                         
/* 8030C85C  48 00 00 08 */	b lbl_8030C864                           /* constant-address: 8030C864, symbol: lbl_8030C864 */
lbl_8030C860:
/* 8030C860  7C E6 3B 78 */	mr r6, r7                               
lbl_8030C864:
/* 8030C864  28 06 00 01 */	cmplwi r6, 1                            
/* 8030C868  41 81 FF BC */	bgt lbl_8030C824                         /* constant-address: 8030C824, symbol: lbl_8030C824 */
...
/* 8030C8BC  48 00 00 EC */	b lbl_8030C9A8                           /* constant-address: 8030C9A8, symbol: lbl_8030C9A8 */
lbl_8030C8C0:
...
/* 8030C8EC  40 82 00 64 */	bne lbl_8030C950                         /* constant-address: 8030C950, symbol: lbl_8030C950 */
...
/* 8030C90C  48 00 00 9C */	b lbl_8030C9A8                           /* constant-address: 8030C9A8, symbol: lbl_8030C9A8 */
/* 8030C910  48 00 00 40 */	b lbl_8030C950                           /* constant-address: 8030C950, symbol: lbl_8030C950 */
lbl_8030C914:
...
/* 8030C93C  40 82 00 10 */	bne lbl_8030C94C                         /* constant-address: 8030C94C, symbol: lbl_8030C94C */
/* 8030C940  7C 84 1A 14 */	add r4, r4, r3                          
/* 8030C944  7C C7 30 50 */	subf r6, r7, r6                         
/* 8030C948  48 00 00 08 */	b lbl_8030C950                           /* constant-address: 8030C950, symbol: lbl_8030C950 */
lbl_8030C94C:
/* 8030C94C  7C E6 3B 78 */	mr r6, r7                               
lbl_8030C950:
/* 8030C950  28 06 00 01 */	cmplwi r6, 1                            
/* 8030C954  41 81 FF C0 */	bgt lbl_8030C914                         /* constant-address: 8030C914, symbol: lbl_8030C914 */

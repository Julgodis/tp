...
/* 8030C9B8  40 80 00 0C */	bge lbl_8030C9C4                         /* constant-address: 8030C9C4, symbol: lbl_8030C9C4 */
/* 8030C9BC  C0 24 00 04 */	lfs f1, 4(r4)                           
/* 8030C9C0  4E 80 00 20 */	blr                                     
lbl_8030C9C4:
/* 8030C9C4  A0 03 00 04 */	lhz r0, 4(r3)                           
/* 8030C9C8  28 00 00 00 */	cmplwi r0, 0                            
/* 8030C9CC  40 82 00 B4 */	bne lbl_8030CA80                         /* constant-address: 8030CA80, symbol: lbl_8030CA80 */
...
/* 8030C9E8  40 82 00 40 */	bne lbl_8030CA28                         /* constant-address: 8030CA28, symbol: lbl_8030CA28 */
/* 8030C9EC  7C 64 02 14 */	add r3, r4, r0                          
/* 8030C9F0  C0 23 00 04 */	lfs f1, 4(r3)                           
/* 8030C9F4  4E 80 00 20 */	blr                                     
/* 8030C9F8  48 00 00 30 */	b lbl_8030CA28                           /* constant-address: 8030CA28, symbol: lbl_8030CA28 */
lbl_8030C9FC:
...
/* 8030CA14  40 82 00 10 */	bne lbl_8030CA24                         /* constant-address: 8030CA24, symbol: lbl_8030CA24 */
/* 8030CA18  7C 84 02 14 */	add r4, r4, r0                          
/* 8030CA1C  7C 65 18 50 */	subf r3, r5, r3                         
/* 8030CA20  48 00 00 08 */	b lbl_8030CA28                           /* constant-address: 8030CA28, symbol: lbl_8030CA28 */
lbl_8030CA24:
/* 8030CA24  7C A3 2B 78 */	mr r3, r5                               
lbl_8030CA28:
/* 8030CA28  28 03 00 01 */	cmplwi r3, 1                            
/* 8030CA2C  41 81 FF D0 */	bgt lbl_8030C9FC                         /* constant-address: 8030C9FC, symbol: lbl_8030C9FC */
...
/* 8030CA98  40 82 00 3C */	bne lbl_8030CAD4                         /* constant-address: 8030CAD4, symbol: lbl_8030CAD4 */
/* 8030CA9C  7C 64 02 14 */	add r3, r4, r0                          
/* 8030CAA0  C0 23 00 04 */	lfs f1, 4(r3)                           
/* 8030CAA4  4E 80 00 20 */	blr                                     
/* 8030CAA8  48 00 00 2C */	b lbl_8030CAD4                           /* constant-address: 8030CAD4, symbol: lbl_8030CAD4 */
lbl_8030CAAC:
...
/* 8030CAC0  40 82 00 10 */	bne lbl_8030CAD0                         /* constant-address: 8030CAD0, symbol: lbl_8030CAD0 */
/* 8030CAC4  7C 84 02 14 */	add r4, r4, r0                          
/* 8030CAC8  7C 65 18 50 */	subf r3, r5, r3                         
/* 8030CACC  48 00 00 08 */	b lbl_8030CAD4                           /* constant-address: 8030CAD4, symbol: lbl_8030CAD4 */
lbl_8030CAD0:
/* 8030CAD0  7C A3 2B 78 */	mr r3, r5                               
lbl_8030CAD4:
/* 8030CAD4  28 03 00 01 */	cmplwi r3, 1                            
/* 8030CAD8  41 81 FF D4 */	bgt lbl_8030CAAC                         /* constant-address: 8030CAAC, symbol: lbl_8030CAAC */

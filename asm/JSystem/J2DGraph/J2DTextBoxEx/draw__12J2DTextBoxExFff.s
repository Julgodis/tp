...
/* 803078E0  41 82 01 EC */	beq lbl_80307ACC                         /* constant-address: 80307ACC, symbol: lbl_80307ACC */
/* 803078E4  38 80 00 00 */	li r4, 0                                
/* 803078E8  80 7F 01 38 */	lwz r3, 0x138(r31)                      
/* 803078EC  28 03 00 00 */	cmplwi r3, 0                            
/* 803078F0  41 82 00 24 */	beq lbl_80307914                         /* constant-address: 80307914, symbol: lbl_80307914 */
/* 803078F4  80 63 00 70 */	lwz r3, 0x70(r3)                        
/* 803078F8  28 03 00 00 */	cmplwi r3, 0                            
/* 803078FC  41 82 00 18 */	beq lbl_80307914                         /* constant-address: 80307914, symbol: lbl_80307914 */
...
/* 80307950  4B FE CA 45 */	bl __ct__8J2DPrintFP7JUTFontffQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColor /* constant-address: 802F4394, symbol: __ct__8J2DPrintFP7JUTFontffQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColor */
/* 80307954  C0 5F 01 20 */	lfs f2, 0x120(r31)                      
/* 80307958  C0 3F 01 1C */	lfs f1, 0x11c(r31)                      
/* 8030795C  C0 02 C8 D8 */	lfs f0, lit_1534(r2)                     /* constant-address: 804562D8, symbol: lit_1534 */
/* 80307960  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80307964  40 81 00 08 */	ble lbl_8030796C                         /* constant-address: 8030796C, symbol: lbl_8030796C */
/* 80307968  48 00 00 08 */	b lbl_80307970                           /* constant-address: 80307970, symbol: lbl_80307970 */
lbl_8030796C:
/* 8030796C  FC 20 00 90 */	fmr f1, f0                              
lbl_80307970:
/* 80307970  D0 21 00 98 */	stfs f1, 0x98(r1)                       
/* 80307974  C0 02 C8 D8 */	lfs f0, lit_1534(r2)                     /* constant-address: 804562D8, symbol: lit_1534 */
/* 80307978  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8030797C  40 81 00 08 */	ble lbl_80307984                         /* constant-address: 80307984, symbol: lbl_80307984 */
/* 80307980  48 00 00 08 */	b lbl_80307988                           /* constant-address: 80307988, symbol: lbl_80307988 */
lbl_80307984:
...
/* 8030799C  41 82 01 24 */	beq lbl_80307AC0                         /* constant-address: 80307AC0, symbol: lbl_80307AC0 */
/* 803079A0  4B FE 29 ED */	bl setGX__11J2DMaterialFv                /* constant-address: 802EA38C, symbol: setGX__11J2DMaterialFv */
/* 803079A4  7F E3 FB 78 */	mr r3, r31                              
/* 803079A8  FC 20 F0 90 */	fmr f1, f30                             
/* 803079AC  FC 40 F8 90 */	fmr f2, f31                             
/* 803079B0  C0 62 C8 D8 */	lfs f3, lit_1534(r2)                     /* constant-address: 804562D8, symbol: lit_1534 */
...
/* 803079D0  48 05 88 7D */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
/* 803079D4  38 60 00 00 */	li r3, 0                                
/* 803079D8  48 05 89 15 */	bl GXSetCurrentMtx                       /* constant-address: 803602EC, symbol: GXSetCurrentMtx */
/* 803079DC  80 7F 01 38 */	lwz r3, 0x138(r31)                      
/* 803079E0  88 03 00 0E */	lbz r0, 0xe(r3)                         
/* 803079E4  28 00 00 00 */	cmplwi r0, 0                            
/* 803079E8  40 82 00 14 */	bne lbl_803079FC                         /* constant-address: 803079FC, symbol: lbl_803079FC */
/* 803079EC  38 61 00 48 */	addi r3, r1, 0x48                       
/* 803079F0  38 80 FF FF */	li r4, -1                               
/* 803079F4  4B FE CA 2D */	bl __dt__8J2DPrintFv                     /* constant-address: 802F4420, symbol: __dt__8J2DPrintFv */
/* 803079F8  48 00 00 D4 */	b lbl_80307ACC                           /* constant-address: 80307ACC, symbol: lbl_80307ACC */
lbl_803079FC:
/* 803079FC  48 05 3B 91 */	bl GXClearVtxDesc                        /* constant-address: 8035B58C, symbol: GXClearVtxDesc */
/* 80307A00  38 60 00 09 */	li r3, 9                                
/* 80307A04  38 80 00 01 */	li r4, 1                                
/* 80307A08  48 05 34 B1 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 80307A0C  38 60 00 0B */	li r3, 0xb                              
/* 80307A10  38 80 00 01 */	li r4, 1                                
/* 80307A14  48 05 34 A5 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 80307A18  38 60 00 0D */	li r3, 0xd                              
/* 80307A1C  38 80 00 01 */	li r4, 1                                
/* 80307A20  48 05 34 99 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 80307A24  80 DF 01 24 */	lwz r6, 0x124(r31)                      
/* 80307A28  28 06 00 00 */	cmplwi r6, 0                            
/* 80307A2C  41 82 00 38 */	beq lbl_80307A64                         /* constant-address: 80307A64, symbol: lbl_80307A64 */
...
/* 80307A40  40 82 00 08 */	bne lbl_80307A48                         /* constant-address: 80307A48, symbol: lbl_80307A48 */
/* 80307A44  88 9F 00 B3 */	lbz r4, 0xb3(r31)                       
lbl_80307A48:
/* 80307A48  38 61 00 48 */	addi r3, r1, 0x48                       
/* 80307A4C  C0 22 C8 D8 */	lfs f1, lit_1534(r2)                     /* constant-address: 804562D8, symbol: lit_1534 */
/* 80307A50  FC 40 08 90 */	fmr f2, f1                              
/* 80307A54  3C A0 80 3A */	lis r5, J2DTextBoxEx__stringBase0@ha    
/* 80307A58  38 A5 1D F0 */	addi r5, r5, J2DTextBoxEx__stringBase0@l /* constant-address: 803A1DF0, symbol: J2DTextBoxEx__stringBase0 */
/* 80307A5C  4C C6 32 42 */	crset 6                                 
/* 80307A60  4B FE CD 19 */	bl print__8J2DPrintFffUcPCce             /* constant-address: 802F4778, symbol: print__8J2DPrintFffUcPCce */
lbl_80307A64:
...
/* 80307A7C  48 05 7B 29 */	bl GXSetTevSwapModeTable                 /* constant-address: 8035F5A4, symbol: GXSetTevSwapModeTable */
/* 80307A80  3B FF 00 01 */	addi r31, r31, 1                        
/* 80307A84  2C 1F 00 04 */	cmpwi r31, 4                            
/* 80307A88  41 80 FF E0 */	blt lbl_80307A68                         /* constant-address: 80307A68, symbol: lbl_80307A68 */
/* 80307A8C  38 60 00 00 */	li r3, 0                                
/* 80307A90  48 05 76 45 */	bl GXSetNumIndStages                     /* constant-address: 8035F0D4, symbol: GXSetNumIndStages */
/* 80307A94  3B E0 00 00 */	li r31, 0                               
lbl_80307A98:
/* 80307A98  7F E3 FB 78 */	mr r3, r31                              
/* 80307A9C  48 05 76 5D */	bl GXSetTevDirect                        /* constant-address: 8035F0F8, symbol: GXSetTevDirect */
/* 80307AA0  3B FF 00 01 */	addi r31, r31, 1                        
/* 80307AA4  2C 1F 00 10 */	cmpwi r31, 0x10                         
/* 80307AA8  41 80 FF F0 */	blt lbl_80307A98                         /* constant-address: 80307A98, symbol: lbl_80307A98 */
/* 80307AAC  38 61 00 18 */	addi r3, r1, 0x18                       
/* 80307AB0  48 03 E9 D5 */	bl PSMTXIdentity                         /* constant-address: 80346484, symbol: PSMTXIdentity */
/* 80307AB4  38 61 00 18 */	addi r3, r1, 0x18                       
/* 80307AB8  38 80 00 00 */	li r4, 0                                
/* 80307ABC  48 05 87 91 */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
lbl_80307AC0:
/* 80307AC0  38 61 00 48 */	addi r3, r1, 0x48                       
/* 80307AC4  38 80 FF FF */	li r4, -1                               
/* 80307AC8  4B FE C9 59 */	bl __dt__8J2DPrintFv                     /* constant-address: 802F4420, symbol: __dt__8J2DPrintFv */
lbl_80307ACC:

...
/* 802FFC68  48 06 25 69 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 802FFC84  41 82 00 28 */	beq lbl_802FFCAC                         /* constant-address: 802FFCAC, symbol: lbl_802FFCAC */
/* 802FFC88  38 60 00 70 */	li r3, 0x70                             
/* 802FFC8C  4B FC EF C1 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802FFC90  7C 60 1B 79 */	or. r0, r3, r3                          
/* 802FFC94  41 82 00 14 */	beq lbl_802FFCA8                         /* constant-address: 802FFCA8, symbol: lbl_802FFCA8 */
/* 802FFC98  7F 44 D3 78 */	mr r4, r26                              
/* 802FFC9C  38 A0 00 00 */	li r5, 0                                
/* 802FFCA0  4B FD F2 F5 */	bl __ct__10JUTResFontFPC7ResFONTP7JKRHeap /* constant-address: 802DEF94, symbol: __ct__10JUTResFontFPC7ResFONTP7JKRHeap */
...
/* 802FFD1C  41 82 00 7C */	beq lbl_802FFD98                         /* constant-address: 802FFD98, symbol: lbl_802FFD98 */
/* 802FFD20  7F A0 07 35 */	extsh. r0, r29                          
/* 802FFD24  41 82 00 74 */	beq lbl_802FFD98                         /* constant-address: 802FFD98, symbol: lbl_802FFD98 */
/* 802FFD28  7F 83 E3 78 */	mr r3, r28                              
/* 802FFD2C  48 06 8E B9 */	bl strlen                                /* constant-address: 80368BE4, symbol: strlen */
/* 802FFD30  57 BE 04 3E */	clrlwi r30, r29, 0x10                   
/* 802FFD34  7F A0 07 34 */	extsh r0, r29                           
/* 802FFD38  2C 00 FF FF */	cmpwi r0, -1                            
/* 802FFD3C  40 82 00 1C */	bne lbl_802FFD58                         /* constant-address: 802FFD58, symbol: lbl_802FFD58 */
/* 802FFD40  28 03 FF FF */	cmplwi r3, 0xffff                       
/* 802FFD44  41 80 00 0C */	blt lbl_802FFD50                         /* constant-address: 802FFD50, symbol: lbl_802FFD50 */
/* 802FFD48  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFE@ha */      
/* 802FFD4C  38 63 FF FE */	addi r3, r3, 0xFFFE /* 0x0000FFFE@l */   /* constant-address: 0000FFFE */
lbl_802FFD50:
/* 802FFD50  38 03 00 01 */	addi r0, r3, 1                          
/* 802FFD54  54 1E 04 3E */	clrlwi r30, r0, 0x10                    
lbl_802FFD58:
/* 802FFD58  57 C3 04 3E */	clrlwi r3, r30, 0x10                    
/* 802FFD5C  4B FC EF 69 */	bl __nwa__FUl                            /* constant-address: 802CECC4, symbol: __nwa__FUl */
/* 802FFD60  90 7B 01 24 */	stw r3, 0x124(r27)                      
/* 802FFD64  57 DD 04 3F */	clrlwi. r29, r30, 0x10                  
/* 802FFD68  41 82 00 30 */	beq lbl_802FFD98                         /* constant-address: 802FFD98, symbol: lbl_802FFD98 */
/* 802FFD6C  80 7B 01 24 */	lwz r3, 0x124(r27)                      
/* 802FFD70  28 03 00 00 */	cmplwi r3, 0                            
/* 802FFD74  41 82 00 24 */	beq lbl_802FFD98                         /* constant-address: 802FFD98, symbol: lbl_802FFD98 */
/* 802FFD78  7F 84 E3 78 */	mr r4, r28                              
/* 802FFD7C  38 BD FF FF */	addi r5, r29, -1                        
/* 802FFD80  48 06 8D 69 */	bl strncpy                               /* constant-address: 80368AE8, symbol: strncpy */
...
lbl_802FFD98:
/* 802FFD98  C0 02 C8 80 */	lfs f0, lit_1660(r2)                     /* constant-address: 80456280, symbol: lit_1660 */
...
/* 802FFDB0  40 82 00 14 */	bne lbl_802FFDC4                         /* constant-address: 802FFDC4, symbol: lbl_802FFDC4 */
/* 802FFDB4  D0 1B 01 18 */	stfs f0, 0x118(r27)                     
/* 802FFDB8  D0 1B 01 1C */	stfs f0, 0x11c(r27)                     
/* 802FFDBC  D0 1B 01 20 */	stfs f0, 0x120(r27)                     
/* 802FFDC0  48 00 00 9C */	b lbl_802FFE5C                           /* constant-address: 802FFE5C, symbol: lbl_802FFE5C */
lbl_802FFDC4:
...
/* 802FFDD4  C8 22 C8 88 */	lfd f1, lit_1662(r2)                     /* constant-address: 80456288, symbol: lit_1662 */
...
/* 802FFE08  C8 22 C8 88 */	lfd f1, lit_1662(r2)                     /* constant-address: 80456288, symbol: lit_1662 */
...
/* 802FFE3C  C8 22 C8 88 */	lfd f1, lit_1662(r2)                     /* constant-address: 80456288, symbol: lit_1662 */
...
/* 802FFE60  38 03 58 31 */	addi r0, r3, 0x5831 /* 0x54425831@l */   /* constant-address: 54425831 */
...
/* 802FFE74  48 06 23 A9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

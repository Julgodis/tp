...
/* 80303C0C  48 05 E5 B9 */	bl _savegpr_23                           /* constant-address: 803621C4, symbol: _savegpr_23 */
...
/* 80303C50  48 04 28 95 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 80303C54  80 77 01 50 */	lwz r3, 0x150(r23)                      
/* 80303C58  28 03 00 00 */	cmplwi r3, 0                            
/* 80303C5C  41 82 00 10 */	beq lbl_80303C6C                         /* constant-address: 80303C6C, symbol: lbl_80303C6C */
/* 80303C60  88 03 00 0E */	lbz r0, 0xe(r3)                         
/* 80303C64  28 00 00 00 */	cmplwi r0, 0                            
/* 80303C68  41 82 01 BC */	beq lbl_80303E24                         /* constant-address: 80303E24, symbol: lbl_80303E24 */
lbl_80303C6C:
/* 80303C6C  38 61 00 20 */	addi r3, r1, 0x20                       
/* 80303C70  38 80 00 00 */	li r4, 0                                
/* 80303C74  48 05 C5 D9 */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
...
/* 80303CA0  41 82 00 90 */	beq lbl_80303D30                         /* constant-address: 80303D30, symbol: lbl_80303D30 */
/* 80303CA4  A0 03 00 1C */	lhz r0, 0x1c(r3)                        
/* 80303CA8  54 00 07 FE */	clrlwi r0, r0, 0x1f                     
/* 80303CAC  28 00 00 01 */	cmplwi r0, 1                            
/* 80303CB0  40 82 00 5C */	bne lbl_80303D0C                         /* constant-address: 80303D0C, symbol: lbl_80303D0C */
/* 80303CB4  88 03 00 0F */	lbz r0, 0xf(r3)                         
/* 80303CB8  2C 00 00 01 */	cmpwi r0, 1                             
/* 80303CBC  40 82 00 74 */	bne lbl_80303D30                         /* constant-address: 80303D30, symbol: lbl_80303D30 */
...
/* 80303D08  48 00 00 28 */	b lbl_80303D30                           /* constant-address: 80303D30, symbol: lbl_80303D30 */
lbl_80303D0C:
/* 80303D0C  88 17 00 B4 */	lbz r0, 0xb4(r23)                       
/* 80303D10  28 00 00 00 */	cmplwi r0, 0                            
/* 80303D14  41 82 00 1C */	beq lbl_80303D30                         /* constant-address: 80303D30, symbol: lbl_80303D30 */
...
/* 80303D2C  48 05 9D 1D */	bl GXSetChanMatColor                     /* constant-address: 8035DA48, symbol: GXSetChanMatColor */
lbl_80303D30:
...
/* 80303D44  48 05 78 81 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
...
/* 80303D5C  48 05 78 69 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
/* 80303D60  38 60 00 80 */	li r3, 0x80                             
/* 80303D64  38 80 00 00 */	li r4, 0                                
/* 80303D68  38 A0 00 04 */	li r5, 4                                
/* 80303D6C  48 05 89 F9 */	bl GXBegin                               /* constant-address: 8035C764, symbol: GXBegin */
/* 80303D70  3C 60 CC 01 */	lis r3, 0xCC01 /* 0xCC008000@ha */      
/* 80303D74  D3 83 80 00 */	stfs f28, 0x8000(r3)                     /* constant-address: CC008000 */
/* 80303D78  D3 A3 80 00 */	stfs f29, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303D7C  C0 02 C8 C4 */	lfs f0, lit_1784(r2)                     /* constant-address: 804562C4, symbol: lit_1784 */
/* 80303D80  D0 03 80 00 */	stfs f0, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303D84  80 01 00 1C */	lwz r0, 0x1c(r1)                        
/* 80303D88  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 80303D8C  B3 03 80 00 */	sth r24, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303D90  B3 23 80 00 */	sth r25, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303D94  D3 E3 80 00 */	stfs f31, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303D98  D3 A3 80 00 */	stfs f29, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303D9C  C0 02 C8 C4 */	lfs f0, lit_1784(r2)                     /* constant-address: 804562C4, symbol: lit_1784 */
/* 80303DA0  D0 03 80 00 */	stfs f0, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DA4  80 01 00 18 */	lwz r0, 0x18(r1)                        
/* 80303DA8  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 80303DAC  B3 43 80 00 */	sth r26, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DB0  B3 63 80 00 */	sth r27, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DB4  D3 E3 80 00 */	stfs f31, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303DB8  D3 C3 80 00 */	stfs f30, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303DBC  C0 02 C8 C4 */	lfs f0, lit_1784(r2)                     /* constant-address: 804562C4, symbol: lit_1784 */
/* 80303DC0  D0 03 80 00 */	stfs f0, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DC4  80 01 00 10 */	lwz r0, 0x10(r1)                        
/* 80303DC8  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 80303DCC  B3 C3 80 00 */	sth r30, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DD0  B3 E3 80 00 */	sth r31, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DD4  D3 83 80 00 */	stfs f28, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303DD8  D3 C3 80 00 */	stfs f30, -0x8000(r3)                    /* constant-address: CC008000 */
/* 80303DDC  C0 02 C8 C4 */	lfs f0, lit_1784(r2)                     /* constant-address: 804562C4, symbol: lit_1784 */
/* 80303DE0  D0 03 80 00 */	stfs f0, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DE4  80 01 00 14 */	lwz r0, 0x14(r1)                        
/* 80303DE8  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 80303DEC  B3 83 80 00 */	sth r28, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80303DF0  B3 A3 80 00 */	sth r29, -0x8000(r3)                     /* constant-address: CC008000 */
...
/* 80303E08  48 05 77 BD */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
...
/* 80303E20  48 05 77 A5 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
lbl_80303E24:
...
/* 80303E48  48 05 E3 C9 */	bl _restgpr_23                           /* constant-address: 80362210, symbol: _restgpr_23 */

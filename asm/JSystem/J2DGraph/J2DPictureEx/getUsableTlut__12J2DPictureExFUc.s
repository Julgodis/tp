...
/* 80306DD8  48 05 B3 FD */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 80306DF4  48 00 00 84 */	b lbl_80306E78                           /* constant-address: 80306E78, symbol: lbl_80306E78 */
lbl_80306DF8:
...
/* 80306E1C  41 82 00 58 */	beq lbl_80306E74                         /* constant-address: 80306E74, symbol: lbl_80306E74 */
/* 80306E20  28 03 00 00 */	cmplwi r3, 0                            
/* 80306E24  41 82 00 50 */	beq lbl_80306E74                         /* constant-address: 80306E74, symbol: lbl_80306E74 */
/* 80306E28  80 83 00 20 */	lwz r4, 0x20(r3)                        
/* 80306E2C  28 04 00 00 */	cmplwi r4, 0                            
/* 80306E30  41 82 00 44 */	beq lbl_80306E74                         /* constant-address: 80306E74, symbol: lbl_80306E74 */
/* 80306E34  88 04 00 08 */	lbz r0, 8(r4)                           
/* 80306E38  28 00 00 00 */	cmplwi r0, 0                            
/* 80306E3C  41 82 00 38 */	beq lbl_80306E74                         /* constant-address: 80306E74, symbol: lbl_80306E74 */
/* 80306E40  88 63 00 3A */	lbz r3, 0x3a(r3)                        
/* 80306E44  2C 03 00 10 */	cmpwi r3, 0x10                          
/* 80306E48  38 00 00 00 */	li r0, 0                                
/* 80306E4C  41 80 00 08 */	blt lbl_80306E54                         /* constant-address: 80306E54, symbol: lbl_80306E54 */
...
/* 80306E60  40 80 00 14 */	bge lbl_80306E74                         /* constant-address: 80306E74, symbol: lbl_80306E74 */
...
lbl_80306E74:
/* 80306E74  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
lbl_80306E78:
/* 80306E78  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 80306E7C  7C 00 E8 40 */	cmplw r0, r29                           
/* 80306E80  41 80 FF 78 */	blt lbl_80306DF8                         /* constant-address: 80306DF8, symbol: lbl_80306DF8 */
/* 80306E84  38 60 00 00 */	li r3, 0                                
/* 80306E88  57 85 06 3E */	clrlwi r5, r28, 0x18                    
/* 80306E8C  38 80 00 01 */	li r4, 1                                
/* 80306E90  48 00 00 1C */	b lbl_80306EAC                           /* constant-address: 80306EAC, symbol: lbl_80306EAC */
lbl_80306E94:
/* 80306E94  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 80306E98  7C 80 00 30 */	slw r0, r4, r0                          
/* 80306E9C  7C A0 00 39 */	and. r0, r5, r0                         
/* 80306EA0  40 82 00 08 */	bne lbl_80306EA8                         /* constant-address: 80306EA8, symbol: lbl_80306EA8 */
/* 80306EA4  48 00 00 18 */	b lbl_80306EBC                           /* constant-address: 80306EBC, symbol: lbl_80306EBC */
lbl_80306EA8:
/* 80306EA8  38 63 00 01 */	addi r3, r3, 1                           /* constant-address: 00000001 */
lbl_80306EAC:
/* 80306EAC  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 80306EB0  28 00 00 08 */	cmplwi r0, 8                            
/* 80306EB4  41 80 FF E0 */	blt lbl_80306E94                         /* constant-address: 80306E94, symbol: lbl_80306E94 */
/* 80306EB8  38 60 00 00 */	li r3, 0                                
lbl_80306EBC:
/* 80306EBC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 80306EC0  48 05 B3 61 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

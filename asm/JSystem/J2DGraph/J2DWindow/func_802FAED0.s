...
/* 802FAEE0  48 06 72 FD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802FAF00  C8 82 C8 40 */	lfd f4, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FAF24  40 82 00 C4 */	bne lbl_802FAFE8                         /* constant-address: 802FAFE8, symbol: lbl_802FAFE8 */
...
/* 802FAF54  40 82 00 94 */	bne lbl_802FAFE8                         /* constant-address: 802FAFE8, symbol: lbl_802FAFE8 */
/* 802FAF58  88 1D 00 B0 */	lbz r0, 0xb0(r29)                       
/* 802FAF5C  28 00 00 00 */	cmplwi r0, 0                            
/* 802FAF60  41 82 00 88 */	beq lbl_802FAFE8                         /* constant-address: 802FAFE8, symbol: lbl_802FAFE8 */
/* 802FAF64  C0 62 C8 50 */	lfs f3, lit_2156(r2)                     /* constant-address: 80456250, symbol: lit_2156 */
...
/* 802FAF84  48 06 52 C9 */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
/* 802FAF88  38 60 00 00 */	li r3, 0                                
/* 802FAF8C  48 06 53 61 */	bl GXSetCurrentMtx                       /* constant-address: 803602EC, symbol: GXSetCurrentMtx */
...
/* 802FAFB0  C0 02 C8 50 */	lfs f0, lit_2156(r2)                     /* constant-address: 80456250, symbol: lit_2156 */
...
/* 802FAFD0  4B FF FA 8D */	bl func_802FAA5C                         /* constant-address: 802FAA5C, symbol: func_802FAA5C */
/* 802FAFD4  38 61 00 18 */	addi r3, r1, 0x18                       
/* 802FAFD8  48 04 B4 AD */	bl PSMTXIdentity                         /* constant-address: 80346484, symbol: PSMTXIdentity */
/* 802FAFDC  38 61 00 18 */	addi r3, r1, 0x18                       
/* 802FAFE0  38 80 00 00 */	li r4, 0                                
/* 802FAFE4  48 06 52 69 */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
lbl_802FAFE8:
/* 802FAFE8  39 61 00 60 */	addi r11, r1, 0x60                      
/* 802FAFEC  48 06 72 3D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 802FBBA0  48 06 66 3D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802FBBB8  40 82 00 F4 */	bne lbl_802FBCAC                         /* constant-address: 802FBCAC, symbol: lbl_802FBCAC */
/* 802FBBBC  80 7F 00 00 */	lwz r3, 0(r31)                          
/* 802FBBC0  3C 03 00 01 */	addis r0, r3, 1                         
/* 802FBBC4  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 802FBBC8  40 82 00 E4 */	bne lbl_802FBCAC                         /* constant-address: 802FBCAC, symbol: lbl_802FBCAC */
/* 802FBBCC  38 60 00 00 */	li r3, 0                                
/* 802FBBD0  38 80 00 00 */	li r4, 0                                
/* 802FBBD4  38 A0 00 00 */	li r5, 0                                
/* 802FBBD8  38 C0 00 04 */	li r6, 4                                
/* 802FBBDC  48 06 3B 19 */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
...
/* 802FBBF4  48 06 36 31 */	bl GXSetTevColorIn                       /* constant-address: 8035F224, symbol: GXSetTevColorIn */
/* 802FBBF8  80 7D 00 20 */	lwz r3, 0x20(r29)                       
/* 802FBBFC  88 03 00 01 */	lbz r0, 1(r3)                           
/* 802FBC00  2C 00 00 00 */	cmpwi r0, 0                             
/* 802FBC04  41 82 00 20 */	beq lbl_802FBC24                         /* constant-address: 802FBC24, symbol: lbl_802FBC24 */
...
/* 802FBC1C  48 06 36 4D */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
/* 802FBC20  48 00 00 34 */	b lbl_802FBC54                           /* constant-address: 802FBC54, symbol: lbl_802FBC54 */
lbl_802FBC24:
...
/* 802FBC38  48 06 37 45 */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
...
/* 802FBC50  48 06 36 19 */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
lbl_802FBC54:
...
/* 802FBC6C  48 06 36 41 */	bl GXSetTevColorOp                       /* constant-address: 8035F2AC, symbol: GXSetTevColorOp */
...
/* 802FBC88  48 06 36 8D */	bl GXSetTevAlphaOp                       /* constant-address: 8035F314, symbol: GXSetTevAlphaOp */
/* 802FBC8C  38 60 00 01 */	li r3, 1                                
/* 802FBC90  48 06 3C 01 */	bl GXSetNumTevStages                     /* constant-address: 8035F890, symbol: GXSetNumTevStages */
/* 802FBC94  38 60 00 01 */	li r3, 1                                
/* 802FBC98  38 80 00 04 */	li r4, 4                                
/* 802FBC9C  38 A0 00 05 */	li r5, 5                                
/* 802FBCA0  38 C0 00 0F */	li r6, 0xf                              
/* 802FBCA4  48 06 3F 4D */	bl GXSetBlendMode                        /* constant-address: 8035FBF0, symbol: GXSetBlendMode */
/* 802FBCA8  48 00 01 70 */	b lbl_802FBE18                           /* constant-address: 802FBE18, symbol: lbl_802FBE18 */
lbl_802FBCAC:
/* 802FBCAC  38 60 00 00 */	li r3, 0                                
/* 802FBCB0  38 80 00 00 */	li r4, 0                                
/* 802FBCB4  38 A0 00 00 */	li r5, 0                                
/* 802FBCB8  38 C0 00 FF */	li r6, 0xff                             
/* 802FBCBC  48 06 3A 39 */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
...
/* 802FBCD0  48 06 36 AD */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
...
/* 802FBCE4  48 06 36 99 */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
...
/* 802FBCFC  48 06 35 29 */	bl GXSetTevColorIn                       /* constant-address: 8035F224, symbol: GXSetTevColorIn */
/* 802FBD00  80 7D 00 20 */	lwz r3, 0x20(r29)                       
/* 802FBD04  88 03 00 01 */	lbz r0, 1(r3)                           
/* 802FBD08  2C 00 00 00 */	cmpwi r0, 0                             
/* 802FBD0C  41 82 00 20 */	beq lbl_802FBD2C                         /* constant-address: 802FBD2C, symbol: lbl_802FBD2C */
...
/* 802FBD24  48 06 35 45 */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
/* 802FBD28  48 00 00 34 */	b lbl_802FBD5C                           /* constant-address: 802FBD5C, symbol: lbl_802FBD5C */
lbl_802FBD2C:
...
/* 802FBD40  48 06 36 3D */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
...
/* 802FBD58  48 06 35 11 */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
lbl_802FBD5C:
...
/* 802FBD74  48 06 35 39 */	bl GXSetTevColorOp                       /* constant-address: 8035F2AC, symbol: GXSetTevColorOp */
...
/* 802FBD90  48 06 35 85 */	bl GXSetTevAlphaOp                       /* constant-address: 8035F314, symbol: GXSetTevAlphaOp */
/* 802FBD94  38 60 00 01 */	li r3, 1                                
/* 802FBD98  38 80 00 FF */	li r4, 0xff                             
/* 802FBD9C  38 A0 00 FF */	li r5, 0xff                             
/* 802FBDA0  38 C0 00 04 */	li r6, 4                                
/* 802FBDA4  48 06 39 51 */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
...
/* 802FBDBC  48 06 34 69 */	bl GXSetTevColorIn                       /* constant-address: 8035F224, symbol: GXSetTevColorIn */
...
/* 802FBDD4  48 06 34 95 */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
...
/* 802FBDF0  48 06 34 BD */	bl GXSetTevColorOp                       /* constant-address: 8035F2AC, symbol: GXSetTevColorOp */
...
/* 802FBE0C  48 06 35 09 */	bl GXSetTevAlphaOp                       /* constant-address: 8035F314, symbol: GXSetTevAlphaOp */
/* 802FBE10  38 60 00 02 */	li r3, 2                                
/* 802FBE14  48 06 3A 7D */	bl GXSetNumTevStages                     /* constant-address: 8035F890, symbol: GXSetNumTevStages */
lbl_802FBE18:
...
/* 802FBE30  48 05 FD 4D */	bl GXSetTexCoordGen2                     /* constant-address: 8035BB7C, symbol: GXSetTexCoordGen2 */
/* 802FBE34  38 60 00 01 */	li r3, 1                                
/* 802FBE38  38 80 00 04 */	li r4, 4                                
/* 802FBE3C  38 A0 00 05 */	li r5, 5                                
/* 802FBE40  38 C0 00 0F */	li r6, 0xf                              
/* 802FBE44  48 06 3D AD */	bl GXSetBlendMode                        /* constant-address: 8035FBF0, symbol: GXSetBlendMode */
/* 802FBE48  39 61 00 30 */	addi r11, r1, 0x30                      
/* 802FBE4C  48 06 63 DD */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 802FA93C  41 82 00 D0 */	beq lbl_802FAA0C                         /* constant-address: 802FAA0C, symbol: lbl_802FAA0C */
/* 802FA940  80 E3 01 04 */	lwz r7, 0x104(r3)                       
/* 802FA944  28 07 00 00 */	cmplwi r7, 0                            
/* 802FA948  41 82 00 C4 */	beq lbl_802FAA0C                         /* constant-address: 802FAA0C, symbol: lbl_802FAA0C */
/* 802FA94C  80 A3 01 08 */	lwz r5, 0x108(r3)                       
/* 802FA950  28 05 00 00 */	cmplwi r5, 0                            
/* 802FA954  41 82 00 B8 */	beq lbl_802FAA0C                         /* constant-address: 802FAA0C, symbol: lbl_802FAA0C */
/* 802FA958  80 03 01 0C */	lwz r0, 0x10c(r3)                       
/* 802FA95C  28 00 00 00 */	cmplwi r0, 0                            
/* 802FA960  41 82 00 AC */	beq lbl_802FAA0C                         /* constant-address: 802FAA0C, symbol: lbl_802FAA0C */
...
/* 802FA978  C8 42 C8 40 */	lfd f2, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FAA08  48 00 00 30 */	b lbl_802FAA38                           /* constant-address: 802FAA38, symbol: lbl_802FAA38 */
lbl_802FAA0C:
...
/* 802FAA24  C0 02 C8 50 */	lfs f0, lit_2156(r2)                     /* constant-address: 80456250, symbol: lit_2156 */

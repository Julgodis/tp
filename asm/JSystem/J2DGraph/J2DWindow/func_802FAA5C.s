...
/* 802FAB04  48 06 0A 89 */	bl GXClearVtxDesc                        /* constant-address: 8035B58C, symbol: GXClearVtxDesc */
/* 802FAB08  38 60 00 09 */	li r3, 9                                
/* 802FAB0C  38 80 00 01 */	li r4, 1                                
/* 802FAB10  48 06 03 A9 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 802FAB14  38 60 00 0B */	li r3, 0xb                              
/* 802FAB18  38 80 00 01 */	li r4, 1                                
/* 802FAB1C  48 06 03 9D */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 802FAB20  38 60 00 0D */	li r3, 0xd                              
/* 802FAB24  38 80 00 01 */	li r4, 1                                
/* 802FAB28  48 06 03 91 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 802FAB2C  38 60 00 01 */	li r3, 1                                
/* 802FAB30  48 06 12 CD */	bl GXSetNumTexGens                       /* constant-address: 8035BDFC, symbol: GXSetNumTexGens */
/* 802FAB34  80 9F 01 00 */	lwz r4, 0x100(r31)                      
/* 802FAB38  28 04 00 00 */	cmplwi r4, 0                            
/* 802FAB3C  41 82 03 18 */	beq lbl_802FAE54                         /* constant-address: 802FAE54, symbol: lbl_802FAE54 */
/* 802FAB40  80 1F 01 04 */	lwz r0, 0x104(r31)                      
/* 802FAB44  28 00 00 00 */	cmplwi r0, 0                            
/* 802FAB48  41 82 03 0C */	beq lbl_802FAE54                         /* constant-address: 802FAE54, symbol: lbl_802FAE54 */
/* 802FAB4C  80 1F 01 08 */	lwz r0, 0x108(r31)                      
/* 802FAB50  28 00 00 00 */	cmplwi r0, 0                            
/* 802FAB54  41 82 03 00 */	beq lbl_802FAE54                         /* constant-address: 802FAE54, symbol: lbl_802FAE54 */
/* 802FAB58  80 7F 01 0C */	lwz r3, 0x10c(r31)                      
/* 802FAB5C  28 03 00 00 */	cmplwi r3, 0                            
/* 802FAB60  41 82 02 F4 */	beq lbl_802FAE54                         /* constant-address: 802FAE54, symbol: lbl_802FAE54 */
...
/* 802FAB78  C8 42 C8 40 */	lfd f2, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FAC10  48 00 0B B9 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffbbb /* constant-address: 802FB7C8, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffbbb */
...
/* 802FAC38  48 00 0B 91 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffbbb /* constant-address: 802FB7C8, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffbbb */
...
/* 802FAC4C  38 63 80 00 */	addi r3, r3, 0x8000 /* 0x00008000@l */   /* constant-address: 00008000 */
...
/* 802FAC88  C8 82 C8 40 */	lfd f4, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FACAC  48 00 09 89 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb /* constant-address: 802FB634, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb */
...
/* 802FACD4  48 00 0A F5 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffbbb /* constant-address: 802FB7C8, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffbbb */
...
/* 802FACE8  38 63 80 00 */	addi r3, r3, 0x8000 /* 0x00008000@l */   /* constant-address: 00008000 */
...
/* 802FAD20  C8 82 C8 40 */	lfd f4, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FAD44  48 00 08 F1 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb /* constant-address: 802FB634, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb */
...
/* 802FAD58  38 63 80 00 */	addi r3, r3, 0x8000 /* 0x00008000@l */   /* constant-address: 00008000 */
...
/* 802FAD8C  C8 62 C8 40 */	lfd f3, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FADB8  48 00 08 7D */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb /* constant-address: 802FB634, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb */
...
/* 802FADE0  48 00 09 E9 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffbbb /* constant-address: 802FB7C8, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffbbb */
...
/* 802FADF4  38 63 80 00 */	addi r3, r3, 0x8000 /* 0x00008000@l */   /* constant-address: 00008000 */
...
/* 802FAE28  C8 62 C8 40 */	lfd f3, lit_1971(r2)                     /* constant-address: 80456240, symbol: lit_1971 */
...
/* 802FAE50  48 00 07 E5 */	bl drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb /* constant-address: 802FB634, symbol: drawFrameTexture__9J2DWindowFP10JUTTextureffffUsUsUsUsb */
lbl_802FAE54:
/* 802FAE54  38 60 00 00 */	li r3, 0                                
/* 802FAE58  38 80 00 04 */	li r4, 4                                
/* 802FAE5C  48 06 43 3D */	bl GXSetTevOp                            /* constant-address: 8035F198, symbol: GXSetTevOp */
/* 802FAE60  38 60 00 00 */	li r3, 0                                
/* 802FAE64  38 80 00 FF */	li r4, 0xff                             
/* 802FAE68  38 A0 00 FF */	li r5, 0xff                             
/* 802FAE6C  38 C0 00 04 */	li r6, 4                                
/* 802FAE70  48 06 48 85 */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
/* 802FAE74  38 60 00 00 */	li r3, 0                                
/* 802FAE78  48 06 0F 85 */	bl GXSetNumTexGens                       /* constant-address: 8035BDFC, symbol: GXSetNumTexGens */
/* 802FAE7C  38 60 00 0D */	li r3, 0xd                              
/* 802FAE80  38 80 00 00 */	li r4, 0                                
/* 802FAE84  48 06 00 35 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */

...
/* 802FBE68  38 E6 1C 30 */	addi r7, r6, lit_3028@l                  /* constant-address: 803A1C30, symbol: lit_3028 */
/* 802FBE6C  80 C7 00 00 */	lwz r6, 0(r7)                            /* constant-address: 803A1C30, symbol: lit_3028 */
/* 802FBE70  80 07 00 04 */	lwz r0, 4(r7)                            /* constant-address: 803A1C34, symbol: None */
/* 802FBE74  90 C1 00 08 */	stw r6, 8(r1)                           
/* 802FBE78  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 802FBE7C  80 C7 00 08 */	lwz r6, 8(r7)                            /* constant-address: 803A1C38, symbol: None */
/* 802FBE80  80 07 00 0C */	lwz r0, 0xc(r7)                          /* constant-address: 803A1C3C, symbol: None */
...
/* 802FBEB4  40 80 00 0C */	bge lbl_802FBEC0                         /* constant-address: 802FBEC0, symbol: lbl_802FBEC0 */
/* 802FBEB8  54 A0 06 3F */	clrlwi. r0, r5, 0x18                    
/* 802FBEBC  41 82 00 0C */	beq lbl_802FBEC8                         /* constant-address: 802FBEC8, symbol: lbl_802FBEC8 */
lbl_802FBEC0:
/* 802FBEC0  38 60 00 00 */	li r3, 0                                
/* 802FBEC4  48 00 00 10 */	b lbl_802FBED4                           /* constant-address: 802FBED4, symbol: lbl_802FBED4 */
lbl_802FBEC8:

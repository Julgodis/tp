...
/* 802E8BFC  C0 02 C7 48 */	lfs f0, lit_627(r2)                      /* constant-address: 80456148, symbol: lit_627 */
/* 802E8C00  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802E8C04  40 80 00 08 */	bge lbl_802E8C0C                         /* constant-address: 802E8C0C, symbol: lbl_802E8C0C */
/* 802E8C08  FC 20 00 90 */	fmr f1, f0                              
lbl_802E8C0C:
/* 802E8C0C  C0 02 C7 48 */	lfs f0, lit_627(r2)                      /* constant-address: 80456148, symbol: lit_627 */
/* 802E8C10  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 802E8C14  40 80 00 08 */	bge lbl_802E8C1C                         /* constant-address: 802E8C1C, symbol: lbl_802E8C1C */
/* 802E8C18  FC 40 00 90 */	fmr f2, f0                              
lbl_802E8C1C:
/* 802E8C1C  EC 63 08 28 */	fsubs f3, f3, f1                        
/* 802E8C20  EC 84 10 28 */	fsubs f4, f4, f2                        
/* 802E8C24  C0 A2 C7 48 */	lfs f5, lit_627(r2)                      /* constant-address: 80456148, symbol: lit_627 */
/* 802E8C28  C0 C2 C7 4C */	lfs f6, lit_628(r2)                      /* constant-address: 8045614C, symbol: lit_628 */
/* 802E8C2C  48 07 78 39 */	bl GXSetViewport                         /* constant-address: 80360464, symbol: GXSetViewport */

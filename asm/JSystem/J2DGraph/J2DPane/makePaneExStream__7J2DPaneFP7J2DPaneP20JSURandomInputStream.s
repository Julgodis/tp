...
/* 802F7B28  48 06 A6 B5 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802F7B58  4B FE 47 41 */	bl read__14JSUInputStreamFPvl            /* constant-address: 802DC298, symbol: read__14JSUInputStreamFPvl */
...
/* 802F7BE8  40 82 00 10 */	bne lbl_802F7BF8                         /* constant-address: 802F7BF8, symbol: lbl_802F7BF8 */
/* 802F7BEC  C0 02 C7 F0 */	lfs f0, lit_1469(r2)                     /* constant-address: 804561F0, symbol: lit_1469 */
/* 802F7BF0  D0 1E 00 C4 */	stfs f0, 0xc4(r30)                      
/* 802F7BF4  48 00 00 28 */	b lbl_802F7C1C                           /* constant-address: 802F7C1C, symbol: lbl_802F7C1C */
lbl_802F7BF8:
/* 802F7BF8  2C 00 00 01 */	cmpwi r0, 1                             
/* 802F7BFC  40 82 00 18 */	bne lbl_802F7C14                         /* constant-address: 802F7C14, symbol: lbl_802F7C14 */
/* 802F7C00  C0 21 00 28 */	lfs f1, 0x28(r1)                        
/* 802F7C04  C0 02 C8 08 */	lfs f0, lit_1725(r2)                     /* constant-address: 80456208, symbol: lit_1725 */
/* 802F7C08  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802F7C0C  D0 1E 00 C4 */	stfs f0, 0xc4(r30)                      
/* 802F7C10  48 00 00 0C */	b lbl_802F7C1C                           /* constant-address: 802F7C1C, symbol: lbl_802F7C1C */
lbl_802F7C14:
...
/* 802F7C28  40 82 00 10 */	bne lbl_802F7C38                         /* constant-address: 802F7C38, symbol: lbl_802F7C38 */
/* 802F7C2C  C0 02 C7 F0 */	lfs f0, lit_1469(r2)                     /* constant-address: 804561F0, symbol: lit_1469 */
/* 802F7C30  D0 1E 00 C8 */	stfs f0, 0xc8(r30)                      
/* 802F7C34  48 00 00 28 */	b lbl_802F7C5C                           /* constant-address: 802F7C5C, symbol: lbl_802F7C5C */
lbl_802F7C38:
/* 802F7C38  2C 00 00 01 */	cmpwi r0, 1                             
/* 802F7C3C  40 82 00 18 */	bne lbl_802F7C54                         /* constant-address: 802F7C54, symbol: lbl_802F7C54 */
/* 802F7C40  C0 21 00 2C */	lfs f1, 0x2c(r1)                        
/* 802F7C44  C0 02 C8 08 */	lfs f0, lit_1725(r2)                     /* constant-address: 80456208, symbol: lit_1725 */
/* 802F7C48  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802F7C4C  D0 1E 00 C8 */	stfs f0, 0xc8(r30)                      
/* 802F7C50  48 00 00 0C */	b lbl_802F7C5C                           /* constant-address: 802F7C5C, symbol: lbl_802F7C5C */
lbl_802F7C54:
...
/* 802F7CA8  41 82 00 18 */	beq lbl_802F7CC0                         /* constant-address: 802F7CC0, symbol: lbl_802F7CC0 */
/* 802F7CAC  34 9E 00 DC */	addic. r4, r30, 0xdc                    
/* 802F7CB0  41 82 00 08 */	beq lbl_802F7CB8                         /* constant-address: 802F7CB8, symbol: lbl_802F7CB8 */
/* 802F7CB4  38 84 00 0C */	addi r4, r4, 0xc                        
lbl_802F7CB8:
/* 802F7CB8  38 7F 00 DC */	addi r3, r31, 0xdc                      
/* 802F7CBC  4B FE 42 91 */	bl append__10JSUPtrListFP10JSUPtrLink    /* constant-address: 802DBF4C, symbol: append__10JSUPtrListFP10JSUPtrLink */
lbl_802F7CC0:
...
/* 802F7CEC  48 06 A5 3D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

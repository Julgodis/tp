...
/* 802F7598  C0 62 C7 F0 */	lfs f3, lit_1469(r2)                     /* constant-address: 804561F0, symbol: lit_1469 */
/* 802F759C  48 04 F3 4D */	bl PSMTXTrans                            /* constant-address: 803468E8, symbol: PSMTXTrans */
/* 802F75A0  38 61 00 F8 */	addi r3, r1, 0xf8                       
/* 802F75A4  38 80 00 78 */	li r4, 0x78                             
/* 802F75A8  C0 22 C8 0C */	lfs f1, lit_2466(r2)                     /* constant-address: 8045620C, symbol: lit_2466 */
/* 802F75AC  C0 1F 00 B8 */	lfs f0, 0xb8(r31)                       
/* 802F75B0  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 802F75B4  48 04 F0 F5 */	bl PSMTXRotRad                           /* constant-address: 803466A8, symbol: PSMTXRotRad */
/* 802F75B8  38 61 00 C8 */	addi r3, r1, 0xc8                       
/* 802F75BC  38 80 00 79 */	li r4, 0x79                             
/* 802F75C0  C0 22 C8 0C */	lfs f1, lit_2466(r2)                     /* constant-address: 8045620C, symbol: lit_2466 */
/* 802F75C4  C0 1F 00 BC */	lfs f0, 0xbc(r31)                       
/* 802F75C8  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 802F75CC  48 04 F0 DD */	bl PSMTXRotRad                           /* constant-address: 803466A8, symbol: PSMTXRotRad */
/* 802F75D0  38 61 00 98 */	addi r3, r1, 0x98                       
/* 802F75D4  38 80 00 7A */	li r4, 0x7a                             
/* 802F75D8  C0 22 C8 0C */	lfs f1, lit_2466(r2)                     /* constant-address: 8045620C, symbol: lit_2466 */
/* 802F75DC  C0 1F 00 C0 */	lfs f0, 0xc0(r31)                       
/* 802F75E0  FC 00 00 50 */	fneg f0, f0                             
/* 802F75E4  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 802F75E8  48 04 F0 C1 */	bl PSMTXRotRad                           /* constant-address: 803466A8, symbol: PSMTXRotRad */
/* 802F75EC  38 61 00 98 */	addi r3, r1, 0x98                       
/* 802F75F0  38 81 00 F8 */	addi r4, r1, 0xf8                       
/* 802F75F4  38 A1 00 08 */	addi r5, r1, 8                          
/* 802F75F8  48 04 EE ED */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 802F75FC  38 61 00 C8 */	addi r3, r1, 0xc8                       
/* 802F7600  38 81 00 08 */	addi r4, r1, 8                          
/* 802F7604  38 A1 00 68 */	addi r5, r1, 0x68                       
/* 802F7608  48 04 EE DD */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
...
/* 802F761C  C0 62 C7 F4 */	lfs f3, lit_1489(r2)                     /* constant-address: 804561F4, symbol: lit_1489 */
/* 802F7620  48 04 F3 71 */	bl PSMTXScaleApply                       /* constant-address: 80346990, symbol: PSMTXScaleApply */
/* 802F7624  38 61 00 68 */	addi r3, r1, 0x68                       
/* 802F7628  38 9F 00 50 */	addi r4, r31, 0x50                      
/* 802F762C  38 A1 00 08 */	addi r5, r1, 8                          
/* 802F7630  48 04 EE B5 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
...
/* 802F7644  C0 62 C7 F0 */	lfs f3, lit_1469(r2)                     /* constant-address: 804561F0, symbol: lit_1469 */
/* 802F7648  48 04 F2 D5 */	bl PSMTXTransApply                       /* constant-address: 8034691C, symbol: PSMTXTransApply */

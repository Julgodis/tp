...
/* 802F59D0  48 06 C8 09 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802F59EC  41 82 00 0C */	beq lbl_802F59F8                         /* constant-address: 802F59F8, symbol: lbl_802F59F8 */
/* 802F59F0  7F E3 FB 78 */	mr r3, r31                              
/* 802F59F4  48 00 00 B8 */	b lbl_802F5AAC                           /* constant-address: 802F5AAC, symbol: lbl_802F5AAC */
lbl_802F59F8:
...
/* 802F5A08  40 82 00 18 */	bne lbl_802F5A20                         /* constant-address: 802F5A20, symbol: lbl_802F5A20 */
/* 802F5A0C  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 802F5A10  38 81 00 08 */	addi r4, r1, 8                          
/* 802F5A14  7C E5 3B 78 */	mr r5, r7                               
/* 802F5A18  48 07 31 E9 */	bl strtol                                /* constant-address: 80368C00, symbol: strtol */
/* 802F5A1C  48 00 00 50 */	b lbl_802F5A6C                           /* constant-address: 802F5A6C, symbol: lbl_802F5A6C */
lbl_802F5A20:
/* 802F5A20  2C 07 00 10 */	cmpwi r7, 0x10                          
/* 802F5A24  40 82 00 48 */	bne lbl_802F5A6C                         /* constant-address: 802F5A6C, symbol: lbl_802F5A6C */
/* 802F5A28  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 802F5A2C  38 81 00 08 */	addi r4, r1, 8                          
/* 802F5A30  7C E5 3B 78 */	mr r5, r7                               
/* 802F5A34  48 07 32 BD */	bl strtoul                               /* constant-address: 80368CF0, symbol: strtoul */
...
/* 802F5A48  41 82 00 24 */	beq lbl_802F5A6C                         /* constant-address: 802F5A6C, symbol: lbl_802F5A6C */
/* 802F5A4C  28 00 00 06 */	cmplwi r0, 6                            
/* 802F5A50  40 82 00 10 */	bne lbl_802F5A60                         /* constant-address: 802F5A60, symbol: lbl_802F5A60 */
/* 802F5A54  54 60 40 2E */	slwi r0, r3, 8                          
/* 802F5A58  60 03 00 FF */	ori r3, r0, 0xff                        
/* 802F5A5C  48 00 00 10 */	b lbl_802F5A6C                           /* constant-address: 802F5A6C, symbol: lbl_802F5A6C */
lbl_802F5A60:
/* 802F5A60  93 BE 00 00 */	stw r29, 0(r30)                         
/* 802F5A64  7F 83 E3 78 */	mr r3, r28                              
/* 802F5A68  48 00 00 44 */	b lbl_802F5AAC                           /* constant-address: 802F5AAC, symbol: lbl_802F5AAC */
lbl_802F5A6C:
/* 802F5A6C  80 81 00 08 */	lwz r4, 8(r1)                           
/* 802F5A70  88 04 00 00 */	lbz r0, 0(r4)                           
/* 802F5A74  2C 00 00 5D */	cmpwi r0, 0x5d                          
/* 802F5A78  41 82 00 10 */	beq lbl_802F5A88                         /* constant-address: 802F5A88, symbol: lbl_802F5A88 */
/* 802F5A7C  93 BE 00 00 */	stw r29, 0(r30)                         
/* 802F5A80  7F 83 E3 78 */	mr r3, r28                              
/* 802F5A84  48 00 00 28 */	b lbl_802F5AAC                           /* constant-address: 802F5AAC, symbol: lbl_802F5AAC */
lbl_802F5A88:
/* 802F5A88  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 802F5A8C  7C 00 20 40 */	cmplw r0, r4                            
/* 802F5A90  40 82 00 14 */	bne lbl_802F5AA4                         /* constant-address: 802F5AA4, symbol: lbl_802F5AA4 */
/* 802F5A94  38 04 00 01 */	addi r0, r4, 1                          
/* 802F5A98  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802F5A9C  7F E3 FB 78 */	mr r3, r31                              
/* 802F5AA0  48 00 00 0C */	b lbl_802F5AAC                           /* constant-address: 802F5AAC, symbol: lbl_802F5AAC */
lbl_802F5AA4:
/* 802F5AA4  38 04 00 01 */	addi r0, r4, 1                          
/* 802F5AA8  90 1E 00 00 */	stw r0, 0(r30)                          
lbl_802F5AAC:
/* 802F5AAC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802F5AB0  48 06 C7 75 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

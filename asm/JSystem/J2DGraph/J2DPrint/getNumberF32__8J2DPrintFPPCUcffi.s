...
/* 802F5B00  41 82 00 08 */	beq lbl_802F5B08                         /* constant-address: 802F5B08, symbol: lbl_802F5B08 */
/* 802F5B04  48 00 00 CC */	b lbl_802F5BD0                           /* constant-address: 802F5BD0, symbol: lbl_802F5BD0 */
lbl_802F5B08:
...
/* 802F5B18  40 82 00 14 */	bne lbl_802F5B2C                         /* constant-address: 802F5B2C, symbol: lbl_802F5B2C */
/* 802F5B1C  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 802F5B20  38 81 00 08 */	addi r4, r1, 8                          
/* 802F5B24  48 07 30 DD */	bl strtol                                /* constant-address: 80368C00, symbol: strtol */
/* 802F5B28  48 00 00 4C */	b lbl_802F5B74                           /* constant-address: 802F5B74, symbol: lbl_802F5B74 */
lbl_802F5B2C:
/* 802F5B2C  2C 05 00 10 */	cmpwi r5, 0x10                          
/* 802F5B30  40 82 00 44 */	bne lbl_802F5B74                         /* constant-address: 802F5B74, symbol: lbl_802F5B74 */
/* 802F5B34  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 802F5B38  38 81 00 08 */	addi r4, r1, 8                          
/* 802F5B3C  48 07 31 B5 */	bl strtoul                               /* constant-address: 80368CF0, symbol: strtoul */
...
/* 802F5B50  41 82 00 24 */	beq lbl_802F5B74                         /* constant-address: 802F5B74, symbol: lbl_802F5B74 */
/* 802F5B54  28 00 00 06 */	cmplwi r0, 6                            
/* 802F5B58  40 82 00 10 */	bne lbl_802F5B68                         /* constant-address: 802F5B68, symbol: lbl_802F5B68 */
/* 802F5B5C  54 60 40 2E */	slwi r0, r3, 8                          
/* 802F5B60  60 03 00 FF */	ori r3, r0, 0xff                        
/* 802F5B64  48 00 00 10 */	b lbl_802F5B74                           /* constant-address: 802F5B74, symbol: lbl_802F5B74 */
lbl_802F5B68:
/* 802F5B68  93 FE 00 00 */	stw r31, 0(r30)                         
/* 802F5B6C  FC 20 F8 90 */	fmr f1, f31                             
/* 802F5B70  48 00 00 60 */	b lbl_802F5BD0                           /* constant-address: 802F5BD0, symbol: lbl_802F5BD0 */
lbl_802F5B74:
/* 802F5B74  80 81 00 08 */	lwz r4, 8(r1)                           
/* 802F5B78  88 04 00 00 */	lbz r0, 0(r4)                           
/* 802F5B7C  2C 00 00 5D */	cmpwi r0, 0x5d                          
/* 802F5B80  41 82 00 10 */	beq lbl_802F5B90                         /* constant-address: 802F5B90, symbol: lbl_802F5B90 */
/* 802F5B84  93 FE 00 00 */	stw r31, 0(r30)                         
/* 802F5B88  FC 20 F8 90 */	fmr f1, f31                             
/* 802F5B8C  48 00 00 44 */	b lbl_802F5BD0                           /* constant-address: 802F5BD0, symbol: lbl_802F5BD0 */
lbl_802F5B90:
/* 802F5B90  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 802F5B94  7C 00 20 40 */	cmplw r0, r4                            
/* 802F5B98  40 82 00 14 */	bne lbl_802F5BAC                         /* constant-address: 802F5BAC, symbol: lbl_802F5BAC */
/* 802F5B9C  38 04 00 01 */	addi r0, r4, 1                          
/* 802F5BA0  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802F5BA4  FC 20 F0 90 */	fmr f1, f30                             
/* 802F5BA8  48 00 00 28 */	b lbl_802F5BD0                           /* constant-address: 802F5BD0, symbol: lbl_802F5BD0 */
lbl_802F5BAC:
/* 802F5BAC  38 04 00 01 */	addi r0, r4, 1                          
/* 802F5BB0  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802F5BB4  C8 22 C7 D0 */	lfd f1, lit_650(r2)                      /* constant-address: 804561D0, symbol: lit_650 */

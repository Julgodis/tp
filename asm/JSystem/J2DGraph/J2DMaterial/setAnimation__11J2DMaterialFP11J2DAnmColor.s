...
/* 802EA8B8  40 82 00 10 */	bne lbl_802EA8C8                         /* constant-address: 802EA8C8, symbol: lbl_802EA8C8 */
/* 802EA8BC  80 1E 00 84 */	lwz r0, 0x84(r30)                       
/* 802EA8C0  28 00 00 00 */	cmplwi r0, 0                            
/* 802EA8C4  41 82 00 70 */	beq lbl_802EA934                         /* constant-address: 802EA934, symbol: lbl_802EA934 */
lbl_802EA8C8:
/* 802EA8C8  7F C3 F3 78 */	mr r3, r30                              
/* 802EA8CC  4B FF FF 81 */	bl makeAnmPointer__11J2DMaterialFv       /* constant-address: 802EA84C, symbol: makeAnmPointer__11J2DMaterialFv */
/* 802EA8D0  80 7E 00 84 */	lwz r3, 0x84(r30)                       
/* 802EA8D4  93 E3 00 00 */	stw r31, 0(r3)                          
/* 802EA8D8  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 802EA8DC  38 03 FF FF */	addi r0, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 802EA8E0  80 7E 00 84 */	lwz r3, 0x84(r30)                       
/* 802EA8E4  B0 03 00 10 */	sth r0, 0x10(r3)                        
/* 802EA8E8  28 1F 00 00 */	cmplwi r31, 0                           
/* 802EA8EC  41 82 00 48 */	beq lbl_802EA934                         /* constant-address: 802EA934, symbol: lbl_802EA934 */
...
/* 802EA900  48 00 00 28 */	b lbl_802EA928                           /* constant-address: 802EA928, symbol: lbl_802EA928 */
lbl_802EA904:
...
/* 802EA914  40 82 00 10 */	bne lbl_802EA924                         /* constant-address: 802EA924, symbol: lbl_802EA924 */
/* 802EA918  80 7E 00 84 */	lwz r3, 0x84(r30)                       
/* 802EA91C  B0 C3 00 10 */	sth r6, 0x10(r3)                        
/* 802EA920  48 00 00 14 */	b lbl_802EA934                           /* constant-address: 802EA934, symbol: lbl_802EA934 */
lbl_802EA924:
/* 802EA924  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
lbl_802EA928:
/* 802EA928  54 C3 04 3E */	clrlwi r3, r6, 0x10                     
/* 802EA92C  7C 03 00 40 */	cmplw r3, r0                            
/* 802EA930  41 80 FF D4 */	blt lbl_802EA904                         /* constant-address: 802EA904, symbol: lbl_802EA904 */
lbl_802EA934:

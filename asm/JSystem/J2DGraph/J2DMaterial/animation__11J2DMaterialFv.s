...
/* 802EAC9C 00000000  DB 81 00 D0 */	stfd f28, 0xd0(r1)
/* 802EACA0 00000028  F3 81 00 D8 */	psq_st f28, 216(r1), 0, 0 /* qr0 */
/* 802EACA4 00000000  DB 61 00 C0 */	stfd f27, 0xc0(r1)
/* 802EACA8 00000030  F3 61 00 C8 */	psq_st f27, 200(r1), 0, 0 /* qr0 */
/* 802EACAC 00000000  39 61 00 C0 */	addi r11, r1, 0xc0
/* 802EACB0 00000004  48 07 75 21 */	bl _savegpr_26
/* 802EACB4 00000008  7C 7F 1B 78 */	mr r31, r3
/* 802EACB8 0000000C  80 83 00 84 */	lwz r4, 0x84(r3)
/* 802EACBC 00000010  28 04 00 00 */	cmplwi r4, 0
/* 802EACC0 00000014  41 82 03 F4 */	beq lbl_802EB0B4
/* 802EACC4 00000018  80 64 00 00 */	lwz r3, 0(r4)
/* 802EACC8 0000001C  28 03 00 00 */	cmplwi r3, 0
/* 802EACCC 00000020  41 82 00 74 */	beq lbl_802EAD40
/* 802EACD0 00000024  A0 84 00 10 */	lhz r4, 0x10(r4)
/* 802EACD4 00000028  28 04 FF FF */	cmplwi r4, 0xffff
/* 802EACD8 0000002C  41 82 00 68 */	beq lbl_802EAD40
/* 802EACDC 00000030  38 A1 00 20 */	addi r5, r1, 0x20
/* 802EACE0 00000034  81 83 00 00 */	lwz r12, 0(r3)
/* 802EACE4 00000038  81 8C 00 10 */	lwz r12, 0x10(r12)
/* 802EACE8 0000003C  7D 89 03 A6 */	mtctr r12
/* 802EACEC 00000040  4E 80 04 21 */	bctrl 
/* 802EACF0 00000044  80 01 00 20 */	lwz r0, 0x20(r1)
/* 802EACF4 00000048  90 01 00 0C */	stw r0, 0xc(r1)
/* 802EACF8 0000004C  88 01 00 0C */	lbz r0, 0xc(r1)
/* 802EACFC 00000050  98 01 00 14 */	stb r0, 0x14(r1)
/* 802EAD00 00000054  88 01 00 0D */	lbz r0, 0xd(r1)
/* 802EAD04 00000058  98 01 00 15 */	stb r0, 0x15(r1)
/* 802EAD08 0000005C  88 01 00 0E */	lbz r0, 0xe(r1)
/* 802EAD0C 00000060  98 01 00 16 */	stb r0, 0x16(r1)
/* 802EAD10 00000064  88 01 00 0F */	lbz r0, 0xf(r1)
/* 802EAD14 00000068  98 01 00 17 */	stb r0, 0x17(r1)
/* 802EAD18 0000006C  80 01 00 14 */	lwz r0, 0x14(r1)
/* 802EAD1C 00000070  90 01 00 18 */	stw r0, 0x18(r1)
/* 802EAD20 00000074  88 01 00 18 */	lbz r0, 0x18(r1)
/* 802EAD24 00000078  98 1F 00 10 */	stb r0, 0x10(r31)
/* 802EAD28 0000007C  88 01 00 19 */	lbz r0, 0x19(r1)
/* 802EAD2C 00000080  98 1F 00 11 */	stb r0, 0x11(r31)
/* 802EAD30 00000084  88 01 00 1A */	lbz r0, 0x1a(r1)
/* 802EAD34 00000088  98 1F 00 12 */	stb r0, 0x12(r31)
/* 802EAD38 0000008C  88 01 00 1B */	lbz r0, 0x1b(r1)
/* 802EAD3C 00000090  98 1F 00 13 */	stb r0, 0x13(r31)
lbl_802EAD40:
...
/* 802EB0B8 00000000  CB E1 01 00 */	lfd f31, 0x100(r1)
/* 802EB0BC 00000008  E3 C1 00 F8 */	psq_l f30, 248(r1), 0, 0 /* qr0 */
/* 802EB0C0 00000000  CB C1 00 F0 */	lfd f30, 0xf0(r1)
/* 802EB0C4 00000010  E3 A1 00 E8 */	psq_l f29, 232(r1), 0, 0 /* qr0 */
/* 802EB0C8 00000000  CB A1 00 E0 */	lfd f29, 0xe0(r1)
/* 802EB0CC 00000018  E3 81 00 D8 */	psq_l f28, 216(r1), 0, 0 /* qr0 */
/* 802EB0D0 00000000  CB 81 00 D0 */	lfd f28, 0xd0(r1)
/* 802EB0D4 00000020  E3 61 00 C8 */	psq_l f27, 200(r1), 0, 0 /* qr0 */
/* 802EB0D8 00000000  CB 61 00 C0 */	lfd f27, 0xc0(r1)
/* 802EB0DC 00000004  39 61 00 C0 */	addi r11, r1, 0xc0
/* 802EB0E0 00000008  48 07 71 3D */	bl _restgpr_26
/* 802EB0E4 0000000C  80 01 01 14 */	lwz r0, 0x114(r1)
/* 802EB0E8 00000010  7C 08 03 A6 */	mtlr r0
/* 802EB0EC 00000014  38 21 01 10 */	addi r1, r1, 0x110
/* 802EB0F0 00000018  4E 80 00 20 */	blr 

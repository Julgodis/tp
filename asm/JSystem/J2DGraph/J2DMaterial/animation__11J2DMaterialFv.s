...
/* 802EACB0  48 07 75 21 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 802EACB4  7C 7F 1B 78 */	mr r31, r3                              
/* 802EACB8  80 83 00 84 */	lwz r4, 0x84(r3)                        
/* 802EACBC  28 04 00 00 */	cmplwi r4, 0                            
/* 802EACC0  41 82 03 F4 */	beq lbl_802EB0B4                         /* constant-address: 802EB0B4, symbol: lbl_802EB0B4 */
/* 802EACC4  80 64 00 00 */	lwz r3, 0(r4)                           
/* 802EACC8  28 03 00 00 */	cmplwi r3, 0                            
/* 802EACCC  41 82 00 74 */	beq lbl_802EAD40                         /* constant-address: 802EAD40, symbol: lbl_802EAD40 */
/* 802EACD0  A0 84 00 10 */	lhz r4, 0x10(r4)                        
/* 802EACD4  28 04 FF FF */	cmplwi r4, 0xffff                       
/* 802EACD8  41 82 00 68 */	beq lbl_802EAD40                         /* constant-address: 802EAD40, symbol: lbl_802EAD40 */
...
/* 802EAD4C  41 82 01 38 */	beq lbl_802EAE84                         /* constant-address: 802EAE84, symbol: lbl_802EAE84 */
/* 802EAD50  3B 80 00 00 */	li r28, 0                               
/* 802EAD54  3B 60 00 00 */	li r27, 0                               
/* 802EAD58  3C 60 80 3A */	lis r3, j2dDefaultTexMtxInfo@ha         
/* 802EAD5C  3B C3 1B A0 */	addi r30, r3, j2dDefaultTexMtxInfo@l     /* constant-address: 803A1BA0, symbol: j2dDefaultTexMtxInfo */
/* 802EAD60  48 00 01 18 */	b lbl_802EAE78                           /* constant-address: 802EAE78, symbol: lbl_802EAE78 */
lbl_802EAD64:
...
/* 802EAD7C  41 82 00 F4 */	beq lbl_802EAE70                         /* constant-address: 802EAE70, symbol: lbl_802EAE70 */
/* 802EAD80  80 65 00 04 */	lwz r3, 4(r5)                           
/* 802EAD84  C0 23 00 08 */	lfs f1, 8(r3)                           
/* 802EAD88  38 A1 00 34 */	addi r5, r1, 0x34                       
/* 802EAD8C  48 02 0C 65 */	bl calcTransform__19J2DAnmTextureSRTKeyCFfUsP17J3DTextureSRTInfo /* constant-address: 8030B9F0, symbol: calcTransform__19J2DAnmTextureSRTKeyCFfUsP17J3DTextureSRTInfo */
/* 802EAD90  C3 E1 00 34 */	lfs f31, 0x34(r1)                       
/* 802EAD94  C3 C1 00 38 */	lfs f30, 0x38(r1)                       
/* 802EAD98  C0 42 C7 B0 */	lfs f2, lit_1943(r2)                     /* constant-address: 804561B0, symbol: lit_1943 */
/* 802EAD9C  A8 01 00 3C */	lha r0, 0x3c(r1)                        
/* 802EADA0  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 802EADA4  C8 22 C7 B8 */	lfd f1, lit_1946(r2)                     /* constant-address: 804561B8, symbol: lit_1946 */
...
/* 802EADC0  C0 02 C7 B4 */	lfs f0, lit_1944(r2)                     /* constant-address: 804561B4, symbol: lit_1944 */
/* 802EADC4  EF A1 00 24 */	fdivs f29, f1, f0                       
/* 802EADC8  C3 81 00 40 */	lfs f28, 0x40(r1)                       
/* 802EADCC  C3 61 00 44 */	lfs f27, 0x44(r1)                       
/* 802EADD0  C0 1E 00 04 */	lfs f0, 4(r30)                           /* constant-address: 803A1BA4, symbol: None */
/* 802EADD4  D0 01 00 4C */	stfs f0, 0x4c(r1)                       
/* 802EADD8  C0 1E 00 08 */	lfs f0, 8(r30)                           /* constant-address: 803A1BA8, symbol: None */
/* 802EADDC  D0 01 00 50 */	stfs f0, 0x50(r1)                       
/* 802EADE0  C0 1E 00 0C */	lfs f0, 0xc(r30)                         /* constant-address: 803A1BAC, symbol: None */
/* 802EADE4  D0 01 00 54 */	stfs f0, 0x54(r1)                       
/* 802EADE8  3C 60 80 3A */	lis r3, j2dDefaultTexMtxInfo@ha         
/* 802EADEC  88 03 1B A0 */	lbz r0, j2dDefaultTexMtxInfo@l(r3)       /* constant-address: 803A1BA0, symbol: j2dDefaultTexMtxInfo */
/* 802EADF0  98 01 00 48 */	stb r0, 0x48(r1)                        
/* 802EADF4  88 1E 00 01 */	lbz r0, 1(r30)                           /* constant-address: 803A1BA1, symbol: None */
/* 802EADF8  98 01 00 49 */	stb r0, 0x49(r1)                        
/* 802EADFC  C0 1E 00 10 */	lfs f0, 0x10(r30)                        /* constant-address: 803A1BB0, symbol: None */
/* 802EAE00  D0 01 00 58 */	stfs f0, 0x58(r1)                       
/* 802EAE04  C0 1E 00 14 */	lfs f0, 0x14(r30)                        /* constant-address: 803A1BB4, symbol: None */
/* 802EAE08  D0 01 00 5C */	stfs f0, 0x5c(r1)                       
/* 802EAE0C  C0 1E 00 18 */	lfs f0, 0x18(r30)                        /* constant-address: 803A1BB8, symbol: None */
/* 802EAE10  D0 01 00 60 */	stfs f0, 0x60(r1)                       
/* 802EAE14  C0 1E 00 1C */	lfs f0, 0x1c(r30)                        /* constant-address: 803A1BBC, symbol: None */
/* 802EAE18  D0 01 00 64 */	stfs f0, 0x64(r1)                       
/* 802EAE1C  C0 1E 00 20 */	lfs f0, 0x20(r30)                        /* constant-address: 803A1BC0, symbol: None */
...
/* 802EAE30  48 00 09 B1 */	bl getTexMtx__14J2DTexGenBlockFUlR9J2DTexMtx /* constant-address: 802EB7E0, symbol: getTexMtx__14J2DTexGenBlockFUlR9J2DTexMtx */
...
/* 802EAE54  48 00 08 51 */	bl setTexMtx__14J2DTexGenBlockFUlR9J2DTexMtx /* constant-address: 802EB6A4, symbol: setTexMtx__14J2DTexGenBlockFUlR9J2DTexMtx */
...
/* 802EAE68  38 1B 00 1E */	addi r0, r27, 0x1e                       /* constant-address: 0000001E */
/* 802EAE6C  98 03 00 02 */	stb r0, 2(r3)                           
lbl_802EAE70:
/* 802EAE70  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 802EAE74  3B 7B 00 03 */	addi r27, r27, 3                         /* constant-address: 00000003 */
lbl_802EAE78:
/* 802EAE78  57 80 06 3E */	clrlwi r0, r28, 0x18                    
/* 802EAE7C  28 00 00 08 */	cmplwi r0, 8                            
/* 802EAE80  41 80 FE E4 */	blt lbl_802EAD64                         /* constant-address: 802EAD64, symbol: lbl_802EAD64 */
lbl_802EAE84:
/* 802EAE84  80 1F 00 70 */	lwz r0, 0x70(r31)                       
/* 802EAE88  28 00 00 00 */	cmplwi r0, 0                            
/* 802EAE8C  41 82 01 20 */	beq lbl_802EAFAC                         /* constant-address: 802EAFAC, symbol: lbl_802EAFAC */
/* 802EAE90  80 7F 00 84 */	lwz r3, 0x84(r31)                       
/* 802EAE94  80 03 00 08 */	lwz r0, 8(r3)                           
/* 802EAE98  28 00 00 00 */	cmplwi r0, 0                            
/* 802EAE9C  41 82 01 10 */	beq lbl_802EAFAC                         /* constant-address: 802EAFAC, symbol: lbl_802EAFAC */
/* 802EAEA0  3B 80 00 00 */	li r28, 0                               
/* 802EAEA4  48 00 00 FC */	b lbl_802EAFA0                           /* constant-address: 802EAFA0, symbol: lbl_802EAFA0 */
lbl_802EAEA8:
...
/* 802EAEC0  41 82 00 DC */	beq lbl_802EAF9C                         /* constant-address: 802EAF9C, symbol: lbl_802EAF9C */
...
/* 802EAEE0  41 82 00 BC */	beq lbl_802EAF9C                         /* constant-address: 802EAF9C, symbol: lbl_802EAF9C */
...
/* 802EAEFC  48 02 0F ED */	bl getTexNo__16J2DAnmTexPatternCFUsPUs   /* constant-address: 8030BEE8, symbol: getTexNo__16J2DAnmTexPatternCFUsPUs */
...
/* 802EAF28  48 02 10 75 */	bl getResTIMG__16J2DAnmTexPatternCFUs    /* constant-address: 8030BF9C, symbol: getResTIMG__16J2DAnmTexPatternCFUs */
/* 802EAF2C  7C 7E 1B 78 */	mr r30, r3                              
/* 802EAF30  80 1D 00 20 */	lwz r0, 0x20(r29)                       
/* 802EAF34  7C 00 F0 40 */	cmplw r0, r30                           
/* 802EAF38  41 82 00 64 */	beq lbl_802EAF9C                         /* constant-address: 802EAF9C, symbol: lbl_802EAF9C */
...
/* 802EAF4C  41 82 00 44 */	beq lbl_802EAF90                         /* constant-address: 802EAF90, symbol: lbl_802EAF90 */
/* 802EAF50  80 7F 00 84 */	lwz r3, 0x84(r31)                       
/* 802EAF54  80 63 00 08 */	lwz r3, 8(r3)                           
/* 802EAF58  7F 44 D3 78 */	mr r4, r26                              
/* 802EAF5C  48 02 10 95 */	bl getPalette__16J2DAnmTexPatternCFUs    /* constant-address: 8030BFF0, symbol: getPalette__16J2DAnmTexPatternCFUs */
/* 802EAF60  7C 65 1B 78 */	mr r5, r3                               
/* 802EAF64  A0 03 00 14 */	lhz r0, 0x14(r3)                        
/* 802EAF68  28 00 01 00 */	cmplwi r0, 0x100                        
/* 802EAF6C  40 81 00 20 */	ble lbl_802EAF8C                         /* constant-address: 802EAF8C, symbol: lbl_802EAF8C */
...
/* 802EAF88  48 00 00 08 */	b lbl_802EAF90                           /* constant-address: 802EAF90, symbol: lbl_802EAF90 */
lbl_802EAF8C:
/* 802EAF8C  7F 66 DB 78 */	mr r6, r27                              
lbl_802EAF90:
/* 802EAF90  7F A3 EB 78 */	mr r3, r29                              
/* 802EAF94  7F C4 F3 78 */	mr r4, r30                              
/* 802EAF98  4B FF 34 E9 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette7_GXTlut /* constant-address: 802DE480, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette7_GXTlut */
lbl_802EAF9C:
/* 802EAF9C  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
lbl_802EAFA0:
/* 802EAFA0  57 80 06 3E */	clrlwi r0, r28, 0x18                    
/* 802EAFA4  28 00 00 08 */	cmplwi r0, 8                            
/* 802EAFA8  41 80 FF 00 */	blt lbl_802EAEA8                         /* constant-address: 802EAEA8, symbol: lbl_802EAEA8 */
lbl_802EAFAC:
/* 802EAFAC  80 1F 00 70 */	lwz r0, 0x70(r31)                       
/* 802EAFB0  28 00 00 00 */	cmplwi r0, 0                            
/* 802EAFB4  41 82 01 00 */	beq lbl_802EB0B4                         /* constant-address: 802EB0B4, symbol: lbl_802EB0B4 */
/* 802EAFB8  80 7F 00 84 */	lwz r3, 0x84(r31)                       
/* 802EAFBC  80 03 00 0C */	lwz r0, 0xc(r3)                         
/* 802EAFC0  28 00 00 00 */	cmplwi r0, 0                            
/* 802EAFC4  41 82 00 F0 */	beq lbl_802EB0B4                         /* constant-address: 802EB0B4, symbol: lbl_802EB0B4 */
/* 802EAFC8  3B 40 00 00 */	li r26, 0                               
/* 802EAFCC  48 00 00 6C */	b lbl_802EB038                           /* constant-address: 802EB038, symbol: lbl_802EB038 */
lbl_802EAFD0:
...
/* 802EAFE8  41 82 00 4C */	beq lbl_802EB034                         /* constant-address: 802EB034, symbol: lbl_802EB034 */
/* 802EAFEC  80 65 00 0C */	lwz r3, 0xc(r5)                         
/* 802EAFF0  38 A1 00 2C */	addi r5, r1, 0x2c                       
/* 802EAFF4  48 02 10 FD */	bl getTevColorReg__15J2DAnmTevRegKeyCFUsP11_GXColorS10 /* constant-address: 8030C0F0, symbol: getTevColorReg__15J2DAnmTevRegKeyCFUsP11_GXColorS10 */
...
lbl_802EB034:
/* 802EB034  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
lbl_802EB038:
/* 802EB038  57 40 06 3E */	clrlwi r0, r26, 0x18                    
/* 802EB03C  28 00 00 04 */	cmplwi r0, 4                            
/* 802EB040  41 80 FF 90 */	blt lbl_802EAFD0                         /* constant-address: 802EAFD0, symbol: lbl_802EAFD0 */
/* 802EB044  3B 40 00 00 */	li r26, 0                               
/* 802EB048  48 00 00 60 */	b lbl_802EB0A8                           /* constant-address: 802EB0A8, symbol: lbl_802EB0A8 */
lbl_802EB04C:
...
/* 802EB064  41 82 00 40 */	beq lbl_802EB0A4                         /* constant-address: 802EB0A4, symbol: lbl_802EB0A4 */
...
/* 802EB07C  48 02 13 39 */	bl getTevKonstReg__15J2DAnmTevRegKeyCFUsP8_GXColor /* constant-address: 8030C3B4, symbol: getTevKonstReg__15J2DAnmTevRegKeyCFUsP8_GXColor */
...
lbl_802EB0A4:
/* 802EB0A4  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
lbl_802EB0A8:
/* 802EB0A8  57 40 06 3E */	clrlwi r0, r26, 0x18                    
/* 802EB0AC  28 00 00 04 */	cmplwi r0, 4                            
/* 802EB0B0  41 80 FF 9C */	blt lbl_802EB04C                         /* constant-address: 802EB04C, symbol: lbl_802EB04C */
lbl_802EB0B4:
...
/* 802EB0E0  48 07 71 3D */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

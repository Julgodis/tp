...
/* 802EAB28  40 82 00 10 */	bne lbl_802EAB38                         /* constant-address: 802EAB38, symbol: lbl_802EAB38 */
/* 802EAB2C  80 1E 00 84 */	lwz r0, 0x84(r30)                       
/* 802EAB30  28 00 00 00 */	cmplwi r0, 0                            
/* 802EAB34  41 82 01 2C */	beq lbl_802EAC60                         /* constant-address: 802EAC60, symbol: lbl_802EAC60 */
lbl_802EAB38:
/* 802EAB38  7F C3 F3 78 */	mr r3, r30                              
/* 802EAB3C  4B FF FD 11 */	bl makeAnmPointer__11J2DMaterialFv       /* constant-address: 802EA84C, symbol: makeAnmPointer__11J2DMaterialFv */
...
/* 802EAB50  38 A4 FF FF */	addi r5, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EAB6C  42 00 FF F0 */	bdnz lbl_802EAB5C                        /* constant-address: 802EAB5C, symbol: lbl_802EAB5C */
/* 802EAB70  28 1F 00 00 */	cmplwi r31, 0                           
/* 802EAB74  41 82 00 60 */	beq lbl_802EABD4                         /* constant-address: 802EABD4, symbol: lbl_802EABD4 */
...
/* 802EAB88  48 00 00 40 */	b lbl_802EABC8                           /* constant-address: 802EABC8, symbol: lbl_802EABC8 */
lbl_802EAB8C:
...
/* 802EABA0  40 82 00 24 */	bne lbl_802EABC4                         /* constant-address: 802EABC4, symbol: lbl_802EABC4 */
...
lbl_802EABC4:
/* 802EABC4  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000001 */
lbl_802EABC8:
/* 802EABC8  55 03 04 3E */	clrlwi r3, r8, 0x10                     
/* 802EABCC  7C 03 00 40 */	cmplw r3, r0                            
/* 802EABD0  41 80 FF BC */	blt lbl_802EAB8C                         /* constant-address: 802EAB8C, symbol: lbl_802EAB8C */
lbl_802EABD4:
/* 802EABD4  38 60 00 00 */	li r3, 0                                
/* 802EABD8  3C 80 00 01 */	lis r4, 0x0001 /* 0x0000FFFF@ha */      
/* 802EABDC  38 A4 FF FF */	addi r5, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EABF8  42 00 FF F0 */	bdnz lbl_802EABE8                        /* constant-address: 802EABE8, symbol: lbl_802EABE8 */
/* 802EABFC  28 1F 00 00 */	cmplwi r31, 0                           
/* 802EAC00  41 82 00 60 */	beq lbl_802EAC60                         /* constant-address: 802EAC60, symbol: lbl_802EAC60 */
...
/* 802EAC14  48 00 00 40 */	b lbl_802EAC54                           /* constant-address: 802EAC54, symbol: lbl_802EAC54 */
lbl_802EAC18:
...
/* 802EAC2C  40 82 00 24 */	bne lbl_802EAC50                         /* constant-address: 802EAC50, symbol: lbl_802EAC50 */
...
lbl_802EAC50:
/* 802EAC50  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000001 */
lbl_802EAC54:
/* 802EAC54  55 03 04 3E */	clrlwi r3, r8, 0x10                     
/* 802EAC58  7C 03 00 40 */	cmplw r3, r0                            
/* 802EAC5C  41 80 FF BC */	blt lbl_802EAC18                         /* constant-address: 802EAC18, symbol: lbl_802EAC18 */
lbl_802EAC60:

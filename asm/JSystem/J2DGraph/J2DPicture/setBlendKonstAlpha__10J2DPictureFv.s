...
/* 802FEBA4  C0 62 C8 6C */	lfs f3, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FEBA8  48 00 00 84 */	b lbl_802FEC2C                           /* constant-address: 802FEC2C, symbol: lbl_802FEC2C */
lbl_802FEBAC:
/* 802FEBAC  C0 82 C8 6C */	lfs f4, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FEBB0  39 20 00 00 */	li r9, 0                                
/* 802FEBB4  55 05 06 3E */	clrlwi r5, r8, 0x18                     
/* 802FEBB8  48 00 00 18 */	b lbl_802FEBD0                           /* constant-address: 802FEBD0, symbol: lbl_802FEBD0 */
lbl_802FEBBC:
...
/* 802FEBCC  39 29 00 01 */	addi r9, r9, 1                           /* constant-address: 00000001 */
lbl_802FEBD0:
/* 802FEBD0  55 20 06 3E */	clrlwi r0, r9, 0x18                     
/* 802FEBD4  7C 00 28 40 */	cmplw r0, r5                            
/* 802FEBD8  41 80 FF E4 */	blt lbl_802FEBBC                         /* constant-address: 802FEBBC, symbol: lbl_802FEBBC */
...
/* 802FEBF0  41 82 00 38 */	beq lbl_802FEC28                         /* constant-address: 802FEC28, symbol: lbl_802FEC28 */
/* 802FEBF4  C0 42 C8 78 */	lfs f2, lit_2758(r2)                     /* constant-address: 80456278, symbol: lit_2758 */
/* 802FEBF8  C0 22 C8 68 */	lfs f1, lit_1767(r2)                     /* constant-address: 80456268, symbol: lit_1767 */
...
lbl_802FEC28:
/* 802FEC28  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000002 */
lbl_802FEC2C:
/* 802FEC2C  55 00 06 3E */	clrlwi r0, r8, 0x18                     
/* 802FEC30  7C 00 30 40 */	cmplw r0, r6                            
/* 802FEC34  41 80 FF 78 */	blt lbl_802FEBAC                         /* constant-address: 802FEBAC, symbol: lbl_802FEBAC */

...
/* 802FCCF0  48 00 00 81 */	bl private_initiate__10J2DPictureFPC7ResTIMGPC7ResTLUT /* constant-address: 802FCD70, symbol: private_initiate__10J2DPictureFPC7ResTIMGPC7ResTLUT */
/* 802FCCF4  80 7F 01 00 */	lwz r3, 0x100(r31)                      
/* 802FCCF8  28 03 00 00 */	cmplwi r3, 0                            
/* 802FCCFC  41 82 00 60 */	beq lbl_802FCD5C                         /* constant-address: 802FCD5C, symbol: lbl_802FCD5C */
/* 802FCD00  80 63 00 20 */	lwz r3, 0x20(r3)                        
/* 802FCD04  A0 83 00 04 */	lhz r4, 4(r3)                           
/* 802FCD08  A0 03 00 02 */	lhz r0, 2(r3)                           
/* 802FCD0C  C0 02 C8 6C */	lfs f0, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FCD10  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 802FCD14  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 802FCD18  C8 22 C8 70 */	lfd f1, lit_2021(r2)                     /* constant-address: 80456270, symbol: lit_2021 */
...
/* 802FCD58  4B FF 9F C1 */	bl func_802F6D18                         /* constant-address: 802F6D18, symbol: func_802F6D18 */
lbl_802FCD5C:

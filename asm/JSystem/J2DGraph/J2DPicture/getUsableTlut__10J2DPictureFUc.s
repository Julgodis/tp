...
/* 802FF110  48 00 00 74 */	b lbl_802FF184                           /* constant-address: 802FF184, symbol: lbl_802FF184 */
lbl_802FF114:
/* 802FF114  55 20 06 3E */	clrlwi r0, r9, 0x18                     
/* 802FF118  7C 00 28 40 */	cmplw r0, r5                            
/* 802FF11C  41 82 00 64 */	beq lbl_802FF180                         /* constant-address: 802FF180, symbol: lbl_802FF180 */
...
/* 802FF130  41 82 00 50 */	beq lbl_802FF180                         /* constant-address: 802FF180, symbol: lbl_802FF180 */
/* 802FF134  80 87 00 20 */	lwz r4, 0x20(r7)                        
/* 802FF138  28 04 00 00 */	cmplwi r4, 0                            
/* 802FF13C  41 82 00 44 */	beq lbl_802FF180                         /* constant-address: 802FF180, symbol: lbl_802FF180 */
/* 802FF140  88 04 00 08 */	lbz r0, 8(r4)                           
/* 802FF144  28 00 00 00 */	cmplwi r0, 0                            
/* 802FF148  41 82 00 38 */	beq lbl_802FF180                         /* constant-address: 802FF180, symbol: lbl_802FF180 */
/* 802FF14C  88 87 00 3A */	lbz r4, 0x3a(r7)                        
/* 802FF150  2C 04 00 10 */	cmpwi r4, 0x10                          
/* 802FF154  38 00 00 00 */	li r0, 0                                
/* 802FF158  41 80 00 08 */	blt lbl_802FF160                         /* constant-address: 802FF160, symbol: lbl_802FF160 */
...
/* 802FF16C  40 80 00 14 */	bge lbl_802FF180                         /* constant-address: 802FF180, symbol: lbl_802FF180 */
...
lbl_802FF180:
/* 802FF180  39 29 00 01 */	addi r9, r9, 1                           /* constant-address: 00000001 */
lbl_802FF184:
/* 802FF184  55 20 06 3E */	clrlwi r0, r9, 0x18                     
/* 802FF188  7C 00 30 40 */	cmplw r0, r6                            
/* 802FF18C  41 80 FF 88 */	blt lbl_802FF114                         /* constant-address: 802FF114, symbol: lbl_802FF114 */
...
/* 802FF1A0  48 00 00 20 */	b lbl_802FF1C0                           /* constant-address: 802FF1C0, symbol: lbl_802FF1C0 */
lbl_802FF1A4:
/* 802FF1A4  54 C0 06 3E */	clrlwi r0, r6, 0x18                     
/* 802FF1A8  7C 80 00 30 */	slw r0, r4, r0                          
/* 802FF1AC  7C A0 00 39 */	and. r0, r5, r0                         
/* 802FF1B0  40 82 00 0C */	bne lbl_802FF1BC                         /* constant-address: 802FF1BC, symbol: lbl_802FF1BC */
/* 802FF1B4  7C C3 33 78 */	mr r3, r6                               
/* 802FF1B8  4E 80 00 20 */	blr                                     
lbl_802FF1BC:
/* 802FF1BC  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
lbl_802FF1C0:
/* 802FF1C0  54 C0 06 3E */	clrlwi r0, r6, 0x18                     
/* 802FF1C4  28 00 00 02 */	cmplwi r0, 2                            
/* 802FF1C8  41 80 FF DC */	blt lbl_802FF1A4                         /* constant-address: 802FF1A4, symbol: lbl_802FF1A4 */

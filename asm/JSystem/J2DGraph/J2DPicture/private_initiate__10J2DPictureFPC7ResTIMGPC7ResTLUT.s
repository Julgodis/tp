...
/* 802FCD80  48 06 54 59 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802FCD98  40 82 00 EC */	bne lbl_802FCE84                         /* constant-address: 802FCE84, symbol: lbl_802FCE84 */
/* 802FCD9C  28 1C 00 00 */	cmplwi r28, 0                           
/* 802FCDA0  41 82 00 94 */	beq lbl_802FCE34                         /* constant-address: 802FCE34, symbol: lbl_802FCE34 */
/* 802FCDA4  80 7E 01 00 */	lwz r3, 0x100(r30)                      
/* 802FCDA8  28 03 00 00 */	cmplwi r3, 0                            
/* 802FCDAC  40 82 00 64 */	bne lbl_802FCE10                         /* constant-address: 802FCE10, symbol: lbl_802FCE10 */
/* 802FCDB0  38 60 00 40 */	li r3, 0x40                             
/* 802FCDB4  4B FD 1E 99 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802FCDB8  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 802FCDBC  41 82 00 24 */	beq lbl_802FCDE0                         /* constant-address: 802FCDE0, symbol: lbl_802FCDE0 */
...
/* 802FCDD0  4B FE 14 D9 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802FCDEC  41 82 00 48 */	beq lbl_802FCE34                         /* constant-address: 802FCE34, symbol: lbl_802FCE34 */
...
/* 802FCE0C  48 00 00 28 */	b lbl_802FCE34                           /* constant-address: 802FCE34, symbol: lbl_802FCE34 */
lbl_802FCE10:
/* 802FCE10  38 A0 00 00 */	li r5, 0                                
/* 802FCE14  4B FE 14 95 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802FCE40  41 82 00 44 */	beq lbl_802FCE84                         /* constant-address: 802FCE84, symbol: lbl_802FCE84 */
/* 802FCE44  80 1E 01 2C */	lwz r0, 0x12c(r30)                      
/* 802FCE48  28 00 00 00 */	cmplwi r0, 0                            
/* 802FCE4C  40 82 00 38 */	bne lbl_802FCE84                         /* constant-address: 802FCE84, symbol: lbl_802FCE84 */
/* 802FCE50  38 60 00 18 */	li r3, 0x18                             
/* 802FCE54  4B FD 1D F9 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802FCE58  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 802FCE5C  41 82 00 10 */	beq lbl_802FCE6C                         /* constant-address: 802FCE6C, symbol: lbl_802FCE6C */
/* 802FCE60  38 80 00 00 */	li r4, 0                                
/* 802FCE64  7F E5 FB 78 */	mr r5, r31                              
/* 802FCE68  4B FE 1A 29 */	bl storeTLUT__10JUTPaletteF7_GXTlutP7ResTLUT /* constant-address: 802DE890, symbol: storeTLUT__10JUTPaletteF7_GXTlutP7ResTLUT */
lbl_802FCE6C:
/* 802FCE6C  93 BE 01 2C */	stw r29, 0x12c(r30)                     
/* 802FCE70  80 7E 01 00 */	lwz r3, 0x100(r30)                      
/* 802FCE74  28 03 00 00 */	cmplwi r3, 0                            
/* 802FCE78  41 82 00 0C */	beq lbl_802FCE84                         /* constant-address: 802FCE84, symbol: lbl_802FCE84 */
/* 802FCE7C  80 9E 01 2C */	lwz r4, 0x12c(r30)                      
/* 802FCE80  4B FE 17 31 */	bl attachPalette__10JUTTextureFP10JUTPalette /* constant-address: 802DE5B0, symbol: attachPalette__10JUTTextureFP10JUTPalette */
lbl_802FCE84:
/* 802FCE84  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802FCE88  48 06 53 9D */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

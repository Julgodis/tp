...
/* 802FEAD4  C0 62 C8 6C */	lfs f3, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FEAD8  48 00 00 84 */	b lbl_802FEB5C                           /* constant-address: 802FEB5C, symbol: lbl_802FEB5C */
lbl_802FEADC:
/* 802FEADC  C0 82 C8 6C */	lfs f4, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FEAE0  39 20 00 00 */	li r9, 0                                
/* 802FEAE4  55 05 06 3E */	clrlwi r5, r8, 0x18                     
/* 802FEAE8  48 00 00 18 */	b lbl_802FEB00                           /* constant-address: 802FEB00, symbol: lbl_802FEB00 */
lbl_802FEAEC:
...
/* 802FEAFC  39 29 00 01 */	addi r9, r9, 1                           /* constant-address: 00000001 */
lbl_802FEB00:
/* 802FEB00  55 20 06 3E */	clrlwi r0, r9, 0x18                     
/* 802FEB04  7C 00 28 40 */	cmplw r0, r5                            
/* 802FEB08  41 80 FF E4 */	blt lbl_802FEAEC                         /* constant-address: 802FEAEC, symbol: lbl_802FEAEC */
...
/* 802FEB20  41 82 00 38 */	beq lbl_802FEB58                         /* constant-address: 802FEB58, symbol: lbl_802FEB58 */
/* 802FEB24  C0 42 C8 78 */	lfs f2, lit_2758(r2)                     /* constant-address: 80456278, symbol: lit_2758 */
/* 802FEB28  C0 22 C8 68 */	lfs f1, lit_1767(r2)                     /* constant-address: 80456268, symbol: lit_1767 */
...
lbl_802FEB58:
/* 802FEB58  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000002 */
lbl_802FEB5C:
/* 802FEB5C  55 00 06 3E */	clrlwi r0, r8, 0x18                     
/* 802FEB60  7C 00 30 40 */	cmplw r0, r6                            
/* 802FEB64  41 80 FF 78 */	blt lbl_802FEADC                         /* constant-address: 802FEADC, symbol: lbl_802FEADC */

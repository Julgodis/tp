...
/* 802FD53C  48 06 4C A1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802FD550  41 82 00 24 */	beq lbl_802FD574                         /* constant-address: 802FD574, symbol: lbl_802FD574 */
/* 802FD554  88 7D 01 08 */	lbz r3, 0x108(r29)                      
/* 802FD558  28 03 00 02 */	cmplwi r3, 2                            
/* 802FD55C  40 80 00 18 */	bge lbl_802FD574                         /* constant-address: 802FD574, symbol: lbl_802FD574 */
/* 802FD560  57 E0 06 3E */	clrlwi r0, r31, 0x18                    
/* 802FD564  28 00 00 02 */	cmplwi r0, 2                            
/* 802FD568  40 80 00 0C */	bge lbl_802FD574                         /* constant-address: 802FD574, symbol: lbl_802FD574 */
/* 802FD56C  7C 00 18 40 */	cmplw r0, r3                            
/* 802FD570  40 81 00 0C */	ble lbl_802FD57C                         /* constant-address: 802FD57C, symbol: lbl_802FD57C */
lbl_802FD574:
/* 802FD574  38 60 00 00 */	li r3, 0                                
/* 802FD578  48 00 01 5C */	b lbl_802FD6D4                           /* constant-address: 802FD6D4, symbol: lbl_802FD6D4 */
lbl_802FD57C:
/* 802FD57C  80 7D 01 04 */	lwz r3, 0x104(r29)                      
/* 802FD580  28 03 00 00 */	cmplwi r3, 0                            
/* 802FD584  41 82 00 24 */	beq lbl_802FD5A8                         /* constant-address: 802FD5A8, symbol: lbl_802FD5A8 */
/* 802FD588  88 1D 01 09 */	lbz r0, 0x109(r29)                      
/* 802FD58C  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 802FD590  41 82 00 18 */	beq lbl_802FD5A8                         /* constant-address: 802FD5A8, symbol: lbl_802FD5A8 */
/* 802FD594  38 80 00 01 */	li r4, 1                                
/* 802FD598  4B FE 0C 9D */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
...
/* 802FD5B0  48 00 00 28 */	b lbl_802FD5D8                           /* constant-address: 802FD5D8, symbol: lbl_802FD5D8 */
lbl_802FD5B4:
...
/* 802FD5E0  41 81 FF D4 */	bgt lbl_802FD5B4                         /* constant-address: 802FD5B4, symbol: lbl_802FD5B4 */
...
/* 802FD630  40 82 00 84 */	bne lbl_802FD6B4                         /* constant-address: 802FD6B4, symbol: lbl_802FD6B4 */
/* 802FD634  34 1D 01 00 */	addic. r0, r29, 0x100                   
/* 802FD638  41 82 00 7C */	beq lbl_802FD6B4                         /* constant-address: 802FD6B4, symbol: lbl_802FD6B4 */
...
/* 802FD64C  C0 02 C8 6C */	lfs f0, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FD650  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 802FD654  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 802FD658  C8 22 C8 70 */	lfd f1, lit_2021(r2)                     /* constant-address: 80456270, symbol: lit_2021 */
...
/* 802FD698  4B FF 96 81 */	bl func_802F6D18                         /* constant-address: 802F6D18, symbol: func_802F6D18 */
...
/* 802FD6B0  48 00 16 95 */	bl setTexCoord__10J2DPictureFPC10JUTTexture10J2DBinding9J2DMirrorb /* constant-address: 802FED44, symbol: setTexCoord__10J2DPictureFPC10JUTTexture10J2DBinding9J2DMirrorb */
lbl_802FD6B4:
...
/* 802FD6C4  48 00 14 01 */	bl setBlendKonstColor__10J2DPictureFv    /* constant-address: 802FEAC4, symbol: setBlendKonstColor__10J2DPictureFv */
/* 802FD6C8  7F A3 EB 78 */	mr r3, r29                              
/* 802FD6CC  48 00 14 C9 */	bl setBlendKonstAlpha__10J2DPictureFv    /* constant-address: 802FEB94, symbol: setBlendKonstAlpha__10J2DPictureFv */
...
/* 802FD6E0  48 06 4B 49 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

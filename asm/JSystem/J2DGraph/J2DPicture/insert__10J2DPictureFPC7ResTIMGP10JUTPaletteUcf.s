...
/* 802FD180  48 06 50 51 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 802FD198  41 82 00 24 */	beq lbl_802FD1BC                         /* constant-address: 802FD1BC, symbol: lbl_802FD1BC */
/* 802FD19C  88 9B 01 08 */	lbz r4, 0x108(r27)                      
/* 802FD1A0  28 04 00 02 */	cmplwi r4, 2                            
/* 802FD1A4  40 80 00 18 */	bge lbl_802FD1BC                         /* constant-address: 802FD1BC, symbol: lbl_802FD1BC */
/* 802FD1A8  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802FD1AC  28 00 00 02 */	cmplwi r0, 2                            
/* 802FD1B0  40 80 00 0C */	bge lbl_802FD1BC                         /* constant-address: 802FD1BC, symbol: lbl_802FD1BC */
/* 802FD1B4  7C 00 20 40 */	cmplw r0, r4                            
/* 802FD1B8  40 81 00 0C */	ble lbl_802FD1C4                         /* constant-address: 802FD1C4, symbol: lbl_802FD1C4 */
lbl_802FD1BC:
/* 802FD1BC  38 60 00 00 */	li r3, 0                                
/* 802FD1C0  48 00 02 D4 */	b lbl_802FD494                           /* constant-address: 802FD494, symbol: lbl_802FD494 */
lbl_802FD1C4:
/* 802FD1C4  3B 40 00 00 */	li r26, 0                               
/* 802FD1C8  88 1C 00 08 */	lbz r0, 8(r28)                          
/* 802FD1CC  28 00 00 00 */	cmplwi r0, 0                            
/* 802FD1D0  41 82 00 20 */	beq lbl_802FD1F0                         /* constant-address: 802FD1F0, symbol: lbl_802FD1F0 */
/* 802FD1D4  28 1D 00 00 */	cmplwi r29, 0                           
/* 802FD1D8  40 82 00 18 */	bne lbl_802FD1F0                         /* constant-address: 802FD1F0, symbol: lbl_802FD1F0 */
...
/* 802FD204  40 82 00 BC */	bne lbl_802FD2C0                         /* constant-address: 802FD2C0, symbol: lbl_802FD2C0 */
/* 802FD208  38 60 00 40 */	li r3, 0x40                             
/* 802FD20C  4B FD 1A 41 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802FD210  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 802FD214  41 82 00 24 */	beq lbl_802FD238                         /* constant-address: 802FD238, symbol: lbl_802FD238 */
...
/* 802FD228  4B FE 10 81 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802FD23C  41 82 00 14 */	beq lbl_802FD250                         /* constant-address: 802FD250, symbol: lbl_802FD250 */
/* 802FD240  7F E3 FB 78 */	mr r3, r31                              
/* 802FD244  7F 84 E3 78 */	mr r4, r28                              
/* 802FD248  7F A5 EB 78 */	mr r5, r29                              
/* 802FD24C  4B FE 12 01 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette /* constant-address: 802DE44C, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette */
lbl_802FD250:
/* 802FD250  38 A0 00 01 */	li r5, 1                                
/* 802FD254  57 C3 06 3E */	clrlwi r3, r30, 0x18                    
/* 802FD258  48 00 00 28 */	b lbl_802FD280                           /* constant-address: 802FD280, symbol: lbl_802FD280 */
lbl_802FD25C:
...
/* 802FD288  41 81 FF D4 */	bgt lbl_802FD25C                         /* constant-address: 802FD25C, symbol: lbl_802FD25C */
...
/* 802FD2BC  48 00 01 18 */	b lbl_802FD3D4                           /* constant-address: 802FD3D4, symbol: lbl_802FD3D4 */
lbl_802FD2C0:
/* 802FD2C0  7C 7F 1B 78 */	mr r31, r3                              
/* 802FD2C4  28 1D 00 00 */	cmplwi r29, 0                           
/* 802FD2C8  40 82 00 14 */	bne lbl_802FD2DC                         /* constant-address: 802FD2DC, symbol: lbl_802FD2DC */
/* 802FD2CC  7F 84 E3 78 */	mr r4, r28                              
/* 802FD2D0  7F 45 D3 78 */	mr r5, r26                              
/* 802FD2D4  4B FE 0F D5 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
/* 802FD2D8  48 00 00 10 */	b lbl_802FD2E8                           /* constant-address: 802FD2E8, symbol: lbl_802FD2E8 */
lbl_802FD2DC:
/* 802FD2DC  7F 84 E3 78 */	mr r4, r28                              
/* 802FD2E0  7F A5 EB 78 */	mr r5, r29                              
/* 802FD2E4  4B FE 11 69 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette /* constant-address: 802DE44C, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette */
lbl_802FD2E8:
/* 802FD2E8  38 E0 00 00 */	li r7, 0                                
/* 802FD2EC  38 C0 00 01 */	li r6, 1                                
/* 802FD2F0  38 61 00 08 */	addi r3, r1, 8                          
/* 802FD2F4  48 00 00 24 */	b lbl_802FD318                           /* constant-address: 802FD318, symbol: lbl_802FD318 */
lbl_802FD2F8:
...
/* 802FD314  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_802FD318:
/* 802FD318  54 E0 06 3E */	clrlwi r0, r7, 0x18                     
/* 802FD31C  28 00 00 02 */	cmplwi r0, 2                            
/* 802FD320  41 80 FF D8 */	blt lbl_802FD2F8                         /* constant-address: 802FD2F8, symbol: lbl_802FD2F8 */
/* 802FD324  88 FB 01 08 */	lbz r7, 0x108(r27)                      
/* 802FD328  38 81 00 08 */	addi r4, r1, 8                          
/* 802FD32C  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802FD330  48 00 00 38 */	b lbl_802FD368                           /* constant-address: 802FD368, symbol: lbl_802FD368 */
lbl_802FD334:
...
/* 802FD370  41 81 FF C4 */	bgt lbl_802FD334                         /* constant-address: 802FD334, symbol: lbl_802FD334 */
...
/* 802FD388  48 00 00 28 */	b lbl_802FD3B0                           /* constant-address: 802FD3B0, symbol: lbl_802FD3B0 */
lbl_802FD38C:
/* 802FD38C  54 E6 06 3E */	clrlwi r6, r7, 0x18                     
/* 802FD390  7C 05 30 AE */	lbzx r0, r5, r6                         
/* 802FD394  28 00 00 00 */	cmplwi r0, 0                            
/* 802FD398  41 82 00 14 */	beq lbl_802FD3AC                         /* constant-address: 802FD3AC, symbol: lbl_802FD3AC */
...
lbl_802FD3AC:
/* 802FD3AC  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_802FD3B0:
/* 802FD3B0  54 E0 06 3E */	clrlwi r0, r7, 0x18                     
/* 802FD3B4  28 00 00 02 */	cmplwi r0, 2                            
/* 802FD3B8  41 80 FF D4 */	blt lbl_802FD38C                         /* constant-address: 802FD38C, symbol: lbl_802FD38C */
...
/* 802FD3F0  40 82 00 84 */	bne lbl_802FD474                         /* constant-address: 802FD474, symbol: lbl_802FD474 */
/* 802FD3F4  80 7B 01 00 */	lwz r3, 0x100(r27)                      
/* 802FD3F8  28 03 00 00 */	cmplwi r3, 0                            
/* 802FD3FC  41 82 00 78 */	beq lbl_802FD474                         /* constant-address: 802FD474, symbol: lbl_802FD474 */
/* 802FD400  80 63 00 20 */	lwz r3, 0x20(r3)                        
/* 802FD404  A0 83 00 04 */	lhz r4, 4(r3)                           
/* 802FD408  A0 03 00 02 */	lhz r0, 2(r3)                           
/* 802FD40C  C0 02 C8 6C */	lfs f0, lit_2017(r2)                     /* constant-address: 8045626C, symbol: lit_2017 */
/* 802FD410  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 802FD414  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 802FD418  C8 22 C8 70 */	lfd f1, lit_2021(r2)                     /* constant-address: 80456270, symbol: lit_2021 */
...
/* 802FD458  4B FF 98 C1 */	bl func_802F6D18                         /* constant-address: 802F6D18, symbol: func_802F6D18 */
...
/* 802FD470  48 00 18 D5 */	bl setTexCoord__10J2DPictureFPC10JUTTexture10J2DBinding9J2DMirrorb /* constant-address: 802FED44, symbol: setTexCoord__10J2DPictureFPC10JUTTexture10J2DBinding9J2DMirrorb */
lbl_802FD474:
...
/* 802FD484  48 00 16 41 */	bl setBlendKonstColor__10J2DPictureFv    /* constant-address: 802FEAC4, symbol: setBlendKonstColor__10J2DPictureFv */
/* 802FD488  7F 63 DB 78 */	mr r3, r27                              
/* 802FD48C  48 00 17 09 */	bl setBlendKonstAlpha__10J2DPictureFv    /* constant-address: 802FEB94, symbol: setBlendKonstAlpha__10J2DPictureFv */
...
/* 802FD4A0  48 06 4D 7D */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

...
/* 802FD0A8  48 06 51 31 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 802FD0AC  7C 7C 1B 78 */	mr r28, r3                              
/* 802FD0B0  3B A0 00 00 */	li r29, 0                               
/* 802FD0B4  54 9F 06 3E */	clrlwi r31, r4, 0x18                    
/* 802FD0B8  48 00 00 88 */	b lbl_802FD140                           /* constant-address: 802FD140, symbol: lbl_802FD140 */
lbl_802FD0BC:
/* 802FD0BC  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 802FD0C0  28 00 00 02 */	cmplwi r0, 2                            
/* 802FD0C4  41 80 00 0C */	blt lbl_802FD0D0                         /* constant-address: 802FD0D0, symbol: lbl_802FD0D0 */
/* 802FD0C8  38 60 00 00 */	li r3, 0                                
/* 802FD0CC  48 00 00 84 */	b lbl_802FD150                           /* constant-address: 802FD150, symbol: lbl_802FD150 */
lbl_802FD0D0:
...
/* 802FD0E0  40 82 00 5C */	bne lbl_802FD13C                         /* constant-address: 802FD13C, symbol: lbl_802FD13C */
/* 802FD0E4  38 60 00 40 */	li r3, 0x40                             
/* 802FD0E8  4B FD 1B 65 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802FD0EC  28 03 00 00 */	cmplwi r3, 0                            
/* 802FD0F0  41 82 00 1C */	beq lbl_802FD10C                         /* constant-address: 802FD10C, symbol: lbl_802FD10C */
/* 802FD0F4  88 03 00 3B */	lbz r0, 0x3b(r3)                         /* constant-address: 0000007B */
/* 802FD0F8  54 00 07 BC */	rlwinm r0, r0, 0, 0x1e, 0x1e            
/* 802FD0FC  98 03 00 3B */	stb r0, 0x3b(r3)                         /* constant-address: 0000007B */
/* 802FD100  38 00 00 00 */	li r0, 0                                
/* 802FD104  90 03 00 28 */	stw r0, 0x28(r3)                         /* constant-address: 00000068 */
/* 802FD108  90 03 00 20 */	stw r0, 0x20(r3)                         /* constant-address: 00000060 */
lbl_802FD10C:
/* 802FD10C  7C 7C F1 2E */	stwx r3, r28, r30                       
/* 802FD110  7C 1C F0 2E */	lwzx r0, r28, r30                       
/* 802FD114  28 00 00 00 */	cmplwi r0, 0                            
/* 802FD118  40 82 00 0C */	bne lbl_802FD124                         /* constant-address: 802FD124, symbol: lbl_802FD124 */
/* 802FD11C  38 60 00 00 */	li r3, 0                                
/* 802FD120  48 00 00 30 */	b lbl_802FD150                           /* constant-address: 802FD150, symbol: lbl_802FD150 */
lbl_802FD124:
...
lbl_802FD13C:
/* 802FD13C  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
lbl_802FD140:
/* 802FD140  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 802FD144  7C 00 F8 40 */	cmplw r0, r31                           
/* 802FD148  41 80 FF 74 */	blt lbl_802FD0BC                         /* constant-address: 802FD0BC, symbol: lbl_802FD0BC */
/* 802FD14C  38 60 00 01 */	li r3, 1                                
lbl_802FD150:
/* 802FD150  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802FD154  48 06 50 D1 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

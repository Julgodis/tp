...
/* 80303380  48 05 EE 59 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 80303394  41 82 00 38 */	beq lbl_803033CC                         /* constant-address: 803033CC, symbol: lbl_803033CC */
/* 80303398  A0 9C 01 66 */	lhz r4, 0x166(r28)                      
/* 8030339C  28 04 FF FF */	cmplwi r4, 0xffff                       
/* 803033A0  41 82 00 2C */	beq lbl_803033CC                         /* constant-address: 803033CC, symbol: lbl_803033CC */
/* 803033A4  38 A1 00 08 */	addi r5, r1, 8                          
/* 803033A8  48 00 8C A1 */	bl getVisibility__20J2DAnmVisibilityFullCFUsPUc /* constant-address: 8030C048, symbol: getVisibility__20J2DAnmVisibilityFullCFUsPUc */
/* 803033AC  88 01 00 08 */	lbz r0, 8(r1)                           
/* 803033B0  28 00 00 00 */	cmplwi r0, 0                            
/* 803033B4  41 82 00 10 */	beq lbl_803033C4                         /* constant-address: 803033C4, symbol: lbl_803033C4 */
/* 803033B8  38 00 00 01 */	li r0, 1                                
/* 803033BC  98 1C 00 B0 */	stb r0, 0xb0(r28)                       
/* 803033C0  48 00 00 0C */	b lbl_803033CC                           /* constant-address: 803033CC, symbol: lbl_803033CC */
lbl_803033C4:
/* 803033C4  38 00 00 00 */	li r0, 0                                
/* 803033C8  98 1C 00 B0 */	stb r0, 0xb0(r28)                       
lbl_803033CC:
/* 803033CC  3C 60 80 3A */	lis r3, lit_3089@ha                     
/* 803033D0  38 83 1D 40 */	addi r4, r3, lit_3089@l                  /* constant-address: 803A1D40, symbol: lit_3089 */
/* 803033D4  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 803A1D40, symbol: lit_3089 */
/* 803033D8  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A1D44, symbol: None */
/* 803033DC  90 61 00 0C */	stw r3, 0xc(r1)                         
/* 803033E0  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 803033E4  80 64 00 08 */	lwz r3, 8(r4)                            /* constant-address: 803A1D48, symbol: None */
/* 803033E8  80 04 00 0C */	lwz r0, 0xc(r4)                          /* constant-address: 803A1D4C, symbol: None */
...
/* 8030341C  41 82 00 D0 */	beq lbl_803034EC                         /* constant-address: 803034EC, symbol: lbl_803034EC */
/* 80303420  A3 E3 00 10 */	lhz r31, 0x10(r3)                       
/* 80303424  3B C0 00 00 */	li r30, 0                               
/* 80303428  48 00 00 B8 */	b lbl_803034E0                           /* constant-address: 803034E0, symbol: lbl_803034E0 */
lbl_8030342C:
...
/* 80303440  41 82 00 9C */	beq lbl_803034DC                         /* constant-address: 803034DC, symbol: lbl_803034DC */
...
/* 80303454  48 00 00 7C */	b lbl_803034D0                           /* constant-address: 803034D0, symbol: lbl_803034D0 */
lbl_80303458:
...
/* 80303480  48 00 00 40 */	b lbl_803034C0                           /* constant-address: 803034C0, symbol: lbl_803034C0 */
lbl_80303484:
...
/* 80303494  40 82 00 28 */	bne lbl_803034BC                         /* constant-address: 803034BC, symbol: lbl_803034BC */
...
/* 803034B8  48 00 00 24 */	b lbl_803034DC                           /* constant-address: 803034DC, symbol: lbl_803034DC */
lbl_803034BC:
/* 803034BC  39 6B 00 01 */	addi r11, r11, 1                         /* constant-address: 00000001 */
lbl_803034C0:
/* 803034C0  55 64 04 3E */	clrlwi r4, r11, 0x10                    
/* 803034C4  7C 04 40 40 */	cmplw r4, r8                            
/* 803034C8  41 80 FF BC */	blt lbl_80303484                         /* constant-address: 80303484, symbol: lbl_80303484 */
/* 803034CC  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
lbl_803034D0:
/* 803034D0  54 A3 04 3E */	clrlwi r3, r5, 0x10                     
/* 803034D4  7C 03 00 40 */	cmplw r3, r0                            
/* 803034D8  41 80 FF 80 */	blt lbl_80303458                         /* constant-address: 80303458, symbol: lbl_80303458 */
lbl_803034DC:
/* 803034DC  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_803034E0:
/* 803034E0  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 803034E4  28 00 00 04 */	cmplwi r0, 4                            
/* 803034E8  41 80 FF 44 */	blt lbl_8030342C                         /* constant-address: 8030342C, symbol: lbl_8030342C */
lbl_803034EC:
/* 803034EC  7F 83 E3 78 */	mr r3, r28                              
/* 803034F0  7F A4 EB 78 */	mr r4, r29                              
/* 803034F4  4B FF 4D 35 */	bl animationPane__7J2DPaneFPC15J2DAnmTransform /* constant-address: 802F8228, symbol: animationPane__7J2DPaneFPC15J2DAnmTransform */
/* 803034F8  39 61 00 30 */	addi r11, r1, 0x30                      
/* 803034FC  48 05 ED 29 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

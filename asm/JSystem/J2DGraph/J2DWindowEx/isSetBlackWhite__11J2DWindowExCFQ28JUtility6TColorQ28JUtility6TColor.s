...
/* 80302BF8  48 05 F5 E5 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 80302BFC  7C 7D 1B 78 */	mr r29, r3                              
/* 80302C00  80 04 00 00 */	lwz r0, 0(r4)                           
/* 80302C04  28 00 00 00 */	cmplwi r0, 0                            
/* 80302C08  40 82 00 1C */	bne lbl_80302C24                         /* constant-address: 80302C24, symbol: lbl_80302C24 */
/* 80302C0C  80 65 00 00 */	lwz r3, 0(r5)                           
/* 80302C10  3C 03 00 01 */	addis r0, r3, 1                         
/* 80302C14  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 80302C18  40 82 00 0C */	bne lbl_80302C24                         /* constant-address: 80302C24, symbol: lbl_80302C24 */
/* 80302C1C  38 60 00 01 */	li r3, 1                                
/* 80302C20  48 00 00 50 */	b lbl_80302C70                           /* constant-address: 80302C70, symbol: lbl_80302C70 */
lbl_80302C24:
...
/* 80302C50  40 82 00 0C */	bne lbl_80302C5C                         /* constant-address: 80302C5C, symbol: lbl_80302C5C */
/* 80302C54  38 60 00 00 */	li r3, 0                                
/* 80302C58  48 00 00 18 */	b lbl_80302C70                           /* constant-address: 80302C70, symbol: lbl_80302C70 */
lbl_80302C5C:
/* 80302C5C  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
/* 80302C60  2C 1E 00 04 */	cmpwi r30, 4                            
/* 80302C64  3B FF 00 04 */	addi r31, r31, 4                         /* constant-address: 00000004 */
/* 80302C68  41 80 FF C4 */	blt lbl_80302C2C                         /* constant-address: 80302C2C, symbol: lbl_80302C2C */
/* 80302C6C  38 60 00 01 */	li r3, 1                                
lbl_80302C70:
/* 80302C70  39 61 00 20 */	addi r11, r1, 0x20                      
/* 80302C74  48 05 F5 B5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

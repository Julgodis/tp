...
/* 80302294  48 05 FF 39 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 80302298  7C 7F 1B 78 */	mr r31, r3                              
/* 8030229C  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 803022A0  40 82 00 1C */	bne lbl_803022BC                         /* constant-address: 803022BC, symbol: lbl_803022BC */
/* 803022A4  38 00 00 04 */	li r0, 4                                
/* 803022A8  B0 01 00 10 */	sth r0, 0x10(r1)                        
/* 803022AC  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 803022B0  38 03 FF FF */	addi r0, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 803022B4  B0 01 00 12 */	sth r0, 0x12(r1)                        
/* 803022B8  48 00 00 18 */	b lbl_803022D0                           /* constant-address: 803022D0, symbol: lbl_803022D0 */
lbl_803022BC:
/* 803022BC  38 00 00 FF */	li r0, 0xff                             
/* 803022C0  B0 01 00 10 */	sth r0, 0x10(r1)                        
/* 803022C4  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FF04@ha */      
/* 803022C8  38 03 FF 04 */	addi r0, r3, 0xFF04 /* 0x0000FF04@l */   /* constant-address: 0000FF04 */
/* 803022CC  B0 01 00 12 */	sth r0, 0x12(r1)                        
lbl_803022D0:
/* 803022D0  3B 40 00 00 */	li r26, 0                               
/* 803022D4  3B A1 00 10 */	addi r29, r1, 0x10                      
/* 803022D8  48 00 00 8C */	b lbl_80302364                           /* constant-address: 80302364, symbol: lbl_80302364 */
lbl_803022DC:
...
/* 80302324  40 81 00 2C */	ble lbl_80302350                         /* constant-address: 80302350, symbol: lbl_80302350 */
...
/* 8030235C  41 80 FF A4 */	blt lbl_80302300                         /* constant-address: 80302300, symbol: lbl_80302300 */
/* 80302360  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
lbl_80302364:
/* 80302364  57 40 06 3E */	clrlwi r0, r26, 0x18                    
/* 80302368  28 00 00 02 */	cmplwi r0, 2                            
/* 8030236C  41 80 FF 70 */	blt lbl_803022DC                         /* constant-address: 803022DC, symbol: lbl_803022DC */
/* 80302370  39 61 00 40 */	addi r11, r1, 0x40                      
/* 80302374  48 05 FE A5 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 802EC03C  41 82 00 0C */	beq lbl_802EC048                         /* constant-address: 802EC048, symbol: lbl_802EC048 */
/* 802EC040  38 60 00 00 */	li r3, 0                                
/* 802EC044  48 00 00 4C */	b lbl_802EC090                           /* constant-address: 802EC090, symbol: lbl_802EC090 */
lbl_802EC048:
/* 802EC048  88 1E 00 5C */	lbz r0, 0x5c(r30)                       
/* 802EC04C  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 802EC050  41 82 00 10 */	beq lbl_802EC060                         /* constant-address: 802EC060, symbol: lbl_802EC060 */
/* 802EC054  80 7E 00 50 */	lwz r3, 0x50(r30)                       
/* 802EC058  38 80 00 01 */	li r4, 1                                
/* 802EC05C  4B FF 21 D9 */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802EC060:
...
/* 802EC074  4B FE 2C C9 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802EC078  38 00 00 00 */	li r0, 0                                
/* 802EC07C  90 1E 00 54 */	stw r0, 0x54(r30)                       
/* 802EC080  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 802EC084  38 03 FF FF */	addi r0, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */

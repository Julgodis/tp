...
/* 802EDD44  48 07 44 95 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 802EDD48  7C 7C 1B 78 */	mr r28, r3                              
/* 802EDD4C  3B A0 00 00 */	li r29, 0                               
/* 802EDD50  54 9F 06 3E */	clrlwi r31, r4, 0x18                    
/* 802EDD54  48 00 00 88 */	b lbl_802EDDDC                           /* constant-address: 802EDDDC, symbol: lbl_802EDDDC */
lbl_802EDD58:
/* 802EDD58  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 802EDD5C  28 00 00 04 */	cmplwi r0, 4                            
/* 802EDD60  41 80 00 0C */	blt lbl_802EDD6C                         /* constant-address: 802EDD6C, symbol: lbl_802EDD6C */
/* 802EDD64  38 60 00 00 */	li r3, 0                                
/* 802EDD68  48 00 00 84 */	b lbl_802EDDEC                           /* constant-address: 802EDDEC, symbol: lbl_802EDDEC */
lbl_802EDD6C:
...
/* 802EDD7C  40 82 00 5C */	bne lbl_802EDDD8                         /* constant-address: 802EDDD8, symbol: lbl_802EDDD8 */
/* 802EDD80  38 60 00 40 */	li r3, 0x40                             
/* 802EDD84  4B FE 0E C9 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EDD88  28 03 00 00 */	cmplwi r3, 0                            
/* 802EDD8C  41 82 00 1C */	beq lbl_802EDDA8                         /* constant-address: 802EDDA8, symbol: lbl_802EDDA8 */
/* 802EDD90  88 03 00 3B */	lbz r0, 0x3b(r3)                         /* constant-address: 0000007B */
/* 802EDD94  54 00 07 BC */	rlwinm r0, r0, 0, 0x1e, 0x1e            
/* 802EDD98  98 03 00 3B */	stb r0, 0x3b(r3)                         /* constant-address: 0000007B */
/* 802EDD9C  38 00 00 00 */	li r0, 0                                
/* 802EDDA0  90 03 00 28 */	stw r0, 0x28(r3)                         /* constant-address: 00000068 */
/* 802EDDA4  90 03 00 20 */	stw r0, 0x20(r3)                         /* constant-address: 00000060 */
lbl_802EDDA8:
/* 802EDDA8  7C 7C F1 2E */	stwx r3, r28, r30                       
/* 802EDDAC  7C 1C F0 2E */	lwzx r0, r28, r30                       
/* 802EDDB0  28 00 00 00 */	cmplwi r0, 0                            
/* 802EDDB4  40 82 00 0C */	bne lbl_802EDDC0                         /* constant-address: 802EDDC0, symbol: lbl_802EDDC0 */
/* 802EDDB8  38 60 00 00 */	li r3, 0                                
/* 802EDDBC  48 00 00 30 */	b lbl_802EDDEC                           /* constant-address: 802EDDEC, symbol: lbl_802EDDEC */
lbl_802EDDC0:
...
lbl_802EDDD8:
/* 802EDDD8  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
lbl_802EDDDC:
/* 802EDDDC  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 802EDDE0  7C 00 F8 40 */	cmplw r0, r31                           
/* 802EDDE4  41 80 FF 74 */	blt lbl_802EDD58                         /* constant-address: 802EDD58, symbol: lbl_802EDD58 */
/* 802EDDE8  38 60 00 01 */	li r3, 1                                
lbl_802EDDEC:
/* 802EDDEC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802EDDF0  48 07 44 35 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 802EEF7C  38 A5 FF FF */	addi r5, r5, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EEF94  42 00 FF F4 */	bdnz lbl_802EEF88                        /* constant-address: 802EEF88, symbol: lbl_802EEF88 */
/* 802EEF98  3C 80 00 01 */	lis r4, 0x0001 /* 0x0000FFFF@ha */      
/* 802EEF9C  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 802EEFA0  B0 03 00 14 */	sth r0, 0x14(r3)                        
/* 802EEFA4  38 80 00 00 */	li r4, 0                                
/* 802EEFA8  38 A2 C7 80 */	la r5, j2dDefaultTevOrderInfoNull(r2) /* 80456180-_SDA2_BASE_ */ /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EEFAC  38 00 00 08 */	li r0, 8                                
/* 802EEFB0  7C 09 03 A6 */	mtctr r0                                
lbl_802EEFB4:
/* 802EEFB4  88 02 C7 80 */	lbz r0, j2dDefaultTevOrderInfoNull(r2)   /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EEFB8  7C C3 22 14 */	add r6, r3, r4                          
/* 802EEFBC  98 06 00 16 */	stb r0, 0x16(r6)                        
/* 802EEFC0  88 05 00 01 */	lbz r0, 1(r5)                            /* constant-address: 80456181, symbol: None */
/* 802EEFC4  98 06 00 17 */	stb r0, 0x17(r6)                        
/* 802EEFC8  88 05 00 02 */	lbz r0, 2(r5)                            /* constant-address: 80456182, symbol: None */
/* 802EEFCC  98 06 00 18 */	stb r0, 0x18(r6)                        
/* 802EEFD0  38 84 00 04 */	addi r4, r4, 4                          
/* 802EEFD4  42 00 FF E0 */	bdnz lbl_802EEFB4                        /* constant-address: 802EEFB4, symbol: lbl_802EEFB4 */
/* 802EEFD8  38 80 00 00 */	li r4, 0                                
/* 802EEFDC  38 A2 C7 88 */	la r5, j2dDefaultTevColor(r2) /* 80456188-_SDA2_BASE_ */ /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EEFE0  A9 02 C7 88 */	lha r8, j2dDefaultTevColor(r2)           /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EEFE4  A8 E5 00 02 */	lha r7, 2(r5)                            /* constant-address: 8045618A, symbol: None */
/* 802EEFE8  A8 C5 00 04 */	lha r6, 4(r5)                            /* constant-address: 8045618C, symbol: None */
/* 802EEFEC  A8 A5 00 06 */	lha r5, 6(r5)                            /* constant-address: 8045618E, symbol: None */
...
/* 802EF010  42 00 FF E8 */	bdnz lbl_802EEFF8                        /* constant-address: 802EEFF8, symbol: lbl_802EEFF8 */
...
/* 802EF048  42 00 FF E4 */	bdnz lbl_802EF02C                        /* constant-address: 802EF02C, symbol: lbl_802EF02C */
/* 802EF04C  38 80 00 00 */	li r4, 0                                
/* 802EF050  81 02 C7 94 */	lwz r8, j2dDefaultTevKColor(r2)          /* constant-address: 80456194, symbol: j2dDefaultTevKColor */
...
/* 802EF098  42 00 FF C4 */	bdnz lbl_802EF05C                        /* constant-address: 802EF05C, symbol: lbl_802EF05C */
...
/* 802EF0BC  42 00 FF F0 */	bdnz lbl_802EF0AC                        /* constant-address: 802EF0AC, symbol: lbl_802EF0AC */
/* 802EF0C0  39 20 00 00 */	li r9, 0                                
/* 802EF0C4  39 02 C7 9C */	la r8, j2dDefaultTevSwapModeTable(r2) /* 8045619C-_SDA2_BASE_ */ /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
/* 802EF0C8  38 00 00 04 */	li r0, 4                                
/* 802EF0CC  7C 09 03 A6 */	mtctr r0                                
lbl_802EF0D0:
/* 802EF0D0  88 E8 00 01 */	lbz r7, 1(r8)                            /* constant-address: 8045619D, symbol: None */
/* 802EF0D4  88 C8 00 03 */	lbz r6, 3(r8)                            /* constant-address: 8045619F, symbol: None */
/* 802EF0D8  88 08 00 02 */	lbz r0, 2(r8)                            /* constant-address: 8045619E, symbol: None */
/* 802EF0DC  54 05 15 BA */	rlwinm r5, r0, 2, 0x16, 0x1d            
/* 802EF0E0  88 02 C7 9C */	lbz r0, j2dDefaultTevSwapModeTable(r2)   /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
...
/* 802EF104  42 00 FF CC */	bdnz lbl_802EF0D0                        /* constant-address: 802EF0D0, symbol: lbl_802EF0D0 */
/* 802EF108  38 A0 00 00 */	li r5, 0                                
/* 802EF10C  3C 80 80 3A */	lis r4, j2dDefaultIndTevStageInfo@ha    
/* 802EF110  38 84 1B F4 */	addi r4, r4, j2dDefaultIndTevStageInfo@l /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EF114  38 00 00 08 */	li r0, 8                                
/* 802EF118  7C 09 03 A6 */	mtctr r0                                
lbl_802EF11C:
/* 802EF11C  80 C4 00 00 */	lwz r6, 0(r4)                            /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EF120  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A1BF8, symbol: None */
/* 802EF124  90 C1 00 10 */	stw r6, 0x10(r1)                        
/* 802EF128  90 01 00 14 */	stw r0, 0x14(r1)                        
/* 802EF12C  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803A1BFC, symbol: None */
...
/* 802EF1A4  42 00 FF 78 */	bdnz lbl_802EF11C                        /* constant-address: 802EF11C, symbol: lbl_802EF11C */
...
/* 802EF1C4  42 00 FF F4 */	bdnz lbl_802EF1B8                        /* constant-address: 802EF1B8, symbol: lbl_802EF1B8 */

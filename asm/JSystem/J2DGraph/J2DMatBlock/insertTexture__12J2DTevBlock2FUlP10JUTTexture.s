...
/* 802ECDF8  48 07 53 E5 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802ECE0C  40 80 00 0C */	bge lbl_802ECE18                         /* constant-address: 802ECE18, symbol: lbl_802ECE18 */
/* 802ECE10  28 1F 00 00 */	cmplwi r31, 0                           
/* 802ECE14  40 82 00 0C */	bne lbl_802ECE20                         /* constant-address: 802ECE20, symbol: lbl_802ECE20 */
lbl_802ECE18:
/* 802ECE18  38 60 00 00 */	li r3, 0                                
/* 802ECE1C  48 00 01 14 */	b lbl_802ECF30                           /* constant-address: 802ECF30, symbol: lbl_802ECF30 */
lbl_802ECE20:
/* 802ECE20  38 80 00 00 */	li r4, 0                                
/* 802ECE24  48 00 00 28 */	b lbl_802ECE4C                           /* constant-address: 802ECE4C, symbol: lbl_802ECE4C */
lbl_802ECE28:
...
/* 802ECE38  41 82 00 20 */	beq lbl_802ECE58                         /* constant-address: 802ECE58, symbol: lbl_802ECE58 */
/* 802ECE3C  80 03 00 20 */	lwz r0, 0x20(r3)                        
/* 802ECE40  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECE44  41 82 00 14 */	beq lbl_802ECE58                         /* constant-address: 802ECE58, symbol: lbl_802ECE58 */
/* 802ECE48  38 84 00 01 */	addi r4, r4, 1                           /* constant-address: 00000001 */
lbl_802ECE4C:
/* 802ECE4C  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 802ECE50  28 00 00 02 */	cmplwi r0, 2                            
/* 802ECE54  41 80 FF D4 */	blt lbl_802ECE28                         /* constant-address: 802ECE28, symbol: lbl_802ECE28 */
lbl_802ECE58:
/* 802ECE58  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 802ECE5C  7C 00 F0 40 */	cmplw r0, r30                           
/* 802ECE60  40 80 00 0C */	bge lbl_802ECE6C                         /* constant-address: 802ECE6C, symbol: lbl_802ECE6C */
/* 802ECE64  38 60 00 00 */	li r3, 0                                
/* 802ECE68  48 00 00 C8 */	b lbl_802ECF30                           /* constant-address: 802ECF30, symbol: lbl_802ECF30 */
lbl_802ECE6C:
/* 802ECE6C  28 00 00 02 */	cmplwi r0, 2                            
/* 802ECE70  40 82 00 0C */	bne lbl_802ECE7C                         /* constant-address: 802ECE7C, symbol: lbl_802ECE7C */
/* 802ECE74  38 60 00 00 */	li r3, 0                                
/* 802ECE78  48 00 00 B8 */	b lbl_802ECF30                           /* constant-address: 802ECF30, symbol: lbl_802ECF30 */
lbl_802ECE7C:
/* 802ECE7C  80 7D 00 68 */	lwz r3, 0x68(r29)                       
/* 802ECE80  28 03 00 00 */	cmplwi r3, 0                            
/* 802ECE84  41 82 00 30 */	beq lbl_802ECEB4                         /* constant-address: 802ECEB4, symbol: lbl_802ECEB4 */
/* 802ECE88  80 03 00 20 */	lwz r0, 0x20(r3)                        
/* 802ECE8C  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECE90  40 82 00 24 */	bne lbl_802ECEB4                         /* constant-address: 802ECEB4, symbol: lbl_802ECEB4 */
/* 802ECE94  88 1D 00 78 */	lbz r0, 0x78(r29)                       
/* 802ECE98  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 802ECE9C  41 82 00 0C */	beq lbl_802ECEA8                         /* constant-address: 802ECEA8, symbol: lbl_802ECEA8 */
/* 802ECEA0  38 80 00 01 */	li r4, 1                                
/* 802ECEA4  4B FF 13 91 */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802ECEA8:
...
/* 802ECEB8  40 82 00 1C */	bne lbl_802ECED4                         /* constant-address: 802ECED4, symbol: lbl_802ECED4 */
...
/* 802ECEEC  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802ECF34  48 07 52 F5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

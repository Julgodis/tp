...
/* 802EBC2C  40 82 00 0C */	bne lbl_802EBC38                         /* constant-address: 802EBC38, symbol: lbl_802EBC38 */
/* 802EBC30  38 60 00 01 */	li r3, 1                                
/* 802EBC34  48 00 00 74 */	b lbl_802EBCA8                           /* constant-address: 802EBCA8, symbol: lbl_802EBCA8 */
lbl_802EBC38:
/* 802EBC38  80 1E 00 50 */	lwz r0, 0x50(r30)                       
/* 802EBC3C  28 00 00 00 */	cmplwi r0, 0                            
/* 802EBC40  40 82 00 54 */	bne lbl_802EBC94                         /* constant-address: 802EBC94, symbol: lbl_802EBC94 */
/* 802EBC44  38 60 00 40 */	li r3, 0x40                             
/* 802EBC48  4B FE 30 05 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EBC4C  28 03 00 00 */	cmplwi r3, 0                            
/* 802EBC50  41 82 00 1C */	beq lbl_802EBC6C                         /* constant-address: 802EBC6C, symbol: lbl_802EBC6C */
/* 802EBC54  88 03 00 3B */	lbz r0, 0x3b(r3)                         /* constant-address: 0000007B */
/* 802EBC58  54 00 07 BC */	rlwinm r0, r0, 0, 0x1e, 0x1e            
/* 802EBC5C  98 03 00 3B */	stb r0, 0x3b(r3)                         /* constant-address: 0000007B */
/* 802EBC60  38 00 00 00 */	li r0, 0                                
/* 802EBC64  90 03 00 28 */	stw r0, 0x28(r3)                         /* constant-address: 00000068 */
/* 802EBC68  90 03 00 20 */	stw r0, 0x20(r3)                         /* constant-address: 00000060 */
lbl_802EBC6C:
/* 802EBC6C  90 7E 00 50 */	stw r3, 0x50(r30)                       
/* 802EBC70  80 1E 00 50 */	lwz r0, 0x50(r30)                       
/* 802EBC74  28 00 00 00 */	cmplwi r0, 0                            
/* 802EBC78  40 82 00 0C */	bne lbl_802EBC84                         /* constant-address: 802EBC84, symbol: lbl_802EBC84 */
/* 802EBC7C  38 60 00 00 */	li r3, 0                                
/* 802EBC80  48 00 00 28 */	b lbl_802EBCA8                           /* constant-address: 802EBCA8, symbol: lbl_802EBCA8 */
lbl_802EBC84:

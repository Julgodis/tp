...
/* 802EFC50  48 07 25 8D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802EFC54  7C 7D 1B 78 */	mr r29, r3                              
/* 802EFC58  7C 9E 23 79 */	or. r30, r4, r4                         
/* 802EFC5C  40 82 00 0C */	bne lbl_802EFC68                         /* constant-address: 802EFC68, symbol: lbl_802EFC68 */
/* 802EFC60  38 60 00 00 */	li r3, 0                                
/* 802EFC64  48 00 00 70 */	b lbl_802EFCD4                           /* constant-address: 802EFCD4, symbol: lbl_802EFCD4 */
lbl_802EFC68:
/* 802EFC68  38 60 00 70 */	li r3, 0x70                             
/* 802EFC6C  4B FD EF E1 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EFC70  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 802EFC74  41 82 00 14 */	beq lbl_802EFC88                         /* constant-address: 802EFC88, symbol: lbl_802EFC88 */
/* 802EFC78  7F C4 F3 78 */	mr r4, r30                              
/* 802EFC7C  38 A0 00 00 */	li r5, 0                                
/* 802EFC80  4B FE F3 15 */	bl __ct__10JUTResFontFPC7ResFONTP7JKRHeap /* constant-address: 802DEF94, symbol: __ct__10JUTResFontFPC7ResFONTP7JKRHeap */
/* 802EFC84  7C 7F 1B 78 */	mr r31, r3                              
lbl_802EFC88:
/* 802EFC88  28 1F 00 00 */	cmplwi r31, 0                           
/* 802EFC8C  40 82 00 0C */	bne lbl_802EFC98                         /* constant-address: 802EFC98, symbol: lbl_802EFC98 */
/* 802EFC90  38 60 00 00 */	li r3, 0                                
/* 802EFC94  48 00 00 40 */	b lbl_802EFCD4                           /* constant-address: 802EFCD4, symbol: lbl_802EFCD4 */
lbl_802EFC98:
/* 802EFC98  88 1D 01 21 */	lbz r0, 0x121(r29)                      
/* 802EFC9C  28 00 00 00 */	cmplwi r0, 0                            
/* 802EFCA0  41 82 00 24 */	beq lbl_802EFCC4                         /* constant-address: 802EFCC4, symbol: lbl_802EFCC4 */
/* 802EFCA4  80 7D 01 1C */	lwz r3, 0x11c(r29)                      
/* 802EFCA8  28 03 00 00 */	cmplwi r3, 0                            
/* 802EFCAC  41 82 00 18 */	beq lbl_802EFCC4                         /* constant-address: 802EFCC4, symbol: lbl_802EFCC4 */
...
/* 802EFCD8  48 07 25 51 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

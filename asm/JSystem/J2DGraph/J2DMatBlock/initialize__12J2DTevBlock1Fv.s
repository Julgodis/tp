...
/* 802EBA58  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 802EBA5C  B0 03 00 04 */	sth r0, 4(r3)                           
/* 802EBA60  B0 03 00 06 */	sth r0, 6(r3)                           
/* 802EBA64  88 02 C7 80 */	lbz r0, j2dDefaultTevOrderInfoNull(r2)   /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EBA68  98 03 00 08 */	stb r0, 8(r3)                           
/* 802EBA6C  38 82 C7 80 */	la r4, j2dDefaultTevOrderInfoNull(r2) /* 80456180-_SDA2_BASE_ */ /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EBA70  88 04 00 01 */	lbz r0, 1(r4)                            /* constant-address: 80456181, symbol: None */
/* 802EBA74  98 03 00 09 */	stb r0, 9(r3)                           
/* 802EBA78  88 04 00 02 */	lbz r0, 2(r4)                            /* constant-address: 80456182, symbol: None */
/* 802EBA7C  98 03 00 0A */	stb r0, 0xa(r3)                         
/* 802EBA80  38 80 00 00 */	li r4, 0                                
/* 802EBA84  38 A2 C7 88 */	la r5, j2dDefaultTevColor(r2) /* 80456188-_SDA2_BASE_ */ /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EBA88  A9 02 C7 88 */	lha r8, j2dDefaultTevColor(r2)           /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EBA8C  A8 E5 00 02 */	lha r7, 2(r5)                            /* constant-address: 8045618A, symbol: None */
/* 802EBA90  A8 C5 00 04 */	lha r6, 4(r5)                            /* constant-address: 8045618C, symbol: None */
/* 802EBA94  A8 A5 00 06 */	lha r5, 6(r5)                            /* constant-address: 8045618E, symbol: None */
...
/* 802EBAB8  42 00 FF E8 */	bdnz lbl_802EBAA0                        /* constant-address: 802EBAA0, symbol: lbl_802EBAA0 */
...
/* 802EBAD0  81 02 C7 94 */	lwz r8, j2dDefaultTevKColor(r2)          /* constant-address: 80456194, symbol: j2dDefaultTevKColor */
...
/* 802EBB18  42 00 FF C4 */	bdnz lbl_802EBADC                        /* constant-address: 802EBADC, symbol: lbl_802EBADC */
...
/* 802EBB2C  39 02 C7 9C */	la r8, j2dDefaultTevSwapModeTable(r2) /* 8045619C-_SDA2_BASE_ */ /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
/* 802EBB30  38 00 00 04 */	li r0, 4                                
/* 802EBB34  7C 09 03 A6 */	mtctr r0                                
lbl_802EBB38:
/* 802EBB38  88 E8 00 01 */	lbz r7, 1(r8)                            /* constant-address: 8045619D, symbol: None */
/* 802EBB3C  88 C8 00 03 */	lbz r6, 3(r8)                            /* constant-address: 8045619F, symbol: None */
/* 802EBB40  88 08 00 02 */	lbz r0, 2(r8)                            /* constant-address: 8045619E, symbol: None */
/* 802EBB44  54 05 15 BA */	rlwinm r5, r0, 2, 0x16, 0x1d            
/* 802EBB48  88 02 C7 9C */	lbz r0, j2dDefaultTevSwapModeTable(r2)   /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
...
/* 802EBB6C  42 00 FF CC */	bdnz lbl_802EBB38                        /* constant-address: 802EBB38, symbol: lbl_802EBB38 */
/* 802EBB70  3C 80 80 3A */	lis r4, j2dDefaultIndTevStageInfo@ha    
/* 802EBB74  38 A4 1B F4 */	addi r5, r4, j2dDefaultIndTevStageInfo@l /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EBB78  80 85 00 00 */	lwz r4, 0(r5)                            /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EBB7C  80 05 00 04 */	lwz r0, 4(r5)                            /* constant-address: 803A1BF8, symbol: None */
/* 802EBB80  90 81 00 10 */	stw r4, 0x10(r1)                        
/* 802EBB84  90 01 00 14 */	stw r0, 0x14(r1)                        
/* 802EBB88  80 05 00 08 */	lwz r0, 8(r5)                            /* constant-address: 803A1BFC, symbol: None */

...
/* 802ECAF8  48 07 56 D5 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802ECB10  40 80 00 0C */	bge lbl_802ECB1C                         /* constant-address: 802ECB1C, symbol: lbl_802ECB1C */
/* 802ECB14  28 1C 00 00 */	cmplwi r28, 0                           
/* 802ECB18  40 82 00 0C */	bne lbl_802ECB24                         /* constant-address: 802ECB24, symbol: lbl_802ECB24 */
lbl_802ECB1C:
/* 802ECB1C  38 60 00 00 */	li r3, 0                                
/* 802ECB20  48 00 02 B0 */	b lbl_802ECDD0                           /* constant-address: 802ECDD0, symbol: lbl_802ECDD0 */
lbl_802ECB24:
/* 802ECB24  3B C0 00 00 */	li r30, 0                               
/* 802ECB28  48 00 00 28 */	b lbl_802ECB50                           /* constant-address: 802ECB50, symbol: lbl_802ECB50 */
lbl_802ECB2C:
...
/* 802ECB3C  41 82 00 20 */	beq lbl_802ECB5C                         /* constant-address: 802ECB5C, symbol: lbl_802ECB5C */
/* 802ECB40  80 03 00 20 */	lwz r0, 0x20(r3)                        
/* 802ECB44  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECB48  41 82 00 14 */	beq lbl_802ECB5C                         /* constant-address: 802ECB5C, symbol: lbl_802ECB5C */
/* 802ECB4C  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_802ECB50:
/* 802ECB50  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802ECB54  28 00 00 02 */	cmplwi r0, 2                            
/* 802ECB58  41 80 FF D4 */	blt lbl_802ECB2C                         /* constant-address: 802ECB2C, symbol: lbl_802ECB2C */
lbl_802ECB5C:
/* 802ECB5C  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802ECB60  7C 00 D8 40 */	cmplw r0, r27                           
/* 802ECB64  40 80 00 0C */	bge lbl_802ECB70                         /* constant-address: 802ECB70, symbol: lbl_802ECB70 */
/* 802ECB68  38 60 00 00 */	li r3, 0                                
/* 802ECB6C  48 00 02 64 */	b lbl_802ECDD0                           /* constant-address: 802ECDD0, symbol: lbl_802ECDD0 */
lbl_802ECB70:
/* 802ECB70  28 00 00 02 */	cmplwi r0, 2                            
/* 802ECB74  40 82 00 0C */	bne lbl_802ECB80                         /* constant-address: 802ECB80, symbol: lbl_802ECB80 */
/* 802ECB78  38 60 00 00 */	li r3, 0                                
/* 802ECB7C  48 00 02 54 */	b lbl_802ECDD0                           /* constant-address: 802ECDD0, symbol: lbl_802ECDD0 */
lbl_802ECB80:
/* 802ECB80  3B 20 00 00 */	li r25, 0                               
/* 802ECB84  88 1C 00 08 */	lbz r0, 8(r28)                          
/* 802ECB88  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECB8C  41 82 00 48 */	beq lbl_802ECBD4                         /* constant-address: 802ECBD4, symbol: lbl_802ECBD4 */
/* 802ECB90  28 1D 00 00 */	cmplwi r29, 0                           
/* 802ECB94  40 82 00 40 */	bne lbl_802ECBD4                         /* constant-address: 802ECBD4, symbol: lbl_802ECBD4 */
/* 802ECB98  80 9A 00 64 */	lwz r4, 0x64(r26)                       
/* 802ECB9C  28 04 00 00 */	cmplwi r4, 0                            
/* 802ECBA0  41 82 00 34 */	beq lbl_802ECBD4                         /* constant-address: 802ECBD4, symbol: lbl_802ECBD4 */
/* 802ECBA4  80 64 00 20 */	lwz r3, 0x20(r4)                        
/* 802ECBA8  28 03 00 00 */	cmplwi r3, 0                            
/* 802ECBAC  41 82 00 28 */	beq lbl_802ECBD4                         /* constant-address: 802ECBD4, symbol: lbl_802ECBD4 */
/* 802ECBB0  88 03 00 08 */	lbz r0, 8(r3)                           
/* 802ECBB4  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECBB8  41 82 00 1C */	beq lbl_802ECBD4                         /* constant-address: 802ECBD4, symbol: lbl_802ECBD4 */
/* 802ECBBC  88 04 00 3A */	lbz r0, 0x3a(r4)                        
/* 802ECBC0  2C 00 00 00 */	cmpwi r0, 0                             
/* 802ECBC4  41 82 00 0C */	beq lbl_802ECBD0                         /* constant-address: 802ECBD0, symbol: lbl_802ECBD0 */
/* 802ECBC8  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 802ECBCC  40 82 00 08 */	bne lbl_802ECBD4                         /* constant-address: 802ECBD4, symbol: lbl_802ECBD4 */
lbl_802ECBD0:
...
/* 802ECBE4  40 82 00 BC */	bne lbl_802ECCA0                         /* constant-address: 802ECCA0, symbol: lbl_802ECCA0 */
/* 802ECBE8  38 60 00 40 */	li r3, 0x40                             
/* 802ECBEC  4B FE 20 61 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802ECBF0  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 802ECBF4  41 82 00 24 */	beq lbl_802ECC18                         /* constant-address: 802ECC18, symbol: lbl_802ECC18 */
...
/* 802ECC08  4B FF 16 A1 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802ECC1C  40 82 00 0C */	bne lbl_802ECC28                         /* constant-address: 802ECC28, symbol: lbl_802ECC28 */
/* 802ECC20  38 60 00 00 */	li r3, 0                                
/* 802ECC24  48 00 01 AC */	b lbl_802ECDD0                           /* constant-address: 802ECDD0, symbol: lbl_802ECDD0 */
lbl_802ECC28:
/* 802ECC28  28 1D 00 00 */	cmplwi r29, 0                           
/* 802ECC2C  41 82 00 14 */	beq lbl_802ECC40                         /* constant-address: 802ECC40, symbol: lbl_802ECC40 */
/* 802ECC30  7F C3 F3 78 */	mr r3, r30                              
/* 802ECC34  7F 84 E3 78 */	mr r4, r28                              
/* 802ECC38  7F A5 EB 78 */	mr r5, r29                              
/* 802ECC3C  4B FF 18 11 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette /* constant-address: 802DE44C, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette */
lbl_802ECC40:
/* 802ECC40  28 1B 00 00 */	cmplwi r27, 0                           
/* 802ECC44  40 82 00 1C */	bne lbl_802ECC60                         /* constant-address: 802ECC60, symbol: lbl_802ECC60 */
...
/* 802ECC9C  48 00 01 0C */	b lbl_802ECDA8                           /* constant-address: 802ECDA8, symbol: lbl_802ECDA8 */
lbl_802ECCA0:
/* 802ECCA0  28 1D 00 00 */	cmplwi r29, 0                           
/* 802ECCA4  40 82 00 18 */	bne lbl_802ECCBC                         /* constant-address: 802ECCBC, symbol: lbl_802ECCBC */
/* 802ECCA8  7F E3 FB 78 */	mr r3, r31                              
/* 802ECCAC  7F 84 E3 78 */	mr r4, r28                              
/* 802ECCB0  7F 25 CB 78 */	mr r5, r25                              
/* 802ECCB4  4B FF 15 F5 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
/* 802ECCB8  48 00 00 14 */	b lbl_802ECCCC                           /* constant-address: 802ECCCC, symbol: lbl_802ECCCC */
lbl_802ECCBC:
/* 802ECCBC  7F E3 FB 78 */	mr r3, r31                              
/* 802ECCC0  7F 84 E3 78 */	mr r4, r28                              
/* 802ECCC4  7F A5 EB 78 */	mr r5, r29                              
/* 802ECCC8  4B FF 17 85 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette /* constant-address: 802DE44C, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette */
lbl_802ECCCC:
/* 802ECCCC  38 E0 00 00 */	li r7, 0                                
/* 802ECCD0  38 C0 00 01 */	li r6, 1                                
/* 802ECCD4  38 61 00 08 */	addi r3, r1, 8                          
/* 802ECCD8  48 00 00 24 */	b lbl_802ECCFC                           /* constant-address: 802ECCFC, symbol: lbl_802ECCFC */
lbl_802ECCDC:
...
/* 802ECCF8  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_802ECCFC:
/* 802ECCFC  54 E0 06 3E */	clrlwi r0, r7, 0x18                     
/* 802ECD00  28 00 00 02 */	cmplwi r0, 2                            
/* 802ECD04  41 80 FF D8 */	blt lbl_802ECCDC                         /* constant-address: 802ECCDC, symbol: lbl_802ECCDC */
/* 802ECD08  28 1B 00 00 */	cmplwi r27, 0                           
/* 802ECD0C  40 82 00 30 */	bne lbl_802ECD3C                         /* constant-address: 802ECD3C, symbol: lbl_802ECD3C */
/* 802ECD10  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802ECD14  28 00 00 01 */	cmplwi r0, 1                            
/* 802ECD18  40 82 00 24 */	bne lbl_802ECD3C                         /* constant-address: 802ECD3C, symbol: lbl_802ECD3C */
...
/* 802ECD60  48 00 00 28 */	b lbl_802ECD88                           /* constant-address: 802ECD88, symbol: lbl_802ECD88 */
lbl_802ECD64:
/* 802ECD64  54 E6 06 3E */	clrlwi r6, r7, 0x18                     
/* 802ECD68  7C 05 30 AE */	lbzx r0, r5, r6                         
/* 802ECD6C  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECD70  41 82 00 14 */	beq lbl_802ECD84                         /* constant-address: 802ECD84, symbol: lbl_802ECD84 */
...
lbl_802ECD84:
/* 802ECD84  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_802ECD88:
/* 802ECD88  54 E0 06 3E */	clrlwi r0, r7, 0x18                     
/* 802ECD8C  28 00 00 02 */	cmplwi r0, 2                            
/* 802ECD90  41 80 FF D4 */	blt lbl_802ECD64                         /* constant-address: 802ECD64, symbol: lbl_802ECD64 */
...
/* 802ECDBC  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802ECDD4  48 07 54 45 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

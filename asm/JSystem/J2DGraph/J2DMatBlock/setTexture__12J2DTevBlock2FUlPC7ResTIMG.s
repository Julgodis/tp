...
/* 802ECF58  48 07 52 75 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802ECF6C  41 80 00 0C */	blt lbl_802ECF78                         /* constant-address: 802ECF78, symbol: lbl_802ECF78 */
/* 802ECF70  38 60 00 00 */	li r3, 0                                
/* 802ECF74  48 00 01 E0 */	b lbl_802ED154                           /* constant-address: 802ED154, symbol: lbl_802ED154 */
lbl_802ECF78:
/* 802ECF78  3B 80 00 00 */	li r28, 0                               
/* 802ECF7C  28 1B 00 00 */	cmplwi r27, 0                           
/* 802ECF80  41 82 00 64 */	beq lbl_802ECFE4                         /* constant-address: 802ECFE4, symbol: lbl_802ECFE4 */
/* 802ECF84  88 1B 00 08 */	lbz r0, 8(r27)                          
/* 802ECF88  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECF8C  41 82 00 58 */	beq lbl_802ECFE4                         /* constant-address: 802ECFE4, symbol: lbl_802ECFE4 */
...
/* 802ECFA4  41 82 00 40 */	beq lbl_802ECFE4                         /* constant-address: 802ECFE4, symbol: lbl_802ECFE4 */
/* 802ECFA8  80 64 00 20 */	lwz r3, 0x20(r4)                        
/* 802ECFAC  28 03 00 00 */	cmplwi r3, 0                            
/* 802ECFB0  41 82 00 34 */	beq lbl_802ECFE4                         /* constant-address: 802ECFE4, symbol: lbl_802ECFE4 */
/* 802ECFB4  88 03 00 08 */	lbz r0, 8(r3)                           
/* 802ECFB8  28 00 00 00 */	cmplwi r0, 0                            
/* 802ECFBC  41 82 00 28 */	beq lbl_802ECFE4                         /* constant-address: 802ECFE4, symbol: lbl_802ECFE4 */
/* 802ECFC0  88 64 00 3A */	lbz r3, 0x3a(r4)                        
/* 802ECFC4  2C 03 00 10 */	cmpwi r3, 0x10                          
/* 802ECFC8  38 00 00 00 */	li r0, 0                                
/* 802ECFCC  41 80 00 08 */	blt lbl_802ECFD4                         /* constant-address: 802ECFD4, symbol: lbl_802ECFD4 */
/* 802ECFD0  38 00 00 10 */	li r0, 0x10                             
lbl_802ECFD4:
/* 802ECFD4  7C 00 18 50 */	subf r0, r0, r3                         
/* 802ECFD8  54 00 06 3F */	clrlwi. r0, r0, 0x18                    
/* 802ECFDC  40 82 00 08 */	bne lbl_802ECFE4                         /* constant-address: 802ECFE4, symbol: lbl_802ECFE4 */
...
/* 802ECFF4  40 82 00 84 */	bne lbl_802ED078                         /* constant-address: 802ED078, symbol: lbl_802ED078 */
/* 802ECFF8  28 1B 00 00 */	cmplwi r27, 0                           
/* 802ECFFC  41 82 00 64 */	beq lbl_802ED060                         /* constant-address: 802ED060, symbol: lbl_802ED060 */
/* 802ED000  38 60 00 40 */	li r3, 0x40                             
/* 802ED004  4B FE 1C 49 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802ED008  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 802ED00C  41 82 00 24 */	beq lbl_802ED030                         /* constant-address: 802ED030, symbol: lbl_802ED030 */
...
/* 802ED020  4B FF 12 89 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802ED03C  40 82 00 0C */	bne lbl_802ED048                         /* constant-address: 802ED048, symbol: lbl_802ED048 */
/* 802ED040  38 60 00 00 */	li r3, 0                                
/* 802ED044  48 00 01 10 */	b lbl_802ED154                           /* constant-address: 802ED154, symbol: lbl_802ED154 */
lbl_802ED048:
...
/* 802ED05C  48 00 00 CC */	b lbl_802ED128                           /* constant-address: 802ED128, symbol: lbl_802ED128 */
lbl_802ED060:
...
/* 802ED074  48 00 00 B4 */	b lbl_802ED128                           /* constant-address: 802ED128, symbol: lbl_802ED128 */
lbl_802ED078:
...
/* 802ED088  41 82 00 3C */	beq lbl_802ED0C4                         /* constant-address: 802ED0C4, symbol: lbl_802ED0C4 */
/* 802ED08C  28 1B 00 00 */	cmplwi r27, 0                           
/* 802ED090  41 82 00 14 */	beq lbl_802ED0A4                         /* constant-address: 802ED0A4, symbol: lbl_802ED0A4 */
/* 802ED094  7F 64 DB 78 */	mr r4, r27                              
/* 802ED098  7F 85 E3 78 */	mr r5, r28                              
/* 802ED09C  4B FF 12 0D */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
/* 802ED0A0  48 00 00 88 */	b lbl_802ED128                           /* constant-address: 802ED128, symbol: lbl_802ED128 */
lbl_802ED0A4:
/* 802ED0A4  38 80 00 01 */	li r4, 1                                
/* 802ED0A8  4B FF 11 8D */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
...
/* 802ED0C0  48 00 00 68 */	b lbl_802ED128                           /* constant-address: 802ED128, symbol: lbl_802ED128 */
lbl_802ED0C4:
/* 802ED0C4  38 00 00 00 */	li r0, 0                                
/* 802ED0C8  90 1F 00 64 */	stw r0, 0x64(r31)                       
/* 802ED0CC  28 1B 00 00 */	cmplwi r27, 0                           
/* 802ED0D0  41 82 00 58 */	beq lbl_802ED128                         /* constant-address: 802ED128, symbol: lbl_802ED128 */
/* 802ED0D4  38 60 00 40 */	li r3, 0x40                             
/* 802ED0D8  4B FE 1B 75 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802ED0DC  7C 7C 1B 79 */	or. r28, r3, r3                         
/* 802ED0E0  41 82 00 24 */	beq lbl_802ED104                         /* constant-address: 802ED104, symbol: lbl_802ED104 */
...
/* 802ED0F4  4B FF 11 B5 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802ED110  40 82 00 0C */	bne lbl_802ED11C                         /* constant-address: 802ED11C, symbol: lbl_802ED11C */
/* 802ED114  38 60 00 00 */	li r3, 0                                
/* 802ED118  48 00 00 3C */	b lbl_802ED154                           /* constant-address: 802ED154, symbol: lbl_802ED154 */
lbl_802ED11C:
...
/* 802ED130  4B FE 1C 0D */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802ED134  38 00 00 00 */	li r0, 0                                
/* 802ED138  90 1B 00 6C */	stw r0, 0x6c(r27)                       
/* 802ED13C  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 802ED140  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802ED158  48 07 50 C1 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

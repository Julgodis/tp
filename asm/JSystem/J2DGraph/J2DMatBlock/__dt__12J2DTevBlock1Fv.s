...
/* 802EB9B4  41 82 00 80 */	beq lbl_802EBA34                         /* constant-address: 802EBA34, symbol: lbl_802EBA34 */
/* 802EB9B8  3C 60 80 3D */	lis r3, __vt__12J2DTevBlock1@ha         
/* 802EB9BC  38 03 CD B8 */	addi r0, r3, __vt__12J2DTevBlock1@l      /* constant-address: 803CCDB8, symbol: __vt__12J2DTevBlock1 */
/* 802EB9C0  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802EB9C4  88 1E 00 5C */	lbz r0, 0x5c(r30)                       
/* 802EB9C8  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 802EB9CC  41 82 00 10 */	beq lbl_802EB9DC                         /* constant-address: 802EB9DC, symbol: lbl_802EB9DC */
/* 802EB9D0  80 7E 00 50 */	lwz r3, 0x50(r30)                       
/* 802EB9D4  38 80 00 01 */	li r4, 1                                
/* 802EB9D8  4B FF 28 5D */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802EB9DC:
/* 802EB9DC  80 7E 00 54 */	lwz r3, 0x54(r30)                       
/* 802EB9E0  4B FE 33 5D */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802EB9E4  88 1E 00 5C */	lbz r0, 0x5c(r30)                       
/* 802EB9E8  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18           
/* 802EB9EC  41 82 00 24 */	beq lbl_802EBA10                         /* constant-address: 802EBA10, symbol: lbl_802EBA10 */
/* 802EB9F0  80 7E 00 58 */	lwz r3, 0x58(r30)                       
/* 802EB9F4  28 03 00 00 */	cmplwi r3, 0                            
/* 802EB9F8  41 82 00 18 */	beq lbl_802EBA10                         /* constant-address: 802EBA10, symbol: lbl_802EBA10 */
...
/* 802EBA14  41 82 00 10 */	beq lbl_802EBA24                         /* constant-address: 802EBA24, symbol: lbl_802EBA24 */
/* 802EBA18  3C 60 80 3D */	lis r3, __vt__11J2DTevBlock@ha          
/* 802EBA1C  38 03 CE 74 */	addi r0, r3, __vt__11J2DTevBlock@l       /* constant-address: 803CCE74, symbol: __vt__11J2DTevBlock */
/* 802EBA20  90 1E 00 00 */	stw r0, 0(r30)                          
lbl_802EBA24:
/* 802EBA24  7F E0 07 35 */	extsh. r0, r31                          
/* 802EBA28  40 81 00 0C */	ble lbl_802EBA34                         /* constant-address: 802EBA34, symbol: lbl_802EBA34 */
/* 802EBA2C  7F C3 F3 78 */	mr r3, r30                              
/* 802EBA30  4B FE 33 0D */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802EBA34:

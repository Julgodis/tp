...
/* 802EE374  48 07 3E 59 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802EE388  41 80 00 0C */	blt lbl_802EE394                         /* constant-address: 802EE394, symbol: lbl_802EE394 */
/* 802EE38C  38 60 00 00 */	li r3, 0                                
/* 802EE390  48 00 02 48 */	b lbl_802EE5D8                           /* constant-address: 802EE5D8, symbol: lbl_802EE5D8 */
lbl_802EE394:
/* 802EE394  3B 80 00 00 */	li r28, 0                               
/* 802EE398  28 1B 00 00 */	cmplwi r27, 0                           
/* 802EE39C  41 82 00 CC */	beq lbl_802EE468                         /* constant-address: 802EE468, symbol: lbl_802EE468 */
/* 802EE3A0  88 1B 00 08 */	lbz r0, 8(r27)                          
/* 802EE3A4  28 00 00 00 */	cmplwi r0, 0                            
/* 802EE3A8  41 82 00 C0 */	beq lbl_802EE468                         /* constant-address: 802EE468, symbol: lbl_802EE468 */
...
/* 802EE3C4  41 82 00 60 */	beq lbl_802EE424                         /* constant-address: 802EE424, symbol: lbl_802EE424 */
/* 802EE3C8  38 03 00 8C */	addi r0, r3, 0x8c                        /* constant-address: 0000008C */
/* 802EE3CC  7C B9 00 2E */	lwzx r5, r25, r0                        
/* 802EE3D0  28 05 00 00 */	cmplwi r5, 0                            
/* 802EE3D4  41 82 00 50 */	beq lbl_802EE424                         /* constant-address: 802EE424, symbol: lbl_802EE424 */
/* 802EE3D8  80 85 00 20 */	lwz r4, 0x20(r5)                        
/* 802EE3DC  28 04 00 00 */	cmplwi r4, 0                            
/* 802EE3E0  41 82 00 44 */	beq lbl_802EE424                         /* constant-address: 802EE424, symbol: lbl_802EE424 */
/* 802EE3E4  88 04 00 08 */	lbz r0, 8(r4)                           
/* 802EE3E8  28 00 00 00 */	cmplwi r0, 0                            
/* 802EE3EC  41 82 00 38 */	beq lbl_802EE424                         /* constant-address: 802EE424, symbol: lbl_802EE424 */
/* 802EE3F0  88 85 00 3A */	lbz r4, 0x3a(r5)                        
/* 802EE3F4  2C 04 00 10 */	cmpwi r4, 0x10                          
/* 802EE3F8  38 00 00 00 */	li r0, 0                                
/* 802EE3FC  41 80 00 08 */	blt lbl_802EE404                         /* constant-address: 802EE404, symbol: lbl_802EE404 */
...
/* 802EE410  40 80 00 14 */	bge lbl_802EE424                         /* constant-address: 802EE424, symbol: lbl_802EE424 */
...
/* 802EE42C  42 00 FF 94 */	bdnz lbl_802EE3C0                        /* constant-address: 802EE3C0, symbol: lbl_802EE3C0 */
/* 802EE430  38 A0 00 00 */	li r5, 0                                
/* 802EE434  54 C4 06 3E */	clrlwi r4, r6, 0x18                     
/* 802EE438  38 60 00 01 */	li r3, 1                                
/* 802EE43C  48 00 00 20 */	b lbl_802EE45C                           /* constant-address: 802EE45C, symbol: lbl_802EE45C */
lbl_802EE440:
/* 802EE440  54 A0 06 3E */	clrlwi r0, r5, 0x18                     
/* 802EE444  7C 60 00 30 */	slw r0, r3, r0                          
/* 802EE448  7C 80 00 39 */	and. r0, r4, r0                         
/* 802EE44C  40 82 00 0C */	bne lbl_802EE458                         /* constant-address: 802EE458, symbol: lbl_802EE458 */
/* 802EE450  7C BC 2B 78 */	mr r28, r5                              
/* 802EE454  48 00 00 14 */	b lbl_802EE468                           /* constant-address: 802EE468, symbol: lbl_802EE468 */
lbl_802EE458:
/* 802EE458  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
lbl_802EE45C:
/* 802EE45C  54 A0 06 3E */	clrlwi r0, r5, 0x18                     
/* 802EE460  28 00 00 04 */	cmplwi r0, 4                            
/* 802EE464  41 80 FF DC */	blt lbl_802EE440                         /* constant-address: 802EE440, symbol: lbl_802EE440 */
lbl_802EE468:
...
/* 802EE478  40 82 00 84 */	bne lbl_802EE4FC                         /* constant-address: 802EE4FC, symbol: lbl_802EE4FC */
/* 802EE47C  28 1B 00 00 */	cmplwi r27, 0                           
/* 802EE480  41 82 00 64 */	beq lbl_802EE4E4                         /* constant-address: 802EE4E4, symbol: lbl_802EE4E4 */
/* 802EE484  38 60 00 40 */	li r3, 0x40                             
/* 802EE488  4B FE 07 C5 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EE48C  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 802EE490  41 82 00 24 */	beq lbl_802EE4B4                         /* constant-address: 802EE4B4, symbol: lbl_802EE4B4 */
...
/* 802EE4A4  4B FE FE 05 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802EE4C0  40 82 00 0C */	bne lbl_802EE4CC                         /* constant-address: 802EE4CC, symbol: lbl_802EE4CC */
/* 802EE4C4  38 60 00 00 */	li r3, 0                                
/* 802EE4C8  48 00 01 10 */	b lbl_802EE5D8                           /* constant-address: 802EE5D8, symbol: lbl_802EE5D8 */
lbl_802EE4CC:
...
/* 802EE4E0  48 00 00 CC */	b lbl_802EE5AC                           /* constant-address: 802EE5AC, symbol: lbl_802EE5AC */
lbl_802EE4E4:
...
/* 802EE4F8  48 00 00 B4 */	b lbl_802EE5AC                           /* constant-address: 802EE5AC, symbol: lbl_802EE5AC */
lbl_802EE4FC:
...
/* 802EE50C  41 82 00 3C */	beq lbl_802EE548                         /* constant-address: 802EE548, symbol: lbl_802EE548 */
/* 802EE510  28 1B 00 00 */	cmplwi r27, 0                           
/* 802EE514  41 82 00 14 */	beq lbl_802EE528                         /* constant-address: 802EE528, symbol: lbl_802EE528 */
/* 802EE518  7F 64 DB 78 */	mr r4, r27                              
/* 802EE51C  7F 85 E3 78 */	mr r5, r28                              
/* 802EE520  4B FE FD 89 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
/* 802EE524  48 00 00 88 */	b lbl_802EE5AC                           /* constant-address: 802EE5AC, symbol: lbl_802EE5AC */
lbl_802EE528:
/* 802EE528  38 80 00 01 */	li r4, 1                                
/* 802EE52C  4B FE FD 09 */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
...
/* 802EE544  48 00 00 68 */	b lbl_802EE5AC                           /* constant-address: 802EE5AC, symbol: lbl_802EE5AC */
lbl_802EE548:
/* 802EE548  38 00 00 00 */	li r0, 0                                
/* 802EE54C  90 1F 00 8C */	stw r0, 0x8c(r31)                       
/* 802EE550  28 1B 00 00 */	cmplwi r27, 0                           
/* 802EE554  41 82 00 58 */	beq lbl_802EE5AC                         /* constant-address: 802EE5AC, symbol: lbl_802EE5AC */
/* 802EE558  38 60 00 40 */	li r3, 0x40                             
/* 802EE55C  4B FE 06 F1 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EE560  7C 7C 1B 79 */	or. r28, r3, r3                         
/* 802EE564  41 82 00 24 */	beq lbl_802EE588                         /* constant-address: 802EE588, symbol: lbl_802EE588 */
...
/* 802EE578  4B FE FD 31 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802EE594  40 82 00 0C */	bne lbl_802EE5A0                         /* constant-address: 802EE5A0, symbol: lbl_802EE5A0 */
/* 802EE598  38 60 00 00 */	li r3, 0                                
/* 802EE59C  48 00 00 3C */	b lbl_802EE5D8                           /* constant-address: 802EE5D8, symbol: lbl_802EE5D8 */
lbl_802EE5A0:
...
/* 802EE5B4  4B FE 07 89 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802EE5B8  38 00 00 00 */	li r0, 0                                
/* 802EE5BC  90 1B 00 9C */	stw r0, 0x9c(r27)                       
/* 802EE5C0  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 802EE5C4  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EE5DC  48 07 3C 3D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 802EC7A8  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 802EC7AC  B0 03 00 04 */	sth r0, 4(r3)                           
/* 802EC7B0  B0 03 00 06 */	sth r0, 6(r3)                           
/* 802EC7B4  B0 03 00 08 */	sth r0, 8(r3)                           
/* 802EC7B8  88 02 C7 80 */	lbz r0, j2dDefaultTevOrderInfoNull(r2)   /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EC7BC  98 03 00 0A */	stb r0, 0xa(r3)                         
/* 802EC7C0  38 82 C7 80 */	la r4, j2dDefaultTevOrderInfoNull(r2) /* 80456180-_SDA2_BASE_ */ /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EC7C4  88 04 00 01 */	lbz r0, 1(r4)                            /* constant-address: 80456181, symbol: None */
/* 802EC7C8  98 03 00 0B */	stb r0, 0xb(r3)                         
/* 802EC7CC  88 04 00 02 */	lbz r0, 2(r4)                            /* constant-address: 80456182, symbol: None */
/* 802EC7D0  98 03 00 0C */	stb r0, 0xc(r3)                         
/* 802EC7D4  88 02 C7 80 */	lbz r0, j2dDefaultTevOrderInfoNull(r2)   /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EC7D8  98 03 00 0E */	stb r0, 0xe(r3)                         
/* 802EC7DC  88 04 00 01 */	lbz r0, 1(r4)                            /* constant-address: 80456181, symbol: None */
/* 802EC7E0  98 03 00 0F */	stb r0, 0xf(r3)                         
/* 802EC7E4  88 04 00 02 */	lbz r0, 2(r4)                            /* constant-address: 80456182, symbol: None */
/* 802EC7E8  98 03 00 10 */	stb r0, 0x10(r3)                        
/* 802EC7EC  38 80 00 00 */	li r4, 0                                
/* 802EC7F0  38 A2 C7 88 */	la r5, j2dDefaultTevColor(r2) /* 80456188-_SDA2_BASE_ */ /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EC7F4  A9 02 C7 88 */	lha r8, j2dDefaultTevColor(r2)           /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EC7F8  A8 E5 00 02 */	lha r7, 2(r5)                            /* constant-address: 8045618A, symbol: None */
/* 802EC7FC  A8 C5 00 04 */	lha r6, 4(r5)                            /* constant-address: 8045618C, symbol: None */
/* 802EC800  A8 A5 00 06 */	lha r5, 6(r5)                            /* constant-address: 8045618E, symbol: None */
...
/* 802EC824  42 00 FF E8 */	bdnz lbl_802EC80C                        /* constant-address: 802EC80C, symbol: lbl_802EC80C */
...
/* 802EC854  81 02 C7 94 */	lwz r8, j2dDefaultTevKColor(r2)          /* constant-address: 80456194, symbol: j2dDefaultTevKColor */
...
/* 802EC89C  42 00 FF C4 */	bdnz lbl_802EC860                        /* constant-address: 802EC860, symbol: lbl_802EC860 */
...
/* 802EC8B8  39 02 C7 9C */	la r8, j2dDefaultTevSwapModeTable(r2) /* 8045619C-_SDA2_BASE_ */ /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
/* 802EC8BC  38 00 00 04 */	li r0, 4                                
/* 802EC8C0  7C 09 03 A6 */	mtctr r0                                
lbl_802EC8C4:
/* 802EC8C4  88 E8 00 01 */	lbz r7, 1(r8)                            /* constant-address: 8045619D, symbol: None */
/* 802EC8C8  88 C8 00 03 */	lbz r6, 3(r8)                            /* constant-address: 8045619F, symbol: None */
/* 802EC8CC  88 08 00 02 */	lbz r0, 2(r8)                            /* constant-address: 8045619E, symbol: None */
/* 802EC8D0  54 05 15 BA */	rlwinm r5, r0, 2, 0x16, 0x1d            
/* 802EC8D4  88 02 C7 9C */	lbz r0, j2dDefaultTevSwapModeTable(r2)   /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
...
/* 802EC8F8  42 00 FF CC */	bdnz lbl_802EC8C4                        /* constant-address: 802EC8C4, symbol: lbl_802EC8C4 */
/* 802EC8FC  3C 80 80 3A */	lis r4, j2dDefaultIndTevStageInfo@ha    
/* 802EC900  84 A4 1B F4 */	lwzu r5, j2dDefaultIndTevStageInfo@l(r4) /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EC904  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A1BF8, symbol: None */
/* 802EC908  90 A1 00 1C */	stw r5, 0x1c(r1)                        
/* 802EC90C  90 01 00 20 */	stw r0, 0x20(r1)                        
/* 802EC910  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803A1BFC, symbol: None */
...
/* 802EC980  80 A4 00 00 */	lwz r5, 0(r4)                            /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EC984  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A1BF8, symbol: None */
/* 802EC988  90 A1 00 10 */	stw r5, 0x10(r1)                        
/* 802EC98C  90 01 00 14 */	stw r0, 0x14(r1)                        
/* 802EC990  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803A1BFC, symbol: None */

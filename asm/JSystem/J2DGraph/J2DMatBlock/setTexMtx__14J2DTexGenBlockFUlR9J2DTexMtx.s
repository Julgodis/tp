...
/* 802EB6CC  40 82 00 78 */	bne lbl_802EB744                         /* constant-address: 802EB744, symbol: lbl_802EB744 */
/* 802EB6D0  38 60 00 54 */	li r3, 0x54                             
/* 802EB6D4  4B FE 35 79 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EB6D8  28 03 00 00 */	cmplwi r3, 0                            
/* 802EB6DC  41 82 00 54 */	beq lbl_802EB730                         /* constant-address: 802EB730, symbol: lbl_802EB730 */
/* 802EB6E0  C0 1E 00 04 */	lfs f0, 4(r30)                          
/* 802EB6E4  D0 03 00 04 */	stfs f0, 4(r3)                           /* constant-address: 00000058 */
/* 802EB6E8  C0 1E 00 08 */	lfs f0, 8(r30)                          
/* 802EB6EC  D0 03 00 08 */	stfs f0, 8(r3)                           /* constant-address: 0000005C */
/* 802EB6F0  C0 1E 00 0C */	lfs f0, 0xc(r30)                        
/* 802EB6F4  D0 03 00 0C */	stfs f0, 0xc(r3)                         /* constant-address: 00000060 */
/* 802EB6F8  88 1E 00 00 */	lbz r0, 0(r30)                          
/* 802EB6FC  98 03 00 00 */	stb r0, 0(r3)                            /* constant-address: 00000054 */
/* 802EB700  88 1E 00 01 */	lbz r0, 1(r30)                          
/* 802EB704  98 03 00 01 */	stb r0, 1(r3)                            /* constant-address: 00000055 */
/* 802EB708  C0 1E 00 10 */	lfs f0, 0x10(r30)                       
/* 802EB70C  D0 03 00 10 */	stfs f0, 0x10(r3)                        /* constant-address: 00000064 */
/* 802EB710  C0 1E 00 14 */	lfs f0, 0x14(r30)                       
/* 802EB714  D0 03 00 14 */	stfs f0, 0x14(r3)                        /* constant-address: 00000068 */
/* 802EB718  C0 1E 00 18 */	lfs f0, 0x18(r30)                       
/* 802EB71C  D0 03 00 18 */	stfs f0, 0x18(r3)                        /* constant-address: 0000006C */
/* 802EB720  C0 1E 00 1C */	lfs f0, 0x1c(r30)                       
/* 802EB724  D0 03 00 1C */	stfs f0, 0x1c(r3)                        /* constant-address: 00000070 */
/* 802EB728  C0 1E 00 20 */	lfs f0, 0x20(r30)                       
/* 802EB72C  D0 03 00 20 */	stfs f0, 0x20(r3)                        /* constant-address: 00000074 */
lbl_802EB730:
/* 802EB730  90 7F 00 24 */	stw r3, 0x24(r31)                       
/* 802EB734  80 1F 00 24 */	lwz r0, 0x24(r31)                       
/* 802EB738  28 00 00 00 */	cmplwi r0, 0                            
/* 802EB73C  40 82 00 84 */	bne lbl_802EB7C0                         /* constant-address: 802EB7C0, symbol: lbl_802EB7C0 */
/* 802EB740  48 00 00 88 */	b lbl_802EB7C8                           /* constant-address: 802EB7C8, symbol: lbl_802EB7C8 */
lbl_802EB744:
...
/* 802EB764  42 00 FF F0 */	bdnz lbl_802EB754                        /* constant-address: 802EB754, symbol: lbl_802EB754 */
...
/* 802EB7C4  4B FF E5 01 */	bl calc__9J2DTexMtxFv                    /* constant-address: 802E9CC4, symbol: calc__9J2DTexMtxFv */
lbl_802EB7C8:

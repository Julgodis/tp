...
/* 802EC134  48 07 60 A9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802EC138  7C 7D 1B 78 */	mr r29, r3                              
/* 802EC13C  7C 9E 23 79 */	or. r30, r4, r4                         
/* 802EC140  40 82 00 0C */	bne lbl_802EC14C                         /* constant-address: 802EC14C, symbol: lbl_802EC14C */
/* 802EC144  38 60 00 00 */	li r3, 0                                
/* 802EC148  48 00 00 78 */	b lbl_802EC1C0                           /* constant-address: 802EC1C0, symbol: lbl_802EC1C0 */
lbl_802EC14C:
/* 802EC14C  38 60 00 70 */	li r3, 0x70                             
/* 802EC150  4B FE 2A FD */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EC154  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 802EC158  41 82 00 14 */	beq lbl_802EC16C                         /* constant-address: 802EC16C, symbol: lbl_802EC16C */
/* 802EC15C  7F C4 F3 78 */	mr r4, r30                              
/* 802EC160  38 A0 00 00 */	li r5, 0                                
/* 802EC164  4B FF 2E 31 */	bl __ct__10JUTResFontFPC7ResFONTP7JKRHeap /* constant-address: 802DEF94, symbol: __ct__10JUTResFontFPC7ResFONTP7JKRHeap */
/* 802EC168  7C 7F 1B 78 */	mr r31, r3                              
lbl_802EC16C:
/* 802EC16C  28 1F 00 00 */	cmplwi r31, 0                           
/* 802EC170  40 82 00 0C */	bne lbl_802EC17C                         /* constant-address: 802EC17C, symbol: lbl_802EC17C */
/* 802EC174  38 60 00 00 */	li r3, 0                                
/* 802EC178  48 00 00 48 */	b lbl_802EC1C0                           /* constant-address: 802EC1C0, symbol: lbl_802EC1C0 */
lbl_802EC17C:
/* 802EC17C  88 1D 00 5C */	lbz r0, 0x5c(r29)                       
/* 802EC180  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18           
/* 802EC184  41 82 00 24 */	beq lbl_802EC1A8                         /* constant-address: 802EC1A8, symbol: lbl_802EC1A8 */
/* 802EC188  80 7D 00 58 */	lwz r3, 0x58(r29)                       
/* 802EC18C  28 03 00 00 */	cmplwi r3, 0                            
/* 802EC190  41 82 00 18 */	beq lbl_802EC1A8                         /* constant-address: 802EC1A8, symbol: lbl_802EC1A8 */
...
/* 802EC1C4  48 07 60 65 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

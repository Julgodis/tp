...
/* 802EC6E4  41 82 00 A0 */	beq lbl_802EC784                         /* constant-address: 802EC784, symbol: lbl_802EC784 */
/* 802EC6E8  3C 60 80 3D */	lis r3, __vt__12J2DTevBlock2@ha         
/* 802EC6EC  38 03 CC FC */	addi r0, r3, __vt__12J2DTevBlock2@l      /* constant-address: 803CCCFC, symbol: __vt__12J2DTevBlock2 */
/* 802EC6F0  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802EC6F4  88 1E 00 78 */	lbz r0, 0x78(r30)                       
/* 802EC6F8  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 802EC6FC  41 82 00 10 */	beq lbl_802EC70C                         /* constant-address: 802EC70C, symbol: lbl_802EC70C */
/* 802EC700  80 7E 00 64 */	lwz r3, 0x64(r30)                       
/* 802EC704  38 80 00 01 */	li r4, 1                                
/* 802EC708  4B FF 1B 2D */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802EC70C:
/* 802EC70C  88 1E 00 78 */	lbz r0, 0x78(r30)                       
/* 802EC710  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 802EC714  41 82 00 10 */	beq lbl_802EC724                         /* constant-address: 802EC724, symbol: lbl_802EC724 */
/* 802EC718  80 7E 00 68 */	lwz r3, 0x68(r30)                       
/* 802EC71C  38 80 00 01 */	li r4, 1                                
/* 802EC720  4B FF 1B 15 */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802EC724:
/* 802EC724  80 7E 00 6C */	lwz r3, 0x6c(r30)                       
/* 802EC728  4B FE 26 15 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802EC72C  80 7E 00 70 */	lwz r3, 0x70(r30)                       
/* 802EC730  4B FE 26 0D */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802EC734  88 1E 00 78 */	lbz r0, 0x78(r30)                       
/* 802EC738  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18           
/* 802EC73C  41 82 00 24 */	beq lbl_802EC760                         /* constant-address: 802EC760, symbol: lbl_802EC760 */
/* 802EC740  80 7E 00 74 */	lwz r3, 0x74(r30)                       
/* 802EC744  28 03 00 00 */	cmplwi r3, 0                            
/* 802EC748  41 82 00 18 */	beq lbl_802EC760                         /* constant-address: 802EC760, symbol: lbl_802EC760 */
...
/* 802EC764  41 82 00 10 */	beq lbl_802EC774                         /* constant-address: 802EC774, symbol: lbl_802EC774 */
/* 802EC768  3C 60 80 3D */	lis r3, __vt__11J2DTevBlock@ha          
/* 802EC76C  38 03 CE 74 */	addi r0, r3, __vt__11J2DTevBlock@l       /* constant-address: 803CCE74, symbol: __vt__11J2DTevBlock */
/* 802EC770  90 1E 00 00 */	stw r0, 0(r30)                          
lbl_802EC774:
/* 802EC774  7F E0 07 35 */	extsh. r0, r31                          
/* 802EC778  40 81 00 0C */	ble lbl_802EC784                         /* constant-address: 802EC784, symbol: lbl_802EC784 */
/* 802EC77C  7F C3 F3 78 */	mr r3, r30                              
/* 802EC780  4B FE 25 BD */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802EC784:

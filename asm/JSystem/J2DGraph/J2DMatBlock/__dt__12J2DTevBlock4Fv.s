...
/* 802ED9F4  48 07 47 E1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 802ED9F8  7C 7B 1B 79 */	or. r27, r3, r3                         
/* 802ED9FC  7C 9C 23 78 */	mr r28, r4                              
/* 802EDA00  41 82 00 A8 */	beq lbl_802EDAA8                         /* constant-address: 802EDAA8, symbol: lbl_802EDAA8 */
/* 802EDA04  3C 60 80 3D */	lis r3, __vt__12J2DTevBlock4@ha         
/* 802EDA08  38 03 CC 40 */	addi r0, r3, __vt__12J2DTevBlock4@l      /* constant-address: 803CCC40, symbol: __vt__12J2DTevBlock4 */
...
/* 802EDA28  41 82 00 14 */	beq lbl_802EDA3C                         /* constant-address: 802EDA3C, symbol: lbl_802EDA3C */
/* 802EDA2C  38 1F 00 8C */	addi r0, r31, 0x8c                      
/* 802EDA30  7C 7B 00 2E */	lwzx r3, r27, r0                        
/* 802EDA34  38 80 00 01 */	li r4, 1                                
/* 802EDA38  4B FF 07 FD */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802EDA3C:
/* 802EDA3C  38 1F 00 9C */	addi r0, r31, 0x9c                      
/* 802EDA40  7C 7B 00 2E */	lwzx r3, r27, r0                        
/* 802EDA44  4B FE 12 F9 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 802EDA48  3B BD 00 01 */	addi r29, r29, 1                        
/* 802EDA4C  2C 1D 00 04 */	cmpwi r29, 4                            
/* 802EDA50  3B FF 00 04 */	addi r31, r31, 4                        
/* 802EDA54  41 80 FF C8 */	blt lbl_802EDA1C                         /* constant-address: 802EDA1C, symbol: lbl_802EDA1C */
/* 802EDA58  88 1B 00 B0 */	lbz r0, 0xb0(r27)                       
/* 802EDA5C  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18           
/* 802EDA60  41 82 00 24 */	beq lbl_802EDA84                         /* constant-address: 802EDA84, symbol: lbl_802EDA84 */
/* 802EDA64  80 7B 00 AC */	lwz r3, 0xac(r27)                       
/* 802EDA68  28 03 00 00 */	cmplwi r3, 0                            
/* 802EDA6C  41 82 00 18 */	beq lbl_802EDA84                         /* constant-address: 802EDA84, symbol: lbl_802EDA84 */
...
/* 802EDA88  41 82 00 10 */	beq lbl_802EDA98                         /* constant-address: 802EDA98, symbol: lbl_802EDA98 */
/* 802EDA8C  3C 60 80 3D */	lis r3, __vt__11J2DTevBlock@ha          
/* 802EDA90  38 03 CE 74 */	addi r0, r3, __vt__11J2DTevBlock@l       /* constant-address: 803CCE74, symbol: __vt__11J2DTevBlock */
/* 802EDA94  90 1B 00 00 */	stw r0, 0(r27)                          
lbl_802EDA98:
/* 802EDA98  7F 80 07 35 */	extsh. r0, r28                          
/* 802EDA9C  40 81 00 0C */	ble lbl_802EDAA8                         /* constant-address: 802EDAA8, symbol: lbl_802EDAA8 */
/* 802EDAA0  7F 63 DB 78 */	mr r3, r27                              
/* 802EDAA4  4B FE 12 99 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802EDAA8:
/* 802EDAA8  7F 63 DB 78 */	mr r3, r27                              
/* 802EDAAC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802EDAB0  48 07 47 71 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

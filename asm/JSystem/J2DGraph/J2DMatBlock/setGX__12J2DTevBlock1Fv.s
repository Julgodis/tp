...
/* 802EC338  48 07 5E A1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802EC368  48 07 33 8D */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
...
/* 802EC398  41 82 00 08 */	beq lbl_802EC3A0                         /* constant-address: 802EC3A0, symbol: lbl_802EC3A0 */
/* 802EC39C  38 7C 00 01 */	addi r3, r28, 1                         
lbl_802EC3A0:
/* 802EC3A0  7F A4 EB 78 */	mr r4, r29                              
/* 802EC3A4  48 07 30 39 */	bl GXSetTevColorS10                      /* constant-address: 8035F3DC, symbol: GXSetTevColorS10 */
/* 802EC3A8  3B 9C 00 01 */	addi r28, r28, 1                        
/* 802EC3AC  2C 1C 00 04 */	cmpwi r28, 4                            
/* 802EC3B0  3B DE 00 08 */	addi r30, r30, 8                        
/* 802EC3B4  41 80 FF C4 */	blt lbl_802EC378                         /* constant-address: 802EC378, symbol: lbl_802EC378 */
/* 802EC3B8  38 60 00 01 */	li r3, 1                                
/* 802EC3BC  48 07 34 D5 */	bl GXSetNumTevStages                     /* constant-address: 8035F890, symbol: GXSetNumTevStages */
...
/* 802EC3DC  48 07 2E 49 */	bl GXSetTevColorIn                       /* constant-address: 8035F224, symbol: GXSetTevColorIn */
...
/* 802EC40C  48 07 2E 5D */	bl GXSetTevAlphaIn                       /* constant-address: 8035F268, symbol: GXSetTevAlphaIn */
...
/* 802EC448  41 82 00 08 */	beq lbl_802EC450                         /* constant-address: 802EC450, symbol: lbl_802EC450 */
/* 802EC44C  7D 20 4B 78 */	mr r0, r9                               
lbl_802EC450:
/* 802EC450  54 04 06 3E */	clrlwi r4, r0, 0x18                     
/* 802EC454  48 07 2E 59 */	bl GXSetTevColorOp                       /* constant-address: 8035F2AC, symbol: GXSetTevColorOp */
...
/* 802EC490  41 82 00 08 */	beq lbl_802EC498                         /* constant-address: 802EC498, symbol: lbl_802EC498 */
/* 802EC494  7D 20 4B 78 */	mr r0, r9                               
lbl_802EC498:
/* 802EC498  54 04 06 3E */	clrlwi r4, r0, 0x18                     
/* 802EC49C  48 07 2E 79 */	bl GXSetTevAlphaOp                       /* constant-address: 8035F314, symbol: GXSetTevAlphaOp */
/* 802EC4A0  88 1F 00 44 */	lbz r0, 0x44(r31)                       
/* 802EC4A4  28 00 00 FF */	cmplwi r0, 0xff                         
/* 802EC4A8  38 80 00 00 */	li r4, 0                                
/* 802EC4AC  41 82 00 08 */	beq lbl_802EC4B4                         /* constant-address: 802EC4B4, symbol: lbl_802EC4B4 */
/* 802EC4B0  7C 04 03 78 */	mr r4, r0                               
lbl_802EC4B4:
/* 802EC4B4  38 60 00 00 */	li r3, 0                                
/* 802EC4B8  48 07 2F ED */	bl GXSetTevKColorSel                     /* constant-address: 8035F4A4, symbol: GXSetTevKColorSel */
/* 802EC4BC  88 1F 00 45 */	lbz r0, 0x45(r31)                       
/* 802EC4C0  28 00 00 FF */	cmplwi r0, 0xff                         
/* 802EC4C4  38 80 00 00 */	li r4, 0                                
/* 802EC4C8  41 82 00 08 */	beq lbl_802EC4D0                         /* constant-address: 802EC4D0, symbol: lbl_802EC4D0 */
/* 802EC4CC  7C 04 03 78 */	mr r4, r0                               
lbl_802EC4D0:
/* 802EC4D0  38 60 00 00 */	li r3, 0                                
/* 802EC4D4  48 07 30 2D */	bl GXSetTevKAlphaSel                     /* constant-address: 8035F500, symbol: GXSetTevKAlphaSel */
...
/* 802EC4F4  48 07 2F 4D */	bl GXSetTevKColor                        /* constant-address: 8035F440, symbol: GXSetTevKColor */
/* 802EC4F8  3B 9C 00 01 */	addi r28, r28, 1                        
/* 802EC4FC  2C 1C 00 04 */	cmpwi r28, 4                            
/* 802EC500  3B DE 00 04 */	addi r30, r30, 4                        
/* 802EC504  41 80 FF DC */	blt lbl_802EC4E0                         /* constant-address: 802EC4E0, symbol: lbl_802EC4E0 */
...
/* 802EC518  48 07 30 45 */	bl GXSetTevSwapMode                      /* constant-address: 8035F55C, symbol: GXSetTevSwapMode */
...
/* 802EC53C  48 07 30 69 */	bl GXSetTevSwapModeTable                 /* constant-address: 8035F5A4, symbol: GXSetTevSwapModeTable */
/* 802EC540  3B 9C 00 01 */	addi r28, r28, 1                        
/* 802EC544  2C 1C 00 04 */	cmpwi r28, 4                            
/* 802EC548  41 80 FF D8 */	blt lbl_802EC520                         /* constant-address: 802EC520, symbol: lbl_802EC520 */
/* 802EC54C  38 7F 00 4C */	addi r3, r31, 0x4c                      
/* 802EC550  38 80 00 00 */	li r4, 0                                
/* 802EC554  4B FF DA F1 */	bl load__14J2DIndTevStageFUc             /* constant-address: 802EA044, symbol: load__14J2DIndTevStageFUc */
/* 802EC558  39 61 00 30 */	addi r11, r1, 0x30                      
/* 802EC55C  48 07 5C C9 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

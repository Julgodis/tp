...
/* 802EE1E4  48 07 3F F9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802EE1F8  40 80 00 0C */	bge lbl_802EE204                         /* constant-address: 802EE204, symbol: lbl_802EE204 */
/* 802EE1FC  28 1F 00 00 */	cmplwi r31, 0                           
/* 802EE200  40 82 00 0C */	bne lbl_802EE20C                         /* constant-address: 802EE20C, symbol: lbl_802EE20C */
lbl_802EE204:
/* 802EE204  38 60 00 00 */	li r3, 0                                
/* 802EE208  48 00 01 44 */	b lbl_802EE34C                           /* constant-address: 802EE34C, symbol: lbl_802EE34C */
lbl_802EE20C:
/* 802EE20C  38 80 00 00 */	li r4, 0                                
/* 802EE210  48 00 00 28 */	b lbl_802EE238                           /* constant-address: 802EE238, symbol: lbl_802EE238 */
lbl_802EE214:
...
/* 802EE224  41 82 00 20 */	beq lbl_802EE244                         /* constant-address: 802EE244, symbol: lbl_802EE244 */
/* 802EE228  80 03 00 20 */	lwz r0, 0x20(r3)                        
/* 802EE22C  28 00 00 00 */	cmplwi r0, 0                            
/* 802EE230  41 82 00 14 */	beq lbl_802EE244                         /* constant-address: 802EE244, symbol: lbl_802EE244 */
/* 802EE234  38 84 00 01 */	addi r4, r4, 1                           /* constant-address: 00000001 */
lbl_802EE238:
/* 802EE238  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 802EE23C  28 00 00 04 */	cmplwi r0, 4                            
/* 802EE240  41 80 FF D4 */	blt lbl_802EE214                         /* constant-address: 802EE214, symbol: lbl_802EE214 */
lbl_802EE244:
/* 802EE244  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 802EE248  7C 00 F0 40 */	cmplw r0, r30                           
/* 802EE24C  40 80 00 0C */	bge lbl_802EE258                         /* constant-address: 802EE258, symbol: lbl_802EE258 */
/* 802EE250  38 60 00 00 */	li r3, 0                                
/* 802EE254  48 00 00 F8 */	b lbl_802EE34C                           /* constant-address: 802EE34C, symbol: lbl_802EE34C */
lbl_802EE258:
/* 802EE258  28 00 00 04 */	cmplwi r0, 4                            
/* 802EE25C  40 82 00 0C */	bne lbl_802EE268                         /* constant-address: 802EE268, symbol: lbl_802EE268 */
/* 802EE260  38 60 00 00 */	li r3, 0                                
/* 802EE264  48 00 00 E8 */	b lbl_802EE34C                           /* constant-address: 802EE34C, symbol: lbl_802EE34C */
lbl_802EE268:
/* 802EE268  80 7D 00 98 */	lwz r3, 0x98(r29)                       
/* 802EE26C  28 03 00 00 */	cmplwi r3, 0                            
/* 802EE270  41 82 00 30 */	beq lbl_802EE2A0                         /* constant-address: 802EE2A0, symbol: lbl_802EE2A0 */
/* 802EE274  80 03 00 20 */	lwz r0, 0x20(r3)                        
/* 802EE278  28 00 00 00 */	cmplwi r0, 0                            
/* 802EE27C  40 82 00 24 */	bne lbl_802EE2A0                         /* constant-address: 802EE2A0, symbol: lbl_802EE2A0 */
/* 802EE280  88 1D 00 B0 */	lbz r0, 0xb0(r29)                       
/* 802EE284  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c           
/* 802EE288  41 82 00 0C */	beq lbl_802EE294                         /* constant-address: 802EE294, symbol: lbl_802EE294 */
/* 802EE28C  38 80 00 01 */	li r4, 1                                
/* 802EE290  4B FE FF A5 */	bl __dt__10JUTTextureFv                  /* constant-address: 802DE234, symbol: __dt__10JUTTextureFv */
lbl_802EE294:
...
/* 802EE2A4  48 00 00 40 */	b lbl_802EE2E4                           /* constant-address: 802EE2E4, symbol: lbl_802EE2E4 */
lbl_802EE2A8:
...
/* 802EE2E0  38 E7 FF FF */	addi r7, r7, -1                          /* constant-address: 00000002 */
lbl_802EE2E4:
/* 802EE2E4  54 E4 06 3E */	clrlwi r4, r7, 0x18                     
/* 802EE2E8  7C 04 F0 40 */	cmplw r4, r30                           
/* 802EE2EC  41 81 FF BC */	bgt lbl_802EE2A8                         /* constant-address: 802EE2A8, symbol: lbl_802EE2A8 */
...
/* 802EE308  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EE350  48 07 3E D9 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

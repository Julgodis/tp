...
/* 802EDAD4  38 A5 FF FF */	addi r5, r5, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EDAEC  42 00 FF F4 */	bdnz lbl_802EDAE0                        /* constant-address: 802EDAE0, symbol: lbl_802EDAE0 */
/* 802EDAF0  3C 80 00 01 */	lis r4, 0x0001 /* 0x0000FFFF@ha */      
/* 802EDAF4  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 802EDAF8  B0 03 00 0C */	sth r0, 0xc(r3)                         
/* 802EDAFC  38 80 00 00 */	li r4, 0                                
/* 802EDB00  38 A2 C7 80 */	la r5, j2dDefaultTevOrderInfoNull(r2) /* 80456180-_SDA2_BASE_ */ /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EDB04  38 00 00 04 */	li r0, 4                                
/* 802EDB08  7C 09 03 A6 */	mtctr r0                                
lbl_802EDB0C:
/* 802EDB0C  88 02 C7 80 */	lbz r0, j2dDefaultTevOrderInfoNull(r2)   /* constant-address: 80456180, symbol: j2dDefaultTevOrderInfoNull */
/* 802EDB10  7C C3 22 14 */	add r6, r3, r4                          
/* 802EDB14  98 06 00 0E */	stb r0, 0xe(r6)                         
/* 802EDB18  88 05 00 01 */	lbz r0, 1(r5)                            /* constant-address: 80456181, symbol: None */
/* 802EDB1C  98 06 00 0F */	stb r0, 0xf(r6)                         
/* 802EDB20  88 05 00 02 */	lbz r0, 2(r5)                            /* constant-address: 80456182, symbol: None */
/* 802EDB24  98 06 00 10 */	stb r0, 0x10(r6)                        
/* 802EDB28  38 84 00 04 */	addi r4, r4, 4                          
/* 802EDB2C  42 00 FF E0 */	bdnz lbl_802EDB0C                        /* constant-address: 802EDB0C, symbol: lbl_802EDB0C */
/* 802EDB30  38 80 00 00 */	li r4, 0                                
/* 802EDB34  38 A2 C7 88 */	la r5, j2dDefaultTevColor(r2) /* 80456188-_SDA2_BASE_ */ /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EDB38  A9 02 C7 88 */	lha r8, j2dDefaultTevColor(r2)           /* constant-address: 80456188, symbol: j2dDefaultTevColor */
/* 802EDB3C  A8 E5 00 02 */	lha r7, 2(r5)                            /* constant-address: 8045618A, symbol: None */
/* 802EDB40  A8 C5 00 04 */	lha r6, 4(r5)                            /* constant-address: 8045618C, symbol: None */
/* 802EDB44  A8 A5 00 06 */	lha r5, 6(r5)                            /* constant-address: 8045618E, symbol: None */
...
/* 802EDB68  42 00 FF E8 */	bdnz lbl_802EDB50                        /* constant-address: 802EDB50, symbol: lbl_802EDB50 */
...
/* 802EDBA0  42 00 FF E4 */	bdnz lbl_802EDB84                        /* constant-address: 802EDB84, symbol: lbl_802EDB84 */
/* 802EDBA4  38 80 00 00 */	li r4, 0                                
/* 802EDBA8  81 02 C7 94 */	lwz r8, j2dDefaultTevKColor(r2)          /* constant-address: 80456194, symbol: j2dDefaultTevKColor */
...
/* 802EDBF0  42 00 FF C4 */	bdnz lbl_802EDBB4                        /* constant-address: 802EDBB4, symbol: lbl_802EDBB4 */
...
/* 802EDC14  42 00 FF F0 */	bdnz lbl_802EDC04                        /* constant-address: 802EDC04, symbol: lbl_802EDC04 */
/* 802EDC18  39 20 00 00 */	li r9, 0                                
/* 802EDC1C  39 02 C7 9C */	la r8, j2dDefaultTevSwapModeTable(r2) /* 8045619C-_SDA2_BASE_ */ /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
/* 802EDC20  38 00 00 04 */	li r0, 4                                
/* 802EDC24  7C 09 03 A6 */	mtctr r0                                
lbl_802EDC28:
/* 802EDC28  88 E8 00 01 */	lbz r7, 1(r8)                            /* constant-address: 8045619D, symbol: None */
/* 802EDC2C  88 C8 00 03 */	lbz r6, 3(r8)                            /* constant-address: 8045619F, symbol: None */
/* 802EDC30  88 08 00 02 */	lbz r0, 2(r8)                            /* constant-address: 8045619E, symbol: None */
/* 802EDC34  54 05 15 BA */	rlwinm r5, r0, 2, 0x16, 0x1d            
/* 802EDC38  88 02 C7 9C */	lbz r0, j2dDefaultTevSwapModeTable(r2)   /* constant-address: 8045619C, symbol: j2dDefaultTevSwapModeTable */
...
/* 802EDC5C  42 00 FF CC */	bdnz lbl_802EDC28                        /* constant-address: 802EDC28, symbol: lbl_802EDC28 */
/* 802EDC60  38 A0 00 00 */	li r5, 0                                
/* 802EDC64  3C 80 80 3A */	lis r4, j2dDefaultIndTevStageInfo@ha    
/* 802EDC68  38 84 1B F4 */	addi r4, r4, j2dDefaultIndTevStageInfo@l /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EDC6C  38 00 00 04 */	li r0, 4                                
/* 802EDC70  7C 09 03 A6 */	mtctr r0                                
lbl_802EDC74:
/* 802EDC74  80 C4 00 00 */	lwz r6, 0(r4)                            /* constant-address: 803A1BF4, symbol: j2dDefaultIndTevStageInfo */
/* 802EDC78  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A1BF8, symbol: None */
/* 802EDC7C  90 C1 00 10 */	stw r6, 0x10(r1)                        
/* 802EDC80  90 01 00 14 */	stw r0, 0x14(r1)                        
/* 802EDC84  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803A1BFC, symbol: None */
...
/* 802EDCFC  42 00 FF 78 */	bdnz lbl_802EDC74                        /* constant-address: 802EDC74, symbol: lbl_802EDC74 */
...
/* 802EDD1C  42 00 FF F4 */	bdnz lbl_802EDD10                        /* constant-address: 802EDD10, symbol: lbl_802EDD10 */

...
/* 802EDE14  48 07 43 B9 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802EDE2C  40 80 00 0C */	bge lbl_802EDE38                         /* constant-address: 802EDE38, symbol: lbl_802EDE38 */
/* 802EDE30  28 1B 00 00 */	cmplwi r27, 0                           
/* 802EDE34  40 82 00 0C */	bne lbl_802EDE40                         /* constant-address: 802EDE40, symbol: lbl_802EDE40 */
lbl_802EDE38:
/* 802EDE38  38 60 00 00 */	li r3, 0                                
/* 802EDE3C  48 00 03 80 */	b lbl_802EE1BC                           /* constant-address: 802EE1BC, symbol: lbl_802EE1BC */
lbl_802EDE40:
/* 802EDE40  3B C0 00 00 */	li r30, 0                               
/* 802EDE44  48 00 00 28 */	b lbl_802EDE6C                           /* constant-address: 802EDE6C, symbol: lbl_802EDE6C */
lbl_802EDE48:
...
/* 802EDE58  41 82 00 20 */	beq lbl_802EDE78                         /* constant-address: 802EDE78, symbol: lbl_802EDE78 */
/* 802EDE5C  80 03 00 20 */	lwz r0, 0x20(r3)                        
/* 802EDE60  28 00 00 00 */	cmplwi r0, 0                            
/* 802EDE64  41 82 00 14 */	beq lbl_802EDE78                         /* constant-address: 802EDE78, symbol: lbl_802EDE78 */
/* 802EDE68  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_802EDE6C:
/* 802EDE6C  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802EDE70  28 00 00 04 */	cmplwi r0, 4                            
/* 802EDE74  41 80 FF D4 */	blt lbl_802EDE48                         /* constant-address: 802EDE48, symbol: lbl_802EDE48 */
lbl_802EDE78:
/* 802EDE78  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 802EDE7C  7C 00 D0 40 */	cmplw r0, r26                           
/* 802EDE80  40 80 00 0C */	bge lbl_802EDE8C                         /* constant-address: 802EDE8C, symbol: lbl_802EDE8C */
/* 802EDE84  38 60 00 00 */	li r3, 0                                
/* 802EDE88  48 00 03 34 */	b lbl_802EE1BC                           /* constant-address: 802EE1BC, symbol: lbl_802EE1BC */
lbl_802EDE8C:
/* 802EDE8C  28 00 00 04 */	cmplwi r0, 4                            
/* 802EDE90  40 82 00 0C */	bne lbl_802EDE9C                         /* constant-address: 802EDE9C, symbol: lbl_802EDE9C */
/* 802EDE94  38 60 00 00 */	li r3, 0                                
/* 802EDE98  48 00 03 24 */	b lbl_802EE1BC                           /* constant-address: 802EE1BC, symbol: lbl_802EE1BC */
lbl_802EDE9C:
/* 802EDE9C  3B A0 00 00 */	li r29, 0                               
/* 802EDEA0  88 1B 00 08 */	lbz r0, 8(r27)                          
/* 802EDEA4  28 00 00 00 */	cmplwi r0, 0                            
/* 802EDEA8  41 82 00 B8 */	beq lbl_802EDF60                         /* constant-address: 802EDF60, symbol: lbl_802EDF60 */
/* 802EDEAC  28 1C 00 00 */	cmplwi r28, 0                           
/* 802EDEB0  40 82 00 B0 */	bne lbl_802EDF60                         /* constant-address: 802EDF60, symbol: lbl_802EDF60 */
...
/* 802EDED0  41 82 00 50 */	beq lbl_802EDF20                         /* constant-address: 802EDF20, symbol: lbl_802EDF20 */
/* 802EDED4  80 85 00 20 */	lwz r4, 0x20(r5)                        
/* 802EDED8  28 04 00 00 */	cmplwi r4, 0                            
/* 802EDEDC  41 82 00 44 */	beq lbl_802EDF20                         /* constant-address: 802EDF20, symbol: lbl_802EDF20 */
/* 802EDEE0  88 04 00 08 */	lbz r0, 8(r4)                           
/* 802EDEE4  28 00 00 00 */	cmplwi r0, 0                            
/* 802EDEE8  41 82 00 38 */	beq lbl_802EDF20                         /* constant-address: 802EDF20, symbol: lbl_802EDF20 */
/* 802EDEEC  88 85 00 3A */	lbz r4, 0x3a(r5)                        
/* 802EDEF0  2C 04 00 10 */	cmpwi r4, 0x10                          
/* 802EDEF4  38 00 00 00 */	li r0, 0                                
/* 802EDEF8  41 80 00 08 */	blt lbl_802EDF00                         /* constant-address: 802EDF00, symbol: lbl_802EDF00 */
...
/* 802EDF0C  40 80 00 14 */	bge lbl_802EDF20                         /* constant-address: 802EDF20, symbol: lbl_802EDF20 */
...
/* 802EDF24  42 00 FF A0 */	bdnz lbl_802EDEC4                        /* constant-address: 802EDEC4, symbol: lbl_802EDEC4 */
/* 802EDF28  38 A0 00 00 */	li r5, 0                                
/* 802EDF2C  54 C4 06 3E */	clrlwi r4, r6, 0x18                     
/* 802EDF30  38 60 00 01 */	li r3, 1                                
/* 802EDF34  48 00 00 20 */	b lbl_802EDF54                           /* constant-address: 802EDF54, symbol: lbl_802EDF54 */
lbl_802EDF38:
/* 802EDF38  54 A0 06 3E */	clrlwi r0, r5, 0x18                     
/* 802EDF3C  7C 60 00 30 */	slw r0, r3, r0                          
/* 802EDF40  7C 80 00 39 */	and. r0, r4, r0                         
/* 802EDF44  40 82 00 0C */	bne lbl_802EDF50                         /* constant-address: 802EDF50, symbol: lbl_802EDF50 */
/* 802EDF48  7C BD 2B 78 */	mr r29, r5                              
/* 802EDF4C  48 00 00 14 */	b lbl_802EDF60                           /* constant-address: 802EDF60, symbol: lbl_802EDF60 */
lbl_802EDF50:
/* 802EDF50  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
lbl_802EDF54:
/* 802EDF54  54 A0 06 3E */	clrlwi r0, r5, 0x18                     
/* 802EDF58  28 00 00 04 */	cmplwi r0, 4                            
/* 802EDF5C  41 80 FF DC */	blt lbl_802EDF38                         /* constant-address: 802EDF38, symbol: lbl_802EDF38 */
lbl_802EDF60:
...
/* 802EDF70  40 82 00 EC */	bne lbl_802EE05C                         /* constant-address: 802EE05C, symbol: lbl_802EE05C */
/* 802EDF74  38 60 00 40 */	li r3, 0x40                             
/* 802EDF78  4B FE 0C D5 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 802EDF7C  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 802EDF80  41 82 00 24 */	beq lbl_802EDFA4                         /* constant-address: 802EDFA4, symbol: lbl_802EDFA4 */
...
/* 802EDF94  4B FF 03 15 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
...
/* 802EDFA8  40 82 00 0C */	bne lbl_802EDFB4                         /* constant-address: 802EDFB4, symbol: lbl_802EDFB4 */
/* 802EDFAC  38 60 00 00 */	li r3, 0                                
/* 802EDFB0  48 00 02 0C */	b lbl_802EE1BC                           /* constant-address: 802EE1BC, symbol: lbl_802EE1BC */
lbl_802EDFB4:
/* 802EDFB4  28 1C 00 00 */	cmplwi r28, 0                           
/* 802EDFB8  41 82 00 14 */	beq lbl_802EDFCC                         /* constant-address: 802EDFCC, symbol: lbl_802EDFCC */
/* 802EDFBC  7F E3 FB 78 */	mr r3, r31                              
/* 802EDFC0  7F 64 DB 78 */	mr r4, r27                              
/* 802EDFC4  7F 85 E3 78 */	mr r5, r28                              
/* 802EDFC8  4B FF 04 85 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette /* constant-address: 802DE44C, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette */
lbl_802EDFCC:
/* 802EDFCC  38 E0 00 03 */	li r7, 3                                
/* 802EDFD0  48 00 00 40 */	b lbl_802EE010                           /* constant-address: 802EE010, symbol: lbl_802EE010 */
lbl_802EDFD4:
...
/* 802EE00C  38 E7 FF FF */	addi r7, r7, -1                          /* constant-address: 00000002 */
lbl_802EE010:
/* 802EE010  54 E4 06 3E */	clrlwi r4, r7, 0x18                     
/* 802EE014  7C 04 D0 40 */	cmplw r4, r26                           
/* 802EE018  41 81 FF BC */	bgt lbl_802EDFD4                         /* constant-address: 802EDFD4, symbol: lbl_802EDFD4 */
...
/* 802EE058  48 00 01 3C */	b lbl_802EE194                           /* constant-address: 802EE194, symbol: lbl_802EE194 */
lbl_802EE05C:
/* 802EE05C  28 1C 00 00 */	cmplwi r28, 0                           
/* 802EE060  40 82 00 18 */	bne lbl_802EE078                         /* constant-address: 802EE078, symbol: lbl_802EE078 */
/* 802EE064  7F E3 FB 78 */	mr r3, r31                              
/* 802EE068  7F 64 DB 78 */	mr r4, r27                              
/* 802EE06C  7F A5 EB 78 */	mr r5, r29                              
/* 802EE070  4B FF 02 39 */	bl storeTIMG__10JUTTextureFPC7ResTIMGUc  /* constant-address: 802DE2A8, symbol: storeTIMG__10JUTTextureFPC7ResTIMGUc */
/* 802EE074  48 00 00 14 */	b lbl_802EE088                           /* constant-address: 802EE088, symbol: lbl_802EE088 */
lbl_802EE078:
/* 802EE078  7F E3 FB 78 */	mr r3, r31                              
/* 802EE07C  7F 64 DB 78 */	mr r4, r27                              
/* 802EE080  7F 85 E3 78 */	mr r5, r28                              
/* 802EE084  4B FF 03 C9 */	bl storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette /* constant-address: 802DE44C, symbol: storeTIMG__10JUTTextureFPC7ResTIMGP10JUTPalette */
lbl_802EE088:
/* 802EE088  38 E0 00 00 */	li r7, 0                                
/* 802EE08C  38 C0 00 01 */	li r6, 1                                
/* 802EE090  38 61 00 08 */	addi r3, r1, 8                          
/* 802EE094  48 00 00 24 */	b lbl_802EE0B8                           /* constant-address: 802EE0B8, symbol: lbl_802EE0B8 */
lbl_802EE098:
...
/* 802EE0B4  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_802EE0B8:
/* 802EE0B8  54 E0 06 3E */	clrlwi r0, r7, 0x18                     
/* 802EE0BC  28 00 00 04 */	cmplwi r0, 4                            
/* 802EE0C0  41 80 FF D8 */	blt lbl_802EE098                         /* constant-address: 802EE098, symbol: lbl_802EE098 */
/* 802EE0C4  7F C9 F3 78 */	mr r9, r30                              
/* 802EE0C8  38 61 00 08 */	addi r3, r1, 8                          
/* 802EE0CC  48 00 00 50 */	b lbl_802EE11C                           /* constant-address: 802EE11C, symbol: lbl_802EE11C */
lbl_802EE0D0:
...
/* 802EE118  39 29 FF FF */	addi r9, r9, -1                          /* constant-address: -0000001 */
lbl_802EE11C:
/* 802EE11C  55 26 06 3E */	clrlwi r6, r9, 0x18                     
/* 802EE120  7C 06 D0 40 */	cmplw r6, r26                           
/* 802EE124  41 81 FF AC */	bgt lbl_802EE0D0                         /* constant-address: 802EE0D0, symbol: lbl_802EE0D0 */
...
/* 802EE14C  48 00 00 28 */	b lbl_802EE174                           /* constant-address: 802EE174, symbol: lbl_802EE174 */
lbl_802EE150:
/* 802EE150  54 E6 06 3E */	clrlwi r6, r7, 0x18                     
/* 802EE154  7C 05 30 AE */	lbzx r0, r5, r6                         
/* 802EE158  28 00 00 00 */	cmplwi r0, 0                            
/* 802EE15C  41 82 00 14 */	beq lbl_802EE170                         /* constant-address: 802EE170, symbol: lbl_802EE170 */
...
lbl_802EE170:
/* 802EE170  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_802EE174:
/* 802EE174  54 E0 06 3E */	clrlwi r0, r7, 0x18                     
/* 802EE178  28 00 00 04 */	cmplwi r0, 4                            
/* 802EE17C  41 80 FF D4 */	blt lbl_802EE150                         /* constant-address: 802EE150, symbol: lbl_802EE150 */
...
/* 802EE1A8  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 802EE1C0  48 07 40 59 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

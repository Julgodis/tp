...
/* 8028DFC0  41 82 00 80 */	beq lbl_8028E040                         /* constant-address: 8028E040, symbol: lbl_8028E040 */
/* 8028DFC4  80 1F 01 28 */	lwz r0, 0x128(r31)                      
/* 8028DFC8  C0 22 BB 10 */	lfs f1, lit_1470(r2)                     /* constant-address: 80455510, symbol: lit_1470 */
/* 8028DFCC  D0 23 00 24 */	stfs f1, 0x24(r3)                       
/* 8028DFD0  28 00 00 00 */	cmplwi r0, 0                            
/* 8028DFD4  41 82 00 40 */	beq lbl_8028E014                         /* constant-address: 8028E014, symbol: lbl_8028E014 */
/* 8028DFD8  C0 03 00 24 */	lfs f0, 0x24(r3)                        
/* 8028DFDC  90 03 00 30 */	stw r0, 0x30(r3)                        
/* 8028DFE0  C0 62 BB 14 */	lfs f3, lit_1805(r2)                     /* constant-address: 80455514, symbol: lit_1805 */
/* 8028DFE4  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 8028DFE8  80 03 00 30 */	lwz r0, 0x30(r3)                        
/* 8028DFEC  C8 22 BB 18 */	lfd f1, lit_1807(r2)                     /* constant-address: 80455518, symbol: lit_1807 */
...
/* 8028E010  48 00 00 1C */	b lbl_8028E02C                           /* constant-address: 8028E02C, symbol: lbl_8028E02C */
lbl_8028E014:
/* 8028E014  C0 02 BB 14 */	lfs f0, lit_1805(r2)                     /* constant-address: 80455514, symbol: lit_1805 */
...
/* 8028E034  48 01 42 11 */	bl unlockIfLocked__15JAISoundStatus_Fv   /* constant-address: 802A2244, symbol: unlockIfLocked__15JAISoundStatus_Fv */

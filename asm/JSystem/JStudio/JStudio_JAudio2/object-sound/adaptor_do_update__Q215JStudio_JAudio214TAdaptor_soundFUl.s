...
/* 8028DAA0  38 A5 AB 6C */	addi r5, r5, sauVariableValue_3_POSITION_XYZ__Q27JStudio14TAdaptor_sound@l /* constant-address: 8039AB6C, symbol: sauVariableValue_3_POSITION_XYZ__Q27JStudio14TAdaptor_sound */
/* 8028DAA4  4B FF 87 D1 */	bl adaptor_getVariableValue_Vec__Q27JStudio8TAdaptorCFP3VecPCUl /* constant-address: 80286274, symbol: adaptor_getVariableValue_Vec__Q27JStudio8TAdaptorCFP3VecPCUl */
/* 8028DAA8  88 1F 01 44 */	lbz r0, 0x144(r31)                      
/* 8028DAAC  28 00 00 00 */	cmplwi r0, 0                            
/* 8028DAB0  40 82 00 34 */	bne lbl_8028DAE4                         /* constant-address: 8028DAE4, symbol: lbl_8028DAE4 */
/* 8028DAB4  88 1E 00 88 */	lbz r0, 0x88(r30)                       
/* 8028DAB8  28 00 00 00 */	cmplwi r0, 0                            
/* 8028DABC  40 82 00 0C */	bne lbl_8028DAC8                         /* constant-address: 8028DAC8, symbol: lbl_8028DAC8 */
/* 8028DAC0  38 01 00 18 */	addi r0, r1, 0x18                       
/* 8028DAC4  48 00 00 18 */	b lbl_8028DADC                           /* constant-address: 8028DADC, symbol: lbl_8028DADC */
lbl_8028DAC8:
/* 8028DAC8  38 7E 00 AC */	addi r3, r30, 0xac                      
/* 8028DACC  38 81 00 18 */	addi r4, r1, 0x18                       
/* 8028DAD0  38 A1 00 0C */	addi r5, r1, 0xc                        
/* 8028DAD4  48 0B 92 99 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 8028DAD8  38 01 00 0C */	addi r0, r1, 0xc                        
lbl_8028DADC:
/* 8028DADC  7C 03 03 78 */	mr r3, r0                               
/* 8028DAE0  48 00 00 50 */	b lbl_8028DB30                           /* constant-address: 8028DB30, symbol: lbl_8028DB30 */
lbl_8028DAE4:
...
/* 8028DAF4  4B FF C7 9D */	bl transform_toGlobalFromLocal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl /* constant-address: 8028A290, symbol: transform_toGlobalFromLocal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl */
/* 8028DAF8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8028DAFC  40 82 00 0C */	bne lbl_8028DB08                         /* constant-address: 8028DB08, symbol: lbl_8028DB08 */
/* 8028DB00  38 00 00 00 */	li r0, 0                                
/* 8028DB04  48 00 00 20 */	b lbl_8028DB24                           /* constant-address: 8028DB24, symbol: lbl_8028DB24 */
lbl_8028DB08:
...
/* 8028DB28  41 82 00 E0 */	beq lbl_8028DC08                         /* constant-address: 8028DC08, symbol: lbl_8028DC08 */
...
/* 8028DB48  41 82 00 4C */	beq lbl_8028DB94                         /* constant-address: 8028DB94, symbol: lbl_8028DB94 */
/* 8028DB4C  88 1F 01 20 */	lbz r0, 0x120(r31)                      
/* 8028DB50  2C 00 00 02 */	cmpwi r0, 2                             
/* 8028DB54  41 82 00 14 */	beq lbl_8028DB68                         /* constant-address: 8028DB68, symbol: lbl_8028DB68 */
/* 8028DB58  40 80 00 3C */	bge lbl_8028DB94                         /* constant-address: 8028DB94, symbol: lbl_8028DB94 */
/* 8028DB5C  2C 00 00 01 */	cmpwi r0, 1                             
/* 8028DB60  40 80 00 2C */	bge lbl_8028DB8C                         /* constant-address: 8028DB8C, symbol: lbl_8028DB8C */
/* 8028DB64  48 00 00 30 */	b lbl_8028DB94                           /* constant-address: 8028DB94, symbol: lbl_8028DB94 */
lbl_8028DB68:
...
/* 8028DB84  48 01 54 69 */	bl func_802A2FEC                         /* constant-address: 802A2FEC, symbol: func_802A2FEC */
/* 8028DB88  48 00 00 0C */	b lbl_8028DB94                           /* constant-address: 8028DB94, symbol: lbl_8028DB94 */
lbl_8028DB8C:
...
/* 8028DB9C  41 82 00 30 */	beq lbl_8028DBCC                         /* constant-address: 8028DBCC, symbol: lbl_8028DBCC */
/* 8028DBA0  80 7F 01 24 */	lwz r3, 0x124(r31)                      
/* 8028DBA4  3C 03 00 01 */	addis r0, r3, 1                         
/* 8028DBA8  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 8028DBAC  41 82 00 20 */	beq lbl_8028DBCC                         /* constant-address: 8028DBCC, symbol: lbl_8028DBCC */
/* 8028DBB0  80 1F 01 18 */	lwz r0, 0x118(r31)                      
/* 8028DBB4  28 00 00 00 */	cmplwi r0, 0                            
/* 8028DBB8  40 82 00 14 */	bne lbl_8028DBCC                         /* constant-address: 8028DBCC, symbol: lbl_8028DBCC */
/* 8028DBBC  7F E3 FB 78 */	mr r3, r31                              
/* 8028DBC0  48 00 03 45 */	bl prepareSound___Q215JStudio_JAudio214TAdaptor_soundFv /* constant-address: 8028DF04, symbol: prepareSound___Q215JStudio_JAudio214TAdaptor_soundFv */
/* 8028DBC4  7F E3 FB 78 */	mr r3, r31                              
/* 8028DBC8  48 00 03 DD */	bl beginSound_fadeIn___Q215JStudio_JAudio214TAdaptor_soundFv /* constant-address: 8028DFA4, symbol: beginSound_fadeIn___Q215JStudio_JAudio214TAdaptor_soundFv */
lbl_8028DBCC:
/* 8028DBCC  80 7F 01 2C */	lwz r3, 0x12c(r31)                      
/* 8028DBD0  28 03 00 00 */	cmplwi r3, 0                            
/* 8028DBD4  41 82 00 34 */	beq lbl_8028DC08                         /* constant-address: 8028DC08, symbol: lbl_8028DC08 */
/* 8028DBD8  80 9F 01 18 */	lwz r4, 0x118(r31)                      
/* 8028DBDC  28 04 00 00 */	cmplwi r4, 0                            
/* 8028DBE0  41 82 00 28 */	beq lbl_8028DC08                         /* constant-address: 8028DC08, symbol: lbl_8028DC08 */
/* 8028DBE4  80 84 00 08 */	lwz r4, 8(r4)                           
/* 8028DBE8  28 04 00 00 */	cmplwi r4, 0                            
/* 8028DBEC  41 82 00 1C */	beq lbl_8028DC08                         /* constant-address: 8028DC08, symbol: lbl_8028DC08 */

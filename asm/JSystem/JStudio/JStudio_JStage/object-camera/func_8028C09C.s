...
/* 8028C0D8  40 82 00 34 */	bne lbl_8028C10C                         /* constant-address: 8028C10C, symbol: lbl_8028C10C */
/* 8028C0DC  88 1F 00 89 */	lbz r0, 0x89(r31)                       
/* 8028C0E0  28 00 00 00 */	cmplwi r0, 0                            
/* 8028C0E4  40 82 00 0C */	bne lbl_8028C0F0                         /* constant-address: 8028C0F0, symbol: lbl_8028C0F0 */
/* 8028C0E8  38 01 00 14 */	addi r0, r1, 0x14                       
/* 8028C0EC  48 00 00 18 */	b lbl_8028C104                           /* constant-address: 8028C104, symbol: lbl_8028C104 */
lbl_8028C0F0:
/* 8028C0F0  38 7F 00 DC */	addi r3, r31, 0xdc                      
/* 8028C0F4  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8028C0F8  38 A1 00 08 */	addi r5, r1, 8                          
/* 8028C0FC  48 0B AC 71 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 8028C100  38 01 00 08 */	addi r0, r1, 8                          
lbl_8028C104:
/* 8028C104  7C 05 03 78 */	mr r5, r0                               
/* 8028C108  48 00 00 50 */	b lbl_8028C158                           /* constant-address: 8028C158, symbol: lbl_8028C158 */
lbl_8028C10C:
...
/* 8028C11C  4B FF E2 B1 */	bl transform_toLocalFromGlobal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl /* constant-address: 8028A3CC, symbol: transform_toLocalFromGlobal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl */
/* 8028C120  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8028C124  40 82 00 0C */	bne lbl_8028C130                         /* constant-address: 8028C130, symbol: lbl_8028C130 */
/* 8028C128  38 00 00 00 */	li r0, 0                                
/* 8028C12C  48 00 00 20 */	b lbl_8028C14C                           /* constant-address: 8028C14C, symbol: lbl_8028C14C */
lbl_8028C130:
...
/* 8028C150  41 82 00 18 */	beq lbl_8028C168                         /* constant-address: 8028C168, symbol: lbl_8028C168 */
...
/* 8028C160  38 84 AA B4 */	addi r4, r4, sauVariableValue_3_TARGET_POSITION_XYZ__Q27JStudio15TAdaptor_camera@l /* constant-address: 8039AAB4, symbol: sauVariableValue_3_TARGET_POSITION_XYZ__Q27JStudio15TAdaptor_camera */
/* 8028C164  4B FF A0 A1 */	bl adaptor_setVariableValue_Vec__Q27JStudio8TAdaptorFPCUlRC3Vec /* constant-address: 80286204, symbol: adaptor_setVariableValue_Vec__Q27JStudio8TAdaptorFPCUlRC3Vec */
lbl_8028C168:

...
/* 8028BFDC  3C A0 80 3A */	lis r5, sauVariableValue_3_TARGET_POSITION_XYZ__Q27JStudio15TAdaptor_camera@ha
/* 8028BFE0  38 A5 AA B4 */	addi r5, r5, sauVariableValue_3_TARGET_POSITION_XYZ__Q27JStudio15TAdaptor_camera@l /* constant-address: 8039AAB4, symbol: sauVariableValue_3_TARGET_POSITION_XYZ__Q27JStudio15TAdaptor_camera */
/* 8028BFE4  4B FF A2 91 */	bl adaptor_getVariableValue_Vec__Q27JStudio8TAdaptorCFP3VecPCUl /* constant-address: 80286274, symbol: adaptor_getVariableValue_Vec__Q27JStudio8TAdaptorCFP3VecPCUl */
/* 8028BFE8  88 1E 01 20 */	lbz r0, 0x120(r30)                      
/* 8028BFEC  28 00 00 00 */	cmplwi r0, 0                            
/* 8028BFF0  40 82 00 34 */	bne lbl_8028C024                         /* constant-address: 8028C024, symbol: lbl_8028C024 */
/* 8028BFF4  88 1F 00 88 */	lbz r0, 0x88(r31)                       
/* 8028BFF8  28 00 00 00 */	cmplwi r0, 0                            
/* 8028BFFC  40 82 00 0C */	bne lbl_8028C008                         /* constant-address: 8028C008, symbol: lbl_8028C008 */
/* 8028C000  38 01 00 14 */	addi r0, r1, 0x14                       
/* 8028C004  48 00 00 18 */	b lbl_8028C01C                           /* constant-address: 8028C01C, symbol: lbl_8028C01C */
lbl_8028C008:
/* 8028C008  38 7F 00 AC */	addi r3, r31, 0xac                      
/* 8028C00C  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8028C010  38 A1 00 08 */	addi r5, r1, 8                          
/* 8028C014  48 0B AD 59 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 8028C018  38 01 00 08 */	addi r0, r1, 8                          
lbl_8028C01C:
/* 8028C01C  7C 04 03 78 */	mr r4, r0                               
/* 8028C020  48 00 00 50 */	b lbl_8028C070                           /* constant-address: 8028C070, symbol: lbl_8028C070 */
lbl_8028C024:
...
/* 8028C034  4B FF E2 5D */	bl transform_toGlobalFromLocal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl /* constant-address: 8028A290, symbol: transform_toGlobalFromLocal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl */
/* 8028C038  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8028C03C  40 82 00 0C */	bne lbl_8028C048                         /* constant-address: 8028C048, symbol: lbl_8028C048 */
/* 8028C040  38 00 00 00 */	li r0, 0                                
/* 8028C044  48 00 00 20 */	b lbl_8028C064                           /* constant-address: 8028C064, symbol: lbl_8028C064 */
lbl_8028C048:
...
/* 8028C068  41 82 00 1C */	beq lbl_8028C084                         /* constant-address: 8028C084, symbol: lbl_8028C084 */

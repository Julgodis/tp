...
/* 8028BDE0  38 A5 AA A8 */	addi r5, r5, sauVariableValue_3_POSITION_XYZ__Q27JStudio15TAdaptor_camera@l /* constant-address: 8039AAA8, symbol: sauVariableValue_3_POSITION_XYZ__Q27JStudio15TAdaptor_camera */
/* 8028BDE4  4B FF A4 91 */	bl adaptor_getVariableValue_Vec__Q27JStudio8TAdaptorCFP3VecPCUl /* constant-address: 80286274, symbol: adaptor_getVariableValue_Vec__Q27JStudio8TAdaptorCFP3VecPCUl */
/* 8028BDE8  88 1E 01 14 */	lbz r0, 0x114(r30)                      
/* 8028BDEC  28 00 00 00 */	cmplwi r0, 0                            
/* 8028BDF0  40 82 00 34 */	bne lbl_8028BE24                         /* constant-address: 8028BE24, symbol: lbl_8028BE24 */
/* 8028BDF4  88 1F 00 88 */	lbz r0, 0x88(r31)                       
/* 8028BDF8  28 00 00 00 */	cmplwi r0, 0                            
/* 8028BDFC  40 82 00 0C */	bne lbl_8028BE08                         /* constant-address: 8028BE08, symbol: lbl_8028BE08 */
/* 8028BE00  38 01 00 14 */	addi r0, r1, 0x14                       
/* 8028BE04  48 00 00 18 */	b lbl_8028BE1C                           /* constant-address: 8028BE1C, symbol: lbl_8028BE1C */
lbl_8028BE08:
/* 8028BE08  38 7F 00 AC */	addi r3, r31, 0xac                      
/* 8028BE0C  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8028BE10  38 A1 00 08 */	addi r5, r1, 8                          
/* 8028BE14  48 0B AF 59 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 8028BE18  38 01 00 08 */	addi r0, r1, 8                          
lbl_8028BE1C:
/* 8028BE1C  7C 04 03 78 */	mr r4, r0                               
/* 8028BE20  48 00 00 6C */	b lbl_8028BE8C                           /* constant-address: 8028BE8C, symbol: lbl_8028BE8C */
lbl_8028BE24:
/* 8028BE24  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8028BE28  80 1E 01 08 */	lwz r0, 0x108(r30)                      
/* 8028BE2C  2C 00 00 01 */	cmpwi r0, 1                             
/* 8028BE30  41 82 00 5C */	beq lbl_8028BE8C                         /* constant-address: 8028BE8C, symbol: lbl_8028BE8C */
/* 8028BE34  40 80 00 58 */	bge lbl_8028BE8C                         /* constant-address: 8028BE8C, symbol: lbl_8028BE8C */
/* 8028BE38  2C 00 00 00 */	cmpwi r0, 0                             
/* 8028BE3C  40 80 00 08 */	bge lbl_8028BE44                         /* constant-address: 8028BE44, symbol: lbl_8028BE44 */
/* 8028BE40  48 00 00 4C */	b lbl_8028BE8C                           /* constant-address: 8028BE8C, symbol: lbl_8028BE8C */
lbl_8028BE44:
/* 8028BE44  38 61 00 20 */	addi r3, r1, 0x20                       
/* 8028BE48  80 BE 01 0C */	lwz r5, 0x10c(r30)                      
/* 8028BE4C  80 DE 01 10 */	lwz r6, 0x110(r30)                      
/* 8028BE50  4B FF E4 41 */	bl transform_toGlobalFromLocal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl /* constant-address: 8028A290, symbol: transform_toGlobalFromLocal__14JStudio_JStageFPA4_fRCQ37JStudio8TControl19TTransform_positionPCQ26JStage7TObjectUl */
/* 8028BE54  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8028BE58  40 82 00 0C */	bne lbl_8028BE64                         /* constant-address: 8028BE64, symbol: lbl_8028BE64 */
/* 8028BE5C  38 00 00 00 */	li r0, 0                                
/* 8028BE60  48 00 00 20 */	b lbl_8028BE80                           /* constant-address: 8028BE80, symbol: lbl_8028BE80 */
lbl_8028BE64:
...
/* 8028BE84  41 82 00 1C */	beq lbl_8028BEA0                         /* constant-address: 8028BEA0, symbol: lbl_8028BEA0 */

...
/* 80285BFC  48 0D C5 DD */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 80285C2C  48 0C 15 25 */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
...
/* 80285C50  48 0C 15 01 */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
...
/* 80285C74  48 0C 14 DD */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
...
/* 80285C94  C8 62 BA 70 */	lfd f3, lit_623(r2)                      /* constant-address: 80455470, symbol: lit_623 */
/* 80285C98  FC 80 18 90 */	fmr f4, f3                              
/* 80285C9C  FC 40 18 90 */	fmr f2, f3                              
/* 80285CA0  C0 02 BA 6C */	lfs f0, lit_489(r2)                      /* constant-address: 8045546C, symbol: lit_489 */
/* 80285CA4  C0 3C 00 00 */	lfs f1, 0(r28)                          
/* 80285CA8  FC 00 08 00 */	fcmpu cr0, f0, f1                       
/* 80285CAC  41 82 00 0C */	beq lbl_80285CB8                         /* constant-address: 80285CB8, symbol: lbl_80285CB8 */
/* 80285CB0  C8 02 BA 78 */	lfd f0, lit_624(r2)                      /* constant-address: 80455478, symbol: lit_624 */
/* 80285CB4  FC 60 08 24 */	fdiv f3, f0, f1                         
lbl_80285CB8:
/* 80285CB8  C0 02 BA 6C */	lfs f0, lit_489(r2)                      /* constant-address: 8045546C, symbol: lit_489 */
/* 80285CBC  C0 3C 00 04 */	lfs f1, 4(r28)                          
/* 80285CC0  FC 00 08 00 */	fcmpu cr0, f0, f1                       
/* 80285CC4  41 82 00 0C */	beq lbl_80285CD0                         /* constant-address: 80285CD0, symbol: lbl_80285CD0 */
/* 80285CC8  C8 02 BA 78 */	lfd f0, lit_624(r2)                      /* constant-address: 80455478, symbol: lit_624 */
/* 80285CCC  FC 80 08 24 */	fdiv f4, f0, f1                         
lbl_80285CD0:
/* 80285CD0  C0 02 BA 6C */	lfs f0, lit_489(r2)                      /* constant-address: 8045546C, symbol: lit_489 */
/* 80285CD4  C0 3C 00 08 */	lfs f1, 8(r28)                          
/* 80285CD8  FC 00 08 00 */	fcmpu cr0, f0, f1                       
/* 80285CDC  41 82 00 0C */	beq lbl_80285CE8                         /* constant-address: 80285CE8, symbol: lbl_80285CE8 */
/* 80285CE0  C8 02 BA 78 */	lfd f0, lit_624(r2)                      /* constant-address: 80455478, symbol: lit_624 */
...
/* 80285D20  C8 A2 BA 78 */	lfd f5, lit_624(r2)                      /* constant-address: 80455478, symbol: lit_624 */
/* 80285D24  FC 9F 28 28 */	fsub f4, f31, f5                        
/* 80285D28  C0 62 BA 80 */	lfs f3, lit_625(r2)                      /* constant-address: 80455480, symbol: lit_625 */
/* 80285D2C  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 80285D30  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
...
/* 80285D44  40 82 00 1C */	bne lbl_80285D60                         /* constant-address: 80285D60, symbol: lbl_80285D60 */
/* 80285D48  FC 20 08 50 */	fneg f1, f1                             
/* 80285D4C  48 0E 69 D5 */	bl atan2                                 /* constant-address: 8036C720, symbol: atan2 */
/* 80285D50  FF 80 08 90 */	fmr f28, f1                             
/* 80285D54  C8 22 BA 88 */	lfd f1, lit_626(r2)                      /* constant-address: 80455488, symbol: lit_626 */
/* 80285D58  CB A2 BA 70 */	lfd f29, lit_623(r2)                     /* constant-address: 80455470, symbol: lit_623 */
/* 80285D5C  48 00 00 50 */	b lbl_80285DAC                           /* constant-address: 80285DAC, symbol: lbl_80285DAC */
lbl_80285D60:
/* 80285D60  FC 1F 28 2A */	fadd f0, f31, f5                        
/* 80285D64  FC 00 18 40 */	fcmpo cr0, f0, f3                       
/* 80285D68  4C 40 13 82 */	cror 2, 0, 2                            
/* 80285D6C  40 82 00 18 */	bne lbl_80285D84                         /* constant-address: 80285D84, symbol: lbl_80285D84 */
/* 80285D70  48 0E 69 B1 */	bl atan2                                 /* constant-address: 8036C720, symbol: atan2 */
/* 80285D74  FF 80 08 90 */	fmr f28, f1                             
/* 80285D78  C8 22 BA 90 */	lfd f1, lit_627(r2)                      /* constant-address: 80455490, symbol: lit_627 */
/* 80285D7C  CB A2 BA 70 */	lfd f29, lit_623(r2)                     /* constant-address: 80455470, symbol: lit_623 */
/* 80285D80  48 00 00 2C */	b lbl_80285DAC                           /* constant-address: 80285DAC, symbol: lbl_80285DAC */
lbl_80285D84:
/* 80285D84  FC 20 30 90 */	fmr f1, f6                              
/* 80285D88  FC 40 38 90 */	fmr f2, f7                              
/* 80285D8C  48 0E 69 95 */	bl atan2                                 /* constant-address: 8036C720, symbol: atan2 */
/* 80285D90  FF 80 08 90 */	fmr f28, f1                             
/* 80285D94  FC 20 E8 90 */	fmr f1, f29                             
/* 80285D98  FC 40 F0 90 */	fmr f2, f30                             
/* 80285D9C  48 0E 69 85 */	bl atan2                                 /* constant-address: 8036C720, symbol: atan2 */
/* 80285DA0  FF A0 08 90 */	fmr f29, f1                             
/* 80285DA4  FC 20 F8 50 */	fneg f1, f31                            
/* 80285DA8  48 0E 69 59 */	bl asin                                  /* constant-address: 8036C700, symbol: asin */
lbl_80285DAC:
/* 80285DAC  C8 02 BA 98 */	lfd f0, lit_628(r2)                      /* constant-address: 80455498, symbol: lit_628 */
...
/* 80285DF8  48 0D C4 2D */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 8029884C  48 0C 99 81 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 80298860  48 0A 67 E1 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 80298864  3B 60 00 00 */	li r27, 0                               
/* 80298868  3B 9A 00 04 */	addi r28, r26, 4                        
/* 8029886C  3B A0 00 00 */	li r29, 0                               
/* 80298870  3B CD 8C F8 */	la r30, mNoLoad__16JASBasicWaveBank(r13) /* 80451278-_SDA_BASE_ */ /* constant-address: 80451278, symbol: mNoLoad__16JASBasicWaveBank */
/* 80298874  3B E0 FF FF */	li r31, -1                              
/* 80298878  48 00 00 38 */	b lbl_802988B0                           /* constant-address: 802988B0, symbol: lbl_802988B0 */
lbl_8029887C:
/* 8029887C  7F 43 D3 78 */	mr r3, r26                              
/* 80298880  7F 64 DB 78 */	mr r4, r27                              
/* 80298884  48 00 02 D1 */	bl getWaveID__Q216JASBasicWaveBank10TWaveGroupCFi /* constant-address: 80298B54, symbol: getWaveID__Q216JASBasicWaveBank10TWaveGroupCFi */
...
/* 8029889C  40 82 00 10 */	bne lbl_802988AC                         /* constant-address: 802988AC, symbol: lbl_802988AC */
/* 802988A0  93 A3 00 28 */	stw r29, 0x28(r3)                       
/* 802988A4  93 C3 00 24 */	stw r30, 0x24(r3)                       
/* 802988A8  93 E3 00 0C */	stw r31, 0xc(r3)                        
lbl_802988AC:
/* 802988AC  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
lbl_802988B0:
/* 802988B0  A0 1A 00 7C */	lhz r0, 0x7c(r26)                       
/* 802988B4  7C 1B 00 40 */	cmplw r27, r0                           
/* 802988B8  41 80 FF C4 */	blt lbl_8029887C                         /* constant-address: 8029887C, symbol: lbl_8029887C */
/* 802988BC  80 61 00 08 */	lwz r3, 8(r1)                           
/* 802988C0  48 0A 68 5D */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 802988C4  39 61 00 30 */	addi r11, r1, 0x30                      
/* 802988C8  48 0C 99 51 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

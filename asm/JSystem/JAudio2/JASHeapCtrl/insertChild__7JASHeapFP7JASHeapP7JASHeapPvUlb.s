...
/* 80290618  48 0D 1B B9 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8029063C  48 0A EA 05 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 80290640  57 C0 06 3F */	clrlwi. r0, r30, 0x18                   
/* 80290644  40 82 00 54 */	bne lbl_80290698                         /* constant-address: 80290698, symbol: lbl_80290698 */
/* 80290648  28 1B 00 00 */	cmplwi r27, 0                           
/* 8029064C  40 82 00 18 */	bne lbl_80290664                         /* constant-address: 80290664, symbol: lbl_80290664 */
/* 80290650  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 80290654  28 03 00 00 */	cmplwi r3, 0                            
/* 80290658  41 82 00 1C */	beq lbl_80290674                         /* constant-address: 80290674, symbol: lbl_80290674 */
/* 8029065C  38 63 FF F4 */	addi r3, r3, -12                        
/* 80290660  48 00 00 14 */	b lbl_80290674                           /* constant-address: 80290674, symbol: lbl_80290674 */
lbl_80290664:
/* 80290664  80 7B 00 14 */	lwz r3, 0x14(r27)                       
/* 80290668  28 03 00 00 */	cmplwi r3, 0                            
/* 8029066C  41 82 00 08 */	beq lbl_80290674                         /* constant-address: 80290674, symbol: lbl_80290674 */
/* 80290670  38 63 FF F4 */	addi r3, r3, -12                        
lbl_80290674:
/* 80290674  28 03 00 00 */	cmplwi r3, 0                            
/* 80290678  41 82 00 0C */	beq lbl_80290684                         /* constant-address: 80290684, symbol: lbl_80290684 */
/* 8029067C  80 63 00 0C */	lwz r3, 0xc(r3)                         
/* 80290680  48 00 00 08 */	b lbl_80290688                           /* constant-address: 80290688, symbol: lbl_80290688 */
lbl_80290684:
/* 80290684  38 60 00 00 */	li r3, 0                                
lbl_80290688:
/* 80290688  80 1F 00 40 */	lwz r0, 0x40(r31)                       
/* 8029068C  7C 00 18 40 */	cmplw r0, r3                            
/* 80290690  40 82 00 08 */	bne lbl_80290698                         /* constant-address: 80290698, symbol: lbl_80290698 */
...
/* 802906B0  41 82 00 08 */	beq lbl_802906B8                         /* constant-address: 802906B8, symbol: lbl_802906B8 */
/* 802906B4  38 BA 00 0C */	addi r5, r26, 0xc                       
lbl_802906B8:
/* 802906B8  7F 64 DB 78 */	mr r4, r27                              
/* 802906BC  28 1B 00 00 */	cmplwi r27, 0                           
/* 802906C0  41 82 00 08 */	beq lbl_802906C8                         /* constant-address: 802906C8, symbol: lbl_802906C8 */
/* 802906C4  38 9B 00 0C */	addi r4, r27, 0xc                       
lbl_802906C8:
/* 802906C8  7F E3 FB 78 */	mr r3, r31                              
/* 802906CC  48 04 B9 C9 */	bl insert__10JSUPtrListFP10JSUPtrLinkP10JSUPtrLink /* constant-address: 802DC094, symbol: insert__10JSUPtrListFP10JSUPtrLinkP10JSUPtrLink */
/* 802906D0  80 61 00 08 */	lwz r3, 8(r1)                           
/* 802906D4  48 0A EA 49 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 802906D8  39 61 00 30 */	addi r11, r1, 0x30                      
/* 802906DC  48 0D 1B 41 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

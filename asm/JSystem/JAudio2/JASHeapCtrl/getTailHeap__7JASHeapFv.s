...
/* 8029070C  48 0A E9 35 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 80290710  80 7F 00 40 */	lwz r3, 0x40(r31)                       
/* 80290714  28 03 00 00 */	cmplwi r3, 0                            
/* 80290718  40 82 00 18 */	bne lbl_80290730                         /* constant-address: 80290730, symbol: lbl_80290730 */
/* 8029071C  80 7F 00 00 */	lwz r3, 0(r31)                          
/* 80290720  28 03 00 00 */	cmplwi r3, 0                            
/* 80290724  41 82 00 1C */	beq lbl_80290740                         /* constant-address: 80290740, symbol: lbl_80290740 */
/* 80290728  38 63 FF F4 */	addi r3, r3, -12                        
/* 8029072C  48 00 00 14 */	b lbl_80290740                           /* constant-address: 80290740, symbol: lbl_80290740 */
lbl_80290730:
/* 80290730  80 63 00 18 */	lwz r3, 0x18(r3)                        
/* 80290734  28 03 00 00 */	cmplwi r3, 0                            
/* 80290738  41 82 00 08 */	beq lbl_80290740                         /* constant-address: 80290740, symbol: lbl_80290740 */
/* 8029073C  38 63 FF F4 */	addi r3, r3, -12                        
lbl_80290740:
/* 80290740  28 03 00 00 */	cmplwi r3, 0                            
/* 80290744  40 82 00 14 */	bne lbl_80290758                         /* constant-address: 80290758, symbol: lbl_80290758 */
/* 80290748  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8029074C  48 0A E9 D1 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 80290750  38 60 00 00 */	li r3, 0                                
/* 80290754  48 00 00 14 */	b lbl_80290768                           /* constant-address: 80290768, symbol: lbl_80290768 */
lbl_80290758:
/* 80290758  83 E3 00 0C */	lwz r31, 0xc(r3)                        
/* 8029075C  80 61 00 08 */	lwz r3, 8(r1)                           
/* 80290760  48 0A E9 BD */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */

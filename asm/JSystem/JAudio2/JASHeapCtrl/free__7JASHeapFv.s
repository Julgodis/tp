...
/* 80290504  48 0A EB 3D */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 80290508  80 1E 00 38 */	lwz r0, 0x38(r30)                       
/* 8029050C  28 00 00 00 */	cmplwi r0, 0                            
/* 80290510  40 82 00 14 */	bne lbl_80290524                         /* constant-address: 80290524, symbol: lbl_80290524 */
/* 80290514  80 61 00 08 */	lwz r3, 8(r1)                           
/* 80290518  48 0A EC 05 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 8029051C  38 60 00 00 */	li r3, 0                                
/* 80290520  48 00 00 D0 */	b lbl_802905F0                           /* constant-address: 802905F0, symbol: lbl_802905F0 */
lbl_80290524:
/* 80290524  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 80290528  28 03 00 00 */	cmplwi r3, 0                            
/* 8029052C  41 82 00 28 */	beq lbl_80290554                         /* constant-address: 80290554, symbol: lbl_80290554 */
/* 80290530  38 63 FF F4 */	addi r3, r3, -12                        
/* 80290534  48 00 00 20 */	b lbl_80290554                           /* constant-address: 80290554, symbol: lbl_80290554 */
lbl_80290538:
/* 80290538  83 E3 00 18 */	lwz r31, 0x18(r3)                       
/* 8029053C  28 1F 00 00 */	cmplwi r31, 0                           
/* 80290540  41 82 00 08 */	beq lbl_80290548                         /* constant-address: 80290548, symbol: lbl_80290548 */
/* 80290544  3B FF FF F4 */	addi r31, r31, -12                      
lbl_80290548:
/* 80290548  80 63 00 0C */	lwz r3, 0xc(r3)                         
/* 8029054C  4B FF FF 99 */	bl free__7JASHeapFv                      /* constant-address: 802904E4, symbol: free__7JASHeapFv */
/* 80290550  7F E3 FB 78 */	mr r3, r31                              
lbl_80290554:
/* 80290554  28 03 00 00 */	cmplwi r3, 0                            
/* 80290558  40 82 FF E0 */	bne lbl_80290538                         /* constant-address: 80290538, symbol: lbl_80290538 */
/* 8029055C  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 80290560  28 03 00 00 */	cmplwi r3, 0                            
/* 80290564  41 82 00 54 */	beq lbl_802905B8                         /* constant-address: 802905B8, symbol: lbl_802905B8 */
/* 80290568  80 83 00 0C */	lwz r4, 0xc(r3)                         
/* 8029056C  80 04 00 40 */	lwz r0, 0x40(r4)                        
/* 80290570  7C 00 F0 40 */	cmplw r0, r30                           
/* 80290574  40 82 00 30 */	bne lbl_802905A4                         /* constant-address: 802905A4, symbol: lbl_802905A4 */
/* 80290578  80 BE 00 14 */	lwz r5, 0x14(r30)                       
/* 8029057C  28 05 00 00 */	cmplwi r5, 0                            
/* 80290580  41 82 00 08 */	beq lbl_80290588                         /* constant-address: 80290588, symbol: lbl_80290588 */
/* 80290584  38 A5 FF F4 */	addi r5, r5, -12                        
lbl_80290588:
/* 80290588  28 05 00 00 */	cmplwi r5, 0                            
/* 8029058C  41 82 00 10 */	beq lbl_8029059C                         /* constant-address: 8029059C, symbol: lbl_8029059C */
/* 80290590  80 05 00 0C */	lwz r0, 0xc(r5)                         
/* 80290594  90 04 00 40 */	stw r0, 0x40(r4)                        
/* 80290598  48 00 00 0C */	b lbl_802905A4                           /* constant-address: 802905A4, symbol: lbl_802905A4 */
lbl_8029059C:
...
/* 802905AC  41 82 00 08 */	beq lbl_802905B4                         /* constant-address: 802905B4, symbol: lbl_802905B4 */
/* 802905B0  38 9E 00 0C */	addi r4, r30, 0xc                       
lbl_802905B4:
/* 802905B4  48 04 BB A9 */	bl remove__10JSUPtrListFP10JSUPtrLink    /* constant-address: 802DC15C, symbol: remove__10JSUPtrListFP10JSUPtrLink */
lbl_802905B8:
...
/* 802905D0  41 82 00 14 */	beq lbl_802905E4                         /* constant-address: 802905E4, symbol: lbl_802905E4 */
...
/* 802905E8  48 0A EB 35 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */

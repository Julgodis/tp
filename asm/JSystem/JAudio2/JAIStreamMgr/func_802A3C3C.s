...
/* 802A3C4C  48 0B E5 81 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802A3C60  41 82 00 14 */	beq lbl_802A3C74                         /* constant-address: 802A3C74, symbol: lbl_802A3C74 */
/* 802A3C64  80 7B 00 00 */	lwz r3, 0(r27)                          
/* 802A3C68  28 03 00 00 */	cmplwi r3, 0                            
/* 802A3C6C  41 82 00 08 */	beq lbl_802A3C74                         /* constant-address: 802A3C74, symbol: lbl_802A3C74 */
/* 802A3C70  4B FF E9 29 */	bl stop__8JAISoundFv                     /* constant-address: 802A2598, symbol: stop__8JAISoundFv */
lbl_802A3C74:
...
/* 802A3C98  40 80 00 0C */	bge lbl_802A3CA4                         /* constant-address: 802A3CA4, symbol: lbl_802A3CA4 */
/* 802A3C9C  38 60 00 00 */	li r3, 0                                
/* 802A3CA0  48 00 00 B8 */	b lbl_802A3D58                           /* constant-address: 802A3D58, symbol: lbl_802A3D58 */
lbl_802A3CA4:
/* 802A3CA4  7F 23 CB 78 */	mr r3, r25                              
/* 802A3CA8  48 00 04 CD */	bl newStream___12JAIStreamMgrFv          /* constant-address: 802A4174, symbol: newStream___12JAIStreamMgrFv */
/* 802A3CAC  7C 7D 1B 78 */	mr r29, r3                              
/* 802A3CB0  83 ED 85 DC */	lwz r31, data_80450B5C(r13)              /* constant-address: 80450B5C, symbol: data_80450B5C */
/* 802A3CB4  39 00 FF FF */	li r8, -1                               
/* 802A3CB8  28 1F 00 00 */	cmplwi r31, 0                           
/* 802A3CBC  41 82 00 28 */	beq lbl_802A3CE4                         /* constant-address: 802A3CE4, symbol: lbl_802A3CE4 */
...
/* 802A3CE8  40 82 00 0C */	bne lbl_802A3CF4                         /* constant-address: 802A3CF4, symbol: lbl_802A3CF4 */
/* 802A3CEC  38 60 00 00 */	li r3, 0                                
/* 802A3CF0  48 00 00 68 */	b lbl_802A3D58                           /* constant-address: 802A3D58, symbol: lbl_802A3D58 */
lbl_802A3CF4:
...
/* 802A3D10  4B FF F4 8D */	bl func_802A319C                         /* constant-address: 802A319C, symbol: func_802A319C */
/* 802A3D14  28 1F 00 00 */	cmplwi r31, 0                           
/* 802A3D18  41 82 00 28 */	beq lbl_802A3D40                         /* constant-address: 802A3D40, symbol: lbl_802A3D40 */
...
/* 802A3D44  41 82 00 10 */	beq lbl_802A3D54                         /* constant-address: 802A3D54, symbol: lbl_802A3D54 */
/* 802A3D48  7F A3 EB 78 */	mr r3, r29                              
/* 802A3D4C  7F 64 DB 78 */	mr r4, r27                              
/* 802A3D50  4B FF E4 6D */	bl attachHandle__8JAISoundFP14JAISoundHandle /* constant-address: 802A21BC, symbol: attachHandle__8JAISoundFP14JAISoundHandle */
lbl_802A3D54:
/* 802A3D54  38 60 00 00 */	li r3, 0                                
lbl_802A3D58:
/* 802A3D58  39 61 00 40 */	addi r11, r1, 0x40                      
/* 802A3D5C  48 0B E4 BD */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

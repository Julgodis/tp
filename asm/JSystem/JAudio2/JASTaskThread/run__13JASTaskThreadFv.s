...
/* 8028FD5C  48 0D 24 7D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8028FDA0  48 0A ED 1D */	bl OSReceiveMessage                      /* constant-address: 8033EABC, symbol: OSReceiveMessage */
/* 8028FDA4  83 81 00 0C */	lwz r28, 0xc(r1)                        
/* 8028FDA8  88 1F 00 84 */	lbz r0, 0x84(r31)                       
/* 8028FDAC  28 00 00 00 */	cmplwi r0, 0                            
/* 8028FDB0  41 82 00 0C */	beq lbl_8028FDBC                         /* constant-address: 8028FDBC, symbol: lbl_8028FDBC */
/* 8028FDB4  38 7F 00 7C */	addi r3, r31, 0x7c                      
/* 8028FDB8  48 0B 1D F5 */	bl OSSleepThread                         /* constant-address: 80341BAC, symbol: OSSleepThread */
lbl_8028FDBC:
/* 8028FDBC  80 1C 00 04 */	lwz r0, 4(r28)                          
/* 8028FDC0  28 00 00 00 */	cmplwi r0, 0                            
/* 8028FDC4  41 82 00 18 */	beq lbl_8028FDDC                         /* constant-address: 8028FDDC, symbol: lbl_8028FDDC */
...
/* 8028FDD8  48 00 00 14 */	b lbl_8028FDEC                           /* constant-address: 8028FDEC, symbol: lbl_8028FDEC */
lbl_8028FDDC:
...
lbl_8028FDEC:
/* 8028FDEC  48 00 0C DD */	bl getCommandHeap__9JASKernelFv          /* constant-address: 80290AC8, symbol: getCommandHeap__9JASKernelFv */
/* 8028FDF0  7C 7E 1B 78 */	mr r30, r3                              
/* 8028FDF4  93 C1 00 08 */	stw r30, 8(r1)                          
/* 8028FDF8  48 0A F2 49 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 8028FDFC  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 8028FE00  3B A0 00 00 */	li r29, 0                               
/* 8028FE04  48 00 00 70 */	b lbl_8028FE74                           /* constant-address: 8028FE74, symbol: lbl_8028FE74 */
lbl_8028FE08:
/* 8028FE08  38 80 00 00 */	li r4, 0                                
/* 8028FE0C  38 03 00 0C */	addi r0, r3, 0xc                        
/* 8028FE10  7C 00 E0 40 */	cmplw r0, r28                           
/* 8028FE14  41 81 00 14 */	bgt lbl_8028FE28                         /* constant-address: 8028FE28, symbol: lbl_8028FE28 */
/* 8028FE18  38 03 04 0C */	addi r0, r3, 0x40c                      
/* 8028FE1C  7C 1C 00 40 */	cmplw r28, r0                           
/* 8028FE20  40 80 00 08 */	bge lbl_8028FE28                         /* constant-address: 8028FE28, symbol: lbl_8028FE28 */
/* 8028FE24  38 80 00 01 */	li r4, 1                                
lbl_8028FE28:
/* 8028FE28  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 8028FE2C  41 82 00 40 */	beq lbl_8028FE6C                         /* constant-address: 8028FE6C, symbol: lbl_8028FE6C */
...
/* 8028FE44  41 82 00 1C */	beq lbl_8028FE60                         /* constant-address: 8028FE60, symbol: lbl_8028FE60 */
/* 8028FE48  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8028FE4C  28 00 00 00 */	cmplwi r0, 0                            
/* 8028FE50  40 82 00 10 */	bne lbl_8028FE60                         /* constant-address: 8028FE60, symbol: lbl_8028FE60 */
/* 8028FE54  83 83 00 00 */	lwz r28, 0(r3)                          
/* 8028FE58  48 03 EE E5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
/* 8028FE5C  93 9D 00 00 */	stw r28, 0(r29)                          /* constant-address: 00000000 */
lbl_8028FE60:
/* 8028FE60  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8028FE64  48 0A F2 B9 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 8028FE68  4B FF FF 2C */	b lbl_8028FD94                           /* constant-address: 8028FD94, symbol: lbl_8028FD94 */
lbl_8028FE6C:
/* 8028FE6C  7C 7D 1B 78 */	mr r29, r3                              
/* 8028FE70  80 63 00 00 */	lwz r3, 0(r3)                           
lbl_8028FE74:
/* 8028FE74  28 03 00 00 */	cmplwi r3, 0                            
/* 8028FE78  40 82 FF 90 */	bne lbl_8028FE08                         /* constant-address: 8028FE08, symbol: lbl_8028FE08 */
/* 8028FE7C  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8028FE80  48 0A F2 9D */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 8028FE84  4B FF FF 10 */	b lbl_8028FD94                           /* constant-address: 8028FD94, symbol: lbl_8028FD94 */

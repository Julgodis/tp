...
/* 8028FEA4  48 0A D8 51 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8028FEA8  90 61 00 08 */	stw r3, 8(r1)                           
/* 8028FEAC  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 8028FEB0  41 82 00 10 */	beq lbl_8028FEC0                         /* constant-address: 8028FEC0, symbol: lbl_8028FEC0 */
/* 8028FEB4  38 00 00 01 */	li r0, 1                                
/* 8028FEB8  98 1E 00 84 */	stb r0, 0x84(r30)                       
/* 8028FEBC  48 00 00 20 */	b lbl_8028FEDC                           /* constant-address: 8028FEDC, symbol: lbl_8028FEDC */
lbl_8028FEC0:
/* 8028FEC0  88 1E 00 84 */	lbz r0, 0x84(r30)                       
/* 8028FEC4  28 00 00 00 */	cmplwi r0, 0                            
/* 8028FEC8  41 82 00 0C */	beq lbl_8028FED4                         /* constant-address: 8028FED4, symbol: lbl_8028FED4 */
/* 8028FECC  38 7E 00 7C */	addi r3, r30, 0x7c                      
/* 8028FED0  48 0B 1D C9 */	bl OSWakeupThread                        /* constant-address: 80341C98, symbol: OSWakeupThread */
lbl_8028FED4:
/* 8028FED4  38 00 00 00 */	li r0, 0                                
/* 8028FED8  98 1E 00 84 */	stb r0, 0x84(r30)                       
lbl_8028FEDC:
/* 8028FEDC  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8028FEE0  48 0A D8 3D */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

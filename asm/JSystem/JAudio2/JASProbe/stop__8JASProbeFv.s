...
/* 80290DD8  48 0A C9 1D */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80290DDC  90 61 00 08 */	stw r3, 8(r1)                           
/* 80290DE0  48 0B 19 1D */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
/* 80290DE4  80 1F 00 04 */	lwz r0, 4(r31)                          
/* 80290DE8  7C 00 20 50 */	subf r0, r0, r4                         
/* 80290DEC  C8 22 BB 98 */	lfd f1, lit_129(r2)                      /* constant-address: 80455598, symbol: lit_129 */
...
/* 80290E10  80 03 00 F8 */	lwz r0, 0x00F8(r3)                       /* constant-address: 800000F8 */
...
/* 80290E28  C0 02 BB 88 */	lfs f0, lit_125(r2)                      /* constant-address: 80455588, symbol: lit_125 */
...
/* 80290E44  40 80 00 14 */	bge lbl_80290E58                         /* constant-address: 80290E58, symbol: lbl_80290E58 */
/* 80290E48  80 1F 01 A8 */	lwz r0, 0x1a8(r31)                      
/* 80290E4C  28 00 00 64 */	cmplwi r0, 0x64                         
/* 80290E50  40 81 00 08 */	ble lbl_80290E58                         /* constant-address: 80290E58, symbol: lbl_80290E58 */
/* 80290E54  D0 3F 00 10 */	stfs f1, 0x10(r31)                      
lbl_80290E58:
/* 80290E58  C0 22 BB 8C */	lfs f1, lit_126(r2)                      /* constant-address: 8045558C, symbol: lit_126 */
/* 80290E5C  C0 1F 00 0C */	lfs f0, 0xc(r31)                        
/* 80290E60  EC 41 00 32 */	fmuls f2, f1, f0                        
/* 80290E64  C0 22 BB 90 */	lfs f1, lit_127(r2)                      /* constant-address: 80455590, symbol: lit_127 */
...
/* 80290ECC  48 0A C8 51 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

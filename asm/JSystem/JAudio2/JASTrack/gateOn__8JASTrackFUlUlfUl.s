...
/* 80292020  48 0D 01 99 */	bl _savegpr_20                           /* constant-address: 803621B8, symbol: _savegpr_20 */
...
/* 80292038  48 00 0A 6D */	bl getTransposeTotal__8JASTrackCFv       /* constant-address: 80292AA4, symbol: getTransposeTotal__8JASTrackCFv */
/* 8029203C  7E F7 1A 14 */	add r23, r23, r3                        
/* 80292040  88 16 02 33 */	lbz r0, 0x233(r22)                      
/* 80292044  28 00 00 64 */	cmplwi r0, 0x64                         
/* 80292048  41 82 00 28 */	beq lbl_80292070                         /* constant-address: 80292070, symbol: lbl_80292070 */
/* 8029204C  C8 22 BB B0 */	lfd f1, lit_954(r2)                      /* constant-address: 804555B0, symbol: lit_954 */
...
/* 80292064  C0 02 BB AC */	lfs f0, lit_952(r2)                      /* constant-address: 804555AC, symbol: lit_952 */
...
/* 80292078  48 00 05 CD */	bl seqTimeToDspTime__8JASTrackFf         /* constant-address: 80292644, symbol: seqTimeToDspTime__8JASTrackFf */
...
/* 80292094  41 82 00 0C */	beq lbl_802920A0                         /* constant-address: 802920A0, symbol: lbl_802920A0 */
/* 80292098  8B D6 02 2B */	lbz r30, 0x22b(r22)                     
/* 8029209C  48 00 00 08 */	b lbl_802920A4                           /* constant-address: 802920A4, symbol: lbl_802920A4 */
lbl_802920A0:
...
/* 802920B0  48 00 00 A8 */	b lbl_80292158                           /* constant-address: 80292158, symbol: lbl_80292158 */
lbl_802920B4:
/* 802920B4  38 15 01 70 */	addi r0, r21, 0x170                      /* constant-address: 00000170 */
/* 802920B8  7E 96 00 2E */	lwzx r20, r22, r0                       
/* 802920BC  28 14 00 00 */	cmplwi r20, 0                           
/* 802920C0  41 82 00 90 */	beq lbl_80292150                         /* constant-address: 80292150, symbol: lbl_80292150 */
/* 802920C4  88 16 02 16 */	lbz r0, 0x216(r22)                      
/* 802920C8  54 00 EF FF */	rlwinm. r0, r0, 0x1d, 0x1f, 0x1f        
/* 802920CC  40 82 00 44 */	bne lbl_80292110                         /* constant-address: 80292110, symbol: lbl_80292110 */
/* 802920D0  7E 83 A3 78 */	mr r3, r20                              
/* 802920D4  38 80 00 00 */	li r4, 0                                
/* 802920D8  38 A0 00 00 */	li r5, 0                                
/* 802920DC  48 00 11 45 */	bl noteOff__Q28JASTrack11TChannelMgrFUlUs /* constant-address: 80293220, symbol: noteOff__Q28JASTrack11TChannelMgrFUlUs */
/* 802920E0  7E C3 B3 78 */	mr r3, r22                              
/* 802920E4  48 00 0A 11 */	bl isMute__8JASTrackCFv                  /* constant-address: 80292AF4, symbol: isMute__8JASTrackCFv */
/* 802920E8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802920EC  40 82 00 44 */	bne lbl_80292130                         /* constant-address: 80292130, symbol: lbl_80292130 */
...
/* 80292104  4B FF FC F5 */	bl channelStart__8JASTrackFPQ28JASTrack11TChannelMgrUlUlUl /* constant-address: 80291DF8, symbol: channelStart__8JASTrackFPQ28JASTrack11TChannelMgrUlUlUl */
/* 80292108  90 74 00 00 */	stw r3, 0(r20)                          
/* 8029210C  48 00 00 24 */	b lbl_80292130                           /* constant-address: 80292130, symbol: lbl_80292130 */
lbl_80292110:
/* 80292110  80 74 00 00 */	lwz r3, 0(r20)                          
/* 80292114  28 03 00 00 */	cmplwi r3, 0                            
/* 80292118  41 82 00 18 */	beq lbl_80292130                         /* constant-address: 80292130, symbol: lbl_80292130 */
...
/* 80292134  41 82 00 1C */	beq lbl_80292150                         /* constant-address: 80292150, symbol: lbl_80292150 */
/* 80292138  80 74 00 00 */	lwz r3, 0(r20)                          
/* 8029213C  28 03 00 00 */	cmplwi r3, 0                            
/* 80292140  41 82 00 10 */	beq lbl_80292150                         /* constant-address: 80292150, symbol: lbl_80292150 */
/* 80292144  7F A4 EB 78 */	mr r4, r29                              
/* 80292148  7F 65 DB 78 */	mr r5, r27                              
/* 8029214C  48 00 8B 89 */	bl setKeySweepTarget__10JASChannelFlUl   /* constant-address: 8029ACD4, symbol: setKeySweepTarget__10JASChannelFlUl */
lbl_80292150:
/* 80292150  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
/* 80292154  3A B5 00 04 */	addi r21, r21, 4                         /* constant-address: 00000004 */
lbl_80292158:
/* 80292158  80 16 01 D0 */	lwz r0, 0x1d0(r22)                      
/* 8029215C  7C 1A 00 40 */	cmplw r26, r0                           
/* 80292160  41 80 FF 54 */	blt lbl_802920B4                         /* constant-address: 802920B4, symbol: lbl_802920B4 */
...
/* 80292184  48 0D 00 81 */	bl _restgpr_20                           /* constant-address: 80362204, symbol: _restgpr_20 */

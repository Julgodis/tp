...
/* 80292368  48 00 01 7D */	bl updateTempo__8JASTrackFv              /* constant-address: 802924E4, symbol: updateTempo__8JASTrackFv */
/* 8029236C  38 A0 00 00 */	li r5, 0                                
/* 80292370  38 60 00 00 */	li r3, 0                                
/* 80292374  48 00 01 48 */	b lbl_802924BC                           /* constant-address: 802924BC, symbol: lbl_802924BC */
lbl_80292378:
/* 80292378  38 03 01 70 */	addi r0, r3, 0x170                       /* constant-address: 00000170 */
/* 8029237C  7C DF 00 2E */	lwzx r6, r31, r0                        
/* 80292380  28 06 00 00 */	cmplwi r6, 0                            
/* 80292384  41 82 01 30 */	beq lbl_802924B4                         /* constant-address: 802924B4, symbol: lbl_802924B4 */
/* 80292388  C0 9F 00 9C */	lfs f4, 0x9c(r31)                       
/* 8029238C  EC 84 01 32 */	fmuls f4, f4, f4                        
/* 80292390  C0 A2 BB A4 */	lfs f5, lit_679(r2)                      /* constant-address: 804555A4, symbol: lit_679 */
/* 80292394  C0 62 BB B8 */	lfs f3, lit_1032(r2)                     /* constant-address: 804555B8, symbol: lit_1032 */
/* 80292398  C0 5F 00 A8 */	lfs f2, 0xa8(r31)                       
/* 8029239C  88 1F 02 30 */	lbz r0, 0x230(r31)                      
/* 802923A0  C8 22 BB B0 */	lfd f1, lit_954(r2)                      /* constant-address: 804555B0, symbol: lit_954 */
...
/* 802923C4  C0 42 BB A8 */	lfs f2, lit_690(r2)                      /* constant-address: 804555A8, symbol: lit_690 */
...
/* 802923E4  41 82 00 30 */	beq lbl_80292414                         /* constant-address: 80292414, symbol: lbl_80292414 */
...
/* 80292420  40 82 00 20 */	bne lbl_80292440                         /* constant-address: 80292440, symbol: lbl_80292440 */
...
/* 8029243C  48 00 00 68 */	b lbl_802924A4                           /* constant-address: 802924A4, symbol: lbl_802924A4 */
lbl_80292440:
/* 80292440  38 03 01 70 */	addi r0, r3, 0x170                       /* constant-address: 00000170 */
/* 80292444  7C E4 00 2E */	lwzx r7, r4, r0                         
/* 80292448  28 07 00 00 */	cmplwi r7, 0                            
/* 8029244C  40 82 00 08 */	bne lbl_80292454                         /* constant-address: 80292454, symbol: lbl_80292454 */
...
/* 80292470  C0 02 BB A8 */	lfs f0, lit_690(r2)                      /* constant-address: 804555A8, symbol: lit_690 */
...
/* 802924A8  C0 02 BB A8 */	lfs f0, lit_690(r2)                      /* constant-address: 804555A8, symbol: lit_690 */
/* 802924AC  EC 01 00 2A */	fadds f0, f1, f0                        
/* 802924B0  D0 06 00 2C */	stfs f0, 0x2c(r6)                       
lbl_802924B4:
/* 802924B4  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
/* 802924B8  38 63 00 04 */	addi r3, r3, 4                           /* constant-address: 00000004 */
lbl_802924BC:
/* 802924BC  80 1F 01 D0 */	lwz r0, 0x1d0(r31)                      
/* 802924C0  7C 05 00 40 */	cmplw r5, r0                            
/* 802924C4  41 80 FE B4 */	blt lbl_80292378                         /* constant-address: 80292378, symbol: lbl_80292378 */

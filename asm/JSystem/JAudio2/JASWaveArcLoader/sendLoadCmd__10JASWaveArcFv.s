...
/* 8029A420  48 0A 4C 21 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
...
/* 8029A468  4B FF 5A 95 */	bl getThreadPointer__6JASDvdFv           /* constant-address: 8028FEFC, symbol: getThreadPointer__6JASDvdFv */
/* 8029A46C  3C 80 80 2A */	lis r4, loadToAramCallback__10JASWaveArcFPv@ha
/* 8029A470  38 84 A3 78 */	addi r4, r4, loadToAramCallback__10JASWaveArcFPv@l /* constant-address: 8029A378, symbol: loadToAramCallback__10JASWaveArcFPv */
/* 8029A474  38 A1 00 0C */	addi r5, r1, 0xc                        
/* 8029A478  38 C0 00 10 */	li r6, 0x10                             
/* 8029A47C  4B FF 56 E1 */	bl sendCmdMsg__13JASTaskThreadFPFPv_vPCvUl /* constant-address: 8028FB5C, symbol: sendCmdMsg__13JASTaskThreadFPFPv_vPCvUl */
/* 8029A480  2C 03 00 00 */	cmpwi r3, 0                             
/* 8029A484  40 82 00 1C */	bne lbl_8029A4A0                         /* constant-address: 8029A4A0, symbol: lbl_8029A4A0 */
/* 8029A488  38 7F 00 04 */	addi r3, r31, 4                         
/* 8029A48C  4B FF 60 59 */	bl free__7JASHeapFv                      /* constant-address: 802904E4, symbol: free__7JASHeapFv */
/* 8029A490  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8029A494  48 0A 4C 89 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 8029A498  38 60 00 00 */	li r3, 0                                
/* 8029A49C  48 00 00 10 */	b lbl_8029A4AC                           /* constant-address: 8029A4AC, symbol: lbl_8029A4AC */
lbl_8029A4A0:
/* 8029A4A0  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8029A4A4  48 0A 4C 79 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */

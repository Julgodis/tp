...
/* 8029A308  48 0A 4D 39 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 8029A30C  80 1F 00 4C */	lwz r0, 0x4c(r31)                       
/* 8029A310  2C 00 00 00 */	cmpwi r0, 0                             
/* 8029A314  40 82 00 14 */	bne lbl_8029A328                         /* constant-address: 8029A328, symbol: lbl_8029A328 */
/* 8029A318  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8029A31C  48 0A 4E 01 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 8029A320  38 60 00 00 */	li r3, 0                                
/* 8029A324  48 00 00 40 */	b lbl_8029A364                           /* constant-address: 8029A364, symbol: lbl_8029A364 */
lbl_8029A328:
/* 8029A328  80 1F 00 4C */	lwz r0, 0x4c(r31)                       
/* 8029A32C  2C 00 00 01 */	cmpwi r0, 1                             
/* 8029A330  40 82 00 1C */	bne lbl_8029A34C                         /* constant-address: 8029A34C, symbol: lbl_8029A34C */
/* 8029A334  38 00 00 00 */	li r0, 0                                
/* 8029A338  90 1F 00 4C */	stw r0, 0x4c(r31)                       
/* 8029A33C  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8029A340  48 0A 4D DD */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
/* 8029A344  38 60 00 00 */	li r3, 0                                
/* 8029A348  48 00 00 1C */	b lbl_8029A364                           /* constant-address: 8029A364, symbol: lbl_8029A364 */
lbl_8029A34C:
...
/* 8029A35C  48 0A 4D C1 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */

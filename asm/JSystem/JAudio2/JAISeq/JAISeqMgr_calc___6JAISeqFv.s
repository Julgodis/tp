...
/* 802A109C  48 0C 11 41 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802A10A0  7C 7D 1B 78 */	mr r29, r3                              
/* 802A10A4  88 03 02 BD */	lbz r0, 0x2bd(r3)                       
/* 802A10A8  28 00 00 02 */	cmplwi r0, 2                            
/* 802A10AC  41 82 00 1C */	beq lbl_802A10C8                         /* constant-address: 802A10C8, symbol: lbl_802A10C8 */
/* 802A10B0  88 1D 02 BD */	lbz r0, 0x2bd(r29)                      
/* 802A10B4  54 00 06 3F */	clrlwi. r0, r0, 0x18                    
/* 802A10B8  40 82 00 1C */	bne lbl_802A10D4                         /* constant-address: 802A10D4, symbol: lbl_802A10D4 */
/* 802A10BC  88 1D 00 1E */	lbz r0, 0x1e(r29)                       
/* 802A10C0  28 00 00 02 */	cmplwi r0, 2                            
/* 802A10C4  40 82 00 10 */	bne lbl_802A10D4                         /* constant-address: 802A10D4, symbol: lbl_802A10D4 */
lbl_802A10C8:
/* 802A10C8  7F A3 EB 78 */	mr r3, r29                              
/* 802A10CC  48 00 00 B5 */	bl die___6JAISeqFv                       /* constant-address: 802A1180, symbol: die___6JAISeqFv */
/* 802A10D0  48 00 00 98 */	b lbl_802A1168                           /* constant-address: 802A1168, symbol: lbl_802A1168 */
lbl_802A10D4:
/* 802A10D4  7F A3 EB 78 */	mr r3, r29                              
/* 802A10D8  48 00 15 E1 */	bl calc_JAISound___8JAISoundFv           /* constant-address: 802A26B8, symbol: calc_JAISound___8JAISoundFv */
/* 802A10DC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A10E0  41 82 00 88 */	beq lbl_802A1168                         /* constant-address: 802A1168, symbol: lbl_802A1168 */
/* 802A10E4  C0 3D 03 70 */	lfs f1, 0x370(r29)                      
/* 802A10E8  80 7D 03 7C */	lwz r3, 0x37c(r29)                      
/* 802A10EC  28 03 00 01 */	cmplwi r3, 1                            
/* 802A10F0  40 81 00 18 */	ble lbl_802A1108                         /* constant-address: 802A1108, symbol: lbl_802A1108 */
...
/* 802A1104  48 00 00 14 */	b lbl_802A1118                           /* constant-address: 802A1118, symbol: lbl_802A1118 */
lbl_802A1108:
/* 802A1108  40 82 00 10 */	bne lbl_802A1118                         /* constant-address: 802A1118, symbol: lbl_802A1118 */
...
/* 802A1130  41 82 00 08 */	beq lbl_802A1138                         /* constant-address: 802A1138, symbol: lbl_802A1138 */
/* 802A1134  48 00 1A 49 */	bl calc__13JAISoundChildFv               /* constant-address: 802A2B7C, symbol: calc__13JAISoundChildFv */
lbl_802A1138:
/* 802A1138  3B DE 00 01 */	addi r30, r30, 1                        
/* 802A113C  2C 1E 00 20 */	cmpwi r30, 0x20                         
/* 802A1140  3B FF 00 04 */	addi r31, r31, 4                        
/* 802A1144  41 80 FF E0 */	blt lbl_802A1124                         /* constant-address: 802A1124, symbol: lbl_802A1124 */
/* 802A1148  80 7D 03 A8 */	lwz r3, 0x3a8(r29)                      
/* 802A114C  28 03 00 00 */	cmplwi r3, 0                            
/* 802A1150  41 82 00 18 */	beq lbl_802A1168                         /* constant-address: 802A1168, symbol: lbl_802A1168 */
...
/* 802A116C  48 0C 10 BD */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

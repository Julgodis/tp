...
/* 8029DB88  48 0C 46 51 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8029DB8C  7C 9D 23 78 */	mr r29, r4                              
/* 8029DB90  7C BE 2B 78 */	mr r30, r5                              
/* 8029DB94  80 8D 8D 6C */	lwz r4, FX_BUF__6JASDsp(r13)             /* constant-address: 804512EC, symbol: FX_BUF__6JASDsp */
/* 8029DB98  54 60 2C F4 */	rlwinm r0, r3, 5, 0x13, 0x1a            
/* 8029DB9C  7F E4 02 14 */	add r31, r4, r0                         
/* 8029DBA0  48 09 FB 55 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8029DBB4  41 82 00 54 */	beq lbl_8029DC08                         /* constant-address: 8029DC08, symbol: lbl_8029DC08 */
...
/* 8029DBCC  38 63 78 F0 */	addi r3, r3, SEND_TABLE__6JASDsp@l       /* constant-address: 803C78F0, symbol: SEND_TABLE__6JASDsp */
...
/* 8029DC04  4B FF FE 45 */	bl setFilterTable__6JASDspFPsPsUl        /* constant-address: 8029DA48, symbol: setFilterTable__6JASDspFPsPsUl */
lbl_8029DC08:
/* 8029DC08  28 1D 00 00 */	cmplwi r29, 0                           
/* 8029DC0C  41 82 00 34 */	beq lbl_8029DC40                         /* constant-address: 8029DC40, symbol: lbl_8029DC40 */
/* 8029DC10  28 1E 00 00 */	cmplwi r30, 0                           
/* 8029DC14  41 82 00 2C */	beq lbl_8029DC40                         /* constant-address: 8029DC40, symbol: lbl_8029DC40 */
...
/* 8029DC2C  4B FF 18 55 */	bl bzero__7JASCalcFPvUl                  /* constant-address: 8028F480, symbol: bzero__7JASCalcFPvUl */
/* 8029DC30  7F A3 EB 78 */	mr r3, r29                              
/* 8029DC34  7F 84 E3 78 */	mr r4, r28                              
/* 8029DC38  48 09 D9 75 */	bl DCFlushRange                          /* constant-address: 8033B5AC, symbol: DCFlushRange */
/* 8029DC3C  48 00 00 18 */	b lbl_8029DC54                           /* constant-address: 8029DC54, symbol: lbl_8029DC54 */
lbl_8029DC40:
/* 8029DC40  28 1E 00 00 */	cmplwi r30, 0                           
/* 8029DC44  41 82 00 0C */	beq lbl_8029DC50                         /* constant-address: 8029DC50, symbol: lbl_8029DC50 */
/* 8029DC48  28 1D 00 00 */	cmplwi r29, 0                           
/* 8029DC4C  41 82 00 08 */	beq lbl_8029DC54                         /* constant-address: 8029DC54, symbol: lbl_8029DC54 */
lbl_8029DC50:
/* 8029DC50  93 BF 00 04 */	stw r29, 4(r31)                         
lbl_8029DC54:
/* 8029DC54  80 1F 00 04 */	lwz r0, 4(r31)                          
/* 8029DC58  28 00 00 00 */	cmplwi r0, 0                            
/* 8029DC5C  41 82 00 10 */	beq lbl_8029DC6C                         /* constant-address: 8029DC6C, symbol: lbl_8029DC6C */
/* 8029DC60  88 1E 00 00 */	lbz r0, 0(r30)                          
/* 8029DC64  B0 1F 00 00 */	sth r0, 0(r31)                          
/* 8029DC68  48 00 00 0C */	b lbl_8029DC74                           /* constant-address: 8029DC74, symbol: lbl_8029DC74 */
lbl_8029DC6C:
...
/* 8029DC7C  48 09 D9 31 */	bl DCFlushRange                          /* constant-address: 8033B5AC, symbol: DCFlushRange */
/* 8029DC80  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8029DC84  48 09 FA 99 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8029DC88  38 60 00 01 */	li r3, 1                                
/* 8029DC8C  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8029DC90  48 0C 45 95 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 8029DD94  38 A2 BD 4C */	la r5, data_8045574C(r2) /* 8045574C-_SDA2_BASE_ */ /* constant-address: 8045574C, symbol: data_8045574C */
/* 8029DD98  7C 05 38 AE */	lbzx r0, r5, r7                         
/* 8029DD9C  B0 03 00 64 */	sth r0, 0x64(r3)                        
/* 8029DDA0  38 A2 BD 54 */	la r5, data_80455754(r2) /* 80455754-_SDA2_BASE_ */ /* constant-address: 80455754, symbol: data_80455754 */
...
/* 8029DDD8  41 82 00 34 */	beq lbl_8029DE0C                         /* constant-address: 8029DE0C, symbol: lbl_8029DE0C */
/* 8029DDDC  28 06 00 01 */	cmplwi r6, 1                            
/* 8029DDE0  40 82 00 08 */	bne lbl_8029DDE8                         /* constant-address: 8029DDE8, symbol: lbl_8029DDE8 */
...
/* 8029DE08  48 00 00 0C */	b lbl_8029DE14                           /* constant-address: 8029DE14, symbol: lbl_8029DE14 */
lbl_8029DE0C:
/* 8029DE0C  80 03 01 1C */	lwz r0, 0x11c(r3)                       
/* 8029DE10  90 03 01 14 */	stw r0, 0x114(r3)                       
lbl_8029DE14:
/* 8029DE14  28 06 00 00 */	cmplwi r6, 0                            
/* 8029DE18  41 82 00 70 */	beq lbl_8029DE88                         /* constant-address: 8029DE88, symbol: lbl_8029DE88 */
/* 8029DE1C  80 03 01 14 */	lwz r0, 0x114(r3)                       
/* 8029DE20  7C 00 30 40 */	cmplw r0, r6                            
/* 8029DE24  40 81 00 64 */	ble lbl_8029DE88                         /* constant-address: 8029DE88, symbol: lbl_8029DE88 */
/* 8029DE28  88 04 00 00 */	lbz r0, 0(r4)                           
/* 8029DE2C  2C 00 00 02 */	cmpwi r0, 2                             
/* 8029DE30  40 80 00 10 */	bge lbl_8029DE40                         /* constant-address: 8029DE40, symbol: lbl_8029DE40 */
/* 8029DE34  2C 00 00 00 */	cmpwi r0, 0                             
/* 8029DE38  40 80 00 14 */	bge lbl_8029DE4C                         /* constant-address: 8029DE4C, symbol: lbl_8029DE4C */
/* 8029DE3C  48 00 00 4C */	b lbl_8029DE88                           /* constant-address: 8029DE88, symbol: lbl_8029DE88 */
lbl_8029DE40:
/* 8029DE40  2C 00 00 04 */	cmpwi r0, 4                             
/* 8029DE44  40 80 00 44 */	bge lbl_8029DE88                         /* constant-address: 8029DE88, symbol: lbl_8029DE88 */
/* 8029DE48  48 00 00 3C */	b lbl_8029DE84                           /* constant-address: 8029DE84, symbol: lbl_8029DE84 */
lbl_8029DE4C:
...
/* 8029DE80  48 00 00 08 */	b lbl_8029DE88                           /* constant-address: 8029DE88, symbol: lbl_8029DE88 */
lbl_8029DE84:
...
/* 8029DEA4  42 00 FF F4 */	bdnz lbl_8029DE98                        /* constant-address: 8029DE98, symbol: lbl_8029DE98 */

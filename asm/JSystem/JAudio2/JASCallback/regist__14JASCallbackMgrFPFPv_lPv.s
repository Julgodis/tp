...
/* 8028FFB8  48 0D 22 25 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8028FFBC  7C 7D 1B 78 */	mr r29, r3                              
/* 8028FFC0  7C 9E 23 78 */	mr r30, r4                              
/* 8028FFC4  7C BF 2B 78 */	mr r31, r5                              
/* 8028FFC8  48 0A D7 2D */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8028FFE8  40 82 00 1C */	bne lbl_80290004                         /* constant-address: 80290004, symbol: lbl_80290004 */
/* 8028FFEC  93 C4 00 00 */	stw r30, 0(r4)                          
/* 8028FFF0  93 E4 00 04 */	stw r31, 4(r4)                          
/* 8028FFF4  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8028FFF8  48 0A D7 25 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8028FFFC  38 60 00 01 */	li r3, 1                                
/* 80290000  48 00 00 18 */	b lbl_80290018                           /* constant-address: 80290018, symbol: lbl_80290018 */
lbl_80290004:
/* 80290004  38 63 00 08 */	addi r3, r3, 8                           /* constant-address: 00000008 */
/* 80290008  42 00 FF D4 */	bdnz lbl_8028FFDC                        /* constant-address: 8028FFDC, symbol: lbl_8028FFDC */
/* 8029000C  80 61 00 08 */	lwz r3, 8(r1)                           
/* 80290010  48 0A D7 0D */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 80290014  38 60 00 00 */	li r3, 0                                
lbl_80290018:
/* 80290018  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8029001C  48 0D 22 0D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

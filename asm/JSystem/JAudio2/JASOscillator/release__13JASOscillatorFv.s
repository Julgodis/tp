...
/* 8029BFFC  40 82 00 1C */	bne lbl_8029C018                         /* constant-address: 8029C018, symbol: lbl_8029C018 */
/* 8029C000  A0 03 00 16 */	lhz r0, 0x16(r3)                        
/* 8029C004  28 00 00 00 */	cmplwi r0, 0                            
/* 8029C008  40 82 00 10 */	bne lbl_8029C018                         /* constant-address: 8029C018, symbol: lbl_8029C018 */
/* 8029C00C  38 00 00 00 */	li r0, 0                                
/* 8029C010  90 03 00 1C */	stw r0, 0x1c(r3)                        
/* 8029C014  48 00 00 BC */	b lbl_8029C0D0                           /* constant-address: 8029C0D0, symbol: lbl_8029C0D0 */
lbl_8029C018:
/* 8029C018  A0 03 00 16 */	lhz r0, 0x16(r3)                        
/* 8029C01C  28 00 00 00 */	cmplwi r0, 0                            
/* 8029C020  41 82 00 3C */	beq lbl_8029C05C                         /* constant-address: 8029C05C, symbol: lbl_8029C05C */
/* 8029C024  C0 22 BC F8 */	lfs f1, lit_77(r2)                       /* constant-address: 804556F8, symbol: lit_77 */
...
/* 8029C054  48 00 00 8D */	bl update__13JASOscillatorFv             /* constant-address: 8029C0E0, symbol: update__13JASOscillatorFv */
/* 8029C058  48 00 00 78 */	b lbl_8029C0D0                           /* constant-address: 8029C0D0, symbol: lbl_8029C0D0 */
lbl_8029C05C:
/* 8029C05C  80 05 00 08 */	lwz r0, 8(r5)                           
/* 8029C060  7C 00 20 40 */	cmplw r0, r4                            
/* 8029C064  41 82 00 60 */	beq lbl_8029C0C4                         /* constant-address: 8029C0C4, symbol: lbl_8029C0C4 */
/* 8029C068  C0 02 BC F8 */	lfs f0, lit_77(r2)                       /* constant-address: 804556F8, symbol: lit_77 */
...
/* 8029C084  C8 22 BD 08 */	lfd f1, lit_91(r2)                       /* constant-address: 80455708, symbol: lit_91 */
...
/* 8029C0A0  C0 02 BD 00 */	lfs f0, lit_88(r2)                       /* constant-address: 80455700, symbol: lit_88 */
...
/* 8029C0CC  48 00 00 15 */	bl update__13JASOscillatorFv             /* constant-address: 8029C0E0, symbol: update__13JASOscillatorFv */
lbl_8029C0D0:

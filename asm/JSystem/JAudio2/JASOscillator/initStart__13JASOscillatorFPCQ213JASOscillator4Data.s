...
/* 8029BECC  C0 02 BC F8 */	lfs f0, lit_77(r2)                       /* constant-address: 804556F8, symbol: lit_77 */
...
/* 8029BEEC  40 82 00 0C */	bne lbl_8029BEF8                         /* constant-address: 8029BEF8, symbol: lbl_8029BEF8 */
/* 8029BEF0  90 03 00 1C */	stw r0, 0x1c(r3)                        
/* 8029BEF4  48 00 00 6C */	b lbl_8029BF60                           /* constant-address: 8029BF60, symbol: lbl_8029BF60 */
lbl_8029BEF8:
/* 8029BEF8  80 83 00 00 */	lwz r4, 0(r3)                           
/* 8029BEFC  80 84 00 08 */	lwz r4, 8(r4)                           
/* 8029BF00  28 04 00 00 */	cmplwi r4, 0                            
/* 8029BF04  40 82 00 18 */	bne lbl_8029BF1C                         /* constant-address: 8029BF1C, symbol: lbl_8029BF1C */
/* 8029BF08  38 00 00 02 */	li r0, 2                                
/* 8029BF0C  90 03 00 1C */	stw r0, 0x1c(r3)                        
/* 8029BF10  C0 02 BC FC */	lfs f0, lit_87(r2)                       /* constant-address: 804556FC, symbol: lit_87 */
/* 8029BF14  D0 03 00 08 */	stfs f0, 8(r3)                          
/* 8029BF18  48 00 00 48 */	b lbl_8029BF60                           /* constant-address: 8029BF60, symbol: lbl_8029BF60 */
lbl_8029BF1C:
/* 8029BF1C  A8 04 00 04 */	lha r0, 4(r4)                           
/* 8029BF20  C8 22 BD 08 */	lfd f1, lit_91(r2)                       /* constant-address: 80455708, symbol: lit_91 */
...
/* 8029BF3C  C0 02 BD 00 */	lfs f0, lit_88(r2)                       /* constant-address: 80455700, symbol: lit_88 */

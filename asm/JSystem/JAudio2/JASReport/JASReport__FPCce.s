...
/* 80290F78  40 86 00 24 */	bne cr1, lbl_80290F9C                    /* constant-address: 80290F9C, symbol: lbl_80290F9C */
...
/* 80290FBC  80 0D 8C A0 */	lwz r0, sBuffer(r13)                     /* constant-address: 80451220, symbol: sBuffer */
/* 80290FC0  28 00 00 00 */	cmplwi r0, 0                            
/* 80290FC4  41 82 00 88 */	beq lbl_8029104C                         /* constant-address: 8029104C, symbol: lbl_8029104C */
...
/* 80290FE4  38 63 16 60 */	addi r3, r3, sMutex@l                    /* constant-address: 80431660, symbol: sMutex */
/* 80290FE8  90 61 00 68 */	stw r3, 0x68(r1)                        
/* 80290FEC  48 0A E0 55 */	bl OSLockMutex                           /* constant-address: 8033F040, symbol: OSLockMutex */
/* 80290FF0  80 6D 8C A0 */	lwz r3, sBuffer(r13)                     /* constant-address: 80451220, symbol: sBuffer */
/* 80290FF4  80 0D 8C AC */	lwz r0, sTop(r13)                        /* constant-address: 8045122C, symbol: sTop */
...
/* 8029100C  48 0D 56 85 */	bl vsnprintf                             /* constant-address: 80366690, symbol: vsnprintf */
/* 80291010  80 6D 8C AC */	lwz r3, sTop(r13)                        /* constant-address: 8045122C, symbol: sTop */
/* 80291014  38 03 00 01 */	addi r0, r3, 1                          
/* 80291018  90 0D 8C AC */	stw r0, sTop(r13)                        /* constant-address: 8045122C, symbol: sTop */
/* 8029101C  80 8D 8C A4 */	lwz r4, sLineMax(r13)                    /* constant-address: 80451224, symbol: sLineMax */
/* 80291020  7C 00 20 00 */	cmpw r0, r4                             
/* 80291024  41 80 00 0C */	blt lbl_80291030                         /* constant-address: 80291030, symbol: lbl_80291030 */
/* 80291028  38 00 00 00 */	li r0, 0                                
/* 8029102C  90 0D 8C AC */	stw r0, sTop(r13)                        /* constant-address: 8045122C, symbol: sTop */
lbl_80291030:
/* 80291030  80 6D 8C A8 */	lwz r3, sLineCount(r13)                  /* constant-address: 80451228, symbol: sLineCount */
/* 80291034  7C 03 20 00 */	cmpw r3, r4                             
/* 80291038  40 80 00 0C */	bge lbl_80291044                         /* constant-address: 80291044, symbol: lbl_80291044 */
/* 8029103C  38 03 00 01 */	addi r0, r3, 1                          
/* 80291040  90 0D 8C A8 */	stw r0, sLineCount(r13)                  /* constant-address: 80451228, symbol: sLineCount */
lbl_80291044:
/* 80291044  80 61 00 68 */	lwz r3, 0x68(r1)                        
/* 80291048  48 0A E0 D5 */	bl OSUnlockMutex                         /* constant-address: 8033F11C, symbol: OSUnlockMutex */
lbl_8029104C:

...
/* 802A29EC  48 0B F7 E5 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 802A2A08  48 00 00 34 */	b lbl_802A2A3C                           /* constant-address: 802A2A3C, symbol: lbl_802A2A3C */
lbl_802A2A0C:
...
/* 802A2A28  41 82 00 10 */	beq lbl_802A2A38                         /* constant-address: 802A2A38, symbol: lbl_802A2A38 */
/* 802A2A2C  7C 7E F9 2E */	stwx r3, r30, r31                       
/* 802A2A30  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
/* 802A2A34  3B FF 00 04 */	addi r31, r31, 4                         /* constant-address: 00000004 */
lbl_802A2A38:
/* 802A2A38  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
lbl_802A2A3C:
...
/* 802A2A54  41 80 FF B8 */	blt lbl_802A2A0C                         /* constant-address: 802A2A0C, symbol: lbl_802A2A0C */
/* 802A2A58  7F 63 DB 78 */	mr r3, r27                              
/* 802A2A5C  7F A4 EB 78 */	mr r4, r29                              
/* 802A2A60  4B FE E9 E5 */	bl setChannelMgrCount__8JASTrackFUl      /* constant-address: 80291444, symbol: setChannelMgrCount__8JASTrackFUl */
/* 802A2A64  3B 80 00 00 */	li r28, 0                               
/* 802A2A68  3B E0 00 00 */	li r31, 0                               
/* 802A2A6C  3B C1 00 08 */	addi r30, r1, 8                         
/* 802A2A70  48 00 00 1C */	b lbl_802A2A8C                           /* constant-address: 802A2A8C, symbol: lbl_802A2A8C */
lbl_802A2A74:
/* 802A2A74  7F 63 DB 78 */	mr r3, r27                              
/* 802A2A78  7F 84 E3 78 */	mr r4, r28                              
/* 802A2A7C  7C BE F8 2E */	lwzx r5, r30, r31                       
/* 802A2A80  4B FE EF 75 */	bl assignExtBuffer__8JASTrackFUlP14JASSoundParams /* constant-address: 802919F4, symbol: assignExtBuffer__8JASTrackFUlP14JASSoundParams */
/* 802A2A84  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 802A2A88  3B FF 00 04 */	addi r31, r31, 4                         /* constant-address: 00000004 */
lbl_802A2A8C:
/* 802A2A8C  80 1B 01 D0 */	lwz r0, 0x1d0(r27)                      
/* 802A2A90  7C 1C 00 40 */	cmplw r28, r0                           
/* 802A2A94  41 80 FF E0 */	blt lbl_802A2A74                         /* constant-address: 802A2A74, symbol: lbl_802A2A74 */
/* 802A2A98  39 61 00 40 */	addi r11, r1, 0x40                      
/* 802A2A9C  48 0B F7 81 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

...
/* 8029ABFC  48 0C 75 E1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8029AC14  48 00 13 B5 */	bl getValue__13JASOscillatorCFv          /* constant-address: 8029BFC8, symbol: getValue__13JASOscillatorCFv */
...
/* 8029AC28  41 81 00 94 */	bgt lbl_8029ACBC                         /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
/* 8029AC2C  3C 60 80 3C */	lis r3, lit_662@ha                      
/* 8029AC30  38 63 78 48 */	addi r3, r3, lit_662@l                   /* constant-address: 803C7848, symbol: lit_662 */
...
/* 8029AC50  48 00 00 6C */	b lbl_8029ACBC                           /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
/* 8029AC54  C0 1E 00 00 */	lfs f0, 0(r30)                          
/* 8029AC58  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 8029AC5C  D0 1E 00 00 */	stfs f0, 0(r30)                         
/* 8029AC60  48 00 00 5C */	b lbl_8029ACBC                           /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
/* 8029AC64  C8 02 BC 90 */	lfd f0, lit_661(r2)                      /* constant-address: 80455690, symbol: lit_661 */
...
/* 8029AC7C  48 00 00 40 */	b lbl_8029ACBC                           /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
/* 8029AC80  C0 1E 00 0C */	lfs f0, 0xc(r30)                        
/* 8029AC84  EC 00 08 2A */	fadds f0, f0, f1                        
/* 8029AC88  D0 1E 00 0C */	stfs f0, 0xc(r30)                       
/* 8029AC8C  48 00 00 30 */	b lbl_8029ACBC                           /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
/* 8029AC90  C0 1E 00 10 */	lfs f0, 0x10(r30)                       
/* 8029AC94  EC 00 08 2A */	fadds f0, f0, f1                        
/* 8029AC98  D0 1E 00 10 */	stfs f0, 0x10(r30)                      
/* 8029AC9C  48 00 00 20 */	b lbl_8029ACBC                           /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
/* 8029ACA0  C0 1E 00 14 */	lfs f0, 0x14(r30)                       
/* 8029ACA4  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 8029ACA8  D0 1E 00 14 */	stfs f0, 0x14(r30)                      
/* 8029ACAC  48 00 00 10 */	b lbl_8029ACBC                           /* constant-address: 8029ACBC, symbol: lbl_8029ACBC */
...
/* 8029ACC0  48 0C 75 69 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

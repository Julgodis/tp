...
/* 802A1B58  48 0C 06 75 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802A1B6C  41 82 00 14 */	beq lbl_802A1B80                         /* constant-address: 802A1B80, symbol: lbl_802A1B80 */
/* 802A1B70  80 7B 00 00 */	lwz r3, 0(r27)                          
/* 802A1B74  28 03 00 00 */	cmplwi r3, 0                            
/* 802A1B78  41 82 00 08 */	beq lbl_802A1B80                         /* constant-address: 802A1B80, symbol: lbl_802A1B80 */
/* 802A1B7C  48 00 0A 1D */	bl stop__8JAISoundFv                     /* constant-address: 802A2598, symbol: stop__8JAISoundFv */
lbl_802A1B80:
/* 802A1B80  83 CD 85 DC */	lwz r30, data_80450B5C(r13)              /* constant-address: 80450B5C, symbol: data_80450B5C */
/* 802A1B84  28 1E 00 00 */	cmplwi r30, 0                           
/* 802A1B88  41 82 00 2C */	beq lbl_802A1BB4                         /* constant-address: 802A1BB4, symbol: lbl_802A1BB4 */
...
/* 802A1BB0  48 00 00 08 */	b lbl_802A1BB8                           /* constant-address: 802A1BB8, symbol: lbl_802A1BB8 */
lbl_802A1BB4:
...
/* 802A1BEC  40 82 00 0C */	bne lbl_802A1BF8                         /* constant-address: 802A1BF8, symbol: lbl_802A1BF8 */
/* 802A1BF0  38 60 00 00 */	li r3, 0                                
/* 802A1BF4  48 00 00 84 */	b lbl_802A1C78                           /* constant-address: 802A1C78, symbol: lbl_802A1C78 */
lbl_802A1BF8:
/* 802A1BF8  7F 23 CB 78 */	mr r3, r25                              
/* 802A1BFC  48 00 03 5D */	bl beginStartSeq___9JAISeqMgrFv          /* constant-address: 802A1F58, symbol: beginStartSeq___9JAISeqMgrFv */
/* 802A1C00  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 802A1C04  41 82 00 70 */	beq lbl_802A1C74                         /* constant-address: 802A1C74, symbol: lbl_802A1C74 */
...
/* 802A1C24  4B FF EF 41 */	bl func_802A0B64                         /* constant-address: 802A0B64, symbol: func_802A0B64 */
/* 802A1C28  7F 23 CB 78 */	mr r3, r25                              
/* 802A1C2C  7F A4 EB 78 */	mr r4, r29                              
/* 802A1C30  7F 65 DB 78 */	mr r5, r27                              
/* 802A1C34  48 00 03 B5 */	bl endStartSeq___9JAISeqMgrFP6JAISeqP14JAISoundHandle /* constant-address: 802A1FE8, symbol: endStartSeq___9JAISeqMgrFP6JAISeqP14JAISoundHandle */
/* 802A1C38  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A1C3C  41 82 00 38 */	beq lbl_802A1C74                         /* constant-address: 802A1C74, symbol: lbl_802A1C74 */
/* 802A1C40  28 1E 00 00 */	cmplwi r30, 0                           
/* 802A1C44  41 82 00 28 */	beq lbl_802A1C6C                         /* constant-address: 802A1C6C, symbol: lbl_802A1C6C */
...
/* 802A1C70  48 00 00 08 */	b lbl_802A1C78                           /* constant-address: 802A1C78, symbol: lbl_802A1C78 */
lbl_802A1C74:
/* 802A1C74  38 60 00 00 */	li r3, 0                                
lbl_802A1C78:
/* 802A1C78  39 61 00 40 */	addi r11, r1, 0x40                      
/* 802A1C7C  48 0C 05 9D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

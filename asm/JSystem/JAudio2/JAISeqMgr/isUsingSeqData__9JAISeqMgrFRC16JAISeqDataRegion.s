...
/* 802A1814  48 00 00 4C */	b lbl_802A1860                           /* constant-address: 802A1860, symbol: lbl_802A1860 */
lbl_802A1818:
/* 802A1818  80 87 00 00 */	lwz r4, 0(r7)                           
/* 802A181C  80 A4 03 94 */	lwz r5, 0x394(r4)                       
/* 802A1820  7C 03 28 40 */	cmplw r3, r5                            
/* 802A1824  40 80 00 0C */	bge lbl_802A1830                         /* constant-address: 802A1830, symbol: lbl_802A1830 */
/* 802A1828  38 00 00 00 */	li r0, 0                                
/* 802A182C  48 00 00 20 */	b lbl_802A184C                           /* constant-address: 802A184C, symbol: lbl_802A184C */
lbl_802A1830:
/* 802A1830  80 04 03 98 */	lwz r0, 0x398(r4)                       
/* 802A1834  7C 05 02 14 */	add r0, r5, r0                          
/* 802A1838  7C 00 30 40 */	cmplw r0, r6                            
/* 802A183C  40 80 00 0C */	bge lbl_802A1848                         /* constant-address: 802A1848, symbol: lbl_802A1848 */
/* 802A1840  38 00 00 00 */	li r0, 0                                
/* 802A1844  48 00 00 08 */	b lbl_802A184C                           /* constant-address: 802A184C, symbol: lbl_802A184C */
lbl_802A1848:
/* 802A1848  38 00 00 01 */	li r0, 1                                
lbl_802A184C:
/* 802A184C  54 00 06 3F */	clrlwi. r0, r0, 0x18                    
/* 802A1850  41 82 00 0C */	beq lbl_802A185C                         /* constant-address: 802A185C, symbol: lbl_802A185C */
...
/* 802A1864  40 82 FF B4 */	bne lbl_802A1818                         /* constant-address: 802A1818, symbol: lbl_802A1818 */

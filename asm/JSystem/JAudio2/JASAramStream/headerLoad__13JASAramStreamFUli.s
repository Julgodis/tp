...
/* 80296930  48 0C B8 AD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 80296934  7C 7D 1B 78 */	mr r29, r3                              
/* 80296938  7C 9E 23 78 */	mr r30, r4                              
/* 8029693C  7C BF 2B 78 */	mr r31, r5                              
/* 80296940  88 0D 8C E1 */	lbz r0, struct_80451260+0x1(r13)         /* constant-address: 80451261, symbol: struct_80451260+0x1 */
/* 80296944  28 00 00 00 */	cmplwi r0, 0                            
/* 80296948  41 82 00 0C */	beq lbl_80296954                         /* constant-address: 80296954, symbol: lbl_80296954 */
/* 8029694C  38 60 00 00 */	li r3, 0                                
/* 80296950  48 00 01 80 */	b lbl_80296AD0                           /* constant-address: 80296AD0, symbol: lbl_80296AD0 */
lbl_80296954:
/* 80296954  88 1D 01 14 */	lbz r0, 0x114(r29)                      
/* 80296958  28 00 00 00 */	cmplwi r0, 0                            
/* 8029695C  41 82 00 0C */	beq lbl_80296968                         /* constant-address: 80296968, symbol: lbl_80296968 */
/* 80296960  38 60 00 00 */	li r3, 0                                
/* 80296964  48 00 01 6C */	b lbl_80296AD0                           /* constant-address: 80296AD0, symbol: lbl_80296AD0 */
lbl_80296968:
/* 80296968  38 7D 00 CC */	addi r3, r29, 0xcc                      
/* 8029696C  80 8D 8C D4 */	lwz r4, sReadBuffer__13JASAramStream(r13) /* constant-address: 80451254, symbol: sReadBuffer__13JASAramStream */
/* 80296970  38 A0 00 40 */	li r5, 0x40                             
/* 80296974  38 C0 00 00 */	li r6, 0                                
/* 80296978  38 E0 00 01 */	li r7, 1                                
/* 8029697C  48 0B 24 C9 */	bl DVDReadPrio                           /* constant-address: 80348E44, symbol: DVDReadPrio */
/* 80296980  2C 03 00 00 */	cmpwi r3, 0                             
/* 80296984  40 80 00 14 */	bge lbl_80296998                         /* constant-address: 80296998, symbol: lbl_80296998 */
/* 80296988  38 00 00 01 */	li r0, 1                                
/* 8029698C  98 0D 8C E1 */	stb r0, struct_80451260+0x1(r13)         /* constant-address: 80451261, symbol: struct_80451260+0x1 */
/* 80296990  38 60 00 00 */	li r3, 0                                
/* 80296994  48 00 01 3C */	b lbl_80296AD0                           /* constant-address: 80296AD0, symbol: lbl_80296AD0 */
lbl_80296998:
/* 80296998  80 8D 8C D4 */	lwz r4, sReadBuffer__13JASAramStream(r13) /* constant-address: 80451254, symbol: sReadBuffer__13JASAramStream */
...
/* 802969D8  C8 22 BC 20 */	lfd f1, lit_533(r2)                      /* constant-address: 80455620, symbol: lit_533 */
...
/* 802969F0  C0 02 BC 1C */	lfs f0, lit_531(r2)                      /* constant-address: 8045561C, symbol: lit_531 */
...
/* 80296A0C  80 0D 8C D8 */	lwz r0, sBlockSize__13JASAramStream(r13) /* constant-address: 80451258, symbol: sBlockSize__13JASAramStream */
...
/* 80296A40  4B FF FC D1 */	bl getBlockSamples__13JASAramStreamCFv   /* constant-address: 80296710, symbol: getBlockSamples__13JASAramStreamCFv */
/* 80296A44  2C 1F 00 00 */	cmpwi r31, 0                            
/* 80296A48  41 80 00 10 */	blt lbl_80296A58                         /* constant-address: 80296A58, symbol: lbl_80296A58 */
/* 80296A4C  80 1D 01 08 */	lwz r0, 0x108(r29)                      
/* 80296A50  7C 1F 00 40 */	cmplw r31, r0                           
/* 80296A54  40 81 00 08 */	ble lbl_80296A5C                         /* constant-address: 80296A5C, symbol: lbl_80296A5C */
lbl_80296A58:
/* 80296A58  83 FD 01 08 */	lwz r31, 0x108(r29)                     
lbl_80296A5C:
/* 80296A5C  88 1D 01 14 */	lbz r0, 0x114(r29)                      
/* 80296A60  28 00 00 00 */	cmplwi r0, 0                            
/* 80296A64  41 82 00 0C */	beq lbl_80296A70                         /* constant-address: 80296A70, symbol: lbl_80296A70 */
/* 80296A68  38 60 00 00 */	li r3, 0                                
/* 80296A6C  48 00 00 64 */	b lbl_80296AD0                           /* constant-address: 80296AD0, symbol: lbl_80296AD0 */
lbl_80296A70:
...
/* 80296A84  80 6D 8C D0 */	lwz r3, sLoadThread__13JASAramStream(r13) /* constant-address: 80451250, symbol: sLoadThread__13JASAramStream */
/* 80296A88  3C 80 80 29 */	lis r4, firstLoadTask__13JASAramStreamFPv@ha
/* 80296A8C  38 84 67 6C */	addi r4, r4, firstLoadTask__13JASAramStreamFPv@l /* constant-address: 8029676C, symbol: firstLoadTask__13JASAramStreamFPv */
/* 80296A90  38 A1 00 0C */	addi r5, r1, 0xc                        
/* 80296A94  38 C0 00 0C */	li r6, 0xc                              
/* 80296A98  4B FF 90 C5 */	bl sendCmdMsg__13JASTaskThreadFPFPv_vPCvUl /* constant-address: 8028FB5C, symbol: sendCmdMsg__13JASTaskThreadFPFPv_vPCvUl */
/* 80296A9C  2C 03 00 00 */	cmpwi r3, 0                             
/* 80296AA0  40 82 00 14 */	bne lbl_80296AB4                         /* constant-address: 80296AB4, symbol: lbl_80296AB4 */
/* 80296AA4  38 00 00 01 */	li r0, 1                                
/* 80296AA8  98 0D 8C E1 */	stb r0, struct_80451260+0x1(r13)         /* constant-address: 80451261, symbol: struct_80451260+0x1 */
/* 80296AAC  38 60 00 00 */	li r3, 0                                
/* 80296AB0  48 00 00 20 */	b lbl_80296AD0                           /* constant-address: 80296AD0, symbol: lbl_80296AD0 */
lbl_80296AB4:
/* 80296AB4  48 0A 6C 41 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 80296AC8  48 0A 6C 55 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 80296ACC  38 60 00 01 */	li r3, 1                                
lbl_80296AD0:
/* 80296AD0  39 61 00 30 */	addi r11, r1, 0x30                      
/* 80296AD4  48 0C B7 55 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 8029EA18  80 0D 8D 8C */	lwz r0, DSP_prior_task(r13)              /* constant-address: 8045130C, symbol: DSP_prior_task */
/* 8029EA1C  28 00 00 00 */	cmplwi r0, 0                            
/* 8029EA20  40 82 00 1C */	bne lbl_8029EA3C                         /* constant-address: 8029EA3C, symbol: lbl_8029EA3C */
/* 8029EA24  3C 60 80 3A */	lis r3, lit_81@ha                       
/* 8029EA28  38 63 B8 B8 */	addi r3, r3, lit_81@l                    /* constant-address: 8039B8B8, symbol: lit_81 */
/* 8029EA2C  4C C6 31 82 */	crclr 6                                 
/* 8029EA30  4B D6 80 8D */	bl OSReport                              /* constant-address: 80006ABC, symbol: OSReport */
/* 8029EA34  38 60 00 00 */	li r3, 0                                
/* 8029EA38  48 00 00 34 */	b lbl_8029EA6C                           /* constant-address: 8029EA6C, symbol: lbl_8029EA6C */
lbl_8029EA3C:
/* 8029EA3C  48 09 EC B9 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8029EA40  7C 60 1B 78 */	mr r0, r3                               
/* 8029EA44  7F C3 F3 78 */	mr r3, r30                              
/* 8029EA48  7C 1F 03 78 */	mr r31, r0                              
/* 8029EA4C  48 0B 3E B1 */	bl __DSP_insert_task                     /* constant-address: 803528FC, symbol: __DSP_insert_task */
...
/* 8029EA64  48 09 EC B9 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

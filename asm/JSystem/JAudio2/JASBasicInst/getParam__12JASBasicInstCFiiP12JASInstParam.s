...
/* 80298138  40 81 00 24 */	ble lbl_8029815C                         /* constant-address: 8029815C, symbol: lbl_8029815C */
lbl_8029813C:
/* 8029813C  7C E3 2A 14 */	add r7, r3, r5                          
/* 80298140  80 07 00 00 */	lwz r0, 0(r7)                           
/* 80298144  7C 04 00 00 */	cmpw r4, r0                             
/* 80298148  41 81 00 0C */	bgt lbl_80298154                         /* constant-address: 80298154, symbol: lbl_80298154 */
/* 8029814C  7C E8 3B 78 */	mr r8, r7                               
/* 80298150  48 00 00 0C */	b lbl_8029815C                           /* constant-address: 8029815C, symbol: lbl_8029815C */
lbl_80298154:
/* 80298154  38 A5 00 10 */	addi r5, r5, 0x10                        /* constant-address: 00000010 */
/* 80298158  42 00 FF E4 */	bdnz lbl_8029813C                        /* constant-address: 8029813C, symbol: lbl_8029813C */
lbl_8029815C:
/* 8029815C  28 08 00 00 */	cmplwi r8, 0                            
/* 80298160  40 82 00 0C */	bne lbl_8029816C                         /* constant-address: 8029816C, symbol: lbl_8029816C */
/* 80298164  38 60 00 00 */	li r3, 0                                
/* 80298168  4E 80 00 20 */	blr                                     
lbl_8029816C:
/* 8029816C  C0 26 00 00 */	lfs f1, 0(r6)                           
/* 80298170  C0 08 00 08 */	lfs f0, 8(r8)                            /* constant-address: 00000008 */
/* 80298174  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 80298178  D0 06 00 00 */	stfs f0, 0(r6)                          
/* 8029817C  C0 26 00 08 */	lfs f1, 8(r6)                           
/* 80298180  C0 08 00 0C */	lfs f0, 0xc(r8)                          /* constant-address: 0000000C */
/* 80298184  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 80298188  D0 06 00 08 */	stfs f0, 8(r6)                          
/* 8029818C  A0 08 00 04 */	lhz r0, 4(r8)                            /* constant-address: 00000004 */

...
/* 8029D220  40 82 00 50 */	bne lbl_8029D270                         /* constant-address: 8029D270, symbol: lbl_8029D270 */
/* 8029D224  3B E0 00 00 */	li r31, 0                               
lbl_8029D228:
/* 8029D228  7F E3 FB 78 */	mr r3, r31                              
/* 8029D22C  48 00 07 1D */	bl getHandle__13JASDSPChannelFUl         /* constant-address: 8029D948, symbol: getHandle__13JASDSPChannelFUl */
/* 8029D230  80 03 00 00 */	lwz r0, 0(r3)                           
/* 8029D234  54 00 06 3F */	clrlwi. r0, r0, 0x18                    
/* 8029D238  40 82 00 08 */	bne lbl_8029D240                         /* constant-address: 8029D240, symbol: lbl_8029D240 */
/* 8029D23C  48 00 01 05 */	bl drop__13JASDSPChannelFv               /* constant-address: 8029D340, symbol: drop__13JASDSPChannelFv */
lbl_8029D240:
/* 8029D240  3B FF 00 01 */	addi r31, r31, 1                        
/* 8029D244  28 1F 00 40 */	cmplwi r31, 0x40                        
/* 8029D248  41 80 FF E0 */	blt lbl_8029D228                         /* constant-address: 8029D228, symbol: lbl_8029D228 */
/* 8029D24C  88 1E 00 0C */	lbz r0, 0xc(r30)                        
/* 8029D250  28 00 00 00 */	cmplwi r0, 0                            
/* 8029D254  41 82 00 0C */	beq lbl_8029D260                         /* constant-address: 8029D260, symbol: lbl_8029D260 */
/* 8029D258  80 6D 86 0C */	lwz r3, data_80450B8C(r13)               /* constant-address: 80450B8C, symbol: data_80450B8C */
/* 8029D25C  4B FF FB 65 */	bl stop__14JASAudioThreadFv              /* constant-address: 8029CDC0, symbol: stop__14JASAudioThreadFv */
lbl_8029D260:
/* 8029D260  38 00 00 01 */	li r0, 1                                
/* 8029D264  90 1E 00 08 */	stw r0, 8(r30)                          
/* 8029D268  38 60 FF FF */	li r3, -1                               
/* 8029D26C  48 00 00 50 */	b lbl_8029D2BC                           /* constant-address: 8029D2BC, symbol: lbl_8029D2BC */
lbl_8029D270:
/* 8029D270  38 03 FF FF */	addi r0, r3, -1                         
/* 8029D274  90 1E 00 00 */	stw r0, 0(r30)                          
/* 8029D278  83 FE 00 00 */	lwz r31, 0(r30)                         
/* 8029D27C  48 00 0E DD */	bl getDSPLevel__9JASDriverFv             /* constant-address: 8029E158, symbol: getDSPLevel__9JASDriverFv */
/* 8029D280  C8 42 BD 40 */	lfd f2, lit_156(r2)                      /* constant-address: 80455740, symbol: lit_156 */
...
/* 8029D2B4  48 00 0E 7D */	bl setDSPLevel__9JASDriverFf             /* constant-address: 8029E130, symbol: setDSPLevel__9JASDriverFf */

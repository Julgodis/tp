...
/* 802DD834  4B FF 14 DD */	bl __nwa__FUlP7JKRHeapi                  /* constant-address: 802CED10, symbol: __nwa__FUlP7JKRHeapi */
/* 802DD838  90 7F 00 50 */	stw r3, 0x50(r31)                       
/* 802DD83C  80 7F 00 50 */	lwz r3, 0x50(r31)                       
/* 802DD840  28 03 00 00 */	cmplwi r3, 0                            
/* 802DD844  40 82 00 0C */	bne lbl_802DD850                         /* constant-address: 802DD850, symbol: lbl_802DD850 */
/* 802DD848  38 60 00 00 */	li r3, 0                                
/* 802DD84C  48 00 00 8C */	b lbl_802DD8D8                           /* constant-address: 802DD8D8, symbol: lbl_802DD8D8 */
lbl_802DD850:
/* 802DD850  7C 65 1B 78 */	mr r5, r3                               
/* 802DD854  A0 1F 00 60 */	lhz r0, 0x60(r31)                       
/* 802DD858  28 00 00 00 */	cmplwi r0, 0                            
/* 802DD85C  41 82 00 14 */	beq lbl_802DD870                         /* constant-address: 802DD870, symbol: lbl_802DD870 */
...
/* 802DD878  41 82 00 4C */	beq lbl_802DD8C4                         /* constant-address: 802DD8C4, symbol: lbl_802DD8C4 */
...
/* 802DD894  48 00 00 24 */	b lbl_802DD8B8                           /* constant-address: 802DD8B8, symbol: lbl_802DD8B8 */
lbl_802DD898:
...
/* 802DD8B0  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
/* 802DD8B4  38 63 00 04 */	addi r3, r3, 4                           /* constant-address: 00000004 */
lbl_802DD8B8:
/* 802DD8B8  A0 1F 00 62 */	lhz r0, 0x62(r31)                       
/* 802DD8BC  7C 06 00 00 */	cmpw r6, r0                             
/* 802DD8C0  41 80 FF D8 */	blt lbl_802DD898                         /* constant-address: 802DD898, symbol: lbl_802DD898 */
lbl_802DD8C4:
/* 802DD8C4  A0 1F 00 64 */	lhz r0, 0x64(r31)                       
/* 802DD8C8  28 00 00 00 */	cmplwi r0, 0                            
/* 802DD8CC  41 82 00 08 */	beq lbl_802DD8D4                         /* constant-address: 802DD8D4, symbol: lbl_802DD8D4 */

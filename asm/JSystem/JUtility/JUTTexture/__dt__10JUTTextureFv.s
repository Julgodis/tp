...
/* 802DE250  41 82 00 3C */	beq lbl_802DE28C                         /* constant-address: 802DE28C, symbol: lbl_802DE28C */
/* 802DE254  88 1E 00 3B */	lbz r0, 0x3b(r30)                       
/* 802DE258  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 802DE25C  41 82 00 0C */	beq lbl_802DE268                         /* constant-address: 802DE268, symbol: lbl_802DE268 */
/* 802DE260  80 7E 00 3C */	lwz r3, 0x3c(r30)                       
/* 802DE264  4B FF 0A FD */	bl __dla__FPv                            /* constant-address: 802CED60, symbol: __dla__FPv */
lbl_802DE268:
/* 802DE268  88 1E 00 3B */	lbz r0, 0x3b(r30)                       
/* 802DE26C  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 802DE270  41 82 00 0C */	beq lbl_802DE27C                         /* constant-address: 802DE27C, symbol: lbl_802DE27C */
/* 802DE274  80 7E 00 28 */	lwz r3, 0x28(r30)                       
/* 802DE278  4B FF 0A C5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802DE27C:
/* 802DE27C  7F E0 07 35 */	extsh. r0, r31                          
/* 802DE280  40 81 00 0C */	ble lbl_802DE28C                         /* constant-address: 802DE28C, symbol: lbl_802DE28C */
/* 802DE284  7F C3 F3 78 */	mr r3, r30                              
/* 802DE288  4B FF 0A B5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802DE28C:

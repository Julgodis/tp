...
/* 802E432C  48 07 DE A9 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 802E4330  3C E0 80 3D */	lis r7, sAsciiTable__14JUTDirectPrint@ha
/* 802E4334  38 E7 C6 B8 */	addi r7, r7, sAsciiTable__14JUTDirectPrint@l /* constant-address: 803CC6B8, symbol: sAsciiTable__14JUTDirectPrint */
/* 802E4338  2C 06 00 64 */	cmpwi r6, 0x64                          
/* 802E433C  7C C8 33 78 */	mr r8, r6                               
/* 802E4340  41 80 00 08 */	blt lbl_802E4348                         /* constant-address: 802E4348, symbol: lbl_802E4348 */
...
/* 802E4368  38 C7 01 80 */	addi r6, r7, 0x180                       /* constant-address: 803CC838, symbol: sFontData2__14JUTDirectPrint */
/* 802E436C  7C C6 02 14 */	add r6, r6, r0                          
/* 802E4370  40 80 00 0C */	bge lbl_802E437C                         /* constant-address: 802E437C, symbol: lbl_802E437C */
/* 802E4374  38 C7 00 80 */	addi r6, r7, 0x80                        /* constant-address: 803CC738, symbol: sFontData__14JUTDirectPrint */
...
/* 802E43E4  40 82 00 0C */	bne lbl_802E43F0                         /* constant-address: 802E43F0, symbol: lbl_802E43F0 */
/* 802E43E8  57 65 F8 4C */	rlwinm r5, r27, 0x1f, 1, 6              
/* 802E43EC  48 00 00 34 */	b lbl_802E4420                           /* constant-address: 802E4420, symbol: lbl_802E4420 */
lbl_802E43F0:
/* 802E43F0  57 65 27 3A */	rlwinm r5, r27, 4, 0x1c, 0x1d           
/* 802E43F4  3B C7 02 B4 */	addi r30, r7, 0x2b4                      /* constant-address: 803CC96C, symbol: data_803CC96C */
...
/* 802E4430  40 81 01 04 */	ble lbl_802E4534                         /* constant-address: 802E4534, symbol: lbl_802E4534 */
lbl_802E4434:
/* 802E4434  54 BC 00 43 */	rlwinm. r28, r5, 0, 1, 1                
/* 802E4438  41 82 00 0C */	beq lbl_802E4444                         /* constant-address: 802E4444, symbol: lbl_802E4444 */
/* 802E443C  A3 C3 00 20 */	lhz r30, 0x20(r3)                       
/* 802E4440  48 00 00 08 */	b lbl_802E4448                           /* constant-address: 802E4448, symbol: lbl_802E4448 */
lbl_802E4444:
/* 802E4444  3B C0 00 40 */	li r30, 0x40                            
lbl_802E4448:
/* 802E4448  54 AC 00 01 */	rlwinm. r12, r5, 0, 0, 0                
/* 802E444C  41 82 00 0C */	beq lbl_802E4458                         /* constant-address: 802E4458, symbol: lbl_802E4458 */
/* 802E4450  A3 A3 00 22 */	lhz r29, 0x22(r3)                       
/* 802E4454  48 00 00 08 */	b lbl_802E445C                           /* constant-address: 802E445C, symbol: lbl_802E445C */
lbl_802E4458:
/* 802E4458  3B A0 00 20 */	li r29, 0x20                            
lbl_802E445C:
/* 802E445C  54 BB 00 85 */	rlwinm. r27, r5, 0, 2, 2                
/* 802E4460  41 82 00 0C */	beq lbl_802E446C                         /* constant-address: 802E446C, symbol: lbl_802E446C */
/* 802E4464  A1 83 00 22 */	lhz r12, 0x22(r3)                       
/* 802E4468  48 00 00 08 */	b lbl_802E4470                           /* constant-address: 802E4470, symbol: lbl_802E4470 */
lbl_802E446C:
/* 802E446C  39 80 00 20 */	li r12, 0x20                            
lbl_802E4470:
/* 802E4470  28 1C 00 00 */	cmplwi r28, 0                           
/* 802E4474  41 82 00 0C */	beq lbl_802E4480                         /* constant-address: 802E4480, symbol: lbl_802E4480 */
/* 802E4478  A3 E3 00 1C */	lhz r31, 0x1c(r3)                       
/* 802E447C  48 00 00 08 */	b lbl_802E4484                           /* constant-address: 802E4484, symbol: lbl_802E4484 */
lbl_802E4480:
...
/* 802E449C  40 81 00 10 */	ble lbl_802E44AC                         /* constant-address: 802E44AC, symbol: lbl_802E44AC */
...
/* 802E44B0  41 82 00 0C */	beq lbl_802E44BC                         /* constant-address: 802E44BC, symbol: lbl_802E44BC */
/* 802E44B4  A3 A3 00 26 */	lhz r29, 0x26(r3)                       
/* 802E44B8  48 00 00 08 */	b lbl_802E44C0                           /* constant-address: 802E44C0, symbol: lbl_802E44C0 */
lbl_802E44BC:
/* 802E44BC  3B A0 00 40 */	li r29, 0x40                            
lbl_802E44C0:
/* 802E44C0  28 1C 00 00 */	cmplwi r28, 0                           
/* 802E44C4  41 82 00 0C */	beq lbl_802E44D0                         /* constant-address: 802E44D0, symbol: lbl_802E44D0 */
/* 802E44C8  A3 C3 00 28 */	lhz r30, 0x28(r3)                       
/* 802E44CC  48 00 00 08 */	b lbl_802E44D4                           /* constant-address: 802E44D4, symbol: lbl_802E44D4 */
lbl_802E44D0:
/* 802E44D0  3B C0 00 20 */	li r30, 0x20                            
lbl_802E44D4:
/* 802E44D4  54 AC 00 C7 */	rlwinm. r12, r5, 0, 3, 3                
/* 802E44D8  41 82 00 0C */	beq lbl_802E44E4                         /* constant-address: 802E44E4, symbol: lbl_802E44E4 */
/* 802E44DC  A1 83 00 28 */	lhz r12, 0x28(r3)                       
/* 802E44E0  48 00 00 08 */	b lbl_802E44E8                           /* constant-address: 802E44E8, symbol: lbl_802E44E8 */
lbl_802E44E4:
/* 802E44E4  39 80 00 20 */	li r12, 0x20                            
lbl_802E44E8:
/* 802E44E8  28 1B 00 00 */	cmplwi r27, 0                           
/* 802E44EC  41 82 00 0C */	beq lbl_802E44F8                         /* constant-address: 802E44F8, symbol: lbl_802E44F8 */
/* 802E44F0  A3 E3 00 1C */	lhz r31, 0x1c(r3)                       
/* 802E44F4  48 00 00 08 */	b lbl_802E44FC                           /* constant-address: 802E44FC, symbol: lbl_802E44FC */
lbl_802E44F8:
...
/* 802E4514  40 81 00 14 */	ble lbl_802E4528                         /* constant-address: 802E4528, symbol: lbl_802E4528 */
...
/* 802E4530  42 00 FF 04 */	bdnz lbl_802E4434                        /* constant-address: 802E4434, symbol: lbl_802E4434 */
lbl_802E4534:
...
/* 802E4550  41 80 FE 84 */	blt lbl_802E43D4                         /* constant-address: 802E43D4, symbol: lbl_802E43D4 */
/* 802E4554  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802E4558  48 07 DC C9 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

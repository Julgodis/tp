...
/* 802DEB70  38 03 C5 90 */	addi r0, r3, __vt__12JUTGraphFifo@l      /* constant-address: 803CC590, symbol: __vt__12JUTGraphFifo */
...
/* 802DEB84  88 0D 8F 38 */	lbz r0, data_804514B8(r13)               /* constant-address: 804514B8, symbol: data_804514B8 */
/* 802DEB88  28 00 00 00 */	cmplwi r0, 0                            
/* 802DEB8C  41 82 00 4C */	beq lbl_802DEBD8                         /* constant-address: 802DEBD8, symbol: lbl_802DEBD8 */
/* 802DEB90  80 6D 8D F0 */	lwz r3, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802DEB94  80 9F 00 0C */	lwz r4, 0xc(r31)                        
/* 802DEB98  38 84 00 80 */	addi r4, r4, 0x80                       
/* 802DEB9C  38 A0 00 20 */	li r5, 0x20                             
/* 802DEBA0  4B FE F9 35 */	bl alloc__7JKRHeapFUli                   /* constant-address: 802CE4D4, symbol: alloc__7JKRHeapFUli */
...
/* 802DEBC0  48 07 BB 1D */	bl GXInitFifoBase                        /* constant-address: 8035A6DC, symbol: GXInitFifoBase */
/* 802DEBC4  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 802DEBC8  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802DEBCC  7C 85 23 78 */	mr r5, r4                               
/* 802DEBD0  48 07 BB 79 */	bl GXInitFifoPtrs                        /* constant-address: 8035A748, symbol: GXInitFifoPtrs */
/* 802DEBD4  48 00 00 48 */	b lbl_802DEC1C                           /* constant-address: 802DEC1C, symbol: lbl_802DEC1C */
lbl_802DEBD8:
/* 802DEBD8  80 6D 8D F0 */	lwz r3, sSystemHeap__7JKRHeap(r13)       /* constant-address: 80451370, symbol: sSystemHeap__7JKRHeap */
/* 802DEBDC  80 9F 00 0C */	lwz r4, 0xc(r31)                        
/* 802DEBE0  38 84 00 A0 */	addi r4, r4, 0xa0                       
/* 802DEBE4  38 A0 00 20 */	li r5, 0x20                             
/* 802DEBE8  4B FE F8 ED */	bl alloc__7JKRHeapFUli                   /* constant-address: 802CE4D4, symbol: alloc__7JKRHeapFUli */
...
/* 802DEC08  48 07 AA 69 */	bl GXInit                                /* constant-address: 80359670, symbol: GXInit */
/* 802DEC0C  90 7F 00 04 */	stw r3, 4(r31)                          
/* 802DEC10  38 00 00 01 */	li r0, 1                                
/* 802DEC14  98 0D 8F 38 */	stb r0, data_804514B8(r13)               /* constant-address: 804514B8, symbol: data_804514B8 */
/* 802DEC18  93 ED 8F 3C */	stw r31, sCurrentFifo__12JUTGraphFifo(r13) /* constant-address: 804514BC, symbol: sCurrentFifo__12JUTGraphFifo */
lbl_802DEC1C:

...
/* 802E82D4  40 82 00 64 */	bne lbl_802E8338                         /* constant-address: 802E8338, symbol: lbl_802E8338 */
/* 802E82D8  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 802E82DC  28 00 00 01 */	cmplwi r0, 1                            
/* 802E82E0  41 81 00 10 */	bgt lbl_802E82F0                         /* constant-address: 802E82F0, symbol: lbl_802E82F0 */
/* 802E82E4  38 00 00 00 */	li r0, 0                                
/* 802E82E8  90 1E 00 0C */	stw r0, 0xc(r30)                        
/* 802E82EC  48 00 00 4C */	b lbl_802E8338                           /* constant-address: 802E8338, symbol: lbl_802E8338 */
lbl_802E82F0:
...
/* 802E8310  41 82 00 10 */	beq lbl_802E8320                         /* constant-address: 802E8320, symbol: lbl_802E8320 */
/* 802E8314  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 802E8318  38 03 FF E8 */	addi r0, r3, -24                        
/* 802E831C  48 00 00 18 */	b lbl_802E8334                           /* constant-address: 802E8334, symbol: lbl_802E8334 */
lbl_802E8320:
...
lbl_802E8338:
/* 802E8338  48 00 02 01 */	bl JUTGetWarningConsole                  /* constant-address: 802E8538, symbol: JUTGetWarningConsole */
/* 802E833C  7C 03 F8 40 */	cmplw r3, r31                           
/* 802E8340  40 82 00 0C */	bne lbl_802E834C                         /* constant-address: 802E834C, symbol: lbl_802E834C */
/* 802E8344  38 60 00 00 */	li r3, 0                                
/* 802E8348  48 00 01 E9 */	bl JUTSetWarningConsole                  /* constant-address: 802E8530, symbol: JUTSetWarningConsole */
lbl_802E834C:
/* 802E834C  48 00 01 DD */	bl JUTGetReportConsole                   /* constant-address: 802E8528, symbol: JUTGetReportConsole */
/* 802E8350  7C 03 F8 40 */	cmplw r3, r31                           
/* 802E8354  40 82 00 0C */	bne lbl_802E8360                         /* constant-address: 802E8360, symbol: lbl_802E8360 */
/* 802E8358  38 60 00 00 */	li r3, 0                                
/* 802E835C  48 00 01 C5 */	bl JUTSetReportConsole                   /* constant-address: 802E8520, symbol: JUTSetReportConsole */
lbl_802E8360:
/* 802E8360  38 9F 00 18 */	addi r4, r31, 0x18                      
/* 802E8364  7F C3 F3 78 */	mr r3, r30                              
/* 802E8368  4B FF 48 91 */	bl Remove__Q27JGadget13TNodeLinkListFPQ27JGadget13TLinkListNode /* constant-address: 802DCBF8, symbol: Remove__Q27JGadget13TNodeLinkListFPQ27JGadget13TLinkListNode */

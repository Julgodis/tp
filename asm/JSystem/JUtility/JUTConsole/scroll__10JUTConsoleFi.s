...
/* 802E80AC  40 80 00 34 */	bge lbl_802E80E0                         /* constant-address: 802E80E0, symbol: lbl_802E80E0 */
/* 802E80B0  80 A3 00 34 */	lwz r5, 0x34(r3)                        
/* 802E80B4  80 03 00 30 */	lwz r0, 0x30(r3)                        
/* 802E80B8  7C A5 00 51 */	subf. r5, r5, r0                        
/* 802E80BC  41 80 00 08 */	blt lbl_802E80C4                         /* constant-address: 802E80C4, symbol: lbl_802E80C4 */
/* 802E80C0  48 00 00 0C */	b lbl_802E80CC                           /* constant-address: 802E80CC, symbol: lbl_802E80CC */
lbl_802E80C4:
...
/* 802E80D4  40 80 00 70 */	bge lbl_802E8144                         /* constant-address: 802E8144, symbol: lbl_802E8144 */
/* 802E80D8  7C 04 03 78 */	mr r4, r0                               
/* 802E80DC  48 00 00 68 */	b lbl_802E8144                           /* constant-address: 802E8144, symbol: lbl_802E8144 */
lbl_802E80E0:
/* 802E80E0  40 81 00 64 */	ble lbl_802E8144                         /* constant-address: 802E8144, symbol: lbl_802E8144 */
/* 802E80E4  80 03 00 34 */	lwz r0, 0x34(r3)                        
/* 802E80E8  80 C3 00 38 */	lwz r6, 0x38(r3)                        
/* 802E80EC  7C A0 30 51 */	subf. r5, r0, r6                        
/* 802E80F0  41 80 00 08 */	blt lbl_802E80F8                         /* constant-address: 802E80F8, symbol: lbl_802E80F8 */
/* 802E80F4  48 00 00 0C */	b lbl_802E8100                           /* constant-address: 802E8100, symbol: lbl_802E8100 */
lbl_802E80F8:
...
/* 802E810C  41 81 00 0C */	bgt lbl_802E8118                         /* constant-address: 802E8118, symbol: lbl_802E8118 */
/* 802E8110  38 80 00 00 */	li r4, 0                                
/* 802E8114  48 00 00 30 */	b lbl_802E8144                           /* constant-address: 802E8144, symbol: lbl_802E8144 */
lbl_802E8118:
/* 802E8118  80 03 00 30 */	lwz r0, 0x30(r3)                        
/* 802E811C  7C A0 30 51 */	subf. r5, r0, r6                        
/* 802E8120  41 80 00 08 */	blt lbl_802E8128                         /* constant-address: 802E8128, symbol: lbl_802E8128 */
/* 802E8124  48 00 00 0C */	b lbl_802E8130                           /* constant-address: 802E8130, symbol: lbl_802E8130 */
lbl_802E8128:
...
/* 802E813C  40 81 00 08 */	ble lbl_802E8144                         /* constant-address: 802E8144, symbol: lbl_802E8144 */
...
/* 802E8158  40 80 00 10 */	bge lbl_802E8168                         /* constant-address: 802E8168, symbol: lbl_802E8168 */

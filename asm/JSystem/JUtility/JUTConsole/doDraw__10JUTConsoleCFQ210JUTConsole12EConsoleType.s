...
/* 802E7680  48 07 AB 39 */	bl _savegpr_20                           /* constant-address: 803621B8, symbol: _savegpr_20 */
...
/* 802E7694  41 82 04 E4 */	beq lbl_802E7B78                         /* constant-address: 802E7B78, symbol: lbl_802E7B78 */
/* 802E7698  80 19 00 4C */	lwz r0, 0x4c(r25)                       
/* 802E769C  28 00 00 00 */	cmplwi r0, 0                            
/* 802E76A0  40 82 00 0C */	bne lbl_802E76AC                         /* constant-address: 802E76AC, symbol: lbl_802E76AC */
/* 802E76A4  2C 1A 00 02 */	cmpwi r26, 2                            
/* 802E76A8  40 82 04 D0 */	bne lbl_802E7B78                         /* constant-address: 802E7B78, symbol: lbl_802E7B78 */
lbl_802E76AC:
/* 802E76AC  80 F9 00 48 */	lwz r7, 0x48(r25)                       
/* 802E76B0  28 07 00 00 */	cmplwi r7, 0                            
/* 802E76B4  41 82 04 C4 */	beq lbl_802E7B78                         /* constant-address: 802E7B78, symbol: lbl_802E7B78 */
/* 802E76B8  7F 40 00 34 */	cntlzw r0, r26                          
/* 802E76BC  54 1E D9 7E */	srwi r30, r0, 5                         
/* 802E76C0  C0 22 C7 18 */	lfs f1, lit_2460(r2)                     /* constant-address: 80456118, symbol: lit_2460 */
/* 802E76C4  C0 19 00 54 */	lfs f0, 0x54(r25)                       
/* 802E76C8  EF E1 00 2A */	fadds f31, f1, f0                       
/* 802E76CC  2C 1A 00 02 */	cmpwi r26, 2                            
/* 802E76D0  41 82 02 D4 */	beq lbl_802E79A4                         /* constant-address: 802E79A4, symbol: lbl_802E79A4 */
/* 802E76D4  80 6D 8F B8 */	lwz r3, sManager__8JUTVideo(r13)         /* constant-address: 80451538, symbol: sManager__8JUTVideo */
/* 802E76D8  28 03 00 00 */	cmplwi r3, 0                            
/* 802E76DC  40 82 00 48 */	bne lbl_802E7724                         /* constant-address: 802E7724, symbol: lbl_802E7724 */
/* 802E76E0  38 61 01 08 */	addi r3, r1, 0x108                      
/* 802E76E4  C0 22 C7 1C */	lfs f1, lit_2461(r2)                     /* constant-address: 8045611C, symbol: lit_2461 */
/* 802E76E8  FC 40 08 90 */	fmr f2, f1                              
/* 802E76EC  C0 62 C7 20 */	lfs f3, lit_2462(r2)                     /* constant-address: 80456120, symbol: lit_2462 */
/* 802E76F0  C0 82 C7 24 */	lfs f4, lit_2463(r2)                     /* constant-address: 80456124, symbol: lit_2463 */
/* 802E76F4  C0 A2 C7 28 */	lfs f5, lit_2464(r2)                     /* constant-address: 80456128, symbol: lit_2464 */
/* 802E76F8  C0 C2 C7 2C */	lfs f6, lit_2465(r2)                     /* constant-address: 8045612C, symbol: lit_2465 */
/* 802E76FC  48 00 1F D5 */	bl __ct__13J2DOrthoGraphFffffff          /* constant-address: 802E96D0, symbol: __ct__13J2DOrthoGraphFffffff */
/* 802E7700  38 61 01 08 */	addi r3, r1, 0x108                      
/* 802E7704  48 00 20 B1 */	bl setPort__13J2DOrthoGraphFv            /* constant-address: 802E97B4, symbol: setPort__13J2DOrthoGraphFv */
/* 802E7708  3C 60 80 3D */	lis r3, __vt__13J2DOrthoGraph@ha        
/* 802E770C  38 03 C9 E0 */	addi r0, r3, __vt__13J2DOrthoGraph@l     /* constant-address: 803CC9E0, symbol: __vt__13J2DOrthoGraph */
/* 802E7710  90 01 01 08 */	stw r0, 0x108(r1)                       
/* 802E7714  3C 60 80 3D */	lis r3, __vt__14J2DGrafContext@ha       
/* 802E7718  38 03 C9 B8 */	addi r0, r3, __vt__14J2DGrafContext@l    /* constant-address: 803CC9B8, symbol: __vt__14J2DGrafContext */
/* 802E771C  90 01 01 08 */	stw r0, 0x108(r1)                       
/* 802E7720  48 00 00 70 */	b lbl_802E7790                           /* constant-address: 802E7790, symbol: lbl_802E7790 */
lbl_802E7724:
...
/* 802E7734  C0 22 C7 1C */	lfs f1, lit_2461(r2)                     /* constant-address: 8045611C, symbol: lit_2461 */
/* 802E7738  FC 40 08 90 */	fmr f2, f1                              
/* 802E773C  C8 82 C7 38 */	lfd f4, lit_2469(r2)                     /* constant-address: 80456138, symbol: lit_2469 */
...
/* 802E7764  C0 A2 C7 28 */	lfs f5, lit_2464(r2)                     /* constant-address: 80456128, symbol: lit_2464 */
/* 802E7768  C0 C2 C7 2C */	lfs f6, lit_2465(r2)                     /* constant-address: 8045612C, symbol: lit_2465 */
/* 802E776C  48 00 1F 65 */	bl __ct__13J2DOrthoGraphFffffff          /* constant-address: 802E96D0, symbol: __ct__13J2DOrthoGraphFffffff */
/* 802E7770  38 61 00 34 */	addi r3, r1, 0x34                       
/* 802E7774  48 00 20 41 */	bl setPort__13J2DOrthoGraphFv            /* constant-address: 802E97B4, symbol: setPort__13J2DOrthoGraphFv */
/* 802E7778  3C 60 80 3D */	lis r3, __vt__13J2DOrthoGraph@ha        
/* 802E777C  38 03 C9 E0 */	addi r0, r3, __vt__13J2DOrthoGraph@l     /* constant-address: 803CC9E0, symbol: __vt__13J2DOrthoGraph */
/* 802E7780  90 01 00 34 */	stw r0, 0x34(r1)                        
/* 802E7784  3C 60 80 3D */	lis r3, __vt__14J2DGrafContext@ha       
/* 802E7788  38 03 C9 B8 */	addi r0, r3, __vt__14J2DGrafContext@l    /* constant-address: 803CC9B8, symbol: __vt__14J2DGrafContext */
/* 802E778C  90 01 00 34 */	stw r0, 0x34(r1)                        
lbl_802E7790:
/* 802E7790  57 C0 06 3F */	clrlwi. r0, r30, 0x18                   
/* 802E7794  41 82 00 0C */	beq lbl_802E77A0                         /* constant-address: 802E77A0, symbol: lbl_802E77A0 */
/* 802E7798  38 79 00 60 */	addi r3, r25, 0x60                      
/* 802E779C  48 00 00 08 */	b lbl_802E77A4                           /* constant-address: 802E77A4, symbol: lbl_802E77A4 */
lbl_802E77A0:
...
/* 802E77B4  C8 C2 C7 40 */	lfd f6, lit_2471(r2)                     /* constant-address: 80456140, symbol: lit_2471 */
...
/* 802E780C  C0 A2 C7 30 */	lfs f5, lit_2466(r2)                     /* constant-address: 80456130, symbol: lit_2466 */
/* 802E7810  C0 79 00 50 */	lfs f3, 0x50(r25)                       
/* 802E7814  80 19 00 20 */	lwz r0, 0x20(r25)                       
/* 802E7818  C8 82 C7 38 */	lfd f4, lit_2469(r2)                     /* constant-address: 80456138, symbol: lit_2469 */
...
/* 802E7890  48 00 22 35 */	bl J2DFillBox__FffffQ28JUtility6TColor   /* constant-address: 802E9AC4, symbol: J2DFillBox__FffffQ28JUtility6TColor */
...
/* 802E78AC  41 82 00 C8 */	beq lbl_802E7974                         /* constant-address: 802E7974, symbol: lbl_802E7974 */
...
/* 802E78C0  41 80 00 08 */	blt lbl_802E78C8                         /* constant-address: 802E78C8, symbol: lbl_802E78C8 */
/* 802E78C4  48 00 00 0C */	b lbl_802E78D0                           /* constant-address: 802E78D0, symbol: lbl_802E78D0 */
lbl_802E78C8:
...
/* 802E78D8  41 81 00 30 */	bgt lbl_802E7908                         /* constant-address: 802E7908, symbol: lbl_802E7908 */
...
/* 802E7900  4B FF 74 71 */	bl setCharColor__7JUTFontFQ28JUtility6TColor /* constant-address: 802DED70, symbol: setCharColor__7JUTFontFQ28JUtility6TColor */
/* 802E7904  48 00 01 18 */	b lbl_802E7A1C                           /* constant-address: 802E7A1C, symbol: lbl_802E7A1C */
lbl_802E7908:
/* 802E7908  80 19 00 34 */	lwz r0, 0x34(r25)                       
/* 802E790C  7C 05 00 00 */	cmpw r5, r0                             
/* 802E7910  40 82 00 34 */	bne lbl_802E7944                         /* constant-address: 802E7944, symbol: lbl_802E7944 */
...
/* 802E793C  4B FF 74 35 */	bl setCharColor__7JUTFontFQ28JUtility6TColor /* constant-address: 802DED70, symbol: setCharColor__7JUTFontFQ28JUtility6TColor */
/* 802E7940  48 00 00 DC */	b lbl_802E7A1C                           /* constant-address: 802E7A1C, symbol: lbl_802E7A1C */
lbl_802E7944:
...
/* 802E796C  4B FF 74 05 */	bl setCharColor__7JUTFontFQ28JUtility6TColor /* constant-address: 802DED70, symbol: setCharColor__7JUTFontFQ28JUtility6TColor */
/* 802E7970  48 00 00 AC */	b lbl_802E7A1C                           /* constant-address: 802E7A1C, symbol: lbl_802E7A1C */
lbl_802E7974:
...
/* 802E799C  4B FF 73 D5 */	bl setCharColor__7JUTFontFQ28JUtility6TColor /* constant-address: 802DED70, symbol: setCharColor__7JUTFontFQ28JUtility6TColor */
/* 802E79A0  48 00 00 7C */	b lbl_802E7A1C                           /* constant-address: 802E7A1C, symbol: lbl_802E7A1C */
lbl_802E79A4:
/* 802E79A4  80 6D 8F A8 */	lwz r3, sDirectPrint__14JUTDirectPrint(r13) /* constant-address: 80451528, symbol: sDirectPrint__14JUTDirectPrint */
...
/* 802E79C4  C8 22 C7 38 */	lfd f1, lit_2469(r2)                     /* constant-address: 80456138, symbol: lit_2469 */
...
/* 802E79F0  4B FF C8 99 */	bl erase__14JUTDirectPrintFiiii          /* constant-address: 802E4288, symbol: erase__14JUTDirectPrintFiiii */
...
/* 802E7A10  80 6D 8F A8 */	lwz r3, sDirectPrint__14JUTDirectPrint(r13) /* constant-address: 80451528, symbol: sDirectPrint__14JUTDirectPrint */
/* 802E7A14  38 81 00 0C */	addi r4, r1, 0xc                        
/* 802E7A18  4B FF CD 81 */	bl setCharColor__14JUTDirectPrintFQ28JUtility6TColor /* constant-address: 802E4798, symbol: setCharColor__14JUTDirectPrintFQ28JUtility6TColor */
lbl_802E7A1C:
...
/* 802E7A54  41 82 01 24 */	beq lbl_802E7B78                         /* constant-address: 802E7B78, symbol: lbl_802E7B78 */
/* 802E7A58  2C 1A 00 02 */	cmpwi r26, 2                            
/* 802E7A5C  41 82 00 94 */	beq lbl_802E7AF0                         /* constant-address: 802E7AF0, symbol: lbl_802E7AF0 */
/* 802E7A60  C3 79 00 54 */	lfs f27, 0x54(r25)                      
/* 802E7A64  C3 99 00 50 */	lfs f28, 0x50(r25)                      
/* 802E7A68  80 19 00 44 */	lwz r0, 0x44(r25)                       
/* 802E7A6C  C8 42 C7 40 */	lfd f2, lit_2471(r2)                     /* constant-address: 80456140, symbol: lit_2471 */
...
/* 802E7AC4  48 08 11 21 */	bl strlen                                /* constant-address: 80368BE4, symbol: strlen */
...
/* 802E7AE8  4B FF 73 41 */	bl drawString_size_scale__7JUTFontFffffPCcUlb /* constant-address: 802DEE28, symbol: drawString_size_scale__7JUTFontFffffPCcUlb */
/* 802E7AEC  48 00 00 60 */	b lbl_802E7B4C                           /* constant-address: 802E7B4C, symbol: lbl_802E7B4C */
lbl_802E7AF0:
/* 802E7AF0  80 6D 8F A8 */	lwz r3, sDirectPrint__14JUTDirectPrint(r13) /* constant-address: 80451528, symbol: sDirectPrint__14JUTDirectPrint */
/* 802E7AF4  80 19 00 40 */	lwz r0, 0x40(r25)                       
/* 802E7AF8  54 04 04 3E */	clrlwi r4, r0, 0x10                     
/* 802E7AFC  80 19 00 44 */	lwz r0, 0x44(r25)                       
/* 802E7B00  C8 42 C7 40 */	lfd f2, lit_2471(r2)                     /* constant-address: 80456140, symbol: lit_2471 */
...
/* 802E7B48  4B FF CB 91 */	bl drawString__14JUTDirectPrintFUsUsPc   /* constant-address: 802E46D8, symbol: drawString__14JUTDirectPrintFUsUsPc */
lbl_802E7B4C:
...
/* 802E7B64  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
/* 802E7B68  7C 1B B8 40 */	cmplw r27, r23                          
/* 802E7B6C  40 80 00 0C */	bge lbl_802E7B78                         /* constant-address: 802E7B78, symbol: lbl_802E7B78 */
/* 802E7B70  7C 00 C0 00 */	cmpw r0, r24                            
/* 802E7B74  40 82 FE CC */	bne lbl_802E7A40                         /* constant-address: 802E7A40, symbol: lbl_802E7A40 */
lbl_802E7B78:
...
/* 802E7BA4  48 07 A6 61 */	bl _restgpr_20                           /* constant-address: 80362204, symbol: _restgpr_20 */

...
/* 802E1248  48 08 0F 95 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802E124C  7C 7D 1B 78 */	mr r29, r3                              
/* 802E1250  7C FE 3B 78 */	mr r30, r7                              
/* 802E1254  7D 1F 43 78 */	mr r31, r8                              
/* 802E1258  80 0D 83 5C */	lwz r0, sClampMode__10JUTGamePad(r13)    /* constant-address: 804508DC, symbol: sClampMode__10JUTGamePad */
/* 802E125C  2C 00 00 02 */	cmpwi r0, 2                             
/* 802E1260  41 82 00 2C */	beq lbl_802E128C                         /* constant-address: 802E128C, symbol: lbl_802E128C */
/* 802E1264  40 80 00 40 */	bge lbl_802E12A4                         /* constant-address: 802E12A4, symbol: lbl_802E12A4 */
/* 802E1268  2C 00 00 01 */	cmpwi r0, 1                             
/* 802E126C  40 80 00 08 */	bge lbl_802E1274                         /* constant-address: 802E1274, symbol: lbl_802E1274 */
/* 802E1270  48 00 00 34 */	b lbl_802E12A4                           /* constant-address: 802E12A4, symbol: lbl_802E12A4 */
lbl_802E1274:
/* 802E1274  2C 1E 00 00 */	cmpwi r30, 0                            
/* 802E1278  38 00 00 2A */	li r0, 0x2a                             
/* 802E127C  40 82 00 08 */	bne lbl_802E1284                         /* constant-address: 802E1284, symbol: lbl_802E1284 */
/* 802E1280  38 00 00 36 */	li r0, 0x36                             
lbl_802E1284:
/* 802E1284  7C 03 03 78 */	mr r3, r0                               
/* 802E1288  48 00 00 30 */	b lbl_802E12B8                           /* constant-address: 802E12B8, symbol: lbl_802E12B8 */
lbl_802E128C:
/* 802E128C  2C 1E 00 00 */	cmpwi r30, 0                            
/* 802E1290  38 00 00 1D */	li r0, 0x1d                             
/* 802E1294  40 82 00 08 */	bne lbl_802E129C                         /* constant-address: 802E129C, symbol: lbl_802E129C */
/* 802E1298  38 00 00 26 */	li r0, 0x26                             
lbl_802E129C:
/* 802E129C  7C 03 03 78 */	mr r3, r0                               
/* 802E12A0  48 00 00 18 */	b lbl_802E12B8                           /* constant-address: 802E12B8, symbol: lbl_802E12B8 */
lbl_802E12A4:
/* 802E12A4  2C 1E 00 00 */	cmpwi r30, 0                            
/* 802E12A8  38 00 00 39 */	li r0, 0x39                             
/* 802E12AC  40 82 00 08 */	bne lbl_802E12B4                         /* constant-address: 802E12B4, symbol: lbl_802E12B4 */
...
/* 802E12C4  C8 42 C6 20 */	lfd f2, lit_1050(r2)                     /* constant-address: 80456020, symbol: lit_1050 */
...
/* 802E1340  C0 02 C6 28 */	lfs f0, lit_1056(r2)                     /* constant-address: 80456028, symbol: lit_1056 */
/* 802E1344  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 802E1348  40 81 00 58 */	ble lbl_802E13A0                         /* constant-address: 802E13A0, symbol: lbl_802E13A0 */
/* 802E134C  FC 00 20 34 */	frsqrte f0, f4                          
/* 802E1350  C8 62 C6 30 */	lfd f3, lit_1117(r2)                     /* constant-address: 80456030, symbol: lit_1117 */
/* 802E1354  FC 23 00 32 */	fmul f1, f3, f0                         
/* 802E1358  C8 42 C6 38 */	lfd f2, lit_1118(r2)                     /* constant-address: 80456038, symbol: lit_1118 */
...
/* 802E139C  48 00 00 88 */	b lbl_802E1424                           /* constant-address: 802E1424, symbol: lbl_802E1424 */
lbl_802E13A0:
/* 802E13A0  C8 02 C6 40 */	lfd f0, lit_1119(r2)                     /* constant-address: 80456040, symbol: lit_1119 */
/* 802E13A4  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 802E13A8  40 80 00 10 */	bge lbl_802E13B8                         /* constant-address: 802E13B8, symbol: lbl_802E13B8 */
/* 802E13AC  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 802E13B0  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 802E13B4  48 00 00 70 */	b lbl_802E1424                           /* constant-address: 802E1424, symbol: lbl_802E1424 */
lbl_802E13B8:
...
/* 802E13CC  41 82 00 14 */	beq lbl_802E13E0                         /* constant-address: 802E13E0, symbol: lbl_802E13E0 */
/* 802E13D0  40 80 00 40 */	bge lbl_802E1410                         /* constant-address: 802E1410, symbol: lbl_802E1410 */
/* 802E13D4  2C 03 00 00 */	cmpwi r3, 0                             
/* 802E13D8  41 82 00 20 */	beq lbl_802E13F8                         /* constant-address: 802E13F8, symbol: lbl_802E13F8 */
/* 802E13DC  48 00 00 34 */	b lbl_802E1410                           /* constant-address: 802E1410, symbol: lbl_802E1410 */
lbl_802E13E0:
/* 802E13E0  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 802E13E4  41 82 00 0C */	beq lbl_802E13F0                         /* constant-address: 802E13F0, symbol: lbl_802E13F0 */
/* 802E13E8  38 00 00 01 */	li r0, 1                                
/* 802E13EC  48 00 00 28 */	b lbl_802E1414                           /* constant-address: 802E1414, symbol: lbl_802E1414 */
lbl_802E13F0:
/* 802E13F0  38 00 00 02 */	li r0, 2                                
/* 802E13F4  48 00 00 20 */	b lbl_802E1414                           /* constant-address: 802E1414, symbol: lbl_802E1414 */
lbl_802E13F8:
/* 802E13F8  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 802E13FC  41 82 00 0C */	beq lbl_802E1408                         /* constant-address: 802E1408, symbol: lbl_802E1408 */
/* 802E1400  38 00 00 05 */	li r0, 5                                
/* 802E1404  48 00 00 10 */	b lbl_802E1414                           /* constant-address: 802E1414, symbol: lbl_802E1414 */
lbl_802E1408:
/* 802E1408  38 00 00 03 */	li r0, 3                                
/* 802E140C  48 00 00 08 */	b lbl_802E1414                           /* constant-address: 802E1414, symbol: lbl_802E1414 */
lbl_802E1410:
/* 802E1410  38 00 00 04 */	li r0, 4                                
lbl_802E1414:
/* 802E1414  2C 00 00 01 */	cmpwi r0, 1                             
/* 802E1418  40 82 00 0C */	bne lbl_802E1424                         /* constant-address: 802E1424, symbol: lbl_802E1424 */
/* 802E141C  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 802E1420  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_802E1424:
/* 802E1424  D0 9D 00 08 */	stfs f4, 8(r29)                         
/* 802E1428  C0 3D 00 08 */	lfs f1, 8(r29)                          
/* 802E142C  C0 02 C6 48 */	lfs f0, lit_1120(r2)                     /* constant-address: 80456048, symbol: lit_1120 */
/* 802E1430  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802E1434  40 81 00 30 */	ble lbl_802E1464                         /* constant-address: 802E1464, symbol: lbl_802E1464 */
/* 802E1438  2C 06 00 01 */	cmpwi r6, 1                             
/* 802E143C  40 82 00 20 */	bne lbl_802E145C                         /* constant-address: 802E145C, symbol: lbl_802E145C */
...
lbl_802E145C:
/* 802E145C  C0 02 C6 48 */	lfs f0, lit_1120(r2)                     /* constant-address: 80456048, symbol: lit_1120 */
/* 802E1460  D0 1D 00 08 */	stfs f0, 8(r29)                         
lbl_802E1464:
/* 802E1464  C0 1D 00 08 */	lfs f0, 8(r29)                          
/* 802E1468  C0 22 C6 28 */	lfs f1, lit_1056(r2)                     /* constant-address: 80456028, symbol: lit_1056 */
/* 802E146C  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 802E1470  40 81 00 5C */	ble lbl_802E14CC                         /* constant-address: 802E14CC, symbol: lbl_802E14CC */
/* 802E1474  C0 1D 00 04 */	lfs f0, 4(r29)                          
/* 802E1478  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 802E147C  40 82 00 28 */	bne lbl_802E14A4                         /* constant-address: 802E14A4, symbol: lbl_802E14A4 */
/* 802E1480  C0 1D 00 00 */	lfs f0, 0(r29)                          
/* 802E1484  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 802E1488  40 81 00 10 */	ble lbl_802E1498                         /* constant-address: 802E1498, symbol: lbl_802E1498 */
/* 802E148C  38 00 40 00 */	li r0, 0x4000                           
/* 802E1490  B0 1D 00 0C */	sth r0, 0xc(r29)                        
/* 802E1494  48 00 00 38 */	b lbl_802E14CC                           /* constant-address: 802E14CC, symbol: lbl_802E14CC */
lbl_802E1498:
/* 802E1498  38 00 C0 00 */	li r0, -16384                           
/* 802E149C  B0 1D 00 0C */	sth r0, 0xc(r29)                        
/* 802E14A0  48 00 00 2C */	b lbl_802E14CC                           /* constant-address: 802E14CC, symbol: lbl_802E14CC */
lbl_802E14A4:
/* 802E14A4  C0 3D 00 00 */	lfs f1, 0(r29)                          
/* 802E14A8  FC 40 00 50 */	fneg f2, f0                             
/* 802E14AC  48 08 B2 75 */	bl atan2                                 /* constant-address: 8036C720, symbol: atan2 */
/* 802E14B0  FC 20 08 18 */	frsp f1, f1                             
/* 802E14B4  C0 02 C6 4C */	lfs f0, lit_1121(r2)                     /* constant-address: 8045604C, symbol: lit_1121 */
...
/* 802E14D8  40 82 00 08 */	bne lbl_802E14E0                         /* constant-address: 802E14E0, symbol: lbl_802E14E0 */
/* 802E14DC  38 00 00 18 */	li r0, 0x18                             
lbl_802E14E0:
/* 802E14E0  7F E4 04 30 */	srw r4, r31, r0                         
/* 802E14E4  48 00 00 1D */	bl getButton__Q210JUTGamePad6CStickFUl   /* constant-address: 802E1500, symbol: getButton__Q210JUTGamePad6CStickFUl */
/* 802E14E8  39 61 00 40 */	addi r11, r1, 0x40                      
/* 802E14EC  48 08 0D 3D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

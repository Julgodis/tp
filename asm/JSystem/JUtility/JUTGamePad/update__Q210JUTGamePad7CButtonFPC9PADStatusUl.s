...
/* 802E1094  41 82 00 0C */	beq lbl_802E10A0                         /* constant-address: 802E10A0, symbol: lbl_802E10A0 */
/* 802E1098  A0 04 00 00 */	lhz r0, 0(r4)                           
/* 802E109C  48 00 00 08 */	b lbl_802E10A4                           /* constant-address: 802E10A4, symbol: lbl_802E10A4 */
lbl_802E10A0:
...
/* 802E10B8  41 82 00 8C */	beq lbl_802E1144                         /* constant-address: 802E1144, symbol: lbl_802E1144 */
/* 802E10BC  80 03 00 24 */	lwz r0, 0x24(r3)                        
/* 802E10C0  28 00 00 00 */	cmplwi r0, 0                            
/* 802E10C4  41 82 00 80 */	beq lbl_802E1144                         /* constant-address: 802E1144, symbol: lbl_802E1144 */
/* 802E10C8  7C E8 00 39 */	and. r8, r7, r0                         
/* 802E10CC  90 A3 00 18 */	stw r5, 0x18(r3)                        
/* 802E10D0  40 82 00 10 */	bne lbl_802E10E0                         /* constant-address: 802E10E0, symbol: lbl_802E10E0 */
/* 802E10D4  90 A3 00 20 */	stw r5, 0x20(r3)                        
/* 802E10D8  90 A3 00 1C */	stw r5, 0x1c(r3)                        
/* 802E10DC  48 00 00 68 */	b lbl_802E1144                           /* constant-address: 802E1144, symbol: lbl_802E1144 */
lbl_802E10E0:
/* 802E10E0  80 C3 00 20 */	lwz r6, 0x20(r3)                        
/* 802E10E4  7C 06 40 40 */	cmplw r6, r8                            
/* 802E10E8  40 82 00 44 */	bne lbl_802E112C                         /* constant-address: 802E112C, symbol: lbl_802E112C */
...
/* 802E1104  41 82 00 20 */	beq lbl_802E1124                         /* constant-address: 802E1124, symbol: lbl_802E1124 */
/* 802E1108  40 81 00 3C */	ble lbl_802E1144                         /* constant-address: 802E1144, symbol: lbl_802E1144 */
...
/* 802E1120  40 82 00 24 */	bne lbl_802E1144                         /* constant-address: 802E1144, symbol: lbl_802E1144 */
lbl_802E1124:
/* 802E1124  91 03 00 18 */	stw r8, 0x18(r3)                        
/* 802E1128  48 00 00 1C */	b lbl_802E1144                           /* constant-address: 802E1144, symbol: lbl_802E1144 */
lbl_802E112C:
...
/* 802E118C  41 82 00 28 */	beq lbl_802E11B4                         /* constant-address: 802E11B4, symbol: lbl_802E11B4 */
...
/* 802E11B0  48 00 00 18 */	b lbl_802E11C8                           /* constant-address: 802E11C8, symbol: lbl_802E11C8 */
lbl_802E11B4:
...
/* 802E11CC  C8 42 C6 20 */	lfd f2, lit_1050(r2)                     /* constant-address: 80456020, symbol: lit_1050 */
...
/* 802E11E8  C0 22 C6 18 */	lfs f1, lit_1047(r2)                     /* constant-address: 80456018, symbol: lit_1047 */

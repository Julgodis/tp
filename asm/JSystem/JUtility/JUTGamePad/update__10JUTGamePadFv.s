...
/* 802E0CE8  48 08 14 F1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 802E0CEC  7C 7E 1B 78 */	mr r30, r3                              
/* 802E0CF0  3C 60 80 43 */	lis r3, lit_525@ha                      
/* 802E0CF4  38 63 43 D8 */	addi r3, r3, lit_525@l                   /* constant-address: 804343D8, symbol: lit_525 */
/* 802E0CF8  A8 9E 00 7C */	lha r4, 0x7c(r30)                       
/* 802E0CFC  2C 04 FF FF */	cmpwi r4, -1                            
/* 802E0D00  41 82 02 8C */	beq lbl_802E0F8C                         /* constant-address: 802E0F8C, symbol: lbl_802E0F8C */
/* 802E0D04  7C 80 07 35 */	extsh. r0, r4                           
/* 802E0D08  41 80 01 28 */	blt lbl_802E0E30                         /* constant-address: 802E0E30, symbol: lbl_802E0E30 */
/* 802E0D0C  2C 04 00 04 */	cmpwi r4, 4                             
/* 802E0D10  40 80 01 20 */	bge lbl_802E0E30                         /* constant-address: 802E0E30, symbol: lbl_802E0E30 */
/* 802E0D14  1C 04 00 30 */	mulli r0, r4, 0x30                      
/* 802E0D18  38 83 00 48 */	addi r4, r3, 0x48                        /* constant-address: 80434420, symbol: mPadButton__10JUTGamePad */
...
/* 802E0DA0  38 83 01 08 */	addi r4, r3, 0x108                       /* constant-address: 804344E0, symbol: mPadMStick__10JUTGamePad */
...
/* 802E0DE0  38 83 01 48 */	addi r4, r3, 0x148                       /* constant-address: 80434520, symbol: mPadSStick__10JUTGamePad */
...
/* 802E0E18  38 63 00 18 */	addi r3, r3, 0x18                        /* constant-address: 804343F0, symbol: mPadStatus__10JUTGamePad */
...
/* 802E0E38  41 82 00 1C */	beq lbl_802E0E54                         /* constant-address: 802E0E54, symbol: lbl_802E0E54 */
/* 802E0E3C  80 8D 83 68 */	lwz r4, sResetPattern__Q210JUTGamePad13C3ButtonReset(r13) /* constant-address: 804508E8, symbol: sResetPattern__Q210JUTGamePad13C3ButtonReset */
/* 802E0E40  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 802E0E44  80 0D 83 6C */	lwz r0, sResetMaskPattern__Q210JUTGamePad13C3ButtonReset(r13) /* constant-address: 804508EC, symbol: sResetMaskPattern__Q210JUTGamePad13C3ButtonReset */
/* 802E0E48  7C 60 00 38 */	and r0, r3, r0                          
/* 802E0E4C  7C 04 00 40 */	cmplw r4, r0                            
/* 802E0E50  41 82 00 10 */	beq lbl_802E0E60                         /* constant-address: 802E0E60, symbol: lbl_802E0E60 */
lbl_802E0E54:
/* 802E0E54  38 00 00 00 */	li r0, 0                                
/* 802E0E58  98 1E 00 98 */	stb r0, 0x98(r30)                       
/* 802E0E5C  48 00 00 50 */	b lbl_802E0EAC                           /* constant-address: 802E0EAC, symbol: lbl_802E0EAC */
lbl_802E0E60:
/* 802E0E60  88 0D 8F 81 */	lbz r0, struct_80451500+0x1(r13)         /* constant-address: 80451501, symbol: struct_80451500+0x1 */
/* 802E0E64  28 00 00 00 */	cmplwi r0, 0                            
/* 802E0E68  40 82 00 44 */	bne lbl_802E0EAC                         /* constant-address: 802E0EAC, symbol: lbl_802E0EAC */
/* 802E0E6C  88 1E 00 98 */	lbz r0, 0x98(r30)                       
/* 802E0E70  28 00 00 01 */	cmplwi r0, 1                            
/* 802E0E74  40 82 00 24 */	bne lbl_802E0E98                         /* constant-address: 802E0E98, symbol: lbl_802E0E98 */
/* 802E0E78  48 06 18 85 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 802E0E90  4B FF FD DD */	bl checkResetCallback__10JUTGamePadFx    /* constant-address: 802E0C6C, symbol: checkResetCallback__10JUTGamePadFx */
/* 802E0E94  48 00 00 18 */	b lbl_802E0EAC                           /* constant-address: 802E0EAC, symbol: lbl_802E0EAC */
lbl_802E0E98:
/* 802E0E98  38 00 00 01 */	li r0, 1                                
/* 802E0E9C  98 1E 00 98 */	stb r0, 0x98(r30)                       
/* 802E0EA0  48 06 18 5D */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 802E0EB0  83 E3 45 6C */	lwz r31, sPatternList__19JUTGamePadLongPress@l(r3) /* constant-address: 8043456C, symbol: sPatternList__19JUTGamePadLongPress */
/* 802E0EB4  48 00 00 B4 */	b lbl_802E0F68                           /* constant-address: 802E0F68, symbol: lbl_802E0F68 */
lbl_802E0EB8:
/* 802E0EB8  83 9F 00 00 */	lwz r28, 0(r31)                         
/* 802E0EBC  88 1C 00 10 */	lbz r0, 0x10(r28)                       
/* 802E0EC0  28 00 00 00 */	cmplwi r0, 0                            
/* 802E0EC4  41 82 00 A0 */	beq lbl_802E0F64                         /* constant-address: 802E0F64, symbol: lbl_802E0F64 */
/* 802E0EC8  AB BE 00 7C */	lha r29, 0x7c(r30)                      
/* 802E0ECC  7F A0 07 35 */	extsh. r0, r29                          
/* 802E0ED0  41 80 00 94 */	blt lbl_802E0F64                         /* constant-address: 802E0F64, symbol: lbl_802E0F64 */
/* 802E0ED4  2C 1D 00 04 */	cmpwi r29, 4                            
/* 802E0ED8  40 80 00 8C */	bge lbl_802E0F64                         /* constant-address: 802E0F64, symbol: lbl_802E0F64 */
...
/* 802E0EF0  40 82 00 68 */	bne lbl_802E0F58                         /* constant-address: 802E0F58, symbol: lbl_802E0F58 */
/* 802E0EF4  38 7D 00 20 */	addi r3, r29, 0x20                      
/* 802E0EF8  7C 1C 18 AE */	lbzx r0, r28, r3                        
/* 802E0EFC  28 00 00 01 */	cmplwi r0, 1                            
/* 802E0F00  40 82 00 2C */	bne lbl_802E0F2C                         /* constant-address: 802E0F2C, symbol: lbl_802E0F2C */
/* 802E0F04  48 06 17 F9 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 802E0F24  48 00 0B D9 */	bl checkCallback__19JUTGamePadLongPressFiUl /* constant-address: 802E1AFC, symbol: checkCallback__19JUTGamePadLongPressFiUl */
/* 802E0F28  48 00 00 3C */	b lbl_802E0F64                           /* constant-address: 802E0F64, symbol: lbl_802E0F64 */
lbl_802E0F2C:
/* 802E0F2C  38 00 00 01 */	li r0, 1                                
/* 802E0F30  7C 1C 19 AE */	stbx r0, r28, r3                        
/* 802E0F34  83 BF 00 00 */	lwz r29, 0(r31)                         
/* 802E0F38  48 06 17 C5 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 802E0F54  48 00 00 10 */	b lbl_802E0F64                           /* constant-address: 802E0F64, symbol: lbl_802E0F64 */
lbl_802E0F58:
...
/* 802E0F6C  40 82 FF 4C */	bne lbl_802E0EB8                         /* constant-address: 802E0EB8, symbol: lbl_802E0EB8 */
/* 802E0F70  A8 9E 00 7C */	lha r4, 0x7c(r30)                       
/* 802E0F74  7C 80 07 35 */	extsh. r0, r4                           
/* 802E0F78  41 80 00 14 */	blt lbl_802E0F8C                         /* constant-address: 802E0F8C, symbol: lbl_802E0F8C */
/* 802E0F7C  2C 04 00 04 */	cmpwi r4, 4                             
/* 802E0F80  40 80 00 0C */	bge lbl_802E0F8C                         /* constant-address: 802E0F8C, symbol: lbl_802E0F8C */
/* 802E0F84  38 7E 00 68 */	addi r3, r30, 0x68                      
/* 802E0F88  48 00 07 99 */	bl update__Q210JUTGamePad7CRumbleFs      /* constant-address: 802E1720, symbol: update__Q210JUTGamePad7CRumbleFs */
lbl_802E0F8C:
/* 802E0F8C  39 61 00 20 */	addi r11, r1, 0x20                      
/* 802E0F90  48 08 12 95 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

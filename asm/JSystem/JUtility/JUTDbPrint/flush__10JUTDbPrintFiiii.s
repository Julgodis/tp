...
/* 802E02EC  48 08 1E ED */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802E0304  41 82 01 24 */	beq lbl_802E0428                         /* constant-address: 802E0428, symbol: lbl_802E0428 */
/* 802E0308  28 1E 00 00 */	cmplwi r30, 0                           
/* 802E030C  41 82 01 1C */	beq lbl_802E0428                         /* constant-address: 802E0428, symbol: lbl_802E0428 */
/* 802E0310  38 61 00 0C */	addi r3, r1, 0xc                        
/* 802E0314  C8 82 C6 10 */	lfd f4, lit_838(r2)                      /* constant-address: 80456010, symbol: lit_838 */
...
/* 802E036C  C0 A2 C6 08 */	lfs f5, lit_835(r2)                      /* constant-address: 80456008, symbol: lit_835 */
/* 802E0370  C0 C2 C6 0C */	lfs f6, lit_836(r2)                      /* constant-address: 8045600C, symbol: lit_836 */
/* 802E0374  48 00 93 5D */	bl __ct__13J2DOrthoGraphFffffff          /* constant-address: 802E96D0, symbol: __ct__13J2DOrthoGraphFffffff */
/* 802E0378  38 61 00 0C */	addi r3, r1, 0xc                        
/* 802E037C  48 00 94 39 */	bl setPort__13J2DOrthoGraphFv            /* constant-address: 802E97B4, symbol: setPort__13J2DOrthoGraphFv */
...
/* 802E03A4  4B FF E9 CD */	bl setCharColor__7JUTFontFQ28JUtility6TColor /* constant-address: 802DED70, symbol: setCharColor__7JUTFontFQ28JUtility6TColor */
/* 802E03A8  48 00 00 60 */	b lbl_802E0408                           /* constant-address: 802E0408, symbol: lbl_802E0408 */
lbl_802E03AC:
/* 802E03AC  88 1C 00 0C */	lbz r0, 0xc(r28)                        
/* 802E03B0  28 00 00 00 */	cmplwi r0, 0                            
/* 802E03B4  41 82 00 1C */	beq lbl_802E03D0                         /* constant-address: 802E03D0, symbol: lbl_802E03D0 */
...
/* 802E03CC  48 00 00 75 */	bl drawString__10JUTDbPrintFiiiPCUc      /* constant-address: 802E0440, symbol: drawString__10JUTDbPrintFiiiPCUc */
lbl_802E03D0:
...
/* 802E03E0  41 81 00 20 */	bgt lbl_802E0400                         /* constant-address: 802E0400, symbol: lbl_802E0400 */
/* 802E03E4  83 BE 00 00 */	lwz r29, 0(r30)                         
/* 802E03E8  7F C3 F3 78 */	mr r3, r30                              
/* 802E03EC  80 9C 00 10 */	lwz r4, 0x10(r28)                       
/* 802E03F0  4B FE E1 11 */	bl free__7JKRHeapFPvP7JKRHeap            /* constant-address: 802CE500, symbol: free__7JKRHeapFPvP7JKRHeap */
/* 802E03F4  7F BE EB 78 */	mr r30, r29                             
/* 802E03F8  93 BF 00 00 */	stw r29, 0(r31)                         
/* 802E03FC  48 00 00 0C */	b lbl_802E0408                           /* constant-address: 802E0408, symbol: lbl_802E0408 */
lbl_802E0400:
/* 802E0400  7F DF F3 78 */	mr r31, r30                             
/* 802E0404  83 DE 00 00 */	lwz r30, 0(r30)                         
lbl_802E0408:
/* 802E0408  28 1E 00 00 */	cmplwi r30, 0                           
/* 802E040C  40 82 FF A0 */	bne lbl_802E03AC                         /* constant-address: 802E03AC, symbol: lbl_802E03AC */
/* 802E0410  3C 60 80 3D */	lis r3, __vt__13J2DOrthoGraph@ha        
/* 802E0414  38 03 C9 E0 */	addi r0, r3, __vt__13J2DOrthoGraph@l     /* constant-address: 803CC9E0, symbol: __vt__13J2DOrthoGraph */
/* 802E0418  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 802E041C  3C 60 80 3D */	lis r3, __vt__14J2DGrafContext@ha       
/* 802E0420  38 03 C9 B8 */	addi r0, r3, __vt__14J2DGrafContext@l    /* constant-address: 803CC9B8, symbol: __vt__14J2DGrafContext */
/* 802E0424  90 01 00 0C */	stw r0, 0xc(r1)                         
lbl_802E0428:
/* 802E0428  39 61 01 10 */	addi r11, r1, 0x110                     
/* 802E042C  48 08 1D F9 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 802A91C8  48 0B 90 11 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802A91EC  38 82 BE 18 */	la r4, ga4cSignature__Q28JMessage4data(r2) /* 80455818-_SDA2_BASE_ */ /* constant-address: 80455818, symbol: ga4cSignature__Q28JMessage4data */
/* 802A91F0  38 A0 00 04 */	li r5, 4                                
/* 802A91F4  48 0B CE 99 */	bl memcmp                                /* constant-address: 8036608C, symbol: memcmp */
/* 802A91F8  2C 03 00 00 */	cmpwi r3, 0                             
/* 802A91FC  41 82 00 0C */	beq lbl_802A9208                         /* constant-address: 802A9208, symbol: lbl_802A9208 */
/* 802A9200  38 60 00 00 */	li r3, 0                                
/* 802A9204  48 00 00 D8 */	b lbl_802A92DC                           /* constant-address: 802A92DC, symbol: lbl_802A92DC */
lbl_802A9208:
/* 802A9208  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 802A920C  3C 03 9D 93 */	addis r0, r3, 0x9d93                    
/* 802A9210  28 00 67 31 */	cmplwi r0, 0x6731                       
/* 802A9214  41 82 00 0C */	beq lbl_802A9220                         /* constant-address: 802A9220, symbol: lbl_802A9220 */
/* 802A9218  38 60 00 00 */	li r3, 0                                
/* 802A921C  48 00 00 C0 */	b lbl_802A92DC                           /* constant-address: 802A92DC, symbol: lbl_802A92DC */
lbl_802A9220:
/* 802A9220  88 9E 00 10 */	lbz r4, 0x10(r30)                       
/* 802A9224  28 04 00 00 */	cmplwi r4, 0                            
/* 802A9228  41 82 00 3C */	beq lbl_802A9264                         /* constant-address: 802A9264, symbol: lbl_802A9264 */
...
/* 802A9240  41 82 00 0C */	beq lbl_802A924C                         /* constant-address: 802A924C, symbol: lbl_802A924C */
/* 802A9244  28 05 00 00 */	cmplwi r5, 0                            
/* 802A9248  40 82 00 08 */	bne lbl_802A9250                         /* constant-address: 802A9250, symbol: lbl_802A9250 */
lbl_802A924C:
/* 802A924C  38 00 00 01 */	li r0, 1                                
lbl_802A9250:
/* 802A9250  54 00 06 3F */	clrlwi. r0, r0, 0x18                    
/* 802A9254  40 82 00 0C */	bne lbl_802A9260                         /* constant-address: 802A9260, symbol: lbl_802A9260 */
/* 802A9258  38 60 00 00 */	li r3, 0                                
/* 802A925C  48 00 00 80 */	b lbl_802A92DC                           /* constant-address: 802A92DC, symbol: lbl_802A92DC */
lbl_802A9260:
/* 802A9260  4B FF FE 59 */	bl setEncoding__Q28JMessage18TResourceContainerFUc /* constant-address: 802A90B8, symbol: setEncoding__Q28JMessage18TResourceContainerFUc */
lbl_802A9264:
/* 802A9264  57 80 06 F7 */	rlwinm. r0, r28, 0, 0x1b, 0x1b          
/* 802A9268  41 82 00 0C */	beq lbl_802A9274                         /* constant-address: 802A9274, symbol: lbl_802A9274 */
/* 802A926C  38 60 00 01 */	li r3, 1                                
/* 802A9270  48 00 00 6C */	b lbl_802A92DC                           /* constant-address: 802A92DC, symbol: lbl_802A92DC */
lbl_802A9274:
...
/* 802A929C  40 82 00 0C */	bne lbl_802A92A8                         /* constant-address: 802A92A8, symbol: lbl_802A92A8 */
/* 802A92A0  57 83 DF FE */	rlwinm r3, r28, 0x1b, 0x1f, 0x1f        
/* 802A92A4  48 00 00 38 */	b lbl_802A92DC                           /* constant-address: 802A92DC, symbol: lbl_802A92DC */
lbl_802A92A8:
...
/* 802A92CC  48 03 38 DD */	bl Insert__Q27JGadget13TNodeLinkListFQ37JGadget13TNodeLinkList8iteratorPQ27JGadget13TLinkListNode /* constant-address: 802DCBA8, symbol: Insert__Q27JGadget13TNodeLinkListFQ37JGadget13TNodeLinkList8iteratorPQ27JGadget13TLinkListNode */
...
/* 802A92E0  48 0B 8F 45 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

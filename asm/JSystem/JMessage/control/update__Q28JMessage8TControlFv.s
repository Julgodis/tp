...
/* 802A7654  41 82 00 14 */	beq lbl_802A7668                         /* constant-address: 802A7668, symbol: lbl_802A7668 */
/* 802A7658  80 1F 00 04 */	lwz r0, 4(r31)                          
/* 802A765C  28 00 00 00 */	cmplwi r0, 0                            
/* 802A7660  41 82 00 08 */	beq lbl_802A7668                         /* constant-address: 802A7668, symbol: lbl_802A7668 */
/* 802A7664  38 60 00 01 */	li r3, 1                                
lbl_802A7668:
/* 802A7668  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A766C  40 82 00 0C */	bne lbl_802A7678                         /* constant-address: 802A7678, symbol: lbl_802A7678 */
/* 802A7670  38 60 00 00 */	li r3, 0                                
/* 802A7674  48 00 00 34 */	b lbl_802A76A8                           /* constant-address: 802A76A8, symbol: lbl_802A76A8 */
lbl_802A7678:
/* 802A7678  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802A767C  38 80 00 00 */	li r4, 0                                
/* 802A7680  48 00 0D 99 */	bl process__Q28JMessage18TSequenceProcessorFPCc /* constant-address: 802A8418, symbol: process__Q28JMessage18TSequenceProcessorFPCc */
/* 802A7684  90 7F 00 1C */	stw r3, 0x1c(r31)                       
/* 802A7688  80 1F 00 1C */	lwz r0, 0x1c(r31)                       
/* 802A768C  28 00 00 00 */	cmplwi r0, 0                            
/* 802A7690  40 82 00 14 */	bne lbl_802A76A4                         /* constant-address: 802A76A4, symbol: lbl_802A76A4 */
/* 802A7694  38 00 00 00 */	li r0, 0                                
/* 802A7698  90 1F 00 18 */	stw r0, 0x18(r31)                       
/* 802A769C  38 60 00 00 */	li r3, 0                                
/* 802A76A0  48 00 00 08 */	b lbl_802A76A8                           /* constant-address: 802A76A8, symbol: lbl_802A76A8 */
lbl_802A76A4:

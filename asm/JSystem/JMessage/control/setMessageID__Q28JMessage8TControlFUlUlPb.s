...
/* 802A7904  48 0B A8 D5 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 802A7908  7C 7C 1B 78 */	mr r28, r3                              
/* 802A790C  83 C3 00 04 */	lwz r30, 4(r3)                          
/* 802A7910  28 1E 00 00 */	cmplwi r30, 0                           
/* 802A7914  41 82 00 08 */	beq lbl_802A791C                         /* constant-address: 802A791C, symbol: lbl_802A791C */
/* 802A7918  48 00 00 08 */	b lbl_802A7920                           /* constant-address: 802A7920, symbol: lbl_802A7920 */
lbl_802A791C:
/* 802A791C  83 DC 00 08 */	lwz r30, 8(r28)                         
lbl_802A7920:
/* 802A7920  7F C3 F3 78 */	mr r3, r30                              
/* 802A7924  48 00 03 B1 */	bl toMessageCode_messageID__Q28JMessage10TProcessorCFUlUlPb /* constant-address: 802A7CD4, symbol: toMessageCode_messageID__Q28JMessage10TProcessorCFUlUlPb */
/* 802A7928  7C 66 1B 78 */	mr r6, r3                               
/* 802A792C  3C 06 00 01 */	addis r0, r6, 1                         
/* 802A7930  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 802A7934  40 82 00 0C */	bne lbl_802A7940                         /* constant-address: 802A7940, symbol: lbl_802A7940 */
/* 802A7938  38 60 00 00 */	li r3, 0                                
/* 802A793C  48 00 00 CC */	b lbl_802A7A08                           /* constant-address: 802A7A08, symbol: lbl_802A7A08 */
lbl_802A7940:
...
/* 802A7950  48 00 00 D1 */	bl setMessageCode_inSequence___Q28JMessage8TControlFPCQ28JMessage10TProcessorUsUs /* constant-address: 802A7A20, symbol: setMessageCode_inSequence___Q28JMessage8TControlFPCQ28JMessage10TProcessorUsUs */
/* 802A7954  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A7958  40 82 00 0C */	bne lbl_802A7964                         /* constant-address: 802A7964, symbol: lbl_802A7964 */
/* 802A795C  38 60 00 00 */	li r3, 0                                
/* 802A7960  48 00 00 A8 */	b lbl_802A7A08                           /* constant-address: 802A7A08, symbol: lbl_802A7A08 */
lbl_802A7964:
/* 802A7964  38 60 00 00 */	li r3, 0                                
/* 802A7968  83 BC 00 18 */	lwz r29, 0x18(r28)                      
/* 802A796C  28 1D 00 00 */	cmplwi r29, 0                           
/* 802A7970  41 82 00 14 */	beq lbl_802A7984                         /* constant-address: 802A7984, symbol: lbl_802A7984 */
/* 802A7974  80 1C 00 04 */	lwz r0, 4(r28)                          
/* 802A7978  28 00 00 00 */	cmplwi r0, 0                            
/* 802A797C  41 82 00 08 */	beq lbl_802A7984                         /* constant-address: 802A7984, symbol: lbl_802A7984 */
/* 802A7980  38 60 00 01 */	li r3, 1                                
lbl_802A7984:
/* 802A7984  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A7988  41 82 00 7C */	beq lbl_802A7A04                         /* constant-address: 802A7A04, symbol: lbl_802A7A04 */
...
/* 802A79AC  38 03 82 8C */	addi r0, r3, process_onCharacterEnd_normal___Q28JMessage10TProcessorFPQ28JMessage10TProcessor@l /* constant-address: 802A828C, symbol: process_onCharacterEnd_normal___Q28JMessage10TProcessorFPQ28JMessage10TProcessor */
...
/* 802A7A0C  48 0B A8 19 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 802A77F8  48 0B A9 E1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802A7810  41 82 00 08 */	beq lbl_802A7818                         /* constant-address: 802A7818, symbol: lbl_802A7818 */
/* 802A7814  48 00 00 08 */	b lbl_802A781C                           /* constant-address: 802A781C, symbol: lbl_802A781C */
lbl_802A7818:
/* 802A7818  80 9C 00 08 */	lwz r4, 8(r28)                          
lbl_802A781C:
/* 802A781C  7F 83 E3 78 */	mr r3, r28                              
/* 802A7820  7C 05 03 78 */	mr r5, r0                               
/* 802A7824  48 00 01 FD */	bl setMessageCode_inSequence___Q28JMessage8TControlFPCQ28JMessage10TProcessorUsUs /* constant-address: 802A7A20, symbol: setMessageCode_inSequence___Q28JMessage8TControlFPCQ28JMessage10TProcessorUsUs */
/* 802A7828  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A782C  40 82 00 0C */	bne lbl_802A7838                         /* constant-address: 802A7838, symbol: lbl_802A7838 */
/* 802A7830  38 60 00 00 */	li r3, 0                                
/* 802A7834  48 00 00 A8 */	b lbl_802A78DC                           /* constant-address: 802A78DC, symbol: lbl_802A78DC */
lbl_802A7838:
/* 802A7838  38 60 00 00 */	li r3, 0                                
/* 802A783C  83 BC 00 18 */	lwz r29, 0x18(r28)                      
/* 802A7840  28 1D 00 00 */	cmplwi r29, 0                           
/* 802A7844  41 82 00 14 */	beq lbl_802A7858                         /* constant-address: 802A7858, symbol: lbl_802A7858 */
/* 802A7848  80 1C 00 04 */	lwz r0, 4(r28)                          
/* 802A784C  28 00 00 00 */	cmplwi r0, 0                            
/* 802A7850  41 82 00 08 */	beq lbl_802A7858                         /* constant-address: 802A7858, symbol: lbl_802A7858 */
/* 802A7854  38 60 00 01 */	li r3, 1                                
lbl_802A7858:
/* 802A7858  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802A785C  41 82 00 7C */	beq lbl_802A78D8                         /* constant-address: 802A78D8, symbol: lbl_802A78D8 */
...
/* 802A7880  38 03 82 8C */	addi r0, r3, process_onCharacterEnd_normal___Q28JMessage10TProcessorFPQ28JMessage10TProcessor@l /* constant-address: 802A828C, symbol: process_onCharacterEnd_normal___Q28JMessage10TProcessorFPQ28JMessage10TProcessor */
...
/* 802A78E0  48 0B A9 45 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

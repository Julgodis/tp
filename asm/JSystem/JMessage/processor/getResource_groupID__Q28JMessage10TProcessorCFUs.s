...
/* 802A7C74  41 82 00 1C */	beq lbl_802A7C90                         /* constant-address: 802A7C90, symbol: lbl_802A7C90 */
...
/* 802A7C88  40 82 00 08 */	bne lbl_802A7C90                         /* constant-address: 802A7C90, symbol: lbl_802A7C90 */
/* 802A7C8C  38 C0 00 01 */	li r6, 1                                
lbl_802A7C90:
/* 802A7C90  54 C0 06 3F */	clrlwi. r0, r6, 0x18                    
/* 802A7C94  41 82 00 08 */	beq lbl_802A7C9C                         /* constant-address: 802A7C9C, symbol: lbl_802A7C9C */
/* 802A7C98  48 00 00 28 */	b lbl_802A7CC0                           /* constant-address: 802A7CC0, symbol: lbl_802A7CC0 */
lbl_802A7C9C:
/* 802A7C9C  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802A7CA0  80 63 00 04 */	lwz r3, 4(r3)                           
/* 802A7CA4  28 03 00 00 */	cmplwi r3, 0                            
/* 802A7CA8  40 82 00 0C */	bne lbl_802A7CB4                         /* constant-address: 802A7CB4, symbol: lbl_802A7CB4 */
/* 802A7CAC  38 60 00 00 */	li r3, 0                                
/* 802A7CB0  48 00 00 0C */	b lbl_802A7CBC                           /* constant-address: 802A7CBC, symbol: lbl_802A7CBC */
lbl_802A7CB4:
/* 802A7CB4  38 63 00 08 */	addi r3, r3, 8                          
/* 802A7CB8  48 00 12 B5 */	bl Get_groupID__Q38JMessage18TResourceContainer10TCResourceFUs /* constant-address: 802A8F6C, symbol: Get_groupID__Q38JMessage18TResourceContainer10TCResourceFUs */
lbl_802A7CBC:

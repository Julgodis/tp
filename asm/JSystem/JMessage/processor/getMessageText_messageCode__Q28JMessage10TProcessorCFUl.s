...
/* 802A8C64  4B FF EF F1 */	bl getResource_groupID__Q28JMessage10TProcessorCFUs /* constant-address: 802A7C54, symbol: getResource_groupID__Q28JMessage10TProcessorCFUs */
/* 802A8C68  28 03 00 00 */	cmplwi r3, 0                            
/* 802A8C6C  40 82 00 0C */	bne lbl_802A8C78                         /* constant-address: 802A8C78, symbol: lbl_802A8C78 */
/* 802A8C70  38 80 00 00 */	li r4, 0                                
/* 802A8C74  48 00 00 30 */	b lbl_802A8CA4                           /* constant-address: 802A8CA4, symbol: lbl_802A8CA4 */
lbl_802A8C78:
...
/* 802A8C88  40 80 00 18 */	bge lbl_802A8CA0                         /* constant-address: 802A8CA0, symbol: lbl_802A8CA0 */
...
/* 802A8C9C  48 00 00 08 */	b lbl_802A8CA4                           /* constant-address: 802A8CA4, symbol: lbl_802A8CA4 */
lbl_802A8CA0:
/* 802A8CA0  38 80 00 00 */	li r4, 0                                
lbl_802A8CA4:
/* 802A8CA4  28 04 00 00 */	cmplwi r4, 0                            
/* 802A8CA8  40 82 00 0C */	bne lbl_802A8CB4                         /* constant-address: 802A8CB4, symbol: lbl_802A8CB4 */
/* 802A8CAC  38 60 00 00 */	li r3, 0                                
/* 802A8CB0  48 00 00 14 */	b lbl_802A8CC4                           /* constant-address: 802A8CC4, symbol: lbl_802A8CC4 */
lbl_802A8CB4:
/* 802A8CB4  80 7E 00 08 */	lwz r3, 8(r30)                          
/* 802A8CB8  80 63 00 10 */	lwz r3, 0x10(r3)                        
/* 802A8CBC  80 04 00 00 */	lwz r0, 0(r4)                            /* constant-address: 00000000 */

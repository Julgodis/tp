...
/* 8031C568  48 04 5C 71 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031C56C  7C 7E 1B 78 */	mr r30, r3                              
/* 8031C570  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C584  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C5A4  41 82 00 0C */	beq lbl_8031C5B0                         /* constant-address: 8031C5B0, symbol: lbl_8031C5B0 */
/* 8031C5A8  7F 83 E3 78 */	mr r3, r28                              
/* 8031C5AC  48 00 79 E9 */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C5B0:
/* 8031C5B0  3B 9C 00 01 */	addi r28, r28, 1                        
/* 8031C5B4  28 1C 00 02 */	cmplwi r28, 2                           
/* 8031C5B8  3B BD 00 02 */	addi r29, r29, 2                        
/* 8031C5BC  41 80 FF D8 */	blt lbl_8031C594                         /* constant-address: 8031C594, symbol: lbl_8031C594 */
...
/* 8031C5DC  4B FF 2B 2D */	bl J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID /* constant-address: 8030F108, symbol: J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID */
...
/* 8031C5EC  38 03 4C 2C */	addi r0, r3, sTexCoordScaleTable__6J3DSys@l /* constant-address: 80434C2C, symbol: sTexCoordScaleTable__6J3DSys */
...
/* 8031C628  4B FF 1C 0D */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
...
/* 8031C638  38 03 4C 2C */	addi r0, r3, sTexCoordScaleTable__6J3DSys@l /* constant-address: 80434C2C, symbol: sTexCoordScaleTable__6J3DSys */
...
/* 8031C678  4B FF 1B BD */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
/* 8031C67C  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C680  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C684  7F E3 FB 78 */	mr r3, r31                              
/* 8031C688  7C 9F 00 50 */	subf r4, r31, r0                        
/* 8031C68C  48 01 EF 51 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C690  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8031C694  48 04 5B 91 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

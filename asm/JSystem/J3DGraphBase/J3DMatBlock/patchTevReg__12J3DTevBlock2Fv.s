...
/* 8031C49C  48 04 5D 3D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031C4A0  7C 7C 1B 78 */	mr r28, r3                              
/* 8031C4A4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C4B8  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C4E8  4B FF 2F 15 */	bl J3DGDSetTevColorS10__F11_GXTevRegID11_GXColorS10 /* constant-address: 8030F3FC, symbol: J3DGDSetTevColorS10__F11_GXTevRegID11_GXColorS10 */
/* 8031C4EC  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C4F0  28 1D 00 03 */	cmplwi r29, 3                           
/* 8031C4F4  3B FF 00 08 */	addi r31, r31, 8                        
/* 8031C4F8  41 80 FF D0 */	blt lbl_8031C4C8                         /* constant-address: 8031C4C8, symbol: lbl_8031C4C8 */
...
/* 8031C518  4B FF 2D 7D */	bl J3DGDSetTevKColor__F14_GXTevKColorID8_GXColor /* constant-address: 8030F294, symbol: J3DGDSetTevKColor__F14_GXTevKColorID8_GXColor */
/* 8031C51C  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C520  28 1D 00 04 */	cmplwi r29, 4                           
/* 8031C524  3B FF 00 04 */	addi r31, r31, 4                        
/* 8031C528  41 80 FF DC */	blt lbl_8031C504                         /* constant-address: 8031C504, symbol: lbl_8031C504 */
/* 8031C52C  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C530  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C534  7F C3 F3 78 */	mr r3, r30                              
/* 8031C538  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C53C  48 01 F0 A1 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C540  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8031C544  48 04 5C E1 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

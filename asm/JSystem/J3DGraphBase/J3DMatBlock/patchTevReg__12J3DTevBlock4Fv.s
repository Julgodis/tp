...
/* 8031C798  48 04 5A 41 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031C79C  7C 7C 1B 78 */	mr r28, r3                              
/* 8031C7A0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C7B4  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C7E4  4B FF 2C 19 */	bl J3DGDSetTevColorS10__F11_GXTevRegID11_GXColorS10 /* constant-address: 8030F3FC, symbol: J3DGDSetTevColorS10__F11_GXTevRegID11_GXColorS10 */
/* 8031C7E8  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C7EC  28 1D 00 03 */	cmplwi r29, 3                           
/* 8031C7F0  3B FF 00 08 */	addi r31, r31, 8                        
/* 8031C7F4  41 80 FF D0 */	blt lbl_8031C7C4                         /* constant-address: 8031C7C4, symbol: lbl_8031C7C4 */
...
/* 8031C814  4B FF 2A 81 */	bl J3DGDSetTevKColor__F14_GXTevKColorID8_GXColor /* constant-address: 8030F294, symbol: J3DGDSetTevKColor__F14_GXTevKColorID8_GXColor */
/* 8031C818  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C81C  28 1D 00 04 */	cmplwi r29, 4                           
/* 8031C820  3B FF 00 04 */	addi r31, r31, 4                        
/* 8031C824  41 80 FF DC */	blt lbl_8031C800                         /* constant-address: 8031C800, symbol: lbl_8031C800 */
/* 8031C828  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C82C  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C830  7F C3 F3 78 */	mr r3, r30                              
/* 8031C834  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C838  48 01 ED A5 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C83C  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8031C840  48 04 59 E5 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

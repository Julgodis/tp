...
/* 8031F9CC  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031F9E0  40 81 00 08 */	ble lbl_8031F9E8                         /* constant-address: 8031F9E8, symbol: lbl_8031F9E8 */
/* 8031F9E4  48 04 16 F1 */	bl GDOverflowed                          /* constant-address: 803610D4, symbol: GDOverflowed */
lbl_8031F9E8:
...
/* 8031FA00  81 2D 94 00 */	lwz r9, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FA18  81 2D 94 00 */	lwz r9, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FA30  81 4D 94 00 */	lwz r10, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FA48  81 4D 94 00 */	lwz r10, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FA60  81 4D 94 00 */	lwz r10, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FA74  81 4D 94 00 */	lwz r10, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FA8C  41 82 00 0C */	beq lbl_8031FA98                         /* constant-address: 8031FA98, symbol: lbl_8031FA98 */
/* 8031FA90  2C 04 00 03 */	cmpwi r4, 3                             
/* 8031FA94  40 82 00 08 */	bne lbl_8031FA9C                         /* constant-address: 8031FA9C, symbol: lbl_8031FA9C */
lbl_8031FA98:
...
/* 8031FAE8  81 6D 94 00 */	lwz r11, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FB04  41 82 00 0C */	beq lbl_8031FB10                         /* constant-address: 8031FB10, symbol: lbl_8031FB10 */
/* 8031FB08  2C 04 00 03 */	cmpwi r4, 3                             
/* 8031FB0C  40 82 00 08 */	bne lbl_8031FB14                         /* constant-address: 8031FB14, symbol: lbl_8031FB14 */
lbl_8031FB10:
...
/* 8031FB38  81 6D 94 00 */	lwz r11, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FB54  41 82 00 0C */	beq lbl_8031FB60                         /* constant-address: 8031FB60, symbol: lbl_8031FB60 */
/* 8031FB58  2C 04 00 03 */	cmpwi r4, 3                             
/* 8031FB5C  40 82 00 08 */	bne lbl_8031FB64                         /* constant-address: 8031FB64, symbol: lbl_8031FB64 */
lbl_8031FB60:
...
/* 8031FB88  81 6D 94 00 */	lwz r11, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FBA4  41 82 00 0C */	beq lbl_8031FBB0                         /* constant-address: 8031FBB0, symbol: lbl_8031FBB0 */
/* 8031FBA8  2C 04 00 03 */	cmpwi r4, 3                             
/* 8031FBAC  40 82 00 08 */	bne lbl_8031FBB4                         /* constant-address: 8031FBB4, symbol: lbl_8031FBB4 */
lbl_8031FBB0:
...
/* 8031FBD0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FBE8  38 83 71 60 */	addi r4, r3, j3dZModeTable@l             /* constant-address: 80437160, symbol: j3dZModeTable */
...
/* 8031FC08  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FC34  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FC4C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FC64  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031FC78  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */

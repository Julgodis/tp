...
/* 8031C0BC  48 04 61 0D */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 8031C0C0  7C 7A 1B 78 */	mr r26, r3                              
/* 8031C0C4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C0D8  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C0FC  41 82 00 0C */	beq lbl_8031C108                         /* constant-address: 8031C108, symbol: lbl_8031C108 */
/* 8031C100  7F 03 C3 78 */	mr r3, r24                              
/* 8031C104  48 00 7E 91 */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C108:
/* 8031C108  3B 18 00 01 */	addi r24, r24, 1                        
/* 8031C10C  28 18 00 08 */	cmplwi r24, 8                           
/* 8031C110  3B 39 00 02 */	addi r25, r25, 2                        
/* 8031C114  41 80 FF D8 */	blt lbl_8031C0EC                         /* constant-address: 8031C0EC, symbol: lbl_8031C0EC */
/* 8031C118  3B 60 00 00 */	li r27, 0                               
/* 8031C11C  3B 20 00 00 */	li r25, 0                               
/* 8031C120  3C 60 80 43 */	lis r3, sTexCoordScaleTable__6J3DSys@ha 
/* 8031C124  3B E3 4C 2C */	addi r31, r3, sTexCoordScaleTable__6J3DSys@l /* constant-address: 80434C2C, symbol: sTexCoordScaleTable__6J3DSys */
/* 8031C128  48 00 00 CC */	b lbl_8031C1F4                           /* constant-address: 8031C1F4, symbol: lbl_8031C1F4 */
lbl_8031C12C:
/* 8031C12C  38 1B 00 01 */	addi r0, r27, 1                          /* constant-address: 00000001 */
...
/* 8031C158  4B FF 2F B1 */	bl J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID /* constant-address: 8030F108, symbol: J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID */
...
/* 8031C1A0  4B FF 20 95 */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
...
/* 8031C1E8  4B FF 20 4D */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
/* 8031C1EC  3B 7B 00 02 */	addi r27, r27, 2                         /* constant-address: 00000002 */
/* 8031C1F0  3B 39 00 08 */	addi r25, r25, 8                         /* constant-address: 00000008 */
lbl_8031C1F4:
/* 8031C1F4  7C 1B E0 40 */	cmplw r27, r28                          
/* 8031C1F8  41 80 FF 34 */	blt lbl_8031C12C                         /* constant-address: 8031C12C, symbol: lbl_8031C12C */
/* 8031C1FC  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C200  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C204  7F C3 F3 78 */	mr r3, r30                              
/* 8031C208  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C20C  48 01 F3 D1 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C210  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8031C214  48 04 60 01 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

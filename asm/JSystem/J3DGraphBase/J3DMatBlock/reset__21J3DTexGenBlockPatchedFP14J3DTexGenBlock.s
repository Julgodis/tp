...
/* 80320094  48 04 21 41 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 803200F0  41 80 FF D0 */	blt lbl_803200C0                         /* constant-address: 803200C0, symbol: lbl_803200C0 */
...
/* 80320118  41 82 00 60 */	beq lbl_80320178                         /* constant-address: 80320178, symbol: lbl_80320178 */
/* 8032011C  3B DF 00 38 */	addi r30, r31, 0x38                     
/* 80320120  7C 1B F0 2E */	lwzx r0, r27, r30                       
/* 80320124  28 00 00 00 */	cmplwi r0, 0                            
/* 80320128  41 82 00 3C */	beq lbl_80320164                         /* constant-address: 80320164, symbol: lbl_80320164 */
...
/* 80320150  4B CE 33 F1 */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
/* 80320154  7C 7B F0 2E */	lwzx r3, r27, r30                       
/* 80320158  38 80 00 94 */	li r4, 0x94                             
/* 8032015C  48 01 B4 81 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 80320160  48 00 00 18 */	b lbl_80320178                           /* constant-address: 80320178, symbol: lbl_80320178 */
lbl_80320164:
/* 80320164  3C 60 80 3A */	lis r3, J3DMatBlock__stringBase0@ha     
/* 80320168  38 63 1E A8 */	addi r3, r3, J3DMatBlock__stringBase0@l  /* constant-address: 803A1EA8, symbol: J3DMatBlock__stringBase0 */
/* 8032016C  7F A4 EB 78 */	mr r4, r29                              
/* 80320170  4C C6 31 82 */	crclr 6                                 
/* 80320174  4B CE 69 49 */	bl OSReport                              /* constant-address: 80006ABC, symbol: OSReport */
lbl_80320178:
/* 80320178  3B BD 00 01 */	addi r29, r29, 1                        
/* 8032017C  28 1D 00 08 */	cmplwi r29, 8                           
/* 80320180  3B FF 00 04 */	addi r31, r31, 4                        
/* 80320184  41 80 FF 78 */	blt lbl_803200FC                         /* constant-address: 803200FC, symbol: lbl_803200FC */
/* 80320188  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8032018C  48 04 20 95 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

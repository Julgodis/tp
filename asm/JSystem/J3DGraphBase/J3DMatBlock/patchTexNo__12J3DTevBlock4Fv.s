...
/* 8031C704  48 04 5A D5 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031C708  7C 7C 1B 78 */	mr r28, r3                              
/* 8031C70C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C720  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C740  41 82 00 0C */	beq lbl_8031C74C                         /* constant-address: 8031C74C, symbol: lbl_8031C74C */
/* 8031C744  7F A3 EB 78 */	mr r3, r29                              
/* 8031C748  48 00 78 4D */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C74C:
/* 8031C74C  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C750  28 1D 00 04 */	cmplwi r29, 4                           
/* 8031C754  3B FF 00 02 */	addi r31, r31, 2                        
/* 8031C758  41 80 FF D8 */	blt lbl_8031C730                         /* constant-address: 8031C730, symbol: lbl_8031C730 */
/* 8031C75C  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C760  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C764  7F C3 F3 78 */	mr r3, r30                              
/* 8031C768  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C76C  48 01 EE 71 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C770  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8031C774  48 04 5A B1 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 80318F18  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318F2C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 80318F30  83 E4 00 08 */	lwz r31, 8(r4)                          
/* 80318F34  80 0D 83 E0 */	lwz r0, SizeOfLoadMatColors(r13)         /* constant-address: 80450960, symbol: SizeOfLoadMatColors */
/* 80318F38  7C 7F 02 14 */	add r3, r31, r0                         
/* 80318F3C  80 04 00 0C */	lwz r0, 0xc(r4)                         
/* 80318F40  7C 03 00 40 */	cmplw r3, r0                            
/* 80318F44  40 81 00 08 */	ble lbl_80318F4C                         /* constant-address: 80318F4C, symbol: lbl_80318F4C */
/* 80318F48  48 04 81 8D */	bl GDOverflowed                          /* constant-address: 803610D4, symbol: GDOverflowed */
lbl_80318F4C:
/* 80318F4C  38 C0 00 10 */	li r6, 0x10                             
/* 80318F50  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318F68  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318F80  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318F94  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318FAC  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318FC8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318FE0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80318FF8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031900C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80319028  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80319040  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80319058  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031906C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80319080  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 80319084  80 03 00 08 */	lwz r0, 8(r3)                           
/* 80319088  7F E3 FB 78 */	mr r3, r31                              
/* 8031908C  7C 9F 00 50 */	subf r4, r31, r0                        
/* 80319090  48 02 25 4D */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */

...
/* 8031A4E8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031A4EC  80 64 00 08 */	lwz r3, 8(r4)                           
/* 8031A4F0  80 0D 83 E8 */	lwz r0, SizeOfLoadColorChans(r13)        /* constant-address: 80450968, symbol: SizeOfLoadColorChans */
/* 8031A4F4  7C 63 02 14 */	add r3, r3, r0                          
/* 8031A4F8  80 04 00 0C */	lwz r0, 0xc(r4)                         
/* 8031A4FC  7C 03 00 40 */	cmplw r3, r0                            
/* 8031A500  40 81 00 08 */	ble lbl_8031A508                         /* constant-address: 8031A508, symbol: lbl_8031A508 */
/* 8031A504  48 04 6B D1 */	bl GDOverflowed                          /* constant-address: 803610D4, symbol: GDOverflowed */
lbl_8031A508:
/* 8031A508  38 E0 00 10 */	li r7, 0x10                             
/* 8031A50C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A524  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A53C  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A550  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A568  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A57C  80 62 C9 A8 */	lwz r3, lit_585(r2)                      /* constant-address: 804563A8, symbol: lit_585 */
...
/* 8031A5D8  40 82 00 08 */	bne lbl_8031A5E0                         /* constant-address: 8031A5E0, symbol: lbl_8031A5E0 */
...
/* 8031A5F8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A610  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A628  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A63C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A650  80 02 C9 A8 */	lwz r0, lit_585(r2)                      /* constant-address: 804563A8, symbol: lit_585 */
...
/* 8031A6AC  40 82 00 08 */	bne lbl_8031A6B4                         /* constant-address: 8031A6B4, symbol: lbl_8031A6B4 */
...
/* 8031A6CC  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A6E4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A6FC  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A710  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A724  80 02 C9 A8 */	lwz r0, lit_585(r2)                      /* constant-address: 804563A8, symbol: lit_585 */
...
/* 8031A780  40 82 00 08 */	bne lbl_8031A788                         /* constant-address: 8031A788, symbol: lbl_8031A788 */
...
/* 8031A7A0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A7B8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A7D0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A7E4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A7F8  80 02 C9 A8 */	lwz r0, lit_585(r2)                      /* constant-address: 804563A8, symbol: lit_585 */
...
/* 8031A854  40 82 00 08 */	bne lbl_8031A85C                         /* constant-address: 8031A85C, symbol: lbl_8031A85C */
...
/* 8031A874  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A88C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A8A4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A8B8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */

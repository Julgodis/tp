...
/* 8031C288  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C29C  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C2A0  83 E3 00 08 */	lwz r31, 8(r3)                          
/* 8031C2A4  A0 05 00 08 */	lhz r0, 8(r5)                           
/* 8031C2A8  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 8031C2AC  41 82 00 10 */	beq lbl_8031C2BC                         /* constant-address: 8031C2BC, symbol: lbl_8031C2BC */
/* 8031C2B0  38 60 00 00 */	li r3, 0                                
/* 8031C2B4  38 85 00 08 */	addi r4, r5, 8                          
/* 8031C2B8  48 00 7C DD */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C2BC:
/* 8031C2BC  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C2C0  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C2C4  7F E3 FB 78 */	mr r3, r31                              
/* 8031C2C8  7C 9F 00 50 */	subf r4, r31, r0                        
/* 8031C2CC  48 01 F3 11 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */

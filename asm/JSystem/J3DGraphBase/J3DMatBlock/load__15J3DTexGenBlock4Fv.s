...
/* 8031A958  48 04 78 81 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031A95C  7C 7C 1B 78 */	mr r28, r3                              
/* 8031A960  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031A98C  41 82 00 1C */	beq lbl_8031A9A8                         /* constant-address: 8031A9A8, symbol: lbl_8031A9A8 */
/* 8031A990  38 1F 00 0A */	addi r0, r31, 0xa                       
/* 8031A994  7C 1C 00 AE */	lbzx r0, r28, r0                        
/* 8031A998  28 00 00 3C */	cmplwi r0, 0x3c                         
/* 8031A99C  41 82 00 0C */	beq lbl_8031A9A8                         /* constant-address: 8031A9A8, symbol: lbl_8031A9A8 */
/* 8031A9A0  7F A4 EB 78 */	mr r4, r29                              
/* 8031A9A4  48 00 8F 21 */	bl load__9J3DTexMtxCFUl                  /* constant-address: 803238C4, symbol: load__9J3DTexMtxCFUl */
lbl_8031A9A8:
...
/* 8031A9B8  41 80 FF C8 */	blt lbl_8031A980                         /* constant-address: 8031A980, symbol: lbl_8031A980 */
/* 8031A9BC  80 7C 00 04 */	lwz r3, 4(r28)                          
/* 8031A9C0  28 03 00 00 */	cmplwi r3, 0                            
/* 8031A9C4  41 82 00 0C */	beq lbl_8031A9D0                         /* constant-address: 8031A9D0, symbol: lbl_8031A9D0 */
/* 8031A9C8  38 9C 00 08 */	addi r4, r28, 8                         
/* 8031A9CC  48 00 8C 79 */	bl loadTexCoordGens__FUlP11J3DTexCoord   /* constant-address: 80323644, symbol: loadTexCoordGens__FUlP11J3DTexCoord */
lbl_8031A9D0:
/* 8031A9D0  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8031A9D4  48 04 78 51 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

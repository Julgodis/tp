...
/* 8031C864  48 04 59 65 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 8031C868  7C 7A 1B 78 */	mr r26, r3                              
/* 8031C86C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C880  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C8A4  41 82 00 0C */	beq lbl_8031C8B0                         /* constant-address: 8031C8B0, symbol: lbl_8031C8B0 */
/* 8031C8A8  7F 03 C3 78 */	mr r3, r24                              
/* 8031C8AC  48 00 76 E9 */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C8B0:
/* 8031C8B0  3B 18 00 01 */	addi r24, r24, 1                        
/* 8031C8B4  28 18 00 04 */	cmplwi r24, 4                           
/* 8031C8B8  3B 39 00 02 */	addi r25, r25, 2                        
/* 8031C8BC  41 80 FF D8 */	blt lbl_8031C894                         /* constant-address: 8031C894, symbol: lbl_8031C894 */
/* 8031C8C0  3B 60 00 00 */	li r27, 0                               
/* 8031C8C4  3B 20 00 00 */	li r25, 0                               
/* 8031C8C8  3C 60 80 43 */	lis r3, sTexCoordScaleTable__6J3DSys@ha 
/* 8031C8CC  3B E3 4C 2C */	addi r31, r3, sTexCoordScaleTable__6J3DSys@l /* constant-address: 80434C2C, symbol: sTexCoordScaleTable__6J3DSys */
/* 8031C8D0  48 00 00 CC */	b lbl_8031C99C                           /* constant-address: 8031C99C, symbol: lbl_8031C99C */
lbl_8031C8D4:
/* 8031C8D4  38 1B 00 01 */	addi r0, r27, 1                          /* constant-address: 00000001 */
...
/* 8031C900  4B FF 28 09 */	bl J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID /* constant-address: 8030F108, symbol: J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID */
...
/* 8031C948  4B FF 18 ED */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
...
/* 8031C990  4B FF 18 A5 */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
/* 8031C994  3B 7B 00 02 */	addi r27, r27, 2                         /* constant-address: 00000002 */
/* 8031C998  3B 39 00 08 */	addi r25, r25, 8                         /* constant-address: 00000008 */
lbl_8031C99C:
/* 8031C99C  7C 1B E0 40 */	cmplw r27, r28                          
/* 8031C9A0  41 80 FF 34 */	blt lbl_8031C8D4                         /* constant-address: 8031C8D4, symbol: lbl_8031C8D4 */
/* 8031C9A4  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C9A8  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C9AC  7F C3 F3 78 */	mr r3, r30                              
/* 8031C9B0  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C9B4  48 01 EC 29 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C9B8  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8031C9BC  48 04 58 59 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

...
/* 8031BFF0  48 04 61 E9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031BFF4  7C 7C 1B 78 */	mr r28, r3                              
/* 8031BFF8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C00C  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C03C  4B FF 33 C1 */	bl J3DGDSetTevColorS10__F11_GXTevRegID11_GXColorS10 /* constant-address: 8030F3FC, symbol: J3DGDSetTevColorS10__F11_GXTevRegID11_GXColorS10 */
/* 8031C040  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C044  28 1D 00 03 */	cmplwi r29, 3                           
/* 8031C048  3B FF 00 08 */	addi r31, r31, 8                        
/* 8031C04C  41 80 FF D0 */	blt lbl_8031C01C                         /* constant-address: 8031C01C, symbol: lbl_8031C01C */
...
/* 8031C06C  4B FF 32 29 */	bl J3DGDSetTevKColor__F14_GXTevKColorID8_GXColor /* constant-address: 8030F294, symbol: J3DGDSetTevKColor__F14_GXTevKColorID8_GXColor */
/* 8031C070  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C074  28 1D 00 04 */	cmplwi r29, 4                           
/* 8031C078  3B FF 00 04 */	addi r31, r31, 4                        
/* 8031C07C  41 80 FF DC */	blt lbl_8031C058                         /* constant-address: 8031C058, symbol: lbl_8031C058 */
/* 8031C080  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C084  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C088  7F C3 F3 78 */	mr r3, r30                              
/* 8031C08C  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C090  48 01 F5 4D */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C094  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8031C098  48 04 61 8D */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

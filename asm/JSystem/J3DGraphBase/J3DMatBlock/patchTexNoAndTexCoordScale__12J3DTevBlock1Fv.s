...
/* 8031C300  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C314  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C318  83 E3 00 08 */	lwz r31, 8(r3)                          
/* 8031C31C  A0 1E 00 08 */	lhz r0, 8(r30)                          
/* 8031C320  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 8031C324  41 82 00 10 */	beq lbl_8031C334                         /* constant-address: 8031C334, symbol: lbl_8031C334 */
/* 8031C328  38 60 00 00 */	li r3, 0                                
/* 8031C32C  38 9E 00 08 */	addi r4, r30, 8                         
/* 8031C330  48 00 7C 65 */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C334:
...
/* 8031C350  4B FF 2D B9 */	bl J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID /* constant-address: 8030F108, symbol: J3DGDSetTevOrder__F13_GXTevStageID13_GXTexCoordID11_GXTexMapID12_GXChannelID13_GXTexCoordID11_GXTexMapID12_GXChannelID */
/* 8031C354  88 1E 00 0B */	lbz r0, 0xb(r30)                        
/* 8031C358  54 04 1E B8 */	rlwinm r4, r0, 3, 0x1a, 0x1c            
/* 8031C35C  3C 60 80 43 */	lis r3, sTexCoordScaleTable__6J3DSys@ha 
/* 8031C360  38 03 4C 2C */	addi r0, r3, sTexCoordScaleTable__6J3DSys@l /* constant-address: 80434C2C, symbol: sTexCoordScaleTable__6J3DSys */
...
/* 8031C39C  4B FF 1E 99 */	bl J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc /* constant-address: 8030E234, symbol: J3DGDSetTexCoordScale2__F13_GXTexCoordIDUsUcUcUsUcUc */
/* 8031C3A0  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C3A4  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C3A8  7F E3 FB 78 */	mr r3, r31                              
/* 8031C3AC  7C 9F 00 50 */	subf r4, r31, r0                        
/* 8031C3B0  48 01 F2 2D */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */

...
/* 8031C408  48 04 5D D1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8031C40C  7C 7C 1B 78 */	mr r28, r3                              
/* 8031C410  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C424  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8031C444  41 82 00 0C */	beq lbl_8031C450                         /* constant-address: 8031C450, symbol: lbl_8031C450 */
/* 8031C448  7F A3 EB 78 */	mr r3, r29                              
/* 8031C44C  48 00 7B 49 */	bl loadTexNo__FUlRCUs                    /* constant-address: 80323F94, symbol: loadTexNo__FUlRCUs */
lbl_8031C450:
/* 8031C450  3B BD 00 01 */	addi r29, r29, 1                        
/* 8031C454  28 1D 00 02 */	cmplwi r29, 2                           
/* 8031C458  3B FF 00 02 */	addi r31, r31, 2                        
/* 8031C45C  41 80 FF D8 */	blt lbl_8031C434                         /* constant-address: 8031C434, symbol: lbl_8031C434 */
/* 8031C460  80 6D 94 00 */	lwz r3, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8031C464  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8031C468  7F C3 F3 78 */	mr r3, r30                              
/* 8031C46C  7C 9E 00 50 */	subf r4, r30, r0                        
/* 8031C470  48 01 F1 6D */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 8031C474  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8031C478  48 04 5D AD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

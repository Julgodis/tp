...
/* 8030DB14  48 05 46 8D */	bl __save_gpr                            /* constant-address: 803621A0, symbol: __save_gpr */
...
/* 8030DBE8  48 00 01 4C */	b lbl_8030DD34                           /* constant-address: 8030DD34, symbol: lbl_8030DD34 */
lbl_8030DBEC:
/* 8030DBEC  38 03 FF F7 */	addi r0, r3, -9                         
/* 8030DBF0  28 00 00 10 */	cmplwi r0, 0x10                         
/* 8030DBF4  41 81 01 3C */	bgt lbl_8030DD30                         /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
/* 8030DBF8  3C 60 80 3D */	lis r3, lit_899@ha                      
/* 8030DBFC  38 63 D7 E8 */	addi r3, r3, lit_899@l                   /* constant-address: 803CD7E8, symbol: lit_899 */
...
/* 8030DC28  48 00 01 08 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DC3C  40 82 00 10 */	bne lbl_8030DC4C                         /* constant-address: 8030DC4C, symbol: lbl_8030DC4C */
/* 8030DC40  3B E0 00 01 */	li r31, 1                               
/* 8030DC44  3B C0 00 01 */	li r30, 1                               
/* 8030DC48  48 00 00 E8 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
lbl_8030DC4C:
/* 8030DC4C  54 A0 06 3F */	clrlwi. r0, r5, 0x18                    
/* 8030DC50  38 00 00 01 */	li r0, 1                                
/* 8030DC54  40 82 00 08 */	bne lbl_8030DC5C                         /* constant-address: 8030DC5C, symbol: lbl_8030DC5C */
/* 8030DC58  7C 60 1B 78 */	mr r0, r3                               
lbl_8030DC5C:
/* 8030DC5C  7C 1F 03 78 */	mr r31, r0                              
/* 8030DC60  3B C0 00 00 */	li r30, 0                               
/* 8030DC64  48 00 00 CC */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DC78  48 00 00 B8 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DC8C  48 00 00 A4 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DCA8  48 00 00 88 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DCC4  48 00 00 6C */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DCE0  48 00 00 50 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
/* 8030DCE4  81 C4 00 04 */	lwz r14, 4(r4)                          
/* 8030DCE8  83 A4 00 08 */	lwz r29, 8(r4)                          
/* 8030DCEC  8B 84 00 0C */	lbz r28, 0xc(r4)                        
/* 8030DCF0  48 00 00 40 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
/* 8030DCF4  83 64 00 04 */	lwz r27, 4(r4)                          
/* 8030DCF8  83 44 00 08 */	lwz r26, 8(r4)                          
/* 8030DCFC  8B 24 00 0C */	lbz r25, 0xc(r4)                        
/* 8030DD00  48 00 00 30 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
/* 8030DD04  83 04 00 04 */	lwz r24, 4(r4)                          
/* 8030DD08  82 E4 00 08 */	lwz r23, 8(r4)                          
/* 8030DD0C  8A C4 00 0C */	lbz r22, 0xc(r4)                        
/* 8030DD10  48 00 00 20 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
/* 8030DD14  82 A4 00 04 */	lwz r21, 4(r4)                          
/* 8030DD18  82 84 00 08 */	lwz r20, 8(r4)                          
/* 8030DD1C  8A 64 00 0C */	lbz r19, 0xc(r4)                        
/* 8030DD20  48 00 00 10 */	b lbl_8030DD30                           /* constant-address: 8030DD30, symbol: lbl_8030DD30 */
...
/* 8030DD3C  40 82 FE B0 */	bne lbl_8030DBEC                         /* constant-address: 8030DBEC, symbol: lbl_8030DBEC */
/* 8030DD40  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DD54  40 81 00 08 */	ble lbl_8030DD5C                         /* constant-address: 8030DD5C, symbol: lbl_8030DD5C */
/* 8030DD58  48 05 33 7D */	bl GDOverflowed                          /* constant-address: 803610D4, symbol: GDOverflowed */
lbl_8030DD5C:
/* 8030DD5C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DD78  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DE28  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DE40  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DE58  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DE6C  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DE80  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DE9C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DF20  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DF38  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DF50  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DF64  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DF78  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DF94  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030DFF4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030E00C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030E024  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030E038  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030E050  48 05 41 9D */	bl __restore_gpr                         /* constant-address: 803621EC, symbol: __restore_gpr */

...
/* 8030D220  48 05 4F BD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8030D224  7C 7D 1B 78 */	mr r29, r3                              
/* 8030D228  7C 9E 23 78 */	mr r30, r4                              
/* 8030D22C  7C BF 2B 78 */	mr r31, r5                              
/* 8030D230  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D244  40 81 00 08 */	ble lbl_8030D24C                         /* constant-address: 8030D24C, symbol: lbl_8030D24C */
/* 8030D248  48 05 3E 8D */	bl GDOverflowed                          /* constant-address: 803610D4, symbol: GDOverflowed */
lbl_8030D24C:
/* 8030D24C  38 C0 00 61 */	li r6, 0x61                             
/* 8030D250  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D268  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D280  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D298  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D2B0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D2C4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D2F4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D30C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D324  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D338  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030D350  48 05 4E D9 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

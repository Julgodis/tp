...
/* 8030F640  48 05 2B 9D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8030F644  7C 7D 1B 78 */	mr r29, r3                              
/* 8030F648  7C 9E 23 78 */	mr r30, r4                              
/* 8030F64C  FC 04 18 00 */	fcmpu cr0, f4, f3                       
/* 8030F650  41 82 00 0C */	beq lbl_8030F65C                         /* constant-address: 8030F65C, symbol: lbl_8030F65C */
/* 8030F654  FC 02 08 00 */	fcmpu cr0, f2, f1                       
/* 8030F658  40 82 00 14 */	bne lbl_8030F66C                         /* constant-address: 8030F66C, symbol: lbl_8030F66C */
lbl_8030F65C:
/* 8030F65C  C0 A2 C9 34 */	lfs f5, lit_1460(r2)                     /* constant-address: 80456334, symbol: lit_1460 */
/* 8030F660  C0 62 C9 38 */	lfs f3, lit_1461(r2)                     /* constant-address: 80456338, symbol: lit_1461 */
/* 8030F664  D0 A1 00 0C */	stfs f5, 0xc(r1)                        
/* 8030F668  48 00 00 24 */	b lbl_8030F68C                           /* constant-address: 8030F68C, symbol: lbl_8030F68C */
lbl_8030F66C:
...
/* 8030F690  C0 22 C9 38 */	lfs f1, lit_1461(r2)                     /* constant-address: 80456338, symbol: lit_1461 */
/* 8030F694  C8 02 C9 40 */	lfd f0, lit_1462(r2)                     /* constant-address: 80456340, symbol: lit_1462 */
/* 8030F698  48 00 00 0C */	b lbl_8030F6A4                           /* constant-address: 8030F6A4, symbol: lbl_8030F6A4 */
lbl_8030F69C:
/* 8030F69C  EC 63 00 72 */	fmuls f3, f3, f1                        
/* 8030F6A0  3B FF 00 01 */	addi r31, r31, 1                         /* constant-address: 00000002 */
lbl_8030F6A4:
/* 8030F6A4  FC 03 00 40 */	fcmpo cr0, f3, f0                       
/* 8030F6A8  41 81 FF F4 */	bgt lbl_8030F69C                         /* constant-address: 8030F69C, symbol: lbl_8030F69C */
/* 8030F6AC  C8 02 C9 50 */	lfd f0, lit_1464(r2)                     /* constant-address: 80456350, symbol: lit_1464 */
/* 8030F6B0  C0 42 C9 48 */	lfs f2, lit_1463(r2)                     /* constant-address: 80456348, symbol: lit_1463 */
/* 8030F6B4  C0 22 C9 34 */	lfs f1, lit_1460(r2)                     /* constant-address: 80456334, symbol: lit_1460 */
/* 8030F6B8  48 00 00 0C */	b lbl_8030F6C4                           /* constant-address: 8030F6C4, symbol: lbl_8030F6C4 */
lbl_8030F6BC:
/* 8030F6BC  EC 63 00 B2 */	fmuls f3, f3, f2                        
/* 8030F6C0  3B FF FF FF */	addi r31, r31, -1                       
lbl_8030F6C4:
/* 8030F6C4  FC 03 08 40 */	fcmpo cr0, f3, f1                       
/* 8030F6C8  40 81 00 0C */	ble lbl_8030F6D4                         /* constant-address: 8030F6D4, symbol: lbl_8030F6D4 */
/* 8030F6CC  FC 03 00 40 */	fcmpo cr0, f3, f0                       
/* 8030F6D0  41 80 FF EC */	blt lbl_8030F6BC                         /* constant-address: 8030F6BC, symbol: lbl_8030F6BC */
lbl_8030F6D4:
/* 8030F6D4  38 00 00 01 */	li r0, 1                                
/* 8030F6D8  7C 00 F8 30 */	slw r0, r0, r31                         
/* 8030F6DC  C8 22 C9 60 */	lfd f1, lit_1468(r2)                     /* constant-address: 80456360, symbol: lit_1468 */
...
/* 8030F700  C0 02 C9 58 */	lfs f0, lit_1465(r2)                     /* constant-address: 80456358, symbol: lit_1465 */
/* 8030F704  EC 20 00 F2 */	fmuls f1, f0, f3                        
/* 8030F708  48 05 29 A5 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8030F70C  81 01 00 08 */	lwz r8, 8(r1)                           
/* 8030F710  80 81 00 0C */	lwz r4, 0xc(r1)                         
/* 8030F714  38 00 00 61 */	li r0, 0x61                             
/* 8030F718  80 ED 94 00 */	lwz r7, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F738  80 ED 94 00 */	lwz r7, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F750  80 ED 94 00 */	lwz r7, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F768  80 ED 94 00 */	lwz r7, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F77C  80 ED 94 00 */	lwz r7, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F790  80 ED 94 00 */	lwz r7, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F7AC  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F7C4  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F7DC  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F7F0  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F804  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F820  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F838  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F850  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F864  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F878  80 CD 94 00 */	lwz r6, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F89C  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F8B4  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F8CC  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F8E0  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F90C  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F924  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F93C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F954  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F968  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8030F980  48 05 28 A9 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

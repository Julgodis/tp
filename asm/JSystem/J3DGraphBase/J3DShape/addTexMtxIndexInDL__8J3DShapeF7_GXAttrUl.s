...
/* 80314BC8  48 04 D6 0D */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 80314BCC  7C 7F 1B 78 */	mr r31, r3                              
/* 80314BD0  3C 60 80 3A */	lis r3, lit_697@ha                      
/* 80314BD4  38 C3 1E 98 */	addi r6, r3, lit_697@l                   /* constant-address: 803A1E98, symbol: lit_697 */
/* 80314BD8  80 66 00 00 */	lwz r3, 0(r6)                            /* constant-address: 803A1E98, symbol: lit_697 */
/* 80314BDC  80 06 00 04 */	lwz r0, 4(r6)                            /* constant-address: 803A1E9C, symbol: None */
/* 80314BE0  90 61 00 08 */	stw r3, 8(r1)                           
/* 80314BE4  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 80314BE8  80 66 00 08 */	lwz r3, 8(r6)                            /* constant-address: 803A1EA0, symbol: None */
/* 80314BEC  80 06 00 0C */	lwz r0, 0xc(r6)                          /* constant-address: 803A1EA4, symbol: None */
...
/* 80314C10  48 00 00 3C */	b lbl_80314C4C                           /* constant-address: 80314C4C, symbol: lbl_80314C4C */
lbl_80314C14:
/* 80314C14  2C 00 00 00 */	cmpwi r0, 0                             
/* 80314C18  40 82 00 08 */	bne lbl_80314C20                         /* constant-address: 80314C20, symbol: lbl_80314C20 */
/* 80314C1C  7D 06 43 78 */	mr r6, r8                               
lbl_80314C20:
/* 80314C20  7C 04 00 00 */	cmpw r4, r0                             
/* 80314C24  40 80 00 14 */	bge lbl_80314C38                         /* constant-address: 80314C38, symbol: lbl_80314C38 */
/* 80314C28  55 20 06 3F */	clrlwi. r0, r9, 0x18                    
/* 80314C2C  40 82 00 0C */	bne lbl_80314C38                         /* constant-address: 80314C38, symbol: lbl_80314C38 */
...
/* 80314C54  40 82 FF C0 */	bne lbl_80314C14                         /* constant-address: 80314C14, symbol: lbl_80314C14 */
/* 80314C58  2C 06 FF FF */	cmpwi r6, -1                            
/* 80314C5C  41 82 00 48 */	beq lbl_80314CA4                         /* constant-address: 80314CA4, symbol: lbl_80314CA4 */
/* 80314C60  3B 60 00 00 */	li r27, 0                               
/* 80314C64  7C BE 2B 78 */	mr r30, r5                              
/* 80314C68  7C FD 3B 78 */	mr r29, r7                              
/* 80314C6C  7D 1C 43 78 */	mr r28, r8                              
/* 80314C70  48 00 00 24 */	b lbl_80314C94                           /* constant-address: 80314C94, symbol: lbl_80314C94 */
lbl_80314C74:
...
/* 80314C8C  4B FF FC E9 */	bl addTexMtxIndexInDL__12J3DShapeDrawFUlUlUl /* constant-address: 80314974, symbol: addTexMtxIndexInDL__12J3DShapeDrawFUlUlUl */
/* 80314C90  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
lbl_80314C94:
/* 80314C94  57 63 04 3E */	clrlwi r3, r27, 0x10                    
/* 80314C98  A0 1F 00 0A */	lhz r0, 0xa(r31)                        
/* 80314C9C  7C 03 00 40 */	cmplw r3, r0                            
/* 80314CA0  41 80 FF D4 */	blt lbl_80314C74                         /* constant-address: 80314C74, symbol: lbl_80314C74 */
lbl_80314CA4:
/* 80314CA4  39 61 00 30 */	addi r11, r1, 0x30                      
/* 80314CA8  48 04 D5 79 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 80323654  48 03 EB 7D */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 80323658  7C 7C 1B 78 */	mr r28, r3                              
/* 8032365C  7C 9D 23 78 */	mr r29, r4                              
/* 80323660  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8032367C  40 81 00 08 */	ble lbl_80323684                         /* constant-address: 80323684, symbol: lbl_80323684 */
/* 80323680  48 03 DA 55 */	bl GDOverflowed                          /* constant-address: 803610D4, symbol: GDOverflowed */
lbl_80323684:
/* 80323684  38 C0 00 10 */	li r6, 0x10                             
/* 80323688  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 803236A8  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 803236C0  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 803236D4  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 803236EC  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323708  48 00 00 1C */	b lbl_80323724                           /* constant-address: 80323724, symbol: lbl_80323724 */
lbl_8032370C:
/* 8032370C  7C 9D DA 14 */	add r4, r29, r27                        
/* 80323710  88 64 00 00 */	lbz r3, 0(r4)                           
/* 80323714  88 84 00 01 */	lbz r4, 1(r4)                           
/* 80323718  4B FE A9 4D */	bl J3DGDSetTexCoordGen__F13_GXTexGenType12_GXTexGenSrc /* constant-address: 8030E064, symbol: J3DGDSetTexCoordGen__F13_GXTexGenType12_GXTexGenSrc */
/* 8032371C  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
/* 80323720  3B 7B 00 06 */	addi r27, r27, 6                         /* constant-address: 00000006 */
lbl_80323724:
/* 80323724  7C 1A E0 40 */	cmplw r26, r28                          
/* 80323728  41 80 FF E4 */	blt lbl_8032370C                         /* constant-address: 8032370C, symbol: lbl_8032370C */
/* 8032372C  38 A0 00 10 */	li r5, 0x10                             
/* 80323730  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323744  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323758  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8032376C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323784  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323798  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8032379C  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 803237A0  80 03 00 34 */	lwz r0, 0x34(r3)                         /* constant-address: 80434AFC, symbol: None */
/* 803237A4  54 00 00 43 */	rlwinm. r0, r0, 0, 1, 1                 
/* 803237A8  41 82 00 9C */	beq lbl_80323844                         /* constant-address: 80323844, symbol: lbl_80323844 */
/* 803237AC  39 00 00 00 */	li r8, 0                                
/* 803237B0  38 60 00 00 */	li r3, 0                                
/* 803237B4  7F 89 03 A6 */	mtctr r28                               
/* 803237B8  28 1C 00 00 */	cmplwi r28, 0                           
/* 803237BC  40 81 00 F0 */	ble lbl_803238AC                         /* constant-address: 803238AC, symbol: lbl_803238AC */
lbl_803237C0:
...
/* 803237D0  41 82 00 08 */	beq lbl_803237D8                         /* constant-address: 803237D8, symbol: lbl_803237D8 */
/* 803237D4  1C E8 00 03 */	mulli r7, r8, 3                         
lbl_803237D8:
/* 803237D8  54 E6 46 3E */	srwi r6, r7, 0x18                       
/* 803237DC  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 803237F4  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8032380C  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323820  80 AD 94 00 */	lwz r5, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8032383C  42 00 FF 84 */	bdnz lbl_803237C0                        /* constant-address: 803237C0, symbol: lbl_803237C0 */
/* 80323840  48 00 00 6C */	b lbl_803238AC                           /* constant-address: 803238AC, symbol: lbl_803238AC */
lbl_80323844:
/* 80323844  7F 89 03 A6 */	mtctr r28                               
/* 80323848  28 1C 00 00 */	cmplwi r28, 0                           
/* 8032384C  40 81 00 60 */	ble lbl_803238AC                         /* constant-address: 803238AC, symbol: lbl_803238AC */
lbl_80323850:
/* 80323850  38 A0 00 00 */	li r5, 0                                
/* 80323854  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323868  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8032387C  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 80323894  80 8D 94 00 */	lwz r4, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 803238A8  42 00 FF A8 */	bdnz lbl_80323850                        /* constant-address: 80323850, symbol: lbl_80323850 */
lbl_803238AC:
/* 803238AC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 803238B0  48 03 E9 6D */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

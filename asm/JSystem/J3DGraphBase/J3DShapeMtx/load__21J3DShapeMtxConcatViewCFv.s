...
/* 80313C70  3B C3 4A C8 */	addi r30, r3, j3dSys@l                   /* constant-address: 80434AC8, symbol: j3dSys */
/* 80313C74  80 DE 00 38 */	lwz r6, 0x38(r30)                        /* constant-address: 80434B00, symbol: None */
/* 80313C78  80 66 00 84 */	lwz r3, 0x84(r6)                        
/* 80313C7C  80 03 00 34 */	lwz r0, 0x34(r3)                        
/* 80313C80  90 0D 90 38 */	stw r0, sMtxPtrTbl__21J3DShapeMtxConcatView(r13) /* constant-address: 804515B8, symbol: sMtxPtrTbl__21J3DShapeMtxConcatView */
/* 80313C84  80 03 00 10 */	lwz r0, 0x10(r3)                        
/* 80313C88  38 AD 90 38 */	la r5, sMtxPtrTbl__21J3DShapeMtxConcatView(r13) /* 804515B8-_SDA_BASE_ */ /* constant-address: 804515B8, symbol: sMtxPtrTbl__21J3DShapeMtxConcatView */
/* 80313C8C  90 05 00 04 */	stw r0, 4(r5)                            /* constant-address: 804515BC, symbol: None */
/* 80313C90  80 0D 90 28 */	lwz r0, sCurrentPipeline__11J3DShapeMtx(r13) /* constant-address: 804515A8, symbol: sCurrentPipeline__11J3DShapeMtx */
/* 80313C94  1C 80 00 0C */	mulli r4, r0, 0xc                       
/* 80313C98  3C 60 80 3D */	lis r3, sMtxLoadPipeline__21J3DShapeMtxConcatView@ha
/* 80313C9C  38 03 DA 20 */	addi r0, r3, sMtxLoadPipeline__21J3DShapeMtxConcatView@l /* constant-address: 803CDA20, symbol: sMtxLoadPipeline__21J3DShapeMtxConcatView */
...
/* 80313CD4  90 9E 01 04 */	stw r4, 0x104(r30)                       /* constant-address: 80434BCC, symbol: None */
/* 80313CD8  38 60 00 15 */	li r3, 0x15                             
/* 80313CDC  38 A0 00 30 */	li r5, 0x30                             
/* 80313CE0  48 04 7E 49 */	bl GXSetArray                            /* constant-address: 8035BB28, symbol: GXSetArray */
/* 80313CE4  80 7E 00 38 */	lwz r3, 0x38(r30)                        /* constant-address: 80434B00, symbol: None */
...
/* 80313D08  48 04 E3 7D */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */

...
/* 80312FD8  40 82 00 58 */	bne lbl_80313030                         /* constant-address: 80313030, symbol: lbl_80313030 */
/* 80312FDC  80 1F 00 28 */	lwz r0, 0x28(r31)                       
/* 80312FE0  28 00 00 00 */	cmplwi r0, 0                            
/* 80312FE4  41 82 00 4C */	beq lbl_80313030                         /* constant-address: 80313030, symbol: lbl_80313030 */
/* 80312FE8  4B FF FE 21 */	bl prepareDraw__14J3DShapePacketCFv      /* constant-address: 80312E08, symbol: prepareDraw__14J3DShapePacketCFv */
/* 80312FEC  80 1F 00 24 */	lwz r0, 0x24(r31)                       
/* 80312FF0  28 00 00 00 */	cmplwi r0, 0                            
/* 80312FF4  41 82 00 20 */	beq lbl_80313014                         /* constant-address: 80313014, symbol: lbl_80313014 */
/* 80312FF8  80 7F 00 28 */	lwz r3, 0x28(r31)                       
/* 80312FFC  80 63 00 04 */	lwz r3, 4(r3)                           
/* 80313000  80 03 00 28 */	lwz r0, 0x28(r3)                        
/* 80313004  90 0D 90 40 */	stw r0, sTexGenBlock__17J3DDifferedTexMtx(r13) /* constant-address: 804515C0, symbol: sTexGenBlock__17J3DDifferedTexMtx */
/* 80313008  80 1F 00 24 */	lwz r0, 0x24(r31)                       
/* 8031300C  90 0D 90 44 */	stw r0, sTexMtxObj__17J3DDifferedTexMtx(r13) /* constant-address: 804515C4, symbol: sTexMtxObj__17J3DDifferedTexMtx */
/* 80313010  48 00 00 0C */	b lbl_8031301C                           /* constant-address: 8031301C, symbol: lbl_8031301C */
lbl_80313014:
/* 80313014  38 00 00 00 */	li r0, 0                                
/* 80313018  90 0D 90 40 */	stw r0, sTexGenBlock__17J3DDifferedTexMtx(r13) /* constant-address: 804515C0, symbol: sTexGenBlock__17J3DDifferedTexMtx */
lbl_8031301C:

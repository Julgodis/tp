...
/* 80310810  48 04 D3 5D */	bl GXSetChanCtrl                         /* constant-address: 8035DB6C, symbol: GXSetChanCtrl */
...
/* 80310830  48 04 D3 3D */	bl GXSetChanCtrl                         /* constant-address: 8035DB6C, symbol: GXSetChanCtrl */
/* 80310834  80 0D 83 D0 */	lwz r0, ColorBlack(r13)                  /* constant-address: 80450950, symbol: ColorBlack */
/* 80310838  90 01 00 14 */	stw r0, 0x14(r1)                        
/* 8031083C  38 60 00 04 */	li r3, 4                                
/* 80310840  38 81 00 14 */	addi r4, r1, 0x14                       
/* 80310844  48 04 D1 1D */	bl GXSetChanAmbColor                     /* constant-address: 8035D960, symbol: GXSetChanAmbColor */
/* 80310848  80 0D 83 D0 */	lwz r0, ColorBlack(r13)                  /* constant-address: 80450950, symbol: ColorBlack */
/* 8031084C  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 80310850  38 60 00 05 */	li r3, 5                                
/* 80310854  38 81 00 10 */	addi r4, r1, 0x10                       
/* 80310858  48 04 D1 09 */	bl GXSetChanAmbColor                     /* constant-address: 8035D960, symbol: GXSetChanAmbColor */
/* 8031085C  80 0D 83 D4 */	lwz r0, ColorWhite(r13)                  /* constant-address: 80450954, symbol: ColorWhite */
/* 80310860  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 80310864  38 60 00 04 */	li r3, 4                                
/* 80310868  38 81 00 0C */	addi r4, r1, 0xc                        
/* 8031086C  48 04 D1 DD */	bl GXSetChanMatColor                     /* constant-address: 8035DA48, symbol: GXSetChanMatColor */
/* 80310870  80 0D 83 D4 */	lwz r0, ColorWhite(r13)                  /* constant-address: 80450954, symbol: ColorWhite */
/* 80310874  90 01 00 08 */	stw r0, 8(r1)                           
/* 80310878  38 60 00 05 */	li r3, 5                                
/* 8031087C  38 81 00 08 */	addi r4, r1, 8                          
/* 80310880  48 04 D1 C9 */	bl GXSetChanMatColor                     /* constant-address: 8035DA48, symbol: GXSetChanMatColor */

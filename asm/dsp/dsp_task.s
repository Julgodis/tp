...
/* ###################################################################################### */
.section .text, "ax"
/* 803525D0 0028 .text      __DSP_exec_task                __DSP_exec_task                */
...
/* 80352770 0020 .text      __DSP_boot_task                __DSP_boot_task                */
.global __DSP_boot_task
__DSP_boot_task:
/* 80352770 0034F6B0  7C 08 02 A6 */	mflr r0
/* 80352774 0034F6B4  3C 80 80 3D */	lis r4, LIT_266@ha
...
/* 803527DC 0018 .text      func_803527DC                  func_803527DC                  */
.global func_803527DC
func_803527DC:
/* 803527DC 0034F71C  4B FF FC 55 */	bl DSPCheckMailToDSP
/* 803527E0 0034F720  28 03 00 00 */	cmplwi r3, 0
/* 803527E4 0034F724  40 82 FF F8 */	bne func_803527DC
...
/* 803527F4 0018 .text      func_803527F4                  func_803527F4                  */
.global func_803527F4
func_803527F4:
/* 803527F4 0034F734  4B FF FC 3D */	bl DSPCheckMailToDSP
/* 803527F8 0034F738  28 03 00 00 */	cmplwi r3, 0
/* 803527FC 0034F73C  40 82 FF F8 */	bne func_803527F4
...
/* 803528FC 0028 .text      __DSP_insert_task              __DSP_insert_task              */
.global __DSP_insert_task
__DSP_insert_task:
/* 803528FC 0034F83C  80 0D 93 90 */	lwz r0, __DSP_first_task-_SDA_BASE_(r13)
/* 80352900 0034F840  28 00 00 00 */	cmplwi r0, 0
/* 80352904 0034F844  40 82 00 20 */	bne func_80352924
/* 80352908 0034F848  90 6D 93 94 */	stw r3, __DSP_curr_task-_SDA_BASE_(r13)
/* 8035290C 0034F84C  38 00 00 00 */	li r0, 0
/* 80352910 0034F850  90 6D 93 8C */	stw r3, __DSP_last_task-_SDA_BASE_(r13)
/* 80352914 0034F854  90 6D 93 90 */	stw r3, __DSP_first_task-_SDA_BASE_(r13)
...
/* 80352924 0008 .text      func_80352924                  func_80352924                  */
.global func_80352924
func_80352924:
/* 80352924 0034F864  7C 05 03 78 */	mr r5, r0
/* 80352928 0034F868  48 00 00 44 */	b func_8035296C

/* 8035292C 0034 .text      func_8035292C                  func_8035292C                  */
.global func_8035292C
func_8035292C:
...
/* 80352938 0034F878  40 80 00 30 */	bge func_80352968
...
/* 80352954 0034F894  40 82 00 0C */	bne func_80352960
/* 80352958 0034F898  90 6D 93 90 */	stw r3, __DSP_first_task-_SDA_BASE_(r13)
/* 8035295C 0034F89C  48 00 00 18 */	b func_80352974

/* 80352960 0008 .text      func_80352960                  func_80352960                  */
.global func_80352960
func_80352960:
/* 80352960 0034F8A0  90 64 00 38 */	stw r3, 0x38(r4)
/* 80352964 0034F8A4  48 00 00 10 */	b func_80352974

/* 80352968 0004 .text      func_80352968                  func_80352968                  */
.global func_80352968
func_80352968:
/* 80352968 0034F8A8  80 A5 00 38 */	lwz r5, 0x38(r5)

/* 8035296C 0008 .text      func_8035296C                  func_8035296C                  */
.global func_8035296C
func_8035296C:
/* 8035296C 0034F8AC  28 05 00 00 */	cmplwi r5, 0
/* 80352970 0034F8B0  40 82 FF BC */	bne func_8035292C

/* 80352974 0028 .text      func_80352974                  func_80352974                  */
.global func_80352974
func_80352974:
/* 80352974 0034F8B4  28 05 00 00 */	cmplwi r5, 0
/* 80352978 0034F8B8  4C 82 00 20 */	bnelr 
/* 8035297C 0034F8BC  80 8D 93 8C */	lwz r4, __DSP_last_task-_SDA_BASE_(r13)
...
/* 8035298C 0034F8CC  80 0D 93 8C */	lwz r0, __DSP_last_task-_SDA_BASE_(r13)
/* 80352990 0034F8D0  90 03 00 3C */	stw r0, 0x3c(r3)
/* 80352994 0034F8D4  90 6D 93 8C */	stw r3, __DSP_last_task-_SDA_BASE_(r13)
/* 80352998 0034F8D8  4E 80 00 20 */	blr 

/* 8035299C 0038 .text      __DSP_remove_task              __DSP_remove_task              */
...
/* 803529AC 0034F8EC  80 0D 93 90 */	lwz r0, __DSP_first_task-_SDA_BASE_(r13)
/* 803529B0 0034F8F0  7C 00 18 40 */	cmplw r0, r3
/* 803529B4 0034F8F4  40 82 00 30 */	bne func_803529E4
/* 803529B8 0034F8F8  80 03 00 38 */	lwz r0, 0x38(r3)
/* 803529BC 0034F8FC  28 00 00 00 */	cmplwi r0, 0
/* 803529C0 0034F900  41 82 00 14 */	beq func_803529D4
/* 803529C4 0034F904  90 0D 93 90 */	stw r0, __DSP_first_task-_SDA_BASE_(r13)
...
/* 803529D4 0010 .text      func_803529D4                  func_803529D4                  */
.global func_803529D4
func_803529D4:
/* 803529D4 0034F914  90 8D 93 94 */	stw r4, __DSP_curr_task-_SDA_BASE_(r13)
/* 803529D8 0034F918  90 8D 93 8C */	stw r4, __DSP_last_task-_SDA_BASE_(r13)
/* 803529DC 0034F91C  90 8D 93 90 */	stw r4, __DSP_first_task-_SDA_BASE_(r13)
/* 803529E0 0034F920  4E 80 00 20 */	blr 

/* 803529E4 0028 .text      func_803529E4                  func_803529E4                  */
.global func_803529E4
func_803529E4:
/* 803529E4 0034F924  80 0D 93 8C */	lwz r0, __DSP_last_task-_SDA_BASE_(r13)
/* 803529E8 0034F928  7C 00 18 40 */	cmplw r0, r3
/* 803529EC 0034F92C  40 82 00 20 */	bne func_80352A0C
/* 803529F0 0034F930  80 03 00 3C */	lwz r0, 0x3c(r3)
/* 803529F4 0034F934  90 0D 93 8C */	stw r0, __DSP_last_task-_SDA_BASE_(r13)
/* 803529F8 0034F938  80 63 00 3C */	lwz r3, 0x3c(r3)
/* 803529FC 0034F93C  90 83 00 38 */	stw r4, 0x38(r3)
/* 80352A00 0034F940  80 0D 93 90 */	lwz r0, __DSP_first_task-_SDA_BASE_(r13)
/* 80352A04 0034F944  90 0D 93 94 */	stw r0, __DSP_curr_task-_SDA_BASE_(r13)
/* 80352A08 0034F948  4E 80 00 20 */	blr 

/* 80352A0C 0024 .text      func_80352A0C                  func_80352A0C                  */
.global func_80352A0C
func_80352A0C:
/* 80352A0C 0034F94C  80 03 00 38 */	lwz r0, 0x38(r3)
/* 80352A10 0034F950  90 0D 93 94 */	stw r0, __DSP_curr_task-_SDA_BASE_(r13)
...
/* ###################################################################################### */
.section .data, "aw"
/* 803D1CF8 0000 .data      sym_803D1CF8                   ...data.0                      */
.global sym_803D1CF8
sym_803D1CF8:

/* 803D1CF8 001D .data      LIT_266                        @266                           */
.global LIT_266
LIT_266:
...
/* 803D1D18 002D .data      dsp_task__LIT_267              @267                           */
.global dsp_task__LIT_267
dsp_task__LIT_267:
...
/* 803D1D48 002D .data      dsp_task__LIT_268              @268                           */
.global dsp_task__LIT_268
dsp_task__LIT_268:
...
/* 803D1D78 002D .data      dsp_task__LIT_269              @269                           */
.global dsp_task__LIT_269
dsp_task__LIT_269:
...
/* 803D1DA8 002D .data      dsp_task__LIT_270              @270                           */
.global dsp_task__LIT_270
dsp_task__LIT_270:
...
/* 803D1DD8 002D .data      dsp_task__LIT_271              @271                           */
.global dsp_task__LIT_271
dsp_task__LIT_271:
...
/* 803D1E08 002B .data      dsp_task__LIT_294              @294                           */
.global dsp_task__LIT_294
dsp_task__LIT_294:

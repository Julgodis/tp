...
/* 803726D0  40 81 00 0C */	ble lbl_803726DC                         /* constant-address: 803726DC, symbol: lbl_803726DC */
/* 803726D4  38 60 FF FF */	li r3, -1                               
/* 803726D8  48 00 00 B0 */	b lbl_80372788                           /* constant-address: 80372788, symbol: lbl_80372788 */
lbl_803726DC:
/* 803726DC  38 7E 00 18 */	addi r3, r30, 0x18                      
/* 803726E0  48 00 05 E9 */	bl MWEnterCriticalSection                /* constant-address: 80372CC8, symbol: MWEnterCriticalSection */
...
/* 803726FC  40 80 00 20 */	bge lbl_8037271C                         /* constant-address: 8037271C, symbol: lbl_8037271C */
/* 80372700  7F 83 E3 78 */	mr r3, r28                              
/* 80372704  7F E5 FB 78 */	mr r5, r31                              
/* 80372708  4B C9 0E 39 */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
/* 8037270C  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 80372710  7C 00 FA 14 */	add r0, r0, r31                         
/* 80372714  90 1E 00 00 */	stw r0, 0(r30)                          
/* 80372718  48 00 00 30 */	b lbl_80372748                           /* constant-address: 80372748, symbol: lbl_80372748 */
lbl_8037271C:
/* 8037271C  7F 83 E3 78 */	mr r3, r28                              
/* 80372720  7F A5 EB 78 */	mr r5, r29                              
/* 80372724  4B C9 0E 1D */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
/* 80372728  80 9E 00 08 */	lwz r4, 8(r30)                          
/* 8037272C  7C 7C EA 14 */	add r3, r28, r29                        
/* 80372730  7C BD F8 50 */	subf r5, r29, r31                       
/* 80372734  4B C9 0E 0D */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
...
/* 8037275C  40 82 00 08 */	bne lbl_80372764                         /* constant-address: 80372764, symbol: lbl_80372764 */
...
/* 80372780  48 00 05 25 */	bl MWExitCriticalSection                 /* constant-address: 80372CA4, symbol: MWExitCriticalSection */

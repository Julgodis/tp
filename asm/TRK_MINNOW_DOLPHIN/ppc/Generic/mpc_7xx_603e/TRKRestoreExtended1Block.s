...
/* 803713AC  60 42 F3 38 */	ori r2, r2, gTRKCPUState@l               /* constant-address: 8044F338, symbol: gTRKCPUState */
/* 803713B0  3C A0 80 3D */	lis r5, gTRKRestoreFlags@h              
/* 803713B4  60 A5 32 38 */	ori r5, r5, gTRKRestoreFlags@l           /* constant-address: 803D3238, symbol: gTRKRestoreFlags */
/* 803713B8  88 65 00 00 */	lbz r3, 0(r5)                            /* constant-address: 803D3238, symbol: gTRKRestoreFlags */
/* 803713BC  88 C5 00 01 */	lbz r6, 1(r5)                            /* constant-address: 803D3239, symbol: None */
/* 803713C0  38 00 00 00 */	li r0, 0                                
/* 803713C4  98 05 00 00 */	stb r0, 0(r5)                            /* constant-address: 803D3238, symbol: gTRKRestoreFlags */
/* 803713C8  98 05 00 01 */	stb r0, 1(r5)                            /* constant-address: 803D3239, symbol: None */
/* 803713CC  2C 03 00 00 */	cmpwi r3, 0                             
/* 803713D0  41 82 00 14 */	beq lbl_803713E4                         /* constant-address: 803713E4, symbol: lbl_803713E4 */
/* 803713D4  83 02 01 E8 */	lwz r24, 0x1e8(r2)                       /* constant-address: 8044F520, symbol: None */
/* 803713D8  83 22 01 EC */	lwz r25, 0x1ec(r2)                       /* constant-address: 8044F524, symbol: None */
...
/* 80371414  48 00 00 1C */	b lbl_80371430                           /* constant-address: 80371430, symbol: lbl_80371430 */
...
/* 80371468  48 00 00 34 */	b lbl_8037149C                           /* constant-address: 8037149C, symbol: lbl_8037149C */
/* 8037146C  2C 06 00 00 */	cmpwi r6, 0                             
/* 80371470  41 82 00 0C */	beq lbl_8037147C                         /* constant-address: 8037147C, symbol: lbl_8037147C */
/* 80371474  83 42 02 78 */	lwz r26, 0x278(r2)                       /* constant-address: 80459C78, symbol: None */

...
/* 8036EEC0  4B C9 45 99 */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036EEE0  4B FF E8 3D */	bl TRKGetFreeBuffer                      /* constant-address: 8036D71C, symbol: TRKGetFreeBuffer */
/* 8036EEE4  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8036EEE8  40 82 00 18 */	bne lbl_8036EF00                         /* constant-address: 8036EF00, symbol: lbl_8036EF00 */
/* 8036EEEC  80 61 00 08 */	lwz r3, 8(r1)                           
/* 8036EEF0  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8036EEF4  38 A0 00 40 */	li r5, 0x40                             
/* 8036EEF8  4B FF E4 91 */	bl TRKAppendBuffer_ui8                   /* constant-address: 8036D388, symbol: TRKAppendBuffer_ui8 */
/* 8036EEFC  7C 7F 1B 78 */	mr r31, r3                              
lbl_8036EF00:
/* 8036EF00  2C 1F 00 00 */	cmpwi r31, 0                            
/* 8036EF04  40 82 00 50 */	bne lbl_8036EF54                         /* constant-address: 8036EF54, symbol: lbl_8036EF54 */
...
/* 8036EF24  48 00 01 75 */	bl TRKRequestSend                        /* constant-address: 8036F098, symbol: TRKRequestSend */
/* 8036EF28  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8036EF2C  40 82 00 10 */	bne lbl_8036EF3C                         /* constant-address: 8036EF3C, symbol: lbl_8036EF3C */
/* 8036EF30  80 61 00 10 */	lwz r3, 0x10(r1)                        
/* 8036EF34  4B FF E7 BD */	bl TRKGetBuffer                          /* constant-address: 8036D6F0, symbol: TRKGetBuffer */
/* 8036EF38  7C 7E 1B 78 */	mr r30, r3                              
lbl_8036EF3C:
/* 8036EF3C  2C 1F 00 00 */	cmpwi r31, 0                            
/* 8036EF40  40 82 00 0C */	bne lbl_8036EF4C                         /* constant-address: 8036EF4C, symbol: lbl_8036EF4C */
/* 8036EF44  80 1E 00 20 */	lwz r0, 0x20(r30)                       
/* 8036EF48  90 1D 00 00 */	stw r0, 0(r29)                          
lbl_8036EF4C:
/* 8036EF4C  80 61 00 10 */	lwz r3, 0x10(r1)                        
/* 8036EF50  4B FF E7 3D */	bl TRKReleaseBuffer                      /* constant-address: 8036D68C, symbol: TRKReleaseBuffer */
lbl_8036EF54:
/* 8036EF54  80 61 00 0C */	lwz r3, 0xc(r1)                         
/* 8036EF58  4B FF E7 35 */	bl TRKReleaseBuffer                      /* constant-address: 8036D68C, symbol: TRKReleaseBuffer */

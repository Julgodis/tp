...
/* 8036E6C8  3B E3 28 D0 */	addi r31, r3, lit_321@l                  /* constant-address: 803A28D0, symbol: lit_321 */
/* 8036E6CC  38 9F 01 80 */	addi r4, r31, 0x180                      /* constant-address: 803A2A50, symbol: lit_498 */
...
/* 8036E6F4  48 00 45 61 */	bl MWTRACE                               /* constant-address: 80372C54, symbol: MWTRACE */
/* 8036E6F8  57 C0 07 BD */	rlwinm. r0, r30, 0, 0x1e, 0x1e          
/* 8036E6FC  41 82 00 40 */	beq lbl_8036E73C                         /* constant-address: 8036E73C, symbol: lbl_8036E73C */
/* 8036E700  38 61 00 64 */	addi r3, r1, 0x64                       
/* 8036E704  38 80 00 00 */	li r4, 0                                
/* 8036E708  38 A0 00 40 */	li r5, 0x40                             
/* 8036E70C  4B C9 4D 4D */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036E730  48 00 36 39 */	bl TRKWriteUARTN                         /* constant-address: 80371D68, symbol: TRKWriteUARTN */
/* 8036E734  38 60 00 00 */	li r3, 0                                
/* 8036E738  48 00 01 90 */	b lbl_8036E8C8                           /* constant-address: 8036E8C8, symbol: lbl_8036E8C8 */
lbl_8036E73C:
/* 8036E73C  93 A1 00 20 */	stw r29, 0x20(r1)                       
/* 8036E740  7F 63 DB 78 */	mr r3, r27                              
/* 8036E744  38 80 00 40 */	li r4, 0x40                             
/* 8036E748  4B FF EE D5 */	bl TRKSetBufferPosition                  /* constant-address: 8036D61C, symbol: TRKSetBufferPosition */
/* 8036E74C  57 C0 06 73 */	rlwinm. r0, r30, 0, 0x19, 0x19          
/* 8036E750  41 82 00 38 */	beq lbl_8036E788                         /* constant-address: 8036E788, symbol: lbl_8036E788 */
...
/* 8036E768  4B FF ED 85 */	bl TRKReadBuffer                         /* constant-address: 8036D4EC, symbol: TRKReadBuffer */
...
/* 8036E77C  48 00 12 99 */	bl TRKTargetAccessARAM                   /* constant-address: 8036FA14, symbol: TRKTargetAccessARAM */
/* 8036E780  7C 7E 1B 78 */	mr r30, r3                              
/* 8036E784  48 00 00 34 */	b lbl_8036E7B8                           /* constant-address: 8036E7B8, symbol: lbl_8036E7B8 */
lbl_8036E788:
/* 8036E788  80 A1 00 20 */	lwz r5, 0x20(r1)                        
/* 8036E78C  7F 63 DB 78 */	mr r3, r27                              
/* 8036E790  38 81 01 00 */	addi r4, r1, 0x100                      
/* 8036E794  4B FF ED 59 */	bl TRKReadBuffer                         /* constant-address: 8036D4EC, symbol: TRKReadBuffer */
...
/* 8036E7B0  48 00 26 25 */	bl TRKTargetAccessMemory                 /* constant-address: 80370DD4, symbol: TRKTargetAccessMemory */
/* 8036E7B4  7C 7E 1B 78 */	mr r30, r3                              
lbl_8036E7B8:
/* 8036E7B8  7F 63 DB 78 */	mr r3, r27                              
/* 8036E7BC  38 80 00 00 */	li r4, 0                                
/* 8036E7C0  4B FF EE 8D */	bl TRKResetBuffer                        /* constant-address: 8036D64C, symbol: TRKResetBuffer */
/* 8036E7C4  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8036E7C8  40 82 00 3C */	bne lbl_8036E804                         /* constant-address: 8036E804, symbol: lbl_8036E804 */
/* 8036E7CC  38 61 00 A4 */	addi r3, r1, 0xa4                       
/* 8036E7D0  38 80 00 00 */	li r4, 0                                
/* 8036E7D4  38 A0 00 40 */	li r5, 0x40                             
/* 8036E7D8  4B C9 4C 81 */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036E7FC  4B FF ED 7D */	bl TRKAppendBuffer                       /* constant-address: 8036D578, symbol: TRKAppendBuffer */
/* 8036E800  7C 7E 1B 78 */	mr r30, r3                              
lbl_8036E804:
/* 8036E804  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8036E808  41 82 00 8C */	beq lbl_8036E894                         /* constant-address: 8036E894, symbol: lbl_8036E894 */
/* 8036E80C  38 1E F9 00 */	addi r0, r30, -1792                     
/* 8036E810  28 00 00 06 */	cmplwi r0, 6                            
/* 8036E814  41 81 00 44 */	bgt lbl_8036E858                         /* constant-address: 8036E858, symbol: lbl_8036E858 */
/* 8036E818  3C 60 80 3D */	lis r3, lit_499@ha                      
/* 8036E81C  54 00 10 3A */	slwi r0, r0, 2                          
/* 8036E820  38 63 32 00 */	addi r3, r3, lit_499@l                   /* constant-address: 803D3200, symbol: lit_499 */
/* 8036E824  7C 03 00 2E */	lwzx r0, r3, r0                         
/* 8036E828  7C 09 03 A6 */	mtctr r0                                
/* 8036E82C  4E 80 04 20 */	bctr                                    
/* 8036E830  3B C0 00 15 */	li r30, 0x15                            
/* 8036E834  48 00 00 28 */	b lbl_8036E85C                           /* constant-address: 8036E85C, symbol: lbl_8036E85C */
/* 8036E838  3B C0 00 13 */	li r30, 0x13                            
/* 8036E83C  48 00 00 20 */	b lbl_8036E85C                           /* constant-address: 8036E85C, symbol: lbl_8036E85C */
/* 8036E840  3B C0 00 21 */	li r30, 0x21                            
/* 8036E844  48 00 00 18 */	b lbl_8036E85C                           /* constant-address: 8036E85C, symbol: lbl_8036E85C */
/* 8036E848  3B C0 00 22 */	li r30, 0x22                            
/* 8036E84C  48 00 00 10 */	b lbl_8036E85C                           /* constant-address: 8036E85C, symbol: lbl_8036E85C */
/* 8036E850  3B C0 00 20 */	li r30, 0x20                            
/* 8036E854  48 00 00 08 */	b lbl_8036E85C                           /* constant-address: 8036E85C, symbol: lbl_8036E85C */
lbl_8036E858:
...
/* 8036E868  4B C9 4B F1 */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036E888  48 00 34 E1 */	bl TRKWriteUARTN                         /* constant-address: 80371D68, symbol: TRKWriteUARTN */
/* 8036E88C  38 60 00 00 */	li r3, 0                                
/* 8036E890  48 00 00 38 */	b lbl_8036E8C8                           /* constant-address: 8036E8C8, symbol: lbl_8036E8C8 */
lbl_8036E894:
/* 8036E894  38 9F 00 60 */	addi r4, r31, 0x60                       /* constant-address: 803A2930, symbol: lit_403 */
/* 8036E898  38 60 00 01 */	li r3, 1                                
/* 8036E89C  4C C6 31 82 */	crclr 6                                 
/* 8036E8A0  48 00 43 B5 */	bl MWTRACE                               /* constant-address: 80372C54, symbol: MWTRACE */
/* 8036E8A4  7F 63 DB 78 */	mr r3, r27                              
/* 8036E8A8  4B FF E7 31 */	bl TRKMessageSend                        /* constant-address: 8036CFD8, symbol: TRKMessageSend */
/* 8036E8AC  38 9F 00 80 */	addi r4, r31, 0x80                       /* constant-address: 803A2950, symbol: lit_404 */
/* 8036E8B0  7C 7F 1B 78 */	mr r31, r3                              
/* 8036E8B4  38 60 00 01 */	li r3, 1                                
/* 8036E8B8  7F E5 FB 78 */	mr r5, r31                              
/* 8036E8BC  4C C6 31 82 */	crclr 6                                 
/* 8036E8C0  48 00 43 95 */	bl MWTRACE                               /* constant-address: 80372C54, symbol: MWTRACE */

...
/* 8036E904  3B A3 28 D0 */	addi r29, r3, lit_321@l                  /* constant-address: 803A28D0, symbol: lit_321 */
/* 8036E908  38 9D 01 B0 */	addi r4, r29, 0x1b0                      /* constant-address: 803A2A80, symbol: lit_535 */
...
/* 8036E930  48 00 43 25 */	bl MWTRACE                               /* constant-address: 80372C54, symbol: MWTRACE */
/* 8036E934  57 C0 07 BD */	rlwinm. r0, r30, 0, 0x1e, 0x1e          
/* 8036E938  41 82 00 40 */	beq lbl_8036E978                         /* constant-address: 8036E978, symbol: lbl_8036E978 */
/* 8036E93C  38 61 00 64 */	addi r3, r1, 0x64                       
/* 8036E940  38 80 00 00 */	li r4, 0                                
/* 8036E944  38 A0 00 40 */	li r5, 0x40                             
/* 8036E948  4B C9 4B 11 */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036E96C  48 00 33 FD */	bl TRKWriteUARTN                         /* constant-address: 80371D68, symbol: TRKWriteUARTN */
/* 8036E970  38 60 00 00 */	li r3, 0                                
/* 8036E974  48 00 01 98 */	b lbl_8036EB0C                           /* constant-address: 8036EB0C, symbol: lbl_8036EB0C */
lbl_8036E978:
/* 8036E978  57 DC 06 73 */	rlwinm. r28, r30, 0, 0x19, 0x19         
/* 8036E97C  93 61 00 20 */	stw r27, 0x20(r1)                       
/* 8036E980  41 82 00 20 */	beq lbl_8036E9A0                         /* constant-address: 8036E9A0, symbol: lbl_8036E9A0 */
...
/* 8036E994  48 00 10 81 */	bl TRKTargetAccessARAM                   /* constant-address: 8036FA14, symbol: TRKTargetAccessARAM */
/* 8036E998  7C 7E 1B 78 */	mr r30, r3                              
/* 8036E99C  48 00 00 24 */	b lbl_8036E9C0                           /* constant-address: 8036E9C0, symbol: lbl_8036E9C0 */
lbl_8036E9A0:
...
/* 8036E9B8  48 00 24 1D */	bl TRKTargetAccessMemory                 /* constant-address: 80370DD4, symbol: TRKTargetAccessMemory */
/* 8036E9BC  7C 7E 1B 78 */	mr r30, r3                              
lbl_8036E9C0:
/* 8036E9C0  7F E3 FB 78 */	mr r3, r31                              
/* 8036E9C4  38 80 00 00 */	li r4, 0                                
/* 8036E9C8  4B FF EC 85 */	bl TRKResetBuffer                        /* constant-address: 8036D64C, symbol: TRKResetBuffer */
/* 8036E9CC  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8036E9D0  40 82 00 78 */	bne lbl_8036EA48                         /* constant-address: 8036EA48, symbol: lbl_8036EA48 */
/* 8036E9D4  38 61 00 A4 */	addi r3, r1, 0xa4                       
/* 8036E9D8  38 80 00 00 */	li r4, 0                                
/* 8036E9DC  38 A0 00 40 */	li r5, 0x40                             
/* 8036E9E0  4B C9 4A 79 */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036EA08  4B FF EB 71 */	bl TRKAppendBuffer                       /* constant-address: 8036D578, symbol: TRKAppendBuffer */
/* 8036EA0C  2C 1C 00 00 */	cmpwi r28, 0                            
/* 8036EA10  41 82 00 24 */	beq lbl_8036EA34                         /* constant-address: 8036EA34, symbol: lbl_8036EA34 */
...
/* 8036EA28  4B FF EB 51 */	bl TRKAppendBuffer                       /* constant-address: 8036D578, symbol: TRKAppendBuffer */
/* 8036EA2C  7C 7E 1B 78 */	mr r30, r3                              
/* 8036EA30  48 00 00 18 */	b lbl_8036EA48                           /* constant-address: 8036EA48, symbol: lbl_8036EA48 */
lbl_8036EA34:
/* 8036EA34  80 A1 00 20 */	lwz r5, 0x20(r1)                        
/* 8036EA38  7F E3 FB 78 */	mr r3, r31                              
/* 8036EA3C  38 81 01 00 */	addi r4, r1, 0x100                      
/* 8036EA40  4B FF EB 39 */	bl TRKAppendBuffer                       /* constant-address: 8036D578, symbol: TRKAppendBuffer */
/* 8036EA44  7C 7E 1B 78 */	mr r30, r3                              
lbl_8036EA48:
/* 8036EA48  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8036EA4C  41 82 00 8C */	beq lbl_8036EAD8                         /* constant-address: 8036EAD8, symbol: lbl_8036EAD8 */
/* 8036EA50  38 1E F9 00 */	addi r0, r30, -1792                     
/* 8036EA54  28 00 00 06 */	cmplwi r0, 6                            
/* 8036EA58  41 81 00 44 */	bgt lbl_8036EA9C                         /* constant-address: 8036EA9C, symbol: lbl_8036EA9C */
/* 8036EA5C  3C 60 80 3D */	lis r3, lit_536@ha                      
/* 8036EA60  54 00 10 3A */	slwi r0, r0, 2                          
/* 8036EA64  38 63 32 1C */	addi r3, r3, lit_536@l                   /* constant-address: 803D321C, symbol: lit_536 */
/* 8036EA68  7C 03 00 2E */	lwzx r0, r3, r0                         
/* 8036EA6C  7C 09 03 A6 */	mtctr r0                                
/* 8036EA70  4E 80 04 20 */	bctr                                    
/* 8036EA74  3B 80 00 15 */	li r28, 0x15                            
/* 8036EA78  48 00 00 28 */	b lbl_8036EAA0                           /* constant-address: 8036EAA0, symbol: lbl_8036EAA0 */
/* 8036EA7C  3B 80 00 13 */	li r28, 0x13                            
/* 8036EA80  48 00 00 20 */	b lbl_8036EAA0                           /* constant-address: 8036EAA0, symbol: lbl_8036EAA0 */
/* 8036EA84  3B 80 00 21 */	li r28, 0x21                            
/* 8036EA88  48 00 00 18 */	b lbl_8036EAA0                           /* constant-address: 8036EAA0, symbol: lbl_8036EAA0 */
/* 8036EA8C  3B 80 00 22 */	li r28, 0x22                            
/* 8036EA90  48 00 00 10 */	b lbl_8036EAA0                           /* constant-address: 8036EAA0, symbol: lbl_8036EAA0 */
/* 8036EA94  3B 80 00 20 */	li r28, 0x20                            
/* 8036EA98  48 00 00 08 */	b lbl_8036EAA0                           /* constant-address: 8036EAA0, symbol: lbl_8036EAA0 */
lbl_8036EA9C:
...
/* 8036EAAC  4B C9 49 AD */	bl memset                                /* constant-address: 80003458, symbol: memset */
...
/* 8036EACC  48 00 32 9D */	bl TRKWriteUARTN                         /* constant-address: 80371D68, symbol: TRKWriteUARTN */
/* 8036EAD0  38 60 00 00 */	li r3, 0                                
/* 8036EAD4  48 00 00 38 */	b lbl_8036EB0C                           /* constant-address: 8036EB0C, symbol: lbl_8036EB0C */
lbl_8036EAD8:
/* 8036EAD8  38 9D 00 60 */	addi r4, r29, 0x60                       /* constant-address: 803A2930, symbol: lit_403 */
/* 8036EADC  38 60 00 01 */	li r3, 1                                
/* 8036EAE0  4C C6 31 82 */	crclr 6                                 
/* 8036EAE4  48 00 41 71 */	bl MWTRACE                               /* constant-address: 80372C54, symbol: MWTRACE */
/* 8036EAE8  7F E3 FB 78 */	mr r3, r31                              
/* 8036EAEC  4B FF E4 ED */	bl TRKMessageSend                        /* constant-address: 8036CFD8, symbol: TRKMessageSend */
/* 8036EAF0  38 9D 00 80 */	addi r4, r29, 0x80                       /* constant-address: 803A2950, symbol: lit_404 */
/* 8036EAF4  7C 7D 1B 78 */	mr r29, r3                              
/* 8036EAF8  38 60 00 01 */	li r3, 1                                
/* 8036EAFC  7F A5 EB 78 */	mr r5, r29                              
/* 8036EB00  4C C6 31 82 */	crclr 6                                 
/* 8036EB04  48 00 41 51 */	bl MWTRACE                               /* constant-address: 80372C54, symbol: MWTRACE */

...
/* 8036D410  80 04 D8 B8 */	lwz r0, gTRKBigEndian@l(r4)              /* constant-address: 8044D8B8, symbol: gTRKBigEndian */
/* 8036D414  90 A1 00 08 */	stw r5, 8(r1)                           
/* 8036D418  2C 00 00 00 */	cmpwi r0, 0                             
/* 8036D41C  90 C1 00 0C */	stw r6, 0xc(r1)                         
/* 8036D420  41 82 00 0C */	beq lbl_8036D42C                         /* constant-address: 8036D42C, symbol: lbl_8036D42C */
/* 8036D424  38 81 00 08 */	addi r4, r1, 8                          
/* 8036D428  48 00 00 48 */	b lbl_8036D470                           /* constant-address: 8036D470, symbol: lbl_8036D470 */
lbl_8036D42C:
...
/* 8036D484  40 80 00 0C */	bge lbl_8036D490                         /* constant-address: 8036D490, symbol: lbl_8036D490 */
/* 8036D488  3B C0 03 01 */	li r30, 0x301                           
/* 8036D48C  7C 1D 03 78 */	mr r29, r0                              
lbl_8036D490:
/* 8036D490  28 1D 00 01 */	cmplwi r29, 1                           
/* 8036D494  40 82 00 14 */	bne lbl_8036D4A8                         /* constant-address: 8036D4A8, symbol: lbl_8036D4A8 */
/* 8036D498  88 04 00 00 */	lbz r0, 0(r4)                           
/* 8036D49C  7C 7F 1A 14 */	add r3, r31, r3                         
/* 8036D4A0  98 03 00 10 */	stb r0, 0x10(r3)                        
/* 8036D4A4  48 00 00 14 */	b lbl_8036D4B8                           /* constant-address: 8036D4B8, symbol: lbl_8036D4B8 */
lbl_8036D4A8:
/* 8036D4A8  38 63 00 10 */	addi r3, r3, 0x10                       
/* 8036D4AC  7F A5 EB 78 */	mr r5, r29                              
/* 8036D4B0  7C 7F 1A 14 */	add r3, r31, r3                         
/* 8036D4B4  4B C9 61 0D */	bl TRK_memcpy                            /* constant-address: 800035C0, symbol: TRK_memcpy */
lbl_8036D4B8:

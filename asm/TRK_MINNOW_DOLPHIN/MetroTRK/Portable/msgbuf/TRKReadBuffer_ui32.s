...
/* 8036D03C  3B 66 D8 B8 */	addi r27, r6, gTRKBigEndian@l            /* constant-address: 8044D8B8, symbol: gTRKBigEndian */
/* 8036D040  3B C0 00 00 */	li r30, 0                               
/* 8036D044  38 60 00 00 */	li r3, 0                                
/* 8036D048  48 00 00 A0 */	b lbl_8036D0E8                           /* constant-address: 8036D0E8, symbol: lbl_8036D0E8 */
lbl_8036D04C:
/* 8036D04C  80 1B 00 00 */	lwz r0, 0(r27)                           /* constant-address: 8044D8B8, symbol: gTRKBigEndian */
/* 8036D050  2C 00 00 00 */	cmpwi r0, 0                             
/* 8036D054  41 82 00 0C */	beq lbl_8036D060                         /* constant-address: 8036D060, symbol: lbl_8036D060 */
/* 8036D058  7F F9 FB 78 */	mr r25, r31                             
/* 8036D05C  48 00 00 08 */	b lbl_8036D064                           /* constant-address: 8036D064, symbol: lbl_8036D064 */
lbl_8036D060:
...
/* 8036D07C  40 81 00 0C */	ble lbl_8036D088                         /* constant-address: 8036D088, symbol: lbl_8036D088 */
...
/* 8036D098  4B C9 65 29 */	bl TRK_memcpy                            /* constant-address: 800035C0, symbol: TRK_memcpy */
/* 8036D09C  80 1C 00 0C */	lwz r0, 0xc(r28)                        
/* 8036D0A0  7C 00 C2 14 */	add r0, r0, r24                         
/* 8036D0A4  90 1C 00 0C */	stw r0, 0xc(r28)                        
/* 8036D0A8  80 1B 00 00 */	lwz r0, 0(r27)                           /* constant-address: 8044D8B8, symbol: gTRKBigEndian */
/* 8036D0AC  2C 00 00 00 */	cmpwi r0, 0                             
/* 8036D0B0  40 82 00 2C */	bne lbl_8036D0DC                         /* constant-address: 8036D0DC, symbol: lbl_8036D0DC */
/* 8036D0B4  2C 1A 00 00 */	cmpwi r26, 0                            
/* 8036D0B8  40 82 00 24 */	bne lbl_8036D0DC                         /* constant-address: 8036D0DC, symbol: lbl_8036D0DC */
...
/* 8036D0E4  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_8036D0E8:
/* 8036D0E8  2C 03 00 00 */	cmpwi r3, 0                             
/* 8036D0EC  40 82 00 0C */	bne lbl_8036D0F8                         /* constant-address: 8036D0F8, symbol: lbl_8036D0F8 */
/* 8036D0F0  7C 1E E8 00 */	cmpw r30, r29                           
/* 8036D0F4  41 80 FF 58 */	blt lbl_8036D04C                         /* constant-address: 8036D04C, symbol: lbl_8036D04C */
lbl_8036D0F8:

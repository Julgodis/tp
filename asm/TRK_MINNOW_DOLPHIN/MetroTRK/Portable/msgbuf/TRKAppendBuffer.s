...
/* 8036D59C  40 82 00 0C */	bne lbl_8036D5A8                         /* constant-address: 8036D5A8, symbol: lbl_8036D5A8 */
/* 8036D5A0  38 60 00 00 */	li r3, 0                                
/* 8036D5A4  48 00 00 5C */	b lbl_8036D600                           /* constant-address: 8036D600, symbol: lbl_8036D600 */
lbl_8036D5A8:
/* 8036D5A8  80 7D 00 0C */	lwz r3, 0xc(r29)                        
/* 8036D5AC  20 03 08 80 */	subfic r0, r3, 0x880                    
/* 8036D5B0  7C 00 F0 40 */	cmplw r0, r30                           
/* 8036D5B4  40 80 00 0C */	bge lbl_8036D5C0                         /* constant-address: 8036D5C0, symbol: lbl_8036D5C0 */
/* 8036D5B8  3B E0 03 01 */	li r31, 0x301                           
/* 8036D5BC  7C 1E 03 78 */	mr r30, r0                              
lbl_8036D5C0:
/* 8036D5C0  28 1E 00 01 */	cmplwi r30, 1                           
/* 8036D5C4  40 82 00 14 */	bne lbl_8036D5D8                         /* constant-address: 8036D5D8, symbol: lbl_8036D5D8 */
/* 8036D5C8  88 04 00 00 */	lbz r0, 0(r4)                           
/* 8036D5CC  7C 7D 1A 14 */	add r3, r29, r3                         
/* 8036D5D0  98 03 00 10 */	stb r0, 0x10(r3)                        
/* 8036D5D4  48 00 00 14 */	b lbl_8036D5E8                           /* constant-address: 8036D5E8, symbol: lbl_8036D5E8 */
lbl_8036D5D8:
/* 8036D5D8  38 63 00 10 */	addi r3, r3, 0x10                       
/* 8036D5DC  7F C5 F3 78 */	mr r5, r30                              
/* 8036D5E0  7C 7D 1A 14 */	add r3, r29, r3                         
/* 8036D5E4  4B C9 5F DD */	bl TRK_memcpy                            /* constant-address: 800035C0, symbol: TRK_memcpy */
lbl_8036D5E8:

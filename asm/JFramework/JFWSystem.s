...
/* 80271CE4 0026EC24  80 6D 81 F0 */	lwz r3, maxStdHeaps__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
...
/* 80271CF4 0026EC34  90 8D 8C 20 */	stw r4, rootHeap__9JFWSystem-_SDA_BASE_(r13)
/* 80271CF8 0026EC38  80 6D 81 F4 */	lwz r3, sysHeapSize__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
/* 80271CFC 0026EC3C  38 A0 00 00 */	li r5, 0
/* 80271D00 0026EC40  48 05 D1 2D */	bl create__10JKRExpHeapFUlP7JKRHeapb
/* 80271D04 0026EC44  90 6D 8C 24 */	stw r3, systemHeap__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271D48 0026EC88  98 0D 8C 3C */	stb r0, data_804511BC-_SDA_BASE_(r13)
...
/* 80271D58 0026EC98  80 CD 82 08 */	lwz r6, decompPriority__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
/* 80271D5C 0026EC9C  80 ED 82 0C */	lwz r7, aPiecePriority__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
...
/* 80271D98 0026ECD8  83 ED 81 F8 */	lwz r31, fifoBufSize__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
...
/* 80271DFC 0026ED3C  90 6D 8C 2C */	stw r3, debugPrint__9JFWSystem-_SDA_BASE_(r13)
/* 80271E00 0026ED40  80 8D 8C 30 */	lwz r4, systemFont__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271E10 0026ED50  90 6D 8C 34 */	stw r3, systemConsoleManager__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271E28 0026ED68  93 ED 8C 38 */	stw r31, systemConsole__9JFWSystem-_SDA_BASE_(r13)
/* 80271E2C 0026ED6C  83 CD 8C 30 */	lwz r30, systemFont__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271F28 0026EE68  80 6D 8C 38 */	lwz r3, systemConsole__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271F70 0026EEB0  80 6D 8C 30 */	lwz r3, systemFont__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271FA0 0026EEE0  80 6D 8C 38 */	lwz r3, systemConsole__9JFWSystem-_SDA_BASE_(r13)
/* 80271FA4 0026EEE4  D0 03 00 50 */	stfs f0, 0x50(r3)
/* 80271FA8 0026EEE8  D3 E3 00 54 */	stfs f31, 0x54(r3)
/* 80271FAC 0026EEEC  80 6D 8C 38 */	lwz r3, systemConsole__9JFWSystem-_SDA_BASE_(r13)
...
/* 80271FF0 0026EF30  80 6D 8C 38 */	lwz r3, systemConsole__9JFWSystem-_SDA_BASE_(r13)
/* 80271FF4 0026EF34  90 03 00 58 */	stw r0, 0x58(r3)
/* 80271FF8 0026EF38  80 6D 8C 38 */	lwz r3, systemConsole__9JFWSystem-_SDA_BASE_(r13)
/* 80271FFC 0026EF3C  48 07 65 25 */	bl JUTSetReportConsole
/* 80272000 0026EF40  80 6D 8C 38 */	lwz r3, systemConsole__9JFWSystem-_SDA_BASE_(r13)
/* 80272004 0026EF44  48 07 65 2D */	bl JUTSetWarningConsole
/* 80272008 0026EF48  80 6D 8C 24 */	lwz r3, systemHeap__9JFWSystem-_SDA_BASE_(r13)
/* 8027200C 0026EF4C  80 8D 82 18 */	lwz r4, exConsoleBufferSize__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
/* 80272010 0026EF50  38 A0 00 04 */	li r5, 4
/* 80272014 0026EF54  48 05 C4 C1 */	bl alloc__7JKRHeapFUli
/* 80272018 0026EF58  80 8D 82 18 */	lwz r4, exConsoleBufferSize__Q29JFWSystem11CSetUpParam-_SDA_BASE_(r13)
/* 8027201C 0026EF5C  48 07 1F D1 */	bl createConsole__12JUTExceptionFPvUl

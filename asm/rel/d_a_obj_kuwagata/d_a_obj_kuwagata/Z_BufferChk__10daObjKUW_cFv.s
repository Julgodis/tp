...
/* 80C4BD48 0000000C  3C 60 00 00 */	lis r3, LIT_3775@ha
/* 80C4BD4C 00000010  3B E3 00 00 */	addi r31, LIT_3775@l
...
/* 80C4BD68 0000002C  C0 1F 00 48 */	lfs f0, 0x48(r31)
...
/* 80C4BD7C 00000040  4B FF E3 DD */	bl mDoLib_project__FP3VecP3Vec
/* 80C4BD80 00000044  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C4BD84 00000048  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C4BD88 0000004C  80 63 5D 74 */	lwz r3, 0x5d74(r3)
...
lbl_80C4BD9C:
/* 80C4BD9C 00000000  C0 7F 00 50 */	lfs f3, 0x50(r31)
lbl_80C4BDA0:
/* 80C4BDA0 00000000  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80C4BDA4 00000004  C0 1F 00 50 */	lfs f0, 0x50(r31)
/* 80C4BDA8 00000008  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C4BDAC 00000000  40 81 00 5C */	ble lbl_80C4BE08
/* 80C4BDB0 00000004  C0 1F 00 C0 */	lfs f0, 0xc0(r31)
...
/* 80C4BDC8 00000004  C0 1F 00 C4 */	lfs f0, 0xc4(r31)
...
/* 80C4BDD8 00000004  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C4BDDC 00000008  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C4BE04 00000030  4B FF E3 55 */	bl newData__13dDlst_peekZ_cFssPUl
lbl_80C4BE08:
/* 80C4BE08 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C4BE0C 00000004  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C4BE10 00000008  80 63 61 B0 */	lwz r3, 0x61b0(r3)
/* 80C4BE14 0000000C  C3 E3 00 C8 */	lfs f31, 0xc8(r3)
/* 80C4BE18 00000010  C3 C3 00 CC */	lfs f30, 0xcc(r3)
/* 80C4BE1C 00000014  38 61 00 08 */	addi r3, r1, 8
/* 80C4BE20 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 80C4BE24 0000001C  4B FF E3 35 */	bl mDoLib_pos2camera__FP3VecP3Vec
/* 80C4BE28 00000020  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80C4BE2C 00000024  C0 1F 00 5C */	lfs f0, 0x5c(r31)
/* 80C4BE30 00000028  EC 21 00 2A */	fadds f1, f1, f0
/* 80C4BE34 0000002C  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C4BE38 00000030  C0 1F 00 50 */	lfs f0, 0x50(r31)
...
lbl_80C4BE48:
/* 80C4BE48 00000000  C0 7F 00 C8 */	lfs f3, 0xc8(r31)
/* 80C4BE4C 00000004  C0 5F 00 4C */	lfs f2, 0x4c(r31)

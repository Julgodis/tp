...
/* 805C4704 00000010  3B C3 00 00 */	addi r30, LIT_3800@l
...
/* 805C4734 00000010  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 805C4738 00000014  4B FF 66 A1 */	bl PSMTXCopy
/* 805C473C 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4740 0000001C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C477C 0000001C  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 805C4780 00000020  4B FF 66 59 */	bl PSMTXCopy
/* 805C4784 00000024  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4788 00000028  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C47C4 0000001C  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 805C47C8 00000020  4B FF 66 11 */	bl PSMTXCopy
/* 805C47CC 00000024  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C47D0 00000028  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C4824 00000038  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
...
/* 805C4844 00000058  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C4870 00000084  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 805C4894 000000A8  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 805C4898 000000AC  4B FF 65 41 */	bl PSMTXCopy
/* 805C489C 000000B0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C48A0 000000B4  3B 63 00 00 */	addi r27, now__14mDoMtx_stack_c@l
...
/* 805C4904 00000118  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C4918 0000012C  38 63 00 00 */	addi r3, sincosTable___5JMath@l
...
/* 805C4934 00000148  38 63 00 00 */	addi r3, l_HIO@l
...
/* 805C4970 00000184  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
...
/* 805C4A30 00000010  38 63 00 00 */	addi r3, sincosTable___5JMath@l
/* 805C4A34 00000014  7C 03 04 2E */	lfsx f0, r3, r0
/* 805C4A38 00000018  3C 60 00 00 */	lis r3, l_HIO@ha
/* 805C4A3C 0000001C  38 63 00 00 */	addi r3, l_HIO@l
...
/* 805C4B7C 00000070  38 63 00 00 */	addi r3, sincosTable___5JMath@l
/* 805C4B80 00000074  7C 03 04 2E */	lfsx f0, r3, r0
/* 805C4B84 00000078  3C 60 00 00 */	lis r3, l_HIO@ha
/* 805C4B88 0000007C  38 63 00 00 */	addi r3, l_HIO@l
...
/* 805C4C68 00000024  38 63 00 00 */	addi r3, sincosTable___5JMath@l
...
/* 805C4C9C 00000058  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
...
/* 805C4CBC 00000078  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C4D18 000000D4  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
...
/* 805C4D38 000000F4  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 805C4D94 00000010  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
...
/* 805C4DB4 00000030  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l

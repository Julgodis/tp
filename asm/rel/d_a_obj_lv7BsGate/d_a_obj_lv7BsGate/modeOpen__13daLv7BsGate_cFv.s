...
/* 80C84D58 00000018  3C 60 00 00 */	lis r3, LIT_3628@ha
/* 80C84D5C 0000001C  3B E3 00 00 */	addi r31, LIT_3628@l
...
/* 80C84D74 00000034  4B FF FA A5 */	bl dComIfGp_getReverb__Fi
...
/* 80C84D88 00000048  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C84D8C 0000004C  38 63 00 00 */	addi r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C84D90 00000050  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C84DA0 00000060  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80C84DA4 00000064  FC 40 08 90 */	fmr f2, f1
/* 80C84DA8 00000068  C0 7F 00 14 */	lfs f3, 0x14(r31)
/* 80C84DAC 0000006C  FC 80 18 90 */	fmr f4, f3
/* 80C84DB0 00000070  39 00 00 00 */	li r8, 0
/* 80C84DB4 00000074  4B FF FA 65 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C84DB8:
/* 80C84DB8 00000000  38 7E 05 B8 */	addi r3, r30, 0x5b8
/* 80C84DBC 00000004  C0 3E 05 B4 */	lfs f1, 0x5b4(r30)
/* 80C84DC0 00000008  C0 5F 00 18 */	lfs f2, 0x18(r31)
/* 80C84DC4 0000000C  3C 80 00 00 */	lis r4, l_HIO@ha
/* 80C84DC8 00000010  38 84 00 00 */	addi r4, l_HIO@l
/* 80C84DCC 00000014  C0 64 00 04 */	lfs f3, 4(r4)
/* 80C84DD0 00000018  C0 9F 00 1C */	lfs f4, 0x1c(r31)
/* 80C84DD4 0000001C  4B FF FA 45 */	bl cLib_addCalc__FPfffff
/* 80C84DD8 00000020  C0 1F 00 08 */	lfs f0, 8(r31)
...
/* 80C84DF8 00000040  4B FF FA 21 */	bl dComIfGp_getReverb__Fi
...
/* 80C84E0C 00000054  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C84E10 00000058  38 63 00 00 */	addi r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C84E14 0000005C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C84E24 0000006C  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80C84E28 00000070  FC 40 08 90 */	fmr f2, f1
/* 80C84E2C 00000074  C0 7F 00 14 */	lfs f3, 0x14(r31)
/* 80C84E30 00000078  FC 80 18 90 */	fmr f4, f3
/* 80C84E34 0000007C  39 00 00 00 */	li r8, 0
/* 80C84E38 00000080  4B FF F9 E1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C84E3C:
/* 80C84E3C 00000000  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C84E40 00000004  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C84E44 00000008  C0 1F 00 10 */	lfs f0, 0x10(r31)
/* 80C84E48 0000000C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80C84E4C 00000010  D0 21 00 18 */	stfs f1, 0x18(r1)
/* 80C84E50 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C84E54 00000018  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C84E58 0000001C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C84E5C 00000020  3C 80 00 00 */	lis r4, l_HIO@ha
/* 80C84E60 00000024  38 84 00 00 */	addi r4, l_HIO@l
/* 80C84E64 00000028  88 84 00 0C */	lbz r4, 0xc(r4)
/* 80C84E68 0000002C  38 A0 00 0F */	li r5, 0xf
/* 80C84E6C 00000030  38 C1 00 10 */	addi r6, r1, 0x10
/* 80C84E70 00000034  4B FF F9 A9 */	bl StartShock__12dVibration_cFii4cXyz

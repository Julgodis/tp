...
/* 8074AC28 00000018  3C 60 00 00 */	lis r3, LIT_3910@ha
/* 8074AC2C 0000001C  3B E3 00 00 */	addi r31, LIT_3910@l
...
/* 8074AC44 00000034  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 8074AC48 00000038  38 84 00 00 */	addi r4, calc_mtx@l
...
/* 8074AC88 00000078  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8074AC8C 0000007C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 8074ACAC 0000009C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8074ACB0 000000A0  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 8074ACB4 000000A4  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 8074ACB8 000000A8  38 84 00 00 */	addi r4, calc_mtx@l
...
/* 8074ACD0 000000C0  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8074ACD4 000000C4  3B A3 00 00 */	addi r29, g_dComIfG_gameInfo@l
...
/* 8074AD44 00000134  3C 80 00 00 */	lis r4, l_HIO@ha
/* 8074AD48 00000138  38 84 00 00 */	addi r4, l_HIO@l
...
lbl_8074AD88:
/* 8074AD88 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8074AD8C 00000004  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 8074ADA4 0000001C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 8074ADA8 00000020  38 84 00 00 */	addi r4, g_dComIfG_gameInfo@l
...
/* 8074ADDC 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8074ADE0 00000058  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 8074AE20 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8074AE24 00000014  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 8074AE28 00000018  4B FF 70 31 */	bl mDoMtx_XrotM__FPA4_fs
/* 8074AE2C 0000001C  3C 60 00 00 */	lis r3, l_HIO@ha
/* 8074AE30 00000020  38 63 00 00 */	addi r3, l_HIO@l
...
/* 8074AE4C 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8074AE50 00000040  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l

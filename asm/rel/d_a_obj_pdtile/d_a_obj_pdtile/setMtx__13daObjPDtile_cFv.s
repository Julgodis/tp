...
/* 80CAAE94 00000014  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAE98 00000018  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 80CAAEB8 00000038  4B FF FD E1 */	bl PSMTXTrans
/* 80CAAEBC 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAEC0 00000040  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 80CAAED0 00000050  4B FF FD C9 */	bl mDoMtx_XYZrotM__FPA4_fsss
/* 80CAAED4 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAED8 00000058  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80CAAEDC 0000005C  38 9F 05 D8 */	addi r4, r31, 0x5d8
/* 80CAAEE0 00000060  4B FF FD B9 */	bl PSMTXCopy
...
/* 80CAAEF8 00000078  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAEFC 0000007C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80CAAF00 00000080  38 9F 05 A8 */	addi r4, r31, 0x5a8
/* 80CAAF04 00000084  4B FF FD 95 */	bl PSMTXCopy
/* 80CAAF08 00000088  48 00 00 74 */	b lbl_80CAAF7C
lbl_80CAAF0C:
/* 80CAAF0C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAF10 00000004  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 80CAAF20 00000014  4B FF FD 79 */	bl PSMTXTrans
/* 80CAAF24 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAF28 0000001C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80CAAF2C 00000020  38 80 00 00 */	li r4, 0
/* 80CAAF30 00000024  A8 BF 04 DE */	lha r5, 0x4de(r31)
/* 80CAAF34 00000028  38 C0 00 00 */	li r6, 0
/* 80CAAF38 0000002C  4B FF FD 61 */	bl mDoMtx_XYZrotM__FPA4_fsss
...
/* 80CAAF48 0000003C  3C 60 00 00 */	lis r3, LIT_3716@ha
/* 80CAAF4C 00000040  C0 23 00 00 */	lfs f1, LIT_3716@l(r3)
/* 80CAAF50 00000044  D0 21 00 08 */	stfs f1, 8(r1)
/* 80CAAF54 00000048  3C 60 00 00 */	lis r3, LIT_3717@ha
/* 80CAAF58 0000004C  C0 03 00 00 */	lfs f0, LIT_3717@l(r3)
...
/* 80CAAF68 0000005C  4B FF FD 31 */	bl scaleM__14mDoMtx_stack_cFRC4cXyz
lbl_80CAAF6C:
/* 80CAAF6C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CAAF70 00000004  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80CAAF74 00000008  38 9F 05 A8 */	addi r4, r31, 0x5a8
/* 80CAAF78 0000000C  4B FF FD 21 */	bl PSMTXCopy
lbl_80CAAF7C:

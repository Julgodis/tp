...
lbl_80C323F8:
/* 80C323F8 00000000  3C 60 00 00 */	lis r3, l_bmdData@ha
/* 80C323FC 00000004  38 83 00 00 */	addi r4, l_bmdData@l
/* 80C32400 00000008  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C32404 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80C32408 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80C3240C 00000014  38 63 00 00 */	addi r3, l_resNameList@l
/* 80C32410 00000018  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C32414 0000001C  80 84 00 08 */	lwz r4, 8(r4)
/* 80C32418 00000020  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C3241C 00000024  38 A5 00 00 */	addi r5, g_dComIfG_gameInfo@l
...
/* 80C3242C 00000034  4B FF F6 2D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C32430 00000038  48 00 00 3C */	b lbl_80C3246C
lbl_80C32434:
/* 80C32434 00000000  3C 60 00 00 */	lis r3, l_bmdData@ha
/* 80C32438 00000004  38 83 00 00 */	addi r4, l_bmdData@l
/* 80C3243C 00000008  80 04 00 04 */	lwz r0, 4(r4)
/* 80C32440 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80C32444 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80C32448 00000014  38 63 00 00 */	addi r3, l_resNameList@l
/* 80C3244C 00000018  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C32450 0000001C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C32454 00000020  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C32458 00000024  38 A5 00 00 */	addi r5, g_dComIfG_gameInfo@l
...
/* 80C32468 00000034  4B FF F5 F1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
lbl_80C3246C:
...
/* 80C32488 0000000C  4B FF F5 D1 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl

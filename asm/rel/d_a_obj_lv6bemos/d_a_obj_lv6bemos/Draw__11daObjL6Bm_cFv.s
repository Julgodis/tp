...
/* 80C7D8A8 00000010  4B FF F2 51 */	bl _savegpr_29
/* 80C7D8AC 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C7D8B0 00000018  3C 60 00 00 */	lis r3, l_sph_src@ha
/* 80C7D8B4 0000001C  3B E3 00 00 */	addi r31, l_sph_src@l
/* 80C7D8B8 00000020  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C7D8BC 00000024  38 63 00 00 */	addi r3, g_env_light@l
...
/* 80C7D8CC 00000034  4B FF F2 2D */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C7D8D0 00000038  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C7D8D4 0000003C  38 63 00 00 */	addi r3, g_env_light@l
...
/* 80C7D8E4 0000004C  4B FF F2 15 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C7D8E8 00000050  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C7D8EC 00000054  38 83 00 00 */	addi r4, g_dComIfG_gameInfo@l
/* 80C7D8F0 00000058  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C7D8F4 0000005C  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80C7D8F8 00000060  3B A3 00 00 */	addi r29, j3dSys@l
/* 80C7D8FC 00000064  90 1D 00 48 */	stw r0, 0x48(r29)
/* 80C7D900 00000068  80 04 5F 74 */	lwz r0, 0x5f74(r4)
/* 80C7D904 0000006C  90 1D 00 4C */	stw r0, 0x4c(r29)
/* 80C7D908 00000070  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80C7D90C 00000074  4B FF F1 ED */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C7D910 00000078  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C7D914 0000007C  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C7D918 00000080  80 03 5F 80 */	lwz r0, 0x5f80(r3)
/* 80C7D91C 00000084  90 1D 00 48 */	stw r0, 0x48(r29)
/* 80C7D920 00000088  80 03 5F 84 */	lwz r0, 0x5f84(r3)
/* 80C7D924 0000008C  90 1D 00 4C */	stw r0, 0x4c(r29)
...
/* 80C7D934 0000009C  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C7D938 000000A0  38 63 00 00 */	addi r3, g_env_light@l
...
/* 80C7D948 000000B0  4B FF F1 B1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C7D960 000000C8  4B FF F1 99 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C7D978 000000E0  4B FF F1 81 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C7D98C 000000F4  4B FF F1 6D */	bl entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C7D990 000000F8  80 7E 08 80 */	lwz r3, 0x880(r30)
/* 80C7D994 000000FC  4B FF F1 65 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C7D9C4 0000012C  4B FF F1 35 */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
...
/* 80C7D9DC 00000144  4B FF F1 1D */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_80C7D9E0:
/* 80C7D9E0 00000000  C0 3F 00 98 */	lfs f1, 0x98(r31)
...
/* 80C7D9F0 00000010  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C7D9F4 00000014  38 03 00 00 */	addi r0, __vt__8cM3dGPla@l
/* 80C7D9F8 00000018  90 01 00 18 */	stw r0, 0x18(r1)
/* 80C7D9FC 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C7DA00 00000020  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C7DA10 00000030  4B FF F0 E9 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C7DA14 00000034  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C7DA18 00000038  41 82 00 34 */	beq lbl_80C7DA4C
/* 80C7DA1C 0000003C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C7DA20 00000040  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C7DA30 00000050  C0 5F 00 9C */	lfs f2, 0x9c(r31)
/* 80C7DA34 00000054  38 A1 00 08 */	addi r5, r1, 8
/* 80C7DA38 00000058  38 C0 00 00 */	li r6, 0
/* 80C7DA3C 0000005C  C0 7F 00 6C */	lfs f3, 0x6c(r31)
/* 80C7DA40 00000060  3C E0 00 00 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80C7DA44 00000064  38 E7 00 00 */	addi r7, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80C7DA48 00000068  4B FF F0 B1 */	bl setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80C7DA4C:
/* 80C7DA4C 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C7DA50 00000004  38 03 00 00 */	addi r0, __vt__8cM3dGPla@l
...
/* 80C7DA60 00000008  4B FF F0 99 */	bl _restgpr_29

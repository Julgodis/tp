...
/* 80C3D5C4 00000010  3C 60 00 00 */	lis r3, __global_destructor_chain@ha
/* 80C3D5C8 00000014  3B E3 00 00 */	addi r31, __global_destructor_chain@l
/* 80C3D5CC 00000018  48 00 00 20 */	b lbl_80C3D5EC
lbl_80C3D5D0:
/* 80C3D5D0 00000000  80 05 00 00 */	lwz r0, 0(r5)
/* 80C3D5D4 00000004  90 1F 00 00 */	stw r0, 0(r31)
...
lbl_80C3D5EC:
/* 80C3D5EC 00000000  80 BF 00 00 */	lwz r5, 0(r31)

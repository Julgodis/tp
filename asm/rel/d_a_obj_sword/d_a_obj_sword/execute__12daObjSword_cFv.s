...
/* 80CFDC30 00000014  3C 60 00 00 */	lis r3, cNullVec__6Z2Calc@ha
/* 80CFDC34 00000018  38 C3 00 00 */	addi r6, cNullVec__6Z2Calc@l
/* 80CFDC38 0000001C  3C 60 00 00 */	lis r3, unknown_translation_unit_bss__data_80CFE01C@ha
/* 80CFDC3C 00000020  38 A3 00 00 */	addi r5, unknown_translation_unit_bss__data_80CFE01C@l
/* 80CFDC40 00000024  88 05 00 00 */	lbz r0, 0(r5)
/* 80CFDC44 00000028  7C 00 07 75 */	extsb. r0, r0
/* 80CFDC48 0000002C  40 82 00 58 */	bne lbl_80CFDCA0
/* 80CFDC4C 00000030  80 66 00 38 */	lwz r3, 0x38(r6)
/* 80CFDC50 00000034  80 06 00 3C */	lwz r0, 0x3c(r6)
/* 80CFDC54 00000038  90 66 00 5C */	stw r3, 0x5c(r6)
/* 80CFDC58 0000003C  90 06 00 60 */	stw r0, 0x60(r6)
/* 80CFDC5C 00000040  80 06 00 40 */	lwz r0, 0x40(r6)
/* 80CFDC60 00000044  90 06 00 64 */	stw r0, 0x64(r6)
/* 80CFDC64 00000048  38 86 00 5C */	addi r4, r6, 0x5c
/* 80CFDC68 0000004C  80 66 00 44 */	lwz r3, 0x44(r6)
/* 80CFDC6C 00000050  80 06 00 48 */	lwz r0, 0x48(r6)
/* 80CFDC70 00000054  90 64 00 0C */	stw r3, 0xc(r4)
/* 80CFDC74 00000058  90 04 00 10 */	stw r0, 0x10(r4)
/* 80CFDC78 0000005C  80 06 00 4C */	lwz r0, 0x4c(r6)
/* 80CFDC7C 00000060  90 04 00 14 */	stw r0, 0x14(r4)
/* 80CFDC80 00000064  80 66 00 50 */	lwz r3, 0x50(r6)
/* 80CFDC84 00000068  80 06 00 54 */	lwz r0, 0x54(r6)
/* 80CFDC88 0000006C  90 64 00 18 */	stw r3, 0x18(r4)
/* 80CFDC8C 00000070  90 04 00 1C */	stw r0, 0x1c(r4)
/* 80CFDC90 00000074  80 06 00 58 */	lwz r0, 0x58(r6)
/* 80CFDC94 00000078  90 04 00 20 */	stw r0, 0x20(r4)
/* 80CFDC98 0000007C  38 00 00 01 */	li r0, 1
/* 80CFDC9C 00000080  98 05 00 00 */	stb r0, 0(r5)
lbl_80CFDCA0:
...
/* 80CFDCC0 00000020  4B FF F8 79 */	bl __ptmf_scall

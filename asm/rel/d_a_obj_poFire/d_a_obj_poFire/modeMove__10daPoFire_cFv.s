...
/* 80CB3750 00000020  3C 60 00 00 */	lis r3, LIT_3662@ha
/* 80CB3754 00000024  3B C3 00 00 */	addi r30, LIT_3662@l
/* 80CB3758 00000028  C0 5E 00 3C */	lfs f2, 0x3c(r30)
/* 80CB375C 0000002C  C0 3F 05 EC */	lfs f1, 0x5ec(r31)
/* 80CB3760 00000030  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80CB3764 00000034  38 63 00 00 */	addi r3, l_HIO@l
/* 80CB3768 00000038  C0 03 00 14 */	lfs f0, 0x14(r3)
...
/* 80CB3784 00000054  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80CB3788 00000058  38 63 00 00 */	addi r3, sincosTable___5JMath@l
/* 80CB378C 0000005C  7C 23 04 2E */	lfsx f1, r3, r0
/* 80CB3790 00000060  C0 1E 00 00 */	lfs f0, 0(r30)
...
/* 80CB37B0 00000080  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80CB37B4 00000084  3C A0 00 00 */	lis r5, l_HIO@ha
/* 80CB37B8 00000088  38 A5 00 00 */	addi r5, l_HIO@l
/* 80CB37BC 0000008C  C0 45 00 1C */	lfs f2, 0x1c(r5)
/* 80CB37C0 00000090  C0 1F 05 E8 */	lfs f0, 0x5e8(r31)
/* 80CB37C4 00000094  EC 42 00 32 */	fmuls f2, f2, f0
/* 80CB37C8 00000098  C0 7E 00 28 */	lfs f3, 0x28(r30)
/* 80CB37CC 0000009C  4B FF F0 ED */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
/* 80CB37D0 000000A0  FF E0 08 90 */	fmr f31, f1
/* 80CB37D4 000000A4  C0 3F 05 EC */	lfs f1, 0x5ec(r31)
/* 80CB37D8 000000A8  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80CB37DC 000000AC  38 63 00 00 */	addi r3, l_HIO@l
/* 80CB37E0 000000B0  C0 03 00 18 */	lfs f0, 0x18(r3)
/* 80CB37E4 000000B4  EC 01 00 2A */	fadds f0, f1, f0
/* 80CB37E8 000000B8  D0 1F 05 EC */	stfs f0, 0x5ec(r31)
/* 80CB37EC 000000BC  C0 1E 00 40 */	lfs f0, 0x40(r30)
...
/* 80CB37FC 00000008  C0 3E 00 20 */	lfs f1, 0x20(r30)
/* 80CB3800 0000000C  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 80CB3804 00000010  C0 7E 00 0C */	lfs f3, 0xc(r30)
/* 80CB3808 00000014  C0 9E 00 44 */	lfs f4, 0x44(r30)
/* 80CB380C 00000018  4B FF F0 AD */	bl cLib_addCalc__FPfffff
/* 80CB3810 0000001C  48 00 00 0C */	b lbl_80CB381C
lbl_80CB3814:
/* 80CB3814 00000000  C0 1E 00 00 */	lfs f0, 0(r30)
/* 80CB3818 00000004  D0 1F 06 08 */	stfs f0, 0x608(r31)
lbl_80CB381C:
/* 80CB381C 00000000  C0 5E 00 3C */	lfs f2, 0x3c(r30)
/* 80CB3820 00000004  C0 3F 05 F0 */	lfs f1, 0x5f0(r31)
/* 80CB3824 00000008  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80CB3828 0000000C  38 83 00 00 */	addi r4, l_HIO@l
/* 80CB382C 00000010  C0 04 00 20 */	lfs f0, 0x20(r4)
...
/* 80CB3848 0000002C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80CB384C 00000030  38 63 00 00 */	addi r3, sincosTable___5JMath@l
/* 80CB3850 00000034  7C 63 04 2E */	lfsx f3, r3, r0
/* 80CB3854 00000038  C0 24 00 28 */	lfs f1, 0x28(r4)
...
/* 80CB386C 00000050  C0 04 00 20 */	lfs f0, 0x20(r4)
...
/* 80CB388C 00000070  C0 24 00 28 */	lfs f1, 0x28(r4)

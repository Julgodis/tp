...
/* 80878C4C 00000024  3C 60 00 00 */	lis r3, daMP_Fail_alloc@ha
/* 80878C50 00000028  90 03 00 00 */	stw r0, daMP_Fail_alloc@l(r3)
...
/* 80878C70 00000048  3C 80 00 00 */	lis r4, stringBase0@ha
/* 80878C74 0000004C  38 84 00 00 */	addi r4, stringBase0@l
...
/* 80878C9C 00000074  3C 60 00 00 */	lis r3, daMP_Fail_alloc@ha
/* 80878CA0 00000078  90 03 00 00 */	stw r0, daMP_Fail_alloc@l(r3)
lbl_80878CA4:
/* 80878CA4 00000000  3C 60 00 00 */	lis r3, daMP_Get_MovieRestFrame__Fv@ha
/* 80878CA8 00000004  38 03 00 00 */	addi r0, daMP_Get_MovieRestFrame__Fv@l
/* 80878CAC 00000008  90 1F 05 68 */	stw r0, 0x568(r31)
/* 80878CB0 0000000C  3C 60 00 00 */	lis r3, daMP_Set_PercentMovieVolume__Ff@ha
/* 80878CB4 00000010  38 03 00 00 */	addi r0, daMP_Set_PercentMovieVolume__Ff@l
/* 80878CB8 00000014  90 1F 05 6C */	stw r0, 0x56c(r31)
/* 80878CBC 00000018  3C 60 00 00 */	lis r3, daMP_THPPlayerGetTotalFrame__Fv@ha
/* 80878CC0 0000001C  38 03 00 00 */	addi r0, daMP_THPPlayerGetTotalFrame__Fv@l
/* 80878CC4 00000020  90 1F 05 70 */	stw r0, 0x570(r31)
/* 80878CC8 00000024  3C 60 00 00 */	lis r3, daMP_THPPlayerPlay__Fv@ha
/* 80878CCC 00000028  38 03 00 00 */	addi r0, daMP_THPPlayerPlay__Fv@l
/* 80878CD0 0000002C  90 1F 05 74 */	stw r0, 0x574(r31)
/* 80878CD4 00000030  3C 60 00 00 */	lis r3, daMP_THPPlayerStop__Fv@ha
/* 80878CD8 00000034  38 03 00 00 */	addi r0, daMP_THPPlayerStop__Fv@l
/* 80878CDC 00000038  90 1F 05 78 */	stw r0, 0x578(r31)
/* 80878CE0 0000003C  3C 60 00 00 */	lis r3, daMP_THPPlayerPause__Fv@ha
/* 80878CE4 00000040  38 03 00 00 */	addi r0, daMP_THPPlayerPause__Fv@l
/* 80878CE8 00000044  90 1F 05 7C */	stw r0, 0x57c(r31)
/* 80878CEC 00000048  3C 60 00 00 */	lis r3, m_myObj__6daMP_c@ha
/* 80878CF0 0000004C  93 E3 00 00 */	stw r31, m_myObj__6daMP_c@l(r3)

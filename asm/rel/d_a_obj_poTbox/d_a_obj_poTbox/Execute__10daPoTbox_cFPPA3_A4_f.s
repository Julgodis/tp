...
/* 80CB49B8 0000001C  3C 60 00 00 */	lis r3, cNullVec__6Z2Calc@ha
/* 80CB49BC 00000020  38 C3 00 00 */	addi r6, cNullVec__6Z2Calc@l
/* 80CB49C0 00000024  3C 60 00 00 */	lis r3, d_a_obj_poTbox__data_80CB514C@ha
/* 80CB49C4 00000028  38 A3 00 00 */	addi r5, d_a_obj_poTbox__data_80CB514C@l
/* 80CB49C8 0000002C  88 05 00 00 */	lbz r0, 0(r5)
/* 80CB49CC 00000030  7C 00 07 75 */	extsb. r0, r0
/* 80CB49D0 00000034  40 82 00 70 */	bne lbl_80CB4A40
/* 80CB49D4 00000038  80 66 00 38 */	lwz r3, 0x38(r6)
/* 80CB49D8 0000003C  80 06 00 3C */	lwz r0, 0x3c(r6)
/* 80CB49DC 00000040  90 66 00 68 */	stw r3, 0x68(r6)
/* 80CB49E0 00000044  90 06 00 6C */	stw r0, 0x6c(r6)
/* 80CB49E4 00000048  80 06 00 40 */	lwz r0, 0x40(r6)
/* 80CB49E8 0000004C  90 06 00 70 */	stw r0, 0x70(r6)
/* 80CB49EC 00000050  38 86 00 68 */	addi r4, r6, 0x68
/* 80CB49F0 00000054  80 66 00 44 */	lwz r3, 0x44(r6)
/* 80CB49F4 00000058  80 06 00 48 */	lwz r0, 0x48(r6)
/* 80CB49F8 0000005C  90 64 00 0C */	stw r3, 0xc(r4)
/* 80CB49FC 00000060  90 04 00 10 */	stw r0, 0x10(r4)
/* 80CB4A00 00000064  80 06 00 4C */	lwz r0, 0x4c(r6)
/* 80CB4A04 00000068  90 04 00 14 */	stw r0, 0x14(r4)
/* 80CB4A08 0000006C  80 66 00 50 */	lwz r3, 0x50(r6)
/* 80CB4A0C 00000070  80 06 00 54 */	lwz r0, 0x54(r6)
/* 80CB4A10 00000074  90 64 00 18 */	stw r3, 0x18(r4)
/* 80CB4A14 00000078  90 04 00 1C */	stw r0, 0x1c(r4)
/* 80CB4A18 0000007C  80 06 00 58 */	lwz r0, 0x58(r6)
/* 80CB4A1C 00000080  90 04 00 20 */	stw r0, 0x20(r4)
/* 80CB4A20 00000084  80 66 00 5C */	lwz r3, 0x5c(r6)
/* 80CB4A24 00000088  80 06 00 60 */	lwz r0, 0x60(r6)
/* 80CB4A28 0000008C  90 64 00 24 */	stw r3, 0x24(r4)
/* 80CB4A2C 00000090  90 04 00 28 */	stw r0, 0x28(r4)
/* 80CB4A30 00000094  80 06 00 64 */	lwz r0, 0x64(r6)
/* 80CB4A34 00000098  90 04 00 2C */	stw r0, 0x2c(r4)
/* 80CB4A38 0000009C  38 00 00 01 */	li r0, 1
/* 80CB4A3C 000000A0  98 05 00 00 */	stb r0, 0(r5)
lbl_80CB4A40:
...
/* 80CB4A54 00000014  4B FF F7 65 */	bl __ptmf_scall

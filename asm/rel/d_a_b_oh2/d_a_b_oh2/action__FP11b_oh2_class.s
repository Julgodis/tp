...
/* 8061E1F0 00000018  3C 60 00 00 */	lis r3, LIT_3678@ha
/* 8061E1F4 0000001C  3B E3 00 00 */	addi r31, LIT_3678@l
/* 8061E1F8 00000020  A8 1E 05 CE */	lha r0, 0x5ce(r30)
/* 8061E1FC 00000024  2C 00 00 00 */	cmpwi r0, 0
/* 8061E200 00000028  3C 60 00 00 */	lis r3, boss@ha
/* 8061E204 0000002C  38 63 00 00 */	addi r3, boss@l
/* 8061E208 00000030  80 63 00 00 */	lwz r3, 0(r3)
/* 8061E20C 00000034  80 63 05 C0 */	lwz r3, 0x5c0(r3)
/* 8061E210 00000038  80 63 00 04 */	lwz r3, 4(r3)
/* 8061E214 0000003C  80 63 00 84 */	lwz r3, 0x84(r3)
/* 8061E218 00000040  80 83 00 0C */	lwz r4, 0xc(r3)
...
/* 8061E22C 00000054  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 8061E230 00000058  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 8061E234 0000005C  4B FF FA 65 */	bl PSMTXCopy
/* 8061E238 00000060  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061E23C 00000064  38 83 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 8061E240 00000068  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 8061E244 0000006C  D0 1E 04 D0 */	stfs f0, 0x4d0(r30)
/* 8061E248 00000070  C0 04 00 1C */	lfs f0, 0x1c(r4)
/* 8061E24C 00000074  D0 1E 04 D4 */	stfs f0, 0x4d4(r30)
/* 8061E250 00000078  C0 04 00 2C */	lfs f0, 0x2c(r4)
/* 8061E254 0000007C  D0 1E 04 D8 */	stfs f0, 0x4d8(r30)
/* 8061E258 00000080  3C 60 00 00 */	lis r3, boss@ha
/* 8061E25C 00000084  38 63 00 00 */	addi r3, boss@l
/* 8061E260 00000088  80 63 00 00 */	lwz r3, 0(r3)
/* 8061E264 0000008C  80 63 05 C0 */	lwz r3, 0x5c0(r3)
/* 8061E268 00000090  80 63 00 04 */	lwz r3, 4(r3)
/* 8061E26C 00000094  80 63 00 84 */	lwz r3, 0x84(r3)
/* 8061E270 00000098  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8061E274 0000009C  4B FF FA 25 */	bl PSMTXCopy
/* 8061E278 000000A0  C0 7F 00 24 */	lfs f3, 0x24(r31)
/* 8061E27C 000000A4  C0 5F 00 28 */	lfs f2, 0x28(r31)
/* 8061E280 000000A8  80 1E 05 C8 */	lwz r0, 0x5c8(r30)
/* 8061E284 000000AC  C8 3F 00 30 */	lfd f1, 0x30(r31)
...
/* 8061E2A8 000000D0  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 8061E2B8 000000E0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061E2BC 000000E4  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 8061E2C0 000000E8  38 81 00 20 */	addi r4, r1, 0x20
/* 8061E2C4 000000EC  38 A1 00 14 */	addi r5, r1, 0x14
/* 8061E2C8 000000F0  4B FF F9 D1 */	bl PSMTXMultVec
...
/* 8061E2D8 00000100  4B FF F9 C1 */	bl __mi__4cXyzCFRC3Vec
...
/* 8061E2F4 0000011C  4B FF F9 A5 */	bl cM_atan2s__Fff
...
/* 8061E310 00000138  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 8061E328 00000004  4B FF F9 71 */	bl cM_atan2s__Fff
...
/* 8061E33C 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061E340 0000001C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 8061E350 0000002C  4B FF F9 49 */	bl PSMTXTrans
/* 8061E354 00000030  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061E358 00000034  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 8061E35C 00000038  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8061E360 0000003C  4B FF F9 39 */	bl mDoMtx_YrotM__FPA4_fs
/* 8061E364 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061E368 00000044  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 8061E36C 00000048  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 8061E370 0000004C  4B FF F9 29 */	bl mDoMtx_XrotM__FPA4_fs
/* 8061E374 00000050  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 8061E378 00000054  80 83 00 04 */	lwz r4, 4(r3)
/* 8061E37C 00000058  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061E380 0000005C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 8061E384 00000060  38 84 00 24 */	addi r4, r4, 0x24
/* 8061E388 00000064  4B FF F9 11 */	bl PSMTXCopy
/* 8061E38C 00000068  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8061E390 0000006C  7C 03 07 74 */	extsb r3, r0
/* 8061E394 00000070  4B FF F9 05 */	bl dComIfGp_getReverb__Fi
...
/* 8061E3A4 00000080  4B FF F8 F5 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 8061E3A8 00000084  3C 60 00 00 */	lis r3, boss@ha
/* 8061E3AC 00000088  38 63 00 00 */	addi r3, boss@l
/* 8061E3B0 0000008C  80 63 00 00 */	lwz r3, 0(r3)
/* 8061E3B4 00000090  C0 23 05 2C */	lfs f1, 0x52c(r3)
/* 8061E3B8 00000094  C0 1F 00 00 */	lfs f0, 0(r31)
...
/* 8061E3C8 00000008  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 8061E3E4 00000004  4B FF F8 B5 */	bl play__14mDoExt_baseAnmFv
/* 8061E3E8 00000008  80 7E 05 C4 */	lwz r3, 0x5c4(r30)
/* 8061E3EC 0000000C  4B FF F8 AD */	bl play__14mDoExt_baseAnmFv
lbl_8061E3F0:
/* 8061E3F0 00000000  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 8061E3F4 00000004  4B FF F8 A5 */	bl modelCalc__16mDoExt_McaMorfSOFv

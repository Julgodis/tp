...
/* 8061DE9C 00000004  4B FF FD FD */	bl _savegpr_24
/* 8061DEA0 00000008  7C 7C 1B 78 */	mr r28, r3
/* 8061DEA4 0000000C  3C 60 00 00 */	lis r3, LIT_3678@ha
/* 8061DEA8 00000010  3B E3 00 00 */	addi r31, LIT_3678@l
...
/* 8061DECC 00000034  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 8061DED0 00000038  38 63 00 00 */	addi r3, calc_mtx@l
/* 8061DED4 0000003C  80 63 00 00 */	lwz r3, 0(r3)
/* 8061DED8 00000040  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 8061DEDC 00000044  4B FF FD BD */	bl mDoMtx_YrotS__FPA4_fs
/* 8061DEE0 00000048  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 8061DEE4 0000004C  38 63 00 00 */	addi r3, calc_mtx@l
/* 8061DEE8 00000050  80 63 00 00 */	lwz r3, 0(r3)
/* 8061DEEC 00000054  A8 9C 04 E4 */	lha r4, 0x4e4(r28)
/* 8061DEF0 00000058  4B FF FD A9 */	bl mDoMtx_XrotM__FPA4_fs
/* 8061DEF4 0000005C  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 8061DF0C 00000074  C0 1F 00 08 */	lfs f0, 8(r31)
/* 8061DF10 00000078  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 8061DF14 0000007C  48 00 00 38 */	b lbl_8061DF4C
lbl_8061DF18:
/* 8061DF18 00000000  3C 60 00 00 */	lis r3, boss@ha
/* 8061DF1C 00000004  38 63 00 00 */	addi r3, boss@l
/* 8061DF20 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 8061DF24 0000000C  A8 03 47 52 */	lha r0, 0x4752(r3)
/* 8061DF28 00000010  2C 00 00 65 */	cmpwi r0, 0x65
/* 8061DF2C 00000014  40 82 00 10 */	bne lbl_8061DF3C
/* 8061DF30 00000018  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8061DF34 0000001C  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 8061DF38 00000020  48 00 00 14 */	b lbl_8061DF4C
lbl_8061DF3C:
/* 8061DF3C 00000000  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 8061DF40 00000004  C0 03 5D 04 */	lfs f0, 0x5d04(r3)
...
/* 8061DF54 00000008  4B FF FD 45 */	bl MtxPosition__FP4cXyzP4cXyz
/* 8061DF58 0000000C  C0 3F 00 04 */	lfs f1, 4(r31)
...
/* 8061DF6C 00000020  C3 FF 00 00 */	lfs f31, 0(r31)
/* 8061DF70 00000024  FF C0 08 90 */	fmr f30, f1
/* 8061DF74 00000028  C3 BF 00 14 */	lfs f29, 0x14(r31)
/* 8061DF78 0000002C  3C 60 00 00 */	lis r3, boss@ha
/* 8061DF7C 00000030  38 63 00 00 */	addi r3, boss@l
/* 8061DF80 00000034  80 63 00 00 */	lwz r3, 0(r3)
/* 8061DF84 00000038  C0 03 05 2C */	lfs f0, 0x52c(r3)
/* 8061DF88 0000003C  FC 00 F8 40 */	fcmpo cr0, f0, f31
/* 8061DF8C 00000000  40 80 00 14 */	bge lbl_8061DFA0
/* 8061DF90 00000004  C0 3F 00 0C */	lfs f1, 0xc(r31)
/* 8061DF94 00000008  C0 03 47 A0 */	lfs f0, 0x47a0(r3)
/* 8061DF98 0000000C  EF A1 00 2A */	fadds f29, f1, f0
/* 8061DF9C 00000010  C3 DF 00 18 */	lfs f30, 0x18(r31)
lbl_8061DFA0:
/* 8061DFA0 00000000  3B 40 00 01 */	li r26, 1
/* 8061DFA4 00000004  C3 7F 00 1C */	lfs f27, 0x1c(r31)
/* 8061DFA8 00000008  C3 9F 00 04 */	lfs f28, 4(r31)
/* 8061DFAC 0000000C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 8061DFB0 00000010  3B 63 00 00 */	addi r27, calc_mtx@l
lbl_8061DFB4:
...
/* 8061E018 0000002C  4B FF FC 81 */	bl cM_atan2s__Fff
...
/* 8061E040 00000004  4B FF FC 59 */	bl cM_atan2s__Fff
/* 8061E044 00000008  7C 03 00 D0 */	neg r0, r3
/* 8061E048 0000000C  7C 19 07 34 */	extsh r25, r0
/* 8061E04C 00000010  80 7B 00 00 */	lwz r3, 0(r27)
/* 8061E050 00000014  7F 04 C3 78 */	mr r4, r24
/* 8061E054 00000018  4B FF FC 45 */	bl mDoMtx_YrotS__FPA4_fs
/* 8061E058 0000001C  80 7B 00 00 */	lwz r3, 0(r27)
/* 8061E05C 00000020  7F 24 CB 78 */	mr r4, r25
/* 8061E060 00000024  4B FF FC 39 */	bl mDoMtx_XrotM__FPA4_fs
/* 8061E064 00000028  38 61 00 20 */	addi r3, r1, 0x20
/* 8061E068 0000002C  38 81 00 14 */	addi r4, r1, 0x14
/* 8061E06C 00000030  4B FF FC 2D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8061E0BC 00000080  C0 1F 00 20 */	lfs f0, 0x20(r31)
...
/* 8061E0D8 0000009C  3C 80 00 00 */	lis r4, boss@ha
/* 8061E0DC 000000A0  38 A4 00 00 */	addi r5, boss@l
/* 8061E0E0 000000A4  C0 5F 00 00 */	lfs f2, 0(r31)
/* 8061E0E4 000000A8  38 00 00 1E */	li r0, 0x1e
/* 8061E0E8 000000AC  7C 09 03 A6 */	mtctr r0
lbl_8061E0EC:
/* 8061E0EC 00000000  80 85 00 00 */	lwz r4, 0(r5)
/* 8061E0F0 00000004  C0 04 05 2C */	lfs f0, 0x52c(r4)
...
/* 8061E108 00000010  3C 80 00 00 */	lis r4, sincosTable___5JMath@ha
/* 8061E10C 00000014  38 84 00 00 */	addi r4, sincosTable___5JMath@l
...
/* 8061E188 00000008  4B FF FB 11 */	bl _restgpr_24

...
/* 80CCF424 00000040  3C 60 00 00 */	lis r3, m__21daObj_Sekizoa_Param_c@ha
/* 80CCF428 00000044  38 63 00 00 */	addi r3, m__21daObj_Sekizoa_Param_c@l
...
/* 80CCF470 0000008C  4B FF EE 49 */	bl SetWallR__12dBgS_AcchCirFf
/* 80CCF474 00000090  3C 60 00 00 */	lis r3, m__21daObj_Sekizoa_Param_c@ha
/* 80CCF478 00000094  38 63 00 00 */	addi r3, m__21daObj_Sekizoa_Param_c@l
...
lbl_80CCF4B8:
/* 80CCF4B8 00000000  3C 60 00 00 */	lis r3, LIT_4350@ha
/* 80CCF4BC 00000004  C0 03 00 00 */	lfs f0, LIT_4350@l(r3)
...
/* 80CCF518 00000004  4B FF ED A1 */	bl daNpcT_chkEvtBit__FUl
/* 80CCF51C 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF520 0000000C  41 82 00 24 */	beq lbl_80CCF544
/* 80CCF524 00000010  3C 60 00 00 */	lis r3, l_srcPosL@ha
/* 80CCF528 00000014  C4 03 00 00 */	lfsu f0, l_srcPosL@l(r3)
...
lbl_80CCF544:
/* 80CCF544 00000000  3C 60 00 00 */	lis r3, l_srcPosR@ha
/* 80CCF548 00000004  C4 03 00 00 */	lfsu f0, l_srcPosR@l(r3)
...
/* 80CCF568 00000004  4B FF ED 51 */	bl daNpcT_chkEvtBit__FUl
/* 80CCF56C 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF570 0000000C  41 82 00 24 */	beq lbl_80CCF594
/* 80CCF574 00000010  3C 60 00 00 */	lis r3, l_srcPosR@ha
/* 80CCF578 00000014  C4 03 00 00 */	lfsu f0, l_srcPosR@l(r3)
...
lbl_80CCF594:
/* 80CCF594 00000000  3C 60 00 00 */	lis r3, l_srcPosL@ha
/* 80CCF598 00000004  C4 03 00 00 */	lfsu f0, l_srcPosL@l(r3)
...
/* 80CCF5B8 00000004  4B FF ED 01 */	bl daNpcT_chkEvtBit__FUl
/* 80CCF5BC 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF5C0 0000000C  41 82 00 24 */	beq lbl_80CCF5E4
/* 80CCF5C4 00000010  3C 60 00 00 */	lis r3, l_srcPosL@ha
/* 80CCF5C8 00000014  C4 03 00 00 */	lfsu f0, l_srcPosL@l(r3)
...
lbl_80CCF5E4:
/* 80CCF5E4 00000000  3C 60 00 00 */	lis r3, l_srcPosR@ha
/* 80CCF5E8 00000004  C4 03 00 00 */	lfsu f0, l_srcPosR@l(r3)
...
/* 80CCF608 00000004  4B FF EC B1 */	bl daNpcT_chkEvtBit__FUl
/* 80CCF60C 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF610 0000000C  41 82 00 24 */	beq lbl_80CCF634
/* 80CCF614 00000010  3C 60 00 00 */	lis r3, l_srcPosR@ha
/* 80CCF618 00000014  C4 03 00 00 */	lfsu f0, l_srcPosR@l(r3)
...
lbl_80CCF634:
/* 80CCF634 00000000  3C 60 00 00 */	lis r3, l_srcPosL@ha
/* 80CCF638 00000004  C4 03 00 00 */	lfsu f0, l_srcPosL@l(r3)
...
/* 80CCF690 0000002C  4B FF EC 29 */	bl setPos__8daNpcT_cF4cXyz
/* 80CCF694 00000030  7F E3 FB 78 */	mr r3, r31
/* 80CCF698 00000034  A8 81 00 0A */	lha r4, 0xa(r1)
/* 80CCF69C 00000038  4B FF EC 1D */	bl setAngle__8daNpcT_cFs

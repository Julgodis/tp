...
/* 80C2C7F0 0000000C  3C 60 00 00 */	lis r3, LIT_3775@ha
/* 80C2C7F4 00000010  3B E3 00 00 */	addi r31, LIT_3775@l
...
/* 80C2C810 0000002C  C0 1F 00 4C */	lfs f0, 0x4c(r31)
...
/* 80C2C824 00000040  4B FF E5 B5 */	bl mDoLib_project__FP3VecP3Vec
/* 80C2C828 00000044  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C2C82C 00000048  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C2C830 0000004C  80 63 5D 74 */	lwz r3, 0x5d74(r3)
...
lbl_80C2C844:
/* 80C2C844 00000000  C0 7F 00 54 */	lfs f3, 0x54(r31)
lbl_80C2C848:
/* 80C2C848 00000000  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80C2C84C 00000004  C0 1F 00 54 */	lfs f0, 0x54(r31)
/* 80C2C850 00000008  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C2C854 00000000  40 81 00 5C */	ble lbl_80C2C8B0
/* 80C2C858 00000004  C0 1F 00 C4 */	lfs f0, 0xc4(r31)
...
/* 80C2C870 00000004  C0 1F 00 C8 */	lfs f0, 0xc8(r31)
...
/* 80C2C880 00000004  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C2C884 00000008  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C2C8AC 00000030  4B FF E5 2D */	bl newData__13dDlst_peekZ_cFssPUl
lbl_80C2C8B0:
/* 80C2C8B0 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C2C8B4 00000004  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C2C8B8 00000008  80 63 61 B0 */	lwz r3, 0x61b0(r3)
/* 80C2C8BC 0000000C  C3 E3 00 C8 */	lfs f31, 0xc8(r3)
/* 80C2C8C0 00000010  C3 C3 00 CC */	lfs f30, 0xcc(r3)
/* 80C2C8C4 00000014  38 61 00 08 */	addi r3, r1, 8
/* 80C2C8C8 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 80C2C8CC 0000001C  4B FF E5 0D */	bl mDoLib_pos2camera__FP3VecP3Vec
/* 80C2C8D0 00000020  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80C2C8D4 00000024  C0 1F 00 60 */	lfs f0, 0x60(r31)
/* 80C2C8D8 00000028  EC 21 00 2A */	fadds f1, f1, f0
/* 80C2C8DC 0000002C  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C2C8E0 00000030  C0 1F 00 54 */	lfs f0, 0x54(r31)
...
lbl_80C2C8F0:
/* 80C2C8F0 00000000  C0 7F 00 CC */	lfs f3, 0xcc(r31)
/* 80C2C8F4 00000004  C0 5F 00 50 */	lfs f2, 0x50(r31)

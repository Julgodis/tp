...
/* 80C78DC4 00000004  4B FF ED D5 */	bl _savegpr_29
/* 80C78DC8 00000008  7C 7E 1B 78 */	mr r30, r3
/* 80C78DCC 0000000C  3C 60 00 00 */	lis r3, LIT_3651@ha
/* 80C78DD0 00000010  3B E3 00 00 */	addi r31, LIT_3651@l
...
/* 80C78E10 00000050  4B FF ED 89 */	bl __mi__4cXyzCFRC3Vec
/* 80C78E14 00000054  38 61 00 20 */	addi r3, r1, 0x20
/* 80C78E18 00000058  4B FF ED 81 */	bl PSVECSquareMag
/* 80C78E1C 0000005C  C0 1F 00 AC */	lfs f0, 0xac(r31)
...
/* 80C78E2C 00000008  C8 9F 00 C8 */	lfd f4, 0xc8(r31)
/* 80C78E30 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C78E34 00000010  C8 7F 00 D0 */	lfd f3, 0xd0(r31)
...
lbl_80C78E7C:
/* 80C78E7C 00000000  C8 1F 00 D8 */	lfd f0, 0xd8(r31)
/* 80C78E80 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C78E84 00000000  40 80 00 10 */	bge lbl_80C78E94
/* 80C78E88 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C78E8C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80C78EF8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C78EFC 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80C78F00:
/* 80C78F00 00000000  C0 1F 00 04 */	lfs f0, 4(r31)
/* 80C78F04 00000004  EF E0 00 72 */	fmuls f31, f0, f1
/* 80C78F08 00000008  C0 1F 00 BC */	lfs f0, 0xbc(r31)
...
lbl_80C78F18:
/* 80C78F18 00000000  C0 1F 00 F8 */	lfs f0, 0xf8(r31)
...
/* 80C78F30 00000008  C0 3F 00 EC */	lfs f1, 0xec(r31)
/* 80C78F34 0000000C  C0 5E 05 2C */	lfs f2, 0x52c(r30)
/* 80C78F38 00000010  C0 7F 00 F0 */	lfs f3, 0xf0(r31)
/* 80C78F3C 00000014  4B FF EC 5D */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
/* 80C78F40 00000018  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C78F44 0000001C  7C 03 07 74 */	extsb r3, r0
/* 80C78F48 00000020  4B FF EC 51 */	bl dComIfGp_getReverb__Fi
/* 80C78F4C 00000024  7C 7D 1B 78 */	mr r29, r3
/* 80C78F50 00000028  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 80C78F54 0000002C  4B FF EC 45 */	bl __cvt_fp2unsigned
...
/* 80C78F68 00000040  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C78F6C 00000044  38 63 00 00 */	addi r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C78F70 00000048  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C78F80 00000058  C0 3F 00 EC */	lfs f1, 0xec(r31)
/* 80C78F84 0000005C  FC 40 08 90 */	fmr f2, f1
/* 80C78F88 00000060  C0 7F 00 F4 */	lfs f3, 0xf4(r31)
/* 80C78F8C 00000064  FC 80 18 90 */	fmr f4, f3
/* 80C78F90 00000068  39 00 00 00 */	li r8, 0
/* 80C78F94 0000006C  4B FF EC 05 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C78FA4 0000007C  4B FF EB F5 */	bl __mi__4cXyzCFRC3Vec
/* 80C78FA8 00000080  38 61 00 14 */	addi r3, r1, 0x14
/* 80C78FAC 00000084  4B FF EB ED */	bl PSVECSquareMag
/* 80C78FB0 00000088  C0 1F 00 AC */	lfs f0, 0xac(r31)
...
/* 80C78FC0 00000008  C8 9F 00 C8 */	lfd f4, 0xc8(r31)
/* 80C78FC4 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C78FC8 00000010  C8 7F 00 D0 */	lfd f3, 0xd0(r31)
...
lbl_80C79010:
/* 80C79010 00000000  C8 1F 00 D8 */	lfd f0, 0xd8(r31)
/* 80C79014 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C79018 00000000  40 80 00 10 */	bge lbl_80C79028
/* 80C7901C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C79020 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80C7908C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C79090 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80C79094:
...
/* 80C790B0 00000008  4B FF EA E9 */	bl _restgpr_29

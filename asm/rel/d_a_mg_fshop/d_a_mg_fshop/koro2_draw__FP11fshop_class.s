...
/* 8086C244 00000008  38 83 00 00 */	addi r4, g_dComIfG_gameInfo@l
/* 8086C248 0000000C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8086C24C 00000010  3C 60 00 00 */	lis r3, j3dSys@ha
/* 8086C250 00000014  38 63 00 00 */	addi r3, j3dSys@l
...
/* 8086C264 00000004  38 63 00 00 */	addi r3, g_env_light@l
/* 8086C268 00000008  3C 80 00 00 */	lis r4, ArcIX_A_crwaku_model@ha
/* 8086C26C 0000000C  38 84 00 00 */	addi r4, ArcIX_A_crwaku_model@l
...
/* 8086C284 00000024  38 63 00 00 */	addi r3, ArcIX_A_crwaku_model@l
...
/* 8086C29C 0000003C  3B A3 00 00 */	addi r29, g_env_light@l
lbl_8086C2A0:
...
/* 8086C2DC 00000014  38 83 00 00 */	addi r4, g_dComIfG_gameInfo@l
/* 8086C2E0 00000018  80 04 5F 80 */	lwz r0, 0x5f80(r4)
/* 8086C2E4 0000001C  3C 60 00 00 */	lis r3, j3dSys@ha
/* 8086C2E8 00000020  38 63 00 00 */	addi r3, j3dSys@l

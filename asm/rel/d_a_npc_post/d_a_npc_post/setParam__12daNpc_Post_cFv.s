...
/* 80AA9A8C 00000010  4B FF F1 6D */	bl _savegpr_29
...
/* 80AA9AA0 00000024  3C 60 00 00 */	lis r3, m__18daNpc_Post_Param_c@ha
/* 80AA9AA4 00000028  38 83 00 00 */	addi r4, m__18daNpc_Post_Param_c@l
/* 80AA9AA8 0000002C  AB A4 00 48 */	lha r29, 0x48(r4)
/* 80AA9AAC 00000030  AB C4 00 4A */	lha r30, 0x4a(r4)
/* 80AA9AB0 00000034  A8 64 00 4C */	lha r3, 0x4c(r4)
/* 80AA9AB4 00000038  A8 84 00 4E */	lha r4, 0x4e(r4)
/* 80AA9AB8 0000003C  4B FF F1 41 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80AA9AD0 00000054  4B FF F1 29 */	bl daNpcT_getDistTableIdx__Fii
...
/* 80AA9AE0 00000064  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80AA9AE4 00000068  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80AA9AE8 0000006C  80 63 5D B4 */	lwz r3, 0x5db4(r3)
/* 80AA9AEC 00000070  80 03 05 74 */	lwz r0, 0x574(r3)
...
lbl_80AA9B04:
/* 80AA9B04 00000000  3C 60 00 00 */	lis r3, m__18daNpc_Post_Param_c@ha
/* 80AA9B08 00000004  38 63 00 00 */	addi r3, m__18daNpc_Post_Param_c@l
/* 80AA9B0C 00000008  C0 03 00 08 */	lfs f0, 8(r3)
...
/* 80AA9B1C 00000018  C0 03 00 10 */	lfs f0, 0x10(r3)
...
/* 80AA9B30 0000002C  C0 03 00 14 */	lfs f0, 0x14(r3)
/* 80AA9B34 00000030  D0 1F 0D EC */	stfs f0, 0xdec(r31)
/* 80AA9B38 00000034  C0 03 00 1C */	lfs f0, 0x1c(r3)
/* 80AA9B3C 00000038  D0 1F 0D F0 */	stfs f0, 0xdf0(r31)
/* 80AA9B40 0000003C  C0 03 00 50 */	lfs f0, 0x50(r3)
...
/* 80AA9B50 0000004C  4B FF F0 A9 */	bl SetWallR__12dBgS_AcchCirFf
/* 80AA9B54 00000050  3C 60 00 00 */	lis r3, m__18daNpc_Post_Param_c@ha
/* 80AA9B58 00000054  38 63 00 00 */	addi r3, m__18daNpc_Post_Param_c@l
/* 80AA9B5C 00000058  C0 03 00 18 */	lfs f0, 0x18(r3)
/* 80AA9B60 0000005C  D0 1F 08 D0 */	stfs f0, 0x8d0(r31)
/* 80AA9B64 00000060  C0 03 00 0C */	lfs f0, 0xc(r3)
/* 80AA9B68 00000064  D0 1F 0D E8 */	stfs f0, 0xde8(r31)
/* 80AA9B6C 00000068  C0 03 00 6C */	lfs f0, 0x6c(r3)
/* 80AA9B70 0000006C  D0 1F 0A 80 */	stfs f0, 0xa80(r31)
/* 80AA9B74 00000070  C0 03 00 44 */	lfs f0, 0x44(r3)
/* 80AA9B78 00000074  D0 1F 0A 84 */	stfs f0, 0xa84(r31)
/* 80AA9B7C 00000078  C0 03 00 04 */	lfs f0, 4(r3)
...
/* 80AA9B90 0000008C  4B FF F0 69 */	bl _restgpr_29

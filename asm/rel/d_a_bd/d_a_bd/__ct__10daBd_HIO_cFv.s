lbl_804D6C4C:
/* 804D6C4C 00000000  3C 80 00 00 */	lis r4, LIT_3942@ha
/* 804D6C50 00000004  38 A4 00 00 */	addi r5, LIT_3942@l
/* 804D6C54 00000008  3C 80 00 00 */	lis r4, __vt__10daBd_HIO_c@ha
/* 804D6C58 0000000C  38 04 00 00 */	addi r0, __vt__10daBd_HIO_c@l
/* 804D6C5C 00000010  90 03 00 00 */	stw r0, 0(r3)
/* 804D6C60 00000014  38 00 FF FF */	li r0, -1
/* 804D6C64 00000018  98 03 00 04 */	stb r0, 4(r3)
/* 804D6C68 0000001C  C0 05 00 00 */	lfs f0, 0(r5)
/* 804D6C6C 00000020  D0 03 00 08 */	stfs f0, 8(r3)
/* 804D6C70 00000024  C0 05 00 04 */	lfs f0, 4(r5)
/* 804D6C74 00000028  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 804D6C78 0000002C  C0 05 00 08 */	lfs f0, 8(r5)
...
/* 804D6C88 0000003C  C0 05 00 0C */	lfs f0, 0xc(r5)

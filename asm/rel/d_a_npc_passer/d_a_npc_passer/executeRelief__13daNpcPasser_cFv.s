lbl_80AA4128:
/* 80AA4128 00000000  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 80AA412C 00000004  7C 08 02 A6 */	mflr r0
/* 80AA4130 00000008  90 01 00 24 */	stw r0, 0x24(r1)
/* 80AA4134 0000000C  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 80AA4138 00000010  7C 7F 1B 78 */	mr r31, r3
...
/* 80AA4160 00000014  2C 00 00 02 */	cmpwi r0, 2
/* 80AA4164 00000018  40 82 00 28 */	bne lbl_80AA418C
/* 80AA4168 0000001C  80 1F 0A 98 */	lwz r0, 0xa98(r31)
/* 80AA416C 00000020  2C 00 00 00 */	cmpwi r0, 0
/* 80AA4170 00000024  41 82 00 0C */	beq lbl_80AA417C
/* 80AA4174 00000028  2C 00 00 01 */	cmpwi r0, 1
/* 80AA4178 0000002C  40 82 00 14 */	bne lbl_80AA418C
lbl_80AA417C:
/* 80AA417C 00000000  7F E3 FB 78 */	mr r3, r31
/* 80AA4180 00000004  38 80 00 03 */	li r4, 3
/* 80AA4184 00000008  4B FF F0 69 */	bl setAction__13daNpcPasser_cFQ213daNpcPasser_c6Mode_e
/* 80AA4188 0000000C  48 00 00 10 */	b lbl_80AA4198
lbl_80AA418C:
/* 80AA418C 00000000  7F E3 FB 78 */	mr r3, r31
/* 80AA4190 00000004  38 80 00 01 */	li r4, 1
/* 80AA4194 00000008  4B FF F0 59 */	bl setAction__13daNpcPasser_cFQ213daNpcPasser_c6Mode_e
lbl_80AA4198:
...
/* 80AA41A4 0000000C  38 63 00 00 */	addi r3, fpcSch_JudgeByID__FPvPv@l
...
/* 80AA41DC 00000020  38 21 00 20 */	addi r1, r1, 0x20
/* 80AA41E0 00000024  4E 80 00 20 */	blr 

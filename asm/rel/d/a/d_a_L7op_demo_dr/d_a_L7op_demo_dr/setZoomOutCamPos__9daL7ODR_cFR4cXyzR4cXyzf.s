...
/* 805ABC58 00000018  4B CC 50 1C */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 805ABC6C 0000002C  4B CC 4F 98 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805ABC80 00000040  4B A6 10 E4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 805ABC84 00000044  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805ABC88 00000048  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805ABC8C 0000004C  A8 81 00 0A */	lha r4, 0xa(r1)
/* 805ABC90 00000050  4B A6 07 A4 */	b mDoMtx_YrotM__FPA4_fs
/* 805ABC94 00000054  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805ABC98 00000058  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805ABC9C 0000005C  A8 81 00 08 */	lha r4, 8(r1)
/* 805ABCA0 00000060  4B A6 06 FC */	b mDoMtx_XrotM__FPA4_fs
/* 805ABCA4 00000064  3C 60 80 5B */	lis r3, lit_3852@ha
/* 805ABCA8 00000068  C0 23 DF 58 */	lfs f1, lit_3852@l(r3)
/* 805ABCAC 0000006C  FC 40 08 90 */	fmr f2, f1
/* 805ABCB0 00000070  FC 60 F8 90 */	fmr f3, f31
/* 805ABCB4 00000074  4B A6 10 E8 */	b transM__14mDoMtx_stack_cFfff
/* 805ABCB8 00000078  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805ABCBC 0000007C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805ABCC0 00000080  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 805ABCC4 00000084  D0 1E 00 00 */	stfs f0, 0(r30)
/* 805ABCC8 00000088  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 805ABCCC 0000008C  D0 1E 00 04 */	stfs f0, 4(r30)
/* 805ABCD0 00000090  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */

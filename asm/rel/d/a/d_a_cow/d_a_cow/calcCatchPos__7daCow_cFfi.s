...
/* 8065DC28 00000004  4B D0 45 AC */	b _savegpr_27
/* 8065DC2C 00000008  7C 7B 1B 78 */	mr r27, r3
/* 8065DC30 0000000C  FF C0 08 90 */	fmr f30, f1
/* 8065DC34 00000010  7C 9C 23 78 */	mr r28, r4
/* 8065DC38 00000014  3C 60 80 66 */	lis r3, lit_3987@ha
/* 8065DC3C 00000018  3B C3 2D B0 */	addi r30, r3, lit_3987@l
/* 8065DC40 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8065DC44 00000020  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 8065DC48 00000024  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 8065DC74 00000050  C0 3E 00 18 */	lfs f1, 0x18(r30)	/* effective address: 80662DC8 */
...
/* 8065DC9C 00000078  4B CE 97 00 */	b PSVECSquareDistance
/* 8065DCA0 0000007C  C0 1E 00 18 */	lfs f0, 0x18(r30)	/* effective address: 80662DC8 */
...
/* 8065DCB0 00000008  C8 9E 00 68 */	lfd f4, 0x68(r30)	/* effective address: 80662E18 */
/* 8065DCB4 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8065DCB8 00000010  C8 7E 00 70 */	lfd f3, 0x70(r30)	/* effective address: 80662E20 */
...
lbl_8065DD00:
/* 8065DD00 00000000  C8 1E 00 78 */	lfd f0, 0x78(r30)	/* effective address: 80662E28 */
/* 8065DD04 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8065DD08 00000000  40 80 00 10 */	bge lbl_8065DD18
/* 8065DD0C 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065DD10 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8065DD7C 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065DD80 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8065DD84:
/* 8065DD84 00000000  FC 40 F8 90 */	fmr f2, f31
/* 8065DD88 00000004  4B C0 98 EC */	b cM_atan2s__Fff
/* 8065DD8C 00000008  7C 65 07 34 */	extsh r5, r3
/* 8065DD90 0000000C  C0 1E 00 18 */	lfs f0, 0x18(r30)	/* effective address: 80662DC8 */
/* 8065DD94 00000010  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 8065DD98 00000014  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8065DD9C 00000018  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 8065DDE8 00000064  4B C1 27 58 */	b cLib_addCalcAngleS__FPsssss
...
/* 8065DDFC 00000078  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 8065DE0C 00000088  4B C1 2F B4 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 8065DE10 0000008C  38 7B 04 D0 */	addi r3, r27, 0x4d0
/* 8065DE14 00000090  38 81 00 24 */	addi r4, r1, 0x24
/* 8065DE18 00000094  C0 3E 00 CC */	lfs f1, 0xcc(r30)	/* effective address: 80662E7C */
/* 8065DE1C 00000098  4B C1 29 90 */	b cLib_chasePos__FP4cXyzRC4cXyzf
/* 8065DE20 0000009C  48 00 00 28 */	b lbl_8065DE48
lbl_8065DE24:
/* 8065DE24 00000000  38 7B 04 D0 */	addi r3, r27, 0x4d0
/* 8065DE28 00000004  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 8065DE38 00000014  4B C1 2F 88 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 8065DE5C 00000008  4B D0 43 C4 */	b _restgpr_27

...
/* 8065C72C  4B D0 5A B0 */	b _savegpr_29
/* 8065C730  7C 7D 1B 78 */	mr r29, r3
/* 8065C734  3C 60 80 66 */	lis r3, lit_1109@ha
/* 8065C738  3B C3 34 60 */	addi r30, r3, lit_1109@l
/* 8065C73C  3C 60 80 66 */	lis r3, lit_3987@ha
/* 8065C740  3B E3 2D B0 */	addi r31, r3, lit_3987@l
/* 8065C744  38 61 00 3C */	addi r3, r1, 0x3c
/* 8065C748  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 8065C74C  38 BE 00 4C */	addi r5, r30, 0x4c
/* 8065C750  4B C0 A3 E4 */	b __mi__4cXyzCFRC3Vec
...
/* 8065C780  4B CE A9 B8 */	b PSVECSquareMag
...
/* 8065C7F0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065C7F4  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 8065C860  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065C864  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 8065C888  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8065C88C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8065C890  3C 80 80 66 */	lis r4, struct_80662FB8+0x0@ha
/* 8065C894  A8 04 2F B8 */	lha r0, struct_80662FB8+0x0@l(r4)
/* 8065C898  7C 00 00 D0 */	neg r0, r0
/* 8065C89C  7C 04 07 34 */	extsh r4, r0
/* 8065C8A0  4B 9A FB 3C */	b mDoMtx_YrotS__FPA4_fs
/* 8065C8A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8065C8A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8065C8AC  38 81 00 48 */	addi r4, r1, 0x48
/* 8065C8B0  7C 85 23 78 */	mr r5, r4
/* 8065C8B4  4B CE A5 98 */	b PSMTXMultVecSR
...
/* 8065C910  4B C0 70 4C */	b ClrCcMove__9cCcD_SttsFv
...
/* 8065C9A8  4B C1 3C 60 */	b cLib_addCalcAngleS2__FPssss
...
/* 8065C9BC  4B C1 3C 4C */	b cLib_addCalcAngleS2__FPssss
...
/* 8065C9D4  4B C1 3C 34 */	b cLib_addCalcAngleS2__FPssss
...
/* 8065C9E8  4B C1 3C 20 */	b cLib_addCalcAngleS2__FPssss
lbl_8065C9EC:
...
/* 8065CA04  3C 60 80 66 */	lis r3, struct_80662FB8+0x0@ha
/* 8065CA08  A8 03 2F B8 */	lha r0, struct_80662FB8+0x0@l(r3)
...
/* 8065CA20  4B C1 3B E8 */	b cLib_addCalcAngleS2__FPssss
...
/* 8065CA34  4B C1 3B D4 */	b cLib_addCalcAngleS2__FPssss
...
/* 8065CA90  4B C0 AE FC */	b cM_rndFX__Ff
...
/* 8065CAA8  4B C0 AE E4 */	b cM_rndFX__Ff
...
/* 8065CAC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8065CAC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8065CACC  3C 80 80 66 */	lis r4, struct_80662FB8+0x0@ha
/* 8065CAD0  38 84 2F B8 */	addi r4, r4, struct_80662FB8+0x0@l
/* 8065CAD4  A8 84 00 00 */	lha r4, 0(r4)	/* effective address: 80662FB8 */
/* 8065CAD8  4B 9A F9 04 */	b mDoMtx_YrotS__FPA4_fs
/* 8065CADC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8065CAE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8065CAE4  38 81 00 48 */	addi r4, r1, 0x48
/* 8065CAE8  7C 85 23 78 */	mr r5, r4
/* 8065CAEC  4B CE A3 60 */	b PSMTXMultVecSR
/* 8065CAF0  38 61 00 30 */	addi r3, r1, 0x30
/* 8065CAF4  38 9E 00 4C */	addi r4, r30, 0x4c
/* 8065CAF8  38 A1 00 48 */	addi r5, r1, 0x48
/* 8065CAFC  4B C0 9F E8 */	b __pl__4cXyzCFRC3Vec
...
/* 8065CB40  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 8065CB44  38 83 01 88 */	addi r4, r3, g_meter2_info@l
/* 8065CB48  88 64 00 BC */	lbz r3, 0xbc(r4)	/* effective address: 80430244 */
/* 8065CB4C  88 04 00 BB */	lbz r0, 0xbb(r4)	/* effective address: 80430243 */
...
/* 8065CB6C  4B 9B CE C0 */	b fopAcM_SearchByName__FsPP10fopAc_ac_c
...
/* 8065CB90  4B C1 40 74 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8065CBA4  4B C1 3A 64 */	b cLib_addCalcAngleS2__FPssss
...
/* 8065CBB8  4B C1 3A 50 */	b cLib_addCalcAngleS2__FPssss
...
/* 8065CBCC  4B CE A7 D0 */	b PSVECSquareDistance
...
/* 8065CC3C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065CC40  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8065CCAC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065CCB0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8065CCB4:
...
/* 8065CD44  4B CE A6 58 */	b PSVECSquareDistance
...
/* 8065CDB4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065CDB8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8065CE24  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8065CE28  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8065CE2C:
...
/* 8065CEB0  3C 60 80 66 */	lis r3, lit_5818@ha
/* 8065CEB4  38 83 32 08 */	addi r4, r3, lit_5818@l
/* 8065CEB8  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80663208 */
/* 8065CEBC  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 8066320C */
/* 8065CEC0  90 61 00 24 */	stw r3, 0x24(r1)
/* 8065CEC4  90 01 00 28 */	stw r0, 0x28(r1)
/* 8065CEC8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80663210 */
...
/* 8065CEEC  4B A1 90 6C */	b SetWall__12dBgS_AcchCirFff
lbl_8065CEF0:
...
/* 8065CF14  3C 60 80 66 */	lis r3, s_near_cow__FPvPv@ha
/* 8065CF18  38 63 97 2C */	addi r3, r3, s_near_cow__FPvPv@l
/* 8065CF1C  7F A4 EB 78 */	mr r4, r29
/* 8065CF20  4B 9C 44 18 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 8065CF6C  4B C1 37 D4 */	b cLib_chaseF__FPfff
lbl_8065CF70:
...
/* 8065CFA8  4B D0 52 80 */	b _restgpr_29

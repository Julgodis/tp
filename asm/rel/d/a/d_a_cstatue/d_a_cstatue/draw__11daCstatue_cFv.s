...
/* 80667448  4B CF AD 94 */	b _savegpr_29
/* 8066744C  7C 7E 1B 78 */	mr r30, r3
/* 80667450  3C 60 80 66 */	lis r3, lit_3768@ha
/* 80667454  3B E3 76 98 */	addi r31, r3, lit_3768@l
...
lbl_80667484:
/* 80667484  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80667488  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8066748C  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80667490  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80667494  4B B3 C3 30 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80667498  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8066749C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806674A0  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 806674A4  80 84 00 04 */	lwz r4, 4(r4)
/* 806674A8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 806674AC  4B B3 D8 F4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806674C4  4B 9A 62 E4 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 806674E8  4B 9A 61 F0 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_806674EC:
/* 806674EC  88 1E 0A DD */	lbz r0, 0xadd(r30)
/* 806674F0  28 00 00 02 */	cmplwi r0, 2
/* 806674F4  40 82 00 84 */	bne lbl_80667578
/* 806674F8  4B 9C 85 5C */	b dComIfGs_wolfeye_effect_check__Fv
...
/* 80667528  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8066752C  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80667530  80 7D 61 B0 */	lwz r3, 0x61b0(r29)	/* effective address: 8040C370 */
/* 80667534  38 63 01 40 */	addi r3, r3, 0x140
/* 80667538  38 81 00 14 */	addi r4, r1, 0x14
/* 8066753C  7C 85 23 78 */	mr r5, r4
/* 80667540  4B CD F8 2C */	b PSMTXMultVec
...
/* 80667564  4B CD F8 08 */	b PSMTXMultVec
/* 80667568  38 7E 0A 0C */	addi r3, r30, 0xa0c
/* 8066756C  38 81 00 14 */	addi r4, r1, 0x14
/* 80667570  4B 9A 72 50 */	b entryDL__21mDoExt_invisibleModelFP4cXyz
/* 80667574  48 00 00 80 */	b lbl_806675F4
lbl_80667578:
/* 80667578  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 8066757C  4B 9A 67 E8 */	b mDoExt_modelEntryDL__FP8J3DModel
...
/* 806675E4  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806675E8  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806675EC  4B 9C 73 24 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806675F0  90 7E 0A F0 */	stw r3, 0xaf0(r30)
lbl_806675F4:
/* 806675F4  38 60 00 01 */	li r3, 1
/* 806675F8  39 61 00 30 */	addi r11, r1, 0x30
/* 806675FC  4B CF AC 2C */	b _restgpr_29

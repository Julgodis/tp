...
/* 8046BDE0  3C 60 80 47 */	lis r3, lit_3957@ha
/* 8046BDE4  38 63 C9 E0 */	addi r3, r3, lit_3957@l
...
/* 8046BE04  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8046BE08  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8046BE0C  90 03 0E 8C */	stw r0, 0xe8c(r3)	/* effective address: 8042D8E0 */
/* 8046BE10  90 03 0E B8 */	stw r0, 0xeb8(r3)	/* effective address: 8042D90C */
/* 8046BE14  48 00 00 90 */	b lbl_8046BEA4
lbl_8046BE18:
/* 8046BE18  38 00 00 00 */	li r0, 0
/* 8046BE1C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8046BE20  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8046BE24  90 03 0E AC */	stw r0, 0xeac(r3)	/* effective address: 8042D900 */
/* 8046BE28  98 03 0E A9 */	stb r0, 0xea9(r3)	/* effective address: 8042D8FD */
/* 8046BE2C  48 00 00 78 */	b lbl_8046BEA4
lbl_8046BE30:
/* 8046BE30  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8046BE34  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8046BE38  80 03 0E D8 */	lwz r0, 0xed8(r3)	/* effective address: 8042D92C */
...
/* 8046BE74  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8046BE78  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8046BE7C  90 03 0E B8 */	stw r0, 0xeb8(r3)	/* effective address: 8042D90C */
/* 8046BE80  48 00 00 24 */	b lbl_8046BEA4
lbl_8046BE84:
/* 8046BE84  38 00 00 00 */	li r0, 0
/* 8046BE88  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8046BE8C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8046BE90  90 03 0E B8 */	stw r0, 0xeb8(r3)	/* effective address: 8042D90C */
/* 8046BE94  48 00 00 10 */	b lbl_8046BEA4
lbl_8046BE98:
/* 8046BE98  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8046BE9C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8046BEA0  90 83 10 48 */	stw r4, 0x1048(r3)	/* effective address: 8042DA9C */
lbl_8046BEA4:

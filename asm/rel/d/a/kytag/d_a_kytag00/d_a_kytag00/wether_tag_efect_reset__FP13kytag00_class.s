...
/* 8046BDE0 00000028  3C 60 00 00 */	lis r3, lit_3957@ha /* 8046C9E0 */
/* 8046BDE4 0000002C  38 63 00 00 */	addi r3, r3, lit_3957@l /* 8046C9E0 */
...
/* 8046BE04 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046BE08 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046BE0C 0000000C  90 03 0E 8C */	stw r0, 0xe8c(r3)
/* 8046BE10 00000010  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046BE14 00000014  48 00 00 90 */	b lbl_8046BEA4
lbl_8046BE18:
/* 8046BE18 00000000  38 00 00 00 */	li r0, 0
/* 8046BE1C 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046BE20 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046BE24 0000000C  90 03 0E AC */	stw r0, 0xeac(r3)
/* 8046BE28 00000010  98 03 0E A9 */	stb r0, 0xea9(r3)
/* 8046BE2C 00000014  48 00 00 78 */	b lbl_8046BEA4
lbl_8046BE30:
/* 8046BE30 00000000  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046BE34 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046BE38 00000008  80 03 0E D8 */	lwz r0, 0xed8(r3)
...
/* 8046BE48 00000018  90 03 0E D8 */	stw r0, 0xed8(r3)
lbl_8046BE4C:
...
/* 8046BE74 00000010  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046BE78 00000014  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 8046BE88 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046BE8C 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046BE90 0000000C  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046BE94 00000010  48 00 00 10 */	b lbl_8046BEA4
lbl_8046BE98:
/* 8046BE98 00000000  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046BE9C 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046BEA0 00000008  90 83 10 48 */	stw r4, 0x1048(r3)
lbl_8046BEA4:

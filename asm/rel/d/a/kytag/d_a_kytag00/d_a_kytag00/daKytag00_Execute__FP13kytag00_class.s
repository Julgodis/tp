...
/* 8046C694 00000010  4B EF 5B 48 */	b _savegpr_29
/* 8046C698 00000014  7C 7D 1B 78 */	mr r29, r3
/* 8046C69C 00000018  3C 60 80 47 */	lis r3, lit_3798@ha
/* 8046C6A0 0000001C  3B E3 C9 80 */	addi r31, r3, lit_3798@l
...
/* 8046C6B4 00000030  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 8046C6B8 00000034  88 A3 0D 64 */	lbz r5, struct_80450D64+0x0@l(r3)
/* 8046C6BC 00000038  7C A5 07 74 */	extsb r5, r5
/* 8046C6C0 0000003C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046C6C4 00000040  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8046C6C8 00000044  4B BC 8C 98 */	b isSwitch__10dSv_info_cCFii
...
/* 8046C6E8 0000000C  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 8046C6EC 00000010  88 A3 0D 64 */	lbz r5, struct_80450D64+0x0@l(r3)
/* 8046C6F0 00000014  7C A5 07 74 */	extsb r5, r5
/* 8046C6F4 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046C6F8 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8046C6FC 00000020  4B BC 8C 64 */	b isSwitch__10dSv_info_cCFii
...
/* 8046C718 0000000C  C0 3F 00 28 */	lfs f1, 0x28(r31)	/* effective address: 8046C9A8 */
/* 8046C71C 00000010  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 8046C9D4 */
/* 8046C720 00000014  C0 7F 00 58 */	lfs f3, 0x58(r31)	/* effective address: 8046C9D8 */
/* 8046C724 00000018  C0 9F 00 5C */	lfs f4, 0x5c(r31)	/* effective address: 8046C9DC */
/* 8046C728 0000001C  4B E0 32 54 */	b cLib_addCalc__FPfffff
/* 8046C72C 00000020  48 00 00 1C */	b lbl_8046C748
lbl_8046C730:
/* 8046C730 00000000  38 7D 05 88 */	addi r3, r29, 0x588
/* 8046C734 00000004  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 8046C980 */
/* 8046C738 00000008  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 8046C9D4 */
/* 8046C73C 0000000C  C0 7F 00 58 */	lfs f3, 0x58(r31)	/* effective address: 8046C9D8 */
/* 8046C740 00000010  C0 9F 00 5C */	lfs f4, 0x5c(r31)	/* effective address: 8046C9DC */
/* 8046C744 00000014  4B E0 32 38 */	b cLib_addCalc__FPfffff
lbl_8046C748:
...
/* 8046C758 00000010  4B EF 5A D0 */	b _restgpr_29

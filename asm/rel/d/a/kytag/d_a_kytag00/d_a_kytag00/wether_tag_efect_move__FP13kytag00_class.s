...
/* 8046BED8 0000000C  3C 60 00 00 */	lis r3, lit_3798@ha /* 8046C980 */
/* 8046BEDC 00000010  3B E3 00 00 */	addi r31, r3, lit_3798@l /* 8046C980 */
...
/* 8046BFB4 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8046BFB8 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 8046C024 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8046C028 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_8046C02C:
...
/* 8046C144 00000018  3C 60 00 00 */	lis r3, lit_4108@ha /* 8046CA2C */
/* 8046C148 0000001C  38 63 00 00 */	addi r3, r3, lit_4108@l /* 8046CA2C */
...
/* 8046C170 00000008  3C 60 00 00 */	lis r3, struct_80450D64+0x0@ha /* 80450D64 */
/* 8046C174 0000000C  88 03 00 00 */	lbz r0, struct_80450D64+0x0@l(r3) /* 80450D64 */
...
/* 8046C188 00000020  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C18C 00000024  38 83 00 00 */	addi r4, r3, g_env_light@l /* 8042CA54 */
/* 8046C190 00000028  98 04 0E 92 */	stb r0, 0xe92(r4)
/* 8046C194 0000002C  80 64 0E 8C */	lwz r3, 0xe8c(r4)
/* 8046C198 00000030  C0 3F 00 3C */	lfs f1, 0x3c(r31)
...
/* 8046C1B4 0000004C  C0 3F 00 40 */	lfs f1, 0x40(r31)
...
/* 8046C1CC 00000064  90 04 0E 8C */	stw r0, 0xe8c(r4)
/* 8046C1D0 00000068  7C 00 28 00 */	cmpw r0, r5
/* 8046C1D4 0000006C  40 81 00 08 */	ble lbl_8046C1DC
/* 8046C1D8 00000070  90 A4 0E 8C */	stw r5, 0xe8c(r4)
lbl_8046C1DC:
/* 8046C1DC 00000000  38 00 00 00 */	li r0, 0
/* 8046C1E0 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C1E4 00000008  38 83 00 00 */	addi r4, r3, g_env_light@l /* 8042CA54 */
...
/* 8046C23C 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C240 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C244 0000000C  90 03 0E 8C */	stw r0, 0xe8c(r3)
/* 8046C248 00000010  90 03 0E B8 */	stw r0, 0xeb8(r3)
lbl_8046C24C:
/* 8046C24C 00000000  3C 60 00 00 */	lis r3, g_mEnvSeMgr@ha /* 8042DD70 */
/* 8046C250 00000004  38 63 00 00 */	addi r3, r3, g_mEnvSeMgr@l /* 8042DD70 */
...
/* 8046C274 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C278 00000008  38 A3 00 00 */	addi r5, r3, g_env_light@l /* 8042CA54 */
/* 8046C27C 0000000C  98 C5 0E A9 */	stb r6, 0xea9(r5)
/* 8046C280 00000010  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 8046C284 00000014  7C 04 07 74 */	extsb r4, r0
/* 8046C288 00000018  3C 60 00 00 */	lis r3, struct_80450D64+0x0@ha /* 80450D64 */
/* 8046C28C 0000001C  88 03 00 00 */	lbz r0, struct_80450D64+0x0@l(r3) /* 80450D64 */
...
/* 8046C29C 0000002C  C0 3F 00 4C */	lfs f1, 0x4c(r31)
...
/* 8046C2B0 00000040  90 05 0E AC */	stw r0, 0xeac(r5)
...
lbl_8046C2D4:
/* 8046C2D4 00000000  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C2D8 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C2DC 00000008  80 03 0E D8 */	lwz r0, 0xed8(r3)
...
/* 8046C2EC 00000018  90 03 0E D8 */	stw r0, 0xed8(r3)
/* 8046C2F0 0000001C  48 00 03 50 */	b lbl_8046C640
lbl_8046C2F4:
/* 8046C2F4 00000000  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C2F8 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C2FC 00000008  80 03 0E D8 */	lwz r0, 0xed8(r3)
...
/* 8046C30C 00000018  90 03 0E D8 */	stw r0, 0xed8(r3)
lbl_8046C310:
...
/* 8046C320 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C324 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C328 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C32C 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C340 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C344 00000028  FC 20 00 90 */	fmr f1, f0
/* 8046C348 0000002C  4B FF FA 19 */	bl raincnt_set__Ff
/* 8046C34C 00000030  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C350 00000034  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C354 00000038  80 03 0E D8 */	lwz r0, 0xed8(r3)
...
/* 8046C364 00000048  90 03 0E D8 */	stw r0, 0xed8(r3)
/* 8046C368 0000004C  48 00 02 D8 */	b lbl_8046C640
lbl_8046C36C:
/* 8046C36C 00000000  38 00 00 00 */	li r0, 0
/* 8046C370 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C374 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C378 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C37C 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C390 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C394 00000028  48 00 02 AC */	b lbl_8046C640
lbl_8046C398:
/* 8046C398 00000000  38 00 00 01 */	li r0, 1
/* 8046C39C 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C3A0 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C3A4 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C3A8 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C3BC 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C3C0 00000028  48 00 02 80 */	b lbl_8046C640
lbl_8046C3C4:
/* 8046C3C4 00000000  38 00 00 02 */	li r0, 2
/* 8046C3C8 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C3CC 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C3D0 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C3D4 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C3E8 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C3EC 00000028  48 00 02 54 */	b lbl_8046C640
lbl_8046C3F0:
/* 8046C3F0 00000000  38 00 00 03 */	li r0, 3
/* 8046C3F4 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C3F8 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C3FC 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C400 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C414 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C418 00000028  48 00 02 28 */	b lbl_8046C640
lbl_8046C41C:
/* 8046C41C 00000000  38 00 00 32 */	li r0, 0x32
/* 8046C420 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C424 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C428 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C42C 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
/* 8046C430 00000014  EC 21 00 32 */	fmuls f1, f1, f0
/* 8046C434 00000018  C0 03 0F 40 */	lfs f0, 0xf40(r3)
...
/* 8046C448 0000002C  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C44C 00000030  48 00 01 F4 */	b lbl_8046C640
lbl_8046C450:
/* 8046C450 00000000  38 00 00 05 */	li r0, 5
/* 8046C454 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C458 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C45C 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C460 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C474 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C478 00000028  48 00 01 C8 */	b lbl_8046C640
lbl_8046C47C:
/* 8046C47C 00000000  38 00 00 06 */	li r0, 6
/* 8046C480 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C484 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C488 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C48C 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C4A0 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C4A4 00000028  48 00 01 9C */	b lbl_8046C640
lbl_8046C4A8:
/* 8046C4A8 00000000  C0 3F 00 20 */	lfs f1, 0x20(r31)
...
/* 8046C4BC 00000014  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C4C0 00000018  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C4C4 0000001C  90 03 10 48 */	stw r0, 0x1048(r3)
...
/* 8046C4D4 00000008  3C 60 00 00 */	lis r3, struct_80450D64+0x0@ha /* 80450D64 */
/* 8046C4D8 0000000C  88 03 00 00 */	lbz r0, struct_80450D64+0x0@l(r3) /* 80450D64 */
...
/* 8046C4EC 00000020  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C4F0 00000024  38 83 00 00 */	addi r4, r3, g_env_light@l /* 8042CA54 */
/* 8046C4F4 00000028  98 04 0E 92 */	stb r0, 0xe92(r4)
/* 8046C4F8 0000002C  80 64 0E 8C */	lwz r3, 0xe8c(r4)
/* 8046C4FC 00000030  C0 3F 00 3C */	lfs f1, 0x3c(r31)
...
/* 8046C518 0000004C  C0 3F 00 40 */	lfs f1, 0x40(r31)
...
/* 8046C530 00000064  90 04 0E 8C */	stw r0, 0xe8c(r4)
/* 8046C534 00000068  7C 00 28 00 */	cmpw r0, r5
/* 8046C538 0000006C  40 81 00 08 */	ble lbl_8046C540
/* 8046C53C 00000070  90 A4 0E 8C */	stw r5, 0xe8c(r4)
lbl_8046C540:
/* 8046C540 00000000  38 00 00 00 */	li r0, 0
/* 8046C544 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C548 00000008  38 83 00 00 */	addi r4, r3, g_env_light@l /* 8042CA54 */
...
/* 8046C5A0 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C5A4 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C5A8 0000000C  90 03 0E 8C */	stw r0, 0xe8c(r3)
/* 8046C5AC 00000010  90 03 0E B8 */	stw r0, 0xeb8(r3)
lbl_8046C5B0:
/* 8046C5B0 00000000  3C 60 00 00 */	lis r3, g_mEnvSeMgr@ha /* 8042DD70 */
/* 8046C5B4 00000004  38 63 00 00 */	addi r3, r3, g_mEnvSeMgr@l /* 8042DD70 */
...
/* 8046C5D8 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C5DC 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C5E0 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C5E4 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C5F8 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)
/* 8046C5FC 00000028  48 00 00 44 */	b lbl_8046C640
lbl_8046C600:
/* 8046C600 00000000  38 00 00 09 */	li r0, 9
/* 8046C604 00000004  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8046C608 00000008  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8046C60C 0000000C  98 03 0E B5 */	stb r0, 0xeb5(r3)
/* 8046C610 00000010  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 8046C624 00000024  90 03 0E B8 */	stw r0, 0xeb8(r3)

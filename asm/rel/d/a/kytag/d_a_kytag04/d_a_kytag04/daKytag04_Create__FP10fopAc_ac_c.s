...
/* 8046D5D4 00000038  3C 60 00 00 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8046D5D8 0000003C  38 03 00 00 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 8046D5F4 00000058  3C 60 00 00 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8046D5F8 0000005C  38 03 00 00 */	addi r0, r3, __vt__12J3DFrameCtrl@l
...
/* 8046D62C 0000000C  3C 80 00 00 */	lis r4, stringBase0@ha
/* 8046D630 00000010  38 84 00 00 */	addi r4, r4, stringBase0@l
...
/* 8046D68C 0000006C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D690 00000070  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8046D694 00000074  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8046D698 00000078  3C 80 00 00 */	lis r4, stringBase0@ha
/* 8046D69C 0000007C  38 84 00 00 */	addi r4, r4, stringBase0@l
...
/* 8046D6B0 00000090  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D6B4 00000094  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8046D6FC 00000020  3C 60 00 00 */	lis r3, lit_3962@ha
/* 8046D700 00000024  C0 03 00 00 */	lfs f0, lit_3962@l(r3)
...
/* 8046D730 00000054  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D734 00000058  3B A3 00 00 */	addi r29, r3, g_dComIfG_gameInfo@l
...
/* 8046D748 0000006C  3C 60 00 00 */	lis r3, struct_80450D64@ha
/* 8046D74C 00000070  88 A3 00 00 */	lbz r5, struct_80450D64@l(r3)
...
/* 8046D778 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D77C 00000010  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
...
/* 8046D7C4 00000008  3C 60 00 00 */	lis r3, struct_80450D64@ha
/* 8046D7C8 0000000C  88 A3 00 00 */	lbz r5, struct_80450D64@l(r3)
/* 8046D7CC 00000010  7C A5 07 74 */	extsb r5, r5
/* 8046D7D0 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D7D4 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8046D7F8 00000014  3C 60 00 00 */	lis r3, struct_80450D64@ha
/* 8046D7FC 00000018  88 A3 00 00 */	lbz r5, struct_80450D64@l(r3)
/* 8046D800 0000001C  7C A5 07 74 */	extsb r5, r5
/* 8046D804 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D808 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8046D820 0000003C  3C 60 00 00 */	lis r3, lit_3963@ha
/* 8046D824 00000040  C0 03 00 00 */	lfs f0, lit_3963@l(r3)
...
/* 8046D854 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D858 00000020  38 03 00 00 */	addi r0, r3, g_dComIfG_gameInfo@l
...
/* 8046D878 00000040  3C 60 00 00 */	lis r3, lit_3963@ha
/* 8046D87C 00000044  C0 03 00 00 */	lfs f0, lit_3963@l(r3)
...
/* 8046D890 00000004  3C 80 00 00 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 8046D894 00000008  38 84 00 00 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
...
/* 8046D8C8 00000018  3C 60 00 00 */	lis r3, struct_80450D64@ha
/* 8046D8CC 0000001C  88 A3 00 00 */	lbz r5, struct_80450D64@l(r3)
/* 8046D8D0 00000020  7C A5 07 74 */	extsb r5, r5
/* 8046D8D4 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D8D8 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8046D8EC 0000003C  3C 60 00 00 */	lis r3, lit_4326@ha
/* 8046D8F0 00000040  C8 23 00 00 */	lfd f1, lit_4326@l(r3)
...
/* 8046D94C 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8046D950 00000024  38 03 00 00 */	addi r0, r3, g_dComIfG_gameInfo@l
...
/* 8046D96C 00000040  3C 60 00 00 */	lis r3, lit_4326@ha
/* 8046D970 00000044  C8 23 00 00 */	lfd f1, lit_4326@l(r3)

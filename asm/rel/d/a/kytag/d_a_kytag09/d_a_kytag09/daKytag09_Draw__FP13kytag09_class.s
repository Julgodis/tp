...
/* 8085B418 00000020  3C 60 00 00 */	lis r3, g_env_light@ha
/* 8085B41C 00000024  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 8085B430 00000038  3C 60 00 00 */	lis r3, g_env_light@ha
/* 8085B434 0000003C  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 8085B458 00000060  3C 60 00 00 */	lis r3, g_env_light@ha
/* 8085B45C 00000064  38 63 00 00 */	addi r3, r3, g_env_light@l
...
lbl_8085B468:
/* 8085B468 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8085B46C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8085B470 00000008  3C 80 00 00 */	lis r4, lit_3863@ha
/* 8085B474 0000000C  C0 24 00 00 */	lfs f1, lit_3863@l(r4)
...
/* 8085B484 0000001C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8085B488 00000020  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8085B48C 00000024  38 81 00 08 */	addi r4, r1, 8
/* 8085B490 00000028  4B FF FF 49 */	bl PSMTXCopy
/* 8085B494 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8085B498 00000030  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 8085B49C 00000034  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8085B4A0 00000038  3C 60 00 00 */	lis r3, j3dSys@ha
/* 8085B4A4 0000003C  3B E3 00 00 */	addi r31, r3, j3dSys@l
...
/* 8085B4E0 00000078  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8085B4E4 0000007C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8085B57C 00000010  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8085B580 00000014  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_8085B5C0:
/* 8085B5C0 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8085B5C4 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l

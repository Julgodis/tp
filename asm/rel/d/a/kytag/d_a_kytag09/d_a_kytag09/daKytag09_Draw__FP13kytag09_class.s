...
/* 8085B408 00000010  4B FF FF D1 */	bl _savegpr_29
...
/* 8085B418 00000020  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8085B41C 00000024  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 8085B42C 00000034  4B FF FF AD */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8085B430 00000038  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8085B434 0000003C  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8085B438 00000040  7F E4 FB 78 */	mr r4, r31
/* 8085B43C 00000044  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8085B440 00000048  4B FF FF 99 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8085B458 00000060  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8085B45C 00000064  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8085B460 00000068  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8085B464 0000006C  4B FF FF 75 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_8085B468:
/* 8085B468 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8085B46C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8085B470 00000008  3C 80 00 00 */	lis r4, lit_3863@ha /* 8085BA44 */
/* 8085B474 0000000C  C0 24 00 00 */	lfs f1, lit_3863@l(r4) /* 8085BA44 */
/* 8085B478 00000010  FC 40 08 90 */	fmr f2, f1
/* 8085B47C 00000014  FC 60 08 90 */	fmr f3, f1
/* 8085B480 00000018  4B FF FF 59 */	bl PSMTXTrans
/* 8085B484 0000001C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8085B488 00000020  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8085B48C 00000024  38 81 00 08 */	addi r4, r1, 8
/* 8085B490 00000028  4B FF FF 49 */	bl PSMTXCopy
/* 8085B494 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8085B498 00000030  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 8085B49C 00000034  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8085B4A0 00000038  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 8085B4A4 0000003C  3B E3 00 00 */	addi r31, r3, j3dSys@l /* 80434AC8 */
/* 8085B4A8 00000040  90 1F 00 48 */	stw r0, 0x48(r31)
/* 8085B4AC 00000044  80 04 5F 74 */	lwz r0, 0x5f74(r4)
/* 8085B4B0 00000048  90 1F 00 4C */	stw r0, 0x4c(r31)
...
/* 8085B4CC 00000064  4B FF FF 0D */	bl PSMTXCopy
...
/* 8085B4DC 00000074  4B FF FE FD */	bl PSMTXCopy
/* 8085B4E0 00000078  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8085B4E4 0000007C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8085B4F4 0000008C  4B FF FE E5 */	bl isDarkClearLV__21dSv_player_status_b_cCFi
...
/* 8085B514 000000AC  4B FF FE C5 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 8085B518 000000B0  38 7E 05 74 */	addi r3, r30, 0x574
/* 8085B51C 000000B4  4B FF FE BD */	bl play__14mDoExt_baseAnmFv
/* 8085B520 000000B8  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 8085B524 000000BC  4B FF FE B5 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 8085B528 000000C0  48 00 00 98 */	b lbl_8085B5C0
lbl_8085B52C:
/* 8085B52C 00000000  7F A3 EB 78 */	mr r3, r29
/* 8085B530 00000004  38 80 00 02 */	li r4, 2
/* 8085B534 00000008  4B FF FE A5 */	bl isDarkClearLV__21dSv_player_status_b_cCFi
...
/* 8085B554 00000028  4B FF FE 85 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 8085B558 0000002C  38 7E 05 8C */	addi r3, r30, 0x58c
/* 8085B55C 00000030  4B FF FE 7D */	bl play__14mDoExt_baseAnmFv
/* 8085B560 00000034  80 7E 05 6C */	lwz r3, 0x56c(r30)
/* 8085B564 00000038  4B FF FE 75 */	bl mDoExt_modelUpdateDL__FP8J3DModel
...
/* 8085B578 0000000C  4B FF FE 61 */	bl PSMTXCopy
/* 8085B57C 00000010  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8085B580 00000014  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 8085B584 00000018  38 63 00 28 */	addi r3, r3, 0x28
/* 8085B588 0000001C  38 80 00 00 */	li r4, 0
/* 8085B58C 00000020  4B FF FE 4D */	bl isDarkClearLV__21dSv_player_status_b_cCFi
...
/* 8085B5AC 00000040  4B FF FE 2D */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 8085B5B0 00000044  38 7E 05 74 */	addi r3, r30, 0x574
/* 8085B5B4 00000048  4B FF FE 25 */	bl play__14mDoExt_baseAnmFv
/* 8085B5B8 0000004C  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 8085B5BC 00000050  4B FF FE 1D */	bl mDoExt_modelUpdateDL__FP8J3DModel
lbl_8085B5C0:
/* 8085B5C0 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8085B5C4 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 8085B5C8 00000008  80 03 5F 80 */	lwz r0, 0x5f80(r3)
/* 8085B5CC 0000000C  90 1F 00 48 */	stw r0, 0x48(r31)
/* 8085B5D0 00000010  80 03 5F 84 */	lwz r0, 0x5f84(r3)
/* 8085B5D4 00000014  90 1F 00 4C */	stw r0, 0x4c(r31)
/* 8085B5D8 00000018  38 60 00 01 */	li r3, 1
/* 8085B5DC 0000001C  39 61 00 50 */	addi r11, r1, 0x50
/* 8085B5E0 00000020  4B FF FD F9 */	bl _restgpr_29

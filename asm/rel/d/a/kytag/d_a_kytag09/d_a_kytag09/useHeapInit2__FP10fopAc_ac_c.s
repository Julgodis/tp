...
/* 8085B7D0  4B B0 6A 0C */	b _savegpr_29
/* 8085B7D4  7C 7D 1B 78 */	mr r29, r3
/* 8085B7D8  3C 60 80 86 */	lis r3, stringBase0@ha
/* 8085B7DC  38 63 BA 4C */	addi r3, r3, stringBase0@l
/* 8085B7E0  38 63 00 08 */	addi r3, r3, 8
/* 8085B7E4  38 80 00 04 */	li r4, 4
/* 8085B7E8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8085B7EC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8085B800  4B 7E 0A EC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8085B814  4B 7B 94 40 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8085B830:
/* 8085B830  3C 60 80 86 */	lis r3, stringBase0@ha
/* 8085B834  38 63 BA 4C */	addi r3, r3, stringBase0@l
...
/* 8085B848  4B 7E 0A A4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8085B860  3D 00 80 86 */	lis r8, lit_3906@ha
/* 8085B864  C0 28 BA 48 */	lfs f1, lit_3906@l(r8)
/* 8085B868  39 00 00 00 */	li r8, 0
/* 8085B86C  39 20 FF FF */	li r9, -1
/* 8085B870  4B 7B 1D CC */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 8085B874  30 03 FF FF */	addic r0, r3, -1
/* 8085B878  7C 60 19 10 */	subfe r3, r0, r3
lbl_8085B87C:
/* 8085B87C  39 61 00 20 */	addi r11, r1, 0x20
/* 8085B880  4B B0 69 A8 */	b _restgpr_29

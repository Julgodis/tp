...
/* 8085B668  4B B0 6B 70 */	b _savegpr_28
/* 8085B66C  7C 7E 1B 78 */	mr r30, r3
/* 8085B670  3C 60 80 86 */	lis r3, stringBase0@ha
/* 8085B674  38 63 BA 4C */	addi r3, r3, stringBase0@l
/* 8085B678  38 80 00 04 */	li r4, 4
/* 8085B67C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8085B680  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8085B694  4B 7E 0C 58 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8085B698  7C 7D 1B 78 */	mr r29, r3
/* 8085B69C  3C 60 80 86 */	lis r3, stringBase0@ha
/* 8085B6A0  38 63 BA 4C */	addi r3, r3, stringBase0@l
/* 8085B6A4  38 80 00 05 */	li r4, 5
/* 8085B6A8  7F E5 FB 78 */	mr r5, r31
/* 8085B6AC  38 C0 00 80 */	li r6, 0x80
/* 8085B6B0  4B 7E 0C 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8085B6C8  4B 7B 95 8C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8085B6E4:
/* 8085B6E4  3C 60 80 86 */	lis r3, stringBase0@ha
/* 8085B6E8  38 63 BA 4C */	addi r3, r3, stringBase0@l
/* 8085B6EC  38 80 00 09 */	li r4, 9
/* 8085B6F0  7F E5 FB 78 */	mr r5, r31
/* 8085B6F4  38 C0 00 80 */	li r6, 0x80
/* 8085B6F8  4B 7E 0B F4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8085B710  3D 00 80 86 */	lis r8, lit_3906@ha
/* 8085B714  C0 28 BA 48 */	lfs f1, lit_3906@l(r8)
/* 8085B718  39 00 00 00 */	li r8, 0
/* 8085B71C  39 20 FF FF */	li r9, -1
/* 8085B720  4B 7B 1F 1C */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 8085B744  4B 7B 95 10 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_8085B760:
/* 8085B760  3C 60 80 86 */	lis r3, stringBase0@ha
/* 8085B764  38 63 BA 4C */	addi r3, r3, stringBase0@l
/* 8085B768  38 80 00 0A */	li r4, 0xa
/* 8085B76C  7F E5 FB 78 */	mr r5, r31
/* 8085B770  38 C0 00 80 */	li r6, 0x80
/* 8085B774  4B 7E 0B 78 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8085B78C  3D 00 80 86 */	lis r8, lit_3906@ha
/* 8085B790  C0 28 BA 48 */	lfs f1, lit_3906@l(r8)
/* 8085B794  39 00 00 00 */	li r8, 0
/* 8085B798  39 20 FF FF */	li r9, -1
/* 8085B79C  4B 7B 1E A0 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 8085B7A0  30 03 FF FF */	addic r0, r3, -1
/* 8085B7A4  7C 60 19 10 */	subfe r3, r0, r3
lbl_8085B7A8:
/* 8085B7A8  39 61 00 20 */	addi r11, r1, 0x20
/* 8085B7AC  4B B0 6A 78 */	b _restgpr_28

lbl_80855CEC:
/* 80855CEC 00000000  94 21 FF F0 */	stwu r1, -0x10(r1)
/* 80855CF0 00000004  7C 08 02 A6 */	mflr r0
/* 80855CF4 00000008  90 01 00 14 */	stw r0, 0x14(r1)
...
/* 80855D04 00000018  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80855D08 0000001C  3B C3 00 00 */	addi r30, r3, g_env_light@l /* 8042CA54 */
/* 80855D0C 00000020  4B FF FD 8D */	bl dKyw_get_wind_vec__Fv
...
/* 80855D28 0000003C  4B FF FD 71 */	bl __ct__10fopAc_ac_cFv
lbl_80855D2C:
/* 80855D2C 00000000  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 80855D30 00000004  60 00 00 08 */	ori r0, r0, 8
/* 80855D34 00000008  90 1F 04 A0 */	stw r0, 0x4a0(r31)
lbl_80855D38:
/* 80855D38 00000000  38 00 00 00 */	li r0, 0
/* 80855D3C 00000004  B0 1F 05 74 */	sth r0, 0x574(r31)
...
/* 80855D4C 00000014  3C 60 00 00 */	lis r3, lit_3668@ha /* 80855E04 */
/* 80855D50 00000018  C0 03 00 00 */	lfs f0, lit_3668@l(r3) /* 80855E04 */
...
/* 80855D60 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80855D64 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80855D74 0000003C  4B FF FD 25 */	bl isSwitch__10dSv_info_cCFii
/* 80855D78 00000040  2C 03 00 00 */	cmpwi r3, 0
/* 80855D7C 00000044  41 82 00 44 */	beq lbl_80855DC0
/* 80855D80 00000048  4B FF FD 19 */	bl dKyw_evt_wind_set_go__Fv
/* 80855D84 0000004C  38 60 00 00 */	li r3, 0
/* 80855D88 00000050  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80855D8C 00000054  4B FF FD 0D */	bl dKyw_evt_wind_set__Fss
...
/* 80855DCC 0000000C  3C 60 00 00 */	lis r3, g_mEnvSeMgr@ha /* 8042DD70 */
/* 80855DD0 00000010  38 63 00 00 */	addi r3, r3, g_mEnvSeMgr@l /* 8042DD70 */
/* 80855DD4 00000014  4B FF FC C5 */	bl initStrongWindSe__10Z2EnvSeMgrFv
lbl_80855DD8:
/* 80855DD8 00000000  38 60 00 04 */	li r3, 4
/* 80855DDC 00000004  83 E1 00 0C */	lwz r31, 0xc(r1)
/* 80855DE0 00000008  83 C1 00 08 */	lwz r30, 8(r1)
/* 80855DE4 0000000C  80 01 00 14 */	lwz r0, 0x14(r1)
/* 80855DE8 00000010  7C 08 03 A6 */	mtlr r0
/* 80855DEC 00000014  38 21 00 10 */	addi r1, r1, 0x10
/* 80855DF0 00000018  4E 80 00 20 */	blr 

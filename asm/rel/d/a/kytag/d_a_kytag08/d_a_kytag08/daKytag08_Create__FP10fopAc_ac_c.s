...
/* 8085AFFC  4B B0 71 D8 */	b _savegpr_27
/* 8085B000  7C 7D 1B 78 */	mr r29, r3
/* 8085B004  3C 80 80 86 */	lis r4, lit_4012@ha
/* 8085B008  3B C4 B2 8C */	addi r30, r4, lit_4012@l
/* 8085B00C  C0 1E 00 50 */	lfs f0, 0x50(r30)	/* effective address: 8085B2DC */
/* 8085B010  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 8085B014  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 8085B018  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 8085B01C  3C 80 80 43 */	lis r4, g_env_light@ha
/* 8085B020  3B E4 CA 54 */	addi r31, r4, g_env_light@l
...
/* 8085B03C  4B 7B DB 28 */	b __ct__10fopAc_ac_cFv
/* 8085B040  3B 9B 05 6C */	addi r28, r27, 0x56c
/* 8085B044  3C 60 80 86 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8085B048  38 03 B3 68 */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 8085B04C  90 1B 05 6C */	stw r0, 0x56c(r27)
/* 8085B050  7F 83 E3 78 */	mr r3, r28
/* 8085B054  38 80 00 00 */	li r4, 0
/* 8085B058  4B AC D3 A4 */	b init__12J3DFrameCtrlFs
/* 8085B05C  38 00 00 00 */	li r0, 0
/* 8085B060  90 1C 00 14 */	stw r0, 0x14(r28)
/* 8085B064  3C 60 80 86 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 8085B068  38 03 B3 68 */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 8085B06C  94 1B 05 84 */	stwu r0, 0x584(r27)
/* 8085B070  7F 63 DB 78 */	mr r3, r27
/* 8085B074  38 80 00 00 */	li r4, 0
/* 8085B078  4B AC D3 84 */	b init__12J3DFrameCtrlFs
...
/* 8085B094  3C 80 80 86 */	lis r4, stringBase0@ha
/* 8085B098  38 84 B3 10 */	addi r4, r4, stringBase0@l
/* 8085B09C  4B 7D 1E 20 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8085B0B0  3C 80 80 86 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 8085B0B4  38 84 AF 74 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 8085B0B8  38 A0 05 50 */	li r5, 0x550
/* 8085B0BC  4B 7B F3 F4 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8085B0E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8085B0EC  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 8085B0F0  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 8085B134  4B 7F 19 5C */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8085B138  90 7D 05 9C */	stw r3, 0x59c(r29)
/* 8085B13C  4B 95 14 40 */	b dKy_darkworld_check__Fv
...
/* 8085B18C  4B 7F 19 04 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8085B1DC  4B 7F 18 B4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8085B228  4B B0 6F F8 */	b _restgpr_27

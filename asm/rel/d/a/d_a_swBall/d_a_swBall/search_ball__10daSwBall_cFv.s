...
/* 80D4E260 00000018  3C 60 80 D5 */	lis r3, l_target_info_count@ha
/* 80D4E264 0000001C  90 A3 EA 70 */	stw r5, l_target_info_count@l(r3)
/* 80D4E268 00000020  7C A3 2B 78 */	mr r3, r5
/* 80D4E26C 00000024  3C 80 80 D5 */	lis r4, l_target_info@ha
/* 80D4E270 00000028  38 84 EA 50 */	addi r4, r4, l_target_info@l
...
/* 80D4E288 0000000C  3C 60 80 D5 */	lis r3, s_ball_sub__FPvPv@ha
/* 80D4E28C 00000010  38 63 DF D8 */	addi r3, r3, s_ball_sub__FPvPv@l
/* 80D4E290 00000014  7F E4 FB 78 */	mr r4, r31
/* 80D4E294 00000018  4B 2D 30 A4 */	b fpcEx_Search__FPFPvPv_PvPv
/* 80D4E298 0000001C  39 40 00 00 */	li r10, 0
/* 80D4E29C 00000020  38 60 00 00 */	li r3, 0
/* 80D4E2A0 00000024  3C 80 80 D5 */	lis r4, l_target_info@ha
/* 80D4E2A4 00000028  38 E4 EA 50 */	addi r7, r4, l_target_info@l
/* 80D4E2A8 0000002C  3C 80 80 D5 */	lis r4, l_target_info_count@ha
/* 80D4E2AC 00000030  38 A4 EA 70 */	addi r5, r4, l_target_info_count@l
...
lbl_80D4E354:
/* 80D4E354 00000000  80 05 00 00 */	lwz r0, 0(r5)	/* effective address: 80D4EA70 */

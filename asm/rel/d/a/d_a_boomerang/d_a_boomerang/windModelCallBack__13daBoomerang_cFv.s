...
/* 8049F294  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049F298  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049F29C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8049F2A0  4B B6 D1 3C */	b mDoMtx_YrotS__FPA4_fs
/* 8049F2A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049F2A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049F2AC  A8 1F 04 E8 */	lha r0, 0x4e8(r31)
/* 8049F2B0  7C 00 00 D0 */	neg r0, r0
/* 8049F2B4  7C 04 07 34 */	extsh r4, r0
/* 8049F2B8  4B B6 D2 14 */	b mDoMtx_ZrotM__FPA4_fs
/* 8049F2BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049F2C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049F2C4  A8 1F 04 E4 */	lha r0, 0x4e4(r31)
/* 8049F2C8  7C 00 00 D0 */	neg r0, r0
/* 8049F2CC  7C 04 07 34 */	extsh r4, r0
/* 8049F2D0  4B B6 D0 CC */	b mDoMtx_XrotM__FPA4_fs
/* 8049F2D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049F2D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049F2DC  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 8049F2E0  7C 00 00 D0 */	neg r0, r0
/* 8049F2E4  7C 04 07 34 */	extsh r4, r0
/* 8049F2E8  4B B6 D1 4C */	b mDoMtx_YrotM__FPA4_fs
/* 8049F2EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049F2F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049F2F4  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 8049F2F8  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
...
/* 8049F348  4B EA 71 68 */	b PSMTXCopy

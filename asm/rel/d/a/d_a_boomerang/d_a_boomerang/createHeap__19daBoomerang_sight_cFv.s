...
/* 8049E0D4 0000001C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 8049E0D8 00000020  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
lbl_8049E120:
/* 8049E120 00000000  3C 80 00 00 */	lis r4, stringBase0@ha
/* 8049E124 00000004  38 84 00 00 */	addi r4, r4, stringBase0@l
...
/* 8049E13C 0000001C  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E140 00000020  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E16C:
/* 8049E16C 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E170 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E19C:
/* 8049E19C 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E1A0 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E1CC:
/* 8049E1CC 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E1D0 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E22C:
/* 8049E22C 00000000  3C 80 00 00 */	lis r4, stringBase0@ha
/* 8049E230 00000004  38 84 00 00 */	addi r4, r4, stringBase0@l
...
/* 8049E24C 00000020  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E250 00000024  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E27C:
/* 8049E27C 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E280 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E2DC:
/* 8049E2DC 00000000  3C 80 00 00 */	lis r4, stringBase0@ha
/* 8049E2E0 00000004  38 84 00 00 */	addi r4, r4, stringBase0@l
...
/* 8049E2FC 00000020  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E300 00000024  38 63 00 00 */	addi r3, r3, stringBase0@l
...
lbl_8049E32C:
/* 8049E32C 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8049E330 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l

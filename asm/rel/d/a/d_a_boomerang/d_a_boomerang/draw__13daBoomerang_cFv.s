...
/* 8049F3AC  4B EC 2E 30 */	b _savegpr_29
...
/* 8049F3F4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8049F3F8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8049F3FC  38 81 00 0C */	addi r4, r1, 0xc
/* 8049F400  4B B7 A3 F8 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8049F4A0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8049F4A4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8049F4A8  38 81 00 08 */	addi r4, r1, 8
/* 8049F4AC  4B B7 A3 4C */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8049F508  4B BB 72 8C */	b set__12dDlst_list_cFRPP12dDlst_base_cRPP12dDlst_base_cP12dDlst_base_c
lbl_8049F50C:
/* 8049F50C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8049F510  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8049F514  38 80 00 00 */	li r4, 0
/* 8049F518  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8049F51C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8049F520  4B D0 42 A4 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8049F524  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8049F528  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8049F52C  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 8049F530  80 84 00 04 */	lwz r4, 4(r4)
/* 8049F534  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8049F538  4B D0 58 68 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8049F53C  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 8049F540  4B B6 E7 84 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 8049F544  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 8049F548  4B B9 24 04 */	b entry__10daMirror_cFP8J3DModel
/* 8049F54C  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 8049F550  28 00 00 00 */	cmplwi r0, 0
/* 8049F554  41 82 00 30 */	beq lbl_8049F584
/* 8049F558  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8049F55C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8049F560  80 9F 05 6C */	lwz r4, 0x56c(r31)
/* 8049F564  80 84 00 04 */	lwz r4, 4(r4)
/* 8049F568  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8049F56C  4B D0 58 34 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8049F570  80 7F 05 6C */	lwz r3, 0x56c(r31)
/* 8049F574  4B B6 E7 F0 */	b mDoExt_modelEntryDL__FP8J3DModel
...
/* 8049F59C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8049F5A0  80 9F 05 90 */	lwz r4, 0x590(r31)
/* 8049F5A4  80 84 00 04 */	lwz r4, 4(r4)
/* 8049F5A8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8049F5AC  4B D0 57 F4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8049F5B0  80 7F 05 90 */	lwz r3, 0x590(r31)
/* 8049F5B4  4B B6 E7 10 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_8049F5B8:
/* 8049F5B8  38 60 00 01 */	li r3, 1
/* 8049F5BC  39 61 00 20 */	addi r11, r1, 0x20
/* 8049F5C0  4B EC 2C 68 */	b _restgpr_29

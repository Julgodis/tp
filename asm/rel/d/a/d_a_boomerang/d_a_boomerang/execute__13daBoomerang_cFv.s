...
/* 804A182C  4B EC 09 A0 */	b _savegpr_25
/* 804A1830  7C 7C 1B 78 */	mr r28, r3
/* 804A1834  3C 60 80 4A */	lis r3, lit_4078@ha
/* 804A1838  3B E3 28 50 */	addi r31, r3, lit_4078@l
...
/* 804A1870  4B B7 C5 14 */	b waterCheck__11fopAcM_wt_cFPC4cXyz
...
/* 804A18C0  4B BD 34 EC */	b GetUnderwaterRoofCode__4dBgSFRC13cBgS_PolyInfo
/* 804A18C4  28 03 00 00 */	cmplwi r3, 0
/* 804A18C8  40 82 00 10 */	bne lbl_804A18D8
/* 804A18CC  3C 60 80 45 */	lis r3, mRoofY__11fopAcM_rc_c@ha
/* 804A18D0  C0 03 0C D4 */	lfs f0, mRoofY__11fopAcM_rc_c@l(r3)
/* 804A18D4  48 00 00 08 */	b lbl_804A18DC
lbl_804A18D8:
/* 804A18D8  C0 1F 01 34 */	lfs f0, 0x134(r31)
lbl_804A18DC:
/* 804A18DC  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha
/* 804A18E0  C0 43 0C D8 */	lfs f2, mWaterY__11fopAcM_wt_c@l(r3)
...
/* 804A1904  4B B7 83 78 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 804A1920  4B B7 83 5C */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 804A197C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 804A1980  3B 63 35 90 */	addi r27, r3, fpcSch_JudgeByID__FPvPv@l
...
/* 804A19AC  4B B7 7E 4C */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804A1A14  4B C3 E7 08 */	b getBoomLockMax__9daAlink_cFv
...
/* 804A1A50  4B EA 59 4C */	b PSVECSquareDistance
...
/* 804A1A74  4B EA 59 28 */	b PSVECSquareDistance
lbl_804A1A78:
...
/* 804A1AD0  4B EC 05 B4 */	b __ptmf_scall
...
/* 804A1B4C  4B DC EC 60 */	b cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 804A1BA8  3C 60 80 45 */	lis r3, struct_8045101C+0x2@ha
/* 804A1BAC  B0 03 10 1E */	sth r0, struct_8045101C+0x2@l(r3)
lbl_804A1BB0:
...
/* 804A1BC0  4B EC 06 58 */	b _restgpr_25

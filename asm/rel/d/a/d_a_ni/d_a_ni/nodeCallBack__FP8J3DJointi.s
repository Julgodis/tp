...
/* 8094BE88  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 8094BEB0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
...
/* 8094BEC8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BEDC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BEFC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BF1C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BF3C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BF5C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BF84  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BFA0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BFBC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094BFE8  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8094BFEC  4B 9F A4 C4 */	b PSMTXCopy
/* 8094BFF0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8094BFF4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8094BFF8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C00C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C020  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C034  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C050  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C07C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8094C080  4B 9F A4 30 */	b PSMTXCopy
/* 8094C084  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8094C088  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8094C08C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C0A0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C0B4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C0C8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8094C0E4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

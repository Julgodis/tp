...
/* 8094C2B0 00000018  3C 60 80 95 */	lis r3, lit_3958@ha
/* 8094C2B4 0000001C  3B C3 11 C0 */	addi r30, r3, lit_3958@l
...
/* 8094C2C8 00000030  4B 73 75 68 */	b Move__10dCcD_GSttsFv
/* 8094C2CC 00000034  38 7F 08 88 */	addi r3, r31, 0x888
/* 8094C2D0 00000038  4B 73 81 90 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 8094C2E8 00000050  4B 73 82 10 */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 8094C2F8 00000060  C0 3E 00 08 */	lfs f1, 8(r30)	/* effective address: 809511C8 */
...
/* 8094C35C 00000004  4B 73 B6 FC */	b at_power_check__FP11dCcU_AtInfo
...
/* 8094C38C 00000034  C0 3E 00 30 */	lfs f1, 0x30(r30)	/* effective address: 809511F0 */
/* 8094C390 00000038  4B 91 B5 FC */	b cM_rndFX__Ff
/* 8094C394 0000003C  A8 1F 05 E4 */	lha r0, 0x5e4(r31)
/* 8094C398 00000040  C8 5E 00 40 */	lfd f2, 0x40(r30)	/* effective address: 80951200 */
...
/* 8094C3F4 0000000C  C0 1E 00 18 */	lfs f0, 0x18(r30)	/* effective address: 809511D8 */
/* 8094C3F8 00000010  D0 1F 06 10 */	stfs f0, 0x610(r31)
/* 8094C3FC 00000014  7F E3 FB 78 */	mr r3, r31
/* 8094C400 00000018  C0 3E 00 10 */	lfs f1, 0x10(r30)	/* effective address: 809511D0 */
/* 8094C404 0000001C  C0 5E 00 34 */	lfs f2, 0x34(r30)	/* effective address: 809511F4 */
/* 8094C408 00000020  4B FF F9 61 */	bl hane_set__FP8ni_classff
/* 8094C40C 00000024  48 00 00 18 */	b lbl_8094C424
lbl_8094C410:
/* 8094C410 00000000  C0 5E 00 34 */	lfs f2, 0x34(r30)	/* effective address: 809511F4 */
/* 8094C414 00000004  D0 5F 06 10 */	stfs f2, 0x610(r31)
/* 8094C418 00000008  7F E3 FB 78 */	mr r3, r31
/* 8094C41C 0000000C  C0 3E 00 38 */	lfs f1, 0x38(r30)	/* effective address: 809511F8 */
...
/* 8094C45C 00000038  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8094C460 0000003C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8094C464 00000040  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
/* 8094C468 00000044  28 00 00 00 */	cmplwi r0, 0
/* 8094C46C 00000048  40 82 00 2C */	bne lbl_8094C498
/* 8094C470 0000004C  3C 60 80 95 */	lis r3, s_play_sub__FPvPv@ha
/* 8094C474 00000050  38 63 C2 40 */	addi r3, r3, s_play_sub__FPvPv@l
/* 8094C478 00000054  7F E4 FB 78 */	mr r4, r31
/* 8094C47C 00000058  4B 6D 4E BC */	b fpcEx_Search__FPFPvPv_PvPv

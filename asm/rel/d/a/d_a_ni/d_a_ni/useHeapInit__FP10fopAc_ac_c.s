...
/* 809508F0  4B A1 18 E8 */	b _savegpr_28
/* 809508F4  7C 7F 1B 78 */	mr r31, r3
/* 809508F8  38 60 00 54 */	li r3, 0x54
/* 809508FC  4B 97 E3 50 */	b __nw__FUl
/* 80950900  7C 7E 1B 79 */	or. r30, r3, r3
/* 80950904  41 82 00 9C */	beq lbl_809509A0
/* 80950908  3C 60 80 95 */	lis r3, stringBase0@ha
/* 8095090C  38 63 13 1C */	addi r3, r3, stringBase0@l
/* 80950910  38 80 00 0B */	li r4, 0xb
/* 80950914  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80950918  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8095092C  4B 6E B9 C0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80950930  7C 7D 1B 78 */	mr r29, r3
/* 80950934  3C 60 80 95 */	lis r3, stringBase0@ha
/* 80950938  38 63 13 1C */	addi r3, r3, stringBase0@l
/* 8095093C  38 80 00 10 */	li r4, 0x10
/* 80950940  7F 85 E3 78 */	mr r5, r28
/* 80950944  38 C0 00 80 */	li r6, 0x80
/* 80950948  4B 6E B9 A4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80950988  3D 20 80 95 */	lis r9, lit_3981@ha
/* 8095098C  C0 29 11 E0 */	lfs f1, lit_3981@l(r9)
/* 80950990  39 20 00 00 */	li r9, 0
/* 80950994  39 40 FF FF */	li r10, -1
/* 80950998  4B 6B F2 B4 */	b __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 809509D0  3C 60 80 95 */	lis r3, nodeCallBack__FP8J3DJointi@ha
/* 809509D4  38 83 BE 60 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l
...
/* 80950A08  4B 97 E2 44 */	b __nw__FUl
/* 80950A0C  7C 7E 1B 79 */	or. r30, r3, r3
/* 80950A10  41 82 00 20 */	beq lbl_80950A30
/* 80950A14  3C 80 80 95 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80950A18  38 04 15 30 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80950A1C  90 1E 00 00 */	stw r0, 0(r30)
/* 80950A20  38 80 00 00 */	li r4, 0
/* 80950A24  4B 9D 79 D8 */	b init__12J3DFrameCtrlFs
...
lbl_80950A48:
/* 80950A48  3C 60 80 95 */	lis r3, stringBase0@ha
/* 80950A4C  38 63 13 1C */	addi r3, r3, stringBase0@l
/* 80950A50  38 80 00 13 */	li r4, 0x13
/* 80950A54  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80950A58  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80950A5C  3C A5 00 02 */	addis r5, r5, 2
/* 80950A60  38 C0 00 80 */	li r6, 0x80
/* 80950A64  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80950A68  4B 6E B8 84 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80950A8C  3D 00 80 95 */	lis r8, lit_3981@ha
/* 80950A90  C0 28 11 E0 */	lfs f1, lit_3981@l(r8)
/* 80950A94  39 00 00 00 */	li r8, 0
/* 80950A98  39 20 FF FF */	li r9, -1
/* 80950A9C  4B 6B CB A0 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80950AD4  4B A1 17 50 */	b _restgpr_28

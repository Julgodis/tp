...
/* 8094DEE8 00000018  3C 60 00 00 */	lis r3, lit_3958@ha
/* 8094DEEC 0000001C  3B E3 00 00 */	addi r31, r3, lit_3958@l
/* 8094DEF0 00000020  38 00 02 9C */	li r0, 0x29c
/* 8094DEF4 00000024  B0 01 00 08 */	sth r0, 8(r1)
/* 8094DEF8 00000028  3C 60 00 00 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 8094DEFC 0000002C  38 63 00 00 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
...
/* 8094DF30 00000060  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 8094DF34 00000064  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 8094DF4C 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8094DF50 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8094E12C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8094E130 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8094E19C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8094E1A0 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8094E1A4:

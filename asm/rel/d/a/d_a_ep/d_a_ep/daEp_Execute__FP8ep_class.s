...
/* 8046A0D8  4B EF 80 F8 */	b _savegpr_26
/* 8046A0DC  7C 7E 1B 78 */	mr r30, r3
/* 8046A0E0  3C 60 80 47 */	lis r3, lit_3681@ha
/* 8046A0E4  3B E3 AF C4 */	addi r31, r3, lit_3681@l
...
/* 8046A14C  4B E0 50 90 */	b SetC__8cM3dGCylFRC4cXyz
/* 8046A150  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8046A154  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8046A158  38 63 23 3C */	addi r3, r3, 0x233c
/* 8046A15C  38 9E 06 80 */	addi r4, r30, 0x680
/* 8046A160  4B DF AA 48 */	b Set__4cCcSFP8cCcD_Obj
...
/* 8046A174  4B C1 A2 EC */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 8046A19C  4B BC D7 64 */	b HitSeStart__5daObjFPC4cXyziPC12dCcD_GObjInfUl
lbl_8046A1A0:
...
/* 8046A1BC  4B BB 09 24 */	b fopAcM_rollPlayerCrash__FPC10fopAc_ac_cfUlffif
/* 8046A1C0  C0 1F 00 C4 */	lfs f0, 0xc4(r31)
/* 8046A1C4  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha
/* 8046A1C8  3B 63 D8 E4 */	addi r27, r3, mClipper__14mDoLib_clipper@l
/* 8046A1CC  D0 1B 00 58 */	stfs f0, 0x58(r27)	/* effective address: 803DD93C */
/* 8046A1D0  7F 63 DB 78 */	mr r3, r27
/* 8046A1D4  4B E0 95 B8 */	b calcViewFrustum__11J3DUClipperFv
...
/* 8046A1F8  4B BB 0A 48 */	b fopAcM_checkCullingBox__FPA4_fffffff
/* 8046A1FC  98 7E 06 02 */	stb r3, 0x602(r30)
/* 8046A200  3C 60 80 45 */	lis r3, mSystemFar__14mDoLib_clipper@ha
/* 8046A204  C0 03 0C 70 */	lfs f0, mSystemFar__14mDoLib_clipper@l(r3)
/* 8046A208  D0 1B 00 58 */	stfs f0, 0x58(r27)
/* 8046A20C  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha
/* 8046A210  38 63 D8 E4 */	addi r3, r3, mClipper__14mDoLib_clipper@l
/* 8046A214  4B E0 95 78 */	b calcViewFrustum__11J3DUClipperFv
lbl_8046A218:
...
lbl_8046A260:
/* 8046A260  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8046A264  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8046A268  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 8046A298  4B DF D6 BC */	b cM_rndF__Ff
...
/* 8046A2B0  4B DF D6 A4 */	b cM_rndF__Ff
...
/* 8046A2DC  4B DF D6 78 */	b cM_rndF__Ff
...
/* 8046A2F4  4B DF D6 60 */	b cM_rndF__Ff
...
/* 8046A30C  4B DF D6 48 */	b cM_rndF__Ff
...
/* 8046A32C  4B DF D6 28 */	b cM_rndF__Ff
...
/* 8046A34C  4B E0 56 F0 */	b cLib_addCalc2__FPffff
...
/* 8046A360  4B E0 56 DC */	b cLib_addCalc2__FPffff
/* 8046A364  C0 1F 00 C4 */	lfs f0, 0xc4(r31)
/* 8046A368  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha
/* 8046A36C  3B 63 D8 E4 */	addi r27, r3, mClipper__14mDoLib_clipper@l
/* 8046A370  D0 1B 00 58 */	stfs f0, 0x58(r27)	/* effective address: 803DD93C */
/* 8046A374  7F 63 DB 78 */	mr r3, r27
/* 8046A378  4B E0 94 14 */	b calcViewFrustum__11J3DUClipperFv
...
/* 8046A398  4B BB 08 A8 */	b fopAcM_checkCullingBox__FPA4_fffffff
/* 8046A39C  98 7E 06 01 */	stb r3, 0x601(r30)
/* 8046A3A0  3C 60 80 45 */	lis r3, mSystemFar__14mDoLib_clipper@ha
/* 8046A3A4  C0 03 0C 70 */	lfs f0, mSystemFar__14mDoLib_clipper@l(r3)
/* 8046A3A8  D0 1B 00 58 */	stfs f0, 0x58(r27)
/* 8046A3AC  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha
/* 8046A3B0  38 63 D8 E4 */	addi r3, r3, mClipper__14mDoLib_clipper@l
/* 8046A3B4  4B E0 93 D8 */	b calcViewFrustum__11J3DUClipperFv
...
/* 8046A3F8  4B C1 D6 60 */	b at_power_check__FP11dCcU_AtInfo
...
/* 8046A438  3C 60 80 45 */	lis r3, struct_80451124+0x1@ha
/* 8046A43C  98 03 11 25 */	stb r0, struct_80451124+0x1@l(r3)
lbl_8046A440:
...
/* 8046A44C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8046A450  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8046A454  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8046A47C  4B E4 15 08 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8046A480  38 7E 06 14 */	addi r3, r30, 0x614
/* 8046A484  4B D3 D4 A8 */	b dKy_plight_cut__FP15LIGHT_INFLUENCE
lbl_8046A488:
...
/* 8046A4CC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8046A4D0  3B 63 07 68 */	addi r27, r3, calc_mtx@l
...
/* 8046A550  4B BA 1E 8C */	b mDoMtx_YrotS__FPA4_fs
...
/* 8046A59C  4B DF D3 F0 */	b cM_rndFX__Ff
...
/* 8046A620  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8046A624  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 8046A628  3C 60 80 47 */	lis r3, data_8046B134@ha
/* 8046A62C  3B 83 B1 34 */	addi r28, r3, data_8046B134@l
lbl_8046A630:
/* 8046A630  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 8046A670  4B BE 24 20 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8046A6C0  4B EF 7B 5C */	b _restgpr_26

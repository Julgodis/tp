...
/* 804DB414  4B E8 6D C0 */	b _savegpr_27
/* 804DB418  7C 7F 1B 78 */	mr r31, r3
/* 804DB41C  38 7F 05 98 */	addi r3, r31, 0x598
/* 804DB420  4B BA 84 10 */	b Move__10dCcD_GSttsFv
/* 804DB424  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 804DB428  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 804DB42C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804DB430  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804DB444  3C 60 80 4E */	lis r3, lit_4683@ha
/* 804DB448  C0 03 D6 80 */	lfs f0, lit_4683@l(r3)
/* 804DB44C  EC 01 00 28 */	fsubs f0, f1, f0
/* 804DB450  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 804DB454  3B 9F 0D 80 */	addi r28, r31, 0xd80
/* 804DB458  3C 60 80 4E */	lis r3, l_cylOffsetZ@ha
/* 804DB45C  38 03 D6 00 */	addi r0, r3, l_cylOffsetZ@l
/* 804DB460  7C 1B 03 78 */	mr r27, r0
/* 804DB464  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804DB468  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804DB46C  83 A3 5D B4 */	lwz r29, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804DB4CC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804DB4D0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 804DB504  4B D9 3C D8 */	b SetC__8cM3dGCylFRC4cXyz
/* 804DB508  7F A3 EB 78 */	mr r3, r29
/* 804DB50C  7F 84 E3 78 */	mr r4, r28
/* 804DB510  4B D8 96 98 */	b Set__4cCcSFP8cCcD_Obj
...
/* 804DB564  4B E8 6C BC */	b _restgpr_27

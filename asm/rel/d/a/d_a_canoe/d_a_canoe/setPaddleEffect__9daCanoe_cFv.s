...
/* 804DC340  4B E8 5E 98 */	b _savegpr_28
/* 804DC344  7C 7C 1B 78 */	mr r28, r3
/* 804DC348  3C 60 80 4E */	lis r3, lit_1109@ha
...
/* 804DC378  3C 80 80 4E */	lis r4, __dt__4cXyzFv@ha
/* 804DC37C  38 84 A5 B8 */	addi r4, r4, __dt__4cXyzFv@l
...
lbl_804DC3DC:
/* 804DC3DC  4B C1 78 F0 */	b getCanoeLocalPaddleTop__9daAlink_cFv
...
/* 804DC3F0  4B E6 A9 7C */	b PSMTXMultVec
/* 804DC3F4  38 61 00 2C */	addi r3, r1, 0x2c
/* 804DC3F8  4B B4 19 8C */	b waterCheck__11fopAcM_wt_cFPC4cXyz
/* 804DC3FC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804DC400  41 82 01 28 */	beq lbl_804DC528
/* 804DC404  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 804DC408  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha
/* 804DC40C  C0 03 0C D8 */	lfs f0, mWaterY__11fopAcM_wt_c@l(r3)
...
/* 804DC440  4B D8 A6 F4 */	b __mi__4cXyzCFRC3Vec
...
/* 804DC474  3C A0 80 45 */	lis r5, mWaterY__11fopAcM_wt_c@ha
/* 804DC478  C0 25 0C D8 */	lfs f1, mWaterY__11fopAcM_wt_c@l(r5)
...
/* 804DC48C  4B E6 AC 4C */	b PSVECScale
/* 804DC490  38 61 00 20 */	addi r3, r1, 0x20
/* 804DC494  38 81 00 14 */	addi r4, r1, 0x14
/* 804DC498  7C 65 1B 78 */	mr r5, r3
/* 804DC49C  4B E6 AB F4 */	b PSVECAdd
/* 804DC4A0  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha
/* 804DC4A4  C0 03 0C D8 */	lfs f0, mWaterY__11fopAcM_wt_c@l(r3)
...
/* 804DC4DC  4B B7 03 5C */	b setWaterRipple__13dPa_control_cFPUlR13cBgS_PolyInfoPC4cXyzfPC12dKy_tevstr_cPC4cXyzSc
...
/* 804DC50C  4B B4 33 70 */	b fopKyM_createWpillar__FPC4cXyzfi
lbl_804DC510:
...
/* 804DC540  4B E8 5C E4 */	b _restgpr_28

...
/* 8049B77C  4B EC 6A 50 */	b _savegpr_25
/* 8049B780  7C 7A 1B 78 */	mr r26, r3
/* 8049B784  3C 80 80 4A */	lis r4, cNullVec__6Z2Calc@ha
/* 8049B788  3B C4 DE 0C */	addi r30, r4, cNullVec__6Z2Calc@l
/* 8049B78C  3C 80 80 4A */	lis r4, lit_3768@ha
/* 8049B790  3B E4 DC 84 */	addi r31, r4, lit_3768@l
...
/* 8049B83C  4B BD C5 28 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8049B840  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8049B844  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8049B848  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8049B84C  38 9A 05 6C */	addi r4, r26, 0x56c
/* 8049B850  4B BD 8B 64 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 8049B8D8  4B B8 3F A4 */	b fopKyM_createWpillar__FPC4cXyzfi
...
/* 8049B8EC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8049B8F0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8049B8F4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8049B918  4B E1 00 6C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8049B91C:
...
/* 8049B9B8  4B EA B7 20 */	b PSVECScale
...
/* 8049BA64  4B C3 BD 04 */	b checkIcePolygonDamage__9daAlink_cFP13cBgS_PolyInfo
...
/* 8049BAC0  4B EA B6 78 */	b PSVECSquareMag
...
/* 8049BAD4  4B BE 7B B4 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 8049BAD8  28 03 00 00 */	cmplwi r3, 0
/* 8049BADC  41 82 00 20 */	beq lbl_8049BAFC
/* 8049BAE0  7F 63 DB 78 */	mr r3, r27
/* 8049BAE4  4B BE 7B A4 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 8049BAE8  7C 64 1B 78 */	mr r4, r3
/* 8049BAEC  7F 43 D3 78 */	mr r3, r26
/* 8049BAF0  4B B7 EC 20 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8049BB04  4B DD 51 00 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8049BB20  4B DC BB 54 */	b cM_atan2s__Fff
...
/* 8049BB48  4B BE 87 78 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 8049BBBC  4B BE 7A CC */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 8049BBC0  28 03 00 00 */	cmplwi r3, 0
/* 8049BBC4  41 82 00 20 */	beq lbl_8049BBE4
/* 8049BBC8  7F 23 CB 78 */	mr r3, r25
/* 8049BBCC  4B BE 7A BC */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 8049BC30  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8049BC34  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8049BC38  38 81 00 18 */	addi r4, r1, 0x18
/* 8049BC3C  4B B7 DB BC */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8049BDC8  4B BE 84 F8 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 8049BE98  4B D0 C3 28 */	b dKy_Sound_set__F4cXyziUii
...
lbl_8049BED0:
/* 8049BED0  3C 60 80 4A */	lis r3, __vt__8cM3dGPla@ha
/* 8049BED4  38 03 DF 4C */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8049BEE8  4B BD 88 5C */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 8049BEEC  7F A3 EB 78 */	mr r3, r29
/* 8049BEF0  38 9A 05 80 */	addi r4, r26, 0x580
/* 8049BEF4  4B BD 8F 5C */	b GetPolyAtt0__4dBgSFRC13cBgS_PolyInfo
...
/* 8049BF38  3C 60 80 4A */	lis r3, __vt__8cM3dGPla@ha
/* 8049BF3C  38 03 DF 4C */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8049BF68  4B EA B1 D0 */	b PSVECSquareMag
...
/* 8049BFD8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049BFDC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 8049C048  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C04C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 8049C08C  4B DC B3 68 */	b __ct__5csXyzFsss
...
/* 8049C0DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8049C0E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8049C0E4  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8049C100  4B BB 01 18 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 8049C160  4B BD 9A 94 */	b ArrowStickCallBack__4dBgSFRC13cBgS_PolyInfoP10fopAc_ac_cR4cXyz
lbl_8049C164:
/* 8049C164  38 7A 05 80 */	addi r3, r26, 0x580
/* 8049C168  4B D0 F3 58 */	b dKy_pol_sound_get__FPC13cBgS_PolyInfo
/* 8049C16C  54 65 06 3E */	clrlwi r5, r3, 0x18
/* 8049C170  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8049C174  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8049C178  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 8049C18C  4B E2 86 88 */	b startHitItemSE__14Z2CreatureLinkFUlUlP14Z2SoundObjBasef
/* 8049C190  3C 60 80 4A */	lis r3, __vt__8cM3dGPla@ha
/* 8049C194  38 03 DF 4C */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8049C268  4B EA B1 34 */	b PSVECSquareDistance
...
/* 8049C2D8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C2DC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8049C348  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C34C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8049C350:
...
/* 8049C364  4B EA B0 38 */	b PSVECSquareDistance
...
/* 8049C3D4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C3D8  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 8049C444  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C448  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 8049C4CC  4B DC AC 84 */	b atan2sY_XZ__4cXyzCFv
...
/* 8049C4F0  4B EA AC 48 */	b PSVECSquareMag
...
/* 8049C560  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C564  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8049C5D0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049C5D4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8049C5D8:
...
/* 8049C6A4  4B EC 5B 74 */	b _restgpr_25

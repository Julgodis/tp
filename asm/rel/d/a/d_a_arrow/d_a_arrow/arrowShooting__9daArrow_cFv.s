...
/* 8049A9E4 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8049A9E8 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
lbl_8049AA28:
/* 8049AA28 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8049AA2C 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8049AA88 00000040  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8049AA8C 00000044  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 8049AA9C 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8049AAA0 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
lbl_8049AAC0:
/* 8049AAC0 00000000  3C 60 00 00 */	lis r3, lit_4541@ha /* 8049DD74 */
/* 8049AAC4 00000004  C0 03 00 00 */	lfs f0, lit_4541@l(r3) /* 8049DD74 */
...
/* 8049AAE4 00000024  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 8049AAE8 00000028  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 8049AB54 00000094  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8049AB58 00000098  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8049AB78 000000B8  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8049AB7C 000000BC  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 8049AB80 000000C0  83 C3 5D B8 */	lwz r30, 0x5db8(r3)
/* 8049AB84 000000C4  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8049AB88 000000C8  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 8049AB98 000000D8  3C 60 00 00 */	lis r3, lit_4130@ha /* 8049DD1C */
/* 8049AB9C 000000DC  C0 03 00 00 */	lfs f0, lit_4130@l(r3) /* 8049DD1C */
...
lbl_8049AC1C:
/* 8049AC1C 00000000  3C 60 00 00 */	lis r3, struct_80450D88+0x0@ha /* 80450D88 */
/* 8049AC20 00000004  38 83 00 00 */	addi r4, r3, struct_80450D88+0x0@l /* 80450D88 */
...
/* 8049AC58 0000000C  3C 80 00 00 */	lis r4, lit_4130@ha /* 8049DD1C */
/* 8049AC5C 00000010  C0 24 00 00 */	lfs f1, lit_4130@l(r4) /* 8049DD1C */

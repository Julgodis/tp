...
/* 8049B004  3C 60 80 4A */	lis r3, lit_3768@ha
/* 8049B008  3B C3 DC 84 */	addi r30, r3, lit_3768@l
...
/* 8049B034  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8049B038  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8049B03C  4B EA B4 74 */	b PSMTXCopy
/* 8049B040  C0 3E 01 28 */	lfs f1, 0x128(r30)
/* 8049B044  C0 5E 01 2C */	lfs f2, 0x12c(r30)
/* 8049B048  C0 7E 00 98 */	lfs f3, 0x98(r30)
/* 8049B04C  4B B7 1D 50 */	b transM__14mDoMtx_stack_cFfff
/* 8049B050  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049B054  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049B058  38 80 40 00 */	li r4, 0x4000
/* 8049B05C  38 A0 2A AA */	li r5, 0x2aaa
/* 8049B060  38 C0 40 00 */	li r6, 0x4000
/* 8049B064  4B B7 11 00 */	b mDoMtx_XYZrotM__FPA4_fsss
...
lbl_8049B078:
/* 8049B078  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
...
/* 8049B0A4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8049B0A8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8049B0AC  7C 85 23 78 */	mr r5, r4
/* 8049B0B0  4B EA B4 34 */	b PSMTXConcat
lbl_8049B0B4:
/* 8049B0B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8049B0B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8049B0BC  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 8049B0C0  38 84 00 24 */	addi r4, r4, 0x24
/* 8049B0C4  4B EA B3 EC */	b PSMTXCopy
...
/* 8049B0F0  4B B7 1B 10 */	b mDoMtx_MtxToRot__FPA4_CfP5csXyz

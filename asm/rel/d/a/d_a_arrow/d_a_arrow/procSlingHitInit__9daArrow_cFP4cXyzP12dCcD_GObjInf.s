...
/* 8049CD00  4B EC 54 D0 */	b _savegpr_26
/* 8049CD04  7C 7D 1B 78 */	mr r29, r3
/* 8049CD08  7C 9E 23 78 */	mr r30, r4
/* 8049CD0C  7C BA 2B 79 */	or. r26, r5, r5
/* 8049CD10  3C 60 80 4A */	lis r3, lit_3768@ha
/* 8049CD14  3B E3 DC 84 */	addi r31, r3, lit_3768@l
/* 8049CD18  41 82 00 14 */	beq lbl_8049CD2C
/* 8049CD1C  38 7A 00 58 */	addi r3, r26, 0x58
/* 8049CD20  4B BE 69 68 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 8049CD34  4B C3 4A 54 */	b notSwordHitVibActor__9daAlink_cFP10fopAc_ac_c
...
/* 8049CD6C  4B BE 76 3C */	b GetAtHitGObj__12dCcD_GObjInfFv
/* 8049CD70  28 03 00 00 */	cmplwi r3, 0
/* 8049CD74  41 82 00 58 */	beq lbl_8049CDCC
/* 8049CD78  7F 43 D3 78 */	mr r3, r26
/* 8049CD7C  4B BE 76 2C */	b GetAtHitGObj__12dCcD_GObjInfFv
...
/* 8049CD9C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8049CDA0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8049CDA4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8049CDC8  4B E0 EB BC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8049CDCC:
/* 8049CDCC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8049CDD0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8049CDD4  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8049CDF0  4B BA F4 28 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
lbl_8049CDF4:
...
/* 8049CE04  3C 60 80 4A */	lis r3, lit_5506@ha
/* 8049CE08  38 83 DE 68 */	addi r4, r3, lit_5506@l
/* 8049CE0C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 8049DE68 */
/* 8049CE10  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 8049DE6C */
/* 8049CE14  90 7D 0A 28 */	stw r3, 0xa28(r29)
/* 8049CE18  90 1D 0A 2C */	stw r0, 0xa2c(r29)
/* 8049CE1C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 8049DE70 */
...
/* 8049CE3C  4B EC 53 E0 */	b _restgpr_26

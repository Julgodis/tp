...
/* 8084FB68 00000018  3C 60 00 00 */	lis r3, lit_3929@ha
/* 8084FB6C 0000001C  3B E3 00 00 */	addi r31, r3, lit_3929@l
/* 8084FB70 00000020  4B FF 99 A9 */	bl dCam_getBody__Fv
/* 8084FB74 00000024  7C 7C 1B 78 */	mr r28, r3
/* 8084FB78 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8084FB7C 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8084FB9C 0000004C  3C 60 00 00 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 8084FBA0 00000050  83 A3 00 00 */	lwz r29, m_midnaActor__9daPy_py_c@l(r3)
...
/* 8084FBD0 0000000C  3C 60 00 00 */	lis r3, lit_6560@ha
/* 8084FBD4 00000010  38 63 00 00 */	addi r3, r3, lit_6560@l
...
/* 8084FBE8 00000024  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8084FBEC 00000028  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 8084FBFC 00000038  4B FF 99 1D */	bl setDemoName__11Z2StatusMgrFPc
...
/* 8084FC64 000000A0  4B FF 98 B5 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8084FC98 000000D4  4B FF 98 81 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 8084FC9C 000000D8  38 61 00 98 */	addi r3, r1, 0x98
/* 8084FCA0 000000DC  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 8084FCA4 000000E0  4B FF 98 75 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8084FEFC 000000D4  4B FF 96 1D */	bl init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 8084FF0C 000000E4  4B FF 96 0D */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 8084FF28 00000100  4B FF 95 F1 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8084FF6C 00000144  4B FF 95 AD */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 8084FF94 0000016C  4B FF 95 85 */	bl cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 8084FFE4 000001BC  4B FF 95 35 */	bl Set__9dCamera_cF4cXyz4cXyzfs
/* 8084FFE8 000001C0  38 61 00 98 */	addi r3, r1, 0x98
/* 8084FFEC 000001C4  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 8084FFF0 000001C8  4B FF 95 29 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80850030 00000208  4B FF 94 E9 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80850034 0000020C  B0 7B 06 BC */	sth r3, 0x6bc(r27)
/* 80850038 00000210  38 61 00 98 */	addi r3, r1, 0x98
/* 8085003C 00000214  4B FF 94 DD */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80850040 00000218  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80850044 0000021C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80850048 00000220  A8 9B 06 BC */	lha r4, 0x6bc(r27)
/* 8085004C 00000224  4B FF 94 CD */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8085005C 00000234  4B FF 94 BD */	bl transM__14mDoMtx_stack_cFfff
/* 80850060 00000238  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80850064 0000023C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80850094 0000026C  4B FF 94 85 */	bl cLib_targetAngleY__FPC3VecPC3Vec
/* 80850098 00000270  B0 7B 06 BC */	sth r3, 0x6bc(r27)
/* 8085009C 00000274  38 61 00 98 */	addi r3, r1, 0x98
/* 808500A0 00000278  4B FF 94 79 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 808500A4 0000027C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808500A8 00000280  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808500AC 00000284  A8 9B 06 BC */	lha r4, 0x6bc(r27)
/* 808500B0 00000288  4B FF 94 69 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 808500C0 00000298  4B FF 94 59 */	bl transM__14mDoMtx_stack_cFfff
/* 808500C4 0000029C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808500C8 000002A0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80850114 000002EC  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80850118 000002F0  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8085012C 00000304  4B FF 93 ED */	bl StartShock__12dVibration_cFii4cXyz
...
/* 80850250 00000428  4B FF 92 C9 */	bl Set__9dCamera_cF4cXyz4cXyzfs

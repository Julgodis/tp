...
/* 80853BDC  4B B0 E6 00 */	b _savegpr_29
/* 80853BE0  7C 7E 1B 78 */	mr r30, r3
/* 80853BE4  3C 80 80 85 */	lis r4, lit_3929@ha
/* 80853BE8  3B E4 4B 04 */	addi r31, r4, lit_3929@l
...
/* 80853C00  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha
/* 80853C04  C4 03 D2 E8 */	lfsu f0, m_cpadInfo__8mDoCPd_c@l(r3)
/* 80853C08  D0 1E 06 F0 */	stfs f0, 0x6f0(r30)
/* 80853C0C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 803E0004 */
...
/* 80853C20  3C 60 80 85 */	lis r3, s_waterfall__FPvPv@ha
/* 80853C24  38 63 38 80 */	addi r3, r3, s_waterfall__FPvPv@l
/* 80853C28  7F C4 F3 78 */	mr r4, r30
/* 80853C2C  4B 7C D7 0C */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 80853C60  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80853C64  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80853C78  4B 81 BE 98 */	b StartQuake__12dVibration_cFii4cXyz
lbl_80853C7C:
...
/* 80853CC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80853CCC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80853CD0  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80853CD4  38 80 00 1F */	li r4, 0x1f
/* 80853CD8  4B 81 C0 BC */	b StopQuake__12dVibration_cFi
lbl_80853CDC:
...
/* 80853CF0  3C 60 80 85 */	lis r3, lit_7982@ha
/* 80853CF4  38 63 4E 90 */	addi r3, r3, lit_7982@l
...
/* 80853DBC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80853DC0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80853DC4  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80853DC8  88 03 05 6A */	lbz r0, 0x56a(r3)	/* effective address: 8040672A */
...
lbl_80853DE8:
/* 80853DE8  4B 92 D8 58 */	b dCam_getBody__Fv
/* 80853DEC  38 80 00 02 */	li r4, 2
/* 80853DF0  4B 90 F2 38 */	b SetTrimTypeForce__9dCamera_cFl
...
/* 80853E04  4B 92 D8 3C */	b dCam_getBody__Fv
/* 80853E08  38 80 00 00 */	li r4, 0
/* 80853E0C  4B 90 F2 1C */	b SetTrimTypeForce__9dCamera_cFl
/* 80853E10  4B 92 D8 30 */	b dCam_getBody__Fv
/* 80853E14  38 80 00 05 */	li r4, 5
/* 80853E18  4B 90 FF 38 */	b ModeFix__9dCamera_cFl
lbl_80853E1C:
/* 80853E1C  7F C3 F3 78 */	mr r3, r30
/* 80853E20  38 80 00 00 */	li r4, 0
/* 80853E24  4B 7C 68 A8 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80853E38  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80853E3C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80853E40  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80853E44  4B 82 2C 68 */	b CrrPos__9dBgS_AcchFR4dBgS
lbl_80853E48:
...
/* 80853E5C  4B 7D 92 10 */	b dComIfGp_getReverb__Fi
/* 80853E60  7C 65 1B 78 */	mr r5, r3
/* 80853E64  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80853E68  38 80 00 00 */	li r4, 0
/* 80853E6C  4B 7B D2 44 */	b play__16mDoExt_McaMorfSOFUlSc
lbl_80853E70:
...
/* 80853E94  4B A1 C8 AC */	b cLib_chaseF__FPfff
...
/* 80853EB4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80853EB8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80853EDC  4B B0 E3 4C */	b _restgpr_29

...
/* 80657278 00000018  4B D0 AF 64 */	b _savegpr_29
/* 8065727C 0000001C  7C 7E 1B 78 */	mr r30, r3
/* 80657280 00000020  3C 60 80 65 */	lis r3, lit_4003@ha
/* 80657284 00000024  3B E3 79 24 */	addi r31, r3, lit_4003@l
/* 80657288 00000028  3C 60 80 65 */	lis r3, l_HOSTIO@ha
/* 8065728C 0000002C  38 83 7A 9C */	addi r4, r3, l_HOSTIO@l
/* 80657290 00000030  C0 64 00 14 */	lfs f3, 0x14(r4)	/* effective address: 80657AB0 */
/* 80657294 00000034  C0 44 00 18 */	lfs f2, 0x18(r4)	/* effective address: 80657AB4 */
/* 80657298 00000038  88 7E 07 81 */	lbz r3, 0x781(r30)
/* 8065729C 0000003C  38 03 FF FF */	addi r0, r3, -1
/* 806572A0 00000040  C8 3F 00 20 */	lfd f1, 0x20(r31)	/* effective address: 80657944 */
...
/* 806572C4 00000064  C0 24 00 1C */	lfs f1, 0x1c(r4)	/* effective address: 80657AB8 */
...
/* 8065732C 00000058  C8 3F 00 28 */	lfd f1, 0x28(r31)	/* effective address: 8065794C */
...
/* 80657344 00000070  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 80657930 */
/* 80657348 00000074  EF E0 00 72 */	fmuls f31, f0, f1
/* 8065734C 00000078  C0 1F 00 10 */	lfs f0, 0x10(r31)	/* effective address: 80657934 */
...
/* 80657360 00000004  3C 80 80 65 */	lis r4, l_HOSTIO@ha
/* 80657364 00000008  38 84 7A 9C */	addi r4, r4, l_HOSTIO@l
/* 80657368 0000000C  C0 24 00 04 */	lfs f1, 4(r4)	/* effective address: 80657AA0 */
/* 8065736C 00000010  C0 44 00 08 */	lfs f2, 8(r4)	/* effective address: 80657AA4 */
/* 80657370 00000014  4B BF D2 40 */	b paneTrans__8CPaneMgrFff
/* 80657374 00000018  3C 60 80 65 */	lis r3, l_HOSTIO@ha
/* 80657378 0000001C  38 63 7A 9C */	addi r3, r3, l_HOSTIO@l
/* 8065737C 00000020  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80657AA8 */
...
/* 806573A4 00000048  3C 80 80 65 */	lis r4, l_HOSTIO@ha
/* 806573A8 0000004C  3B A4 7A 9C */	addi r29, r4, l_HOSTIO@l
/* 806573AC 00000050  C0 3D 00 10 */	lfs f1, 0x10(r29)	/* effective address: 80657AAC */
/* 806573B0 00000054  4B BF E4 20 */	b setAlphaRate__13CPaneMgrAlphaFf
/* 806573B4 00000058  80 7E 05 88 */	lwz r3, 0x588(r30)
/* 806573B8 0000005C  C0 7F 00 14 */	lfs f3, 0x14(r31)	/* effective address: 80657938 */
/* 806573BC 00000060  C0 5F 00 18 */	lfs f2, 0x18(r31)	/* effective address: 8065793C */
/* 806573C0 00000064  C0 3F 00 10 */	lfs f1, 0x10(r31)	/* effective address: 80657934 */
...
/* 806573D4 00000078  3C 80 80 65 */	lis r4, l_HOSTIO@ha
/* 806573D8 0000007C  3B E4 7A 9C */	addi r31, r4, l_HOSTIO@l
/* 806573DC 00000080  C0 3F 00 24 */	lfs f1, 0x24(r31)	/* effective address: 80657AC0 */
/* 806573E0 00000084  C0 1D 00 10 */	lfs f0, 0x10(r29)	/* effective address: 80657AAC */
/* 806573E4 00000088  EC 01 00 32 */	fmuls f0, f1, f0
/* 806573E8 0000008C  EC 22 00 32 */	fmuls f1, f2, f0
/* 806573EC 00000090  4B BF E3 E4 */	b setAlphaRate__13CPaneMgrAlphaFf
/* 806573F0 00000094  80 7E 05 8C */	lwz r3, 0x58c(r30)
/* 806573F4 00000098  C0 3F 00 24 */	lfs f1, 0x24(r31)	/* effective address: 80657AC0 */
/* 806573F8 0000009C  C0 1D 00 10 */	lfs f0, 0x10(r29)	/* effective address: 80657AAC */
/* 806573FC 000000A0  EC 21 00 32 */	fmuls f1, f1, f0
/* 80657400 000000A4  4B BF E3 D0 */	b setAlphaRate__13CPaneMgrAlphaFf
/* 80657404 000000A8  3C 60 80 65 */	lis r3, l_HOSTIO@ha
/* 80657408 000000AC  38 63 7A 9C */	addi r3, r3, l_HOSTIO@l
/* 8065740C 000000B0  C0 03 00 30 */	lfs f0, 0x30(r3)	/* effective address: 80657ACC */
...
/* 80657434 000000D8  3C 80 80 65 */	lis r4, l_HOSTIO@ha
/* 80657438 000000DC  38 84 7A 9C */	addi r4, r4, l_HOSTIO@l
/* 8065743C 000000E0  C0 24 00 34 */	lfs f1, 0x34(r4)	/* effective address: 80657AD0 */
/* 80657440 000000E4  C0 1D 00 10 */	lfs f0, 0x10(r29)	/* effective address: 80657AAC */
/* 80657444 000000E8  EC 21 00 32 */	fmuls f1, f1, f0
/* 80657448 000000EC  4B BF E3 88 */	b setAlphaRate__13CPaneMgrAlphaFf
/* 8065744C 000000F0  3C 60 80 65 */	lis r3, l_HOSTIO@ha
/* 80657450 000000F4  38 63 7A 9C */	addi r3, r3, l_HOSTIO@l
/* 80657454 000000F8  88 03 00 58 */	lbz r0, 0x58(r3)	/* effective address: 80657AF4 */
/* 80657458 000000FC  28 00 00 00 */	cmplwi r0, 0
/* 8065745C 00000100  41 82 00 14 */	beq lbl_80657470
/* 80657460 00000104  88 03 00 59 */	lbz r0, 0x59(r3)	/* effective address: 80657AF5 */
/* 80657464 00000108  98 1E 07 81 */	stb r0, 0x781(r30)
/* 80657468 0000010C  88 03 00 5A */	lbz r0, 0x5a(r3)	/* effective address: 80657AF6 */
...
/* 8065747C 00000008  4B D0 AD AC */	b _restgpr_29

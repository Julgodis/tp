...
/* 805A883C 00000010  4B DB 99 A0 */	b _savegpr_29
/* 805A8840 00000014  7C 7D 1B 78 */	mr r29, r3
/* 805A8844 00000018  3C 80 80 5B */	lis r4, lit_3759@ha
/* 805A8848 0000001C  3B C4 8F BC */	addi r30, r4, lit_3759@l
...
/* 805A8868 0000003C  4B A7 02 FC */	b __ct__10fopAc_ac_cFv
lbl_805A886C:
...
/* 805A8890 00000018  4B AA 8F 5C */	b dPath_GetRoomPath__Fii
/* 805A8894 0000001C  48 00 00 08 */	b lbl_805A889C
lbl_805A8898:
/* 805A8898 00000000  38 60 00 00 */	li r3, 0
lbl_805A889C:
/* 805A889C 00000000  3C 80 80 45 */	lis r4, m_path__8daYkgr_c@ha
/* 805A88A0 00000004  90 64 0D 94 */	stw r3, m_path__8daYkgr_c@l(r4)
/* 805A88A4 00000008  3C 60 80 45 */	lis r3, m_emitter__8daYkgr_c@ha
/* 805A88A8 0000000C  80 03 0D 98 */	lwz r0, m_emitter__8daYkgr_c@l(r3)
/* 805A88AC 00000010  28 00 00 00 */	cmplwi r0, 0
/* 805A88B0 00000014  40 82 01 40 */	bne lbl_805A89F0
/* 805A88B4 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A88B8 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A88BC 00000020  80 83 5D AC */	lwz r4, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 805A88C0 00000024  C0 04 04 D0 */	lfs f0, 0x4d0(r4)	/* effective address: 804504D0 */
/* 805A88C4 00000028  38 DD 04 D0 */	addi r6, r29, 0x4d0
/* 805A88C8 0000002C  D0 1D 04 D0 */	stfs f0, 0x4d0(r29)
/* 805A88CC 00000030  C0 04 04 D4 */	lfs f0, 0x4d4(r4)	/* effective address: 804504D4 */
/* 805A88D0 00000034  D0 1D 04 D4 */	stfs f0, 0x4d4(r29)
/* 805A88D4 00000038  C0 04 04 D8 */	lfs f0, 0x4d8(r4)	/* effective address: 804504D8 */
/* 805A88D8 0000003C  D0 1D 04 D8 */	stfs f0, 0x4d8(r29)
/* 805A88DC 00000040  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 805A8918 0000007C  C0 3E 00 10 */	lfs f1, 0x10(r30)	/* effective address: 805A8FCC */
/* 805A891C 00000080  4B AA 41 74 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 805A8920 00000084  3C 80 80 45 */	lis r4, m_emitter__8daYkgr_c@ha
/* 805A8924 00000088  90 64 0D 98 */	stw r3, m_emitter__8daYkgr_c@l(r4)
/* 805A8928 0000008C  28 03 00 00 */	cmplwi r3, 0
/* 805A892C 00000090  41 82 00 20 */	beq lbl_805A894C
/* 805A8930 00000094  3C 80 80 5B */	lis r4, YkgrCB@ha
/* 805A8934 00000098  38 04 91 38 */	addi r0, r4, YkgrCB@l
/* 805A8938 0000009C  90 03 00 F0 */	stw r0, 0xf0(r3)
/* 805A893C 000000A0  7C 03 03 78 */	mr r3, r0
/* 805A8940 000000A4  C0 3E 00 38 */	lfs f1, 0x38(r30)	/* effective address: 805A8FF4 */
...
/* 805A8958 00000004  4B A7 0F 6C */	b fopAcM_setStageLayer__FPv
...
/* 805A8968 00000014  3C 60 80 45 */	lis r3, struct_80450D8C+0x2@ha
/* 805A896C 00000018  98 03 0D 8E */	stb r0, struct_80450D8C+0x2@l(r3)
/* 805A8970 0000001C  3C 60 80 45 */	lis r3, m_emitter__8daYkgr_c@ha
/* 805A8974 00000020  38 83 0D 98 */	addi r4, r3, m_emitter__8daYkgr_c@l
/* 805A8978 00000024  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80450D98 */
/* 805A897C 00000028  98 03 00 BB */	stb r0, 0xbb(r3)	/* effective address: 804500BB */
/* 805A8980 0000002C  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 805A8FC8 */
/* 805A8984 00000030  D0 1D 05 A4 */	stfs f0, 0x5a4(r29)
/* 805A8988 00000034  C0 1E 00 08 */	lfs f0, 8(r30)	/* effective address: 805A8FC4 */
/* 805A898C 00000038  D0 1D 05 A8 */	stfs f0, 0x5a8(r29)
/* 805A8990 0000003C  80 04 00 00 */	lwz r0, 0(r4)	/* effective address: 80450D98 */
...
/* 805A89A0 0000004C  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A89A4 00000050  98 03 0D 8D */	stb r0, struct_80450D8C+0x1@l(r3)
/* 805A89A8 00000054  48 00 00 84 */	b lbl_805A8A2C
lbl_805A89AC:
/* 805A89AC 00000000  38 A0 00 00 */	li r5, 0
/* 805A89B0 00000004  3C 60 80 45 */	lis r3, struct_80450D8C+0x2@ha
/* 805A89B4 00000008  98 A3 0D 8E */	stb r5, struct_80450D8C+0x2@l(r3)
/* 805A89B8 0000000C  3C 60 80 45 */	lis r3, m_emitter__8daYkgr_c@ha
/* 805A89BC 00000010  38 83 0D 98 */	addi r4, r3, m_emitter__8daYkgr_c@l
/* 805A89C0 00000014  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80450D98 */
/* 805A89C4 00000018  98 A3 00 BB */	stb r5, 0xbb(r3)	/* effective address: 804500BB */
/* 805A89C8 0000001C  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 805A8FC8 */
/* 805A89CC 00000020  D0 1D 05 A4 */	stfs f0, 0x5a4(r29)
/* 805A89D0 00000024  C0 1E 00 08 */	lfs f0, 8(r30)	/* effective address: 805A8FC4 */
/* 805A89D4 00000028  D0 1D 05 A8 */	stfs f0, 0x5a8(r29)
/* 805A89D8 0000002C  80 04 00 00 */	lwz r0, 0(r4)	/* effective address: 80450D98 */
/* 805A89DC 00000030  28 00 00 00 */	cmplwi r0, 0
/* 805A89E0 00000034  41 82 00 4C */	beq lbl_805A8A2C
/* 805A89E4 00000038  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A89E8 0000003C  98 A3 0D 8D */	stb r5, struct_80450D8C+0x1@l(r3)
...
/* 805A8A04 00000014  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A8A08 00000018  98 03 0D 8D */	stb r0, struct_80450D8C+0x1@l(r3)
...
/* 805A8A1C 0000000C  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A8A20 00000010  98 03 0D 8D */	stb r0, struct_80450D8C+0x1@l(r3)
lbl_805A8A24:
...
/* 805A8A34 00000004  4B DB 97 F4 */	b _restgpr_29

...
/* 805A8848 0000001C  3B C4 00 00 */	addi r30, r4, lit_3759@l
...
/* 805A88B8 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 805A8934 00000098  38 04 00 00 */	addi r0, r4, YkgrCB@l
...
/* 805A8968 00000014  3C 60 00 00 */	lis r3, struct_80450D8C@ha
/* 805A896C 00000018  98 03 00 00 */	stb r0, struct_80450D8C@l(r3)
/* 805A8970 0000001C  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha
/* 805A8974 00000020  38 83 00 00 */	addi r4, r3, m_emitter__8daYkgr_c@l
...
/* 805A89A0 0000004C  3C 60 00 00 */	lis r3, struct_80450D8C@ha
/* 805A89A4 00000050  98 03 00 00 */	stb r0, struct_80450D8C@l(r3)
/* 805A89A8 00000054  48 00 00 84 */	b lbl_805A8A2C
lbl_805A89AC:
/* 805A89AC 00000000  38 A0 00 00 */	li r5, 0
/* 805A89B0 00000004  3C 60 00 00 */	lis r3, struct_80450D8C@ha
/* 805A89B4 00000008  98 A3 00 00 */	stb r5, struct_80450D8C@l(r3)
/* 805A89B8 0000000C  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha
/* 805A89BC 00000010  38 83 00 00 */	addi r4, r3, m_emitter__8daYkgr_c@l
...
/* 805A89E4 00000038  3C 60 00 00 */	lis r3, struct_80450D8C@ha
/* 805A89E8 0000003C  98 A3 00 00 */	stb r5, struct_80450D8C@l(r3)
...
/* 805A8A04 00000014  3C 60 00 00 */	lis r3, struct_80450D8C@ha
/* 805A8A08 00000018  98 03 00 00 */	stb r0, struct_80450D8C@l(r3)
...
/* 805A8A1C 0000000C  3C 60 00 00 */	lis r3, struct_80450D8C@ha
/* 805A8A20 00000010  98 03 00 00 */	stb r0, struct_80450D8C@l(r3)
lbl_805A8A24:

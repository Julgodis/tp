...
/* 805A8844 00000018  3C 80 00 00 */	lis r4, lit_3759@ha /* 805A8FBC */
/* 805A8848 0000001C  3B C4 00 00 */	addi r30, r4, lit_3759@l /* 805A8FBC */
...
lbl_805A889C:
/* 805A889C 00000000  3C 80 00 00 */	lis r4, m_path__8daYkgr_c@ha /* 80450D94 */
/* 805A88A0 00000004  90 64 00 00 */	stw r3, m_path__8daYkgr_c@l(r4) /* 80450D94 */
/* 805A88A4 00000008  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha /* 80450D98 */
/* 805A88A8 0000000C  80 03 00 00 */	lwz r0, m_emitter__8daYkgr_c@l(r3) /* 80450D98 */
/* 805A88AC 00000010  28 00 00 00 */	cmplwi r0, 0
/* 805A88B0 00000014  40 82 01 40 */	bne lbl_805A89F0
/* 805A88B4 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A88B8 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805A8920 00000084  3C 80 00 00 */	lis r4, m_emitter__8daYkgr_c@ha /* 80450D98 */
/* 805A8924 00000088  90 64 00 00 */	stw r3, m_emitter__8daYkgr_c@l(r4) /* 80450D98 */
/* 805A8928 0000008C  28 03 00 00 */	cmplwi r3, 0
/* 805A892C 00000090  41 82 00 20 */	beq lbl_805A894C
/* 805A8930 00000094  3C 80 00 00 */	lis r4, YkgrCB@ha /* 805A9138 */
/* 805A8934 00000098  38 04 00 00 */	addi r0, r4, YkgrCB@l /* 805A9138 */
...
/* 805A8968 00000014  3C 60 00 00 */	lis r3, struct_80450D8C+0x2@ha /* 80450D8E */
/* 805A896C 00000018  98 03 00 00 */	stb r0, struct_80450D8C+0x2@l(r3) /* 80450D8E */
/* 805A8970 0000001C  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha /* 80450D98 */
/* 805A8974 00000020  38 83 00 00 */	addi r4, r3, m_emitter__8daYkgr_c@l /* 80450D98 */
...
/* 805A89A0 0000004C  3C 60 00 00 */	lis r3, struct_80450D8C+0x1@ha /* 80450D8D */
/* 805A89A4 00000050  98 03 00 00 */	stb r0, struct_80450D8C+0x1@l(r3) /* 80450D8D */
/* 805A89A8 00000054  48 00 00 84 */	b lbl_805A8A2C
lbl_805A89AC:
/* 805A89AC 00000000  38 A0 00 00 */	li r5, 0
/* 805A89B0 00000004  3C 60 00 00 */	lis r3, struct_80450D8C+0x2@ha /* 80450D8E */
/* 805A89B4 00000008  98 A3 00 00 */	stb r5, struct_80450D8C+0x2@l(r3) /* 80450D8E */
/* 805A89B8 0000000C  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha /* 80450D98 */
/* 805A89BC 00000010  38 83 00 00 */	addi r4, r3, m_emitter__8daYkgr_c@l /* 80450D98 */
...
/* 805A89E4 00000038  3C 60 00 00 */	lis r3, struct_80450D8C+0x1@ha /* 80450D8D */
/* 805A89E8 0000003C  98 A3 00 00 */	stb r5, struct_80450D8C+0x1@l(r3) /* 80450D8D */
...
/* 805A8A04 00000014  3C 60 00 00 */	lis r3, struct_80450D8C+0x1@ha /* 80450D8D */
/* 805A8A08 00000018  98 03 00 00 */	stb r0, struct_80450D8C+0x1@l(r3) /* 80450D8D */
...
/* 805A8A1C 0000000C  3C 60 00 00 */	lis r3, struct_80450D8C+0x1@ha /* 80450D8D */
/* 805A8A20 00000010  98 03 00 00 */	stb r0, struct_80450D8C+0x1@l(r3) /* 80450D8D */
lbl_805A8A24:

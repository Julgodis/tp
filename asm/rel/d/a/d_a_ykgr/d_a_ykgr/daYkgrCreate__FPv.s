...
/* 805A883C  4B DB 99 A0 */	b _savegpr_29
/* 805A8840  7C 7D 1B 78 */	mr r29, r3
/* 805A8844  3C 80 80 5B */	lis r4, lit_3759@ha
/* 805A8848  3B C4 8F BC */	addi r30, r4, lit_3759@l
...
/* 805A8868  4B A7 02 FC */	b __ct__10fopAc_ac_cFv
lbl_805A886C:
...
/* 805A8890  4B AA 8F 5C */	b dPath_GetRoomPath__Fii
/* 805A8894  48 00 00 08 */	b lbl_805A889C
lbl_805A8898:
/* 805A8898  38 60 00 00 */	li r3, 0
lbl_805A889C:
/* 805A889C  3C 80 80 45 */	lis r4, m_path__8daYkgr_c@ha
/* 805A88A0  90 64 0D 94 */	stw r3, m_path__8daYkgr_c@l(r4)
/* 805A88A4  3C 60 80 45 */	lis r3, m_emitter__8daYkgr_c@ha
...
/* 805A891C  4B AA 41 74 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 805A8920  3C 80 80 45 */	lis r4, m_emitter__8daYkgr_c@ha
/* 805A8924  90 64 0D 98 */	stw r3, m_emitter__8daYkgr_c@l(r4)
/* 805A8928  28 03 00 00 */	cmplwi r3, 0
/* 805A892C  41 82 00 20 */	beq lbl_805A894C
/* 805A8930  3C 80 80 5B */	lis r4, YkgrCB@ha
/* 805A8934  38 04 91 38 */	addi r0, r4, YkgrCB@l
...
/* 805A89A0  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A89A4  98 03 0D 8D */	stb r0, struct_80450D8C+0x1@l(r3)
/* 805A89A8  48 00 00 84 */	b lbl_805A8A2C
lbl_805A89AC:
/* 805A89AC  38 A0 00 00 */	li r5, 0
/* 805A89B0  3C 60 80 45 */	lis r3, struct_80450D8C+0x2@ha
...
/* 805A89E8  98 A3 0D 8D */	stb r5, struct_80450D8C+0x1@l(r3)
...
/* 805A8A04  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A8A08  98 03 0D 8D */	stb r0, struct_80450D8C+0x1@l(r3)
...
/* 805A8A1C  3C 60 80 45 */	lis r3, struct_80450D8C+0x1@ha
/* 805A8A20  98 03 0D 8D */	stb r0, struct_80450D8C+0x1@l(r3)
lbl_805A8A24:
...
/* 805A8A34  4B DB 97 F4 */	b _restgpr_29

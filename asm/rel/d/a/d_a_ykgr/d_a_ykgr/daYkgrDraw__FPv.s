...
/* 805A8BD4 00000018  3C 60 00 00 */	lis r3, lit_3759@ha /* 805A8FBC */
/* 805A8BD8 0000001C  3B E3 00 00 */	addi r31, r3, lit_3759@l /* 805A8FBC */
/* 805A8BDC 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A8BE0 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A8BE4 00000028  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 805A8BE8 0000002C  3C 80 00 00 */	lis r4, stringBase0@ha /* 805A9018 */
/* 805A8BEC 00000030  38 84 00 00 */	addi r4, r4, stringBase0@l /* 805A9018 */
/* 805A8BF0 00000034  4B FF F8 09 */	bl strcmp
/* 805A8BF4 00000038  2C 03 00 00 */	cmpwi r3, 0
/* 805A8BF8 0000003C  40 82 00 60 */	bne lbl_805A8C58
/* 805A8BFC 00000040  4B FF F7 FD */	bl dComIfGs_BossLife_public_Get__Fv
...
/* 805A8C3C 00000080  3C 60 00 00 */	lis r3, struct_80450D8C+0x2@ha /* 80450D8E */
/* 805A8C40 00000084  38 83 00 00 */	addi r4, r3, struct_80450D8C+0x2@l /* 80450D8E */
...
lbl_805A8C58:
/* 805A8C58 00000000  3C 60 00 00 */	lis r3, struct_80450D8C+0x2@ha /* 80450D8E */
/* 805A8C5C 00000004  88 03 00 00 */	lbz r0, struct_80450D8C+0x2@l(r3) /* 80450D8E */
...
lbl_805A8C70:
/* 805A8C70 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A8C74 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805A8CA0 00000030  4B FF F7 59 */	bl dKyr_get_vectle_calc__FP4cXyzP4cXyzP4cXyz
/* 805A8CA4 00000034  C0 21 00 08 */	lfs f1, 8(r1)
/* 805A8CA8 00000038  C0 41 00 10 */	lfs f2, 0x10(r1)
/* 805A8CAC 0000003C  4B FF F7 4D */	bl cM_atan2s__Fff
...
/* 805A8CE0 00000004  4B FF F7 19 */	bl cM_atan2s__Fff
/* 805A8CE4 00000008  7C 03 00 D0 */	neg r0, r3
/* 805A8CE8 0000000C  B0 1E 04 DC */	sth r0, 0x4dc(r30)
/* 805A8CEC 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805A8CF0 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805A8D00 00000024  4B FF F6 F9 */	bl PSMTXTrans
/* 805A8D04 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805A8D08 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805A8D0C 00000030  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 805A8D10 00000034  4B FF F6 E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 805A8D14 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805A8D18 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805A8D1C 00000040  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 805A8D20 00000044  4B FF F6 D9 */	bl mDoMtx_XrotM__FPA4_fs
/* 805A8D24 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805A8D28 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805A8D2C 00000050  3B DE 05 70 */	addi r30, r30, 0x570
/* 805A8D30 00000054  7F C4 F3 78 */	mr r4, r30
/* 805A8D34 00000058  4B FF F6 C5 */	bl PSMTXCopy
/* 805A8D38 0000005C  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha /* 80450D98 */
/* 805A8D3C 00000060  80 A3 00 00 */	lwz r5, m_emitter__8daYkgr_c@l(r3) /* 80450D98 */
...
/* 805A8D54 00000078  4B FF F6 A5 */	bl func_802807E0
/* 805A8D58 0000007C  3C 60 00 00 */	lis r3, struct_80450D8C+0x2@ha /* 80450D8E */
/* 805A8D5C 00000080  88 03 00 00 */	lbz r0, struct_80450D8C+0x2@l(r3) /* 80450D8E */
/* 805A8D60 00000084  3C 60 00 00 */	lis r3, m_emitter__8daYkgr_c@ha /* 80450D98 */
/* 805A8D64 00000088  38 63 00 00 */	addi r3, r3, m_emitter__8daYkgr_c@l /* 80450D98 */

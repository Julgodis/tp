...
/* 805A8BF0  4B DB FD A4 */	b strcmp
/* 805A8BF4  2C 03 00 00 */	cmpwi r3, 0
/* 805A8BF8  40 82 00 60 */	bne lbl_805A8C58
/* 805A8BFC  4B A8 4D 14 */	b dComIfGs_BossLife_public_Get__Fv
...
lbl_805A8C58:
/* 805A8C58  3C 60 80 45 */	lis r3, struct_80450D8C+0x2@ha
/* 805A8C5C  88 03 0D 8E */	lbz r0, struct_80450D8C+0x2@l(r3)
...
/* 805A8CA0  4B AB 2A C0 */	b dKyr_get_vectle_calc__FP4cXyzP4cXyzP4cXyz
/* 805A8CA4  C0 21 00 08 */	lfs f1, 8(r1)
/* 805A8CA8  C0 41 00 10 */	lfs f2, 0x10(r1)
/* 805A8CAC  4B CB E9 C8 */	b cM_atan2s__Fff
...
/* 805A8CE0  4B CB E9 94 */	b cM_atan2s__Fff
/* 805A8CE4  7C 03 00 D0 */	neg r0, r3
/* 805A8CE8  B0 1E 04 DC */	sth r0, 0x4dc(r30)
/* 805A8CEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A8CF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A8CF4  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 805A8CF8  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 805A8CFC  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 805A8D00  4B D9 DB E8 */	b PSMTXTrans
/* 805A8D04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A8D08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A8D0C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 805A8D10  4B A6 37 24 */	b mDoMtx_YrotM__FPA4_fs
/* 805A8D14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A8D18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A8D1C  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 805A8D20  4B A6 36 7C */	b mDoMtx_XrotM__FPA4_fs
/* 805A8D24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A8D28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A8D2C  3B DE 05 70 */	addi r30, r30, 0x570
/* 805A8D30  7F C4 F3 78 */	mr r4, r30
/* 805A8D34  4B D9 D7 7C */	b PSMTXCopy
/* 805A8D38  3C 60 80 45 */	lis r3, m_emitter__8daYkgr_c@ha
/* 805A8D3C  80 A3 0D 98 */	lwz r5, m_emitter__8daYkgr_c@l(r3)
...
/* 805A8D54  4B CD 7A 8C */	b func_802807E0
/* 805A8D58  3C 60 80 45 */	lis r3, struct_80450D8C+0x2@ha

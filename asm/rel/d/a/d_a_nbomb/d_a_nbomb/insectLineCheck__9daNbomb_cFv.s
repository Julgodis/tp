...
/* 804C8940 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804C8944 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 804C8954 0000002C  4B BA BA 60 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 804C8958 00000030  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804C895C 00000034  41 82 00 C8 */	beq lbl_804C8A24
/* 804C8960 00000038  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8964 0000003C  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804C8978 00000050  4B BA BD CC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 804C897C 00000054  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804C8980 00000058  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 804C8984 0000005C  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 804C8988 00000060  4B C1 AE 98 */	b getBombInsectLimitAngle__9daAlink_cCFv
/* 804C898C 00000064  7C 60 07 34 */	extsh r0, r3
/* 804C8990 00000068  3C 60 80 4D */	lis r3, lit_4689@ha
/* 804C8994 0000006C  C8 23 C3 D8 */	lfd f1, lit_4689@l(r3)
...
/* 804C89B0 00000088  3C 60 80 4D */	lis r3, lit_5214@ha
/* 804C89B4 0000008C  C0 03 C3 F8 */	lfs f0, lit_5214@l(r3)
...
/* 804C89C8 000000A0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804C89CC 000000A4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804C89F0 0000000C  4B BA C5 00 */	b GetGroundCode__4dBgSFRC13cBgS_PolyInfo
/* 804C89F4 00000010  2C 03 00 01 */	cmpwi r3, 1
/* 804C89F8 00000014  40 82 00 18 */	bne lbl_804C8A10
lbl_804C89FC:
/* 804C89FC 00000000  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8A00 00000004  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
lbl_804C8A10:
/* 804C8A10 00000000  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8A14 00000004  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l

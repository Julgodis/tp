...
/* 804C8954  4B BA BA 60 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 804C8958  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804C895C  41 82 00 C8 */	beq lbl_804C8A24
/* 804C8960  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8964  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804C8994  C8 23 C3 D8 */	lfd f1, lit_4689@l(r3)
...
/* 804C89B0  3C 60 80 4D */	lis r3, lit_5214@ha
/* 804C89B4  C0 03 C3 F8 */	lfs f0, lit_5214@l(r3)
...
/* 804C89C8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804C89CC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804C89F0  4B BA C5 00 */	b GetGroundCode__4dBgSFRC13cBgS_PolyInfo
/* 804C89F4  2C 03 00 01 */	cmpwi r3, 1
/* 804C89F8  40 82 00 18 */	bne lbl_804C8A10
lbl_804C89FC:
/* 804C89FC  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8A00  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 804C8A04  90 01 00 18 */	stw r0, 0x18(r1)
/* 804C8A08  38 60 00 02 */	li r3, 2
/* 804C8A0C  48 00 00 1C */	b lbl_804C8A28
lbl_804C8A10:
/* 804C8A10  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8A14  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l

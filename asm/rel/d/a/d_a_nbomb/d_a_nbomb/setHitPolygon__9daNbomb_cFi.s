...
/* 804C8AA0  4B E9 97 3C */	b _savegpr_29
/* 804C8AA4  7C 7E 1B 78 */	mr r30, r3
/* 804C8AA8  7C 9F 23 79 */	or. r31, r4, r4
/* 804C8AAC  3C 60 80 4D */	lis r3, lit_3767@ha
/* 804C8AB0  3B A3 C3 40 */	addi r29, r3, lit_3767@l
/* 804C8AB4  40 82 00 28 */	bne lbl_804C8ADC
/* 804C8AB8  38 7E 0B 10 */	addi r3, r30, 0xb10
/* 804C8ABC  38 9E 0A B4 */	addi r4, r30, 0xab4
/* 804C8AC0  4B D9 F6 88 */	b SetPolyInfo__13cBgS_PolyInfoFRC13cBgS_PolyInfo
...
/* 804C8AFC  4B BA BC 48 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 804C8B00  38 7E 0B F0 */	addi r3, r30, 0xbf0
/* 804C8B04  38 81 00 34 */	addi r4, r1, 0x34
/* 804C8B08  4B E7 E6 8C */	b PSVECDotProduct
...
/* 804C8B30  4B D9 E1 8C */	b outprod__4cXyzCFRC3Vec
...
/* 804C8B54  4B D9 E3 F4 */	b normalizeZP__4cXyzFv
...
/* 804C8B7C  4B D9 EC 98 */	b cM_atan2f__Fff
/* 804C8B80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804C8B84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804C8B88  38 81 00 28 */	addi r4, r1, 0x28
/* 804C8B8C  4B E7 DC EC */	b PSMTXRotAxisRad
...
/* 804C8BA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804C8BAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804C8BB0  38 9E 0C 08 */	addi r4, r30, 0xc08
/* 804C8BB4  7C 85 23 78 */	mr r5, r4
/* 804C8BB8  4B E7 E2 94 */	b PSMTXMultVecSR
/* 804C8BBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804C8BC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804C8BC4  38 9E 0B FC */	addi r4, r30, 0xbfc
/* 804C8BC8  7C 85 23 78 */	mr r5, r4
/* 804C8BCC  4B E7 E2 80 */	b PSMTXMultVecSR
...
/* 804C8BE4  4B B4 43 60 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 804C8BE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804C8BEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804C8BF0  38 9E 04 DC */	addi r4, r30, 0x4dc
/* 804C8BF4  4B B4 40 0C */	b mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 804C8C64  4B DA 78 DC */	b cLib_addCalcAngleS__FPsssss
...
/* 804C8C7C  4B DA 78 C4 */	b cLib_addCalcAngleS__FPsssss
...
/* 804C8C94  4B DA 78 AC */	b cLib_addCalcAngleS__FPsssss
lbl_804C8C98:
/* 804C8C98  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 804C8C9C  4B B4 40 C8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 804C8CA0  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 804C8CA4  4B B4 42 A0 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 804C8CA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804C8CAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804C8CB0  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 804C8CB4  38 84 00 24 */	addi r4, r4, 0x24
/* 804C8CB8  4B E7 D7 F8 */	b PSMTXCopy
/* 804C8CBC  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 804C8CC0  38 63 00 24 */	addi r3, r3, 0x24
/* 804C8CC4  38 9E 0A 70 */	addi r4, r30, 0xa70
/* 804C8CC8  4B E7 D8 E8 */	b PSMTXInverse
/* 804C8CCC  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C8CD0  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804C8CE4  4B E9 95 44 */	b _restgpr_29

...
/* 804C733C 00000018  3C 80 00 00 */	lis r4, lit_3767@ha /* 804CC340 */
/* 804C7340 0000001C  3B E4 00 00 */	addi r31, r4, lit_3767@l /* 804CC340 */
...
/* 804C73E4 00000010  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C73E8 00000014  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 804C73EC 00000018  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 804C73F0 0000001C  3C 80 00 00 */	lis r4, stringBase0@ha /* 804CC4D0 */
/* 804C73F4 00000020  38 84 00 00 */	addi r4, r4, stringBase0@l /* 804CC4D0 */
...
/* 804C7470 00000014  3C 80 00 00 */	lis r4, m_arcNameList__9daNbomb_c@ha /* 804CC518 */
/* 804C7474 00000018  38 84 00 00 */	addi r4, r4, m_arcNameList__9daNbomb_c@l /* 804CC518 */
...
/* 804C7494 00000004  3C 80 00 00 */	lis r4, daNbomb_createHeap__FP10fopAc_ac_c@ha /* 804C7304 */
/* 804C7498 00000008  38 84 00 00 */	addi r4, r4, daNbomb_createHeap__FP10fopAc_ac_c@l /* 804C7304 */
...
/* 804C752C 0000001C  3C 60 00 00 */	lis r3, g_mDoMtx_identity@ha /* 803A2FD8 */
/* 804C7530 00000020  38 63 00 00 */	addi r3, r3, g_mDoMtx_identity@l /* 803A2FD8 */
...
/* 804C7560 00000050  3C 80 00 00 */	lis r4, l_sphSrc@ha /* 804CC4D8 */
/* 804C7564 00000054  38 84 00 00 */	addi r4, r4, l_sphSrc@l /* 804CC4D8 */
...
/* 804C7574 00000064  3C 60 00 00 */	lis r3, daNbomb_tgHitCallback__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 804C6FB4 */
/* 804C7578 00000068  38 03 00 00 */	addi r0, r3, daNbomb_tgHitCallback__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 804C6FB4 */
/* 804C757C 0000006C  90 1C 08 70 */	stw r0, 0x870(r28)
/* 804C7580 00000070  38 7C 09 04 */	addi r3, r28, 0x904
/* 804C7584 00000074  3C 80 00 00 */	lis r4, l_sphSrc@ha /* 804CC4D8 */
/* 804C7588 00000078  38 84 00 00 */	addi r4, r4, l_sphSrc@l /* 804CC4D8 */
...
/* 804C75B8 000000A8  3C 60 00 00 */	lis r3, daNbomb_tgHitCallback__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@ha /* 804C6FB4 */
/* 804C75BC 000000AC  38 03 00 00 */	addi r0, r3, daNbomb_tgHitCallback__FP10fopAc_ac_cP12dCcD_GObjInfP10fopAc_ac_cP12dCcD_GObjInf@l /* 804C6FB4 */
/* 804C75C0 000000B0  90 1C 09 A8 */	stw r0, 0x9a8(r28)
/* 804C75C4 000000B4  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C75C8 000000B8  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C766C 00000004  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C7670 00000008  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C7698 00000004  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C769C 00000008  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C7830 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 804C7834 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 804C7838 00000048  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 804C783C 0000004C  4B FF F4 FD */	bl mDoMtx_YrotM__FPA4_fs
/* 804C7840 00000050  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 804C7844 00000054  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 804C7890 000000A0  3C 60 00 00 */	lis r3, BaseY__4cXyz@ha /* 80430D24 */
/* 804C7894 000000A4  C4 03 00 00 */	lfsu f0, BaseY__4cXyz@l(r3) /* 80430D24 */
...
/* 804C78AC 000000BC  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 804C78B0 000000C0  38 83 00 00 */	addi r4, r3, sincosTable___5JMath@l /* 80439A20 */
...
lbl_804C7AAC:
/* 804C7AAC 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 804C7AB0 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 804C7AC4 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 804C7AC8 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */

...
/* 804C93F8 00000018  3C 60 00 00 */	lis r3, lit_5462@ha /* 804CC548 */
/* 804C93FC 0000001C  38 83 00 00 */	addi r4, r3, lit_5462@l /* 804CC548 */
...
/* 804C9424 00000044  3C 60 00 00 */	lis r3, Zero__4cXyz@ha /* 80430CF4 */
/* 804C9428 00000048  3B E3 00 00 */	addi r31, r3, Zero__4cXyz@l /* 80430CF4 */
...
/* 804C9490 00000014  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C9494 00000018  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C94B8 0000003C  3C E0 00 00 */	lis r7, lit_4216@ha /* 804CC37C */
/* 804C94BC 00000040  C0 27 00 00 */	lfs f1, lit_4216@l(r7) /* 804CC37C */
...
/* 804C94D0 00000054  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C94D4 00000058  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C94F0 00000074  3C 60 00 00 */	lis r3, g_mDoMtx_identity@ha /* 803A2FD8 */
/* 804C94F4 00000078  38 63 00 00 */	addi r3, r3, g_mDoMtx_identity@l /* 803A2FD8 */
/* 804C94F8 0000007C  38 9E 0A 40 */	addi r4, r30, 0xa40
/* 804C94FC 00000080  4B FF D8 3D */	bl PSMTXCopy
lbl_804C9500:
/* 804C9500 00000000  3C 60 00 00 */	lis r3, lit_4255@ha /* 804CC380 */
/* 804C9504 00000004  C0 03 00 00 */	lfs f0, lit_4255@l(r3) /* 804CC380 */
/* 804C9508 00000008  D0 1E 05 2C */	stfs f0, 0x52c(r30)
/* 804C950C 0000000C  3C 60 00 00 */	lis r3, Zero__4cXyz@ha /* 80430CF4 */
/* 804C9510 00000010  C0 03 00 00 */	lfs f0, Zero__4cXyz@l(r3) /* 80430CF4 */

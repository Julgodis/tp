...
lbl_804CA50C:
/* 804CA50C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CA510  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804CA514  83 C3 5D B4 */	lwz r30, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804CA544  3C 60 80 4D */	lis r3, lit_4255@ha
/* 804CA548  C0 03 C3 80 */	lfs f0, lit_4255@l(r3)
...
/* 804CA574  4B C9 40 E0 */	b posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
/* 804CA578  2C 03 00 00 */	cmpwi r3, 0
/* 804CA57C  40 82 00 48 */	bne lbl_804CA5C4
/* 804CA580  7F C3 F3 78 */	mr r3, r30
/* 804CA584  4B C1 91 DC */	b getBombExplodeTime__9daAlink_cCFv
...
lbl_804CA5AC:
/* 804CA5AC  3C 60 80 4D */	lis r3, lit_4255@ha
/* 804CA5B0  C0 03 C3 80 */	lfs f0, lit_4255@l(r3)
...
/* 804CA5C8  4B C1 91 98 */	b getBombExplodeTime__9daAlink_cCFv
...
/* 804CA5E0  4B C1 91 80 */	b getBombExplodeTime__9daAlink_cCFv
/* 804CA5E4  7C 60 07 34 */	extsh r0, r3
/* 804CA5E8  3C 60 80 4D */	lis r3, lit_4689@ha
/* 804CA5EC  C8 23 C3 D8 */	lfd f1, lit_4689@l(r3)
...
/* 804CA608  3C 60 80 4D */	lis r3, lit_5021@ha
/* 804CA60C  C0 03 C3 E0 */	lfs f0, lit_5021@l(r3)
...
/* 804CA640  4B E7 CA 50 */	b PSVECAdd
lbl_804CA644:
/* 804CA644  38 7F 05 78 */	addi r3, r31, 0x578
/* 804CA648  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 804CA64C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 804CA650  38 84 0F 38 */	addi r4, r4, 0xf38
/* 804CA654  4B BA C4 58 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 804CA668  4B C9 42 14 */	b bgCheckAfterOffset__20daPy_boomerangMove_cFPC4cXyz

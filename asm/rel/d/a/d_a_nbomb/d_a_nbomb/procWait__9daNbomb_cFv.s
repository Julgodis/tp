...
/* 804C99AC 0000000C  3C 80 00 00 */	lis r4, lit_3767@ha /* 804CC340 */
/* 804C99B0 00000010  3B E4 00 00 */	addi r31, r4, lit_3767@l /* 804CC340 */
...
/* 804C9A08 00000028  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 804C9A0C 0000002C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 804C9C14 00000038  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C9C18 0000003C  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C9C70 0000000C  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 804CC5E0 */
/* 804C9C74 00000010  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 804CC5E0 */
...
/* 804C9D18 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 804C9D1C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 804C9D88 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 804C9D8C 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_804C9D90:
...
/* 804C9DF0 0000000C  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 804CC5E0 */
/* 804C9DF4 00000010  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 804CC5E0 */
...
lbl_804C9E38:
/* 804C9E38 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 804CC5E0 */
/* 804C9E3C 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 804CC5E0 */
/* 804C9E40 00000008  90 01 00 68 */	stw r0, 0x68(r1)
lbl_804C9E44:
/* 804C9E44 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 804C9E48 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 804C9F98 0000000C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 804C9F9C 00000010  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
...
/* 804CA03C 00000028  3C 80 00 00 */	lis r4, sincosTable___5JMath@ha /* 80439A20 */
/* 804CA040 0000002C  38 84 00 00 */	addi r4, r4, sincosTable___5JMath@l /* 80439A20 */
...
/* 804CA098 0000001C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 804CA09C 00000020  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
...
/* 804CA0D4 00000008  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 804CC5E0 */
/* 804CA0D8 0000000C  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 804CC5E0 */
...
/* 804CA114 00000048  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 804CA118 0000004C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
lbl_804CA214:
/* 804CA214 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 804CC5E0 */
/* 804CA218 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 804CC5E0 */

...
/* 804C99A4 00000004  4B E9 88 2C */	b _savegpr_26
/* 804C99A8 00000008  7C 7A 1B 78 */	mr r26, r3
/* 804C99AC 0000000C  3C 80 80 4D */	lis r4, lit_3767@ha
/* 804C99B0 00000010  3B E4 C3 40 */	addi r31, r4, lit_3767@l
...
/* 804C9A00 00000020  4B B5 40 E4 */	b fopAcM_getPolygonAngle__FRC13cBgS_PolyInfos
/* 804C9A04 00000024  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 804C9A08 00000028  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804C9A0C 0000002C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804C9A4C 00000004  C0 3F 00 40 */	lfs f1, 0x40(r31)	/* effective address: 804CC380 */
/* 804C9A50 00000008  C0 5F 00 3C */	lfs f2, 0x3c(r31)	/* effective address: 804CC37C */
/* 804C9A54 0000000C  4B DA 6C EC */	b cLib_chaseF__FPfff
lbl_804C9A58:
/* 804C9A58 00000000  C3 DA 05 30 */	lfs f30, 0x530(r26)
/* 804C9A5C 00000004  C0 3A 0C 24 */	lfs f1, 0xc24(r26)
/* 804C9A60 00000008  C0 1F 00 88 */	lfs f0, 0x88(r31)	/* effective address: 804CC3C8 */
/* 804C9A64 0000000C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804C9A68 00000000  40 81 00 7C */	ble lbl_804C9AE4
/* 804C9A6C 00000004  C0 5F 00 40 */	lfs f2, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9AB4 0000000C  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9AC4 0000001C  4B E7 D6 74 */	b PSVECSquareMag
/* 804C9AC8 00000020  C0 1F 01 34 */	lfs f0, 0x134(r31)	/* effective address: 804CC474 */
...
/* 804C9AD8 00000008  C0 1F 00 34 */	lfs f0, 0x34(r31)	/* effective address: 804CC374 */
...
/* 804C9AE8 00000004  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 804CC370 */
/* 804C9AEC 00000008  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804C9AF0 00000000  40 81 00 88 */	ble lbl_804C9B78
/* 804C9AF4 00000004  C0 5F 00 40 */	lfs f2, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9B48 0000000C  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9B58 0000001C  4B E7 D5 E0 */	b PSVECSquareMag
/* 804C9B5C 00000020  C0 1F 01 34 */	lfs f0, 0x134(r31)	/* effective address: 804CC474 */
...
/* 804C9B6C 00000008  C0 1F 00 34 */	lfs f0, 0x34(r31)	/* effective address: 804CC374 */
...
/* 804C9B80 00000008  4B B5 0B 4C */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 804C9BA4 0000002C  C0 5F 00 3C */	lfs f2, 0x3c(r31)	/* effective address: 804CC37C */
/* 804C9BA8 00000030  C0 3F 00 70 */	lfs f1, 0x70(r31)	/* effective address: 804CC3B0 */
...
/* 804C9BD4 00000014  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9BFC 00000020  4B D9 CE E8 */	b __pl__4cXyzCFRC3Vec
...
/* 804C9C0C 00000030  4B E7 D4 84 */	b PSVECAdd
/* 804C9C10 00000034  38 7A 05 78 */	addi r3, r26, 0x578
/* 804C9C14 00000038  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 804C9C18 0000003C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 804C9C1C 00000040  3B A4 0F 38 */	addi r29, r4, 0xf38
/* 804C9C20 00000044  7F A4 EB 78 */	mr r4, r29
/* 804C9C24 00000048  4B BA CE 88 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 804C9C70 0000000C  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C9C74 00000010  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804C9C88 00000024  4B BA AA BC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 804C9C8C 00000028  C0 01 00 58 */	lfs f0, 0x58(r1)
/* 804C9C90 0000002C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 804C9C94 00000030  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9CA8 00000044  4B E7 D4 90 */	b PSVECSquareMag
/* 804C9CAC 00000048  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804C9CBC 00000008  C8 9F 01 10 */	lfd f4, 0x110(r31)	/* effective address: 804CC450 */
/* 804C9CC0 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 804C9CC4 00000010  C8 7F 01 18 */	lfd f3, 0x118(r31)	/* effective address: 804CC458 */
...
lbl_804C9D0C:
/* 804C9D0C 00000000  C8 1F 01 20 */	lfd f0, 0x120(r31)	/* effective address: 804CC460 */
/* 804C9D10 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804C9D14 00000000  40 80 00 10 */	bge lbl_804C9D24
/* 804C9D18 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804C9D1C 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 804C9D88 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804C9D8C 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_804C9D90:
/* 804C9D90 00000000  C0 41 00 5C */	lfs f2, 0x5c(r1)
/* 804C9D94 00000004  4B D9 D8 E0 */	b cM_atan2s__Fff
/* 804C9D98 00000008  B0 7A 0B 5A */	sth r3, 0xb5a(r26)
/* 804C9D9C 0000000C  38 61 00 58 */	addi r3, r1, 0x58
/* 804C9DA0 00000010  4B D9 D3 88 */	b atan2sX_Z__4cXyzCFv
...
/* 804C9DCC 0000003C  C0 3F 01 38 */	lfs f1, 0x138(r31)	/* effective address: 804CC478 */
...
/* 804C9DF0 0000000C  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C9DF4 00000010  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804C9E08 00000004  4B C3 BC B4 */	b checkSnowCodePolygon__9daAlink_cFR13cBgS_PolyInfo
/* 804C9E0C 00000008  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804C9E10 0000000C  41 82 00 28 */	beq lbl_804C9E38
/* 804C9E14 00000010  C0 1F 01 3C */	lfs f0, 0x13c(r31)	/* effective address: 804CC47C */
/* 804C9E18 00000014  D0 1A 0B B0 */	stfs f0, 0xbb0(r26)
/* 804C9E1C 00000018  C0 3A 05 2C */	lfs f1, 0x52c(r26)
/* 804C9E20 0000001C  C0 1F 01 40 */	lfs f0, 0x140(r31)	/* effective address: 804CC480 */
/* 804C9E24 00000020  EC 01 00 32 */	fmuls f0, f1, f0
/* 804C9E28 00000024  D0 1A 05 2C */	stfs f0, 0x52c(r26)
/* 804C9E2C 00000028  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
/* 804C9E30 0000002C  D0 1A 04 FC */	stfs f0, 0x4fc(r26)
/* 804C9E34 00000030  FF C0 00 90 */	fmr f30, f0
lbl_804C9E38:
/* 804C9E38 00000000  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804C9E3C 00000004  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 804C9E40 00000008  90 01 00 68 */	stw r0, 0x68(r1)
lbl_804C9E44:
/* 804C9E44 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804C9E48 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 804C9E4C 00000008  83 C3 5D B4 */	lwz r30, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804C9E60 0000001C  4B C1 99 30 */	b getBombBoundRate__9daAlink_cCFv
...
/* 804C9E9C 0000000C  C0 1F 00 88 */	lfs f0, 0x88(r31)	/* effective address: 804CC3C8 */
...
/* 804C9EB8 00000014  C8 3F 00 98 */	lfd f1, 0x98(r31)	/* effective address: 804CC3D8 */
...
/* 804C9EDC 00000038  C0 1F 01 44 */	lfs f0, 0x144(r31)	/* effective address: 804CC484 */
...
/* 804C9EF0 0000000C  4B C1 98 A0 */	b getBombBoundRate__9daAlink_cCFv
...
/* 804C9F48 00000010  C0 3F 00 30 */	lfs f1, 0x30(r31)	/* effective address: 804CC370 */
/* 804C9F4C 00000014  FC 00 00 18 */	frsp f0, f0
/* 804C9F50 00000018  EC 21 00 32 */	fmuls f1, f1, f0
/* 804C9F54 0000001C  4B E9 81 58 */	b __cvt_fp2unsigned
...
/* 804C9F6C 00000034  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 804CC37C */
...
/* 804C9F98 0000000C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804C9F9C 00000010  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 804C9FA0 00000014  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 804C9FB4 00000028  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 804CC37C */
/* 804C9FB8 0000002C  C8 5F 01 58 */	lfd f2, 0x158(r31)	/* effective address: 804CC498 */
...
/* 804C9FD0 00000044  C0 7F 01 48 */	lfs f3, 0x148(r31)	/* effective address: 804CC488 */
/* 804C9FD4 00000048  FC 80 18 90 */	fmr f4, f3
/* 804C9FD8 0000004C  39 00 00 00 */	li r8, 0
/* 804C9FDC 00000050  4B DE 19 A8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 804C9FE0 00000054  7F C3 F3 78 */	mr r3, r30
/* 804C9FE4 00000058  4B C1 97 AC */	b getBombBoundRate__9daAlink_cCFv
...
/* 804C9FF4 00000068  4B C1 97 AC */	b getBombStopSpeedY__9daAlink_cCFv
...
/* 804CA004 00000008  C0 3F 00 40 */	lfs f1, 0x40(r31)	/* effective address: 804CC380 */
/* 804CA008 0000000C  C0 5F 01 4C */	lfs f2, 0x14c(r31)	/* effective address: 804CC48C */
/* 804CA00C 00000010  4B DA 67 34 */	b cLib_chaseF__FPfff
/* 804CA010 00000014  48 00 00 6C */	b lbl_804CA07C
lbl_804CA014:
/* 804CA014 00000000  C0 3A 05 2C */	lfs f1, 0x52c(r26)
/* 804CA018 00000004  C0 1F 01 50 */	lfs f0, 0x150(r31)	/* effective address: 804CC490 */
...
/* 804CA02C 00000018  4B B5 3A B8 */	b fopAcM_getPolygonAngle__FRC13cBgS_PolyInfos
...
/* 804CA03C 00000028  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha
/* 804CA040 0000002C  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l
...
/* 804CA05C 00000004  4B C1 97 54 */	b getBombMaxSpeedY__9daAlink_cCFv
...
/* 804CA06C 00000008  4B C1 97 44 */	b getBombMaxSpeedY__9daAlink_cCFv
...
/* 804CA084 00000008  4B B6 2F E8 */	b dComIfGp_getReverb__Fi
...
/* 804CA098 0000001C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804CA09C 00000020  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 804CA0A0 00000024  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 804CA0B0 00000034  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 804CC37C */
/* 804CA0B4 00000038  FC 40 08 90 */	fmr f2, f1
/* 804CA0B8 0000003C  C0 7F 01 48 */	lfs f3, 0x148(r31)	/* effective address: 804CC488 */
/* 804CA0BC 00000040  FC 80 18 90 */	fmr f4, f3
/* 804CA0C0 00000044  39 00 00 00 */	li r8, 0
/* 804CA0C4 00000048  4B DE 18 C0 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 804CA0D4 00000008  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804CA0D8 0000000C  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804CA0EC 00000020  4B BA A6 58 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 804CA100 00000034  4B C3 B9 BC */	b checkSnowCodePolygon__9daAlink_cFR13cBgS_PolyInfo
...
/* 804CA114 00000048  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804CA118 0000004C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 804CA11C 00000050  7C 23 04 2E */	lfsx f1, r3, r0
/* 804CA120 00000054  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 804CC370 */
...
/* 804CA168 0000009C  4B D9 D5 0C */	b cM_atan2s__Fff
...
/* 804CA17C 000000B0  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 804CC380 */
...
/* 804CA198 00000008  C0 1F 01 54 */	lfs f0, 0x154(r31)	/* effective address: 804CC494 */
...
/* 804CA1B0 00000004  C0 3F 00 40 */	lfs f1, 0x40(r31)	/* effective address: 804CC380 */
/* 804CA1B4 00000008  C0 5F 00 30 */	lfs f2, 0x30(r31)	/* effective address: 804CC370 */
/* 804CA1B8 0000000C  4B DA 65 88 */	b cLib_chaseF__FPfff
...
/* 804CA1C8 0000001C  4B E7 CF 70 */	b PSVECSquareMag
/* 804CA1CC 00000020  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 804CC37C */
...
/* 804CA1DC 00000008  4B E7 CF 5C */	b PSVECSquareMag
/* 804CA1E0 0000000C  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 804CC37C */
...
lbl_804CA214:
/* 804CA214 00000000  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804CA218 00000004  38 03 C5 E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804CA254 00000008  4B E9 7F C8 */	b _restgpr_26

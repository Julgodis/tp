...
/* 804C7124  4B E9 B0 B4 */	b _savegpr_28
/* 804C7128  7C 7E 1B 78 */	mr r30, r3
/* 804C712C  3C 60 80 4D */	lis r3, lit_3767@ha
/* 804C7130  3B E3 C3 40 */	addi r31, r3, lit_3767@l
/* 804C7134  88 9E 0B 54 */	lbz r4, 0xb54(r30)
/* 804C7138  54 80 10 3A */	slwi r0, r4, 2
/* 804C713C  3C 60 80 4D */	lis r3, m_arcNameList__9daNbomb_c@ha
/* 804C7140  38 63 C5 18 */	addi r3, r3, m_arcNameList__9daNbomb_c@l
...
/* 804C716C  4B B7 51 80 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804C717C  4B B4 DA D8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 804C71B8  4B B7 51 34 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804C71DC  4B B7 51 10 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804C71F0  4B BD 66 94 */	b getAlinkArcName__9daAlink_cFv
/* 804C71F4  38 80 00 15 */	li r4, 0x15
/* 804C71F8  7F A5 EB 78 */	mr r5, r29
/* 804C71FC  38 C0 00 80 */	li r6, 0x80
/* 804C7200  4B B7 50 EC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 804C7214  4B E0 7A 38 */	b __nw__FUl
/* 804C7218  7C 7D 1B 79 */	or. r29, r3, r3
/* 804C721C  41 82 00 20 */	beq lbl_804C723C
/* 804C7220  3C 80 80 4D */	lis r4, __vt__12J3DFrameCtrl@ha
/* 804C7224  38 04 C6 74 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 804C7228  90 1D 00 00 */	stw r0, 0(r29)
/* 804C722C  38 80 00 00 */	li r4, 0
/* 804C7230  4B E6 11 CC */	b init__12J3DFrameCtrlFs
...
/* 804C7270  4B B4 65 6C */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 804C72A8  4B E9 AF 7C */	b _restgpr_28

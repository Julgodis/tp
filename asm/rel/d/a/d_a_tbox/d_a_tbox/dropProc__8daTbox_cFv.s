...
/* 80492F60  4B EC F2 68 */	b _savegpr_24
/* 80492F64  7C 7E 1B 78 */	mr r30, r3
/* 80492F68  3C 60 80 49 */	lis r3, l_cull_size_box@ha
/* 80492F6C  3B E3 61 D4 */	addi r31, r3, l_cull_size_box@l
...
/* 80492FCC  4B EB 34 B8 */	b PSMTXIdentity
lbl_80492FD0:
...
/* 80492FF8  4B EB 34 8C */	b PSMTXIdentity
...
/* 8049302C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80493030  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80493034  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80493054  4B BB A0 14 */	b setPoly__13dPa_control_cFUsR13cBgS_PolyInfoPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyziP18dPa_levelEcallBackScPC4cXyz
...
/* 8049306C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80493070  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80493088  4B BD C9 9C */	b StartShock__12dVibration_cFii4cXyz
...
/* 804930BC  4B BE 44 C0 */	b __ct__11dBgS_GndChkFv
/* 804930C0  3C 60 80 49 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 804930C4  38 63 68 0C */	addi r3, r3, __vt__14dBgS_ObjGndChk@l
...
/* 804930E8  4B BE 5D 80 */	b SetObj__16dBgS_PolyPassChkFv
/* 804930EC  7F 03 C3 78 */	mr r3, r24
/* 804930F0  38 81 00 2C */	addi r4, r1, 0x2c
/* 804930F4  4B DD 4C 34 */	b SetPos__11cBgS_GndChkFPC4cXyz
...
/* 80493108  4B BE 13 98 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80493124  4B D1 83 9C */	b dKy_pol_sound_get__FPC13cBgS_PolyInfo
...
/* 80493138  4B B9 9F 34 */	b dComIfGp_getReverb__Fi
...
/* 8049314C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80493150  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80493154  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80493178  4B E1 88 0C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8049317C  3C 60 80 49 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 80493180  38 03 68 0C */	addi r0, r3, __vt__14dBgS_ObjGndChk@l
...
/* 8049319C  4B BE 44 54 */	b __dt__11dBgS_GndChkFv
lbl_804931A0:
/* 804931A0  38 7E 04 A8 */	addi r3, r30, 0x4a8
/* 804931A4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 804931A8  4B EB 41 F4 */	b PSVECSquareDistance
...
/* 80493218  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049321C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80493288  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8049328C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80493290:
...
/* 804932AC  4B EC EF 68 */	b _restgpr_24

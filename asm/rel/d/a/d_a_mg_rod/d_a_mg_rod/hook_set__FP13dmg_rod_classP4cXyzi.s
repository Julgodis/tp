...
/* 804B1204 00000014  3C 60 00 00 */	lis r3, lit_3879@ha
/* 804B1208 00000018  3B E3 00 00 */	addi r31, r3, lit_3879@l
...
lbl_804B123C:
/* 804B123C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1240 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B1244 00000008  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804B1248 0000000C  4B FF 83 11 */	bl mDoMtx_YrotS__FPA4_fs
/* 804B124C 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1250 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B1270 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1274 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B1294 0000000C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1298 00000010  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B129C 00000014  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804B12A0 00000018  4B FF 82 B9 */	bl mDoMtx_YrotS__FPA4_fs
/* 804B12A4 0000001C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B12A8 00000020  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B12BC 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B12C0 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_804B1310:
/* 804B1310 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1314 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B1408 0000000C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804B140C 00000010  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 804B141C 00000020  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804B1420 00000024  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 804B1478 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B147C 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_804B14AC:
/* 804B14AC 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B14B0 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B14B4 00000008  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804B14B8 0000000C  4B FF 80 A1 */	bl mDoMtx_YrotM__FPA4_fs
/* 804B14BC 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B14C0 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B14C4 00000018  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 804B14C8 0000001C  4B FF 80 91 */	bl mDoMtx_XrotM__FPA4_fs
/* 804B14CC 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B14D0 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_804B14E0:
/* 804B14E0 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B14E4 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B14E8 00000008  A8 9C 00 18 */	lha r4, 0x18(r28)
/* 804B14EC 0000000C  4B FF 80 6D */	bl mDoMtx_XrotM__FPA4_fs
/* 804B14F0 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B14F4 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B14F8 00000018  A8 9C 00 1A */	lha r4, 0x1a(r28)
/* 804B14FC 0000001C  4B FF 80 5D */	bl mDoMtx_YrotM__FPA4_fs
/* 804B1500 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1504 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B15E4 0000000C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 804B15E8 00000010  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804B1610 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1614 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B162C 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1630 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B165C 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1660 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B1664 00000018  A8 9E 04 E0 */	lha r4, 0x4e0(r30)
/* 804B1668 0000001C  4B FF 7E F1 */	bl mDoMtx_YrotM__FPA4_fs
/* 804B166C 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1670 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

...
/* 804BA84C  4B EA 79 84 */	b _savegpr_26
/* 804BA850  7C 7C 1B 78 */	mr r28, r3
/* 804BA854  3C 80 80 4C */	lis r4, lit_1109@ha
/* 804BA858  3B A4 BB 90 */	addi r29, r4, lit_1109@l
/* 804BA85C  3C 80 80 4C */	lis r4, lit_3879@ha
/* 804BA860  3B C4 B5 34 */	addi r30, r4, lit_3879@l
...
/* 804BA8A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804BA8AC  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 804BA8B0  83 7F 5D AC */	lwz r27, 0x5dac(r31)	/* effective address: 8040BF6C */
...
lbl_804BA8C8:
/* 804BA8C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804BA8CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804BA8D0  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 804BA8D4  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 804BA908  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804BA90C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804BA910  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 804BA914  3C 80 80 4C */	lis r4, stringBase0@ha
/* 804BA918  38 84 B8 30 */	addi r4, r4, stringBase0@l
/* 804BA91C  38 84 00 0E */	addi r4, r4, 0xe
/* 804BA920  4B EA E0 74 */	b strcmp
...
/* 804BA97C  3C 60 80 4C */	lis r3, stringBase0@ha
/* 804BA980  38 63 B8 30 */	addi r3, r3, stringBase0@l
...
/* 804BA9A0  3C 60 80 4C */	lis r3, stringBase0@ha
/* 804BA9A4  38 63 B8 30 */	addi r3, r3, stringBase0@l
...
/* 804BA9C8  4B B7 24 F4 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804BA9DC  3C 80 80 4C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 804BA9E0  38 84 A1 F4 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 804BA9E4  7F 45 D3 78 */	mr r5, r26
/* 804BA9E8  4B B5 FA C8 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 804BAA48  4B BB B8 00 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 804BAA4C  38 7C 11 90 */	addi r3, r28, 0x1190
/* 804BAA50  C0 3E 01 5C */	lfs f1, 0x15c(r30)
/* 804BAA54  FC 40 08 90 */	fmr f2, f1
/* 804BAA58  4B BB B5 00 */	b SetWall__12dBgS_AcchCirFff
/* 804BAA5C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804BAA60  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804BAA64  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 804BAA68  3C 80 80 4C */	lis r4, stringBase0@ha
/* 804BAA6C  38 84 B8 30 */	addi r4, r4, stringBase0@l
/* 804BAA70  4B EA DF 24 */	b strcmp
...
/* 804BAA98  4B E0 5A 98 */	b init__10Z2CreatureFP3VecP3VecUcUc
/* 804BAA9C  38 00 00 14 */	li r0, 0x14
/* 804BAAA0  98 1C 11 65 */	stb r0, 0x1165(r28)
/* 804BAAA4  3C 60 80 4B */	lis r3, s_boat_sub__FPvPv@ha
/* 804BAAA8  38 63 C1 C0 */	addi r3, r3, s_boat_sub__FPvPv@l
/* 804BAAAC  7F 84 E3 78 */	mr r4, r28
/* 804BAAB0  4B B6 68 88 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 804BAADC  4B B5 ED E8 */	b fopAcM_setStageLayer__FPv
...
/* 804BABA4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804BABA8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 804BABBC  4B B7 9E 48 */	b getEventReg__11dSv_event_cCFUs
...
/* 804BABDC  4B B7 9E 04 */	b setEventReg__11dSv_event_cFUsUc
lbl_804BABE0:
...
/* 804BABF8  4B EA 76 24 */	b _restgpr_26

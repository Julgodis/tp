...
/* 804ADDF8 00000024  3C 60 80 4C */	lis r3, lit_3879@ha
/* 804ADDFC 00000028  3B E3 B5 34 */	addi r31, r3, lit_3879@l
...
/* 804ADE28 00000054  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804ADE2C 00000058  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 804ADE30 0000005C  7C 23 04 2E */	lfsx f1, r3, r0
/* 804ADE34 00000060  C0 1F 00 4C */	lfs f0, 0x4c(r31)	/* effective address: 804BB580 */
...
/* 804ADE60 00000008  C0 3F 00 2C */	lfs f1, 0x2c(r31)	/* effective address: 804BB560 */
/* 804ADE64 0000000C  4B DB 9A F0 */	b cM_rndF__Ff
/* 804ADE68 00000010  C0 1F 01 64 */	lfs f0, 0x164(r31)	/* effective address: 804BB698 */
...
/* 804ADE80 00000028  C0 3F 01 30 */	lfs f1, 0x130(r31)	/* effective address: 804BB664 */
/* 804ADE84 0000002C  4B DB 9A D0 */	b cM_rndF__Ff
/* 804ADE88 00000030  C0 1F 01 68 */	lfs f0, 0x168(r31)	/* effective address: 804BB69C */
...
lbl_804ADEA4:
/* 804ADEA4 00000000  C0 1F 00 50 */	lfs f0, 0x50(r31)	/* effective address: 804BB584 */
...
/* 804ADEC0 00000014  C0 1F 01 00 */	lfs f0, 0x100(r31)	/* effective address: 804BB634 */
/* 804ADEC4 00000018  EC 00 07 F2 */	fmuls f0, f0, f31
/* 804ADEC8 0000001C  D0 1E 05 2C */	stfs f0, 0x52c(r30)
/* 804ADECC 00000020  C0 3F 00 2C */	lfs f1, 0x2c(r31)	/* effective address: 804BB560 */
/* 804ADED0 00000024  4B DB 9A 84 */	b cM_rndF__Ff
/* 804ADED4 00000028  C0 5F 01 6C */	lfs f2, 0x16c(r31)	/* effective address: 804BB6A0 */
...
/* 804ADEF4 00000048  C0 3F 01 30 */	lfs f1, 0x130(r31)	/* effective address: 804BB664 */
/* 804ADEF8 0000004C  4B DB 9A 5C */	b cM_rndF__Ff
/* 804ADEFC 00000050  C0 5F 00 4C */	lfs f2, 0x4c(r31)	/* effective address: 804BB580 */
...
/* 804ADF2C 00000080  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 804BB5EC */
...
/* 804ADF4C 0000000C  C0 1F 01 00 */	lfs f0, 0x100(r31)	/* effective address: 804BB634 */
...
/* 804ADF60 0000000C  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 804BB5EC */
/* 804ADF64 00000024  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804ADF68 00000000  40 81 00 48 */	ble lbl_804ADFB0
/* 804ADF6C 00000004  C0 1F 01 70 */	lfs f0, 0x170(r31)	/* effective address: 804BB6A4 */
/* 804ADF70 00000008  EC 20 00 72 */	fmuls f1, f0, f1
/* 804ADF74 0000000C  4B EB 41 38 */	b __cvt_fp2unsigned
...
/* 804ADFB8 00000008  C0 3F 00 10 */	lfs f1, 0x10(r31)	/* effective address: 804BB544 */
/* 804ADFBC 0000000C  C0 5F 00 9C */	lfs f2, 0x9c(r31)	/* effective address: 804BB5D0 */
/* 804ADFC0 00000010  4B DC 1A C0 */	b cLib_addCalc0__FPfff
/* 804ADFC4 00000014  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 804ADFC8 00000018  C0 1F 01 54 */	lfs f0, 0x154(r31)	/* effective address: 804BB688 */
...
/* 804ADFE0 00000008  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 804BB540 */
/* 804ADFE4 0000000C  4B DB 99 70 */	b cM_rndF__Ff
/* 804ADFE8 00000010  C0 1F 00 9C */	lfs f0, 0x9c(r31)	/* effective address: 804BB5D0 */
...
/* 804AE020 00000010  4B DC 25 E8 */	b cLib_addCalcAngleS2__FPssss
...
/* 804AE034 00000024  4B DC 25 D4 */	b cLib_addCalcAngleS2__FPssss
/* 804AE038 00000028  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 804AE03C 0000002C  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 804BB590 */

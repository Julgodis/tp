...
/* 804ADB70 00000018  4B EB 46 6C */	b _savegpr_29
/* 804ADB74 0000001C  7C 7D 1B 78 */	mr r29, r3
/* 804ADB78 00000020  3C 60 80 4C */	lis r3, lit_3879@ha
/* 804ADB7C 00000024  3B E3 B5 34 */	addi r31, r3, lit_3879@l
...
/* 804ADBAC 00000054  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804ADBB0 00000058  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 804ADBB4 0000005C  7C 43 04 2E */	lfsx f2, r3, r0
/* 804ADBB8 00000060  C0 1F 00 E4 */	lfs f0, 0xe4(r31)	/* effective address: 804BB618 */
...
/* 804ADBEC 00000010  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 804BB590 */
/* 804ADBF0 00000014  FC 02 00 40 */	fcmpo cr0, f2, f0
/* 804ADBF4 00000000  40 81 00 0C */	ble lbl_804ADC00
/* 804ADBF8 00000004  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 804BB5EC */
/* 804ADBFC 00000008  D0 1D 11 88 */	stfs f0, 0x1188(r29)
lbl_804ADC00:
/* 804ADC00 00000000  C0 1F 00 50 */	lfs f0, 0x50(r31)	/* effective address: 804BB584 */
...
/* 804ADC1C 00000014  C0 1F 01 5C */	lfs f0, 0x15c(r31)	/* effective address: 804BB690 */
...
/* 804ADC34 0000002C  C0 1F 01 00 */	lfs f0, 0x100(r31)	/* effective address: 804BB634 */
...
/* 804ADC44 00000008  C0 1F 01 60 */	lfs f0, 0x160(r31)	/* effective address: 804BB694 */
/* 804ADC48 0000000C  EC 20 00 72 */	fmuls f1, f0, f1
/* 804ADC4C 00000010  4B EB 44 60 */	b __cvt_fp2unsigned
...
/* 804ADCAC 00000018  C0 1F 01 34 */	lfs f0, 0x134(r31)	/* effective address: 804BB668 */
/* 804ADCB0 0000001C  D0 1D 04 FC */	stfs f0, 0x4fc(r29)
/* 804ADCB4 00000020  C0 3D 0F 5C */	lfs f1, 0xf5c(r29)
/* 804ADCB8 00000024  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 804BB5EC */
...
/* 804ADCE4 00000008  C0 3F 00 9C */	lfs f1, 0x9c(r31)	/* effective address: 804BB5D0 */
/* 804ADCE8 0000000C  C0 5F 00 24 */	lfs f2, 0x24(r31)	/* effective address: 804BB558 */
/* 804ADCEC 00000010  4B DC 1D 94 */	b cLib_addCalc0__FPfff
/* 804ADCF0 00000014  C0 3D 05 2C */	lfs f1, 0x52c(r29)
/* 804ADCF4 00000018  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 804BB5EC */
...
/* 804ADD0C 00000008  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 804BB540 */
/* 804ADD10 0000000C  4B DB 9C 44 */	b cM_rndF__Ff
/* 804ADD14 00000010  C0 1F 00 9C */	lfs f0, 0x9c(r31)	/* effective address: 804BB5D0 */
...
lbl_804ADD34:
/* 804ADD34 00000000  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 804BB540 */
...
/* 804ADD48 0000000C  C0 3F 00 2C */	lfs f1, 0x2c(r31)	/* effective address: 804BB560 */
/* 804ADD4C 00000010  4B DB 9C 40 */	b cM_rndFX__Ff
...
/* 804ADD78 00000010  4B DC 28 90 */	b cLib_addCalcAngleS2__FPssss
/* 804ADD7C 00000014  C0 3D 05 2C */	lfs f1, 0x52c(r29)
/* 804ADD80 00000018  C0 1F 01 54 */	lfs f0, 0x154(r31)	/* effective address: 804BB688 */
...
/* 804ADDB0 00000010  4B DC 28 58 */	b cLib_addCalcAngleS2__FPssss
...
/* 804ADDC0 00000008  4B EB 44 68 */	b _restgpr_29

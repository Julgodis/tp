...
/* 804A99F0  4B EB 87 E4 */	b _savegpr_27
/* 804A99F4  7C 7F 1B 78 */	mr r31, r3
/* 804A99F8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A99FC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804A9A00  38 80 00 00 */	li r4, 0
/* 804A9A04  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 804A9A08  38 DF 01 0C */	addi r6, r31, 0x10c
/* 804A9A0C  4B CF 9D B8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 804A9A30  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9A34  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804A9A38  80 9C 00 04 */	lwz r4, 4(r28)
/* 804A9A3C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804A9A40  4B CF B3 60 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9A44  7F 83 E3 78 */	mr r3, r28
/* 804A9A48  4B B6 42 7C */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 804A9A4C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9A50  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804A9A54  80 9F 0F A0 */	lwz r4, 0xfa0(r31)
/* 804A9A58  80 84 00 04 */	lwz r4, 4(r4)
/* 804A9A5C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804A9A60  4B CF B3 40 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9A64  80 7F 0F A0 */	lwz r3, 0xfa0(r31)
/* 804A9A68  4B B6 42 5C */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 804A9A80  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9A84  3B A3 CA 54 */	addi r29, r3, g_env_light@l
lbl_804A9A88:
...
/* 804A9AB0  4B CF B2 F0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9AB4  7C 7F E0 2E */	lwzx r3, r31, r28
/* 804A9AB8  4B B6 42 0C */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_804A9ABC:
...
/* 804A9AEC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9AF0  3B A3 CA 54 */	addi r29, r3, g_env_light@l
lbl_804A9AF4:
...
/* 804A9B08  4B CF B2 98 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9B0C  7C 7F E0 2E */	lwzx r3, r31, r28
/* 804A9B10  4B B6 41 B4 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 804A9B2C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9B30  3B A3 CA 54 */	addi r29, r3, g_env_light@l
lbl_804A9B34:
...
/* 804A9B48  4B CF B2 58 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9B4C  7C 7F E0 2E */	lwzx r3, r31, r28
/* 804A9B50  4B B6 41 74 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 804A9B94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A9B98  38 03 61 C0 */	addi r0, r3, struct_804061C0+0x0@l
...
/* 804A9BB0  4B B6 AB 88 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 804A9BB4  80 7F 07 00 */	lwz r3, 0x700(r31)
/* 804A9BB8  80 83 00 04 */	lwz r4, 4(r3)
/* 804A9BBC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9BC0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804A9BC4  80 84 00 04 */	lwz r4, 4(r4)
/* 804A9BC8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804A9BCC  4B CF B1 D4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9BD0  80 7F 07 00 */	lwz r3, 0x700(r31)
/* 804A9BD4  4B B6 6A AC */	b entryDL__14mDoExt_McaMorfFv
/* 804A9BD8  48 00 02 B8 */	b lbl_804A9E90
lbl_804A9BDC:
/* 804A9BDC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A9BE0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804A9BE4  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 804A9C1C  3C 60 80 4C */	lis r3, lit_4545@ha
/* 804A9C20  C0 03 B5 60 */	lfs f0, lit_4545@l(r3)
...
lbl_804A9C34:
/* 804A9C34  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9C38  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804A9C3C  80 9F 10 24 */	lwz r4, 0x1024(r31)
/* 804A9C40  80 84 00 04 */	lwz r4, 4(r4)
/* 804A9C44  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804A9C48  4B CF B1 58 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9C4C  80 7F 10 24 */	lwz r3, 0x1024(r31)
/* 804A9C50  4B B6 40 74 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 804A9C54  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9C58  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804A9C5C  80 9F 10 28 */	lwz r4, 0x1028(r31)
/* 804A9C60  80 84 00 04 */	lwz r4, 4(r4)
/* 804A9C64  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804A9C68  4B CF B1 38 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804A9CA4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A9CA8  38 03 61 C0 */	addi r0, r3, struct_804061C0+0x0@l
...
/* 804A9CC0  4B B6 AA 78 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 804A9CC4  3B 60 00 00 */	li r27, 0
/* 804A9CC8  3B C0 00 00 */	li r30, 0
/* 804A9CCC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9CD0  3B A3 CA 54 */	addi r29, r3, g_env_light@l
lbl_804A9CD4:
...
/* 804A9CE8  4B CF B0 B8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804A9CEC  7C 7F E0 2E */	lwzx r3, r31, r28
/* 804A9CF0  4B B6 3F D4 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 804A9D18  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9D1C  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 804A9D3C  4B CF B0 64 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804A9D54  4B B6 3F 70 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 804A9D58  88 9F 10 2C */	lbz r4, 0x102c(r31)
/* 804A9D5C  7C 80 07 75 */	extsb. r0, r4
/* 804A9D60  41 82 01 30 */	beq lbl_804A9E90
/* 804A9D64  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9D68  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 804A9D84  4B CF B0 1C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804A9DAC  3C 60 80 4B */	lis r3, Worm_nodeCallBack__FP8J3DJointi@ha
/* 804A9DB0  38 83 98 F4 */	addi r4, r3, Worm_nodeCallBack__FP8J3DJointi@l
...
/* 804A9E14  4B B6 3E B0 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 804A9E2C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 804A9E30  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 804A9E34  38 81 00 08 */	addi r4, r1, 8
/* 804A9E38  4B B6 F9 C0 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
lbl_804A9E50:
/* 804A9E50  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804A9E54  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 804A9E74  4B CF AF 2C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804A9E8C  4B B6 3E 38 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_804A9E90:
/* 804A9E90  38 60 00 01 */	li r3, 1
lbl_804A9E94:
/* 804A9E94  39 61 00 30 */	addi r11, r1, 0x30
/* 804A9E98  4B EB 83 88 */	b _restgpr_27

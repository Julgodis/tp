...
/* 804B16D0  4B EB 0B 0C */	b _savegpr_29
/* 804B16D4  7C 7F 1B 78 */	mr r31, r3
/* 804B16D8  3C 60 80 4C */	lis r3, cNullVec__6Z2Calc@ha
/* 804B16DC  3B A3 B8 50 */	addi r29, r3, cNullVec__6Z2Calc@l
/* 804B16E0  3C 60 80 4C */	lis r3, lit_3879@ha
/* 804B16E4  3B C3 B5 34 */	addi r30, r3, lit_3879@l
/* 804B16E8  A8 1F 0F 7E */	lha r0, 0xf7e(r31)
/* 804B16EC  2C 00 00 01 */	cmpwi r0, 1
/* 804B16F0  41 81 00 D4 */	bgt lbl_804B17C4
/* 804B16F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B16F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B16FC  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 804B1700  4B B5 AC 9C */	b mDoMtx_XrotM__FPA4_fs
/* 804B1704  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1708  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B170C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 804B1710  4B B5 AD 24 */	b mDoMtx_YrotM__FPA4_fs
/* 804B1714  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1718  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B171C  A8 9F 04 E0 */	lha r4, 0x4e0(r31)
/* 804B1720  4B B5 AD AC */	b mDoMtx_ZrotM__FPA4_fs
...
/* 804B1750  4B DB EE B8 */	b cLib_addCalcAngleS2__FPssss
...
/* 804B1768  4B DB EE A0 */	b cLib_addCalcAngleS2__FPssss
lbl_804B176C:
...
/* 804B17BC  4B DB E2 80 */	b cLib_addCalc2__FPffff
/* 804B17C0  48 00 00 98 */	b lbl_804B1858
lbl_804B17C4:
/* 804B17C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B17C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B17DC  4B B5 AC 58 */	b mDoMtx_YrotM__FPA4_fs
/* 804B17E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B17E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B17F8  4B B5 AB A4 */	b mDoMtx_XrotM__FPA4_fs
...
/* 804B1814  4B B5 B5 88 */	b transM__14mDoMtx_stack_cFfff
/* 804B1818  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B181C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B1820  A8 9F 10 04 */	lha r4, 0x1004(r31)
/* 804B1824  4B B5 AC 10 */	b mDoMtx_YrotM__FPA4_fs
/* 804B1828  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 804B182C  FC 40 08 90 */	fmr f2, f1
/* 804B1830  C0 7E 00 6C */	lfs f3, 0x6c(r30)
/* 804B1834  4B B5 B5 68 */	b transM__14mDoMtx_stack_cFfff
lbl_804B1838:
/* 804B1838  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B183C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B1840  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 804B1844  4B B5 AC 88 */	b mDoMtx_ZrotM__FPA4_fs
/* 804B1848  38 7F 11 54 */	addi r3, r31, 0x1154
/* 804B184C  C0 3E 00 0C */	lfs f1, 0xc(r30)
/* 804B1850  C0 5E 00 B8 */	lfs f2, 0xb8(r30)
/* 804B1854  4B DB E2 2C */	b cLib_addCalc0__FPfff
lbl_804B1858:
...
/* 804B1898  4B B5 B5 A0 */	b scaleM__14mDoMtx_stack_cFfff
/* 804B189C  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 804B18A0  FC 40 08 90 */	fmr f2, f1
/* 804B18A4  C0 7F 11 54 */	lfs f3, 0x1154(r31)
/* 804B18A8  4B B5 B4 F4 */	b transM__14mDoMtx_stack_cFfff
/* 804B18AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B18B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804B18CC  4B E9 4B E4 */	b PSMTXCopy
...
/* 804B18F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B18F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B18FC  38 81 00 24 */	addi r4, r1, 0x24
/* 804B1900  38 BF 10 10 */	addi r5, r31, 0x1010
/* 804B1904  4B E9 54 68 */	b PSMTXMultVec
...
lbl_804B1920:
/* 804B1920  4B B5 B3 A8 */	b push__14mDoMtx_stack_cFv
...
/* 804B1940  4B B5 B4 5C */	b transM__14mDoMtx_stack_cFfff
/* 804B1944  88 1F 0F 80 */	lbz r0, 0xf80(r31)
/* 804B1948  7C 00 07 75 */	extsb. r0, r0
/* 804B194C  41 82 00 14 */	beq lbl_804B1960
/* 804B1950  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1954  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B1958  38 80 40 00 */	li r4, 0x4000
/* 804B195C  4B B5 AB 70 */	b mDoMtx_ZrotM__FPA4_fs
lbl_804B1960:
/* 804B1960  FC 20 F8 90 */	fmr f1, f31
/* 804B1964  FC 40 F8 90 */	fmr f2, f31
/* 804B1968  FC 60 F8 90 */	fmr f3, f31
/* 804B196C  4B B5 B4 CC */	b scaleM__14mDoMtx_stack_cFfff
/* 804B1970  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804B1974  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804B1978  80 9F 0F A0 */	lwz r4, 0xfa0(r31)
/* 804B197C  38 84 00 24 */	addi r4, r4, 0x24
/* 804B1980  4B E9 4B 30 */	b PSMTXCopy
/* 804B1984  4B B5 B3 90 */	b pop__14mDoMtx_stack_cFv
...
/* 804B19A0  4B B5 B3 28 */	b push__14mDoMtx_stack_cFv
...
/* 804B19F4  4B B5 B3 20 */	b pop__14mDoMtx_stack_cFv
lbl_804B19F8:
...
/* 804B1A68  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804B1A6C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804B1AA0  4B DB 50 94 */	b __mi__4cXyzCFRC3Vec
/* 804B1AA4  38 61 00 0C */	addi r3, r1, 0xc
/* 804B1AA8  4B E9 56 90 */	b PSVECSquareMag
...
/* 804B1B18  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804B1B1C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 804B1B88  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804B1B8C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_804B1B90:
...
/* 804B1BC8  4B DB DE 74 */	b cLib_addCalc2__FPffff
...
/* 804B1BE4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804B1BE8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804B1CAC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804B1CB0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804B1CDC  4B DB E9 2C */	b cLib_addCalcAngleS2__FPssss

...
/* 804AFA9C 00000018  3C 60 00 00 */	lis r3, lit_3879@ha
/* 804AFAA0 0000001C  3B C3 00 00 */	addi r30, r3, lit_3879@l
/* 804AFAA4 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 804AFAA8 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 804AFAB8 00000034  3C 60 00 00 */	lis r3, henna@ha
/* 804AFABC 00000038  38 63 00 00 */	addi r3, r3, henna@l
...
/* 804AFAF0 00000018  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804AFAF4 0000001C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 804AFB24 0000004C  3C 60 00 00 */	lis r3, g_meter2_info@ha
/* 804AFB28 00000050  38 63 00 00 */	addi r3, r3, g_meter2_info@l
/* 804AFB2C 00000054  38 80 04 C7 */	li r4, 0x4c7
/* 804AFB30 00000058  4B FF 9A 29 */	bl setMeterString__13dMeter2Info_cFl
/* 804AFB34 0000005C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804AFB38 00000060  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 804AFB70 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 804AFB74 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_804AFB94:
/* 804AFB94 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 804AFB98 00000004  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l
...
/* 804AFC28 00000010  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 804AFC2C 00000014  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804AFCF8 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 804AFCFC 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 804AFD68 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 804AFD6C 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_804AFD70:
...
lbl_804AFE30:
/* 804AFE30 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804AFE34 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 804AFEA8 00000078  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804AFEAC 0000007C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 804AFFD8 00000008  3C 60 00 00 */	lis r3, g_meter2_info@ha
/* 804AFFDC 0000000C  38 63 00 00 */	addi r3, r3, g_meter2_info@l
...
/* 804AFFF0 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 804AFFF4 00000024  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
...
/* 804B0094 00000020  3C 60 00 00 */	lis r3, data_804BB90C@ha
/* 804B0098 00000024  38 63 00 00 */	addi r3, r3, data_804BB90C@l
...
/* 804B0260 00000018  3C 60 00 00 */	lis r3, g_meter2_info@ha
/* 804B0264 0000001C  38 63 00 00 */	addi r3, r3, g_meter2_info@l
...
/* 804B0278 00000030  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 804B027C 00000034  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l

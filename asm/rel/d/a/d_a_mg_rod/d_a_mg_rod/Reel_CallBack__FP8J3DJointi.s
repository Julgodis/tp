...
/* 804A9808 00000010  4B FF FD 51 */	bl _savegpr_28
...
/* 804A9818 00000020  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 804A981C 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l /* 80434AC8 */
/* 804A9820 00000028  83 E3 00 38 */	lwz r31, 0x38(r3)
...
/* 804A9850 00000010  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 804A9854 00000014  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
/* 804A9858 00000018  80 84 00 00 */	lwz r4, 0(r4)
/* 804A985C 0000001C  4B FF FC FD */	bl PSMTXCopy
/* 804A9860 00000020  2C 1D 00 01 */	cmpwi r29, 1
/* 804A9864 00000024  40 82 00 24 */	bne lbl_804A9888
/* 804A9868 00000028  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 804A986C 0000002C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 804A9870 00000030  80 63 00 00 */	lwz r3, 0(r3)
...
/* 804A9880 00000040  4B FF FC D9 */	bl mDoMtx_XrotM__FPA4_fs
/* 804A9884 00000044  48 00 00 20 */	b lbl_804A98A4
lbl_804A9888:
/* 804A9888 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 804A988C 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 804A9890 00000008  80 63 00 00 */	lwz r3, 0(r3)
...
/* 804A98A0 00000018  4B FF FC B9 */	bl mDoMtx_XrotM__FPA4_fs
lbl_804A98A4:
/* 804A98A4 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 804A98A8 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 804A98AC 00000008  80 63 00 00 */	lwz r3, 0(r3)
...
/* 804A98BC 00000018  4B FF FC 9D */	bl PSMTXCopy
/* 804A98C0 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 804A98C4 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 804A98C8 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 804A98CC 00000028  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 804A98D0 0000002C  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */
/* 804A98D4 00000030  4B FF FC 85 */	bl PSMTXCopy
lbl_804A98D8:
/* 804A98D8 00000000  38 60 00 01 */	li r3, 1
/* 804A98DC 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 804A98E0 00000008  4B FF FC 79 */	bl _restgpr_28

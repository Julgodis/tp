...
/* 804A9818 00000020  3C 60 00 00 */	lis r3, j3dSys@ha
/* 804A981C 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l
...
/* 804A9850 00000010  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 804A9854 00000014  38 84 00 00 */	addi r4, r4, calc_mtx@l
...
/* 804A9868 00000028  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804A986C 0000002C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
lbl_804A9888:
/* 804A9888 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804A988C 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
lbl_804A98A4:
/* 804A98A4 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804A98A8 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 804A98C0 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804A98C4 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 804A98C8 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 804A98CC 00000028  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 804A98D0 0000002C  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l

...
/* 804D9210  3C 60 80 4E */	lis r3, lit_3942@ha
/* 804D9214  3B E3 9E 64 */	addi r31, r3, lit_3942@l
...
/* 804D9240  4B B4 07 EC */	b fopAcM_SearchByName__FsPP10fopAc_ac_c
...
/* 804D927C  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804D9280  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804D9284  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804D9288  4B E6 D2 28 */	b PSMTXCopy
...
/* 804D92AC  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804D92B0  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804D92B4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804D92B8  4B E6 D1 F8 */	b PSMTXCopy
...
/* 804D92D4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804D92D8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804D92DC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804D92E0  4B E6 D1 D0 */	b PSMTXCopy
lbl_804D92E4:
...
/* 804D92FC  4B D9 7B F0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 804D9368  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D936C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804D9384  4B E6 D5 64 */	b PSMTXTrans
/* 804D9388  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D938C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804D9390  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 804D9394  4B B3 30 A0 */	b mDoMtx_YrotM__FPA4_fs
/* 804D9398  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D939C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804D93A0  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 804D93A4  4B B3 2F F8 */	b mDoMtx_XrotM__FPA4_fs
/* 804D93A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D93AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804D93B0  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 804D93B4  4B B3 31 18 */	b mDoMtx_ZrotM__FPA4_fs
/* 804D93B8  3C 60 80 4E */	lis r3, l_HIO@ha
/* 804D93BC  38 63 A3 6C */	addi r3, r3, l_HIO@l
/* 804D93C0  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 804DA374 */
/* 804D93C4  FC 40 08 90 */	fmr f2, f1
/* 804D93C8  FC 60 08 90 */	fmr f3, f1
/* 804D93CC  4B B3 3A 6C */	b scaleM__14mDoMtx_stack_cFfff
/* 804D93D0  80 7E 05 E4 */	lwz r3, 0x5e4(r30)
/* 804D93D4  80 83 00 04 */	lwz r4, 4(r3)
/* 804D93D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D93DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804D93E0  38 84 00 24 */	addi r4, r4, 0x24
/* 804D93E4  4B E6 D0 CC */	b PSMTXCopy
...
/* 804D93F8  4B B3 71 D0 */	b play__14mDoExt_McaMorfFP3VecUlSc
...
/* 804D9478  4B B3 72 34 */	b modelCalc__14mDoExt_McaMorfFv
...
/* 804D94C4  4B B5 3B A8 */	b dComIfGp_getReverb__Fi
...
/* 804D94F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804D94F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804D94F8  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 804D950C  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 804D9510  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 804D9514  38 81 00 08 */	addi r4, r1, 8
/* 804D9518  4B B4 02 E0 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 804D9554  4B D8 E4 38 */	b cM_rndFX__Ff
...
/* 804D9570  4B D8 E4 1C */	b cM_rndFX__Ff

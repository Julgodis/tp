...
/* 804D8C60 00000018  3C 60 00 00 */	lis r3, lit_3942@ha /* 804D9E64 */
/* 804D8C64 0000001C  3B E3 00 00 */	addi r31, r3, lit_3942@l /* 804D9E64 */
/* 804D8C68 00000020  C0 1F 00 10 */	lfs f0, 0x10(r31)
...
/* 804D8C84 0000003C  C0 3F 00 44 */	lfs f1, 0x44(r31)
/* 804D8C88 00000040  4B FF DF 31 */	bl cM_rndF__Ff
/* 804D8C8C 00000044  C0 1F 00 84 */	lfs f0, 0x84(r31)
/* 804D8C90 00000048  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804D8C94 00000000  40 80 00 28 */	bge lbl_804D8CBC
/* 804D8C98 00000004  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 804D8C9C 00000008  4B FF DF 1D */	bl cM_rndF__Ff
/* 804D8CA0 0000000C  C0 1F 00 04 */	lfs f0, 4(r31)
...
lbl_804D8CBC:
/* 804D8CBC 00000000  C0 3F 00 40 */	lfs f1, 0x40(r31)
/* 804D8CC0 00000004  4B FF DE F9 */	bl cM_rndF__Ff
/* 804D8CC4 00000008  C0 1F 00 40 */	lfs f0, 0x40(r31)
...
lbl_804D8CDC:
/* 804D8CDC 00000000  C0 3F 00 B8 */	lfs f1, 0xb8(r31)
/* 804D8CE0 00000004  4B FF DE D9 */	bl cM_rndF__Ff
...
/* 804D8CF4 00000018  3C 60 00 00 */	lis r3, wait_bck@ha /* 804DA208 */
/* 804D8CF8 0000001C  38 83 00 00 */	addi r4, r3, wait_bck@l /* 804DA208 */
/* 804D8CFC 00000020  7F C3 F3 78 */	mr r3, r30
/* 804D8D00 00000024  7C 84 00 2E */	lwzx r4, r4, r0
/* 804D8D04 00000028  C0 3F 00 40 */	lfs f1, 0x40(r31)
/* 804D8D08 0000002C  38 A0 00 00 */	li r5, 0
/* 804D8D0C 00000030  C0 5F 00 44 */	lfs f2, 0x44(r31)
...
/* 804D8D40 0000002C  C0 5F 00 44 */	lfs f2, 0x44(r31)
/* 804D8D44 00000030  C0 1F 00 08 */	lfs f0, 8(r31)
/* 804D8D48 00000034  EC 60 18 2A */	fadds f3, f0, f3
/* 804D8D4C 00000038  4B FF DE 6D */	bl cLib_addCalc2__FPffff
...
/* 804D8D64 00000050  C0 5F 00 44 */	lfs f2, 0x44(r31)
/* 804D8D68 00000054  C0 1F 00 08 */	lfs f0, 8(r31)
/* 804D8D6C 00000058  EC 60 18 2A */	fadds f3, f0, f3
/* 804D8D70 0000005C  4B FF DE 49 */	bl cLib_addCalc2__FPffff
...
/* 804D8D88 00000074  C0 5F 00 44 */	lfs f2, 0x44(r31)
/* 804D8D8C 00000078  C0 1F 00 08 */	lfs f0, 8(r31)
/* 804D8D90 0000007C  EC 60 18 2A */	fadds f3, f0, f3
/* 804D8D94 00000080  4B FF DE 25 */	bl cLib_addCalc2__FPffff
...
/* 804D8DB8 000000A4  C0 1F 00 10 */	lfs f0, 0x10(r31)
/* 804D8DBC 000000A8  D0 1E 06 24 */	stfs f0, 0x624(r30)
/* 804D8DC0 000000AC  C0 3F 00 40 */	lfs f1, 0x40(r31)
/* 804D8DC4 000000B0  4B FF DD F5 */	bl cM_rndF__Ff
/* 804D8DC8 000000B4  C0 1F 00 3C */	lfs f0, 0x3c(r31)
...
/* 804D8DE8 000000D4  C0 3F 00 44 */	lfs f1, 0x44(r31)
...
/* 804D8DF8 000000E4  3C 60 00 00 */	lis r3, l_HIO@ha /* 804DA36C */
/* 804D8DFC 000000E8  38 63 00 00 */	addi r3, r3, l_HIO@l /* 804DA36C */
/* 804D8E00 000000EC  A8 03 00 1C */	lha r0, 0x1c(r3)

...
/* 8086C154 00000014  3C A0 00 00 */	lis r5, lit_3829@ha /* 80870094 */
/* 8086C158 00000018  3B E5 00 00 */	addi r31, r5, lit_3829@l /* 80870094 */
...
/* 8086C168 00000028  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 8086C16C 0000002C  38 63 00 00 */	addi r3, r3, j3dSys@l /* 80434AC8 */
...
/* 8086C18C 0000004C  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 8086C190 00000050  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
/* 8086C194 00000054  80 84 00 00 */	lwz r4, 0(r4)
/* 8086C198 00000058  4B FF FE 41 */	bl PSMTXCopy
/* 8086C19C 0000005C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8086C1A0 00000060  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 8086C1C4 00000084  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8086C1C8 00000088  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 8086C1E0 000000A0  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8086C1E4 000000A4  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8086C1E8 000000A8  80 63 00 00 */	lwz r3, 0(r3)
/* 8086C1EC 000000AC  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 8086C1F0 000000B0  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */

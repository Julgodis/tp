...
/* 8086DA10  4B AF 47 B8 */	b _savegpr_24
/* 8086DA14  7C 7F 1B 78 */	mr r31, r3
/* 8086DA18  3C 80 80 87 */	lis r4, lit_3829@ha
/* 8086DA1C  3B C4 00 94 */	addi r30, r4, lit_3829@l
/* 8086DA20  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8086DA24  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 8086DA28  83 9D 5D AC */	lwz r28, 0x5dac(r29)	/* effective address: 8040BF6C */
...
lbl_8086DABC:
/* 8086DABC  3C 60 80 87 */	lis r3, BallStartPos@ha
/* 8086DAC0  C4 03 09 A4 */	lfsu f0, BallStartPos@l(r3)
/* 8086DAC4  D0 1F 04 D0 */	stfs f0, 0x4d0(r31)
/* 8086DAC8  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80870004 */
/* 8086DACC  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)
/* 8086DAD0  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80870008 */
...
lbl_8086DB0C:
/* 8086DB0C  3C 60 80 87 */	lis r3, BallStartPos@ha
/* 8086DB10  C4 03 09 A4 */	lfsu f0, BallStartPos@l(r3)
/* 8086DB14  D0 1F 04 D0 */	stfs f0, 0x4d0(r31)
/* 8086DB18  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80870004 */
/* 8086DB1C  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)
/* 8086DB20  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80870008 */
...
/* 8086DB98  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8086DB9C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8086DBA0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8086DBA4  A8 9F 40 22 */	lha r4, 0x4022(r31)
/* 8086DBA8  4B 79 E8 34 */	b mDoMtx_YrotS__FPA4_fs
/* 8086DBAC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8086DBB0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8086DBB4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8086DBB8  A8 9F 40 20 */	lha r4, 0x4020(r31)
/* 8086DBBC  4B 79 E7 E0 */	b mDoMtx_XrotM__FPA4_fs
/* 8086DBC0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8086DBC4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8086DBC8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8086DBCC  A8 9F 40 24 */	lha r4, 0x4024(r31)
/* 8086DBD0  4B 79 E8 FC */	b mDoMtx_ZrotM__FPA4_fs
/* 8086DBD4  38 7F 04 F8 */	addi r3, r31, 0x4f8
/* 8086DBD8  38 9F 40 64 */	addi r4, r31, 0x4064
/* 8086DBDC  4B A0 33 10 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8086DC04  4B AD 94 8C */	b PSVECAdd
...
/* 8086DC28  4B 9F 9A 4C */	b cM_atan2s__Fff
...
/* 8086DC68  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8086DC6C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8086DC70  3B 84 0F 38 */	addi r28, r4, 0xf38
/* 8086DC74  7F 84 E3 78 */	mr r4, r28
/* 8086DC78  4B 80 8E 34 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8086DD20  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 8086DD24  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 8086DD28  38 81 00 22 */	addi r4, r1, 0x22
/* 8086DD2C  4B 7A BA CC */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8086DD50  4B 9F 34 F4 */	b dTimer_getRestTimeMs__Fv
...
/* 8086DDFC  3C 80 80 87 */	lis r4, BallEndPos@ha
/* 8086DE00  38 84 09 BC */	addi r4, r4, BallEndPos@l
/* 8086DE04  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8086DE08  4B 9F 8D 2C */	b __mi__4cXyzCFRC3Vec
...
/* 8086DE28  4B AD 93 10 */	b PSVECSquareMag
...
/* 8086DE98  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8086DE9C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8086DF08  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8086DF0C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8086DF10:
...
/* 8086DF24  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 8086DF28  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 8086DF2C  38 81 00 20 */	addi r4, r1, 0x20
/* 8086DF30  4B 7A B8 C8 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8086E01C  4B 80 95 60 */	b __ct__11dBgS_GndChkFv
...
/* 8086E058  4B 9F 9C D0 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 8086E05C  7F 83 E3 78 */	mr r3, r28
/* 8086E060  38 81 00 88 */	addi r4, r1, 0x88
/* 8086E064  4B 80 64 3C */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8086E084  4B 9F 95 F0 */	b cM_atan2s__Fff
...
/* 8086E0E4  4B 9F 9C 44 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 8086E0E8  7F 83 E3 78 */	mr r3, r28
/* 8086E0EC  38 81 00 88 */	addi r4, r1, 0x88
/* 8086E0F0  4B 80 63 B0 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8086E110  4B 9F 95 64 */	b cM_atan2s__Fff
...
lbl_8086E134:
/* 8086E134  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8086E138  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8086E13C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8086E140  7F 24 CB 78 */	mr r4, r25
/* 8086E144  4B 79 E2 00 */	b mDoMtx_XrotS__FPA4_fs
/* 8086E148  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8086E14C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8086E150  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8086E154  7F 44 D3 78 */	mr r4, r26
/* 8086E158  4B 79 E3 74 */	b mDoMtx_ZrotM__FPA4_fs
...
/* 8086E178  4B A0 2D 74 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8086E1A0  4B A0 18 9C */	b cLib_addCalc2__FPffff
...
/* 8086E1C8  4B A0 18 74 */	b cLib_addCalc2__FPffff
/* 8086E1CC  38 61 00 88 */	addi r3, r1, 0x88
/* 8086E1D0  38 80 FF FF */	li r4, -1
/* 8086E1D4  4B 80 94 1C */	b __dt__11dBgS_GndChkFv
lbl_8086E1D8:
/* 8086E1D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8086E1DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8086E1E0  83 23 5D 74 */	lwz r25, 0x5d74(r3)	/* effective address: 8040BF34 */
/* 8086E1E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E1E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E1EC  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8086E1F0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8086E1F4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8086E1F8  4B AD 86 F0 */	b PSMTXTrans
/* 8086E1FC  C0 3F 04 EC */	lfs f1, 0x4ec(r31)
/* 8086E200  FC 40 08 90 */	fmr f2, f1
/* 8086E204  FC 60 08 90 */	fmr f3, f1
/* 8086E208  4B 79 EC 30 */	b scaleM__14mDoMtx_stack_cFfff
...
/* 8086E24C  4B 9F 94 28 */	b cM_atan2s__Fff
/* 8086E250  7C 64 1B 78 */	mr r4, r3
/* 8086E254  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E258  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E25C  4B 79 E1 D8 */	b mDoMtx_YrotM__FPA4_fs
...
/* 8086E28C  4B 9F 93 E8 */	b cM_atan2s__Fff
/* 8086E290  7C 03 00 D0 */	neg r0, r3
/* 8086E294  7C 04 07 34 */	extsh r4, r0
/* 8086E298  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E29C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E2A0  4B 79 E0 FC */	b mDoMtx_XrotM__FPA4_fs
/* 8086E2A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E2A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E2AC  80 9F 40 70 */	lwz r4, 0x4070(r31)
/* 8086E2B0  38 84 00 24 */	addi r4, r4, 0x24
/* 8086E2B4  4B AD 81 FC */	b PSMTXCopy
...
/* 8086E2E0  3C 60 80 87 */	lis r3, s_fish_sub__FPvPv@ha
/* 8086E2E4  3B 43 CC 6C */	addi r26, r3, s_fish_sub__FPvPv@l
lbl_8086E2E8:
...
/* 8086E338  4B 7B 30 00 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 8086E380  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8086E384  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
lbl_8086E388:
...
/* 8086E3F0  4B 7D F0 DC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8086E42C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8086E430  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
lbl_8086E47C:
/* 8086E47C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E480  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E484  C0 3E 01 18 */	lfs f1, 0x118(r30)
/* 8086E488  C0 5E 00 30 */	lfs f2, 0x30(r30)
/* 8086E48C  C0 7E 01 1C */	lfs f3, 0x11c(r30)
/* 8086E490  4B AD 84 58 */	b PSMTXTrans
/* 8086E494  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E498  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E49C  38 80 40 00 */	li r4, 0x4000
/* 8086E4A0  4B 79 DF 94 */	b mDoMtx_YrotM__FPA4_fs
/* 8086E4A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E4A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E4AC  38 18 07 D0 */	addi r0, r24, 0x7d0
/* 8086E4B0  7C 04 07 34 */	extsh r4, r0
/* 8086E4B4  4B 79 E0 18 */	b mDoMtx_ZrotM__FPA4_fs
/* 8086E4B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E4BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E4C0  80 9F 6B 30 */	lwz r4, 0x6b30(r31)
/* 8086E4C4  38 84 00 24 */	addi r4, r4, 0x24
/* 8086E4C8  4B AD 7F E8 */	b PSMTXCopy
/* 8086E4CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E4D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E4D4  C0 3E 01 18 */	lfs f1, 0x118(r30)
/* 8086E4D8  C0 5E 00 1C */	lfs f2, 0x1c(r30)
/* 8086E4DC  C0 7E 01 1C */	lfs f3, 0x11c(r30)
/* 8086E4E0  4B AD 84 08 */	b PSMTXTrans
/* 8086E4E4  C0 3E 00 44 */	lfs f1, 0x44(r30)
/* 8086E4E8  C0 5E 00 08 */	lfs f2, 8(r30)
/* 8086E4EC  C0 7E 00 04 */	lfs f3, 4(r30)
/* 8086E4F0  4B 79 E9 48 */	b scaleM__14mDoMtx_stack_cFfff
/* 8086E4F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E4F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E4FC  38 9F 6B 38 */	addi r4, r31, 0x6b38
/* 8086E500  4B AD 7F B0 */	b PSMTXCopy
/* 8086E504  80 7F 6B 68 */	lwz r3, 0x6b68(r31)
/* 8086E508  4B 80 D4 B8 */	b Move__4dBgWFv
...
/* 8086E56C  4B 9F 93 E8 */	b cM_rndF__Ff
...
/* 8086E584  4B 9F 93 D0 */	b cM_rndF__Ff
...
/* 8086E59C  4B 9F 93 B8 */	b cM_rndF__Ff
...
/* 8086E5B0  4B 9F 93 A4 */	b cM_rndF__Ff
...
/* 8086E5E0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8086E5E4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8086E62C  4B A0 14 54 */	b cLib_addCalc0__FPfff
/* 8086E630  38 7F 40 00 */	addi r3, r31, 0x4000
/* 8086E634  C0 3E 00 04 */	lfs f1, 4(r30)
/* 8086E638  C0 5E 00 2C */	lfs f2, 0x2c(r30)
/* 8086E63C  4B A0 14 44 */	b cLib_addCalc0__FPfff
/* 8086E640  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E644  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E648  C0 3E 01 20 */	lfs f1, 0x120(r30)
/* 8086E64C  C0 5E 01 2C */	lfs f2, 0x12c(r30)
/* 8086E650  C0 7E 01 24 */	lfs f3, 0x124(r30)
/* 8086E654  4B AD 82 94 */	b PSMTXTrans
/* 8086E658  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E65C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E660  7F 04 07 34 */	extsh r4, r24
/* 8086E664  4B 79 DD 38 */	b mDoMtx_XrotM__FPA4_fs
/* 8086E668  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E66C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E670  38 19 3A 98 */	addi r0, r25, 0x3a98
/* 8086E674  7C 04 07 34 */	extsh r4, r0
/* 8086E678  4B 79 DE 54 */	b mDoMtx_ZrotM__FPA4_fs
/* 8086E67C  C0 3E 00 84 */	lfs f1, 0x84(r30)
/* 8086E680  C0 5E 01 30 */	lfs f2, 0x130(r30)
/* 8086E684  C0 7E 00 1C */	lfs f3, 0x1c(r30)
/* 8086E688  4B 79 E7 14 */	b transM__14mDoMtx_stack_cFfff
/* 8086E68C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086E690  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086E694  80 9F 3F F4 */	lwz r4, 0x3ff4(r31)
/* 8086E698  38 84 00 24 */	addi r4, r4, 0x24
/* 8086E69C  4B AD 7E 14 */	b PSMTXCopy
...
/* 8086E6B0  4B AF 3B 64 */	b _restgpr_24

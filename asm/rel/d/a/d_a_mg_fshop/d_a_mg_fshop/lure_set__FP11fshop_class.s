...
/* 8086C6FC  4B AF 5A BC */	b _savegpr_20
/* 8086C700  3C 80 80 87 */	lis r4, cNullVec__6Z2Calc@ha
/* 8086C704  3A C4 02 84 */	addi r22, r4, cNullVec__6Z2Calc@l
/* 8086C708  3C 80 80 87 */	lis r4, lit_3829@ha
...
/* 8086C72C  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l
...
/* 8086C758  4B 9F B1 FC */	b cM_rndF__Ff
...
/* 8086C770  4B 9F B1 E4 */	b cM_rndF__Ff
...
/* 8086C788  4B 9F B1 CC */	b cM_rndF__Ff
...
/* 8086C79C  4B 9F B1 B8 */	b cM_rndF__Ff
...
/* 8086C930  4B 7A 04 6C */	b transM__14mDoMtx_stack_cFfff
/* 8086C934  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086C938  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086C93C  38 80 D8 F0 */	li r4, -10000
/* 8086C940  4B 79 FA 5C */	b mDoMtx_XrotM__FPA4_fs
/* 8086C944  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086C948  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086C94C  80 95 00 18 */	lwz r4, 0x18(r21)
/* 8086C950  38 84 00 24 */	addi r4, r4, 0x24
/* 8086C954  4B AD 9B 5C */	b PSMTXCopy
/* 8086C958  4B 7A 03 BC */	b pop__14mDoMtx_stack_cFv
...
/* 8086C978  4B 7A 04 24 */	b transM__14mDoMtx_stack_cFfff
/* 8086C97C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086C980  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086C984  38 80 40 00 */	li r4, 0x4000
/* 8086C988  4B 79 FA 14 */	b mDoMtx_XrotM__FPA4_fs
/* 8086C98C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8086C990  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8086C994  80 95 00 1C */	lwz r4, 0x1c(r21)
/* 8086C998  38 84 00 24 */	addi r4, r4, 0x24
/* 8086C99C  4B AD 9B 14 */	b PSMTXCopy
lbl_8086C9A0:
...
/* 8086C9BC  4B AF 58 48 */	b _restgpr_20

...
/* 8086C0B4  83 E3 00 38 */	lwz r31, 0x38(r3)	/* effective address: 80434B00 */
...
/* 8086C0D4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8086C0D8  4B AD A3 D8 */	b PSMTXCopy
/* 8086C0DC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8086C0E0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8086C0E4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8086C0F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8086C114  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

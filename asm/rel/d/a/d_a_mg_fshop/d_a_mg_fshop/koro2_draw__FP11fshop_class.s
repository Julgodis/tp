...
/* 8086C230 0000001C  3C 60 00 00 */	lis r3, lit_3871@ha /* 808700A0 */
/* 8086C234 00000020  C0 03 00 00 */	lfs f0, lit_3871@l(r3) /* 808700A0 */
/* 8086C238 00000024  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8086C23C 00000000  40 81 00 24 */	ble lbl_8086C260
/* 8086C240 00000004  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8086C244 00000008  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 8086C248 0000000C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 8086C24C 00000010  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 8086C250 00000014  38 63 00 00 */	addi r3, r3, j3dSys@l /* 80434AC8 */
...
lbl_8086C260:
/* 8086C260 00000000  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8086C264 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8086C268 00000008  3C 80 00 00 */	lis r4, ArcIX_A_crwaku_model@ha /* 808709C8 */
/* 8086C26C 0000000C  38 84 00 00 */	addi r4, r4, ArcIX_A_crwaku_model@l /* 808709C8 */
...
/* 8086C280 00000020  3C 60 00 00 */	lis r3, ArcIX_A_crwaku_model@ha /* 808709C8 */
/* 8086C284 00000024  38 63 00 00 */	addi r3, r3, ArcIX_A_crwaku_model@l /* 808709C8 */
...
/* 8086C298 00000038  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8086C29C 0000003C  3B A3 00 00 */	addi r29, r3, g_env_light@l /* 8042CA54 */
lbl_8086C2A0:
...
/* 8086C2D8 00000010  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8086C2DC 00000014  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 8086C2E0 00000018  80 04 5F 80 */	lwz r0, 0x5f80(r4)
/* 8086C2E4 0000001C  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 8086C2E8 00000020  38 63 00 00 */	addi r3, r3, j3dSys@l /* 80434AC8 */

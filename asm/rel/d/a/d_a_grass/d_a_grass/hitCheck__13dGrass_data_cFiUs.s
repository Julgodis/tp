...
/* 8051EBA8 00000020  3C 60 00 00 */	lis r3, __vt__15dCcMassS_HitInf@ha
/* 8051EBAC 00000024  38 03 00 00 */	addi r0, r3, __vt__15dCcMassS_HitInf@l
/* 8051EBB0 00000028  90 01 00 20 */	stw r0, 0x20(r1)
/* 8051EBB4 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8051EBB8 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8051EC2C 00000020  3C 60 00 00 */	lis r3, m_grass__9daGrass_c@ha
/* 8051EC30 00000024  80 83 00 00 */	lwz r4, m_grass__9daGrass_c@l(r3)
...
/* 8051EC7C 00000070  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8051EC80 00000074  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 8051EC94 00000088  3D 00 00 00 */	lis r8, lit_4516@ha
/* 8051EC98 0000008C  C0 28 00 00 */	lfs f1, lit_4516@l(r8)
/* 8051EC9C 00000090  FC 40 08 90 */	fmr f2, f1
/* 8051ECA0 00000094  3D 00 00 00 */	lis r8, lit_4517@ha
/* 8051ECA4 00000098  C0 68 00 00 */	lfs f3, lit_4517@l(r8)
...
/* 8051ED00 00000044  3C 60 00 00 */	lis r3, m_grass__9daGrass_c@ha
/* 8051ED04 00000048  38 63 00 00 */	addi r3, r3, m_grass__9daGrass_c@l
...
lbl_8051ED74:
/* 8051ED74 00000000  3C 60 00 00 */	lis r3, __vt__15dCcMassS_HitInf@ha
/* 8051ED78 00000004  38 03 00 00 */	addi r0, r3, __vt__15dCcMassS_HitInf@l

...
/* 80520B5C  4B B6 3C 40 */	b dCcD_GetGObjInf__FP8cCcD_Obj
...
/* 80520B7C  3C 60 80 52 */	lis r3, lit_4000@ha
/* 80520B80  C0 03 30 2C */	lfs f0, lit_4000@l(r3)
/* 80520B84  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80520B88  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 80520B8C  38 61 00 20 */	addi r3, r1, 0x20
/* 80520B90  4B E2 65 A8 */	b PSVECSquareMag
/* 80520B94  FC 00 0A 10 */	fabs f0, f1
/* 80520B98  FC 20 00 18 */	frsp f1, f0
/* 80520B9C  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80520BA0  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80520BEC  3C 60 80 52 */	lis r3, lit_4000@ha
/* 80520BF0  C0 03 30 2C */	lfs f0, lit_4000@l(r3)
/* 80520BF4  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80520BF8  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80520BFC  38 61 00 14 */	addi r3, r1, 0x14
/* 80520C00  4B E2 65 38 */	b PSVECSquareMag
lbl_80520C04:
/* 80520C04  C0 01 00 2C */	lfs f0, 0x2c(r1)
/* 80520C08  D0 01 00 08 */	stfs f0, 8(r1)
/* 80520C0C  3C 60 80 52 */	lis r3, lit_4000@ha
/* 80520C10  C0 03 30 2C */	lfs f0, lit_4000@l(r3)
...
/* 80520C24  4B E2 65 14 */	b PSVECSquareMag
/* 80520C28  FF E0 08 90 */	fmr f31, f1
/* 80520C2C  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 80520C30  C0 41 00 34 */	lfs f2, 0x34(r1)
/* 80520C34  4B D4 6A 40 */	b cM_atan2s__Fff
/* 80520C38  7C 7E 1B 78 */	mr r30, r3
/* 80520C3C  3C 60 80 52 */	lis r3, lit_4000@ha
/* 80520C40  C0 03 30 2C */	lfs f0, lit_4000@l(r3)
...
/* 80520C80  3C 60 80 45 */	lis r3, m_flower__9daGrass_c@ha
/* 80520C84  80 83 0D B4 */	lwz r4, m_flower__9daGrass_c@l(r3)
...
lbl_80520CA8:
/* 80520CA8  3C 60 80 45 */	lis r3, m_flower__9daGrass_c@ha
/* 80520CAC  80 03 0D B4 */	lwz r0, m_flower__9daGrass_c@l(r3)
...
/* 80520CCC  3C 60 80 52 */	lis r3, lit_5352@ha
/* 80520CD0  C0 43 31 64 */	lfs f2, lit_5352@l(r3)
/* 80520CD4  4B D4 69 A0 */	b cM_atan2s__Fff

...
/* 8051DF6C 00000004  4B E4 42 68 */	b _savegpr_27
...
/* 8051DF80 00000018  3C 60 80 52 */	lis r3, lit_3999@ha
/* 8051DF84 0000001C  3B C3 30 28 */	addi r30, r3, lit_3999@l
...
/* 8051DFC0 00000058  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 8052302C */
...
/* 8051DFD0 00000068  4B E2 91 68 */	b PSVECSquareMag
...
/* 8051DFE4 00000004  4B B6 67 B8 */	b dCcD_GetGObjInf__FP8cCcD_Obj
...
/* 8051E004 00000024  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 8052302C */
...
/* 8051E014 00000034  4B E2 91 24 */	b PSVECSquareMag
/* 8051E018 00000038  FF E0 08 90 */	fmr f31, f1
/* 8051E01C 0000003C  FC 00 0A 10 */	fabs f0, f1
/* 8051E020 00000040  FC 20 00 18 */	frsp f1, f0
/* 8051E024 00000044  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8051E028 00000048  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 8051E070 00000040  C0 3E 00 14 */	lfs f1, 0x14(r30)	/* effective address: 8052303C */
/* 8051E074 00000044  4B E2 90 64 */	b PSVECScale
/* 8051E078 00000048  C0 01 00 38 */	lfs f0, 0x38(r1)
/* 8051E07C 0000004C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8051E080 00000050  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 8052302C */
...
/* 8051E094 00000064  4B E2 90 A4 */	b PSVECSquareMag
...
/* 8051E0D4 00000034  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 8052302C */
...
/* 8051E0E4 00000044  4B E2 90 54 */	b PSVECSquareMag
...
/* 8051E0F4 00000008  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8051E0F8 0000000C  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 8051E10C 0000000C  4B D4 95 68 */	b cM_atan2s__Fff
/* 8051E110 00000010  7C 7D 1B 78 */	mr r29, r3
lbl_8051E114:
/* 8051E114 00000000  4B D4 97 58 */	b cM_rnd__Fv
/* 8051E118 00000004  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 80523044 */
/* 8051E11C 00000008  EC 20 00 72 */	fmuls f1, f0, f1
/* 8051E120 0000000C  C0 1E 00 18 */	lfs f0, 0x18(r30)	/* effective address: 80523040 */
/* 8051E124 00000010  EC 40 08 2A */	fadds f2, f0, f1
/* 8051E128 00000014  7F A0 07 34 */	extsh r0, r29
/* 8051E12C 00000018  C8 3E 00 38 */	lfd f1, 0x38(r30)	/* effective address: 80523060 */
...
/* 8051E160 0000004C  C0 5E 00 0C */	lfs f2, 0xc(r30)	/* effective address: 80523034 */
/* 8051E164 00000050  4B D4 95 10 */	b cM_atan2s__Fff
/* 8051E168 00000054  7C 60 07 34 */	extsh r0, r3
/* 8051E16C 00000058  C8 3E 00 38 */	lfd f1, 0x38(r30)	/* effective address: 80523060 */
...
/* 8051E188 00000074  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80523028 */
...
/* 8051E1B4 00000008  4B E4 40 6C */	b _restgpr_27

...
/* 805A06DC  4B CA 9B FC */	b doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
/* 805A06E0  2C 03 00 00 */	cmpwi r3, 0
/* 805A06E4  41 82 00 1C */	beq lbl_805A0700
/* 805A06E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A06EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A06F0  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 805A06F4  4B AA 1D 74 */	b reset__14dEvt_control_cFv
...
lbl_805A0708:
/* 805A0708  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A070C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A0710  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 805A073C  4B CA 98 54 */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 805A0760  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A0764  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A0768  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 805A076C  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */

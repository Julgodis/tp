...
/* 805A07D8  4B DC 1A 00 */	b _savegpr_28
/* 805A07DC  7C 7E 1B 78 */	mr r30, r3
/* 805A07E0  3C 60 80 5A */	lis r3, lit_3769@ha
/* 805A07E4  3B E3 11 58 */	addi r31, r3, lit_3769@l
/* 805A07E8  C0 1F 00 20 */	lfs f0, 0x20(r31)	/* effective address: 805A1178 */
...
/* 805A07FC  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 805A1160 */
/* 805A0800  FC 40 08 90 */	fmr f2, f1
/* 805A0804  C0 7F 00 84 */	lfs f3, 0x84(r31)	/* effective address: 805A11DC */
/* 805A0808  4B CC F2 34 */	b cLib_addCalc2__FPffff
...
/* 805A0874  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A0878  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A087C  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 805A0880  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 805A0884  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 805A0888  4B DA 60 60 */	b PSMTXTrans
/* 805A088C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A0890  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A0894  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 805A0898  4B A6 BB 9C */	b mDoMtx_YrotM__FPA4_fs
/* 805A089C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A08A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A08A4  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 805A08A8  4B A6 BA F4 */	b mDoMtx_XrotM__FPA4_fs
/* 805A08AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A08B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A08B4  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 805A08B8  4B A6 BC 14 */	b mDoMtx_ZrotM__FPA4_fs
/* 805A08BC  C0 3E 04 EC */	lfs f1, 0x4ec(r30)
/* 805A08C0  3C 60 80 5A */	lis r3, l_HIO@ha
/* 805A08C4  3B A3 13 40 */	addi r29, r3, l_HIO@l
/* 805A08C8  C0 1D 00 08 */	lfs f0, 8(r29)	/* effective address: 805A1348 */
/* 805A08CC  EC 21 00 32 */	fmuls f1, f1, f0
/* 805A08D0  FC 40 08 90 */	fmr f2, f1
/* 805A08D4  FC 60 08 90 */	fmr f3, f1
/* 805A08D8  4B A6 C5 60 */	b scaleM__14mDoMtx_stack_cFfff
/* 805A08DC  80 7E 05 EC */	lwz r3, 0x5ec(r30)
/* 805A08E0  83 83 00 04 */	lwz r28, 4(r3)
/* 805A08E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A08E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A08EC  38 9C 00 24 */	addi r4, r28, 0x24
/* 805A08F0  4B DA 5B C0 */	b PSMTXCopy
...
/* 805A0904  4B A6 FC C4 */	b play__14mDoExt_McaMorfFP3VecUlSc
...
/* 805A0938  4B A6 FD 74 */	b modelCalc__14mDoExt_McaMorfFv
/* 805A093C  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 805A0940  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805A0944  38 63 00 60 */	addi r3, r3, 0x60
/* 805A0948  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 805A094C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 805A0950  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 805A0954  4B DA 5B 5C */	b PSMTXCopy
/* 805A0958  38 61 00 08 */	addi r3, r1, 8
/* 805A095C  38 9E 05 38 */	addi r4, r30, 0x538
/* 805A0960  4B CD 05 8C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 805A099C  4B CC EC AC */	b SetC__8cM3dGSphFRC4cXyz
...
/* 805A09B0  4B CC ED 58 */	b SetR__8cM3dGSphFf
/* 805A09B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A09B8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A09BC  38 63 23 3C */	addi r3, r3, 0x233c
/* 805A09C0  38 9E 08 C4 */	addi r4, r30, 0x8c4
/* 805A09C4  4B CC 41 E4 */	b Set__4cCcSFP8cCcD_Obj
...
/* 805A09D8  4B DC 18 4C */	b _restgpr_28

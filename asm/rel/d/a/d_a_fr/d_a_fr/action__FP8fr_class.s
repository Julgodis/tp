...
/* 8051AD1C 00000004  4B E4 74 BC */	b _savegpr_28
/* 8051AD20 00000008  7C 7D 1B 78 */	mr r29, r3
/* 8051AD24 0000000C  3C 80 80 52 */	lis r4, lit_3649@ha
/* 8051AD28 00000010  3B E4 B9 C8 */	addi r31, r4, lit_3649@l
/* 8051AD2C 00000014  3B C0 00 00 */	li r30, 0
/* 8051AD30 00000018  3C 80 80 52 */	lis r4, l_HIO@ha
/* 8051AD34 0000001C  38 84 BC 20 */	addi r4, r4, l_HIO@l
/* 8051AD38 00000020  C0 04 00 10 */	lfs f0, 0x10(r4)	/* effective address: 8051BC30 */
...
/* 8051AD54 0000003C  3C 80 80 52 */	lis r4, lit_4226@ha
/* 8051AD58 00000040  38 84 BA 94 */	addi r4, r4, lit_4226@l
...
lbl_8051AD6C:
/* 8051AD6C 00000000  4B FF F0 B9 */	bl fr_normal__FP8fr_class
/* 8051AD70 00000004  38 00 00 01 */	li r0, 1
/* 8051AD74 00000008  98 1D 09 91 */	stb r0, 0x991(r29)
/* 8051AD78 0000000C  48 00 00 58 */	b lbl_8051ADD0
lbl_8051AD7C:
/* 8051AD7C 00000000  4B FF F3 5D */	bl fr_away__FP8fr_class
/* 8051AD80 00000004  38 00 00 01 */	li r0, 1
/* 8051AD84 00000008  98 1D 09 91 */	stb r0, 0x991(r29)
/* 8051AD88 0000000C  48 00 00 48 */	b lbl_8051ADD0
lbl_8051AD8C:
/* 8051AD8C 00000000  4B FF FE A1 */	bl fr_message__FP8fr_class
/* 8051AD90 00000004  38 00 00 02 */	li r0, 2
/* 8051AD94 00000008  98 1D 09 91 */	stb r0, 0x991(r29)
/* 8051AD98 0000000C  48 00 00 38 */	b lbl_8051ADD0
lbl_8051AD9C:
/* 8051AD9C 00000000  4B FF F5 7D */	bl fr_s_normal__FP8fr_class
/* 8051ADA0 00000004  3B C0 00 01 */	li r30, 1
/* 8051ADA4 00000008  48 00 00 2C */	b lbl_8051ADD0
lbl_8051ADA8:
/* 8051ADA8 00000000  4B FF F7 B1 */	bl fr_s_wait__FP8fr_class
/* 8051ADAC 00000004  3B C0 00 01 */	li r30, 1
/* 8051ADB0 00000008  48 00 00 20 */	b lbl_8051ADD0
lbl_8051ADB4:
/* 8051ADB4 00000000  4B FF F8 6D */	bl fr_s_away__FP8fr_class
/* 8051ADB8 00000004  3B C0 00 01 */	li r30, 1
/* 8051ADBC 00000008  48 00 00 14 */	b lbl_8051ADD0
lbl_8051ADC0:
/* 8051ADC0 00000000  4B FF FA 61 */	bl fr_eat__FP8fr_class
/* 8051ADC4 00000004  3B C0 FF FE */	li r30, -2
/* 8051ADC8 00000008  48 00 00 08 */	b lbl_8051ADD0
lbl_8051ADCC:
/* 8051ADCC 00000000  3B C0 FF FF */	li r30, -1
lbl_8051ADD0:
...
/* 8051ADE8 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8051ADEC 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8051ADF0 00000020  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 8051ADF4 00000024  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 8051AE04 00000034  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 8051B9D4 */
...
/* 8051AE3C 0000001C  4B D5 57 CC */	b cLib_addCalcAngleS2__FPssss
/* 8051AE40 00000020  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8051AE44 00000024  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8051AE48 00000028  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8051AE4C 0000002C  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8051AE50 00000030  4B AF 15 8C */	b mDoMtx_YrotS__FPA4_fs
/* 8051AE54 00000034  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 8051B9E4 */
...
/* 8051AE70 00000050  4B D5 60 7C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8051AEA0 00000080  4B D4 BC E4 */	b __ml__4cXyzCFf
/* 8051AEA4 00000084  38 61 00 08 */	addi r3, r1, 8
/* 8051AEA8 00000088  38 81 00 14 */	addi r4, r1, 0x14
/* 8051AEAC 0000008C  C0 3F 00 88 */	lfs f1, 0x88(r31)	/* effective address: 8051BA50 */
/* 8051AEB0 00000090  4B D4 BC D4 */	b __ml__4cXyzCFf
...
/* 8051AEC0 000000A0  4B E2 C1 D0 */	b PSVECAdd
/* 8051AEC4 000000A4  C0 3D 04 FC */	lfs f1, 0x4fc(r29)
/* 8051AEC8 000000A8  C0 1F 00 A8 */	lfs f0, 0xa8(r31)	/* effective address: 8051BA70 */
...
/* 8051AEF0 00000018  C0 1F 00 68 */	lfs f0, 0x68(r31)	/* effective address: 8051BA30 */
...
/* 8051AF04 0000002C  4B B5 C8 AC */	b __ct__18dBgS_ObjGndChk_SplFv
...
/* 8051AF34 00000008  4B D4 CD F4 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 8051AF38 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8051AF3C 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8051AF40 00000014  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8051AF44 00000018  38 81 00 38 */	addi r4, r1, 0x38
/* 8051AF48 0000001C  4B B5 95 58 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8051AFAC 00000020  C0 3F 00 AC */	lfs f1, 0xac(r31)	/* effective address: 8051BA74 */
/* 8051AFB0 00000024  4B B0 22 44 */	b fopAcM_riverStream__FP4cXyzPsPff
lbl_8051AFB4:
/* 8051AFB4 00000000  38 7D 06 44 */	addi r3, r29, 0x644
/* 8051AFB8 00000004  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 8051AFBC 00000008  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 8051AFC0 0000000C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8051AFC4 00000010  4B B5 BA E8 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8051AFDC 00000028  C0 9F 00 1C */	lfs f4, 0x1c(r31)	/* effective address: 8051B9E4 */
...
/* 8051AFF4 00000010  C0 3F 00 14 */	lfs f1, 0x14(r31)	/* effective address: 8051B9DC */
...
/* 8051B028 00000008  4B B5 C8 20 */	b __dt__18dBgS_ObjGndChk_SplFv
lbl_8051B02C:
...
/* 8051B038 00000008  4B E4 71 EC */	b _restgpr_28

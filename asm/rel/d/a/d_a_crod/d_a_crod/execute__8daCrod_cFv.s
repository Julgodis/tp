...
/* 804A36F0  4B EB EA E4 */	b _savegpr_27
/* 804A36F4  7C 7F 1B 78 */	mr r31, r3
/* 804A36F8  3C 60 80 4A */	lis r3, lit_3759@ha
/* 804A36FC  3B C3 40 EC */	addi r30, r3, lit_3759@l
/* 804A3700  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A3704  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 804A3708  83 9D 5D B4 */	lwz r28, 0x5db4(r29)	/* effective address: 8040BF74 */
...
/* 804A38A4  4B CB B4 14 */	b setData__16daPy_actorKeep_cFP10fopAc_ac_c
/* 804A38A8  38 7F 07 48 */	addi r3, r31, 0x748
/* 804A38AC  7F 64 DB 78 */	mr r4, r27
/* 804A38B0  4B CB B4 08 */	b setData__16daPy_actorKeep_cFP10fopAc_ac_c
...
lbl_804A3928:
/* 804A3928  3C 60 80 4A */	lis r3, data_804A4218@ha
/* 804A392C  38 83 42 18 */	addi r4, r3, data_804A4218@l
/* 804A3930  88 04 00 00 */	lbz r0, 0(r4)	/* effective address: 804A4218 */
...
/* 804A3948  D0 03 00 04 */	stfs f0, 4(r3)	/* effective address: 804A418C */
/* 804A394C  C0 1E 00 20 */	lfs f0, 0x20(r30)
/* 804A3950  D0 03 00 08 */	stfs f0, 8(r3)	/* effective address: 804A4190 */
...
/* 804A3990  4B C3 D9 80 */	b getCopyRodBallSpeed__9daAlink_cCFv
/* 804A3994  D0 3F 05 2C */	stfs f1, 0x52c(r31)
/* 804A3998  38 7C 38 34 */	addi r3, r28, 0x3834
/* 804A399C  4B B6 93 C8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 804A39A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804A39A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804A3A24  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A3A28  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804A3A2C  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 804A3A58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A3A5C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804A3A60  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 804A3A98  4B DC 30 9C */	b __mi__4cXyzCFRC3Vec
...
/* 804A3AB8  4B EA 36 80 */	b PSVECSquareMag
...
/* 804A3AD0  4B CB B2 2C */	b clearData__16daPy_actorKeep_cFv
/* 804A3AD4  7F 83 E3 78 */	mr r3, r28
/* 804A3AD8  4B C3 DF 58 */	b returnCopyRod__9daAlink_cFv
...
/* 804A3B00  4B B8 95 6C */	b dComIfGp_getReverb__Fi
...
/* 804A3B14  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804A3B18  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 804A3B1C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 804A3B40  4B E0 7E 44 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 804A3B44  48 00 01 38 */	b lbl_804A3C7C
lbl_804A3B48:
/* 804A3B48  7F E3 FB 78 */	mr r3, r31
/* 804A3B4C  4B B7 61 30 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 804A3B74  4B EA 35 C4 */	b PSVECSquareMag
...
/* 804A3BE4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804A3BE8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 804A3CF0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A3CF4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804A3CF8  38 63 23 3C */	addi r3, r3, 0x233c
/* 804A3CFC  38 9F 05 CC */	addi r4, r31, 0x5cc
/* 804A3D00  4B DC 0E A8 */	b Set__4cCcSFP8cCcD_Obj
/* 804A3D04  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 804A3D08  7C 03 07 74 */	extsb r3, r0
/* 804A3D0C  4B B8 93 60 */	b dComIfGp_getReverb__Fi
...
/* 804A3D20  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804A3D24  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 804A3D28  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 804A3D4C  4B E0 87 C0 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 804A3D84  4B EA 36 18 */	b PSVECSquareDistance
...
/* 804A3DA8  4B B8 92 C4 */	b dComIfGp_getReverb__Fi
...
/* 804A3DBC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804A3DC0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 804A3DC4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 804A3DE8  4B E0 87 24 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 804A3DEC  48 00 01 20 */	b lbl_804A3F0C
lbl_804A3DF0:
/* 804A3DF0  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 804A3DF4  4B BE 05 24 */	b ResetAtHit__12dCcD_GObjInfFv
...
/* 804A3E90  4B EA 2E DC */	b PSMTXMultVec
lbl_804A3E94:
...
/* 804A3EC8  4B B8 91 A4 */	b dComIfGp_getReverb__Fi
...
/* 804A3EDC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 804A3EE0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 804A3EE4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 804A3F08  4B E0 86 04 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_804A3F0C:
...
/* 804A3F40  4B C0 53 08 */	b simpleAnmPlay__9daAlink_cFP10J3DAnmBase
/* 804A3F44  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 804A3F48  4B C0 53 00 */	b simpleAnmPlay__9daAlink_cFP10J3DAnmBase
/* 804A3F4C  38 7F 05 6C */	addi r3, r31, 0x56c
/* 804A3F50  4B B6 94 D8 */	b play__14mDoExt_baseAnmFv
...
/* 804A3F64  4B B6 9A 68 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
...
/* 804A3FA0  4B EB E2 80 */	b _restgpr_27

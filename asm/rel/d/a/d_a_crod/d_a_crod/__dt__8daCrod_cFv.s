...
/* 804A3330  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804A3334  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804A3338  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804A3350  4B D0 45 DC */	b dKy_plight_cut__FP15LIGHT_INFLUENCE
lbl_804A3354:
/* 804A3354  34 1E 05 CC */	addic. r0, r30, 0x5cc
/* 804A3358  41 82 00 7C */	beq lbl_804A33D4
/* 804A335C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cps@ha
/* 804A3360  38 63 C1 70 */	addi r3, r3, __vt__8dCcD_Cps@l
...
/* 804A3380  3C 60 80 3C */	lis r3, __vt__12cCcD_CpsAttr@ha
/* 804A3384  38 63 36 08 */	addi r3, r3, __vt__12cCcD_CpsAttr@l
...
/* 804A339C  4B DC BC 08 */	b __dt__8cM3dGCpsFv
/* 804A33A0  34 1E 06 D0 */	addic. r0, r30, 0x6d0
/* 804A33A4  41 82 00 24 */	beq lbl_804A33C8
/* 804A33A8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 804A33AC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 804A33B0  90 1E 06 EC */	stw r0, 0x6ec(r30)
/* 804A33B4  34 1E 06 D0 */	addic. r0, r30, 0x6d0
/* 804A33B8  41 82 00 10 */	beq lbl_804A33C8
/* 804A33BC  3C 60 80 4A */	lis r3, __vt__8cM3dGAab@ha
/* 804A33C0  38 03 41 FC */	addi r0, r3, __vt__8cM3dGAab@l
/* 804A33C4  90 1E 06 E8 */	stw r0, 0x6e8(r30)
lbl_804A33C8:
/* 804A33C8  38 7E 05 CC */	addi r3, r30, 0x5cc
/* 804A33CC  38 80 00 00 */	li r4, 0
/* 804A33D0  4B BE 0D 14 */	b __dt__12dCcD_GObjInfFv
lbl_804A33D4:
/* 804A33D4  34 1E 05 90 */	addic. r0, r30, 0x590
/* 804A33D8  41 82 00 54 */	beq lbl_804A342C
/* 804A33DC  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 804A33E0  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 804A33F8  3C 60 80 4A */	lis r3, __vt__10dCcD_GStts@ha
/* 804A33FC  38 03 41 F0 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 804A3400  90 1E 05 AC */	stw r0, 0x5ac(r30)
/* 804A3404  34 1E 05 AC */	addic. r0, r30, 0x5ac
/* 804A3408  41 82 00 10 */	beq lbl_804A3418
/* 804A340C  3C 60 80 4A */	lis r3, __vt__10cCcD_GStts@ha
/* 804A3410  38 03 41 E4 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 804A3414  90 1E 05 AC */	stw r0, 0x5ac(r30)
lbl_804A3418:
/* 804A3418  34 1E 05 90 */	addic. r0, r30, 0x590
/* 804A341C  41 82 00 10 */	beq lbl_804A342C
/* 804A3420  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 804A3424  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l

...
/* 805A1B44 00000018  3C 80 80 5A */	lis r4, lit_3708@ha
/* 805A1B48 0000001C  3B E4 1D 94 */	addi r31, r4, lit_3708@l
...
/* 805A1B60 00000034  4B A7 70 04 */	b __ct__10fopAc_ac_cFv
lbl_805A1B64:
...
/* 805A1B78 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A1B7C 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A1B80 00000010  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805A1B84 00000014  7C 05 07 74 */	extsb r5, r0
/* 805A1B88 00000018  4B A9 37 D8 */	b isSwitch__10dSv_info_cCFii
...
/* 805A1BA4 00000034  3C 60 80 5A */	lis r3, lit_3996@ha
/* 805A1BA8 00000038  38 63 1E 94 */	addi r3, r3, lit_3996@l
...
lbl_805A1BBC:
/* 805A1BBC 00000000  38 60 00 05 */	li r3, 5
/* 805A1BC0 00000004  48 00 01 B4 */	b lbl_805A1D74
lbl_805A1BC4:
/* 805A1BC4 00000000  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 805A1BC8 00000004  54 04 06 3E */	clrlwi r4, r0, 0x18
/* 805A1BCC 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A1BD0 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A1BD4 00000010  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 805A1BD8 00000014  7C 05 07 74 */	extsb r5, r0
/* 805A1BDC 00000018  4B A9 36 D4 */	b offSwitch__10dSv_info_cFii
/* 805A1BE0 0000001C  48 00 00 28 */	b lbl_805A1C08
lbl_805A1BE4:
...
/* 805A1C28 00000020  C0 5F 00 04 */	lfs f2, 4(r31)	/* effective address: 805A1D98 */
...
/* 805A1C38 00000030  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 805A1D9C */
...
/* 805A1C64 00000004  C0 5F 00 0C */	lfs f2, 0xc(r31)	/* effective address: 805A1DA0 */
...
/* 805A1C74 00000014  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 805A1D9C */
...
lbl_805A1CB4:
/* 805A1CB4 00000000  C0 3F 00 10 */	lfs f1, 0x10(r31)	/* effective address: 805A1DA4 */
...
/* 805A1CE0 00000004  C0 7F 00 14 */	lfs f3, 0x14(r31)	/* effective address: 805A1DA8 */
...
/* 805A1D24 00000048  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 805A1D98 */
...
lbl_805A1D50:
/* 805A1D50 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A1D54 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 805A1D68 00000018  4B AA 59 30 */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc

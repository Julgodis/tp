...
/* 805A1614  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A1618  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 805A161C  80 64 5D AC */	lwz r3, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 805A170C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A1710  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A1714  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A1718  7C 05 07 74 */	extsb r5, r0
/* 805A171C  4B A9 3C 44 */	b isSwitch__10dSv_info_cCFii
...
/* 805A1738  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A173C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A1740  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A1744  7C 05 07 74 */	extsb r5, r0
/* 805A1748  4B A9 3C 18 */	b isSwitch__10dSv_info_cCFii
...
lbl_805A175C:
/* 805A175C  3C 60 80 5A */	lis r3, stringBase0@ha
/* 805A1760  38 63 1D AC */	addi r3, r3, stringBase0@l
/* 805A1764  7C A4 2B 78 */	mr r4, r5
/* 805A1768  4C C6 31 82 */	crclr 6
/* 805A176C  4B A6 54 A0 */	b OSReport_Error
lbl_805A1770:
...
/* 805A1788  3C 60 80 5A */	lis r3, lit_3812@ha
/* 805A178C  38 63 1D F4 */	addi r3, r3, lit_3812@l
...
/* 805A17B0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A17B4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A17B8  7F C4 F3 78 */	mr r4, r30
/* 805A17BC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805A17C0  7C 05 07 74 */	extsb r5, r0
/* 805A17C4  4B A9 3A 3C */	b onSwitch__10dSv_info_cFii
...
/* 805A17E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A17EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A17F0  7F C4 F3 78 */	mr r4, r30
/* 805A17F4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805A17F8  7C 05 07 74 */	extsb r5, r0
/* 805A17FC  4B A9 3A 04 */	b onSwitch__10dSv_info_cFii
/* 805A1800  38 00 00 01 */	li r0, 1
/* 805A1804  98 1F 05 84 */	stb r0, 0x584(r31)
/* 805A1808  48 00 00 BC */	b lbl_805A18C4
lbl_805A180C:
/* 805A180C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A1810  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A1814  7F C4 F3 78 */	mr r4, r30
/* 805A1818  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805A181C  7C 05 07 74 */	extsb r5, r0
/* 805A1820  4B A9 3A 90 */	b offSwitch__10dSv_info_cFii
...
/* 805A1838  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A183C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A1840  7F C4 F3 78 */	mr r4, r30
/* 805A1844  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805A1848  7C 05 07 74 */	extsb r5, r0
/* 805A184C  4B A9 39 B4 */	b onSwitch__10dSv_info_cFii
...
/* 805A186C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A1870  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A1874  7F C4 F3 78 */	mr r4, r30
/* 805A1878  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805A187C  7C 05 07 74 */	extsb r5, r0
/* 805A1880  4B A9 3A 30 */	b offSwitch__10dSv_info_cFii
...
/* 805A18A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A18A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A18A8  7F C4 F3 78 */	mr r4, r30
/* 805A18AC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805A18B0  7C 05 07 74 */	extsb r5, r0
/* 805A18B4  4B A9 39 FC */	b offSwitch__10dSv_info_cFii

...
/* 805A1460  4B A7 96 34 */	b fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805A147C  3C 60 80 5A */	lis r3, lit_3708@ha
/* 805A1480  C0 03 1D 94 */	lfs f0, lit_3708@l(r3)
...
/* 805A14B4  4B CC 56 80 */	b __mi__4cXyzCFRC3Vec
...
/* 805A14DC  4B CC 56 58 */	b __mi__4cXyzCFRC3Vec
...
/* 805A1504  4B CC 56 30 */	b __mi__4cXyzCFRC3Vec
...
/* 805A1520  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A1524  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A1528  A8 1F 04 DE */	lha r0, 0x4de(r31)
/* 805A152C  7C 00 00 D0 */	neg r0, r0
/* 805A1530  7C 04 07 34 */	extsh r4, r0
/* 805A1534  4B A6 AE A8 */	b mDoMtx_YrotS__FPA4_fs
/* 805A1538  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A153C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A1540  38 81 00 2C */	addi r4, r1, 0x2c
/* 805A1544  7C 85 23 78 */	mr r5, r4
/* 805A1548  4B DA 58 24 */	b PSMTXMultVec

...
/* 8066FF14  4B CF 22 C4 */	b _savegpr_28
...
/* 8066FF60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066FF64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066FF68  A8 1D 04 DE */	lha r0, 0x4de(r29)
/* 8066FF6C  7C 00 00 D0 */	neg r0, r0
/* 8066FF70  7C 04 07 34 */	extsh r4, r0
/* 8066FF74  4B 99 C4 68 */	b mDoMtx_YrotS__FPA4_fs
/* 8066FF78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066FF7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066FF80  38 81 00 14 */	addi r4, r1, 0x14
/* 8066FF84  7C 85 23 78 */	mr r5, r4
/* 8066FF88  4B CD 6D E4 */	b PSMTXMultVec
...
lbl_8066FFC0:
/* 8066FFC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066FFC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066FFC8  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 8066FFCC  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 8066FFD0  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 8066FFD4  4B CD 69 14 */	b PSMTXTrans
/* 8066FFD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066FFDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066FFE0  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8066FFE4  4B 99 C4 50 */	b mDoMtx_YrotM__FPA4_fs
/* 8066FFE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066FFEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066FFF0  38 81 00 14 */	addi r4, r1, 0x14
/* 8066FFF4  7C 85 23 78 */	mr r5, r4
/* 8066FFF8  4B CD 6D 74 */	b PSMTXMultVec
...
/* 80670018  4B CF 22 0C */	b _restgpr_28

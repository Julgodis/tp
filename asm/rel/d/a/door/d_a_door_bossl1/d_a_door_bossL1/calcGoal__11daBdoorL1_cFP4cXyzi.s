...
/* 804E3DF8  4B E7 E3 E0 */	b _savegpr_28
/* 804E3DFC  7C 7D 1B 78 */	mr r29, r3
/* 804E3E00  7C 9E 23 78 */	mr r30, r4
/* 804E3E04  7C BC 2B 78 */	mr r28, r5
/* 804E3E08  3C 60 80 4E */	lis r3, l_staff_name@ha
/* 804E3E0C  3B E3 4A 14 */	addi r31, r3, l_staff_name@l
/* 804E3E10  38 61 00 08 */	addi r3, r1, 8
/* 804E3E14  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 804E3E18  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 804E3E1C  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 804E3E20  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 804E3E24  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 804E3E28  4B D8 2D 0C */	b __mi__4cXyzCFRC3Vec
...
/* 804E3E44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E3E48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E3E4C  A8 1D 04 DE */	lha r0, 0x4de(r29)
/* 804E3E50  7C 00 00 D0 */	neg r0, r0
/* 804E3E54  7C 04 07 34 */	extsh r4, r0
/* 804E3E58  4B B2 85 84 */	b mDoMtx_YrotS__FPA4_fs
/* 804E3E5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E3E60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E3E64  38 81 00 14 */	addi r4, r1, 0x14
/* 804E3E68  7C 85 23 78 */	mr r5, r4
/* 804E3E6C  4B E6 2F 00 */	b PSMTXMultVec
...
lbl_804E3EA4:
/* 804E3EA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E3EA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E3EAC  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 804E3EB0  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 804E3EB4  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 804E3EB8  4B E6 2A 30 */	b PSMTXTrans
/* 804E3EBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E3EC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E3EC4  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 804E3EC8  4B B2 85 6C */	b mDoMtx_YrotM__FPA4_fs
/* 804E3ECC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804E3ED0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804E3ED4  38 81 00 14 */	addi r4, r1, 0x14
/* 804E3ED8  7C 85 23 78 */	mr r5, r4
/* 804E3EDC  4B E6 2E 90 */	b PSMTXMultVec
...
/* 804E3EFC  4B E7 E3 28 */	b _restgpr_28

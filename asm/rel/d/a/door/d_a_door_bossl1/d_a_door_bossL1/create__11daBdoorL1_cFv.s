...
/* 804E28F4  4B E7 F8 E8 */	b _savegpr_29
...
/* 804E2914  4B B3 62 50 */	b __ct__10fopAc_ac_cFv
/* 804E2918  3B BE 05 AC */	addi r29, r30, 0x5ac
/* 804E291C  7F A3 EB 78 */	mr r3, r29
/* 804E2920  4B B9 37 80 */	b __ct__9dBgS_AcchFv
/* 804E2924  3C 60 80 4E */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 804E2928  38 63 50 74 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 804E2944  4B B9 65 24 */	b SetObj__16dBgS_PolyPassChkFv
/* 804E2948  38 7E 07 84 */	addi r3, r30, 0x784
/* 804E294C  4B B9 35 60 */	b __ct__12dBgS_AcchCirFv
lbl_804E2950:
...
/* 804E296C  4B B4 A5 50 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804E298C  4B B4 A5 30 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804E29AC  4B B4 A5 10 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 804E29DC  4B B5 77 F4 */	b getSwbit__13door_param2_cFP10fopAc_ac_c
/* 804E29E0  54 64 06 3E */	clrlwi r4, r3, 0x18
/* 804E29E4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804E29E8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804E29EC  7F C5 F3 78 */	mr r5, r30
/* 804E29F0  4B B5 29 70 */	b isSwitch__10dSv_info_cCFii
/* 804E29F4  2C 03 00 00 */	cmpwi r3, 0
/* 804E29F8  40 82 00 38 */	bne lbl_804E2A30
/* 804E29FC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804E2A00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804E2A04  85 83 4E 20 */	lwzu r12, 0x4e20(r3)	/* effective address: 8040AFE0 */
/* 804E2A08  81 8C 00 BC */	lwz r12, 0xbc(r12)
/* 804E2A0C  7D 89 03 A6 */	mtctr r12
/* 804E2A10  4E 80 04 21 */	bctrl 
/* 804E2A14  80 03 00 0C */	lwz r0, 0xc(r3)	/* effective address: 804061CC */
...
/* 804E2A40  3C 60 80 4E */	lis r3, l_heap_size@ha
/* 804E2A44  38 A3 4A 24 */	addi r5, r3, l_heap_size@l
/* 804E2A48  7F E3 FB 78 */	mr r3, r31
/* 804E2A4C  3C 80 80 4E */	lis r4, CheckCreateHeap__FP10fopAc_ac_c@ha
/* 804E2A50  38 84 22 38 */	addi r4, r4, CheckCreateHeap__FP10fopAc_ac_c@l
/* 804E2A54  7C A5 00 2E */	lwzx r5, r5, r0
/* 804E2A58  4B B3 7A 58 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 804E2A84  4B E7 F7 A4 */	b _restgpr_29

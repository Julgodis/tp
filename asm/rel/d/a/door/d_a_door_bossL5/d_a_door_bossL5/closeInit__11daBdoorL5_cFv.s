...
/* 8067174C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80671750  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80671754  3C A5 00 02 */	addis r5, r5, 2
/* 80671758  38 C0 00 80 */	li r6, 0x80
/* 8067175C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80671760  4B 9C AB 8C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80671774  3C E0 80 67 */	lis r7, lit_3757@ha
/* 80671778  C0 27 25 0C */	lfs f1, lit_3757@l(r7)
/* 8067177C  38 E0 00 00 */	li r7, 0
/* 80671780  39 00 FF FF */	li r8, -1
/* 80671784  39 20 00 01 */	li r9, 1
/* 80671788  4B 99 C0 54 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 8067178C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80671790  7C 03 07 74 */	extsb r3, r0
/* 80671794  4B 9B B8 D8 */	b dComIfGp_getReverb__Fi
...
/* 806717A8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806717AC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806717B0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 806717B4  38 81 00 08 */	addi r4, r1, 8
/* 806717B8  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 806717BC  38 C0 00 00 */	li r6, 0
/* 806717C0  3D 00 80 67 */	lis r8, lit_3757@ha
/* 806717C4  C0 28 25 0C */	lfs f1, lit_3757@l(r8)
/* 806717C8  FC 40 08 90 */	fmr f2, f1
/* 806717CC  3D 00 80 67 */	lis r8, lit_3981@ha
/* 806717D0  C0 68 25 18 */	lfs f3, lit_3981@l(r8)
/* 806717D4  FC 80 18 90 */	fmr f4, f3
/* 806717D8  39 00 00 00 */	li r8, 0
/* 806717DC  4B C3 A1 A8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

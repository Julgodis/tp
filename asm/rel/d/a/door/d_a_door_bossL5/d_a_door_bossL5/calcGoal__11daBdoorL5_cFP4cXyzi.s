...
/* 80671964  4B CF 08 74 */	b _savegpr_28
...
/* 806719B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806719B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806719B8  A8 1D 04 DE */	lha r0, 0x4de(r29)
/* 806719BC  7C 00 00 D0 */	neg r0, r0
/* 806719C0  7C 04 07 34 */	extsh r4, r0
/* 806719C4  4B 99 AA 18 */	b mDoMtx_YrotS__FPA4_fs
/* 806719C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806719CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806719D0  38 81 00 14 */	addi r4, r1, 0x14
/* 806719D4  7C 85 23 78 */	mr r5, r4
/* 806719D8  4B CD 53 94 */	b PSMTXMultVec
...
lbl_80671A10:
/* 80671A10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80671A14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80671A18  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 80671A1C  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 80671A20  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 80671A24  4B CD 4E C4 */	b PSMTXTrans
/* 80671A28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80671A2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80671A30  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 80671A34  4B 99 AA 00 */	b mDoMtx_YrotM__FPA4_fs
/* 80671A38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80671A3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80671A40  38 81 00 14 */	addi r4, r1, 0x14
/* 80671A44  7C 85 23 78 */	mr r5, r4
/* 80671A48  4B CD 53 24 */	b PSMTXMultVec
...
/* 80671A68  4B CF 07 BC */	b _restgpr_28

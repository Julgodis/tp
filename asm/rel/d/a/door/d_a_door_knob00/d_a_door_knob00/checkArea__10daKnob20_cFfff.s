...
/* 8045F080  4B F0 31 5C */	b _savegpr_29
...
/* 8045F0B4  4B E0 7A 80 */	b __mi__4cXyzCFRC3Vec
...
/* 8045F0D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045F0D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045F0D8  A8 1E 04 DE */	lha r0, 0x4de(r30)
/* 8045F0DC  7C 00 00 D0 */	neg r0, r0
/* 8045F0E0  7C 04 07 34 */	extsh r4, r0
/* 8045F0E4  4B BA D2 F8 */	b mDoMtx_YrotS__FPA4_fs
/* 8045F0E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045F0EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045F0F0  38 81 00 18 */	addi r4, r1, 0x18
/* 8045F0F4  7C 85 23 78 */	mr r5, r4
/* 8045F0F8  4B EE 7C 74 */	b PSMTXMultVec
/* 8045F0FC  38 61 00 18 */	addi r3, r1, 0x18
/* 8045F100  4B EE 80 38 */	b PSVECSquareMag
...
/* 8045F170  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8045F174  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8045F1E0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8045F1E4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8045F1E8:
...
/* 8045F288  4B F0 2F A0 */	b _restgpr_29

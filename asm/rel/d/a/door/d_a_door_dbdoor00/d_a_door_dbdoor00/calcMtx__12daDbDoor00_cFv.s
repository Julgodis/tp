...
/* 8045D75C 00000018  3C 60 00 00 */	lis r3, lit_3806@ha
/* 8045D760 0000001C  3B E3 00 00 */	addi r31, r3, lit_3806@l
/* 8045D764 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D768 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D77C 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D780 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045D784 00000040  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 8045D788 00000044  4B FF FB D1 */	bl mDoMtx_YrotM__FPA4_fs
/* 8045D78C 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D790 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D7A0 0000005C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D7A4 00000060  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D7C8 00000084  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D7CC 00000088  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D7F0 000000AC  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D7F4 000000B0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D814 000000D0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D818 000000D4  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D83C 000000F8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D840 000000FC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D860 0000011C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D864 00000120  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D884 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D888 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D8A4 00000030  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D8A8 00000034  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8045D8C8 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D8CC 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

...
/* 8045DAC0 00000010  4B FF F8 99 */	bl _savegpr_26
/* 8045DAC4 00000014  7C 7A 1B 78 */	mr r26, r3
/* 8045DAC8 00000018  3C 80 00 00 */	lis r4, lit_3806@ha
/* 8045DACC 0000001C  3B A4 00 00 */	addi r29, r4, lit_3806@l
/* 8045DAD0 00000020  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 8045DAD4 00000024  3B C4 00 00 */	addi r30, r4, g_dComIfG_gameInfo@l
/* 8045DAD8 00000028  83 7E 5D AC */	lwz r27, 0x5dac(r30)
/* 8045DADC 0000002C  4B FF FF 8D */	bl getDemoAction__12daDbDoor00_cFv
/* 8045DAE0 00000030  7C 7F 1B 78 */	mr r31, r3
/* 8045DAE4 00000034  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8045DAE8 00000038  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8045DAF8 00000048  4B FF F8 61 */	bl getIsAddvance__16dEvent_manager_cFi
...
/* 8045DB0C 0000005C  3C 60 00 00 */	lis r3, lit_3957@ha
/* 8045DB10 00000060  38 63 00 00 */	addi r3, r3, lit_3957@l
...
/* 8045DB24 00000074  7F 43 D3 78 */	mr r3, r26
/* 8045DB28 00000078  4B FF FC 1D */	bl calcMtx__12daDbDoor00_cFv
/* 8045DB2C 0000007C  C0 1A 05 9C */	lfs f0, 0x59c(r26)
/* 8045DB30 00000080  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8045DB34 00000084  C0 1A 05 A0 */	lfs f0, 0x5a0(r26)
/* 8045DB38 00000088  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8045DB3C 0000008C  C0 1A 05 A4 */	lfs f0, 0x5a4(r26)
/* 8045DB40 00000090  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8045DB44 00000094  7F 83 E3 78 */	mr r3, r28
/* 8045DB48 00000098  38 81 00 10 */	addi r4, r1, 0x10
/* 8045DB4C 0000009C  4B FF F8 0D */	bl setGoal__16dEvent_manager_cFP4cXyz
/* 8045DB50 000000A0  48 00 01 04 */	b lbl_8045DC54
/* 8045DB54 000000A4  A8 7A 04 DE */	lha r3, 0x4de(r26)
/* 8045DB58 000000A8  38 03 7F FF */	addi r0, r3, 0x7fff
/* 8045DB5C 000000AC  B0 01 00 08 */	sth r0, 8(r1)
/* 8045DB60 000000B0  B0 1B 06 06 */	sth r0, 0x606(r27)
/* 8045DB64 000000B4  48 00 00 F0 */	b lbl_8045DC54
/* 8045DB68 000000B8  38 00 00 00 */	li r0, 0
/* 8045DB6C 000000BC  B0 1A 05 8C */	sth r0, 0x58c(r26)
/* 8045DB70 000000C0  38 00 00 1E */	li r0, 0x1e
/* 8045DB74 000000C4  B0 1A 05 C2 */	sth r0, 0x5c2(r26)
/* 8045DB78 000000C8  88 1A 04 E2 */	lbz r0, 0x4e2(r26)
/* 8045DB7C 000000CC  7C 03 07 74 */	extsb r3, r0
/* 8045DB80 000000D0  4B FF F7 D9 */	bl dComIfGp_getReverb__Fi
/* 8045DB84 000000D4  7C 67 1B 78 */	mr r7, r3
/* 8045DB88 000000D8  3C 60 00 08 */	lis r3, 0x0008 /* 0x0008009C@ha */
/* 8045DB8C 000000DC  38 03 00 9C */	addi r0, r3, 0x009C /* 0x0008009C@l */
/* 8045DB90 000000E0  90 01 00 0C */	stw r0, 0xc(r1)
/* 8045DB94 000000E4  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8045DB98 000000E8  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8045DB9C 000000EC  80 63 00 00 */	lwz r3, 0(r3)
/* 8045DBA0 000000F0  38 81 00 0C */	addi r4, r1, 0xc
/* 8045DBA4 000000F4  38 BA 05 38 */	addi r5, r26, 0x538
/* 8045DBA8 000000F8  38 C0 00 00 */	li r6, 0
/* 8045DBAC 000000FC  C0 3D 00 1C */	lfs f1, 0x1c(r29)
/* 8045DBB0 00000100  FC 40 08 90 */	fmr f2, f1
/* 8045DBB4 00000104  C0 7D 00 20 */	lfs f3, 0x20(r29)
/* 8045DBB8 00000108  FC 80 18 90 */	fmr f4, f3
/* 8045DBBC 0000010C  39 00 00 00 */	li r8, 0
/* 8045DBC0 00000110  4B FF F7 99 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8045DBC4 00000114  48 00 00 90 */	b lbl_8045DC54
/* 8045DBC8 00000118  C0 1A 05 A8 */	lfs f0, 0x5a8(r26)
/* 8045DBCC 0000011C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8045DBD0 00000120  C0 1A 05 AC */	lfs f0, 0x5ac(r26)
/* 8045DBD4 00000124  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8045DBD8 00000128  C0 1A 05 B0 */	lfs f0, 0x5b0(r26)
/* 8045DBDC 0000012C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8045DBE0 00000130  7F 83 E3 78 */	mr r3, r28
/* 8045DBE4 00000134  38 81 00 10 */	addi r4, r1, 0x10
/* 8045DBE8 00000138  4B FF F7 71 */	bl setGoal__16dEvent_manager_cFP4cXyz
/* 8045DBEC 0000013C  48 00 00 68 */	b lbl_8045DC54
/* 8045DBF0 00000140  C0 1A 05 B4 */	lfs f0, 0x5b4(r26)
/* 8045DBF4 00000144  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8045DBF8 00000148  C0 1A 05 B8 */	lfs f0, 0x5b8(r26)
/* 8045DBFC 0000014C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8045DC00 00000150  C0 1A 05 BC */	lfs f0, 0x5bc(r26)
/* 8045DC04 00000154  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8045DC08 00000158  7F 83 E3 78 */	mr r3, r28
/* 8045DC0C 0000015C  38 81 00 10 */	addi r4, r1, 0x10
/* 8045DC10 00000160  4B FF F7 49 */	bl setGoal__16dEvent_manager_cFP4cXyz
/* 8045DC14 00000164  48 00 00 40 */	b lbl_8045DC54
/* 8045DC18 00000168  7F 43 D3 78 */	mr r3, r26
/* 8045DC1C 0000016C  4B FF FB 29 */	bl calcMtx__12daDbDoor00_cFv
/* 8045DC20 00000170  38 00 00 00 */	li r0, 0
/* 8045DC24 00000174  B0 1A 05 90 */	sth r0, 0x590(r26)
/* 8045DC28 00000178  7F 83 E3 78 */	mr r3, r28
/* 8045DC2C 0000017C  80 9A 05 98 */	lwz r4, 0x598(r26)
/* 8045DC30 00000180  3C A0 00 00 */	lis r5, stringBase0@ha
/* 8045DC34 00000184  38 A5 00 00 */	addi r5, r5, stringBase0@l
/* 8045DC38 00000188  38 A5 00 B8 */	addi r5, r5, 0xb8
/* 8045DC3C 0000018C  38 C0 00 03 */	li r6, 3
/* 8045DC40 00000190  4B FF F7 19 */	bl getMySubstanceP__16dEvent_manager_cFiPCci
/* 8045DC44 00000194  28 03 00 00 */	cmplwi r3, 0
/* 8045DC48 00000198  41 82 00 0C */	beq lbl_8045DC54
/* 8045DC4C 0000019C  80 03 00 00 */	lwz r0, 0(r3)
/* 8045DC50 000001A0  B0 1A 05 90 */	sth r0, 0x590(r26)
lbl_8045DC54:
...
/* 8045DCB4 00000024  4B FF F6 A5 */	bl cutEnd__16dEvent_manager_cFi
...
/* 8045DD30 00000030  83 7E 5D AC */	lwz r27, 0x5dac(r30)
/* 8045DD34 00000034  7F 43 D3 78 */	mr r3, r26
/* 8045DD38 00000038  4B FF F6 21 */	bl getExitNo__13door_param2_cFP10fopAc_ac_c
...
/* 8045DD8C 00000020  4B FF F5 CD */	bl cLib_addCalcAngleS2__FPssss
...
/* 8045DDA8 0000003C  C0 7D 00 24 */	lfs f3, 0x24(r29)
/* 8045DDAC 00000040  EC 23 00 72 */	fmuls f1, f3, f1
/* 8045DDB0 00000044  C0 5D 00 28 */	lfs f2, 0x28(r29)
...
/* 8045DE18 00000008  4B FF F5 41 */	bl cutEnd__16dEvent_manager_cFi
...
/* 8045DE28 00000008  4B FF F5 31 */	bl cutEnd__16dEvent_manager_cFi
lbl_8045DE2C:
/* 8045DE2C 00000000  39 61 00 40 */	addi r11, r1, 0x40
/* 8045DE30 00000004  4B FF F5 29 */	bl _restgpr_26

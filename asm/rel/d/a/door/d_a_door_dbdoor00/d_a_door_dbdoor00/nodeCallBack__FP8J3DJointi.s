...
/* 8045D388  4B F0 4E 50 */	b _savegpr_28
...
/* 8045D3B8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8045D3BC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8045D3C0  4B EE 90 F0 */	b PSMTXCopy
...
/* 8045D3E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D3E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045D3E8  A8 1D 05 8A */	lha r0, 0x58a(r29)
/* 8045D3EC  7C 00 00 D0 */	neg r0, r0
/* 8045D3F0  7C 04 07 34 */	extsh r4, r0
/* 8045D3F4  4B BA F0 40 */	b mDoMtx_YrotM__FPA4_fs
...
/* 8045D418  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D41C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045D420  A8 9D 05 8A */	lha r4, 0x58a(r29)
/* 8045D424  4B BA F0 10 */	b mDoMtx_YrotM__FPA4_fs
lbl_8045D428:
/* 8045D428  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D42C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045D430  80 9F 00 84 */	lwz r4, 0x84(r31)
/* 8045D434  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8045D438  7C 80 F2 14 */	add r4, r0, r30
/* 8045D43C  4B EE 90 74 */	b PSMTXCopy
/* 8045D440  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045D444  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045D448  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 8045D44C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 8045D450  4B EE 90 60 */	b PSMTXCopy
lbl_8045D454:
/* 8045D454  38 60 00 01 */	li r3, 1
/* 8045D458  39 61 00 20 */	addi r11, r1, 0x20
/* 8045D45C  4B F0 4D C8 */	b _restgpr_28

...
/* 80678BD4 00000014  3C 60 00 00 */	lis r3, lit_3688@ha /* 80678ECC */
/* 80678BD8 00000018  38 63 00 00 */	addi r3, r3, lit_3688@l /* 80678ECC */
...
/* 80678BE8 00000028  C0 03 00 40 */	lfs f0, 0x40(r3)
/* 80678BEC 0000002C  D0 01 00 08 */	stfs f0, 8(r1)
/* 80678BF0 00000030  C0 03 00 04 */	lfs f0, 4(r3)
/* 80678BF4 00000034  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80678BF8 00000038  C0 03 00 44 */	lfs f0, 0x44(r3)
/* 80678BFC 0000003C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80678C00 00000040  48 00 00 1C */	b lbl_80678C1C
lbl_80678C04:
/* 80678C04 00000000  C0 03 00 48 */	lfs f0, 0x48(r3)
/* 80678C08 00000004  D0 01 00 08 */	stfs f0, 8(r1)
/* 80678C0C 00000008  C0 03 00 04 */	lfs f0, 4(r3)
/* 80678C10 0000000C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80678C14 00000010  C0 03 00 44 */	lfs f0, 0x44(r3)
/* 80678C18 00000014  D0 01 00 10 */	stfs f0, 0x10(r1)
lbl_80678C1C:
/* 80678C1C 00000000  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80678C20 00000004  4B FF F1 79 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80678C24 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80678C28 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80678C2C 00000010  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 80678C30 00000014  4B FF F1 69 */	bl mDoMtx_YrotM__FPA4_fs
/* 80678C34 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80678C38 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80678C3C 00000020  38 81 00 08 */	addi r4, r1, 8
/* 80678C40 00000024  7C 85 23 78 */	mr r5, r4
/* 80678C44 00000028  4B FF F1 55 */	bl PSMTXMultVec
/* 80678C48 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80678C4C 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80678C50 00000034  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80678C54 00000038  38 81 00 08 */	addi r4, r1, 8
/* 80678C58 0000003C  4B FF F1 41 */	bl setGoal__16dEvent_manager_cFP4cXyz

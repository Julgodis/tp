...
/* 8067365C  4B 99 97 08 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80673660  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80673664  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673668  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 8067366C  4B 99 8D C8 */	b mDoMtx_YrotM__FPA4_fs
/* 80673670  88 1F 05 DF */	lbz r0, 0x5df(r31)
/* 80673674  28 00 00 00 */	cmplwi r0, 0
/* 80673678  40 82 00 14 */	bne lbl_8067368C
/* 8067367C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80673680  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673684  38 80 7F FF */	li r4, 0x7fff
/* 80673688  4B 99 8D AC */	b mDoMtx_YrotM__FPA4_fs
lbl_8067368C:
/* 8067368C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80673690  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673694  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 80673698  38 84 00 24 */	addi r4, r4, 0x24
/* 8067369C  4B CD 2E 14 */	b PSMTXCopy
/* 806736A0  48 00 00 DC */	b lbl_8067377C
lbl_806736A4:
/* 806736A4  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 806736A8  4B 99 96 BC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 806736AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806736B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806736B4  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 806736B8  4B 99 8D 7C */	b mDoMtx_YrotM__FPA4_fs
/* 806736BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806736C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806736C4  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 806736C8  38 84 00 24 */	addi r4, r4, 0x24
/* 806736CC  4B CD 2D E4 */	b PSMTXCopy
/* 806736D0  48 00 00 AC */	b lbl_8067377C
lbl_806736D4:
/* 806736D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806736D8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806736DC  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 806736E0  4B 99 8C FC */	b mDoMtx_YrotS__FPA4_fs
/* 806736E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806736E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806736EC  38 81 00 14 */	addi r4, r1, 0x14
/* 806736F0  7C 85 23 78 */	mr r5, r4
/* 806736F4  4B CD 36 78 */	b PSMTXMultVec
/* 806736F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806736FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673700  38 81 00 08 */	addi r4, r1, 8
/* 80673704  7C 85 23 78 */	mr r5, r4
/* 80673708  4B CD 36 64 */	b PSMTXMultVec
/* 8067370C  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80673710  4B 99 96 54 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80673714  38 61 00 14 */	addi r3, r1, 0x14
/* 80673718  4B 99 96 BC */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 8067371C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80673720  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673724  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 80673728  4B 99 8D 0C */	b mDoMtx_YrotM__FPA4_fs
/* 8067372C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80673730  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673734  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 80673738  38 84 00 24 */	addi r4, r4, 0x24
/* 8067373C  4B CD 2D 74 */	b PSMTXCopy
/* 80673740  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80673744  4B 99 96 20 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80673748  38 61 00 08 */	addi r3, r1, 8
/* 8067374C  4B 99 96 88 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80673750  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80673754  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673758  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 8067375C  38 04 7F FF */	addi r0, r4, 0x7fff
/* 80673760  7C 04 07 34 */	extsh r4, r0
/* 80673764  4B 99 8C D0 */	b mDoMtx_YrotM__FPA4_fs
/* 80673768  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8067376C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80673770  80 9F 05 84 */	lwz r4, 0x584(r31)
/* 80673774  38 84 00 24 */	addi r4, r4, 0x24
/* 80673778  4B CD 2D 38 */	b PSMTXCopy
lbl_8067377C:

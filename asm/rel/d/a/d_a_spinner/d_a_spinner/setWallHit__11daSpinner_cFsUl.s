...
/* 804D3184  4B E8 F0 4C */	b _savegpr_26
/* 804D3188  7C 7B 1B 78 */	mr r27, r3
/* 804D318C  7C 9A 23 78 */	mr r26, r4
/* 804D3190  7C BC 2B 78 */	mr r28, r5
/* 804D3194  3C 80 80 4D */	lis r4, lit_3768@ha
/* 804D3198  3B E4 4D 90 */	addi r31, r4, lit_3768@l
...
/* 804D31C8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804D31CC  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 804D320C  4B BA 4B 58 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 804D3210  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804D3214  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804D3218  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 804D321C  7F C3 F3 78 */	mr r3, r30
/* 804D3220  38 9B 08 24 */	addi r4, r27, 0x824
/* 804D3224  4B BA 11 90 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 804D3228  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804D322C  41 82 01 70 */	beq lbl_804D339C
/* 804D3230  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804D3234  38 03 4F 3C */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804D3248  4B BA 14 FC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 804D3260  4B D9 44 14 */	b cM_atan2s__Fff
...
/* 804D3284  4B E7 3E B4 */	b PSVECSquareMag
...
/* 804D32F4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804D32F8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 804D3364  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804D3368  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 804D336C  48 00 00 08 */	b lbl_804D3374
lbl_804D3370:
/* 804D3370  FC 40 08 90 */	fmr f2, f1
lbl_804D3374:
/* 804D3374  C0 21 00 48 */	lfs f1, 0x48(r1)
/* 804D3378  4B D9 42 FC */	b cM_atan2s__Fff
...
/* 804D338C  3C 60 80 4D */	lis r3, __vt__8cM3dGPla@ha
/* 804D3390  38 03 4F 3C */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 804D33C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804D33C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804D33CC  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804D33E8  4B DF 14 2C */	b startHitItemSE__14Z2CreatureLinkFUlUlP14Z2SoundObjBasef
...
/* 804D3424  4B B9 C6 00 */	b StartShock__12dVibration_cFii4cXyz
/* 804D3428  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804D342C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804D3430  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 804D344C  4B B7 8D CC */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
lbl_804D3450:
/* 804D3450  39 61 00 70 */	addi r11, r1, 0x70
/* 804D3454  4B E8 ED C8 */	b _restgpr_26

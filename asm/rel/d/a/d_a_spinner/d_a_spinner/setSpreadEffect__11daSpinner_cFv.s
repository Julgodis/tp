...
/* 804D3D70  4B E8 E4 60 */	b _savegpr_26
/* 804D3D74  7C 7B 1B 78 */	mr r27, r3
/* 804D3D78  3C 60 80 4D */	lis r3, lit_3768@ha
/* 804D3D7C  3B C3 4D 90 */	addi r30, r3, lit_3768@l
/* 804D3D80  3B BB 0A 8C */	addi r29, r27, 0xa8c
/* 804D3D84  80 7B 05 68 */	lwz r3, 0x568(r27)
/* 804D3D88  38 63 00 24 */	addi r3, r3, 0x24
/* 804D3D8C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 804D3D90  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 804D3D94  4B E7 27 1C */	b PSMTXCopy
/* 804D3D98  88 1B 0A 76 */	lbz r0, 0xa76(r27)
/* 804D3D9C  7C 00 07 75 */	extsb. r0, r0
/* 804D3DA0  40 80 00 14 */	bge lbl_804D3DB4
/* 804D3DA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D3DA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804D3DAC  38 80 7F FF */	li r4, 0x7fff
/* 804D3DB0  4B B3 85 EC */	b mDoMtx_XrotM__FPA4_fs
lbl_804D3DB4:
...
/* 804D3EB4  4B B7 96 18 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804D3EC8  4B B7 7A 50 */	b getEmitter__Q213dPa_control_c7level_cFUl
/* 804D3ECC  7C 65 1B 79 */	or. r5, r3, r3
/* 804D3ED0  41 82 00 18 */	beq lbl_804D3EE8
/* 804D3ED4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804D3ED8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804D3EDC  38 85 00 68 */	addi r4, r5, 0x68
/* 804D3EE0  38 A5 00 A4 */	addi r5, r5, 0xa4
/* 804D3EE4  4B DA C8 FC */	b func_802807E0
lbl_804D3EE8:
...
/* 804D3F00  4B E8 E3 1C */	b _restgpr_26

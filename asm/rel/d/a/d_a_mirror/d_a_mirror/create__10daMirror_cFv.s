...
/* 80872084 00000018  3C 60 00 00 */	lis r3, lit_3884@ha
/* 80872088 0000001C  3B C3 00 00 */	addi r30, r3, lit_3884@l
...
/* 8087209C 00000030  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 808720A0 00000034  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_808720C0:
/* 808720C0 00000000  3C 60 00 00 */	lis r3, m_myObj__10daMirror_c@ha
/* 808720C4 00000004  80 03 00 00 */	lwz r0, m_myObj__10daMirror_c@l(r3)
...
lbl_808720F8:
/* 808720F8 00000000  3C 80 00 00 */	lis r4, l_arcName@ha
/* 808720FC 00000004  38 84 00 00 */	addi r4, r4, l_arcName@l
...
/* 80872118 00000004  3C 80 00 00 */	lis r4, daMirror_c_createHeap__FP10fopAc_ac_c@ha
/* 8087211C 00000008  38 84 00 00 */	addi r4, r4, daMirror_c_createHeap__FP10fopAc_ac_c@l
...
/* 80872140 00000008  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80872144 0000000C  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80872148 00000010  80 63 00 00 */	lwz r3, 0(r3)
/* 8087214C 00000014  38 80 00 07 */	li r4, 7
/* 80872150 00000018  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80872154 0000001C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 808721AC 00000024  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 808721B0 00000028  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 808721B4 0000002C  7C 85 23 78 */	mr r5, r4
/* 808721B8 00000030  4B FF E9 E1 */	bl PSMTXConcat
/* 808721BC 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808721C0 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_80872234:
/* 80872234 00000000  3C 80 00 00 */	lis r4, l_arcName2@ha
/* 80872238 00000004  38 84 00 00 */	addi r4, r4, l_arcName2@l
...
lbl_80872250:
/* 80872250 00000000  3C 60 00 00 */	lis r3, l_arcName2@ha
/* 80872254 00000004  38 63 00 00 */	addi r3, r3, l_arcName2@l
/* 80872258 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 8087225C 0000000C  38 80 00 25 */	li r4, 0x25
/* 80872260 00000010  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80872264 00000014  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
lbl_8087229C:
/* 8087229C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808722A0 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 808722B4 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808722B8 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808722BC 00000020  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 808722C0 00000024  4B FF E8 D9 */	bl mDoMtx_YrotM__FPA4_fs
/* 808722C4 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808722C8 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 808722E4 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 808722E8 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 808722EC 00000050  3C 80 00 00 */	lis r4, data_8087260C@ha
/* 808722F0 00000054  38 84 00 00 */	addi r4, r4, data_8087260C@l
...
lbl_80872300:
/* 80872300 00000000  3C 60 00 00 */	lis r3, m_myObj__10daMirror_c@ha
/* 80872304 00000004  93 E3 00 00 */	stw r31, m_myObj__10daMirror_c@l(r3)
/* 80872308 00000008  38 7F 05 70 */	addi r3, r31, 0x570
/* 8087230C 0000000C  4B FF E9 95 */	bl calcMinMax__16dMirror_packet_cFv
/* 80872310 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80872314 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80872318 00000018  3C 80 00 00 */	lis r4, data_8087263C@ha
/* 8087231C 0000001C  38 84 00 00 */	addi r4, r4, data_8087263C@l

...
/* 808723FC  3C 80 80 45 */	lis r4, m_myObj__10daMirror_c@ha
/* 80872400  80 04 0D A8 */	lwz r0, m_myObj__10daMirror_c@l(r4)
...
/* 80872424  4B 7A 78 58 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80872428:
/* 80872428  38 60 00 01 */	li r3, 1
/* 8087242C  48 00 00 7C */	b lbl_808724A8
lbl_80872430:
/* 80872430  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80872434  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80872438  83 E3 5D B4 */	lwz r31, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 8087243C  C0 3E 06 F0 */	lfs f1, 0x6f0(r30)
/* 80872440  3C 60 80 87 */	lis r3, lit_3945@ha
/* 80872444  C0 03 25 98 */	lfs f0, lit_3945@l(r3)
...
/* 80872474  4B 7A 84 A0 */	b fopAcM_searchActorDistance2__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80872478  3C 60 80 87 */	lis r3, lit_4574@ha
/* 8087247C  C0 03 26 4C */	lfs f0, lit_4574@l(r3)
...
/* 80872490  4B 7A 83 0C */	b fopAcM_seenActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80872494  2C 03 40 00 */	cmpwi r3, 0x4000
/* 80872498  40 80 00 0C */	bge lbl_808724A4
/* 8087249C  38 7E 05 38 */	addi r3, r30, 0x538
/* 808724A0  4B 8E D0 50 */	b setLookPos__9daPy_py_cFP4cXyz
lbl_808724A4:

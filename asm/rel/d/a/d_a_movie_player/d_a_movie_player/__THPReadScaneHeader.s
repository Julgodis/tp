lbl_80873088:
/* 80873088  3C 60 80 88 */	lis r3, __THPInfo@ha
/* 8087308C  38 A3 9B C4 */	addi r5, r3, __THPInfo@l
/* 80873090  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80879BC4 */
/* 80873094  80 64 06 9C */	lwz r3, 0x69c(r4)
/* 80873098  38 03 00 02 */	addi r0, r3, 2
/* 8087309C  90 04 06 9C */	stw r0, 0x69c(r4)
/* 808730A0  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80879BC4 */
...
/* 80873160  3C 60 80 88 */	lis r3, __THPInfo@ha
/* 80873164  38 A3 9B C4 */	addi r5, r3, __THPInfo@l
/* 80873168  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80879BC4 */
/* 8087316C  80 64 06 9C */	lwz r3, 0x69c(r4)
/* 80873170  38 03 00 03 */	addi r0, r3, 3
/* 80873174  90 04 06 9C */	stw r0, 0x69c(r4)
/* 80873178  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80879BC4 */
...
/* 80873194  80 65 00 00 */	lwz r3, 0(r5)	/* effective address: 80879BC4 */
/* 80873198  B0 03 06 84 */	sth r0, 0x684(r3)
/* 8087319C  80 65 00 00 */	lwz r3, 0(r5)	/* effective address: 80879BC4 */
/* 808731A0  B0 03 06 8A */	sth r0, 0x68a(r3)
/* 808731A4  80 65 00 00 */	lwz r3, 0(r5)	/* effective address: 80879BC4 */

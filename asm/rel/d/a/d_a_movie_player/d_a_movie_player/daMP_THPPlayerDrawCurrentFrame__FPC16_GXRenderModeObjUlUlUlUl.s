...
/* 80878448  4B AE 9D 8C */	b _savegpr_27
/* 8087844C  7C 9B 23 78 */	mr r27, r4
/* 80878450  7C BC 2B 78 */	mr r28, r5
/* 80878454  7C DD 33 78 */	mr r29, r6
/* 80878458  7C FE 3B 78 */	mr r30, r7
/* 8087845C  3C 80 80 88 */	lis r4, daMP_ActivePlayer@ha
/* 80878460  3B E4 9B D0 */	addi r31, r4, daMP_ActivePlayer@l
/* 80878464  80 1F 00 A0 */	lwz r0, 0xa0(r31)	/* effective address: 80879C70 */
...
/* 808784AC  3D 00 80 88 */	lis r8, daMP_ActivePlayer@ha
/* 808784B0  39 28 9B D0 */	addi r9, r8, daMP_ActivePlayer@l
/* 808784B4  80 09 00 80 */	lwz r0, 0x80(r9)	/* effective address: 80879C50 */
/* 808784B8  7C 08 07 34 */	extsh r8, r0
/* 808784BC  80 09 00 84 */	lwz r0, 0x84(r9)	/* effective address: 80879C54 */
...
/* 808784D8  3C 60 80 88 */	lis r3, daMP_ActivePlayer@ha
/* 808784DC  38 63 9B D0 */	addi r3, r3, daMP_ActivePlayer@l
/* 808784E0  80 03 00 C0 */	lwz r0, 0xc0(r3)	/* effective address: 80879C90 */
/* 808784E4  7C 84 02 14 */	add r4, r4, r0
/* 808784E8  80 63 00 50 */	lwz r3, 0x50(r3)	/* effective address: 80879C20 */
...
/* 80878504  3C 60 80 88 */	lis r3, lit_4811@ha
/* 80878508  C0 23 91 04 */	lfs f1, lit_4811@l(r3)
...
/* 80878520  4B AE 9D 00 */	b _restgpr_27

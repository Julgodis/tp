...
/* 80875B2C 00000014  3C 60 00 00 */	lis r3, lit_1109@ha
/* 80875B30 00000018  3B E3 00 00 */	addi r31, r3, lit_1109@l
/* 80875B34 0000001C  38 7F 08 E0 */	addi r3, r31, 0x8e0
/* 80875B38 00000020  3C 80 00 00 */	lis r4, daMP_Reader__FPv@ha
/* 80875B3C 00000024  38 84 00 00 */	addi r4, r4, daMP_Reader__FPv@l
...
/* 80875B54 0000003C  4B FF CB E5 */	bl OSCreateThread
/* 80875B58 00000040  2C 03 00 00 */	cmpwi r3, 0
/* 80875B5C 00000044  40 82 00 1C */	bne lbl_80875B78
/* 80875B60 00000048  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80875B64 0000004C  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80875B68 00000050  4C C6 31 82 */	crclr 6
/* 80875B6C 00000054  4B FF CB CD */	bl OSReport
...
/* 80875B84 0000000C  4B FF CB B5 */	bl OSInitMessageQueue
...
/* 80875B94 0000001C  4B FF CB A5 */	bl OSInitMessageQueue
...
/* 80875BA4 0000002C  4B FF CB 95 */	bl OSInitMessageQueue

...
/* 80636EBC 0000000C  3C 80 80 64 */	lis r4, lit_3788@ha
/* 80636EC0 00000010  3B E4 97 F4 */	addi r31, r4, lit_3788@l
/* 80636EC4 00000014  C0 43 0F 4C */	lfs f2, 0xf4c(r3)
/* 80636EC8 00000018  C0 1F 00 E8 */	lfs f0, 0xe8(r31)	/* effective address: 806398DC */
...
lbl_80636ED8:
/* 80636ED8 00000000  C0 3F 02 18 */	lfs f1, 0x218(r31)	/* effective address: 80639A0C */
/* 80636EDC 00000004  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 80639830 */
...
/* 80636EF4 0000001C  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 80639824 */
...
/* 80636F04 0000002C  4B D1 02 34 */	b PSVECSquareMag
/* 80636F08 00000030  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 80639824 */
...
/* 80636F18 00000008  C8 9F 01 40 */	lfd f4, 0x140(r31)	/* effective address: 80639934 */
/* 80636F1C 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80636F20 00000010  C8 7F 01 48 */	lfd f3, 0x148(r31)	/* effective address: 8063993C */
...
lbl_80636F68:
/* 80636F68 00000000  C8 1F 01 50 */	lfd f0, 0x150(r31)	/* effective address: 80639944 */
/* 80636F6C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80636F70 00000000  40 80 00 10 */	bge lbl_80636F80
/* 80636F74 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80636F78 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80636FE4 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80636FE8 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80636FEC:
...
/* 80636FFC 0000000C  4B C3 06 78 */	b cM_atan2s__Fff
/* 80637000 00000010  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 80637004 00000014  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80637008 00000018  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l

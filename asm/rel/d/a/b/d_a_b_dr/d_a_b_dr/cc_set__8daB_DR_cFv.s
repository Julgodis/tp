...
/* 805C46F8  4B D9 DA D4 */	b _savegpr_25
/* 805C46FC  7C 7F 1B 78 */	mr r31, r3
/* 805C4700  3C 60 80 5C */	lis r3, lit_3800@ha
/* 805C4704  3B C3 6C 74 */	addi r30, r3, lit_3800@l
...
/* 805C4730  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4734  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4738  4B D8 1D 78 */	b PSMTXCopy
/* 805C473C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4740  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C4744  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 805C4748  D0 1F 05 38 */	stfs f0, 0x538(r31)
/* 805C474C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 805C4750  D0 1F 05 3C */	stfs f0, 0x53c(r31)
/* 805C4754  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 805C4778  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C477C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4780  4B D8 1D 30 */	b PSMTXCopy
/* 805C4784  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4788  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C478C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 805C4790  D0 1F 05 38 */	stfs f0, 0x538(r31)
/* 805C4794  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 805C4798  D0 1F 05 3C */	stfs f0, 0x53c(r31)
/* 805C479C  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 805C47C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C47C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C47C8  4B D8 1C E8 */	b PSMTXCopy
/* 805C47CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C47D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C47D4  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 805C47D8  D0 1F 05 38 */	stfs f0, 0x538(r31)
/* 805C47DC  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 805C47E0  D0 1F 05 3C */	stfs f0, 0x53c(r31)
/* 805C47E4  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 805C4820  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4824  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4828  4B D8 1C 88 */	b PSMTXCopy
...
/* 805C4840  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4844  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C4848  38 81 00 28 */	addi r4, r1, 0x28
/* 805C484C  38 A1 00 1C */	addi r5, r1, 0x1c
/* 805C4850  4B D8 25 1C */	b PSMTXMultVec
/* 805C4854  38 7F 15 2C */	addi r3, r31, 0x152c
/* 805C4858  38 81 00 1C */	addi r4, r1, 0x1c
/* 805C485C  4B CA AD EC */	b SetC__8cM3dGSphFRC4cXyz
/* 805C4860  38 7F 15 2C */	addi r3, r31, 0x152c
/* 805C4864  C0 3E 04 64 */	lfs f1, 0x464(r30)
/* 805C4868  4B CA AE A0 */	b SetR__8cM3dGSphFf
/* 805C486C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C4870  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C4874  3B 83 23 3C */	addi r28, r3, 0x233c
/* 805C4878  7F 83 E3 78 */	mr r3, r28
/* 805C487C  38 9F 14 08 */	addi r4, r31, 0x1408
/* 805C4880  4B CA 03 28 */	b Set__4cCcSFP8cCcD_Obj
/* 805C4884  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 805C4888  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805C488C  38 63 03 90 */	addi r3, r3, 0x390
/* 805C4890  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4894  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4898  4B D8 1C 18 */	b PSMTXCopy
/* 805C489C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C48A0  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l
/* 805C48A4  C0 1B 00 0C */	lfs f0, 0xc(r27)	/* effective address: 803DD47C */
/* 805C48A8  D0 1F 07 60 */	stfs f0, 0x760(r31)
/* 805C48AC  C0 1B 00 1C */	lfs f0, 0x1c(r27)	/* effective address: 803DD48C */
/* 805C48B0  D0 1F 07 64 */	stfs f0, 0x764(r31)
/* 805C48B4  C0 1B 00 2C */	lfs f0, 0x2c(r27)	/* effective address: 803DD49C */
/* 805C48B8  D0 1F 07 68 */	stfs f0, 0x768(r31)
/* 805C48BC  C0 1B 00 0C */	lfs f0, 0xc(r27)	/* effective address: 803DD47C */
/* 805C48C0  D0 1F 07 90 */	stfs f0, 0x790(r31)
/* 805C48C4  C0 1B 00 1C */	lfs f0, 0x1c(r27)	/* effective address: 803DD48C */
/* 805C48C8  D0 1F 07 94 */	stfs f0, 0x794(r31)
/* 805C48CC  C0 1B 00 2C */	lfs f0, 0x2c(r27)	/* effective address: 803DD49C */
...
/* 805C48E4  4B D8 1B CC */	b PSMTXCopy
...
/* 805C4900  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4904  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C4908  38 81 00 28 */	addi r4, r1, 0x28
/* 805C490C  38 BF 07 78 */	addi r5, r31, 0x778
/* 805C4910  4B D8 24 5C */	b PSMTXMultVec
/* 805C4914  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 805C4918  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 805C4930  3C 60 80 5C */	lis r3, l_HIO@ha
/* 805C4934  38 63 79 0C */	addi r3, r3, l_HIO@l
/* 805C4938  C0 43 00 1C */	lfs f2, 0x1c(r3)	/* effective address: 805C7928 */
...
/* 805C496C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4970  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4974  4B D8 1B 3C */	b PSMTXCopy
...
/* 805C4998  4B CA AC B0 */	b SetC__8cM3dGSphFRC4cXyz
/* 805C499C  38 7F 11 84 */	addi r3, r31, 0x1184
/* 805C49A0  C0 3E 00 18 */	lfs f1, 0x18(r30)
/* 805C49A4  4B CA AD 64 */	b SetR__8cM3dGSphFf
...
/* 805C49C8  4B CA 01 E0 */	b Set__4cCcSFP8cCcD_Obj
lbl_805C49CC:
...
/* 805C4A2C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 805C4A30  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 805C4A34  7C 03 04 2E */	lfsx f0, r3, r0
/* 805C4A38  3C 60 80 5C */	lis r3, l_HIO@ha
/* 805C4A3C  38 63 79 0C */	addi r3, r3, l_HIO@l
/* 805C4A40  C0 43 00 24 */	lfs f2, 0x24(r3)	/* effective address: 805C7930 */
...
/* 805C4AD8  4B CA AB 70 */	b SetC__8cM3dGSphFRC4cXyz
/* 805C4ADC  38 7F 12 BC */	addi r3, r31, 0x12bc
/* 805C4AE0  FC 20 F8 90 */	fmr f1, f31
/* 805C4AE4  4B CA AC 24 */	b SetR__8cM3dGSphFf
...
/* 805C4B08  4B CA 00 A0 */	b Set__4cCcSFP8cCcD_Obj
lbl_805C4B0C:
...
/* 805C4B50  4B CA AA F8 */	b SetC__8cM3dGSphFRC4cXyz
/* 805C4B54  38 7F 13 F4 */	addi r3, r31, 0x13f4
/* 805C4B58  C0 3E 04 24 */	lfs f1, 0x424(r30)
/* 805C4B5C  4B CA AB AC */	b SetR__8cM3dGSphFf
...
/* 805C4B78  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 805C4B7C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 805C4B80  7C 03 04 2E */	lfsx f0, r3, r0
/* 805C4B84  3C 60 80 5C */	lis r3, l_HIO@ha
/* 805C4B88  38 63 79 0C */	addi r3, r3, l_HIO@l
/* 805C4B8C  C0 43 00 20 */	lfs f2, 0x20(r3)	/* effective address: 805C792C */
...
/* 805C4BF8  4B C9 FF B0 */	b Set__4cCcSFP8cCcD_Obj
lbl_805C4BFC:
...
/* 805C4C18  4B CA AD 64 */	b cLib_addCalc__FPfffff
...
/* 805C4C34  4B CA AD 48 */	b cLib_addCalc__FPfffff
/* 805C4C38  38 60 00 00 */	li r3, 0
/* 805C4C3C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 805C4C40  4B A9 69 DC */	b dKyw_evt_wind_set__Fss
lbl_805C4C44:
/* 805C4C44  C0 3F 07 38 */	lfs f1, 0x738(r31)
/* 805C4C48  4B A9 69 C4 */	b dKyw_custom_windpower__Ff
...
/* 805C4C64  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 805C4C68  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 805C4C98  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4C9C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4CA0  4B D8 18 10 */	b PSMTXCopy
...
/* 805C4CB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4CBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C4CC0  38 81 00 28 */	addi r4, r1, 0x28
/* 805C4CC4  38 A1 00 1C */	addi r5, r1, 0x1c
/* 805C4CC8  4B D8 20 A4 */	b PSMTXMultVec
/* 805C4CCC  38 7F 0C A4 */	addi r3, r31, 0xca4
/* 805C4CD0  38 81 00 1C */	addi r4, r1, 0x1c
/* 805C4CD4  4B CA A9 74 */	b SetC__8cM3dGSphFRC4cXyz
/* 805C4CD8  38 7F 0C A4 */	addi r3, r31, 0xca4
/* 805C4CDC  C0 3E 03 BC */	lfs f1, 0x3bc(r30)
/* 805C4CE0  4B CA AA 28 */	b SetR__8cM3dGSphFf
...
/* 805C4D04  4B C9 FE A4 */	b Set__4cCcSFP8cCcD_Obj
/* 805C4D08  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 805C4D0C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805C4D10  38 63 06 F0 */	addi r3, r3, 0x6f0
/* 805C4D14  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4D18  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4D1C  4B D8 17 94 */	b PSMTXCopy
...
/* 805C4D34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4D38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C4D3C  38 81 00 28 */	addi r4, r1, 0x28
/* 805C4D40  38 A1 00 1C */	addi r5, r1, 0x1c
/* 805C4D44  4B D8 20 28 */	b PSMTXMultVec
/* 805C4D48  38 7F 0D DC */	addi r3, r31, 0xddc
/* 805C4D4C  38 81 00 1C */	addi r4, r1, 0x1c
/* 805C4D50  4B CA A8 F8 */	b SetC__8cM3dGSphFRC4cXyz
/* 805C4D54  38 7F 0D DC */	addi r3, r31, 0xddc
/* 805C4D58  C0 3E 03 BC */	lfs f1, 0x3bc(r30)
/* 805C4D5C  4B CA A9 AC */	b SetR__8cM3dGSphFf
...
/* 805C4D80  4B C9 FE 28 */	b Set__4cCcSFP8cCcD_Obj
lbl_805C4D84:
/* 805C4D84  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 805C4D88  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805C4D8C  38 63 02 D0 */	addi r3, r3, 0x2d0
/* 805C4D90  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4D94  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C4D98  4B D8 17 18 */	b PSMTXCopy

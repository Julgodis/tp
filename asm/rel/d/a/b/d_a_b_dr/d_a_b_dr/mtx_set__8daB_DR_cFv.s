...
/* 805C41B4  4B D9 E0 08 */	b _savegpr_21
/* 805C41B8  7C 78 1B 78 */	mr r24, r3
/* 805C41BC  3C 60 80 5C */	lis r3, lit_3800@ha
/* 805C41C0  3B 63 6C 74 */	addi r27, r3, lit_3800@l
/* 805C41C4  38 78 04 D0 */	addi r3, r24, 0x4d0
/* 805C41C8  4B A4 8B 9C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 805C41CC  C0 38 07 6C */	lfs f1, 0x76c(r24)
/* 805C41D0  C0 58 07 70 */	lfs f2, 0x770(r24)
/* 805C41D4  C0 78 07 74 */	lfs f3, 0x774(r24)
/* 805C41D8  4B A4 8B C4 */	b transM__14mDoMtx_stack_cFfff
/* 805C41DC  38 78 04 E4 */	addi r3, r24, 0x4e4
/* 805C41E0  4B A4 8D 64 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805C41E4  3C 60 80 5C */	lis r3, l_HIO@ha
/* 805C41E8  38 63 79 0C */	addi r3, r3, l_HIO@l
/* 805C41EC  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 805C7914 */
/* 805C41F0  FC 40 08 90 */	fmr f2, f1
/* 805C41F4  FC 60 08 90 */	fmr f3, f1
/* 805C41F8  4B A4 8C 40 */	b scaleM__14mDoMtx_stack_cFfff
/* 805C41FC  80 78 05 B4 */	lwz r3, 0x5b4(r24)
/* 805C4200  80 83 00 04 */	lwz r4, 4(r3)
/* 805C4204  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4208  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C420C  38 84 00 24 */	addi r4, r4, 0x24
/* 805C4210  4B D8 22 A0 */	b PSMTXCopy
/* 805C4214  80 78 05 B4 */	lwz r3, 0x5b4(r24)
/* 805C4218  4B A4 CF D4 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 805C422C  4B AB 33 50 */	b __ct__11dBgS_GndChkFv
...
/* 805C4244  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805C4248  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805C424C  4B D8 22 64 */	b PSMTXCopy
/* 805C4250  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805C4254  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805C4258  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 805C425C  D0 01 00 44 */	stfs f0, 0x44(r1)
/* 805C4260  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 805C4264  D0 01 00 48 */	stfs f0, 0x48(r1)
/* 805C4268  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 805C426C  D0 01 00 4C */	stfs f0, 0x4c(r1)
/* 805C4270  38 61 00 50 */	addi r3, r1, 0x50
/* 805C4274  38 81 00 44 */	addi r4, r1, 0x44
/* 805C4278  4B CA 3A B0 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 805C427C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C4280  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C4284  38 63 0F 38 */	addi r3, r3, 0xf38
/* 805C4288  38 81 00 50 */	addi r4, r1, 0x50
/* 805C428C  4B AB 02 14 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 805C4300  4B CA B7 B8 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805C431C  4B CA B7 9C */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
lbl_805C4320:
...
/* 805C433C  4B AB 32 B4 */	b __dt__11dBgS_GndChkFv
lbl_805C4340:
...
/* 805C4368  4B CA 27 CC */	b __mi__4cXyzCFRC3Vec
...
/* 805C4388  4B D8 2D B0 */	b PSVECSquareMag
...
/* 805C43F8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C43FC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805C4468  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C446C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805C4470:
...
/* 805C44D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C44DC  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 805C44E0  3C 60 80 5C */	lis r3, data_805C77A4@ha
/* 805C44E4  3B A3 77 A4 */	addi r29, r3, data_805C77A4@l
/* 805C44E8  3C 60 00 07 */	lis r3, 0x0007 /* 0x0007048C@ha */
/* 805C44EC  3B C3 04 8C */	addi r30, r3, 0x048C /* 0x0007048C@l */
/* 805C44F0  3C 60 80 5C */	lis r3, data_805C77AC@ha
/* 805C44F4  3B E3 77 AC */	addi r31, r3, data_805C77AC@l
lbl_805C44F8:
/* 805C44F8  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)	/* effective address: 8040BEFC */
...
/* 805C4544  4B A8 8F 88 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805C4558  4B A8 73 C0 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805C4584  4B CB C2 84 */	b func_80280808
...
/* 805C4604  4B A8 8E C8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805C4618  4B A8 73 00 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805C4644  4B CB C1 C4 */	b func_80280808
...
/* 805C4670  4B D9 DB 98 */	b _restgpr_21

...
/* 805C5984  4B D9 C8 44 */	b _savegpr_24
/* 805C5988  7C 7F 1B 78 */	mr r31, r3
/* 805C598C  3C 80 80 5C */	lis r4, cNullVec__6Z2Calc@ha
/* 805C5990  3B 84 72 48 */	addi r28, r4, cNullVec__6Z2Calc@l
/* 805C5994  3C 80 80 5C */	lis r4, lit_3800@ha
/* 805C5998  3B C4 6C 74 */	addi r30, r4, lit_3800@l
...
/* 805C59C4  3C 80 80 5C */	lis r4, stringBase0@ha
/* 805C59C8  38 84 72 40 */	addi r4, r4, stringBase0@l
/* 805C59CC  4B A6 74 F0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805C5AC0  4B AB DD A0 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805C5AC4  38 7F 0F 28 */	addi r3, r31, 0xf28
/* 805C5AC8  38 9C 00 A4 */	addi r4, r28, 0xa4
/* 805C5ACC  4B AB EF 68 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5AF4  3C 80 80 5C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 805C5AF8  38 84 59 54 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
...
/* 805C5B0C  4B A5 49 A4 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 805C5B48  4B AB 07 00 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 805C5B4C  38 7F 07 F0 */	addi r3, r31, 0x7f0
/* 805C5B50  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 805C5B54  C0 5E 00 7C */	lfs f2, 0x7c(r30)
/* 805C5B58  4B AB 04 00 */	b SetWall__12dBgS_AcchCirFff
/* 805C5B5C  38 7F 08 30 */	addi r3, r31, 0x830
/* 805C5B60  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805C5B64  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 805C5B68  38 84 0F 38 */	addi r4, r4, 0xf38
/* 805C5B6C  4B AB 0F 40 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 805C5B8C  4B CF B5 08 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 805C5BA0  4B AB DC C0 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
lbl_805C5BE4:
/* 805C5BE4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C5BE8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C5BEC  3B 43 09 58 */	addi r26, r3, 0x958
/* 805C5BF0  7F 43 D3 78 */	mr r3, r26
/* 805C5BF4  38 80 00 03 */	li r4, 3
/* 805C5BF8  4B A6 ED 3C */	b isDungeonItem__12dSv_memBit_cCFi
...
/* 805C5C38  4B A5 6D 24 */	b fopAcM_createWarpHole__FPC4cXyzPC5csXyziUcUcUc
/* 805C5C3C  7F 43 D3 78 */	mr r3, r26
/* 805C5C40  38 80 00 04 */	li r4, 4
/* 805C5C44  4B A6 EC F0 */	b isDungeonItem__12dSv_memBit_cCFi
...
/* 805C5CA8  4B A5 64 2C */	b fopAcM_createItemForBoss__FPC4cXyziiPC5csXyzPC4cXyzffi
lbl_805C5CAC:
/* 805C5CAC  38 00 00 00 */	li r0, 0
/* 805C5CB0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805C5CB4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805C5CB8  98 03 12 CC */	stb r0, 0x12cc(r3)	/* effective address: 8042DD20 */
/* 805C5CBC  38 60 00 05 */	li r3, 5
/* 805C5CC0  48 00 05 D8 */	b lbl_805C6298
lbl_805C5CC4:
/* 805C5CC4  7F E3 FB 78 */	mr r3, r31
/* 805C5CC8  3C 80 80 5C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 805C5CCC  38 84 59 54 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 805C5CD0  38 A0 68 E0 */	li r5, 0x68e0
/* 805C5CD4  4B A5 47 DC */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 805C5CF4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C5CF8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C5CFC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805C5D00  7C 05 07 74 */	extsb r5, r0
/* 805C5D04  4B A6 F5 AC */	b offSwitch__10dSv_info_cFii
lbl_805C5D08:
/* 805C5D08  88 9F 07 ED */	lbz r4, 0x7ed(r31)
/* 805C5D0C  28 04 00 FF */	cmplwi r4, 0xff
/* 805C5D10  41 82 00 18 */	beq lbl_805C5D28
/* 805C5D14  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C5D18  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C5D1C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805C5D20  7C 05 07 74 */	extsb r5, r0
/* 805C5D24  4B A6 F5 8C */	b offSwitch__10dSv_info_cFii
lbl_805C5D28:
/* 805C5D28  88 9F 07 EE */	lbz r4, 0x7ee(r31)
/* 805C5D2C  28 04 00 FF */	cmplwi r4, 0xff
/* 805C5D30  41 82 00 18 */	beq lbl_805C5D48
/* 805C5D34  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C5D38  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C5D3C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805C5D40  7C 05 07 74 */	extsb r5, r0
/* 805C5D44  4B A6 F5 6C */	b offSwitch__10dSv_info_cFii
lbl_805C5D48:
/* 805C5D48  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C5D4C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C5D50  38 63 09 78 */	addi r3, r3, 0x978
/* 805C5D54  38 80 00 16 */	li r4, 0x16
/* 805C5D58  4B A6 EE 68 */	b offSwitch__12dSv_danBit_cFi
...
/* 805C5D74  3C 60 80 5C */	lis r3, struct_805C78FC+0x1@ha
/* 805C5D78  8C 03 78 FD */	lbzu r0, struct_805C78FC+0x1@l(r3)
...
/* 805C5D94  3C 60 80 5C */	lis r3, l_HIO@ha
/* 805C5D98  38 63 79 0C */	addi r3, r3, l_HIO@l
/* 805C5D9C  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 805C7910 */
lbl_805C5DA0:
...
/* 805C5DE4  4B A5 47 44 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 805C5DF8  4B A5 47 40 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 805C5E24  4B AB 04 24 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 805C5E28  38 7F 07 F0 */	addi r3, r31, 0x7f0
/* 805C5E2C  C0 3E 00 30 */	lfs f1, 0x30(r30)
/* 805C5E30  C0 5E 03 6C */	lfs f2, 0x36c(r30)
/* 805C5E34  4B AB 01 24 */	b SetWall__12dBgS_AcchCirFff
/* 805C5E38  38 7F 08 30 */	addi r3, r31, 0x830
/* 805C5E3C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805C5E40  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 805C5E44  38 84 0F 38 */	addi r4, r4, 0xf38
/* 805C5E48  4B AB 0C 64 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 805C5E5C  4B AB DA 04 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 805C5E60  38 7F 15 40 */	addi r3, r31, 0x1540
/* 805C5E64  38 9C 01 64 */	addi r4, r28, 0x164
/* 805C5E68  4B AB EA 4C */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 805C5E7C  4B AB EA 38 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 805C5E9C  4B AB EB 98 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5EB0  4B AB EB 84 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5EC4  4B AB EB 70 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5ED8  4B AB EB 5C */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5EF8  4B AB E9 BC */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 805C5F28  4B AB EB 0C */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5F58  4B AB EA DC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 805C5FBC  4B CF B0 F8 */	b init__15Z2CreatureEnemyFP3VecP3VecP3VecUcUcUc
...
/* 805C5FD4  4B CF B0 C0 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 805C6004  4B CA 19 88 */	b cM_rndFX__Ff
...
/* 805C6098  4B A6 79 98 */	b dComIfGs_isZoneSwitch__Fii
...
/* 805C60C0  4B A6 79 70 */	b dComIfGs_isZoneSwitch__Fii
...
/* 805C60D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C60D8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C60DC  38 80 00 10 */	li r4, 0x10
/* 805C60E0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805C60E4  7C 05 07 74 */	extsb r5, r0
/* 805C60E8  4B A6 F1 18 */	b onSwitch__10dSv_info_cFii
...
/* 805C6120  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805C6124  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805C6128  98 03 12 CC */	stb r0, 0x12cc(r3)	/* effective address: 8042DD20 */
lbl_805C612C:
...
/* 805C6140  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 805C6144  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)
...
/* 805C615C  4B A6 78 D4 */	b dComIfGs_isZoneSwitch__Fii
...
/* 805C61BC  4B A5 3D 34 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805C61D4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805C61D8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805C61DC  98 03 12 CC */	stb r0, 0x12cc(r3)	/* effective address: 8042DD20 */
lbl_805C61E0:
/* 805C61E0  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 805C61E4  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)
...
/* 805C61FC  4B A6 78 34 */	b dComIfGs_isZoneSwitch__Fii
/* 805C6200  2C 03 00 00 */	cmpwi r3, 0
/* 805C6204  41 82 00 88 */	beq lbl_805C628C
lbl_805C6208:
/* 805C6208  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805C620C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 805C6210  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 805C629C  4B D9 BF 78 */	b _restgpr_24

...
/* 805BF778  4B DA 2A 5C */	b _savegpr_27
/* 805BF77C  7C 7C 1B 78 */	mr r28, r3
/* 805BF780  7C 9D 23 78 */	mr r29, r4
/* 805BF784  3C 80 80 5C */	lis r4, lit_3800@ha
/* 805BF788  3B C4 6C 74 */	addi r30, r4, lit_3800@l
/* 805BF78C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805BF790  3B E4 61 C0 */	addi r31, r4, struct_804061C0+0x0@l
/* 805BF794  83 7F 5D AC */	lwz r27, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 805BF7C4  4B A5 AF 4C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805BF7C8  7C 64 1B 78 */	mr r4, r3
/* 805BF7CC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805BF7D0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805BF7D4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805BF7D8  4B A4 CC 04 */	b mDoMtx_YrotS__FPA4_fs
...
/* 805BF7F8  4B CB 16 F4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 805BF87C  4B A5 AE 94 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805BF890  4B CB 0D 78 */	b cLib_addCalcAngleS2__FPssss
...
/* 805BF8A4  4B CB 0D 64 */	b cLib_addCalcAngleS2__FPssss
...
/* 805BF8B8  4B CB 0D 50 */	b cLib_addCalcAngleS2__FPssss
lbl_805BF8BC:
/* 805BF8BC  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 805BF8C0  38 9C 07 A8 */	addi r4, r28, 0x7a8
/* 805BF8C4  C0 3E 00 00 */	lfs f1, 0(r30)
/* 805BF8C8  3C A0 80 5C */	lis r5, l_HIO@ha
/* 805BF8CC  38 A5 79 0C */	addi r5, r5, l_HIO@l
/* 805BF8D0  C0 45 00 30 */	lfs f2, 0x30(r5)	/* effective address: 805C793C */
/* 805BF8D4  C0 65 00 34 */	lfs f3, 0x34(r5)	/* effective address: 805C7940 */
/* 805BF8D8  4B CB 01 E0 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
/* 805BF8DC  38 61 00 0C */	addi r3, r1, 0xc
/* 805BF8E0  38 9C 07 A8 */	addi r4, r28, 0x7a8
/* 805BF8E4  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 805BF8E8  4B CA 72 4C */	b __mi__4cXyzCFRC3Vec
...
/* 805BF908  4B D8 78 30 */	b PSVECSquareMag
...
/* 805BF978  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805BF97C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805BF9E8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805BF9EC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805BF9F0:
...
/* 805BFA2C  4B A5 AC E4 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805BFA30  A8 1C 04 E6 */	lha r0, 0x4e6(r28)
/* 805BFA34  7C 03 00 50 */	subf r0, r3, r0
/* 805BFA38  7C 03 07 34 */	extsh r3, r0
/* 805BFA3C  4B DA 56 94 */	b abs
...
/* 805BFA58  4B DA 27 C8 */	b _restgpr_27

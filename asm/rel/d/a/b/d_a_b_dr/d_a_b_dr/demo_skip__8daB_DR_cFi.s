...
/* 805C4FCC 00000018  3C 60 00 00 */	lis r3, sConsole@ha
/* 805C4FD0 0000001C  88 03 00 00 */	lbz r0, sConsole@l(r3)
...
/* 805C4FFC 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 805C5000 0000004C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 805C501C 00000068  3C 80 00 00 */	lis r4, lit_4011@ha
/* 805C5020 0000006C  C0 24 00 00 */	lfs f1, lit_4011@l(r4)
...
/* 805C503C 00000088  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805C5040 0000008C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 805C5054 000000A0  3C 60 00 00 */	lis r3, g_env_light@ha
/* 805C5058 000000A4  38 63 00 00 */	addi r3, r3, g_env_light@l
/* 805C505C 000000A8  98 03 12 CC */	stb r0, 0x12cc(r3)
/* 805C5060 000000AC  3C 60 00 00 */	lis r3, sConsole@ha
/* 805C5064 000000B0  98 03 00 00 */	stb r0, sConsole@l(r3)

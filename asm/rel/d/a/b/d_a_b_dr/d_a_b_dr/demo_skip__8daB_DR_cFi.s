...
/* 805C4FCC 00000018  3C 60 00 00 */	lis r3, struct_80450C98+0x0@ha /* 80450C98 */
/* 805C4FD0 0000001C  88 03 00 00 */	lbz r0, struct_80450C98+0x0@l(r3) /* 80450C98 */
...
/* 805C4FE4 00000030  4B FF 5D F5 */	bl fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805C4FFC 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805C5000 0000004C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805C501C 00000068  3C 80 00 00 */	lis r4, lit_4011@ha /* 805C6CA4 */
/* 805C5020 0000006C  C0 24 00 00 */	lfs f1, lit_4011@l(r4) /* 805C6CA4 */
...
/* 805C5038 00000084  4B FF 5D A1 */	bl dStage_changeScene__FifUlScsi
/* 805C503C 00000088  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 805C5040 0000008C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 805C5044 00000090  80 63 00 00 */	lwz r3, 0(r3)
/* 805C5048 00000094  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805C504C 00000098  4B FF 5D 8D */	bl subBgmStop__8Z2SeqMgrFv
/* 805C5050 0000009C  38 00 00 01 */	li r0, 1
/* 805C5054 000000A0  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 805C5058 000000A4  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 805C505C 000000A8  98 03 12 CC */	stb r0, 0x12cc(r3)
/* 805C5060 000000AC  3C 60 00 00 */	lis r3, struct_80450C98+0x0@ha /* 80450C98 */
/* 805C5064 000000B0  98 03 00 00 */	stb r0, struct_80450C98+0x0@l(r3) /* 80450C98 */
...
/* 805C5074 000000C0  4B FF 5D 65 */	bl dComIfGs_onZoneSwitch__Fii
...
/* 805C5084 000000D0  4B FF 5D 55 */	bl dComIfGs_onZoneSwitch__Fii
/* 805C5088 000000D4  38 7E 02 48 */	addi r3, r30, 0x248
/* 805C508C 000000D8  4B FF 5D 4D */	bl Start__9dCamera_cFv
/* 805C5090 000000DC  38 7E 02 48 */	addi r3, r30, 0x248
/* 805C5094 000000E0  38 80 00 00 */	li r4, 0
/* 805C5098 000000E4  4B FF 5D 41 */	bl SetTrimSize__9dCamera_cFl
/* 805C509C 000000E8  80 61 00 08 */	lwz r3, 8(r1)
/* 805C50A0 000000EC  4B FF 5D 39 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_805C50A4:

...
/* 805C4FCC  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 805C4FD0  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)
...
/* 805C4FE4  4B A5 49 D8 */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805C501C  3C 80 80 5C */	lis r4, lit_4011@ha
/* 805C5020  C0 24 6C A4 */	lfs f1, lit_4011@l(r4)
...
/* 805C5074  4B A6 88 D8 */	b dComIfGs_onZoneSwitch__Fii
/* 805C5078  38 60 00 14 */	li r3, 0x14
/* 805C507C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 805C5080  7C 04 07 74 */	extsb r4, r0
/* 805C5084  4B A6 88 C8 */	b dComIfGs_onZoneSwitch__Fii
/* 805C5088  38 7E 02 48 */	addi r3, r30, 0x248
/* 805C508C  4B B9 C4 20 */	b Start__9dCamera_cFv
/* 805C5090  38 7E 02 48 */	addi r3, r30, 0x248
/* 805C5094  38 80 00 00 */	li r4, 0
/* 805C5098  4B B9 DF 74 */	b SetTrimSize__9dCamera_cFl
/* 805C509C  80 61 00 08 */	lwz r3, 8(r1)
/* 805C50A0  4B A5 4B DC */	b fopAcM_delete__FP10fopAc_ac_c
lbl_805C50A4:

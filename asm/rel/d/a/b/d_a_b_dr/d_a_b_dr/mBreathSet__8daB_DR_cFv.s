...
/* 805BF4D8 00000010  4B DA 2C F0 */	b _savegpr_24
/* 805BF4DC 00000014  7C 7B 1B 78 */	mr r27, r3
/* 805BF4E0 00000018  3C 60 80 5C */	lis r3, lit_3800@ha
/* 805BF4E4 0000001C  3B A3 6C 74 */	addi r29, r3, lit_3800@l
/* 805BF4E8 00000020  38 7B 07 2C */	addi r3, r27, 0x72c
/* 805BF4EC 00000024  C0 3D 00 08 */	lfs f1, 8(r29)	/* effective address: 805C6C7C */
/* 805BF4F0 00000028  C0 5D 03 78 */	lfs f2, 0x378(r29)	/* effective address: 805C6FEC */
/* 805BF4F4 0000002C  C0 7D 03 70 */	lfs f3, 0x370(r29)	/* effective address: 805C6FE4 */
/* 805BF4F8 00000030  4B CB 05 44 */	b cLib_addCalc2__FPffff
...
/* 805BF50C 00000044  3C 60 80 5C */	lis r3, data_805C7974@ha
/* 805BF510 00000048  98 03 79 74 */	stb r0, data_805C7974@l(r3)
...
/* 805BF530 00000068  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805BF534 0000006C  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l
/* 805BF538 00000070  3C 60 80 5C */	lis r3, data_805C76A0@ha
/* 805BF53C 00000074  3B E3 76 A0 */	addi r31, r3, data_805C76A0@l
lbl_805BF540:
/* 805BF540 00000000  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 805BF588 00000048  C0 3D 00 34 */	lfs f1, 0x34(r29)	/* effective address: 805C6CA8 */
/* 805BF58C 0000004C  4B A8 DF 40 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 805BF590 00000050  7C 7B C1 2E */	stwx r3, r27, r24
/* 805BF594 00000054  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
/* 805BF598 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 805BF59C 0000005C  7C 9B C0 2E */	lwzx r4, r27, r24
/* 805BF5A0 00000060  4B A8 C3 78 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805BF5CC 0000008C  4B CC 12 3C */	b func_80280808
...
/* 805BF5E4 000000A4  80 9E 5D AC */	lwz r4, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 805BF5E8 000000A8  4B A5 B1 28 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805BF5EC 000000AC  7C 64 1B 78 */	mr r4, r3
/* 805BF5F0 000000B0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805BF5F4 000000B4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805BF5F8 000000B8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805BF5FC 000000BC  4B A4 CD E0 */	b mDoMtx_YrotS__FPA4_fs
/* 805BF600 000000C0  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
/* 805BF604 000000C4  D0 01 00 48 */	stfs f0, 0x48(r1)
/* 805BF608 000000C8  D0 01 00 4C */	stfs f0, 0x4c(r1)
/* 805BF60C 000000CC  C0 1D 03 D8 */	lfs f0, 0x3d8(r29)	/* effective address: 805C704C */
...
/* 805BF61C 000000DC  4B CB 18 D0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 805BF62C 000000EC  4B D8 7A 64 */	b PSVECAdd
...
/* 805BF6D8 0000003C  4B CA 74 5C */	b __mi__4cXyzCFRC3Vec
...
/* 805BF6F8 0000005C  4B CA 7A 30 */	b atan2sX_Z__4cXyzCFv
...
/* 805BF74C 00000014  4B A5 A7 A4 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
lbl_805BF750:
/* 805BF750 00000000  39 61 00 80 */	addi r11, r1, 0x80
/* 805BF754 00000004  4B DA 2A C0 */	b _restgpr_24

...
/* 805BB17C  4B DA 70 60 */	b _savegpr_29
/* 805BB180  7C 7D 1B 78 */	mr r29, r3
/* 805BB184  3C 60 80 5C */	lis r3, lit_3800@ha
/* 805BB188  3B E3 6C 74 */	addi r31, r3, lit_3800@l
...
lbl_805BB1C0:
/* 805BB1C0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805BB1C4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805BB1C8  38 80 00 00 */	li r4, 0
/* 805BB1CC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805BB1D0  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805BB1D4  4B BE 85 F0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805BB1D8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805BB1DC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805BB1E0  80 9D 05 B8 */	lwz r4, 0x5b8(r29)
/* 805BB1E4  80 84 00 04 */	lwz r4, 4(r4)
/* 805BB1E8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805BB1EC  4B BE 9B B4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805BB260  4B A5 2A 64 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 805BB274  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805BB278  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805BB27C  38 80 00 00 */	li r4, 0
/* 805BB280  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 805BB284  38 DD 01 0C */	addi r6, r29, 0x10c
/* 805BB288  4B BE 85 3C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 805BB28C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805BB290  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805BB294  80 9E 00 04 */	lwz r4, 4(r30)
/* 805BB298  38 BD 01 0C */	addi r5, r29, 0x10c
/* 805BB29C  4B BE 9B 04 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805BB364  4B A5 24 44 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 805BB368  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 805BB36C  4B A5 5E 54 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 805BB3BC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 805BB3C0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 805BB3C4  4B A7 35 4C */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 805BB3C8  90 7D 07 1C */	stw r3, 0x71c(r29)
/* 805BB3CC  38 60 00 01 */	li r3, 1
lbl_805BB3D0:
/* 805BB3D0  39 61 00 30 */	addi r11, r1, 0x30
/* 805BB3D4  4B DA 6E 54 */	b _restgpr_29

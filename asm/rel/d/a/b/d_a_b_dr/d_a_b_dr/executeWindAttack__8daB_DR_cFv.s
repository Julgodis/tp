...
/* 805C063C 00000010  4B FF A7 9D */	bl _savegpr_28
/* 805C0640 00000014  7C 7C 1B 78 */	mr r28, r3
/* 805C0644 00000018  3C 80 00 00 */	lis r4, lit_3800@ha /* 805C6C74 */
/* 805C0648 0000001C  3B A4 00 00 */	addi r29, r4, lit_3800@l /* 805C6C74 */
/* 805C064C 00000020  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805C0650 00000024  3B C4 00 00 */	addi r30, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805C0678 0000000C  4B FF A7 61 */	bl cLib_addCalc0__FPfff
...
/* 805C0688 0000001C  4B FF A7 51 */	bl cLib_addCalc0__FPfff
...
/* 805C0748 0000002C  4B FF A6 91 */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805C0758 0000003C  4B FF A6 81 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C0780 00000064  4B FF A6 59 */	bl PSVECSquareMag
...
/* 805C07F0 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805C07F4 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 805C0860 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805C0864 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_805C0868:
...
lbl_805C08C8:
/* 805C08C8 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805C08CC 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805C0910 0000000C  4B FF A4 C9 */	bl __mi__4cXyzCFRC3Vec
...
/* 805C0944 00000040  4B FF A4 95 */	bl PSVECSquareMag
...
/* 805C09B4 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805C09B8 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 805C0A24 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805C0A28 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_805C0A2C:
/* 805C0A2C 00000000  C0 5D 03 74 */	lfs f2, 0x374(r29)
/* 805C0A30 00000004  3C 60 00 00 */	lis r3, l_HIO@ha /* 805C790C */
/* 805C0A34 00000008  3B E3 00 00 */	addi r31, r3, l_HIO@l /* 805C790C */
...
/* 805C0B20 00000004  4B FF A2 B9 */	bl PSVECSquareMag
...
/* 805C0B90 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805C0B94 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 805C0C00 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805C0C04 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_805C0C08:
...
/* 805C0C38 00000008  4B FF A1 A1 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805C0C4C 0000001C  4B FF A1 8D */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C0C60 00000030  4B FF A1 79 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C0C74 00000044  4B FF A1 65 */	bl cLib_addCalcAngleS2__FPssss
...
/* 805C0C90 00000060  4B FF A1 49 */	bl cLib_addCalc2__FPffff
lbl_805C0C94:
/* 805C0C94 00000000  39 61 00 60 */	addi r11, r1, 0x60
/* 805C0C98 00000004  4B FF A1 41 */	bl _restgpr_28

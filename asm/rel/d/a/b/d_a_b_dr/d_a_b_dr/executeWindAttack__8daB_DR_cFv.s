...
/* 805C0644 00000018  3C 80 00 00 */	lis r4, lit_3800@ha
/* 805C0648 0000001C  3B A4 00 00 */	addi r29, r4, lit_3800@l
/* 805C064C 00000020  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 805C0650 00000024  3B C4 00 00 */	addi r30, r4, g_dComIfG_gameInfo@l
...
/* 805C07F0 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 805C07F4 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 805C0860 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 805C0864 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_805C0868:
...
lbl_805C08C8:
/* 805C08C8 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 805C08CC 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 805C09B4 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 805C09B8 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 805C0A24 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 805C0A28 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_805C0A2C:
/* 805C0A2C 00000000  C0 5D 03 74 */	lfs f2, 0x374(r29)
/* 805C0A30 00000004  3C 60 00 00 */	lis r3, l_HIO@ha
/* 805C0A34 00000008  3B E3 00 00 */	addi r31, r3, l_HIO@l
...
/* 805C0B90 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 805C0B94 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 805C0C00 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 805C0C04 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_805C0C08:

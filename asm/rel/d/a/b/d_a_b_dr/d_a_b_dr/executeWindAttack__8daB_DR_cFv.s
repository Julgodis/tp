...
/* 805C063C 00000010  4B DA 1B 9C */	b _savegpr_28
/* 805C0640 00000014  7C 7C 1B 78 */	mr r28, r3
/* 805C0644 00000018  3C 80 80 5C */	lis r4, lit_3800@ha
/* 805C0648 0000001C  3B A4 6C 74 */	addi r29, r4, lit_3800@l
/* 805C064C 00000020  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 805C0650 00000024  3B C4 61 C0 */	addi r30, r4, g_dComIfG_gameInfo@l
/* 805C0654 00000028  83 FE 5D AC */	lwz r31, 0x5dac(r30)	/* effective address: 8040BF6C */
...
/* 805C0670 00000004  C0 3D 03 DC */	lfs f1, 0x3dc(r29)	/* effective address: 805C7050 */
/* 805C0674 00000008  C0 5D 00 20 */	lfs f2, 0x20(r29)	/* effective address: 805C6C94 */
/* 805C0678 0000000C  4B CA F4 08 */	b cLib_addCalc0__FPfff
/* 805C067C 00000010  38 7C 04 FC */	addi r3, r28, 0x4fc
/* 805C0680 00000014  C0 3D 03 DC */	lfs f1, 0x3dc(r29)	/* effective address: 805C7050 */
/* 805C0684 00000018  C0 5D 00 20 */	lfs f2, 0x20(r29)	/* effective address: 805C6C94 */
/* 805C0688 0000001C  4B CA F3 F8 */	b cLib_addCalc0__FPfff
...
/* 805C06E0 0000002C  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
/* 805C06E4 00000030  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805C06E8 00000000  40 80 00 10 */	bge lbl_805C06F8
/* 805C06EC 00000004  C0 1D 03 E0 */	lfs f0, 0x3e0(r29)	/* effective address: 805C7054 */
/* 805C06F0 00000008  D0 1C 07 BC */	stfs f0, 0x7bc(r28)
/* 805C06F4 0000000C  48 00 00 0C */	b lbl_805C0700
lbl_805C06F8:
/* 805C06F8 00000000  C0 1D 03 E4 */	lfs f0, 0x3e4(r29)	/* effective address: 805C7058 */
/* 805C06FC 00000004  D0 1C 07 BC */	stfs f0, 0x7bc(r28)
lbl_805C0700:
/* 805C0700 00000000  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
...
/* 805C073C 00000020  C0 3D 00 00 */	lfs f1, 0(r29)	/* effective address: 805C6C74 */
/* 805C0740 00000024  C0 5D 00 7C */	lfs f2, 0x7c(r29)	/* effective address: 805C6CF0 */
/* 805C0744 00000028  C0 7D 00 1C */	lfs f3, 0x1c(r29)	/* effective address: 805C6C90 */
/* 805C0748 0000002C  4B CA F3 70 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805C0758 0000003C  4B CA 63 DC */	b __mi__4cXyzCFRC3Vec
...
/* 805C0774 00000058  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
/* 805C0778 0000005C  D0 01 00 3C */	stfs f0, 0x3c(r1)
/* 805C077C 00000060  38 61 00 38 */	addi r3, r1, 0x38
/* 805C0780 00000064  4B D8 69 B8 */	b PSVECSquareMag
/* 805C0784 00000068  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
...
/* 805C0794 00000008  C8 9D 03 98 */	lfd f4, 0x398(r29)	/* effective address: 805C700C */
/* 805C0798 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805C079C 00000010  C8 7D 03 A0 */	lfd f3, 0x3a0(r29)	/* effective address: 805C7014 */
...
lbl_805C07E4:
/* 805C07E4 00000000  C8 1D 03 A8 */	lfd f0, 0x3a8(r29)	/* effective address: 805C701C */
/* 805C07E8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805C07EC 00000000  40 80 00 10 */	bge lbl_805C07FC
/* 805C07F0 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C07F4 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805C0860 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C0864 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805C0868:
/* 805C0868 00000000  C0 1D 00 18 */	lfs f0, 0x18(r29)	/* effective address: 805C6C8C */
...
/* 805C08A4 0000001C  80 7E 5D AC */	lwz r3, 0x5dac(r30)	/* effective address: 8040BF6C */
...
lbl_805C08C8:
/* 805C08C8 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805C08CC 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805C08D0 00000008  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 805C0910 0000000C  4B CA 62 24 */	b __mi__4cXyzCFRC3Vec
...
/* 805C092C 00000028  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
...
/* 805C0944 00000040  4B D8 67 F4 */	b PSVECSquareMag
/* 805C0948 00000044  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
...
/* 805C0958 00000008  C8 9D 03 98 */	lfd f4, 0x398(r29)	/* effective address: 805C700C */
/* 805C095C 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805C0960 00000010  C8 7D 03 A0 */	lfd f3, 0x3a0(r29)	/* effective address: 805C7014 */
...
lbl_805C09A8:
/* 805C09A8 00000000  C8 1D 03 A8 */	lfd f0, 0x3a8(r29)	/* effective address: 805C701C */
/* 805C09AC 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805C09B0 00000000  40 80 00 10 */	bge lbl_805C09C0
/* 805C09B4 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C09B8 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805C0A24 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C0A28 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805C0A2C:
/* 805C0A2C 00000000  C0 5D 03 74 */	lfs f2, 0x374(r29)	/* effective address: 805C6FE8 */
/* 805C0A30 00000004  3C 60 80 5C */	lis r3, l_HIO@ha
/* 805C0A34 00000008  3B E3 79 0C */	addi r31, r3, l_HIO@l
/* 805C0A38 0000000C  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 805C7920 */
...
/* 805C0A48 00000004  C0 1D 00 34 */	lfs f0, 0x34(r29)	/* effective address: 805C6CA8 */
...
/* 805C0A78 00000034  A8 1F 00 48 */	lha r0, 0x48(r31)	/* effective address: 805C7954 */
...
/* 805C0A94 00000008  C0 1D 03 E8 */	lfs f0, 0x3e8(r29)	/* effective address: 805C705C */
...
/* 805C0AB4 00000028  A8 1F 00 3A */	lha r0, 0x3a(r31)	/* effective address: 805C7946 */
...
/* 805C0B20 00000004  4B D8 66 18 */	b PSVECSquareMag
/* 805C0B24 00000008  C0 1D 00 30 */	lfs f0, 0x30(r29)	/* effective address: 805C6CA4 */
...
/* 805C0B34 00000008  C8 9D 03 98 */	lfd f4, 0x398(r29)	/* effective address: 805C700C */
/* 805C0B38 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805C0B3C 00000010  C8 7D 03 A0 */	lfd f3, 0x3a0(r29)	/* effective address: 805C7014 */
...
lbl_805C0B84:
/* 805C0B84 00000000  C8 1D 03 A8 */	lfd f0, 0x3a8(r29)	/* effective address: 805C701C */
/* 805C0B88 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805C0B8C 00000000  40 80 00 10 */	bge lbl_805C0B9C
/* 805C0B90 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C0B94 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805C0C00 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805C0C04 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805C0C08:
/* 805C0C08 00000000  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 805C7920 */
...
/* 805C0C34 00000004  80 9E 5D AC */	lwz r4, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 805C0C38 00000008  4B A5 9A D8 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805C0C4C 0000001C  4B CA F9 BC */	b cLib_addCalcAngleS2__FPssss
...
/* 805C0C60 00000030  4B CA F9 A8 */	b cLib_addCalcAngleS2__FPssss
...
/* 805C0C74 00000044  4B CA F9 94 */	b cLib_addCalcAngleS2__FPssss
/* 805C0C78 00000048  38 7C 04 D4 */	addi r3, r28, 0x4d4
/* 805C0C7C 0000004C  C0 3D 03 84 */	lfs f1, 0x384(r29)	/* effective address: 805C6FF8 */
/* 805C0C80 00000050  C0 1C 07 20 */	lfs f0, 0x720(r28)
/* 805C0C84 00000054  EC 21 00 2A */	fadds f1, f1, f0
/* 805C0C88 00000058  C0 5D 00 00 */	lfs f2, 0(r29)	/* effective address: 805C6C74 */
/* 805C0C8C 0000005C  C0 7D 00 1C */	lfs f3, 0x1c(r29)	/* effective address: 805C6C90 */
/* 805C0C90 00000060  4B CA ED AC */	b cLib_addCalc2__FPffff
lbl_805C0C94:
/* 805C0C94 00000000  39 61 00 60 */	addi r11, r1, 0x60
/* 805C0C98 00000004  4B DA 15 8C */	b _restgpr_28

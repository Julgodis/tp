...
/* 805C39E8  4B D9 E7 F4 */	b _savegpr_29
/* 805C39EC  7C 7E 1B 78 */	mr r30, r3
/* 805C39F0  3C 60 80 5C */	lis r3, lit_3800@ha
/* 805C39F4  3B E3 6C 74 */	addi r31, r3, lit_3800@l
/* 805C39F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C39FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C3A00  83 A3 5D 74 */	lwz r29, 0x5d74(r3)	/* effective address: 8040BF34 */
/* 805C3A04  80 1E 07 0C */	lwz r0, 0x70c(r30)
/* 805C3A08  28 00 00 0B */	cmplwi r0, 0xb
/* 805C3A0C  41 81 02 8C */	bgt lbl_805C3C98
/* 805C3A10  3C 60 80 5C */	lis r3, lit_7559@ha
/* 805C3A14  38 63 77 3C */	addi r3, r3, lit_7559@l
...
/* 805C3A2C  4B CA 3F 28 */	b cM_rndF__Ff
...
/* 805C3A40  4B CA 3F 4C */	b cM_rndFX__Ff
...
/* 805C3A68  4B CA 3F 24 */	b cM_rndFX__Ff
...
/* 805C3A7C  4B CA 3E D8 */	b cM_rndF__Ff
...
/* 805C3AE0  4B A5 61 9C */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 805C3B1C  4B CA BF 64 */	b cLib_addCalc0__FPfff
...
/* 805C3B3C  4B CA CA CC */	b cLib_addCalcAngleS2__FPssss
...
/* 805C3B88  4B A5 60 F4 */	b fopAcM_delete__FP10fopAc_ac_c
/* 805C3B8C  48 00 01 0C */	b lbl_805C3C98
lbl_805C3B90:
/* 805C3B90  C0 3F 00 24 */	lfs f1, 0x24(r31)
/* 805C3B94  4B CA 3D C0 */	b cM_rndF__Ff
...
/* 805C3BB0  4B CA 3D DC */	b cM_rndFX__Ff
...
/* 805C3BD8  4B CA 2F 5C */	b __mi__4cXyzCFRC3Vec
...
/* 805C3BF8  4B CA 35 30 */	b atan2sX_Z__4cXyzCFv
/* 805C3BFC  B0 7E 04 DE */	sth r3, 0x4de(r30)
/* 805C3C00  C0 3F 04 54 */	lfs f1, 0x454(r31)
/* 805C3C04  4B CA 3D 88 */	b cM_rndFX__Ff
...
/* 805C3C20  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805C3C24  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805C3C28  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805C3C2C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 805C3C30  4B A4 87 AC */	b mDoMtx_YrotS__FPA4_fs
/* 805C3C34  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805C3C38  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805C3C3C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805C3C40  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 805C3C44  4B A4 87 58 */	b mDoMtx_XrotM__FPA4_fs
...
/* 805C3C64  4B CA D2 88 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 805C3C94  4B A5 5F E8 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_805C3C98:
/* 805C3C98  39 61 00 50 */	addi r11, r1, 0x50
/* 805C3C9C  4B D9 E5 8C */	b _restgpr_29

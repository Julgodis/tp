...
/* 805EFDE4  4B D7 23 E4 */	b _savegpr_24
...
/* 805EFE24  C0 23 41 A4 */	lfs f1, lit_3794@l(r3)
/* 805EFE28  D0 21 00 08 */	stfs f1, 8(r1)
/* 805EFE2C  3C 60 80 5F */	lis r3, lit_4154@ha
/* 805EFE30  C0 03 41 B4 */	lfs f0, lit_4154@l(r3)
...
/* 805EFE44  4B C8 10 A8 */	b MtxPosition__FP4cXyzP4cXyz
/* 805EFE48  38 79 07 30 */	addi r3, r25, 0x730
/* 805EFE4C  38 99 04 D0 */	addi r4, r25, 0x4d0
/* 805EFE50  7C 65 1B 78 */	mr r5, r3
/* 805EFE54  4B D5 72 3C */	b PSVECAdd
/* 805EFE58  3B 60 00 00 */	li r27, 0
/* 805EFE5C  3B 40 00 00 */	li r26, 0
/* 805EFE60  3C 60 80 5F */	lis r3, l_HIO@ha
/* 805EFE64  3B C3 47 DC */	addi r30, r3, l_HIO@l
/* 805EFE68  3C 60 80 5F */	lis r3, top_j@ha
/* 805EFE6C  3B E3 44 74 */	addi r31, r3, top_j@l
/* 805EFE70  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805EFE74  3B 03 07 68 */	addi r24, r3, calc_mtx@l
...
/* 805EFE98  4B D5 66 18 */	b PSMTXCopy
...
/* 805EFEAC  4B C8 0F F8 */	b MtxScale__FfffUc
/* 805EFEB0  2C 1A 00 08 */	cmpwi r26, 8
/* 805EFEB4  41 80 00 28 */	blt lbl_805EFEDC
/* 805EFEB8  3C 60 80 5F */	lis r3, lit_3794@ha
/* 805EFEBC  C0 03 41 A4 */	lfs f0, lit_3794@l(r3)
...
/* 805EFED4  4B C8 10 18 */	b MtxPosition__FP4cXyzP4cXyz
/* 805EFED8  48 00 00 20 */	b lbl_805EFEF8
lbl_805EFEDC:
/* 805EFEDC  57 40 07 BE */	clrlwi r0, r26, 0x1e
/* 805EFEE0  1C 80 00 0C */	mulli r4, r0, 0xc
/* 805EFEE4  3C 60 80 5F */	lis r3, top_pos_data@ha
/* 805EFEE8  38 03 48 BC */	addi r0, r3, top_pos_data@l
/* 805EFEEC  7C 60 22 14 */	add r3, r0, r4
/* 805EFEF0  38 9C 00 10 */	addi r4, r28, 0x10
/* 805EFEF4  4B C8 0F F8 */	b MtxPosition__FP4cXyzP4cXyz
lbl_805EFEF8:
...
/* 805EFF1C  4B A2 12 38 */	b updateDL__16mDoExt_McaMorfSOFv
...
/* 805EFF3C  4B D7 22 D8 */	b _restgpr_24

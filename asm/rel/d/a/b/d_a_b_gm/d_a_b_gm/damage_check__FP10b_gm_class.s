...
/* 805EE144 00000044  3C 60 00 00 */	lis r3, lit_3794@ha
/* 805EE148 00000048  C0 03 00 00 */	lfs f0, lit_3794@l(r3)
...
/* 805EE164 00000064  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 805EE168 00000068  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805EE16C 0000006C  4B FF F7 4D */	bl PSMTXCopy
/* 805EE170 00000070  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805EE174 00000074  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805EE198 00000098  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 805EE19C 0000009C  3B A3 00 00 */	addi r29, r3, g_dComIfG_gameInfo@l
/* 805EE1A0 000000A0  3C 60 00 00 */	lis r3, data_805F43B4@ha
/* 805EE1A4 000000A4  3B 83 00 00 */	addi r28, r3, data_805F43B4@l
/* 805EE1A8 000000A8  3C 60 00 00 */	lis r3, lit_3774@ha
/* 805EE1AC 000000AC  3B 63 00 00 */	addi r27, r3, lit_3774@l
lbl_805EE1B0:
...
/* 805EE284 0000002C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805EE288 00000030  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 805EE2BC 00000064  3C 60 00 00 */	lis r3, s_ko_del__FPvPv@ha
/* 805EE2C0 00000068  38 63 00 00 */	addi r3, r3, s_ko_del__FPvPv@l
/* 805EE2C4 0000006C  7F E4 FB 78 */	mr r4, r31
/* 805EE2C8 00000070  4B FF F5 F1 */	bl fpcEx_Search__FPFPvPv_PvPv
/* 805EE2CC 00000074  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805EE2D0 00000078  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
lbl_805EE304:
/* 805EE304 00000000  3C 60 00 00 */	lis r3, lit_3794@ha
/* 805EE308 00000004  C0 23 00 00 */	lfs f1, lit_3794@l(r3)
/* 805EE30C 00000008  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 805EE310 0000000C  3C 60 00 00 */	lis r3, lit_3774@ha
/* 805EE314 00000010  C0 03 00 00 */	lfs f0, lit_3774@l(r3)
/* 805EE318 00000014  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 805EE31C 00000018  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 805EE320 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 805EE324 00000020  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 805EE344 00000040  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 805EE348 00000044  3B 63 00 00 */	addi r27, r3, g_dComIfG_gameInfo@l
/* 805EE34C 00000048  3C 60 00 00 */	lis r3, data_805F43BC@ha
/* 805EE350 0000004C  3B 83 00 00 */	addi r28, r3, data_805F43BC@l
/* 805EE354 00000050  3C 60 00 00 */	lis r3, lit_3774@ha
/* 805EE358 00000054  3B A3 00 00 */	addi r29, r3, lit_3774@l
lbl_805EE35C:

...
/* 805EE8A8  4B D7 39 28 */	b _savegpr_26
/* 805EE8AC  7C 7D 1B 78 */	mr r29, r3
/* 805EE8B0  3C 80 80 5F */	lis r4, lit_3774@ha
/* 805EE8B4  3B C4 41 88 */	addi r30, r4, lit_3774@l
/* 805EE8B8  3C 80 80 5F */	lis r4, l_HIO@ha
/* 805EE8BC  3B E4 47 DC */	addi r31, r4, l_HIO@l
/* 805EE8C0  C3 FF 00 10 */	lfs f31, 0x10(r31)	/* effective address: 805F47EC */
/* 805EE8C4  A8 03 07 20 */	lha r0, 0x720(r3)
/* 805EE8C8  28 00 00 0A */	cmplwi r0, 0xa
/* 805EE8CC  41 81 04 AC */	bgt lbl_805EED78
/* 805EE8D0  3C 80 80 5F */	lis r4, lit_4354@ha
/* 805EE8D4  38 84 43 C0 */	addi r4, r4, lit_4354@l
...
/* 805EE92C  3C 60 80 5F */	lis r3, target_pos@ha
/* 805EE930  3B 63 48 5C */	addi r27, r3, target_pos@l
lbl_805EE934:
...
/* 805EE960  4B C7 8D 14 */	b cM_atan2s__Fff
...
/* 805EEA3C  4B C8 10 00 */	b cLib_addCalc2__FPffff
...
/* 805EEAC4  4B C8 1B 44 */	b cLib_addCalcAngleS2__FPssss
...
/* 805EEAF8  4B C7 80 3C */	b __mi__4cXyzCFRC3Vec
...
/* 805EEB14  4B C7 8B 60 */	b cM_atan2s__Fff
...
/* 805EEB30  4B C8 1A D8 */	b cLib_addCalcAngleS2__FPssss
/* 805EEB34  38 61 00 18 */	addi r3, r1, 0x18
/* 805EEB38  4B D5 86 00 */	b PSVECSquareMag
...
/* 805EEBA8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805EEBAC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805EEC18  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805EEC1C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805EEC20:
...
/* 805EEC58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805EEC5C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805EEC60  88 03 00 EC */	lbz r0, 0xec(r3)	/* effective address: 804062AC */
...
/* 805EEC9C  4B C7 8C B8 */	b cM_rndF__Ff
...
/* 805EECFC  4B C7 8C 58 */	b cM_rndF__Ff
...
/* 805EED34  3C 60 80 5F */	lis r3, target_pos@ha
/* 805EED38  38 63 48 5C */	addi r3, r3, target_pos@l
...
/* 805EED94  4B C8 0C A8 */	b cLib_addCalc2__FPffff
...
/* 805EEDBC  4B C8 0C 80 */	b cLib_addCalc2__FPffff
/* 805EEDC0  38 7D 07 88 */	addi r3, r29, 0x788
/* 805EEDC4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805EEDC8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 805EEDCC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 805EEDD0  4B A8 7C DC */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 805EEDF8  4B C8 0C 44 */	b cLib_addCalc2__FPffff
...
/* 805EEE10  4B C8 0C 2C */	b cLib_addCalc2__FPffff
...
/* 805EEE24  4B C8 0C 18 */	b cLib_addCalc2__FPffff
lbl_805EEE28:
...
/* 805EEE3C  4B D7 33 E0 */	b _restgpr_26

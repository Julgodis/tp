...
/* 805EFB38 00000010  4B D7 26 A0 */	b _savegpr_28
/* 805EFB3C 00000014  7C 7C 1B 78 */	mr r28, r3
/* 805EFB40 00000018  7C 9E 23 78 */	mr r30, r4
/* 805EFB44 0000001C  3C 60 80 5F */	lis r3, lit_3774@ha
/* 805EFB48 00000020  3B A3 41 88 */	addi r29, r3, lit_3774@l
/* 805EFB4C 00000024  3B E0 00 00 */	li r31, 0
/* 805EFB50 00000028  38 61 00 18 */	addi r3, r1, 0x18
/* 805EFB54 0000002C  4B A8 81 14 */	b __ct__11dBgS_LinChkFv
...
/* 805EFB80 00000058  4B A8 81 E4 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 805EFB84 0000005C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805EFB88 00000060  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805EFB8C 00000064  38 63 0F 38 */	addi r3, r3, 0xf38
/* 805EFB90 00000068  38 81 00 18 */	addi r4, r1, 0x18
/* 805EFB94 0000006C  4B A8 48 20 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 805EFBC4 0000009C  4B C7 6F 70 */	b __mi__4cXyzCFRC3Vec
/* 805EFBC8 000000A0  38 61 00 0C */	addi r3, r1, 0xc
/* 805EFBCC 000000A4  4B D5 75 6C */	b PSVECSquareMag
/* 805EFBD0 000000A8  C0 1D 00 1C */	lfs f0, 0x1c(r29)	/* effective address: 805F41A4 */
...
/* 805EFBE0 00000008  C8 9D 00 60 */	lfd f4, 0x60(r29)	/* effective address: 805F41E8 */
/* 805EFBE4 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805EFBE8 00000010  C8 7D 00 68 */	lfd f3, 0x68(r29)	/* effective address: 805F41F0 */
...
lbl_805EFC30:
/* 805EFC30 00000000  C8 1D 00 70 */	lfd f0, 0x70(r29)	/* effective address: 805F41F8 */
/* 805EFC34 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805EFC38 00000000  40 80 00 10 */	bge lbl_805EFC48
/* 805EFC3C 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805EFC40 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805EFCAC 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805EFCB0 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805EFCB4:
/* 805EFCB4 00000000  C0 7E 00 00 */	lfs f3, 0(r30)
/* 805EFCB8 00000004  C0 5D 00 40 */	lfs f2, 0x40(r29)	/* effective address: 805F41C8 */
/* 805EFCBC 00000008  C0 1D 00 3C */	lfs f0, 0x3c(r29)	/* effective address: 805F41C4 */
...
/* 805EFCD8 00000024  C0 1D 00 A4 */	lfs f0, 0xa4(r29)	/* effective address: 805F422C */
...
lbl_805EFCF0:
/* 805EFCF0 00000000  C0 1D 00 1C */	lfs f0, 0x1c(r29)	/* effective address: 805F41A4 */
...
/* 805EFD00 00000004  C0 3D 00 1C */	lfs f1, 0x1c(r29)	/* effective address: 805F41A4 */
/* 805EFD04 00000008  C0 5D 00 00 */	lfs f2, 0(r29)	/* effective address: 805F4188 */
/* 805EFD08 0000000C  C0 7E 00 04 */	lfs f3, 4(r30)
/* 805EFD0C 00000010  4B C7 FD 30 */	b cLib_addCalc2__FPffff
/* 805EFD10 00000014  38 7E 00 04 */	addi r3, r30, 4
/* 805EFD14 00000018  C0 3D 00 A8 */	lfs f1, 0xa8(r29)	/* effective address: 805F4230 */
/* 805EFD18 0000001C  C0 5D 00 00 */	lfs f2, 0(r29)	/* effective address: 805F4188 */
/* 805EFD1C 00000020  C0 9D 00 AC */	lfs f4, 0xac(r29)	/* effective address: 805F4234 */
/* 805EFD20 00000024  C0 7D 00 84 */	lfs f3, 0x84(r29)	/* effective address: 805F420C */
...
/* 805EFD30 00000034  4B C7 FD 0C */	b cLib_addCalc2__FPffff
lbl_805EFD34:
/* 805EFD34 00000000  C0 3E 00 00 */	lfs f1, 0(r30)
/* 805EFD38 00000004  3C 60 80 5F */	lis r3, l_HIO@ha
/* 805EFD3C 00000008  38 63 47 DC */	addi r3, r3, l_HIO@l
/* 805EFD40 0000000C  C0 03 00 3C */	lfs f0, 0x3c(r3)	/* effective address: 805F4818 */
...
/* 805EFD5C 00000028  C0 1D 00 1C */	lfs f0, 0x1c(r29)	/* effective address: 805F41A4 */
/* 805EFD60 0000002C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805EFD64 00000000  40 81 00 3C */	ble lbl_805EFDA0
/* 805EFD68 00000004  C0 03 00 40 */	lfs f0, 0x40(r3)	/* effective address: 805F481C */
...
/* 805EFD84 00000020  C0 03 00 44 */	lfs f0, 0x44(r3)	/* effective address: 805F4820 */
...
/* 805EFDB4 00000008  4B A8 7F 28 */	b __dt__11dBgS_LinChkFv
/* 805EFDB8 0000000C  7F E3 FB 78 */	mr r3, r31
/* 805EFDBC 00000010  39 61 00 B0 */	addi r11, r1, 0xb0
/* 805EFDC0 00000014  4B D7 24 64 */	b _restgpr_28

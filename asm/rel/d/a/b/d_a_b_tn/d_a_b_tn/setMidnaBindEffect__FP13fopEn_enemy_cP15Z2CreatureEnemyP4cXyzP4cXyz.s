...
/* 8062E18C  4B D3 40 28 */	b _savegpr_19
/* 8062E190  7C 7E 1B 78 */	mr r30, r3
/* 8062E194  7C 9A 23 78 */	mr r26, r4
/* 8062E198  7C BB 2B 78 */	mr r27, r5
/* 8062E19C  7C DC 33 78 */	mr r28, r6
/* 8062E1A0  3C 60 80 63 */	lis r3, cNullVec__6Z2Calc@ha
/* 8062E1A4  3A E3 E9 04 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 8062E1A8  3C 60 80 63 */	lis r3, lit_3920@ha
/* 8062E1AC  3B E3 E6 34 */	addi r31, r3, lit_3920@l
/* 8062E1B0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8062E1B4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8062E1B8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8062E1BC  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 8062E1C0  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 8062E1E8  4B B7 E3 94 */	b dKy_darkworld_check__Fv
...
/* 8062E20C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 8062E210  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 8062E214  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 8062E218  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 8062E21C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 8062E220  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 8062E224  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 8062E228  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8062E22C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8062E230  4B D1 82 80 */	b PSMTXCopy
...
/* 8062E248  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062E24C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062E250  38 81 00 4C */	addi r4, r1, 0x4c
/* 8062E254  38 A1 00 58 */	addi r5, r1, 0x58
/* 8062E258  4B D1 8B 14 */	b PSMTXMultVec
/* 8062E25C  38 61 00 34 */	addi r3, r1, 0x34
/* 8062E260  38 81 00 58 */	addi r4, r1, 0x58
/* 8062E264  7F 65 DB 78 */	mr r5, r27
/* 8062E268  4B C3 88 CC */	b __mi__4cXyzCFRC3Vec
...
/* 8062E284  4B C3 93 F0 */	b cM_atan2s__Fff
...
/* 8062E2B8  4B C3 93 BC */	b cM_atan2s__Fff
...
/* 8062E2D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8062E2D8  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 8062E2DC  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 8062E328  4B A1 E7 68 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8062E32C  7C 79 1B 79 */	or. r25, r3, r3
/* 8062E330  41 82 00 FC */	beq lbl_8062E42C
/* 8062E334  38 61 00 40 */	addi r3, r1, 0x40
/* 8062E338  4B D1 8E 00 */	b PSVECSquareMag
...
/* 8062E3A8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8062E3AC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8062E418  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8062E41C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8062E420:
...
/* 8062E470  4B A1 E6 20 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8062E4AC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8062E4B0  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 8062E4DC  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 8062E51C  4B A1 EF B0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8062E57C  4B D3 3C 84 */	b _restgpr_19

...
/* 8062BA6C  4B D3 67 48 */	b _savegpr_19
/* 8062BA70  7C 7F 1B 78 */	mr r31, r3
/* 8062BA74  3C 60 80 63 */	lis r3, lit_3920@ha
/* 8062BA78  3A E3 E6 34 */	addi r23, r3, lit_3920@l
/* 8062BA7C  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 8062BA80  4B 9E 12 E4 */	b transS__14mDoMtx_stack_cFRC4cXyz
...
/* 8062BAAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BAB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BAB4  38 98 00 24 */	addi r4, r24, 0x24
/* 8062BAB8  4B D1 A9 F8 */	b PSMTXCopy
/* 8062BABC  80 7F 06 00 */	lwz r3, 0x600(r31)
/* 8062BAC0  4B 9E 57 2C */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 8062BB30  3C 60 80 63 */	lis r3, data_8062EBA8@ha
/* 8062BB34  38 63 EB A8 */	addi r3, r3, data_8062EBA8@l
/* 8062BB38  7C 03 E0 2E */	lwzx r0, r3, r28
/* 8062BB3C  1C 00 00 30 */	mulli r0, r0, 0x30
/* 8062BB40  7C 64 02 14 */	add r3, r4, r0
/* 8062BB44  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8062BB48  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8062BB4C  4B D1 A9 64 */	b PSMTXCopy
...
/* 8062BB94  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8062BB98  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 8062BBB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BBBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8062BC2C  4B 9E 06 74 */	b mDoMtx_ZXYrotM__FPA4_fsss
lbl_8062BC30:
/* 8062BC30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BC34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BC38  38 9D 00 24 */	addi r4, r29, 0x24
/* 8062BC3C  4B D1 A8 74 */	b PSMTXCopy
...
/* 8062BC58  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8062BC5C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8062BC60  4B D1 A8 50 */	b PSMTXCopy
/* 8062BC64  C0 37 02 70 */	lfs f1, 0x270(r23)
/* 8062BC68  C0 57 02 74 */	lfs f2, 0x274(r23)
/* 8062BC6C  C0 77 02 78 */	lfs f3, 0x278(r23)
/* 8062BC70  4B 9E 11 2C */	b transM__14mDoMtx_stack_cFfff
/* 8062BC74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BC78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BC7C  38 80 88 89 */	li r4, -30583
/* 8062BC80  38 A0 E1 A0 */	li r5, -7776
/* 8062BC84  38 C0 37 64 */	li r6, 0x3764
/* 8062BC88  4B 9E 06 18 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 8062BC8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BC90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BC94  38 9D 00 24 */	addi r4, r29, 0x24
/* 8062BC98  4B D1 A8 18 */	b PSMTXCopy
...
/* 8062BCB0  4B D1 A8 00 */	b PSMTXCopy
...
/* 8062BCD4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8062BCD8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8062BCDC  4B D1 A7 D4 */	b PSMTXCopy
/* 8062BCE0  48 00 00 7C */	b lbl_8062BD5C
lbl_8062BCE4:
/* 8062BCE4  38 7A 07 5C */	addi r3, r26, 0x75c
/* 8062BCE8  7C 7F 1A 14 */	add r3, r31, r3
/* 8062BCEC  4B 9E 10 78 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8062BCF0  2C 1E 00 04 */	cmpwi r30, 4
/* 8062BCF4  40 82 00 3C */	bne lbl_8062BD30
/* 8062BCF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BCFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BD00  7E 7F CA 14 */	add r19, r31, r25
/* 8062BD04  A8 93 09 9E */	lha r4, 0x99e(r19)
/* 8062BD08  4B 9E 07 2C */	b mDoMtx_YrotM__FPA4_fs
/* 8062BD0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BD10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BD14  A8 93 09 A0 */	lha r4, 0x9a0(r19)
/* 8062BD18  4B 9E 07 B4 */	b mDoMtx_ZrotM__FPA4_fs
/* 8062BD1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BD20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BD24  A8 93 09 9C */	lha r4, 0x99c(r19)
/* 8062BD28  4B 9E 06 74 */	b mDoMtx_XrotM__FPA4_fs
/* 8062BD2C  48 00 00 10 */	b lbl_8062BD3C
lbl_8062BD30:
/* 8062BD30  38 79 09 9C */	addi r3, r25, 0x99c
/* 8062BD34  7C 7F 1A 14 */	add r3, r31, r3
/* 8062BD38  4B 9E 12 0C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_8062BD3C:
/* 8062BD3C  3C 60 80 63 */	lis r3, data_8062F11C@ha
/* 8062BD40  38 03 F1 1C */	addi r0, r3, data_8062F11C@l
/* 8062BD44  7C 60 D2 14 */	add r3, r0, r26
/* 8062BD48  4B 9E 10 8C */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 8062BD4C  C0 34 00 08 */	lfs f1, 8(r20)
/* 8062BD50  FC 40 08 90 */	fmr f2, f1
/* 8062BD54  FC 60 08 90 */	fmr f3, f1
/* 8062BD58  4B 9E 10 E0 */	b scaleM__14mDoMtx_stack_cFfff
lbl_8062BD5C:
/* 8062BD5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8062BD60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8062BD64  38 9D 00 24 */	addi r4, r29, 0x24
/* 8062BD68  4B D1 A7 48 */	b PSMTXCopy
lbl_8062BD6C:
...
/* 8062BD94  4B 9E 54 58 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 8062BDB0  4B D1 A7 00 */	b PSMTXCopy
lbl_8062BDB4:
/* 8062BDB4  39 61 00 70 */	addi r11, r1, 0x70
/* 8062BDB8  4B D3 64 48 */	b _restgpr_19

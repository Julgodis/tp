...
/* 80622CF4  4B D3 F4 DC */	b _savegpr_26
/* 80622CF8  7C 7F 1B 78 */	mr r31, r3
/* 80622CFC  3C 60 80 63 */	lis r3, l_HIO@ha
/* 80622D00  38 63 F0 2C */	addi r3, r3, l_HIO@l
/* 80622D04  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 8062F034 */
...
/* 80622D28  3C 60 80 63 */	lis r3, data_8062EBA8@ha
/* 80622D2C  38 63 EB A8 */	addi r3, r3, data_8062EBA8@l
/* 80622D30  7C 03 00 2E */	lwzx r0, r3, r0
/* 80622D34  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80622D38  7C 65 02 14 */	add r3, r5, r0
/* 80622D3C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80622D40  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80622D44  4B D2 37 6C */	b PSMTXCopy
/* 80622D48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80622D4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80622D50  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80622D54  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80622D58  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80622D5C  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80622D60  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80622D64  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80622D68  3B 40 00 00 */	li r26, 0
/* 80622D6C  3B C0 00 00 */	li r30, 0
/* 80622D70  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80622D74  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 80622D78  3C 60 80 63 */	lis r3, data_8062ED94@ha
/* 80622D7C  3B 83 ED 94 */	addi r28, r3, data_8062ED94@l
/* 80622D80  3C 60 80 63 */	lis r3, lit_3922@ha
/* 80622D84  3B A3 E6 3C */	addi r29, r3, lit_3922@l
lbl_80622D88:
/* 80622D88  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 80622DC4  C0 3D 00 00 */	lfs f1, 0(r29)	/* effective address: 8062E63C */
/* 80622DC8  4B A2 9C C8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80622DE0  4B D3 F4 3C */	b _restgpr_26

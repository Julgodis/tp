...
/* 8061F548  4B D4 2C 94 */	b _savegpr_29
/* 8061F54C  7C 7E 1B 78 */	mr r30, r3
/* 8061F550  3C 60 80 63 */	lis r3, lit_3920@ha
/* 8061F554  3B E3 E6 34 */	addi r31, r3, lit_3920@l
...
/* 8061F58C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8061F590  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8061F594  4B D2 6F 1C */	b PSMTXCopy
/* 8061F598  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8061F59C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8061F5A0  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 8061F5A4  D0 1E 07 EC */	stfs f0, 0x7ec(r30)
/* 8061F5A8  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 8061F5AC  D0 1E 07 F0 */	stfs f0, 0x7f0(r30)
/* 8061F5B0  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 8061F5D4  4B 9E D6 2C */	b mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 8061F5F0  4B C4 83 64 */	b cM_rndF__Ff
/* 8061F5F4  C0 1F 00 50 */	lfs f0, 0x50(r31)
/* 8061F5F8  EC 20 08 2A */	fadds f1, f0, f1
/* 8061F5FC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F600  38 03 9A 20 */	addi r0, r3, sincosTable___5JMath@l
...
/* 8061F618  4B C4 83 3C */	b cM_rndF__Ff
/* 8061F61C  C0 1F 00 58 */	lfs f0, 0x58(r31)
/* 8061F620  EF E0 08 2A */	fadds f31, f0, f1
/* 8061F624  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F628  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 8061F62C  7F A3 EC 2E */	lfsx f29, r3, r29
/* 8061F630  C0 3F 00 54 */	lfs f1, 0x54(r31)
/* 8061F634  4B C4 83 20 */	b cM_rndF__Ff
...
/* 8061F664  3C 80 80 63 */	lis r4, data_8062EBE8@ha
/* 8061F668  38 84 EB E8 */	addi r4, r4, data_8062EBE8@l
/* 8061F66C  C0 04 00 30 */	lfs f0, 0x30(r4)	/* effective address: 8062EC18 */
/* 8061F670  EC 21 00 2A */	fadds f1, f1, f0
/* 8061F674  4B A5 7A A0 */	b SetGroundUpY__9dBgS_AcchFf
/* 8061F678  38 7E 09 70 */	addi r3, r30, 0x970
/* 8061F67C  C0 3F 00 64 */	lfs f1, 0x64(r31)
/* 8061F680  C0 5F 00 54 */	lfs f2, 0x54(r31)
/* 8061F684  4B C5 10 BC */	b cLib_chaseF__FPfff
/* 8061F688  38 7E 09 E4 */	addi r3, r30, 0x9e4
/* 8061F68C  3C 80 80 63 */	lis r4, data_8062F29C@ha
/* 8061F690  38 84 F2 9C */	addi r4, r4, data_8062F29C@l
/* 8061F694  A8 84 00 48 */	lha r4, 0x48(r4)	/* effective address: 8062F2E4 */
/* 8061F698  38 A0 04 00 */	li r5, 0x400
/* 8061F69C  4B C5 14 F4 */	b cLib_chaseAngleS__FPsss
/* 8061F6A0  38 7E 09 E8 */	addi r3, r30, 0x9e8
/* 8061F6A4  A8 BE 0A 5C */	lha r5, 0xa5c(r30)
/* 8061F6A8  3C 80 80 63 */	lis r4, data_8062F29C@ha
/* 8061F6AC  38 84 F2 9C */	addi r4, r4, data_8062F29C@l
/* 8061F6B0  A8 04 00 4C */	lha r0, 0x4c(r4)	/* effective address: 8062F2E8 */
/* 8061F6B4  7C 05 02 14 */	add r0, r5, r0
/* 8061F6B8  7C 04 07 34 */	extsh r4, r0
/* 8061F6BC  38 A0 08 00 */	li r5, 0x800
/* 8061F6C0  4B C5 14 D0 */	b cLib_chaseAngleS__FPsss
...
/* 8061F6DC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8061F6E0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8061F6E4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8061F70C  4B C8 C2 78 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8061F710  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 8061F714  4B C4 82 78 */	b cM_rndFX__Ff
...
/* 8061F728  4B C4 82 2C */	b cM_rndF__Ff
/* 8061F72C  C0 5F 00 54 */	lfs f2, 0x54(r31)
/* 8061F730  EC 22 08 2A */	fadds f1, f2, f1
/* 8061F734  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F738  38 03 9A 20 */	addi r0, r3, sincosTable___5JMath@l
...
/* 8061F750  4B C4 82 04 */	b cM_rndF__Ff
/* 8061F754  C0 1F 00 74 */	lfs f0, 0x74(r31)
/* 8061F758  EF C0 08 2A */	fadds f30, f0, f1
/* 8061F75C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F760  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 8061F764  7F A3 EC 2E */	lfsx f29, r3, r29
/* 8061F768  C0 3F 00 70 */	lfs f1, 0x70(r31)
/* 8061F76C  4B C4 81 E8 */	b cM_rndF__Ff
...
/* 8061F7AC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F7B0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 8061F7B4  7C 43 04 2E */	lfsx f2, r3, r0
/* 8061F7B8  38 7E 26 F0 */	addi r3, r30, 0x26f0
/* 8061F7BC  3C 80 80 63 */	lis r4, data_8062EBE8@ha
/* 8061F7C0  38 84 EB E8 */	addi r4, r4, data_8062EBE8@l
/* 8061F7C4  C0 24 00 30 */	lfs f1, 0x30(r4)	/* effective address: 8062EC18 */
/* 8061F7C8  C0 1F 00 78 */	lfs f0, 0x78(r31)
/* 8061F7CC  EC 00 00 B2 */	fmuls f0, f0, f2
/* 8061F7D0  EC 21 00 2A */	fadds f1, f1, f0
/* 8061F7D4  4B A5 79 40 */	b SetGroundUpY__9dBgS_AcchFf
/* 8061F7D8  38 7E 09 E4 */	addi r3, r30, 0x9e4
/* 8061F7DC  3C 80 80 63 */	lis r4, data_8062F29C@ha
/* 8061F7E0  38 84 F2 9C */	addi r4, r4, data_8062F29C@l
/* 8061F7E4  A8 84 00 48 */	lha r4, 0x48(r4)	/* effective address: 8062F2E4 */
/* 8061F7E8  38 A0 04 00 */	li r5, 0x400
/* 8061F7EC  4B C5 13 A4 */	b cLib_chaseAngleS__FPsss
/* 8061F7F0  38 7E 09 E8 */	addi r3, r30, 0x9e8
/* 8061F7F4  3C 80 80 63 */	lis r4, data_8062F29C@ha
/* 8061F7F8  38 84 F2 9C */	addi r4, r4, data_8062F29C@l
/* 8061F7FC  A8 84 00 4C */	lha r4, 0x4c(r4)	/* effective address: 8062F2E8 */
/* 8061F800  38 A0 04 00 */	li r5, 0x400
/* 8061F804  4B C5 13 8C */	b cLib_chaseAngleS__FPsss
/* 8061F808  38 7E 0A 5C */	addi r3, r30, 0xa5c
/* 8061F80C  38 80 00 00 */	li r4, 0
/* 8061F810  38 A0 00 60 */	li r5, 0x60
/* 8061F814  4B C5 13 7C */	b cLib_chaseAngleS__FPsss
...
/* 8061F82C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F830  38 A3 9A 20 */	addi r5, r3, sincosTable___5JMath@l
...
/* 8061F8C4  4B C5 0E 7C */	b cLib_chaseF__FPfff
...
/* 8061F934  4B 9F D1 A4 */	b fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
...
/* 8061F954  4B C4 80 00 */	b cM_rndF__Ff
/* 8061F958  C0 5F 00 54 */	lfs f2, 0x54(r31)
/* 8061F95C  EC 22 08 2A */	fadds f1, f2, f1
/* 8061F960  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F964  38 03 9A 20 */	addi r0, r3, sincosTable___5JMath@l
...
/* 8061F97C  4B C4 7F D8 */	b cM_rndF__Ff
/* 8061F980  C0 1F 00 74 */	lfs f0, 0x74(r31)
/* 8061F984  EF C0 08 2A */	fadds f30, f0, f1
/* 8061F988  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8061F98C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 8061F990  7F A3 EC 2E */	lfsx f29, r3, r29
/* 8061F994  C0 3F 00 70 */	lfs f1, 0x70(r31)
/* 8061F998  4B C4 7F BC */	b cM_rndF__Ff
...
/* 8061F9E0  4B D4 28 48 */	b _restgpr_29

...
/* 8062C878  4B D3 59 48 */	b _savegpr_22
/* 8062C87C  7C 7F 1B 78 */	mr r31, r3
/* 8062C880  3C 60 80 63 */	lis r3, cNullVec__6Z2Calc@ha
/* 8062C884  3B C3 E9 04 */	addi r30, r3, cNullVec__6Z2Calc@l
/* 8062C888  88 1F 0A A5 */	lbz r0, 0xaa5(r31)
/* 8062C88C  28 00 00 00 */	cmplwi r0, 0
/* 8062C890  40 82 00 34 */	bne lbl_8062C8C4
/* 8062C894  3C 60 80 63 */	lis r3, stringBase0@ha
/* 8062C898  38 63 E8 E8 */	addi r3, r3, stringBase0@l
/* 8062C89C  38 63 00 05 */	addi r3, r3, 5
/* 8062C8A0  38 80 00 03 */	li r4, 3
/* 8062C8A4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8062C8A8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8062C8AC  3C A5 00 02 */	addis r5, r5, 2
/* 8062C8B0  38 C0 00 80 */	li r6, 0x80
/* 8062C8B4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8062C8B8  4B A0 FA 34 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8062C8BC  7C 7A 1B 78 */	mr r26, r3
/* 8062C8C0  48 00 00 30 */	b lbl_8062C8F0
lbl_8062C8C4:
/* 8062C8C4  3C 60 80 63 */	lis r3, stringBase0@ha
/* 8062C8C8  38 63 E8 E8 */	addi r3, r3, stringBase0@l
/* 8062C8CC  38 63 00 0B */	addi r3, r3, 0xb
/* 8062C8D0  38 80 00 04 */	li r4, 4
/* 8062C8D4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8062C8D8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8062C8DC  3C A5 00 02 */	addis r5, r5, 2
/* 8062C8E0  38 C0 00 80 */	li r6, 0x80
/* 8062C8E4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8062C8E8  4B A0 FA 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8062C8EC  7C 7A 1B 78 */	mr r26, r3
lbl_8062C8F0:
/* 8062C8F0  38 60 00 58 */	li r3, 0x58
/* 8062C8F4  4B CA 23 58 */	b __nw__FUl
/* 8062C8F8  7C 77 1B 79 */	or. r23, r3, r3
/* 8062C8FC  41 82 00 74 */	beq lbl_8062C970
/* 8062C900  3C 60 80 63 */	lis r3, stringBase0@ha
/* 8062C904  38 63 E8 E8 */	addi r3, r3, stringBase0@l
/* 8062C908  38 80 00 0F */	li r4, 0xf
/* 8062C90C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8062C910  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8062C914  3C A5 00 02 */	addis r5, r5, 2
/* 8062C918  38 C0 00 80 */	li r6, 0x80
/* 8062C91C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8062C920  4B A0 F9 CC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062C958  3D 20 80 63 */	lis r9, lit_3922@ha
/* 8062C95C  C0 29 E6 3C */	lfs f1, lit_3922@l(r9)
/* 8062C960  39 20 00 00 */	li r9, 0
/* 8062C964  39 40 FF FF */	li r10, -1
/* 8062C968  4B 9E 3E 68 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8062C9A4  4B CA 22 A8 */	b __nw__FUl
/* 8062C9A8  7C 77 1B 79 */	or. r23, r3, r3
/* 8062C9AC  41 82 00 20 */	beq lbl_8062C9CC
/* 8062C9B0  3C 80 80 63 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8062C9B4  38 04 EF A8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8062C9B8  90 17 00 00 */	stw r0, 0(r23)
/* 8062C9BC  38 80 00 00 */	li r4, 0
/* 8062C9C0  4B CF BA 3C */	b init__12J3DFrameCtrlFs
...
/* 8062C9EC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8062C9F0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8062C9F4  3C A5 00 02 */	addis r5, r5, 2
/* 8062C9F8  38 C0 00 80 */	li r6, 0x80
/* 8062C9FC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8062CA00  4B A0 F8 EC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062CA18  3D 00 80 63 */	lis r8, lit_3921@ha
/* 8062CA1C  C0 28 E6 38 */	lfs f1, lit_3921@l(r8)
/* 8062CA20  39 00 00 00 */	li r8, 0
/* 8062CA24  39 20 FF FF */	li r9, -1
/* 8062CA28  4B 9E 0C E4 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8062CA54  3C 60 80 62 */	lis r3, JointCallBack__8daB_TN_cFP8J3DJointi@ha
/* 8062CA58  38 03 ED 10 */	addi r0, r3, JointCallBack__8daB_TN_cFP8J3DJointi@l
...
/* 8062CA78  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8062CA7C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8062CABC  4B A0 F8 30 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062CAEC  4B A0 F8 00 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062CB00  4B 9E 81 54 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8062CB58  4B CA 20 F4 */	b __nw__FUl
/* 8062CB5C  7C 77 1B 79 */	or. r23, r3, r3
/* 8062CB60  41 82 00 20 */	beq lbl_8062CB80
/* 8062CB64  3C 80 80 63 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8062CB68  38 04 EF A8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8062CB6C  90 17 00 00 */	stw r0, 0(r23)
/* 8062CB70  38 80 00 00 */	li r4, 0
/* 8062CB74  4B CF B8 88 */	b init__12J3DFrameCtrlFs
...
/* 8062CBB4  4B A0 F7 38 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062CBCC  3D 00 80 63 */	lis r8, lit_3921@ha
/* 8062CBD0  C0 28 E6 38 */	lfs f1, lit_3921@l(r8)
/* 8062CBD4  39 00 00 00 */	li r8, 0
/* 8062CBD8  39 20 FF FF */	li r9, -1
/* 8062CBDC  4B 9E 0B 30 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 8062CC20  4B A0 F6 CC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8062CC24  7C 78 1B 78 */	mr r24, r3
/* 8062CC28  38 60 00 58 */	li r3, 0x58
/* 8062CC2C  4B CA 20 20 */	b __nw__FUl
/* 8062CC30  7C 77 1B 79 */	or. r23, r3, r3
/* 8062CC34  41 82 00 68 */	beq lbl_8062CC9C
/* 8062CC38  3C 60 80 63 */	lis r3, stringBase0@ha
/* 8062CC3C  38 63 E8 E8 */	addi r3, r3, stringBase0@l
/* 8062CC40  38 80 00 27 */	li r4, 0x27
/* 8062CC44  7F A5 EB 78 */	mr r5, r29
/* 8062CC48  38 C0 00 80 */	li r6, 0x80
/* 8062CC4C  4B A0 F6 A0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062CC84  3D 20 80 63 */	lis r9, lit_3922@ha
/* 8062CC88  C0 29 E6 3C */	lfs f1, lit_3922@l(r9)
/* 8062CC8C  39 20 00 00 */	li r9, 0
/* 8062CC90  39 40 FF FF */	li r10, -1
/* 8062CC94  4B 9E 3B 3C */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_8062CCC0:
/* 8062CCC0  3C 60 80 63 */	lis r3, stringBase0@ha
/* 8062CCC4  38 63 E8 E8 */	addi r3, r3, stringBase0@l
/* 8062CCC8  38 80 00 30 */	li r4, 0x30
/* 8062CCCC  7F A5 EB 78 */	mr r5, r29
/* 8062CCD0  38 C0 00 80 */	li r6, 0x80
/* 8062CCD4  4B A0 F6 18 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8062CCE4  4B 9E 7F 70 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8062CCFC  4B D3 55 10 */	b _restgpr_22

...
/* 805C7B44 00000018  3C 60 00 00 */	lis r3, stringBase0@ha
/* 805C7B48 0000001C  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 805C7B4C 00000020  38 80 00 49 */	li r4, 0x49
/* 805C7B50 00000024  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 805C7B54 00000028  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 805C7B8C 00000060  3C 60 00 00 */	lis r3, stringBase0@ha
/* 805C7B90 00000064  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 805C7BD8 000000AC  3D 20 00 00 */	lis r9, lit_3844@ha
/* 805C7BDC 000000B0  C0 29 00 00 */	lfs f1, lit_3844@l(r9)
...
/* 805C7C08 00000010  3C 60 00 00 */	lis r3, stringBase0@ha
/* 805C7C0C 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 805C7C54 0000005C  3D 20 00 00 */	lis r9, lit_3844@ha
/* 805C7C58 00000060  C0 29 00 00 */	lfs f1, lit_3844@l(r9)
...
/* 805C7CA0 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 805C7CA4 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
lbl_805C7CD4:
/* 805C7CD4 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 805C7CD8 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 805C7D0C 00000038  3D 00 00 00 */	lis r8, lit_3844@ha
/* 805C7D10 0000003C  C0 28 00 00 */	lfs f1, lit_3844@l(r8)

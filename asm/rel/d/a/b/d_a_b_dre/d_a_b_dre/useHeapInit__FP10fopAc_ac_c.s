...
/* 805C7B3C 00000010  4B D9 A6 9C */	b _savegpr_28
/* 805C7B40 00000014  7C 7F 1B 78 */	mr r31, r3
/* 805C7B44 00000018  3C 60 80 5D */	lis r3, stringBase0@ha
/* 805C7B48 0000001C  38 63 AE CC */	addi r3, r3, stringBase0@l
/* 805C7B4C 00000020  38 80 00 49 */	li r4, 0x49
/* 805C7B50 00000024  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 805C7B54 00000028  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 805C7B68 0000003C  4B A7 47 84 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7B80 00000054  4B D0 70 CC */	b __nw__FUl
/* 805C7B84 00000058  7C 7C 1B 79 */	or. r28, r3, r3
/* 805C7B88 0000005C  41 82 00 68 */	beq lbl_805C7BF0
/* 805C7B8C 00000060  3C 60 80 5D */	lis r3, stringBase0@ha
/* 805C7B90 00000064  38 63 AE CC */	addi r3, r3, stringBase0@l
/* 805C7B94 00000068  38 80 00 1D */	li r4, 0x1d
/* 805C7B98 0000006C  7F A5 EB 78 */	mr r5, r29
/* 805C7B9C 00000070  38 C0 00 80 */	li r6, 0x80
/* 805C7BA0 00000074  4B A7 47 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7BD8 000000AC  3D 20 80 5D */	lis r9, lit_3844@ha
/* 805C7BDC 000000B0  C0 29 AD 5C */	lfs f1, lit_3844@l(r9)
/* 805C7BE0 000000B4  39 20 00 00 */	li r9, 0
/* 805C7BE4 000000B8  39 40 FF FF */	li r10, -1
/* 805C7BE8 000000BC  4B A4 8B E8 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805C7BFC 00000004  4B D0 70 50 */	b __nw__FUl
/* 805C7C00 00000008  7C 7C 1B 79 */	or. r28, r3, r3
/* 805C7C04 0000000C  41 82 00 68 */	beq lbl_805C7C6C
/* 805C7C08 00000010  3C 60 80 5D */	lis r3, stringBase0@ha
/* 805C7C0C 00000014  38 63 AE CC */	addi r3, r3, stringBase0@l
/* 805C7C10 00000018  38 80 00 1F */	li r4, 0x1f
/* 805C7C14 0000001C  7F A5 EB 78 */	mr r5, r29
/* 805C7C18 00000020  38 C0 00 80 */	li r6, 0x80
/* 805C7C1C 00000024  4B A7 46 D0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7C54 0000005C  3D 20 80 5D */	lis r9, lit_3844@ha
/* 805C7C58 00000060  C0 29 AD 5C */	lfs f1, lit_3844@l(r9)
/* 805C7C5C 00000064  39 20 00 00 */	li r9, 0
/* 805C7C60 00000068  39 40 FF FF */	li r10, -1
/* 805C7C64 0000006C  4B A4 8B 6C */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 805C7C94 00000004  4B D0 6F B8 */	b __nw__FUl
/* 805C7C98 00000008  7C 7E 1B 79 */	or. r30, r3, r3
/* 805C7C9C 0000000C  41 82 00 20 */	beq lbl_805C7CBC
/* 805C7CA0 00000010  3C 80 80 5D */	lis r4, __vt__12J3DFrameCtrl@ha
/* 805C7CA4 00000014  38 04 B0 28 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 805C7CA8 00000018  90 1E 00 00 */	stw r0, 0(r30)
/* 805C7CAC 0000001C  38 80 00 00 */	li r4, 0
/* 805C7CB0 00000020  4B D6 07 4C */	b init__12J3DFrameCtrlFs
...
lbl_805C7CD4:
/* 805C7CD4 00000000  3C 60 80 5D */	lis r3, stringBase0@ha
/* 805C7CD8 00000004  38 63 AE CC */	addi r3, r3, stringBase0@l
/* 805C7CDC 00000008  38 80 00 51 */	li r4, 0x51
/* 805C7CE0 0000000C  7F A5 EB 78 */	mr r5, r29
/* 805C7CE4 00000010  38 C0 00 80 */	li r6, 0x80
/* 805C7CE8 00000014  4B A7 46 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805C7D0C 00000038  3D 00 80 5D */	lis r8, lit_3844@ha
/* 805C7D10 0000003C  C0 28 AD 5C */	lfs f1, lit_3844@l(r8)
/* 805C7D14 00000040  39 00 00 00 */	li r8, 0
/* 805C7D18 00000044  39 20 FF FF */	li r9, -1
/* 805C7D1C 00000048  4B A4 59 F0 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 805C7D58 00000004  4B D9 A4 CC */	b _restgpr_28

...
/* 805C8C10 00000018  3C 80 80 5D */	lis r4, lit_3844@ha
/* 805C8C14 0000001C  3B E4 AD 5C */	addi r31, r4, lit_3844@l
...
/* 805C8C50 00000008  C0 3F 00 4C */	lfs f1, 0x4c(r31)	/* effective address: 805CADA8 */
/* 805C8C54 0000000C  4B D5 F7 D8 */	b checkPass__12J3DFrameCtrlFf
/* 805C8C58 00000010  2C 03 00 00 */	cmpwi r3, 0
/* 805C8C5C 00000014  41 82 00 14 */	beq lbl_805C8C70
/* 805C8C60 00000018  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 805CAD60 */
/* 805C8C64 0000001C  D0 1E 06 14 */	stfs f0, 0x614(r30)
/* 805C8C68 00000020  C0 1F 00 68 */	lfs f0, 0x68(r31)	/* effective address: 805CADC4 */
...
/* 805C8C84 00000014  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 805CAD60 */
...
/* 805C8CBC 00000024  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 805CAD98 */
/* 805C8CC0 00000028  C0 5F 00 00 */	lfs f2, 0(r31)	/* effective address: 805CAD5C */
...
/* 805C8CD4 00000008  C0 3F 00 6C */	lfs f1, 0x6c(r31)	/* effective address: 805CADC8 */
/* 805C8CD8 0000000C  4B D5 F7 54 */	b checkPass__12J3DFrameCtrlFf
...
/* 805C8CEC 00000020  C0 1F 00 68 */	lfs f0, 0x68(r31)	/* effective address: 805CADC4 */
...
/* 805C8D0C 00000008  C0 3F 00 70 */	lfs f1, 0x70(r31)	/* effective address: 805CADCC */
/* 805C8D10 0000000C  4B D5 F7 1C */	b checkPass__12J3DFrameCtrlFf
/* 805C8D14 00000010  2C 03 00 00 */	cmpwi r3, 0
/* 805C8D18 00000014  41 82 00 1C */	beq lbl_805C8D34
/* 805C8D1C 00000018  C0 1F 00 68 */	lfs f0, 0x68(r31)	/* effective address: 805CADC4 */
...
/* 805C8D3C 00000008  C0 1F 00 70 */	lfs f0, 0x70(r31)	/* effective address: 805CADCC */
...
/* 805C8D4C 00000008  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 805CAD60 */
/* 805C8D50 0000000C  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 805CADB0 */
/* 805C8D54 00000010  C0 7F 00 00 */	lfs f3, 0(r31)	/* effective address: 805CAD5C */
/* 805C8D58 00000014  4B CA 6C E4 */	b cLib_addCalc2__FPffff
/* 805C8D5C 00000018  48 00 00 18 */	b lbl_805C8D74
lbl_805C8D60:
/* 805C8D60 00000000  38 7E 05 F8 */	addi r3, r30, 0x5f8
/* 805C8D64 00000004  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 805CAD60 */
/* 805C8D68 00000008  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 805CADB0 */
/* 805C8D6C 0000000C  C0 7F 00 00 */	lfs f3, 0(r31)	/* effective address: 805CAD5C */
/* 805C8D70 00000010  4B CA 6C CC */	b cLib_addCalc2__FPffff
lbl_805C8D74:
...
/* 805C8D88 00000014  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 805CAD60 */
...
/* 805C8DB0 00000014  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 805CAD98 */
/* 805C8DB4 00000018  C0 5F 00 00 */	lfs f2, 0(r31)	/* effective address: 805CAD5C */
/* 805C8DB8 0000001C  4B FF F0 1D */	bl SetAnm__9daB_DRE_cFP16mDoExt_McaMorfSOiiff
/* 805C8DBC 00000020  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 805CAD84 */
...
/* 805C8DDC 00000040  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805C8DE0 00000044  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805C8DE4 00000048  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 805C8DE8 0000004C  38 80 00 1F */	li r4, 0x1f
/* 805C8DEC 00000050  4B AA 6F A8 */	b StopQuake__12dVibration_cFi
/* 805C8DF0 00000054  48 00 00 D4 */	b lbl_805C8EC4
lbl_805C8DF4:
/* 805C8DF4 00000000  C0 3E 04 D4 */	lfs f1, 0x4d4(r30)
/* 805C8DF8 00000004  C0 1F 00 74 */	lfs f0, 0x74(r31)	/* effective address: 805CADD0 */
...
/* 805C8E0C 0000000C  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 805CAD60 */
...
/* 805C8E20 00000020  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 805CAD74 */
/* 805C8E24 00000024  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 805C8E28 00000028  C0 1F 00 78 */	lfs f0, 0x78(r31)	/* effective address: 805CADD4 */
...
/* 805C8E40 00000040  4B CA 7F 80 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 805C8E5C 0000005C  3C 60 80 5D */	lis r3, data_805CB084@ha
/* 805C8E60 00000060  38 63 B0 84 */	addi r3, r3, data_805CB084@l
/* 805C8E64 00000064  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 805CB084 */
/* 805C8E68 00000068  C0 03 00 00 */	lfs f0, 0(r3)	/* effective address: 805CB084 */
/* 805C8E6C 0000006C  D0 1E 05 C8 */	stfs f0, 0x5c8(r30)
/* 805C8E70 00000070  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 805CB088 */
/* 805C8E74 00000074  D0 1E 05 CC */	stfs f0, 0x5cc(r30)
/* 805C8E78 00000078  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 805CB08C */
/* 805C8E7C 0000007C  D0 1E 05 D0 */	stfs f0, 0x5d0(r30)
/* 805C8E80 00000080  C0 3E 05 CC */	lfs f1, 0x5cc(r30)
/* 805C8E84 00000084  C0 1F 00 48 */	lfs f0, 0x48(r31)	/* effective address: 805CADA4 */
/* 805C8E88 00000088  EC 01 00 2A */	fadds f0, f1, f0
/* 805C8E8C 0000008C  D0 1E 05 CC */	stfs f0, 0x5cc(r30)
/* 805C8E90 00000090  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805C8E94 00000094  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 805C8EA4 000000A4  4B A6 C3 5C */	b onSwitch__10dSv_info_cFii
...
/* 805C8EC0 0000000C  4B A5 0D BC */	b fopAcM_delete__FP10fopAc_ac_c
lbl_805C8EC4:

...
/* 805CA50C 00000010  4B D9 7C B4 */	b _savegpr_22
/* 805CA510 00000014  7C 7C 1B 78 */	mr r28, r3
/* 805CA514 00000018  3C 60 80 5D */	lis r3, lit_3844@ha
/* 805CA518 0000001C  3B C3 AD 5C */	addi r30, r3, lit_3844@l
/* 805CA51C 00000020  38 7C 06 18 */	addi r3, r28, 0x618
/* 805CA520 00000024  C0 3E 00 80 */	lfs f1, 0x80(r30)	/* effective address: 805CADDC */
/* 805CA524 00000028  C0 5E 01 50 */	lfs f2, 0x150(r30)	/* effective address: 805CAEAC */
/* 805CA528 0000002C  C0 7E 01 54 */	lfs f3, 0x154(r30)	/* effective address: 805CAEB0 */
/* 805CA52C 00000030  4B CA 55 10 */	b cLib_addCalc2__FPffff
...
/* 805CA540 00000044  3C 60 80 5D */	lis r3, data_805CB0D4@ha
/* 805CA544 00000048  98 03 B0 D4 */	stb r0, data_805CB0D4@l(r3)
...
/* 805CA564 00000068  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805CA568 0000006C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 805CA56C 00000070  3C 60 80 5D */	lis r3, data_805CAFAC@ha
/* 805CA570 00000074  3A C3 AF AC */	addi r22, r3, data_805CAFAC@l
/* 805CA574 00000078  3C 60 80 5D */	lis r3, data_805CB098@ha
/* 805CA578 0000007C  3A E3 B0 98 */	addi r23, r3, data_805CB098@l
/* 805CA57C 00000080  3C 60 00 07 */	lis r3, 0x0007 /* 0x0007047C@ha */
/* 805CA580 00000084  3B 23 04 7C */	addi r25, r3, 0x047C /* 0x0007047C@l */
lbl_805CA584:
/* 805CA584 00000000  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)	/* effective address: 8040BEFC */
...
/* 805CA5CC 00000048  C0 3E 00 00 */	lfs f1, 0(r30)	/* effective address: 805CAD5C */
/* 805CA5D0 0000004C  4B A8 2E FC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 805CA5D4 00000050  7C 7C C1 2E */	stwx r3, r28, r24
/* 805CA5D8 00000054  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)	/* effective address: 8040BEFC */
/* 805CA5DC 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 805CA5E0 0000005C  7C 9C C0 2E */	lwzx r4, r28, r24
/* 805CA5E4 00000060  4B A8 13 34 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805CA610 0000008C  4B CB 61 F8 */	b func_80280808
...
/* 805CA65C 00000038  4B D9 7B B0 */	b _restgpr_22

...
/* 805CA168 00000010  4B FF D9 31 */	bl _savegpr_29
/* 805CA16C 00000014  7C 7D 1B 78 */	mr r29, r3
/* 805CA170 00000018  3C 60 00 00 */	lis r3, lit_1109@ha /* 805CB040 */
/* 805CA174 0000001C  3B C3 00 00 */	addi r30, r3, lit_1109@l /* 805CB040 */
/* 805CA178 00000020  3C 60 00 00 */	lis r3, lit_3844@ha /* 805CAD5C */
/* 805CA17C 00000024  3B E3 00 00 */	addi r31, r3, lit_3844@l /* 805CAD5C */
/* 805CA180 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805CA184 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805CA198 00000040  4B FF D9 01 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805CA1A8 00000050  4B FF D8 F1 */	bl PSVECSquareDistance
...
/* 805CA218 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805CA21C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 805CA288 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805CA28C 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_805CA290:
...
/* 805CA2B8 00000028  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805CA2BC 0000002C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805CA2C0 00000030  4B FF D7 D9 */	bl PSMTXCopy
/* 805CA2C4 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805CA2C8 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805CA2CC 0000003C  38 81 00 0C */	addi r4, r1, 0xc
/* 805CA2D0 00000040  7C 85 23 78 */	mr r5, r4
/* 805CA2D4 00000044  4B FF D7 C5 */	bl PSMTXMultVec
...
/* 805CA318 00000088  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805CA31C 0000008C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805CA320 00000090  4B FF D7 79 */	bl PSMTXCopy
/* 805CA324 00000094  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805CA328 00000098  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805CA32C 0000009C  38 81 00 0C */	addi r4, r1, 0xc
/* 805CA330 000000A0  7C 85 23 78 */	mr r5, r4
/* 805CA334 000000A4  4B FF D7 65 */	bl PSMTXMultVec
...
/* 805CA378 000000E8  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805CA37C 000000EC  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805CA380 000000F0  4B FF D7 19 */	bl PSMTXCopy
/* 805CA384 000000F4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805CA388 000000F8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805CA38C 000000FC  38 81 00 0C */	addi r4, r1, 0xc
/* 805CA390 00000100  7C 85 23 78 */	mr r5, r4
/* 805CA394 00000104  4B FF D7 05 */	bl PSMTXMultVec
...
/* 805CA444 00000060  4B FF D6 55 */	bl play__14mDoExt_baseAnmFv
lbl_805CA448:
/* 805CA448 00000000  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 805CA44C 00000004  7C 03 07 74 */	extsb r3, r0
/* 805CA450 00000008  4B FF D6 49 */	bl dComIfGp_getReverb__Fi
...
/* 805CA460 00000018  4B FF D6 39 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 805CA464 0000001C  38 7D 07 30 */	addi r3, r29, 0x730
/* 805CA468 00000020  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805CA46C 00000024  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805CA470 00000028  38 84 0F 38 */	addi r4, r4, 0xf38
/* 805CA474 0000002C  4B FF D6 25 */	bl CrrPos__9dBgS_AcchFR4dBgS
...
/* 805CA488 00000040  4B FF D6 11 */	bl _restgpr_29

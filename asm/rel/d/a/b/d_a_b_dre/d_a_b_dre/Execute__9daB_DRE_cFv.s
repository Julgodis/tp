...
/* 805CA168  4B D9 80 74 */	b _savegpr_29
/* 805CA16C  7C 7D 1B 78 */	mr r29, r3
/* 805CA170  3C 60 80 5D */	lis r3, lit_1109@ha
...
/* 805CA1A8  4B D7 D1 F4 */	b PSVECSquareDistance
...
/* 805CA218  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805CA21C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805CA288  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805CA28C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805CA290:
...
/* 805CA2B8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805CA2BC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805CA2C0  4B D7 C1 F0 */	b PSMTXCopy
/* 805CA2C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CA2C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CA2CC  38 81 00 0C */	addi r4, r1, 0xc
/* 805CA2D0  7C 85 23 78 */	mr r5, r4
/* 805CA2D4  4B D7 CA 98 */	b PSMTXMultVec
...
/* 805CA318  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805CA31C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805CA320  4B D7 C1 90 */	b PSMTXCopy
/* 805CA324  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CA328  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CA32C  38 81 00 0C */	addi r4, r1, 0xc
/* 805CA330  7C 85 23 78 */	mr r5, r4
/* 805CA334  4B D7 CA 38 */	b PSMTXMultVec
...
/* 805CA378  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805CA37C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805CA380  4B D7 C1 30 */	b PSMTXCopy
/* 805CA384  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805CA388  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805CA38C  38 81 00 0C */	addi r4, r1, 0xc
/* 805CA390  7C 85 23 78 */	mr r5, r4
/* 805CA394  4B D7 C9 D8 */	b PSMTXMultVec
...
/* 805CA444  4B A4 2F E4 */	b play__14mDoExt_baseAnmFv
lbl_805CA448:
/* 805CA448  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 805CA44C  7C 03 07 74 */	extsb r3, r0
/* 805CA450  4B A6 2C 1C */	b dComIfGp_getReverb__Fi
...
/* 805CA488  4B D9 7D A0 */	b _restgpr_29

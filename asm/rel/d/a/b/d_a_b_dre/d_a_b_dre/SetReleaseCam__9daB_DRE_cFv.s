...
/* 805C8554  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805C8558  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 805C855C  88 04 5D B0 */	lbz r0, 0x5db0(r4)	/* effective address: 8040BF70 */
...
/* 805C85AC  4B BB 86 6C */	b Reset__9dCamera_cF4cXyz4cXyz
/* 805C85B0  38 7F 02 48 */	addi r3, r31, 0x248
/* 805C85B4  4B B9 8E F8 */	b Start__9dCamera_cFv
/* 805C85B8  38 7F 02 48 */	addi r3, r31, 0x248
/* 805C85BC  38 80 00 00 */	li r4, 0
/* 805C85C0  4B B9 AA 4C */	b SetTrimSize__9dCamera_cFl
/* 805C85C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805C85C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805C85CC  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 805C85D0  4B A7 9E 98 */	b reset__14dEvt_control_cFv

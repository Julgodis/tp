...
/* 805C7AE4 00000010  3C 60 80 5D */	lis r3, __global_destructor_chain@ha
/* 805C7AE8 00000014  3B E3 B0 38 */	addi r31, r3, __global_destructor_chain@l
/* 805C7AEC 00000018  48 00 00 20 */	b lbl_805C7B0C
lbl_805C7AF0:
/* 805C7AF0 00000000  80 05 00 00 */	lwz r0, 0(r5)
/* 805C7AF4 00000004  90 1F 00 00 */	stw r0, 0(r31)	/* effective address: 805CB038 */
...
lbl_805C7B0C:
/* 805C7B0C 00000000  80 BF 00 00 */	lwz r5, 0(r31)	/* effective address: 805CB038 */

...
/* 805F4DDC 00000010  4B D6 D3 FC */	b _savegpr_28
...
/* 805F4DEC 00000020  3C 60 80 43 */	lis r3, j3dSys@ha
/* 805F4DF0 00000024  38 63 4A C8 */	addi r3, r3, j3dSys@l
/* 805F4DF4 00000028  83 E3 00 38 */	lwz r31, 0x38(r3)	/* effective address: 80434B00 */
...
/* 805F4E14 00000048  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 805F4E18 0000004C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 805F4E1C 00000050  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 805F4E20 00000054  4B D5 16 90 */	b PSMTXCopy
...
lbl_805F4E34:
/* 805F4E34 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805F4E38 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805F4E3C 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 805F4E50 0000001C  4B A1 76 7C */	b mDoMtx_ZrotM__FPA4_fs
...
lbl_805F4E68:
/* 805F4E68 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805F4E6C 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805F4E70 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 805F4E84 0000001C  4B A1 75 B0 */	b mDoMtx_YrotM__FPA4_fs
...
lbl_805F4E9C:
/* 805F4E9C 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805F4EA0 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805F4EA4 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 805F4EB4 00000018  4B A1 75 80 */	b mDoMtx_YrotM__FPA4_fs
...
lbl_805F4ECC:
/* 805F4ECC 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805F4ED0 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805F4ED4 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 805F4EE4 00000018  4B A1 75 50 */	b mDoMtx_YrotM__FPA4_fs
lbl_805F4EE8:
/* 805F4EE8 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805F4EEC 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805F4EF0 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 805F4F00 00000018  4B D5 15 B0 */	b PSMTXCopy
/* 805F4F04 0000001C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805F4F08 00000020  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805F4F0C 00000024  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805F4F10 00000028  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 805F4F14 0000002C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 805F4F18 00000030  4B D5 15 98 */	b PSMTXCopy
lbl_805F4F1C:
/* 805F4F1C 00000000  38 60 00 01 */	li r3, 1
/* 805F4F20 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 805F4F24 00000008  4B D6 D3 00 */	b _restgpr_28

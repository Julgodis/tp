...
/* 805F4DDC 00000010  4B FF FB DD */	bl _savegpr_28
...
/* 805F4DEC 00000020  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 805F4DF0 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l /* 80434AC8 */
...
/* 805F4E14 00000048  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 805F4E18 0000004C  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
/* 805F4E1C 00000050  80 84 00 00 */	lwz r4, 0(r4)
/* 805F4E20 00000054  4B FF FB 99 */	bl PSMTXCopy
...
lbl_805F4E34:
/* 805F4E34 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805F4E38 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 805F4E50 0000001C  4B FF FB 69 */	bl mDoMtx_ZrotM__FPA4_fs
...
lbl_805F4E68:
/* 805F4E68 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805F4E6C 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 805F4E84 0000001C  4B FF FB 35 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_805F4E9C:
/* 805F4E9C 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805F4EA0 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 805F4EB4 00000018  4B FF FB 05 */	bl mDoMtx_YrotM__FPA4_fs
...
lbl_805F4ECC:
/* 805F4ECC 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805F4ED0 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 805F4EE4 00000018  4B FF FA D5 */	bl mDoMtx_YrotM__FPA4_fs
lbl_805F4EE8:
/* 805F4EE8 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805F4EEC 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 805F4F00 00000018  4B FF FA B9 */	bl PSMTXCopy
/* 805F4F04 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805F4F08 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 805F4F0C 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 805F4F10 00000028  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 805F4F14 0000002C  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */
/* 805F4F18 00000030  4B FF FA A1 */	bl PSMTXCopy
lbl_805F4F1C:
/* 805F4F1C 00000000  38 60 00 01 */	li r3, 1
/* 805F4F20 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 805F4F24 00000008  4B FF FA 95 */	bl _restgpr_28

...
/* 805DFF7C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DFF80  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805DFF84  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 805DFF98  3C 60 80 5F */	lis r3, lit_3912@ha
/* 805DFF9C  C0 03 D0 64 */	lfs f0, lit_3912@l(r3)
...
/* 805DFFD8  4B C9 0D E8 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 805E0004  3C A0 80 5F */	lis r5, lit_3912@ha
/* 805E0008  C0 65 D0 64 */	lfs f3, lit_3912@l(r5)
/* 805E000C  4B C8 FA AC */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805E0020  3C A0 80 5F */	lis r5, lit_3912@ha
/* 805E0024  C0 65 D0 64 */	lfs f3, lit_3912@l(r5)
/* 805E0028  4B C8 FA 90 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805E003C  3C A0 80 5F */	lis r5, lit_3912@ha
/* 805E0040  C0 65 D0 64 */	lfs f3, lit_3912@l(r5)
/* 805E0044  4B C8 FA 74 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805E0058  3C A0 80 5F */	lis r5, lit_3912@ha
/* 805E005C  C0 65 D0 64 */	lfs f3, lit_3912@l(r5)
/* 805E0060  4B C8 FA 58 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 805E00A8  4B BA 0A 38 */	b Set__9dCamera_cF4cXyz4cXyzfs

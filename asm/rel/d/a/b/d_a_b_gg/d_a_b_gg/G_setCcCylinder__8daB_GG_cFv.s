...
/* 805DE9C8  4B D8 38 10 */	b _savegpr_28
/* 805DE9CC  7C 7C 1B 78 */	mr r28, r3
/* 805DE9D0  3C 60 80 5F */	lis r3, lit_3911@ha
/* 805DE9D4  3B C3 D0 60 */	addi r30, r3, lit_3911@l
/* 805DE9D8  38 7C 07 FC */	addi r3, r28, 0x7fc
/* 805DE9DC  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 805DE9E0  4B C9 07 FC */	b SetC__8cM3dGCylFRC4cXyz
...
/* 805DEA14  4B C8 61 94 */	b Set__4cCcSFP8cCcD_Obj
/* 805DEA18  38 7C 0C E0 */	addi r3, r28, 0xce0
/* 805DEA1C  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 805DEA20  4B C9 07 BC */	b SetC__8cM3dGCylFRC4cXyz
...
/* 805DEA34  4B C9 07 CC */	b SetR__8cM3dGCylFf
/* 805DEA38  7F A3 EB 78 */	mr r3, r29
/* 805DEA3C  38 9C 0B BC */	addi r4, r28, 0xbbc
/* 805DEA40  4B C8 61 68 */	b Set__4cCcSFP8cCcD_Obj
...
/* 805DEA6C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805DEA70  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805DEA74  4B D6 7A 3C */	b PSMTXCopy
/* 805DEA78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DEA7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DEA80  38 81 00 08 */	addi r4, r1, 8
/* 805DEA84  7C 85 23 78 */	mr r5, r4
/* 805DEA88  4B D6 82 E4 */	b PSMTXMultVec
/* 805DEA8C  38 7C 0E 1C */	addi r3, r28, 0xe1c
/* 805DEA90  38 81 00 08 */	addi r4, r1, 8
/* 805DEA94  4B C9 0B B4 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 805DEAA8  4B C9 0C 60 */	b SetR__8cM3dGSphFf
/* 805DEAAC  7F A3 EB 78 */	mr r3, r29
/* 805DEAB0  38 9C 0C F8 */	addi r4, r28, 0xcf8
/* 805DEAB4  4B C8 60 F4 */	b Set__4cCcSFP8cCcD_Obj
/* 805DEAB8  39 61 00 30 */	addi r11, r1, 0x30
/* 805DEABC  4B D8 37 68 */	b _restgpr_28

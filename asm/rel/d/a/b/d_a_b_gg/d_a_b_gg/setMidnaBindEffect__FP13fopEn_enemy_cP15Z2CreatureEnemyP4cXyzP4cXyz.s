...
/* 805ECC0C  4B D7 55 A8 */	b _savegpr_19
/* 805ECC10  7C 7E 1B 78 */	mr r30, r3
/* 805ECC14  7C 9A 23 78 */	mr r26, r4
/* 805ECC18  7C BB 2B 78 */	mr r27, r5
/* 805ECC1C  7C DC 33 78 */	mr r28, r6
/* 805ECC20  3C 60 80 5F */	lis r3, cNullVec__6Z2Calc@ha
/* 805ECC24  3A E3 D3 F0 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 805ECC28  3C 60 80 5F */	lis r3, lit_3911@ha
/* 805ECC2C  3B E3 D0 60 */	addi r31, r3, lit_3911@l
/* 805ECC30  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805ECC34  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805ECC38  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 805ECC3C  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 805ECC40  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 805ECC68  4B BB F9 14 */	b dKy_darkworld_check__Fv
...
/* 805ECC8C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 805ECC90  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 805ECC94  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 805ECC98  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 805ECC9C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 805ECCA0  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 805ECCA4  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 805ECCA8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805ECCAC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805ECCB0  4B D5 98 00 */	b PSMTXCopy
...
/* 805ECCC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805ECCCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805ECCD0  38 81 00 4C */	addi r4, r1, 0x4c
/* 805ECCD4  38 A1 00 58 */	addi r5, r1, 0x58
/* 805ECCD8  4B D5 A0 94 */	b PSMTXMultVec
/* 805ECCDC  38 61 00 34 */	addi r3, r1, 0x34
/* 805ECCE0  38 81 00 58 */	addi r4, r1, 0x58
/* 805ECCE4  7F 65 DB 78 */	mr r5, r27
/* 805ECCE8  4B C7 9E 4C */	b __mi__4cXyzCFRC3Vec
...
/* 805ECD04  4B C7 A9 70 */	b cM_atan2s__Fff
...
/* 805ECD38  4B C7 A9 3C */	b cM_atan2s__Fff
...
/* 805ECD54  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805ECD58  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 805ECD5C  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 805ECDA8  4B A5 FC E8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 805ECDAC  7C 79 1B 79 */	or. r25, r3, r3
/* 805ECDB0  41 82 00 FC */	beq lbl_805ECEAC
/* 805ECDB4  38 61 00 40 */	addi r3, r1, 0x40
/* 805ECDB8  4B D5 A3 80 */	b PSVECSquareMag
...
/* 805ECE28  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805ECE2C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805ECE98  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805ECE9C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805ECEA0:
...
/* 805ECEF0  4B A5 FB A0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805ECF2C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805ECF30  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 805ECF5C  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 805ECF9C  4B A6 05 30 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805ECFFC  4B D7 52 04 */	b _restgpr_19

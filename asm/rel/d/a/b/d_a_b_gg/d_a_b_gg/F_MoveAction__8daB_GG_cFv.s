...
/* 805E3458  4B D7 ED 7C */	b _savegpr_27
/* 805E345C  7C 7C 1B 78 */	mr r28, r3
/* 805E3460  3C 60 80 5F */	lis r3, lit_1109@ha
/* 805E3464  3B C3 D6 C0 */	addi r30, r3, lit_1109@l
/* 805E3468  3C 60 80 5F */	lis r3, lit_3911@ha
/* 805E346C  3B E3 D0 60 */	addi r31, r3, lit_3911@l
/* 805E3470  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805E3474  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805E3478  83 A3 5D AC */	lwz r29, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 805E34B4  4B C8 44 A0 */	b cM_rndF__Ff
...
/* 805E34D8  4B C8 44 7C */	b cM_rndF__Ff
...
/* 805E350C  4B CD E6 70 */	b setLinkSearch__15Z2CreatureEnemyFb
/* 805E3510  48 00 00 10 */	b lbl_805E3520
lbl_805E3514:
/* 805E3514  38 7C 0E 4C */	addi r3, r28, 0xe4c
/* 805E3518  38 80 00 01 */	li r4, 1
/* 805E351C  4B CD E6 60 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_805E3520:
...
/* 805E354C  4B C8 44 08 */	b cM_rndF__Ff
...
/* 805E3560  4B C8 43 F4 */	b cM_rndF__Ff
...
/* 805E3588  4B C8 35 AC */	b __mi__4cXyzCFRC3Vec
...
/* 805E35B4  4B C8 43 D8 */	b cM_rndFX__Ff
...
/* 805E35C8  4B C8 43 C4 */	b cM_rndFX__Ff
...
/* 805E35E0  4B C8 43 AC */	b cM_rndFX__Ff
...
/* 805E35FC  4B C8 43 90 */	b cM_rndFX__Ff
...
/* 805E361C  4B C8 40 58 */	b cM_atan2s__Fff
...
/* 805E363C  4B C8 43 18 */	b cM_rndF__Ff
...
/* 805E365C  4B C8 43 30 */	b cM_rndFX__Ff
...
lbl_805E367C:
/* 805E367C  3C 60 80 5F */	lis r3, stringBase0@ha
/* 805E3680  38 63 D3 D4 */	addi r3, r3, stringBase0@l
/* 805E3684  38 63 00 05 */	addi r3, r3, 5
/* 805E3688  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805E368C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 805E3690  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 805E3694  4B D8 53 00 */	b strcmp
/* 805E3698  2C 03 00 00 */	cmpwi r3, 0
/* 805E369C  40 82 00 5C */	bne lbl_805E36F8
/* 805E36A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805E36A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805E36A8  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
...
/* 805E3784  4B D6 3C 18 */	b PSVECSquareDistance
...
/* 805E37F4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E37F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805E3864  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E3868  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805E386C:
...
/* 805E38EC  4B D6 3A B0 */	b PSVECSquareDistance
...
/* 805E395C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E3960  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805E39CC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E39D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805E39D4:
...
/* 805E3A54  3C 60 80 5F */	lis r3, stringBase0@ha
/* 805E3A58  38 63 D3 D4 */	addi r3, r3, stringBase0@l
/* 805E3A5C  38 63 00 05 */	addi r3, r3, 5
/* 805E3A60  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805E3A64  3B 64 61 C0 */	addi r27, r4, struct_804061C0+0x0@l
/* 805E3A68  38 9B 4E 00 */	addi r4, r27, 0x4e00
/* 805E3A6C  4B D8 4F 28 */	b strcmp
/* 805E3A70  2C 03 00 00 */	cmpwi r3, 0
/* 805E3A74  40 82 00 2C */	bne lbl_805E3AA0
/* 805E3A78  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805E3A7C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805E3A80  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
...
/* 805E3BD0  4B C8 3A A4 */	b cM_atan2s__Fff
...
/* 805E3BE8  4B C8 CA 20 */	b cLib_addCalcAngleS2__FPssss
/* 805E3BEC  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 805E3BF0  80 9E 00 6C */	lwz r4, 0x6c(r30)
/* 805E3BF4  4B C8 D0 10 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805E3C10  4B C8 C9 F8 */	b cLib_addCalcAngleS2__FPssss
...
/* 805E3C98  4B D7 E5 88 */	b _restgpr_27

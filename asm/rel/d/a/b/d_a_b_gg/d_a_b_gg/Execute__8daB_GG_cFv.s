...
/* 805EA37C  4B D7 7E 48 */	b _savegpr_23
/* 805EA380  7C 7C 1B 78 */	mr r28, r3
/* 805EA384  3C 80 80 5F */	lis r4, lit_1109@ha
...
/* 805EA3B8  4B D5 CF E4 */	b PSVECSquareDistance
...
/* 805EA428  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805EA42C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805EA498  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805EA49C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805EA4A0:
...
/* 805EA57C  4B A4 2A F0 */	b dComIfGp_getReverb__Fi
/* 805EA580  7C 65 1B 78 */	mr r5, r3
/* 805EA584  80 7C 0E 30 */	lwz r3, 0xe30(r28)
/* 805EA588  38 80 00 00 */	li r4, 0
/* 805EA58C  4B A2 6B 24 */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 805EA62C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805EA630  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l
...
/* 805EA718  4B D7 7A F8 */	b _restgpr_23

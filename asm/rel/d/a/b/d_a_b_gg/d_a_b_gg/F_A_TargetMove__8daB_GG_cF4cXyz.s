...
/* 805E562C 00000010  4B D7 CB B0 */	b _savegpr_29
/* 805E5630 00000014  7C 7F 1B 78 */	mr r31, r3
/* 805E5634 00000018  7C 9D 23 78 */	mr r29, r4
/* 805E5638 0000001C  3C 60 80 5F */	lis r3, lit_3911@ha
/* 805E563C 00000020  3B C3 D0 60 */	addi r30, r3, lit_3911@l
/* 805E5640 00000024  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 805E5644 00000028  4B C8 B5 C0 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 805E5658 0000003C  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 805ED064 */
...
/* 805E5680 00000064  4B D6 1D 1C */	b PSVECSquareDistance
/* 805E5684 00000068  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 805ED064 */
...
/* 805E5694 00000008  C8 9E 00 10 */	lfd f4, 0x10(r30)	/* effective address: 805ED070 */
/* 805E5698 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805E569C 00000010  C8 7E 00 18 */	lfd f3, 0x18(r30)	/* effective address: 805ED078 */
...
lbl_805E56E4:
/* 805E56E4 00000000  C8 1E 00 20 */	lfd f0, 0x20(r30)	/* effective address: 805ED080 */
/* 805E56E8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805E56EC 00000000  40 80 00 10 */	bge lbl_805E56FC
/* 805E56F0 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E56F4 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805E5760 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805E5764 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805E5768:
...
/* 805E57B4 0000004C  3C 60 80 5F */	lis r3, out_pos@ha
/* 805E57B8 00000050  38 03 D7 74 */	addi r0, r3, out_pos@l
...
/* 805E57F4 0000008C  4B D7 CA 34 */	b _restgpr_29

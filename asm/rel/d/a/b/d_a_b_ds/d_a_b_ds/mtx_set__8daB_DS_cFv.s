...
/* 805D91BC 00000018  3C 60 00 00 */	lis r3, lit_3932@ha
/* 805D91C0 0000001C  3B C3 00 00 */	addi r30, r3, lit_3932@l
...
/* 805D91D4 00000030  3C 60 00 00 */	lis r3, l_HIO@ha
/* 805D91D8 00000034  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 805D91F8 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D91FC 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D9214 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9218 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D9238 0000002C  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 805D923C 00000030  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805D9240 00000034  4B FF 1F 59 */	bl PSMTXCopy
/* 805D9244 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9248 0000003C  3B A3 00 00 */	addi r29, r3, now__14mDoMtx_stack_c@l
...
/* 805D928C 00000080  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9290 00000084  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D92AC 000000A0  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 805D92B0 000000A4  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 805D92D0 000000C4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D92D4 000000C8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D92F0 000000E4  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 805D92F4 000000E8  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
lbl_805D9374:
/* 805D9374 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9378 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D937C 00000008  38 80 C0 00 */	li r4, -16384
/* 805D9380 0000000C  4B FF 1E 19 */	bl mDoMtx_YrotM__FPA4_fs
/* 805D9384 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9388 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_805D9398:
/* 805D9398 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D939C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D93A0 00000008  38 80 C2 BC */	li r4, -15684
/* 805D93A4 0000000C  4B FF 1D F5 */	bl mDoMtx_YrotM__FPA4_fs
/* 805D93A8 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D93AC 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D93E8 00000030  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D93EC 00000034  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D9418 00000060  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D941C 00000064  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D94A4 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D94A8 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805D94EC 0000009C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D94F0 000000A0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

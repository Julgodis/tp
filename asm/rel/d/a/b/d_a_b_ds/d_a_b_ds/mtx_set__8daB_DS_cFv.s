...
/* 805D91B4  4B D8 90 24 */	b _savegpr_28
/* 805D91B8  7C 7F 1B 78 */	mr r31, r3
/* 805D91BC  3C 60 80 5E */	lis r3, lit_3932@ha
/* 805D91C0  3B C3 CA 54 */	addi r30, r3, lit_3932@l
/* 805D91C4  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 805D91C8  4B A3 3B 9C */	b transS__14mDoMtx_stack_cFRC4cXyz
...
/* 805D91F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D91FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D9200  80 9F 05 C0 */	lwz r4, 0x5c0(r31)
/* 805D9204  38 84 00 24 */	addi r4, r4, 0x24
/* 805D9208  4B D6 D2 A8 */	b PSMTXCopy
lbl_805D920C:
/* 805D920C  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 805D9210  83 83 00 04 */	lwz r28, 4(r3)
/* 805D9214  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9218  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D921C  38 9C 00 24 */	addi r4, r28, 0x24
/* 805D9220  4B D6 D2 90 */	b PSMTXCopy
/* 805D9224  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 805D9228  4B A3 7F C4 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 805D922C  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 805D9230  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805D9234  38 63 01 20 */	addi r3, r3, 0x120
/* 805D9238  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805D923C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 805D9274  4B D6 D2 3C */	b PSMTXCopy
...
/* 805D928C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9290  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D9294  38 81 00 08 */	addi r4, r1, 8
/* 805D9298  38 BF 07 00 */	addi r5, r31, 0x700
/* 805D929C  4B D6 DA D0 */	b PSMTXMultVec
/* 805D92A0  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 805D92A4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805D92A8  38 63 01 50 */	addi r3, r3, 0x150
/* 805D92AC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805D92B0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805D92B4  4B D6 D1 FC */	b PSMTXCopy
...
/* 805D92D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D92D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D92D8  38 81 00 08 */	addi r4, r1, 8
/* 805D92DC  38 BF 07 0C */	addi r5, r31, 0x70c
/* 805D92E0  4B D6 DA 8C */	b PSMTXMultVec
/* 805D92E4  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 805D92E8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805D92EC  38 63 01 20 */	addi r3, r3, 0x120
/* 805D92F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805D92F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805D92F8  4B D6 D1 B8 */	b PSMTXCopy
...
/* 805D9358  4B A3 3A 44 */	b transM__14mDoMtx_stack_cFfff
...
lbl_805D9374:
/* 805D9374  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9378  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D937C  38 80 C0 00 */	li r4, -16384
/* 805D9380  4B A3 30 B4 */	b mDoMtx_YrotM__FPA4_fs
/* 805D9384  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D9388  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D938C  38 80 88 90 */	li r4, -30576
/* 805D9390  4B A3 30 0C */	b mDoMtx_XrotM__FPA4_fs
/* 805D9394  48 00 00 24 */	b lbl_805D93B8
lbl_805D9398:
/* 805D9398  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D939C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D93A0  38 80 C2 BC */	li r4, -15684
/* 805D93A4  4B A3 30 90 */	b mDoMtx_YrotM__FPA4_fs
/* 805D93A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D93AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D93B0  38 80 83 B4 */	li r4, -31820
/* 805D93B4  4B A3 2F E8 */	b mDoMtx_XrotM__FPA4_fs
lbl_805D93B8:
/* 805D93B8  C0 3F 06 B8 */	lfs f1, 0x6b8(r31)
/* 805D93BC  C0 5F 06 BC */	lfs f2, 0x6bc(r31)
/* 805D93C0  C0 7F 06 C0 */	lfs f3, 0x6c0(r31)
/* 805D93C4  4B A3 3A 74 */	b scaleM__14mDoMtx_stack_cFfff
...
/* 805D93E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D93EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D93F0  38 84 00 24 */	addi r4, r4, 0x24
/* 805D93F4  4B D6 D0 BC */	b PSMTXCopy
/* 805D93F8  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 805D93FC  4B A3 7D F0 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 805D9418  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D941C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D9420  38 81 00 08 */	addi r4, r1, 8
/* 805D9424  38 BF 05 38 */	addi r5, r31, 0x538
/* 805D9428  4B D6 D9 44 */	b PSMTXMultVec
...
/* 805D947C  4B A3 38 E8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 805D9480  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 805D9484  4B A3 3A C0 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
...
/* 805D94A0  4B A3 38 FC */	b transM__14mDoMtx_stack_cFfff
/* 805D94A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D94A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D94AC  A8 9F 07 CA */	lha r4, 0x7ca(r31)
/* 805D94B0  38 04 13 88 */	addi r0, r4, 0x1388
/* 805D94B4  7C 04 07 34 */	extsh r4, r0
/* 805D94B8  4B A3 2F 7C */	b mDoMtx_YrotM__FPA4_fs
/* 805D94BC  C0 3F 06 AC */	lfs f1, 0x6ac(r31)
/* 805D94C0  C0 5F 06 B0 */	lfs f2, 0x6b0(r31)
/* 805D94C4  C0 7F 06 B4 */	lfs f3, 0x6b4(r31)
/* 805D94C8  4B A3 39 70 */	b scaleM__14mDoMtx_stack_cFfff
...
/* 805D94EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805D94F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805D94F4  38 84 00 24 */	addi r4, r4, 0x24
/* 805D94F8  4B D6 CF B8 */	b PSMTXCopy
/* 805D94FC  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 805D9500  4B A3 7C EC */	b modelCalc__16mDoExt_McaMorfSOFv
/* 805D9504  39 61 00 30 */	addi r11, r1, 0x30
/* 805D9508  4B D8 8D 1C */	b _restgpr_28

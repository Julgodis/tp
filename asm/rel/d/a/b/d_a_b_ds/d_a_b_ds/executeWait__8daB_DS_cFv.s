...
/* 805D0044 00000018  3C 60 00 00 */	lis r3, lit_3932@ha /* 805DCA54 */
/* 805D0048 0000001C  3B C3 00 00 */	addi r30, r3, lit_3932@l /* 805DCA54 */
...
/* 805D0074 0000000C  C0 3E 02 E8 */	lfs f1, 0x2e8(r30)
/* 805D0078 00000010  4B FF B1 21 */	bl cM_rndF__Ff
...
/* 805D00CC 0000000C  3C 60 00 00 */	lis r3, data_805DD570@ha /* 805DD570 */
/* 805D00D0 00000010  38 63 00 00 */	addi r3, r3, data_805DD570@l /* 805DD570 */
...
/* 805D00E8 00000028  C0 3E 01 90 */	lfs f1, 0x190(r30)
/* 805D00EC 0000002C  C0 5E 00 08 */	lfs f2, 8(r30)
...
/* 805D0100 00000004  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805D0104 00000008  3B C4 00 00 */	addi r30, r4, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805D0108 0000000C  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 805D010C 00000010  4B FF B0 8D */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805D0110 00000014  3C 60 00 00 */	lis r3, l_HIO@ha /* 805DDABC */
/* 805D0114 00000018  38 63 00 00 */	addi r3, r3, l_HIO@l /* 805DDABC */
/* 805D0118 0000001C  C0 03 00 18 */	lfs f0, 0x18(r3)
/* 805D011C 00000020  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805D0120 00000000  41 81 00 20 */	bgt lbl_805D0140
/* 805D0124 00000004  80 7E 5D AC */	lwz r3, 0x5dac(r30)
/* 805D0128 00000008  81 83 06 28 */	lwz r12, 0x628(r3)
...
/* 805D0144 00000004  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 805D0148 00000008  4B FF B0 51 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805D0158 00000018  4B FF B0 41 */	bl abs

...
/* 805D42B4  4B D8 DF 20 */	b _savegpr_27
...
/* 805D42F0  4B C9 28 44 */	b __mi__4cXyzCFRC3Vec
...
/* 805D4324  4B D7 2E 14 */	b PSVECSquareMag
...
/* 805D4394  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D4398  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805D4404  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D4408  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805D440C:
...
/* 805D445C  4B C9 B5 E0 */	b cLib_addCalc2__FPffff
...
/* 805D4470  4B C9 26 C4 */	b __mi__4cXyzCFRC3Vec
...
/* 805D4498  4B C9 2C 90 */	b atan2sX_Z__4cXyzCFv
...
/* 805D450C  4B D7 2C 2C */	b PSVECSquareMag
...
/* 805D457C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D4580  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805D45EC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D45F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805D45F4:
...
/* 805D464C  4B C9 24 E8 */	b __mi__4cXyzCFRC3Vec
...
/* 805D4674  4B D7 2A C4 */	b PSVECSquareMag
...
/* 805D46E4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D46E8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805D4754  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D4758  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805D475C:
...
/* 805D4778  4B C9 B2 C4 */	b cLib_addCalc2__FPffff
...
/* 805D478C  4B C9 B2 B0 */	b cLib_addCalc2__FPffff
...
/* 805D47E4  4B D7 29 54 */	b PSVECSquareMag
...
/* 805D4854  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D4858  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805D48C4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805D48C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805D48CC:
...
/* 805D4968  4B D8 D8 B8 */	b _restgpr_27

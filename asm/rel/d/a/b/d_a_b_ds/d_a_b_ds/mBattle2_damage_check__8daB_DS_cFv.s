...
/* 805DA064  4B C8 CA D0 */	b __mi__4cXyzCFRC3Vec
...
/* 805DA0A8  4B AA DB 5C */	b cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
/* 805DA0AC  38 00 00 00 */	li r0, 0
/* 805DA0B0  B0 01 00 10 */	sth r0, 0x10(r1)
/* 805DA0B4  38 61 00 30 */	addi r3, r1, 0x30
/* 805DA0B8  4B C8 D0 70 */	b atan2sX_Z__4cXyzCFv
...
/* 805DA0D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DA0D8  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 805DA0DC  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)	/* effective address: 8040BEFC */
...
/* 805DA0F8  4B A7 21 20 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 805DA144  4B A7 17 D4 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
lbl_805DA15C:
/* 805DA15C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805DA160  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 805DA164  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 805DA168  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805DA16C  38 80 00 1E */	li r4, 0x1e
/* 805DA170  38 A0 00 00 */	li r5, 0
/* 805DA174  4B CD 52 94 */	b bgmStop__8Z2SeqMgrFUll
/* 805DA178  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805DA17C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 805DA180  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 805DA190  4B CD 5A 04 */	b bgmStreamPrepare__8Z2SeqMgrFUl
/* 805DA194  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805DA198  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 805DA19C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 805DA1A0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 805DA1A4  4B CD 5C 74 */	b bgmStreamPlay__8Z2SeqMgrFv
...
/* 805DA1DC  3C C0 80 5E */	lis r6, lit_7137@ha
/* 805DA1E0  C0 26 CE 0C */	lfs f1, lit_7137@l(r6)
/* 805DA1E4  3C C0 80 5E */	lis r6, lit_3934@ha
/* 805DA1E8  C0 46 CA 5C */	lfs f2, lit_3934@l(r6)
...
/* 805DA20C  4B AA A2 EC */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 805DA220  4B AA A2 D8 */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 805DA23C  3C C0 80 5E */	lis r6, lit_7137@ha
/* 805DA240  C0 26 CE 0C */	lfs f1, lit_7137@l(r6)
/* 805DA244  3C C0 80 5E */	lis r6, lit_3934@ha
/* 805DA248  C0 46 CA 5C */	lfs f2, lit_3934@l(r6)
...
/* 805DA278  3C 60 80 5E */	lis r3, stringBase0@ha
/* 805DA27C  38 63 D2 2C */	addi r3, r3, stringBase0@l
/* 805DA280  38 80 00 4E */	li r4, 0x4e
/* 805DA284  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 805DA288  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 805DA29C  4B A6 20 50 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805DA2BC  3D 00 80 5E */	lis r8, lit_3934@ha
/* 805DA2C0  C0 28 CA 5C */	lfs f1, lit_3934@l(r8)
/* 805DA2C4  39 00 00 00 */	li r8, 0
/* 805DA2C8  39 20 FF FF */	li r9, -1
/* 805DA2CC  4B A3 34 40 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 805DA2D0  3C 60 80 5E */	lis r3, stringBase0@ha
/* 805DA2D4  38 63 D2 2C */	addi r3, r3, stringBase0@l
/* 805DA2D8  38 80 00 54 */	li r4, 0x54
/* 805DA2DC  7F E5 FB 78 */	mr r5, r31
/* 805DA2E0  38 C0 00 80 */	li r6, 0x80
/* 805DA2E4  4B A6 20 08 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805DA304  3D 00 80 5E */	lis r8, lit_3934@ha
/* 805DA308  C0 28 CA 5C */	lfs f1, lit_3934@l(r8)
/* 805DA30C  39 00 00 00 */	li r8, 0
/* 805DA310  39 20 FF FF */	li r9, -1
/* 805DA314  4B A3 33 28 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 805DA344  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DA348  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805DA34C  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 805DA368  4B A7 1E B0 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
lbl_805DA394:
/* 805DA394  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DA398  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805DA39C  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 805DA3B8  4B A7 1E 60 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
lbl_805DA3E4:
/* 805DA3E4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DA3E8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805DA3EC  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 805DA408  4B A7 1E 10 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 805DA41C  4B AA D0 F8 */	b def_se_set__FP10Z2CreatureP8cCcD_ObjUlP10fopAc_ac_c
lbl_805DA420:
/* 805DA420  3C 60 80 5E */	lis r3, stringBase0@ha
/* 805DA424  38 63 D2 2C */	addi r3, r3, stringBase0@l
/* 805DA428  38 80 00 50 */	li r4, 0x50
/* 805DA42C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 805DA430  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 805DA444  4B A6 1E A8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805DA468  3D 00 80 5E */	lis r8, lit_3934@ha
/* 805DA46C  C0 28 CA 5C */	lfs f1, lit_3934@l(r8)
/* 805DA470  39 00 00 00 */	li r8, 0
/* 805DA474  39 20 FF FF */	li r9, -1
/* 805DA478  4B A3 32 94 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 805DA48C  3C 60 80 5E */	lis r3, stringBase0@ha
/* 805DA490  38 63 D2 2C */	addi r3, r3, stringBase0@l
/* 805DA494  38 80 00 4E */	li r4, 0x4e
/* 805DA498  7F E5 FB 78 */	mr r5, r31
/* 805DA49C  38 C0 00 80 */	li r6, 0x80
/* 805DA4A0  4B A6 1E 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805DA4C0  3D 00 80 5E */	lis r8, lit_3934@ha
/* 805DA4C4  C0 28 CA 5C */	lfs f1, lit_3934@l(r8)
/* 805DA4C8  39 00 00 00 */	li r8, 0
/* 805DA4CC  39 20 FF FF */	li r9, -1
/* 805DA4D0  4B A3 32 3C */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 805DA4D4  3C 60 80 5E */	lis r3, stringBase0@ha
/* 805DA4D8  38 63 D2 2C */	addi r3, r3, stringBase0@l
/* 805DA4DC  38 80 00 54 */	li r4, 0x54
/* 805DA4E0  7F E5 FB 78 */	mr r5, r31
/* 805DA4E4  38 C0 00 80 */	li r6, 0x80
/* 805DA4E8  4B A6 1E 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 805DA508  3D 00 80 5E */	lis r8, lit_3934@ha
/* 805DA50C  C0 28 CA 5C */	lfs f1, lit_3934@l(r8)
/* 805DA510  39 00 00 00 */	li r8, 0
/* 805DA514  39 20 FF FF */	li r9, -1
/* 805DA518  4B A3 31 24 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 805DA564  4B AA 92 CC */	b Move__10dCcD_GSttsFv

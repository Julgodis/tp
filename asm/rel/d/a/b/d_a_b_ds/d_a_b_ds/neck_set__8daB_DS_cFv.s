...
/* 805CD664 0000003C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805CD668 00000040  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 805CD66C 00000044  80 7F 5D AC */	lwz r3, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 805CD670 00000048  C0 23 04 D0 */	lfs f1, 0x4d0(r3)	/* effective address: 804004D0 */
...
/* 805CD680 00000058  C0 23 04 D8 */	lfs f1, 0x4d8(r3)	/* effective address: 804004D8 */
...
/* 805CD690 00000068  C0 43 04 D4 */	lfs f2, 0x4d4(r3)	/* effective address: 804004D4 */
...
/* 805CD6A0 00000078  3C 60 80 5E */	lis r3, data_805DD49C@ha
/* 805CD6A4 0000007C  38 63 D4 9C */	addi r3, r3, data_805DD49C@l
...
/* 805CD6BC 00000094  4B C9 9A 94 */	b atan2sY_XZ__4cXyzCFv
/* 805CD6C0 00000098  7C 60 07 34 */	extsh r0, r3
/* 805CD6C4 0000009C  7C 00 00 D0 */	neg r0, r0
/* 805CD6C8 000000A0  3C 60 80 5E */	lis r3, lit_5154@ha
/* 805CD6CC 000000A4  C8 23 CA EC */	lfd f1, lit_5154@l(r3)
...
/* 805CD6E8 000000C0  3C 60 80 5E */	lis r3, lit_4649@ha
/* 805CD6EC 000000C4  C0 03 CA CC */	lfs f0, lit_4649@l(r3)
...
/* 805CD76C 00000018  4B CA 2E 9C */	b cLib_addCalcAngleS2__FPssss
/* 805CD770 0000001C  38 61 00 10 */	addi r3, r1, 0x10
/* 805CD774 00000020  4B C9 99 B4 */	b atan2sX_Z__4cXyzCFv
...
/* 805CD7BC 00000010  4B D9 79 14 */	b abs
...
/* 805CD7CC 00000020  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 805CD7D0 00000024  4B A4 CF 40 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 805CD7E0 00000034  4B D9 78 F0 */	b abs
...
/* 805CD7F0 00000044  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 805CD7F4 00000048  4B A4 CF EC */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CD7F8 0000004C  3C 60 80 5E */	lis r3, l_HIO@ha
/* 805CD7FC 00000050  38 63 DA BC */	addi r3, r3, l_HIO@l
/* 805CD800 00000054  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 805DDAD4 */
...
/* 805CD81C 00000014  4B CA 2D EC */	b cLib_addCalcAngleS2__FPssss

lbl_805CB22C:
/* 805CB22C 00000000  3C 80 80 5E */	lis r4, lit_3932@ha
/* 805CB230 00000004  38 A4 CA 54 */	addi r5, r4, lit_3932@l
/* 805CB234 00000008  3C 80 80 5E */	lis r4, __vt__12daB_DS_HIO_c@ha
/* 805CB238 0000000C  38 04 DA 5C */	addi r0, r4, __vt__12daB_DS_HIO_c@l
/* 805CB23C 00000010  90 03 00 00 */	stw r0, 0(r3)
/* 805CB240 00000014  38 00 FF FF */	li r0, -1
/* 805CB244 00000018  98 03 00 04 */	stb r0, 4(r3)
/* 805CB248 0000001C  C0 05 00 08 */	lfs f0, 8(r5)	/* effective address: 805DCA5C */
/* 805CB24C 00000020  D0 03 00 08 */	stfs f0, 8(r3)
/* 805CB250 00000024  C0 25 00 2C */	lfs f1, 0x2c(r5)	/* effective address: 805DCA80 */
/* 805CB254 00000028  D0 23 00 0C */	stfs f1, 0xc(r3)
/* 805CB258 0000002C  C0 05 00 30 */	lfs f0, 0x30(r5)	/* effective address: 805DCA84 */
/* 805CB25C 00000030  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 805CB260 00000034  D0 23 00 14 */	stfs f1, 0x14(r3)
/* 805CB264 00000038  C0 05 00 34 */	lfs f0, 0x34(r5)	/* effective address: 805DCA88 */
/* 805CB268 0000003C  D0 03 00 18 */	stfs f0, 0x18(r3)
/* 805CB26C 00000040  C0 05 00 38 */	lfs f0, 0x38(r5)	/* effective address: 805DCA8C */
/* 805CB270 00000044  D0 03 00 1C */	stfs f0, 0x1c(r3)
/* 805CB274 00000048  C0 05 00 3C */	lfs f0, 0x3c(r5)	/* effective address: 805DCA90 */
/* 805CB278 0000004C  D0 03 00 24 */	stfs f0, 0x24(r3)
/* 805CB27C 00000050  C0 05 00 40 */	lfs f0, 0x40(r5)	/* effective address: 805DCA94 */

...
/* 805CC8B4 00000010  4B D9 59 08 */	b _savegpr_21
/* 805CC8B8 00000014  7C 7F 1B 78 */	mr r31, r3
/* 805CC8BC 00000018  7C 98 23 78 */	mr r24, r4
/* 805CC8C0 0000001C  3C 60 80 5E */	lis r3, cNullVec__6Z2Calc@ha
/* 805CC8C4 00000020  3B 83 D2 48 */	addi r28, r3, cNullVec__6Z2Calc@l
/* 805CC8C8 00000024  3C 60 80 5E */	lis r3, lit_3932@ha
/* 805CC8CC 00000028  3B A3 CA 54 */	addi r29, r3, lit_3932@l
/* 805CC8D0 0000002C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805CC8D4 00000030  3A A3 61 C0 */	addi r21, r3, g_dComIfG_gameInfo@l
/* 805CC8D8 00000034  80 95 5D AC */	lwz r4, 0x5dac(r21)	/* effective address: 8040BF6C */
...
/* 805CC938 00000004  C0 1D 00 8C */	lfs f0, 0x8c(r29)	/* effective address: 805DCAE0 */
/* 805CC93C 00000008  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805CC940 00000000  41 80 00 70 */	blt lbl_805CC9B0
/* 805CC944 00000004  3C 60 80 5E */	lis r3, l_HIO@ha
/* 805CC948 00000008  38 63 DA BC */	addi r3, r3, l_HIO@l
/* 805CC94C 0000000C  C0 03 00 24 */	lfs f0, 0x24(r3)	/* effective address: 805DDAE0 */
...
/* 805CC9E8 00000020  80 95 5D AC */	lwz r4, 0x5dac(r21)	/* effective address: 8040BF6C */
/* 805CC9EC 00000024  4B A4 DD 24 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 805CC9F0 00000028  54 60 05 3F */	clrlwi. r0, r3, 0x14
/* 805CC9F4 0000002C  41 82 04 A8 */	beq lbl_805CCE9C
lbl_805CC9F8:
/* 805CC9F8 00000000  C0 1D 00 08 */	lfs f0, 8(r29)	/* effective address: 805DCA5C */
...
/* 805CCA18 00000020  3C 60 80 5E */	lis r3, l_HIO@ha
/* 805CCA1C 00000024  3B C3 DA BC */	addi r30, r3, l_HIO@l
/* 805CCA20 00000028  A8 7E 00 4A */	lha r3, 0x4a(r30)	/* effective address: 805DDB06 */
...
/* 805CCA68 00000014  4B A4 CF 54 */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 805CCA90 00000008  A8 1E 00 40 */	lha r0, 0x40(r30)	/* effective address: 805DDAFC */
...
/* 805CCAA4 0000001C  A8 1E 00 36 */	lha r0, 0x36(r30)	/* effective address: 805DDAF2 */
...
lbl_805CCAB8:
/* 805CCAB8 00000000  A8 1E 00 38 */	lha r0, 0x38(r30)	/* effective address: 805DDAF4 */
...
/* 805CCAD4 0000000C  4B A8 4D 18 */	b dPath_GetRoomPath__Fii
...
/* 805CCB10 00000048  4B C9 A0 24 */	b __mi__4cXyzCFRC3Vec
...
/* 805CCB30 00000068  4B D7 A6 08 */	b PSVECSquareMag
/* 805CCB34 0000006C  C0 1D 00 04 */	lfs f0, 4(r29)	/* effective address: 805DCA58 */
...
/* 805CCB44 00000008  C8 9D 00 10 */	lfd f4, 0x10(r29)	/* effective address: 805DCA64 */
/* 805CCB48 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805CCB4C 00000010  C8 7D 00 18 */	lfd f3, 0x18(r29)	/* effective address: 805DCA6C */
...
lbl_805CCB94:
/* 805CCB94 00000000  C8 1D 00 20 */	lfd f0, 0x20(r29)	/* effective address: 805DCA74 */
/* 805CCB98 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805CCB9C 00000000  40 80 00 10 */	bge lbl_805CCBAC
/* 805CCBA0 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805CCBA4 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805CCC10 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805CCC14 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805CCC18:
/* 805CCC18 00000000  C0 1D 00 64 */	lfs f0, 0x64(r29)	/* effective address: 805DCAB8 */
...
/* 805CCC70 00000014  4B A4 D2 80 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
lbl_805CCC9C:
/* 805CCC9C 00000000  C0 3D 00 04 */	lfs f1, 4(r29)	/* effective address: 805DCA58 */
/* 805CCCA0 00000004  D0 21 00 34 */	stfs f1, 0x34(r1)
/* 805CCCA4 00000008  C0 1D 00 90 */	lfs f0, 0x90(r29)	/* effective address: 805DCAE4 */
...
/* 805CCCCC 00000030  C0 1D 00 94 */	lfs f0, 0x94(r29)	/* effective address: 805DCAE8 */
...
/* 805CCD6C 00000018  4B A4 D1 84 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805CCDB4 00000010  3C 60 80 5E */	lis r3, l_HIO@ha
/* 805CCDB8 00000014  38 83 DA BC */	addi r4, r3, l_HIO@l
/* 805CCDBC 00000018  A8 64 00 4A */	lha r3, 0x4a(r4)	/* effective address: 805DDB06 */
...
/* 805CCDD8 00000034  A8 04 00 3E */	lha r0, 0x3e(r4)	/* effective address: 805DDAFA */
...
/* 805CCE70 00000014  4B A4 D0 80 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 805CCEA0 00000004  4B D9 53 68 */	b _restgpr_21

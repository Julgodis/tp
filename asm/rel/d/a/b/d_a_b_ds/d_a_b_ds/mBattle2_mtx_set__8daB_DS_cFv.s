...
/* 805DA594  4B D8 7C 48 */	b _savegpr_29
/* 805DA598  7C 7F 1B 78 */	mr r31, r3
/* 805DA59C  3C 60 80 5E */	lis r3, lit_3932@ha
/* 805DA5A0  3B C3 CA 54 */	addi r30, r3, lit_3932@l
...
/* 805DA5BC  4B A3 27 A8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 805DA5C0  C0 3F 07 90 */	lfs f1, 0x790(r31)
/* 805DA5C4  C0 5F 07 94 */	lfs f2, 0x794(r31)
/* 805DA5C8  C0 7F 07 98 */	lfs f3, 0x798(r31)
/* 805DA5CC  4B A3 27 D0 */	b transM__14mDoMtx_stack_cFfff
/* 805DA5D0  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 805DA5D4  4B A3 29 70 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805DA5D8  38 7F 07 AE */	addi r3, r31, 0x7ae
/* 805DA5DC  4B A3 29 68 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805DA5E0  3C 60 80 5E */	lis r3, l_HIO@ha
/* 805DA5E4  38 63 DA BC */	addi r3, r3, l_HIO@l
/* 805DA5E8  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 805DDAC4 */
/* 805DA5EC  FC 40 08 90 */	fmr f2, f1
/* 805DA5F0  FC 60 08 90 */	fmr f3, f1
/* 805DA5F4  4B A3 28 44 */	b scaleM__14mDoMtx_stack_cFfff
/* 805DA5F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA5FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA600  38 9D 00 24 */	addi r4, r29, 0x24
/* 805DA604  4B D6 BE AC */	b PSMTXCopy
/* 805DA608  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 805DA60C  4B A3 6B E0 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 805DA610  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 805DA614  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805DA618  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805DA61C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805DA620  4B D6 BE 90 */	b PSMTXCopy
/* 805DA624  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA628  38 83 D4 70 */	addi r4, r3, now__14mDoMtx_stack_c@l
/* 805DA62C  C0 04 00 0C */	lfs f0, 0xc(r4)	/* effective address: 803DD47C */
/* 805DA630  D0 1F 07 54 */	stfs f0, 0x754(r31)
/* 805DA634  C0 04 00 1C */	lfs f0, 0x1c(r4)	/* effective address: 803DD48C */
/* 805DA638  D0 1F 07 58 */	stfs f0, 0x758(r31)
/* 805DA63C  C0 04 00 2C */	lfs f0, 0x2c(r4)	/* effective address: 803DD49C */
...
/* 805DA658  4B D6 BE 58 */	b PSMTXCopy
/* 805DA65C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA660  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA664  80 9F 05 C4 */	lwz r4, 0x5c4(r31)
/* 805DA668  38 84 00 24 */	addi r4, r4, 0x24
/* 805DA66C  4B D6 BE 44 */	b PSMTXCopy
lbl_805DA670:
/* 805DA670  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 805DA674  80 63 00 0C */	lwz r3, 0xc(r3)
/* 805DA678  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805DA67C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805DA680  4B D6 BE 30 */	b PSMTXCopy
...
/* 805DA698  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA69C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA6A0  38 81 00 4C */	addi r4, r1, 0x4c
/* 805DA6A4  38 BF 07 00 */	addi r5, r31, 0x700
/* 805DA6A8  4B D6 C6 C4 */	b PSMTXMultVec
lbl_805DA6AC:
...
/* 805DA6C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 805DA6C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805DA6C8  4B D6 BD E8 */	b PSMTXCopy
...
/* 805DA6E4  4B A3 26 B8 */	b transM__14mDoMtx_stack_cFfff
/* 805DA6E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA6EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA6F0  38 80 40 00 */	li r4, 0x4000
/* 805DA6F4  4B A3 1D 40 */	b mDoMtx_YrotM__FPA4_fs
/* 805DA6F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA6FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA700  38 80 1B 58 */	li r4, 0x1b58
/* 805DA704  4B A3 1C 98 */	b mDoMtx_XrotM__FPA4_fs
/* 805DA708  C0 3F 06 B8 */	lfs f1, 0x6b8(r31)
/* 805DA70C  C0 5F 06 BC */	lfs f2, 0x6bc(r31)
/* 805DA710  C0 7F 06 C0 */	lfs f3, 0x6c0(r31)
/* 805DA714  4B A3 27 24 */	b scaleM__14mDoMtx_stack_cFfff
/* 805DA718  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA71C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA720  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 805DA724  D0 1F 06 E8 */	stfs f0, 0x6e8(r31)
/* 805DA728  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 805DA72C  D0 1F 06 EC */	stfs f0, 0x6ec(r31)
/* 805DA730  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 805DA734  D0 1F 06 F0 */	stfs f0, 0x6f0(r31)
/* 805DA738  48 00 00 24 */	b lbl_805DA75C
lbl_805DA73C:
/* 805DA73C  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 805DA740  4B A3 26 24 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 805DA744  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 805DA748  4B A3 27 FC */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 805DA74C  C0 3E 00 04 */	lfs f1, 4(r30)
/* 805DA750  C0 5E 01 78 */	lfs f2, 0x178(r30)
/* 805DA754  FC 60 08 90 */	fmr f3, f1
/* 805DA758  4B A3 26 44 */	b transM__14mDoMtx_stack_cFfff
lbl_805DA75C:
/* 805DA75C  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 805DA760  80 83 00 04 */	lwz r4, 4(r3)
/* 805DA764  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA768  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA76C  38 84 00 24 */	addi r4, r4, 0x24
/* 805DA770  4B D6 BD 40 */	b PSMTXCopy
/* 805DA774  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 805DA778  4B A3 6A 74 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 805DA794  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805DA798  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805DA79C  38 81 00 4C */	addi r4, r1, 0x4c
/* 805DA7A0  38 BF 05 38 */	addi r5, r31, 0x538
/* 805DA7A4  4B D6 C5 C8 */	b PSMTXMultVec
...
/* 805DA7D4  4B A9 D4 94 */	b __ct__11dBgS_LinChkFv
...
/* 805DA7F0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805DA7F4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805DA7F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805DA7FC  4B A3 1B E0 */	b mDoMtx_YrotS__FPA4_fs
/* 805DA800  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 805DA804  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 805DA808  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 805DA80C  A8 81 00 20 */	lha r4, 0x20(r1)
/* 805DA810  4B A3 1B 8C */	b mDoMtx_XrotM__FPA4_fs
...
/* 805DA86C  4B A9 D4 F8 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 805DA870  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DA874  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805DA878  38 63 0F 38 */	addi r3, r3, 0xf38
/* 805DA87C  38 81 00 58 */	addi r4, r1, 0x58
/* 805DA880  4B A9 9B 34 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 805DA8AC  4B A9 D4 30 */	b __dt__11dBgS_LinChkFv
...
/* 805DA8E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805DA8EC  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 805DA8F0  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 805DA93C  4B A7 2B 90 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 805DA950  4B A7 0F C8 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 805DA978  4B CA 5E 90 */	b func_80280808
...
/* 805DA990  4B D8 78 98 */	b _restgpr_29

...
/* 805DA59C 00000018  3C 60 00 00 */	lis r3, lit_3932@ha /* 805DCA54 */
/* 805DA5A0 0000001C  3B C3 00 00 */	addi r30, r3, lit_3932@l /* 805DCA54 */
...
/* 805DA5E0 0000005C  3C 60 00 00 */	lis r3, l_HIO@ha /* 805DDABC */
/* 805DA5E4 00000060  38 63 00 00 */	addi r3, r3, l_HIO@l /* 805DDABC */
...
/* 805DA5F8 00000074  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA5FC 00000078  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA618 00000094  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA61C 00000098  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805DA620 0000009C  4B FF 0B 79 */	bl PSMTXCopy
/* 805DA624 000000A0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA628 000000A4  38 83 00 00 */	addi r4, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA65C 000000D8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA660 000000DC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA678 00000008  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA67C 0000000C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA698 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA69C 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA6C0 00000014  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA6C4 00000018  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA6E8 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA6EC 00000040  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 805DA6F0 00000044  38 80 40 00 */	li r4, 0x4000
/* 805DA6F4 00000048  4B FF 0A A5 */	bl mDoMtx_YrotM__FPA4_fs
/* 805DA6F8 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA6FC 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA718 0000006C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA71C 00000070  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA764 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA768 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA794 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805DA798 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805DA7F0 00000094  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805DA7F4 00000098  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 805DA7F8 0000009C  80 63 00 00 */	lwz r3, 0(r3)
/* 805DA7FC 000000A0  4B FF 09 9D */	bl mDoMtx_YrotS__FPA4_fs
/* 805DA800 000000A4  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 805DA804 000000A8  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 805DA870 00000114  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805DA874 00000118  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 805DA8E8 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805DA8EC 00000024  3B A3 00 00 */	addi r29, r3, g_dComIfG_gameInfo@l /* 804061C0 */

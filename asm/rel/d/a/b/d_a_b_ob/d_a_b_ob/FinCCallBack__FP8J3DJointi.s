...
/* 80610C44 00000020  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80610C48 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l
...
/* 80610C74 00000050  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 80610C78 00000054  38 84 00 00 */	addi r4, r4, calc_mtx@l
/* 80610C7C 00000058  80 84 00 00 */	lwz r4, 0(r4)
/* 80610C80 0000005C  4B FF F8 59 */	bl PSMTXCopy
/* 80610C84 00000060  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80610C88 00000064  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 80610C8C 00000068  80 63 00 00 */	lwz r3, 0(r3)
/* 80610C90 0000006C  3C 80 00 00 */	lis r4, pno@ha
/* 80610C94 00000070  80 04 00 00 */	lwz r0, pno@l(r4)
...
/* 80610CA8 00000084  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80610CAC 00000088  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 80610CB0 0000008C  80 63 00 00 */	lwz r3, 0(r3)
/* 80610CB4 00000090  3C 80 00 00 */	lis r4, pno@ha
/* 80610CB8 00000094  80 04 00 00 */	lwz r0, pno@l(r4)
...
/* 80610CD4 000000B0  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80610CD8 000000B4  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 80610CF0 000000CC  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80610CF4 000000D0  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 80610CF8 000000D4  80 63 00 00 */	lwz r3, 0(r3)
/* 80610CFC 000000D8  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80610D00 000000DC  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l

...
/* 806107DC  83 E3 00 38 */	lwz r31, 0x38(r3)	/* effective address: 80434B00 */
...
/* 8061080C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80610810  4B D3 5C A0 */	b PSMTXCopy
/* 80610814  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80610818  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8061081C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80610830  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8061084C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80610880  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80610884  4B D3 5C 2C */	b PSMTXCopy
/* 80610888  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8061088C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80610890  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806108AC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806108C8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8061092C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80610930  4B D3 5B 80 */	b PSMTXCopy
/* 80610934  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80610938  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8061093C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80610964  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80610980  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

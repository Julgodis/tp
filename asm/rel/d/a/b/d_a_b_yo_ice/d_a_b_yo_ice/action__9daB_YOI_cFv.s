...
/* 8063CDA0  4B D2 54 3C */	b _savegpr_29
/* 8063CDA4  7C 7E 1B 78 */	mr r30, r3
/* 8063CDA8  3C 60 80 64 */	lis r3, lit_3776@ha
/* 8063CDAC  3B E3 DC 84 */	addi r31, r3, lit_3776@l
...
/* 8063CDC0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8063CDC4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 8063CDC8  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 8063CE10  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 8063DC84 */
/* 8063CE14  4B A1 06 B8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8063CE28  4B A0 EA F0 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 8063CE7C  3C 60 80 64 */	lis r3, lit_4909@ha
/* 8063CE80  38 63 DF 30 */	addi r3, r3, lit_4909@l
...
/* 8063CF00  4B C2 6A 5C */	b ClrCcMove__9cCcD_SttsFv
lbl_8063CF04:
/* 8063CF04  7F C3 F3 78 */	mr r3, r30
/* 8063CF08  38 9E 07 1C */	addi r4, r30, 0x71c
/* 8063CF0C  4B 9D D7 C0 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8063CF38  4B D0 A2 00 */	b PSVECSquareMag
...
/* 8063CFA8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063CFAC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8063D018  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063D01C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8063D020:
...
/* 8063D034  4B C2 A6 40 */	b cM_atan2s__Fff
/* 8063D038  C0 3F 00 E4 */	lfs f1, 0xe4(r31)
/* 8063D03C  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 8063D040  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8063D044  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8063D090  4B C2 AC 98 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 8063D094  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8063D098  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8063D09C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8063D0A0  38 9E 06 C8 */	addi r4, r30, 0x6c8
/* 8063D0A4  4B A3 73 FC */	b GroundCross__4cBgSFP11cBgS_GndChk
/* 8063D0A8  7F C3 F3 78 */	mr r3, r30
/* 8063D0AC  4B FF FC 69 */	bl crack_execute__9daB_YOI_cFv
/* 8063D0B0  39 61 00 70 */	addi r11, r1, 0x70
/* 8063D0B4  4B D2 51 74 */	b _restgpr_29

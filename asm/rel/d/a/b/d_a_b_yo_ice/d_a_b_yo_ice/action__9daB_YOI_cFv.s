...
/* 8063CDA0 00000010  4B D2 54 3C */	b _savegpr_29
/* 8063CDA4 00000014  7C 7E 1B 78 */	mr r30, r3
/* 8063CDA8 00000018  3C 60 80 64 */	lis r3, lit_3776@ha
/* 8063CDAC 0000001C  3B E3 DC 84 */	addi r31, r3, lit_3776@l
...
/* 8063CDC0 00000030  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8063CDC4 00000034  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l
/* 8063CDC8 00000038  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 8063CE10 00000080  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 8063DC84 */
/* 8063CE14 00000084  4B A1 06 B8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8063CE18 00000088  90 7E 0B 30 */	stw r3, 0xb30(r30)
/* 8063CE1C 0000008C  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
/* 8063CE20 00000090  38 63 02 10 */	addi r3, r3, 0x210
/* 8063CE24 00000094  80 9E 0B 30 */	lwz r4, 0xb30(r30)
/* 8063CE28 00000098  4B A0 EA F0 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 8063CE7C 0000001C  3C 60 80 64 */	lis r3, lit_4909@ha
/* 8063CE80 00000020  38 63 DF 30 */	addi r3, r3, lit_4909@l
...
/* 8063CF00 00000010  4B C2 6A 5C */	b ClrCcMove__9cCcD_SttsFv
lbl_8063CF04:
/* 8063CF04 00000000  7F C3 F3 78 */	mr r3, r30
/* 8063CF08 00000004  38 9E 07 1C */	addi r4, r30, 0x71c
/* 8063CF0C 00000008  4B 9D D7 C0 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8063CF28 00000024  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 8063DC98 */
...
/* 8063CF38 00000034  4B D0 A2 00 */	b PSVECSquareMag
/* 8063CF3C 00000038  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 8063DC98 */
...
/* 8063CF4C 00000008  C8 9F 00 B8 */	lfd f4, 0xb8(r31)	/* effective address: 8063DD3C */
/* 8063CF50 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8063CF54 00000010  C8 7F 00 C0 */	lfd f3, 0xc0(r31)	/* effective address: 8063DD44 */
...
lbl_8063CF9C:
/* 8063CF9C 00000000  C8 1F 00 C8 */	lfd f0, 0xc8(r31)	/* effective address: 8063DD4C */
/* 8063CFA0 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8063CFA4 00000000  40 80 00 10 */	bge lbl_8063CFB4
/* 8063CFA8 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063CFAC 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8063D018 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063D01C 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8063D020:
/* 8063D020 00000000  C0 1F 00 E4 */	lfs f0, 0xe4(r31)	/* effective address: 8063DD68 */
...
/* 8063D034 0000000C  4B C2 A6 40 */	b cM_atan2s__Fff
/* 8063D038 00000010  C0 3F 00 E4 */	lfs f1, 0xe4(r31)	/* effective address: 8063DD68 */
/* 8063D03C 00000014  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 8063D040 00000018  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8063D044 0000001C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8063D07C 00000018  C0 1F 00 EC */	lfs f0, 0xec(r31)	/* effective address: 8063DD70 */
...
/* 8063D090 0000002C  4B C2 AC 98 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 8063D094 00000030  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8063D098 00000034  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8063D09C 00000038  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8063D0A0 0000003C  38 9E 06 C8 */	addi r4, r30, 0x6c8
/* 8063D0A4 00000040  4B A3 73 FC */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8063D0B4 00000050  4B D2 51 74 */	b _restgpr_29

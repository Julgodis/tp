...
/* 8063ACE4  4B D2 74 F8 */	b _savegpr_29
/* 8063ACE8  7C 7E 1B 78 */	mr r30, r3
/* 8063ACEC  3C 60 80 64 */	lis r3, lit_3776@ha
/* 8063ACF0  3B E3 DC 84 */	addi r31, r3, lit_3776@l
...
/* 8063AD30  3C 60 80 64 */	lis r3, lit_4180@ha
/* 8063AD34  38 63 DE DC */	addi r3, r3, lit_4180@l
...
/* 8063ADCC  4B C2 CB C0 */	b cM_rndFX__Ff
...
/* 8063AE64  4B C2 CA 08 */	b cM_rnd__Fv
...
/* 8063AE78  4B C2 CA DC */	b cM_rndF__Ff
...
/* 8063AE9C  4B C2 CA B8 */	b cM_rndF__Ff
...
/* 8063AED8  4B C2 C9 94 */	b cM_rnd__Fv
...
/* 8063AEEC  4B C2 CA 68 */	b cM_rndF__Ff
...
/* 8063AF10  4B C2 CA 44 */	b cM_rndF__Ff
...
/* 8063AF38  4B C3 5C 58 */	b cLib_chaseAngleS__FPsss
...
/* 8063AFC8  4B C3 5B C8 */	b cLib_chaseAngleS__FPsss
...
/* 8063B058  4B C3 56 E8 */	b cLib_chaseF__FPfff
...
/* 8063B06C  4B C3 56 D4 */	b cLib_chaseF__FPfff
lbl_8063B070:
/* 8063B070  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8063B074  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 8063B0C8  4B C3 56 E4 */	b cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 8063B178  4B C3 55 C8 */	b cLib_chaseF__FPfff
...
/* 8063B18C  4B C3 55 B4 */	b cLib_chaseF__FPfff
lbl_8063B190:
...
/* 8063B1D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8063B1DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8063B1E0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8063B1E4  C0 03 05 2C */	lfs f0, 0x52c(r3)	/* effective address: 804066EC */

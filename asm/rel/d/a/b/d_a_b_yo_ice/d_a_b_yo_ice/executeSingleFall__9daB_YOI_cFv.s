...
/* 8063B250  4B D2 6F 88 */	b _savegpr_28
/* 8063B254  7C 7E 1B 78 */	mr r30, r3
/* 8063B258  3C 80 80 64 */	lis r4, lit_3776@ha
/* 8063B25C  3B E4 DC 84 */	addi r31, r4, lit_3776@l
/* 8063B260  80 03 06 98 */	lwz r0, 0x698(r3)
/* 8063B264  28 00 00 0A */	cmplwi r0, 0xa
/* 8063B268  41 81 08 B8 */	bgt lbl_8063BB20
/* 8063B26C  3C 80 80 64 */	lis r4, lit_4385@ha
/* 8063B270  38 84 DF 04 */	addi r4, r4, lit_4385@l
...
/* 8063B32C  4B C3 56 64 */	b cLib_chasePosXZ__FP4cXyzRC4cXyzf
...
/* 8063B40C  4B C2 C5 80 */	b cM_rndFX__Ff
...
/* 8063B468  4B C3 55 28 */	b cLib_chasePosXZ__FP4cXyzRC4cXyzf
...
/* 8063B56C  4B C2 C4 20 */	b cM_rndFX__Ff
...
/* 8063B580  4B C2 C3 D4 */	b cM_rndF__Ff
...
/* 8063B5B0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8063B5B4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8063B630  4B C2 C3 5C */	b cM_rndFX__Ff
...
/* 8063B674  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8063B678  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8063B6D8  4B D0 BC C4 */	b PSVECSquareDistance
...
/* 8063B748  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063B74C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8063B7B8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063B7BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8063B7C0:
...
/* 8063B7E8  4B C3 54 1C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8063B82C  4B C3 53 64 */	b cLib_chaseAngleS__FPsss
...
/* 8063B860  4B C2 C1 2C */	b cM_rndFX__Ff
...
/* 8063B878  4B C2 C1 14 */	b cM_rndFX__Ff
...
/* 8063B8AC  4B C3 52 E4 */	b cLib_chaseAngleS__FPsss
...
/* 8063B8F8  4B A3 41 2C */	b StartShock__12dVibration_cFii4cXyz
...
/* 8063B950  4B C3 52 40 */	b cLib_chaseAngleS__FPsss
...
/* 8063B978  4B C3 4B C8 */	b cLib_addCalcAngleS__FPsssss
...
/* 8063B9BC  4B D0 B7 7C */	b PSVECSquareMag
...
/* 8063BA2C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063BA30  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8063BA9C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8063BAA0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8063BAA4:
...
/* 8063BB2C  4B D2 66 F8 */	b _restgpr_28

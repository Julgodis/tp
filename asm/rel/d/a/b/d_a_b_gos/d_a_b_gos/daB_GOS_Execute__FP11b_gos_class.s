...
/* 80604BA4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80604BA8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80604BAC  38 81 00 08 */	addi r4, r1, 8
/* 80604BB0  4B A1 4C 48 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 80604BB4  3C 80 80 60 */	lis r4, boss@ha
/* 80604BB8  90 64 56 08 */	stw r3, boss@l(r4)
...
/* 80604C0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80604C10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80604C14  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80604C18  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80604C1C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80604C20  4B D4 1C C8 */	b PSMTXTrans
/* 80604C24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80604C28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80604C2C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80604C30  4B A0 78 04 */	b mDoMtx_YrotM__FPA4_fs
/* 80604C34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80604C38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80604C3C  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80604C40  4B A0 77 5C */	b mDoMtx_XrotM__FPA4_fs
/* 80604C44  3C 60 80 60 */	lis r3, l_HIO@ha
/* 80604C48  38 63 56 1C */	addi r3, r3, l_HIO@l
/* 80604C4C  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 80605624 */
/* 80604C50  FC 40 08 90 */	fmr f2, f1
/* 80604C54  FC 60 08 90 */	fmr f3, f1
/* 80604C58  4B A0 81 E0 */	b scaleM__14mDoMtx_stack_cFfff
/* 80604C5C  3C 60 80 60 */	lis r3, lit_3676@ha
/* 80604C60  C0 23 53 D8 */	lfs f1, lit_3676@l(r3)
/* 80604C64  C0 5F 06 98 */	lfs f2, 0x698(r31)
/* 80604C68  C0 7F 06 9C */	lfs f3, 0x69c(r31)
/* 80604C6C  4B A0 81 30 */	b transM__14mDoMtx_stack_cFfff
/* 80604C70  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 80604C74  80 83 00 04 */	lwz r4, 4(r3)
/* 80604C78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80604C7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80604C80  38 84 00 24 */	addi r4, r4, 0x24
/* 80604C84  4B D4 18 2C */	b PSMTXCopy
/* 80604C88  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80604C8C  7C 03 07 74 */	extsb r3, r0
/* 80604C90  4B A2 83 DC */	b dComIfGp_getReverb__Fi
/* 80604C94  7C 65 1B 78 */	mr r5, r3
/* 80604C98  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 80604C9C  38 80 00 00 */	li r4, 0
/* 80604CA0  4B A0 C4 10 */	b play__16mDoExt_McaMorfSOFUlSc
/* 80604CA4  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 80604CA8  4B A0 C5 44 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 80604CAC  38 7F 0C 8C */	addi r3, r31, 0xc8c
/* 80604CB0  3C 80 80 60 */	lis r4, lit_3711@ha
/* 80604CB4  C0 24 53 E8 */	lfs f1, lit_3711@l(r4)
/* 80604CB8  4B C6 A5 48 */	b SetR__8cM3dGCylFf
/* 80604CBC  38 7F 0C 8C */	addi r3, r31, 0xc8c
/* 80604CC0  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80604CC4  4B C6 A5 18 */	b SetC__8cM3dGCylFRC4cXyz
/* 80604CC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80604CCC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80604CD0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80604CD4  38 9F 0B 68 */	addi r4, r31, 0xb68
/* 80604CD8  4B C5 FE D0 */	b Set__4cCcSFP8cCcD_Obj

...
/* 806077C4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806077C8  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
/* 806077CC  7C 04 04 2E */	lfsx f0, r4, r0
/* 806077D0  3C 60 80 61 */	lis r3, lit_4977@ha
/* 806077D4  C0 23 FE 88 */	lfs f1, lit_4977@l(r3)
...
/* 806077FC  4B A7 04 6C */	b __ct__11dBgS_LinChkFv
...
/* 80607810  4B A7 05 54 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80607814  38 00 00 00 */	li r0, 0
/* 80607818  B0 1F 0A 92 */	sth r0, 0xa92(r31)
/* 8060781C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80607820  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80607824  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 80607828  7F C3 F3 78 */	mr r3, r30
/* 8060782C  38 81 00 28 */	addi r4, r1, 0x28
/* 80607830  4B A6 CB 84 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80607834  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80607838  41 82 00 80 */	beq lbl_806078B8
/* 8060783C  3C 60 80 61 */	lis r3, __vt__8cM3dGPla@ha
/* 80607840  38 03 04 20 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80607854  4B A6 CE F0 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80607858  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 8060785C  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 80607860  4B C5 FE 14 */	b cM_atan2s__Fff
...
lbl_806078AC:
/* 806078AC  3C 60 80 61 */	lis r3, __vt__8cM3dGPla@ha
/* 806078B0  38 03 04 20 */	addi r0, r3, __vt__8cM3dGPla@l
/* 806078B4  90 01 00 24 */	stw r0, 0x24(r1)
lbl_806078B8:
/* 806078B8  38 61 00 28 */	addi r3, r1, 0x28
/* 806078BC  38 80 FF FF */	li r4, -1
/* 806078C0  4B A7 04 1C */	b __dt__11dBgS_LinChkFv

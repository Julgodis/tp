...
/* 806087B8 00000010  4B FF CE E1 */	bl _savegpr_28
/* 806087BC 00000014  7C 7C 1B 78 */	mr r28, r3
/* 806087C0 00000018  3C 60 00 00 */	lis r3, lit_3928@ha
/* 806087C4 0000001C  3B A3 00 00 */	addi r29, r3, lit_3928@l
...
/* 806087DC 00000034  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 806087E0 00000038  3B C3 00 00 */	addi r30, r3, g_dComIfG_gameInfo@l
...
/* 80608808 00000060  4B FF CE 91 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8060881C 00000074  3C 60 00 00 */	lis r3, lit_5702@ha
/* 80608820 00000078  38 63 00 00 */	addi r3, r3, lit_5702@l
...
/* 80608834 0000008C  28 04 00 01 */	cmplwi r4, 1
/* 80608838 00000090  40 82 00 10 */	bne lbl_80608848
/* 8060883C 00000094  38 00 00 64 */	li r0, 0x64
/* 80608840 00000098  90 1C 0A A8 */	stw r0, 0xaa8(r28)
/* 80608844 0000009C  48 00 00 14 */	b lbl_80608858
lbl_80608848:
...
/* 8060887C 00000024  3C C0 00 00 */	lis r6, l_HIO@ha
/* 80608880 00000028  38 C6 00 00 */	addi r6, r6, l_HIO@l
...
/* 806088C8 00000038  3C C0 00 00 */	lis r6, l_HIO@ha
/* 806088CC 0000003C  38 C6 00 00 */	addi r6, r6, l_HIO@l
...
/* 80608924 00000020  4B FF CD 75 */	bl cM_rndFX__Ff
...
/* 80608954 00000050  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80608958 00000054  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 8060896C 00000068  7F 83 E3 78 */	mr r3, r28
/* 80608970 0000006C  4B FF D4 09 */	bl setDashSmokeEffect__9daB_MGN_cFv
/* 80608974 00000070  7F 83 E3 78 */	mr r3, r28
/* 80608978 00000074  4B FF E9 25 */	bl setBloodEffect__9daB_MGN_cFv
/* 8060897C 00000078  80 7C 05 BC */	lwz r3, 0x5bc(r28)
/* 80608980 0000007C  38 80 00 01 */	li r4, 1
/* 80608984 00000080  88 03 00 11 */	lbz r0, 0x11(r3)
/* 80608988 00000084  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 8060898C 00000088  40 82 00 18 */	bne lbl_806089A4
/* 80608990 0000008C  C0 3D 00 04 */	lfs f1, 4(r29)
/* 80608994 00000090  C0 03 00 18 */	lfs f0, 0x18(r3)
/* 80608998 00000094  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 8060899C 00000098  41 82 00 08 */	beq lbl_806089A4
/* 806089A0 0000009C  38 80 00 00 */	li r4, 0
lbl_806089A4:
...
/* 806089F8 0000000C  4B FF CC A1 */	bl abs
...
lbl_80608A14:
/* 80608A14 00000000  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80608A18 00000004  38 83 00 00 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80608A58 00000044  4B FF CC 41 */	bl PSVECAdd
/* 80608A5C 00000048  38 7C 05 2C */	addi r3, r28, 0x52c
/* 80608A60 0000004C  3C 80 00 00 */	lis r4, l_HIO@ha
/* 80608A64 00000050  38 84 00 00 */	addi r4, r4, l_HIO@l
/* 80608A68 00000054  C0 24 00 10 */	lfs f1, 0x10(r4)
/* 80608A6C 00000058  C0 5D 00 60 */	lfs f2, 0x60(r29)
/* 80608A70 0000005C  4B FF CC 29 */	bl cLib_chaseF__FPfff
/* 80608A74 00000060  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80608A78 00000064  38 81 00 40 */	addi r4, r1, 0x40
/* 80608A7C 00000068  4B FF CC 1D */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80608A94 00000080  4B FF CC 05 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80608ACC 000000B8  4B FF CB CD */	bl PSVECSquareDistance
...
/* 80608B3C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80608B40 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80608BAC 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80608BB0 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80608BB4:
...
/* 80608C48 0000000C  4B FF CA 51 */	bl cLib_chaseF__FPfff
/* 80608C4C 00000010  80 7C 05 C4 */	lwz r3, 0x5c4(r28)
/* 80608C50 00000014  C0 3D 00 64 */	lfs f1, 0x64(r29)
/* 80608C54 00000018  4B FF CA 45 */	bl checkPass__12J3DFrameCtrlFf
...
/* 80608C64 00000028  4B FF CA 35 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80608C68 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80608C6C 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80608C70 00000034  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80608C74 00000038  4B FF CA 25 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80608C84 00000048  4B FF CA 15 */	bl transM__14mDoMtx_stack_cFfff
/* 80608C88 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80608C8C 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80608CA8 0000006C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80608CAC 00000070  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80608CF4 000000B8  4B FF C9 A5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80608D68 0000001C  7F 83 E3 78 */	mr r3, r28
/* 80608D6C 00000020  4B FF D5 55 */	bl setSlideSmokeEffect__9daB_MGN_cFv
/* 80608D70 00000024  7F 83 E3 78 */	mr r3, r28
/* 80608D74 00000028  4B FF E5 29 */	bl setBloodEffect__9daB_MGN_cFv
/* 80608D78 0000002C  A8 1C 0A 90 */	lha r0, 0xa90(r28)
/* 80608D7C 00000030  7C 1F 00 50 */	subf r0, r31, r0
/* 80608D80 00000034  7C 03 07 34 */	extsh r3, r0
/* 80608D84 00000038  4B FF C9 15 */	bl abs
/* 80608D88 0000003C  2C 03 08 00 */	cmpwi r3, 0x800
/* 80608D8C 00000040  40 80 00 14 */	bge lbl_80608DA0
/* 80608D90 00000044  A8 7C 0A 90 */	lha r3, 0xa90(r28)
/* 80608D94 00000048  A8 1C 0A 92 */	lha r0, 0xa92(r28)
/* 80608D98 0000004C  7C 03 02 14 */	add r0, r3, r0
/* 80608D9C 00000050  B0 1C 0A 90 */	sth r0, 0xa90(r28)
lbl_80608DA0:
/* 80608DA0 00000000  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80608DA4 00000004  38 83 00 00 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80608DE4 00000044  4B FF C8 B5 */	bl PSVECAdd
/* 80608DE8 00000048  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80608DEC 0000004C  38 81 00 40 */	addi r4, r1, 0x40
/* 80608DF0 00000050  4B FF C8 A9 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80608E04 00000064  4B FF C8 95 */	bl cLib_addCalcAngleS2__FPssss
/* 80608E08 00000068  7F 83 E3 78 */	mr r3, r28
/* 80608E0C 0000006C  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80608E10 00000070  4B FF C8 89 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80608E28 00000088  4B FF C8 71 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80608E44 000000A4  4B FF C8 55 */	bl cLib_chaseF__FPfff
...
/* 80608E84 000000E4  7F 83 E3 78 */	mr r3, r28
/* 80608E88 000000E8  4B FF E4 15 */	bl setBloodEffect__9daB_MGN_cFv
/* 80608E8C 000000EC  7F 83 E3 78 */	mr r3, r28
/* 80608E90 000000F0  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 80608E94 000000F4  4B FF C8 05 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80608E98 000000F8  7C 7D 1B 78 */	mr r29, r3
/* 80608E9C 000000FC  38 7C 04 E6 */	addi r3, r28, 0x4e6
/* 80608EA0 00000100  7F A4 EB 78 */	mr r4, r29
/* 80608EA4 00000104  38 A0 00 08 */	li r5, 8
/* 80608EA8 00000108  38 C0 08 00 */	li r6, 0x800
/* 80608EAC 0000010C  4B FF C7 ED */	bl cLib_addCalcAngleS2__FPssss
/* 80608EB0 00000110  7F 83 E3 78 */	mr r3, r28
/* 80608EB4 00000114  7F A4 EB 78 */	mr r4, r29
/* 80608EB8 00000118  4B FF F8 81 */	bl calcJointAngle__9daB_MGN_cFs
/* 80608EBC 0000011C  80 1C 0A 9C */	lwz r0, 0xa9c(r28)
/* 80608EC0 00000120  2C 00 00 00 */	cmpwi r0, 0
/* 80608EC4 00000124  40 82 00 1C */	bne lbl_80608EE0
/* 80608EC8 00000128  38 00 00 00 */	li r0, 0
/* 80608ECC 0000012C  98 1C 0A FD */	stb r0, 0xafd(r28)
/* 80608ED0 00000130  7F 83 E3 78 */	mr r3, r28
/* 80608ED4 00000134  38 80 00 02 */	li r4, 2
/* 80608ED8 00000138  38 A0 00 00 */	li r5, 0
/* 80608EDC 0000013C  4B FF EB 51 */	bl setActionMode__9daB_MGN_cFii
lbl_80608EE0:
/* 80608EE0 00000000  39 61 00 70 */	addi r11, r1, 0x70
/* 80608EE4 00000004  4B FF C7 B5 */	bl _restgpr_28

...
/* 806087C0 00000018  3C 60 00 00 */	lis r3, lit_3928@ha /* 8060FDE0 */
/* 806087C4 0000001C  3B A3 00 00 */	addi r29, r3, lit_3928@l /* 8060FDE0 */
...
/* 806087DC 00000034  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806087E0 00000038  3B C3 00 00 */	addi r30, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8060881C 00000074  3C 60 00 00 */	lis r3, lit_5702@ha /* 806101F4 */
/* 80608820 00000078  38 63 00 00 */	addi r3, r3, lit_5702@l /* 806101F4 */
...
/* 8060887C 00000024  3C C0 00 00 */	lis r6, l_HIO@ha /* 80610450 */
/* 80608880 00000028  38 C6 00 00 */	addi r6, r6, l_HIO@l /* 80610450 */
...
/* 806088C8 00000038  3C C0 00 00 */	lis r6, l_HIO@ha /* 80610450 */
/* 806088CC 0000003C  38 C6 00 00 */	addi r6, r6, l_HIO@l /* 80610450 */
...
/* 80608954 00000050  3C 60 00 00 */	lis r3, l_HIO@ha /* 80610450 */
/* 80608958 00000054  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80610450 */
...
lbl_80608A14:
/* 80608A14 00000000  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80608A18 00000004  38 83 00 00 */	addi r4, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80608A60 0000004C  3C 80 00 00 */	lis r4, l_HIO@ha /* 80610450 */
/* 80608A64 00000050  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80610450 */
...
/* 80608B3C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80608B40 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 80608BAC 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80608BB0 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_80608BB4:
...
/* 80608C68 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80608C6C 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80608C88 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80608C8C 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80608CA8 0000006C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80608CAC 00000070  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80608D84 0000001C  4B FF C9 15 */	bl abs
...
lbl_80608DA0:
/* 80608DA0 00000000  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80608DA4 00000004  38 83 00 00 */	addi r4, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80608E94 00000010  4B FF C8 05 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80608EAC 00000028  4B FF C7 ED */	bl cLib_addCalcAngleS2__FPssss

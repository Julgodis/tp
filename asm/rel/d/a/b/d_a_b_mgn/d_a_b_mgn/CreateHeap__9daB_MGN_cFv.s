...
/* 8060EAF8 00000018  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060EAFC 0000001C  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 8060EB00 00000020  38 63 00 07 */	addi r3, r3, 7
/* 8060EB04 00000024  38 80 00 2F */	li r4, 0x2f
/* 8060EB08 00000028  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 8060EB0C 0000002C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 8060EB38 00000058  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060EB3C 0000005C  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 8060EB88 000000A8  3D 20 00 00 */	lis r9, lit_3930@ha
/* 8060EB8C 000000AC  C0 29 00 00 */	lfs f1, lit_3930@l(r9)
...
/* 8060EBCC 00000008  3C 60 00 00 */	lis r3, JointCallBack__9daB_MGN_cFP8J3DJointi@ha
/* 8060EBD0 0000000C  38 83 00 00 */	addi r4, r3, JointCallBack__9daB_MGN_cFP8J3DJointi@l
...
/* 8060EC24 00000024  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8060EC28 00000028  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
lbl_8060EC58:
/* 8060EC58 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060EC5C 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 8060EC88 00000030  3D 00 00 00 */	lis r8, lit_3929@ha
/* 8060EC8C 00000034  C0 28 00 00 */	lfs f1, lit_3929@l(r8)
...
/* 8060ECBC 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8060ECC0 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
lbl_8060ECF0:
/* 8060ECF0 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060ECF4 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 8060ED2C 0000003C  3D 00 00 00 */	lis r8, lit_3929@ha
/* 8060ED30 00000040  C0 28 00 00 */	lfs f1, lit_3929@l(r8)
...
lbl_8060ED50:
/* 8060ED50 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060ED54 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 8060EDB8 00000010  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060EDBC 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 8060EDDC 00000034  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060EDE0 00000038  3B 63 00 00 */	addi r27, r3, stringBase0@l
/* 8060EDE4 0000003C  3C 60 00 00 */	lis r3, lit_3930@ha
/* 8060EDE8 00000040  3B 43 00 00 */	addi r26, r3, lit_3930@l
...
/* 8060EE00 00000010  3C 60 00 00 */	lis r3, stringBase0@ha
/* 8060EE04 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l
...
/* 8060EE4C 0000005C  3D 20 00 00 */	lis r9, lit_3929@ha
/* 8060EE50 00000060  C0 29 00 00 */	lfs f1, lit_3929@l(r9)
...
/* 8060EE9C 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8060EEA0 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 8060EF28 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8060EF2C 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 8060EFB4 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8060EFB8 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l

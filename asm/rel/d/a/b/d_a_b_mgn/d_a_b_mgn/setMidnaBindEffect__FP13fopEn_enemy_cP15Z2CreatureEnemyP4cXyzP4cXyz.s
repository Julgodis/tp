...
/* 8060F974  4B D5 28 40 */	b _savegpr_19
/* 8060F978  7C 7E 1B 78 */	mr r30, r3
/* 8060F97C  7C 9A 23 78 */	mr r26, r4
/* 8060F980  7C BB 2B 78 */	mr r27, r5
/* 8060F984  7C DC 33 78 */	mr r28, r6
/* 8060F988  3C 60 80 61 */	lis r3, cNullVec__6Z2Calc@ha
/* 8060F98C  3A E3 00 94 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 8060F990  3C 60 80 61 */	lis r3, lit_3928@ha
/* 8060F994  3B E3 FD E0 */	addi r31, r3, lit_3928@l
/* 8060F998  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8060F99C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8060F9A0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8060F9A4  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 8060F9A8  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 8060F9D0  4B B9 CB AC */	b dKy_darkworld_check__Fv
...
/* 8060F9F4  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 8060F9F8  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 8060F9FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 8060FA00  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 8060FA04  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 8060FA08  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 8060FA0C  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 8060FA10  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8060FA14  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8060FA18  4B D3 6A 98 */	b PSMTXCopy
...
/* 8060FA30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8060FA34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8060FA38  38 81 00 4C */	addi r4, r1, 0x4c
/* 8060FA3C  38 A1 00 58 */	addi r5, r1, 0x58
/* 8060FA40  4B D3 73 2C */	b PSMTXMultVec
/* 8060FA44  38 61 00 34 */	addi r3, r1, 0x34
/* 8060FA48  38 81 00 58 */	addi r4, r1, 0x58
/* 8060FA4C  7F 65 DB 78 */	mr r5, r27
/* 8060FA50  4B C5 70 E4 */	b __mi__4cXyzCFRC3Vec
...
/* 8060FA6C  4B C5 7C 08 */	b cM_atan2s__Fff
...
/* 8060FAA0  4B C5 7B D4 */	b cM_atan2s__Fff
...
/* 8060FABC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8060FAC0  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 8060FAC4  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 8060FB10  4B A3 CF 80 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8060FB14  7C 79 1B 79 */	or. r25, r3, r3
/* 8060FB18  41 82 00 FC */	beq lbl_8060FC14
/* 8060FB1C  38 61 00 40 */	addi r3, r1, 0x40
/* 8060FB20  4B D3 76 18 */	b PSVECSquareMag
...
/* 8060FB90  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8060FB94  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8060FC00  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8060FC04  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8060FC08:
...
/* 8060FC58  4B A3 CE 38 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8060FC94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8060FC98  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 8060FCC4  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 8060FD04  4B A3 D7 C8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8060FD64  4B D5 24 9C */	b _restgpr_19

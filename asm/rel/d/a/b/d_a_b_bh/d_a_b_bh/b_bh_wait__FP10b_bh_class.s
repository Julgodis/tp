...
/* 805AE440  4B DB 3D 9C */	b _savegpr_29
/* 805AE444  7C 7D 1B 78 */	mr r29, r3
/* 805AE448  3C 60 80 5B */	lis r3, lit_3764@ha
/* 805AE44C  3B C3 31 40 */	addi r30, r3, lit_3764@l
/* 805AE450  80 1D 04 A4 */	lwz r0, 0x4a4(r29)
/* 805AE454  90 01 00 0C */	stw r0, 0xc(r1)
/* 805AE458  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 805AE45C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 805AE460  38 81 00 0C */	addi r4, r1, 0xc
/* 805AE464  4B A6 B3 94 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 805AE488  4B CB 94 CC */	b cM_rndF__Ff
...
/* 805AE4AC  4B CB 94 A8 */	b cM_rndF__Ff
...
lbl_805AE4C8:
/* 805AE4C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805AE4CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805AE4D0  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 805AE4EC  4B CB 94 68 */	b cM_rndF__Ff
...
/* 805AE510  4B CB 94 44 */	b cM_rndF__Ff
...
/* 805AE574  3C 60 80 5B */	lis r3, l_HIO@ha
/* 805AE578  3B E3 33 FC */	addi r31, r3, l_HIO@l
/* 805AE57C  A8 1F 00 10 */	lha r0, 0x10(r31)	/* effective address: 805B340C */
...
/* 805AE5A4  4B CB 93 B0 */	b cM_rndF__Ff
...
lbl_805AE5E8:
/* 805AE5E8  3C 60 80 5B */	lis r3, l_HIO@ha
/* 805AE5EC  3B E3 33 FC */	addi r31, r3, l_HIO@l
/* 805AE5F0  A8 1F 00 10 */	lha r0, 0x10(r31)	/* effective address: 805B340C */
...
/* 805AE610  4B CB 93 44 */	b cM_rndF__Ff
...
/* 805AE65C  4B CB 92 F8 */	b cM_rndF__Ff
...
/* 805AE67C  4B CB 93 10 */	b cM_rndFX__Ff
...
/* 805AE690  4B CB 92 FC */	b cM_rndFX__Ff
...
/* 805AE6A4  4B CB 92 E8 */	b cM_rndFX__Ff
/* 805AE6A8  C0 7D 06 A8 */	lfs f3, 0x6a8(r29)
/* 805AE6AC  C0 5E 00 30 */	lfs f2, 0x30(r30)
/* 805AE6B0  3C 60 80 5B */	lis r3, l_HIO@ha
/* 805AE6B4  38 63 33 FC */	addi r3, r3, l_HIO@l
/* 805AE6B8  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 805B3404 */
...
/* 805AE6F4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 805AE6F8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 805AE6FC  80 A5 5D AC */	lwz r5, 0x5dac(r5)	/* effective address: 8040BF6C */
/* 805AE700  38 A5 04 D0 */	addi r5, r5, 0x4d0
/* 805AE704  4B CB 84 30 */	b __mi__4cXyzCFRC3Vec
/* 805AE708  38 61 00 1C */	addi r3, r1, 0x1c
/* 805AE70C  4B D9 8A 2C */	b PSVECSquareMag
...
/* 805AE77C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805AE780  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805AE7EC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805AE7F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805AE7F4:
...
/* 805AE830  3C 60 80 5B */	lis r3, bh@ha
/* 805AE834  38 A3 34 14 */	addi r5, r3, bh@l
...
/* 805AE89C  4B CB 90 B8 */	b cM_rndF__Ff
...
/* 805AE8C0  4B CB 90 94 */	b cM_rndF__Ff
...
/* 805AE924  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 805AE928  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 805AE980  4B CC 10 BC */	b cLib_addCalc2__FPffff
...
/* 805AE9A4  4B CC 10 98 */	b cLib_addCalc2__FPffff
...
/* 805AE9C8  4B CC 10 74 */	b cLib_addCalc2__FPffff
...
/* 805AE9DC  4B CC 10 60 */	b cLib_addCalc2__FPffff
...
/* 805AEAA0  4B CC 1B 68 */	b cLib_addCalcAngleS2__FPssss
...
/* 805AEAB4  4B CC 1B 54 */	b cLib_addCalcAngleS2__FPssss
...
/* 805AEAE8  4B A6 E6 24 */	b fopAcM_effHamonSet__FPUlPC4cXyzff
/* 805AEAEC  39 61 00 70 */	addi r11, r1, 0x70
/* 805AEAF0  4B DB 37 38 */	b _restgpr_29

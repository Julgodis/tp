...
/* 8064C5B8 00000010  4B D1 5C 18 */	b _savegpr_26
/* 8064C5BC 00000014  7C 7E 1B 78 */	mr r30, r3
/* 8064C5C0 00000018  3C 80 80 65 */	lis r4, lit_3757@ha
/* 8064C5C4 0000001C  3B E4 EB 1C */	addi r31, r4, lit_3757@l
...
/* 8064C5EC 0000000C  3C 60 80 65 */	lis r3, lit_9987@ha
/* 8064C5F0 00000010  38 63 F3 C8 */	addi r3, r3, lit_9987@l
...
/* 8064C72C 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8064C730 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8064C734 00000014  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8064C738 00000018  80 03 05 88 */	lwz r0, 0x588(r3)	/* effective address: 80406748 */
/* 8064C73C 0000001C  64 00 02 00 */	oris r0, r0, 0x200
/* 8064C740 00000020  90 03 05 88 */	stw r0, 0x588(r3)	/* effective address: 80406748 */
lbl_8064C744:
/* 8064C744 00000000  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 8064EB44 */
...
/* 8064C7A4 00000018  4B 9E 12 F8 */	b dComIfGs_onOneZoneSwitch__Fii
...
/* 8064C7B8 0000000C  4B 9E 13 48 */	b dComIfGs_offOneZoneSwitch__Fii
...
/* 8064C7DC 0000001C  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 8064EB28 */
/* 8064C7E0 00000020  4B CD BC 4C */	b checkPass__12J3DFrameCtrlFf
...
lbl_8064C818:
/* 8064C818 00000000  C0 3F 01 98 */	lfs f1, 0x198(r31)	/* effective address: 8064ECB4 */
/* 8064C81C 00000004  C0 1E 06 C0 */	lfs f0, 0x6c0(r30)
/* 8064C820 00000008  EC 41 00 32 */	fmuls f2, f1, f0
/* 8064C824 0000000C  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 8064EB38 */
...
/* 8064C838 00000004  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 8064EB38 */
/* 8064C83C 00000008  4B A2 97 1C */	b SetWall__12dBgS_AcchCirFff
/* 8064C840 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8064C844 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8064C854 00000020  4B 9E 83 6C */	b offSwitch__12dSv_danBit_cFi
/* 8064C858 00000024  7F A3 EB 78 */	mr r3, r29
/* 8064C85C 00000028  38 80 00 15 */	li r4, 0x15
/* 8064C860 0000002C  4B 9E 83 60 */	b offSwitch__12dSv_danBit_cFi
/* 8064C864 00000030  7F A3 EB 78 */	mr r3, r29
/* 8064C868 00000034  38 80 00 16 */	li r4, 0x16
/* 8064C86C 00000038  4B 9E 83 54 */	b offSwitch__12dSv_danBit_cFi
...
/* 8064C8A0 00000008  4B 9E 82 F8 */	b onSwitch__12dSv_danBit_cFi
...
/* 8064C8B0 00000008  4B 9E 82 E8 */	b onSwitch__12dSv_danBit_cFi
...
/* 8064C8C0 00000008  4B 9E 82 D8 */	b onSwitch__12dSv_danBit_cFi
lbl_8064C8C4:
/* 8064C8C4 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8064C8C8 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8064C8CC 00000008  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8064C914 00000050  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 8064EB28 */
/* 8064C918 00000054  4B A0 0B B4 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8064C940 0000001C  4B 9E 11 5C */	b dComIfGs_onOneZoneSwitch__Fii
...
/* 8064C954 00000004  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 8064C958 00000008  3B A4 61 C0 */	addi r29, r4, g_dComIfG_gameInfo@l
/* 8064C95C 0000000C  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 8064C960 00000010  4B 9C DD D8 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064C9A4 00000008  4B D1 87 2C */	b abs
...
/* 8064C9E4 00000004  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 8064C9E8 00000008  4B 9C DD 28 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064CA34 00000014  4B C2 3B 0C */	b cLib_addCalcAngleS__FPsssss
...
/* 8064CA4C 0000002C  4B C2 3A F4 */	b cLib_addCalcAngleS__FPsssss
...
/* 8064CA64 00000044  4B C2 3A DC */	b cLib_addCalcAngleS__FPsssss
...
/* 8064CA74 00000054  3C 60 80 45 */	lis r3, data_80450D68@ha
/* 8064CA78 00000058  98 03 0D 68 */	stb r0, data_80450D68@l(r3)
/* 8064CA7C 0000005C  88 1E 06 FB */	lbz r0, 0x6fb(r30)
/* 8064CA80 00000060  3C 60 80 65 */	lis r3, data_8064F030@ha
/* 8064CA84 00000064  38 63 F0 30 */	addi r3, r3, data_8064F030@l
/* 8064CA88 00000068  7C 03 00 AE */	lbzx r0, r3, r0
/* 8064CA8C 0000006C  3C 60 80 45 */	lis r3, data_804505F0@ha
/* 8064CA90 00000070  98 03 05 F0 */	stb r0, data_804505F0@l(r3)
...
/* 8064CAA4 00000084  4B 9D A5 44 */	b dStage_RoomCheck__FP11cBgS_GndChk
lbl_8064CAA8:
/* 8064CAA8 00000000  7F C3 F3 78 */	mr r3, r30
/* 8064CAAC 00000004  38 9E 09 A4 */	addi r4, r30, 0x9a4
/* 8064CAB0 00000008  4B 9C DC 1C */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8064CAC4 0000001C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 8064CAC8 00000020  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 8064CACC 00000024  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8064CAD0 00000028  4B A2 9F DC */	b CrrPos__9dBgS_AcchFR4dBgS
lbl_8064CAD4:
/* 8064CAD4 00000000  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 8064EB38 */
/* 8064CAD8 00000004  C0 1E 06 C4 */	lfs f0, 0x6c4(r30)
/* 8064CADC 00000008  EC 21 00 32 */	fmuls f1, f1, f0
/* 8064CAE0 0000000C  4B D1 55 CC */	b __cvt_fp2unsigned
...
/* 8064CAF0 0000001C  4B 9E 05 7C */	b dComIfGp_getReverb__Fi
...
/* 8064CB00 0000002C  4B 9C 45 B0 */	b play__16mDoExt_McaMorfSOFUlSc
/* 8064CB04 00000030  39 61 00 50 */	addi r11, r1, 0x50
/* 8064CB08 00000034  4B D1 57 14 */	b _restgpr_26

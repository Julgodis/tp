...
/* 8064C5B8  4B D1 5C 18 */	b _savegpr_26
/* 8064C5BC  7C 7E 1B 78 */	mr r30, r3
/* 8064C5C0  3C 80 80 65 */	lis r4, lit_3757@ha
/* 8064C5C4  3B E4 EB 1C */	addi r31, r4, lit_3757@l
...
/* 8064C5EC  3C 60 80 65 */	lis r3, lit_9987@ha
/* 8064C5F0  38 63 F3 C8 */	addi r3, r3, lit_9987@l
...
/* 8064C72C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064C730  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064C734  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8064C738  80 03 05 88 */	lwz r0, 0x588(r3)	/* effective address: 80406748 */
/* 8064C73C  64 00 02 00 */	oris r0, r0, 0x200
/* 8064C740  90 03 05 88 */	stw r0, 0x588(r3)	/* effective address: 80406748 */
lbl_8064C744:
...
/* 8064C7A4  4B 9E 12 F8 */	b dComIfGs_onOneZoneSwitch__Fii
...
/* 8064C7B8  4B 9E 13 48 */	b dComIfGs_offOneZoneSwitch__Fii
...
/* 8064C7E0  4B CD BC 4C */	b checkPass__12J3DFrameCtrlFf
...
/* 8064C83C  4B A2 97 1C */	b SetWall__12dBgS_AcchCirFff
/* 8064C840  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064C844  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064C848  3B A3 09 78 */	addi r29, r3, 0x978
/* 8064C84C  7F A3 EB 78 */	mr r3, r29
/* 8064C850  38 80 00 14 */	li r4, 0x14
/* 8064C854  4B 9E 83 6C */	b offSwitch__12dSv_danBit_cFi
/* 8064C858  7F A3 EB 78 */	mr r3, r29
/* 8064C85C  38 80 00 15 */	li r4, 0x15
/* 8064C860  4B 9E 83 60 */	b offSwitch__12dSv_danBit_cFi
/* 8064C864  7F A3 EB 78 */	mr r3, r29
/* 8064C868  38 80 00 16 */	li r4, 0x16
/* 8064C86C  4B 9E 83 54 */	b offSwitch__12dSv_danBit_cFi
...
/* 8064C8A0  4B 9E 82 F8 */	b onSwitch__12dSv_danBit_cFi
/* 8064C8A4  48 00 00 20 */	b lbl_8064C8C4
lbl_8064C8A8:
/* 8064C8A8  7F A3 EB 78 */	mr r3, r29
/* 8064C8AC  38 80 00 15 */	li r4, 0x15
/* 8064C8B0  4B 9E 82 E8 */	b onSwitch__12dSv_danBit_cFi
/* 8064C8B4  48 00 00 10 */	b lbl_8064C8C4
lbl_8064C8B8:
/* 8064C8B8  7F A3 EB 78 */	mr r3, r29
/* 8064C8BC  38 80 00 16 */	li r4, 0x16
/* 8064C8C0  4B 9E 82 D8 */	b onSwitch__12dSv_danBit_cFi
lbl_8064C8C4:
/* 8064C8C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064C8C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064C8CC  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8064C918  4B A0 0B B4 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8064C940  4B 9E 11 5C */	b dComIfGs_onOneZoneSwitch__Fii
...
/* 8064C954  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8064C958  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 8064C95C  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 8064C960  4B 9C DD D8 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064C9E8  4B 9C DD 28 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064CA34  4B C2 3B 0C */	b cLib_addCalcAngleS__FPsssss
...
/* 8064CA4C  4B C2 3A F4 */	b cLib_addCalcAngleS__FPsssss
...
/* 8064CA64  4B C2 3A DC */	b cLib_addCalcAngleS__FPsssss
/* 8064CA68  7F C3 F3 78 */	mr r3, r30
/* 8064CA6C  4B FF E8 05 */	bl calcMahojinAnime__10daB_ZANT_cFv
/* 8064CA70  38 00 00 01 */	li r0, 1
/* 8064CA74  3C 60 80 45 */	lis r3, data_80450D68@ha
/* 8064CA78  98 03 0D 68 */	stb r0, data_80450D68@l(r3)
/* 8064CA7C  88 1E 06 FB */	lbz r0, 0x6fb(r30)
/* 8064CA80  3C 60 80 65 */	lis r3, data_8064F030@ha
/* 8064CA84  38 63 F0 30 */	addi r3, r3, data_8064F030@l
/* 8064CA88  7C 03 00 AE */	lbzx r0, r3, r0
/* 8064CA8C  3C 60 80 45 */	lis r3, data_804505F0@ha
/* 8064CA90  98 03 05 F0 */	stb r0, data_804505F0@l(r3)
...
/* 8064CAA4  4B 9D A5 44 */	b dStage_RoomCheck__FP11cBgS_GndChk
lbl_8064CAA8:
/* 8064CAA8  7F C3 F3 78 */	mr r3, r30
/* 8064CAAC  38 9E 09 A4 */	addi r4, r30, 0x9a4
/* 8064CAB0  4B 9C DC 1C */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz

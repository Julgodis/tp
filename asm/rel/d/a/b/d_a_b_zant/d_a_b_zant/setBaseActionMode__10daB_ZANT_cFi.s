...
/* 8064C1D0 00000010  4B D1 60 0C */	b _savegpr_29
/* 8064C1D4 00000014  7C 7F 1B 78 */	mr r31, r3
/* 8064C1D8 00000018  3C A0 80 65 */	lis r5, lit_3757@ha
/* 8064C1DC 0000001C  3B C5 EB 1C */	addi r30, r5, lit_3757@l
...
/* 8064C1EC 0000002C  3C A0 80 65 */	lis r5, lit_9869@ha
/* 8064C1F0 00000030  38 A5 F3 AC */	addi r5, r5, lit_9869@l
...
lbl_8064C204:
/* 8064C204 00000000  2C 04 00 00 */	cmpwi r4, 0
/* 8064C208 00000004  40 82 00 30 */	bne lbl_8064C238
/* 8064C20C 00000008  88 1F 07 0C */	lbz r0, 0x70c(r31)
/* 8064C210 0000000C  28 00 00 00 */	cmplwi r0, 0
/* 8064C214 00000010  40 82 00 14 */	bne lbl_8064C228
/* 8064C218 00000014  38 80 00 05 */	li r4, 5
/* 8064C21C 00000018  38 A0 00 00 */	li r5, 0
/* 8064C220 0000001C  4B FF 24 A5 */	bl setActionMode__10daB_ZANT_cFii
/* 8064C224 00000020  48 00 03 6C */	b lbl_8064C590
lbl_8064C228:
...
/* 8064C258 00000020  3C 80 80 65 */	lis r4, data_8064F66C@ha
/* 8064C25C 00000024  38 04 F6 6C */	addi r0, r4, data_8064F66C@l
...
/* 8064C298 00000008  C0 1E 00 28 */	lfs f0, 0x28(r30)	/* effective address: 8064EB44 */
/* 8064C29C 0000000C  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 8064C2A0 00000010  C0 3E 00 6C */	lfs f1, 0x6c(r30)	/* effective address: 8064EB88 */
/* 8064C2A4 00000014  4B C1 B6 B0 */	b cM_rndF__Ff
/* 8064C2A8 00000018  88 1F 06 FE */	lbz r0, 0x6fe(r31)
/* 8064C2AC 0000001C  C8 5E 00 70 */	lfd f2, 0x70(r30)	/* effective address: 8064EB8C */
...
/* 8064C2C8 00000038  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 8064EB28 */
...
/* 8064C2F8 00000068  3C 60 80 65 */	lis r3, data_8064F66C@ha
/* 8064C2FC 0000006C  38 03 F6 6C */	addi r0, r3, data_8064F66C@l
...
lbl_8064C338:
/* 8064C338 00000000  2C 04 00 00 */	cmpwi r4, 0
/* 8064C33C 00000004  40 82 00 14 */	bne lbl_8064C350
/* 8064C340 00000008  38 80 00 0A */	li r4, 0xa
/* 8064C344 0000000C  38 A0 00 00 */	li r5, 0
/* 8064C348 00000010  4B FF 23 7D */	bl setActionMode__10daB_ZANT_cFii
/* 8064C34C 00000014  48 00 02 44 */	b lbl_8064C590
lbl_8064C350:
/* 8064C350 00000000  2C 04 00 01 */	cmpwi r4, 1
/* 8064C354 00000004  40 82 00 4C */	bne lbl_8064C3A0
/* 8064C358 00000008  C0 1E 01 8C */	lfs f0, 0x18c(r30)	/* effective address: 8064ECA8 */
...
/* 8064C368 00000018  C0 1E 00 28 */	lfs f0, 0x28(r30)	/* effective address: 8064EB44 */
/* 8064C36C 0000001C  D0 1F 06 A0 */	stfs f0, 0x6a0(r31)
/* 8064C370 00000020  C0 1E 01 BC */	lfs f0, 0x1bc(r30)	/* effective address: 8064ECD8 */
/* 8064C374 00000024  D0 1F 06 A4 */	stfs f0, 0x6a4(r31)
/* 8064C378 00000028  C0 1E 01 E8 */	lfs f0, 0x1e8(r30)	/* effective address: 8064ED04 */
...
lbl_8064C3B0:
/* 8064C3B0 00000000  2C 04 00 00 */	cmpwi r4, 0
/* 8064C3B4 00000004  40 82 00 14 */	bne lbl_8064C3C8
/* 8064C3B8 00000008  38 80 00 0B */	li r4, 0xb
/* 8064C3BC 0000000C  38 A0 00 64 */	li r5, 0x64
/* 8064C3C0 00000010  4B FF 23 05 */	bl setActionMode__10daB_ZANT_cFii
/* 8064C3C4 00000014  48 00 00 28 */	b lbl_8064C3EC
lbl_8064C3C8:
...
lbl_8064C3F8:
/* 8064C3F8 00000000  2C 04 00 00 */	cmpwi r4, 0
/* 8064C3FC 00000004  40 82 00 14 */	bne lbl_8064C410
/* 8064C400 00000008  38 80 00 07 */	li r4, 7
/* 8064C404 0000000C  38 A0 00 00 */	li r5, 0
/* 8064C408 00000010  4B FF 22 BD */	bl setActionMode__10daB_ZANT_cFii
/* 8064C40C 00000014  48 00 01 84 */	b lbl_8064C590
lbl_8064C410:
...
/* 8064C424 00000014  4B 9C D5 98 */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 8064C444 00000034  C0 1E 03 40 */	lfs f0, 0x340(r30)	/* effective address: 8064EE5C */
...
/* 8064C45C 0000004C  C0 3E 00 78 */	lfs f1, 0x78(r30)	/* effective address: 8064EB94 */
/* 8064C460 00000050  57 A0 04 38 */	rlwinm r0, r29, 0, 0x10, 0x1c
/* 8064C464 00000054  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8064C468 00000058  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8064C498 00000088  4B CF AB F8 */	b PSVECAdd
lbl_8064C49C:
...
lbl_8064C4E0:
/* 8064C4E0 00000000  2C 04 00 00 */	cmpwi r4, 0
/* 8064C4E4 00000004  40 82 00 14 */	bne lbl_8064C4F8
/* 8064C4E8 00000008  38 80 00 0F */	li r4, 0xf
/* 8064C4EC 0000000C  38 A0 00 00 */	li r5, 0
/* 8064C4F0 00000010  4B FF 21 D5 */	bl setActionMode__10daB_ZANT_cFii
/* 8064C4F4 00000014  48 00 00 9C */	b lbl_8064C590
lbl_8064C4F8:
...
lbl_8064C530:
/* 8064C530 00000000  2C 04 00 00 */	cmpwi r4, 0
/* 8064C534 00000004  40 82 00 14 */	bne lbl_8064C548
/* 8064C538 00000008  38 80 00 13 */	li r4, 0x13
/* 8064C53C 0000000C  88 BF 07 0F */	lbz r5, 0x70f(r31)
/* 8064C540 00000010  4B FF 21 85 */	bl setActionMode__10daB_ZANT_cFii
/* 8064C544 00000014  48 00 00 4C */	b lbl_8064C590
lbl_8064C548:
...
lbl_8064C57C:
/* 8064C57C 00000000  38 80 00 04 */	li r4, 4
/* 8064C580 00000004  38 A0 00 00 */	li r5, 0
/* 8064C584 00000008  4B FF 21 41 */	bl setActionMode__10daB_ZANT_cFii
/* 8064C588 0000000C  7F E3 FB 78 */	mr r3, r31
/* 8064C58C 00000010  4B FF 50 B5 */	bl executeOpening__10daB_ZANT_cFv
lbl_8064C590:
/* 8064C590 00000000  39 61 00 40 */	addi r11, r1, 0x40
/* 8064C594 00000004  4B D1 5C 94 */	b _restgpr_29

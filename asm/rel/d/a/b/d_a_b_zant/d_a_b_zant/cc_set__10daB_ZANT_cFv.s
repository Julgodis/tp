...
/* 8064CD1C 00000010  4B FF 13 5D */	bl _savegpr_28
/* 8064CD20 00000014  7C 7C 1B 78 */	mr r28, r3
/* 8064CD24 00000018  3C 60 00 00 */	lis r3, lit_3757@ha /* 8064EB1C */
/* 8064CD28 0000001C  3B C3 00 00 */	addi r30, r3, lit_3757@l /* 8064EB1C */
...
/* 8064CD40 00000034  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8064CD44 00000038  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8064CD48 0000003C  4B FF 13 31 */	bl PSMTXCopy
/* 8064CD4C 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8064CD50 00000044  3B E3 00 00 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8064CD54 00000048  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8064CD58 0000004C  D0 1C 05 38 */	stfs f0, 0x538(r28)
/* 8064CD5C 00000050  C0 1F 00 1C */	lfs f0, 0x1c(r31)
/* 8064CD60 00000054  D0 1C 05 3C */	stfs f0, 0x53c(r28)
/* 8064CD64 00000058  C0 1F 00 2C */	lfs f0, 0x2c(r31)
...
/* 8064CD88 0000007C  C0 3E 00 1C */	lfs f1, 0x1c(r30)
...
/* 8064CDB4 000000A8  4B FF 12 C5 */	bl PSMTXCopy
/* 8064CDB8 000000AC  C0 3E 00 D0 */	lfs f1, 0xd0(r30)
/* 8064CDBC 000000B0  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CDC0 000000B4  FC 60 10 90 */	fmr f3, f2
/* 8064CDC4 000000B8  4B FF 12 B5 */	bl transM__14mDoMtx_stack_cFfff
/* 8064CDC8 000000BC  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8064CDCC 000000C0  D0 01 00 08 */	stfs f0, 8(r1)
/* 8064CDD0 000000C4  C0 1F 00 1C */	lfs f0, 0x1c(r31)
/* 8064CDD4 000000C8  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8064CDD8 000000CC  C0 1F 00 2C */	lfs f0, 0x2c(r31)
...
/* 8064CDE8 000000DC  4B FF 12 91 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8064CDEC 000000E0  38 7C 0B 04 */	addi r3, r28, 0xb04
/* 8064CDF0 000000E4  C0 3E 01 0C */	lfs f1, 0x10c(r30)
/* 8064CDF4 000000E8  4B FF 12 85 */	bl SetR__8cM3dGSphFf
/* 8064CDF8 000000EC  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8064CDFC 000000F0  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8064CE0C 00000100  4B FF 12 6D */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8064CE24 00000118  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8064CE28 0000011C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8064CE2C 00000120  4B FF 12 4D */	bl PSMTXCopy
/* 8064CE30 00000124  C0 3E 01 98 */	lfs f1, 0x198(r30)
/* 8064CE34 00000128  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CE38 0000012C  FC 60 10 90 */	fmr f3, f2
/* 8064CE3C 00000130  4B FF 12 3D */	bl transM__14mDoMtx_stack_cFfff
/* 8064CE40 00000134  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8064CE44 00000138  D0 01 00 08 */	stfs f0, 8(r1)
/* 8064CE48 0000013C  C0 1F 00 1C */	lfs f0, 0x1c(r31)
/* 8064CE4C 00000140  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8064CE50 00000144  C0 1F 00 2C */	lfs f0, 0x2c(r31)
...
/* 8064CE60 00000154  4B FF 12 19 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8064CE64 00000158  38 7C 0C 3C */	addi r3, r28, 0xc3c
/* 8064CE68 0000015C  C0 3E 01 0C */	lfs f1, 0x10c(r30)
/* 8064CE6C 00000160  4B FF 12 0D */	bl SetR__8cM3dGSphFf
/* 8064CE70 00000164  7F A3 EB 78 */	mr r3, r29
/* 8064CE74 00000168  38 9C 0B 18 */	addi r4, r28, 0xb18
/* 8064CE78 0000016C  4B FF 12 01 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8064CE90 00000184  4B FF 11 E9 */	bl SetC__8cM3dGCylFRC4cXyz
/* 8064CE94 00000188  38 7C 36 0C */	addi r3, r28, 0x360c
/* 8064CE98 0000018C  C0 3E 00 34 */	lfs f1, 0x34(r30)
/* 8064CE9C 00000190  4B FF 11 DD */	bl SetR__8cM3dGCylFf
/* 8064CEA0 00000194  38 7C 36 0C */	addi r3, r28, 0x360c
/* 8064CEA4 00000198  C0 3E 01 38 */	lfs f1, 0x138(r30)
/* 8064CEA8 0000019C  4B FF 11 D1 */	bl SetH__8cM3dGCylFf
/* 8064CEAC 000001A0  7F A3 EB 78 */	mr r3, r29
/* 8064CEB0 000001A4  38 9C 34 E8 */	addi r4, r28, 0x34e8
/* 8064CEB4 000001A8  4B FF 11 C5 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8064CECC 000001C0  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8064CED0 000001C4  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8064CED4 000001C8  4B FF 11 A5 */	bl PSMTXCopy
/* 8064CED8 000001CC  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 8064CEDC 000001D0  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CEE0 000001D4  FC 60 10 90 */	fmr f3, f2
/* 8064CEE4 000001D8  4B FF 11 95 */	bl transM__14mDoMtx_stack_cFfff
/* 8064CEE8 000001DC  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8064CEEC 000001E0  D0 01 00 08 */	stfs f0, 8(r1)
/* 8064CEF0 000001E4  C0 1F 00 1C */	lfs f0, 0x1c(r31)
/* 8064CEF4 000001E8  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8064CEF8 000001EC  C0 1F 00 2C */	lfs f0, 0x2c(r31)
...
/* 8064CF08 000001FC  4B FF 11 71 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8064CF0C 00000200  38 7C 37 48 */	addi r3, r28, 0x3748
/* 8064CF10 00000204  C0 3E 01 98 */	lfs f1, 0x198(r30)
/* 8064CF14 00000208  4B FF 11 65 */	bl SetR__8cM3dGSphFf
/* 8064CF18 0000020C  7F A3 EB 78 */	mr r3, r29
/* 8064CF1C 00000210  38 9C 36 24 */	addi r4, r28, 0x3624
/* 8064CF20 00000214  4B FF 11 59 */	bl Set__4cCcSFP8cCcD_Obj
...
/* 8064CF38 0000022C  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8064CF3C 00000230  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8064CF40 00000234  4B FF 11 39 */	bl PSMTXCopy
/* 8064CF44 00000238  C0 3E 00 38 */	lfs f1, 0x38(r30)
/* 8064CF48 0000023C  C0 5E 00 28 */	lfs f2, 0x28(r30)
/* 8064CF4C 00000240  FC 60 10 90 */	fmr f3, f2
/* 8064CF50 00000244  4B FF 11 29 */	bl transM__14mDoMtx_stack_cFfff
/* 8064CF54 00000248  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8064CF58 0000024C  D0 01 00 08 */	stfs f0, 8(r1)
/* 8064CF5C 00000250  C0 1F 00 1C */	lfs f0, 0x1c(r31)
/* 8064CF60 00000254  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8064CF64 00000258  C0 1F 00 2C */	lfs f0, 0x2c(r31)
...
/* 8064CF74 00000268  4B FF 11 05 */	bl SetC__8cM3dGSphFRC4cXyz
/* 8064CF78 0000026C  38 7C 38 80 */	addi r3, r28, 0x3880
/* 8064CF7C 00000270  C0 3E 01 98 */	lfs f1, 0x198(r30)
/* 8064CF80 00000274  4B FF 10 F9 */	bl SetR__8cM3dGSphFf
/* 8064CF84 00000278  7F A3 EB 78 */	mr r3, r29
/* 8064CF88 0000027C  38 9C 37 5C */	addi r4, r28, 0x375c
/* 8064CF8C 00000280  4B FF 10 ED */	bl Set__4cCcSFP8cCcD_Obj
lbl_8064CF90:
/* 8064CF90 00000000  39 61 00 30 */	addi r11, r1, 0x30
/* 8064CF94 00000004  4B FF 10 E5 */	bl _restgpr_28

...
/* 8064B878  4B D1 69 58 */	b _savegpr_26
/* 8064B87C  7C 7B 1B 78 */	mr r27, r3
/* 8064B880  3C 60 80 65 */	lis r3, lit_3757@ha
/* 8064B884  3B C3 EB 1C */	addi r30, r3, lit_3757@l
/* 8064B888  4B B3 5D B8 */	b dCam_getBody__Fv
...
/* 8064B8A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064B8A4  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 8064B8A8  83 BF 5D AC */	lwz r29, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 8064B8AC  80 1B 06 DC */	lwz r0, 0x6dc(r27)
/* 8064B8B0  28 00 00 10 */	cmplwi r0, 0x10
/* 8064B8B4  41 81 08 88 */	bgt lbl_8064C13C
/* 8064B8B8  3C 60 80 65 */	lis r3, lit_9790@ha
/* 8064B8BC  38 63 F3 68 */	addi r3, r3, lit_9790@l
...
/* 8064B8FC  4B 9D 00 0C */	b fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 8064B914  4B B1 5B BC */	b Stop__9dCamera_cFv
/* 8064B918  7F 83 E3 78 */	mr r3, r28
/* 8064B91C  38 80 00 03 */	li r4, 3
/* 8064B920  4B B1 76 EC */	b SetTrimSize__9dCamera_cFl
/* 8064B924  4B B3 5D 1C */	b dCam_getBody__Fv
/* 8064B928  7C 64 1B 78 */	mr r4, r3
/* 8064B92C  38 61 00 6C */	addi r3, r1, 0x6c
/* 8064B930  4B B3 65 68 */	b Center__9dCamera_cFv
...
/* 8064B94C  4B B3 5C F4 */	b dCam_getBody__Fv
/* 8064B950  7C 64 1B 78 */	mr r4, r3
/* 8064B954  38 61 00 60 */	addi r3, r1, 0x60
/* 8064B958  4B B3 65 0C */	b Eye__9dCamera_cFv
...
/* 8064B974  4B B3 5C CC */	b dCam_getBody__Fv
...
lbl_8064B9BC:
/* 8064B9BC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064B9C0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064B9C4  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8064BA08  4B A0 10 88 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8064BA58  3C 60 80 65 */	lis r3, l_HIO@ha
/* 8064BA5C  38 63 F6 04 */	addi r3, r3, l_HIO@l
/* 8064BA60  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 8064F614 */
...
/* 8064BB98  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8064BB9C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8064BBA0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8064BBA4  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8064BBA8  38 80 00 0D */	li r4, 0xd
/* 8064BBAC  4B C6 43 E0 */	b changeBgmStatus__8Z2SeqMgrFl
...
/* 8064BBE8  4B 9C DD D4 */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
/* 8064BBEC  80 61 00 2C */	lwz r3, 0x2c(r1)
/* 8064BBF0  28 03 00 00 */	cmplwi r3, 0
/* 8064BBF4  41 82 00 0C */	beq lbl_8064BC00
/* 8064BBF8  4B 9C E0 84 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 8064BC24  4B 9C EA EC */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8064BC28  B0 7B 04 E6 */	sth r3, 0x4e6(r27)
/* 8064BC2C  7F 63 DB 78 */	mr r3, r27
/* 8064BC30  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8064BC34  4B 9C EB 04 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064BC80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064BC84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064BC88  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8064BCCC  4B A0 0D C4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8064BD10  4B 9C EA 00 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8064BD14  B0 7B 04 E6 */	sth r3, 0x4e6(r27)
/* 8064BD18  7F 63 DB 78 */	mr r3, r27
/* 8064BD1C  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8064BD20  4B 9C EA 18 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064BE5C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8064BE60  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8064BE64  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8064BE68  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8064BE6C  88 9B 06 FB */	lbz r4, 0x6fb(r27)
/* 8064BE70  38 84 00 07 */	addi r4, r4, 7
/* 8064BE74  4B C6 41 18 */	b changeBgmStatus__8Z2SeqMgrFl
lbl_8064BE78:
/* 8064BE78  80 7B 05 B4 */	lwz r3, 0x5b4(r27)
/* 8064BE7C  38 63 00 0C */	addi r3, r3, 0xc
/* 8064BE80  C0 3E 03 3C */	lfs f1, 0x33c(r30)
/* 8064BE84  4B CD C5 A8 */	b checkPass__12J3DFrameCtrlFf
...
/* 8064BEA0  4B 9C E8 70 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8064BEA4  B0 7B 04 E6 */	sth r3, 0x4e6(r27)
/* 8064BEA8  7F 63 DB 78 */	mr r3, r27
/* 8064BEAC  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8064BEB0  4B 9C E8 88 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8064BF20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064BF24  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064BF28  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8064BF2C  38 80 00 1F */	li r4, 0x1f
/* 8064BF30  4B A2 3E 64 */	b StopQuake__12dVibration_cFi
...
/* 8064BF74  3C 60 80 65 */	lis r3, l_HIO@ha
/* 8064BF78  38 63 F6 04 */	addi r3, r3, l_HIO@l
/* 8064BF7C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 8064F610 */
...
/* 8064BFA8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064BFAC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8064BFC0  3C C0 80 65 */	lis r6, data_8064F030@ha
/* 8064BFC4  38 C6 F0 30 */	addi r6, r6, data_8064F030@l
/* 8064BFC8  7C C6 00 AE */	lbzx r6, r6, r0
/* 8064BFCC  4B 9E 8F B4 */	b setRoom__13dSv_restart_cFRC4cXyzsSc
...
/* 8064BFE0  3C 60 80 3F */	lis r3, mStatus__20dStage_roomControl_c@ha
/* 8064BFE4  38 83 60 94 */	addi r4, r3, mStatus__20dStage_roomControl_c@l
/* 8064BFE8  88 1B 06 FB */	lbz r0, 0x6fb(r27)
/* 8064BFEC  3C 60 80 65 */	lis r3, data_8064F030@ha
/* 8064BFF0  38 63 F0 30 */	addi r3, r3, data_8064F030@l
...
/* 8064C054  4B C2 46 EC */	b cLib_chaseF__FPfff
...
/* 8064C0F0  4B B3 4B 28 */	b Reset__9dCamera_cF4cXyz4cXyz
/* 8064C0F4  7F 83 E3 78 */	mr r3, r28
/* 8064C0F8  4B B1 53 B4 */	b Start__9dCamera_cFv
/* 8064C0FC  7F 83 E3 78 */	mr r3, r28
/* 8064C100  38 80 00 00 */	li r4, 0
/* 8064C104  4B B1 6F 08 */	b SetTrimSize__9dCamera_cFl
/* 8064C108  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8064C10C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8064C110  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8064C114  4B 9F 63 54 */	b reset__14dEvt_control_cFv
lbl_8064C118:
...
/* 8064C1A4  4B B3 49 3C */	b Set__9dCamera_cF4cXyz4cXyzfs
lbl_8064C1A8:
/* 8064C1A8  39 61 00 C0 */	addi r11, r1, 0xc0
/* 8064C1AC  4B D1 60 70 */	b _restgpr_26

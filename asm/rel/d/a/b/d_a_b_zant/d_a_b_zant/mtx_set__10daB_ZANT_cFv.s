...
/* 8064CB38  4B 9C 02 2C */	b transS__14mDoMtx_stack_cFRC4cXyz
...
/* 8064CB64  4B 9C 02 D4 */	b scaleM__14mDoMtx_stack_cFfff
/* 8064CB68  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8064CB6C  83 C3 00 04 */	lwz r30, 4(r3)
/* 8064CB70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8064CB74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8064CB78  38 9E 00 24 */	addi r4, r30, 0x24
/* 8064CB7C  4B CF 99 34 */	b PSMTXCopy
/* 8064CB80  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 8064CB84  4B 9C 46 68 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 8064CBA0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8064CBA4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8064CBA8  4B CF 99 08 */	b PSMTXCopy
/* 8064CBAC  C0 3F 06 D0 */	lfs f1, 0x6d0(r31)
/* 8064CBB0  FC 40 08 90 */	fmr f2, f1
/* 8064CBB4  FC 60 08 90 */	fmr f3, f1
/* 8064CBB8  4B 9C 02 80 */	b scaleM__14mDoMtx_stack_cFfff
/* 8064CBBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8064CBC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8064CBC4  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 8064CBC8  38 84 00 24 */	addi r4, r4, 0x24
/* 8064CBCC  4B CF 98 E4 */	b PSMTXCopy
/* 8064CBD0  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 8064CBD4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8064CBD8  38 63 04 B0 */	addi r3, r3, 0x4b0
/* 8064CBDC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8064CBE0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8064CBE4  4B CF 98 CC */	b PSMTXCopy
/* 8064CBE8  C0 3F 06 D0 */	lfs f1, 0x6d0(r31)
/* 8064CBEC  FC 40 08 90 */	fmr f2, f1
/* 8064CBF0  FC 60 08 90 */	fmr f3, f1
/* 8064CBF4  4B 9C 02 44 */	b scaleM__14mDoMtx_stack_cFfff
/* 8064CBF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8064CBFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8064CC00  80 9F 05 BC */	lwz r4, 0x5bc(r31)
/* 8064CC04  38 84 00 24 */	addi r4, r4, 0x24
/* 8064CC08  4B CF 98 A8 */	b PSMTXCopy
lbl_8064CC0C:
...
/* 8064CC48  4B C2 41 78 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 8064CC4C  38 61 00 08 */	addi r3, r1, 8
/* 8064CC50  4B 9C 01 14 */	b transS__14mDoMtx_stack_cFRC4cXyz
...
/* 8064CC74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8064CC78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8064CC7C  80 9F 05 C0 */	lwz r4, 0x5c0(r31)
/* 8064CC80  38 84 00 24 */	addi r4, r4, 0x24
/* 8064CC84  4B CF 98 2C */	b PSMTXCopy
/* 8064CC88  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 8064CC8C  4B 9C 07 9C */	b play__14mDoExt_baseAnmFv
/* 8064CC90  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 8064CC94  4B 9C 07 94 */	b play__14mDoExt_baseAnmFv
/* 8064CC98  80 7F 05 D0 */	lwz r3, 0x5d0(r31)
/* 8064CC9C  4B 9C 07 8C */	b play__14mDoExt_baseAnmFv
...
/* 8064CCB4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8064CCB8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8064CCBC  4B CF 97 F4 */	b PSMTXCopy
/* 8064CCC0  C0 3F 05 EC */	lfs f1, 0x5ec(r31)
/* 8064CCC4  FC 40 08 90 */	fmr f2, f1
/* 8064CCC8  FC 60 08 90 */	fmr f3, f1
/* 8064CCCC  4B 9C 01 6C */	b scaleM__14mDoMtx_stack_cFfff
/* 8064CCD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8064CCD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8064CCD8  80 9F 05 C4 */	lwz r4, 0x5c4(r31)
/* 8064CCDC  38 84 00 24 */	addi r4, r4, 0x24
/* 8064CCE0  4B CF 97 D0 */	b PSMTXCopy
/* 8064CCE4  80 7F 05 D4 */	lwz r3, 0x5d4(r31)
/* 8064CCE8  4B 9C 07 40 */	b play__14mDoExt_baseAnmFv
/* 8064CCEC  80 7F 05 D8 */	lwz r3, 0x5d8(r31)
/* 8064CCF0  4B 9C 07 38 */	b play__14mDoExt_baseAnmFv
lbl_8064CCF4:

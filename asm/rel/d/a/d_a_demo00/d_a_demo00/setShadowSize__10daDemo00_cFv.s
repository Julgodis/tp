...
/* 804A4958 00000010  4B FF F9 21 */	bl _savegpr_26
/* 804A495C 00000014  7C 7C 1B 78 */	mr r28, r3
/* 804A4960 00000018  3C 60 00 00 */	lis r3, lit_3727@ha /* 804A8860 */
/* 804A4964 0000001C  3B E3 00 00 */	addi r31, r3, lit_3727@l /* 804A8860 */
/* 804A4968 00000020  80 7C 05 D4 */	lwz r3, 0x5d4(r28)
/* 804A496C 00000024  83 C3 00 04 */	lwz r30, 4(r3)
/* 804A4970 00000028  C0 1F 00 38 */	lfs f0, 0x38(r31)
...
/* 804A4980 00000038  C0 1F 00 3C */	lfs f0, 0x3c(r31)
...
/* 804A49D0 00000038  4B FF F8 A9 */	bl PSMTXMultVec
...
/* 804A49EC 00000054  4B FF F8 8D */	bl PSMTXMultVec
...
/* 804A4AAC 00000010  C0 5F 00 40 */	lfs f2, 0x40(r31)
...
/* 804A4B04 00000068  4B FF F7 75 */	bl __mi__4cXyzCFRC3Vec
...
/* 804A4B24 00000088  4B FF F7 55 */	bl PSVECSquareMag
/* 804A4B28 0000008C  C0 1F 00 0C */	lfs f0, 0xc(r31)
...
/* 804A4B38 00000008  C8 9F 00 18 */	lfd f4, 0x18(r31)
/* 804A4B3C 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 804A4B40 00000010  C8 7F 00 20 */	lfd f3, 0x20(r31)
...
lbl_804A4B88:
/* 804A4B88 00000000  C8 1F 00 28 */	lfd f0, 0x28(r31)
/* 804A4B8C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804A4B90 00000000  40 80 00 10 */	bge lbl_804A4BA0
/* 804A4B94 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 804A4B98 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 804A4C04 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 804A4C08 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_804A4C0C:
/* 804A4C0C 00000000  C0 1F 00 44 */	lfs f0, 0x44(r31)
...
/* 804A4C24 00000018  C0 1F 00 0C */	lfs f0, 0xc(r31)
...
/* 804A4C38 0000002C  4B FF F6 41 */	bl PSVECSquareMag
/* 804A4C3C 00000030  C0 1F 00 0C */	lfs f0, 0xc(r31)
...
/* 804A4C4C 00000008  C8 9F 00 18 */	lfd f4, 0x18(r31)
/* 804A4C50 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 804A4C54 00000010  C8 7F 00 20 */	lfd f3, 0x20(r31)
...
lbl_804A4C9C:
/* 804A4C9C 00000000  C8 1F 00 28 */	lfd f0, 0x28(r31)
/* 804A4CA0 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804A4CA4 00000000  40 80 00 10 */	bge lbl_804A4CB4
/* 804A4CA8 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 804A4CAC 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 804A4D18 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 804A4D1C 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_804A4D20:
/* 804A4D20 00000000  C0 1F 00 48 */	lfs f0, 0x48(r31)
...
/* 804A4D34 00000014  4B FF F5 45 */	bl _restgpr_26

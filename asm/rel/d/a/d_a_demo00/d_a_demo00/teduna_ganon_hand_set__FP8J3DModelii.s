...
/* 804A6894 0000002C  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 804A6898 00000030  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 804A689C 00000034  4B FF D9 DD */	bl PSMTXCopy
/* 804A68A0 00000038  3C 60 00 00 */	lis r3, lit_4004@ha
/* 804A68A4 0000003C  C0 03 00 00 */	lfs f0, lit_4004@l(r3)
...
/* 804A68B4 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804A68B8 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804A68BC 00000054  38 81 00 08 */	addi r4, r1, 8
/* 804A68C0 00000058  3C A0 00 00 */	lis r5, S_ganon_left_hand_pos@ha
/* 804A68C4 0000005C  38 A5 00 00 */	addi r5, r5, S_ganon_left_hand_pos@l
...
/* 804A68DC 00000074  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 804A68E0 00000078  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 804A68E4 0000007C  4B FF D9 95 */	bl PSMTXCopy
/* 804A68E8 00000080  3C 60 00 00 */	lis r3, lit_4004@ha
/* 804A68EC 00000084  C0 03 00 00 */	lfs f0, lit_4004@l(r3)
...
/* 804A68FC 00000094  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 804A6900 00000098  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804A6904 0000009C  38 81 00 08 */	addi r4, r1, 8
/* 804A6908 000000A0  3C A0 00 00 */	lis r5, S_ganon_right_hand_pos@ha
/* 804A690C 000000A4  38 A5 00 00 */	addi r5, r5, S_ganon_right_hand_pos@l

...
/* 804A6D58 00000004  4B EB B4 70 */	b _savegpr_24
/* 804A6D5C 00000008  7C 7C 1B 79 */	or. r28, r3, r3
/* 804A6D60 0000000C  3C 60 80 4B */	lis r3, lit_3727@ha
/* 804A6D64 00000010  3B C3 88 60 */	addi r30, r3, lit_3727@l
...
/* 804A6D88 00000008  4B DC 0C 4C */	b cM_initRnd2__Fiii
...
/* 804A6D9C 0000001C  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804A6DA0 00000020  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804A6DA4 00000024  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804A6DA8 00000028  4B E9 F7 08 */	b PSMTXCopy
/* 804A6DAC 0000002C  3B A0 00 00 */	li r29, 0
/* 804A6DB0 00000030  3B 60 00 00 */	li r27, 0
/* 804A6DB4 00000034  3B 40 00 00 */	li r26, 0
/* 804A6DB8 00000038  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804A6DBC 0000003C  3B E3 07 68 */	addi r31, r3, calc_mtx@l
/* 804A6DC0 00000040  C3 DE 00 88 */	lfs f30, 0x88(r30)	/* effective address: 804A88E8 */
/* 804A6DC4 00000044  C3 FE 01 04 */	lfs f31, 0x104(r30)	/* effective address: 804A8964 */
lbl_804A6DC8:
/* 804A6DC8 00000000  4B DC A1 54 */	b MtxPush__Fv
/* 804A6DCC 00000004  80 7F 00 00 */	lwz r3, 0(r31)	/* effective address: 80450768 */
/* 804A6DD0 00000008  38 80 40 00 */	li r4, 0x4000
/* 804A6DD4 0000000C  4B B6 56 60 */	b mDoMtx_YrotM__FPA4_fs
/* 804A6DD8 00000010  C0 3E 00 EC */	lfs f1, 0xec(r30)	/* effective address: 804A894C */
/* 804A6DDC 00000014  4B DC 0C F0 */	b cM_rndF2__Ff
...
/* 804A6DF4 0000002C  80 7F 00 00 */	lwz r3, 0(r31)	/* effective address: 80450768 */
/* 804A6DF8 00000030  4B B6 55 A4 */	b mDoMtx_XrotM__FPA4_fs
/* 804A6DFC 00000034  2C 1D 00 0A */	cmpwi r29, 0xa
/* 804A6E00 00000038  40 80 00 5C */	bge lbl_804A6E5C
/* 804A6E04 0000003C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804A6E08 00000040  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804A6E0C 00000044  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804A6E10 00000048  3C 80 80 4B */	lis r4, data_804A8A3C@ha
/* 804A6E14 0000004C  38 84 8A 3C */	addi r4, r4, data_804A8A3C@l
...
/* 804A6E24 0000005C  4B B6 56 A8 */	b mDoMtx_ZrotM__FPA4_fs
/* 804A6E28 00000060  C0 3E 00 F4 */	lfs f1, 0xf4(r30)	/* effective address: 804A8954 */
/* 804A6E2C 00000064  4B DC 0C A0 */	b cM_rndF2__Ff
/* 804A6E30 00000068  C0 1E 00 F0 */	lfs f0, 0xf0(r30)	/* effective address: 804A8950 */
/* 804A6E34 0000006C  EF A0 08 2A */	fadds f29, f0, f1
/* 804A6E38 00000070  C0 3E 00 F8 */	lfs f1, 0xf8(r30)	/* effective address: 804A8958 */
/* 804A6E3C 00000074  4B DC 0C 90 */	b cM_rndF2__Ff
/* 804A6E40 00000078  C0 1E 00 50 */	lfs f0, 0x50(r30)	/* effective address: 804A88B0 */
/* 804A6E44 0000007C  EF 81 00 28 */	fsubs f28, f1, f0
/* 804A6E48 00000080  C0 3E 00 68 */	lfs f1, 0x68(r30)	/* effective address: 804A88C8 */
/* 804A6E4C 00000084  4B DC 0C 80 */	b cM_rndF2__Ff
/* 804A6E50 00000088  C0 1E 00 F8 */	lfs f0, 0xf8(r30)	/* effective address: 804A8958 */
/* 804A6E54 0000008C  EF 61 00 28 */	fsubs f27, f1, f0
/* 804A6E58 00000090  48 00 00 60 */	b lbl_804A6EB8
lbl_804A6E5C:
/* 804A6E5C 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804A6E60 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804A6E64 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804A6E68 0000000C  3C 80 80 4B */	lis r4, data_804A8A3C@ha
/* 804A6E6C 00000010  38 84 8A 3C */	addi r4, r4, data_804A8A3C@l
...
/* 804A6E84 00000028  4B B6 56 48 */	b mDoMtx_ZrotM__FPA4_fs
/* 804A6E88 0000002C  C0 3E 00 44 */	lfs f1, 0x44(r30)	/* effective address: 804A88A4 */
/* 804A6E8C 00000030  4B DC 0C 40 */	b cM_rndF2__Ff
/* 804A6E90 00000034  C0 1E 00 FC */	lfs f0, 0xfc(r30)	/* effective address: 804A895C */
/* 804A6E94 00000038  EF A0 08 2A */	fadds f29, f0, f1
/* 804A6E98 0000003C  C0 3E 00 68 */	lfs f1, 0x68(r30)	/* effective address: 804A88C8 */
/* 804A6E9C 00000040  4B DC 0C 30 */	b cM_rndF2__Ff
/* 804A6EA0 00000044  C0 1E 00 F8 */	lfs f0, 0xf8(r30)	/* effective address: 804A8958 */
/* 804A6EA4 00000048  EF 81 00 28 */	fsubs f28, f1, f0
/* 804A6EA8 0000004C  C0 3E 01 00 */	lfs f1, 0x100(r30)	/* effective address: 804A8960 */
/* 804A6EAC 00000050  4B DC 0C 20 */	b cM_rndF2__Ff
/* 804A6EB0 00000054  C0 1E 00 88 */	lfs f0, 0x88(r30)	/* effective address: 804A88E8 */
...
/* 804A6ED4 0000001C  4B DC A0 18 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 804A6F1C 00000064  4B DC A0 3C */	b MtxPull__Fv
...
/* 804A6F60 00000008  4B EB B2 B4 */	b _restgpr_24

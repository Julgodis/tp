...
/* 80D67794  C0 3E 00 24 */	lfs f1, 0x24(r30)	/* effective address: 80D67BF8 */
/* 80D67798  FC 40 08 90 */	fmr f2, f1
/* 80D6779C  C0 7E 00 38 */	lfs f3, 0x38(r30)	/* effective address: 80D67C0C */
...
/* 80D677F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D677F4  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80D677F8  80 04 5F 98 */	lwz r0, 0x5f98(r4)	/* effective address: 8040C158 */
/* 80D677FC  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80D67800  3B C3 4A C8 */	addi r30, r3, j3dSys@l
/* 80D67804  90 1E 00 48 */	stw r0, 0x48(r30)	/* effective address: 80434B10 */
/* 80D67808  80 04 5F 9C */	lwz r0, 0x5f9c(r4)	/* effective address: 8040C15C */
/* 80D6780C  90 1E 00 4C */	stw r0, 0x4c(r30)	/* effective address: 80434B14 */
/* 80D67810  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80D67814  4B 2A 64 B0 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80D67818  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D6781C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D67820  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80D67824  90 1E 00 48 */	stw r0, 0x48(r30)
/* 80D67828  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

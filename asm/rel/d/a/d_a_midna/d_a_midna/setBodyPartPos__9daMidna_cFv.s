...
/* 804BEDD0 00000018  3C 60 80 4C */	lis r3, lit_3777@ha
/* 804BEDD4 0000001C  3B E3 64 C8 */	addi r31, r3, lit_3777@l
/* 804BEDD8 00000020  38 7F 01 1C */	addi r3, r31, 0x11c
/* 804BEDDC 00000024  A0 63 00 D8 */	lhz r3, 0xd8(r3)	/* effective address: 804C66BC */
...
/* 804BEDF4 0000003C  C0 1F 04 1C */	lfs f0, 0x41c(r31)	/* effective address: 804C68E4 */
...
/* 804BEE18 00000018  4B E8 7F 54 */	b PSMTXMultVec
lbl_804BEE1C:
...
/* 804BEE2C 00000010  A0 63 00 C0 */	lhz r3, 0xc0(r3)	/* effective address: 804C66A4 */
...
/* 804BEE44 00000028  C0 1F 04 20 */	lfs f0, 0x420(r31)	/* effective address: 804C68E8 */
/* 804BEE48 0000002C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804BEE4C 00000000  40 80 00 90 */	bge lbl_804BEEDC
lbl_804BEE50:
/* 804BEE50 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804BEE54 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 804BEE58 00000008  80 A3 5D B4 */	lwz r5, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804BEE68 00000018  C0 9F 04 24 */	lfs f4, 0x424(r31)	/* effective address: 804C68EC */
/* 804BEE6C 0000001C  48 00 00 08 */	b lbl_804BEE74
lbl_804BEE70:
/* 804BEE70 00000000  C0 9F 04 28 */	lfs f4, 0x428(r31)	/* effective address: 804C68F0 */
lbl_804BEE74:
/* 804BEE74 00000000  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804BEE78 00000004  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 804BEE9C 00000028  C0 1F 04 2C */	lfs f0, 0x42c(r31)	/* effective address: 804C68F4 */
...
/* 804BEF04 00000004  C0 3F 04 30 */	lfs f1, 0x430(r31)	/* effective address: 804C68F8 */
...
/* 804BEF38 00000018  4B E8 7E 34 */	b PSMTXMultVec
...
/* 804BEF60 00000040  4B E8 7E 0C */	b PSMTXMultVec
/* 804BEF64 00000044  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804BEF68 00000048  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 804BEF6C 0000004C  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 804BEF70 00000050  C0 01 00 08 */	lfs f0, 8(r1)
/* 804BEF74 00000054  D0 03 05 B0 */	stfs f0, 0x5b0(r3)	/* effective address: 80406770 */
/* 804BEF78 00000058  C0 01 00 0C */	lfs f0, 0xc(r1)
/* 804BEF7C 0000005C  D0 03 05 B4 */	stfs f0, 0x5b4(r3)	/* effective address: 80406774 */
/* 804BEF80 00000060  C0 01 00 10 */	lfs f0, 0x10(r1)
/* 804BEF84 00000064  D0 03 05 B8 */	stfs f0, 0x5b8(r3)	/* effective address: 80406778 */
lbl_804BEF88:

...
/* 804BE480  4B EA 3D 54 */	b _savegpr_27
/* 804BE484  7C 7F 1B 78 */	mr r31, r3
/* 804BE488  3C 60 80 4C */	lis r3, lit_3777@ha
/* 804BE48C  3B C3 64 C8 */	addi r30, r3, lit_3777@l
...
/* 804BE4A8  4B E8 80 08 */	b PSMTXCopy
...
/* 804BE4E0  4B E8 7F D0 */	b PSMTXCopy
...
/* 804BE504  4B E8 7F AC */	b PSMTXCopy
lbl_804BE508:
...
/* 804BE518  4B E8 7F 98 */	b PSMTXCopy
...
/* 804BE550  4B E8 7F 60 */	b PSMTXCopy
...
/* 804BE574  4B E8 7F 3C */	b PSMTXCopy
...
/* 804BE598  4B E8 7F 18 */	b PSMTXCopy
...
/* 804BE5C8  4B E8 7E E8 */	b PSMTXCopy
...
/* 804BE5F0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 804BE5F4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 804BE5F8  4B E8 7E B8 */	b PSMTXCopy
/* 804BE5FC  C0 3E 04 08 */	lfs f1, 0x408(r30)
/* 804BE600  C0 5E 00 B8 */	lfs f2, 0xb8(r30)
/* 804BE604  FC 60 10 90 */	fmr f3, f2
/* 804BE608  4B B4 E7 94 */	b transM__14mDoMtx_stack_cFfff
/* 804BE60C  80 1F 08 94 */	lwz r0, 0x894(r31)
/* 804BE610  54 00 06 F7 */	rlwinm. r0, r0, 0, 0x1b, 0x1b
/* 804BE614  41 82 00 48 */	beq lbl_804BE65C
/* 804BE618  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BE61C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804BE620  80 9F 06 D8 */	lwz r4, 0x6d8(r31)
/* 804BE624  38 84 00 24 */	addi r4, r4, 0x24
/* 804BE628  4B E8 7E 88 */	b PSMTXCopy
...
/* 804BE644  4B B4 F3 88 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_804BE648:
...
/* 804BE6B4  4B E8 8A 00 */	b PSVECSubtract
/* 804BE6B8  38 61 00 20 */	addi r3, r1, 0x20
/* 804BE6BC  4B DA 8A 94 */	b atan2sY_XZ__4cXyzCFv
/* 804BE6C0  A8 1F 08 64 */	lha r0, 0x864(r31)
/* 804BE6C4  7C 03 00 50 */	subf r0, r3, r0
/* 804BE6C8  7C 06 07 34 */	extsh r6, r0
/* 804BE6CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BE6D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804BE734  4B DA 84 00 */	b __mi__4cXyzCFRC3Vec
...
/* 804BE754  4B DA 89 D4 */	b atan2sX_Z__4cXyzCFv
/* 804BE758  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 804BE75C  7C 00 18 50 */	subf r0, r0, r3
/* 804BE760  7C 04 07 34 */	extsh r4, r0
/* 804BE764  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BE768  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804BE76C  4B B4 DC 30 */	b mDoMtx_XrotM__FPA4_fs
...
lbl_804BE794:
/* 804BE794  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BE798  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804BE79C  80 9F 06 84 */	lwz r4, 0x684(r31)
/* 804BE7A0  38 84 00 24 */	addi r4, r4, 0x24
/* 804BE7A4  4B E8 7D 0C */	b PSMTXCopy
...
/* 804BE8D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BE8DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804BE8E0  38 84 00 24 */	addi r4, r4, 0x24
/* 804BE8E4  4B E8 7B CC */	b PSMTXCopy
...
/* 804BE980  4B CE DB FC */	b dKy_darkworld_check__Fv
...
/* 804BE9C0  4B CE DB BC */	b dKy_darkworld_check__Fv
...
/* 804BEA88  4B E8 7A 28 */	b PSMTXCopy
...
/* 804BEAB4  4B E8 79 FC */	b PSMTXCopy
...
/* 804BEACC  4B E6 91 8C */	b calcWeightEnvelopeMtx__8J3DModelFv
lbl_804BEAD0:
/* 804BEAD0  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 804BEAD4  80 63 00 84 */	lwz r3, 0x84(r3)
/* 804BEAD8  80 83 00 0C */	lwz r4, 0xc(r3)
/* 804BEADC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BEAE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 804BEAF8  4B E8 7D F0 */	b PSMTXTrans
/* 804BEAFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 804BEB00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 804BEB04  80 9F 06 98 */	lwz r4, 0x698(r31)
/* 804BEB08  38 84 00 24 */	addi r4, r4, 0x24
/* 804BEB0C  4B E8 79 A4 */	b PSMTXCopy
...
/* 804BEB48  4B E8 79 68 */	b PSMTXCopy
...
/* 804BEB64  4B B4 EE 68 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_804BEB68:
...
/* 804BEBF4  4B E8 78 BC */	b PSMTXCopy
...
/* 804BEC10  4B B4 ED BC */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_804BEC14:
...
/* 804BECA0  4B E8 78 10 */	b PSMTXCopy
...
/* 804BECD0  4B E8 77 E0 */	b PSMTXCopy
...
/* 804BECEC  4B B4 EC E0 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_804BECF0:
...
/* 804BED08  4B EA 35 18 */	b _restgpr_27

...
/* 804C4768  4B E9 DA 70 */	b _savegpr_28
/* 804C476C  7C 7D 1B 78 */	mr r29, r3
/* 804C4770  7C 9E 23 78 */	mr r30, r4
/* 804C4774  3C 60 80 4C */	lis r3, lit_3777@ha
/* 804C4778  3B 83 64 C8 */	addi r28, r3, lit_3777@l
/* 804C477C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C4780  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C4784  83 E3 5D B4 */	lwz r31, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 804C47A0  C0 1C 03 E4 */	lfs f0, 0x3e4(r28)	/* effective address: 804C68AC */
...
/* 804C4810  4B E8 2B 8C */	b PSVECSquareDistance
...
/* 804C4880  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804C4884  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 804C48F0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804C48F4  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
/* 804C48F8  48 00 00 08 */	b lbl_804C4900
lbl_804C48FC:
/* 804C48FC  FF E0 08 90 */	fmr f31, f1
lbl_804C4900:
/* 804C4900  7F E3 FB 78 */	mr r3, r31
/* 804C4904  4B BF 00 04 */	b getMetamorphoseNearDis__9daAlink_cCFv
...
/* 804C4924  4B BE FF F4 */	b getMetamorphoseFarDis__9daAlink_cCFv
...
/* 804C4938  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 804C493C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 804C4940  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 804C4944  4B B5 5E 58 */	b fopAcM_seenActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 804C4948  7C 7C 1B 78 */	mr r28, r3
/* 804C494C  7F E3 FB 78 */	mr r3, r31
/* 804C4950  4B BE FF D8 */	b getMetamorphoseFarAngle__9daAlink_cCFv
...
/* 804C4980  4B B5 92 E8 */	b lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 804C49A4  4B E9 D8 80 */	b _restgpr_28

...
/* 804C5A18  4B E9 C7 B4 */	b _savegpr_25
/* 804C5A1C  7C 7F 1B 78 */	mr r31, r3
/* 804C5A20  3C 80 80 4C */	lis r4, lit_3777@ha
/* 804C5A24  3B C4 64 C8 */	addi r30, r4, lit_3777@l
/* 804C5A28  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 804C5A2C  3B 84 61 C0 */	addi r28, r4, struct_804061C0+0x0@l
/* 804C5A30  83 7C 5D B4 */	lwz r27, 0x5db4(r28)	/* effective address: 8040BF74 */
...
/* 804C5A80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C5A84  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 804C5A88  80 04 5F 88 */	lwz r0, 0x5f88(r4)	/* effective address: 8040C148 */
/* 804C5A8C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 804C5A90  3B A3 4A C8 */	addi r29, r3, j3dSys@l
/* 804C5A94  90 1D 00 48 */	stw r0, 0x48(r29)	/* effective address: 80434B10 */
/* 804C5A98  80 04 5F 8C */	lwz r0, 0x5f8c(r4)	/* effective address: 8040C14C */
/* 804C5A9C  90 1D 00 4C */	stw r0, 0x4c(r29)	/* effective address: 80434B14 */
...
/* 804C5AC4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5AC8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5ACC  38 80 00 03 */	li r4, 3
/* 804C5AD0  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 804C5AD4  38 DF 01 0C */	addi r6, r31, 0x10c
/* 804C5AD8  4B CD DC EC */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 804C5B90  4B CE 69 EC */	b dKy_darkworld_check__Fv
...
lbl_804C5C40:
/* 804C5C40  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5C44  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5C48  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 804C5C4C  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5C50  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5C54  4B CD F1 4C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804C5C7C  4B E6 55 7C */	b getTevColorReg__15J3DAnmTevRegKeyCFUsP11_GXColorS10
/* 804C5C80  80 7F 06 68 */	lwz r3, 0x668(r31)
/* 804C5C84  38 80 00 00 */	li r4, 0
/* 804C5C88  38 BF 06 E8 */	addi r5, r31, 0x6e8
/* 804C5C8C  4B E6 58 30 */	b getTevKonstReg__15J3DAnmTevRegKeyCFUsP8_GXColor
lbl_804C5C90:
...
/* 804C5CCC  4B B4 80 98 */	b mDoExt_modelEntryDL__FP8J3DModel
/* 804C5CD0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5CD4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5CD8  80 9F 06 78 */	lwz r4, 0x678(r31)
/* 804C5CDC  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5CE0  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5CE4  4B CD F0 BC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5CE8  80 7F 06 78 */	lwz r3, 0x678(r31)
/* 804C5CEC  4B B4 80 78 */	b mDoExt_modelEntryDL__FP8J3DModel
...
/* 804C5D88  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5D8C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5D90  80 9F 06 80 */	lwz r4, 0x680(r31)
/* 804C5D94  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5D98  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5D9C  4B CD F0 04 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5DA0  80 7F 06 80 */	lwz r3, 0x680(r31)
/* 804C5DA4  4B B4 7F C0 */	b mDoExt_modelEntryDL__FP8J3DModel
lbl_804C5DA8:
/* 804C5DA8  80 1F 08 94 */	lwz r0, 0x894(r31)
/* 804C5DAC  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18
/* 804C5DB0  40 82 00 24 */	bne lbl_804C5DD4
/* 804C5DB4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5DB8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5DBC  80 9F 06 70 */	lwz r4, 0x670(r31)
/* 804C5DC0  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5DC4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5DC8  4B CD EF D8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5DCC  80 7F 06 70 */	lwz r3, 0x670(r31)
/* 804C5DD0  4B B4 7F 94 */	b mDoExt_modelEntryDL__FP8J3DModel
lbl_804C5DD4:
...
lbl_804C5DE8:
/* 804C5DE8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5DEC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5DF0  38 80 00 01 */	li r4, 1
/* 804C5DF4  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 804C5DF8  38 DF 01 0C */	addi r6, r31, 0x10c
/* 804C5DFC  4B CD D9 C8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 804C5E14  4B E6 53 E4 */	b getTevColorReg__15J3DAnmTevRegKeyCFUsP11_GXColorS10
lbl_804C5E18:
/* 804C5E18  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5E1C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5E20  80 9F 06 98 */	lwz r4, 0x698(r31)
/* 804C5E24  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5E28  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5E2C  4B CD EF 74 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5E30  80 7F 06 98 */	lwz r3, 0x698(r31)
/* 804C5E34  4B B4 7F 30 */	b mDoExt_modelEntryDL__FP8J3DModel
...
/* 804C5E5C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C5E60  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 804C5E64  80 7B 61 B0 */	lwz r3, 0x61b0(r27)	/* effective address: 8040C370 */
/* 804C5E68  38 63 01 40 */	addi r3, r3, 0x140
/* 804C5E6C  38 81 00 24 */	addi r4, r1, 0x24
/* 804C5E70  7C 85 23 78 */	mr r5, r4
/* 804C5E74  4B E8 0E F8 */	b PSMTXMultVec
...
/* 804C5E98  4B E8 0E D4 */	b PSMTXMultVec
/* 804C5E9C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5EA0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5EA4  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 804C5EA8  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5EAC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5EB0  4B CD EE F0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5EB4  38 7F 05 C4 */	addi r3, r31, 0x5c4
/* 804C5EB8  38 81 00 24 */	addi r4, r1, 0x24
/* 804C5EBC  4B B4 89 04 */	b entryDL__21mDoExt_invisibleModelFP4cXyz
/* 804C5EC0  80 1F 08 94 */	lwz r0, 0x894(r31)
/* 804C5EC4  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18
/* 804C5EC8  40 82 00 28 */	bne lbl_804C5EF0
/* 804C5ECC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5ED0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5ED4  80 9F 06 74 */	lwz r4, 0x674(r31)
/* 804C5ED8  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5EDC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5EE0  4B CD EE C0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5EE4  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 804C5EE8  38 81 00 24 */	addi r4, r1, 0x24
/* 804C5EEC  4B B4 88 D4 */	b entryDL__21mDoExt_invisibleModelFP4cXyz
lbl_804C5EF0:
/* 804C5EF0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5EF4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5EF8  80 9F 06 7C */	lwz r4, 0x67c(r31)
/* 804C5EFC  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5F00  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5F04  4B CD EE 9C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5F08  38 7F 05 D4 */	addi r3, r31, 0x5d4
/* 804C5F0C  38 81 00 24 */	addi r4, r1, 0x24
/* 804C5F10  4B B4 88 B0 */	b entryDL__21mDoExt_invisibleModelFP4cXyz
/* 804C5F14  80 1F 08 94 */	lwz r0, 0x894(r31)
/* 804C5F18  54 00 06 73 */	rlwinm. r0, r0, 0, 0x19, 0x19
/* 804C5F1C  40 82 00 28 */	bne lbl_804C5F44
/* 804C5F20  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5F24  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5F28  80 9F 06 84 */	lwz r4, 0x684(r31)
/* 804C5F2C  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5F30  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5F34  4B CD EE 6C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5F38  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 804C5F3C  38 81 00 24 */	addi r4, r1, 0x24
/* 804C5F40  4B B4 88 80 */	b entryDL__21mDoExt_invisibleModelFP4cXyz
lbl_804C5F44:
/* 804C5F44  A0 1F 08 78 */	lhz r0, 0x878(r31)
/* 804C5F48  28 00 00 FD */	cmplwi r0, 0xfd
/* 804C5F4C  40 82 00 24 */	bne lbl_804C5F70
/* 804C5F50  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5F54  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5F58  80 9F 06 C8 */	lwz r4, 0x6c8(r31)
/* 804C5F5C  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5F60  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5F64  4B CD EE 3C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5F68  80 7F 06 C8 */	lwz r3, 0x6c8(r31)
/* 804C5F6C  4B B4 7D F8 */	b mDoExt_modelEntryDL__FP8J3DModel
lbl_804C5F70:
/* 804C5F70  A0 1F 08 7A */	lhz r0, 0x87a(r31)
/* 804C5F74  28 00 00 FD */	cmplwi r0, 0xfd
/* 804C5F78  40 82 00 24 */	bne lbl_804C5F9C
/* 804C5F7C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5F80  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5F84  80 9F 06 D0 */	lwz r4, 0x6d0(r31)
/* 804C5F88  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5F8C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5F90  4B CD EE 10 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5F94  80 7F 06 D0 */	lwz r3, 0x6d0(r31)
/* 804C5F98  4B B4 7D CC */	b mDoExt_modelEntryDL__FP8J3DModel
lbl_804C5F9C:
/* 804C5F9C  80 1F 08 90 */	lwz r0, 0x890(r31)
/* 804C5FA0  54 00 06 F7 */	rlwinm. r0, r0, 0, 0x1b, 0x1b
/* 804C5FA4  41 82 00 60 */	beq lbl_804C6004
/* 804C5FA8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5FAC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5FB0  80 9F 06 AC */	lwz r4, 0x6ac(r31)
/* 804C5FB4  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5FB8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5FBC  4B CD ED E4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 804C5FD8  4B E6 9E 98 */	b entryTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
lbl_804C5FDC:
/* 804C5FDC  80 7F 06 AC */	lwz r3, 0x6ac(r31)
/* 804C5FE0  4B B4 7D 84 */	b mDoExt_modelEntryDL__FP8J3DModel
/* 804C5FE4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C5FE8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C5FEC  80 9F 06 B0 */	lwz r4, 0x6b0(r31)
/* 804C5FF0  80 84 00 04 */	lwz r4, 4(r4)
/* 804C5FF4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C5FF8  4B CD ED A8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C5FFC  80 7F 06 B0 */	lwz r3, 0x6b0(r31)
/* 804C6000  4B B4 7D 64 */	b mDoExt_modelEntryDL__FP8J3DModel
lbl_804C6004:
...
/* 804C6018  3C 60 80 43 */	lis r3, g_env_light@ha
/* 804C601C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 804C6020  80 9F 06 D8 */	lwz r4, 0x6d8(r31)
/* 804C6024  80 84 00 04 */	lwz r4, 4(r4)
/* 804C6028  38 BF 01 0C */	addi r5, r31, 0x10c
/* 804C602C  4B CD ED 74 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 804C6030  80 7F 06 D8 */	lwz r3, 0x6d8(r31)
/* 804C6034  4B B4 7D 30 */	b mDoExt_modelEntryDL__FP8J3DModel
lbl_804C6038:
...
/* 804C6048  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C604C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C6050  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 804C6054  90 1D 00 48 */	stw r0, 0x48(r29)
/* 804C6058  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
...
/* 804C609C  4B B5 7C 20 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
...
/* 804C60CC  3C E0 80 45 */	lis r7, mGroundY__11fopAcM_gc_c@ha
/* 804C60D0  C0 87 0C D0 */	lfs f4, mGroundY__11fopAcM_gc_c@l(r7)
/* 804C60D4  3C E0 80 3F */	lis r7, mGndCheck__11fopAcM_gc_c@ha
/* 804C60D8  38 E7 1C C4 */	addi r7, r7, mGndCheck__11fopAcM_gc_c@l
...
/* 804C60EC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 804C60F0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 804C60F4  4B B6 88 1C */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 804C6108  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C610C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C6110  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 804C6114  80 9F 08 9C */	lwz r4, 0x89c(r31)
/* 804C6118  80 BF 06 70 */	lwz r5, 0x670(r31)
/* 804C611C  4B B8 FE 00 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_804C6120:
...
/* 804C6134  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C6138  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C613C  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 804C6140  80 9F 08 9C */	lwz r4, 0x89c(r31)
/* 804C6144  80 BF 06 D8 */	lwz r5, 0x6d8(r31)
/* 804C6148  4B B8 FD D4 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
/* 804C614C  48 00 00 1C */	b lbl_804C6168
lbl_804C6150:
/* 804C6150  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C6154  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C6158  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 804C615C  80 9F 08 9C */	lwz r4, 0x89c(r31)
/* 804C6160  80 BF 06 80 */	lwz r5, 0x680(r31)
/* 804C6164  4B B8 FD B8 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_804C6168:
/* 804C6168  38 60 00 01 */	li r3, 1
lbl_804C616C:
/* 804C616C  39 61 00 60 */	addi r11, r1, 0x60
/* 804C6170  4B E9 C0 A8 */	b _restgpr_25

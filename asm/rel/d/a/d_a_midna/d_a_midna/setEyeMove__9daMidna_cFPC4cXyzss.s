...
/* 804C2AE0  4B E9 F6 EC */	b _savegpr_25
/* 804C2AE4  7C 7E 1B 78 */	mr r30, r3
/* 804C2AE8  7C 99 23 78 */	mr r25, r4
/* 804C2AEC  7C BA 2B 78 */	mr r26, r5
/* 804C2AF0  7C DB 33 78 */	mr r27, r6
/* 804C2AF4  3C 60 80 4C */	lis r3, lit_3777@ha
/* 804C2AF8  3B E3 64 C8 */	addi r31, r3, lit_3777@l
/* 804C2AFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C2B00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C2B04  83 A3 5D B4 */	lwz r29, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 804C2B08  8B 9E 08 4C */	lbz r28, 0x84c(r30)
/* 804C2B0C  C3 BE 08 CC */	lfs f29, 0x8cc(r30)
/* 804C2B10  C3 DE 08 D0 */	lfs f30, 0x8d0(r30)
/* 804C2B14  C0 3F 04 2C */	lfs f1, 0x42c(r31)	/* effective address: 804C68F4 */
/* 804C2B18  4B DA 4E 3C */	b cM_rndF__Ff
...
lbl_804C2BB4:
/* 804C2BB4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804C2BB8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804C2BBC  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
lbl_804C2C24:
/* 804C2C24  4B DA 4C 48 */	b cM_rnd__Fv
...
/* 804C2C4C  4B DA 4A 28 */	b cM_atan2s__Fff
/* 804C2C50  7C 7D 1B 78 */	mr r29, r3
/* 804C2C54  C0 3F 04 20 */	lfs f1, 0x420(r31)
/* 804C2C58  4B DA 4C FC */	b cM_rndF__Ff
...
/* 804C2C7C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804C2C80  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804C2CA0  4B DA 4C B4 */	b cM_rndF__Ff
...
/* 804C2CB4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804C2CB8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
lbl_804C2CE8:
/* 804C2CE8  3C 60 80 4C */	lis r3, struct_804C6CD8+0x1@ha
/* 804C2CEC  88 03 6C D9 */	lbz r0, struct_804C6CD8+0x1@l(r3)
...
/* 804C2E18  3C 60 80 4C */	lis r3, struct_804C6CD8+0x0@ha
/* 804C2E1C  98 03 6C D8 */	stb r0, struct_804C6CD8+0x0@l(r3)
...
/* 804C2E34  4B DA CB 48 */	b cLib_addCalc__FPfffff
...
/* 804C2E50  4B DA CB 2C */	b cLib_addCalc__FPfffff
...
/* 804C2E6C  4B DA CB 10 */	b cLib_addCalc__FPfffff
...
/* 804C2E88  4B DA CA F4 */	b cLib_addCalc__FPfffff
lbl_804C2E8C:
...
/* 804C2EA8  4B E9 F3 70 */	b _restgpr_25

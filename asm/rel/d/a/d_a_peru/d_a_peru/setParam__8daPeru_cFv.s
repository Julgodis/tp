...
/* 80D47B40  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D47B44  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D47B48  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 80D47B4C  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 80D47B90  A8 64 00 4C */	lha r3, 0x4c(r4)	/* effective address: 80D4C0AC */
/* 80D47B94  A8 84 00 4E */	lha r4, 0x4e(r4)	/* effective address: 80D4C0AE */
...
/* 80D47BB0  A8 64 00 48 */	lha r3, 0x48(r4)	/* effective address: 80D4C0A8 */
/* 80D47BB4  A8 84 00 4A */	lha r4, 0x4a(r4)	/* effective address: 80D4C0AA */
...
/* 80D47BC8  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80D4C068 */
/* 80D47BCC  D0 1F 04 EC */	stfs f0, 0x4ec(r31)
/* 80D47BD0  D0 1F 04 F0 */	stfs f0, 0x4f0(r31)
/* 80D47BD4  D0 1F 04 F4 */	stfs f0, 0x4f4(r31)
/* 80D47BD8  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 80D4C070 */
...
/* 80D47BEC  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 80D4C074 */
/* 80D47BF0  D0 1F 0D EC */	stfs f0, 0xdec(r31)
/* 80D47BF4  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 80D4C07C */
...
/* 80D47C10  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80D4C078 */
/* 80D47C14  D0 1F 08 D0 */	stfs f0, 0x8d0(r31)
/* 80D47C18  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80D4C06C */
/* 80D47C1C  D0 1F 0D E8 */	stfs f0, 0xde8(r31)
/* 80D47C20  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80D4C064 */
/* 80D47C24  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 80D47C28  C0 03 00 6C */	lfs f0, 0x6c(r3)	/* effective address: 80D4C0CC */
/* 80D47C2C  D0 1F 0A 80 */	stfs f0, 0xa80(r31)
/* 80D47C30  C0 03 00 44 */	lfs f0, 0x44(r3)	/* effective address: 80D4C0A4 */

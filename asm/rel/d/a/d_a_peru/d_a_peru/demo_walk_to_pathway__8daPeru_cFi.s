...
/* 80D4972C  4B 61 8A B0 */	b _savegpr_29
/* 80D49730  7C 7E 1B 78 */	mr r30, r3
/* 80D49734  3C 60 80 D5 */	lis r3, m__14daPeru_Param_c@ha
/* 80D49738  3B E3 C0 60 */	addi r31, r3, m__14daPeru_Param_c@l
...
/* 80D49770  4B 3F C1 28 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80D4979C  4B 3F C0 FC */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80D49800  4B 52 74 04 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 80D49804  7C 64 1B 78 */	mr r4, r3
/* 80D49808  38 7E 0D 7A */	addi r3, r30, 0xd7a
/* 80D4980C  38 A0 08 00 */	li r5, 0x800
/* 80D49810  4B 52 73 80 */	b cLib_chaseAngleS__FPsss
...
/* 80D49830  4B 51 D3 04 */	b __mi__4cXyzCFRC3Vec
...
/* 80D49850  4B 5F D8 E8 */	b PSVECSquareMag
...
/* 80D498C0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D498C4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80D49930  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D49934  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80D49938:
...
/* 80D49958  3C 60 80 D5 */	lis r3, lit_5372@ha
/* 80D4995C  38 83 C5 B0 */	addi r4, r3, lit_5372@l
/* 80D49960  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80D4C5B0 */
/* 80D49964  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80D4C5B4 */
/* 80D49968  90 61 00 18 */	stw r3, 0x18(r1)
/* 80D4996C  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80D49970  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80D4C5B8 */
...
/* 80D49998  4B 61 88 90 */	b _restgpr_29

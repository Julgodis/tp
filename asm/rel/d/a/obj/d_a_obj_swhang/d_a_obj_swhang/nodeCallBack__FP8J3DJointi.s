...
/* 80CFB948  4B 66 68 90 */	b _savegpr_28
/* 80CFB94C  2C 04 00 00 */	cmpwi r4, 0
/* 80CFB950  40 82 00 6C */	bne lbl_80CFB9BC
/* 80CFB954  A3 E3 00 14 */	lhz r31, 0x14(r3)
/* 80CFB958  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80CFB95C  38 63 4A C8 */	addi r3, r3, j3dSys@l
/* 80CFB960  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 80CFB978  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CFB97C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CFB980  4B 64 AB 30 */	b PSMTXCopy
...
/* 80CFB994  3C 60 80 D0 */	lis r3, lit_3681@ha
/* 80CFB998  C0 43 D2 40 */	lfs f2, lit_3681@l(r3)
/* 80CFB99C  FC 60 10 90 */	fmr f3, f2
/* 80CFB9A0  4B 31 13 FC */	b transM__14mDoMtx_stack_cFfff
lbl_80CFB9A4:
/* 80CFB9A4  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 80CFB9A8  80 03 00 0C */	lwz r0, 0xc(r3)
/* 80CFB9AC  7C 80 EA 14 */	add r4, r0, r29
/* 80CFB9B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CFB9B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CFB9B8  4B 64 AA F8 */	b PSMTXCopy
lbl_80CFB9BC:
/* 80CFB9BC  38 60 00 01 */	li r3, 1
/* 80CFB9C0  39 61 00 20 */	addi r11, r1, 0x20
/* 80CFB9C4  4B 66 68 60 */	b _restgpr_28

...
/* 80CBD3D0  4B 6A 4E 0C */	b _savegpr_29
/* 80CBD3D4  7C 7D 1B 78 */	mr r29, r3
/* 80CBD3D8  3C 80 80 CC */	lis r4, lit_3631@ha
/* 80CBD3DC  3B E4 DA 5C */	addi r31, r4, lit_3631@l
...
/* 80CBD3F8  4B 3B B2 2C */	b __ct__16dBgS_MoveBgActorFv
/* 80CBD3FC  3C 60 80 CC */	lis r3, __vt__16daObjRIVERROCK_c@ha
/* 80CBD400  38 03 DB AC */	addi r0, r3, __vt__16daObjRIVERROCK_c@l
/* 80CBD404  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80CBD408  38 7E 05 F0 */	addi r3, r30, 0x5f0
/* 80CBD40C  4B 60 14 38 */	b __ct__16Z2SoundObjSimpleFv
/* 80CBD410  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80CBD414  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80CBD418  90 1E 06 38 */	stw r0, 0x638(r30)
/* 80CBD41C  38 7E 06 3C */	addi r3, r30, 0x63c
/* 80CBD420  4B 3C 63 40 */	b __ct__10dCcD_GSttsFv
/* 80CBD424  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80CBD428  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80CBD440  4B 3C 65 E8 */	b __ct__12dCcD_GObjInfFv
/* 80CBD444  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80CBD448  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80CBD44C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80CBD450  3C 60 80 CC */	lis r3, __vt__8cM3dGAab@ha
/* 80CBD454  38 03 DB A0 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80CBD458  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80CBD45C  3C 60 80 CC */	lis r3, __vt__8cM3dGCyl@ha
/* 80CBD460  38 03 DB 94 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80CBD464  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80CBD468  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80CBD46C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80CBD470  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80CBD474  38 03 00 58 */	addi r0, r3, 0x58
/* 80CBD478  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80CBD47C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80CBD480  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80CBD4A8  3C 80 80 CC */	lis r4, l_arcName@ha
/* 80CBD4AC  38 84 DB 40 */	addi r4, r4, l_arcName@l
/* 80CBD4B0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80CBDB40 */
/* 80CBD4B4  4B 36 FA 08 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CBD4CC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CBD4D0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CBD4D4  3C 63 00 02 */	addis r3, r3, 2
/* 80CBD4D8  3C 80 80 CC */	lis r4, l_arcName@ha
/* 80CBD4DC  38 84 DB 40 */	addi r4, r4, l_arcName@l
/* 80CBD4E0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80CBDB40 */
/* 80CBD4E4  3C A0 80 CC */	lis r5, stringBase0@ha
/* 80CBD4E8  38 A5 DB 14 */	addi r5, r5, stringBase0@l
/* 80CBD4EC  38 A5 00 1A */	addi r5, r5, 0x1a
/* 80CBD4F0  38 63 C2 F8 */	addi r3, r3, -15624
/* 80CBD4F4  4B 37 F1 C4 */	b getObjectResName2Index__14dRes_control_cFPCcPCc
...
/* 80CBD50C  3C 80 80 CC */	lis r4, l_arcName@ha
/* 80CBD510  38 84 DB 40 */	addi r4, r4, l_arcName@l
/* 80CBD514  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80CBDB40 */
/* 80CBD518  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80CBD51C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80CBD520  38 E0 1B F0 */	li r7, 0x1bf0
/* 80CBD524  39 00 00 00 */	li r8, 0
/* 80CBD528  4B 3B B2 94 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80CBD544  4B 35 15 3C */	b mDoExt_setupStageTexture__FP12J3DModelData
...
lbl_80CBD5E4:
/* 80CBD5E4  3C 60 80 CC */	lis r3, data_80CBDBE8@ha
/* 80CBD5E8  8C 03 DB E8 */	lbzu r0, data_80CBDBE8@l(r3)
...
/* 80CBD604  3C 60 80 CC */	lis r3, l_HIO@ha
/* 80CBD608  38 63 DB F8 */	addi r3, r3, l_HIO@l
/* 80CBD60C  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80CBDBFC */
lbl_80CBD610:
...
/* 80CBD6A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CBD6AC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CBD6B0  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80CBD6B4  7C 05 07 74 */	extsb r5, r0
/* 80CBD6B8  4B 37 7C A8 */	b isSwitch__10dSv_info_cCFii
...
/* 80CBD6F4  4B 35 CE 54 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80CBD708  4B 6A 4B 20 */	b _restgpr_29

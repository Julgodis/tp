...
/* 80C91FC0 00000018  3C 80 00 00 */	lis r4, lit_3900@ha
/* 80C91FC4 0000001C  C0 24 00 00 */	lfs f1, lit_3900@l(r4)
/* 80C91FC8 00000020  3C 80 00 00 */	lis r4, lit_3901@ha
/* 80C91FCC 00000024  C0 44 00 00 */	lfs f2, lit_3901@l(r4)
/* 80C91FD0 00000028  4B FF FB 69 */	bl cLib_chaseF__FPfff
/* 80C91FD4 0000002C  38 7F 07 00 */	addi r3, r31, 0x700
/* 80C91FD8 00000030  3C 80 00 00 */	lis r4, lit_3900@ha
/* 80C91FDC 00000034  C0 24 00 00 */	lfs f1, lit_3900@l(r4)
/* 80C91FE0 00000038  3C 80 00 00 */	lis r4, lit_3901@ha
/* 80C91FE4 0000003C  C0 44 00 00 */	lfs f2, lit_3901@l(r4)
/* 80C91FE8 00000040  4B FF FB 51 */	bl cLib_chaseF__FPfff
/* 80C91FEC 00000044  38 7F 07 04 */	addi r3, r31, 0x704
/* 80C91FF0 00000048  3C 80 00 00 */	lis r4, lit_3900@ha
/* 80C91FF4 0000004C  C0 24 00 00 */	lfs f1, lit_3900@l(r4)
/* 80C91FF8 00000050  3C 80 00 00 */	lis r4, lit_3901@ha
/* 80C91FFC 00000054  C0 44 00 00 */	lfs f2, lit_3901@l(r4)
/* 80C92000 00000058  4B FF FB 39 */	bl cLib_chaseF__FPfff
/* 80C92004 0000005C  48 00 00 2C */	b lbl_80C92030
lbl_80C92008:
/* 80C92008 00000000  3C 80 00 00 */	lis r4, lit_3891@ha
/* 80C9200C 00000004  38 C4 00 00 */	addi r6, r4, lit_3891@l

...
/* 80C921C0  3C 60 80 C9 */	lis r3, l_B_ling_bmd_table@ha
/* 80C921C4  3B E3 2C 50 */	addi r31, r3, l_B_ling_bmd_table@l
/* 80C921C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C921CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C921D0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80C921D4  C0 1F 00 20 */	lfs f0, 0x20(r31)	/* effective address: 80C92C70 */
...
/* 80C921F0  A8 03 04 E6 */	lha r0, 0x4e6(r3)	/* effective address: 804066A6 */
...
/* 80C92224  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 80C92C6C */
/* 80C92228  FC 40 08 90 */	fmr f2, f1
/* 80C9222C  4B 38 9F D0 */	b fopAcM_createItemForSimpleDemo__FPC4cXyziiPC5csXyzPC4cXyzff
/* 80C92230  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C92234  38 C3 61 C0 */	addi r6, r3, struct_804061C0+0x0@l
/* 80C92238  80 A6 5D C4 */	lwz r5, 0x5dc4(r6)	/* effective address: 8040BF84 */
...
/* 80C9224C  90 06 5D C4 */	stw r0, 0x5dc4(r6)	/* effective address: 8040BF84 */
...
/* 80C92260  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C92264  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C92268  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C92290  4B 61 96 F4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

...
/* 80C4F07C  3C 60 80 C5 */	lis r3, searchKWheel00__FPvPv@ha
/* 80C4F080  38 63 EF EC */	addi r3, r3, searchKWheel00__FPvPv@l
/* 80C4F084  7F C4 F3 78 */	mr r4, r30
/* 80C4F088  4B 3C A7 70 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C4F104  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4F108  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C4F10C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C4F110  7C 05 07 74 */	extsb r5, r0
/* 80C4F114  4B 3E 62 4C */	b isSwitch__10dSv_info_cCFii
...
/* 80C4F130  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4F134  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C4F138  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80C4F13C  7F C4 F3 78 */	mr r4, r30
/* 80C4F140  4B 3F 85 58 */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 80C4F158  4B 3F 97 4C */	b setEvent__17dEvLib_callback_cFiii
...
/* 80C4F1D8  4B 6F 72 D8 */	b PSMTXCopy
...
/* 80C4F214  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C4F218  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C4F21C  38 81 00 08 */	addi r4, r1, 8
/* 80C4F220  4B 3C A5 D8 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 80C4F224  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C4F228  41 82 00 5C */	beq lbl_80C4F284
/* 80C4F22C  38 7E 05 B8 */	addi r3, r30, 0x5b8
/* 80C4F230  3C 80 80 C5 */	lis r4, l_pos@ha
/* 80C4F234  38 04 F6 FC */	addi r0, r4, l_pos@l
/* 80C4F238  7C 80 EA 14 */	add r4, r0, r29
/* 80C4F23C  38 A1 00 10 */	addi r5, r1, 0x10
/* 80C4F240  4B 6F 7B 2C */	b PSMTXMultVec
...
/* 80C4F2C0  4B 42 C7 00 */	b Move__4dBgWFv
lbl_80C4F2C4:
...
/* 80C4F2EC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C4F2F0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C4F2F4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C4F308  3D 00 80 C5 */	lis r8, lit_3717@ha
/* 80C4F30C  C0 28 F6 E4 */	lfs f1, lit_3717@l(r8)
/* 80C4F310  FC 40 08 90 */	fmr f2, f1
/* 80C4F314  3D 00 80 C5 */	lis r8, lit_3888@ha
/* 80C4F318  C0 68 F6 E8 */	lfs f3, lit_3888@l(r8)
/* 80C4F31C  FC 80 18 90 */	fmr f4, f3
/* 80C4F320  39 00 00 00 */	li r8, 0
/* 80C4F324  4B 65 D1 E8 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C4F328:
/* 80C4F328  38 60 00 01 */	li r3, 1
/* 80C4F32C  39 61 00 40 */	addi r11, r1, 0x40
/* 80C4F330  4B 71 2E F0 */	b _restgpr_27

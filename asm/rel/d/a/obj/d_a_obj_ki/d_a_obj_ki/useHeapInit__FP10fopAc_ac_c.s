...
/* 80C444A8  4B 68 A7 A4 */	b __nw__FUl
/* 80C444AC  7C 7E 1B 79 */	or. r30, r3, r3
/* 80C444B0  41 82 00 8C */	beq lbl_80C4453C
/* 80C444B4  3C 60 80 C4 */	lis r3, stringBase0@ha
/* 80C444B8  38 63 4B 88 */	addi r3, r3, stringBase0@l
/* 80C444BC  88 1F 05 70 */	lbz r0, 0x570(r31)
/* 80C444C0  54 00 10 3A */	slwi r0, r0, 2
/* 80C444C4  3C 80 80 C4 */	lis r4, ki_bmd@ha
/* 80C444C8  38 84 4B 90 */	addi r4, r4, ki_bmd@l
/* 80C444CC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C444D0  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C444D4  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C444D8  3C A5 00 02 */	addis r5, r5, 2
/* 80C444DC  38 C0 00 80 */	li r6, 0x80
/* 80C444E0  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C444E4  4B 3F 7E 08 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C44524  3D 20 80 C4 */	lis r9, lit_3873@ha
/* 80C44528  C0 29 4B 50 */	lfs f1, lit_3873@l(r9)
/* 80C4452C  39 20 00 00 */	li r9, 0
/* 80C44530  39 40 FF FF */	li r10, -1
/* 80C44534  4B 3C B7 18 */	b __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 80C44580  3C 60 80 C4 */	lis r3, nodeCallBack__FP8J3DJointi@ha
/* 80C44584  38 83 3F 0C */	addi r4, r3, nodeCallBack__FP8J3DJointi@l
...
lbl_80C445E4:
/* 80C445E4  3C 60 80 C4 */	lis r3, stringBase0@ha
...
/* 80C44600  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C44604  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C44608  3C A5 00 02 */	addis r5, r5, 2
/* 80C4460C  38 C0 00 80 */	li r6, 0x80
/* 80C44610  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C44614  4B 3F 7C D8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C44628  4B 43 59 10 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C44640:
/* 80C44640  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C44644  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l

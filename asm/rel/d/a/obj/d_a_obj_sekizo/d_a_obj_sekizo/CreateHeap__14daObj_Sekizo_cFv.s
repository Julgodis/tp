...
/* 80CCDD1C  3C 60 80 CD */	lis r3, l_bmdData@ha
/* 80CCDD20  38 83 E1 9C */	addi r4, r3, l_bmdData@l
/* 80CCDD24  7C 64 2A 14 */	add r3, r4, r5
/* 80CCDD28  80 03 00 04 */	lwz r0, 4(r3)
/* 80CCDD2C  54 00 10 3A */	slwi r0, r0, 2
/* 80CCDD30  3C 60 80 CD */	lis r3, l_resNameList@ha
/* 80CCDD34  38 63 E1 AC */	addi r3, r3, l_resNameList@l
/* 80CCDD38  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CCDD3C  7C 84 28 2E */	lwzx r4, r4, r5
/* 80CCDD40  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CCDD44  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80CCDD48  3C A5 00 02 */	addis r5, r5, 2
/* 80CCDD4C  38 C0 00 80 */	li r6, 0x80
/* 80CCDD50  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80CCDD54  4B 36 E5 98 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCDD64  4B 34 6E F0 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

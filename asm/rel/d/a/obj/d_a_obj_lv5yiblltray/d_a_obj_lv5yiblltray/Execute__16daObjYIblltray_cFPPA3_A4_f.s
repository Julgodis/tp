...
/* 80C6F470  4B 6F 2D 6C */	b _savegpr_29
/* 80C6F474  7C 7F 1B 78 */	mr r31, r3
/* 80C6F478  7C 9D 23 78 */	mr r29, r4
/* 80C6F47C  3C 60 80 C7 */	lis r3, l_cull_box@ha
/* 80C6F480  3B C3 09 A0 */	addi r30, r3, l_cull_box@l
...
/* 80C6F4A0  3C 60 80 C7 */	lis r3, searchObjYIblltray__FPvPv@ha
/* 80C6F4A4  38 63 F2 BC */	addi r3, r3, searchObjYIblltray__FPvPv@l
/* 80C6F4A8  7F E4 FB 78 */	mr r4, r31
/* 80C6F4AC  4B 3A A3 4C */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6F4D4  3C 60 80 C7 */	lis r3, rideCallback__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C6F4D8  38 03 EE D4 */	addi r0, r3, rideCallback__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
/* 80C6F4DC  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 80C6F4E0  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 80C6F4E4  3C 60 80 C7 */	lis r3, searchNearIronball__FPvPv@ha
/* 80C6F4E8  38 63 F3 38 */	addi r3, r3, searchNearIronball__FPvPv@l
/* 80C6F4EC  7F E4 FB 78 */	mr r4, r31
/* 80C6F4F0  4B 3A A3 08 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6F5AC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6F5B0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6F5B4  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6F5B8  7C 05 07 74 */	extsb r5, r0
/* 80C6F5BC  4B 3C 5D A4 */	b isSwitch__10dSv_info_cCFii
...
/* 80C6F5D0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6F5D4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6F5D8  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6F5DC  7C 05 07 74 */	extsb r5, r0
/* 80C6F5E0  4B 3C 5C 20 */	b onSwitch__10dSv_info_cFii
...
/* 80C6F5FC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C6F600  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C6F604  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C6F62C  4B 63 C3 58 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C6F630  48 00 00 6C */	b lbl_80C6F69C
lbl_80C6F634:
/* 80C6F634  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 80C6F638  54 04 FE 3E */	rlwinm r4, r0, 0x1f, 0x18, 0x1f
/* 80C6F63C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6F640  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6F644  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6F648  7C 05 07 74 */	extsb r5, r0
/* 80C6F64C  4B 3C 5C 64 */	b offSwitch__10dSv_info_cFii
...
/* 80C6F668  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C6F66C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C6F670  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C6F698  4B 63 C2 EC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C6F69C:
...
/* 80C6F720  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6F724  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6F728  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6F72C  7C 05 07 74 */	extsb r5, r0
/* 80C6F730  4B 3C 5C 30 */	b isSwitch__10dSv_info_cCFii
...
/* 80C6F7C4  3C 60 80 C7 */	lis r3, searchNearBackTrayIronball__FPvPv@ha
/* 80C6F7C8  38 63 F3 BC */	addi r3, r3, searchNearBackTrayIronball__FPvPv@l
/* 80C6F7CC  7F E4 FB 78 */	mr r4, r31
/* 80C6F7D0  4B 3A A0 28 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6F8B0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6F8B4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6F8B8  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6F8BC  7C 05 07 74 */	extsb r5, r0
/* 80C6F8C0  4B 3C 5A A0 */	b isSwitch__10dSv_info_cCFii
...
/* 80C6F944  3C 60 80 C7 */	lis r3, searchNearBackTrayIronball__FPvPv@ha
/* 80C6F948  38 63 F3 BC */	addi r3, r3, searchNearBackTrayIronball__FPvPv@l
/* 80C6F94C  7F E4 FB 78 */	mr r4, r31
/* 80C6F950  4B 3A 9E A8 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6FA3C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C6FA40  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C6FA44  38 81 00 28 */	addi r4, r1, 0x28
/* 80C6FA48  4B 3A 9D B0 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6FA7C  4B 5F 70 B8 */	b __mi__4cXyzCFRC3Vec
...
/* 80C6FA9C  4B 6D 76 9C */	b PSVECSquareMag
...
/* 80C6FB0C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C6FB10  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C6FB80  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C6FB84:
...
/* 80C6FBB8  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80C6FBBC  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80C6FC58  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C6FC5C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C6FC60  38 81 00 24 */	addi r4, r1, 0x24
/* 80C6FC64  4B 3A 9B 94 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6FC78  4B 5F 6E BC */	b __mi__4cXyzCFRC3Vec
...
/* 80C6FC98  4B 6D 74 A0 */	b PSVECSquareMag
...
/* 80C6FD08  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C6FD0C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C6FD78  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C6FD7C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C6FD80:
...
/* 80C6FDBC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C6FDC0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C6FDC4  38 81 00 20 */	addi r4, r1, 0x20
/* 80C6FDC8  4B 3A 9A 30 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6FDF0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C6FDF4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C6FDF8  38 81 00 1C */	addi r4, r1, 0x1c
/* 80C6FDFC  4B 3A 99 FC */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6FE34  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80C6FE38  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80C6FECC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C6FED0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C6FED4  38 81 00 18 */	addi r4, r1, 0x18
/* 80C6FED8  4B 3A 99 20 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C6FEEC  4B 5F 6C 48 */	b __mi__4cXyzCFRC3Vec
...
/* 80C6FF0C  4B 6D 72 2C */	b PSVECSquareMag
...
/* 80C6FF7C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C6FF80  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C6FFEC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C6FFF0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C6FFF4:
...
/* 80C70028  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C7002C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C70030  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C70058  4B 63 B9 2C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C7006C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80C70070  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80C70074  38 81 00 14 */	addi r4, r1, 0x14
/* 80C70078  4B 3A 97 80 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C700A0  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80C700A4  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80C70128  4B 5F F0 B4 */	b SetC__8cM3dGCylFRC4cXyz
/* 80C7012C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C70130  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C70134  3B A3 23 3C */	addi r29, r3, 0x233c
/* 80C70138  7F A3 EB 78 */	mr r3, r29
/* 80C7013C  38 9F 06 44 */	addi r4, r31, 0x644
/* 80C70140  4B 5F 4A 68 */	b Set__4cCcSFP8cCcD_Obj
/* 80C70144  38 7F 08 A4 */	addi r3, r31, 0x8a4
/* 80C70148  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C7014C  4B 5F F0 90 */	b SetC__8cM3dGCylFRC4cXyz
/* 80C70150  7F A3 EB 78 */	mr r3, r29
/* 80C70154  38 9F 07 80 */	addi r4, r31, 0x780
/* 80C70158  4B 5F 4A 50 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80C7016C  4B 5F F0 70 */	b SetC__8cM3dGCylFRC4cXyz
/* 80C70170  7F A3 EB 78 */	mr r3, r29
/* 80C70174  38 9F 08 BC */	addi r4, r31, 0x8bc
/* 80C70178  4B 5F 4A 30 */	b Set__4cCcSFP8cCcD_Obj
/* 80C7017C  38 7F 0A 14 */	addi r3, r31, 0xa14
/* 80C70180  4B 41 36 B0 */	b Move__10dCcD_GSttsFv
/* 80C70184  38 7F 0A 38 */	addi r3, r31, 0xa38
/* 80C70188  4B 39 D2 A0 */	b play__14mDoExt_baseAnmFv
...
/* 80C701B4  4B 6D 6B B8 */	b PSMTXMultVec
...
/* 80C701E4  4B 6D 63 CC */	b PSMTXInverse
/* 80C701E8  28 03 00 00 */	cmplwi r3, 0
/* 80C701EC  41 82 00 D8 */	beq lbl_80C702C4
/* 80C701F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C701F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C701F8  83 A3 5D AC */	lwz r29, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80C701FC  38 61 00 A4 */	addi r3, r1, 0xa4
/* 80C70200  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 80C70204  38 A1 00 5C */	addi r5, r1, 0x5c
/* 80C70208  4B 6D 6B 64 */	b PSMTXMultVec
/* 80C7020C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C70210  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80C702CC  4B 6F 1F 5C */	b _restgpr_29

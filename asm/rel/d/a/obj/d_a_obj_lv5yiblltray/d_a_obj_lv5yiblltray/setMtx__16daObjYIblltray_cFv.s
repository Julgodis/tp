...
/* 80C6ECA0 00000018  3C 60 00 00 */	lis r3, l_cull_box@ha /* 80C709A0 */
/* 80C6ECA4 0000001C  3B C3 00 00 */	addi r30, r3, l_cull_box@l /* 80C709A0 */
/* 80C6ECA8 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ECAC 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C6ECC0 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ECC4 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
lbl_80C6ED00:
/* 80C6ED00 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ED04 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C6ED08 00000008  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 80C6ED0C 0000000C  4B FF FE CD */	bl mDoMtx_XrotM__FPA4_fs
/* 80C6ED10 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ED14 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C6ED18 00000018  38 9F 05 F0 */	addi r4, r31, 0x5f0
/* 80C6ED1C 0000001C  4B FF FE BD */	bl PSMTXCopy
/* 80C6ED20 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ED24 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C6ED34 00000034  3C 80 00 00 */	lis r4, l_in_ball@ha /* 80C70A3C */
/* 80C6ED38 00000038  38 84 00 00 */	addi r4, r4, l_in_ball@l /* 80C70A3C */
...
/* 80C6ED48 00000048  3C 80 00 00 */	lis r4, l_base@ha /* 80C70A48 */
/* 80C6ED4C 0000004C  38 84 00 00 */	addi r4, r4, l_base@l /* 80C70A48 */
/* 80C6ED50 00000050  38 BF 06 28 */	addi r5, r31, 0x628
/* 80C6ED54 00000054  4B FF FE 85 */	bl PSMTXMultVec
/* 80C6ED58 00000058  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ED5C 0000005C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C6ED70 00000070  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ED74 00000074  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C6ED78 00000078  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80C6ED7C 0000007C  4B FF FE 5D */	bl mDoMtx_YrotM__FPA4_fs
/* 80C6ED80 00000080  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C6ED84 00000084  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */

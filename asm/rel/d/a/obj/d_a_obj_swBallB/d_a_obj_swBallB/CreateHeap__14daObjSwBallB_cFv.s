...
/* 80CF4B84  4B 66 D6 54 */	b _savegpr_28
/* 80CF4B88  7C 7F 1B 78 */	mr r31, r3
/* 80CF4B8C  3C 60 80 CF */	lis r3, l_arcName@ha
/* 80CF4B90  38 63 5A 40 */	addi r3, r3, l_arcName@l
/* 80CF4B94  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80CF5A40 */
/* 80CF4B98  38 80 00 05 */	li r4, 5
/* 80CF4B9C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CF4BA0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80CF4BB4  4B 34 77 38 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CF4BC8  4B 32 00 8C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CF4BE4:
/* 80CF4BE4  3C 60 80 CF */	lis r3, l_arcName@ha
/* 80CF4BE8  38 63 5A 40 */	addi r3, r3, l_arcName@l
/* 80CF4BEC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80CF5A40 */
/* 80CF4BF0  38 80 00 09 */	li r4, 9
/* 80CF4BF4  7F C5 F3 78 */	mr r5, r30
/* 80CF4BF8  38 C0 00 80 */	li r6, 0x80
/* 80CF4BFC  4B 34 76 F0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80CF4C00  7C 7C 1B 78 */	mr r28, r3
/* 80CF4C04  38 60 00 18 */	li r3, 0x18
/* 80CF4C08  4B 5D A0 44 */	b __nw__FUl
/* 80CF4C0C  7C 7E 1B 79 */	or. r30, r3, r3
/* 80CF4C10  41 82 00 20 */	beq lbl_80CF4C30
/* 80CF4C14  3C 80 80 CF */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CF4C18  38 04 5B 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CF4C1C  90 1E 00 00 */	stw r0, 0(r30)
/* 80CF4C20  38 80 00 00 */	li r4, 0
/* 80CF4C24  4B 63 37 D8 */	b init__12J3DFrameCtrlFs
...
/* 80CF4C50  3D 00 80 CF */	lis r8, lit_3969@ha
/* 80CF4C54  C0 28 5A 08 */	lfs f1, lit_3969@l(r8)
/* 80CF4C58  39 00 00 00 */	li r8, 0
/* 80CF4C5C  39 20 FF FF */	li r9, -1
/* 80CF4C60  4B 31 89 DC */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80CF4C74:
/* 80CF4C74  3C 60 80 CF */	lis r3, lit_3755@ha
/* 80CF4C78  C0 03 59 F8 */	lfs f0, lit_3755@l(r3)
...
/* 80CF4C8C  4B 66 D5 98 */	b _restgpr_28

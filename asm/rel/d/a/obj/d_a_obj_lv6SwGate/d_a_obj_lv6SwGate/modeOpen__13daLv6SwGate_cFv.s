...
/* 80C74B84 0000000C  3C 60 80 C7 */	lis r3, lit_3633@ha
/* 80C74B88 00000010  3B E3 55 24 */	addi r31, r3, lit_3633@l
/* 80C74B8C 00000014  38 7E 14 C0 */	addi r3, r30, 0x14c0
/* 80C74B90 00000018  3C 80 80 C7 */	lis r4, l_HIO@ha
/* 80C74B94 0000001C  38 84 57 54 */	addi r4, r4, l_HIO@l
/* 80C74B98 00000020  C0 24 00 10 */	lfs f1, 0x10(r4)	/* effective address: 80C75764 */
/* 80C74B9C 00000024  C0 5F 00 58 */	lfs f2, 0x58(r31)	/* effective address: 80C7557C */
/* 80C74BA0 00000028  C0 64 00 04 */	lfs f3, 4(r4)	/* effective address: 80C75758 */
/* 80C74BA4 0000002C  C0 9F 00 5C */	lfs f4, 0x5c(r31)	/* effective address: 80C75580 */
/* 80C74BA8 00000030  4B 5F AD D4 */	b cLib_addCalc__FPfffff
...
/* 80C74BB8 00000040  4B 3B 84 B4 */	b dComIfGp_getReverb__Fi
...
/* 80C74BCC 00000054  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C74BD0 00000058  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C74BD4 0000005C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C74BE4 0000006C  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 80C75584 */
/* 80C74BE8 00000070  FC 40 08 90 */	fmr f2, f1
/* 80C74BEC 00000074  C0 7F 00 64 */	lfs f3, 0x64(r31)	/* effective address: 80C75588 */
/* 80C74BF0 00000078  FC 80 18 90 */	fmr f4, f3
/* 80C74BF4 0000007C  39 00 00 00 */	li r8, 0
/* 80C74BF8 00000080  4B 63 79 14 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C74BFC 00000084  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 80C75564 */
...
/* 80C74C10 00000098  4B 3B 84 5C */	b dComIfGp_getReverb__Fi
...
/* 80C74C24 000000AC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C74C28 000000B0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C74C2C 000000B4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C74C3C 000000C4  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 80C75584 */
/* 80C74C40 000000C8  FC 40 08 90 */	fmr f2, f1
/* 80C74C44 000000CC  C0 7F 00 64 */	lfs f3, 0x64(r31)	/* effective address: 80C75588 */
/* 80C74C48 000000D0  FC 80 18 90 */	fmr f4, f3
/* 80C74C4C 000000D4  39 00 00 00 */	li r8, 0
/* 80C74C50 000000D8  4B 63 6D 34 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

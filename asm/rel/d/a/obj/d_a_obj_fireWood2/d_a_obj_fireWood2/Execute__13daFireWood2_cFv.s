...
/* 80BE87F4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE87F8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BE8898  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE889C  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80BE88A0  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
lbl_80BE8A04:
/* 80BE8A04  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE8A08  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80BE8A0C  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80BE8B2C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BE8BBC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE8BC0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80BE8BDC:
/* 80BE8BDC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE8BE0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BE8C1C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BE8C94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE8C98  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80BE8CB4:
/* 80BE8CB4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE8CB8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BE8CF4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BE8D38  C0 24 00 08 */	lfs f1, 8(r4)	/* effective address: 80BE9094 */
...
/* 80BE8D4C  C0 24 00 0C */	lfs f1, 0xc(r4)	/* effective address: 80BE9098 */
...
/* 80BE8D60  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE8D64  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l

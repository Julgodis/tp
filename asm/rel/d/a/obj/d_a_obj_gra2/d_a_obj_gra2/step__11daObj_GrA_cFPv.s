...
/* 80C067E8  4B 75 B9 F0 */	b _savegpr_28
/* 80C067EC  7C 7D 1B 78 */	mr r29, r3
/* 80C067F0  3C 80 80 C1 */	lis r4, m__17daObj_GrA_Param_c@ha
/* 80C067F4  3B C4 FA 7C */	addi r30, r4, m__17daObj_GrA_Param_c@l
/* 80C067F8  3C 80 80 C1 */	lis r4, cNullVec__6Z2Calc@ha
/* 80C067FC  3B E4 FE 68 */	addi r31, r4, cNullVec__6Z2Calc@l
...
/* 80C069A0  4B 66 90 9C */	b cLib_addCalc2__FPffff
/* 80C069A4  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C069A8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C069AC  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C069B0  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C069B4  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 80C069B8  4B 66 A2 4C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C069DC  4B 66 9C 2C */	b cLib_addCalcAngleS2__FPssss
...
/* 80C06A8C  4B 47 CB FC */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 80C06A90  7C 64 1B 78 */	mr r4, r3
/* 80C06A94  38 7D 0A B0 */	addi r3, r29, 0xab0
/* 80C06A98  4B 54 6D 84 */	b entry__18daBaseNpc_acMngr_cFP10fopAc_ac_c
...
/* 80C06AFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C06B00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C06B04  3B 83 09 78 */	addi r28, r3, 0x978
/* 80C06B08  7F 83 E3 78 */	mr r3, r28
/* 80C06B0C  38 80 00 1C */	li r4, 0x1c
/* 80C06B10  4B 42 E0 D8 */	b isSwitch__12dSv_danBit_cCFi
...
/* 80C06B24  4B 42 E0 74 */	b onSwitch__12dSv_danBit_cFi
/* 80C06B28  48 00 00 50 */	b lbl_80C06B78
lbl_80C06B2C:
/* 80C06B2C  38 7D 0E 18 */	addi r3, r29, 0xe18
/* 80C06B30  4B 47 D7 90 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 80C06B4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C06B50  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C06B54  3B 83 09 78 */	addi r28, r3, 0x978
/* 80C06B58  7F 83 E3 78 */	mr r3, r28
/* 80C06B5C  38 80 00 1C */	li r4, 0x1c
/* 80C06B60  4B 42 E0 88 */	b isSwitch__12dSv_danBit_cCFi
...
/* 80C06B74  4B 42 E0 24 */	b onSwitch__12dSv_danBit_cFi
lbl_80C06B78:
...
/* 80C06B88  4B 47 CB 00 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
/* 80C06B8C  7C 64 1B 78 */	mr r4, r3
/* 80C06B90  38 7D 0A B0 */	addi r3, r29, 0xab0
/* 80C06B94  4B 54 6C 88 */	b entry__18daBaseNpc_acMngr_cFP10fopAc_ac_c
...
/* 80C06BF8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C06BFC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C06C00  3B 83 09 78 */	addi r28, r3, 0x978
/* 80C06C04  7F 83 E3 78 */	mr r3, r28
/* 80C06C08  38 80 00 1C */	li r4, 0x1c
/* 80C06C0C  4B 42 DF DC */	b isSwitch__12dSv_danBit_cCFi
...
/* 80C06C20  4B 42 DF 78 */	b onSwitch__12dSv_danBit_cFi
/* 80C06C24  48 00 00 9C */	b lbl_80C06CC0
lbl_80C06C28:
/* 80C06C28  38 7D 0C E0 */	addi r3, r29, 0xce0
/* 80C06C2C  4B 47 D6 94 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 80C06C48  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C06C4C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C06C50  3B 83 09 78 */	addi r28, r3, 0x978
/* 80C06C54  7F 83 E3 78 */	mr r3, r28
/* 80C06C58  38 80 00 1C */	li r4, 0x1c
/* 80C06C5C  4B 42 DF 8C */	b isSwitch__12dSv_danBit_cCFi
...
/* 80C06C70  4B 42 DF 28 */	b onSwitch__12dSv_danBit_cFi
...
/* 80C06CC8  4B 75 B5 5C */	b _restgpr_28

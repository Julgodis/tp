...
/* 80C08824 0000000C  3C 80 00 00 */	lis r4, m__17daObj_GrA_Param_c@ha /* 80C0FA7C */
/* 80C08828 00000010  3B C4 00 00 */	addi r30, r4, m__17daObj_GrA_Param_c@l /* 80C0FA7C */
/* 80C0882C 00000014  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C08830 00000018  3B E4 00 00 */	addi r31, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C0892C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C08930 00000008  C3 E3 00 00 */	lfs f31, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C0899C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C089A0 0000000C  C3 E3 00 00 */	lfs f31, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C089DC 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C089E0 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C08A34 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C08A38 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
lbl_80C08A5C:
/* 80C08A5C 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C08A60 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C08B20 00000060  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C08B24 00000064  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C08B58 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C08B5C 00000020  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C08BEC 00000004  3C 60 00 00 */	lis r3, lit_7744@ha /* 80C1028C */
/* 80C08BF0 00000008  38 83 00 00 */	addi r4, r3, lit_7744@l /* 80C1028C */
...
/* 80C08E40 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C08E44 00000010  3B 83 00 00 */	addi r28, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C08E60 0000002C  3C 60 00 00 */	lis r3, g_dComIfGoat_gameInfo@ha /* 80450618 */
/* 80C08E64 00000030  84 03 00 00 */	lwzu r0, g_dComIfGoat_gameInfo@l(r3) /* 80450618 */
...
/* 80C0900C 0000000C  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 80C09010 00000010  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
...
lbl_80C091BC:
/* 80C091BC 00000000  3C 60 00 00 */	lis r3, lit_7836@ha /* 80C10298 */
/* 80C091C0 00000004  38 83 00 00 */	addi r4, r3, lit_7836@l /* 80C10298 */

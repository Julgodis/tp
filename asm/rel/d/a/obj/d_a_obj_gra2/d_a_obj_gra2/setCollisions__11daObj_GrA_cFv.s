...
/* 80C02624  4B 75 FB B4 */	b _savegpr_28
/* 80C02628  7C 7D 1B 78 */	mr r29, r3
/* 80C0262C  3C 60 80 C1 */	lis r3, lit_1109@ha
/* 80C02630  3B C3 08 A0 */	addi r30, r3, lit_1109@l
/* 80C02634  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha
/* 80C02638  3B E3 FA 7C */	addi r31, r3, m__17daObj_GrA_Param_c@l
...
/* 80C02750  3C 80 80 C0 */	lis r4, __dt__4cXyzFv@ha
/* 80C02754  38 84 4C 40 */	addi r4, r4, __dt__4cXyzFv@l
...
/* 80C0276C  4B 40 A5 F8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C02770  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02774  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C02778  A8 9D 09 1C */	lha r4, 0x91c(r29)
/* 80C0277C  4B 40 9C B8 */	b mDoMtx_YrotM__FPA4_fs
/* 80C02780  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02784  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C02788  38 9E 01 E4 */	addi r4, r30, 0x1e4
/* 80C0278C  38 A1 00 14 */	addi r5, r1, 0x14
/* 80C02790  4B 74 45 DC */	b PSMTXMultVec
/* 80C02794  38 7D 10 74 */	addi r3, r29, 0x1074
/* 80C02798  38 81 00 14 */	addi r4, r1, 0x14
/* 80C0279C  4B 66 CA 40 */	b SetC__8cM3dGCylFRC4cXyz
...
/* 80C027BC  4B 66 CA 3C */	b SetH__8cM3dGCylFf
...
/* 80C02800  4B 66 CA 00 */	b SetR__8cM3dGCylFf
lbl_80C02804:
...
lbl_80C02830:
/* 80C02830  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C02834  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C02838  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C0283C  38 9D 0F 50 */	addi r4, r29, 0xf50
/* 80C02840  4B 66 23 68 */	b Set__4cCcSFP8cCcD_Obj
lbl_80C02844:
/* 80C02844  3C 60 80 C1 */	lis r3, lit_5310@ha
/* 80C02848  38 83 01 48 */	addi r4, r3, lit_5310@l
/* 80C0284C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80C10148 */
/* 80C02850  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80C1014C */
/* 80C02854  90 61 00 08 */	stw r3, 8(r1)
/* 80C02858  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C0285C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80C10150 */
...
/* 80C0288C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C02890  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C02894  4B 74 3C 1C */	b PSMTXCopy
/* 80C02898  38 7D 04 EC */	addi r3, r29, 0x4ec
/* 80C0289C  4B 40 A5 D4 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80C028A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C028A4  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 80C028A8  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 80C028AC  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80C028B0  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 80C028B4  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80C028B8  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
/* 80C028BC  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80C028C0  38 7D 0F 3C */	addi r3, r29, 0xf3c
/* 80C028C4  38 81 00 14 */	addi r4, r1, 0x14
/* 80C028C8  4B 66 CD 80 */	b SetC__8cM3dGSphFRC4cXyz
/* 80C028CC  38 7D 0F 3C */	addi r3, r29, 0xf3c
/* 80C028D0  3B FF 00 00 */	addi r31, r31, 0
/* 80C028D4  C0 3F 00 8C */	lfs f1, 0x8c(r31)
/* 80C028D8  4B 66 CE 30 */	b SetR__8cM3dGSphFf
/* 80C028DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C028E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C028E4  3B 83 23 3C */	addi r28, r3, 0x233c
/* 80C028E8  7F 83 E3 78 */	mr r3, r28
/* 80C028EC  38 9D 0E 18 */	addi r4, r29, 0xe18
/* 80C028F0  4B 66 22 B8 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80C02908  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C0290C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C02910  4B 74 3B A0 */	b PSMTXCopy
/* 80C02914  38 7D 04 EC */	addi r3, r29, 0x4ec
/* 80C02918  4B 40 A5 58 */	b scaleM__14mDoMtx_stack_cFRC4cXyz

...
/* 80C02AF8  4B 75 F6 CC */	b _savegpr_23
/* 80C02AFC  7C 7F 1B 78 */	mr r31, r3
/* 80C02B00  3C 60 80 C1 */	lis r3, m__17daObj_GrA_Param_c@ha
/* 80C02B04  3B C3 FA 7C */	addi r30, r3, m__17daObj_GrA_Param_c@l
...
/* 80C02B38  4B 54 AC E4 */	b entry__18daBaseNpc_acMngr_cFP10fopAc_ac_c
...
/* 80C02B64  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C02B68  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C02B6C  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C02B70  4B 54 AC AC */	b entry__18daBaseNpc_acMngr_cFP10fopAc_ac_c
/* 80C02B74  48 00 00 18 */	b lbl_80C02B8C
lbl_80C02B78:
/* 80C02B78  38 7F 20 4C */	addi r3, r31, 0x204c
/* 80C02B7C  4B 54 AC BC */	b getActor__18daBaseNpc_acMngr_cFv
/* 80C02B80  7C 64 1B 78 */	mr r4, r3
/* 80C02B84  38 7F 14 F8 */	addi r3, r31, 0x14f8
/* 80C02B88  4B 54 AC 94 */	b entry__18daBaseNpc_acMngr_cFP10fopAc_ac_c
lbl_80C02B8C:
...
/* 80C02CCC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C02CD0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C02CD4  4B 74 37 DC */	b PSMTXCopy
/* 80C02CD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02CDC  3B 03 D4 70 */	addi r24, r3, now__14mDoMtx_stack_c@l
/* 80C02CE0  C0 18 00 0C */	lfs f0, 0xc(r24)	/* effective address: 803DD47C */
/* 80C02CE4  D0 01 00 A8 */	stfs f0, 0xa8(r1)
/* 80C02CE8  C0 18 00 1C */	lfs f0, 0x1c(r24)	/* effective address: 803DD48C */
/* 80C02CEC  D0 01 00 AC */	stfs f0, 0xac(r1)
/* 80C02CF0  C0 18 00 2C */	lfs f0, 0x2c(r24)	/* effective address: 803DD49C */
...
/* 80C02D10  4B 74 37 A0 */	b PSMTXCopy
...
/* 80C02D40  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C02D44  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C02D48  4B 74 37 68 */	b PSMTXCopy
...
/* 80C02D7C  4B 40 9F E8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C02D80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02D84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C02D88  A8 9F 09 1C */	lha r4, 0x91c(r31)
/* 80C02D8C  4B 40 96 A8 */	b mDoMtx_YrotM__FPA4_fs
/* 80C02D90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02D94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C02D98  38 81 00 6C */	addi r4, r1, 0x6c
/* 80C02D9C  38 A1 00 CC */	addi r5, r1, 0xcc
/* 80C02DA0  4B 74 3F CC */	b PSMTXMultVec
...
/* 80C02DC8  4B 54 AA 70 */	b getActor__18daBaseNpc_acMngr_cFv
...
/* 80C02DF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02DF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C02DF8  A8 9F 09 1C */	lha r4, 0x91c(r31)
/* 80C02DFC  4B 40 95 E0 */	b mDoMtx_YrotS__FPA4_fs
/* 80C02E00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C02E04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C02E08  38 81 00 60 */	addi r4, r1, 0x60
/* 80C02E0C  7C 85 23 78 */	mr r5, r4
/* 80C02E10  4B 74 3F 5C */	b PSMTXMultVec
/* 80C02E14  38 61 00 60 */	addi r3, r1, 0x60
/* 80C02E18  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C02E1C  7C 65 1B 78 */	mr r5, r3
/* 80C02E20  4B 74 42 70 */	b PSVECAdd
/* 80C02E24  3B 61 00 60 */	addi r27, r1, 0x60
lbl_80C02E28:
/* 80C02E28  38 7F 09 20 */	addi r3, r31, 0x920
/* 80C02E2C  7F 64 DB 78 */	mr r4, r27
/* 80C02E30  4B 54 B8 70 */	b setAttnPos__18daBaseNpc_lookat_cFP4cXyz
...
/* 80C02E68  4B 54 B7 CC */	b setMaxJntLmt__18daBaseNpc_lookat_cF5csXyzi
...
/* 80C02E8C  4B 54 B7 CC */	b setMinJntLmt__18daBaseNpc_lookat_cF5csXyzi
...
/* 80C02EBC  4B 54 B7 C0 */	b setJntPos__18daBaseNpc_lookat_cF4cXyzi
...
/* 80C02EE4  4B 54 AC D0 */	b calc__18daBaseNpc_lookat_cFP10fopAc_ac_cPA4_fs
...
/* 80C02F3C  4B 54 B7 70 */	b getRot__18daBaseNpc_lookat_cFi
...
/* 80C02FA8  4B 66 D6 60 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C02FBC  4B 54 B6 F0 */	b getRot__18daBaseNpc_lookat_cFi
...
/* 80C02FDC  4B 54 B6 D0 */	b getRot__18daBaseNpc_lookat_cFi
...
/* 80C02FF4  4B 54 B6 B8 */	b getRot__18daBaseNpc_lookat_cFi
...
/* 80C03078  4B 75 F1 98 */	b _restgpr_23

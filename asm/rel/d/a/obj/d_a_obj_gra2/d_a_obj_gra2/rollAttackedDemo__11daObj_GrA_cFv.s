...
/* 80C0AFA4  4B 75 72 30 */	b _savegpr_27
...
/* 80C0AFD4  4B 57 66 6C */	b dCam_getBody__Fv
...
/* 80C0AFE8  3C 60 80 C1 */	lis r3, lit_8960@ha
/* 80C0AFEC  38 63 03 00 */	addi r3, r3, lit_8960@l
...
/* 80C0B020  4B 41 08 E8 */	b fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80C0B038  4B 55 64 98 */	b Stop__9dCamera_cFv
...
/* 80C0B068  4B 57 6E 30 */	b Center__9dCamera_cFv
...
/* 80C0B0A4  4B 57 6D C0 */	b Eye__9dCamera_cFv
...
/* 80C0B10C  4B 41 07 FC */	b fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80C0B144  4B 57 6D 54 */	b Center__9dCamera_cFv
...
/* 80C0B180  4B 57 6C E4 */	b Eye__9dCamera_cFv
...
/* 80C0B1BC  4B 55 7E 50 */	b SetTrimSize__9dCamera_cFl
...
lbl_80C0B23C:
/* 80C0B23C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C0B240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C0B244  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C0B248  4B 40 11 94 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80C0B264  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C0B268  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C0B26C  38 81 01 04 */	addi r4, r1, 0x104
/* 80C0B270  7C 85 23 78 */	mr r5, r4
/* 80C0B274  4B 73 BA F8 */	b PSMTXMultVec
/* 80C0B278  38 61 01 04 */	addi r3, r1, 0x104
/* 80C0B27C  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C0B280  7C 65 1B 78 */	mr r5, r3
/* 80C0B284  4B 73 BE 0C */	b PSVECAdd
...
/* 80C0B2B8  4B 65 B8 7C */	b __mi__4cXyzCFRC3Vec
/* 80C0B2BC  38 61 00 74 */	addi r3, r1, 0x74
/* 80C0B2C0  4B 73 BE 78 */	b PSVECSquareMag
...
/* 80C0B330  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B334  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B3A0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B3A4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B3C4  4B 66 4D B4 */	b cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 80C0B43C  4B 66 57 C8 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
lbl_80C0B464:
/* 80C0B464  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C0B468  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C0B46C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C0B470  4B 40 0F 6C */	b mDoMtx_YrotS__FPA4_fs
...
/* 80C0B48C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C0B490  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C0B494  38 81 00 EC */	addi r4, r1, 0xec
/* 80C0B498  7C 85 23 78 */	mr r5, r4
/* 80C0B49C  4B 73 B8 D0 */	b PSMTXMultVec
/* 80C0B4A0  38 61 00 EC */	addi r3, r1, 0xec
/* 80C0B4A4  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C0B4A8  7C 65 1B 78 */	mr r5, r3
/* 80C0B4AC  4B 73 BB E4 */	b PSVECAdd
...
/* 80C0B4E0  4B 65 B6 54 */	b __mi__4cXyzCFRC3Vec
/* 80C0B4E4  38 61 00 68 */	addi r3, r1, 0x68
/* 80C0B4E8  4B 73 BC 50 */	b PSVECSquareMag
...
/* 80C0B558  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B55C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B5C8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B5CC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B5EC  4B 66 4B 8C */	b cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
lbl_80C0B60C:
/* 80C0B60C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C0B610  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C0B614  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C0B618  4B 40 0D C4 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80C0B6DC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B6E0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B74C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B750  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B770  4B 66 4A 08 */	b cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 80C0B7A4  4B 65 B3 90 */	b __mi__4cXyzCFRC3Vec
/* 80C0B7A8  38 61 00 50 */	addi r3, r1, 0x50
/* 80C0B7AC  4B 73 B9 8C */	b PSVECSquareMag
...
/* 80C0B81C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B820  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B88C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C0B890  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C0B8B0  4B 66 48 C8 */	b cLib_addCalcPos2__FP4cXyzRC4cXyzff
...
/* 80C0B8FC  4B 57 52 A4 */	b Reset__9dCamera_cF4cXyz4cXyzfs
/* 80C0B900  38 7D 02 48 */	addi r3, r29, 0x248
/* 80C0B904  4B 55 5B A8 */	b Start__9dCamera_cFv
...
/* 80C0B984  4B 57 51 5C */	b Set__9dCamera_cF4cXyz4cXyzfs
...
/* 80C0B998  4B 75 68 88 */	b _restgpr_27

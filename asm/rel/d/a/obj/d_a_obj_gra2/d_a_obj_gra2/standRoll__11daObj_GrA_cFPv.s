...
/* 80C07D50  4B 75 A4 88 */	b _savegpr_28
/* 80C07D54  7C 7C 1B 78 */	mr r28, r3
/* 80C07D58  3C 80 80 C1 */	lis r4, m__17daObj_GrA_Param_c@ha
/* 80C07D5C  3B C4 FA 7C */	addi r30, r4, m__17daObj_GrA_Param_c@l
/* 80C07D60  3C 80 80 C1 */	lis r4, cNullVec__6Z2Calc@ha
/* 80C07D64  3B E4 FE 68 */	addi r31, r4, cNullVec__6Z2Calc@l
/* 80C07D68  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C07D6C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C07D70  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 80C07DF0  4B 41 1E 8C */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 80C07E1C  3C 60 80 C0 */	lis r3, s_sub__FPvPv@ha
/* 80C07E20  38 63 36 B4 */	addi r3, r3, s_sub__FPvPv@l
/* 80C07E24  7F 84 E3 78 */	mr r4, r28
/* 80C07E28  4B 41 95 10 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 80C07E78  4B 41 1E 04 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 80C07EAC  4B 65 EC 88 */	b __mi__4cXyzCFRC3Vec
...
/* 80C07ED8  4B 73 F2 60 */	b PSVECSquareMag
...
/* 80C07F48  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C07F4C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C07FB8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C07FBC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C08010  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C08014  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C08018  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 80C08048  3C 60 80 45 */	lis r3, g_dComIfGoat_gameInfo@ha
/* 80C0804C  93 83 06 18 */	stw r28, g_dComIfGoat_gameInfo@l(r3)
...
/* 80C08060  4B 65 EA D4 */	b __mi__4cXyzCFRC3Vec
...
/* 80C08090  4B 73 F0 A8 */	b PSVECSquareMag
...
/* 80C08100  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C08104  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C08170  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C08174  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C08178:
...
/* 80C081D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C081DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C081E0  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 80C08210  3C 60 80 45 */	lis r3, g_dComIfGoat_gameInfo@ha
/* 80C08214  93 83 06 18 */	stw r28, g_dComIfGoat_gameInfo@l(r3)
...
/* 80C08228  4B 65 E9 0C */	b __mi__4cXyzCFRC3Vec
...
/* 80C08254  4B 73 EE E4 */	b PSVECSquareMag
...
/* 80C082C4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C082C8  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C08334  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C08338  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C0838C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C08390  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C08394  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 80C083C4  3C 60 80 45 */	lis r3, g_dComIfGoat_gameInfo@ha
/* 80C083C8  93 83 06 18 */	stw r28, g_dComIfGoat_gameInfo@l(r3)
lbl_80C083CC:
...
/* 80C083DC  4B 75 9E 48 */	b _restgpr_28

...
/* 80C0CA7C 00000018  3C 60 00 00 */	lis r3, m__17daObj_GrA_Param_c@ha /* 80C0FA7C */
/* 80C0CA80 0000001C  3B E3 00 00 */	addi r31, r3, m__17daObj_GrA_Param_c@l /* 80C0FA7C */
...
/* 80C0CAA0 0000003C  4B FF 33 D9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C0CAB8 00000054  C0 1F 01 1C */	lfs f0, 0x11c(r31)
/* 80C0CABC 00000058  D0 01 00 58 */	stfs f0, 0x58(r1)
/* 80C0CAC0 0000005C  D0 01 00 5C */	stfs f0, 0x5c(r1)
/* 80C0CAC4 00000060  C0 1F 02 10 */	lfs f0, 0x210(r31)
/* 80C0CAC8 00000064  D0 01 00 60 */	stfs f0, 0x60(r1)
/* 80C0CACC 00000068  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C0CAD0 0000006C  4B FF 33 A9 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C0CAD4 00000070  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C0CAD8 00000074  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C0CADC 00000078  A8 9E 09 1C */	lha r4, 0x91c(r30)
/* 80C0CAE0 0000007C  4B FF 33 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C0CAE4 00000080  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C0CAE8 00000084  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C0CAEC 00000088  38 81 00 58 */	addi r4, r1, 0x58
/* 80C0CAF0 0000008C  38 BE 0B 74 */	addi r5, r30, 0xb74
/* 80C0CAF4 00000090  4B FF 33 85 */	bl PSMTXMultVec
...
/* 80C0CB50 000000EC  C0 3F 01 1C */	lfs f1, 0x11c(r31)
/* 80C0CB54 000000F0  D0 21 00 40 */	stfs f1, 0x40(r1)
/* 80C0CB58 000000F4  C0 1F 01 18 */	lfs f0, 0x118(r31)
/* 80C0CB5C 000000F8  D0 01 00 44 */	stfs f0, 0x44(r1)
/* 80C0CB60 000000FC  D0 21 00 48 */	stfs f1, 0x48(r1)
/* 80C0CB64 00000100  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C0CB68 00000104  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C0CB7C 00000118  4B FF 32 FD */	bl StartShock__12dVibration_cFii4cXyz
/* 80C0CB80 0000011C  C0 1F 01 1C */	lfs f0, 0x11c(r31)
/* 80C0CB84 00000120  D0 1E 04 FC */	stfs f0, 0x4fc(r30)
/* 80C0CB88 00000124  3C 60 00 00 */	lis r3, lit_9393@ha /* 80C1035C */
/* 80C0CB8C 00000128  38 83 00 00 */	addi r4, r3, lit_9393@l /* 80C1035C */
/* 80C0CB90 0000012C  80 64 00 00 */	lwz r3, 0(r4)
/* 80C0CB94 00000130  80 04 00 04 */	lwz r0, 4(r4)
/* 80C0CB98 00000134  90 61 00 34 */	stw r3, 0x34(r1)
/* 80C0CB9C 00000138  90 01 00 38 */	stw r0, 0x38(r1)
/* 80C0CBA0 0000013C  80 04 00 08 */	lwz r0, 8(r4)
...
/* 80C0CBBC 00000158  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C0CBC0 0000015C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C0CBC4 00000160  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80C0CBC8 00000164  88 03 05 6A */	lbz r0, 0x56a(r3)
...
/* 80C0CBD8 00000174  98 03 05 6A */	stb r0, 0x56a(r3)
lbl_80C0CBDC:
/* 80C0CBDC 00000000  38 00 00 00 */	li r0, 0
/* 80C0CBE0 00000004  98 1E 20 04 */	stb r0, 0x2004(r30)
/* 80C0CBE4 00000008  C0 1F 03 14 */	lfs f0, 0x314(r31)
/* 80C0CBE8 0000000C  D0 1E 05 30 */	stfs f0, 0x530(r30)
/* 80C0CBEC 00000010  48 00 01 B8 */	b lbl_80C0CDA4
lbl_80C0CBF0:
/* 80C0CBF0 00000000  C0 3F 01 1C */	lfs f1, 0x11c(r31)
/* 80C0CBF4 00000004  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 80C0CBF8 00000008  C0 1F 01 18 */	lfs f0, 0x118(r31)
/* 80C0CBFC 0000000C  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 80C0CC00 00000010  D0 21 00 30 */	stfs f1, 0x30(r1)
/* 80C0CC04 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C0CC08 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C0CC1C 0000002C  4B FF 32 5D */	bl StartShock__12dVibration_cFii4cXyz
/* 80C0CC20 00000030  C0 1F 02 1C */	lfs f0, 0x21c(r31)
...
/* 80C0CC38 00000048  C8 3F 01 30 */	lfd f1, 0x130(r31)
...
/* 80C0CC64 00000074  C0 1F 03 18 */	lfs f0, 0x318(r31)
...
/* 80C0CC7C 00000008  C0 1F 01 1C */	lfs f0, 0x11c(r31)
/* 80C0CC80 0000000C  D0 01 00 4C */	stfs f0, 0x4c(r1)
/* 80C0CC84 00000010  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 80C0CC88 00000014  C0 1F 02 10 */	lfs f0, 0x210(r31)
/* 80C0CC8C 00000018  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 80C0CC90 0000001C  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C0CC94 00000020  4B FF 31 E5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80C0CC98 00000024  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C0CC9C 00000028  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C0CCA0 0000002C  A8 9E 09 1C */	lha r4, 0x91c(r30)
/* 80C0CCA4 00000030  4B FF 31 D5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C0CCA8 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C0CCAC 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C0CCB0 0000003C  38 81 00 4C */	addi r4, r1, 0x4c
/* 80C0CCB4 00000040  38 BE 0B 74 */	addi r5, r30, 0xb74
/* 80C0CCB8 00000044  4B FF 31 C1 */	bl PSMTXMultVec
...
/* 80C0CD08 00000094  C0 3F 01 1C */	lfs f1, 0x11c(r31)
/* 80C0CD0C 00000098  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C0CD10 0000009C  C0 1F 01 18 */	lfs f0, 0x118(r31)
/* 80C0CD14 000000A0  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80C0CD18 000000A4  D0 21 00 24 */	stfs f1, 0x24(r1)
/* 80C0CD1C 000000A8  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C0CD20 000000AC  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C0CD34 000000C0  4B FF 31 45 */	bl StartShock__12dVibration_cFii4cXyz
/* 80C0CD38 000000C4  C0 1F 01 1C */	lfs f0, 0x11c(r31)
/* 80C0CD3C 000000C8  D0 1E 04 FC */	stfs f0, 0x4fc(r30)
/* 80C0CD40 000000CC  3C 60 00 00 */	lis r3, lit_9399@ha /* 80C10368 */
/* 80C0CD44 000000D0  38 83 00 00 */	addi r4, r3, lit_9399@l /* 80C10368 */
/* 80C0CD48 000000D4  80 64 00 00 */	lwz r3, 0(r4)
/* 80C0CD4C 000000D8  80 04 00 04 */	lwz r0, 4(r4)
/* 80C0CD50 000000DC  90 61 00 10 */	stw r3, 0x10(r1)
/* 80C0CD54 000000E0  90 01 00 14 */	stw r0, 0x14(r1)
/* 80C0CD58 000000E4  80 04 00 08 */	lwz r0, 8(r4)
...
/* 80C0CD74 00000100  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C0CD78 00000104  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C0CD7C 00000108  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80C0CD80 0000010C  88 03 05 6A */	lbz r0, 0x56a(r3)
...
/* 80C0CD90 0000011C  98 03 05 6A */	stb r0, 0x56a(r3)
lbl_80C0CD94:
/* 80C0CD94 00000000  38 00 00 00 */	li r0, 0
/* 80C0CD98 00000004  98 1E 20 04 */	stb r0, 0x2004(r30)
/* 80C0CD9C 00000008  C0 1F 03 14 */	lfs f0, 0x314(r31)

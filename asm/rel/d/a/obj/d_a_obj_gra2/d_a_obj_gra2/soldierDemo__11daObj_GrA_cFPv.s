...
/* 80C078B8 00000010  4B 75 A9 24 */	b _savegpr_29
/* 80C078BC 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C078C0 00000018  3C 80 80 C1 */	lis r4, m__17daObj_GrA_Param_c@ha
/* 80C078C4 0000001C  3B E4 FA 7C */	addi r31, r4, m__17daObj_GrA_Param_c@l
...
/* 80C078F8 00000008  C0 25 00 0C */	lfs f1, 0xc(r5)	/* effective address: 80C0FA88 */
...
/* 80C07908 00000018  C0 3F 01 38 */	lfs f1, 0x138(r31)	/* effective address: 80C0FBB4 */
...
/* 80C0796C 00000014  C0 3D 00 0C */	lfs f1, 0xc(r29)	/* effective address: 80C0FA88 */
/* 80C07970 00000018  C0 1F 02 24 */	lfs f0, 0x224(r31)	/* effective address: 80C0FCA0 */
...
/* 80C07984 0000002C  C0 3D 00 0C */	lfs f1, 0xc(r29)	/* effective address: 80C0FA88 */
/* 80C07988 00000030  C0 1F 02 24 */	lfs f0, 0x224(r31)	/* effective address: 80C0FCA0 */
...
/* 80C079B8 00000014  C0 3F 01 1C */	lfs f1, 0x11c(r31)	/* effective address: 80C0FB98 */
...
/* 80C079E4 00000004  C0 3F 02 A4 */	lfs f1, 0x2a4(r31)	/* effective address: 80C0FD20 */
/* 80C079E8 00000008  4B 72 0A 44 */	b checkPass__12J3DFrameCtrlFf
/* 80C079EC 0000000C  2C 03 00 00 */	cmpwi r3, 0
/* 80C079F0 00000010  41 82 02 34 */	beq lbl_80C07C24
/* 80C079F4 00000014  C0 1F 01 1C */	lfs f0, 0x11c(r31)	/* effective address: 80C0FB98 */
/* 80C079F8 00000018  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80C079FC 0000001C  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80C07A00 00000020  C0 1F 02 10 */	lfs f0, 0x210(r31)	/* effective address: 80C0FC8C */
/* 80C07A04 00000024  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80C07A08 00000028  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C07A0C 0000002C  4B 40 53 58 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C07A10 00000030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C07A14 00000034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C07A18 00000038  A8 9E 09 1C */	lha r4, 0x91c(r30)
/* 80C07A1C 0000003C  4B 40 4A 18 */	b mDoMtx_YrotM__FPA4_fs
/* 80C07A20 00000040  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C07A24 00000044  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C07A28 00000048  38 81 00 18 */	addi r4, r1, 0x18
/* 80C07A2C 0000004C  38 BE 0B 74 */	addi r5, r30, 0xb74
/* 80C07A30 00000050  4B 73 F3 3C */	b PSMTXMultVec
...
/* 80C07A64 0000000C  C0 1F 01 1C */	lfs f0, 0x11c(r31)	/* effective address: 80C0FB98 */
/* 80C07A68 00000010  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80C07A6C 00000014  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80C07A70 00000018  C0 1F 02 10 */	lfs f0, 0x210(r31)	/* effective address: 80C0FC8C */
/* 80C07A74 0000001C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80C07A78 00000020  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C07A7C 00000024  4B 40 52 E8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C07A80 00000028  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C07A84 0000002C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C07A88 00000030  A8 9E 09 1C */	lha r4, 0x91c(r30)
/* 80C07A8C 00000034  4B 40 49 A8 */	b mDoMtx_YrotM__FPA4_fs
/* 80C07A90 00000038  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C07A94 0000003C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C07A98 00000040  38 81 00 0C */	addi r4, r1, 0xc
/* 80C07A9C 00000044  38 BE 0C 2C */	addi r5, r30, 0xc2c
/* 80C07AA0 00000048  4B 73 F2 CC */	b PSMTXMultVec
...
/* 80C07B10 000000B8  C0 3F 01 1C */	lfs f1, 0x11c(r31)	/* effective address: 80C0FB98 */
...
/* 80C07B20 000000C8  C0 3F 01 1C */	lfs f1, 0x11c(r31)	/* effective address: 80C0FB98 */
/* 80C07B24 000000CC  4B FF 9C 89 */	bl setFaceMotion__11daObj_GrA_cFif
/* 80C07B28 000000D0  C0 1F 01 18 */	lfs f0, 0x118(r31)	/* effective address: 80C0FB94 */
...
/* 80C07B6C 00000014  C0 3F 01 1C */	lfs f1, 0x11c(r31)	/* effective address: 80C0FB98 */
...
/* 80C07BAC 0000002C  C0 25 00 0C */	lfs f1, 0xc(r5)	/* effective address: 80C0FA88 */
...
/* 80C07BBC 0000003C  C0 3F 01 38 */	lfs f1, 0x138(r31)	/* effective address: 80C0FBB4 */
...
/* 80C07BCC 00000004  C0 3F 02 90 */	lfs f1, 0x290(r31)	/* effective address: 80C0FD0C */
/* 80C07BD0 00000008  4B 72 08 5C */	b checkPass__12J3DFrameCtrlFf
...
/* 80C07C2C 00000008  4B 75 A5 FC */	b _restgpr_29

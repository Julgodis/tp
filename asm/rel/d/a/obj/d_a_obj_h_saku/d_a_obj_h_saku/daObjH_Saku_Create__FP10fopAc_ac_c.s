...
/* 80C15FD4  4B 74 C2 08 */	b _savegpr_29
/* 80C15FD8  3C 80 80 C1 */	lis r4, lit_3703@ha
/* 80C15FDC  3B E4 64 C8 */	addi r31, r4, lit_3703@l
...
/* 80C15FFC  4B 46 26 28 */	b __ct__16dBgS_MoveBgActorFv
/* 80C16000  3C 60 80 C1 */	lis r3, __vt__13daObjH_Saku_c@ha
/* 80C16004  38 03 65 B8 */	addi r0, r3, __vt__13daObjH_Saku_c@l
/* 80C16008  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80C1600C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C16010  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C16014  90 1D 06 04 */	stw r0, 0x604(r29)
/* 80C16018  38 7D 06 08 */	addi r3, r29, 0x608
/* 80C1601C  4B 46 D7 44 */	b __ct__10dCcD_GSttsFv
/* 80C16020  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C16024  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C16038  4B 45 FE 74 */	b __ct__12dBgS_AcchCirFv
/* 80C1603C  3B BD 06 78 */	addi r29, r29, 0x678
/* 80C16040  7F A3 EB 78 */	mr r3, r29
/* 80C16044  4B 46 00 5C */	b __ct__9dBgS_AcchFv
/* 80C16048  3C 60 80 C1 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C1604C  38 63 65 94 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80C16068  4B 46 2E 00 */	b SetObj__16dBgS_PolyPassChkFv
lbl_80C1606C:
...
/* 80C1607C  3C 80 80 C1 */	lis r4, l_arcName@ha
/* 80C16080  38 84 65 40 */	addi r4, r4, l_arcName@l
/* 80C16084  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80C16540 */
/* 80C16088  4B 41 6E 34 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80C1608C  7C 7D 1B 78 */	mr r29, r3
/* 80C16090  2C 1D 00 04 */	cmpwi r29, 4
/* 80C16094  40 82 00 68 */	bne lbl_80C160FC
/* 80C16098  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C1609C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C160A0  3C 63 00 02 */	addis r3, r3, 2
/* 80C160A4  3C 80 80 C1 */	lis r4, l_arcName@ha
/* 80C160A8  38 84 65 40 */	addi r4, r4, l_arcName@l
/* 80C160AC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80C16540 */
/* 80C160B0  3C A0 80 C1 */	lis r5, stringBase0@ha
/* 80C160B4  38 A5 65 20 */	addi r5, r5, stringBase0@l
/* 80C160B8  38 A5 00 07 */	addi r5, r5, 7
/* 80C160BC  38 63 C2 F8 */	addi r3, r3, -15624
/* 80C160C0  4B 42 65 F8 */	b getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80C160C4  7C 65 1B 78 */	mr r5, r3
/* 80C160C8  7F C3 F3 78 */	mr r3, r30
/* 80C160CC  3C 80 80 C1 */	lis r4, l_arcName@ha
/* 80C160D0  38 84 65 40 */	addi r4, r4, l_arcName@l
/* 80C160D4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80C16540 */
/* 80C160D8  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C160DC  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C160E0  38 E0 13 20 */	li r7, 0x1320
/* 80C160E4  39 00 00 00 */	li r8, 0
/* 80C160E8  4B 46 26 D4 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C16134  4B 65 AC 8C */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80C16158  4B 65 AC 68 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
lbl_80C1615C:
/* 80C1615C  7F A3 EB 78 */	mr r3, r29
/* 80C16160  39 61 00 30 */	addi r11, r1, 0x30
/* 80C16164  4B 74 C0 C4 */	b _restgpr_29

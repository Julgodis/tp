...
/* 80BE3C3C  3C 60 80 BE */	lis r3, l_arcName@ha
/* 80BE3C40  38 63 4B 20 */	addi r3, r3, l_arcName@l
/* 80BE3C44  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BE4B20 */
/* 80BE3C48  38 80 00 04 */	li r4, 4
/* 80BE3C4C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80BE3C50  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80BE3C54  3C A5 00 02 */	addis r5, r5, 2
/* 80BE3C58  38 C0 00 80 */	li r6, 0x80
/* 80BE3C5C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BE3C60  4B 45 86 8C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BE3C70  4B 43 0F E4 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

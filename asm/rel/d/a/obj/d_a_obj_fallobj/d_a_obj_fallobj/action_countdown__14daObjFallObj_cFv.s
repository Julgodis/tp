...
/* 80BE441C  C8 23 4B 00 */	lfd f1, lit_3930@l(r3)
...
/* 80BE4440  3C 60 80 BE */	lis r3, lit_3707@ha
/* 80BE4444  C0 03 4A C4 */	lfs f0, lit_3707@l(r3)
...
/* 80BE44B0  3C 60 80 BE */	lis r3, lit_3677@ha
/* 80BE44B4  C0 03 4A B0 */	lfs f0, lit_3677@l(r3)
/* 80BE44B8  D0 1E 04 FC */	stfs f0, 0x4fc(r30)
/* 80BE44BC  38 00 00 02 */	li r0, 2
/* 80BE44C0  98 1E 05 F0 */	stb r0, 0x5f0(r30)
lbl_80BE44C4:
/* 80BE44C4  3C 60 80 BE */	lis r3, lit_3677@ha
/* 80BE44C8  C0 23 4A B0 */	lfs f1, lit_3677@l(r3)
...
/* 80BE44F8  4B 68 C1 D8 */	b cLib_chaseS__FPsss
/* 80BE44FC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80BE4500  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80BE451C  3C 60 80 BE */	lis r3, lit_3930@ha
/* 80BE4520  C8 23 4B 00 */	lfd f1, lit_3930@l(r3)
...
/* 80BE45A0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80BE45A4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80BE45A8  38 81 00 08 */	addi r4, r1, 8
/* 80BE45AC  4B 43 52 4C */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 80BE45B0  28 03 00 00 */	cmplwi r3, 0
/* 80BE45B4  41 82 00 20 */	beq lbl_80BE45D4
/* 80BE45B8  3C 80 80 BE */	lis r4, lit_3677@ha
/* 80BE45BC  C0 24 4A B0 */	lfs f1, lit_3677@l(r4)

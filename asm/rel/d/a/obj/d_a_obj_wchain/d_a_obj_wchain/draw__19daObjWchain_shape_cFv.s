...
/* 80D31438  4B 63 0D 80 */	b _savegpr_20
/* 80D3143C  3C 80 80 D3 */	lis r4, l_arcName@ha
/* 80D31440  3B E4 19 24 */	addi r31, r4, l_arcName@l
...
/* 80D314A8  4B 5E 3E 58 */	b loadPreDrawSetting__8J3DShapeCFv
...
/* 80D314DC  4B 62 C4 84 */	b GXSetChanAmbColor
/* 80D314E0  3C 60 80 45 */	lis r3, g_whiteColor@ha
/* 80D314E4  80 03 06 08 */	lwz r0, g_whiteColor@l(r3)
/* 80D314E8  90 01 00 0C */	stw r0, 0xc(r1)
/* 80D314EC  38 60 00 04 */	li r3, 4
/* 80D314F0  38 81 00 0C */	addi r4, r1, 0xc
/* 80D314F4  4B 62 C5 54 */	b GXSetChanMatColor
/* 80D314F8  4B 47 60 C8 */	b dKy_setLight_again__Fv
/* 80D314FC  7F 23 CB 78 */	mr r3, r25
/* 80D31500  4B 47 71 50 */	b dKy_GxFog_tevstr_set__FP12dKy_tevstr_c
/* 80D31504  38 79 00 34 */	addi r3, r25, 0x34
/* 80D31508  38 80 00 01 */	li r4, 1
/* 80D3150C  4B 62 C3 D8 */	b GXLoadLightObjImm
/* 80D31510  3A 80 00 00 */	li r20, 0
/* 80D31514  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80D31518  3A A3 4A C8 */	addi r21, r3, j3dSys@l
/* 80D3151C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D31520  3A C3 D4 70 */	addi r22, r3, now__14mDoMtx_stack_c@l
...
/* 80D31538  4B 61 4F 78 */	b PSMTXCopy
/* 80D3153C  7F 83 E3 78 */	mr r3, r28
/* 80D31540  4B 2D B8 94 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80D31544  7E C3 B3 78 */	mr r3, r22
/* 80D31548  A8 9A 00 00 */	lha r4, 0(r26)
/* 80D3154C  4B 2D AF 80 */	b mDoMtx_ZrotM__FPA4_fs
...
/* 80D315DC  4B 53 55 58 */	b __mi__4cXyzCFRC3Vec
...
/* 80D315FC  4B 61 5B 3C */	b PSVECSquareMag
...
/* 80D3166C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D31670  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80D316DC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D316E0  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80D31718  4B 53 5A 38 */	b atan2sY_XZ__4cXyzCFv
...
/* 80D31734  4B 53 5C C0 */	b __ct__5csXyzFsss
...
/* 80D31748  4B 61 59 90 */	b PSVECScale
/* 80D3174C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80D31750  3B 63 4A C8 */	addi r27, r3, j3dSys@l
/* 80D31754  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D31758  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l
...
/* 80D317D0  4B 61 58 C0 */	b PSVECAdd
...
/* 80D317FC  4B 63 0A 08 */	b _restgpr_20

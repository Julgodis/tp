...
/* 80C212EC 0000000C  3C 80 00 00 */	lis r4, lit_3644@ha
/* 80C212F0 00000010  3B E4 00 00 */	addi r31, r4, lit_3644@l
...
/* 80C21310 00000030  3C 60 00 00 */	lis r3, __vt__12daObjIce_s_c@ha
/* 80C21314 00000034  38 03 00 00 */	addi r0, r3, __vt__12daObjIce_s_c@l
/* 80C21318 00000038  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C2131C 0000003C  3C 60 00 00 */	lis r3, __vt__9cCcD_Stts@ha
/* 80C21320 00000040  38 03 00 00 */	addi r0, r3, __vt__9cCcD_Stts@l
...
/* 80C21330 00000050  3C 60 00 00 */	lis r3, __vt__9dCcD_Stts@ha
/* 80C21334 00000054  38 63 00 00 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C21354 00000004  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80C21358 00000008  38 84 00 00 */	addi r4, r4, l_arcName@l
...
/* 80C21370 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C21374 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C21378 00000028  3C 63 00 02 */	addis r3, r3, 2
/* 80C2137C 0000002C  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80C21380 00000030  38 84 00 00 */	addi r4, r4, l_arcName@l
/* 80C21384 00000034  80 84 00 00 */	lwz r4, 0(r4)
/* 80C21388 00000038  3C A0 00 00 */	lis r5, stringBase0@ha
/* 80C2138C 0000003C  38 A5 00 00 */	addi r5, r5, stringBase0@l
...
/* 80C213A4 00000054  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80C213A8 00000058  38 84 00 00 */	addi r4, r4, l_arcName@l
/* 80C213AC 0000005C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C213B0 00000060  3C C0 00 00 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C213B4 00000064  38 C6 00 00 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
...
lbl_80C213D4:
/* 80C213D4 00000000  3C 60 00 00 */	lis r3, data_80C21C54@ha
/* 80C213D8 00000004  8C 03 00 00 */	lbzu r0, data_80C21C54@l(r3)
...
/* 80C213F4 00000020  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80C213F8 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 80C21428 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C2142C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l

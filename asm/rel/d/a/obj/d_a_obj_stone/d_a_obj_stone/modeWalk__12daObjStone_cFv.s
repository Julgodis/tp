...
/* 80CEB738 00000018  3C 80 00 00 */	lis r4, l_bmdIdx@ha
/* 80CEB73C 0000001C  3B E4 00 00 */	addi r31, r4, l_bmdIdx@l
...
/* 80CEB7AC 00000014  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80CEB7B0 00000018  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80CEB8B8 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CEB8BC 00000008  C0 83 00 00 */	lfs f4, __float_nan@l(r3)
...
/* 80CEB928 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CEB92C 0000000C  C0 83 00 00 */	lfs f4, __float_nan@l(r3)
lbl_80CEB930:
...
/* 80CEB988 00000030  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CEB98C 00000034  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80CEB9A0 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CEB9A4 0000004C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CEB9A8 00000050  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CEB9AC 00000054  3C 80 00 00 */	lis r4, mGndCheck__11fopAcM_gc_c@ha
/* 80CEB9B0 00000058  38 84 00 00 */	addi r4, r4, mGndCheck__11fopAcM_gc_c@l
...
/* 80CEB9C0 00000068  3C 80 00 00 */	lis r4, mGroundY__11fopAcM_gc_c@ha
/* 80CEB9C4 0000006C  C0 24 00 00 */	lfs f1, mGroundY__11fopAcM_gc_c@l(r4)
...
/* 80CEB9F4 0000009C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80CEB9F8 000000A0  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80CEBA88 00000014  3C 80 00 00 */	lis r4, sincosTable___5JMath@ha
/* 80CEBA8C 00000018  38 84 00 00 */	addi r4, r4, sincosTable___5JMath@l
...
/* 80CEBB58 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CEBB5C 00000008  C0 83 00 00 */	lfs f4, __float_nan@l(r3)
...
/* 80CEBBC8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CEBBCC 0000000C  C0 83 00 00 */	lfs f4, __float_nan@l(r3)
lbl_80CEBBD0:
...
lbl_80CEBCB8:
/* 80CEBCB8 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CEBCBC 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l

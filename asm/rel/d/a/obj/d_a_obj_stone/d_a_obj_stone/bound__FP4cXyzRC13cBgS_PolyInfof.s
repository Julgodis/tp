...
/* 80CE90A4 00000010  3C 60 00 00 */	lis r3, l_bmdIdx@ha
/* 80CE90A8 00000014  3B C3 00 00 */	addi r30, r3, l_bmdIdx@l
/* 80CE90AC 00000018  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CE90B0 0000001C  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CE90B4 00000020  90 01 00 50 */	stw r0, 0x50(r1)
/* 80CE90B8 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CE90BC 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CE9148 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CE914C 00000008  C3 C3 00 00 */	lfs f30, __float_nan@l(r3)
...
/* 80CE91B8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CE91BC 0000000C  C3 C3 00 00 */	lfs f30, __float_nan@l(r3)
...
/* 80CE929C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CE92A0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80CE930C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80CE9310 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80CE9314:
/* 80CE9314 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CE9318 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CE931C 00000008  90 01 00 50 */	stw r0, 0x50(r1)
/* 80CE9320 0000000C  48 00 00 14 */	b lbl_80CE9334
lbl_80CE9324:
/* 80CE9324 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CE9328 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l

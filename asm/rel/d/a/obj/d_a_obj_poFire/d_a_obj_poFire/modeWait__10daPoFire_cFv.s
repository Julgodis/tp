...
/* 80CB3214 00000018  3C 80 00 00 */	lis r4, lit_3662@ha /* 80CB3EEC */
/* 80CB3218 0000001C  3B C4 00 00 */	addi r30, r4, lit_3662@l /* 80CB3EEC */
...
lbl_80CB3230:
/* 80CB3230 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80CB3234 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80CB324C 0000001C  3C C0 00 00 */	lis r6, l_HIO@ha /* 80CB4114 */
/* 80CB3250 00000020  38 C6 00 00 */	addi r6, r6, l_HIO@l /* 80CB4114 */
/* 80CB3254 00000024  C0 26 00 2C */	lfs f1, 0x2c(r6)
/* 80CB3258 00000028  C0 5E 00 2C */	lfs f2, 0x2c(r30)
/* 80CB325C 0000002C  C0 7E 00 38 */	lfs f3, 0x38(r30)
/* 80CB3260 00000030  38 C0 50 00 */	li r6, 0x5000
/* 80CB3264 00000034  38 E0 00 01 */	li r7, 1
/* 80CB3268 00000038  4B FF F6 51 */	bl request__11dAttCatch_cFP10fopAc_ac_cUcfffsi
...
lbl_80CB3278:
/* 80CB3278 00000000  C0 5E 00 3C */	lfs f2, 0x3c(r30)
/* 80CB327C 00000004  C0 3F 05 D8 */	lfs f1, 0x5d8(r31)
/* 80CB3280 00000008  3C 60 00 00 */	lis r3, l_HIO@ha /* 80CB4114 */
/* 80CB3284 0000000C  38 83 00 00 */	addi r4, r3, l_HIO@l /* 80CB4114 */
/* 80CB3288 00000010  C0 04 00 08 */	lfs f0, 8(r4)
...
/* 80CB32A4 0000002C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80CB32A8 00000030  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
/* 80CB32AC 00000034  7C 43 04 2E */	lfsx f2, r3, r0
/* 80CB32B0 00000038  C0 3F 05 D4 */	lfs f1, 0x5d4(r31)
/* 80CB32B4 0000003C  C0 04 00 0C */	lfs f0, 0xc(r4)
...
/* 80CB32C8 00000050  C0 04 00 10 */	lfs f0, 0x10(r4)

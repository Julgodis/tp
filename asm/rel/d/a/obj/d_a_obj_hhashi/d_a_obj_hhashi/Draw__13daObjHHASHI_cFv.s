...
/* 805812CC  4B DE 0F 08 */	b _savegpr_27
/* 805812D0  7C 7E 1B 78 */	mr r30, r3
/* 805812D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805812D8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805812DC  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 805812E0  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80581314  3C 60 80 58 */	lis r3, lit_3923@ha
/* 80581318  C0 03 15 20 */	lfs f0, lit_3923@l(r3)
...
lbl_8058132C:
/* 8058132C  3C 60 80 58 */	lis r3, lit_4485@ha
/* 80581330  C0 03 15 A8 */	lfs f0, lit_4485@l(r3)
...
lbl_80581344:
/* 80581344  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80581348  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8058134C  38 80 00 10 */	li r4, 0x10
/* 80581350  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80581354  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80581358  4B C2 24 6C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8058135C  80 1E 05 A4 */	lwz r0, 0x5a4(r30)
/* 80581360  2C 00 00 00 */	cmpwi r0, 0
/* 80581364  40 82 00 1C */	bne lbl_80581380
/* 80581368  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8058136C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80581370  80 9E 0F 4C */	lwz r4, 0xf4c(r30)
/* 80581374  80 84 00 04 */	lwz r4, 4(r4)
/* 80581378  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8058137C  4B C2 3A 24 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_80581380:
/* 80581380  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80581384  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80581388  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 8058138C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80581390  38 63 4A C8 */	addi r3, r3, j3dSys@l
/* 80581394  90 03 00 48 */	stw r0, 0x48(r3)	/* effective address: 80434B10 */
/* 80581398  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 8058139C  90 03 00 4C */	stw r0, 0x4c(r3)	/* effective address: 80434B14 */
...
/* 805813B0  4B A8 C9 14 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 805813DC  4B AA B7 8C */	b entrySimpleModel__14dComIfG_play_cFP8J3DModeli
...
/* 805813F8  4B DE 0E 28 */	b _restgpr_27

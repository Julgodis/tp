...
/* 80C9B8E4  3C 60 80 CA */	lis r3, lit_3863@ha
/* 80C9B8E8  3B E3 CD 4C */	addi r31, r3, lit_3863@l
/* 80C9B8EC  C0 3F 00 28 */	lfs f1, 0x28(r31)	/* effective address: 80C9CD74 */
...
/* 80C9B910  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C9B914  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 80C9B918  7C 43 04 2E */	lfsx f2, r3, r0
/* 80C9B91C  38 7E 04 D4 */	addi r3, r30, 0x4d4
/* 80C9B920  C0 3E 05 8C */	lfs f1, 0x58c(r30)
/* 80C9B924  3C 80 80 CA */	lis r4, l_HIO@ha
/* 80C9B928  38 84 CE B4 */	addi r4, r4, l_HIO@l
/* 80C9B92C  C0 04 00 10 */	lfs f0, 0x10(r4)	/* effective address: 80C9CEC4 */
...
/* 80C9B944  4B 5D 40 F8 */	b cLib_addCalc2__FPffff
lbl_80C9B948:
/* 80C9B948  A8 1E 05 94 */	lha r0, 0x594(r30)
/* 80C9B94C  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C9B950  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C9B954  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C9B9B0  4B 5D 4C 58 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C9B9C4  4B 5D 4C 44 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C9B9D8  4B 5D 40 64 */	b cLib_addCalc2__FPffff
...
/* 80C9B9EC  4B 5D 40 50 */	b cLib_addCalc2__FPffff
...
/* 80C9BA14  4B 5D 40 28 */	b cLib_addCalc2__FPffff

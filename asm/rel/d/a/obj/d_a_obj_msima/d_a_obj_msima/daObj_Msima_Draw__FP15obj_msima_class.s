...
/* 80C9B4B8 00000010  4B 6C 6D 10 */	b _savegpr_24
/* 80C9B4BC 00000014  7C 7F 1B 78 */	mr r31, r3
/* 80C9B4C0 00000018  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C9B4C4 0000001C  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80C9B4D4 0000002C  4B 50 82 F0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C9B4D8 00000030  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C9B4DC 00000034  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80C9B4EC 00000044  4B 50 98 B4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C9B4F0 00000048  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C9B4F4 0000004C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 80C9B4F8 00000050  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80C9B4FC 00000054  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C9B500 00000058  3B 83 4A C8 */	addi r28, r3, j3dSys@l
/* 80C9B504 0000005C  90 1C 00 48 */	stw r0, 0x48(r28)	/* effective address: 80434B10 */
/* 80C9B508 00000060  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80C9B50C 00000064  90 1C 00 4C */	stw r0, 0x4c(r28)	/* effective address: 80434B14 */
...
/* 80C9B524 0000007C  4B 37 21 B4 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C9B53C 00000094  4B 37 22 6C */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C9B540 00000098  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C9B544 0000009C  4B 37 27 80 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C9B548 000000A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C9B54C 000000A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C9B550 000000A8  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80C9B554 000000AC  90 1C 00 48 */	stw r0, 0x48(r28)	/* effective address: 80434B10 */
/* 80C9B558 000000B0  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
/* 80C9B55C 000000B4  90 1C 00 4C */	stw r0, 0x4c(r28)	/* effective address: 80434B14 */
...
/* 80C9B574 000000CC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C9B578 000000D0  3B 83 CA 54 */	addi r28, r3, g_env_light@l
lbl_80C9B57C:
...
/* 80C9B5A0 00000018  4B 50 82 24 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80C9B5B0 00000028  4B 50 97 F0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C9B5B4 0000002C  7F 43 D3 78 */	mr r3, r26
/* 80C9B5B8 00000030  4B 37 27 0C */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C9B5E4 00000008  4B 6C 6C 30 */	b _restgpr_24

...
/* 80C9C43C  4B 6C 5D 84 */	b _savegpr_22
/* 80C9C440  7C 7E 1B 78 */	mr r30, r3
/* 80C9C444  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C448  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C44C  38 80 00 07 */	li r4, 7
/* 80C9C450  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C9C454  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C9C468  4B 39 FE 84 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C478  4B 37 87 DC */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C9C4C4:
/* 80C9C4C4  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C4C8  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C4CC  38 80 00 10 */	li r4, 0x10
/* 80C9C4D0  7F E5 FB 78 */	mr r5, r31
/* 80C9C4D4  38 C0 00 80 */	li r6, 0x80
/* 80C9C4D8  4B 39 FE 14 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C4EC  4B 3D DA 4C */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C9C504:
/* 80C9C504  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C9C508  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C9C50C  80 7E 05 FC */	lwz r3, 0x5fc(r30)
/* 80C9C510  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 80C9C514  3C 60 80 CA */	lis r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C9C518  38 03 B4 4C */	addi r0, r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
/* 80C9C51C  80 7E 05 FC */	lwz r3, 0x5fc(r30)
/* 80C9C520  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 80C9C524  38 60 00 18 */	li r3, 0x18
/* 80C9C528  4B 63 27 24 */	b __nw__FUl
/* 80C9C52C  7C 79 1B 79 */	or. r25, r3, r3
/* 80C9C530  41 82 00 20 */	beq lbl_80C9C550
/* 80C9C534  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9C538  38 04 CE 48 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C9C53C  90 19 00 00 */	stw r0, 0(r25)
/* 80C9C540  38 80 00 00 */	li r4, 0
/* 80C9C544  4B 68 BE B8 */	b init__12J3DFrameCtrlFs
...
lbl_80C9C568:
/* 80C9C568  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C56C  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C570  38 80 00 0D */	li r4, 0xd
/* 80C9C574  7F E5 FB 78 */	mr r5, r31
/* 80C9C578  38 C0 00 80 */	li r6, 0x80
/* 80C9C57C  4B 39 FD 70 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C59C  3D 00 80 CA */	lis r8, lit_3863@ha
/* 80C9C5A0  C0 28 CD 4C */	lfs f1, lit_3863@l(r8)
/* 80C9C5A4  39 00 00 00 */	li r8, 0
/* 80C9C5A8  39 20 FF FF */	li r9, -1
/* 80C9C5AC  4B 37 10 90 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C9C5C4  4B 63 26 88 */	b __nw__FUl
/* 80C9C5C8  7C 79 1B 79 */	or. r25, r3, r3
/* 80C9C5CC  41 82 00 20 */	beq lbl_80C9C5EC
/* 80C9C5D0  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9C5D4  38 04 CE 48 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C9C5D8  90 19 00 00 */	stw r0, 0(r25)
/* 80C9C5DC  38 80 00 00 */	li r4, 0
/* 80C9C5E0  4B 68 BE 1C */	b init__12J3DFrameCtrlFs
...
lbl_80C9C604:
/* 80C9C604  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C608  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C60C  38 80 00 0A */	li r4, 0xa
/* 80C9C610  7F E5 FB 78 */	mr r5, r31
/* 80C9C614  38 C0 00 80 */	li r6, 0x80
/* 80C9C618  4B 39 FC D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C638  3D 00 80 CA */	lis r8, lit_3863@ha
/* 80C9C63C  C0 28 CD 4C */	lfs f1, lit_3863@l(r8)
/* 80C9C640  39 00 00 00 */	li r8, 0
/* 80C9C644  39 20 FF FF */	li r9, -1
/* 80C9C648  4B 37 10 C4 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C9C670  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C674  3B 23 CD EC */	addi r25, r3, stringBase0@l
/* 80C9C678  3F 40 11 00 */	lis r26, 0x1100
/* 80C9C67C  3C 60 80 CA */	lis r3, lit_4412@ha
/* 80C9C680  3B 63 CD CC */	addi r27, r3, lit_4412@l
lbl_80C9C684:
...
/* 80C9C6A0  4B 39 FC 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C9C6A4  3C 80 00 08 */	lis r4, 8
/* 80C9C6A8  38 BA 00 84 */	addi r5, r26, 0x84
/* 80C9C6AC  4B 37 85 A8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C9C6E0  4B 5C B2 74 */	b cM_rndF__Ff
...
/* 80C9C70C  4B 6C 5B 00 */	b _restgpr_22

...
/* 80C9C444 00000018  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C9CDEC */
/* 80C9C448 0000001C  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C9CDEC */
/* 80C9C44C 00000020  38 80 00 07 */	li r4, 7
/* 80C9C450 00000024  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C9C454 00000028  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
lbl_80C9C4C4:
/* 80C9C4C4 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C9CDEC */
/* 80C9C4C8 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C9CDEC */
...
lbl_80C9C504:
/* 80C9C504 00000000  3C 60 00 00 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 80075A24 */
/* 80C9C508 00000004  38 03 00 00 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 80075A24 */
/* 80C9C50C 00000008  80 7E 05 FC */	lwz r3, 0x5fc(r30)
/* 80C9C510 0000000C  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 80C9C514 00000010  3C 60 00 00 */	lis r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha /* 80C9B44C */
/* 80C9C518 00000014  38 03 00 00 */	addi r0, r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l /* 80C9B44C */
...
/* 80C9C534 00000030  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9CE48 */
/* 80C9C538 00000034  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9CE48 */
...
lbl_80C9C568:
/* 80C9C568 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C9CDEC */
/* 80C9C56C 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C9CDEC */
...
/* 80C9C59C 00000034  3D 00 00 00 */	lis r8, lit_3863@ha /* 80C9CD4C */
/* 80C9C5A0 00000038  C0 28 00 00 */	lfs f1, lit_3863@l(r8) /* 80C9CD4C */
...
/* 80C9C5D0 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9CE48 */
/* 80C9C5D4 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9CE48 */
...
lbl_80C9C604:
/* 80C9C604 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C9CDEC */
/* 80C9C608 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C9CDEC */
...
/* 80C9C638 00000034  3D 00 00 00 */	lis r8, lit_3863@ha /* 80C9CD4C */
/* 80C9C63C 00000038  C0 28 00 00 */	lfs f1, lit_3863@l(r8) /* 80C9CD4C */
...
/* 80C9C670 00000014  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C9CDEC */
/* 80C9C674 00000018  3B 23 00 00 */	addi r25, r3, stringBase0@l /* 80C9CDEC */
/* 80C9C678 0000001C  3F 40 11 00 */	lis r26, 0x1100
/* 80C9C67C 00000020  3C 60 00 00 */	lis r3, lit_4412@ha /* 80C9CDCC */
/* 80C9C680 00000024  3B 63 00 00 */	addi r27, r3, lit_4412@l /* 80C9CDCC */
lbl_80C9C684:

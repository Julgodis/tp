...
/* 80C9C43C 00000010  4B 6C 5D 84 */	b _savegpr_22
/* 80C9C440 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C9C444 00000018  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C448 0000001C  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C44C 00000020  38 80 00 07 */	li r4, 7
/* 80C9C450 00000024  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C9C454 00000028  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C9C468 0000003C  4B 39 FE 84 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C478 0000004C  4B 37 87 DC */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C9C4C4:
/* 80C9C4C4 00000000  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C4C8 00000004  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C4CC 00000008  38 80 00 10 */	li r4, 0x10
/* 80C9C4D0 0000000C  7F E5 FB 78 */	mr r5, r31
/* 80C9C4D4 00000010  38 C0 00 80 */	li r6, 0x80
/* 80C9C4D8 00000014  4B 39 FE 14 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C4EC 00000028  4B 3D DA 4C */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C9C504:
/* 80C9C504 00000000  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C9C508 00000004  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C9C50C 00000008  80 7E 05 FC */	lwz r3, 0x5fc(r30)
/* 80C9C510 0000000C  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 80C9C514 00000010  3C 60 80 CA */	lis r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C9C518 00000014  38 03 B4 4C */	addi r0, r3, ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
...
/* 80C9C528 00000024  4B 63 27 24 */	b __nw__FUl
/* 80C9C52C 00000028  7C 79 1B 79 */	or. r25, r3, r3
/* 80C9C530 0000002C  41 82 00 20 */	beq lbl_80C9C550
/* 80C9C534 00000030  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9C538 00000034  38 04 CE 48 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C9C53C 00000038  90 19 00 00 */	stw r0, 0(r25)
/* 80C9C540 0000003C  38 80 00 00 */	li r4, 0
/* 80C9C544 00000040  4B 68 BE B8 */	b init__12J3DFrameCtrlFs
...
lbl_80C9C568:
/* 80C9C568 00000000  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C56C 00000004  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C570 00000008  38 80 00 0D */	li r4, 0xd
/* 80C9C574 0000000C  7F E5 FB 78 */	mr r5, r31
/* 80C9C578 00000010  38 C0 00 80 */	li r6, 0x80
/* 80C9C57C 00000014  4B 39 FD 70 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C59C 00000034  3D 00 80 CA */	lis r8, lit_3863@ha
/* 80C9C5A0 00000038  C0 28 CD 4C */	lfs f1, lit_3863@l(r8)
/* 80C9C5A4 0000003C  39 00 00 00 */	li r8, 0
/* 80C9C5A8 00000040  39 20 FF FF */	li r9, -1
/* 80C9C5AC 00000044  4B 37 10 90 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C9C5C4 00000004  4B 63 26 88 */	b __nw__FUl
/* 80C9C5C8 00000008  7C 79 1B 79 */	or. r25, r3, r3
/* 80C9C5CC 0000000C  41 82 00 20 */	beq lbl_80C9C5EC
/* 80C9C5D0 00000010  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9C5D4 00000014  38 04 CE 48 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C9C5D8 00000018  90 19 00 00 */	stw r0, 0(r25)
/* 80C9C5DC 0000001C  38 80 00 00 */	li r4, 0
/* 80C9C5E0 00000020  4B 68 BE 1C */	b init__12J3DFrameCtrlFs
...
lbl_80C9C604:
/* 80C9C604 00000000  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C608 00000004  38 63 CD EC */	addi r3, r3, stringBase0@l
/* 80C9C60C 00000008  38 80 00 0A */	li r4, 0xa
/* 80C9C610 0000000C  7F E5 FB 78 */	mr r5, r31
/* 80C9C614 00000010  38 C0 00 80 */	li r6, 0x80
/* 80C9C618 00000014  4B 39 FC D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9C638 00000034  3D 00 80 CA */	lis r8, lit_3863@ha
/* 80C9C63C 00000038  C0 28 CD 4C */	lfs f1, lit_3863@l(r8)
/* 80C9C640 0000003C  39 00 00 00 */	li r8, 0
/* 80C9C644 00000040  39 20 FF FF */	li r9, -1
/* 80C9C648 00000044  4B 37 10 C4 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C9C670 00000014  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9C674 00000018  3B 23 CD EC */	addi r25, r3, stringBase0@l
/* 80C9C678 0000001C  3F 40 11 00 */	lis r26, 0x1100
/* 80C9C67C 00000020  3C 60 80 CA */	lis r3, lit_4412@ha
/* 80C9C680 00000024  3B 63 CD CC */	addi r27, r3, lit_4412@l
lbl_80C9C684:
...
/* 80C9C6A0 00000010  4B 39 FC 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C9C6A4 00000014  3C 80 00 08 */	lis r4, 8
/* 80C9C6A8 00000018  38 BA 00 84 */	addi r5, r26, 0x84
/* 80C9C6AC 0000001C  4B 37 85 A8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C9C6DC 00000010  C0 3B 00 00 */	lfs f1, 0(r27)	/* effective address: 80C9CDCC */
/* 80C9C6E0 00000014  4B 5C B2 74 */	b cM_rndF__Ff
...
/* 80C9C70C 00000004  4B 6C 5B 00 */	b _restgpr_22

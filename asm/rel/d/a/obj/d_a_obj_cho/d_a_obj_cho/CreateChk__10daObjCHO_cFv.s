...
/* 80BCBEB0 00000014  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80BCBEB4 00000018  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80BCBEB8 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80BCBEBC 00000020  7F E3 FB 78 */	mr r3, r31
/* 80BCBEC0 00000024  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBEC4 00000028  A0 04 00 00 */	lhz r0, 0x0000(r4)
/* 80BCBEC8 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80BCBECC 00000030  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBED0 00000034  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBED4 00000038  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BCBED8 0000003C  4B FF E3 A1 */	bl _unresolved
...
/* 80BCBEE8 0000004C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBEEC 00000050  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBEF0 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80BCBEF4 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80BCBEF8 0000005C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBEFC 00000060  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBF00 00000064  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BCBF04 00000068  4B FF E3 75 */	bl _unresolved
...
lbl_80BCBF18:
/* 80BCBF18 00000000  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80BCBF1C 00000004  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80BCBF20 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80BCBF24 0000000C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBF28 00000010  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBF2C 00000014  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80BCBF30 00000018  4B FF E3 49 */	bl _unresolved
/* 80BCBF34 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80BCBF38 00000020  40 82 00 CC */	bne lbl_80BCC004
/* 80BCBF3C 00000024  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80BCBF40 00000028  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
...
/* 80BCBF54 0000003C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80BCBF58 00000040  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80BCBF5C 00000044  7C 63 00 AE */	lbzx r3, r3, r0
/* 80BCBF60 00000048  4B FF E3 19 */	bl _unresolved
...
/* 80BCBF80 0000000C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80BCBF84 00000010  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80BCBF88 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BCBF8C 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80BCBF90 0000001C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBF94 00000020  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBF98 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80BCBF9C 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80BCBFA0 0000002C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBFA4 00000030  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBFA8 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BCBFAC 00000038  4B FF E2 CD */	bl _unresolved
...
/* 80BCBFC4 0000000C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80BCBFC8 00000010  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80BCBFCC 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BCBFD0 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80BCBFD4 0000001C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBFD8 00000020  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBFDC 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80BCBFE0 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80BCBFE4 0000002C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80BCBFE8 00000030  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80BCBFEC 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BCBFF0 00000038  4B FF E2 89 */	bl _unresolved

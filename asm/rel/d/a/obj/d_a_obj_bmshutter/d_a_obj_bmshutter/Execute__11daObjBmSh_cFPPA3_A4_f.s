...
/* 80BB9DC4  4B 7A 84 18 */	b _savegpr_29
/* 80BB9DC8  7C 7D 1B 78 */	mr r29, r3
/* 80BB9DCC  7C 9E 23 78 */	mr r30, r4
/* 80BB9DD0  3C 60 80 BC */	lis r3, l_cull_box@ha
/* 80BB9DD4  3B E3 A7 B0 */	addi r31, r3, l_cull_box@l
/* 80BB9DD8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB9DDC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BB9DE0  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 80BB9DE4  80 03 05 80 */	lwz r0, 0x580(r3)	/* effective address: 80406740 */
...
/* 80BB9E30  4B 47 88 24 */	b dLib_checkActorInRectangle__FP10fopAc_ac_cP10fopAc_ac_cPC4cXyzPC4cXyz
...
/* 80BB9E58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB9E5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB9E60  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 80BB9E64  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 80BB9E68  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 80BB9E6C  4B 78 CA 7C */	b PSMTXTrans
/* 80BB9E70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB9E74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB9E78  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80BB9E7C  4B 45 25 B8 */	b mDoMtx_YrotM__FPA4_fs
/* 80BB9E80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB9E84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB9E88  38 9D 05 D0 */	addi r4, r29, 0x5d0
/* 80BB9E8C  7C 85 23 78 */	mr r5, r4
/* 80BB9E90  4B 78 CE DC */	b PSMTXMultVec
...
/* 80BB9EA0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BB9EA4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BB9EA8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BB9ED0  4B 6F 1A B4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BB9ED4:
...
/* 80BB9F20  4B 7A 83 08 */	b _restgpr_29

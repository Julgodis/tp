...
/* 80BBA280 00000014  3C 60 00 00 */	lis r3, cNullVec__6Z2Calc@ha /* 80BBA82C */
/* 80BBA284 00000018  38 C3 00 00 */	addi r6, r3, cNullVec__6Z2Calc@l /* 80BBA82C */
/* 80BBA288 0000001C  3C 60 00 00 */	lis r3, struct_80BBA970+0x1@ha /* 80BBA971 */
/* 80BBA28C 00000020  38 A3 00 00 */	addi r5, r3, struct_80BBA970+0x1@l /* 80BBA971 */
/* 80BBA290 00000024  88 05 00 00 */	lbz r0, 0(r5)
/* 80BBA294 00000028  7C 00 07 75 */	extsb. r0, r0
/* 80BBA298 0000002C  40 82 00 58 */	bne lbl_80BBA2F0
/* 80BBA29C 00000030  80 66 00 84 */	lwz r3, 0x84(r6)
/* 80BBA2A0 00000034  80 06 00 88 */	lwz r0, 0x88(r6)
/* 80BBA2A4 00000038  90 66 00 A8 */	stw r3, 0xa8(r6)
/* 80BBA2A8 0000003C  90 06 00 AC */	stw r0, 0xac(r6)
/* 80BBA2AC 00000040  80 06 00 8C */	lwz r0, 0x8c(r6)
/* 80BBA2B0 00000044  90 06 00 B0 */	stw r0, 0xb0(r6)
/* 80BBA2B4 00000048  38 86 00 A8 */	addi r4, r6, 0xa8
/* 80BBA2B8 0000004C  80 66 00 90 */	lwz r3, 0x90(r6)
/* 80BBA2BC 00000050  80 06 00 94 */	lwz r0, 0x94(r6)
/* 80BBA2C0 00000054  90 64 00 0C */	stw r3, 0xc(r4)
/* 80BBA2C4 00000058  90 04 00 10 */	stw r0, 0x10(r4)
/* 80BBA2C8 0000005C  80 06 00 98 */	lwz r0, 0x98(r6)
/* 80BBA2CC 00000060  90 04 00 14 */	stw r0, 0x14(r4)
/* 80BBA2D0 00000064  80 66 00 9C */	lwz r3, 0x9c(r6)
/* 80BBA2D4 00000068  80 06 00 A0 */	lwz r0, 0xa0(r6)
/* 80BBA2D8 0000006C  90 64 00 18 */	stw r3, 0x18(r4)
/* 80BBA2DC 00000070  90 04 00 1C */	stw r0, 0x1c(r4)
/* 80BBA2E0 00000074  80 06 00 A4 */	lwz r0, 0xa4(r6)
/* 80BBA2E4 00000078  90 04 00 20 */	stw r0, 0x20(r4)
/* 80BBA2E8 0000007C  38 00 00 01 */	li r0, 1
/* 80BBA2EC 00000080  98 05 00 00 */	stb r0, 0(r5)
lbl_80BBA2F0:
...
/* 80BBA304 00000014  4B FF F7 35 */	bl __ptmf_scall
/* 80BBA308 00000018  60 00 00 00 */	nop 
/* 80BBA30C 0000001C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80BBA310 00000020  38 83 00 00 */	addi r4, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80BBA36C 0000007C  3C 80 00 00 */	lis r4, lit_3908@ha /* 80BBA810 */
/* 80BBA370 00000080  C0 24 00 00 */	lfs f1, lit_3908@l(r4) /* 80BBA810 */
/* 80BBA374 00000084  3C 80 00 00 */	lis r4, lit_3909@ha /* 80BBA814 */
/* 80BBA378 00000088  C0 44 00 00 */	lfs f2, lit_3909@l(r4) /* 80BBA814 */
/* 80BBA37C 0000008C  4B FF F6 BD */	bl cLib_addCalc0__FPfff

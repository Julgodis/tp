...
/* 80BBA3A4  4B 7A 7E 38 */	b _savegpr_29
/* 80BBA3A8  7C 7E 1B 78 */	mr r30, r3
/* 80BBA3AC  3C 80 80 BC */	lis r4, l_cull_box@ha
/* 80BBA3B0  3B E4 A7 B0 */	addi r31, r4, l_cull_box@l
...
/* 80BBA404  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBA408  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBA40C  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80BBA410  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80BBA414  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80BBA418  4B 78 C4 D0 */	b PSMTXTrans
/* 80BBA41C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBA420  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBA424  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80BBA428  4B 45 20 0C */	b mDoMtx_YrotM__FPA4_fs
/* 80BBA42C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBA430  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBA434  38 9E 05 D0 */	addi r4, r30, 0x5d0
/* 80BBA438  7C 85 23 78 */	mr r5, r4
/* 80BBA43C  4B 78 C9 30 */	b PSMTXMultVec
...
/* 80BBA44C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BBA450  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BBA454  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BBA47C  4B 6F 15 08 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BBA480:
/* 80BBA480  2C 1D 00 00 */	cmpwi r29, 0
/* 80BBA484  41 82 01 18 */	beq lbl_80BBA59C
/* 80BBA488  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BBA48C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BBA4A0  4B 47 AD 60 */	b onSwitch__10dSv_info_cFii
...
/* 80BBA4C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBA4C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBA4CC  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80BBA4D0  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80BBA4D4  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80BBA4D8  4B 78 C4 10 */	b PSMTXTrans
/* 80BBA4DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBA4E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBA4E4  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80BBA4E8  4B 45 1F 4C */	b mDoMtx_YrotM__FPA4_fs
/* 80BBA4EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBA4F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBA4F4  38 9E 05 D0 */	addi r4, r30, 0x5d0
/* 80BBA4F8  7C 85 23 78 */	mr r5, r4
/* 80BBA4FC  4B 78 C8 70 */	b PSMTXMultVec
...
/* 80BBA51C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BBA520  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BBA524  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BBA54C  4B 6F 14 38 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BBA568  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BBA56C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BBA570  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BBA598  4B 6F 13 EC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BBA59C:
/* 80BBA59C  39 61 00 30 */	addi r11, r1, 0x30
/* 80BBA5A0  4B 7A 7C 88 */	b _restgpr_29

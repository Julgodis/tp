...
/* 80BDB28C  3C 60 80 BE */	lis r3, lit_4158@ha
/* 80BDB290  C8 23 C4 40 */	lfd f1, lit_4158@l(r3)
...
/* 80BDB2B4  3C 80 80 BE */	lis r4, lit_3939@ha
/* 80BDB2B8  C0 24 C4 04 */	lfs f1, lit_3939@l(r4)
/* 80BDB2BC  3C 80 80 BE */	lis r4, lit_3775@ha
/* 80BDB2C0  C0 44 C3 B0 */	lfs f2, lit_3775@l(r4)
/* 80BDB2C4  FC 60 10 90 */	fmr f3, f2
/* 80BDB2C8  4B 69 47 74 */	b cLib_addCalc2__FPffff
/* 80BDB2CC  48 00 00 1C */	b lbl_80BDB2E8
lbl_80BDB2D0:
/* 80BDB2D0  38 7F 07 A4 */	addi r3, r31, 0x7a4
/* 80BDB2D4  3C 80 80 BE */	lis r4, lit_3775@ha
/* 80BDB2D8  C0 24 C3 B0 */	lfs f1, lit_3775@l(r4)
/* 80BDB2DC  FC 40 08 90 */	fmr f2, f1
/* 80BDB2E0  FC 60 08 90 */	fmr f3, f1
/* 80BDB2E4  4B 69 47 58 */	b cLib_addCalc2__FPffff
lbl_80BDB2E8:
/* 80BDB2E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BDB2EC  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80BDB2F0  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80BDB334  3D 60 80 BE */	lis r11, lit_3775@ha
/* 80BDB338  C0 2B C3 B0 */	lfs f1, lit_3775@l(r11)
/* 80BDB33C  4B 47 21 90 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BDB354  4B 47 05 C4 */	b getEmitter__Q213dPa_control_c7level_cFUl

...
/* 80BDBB4C 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BDBB50 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BDBB54 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80BDBB58 00000020  7F E3 FB 78 */	mr r3, r31
/* 80BDBB5C 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BDBB60 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4)
/* 80BDBB64 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80BDBB68 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BDBB6C 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80BDBB84 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BDBB88 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l
/* 80BDBB8C 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80BDBB90 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80BDBB94 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BDBB98 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
lbl_80BDBBB4:
/* 80BDBBB4 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80BDBBB8 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80BDBBBC 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80BDBBC0 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 80BDBBC4 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
/* 80BDBBD8 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BDBBDC 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80BDBBF0 0000003C  3C 60 00 00 */	lis r3, l_dan_itemno@ha
/* 80BDBBF4 00000040  38 63 00 00 */	addi r3, r3, l_dan_itemno@l
...
/* 80BDBC1C 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BDBC20 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BDBC24 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BDBC28 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80BDBC2C 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BDBC30 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l
/* 80BDBC34 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80BDBC38 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80BDBC3C 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BDBC40 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80BDBC60 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BDBC64 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BDBC68 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BDBC6C 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80BDBC70 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BDBC74 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l
/* 80BDBC78 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80BDBC7C 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80BDBC80 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BDBC84 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l

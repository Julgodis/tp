...
/* 80C5E3AC  3C 60 80 C6 */	lis r3, lit_3634@ha
/* 80C5E3B0  3B E3 E8 DC */	addi r31, r3, lit_3634@l
/* 80C5E3B4  38 7E 05 D0 */	addi r3, r30, 0x5d0
/* 80C5E3B8  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 80C5E8E4 */
/* 80C5E3BC  C0 5F 00 14 */	lfs f2, 0x14(r31)	/* effective address: 80C5E8F0 */
/* 80C5E3C0  C0 7E 05 D8 */	lfs f3, 0x5d8(r30)
/* 80C5E3C4  C0 9F 00 18 */	lfs f4, 0x18(r31)	/* effective address: 80C5E8F4 */
/* 80C5E3C8  4B 61 15 B4 */	b cLib_addCalc__FPfffff
...
/* 80C5E3E0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5E3E4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5E3E8  88 9E 05 C8 */	lbz r4, 0x5c8(r30)
/* 80C5E3EC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C5E3F0  7C 05 07 74 */	extsb r5, r0
/* 80C5E3F4  4B 3D 6E BC */	b offSwitch__10dSv_info_cFii
/* 80C5E3F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5E3FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5E400  88 9E 05 C9 */	lbz r4, 0x5c9(r30)
/* 80C5E404  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C5E408  7C 05 07 74 */	extsb r5, r0
/* 80C5E40C  4B 3D 6E A4 */	b offSwitch__10dSv_info_cFii
/* 80C5E410  88 9E 05 CC */	lbz r4, 0x5cc(r30)
/* 80C5E414  28 04 00 FF */	cmplwi r4, 0xff
/* 80C5E418  41 82 00 2C */	beq lbl_80C5E444
/* 80C5E41C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5E420  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5E424  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C5E428  7C 05 07 74 */	extsb r5, r0
/* 80C5E42C  4B 3D 6F 34 */	b isSwitch__10dSv_info_cCFii

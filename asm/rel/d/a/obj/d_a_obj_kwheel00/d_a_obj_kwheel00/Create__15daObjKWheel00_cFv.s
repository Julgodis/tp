...
/* 80C4DA48  4B 71 47 8C */	b _savegpr_27
...
/* 80C4DA5C  4B 6F 8A 54 */	b PSMTXCopy
...
/* 80C4DA80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4DA84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C4DA88  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C4DA8C  7C 05 07 74 */	extsb r5, r0
/* 80C4DA90  4B 3E 78 D0 */	b isSwitch__10dSv_info_cCFii
...
/* 80C4DACC  3C 60 80 C5 */	lis r3, l_cull_box@ha
/* 80C4DAD0  38 83 E8 10 */	addi r4, r3, l_cull_box@l
...
/* 80C4DAFC  4B 3C CA 4C */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C4DB24  4B 43 5D 3C */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C4DB28  3B 60 00 00 */	li r27, 0
/* 80C4DB2C  3B C0 00 00 */	li r30, 0
/* 80C4DB30  3B 9F 06 24 */	addi r28, r31, 0x624
/* 80C4DB34  3C 60 80 C5 */	lis r3, l_sphSrc@ha
/* 80C4DB38  3B A3 E8 78 */	addi r29, r3, l_sphSrc@l
lbl_80C4DB3C:
...
/* 80C4DB4C  4B 43 6E E8 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80C4DB70  3C 80 80 C5 */	lis r4, l_se_angle@ha
/* 80C4DB74  38 84 E8 B8 */	addi r4, r4, l_se_angle@l
...
/* 80C4DBA8  4B 71 46 78 */	b _restgpr_27

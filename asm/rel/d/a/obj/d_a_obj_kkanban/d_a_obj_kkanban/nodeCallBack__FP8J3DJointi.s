...
/* 80C466A8  4B 71 BB 34 */	b _savegpr_29
...
/* 80C466E4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C466E8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C466EC  4B 6F FD C4 */	b PSMTXCopy
/* 80C466F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C466F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C466F8  A8 9F 07 46 */	lha r4, 0x746(r31)
/* 80C466FC  4B 3C 5C A0 */	b mDoMtx_XrotM__FPA4_fs
/* 80C46700  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C46704  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C46708  A8 9F 07 48 */	lha r4, 0x748(r31)
/* 80C4670C  4B 3C 5D C0 */	b mDoMtx_ZrotM__FPA4_fs
/* 80C46710  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C46714  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C46718  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80C4671C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C46720  7C 80 EA 14 */	add r4, r0, r29
/* 80C46724  4B 6F FD 8C */	b PSMTXCopy
/* 80C46728  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4672C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C46730  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80C46734  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80C46738  4B 6F FD 78 */	b PSMTXCopy
/* 80C4673C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C46740  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C46744  38 9F 05 6C */	addi r4, r31, 0x56c
/* 80C46748  4B 6F FD 68 */	b PSMTXCopy
lbl_80C4674C:
/* 80C4674C  38 60 00 01 */	li r3, 1
/* 80C46750  39 61 00 20 */	addi r11, r1, 0x20
/* 80C46754  4B 71 BA D4 */	b _restgpr_29

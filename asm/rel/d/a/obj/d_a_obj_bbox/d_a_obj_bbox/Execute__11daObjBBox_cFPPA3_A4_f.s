...
/* 80BAD0D0  4B 7B 50 FC */	b _savegpr_25
/* 80BAD0D4  7C 7D 1B 78 */	mr r29, r3
/* 80BAD0D8  7C 9E 23 78 */	mr r30, r4
/* 80BAD0DC  3C 60 80 BB */	lis r3, l_cyl_src@ha
/* 80BAD0E0  3B E3 D4 74 */	addi r31, r3, l_cyl_src@l
/* 80BAD0E4  38 7D 05 E8 */	addi r3, r29, 0x5e8
/* 80BAD0E8  4B 4D 73 78 */	b ChkTgHit__12dCcD_GObjInfFv
/* 80BAD0EC  28 03 00 00 */	cmplwi r3, 0
/* 80BAD0F0  41 82 00 F8 */	beq lbl_80BAD1E8
/* 80BAD0F4  38 7D 05 E8 */	addi r3, r29, 0x5e8
/* 80BAD0F8  4B 4D 74 00 */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 80BAD118  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAD11C  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
/* 80BAD120  3B 7F 00 44 */	addi r27, r31, 0x44
lbl_80BAD124:
/* 80BAD124  80 7A 5D 3C */	lwz r3, 0x5d3c(r26)	/* effective address: 8040BEFC */
...
/* 80BAD164  4B 49 F9 2C */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BAD180  4B 47 FE EC */	b dComIfGp_getReverb__Fi
...
/* 80BAD194  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BAD198  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BAD19C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BAD1C0  4B 6F E7 C4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80BAD1C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAD1C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BAD1DC  4B 48 80 24 */	b onSwitch__10dSv_info_cFii
/* 80BAD1E0  7F A3 EB 78 */	mr r3, r29
/* 80BAD1E4  4B 46 CA 98 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80BAD1E8:
...
/* 80BAD200  4B 6C 1F DC */	b SetC__8cM3dGCylFRC4cXyz
/* 80BAD204  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAD208  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BAD20C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80BAD210  38 9D 05 E8 */	addi r4, r29, 0x5e8
/* 80BAD214  4B 6B 79 94 */	b Set__4cCcSFP8cCcD_Obj
/* 80BAD218  38 60 00 01 */	li r3, 1
/* 80BAD21C  39 61 00 50 */	addi r11, r1, 0x50
/* 80BAD220  4B 7B 4F F8 */	b _restgpr_25

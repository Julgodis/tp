...
/* 80C7CB28  4B 6E 56 AC */	b _savegpr_27
/* 80C7CB2C  3C A0 80 C8 */	lis r5, l_sph_src@ha
/* 80C7CB30  3B E5 DE CC */	addi r31, r5, l_sph_src@l
/* 80C7CB34  2C 04 00 00 */	cmpwi r4, 0
/* 80C7CB38  40 82 02 D0 */	bne lbl_80C7CE08
/* 80C7CB3C  A3 63 00 14 */	lhz r27, 0x14(r3)
/* 80C7CB40  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C7CB44  38 63 4A C8 */	addi r3, r3, j3dSys@l
/* 80C7CB48  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 80C7CB60  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C7CB64  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C7CB68  4B 6C 99 48 */	b PSMTXCopy
/* 80C7CB6C  2C 1B 00 01 */	cmpwi r27, 1
/* 80C7CB70  40 82 00 18 */	bne lbl_80C7CB88
/* 80C7CB74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CB78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CB7C  A8 9C 08 92 */	lha r4, 0x892(r28)
/* 80C7CB80  4B 38 F8 1C */	b mDoMtx_XrotM__FPA4_fs
/* 80C7CB84  48 00 02 58 */	b lbl_80C7CDDC
lbl_80C7CB88:
/* 80C7CB88  2C 1B 00 02 */	cmpwi r27, 2
/* 80C7CB8C  40 82 02 50 */	bne lbl_80C7CDDC
/* 80C7CB90  4B 39 01 38 */	b push__14mDoMtx_stack_cFv
/* 80C7CB94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CB98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CB9C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80C7CBA0  D0 1C 08 94 */	stfs f0, 0x894(r28)
/* 80C7CBA4  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C7CBA8  D0 1C 08 98 */	stfs f0, 0x898(r28)
/* 80C7CBAC  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80C7CBB0  D0 1C 08 9C */	stfs f0, 0x89c(r28)
/* 80C7CBB4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C7CBB8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C7CBBC  83 63 5D AC */	lwz r27, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80C7CBD8  4B 5F 2E A8 */	b cLib_addCalc0__FPfff
...
/* 80C7CC1C  4B 6C A7 80 */	b PSVECSquareDistance
...
/* 80C7CC8C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C7CC90  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C7CCFC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C7CD00  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C7CD04:
...
/* 80C7CD28  4B 5E A9 4C */	b cM_atan2s__Fff
...
/* 80C7CD44  4B 39 00 20 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C7CD48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CD4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CD50  A8 9C 08 92 */	lha r4, 0x892(r28)
/* 80C7CD54  4B 38 F6 E0 */	b mDoMtx_YrotM__FPA4_fs
/* 80C7CD58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CD5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CD60  7F 64 DB 78 */	mr r4, r27
/* 80C7CD64  4B 38 F6 38 */	b mDoMtx_XrotM__FPA4_fs
/* 80C7CD68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CD6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CD70  80 9C 08 80 */	lwz r4, 0x880(r28)
/* 80C7CD74  38 84 00 24 */	addi r4, r4, 0x24
/* 80C7CD78  4B 6C 97 38 */	b PSMTXCopy
...
/* 80C7CD90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CD94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CD98  38 81 00 24 */	addi r4, r1, 0x24
/* 80C7CD9C  38 BC 07 38 */	addi r5, r28, 0x738
/* 80C7CDA0  4B 6C 9F CC */	b PSMTXMultVec
...
/* 80C7CDCC  4B 5F 22 70 */	b Set__8cM3dGCpsFRC9cM3dGCpsS
/* 80C7CDD0  38 7C 05 E8 */	addi r3, r28, 0x5e8
/* 80C7CDD4  4B 40 7A 50 */	b CalcAtVec__8dCcD_CpsFv
/* 80C7CDD8  4B 38 FF 3C */	b pop__14mDoMtx_stack_cFv
lbl_80C7CDDC:
/* 80C7CDDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CDE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CDE4  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80C7CDE8  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C7CDEC  7C 80 EA 14 */	add r4, r0, r29
/* 80C7CDF0  4B 6C 96 C0 */	b PSMTXCopy
/* 80C7CDF4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7CDF8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7CDFC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80C7CE00  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80C7CE04  4B 6C 96 AC */	b PSMTXCopy
lbl_80C7CE08:
/* 80C7CE08  38 60 00 01 */	li r3, 1
/* 80C7CE0C  39 61 00 50 */	addi r11, r1, 0x50
/* 80C7CE10  4B 6E 54 10 */	b _restgpr_27

...
/* 80CDC4C0  3C 60 80 CE */	lis r3, lit_3706@ha
/* 80CDC4C4  C0 23 CB F8 */	lfs f1, lit_3706@l(r3)
/* 80CDC4C8  D0 21 00 08 */	stfs f1, 8(r1)
/* 80CDC4CC  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80CDC4D0  3C 60 80 CE */	lis r3, lit_3888@ha
/* 80CDC4D4  C0 03 CC 0C */	lfs f0, lit_3888@l(r3)
...
/* 80CDC4F8  4B 33 08 6C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CDC4FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDC500  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CDC504  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CDC508  4B 32 FF 2C */	b mDoMtx_YrotM__FPA4_fs
/* 80CDC50C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDC510  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l

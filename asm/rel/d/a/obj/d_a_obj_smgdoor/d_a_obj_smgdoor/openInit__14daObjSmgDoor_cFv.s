...
/* 80CDC268 00000020  4B 58 BF 6C */	b ChkUsed__9cBgW_BgIdCFv
/* 80CDC26C 00000024  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CDC270 00000028  41 82 00 18 */	beq lbl_80CDC288
/* 80CDC274 0000002C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CDC278 00000030  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CDC27C 00000034  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CDC280 00000038  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80CDC284 0000003C  4B 39 7F CC */	b Release__4cBgSFP9dBgW_Base
lbl_80CDC288:
...
/* 80CDC29C 00000014  4B 35 0D D0 */	b dComIfGp_getReverb__Fi
...
/* 80CDC2B0 00000028  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CDC2B4 0000002C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CDC2B8 00000030  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CDC2C8 00000040  3D 00 80 CE */	lis r8, lit_3825@ha
/* 80CDC2CC 00000044  C0 28 CC 04 */	lfs f1, lit_3825@l(r8)
/* 80CDC2D0 00000048  FC 40 08 90 */	fmr f2, f1
/* 80CDC2D4 0000004C  3D 00 80 CE */	lis r8, lit_3826@ha
/* 80CDC2D8 00000050  C0 68 CC 08 */	lfs f3, lit_3826@l(r8)
/* 80CDC2DC 00000054  FC 80 18 90 */	fmr f4, f3
/* 80CDC2E0 00000058  39 00 00 00 */	li r8, 0
/* 80CDC2E4 0000005C  4B 5C F6 A0 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CDC2FC 00000010  4B 35 0D 70 */	b dComIfGp_getReverb__Fi
...
/* 80CDC310 00000024  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CDC314 00000028  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CDC318 0000002C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CDC328 0000003C  3D 00 80 CE */	lis r8, lit_3825@ha
/* 80CDC32C 00000040  C0 28 CC 04 */	lfs f1, lit_3825@l(r8)
/* 80CDC330 00000044  FC 40 08 90 */	fmr f2, f1
/* 80CDC334 00000048  3D 00 80 CE */	lis r8, lit_3826@ha
/* 80CDC338 0000004C  C0 68 CC 08 */	lfs f3, lit_3826@l(r8)
/* 80CDC33C 00000050  FC 80 18 90 */	fmr f4, f3
/* 80CDC340 00000054  39 00 00 00 */	li r8, 0
/* 80CDC344 00000058  4B 5C F6 40 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CDC348:

...
/* 80CDBF00  3C 80 80 CE */	lis r4, l_arcName@ha
/* 80CDBF04  38 84 CC E4 */	addi r4, r4, l_arcName@l
/* 80CDBF08  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CDBF0C  4B 35 0F B0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CDBF24  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CDBF28  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CDBF2C  3C 63 00 02 */	addis r3, r3, 2
/* 80CDBF30  3C 80 80 CE */	lis r4, l_arcName@ha
/* 80CDBF34  38 84 CC E4 */	addi r4, r4, l_arcName@l
/* 80CDBF38  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CDBF3C  3C A0 80 CE */	lis r5, l_dzb@ha
/* 80CDBF40  38 A5 CC F4 */	addi r5, r5, l_dzb@l
/* 80CDBF44  7C A5 00 2E */	lwzx r5, r5, r0
/* 80CDBF48  38 63 C2 F8 */	addi r3, r3, -15624
/* 80CDBF4C  4B 36 07 6C */	b getObjectResName2Index__14dRes_control_cFPCcPCc
...
/* 80CDBF60  3C 80 80 CE */	lis r4, l_arcName@ha
/* 80CDBF64  38 84 CC E4 */	addi r4, r4, l_arcName@l
...
/* 80CDBF78  4B 39 C8 44 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f

...
/* 80CDC048  4B 68 61 94 */	b _savegpr_29
/* 80CDC04C  7C 7E 1B 78 */	mr r30, r3
/* 80CDC050  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CDC054  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CDC058  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 80CDC05C  7F E3 FB 78 */	mr r3, r31
/* 80CDC060  3C 80 80 CE */	lis r4, struct_80CDCC24+0x0@ha
/* 80CDC064  38 84 CC 24 */	addi r4, r4, struct_80CDCC24+0x0@l
/* 80CDC068  38 84 00 91 */	addi r4, r4, 0x91
/* 80CDC06C  38 A0 00 00 */	li r5, 0
/* 80CDC070  38 C0 00 00 */	li r6, 0
/* 80CDC074  4B 36 BA A8 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80CDC090  4B 36 BC BC */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80CDC0CC  3C A0 80 CE */	lis r5, struct_80CDCC24+0x0@ha
/* 80CDC0D0  38 A5 CC 24 */	addi r5, r5, struct_80CDCC24+0x0@l
/* 80CDC0D4  38 A5 00 99 */	addi r5, r5, 0x99
/* 80CDC0D8  38 C0 00 03 */	li r6, 3
/* 80CDC0DC  4B 36 C0 10 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CDC11C  4B 4C C6 C8 */	b dKy_change_colpat__FUc
...
/* 80CDC170  4B 36 C0 0C */	b cutEnd__16dEvent_manager_cFi
...
/* 80CDC190  4B 36 BF EC */	b cutEnd__16dEvent_manager_cFi
...
/* 80CDC1B8  4B 35 0E B4 */	b dComIfGp_getReverb__Fi
...
/* 80CDC1CC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CDC1D0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CDC1D4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80CDC1D8  38 81 00 08 */	addi r4, r1, 8
/* 80CDC1DC  38 BE 05 38 */	addi r5, r30, 0x538
/* 80CDC1E0  38 C0 00 00 */	li r6, 0
/* 80CDC1E4  3D 00 80 CE */	lis r8, lit_3825@ha
/* 80CDC1E8  C0 28 CC 04 */	lfs f1, lit_3825@l(r8)
/* 80CDC1EC  FC 40 08 90 */	fmr f2, f1
/* 80CDC1F0  3D 00 80 CE */	lis r8, lit_3826@ha
/* 80CDC1F4  C0 68 CC 08 */	lfs f3, lit_3826@l(r8)
/* 80CDC1F8  FC 80 18 90 */	fmr f4, f3
/* 80CDC1FC  39 00 00 00 */	li r8, 0
/* 80CDC200  4B 5C F7 84 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CDC204  7F E3 FB 78 */	mr r3, r31
/* 80CDC208  80 9E 05 B4 */	lwz r4, 0x5b4(r30)
/* 80CDC20C  4B 36 BF 70 */	b cutEnd__16dEvent_manager_cFi
lbl_80CDC210:
...
/* 80CDC228  4B 36 BF 54 */	b cutEnd__16dEvent_manager_cFi
lbl_80CDC22C:
/* 80CDC22C  38 60 00 00 */	li r3, 0
/* 80CDC230  39 61 00 20 */	addi r11, r1, 0x20
/* 80CDC234  4B 68 5F F4 */	b _restgpr_29

...
/* 80CDC560 00000018  3C 60 80 CE */	lis r3, lit_3705@ha
/* 80CDC564 0000001C  38 83 CB F4 */	addi r4, r3, lit_3705@l
/* 80CDC568 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CDC56C 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CDC570 00000028  83 E3 5D AC */	lwz r31, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80CDC574 0000002C  C0 24 00 04 */	lfs f1, 4(r4)	/* effective address: 80CDCBF8 */
/* 80CDC578 00000030  D0 21 00 08 */	stfs f1, 8(r1)
/* 80CDC57C 00000034  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80CDC580 00000038  C0 04 00 1C */	lfs f0, 0x1c(r4)	/* effective address: 80CDCC10 */
...
/* 80CDC59C 00000054  C0 04 00 20 */	lfs f0, 0x20(r4)	/* effective address: 80CDCC14 */
/* 80CDC5A0 00000058  D0 01 00 10 */	stfs f0, 0x10(r1)
lbl_80CDC5A4:
/* 80CDC5A4 00000000  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80CDC5A8 00000004  4B 33 07 BC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CDC5AC 00000008  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDC5B0 0000000C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CDC5B4 00000010  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80CDC5B8 00000014  4B 32 FE 7C */	b mDoMtx_YrotM__FPA4_fs
/* 80CDC5BC 00000018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDC5C0 0000001C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CDC5C4 00000020  38 81 00 08 */	addi r4, r1, 8
/* 80CDC5C8 00000024  7C 85 23 78 */	mr r5, r4
/* 80CDC5CC 00000028  4B 66 A7 A0 */	b PSMTXMultVec

...
/* 80CF3BAC 00000024  4B 33 94 C0 */	b dComIfGp_getReverb__Fi
...
/* 80CF3BC0 00000038  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CF3BC4 0000003C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CF3BC8 00000040  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CF3BD8 00000050  3D 00 80 CF */	lis r8, lit_3918@ha
/* 80CF3BDC 00000054  C0 28 44 04 */	lfs f1, lit_3918@l(r8)
/* 80CF3BE0 00000058  FC 40 08 90 */	fmr f2, f1
/* 80CF3BE4 0000005C  3D 00 80 CF */	lis r8, lit_4032@ha
/* 80CF3BE8 00000060  C0 68 44 08 */	lfs f3, lit_4032@l(r8)
/* 80CF3BEC 00000064  FC 80 18 90 */	fmr f4, f3
/* 80CF3BF0 00000068  39 00 00 00 */	li r8, 0
/* 80CF3BF4 0000006C  4B 5B 7D 90 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CF3BF8 00000070  3C 60 80 CF */	lis r3, lit_3918@ha
/* 80CF3BFC 00000074  C0 03 44 04 */	lfs f0, lit_3918@l(r3)
...
/* 80CF3C2C 00000018  4B 33 94 40 */	b dComIfGp_getReverb__Fi
...
/* 80CF3C40 0000002C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CF3C44 00000030  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CF3C48 00000034  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CF3C58 00000044  3D 00 80 CF */	lis r8, lit_3918@ha
/* 80CF3C5C 00000048  C0 28 44 04 */	lfs f1, lit_3918@l(r8)
/* 80CF3C60 0000004C  FC 40 08 90 */	fmr f2, f1
/* 80CF3C64 00000050  3D 00 80 CF */	lis r8, lit_4032@ha
/* 80CF3C68 00000054  C0 68 44 08 */	lfs f3, lit_4032@l(r8)
/* 80CF3C6C 00000058  FC 80 18 90 */	fmr f4, f3
/* 80CF3C70 0000005C  39 00 00 00 */	li r8, 0
/* 80CF3C74 00000060  4B 5B 7D 10 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CF3C78 00000064  3C 60 80 CF */	lis r3, lit_4032@ha
/* 80CF3C7C 00000068  C0 03 44 08 */	lfs f0, lit_4032@l(r3)
/* 80CF3C80 0000006C  80 7F 05 88 */	lwz r3, 0x588(r31)
/* 80CF3C84 00000070  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 80CF3C88 00000074  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CF3C8C 00000078  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CF3CA0 0000008C  4B 34 16 10 */	b offSwitch__10dSv_info_cFii
...
/* 80CF3CB4 00000004  4B 31 97 74 */	b play__14mDoExt_baseAnmFv
/* 80CF3CB8 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CF3CBC 0000000C  41 82 00 58 */	beq lbl_80CF3D14
/* 80CF3CC0 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CF3CC4 00000014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CF3CD8 00000028  4B 34 15 28 */	b onSwitch__10dSv_info_cFii
...
/* 80CF3CF8 00000048  4B 35 4C 48 */	b orderEvent__17dEvLib_callback_cFiii
lbl_80CF3CFC:
...
/* 80CF3D1C 00000008  4B 33 93 50 */	b dComIfGp_getReverb__Fi
...
/* 80CF3D30 0000001C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CF3D34 00000020  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CF3D38 00000024  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CF3D48 00000034  3D 00 80 CF */	lis r8, lit_3918@ha
/* 80CF3D4C 00000038  C0 28 44 04 */	lfs f1, lit_3918@l(r8)
/* 80CF3D50 0000003C  FC 40 08 90 */	fmr f2, f1
/* 80CF3D54 00000040  3D 00 80 CF */	lis r8, lit_4032@ha
/* 80CF3D58 00000044  C0 68 44 08 */	lfs f3, lit_4032@l(r8)
/* 80CF3D5C 00000048  FC 80 18 90 */	fmr f4, f3
/* 80CF3D60 0000004C  39 00 00 00 */	li r8, 0
/* 80CF3D64 00000050  4B 5B 87 A8 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80CF3D68:

...
/* 80BAC1A4  4B 7B 60 2C */	b _savegpr_26
/* 80BAC1A8  7C 7B 1B 78 */	mr r27, r3
/* 80BAC1AC  3C 80 80 BB */	lis r4, cNullVec__6Z2Calc@ha
/* 80BAC1B0  3B C4 CA 70 */	addi r30, r4, cNullVec__6Z2Calc@l
/* 80BAC1B4  3C 80 80 BB */	lis r4, lit_3774@ha
/* 80BAC1B8  3B E4 C9 70 */	addi r31, r4, lit_3774@l
...
/* 80BAC1E0  4B 5B 1E 30 */	b __ct__9dInsect_cFv
/* 80BAC1E4  3C 60 80 BB */	lis r3, __vt__12daObjBATTA_c@ha
/* 80BAC1E8  38 03 CC 58 */	addi r0, r3, __vt__12daObjBATTA_c@l
/* 80BAC1EC  90 1C 05 68 */	stw r0, 0x568(r28)
/* 80BAC1F0  38 7C 05 90 */	addi r3, r28, 0x590
/* 80BAC1F4  4B 71 41 D4 */	b __ct__10Z2CreatureFv
/* 80BAC1F8  38 7C 06 2C */	addi r3, r28, 0x62c
/* 80BAC1FC  4B 4C 9C B0 */	b __ct__12dBgS_AcchCirFv
/* 80BAC200  3B 5C 06 6C */	addi r26, r28, 0x66c
/* 80BAC204  7F 43 D3 78 */	mr r3, r26
/* 80BAC208  4B 4C 9E 98 */	b __ct__9dBgS_AcchFv
/* 80BAC20C  3C 60 80 BB */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80BAC210  38 63 CC 34 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80BAC22C  4B 4C CC 3C */	b SetObj__16dBgS_PolyPassChkFv
/* 80BAC230  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80BAC234  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80BAC238  90 1C 08 5C */	stw r0, 0x85c(r28)
/* 80BAC23C  38 7C 08 60 */	addi r3, r28, 0x860
/* 80BAC240  4B 4D 75 20 */	b __ct__10dCcD_GSttsFv
/* 80BAC244  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80BAC248  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80BAC260  4B 4D 77 C8 */	b __ct__12dCcD_GObjInfFv
/* 80BAC264  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80BAC268  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80BAC26C  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80BAC270  3C 60 80 BB */	lis r3, __vt__8cM3dGAab@ha
/* 80BAC274  38 03 CC 28 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80BAC278  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80BAC27C  3C 60 80 BB */	lis r3, __vt__8cM3dGSph@ha
/* 80BAC280  38 03 CC 1C */	addi r0, r3, __vt__8cM3dGSph@l
/* 80BAC284  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80BAC288  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 80BAC28C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 80BAC290  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80BAC294  38 03 00 58 */	addi r0, r3, 0x58
/* 80BAC298  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80BAC29C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 80BAC2A0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 80BAC2C8  3C 80 80 BB */	lis r4, stringBase0@ha
/* 80BAC2CC  38 84 CA 64 */	addi r4, r4, stringBase0@l
/* 80BAC2D0  4B 48 0B EC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BAC318  3C 60 80 BB */	lis r3, l_HIO@ha
/* 80BAC31C  38 63 CC 98 */	addi r3, r3, l_HIO@l
/* 80BAC320  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80BACCA0 */
...
lbl_80BAC334:
/* 80BAC334  3C 60 80 BB */	lis r3, l_HIO@ha
/* 80BAC338  38 63 CC 98 */	addi r3, r3, l_HIO@l
/* 80BAC33C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80BACCA4 */
...
/* 80BAC394  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAC398  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BAC3AC  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BAC3B0  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80BAC3B4  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BAC3B8  4B 48 86 04 */	b isEventBit__11dSv_event_cCFUs
...
/* 80BAC3D4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BAC3D8  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80BAC3DC  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BAC3E0  4B 48 85 DC */	b isEventBit__11dSv_event_cCFUs
...
lbl_80BAC3F4:
/* 80BAC3F4  3C 60 80 BB */	lis r3, stringBase0@ha
/* 80BAC3F8  38 63 CA 64 */	addi r3, r3, stringBase0@l
/* 80BAC3FC  38 63 00 04 */	addi r3, r3, 4
/* 80BAC400  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80BAC404  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80BAC408  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80BAC40C  4B 7B C5 88 */	b strcmp
/* 80BAC410  2C 03 00 00 */	cmpwi r3, 0
/* 80BAC414  40 82 00 AC */	bne lbl_80BAC4C0
/* 80BAC418  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAC41C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BAC420  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80BAC424  2C 00 00 03 */	cmpwi r0, 3
/* 80BAC428  40 82 00 98 */	bne lbl_80BAC4C0
/* 80BAC42C  88 7B 05 80 */	lbz r3, 0x580(r27)
/* 80BAC430  4B 62 DB 0C */	b isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
/* 80BAC450  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAC454  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BAC458  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BAC45C  A0 1F 00 EC */	lhz r0, 0xec(r31)
/* 80BAC460  54 00 08 3C */	slwi r0, r0, 1
/* 80BAC464  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BAC468  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80BAC46C  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BAC470  4B 48 85 4C */	b isEventBit__11dSv_event_cCFUs
...
/* 80BAC488  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAC48C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BAC4A0  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BAC4A4  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80BAC4A8  7C 84 02 2E */	lhzx r4, r4, r0
/* 80BAC4AC  4B 48 85 10 */	b isEventBit__11dSv_event_cCFUs
...
/* 80BAC4CC  3C 80 80 BB */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80BAC4D0  38 84 9F 00 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80BAC4D4  38 A0 0B 00 */	li r5, 0xb00
/* 80BAC4D8  4B 46 DF D8 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80BAC4EC:
/* 80BAC4EC  3C 60 80 BB */	lis r3, data_80BACC88@ha
/* 80BAC4F0  8C 03 CC 88 */	lbzu r0, data_80BACC88@l(r3)
...
/* 80BAC50C  3C 60 80 BB */	lis r3, l_HIO@ha
/* 80BAC510  38 63 CC 98 */	addi r3, r3, l_HIO@l
/* 80BAC514  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80BACC9C */
lbl_80BAC518:
...
/* 80BAC538  4B 46 DF F0 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80BAC54C  4B 46 DF EC */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80BAC578  4B 71 3F B8 */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80BAC5A0  4B 4D 72 C0 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80BAC5A4  38 7B 08 80 */	addi r3, r27, 0x880
/* 80BAC5A8  38 9E 00 20 */	addi r4, r30, 0x20
/* 80BAC5AC  4B 4D 84 88 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80BAC614  4B 4C 9C 34 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80BAC618  38 7B 06 80 */	addi r3, r27, 0x680
/* 80BAC61C  4B 4C C8 4C */	b SetObj__16dBgS_PolyPassChkFv
/* 80BAC620  38 7B 06 2C */	addi r3, r27, 0x62c
/* 80BAC624  C0 3F 00 A4 */	lfs f1, 0xa4(r31)
/* 80BAC628  FC 40 08 90 */	fmr f2, f1
/* 80BAC62C  4B 4C 99 2C */	b SetWall__12dBgS_AcchCirFff
...
/* 80BAC644  4B 6B B3 48 */	b cM_rndFX__Ff
...
/* 80BAC68C  4B 7B 5B 90 */	b _restgpr_26

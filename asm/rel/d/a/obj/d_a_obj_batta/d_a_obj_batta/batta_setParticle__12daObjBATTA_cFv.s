...
/* 80BABAB4  4B 7B 65 F8 */	b __cvt_fp2unsigned
...
/* 80BABAC8  3C 80 80 BB */	lis r4, lit_3956@ha
/* 80BABACC  C0 24 C9 8C */	lfs f1, lit_3956@l(r4)
/* 80BABAD0  3C 80 80 BB */	lis r4, lit_3774@ha
/* 80BABAD4  C0 44 C9 70 */	lfs f2, lit_3774@l(r4)
/* 80BABAD8  4B 6C 4C 68 */	b cLib_chaseF__FPfff
/* 80BABADC  48 00 00 18 */	b lbl_80BABAF4
lbl_80BABAE0:
/* 80BABAE0  38 7F 09 CC */	addi r3, r31, 0x9cc
/* 80BABAE4  3C 80 80 BB */	lis r4, lit_3774@ha
/* 80BABAE8  C0 24 C9 70 */	lfs f1, lit_3774@l(r4)
/* 80BABAEC  FC 40 08 90 */	fmr f2, f1
/* 80BABAF0  4B 6C 4C 50 */	b cLib_chaseF__FPfff
lbl_80BABAF4:
/* 80BABAF4  88 1F 09 F0 */	lbz r0, 0x9f0(r31)
/* 80BABAF8  28 00 00 02 */	cmplwi r0, 2
/* 80BABAFC  41 82 01 90 */	beq lbl_80BABC8C
/* 80BABB00  3C 60 80 BB */	lis r3, stringBase0@ha
/* 80BABB04  38 63 CA 64 */	addi r3, r3, stringBase0@l
/* 80BABB08  38 63 00 04 */	addi r3, r3, 4
/* 80BABB0C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80BABB10  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80BABB14  3B C4 4E 00 */	addi r30, r4, 0x4e00
/* 80BABB18  7F C4 F3 78 */	mr r4, r30
/* 80BABB1C  4B 7B CE 78 */	b strcmp
/* 80BABB20  2C 03 00 00 */	cmpwi r3, 0
/* 80BABB24  40 82 00 34 */	bne lbl_80BABB58
/* 80BABB28  3C 60 80 BB */	lis r3, stringBase0@ha
/* 80BABB2C  38 63 CA 64 */	addi r3, r3, stringBase0@l
/* 80BABB30  38 63 00 04 */	addi r3, r3, 4
/* 80BABB34  7F C4 F3 78 */	mr r4, r30
/* 80BABB38  4B 7B CE 5C */	b strcmp
/* 80BABB3C  2C 03 00 00 */	cmpwi r3, 0
/* 80BABB40  40 82 01 4C */	bne lbl_80BABC8C
/* 80BABB44  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BABB48  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BABB4C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80BABB50  2C 00 00 03 */	cmpwi r0, 3
/* 80BABB54  41 82 01 38 */	beq lbl_80BABC8C
lbl_80BABB58:
/* 80BABB58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BABB5C  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80BABB60  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80BABBA4  3D 60 80 BB */	lis r11, lit_3774@ha
/* 80BABBA8  C0 2B C9 70 */	lfs f1, lit_3774@l(r11)
/* 80BABBAC  4B 4A 19 20 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BABBC0  4B 49 FD 58 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80BABC24  3D 60 80 BB */	lis r11, lit_3774@ha
/* 80BABC28  C0 2B C9 70 */	lfs f1, lit_3774@l(r11)
/* 80BABC2C  4B 4A 18 A0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BABC40  4B 49 FC D8 */	b getEmitter__Q213dPa_control_c7level_cFUl

...
/* 80BAB538  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80BAB53C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80BAB5B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAB5B8  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80BAB5BC  80 64 5D AC */	lwz r3, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80BAB5C0  A8 63 04 DE */	lha r3, 0x4de(r3)	/* effective address: 804004DE */
...
/* 80BAB5E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BAB5EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BAB5F0  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
...
/* 80BAB65C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80BACB30 */
/* 80BAB660  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80BACB34 */
/* 80BAB664  90 61 00 1C */	stw r3, 0x1c(r1)
/* 80BAB668  90 01 00 20 */	stw r0, 0x20(r1)
/* 80BAB66C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80BACB38 */
...
/* 80BAB68C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80BACB3C */
/* 80BAB690  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80BACB40 */
/* 80BAB694  90 61 00 10 */	stw r3, 0x10(r1)
/* 80BAB698  90 01 00 14 */	stw r0, 0x14(r1)
/* 80BAB69C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80BACB44 */

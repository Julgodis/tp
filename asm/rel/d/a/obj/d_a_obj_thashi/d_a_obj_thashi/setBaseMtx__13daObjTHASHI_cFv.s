...
/* 80D0C380  3C 60 80 D1 */	lis r3, lit_4521@ha
/* 80D0C384  38 63 D3 38 */	addi r3, r3, lit_4521@l
...
/* 80D0C39C  4B 30 09 C8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D0C3A0  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80D0C3A4  4B 30 0B A0 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D0C3A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C3AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C3B0  80 9E 10 D4 */	lwz r4, 0x10d4(r30)
/* 80D0C3B4  38 84 00 24 */	addi r4, r4, 0x24
/* 80D0C3B8  4B 63 A0 F8 */	b PSMTXCopy
/* 80D0C3BC  48 00 02 34 */	b lbl_80D0C5F0
lbl_80D0C3C0:
/* 80D0C3C0  3B 40 00 00 */	li r26, 0
/* 80D0C3C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C3C8  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l
...
/* 80D0C3E0  4B 30 09 84 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D0C3E4  1C 7C 00 06 */	mulli r3, r28, 6
/* 80D0C3E8  38 63 0D 48 */	addi r3, r3, 0xd48
/* 80D0C3EC  7C 7E 1A 14 */	add r3, r30, r3
/* 80D0C3F0  4B 30 0B 54 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D0C3F4  38 7B 0A E8 */	addi r3, r27, 0xae8
/* 80D0C3F8  4B 30 0A 78 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
...
/* 80D0C410  4B 63 A0 A0 */	b PSMTXCopy
...
/* 80D0C42C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80D0C430  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80D0C448  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C44C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D0C468  4B 63 A4 80 */	b PSMTXTrans
/* 80D0C46C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C470  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C474  A8 9E 05 BA */	lha r4, 0x5ba(r30)
/* 80D0C478  4B 2F FF BC */	b mDoMtx_YrotM__FPA4_fs
/* 80D0C47C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C480  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C484  A8 9E 05 BC */	lha r4, 0x5bc(r30)
/* 80D0C488  4B 30 00 44 */	b mDoMtx_ZrotM__FPA4_fs
/* 80D0C48C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C490  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C494  A8 9E 05 B8 */	lha r4, 0x5b8(r30)
/* 80D0C498  4B 2F FF 04 */	b mDoMtx_XrotM__FPA4_fs
/* 80D0C49C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C4A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C4A4  A8 1E 05 BA */	lha r0, 0x5ba(r30)
/* 80D0C4A8  7C 00 00 D0 */	neg r0, r0
/* 80D0C4AC  7C 04 07 34 */	extsh r4, r0
/* 80D0C4B0  4B 2F FF 84 */	b mDoMtx_YrotM__FPA4_fs
/* 80D0C4B4  C0 3F 00 40 */	lfs f1, 0x40(r31)
/* 80D0C4B8  C0 5F 00 A0 */	lfs f2, 0xa0(r31)
/* 80D0C4BC  FC 60 08 90 */	fmr f3, f1
/* 80D0C4C0  4B 30 08 DC */	b transM__14mDoMtx_stack_cFfff
/* 80D0C4C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C4C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C4CC  80 9E 11 A4 */	lwz r4, 0x11a4(r30)
/* 80D0C4D0  38 84 00 24 */	addi r4, r4, 0x24
/* 80D0C4D4  4B 63 9F DC */	b PSMTXCopy
/* 80D0C4D8  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80D0C4DC  4B 30 08 88 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D0C4E0  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80D0C4E4  4B 30 0A 60 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D0C4E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C4EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C4F0  80 9E 10 D8 */	lwz r4, 0x10d8(r30)
/* 80D0C4F4  38 84 00 24 */	addi r4, r4, 0x24
/* 80D0C4F8  4B 63 9F B8 */	b PSMTXCopy
/* 80D0C4FC  48 00 00 F4 */	b lbl_80D0C5F0
lbl_80D0C500:
/* 80D0C500  3B 40 00 00 */	li r26, 0
/* 80D0C504  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C508  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
...
/* 80D0C520  4B 30 08 44 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D0C524  1C 7B 00 06 */	mulli r3, r27, 6
/* 80D0C528  38 63 0D 48 */	addi r3, r3, 0xd48
/* 80D0C52C  7C 7E 1A 14 */	add r3, r30, r3
/* 80D0C530  4B 30 0A 14 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D0C534  38 7C 0A E8 */	addi r3, r28, 0xae8
/* 80D0C538  4B 30 09 38 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
...
/* 80D0C550  4B 63 9F 60 */	b PSMTXCopy
...
/* 80D0C56C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C570  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
...
/* 80D0C588  4B 30 07 DC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D0C58C  1C 7B 00 06 */	mulli r3, r27, 6
/* 80D0C590  38 63 0D 48 */	addi r3, r3, 0xd48
/* 80D0C594  7C 7E 1A 14 */	add r3, r30, r3
/* 80D0C598  4B 30 09 AC */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D0C59C  38 7C 0A E8 */	addi r3, r28, 0xae8
/* 80D0C5A0  4B 30 08 D0 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
...
/* 80D0C5B8  4B 63 9E F8 */	b PSMTXCopy
...
/* 80D0C5D0  4B 30 07 94 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D0C5D4  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80D0C5D8  4B 30 09 6C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D0C5DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D0C5E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0C5E4  80 9E 10 D8 */	lwz r4, 0x10d8(r30)
/* 80D0C5E8  38 84 00 24 */	addi r4, r4, 0x24
/* 80D0C5EC  4B 63 9E C4 */	b PSMTXCopy
lbl_80D0C5F0:
/* 80D0C5F0  39 61 00 20 */	addi r11, r1, 0x20
/* 80D0C5F4  4B 65 5C 28 */	b _restgpr_26

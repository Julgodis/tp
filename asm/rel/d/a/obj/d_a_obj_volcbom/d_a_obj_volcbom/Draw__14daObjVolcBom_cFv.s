...
/* 80D264F8  4B 63 BC E4 */	b _savegpr_29
/* 80D264FC  7C 7D 1B 78 */	mr r29, r3
/* 80D26500  3C 60 80 D2 */	lis r3, l_midna_offset@ha
/* 80D26504  3B C3 6B 5C */	addi r30, r3, l_midna_offset@l
...
lbl_80D2651C:
/* 80D2651C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D26520  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D26524  38 80 00 00 */	li r4, 0
/* 80D26528  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80D2652C  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80D26530  4B 47 D2 94 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D26534  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D26538  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D2653C  80 9D 05 A8 */	lwz r4, 0x5a8(r29)
/* 80D26540  80 84 00 04 */	lwz r4, 4(r4)
/* 80D26544  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80D26548  4B 47 E8 58 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D2654C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D26550  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80D26554  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80D26558  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80D2655C  3B E3 4A C8 */	addi r31, r3, j3dSys@l
/* 80D26560  90 1F 00 48 */	stw r0, 0x48(r31)	/* effective address: 80434B10 */
/* 80D26564  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80D26568  90 1F 00 4C */	stw r0, 0x4c(r31)	/* effective address: 80434B14 */
...
/* 80D26580  4B 2E 71 58 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80D26598  4B 2E 72 10 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80D265B8  4B 2E 74 14 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80D265BC:
...
/* 80D265CC  4B 2E 76 F8 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D26608  4B 2E 77 E8 */	b mDoExt_btkAnmRemove__FP12J3DModelData
/* 80D2660C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D26610  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D26614  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80D26618  90 1F 00 48 */	stw r0, 0x48(r31)
/* 80D2661C  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
...
/* 80D26674  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80D26678  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80D2667C  4B 30 82 94 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 80D26690  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D26694  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D26698  80 9D 05 B8 */	lwz r4, 0x5b8(r29)
/* 80D2669C  80 84 00 04 */	lwz r4, 4(r4)
/* 80D266A0  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80D266A4  4B 47 E6 FC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D266BC  4B 2E 70 1C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80D266D4  4B 2E 70 D4 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80D266D8  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 80D266DC  4B 2E 75 E8 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_80D266E0:
/* 80D266E0  38 60 00 01 */	li r3, 1
lbl_80D266E4:
/* 80D266E4  39 61 00 20 */	addi r11, r1, 0x20
/* 80D266E8  4B 63 BB 40 */	b _restgpr_29

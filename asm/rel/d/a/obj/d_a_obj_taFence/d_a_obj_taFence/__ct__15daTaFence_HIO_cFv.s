...
/* 80D04E8C  C0 05 00 00 */	lfs f0, 0(r5)	/* effective address: 80D060E0 */
/* 80D04E90  D0 03 00 04 */	stfs f0, 4(r3)
/* 80D04E94  C0 05 00 04 */	lfs f0, 4(r5)	/* effective address: 80D060E4 */
/* 80D04E98  D0 03 00 08 */	stfs f0, 8(r3)
/* 80D04E9C  38 00 00 04 */	li r0, 4
/* 80D04EA0  98 03 00 0C */	stb r0, 0xc(r3)
/* 80D04EA4  C0 05 00 08 */	lfs f0, 8(r5)	/* effective address: 80D060E8 */
/* 80D04EA8  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 80D04EAC  C0 85 00 0C */	lfs f4, 0xc(r5)	/* effective address: 80D060EC */
/* 80D04EB0  D0 83 00 14 */	stfs f4, 0x14(r3)
/* 80D04EB4  C0 65 00 10 */	lfs f3, 0x10(r5)	/* effective address: 80D060F0 */
/* 80D04EB8  D0 63 00 18 */	stfs f3, 0x18(r3)
/* 80D04EBC  C0 25 00 14 */	lfs f1, 0x14(r5)	/* effective address: 80D060F4 */
/* 80D04EC0  D0 23 00 1C */	stfs f1, 0x1c(r3)
/* 80D04EC4  C0 05 00 18 */	lfs f0, 0x18(r5)	/* effective address: 80D060F8 */
/* 80D04EC8  D0 03 00 20 */	stfs f0, 0x20(r3)
/* 80D04ECC  C0 45 00 1C */	lfs f2, 0x1c(r5)	/* effective address: 80D060FC */
...
/* 80D04EEC  C0 05 00 20 */	lfs f0, 0x20(r5)	/* effective address: 80D06100 */
/* 80D04EF0  D0 03 00 40 */	stfs f0, 0x40(r3)
/* 80D04EF4  D0 83 00 44 */	stfs f4, 0x44(r3)
/* 80D04EF8  D0 63 00 48 */	stfs f3, 0x48(r3)
/* 80D04EFC  C0 25 00 24 */	lfs f1, 0x24(r5)	/* effective address: 80D06104 */
/* 80D04F00  D0 23 00 4C */	stfs f1, 0x4c(r3)
/* 80D04F04  C0 05 00 28 */	lfs f0, 0x28(r5)	/* effective address: 80D06108 */
/* 80D04F08  D0 03 00 50 */	stfs f0, 0x50(r3)
/* 80D04F0C  D0 43 00 54 */	stfs f2, 0x54(r3)
/* 80D04F10  C0 05 00 2C */	lfs f0, 0x2c(r5)	/* effective address: 80D0610C */
...
/* 80D04F28  C0 05 00 30 */	lfs f0, 0x30(r5)	/* effective address: 80D06110 */

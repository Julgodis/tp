...
/* 80D05BD0 0000001C  4B 56 26 04 */	b ChkUsed__9cBgW_BgIdCFv
/* 80D05BD4 00000020  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D05BD8 00000024  41 82 00 18 */	beq lbl_80D05BF0
/* 80D05BDC 00000028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D05BE0 0000002C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D05BE4 00000030  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D05BE8 00000034  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80D05BEC 00000038  4B 36 E6 64 */	b Release__4cBgSFP9dBgW_Base
lbl_80D05BF0:
/* 80D05BF0 00000000  3C 60 80 D0 */	lis r3, l_HIO@ha
/* 80D05BF4 00000004  38 63 63 3C */	addi r3, r3, l_HIO@l
/* 80D05BF8 00000008  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80D06344 */
/* 80D05BFC 0000000C  D0 1F 13 80 */	stfs f0, 0x1380(r31)
/* 80D05C00 00000010  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80D06340 */
/* 80D05C04 00000014  D0 1F 05 2C */	stfs f0, 0x52c(r31)
/* 80D05C08 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D05C0C 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D05C10 00000020  80 83 5D AC */	lwz r4, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80D05C20 00000030  4B 56 0F 14 */	b __mi__4cXyzCFRC3Vec
...
/* 80D05C3C 0000004C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D05C40 00000050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D05C50 00000060  4B 30 67 8C */	b mDoMtx_YrotS__FPA4_fs
/* 80D05C54 00000064  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D05C58 00000068  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D05C5C 0000006C  38 81 00 14 */	addi r4, r1, 0x14
/* 80D05C60 00000070  7C 85 23 78 */	mr r5, r4
/* 80D05C64 00000074  4B 64 11 08 */	b PSMTXMultVec
/* 80D05C68 00000078  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80D05C6C 0000007C  3C 60 80 D0 */	lis r3, lit_3651@ha
/* 80D05C70 00000080  C0 03 60 E0 */	lfs f0, lit_3651@l(r3)

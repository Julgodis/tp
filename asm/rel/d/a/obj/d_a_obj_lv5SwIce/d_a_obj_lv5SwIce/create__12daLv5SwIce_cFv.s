...
/* 80C6CB44  4B 40 BA E0 */	b __ct__16dBgS_MoveBgActorFv
/* 80C6CB48  3C 60 80 C7 */	lis r3, __vt__12daLv5SwIce_c@ha
/* 80C6CB4C  38 03 D6 74 */	addi r0, r3, __vt__12daLv5SwIce_c@l
/* 80C6CB50  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C6CB54  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C6CB58  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C6CB5C  90 1E 05 B8 */	stw r0, 0x5b8(r30)
/* 80C6CB60  38 7E 05 BC */	addi r3, r30, 0x5bc
/* 80C6CB64  4B 41 6B FC */	b __ct__10dCcD_GSttsFv
/* 80C6CB68  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C6CB6C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C6CB84  4B 41 6E A4 */	b __ct__12dCcD_GObjInfFv
/* 80C6CB88  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C6CB8C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C6CB90  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C6CB94  3C 60 80 C7 */	lis r3, __vt__8cM3dGAab@ha
/* 80C6CB98  38 03 D6 68 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C6CB9C  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C6CBA0  3C 60 80 C7 */	lis r3, __vt__8cM3dGCyl@ha
/* 80C6CBA4  38 03 D6 5C */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80C6CBA8  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C6CBAC  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C6CBB0  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80C6CBB4  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80C6CBB8  38 03 00 58 */	addi r0, r3, 0x58
/* 80C6CBBC  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C6CBC0  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C6CBC4  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C6CBFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6CC00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6CC04  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6CC08  7C 05 07 74 */	extsb r5, r0
/* 80C6CC0C  4B 3C 87 54 */	b isSwitch__10dSv_info_cCFii
...
/* 80C6CC24  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C6CC28  38 84 D5 58 */	addi r4, r4, stringBase0@l
/* 80C6CC2C  4B 3C 02 90 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C6CC40  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C6CC44  38 84 D5 58 */	addi r4, r4, stringBase0@l
/* 80C6CC48  38 A0 00 07 */	li r5, 7
/* 80C6CC4C  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C6CC50  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C6CC54  38 E0 14 B0 */	li r7, 0x14b0
/* 80C6CC58  39 00 00 00 */	li r8, 0
/* 80C6CC5C  4B 40 BB 60 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C6CC88  4B 3A D8 F0 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C6CC9C  4B 41 6B C4 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C6CCA0  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 80C6CCA4  3C 80 80 C7 */	lis r4, mCcDCyl__12daLv5SwIce_c@ha
/* 80C6CCA8  38 84 D5 80 */	addi r4, r4, mCcDCyl__12daLv5SwIce_c@l
/* 80C6CCAC  4B 41 7C 08 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl

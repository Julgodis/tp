...
/* 80B9FFDC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B9FFE0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B9FFE4  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80B9FFE8  7C 05 07 74 */	extsb r5, r0
/* 80B9FFEC  4B 49 52 14 */	b onSwitch__10dSv_info_cFii
/* 80B9FFF0  48 00 00 18 */	b lbl_80BA0008
lbl_80B9FFF4:
/* 80B9FFF4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B9FFF8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B9FFFC  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80BA0000  7C 05 07 74 */	extsb r5, r0
/* 80BA0004  4B 49 52 AC */	b offSwitch__10dSv_info_cFii
lbl_80BA0008:
/* 80BA0008  88 1E 07 75 */	lbz r0, 0x775(r30)
/* 80BA000C  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 80BA0010  41 82 00 20 */	beq lbl_80BA0030
/* 80BA0014  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BA0018  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BA001C  7F E4 FB 78 */	mr r4, r31
/* 80BA0020  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80BA0024  7C 05 07 74 */	extsb r5, r0
/* 80BA0028  4B 49 51 D8 */	b onSwitch__10dSv_info_cFii
/* 80BA002C  48 00 00 1C */	b lbl_80BA0048
lbl_80BA0030:
/* 80BA0030  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BA0034  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BA0038  7F E4 FB 78 */	mr r4, r31
/* 80BA003C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80BA0040  7C 05 07 74 */	extsb r5, r0
/* 80BA0044  4B 49 52 6C */	b offSwitch__10dSv_info_cFii
lbl_80BA0048:

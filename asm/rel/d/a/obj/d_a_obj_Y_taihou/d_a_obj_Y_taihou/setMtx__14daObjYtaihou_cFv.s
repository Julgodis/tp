...
/* 80BA009C 00000018  3C 60 00 00 */	lis r3, lit_3695@ha /* 80BA1154 */
/* 80BA00A0 0000001C  3B E3 00 00 */	addi r31, r3, lit_3695@l /* 80BA1154 */
/* 80BA00A4 00000020  A8 9E 04 B8 */	lha r4, 0x4b8(r30)
/* 80BA00A8 00000024  C0 5F 00 18 */	lfs f2, 0x18(r31)
...
/* 80BA00BC 00000038  C8 3F 00 30 */	lfd f1, 0x30(r31)
...
/* 80BA00F0 0000006C  3C 60 00 00 */	lis r3, data_80BA135C@ha /* 80BA135C */
/* 80BA00F4 00000070  38 83 00 00 */	addi r4, r3, data_80BA135C@l /* 80BA135C */
/* 80BA00F8 00000074  88 04 00 00 */	lbz r0, 0(r4)
/* 80BA00FC 00000078  7C 00 07 75 */	extsb. r0, r0
/* 80BA0100 0000007C  40 82 00 28 */	bne lbl_80BA0128
/* 80BA0104 00000080  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 80BA0108 00000084  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80BA010C 00000088  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
/* 80BA0110 0000008C  C0 03 0C CC */	lfs f0, 0xccc(r3)
/* 80BA0114 00000090  EC 01 00 32 */	fmuls f0, f1, f0
/* 80BA0118 00000094  3C 60 00 00 */	lis r3, data_80BA1358@ha /* 80BA1358 */
/* 80BA011C 00000098  D0 03 00 00 */	stfs f0, data_80BA1358@l(r3) /* 80BA1358 */
/* 80BA0120 0000009C  38 00 00 01 */	li r0, 1
/* 80BA0124 000000A0  98 04 00 00 */	stb r0, 0(r4)
lbl_80BA0128:
...
/* 80BA013C 00000014  4B FF F9 1D */	bl abs
/* 80BA0140 00000018  38 03 F3 34 */	addi r0, r3, -3276
/* 80BA0144 0000001C  C0 5F 00 20 */	lfs f2, 0x20(r31)
/* 80BA0148 00000020  3C 60 00 00 */	lis r3, data_80BA1358@ha /* 80BA1358 */
/* 80BA014C 00000024  C0 23 00 00 */	lfs f1, data_80BA1358@l(r3) /* 80BA1358 */
/* 80BA0150 00000028  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80BA0154 0000002C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80BA0180 00000058  C0 1F 00 24 */	lfs f0, 0x24(r31)
...
/* 80BA0190 00000068  C0 3F 00 28 */	lfs f1, 0x28(r31)
...
/* 80BA01A4 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80BA01A8 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80BA01BC 00000094  4B FF F8 9D */	bl PSMTXTrans
/* 80BA01C0 00000098  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80BA01C4 0000009C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80BA01C8 000000A0  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80BA01CC 000000A4  4B FF F8 8D */	bl mDoMtx_YrotM__FPA4_fs
/* 80BA01D0 000000A8  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80BA01D4 000000AC  FC 40 08 90 */	fmr f2, f1
/* 80BA01D8 000000B0  C0 7E 05 2C */	lfs f3, 0x52c(r30)
/* 80BA01DC 000000B4  4B FF F8 7D */	bl transM__14mDoMtx_stack_cFfff
/* 80BA01E0 000000B8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80BA01E4 000000BC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80BA01E8 000000C0  38 9E 05 B8 */	addi r4, r30, 0x5b8
/* 80BA01EC 000000C4  4B FF F8 6D */	bl PSMTXCopy

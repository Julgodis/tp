...
/* 80C497D0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C497D4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C497D8  88 9F 05 EB */	lbz r4, 0x5eb(r31)
/* 80C497DC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C497E0  7C 05 07 74 */	extsb r5, r0
/* 80C497E4  4B 3E BA 1C */	b onSwitch__10dSv_info_cFii
/* 80C497E8  88 1F 05 EA */	lbz r0, 0x5ea(r31)
/* 80C497EC  28 00 00 03 */	cmplwi r0, 3
/* 80C497F0  40 82 00 7C */	bne lbl_80C4986C
/* 80C497F4  3C 60 80 43 */	lis r3, g_meter2_info@ha
/* 80C497F8  38 63 01 88 */	addi r3, r3, g_meter2_info@l
/* 80C497FC  A0 03 00 B0 */	lhz r0, 0xb0(r3)	/* effective address: 80430238 */
/* 80C49800  60 00 00 02 */	ori r0, r0, 2
/* 80C49804  B0 03 00 B0 */	sth r0, 0xb0(r3)	/* effective address: 80430238 */
...
/* 80C49818  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4981C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C49820  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 80C49824  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */

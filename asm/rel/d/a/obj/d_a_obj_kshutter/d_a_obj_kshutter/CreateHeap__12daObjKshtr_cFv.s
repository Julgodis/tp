...
/* 80C47EB8  4B 71 A3 24 */	b _savegpr_29
/* 80C47EBC  7C 7E 1B 78 */	mr r30, r3
/* 80C47EC0  3C 60 80 C5 */	lis r3, cNullVec__6Z2Calc@ha
/* 80C47EC4  3B E3 9E 60 */	addi r31, r3, cNullVec__6Z2Calc@l
...
/* 80C47ED8  3C 80 80 C5 */	lis r4, l_bmd@ha
/* 80C47EDC  38 84 9C A8 */	addi r4, r4, l_bmd@l
/* 80C47EE0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C47EE4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C47EE8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C47EFC  4B 3F 43 F0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C47F0C  4B 3C CD 48 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C47F40  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C47F44  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C47F48  80 84 5D B4 */	lwz r4, 0x5db4(r4)	/* effective address: 8040BF74 */
/* 80C47F4C  80 04 05 74 */	lwz r0, 0x574(r4)	/* effective address: 80406734 */
...
/* 80C47F74  4B 3F 44 08 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80C47F78  7C 7D 1B 78 */	mr r29, r3
/* 80C47F7C  38 60 00 1C */	li r3, 0x1c
/* 80C47F80  4B 68 6C CC */	b __nw__FUl
/* 80C47F84  7C 7F 1B 79 */	or. r31, r3, r3
/* 80C47F88  41 82 00 20 */	beq lbl_80C47FA8
/* 80C47F8C  3C 80 80 C5 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C47F90  38 04 A0 B0 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C47F94  90 1F 00 00 */	stw r0, 0(r31)
/* 80C47F98  38 80 00 00 */	li r4, 0
/* 80C47F9C  4B 6E 04 60 */	b init__12J3DFrameCtrlFs
...
/* 80C47FC4  3C E0 80 C5 */	lis r7, lit_3842@ha
/* 80C47FC8  C0 27 9D 10 */	lfs f1, lit_3842@l(r7)
/* 80C47FCC  38 E0 00 00 */	li r7, 0
/* 80C47FD0  39 00 FF FF */	li r8, -1
/* 80C47FD4  39 20 00 00 */	li r9, 0
/* 80C47FD8  4B 3C 58 04 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C47FF4  4B 71 A2 34 */	b _restgpr_29

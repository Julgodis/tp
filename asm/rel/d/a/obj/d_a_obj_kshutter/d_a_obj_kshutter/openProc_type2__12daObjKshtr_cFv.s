...
/* 80C48FA4  4B 71 92 28 */	b _savegpr_25
/* 80C48FA8  7C 7D 1B 78 */	mr r29, r3
/* 80C48FAC  3C 60 80 C5 */	lis r3, l_bmd@ha
/* 80C48FB0  3B E3 9C A8 */	addi r31, r3, l_bmd@l
/* 80C48FB4  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 80C48FB8  4B 3C 44 70 */	b play__14mDoExt_baseAnmFv
...
/* 80C48FDC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C48FE0  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
/* 80C48FE4  3B 7F 00 84 */	addi r27, r31, 0x84
lbl_80C48FE8:
/* 80C48FE8  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80C48FEC  7C 04 07 74 */	extsb r4, r0
/* 80C48FF0  80 7A 5D 3C */	lwz r3, 0x5d3c(r26)	/* effective address: 8040BEFC */
...
/* 80C4902C  4B 40 3A 64 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C49060  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C49064  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C49078  4B 42 69 AC */	b StartShock__12dVibration_cFii4cXyz
lbl_80C4907C:
...
/* 80C49098  4B 3E 3F D4 */	b dComIfGp_getReverb__Fi
...
/* 80C490AC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C490B0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C490B4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C490D8  4B 66 28 AC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C490DC:
/* 80C490DC  7F C3 F3 78 */	mr r3, r30
/* 80C490E0  39 61 00 50 */	addi r11, r1, 0x50
/* 80C490E4  4B 71 91 34 */	b _restgpr_25

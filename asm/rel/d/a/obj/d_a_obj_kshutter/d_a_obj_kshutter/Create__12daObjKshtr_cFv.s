...
/* 80C47C24 00000010  4B 71 A5 B0 */	b _savegpr_27
/* 80C47C28 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C47C2C 00000018  3C 60 80 C5 */	lis r3, l_bmd@ha
/* 80C47C30 0000001C  3B E3 9C A8 */	addi r31, r3, l_bmd@l
/* 80C47C34 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C47C38 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C47C48 00000034  4B 3E D7 18 */	b isSwitch__10dSv_info_cCFii
...
/* 80C47C5C 00000048  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 80C49CFC */
/* 80C47C60 0000004C  D0 1E 05 FC */	stfs f0, 0x5fc(r30)
/* 80C47C64 00000050  C0 1E 05 54 */	lfs f0, 0x554(r30)
/* 80C47C68 00000054  C0 3F 00 58 */	lfs f1, 0x58(r31)	/* effective address: 80C49D00 */
...
/* 80C47CAC 0000000C  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 80C49CFC */
...
/* 80C47CDC 0000001C  C8 3F 00 60 */	lfd f1, 0x60(r31)	/* effective address: 80C49D08 */
...
lbl_80C47D00:
/* 80C47D00 00000000  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80C49D04 */
...
/* 80C47D5C 00000014  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 80C49CE4 */
/* 80C47D60 00000018  38 9F 00 3C */	addi r4, r31, 0x3c
/* 80C47D64 0000001C  C0 44 00 04 */	lfs f2, 4(r4)	/* effective address: 80C49CE8 */
/* 80C47D68 00000020  C0 64 00 08 */	lfs f3, 8(r4)	/* effective address: 80C49CEC */
/* 80C47D6C 00000024  C0 84 00 0C */	lfs f4, 0xc(r4)	/* effective address: 80C49CF0 */
/* 80C47D70 00000028  C0 A4 00 10 */	lfs f5, 0x10(r4)	/* effective address: 80C49CF4 */
/* 80C47D74 0000002C  C0 C4 00 14 */	lfs f6, 0x14(r4)	/* effective address: 80C49CF8 */
/* 80C47D78 00000030  4B 3D 27 D0 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C47D94 0000004C  3C 60 80 C5 */	lis r3, l_arcName@ha
/* 80C47D98 00000050  38 63 9E 80 */	addi r3, r3, l_arcName@l
...
/* 80C47DAC 00000064  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C47DB0 00000068  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C47DB4 0000006C  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 80C47DB8 00000070  3C 60 80 C5 */	lis r3, l_eventName@ha
/* 80C47DBC 00000074  3B A3 9E BC */	addi r29, r3, l_eventName@l
lbl_80C47DC0:
...
/* 80C47DE0 00000020  4B 3F F9 78 */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80C47E14 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C47E18 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C47E28 0000001C  4B 3F F8 70 */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cUc
...
/* 80C47E40 00000008  4B 71 A3 E0 */	b _restgpr_27

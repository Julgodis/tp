...
/* 80C8A530  4B 3E E0 F4 */	b __ct__16dBgS_MoveBgActorFv
/* 80C8A534  3C 60 80 C9 */	lis r3, __vt__12daOptiLift_c@ha
/* 80C8A538  38 03 BB 98 */	addi r0, r3, __vt__12daOptiLift_c@l
/* 80C8A53C  90 1F 05 9C */	stw r0, 0x59c(r31)
/* 80C8A540  3C 60 80 C9 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80C8A544  38 03 BB 8C */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80C8A548  94 1F 05 AC */	stwu r0, 0x5ac(r31)
/* 80C8A54C  7F E3 FB 78 */	mr r3, r31
/* 80C8A550  38 80 00 00 */	li r4, 0
/* 80C8A554  4B 69 DE A8 */	b init__12J3DFrameCtrlFs
...
/* 80C8A570  3C 80 80 C9 */	lis r4, stringBase0@ha
/* 80C8A574  38 84 BA 3C */	addi r4, r4, stringBase0@l
/* 80C8A578  4B 3A 29 44 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C8A58C  3C 80 80 C9 */	lis r4, stringBase0@ha
/* 80C8A590  38 84 BA 3C */	addi r4, r4, stringBase0@l
/* 80C8A594  38 A0 00 0B */	li r5, 0xb
/* 80C8A598  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C8A59C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C8A5A0  38 E0 0D 20 */	li r7, 0xd20
/* 80C8A5A4  39 00 00 00 */	li r8, 0
/* 80C8A5A8  4B 3E E2 14 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C8A5D4  4B 3C 72 18 */	b dPath_GetRoomPath__Fii
...
/* 80C8A61C  3C 60 80 C9 */	lis r3, mSpeed__12daOptiLift_c@ha
/* 80C8A620  38 63 B9 B0 */	addi r3, r3, mSpeed__12daOptiLift_c@l
/* 80C8A624  7C 03 04 2E */	lfsx f0, r3, r0
/* 80C8A628  D0 1E 05 E4 */	stfs f0, 0x5e4(r30)
/* 80C8A62C  3C 60 80 C9 */	lis r3, lit_3778@ha
/* 80C8A630  C0 03 B9 F4 */	lfs f0, lit_3778@l(r3)
...
/* 80C8A64C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C8A650  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C8A654  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C8A658  4B 3E 9B F8 */	b Release__4cBgSFP9dBgW_Base
lbl_80C8A65C:
/* 80C8A65C  38 00 00 00 */	li r0, 0
/* 80C8A660  98 1E 06 15 */	stb r0, 0x615(r30)
/* 80C8A664  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C8A668  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C8A66C  88 9E 05 C4 */	lbz r4, 0x5c4(r30)
/* 80C8A670  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C8A674  7C 05 07 74 */	extsb r5, r0
/* 80C8A678  4B 3A AC E8 */	b isSwitch__10dSv_info_cCFii
...
/* 80C8A6A8  4B 38 FE D0 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80C8A6AC  7F C3 F3 78 */	mr r3, r30
/* 80C8A6B0  4B FF FD 01 */	bl setBaseMtx__12daOptiLift_cFv
/* 80C8A6B4  3C 60 80 C9 */	lis r3, rideCallBack__12daOptiLift_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C8A6B8  38 03 A7 D0 */	addi r0, r3, rideCallBack__12daOptiLift_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
...
/* 80C8A6FC  3C 80 80 C9 */	lis r4, l_HIO@ha
/* 80C8A700  38 84 BB EC */	addi r4, r4, l_HIO@l
/* 80C8A704  88 04 00 07 */	lbz r0, 7(r4)	/* effective address: 80C8BBF3 */
/* 80C8A708  98 03 00 00 */	stb r0, 0(r3)
/* 80C8A70C  88 04 00 08 */	lbz r0, 8(r4)	/* effective address: 80C8BBF4 */
/* 80C8A710  98 03 00 01 */	stb r0, 1(r3)
/* 80C8A714  88 04 00 09 */	lbz r0, 9(r4)	/* effective address: 80C8BBF5 */

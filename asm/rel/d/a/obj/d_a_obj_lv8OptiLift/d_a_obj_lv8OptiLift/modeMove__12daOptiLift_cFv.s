...
/* 80C8ABD4  4B 6D 76 08 */	b _savegpr_29
/* 80C8ABD8  7C 7E 1B 78 */	mr r30, r3
/* 80C8ABDC  3C 60 80 C9 */	lis r3, lit_3661@ha
/* 80C8ABE0  3B E3 B9 AC */	addi r31, r3, lit_3661@l
...
/* 80C8AC20  4B 5D BF 14 */	b __mi__4cXyzCFRC3Vec
/* 80C8AC24  38 61 00 20 */	addi r3, r1, 0x20
/* 80C8AC28  4B 6B C5 10 */	b PSVECSquareMag
...
/* 80C8AC98  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8AC9C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C8AD08  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8AD0C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C8AD10:
...
/* 80C8AD44  4B 5D BD F0 */	b __mi__4cXyzCFRC3Vec
/* 80C8AD48  38 61 00 14 */	addi r3, r1, 0x14
/* 80C8AD4C  4B 6B C3 EC */	b PSVECSquareMag
...
/* 80C8ADBC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8ADC0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C8AE2C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C8AE30  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C8AE34:
...
/* 80C8AE58  4B 5E 4C 60 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
/* 80C8AE5C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8AE60  7C 03 07 74 */	extsb r3, r0
/* 80C8AE64  4B 3A 22 08 */	b dComIfGp_getReverb__Fi
/* 80C8AE68  7C 7D 1B 78 */	mr r29, r3
/* 80C8AE6C  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 80C8AE70  4B 6D 72 3C */	b __cvt_fp2unsigned

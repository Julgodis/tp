...
/* 80C8B120  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C8B124  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C8B128  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C8B12C  7F E5 FB 78 */	mr r5, r31
/* 80C8B130  4B 3E 98 D8 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80C8B134:
/* 80C8B134  3C 60 80 C9 */	lis r3, lit_3695@ha
/* 80C8B138  C0 03 B9 F0 */	lfs f0, lit_3695@l(r3)
/* 80C8B13C  D0 1F 05 B8 */	stfs f0, 0x5b8(r31)
/* 80C8B140  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C8B144  7C 03 07 74 */	extsb r3, r0
/* 80C8B148  4B 3A 1F 24 */	b dComIfGp_getReverb__Fi
...
/* 80C8B15C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8B160  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C8B164  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C8B168  38 81 00 08 */	addi r4, r1, 8
/* 80C8B16C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C8B170  38 C0 00 00 */	li r6, 0
/* 80C8B174  3D 00 80 C9 */	lis r8, lit_3695@ha
/* 80C8B178  C0 28 B9 F0 */	lfs f1, lit_3695@l(r8)
/* 80C8B17C  FC 40 08 90 */	fmr f2, f1
/* 80C8B180  3D 00 80 C9 */	lis r8, lit_3902@ha
/* 80C8B184  C0 68 BA 00 */	lfs f3, lit_3902@l(r8)
/* 80C8B188  FC 80 18 90 */	fmr f4, f3
/* 80C8B18C  39 00 00 00 */	li r8, 0
/* 80C8B190  4B 62 07 F4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

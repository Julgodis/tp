...
/* 80C8A798  3C 80 80 C9 */	lis r4, l_HIO@ha
/* 80C8A79C  38 84 BB EC */	addi r4, r4, l_HIO@l
/* 80C8A7A0  88 04 00 10 */	lbz r0, 0x10(r4)	/* effective address: 80C8BBFC */
/* 80C8A7A4  B0 03 06 00 */	sth r0, 0x600(r3)
/* 80C8A7A8  88 04 00 11 */	lbz r0, 0x11(r4)	/* effective address: 80C8BBFD */
/* 80C8A7AC  B0 03 06 02 */	sth r0, 0x602(r3)
/* 80C8A7B0  88 04 00 12 */	lbz r0, 0x12(r4)	/* effective address: 80C8BBFE */
/* 80C8A7B4  B0 03 06 04 */	sth r0, 0x604(r3)
/* 80C8A7B8  C0 04 00 0C */	lfs f0, 0xc(r4)	/* effective address: 80C8BBF8 */
/* 80C8A7BC  D0 03 06 08 */	stfs f0, 0x608(r3)
/* 80C8A7C0  3C 80 80 C9 */	lis r4, lit_3695@ha
/* 80C8A7C4  C0 04 B9 F0 */	lfs f0, lit_3695@l(r4)

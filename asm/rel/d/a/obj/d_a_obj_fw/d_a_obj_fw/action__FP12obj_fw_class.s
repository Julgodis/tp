...
/* 80BF24DC  3C 80 80 BF */	lis r4, lit_3647@ha
/* 80BF24E0  3B E4 2B 48 */	addi r31, r4, lit_3647@l
...
lbl_80BF24F8:
/* 80BF24F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF24FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80BF251C  4B 75 43 CC */	b PSMTXTrans
/* 80BF2520  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF2524  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF2528  A8 9E 05 A0 */	lha r4, 0x5a0(r30)
/* 80BF252C  4B 41 9F 08 */	b mDoMtx_YrotM__FPA4_fs
/* 80BF2530  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF2534  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF2538  A8 9E 05 A2 */	lha r4, 0x5a2(r30)
/* 80BF253C  4B 41 9E 60 */	b mDoMtx_XrotM__FPA4_fs
/* 80BF2540  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF2544  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF2548  A8 1E 05 A0 */	lha r0, 0x5a0(r30)
/* 80BF254C  7C 00 00 D0 */	neg r0, r0
/* 80BF2550  7C 04 07 34 */	extsh r4, r0
/* 80BF2554  4B 41 9E E0 */	b mDoMtx_YrotM__FPA4_fs
/* 80BF2558  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF255C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80BF2570  4B 41 9E 2C */	b mDoMtx_XrotM__FPA4_fs
/* 80BF2574  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF2578  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF257C  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80BF2580  4B 41 9E B4 */	b mDoMtx_YrotM__FPA4_fs
/* 80BF2584  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF2588  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80BF25AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF25B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF25B4  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80BF25B8  38 84 00 24 */	addi r4, r4, 0x24
/* 80BF25BC  4B 75 3E F4 */	b PSMTXCopy
...
/* 80BF25D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF25D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF25D8  38 81 00 14 */	addi r4, r1, 0x14
/* 80BF25DC  38 BE 05 A8 */	addi r5, r30, 0x5a8
/* 80BF25E0  4B 75 47 8C */	b PSMTXMultVec
...
/* 80BF2620  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF2624  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF2628  38 9E 05 B8 */	addi r4, r30, 0x5b8
/* 80BF262C  4B 75 3E 84 */	b PSMTXCopy
/* 80BF2630  80 7E 05 E8 */	lwz r3, 0x5e8(r30)
/* 80BF2634  4B 48 93 8C */	b Move__4dBgWFv
...
/* 80BF2654  4B 67 DF B4 */	b cLib_addCalcAngleS2__FPssss
lbl_80BF2658:

...
/* 80D07150  4B 65 B0 8C */	b _savegpr_29
/* 80D07154  7C 7D 1B 78 */	mr r29, r3
/* 80D07158  3C 80 80 D0 */	lis r4, lit_3627@ha
/* 80D0715C  3B E4 78 08 */	addi r31, r4, lit_3627@l
...
/* 80D07174  4B 37 14 B0 */	b __ct__16dBgS_MoveBgActorFv
/* 80D07178  3C 60 80 D0 */	lis r3, __vt__11daTkraDai_c@ha
/* 80D0717C  38 03 78 C8 */	addi r0, r3, __vt__11daTkraDai_c@l
...
/* 80D07194  3C 80 80 D0 */	lis r4, stringBase0@ha
/* 80D07198  38 84 78 54 */	addi r4, r4, stringBase0@l
/* 80D0719C  4B 32 5D 20 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D071B0  3C 80 80 D0 */	lis r4, stringBase0@ha
/* 80D071B4  38 84 78 54 */	addi r4, r4, stringBase0@l
/* 80D071B8  38 A0 00 08 */	li r5, 8
/* 80D071BC  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80D071C0  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80D071C4  38 E0 2E 00 */	li r7, 0x2e00
/* 80D071C8  39 00 00 00 */	li r8, 0
/* 80D071CC  4B 37 15 F0 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80D07250  4B 31 32 F8 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80D07254  80 9D 06 28 */	lwz r4, 0x628(r29)
/* 80D07258  28 04 00 00 */	cmplwi r4, 0
/* 80D0725C  41 82 00 20 */	beq lbl_80D0727C
/* 80D07260  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D07264  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D07268  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80D0726C  7F A5 EB 78 */	mr r5, r29
/* 80D07270  4B 36 D7 98 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80D07274  80 7D 06 28 */	lwz r3, 0x628(r29)
/* 80D07278  4B 37 47 48 */	b Move__4dBgWFv
lbl_80D0727C:
...
/* 80D072D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D072DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D072E0  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 80D072E4  A8 BD 04 DE */	lha r5, 0x4de(r29)
/* 80D072E8  A8 DD 04 E0 */	lha r6, 0x4e0(r29)
/* 80D072EC  4B 30 4F 1C */	b mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80D07304  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D07308  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D0730C  38 9D 06 1C */	addi r4, r29, 0x61c
/* 80D07310  7C 85 23 78 */	mr r5, r4
/* 80D07314  4B 63 FA 58 */	b PSMTXMultVec
...
/* 80D07330  4B 65 AE F8 */	b _restgpr_29

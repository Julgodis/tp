...
/* 80CC9920 00000010  4B 69 88 B4 */	b _savegpr_27
/* 80CC9924 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80CC9928 00000018  3C 80 80 CD */	lis r4, DISAP_PARTICLE_NAME@ha
/* 80CC992C 0000001C  3B E4 B0 80 */	addi r31, r4, DISAP_PARTICLE_NAME@l
...
lbl_80CC9954:
/* 80CC9954 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CC9958 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CC995C 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80CC9960 0000000C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80CC9964 00000010  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80CC9968 00000014  A0 84 03 20 */	lhz r4, 0x320(r4)	/* effective address: 803A75A8 */
/* 80CC996C 00000018  4B 36 B0 50 */	b isEventBit__11dSv_event_cCFUs
...
lbl_80CC9990:
/* 80CC9990 00000000  3C 80 80 CD */	lis r4, l_arcName@ha
/* 80CC9994 00000004  38 84 B1 7C */	addi r4, r4, l_arcName@l
/* 80CC9998 00000008  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80CCB17C */
/* 80CC999C 0000000C  4B 36 35 20 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CC99B0 00000020  3C 80 80 CD */	lis r4, daSCannonCrs_c_createHeap__FP10fopAc_ac_c@ha
/* 80CC99B4 00000024  38 84 96 78 */	addi r4, r4, daSCannonCrs_c_createHeap__FP10fopAc_ac_c@l
/* 80CC99B8 00000028  3C A0 00 01 */	lis r5, 0x0001 /* 0x00009000@ha */
/* 80CC99BC 0000002C  38 A5 90 00 */	addi r5, r5, 0x9000 /* 0x00009000@l */
/* 80CC99C0 00000030  4B 35 0A F0 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80CC99D4:
/* 80CC99D4 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CC99D8 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CC99EC 00000018  4B 3A B0 1C */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80CC9A20 00000020  C0 3F 00 10 */	lfs f1, 0x10(r31)	/* effective address: 80CCB090 */
/* 80CC9A24 00000024  C0 5F 00 14 */	lfs f2, 0x14(r31)	/* effective address: 80CCB094 */
/* 80CC9A28 00000028  FC 60 08 90 */	fmr f3, f1
/* 80CC9A2C 0000002C  C0 9F 00 18 */	lfs f4, 0x18(r31)	/* effective address: 80CCB098 */
/* 80CC9A30 00000030  C0 BF 00 1C */	lfs f5, 0x1c(r31)	/* effective address: 80CCB09C */
/* 80CC9A34 00000034  FC C0 20 90 */	fmr f6, f4
/* 80CC9A38 00000038  4B 35 0B 10 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80CC9A48 00000048  3C 60 80 CD */	lis r3, l_arcName@ha
/* 80CC9A4C 0000004C  80 03 B1 7C */	lwz r0, l_arcName@l(r3)
...
/* 80CC9A5C 0000005C  3C A0 80 CD */	lis r5, l_eventName@ha
/* 80CC9A60 00000060  38 A5 B1 80 */	addi r5, r5, l_eventName@l
/* 80CC9A64 00000064  80 A5 00 00 */	lwz r5, 0(r5)	/* effective address: 80CCB180 */
/* 80CC9A68 00000068  38 C0 00 FF */	li r6, 0xff
/* 80CC9A6C 0000006C  4B 37 DC EC */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80CC9A84 00000084  3C 60 80 CD */	lis r3, stringBase0@ha
/* 80CC9A88 00000088  3B E3 B1 14 */	addi r31, r3, stringBase0@l
...
/* 80CC9A98 00000008  4B 61 50 60 */	b getName__10JUTNameTabCFUs
/* 80CC9A9C 0000000C  38 9F 00 1E */	addi r4, r31, 0x1e
/* 80CC9AA0 00000010  4B 69 EE F4 */	b strcmp
...
/* 80CC9ABC 00000008  4B 61 50 3C */	b getName__10JUTNameTabCFUs
/* 80CC9AC0 0000000C  3C 80 80 CD */	lis r4, stringBase0@ha
/* 80CC9AC4 00000010  38 84 B1 14 */	addi r4, r4, stringBase0@l
/* 80CC9AC8 00000014  38 84 00 27 */	addi r4, r4, 0x27
/* 80CC9ACC 00000018  4B 69 EE C8 */	b strcmp
...
/* 80CC9AFC 00000004  4B 69 87 24 */	b _restgpr_27

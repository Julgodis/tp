...
/* 80CCA8E4 00000018  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80CCA8E8 0000001C  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80CCA8EC 00000020  80 63 00 00 */	lwz r3, 0(r3)
/* 80CCA8F0 00000024  38 80 00 0A */	li r4, 0xa
/* 80CCA8F4 00000028  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80CCA8F8 0000002C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
lbl_80CCA93C:
/* 80CCA93C 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80CCA940 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80CCA968 0000002C  3C E0 00 00 */	lis r7, lit_4033@ha
/* 80CCA96C 00000030  C0 27 00 00 */	lfs f1, lit_4033@l(r7)
...
lbl_80CCA990:
/* 80CCA990 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80CCA994 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80CCA9C0 00000030  3D 00 00 00 */	lis r8, lit_4033@ha
/* 80CCA9C4 00000034  C0 28 00 00 */	lfs f1, lit_4033@l(r8)
...
lbl_80CCAA14:
/* 80CCAA14 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCAA18 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CCAA2C 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCAA30 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCAA34 00000020  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CCAA38 00000024  4B FF EC 21 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CCAA3C 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCAA40 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCAA44 00000030  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80CCAA48 00000034  4B FF EC 11 */	bl mDoMtx_XrotM__FPA4_fs
/* 80CCAA4C 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCAA50 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCAA54 00000040  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80CCAA58 00000044  4B FF EC 01 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80CCAA5C 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CCAA60 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CCAA64 00000050  38 9E 06 08 */	addi r4, r30, 0x608
/* 80CCAA68 00000054  4B FF EB F1 */	bl PSMTXCopy
/* 80CCAA6C 00000058  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80CCAA70 0000005C  38 63 00 00 */	addi r3, r3, l_arcName@l

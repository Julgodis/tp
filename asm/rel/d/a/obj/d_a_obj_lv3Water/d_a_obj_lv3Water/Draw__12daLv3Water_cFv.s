...
/* 80C598CC  4B 70 89 00 */	b _savegpr_25
/* 80C598D0  7C 7D 1B 78 */	mr r29, r3
/* 80C598D4  3C 60 80 C6 */	lis r3, l_bmdIdx@ha
/* 80C598D8  3B C3 9E 70 */	addi r30, r3, l_bmdIdx@l
...
lbl_80C598F0:
/* 80C598F0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C598F4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C598F8  38 80 00 10 */	li r4, 0x10
/* 80C598FC  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80C59900  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80C59904  4B 54 9E C0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C59908  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C5990C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C59910  80 9D 05 C0 */	lwz r4, 0x5c0(r29)
/* 80C59914  80 84 00 04 */	lwz r4, 4(r4)
/* 80C59918  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80C5991C  4B 54 B4 84 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C59920  80 9D 05 C4 */	lwz r4, 0x5c4(r29)
/* 80C59924  28 04 00 00 */	cmplwi r4, 0
/* 80C59928  41 82 00 18 */	beq lbl_80C59940
/* 80C5992C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C59930  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C59934  80 84 00 04 */	lwz r4, 4(r4)
/* 80C59938  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80C5993C  4B 54 B4 64 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_80C59940:
...
/* 80C59954  4B 3B 3D 84 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C59974  4B 3B 3D 64 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80C59978:
/* 80C59978  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5997C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C59980  80 03 5F 7C */	lwz r0, 0x5f7c(r3)	/* effective address: 8040C13C */
/* 80C59984  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C59988  3B E3 4A C8 */	addi r31, r3, j3dSys@l
/* 80C5998C  90 1F 00 4C */	stw r0, 0x4c(r31)	/* effective address: 80434B14 */
/* 80C59990  80 7D 05 C0 */	lwz r3, 0x5c0(r29)
/* 80C59994  4B 3B 43 30 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C59998  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5999C  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 80C599A0  80 1B 5F 80 */	lwz r0, 0x5f80(r27)	/* effective address: 8040C140 */
/* 80C599A4  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C599A8  3B 83 4A C8 */	addi r28, r3, j3dSys@l
/* 80C599AC  90 1C 00 48 */	stw r0, 0x48(r28)	/* effective address: 80434B10 */
/* 80C599B0  80 1B 5F 84 */	lwz r0, 0x5f84(r27)	/* effective address: 8040C144 */
...
/* 80C59A20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C59A24  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C59A28  80 83 61 B0 */	lwz r4, 0x61b0(r3)	/* effective address: 8040C370 */
...
/* 80C59A48  4B 6E D1 D0 */	b C_MTXLightPerspective
/* 80C59A4C  7F 43 D3 78 */	mr r3, r26
/* 80C59A50  38 81 00 08 */	addi r4, r1, 8
/* 80C59A54  4B 6C BD 40 */	b setEffectMtx__13J3DTexMtxInfoFPA4_f
/* 80C59A58  7F 23 CB 78 */	mr r3, r25
/* 80C59A5C  38 80 00 00 */	li r4, 0
/* 80C59A60  3C A0 80 3A */	lis r5, j3dDefaultMtx@ha
/* 80C59A64  38 A5 1E 5C */	addi r5, r5, j3dDefaultMtx@l
/* 80C59A68  4B 6C C5 A4 */	b simpleCalcMaterial__12J3DModelDataFUsPA4_f
lbl_80C59A6C:
/* 80C59A6C  80 7D 05 C4 */	lwz r3, 0x5c4(r29)
/* 80C59A70  4B 3B 42 54 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80C59A8C  4B 70 87 8C */	b _restgpr_25

...
/* 80C5892C  4B 70 98 AC */	b _savegpr_28
/* 80C58930  7C 7D 1B 78 */	mr r29, r3
/* 80C58934  3C 60 80 C6 */	lis r3, l_bmdIdx@ha
/* 80C58938  3B E3 9E 70 */	addi r31, r3, l_bmdIdx@l
/* 80C5893C  88 1D 05 F9 */	lbz r0, 0x5f9(r29)
/* 80C58940  54 00 10 3A */	slwi r0, r0, 2
/* 80C58944  3C 60 80 C6 */	lis r3, l_resNameIdx@ha
/* 80C58948  38 63 A1 5C */	addi r3, r3, l_resNameIdx@l
/* 80C5894C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C58950  38 9F 00 00 */	addi r4, r31, 0
/* 80C58954  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C58958  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C5895C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C58970  4B 3E 39 7C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C58984  4B 3B C2 D0 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C589A8  3C 60 80 C6 */	lis r3, l_resNameIdx@ha
/* 80C589AC  38 63 A1 5C */	addi r3, r3, l_resNameIdx@l
...
/* 80C589C4  4B 3E 39 28 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C589E8  4B 3B 4C 54 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C58A04  3C 60 80 C6 */	lis r3, l_resNameIdx@ha
/* 80C58A08  38 63 A1 5C */	addi r3, r3, l_resNameIdx@l
/* 80C58A0C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C58A10  7F C5 F3 78 */	mr r5, r30
/* 80C58A14  38 C0 00 80 */	li r6, 0x80
/* 80C58A18  4B 3E 38 D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C58A2C  4B 3B C2 28 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C58A50  3C 60 80 C6 */	lis r3, l_resNameIdx@ha
/* 80C58A54  38 63 A1 5C */	addi r3, r3, l_resNameIdx@l
...
/* 80C58A6C  4B 3E 38 80 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C58A90  4B 3B 4B AC */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C58AA8  4B 70 97 7C */	b _restgpr_28

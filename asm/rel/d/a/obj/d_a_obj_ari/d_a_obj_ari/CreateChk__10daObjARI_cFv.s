...
/* 80BA487C 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BA4880 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BA4884 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80BA4888 00000020  7F E3 FB 78 */	mr r3, r31
/* 80BA488C 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BA4890 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4)
/* 80BA4894 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80BA4898 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BA489C 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80BA48B4 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BA48B8 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l
/* 80BA48BC 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80BA48C0 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80BA48C4 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BA48C8 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
lbl_80BA48E4:
/* 80BA48E4 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80BA48E8 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80BA48EC 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80BA48F0 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 80BA48F4 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
/* 80BA4908 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BA490C 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80BA4920 0000003C  3C 60 00 00 */	lis r3, l_ari_itemno@ha
/* 80BA4924 00000040  38 63 00 00 */	addi r3, r3, l_ari_itemno@l
...
/* 80BA494C 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BA4950 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BA4954 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BA4958 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80BA495C 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BA4960 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l
/* 80BA4964 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80BA4968 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80BA496C 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BA4970 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80BA4990 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BA4994 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BA4998 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80BA499C 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80BA49A0 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha
/* 80BA49A4 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l
/* 80BA49A8 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80BA49AC 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80BA49B0 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80BA49B4 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l

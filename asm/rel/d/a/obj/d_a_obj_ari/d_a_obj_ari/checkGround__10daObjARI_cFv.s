...
/* 80BA3418  4B 7B ED C4 */	b _savegpr_29
/* 80BA341C  7C 7F 1B 78 */	mr r31, r3
/* 80BA3420  3C 60 80 BA */	lis r3, lit_3776@ha
/* 80BA3424  3B C3 54 08 */	addi r30, r3, lit_3776@l
/* 80BA3428  38 61 00 38 */	addi r3, r1, 0x38
/* 80BA342C  4B 4D 48 3C */	b __ct__11dBgS_LinChkFv
/* 80BA3430  38 61 00 90 */	addi r3, r1, 0x90
/* 80BA3434  4B 4D 5A 34 */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80BA3448  4B 4D 49 1C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80BA344C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BA3450  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BA3454  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80BA3458  7F A3 EB 78 */	mr r3, r29
/* 80BA345C  38 81 00 38 */	addi r4, r1, 0x38
/* 80BA3460  4B 4D 0F 54 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80BA3464  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BA3468  41 82 01 AC */	beq lbl_80BA3614
/* 80BA346C  3C 60 80 BA */	lis r3, __vt__8cM3dGPla@ha
/* 80BA3470  38 03 55 B4 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80BA3484  4B 4D 12 C0 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80BA34CC  4B 7A 3E D0 */	b PSVECSquareDistance
...
/* 80BA353C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BA3540  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80BA35AC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BA35B0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80BA35B4  48 00 00 08 */	b lbl_80BA35BC
lbl_80BA35B8:
/* 80BA35B8  FC 40 08 90 */	fmr f2, f1
lbl_80BA35BC:
/* 80BA35BC  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80BA35C0  4B 6C 40 B4 */	b cM_atan2s__Fff
...
/* 80BA35D8  4B 6C 40 9C */	b cM_atan2s__Fff
...
/* 80BA35EC  4B 6C 40 88 */	b cM_atan2s__Fff
...
/* 80BA3608  3C 60 80 BA */	lis r3, __vt__8cM3dGPla@ha
/* 80BA360C  38 03 55 B4 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80BA3610  90 01 00 34 */	stw r0, 0x34(r1)
lbl_80BA3614:
/* 80BA3614  38 61 00 38 */	addi r3, r1, 0x38
/* 80BA3618  38 80 FF FF */	li r4, -1
/* 80BA361C  4B 4D 46 C0 */	b __dt__11dBgS_LinChkFv
/* 80BA3620  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80BA3624  4B 7B EC 04 */	b _restgpr_29

...
/* 8057BFB0  3C 80 80 58 */	lis r4, lit_3822@ha
/* 8057BFB4  3B E4 C8 B0 */	addi r31, r4, lit_3822@l
...
/* 8057BFCC  4B A9 CB 98 */	b __ct__10fopAc_ac_cFv
/* 8057BFD0  3C 60 80 58 */	lis r3, __vt__12daObjDigpl_c@ha
/* 8057BFD4  38 03 C9 48 */	addi r0, r3, __vt__12daObjDigpl_c@l
...
/* 8057C024  4B AD 57 C8 */	b dPath_GetRoomPath__Fii
...
/* 8057C04C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057C050  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057C054  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 8057C058  7C 05 07 74 */	extsb r5, r0
/* 8057C05C  4B AB 93 04 */	b isSwitch__10dSv_info_cCFii
...
lbl_8057C070:
/* 8057C070  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8057C074  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8057C078  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 8057C07C  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 8057C080  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 8057C084  4B DC A8 64 */	b PSMTXTrans
/* 8057C088  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8057C08C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8057C090  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 8057C094  4B A9 03 A0 */	b mDoMtx_YrotM__FPA4_fs
/* 8057C098  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8057C09C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8057C0A0  38 9E 05 70 */	addi r4, r30, 0x570
/* 8057C0A4  4B DC A4 0C */	b PSMTXCopy
...
/* 8057C0E0  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 8057C0E4  88 03 0D 64 */	lbz r0, struct_80450D64+0x0@l(r3)
...
/* 8057C0FC  4B A9 E4 2C */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 8057C110  4B A9 E4 28 */	b fopAcM_SetMax__FP10fopAc_ac_cfff

...
/* 80CB7650  3C 60 80 CC */	lis r3, m__21daObj_Pumpkin_Param_c@ha
/* 80CB7654  3B E3 83 70 */	addi r31, r3, m__21daObj_Pumpkin_Param_c@l
/* 80CB7658  88 1E 0B B0 */	lbz r0, 0xbb0(r30)
/* 80CB765C  28 00 00 00 */	cmplwi r0, 0
/* 80CB7660  40 82 01 60 */	bne lbl_80CB77C0
/* 80CB7664  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CB7668  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CB766C  38 80 00 00 */	li r4, 0
/* 80CB7670  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CB7674  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CB7678  4B 4E C1 4C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CB767C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CB7680  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CB7684  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80CB7688  80 84 00 04 */	lwz r4, 4(r4)
/* 80CB768C  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CB7690  4B 4E D7 10 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80CB76C4  4B 35 66 00 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80CB76F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CB76F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CB76F8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80CB76FC  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80CB7710  4B 36 22 AC */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80CB773C  3C 60 80 CC */	lis r3, __vt__8cM3dGPla@ha
/* 80CB7740  38 03 85 38 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CB7744  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80CB7748  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CB774C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CB7750  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CB7754  38 9E 07 E0 */	addi r4, r30, 0x7e0
/* 80CB7758  38 A1 00 0C */	addi r5, r1, 0xc
/* 80CB775C  4B 3B CF E8 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80CB7760  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CB7764  41 82 00 50 */	beq lbl_80CB77B4
/* 80CB7768  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CB776C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80CB77A8  3C E0 80 42 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80CB77AC  38 E7 48 D0 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80CB77B0  4B 39 E7 D4 */	b setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80CB77B4:
/* 80CB77B4  3C 60 80 CC */	lis r3, __vt__8cM3dGPla@ha
/* 80CB77B8  38 03 85 38 */	addi r0, r3, __vt__8cM3dGPla@l

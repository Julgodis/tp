...
/* 80C8F27C 00000018  3C 60 00 00 */	lis r3, lit_3627@ha
/* 80C8F280 0000001C  3B E3 00 00 */	addi r31, r3, lit_3627@l
/* 80C8F284 00000020  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80C8F288 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 80C8F2A0 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F2A4 00000040  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F2C8 00000064  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F2CC 00000068  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F304 000000A0  3C 60 00 00 */	lis r3, data_80C8FC08@ha
/* 80C8F308 000000A4  38 63 00 00 */	addi r3, r3, data_80C8FC08@l
/* 80C8F30C 000000A8  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F310 000000AC  90 01 00 10 */	stw r0, 0x10(r1)
/* 80C8F314 000000B0  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8F318 000000B4  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
lbl_80C8F348:
/* 80C8F348 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F34C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F374 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F378 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F3AC 00000064  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F3B0 00000068  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F3E8 000000A0  3C 60 00 00 */	lis r3, data_80C8FC08@ha
/* 80C8F3EC 000000A4  38 63 00 00 */	addi r3, r3, data_80C8FC08@l
/* 80C8F3F0 000000A8  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F3F4 000000AC  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C8F3F8 000000B0  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8F3FC 000000B4  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 80C8F440 000000F8  3C 60 00 00 */	lis r3, data_80C8FC08@ha
/* 80C8F444 000000FC  38 63 00 00 */	addi r3, r3, data_80C8FC08@l
/* 80C8F448 00000100  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F44C 00000104  90 01 00 08 */	stw r0, 8(r1)
/* 80C8F450 00000108  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8F454 0000010C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l

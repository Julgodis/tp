...
/* 80C8F550 00000018  3C 60 00 00 */	lis r3, lit_3627@ha
/* 80C8F554 0000001C  3B E3 00 00 */	addi r31, r3, lit_3627@l
...
/* 80C8F564 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F568 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F58C 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F590 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F5C8 00000090  3C 60 00 00 */	lis r3, data_80C8FC14@ha
/* 80C8F5CC 00000094  38 63 00 00 */	addi r3, r3, data_80C8FC14@l
/* 80C8F5D0 00000098  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F5D4 0000009C  90 01 00 10 */	stw r0, 0x10(r1)
/* 80C8F5D8 000000A0  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8F5DC 000000A4  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
lbl_80C8F60C:
/* 80C8F60C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F610 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F638 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F63C 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F670 00000064  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C8F674 00000068  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C8F6AC 000000A0  3C 60 00 00 */	lis r3, data_80C8FC14@ha
/* 80C8F6B0 000000A4  38 63 00 00 */	addi r3, r3, data_80C8FC14@l
/* 80C8F6B4 000000A8  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F6B8 000000AC  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C8F6BC 000000B0  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8F6C0 000000B4  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 80C8F704 000000F8  3C 60 00 00 */	lis r3, data_80C8FC14@ha
/* 80C8F708 000000FC  38 63 00 00 */	addi r3, r3, data_80C8FC14@l
/* 80C8F70C 00000100  7C 03 00 2E */	lwzx r0, r3, r0
/* 80C8F710 00000104  90 01 00 08 */	stw r0, 8(r1)
/* 80C8F714 00000108  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8F718 0000010C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
lbl_80C8F744:
/* 80C8F744 00000000  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80C8F748 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l

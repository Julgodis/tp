...
/* 80C8F884  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C8F888  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C8F88C  38 80 00 40 */	li r4, 0x40
/* 80C8F890  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C8F894  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C8F898  4B 51 3F 2C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C8F89C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C8F8A0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C8F8A4  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C8F8A8  80 84 00 04 */	lwz r4, 4(r4)
/* 80C8F8AC  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C8F8B0  4B 51 54 F0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C8F8C4  3C 60 80 C9 */	lis r3, l_btkIdx@ha
/* 80C8F8C8  38 63 FB 30 */	addi r3, r3, l_btkIdx@l
...
/* 80C8F8E4  4B 37 DD F4 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80C8F8E8:
/* 80C8F8E8  88 1F 05 DC */	lbz r0, 0x5dc(r31)
/* 80C8F8EC  54 00 10 3A */	slwi r0, r0, 2
/* 80C8F8F0  3C 60 80 C9 */	lis r3, l_brkIdx@ha
/* 80C8F8F4  38 63 FB 3C */	addi r3, r3, l_brkIdx@l
...
/* 80C8F910  4B 37 DE 98 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_80C8F914:
/* 80C8F914  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C8F918  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80C8F91C  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80C8F920  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C8F924  3B C3 4A C8 */	addi r30, r3, j3dSys@l
/* 80C8F928  90 1E 00 48 */	stw r0, 0x48(r30)	/* effective address: 80434B10 */
/* 80C8F92C  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80C8F930  90 1E 00 4C */	stw r0, 0x4c(r30)	/* effective address: 80434B14 */
/* 80C8F934  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 80C8F938  4B 37 E3 8C */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C8F93C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C8F940  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C8F944  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80C8F948  90 1E 00 48 */	stw r0, 0x48(r30)
/* 80C8F94C  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

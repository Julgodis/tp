...
/* 80C8E974  C0 05 00 00 */	lfs f0, 0(r5)	/* effective address: 80C8FAE8 */
/* 80C8E978  D0 03 00 08 */	stfs f0, 8(r3)
/* 80C8E97C  C0 05 00 04 */	lfs f0, 4(r5)	/* effective address: 80C8FAEC */
/* 80C8E980  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 80C8E984  C0 05 00 08 */	lfs f0, 8(r5)	/* effective address: 80C8FAF0 */
/* 80C8E988  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 80C8E98C  C0 05 00 0C */	lfs f0, 0xc(r5)	/* effective address: 80C8FAF4 */
/* 80C8E990  D0 03 00 14 */	stfs f0, 0x14(r3)
/* 80C8E994  C0 05 00 10 */	lfs f0, 0x10(r5)	/* effective address: 80C8FAF8 */
/* 80C8E998  D0 03 00 18 */	stfs f0, 0x18(r3)
/* 80C8E99C  C0 05 00 14 */	lfs f0, 0x14(r5)	/* effective address: 80C8FAFC */
/* 80C8E9A0  D0 03 00 1C */	stfs f0, 0x1c(r3)
/* 80C8E9A4  C0 05 00 18 */	lfs f0, 0x18(r5)	/* effective address: 80C8FB00 */
/* 80C8E9A8  D0 03 00 20 */	stfs f0, 0x20(r3)
/* 80C8E9AC  C0 45 00 1C */	lfs f2, 0x1c(r5)	/* effective address: 80C8FB04 */
/* 80C8E9B0  D0 43 00 24 */	stfs f2, 0x24(r3)
/* 80C8E9B4  C0 05 00 20 */	lfs f0, 0x20(r5)	/* effective address: 80C8FB08 */
/* 80C8E9B8  D0 03 00 30 */	stfs f0, 0x30(r3)
/* 80C8E9BC  C0 05 00 24 */	lfs f0, 0x24(r5)	/* effective address: 80C8FB0C */
/* 80C8E9C0  D0 03 00 28 */	stfs f0, 0x28(r3)
/* 80C8E9C4  C0 25 00 28 */	lfs f1, 0x28(r5)	/* effective address: 80C8FB10 */
/* 80C8E9C8  D0 23 00 2C */	stfs f1, 0x2c(r3)
/* 80C8E9CC  C0 05 00 2C */	lfs f0, 0x2c(r5)	/* effective address: 80C8FB14 */

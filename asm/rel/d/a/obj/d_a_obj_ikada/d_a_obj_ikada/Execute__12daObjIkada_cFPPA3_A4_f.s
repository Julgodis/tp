...
/* 80C270F8  4B 73 B0 E4 */	b _savegpr_29
/* 80C270FC  7C 7D 1B 78 */	mr r29, r3
/* 80C27100  7C 9E 23 78 */	mr r30, r4
/* 80C27104  3C 60 80 C2 */	lis r3, lit_3668@ha
/* 80C27108  3B E3 74 F0 */	addi r31, r3, lit_3668@l
/* 80C2710C  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 80C27110  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 80C2751C */
...
/* 80C27134  4B 3F 6C 50 */	b waterCheck__11fopAcM_wt_cFPC4cXyz
/* 80C27138  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C2713C  41 82 00 0C */	beq lbl_80C27148
/* 80C27140  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha
/* 80C27144  C3 E3 0C D8 */	lfs f31, mWaterY__11fopAcM_wt_c@l(r3)
lbl_80C27148:
...
/* 80C271D8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C271DC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C27218  4B 64 87 64 */	b cLib_addCalc__FPfffff
...
/* 80C27230  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C27234  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C27298  4B 64 92 A8 */	b cLib_addCalcAngleS__FPsssss
...
/* 80C272AC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C272B0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C27314  4B 64 92 2C */	b cLib_addCalcAngleS__FPsssss
...
/* 80C27338  4B 64 92 08 */	b cLib_addCalcAngleS__FPsssss
...
/* 80C27350  4B 64 91 F0 */	b cLib_addCalcAngleS__FPsssss
...
/* 80C27368  4B 64 86 14 */	b cLib_addCalc__FPfffff
...
/* 80C27380  4B 64 85 FC */	b cLib_addCalc__FPfffff
lbl_80C27384:
...
/* 80C27398  4B 64 85 E4 */	b cLib_addCalc__FPfffff
...
/* 80C273B4  4B 3F 33 18 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80C273CC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C273D0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C273D4  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C273D8  4B 44 F6 D4 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C273EC  4B 73 AE 3C */	b _restgpr_29

...
/* 80C26CE4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C26CE8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C26CEC  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80C26D08  3C 60 80 C2 */	lis r3, lit_3767@ha
/* 80C26D0C  C0 03 75 28 */	lfs f0, lit_3767@l(r3)
/* 80C26D10  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C26D14  40 80 00 10 */	bge lbl_80C26D24
/* 80C26D18  3C 60 80 C2 */	lis r3, lit_3768@ha
/* 80C26D1C  C0 03 75 2C */	lfs f0, lit_3768@l(r3)

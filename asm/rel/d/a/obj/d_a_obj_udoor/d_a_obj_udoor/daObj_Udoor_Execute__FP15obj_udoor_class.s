...
/* 80D207AC  4B 64 1A 2C */	b _savegpr_28
/* 80D207B0  7C 7E 1B 78 */	mr r30, r3
/* 80D207B4  3C 60 80 D2 */	lis r3, lit_3707@ha
/* 80D207B8  3B E3 0D E0 */	addi r31, r3, lit_3707@l
/* 80D207BC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D207C0  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80D207C4  83 9D 5D AC */	lwz r28, 0x5dac(r29)	/* effective address: 8040BF6C */
...
/* 80D20810  4B 54 FD F8 */	b cLib_addCalcAngleS2__FPssss
...
/* 80D20834  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D20838  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2083C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D20864  4B 58 B1 20 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D20868:
...
/* 80D20878  4B 54 FD 90 */	b cLib_addCalcAngleS2__FPssss
lbl_80D2087C:
...
/* 80D208C4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80D208C8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80D208F4  4B 54 F1 8C */	b cLib_addCalc0__FPfff
/* 80D208F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D208FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D20900  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80D20904  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80D20908  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80D2090C  4B 62 5F DC */	b PSMTXTrans
/* 80D20910  88 1E 05 70 */	lbz r0, 0x570(r30)
/* 80D20914  28 00 00 00 */	cmplwi r0, 0
/* 80D20918  40 82 00 2C */	bne lbl_80D20944
/* 80D2091C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D20920  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D2093C  4B 2E BA F8 */	b mDoMtx_YrotM__FPA4_fs
/* 80D20940  48 00 00 28 */	b lbl_80D20968
lbl_80D20944:
/* 80D20944  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D20948  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D20964  4B 2E BA D0 */	b mDoMtx_YrotM__FPA4_fs
lbl_80D20968:
/* 80D20968  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2096C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D20970  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80D20974  38 84 00 24 */	addi r4, r4, 0x24
/* 80D20978  4B 62 5B 38 */	b PSMTXCopy
/* 80D2097C  80 1E 05 B8 */	lwz r0, 0x5b8(r30)
/* 80D20980  28 00 00 00 */	cmplwi r0, 0
/* 80D20984  41 82 00 1C */	beq lbl_80D209A0
/* 80D20988  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2098C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D20990  38 9E 05 88 */	addi r4, r30, 0x588
/* 80D20994  4B 62 5B 1C */	b PSMTXCopy
/* 80D20998  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 80D2099C  4B 35 B0 24 */	b Move__4dBgWFv
lbl_80D209A0:
/* 80D209A0  38 60 00 01 */	li r3, 1
/* 80D209A4  39 61 00 30 */	addi r11, r1, 0x30
/* 80D209A8  4B 64 18 7C */	b _restgpr_28

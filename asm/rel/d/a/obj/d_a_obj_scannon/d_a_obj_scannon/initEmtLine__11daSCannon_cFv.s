...
/* 80CC8C04  4B 69 95 D8 */	b _savegpr_29
/* 80CC8C08  7C 7D 1B 78 */	mr r29, r3
/* 80CC8C0C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CC8C10  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CC8C14  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 80CC8C4C  4B 4B 89 80 */	b dCam_getAngleY__FP12camera_class
/* 80CC8C50  7C 7F 1B 78 */	mr r31, r3
/* 80CC8C54  7F C3 F3 78 */	mr r3, r30
/* 80CC8C58  4B 4B 89 98 */	b dCam_getAngleX__FP12camera_class
...
lbl_80CC8C6C:
/* 80CC8C6C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CC8C70  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CC8C74  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80CC8CB4  3D 60 80 CD */	lis r11, lit_4114@ha
/* 80CC8CB8  C0 2B 91 B8 */	lfs f1, lit_4114@l(r11)
/* 80CC8CBC  4B 38 3D D4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80CC8CC0  90 7D 06 34 */	stw r3, 0x634(r29)
/* 80CC8CC4  39 61 00 50 */	addi r11, r1, 0x50
/* 80CC8CC8  4B 69 95 60 */	b _restgpr_29

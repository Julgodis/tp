...
/* 80C580B0  4B 70 A1 2C */	b _savegpr_29
/* 80C580B4  7C 7E 1B 78 */	mr r30, r3
/* 80C580B8  3C 60 80 C6 */	lis r3, mCcDObjInfo__13daLv3Candle_c@ha
/* 80C580BC  3B E3 85 64 */	addi r31, r3, mCcDObjInfo__13daLv3Candle_c@l
/* 80C580C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C580C4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80C580C8  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C580DC  3D 00 80 45 */	lis r8, g_whiteColor@ha
/* 80C580E0  39 08 06 08 */	addi r8, r8, g_whiteColor@l
/* 80C580E4  7D 09 43 78 */	mr r9, r8
/* 80C580E8  39 40 00 00 */	li r10, 0
/* 80C580EC  C0 3F 00 38 */	lfs f1, 0x38(r31)	/* effective address: 80C5859C */
/* 80C580F0  4B 3F 50 C8 */	b setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
...
/* 80C58108  3D 00 80 45 */	lis r8, g_whiteColor@ha
/* 80C5810C  39 08 06 08 */	addi r8, r8, g_whiteColor@l
/* 80C58110  7D 09 43 78 */	mr r9, r8
/* 80C58114  39 40 00 00 */	li r10, 0
/* 80C58118  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 80C5811C  4B 3F 50 9C */	b setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
...
/* 80C58134  3D 00 80 45 */	lis r8, g_whiteColor@ha
/* 80C58138  39 08 06 08 */	addi r8, r8, g_whiteColor@l
/* 80C5813C  7D 09 43 78 */	mr r9, r8
/* 80C58140  39 40 00 00 */	li r10, 0
/* 80C58144  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 80C58148  4B 3F 50 70 */	b setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
/* 80C5814C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C58150  7C 03 07 74 */	extsb r3, r0
/* 80C58154  4B 3D 4F 18 */	b dComIfGp_getReverb__Fi
...
/* 80C58168  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C5816C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C58170  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C581D0  4B 42 C3 78 */	b GetTgHitGObj__12dCcD_GObjInfFv
...
/* 80C581FC  4B 42 C3 80 */	b GetTgHitObjSe__12dCcD_GObjInfFv
/* 80C58200  38 80 00 01 */	li r4, 1
/* 80C58204  4B 42 C3 AC */	b getHitSeID__12dCcD_GObjInfFUci
...
/* 80C58218  4B 66 62 8C */	b startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
...
/* 80C58230  4B 3D 4E 3C */	b dComIfGp_getReverb__Fi
...
/* 80C58284  4B 61 74 84 */	b SetR__8cM3dGSphFf
...
/* 80C582A4  4B 61 74 64 */	b SetR__8cM3dGSphFf
...
/* 80C582C0  4B 61 73 88 */	b SetC__8cM3dGSphFRC4cXyz
/* 80C582C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C582C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C582CC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C582D0  38 9E 05 B4 */	addi r4, r30, 0x5b4
/* 80C582D4  4B 60 C8 D4 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80C582E8  4B 70 9F 40 */	b _restgpr_29

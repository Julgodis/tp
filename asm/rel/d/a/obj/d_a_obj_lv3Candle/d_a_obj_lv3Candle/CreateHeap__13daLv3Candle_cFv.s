...
/* 80C57BDC  3C 60 80 C6 */	lis r3, l_resNameIdx@ha
/* 80C57BE0  38 63 86 30 */	addi r3, r3, l_resNameIdx@l
/* 80C57BE4  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C57BE8  3C 80 80 C6 */	lis r4, l_bmdIdx@ha
/* 80C57BEC  38 84 85 94 */	addi r4, r4, l_bmdIdx@l
/* 80C57BF0  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C57BF4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C57BF8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C57BFC  3C A5 00 02 */	addis r5, r5, 2
/* 80C57C00  38 C0 00 80 */	li r6, 0x80
/* 80C57C04  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C57C08  4B 3E 46 E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C57C18  4B 3B D0 3C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

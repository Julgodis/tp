...
/* 80595860  4B DC C9 78 */	b _savegpr_28
/* 80595864  7C 7F 1B 78 */	mr r31, r3
/* 80595868  3C 60 80 59 */	lis r3, l_arcName@ha
/* 8059586C  38 63 5D 60 */	addi r3, r3, l_arcName@l
/* 80595870  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80595D60 */
/* 80595874  3C 80 80 59 */	lis r4, stringBase0@ha
/* 80595878  38 84 5D 38 */	addi r4, r4, stringBase0@l
/* 8059587C  38 84 00 0A */	addi r4, r4, 0xa
/* 80595880  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80595884  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80595898  4B AA 6A E4 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 805958AC  4B A7 F3 A8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 805958B0  90 7F 05 68 */	stw r3, 0x568(r31)
/* 805958B4  3C 60 80 59 */	lis r3, l_arcName@ha
/* 805958B8  38 63 5D 60 */	addi r3, r3, l_arcName@l
/* 805958BC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80595D60 */
/* 805958C0  3C 80 80 59 */	lis r4, stringBase0@ha
/* 805958C4  38 84 5D 38 */	addi r4, r4, stringBase0@l
/* 805958C8  38 84 00 18 */	addi r4, r4, 0x18
/* 805958CC  7F 85 E3 78 */	mr r5, r28
/* 805958D0  38 C0 00 80 */	li r6, 0x80
/* 805958D4  4B AA 6A A8 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 805958D8  7C 7C 1B 78 */	mr r28, r3
/* 805958DC  38 60 00 18 */	li r3, 0x18
/* 805958E0  4B D3 93 6C */	b __nw__FUl
/* 805958E4  7C 7E 1B 79 */	or. r30, r3, r3
/* 805958E8  41 82 00 20 */	beq lbl_80595908
/* 805958EC  3C 80 80 59 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 805958F0  38 04 5D B4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 805958F4  90 1E 00 00 */	stw r0, 0(r30)
/* 805958F8  38 80 00 00 */	li r4, 0
/* 805958FC  4B D9 2B 00 */	b init__12J3DFrameCtrlFs
...
/* 80595920  3D 00 80 59 */	lis r8, lit_3973@ha
/* 80595924  C0 28 5D 34 */	lfs f1, lit_3973@l(r8)
/* 80595928  39 00 00 00 */	li r8, 0
/* 8059592C  39 20 FF FF */	li r9, -1
/* 80595930  4B A7 7D 0C */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 8059594C  3C 60 80 59 */	lis r3, lit_3834@ha
/* 80595950  C8 23 5D 2C */	lfd f1, lit_3834@l(r3)
...
/* 80595974  3C 60 80 59 */	lis r3, nodeCallBack__FP8J3DJointi@ha
/* 80595978  38 83 57 84 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l
...
/* 805959D4  4B DC C8 50 */	b _restgpr_28

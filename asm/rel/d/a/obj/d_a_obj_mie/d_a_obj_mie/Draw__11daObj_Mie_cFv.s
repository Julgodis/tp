...
/* 80C95150 00000010  4B 6C D0 8C */	b _savegpr_29
/* 80C95154 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C95158 00000018  3C 60 80 C9 */	lis r3, m__17daObj_Mie_Param_c@ha
/* 80C9515C 0000001C  3B E3 5A AC */	addi r31, r3, m__17daObj_Mie_Param_c@l
...
/* 80C95174 00000034  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C95178 00000038  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80C95188 00000048  4B 50 E6 3C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C9518C 0000004C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C95190 00000050  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80C951A0 00000060  4B 50 FC 00 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C951A4 00000064  7F C3 F3 78 */	mr r3, r30
/* 80C951A8 00000068  7F A4 EB 78 */	mr r4, r29
/* 80C951AC 0000006C  4B 38 82 80 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80C951B0 00000070  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80C951B4 00000074  4B 37 8B 10 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C951B8 00000078  38 00 00 00 */	li r0, 0
/* 80C951BC 0000007C  90 01 00 08 */	stw r0, 8(r1)
/* 80C951C0 00000080  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C951C4 00000084  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C951C8 00000088  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80C951CC 0000008C  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80C951E0 000000A0  4B 38 47 DC */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
lbl_80C951FC:
/* 80C951FC 00000000  C0 3F 00 64 */	lfs f1, 0x64(r31)	/* effective address: 80C95B10 */
...
/* 80C9520C 00000010  3C 60 80 C9 */	lis r3, __vt__8cM3dGPla@ha
/* 80C95210 00000014  38 03 5C 34 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80C95214 00000018  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80C95218 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C9521C 00000020  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C9522C 00000030  4B 3D F5 18 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C95230 00000034  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C95234 00000038  41 82 00 34 */	beq lbl_80C95268
/* 80C95238 0000003C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C9523C 00000040  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C9524C 00000050  C0 5F 00 B8 */	lfs f2, 0xb8(r31)	/* effective address: 80C95B64 */
/* 80C95250 00000054  38 A1 00 0C */	addi r5, r1, 0xc
/* 80C95254 00000058  38 C0 00 00 */	li r6, 0
/* 80C95258 0000005C  C0 7F 00 84 */	lfs f3, 0x84(r31)	/* effective address: 80C95B30 */
/* 80C9525C 00000060  3C E0 80 42 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80C95260 00000064  38 E7 48 D0 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80C95264 00000068  4B 3C 0D 20 */	b setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80C95268:
/* 80C95268 00000000  3C 60 80 C9 */	lis r3, __vt__8cM3dGPla@ha
/* 80C9526C 00000004  38 03 5C 34 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C9527C 00000008  4B 6C CF AC */	b _restgpr_29

...
/* 80D3B2B4 00000014  3C 60 00 00 */	lis r3, cNullVec__6Z2Calc@ha /* 80D3B71C */
/* 80D3B2B8 00000018  38 C3 00 00 */	addi r6, r3, cNullVec__6Z2Calc@l /* 80D3B71C */
/* 80D3B2BC 0000001C  3C 60 00 00 */	lis r3, data_80D3B8F0@ha /* 80D3B8F0 */
/* 80D3B2C0 00000020  38 A3 00 00 */	addi r5, r3, data_80D3B8F0@l /* 80D3B8F0 */
/* 80D3B2C4 00000024  88 05 00 00 */	lbz r0, 0(r5)
/* 80D3B2C8 00000028  7C 00 07 75 */	extsb. r0, r0
/* 80D3B2CC 0000002C  40 82 00 88 */	bne lbl_80D3B354
/* 80D3B2D0 00000030  80 66 00 38 */	lwz r3, 0x38(r6)
/* 80D3B2D4 00000034  80 06 00 3C */	lwz r0, 0x3c(r6)
/* 80D3B2D8 00000038  90 66 00 74 */	stw r3, 0x74(r6)
/* 80D3B2DC 0000003C  90 06 00 78 */	stw r0, 0x78(r6)
/* 80D3B2E0 00000040  80 06 00 40 */	lwz r0, 0x40(r6)
/* 80D3B2E4 00000044  90 06 00 7C */	stw r0, 0x7c(r6)
/* 80D3B2E8 00000048  38 86 00 74 */	addi r4, r6, 0x74
/* 80D3B2EC 0000004C  80 66 00 44 */	lwz r3, 0x44(r6)
/* 80D3B2F0 00000050  80 06 00 48 */	lwz r0, 0x48(r6)
/* 80D3B2F4 00000054  90 64 00 0C */	stw r3, 0xc(r4)
/* 80D3B2F8 00000058  90 04 00 10 */	stw r0, 0x10(r4)
/* 80D3B2FC 0000005C  80 06 00 4C */	lwz r0, 0x4c(r6)
/* 80D3B300 00000060  90 04 00 14 */	stw r0, 0x14(r4)
/* 80D3B304 00000064  80 66 00 50 */	lwz r3, 0x50(r6)
/* 80D3B308 00000068  80 06 00 54 */	lwz r0, 0x54(r6)
/* 80D3B30C 0000006C  90 64 00 18 */	stw r3, 0x18(r4)
/* 80D3B310 00000070  90 04 00 1C */	stw r0, 0x1c(r4)
/* 80D3B314 00000074  80 06 00 58 */	lwz r0, 0x58(r6)
/* 80D3B318 00000078  90 04 00 20 */	stw r0, 0x20(r4)
/* 80D3B31C 0000007C  80 66 00 5C */	lwz r3, 0x5c(r6)
/* 80D3B320 00000080  80 06 00 60 */	lwz r0, 0x60(r6)
/* 80D3B324 00000084  90 64 00 24 */	stw r3, 0x24(r4)
/* 80D3B328 00000088  90 04 00 28 */	stw r0, 0x28(r4)
/* 80D3B32C 0000008C  80 06 00 64 */	lwz r0, 0x64(r6)
/* 80D3B330 00000090  90 04 00 2C */	stw r0, 0x2c(r4)
/* 80D3B334 00000094  80 66 00 68 */	lwz r3, 0x68(r6)
/* 80D3B338 00000098  80 06 00 6C */	lwz r0, 0x6c(r6)
/* 80D3B33C 0000009C  90 64 00 30 */	stw r3, 0x30(r4)
/* 80D3B340 000000A0  90 04 00 34 */	stw r0, 0x34(r4)
/* 80D3B344 000000A4  80 06 00 70 */	lwz r0, 0x70(r6)
/* 80D3B348 000000A8  90 04 00 38 */	stw r0, 0x38(r4)
/* 80D3B34C 000000AC  38 00 00 01 */	li r0, 1
/* 80D3B350 000000B0  98 05 00 00 */	stb r0, 0(r5)
lbl_80D3B354:
...
/* 80D3B38C 00000038  4B FF EA 8D */	bl __ptmf_scall
...
/* 80D3B3D0 0000007C  3C 80 00 00 */	lis r4, lit_4129@ha /* 80D3B6AC */
/* 80D3B3D4 00000080  C0 24 00 00 */	lfs f1, lit_4129@l(r4) /* 80D3B6AC */
...
/* 80D3B3EC 00000098  4B FF EA 2D */	bl animPlay__12daItemBase_cFffffff
/* 80D3B3F0 0000009C  38 7F 09 04 */	addi r3, r31, 0x904
/* 80D3B3F4 000000A0  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80D3B3F8 000000A4  4B FF EA 21 */	bl SetC__8cM3dGCylFRC4cXyz
/* 80D3B3FC 000000A8  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D3B400 000000AC  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D3B404 000000B0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D3B408 000000B4  38 9F 07 E0 */	addi r4, r31, 0x7e0
/* 80D3B40C 000000B8  4B FF EA 0D */	bl Set__4cCcSFP8cCcD_Obj

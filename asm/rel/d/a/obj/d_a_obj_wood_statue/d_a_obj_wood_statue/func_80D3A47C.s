...
/* 80D3A48C  4B 62 7D 4C */	b _savegpr_28
...
/* 80D3A4B0  4B 2D E6 B4 */	b __ct__10fopAc_ac_cFv
/* 80D3A4B4  3C 60 80 3B */	lis r3, __vt__12daItemBase_c@ha
/* 80D3A4B8  38 03 36 10 */	addi r0, r3, __vt__12daItemBase_c@l
/* 80D3A4BC  90 1D 05 68 */	stw r0, 0x568(r29)
/* 80D3A4C0  3B 9D 05 8C */	addi r28, r29, 0x58c
/* 80D3A4C4  7F 83 E3 78 */	mr r3, r28
/* 80D3A4C8  4B 33 BB D8 */	b __ct__9dBgS_AcchFv
/* 80D3A4CC  3C 60 80 D4 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80D3A4D0  38 63 B8 7C */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80D3A4EC  4B 33 E9 7C */	b SetObj__16dBgS_PolyPassChkFv
/* 80D3A4F0  38 7D 07 64 */	addi r3, r29, 0x764
/* 80D3A4F4  4B 33 B9 B8 */	b __ct__12dBgS_AcchCirFv
/* 80D3A4F8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80D3A4FC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80D3A500  90 1D 07 BC */	stw r0, 0x7bc(r29)
/* 80D3A504  38 7D 07 C0 */	addi r3, r29, 0x7c0
/* 80D3A508  4B 34 92 58 */	b __ct__10dCcD_GSttsFv
/* 80D3A50C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80D3A510  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80D3A528  4B 34 95 00 */	b __ct__12dCcD_GObjInfFv
/* 80D3A52C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80D3A530  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80D3A534  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80D3A538  3C 60 80 D4 */	lis r3, __vt__8cM3dGAab@ha
/* 80D3A53C  38 03 B8 70 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80D3A540  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80D3A544  3C 60 80 D4 */	lis r3, __vt__8cM3dGCyl@ha
/* 80D3A548  38 03 B8 64 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80D3A54C  90 1C 01 38 */	stw r0, 0x138(r28)
/* 80D3A550  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80D3A554  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80D3A558  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80D3A55C  38 03 00 58 */	addi r0, r3, 0x58
/* 80D3A560  90 1C 01 38 */	stw r0, 0x138(r28)
/* 80D3A564  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80D3A568  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80D3A580  3C 60 80 D4 */	lis r3, __vt__14daObjWStatue_c@ha
/* 80D3A584  38 03 B8 A0 */	addi r0, r3, __vt__14daObjWStatue_c@l
/* 80D3A588  90 1E 05 68 */	stw r0, 0x568(r30)
/* 80D3A58C  38 7E 09 4C */	addi r3, r30, 0x94c
/* 80D3A590  3C 80 80 D4 */	lis r4, __defctor__19dPa_followEcallBackFv@ha
/* 80D3A594  38 84 A6 F4 */	addi r4, r4, __defctor__19dPa_followEcallBackFv@l
/* 80D3A598  3C A0 80 D4 */	lis r5, __dt__19dPa_followEcallBackFv@ha
/* 80D3A59C  38 A5 A6 6C */	addi r5, r5, __dt__19dPa_followEcallBackFv@l
/* 80D3A5A0  38 C0 00 14 */	li r6, 0x14
/* 80D3A5A4  38 E0 00 02 */	li r7, 2
/* 80D3A5A8  4B 62 77 B8 */	b __construct_array
lbl_80D3A5AC:
...
/* 80D3A5C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D3A5C4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D3A5D8  4B 2F AD 88 */	b isSwitch__10dSv_info_cCFii
...
/* 80D3A5F4  3C 60 80 3B */	lis r3, field_item_res__10dItem_data@ha
/* 80D3A5F8  38 63 DD 88 */	addi r3, r3, field_item_res__10dItem_data@l
/* 80D3A5FC  7C 83 00 2E */	lwzx r4, r3, r0
/* 80D3A600  38 7F 05 6C */	addi r3, r31, 0x56c
/* 80D3A604  4B 2F 28 B8 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D3A618  3C 80 80 03 */	lis r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@ha
/* 80D3A61C  38 84 7B 78 */	addi r4, r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@l
/* 80D3A620  38 A0 08 20 */	li r5, 0x820
/* 80D3A624  4B 2D FE 8C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80D3A658  4B 62 7B CC */	b _restgpr_28

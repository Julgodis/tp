...
/* 80C170A0  4B 74 B1 34 */	b _savegpr_27
/* 80C170A4  7C 7E 1B 78 */	mr r30, r3
/* 80C170A8  3C 60 80 C1 */	lis r3, s_CcDCyl__14daObjHBarrel_c@ha
/* 80C170AC  3B E3 72 FC */	addi r31, r3, s_CcDCyl__14daObjHBarrel_c@l
...
/* 80C170C8  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80C17358 */
/* 80C170CC  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80C170D0  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80C170D4  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80C170D8  3C 60 80 C1 */	lis r3, stringBase0@ha
/* 80C170DC  38 83 73 5C */	addi r4, r3, stringBase0@l
/* 80C170E0  38 64 00 08 */	addi r3, r4, 8
/* 80C170E4  38 84 00 0F */	addi r4, r4, 0xf
/* 80C170E8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C170EC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C170F0  3C A5 00 02 */	addis r5, r5, 2
/* 80C170F4  38 C0 00 80 */	li r6, 0x80
/* 80C170F8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C170FC  4B 42 52 80 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80C17100  7C 7D 1B 78 */	mr r29, r3
/* 80C17104  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C17108  7C 05 07 74 */	extsb r5, r0
/* 80C1710C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C17110  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 80C17114  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)	/* effective address: 8040BEFC */
/* 80C17118  3C 80 80 45 */	lis r4, mEcallback__18dPa_modelEcallBack@ha
/* 80C1711C  38 04 0E 90 */	addi r0, r4, mEcallback__18dPa_modelEcallBack@l
...
/* 80C17160  4B 43 59 30 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C1717C  4B 43 3A 84 */	b setModel__18dPa_modelEcallBackFP14JPABaseEmitterP12J3DModelDataRC12dKy_tevstr_cUcPvUcUc
...
/* 80C171CC  4B 43 58 C4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C171E4  4B 74 B0 3C */	b _restgpr_27

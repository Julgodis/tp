...
/* 80C16EA8  4B 6A 75 FC */	b startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
...
/* 80C16EC4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C16EC8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C16ECC  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80C16EE4  4B 43 53 34 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 80C16EF8  4B 41 61 74 */	b dComIfGp_getReverb__Fi
...
/* 80C16F0C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C16F10  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C16F14  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C16F18  38 81 00 20 */	addi r4, r1, 0x20
/* 80C16F1C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C16F20  38 C0 00 00 */	li r6, 0
/* 80C16F24  3D 00 80 C1 */	lis r8, lit_3916@ha
/* 80C16F28  C0 28 73 48 */	lfs f1, lit_3916@l(r8)
/* 80C16F2C  FC 40 08 90 */	fmr f2, f1
/* 80C16F30  3D 00 80 C1 */	lis r8, lit_3917@ha
/* 80C16F34  C0 68 73 4C */	lfs f3, lit_3917@l(r8)
/* 80C16F38  FC 80 18 90 */	fmr f4, f3
/* 80C16F3C  39 00 00 00 */	li r8, 0
/* 80C16F40  4B 69 4A 44 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C16F78  4B 40 4F EC */	b fopAcM_createItemFromTable__FPC4cXyziiiPC5csXyziPC4cXyzPfPfb
/* 80C16F7C  7F E3 FB 78 */	mr r3, r31
/* 80C16F80  4B 40 2C FC */	b fopAcM_delete__FP10fopAc_ac_c
...
lbl_80C16F98:
/* 80C16F98  3C 60 80 C1 */	lis r3, lit_3916@ha
/* 80C16F9C  C0 03 73 48 */	lfs f0, lit_3916@l(r3)
...
/* 80C16FBC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C16FC0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C16FC4  80 A3 5D AC */	lwz r5, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80C16FEC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C16FF0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C16FF4  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80C1702C  3D 60 80 C1 */	lis r11, lit_3916@ha
/* 80C17030  C0 2B 73 48 */	lfs f1, lit_3916@l(r11)
/* 80C17034  4B 43 5A 5C */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C17038  48 00 00 2C */	b lbl_80C17064
lbl_80C1703C:
/* 80C1703C  38 DF 06 88 */	addi r6, r31, 0x688
/* 80C17040  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C17044  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C17048  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80C17060  4B 43 51 B8 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
lbl_80C17064:

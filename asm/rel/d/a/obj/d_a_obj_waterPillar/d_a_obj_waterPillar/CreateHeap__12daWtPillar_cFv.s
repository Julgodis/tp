...
/* 80D2C868  4B 63 59 74 */	b _savegpr_29
/* 80D2C86C  7C 7F 1B 78 */	mr r31, r3
/* 80D2C870  3C 60 80 D3 */	lis r3, stringBase0@ha
/* 80D2C874  38 63 E8 44 */	addi r3, r3, stringBase0@l
/* 80D2C878  38 80 00 08 */	li r4, 8
/* 80D2C87C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D2C880  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D2C894  4B 30 FA 58 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D2C8A8  4B 2E 83 AC */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D2C8C4:
/* 80D2C8C4  3C 60 80 D3 */	lis r3, stringBase0@ha
/* 80D2C8C8  38 63 E8 44 */	addi r3, r3, stringBase0@l
/* 80D2C8CC  38 80 00 05 */	li r4, 5
/* 80D2C8D0  7F A5 EB 78 */	mr r5, r29
/* 80D2C8D4  38 C0 00 80 */	li r6, 0x80
/* 80D2C8D8  4B 30 FA 14 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D2C8EC  3C E0 80 D3 */	lis r7, lit_3645@ha
/* 80D2C8F0  C0 27 E7 70 */	lfs f1, lit_3645@l(r7)
/* 80D2C8F4  38 E0 00 00 */	li r7, 0
/* 80D2C8F8  39 00 FF FF */	li r8, -1
/* 80D2C8FC  39 20 00 00 */	li r9, 0
/* 80D2C900  4B 2E 0E DC */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 80D2C904  3C 60 80 D3 */	lis r3, stringBase0@ha
/* 80D2C908  38 63 E8 44 */	addi r3, r3, stringBase0@l
/* 80D2C90C  38 80 00 0B */	li r4, 0xb
/* 80D2C910  7F A5 EB 78 */	mr r5, r29
/* 80D2C914  38 C0 00 80 */	li r6, 0x80
/* 80D2C918  4B 30 F9 D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D2C930  3D 00 80 D3 */	lis r8, lit_3645@ha
/* 80D2C934  C0 28 E7 70 */	lfs f1, lit_3645@l(r8)
/* 80D2C938  39 00 00 00 */	li r8, 0
/* 80D2C93C  39 20 FF FF */	li r9, -1
/* 80D2C940  4B 2E 0C FC */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80D2C944  38 60 00 01 */	li r3, 1
lbl_80D2C948:
/* 80D2C948  39 61 00 20 */	addi r11, r1, 0x20
/* 80D2C94C  4B 63 58 DC */	b _restgpr_29

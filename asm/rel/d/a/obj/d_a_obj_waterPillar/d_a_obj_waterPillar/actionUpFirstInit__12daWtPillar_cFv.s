...
/* 80D2D5D8 00000018  3C 60 80 D3 */	lis r3, lit_3645@ha
/* 80D2D5DC 0000001C  3B C3 E7 70 */	addi r30, r3, lit_3645@l
/* 80D2D5E0 00000020  C0 7E 00 84 */	lfs f3, 0x84(r30)	/* effective address: 80D2E7F4 */
/* 80D2D5E4 00000024  C0 5E 00 8C */	lfs f2, 0x8c(r30)	/* effective address: 80D2E7FC */
/* 80D2D5E8 00000028  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 80D2D5EC 0000002C  54 00 7E FE */	rlwinm r0, r0, 0xf, 0x1b, 0x1f
/* 80D2D5F0 00000030  C8 3E 00 98 */	lfd f1, 0x98(r30)	/* effective address: 80D2E808 */
...
/* 80D2D614 00000054  C0 1E 00 AC */	lfs f0, 0xac(r30)	/* effective address: 80D2E81C */
...
/* 80D2D62C 0000006C  C0 1E 00 B8 */	lfs f0, 0xb8(r30)	/* effective address: 80D2E828 */
/* 80D2D630 00000070  D0 1F 0B 10 */	stfs f0, 0xb10(r31)
/* 80D2D634 00000074  48 00 00 0C */	b lbl_80D2D640
lbl_80D2D638:
/* 80D2D638 00000000  C0 1E 00 BC */	lfs f0, 0xbc(r30)	/* effective address: 80D2E82C */
/* 80D2D63C 00000004  D0 1F 0B 10 */	stfs f0, 0xb10(r31)
lbl_80D2D640:
/* 80D2D640 00000000  C0 1E 00 90 */	lfs f0, 0x90(r30)	/* effective address: 80D2E800 */
...
/* 80D2D660 00000020  4B 2F FA 0C */	b dComIfGp_getReverb__Fi
...
/* 80D2D674 00000034  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2D678 00000038  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2D67C 0000003C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2D68C 0000004C  C0 3E 00 00 */	lfs f1, 0(r30)	/* effective address: 80D2E770 */
/* 80D2D690 00000050  FC 40 08 90 */	fmr f2, f1
/* 80D2D694 00000054  C0 7E 00 B4 */	lfs f3, 0xb4(r30)	/* effective address: 80D2E824 */
/* 80D2D698 00000058  FC 80 18 90 */	fmr f4, f3
/* 80D2D69C 0000005C  39 00 00 00 */	li r8, 0
/* 80D2D6A0 00000060  4B 57 E2 E4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

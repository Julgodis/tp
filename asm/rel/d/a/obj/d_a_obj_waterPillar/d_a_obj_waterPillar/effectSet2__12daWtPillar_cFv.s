...
/* 80D2D288  4B 63 4F 54 */	b _savegpr_29
/* 80D2D28C  7C 7E 1B 78 */	mr r30, r3
/* 80D2D290  3C 60 80 D3 */	lis r3, lit_3645@ha
/* 80D2D294  3B E3 E7 70 */	addi r31, r3, lit_3645@l
/* 80D2D298  C0 7E 07 90 */	lfs f3, 0x790(r30)
/* 80D2D29C  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80D2D2A0  EC 23 10 28 */	fsubs f1, f3, f2
/* 80D2D2A4  C0 1F 00 A8 */	lfs f0, 0xa8(r31)	/* effective address: 80D2E818 */
...
/* 80D2D2D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2D2DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D2D2E0  C0 3E 0B 24 */	lfs f1, 0xb24(r30)
/* 80D2D2E4  C0 5E 0B 28 */	lfs f2, 0xb28(r30)
/* 80D2D2E8  C0 7E 0B 2C */	lfs f3, 0xb2c(r30)
/* 80D2D2EC  4B 61 95 FC */	b PSMTXTrans
/* 80D2D2F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2D2F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D2D2F8  38 81 00 38 */	addi r4, r1, 0x38
/* 80D2D2FC  7C 85 23 78 */	mr r5, r4
/* 80D2D300  4B 61 9A 6C */	b PSMTXMultVec
/* 80D2D304  38 61 00 20 */	addi r3, r1, 0x20
/* 80D2D308  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80D2D30C  38 A1 00 38 */	addi r5, r1, 0x38
/* 80D2D310  4B 53 97 D4 */	b __pl__4cXyzCFRC3Vec
...
/* 80D2D334  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2D338  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80D2D33C  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80D2D388  4B 32 01 44 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2D3DC  4B 32 00 F0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80D2D3E0  90 7E 0B 68 */	stw r3, 0xb68(r30)
lbl_80D2D3E4:
/* 80D2D3E4  39 61 00 60 */	addi r11, r1, 0x60
/* 80D2D3E8  4B 63 4E 40 */	b _restgpr_29

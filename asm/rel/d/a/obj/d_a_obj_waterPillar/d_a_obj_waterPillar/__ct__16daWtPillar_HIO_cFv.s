...
/* 80D2C6EC  C0 05 00 00 */	lfs f0, 0(r5)	/* effective address: 80D2E770 */
...
/* 80D2C71C  C0 05 00 04 */	lfs f0, 4(r5)	/* effective address: 80D2E774 */
/* 80D2C720  D0 03 00 20 */	stfs f0, 0x20(r3)
/* 80D2C724  98 03 00 19 */	stb r0, 0x19(r3)
/* 80D2C728  C0 05 00 08 */	lfs f0, 8(r5)	/* effective address: 80D2E778 */
/* 80D2C72C  D0 03 00 34 */	stfs f0, 0x34(r3)
/* 80D2C730  38 00 00 3C */	li r0, 0x3c
/* 80D2C734  98 03 00 2C */	stb r0, 0x2c(r3)
/* 80D2C738  C0 05 00 0C */	lfs f0, 0xc(r5)	/* effective address: 80D2E77C */
/* 80D2C73C  D0 03 00 40 */	stfs f0, 0x40(r3)
/* 80D2C740  C0 05 00 10 */	lfs f0, 0x10(r5)	/* effective address: 80D2E780 */
/* 80D2C744  D0 03 00 44 */	stfs f0, 0x44(r3)
/* 80D2C748  C0 05 00 14 */	lfs f0, 0x14(r5)	/* effective address: 80D2E784 */
/* 80D2C74C  D0 03 00 48 */	stfs f0, 0x48(r3)
/* 80D2C750  C0 25 00 18 */	lfs f1, 0x18(r5)	/* effective address: 80D2E788 */
/* 80D2C754  D0 23 00 4C */	stfs f1, 0x4c(r3)
/* 80D2C758  C0 05 00 1C */	lfs f0, 0x1c(r5)	/* effective address: 80D2E78C */

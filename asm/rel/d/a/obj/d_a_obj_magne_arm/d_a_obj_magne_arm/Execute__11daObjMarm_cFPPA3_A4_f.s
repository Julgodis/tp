...
/* 80590520 0000001C  3C 80 00 00 */	lis r4, cNullVec__6Z2Calc@ha /* 80592980 */
/* 80590524 00000020  3B A4 00 00 */	addi r29, r4, cNullVec__6Z2Calc@l /* 80592980 */
/* 80590528 00000024  3C 80 00 00 */	lis r4, l_magne_scale@ha /* 80592848 */
/* 8059052C 00000028  3B C4 00 00 */	addi r30, r4, l_magne_scale@l /* 80592848 */
...
/* 805905A0 0000009C  3C 60 00 00 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 80023590 */
/* 805905A4 000000A0  38 63 00 00 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 80023590 */
...
/* 805905D8 000000D4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 805905DC 000000D8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805905FC 000000F8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80590600 000000FC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80590604 00000100  A8 9C 0A 32 */	lha r4, 0xa32(r28)
/* 80590608 00000104  4B FF ED 31 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8059060C 00000108  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80590610 0000010C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 8059068C 0000000C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80590690 00000010  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80590700 00000080  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80590704 00000084  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 8059073C 000000BC  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80590740 000000C0  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80590744 000000C4  4B FF EB F5 */	bl PSMTXCopy
/* 80590748 000000C8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8059074C 000000CC  3B E3 00 00 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80590798 00000118  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8059079C 0000011C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 805907D4 00000154  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805907D8 00000158  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */

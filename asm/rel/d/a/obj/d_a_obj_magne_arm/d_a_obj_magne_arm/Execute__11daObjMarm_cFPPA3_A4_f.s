...
/* 80590514  4B DD 1C C4 */	b _savegpr_28
/* 80590518  7C 7C 1B 78 */	mr r28, r3
/* 8059051C  7C 9F 23 78 */	mr r31, r4
/* 80590520  3C 80 80 59 */	lis r4, cNullVec__6Z2Calc@ha
/* 80590524  3B A4 29 80 */	addi r29, r4, cNullVec__6Z2Calc@l
/* 80590528  3C 80 80 59 */	lis r4, l_magne_scale@ha
/* 8059052C  3B C4 28 48 */	addi r30, r4, l_magne_scale@l
...
/* 8059057C  4B AE B4 44 */	b Move__4dBgWFv
/* 80590580  80 7C 06 30 */	lwz r3, 0x630(r28)
/* 80590584  4B AE B4 3C */	b Move__4dBgWFv
/* 80590588  80 7C 05 C0 */	lwz r3, 0x5c0(r28)
/* 8059058C  4B A7 CE 9C */	b play__14mDoExt_baseAnmFv
/* 80590590  80 7C 05 C4 */	lwz r3, 0x5c4(r28)
/* 80590594  4B A7 CE 94 */	b play__14mDoExt_baseAnmFv
/* 80590598  80 1C 0A 18 */	lwz r0, 0xa18(r28)
/* 8059059C  90 01 00 08 */	stw r0, 8(r1)
/* 805905A0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 805905A4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 805905A8  38 81 00 08 */	addi r4, r1, 8
/* 805905AC  4B A8 92 4C */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 805905D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805905DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805905F8  4B A7 BD E4 */	b mDoMtx_YrotS__FPA4_fs
/* 805905FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80590600  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80590604  A8 9C 0A 32 */	lha r4, 0xa32(r28)
/* 80590608  4B A7 BE C4 */	b mDoMtx_ZrotM__FPA4_fs
/* 8059060C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80590610  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80590614  38 81 00 0C */	addi r4, r1, 0xc
/* 80590618  7C 85 23 78 */	mr r5, r4
/* 8059061C  4B DB 67 50 */	b PSMTXMultVec
/* 80590620  38 61 00 18 */	addi r3, r1, 0x18
/* 80590624  38 81 00 0C */	addi r4, r1, 0xc
/* 80590628  7C 65 1B 78 */	mr r5, r3
/* 8059062C  4B DB 6A 64 */	b PSVECAdd
...
/* 8059068C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80590690  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 805906E4  4B CD F3 9C */	b cLib_addCalc0__FPfff
...
/* 80590700  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80590704  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80590730  4B CD F3 50 */	b cLib_addCalc0__FPfff
/* 80590734  80 7C 05 AC */	lwz r3, 0x5ac(r28)
/* 80590738  38 63 00 24 */	addi r3, r3, 0x24
/* 8059073C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80590740  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80590744  4B DB 5D 6C */	b PSMTXCopy
/* 80590748  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8059074C  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 80590750  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 803DD47C */
/* 80590754  D0 1C 0A 44 */	stfs f0, 0xa44(r28)
/* 80590758  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 803DD48C */
/* 8059075C  D0 1C 0A 48 */	stfs f0, 0xa48(r28)
/* 80590760  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 803DD49C */
...
/* 80590774  4B DB 5D 3C */	b PSMTXCopy
...
/* 80590798  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8059079C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805907A0  4B DB 5D 10 */	b PSMTXCopy
...
/* 805907D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805907D8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805907F8  4B AE 35 10 */	b request__10dAttLook_cFP10fopAc_ac_cfffsi
/* 805907FC  38 60 00 01 */	li r3, 1
/* 80590800  39 61 00 50 */	addi r11, r1, 0x50
/* 80590804  4B DD 1A 20 */	b _restgpr_28

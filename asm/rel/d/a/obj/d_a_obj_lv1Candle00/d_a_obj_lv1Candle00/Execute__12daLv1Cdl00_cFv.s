...
/* 80C56398  4B 70 BE 44 */	b _savegpr_29
/* 80C5639C  7C 7F 1B 78 */	mr r31, r3
/* 80C563A0  3C 60 80 C5 */	lis r3, mCcDObjInfo__12daLv1Cdl00_c@ha
/* 80C563A4  3B C3 6A 50 */	addi r30, r3, mCcDObjInfo__12daLv1Cdl00_c@l
/* 80C563A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C563AC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C563C0  4B 3D EF A0 */	b isSwitch__10dSv_info_cCFii
...
/* 80C56440  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C56444  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80C56448  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C56460  3D 00 80 45 */	lis r8, g_whiteColor@ha
/* 80C56464  39 08 06 08 */	addi r8, r8, g_whiteColor@l
/* 80C56468  7D 09 43 78 */	mr r9, r8
/* 80C5646C  39 40 00 00 */	li r10, 0
/* 80C56470  C0 3E 00 40 */	lfs f1, 0x40(r30)
/* 80C56474  4B 3F 6D 44 */	b setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
...
/* 80C56490  3D 00 80 45 */	lis r8, g_whiteColor@ha
/* 80C56494  39 08 06 08 */	addi r8, r8, g_whiteColor@l
/* 80C56498  7D 09 43 78 */	mr r9, r8
/* 80C5649C  39 40 00 00 */	li r10, 0
/* 80C564A0  C0 3E 00 40 */	lfs f1, 0x40(r30)
/* 80C564A4  4B 3F 6D 14 */	b setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
...
/* 80C564BC  3D 00 80 45 */	lis r8, g_whiteColor@ha
/* 80C564C0  39 08 06 08 */	addi r8, r8, g_whiteColor@l
/* 80C564C4  7D 09 43 78 */	mr r9, r8
/* 80C564C8  39 40 00 00 */	li r10, 0
/* 80C564CC  C0 3E 00 40 */	lfs f1, 0x40(r30)
/* 80C564D0  4B 3F 6C E8 */	b setSimple__13dPa_control_cFUsPC4cXyzPC12dKy_tevstr_cUcRC8_GXColorRC8_GXColorif
/* 80C564D4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C564D8  7C 03 07 74 */	extsb r3, r0
/* 80C564DC  4B 3D 6B 90 */	b dComIfGp_getReverb__Fi
...
/* 80C564F0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C564F4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C564F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C56580  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C56584  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C56598  4B 3D EC 68 */	b onSwitch__10dSv_info_cFii
/* 80C5659C  48 00 00 20 */	b lbl_80C565BC
lbl_80C565A0:
/* 80C565A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C565A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C565B8  4B 3D EC F8 */	b offSwitch__10dSv_info_cFii
lbl_80C565BC:
/* 80C565BC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C565C0  7C 03 07 74 */	extsb r3, r0
/* 80C565C4  4B 3D 6A A8 */	b dComIfGp_getReverb__Fi
...
/* 80C565D8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C565DC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C565E0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C56604  4B 65 53 80 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C56650  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C56654  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C56668  4B 3D EC 48 */	b offSwitch__10dSv_info_cFii
/* 80C5666C  48 00 00 20 */	b lbl_80C5668C
lbl_80C56670:
/* 80C56670  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C56674  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C56688  4B 3D EB 78 */	b onSwitch__10dSv_info_cFii
lbl_80C5668C:
/* 80C5668C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C56690  7C 03 07 74 */	extsb r3, r0
/* 80C56694  4B 3D 69 D8 */	b dComIfGp_getReverb__Fi
...
/* 80C566A8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C566AC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C566B0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C56708  4B 42 DE 40 */	b GetTgHitGObj__12dCcD_GObjInfFv
...
/* 80C56734  4B 42 DE 48 */	b GetTgHitObjSe__12dCcD_GObjInfFv
/* 80C56738  38 80 00 01 */	li r4, 1
/* 80C5673C  4B 42 DE 74 */	b getHitSeID__12dCcD_GObjInfFUci
...
/* 80C56750  4B 66 7D 54 */	b startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
...
/* 80C56770  4B 3D 68 FC */	b dComIfGp_getReverb__Fi
...
/* 80C56798  4B 61 8A 68 */	b SetR__8cM3dGCylFf
/* 80C5679C  38 7F 06 D4 */	addi r3, r31, 0x6d4
/* 80C567A0  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 80C567A4  4B 61 8A 54 */	b SetH__8cM3dGCylFf
/* 80C567A8  38 7F 06 D4 */	addi r3, r31, 0x6d4
/* 80C567AC  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C567B0  4B 61 8A 2C */	b SetC__8cM3dGCylFRC4cXyz
/* 80C567B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C567B8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C567BC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80C567C0  38 9F 05 B0 */	addi r4, r31, 0x5b0
/* 80C567C4  4B 60 E3 E4 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80C567D8  4B 70 BA 50 */	b _restgpr_29

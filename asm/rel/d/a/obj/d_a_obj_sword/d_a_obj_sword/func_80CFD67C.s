...
/* 80CFD68C  4B 66 4B 50 */	b _savegpr_29
...
/* 80CFD6AC  4B 31 B4 B8 */	b __ct__10fopAc_ac_cFv
/* 80CFD6B0  3C 60 80 3B */	lis r3, __vt__12daItemBase_c@ha
/* 80CFD6B4  38 03 36 10 */	addi r0, r3, __vt__12daItemBase_c@l
/* 80CFD6B8  90 1E 05 68 */	stw r0, 0x568(r30)
/* 80CFD6BC  3B BE 05 8C */	addi r29, r30, 0x58c
/* 80CFD6C0  7F A3 EB 78 */	mr r3, r29
/* 80CFD6C4  4B 37 89 DC */	b __ct__9dBgS_AcchFv
/* 80CFD6C8  3C 60 80 D0 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80CFD6CC  38 63 DF E4 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80CFD6E8  4B 37 B7 80 */	b SetObj__16dBgS_PolyPassChkFv
/* 80CFD6EC  38 7E 07 64 */	addi r3, r30, 0x764
/* 80CFD6F0  4B 37 87 BC */	b __ct__12dBgS_AcchCirFv
/* 80CFD6F4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80CFD6F8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80CFD6FC  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 80CFD700  38 7E 07 C0 */	addi r3, r30, 0x7c0
/* 80CFD704  4B 38 60 5C */	b __ct__10dCcD_GSttsFv
/* 80CFD708  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80CFD70C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80CFD724  4B 38 63 04 */	b __ct__12dCcD_GObjInfFv
/* 80CFD728  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80CFD72C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80CFD730  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80CFD734  3C 60 80 D0 */	lis r3, __vt__8cM3dGAab@ha
/* 80CFD738  38 03 DF D8 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80CFD73C  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80CFD740  3C 60 80 D0 */	lis r3, __vt__8cM3dGCyl@ha
/* 80CFD744  38 03 DF CC */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80CFD748  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80CFD74C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80CFD750  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80CFD754  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80CFD758  38 03 00 58 */	addi r0, r3, 0x58
/* 80CFD75C  90 1D 01 38 */	stw r0, 0x138(r29)
/* 80CFD760  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80CFD764  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80CFD77C  3C 60 80 D0 */	lis r3, __vt__12daObjSword_c@ha
/* 80CFD780  38 03 DF 88 */	addi r0, r3, __vt__12daObjSword_c@l
...
/* 80CFD7B4  4B 33 7D DC */	b isItem__10dSv_info_cCFii
...
/* 80CFD7D0  3C 60 80 3B */	lis r3, field_item_res__10dItem_data@ha
/* 80CFD7D4  38 63 DD 88 */	addi r3, r3, field_item_res__10dItem_data@l
/* 80CFD7D8  7C 83 00 2E */	lwzx r4, r3, r0
/* 80CFD7DC  38 7F 05 6C */	addi r3, r31, 0x56c
/* 80CFD7E0  4B 32 F6 DC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CFD7F4  3C 80 80 03 */	lis r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@ha
/* 80CFD7F8  38 84 7B 78 */	addi r4, r4, CheckFieldItemCreateHeap__FP10fopAc_ac_c@l
/* 80CFD7FC  38 A0 40 00 */	li r5, 0x4000
/* 80CFD800  4B 31 CC B0 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80CFD834  4B 66 49 F4 */	b _restgpr_29

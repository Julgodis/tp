...
/* 80D1C588 00000018  3C 60 80 D2 */	lis r3, l_R02_eff_id@ha
/* 80D1C58C 0000001C  3B E3 D3 D4 */	addi r31, r3, l_R02_eff_id@l
...
/* 80D1C5CC 0000005C  4B 33 F1 94 */	b dKyr_get_vectle_calc__FP4cXyzP4cXyzP4cXyz
...
/* 80D1C5E8 00000078  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 80D1D410 */
...
/* 80D1C5F8 00000088  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 80D1D404 */
...
/* 80D1C60C 0000009C  C0 5F 00 40 */	lfs f2, 0x40(r31)	/* effective address: 80D1D414 */
/* 80D1C610 000000A0  C0 1F 00 44 */	lfs f0, 0x44(r31)	/* effective address: 80D1D418 */
/* 80D1C614 000000A4  EC 80 00 F2 */	fmuls f4, f0, f3
/* 80D1C618 000000A8  4B 55 33 64 */	b cLib_addCalc__FPfffff
...
/* 80D1C628 000000B8  C0 5F 00 40 */	lfs f2, 0x40(r31)	/* effective address: 80D1D414 */
/* 80D1C62C 000000BC  C0 1F 00 44 */	lfs f0, 0x44(r31)	/* effective address: 80D1D418 */
/* 80D1C630 000000C0  EC 80 00 F2 */	fmuls f4, f0, f3
/* 80D1C634 000000C4  4B 55 33 48 */	b cLib_addCalc__FPfffff
...
/* 80D1C644 000000D4  C0 5F 00 40 */	lfs f2, 0x40(r31)	/* effective address: 80D1D414 */
/* 80D1C648 000000D8  C0 1F 00 44 */	lfs f0, 0x44(r31)	/* effective address: 80D1D418 */
/* 80D1C64C 000000DC  EC 80 00 F2 */	fmuls f4, f0, f3
/* 80D1C650 000000E0  4B 55 33 2C */	b cLib_addCalc__FPfffff
/* 80D1C654 000000E4  38 7E 07 3C */	addi r3, r30, 0x73c
/* 80D1C658 000000E8  38 9E 06 F4 */	addi r4, r30, 0x6f4
/* 80D1C65C 000000EC  4B 62 AD 40 */	b PSVECSquareDistance
/* 80D1C660 000000F0  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 80D1D404 */
...
/* 80D1C670 00000008  C8 9F 00 48 */	lfd f4, 0x48(r31)	/* effective address: 80D1D41C */
/* 80D1C674 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80D1C678 00000010  C8 7F 00 50 */	lfd f3, 0x50(r31)	/* effective address: 80D1D424 */
...
lbl_80D1C6C0:
/* 80D1C6C0 00000000  C8 1F 00 58 */	lfd f0, 0x58(r31)	/* effective address: 80D1D42C */
/* 80D1C6C4 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80D1C6C8 00000000  40 80 00 10 */	bge lbl_80D1C6D8
/* 80D1C6CC 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D1C6D0 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80D1C73C 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D1C740 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80D1C744:

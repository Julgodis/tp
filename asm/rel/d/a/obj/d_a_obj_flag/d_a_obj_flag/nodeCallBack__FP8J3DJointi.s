...
/* 80BEC01C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80BEC020  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80BEC024  4B 75 A4 8C */	b PSMTXCopy
/* 80BEC028  A8 81 00 08 */	lha r4, 8(r1)
/* 80BEC02C  7C 80 07 35 */	extsh. r0, r4
/* 80BEC030  41 82 00 10 */	beq lbl_80BEC040
/* 80BEC034  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEC038  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEC03C  4B 42 03 60 */	b mDoMtx_XrotM__FPA4_fs
lbl_80BEC040:
/* 80BEC040  A8 81 00 0C */	lha r4, 0xc(r1)
/* 80BEC044  7C 80 07 35 */	extsh. r0, r4
/* 80BEC048  41 82 00 10 */	beq lbl_80BEC058
/* 80BEC04C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEC050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEC054  4B 42 04 78 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80BEC058:
/* 80BEC058  A8 81 00 0A */	lha r4, 0xa(r1)
/* 80BEC05C  7C 80 07 35 */	extsh. r0, r4
/* 80BEC060  41 82 00 10 */	beq lbl_80BEC070
/* 80BEC064  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEC068  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEC06C  4B 42 03 C8 */	b mDoMtx_YrotM__FPA4_fs
lbl_80BEC070:
/* 80BEC070  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEC074  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEC078  80 9F 00 84 */	lwz r4, 0x84(r31)
/* 80BEC07C  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80BEC080  7C 80 F2 14 */	add r4, r0, r30
/* 80BEC084  4B 75 A4 2C */	b PSMTXCopy
/* 80BEC088  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEC08C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEC090  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80BEC094  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80BEC098  4B 75 A4 18 */	b PSMTXCopy

...
/* 80C25ADC  3C 60 80 C2 */	lis r3, l_arcName@ha
/* 80C25AE0  38 63 5D D0 */	addi r3, r3, l_arcName@l
/* 80C25AE4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C25DD0 */
/* 80C25AE8  38 80 00 04 */	li r4, 4
/* 80C25AEC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C25AF0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C25AF4  3C A5 00 02 */	addis r5, r5, 2
/* 80C25AF8  38 C0 00 80 */	li r6, 0x80
/* 80C25AFC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C25B00  4B 41 67 EC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C25B1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C25B20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C25B24  C0 3F 09 1C */	lfs f1, 0x91c(r31)
/* 80C25B28  C0 5F 09 20 */	lfs f2, 0x920(r31)
/* 80C25B2C  C0 7F 09 24 */	lfs f3, 0x924(r31)
/* 80C25B30  4B 72 0D B8 */	b PSMTXTrans
/* 80C25B34  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80C25B38  4B 3E 72 9C */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80C25B3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C25B40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C25B44  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80C25B48  D0 1F 09 70 */	stfs f0, 0x970(r31)
/* 80C25B4C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C25B50  D0 1F 09 74 */	stfs f0, 0x974(r31)
/* 80C25B54  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80C25B68  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C25B6C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C25B70  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C25B84  3D 00 80 C2 */	lis r8, lit_3806@ha
/* 80C25B88  C0 28 5D 78 */	lfs f1, lit_3806@l(r8)
/* 80C25B8C  FC 40 08 90 */	fmr f2, f1
/* 80C25B90  3D 00 80 C2 */	lis r8, lit_4095@ha
/* 80C25B94  C0 68 5D A0 */	lfs f3, lit_4095@l(r8)
/* 80C25B98  FC 80 18 90 */	fmr f4, f3
/* 80C25B9C  39 00 00 00 */	li r8, 0
/* 80C25BA0  4B 68 5D E4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

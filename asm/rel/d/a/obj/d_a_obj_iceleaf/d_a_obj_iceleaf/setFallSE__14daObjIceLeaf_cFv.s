...
/* 80C25ADC 00000014  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C25AE0 00000018  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C25AE4 0000001C  80 63 00 00 */	lwz r3, 0(r3)
/* 80C25AE8 00000020  38 80 00 04 */	li r4, 4
/* 80C25AEC 00000024  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C25AF0 00000028  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C25B1C 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C25B20 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C25B3C 00000074  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C25B40 00000078  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C25B68 000000A0  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C25B6C 000000A4  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 80C25B84 000000BC  3D 00 00 00 */	lis r8, lit_3806@ha
/* 80C25B88 000000C0  C0 28 00 00 */	lfs f1, lit_3806@l(r8)
/* 80C25B8C 000000C4  FC 40 08 90 */	fmr f2, f1
/* 80C25B90 000000C8  3D 00 00 00 */	lis r8, lit_4095@ha
/* 80C25B94 000000CC  C0 68 00 00 */	lfs f3, lit_4095@l(r8)

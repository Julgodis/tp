...
/* 80C24798 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C2479C 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_80C24814:
/* 80C24814 00000000  3C 60 00 00 */	lis r3, lit_3703@ha
/* 80C24818 00000004  C0 23 00 00 */	lfs f1, lit_3703@l(r3)
/* 80C2481C 00000008  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C24820 0000000C  3C 60 00 00 */	lis r3, lit_3704@ha
/* 80C24824 00000010  C0 03 00 00 */	lfs f0, lit_3704@l(r3)
...
/* 80C24844 00000030  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C24848 00000034  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80C24868 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2486C 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C2487C 00000068  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24880 0000006C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C24894 00000080  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24898 00000084  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_80C248C8:
/* 80C248C8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C248CC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_80C248FC:
/* 80C248FC 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C24900 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C24904 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 80C24908 0000000C  38 80 00 04 */	li r4, 4
/* 80C2490C 00000010  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C24910 00000014  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2493C 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24940 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C2495C 00000060  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24960 00000064  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_80C249BC:
/* 80C249BC 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C249C0 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

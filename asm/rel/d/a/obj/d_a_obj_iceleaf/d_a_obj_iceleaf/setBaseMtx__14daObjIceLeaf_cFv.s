...
/* 80C24784  4B 73 DA 58 */	b _savegpr_29
...
/* 80C24798  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C2479C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C247A0  83 C3 5D B4 */	lwz r30, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 80C247D0  4B 72 25 9C */	b PSMTXMultVec
...
/* 80C247F0  4B 72 25 7C */	b PSMTXMultVec
...
/* 80C2480C  4B 64 2E 68 */	b cM_atan2s__Fff
/* 80C24810  7C 7D 1B 78 */	mr r29, r3
lbl_80C24814:
/* 80C24814  3C 60 80 C2 */	lis r3, lit_3703@ha
/* 80C24818  C0 23 5D 64 */	lfs f1, lit_3703@l(r3)
/* 80C2481C  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C24820  3C 60 80 C2 */	lis r3, lit_3704@ha
/* 80C24824  C0 03 5D 68 */	lfs f0, lit_3704@l(r3)
...
/* 80C24844  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C24848  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C2484C  4B 72 1C 64 */	b PSMTXCopy
...
/* 80C24868  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2486C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C24870  7F A4 EB 78 */	mr r4, r29
/* 80C24874  38 C0 00 00 */	li r6, 0
/* 80C24878  4B 3E 7A 28 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80C2487C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24880  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C24884  38 80 40 00 */	li r4, 0x4000
/* 80C24888  4B 3E 7B AC */	b mDoMtx_YrotM__FPA4_fs
/* 80C2488C  38 61 00 1C */	addi r3, r1, 0x1c
/* 80C24890  4B 3E 85 44 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80C24894  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24898  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2489C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80C248A0  D0 1F 05 38 */	stfs f0, 0x538(r31)
/* 80C248A4  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C248A8  D0 1F 05 3C */	stfs f0, 0x53c(r31)
/* 80C248AC  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80C248B0  D0 1F 05 40 */	stfs f0, 0x540(r31)
/* 80C248B4  48 00 00 14 */	b lbl_80C248C8
lbl_80C248B8:
/* 80C248B8  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80C248BC  4B 3E 84 A8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C248C0  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80C248C4  4B 3E 86 80 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80C248C8:
/* 80C248C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C248CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C248D0  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80C248D4  38 84 00 24 */	addi r4, r4, 0x24
/* 80C248D8  4B 72 1B D8 */	b PSMTXCopy
...
/* 80C248EC  4B 3E 84 78 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C248F0  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80C248F4  4B 3E 86 50 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C248F8  48 00 00 C4 */	b lbl_80C249BC
lbl_80C248FC:
/* 80C248FC  3C 60 80 C2 */	lis r3, l_arcName@ha
/* 80C24900  38 63 5D D0 */	addi r3, r3, l_arcName@l
/* 80C24904  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C25DD0 */
/* 80C24908  38 80 00 04 */	li r4, 4
/* 80C2490C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C24910  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C24914  3C A5 00 02 */	addis r5, r5, 2
/* 80C24918  38 C0 00 80 */	li r6, 0x80
/* 80C2491C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C24920  4B 41 79 CC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2493C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24940  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C24944  C0 3F 09 1C */	lfs f1, 0x91c(r31)
/* 80C24948  C0 5F 09 20 */	lfs f2, 0x920(r31)
/* 80C2494C  C0 7F 09 24 */	lfs f3, 0x924(r31)
/* 80C24950  4B 72 1F 98 */	b PSMTXTrans
/* 80C24954  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80C24958  4B 3E 84 7C */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80C2495C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C24960  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C24964  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80C24968  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80C2496C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C24970  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80C24974  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80C249B0  4B 3E 83 B4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C249B4  38 61 00 08 */	addi r3, r1, 8
/* 80C249B8  4B 3E 85 8C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
lbl_80C249BC:
/* 80C249BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C249C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C249C4  38 9F 09 30 */	addi r4, r31, 0x930
/* 80C249C8  4B 72 1A E8 */	b PSMTXCopy
/* 80C249CC  39 61 00 50 */	addi r11, r1, 0x50
/* 80C249D0  4B 73 D8 58 */	b _restgpr_29

...
/* 80BFCC00  4B 76 55 D8 */	b _savegpr_28
/* 80BFCC04  7C 7F 1B 78 */	mr r31, r3
/* 80BFCC08  3C 80 80 C0 */	lis r4, lit_3686@ha
/* 80BFCC0C  3B C4 D3 2C */	addi r30, r4, lit_3686@l
...
/* 80BFCC28  4B 41 BF 3C */	b __ct__10fopAc_ac_cFv
/* 80BFCC2C  38 7D 05 78 */	addi r3, r29, 0x578
/* 80BFCC30  4B 6C 37 98 */	b __ct__10Z2CreatureFv
/* 80BFCC34  38 7D 06 14 */	addi r3, r29, 0x614
/* 80BFCC38  3C 80 80 C0 */	lis r4, __ct__4cXyzFv@ha
/* 80BFCC3C  38 84 D2 38 */	addi r4, r4, __ct__4cXyzFv@l
/* 80BFCC40  3C A0 80 C0 */	lis r5, __dt__4cXyzFv@ha
/* 80BFCC44  38 A5 B3 D4 */	addi r5, r5, __dt__4cXyzFv@l
/* 80BFCC48  38 C0 00 0C */	li r6, 0xc
/* 80BFCC4C  38 E0 00 02 */	li r7, 2
/* 80BFCC50  4B 76 51 10 */	b __construct_array
/* 80BFCC54  38 7D 06 54 */	addi r3, r29, 0x654
/* 80BFCC58  3C 80 80 C0 */	lis r4, __ct__4cXyzFv@ha
/* 80BFCC5C  38 84 D2 38 */	addi r4, r4, __ct__4cXyzFv@l
/* 80BFCC60  3C A0 80 C0 */	lis r5, __dt__4cXyzFv@ha
/* 80BFCC64  38 A5 B3 D4 */	addi r5, r5, __dt__4cXyzFv@l
/* 80BFCC68  38 C0 00 0C */	li r6, 0xc
/* 80BFCC6C  38 E0 00 02 */	li r7, 2
/* 80BFCC70  4B 76 50 F0 */	b __construct_array
/* 80BFCC74  38 7D 06 6C */	addi r3, r29, 0x66c
/* 80BFCC78  3C 80 80 C0 */	lis r4, __ct__4cXyzFv@ha
/* 80BFCC7C  38 84 D2 38 */	addi r4, r4, __ct__4cXyzFv@l
/* 80BFCC80  3C A0 80 C0 */	lis r5, __dt__4cXyzFv@ha
/* 80BFCC84  38 A5 B3 D4 */	addi r5, r5, __dt__4cXyzFv@l
/* 80BFCC88  38 C0 00 0C */	li r6, 0xc
/* 80BFCC8C  38 E0 00 02 */	li r7, 2
/* 80BFCC90  4B 76 50 D0 */	b __construct_array
/* 80BFCC94  38 7D 06 84 */	addi r3, r29, 0x684
/* 80BFCC98  3C 80 80 C0 */	lis r4, __ct__4cXyzFv@ha
/* 80BFCC9C  38 84 D2 38 */	addi r4, r4, __ct__4cXyzFv@l
/* 80BFCCA0  3C A0 80 C0 */	lis r5, __dt__4cXyzFv@ha
/* 80BFCCA4  38 A5 B3 D4 */	addi r5, r5, __dt__4cXyzFv@l
/* 80BFCCA8  38 C0 00 0C */	li r6, 0xc
/* 80BFCCAC  38 E0 00 06 */	li r7, 6
/* 80BFCCB0  4B 76 50 B0 */	b __construct_array
/* 80BFCCB4  38 7D 06 CC */	addi r3, r29, 0x6cc
/* 80BFCCB8  3C 80 80 C0 */	lis r4, __ct__4cXyzFv@ha
/* 80BFCCBC  38 84 D2 38 */	addi r4, r4, __ct__4cXyzFv@l
/* 80BFCCC0  3C A0 80 C0 */	lis r5, __dt__4cXyzFv@ha
/* 80BFCCC4  38 A5 B3 D4 */	addi r5, r5, __dt__4cXyzFv@l
/* 80BFCCC8  38 C0 00 0C */	li r6, 0xc
/* 80BFCCCC  38 E0 00 06 */	li r7, 6
/* 80BFCCD0  4B 76 50 90 */	b __construct_array
/* 80BFCCD4  38 7D 07 30 */	addi r3, r29, 0x730
/* 80BFCCD8  4B 47 91 D4 */	b __ct__12dBgS_AcchCirFv
/* 80BFCCDC  3B 9D 07 70 */	addi r28, r29, 0x770
/* 80BFCCE0  7F 83 E3 78 */	mr r3, r28
/* 80BFCCE4  4B 47 93 BC */	b __ct__9dBgS_AcchFv
/* 80BFCCE8  3C 60 80 C0 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80BFCCEC  38 63 D5 60 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80BFCD08  4B 47 C1 60 */	b SetObj__16dBgS_PolyPassChkFv
/* 80BFCD0C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80BFCD10  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80BFCD14  90 1D 09 64 */	stw r0, 0x964(r29)
/* 80BFCD18  38 7D 09 68 */	addi r3, r29, 0x968
/* 80BFCD1C  4B 48 6A 44 */	b __ct__10dCcD_GSttsFv
/* 80BFCD20  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80BFCD24  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80BFCD3C  4B 48 6C EC */	b __ct__12dCcD_GObjInfFv
/* 80BFCD40  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80BFCD44  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80BFCD48  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80BFCD4C  3C 60 80 C0 */	lis r3, __vt__8cM3dGAab@ha
/* 80BFCD50  38 03 D5 54 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80BFCD54  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80BFCD58  3C 60 80 C0 */	lis r3, __vt__8cM3dGSph@ha
/* 80BFCD5C  38 03 D5 48 */	addi r0, r3, __vt__8cM3dGSph@l
/* 80BFCD60  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80BFCD64  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 80BFCD68  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 80BFCD6C  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80BFCD70  38 03 00 58 */	addi r0, r3, 0x58
/* 80BFCD74  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80BFCD78  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 80BFCD7C  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 80BFCDA4  3C 80 80 C0 */	lis r4, stringBase0@ha
/* 80BFCDA8  38 84 D3 C0 */	addi r4, r4, stringBase0@l
/* 80BFCDAC  4B 43 01 10 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80BFCE10  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BFCE14  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BFCE18  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80BFCE1C  7C 05 07 74 */	extsb r5, r0
/* 80BFCE20  4B 43 85 40 */	b isSwitch__10dSv_info_cCFii
...
/* 80BFCE38  3C 80 80 C0 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80BFCE3C  38 84 CB 74 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80BFCE40  38 A0 10 00 */	li r5, 0x1000
/* 80BFCE44  4B 41 D6 6C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80BFCE58:
/* 80BFCE58  3C 60 80 C0 */	lis r3, data_80BFD598@ha
/* 80BFCE5C  8C 03 D5 98 */	lbzu r0, data_80BFD598@l(r3)
...
/* 80BFCE78  3C 60 80 C0 */	lis r3, l_HIO@ha
/* 80BFCE7C  38 63 D5 A8 */	addi r3, r3, l_HIO@l
/* 80BFCE80  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80BFD5AC */
lbl_80BFCE84:
...
/* 80BFCEA0  4B 41 D6 88 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80BFCEB4  4B 41 D6 84 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80BFCF00  4B 6C 36 30 */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80BFCF14  4B 66 AA 40 */	b cM_rndF__Ff
...
/* 80BFCF2C  4B 66 AA 60 */	b cM_rndFX__Ff
...
/* 80BFCF68  4B 47 92 E0 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80BFCF7C  3C 80 80 C0 */	lis r4, obj_size@ha
/* 80BFCF80  38 84 D3 E8 */	addi r4, r4, obj_size@l
/* 80BFCF84  7C 44 04 2E */	lfsx f2, r4, r0
/* 80BFCF88  4B 47 8F D0 */	b SetWall__12dBgS_AcchCirFff
/* 80BFCF8C  C0 3E 00 8C */	lfs f1, 0x8c(r30)
/* 80BFCF90  4B 66 A9 C4 */	b cM_rndF__Ff
...
/* 80BFCFEC  4B 41 CF 04 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80BFD040  4B 41 CE B0 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80BFD058  4B 76 51 CC */	b _restgpr_28

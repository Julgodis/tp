...
/* 80D3F588  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D3F58C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D3F590  80 03 5D B4 */	lwz r0, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 80D3F5A8  3C 60 80 D4 */	lis r3, l_open_speed@ha
/* 80D3F5AC  38 63 02 74 */	addi r3, r3, l_open_speed@l
...
lbl_80D3F5C8:
/* 80D3F5C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D3F5CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D3F5D0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80D3F5D4  88 03 05 68 */	lbz r0, 0x568(r3)	/* effective address: 80406728 */
...
/* 80D3F5EC  3C 60 80 D4 */	lis r3, lit_3714@ha
/* 80D3F5F0  C8 23 02 8C */	lfd f1, lit_3714@l(r3)
...
/* 80D3F60C  3C 60 80 D4 */	lis r3, lit_3712@ha
/* 80D3F610  C0 03 02 84 */	lfs f0, lit_3712@l(r3)

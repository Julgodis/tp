...
/* 80C71884  4B 3B B7 E8 */	b dComIfGp_getReverb__Fi
...
/* 80C71898  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C7189C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C718A0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C718A4  38 81 00 08 */	addi r4, r1, 8
/* 80C718A8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C718AC  38 C0 00 00 */	li r6, 0
/* 80C718B0  3D 00 80 C7 */	lis r8, lit_3922@ha
/* 80C718B4  C0 28 21 98 */	lfs f1, lit_3922@l(r8)
/* 80C718B8  FC 40 08 90 */	fmr f2, f1
/* 80C718BC  3D 00 80 C7 */	lis r8, lit_3923@ha
/* 80C718C0  C0 68 21 9C */	lfs f3, lit_3923@l(r8)
/* 80C718C4  FC 80 18 90 */	fmr f4, f3
/* 80C718C8  39 00 00 00 */	li r8, 0
/* 80C718CC  4B 63 A0 B8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C718D0:

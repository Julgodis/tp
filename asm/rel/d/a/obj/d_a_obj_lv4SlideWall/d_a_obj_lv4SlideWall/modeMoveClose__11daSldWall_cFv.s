...
/* 80C62338 00000018  3C 60 00 00 */	lis r3, lit_3627@ha /* 80C626A8 */
/* 80C6233C 0000001C  3B E3 00 00 */	addi r31, r3, lit_3627@l /* 80C626A8 */
/* 80C62340 00000020  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C62344 00000024  7C 03 07 74 */	extsb r3, r0
/* 80C62348 00000028  4B FF FA 51 */	bl dComIfGp_getReverb__Fi
...
/* 80C6235C 0000003C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 80C62360 00000040  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 80C62364 00000044  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C62374 00000054  C0 3F 00 0C */	lfs f1, 0xc(r31)
/* 80C62378 00000058  FC 40 08 90 */	fmr f2, f1
/* 80C6237C 0000005C  C0 7F 00 10 */	lfs f3, 0x10(r31)
/* 80C62380 00000060  FC 80 18 90 */	fmr f4, f3
/* 80C62384 00000064  39 00 00 00 */	li r8, 0
/* 80C62388 00000068  4B FF FA 11 */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C6238C 0000006C  38 7E 05 B0 */	addi r3, r30, 0x5b0
/* 80C62390 00000070  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C62394 00000074  C0 5F 00 14 */	lfs f2, 0x14(r31)
/* 80C62398 00000078  3C 80 00 00 */	lis r4, l_HIO@ha /* 80C627DC */
/* 80C6239C 0000007C  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80C627DC */
/* 80C623A0 00000080  C0 64 00 08 */	lfs f3, 8(r4)
/* 80C623A4 00000084  C0 9F 00 18 */	lfs f4, 0x18(r31)
/* 80C623A8 00000088  4B FF F9 F1 */	bl cLib_addCalc__FPfffff
/* 80C623AC 0000008C  C0 1F 00 08 */	lfs f0, 8(r31)

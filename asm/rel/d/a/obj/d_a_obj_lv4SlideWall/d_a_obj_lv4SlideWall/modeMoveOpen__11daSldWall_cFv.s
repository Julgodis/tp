...
/* 80C6226C 00000018  3C 60 80 C6 */	lis r3, lit_3627@ha
/* 80C62270 0000001C  3B E3 26 A8 */	addi r31, r3, lit_3627@l
/* 80C62274 00000020  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C62278 00000024  7C 03 07 74 */	extsb r3, r0
/* 80C6227C 00000028  4B 3C AD F0 */	b dComIfGp_getReverb__Fi
...
/* 80C62290 0000003C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C62294 00000040  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C62298 00000044  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C622A8 00000054  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 80C626B4 */
/* 80C622AC 00000058  FC 40 08 90 */	fmr f2, f1
/* 80C622B0 0000005C  C0 7F 00 10 */	lfs f3, 0x10(r31)	/* effective address: 80C626B8 */
/* 80C622B4 00000060  FC 80 18 90 */	fmr f4, f3
/* 80C622B8 00000064  39 00 00 00 */	li r8, 0
/* 80C622BC 00000068  4B 64 A2 50 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C622C0 0000006C  38 7E 05 B0 */	addi r3, r30, 0x5b0
/* 80C622C4 00000070  3C 80 80 C6 */	lis r4, l_HIO@ha
/* 80C622C8 00000074  38 84 27 DC */	addi r4, r4, l_HIO@l
/* 80C622CC 00000078  C0 24 00 04 */	lfs f1, 4(r4)	/* effective address: 80C627E0 */
/* 80C622D0 0000007C  C0 5F 00 14 */	lfs f2, 0x14(r31)	/* effective address: 80C626BC */
/* 80C622D4 00000080  C0 64 00 08 */	lfs f3, 8(r4)	/* effective address: 80C627E4 */
/* 80C622D8 00000084  C0 9F 00 18 */	lfs f4, 0x18(r31)	/* effective address: 80C626C0 */
/* 80C622DC 00000088  4B 60 D6 A0 */	b cLib_addCalc__FPfffff
/* 80C622E0 0000008C  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80C626B0 */

...
/* 80C61FE4  4B 41 66 40 */	b __ct__16dBgS_MoveBgActorFv
/* 80C61FE8  3C 60 80 C6 */	lis r3, __vt__11daSldWall_c@ha
/* 80C61FEC  38 03 27 88 */	addi r0, r3, __vt__11daSldWall_c@l
...
/* 80C62004  3C 80 80 C6 */	lis r4, stringBase0@ha
/* 80C62008  38 84 26 C4 */	addi r4, r4, stringBase0@l
/* 80C6200C  4B 3C AE B0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C62020  3C 80 80 C6 */	lis r4, stringBase0@ha
/* 80C62024  38 84 26 C4 */	addi r4, r4, stringBase0@l
/* 80C62028  38 A0 00 07 */	li r5, 7
/* 80C6202C  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C62030  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C62034  38 E0 13 00 */	li r7, 0x1300
/* 80C62038  39 00 00 00 */	li r8, 0
/* 80C6203C  4B 41 67 80 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C62068  4B 3B 85 10 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80C6206C  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80C62070  98 1E 05 AD */	stb r0, 0x5ad(r30)
/* 80C62074  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C62078  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6207C  88 9E 05 AD */	lbz r4, 0x5ad(r30)
/* 80C62080  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C62084  7C 05 07 74 */	extsb r5, r0
/* 80C62088  4B 3D 32 D8 */	b isSwitch__10dSv_info_cCFii
/* 80C6208C  98 7E 05 AE */	stb r3, 0x5ae(r30)
/* 80C62090  3C 60 80 C6 */	lis r3, lit_3649@ha
/* 80C62094  C0 03 26 B0 */	lfs f0, lit_3649@l(r3)
...
/* 80C620A8  3C 60 80 C6 */	lis r3, l_HIO@ha
/* 80C620AC  38 63 27 DC */	addi r3, r3, l_HIO@l
/* 80C620B0  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80C627E0 */

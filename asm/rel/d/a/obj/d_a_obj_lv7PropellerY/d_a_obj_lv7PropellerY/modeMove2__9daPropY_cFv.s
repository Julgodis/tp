...
/* 80C85B94  4B 6D C6 44 */	b _savegpr_28
/* 80C85B98  7C 7F 1B 78 */	mr r31, r3
/* 80C85B9C  3C 60 80 C8 */	lis r3, lit_3650@ha
/* 80C85BA0  3B 83 61 30 */	addi r28, r3, lit_3650@l
/* 80C85BA4  38 7F 05 2C */	addi r3, r31, 0x52c
/* 80C85BA8  3C 80 80 C8 */	lis r4, l_HIO@ha
/* 80C85BAC  3B A4 62 CC */	addi r29, r4, l_HIO@l
/* 80C85BB0  C0 3D 00 10 */	lfs f1, 0x10(r29)	/* effective address: 80C862DC */
/* 80C85BB4  C0 5D 00 08 */	lfs f2, 8(r29)	/* effective address: 80C862D4 */
/* 80C85BB8  4B 5E AB 88 */	b cLib_chaseF__FPfff
...
/* 80C85BE4  4B 5E A9 5C */	b cLib_addCalcAngleS__FPsssss
...
/* 80C85C0C  4B 3A 74 60 */	b dComIfGp_getReverb__Fi
/* 80C85C10  7C 7D 1B 78 */	mr r29, r3
/* 80C85C14  C0 3F 05 C4 */	lfs f1, 0x5c4(r31)
/* 80C85C18  4B 6D C4 94 */	b __cvt_fp2unsigned
...
/* 80C85C2C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C85C30  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C85C34  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C85C58  4B 62 68 B4 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C85C98  4B 6D C5 8C */	b _restgpr_28

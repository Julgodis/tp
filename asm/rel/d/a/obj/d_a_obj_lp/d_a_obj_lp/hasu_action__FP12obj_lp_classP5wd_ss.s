...
/* 80C546E8  4B 70 DA F4 */	b _savegpr_29
/* 80C546EC  7C 7D 1B 78 */	mr r29, r3
/* 80C546F0  7C 9E 23 78 */	mr r30, r4
/* 80C546F4  3C A0 80 C5 */	lis r5, lit_3916@ha
/* 80C546F8  3B E5 5A 10 */	addi r31, r5, lit_3916@l
...
/* 80C54714  4B 61 B3 6C */	b cLib_addCalc0__FPfff
...
/* 80C54728  4B 61 BE E0 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C5473C  4B 61 BE CC */	b cLib_addCalcAngleS2__FPssss
...
/* 80C54750  4B 61 B2 EC */	b cLib_addCalc2__FPffff
...
/* 80C54764  4B 61 B2 D8 */	b cLib_addCalc2__FPffff
...
/* 80C54778  4B 61 B2 C4 */	b cLib_addCalc2__FPffff
lbl_80C5477C:
...
/* 80C5478C  4B 61 23 A8 */	b __mi__4cXyzCFRC3Vec
...
/* 80C547AC  4B 6F 29 8C */	b PSVECSquareMag
...
/* 80C5481C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C54820  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C5488C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C54890  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C54894:
...
/* 80C548E4  4B 61 2D 90 */	b cM_atan2s__Fff
/* 80C548E8  B0 7E 00 42 */	sth r3, 0x42(r30)
lbl_80C548EC:
/* 80C548EC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C548F0  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80C5495C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C54960  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C54978  4B 6F 1F 70 */	b PSMTXTrans
/* 80C5497C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C54980  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C54984  A8 9E 00 42 */	lha r4, 0x42(r30)
/* 80C54988  4B 3B 7A AC */	b mDoMtx_YrotM__FPA4_fs
/* 80C5498C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C54990  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C54994  A8 9E 00 44 */	lha r4, 0x44(r30)
/* 80C54998  4B 3B 7A 04 */	b mDoMtx_XrotM__FPA4_fs
/* 80C5499C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C549A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C549B4  4B 3B 7A 80 */	b mDoMtx_YrotM__FPA4_fs
/* 80C549B8  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C549BC  FC 40 08 90 */	fmr f2, f1
/* 80C549C0  C0 7E 00 28 */	lfs f3, 0x28(r30)
/* 80C549C4  4B 3B 83 D8 */	b transM__14mDoMtx_stack_cFfff
/* 80C549C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C549CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C549D0  A8 9E 00 36 */	lha r4, 0x36(r30)
/* 80C549D4  4B 3B 79 C8 */	b mDoMtx_XrotM__FPA4_fs
/* 80C549D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C549DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C549E0  A8 9E 00 38 */	lha r4, 0x38(r30)
/* 80C549E4  4B 3B 7A 50 */	b mDoMtx_YrotM__FPA4_fs
/* 80C549E8  C0 3E 00 3C */	lfs f1, 0x3c(r30)
/* 80C549EC  FC 40 08 90 */	fmr f2, f1
/* 80C549F0  FC 60 08 90 */	fmr f3, f1
/* 80C549F4  4B 3B 84 44 */	b scaleM__14mDoMtx_stack_cFfff
/* 80C549F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C549FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C54A00  80 9E 00 00 */	lwz r4, 0(r30)
/* 80C54A04  38 84 00 24 */	addi r4, r4, 0x24
/* 80C54A08  4B 6F 1A A8 */	b PSMTXCopy
...
/* 80C54B0C  4B 70 D7 1C */	b _restgpr_29

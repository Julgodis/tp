...
/* 80C54394 00000004  4B FF FD E5 */	bl _savegpr_24
/* 80C54398 00000008  7C 9B 23 78 */	mr r27, r4
/* 80C5439C 0000000C  3C 60 00 00 */	lis r3, lit_1109@ha /* 80C55B40 */
/* 80C543A0 00000010  3B C3 00 00 */	addi r30, r3, lit_1109@l /* 80C55B40 */
/* 80C543A4 00000014  3C 60 00 00 */	lis r3, lit_3916@ha /* 80C55A10 */
/* 80C543A8 00000018  3B E3 00 00 */	addi r31, r3, lit_3916@l /* 80C55A10 */
/* 80C543AC 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C543B0 00000020  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C543B4 00000024  83 A3 5D AC */	lwz r29, 0x5dac(r3)
/* 80C543B8 00000028  3B 80 00 00 */	li r28, 0
/* 80C543BC 0000002C  C3 DF 00 00 */	lfs f30, 0(r31)
...
/* 80C543CC 0000003C  C3 FF 00 04 */	lfs f31, 4(r31)
...
/* 80C543E4 00000010  4B FF FD 95 */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54418 00000014  C0 1F 00 08 */	lfs f0, 8(r31)
...
/* 80C54448 00000010  C0 5F 00 0C */	lfs f2, 0xc(r31)
/* 80C5444C 00000014  C0 1F 00 10 */	lfs f0, 0x10(r31)
/* 80C54450 00000018  EC 60 00 72 */	fmuls f3, f0, f1
/* 80C54454 0000001C  4B FF FD 25 */	bl cLib_addCalc2__FPffff
/* 80C54458 00000020  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 80C5445C 00000024  C0 41 00 34 */	lfs f2, 0x34(r1)
/* 80C54460 00000028  4B FF FD 19 */	bl cM_atan2s__Fff
...
/* 80C54474 0000003C  4B FF FD 05 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C54488 00000050  4B FF FC F1 */	bl cLib_addCalcAngleS2__FPssss
/* 80C5448C 00000054  3B 80 00 01 */	li r28, 1
lbl_80C54490:
/* 80C54490 00000000  C3 DF 00 14 */	lfs f30, 0x14(r31)
/* 80C54494 00000004  3B 18 00 01 */	addi r24, r24, 1
/* 80C54498 00000008  3B 5A 00 04 */	addi r26, r26, 4
lbl_80C5449C:
/* 80C5449C 00000000  80 1E 00 70 */	lwz r0, 0x70(r30)
/* 80C544A0 00000004  7C 18 00 00 */	cmpw r24, r0
/* 80C544A4 00000008  41 80 FF 30 */	blt lbl_80C543D4
/* 80C544A8 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C544AC 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C544B0 00000014  80 63 5D B4 */	lwz r3, 0x5db4(r3)
/* 80C544B4 00000018  81 83 06 28 */	lwz r12, 0x628(r3)
...
/* 80C544CC 00000030  C3 FF 00 08 */	lfs f31, 8(r31)
/* 80C544D0 00000034  80 1E 00 44 */	lwz r0, 0x44(r30)
...
/* 80C544F0 00000054  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C544F4 00000058  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C544F8 0000005C  4B FF FC 81 */	bl PSMTXCopy
/* 80C544FC 00000060  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C54500 00000064  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C54504 00000068  C0 23 00 0C */	lfs f1, 0xc(r3)
/* 80C54508 0000006C  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 80C5450C 00000070  C0 03 00 1C */	lfs f0, 0x1c(r3)
/* 80C54510 00000074  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80C54514 00000078  C0 43 00 2C */	lfs f2, 0x2c(r3)
...
/* 80C54540 000000A4  C0 1F 00 18 */	lfs f0, 0x18(r31)
/* 80C54544 000000A8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C54548 00000000  40 80 00 08 */	bge lbl_80C54550
/* 80C5454C 00000004  C3 FF 00 1C */	lfs f31, 0x1c(r31)
lbl_80C54550:
...
/* 80C5455C 0000000C  4B FF FC 1D */	bl __mi__4cXyzCFRC3Vec
...
/* 80C54578 00000028  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 80C5457C 0000002C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 80C54580 00000030  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C54590 00000040  4B FF FB E9 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C54594 00000044  C0 3F 00 08 */	lfs f1, 8(r31)
/* 80C54598 00000048  FC 40 08 90 */	fmr f2, f1
/* 80C5459C 0000004C  FC 60 08 90 */	fmr f3, f1
/* 80C545A0 00000050  38 60 00 01 */	li r3, 1
/* 80C545A4 00000054  4B FF FB D5 */	bl MtxTrans__FfffUc
/* 80C545A8 00000058  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C545AC 0000005C  38 81 00 20 */	addi r4, r1, 0x20
/* 80C545B0 00000060  4B FF FB C9 */	bl MtxPosition__FP4cXyzP4cXyz
/* 80C545B4 00000064  80 1E 00 40 */	lwz r0, 0x40(r30)
/* 80C545B8 00000068  2C 00 00 00 */	cmpwi r0, 0
/* 80C545BC 0000006C  41 82 00 10 */	beq lbl_80C545CC
/* 80C545C0 00000070  C0 7F 00 20 */	lfs f3, 0x20(r31)
/* 80C545C4 00000074  C0 9F 00 24 */	lfs f4, 0x24(r31)
/* 80C545C8 00000078  48 00 00 0C */	b lbl_80C545D4
lbl_80C545CC:
/* 80C545CC 00000000  C0 7F 00 28 */	lfs f3, 0x28(r31)
/* 80C545D0 00000004  C0 9F 00 2C */	lfs f4, 0x2c(r31)
lbl_80C545D4:
...
/* 80C545E0 0000000C  C0 1F 00 14 */	lfs f0, 0x14(r31)
...
/* 80C54610 00000004  C0 1F 00 30 */	lfs f0, 0x30(r31)
...
/* 80C54630 00000014  C0 1F 00 34 */	lfs f0, 0x34(r31)
...
/* 80C54644 00000008  C0 1F 00 38 */	lfs f0, 0x38(r31)
/* 80C54648 0000000C  EC 00 07 F2 */	fmuls f0, f0, f31
/* 80C5464C 00000010  EC 21 00 2A */	fadds f1, f1, f0
/* 80C54650 00000014  C0 5F 00 10 */	lfs f2, 0x10(r31)
/* 80C54654 00000018  C0 7F 00 3C */	lfs f3, 0x3c(r31)
/* 80C54658 0000001C  4B FF FB 21 */	bl cLib_addCalc2__FPffff
/* 80C5465C 00000020  38 7B 00 28 */	addi r3, r27, 0x28
/* 80C54660 00000024  FC 20 F8 90 */	fmr f1, f31
/* 80C54664 00000028  C0 5F 00 0C */	lfs f2, 0xc(r31)
/* 80C54668 0000002C  C0 1F 00 10 */	lfs f0, 0x10(r31)
/* 80C5466C 00000030  EC 60 07 F2 */	fmuls f3, f0, f31
/* 80C54670 00000034  4B FF FB 09 */	bl cLib_addCalc2__FPffff
/* 80C54674 00000038  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 80C54678 0000003C  C0 41 00 34 */	lfs f2, 0x34(r1)
/* 80C5467C 00000040  4B FF FA FD */	bl cM_atan2s__Fff
...
/* 80C54690 00000054  4B FF FA E9 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C546A4 00000068  4B FF FA D5 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80C546C4 00000008  4B FF FA B5 */	bl _restgpr_24

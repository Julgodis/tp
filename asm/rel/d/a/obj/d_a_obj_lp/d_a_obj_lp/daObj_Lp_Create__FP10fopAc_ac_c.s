...
/* 80C554C0 00000014  3C 80 00 00 */	lis r4, lit_3916@ha /* 80C55A10 */
/* 80C554C4 00000018  3B C4 00 00 */	addi r30, r4, lit_3916@l /* 80C55A10 */
...
/* 80C554E8 0000003C  3C 80 00 00 */	lis r4, __ct__5wd_ssFv@ha /* 80C55A04 */
/* 80C554EC 00000040  38 84 00 00 */	addi r4, r4, __ct__5wd_ssFv@l /* 80C55A04 */
/* 80C554F0 00000044  3C A0 00 00 */	lis r5, __dt__5wd_ssFv@ha /* 80C559C8 */
/* 80C554F4 00000048  38 A5 00 00 */	addi r5, r5, __dt__5wd_ssFv@l /* 80C559C8 */
...
/* 80C55504 00000058  3C 60 00 00 */	lis r3, __vt__18mDoExt_3DlineMat_c@ha /* 80C55B2C */
/* 80C55508 0000005C  38 03 00 00 */	addi r0, r3, __vt__18mDoExt_3DlineMat_c@l /* 80C55B2C */
/* 80C5550C 00000060  3C 96 00 01 */	addis r4, r22, 1
/* 80C55510 00000064  90 04 AD 7C */	stw r0, -0x5284(r4)
/* 80C55514 00000068  3C 60 00 00 */	lis r3, __vt__19mDoExt_3DlineMat0_c@ha /* 803A325C */
/* 80C55518 0000006C  38 03 00 00 */	addi r0, r3, __vt__19mDoExt_3DlineMat0_c@l /* 803A325C */
...
/* 80C55530 00000004  3C 80 00 00 */	lis r4, stringBase0@ha /* 80C55AC0 */
/* 80C55534 00000008  38 84 00 00 */	addi r4, r4, stringBase0@l /* 80C55AC0 */
...
/* 80C55590 00000010  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C55594 00000014  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C555D0 00000050  3C 80 00 00 */	lis r4, stringBase0@ha /* 80C55AC0 */
/* 80C555D4 00000054  38 84 00 00 */	addi r4, r4, stringBase0@l /* 80C55AC0 */
...
/* 80C55610 00000004  3C 80 00 00 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 80C5518C */
/* 80C55614 00000008  38 84 00 00 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 80C5518C */
...
/* 80C556FC 00000004  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 80C55700 00000008  3B E3 00 00 */	addi r31, r3, calc_mtx@l /* 80450768 */
...
/* 80C55928 00000018  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C55AC0 */
/* 80C5592C 0000001C  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C55AC0 */
/* 80C55930 00000020  38 63 00 07 */	addi r3, r3, 7
/* 80C55934 00000024  38 80 00 03 */	li r4, 3
/* 80C55938 00000028  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C5593C 0000002C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */

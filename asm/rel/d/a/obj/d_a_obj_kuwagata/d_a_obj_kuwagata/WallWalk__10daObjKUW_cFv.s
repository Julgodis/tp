...
/* 80C4AD68  4B 71 74 74 */	b _savegpr_29
...
/* 80C4ADC8  4B 42 CE A0 */	b __ct__11dBgS_LinChkFv
/* 80C4ADCC  38 61 01 34 */	addi r3, r1, 0x134
/* 80C4ADD0  4B 42 E0 98 */	b SetObj__16dBgS_PolyPassChkFv
/* 80C4ADD4  38 61 00 C4 */	addi r3, r1, 0xc4
/* 80C4ADD8  4B 42 E0 90 */	b SetObj__16dBgS_PolyPassChkFv
/* 80C4ADDC  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C4ADE0  4B 3C 1F 84 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C4ADE4  38 7D 09 9A */	addi r3, r29, 0x99a
/* 80C4ADE8  4B 3C 21 5C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C4ADEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4ADF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4ADF4  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 80C4ADF8  4B 3C 16 3C */	b mDoMtx_YrotM__FPA4_fs
/* 80C4ADFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4AE00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4AE04  38 81 00 4C */	addi r4, r1, 0x4c
/* 80C4AE08  7C 85 23 78 */	mr r5, r4
/* 80C4AE0C  4B 6F BF 60 */	b PSMTXMultVec
/* 80C4AE10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C4AE14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C4AE18  38 81 00 40 */	addi r4, r1, 0x40
/* 80C4AE1C  7C 85 23 78 */	mr r5, r4
/* 80C4AE20  4B 6F BF 4C */	b PSMTXMultVec
...
/* 80C4AE4C  4B 42 95 68 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 80C4AE60  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha
/* 80C4AE64  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C4AE78  4B 42 98 CC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C4AE7C  C0 21 00 58 */	lfs f1, 0x58(r1)
/* 80C4AE80  C0 41 00 60 */	lfs f2, 0x60(r1)
/* 80C4AE84  4B 61 C7 F0 */	b cM_atan2s__Fff
...
/* 80C4AEB8  4B 6F C4 E4 */	b PSVECSquareDistance
...
/* 80C4AF28  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C4AF2C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C4AF98  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C4AF9C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C4AFE4  4B 6F C3 B8 */	b PSVECSquareDistance
...
/* 80C4B054  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C4B058  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C4B0C4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C4B0C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C4B0CC:
...
/* 80C4B104  4B 61 C5 70 */	b cM_atan2s__Fff
...
/* 80C4B118  4B 61 C5 5C */	b cM_atan2s__Fff
...
lbl_80C4B130:
/* 80C4B130  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha
/* 80C4B134  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C4B15C  4B 62 54 AC */	b cLib_addCalcAngleS2__FPssss

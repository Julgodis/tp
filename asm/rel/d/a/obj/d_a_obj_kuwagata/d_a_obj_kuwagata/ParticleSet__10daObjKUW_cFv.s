...
/* 80C4BEC4  3C 60 80 C5 */	lis r3, lit_4517@ha
/* 80C4BEC8  C8 23 D5 60 */	lfd f1, lit_4517@l(r3)
...
/* 80C4BEEC  3C 80 80 C5 */	lis r4, lit_3932@ha
/* 80C4BEF0  C0 24 D4 E0 */	lfs f1, lit_3932@l(r4)
/* 80C4BEF4  3C 80 80 C5 */	lis r4, lit_3895@ha
/* 80C4BEF8  C0 44 D4 DC */	lfs f2, lit_3895@l(r4)
/* 80C4BEFC  FC 60 10 90 */	fmr f3, f2
/* 80C4BF00  4B 62 3B 3C */	b cLib_addCalc2__FPffff
/* 80C4BF04  48 00 00 1C */	b lbl_80C4BF20
lbl_80C4BF08:
/* 80C4BF08  38 7F 09 A8 */	addi r3, r31, 0x9a8
/* 80C4BF0C  C0 3F 09 AC */	lfs f1, 0x9ac(r31)
/* 80C4BF10  3C 80 80 C5 */	lis r4, lit_3895@ha
/* 80C4BF14  C0 44 D4 DC */	lfs f2, lit_3895@l(r4)
/* 80C4BF18  FC 60 10 90 */	fmr f3, f2
/* 80C4BF1C  4B 62 3B 20 */	b cLib_addCalc2__FPffff
lbl_80C4BF20:
/* 80C4BF20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4BF24  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80C4BF28  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80C4BF6C  3D 60 80 C5 */	lis r11, lit_3895@ha
/* 80C4BF70  C0 2B D4 DC */	lfs f1, lit_3895@l(r11)
/* 80C4BF74  4B 40 15 58 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C4BF8C  4B 3F F9 8C */	b getEmitter__Q213dPa_control_c7level_cFUl

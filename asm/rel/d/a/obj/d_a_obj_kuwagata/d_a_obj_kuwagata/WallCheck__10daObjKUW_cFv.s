...
/* 80C4A9E0 00000010  4B 71 77 FC */	b _savegpr_29
/* 80C4A9E4 00000014  7C 7F 1B 78 */	mr r31, r3
/* 80C4A9E8 00000018  3C 60 80 C5 */	lis r3, lit_3775@ha
/* 80C4A9EC 0000001C  3B C3 D4 90 */	addi r30, r3, lit_3775@l
/* 80C4A9F0 00000020  38 61 00 38 */	addi r3, r1, 0x38
/* 80C4A9F4 00000024  4B 42 D2 74 */	b __ct__11dBgS_LinChkFv
/* 80C4A9F8 00000028  38 61 00 90 */	addi r3, r1, 0x90
/* 80C4A9FC 0000002C  4B 42 E4 6C */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C4AA10 00000040  4B 42 D3 54 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C4AA14 00000044  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C4AA18 00000048  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C4AA28 00000058  4B 42 99 8C */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C4AA2C 0000005C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C4AA30 00000060  41 82 01 A4 */	beq lbl_80C4ABD4
/* 80C4AA34 00000064  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha
/* 80C4AA38 00000068  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C4AA4C 0000007C  4B 42 9C F8 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C4AA68 00000098  C0 1E 00 50 */	lfs f0, 0x50(r30)	/* effective address: 80C4D4E0 */
...
/* 80C4AA94 000000C4  4B 6F C9 08 */	b PSVECSquareDistance
/* 80C4AA98 000000C8  C0 1E 00 50 */	lfs f0, 0x50(r30)	/* effective address: 80C4D4E0 */
...
/* 80C4AAA8 00000008  C8 9E 00 68 */	lfd f4, 0x68(r30)	/* effective address: 80C4D4F8 */
/* 80C4AAAC 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C4AAB0 00000010  C8 7E 00 70 */	lfd f3, 0x70(r30)	/* effective address: 80C4D500 */
...
lbl_80C4AAF8:
/* 80C4AAF8 00000000  C8 1E 00 78 */	lfd f0, 0x78(r30)	/* effective address: 80C4D508 */
/* 80C4AAFC 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C4AB00 00000000  40 80 00 10 */	bge lbl_80C4AB10
/* 80C4AB04 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C4AB08 00000008  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C4AB74 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C4AB78 0000000C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C4AB88 00000004  4B 61 CA EC */	b cM_atan2s__Fff
...
/* 80C4AB9C 00000018  4B 61 CA D8 */	b cM_atan2s__Fff
...
/* 80C4ABAC 00000028  4B 61 CA C8 */	b cM_atan2s__Fff
/* 80C4ABB0 0000002C  B0 7F 09 A2 */	sth r3, 0x9a2(r31)
/* 80C4ABB4 00000030  3C 60 80 C5 */	lis r3, __vt__8cM3dGPla@ha
/* 80C4ABB8 00000034  38 03 D6 34 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C4ABC8 00000044  4B 42 D1 14 */	b __dt__11dBgS_LinChkFv
...
/* 80C4ABDC 00000008  4B 42 D1 00 */	b __dt__11dBgS_LinChkFv
/* 80C4ABE0 0000000C  38 60 00 00 */	li r3, 0
lbl_80C4ABE4:
/* 80C4ABE4 00000000  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80C4ABE8 00000004  4B 71 76 40 */	b _restgpr_29

...
/* 80C4A864 00000018  3C 80 80 C5 */	lis r4, lit_3775@ha
/* 80C4A868 0000001C  3B E4 D4 90 */	addi r31, r4, lit_3775@l
...
lbl_80C4A888:
/* 80C4A888 00000000  C0 1F 00 50 */	lfs f0, 0x50(r31)	/* effective address: 80C4D4E0 */
/* 80C4A88C 00000004  D0 1E 05 2C */	stfs f0, 0x52c(r30)
/* 80C4A890 00000008  3C 60 80 C5 */	lis r3, stringBase0@ha
/* 80C4A894 0000000C  38 63 D5 8C */	addi r3, r3, stringBase0@l
/* 80C4A898 00000010  38 80 00 07 */	li r4, 7
/* 80C4A89C 00000014  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C4A8A0 00000018  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C4A8B0 00000028  4B 3F 1A 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4A8C0 00000038  C0 3F 00 54 */	lfs f1, 0x54(r31)	/* effective address: 80C4D4E4 */
/* 80C4A8C4 0000003C  C0 5F 00 50 */	lfs f2, 0x50(r31)	/* effective address: 80C4D4E0 */
/* 80C4A8C8 00000040  FC 60 10 90 */	fmr f3, f2
/* 80C4A8CC 00000044  C0 9F 00 58 */	lfs f4, 0x58(r31)	/* effective address: 80C4D4E8 */
/* 80C4A8D0 00000048  4B 3C 65 A0 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C4A8E0 00000058  C0 3F 00 5C */	lfs f1, 0x5c(r31)	/* effective address: 80C4D4EC */
/* 80C4A8E4 0000005C  4B 61 D0 70 */	b cM_rndF__Ff
/* 80C4A8E8 00000060  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80C4D4EC */
...
lbl_80C4A904:
/* 80C4A904 00000000  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C4A908 00000004  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80C4A90C 00000008  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C4A910 0000000C  4B 3C FE D0 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80C4A914 00000010  C0 1F 00 64 */	lfs f0, 0x64(r31)	/* effective address: 80C4D4F4 */
...
/* 80C4A94C 0000000C  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 80C4D4F0 */
/* 80C4A950 00000010  4B 61 D0 04 */	b cM_rndF__Ff
...
lbl_80C4A998:
/* 80C4A998 00000000  C0 3F 00 5C */	lfs f1, 0x5c(r31)	/* effective address: 80C4D4EC */
/* 80C4A99C 00000004  4B 61 CF B8 */	b cM_rndF__Ff
/* 80C4A9A0 00000008  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80C4D4EC */

...
/* 80C4B1C0  3C 60 80 C5 */	lis r3, lit_3775@ha
/* 80C4B1C4  3B E3 D4 90 */	addi r31, r3, lit_3775@l
...
lbl_80C4B21C:
/* 80C4B21C  3C 60 80 C5 */	lis r3, stringBase0@ha
/* 80C4B220  38 63 D5 8C */	addi r3, r3, stringBase0@l
/* 80C4B224  38 80 00 07 */	li r4, 7
/* 80C4B228  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C4B22C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C4B230  3C A5 00 02 */	addis r5, r5, 2
/* 80C4B234  38 C0 00 80 */	li r6, 0x80
/* 80C4B238  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4B23C  4B 3F 10 B0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4B25C  4B 3C 5C 14 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C4B284  4B 61 C6 D0 */	b cM_rndF__Ff
...
/* 80C4B2B4  4B 61 C6 D8 */	b cM_rndFX__Ff
/* 80C4B2B8  FF E0 08 90 */	fmr f31, f1
/* 80C4B2BC  C0 3F 00 60 */	lfs f1, 0x60(r31)
/* 80C4B2C0  4B 61 C6 CC */	b cM_rndFX__Ff
...
/* 80C4B314  4B 61 C6 40 */	b cM_rndF__Ff
...
/* 80C4B35C  4B 61 C5 F8 */	b cM_rndF__Ff

...
/* 80C4C99C 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C4C9A0 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C4C9A4 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C4C9A8 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C4C9AC 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C4D574 */
/* 80C4C9B0 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4) /* 80C4D574 */
/* 80C4C9B4 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C4C9B8 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C4C9BC 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80C4C9D4 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C4D574 */
/* 80C4C9D8 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C4D574 */
/* 80C4C9DC 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C4C9E0 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C4C9E4 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C4C9E8 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
lbl_80C4CA04:
/* 80C4CA04 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C4D58C */
/* 80C4CA08 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C4D58C */
/* 80C4CA0C 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80C4CA10 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C4CA14 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C4CA28 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C4CA2C 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C4CA40 0000003C  3C 60 00 00 */	lis r3, l_kuw_itemno@ha /* 80C4D548 */
/* 80C4CA44 00000040  38 63 00 00 */	addi r3, r3, l_kuw_itemno@l /* 80C4D548 */
...
/* 80C4CA6C 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C4CA70 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C4CA74 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C4CA78 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C4CA7C 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C4D574 */
/* 80C4CA80 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C4D574 */
/* 80C4CA84 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C4CA88 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C4CA8C 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C4CA90 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80C4CAB0 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C4CAB4 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C4CAB8 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C4CABC 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C4CAC0 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C4D574 */
/* 80C4CAC4 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C4D574 */
/* 80C4CAC8 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C4CACC 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C4CAD0 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C4CAD4 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

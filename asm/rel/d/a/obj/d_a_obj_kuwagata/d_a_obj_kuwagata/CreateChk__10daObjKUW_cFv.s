...
/* 80C4C99C 00000014  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C4C9A0 00000018  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C4C9A4 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C4C9A8 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C4C9AC 00000024  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4C9B0 00000028  A0 04 00 00 */	lhz r0, 0x0000(r4)
/* 80C4C9B4 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C4C9B8 00000030  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4C9BC 00000034  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4C9C0 00000038  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4C9C4 0000003C  4B FF D7 95 */	bl _unresolved
...
/* 80C4C9D4 0000004C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4C9D8 00000050  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4C9DC 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C4C9E0 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C4C9E4 0000005C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4C9E8 00000060  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4C9EC 00000064  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4C9F0 00000068  4B FF D7 69 */	bl _unresolved
...
lbl_80C4CA04:
/* 80C4CA04 00000000  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C4CA08 00000004  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C4CA0C 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80C4CA10 0000000C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4CA14 00000010  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4CA18 00000014  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C4CA1C 00000018  4B FF D7 3D */	bl _unresolved
/* 80C4CA20 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80C4CA24 00000020  40 82 00 CC */	bne lbl_80C4CAF0
/* 80C4CA28 00000024  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C4CA2C 00000028  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
...
/* 80C4CA40 0000003C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C4CA44 00000040  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C4CA48 00000044  7C 63 00 AE */	lbzx r3, r3, r0
/* 80C4CA4C 00000048  4B FF D7 0D */	bl _unresolved
...
/* 80C4CA6C 0000000C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C4CA70 00000010  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C4CA74 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C4CA78 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C4CA7C 0000001C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4CA80 00000020  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4CA84 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C4CA88 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C4CA8C 0000002C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4CA90 00000030  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4CA94 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4CA98 00000038  4B FF D6 C1 */	bl _unresolved
...
/* 80C4CAB0 0000000C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C4CAB4 00000010  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C4CAB8 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C4CABC 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C4CAC0 0000001C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4CAC4 00000020  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4CAC8 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C4CACC 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C4CAD0 0000002C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C4CAD4 00000030  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C4CAD8 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C4CADC 00000038  4B FF D6 7D */	bl _unresolved

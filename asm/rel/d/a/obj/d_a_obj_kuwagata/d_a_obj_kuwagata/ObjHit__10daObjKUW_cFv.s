...
/* 80C4C3A4  3C 60 80 C5 */	lis r3, lit_3775@ha
/* 80C4C3A8  3B C3 D4 90 */	addi r30, r3, lit_3775@l
/* 80C4C3AC  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 80C4C3B0  4B 43 80 B0 */	b ChkTgHit__12dCcD_GObjInfFv
/* 80C4C3B4  28 03 00 00 */	cmplwi r3, 0
/* 80C4C3B8  41 82 01 44 */	beq lbl_80C4C4FC
/* 80C4C3BC  38 7F 05 CC */	addi r3, r31, 0x5cc
/* 80C4C3C0  4B 43 81 38 */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 80C4C3E8  4B 43 81 60 */	b GetTgHitGObj__12dCcD_GObjInfFv
/* 80C4C3EC  38 7F 07 04 */	addi r3, r31, 0x704
/* 80C4C3F0  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C4C3F4  4B 51 21 BC */	b initOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80C4C41C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4C420  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C4C424  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80C4C468  3C 60 80 C5 */	lis r3, stringBase0@ha
/* 80C4C46C  38 63 D5 8C */	addi r3, r3, stringBase0@l
/* 80C4C470  38 80 00 06 */	li r4, 6
/* 80C4C474  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C4C478  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C4C47C  3C A5 00 02 */	addis r5, r5, 2
/* 80C4C480  38 C0 00 80 */	li r6, 0x80
/* 80C4C484  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C4C488  4B 3E FE 64 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C4C4CC  4B 61 B4 88 */	b cM_rndF__Ff

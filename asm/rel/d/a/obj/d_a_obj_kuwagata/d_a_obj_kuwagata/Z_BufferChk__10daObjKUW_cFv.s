...
/* 80C4BD48  3C 60 80 C5 */	lis r3, lit_3775@ha
/* 80C4BD4C  3B E3 D4 90 */	addi r31, r3, lit_3775@l
...
/* 80C4BD68  C0 1F 00 48 */	lfs f0, 0x48(r31)	/* effective address: 80C4D4D8 */
...
/* 80C4BD7C  4B 3C 95 94 */	b mDoLib_project__FP3VecP3Vec
/* 80C4BD80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4BD84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C4BD88  80 63 5D 74 */	lwz r3, 0x5d74(r3)	/* effective address: 8040BF34 */
...
/* 80C4BDD8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4BDDC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C4BE04  4B 40 A2 14 */	b newData__13dDlst_peekZ_cFssPUl
lbl_80C4BE08:
/* 80C4BE08  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C4BE0C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C4BE10  80 63 61 B0 */	lwz r3, 0x61b0(r3)	/* effective address: 8040C370 */
/* 80C4BE14  C3 E3 00 C8 */	lfs f31, 0xc8(r3)	/* effective address: 80406288 */
/* 80C4BE18  C3 C3 00 CC */	lfs f30, 0xcc(r3)	/* effective address: 8040628C */
/* 80C4BE1C  38 61 00 08 */	addi r3, r1, 8
/* 80C4BE20  38 81 00 14 */	addi r4, r1, 0x14
/* 80C4BE24  4B 3C 96 C8 */	b mDoLib_pos2camera__FP3VecP3Vec

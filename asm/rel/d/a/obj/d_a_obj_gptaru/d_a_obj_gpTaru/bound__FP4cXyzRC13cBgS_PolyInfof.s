...
/* 8057D824 00000018  3C 60 80 58 */	lis r3, lit_3656@ha
/* 8057D828 0000001C  3B C3 F5 70 */	addi r30, r3, lit_3656@l
/* 8057D82C 00000020  3C 60 80 58 */	lis r3, __vt__8cM3dGPla@ha
/* 8057D830 00000024  38 03 F8 24 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057D834 00000028  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057D838 0000002C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8057D83C 00000030  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8057D840 00000034  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8057D844 00000038  38 A1 00 4C */	addi r5, r1, 0x4c
/* 8057D848 0000003C  4B AF 6E FC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 8057D860 00000054  C0 1E 00 54 */	lfs f0, 0x54(r30)	/* effective address: 8057F5C4 */
...
/* 8057D870 00000064  4B DC 98 C8 */	b PSVECSquareMag
/* 8057D874 00000068  C0 1E 00 54 */	lfs f0, 0x54(r30)	/* effective address: 8057F5C4 */
...
/* 8057D884 00000008  C8 9E 00 58 */	lfd f4, 0x58(r30)	/* effective address: 8057F5C8 */
/* 8057D888 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8057D88C 00000010  C8 7E 00 60 */	lfd f3, 0x60(r30)	/* effective address: 8057F5D0 */
...
lbl_8057D8D4:
/* 8057D8D4 00000000  C8 1E 00 68 */	lfd f0, 0x68(r30)	/* effective address: 8057F5D8 */
/* 8057D8D8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8057D8DC 00000000  40 80 00 10 */	bge lbl_8057D8EC
/* 8057D8E0 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057D8E4 00000008  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 8057D950 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057D954 0000000C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 8057D96C 0000000C  4B DC 99 5C */	b C_VECReflect
...
/* 8057D97C 0000001C  4B CE 92 08 */	b __ml__4cXyzCFf
...
/* 8057D98C 0000002C  4B CE 91 F8 */	b __ml__4cXyzCFf
...
/* 8057D9B4 00000054  C0 1E 00 54 */	lfs f0, 0x54(r30)	/* effective address: 8057F5C4 */
...
/* 8057D9C4 00000064  4B DC 97 74 */	b PSVECSquareMag
/* 8057D9C8 00000068  C0 1E 00 54 */	lfs f0, 0x54(r30)	/* effective address: 8057F5C4 */
...
/* 8057D9D8 00000008  C8 9E 00 58 */	lfd f4, 0x58(r30)	/* effective address: 8057F5C8 */
/* 8057D9DC 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8057D9E0 00000010  C8 7E 00 60 */	lfd f3, 0x60(r30)	/* effective address: 8057F5D0 */
...
lbl_8057DA28:
/* 8057DA28 00000000  C8 1E 00 68 */	lfd f0, 0x68(r30)	/* effective address: 8057F5D8 */
/* 8057DA2C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8057DA30 00000000  40 80 00 10 */	bge lbl_8057DA40
/* 8057DA34 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057DA38 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8057DAA4 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057DAA8 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8057DAAC:
/* 8057DAAC 00000000  3C 60 80 58 */	lis r3, __vt__8cM3dGPla@ha
/* 8057DAB0 00000004  38 03 F8 24 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057DAB4 00000008  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057DAB8 0000000C  48 00 00 14 */	b lbl_8057DACC
lbl_8057DABC:
/* 8057DABC 00000000  3C 60 80 58 */	lis r3, __vt__8cM3dGPla@ha
/* 8057DAC0 00000004  38 03 F8 24 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057DAC4 00000008  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057DAC8 0000000C  C0 3E 00 54 */	lfs f1, 0x54(r30)	/* effective address: 8057F5C4 */
lbl_8057DACC:

...
/* 8057D824  3C 60 80 58 */	lis r3, lit_3656@ha
/* 8057D828  3B C3 F5 70 */	addi r30, r3, lit_3656@l
/* 8057D82C  3C 60 80 58 */	lis r3, __vt__8cM3dGPla@ha
/* 8057D830  38 03 F8 24 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057D834  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057D838  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057D83C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057D840  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8057D844  38 A1 00 4C */	addi r5, r1, 0x4c
/* 8057D848  4B AF 6E FC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 8057D870  4B DC 98 C8 */	b PSVECSquareMag
...
/* 8057D8E0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057D8E4  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 8057D950  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057D954  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 8057D9C4  4B DC 97 74 */	b PSVECSquareMag
...
/* 8057DA34  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057DA38  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8057DAA4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8057DAA8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8057DAAC:
/* 8057DAAC  3C 60 80 58 */	lis r3, __vt__8cM3dGPla@ha
/* 8057DAB0  38 03 F8 24 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057DAB4  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057DAB8  48 00 00 14 */	b lbl_8057DACC
lbl_8057DABC:
/* 8057DABC  3C 60 80 58 */	lis r3, __vt__8cM3dGPla@ha
/* 8057DAC0  38 03 F8 24 */	addi r0, r3, __vt__8cM3dGPla@l

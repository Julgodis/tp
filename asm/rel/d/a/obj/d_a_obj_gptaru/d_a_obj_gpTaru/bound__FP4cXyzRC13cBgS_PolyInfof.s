...
/* 8057D824 00000018  3C 60 00 00 */	lis r3, lit_3656@ha
/* 8057D828 0000001C  3B C3 00 00 */	addi r30, r3, lit_3656@l
/* 8057D82C 00000020  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 8057D830 00000024  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057D834 00000028  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057D838 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8057D83C 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8057D8E0 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8057D8E4 00000008  C3 C3 00 00 */	lfs f30, __float_nan@l(r3)
...
/* 8057D950 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8057D954 0000000C  C3 C3 00 00 */	lfs f30, __float_nan@l(r3)
...
/* 8057DA34 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8057DA38 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8057DAA4 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8057DAA8 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8057DAAC:
/* 8057DAAC 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 8057DAB0 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8057DAB4 00000008  90 01 00 5C */	stw r0, 0x5c(r1)
/* 8057DAB8 0000000C  48 00 00 14 */	b lbl_8057DACC
lbl_8057DABC:
/* 8057DABC 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 8057DAC0 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l

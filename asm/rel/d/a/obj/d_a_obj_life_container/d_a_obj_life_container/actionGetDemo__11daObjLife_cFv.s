...
/* 804CDA18  4B E9 47 C4 */	b _savegpr_29
/* 804CDA1C  7C 7D 1B 78 */	mr r29, r3
/* 804CDA20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CDA24  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 804CDA28  38 7E 4F F8 */	addi r3, r30, 0x4ff8
/* 804CDA2C  3C 80 80 4D */	lis r4, stringBase0@ha
/* 804CDA30  38 84 E4 A4 */	addi r4, r4, stringBase0@l
/* 804CDA34  38 84 00 08 */	addi r4, r4, 8
/* 804CDA38  4B B7 A0 A4 */	b endCheckOld__16dEvent_manager_cFPCc
/* 804CDA3C  2C 03 00 00 */	cmpwi r3, 0
/* 804CDA40  41 82 01 6C */	beq lbl_804CDBAC
/* 804CDA44  38 7E 4E C8 */	addi r3, r30, 0x4ec8
/* 804CDA48  4B B7 4A 20 */	b reset__14dEvt_control_cFv
/* 804CDA4C  7F A3 EB 78 */	mr r3, r29
/* 804CDA50  4B B4 C2 2C */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 804CDA64  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CDA68  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804CDA6C  7F E4 FB 78 */	mr r4, r31
/* 804CDA70  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 804CDA74  7C 05 07 74 */	extsb r5, r0
/* 804CDA78  4B B6 7A 68 */	b onItem__10dSv_info_cFii
lbl_804CDA7C:
...
/* 804CDA90  3C 80 80 4D */	lis r4, stringBase0@ha
/* 804CDA94  38 84 E4 A4 */	addi r4, r4, stringBase0@l
/* 804CDA98  38 84 00 18 */	addi r4, r4, 0x18
/* 804CDA9C  4B E9 AE F8 */	b strcmp
...
/* 804CDABC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CDAC0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 804CDAD4  4B B6 6F 30 */	b getEventReg__11dSv_event_cCFUs
...
/* 804CDAF0  4B B6 6E F0 */	b setEventReg__11dSv_event_cFUsUc
...
/* 804CDB08  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CDB0C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 804CDB20  4B B6 6E E4 */	b getEventReg__11dSv_event_cCFUs
...
/* 804CDB3C  4B B6 6E A4 */	b setEventReg__11dSv_event_cFUsUc
/* 804CDB40  48 00 00 6C */	b lbl_804CDBAC
lbl_804CDB44:
/* 804CDB44  7F C3 F3 78 */	mr r3, r30
/* 804CDB48  3C 80 80 4D */	lis r4, stringBase0@ha
/* 804CDB4C  38 84 E4 A4 */	addi r4, r4, stringBase0@l
/* 804CDB50  38 84 00 20 */	addi r4, r4, 0x20
/* 804CDB54  4B E9 AE 40 */	b strcmp
...
/* 804CDB74  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CDB78  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 804CDB8C  4B B6 6E 78 */	b getEventReg__11dSv_event_cCFUs
...
/* 804CDBA8  4B B6 6E 38 */	b setEventReg__11dSv_event_cFUsUc
lbl_804CDBAC:
/* 804CDBAC  38 60 00 01 */	li r3, 1
/* 804CDBB0  39 61 00 20 */	addi r11, r1, 0x20
/* 804CDBB4  4B E9 46 74 */	b _restgpr_29

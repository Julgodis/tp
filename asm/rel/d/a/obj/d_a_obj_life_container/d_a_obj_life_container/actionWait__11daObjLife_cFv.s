...
/* 804CD670  4B E9 4B 6C */	b _savegpr_29
/* 804CD674  7C 7F 1B 78 */	mr r31, r3
/* 804CD678  3C 60 80 4D */	lis r3, l_cyl_src@ha
/* 804CD67C  3B C3 E3 F4 */	addi r30, r3, l_cyl_src@l
/* 804CD680  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CD684  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 804CD688  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 804CD68C  38 7D 3E C8 */	addi r3, r29, 0x3ec8
/* 804CD690  3C 80 80 4D */	lis r4, stringBase0@ha
/* 804CD694  38 84 E4 A4 */	addi r4, r4, stringBase0@l
/* 804CD698  4B E9 B2 FC */	b strcmp
...
/* 804CD6FC  4B DA 22 80 */	b cLib_addCalc__FPfffff
lbl_804CD700:
/* 804CD700  7F E3 FB 78 */	mr r3, r31
/* 804CD704  38 9F 07 A4 */	addi r4, r31, 0x7a4
/* 804CD708  4B B4 CF C4 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 804CD70C  38 7F 05 8C */	addi r3, r31, 0x58c
/* 804CD710  7F A4 EB 78 */	mr r4, r29
/* 804CD714  4B BA 93 98 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 804CD768  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804CD76C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804CD7A8  4B B4 CF 24 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
lbl_804CD7AC:
/* 804CD7AC  38 7F 05 8C */	addi r3, r31, 0x58c
/* 804CD7B0  7F A4 EB 78 */	mr r4, r29
/* 804CD7B4  4B BA 92 F8 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 804CD804  4B C8 D8 B4 */	b getData__12daItemBase_cFv
...
/* 804CD828  4B DA 2D E0 */	b cLib_addCalcAngleS2__FPssss
lbl_804CD82C:
...
lbl_804CD83C:
/* 804CD83C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804CD840  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 804CD844  80 7E 5D AC */	lwz r3, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 804CD848  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 80400628 */
...
/* 804CD864  4B BB 6D F4 */	b ChkCoHit__12dCcD_GObjInfFv
...
/* 804CD878  4B BB 5E 10 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 804CD8AC  4B E9 49 7C */	b _restgpr_29

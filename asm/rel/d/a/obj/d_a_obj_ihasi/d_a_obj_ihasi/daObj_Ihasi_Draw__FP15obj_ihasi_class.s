...
/* 80C2603C 00000024  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C26040 00000028  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C26054 0000003C  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C26058 00000040  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C2606C 00000054  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C26070 00000058  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 80C26074 0000005C  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C26078 00000060  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80C2607C 00000064  3B C3 00 00 */	addi r30, r3, j3dSys@l
...
/* 80C26094 0000007C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C26098 00000080  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_80C260B0:
/* 80C260B0 00000000  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C260B4 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C260C8 00000018  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C260CC 0000001C  38 63 00 00 */	addi r3, r3, g_env_light@l

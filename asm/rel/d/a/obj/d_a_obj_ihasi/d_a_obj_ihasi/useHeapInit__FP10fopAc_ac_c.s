...
/* 80C26334  4B 73 BE A8 */	b _savegpr_29
/* 80C26338  7C 7E 1B 78 */	mr r30, r3
/* 80C2633C  3C 60 80 C2 */	lis r3, stringBase0@ha
/* 80C26340  38 63 68 C4 */	addi r3, r3, stringBase0@l
/* 80C26344  38 80 00 05 */	li r4, 5
/* 80C26348  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C2634C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C26360  4B 41 5F 8C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C26370  4B 3E E8 E4 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C263BC:
/* 80C263BC  3C 60 80 C2 */	lis r3, stringBase0@ha
/* 80C263C0  38 63 68 C4 */	addi r3, r3, stringBase0@l
/* 80C263C4  38 80 00 0C */	li r4, 0xc
/* 80C263C8  7F E5 FB 78 */	mr r5, r31
/* 80C263CC  38 C0 00 80 */	li r6, 0x80
/* 80C263D0  4B 41 5F 1C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C263E4  4B 45 3B 54 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C263FC:
/* 80C263FC  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C26400  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C26404  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 80C26408  90 03 00 B0 */	stw r0, 0xb0(r3)
/* 80C2640C  3C 60 80 C2 */	lis r3, stringBase0@ha
/* 80C26410  38 63 68 C4 */	addi r3, r3, stringBase0@l
/* 80C26414  38 80 00 06 */	li r4, 6
/* 80C26418  7F E5 FB 78 */	mr r5, r31
/* 80C2641C  38 C0 00 80 */	li r6, 0x80
/* 80C26420  4B 41 5E CC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C26430  4B 3E E8 24 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C26450  4B 6A 87 FC */	b __nw__FUl
/* 80C26454  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C26458  41 82 00 20 */	beq lbl_80C26478
/* 80C2645C  3C 80 80 C2 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C26460  38 04 69 28 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C26464  90 1D 00 00 */	stw r0, 0(r29)
/* 80C26468  38 80 00 00 */	li r4, 0
/* 80C2646C  4B 70 1F 90 */	b init__12J3DFrameCtrlFs
...
lbl_80C26490:
/* 80C26490  3C 60 80 C2 */	lis r3, stringBase0@ha
/* 80C26494  38 63 68 C4 */	addi r3, r3, stringBase0@l
/* 80C26498  38 80 00 09 */	li r4, 9
/* 80C2649C  7F E5 FB 78 */	mr r5, r31
/* 80C264A0  38 C0 00 80 */	li r6, 0x80
/* 80C264A4  4B 41 5E 48 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C264C4  3D 00 80 C2 */	lis r8, lit_3922@ha
/* 80C264C8  C0 28 68 94 */	lfs f1, lit_3922@l(r8)
/* 80C264CC  39 00 00 00 */	li r8, 0
/* 80C264D0  39 20 FF FF */	li r9, -1
/* 80C264D4  4B 3E 71 68 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C264D8  30 03 FF FF */	addic r0, r3, -1
/* 80C264DC  7C 60 19 10 */	subfe r3, r0, r3
lbl_80C264E0:
/* 80C264E0  39 61 00 20 */	addi r11, r1, 0x20
/* 80C264E4  4B 73 BD 44 */	b _restgpr_29

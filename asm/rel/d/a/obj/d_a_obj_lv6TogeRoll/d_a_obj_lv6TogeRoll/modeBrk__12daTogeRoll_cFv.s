...
/* 80C790F0 00000004  4B FF EA A9 */	bl _savegpr_29
/* 80C790F4 00000008  7C 7E 1B 78 */	mr r30, r3
/* 80C790F8 0000000C  3C 60 00 00 */	lis r3, lit_3651@ha /* 80C799E4 */
/* 80C790FC 00000010  3B E3 00 00 */	addi r31, r3, lit_3651@l /* 80C799E4 */
...
/* 80C79120 00000034  C0 3F 00 F0 */	lfs f1, 0xf0(r31)
/* 80C79124 00000038  C0 5E 05 2C */	lfs f2, 0x52c(r30)
/* 80C79128 0000003C  C0 7F 00 FC */	lfs f3, 0xfc(r31)
/* 80C7912C 00000040  4B FF EA 6D */	bl cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 80C79140 00000054  4B FF EA 59 */	bl __mi__4cXyzCFRC3Vec
/* 80C79144 00000058  38 61 00 10 */	addi r3, r1, 0x10
/* 80C79148 0000005C  4B FF EA 51 */	bl PSVECSquareMag
/* 80C7914C 00000060  C0 1F 00 AC */	lfs f0, 0xac(r31)
...
/* 80C7915C 00000008  C8 9F 00 C8 */	lfd f4, 0xc8(r31)
/* 80C79160 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C79164 00000010  C8 7F 00 D0 */	lfd f3, 0xd0(r31)
...
lbl_80C791AC:
/* 80C791AC 00000000  C8 1F 00 D8 */	lfd f0, 0xd8(r31)
/* 80C791B0 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C791B4 00000000  40 80 00 10 */	bge lbl_80C791C4
/* 80C791B8 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C791BC 00000008  C3 C3 00 00 */	lfs f30, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C79228 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C7922C 0000000C  C3 C3 00 00 */	lfs f30, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C79240 00000008  4B FF E9 59 */	bl dComIfGp_getReverb__Fi
...
/* 80C79258 00000020  4B FF E9 41 */	bl __cvt_fp2unsigned
/* 80C7925C 00000024  7C 66 1B 78 */	mr r6, r3
/* 80C79260 00000028  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 80C79264 0000002C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 80C79268 00000030  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C79278 00000040  C0 3F 00 EC */	lfs f1, 0xec(r31)
/* 80C7927C 00000044  FC 40 08 90 */	fmr f2, f1
/* 80C79280 00000048  C0 7F 00 F4 */	lfs f3, 0xf4(r31)
/* 80C79284 0000004C  FC 80 18 90 */	fmr f4, f3
/* 80C79288 00000050  39 00 00 00 */	li r8, 0
/* 80C7928C 00000054  4B FF E9 0D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C79290 00000058  C0 1F 00 AC */	lfs f0, 0xac(r31)
...
/* 80C792B8 00000008  4B FF E8 E1 */	bl _restgpr_29

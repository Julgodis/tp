...
/* 80BBCD80  4B 7A 54 2C */	b _savegpr_17
/* 80BBCD84  7C 7F 1B 78 */	mr r31, r3
/* 80BBCD88  3C 60 80 BC */	lis r3, lit_3896@ha
/* 80BBCD8C  3B 43 21 48 */	addi r26, r3, lit_3896@l
/* 80BBCD90  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80BBCD94  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80BBCD98  38 80 00 10 */	li r4, 0x10
/* 80BBCD9C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80BBCDA0  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80BBCDA4  4B 5E 6A 20 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80BBCDC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BBCDCC  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 80BBCDD0  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80BBCDD4  3B A3 4A C8 */	addi r29, r3, j3dSys@l
/* 80BBCDD8  3B 3C 5F 64 */	addi r25, r28, 0x5f64
/* 80BBCDDC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80BBCDE0  3B C3 CA 54 */	addi r30, r3, g_env_light@l
...
/* 80BBCDF8  4B 5E 7F A8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80BBCE10  4B 45 0E B4 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BBCE38  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80BBCE3C  3A 23 CA 54 */	addi r17, r3, g_env_light@l
lbl_80BBCE40:
...
/* 80BBCE54  4B 5E 7F 4C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80BBCE58  7C 74 A8 2E */	lwzx r3, r20, r21
/* 80BBCE5C  4B 45 0E 68 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80BBCE88  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80BBCE8C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80BBCE90  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80BBCE94  A8 9B AF 1E */	lha r4, -0x50e2(r27)
/* 80BBCE98  4B 44 F5 44 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80BBCEF0  4B 6A 9C 44 */	b __mi__4cXyzCFRC3Vec
...
/* 80BBCFA8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80BBCFAC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80BBD0D4  4B 6A 9A 10 */	b __pl__4cXyzCFRC3Vec
...
/* 80BBD1A0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80BBD1A4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80BBD2CC  4B 6A 98 18 */	b __pl__4cXyzCFRC3Vec
...
/* 80BBD328  3C A0 80 BC */	lis r5, data_80BC23A4@ha
/* 80BBD32C  38 A5 23 A4 */	addi r5, r5, data_80BC23A4@l
/* 80BBD330  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80BBD334  4B 45 6C 7C */	b update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 80BBD360  4B 45 73 D8 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_80BBD364:
...
lbl_80BBD3F8:
/* 80BBD3F8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80BBD3FC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80BBD400  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80BBD404  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 80BBD408  4B 44 EF D4 */	b mDoMtx_YrotS__FPA4_fs
/* 80BBD40C  38 61 00 44 */	addi r3, r1, 0x44
/* 80BBD410  38 81 00 38 */	addi r4, r1, 0x38
/* 80BBD414  4B 6B 3A D8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80BBD4C8  4B 6B 3A 24 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80BBD568  4B 6B 39 84 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80BBD61C  4B 6B 38 D0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80BBD6A4  3C A0 80 BC */	lis r5, data_80BC23A8@ha
/* 80BBD6A8  38 A5 23 A8 */	addi r5, r5, data_80BC23A8@l
/* 80BBD6AC  38 C0 00 00 */	li r6, 0
/* 80BBD6B0  38 FF 01 0C */	addi r7, r31, 0x10c
/* 80BBD6B4  38 63 AE 90 */	addi r3, r3, -20848
/* 80BBD6B8  4B 45 60 84 */	b update__19mDoExt_3DlineMat1_cFifR8_GXColorUsP12dKy_tevstr_c
...
/* 80BBD6E8  4B 45 70 50 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_80BBD6EC:
...
/* 80BBD72C  4B 7A 4A CC */	b _restgpr_17

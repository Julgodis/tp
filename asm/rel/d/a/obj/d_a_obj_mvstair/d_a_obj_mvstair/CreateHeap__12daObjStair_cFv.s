...
/* 80C9D2D4  3C 60 80 CA */	lis r3, l_arcName@ha
/* 80C9D2D8  38 63 E9 40 */	addi r3, r3, l_arcName@l
/* 80C9D2DC  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C9D2E0  3C 80 80 CA */	lis r4, l_bmdName@ha
/* 80C9D2E4  38 84 E8 AC */	addi r4, r4, l_bmdName@l
/* 80C9D2E8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C9D2EC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C9D2F0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C9D2F4  3C A5 00 02 */	addis r5, r5, 2
/* 80C9D2F8  38 C0 00 80 */	li r6, 0x80
/* 80C9D2FC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C9D300  4B 39 EF EC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9D310  4B 37 79 44 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

...
/* 80C9172C 00000018  3C 60 00 00 */	lis r3, mAttr__18daObjMasterSword_c@ha
/* 80C91730 0000001C  3B E3 00 00 */	addi r31, r3, mAttr__18daObjMasterSword_c@l
/* 80C91734 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C91738 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C9173C 00000028  38 63 0D D8 */	addi r3, r3, 0xdd8
/* 80C91740 0000002C  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha
/* 80C91744 00000030  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l
...
/* 80C91768 00000008  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C9176C 0000000C  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C91780 00000020  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C91784 00000024  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C91798 00000038  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C9179C 0000003C  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 80C917A0 00000040  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C917A4 00000044  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80C917A8 00000048  3B A3 00 00 */	addi r29, r3, j3dSys@l
...
/* 80C917F8 00000098  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C917FC 0000009C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C91868 00000108  3D 40 00 00 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80C9186C 0000010C  39 4A 00 00 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l

...
/* 80C90F7C  4B 6D 12 58 */	b _savegpr_27
/* 80C90F80  7C 7C 1B 78 */	mr r28, r3
/* 80C90F84  3C 80 80 C9 */	lis r4, mAttr__18daObjMasterSword_c@ha
/* 80C90F88  3B E4 19 40 */	addi r31, r4, mAttr__18daObjMasterSword_c@l
...
/* 80C90FE4  4B 3F 28 7C */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C90FE8  38 7C 05 E0 */	addi r3, r28, 0x5e0
/* 80C90FEC  3C 80 80 C9 */	lis r4, data_80C919D0@ha
/* 80C90FF0  38 84 19 D0 */	addi r4, r4, data_80C919D0@l
/* 80C90FF4  4B 3F 38 C0 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80C91048  4B 37 BD 1C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9104C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C91050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C91054  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80C91058  4B 37 B3 DC */	b mDoMtx_YrotM__FPA4_fs
/* 80C9105C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C91060  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C91064  80 9C 05 68 */	lwz r4, 0x568(r28)
/* 80C91068  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9106C  4B 6B 54 44 */	b PSMTXCopy
...
/* 80C910D4  4B 3E 4D D8 */	b __ct__12dBgS_AcchCirFv
/* 80C910D8  3B 61 00 5C */	addi r27, r1, 0x5c
/* 80C910DC  7F 63 DB 78 */	mr r3, r27
/* 80C910E0  4B 3E 4F C0 */	b __ct__9dBgS_AcchFv
/* 80C910E4  3C 60 80 C9 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C910E8  38 63 1A 88 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80C91190  3C 60 80 C9 */	lis r3, ActionTable__18daObjMasterSword_c@ha
/* 80C91194  38 03 19 B8 */	addi r0, r3, ActionTable__18daObjMasterSword_c@l
...
/* 80C911A8  4B 6D 0E DC */	b __ptmf_scall
/* 80C911AC  60 00 00 00 */	nop 
/* 80C911B0  3C 60 80 C9 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C911B4  38 03 1A 88 */	addi r0, r3, __vt__12dBgS_ObjAcch@l
...
/* 80C911CC  4B 3E 4D C8 */	b __dt__9dBgS_AcchFv
/* 80C911D0  3C 60 80 C9 */	lis r3, __vt__12dBgS_AcchCir@ha
/* 80C911D4  38 03 1A 7C */	addi r0, r3, __vt__12dBgS_AcchCir@l
/* 80C911D8  90 01 00 28 */	stw r0, 0x28(r1)
/* 80C911DC  38 61 00 30 */	addi r3, r1, 0x30
/* 80C911E0  38 80 FF FF */	li r4, -1
/* 80C911E4  4B 5D DD 34 */	b __dt__8cM3dGCirFv
/* 80C911E8  38 61 00 1C */	addi r3, r1, 0x1c
/* 80C911EC  38 80 00 00 */	li r4, 0
/* 80C911F0  4B 5D 6E C0 */	b __dt__13cBgS_PolyInfoFv
/* 80C911F4  39 61 02 50 */	addi r11, r1, 0x250
/* 80C911F8  4B 6D 10 28 */	b _restgpr_27

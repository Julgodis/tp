...
/* 80C1FA80  4B 74 27 50 */	b _savegpr_26
...
/* 80C1FB30  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C1FB34  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C1FBA0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C1FBA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C1FBA8:
/* 80C1FBA8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C1FBAC  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80C1FC9C  4B 64 FC E0 */	b cLib_addCalc__FPfffff
...
/* 80C1FCB8  4B 74 25 64 */	b _restgpr_26

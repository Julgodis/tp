...
/* 80C1FA80 00000004  4B 74 27 50 */	b _savegpr_26
/* 80C1FA84 00000008  7C 7C 1B 78 */	mr r28, r3
/* 80C1FA88 0000000C  7C 9A 23 78 */	mr r26, r4
/* 80C1FA8C 00000010  3C 60 80 C2 */	lis r3, lit_3675@ha
/* 80C1FA90 00000014  3B E3 07 8C */	addi r31, r3, lit_3675@l
/* 80C1FA94 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C1FA98 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C1FA9C 00000020  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80C1FAB0 00000034  4B 65 11 54 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C1FAC0 00000044  4B 72 78 DC */	b PSVECSquareDistance
/* 80C1FAC4 00000048  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80C2078C */
...
/* 80C1FAD4 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 80C2079C */
/* 80C1FAD8 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C1FADC 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 80C207A4 */
...
lbl_80C1FB24:
/* 80C1FB24 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 80C207AC */
/* 80C1FB28 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C1FB2C 00000000  40 80 00 10 */	bge lbl_80C1FB3C
/* 80C1FB30 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C1FB34 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C1FBA0 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C1FBA4 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C1FBA8:
/* 80C1FBA8 00000000  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C1FBAC 00000004  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80C1FBE4 0000003C  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 80C207B4 */
...
/* 80C1FBF8 00000050  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 80C207B8 */
...
/* 80C1FC14 0000006C  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 80C207B4 */
...
/* 80C1FC28 00000080  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 80C207BC */
...
/* 80C1FC40 00000098  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80C2078C */
/* 80C1FC44 0000009C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C1FC48 00000000  40 81 00 20 */	ble lbl_80C1FC68
/* 80C1FC4C 00000004  C0 1F 00 34 */	lfs f0, 0x34(r31)	/* effective address: 80C207C0 */
...
lbl_80C1FC68:
/* 80C1FC68 00000000  C0 9F 00 00 */	lfs f4, 0(r31)	/* effective address: 80C2078C */
...
/* 80C1FC78 00000010  C8 3F 00 08 */	lfd f1, 8(r31)	/* effective address: 80C20794 */
...
/* 80C1FC94 0000002C  C0 5F 00 38 */	lfs f2, 0x38(r31)	/* effective address: 80C207C4 */
/* 80C1FC98 00000030  C0 7F 00 3C */	lfs f3, 0x3c(r31)	/* effective address: 80C207C8 */
/* 80C1FC9C 00000034  4B 64 FC E0 */	b cLib_addCalc__FPfffff
...
/* 80C1FCB8 00000008  4B 74 25 64 */	b _restgpr_26

...
/* 80C83E68 00000010  4B 6D E3 6C */	b _savegpr_27
/* 80C83E6C 00000014  7C 7B 1B 78 */	mr r27, r3
/* 80C83E70 00000018  3C 60 80 C8 */	lis r3, lit_3695@ha
/* 80C83E74 0000001C  3B C3 46 A4 */	addi r30, r3, lit_3695@l
/* 80C83E78 00000020  3B 80 00 01 */	li r28, 1
/* 80C83E7C 00000024  38 A0 FF FF */	li r5, -1
/* 80C83E80 00000028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C83E84 0000002C  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80C83E88 00000030  83 BF 5D AC */	lwz r29, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 80C83F8C 00000020  4B 5E C6 7C */	b cLib_addCalcAngleS2__FPssss
...
/* 80C83FA4 00000010  4B 5E C6 64 */	b cLib_addCalcAngleS2__FPssss
lbl_80C83FA8:
...
/* 80C83FBC 00000014  4B 3A 90 B0 */	b dComIfGp_getReverb__Fi
...
/* 80C83FD0 00000028  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C83FD4 0000002C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C83FD8 00000030  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C83FE8 00000040  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 80C846A8 */
/* 80C83FEC 00000044  FC 40 08 90 */	fmr f2, f1
/* 80C83FF0 00000048  C0 7E 00 08 */	lfs f3, 8(r30)	/* effective address: 80C846AC */
/* 80C83FF4 0000004C  FC 80 18 90 */	fmr f4, f3
/* 80C83FF8 00000050  39 00 00 00 */	li r8, 0
/* 80C83FFC 00000054  4B 62 79 88 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C84000:
...
/* 80C84018 00000018  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C8401C 0000001C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C8402C 0000002C  C0 5E 00 0C */	lfs f2, 0xc(r30)	/* effective address: 80C846B0 */
/* 80C84030 00000030  A8 1B 05 B4 */	lha r0, 0x5b4(r27)
/* 80C84034 00000034  C8 3E 00 10 */	lfd f1, 0x10(r30)	/* effective address: 80C846B4 */
...
/* 80C8409C 0000001C  80 7F 5D AC */	lwz r3, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 80C840D8 00000020  4B 5E C4 68 */	b cLib_addCalcAngleS__FPsssss
lbl_80C840DC:
...
lbl_80C8412C:
/* 80C8412C 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C84130 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C84134 00000008  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 80C84138 0000000C  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 80C84150 00000024  4B 5E 29 E4 */	b __mi__4cXyzCFRC3Vec
...
/* 80C8416C 00000040  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C84170 00000044  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C84180 00000054  4B 38 82 5C */	b mDoMtx_YrotS__FPA4_fs
/* 80C84184 00000058  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C84188 0000005C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C8418C 00000060  38 81 00 18 */	addi r4, r1, 0x18
/* 80C84190 00000064  7C 85 23 78 */	mr r5, r4
/* 80C84194 00000068  4B 6C 2B D8 */	b PSMTXMultVec
/* 80C84198 0000006C  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 80C8419C 00000070  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80C846A4 */
...
/* 80C84224 00000014  4B 6D DF FC */	b _restgpr_27

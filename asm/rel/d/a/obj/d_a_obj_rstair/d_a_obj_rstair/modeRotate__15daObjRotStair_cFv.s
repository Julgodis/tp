...
/* 80CC1EE0  3C 60 80 CC */	lis r3, l_wtr_bmd@ha
/* 80CC1EE4  3B E3 27 00 */	addi r31, r3, l_wtr_bmd@l
/* 80CC1EE8  A8 7E 04 E6 */	lha r3, 0x4e6(r30)
/* 80CC1EEC  A8 1E 05 D4 */	lha r0, 0x5d4(r30)
/* 80CC1EF0  7C 63 00 50 */	subf r3, r3, r0
/* 80CC1EF4  4B 6A 31 DC */	b abs
...
/* 80CC1F18  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CC1F1C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80CC1F30  4B 3A DA F4 */	b StartShock__12dVibration_cFii4cXyz
/* 80CC1F34  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80CC1F38  7C 03 07 74 */	extsb r3, r0
/* 80CC1F3C  4B 36 B1 30 */	b dComIfGp_getReverb__Fi
...
/* 80CC1F50  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CC1F54  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CC1F58  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CC1F7C  4B 5E 9A 08 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CC1FBC  4B 5A E5 84 */	b cLib_addCalcAngleS__FPsssss
/* 80CC1FC0  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80CC1FC4  7C 03 07 74 */	extsb r3, r0
/* 80CC1FC8  4B 36 B0 A4 */	b dComIfGp_getReverb__Fi
...
/* 80CC1FDC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CC1FE0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CC1FE4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CC2008  4B 5E A5 04 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

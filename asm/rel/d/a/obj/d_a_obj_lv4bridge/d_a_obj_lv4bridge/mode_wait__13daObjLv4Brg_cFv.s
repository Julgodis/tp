...
/* 80C62C48  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C62C4C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C62C60  4B 3D 27 00 */	b isSwitch__10dSv_info_cCFii
...
/* 80C62C88  4B 3E 5C B8 */	b orderEvent__17dEvLib_callback_cFiii
/* 80C62C8C  48 00 00 44 */	b lbl_80C62CD0
lbl_80C62C90:
/* 80C62C90  3C 60 80 C6 */	lis r3, lit_3653@ha
/* 80C62C94  C0 23 31 70 */	lfs f1, lit_3653@l(r3)
/* 80C62C98  D0 21 00 08 */	stfs f1, 8(r1)
/* 80C62C9C  3C 60 80 C6 */	lis r3, lit_3740@ha
/* 80C62CA0  C0 03 31 80 */	lfs f0, lit_3740@l(r3)
/* 80C62CA4  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80C62CA8  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C62CAC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C62CB0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C62CC4  4B 40 CE 4C */	b StartQuake__12dVibration_cFii4cXyz

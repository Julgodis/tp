...
/* 80C62E48  3C 60 80 C6 */	lis r3, lit_3653@ha
/* 80C62E4C  C0 23 31 70 */	lfs f1, lit_3653@l(r3)
/* 80C62E50  D0 21 00 08 */	stfs f1, 8(r1)
/* 80C62E54  3C 60 80 C6 */	lis r3, lit_3740@ha
/* 80C62E58  C0 03 31 80 */	lfs f0, lit_3740@l(r3)
/* 80C62E5C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80C62E60  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C62E64  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C62E68  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C62E7C  4B 40 CC 94 */	b StartQuake__12dVibration_cFii4cXyz

...
/* 80D1D588  4B 64 4C 38 */	b _savegpr_22
/* 80D1D58C  7C 7A 1B 78 */	mr r26, r3
/* 80D1D590  3C 60 80 D2 */	lis r3, lit_3879@ha
/* 80D1D594  3B A3 EE 2C */	addi r29, r3, lit_3879@l
/* 80D1D598  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D1D59C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D1D5A0  38 80 00 10 */	li r4, 0x10
/* 80D1D5A4  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 80D1D5A8  38 DA 01 0C */	addi r6, r26, 0x10c
/* 80D1D5AC  4B 48 62 18 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80D1D5B0  80 7A 05 70 */	lwz r3, 0x570(r26)
/* 80D1D5B4  80 83 00 04 */	lwz r4, 4(r3)
/* 80D1D5B8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D1D5BC  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80D1D648  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D1D64C  3B 03 CA 54 */	addi r24, r3, g_env_light@l
lbl_80D1D650:
...
/* 80D1D6CC  4B 62 95 4C */	b C_MTXLightPerspective
/* 80D1D6D0  7E E3 BB 78 */	mr r3, r23
/* 80D1D6D4  38 81 00 08 */	addi r4, r1, 8
/* 80D1D6D8  4B 60 80 BC */	b setEffectMtx__13J3DTexMtxInfoFPA4_f
/* 80D1D6DC  7E C3 B3 78 */	mr r3, r22
/* 80D1D6E0  38 80 00 00 */	li r4, 0
/* 80D1D6E4  3C A0 80 3A */	lis r5, j3dDefaultMtx@ha
/* 80D1D6E8  38 A5 1E 5C */	addi r5, r5, j3dDefaultMtx@l
/* 80D1D6EC  4B 60 89 20 */	b simpleCalcMaterial__12J3DModelDataFUsPA4_f
lbl_80D1D6F0:
...
/* 80D1D700  4B 48 76 A0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80D1D704  80 7C 05 84 */	lwz r3, 0x584(r28)
/* 80D1D708  C0 23 00 10 */	lfs f1, 0x10(r3)
/* 80D1D70C  38 96 00 58 */	addi r4, r22, 0x58
/* 80D1D710  4B 2E FF C8 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80D1D714  80 7C 05 8C */	lwz r3, 0x58c(r28)
/* 80D1D718  C0 23 00 10 */	lfs f1, 0x10(r3)
/* 80D1D71C  38 96 00 58 */	addi r4, r22, 0x58
/* 80D1D720  4B 2F 00 88 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80D1D724  80 7C 05 7C */	lwz r3, 0x57c(r28)
/* 80D1D728  4B 2F 05 9C */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D1D750  4B 64 4A BC */	b _restgpr_22

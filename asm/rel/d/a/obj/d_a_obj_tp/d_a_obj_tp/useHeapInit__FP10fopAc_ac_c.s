...
/* 80D1E4D0  4B 64 3C E4 */	b _savegpr_19
/* 80D1E4D4  7C 7F 1B 78 */	mr r31, r3
/* 80D1E4D8  3C 60 80 D2 */	lis r3, cNullVec__6Z2Calc@ha
/* 80D1E4DC  3B C3 EE A0 */	addi r30, r3, cNullVec__6Z2Calc@l
/* 80D1E4E0  38 60 00 54 */	li r3, 0x54
/* 80D1E4E4  4B 5B 07 68 */	b __nw__FUl
/* 80D1E4E8  7C 74 1B 79 */	or. r20, r3, r3
/* 80D1E4EC  41 82 00 A8 */	beq lbl_80D1E594
/* 80D1E4F0  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1E4F4  38 63 EE 98 */	addi r3, r3, stringBase0@l
/* 80D1E4F8  38 80 00 07 */	li r4, 7
/* 80D1E4FC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D1E500  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D1E514  4B 31 DD D8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D1E518  7C 73 1B 78 */	mr r19, r3
/* 80D1E51C  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1E520  38 63 EE 98 */	addi r3, r3, stringBase0@l
...
/* 80D1E53C  4B 31 DD B0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1E57C  3D 20 80 D2 */	lis r9, lit_3879@ha
/* 80D1E580  C0 29 EE 2C */	lfs f1, lit_3879@l(r9)
/* 80D1E584  39 20 00 00 */	li r9, 0
/* 80D1E588  39 40 FF FF */	li r10, -1
/* 80D1E58C  4B 2F 16 C0 */	b __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 80D1E5BC  4B 5B 06 90 */	b __nw__FUl
/* 80D1E5C0  7C 73 1B 79 */	or. r19, r3, r3
/* 80D1E5C4  41 82 00 20 */	beq lbl_80D1E5E4
/* 80D1E5C8  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D1E5CC  38 04 EF CC */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D1E5D0  90 13 00 00 */	stw r0, 0(r19)
/* 80D1E5D4  38 80 00 00 */	li r4, 0
/* 80D1E5D8  4B 60 9E 24 */	b init__12J3DFrameCtrlFs
...
lbl_80D1E5FC:
/* 80D1E5FC  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1E600  38 63 EE 98 */	addi r3, r3, stringBase0@l
...
/* 80D1E614  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D1E618  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D1E62C  4B 31 DC C0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1E650  3D 00 80 D2 */	lis r8, lit_3879@ha
/* 80D1E654  C0 28 EE 2C */	lfs f1, lit_3879@l(r8)
/* 80D1E658  39 00 00 00 */	li r8, 0
/* 80D1E65C  39 20 FF FF */	li r9, -1
/* 80D1E660  4B 2E F0 AC */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80D1E688  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1E68C  3A C3 EE 98 */	addi r22, r3, stringBase0@l
/* 80D1E690  3A FE 00 50 */	addi r23, r30, 0x50
/* 80D1E694  3E 80 11 00 */	lis r20, 0x1100
/* 80D1E698  3B 1E 00 58 */	addi r24, r30, 0x58
/* 80D1E69C  3C 60 80 D2 */	lis r3, lit_3879@ha
/* 80D1E6A0  3B 23 EE 2C */	addi r25, r3, lit_3879@l
...
/* 80D1E6BC  4B 31 DC 30 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D1E6C0  3C 80 00 08 */	lis r4, 8
/* 80D1E6C4  38 B4 02 84 */	addi r5, r20, 0x284
/* 80D1E6C8  4B 2F 65 8C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80D1E6EC  4B 5B 05 60 */	b __nw__FUl
/* 80D1E6F0  7C 73 1B 79 */	or. r19, r3, r3
/* 80D1E6F4  41 82 00 20 */	beq lbl_80D1E714
/* 80D1E6F8  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D1E6FC  38 04 EF CC */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D1E700  90 13 00 00 */	stw r0, 0(r19)
/* 80D1E704  38 80 00 00 */	li r4, 0
/* 80D1E708  4B 60 9C F4 */	b init__12J3DFrameCtrlFs
...
/* 80D1E73C  4B 31 DB B0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1E768  4B 2E EE D4 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80D1E780  4B 5B 04 CC */	b __nw__FUl
/* 80D1E784  7C 73 1B 79 */	or. r19, r3, r3
/* 80D1E788  41 82 00 20 */	beq lbl_80D1E7A8
/* 80D1E78C  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D1E790  38 04 EF CC */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D1E794  90 13 00 00 */	stw r0, 0(r19)
/* 80D1E798  38 80 00 00 */	li r4, 0
/* 80D1E79C  4B 60 9C 60 */	b init__12J3DFrameCtrlFs
...
/* 80D1E7D0  4B 31 DB 1C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1E7FC  4B 2E EF 10 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80D1E85C  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1E860  38 63 EE 98 */	addi r3, r3, stringBase0@l
/* 80D1E864  38 80 00 1F */	li r4, 0x1f
/* 80D1E868  7F A5 EB 78 */	mr r5, r29
/* 80D1E86C  38 C0 00 80 */	li r6, 0x80
/* 80D1E870  4B 31 DA 7C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1E884  4B 35 B6 B4 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80D1E89C:
/* 80D1E89C  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1E8A0  38 63 EE 98 */	addi r3, r3, stringBase0@l
/* 80D1E8A4  38 80 00 20 */	li r4, 0x20
/* 80D1E8A8  7F A5 EB 78 */	mr r5, r29
/* 80D1E8AC  38 C0 00 80 */	li r6, 0x80
/* 80D1E8B0  4B 31 DA 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D1E8C4  4B 35 B6 74 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80D1E8DC:
/* 80D1E8DC  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80D1E8E0  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
...
/* 80D1E8F4  4B 64 39 0C */	b _restgpr_19

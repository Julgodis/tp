...
/* 80CD6A84 00000018  3C 60 00 00 */	lis r3, l_cyl_src@ha /* 80CD8274 */
/* 80CD6A88 0000001C  3B C3 00 00 */	addi r30, r3, l_cyl_src@l /* 80CD8274 */
/* 80CD6A8C 00000020  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80CD8510 */
/* 80CD6A90 00000024  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80CD8510 */
/* 80CD6A94 00000028  90 01 00 5C */	stw r0, 0x5c(r1)
/* 80CD6A98 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80CD6A9C 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80CD6AA0 00000034  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CD6AA4 00000038  38 A1 00 4C */	addi r5, r1, 0x4c
/* 80CD6AA8 0000003C  4B FF FF 91 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CD6AD0 00000064  4B FF FF 69 */	bl PSVECSquareMag
...
/* 80CD6B40 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80CD6B44 00000008  C3 C3 00 00 */	lfs f30, __float_nan@l(r3) /* 80450AE0 */
...
/* 80CD6BB0 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80CD6BB4 0000000C  C3 C3 00 00 */	lfs f30, __float_nan@l(r3) /* 80450AE0 */
...
/* 80CD6BCC 0000000C  4B FF FE 6D */	bl C_VECReflect
...
/* 80CD6BDC 0000001C  4B FF FE 5D */	bl __ml__4cXyzCFf
...
/* 80CD6BEC 0000002C  4B FF FE 4D */	bl __ml__4cXyzCFf
...
/* 80CD6C24 00000064  4B FF FE 15 */	bl PSVECSquareMag
...
/* 80CD6C94 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80CD6C98 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 80CD6D04 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80CD6D08 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_80CD6D0C:
/* 80CD6D0C 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80CD8510 */
/* 80CD6D10 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80CD8510 */
/* 80CD6D14 00000008  90 01 00 5C */	stw r0, 0x5c(r1)
/* 80CD6D18 0000000C  48 00 00 14 */	b lbl_80CD6D2C
lbl_80CD6D1C:
/* 80CD6D1C 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80CD8510 */
/* 80CD6D20 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80CD8510 */

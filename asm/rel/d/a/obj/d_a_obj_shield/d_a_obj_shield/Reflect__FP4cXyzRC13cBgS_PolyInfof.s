...
/* 80CD6A84  3C 60 80 CE */	lis r3, l_cyl_src@ha
/* 80CD6A88  3B C3 82 74 */	addi r30, r3, l_cyl_src@l
/* 80CD6A8C  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CD6A90  38 03 85 10 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CD6A94  90 01 00 5C */	stw r0, 0x5c(r1)
/* 80CD6A98  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CD6A9C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CD6AA0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CD6AA4  38 A1 00 4C */	addi r5, r1, 0x4c
/* 80CD6AA8  4B 39 DC 9C */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CD6AD0  4B 67 06 68 */	b PSVECSquareMag
...
/* 80CD6B40  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD6B44  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80CD6BB0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD6BB4  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80CD6C24  4B 67 05 14 */	b PSVECSquareMag
...
/* 80CD6C94  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD6C98  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80CD6D04  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD6D08  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80CD6D0C:
/* 80CD6D0C  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CD6D10  38 03 85 10 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CD6D14  90 01 00 5C */	stw r0, 0x5c(r1)
/* 80CD6D18  48 00 00 14 */	b lbl_80CD6D2C
lbl_80CD6D1C:
/* 80CD6D1C  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CD6D20  38 03 85 10 */	addi r0, r3, __vt__8cM3dGPla@l

...
/* 80C60B94 00000018  3C 60 80 C6 */	lis r3, lit_3709@ha
/* 80C60B98 0000001C  3B E3 1B 38 */	addi r31, r3, lit_3709@l
/* 80C60B9C 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C60BA0 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C60BB4 00000038  4B 3D 47 AC */	b isSwitch__10dSv_info_cCFii
/* 80C60BB8 0000003C  2C 03 00 00 */	cmpwi r3, 0
/* 80C60BBC 00000040  40 82 00 20 */	bne lbl_80C60BDC
/* 80C60BC0 00000044  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C60BC4 00000048  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C60BC8 0000004C  38 63 09 58 */	addi r3, r3, 0x958
/* 80C60BCC 00000050  38 80 00 03 */	li r4, 3
/* 80C60BD0 00000054  4B 3D 3D 64 */	b isDungeonItem__12dSv_memBit_cCFi
/* 80C60BD4 00000058  2C 03 00 00 */	cmpwi r3, 0
/* 80C60BD8 0000005C  41 82 00 34 */	beq lbl_80C60C0C
lbl_80C60BDC:
/* 80C60BDC 00000000  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80C61B38 */
...
/* 80C60BEC 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C60BF0 00000014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C60C04 00000028  4B 3D 45 FC */	b onSwitch__10dSv_info_cFii
/* 80C60C08 0000002C  48 00 00 14 */	b lbl_80C60C1C
lbl_80C60C0C:
/* 80C60C0C 00000000  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80C61B3C */
...
/* 80C60C3C 00000020  4B 3B 99 3C */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C60C58 0000003C  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80C61B40 */
...
/* 80C60CA8 00000014  4B 3B 92 48 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i

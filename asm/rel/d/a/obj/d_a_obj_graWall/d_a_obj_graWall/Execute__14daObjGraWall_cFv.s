...
/* 80C10DF8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C10DFC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C10E00  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C10E04  7C 05 07 74 */	extsb r5, r0
/* 80C10E08  4B 42 45 58 */	b isSwitch__10dSv_info_cCFii
/* 80C10E0C  2C 03 00 00 */	cmpwi r3, 0
/* 80C10E10  41 82 00 48 */	beq lbl_80C10E58
/* 80C10E14  7F E3 FB 78 */	mr r3, r31
/* 80C10E18  4B 40 8E 64 */	b fopAcM_delete__FP10fopAc_ac_c
/* 80C10E1C  38 60 00 01 */	li r3, 1
/* 80C10E20  48 00 00 44 */	b lbl_80C10E64
lbl_80C10E24:
/* 80C10E24  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C10E28  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C10E2C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C10E30  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C10E34  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C10E38  A0 84 00 7C */	lhz r4, 0x7c(r4)	/* effective address: 803A7304 */
/* 80C10E3C  4B 42 3B 80 */	b isEventBit__11dSv_event_cCFUs
/* 80C10E40  2C 03 00 00 */	cmpwi r3, 0
/* 80C10E44  41 82 00 14 */	beq lbl_80C10E58
/* 80C10E48  7F E3 FB 78 */	mr r3, r31
/* 80C10E4C  4B 40 8E 30 */	b fopAcM_delete__FP10fopAc_ac_c

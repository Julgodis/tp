...
/* 80C10C2C 00000034  3C 60 00 00 */	lis r3, __vt__9cCcD_Stts@ha /* 803C3728 */
/* 80C10C30 00000038  38 03 00 00 */	addi r0, r3, __vt__9cCcD_Stts@l /* 803C3728 */
...
/* 80C10C40 00000048  3C 60 00 00 */	lis r3, __vt__9dCcD_Stts@ha /* 803AC2E4 */
/* 80C10C44 0000004C  38 63 00 00 */	addi r3, r3, __vt__9dCcD_Stts@l /* 803AC2E4 */
...
/* 80C10C60 00000068  3C 60 00 00 */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 803C36D0 */
/* 80C10C64 0000006C  38 03 00 00 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 803C36D0 */
/* 80C10C68 00000070  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C10C6C 00000074  3C 60 00 00 */	lis r3, __vt__8cM3dGAab@ha /* 80C11058 */
/* 80C10C70 00000078  38 03 00 00 */	addi r0, r3, __vt__8cM3dGAab@l /* 80C11058 */
/* 80C10C74 0000007C  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C10C78 00000080  3C 60 00 00 */	lis r3, __vt__8cM3dGCyl@ha /* 80C1104C */
/* 80C10C7C 00000084  38 03 00 00 */	addi r0, r3, __vt__8cM3dGCyl@l /* 80C1104C */
/* 80C10C80 00000088  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C10C84 0000008C  3C 60 00 00 */	lis r3, __vt__12cCcD_CylAttr@ha /* 803C35A4 */
/* 80C10C88 00000090  38 63 00 00 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 803C35A4 */
...
/* 80C10C98 000000A0  3C 60 00 00 */	lis r3, __vt__8dCcD_Cyl@ha /* 803AC050 */
/* 80C10C9C 000000A4  38 63 00 00 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 803AC050 */
...
/* 80C10CD4 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C10CD8 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
lbl_80C10CF8:
/* 80C10CF8 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C10CFC 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C10D00 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C10D04 0000000C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C10D08 00000010  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

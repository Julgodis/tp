...
/* 80C3D198  4B 3D B9 CC */	b __ct__10fopAc_ac_cFv
/* 80C3D19C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C3D1A0  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C3D1A4  90 1E 05 CC */	stw r0, 0x5cc(r30)
/* 80C3D1A8  38 7E 05 D0 */	addi r3, r30, 0x5d0
/* 80C3D1AC  4B 44 65 B4 */	b __ct__10dCcD_GSttsFv
/* 80C3D1B0  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C3D1B4  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C3D1CC  4B 44 68 5C */	b __ct__12dCcD_GObjInfFv
/* 80C3D1D0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C3D1D4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C3D1D8  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C3D1DC  3C 60 80 C4 */	lis r3, __vt__8cM3dGAab@ha
/* 80C3D1E0  38 03 D4 FC */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C3D1E4  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C3D1E8  3C 60 80 C4 */	lis r3, __vt__8cM3dGCyl@ha
/* 80C3D1EC  38 03 D5 08 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80C3D1F0  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C3D1F4  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C3D1F8  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80C3D1FC  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80C3D200  38 03 00 58 */	addi r0, r3, 0x58
/* 80C3D204  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C3D208  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C3D20C  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C3D234  3C 80 80 C4 */	lis r4, l_arcName@ha
/* 80C3D238  38 84 D4 90 */	addi r4, r4, l_arcName@l
/* 80C3D23C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80C3D490 */
/* 80C3D240  4B 3E FC 7C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C3D254  3C 80 80 C4 */	lis r4, createSolidHeap__FP10fopAc_ac_c@ha
/* 80C3D258  38 84 CC 90 */	addi r4, r4, createSolidHeap__FP10fopAc_ac_c@l
/* 80C3D25C  38 A0 28 00 */	li r5, 0x2800
/* 80C3D260  4B 3D D2 50 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl

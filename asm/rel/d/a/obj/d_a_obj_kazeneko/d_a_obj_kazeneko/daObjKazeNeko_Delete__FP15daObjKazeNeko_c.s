...
/* 80C3D054  3C 80 80 C4 */	lis r4, l_arcName@ha
/* 80C3D058  38 84 D4 90 */	addi r4, r4, l_arcName@l
/* 80C3D05C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80C3D490 */
/* 80C3D060  4B 3E FF A8 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 80C3D064  34 1F 05 F0 */	addic. r0, r31, 0x5f0
/* 80C3D068  41 82 00 84 */	beq lbl_80C3D0EC
/* 80C3D06C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C3D070  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C3D090  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C3D094  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 80C3D0AC  3C 60 80 C4 */	lis r3, __vt__8cM3dGCyl@ha
/* 80C3D0B0  38 03 D5 08 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80C3D0B4  90 1F 07 28 */	stw r0, 0x728(r31)
lbl_80C3D0B8:
/* 80C3D0B8  34 1F 06 F4 */	addic. r0, r31, 0x6f4
/* 80C3D0BC  41 82 00 24 */	beq lbl_80C3D0E0
/* 80C3D0C0  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C3D0C4  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C3D0C8  90 1F 07 10 */	stw r0, 0x710(r31)
/* 80C3D0CC  34 1F 06 F4 */	addic. r0, r31, 0x6f4
/* 80C3D0D0  41 82 00 10 */	beq lbl_80C3D0E0
/* 80C3D0D4  3C 60 80 C4 */	lis r3, __vt__8cM3dGAab@ha
/* 80C3D0D8  38 03 D4 FC */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C3D0DC  90 1F 07 0C */	stw r0, 0x70c(r31)
lbl_80C3D0E0:
/* 80C3D0E0  38 7F 05 F0 */	addi r3, r31, 0x5f0
/* 80C3D0E4  38 80 00 00 */	li r4, 0
/* 80C3D0E8  4B 44 6F FC */	b __dt__12dCcD_GObjInfFv
lbl_80C3D0EC:
/* 80C3D0EC  34 1F 05 B4 */	addic. r0, r31, 0x5b4
/* 80C3D0F0  41 82 00 54 */	beq lbl_80C3D144
/* 80C3D0F4  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C3D0F8  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C3D110  3C 60 80 C4 */	lis r3, __vt__10dCcD_GStts@ha
/* 80C3D114  38 03 D4 F0 */	addi r0, r3, __vt__10dCcD_GStts@l
/* 80C3D118  90 1F 05 D0 */	stw r0, 0x5d0(r31)
/* 80C3D11C  34 1F 05 D0 */	addic. r0, r31, 0x5d0
/* 80C3D120  41 82 00 10 */	beq lbl_80C3D130
/* 80C3D124  3C 60 80 C4 */	lis r3, __vt__10cCcD_GStts@ha
/* 80C3D128  38 03 D4 E4 */	addi r0, r3, __vt__10cCcD_GStts@l
/* 80C3D12C  90 1F 05 D0 */	stw r0, 0x5d0(r31)
lbl_80C3D130:
/* 80C3D130  34 1F 05 B4 */	addic. r0, r31, 0x5b4
/* 80C3D134  41 82 00 10 */	beq lbl_80C3D144
/* 80C3D138  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C3D13C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C3D140  90 1F 05 CC */	stw r0, 0x5cc(r31)
lbl_80C3D144:
/* 80C3D144  7F E3 FB 78 */	mr r3, r31
/* 80C3D148  38 80 00 00 */	li r4, 0
/* 80C3D14C  4B 3D BB 40 */	b __dt__10fopAc_ac_cFv
lbl_80C3D150:

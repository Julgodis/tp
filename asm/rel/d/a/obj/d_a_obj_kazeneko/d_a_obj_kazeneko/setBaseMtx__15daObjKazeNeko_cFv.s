...
/* 80C3C998  4B 72 58 40 */	b _savegpr_28
/* 80C3C99C  7C 7F 1B 78 */	mr r31, r3
/* 80C3C9A0  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80C3C9A4  4B 3D 03 C0 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C3C9A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3C9AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C3C9B0  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C3C9B4  4B 3C F9 E8 */	b mDoMtx_XrotM__FPA4_fs
/* 80C3C9B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3C9BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C3C9C0  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 80C3C9C4  4B 3C FB 08 */	b mDoMtx_ZrotM__FPA4_fs
/* 80C3C9C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3C9CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C3C9D0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C3C9D4  4B 3C FA 60 */	b mDoMtx_YrotM__FPA4_fs
/* 80C3C9D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3C9DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C3C9E0  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80C3C9E4  38 84 00 24 */	addi r4, r4, 0x24
/* 80C3C9E8  4B 70 9A C8 */	b PSMTXCopy
/* 80C3C9EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3C9F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C3C9F4  38 9F 05 84 */	addi r4, r31, 0x584
/* 80C3C9F8  4B 70 9A B8 */	b PSMTXCopy
/* 80C3C9FC  80 1F 07 38 */	lwz r0, 0x738(r31)
/* 80C3CA00  2C 00 00 00 */	cmpwi r0, 0
/* 80C3CA04  40 82 00 70 */	bne lbl_80C3CA74
/* 80C3CA08  3C 60 80 C4 */	lis r3, lit_3890@ha
...
/* 80C3CA28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C3CA2C  A8 9F 07 48 */	lha r4, 0x748(r31)
/* 80C3CA30  4B 3C FA 04 */	b mDoMtx_YrotM__FPA4_fs
/* 80C3CA34  3B 80 00 00 */	li r28, 0
/* 80C3CA38  3B C0 00 00 */	li r30, 0
/* 80C3CA3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C3CA40  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l
lbl_80C3CA44:
/* 80C3CA44  7F A3 EB 78 */	mr r3, r29
/* 80C3CA48  38 80 40 00 */	li r4, 0x4000
/* 80C3CA4C  4B 3C F9 E8 */	b mDoMtx_YrotM__FPA4_fs
...
/* 80C3CA60  4B 70 9A 50 */	b PSMTXCopy
...
/* 80C3CA78  4B 72 57 AC */	b _restgpr_28

...
/* 80C34458 00000004  4B 72 DD 84 */	b _savegpr_29
/* 80C3445C 00000008  7C 7D 1B 78 */	mr r29, r3
/* 80C34460 0000000C  3C 60 80 C3 */	lis r3, lit_3806@ha
/* 80C34464 00000010  3B C3 4E EC */	addi r30, r3, lit_3806@l
/* 80C34468 00000014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3446C 00000018  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80C34470 0000001C  80 7F 5D AC */	lwz r3, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 80C34474 00000020  C3 E3 05 2C */	lfs f31, 0x52c(r3)	/* effective address: 8040052C */
...
/* 80C34484 00000030  C0 3E 00 54 */	lfs f1, 0x54(r30)	/* effective address: 80C34F40 */
/* 80C34488 00000034  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C3448C 00000038  D0 41 00 14 */	stfs f2, 0x14(r1)
/* 80C34490 0000003C  C0 43 04 D8 */	lfs f2, 0x4d8(r3)	/* effective address: 804004D8 */
/* 80C34494 00000040  C0 03 04 D0 */	lfs f0, 0x4d0(r3)	/* effective address: 804004D0 */
...
/* 80C344AC 00000058  4B 71 2E F0 */	b PSVECSquareDistance
/* 80C344B0 0000005C  C0 1E 00 54 */	lfs f0, 0x54(r30)	/* effective address: 80C34F40 */
...
/* 80C344C0 00000008  C8 9E 00 58 */	lfd f4, 0x58(r30)	/* effective address: 80C34F44 */
/* 80C344C4 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C344C8 00000010  C8 7E 00 60 */	lfd f3, 0x60(r30)	/* effective address: 80C34F4C */
...
lbl_80C34510:
/* 80C34510 00000000  C8 1E 00 68 */	lfd f0, 0x68(r30)	/* effective address: 80C34F54 */
/* 80C34514 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C34518 00000000  40 80 00 10 */	bge lbl_80C34528
/* 80C3451C 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C34520 00000008  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80C3458C 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C34590 0000000C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80C345DC 00000010  4B 45 00 7C */	b ChkCoHit__12dCcD_GObjInfFv
...
/* 80C345EC 00000020  4B 45 01 04 */	b GetCoHitObj__12dCcD_GObjInfFv
...
/* 80C34604 00000038  C8 5E 00 08 */	lfd f2, 8(r30)	/* effective address: 80C34EF4 */
...
/* 80C34620 00000054  C0 1E 00 70 */	lfs f0, 0x70(r30)	/* effective address: 80C34F5C */
...
/* 80C34654 00000088  C0 1E 00 74 */	lfs f0, 0x74(r30)	/* effective address: 80C34F60 */
...
/* 80C34690 0000000C  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 80C34694 00000010  4B 3E 60 7C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C346B8 00000034  4B 63 BE 88 */	b cLib_addCalcAngleS__FPsssss
lbl_80C346BC:
/* 80C346BC 00000000  38 7D 06 38 */	addi r3, r29, 0x638
/* 80C346C0 00000004  4B 44 FD A0 */	b ChkTgHit__12dCcD_GObjInfFv
/* 80C346C4 00000008  28 03 00 00 */	cmplwi r3, 0
/* 80C346C8 0000000C  41 82 00 F8 */	beq lbl_80C347C0
/* 80C346CC 00000010  C0 1E 00 78 */	lfs f0, 0x78(r30)	/* effective address: 80C34F64 */
...
/* 80C346F0 0000000C  C8 5E 00 08 */	lfd f2, 8(r30)	/* effective address: 80C34EF4 */
...
/* 80C3470C 00000028  C0 3E 00 7C */	lfs f1, 0x7c(r30)	/* effective address: 80C34F68 */
...
/* 80C34758 00000074  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 80C3476C 00000088  3C 60 80 C3 */	lis r3, lit_3975@ha
/* 80C34770 0000008C  38 63 4F C4 */	addi r3, r3, lit_3975@l
...
lbl_80C34784:
/* 80C34784 00000000  7F A3 EB 78 */	mr r3, r29
/* 80C34788 00000004  4B 3E 5F 88 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80C3478C 00000008  38 03 40 00 */	addi r0, r3, 0x4000
/* 80C34790 0000000C  B0 1D 05 82 */	sth r0, 0x582(r29)
/* 80C34794 00000010  48 00 00 2C */	b lbl_80C347C0
lbl_80C34798:
/* 80C34798 00000000  7F A3 EB 78 */	mr r3, r29
/* 80C3479C 00000004  4B 3E 5F 74 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80C347A0 00000008  38 03 C0 00 */	addi r0, r3, -16384
/* 80C347A4 0000000C  B0 1D 05 82 */	sth r0, 0x582(r29)
/* 80C347A8 00000010  48 00 00 18 */	b lbl_80C347C0
lbl_80C347AC:
/* 80C347AC 00000000  7F A3 EB 78 */	mr r3, r29
/* 80C347B0 00000004  4B 3E 5F 60 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C34810 00000008  4B 72 DA 18 */	b _restgpr_29

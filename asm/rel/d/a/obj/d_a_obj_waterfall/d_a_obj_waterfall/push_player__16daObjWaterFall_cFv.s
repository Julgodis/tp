...
/* 80D2FA84  4B 63 27 58 */	b _savegpr_29
/* 80D2FA88  7C 7D 1B 78 */	mr r29, r3
/* 80D2FA8C  3C 60 80 D3 */	lis r3, lit_3807@ha
/* 80D2FA90  3B E3 FD 58 */	addi r31, r3, lit_3807@l
/* 80D2FA94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2FA98  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D2FA9C  80 83 5D AC */	lwz r4, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80D2FAA0  7C 9E 23 78 */	mr r30, r4
/* 80D2FAA4  C3 FF 00 10 */	lfs f31, 0x10(r31)	/* effective address: 80D2FD68 */
/* 80D2FAA8  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 80D2FAAC  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 80D2FAD0  4B 2E AE 94 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80D2FAF4  4B 53 70 40 */	b __mi__4cXyzCFRC3Vec
...
/* 80D2FB10  4B 53 7B 64 */	b cM_atan2s__Fff
...
/* 80D2FB44  4B 53 6F F0 */	b __mi__4cXyzCFRC3Vec
...
/* 80D2FB60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2FB64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D2FB68  A8 1D 04 DE */	lha r0, 0x4de(r29)
/* 80D2FB6C  7C 00 00 D0 */	neg r0, r0
/* 80D2FB70  7C 04 07 34 */	extsh r4, r0
/* 80D2FB74  4B 2D C8 68 */	b mDoMtx_YrotS__FPA4_fs
/* 80D2FB78  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2FB7C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D2FB80  38 81 00 20 */	addi r4, r1, 0x20
/* 80D2FB84  7C 85 23 78 */	mr r5, r4
/* 80D2FB88  4B 61 71 E4 */	b PSMTXMultVec
...
/* 80D2FC80  4B 63 25 A8 */	b _restgpr_29

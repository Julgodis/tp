...
/* 80D2ED3C 0000000C  3C 60 00 00 */	lis r3, lit_3807@ha
/* 80D2ED40 00000010  3B 63 00 00 */	addi r27, r3, lit_3807@l
...
/* 80D2ED58 00000028  3C 60 00 00 */	lis r3, target_info_count@ha
/* 80D2ED5C 0000002C  90 A3 00 00 */	stw r5, target_info_count@l(r3)
/* 80D2ED60 00000030  7C A3 2B 78 */	mr r3, r5
/* 80D2ED64 00000034  3C 80 00 00 */	lis r4, target_info@ha
/* 80D2ED68 00000038  38 84 00 00 */	addi r4, r4, target_info@l
...
/* 80D2ED80 0000000C  3C 60 00 00 */	lis r3, s_b_sub__FPvPv@ha
/* 80D2ED84 00000010  38 63 00 00 */	addi r3, r3, s_b_sub__FPvPv@l
/* 80D2ED88 00000014  7F 04 C3 78 */	mr r4, r24
/* 80D2ED8C 00000018  4B FF FE 6D */	bl fpcEx_Search__FPFPvPv_PvPv
/* 80D2ED90 0000001C  3C 60 00 00 */	lis r3, target_info_count@ha
/* 80D2ED94 00000020  3B 83 00 00 */	addi r28, r3, target_info_count@l
...
/* 80D2EDAC 00000038  3C 60 00 00 */	lis r3, target_info@ha
/* 80D2EDB0 0000003C  3B A3 00 00 */	addi r29, r3, target_info@l
/* 80D2EDB4 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2EDB8 00000044  3B C3 00 00 */	addi r30, r3, now__14mDoMtx_stack_c@l

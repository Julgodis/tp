...
/* 80D347A4  4B 62 DA 34 */	b _savegpr_28
/* 80D347A8  7C 7E 1B 78 */	mr r30, r3
/* 80D347AC  3C 60 80 D3 */	lis r3, lit_3724@ha
/* 80D347B0  3B E3 51 7C */	addi r31, r3, lit_3724@l
/* 80D347B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D347B8  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 80D347BC  83 BC 5D AC */	lwz r29, 0x5dac(r28)	/* effective address: 8040BF6C */
...
/* 80D34840  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D34844  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D34848  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80D34888  4B 31 82 08 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D348B8  4B 2F 87 B4 */	b dComIfGp_getReverb__Fi
...
/* 80D348CC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D348D0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D348D4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D348F8  4B 57 7C 14 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
lbl_80D34910:
/* 80D34910  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D34914  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D34928  4B 30 08 D8 */	b onSwitch__10dSv_info_cFii
/* 80D3492C  7F C3 F3 78 */	mr r3, r30
/* 80D34930  4B 2E 53 4C */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80D34934:
...
lbl_80D3494C:
/* 80D3494C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D34950  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D34954  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80D34958  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80D3495C  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80D34960  4B 61 1F 88 */	b PSMTXTrans
/* 80D34964  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D34968  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3496C  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80D34970  4B 2D 7A C4 */	b mDoMtx_YrotM__FPA4_fs
/* 80D34974  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D34978  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D3497C  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80D34980  4B 2D 7B 4C */	b mDoMtx_ZrotM__FPA4_fs
/* 80D34984  C0 3E 04 EC */	lfs f1, 0x4ec(r30)
/* 80D34988  C0 5E 04 F0 */	lfs f2, 0x4f0(r30)
/* 80D3498C  C0 7E 04 F4 */	lfs f3, 0x4f4(r30)
/* 80D34990  4B 2D 84 A8 */	b scaleM__14mDoMtx_stack_cFfff
/* 80D34994  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80D34998  4B 2D 8A 90 */	b play__14mDoExt_baseAnmFv
/* 80D3499C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D349A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D349A4  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80D349A8  38 84 00 24 */	addi r4, r4, 0x24
/* 80D349AC  4B 61 1B 04 */	b PSMTXCopy
...
/* 80D349D0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80D349D4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80D34A10  4B 2E 5D 00 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80D34A28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D34A2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D34A30  38 80 80 00 */	li r4, -32768
/* 80D34A34  4B 2D 7A 00 */	b mDoMtx_YrotM__FPA4_fs
lbl_80D34A38:
/* 80D34A38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D34A3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D34A40  38 9E 05 90 */	addi r4, r30, 0x590
/* 80D34A44  4B 61 1A 6C */	b PSMTXCopy
/* 80D34A48  80 7E 05 C0 */	lwz r3, 0x5c0(r30)
/* 80D34A4C  4B 34 6F 74 */	b Move__4dBgWFv
...
/* 80D34ADC  4B 53 AB 6C */	b SetC__8cM3dGSphFRC4cXyz
...
/* 80D34AF0  4B 53 AC 18 */	b SetR__8cM3dGSphFf
/* 80D34AF4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D34AF8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D34AFC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D34B00  38 9E 06 00 */	addi r4, r30, 0x600
/* 80D34B04  4B 53 00 A4 */	b Set__4cCcSFP8cCcD_Obj
/* 80D34B08  38 60 00 01 */	li r3, 1
/* 80D34B0C  39 61 00 60 */	addi r11, r1, 0x60
/* 80D34B10  4B 62 D7 14 */	b _restgpr_28

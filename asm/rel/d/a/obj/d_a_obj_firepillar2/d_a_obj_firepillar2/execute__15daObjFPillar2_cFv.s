...
/* 80BEA59C 00000018  3C 80 80 BF */	lis r4, lit_3656@ha
/* 80BEA5A0 0000001C  3B C4 B4 C4 */	addi r30, r4, lit_3656@l
...
lbl_80BEA5D8:
/* 80BEA5D8 00000000  3C 60 80 43 */	lis r3, BaseY__4cXyz@ha
/* 80BEA5DC 00000004  C4 03 0D 24 */	lfsu f0, BaseY__4cXyz@l(r3)
/* 80BEA5E0 00000008  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80BEA5E4 0000000C  C0 43 00 04 */	lfs f2, 4(r3)	/* effective address: 80430004 */
/* 80BEA5E8 00000010  D0 41 00 18 */	stfs f2, 0x18(r1)
/* 80BEA5EC 00000014  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80430008 */
/* 80BEA5F0 00000018  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80BEA5F4 0000001C  C0 3E 00 1C */	lfs f1, 0x1c(r30)	/* effective address: 80BEB4E0 */
...
lbl_80BEA60C:
/* 80BEA60C 00000000  3C 60 80 43 */	lis r3, BaseZ__4cXyz@ha
/* 80BEA610 00000004  C4 03 0D 3C */	lfsu f0, BaseZ__4cXyz@l(r3)
/* 80BEA614 00000008  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80BEA618 0000000C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80430004 */
/* 80BEA61C 00000010  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80BEA620 00000014  C0 43 00 08 */	lfs f2, 8(r3)	/* effective address: 80430008 */
/* 80BEA624 00000018  D0 41 00 1C */	stfs f2, 0x1c(r1)
/* 80BEA628 0000001C  C0 3E 00 1C */	lfs f1, 0x1c(r30)	/* effective address: 80BEB4E0 */
...
lbl_80BEA63C:
/* 80BEA63C 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEA640 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEA644 00000008  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80BEA648 0000000C  4B 42 1D 94 */	b mDoMtx_YrotS__FPA4_fs
/* 80BEA64C 00000010  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BEA650 00000014  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BEA654 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 80BEA658 0000001C  7C 85 23 78 */	mr r5, r4
/* 80BEA65C 00000020  4B 75 C7 10 */	b PSMTXMultVec
...
/* 80BEA684 00000048  4B 67 C4 60 */	b __pl__4cXyzCFRC3Vec
...
/* 80BEA6A0 00000064  C0 3E 00 10 */	lfs f1, 0x10(r30)	/* effective address: 80BEB4D4 */
...
/* 80BEA6B4 00000078  C0 3E 00 20 */	lfs f1, 0x20(r30)	/* effective address: 80BEB4E4 */
...
/* 80BEA6D0 0000000C  4B 68 49 6C */	b Set__8cM3dGCpsFRC9cM3dGCpsS
/* 80BEA6D4 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BEA6D8 00000014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80BEA6DC 00000018  38 63 23 3C */	addi r3, r3, 0x233c
/* 80BEA6E0 0000001C  38 9F 07 D0 */	addi r4, r31, 0x7d0
/* 80BEA6E4 00000020  4B 67 A4 C4 */	b Set__4cCcSFP8cCcD_Obj
lbl_80BEA6E8:
...
/* 80BEA6F8 00000010  4B 44 29 74 */	b dComIfGp_getReverb__Fi

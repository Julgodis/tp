...
/* 80C1CAA4 00000010  3C 60 80 C2 */	lis r3, __global_destructor_chain@ha
/* 80C1CAA8 00000014  3B E3 DC 40 */	addi r31, r3, __global_destructor_chain@l
/* 80C1CAAC 00000018  48 00 00 20 */	b lbl_80C1CACC
lbl_80C1CAB0:
/* 80C1CAB0 00000000  80 05 00 00 */	lwz r0, 0(r5)
/* 80C1CAB4 00000004  90 1F 00 00 */	stw r0, 0(r31)	/* effective address: 80C1DC40 */
...
lbl_80C1CACC:
/* 80C1CACC 00000000  80 BF 00 00 */	lwz r5, 0(r31)	/* effective address: 80C1DC40 */

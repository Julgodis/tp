...
/* 80C1D6A0 00000018  3C 60 80 C2 */	lis r3, lit_3647@ha
/* 80C1D6A4 0000001C  3B C3 DA 94 */	addi r30, r3, lit_3647@l
/* 80C1D6A8 00000020  38 00 00 01 */	li r0, 1
/* 80C1D6AC 00000024  98 1F 05 C5 */	stb r0, 0x5c5(r31)
/* 80C1D6B0 00000028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C1D6B4 0000002C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C1D6C8 00000040  4B 41 7C 98 */	b isSwitch__10dSv_info_cCFii
...
/* 80C1D6DC 00000054  4B 40 F9 90 */	b dComIfGp_getReverb__Fi
...
/* 80C1D6F0 00000068  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C1D6F4 0000006C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C1D6F8 00000070  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C1D708 00000080  C0 3E 00 28 */	lfs f1, 0x28(r30)	/* effective address: 80C1DABC */
/* 80C1D70C 00000084  FC 40 08 90 */	fmr f2, f1
/* 80C1D710 00000088  C0 7E 00 2C */	lfs f3, 0x2c(r30)	/* effective address: 80C1DAC0 */
/* 80C1D714 0000008C  FC 80 18 90 */	fmr f4, f3
/* 80C1D718 00000090  39 00 00 00 */	li r8, 0
/* 80C1D71C 00000094  4B 68 E2 68 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C1D720 00000098  C0 3E 00 14 */	lfs f1, 0x14(r30)	/* effective address: 80C1DAA8 */
/* 80C1D724 0000009C  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80C1D728 000000A0  C0 1E 00 28 */	lfs f0, 0x28(r30)	/* effective address: 80C1DABC */
/* 80C1D72C 000000A4  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80C1D730 000000A8  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 80C1D734 000000AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C1D738 000000B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C1D73C 000000B4  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C1D740 000000B8  3C 80 80 C2 */	lis r4, l_HIO@ha
/* 80C1D744 000000BC  38 84 DC 54 */	addi r4, r4, l_HIO@l
/* 80C1D748 000000C0  88 84 00 34 */	lbz r4, 0x34(r4)	/* effective address: 80C1DC88 */
/* 80C1D74C 000000C4  38 A0 00 0F */	li r5, 0xf
/* 80C1D750 000000C8  38 C1 00 0C */	addi r6, r1, 0xc
/* 80C1D754 000000CC  4B 45 22 D0 */	b StartShock__12dVibration_cFii4cXyz
lbl_80C1D758:
/* 80C1D758 00000000  3C 60 80 C2 */	lis r3, l_HIO@ha
/* 80C1D75C 00000004  38 63 DC 54 */	addi r3, r3, l_HIO@l
/* 80C1D760 00000008  88 03 00 32 */	lbz r0, 0x32(r3)	/* effective address: 80C1DC86 */

...
/* 80C1D6B0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C1D6B4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C1D6F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C1D734  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C1D738  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C1D73C  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C1D740  3C 80 80 C2 */	lis r4, l_HIO@ha
/* 80C1D744  38 84 DC 54 */	addi r4, r4, l_HIO@l
/* 80C1D748  88 84 00 34 */	lbz r4, 0x34(r4)	/* effective address: 80C1DC88 */
...
/* 80C1D760  88 03 00 32 */	lbz r0, 0x32(r3)	/* effective address: 80C1DC86 */

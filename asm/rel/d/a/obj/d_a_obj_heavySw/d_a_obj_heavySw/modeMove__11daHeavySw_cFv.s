...
/* 80C1D5A0 00000018  3C 80 80 C2 */	lis r4, lit_3647@ha
/* 80C1D5A4 0000001C  3B E4 DA 94 */	addi r31, r4, lit_3647@l
...
/* 80C1D5E4 00000014  4B 40 FA 88 */	b dComIfGp_getReverb__Fi
...
/* 80C1D5F8 00000028  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C1D5FC 0000002C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C1D600 00000030  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C1D610 00000040  C0 3F 00 28 */	lfs f1, 0x28(r31)	/* effective address: 80C1DABC */
/* 80C1D614 00000044  FC 40 08 90 */	fmr f2, f1
/* 80C1D618 00000048  C0 7F 00 2C */	lfs f3, 0x2c(r31)	/* effective address: 80C1DAC0 */
/* 80C1D61C 0000004C  FC 80 18 90 */	fmr f4, f3
/* 80C1D620 00000050  39 00 00 00 */	li r8, 0
/* 80C1D624 00000054  4B 68 E3 60 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C1D638 00000008  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 80C1DAD4 */
/* 80C1D63C 0000000C  EC 41 00 24 */	fdivs f2, f1, f0
/* 80C1D640 00000010  4B 65 31 00 */	b cLib_chaseF__FPfff
/* 80C1D644 00000014  38 7E 05 BC */	addi r3, r30, 0x5bc
/* 80C1D648 00000018  C0 3F 00 20 */	lfs f1, 0x20(r31)	/* effective address: 80C1DAB4 */
/* 80C1D64C 0000001C  C0 5F 00 28 */	lfs f2, 0x28(r31)	/* effective address: 80C1DABC */
/* 80C1D650 00000020  C0 7E 05 2C */	lfs f3, 0x52c(r30)
/* 80C1D654 00000024  C0 9F 00 3C */	lfs f4, 0x3c(r31)	/* effective address: 80C1DAD0 */
/* 80C1D658 00000028  4B 65 23 24 */	b cLib_addCalc__FPfffff
/* 80C1D65C 0000002C  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 80C1DAA8 */

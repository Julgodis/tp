...
/* 80C1CD0C  4B 45 B9 18 */	b __ct__16dBgS_MoveBgActorFv
/* 80C1CD10  3C 60 80 C2 */	lis r3, __vt__11daHeavySw_c@ha
/* 80C1CD14  38 03 DC 00 */	addi r0, r3, __vt__11daHeavySw_c@l
/* 80C1CD18  90 1F 05 9C */	stw r0, 0x59c(r31)
/* 80C1CD1C  38 7F 05 E0 */	addi r3, r31, 0x5e0
/* 80C1CD20  4B 45 91 8C */	b __ct__12dBgS_AcchCirFv
/* 80C1CD24  3B FF 06 20 */	addi r31, r31, 0x620
/* 80C1CD28  7F E3 FB 78 */	mr r3, r31
/* 80C1CD2C  4B 45 93 74 */	b __ct__9dBgS_AcchFv
/* 80C1CD30  3C 60 80 C2 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C1CD34  38 63 DB DC */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80C1CD50  4B 45 C1 18 */	b SetObj__16dBgS_PolyPassChkFv
lbl_80C1CD54:
...
/* 80C1CD64  3C 80 80 C2 */	lis r4, stringBase0@ha
/* 80C1CD68  38 84 DA E0 */	addi r4, r4, stringBase0@l
/* 80C1CD6C  4B 41 01 50 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C1CD80  3C 80 80 C2 */	lis r4, stringBase0@ha
/* 80C1CD84  38 84 DA E0 */	addi r4, r4, stringBase0@l
/* 80C1CD88  38 A0 00 07 */	li r5, 7
/* 80C1CD8C  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C1CD90  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C1CD94  38 E0 0C 80 */	li r7, 0xc80
/* 80C1CD98  39 00 00 00 */	li r8, 0
/* 80C1CD9C  4B 45 BA 20 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C1CDC8  4B 3F D7 B0 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80C1CDCC  3C 60 80 C2 */	lis r3, rideCallBack__11daHeavySw_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C1CDD0  38 03 CF 90 */	addi r0, r3, rideCallBack__11daHeavySw_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
/* 80C1CDD4  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80C1CDD8  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 80C1CDDC  38 7E 05 E0 */	addi r3, r30, 0x5e0
/* 80C1CDE0  3C 80 80 C2 */	lis r4, lit_3652@ha
/* 80C1CDE4  C0 24 DA A8 */	lfs f1, lit_3652@l(r4)
/* 80C1CDE8  FC 40 08 90 */	fmr f2, f1
/* 80C1CDEC  4B 45 91 6C */	b SetWall__12dBgS_AcchCirFff
...
/* 80C1CE18  4B 45 94 30 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80C1CE1C  3C 60 80 C2 */	lis r3, lit_3652@ha
/* 80C1CE20  C0 03 DA A8 */	lfs f0, lit_3652@l(r3)
...
/* 80C1CE58  4B 41 85 08 */	b isSwitch__10dSv_info_cCFii
/* 80C1CE5C  2C 03 00 00 */	cmpwi r3, 0
/* 80C1CE60  41 82 00 1C */	beq lbl_80C1CE7C
/* 80C1CE64  3C 60 80 C2 */	lis r3, lit_3741@ha
/* 80C1CE68  C0 03 DA B4 */	lfs f0, lit_3741@l(r3)

...
/* 80C23CBC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C23CC0  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80C23D0C  4B 41 16 54 */	b isSwitch__10dSv_info_cCFii
...
/* 80C23D24  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C23D28  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C23D2C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C23D30  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C23D34  4B 58 10 6C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C23D38  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 80C23D3C  4B 3E 9F 88 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C23D40  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 80C23D44  4B 40 DC 08 */	b entry__10daMirror_cFP8J3DModel
/* 80C23D48  48 00 00 2C */	b lbl_80C23D74
lbl_80C23D4C:
/* 80C23D4C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C23D50  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C23D54  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 80C23D58  80 84 00 04 */	lwz r4, 4(r4)
/* 80C23D5C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C23D60  4B 58 10 40 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C23D64  80 7F 05 AC */	lwz r3, 0x5ac(r31)
/* 80C23D68  4B 3E 9F 5C */	b mDoExt_modelUpdateDL__FP8J3DModel

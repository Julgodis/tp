...
/* 80C22640 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C22644 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C2265C 00000044  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C22660 00000048  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C22664 0000004C  80 63 00 00 */	lwz r3, 0(r3)
/* 80C22668 00000050  3C 80 00 00 */	lis r4, data_80C243A0@ha
/* 80C2266C 00000054  38 84 00 00 */	addi r4, r4, data_80C243A0@l
/* 80C22670 00000058  80 84 00 00 */	lwz r4, 0(r4)
/* 80C22674 0000005C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C22678 00000060  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C226E0 00000010  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C226E4 00000014  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C22718 00000048  3C 60 00 00 */	lis r3, dBgS_MoveBGProc_Trans__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C2271C 0000004C  38 03 00 00 */	addi r0, r3, dBgS_MoveBGProc_Trans__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
...
lbl_80C22744:
/* 80C22744 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C22748 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C2274C 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 80C22750 0000000C  3C 80 00 00 */	lis r4, data_80C243A0@ha
/* 80C22754 00000010  38 84 00 00 */	addi r4, r4, data_80C243A0@l
/* 80C22758 00000014  80 84 00 04 */	lwz r4, 4(r4)
/* 80C2275C 00000018  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C22760 0000001C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2277C 00000038  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C22780 0000003C  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C22784 00000040  80 63 00 00 */	lwz r3, 0(r3)
/* 80C22788 00000044  3C 80 00 00 */	lis r4, data_80C243A0@ha
/* 80C2278C 00000048  38 84 00 00 */	addi r4, r4, data_80C243A0@l

...
/* 80C75C1C  4B 6E C5 C0 */	b _savegpr_29
...
/* 80C75C3C  4B 40 29 E8 */	b __ct__16dBgS_MoveBgActorFv
/* 80C75C40  3C 60 80 C7 */	lis r3, __vt__13daLv6SzGate_c@ha
/* 80C75C44  38 03 67 8C */	addi r0, r3, __vt__13daLv6SzGate_c@l
/* 80C75C48  90 1F 05 9C */	stw r0, 0x59c(r31)
/* 80C75C4C  3B BF 05 B0 */	addi r29, r31, 0x5b0
/* 80C75C50  3C 60 80 C7 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80C75C54  38 03 67 80 */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80C75C58  90 1F 05 B0 */	stw r0, 0x5b0(r31)
/* 80C75C5C  7F A3 EB 78 */	mr r3, r29
/* 80C75C60  38 80 00 00 */	li r4, 0
/* 80C75C64  4B 6B 27 98 */	b init__12J3DFrameCtrlFs
/* 80C75C68  38 00 00 00 */	li r0, 0
/* 80C75C6C  90 1D 00 14 */	stw r0, 0x14(r29)
/* 80C75C70  3B BF 05 C8 */	addi r29, r31, 0x5c8
/* 80C75C74  3C 60 80 C7 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80C75C78  38 03 67 80 */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80C75C7C  90 1F 05 C8 */	stw r0, 0x5c8(r31)
/* 80C75C80  7F A3 EB 78 */	mr r3, r29
/* 80C75C84  38 80 00 00 */	li r4, 0
/* 80C75C88  4B 6B 27 74 */	b init__12J3DFrameCtrlFs
...
/* 80C75CA4  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C75CA8  38 84 66 5C */	addi r4, r4, stringBase0@l
/* 80C75CAC  4B 3B 72 10 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C75CC0  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C75CC4  38 84 66 5C */	addi r4, r4, stringBase0@l
/* 80C75CC8  38 A0 00 0F */	li r5, 0xf
/* 80C75CCC  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C75CD0  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C75CD4  38 E0 1D 80 */	li r7, 0x1d80
/* 80C75CD8  39 00 00 00 */	li r8, 0
/* 80C75CDC  4B 40 2A E0 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C75D48  4B 40 5C 78 */	b Move__4dBgWFv
lbl_80C75D4C:
...
/* 80C75D68  4B 3B F5 F8 */	b isSwitch__10dSv_info_cCFii
/* 80C75D6C  98 7E 05 E3 */	stb r3, 0x5e3(r30)
/* 80C75D70  3C 60 80 C7 */	lis r3, lit_3666@ha
/* 80C75D74  C0 03 66 44 */	lfs f0, lit_3666@l(r3)
...
/* 80C75DBC  4B 6E C4 6C */	b _restgpr_29

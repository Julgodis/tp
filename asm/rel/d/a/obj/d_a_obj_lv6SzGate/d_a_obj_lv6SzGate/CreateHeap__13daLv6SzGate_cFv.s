...
/* 80C75A64  4B 6E C7 78 */	b _savegpr_29
/* 80C75A68  7C 7D 1B 78 */	mr r29, r3
/* 80C75A6C  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C75A70  38 63 66 5C */	addi r3, r3, stringBase0@l
/* 80C75A74  38 80 00 06 */	li r4, 6
/* 80C75A78  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C75A7C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C75A90  4B 3C 68 5C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C75AA8  4B 39 F1 AC */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C75AD4  4B 39 F1 80 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C75B18  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C75B1C  38 63 66 5C */	addi r3, r3, stringBase0@l
/* 80C75B20  38 80 00 0F */	li r4, 0xf
/* 80C75B24  7F E5 FB 78 */	mr r5, r31
/* 80C75B28  38 C0 00 80 */	li r6, 0x80
/* 80C75B2C  4B 3C 67 C0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C75B40  4B 40 43 F8 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
/* 80C75B44  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C75B48  40 82 00 18 */	bne lbl_80C75B60
/* 80C75B4C  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C75B50  38 03 5A D8 */	addi r0, r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
...
lbl_80C75B70:
/* 80C75B70  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C75B74  38 63 66 5C */	addi r3, r3, stringBase0@l
/* 80C75B78  38 80 00 09 */	li r4, 9
/* 80C75B7C  7F E5 FB 78 */	mr r5, r31
/* 80C75B80  38 C0 00 80 */	li r6, 0x80
/* 80C75B84  4B 3C 67 68 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C75B9C  3D 00 80 C7 */	lis r8, lit_3697@ha
/* 80C75BA0  C0 28 66 48 */	lfs f1, lit_3697@l(r8)
/* 80C75BA4  39 00 00 00 */	li r8, 0
/* 80C75BA8  39 20 FF FF */	li r9, -1
/* 80C75BAC  4B 39 7B 60 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80C75BB0  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C75BB4  38 63 66 5C */	addi r3, r3, stringBase0@l
/* 80C75BB8  38 80 00 0C */	li r4, 0xc
/* 80C75BBC  7F E5 FB 78 */	mr r5, r31
/* 80C75BC0  38 C0 00 80 */	li r6, 0x80
/* 80C75BC4  4B 3C 67 28 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C75BDC  3D 00 80 C7 */	lis r8, lit_3697@ha
/* 80C75BE0  C0 28 66 48 */	lfs f1, lit_3697@l(r8)
/* 80C75BE4  39 00 00 00 */	li r8, 0
/* 80C75BE8  39 20 FF FF */	li r9, -1
/* 80C75BEC  4B 39 7A 50 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C75BF0  38 60 00 01 */	li r3, 1
lbl_80C75BF4:
/* 80C75BF4  39 61 00 20 */	addi r11, r1, 0x20
/* 80C75BF8  4B 6E C6 30 */	b _restgpr_29

...
/* 8046DD48  4B EF 44 80 */	b _savegpr_24
/* 8046DD4C  7C 7D 1B 78 */	mr r29, r3
/* 8046DD50  3C 60 80 47 */	lis r3, lit_3879@ha
/* 8046DD54  3B C3 E5 28 */	addi r30, r3, lit_3879@l
...
/* 8046DD70  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 8046E528 */
...
/* 8046DDF8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8046DDFC  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 8046DE00  3C 60 80 47 */	lis r3, e_name@ha
/* 8046DE04  3B 43 E5 40 */	addi r26, r3, e_name@l
lbl_8046DE08:
/* 8046DE08  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)	/* effective address: 8040BEFC */
...
/* 8046DE54  4B BD F6 78 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8046DE84  4B E0 17 C4 */	b SetC__8cM3dGSphFRC4cXyz
/* 8046DE88  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8046DE8C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8046DE90  38 63 23 3C */	addi r3, r3, 0x233c
/* 8046DE94  38 9D 05 C4 */	addi r4, r29, 0x5c4
/* 8046DE98  4B DF 6D 10 */	b Set__4cCcSFP8cCcD_Obj
/* 8046DE9C  38 7D 05 C4 */	addi r3, r29, 0x5c4
/* 8046DEA0  4B C1 65 C0 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 8046DEB8  4B C1 66 40 */	b GetTgHitObj__12dCcD_GObjInfFv
/* 8046DEBC  90 61 00 50 */	stw r3, 0x50(r1)
/* 8046DEC0  38 61 00 50 */	addi r3, r1, 0x50
/* 8046DEC4  4B C1 9B 94 */	b at_power_check__FP11dCcU_AtInfo
...
/* 8046DED8  4B DF 8C 5C */	b __mi__4cXyzCFRC3Vec
...
/* 8046DEF4  4B DF 97 80 */	b cM_atan2s__Fff
/* 8046DEF8  B0 7D 04 DE */	sth r3, 0x4de(r29)
/* 8046DEFC  3B 00 00 02 */	li r24, 2
/* 8046DF00  3B 80 00 04 */	li r28, 4
/* 8046DF04  3C 60 80 47 */	lis r3, e_name@ha
/* 8046DF08  3B 63 E5 40 */	addi r27, r3, e_name@l
lbl_8046DF0C:
...
/* 8046DF4C  4B BD EB 44 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8046DF64  4B BA BD 18 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_8046DF68:
/* 8046DF68  39 61 00 A0 */	addi r11, r1, 0xa0
/* 8046DF6C  4B EF 42 A8 */	b _restgpr_24

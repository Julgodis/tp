...
/* 8046E100  4B EF 40 DC */	b _savegpr_29
/* 8046E104  7C 7E 1B 78 */	mr r30, r3
/* 8046E108  3C 60 80 47 */	lis r3, stringBase0@ha
/* 8046E10C  38 63 E5 38 */	addi r3, r3, stringBase0@l
/* 8046E110  88 1E 05 70 */	lbz r0, 0x570(r30)
/* 8046E114  54 00 10 3A */	slwi r0, r0, 2
/* 8046E118  3C 80 80 47 */	lis r4, bef_bmd@ha
/* 8046E11C  38 84 E5 4C */	addi r4, r4, bef_bmd@l
/* 8046E120  7C 84 00 2E */	lwzx r4, r4, r0
/* 8046E124  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8046E128  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8046E13C  4B BC E1 B0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8046E14C  4B BA 6B 08 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8046E16C  4B E6 0A E0 */	b __nw__FUl
/* 8046E170  7C 7D 1B 79 */	or. r29, r3, r3
/* 8046E174  41 82 00 20 */	beq lbl_8046E194
/* 8046E178  3C 80 80 47 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8046E17C  38 04 E6 04 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8046E180  90 1D 00 00 */	stw r0, 0(r29)
/* 8046E184  38 80 00 00 */	li r4, 0
/* 8046E188  4B EB A2 74 */	b init__12J3DFrameCtrlFs
...
lbl_8046E1AC:
/* 8046E1AC  3C 60 80 47 */	lis r3, stringBase0@ha
/* 8046E1B0  38 63 E5 38 */	addi r3, r3, stringBase0@l
/* 8046E1B4  88 1E 05 70 */	lbz r0, 0x570(r30)
/* 8046E1B8  54 00 10 3A */	slwi r0, r0, 2
/* 8046E1BC  3C 80 80 47 */	lis r4, bef_brk@ha
/* 8046E1C0  38 84 E5 54 */	addi r4, r4, bef_brk@l
/* 8046E1C4  7C 84 00 2E */	lwzx r4, r4, r0
/* 8046E1C8  7F E5 FB 78 */	mr r5, r31
/* 8046E1CC  38 C0 00 80 */	li r6, 0x80
/* 8046E1D0  4B BC E1 1C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8046E1F0  3D 00 80 47 */	lis r8, lit_3879@ha
/* 8046E1F4  C0 28 E5 28 */	lfs f1, lit_3879@l(r8)
/* 8046E1F8  39 00 00 00 */	li r8, 0
/* 8046E1FC  39 20 FF FF */	li r9, -1
/* 8046E200  4B B9 F5 0C */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_8046E244:
/* 8046E244  3C 60 80 47 */	lis r3, stringBase0@ha
/* 8046E248  38 63 E5 38 */	addi r3, r3, stringBase0@l
/* 8046E24C  38 80 00 0D */	li r4, 0xd
/* 8046E250  7F E5 FB 78 */	mr r5, r31
/* 8046E254  38 C0 00 80 */	li r6, 0x80
/* 8046E258  4B BC E0 94 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8046E26C  4B C0 BC CC */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_8046E284:
/* 8046E284  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 8046E288  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
...
/* 8046E29C  4B EF 3F 8C */	b _restgpr_29

...
/* 80C307E4 00000010  4B FF DB 95 */	bl _savegpr_29
/* 80C307E8 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80C307EC 00000018  3C 80 00 00 */	lis r4, lit_3774@ha /* 80C3114C */
/* 80C307F0 0000001C  3B E4 00 00 */	addi r31, r4, lit_3774@l /* 80C3114C */
...
/* 80C30800 0000002C  C0 3F 01 00 */	lfs f1, 0x100(r31)
/* 80C30804 00000030  4B FF DB 75 */	bl CalcZBuffer__9dInsect_cFf
/* 80C30808 00000034  80 7D 06 28 */	lwz r3, 0x628(r29)
/* 80C3080C 00000038  83 C3 00 04 */	lwz r30, 4(r3)
/* 80C30810 0000003C  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80C30814 00000040  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80C30824 00000050  4B FF DB 55 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C30828 00000054  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80C3082C 00000058  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 80C30830 0000005C  80 9E 00 04 */	lwz r4, 4(r30)
/* 80C30834 00000060  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80C30838 00000064  4B FF DB 41 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C3084C 00000078  4B FF DB 2D */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C30860 0000008C  4B FF DB 19 */	bl entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80C30878 000000A4  4B FF DB 01 */	bl fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
/* 80C3087C 000000A8  80 7D 06 28 */	lwz r3, 0x628(r29)
/* 80C30880 000000AC  4B FF DA F9 */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 80C30898 000000C4  C0 5F 01 04 */	lfs f2, 0x104(r31)
/* 80C3089C 000000C8  38 9D 06 48 */	addi r4, r29, 0x648
/* 80C308A0 000000CC  38 A0 00 00 */	li r5, 0
/* 80C308A4 000000D0  C0 7F 01 08 */	lfs f3, 0x108(r31)
/* 80C308A8 000000D4  3C C0 00 00 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 804248D0 */
/* 80C308AC 000000D8  38 C6 00 00 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l /* 804248D0 */
/* 80C308B0 000000DC  4B FF DA C9 */	bl dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80C308B4:
/* 80C308B4 00000000  38 60 00 01 */	li r3, 1
/* 80C308B8 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 80C308BC 00000008  4B FF DA BD */	bl _restgpr_29

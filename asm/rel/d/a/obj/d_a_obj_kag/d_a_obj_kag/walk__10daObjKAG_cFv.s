...
/* 80C2F8D4  4B 73 29 08 */	b _savegpr_29
/* 80C2F8D8  7C 7E 1B 78 */	mr r30, r3
/* 80C2F8DC  3C 60 80 C3 */	lis r3, lit_3774@ha
/* 80C2F8E0  3B E3 11 4C */	addi r31, r3, lit_3774@l
...
/* 80C2F910  4B 40 C9 DC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2F930  4B 3E 15 40 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
/* 80C2F934  C0 3F 00 48 */	lfs f1, 0x48(r31)
/* 80C2F938  4B 63 80 1C */	b cM_rndF__Ff
...
/* 80C2F99C  4B 3D D5 70 */	b ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80C2F9A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2F9A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2F9A8  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C2F9AC  4B 3D CA 88 */	b mDoMtx_YrotM__FPA4_fs
/* 80C2F9B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2F9B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2F9B8  38 81 00 70 */	addi r4, r1, 0x70
/* 80C2F9BC  38 A1 00 64 */	addi r5, r1, 0x64
/* 80C2F9C0  4B 71 73 AC */	b PSMTXMultVec
/* 80C2F9C4  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C2F9C8  38 81 00 64 */	addi r4, r1, 0x64
/* 80C2F9CC  7C 65 1B 78 */	mr r5, r3
/* 80C2F9D0  4B 71 76 C0 */	b PSVECAdd
/* 80C2F9D4  38 61 01 00 */	addi r3, r1, 0x100
/* 80C2F9D8  4B 44 82 90 */	b __ct__11dBgS_LinChkFv
/* 80C2F9DC  38 61 00 90 */	addi r3, r1, 0x90
/* 80C2F9E0  4B 44 82 88 */	b __ct__11dBgS_LinChkFv
...
/* 80C2FA18  4B 3D D3 4C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C2FA1C  38 7E 08 14 */	addi r3, r30, 0x814
/* 80C2FA20  4B 3D D5 24 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C2FA24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2FA28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2FA2C  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C2FA30  4B 3D CA 04 */	b mDoMtx_YrotM__FPA4_fs
/* 80C2FA34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2FA38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2FA3C  38 81 00 58 */	addi r4, r1, 0x58
/* 80C2FA40  7C 85 23 78 */	mr r5, r4
/* 80C2FA44  4B 71 73 28 */	b PSMTXMultVec
/* 80C2FA48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2FA4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2FA50  38 81 00 4C */	addi r4, r1, 0x4c
/* 80C2FA54  7C 85 23 78 */	mr r5, r4
/* 80C2FA58  4B 71 73 14 */	b PSMTXMultVec
/* 80C2FA5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2FA60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2FA64  38 81 00 40 */	addi r4, r1, 0x40
/* 80C2FA68  7C 85 23 78 */	mr r5, r4
/* 80C2FA6C  4B 71 73 00 */	b PSMTXMultVec
/* 80C2FA70  38 61 01 58 */	addi r3, r1, 0x158
/* 80C2FA74  4B 44 93 F4 */	b SetObj__16dBgS_PolyPassChkFv
/* 80C2FA78  38 61 00 E8 */	addi r3, r1, 0xe8
/* 80C2FA7C  4B 44 93 EC */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C2FA90  4B 44 82 D4 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 80C2FAC4  4B 44 48 F0 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C2FAC8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C2FACC  41 82 01 B8 */	beq lbl_80C2FC84
/* 80C2FAD0  3C 60 80 C3 */	lis r3, __vt__8cM3dGPla@ha
/* 80C2FAD4  38 03 14 04 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C2FAE8  4B 44 4C 5C */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C2FB18  4B 71 78 84 */	b PSVECSquareDistance
...
/* 80C2FB88  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2FB8C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C2FBF8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2FBFC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C2FC24  4B 63 7A 50 */	b cM_atan2s__Fff
...
lbl_80C2FC74:
/* 80C2FC74  3C 60 80 C3 */	lis r3, __vt__8cM3dGPla@ha
/* 80C2FC78  38 03 14 04 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C2FC9C  4B 64 0E F4 */	b cLib_chaseAngleS__FPsss
...
/* 80C2FCC4  4B 63 7C 90 */	b cM_rndF__Ff
...
/* 80C2FD6C  4B 44 7F 70 */	b __dt__11dBgS_LinChkFv
/* 80C2FD70  38 61 01 00 */	addi r3, r1, 0x100
/* 80C2FD74  38 80 FF FF */	li r4, -1
/* 80C2FD78  4B 44 7F 64 */	b __dt__11dBgS_LinChkFv
lbl_80C2FD7C:
/* 80C2FD7C  39 61 01 90 */	addi r11, r1, 0x190
/* 80C2FD80  4B 73 24 A8 */	b _restgpr_29

...
/* 80C304DC  3C 60 80 C3 */	lis r3, lit_4662@ha
/* 80C304E0  38 83 13 3C */	addi r4, r3, lit_4662@l
/* 80C304E4  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80C3133C */
/* 80C304E8  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80C31340 */
/* 80C304EC  90 61 00 14 */	stw r3, 0x14(r1)
/* 80C304F0  90 01 00 18 */	stw r0, 0x18(r1)
/* 80C304F4  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80C31344 */
...
lbl_80C3050C:
/* 80C3050C  3C 60 80 C3 */	lis r3, lit_4665@ha
/* 80C30510  38 83 13 48 */	addi r4, r3, lit_4665@l
/* 80C30514  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80C31348 */
/* 80C30518  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80C3134C */
/* 80C3051C  90 61 00 08 */	stw r3, 8(r1)
/* 80C30520  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C30524  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80C31350 */

...
/* 80C30900  4B 73 18 D4 */	b _savegpr_27
/* 80C30904  7C 7B 1B 78 */	mr r27, r3
/* 80C30908  3C 80 80 C3 */	lis r4, cNullVec__6Z2Calc@ha
/* 80C3090C  3B C4 12 70 */	addi r30, r4, cNullVec__6Z2Calc@l
/* 80C30910  3C 80 80 C3 */	lis r4, lit_3774@ha
/* 80C30914  3B E4 11 4C */	addi r31, r4, lit_3774@l
...
/* 80C3093C  4B 52 D6 D4 */	b __ct__9dInsect_cFv
/* 80C30940  3C 60 80 C3 */	lis r3, __vt__10daObjKAG_c@ha
/* 80C30944  38 03 13 F8 */	addi r0, r3, __vt__10daObjKAG_c@l
/* 80C30948  90 1C 05 68 */	stw r0, 0x568(r28)
/* 80C3094C  38 7C 05 98 */	addi r3, r28, 0x598
/* 80C30950  4B 68 FA 78 */	b __ct__10Z2CreatureFv
/* 80C30954  38 7C 06 34 */	addi r3, r28, 0x634
/* 80C30958  4B 44 6C 24 */	b __ct__11dBgS_GndChkFv
/* 80C3095C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C30960  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C30964  90 1C 06 A0 */	stw r0, 0x6a0(r28)
/* 80C30968  38 7C 06 A4 */	addi r3, r28, 0x6a4
/* 80C3096C  4B 45 2D F4 */	b __ct__10dCcD_GSttsFv
/* 80C30970  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C30974  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C3098C  4B 45 30 9C */	b __ct__12dCcD_GObjInfFv
/* 80C30990  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C30994  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C30998  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80C3099C  3C 60 80 C3 */	lis r3, __vt__8cM3dGAab@ha
/* 80C309A0  38 03 13 EC */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C309A4  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80C309A8  3C 60 80 C3 */	lis r3, __vt__8cM3dGSph@ha
/* 80C309AC  38 03 13 E0 */	addi r0, r3, __vt__8cM3dGSph@l
/* 80C309B0  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80C309B4  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 80C309B8  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 80C309BC  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80C309C0  38 03 00 58 */	addi r0, r3, 0x58
/* 80C309C4  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80C309C8  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 80C309CC  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 80C309F4  3C 80 80 C3 */	lis r4, stringBase0@ha
/* 80C309F8  38 84 12 60 */	addi r4, r4, stringBase0@l
/* 80C309FC  4B 3F C4 C0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C30A44  3C 60 80 C3 */	lis r3, l_HIO@ha
/* 80C30A48  38 63 14 40 */	addi r3, r3, l_HIO@l
/* 80C30A4C  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80C31448 */
...
lbl_80C30A60:
/* 80C30A60  3C 60 80 C3 */	lis r3, l_HIO@ha
/* 80C30A64  38 63 14 40 */	addi r3, r3, l_HIO@l
/* 80C30A68  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80C3144C */
...
/* 80C30AC0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C30AC4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C30AD8  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C30ADC  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C30AE0  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C30AE4  4B 40 3E D8 */	b isEventBit__11dSv_event_cCFUs
...
/* 80C30B00  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C30B04  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C30B08  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C30B0C  4B 40 3E B0 */	b isEventBit__11dSv_event_cCFUs
...
lbl_80C30B20:
/* 80C30B20  3C 60 80 C3 */	lis r3, stringBase0@ha
/* 80C30B24  38 63 12 60 */	addi r3, r3, stringBase0@l
/* 80C30B28  38 63 00 06 */	addi r3, r3, 6
/* 80C30B2C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C30B30  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C30B34  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C30B38  4B 73 7E 5C */	b strcmp
/* 80C30B3C  2C 03 00 00 */	cmpwi r3, 0
/* 80C30B40  40 82 00 AC */	bne lbl_80C30BEC
/* 80C30B44  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C30B48  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C30B4C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80C30B50  2C 00 00 03 */	cmpwi r0, 3
/* 80C30B54  40 82 00 98 */	bne lbl_80C30BEC
/* 80C30B58  88 7B 05 80 */	lbz r3, 0x580(r27)
/* 80C30B5C  4B 5A 93 E0 */	b isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
/* 80C30B7C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C30B80  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C30B84  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C30B88  A0 1F 01 0C */	lhz r0, 0x10c(r31)
/* 80C30B8C  54 00 08 3C */	slwi r0, r0, 1
/* 80C30B90  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C30B94  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C30B98  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C30B9C  4B 40 3E 20 */	b isEventBit__11dSv_event_cCFUs
...
/* 80C30BB4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C30BB8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C30BCC  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C30BD0  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C30BD4  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C30BD8  4B 40 3D E4 */	b isEventBit__11dSv_event_cCFUs
...
/* 80C30BF8  3C 80 80 C3 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80C30BFC  38 84 E4 D8 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80C30C00  38 A0 0F 40 */	li r5, 0xf40
/* 80C30C04  4B 3E 98 AC */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80C30C18:
/* 80C30C18  3C 60 80 C3 */	lis r3, data_80C31430@ha
/* 80C30C1C  8C 03 14 30 */	lbzu r0, data_80C31430@l(r3)
...
/* 80C30C38  3C 60 80 C3 */	lis r3, l_HIO@ha
/* 80C30C3C  38 63 14 40 */	addi r3, r3, l_HIO@l
/* 80C30C40  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80C31444 */
lbl_80C30C44:
...
/* 80C30C64  4B 3E 98 C4 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 80C30C78  4B 3E 98 C0 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 80C30CA4  4B 68 F8 8C */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80C30CCC  4B 45 2B 94 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C30CD0  38 7B 06 C4 */	addi r3, r27, 0x6c4
/* 80C30CD4  38 9E 00 20 */	addi r4, r30, 0x20
/* 80C30CD8  4B 45 3D 5C */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80C30D4C  4B 73 14 D4 */	b _restgpr_27

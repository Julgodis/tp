...
/* 80C2FF28  3C 80 80 C3 */	lis r4, lit_3774@ha
/* 80C2FF2C  3B E4 11 4C */	addi r31, r4, lit_3774@l
/* 80C2FF30  80 03 08 3C */	lwz r0, 0x83c(r3)
/* 80C2FF34  2C 00 00 00 */	cmpwi r0, 0
/* 80C2FF38  40 82 00 84 */	bne lbl_80C2FFBC
/* 80C2FF3C  3C 60 80 C3 */	lis r3, stringBase0@ha
/* 80C2FF40  38 63 12 60 */	addi r3, r3, stringBase0@l
/* 80C2FF44  38 80 00 06 */	li r4, 6
/* 80C2FF48  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C2FF4C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C2FF50  3C A5 00 02 */	addis r5, r5, 2
/* 80C2FF54  38 C0 00 80 */	li r6, 0x80
/* 80C2FF58  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C2FF5C  4B 40 C3 90 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2FF7C  4B 3E 0E F4 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C2FFD0  4B 3E A6 FC */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 80C2FFEC  4B 64 07 54 */	b cLib_chaseF__FPfff
...
/* 80C30004  4B 63 FA 38 */	b cLib_addCalc2__FPffff
...
/* 80C3002C  4B 3E 9C 50 */	b fopAcM_delete__FP10fopAc_ac_c

...
/* 80C2E7B0  4B 73 3A 24 */	b _savegpr_27
/* 80C2E7B4  7C 7C 1B 78 */	mr r28, r3
/* 80C2E7B8  7C 9B 23 78 */	mr r27, r4
/* 80C2E7BC  7C BE 2B 78 */	mr r30, r5
/* 80C2E7C0  7C DF 33 78 */	mr r31, r6
/* 80C2E7C4  3C 60 80 C3 */	lis r3, lit_3774@ha
/* 80C2E7C8  3B A3 11 4C */	addi r29, r3, lit_3774@l
/* 80C2E7CC  38 61 00 38 */	addi r3, r1, 0x38
/* 80C2E7D0  4B 44 94 98 */	b __ct__11dBgS_LinChkFv
/* 80C2E7D4  38 61 00 90 */	addi r3, r1, 0x90
/* 80C2E7D8  4B 44 A6 90 */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C2E7EC  4B 44 95 78 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C2E7F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C2E7F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C2E7F8  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80C2E7FC  7F 83 E3 78 */	mr r3, r28
/* 80C2E800  38 81 00 38 */	addi r4, r1, 0x38
/* 80C2E804  4B 44 5B B0 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C2E808  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C2E80C  41 82 01 C4 */	beq lbl_80C2E9D0
/* 80C2E810  3C 60 80 C3 */	lis r3, __vt__8cM3dGPla@ha
/* 80C2E814  38 03 14 04 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C2E828  4B 44 5F 1C */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C2E880  4B 71 8B 1C */	b PSVECSquareDistance
...
/* 80C2E8F0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2E8F4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C2E960  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2E964  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80C2E968  48 00 00 08 */	b lbl_80C2E970
lbl_80C2E96C:
/* 80C2E96C  FC 40 08 90 */	fmr f2, f1
lbl_80C2E970:
/* 80C2E970  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80C2E974  4B 63 8D 00 */	b cM_atan2s__Fff
...
/* 80C2E988  4B 63 8C EC */	b cM_atan2s__Fff
...
lbl_80C2E9B0:
/* 80C2E9B0  3C 60 80 C3 */	lis r3, __vt__8cM3dGPla@ha
/* 80C2E9B4  38 03 14 04 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80C2E9B8  90 01 00 34 */	stw r0, 0x34(r1)
/* 80C2E9BC  38 61 00 38 */	addi r3, r1, 0x38
/* 80C2E9C0  38 80 FF FF */	li r4, -1
/* 80C2E9C4  4B 44 93 18 */	b __dt__11dBgS_LinChkFv
...
/* 80C2E9D8  4B 44 93 04 */	b __dt__11dBgS_LinChkFv
/* 80C2E9DC  38 60 00 00 */	li r3, 0
lbl_80C2E9E0:
/* 80C2E9E0  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80C2E9E4  4B 73 38 3C */	b _restgpr_27

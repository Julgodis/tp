...
/* 80BB9334  4B 7A 8E 98 */	b _savegpr_25
/* 80BB9338  7C 7D 1B 78 */	mr r29, r3
/* 80BB933C  7C 9E 23 79 */	or. r30, r4, r4
/* 80BB9340  3C 60 80 BC */	lis r3, lit_3653@ha
/* 80BB9344  3B E3 97 3C */	addi r31, r3, lit_3653@l
...
/* 80BB9374  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB9378  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BB937C  80 83 5D AC */	lwz r4, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80BB9380  38 61 00 28 */	addi r3, r1, 0x28
/* 80BB9384  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 80BB9388  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80BB938C  4B 6A D7 A8 */	b __mi__4cXyzCFRC3Vec
...
/* 80BB93A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB93AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB93B0  A8 1D 04 DE */	lha r0, 0x4de(r29)
/* 80BB93B4  7C 00 00 D0 */	neg r0, r0
/* 80BB93B8  7C 04 07 34 */	extsh r4, r0
/* 80BB93BC  4B 45 30 20 */	b mDoMtx_YrotS__FPA4_fs
/* 80BB93C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB93C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB93C8  38 81 00 34 */	addi r4, r1, 0x34
/* 80BB93CC  7C 85 23 78 */	mr r5, r4
/* 80BB93D0  4B 78 D9 9C */	b PSMTXMultVec
...
/* 80BB9410  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB9414  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
...
/* 80BB9468  4B 49 36 28 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BB9480  4B 7A 8D 98 */	b _restgpr_25

...
/* 80D1BC58  3C 60 80 D2 */	lis r3, lit_3628@ha
/* 80D1BC5C  3B E3 C3 54 */	addi r31, r3, lit_3628@l
/* 80D1BC60  38 7E 07 04 */	addi r3, r30, 0x704
/* 80D1BC64  C0 3E 07 3C */	lfs f1, 0x73c(r30)
/* 80D1BC68  C0 7F 00 38 */	lfs f3, 0x38(r31)	/* effective address: 80D1C38C */
/* 80D1BC6C  C0 5F 00 3C */	lfs f2, 0x3c(r31)	/* effective address: 80D1C390 */
/* 80D1BC70  C0 1E 04 F0 */	lfs f0, 0x4f0(r30)
/* 80D1BC74  EC 02 00 32 */	fmuls f0, f2, f0
/* 80D1BC78  EC 43 00 32 */	fmuls f2, f3, f0
/* 80D1BC7C  4B 55 4A C4 */	b cLib_chaseF__FPfff
...
/* 80D1BCB0  4B 2F 10 B4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D1BCB4  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80D1BCB8  4B 2F 12 8C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D1BCBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D1BCC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D1BCC4  38 9E 06 F4 */	addi r4, r30, 0x6f4
/* 80D1BCC8  7C 85 23 78 */	mr r5, r4
/* 80D1BCCC  4B 62 B0 A0 */	b PSMTXMultVec
/* 80D1BCD0  38 7E 06 C8 */	addi r3, r30, 0x6c8
/* 80D1BCD4  38 9E 06 E8 */	addi r4, r30, 0x6e8
/* 80D1BCD8  4B 55 33 64 */	b Set__8cM3dGCpsFRC9cM3dGCpsS
...
/* 80D1BD10  4B 54 B3 9C */	b isZero__4cXyzCFv
...
/* 80D1BD24  4B 54 B1 D0 */	b normalize__4cXyzFv
/* 80D1BD28  48 00 00 20 */	b lbl_80D1BD48
lbl_80D1BD2C:
/* 80D1BD2C  3C 60 80 43 */	lis r3, Zero__4cXyz@ha
/* 80D1BD30  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)
/* 80D1BD34  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80D1BD38  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80430004 */
/* 80D1BD3C  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80D1BD40  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80430008 */
...
/* 80D1BD5C  4B 62 B3 7C */	b PSVECScale
...
/* 80D1BDA8  4B 64 63 04 */	b __cvt_fp2unsigned
...
/* 80D1BDBC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D1BDC0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D1BDC4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D1BDE8  4B 59 07 24 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D1BDEC:

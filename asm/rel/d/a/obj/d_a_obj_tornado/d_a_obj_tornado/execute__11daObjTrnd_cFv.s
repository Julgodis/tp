...
/* 80D1C108 00000018  3C 60 00 00 */	lis r3, lit_3628@ha /* 80D1C354 */
/* 80D1C10C 0000001C  3B C3 00 00 */	addi r30, r3, lit_3628@l /* 80D1C354 */
...
/* 80D1C120 00000030  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1C124 00000034  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D1C128 00000038  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D1C12C 0000003C  7C 05 07 74 */	extsb r5, r0
/* 80D1C130 00000040  4B FF F8 49 */	bl isSwitch__10dSv_info_cCFii
/* 80D1C134 00000044  2C 03 00 00 */	cmpwi r3, 0
/* 80D1C138 00000048  40 82 00 3C */	bne lbl_80D1C174
/* 80D1C13C 0000004C  C0 3E 00 00 */	lfs f1, 0(r30)
...
/* 80D1C15C 00000004  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 80D1C160 00000008  C0 5E 00 0C */	lfs f2, 0xc(r30)
/* 80D1C164 0000000C  C0 7E 00 14 */	lfs f3, 0x14(r30)
/* 80D1C168 00000010  C0 9E 00 54 */	lfs f4, 0x54(r30)
/* 80D1C16C 00000014  4B FF F8 0D */	bl cLib_addCalc__FPfffff
...
/* 80D1C188 00000014  C0 3E 00 00 */	lfs f1, 0(r30)
...
/* 80D1C19C 00000028  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 80D1C1A0 0000002C  C0 5E 00 0C */	lfs f2, 0xc(r30)
/* 80D1C1A4 00000030  C0 7E 00 14 */	lfs f3, 0x14(r30)
/* 80D1C1A8 00000034  C0 9E 00 54 */	lfs f4, 0x54(r30)
/* 80D1C1AC 00000038  4B FF F7 CD */	bl cLib_addCalc__FPfffff
/* 80D1C1B0 0000003C  48 00 00 70 */	b lbl_80D1C220
lbl_80D1C1B4:
/* 80D1C1B4 00000000  38 7F 07 6C */	addi r3, r31, 0x76c
/* 80D1C1B8 00000004  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 80D1C1BC 00000008  C0 5E 00 18 */	lfs f2, 0x18(r30)
/* 80D1C1C0 0000000C  C0 7E 00 14 */	lfs f3, 0x14(r30)
/* 80D1C1C4 00000010  C0 9E 00 54 */	lfs f4, 0x54(r30)
/* 80D1C1C8 00000014  4B FF F7 B1 */	bl cLib_addCalc__FPfffff
...
/* 80D1C1E8 00000018  C0 3E 00 00 */	lfs f1, 0(r30)
...
/* 80D1C1F8 00000028  C0 3E 00 3C */	lfs f1, 0x3c(r30)
...
/* 80D1C228 00000008  4B FF F7 51 */	bl dKyw_evt_wind_set__Fss
/* 80D1C22C 0000000C  C0 3F 07 6C */	lfs f1, 0x76c(r31)
/* 80D1C230 00000010  4B FF F7 49 */	bl dKyw_custom_windpower__Ff
...
/* 80D1C244 00000024  C0 3E 00 00 */	lfs f1, 0(r30)
...
/* 80D1C25C 0000003C  4B FF F7 1D */	bl Set__8cM3dGCpsFRC9cM3dGCpsS
/* 80D1C260 00000040  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1C264 00000044  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D1C268 00000048  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D1C26C 0000004C  38 9F 05 A4 */	addi r4, r31, 0x5a4
/* 80D1C270 00000050  4B FF F7 09 */	bl Set__4cCcSFP8cCcD_Obj
lbl_80D1C274:

...
/* 80C8DBC0 0000002C  4B FF FD D9 */	bl __ct__16dBgS_MoveBgActorFv
/* 80C8DBC4 00000030  3C 60 00 00 */	lis r3, __vt__11daMagLift_c@ha /* 80C8E800 */
/* 80C8DBC8 00000034  38 03 00 00 */	addi r0, r3, __vt__11daMagLift_c@l /* 80C8E800 */
...
/* 80C8DBE0 00000004  3C 80 00 00 */	lis r4, stringBase0@ha /* 80C8E6D0 */
/* 80C8DBE4 00000008  38 84 00 00 */	addi r4, r4, stringBase0@l /* 80C8E6D0 */
/* 80C8DBE8 0000000C  4B FF FD B1 */	bl dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C8DBFC 00000020  3C 80 00 00 */	lis r4, stringBase0@ha /* 80C8E6D0 */
/* 80C8DC00 00000024  38 84 00 00 */	addi r4, r4, stringBase0@l /* 80C8E6D0 */
/* 80C8DC04 00000028  38 A0 00 07 */	li r5, 7
/* 80C8DC08 0000002C  3C C0 00 00 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha /* 80075AD8 */
/* 80C8DC0C 00000030  38 C6 00 00 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l /* 80075AD8 */
/* 80C8DC10 00000034  38 E0 40 00 */	li r7, 0x4000
/* 80C8DC14 00000038  39 00 00 00 */	li r8, 0
/* 80C8DC18 0000003C  4B FF FD 81 */	bl MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C8DC40 00000014  4B FF FD 59 */	bl dPath_GetRoomPath__Fii
...
/* 80C8DC88 00000034  3C 60 00 00 */	lis r3, mSpeed__11daMagLift_c@ha /* 80C8E65C */
/* 80C8DC8C 00000038  38 63 00 00 */	addi r3, r3, mSpeed__11daMagLift_c@l /* 80C8E65C */
/* 80C8DC90 0000003C  7C 03 04 2E */	lfsx f0, r3, r0
/* 80C8DC94 00000040  D0 1E 05 CC */	stfs f0, 0x5cc(r30)
/* 80C8DC98 00000044  3C 60 00 00 */	lis r3, lit_3718@ha /* 80C8E69C */
/* 80C8DC9C 00000048  C0 03 00 00 */	lfs f0, lit_3718@l(r3) /* 80C8E69C */
...
lbl_80C8DCC0:
/* 80C8DCC0 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C8DCC4 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C8DCC8 00000008  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C8DCCC 0000000C  7C 05 07 74 */	extsb r5, r0
/* 80C8DCD0 00000010  4B FF FC C9 */	bl isSwitch__10dSv_info_cCFii
...
/* 80C8DD10 00000018  4B FF FC 89 */	bl fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData

...
/* 80CC2F44  4B 69 F2 78 */	b _savegpr_21
/* 80CC2F48  7C 7D 1B 78 */	mr r29, r3
/* 80CC2F4C  3C 60 80 CC */	lis r3, lit_3649@ha
/* 80CC2F50  3B C3 3A F4 */	addi r30, r3, lit_3649@l
...
/* 80CC2FC8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80CC2FCC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80CC3008  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CC300C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CC3010  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 80CC3014  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 80CC3018  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 80CC301C  4B 68 38 CC */	b PSMTXTrans
/* 80CC3020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CC3024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CC3028  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80CC302C  4B 34 94 08 */	b mDoMtx_YrotM__FPA4_fs
/* 80CC3030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CC3034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CC3038  7E C4 B3 78 */	mr r4, r22
/* 80CC303C  4B 34 93 60 */	b mDoMtx_XrotM__FPA4_fs
/* 80CC3040  3C 60 80 CC */	lis r3, l_HIO@ha
/* 80CC3044  3B E3 3C 90 */	addi r31, r3, l_HIO@l
/* 80CC3048  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 80CC3C98 */
/* 80CC304C  FC 40 08 90 */	fmr f2, f1
/* 80CC3050  FC 60 08 90 */	fmr f3, f1
/* 80CC3054  4B 34 9D E4 */	b scaleM__14mDoMtx_stack_cFfff
/* 80CC3058  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CC305C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CC3060  80 9D 05 B4 */	lwz r4, 0x5b4(r29)
/* 80CC3064  38 84 00 24 */	addi r4, r4, 0x24
/* 80CC3068  4B 68 34 48 */	b PSMTXCopy
/* 80CC306C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80CC3070  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80CC3074  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80CC3078  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80CC307C  4B 34 93 60 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80CC30D0  4B 5A C6 38 */	b SetR__8cM3dGSphFf
...
/* 80CC3118  4B 5A C5 F0 */	b SetR__8cM3dGSphFf
/* 80CC311C  38 7D 09 10 */	addi r3, r29, 0x910
/* 80CC3120  38 81 00 08 */	addi r4, r1, 8
/* 80CC3124  4B 5A C5 24 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 80CC314C  4B 5A C4 FC */	b SetC__8cM3dGSphFRC4cXyz
/* 80CC3150  38 7D 09 10 */	addi r3, r29, 0x910
/* 80CC3154  38 81 00 08 */	addi r4, r1, 8
/* 80CC3158  4B 5A C4 F0 */	b SetC__8cM3dGSphFRC4cXyz
...
lbl_80CC3170:
/* 80CC3170  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CC3174  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CC3178  3B 03 23 3C */	addi r24, r3, 0x233c
/* 80CC317C  7F 03 C3 78 */	mr r3, r24
/* 80CC3180  38 9D 06 B4 */	addi r4, r29, 0x6b4
/* 80CC3184  4B 5A 1A 24 */	b Set__4cCcSFP8cCcD_Obj
/* 80CC3188  7F 03 C3 78 */	mr r3, r24
/* 80CC318C  38 9D 07 EC */	addi r4, r29, 0x7ec
/* 80CC3190  4B 5A 1A 18 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80CC3298  4B 36 9D D4 */	b dComIfGp_getReverb__Fi
...
/* 80CC32D8  4B 69 EF 30 */	b _restgpr_21

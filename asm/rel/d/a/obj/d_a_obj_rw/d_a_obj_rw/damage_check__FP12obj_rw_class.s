...
/* 80CC2BB4 00000010  4B 69 F6 18 */	b _savegpr_25
/* 80CC2BB8 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80CC2BBC 00000018  3C 60 80 CC */	lis r3, lit_3649@ha
/* 80CC2BC0 0000001C  3B E3 3A F4 */	addi r31, r3, lit_3649@l
/* 80CC2BC4 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CC2BC8 00000024  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l
/* 80CC2BCC 00000028  83 5C 5D AC */	lwz r26, 0x5dac(r28)	/* effective address: 8040BF6C */
/* 80CC2BD0 0000002C  38 7E 06 94 */	addi r3, r30, 0x694
/* 80CC2BD4 00000030  4B 3C 0C 5C */	b Move__10dCcD_GSttsFv
...
/* 80CC2BF8 0000000C  4B 3C 18 68 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 80CC2C08 0000001C  4B 3C 18 F0 */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 80CC2C18 0000002C  4B 3C 4F EC */	b cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 80CC2C5C 00000004  C0 1F 00 10 */	lfs f0, 0x10(r31)	/* effective address: 80CC3B04 */
...
/* 80CC2C6C 00000008  80 9C 5D AC */	lwz r4, 0x5dac(r28)	/* effective address: 8040BF6C */
/* 80CC2C70 0000000C  4B 35 7A A0 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
lbl_80CC2C9C:
/* 80CC2C9C 00000000  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 80CC3B08 */
/* 80CC2CA0 00000004  D0 1E 06 6C */	stfs f0, 0x66c(r30)
/* 80CC2CA4 00000008  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80CC3AF4 */
/* 80CC2CA8 0000000C  4B 5A 4C AC */	b cM_rndF__Ff
/* 80CC2CAC 00000010  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 80CC3B0C */
/* 80CC2CB0 00000014  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80CC2CB4 00000000  40 80 00 68 */	bge lbl_80CC2D1C
/* 80CC2CB8 00000004  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80CC2CBC 00000008  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80CC2CC0 0000000C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80CC2CC4 00000010  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CC2CC8 00000014  4B 34 97 14 */	b mDoMtx_YrotS__FPA4_fs
/* 80CC2CCC 00000018  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 80CC3B10 */
/* 80CC2CD0 0000001C  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CC2CD4 00000020  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 80CC3B00 */
...
/* 80CC2CE8 00000034  4B 5A E2 04 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80CC2CF8 00000044  4B 68 43 98 */	b PSVECAdd
...
/* 80CC2D18 00000064  4B 35 95 28 */	b fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
lbl_80CC2D1C:
...
/* 80CC2D50 00000034  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 80CC3B08 */
...
/* 80CC2D70 00000054  4B 35 9D 68 */	b fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 80CC2D74 00000058  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80CC3AF4 */
...
/* 80CC2D9C 00000080  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 80CC3B00 */
/* 80CC2DA0 00000084  FC 40 08 90 */	fmr f2, f1
/* 80CC2DA4 00000088  89 1E 05 64 */	lbz r8, 0x564(r30)
/* 80CC2DA8 0000008C  4B 35 93 2C */	b fopAcM_createItemForBoss__FPC4cXyziiPC5csXyzPC4cXyzffi
...
/* 80CC2DBC 000000A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CC2DC0 000000A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CC2DC4 000000A8  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80CC2DC8 000000AC  7C 05 07 74 */	extsb r5, r0
/* 80CC2DCC 000000B0  4B 37 24 34 */	b onSwitch__10dSv_info_cFii
...
/* 80CC2DF8 0000000C  4B 3C 16 68 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 80CC2E20 00000034  4B 37 4A E0 */	b HitSeStart__5daObjFPC4cXyziPC12dCcD_GObjInfUl
/* 80CC2E24 00000038  C0 1F 00 20 */	lfs f0, 0x20(r31)	/* effective address: 80CC3B14 */
...
/* 80CC2E4C 00000004  4B 69 F3 CC */	b _restgpr_25

...
/* 80CAF34C  88 05 00 64 */	lbz r0, 0x64(r5)	/* effective address: 80CB0A38 */
/* 80CAF350  98 03 00 04 */	stb r0, 4(r3)
/* 80CAF354  38 85 00 64 */	addi r4, r5, 0x64
/* 80CAF358  88 04 00 01 */	lbz r0, 1(r4)	/* effective address: 80CB0A39 */
/* 80CAF35C  98 03 00 05 */	stb r0, 5(r3)
/* 80CAF360  A8 04 00 02 */	lha r0, 2(r4)	/* effective address: 80CB0A3A */
/* 80CAF364  B0 03 00 06 */	sth r0, 6(r3)
/* 80CAF368  A8 04 00 04 */	lha r0, 4(r4)	/* effective address: 80CB0A3C */
/* 80CAF36C  B0 03 00 08 */	sth r0, 8(r3)
/* 80CAF370  A8 04 00 06 */	lha r0, 6(r4)	/* effective address: 80CB0A3E */
/* 80CAF374  B0 03 00 0A */	sth r0, 0xa(r3)
/* 80CAF378  A8 04 00 08 */	lha r0, 8(r4)	/* effective address: 80CB0A40 */
/* 80CAF37C  B0 03 00 0C */	sth r0, 0xc(r3)
/* 80CAF380  A8 04 00 0A */	lha r0, 0xa(r4)	/* effective address: 80CB0A42 */
/* 80CAF384  B0 03 00 0E */	sth r0, 0xe(r3)
/* 80CAF388  C0 05 00 94 */	lfs f0, 0x94(r5)	/* effective address: 80CB0A68 */
/* 80CAF38C  D0 03 00 1C */	stfs f0, 0x1c(r3)
/* 80CAF390  C0 05 00 98 */	lfs f0, 0x98(r5)	/* effective address: 80CB0A6C */

...
/* 80CE7628 00000018  3C 60 00 00 */	lis r3, mCcDObjInfo__14daObj_SSItem_c@ha /* 80CE7EB0 */
/* 80CE762C 0000001C  3B E3 00 00 */	addi r31, r3, mCcDObjInfo__14daObj_SSItem_c@l /* 80CE7EB0 */
...
lbl_80CE7644:
/* 80CE7644 00000000  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80CE7648 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80CE7658 00000014  4B FF F5 A1 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CE765C 00000018  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80CE7660 0000001C  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80CE7670 0000002C  4B FF F5 89 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CE7674 00000030  80 7E 05 80 */	lwz r3, 0x580(r30)
/* 80CE7678 00000034  4B FF F5 81 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80CE767C 00000038  C0 3F 00 34 */	lfs f1, 0x34(r31)
...
/* 80CE768C 00000048  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80CE7FF8 */
/* 80CE7690 0000004C  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80CE7FF8 */
/* 80CE7694 00000050  90 01 00 18 */	stw r0, 0x18(r1)
/* 80CE7698 00000054  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80CE769C 00000058  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80CE76AC 00000068  4B FF F5 4D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80CE76B0 0000006C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CE76B4 00000070  41 82 00 34 */	beq lbl_80CE76E8
/* 80CE76B8 00000074  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80CE76BC 00000078  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80CE76CC 00000088  C0 5F 00 40 */	lfs f2, 0x40(r31)
/* 80CE76D0 0000008C  38 A1 00 08 */	addi r5, r1, 8
/* 80CE76D4 00000090  38 C0 00 00 */	li r6, 0
/* 80CE76D8 00000094  C0 7F 00 44 */	lfs f3, 0x44(r31)
/* 80CE76DC 00000098  3C E0 00 00 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 804248D0 */
/* 80CE76E0 0000009C  38 E7 00 00 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l /* 804248D0 */
/* 80CE76E4 000000A0  4B FF F5 15 */	bl setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80CE76E8:
/* 80CE76E8 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80CE7FF8 */
/* 80CE76EC 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80CE7FF8 */

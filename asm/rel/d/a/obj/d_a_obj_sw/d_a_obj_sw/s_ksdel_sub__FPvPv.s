...
/* 80CF0814  4B 32 84 CC */	b fopAc_IsActor__FPv
...
/* 80CF0830  4B 32 94 4C */	b fopAcM_delete__FP10fopAc_ac_c
/* 80CF0834  3C 60 80 CF */	lis r3, saru_ct@ha
/* 80CF0838  38 A3 32 78 */	addi r5, r3, saru_ct@l
/* 80CF083C  80 C5 00 00 */	lwz r6, 0(r5)	/* effective address: 80CF3278 */
/* 80CF0840  3C 60 80 CF */	lis r3, sc_path@ha
/* 80CF0844  38 83 31 00 */	addi r4, r3, sc_path@l
...
/* 80CF0864  80 C5 00 00 */	lwz r6, 0(r5)	/* effective address: 80CF3278 */
...
/* 80CF0884  80 C5 00 00 */	lwz r6, 0(r5)	/* effective address: 80CF3278 */
...
/* 80CF08A4  80 05 00 00 */	lwz r0, 0(r5)	/* effective address: 80CF3278 */
...
/* 80CF08BC  80 05 00 00 */	lwz r0, 0(r5)	/* effective address: 80CF3278 */
...
/* 80CF08D0  80 65 00 00 */	lwz r3, 0(r5)	/* effective address: 80CF3278 */
/* 80CF08D4  38 03 00 01 */	addi r0, r3, 1
/* 80CF08D8  90 05 00 00 */	stw r0, 0(r5)	/* effective address: 80CF3278 */
lbl_80CF08DC:

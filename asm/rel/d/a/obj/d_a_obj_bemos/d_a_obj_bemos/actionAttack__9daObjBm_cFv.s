...
/* 80BB1BE8  4B 7B 05 E0 */	b _savegpr_24
/* 80BB1BEC  7C 7F 1B 78 */	mr r31, r3
/* 80BB1BF0  3C 80 80 BB */	lis r4, l_eye_offset@ha
/* 80BB1BF4  3B C4 37 B8 */	addi r30, r4, l_eye_offset@l
/* 80BB1BF8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80BB1BFC  3B 24 61 C0 */	addi r25, r4, struct_804061C0+0x0@l
/* 80BB1C00  80 99 5D AC */	lwz r4, 0x5dac(r25)	/* effective address: 8040BF6C */
/* 80BB1C04  4B 46 8D 60 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80BB1CBC  4B 46 8A 54 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80BB1CD8  4B 6B EA 68 */	b cLib_chaseF__FPfff
...
/* 80BB1D18  4B 46 89 F8 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80BB1D34  4B 6B EA 0C */	b cLib_chaseF__FPfff
...
lbl_80BB1D4C:
/* 80BB1D4C  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BB1D50  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BB1D54  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BB1D58  38 80 00 1A */	li r4, 0x1a
/* 80BB1D5C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80BB1D60  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80BB1D74  4B 48 A5 78 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BB1DA0  4B 45 B8 9C */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80BB1DA4  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BB1DA8  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BB1DAC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BB1DB0  38 80 00 14 */	li r4, 0x14
/* 80BB1DB4  7F 25 CB 78 */	mr r5, r25
/* 80BB1DB8  38 C0 00 80 */	li r6, 0x80
/* 80BB1DBC  4B 48 A5 30 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BB1DE8  4B 45 B9 24 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80BB1F68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB1F6C  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l
lbl_80BB1F70:
/* 80BB1F70  38 61 00 2C */	addi r3, r1, 0x2c
/* 80BB1F74  38 80 00 00 */	li r4, 0
/* 80BB1F78  38 A0 00 00 */	li r5, 0
/* 80BB1F7C  38 C0 00 00 */	li r6, 0
/* 80BB1F80  4B 6B 54 74 */	b __ct__5csXyzFsss
...
/* 80BB1F98  4B 45 AD CC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BB1F9C  7F 43 D3 78 */	mr r3, r26
/* 80BB1FA0  A8 81 00 2E */	lha r4, 0x2e(r1)
/* 80BB1FA4  4B 45 A4 90 */	b mDoMtx_YrotM__FPA4_fs
...
/* 80BB1FB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB1FBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB1FC0  38 85 00 68 */	addi r4, r5, 0x68
/* 80BB1FC4  38 A5 00 A4 */	addi r5, r5, 0xa4
/* 80BB1FC8  4B 6C E8 18 */	b func_802807E0
lbl_80BB1FCC:
...
/* 80BB2000  4B 6B 4B 34 */	b __mi__4cXyzCFRC3Vec
...
/* 80BB203C  4B 6B 4F 0C */	b normalizeZP__4cXyzFv
/* 80BB2040  38 61 00 34 */	addi r3, r1, 0x34
/* 80BB2044  38 81 00 64 */	addi r4, r1, 0x64
/* 80BB2048  C0 3E 00 B0 */	lfs f1, 0xb0(r30)
/* 80BB204C  4B 6B 4B 38 */	b __ml__4cXyzCFf
/* 80BB2050  38 61 00 58 */	addi r3, r1, 0x58
/* 80BB2054  38 81 00 34 */	addi r4, r1, 0x34
/* 80BB2058  7C 65 1B 78 */	mr r5, r3
/* 80BB205C  4B 79 50 34 */	b PSVECAdd
/* 80BB2060  38 7F 0F B8 */	addi r3, r31, 0xfb8
/* 80BB2064  38 81 00 58 */	addi r4, r1, 0x58
/* 80BB2068  7F E5 FB 78 */	mr r5, r31
/* 80BB206C  4B 46 BB FC */	b lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80BB2070  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BB2074  41 82 02 D0 */	beq lbl_80BB2344
/* 80BB2078  3C 60 80 BB */	lis r3, __vt__8cM3dGPla@ha
/* 80BB207C  38 03 3E 40 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80BB2080  90 01 00 94 */	stw r0, 0x94(r1)
/* 80BB2084  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB2088  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BB208C  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80BB2090  7F 83 E3 78 */	mr r3, r28
/* 80BB2094  3C 80 80 3F */	lis r4, mLineCheck__11fopAcM_lc_c@ha
/* 80BB2098  38 84 1C 48 */	addi r4, r4, mLineCheck__11fopAcM_lc_c@l
/* 80BB209C  3B 04 00 14 */	addi r24, r4, 0x14
/* 80BB20A0  7F 04 C3 78 */	mr r4, r24
/* 80BB20A4  38 A1 00 84 */	addi r5, r1, 0x84
/* 80BB20A8  4B 4C 26 9C */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80BB20AC  C0 21 00 88 */	lfs f1, 0x88(r1)
/* 80BB20B0  4B 6B 61 34 */	b cBgW_CheckBGround__Ff
/* 80BB20B4  3C 80 80 BB */	lis r4, __vt__8cM3dGPla@ha
/* 80BB20B8  38 04 3E 40 */	addi r0, r4, __vt__8cM3dGPla@l
...
/* 80BB20E0  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha
/* 80BB20E4  38 63 1C 48 */	addi r3, r3, mLineCheck__11fopAcM_lc_c@l
/* 80BB20E8  3B 83 00 30 */	addi r28, r3, 0x30
/* 80BB20EC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB20F0  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
lbl_80BB20F4:
...
/* 80BB2148  4B 49 A9 48 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BB21C4  4B 49 A8 CC */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
lbl_80BB21EC:
/* 80BB21EC  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha
/* 80BB21F0  3B A3 1C 48 */	addi r29, r3, mLineCheck__11fopAcM_lc_c@l
/* 80BB21F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB21F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB21FC  C0 3D 00 30 */	lfs f1, 0x30(r29)	/* effective address: 803F1C78 */
/* 80BB2200  C0 5E 02 84 */	lfs f2, 0x284(r30)
/* 80BB2204  C0 1D 00 34 */	lfs f0, 0x34(r29)	/* effective address: 803F1C7C */
/* 80BB2208  EC 42 00 2A */	fadds f2, f2, f0
/* 80BB220C  C0 7D 00 38 */	lfs f3, 0x38(r29)	/* effective address: 803F1C80 */
/* 80BB2210  4B 79 46 D8 */	b PSMTXTrans
/* 80BB2214  3C 60 80 BB */	lis r3, __vt__8cM3dGPla@ha
/* 80BB2218  38 03 3E 40 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80BB2230  4B 4C 25 14 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80BB2234  C0 21 00 74 */	lfs f1, 0x74(r1)
/* 80BB2238  4B 6B 5F AC */	b cBgW_CheckBGround__Ff
/* 80BB223C  3C 80 80 BB */	lis r4, __vt__8cM3dGPla@ha
/* 80BB2240  38 04 3E 40 */	addi r0, r4, __vt__8cM3dGPla@l
...
/* 80BB225C  4B 4C 24 E8 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80BB2274  4B 6B C2 88 */	b cM3d_CalcVecAngle__FRC3VecPsPs
/* 80BB2278  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB227C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB2280  A8 81 00 24 */	lha r4, 0x24(r1)
/* 80BB2284  38 A0 00 00 */	li r5, 0
/* 80BB2288  A8 C1 00 28 */	lha r6, 0x28(r1)
/* 80BB228C  4B 45 9E D8 */	b mDoMtx_XYZrotM__FPA4_fsss
lbl_80BB2290:
/* 80BB2290  3B 00 00 00 */	li r24, 0
/* 80BB2294  3B 60 00 00 */	li r27, 0
/* 80BB2298  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB229C  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l
lbl_80BB22A0:
...
/* 80BB22BC  4B 6C E5 24 */	b func_802807E0
lbl_80BB22C0:
...
/* 80BB22D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB22DC  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l
lbl_80BB22E0:
...
/* 80BB22FC  4B 6C E4 E4 */	b func_802807E0
lbl_80BB2300:
...
/* 80BB2338  3C 60 80 BB */	lis r3, __vt__8cM3dGPla@ha
/* 80BB233C  38 03 3E 40 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80BB2340  90 01 00 A8 */	stw r0, 0xa8(r1)
lbl_80BB2344:
/* 80BB2344  38 7F 10 54 */	addi r3, r31, 0x1054
/* 80BB2348  38 9F 04 A8 */	addi r4, r31, 0x4a8
/* 80BB234C  4B 6B 4D 20 */	b __ne__4cXyzCFRC3Vec
...
/* 80BB23B4  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BB23B8  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BB23BC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BB23C0  38 80 00 12 */	li r4, 0x12
/* 80BB23C4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80BB23C8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80BB23CC  3C A5 00 02 */	addis r5, r5, 2
/* 80BB23D0  38 C0 00 80 */	li r6, 0x80
/* 80BB23D4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80BB23D8  4B 48 9F 14 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BB2404  4B 45 B3 08 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
lbl_80BB2408:

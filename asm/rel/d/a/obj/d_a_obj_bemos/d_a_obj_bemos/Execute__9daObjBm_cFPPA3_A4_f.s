...
/* 80BAF0AC 00000010  4B FF F2 2D */	bl _savegpr_29
/* 80BAF0B0 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80BAF0B4 00000018  7C 9E 23 78 */	mr r30, r4
/* 80BAF0B8 0000001C  3C 60 00 00 */	lis r3, l_eye_offset@ha /* 80BB37B8 */
/* 80BAF0BC 00000020  3B E3 00 00 */	addi r31, r3, l_eye_offset@l /* 80BB37B8 */
...
/* 80BAF0FC 0000000C  4B FF F1 DD */	bl cLib_chaseAngleS__FPsss
...
/* 80BAF10C 0000001C  4B FF F1 CD */	bl cLib_chaseAngleS__FPsss
...
/* 80BAF11C 0000002C  4B FF F1 BD */	bl cLib_chaseAngleS__FPsss
...
/* 80BAF12C 0000003C  4B FF F1 AD */	bl cLib_chaseAngleS__FPsss
...
/* 80BAF13C 0000004C  4B FF F1 9D */	bl cLib_chaseAngleS__FPsss
/* 80BAF140 00000050  7F A3 EB 78 */	mr r3, r29
/* 80BAF144 00000054  48 00 01 59 */	bl main_proc_call__9daObjBm_cFv
/* 80BAF148 00000058  C0 1F 00 00 */	lfs f0, 0(r31)
/* 80BAF14C 0000005C  D0 1D 05 38 */	stfs f0, 0x538(r29)
/* 80BAF150 00000060  38 7F 00 00 */	addi r3, r31, 0
/* 80BAF154 00000064  C0 03 00 04 */	lfs f0, 4(r3)
/* 80BAF158 00000068  D0 1D 05 3C */	stfs f0, 0x53c(r29)
/* 80BAF15C 0000006C  C0 03 00 08 */	lfs f0, 8(r3)
/* 80BAF160 00000070  D0 1D 05 40 */	stfs f0, 0x540(r29)
/* 80BAF164 00000074  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80BAF168 00000078  4B FF F1 71 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 80BAF16C 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80BAF170 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80BAF184 00000094  4B FF F1 55 */	bl mDoMtx_YrotM__FPA4_fs
/* 80BAF188 00000098  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80BAF18C 0000009C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80BAF190 000000A0  38 9D 05 38 */	addi r4, r29, 0x538
/* 80BAF194 000000A4  7C 85 23 78 */	mr r5, r4
/* 80BAF198 000000A8  4B FF F1 41 */	bl PSMTXMultVec
...
/* 80BAF1D8 000000E8  4B FF F1 01 */	bl cLib_addCalcAngleS__FPsssss
...
/* 80BAF1F0 00000100  4B FF F0 E9 */	bl cLib_addCalcAngleS__FPsssss
/* 80BAF1F4 00000104  38 7D 10 00 */	addi r3, r29, 0x1000
/* 80BAF1F8 00000108  C0 3F 00 78 */	lfs f1, 0x78(r31)
/* 80BAF1FC 0000010C  C0 5F 00 7C */	lfs f2, 0x7c(r31)
/* 80BAF200 00000110  C0 7F 00 80 */	lfs f3, 0x80(r31)
/* 80BAF204 00000114  C0 9F 00 84 */	lfs f4, 0x84(r31)
/* 80BAF208 00000118  4B FF F0 D1 */	bl cLib_addCalc__FPfffff
...
/* 80BAF21C 0000012C  C0 1F 00 78 */	lfs f0, 0x78(r31)
...
/* 80BAF238 00000008  4B FF F0 A1 */	bl dComIfGp_getReverb__Fi
...
/* 80BAF260 00000030  4B FF F0 79 */	bl dComIfGp_getReverb__Fi
...
/* 80BAF288 00000058  4B FF F0 51 */	bl _restgpr_29

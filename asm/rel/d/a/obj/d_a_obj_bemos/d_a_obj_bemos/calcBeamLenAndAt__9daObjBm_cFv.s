...
/* 80BAFC20  3C 60 80 BB */	lis r3, l_eye_offset@ha
/* 80BAFC24  3B E3 37 B8 */	addi r31, r3, l_eye_offset@l
/* 80BAFC28  38 61 00 3C */	addi r3, r1, 0x3c
/* 80BAFC2C  38 9E 0F CC */	addi r4, r30, 0xfcc
/* 80BAFC30  38 BE 0F B8 */	addi r5, r30, 0xfb8
/* 80BAFC34  4B 6B 6F 00 */	b __mi__4cXyzCFRC3Vec
...
/* 80BAFCD4  4B 4C 4A 70 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80BAFCD8  C0 21 00 84 */	lfs f1, 0x84(r1)
/* 80BAFCDC  4B 6B 85 08 */	b cBgW_CheckBGround__Ff
/* 80BAFCE0  3C 80 80 BB */	lis r4, __vt__8cM3dGPla@ha
/* 80BAFCE4  38 04 3E 40 */	addi r0, r4, __vt__8cM3dGPla@l
/* 80BAFCE8  90 01 00 90 */	stw r0, 0x90(r1)
/* 80BAFCEC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BAFCF0  41 82 01 0C */	beq lbl_80BAFDFC
/* 80BAFCF4  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha
/* 80BAFCF8  38 63 1C 48 */	addi r3, r3, mLineCheck__11fopAcM_lc_c@l
/* 80BAFCFC  38 83 00 30 */	addi r4, r3, 0x30
/* 80BAFD00  38 7E 0F B8 */	addi r3, r30, 0xfb8
/* 80BAFD04  4B 79 76 98 */	b PSVECSquareDistance
...
/* 80BAFD74  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BAFD78  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80BAFDE4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BAFDE8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80BAFDEC:
...
/* 80BAFE54  4B 6B F1 AC */	b Set__8cM3dGCpsFRC4cXyzRC4cXyzf
/* 80BAFE58  38 7E 09 58 */	addi r3, r30, 0x958
/* 80BAFE5C  4B 4D 49 C8 */	b CalcAtVec__8dCcD_CpsFv
...
/* 80BAFE90  4B 46 DD D8 */	b lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 80BAFEC4  4B 4C 48 80 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80BAFEC8  C0 21 00 70 */	lfs f1, 0x70(r1)
/* 80BAFECC  4B 6B 83 18 */	b cBgW_CheckBGround__Ff
/* 80BAFED0  3C 80 80 BB */	lis r4, __vt__8cM3dGPla@ha
/* 80BAFED4  38 04 3E 40 */	addi r0, r4, __vt__8cM3dGPla@l
...
/* 80BAFF10  4B 6C 08 9C */	b cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80BAFF34  4B 6C 08 78 */	b cLib_chasePos__FP4cXyzRC4cXyzf

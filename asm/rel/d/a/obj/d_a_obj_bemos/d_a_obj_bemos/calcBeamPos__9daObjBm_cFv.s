...
/* 80BAF908  4B 7B 28 D0 */	b _savegpr_28
/* 80BAF90C  7C 7E 1B 78 */	mr r30, r3
/* 80BAF910  3C 80 80 BB */	lis r4, l_eye_offset@ha
/* 80BAF914  3B A4 37 B8 */	addi r29, r4, l_eye_offset@l
/* 80BAF918  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80BAF91C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80BAF920  83 84 5D AC */	lwz r28, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80BAF924  7F 84 E3 78 */	mr r4, r28
/* 80BAF928  4B 46 B0 3C */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80BAF9AC  4B 6C 0E 00 */	b cLib_chasePos__FP4cXyzRC4cXyzf
/* 80BAF9B0  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80BAF9B4  4B 45 D3 B0 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BAF9B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BAF9BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BAF9C0  A8 1E 04 DE */	lha r0, 0x4de(r30)
/* 80BAF9C4  7C 1F 02 14 */	add r0, r31, r0
/* 80BAF9C8  7C 04 07 34 */	extsh r4, r0
/* 80BAF9CC  4B 45 CA 68 */	b mDoMtx_YrotM__FPA4_fs
/* 80BAF9D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BAF9D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BAF9D8  38 9E 0F D8 */	addi r4, r30, 0xfd8
/* 80BAF9DC  38 BE 0F B8 */	addi r5, r30, 0xfb8
/* 80BAF9E0  4B 79 73 8C */	b PSMTXMultVec
...
/* 80BAFA08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BAFA0C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BAFA10  38 81 00 3C */	addi r4, r1, 0x3c
/* 80BAFA14  38 BE 0F CC */	addi r5, r30, 0xfcc
/* 80BAFA18  4B 79 73 54 */	b PSMTXMultVec
...
/* 80BAFA40  4B 6B 70 F4 */	b __mi__4cXyzCFRC3Vec
...
/* 80BAFA90  4B 79 79 0C */	b PSVECSquareDistance
...
/* 80BAFB00  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BAFB04  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80BAFB70  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BAFB74  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80BAFB78  48 00 00 08 */	b lbl_80BAFB80
lbl_80BAFB7C:
/* 80BAFB7C  FC 40 08 90 */	fmr f2, f1
lbl_80BAFB80:
/* 80BAFB80  C0 21 00 34 */	lfs f1, 0x34(r1)
/* 80BAFB84  4B 6B 7A F0 */	b cM_atan2s__Fff
...
/* 80BAFBB8  4B 45 D1 AC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BAFBBC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BAFBC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80BAFBD8  4B 45 C6 C8 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80BAFBDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BAFBE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BAFBE4  38 81 00 3C */	addi r4, r1, 0x3c
/* 80BAFBE8  38 BE 0F CC */	addi r5, r30, 0xfcc
/* 80BAFBEC  4B 79 71 80 */	b PSMTXMultVec
/* 80BAFBF0  39 61 00 70 */	addi r11, r1, 0x70
/* 80BAFBF4  4B 7B 26 30 */	b _restgpr_28

...
/* 80BAEAEC  4B 7B 36 E8 */	b _savegpr_27
/* 80BAEAF0  7C 7F 1B 78 */	mr r31, r3
/* 80BAEAF4  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEAF8  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEAFC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEB00  38 80 00 0D */	li r4, 0xd
/* 80BAEB04  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80BAEB08  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80BAEB1C  4B 48 D7 D0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BAEB30  4B 46 61 24 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80BAEB4C:
/* 80BAEB4C  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEB50  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEB54  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEB58  38 80 00 13 */	li r4, 0x13
/* 80BAEB5C  7F C5 F3 78 */	mr r5, r30
/* 80BAEB60  38 C0 00 80 */	li r6, 0x80
/* 80BAEB64  4B 48 D7 88 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BAEB68  7C 7B 1B 78 */	mr r27, r3
/* 80BAEB6C  38 60 00 18 */	li r3, 0x18
/* 80BAEB70  4B 72 00 DC */	b __nw__FUl
/* 80BAEB74  7C 7C 1B 79 */	or. r28, r3, r3
/* 80BAEB78  41 82 00 20 */	beq lbl_80BAEB98
/* 80BAEB7C  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80BAEB80  38 04 3E 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80BAEB84  90 1C 00 00 */	stw r0, 0(r28)
/* 80BAEB88  38 80 00 00 */	li r4, 0
/* 80BAEB8C  4B 77 98 70 */	b init__12J3DFrameCtrlFs
...
/* 80BAEBB8  3D 00 80 BB */	lis r8, lit_3934@ha
/* 80BAEBBC  C0 28 38 24 */	lfs f1, lit_3934@l(r8)
/* 80BAEBC0  39 00 00 00 */	li r8, 0
/* 80BAEBC4  39 20 FF FF */	li r9, -1
/* 80BAEBC8  4B 45 EB 44 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80BAEBDC:
/* 80BAEBDC  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEBE0  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEBE4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEBE8  38 80 00 07 */	li r4, 7
/* 80BAEBEC  7F C5 F3 78 */	mr r5, r30
/* 80BAEBF0  38 C0 00 80 */	li r6, 0x80
/* 80BAEBF4  4B 48 D6 F8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BAEBF8  7C 7B 1B 78 */	mr r27, r3
/* 80BAEBFC  38 60 00 1C */	li r3, 0x1c
/* 80BAEC00  4B 72 00 4C */	b __nw__FUl
/* 80BAEC04  7C 7C 1B 79 */	or. r28, r3, r3
/* 80BAEC08  41 82 00 20 */	beq lbl_80BAEC28
/* 80BAEC0C  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80BAEC10  38 04 3E 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80BAEC14  90 1C 00 00 */	stw r0, 0(r28)
/* 80BAEC18  38 80 00 00 */	li r4, 0
/* 80BAEC1C  4B 77 97 E0 */	b init__12J3DFrameCtrlFs
...
/* 80BAEC44  3C E0 80 BB */	lis r7, lit_3934@ha
/* 80BAEC48  C0 27 38 24 */	lfs f1, lit_3934@l(r7)
/* 80BAEC4C  38 E0 00 00 */	li r7, 0
/* 80BAEC50  39 00 FF FF */	li r8, -1
/* 80BAEC54  39 20 00 00 */	li r9, 0
/* 80BAEC58  4B 45 EB 84 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_80BAEC6C:
/* 80BAEC6C  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEC70  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEC74  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEC78  38 80 00 0E */	li r4, 0xe
/* 80BAEC7C  7F C5 F3 78 */	mr r5, r30
/* 80BAEC80  38 C0 00 80 */	li r6, 0x80
/* 80BAEC84  4B 48 D6 68 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BAEC98  4B 46 5F BC */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80BAECB4:
/* 80BAECB4  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAECB8  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAECBC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAECC0  38 80 00 1A */	li r4, 0x1a
/* 80BAECC4  7F C5 F3 78 */	mr r5, r30
/* 80BAECC8  38 C0 00 80 */	li r6, 0x80
/* 80BAECCC  4B 48 D6 20 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BAECD0  7C 7B 1B 78 */	mr r27, r3
/* 80BAECD4  38 60 00 18 */	li r3, 0x18
/* 80BAECD8  4B 71 FF 74 */	b __nw__FUl
/* 80BAECDC  7C 7C 1B 79 */	or. r28, r3, r3
/* 80BAECE0  41 82 00 20 */	beq lbl_80BAED00
/* 80BAECE4  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80BAECE8  38 04 3E 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80BAECEC  90 1C 00 00 */	stw r0, 0(r28)
/* 80BAECF0  38 80 00 00 */	li r4, 0
/* 80BAECF4  4B 77 97 08 */	b init__12J3DFrameCtrlFs
...
/* 80BAED20  3D 00 80 BB */	lis r8, lit_3934@ha
/* 80BAED24  C0 28 38 24 */	lfs f1, lit_3934@l(r8)
/* 80BAED28  39 00 00 00 */	li r8, 0
/* 80BAED2C  39 20 FF FF */	li r9, -1
/* 80BAED30  4B 45 E9 0C */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80BAED4C  3C 60 80 BB */	lis r3, lit_4106@ha
/* 80BAED50  C8 23 38 28 */	lfd f1, lit_4106@l(r3)
...
/* 80BAED70  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAED74  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAED78  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAED7C  38 80 00 18 */	li r4, 0x18
/* 80BAED80  7F C5 F3 78 */	mr r5, r30
/* 80BAED84  38 C0 00 80 */	li r6, 0x80
/* 80BAED88  4B 48 D5 64 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BAED8C  7C 7B 1B 78 */	mr r27, r3
/* 80BAED90  38 60 00 18 */	li r3, 0x18
/* 80BAED94  4B 71 FE B8 */	b __nw__FUl
/* 80BAED98  7C 7C 1B 79 */	or. r28, r3, r3
/* 80BAED9C  41 82 00 20 */	beq lbl_80BAEDBC
/* 80BAEDA0  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80BAEDA4  38 04 3E 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80BAEDA8  90 1C 00 00 */	stw r0, 0(r28)
/* 80BAEDAC  38 80 00 00 */	li r4, 0
/* 80BAEDB0  4B 77 96 4C */	b init__12J3DFrameCtrlFs
...
/* 80BAEDDC  3D 00 80 BB */	lis r8, lit_3934@ha
/* 80BAEDE0  C0 28 38 24 */	lfs f1, lit_3934@l(r8)
/* 80BAEDE4  39 00 00 00 */	li r8, 0
/* 80BAEDE8  39 20 FF FF */	li r9, -1
/* 80BAEDEC  4B 45 E8 50 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80BAEE00:
/* 80BAEE00  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEE04  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEE08  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEE0C  38 80 00 09 */	li r4, 9
/* 80BAEE10  7F C5 F3 78 */	mr r5, r30
/* 80BAEE14  38 C0 00 80 */	li r6, 0x80
/* 80BAEE18  4B 48 D4 D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BAEE1C  7C 7B 1B 78 */	mr r27, r3
/* 80BAEE20  38 60 00 1C */	li r3, 0x1c
/* 80BAEE24  4B 71 FE 28 */	b __nw__FUl
/* 80BAEE28  7C 7D 1B 79 */	or. r29, r3, r3
/* 80BAEE2C  41 82 00 20 */	beq lbl_80BAEE4C
/* 80BAEE30  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80BAEE34  38 04 3E 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80BAEE38  90 1D 00 00 */	stw r0, 0(r29)
/* 80BAEE3C  38 80 00 00 */	li r4, 0
/* 80BAEE40  4B 77 95 BC */	b init__12J3DFrameCtrlFs
...
/* 80BAEE68  3C E0 80 BB */	lis r7, lit_3934@ha
/* 80BAEE6C  C0 27 38 24 */	lfs f1, lit_3934@l(r7)
/* 80BAEE70  38 E0 00 00 */	li r7, 0
/* 80BAEE74  39 00 FF FF */	li r8, -1
/* 80BAEE78  39 20 00 00 */	li r9, 0
/* 80BAEE7C  4B 45 E9 60 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_80BAEE90:
/* 80BAEE90  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEE94  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEE98  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEE9C  38 80 00 0F */	li r4, 0xf
/* 80BAEEA0  7F C5 F3 78 */	mr r5, r30
/* 80BAEEA4  38 C0 00 80 */	li r6, 0x80
/* 80BAEEA8  4B 48 D4 44 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BAEEB8  4B 46 5D 9C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80BAEED4:
/* 80BAEED4  3C 60 80 BB */	lis r3, l_arcName@ha
/* 80BAEED8  38 63 3A 94 */	addi r3, r3, l_arcName@l
/* 80BAEEDC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80BB3A94 */
/* 80BAEEE0  38 80 00 08 */	li r4, 8
/* 80BAEEE4  7F C5 F3 78 */	mr r5, r30
/* 80BAEEE8  38 C0 00 80 */	li r6, 0x80
/* 80BAEEEC  4B 48 D4 00 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80BAEEF0  7C 7B 1B 78 */	mr r27, r3
/* 80BAEEF4  38 60 00 1C */	li r3, 0x1c
/* 80BAEEF8  4B 71 FD 54 */	b __nw__FUl
/* 80BAEEFC  7C 7D 1B 79 */	or. r29, r3, r3
/* 80BAEF00  41 82 00 20 */	beq lbl_80BAEF20
/* 80BAEF04  3C 80 80 BB */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80BAEF08  38 04 3E 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80BAEF0C  90 1D 00 00 */	stw r0, 0(r29)
/* 80BAEF10  38 80 00 00 */	li r4, 0
/* 80BAEF14  4B 77 94 E8 */	b init__12J3DFrameCtrlFs
...
/* 80BAEF3C  3C E0 80 BB */	lis r7, lit_3934@ha
/* 80BAEF40  C0 27 38 24 */	lfs f1, lit_3934@l(r7)
/* 80BAEF44  38 E0 00 00 */	li r7, 0
/* 80BAEF48  39 00 FF FF */	li r8, -1
/* 80BAEF4C  39 20 00 00 */	li r9, 0
/* 80BAEF50  4B 45 E8 8C */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_80BAEF64:
/* 80BAEF64  3C 60 80 BB */	lis r3, lit_4250@ha
/* 80BAEF68  C0 03 38 30 */	lfs f0, lit_4250@l(r3)
...
/* 80BAEF7C  4B 7B 32 A4 */	b _restgpr_27

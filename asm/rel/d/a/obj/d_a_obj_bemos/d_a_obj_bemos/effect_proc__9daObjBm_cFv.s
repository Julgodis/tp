...
/* 80BB0320  4B 7B 1E B8 */	b _savegpr_28
/* 80BB0324  7C 7D 1B 78 */	mr r29, r3
/* 80BB0328  3C 60 80 BB */	lis r3, cNullVec__6Z2Calc@ha
/* 80BB032C  38 C3 3A 74 */	addi r6, r3, cNullVec__6Z2Calc@l
/* 80BB0330  3C 60 80 BB */	lis r3, data_80BB3F28@ha
/* 80BB0334  38 A3 3F 28 */	addi r5, r3, data_80BB3F28@l
/* 80BB0338  88 05 00 00 */	lbz r0, 0(r5)	/* effective address: 80BB3F28 */
...
/* 80BB03C4  4B 7B 1C C0 */	b __ptmf_scall
...
/* 80BB0404  4B 6D 03 DC */	b func_802807E0
...
/* 80BB0480  4B 45 C8 E4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BB0484  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB0488  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB048C  A8 9D 04 B6 */	lha r4, 0x4b6(r29)
/* 80BB0490  4B 45 BF A4 */	b mDoMtx_YrotM__FPA4_fs
/* 80BB0494  C0 3C 00 30 */	lfs f1, 0x30(r28)
/* 80BB0498  C0 5C 00 2C */	lfs f2, 0x2c(r28)
/* 80BB049C  C0 7C 00 34 */	lfs f3, 0x34(r28)
/* 80BB04A0  4B 45 C8 FC */	b transM__14mDoMtx_stack_cFfff
/* 80BB04A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB04A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB04AC  A8 9D 0F 96 */	lha r4, 0xf96(r29)
/* 80BB04B0  4B 45 BF 84 */	b mDoMtx_YrotM__FPA4_fs
/* 80BB04B4  80 BD 10 34 */	lwz r5, 0x1034(r29)
/* 80BB04B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB04BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB04C0  38 85 00 68 */	addi r4, r5, 0x68
/* 80BB04C4  38 A5 00 A4 */	addi r5, r5, 0xa4
/* 80BB04C8  4B 6D 03 18 */	b func_802807E0
lbl_80BB04CC:
...
/* 80BB04F4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80BB04F8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80BB04FC  4B 79 5F B4 */	b PSMTXCopy
/* 80BB0500  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB0504  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB0508  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80BB050C  D0 1D 10 3C */	stfs f0, 0x103c(r29)
/* 80BB0510  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80BB0514  D0 1D 10 40 */	stfs f0, 0x1040(r29)
/* 80BB0518  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80BB052C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BB0530  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BB0534  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BB0548  3D 00 80 BB */	lis r8, lit_3934@ha
/* 80BB054C  C0 28 38 24 */	lfs f1, lit_3934@l(r8)
/* 80BB0550  FC 40 08 90 */	fmr f2, f1
/* 80BB0554  3D 00 80 BB */	lis r8, lit_4402@ha
/* 80BB0558  C0 68 38 40 */	lfs f3, lit_4402@l(r8)
/* 80BB055C  FC 80 18 90 */	fmr f4, f3
/* 80BB0560  39 00 00 00 */	li r8, 0
/* 80BB0564  4B 6F BF A8 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BB0568:
/* 80BB0568  39 61 00 20 */	addi r11, r1, 0x20
/* 80BB056C  4B 7B 1C B8 */	b _restgpr_28

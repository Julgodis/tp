...
/* 80BB0EEC  4B 7B 12 B4 */	b __save_gpr
...
/* 80BB0F04  3C 60 80 BB */	lis r3, l_eye_offset@ha
/* 80BB0F08  3B C3 37 B8 */	addi r30, r3, l_eye_offset@l
...
/* 80BB0F20  3C 60 80 45 */	lis r3, __float_max@ha
/* 80BB0F24  C0 03 0A E8 */	lfs f0, __float_max@l(r3)
/* 80BB0F28  D0 18 01 7C */	stfs f0, 0x17c(r24)
/* 80BB0F2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB0F30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB0F34  7C 8F 23 78 */	mr r15, r4
/* 80BB0F38  4B 45 B4 A4 */	b mDoMtx_YrotS__FPA4_fs
/* 80BB0F3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB0F40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB0F44  38 80 40 00 */	li r4, 0x4000
/* 80BB0F48  4B 45 B4 54 */	b mDoMtx_XrotM__FPA4_fs
/* 80BB0F4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB0F50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BB0F54  3C 80 80 43 */	lis r4, BaseY__4cXyz@ha
/* 80BB0F58  38 84 0D 24 */	addi r4, r4, BaseY__4cXyz@l
/* 80BB0F5C  38 A1 00 20 */	addi r5, r1, 0x20
/* 80BB0F60  4B 79 5E 0C */	b PSMTXMultVec
...
/* 80BB0F74  4B 79 61 64 */	b PSVECScale
/* 80BB0F78  3B 60 00 00 */	li r27, 0
/* 80BB0F7C  3A E0 00 00 */	li r23, 0
/* 80BB0F80  3A C0 00 00 */	li r22, 0
/* 80BB0F84  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB0F88  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BB0F8C  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80BB0F90  3C 60 80 43 */	lis r3, Zero__4cXyz@ha
/* 80BB0F94  3B E3 0C F4 */	addi r31, r3, Zero__4cXyz@l
/* 80BB0F98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BB0F9C  3A 03 D4 70 */	addi r16, r3, now__14mDoMtx_stack_c@l
...
/* 80BB0FB0  3C 60 80 BB */	lis r3, M_wall_work__Q29daObjBm_c5Bgc_c@ha
/* 80BB0FB4  3A 83 47 94 */	addi r20, r3, M_wall_work__Q29daObjBm_c5Bgc_c@l
...
/* 80BB0FC8  4B 45 B3 7C */	b mDoMtx_XrotS__FPA4_fs
...
/* 80BB10A0  4B 4C 6C C4 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80BB10A4  92 BC 00 08 */	stw r21, 8(r28)
/* 80BB10A8  7F A3 EB 78 */	mr r3, r29
/* 80BB10AC  7F 84 E3 78 */	mr r4, r28
/* 80BB10B0  4B 4C 33 04 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 80BB10E0  4B 79 62 BC */	b PSVECSquareDistance
...
lbl_80BB10FC:
/* 80BB10FC  3C 60 80 43 */	lis r3, Zero__4cXyz@ha
/* 80BB1100  C0 03 0C F4 */	lfs f0, Zero__4cXyz@l(r3)
...
/* 80BB1140  4B 7B 10 AC */	b __restore_gpr

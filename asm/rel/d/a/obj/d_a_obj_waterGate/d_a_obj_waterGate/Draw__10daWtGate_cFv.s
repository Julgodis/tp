...
/* 80D2C2A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2C2AC  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80D2C2B0  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80D2C2B4  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80D2C2B8  3B E3 4A C8 */	addi r31, r3, j3dSys@l
/* 80D2C2BC  90 1F 00 48 */	stw r0, 0x48(r31)	/* effective address: 80434B10 */
/* 80D2C2C0  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80D2C2C4  90 1F 00 4C */	stw r0, 0x4c(r31)	/* effective address: 80434B14 */
/* 80D2C2C8  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80D2C2CC  4B 2E 19 F8 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80D2C2D0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2C2D4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D2C2D8  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80D2C2DC  90 1F 00 48 */	stw r0, 0x48(r31)
/* 80D2C2E0  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

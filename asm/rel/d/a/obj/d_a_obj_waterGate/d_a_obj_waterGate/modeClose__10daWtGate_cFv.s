...
/* 80D2C168  3C 60 80 D3 */	lis r3, lit_3625@ha
/* 80D2C16C  3B E3 C4 6C */	addi r31, r3, lit_3625@l
/* 80D2C170  38 7E 04 D4 */	addi r3, r30, 0x4d4
/* 80D2C174  C0 3E 05 B4 */	lfs f1, 0x5b4(r30)
/* 80D2C178  C0 5F 00 10 */	lfs f2, 0x10(r31)	/* effective address: 80D2C47C */
/* 80D2C17C  C0 7E 05 B8 */	lfs f3, 0x5b8(r30)
/* 80D2C180  C0 9F 00 14 */	lfs f4, 0x14(r31)	/* effective address: 80D2C480 */
/* 80D2C184  4B 54 37 F8 */	b cLib_addCalc__FPfffff
...
/* 80D2C19C  4B 30 0E D0 */	b dComIfGp_getReverb__Fi
...
/* 80D2C1B0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2C1B4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2C1B8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2C1DC  4B 57 F7 A8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D2C1F4  4B 30 0E 78 */	b dComIfGp_getReverb__Fi
...
/* 80D2C208  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2C20C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2C210  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2C234  4B 58 02 D8 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D2C238:

...
/* 80CD3BE8  4B 68 E5 E0 */	b _savegpr_24
/* 80CD3BEC  7C 7A 1B 78 */	mr r26, r3
/* 80CD3BF0  7C 98 23 78 */	mr r24, r4
/* 80CD3BF4  3C 60 80 CD */	lis r3, m__21daObj_Sekizoa_Param_c@ha
/* 80CD3BF8  3B C3 5C FC */	addi r30, r3, m__21daObj_Sekizoa_Param_c@l
/* 80CD3BFC  3B 80 00 00 */	li r28, 0
/* 80CD3C00  3B 60 FF FF */	li r27, -1
/* 80CD3C04  3B 20 00 00 */	li r25, 0
/* 80CD3C08  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CD3C0C  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 80CD3C10  3B BF 4F F8 */	addi r29, r31, 0x4ff8
/* 80CD3C14  7F A3 EB 78 */	mr r3, r29
/* 80CD3C18  3C A0 80 CD */	lis r5, struct_80CD5E64+0x0@ha
/* 80CD3C1C  38 A5 5E 64 */	addi r5, r5, struct_80CD5E64+0x0@l
/* 80CD3C20  38 A5 00 5F */	addi r5, r5, 0x5f
/* 80CD3C24  38 C0 00 03 */	li r6, 3
/* 80CD3C28  4B 37 44 C4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CD3C40  3C A0 80 CD */	lis r5, struct_80CD5E64+0x0@ha
/* 80CD3C44  38 A5 5E 64 */	addi r5, r5, struct_80CD5E64+0x0@l
/* 80CD3C48  38 A5 00 63 */	addi r5, r5, 0x63
/* 80CD3C4C  38 C0 00 03 */	li r6, 3
/* 80CD3C50  4B 37 44 9C */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80CD3C68  4B 37 40 E4 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80CD3CAC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CD3CB0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CD3CB4  88 1A 04 E2 */	lbz r0, 0x4e2(r26)
/* 80CD3CB8  7C 05 07 74 */	extsb r5, r0
/* 80CD3CBC  4B 36 15 44 */	b onSwitch__10dSv_info_cFii
lbl_80CD3CC0:
/* 80CD3CC0  38 7A 10 CC */	addi r3, r26, 0x10cc
/* 80CD3CC4  4B 47 1A 44 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 80CD3CE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CD3CE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CD3CE8  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80CD3CEC  4B 33 86 F0 */	b mDoMtx_YrotS__FPA4_fs
/* 80CD3CF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CD3CF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CD3CF8  38 81 00 0C */	addi r4, r1, 0xc
/* 80CD3CFC  7C 85 23 78 */	mr r5, r4
/* 80CD3D00  4B 67 30 6C */	b PSMTXMultVec
/* 80CD3D04  38 61 00 0C */	addi r3, r1, 0xc
/* 80CD3D08  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 80CD3D0C  7C 65 1B 78 */	mr r5, r3
/* 80CD3D10  4B 67 33 80 */	b PSVECAdd
/* 80CD3D14  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CD3D18  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CD3D1C  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80CD3D38  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80CD3D4C  3C 80 80 CD */	lis r4, l_evtList@ha
/* 80CD3D50  38 84 5F 40 */	addi r4, r4, l_evtList@l
/* 80CD3D54  80 84 00 48 */	lwz r4, 0x48(r4)	/* effective address: 80CD5F88 */
/* 80CD3D58  4B 69 4D D4 */	b strcpy
/* 80CD3D5C  38 61 00 18 */	addi r3, r1, 0x18
/* 80CD3D60  3C 80 80 CD */	lis r4, struct_80CD5E64+0x0@ha
/* 80CD3D64  38 84 5E 64 */	addi r4, r4, struct_80CD5E64+0x0@l
/* 80CD3D68  38 84 00 6F */	addi r4, r4, 0x6f
/* 80CD3D6C  4B 69 4D 50 */	b strcat
...
/* 80CD3D80  4B 36 EB D8 */	b setSkipZev__14dEvt_control_cFPvPc
/* 80CD3D84  7F E3 FB 78 */	mr r3, r31
/* 80CD3D88  4B 36 EC 20 */	b onSkipFade__14dEvt_control_cFv
...
/* 80CD3DA4  4B 36 F8 B8 */	b setPt2__14dEvt_control_cFPv
...
/* 80CD3EF4  4B 68 E3 20 */	b _restgpr_24

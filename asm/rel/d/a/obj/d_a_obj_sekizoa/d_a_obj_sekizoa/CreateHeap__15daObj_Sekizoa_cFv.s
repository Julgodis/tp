...
/* 80CCE8C0  4B 69 39 18 */	b _savegpr_28
...
lbl_80CCE8F4:
/* 80CCE8F4  3C 60 80 CD */	lis r3, l_bmdData@ha
/* 80CCE8F8  38 63 5E F8 */	addi r3, r3, l_bmdData@l
...
/* 80CCE910  3C 60 80 CD */	lis r3, l_resNameList@ha
/* 80CCE914  38 63 5F 90 */	addi r3, r3, l_resNameList@l
/* 80CCE918  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CCE91C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CCE920  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80CCE934  4B 36 D9 B8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCE94C  4B 60 03 00 */	b __nw__FUl
...
/* 80CCE988  3D 20 80 CD */	lis r9, lit_4533@ha
/* 80CCE98C  C0 29 5D C8 */	lfs f1, lit_4533@l(r9)
/* 80CCE990  39 20 00 00 */	li r9, 0
/* 80CCE994  39 40 FF FF */	li r10, -1
/* 80CCE998  4B 34 1E 38 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80CCE9D8  4B 33 FB 64 */	b create__21mDoExt_invisibleModelFP8J3DModelUc
...
/* 80CCE9F0  4B 60 02 5C */	b __nw__FUl
...
/* 80CCEA2C  3D 20 80 CD */	lis r9, lit_4533@ha
/* 80CCEA30  C0 29 5D C8 */	lfs f1, lit_4533@l(r9)
/* 80CCEA34  39 20 00 00 */	li r9, 0
/* 80CCEA38  39 40 FF FF */	li r10, -1
/* 80CCEA3C  4B 34 1D 94 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80CCEAD8  3C 60 80 CD */	lis r3, l_bmdData@ha
/* 80CCEADC  38 63 5E F8 */	addi r3, r3, l_bmdData@l
/* 80CCEAE0  7C 83 00 2E */	lwzx r4, r3, r0
/* 80CCEAE4  54 A0 10 3A */	slwi r0, r5, 2
/* 80CCEAE8  3C 60 80 CD */	lis r3, l_resNameList@ha
/* 80CCEAEC  38 63 5F 90 */	addi r3, r3, l_resNameList@l
/* 80CCEAF0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CCEAF4  7F A5 EB 78 */	mr r5, r29
/* 80CCEAF8  38 C0 00 80 */	li r6, 0x80
/* 80CCEAFC  4B 36 D7 F0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCEB14  4B 60 01 38 */	b __nw__FUl
...
/* 80CCEB50  3D 20 80 CD */	lis r9, lit_4533@ha
/* 80CCEB54  C0 29 5D C8 */	lfs f1, lit_4533@l(r9)
/* 80CCEB58  39 20 00 00 */	li r9, 0
/* 80CCEB5C  39 40 FF FF */	li r10, -1
/* 80CCEB60  4B 34 1C 70 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80CCEBA4  4B 47 B7 E4 */	b setFaceMotionAnm__8daNpcT_cFib
...
/* 80CCEBB8  3C A0 80 CD */	lis r5, lit_4350@ha
/* 80CCEBBC  C0 25 5D BC */	lfs f1, lit_4350@l(r5)
...
/* 80CCEBF8  4B 47 B7 90 */	b setFaceMotionAnm__8daNpcT_cFib
...
/* 80CCEC0C  3C A0 80 CD */	lis r5, lit_4350@ha
/* 80CCEC10  C0 25 5D BC */	lfs f1, lit_4350@l(r5)
...
/* 80CCEC40  4B 69 35 E4 */	b _restgpr_28

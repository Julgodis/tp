...
/* 80CD0BF4  4B 69 15 E4 */	b _savegpr_28
/* 80CD0BF8  7C 7F 1B 78 */	mr r31, r3
/* 80CD0BFC  3C 60 80 CD */	lis r3, m__21daObj_Sekizoa_Param_c@ha
/* 80CD0C00  3B A3 5C FC */	addi r29, r3, m__21daObj_Sekizoa_Param_c@l
/* 80CD0C04  C0 3D 01 28 */	lfs f1, 0x128(r29)	/* effective address: 80CD5E24 */
/* 80CD0C08  C0 1D 00 00 */	lfs f0, 0(r29)	/* effective address: 80CD5CFC */
/* 80CD0C0C  EF E1 00 32 */	fmuls f31, f1, f0
/* 80CD0C10  38 7F 10 E4 */	addi r3, r31, 0x10e4
/* 80CD0C14  4B 47 4A F4 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 80CD0C38  4B 33 C1 2C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CD0C3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CD0C40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CD0C44  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CD0C48  4B 33 B7 EC */	b mDoMtx_YrotM__FPA4_fs
/* 80CD0C4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CD0C50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CD0C54  38 81 00 38 */	addi r4, r1, 0x38
/* 80CD0C58  38 A1 00 2C */	addi r5, r1, 0x2c
/* 80CD0C5C  4B 67 61 10 */	b PSMTXMultVec
...
/* 80CD0CB4  4B 47 A0 3C */	b chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs
...
/* 80CD0CDC  4B 59 70 4C */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 80CD0CE0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CD0CE4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CD0CE8  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 80CD0CEC  7F C3 F3 78 */	mr r3, r30
/* 80CD0CF0  38 9F 09 30 */	addi r4, r31, 0x930
/* 80CD0CF4  4B 3A 37 AC */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80CD0D28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CD0D2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CD0D30  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CD0D34  4B 33 B6 A8 */	b mDoMtx_YrotS__FPA4_fs
/* 80CD0D38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CD0D3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CD0D40  38 81 00 38 */	addi r4, r1, 0x38
/* 80CD0D44  38 A1 00 2C */	addi r5, r1, 0x2c
/* 80CD0D48  4B 67 60 24 */	b PSMTXMultVec
/* 80CD0D4C  38 61 00 08 */	addi r3, r1, 8
/* 80CD0D50  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80CD0D54  38 A1 00 2C */	addi r5, r1, 0x2c
/* 80CD0D58  4B 59 5D 8C */	b __pl__4cXyzCFRC3Vec
...
/* 80CD0DA4  4B 3A 6F C0 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CD0DA8  7F C3 F3 78 */	mr r3, r30
/* 80CD0DAC  38 9F 0A E0 */	addi r4, r31, 0xae0
/* 80CD0DB0  4B 3A 36 04 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 80CD0DD4  4B 69 14 50 */	b _restgpr_28

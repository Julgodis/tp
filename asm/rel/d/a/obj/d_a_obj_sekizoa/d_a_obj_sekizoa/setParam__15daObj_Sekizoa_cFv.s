...
/* 80CCF424 00000040  3C 60 80 CD */	lis r3, m__21daObj_Sekizoa_Param_c@ha
/* 80CCF428 00000044  38 63 5C FC */	addi r3, r3, m__21daObj_Sekizoa_Param_c@l
/* 80CCF42C 00000048  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD5D04 */
...
/* 80CCF43C 00000058  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 80CD5D0C */
...
/* 80CCF450 0000006C  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 80CD5D10 */
/* 80CCF454 00000070  D0 1F 0D EC */	stfs f0, 0xdec(r31)
/* 80CCF458 00000074  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 80CD5D18 */
/* 80CCF45C 00000078  D0 1F 0D F0 */	stfs f0, 0xdf0(r31)
/* 80CCF460 0000007C  C0 03 00 50 */	lfs f0, 0x50(r3)	/* effective address: 80CD5D4C */
...
/* 80CCF470 0000008C  4B 3A 6A D0 */	b SetWallR__12dBgS_AcchCirFf
/* 80CCF474 00000090  3C 60 80 CD */	lis r3, m__21daObj_Sekizoa_Param_c@ha
/* 80CCF478 00000094  38 63 5C FC */	addi r3, r3, m__21daObj_Sekizoa_Param_c@l
/* 80CCF47C 00000098  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80CD5D14 */
/* 80CCF480 0000009C  D0 1F 08 D0 */	stfs f0, 0x8d0(r31)
/* 80CCF484 000000A0  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80CD5D08 */
/* 80CCF488 000000A4  D0 1F 0D E8 */	stfs f0, 0xde8(r31)
/* 80CCF48C 000000A8  C0 03 00 6C */	lfs f0, 0x6c(r3)	/* effective address: 80CD5D68 */
/* 80CCF490 000000AC  D0 1F 0A 80 */	stfs f0, 0xa80(r31)
/* 80CCF494 000000B0  C0 03 00 44 */	lfs f0, 0x44(r3)	/* effective address: 80CD5D40 */
/* 80CCF498 000000B4  D0 1F 0A 84 */	stfs f0, 0xa84(r31)
/* 80CCF49C 000000B8  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD5D00 */
...
lbl_80CCF4B8:
/* 80CCF4B8 00000000  3C 60 80 CD */	lis r3, lit_4350@ha
/* 80CCF4BC 00000004  C0 03 5D BC */	lfs f0, lit_4350@l(r3)
...
/* 80CCF518 00000004  4B 47 D5 94 */	b daNpcT_chkEvtBit__FUl
/* 80CCF51C 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF520 0000000C  41 82 00 24 */	beq lbl_80CCF544
/* 80CCF524 00000010  3C 60 80 CD */	lis r3, l_srcPosL@ha
/* 80CCF528 00000014  C4 03 69 44 */	lfsu f0, l_srcPosL@l(r3)
/* 80CCF52C 00000018  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF530 0000001C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF534 00000020  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF538 00000024  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
/* 80CCF53C 00000028  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80CCF540 0000002C  48 00 01 24 */	b lbl_80CCF664
lbl_80CCF544:
/* 80CCF544 00000000  3C 60 80 CD */	lis r3, l_srcPosR@ha
/* 80CCF548 00000004  C4 03 69 2C */	lfsu f0, l_srcPosR@l(r3)
/* 80CCF54C 00000008  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF550 0000000C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF554 00000010  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF558 00000014  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
...
/* 80CCF568 00000004  4B 47 D5 44 */	b daNpcT_chkEvtBit__FUl
/* 80CCF56C 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF570 0000000C  41 82 00 24 */	beq lbl_80CCF594
/* 80CCF574 00000010  3C 60 80 CD */	lis r3, l_srcPosR@ha
/* 80CCF578 00000014  C4 03 69 2C */	lfsu f0, l_srcPosR@l(r3)
/* 80CCF57C 00000018  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF580 0000001C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF584 00000020  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF588 00000024  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
/* 80CCF58C 00000028  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80CCF590 0000002C  48 00 00 D4 */	b lbl_80CCF664
lbl_80CCF594:
/* 80CCF594 00000000  3C 60 80 CD */	lis r3, l_srcPosL@ha
/* 80CCF598 00000004  C4 03 69 44 */	lfsu f0, l_srcPosL@l(r3)
/* 80CCF59C 00000008  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF5A0 0000000C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF5A4 00000010  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF5A8 00000014  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
...
/* 80CCF5B8 00000004  4B 47 D4 F4 */	b daNpcT_chkEvtBit__FUl
/* 80CCF5BC 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF5C0 0000000C  41 82 00 24 */	beq lbl_80CCF5E4
/* 80CCF5C4 00000010  3C 60 80 CD */	lis r3, l_srcPosL@ha
/* 80CCF5C8 00000014  C4 03 69 44 */	lfsu f0, l_srcPosL@l(r3)
/* 80CCF5CC 00000018  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF5D0 0000001C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF5D4 00000020  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF5D8 00000024  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
/* 80CCF5DC 00000028  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80CCF5E0 0000002C  48 00 00 84 */	b lbl_80CCF664
lbl_80CCF5E4:
/* 80CCF5E4 00000000  3C 60 80 CD */	lis r3, l_srcPosR@ha
/* 80CCF5E8 00000004  C4 03 69 2C */	lfsu f0, l_srcPosR@l(r3)
/* 80CCF5EC 00000008  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF5F0 0000000C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF5F4 00000010  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF5F8 00000014  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
...
/* 80CCF608 00000004  4B 47 D4 A4 */	b daNpcT_chkEvtBit__FUl
/* 80CCF60C 00000008  2C 03 00 00 */	cmpwi r3, 0
/* 80CCF610 0000000C  41 82 00 24 */	beq lbl_80CCF634
/* 80CCF614 00000010  3C 60 80 CD */	lis r3, l_srcPosR@ha
/* 80CCF618 00000014  C4 03 69 2C */	lfsu f0, l_srcPosR@l(r3)
/* 80CCF61C 00000018  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF620 0000001C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF624 00000020  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF628 00000024  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
/* 80CCF62C 00000028  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80CCF630 0000002C  48 00 00 34 */	b lbl_80CCF664
lbl_80CCF634:
/* 80CCF634 00000000  3C 60 80 CD */	lis r3, l_srcPosL@ha
/* 80CCF638 00000004  C4 03 69 44 */	lfsu f0, l_srcPosL@l(r3)
/* 80CCF63C 00000008  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CCF640 0000000C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80CD0004 */
/* 80CCF644 00000010  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CCF648 00000014  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80CD0008 */
...
/* 80CCF690 0000002C  4B 47 B2 78 */	b setPos__8daNpcT_cF4cXyz
/* 80CCF694 00000030  7F E3 FB 78 */	mr r3, r31
/* 80CCF698 00000034  A8 81 00 0A */	lha r4, 0xa(r1)
/* 80CCF69C 00000038  4B 47 B3 7C */	b setAngle__8daNpcT_cFs

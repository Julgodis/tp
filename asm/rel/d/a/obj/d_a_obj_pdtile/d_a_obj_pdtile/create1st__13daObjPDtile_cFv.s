...
/* 80CAACF8 00000018  3C 60 80 CB */	lis r3, lit_3680@ha
/* 80CAACFC 0000001C  3B E3 C5 0C */	addi r31, r3, lit_3680@l
/* 80CAAD00 00000020  3C 60 80 CB */	lis r3, cNullVec__6Z2Calc@ha
/* 80CAAD04 00000024  38 83 C5 9C */	addi r4, r3, cNullVec__6Z2Calc@l
...
/* 80CAAD20 00000040  80 04 00 88 */	lwz r0, 0x88(r4)	/* effective address: 80CAC624 */
/* 80CAAD24 00000044  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 80CAAD28 00000048  80 04 00 8C */	lwz r0, 0x8c(r4)	/* effective address: 80CAC628 */
/* 80CAAD2C 0000004C  90 1E 07 C0 */	stw r0, 0x7c0(r30)
/* 80CAAD30 00000050  80 04 00 90 */	lwz r0, 0x90(r4)	/* effective address: 80CAC62C */
...
/* 80CAAD40 00000060  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80CAC50C */
...
/* 80CAAD54 00000008  80 04 00 64 */	lwz r0, 0x64(r4)	/* effective address: 80CAC600 */
/* 80CAAD58 0000000C  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 80CAAD5C 00000010  80 04 00 68 */	lwz r0, 0x68(r4)	/* effective address: 80CAC604 */
/* 80CAAD60 00000014  90 1E 07 C0 */	stw r0, 0x7c0(r30)
/* 80CAAD64 00000018  80 04 00 6C */	lwz r0, 0x6c(r4)	/* effective address: 80CAC608 */
...
/* 80CAAD74 00000028  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80CAC510 */
...
/* 80CAAD88 00000008  80 04 00 20 */	lwz r0, 0x20(r4)	/* effective address: 80CAC5BC */
/* 80CAAD8C 0000000C  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 80CAAD90 00000010  80 04 00 24 */	lwz r0, 0x24(r4)	/* effective address: 80CAC5C0 */
/* 80CAAD94 00000014  90 1E 07 C0 */	stw r0, 0x7c0(r30)
/* 80CAAD98 00000018  80 04 00 2C */	lwz r0, 0x2c(r4)	/* effective address: 80CAC5C8 */
...
/* 80CAADA8 00000028  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80CAC514 */
/* 80CAADAC 0000002C  D0 1E 07 CC */	stfs f0, 0x7cc(r30)
/* 80CAADB0 00000030  48 00 00 38 */	b lbl_80CAADE8
lbl_80CAADB4:
/* 80CAADB4 00000000  80 04 00 20 */	lwz r0, 0x20(r4)	/* effective address: 80CAC5BC */
/* 80CAADB8 00000004  90 1E 07 BC */	stw r0, 0x7bc(r30)
/* 80CAADBC 00000008  38 64 00 24 */	addi r3, r4, 0x24
/* 80CAADC0 0000000C  80 03 00 04 */	lwz r0, 4(r3)	/* effective address: 80CAC5C4 */
/* 80CAADC4 00000010  90 1E 07 C0 */	stw r0, 0x7c0(r30)
/* 80CAADC8 00000014  38 64 00 2C */	addi r3, r4, 0x2c
/* 80CAADCC 00000018  80 03 00 04 */	lwz r0, 4(r3)	/* effective address: 80CAC5CC */
...
/* 80CAADE0 0000002C  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80CAC514 */
...
/* 80CAADFC 00000004  4B 38 20 C0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80CAAE24 0000002C  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80CAAE28 00000030  38 C3 5A D8 */	addi r6, r3, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
lbl_80CAAE2C:
...
/* 80CAAE40 00000014  4B 3C D9 7C */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
lbl_80CAAE54:
/* 80CAAE54 00000000  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 80CAC518 */

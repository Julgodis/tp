...
/* 80C93214  4B 6C EF BC */	b _savegpr_26
/* 80C93218  7C 7C 1B 78 */	mr r28, r3
/* 80C9321C  3C 60 80 C9 */	lis r3, l_bmd@ha
/* 80C93220  3B C3 3D 88 */	addi r30, r3, l_bmd@l
/* 80C93224  88 1C 07 02 */	lbz r0, 0x702(r28)
/* 80C93228  54 00 10 3A */	slwi r0, r0, 2
/* 80C9322C  3C 60 80 C9 */	lis r3, l_arcName@ha
/* 80C93230  38 63 3E 14 */	addi r3, r3, l_arcName@l
/* 80C93234  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C93238  38 9E 00 00 */	addi r4, r30, 0
/* 80C9323C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C93240  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C93244  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C93258  4B 3A 90 94 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9326C  4B 38 19 E8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C93290  3C 60 80 C9 */	lis r3, l_arcName@ha
/* 80C93294  38 63 3E 14 */	addi r3, r3, l_arcName@l
...
/* 80C932AC  4B 3A 90 40 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C932B0  7C 7A 1B 78 */	mr r26, r3
/* 80C932B4  38 60 00 18 */	li r3, 0x18
/* 80C932B8  4B 63 B9 94 */	b __nw__FUl
/* 80C932BC  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C932C0  41 82 00 20 */	beq lbl_80C932E0
/* 80C932C4  3C 80 80 C9 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C932C8  38 04 3E C4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C932CC  90 1B 00 00 */	stw r0, 0(r27)
/* 80C932D0  38 80 00 00 */	li r4, 0
/* 80C932D4  4B 69 51 28 */	b init__12J3DFrameCtrlFs
...
/* 80C9330C  4B 37 A4 00 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C93334  3C 60 80 C9 */	lis r3, l_arcName@ha
/* 80C93338  38 63 3E 14 */	addi r3, r3, l_arcName@l
...
/* 80C93350  4B 3A 8F 9C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C93354  7C 7A 1B 78 */	mr r26, r3
/* 80C93358  38 60 00 18 */	li r3, 0x18
/* 80C9335C  4B 63 B8 F0 */	b __nw__FUl
/* 80C93360  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C93364  41 82 00 20 */	beq lbl_80C93384
/* 80C93368  3C 80 80 C9 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9336C  38 04 3E C4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C93370  90 1B 00 00 */	stw r0, 0(r27)
/* 80C93374  38 80 00 00 */	li r4, 0
/* 80C93378  4B 69 50 84 */	b init__12J3DFrameCtrlFs
...
/* 80C933B0  4B 37 A2 8C */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C933D8  3C 60 80 C9 */	lis r3, l_arcName@ha
/* 80C933DC  38 63 3E 14 */	addi r3, r3, l_arcName@l
...
/* 80C933F4  4B 3A 8E F8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C933F8  7C 7A 1B 78 */	mr r26, r3
/* 80C933FC  38 60 00 18 */	li r3, 0x18
/* 80C93400  4B 63 B8 4C */	b __nw__FUl
/* 80C93404  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C93408  41 82 00 20 */	beq lbl_80C93428
/* 80C9340C  3C 80 80 C9 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C93410  38 04 3E C4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C93414  90 1D 00 00 */	stw r0, 0(r29)
/* 80C93418  38 80 00 00 */	li r4, 0
/* 80C9341C  4B 69 4F E0 */	b init__12J3DFrameCtrlFs
...
/* 80C93454  4B 37 A1 E8 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C93484  4B 6C ED 98 */	b _restgpr_26

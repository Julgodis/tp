...
/* 80C93AEC  4B 6C E6 E0 */	b _savegpr_25
/* 80C93AF0  7C 7E 1B 78 */	mr r30, r3
/* 80C93AF4  3C 60 80 C9 */	lis r3, l_bmd@ha
/* 80C93AF8  3B E3 3D 88 */	addi r31, r3, l_bmd@l
/* 80C93AFC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C93B00  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C93B04  38 80 00 00 */	li r4, 0
/* 80C93B08  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C93B0C  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C93B10  4B 50 FC B4 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C93B14  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C93B18  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C93B1C  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80C93B20  80 84 00 04 */	lwz r4, 4(r4)
/* 80C93B24  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C93B28  4B 51 12 78 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C93B40  4B 37 9C 68 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80C93B58  4B 37 9B 80 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80C93B70  4B 37 9B 68 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C93B74  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C93B78  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 80C93B7C  80 1C 5F 94 */	lwz r0, 0x5f94(r28)	/* effective address: 8040C154 */
/* 80C93B80  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C93B84  3B A3 4A C8 */	addi r29, r3, j3dSys@l
/* 80C93B88  90 1D 00 48 */	stw r0, 0x48(r29)	/* effective address: 80434B10 */
/* 80C93B8C  90 1D 00 4C */	stw r0, 0x4c(r29)	/* effective address: 80434B14 */
...
/* 80C93BFC  4B 3C 6E E4 */	b dKyw_get_wind_vec__Fv
...
/* 80C93C20  4B 6B 2F F8 */	b C_MTXLightPerspective
/* 80C93C24  7F 63 DB 78 */	mr r3, r27
/* 80C93C28  38 81 00 08 */	addi r4, r1, 8
/* 80C93C2C  4B 69 1B 68 */	b setEffectMtx__13J3DTexMtxInfoFPA4_f
/* 80C93C30  7F 43 D3 78 */	mr r3, r26
/* 80C93C34  38 80 00 00 */	li r4, 0
/* 80C93C38  3C A0 80 3A */	lis r5, j3dDefaultMtx@ha
/* 80C93C3C  38 A5 1E 5C */	addi r5, r5, j3dDefaultMtx@l
/* 80C93C40  4B 69 23 CC */	b simpleCalcMaterial__12J3DModelDataFUsPA4_f
lbl_80C93C44:
...
/* 80C93C5C  4B 37 A0 68 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C93C60  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C93C64  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C93C68  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80C93C6C  90 1D 00 48 */	stw r0, 0x48(r29)
/* 80C93C70  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
/* 80C93C74  90 1D 00 4C */	stw r0, 0x4c(r29)
/* 80C93C78  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80C93C7C  80 63 00 04 */	lwz r3, 4(r3)
/* 80C93C80  4B 37 A2 0C */	b mDoExt_brkAnmRemove__FP12J3DModelData
/* 80C93C84  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80C93C88  80 63 00 04 */	lwz r3, 4(r3)
/* 80C93C8C  4B 37 A1 64 */	b mDoExt_btkAnmRemove__FP12J3DModelData
/* 80C93C90  38 60 00 01 */	li r3, 1
/* 80C93C94  39 61 00 60 */	addi r11, r1, 0x60
/* 80C93C98  4B 6C E5 80 */	b _restgpr_25

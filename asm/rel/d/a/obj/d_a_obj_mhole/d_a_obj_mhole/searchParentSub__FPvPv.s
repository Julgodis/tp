...
/* 80C92E68 00000010  4B 6C F3 74 */	b _savegpr_29
/* 80C92E6C 00000014  7C 9D 23 78 */	mr r29, r4
/* 80C92E70 00000018  3C 80 80 C9 */	lis r4, l_bmd@ha
/* 80C92E74 0000001C  3B E4 3D 88 */	addi r31, r4, l_bmd@l
/* 80C92E78 00000020  7C 7E 1B 79 */	or. r30, r3, r3
/* 80C92E7C 00000024  41 82 01 20 */	beq lbl_80C92F9C
/* 80C92E80 00000028  4B 38 5E 60 */	b fopAc_IsActor__FPv
...
/* 80C92EA0 00000048  4B 6B 44 FC */	b PSVECSquareDistance
/* 80C92EA4 0000004C  C0 1F 00 30 */	lfs f0, 0x30(r31)	/* effective address: 80C93DB8 */
...
/* 80C92EB4 00000008  C8 9F 00 38 */	lfd f4, 0x38(r31)	/* effective address: 80C93DC0 */
/* 80C92EB8 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C92EBC 00000010  C8 7F 00 40 */	lfd f3, 0x40(r31)	/* effective address: 80C93DC8 */
...
lbl_80C92F04:
/* 80C92F04 00000000  C8 1F 00 48 */	lfd f0, 0x48(r31)	/* effective address: 80C93DD0 */
/* 80C92F08 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C92F0C 00000000  40 80 00 10 */	bge lbl_80C92F1C
/* 80C92F10 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C92F14 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C92F80 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C92F84 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C92F88:
/* 80C92F88 00000000  C0 1F 00 50 */	lfs f0, 0x50(r31)	/* effective address: 80C93DD8 */
...
/* 80C92FA4 00000004  4B 6C F2 84 */	b _restgpr_29

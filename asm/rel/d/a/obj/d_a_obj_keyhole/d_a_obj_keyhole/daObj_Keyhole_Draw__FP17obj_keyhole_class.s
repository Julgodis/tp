...
/* 80C4135C  4B 72 0E 70 */	b _savegpr_25
/* 80C41360  7C 7F 1B 78 */	mr r31, r3
/* 80C41364  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C41368  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C4136C  38 80 00 10 */	li r4, 0x10
/* 80C41370  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C41374  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80C41378  4B 56 24 4C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 80C41394  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C41398  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C4139C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C413A0  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C413A4  4B 56 39 FC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C413A8  80 7F 05 78 */	lwz r3, 0x578(r31)
/* 80C413AC  4B 3C C9 18 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C413B0  48 00 00 28 */	b lbl_80C413D8
lbl_80C413B4:
/* 80C413B4  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C413B8  80 83 00 04 */	lwz r4, 4(r3)
/* 80C413BC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C413C0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C413C4  80 84 00 04 */	lwz r4, 4(r4)
/* 80C413C8  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80C413CC  4B 56 39 D4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C413D0  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C413D4  4B 3C F2 AC */	b entryDL__14mDoExt_McaMorfFv
lbl_80C413D8:
/* 80C413D8  3B 60 00 00 */	li r27, 0
/* 80C413DC  3B C0 00 00 */	li r30, 0
/* 80C413E0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C413E4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C41410  4B 3E B7 58 */	b entrySimpleModel__14dComIfG_play_cFP8J3DModeli
...
/* 80C41440  4B 72 0D D8 */	b _restgpr_25

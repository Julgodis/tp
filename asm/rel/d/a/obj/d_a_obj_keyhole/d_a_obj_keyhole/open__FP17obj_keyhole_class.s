...
/* 80C42398 00000018  3C 60 80 C4 */	lis r3, lit_3655@ha
/* 80C4239C 0000001C  3B C3 39 E4 */	addi r30, r3, lit_3655@l
...
/* 80C423CC 00000004  C0 3E 00 70 */	lfs f1, 0x70(r30)	/* effective address: 80C43A54 */
/* 80C423D0 00000008  C0 5E 00 00 */	lfs f2, 0(r30)	/* effective address: 80C439E4 */
/* 80C423D4 0000000C  FC 60 10 90 */	fmr f3, f2
/* 80C423D8 00000010  4B 62 D6 64 */	b cLib_addCalc2__FPffff
/* 80C423DC 00000014  C0 3F 2A FC */	lfs f1, 0x2afc(r31)
/* 80C423E0 00000018  C0 1E 00 70 */	lfs f0, 0x70(r30)	/* effective address: 80C43A54 */
...
/* 80C42410 00000010  4B 62 E1 F8 */	b cLib_addCalcAngleS2__FPssss
...
lbl_80C4243C:
/* 80C4243C 00000000  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80C439E4 */
...
/* 80C42450 00000014  C0 3E 00 0C */	lfs f1, 0xc(r30)	/* effective address: 80C439F0 */
/* 80C42454 00000018  4B 6E 5F D8 */	b checkPass__12J3DFrameCtrlFf
/* 80C42458 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80C4245C 00000020  41 82 00 34 */	beq lbl_80C42490
/* 80C42460 00000024  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 80C439E8 */
/* 80C42464 00000028  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 80C42468 0000002C  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80C439E4 */
/* 80C4246C 00000030  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 80C42470 00000034  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C42474 00000038  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C42478 0000003C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C4248C 00000050  4B 42 D5 98 */	b StartShock__12dVibration_cFii4cXyz
lbl_80C42490:
...
/* 80C424A4 00000014  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 80C439E8 */
...
/* 80C424C0 00000008  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 80C439E8 */
/* 80C424C4 0000000C  D0 21 00 08 */	stfs f1, 8(r1)
/* 80C424C8 00000010  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80C439E4 */
/* 80C424CC 00000014  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80C424D0 00000018  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C424D4 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C424D8 00000020  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C424EC 00000034  4B 42 D5 38 */	b StartShock__12dVibration_cFii4cXyz

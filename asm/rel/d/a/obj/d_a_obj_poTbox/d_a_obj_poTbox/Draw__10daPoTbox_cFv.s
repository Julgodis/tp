...
/* 80CB4CAC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CB4CB0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CB4CB4  38 80 00 10 */	li r4, 0x10
/* 80CB4CB8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80CB4CBC  38 DF 01 0C */	addi r6, r31, 0x10c
/* 80CB4CC0  4B 4E EB 04 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CB4CC4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CB4CC8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CB4CCC  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80CB4CD0  80 84 00 04 */	lwz r4, 4(r4)
/* 80CB4CD4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CB4CD8  4B 4F 00 C8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CB4CDC  80 9F 05 AC */	lwz r4, 0x5ac(r31)
/* 80CB4CE0  28 04 00 00 */	cmplwi r4, 0
/* 80CB4CE4  41 82 00 18 */	beq lbl_80CB4CFC
/* 80CB4CE8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CB4CEC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CB4CF0  80 84 00 04 */	lwz r4, 4(r4)
/* 80CB4CF4  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CB4CF8  4B 4F 00 A8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_80CB4CFC:
/* 80CB4CFC  80 9F 05 B0 */	lwz r4, 0x5b0(r31)
/* 80CB4D00  28 04 00 00 */	cmplwi r4, 0
/* 80CB4D04  41 82 00 18 */	beq lbl_80CB4D1C
/* 80CB4D08  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CB4D0C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CB4D10  80 84 00 04 */	lwz r4, 4(r4)
/* 80CB4D14  38 BF 01 0C */	addi r5, r31, 0x10c
/* 80CB4D18  4B 4F 00 88 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_80CB4D1C:
...
/* 80CB4D44  4B 35 8C 88 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
...
/* 80CB4D5C  4B 35 89 7C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80CB4D60  C0 3F 05 FC */	lfs f1, 0x5fc(r31)
/* 80CB4D64  38 7F 05 EC */	addi r3, r31, 0x5ec
/* 80CB4D68  38 9E 00 58 */	addi r4, r30, 0x58
/* 80CB4D6C  4B 35 8A 3C */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
...
/* 80CB4D84  4B 35 8C 48 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80CB4D88:
/* 80CB4D88  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CB4D8C  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80CB4D90  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80CB4D94  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80CB4D98  3B C3 4A C8 */	addi r30, r3, j3dSys@l
/* 80CB4D9C  90 1E 00 48 */	stw r0, 0x48(r30)	/* effective address: 80434B10 */
/* 80CB4DA0  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80CB4DA4  90 1E 00 4C */	stw r0, 0x4c(r30)	/* effective address: 80434B14 */
...
/* 80CB4DB8  4B 35 8F 0C */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80CB4DCC  4B 35 8E F8 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_80CB4DD0:
/* 80CB4DD0  80 7F 05 B0 */	lwz r3, 0x5b0(r31)
/* 80CB4DD4  28 03 00 00 */	cmplwi r3, 0
/* 80CB4DD8  41 82 00 08 */	beq lbl_80CB4DE0
/* 80CB4DDC  4B 35 8E E8 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_80CB4DE0:
/* 80CB4DE0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CB4DE4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CB4DE8  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80CB4DEC  90 1E 00 48 */	stw r0, 0x48(r30)
/* 80CB4DF0  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

...
/* 80C84EF0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C84F2C  C0 64 00 08 */	lfs f3, 8(r4)	/* effective address: 80C85374 */
...
/* 80C84F74  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C84FB0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C84FB4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C84FB8  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C84FBC  3C 80 80 C8 */	lis r4, l_HIO@ha
/* 80C84FC0  38 84 53 6C */	addi r4, r4, l_HIO@l
/* 80C84FC4  88 84 00 0C */	lbz r4, 0xc(r4)	/* effective address: 80C85378 */

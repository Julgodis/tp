...
/* 80BC6DD8  3C 60 80 BC */	lis r3, l_arcName@ha
/* 80BC6DDC  38 63 7D 78 */	addi r3, r3, l_arcName@l
/* 80BC6DE0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80BC6DE4  3C 80 80 BC */	lis r4, l_bmdIdx@ha
/* 80BC6DE8  38 84 7D 18 */	addi r4, r4, l_bmdIdx@l
/* 80BC6DEC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80BC6DF0  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80BC6DF4  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80BC6E08  4B 47 54 E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BC6E18  4B 44 DE 3C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80BC6E44  3C 60 80 BC */	lis r3, l_arcName@ha
/* 80BC6E48  38 63 7D 78 */	addi r3, r3, l_arcName@l
...
/* 80BC6E5C  4B 47 54 90 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BC6E70  3C E0 80 BC */	lis r7, lit_3783@ha
/* 80BC6E74  C0 27 7D 30 */	lfs f1, lit_3783@l(r7)
/* 80BC6E78  38 E0 00 00 */	li r7, 0
/* 80BC6E7C  39 00 FF FF */	li r8, -1
/* 80BC6E80  39 20 00 00 */	li r9, 0
/* 80BC6E84  4B 44 69 58 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
/* 80BC6E88  88 1F 05 AE */	lbz r0, 0x5ae(r31)
/* 80BC6E8C  54 00 10 3A */	slwi r0, r0, 2
/* 80BC6E90  3C 60 80 BC */	lis r3, l_arcName@ha
/* 80BC6E94  38 63 7D 78 */	addi r3, r3, l_arcName@l
...
/* 80BC6EA8  4B 47 54 44 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80BC6EBC  3C E0 80 BC */	lis r7, lit_3783@ha
/* 80BC6EC0  C0 27 7D 30 */	lfs f1, lit_3783@l(r7)
/* 80BC6EC4  38 E0 00 00 */	li r7, 0
/* 80BC6EC8  39 00 FF FF */	li r8, -1
/* 80BC6ECC  39 20 00 00 */	li r9, 0
/* 80BC6ED0  4B 44 69 0C */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
lbl_80BC6ED4:

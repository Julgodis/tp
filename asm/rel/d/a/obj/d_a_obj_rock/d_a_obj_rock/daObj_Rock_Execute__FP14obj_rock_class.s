...
/* 80CBDD30  4B 6A 44 A8 */	b _savegpr_28
...
/* 80CBDD5C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBDD60  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBDD78  4B 68 8B 70 */	b PSMTXTrans
/* 80CBDD7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBDD80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBDD84  A8 9E 00 20 */	lha r4, 0x20(r30)
/* 80CBDD88  4B 34 E6 AC */	b mDoMtx_YrotM__FPA4_fs
/* 80CBDD8C  C0 3E 00 10 */	lfs f1, 0x10(r30)
/* 80CBDD90  C0 5E 00 14 */	lfs f2, 0x14(r30)
/* 80CBDD94  C0 7E 00 18 */	lfs f3, 0x18(r30)
/* 80CBDD98  4B 34 F0 A0 */	b scaleM__14mDoMtx_stack_cFfff
/* 80CBDD9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBDDA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBDDA4  80 9E 00 00 */	lwz r4, 0(r30)
/* 80CBDDA8  38 84 00 24 */	addi r4, r4, 0x24
/* 80CBDDAC  4B 68 87 04 */	b PSMTXCopy
/* 80CBDDB0  38 7E 01 48 */	addi r3, r30, 0x148
/* 80CBDDB4  38 9E 00 04 */	addi r4, r30, 4
/* 80CBDDB8  4B 5B 18 90 */	b SetC__8cM3dGSphFRC4cXyz
/* 80CBDDBC  38 7E 01 48 */	addi r3, r30, 0x148
/* 80CBDDC0  3C 80 80 CC */	lis r4, lit_3814@ha
/* 80CBDDC4  C0 24 E7 A4 */	lfs f1, lit_3814@l(r4)
/* 80CBDDC8  C0 1E 00 10 */	lfs f0, 0x10(r30)
/* 80CBDDCC  EC 21 00 32 */	fmuls f1, f1, f0
/* 80CBDDD0  4B 5B 19 38 */	b SetR__8cM3dGSphFf
lbl_80CBDDD4:
...
/* 80CBDDFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CBDE00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80CBDE14  4B 5A 6D 94 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80CBDE34  4B 6A 43 F0 */	b _restgpr_28

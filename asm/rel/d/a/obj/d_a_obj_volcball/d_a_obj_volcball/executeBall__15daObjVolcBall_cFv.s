...
/* 80D23448  4B 63 ED 84 */	b _savegpr_25
/* 80D2344C  7C 7A 1B 78 */	mr r26, r3
/* 80D23450  3C 60 80 D2 */	lis r3, l_sph_src@ha
/* 80D23454  3B E3 3D CC */	addi r31, r3, l_sph_src@l
...
/* 80D23468  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2346C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D234CC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80D234D0  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80D2350C  4B 62 3B 84 */	b PSVECAdd
...
/* 80D23530  4B 54 D2 10 */	b cLib_chaseF__FPfff
/* 80D23534  38 7C 00 2C */	addi r3, r28, 0x2c
/* 80D23538  C0 3C 00 20 */	lfs f1, 0x20(r28)
/* 80D2353C  C0 5F 00 8C */	lfs f2, 0x8c(r31)
/* 80D23540  4B 54 D2 00 */	b cLib_chaseF__FPfff
/* 80D23544  38 7C 00 30 */	addi r3, r28, 0x30
/* 80D23548  C0 3C 00 24 */	lfs f1, 0x24(r28)
/* 80D2354C  C0 5F 00 8C */	lfs f2, 0x8c(r31)
/* 80D23550  4B 54 D1 F0 */	b cLib_chaseF__FPfff
lbl_80D23554:
/* 80D23554  38 7C 00 04 */	addi r3, r28, 4
/* 80D23558  4B 2E 98 0C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D2355C  38 7C 00 34 */	addi r3, r28, 0x34
/* 80D23560  4B 2E 99 E4 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80D23564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D23568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D2356C  80 9C 00 00 */	lwz r4, 0(r28)
/* 80D23570  38 84 00 24 */	addi r4, r4, 0x24
/* 80D23574  4B 62 2F 3C */	b PSMTXCopy
...
/* 80D2359C  4B 35 35 10 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80D235C4  4B 30 9A A8 */	b dComIfGp_getReverb__Fi
...
/* 80D235D8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D235DC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D235E0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D23608  4B 58 83 7C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D23640  4B 30 9A 2C */	b dComIfGp_getReverb__Fi
...
/* 80D23654  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D23658  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2365C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D23680  4B 58 8E 8C */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D23684  48 00 00 50 */	b lbl_80D236D4
lbl_80D23688:
/* 80D23688  88 1A 04 E2 */	lbz r0, 0x4e2(r26)
/* 80D2368C  7C 03 07 74 */	extsb r3, r0
/* 80D23690  4B 30 99 DC */	b dComIfGp_getReverb__Fi
...
/* 80D236A4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D236A8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D236AC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D236D0  4B 58 8E 3C */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D236D4:
...
/* 80D23708  4B 62 3C 94 */	b PSVECSquareDistance
...
/* 80D23778  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D2377C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80D237E8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D237EC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80D23804  4B 54 3E 70 */	b cM_atan2s__Fff
...
/* 80D23824  4B 54 3E 50 */	b cM_atan2s__Fff
...
/* 80D23854  4B 63 E9 C4 */	b _restgpr_25

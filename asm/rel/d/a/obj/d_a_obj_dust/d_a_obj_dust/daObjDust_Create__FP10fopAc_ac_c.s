...
/* 80BE2844  4B 77 F9 98 */	b _savegpr_29
/* 80BE2848  3C 80 80 BE */	lis r4, lit_3673@ha
/* 80BE284C  3B E4 2F 98 */	addi r31, r4, lit_3673@l
...
/* 80BE286C  4B 49 5D B8 */	b __ct__16dBgS_MoveBgActorFv
/* 80BE2870  3C 60 80 BE */	lis r3, __vt__11daObjDust_c@ha
/* 80BE2874  38 03 30 CC */	addi r0, r3, __vt__11daObjDust_c@l
/* 80BE2878  90 1D 05 9C */	stw r0, 0x59c(r29)
/* 80BE287C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80BE2880  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80BE2884  90 1D 05 FC */	stw r0, 0x5fc(r29)
/* 80BE2888  38 7D 06 00 */	addi r3, r29, 0x600
/* 80BE288C  4B 4A 0E D4 */	b __ct__10dCcD_GSttsFv
/* 80BE2890  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80BE2894  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80BE28A8  4B 49 36 04 */	b __ct__12dBgS_AcchCirFv
/* 80BE28AC  3B BD 06 74 */	addi r29, r29, 0x674
/* 80BE28B0  7F A3 EB 78 */	mr r3, r29
/* 80BE28B4  4B 49 37 EC */	b __ct__9dBgS_AcchFv
/* 80BE28B8  3C 60 80 BE */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80BE28BC  38 63 30 A8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80BE28D8  4B 49 65 90 */	b SetObj__16dBgS_PolyPassChkFv
lbl_80BE28DC:
...
/* 80BE28EC  3C 80 80 BE */	lis r4, l_arcName@ha
/* 80BE28F0  38 84 30 54 */	addi r4, r4, l_arcName@l
/* 80BE28F4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80BE3054 */
/* 80BE28F8  4B 44 A5 C4 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80BE28FC  7C 7D 1B 78 */	mr r29, r3
/* 80BE2900  2C 1D 00 04 */	cmpwi r29, 4
/* 80BE2904  40 82 00 68 */	bne lbl_80BE296C
/* 80BE2908  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BE290C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BE2910  3C 63 00 02 */	addis r3, r3, 2
/* 80BE2914  3C 80 80 BE */	lis r4, l_arcName@ha
/* 80BE2918  38 84 30 54 */	addi r4, r4, l_arcName@l
/* 80BE291C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80BE3054 */
/* 80BE2920  3C A0 80 BE */	lis r5, stringBase0@ha
/* 80BE2924  38 A5 30 20 */	addi r5, r5, stringBase0@l
/* 80BE2928  38 A5 00 07 */	addi r5, r5, 7
/* 80BE292C  38 63 C2 F8 */	addi r3, r3, -15624
/* 80BE2930  4B 45 9D 88 */	b getObjectResName2Index__14dRes_control_cFPCcPCc
/* 80BE2934  7C 65 1B 78 */	mr r5, r3
/* 80BE2938  7F C3 F3 78 */	mr r3, r30
/* 80BE293C  3C 80 80 BE */	lis r4, l_arcName@ha
/* 80BE2940  38 84 30 54 */	addi r4, r4, l_arcName@l
/* 80BE2944  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80BE3054 */
/* 80BE2948  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80BE294C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80BE2950  38 E0 10 60 */	li r7, 0x1060
/* 80BE2954  39 00 00 00 */	li r8, 0
/* 80BE2958  4B 49 5E 64 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80BE2988  4B 43 7B C0 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80BE29B4  4B 49 38 94 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80BE29B8  38 7E 06 34 */	addi r3, r30, 0x634
/* 80BE29BC  C0 3F 00 38 */	lfs f1, 0x38(r31)
/* 80BE29C0  C0 5F 00 5C */	lfs f2, 0x5c(r31)
/* 80BE29C4  4B 49 35 94 */	b SetWall__12dBgS_AcchCirFff
/* 80BE29C8  38 7E 06 74 */	addi r3, r30, 0x674
/* 80BE29CC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80BE29D0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80BE29D4  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80BE29D8  4B 49 40 D4 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80BE29EC  4B 77 F8 3C */	b _restgpr_29

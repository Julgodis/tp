...
/* 80C12AE8  4B 74 F6 F0 */	b _savegpr_28
...
/* 80C12B04  3C 80 80 C1 */	lis r4, lit_3717@ha
/* 80C12B08  C0 24 32 C4 */	lfs f1, lit_3717@l(r4)
/* 80C12B0C  FC 40 08 90 */	fmr f2, f1
/* 80C12B10  4B 46 34 48 */	b SetWall__12dBgS_AcchCirFff
...
/* 80C12B3C  4B 46 37 0C */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80C12B50  4B 47 0D 10 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C12B54  38 7F 08 00 */	addi r3, r31, 0x800
/* 80C12B58  3C 80 80 C1 */	lis r4, mCcDCyl__14daGraveStone_c@ha
/* 80C12B5C  38 84 32 80 */	addi r4, r4, mCcDCyl__14daGraveStone_c@l
/* 80C12B60  4B 47 1D 54 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
/* 80C12B64  38 1F 07 84 */	addi r0, r31, 0x784
/* 80C12B68  90 1F 08 44 */	stw r0, 0x844(r31)
/* 80C12B6C  38 7F 05 AC */	addi r3, r31, 0x5ac
/* 80C12B70  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C12B74  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C12B78  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80C12B7C  4B 46 3F 30 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80C12C20  3C 60 80 C1 */	lis r3, lit_3717@ha
/* 80C12C24  3B A3 32 C4 */	addi r29, r3, lit_3717@l
lbl_80C12C28:
/* 80C12C28  38 7E 09 9C */	addi r3, r30, 0x99c
/* 80C12C2C  7C 7F 1A 14 */	add r3, r31, r3
/* 80C12C30  38 9F 05 AC */	addi r4, r31, 0x5ac
/* 80C12C34  C0 3D 00 00 */	lfs f1, 0(r29)	/* effective address: 80C132C4 */
/* 80C12C38  FC 40 08 90 */	fmr f2, f1
/* 80C12C3C  4B 43 E0 60 */	b init__7dPaPo_cFP9dBgS_Acchff
...
/* 80C12C7C  4B 40 78 CC */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80C12C90  4B 74 F5 94 */	b _restgpr_28

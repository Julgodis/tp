...
/* 80C8116C 00000018  3C 60 80 C8 */	lis r3, l_eye_offset@ha
/* 80C81170 0000001C  3B E3 1C 2C */	addi r31, r3, l_eye_offset@l
...
/* 80C81180 0000002C  3C 60 80 C8 */	lis r3, lit_5281@ha
/* 80C81184 00000030  38 63 1E FC */	addi r3, r3, lit_5281@l
...
/* 80C8124C 00000014  4B 5E F2 F4 */	b cLib_addCalcAngleS__FPsssss
...
/* 80C81268 00000030  C0 1F 00 84 */	lfs f0, 0x84(r31)	/* effective address: 80C81CB0 */
...
/* 80C81280 00000048  4B 3A BD EC */	b dComIfGp_getReverb__Fi
...
/* 80C81294 0000005C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C81298 00000060  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C8129C 00000064  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C812AC 00000074  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 80C81C48 */
/* 80C812B0 00000078  FC 40 08 90 */	fmr f2, f1
/* 80C812B4 0000007C  C0 7F 00 40 */	lfs f3, 0x40(r31)	/* effective address: 80C81C6C */
/* 80C812B8 00000080  FC 80 18 90 */	fmr f4, f3
/* 80C812BC 00000084  39 00 00 00 */	li r8, 0
/* 80C812C0 00000088  4B 62 A6 C4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C812EC 00000010  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 80C81C48 */
...
/* 80C8130C 00000008  C8 3F 00 20 */	lfd f1, 0x20(r31)	/* effective address: 80C81C4C */
...
/* 80C8132C 00000028  C0 1F 00 9C */	lfs f0, 0x9c(r31)	/* effective address: 80C81CC8 */
...
/* 80C81344 00000040  4B 3A BD 28 */	b dComIfGp_getReverb__Fi
...
/* 80C81358 00000054  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8135C 00000058  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C81360 0000005C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C81370 0000006C  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 80C81C48 */
/* 80C81374 00000070  FC 40 08 90 */	fmr f2, f1
/* 80C81378 00000074  C0 7F 00 40 */	lfs f3, 0x40(r31)	/* effective address: 80C81C6C */
/* 80C8137C 00000078  FC 80 18 90 */	fmr f4, f3
/* 80C81380 0000007C  39 00 00 00 */	li r8, 0
/* 80C81384 00000080  4B 62 A6 00 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C81388:
...
/* 80C8139C 00000014  C0 3F 00 28 */	lfs f1, 0x28(r31)	/* effective address: 80C81C54 */

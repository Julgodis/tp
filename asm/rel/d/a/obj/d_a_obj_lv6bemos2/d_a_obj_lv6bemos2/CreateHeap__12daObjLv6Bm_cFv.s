...
/* 80C7E774  4B 6E 3A 60 */	b _savegpr_27
/* 80C7E778  7C 7D 1B 78 */	mr r29, r3
/* 80C7E77C  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7E780  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7E784  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7E788  38 80 00 0D */	li r4, 0xd
/* 80C7E78C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C7E790  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C7E7A4  4B 3B DB 48 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C7E7B8  4B 39 64 9C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C7E7D4:
/* 80C7E7D4  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7E7D8  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7E7DC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7E7E0  38 80 00 14 */	li r4, 0x14
/* 80C7E7E4  7F C5 F3 78 */	mr r5, r30
/* 80C7E7E8  38 C0 00 80 */	li r6, 0x80
/* 80C7E7EC  4B 3B DB 00 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C7E7F0  7C 7B 1B 78 */	mr r27, r3
/* 80C7E7F4  38 60 00 18 */	li r3, 0x18
/* 80C7E7F8  4B 65 04 54 */	b __nw__FUl
/* 80C7E7FC  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C7E800  41 82 00 20 */	beq lbl_80C7E820
/* 80C7E804  3C 80 80 C8 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C7E808  38 04 1F B0 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C7E80C  90 1C 00 00 */	stw r0, 0(r28)
/* 80C7E810  38 80 00 00 */	li r4, 0
/* 80C7E814  4B 6A 9B E8 */	b init__12J3DFrameCtrlFs
...
/* 80C7E840  3D 00 80 C8 */	lis r8, lit_3855@ha
/* 80C7E844  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)
/* 80C7E848  39 00 00 00 */	li r8, 0
/* 80C7E84C  39 20 FF FF */	li r9, -1
/* 80C7E850  4B 38 EE BC */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C7E864:
/* 80C7E864  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7E868  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7E86C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7E870  38 80 00 09 */	li r4, 9
/* 80C7E874  7F C5 F3 78 */	mr r5, r30
/* 80C7E878  38 C0 00 80 */	li r6, 0x80
/* 80C7E87C  4B 3B DA 70 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C7E880  7C 7B 1B 78 */	mr r27, r3
/* 80C7E884  38 60 00 1C */	li r3, 0x1c
/* 80C7E888  4B 65 03 C4 */	b __nw__FUl
/* 80C7E88C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C7E890  41 82 00 20 */	beq lbl_80C7E8B0
/* 80C7E894  3C 80 80 C8 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C7E898  38 04 1F B0 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C7E89C  90 1C 00 00 */	stw r0, 0(r28)
/* 80C7E8A0  38 80 00 00 */	li r4, 0
/* 80C7E8A4  4B 6A 9B 58 */	b init__12J3DFrameCtrlFs
...
/* 80C7E8CC  3C E0 80 C8 */	lis r7, lit_3855@ha
/* 80C7E8D0  C0 27 1C 48 */	lfs f1, lit_3855@l(r7)
/* 80C7E8D4  38 E0 00 00 */	li r7, 0
/* 80C7E8D8  39 00 FF FF */	li r8, -1
/* 80C7E8DC  39 20 00 00 */	li r9, 0
/* 80C7E8E0  4B 38 EE FC */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_80C7E8F4:
/* 80C7E8F4  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7E8F8  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7E8FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7E900  38 80 00 10 */	li r4, 0x10
/* 80C7E904  7F C5 F3 78 */	mr r5, r30
/* 80C7E908  38 C0 00 80 */	li r6, 0x80
/* 80C7E90C  4B 3B D9 E0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C7E920  4B 39 63 34 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C7E93C:
/* 80C7E93C  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7E940  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7E944  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7E948  38 80 00 1A */	li r4, 0x1a
/* 80C7E94C  7F C5 F3 78 */	mr r5, r30
/* 80C7E950  38 C0 00 80 */	li r6, 0x80
/* 80C7E954  4B 3B D9 98 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C7E958  7C 7B 1B 78 */	mr r27, r3
/* 80C7E95C  38 60 00 18 */	li r3, 0x18
/* 80C7E960  4B 65 02 EC */	b __nw__FUl
/* 80C7E964  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C7E968  41 82 00 20 */	beq lbl_80C7E988
/* 80C7E96C  3C 80 80 C8 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C7E970  38 04 1F B0 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C7E974  90 1C 00 00 */	stw r0, 0(r28)
/* 80C7E978  38 80 00 00 */	li r4, 0
/* 80C7E97C  4B 6A 9A 80 */	b init__12J3DFrameCtrlFs
...
/* 80C7E9A8  3D 00 80 C8 */	lis r8, lit_3855@ha
/* 80C7E9AC  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)
/* 80C7E9B0  39 00 00 00 */	li r8, 0
/* 80C7E9B4  39 20 FF FF */	li r9, -1
/* 80C7E9B8  4B 38 EC 84 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C7E9D4  3C 60 80 C8 */	lis r3, lit_4012@ha
/* 80C7E9D8  C8 23 1C 4C */	lfd f1, lit_4012@l(r3)
...
/* 80C7E9F8  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7E9FC  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7EA00  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7EA04  38 80 00 19 */	li r4, 0x19
/* 80C7EA08  7F C5 F3 78 */	mr r5, r30
/* 80C7EA0C  38 C0 00 80 */	li r6, 0x80
/* 80C7EA10  4B 3B D8 DC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C7EA14  7C 7B 1B 78 */	mr r27, r3
/* 80C7EA18  38 60 00 18 */	li r3, 0x18
/* 80C7EA1C  4B 65 02 30 */	b __nw__FUl
/* 80C7EA20  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C7EA24  41 82 00 20 */	beq lbl_80C7EA44
/* 80C7EA28  3C 80 80 C8 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C7EA2C  38 04 1F B0 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C7EA30  90 1C 00 00 */	stw r0, 0(r28)
/* 80C7EA34  38 80 00 00 */	li r4, 0
/* 80C7EA38  4B 6A 99 C4 */	b init__12J3DFrameCtrlFs
...
/* 80C7EA64  3D 00 80 C8 */	lis r8, lit_3855@ha
/* 80C7EA68  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)
/* 80C7EA6C  39 00 00 00 */	li r8, 0
/* 80C7EA70  39 20 FF FF */	li r9, -1
/* 80C7EA74  4B 38 EB C8 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C7EA88:
/* 80C7EA88  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C7EA8C  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C7EA90  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C7EA94  38 80 00 0A */	li r4, 0xa
/* 80C7EA98  7F C5 F3 78 */	mr r5, r30
/* 80C7EA9C  38 C0 00 80 */	li r6, 0x80
/* 80C7EAA0  4B 3B D8 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C7EAA4  7C 7B 1B 78 */	mr r27, r3
/* 80C7EAA8  38 60 00 1C */	li r3, 0x1c
/* 80C7EAAC  4B 65 01 A0 */	b __nw__FUl
/* 80C7EAB0  7C 7E 1B 79 */	or. r30, r3, r3
/* 80C7EAB4  41 82 00 20 */	beq lbl_80C7EAD4
/* 80C7EAB8  3C 80 80 C8 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C7EABC  38 04 1F B0 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C7EAC0  90 1E 00 00 */	stw r0, 0(r30)
/* 80C7EAC4  38 80 00 00 */	li r4, 0
/* 80C7EAC8  4B 6A 99 34 */	b init__12J3DFrameCtrlFs
...
/* 80C7EAF0  3C E0 80 C8 */	lis r7, lit_3855@ha
/* 80C7EAF4  C0 27 1C 48 */	lfs f1, lit_3855@l(r7)
/* 80C7EAF8  38 E0 00 00 */	li r7, 0
/* 80C7EAFC  39 00 FF FF */	li r8, -1
/* 80C7EB00  39 20 00 00 */	li r9, 0
/* 80C7EB04  4B 38 EC D8 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C7EB20  4B 6E 37 00 */	b _restgpr_27

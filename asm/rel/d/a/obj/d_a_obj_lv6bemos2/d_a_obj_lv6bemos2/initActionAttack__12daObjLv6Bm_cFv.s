...
/* 80C80694 00000010  4B 6E 1B 38 */	b _savegpr_25
/* 80C80698 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C8069C 00000018  3C 80 80 C8 */	lis r4, l_eye_offset@ha
/* 80C806A0 0000001C  3B E4 1C 2C */	addi r31, r4, l_eye_offset@l
/* 80C806A4 00000020  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C806A8 00000024  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80C806AC 00000028  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C806B0 0000002C  4B 39 A2 B4 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80C806B4 00000030  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 80C81C54 */
/* 80C806B8 00000034  EC 01 00 28 */	fsubs f0, f1, f0
/* 80C806BC 00000038  D0 1E 0A 2C */	stfs f0, 0xa2c(r30)
/* 80C806C0 0000003C  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C806C4 00000040  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C806C8 00000044  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C806CC 00000048  38 80 00 1B */	li r4, 0x1b
/* 80C806D0 0000004C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C806D4 00000050  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C806E4 00000060  4B 3B BC 08 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C80704 00000080  C0 3F 00 28 */	lfs f1, 0x28(r31)	/* effective address: 80C81C54 */
/* 80C80708 00000084  39 00 00 00 */	li r8, 0
/* 80C8070C 00000088  39 20 FF FF */	li r9, -1
/* 80C80710 0000008C  4B 38 CF 2C */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80C80714 00000090  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 80C81C54 */
/* 80C80718 00000094  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 80C8071C 00000098  D0 03 00 10 */	stfs f0, 0x10(r3)
/* 80C80720 0000009C  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 80C81C48 */
...
/* 80C8075C 000000D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C80760 000000DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C80764 000000E0  4B 6C 5D 4C */	b PSMTXCopy
/* 80C80768 000000E4  3B 20 00 00 */	li r25, 0
/* 80C8076C 000000E8  3B A0 00 00 */	li r29, 0
/* 80C80770 000000EC  3B 80 00 00 */	li r28, 0
/* 80C80774 000000F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C80778 000000F4  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l
/* 80C8077C 000000F8  3B 7F 00 88 */	addi r27, r31, 0x88
lbl_80C80780:
/* 80C80780 00000000  80 7A 5D 3C */	lwz r3, 0x5d3c(r26)	/* effective address: 8040BEFC */
...
/* 80C807BC 0000003C  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 80C81C48 */
/* 80C807C0 00000040  4B 3C C2 D0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C807D8 00000058  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C807DC 0000005C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C807E0 00000060  38 85 00 68 */	addi r4, r5, 0x68
/* 80C807E4 00000064  38 A5 00 A4 */	addi r5, r5, 0xa4
/* 80C807E8 00000068  4B 5F FF F8 */	b func_802807E0
lbl_80C807EC:
...
/* 80C80818 0000002C  4B 6E 1A 00 */	b _restgpr_25

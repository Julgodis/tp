...
/* 80C7F2BC  4B 6E 2F 1C */	b _savegpr_28
/* 80C7F2C0  7C 7D 1B 78 */	mr r29, r3
/* 80C7F2C4  3C 80 80 C8 */	lis r4, l_eye_offset@ha
/* 80C7F2C8  3B E4 1C 2C */	addi r31, r4, l_eye_offset@l
/* 80C7F2CC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C7F2D0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C7F2D4  83 C4 5D AC */	lwz r30, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C7F2D8  7F C4 F3 78 */	mr r4, r30
/* 80C7F2DC  4B 39 B6 88 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C7F2F8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C7F2FC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C7F300  4B 6C 71 B0 */	b PSMTXCopy
/* 80C7F304  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7F308  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l
/* 80C7F30C  C0 1C 00 0C */	lfs f0, 0xc(r28)	/* effective address: 803DD47C */
/* 80C7F310  D0 1D 09 E4 */	stfs f0, 0x9e4(r29)
/* 80C7F314  C0 1C 00 1C */	lfs f0, 0x1c(r28)	/* effective address: 803DD48C */
/* 80C7F318  D0 1D 09 E8 */	stfs f0, 0x9e8(r29)
/* 80C7F31C  C0 1C 00 2C */	lfs f0, 0x2c(r28)	/* effective address: 803DD49C */
/* 80C7F320  D0 1D 09 EC */	stfs f0, 0x9ec(r29)
/* 80C7F324  38 7D 09 E4 */	addi r3, r29, 0x9e4
/* 80C7F328  4B 38 DA 3C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C7F32C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7F330  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C7F344  4B 38 D0 F0 */	b mDoMtx_YrotM__FPA4_fs
...
/* 80C7F368  4B 38 DA 6C */	b transM__14mDoMtx_stack_cFRC4cXyz
...
/* 80C7F39C  4B 38 D9 C8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C7F3A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7F3A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C7F3B8  4B 38 D0 7C */	b mDoMtx_YrotM__FPA4_fs
/* 80C7F3BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7F3C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7F3C4  38 81 00 A0 */	addi r4, r1, 0xa0
/* 80C7F3C8  38 BD 09 F8 */	addi r5, r29, 0x9f8
/* 80C7F3CC  4B 6C 79 A0 */	b PSMTXMultVec
...
/* 80C7F3F4  4B 5E 77 40 */	b __mi__4cXyzCFRC3Vec
...
/* 80C7F444  4B 6C 7F 58 */	b PSVECSquareDistance
...
/* 80C7F4B4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C7F4B8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C7F524  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C7F528  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80C7F52C  48 00 00 08 */	b lbl_80C7F534
lbl_80C7F530:
/* 80C7F530  FC 40 08 90 */	fmr f2, f1
lbl_80C7F534:
/* 80C7F534  C0 21 00 98 */	lfs f1, 0x98(r1)
/* 80C7F538  4B 5E 81 3C */	b cM_atan2s__Fff
...
/* 80C7F578  4B 5E 75 BC */	b __mi__4cXyzCFRC3Vec
...
/* 80C7F59C  4B 5E 79 AC */	b normalizeZP__4cXyzFv
...
/* 80C7F634  4B 39 E6 34 */	b lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C7F638  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C7F63C  41 82 01 08 */	beq lbl_80C7F744
/* 80C7F640  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha
/* 80C7F644  38 63 1C 48 */	addi r3, r3, mLineCheck__11fopAcM_lc_c@l
/* 80C7F648  38 83 00 30 */	addi r4, r3, 0x30
/* 80C7F64C  38 7D 09 E4 */	addi r3, r29, 0x9e4
/* 80C7F650  4B 6C 7D 4C */	b PSVECSquareDistance
...
/* 80C7F6C0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C7F6C4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C7F730  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C7F734  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C7F738:
...
/* 80C7F7A8  4B 5E F8 58 */	b Set__8cM3dGCpsFRC4cXyzRC4cXyzf
/* 80C7F7AC  38 7D 07 38 */	addi r3, r29, 0x738
/* 80C7F7B0  4B 40 50 74 */	b CalcAtVec__8dCcD_CpsFv
...
/* 80C7F7E4  4B 39 E4 84 */	b lineCheck__11fopAcM_lc_cFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C7F7E8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C7F7EC  41 82 00 6C */	beq lbl_80C7F858
/* 80C7F7F0  3C 60 80 C8 */	lis r3, __vt__8cM3dGPla@ha
/* 80C7F7F4  38 03 1F A4 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80C7F7F8  90 01 00 BC */	stw r0, 0xbc(r1)
/* 80C7F7FC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C7F800  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C7F804  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C7F808  3C 80 80 3F */	lis r4, mLineCheck__11fopAcM_lc_c@ha
/* 80C7F80C  38 84 1C 48 */	addi r4, r4, mLineCheck__11fopAcM_lc_c@l
/* 80C7F810  38 84 00 14 */	addi r4, r4, 0x14
/* 80C7F814  38 A1 00 AC */	addi r5, r1, 0xac
/* 80C7F818  4B 3F 4F 2C */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C7F81C  C0 21 00 B0 */	lfs f1, 0xb0(r1)
/* 80C7F820  4B 5E 89 C4 */	b cBgW_CheckBGround__Ff
/* 80C7F824  3C 80 80 C8 */	lis r4, __vt__8cM3dGPla@ha
/* 80C7F828  38 04 1F A4 */	addi r0, r4, __vt__8cM3dGPla@l
/* 80C7F82C  90 01 00 BC */	stw r0, 0xbc(r1)
/* 80C7F830  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C7F834  41 82 00 24 */	beq lbl_80C7F858
/* 80C7F838  3C 60 80 3F */	lis r3, mLineCheck__11fopAcM_lc_c@ha
/* 80C7F83C  38 63 1C 48 */	addi r3, r3, mLineCheck__11fopAcM_lc_c@l
/* 80C7F840  C0 03 00 30 */	lfs f0, 0x30(r3)	/* effective address: 803F1C78 */
/* 80C7F844  D0 01 00 88 */	stfs f0, 0x88(r1)
/* 80C7F848  C0 03 00 34 */	lfs f0, 0x34(r3)	/* effective address: 803F1C7C */
/* 80C7F84C  D0 01 00 8C */	stfs f0, 0x8c(r1)
/* 80C7F850  C0 03 00 38 */	lfs f0, 0x38(r3)	/* effective address: 803F1C80 */
...
/* 80C7F864  4B 5F 0F 48 */	b cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80C7F888  4B 5F 0F 24 */	b cLib_chasePos__FP4cXyzRC4cXyzf
...
/* 80C7F8A8  4B 6E 29 7C */	b _restgpr_28

...
/* 80C803F0  3C 60 80 C8 */	lis r3, l_arcName@ha
/* 80C803F4  38 63 1D 24 */	addi r3, r3, l_arcName@l
/* 80C803F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C81D24 */
/* 80C803FC  38 80 00 14 */	li r4, 0x14
/* 80C80400  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C80404  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C80408  3C A5 00 02 */	addis r5, r5, 2
/* 80C8040C  38 C0 00 80 */	li r6, 0x80
/* 80C80410  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C80414  4B 3B BE D8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C80434  3D 00 80 C8 */	lis r8, lit_3855@ha
/* 80C80438  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)
/* 80C8043C  39 00 00 00 */	li r8, 0
/* 80C80440  39 20 FF FF */	li r9, -1
/* 80C80444  4B 38 D2 C8 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80C80448  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C8044C  7C 03 07 74 */	extsb r3, r0
/* 80C80450  4B 3A CC 1C */	b dComIfGp_getReverb__Fi
...
/* 80C80464  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C80468  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C8046C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C80480  3D 00 80 C8 */	lis r8, lit_3855@ha
/* 80C80484  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)
/* 80C80488  FC 40 08 90 */	fmr f2, f1
/* 80C8048C  3D 00 80 C8 */	lis r8, lit_4276@ha
/* 80C80490  C0 68 1C 6C */	lfs f3, lit_4276@l(r8)
/* 80C80494  FC 80 18 90 */	fmr f4, f3
/* 80C80498  39 00 00 00 */	li r8, 0
/* 80C8049C  4B 62 B4 E8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C804A0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C804A4  7C 03 07 74 */	extsb r3, r0
/* 80C804A8  4B 3A CB C4 */	b dComIfGp_getReverb__Fi
...
/* 80C804BC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C804C0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C804C4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C804C8  38 81 00 08 */	addi r4, r1, 8
/* 80C804CC  7F C5 F3 78 */	mr r5, r30
/* 80C804D0  38 C0 00 00 */	li r6, 0
/* 80C804D4  3D 00 80 C8 */	lis r8, lit_3855@ha
/* 80C804D8  C0 28 1C 48 */	lfs f1, lit_3855@l(r8)
/* 80C804DC  FC 40 08 90 */	fmr f2, f1
/* 80C804E0  3D 00 80 C8 */	lis r8, lit_4276@ha
/* 80C804E4  C0 68 1C 6C */	lfs f3, lit_4276@l(r8)
/* 80C804E8  FC 80 18 90 */	fmr f4, f3
/* 80C804EC  39 00 00 00 */	li r8, 0
/* 80C804F0  4B 62 B4 94 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

...
/* 80C680B8  3C 60 80 C7 */	lis r3, l_arcName@ha
/* 80C680BC  38 63 85 2C */	addi r3, r3, l_arcName@l
/* 80C680C0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C6852C */
/* 80C680C4  88 1F 05 82 */	lbz r0, 0x582(r31)
/* 80C680C8  54 00 10 3A */	slwi r0, r0, 2
/* 80C680CC  3C 80 80 C7 */	lis r4, l_bmd@ha
/* 80C680D0  38 84 85 00 */	addi r4, r4, l_bmd@l
/* 80C680D4  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C680D8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C680DC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C680E0  3C A5 00 02 */	addis r5, r5, 2
/* 80C680E4  38 C0 00 80 */	li r6, 0x80
/* 80C680E8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C680EC  4B 3D 42 00 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C680FC  4B 3A CB 58 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

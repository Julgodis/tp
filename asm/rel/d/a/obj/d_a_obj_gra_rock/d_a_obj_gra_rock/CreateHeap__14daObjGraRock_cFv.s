...
/* 80C11B78  4B 75 06 64 */	b _savegpr_29
/* 80C11B7C  7C 7F 1B 78 */	mr r31, r3
/* 80C11B80  3C 60 80 C1 */	lis r3, l_arcName@ha
/* 80C11B84  38 63 24 9C */	addi r3, r3, l_arcName@l
/* 80C11B88  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C1249C */
/* 80C11B8C  3C 80 80 C1 */	lis r4, struct_80C12440+0x0@ha
/* 80C11B90  38 84 24 40 */	addi r4, r4, struct_80C12440+0x0@l
/* 80C11B94  38 84 00 2B */	addi r4, r4, 0x2b
/* 80C11B98  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C11B9C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C11BB0  4B 42 A7 CC */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80C11BC4  4B 40 30 90 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C11BE0:
/* 80C11BE0  3C 60 80 C1 */	lis r3, l_arcName@ha
/* 80C11BE4  38 63 24 9C */	addi r3, r3, l_arcName@l
/* 80C11BE8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C1249C */
/* 80C11BEC  3C 80 80 C1 */	lis r4, struct_80C12440+0x0@ha
/* 80C11BF0  38 84 24 40 */	addi r4, r4, struct_80C12440+0x0@l
/* 80C11BF4  38 84 00 3B */	addi r4, r4, 0x3b
/* 80C11BF8  7F A5 EB 78 */	mr r5, r29
/* 80C11BFC  38 C0 00 80 */	li r6, 0x80
/* 80C11C00  4B 42 A7 7C */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80C11C18  3D 00 80 C1 */	lis r8, lit_3860@ha
/* 80C11C1C  C0 28 24 0C */	lfs f1, lit_3860@l(r8)
/* 80C11C20  39 00 00 00 */	li r8, 0
/* 80C11C24  39 20 FF FF */	li r9, -1
/* 80C11C28  4B 3F B9 24 */	b init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
...
lbl_80C11C3C:
/* 80C11C3C  3C 60 80 C1 */	lis r3, lit_3860@ha
/* 80C11C40  C0 03 24 0C */	lfs f0, lit_3860@l(r3)
/* 80C11C44  D0 1F 05 D8 */	stfs f0, 0x5d8(r31)
/* 80C11C48  38 60 00 01 */	li r3, 1
lbl_80C11C4C:
/* 80C11C4C  39 61 00 20 */	addi r11, r1, 0x20
/* 80C11C50  4B 75 05 D8 */	b _restgpr_29

...
/* 80C69C38  4B 6F 85 A0 */	b _savegpr_28
/* 80C69C3C  7C 7C 1B 78 */	mr r28, r3
/* 80C69C40  3C 60 80 C7 */	lis r3, l_arcName@ha
/* 80C69C44  38 63 A4 00 */	addi r3, r3, l_arcName@l
/* 80C69C48  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C6A400 */
/* 80C69C4C  38 80 00 05 */	li r4, 5
/* 80C69C50  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C69C54  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C69C68  4B 3D 26 84 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C69C7C  4B 3A AF D8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C69C98:
/* 80C69C98  3C 60 80 C7 */	lis r3, l_arcName@ha
/* 80C69C9C  38 63 A4 00 */	addi r3, r3, l_arcName@l
/* 80C69CA0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C6A400 */
/* 80C69CA4  38 80 00 08 */	li r4, 8
/* 80C69CA8  7F E5 FB 78 */	mr r5, r31
/* 80C69CAC  38 C0 00 80 */	li r6, 0x80
/* 80C69CB0  4B 3D 26 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C69CB4  7C 7D 1B 78 */	mr r29, r3
/* 80C69CB8  38 60 00 18 */	li r3, 0x18
/* 80C69CBC  4B 66 4F 90 */	b __nw__FUl
/* 80C69CC0  7C 7F 1B 79 */	or. r31, r3, r3
/* 80C69CC4  41 82 00 20 */	beq lbl_80C69CE4
/* 80C69CC8  3C 80 80 C7 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C69CCC  38 04 A4 B4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C69CD0  90 1F 00 00 */	stw r0, 0(r31)
/* 80C69CD4  38 80 00 00 */	li r4, 0
/* 80C69CD8  4B 6B E7 24 */	b init__12J3DFrameCtrlFs
...
/* 80C69D04  3D 00 80 C7 */	lis r8, lit_3710@ha
/* 80C69D08  C0 28 A3 C0 */	lfs f1, lit_3710@l(r8)
/* 80C69D0C  39 00 00 00 */	li r8, 0
/* 80C69D10  39 20 FF FF */	li r9, -1
/* 80C69D14  4B 3A 39 28 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80C69D30  4B 6F 84 F4 */	b _restgpr_28

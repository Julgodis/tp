...
/* 80BA1F0C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BA1F10  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BA1F14  38 80 00 04 */	li r4, 4
/* 80BA1F18  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80BA1F1C  7C 05 07 74 */	extsb r5, r0
/* 80BA1F20  4B 49 34 40 */	b isSwitch__10dSv_info_cCFii
/* 80BA1F24  2C 03 00 00 */	cmpwi r3, 0
/* 80BA1F28  40 82 00 38 */	bne lbl_80BA1F60
/* 80BA1F2C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BA1F30  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80BA1F34  80 A4 5D AC */	lwz r5, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 80BA1F48  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80BA1F4C  38 00 00 19 */	li r0, 0x19
/* 80BA1F50  90 04 06 14 */	stw r0, 0x614(r4)	/* effective address: 804067D4 */
/* 80BA1F54  90 64 06 0C */	stw r3, 0x60c(r4)	/* effective address: 804067CC */
/* 80BA1F58  90 64 06 10 */	stw r3, 0x610(r4)	/* effective address: 804067D0 */
/* 80BA1F5C  B0 64 06 0A */	sth r3, 0x60a(r4)	/* effective address: 804067CA */
lbl_80BA1F60:

...
/* 80CE5EE8  C0 1E 00 30 */	lfs f0, 0x30(r30)	/* effective address: 80CE6960 */
...
/* 80CE5F20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CE5F24  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CE5F28  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80CE5F2C  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80CE5F50  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80CE6A54 */
/* 80CE5F54  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80CE6A58 */
/* 80CE5F58  90 61 00 08 */	stw r3, 8(r1)
/* 80CE5F5C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80CE5F60  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80CE6A5C */
...
/* 80CE5F94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CE5F98  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80CE5FB8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CE5FBC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l

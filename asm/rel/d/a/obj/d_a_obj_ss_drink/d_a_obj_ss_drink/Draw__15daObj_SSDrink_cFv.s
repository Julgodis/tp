...
/* 80CE5870 00000018  3C 80 80 CE */	lis r4, mCcDObjInfo__15daObj_SSDrink_c@ha
/* 80CE5874 0000001C  3B E4 69 30 */	addi r31, r4, mCcDObjInfo__15daObj_SSDrink_c@l
/* 80CE5878 00000020  3C 80 80 CE */	lis r4, lit_4063@ha
/* 80CE587C 00000024  38 A4 6A 3C */	addi r5, r4, lit_4063@l
/* 80CE5880 00000028  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80CE6A3C */
/* 80CE5884 0000002C  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80CE6A40 */
/* 80CE5888 00000030  90 81 00 08 */	stw r4, 8(r1)
/* 80CE588C 00000034  90 01 00 0C */	stw r0, 0xc(r1)
/* 80CE5890 00000038  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80CE6A44 */
...
lbl_80CE58B0:
/* 80CE58B0 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CE58B4 00000004  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80CE58C4 00000014  4B 4B DF 00 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CE58C8 00000018  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CE58CC 0000001C  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80CE58DC 0000002C  4B 4B F4 C4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80CE58EC 0000003C  4B 33 7B 40 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
...
/* 80CE58FC 0000004C  4B 32 83 C8 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80CE5900 00000050  C0 3F 00 34 */	lfs f1, 0x34(r31)	/* effective address: 80CE6964 */
...
/* 80CE5910 00000060  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CE5914 00000064  38 03 6A F8 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CE5918 00000068  90 01 00 24 */	stw r0, 0x24(r1)
/* 80CE591C 0000006C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CE5920 00000070  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CE5930 00000080  4B 38 EE 14 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80CE5934 00000084  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CE5938 00000088  41 82 00 34 */	beq lbl_80CE596C
/* 80CE593C 0000008C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CE5940 00000090  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CE5950 000000A0  C0 5F 00 38 */	lfs f2, 0x38(r31)	/* effective address: 80CE6968 */
/* 80CE5954 000000A4  38 A1 00 14 */	addi r5, r1, 0x14
/* 80CE5958 000000A8  38 C0 00 00 */	li r6, 0
/* 80CE595C 000000AC  C0 7F 00 30 */	lfs f3, 0x30(r31)	/* effective address: 80CE6960 */
/* 80CE5960 000000B0  3C E0 80 42 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80CE5964 000000B4  38 E7 48 D0 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80CE5968 000000B8  4B 37 06 1C */	b setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80CE596C:
/* 80CE596C 00000000  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CE5970 00000004  38 03 6A F8 */	addi r0, r3, __vt__8cM3dGPla@l

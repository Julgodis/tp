...
/* 80CE5870  3C 80 80 CE */	lis r4, mCcDObjInfo__15daObj_SSDrink_c@ha
...
lbl_80CE58B0:
/* 80CE58B0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CE58B4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CE58B8  38 80 00 00 */	li r4, 0
/* 80CE58BC  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80CE58C0  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80CE58C4  4B 4B DF 00 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80CE58C8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80CE58CC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80CE58D0  80 9E 05 8C */	lwz r4, 0x58c(r30)
/* 80CE58D4  80 84 00 04 */	lwz r4, 4(r4)
/* 80CE58D8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80CE58DC  4B 4B F4 C4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80CE58E0  80 7E 05 8C */	lwz r3, 0x58c(r30)
/* 80CE58E4  80 83 00 04 */	lwz r4, 4(r3)
/* 80CE58E8  7F C3 F3 78 */	mr r3, r30
/* 80CE58EC  4B 33 7B 40 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
...
/* 80CE58FC  4B 32 83 C8 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80CE5960  3C E0 80 42 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80CE5964  38 E7 48 D0 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80CE5968  4B 37 06 1C */	b setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80CE596C:
/* 80CE596C  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CE5970  38 03 6A F8 */	addi r0, r3, __vt__8cM3dGPla@l

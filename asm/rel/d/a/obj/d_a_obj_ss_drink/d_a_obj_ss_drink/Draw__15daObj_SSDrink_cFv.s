...
/* 80CE5870 00000018  3C 80 00 00 */	lis r4, mCcDObjInfo__15daObj_SSDrink_c@ha
/* 80CE5874 0000001C  3B E4 00 00 */	addi r31, r4, mCcDObjInfo__15daObj_SSDrink_c@l
/* 80CE5878 00000020  3C 80 00 00 */	lis r4, lit_4063@ha
/* 80CE587C 00000024  38 A4 00 00 */	addi r5, r4, lit_4063@l
...
lbl_80CE58B0:
/* 80CE58B0 00000000  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CE58B4 00000004  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80CE58C8 00000018  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CE58CC 0000001C  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80CE5910 00000060  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CE5914 00000064  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CE5918 00000068  90 01 00 24 */	stw r0, 0x24(r1)
/* 80CE591C 0000006C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CE5920 00000070  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CE593C 0000008C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CE5940 00000090  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CE5960 000000B0  3C E0 00 00 */	lis r7, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80CE5964 000000B4  38 E7 00 00 */	addi r7, r7, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80CE5968 000000B8  4B FF F5 F1 */	bl setSimple__21dDlst_shadowControl_cFP4cXyzffP4cXyzsfP9_GXTexObj
lbl_80CE596C:
/* 80CE596C 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80CE5970 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l

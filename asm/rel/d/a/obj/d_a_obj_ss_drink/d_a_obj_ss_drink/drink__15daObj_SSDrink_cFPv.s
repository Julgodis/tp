...
lbl_80CE6560:
/* 80CE6560  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CE6564  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CE6568  83 E3 5D AC */	lwz r31, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80CE6588  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CE658C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CE6590  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80CE6594  4B 35 BE D4 */	b reset__14dEvt_control_cFv
/* 80CE6598  3C 60 80 CE */	lis r3, lit_4432@ha
/* 80CE659C  38 83 6A 9C */	addi r4, r3, lit_4432@l
/* 80CE65A0  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80CE6A9C */
/* 80CE65A4  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80CE6AA0 */
/* 80CE65A8  90 61 00 14 */	stw r3, 0x14(r1)
/* 80CE65AC  90 01 00 18 */	stw r0, 0x18(r1)
/* 80CE65B0  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80CE6AA4 */

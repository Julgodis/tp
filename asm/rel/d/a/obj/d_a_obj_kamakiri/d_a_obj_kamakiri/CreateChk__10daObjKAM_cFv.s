...
/* 80C37934 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C37938 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C3793C 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C37940 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C37944 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C384E4 */
/* 80C37948 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4) /* 80C384E4 */
/* 80C3794C 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C37950 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C37954 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80C3796C 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C384E4 */
/* 80C37970 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C384E4 */
/* 80C37974 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C37978 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C3797C 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C37980 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
lbl_80C3799C:
/* 80C3799C 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C384FC */
/* 80C379A0 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C384FC */
/* 80C379A4 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80C379A8 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C379AC 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C379C0 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C379C4 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C379D8 0000003C  3C 60 00 00 */	lis r3, l_kam_itemno@ha /* 80C384BC */
/* 80C379DC 00000040  38 63 00 00 */	addi r3, r3, l_kam_itemno@l /* 80C384BC */
...
/* 80C37A04 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C37A08 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C37A0C 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C37A10 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C37A14 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C384E4 */
/* 80C37A18 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C384E4 */
/* 80C37A1C 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C37A20 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C37A24 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C37A28 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80C37A48 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C37A4C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C37A50 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C37A54 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C37A58 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C384E4 */
/* 80C37A5C 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C384E4 */
/* 80C37A60 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C37A64 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C37A68 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C37A6C 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

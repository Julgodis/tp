...
/* 80C37934 00000014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C37938 00000018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C3793C 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C37940 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C37944 00000024  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C37948 00000028  A0 04 84 E4 */	lhz r0, l_musiya_num@l(r4)
/* 80C3794C 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C37950 00000030  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C37954 00000034  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C37958 00000038  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3795C 0000003C  4B 3F D0 60 */	b isEventBit__11dSv_event_cCFUs
...
/* 80C3796C 0000004C  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C37970 00000050  38 84 84 E4 */	addi r4, r4, l_musiya_num@l
/* 80C37974 00000054  A0 04 00 02 */	lhz r0, 2(r4)	/* effective address: 80C384E6 */
/* 80C37978 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C3797C 0000005C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C37980 00000060  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C37984 00000064  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C37988 00000068  4B 3F D0 34 */	b isEventBit__11dSv_event_cCFUs
...
lbl_80C3799C:
/* 80C3799C 00000000  3C 60 80 C4 */	lis r3, stringBase0@ha
/* 80C379A0 00000004  38 63 84 FC */	addi r3, r3, stringBase0@l
/* 80C379A4 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80C379A8 0000000C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C379AC 00000010  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80C379B0 00000014  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C379B4 00000018  4B 73 0F E0 */	b strcmp
/* 80C379B8 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80C379BC 00000020  40 82 00 CC */	bne lbl_80C37A88
/* 80C379C0 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C379C4 00000028  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C379C8 0000002C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80C379CC 00000030  2C 00 00 03 */	cmpwi r0, 3
/* 80C379D0 00000034  40 82 00 B8 */	bne lbl_80C37A88
/* 80C379D4 00000038  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80C379D8 0000003C  3C 60 80 C4 */	lis r3, l_kam_itemno@ha
/* 80C379DC 00000040  38 63 84 BC */	addi r3, r3, l_kam_itemno@l
/* 80C379E0 00000044  7C 63 00 AE */	lbzx r3, r3, r0
/* 80C379E4 00000048  4B 5A 25 58 */	b isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
lbl_80C379F8:
/* 80C379F8 00000000  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80C379FC 00000004  28 00 00 00 */	cmplwi r0, 0
/* 80C37A00 00000008  40 82 00 3C */	bne lbl_80C37A3C
/* 80C37A04 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C37A08 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C37A0C 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C37A10 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C37A14 0000001C  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C37A18 00000020  38 84 84 E4 */	addi r4, r4, l_musiya_num@l
/* 80C37A1C 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C37A20 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C37A24 0000002C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C37A28 00000030  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C37A2C 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C37A30 00000038  4B 3F CF 8C */	b isEventBit__11dSv_event_cCFUs
/* 80C37A34 0000003C  2C 03 00 00 */	cmpwi r3, 0
/* 80C37A38 00000040  41 82 00 48 */	beq lbl_80C37A80
lbl_80C37A3C:
/* 80C37A3C 00000000  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80C37A40 00000004  28 00 00 01 */	cmplwi r0, 1
/* 80C37A44 00000008  40 82 00 44 */	bne lbl_80C37A88
/* 80C37A48 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C37A4C 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C37A50 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C37A54 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C37A58 0000001C  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C37A5C 00000020  38 84 84 E4 */	addi r4, r4, l_musiya_num@l
/* 80C37A60 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C37A64 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C37A68 0000002C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C37A6C 00000030  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C37A70 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C37A74 00000038  4B 3F CF 48 */	b isEventBit__11dSv_event_cCFUs

...
/* 80C35BFC 00000018  3C 60 80 C4 */	lis r3, lit_3775@ha
/* 80C35C00 0000001C  3B E3 84 08 */	addi r31, r3, lit_3775@l
...
/* 80C35C1C 00000038  C0 1F 00 50 */	lfs f0, 0x50(r31)	/* effective address: 80C38458 */
...
/* 80C35C3C 00000058  4B 3D 72 D0 */	b ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80C35C40 0000005C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C35C44 00000060  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C35C48 00000064  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80C35C4C 00000068  4B 3D 67 E8 */	b mDoMtx_YrotM__FPA4_fs
/* 80C35C50 0000006C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C35C54 00000070  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C35C58 00000074  38 81 00 14 */	addi r4, r1, 0x14
/* 80C35C5C 00000078  38 A1 00 08 */	addi r5, r1, 8
/* 80C35C60 0000007C  4B 71 11 0C */	b PSMTXMultVec
...
/* 80C35C9C 000000B8  C0 5F 00 80 */	lfs f2, 0x80(r31)	/* effective address: 80C38488 */
/* 80C35CA0 000000BC  C0 7F 00 84 */	lfs f3, 0x84(r31)	/* effective address: 80C3848C */
/* 80C35CA4 000000C0  4B 63 9D 98 */	b cLib_addCalc2__FPffff
/* 80C35CA8 000000C4  38 7E 04 FC */	addi r3, r30, 0x4fc
/* 80C35CAC 000000C8  C0 3E 09 8C */	lfs f1, 0x98c(r30)
/* 80C35CB0 000000CC  C0 5F 00 88 */	lfs f2, 0x88(r31)	/* effective address: 80C38490 */
/* 80C35CB4 000000D0  C0 7F 00 8C */	lfs f3, 0x8c(r31)	/* effective address: 80C38494 */
/* 80C35CB8 000000D4  4B 63 9D 84 */	b cLib_addCalc2__FPffff
...
/* 80C35CCC 000000E8  4B 63 A9 3C */	b cLib_addCalcAngleS2__FPssss

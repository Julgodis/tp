...
/* 80C36CE0 0000000C  3C 60 00 00 */	lis r3, lit_3775@ha /* 80C38408 */
/* 80C36CE4 00000010  3B E3 00 00 */	addi r31, r3, lit_3775@l /* 80C38408 */
...
/* 80C36D00 0000002C  C0 1F 00 48 */	lfs f0, 0x48(r31)
...
/* 80C36D14 00000040  4B FF E3 E5 */	bl mDoLib_project__FP3VecP3Vec
/* 80C36D18 00000044  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C36D1C 00000048  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C36D20 0000004C  80 63 5D 74 */	lwz r3, 0x5d74(r3)
...
lbl_80C36D34:
/* 80C36D34 00000000  C0 7F 00 50 */	lfs f3, 0x50(r31)
lbl_80C36D38:
/* 80C36D38 00000000  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80C36D3C 00000004  C0 1F 00 50 */	lfs f0, 0x50(r31)
/* 80C36D40 00000008  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C36D44 00000000  40 81 00 5C */	ble lbl_80C36DA0
/* 80C36D48 00000004  C0 1F 00 BC */	lfs f0, 0xbc(r31)
...
/* 80C36D60 00000004  C0 1F 00 C0 */	lfs f0, 0xc0(r31)
...
/* 80C36D70 00000004  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C36D74 00000008  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C36D9C 00000030  4B FF E3 5D */	bl newData__13dDlst_peekZ_cFssPUl
lbl_80C36DA0:
/* 80C36DA0 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C36DA4 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C36DA8 00000008  80 63 61 B0 */	lwz r3, 0x61b0(r3)
/* 80C36DAC 0000000C  C3 E3 00 C8 */	lfs f31, 0xc8(r3)
/* 80C36DB0 00000010  C3 C3 00 CC */	lfs f30, 0xcc(r3)
/* 80C36DB4 00000014  38 61 00 08 */	addi r3, r1, 8
/* 80C36DB8 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 80C36DBC 0000001C  4B FF E3 3D */	bl mDoLib_pos2camera__FP3VecP3Vec
/* 80C36DC0 00000020  C0 21 00 1C */	lfs f1, 0x1c(r1)
/* 80C36DC4 00000024  C0 1F 00 5C */	lfs f0, 0x5c(r31)
/* 80C36DC8 00000028  EC 21 00 2A */	fadds f1, f1, f0
/* 80C36DCC 0000002C  D0 21 00 1C */	stfs f1, 0x1c(r1)
/* 80C36DD0 00000030  C0 1F 00 50 */	lfs f0, 0x50(r31)
...
lbl_80C36DE0:
/* 80C36DE0 00000000  C0 7F 00 C4 */	lfs f3, 0xc4(r31)
/* 80C36DE4 00000004  C0 5F 00 4C */	lfs f2, 0x4c(r31)

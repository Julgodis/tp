...
/* 80C35D10 0000000C  3C 60 00 00 */	lis r3, lit_3775@ha
/* 80C35D14 00000010  3B C3 00 00 */	addi r30, r3, lit_3775@l
...
/* 80C35D84 00000080  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C35D88 00000084  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C35D8C 00000088  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 80C35D90 0000008C  4B FF F3 69 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C35D94 00000090  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C35D98 00000094  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C35DA8 000000A4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C35DAC 000000A8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C35DD0 000000CC  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C35DD4 000000D0  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C35DF8 000000F4  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C35DFC 000000F8  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C35EC0 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C35EC4 00000008  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C35F30 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C35F34 0000000C  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C35FEC 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C35FF0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80C3605C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C36060 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80C36064:
...
lbl_80C360C8:
/* 80C360C8 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C360CC 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l

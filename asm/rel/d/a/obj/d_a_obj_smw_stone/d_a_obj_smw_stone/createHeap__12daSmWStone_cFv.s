...
/* 80CDEC1C  3C 60 80 CE */	lis r3, l_arcName@ha
/* 80CDEC20  38 63 EF 1C */	addi r3, r3, l_arcName@l
/* 80CDEC24  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80CDEF1C */
/* 80CDEC28  38 80 00 04 */	li r4, 4
/* 80CDEC2C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CDEC30  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80CDEC44  4B 35 D6 A8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CDEC54  4B 33 60 00 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80CDECA0:
/* 80CDECA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDECA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CDECA8  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CDECAC  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CDECB0  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CDECB4  4B 66 7C 34 */	b PSMTXTrans
/* 80CDECB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDECBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CDECC0  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80CDECC4  4B 32 D7 70 */	b mDoMtx_YrotM__FPA4_fs
/* 80CDECC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CDECCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CDECD0  38 9F 05 8C */	addi r4, r31, 0x58c
/* 80CDECD4  4B 66 77 DC */	b PSMTXCopy
/* 80CDECD8  3C 60 80 CE */	lis r3, l_arcName@ha
/* 80CDECDC  38 63 EF 1C */	addi r3, r3, l_arcName@l
/* 80CDECE0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80CDEF1C */
/* 80CDECE4  38 80 00 07 */	li r4, 7
/* 80CDECE8  7F C5 F3 78 */	mr r5, r30
/* 80CDECEC  38 C0 00 80 */	li r6, 0x80
/* 80CDECF0  4B 35 D5 FC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CDED04  4B 39 B2 34 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f

...
/* 80BFDB0C 00000018  3C 60 80 C0 */	lis r3, lit_3627@ha
/* 80BFDB10 0000001C  3B E3 DF E8 */	addi r31, r3, lit_3627@l
/* 80BFDB14 00000020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BFDB18 00000024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80BFDB28 00000034  4B 40 E6 E0 */	b mDoMtx_ZXYrotS__FPA4_fsss
/* 80BFDB2C 00000038  C0 1E 05 B0 */	lfs f0, 0x5b0(r30)
/* 80BFDB30 0000003C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80BFDB34 00000040  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80BFDFEC */
/* 80BFDB38 00000044  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80BFDB3C 00000048  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80BFDB40 0000004C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BFDB44 00000050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BFDB48 00000054  38 81 00 0C */	addi r4, r1, 0xc
/* 80BFDB4C 00000058  7C 85 23 78 */	mr r5, r4
/* 80BFDB50 0000005C  4B 74 92 1C */	b PSMTXMultVec
...
/* 80BFDB60 0000006C  4B 74 95 30 */	b PSVECAdd
/* 80BFDB64 00000070  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80BFDB68 00000074  7C 03 07 74 */	extsb r3, r0
/* 80BFDB6C 00000078  4B 42 F5 00 */	b dComIfGp_getReverb__Fi
...
/* 80BFDB80 0000008C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BFDB84 00000090  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BFDB88 00000094  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BFDB98 000000A4  C0 3F 00 10 */	lfs f1, 0x10(r31)	/* effective address: 80BFDFF8 */
/* 80BFDB9C 000000A8  FC 40 08 90 */	fmr f2, f1
/* 80BFDBA0 000000AC  C0 7F 00 14 */	lfs f3, 0x14(r31)	/* effective address: 80BFDFFC */
/* 80BFDBA4 000000B0  FC 80 18 90 */	fmr f4, f3
/* 80BFDBA8 000000B4  39 00 00 00 */	li r8, 0
/* 80BFDBAC 000000B8  4B 6A E9 60 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80BFDBB0 000000BC  38 7E 05 B4 */	addi r3, r30, 0x5b4
/* 80BFDBB4 000000C0  C0 3E 05 B0 */	lfs f1, 0x5b0(r30)
/* 80BFDBB8 000000C4  C0 5F 00 18 */	lfs f2, 0x18(r31)	/* effective address: 80BFE000 */
/* 80BFDBBC 000000C8  3C 80 80 C0 */	lis r4, l_HIO@ha
/* 80BFDBC0 000000CC  38 84 E1 1C */	addi r4, r4, l_HIO@l
/* 80BFDBC4 000000D0  C0 64 00 04 */	lfs f3, 4(r4)	/* effective address: 80BFE120 */
/* 80BFDBC8 000000D4  C0 9F 00 1C */	lfs f4, 0x1c(r31)	/* effective address: 80BFE004 */
/* 80BFDBCC 000000D8  4B 67 1D B0 */	b cLib_addCalc__FPfffff
/* 80BFDBD0 000000DC  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80BFDFEC */

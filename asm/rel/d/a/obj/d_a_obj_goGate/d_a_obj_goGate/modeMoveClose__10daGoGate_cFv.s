...
/* 80BFDC28  3C 60 80 C0 */	lis r3, lit_3627@ha
/* 80BFDC2C  3B E3 DF E8 */	addi r31, r3, lit_3627@l
/* 80BFDC30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BFDC34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BFDC38  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80BFDC3C  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80BFDC40  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80BFDC44  4B 40 E5 C4 */	b mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80BFDC9C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BFDCA0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BFDCA4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BFDCC8  4B 6A E8 44 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80BFDCCC  38 7E 05 B4 */	addi r3, r30, 0x5b4
/* 80BFDCD0  C0 3F 00 04 */	lfs f1, 4(r31)
/* 80BFDCD4  C0 5F 00 18 */	lfs f2, 0x18(r31)
/* 80BFDCD8  3C 80 80 C0 */	lis r4, l_HIO@ha
/* 80BFDCDC  38 84 E1 1C */	addi r4, r4, l_HIO@l
/* 80BFDCE0  C0 64 00 04 */	lfs f3, 4(r4)	/* effective address: 80BFE120 */
/* 80BFDCE4  C0 9F 00 1C */	lfs f4, 0x1c(r31)
/* 80BFDCE8  4B 67 1C 94 */	b cLib_addCalc__FPfffff

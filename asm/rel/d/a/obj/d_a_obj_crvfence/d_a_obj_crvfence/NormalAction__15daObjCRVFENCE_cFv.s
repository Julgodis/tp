...
/* 80BCF414  4B 79 2D C8 */	b _savegpr_29
/* 80BCF418  7C 7E 1B 78 */	mr r30, r3
/* 80BCF41C  3C 60 80 BD */	lis r3, lit_3685@ha
/* 80BCF420  3B E3 01 88 */	addi r31, r3, lit_3685@l
/* 80BCF424  88 1E 05 F4 */	lbz r0, 0x5f4(r30)
/* 80BCF428  28 00 00 00 */	cmplwi r0, 0
/* 80BCF42C  40 82 03 98 */	bne lbl_80BCF7C4
/* 80BCF430  3C 60 80 BD */	lis r3, s_obj_sub__FPvPv@ha
/* 80BCF434  38 63 F3 90 */	addi r3, r3, s_obj_sub__FPvPv@l
/* 80BCF438  7F C4 F3 78 */	mr r4, r30
/* 80BCF43C  4B 45 1E FC */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 80BCF468  4B 45 DC 04 */	b dComIfGp_getReverb__Fi
...
/* 80BCF47C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BCF480  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BCF484  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BCF4A8  4B 6D C4 DC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80BCF4D0  4B 77 70 E0 */	b PSMTXInverse
/* 80BCF4D4  38 61 00 74 */	addi r3, r1, 0x74
/* 80BCF4D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80BCF4DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80BCF4E0  4B 77 6F D0 */	b PSMTXCopy
/* 80BCF4E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BCF4E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BCF4EC  38 81 00 68 */	addi r4, r1, 0x68
/* 80BCF4F0  7C 85 23 78 */	mr r5, r4
/* 80BCF4F4  4B 77 78 78 */	b PSMTXMultVec
...
/* 80BCF54C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BCF550  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BCF564  4B 4A 04 C0 */	b StartShock__12dVibration_cFii4cXyz
...
/* 80BCF698  4B 69 7D 5C */	b __ct__5csXyzFsss
/* 80BCF69C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BCF6A0  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80BCF6A4  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80BCF6E8  4B 47 D3 A8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BCF730  4B 47 D3 60 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BCF778  4B 47 D3 18 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80BCF7C0  4B 47 D2 D0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_80BCF7C4:
/* 80BCF7C4  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80BCF7C8  4B 79 2A 60 */	b _restgpr_29

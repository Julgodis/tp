...
/* 80C89790  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C89794  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C89798  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C8979C  7F E5 FB 78 */	mr r5, r31
/* 80C897A0  4B 3E B2 68 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80C897A4:
/* 80C897A4  3C 60 80 C9 */	lis r3, lit_3661@ha
/* 80C897A8  C0 03 9F A4 */	lfs f0, lit_3661@l(r3)
/* 80C897AC  D0 1F 05 B8 */	stfs f0, 0x5b8(r31)
/* 80C897B0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C897B4  7C 03 07 74 */	extsb r3, r0
/* 80C897B8  4B 3A 38 B4 */	b dComIfGp_getReverb__Fi
...
/* 80C897CC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C897D0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C897D4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C897D8  38 81 00 08 */	addi r4, r1, 8
/* 80C897DC  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C897E0  38 C0 00 00 */	li r6, 0
/* 80C897E4  3D 00 80 C9 */	lis r8, lit_3661@ha
/* 80C897E8  C0 28 9F A4 */	lfs f1, lit_3661@l(r8)
/* 80C897EC  FC 40 08 90 */	fmr f2, f1
/* 80C897F0  3D 00 80 C9 */	lis r8, lit_3896@ha
/* 80C897F4  C0 68 9F C8 */	lfs f3, lit_3896@l(r8)
/* 80C897F8  FC 80 18 90 */	fmr f4, f3
/* 80C897FC  39 00 00 00 */	li r8, 0
/* 80C89800  4B 62 21 84 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

...
/* 80C89910  4B 38 3B 18 */	b play__14mDoExt_baseAnmFv
/* 80C89914  7C 7E 1B 78 */	mr r30, r3
/* 80C89918  C0 7F 05 BC */	lfs f3, 0x5bc(r31)
/* 80C8991C  3C 60 80 C9 */	lis r3, lit_4110@ha
/* 80C89920  C0 43 9F F4 */	lfs f2, lit_4110@l(r3)
/* 80C89924  A8 1F 05 B2 */	lha r0, 0x5b2(r31)
/* 80C89928  3C 60 80 C9 */	lis r3, lit_3770@ha
/* 80C8992C  C8 23 9F B8 */	lfd f1, lit_3770@l(r3)
...
/* 80C89948  3C 60 80 C9 */	lis r3, lit_3661@ha
/* 80C8994C  C0 03 9F A4 */	lfs f0, lit_3661@l(r3)
...
/* 80C89970  4B 5D E8 64 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C89974  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C89978  41 82 00 18 */	beq lbl_80C89990
/* 80C8997C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C89980  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C89984  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C89988  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80C8998C  4B 3E A8 C4 */	b Release__4cBgSFP9dBgW_Base
lbl_80C89990:

...
/* 80C894E8  4B 6D 8C F4 */	b _savegpr_29
/* 80C894EC  7C 7E 1B 78 */	mr r30, r3
/* 80C894F0  3C 60 80 C9 */	lis r3, lit_3627@ha
/* 80C894F4  3B E3 9F 60 */	addi r31, r3, lit_3627@l
...
/* 80C89518  C0 3F 00 64 */	lfs f1, 0x64(r31)	/* effective address: 80C89FC4 */
/* 80C8951C  C0 5E 05 2C */	lfs f2, 0x52c(r30)
/* 80C89520  C0 7F 00 90 */	lfs f3, 0x90(r31)	/* effective address: 80C89FF0 */
/* 80C89524  4B 5E 65 94 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 80C89538  4B 5D D5 FC */	b __mi__4cXyzCFRC3Vec
/* 80C8953C  38 61 00 10 */	addi r3, r1, 0x10
/* 80C89540  4B 6B DB F8 */	b PSVECSquareMag
...
/* 80C895B0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C895B4  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80C89620  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C89624  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80C89638  4B 3A 3A 34 */	b dComIfGp_getReverb__Fi
...
/* 80C89650  4B 6D 8A 5C */	b __cvt_fp2unsigned
/* 80C89654  7C 66 1B 78 */	mr r6, r3
/* 80C89658  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8965C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C89660  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C89684  4B 62 2E 88 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C896B4  4B 6D 8B 74 */	b _restgpr_29

...
/* 80C89C20  4B 6D 85 B0 */	b _savegpr_26
/* 80C89C24  7C 7E 1B 78 */	mr r30, r3
/* 80C89C28  3C 60 80 C9 */	lis r3, lit_3627@ha
/* 80C89C2C  3B 63 9F 60 */	addi r27, r3, lit_3627@l
/* 80C89C30  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C89C34  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C89C38  38 80 00 10 */	li r4, 0x10
/* 80C89C3C  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C89C40  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C89C44  4B 51 9B 80 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C89C48  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C89C4C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C89C50  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C89C54  80 84 00 04 */	lwz r4, 4(r4)
/* 80C89C58  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C89C5C  4B 51 B1 44 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C89C70  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C89C74  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80C89C78  80 04 5F 78 */	lwz r0, 0x5f78(r4)	/* effective address: 8040C138 */
/* 80C89C7C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C89C80  3B 83 4A C8 */	addi r28, r3, j3dSys@l
/* 80C89C84  90 1C 00 48 */	stw r0, 0x48(r28)	/* effective address: 80434B10 */
/* 80C89C88  80 04 5F 7C */	lwz r0, 0x5f7c(r4)	/* effective address: 8040C13C */
/* 80C89C8C  90 1C 00 4C */	stw r0, 0x4c(r28)	/* effective address: 80434B14 */
...
/* 80C89CF4  4B 6B CF F0 */	b C_MTXLightOrtho
/* 80C89CF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C89CFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C89D00  38 80 40 00 */	li r4, 0x4000
/* 80C89D04  4B 38 26 40 */	b mDoMtx_XrotS__FPA4_fs
...
/* 80C89D20  4B 38 30 7C */	b transM__14mDoMtx_stack_cFfff
/* 80C89D24  38 61 00 08 */	addi r3, r1, 8
/* 80C89D28  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C89D2C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C89D30  38 BD 00 24 */	addi r5, r29, 0x24
/* 80C89D34  4B 6B C7 B0 */	b PSMTXConcat
lbl_80C89D38:
/* 80C89D38  C0 3E 05 BC */	lfs f1, 0x5bc(r30)
/* 80C89D3C  38 7E 05 AC */	addi r3, r30, 0x5ac
/* 80C89D40  38 9A 00 58 */	addi r4, r26, 0x58
/* 80C89D44  4B 38 39 94 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C89D48  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80C89D4C  4B 38 3F 78 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C89D50  38 7A 00 58 */	addi r3, r26, 0x58
/* 80C89D54  80 9E 05 C0 */	lwz r4, 0x5c0(r30)
/* 80C89D58  4B 6A 5A 5C */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
/* 80C89D5C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C89D60  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C89D64  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80C89D68  90 1C 00 48 */	stw r0, 0x48(r28)
/* 80C89D6C  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
...
/* 80C89D8C  3C 80 80 C9 */	lis r4, l_HIO@ha
/* 80C89D90  38 84 A1 F4 */	addi r4, r4, l_HIO@l
/* 80C89D94  88 04 00 07 */	lbz r0, 7(r4)	/* effective address: 80C8A1FB */
/* 80C89D98  98 03 00 00 */	stb r0, 0(r3)
/* 80C89D9C  88 04 00 08 */	lbz r0, 8(r4)	/* effective address: 80C8A1FC */
/* 80C89DA0  98 03 00 01 */	stb r0, 1(r3)
/* 80C89DA4  88 04 00 09 */	lbz r0, 9(r4)	/* effective address: 80C8A1FD */
/* 80C89DA8  98 03 00 02 */	stb r0, 2(r3)
/* 80C89DAC  38 60 00 01 */	li r3, 1
/* 80C89DB0  39 61 00 50 */	addi r11, r1, 0x50
/* 80C89DB4  4B 6D 84 68 */	b _restgpr_26

...
/* 80C89C28 00000018  3C 60 00 00 */	lis r3, lit_3627@ha
/* 80C89C2C 0000001C  3B 63 00 00 */	addi r27, r3, lit_3627@l
/* 80C89C30 00000020  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C89C34 00000024  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C89C48 00000038  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80C89C4C 0000003C  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80C89C70 00000060  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C89C74 00000064  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 80C89C78 00000068  80 04 5F 78 */	lwz r0, 0x5f78(r4)
/* 80C89C7C 0000006C  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80C89C80 00000070  3B 83 00 00 */	addi r28, r3, j3dSys@l
...
/* 80C89CF8 000000E8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C89CFC 000000EC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C89D28 00000118  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C89D2C 0000011C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80C89D5C 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C89D60 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C89D8C 00000054  3C 80 00 00 */	lis r4, l_HIO@ha
/* 80C89D90 00000058  38 84 00 00 */	addi r4, r4, l_HIO@l

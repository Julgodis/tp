...
/* 80C89C20 00000010  4B FF EA 79 */	bl _savegpr_26
/* 80C89C24 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C89C28 00000018  3C 60 00 00 */	lis r3, lit_3627@ha /* 80C89F60 */
/* 80C89C2C 0000001C  3B 63 00 00 */	addi r27, r3, lit_3627@l /* 80C89F60 */
/* 80C89C30 00000020  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80C89C34 00000024  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80C89C44 00000034  4B FF EA 55 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C89C48 00000038  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80C89C4C 0000003C  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80C89C5C 0000004C  4B FF EA 3D */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C89C70 00000060  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C89C74 00000064  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C89C78 00000068  80 04 5F 78 */	lwz r0, 0x5f78(r4)
/* 80C89C7C 0000006C  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 80C89C80 00000070  3B 83 00 00 */	addi r28, r3, j3dSys@l /* 80434AC8 */
/* 80C89C84 00000074  90 1C 00 48 */	stw r0, 0x48(r28)
/* 80C89C88 00000078  80 04 5F 7C */	lwz r0, 0x5f7c(r4)
/* 80C89C8C 0000007C  90 1C 00 4C */	stw r0, 0x4c(r28)
...
/* 80C89CD4 000000C4  C0 3B 00 48 */	lfs f1, 0x48(r27)
/* 80C89CD8 000000C8  C0 5B 00 98 */	lfs f2, 0x98(r27)
/* 80C89CDC 000000CC  FC 60 10 90 */	fmr f3, f2
/* 80C89CE0 000000D0  FC 80 08 90 */	fmr f4, f1
/* 80C89CE4 000000D4  C0 BB 00 44 */	lfs f5, 0x44(r27)
/* 80C89CE8 000000D8  FC C0 28 90 */	fmr f6, f5
/* 80C89CEC 000000DC  C0 FB 00 50 */	lfs f7, 0x50(r27)
/* 80C89CF0 000000E0  FD 00 38 90 */	fmr f8, f7
/* 80C89CF4 000000E4  4B FF E9 A5 */	bl C_MTXLightOrtho
/* 80C89CF8 000000E8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C89CFC 000000EC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C89D00 000000F0  38 80 40 00 */	li r4, 0x4000
/* 80C89D04 000000F4  4B FF E9 95 */	bl mDoMtx_XrotS__FPA4_fs
...
/* 80C89D20 00000110  4B FF E9 79 */	bl transM__14mDoMtx_stack_cFfff
/* 80C89D24 00000114  38 61 00 08 */	addi r3, r1, 8
/* 80C89D28 00000118  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C89D2C 0000011C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C89D30 00000120  38 BD 00 24 */	addi r5, r29, 0x24
/* 80C89D34 00000124  4B FF E9 65 */	bl PSMTXConcat
lbl_80C89D38:
...
/* 80C89D44 0000000C  4B FF E9 55 */	bl entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80C89D48 00000010  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80C89D4C 00000014  4B FF E9 4D */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C89D50 00000018  38 7A 00 58 */	addi r3, r26, 0x58
/* 80C89D54 0000001C  80 9E 05 C0 */	lwz r4, 0x5c0(r30)
/* 80C89D58 00000020  4B FF E9 41 */	bl removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
/* 80C89D5C 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C89D60 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C89D64 0000002C  80 03 5F 80 */	lwz r0, 0x5f80(r3)
/* 80C89D68 00000030  90 1C 00 48 */	stw r0, 0x48(r28)
/* 80C89D6C 00000034  80 03 5F 84 */	lwz r0, 0x5f84(r3)
/* 80C89D70 00000038  90 1C 00 4C */	stw r0, 0x4c(r28)
...
/* 80C89D8C 00000054  3C 80 00 00 */	lis r4, l_HIO@ha /* 80C8A1F4 */
/* 80C89D90 00000058  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80C8A1F4 */
/* 80C89D94 0000005C  88 04 00 07 */	lbz r0, 7(r4)
/* 80C89D98 00000060  98 03 00 00 */	stb r0, 0(r3)
/* 80C89D9C 00000064  88 04 00 08 */	lbz r0, 8(r4)
/* 80C89DA0 00000068  98 03 00 01 */	stb r0, 1(r3)
/* 80C89DA4 0000006C  88 04 00 09 */	lbz r0, 9(r4)
...
/* 80C89DB4 0000007C  4B FF E8 E5 */	bl _restgpr_26

...
/* 80C8C9AC 00000018  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80C8C9B0 0000001C  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80C8C9C0 0000002C  4B FF F2 B9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C8C9C4 00000030  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 80C8C9C8 00000034  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 80C8C9D8 00000044  4B FF F2 A1 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C8C9DC 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C8C9E0 0000004C  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C8C9E4 00000050  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80C8C9E8 00000054  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 80C8C9EC 00000058  3B C3 00 00 */	addi r30, r3, j3dSys@l /* 80434AC8 */
/* 80C8C9F0 0000005C  90 1E 00 48 */	stw r0, 0x48(r30)
/* 80C8C9F4 00000060  80 04 5F 74 */	lwz r0, 0x5f74(r4)
/* 80C8C9F8 00000064  90 1E 00 4C */	stw r0, 0x4c(r30)
/* 80C8C9FC 00000068  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 80C8CA00 0000006C  4B FF F2 79 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 80C8CA04 00000070  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C8CA08 00000074  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C8CA0C 00000078  80 03 5F 80 */	lwz r0, 0x5f80(r3)
/* 80C8CA10 0000007C  90 1E 00 48 */	stw r0, 0x48(r30)
/* 80C8CA14 00000080  80 03 5F 84 */	lwz r0, 0x5f84(r3)
/* 80C8CA18 00000084  90 1E 00 4C */	stw r0, 0x4c(r30)

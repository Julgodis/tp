...
/* 80C8C5F8  3C 60 80 C9 */	lis r3, l_HIO@ha
/* 80C8C5FC  38 63 CD 8C */	addi r3, r3, l_HIO@l
/* 80C8C600  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80C8CD94 */
...
/* 80C8C624  4B 3A 0A 48 */	b dComIfGp_getReverb__Fi
...
/* 80C8C638  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C8C63C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C8C640  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C8C644  38 81 00 08 */	addi r4, r1, 8
/* 80C8C648  38 BF 04 A8 */	addi r5, r31, 0x4a8
/* 80C8C64C  38 C0 00 00 */	li r6, 0
/* 80C8C650  3D 00 80 C9 */	lis r8, lit_3777@ha
/* 80C8C654  C0 28 CC 20 */	lfs f1, lit_3777@l(r8)
/* 80C8C658  FC 40 08 90 */	fmr f2, f1
/* 80C8C65C  3D 00 80 C9 */	lis r8, lit_3778@ha
/* 80C8C660  C0 68 CC 24 */	lfs f3, lit_3778@l(r8)
/* 80C8C664  FC 80 18 90 */	fmr f4, f3
/* 80C8C668  39 00 00 00 */	li r8, 0
/* 80C8C66C  4B 61 F3 18 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C8C670:

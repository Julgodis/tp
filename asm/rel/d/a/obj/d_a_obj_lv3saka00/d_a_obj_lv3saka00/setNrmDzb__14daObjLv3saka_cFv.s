...
/* 80C5C194 00000018  4B FF FC A5 */	bl ChkUsed__9cBgW_BgIdCFv
...
/* 80C5C1A4 00000028  4B FF FC 95 */	bl ChkUsed__9cBgW_BgIdCFv
/* 80C5C1A8 0000002C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C5C1AC 00000030  41 82 00 18 */	beq lbl_80C5C1C4
/* 80C5C1B0 00000034  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C5C1B4 00000038  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C5C1B8 0000003C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C5C1BC 00000040  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80C5C1C0 00000044  4B FF FC 79 */	bl Release__4cBgSFP9dBgW_Base
lbl_80C5C1C4:
/* 80C5C1C4 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C5C1C8 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C5C1D8 00000014  4B FF FC 61 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80C5C1DC 00000018  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 80C5C1E0 0000001C  4B FF FC 59 */	bl Move__4dBgWFv
lbl_80C5C1E4:

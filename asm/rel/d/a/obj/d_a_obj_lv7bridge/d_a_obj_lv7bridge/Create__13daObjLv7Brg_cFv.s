...
/* 80C865C8  4B 6D BC 08 */	b _savegpr_26
...
/* 80C865EC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C865F0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C86604  4B 3A ED 5C */	b isSwitch__10dSv_info_cCFii
...
/* 80C8667C  3C 60 80 C8 */	lis r3, lit_3770@ha
/* 80C86680  C8 23 79 D8 */	lfd f1, lit_3770@l(r3)
...
lbl_80C866A4:
/* 80C866A4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C866A8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C866BC  4B 3A EC A4 */	b isSwitch__10dSv_info_cCFii
/* 80C866C0  2C 03 00 00 */	cmpwi r3, 0
/* 80C866C4  41 82 00 60 */	beq lbl_80C86724
/* 80C866C8  3C 60 80 C8 */	lis r3, lit_3767@ha
/* 80C866CC  C0 03 79 D0 */	lfs f0, lit_3767@l(r3)
...
/* 80C866EC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C866F0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C86704  4B 3A EC 5C */	b isSwitch__10dSv_info_cCFii
/* 80C86708  2C 03 00 00 */	cmpwi r3, 0
/* 80C8670C  41 82 00 18 */	beq lbl_80C86724
/* 80C86710  3C 60 80 C8 */	lis r3, lit_3767@ha
/* 80C86714  C0 03 79 D0 */	lfs f0, lit_3767@l(r3)
/* 80C86718  D0 1F 0A 78 */	stfs f0, 0xa78(r31)
/* 80C8671C  38 00 00 01 */	li r0, 1
/* 80C86720  98 1F 0A 7D */	stb r0, 0xa7d(r31)
lbl_80C86724:
/* 80C86724  3C 60 80 C8 */	lis r3, lit_3768@ha
/* 80C86728  C0 03 79 D4 */	lfs f0, lit_3768@l(r3)
...
/* 80C86750  4B 39 3E 28 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C86764  4B 3F D0 FC */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C86768  3B 40 00 00 */	li r26, 0
/* 80C8676C  3B C0 00 00 */	li r30, 0
/* 80C86770  3C 60 80 C8 */	lis r3, l_cyl_src@ha
/* 80C86774  3B 83 7A 5C */	addi r28, r3, l_cyl_src@l
...
/* 80C86788  4B 3F E1 2C */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80C867AC  4B 3F 21 A4 */	b MoveBGExecute__16dBgS_MoveBgActorFv
/* 80C867B0  38 60 00 01 */	li r3, 1
/* 80C867B4  39 61 00 30 */	addi r11, r1, 0x30
/* 80C867B8  4B 6D BA 64 */	b _restgpr_26

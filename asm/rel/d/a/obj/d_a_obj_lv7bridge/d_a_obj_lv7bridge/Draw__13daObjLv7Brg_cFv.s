...
/* 80C8731C  3C 60 80 C8 */	lis r3, lit_3697@ha
/* 80C87320  C0 23 79 CC */	lfs f1, lit_3697@l(r3)
...
lbl_80C87338:
/* 80C87338  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C8733C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C87340  38 80 00 10 */	li r4, 0x10
/* 80C87344  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 80C87348  38 DE 01 0C */	addi r6, r30, 0x10c
/* 80C8734C  4B 51 C4 78 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80C87350  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C87354  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C87358  80 9E 05 A8 */	lwz r4, 0x5a8(r30)
/* 80C8735C  80 84 00 04 */	lwz r4, 4(r4)
/* 80C87360  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C87364  4B 51 DA 3C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80C87368  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C8736C  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80C87370  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80C87374  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C87378  3B E3 4A C8 */	addi r31, r3, j3dSys@l
/* 80C8737C  90 1F 00 48 */	stw r0, 0x48(r31)	/* effective address: 80434B10 */
/* 80C87380  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80C87384  90 1F 00 4C */	stw r0, 0x4c(r31)	/* effective address: 80434B14 */
/* 80C87388  80 7E 05 A8 */	lwz r3, 0x5a8(r30)
/* 80C8738C  4B 38 69 38 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80C87390  88 1E 0A 7E */	lbz r0, 0xa7e(r30)
/* 80C87394  28 00 00 01 */	cmplwi r0, 1
/* 80C87398  40 82 00 8C */	bne lbl_80C87424
/* 80C8739C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80C873A0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80C873A4  80 9E 0A 84 */	lwz r4, 0xa84(r30)
/* 80C873A8  80 84 00 04 */	lwz r4, 4(r4)
/* 80C873AC  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80C873B0  4B 51 D9 F0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80C87400  4B 38 65 CC */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80C87404:
/* 80C87404  80 7E 0A 84 */	lwz r3, 0xa84(r30)
/* 80C87408  4B 38 68 BC */	b mDoExt_modelUpdateDL__FP8J3DModel
...
lbl_80C87424:
/* 80C87424  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C87428  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C8742C  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80C87430  90 1F 00 48 */	stw r0, 0x48(r31)
/* 80C87434  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

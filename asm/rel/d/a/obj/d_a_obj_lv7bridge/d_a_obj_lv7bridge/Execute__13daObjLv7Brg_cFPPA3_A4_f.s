...
/* 80C86B5C 0000001C  3C 80 00 00 */	lis r4, l_bmd@ha /* 80C879A0 */
/* 80C86B60 00000020  3B C4 00 00 */	addi r30, r4, l_bmd@l /* 80C879A0 */
...
lbl_80C86BA8:
/* 80C86BA8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86BAC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C86BB0 00000008  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86BB4 0000000C  4B FF F7 A5 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C86BB8 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86BBC 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C86BDC 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86BE0 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C86BE4 0000003C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86BE8 00000040  4B FF F7 71 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C86BEC 00000044  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86BF0 00000048  3B E3 00 00 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
lbl_80C86C34:
/* 80C86C34 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86C38 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C86C3C 00000008  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86C40 0000000C  4B FF F7 19 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C86C44 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86C48 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C86C68 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86C6C 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C86CD8 000000A4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86CDC 000000A8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C86CE0 000000AC  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86CE4 000000B0  4B FF F6 75 */	bl mDoMtx_YrotS__FPA4_fs
/* 80C86CE8 000000B4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86CEC 000000B8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C86D0C 000000D8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C86D10 000000DC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C86D3C 00000108  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C86D40 0000010C  3B 63 00 00 */	addi r27, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C86DD8 00000038  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C86DDC 0000003C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C86E04 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C86E08 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */

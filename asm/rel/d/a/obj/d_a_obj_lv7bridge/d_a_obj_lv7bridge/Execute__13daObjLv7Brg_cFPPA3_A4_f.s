...
/* 80C86B50  4B 6D B6 80 */	b _savegpr_26
/* 80C86B54  7C 7D 1B 78 */	mr r29, r3
/* 80C86B58  7C 9A 23 78 */	mr r26, r4
/* 80C86B5C  3C 80 80 C8 */	lis r4, l_bmd@ha
/* 80C86B60  3B C4 79 A0 */	addi r30, r4, l_bmd@l
...
lbl_80C86BA8:
/* 80C86BA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86BAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86BB0  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86BB4  4B 38 58 28 */	b mDoMtx_YrotS__FPA4_fs
/* 80C86BB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86BBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86BC0  38 81 00 2C */	addi r4, r1, 0x2c
/* 80C86BC4  7C 85 23 78 */	mr r5, r4
/* 80C86BC8  4B 6C 01 A4 */	b PSMTXMultVec
/* 80C86BCC  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C86BD0  4B 38 61 94 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C86BD4  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C86BD8  4B 38 61 FC */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80C86BDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86BE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86BE4  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86BE8  4B 38 58 4C */	b mDoMtx_YrotM__FPA4_fs
/* 80C86BEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86BF0  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 80C86BF4  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 803DD47C */
/* 80C86BF8  D0 1D 05 38 */	stfs f0, 0x538(r29)
/* 80C86BFC  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 803DD48C */
/* 80C86C00  D0 1D 05 3C */	stfs f0, 0x53c(r29)
/* 80C86C04  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 803DD49C */
...
lbl_80C86C34:
/* 80C86C34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86C38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86C3C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86C40  4B 38 57 9C */	b mDoMtx_YrotS__FPA4_fs
/* 80C86C44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86C48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86C4C  38 81 00 2C */	addi r4, r1, 0x2c
/* 80C86C50  7C 85 23 78 */	mr r5, r4
/* 80C86C54  4B 6C 01 18 */	b PSMTXMultVec
/* 80C86C58  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C86C5C  4B 38 61 08 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C86C60  38 61 00 2C */	addi r3, r1, 0x2c
/* 80C86C64  4B 38 61 70 */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80C86C68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86C6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86C70  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86C74  4B 38 57 C0 */	b mDoMtx_YrotM__FPA4_fs
...
/* 80C86CAC  4B 38 67 7C */	b play__14mDoExt_baseAnmFv
...
/* 80C86CD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86CDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86CE0  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86CE4  4B 38 56 F8 */	b mDoMtx_YrotS__FPA4_fs
/* 80C86CE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86CEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86CF0  38 81 00 20 */	addi r4, r1, 0x20
/* 80C86CF4  7C 85 23 78 */	mr r5, r4
/* 80C86CF8  4B 6C 00 74 */	b PSMTXMultVec
/* 80C86CFC  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C86D00  4B 38 60 64 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C86D04  38 61 00 20 */	addi r3, r1, 0x20
/* 80C86D08  4B 38 60 CC */	b transM__14mDoMtx_stack_cFRC4cXyz
/* 80C86D0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C86D10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C86D14  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80C86D18  4B 38 57 1C */	b mDoMtx_YrotM__FPA4_fs
...
/* 80C86D3C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C86D40  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 80C86D44  3B 9E 00 10 */	addi r28, r30, 0x10
lbl_80C86D48:
/* 80C86D48  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 80C86D88  4B 3C 5D 08 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C86E54  4B 6D B3 C8 */	b _restgpr_26

...
/* 80D27C84 00000018  3C 80 80 D3 */	lis r4, l_bmd_idx@ha
/* 80D27C88 0000001C  3B C4 95 B4 */	addi r30, r4, l_bmd_idx@l
/* 80D27C8C 00000020  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 80D27C90 00000024  38 84 10 18 */	addi r4, r4, m_midnaActor__9daPy_py_c@l
/* 80D27C94 00000028  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80451018 */
...
/* 80D27CA8 0000003C  D0 04 09 AC */	stfs f0, 0x9ac(r4)	/* effective address: 804519C4 */
/* 80D27CAC 00000040  C0 1F 06 2C */	lfs f0, 0x62c(r31)
/* 80D27CB0 00000044  D0 04 09 B0 */	stfs f0, 0x9b0(r4)	/* effective address: 804519C8 */
/* 80D27CB4 00000048  C0 1F 06 30 */	lfs f0, 0x630(r31)
/* 80D27CB8 0000004C  D0 04 09 B4 */	stfs f0, 0x9b4(r4)	/* effective address: 804519CC */
/* 80D27CBC 00000050  80 04 08 90 */	lwz r0, 0x890(r4)	/* effective address: 804518A8 */
/* 80D27CC0 00000054  64 00 08 00 */	oris r0, r0, 0x800
/* 80D27CC4 00000058  60 00 04 00 */	ori r0, r0, 0x400
/* 80D27CC8 0000005C  90 04 08 90 */	stw r0, 0x890(r4)	/* effective address: 804518A8 */
/* 80D27CCC 00000060  38 64 04 D0 */	addi r3, r4, 0x4d0
/* 80D27CD0 00000064  38 9F 06 28 */	addi r4, r31, 0x628
/* 80D27CD4 00000068  4B 61 F6 C8 */	b PSVECSquareDistance
/* 80D27CD8 0000006C  C0 1E 00 70 */	lfs f0, 0x70(r30)	/* effective address: 80D29624 */
...
/* 80D27CE8 00000008  C8 9E 00 88 */	lfd f4, 0x88(r30)	/* effective address: 80D2963C */
/* 80D27CEC 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80D27CF0 00000010  C8 7E 00 90 */	lfd f3, 0x90(r30)	/* effective address: 80D29644 */
...
lbl_80D27D38:
/* 80D27D38 00000000  C8 1E 00 98 */	lfd f0, 0x98(r30)	/* effective address: 80D2964C */
/* 80D27D3C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80D27D40 00000000  40 80 00 10 */	bge lbl_80D27D50
/* 80D27D44 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D27D48 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80D27DB4 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D27DB8 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80D27DBC:
/* 80D27DBC 00000000  C0 1E 00 6C */	lfs f0, 0x6c(r30)	/* effective address: 80D29620 */
...
/* 80D27DE4 00000020  4B 52 21 AC */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c

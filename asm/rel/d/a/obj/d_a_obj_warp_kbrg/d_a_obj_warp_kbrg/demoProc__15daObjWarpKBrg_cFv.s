...
/* 80D28264  4B 63 9F 60 */	b _savegpr_23
/* 80D28268  7C 7F 1B 78 */	mr r31, r3
/* 80D2826C  3C 60 80 D3 */	lis r3, l_bmd_idx@ha
/* 80D28270  3B C3 95 B4 */	addi r30, r3, l_bmd_idx@l
/* 80D28274  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D28278  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80D2827C  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80D28280  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 80D28284  83 23 10 18 */	lwz r25, m_midnaActor__9daPy_py_c@l(r3)
...
/* 80D282AC  4B 31 FB 64 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 80D282B0  7C 7B 1B 78 */	mr r27, r3
/* 80D282B4  7F 83 E3 78 */	mr r3, r28
/* 80D282B8  80 9F 05 D4 */	lwz r4, 0x5d4(r31)
/* 80D282BC  4B 31 FA 90 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80D282D0  3C 60 80 D3 */	lis r3, lit_4533@ha
/* 80D282D4  38 63 98 88 */	addi r3, r3, lit_4533@l
...
/* 80D282F0  3C A0 80 D3 */	lis r5, struct_80D29688+0x0@ha
/* 80D282F4  38 A5 96 88 */	addi r5, r5, struct_80D29688+0x0@l
/* 80D282F8  38 A5 00 7F */	addi r5, r5, 0x7f
/* 80D282FC  38 C0 00 03 */	li r6, 3
/* 80D28300  4B 31 FD EC */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80D28360  4B 30 4D 0C */	b dComIfGp_getReverb__Fi
...
/* 80D28374  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D28378  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2837C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D283A0  4B 58 35 E4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D283A4  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 80D283A8  28 03 00 00 */	cmplwi r3, 0
/* 80D283AC  41 82 00 1C */	beq lbl_80D283C8
/* 80D283B0  4B 53 FE 24 */	b ChkUsed__9cBgW_BgIdCFv
...
/* 80D283C4  4B 34 BE 8C */	b Release__4cBgSFP9dBgW_Base
lbl_80D283C8:
/* 80D283C8  4B 30 77 20 */	b dComIfGp_TransportWarp_check__Fv
/* 80D283CC  2C 03 00 00 */	cmpwi r3, 0
/* 80D283D0  41 82 02 50 */	beq lbl_80D28620
/* 80D283D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D283D8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D283DC  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D283E0  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D283E4  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D283E8  A0 84 00 66 */	lhz r4, 0x66(r4)	/* effective address: 803A72EE */
/* 80D283EC  4B 30 C5 A0 */	b onEventBit__11dSv_event_cFUs
...
/* 80D2841C  4B 34 C5 EC */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80D28420:
/* 80D28420  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80D28424  7C 03 07 74 */	extsb r3, r0
/* 80D28428  4B 30 4C 44 */	b dComIfGp_getReverb__Fi
...
/* 80D2843C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D28440  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D28444  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D28468  4B 58 35 1C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D284BC  3C 60 80 D3 */	lis r3, l_arcName@ha
/* 80D284C0  38 63 97 30 */	addi r3, r3, l_arcName@l
/* 80D284C4  7C 63 00 2E */	lwzx r3, r3, r0
/* 80D284C8  38 80 00 0F */	li r4, 0xf
/* 80D284CC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D284D0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D284E4  4B 31 3E 08 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D284E8  7C 78 1B 78 */	mr r24, r3
/* 80D284EC  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 80D284F0  54 00 1F 7A */	rlwinm r0, r0, 3, 0x1d, 0x1d
/* 80D284F4  3C 60 80 D3 */	lis r3, l_arcName@ha
/* 80D284F8  38 63 97 30 */	addi r3, r3, l_arcName@l
...
/* 80D2850C  4B 31 3D E0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D28534  4B 2E 51 D8 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80D28584  4B 30 4A E8 */	b dComIfGp_getReverb__Fi
...
/* 80D28598  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2859C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D285A0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D285C4  4B 58 33 C0 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D285DC  4B 30 4A 90 */	b dComIfGp_getReverb__Fi
...
/* 80D285F0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D285F4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D285F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2861C  4B 58 33 68 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D28620:
/* 80D28620  28 1B 00 06 */	cmplwi r27, 6
/* 80D28624  41 81 03 F0 */	bgt lbl_80D28A14
/* 80D28628  3C 60 80 D3 */	lis r3, lit_4535@ha
/* 80D2862C  38 63 98 6C */	addi r3, r3, lit_4535@l
...
/* 80D28658  4B 31 FB 24 */	b cutEnd__16dEvent_manager_cFi
/* 80D2865C  48 00 03 C4 */	b lbl_80D28A20
lbl_80D28660:
/* 80D28660  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 80D28664  4B 2E 4D C4 */	b play__14mDoExt_baseAnmFv
/* 80D28668  7C 79 1B 78 */	mr r25, r3
/* 80D2866C  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 80D28670  4B 2E 4D B8 */	b play__14mDoExt_baseAnmFv
...
/* 80D2869C  4B 30 49 D0 */	b dComIfGp_getReverb__Fi
...
/* 80D286B0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D286B4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D286B8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D286DC  4B 58 32 A8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D286E0:
...
/* 80D286F0  4B 31 FA 8C */	b cutEnd__16dEvent_manager_cFi
lbl_80D286F4:
...
/* 80D28704  4B 2E 4D 24 */	b play__14mDoExt_baseAnmFv
...
/* 80D28740  4B 34 72 E4 */	b StartShock__12dVibration_cFii4cXyz
lbl_80D28744:
/* 80D28744  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 80D28748  4B 2E 4C E0 */	b play__14mDoExt_baseAnmFv
...
/* 80D2876C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D28770  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D28784  4B 30 CA 7C */	b onSwitch__10dSv_info_cFii
/* 80D28788  7F 83 E3 78 */	mr r3, r28
/* 80D2878C  80 9F 05 D4 */	lwz r4, 0x5d4(r31)
/* 80D28790  4B 31 F9 EC */	b cutEnd__16dEvent_manager_cFi
lbl_80D28794:
...
/* 80D287AC  4B 2E 4C 7C */	b play__14mDoExt_baseAnmFv
...
/* 80D287C0  4B 31 F9 BC */	b cutEnd__16dEvent_manager_cFi
lbl_80D287C4:
...
/* 80D287E8  4B 31 F9 94 */	b cutEnd__16dEvent_manager_cFi
lbl_80D287EC:
...
/* 80D28808  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D2880C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80D28810  4B 61 DC A0 */	b PSMTXCopy
/* 80D28814  C0 3E 00 A8 */	lfs f1, 0xa8(r30)
/* 80D28818  C0 5E 00 AC */	lfs f2, 0xac(r30)
/* 80D2881C  C0 7E 00 B0 */	lfs f3, 0xb0(r30)
/* 80D28820  4B 2E 45 7C */	b transM__14mDoMtx_stack_cFfff
/* 80D28824  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D28828  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l
/* 80D2882C  C0 19 00 0C */	lfs f0, 0xc(r25)	/* effective address: 803DD47C */
/* 80D28830  D0 01 00 4C */	stfs f0, 0x4c(r1)
/* 80D28834  C0 19 00 1C */	lfs f0, 0x1c(r25)	/* effective address: 803DD48C */
/* 80D28838  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 80D2883C  C0 19 00 2C */	lfs f0, 0x2c(r25)	/* effective address: 803DD49C */
...
/* 80D28888  4B 54 83 7C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 80D2888C  B0 61 00 3A */	sth r3, 0x3a(r1)
/* 80D28890  38 61 00 4C */	addi r3, r1, 0x4c
/* 80D28894  38 81 00 58 */	addi r4, r1, 0x58
/* 80D28898  4B 54 83 DC */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80D288B0  4B 61 EA EC */	b PSVECSquareDistance
...
/* 80D28920  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D28924  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80D28990  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D28994  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80D28998:
/* 80D28998  C0 1E 00 B8 */	lfs f0, 0xb8(r30)
/* 80D2899C  EF E0 00 72 */	fmuls f31, f0, f1
/* 80D289A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D289A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D289A8  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80D289EC  4B 32 40 A4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf

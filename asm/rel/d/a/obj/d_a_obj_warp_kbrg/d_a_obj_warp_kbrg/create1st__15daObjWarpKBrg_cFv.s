...
lbl_80D27714:
/* 80D27714 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D27718 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D2771C 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D27720 0000000C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D27724 00000010  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
lbl_80D27740:
/* 80D27740 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D27744 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D27748 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D2774C 0000000C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D27750 00000010  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80D27770 00000004  3C 80 00 00 */	lis r4, l_evArcName@ha
/* 80D27774 00000008  38 84 00 00 */	addi r4, r4, l_evArcName@l
...
/* 80D27798 0000000C  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80D2779C 00000010  38 84 00 00 */	addi r4, r4, l_arcName@l
...
/* 80D277C0 00000034  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80D277C4 00000038  38 84 00 00 */	addi r4, r4, l_arcName@l
/* 80D277C8 0000003C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80D277CC 00000040  3C A0 00 00 */	lis r5, l_dzb_idx@ha
/* 80D277D0 00000044  38 A5 00 00 */	addi r5, r5, l_dzb_idx@l
/* 80D277D4 00000048  7C A5 00 2E */	lwzx r5, r5, r0
/* 80D277D8 0000004C  3C C0 00 00 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80D277DC 00000050  38 C6 00 00 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80D277E0 00000054  3C E0 00 00 */	lis r7, l_heap_size@ha
/* 80D277E4 00000058  38 E7 00 00 */	addi r7, r7, l_heap_size@l

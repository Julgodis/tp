...
/* 8057BA90  3C 80 80 58 */	lis r4, l_arcName@ha
/* 8057BA94  38 84 BE 20 */	addi r4, r4, l_arcName@l
/* 8057BA98  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 8057BE20 */
/* 8057BA9C  4B AB 14 20 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
lbl_8057BAF8:
/* 8057BAF8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057BAFC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057BB00  3C 63 00 02 */	addis r3, r3, 2
/* 8057BB04  3C 80 80 58 */	lis r4, l_arcName@ha
/* 8057BB08  38 84 BE 20 */	addi r4, r4, l_arcName@l
/* 8057BB0C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 8057BE20 */
/* 8057BB10  54 00 10 3A */	slwi r0, r0, 2
/* 8057BB14  3C A0 80 58 */	lis r5, l_dzbName@ha
/* 8057BB18  38 A5 BE 24 */	addi r5, r5, l_dzbName@l
/* 8057BB1C  7C A5 00 2E */	lwzx r5, r5, r0
/* 8057BB20  38 63 C2 F8 */	addi r3, r3, -15624
/* 8057BB24  4B AC 0B 94 */	b getObjectResName2Index__14dRes_control_cFPCcPCc
/* 8057BB28  7C 65 1B 78 */	mr r5, r3
/* 8057BB2C  7F E3 FB 78 */	mr r3, r31
/* 8057BB30  3C 80 80 58 */	lis r4, l_arcName@ha
/* 8057BB34  38 84 BE 20 */	addi r4, r4, l_arcName@l
/* 8057BB38  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 8057BE20 */
/* 8057BB3C  38 C0 00 00 */	li r6, 0
/* 8057BB40  38 E0 02 00 */	li r7, 0x200
/* 8057BB44  39 00 00 00 */	li r8, 0
/* 8057BB48  4B AF CC 74 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f

...
/* 8059CAAC 00000020  4B FF FF 2D */	bl dKyw_get_AllWind_vec__FP4cXyzP4cXyzPf
/* 8059CAB0 00000024  A8 1F 07 66 */	lha r0, 0x766(r31)
/* 8059CAB4 00000028  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8059CAB8 0000002C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 8059CABC 00000030  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
/* 8059CAC0 00000034  7C 23 04 2E */	lfsx f1, r3, r0
/* 8059CAC4 00000038  3C 60 00 00 */	lis r3, M_attr__15daObjYobikusa_c@ha /* 8059DE7C */
/* 8059CAC8 0000003C  38 63 00 00 */	addi r3, r3, M_attr__15daObjYobikusa_c@l /* 8059DE7C */
/* 8059CACC 00000040  C0 03 00 1C */	lfs f0, 0x1c(r3)
/* 8059CAD0 00000044  EC 40 00 72 */	fmuls f2, f0, f1
/* 8059CAD4 00000048  C0 21 00 08 */	lfs f1, 8(r1)
/* 8059CAD8 0000004C  C0 03 00 00 */	lfs f0, 0(r3)
/* 8059CADC 00000050  EC 01 00 32 */	fmuls f0, f1, f0
/* 8059CAE0 00000054  EC 22 00 2A */	fadds f1, f2, f0
/* 8059CAE4 00000058  3C 60 00 00 */	lis r3, lit_3699@ha /* 8059DEBC */
/* 8059CAE8 0000005C  C0 03 00 00 */	lfs f0, lit_3699@l(r3) /* 8059DEBC */
...
/* 8059CB00 00000008  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 8059CB04 0000000C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 8059CB4C 00000054  3C 60 00 00 */	lis r3, M_attr__15daObjYobikusa_c@ha /* 8059DE7C */
/* 8059CB50 00000058  38 63 00 00 */	addi r3, r3, M_attr__15daObjYobikusa_c@l /* 8059DE7C */
/* 8059CB54 0000005C  C0 03 00 20 */	lfs f0, 0x20(r3)
/* 8059CB58 00000060  EC 40 00 72 */	fmuls f2, f0, f1
/* 8059CB5C 00000064  C0 63 00 10 */	lfs f3, 0x10(r3)
/* 8059CB60 00000068  C0 21 00 08 */	lfs f1, 8(r1)
/* 8059CB64 0000006C  C0 03 00 0C */	lfs f0, 0xc(r3)
...
/* 8059CB78 00000080  3C 60 00 00 */	lis r3, lit_3699@ha /* 8059DEBC */
/* 8059CB7C 00000084  C0 03 00 00 */	lfs f0, lit_3699@l(r3) /* 8059DEBC */
...
/* 8059CB94 00000008  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 8059CB98 0000000C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 8059CBD8 0000004C  3C 60 00 00 */	lis r3, M_attr__15daObjYobikusa_c@ha /* 8059DE7C */
/* 8059CBDC 00000050  38 83 00 00 */	addi r4, r3, M_attr__15daObjYobikusa_c@l /* 8059DE7C */
/* 8059CBE0 00000054  C0 44 00 18 */	lfs f2, 0x18(r4)
/* 8059CBE4 00000058  C0 21 00 08 */	lfs f1, 8(r1)
/* 8059CBE8 0000005C  C0 04 00 14 */	lfs f0, 0x14(r4)
...
/* 8059CC10 00000084  A8 04 00 3A */	lha r0, 0x3a(r4)
...
/* 8059CC28 0000009C  4B FF FD B1 */	bl ChkCoHit__12dCcD_GObjInfFv

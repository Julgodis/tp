...
/* 80C72D48  4B 6E F4 94 */	b _savegpr_29
...
/* 80C72D94  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C72D98  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C72E20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C72E24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C72E28  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C72E2C  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C72E30  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C72E34  4B 39 93 D4 */	b mDoMtx_ZXYrotS__FPA4_fsss
/* 80C72E38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C72E3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C72E40  38 81 00 0C */	addi r4, r1, 0xc
/* 80C72E44  7C 85 23 78 */	mr r5, r4
/* 80C72E48  4B 6D 3F 24 */	b PSMTXMultVec
/* 80C72E4C  38 61 00 0C */	addi r3, r1, 0xc
/* 80C72E50  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C72E54  7C 65 1B 78 */	mr r5, r3
/* 80C72E58  4B 6D 42 38 */	b PSVECAdd
/* 80C72E5C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C72E60  7C 03 07 74 */	extsb r3, r0
/* 80C72E64  4B 3B A2 08 */	b dComIfGp_getReverb__Fi
/* 80C72E68  7C 7D 1B 78 */	mr r29, r3
/* 80C72E6C  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 80C72E70  4B 6E F2 3C */	b __cvt_fp2unsigned
...
/* 80C72EB0  4B 63 8A D4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C72EB4:
...
/* 80C72ECC  4B 6E F3 5C */	b _restgpr_29

...
/* 80C72CBC  88 07 00 00 */	lbz r0, 0(r7)	/* effective address: 80C732E4 */
/* 80C72CC0  7C 00 07 75 */	extsb. r0, r0
/* 80C72CC4  40 82 00 34 */	bne lbl_80C72CF8
/* 80C72CC8  3C 80 80 C7 */	lis r4, data_80C73208@ha
/* 80C72CCC  38 C4 32 08 */	addi r6, r4, data_80C73208@l
/* 80C72CD0  3C 80 80 C7 */	lis r4, lit_3884@ha
/* 80C72CD4  38 A4 31 FC */	addi r5, r4, lit_3884@l
/* 80C72CD8  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80C731FC */
/* 80C72CDC  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80C73200 */
/* 80C72CE0  90 86 00 00 */	stw r4, 0(r6)	/* effective address: 80C73208 */
/* 80C72CE4  90 06 00 04 */	stw r0, 4(r6)	/* effective address: 80C7320C */
/* 80C72CE8  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80C73204 */
/* 80C72CEC  90 06 00 08 */	stw r0, 8(r6)	/* effective address: 80C73210 */
...
/* 80C72D00  3C 80 80 C7 */	lis r4, data_80C73208@ha
/* 80C72D04  38 04 32 08 */	addi r0, r4, data_80C73208@l

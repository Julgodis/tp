...
/* 80C45C6C  4B 71 C5 60 */	b _savegpr_25
/* 80C45C70  7C 7E 1B 78 */	mr r30, r3
/* 80C45C74  3C 80 80 C4 */	lis r4, lit_3769@ha
/* 80C45C78  3B E4 5F 1C */	addi r31, r4, lit_3769@l
...
/* 80C45C94  4B 3D 2E D0 */	b __ct__10fopAc_ac_cFv
/* 80C45C98  38 79 05 94 */	addi r3, r25, 0x594
/* 80C45C9C  3C 80 80 C4 */	lis r4, __ct__6kita_sFv@ha
/* 80C45CA0  38 84 5E 80 */	addi r4, r4, __ct__6kita_sFv@l
/* 80C45CA4  3C A0 80 C4 */	lis r5, __dt__6kita_sFv@ha
/* 80C45CA8  38 A5 5E 44 */	addi r5, r5, __dt__6kita_sFv@l
/* 80C45CAC  38 C0 00 60 */	li r6, 0x60
/* 80C45CB0  38 E0 00 15 */	li r7, 0x15
/* 80C45CB4  4B 71 C0 AC */	b __construct_array
lbl_80C45CB8:
...
/* 80C45CC8  3C 80 80 C4 */	lis r4, stringBase0@ha
/* 80C45CCC  38 84 5F 80 */	addi r4, r4, stringBase0@l
/* 80C45CD0  4B 3E 71 EC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C45D28  3C 80 80 C4 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80C45D2C  38 84 5B 10 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80C45D30  38 A0 47 60 */	li r5, 0x4760
/* 80C45D34  4B 3D 47 7C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C45D50  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C45D54  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C45D78  4B 42 EC 90 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80C45D90  4B 62 1B C4 */	b cM_rndF__Ff
...
/* 80C45DA8  4B 62 1B E4 */	b cM_rndFX__Ff
...
/* 80C45DCC  3C 60 80 C4 */	lis r3, data_80C45FF0@ha
/* 80C45DD0  8C 03 5F F0 */	lbzu r0, data_80C45FF0@l(r3)
...
/* 80C45DEC  3C 60 80 C4 */	lis r3, l_HIO@ha
/* 80C45DF0  38 63 60 00 */	addi r3, r3, l_HIO@l
/* 80C45DF4  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80C46004 */
lbl_80C45DF8:
/* 80C45DF8  C0 3F 00 60 */	lfs f1, 0x60(r31)
/* 80C45DFC  4B 62 1B 58 */	b cM_rndF__Ff
...
/* 80C45E30  4B 71 C3 E8 */	b _restgpr_25

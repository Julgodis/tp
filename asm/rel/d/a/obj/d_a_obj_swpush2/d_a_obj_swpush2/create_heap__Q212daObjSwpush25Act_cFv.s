...
/* 80CFE1E0  4B 66 3F F4 */	b _savegpr_27
...
/* 80CFE214  4B 33 E1 68 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
...
/* 80CFE228  4B 31 6A 2C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CFE264  4B 33 E1 18 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE268  7C 7B 1B 78 */	mr r27, r3
/* 80CFE26C  38 60 00 18 */	li r3, 0x18
/* 80CFE270  4B 5D 09 DC */	b __nw__FUl
/* 80CFE274  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CFE278  41 82 00 20 */	beq lbl_80CFE298
/* 80CFE27C  3C 80 80 D0 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CFE280  38 04 FE E8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CFE284  90 1C 00 00 */	stw r0, 0(r28)
/* 80CFE288  38 80 00 00 */	li r4, 0
/* 80CFE28C  4B 62 A1 70 */	b init__12J3DFrameCtrlFs
...
/* 80CFE2BC  3D 00 80 D0 */	lis r8, lit_3857@ha
/* 80CFE2C0  C0 28 FC E0 */	lfs f1, lit_3857@l(r8)
/* 80CFE2C4  39 00 00 00 */	li r8, 0
/* 80CFE2C8  39 20 FF FF */	li r9, -1
/* 80CFE2CC  4B 30 F4 40 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80CFE2E0:
/* 80CFE2E0  3C 60 80 D0 */	lis r3, lit_3857@ha
/* 80CFE2E4  C0 03 FC E0 */	lfs f0, lit_3857@l(r3)
...
/* 80CFE310  4B 33 E0 6C */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE314  7C 7B 1B 78 */	mr r27, r3
/* 80CFE318  38 60 00 18 */	li r3, 0x18
/* 80CFE31C  4B 5D 09 30 */	b __nw__FUl
/* 80CFE320  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CFE324  41 82 00 20 */	beq lbl_80CFE344
/* 80CFE328  3C 80 80 D0 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CFE32C  38 04 FE E8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CFE330  90 1C 00 00 */	stw r0, 0(r28)
/* 80CFE334  38 80 00 00 */	li r4, 0
/* 80CFE338  4B 62 A0 C4 */	b init__12J3DFrameCtrlFs
...
/* 80CFE364  3D 00 80 D0 */	lis r8, lit_3857@ha
/* 80CFE368  C0 28 FC E0 */	lfs f1, lit_3857@l(r8)
/* 80CFE36C  39 00 00 00 */	li r8, 0
/* 80CFE370  39 20 FF FF */	li r9, -1
/* 80CFE374  4B 30 F2 C8 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80CFE388:
/* 80CFE388  3C 60 80 D0 */	lis r3, lit_3857@ha
/* 80CFE38C  C0 03 FC E0 */	lfs f0, lit_3857@l(r3)
...
/* 80CFE3B8  4B 33 DF C4 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE3BC  7C 7B 1B 78 */	mr r27, r3
/* 80CFE3C0  38 60 00 18 */	li r3, 0x18
/* 80CFE3C4  4B 5D 08 88 */	b __nw__FUl
/* 80CFE3C8  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CFE3CC  41 82 00 20 */	beq lbl_80CFE3EC
/* 80CFE3D0  3C 80 80 D0 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CFE3D4  38 04 FE E8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CFE3D8  90 1C 00 00 */	stw r0, 0(r28)
/* 80CFE3DC  38 80 00 00 */	li r4, 0
/* 80CFE3E0  4B 62 A0 1C */	b init__12J3DFrameCtrlFs
...
/* 80CFE40C  3D 00 80 D0 */	lis r8, lit_3857@ha
/* 80CFE410  C0 28 FC E0 */	lfs f1, lit_3857@l(r8)
/* 80CFE414  39 00 00 00 */	li r8, 0
/* 80CFE418  39 20 FF FF */	li r9, -1
/* 80CFE41C  4B 30 F2 20 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80CFE430:
/* 80CFE430  3C 60 80 D0 */	lis r3, lit_3858@ha
/* 80CFE434  C0 03 FC E4 */	lfs f0, lit_3858@l(r3)
...
/* 80CFE460  4B 33 DF 1C */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE464  7C 7B 1B 78 */	mr r27, r3
/* 80CFE468  38 60 00 18 */	li r3, 0x18
/* 80CFE46C  4B 5D 07 E0 */	b __nw__FUl
/* 80CFE470  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CFE474  41 82 00 20 */	beq lbl_80CFE494
/* 80CFE478  3C 80 80 D0 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CFE47C  38 04 FE E8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CFE480  90 1C 00 00 */	stw r0, 0(r28)
/* 80CFE484  38 80 00 00 */	li r4, 0
/* 80CFE488  4B 62 9F 74 */	b init__12J3DFrameCtrlFs
...
/* 80CFE4B4  3D 00 80 D0 */	lis r8, lit_3857@ha
/* 80CFE4B8  C0 28 FC E0 */	lfs f1, lit_3857@l(r8)
/* 80CFE4BC  39 00 00 00 */	li r8, 0
/* 80CFE4C0  39 20 FF FF */	li r9, -1
/* 80CFE4C4  4B 30 F1 78 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80CFE4D8:
/* 80CFE4D8  3C 60 80 D0 */	lis r3, lit_3858@ha
/* 80CFE4DC  C0 03 FC E4 */	lfs f0, lit_3858@l(r3)
...
/* 80CFE508  4B 33 DE 74 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE50C  7C 7B 1B 78 */	mr r27, r3
/* 80CFE510  38 60 00 18 */	li r3, 0x18
/* 80CFE514  4B 5D 07 38 */	b __nw__FUl
/* 80CFE518  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CFE51C  41 82 00 20 */	beq lbl_80CFE53C
/* 80CFE520  3C 80 80 D0 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CFE524  38 04 FE E8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CFE528  90 1C 00 00 */	stw r0, 0(r28)
/* 80CFE52C  38 80 00 00 */	li r4, 0
/* 80CFE530  4B 62 9E CC */	b init__12J3DFrameCtrlFs
...
/* 80CFE55C  3D 00 80 D0 */	lis r8, lit_3857@ha
/* 80CFE560  C0 28 FC E0 */	lfs f1, lit_3857@l(r8)
/* 80CFE564  39 00 00 00 */	li r8, 0
/* 80CFE568  39 20 FF FF */	li r9, -1
/* 80CFE56C  4B 30 F1 A0 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80CFE580:
/* 80CFE580  3C 60 80 D0 */	lis r3, lit_3858@ha
/* 80CFE584  C0 03 FC E4 */	lfs f0, lit_3858@l(r3)
...
/* 80CFE5B0  4B 33 DD CC */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE5B4  7C 7B 1B 78 */	mr r27, r3
/* 80CFE5B8  38 60 00 18 */	li r3, 0x18
/* 80CFE5BC  4B 5D 06 90 */	b __nw__FUl
/* 80CFE5C0  7C 7C 1B 79 */	or. r28, r3, r3
/* 80CFE5C4  41 82 00 20 */	beq lbl_80CFE5E4
/* 80CFE5C8  3C 80 80 D0 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80CFE5CC  38 04 FE E8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80CFE5D0  90 1C 00 00 */	stw r0, 0(r28)
/* 80CFE5D4  38 80 00 00 */	li r4, 0
/* 80CFE5D8  4B 62 9E 24 */	b init__12J3DFrameCtrlFs
...
/* 80CFE604  3D 00 80 D0 */	lis r8, lit_3857@ha
/* 80CFE608  C0 28 FC E0 */	lfs f1, lit_3857@l(r8)
/* 80CFE60C  39 00 00 00 */	li r8, 0
/* 80CFE610  39 20 FF FF */	li r9, -1
/* 80CFE614  4B 30 EE 68 */	b init__13mDoExt_bpkAnmFP16J3DMaterialTableP11J3DAnmColoriifss
...
lbl_80CFE628:
/* 80CFE628  3C 60 80 D0 */	lis r3, lit_3858@ha
/* 80CFE62C  C0 03 FC E4 */	lfs f0, lit_3858@l(r3)
...
/* 80CFE658  4B 33 DD 24 */	b getRes__14dRes_control_cFPCcPCcP11dRes_info_ci
/* 80CFE65C  38 80 00 01 */	li r4, 1
/* 80CFE660  38 BF 05 74 */	addi r5, r31, 0x574
/* 80CFE664  4B 37 FE 5C */	b dBgW_NewSet__FP6cBgD_tUlPA3_A4_f
...
/* 80CFE67C  4B 66 3B A4 */	b _restgpr_27

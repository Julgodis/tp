...
/* 80C27E58 00000010  4B 73 A3 7C */	b _savegpr_27
/* 80C27E5C 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C27E60 00000018  3C 60 80 C3 */	lis r3, l_cyl_src@ha
/* 80C27E64 0000001C  3B E3 81 20 */	addi r31, r3, l_cyl_src@l
...
/* 80C27E80 00000038  3C 60 80 C3 */	lis r3, struct_80C281C4+0x0@ha
/* 80C27E84 0000003C  38 63 81 C4 */	addi r3, r3, struct_80C281C4+0x0@l
/* 80C27E88 00000040  38 63 00 2A */	addi r3, r3, 0x2a
/* 80C27E8C 00000044  38 80 00 20 */	li r4, 0x20
/* 80C27E90 00000048  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C27E94 0000004C  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C27EA8 00000060  4B 41 44 44 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C27EAC 00000064  7C 7C 1B 78 */	mr r28, r3
/* 80C27EB0 00000068  3C 60 80 C3 */	lis r3, struct_80C281C4+0x0@ha
/* 80C27EB4 0000006C  38 63 81 C4 */	addi r3, r3, struct_80C281C4+0x0@l
...
/* 80C27EC8 00000080  4B 41 44 24 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C27ED8 00000090  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C27EDC 00000094  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l
/* 80C27EE0 00000098  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
/* 80C27EE4 0000009C  3C 80 80 45 */	lis r4, mEcallback__18dPa_modelEcallBack@ha
/* 80C27EE8 000000A0  38 04 0E 90 */	addi r0, r4, mEcallback__18dPa_modelEcallBack@l
...
/* 80C27F28 000000E0  C0 3F 00 9C */	lfs f1, 0x9c(r31)	/* effective address: 80C281BC */
/* 80C27F2C 000000E4  4B 42 4B 64 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C27F48 00000100  4B 42 2C B8 */	b setModel__18dPa_modelEcallBackFP14JPABaseEmitterP12J3DModelDataRC12dKy_tevstr_cUcPvUcUc
/* 80C27F4C 00000104  38 BF 00 98 */	addi r5, r31, 0x98
/* 80C27F50 00000108  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C27F74 0000012C  A0 A5 00 00 */	lhz r5, 0(r5)	/* effective address: 80C281B8 */
...
/* 80C27F8C 00000144  C0 3F 00 9C */	lfs f1, 0x9c(r31)	/* effective address: 80C281BC */
/* 80C27F90 00000148  4B 42 4B 00 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C27FA0 00000158  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C27FA4 0000015C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C27FA8 00000160  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C27FBC 00000174  C0 3F 00 9C */	lfs f1, 0x9c(r31)	/* effective address: 80C281BC */
/* 80C27FC0 00000178  FC 40 08 90 */	fmr f2, f1
/* 80C27FC4 0000017C  C0 7F 00 A0 */	lfs f3, 0xa0(r31)	/* effective address: 80C281C0 */
/* 80C27FC8 00000180  FC 80 18 90 */	fmr f4, f3
/* 80C27FCC 00000184  39 00 00 00 */	li r8, 0
/* 80C27FD0 00000188  4B 68 39 B4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C27FD4 0000018C  39 61 00 50 */	addi r11, r1, 0x50
/* 80C27FD8 00000190  4B 73 A2 48 */	b _restgpr_27

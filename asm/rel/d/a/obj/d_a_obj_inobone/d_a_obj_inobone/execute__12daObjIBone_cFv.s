...
/* 80C27C5C  4B 73 A5 80 */	b _savegpr_29
/* 80C27C60  7C 7F 1B 78 */	mr r31, r3
/* 80C27C64  3C 80 80 C3 */	lis r4, l_cyl_src@ha
/* 80C27C68  3B A4 81 20 */	addi r29, r4, l_cyl_src@l
/* 80C27C6C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C27C70  3B C4 61 C0 */	addi r30, r4, struct_804061C0+0x0@l
/* 80C27C74  80 9E 5D AC */	lwz r4, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 80C27C78  4B 3F 2C EC */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
lbl_80C27CC4:
/* 80C27CC4  3C 60 80 C2 */	lis r3, s_boar_sub__FPvPv@ha
/* 80C27CC8  38 63 77 80 */	addi r3, r3, s_boar_sub__FPvPv@l
/* 80C27CCC  7F E4 FB 78 */	mr r4, r31
/* 80C27CD0  4B 3F 1B 28 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80C27D24  4B 3F 44 94 */	b fopAcM_createItemForDirectGet__FPC4cXyziiPC5csXyzPC4cXyzff
/* 80C27D28  7F E3 FB 78 */	mr r3, r31
/* 80C27D2C  48 00 01 1D */	bl setBreakEffect__12daObjIBone_cFv
/* 80C27D30  7F E3 FB 78 */	mr r3, r31
/* 80C27D34  4B 3F 1F 48 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 80C27D4C  4B 63 F6 A8 */	b __ct__5csXyzFsss
...
/* 80C27DC4  4B 69 66 E0 */	b startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
lbl_80C27DC8:
/* 80C27DC8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80C27DCC  7C 03 07 74 */	extsb r3, r0
/* 80C27DD0  4B 40 52 9C */	b dComIfGp_getReverb__Fi
...
/* 80C27DF8  4B 64 73 E4 */	b SetC__8cM3dGCylFRC4cXyz
/* 80C27DFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C27E00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C27E04  3B A3 23 3C */	addi r29, r3, 0x233c
/* 80C27E08  7F A3 EB 78 */	mr r3, r29
/* 80C27E0C  38 9F 05 B0 */	addi r4, r31, 0x5b0
/* 80C27E10  4B 63 CD 98 */	b Set__4cCcSFP8cCcD_Obj
/* 80C27E14  38 7F 08 10 */	addi r3, r31, 0x810
/* 80C27E18  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C27E1C  4B 64 73 C0 */	b SetC__8cM3dGCylFRC4cXyz
/* 80C27E20  7F A3 EB 78 */	mr r3, r29
/* 80C27E24  38 9F 06 EC */	addi r4, r31, 0x6ec
/* 80C27E28  4B 63 CD 80 */	b Set__4cCcSFP8cCcD_Obj
/* 80C27E2C  38 60 00 01 */	li r3, 1
/* 80C27E30  39 61 00 20 */	addi r11, r1, 0x20
/* 80C27E34  4B 73 A3 F4 */	b _restgpr_29

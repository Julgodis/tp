...
/* 80C2B4EC 00000018  3C 80 80 C3 */	lis r4, lit_3775@ha
/* 80C2B4F0 0000001C  3B E4 E1 10 */	addi r31, r4, lit_3775@l
...
lbl_80C2B510:
/* 80C2B510 00000000  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 80C2E164 */
/* 80C2B514 00000004  D0 1E 05 2C */	stfs f0, 0x52c(r30)
/* 80C2B518 00000008  3C 60 80 C3 */	lis r3, stringBase0@ha
/* 80C2B51C 0000000C  38 63 E2 18 */	addi r3, r3, stringBase0@l
/* 80C2B520 00000010  38 80 00 07 */	li r4, 7
/* 80C2B524 00000014  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2B528 00000018  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B538 00000028  4B 41 0D B4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2B548 00000038  C0 3F 00 58 */	lfs f1, 0x58(r31)	/* effective address: 80C2E168 */
/* 80C2B54C 0000003C  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 80C2E164 */
/* 80C2B550 00000040  FC 60 10 90 */	fmr f3, f2
/* 80C2B554 00000044  C0 9F 00 5C */	lfs f4, 0x5c(r31)	/* effective address: 80C2E16C */
/* 80C2B558 00000048  4B 3E 59 18 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C2B568 00000058  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 80C2E170 */
/* 80C2B56C 0000005C  4B 63 C3 E8 */	b cM_rndF__Ff
/* 80C2B570 00000060  C0 1F 00 60 */	lfs f0, 0x60(r31)	/* effective address: 80C2E170 */
...
lbl_80C2B58C:
/* 80C2B58C 00000000  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C2B590 00000004  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80C2B594 00000008  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C2B598 0000000C  4B 3E F2 48 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80C2B59C 00000010  C0 1F 00 68 */	lfs f0, 0x68(r31)	/* effective address: 80C2E178 */
...
/* 80C2B5D4 0000000C  C0 3F 00 64 */	lfs f1, 0x64(r31)	/* effective address: 80C2E174 */
/* 80C2B5D8 00000010  4B 63 C3 7C */	b cM_rndF__Ff

...
/* 80C2AFAC 00000024  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2AFB0 00000028  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2AFB4 0000002C  38 80 00 0A */	li r4, 0xa
/* 80C2AFB8 00000030  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2AFBC 00000034  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
lbl_80C2AFD8:
/* 80C2AFD8 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2AFDC 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2AFE0 00000008  38 80 00 0B */	li r4, 0xb
/* 80C2AFE4 0000000C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2AFE8 00000010  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B010 00000010  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2B014 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2B018 00000018  38 80 00 07 */	li r4, 7
/* 80C2B01C 0000001C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2B020 00000020  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B068 00000068  3D 20 00 00 */	lis r9, lit_3775@ha
/* 80C2B06C 0000006C  C0 29 00 00 */	lfs f1, lit_3775@l(r9)
...
/* 80C2B0B4 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C2B0B8 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C2B0F4 0000000C  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2B0F8 00000010  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2B0FC 00000014  38 80 00 0E */	li r4, 0xe
/* 80C2B100 00000018  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2B104 0000001C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B130 00000048  3D 00 00 00 */	lis r8, lit_3896@ha
/* 80C2B134 0000004C  C0 28 00 00 */	lfs f1, lit_3896@l(r8)
...
lbl_80C2B154:
/* 80C2B154 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2B158 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2B15C 00000008  38 80 00 0F */	li r4, 0xf
/* 80C2B160 0000000C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2B164 00000010  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B190 0000003C  3D 00 00 00 */	lis r8, lit_3896@ha
/* 80C2B194 00000040  C0 28 00 00 */	lfs f1, lit_3896@l(r8)
...
/* 80C2B1C4 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C2B1C8 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C2B204 0000000C  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2B208 00000010  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2B20C 00000014  38 80 00 12 */	li r4, 0x12
/* 80C2B210 00000018  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2B214 0000001C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B240 00000048  3D 00 00 00 */	lis r8, lit_3896@ha
/* 80C2B244 0000004C  C0 28 00 00 */	lfs f1, lit_3896@l(r8)
...
lbl_80C2B264:
/* 80C2B264 00000000  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C2B268 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C2B26C 00000008  38 80 00 13 */	li r4, 0x13
/* 80C2B270 0000000C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C2B274 00000010  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C2B2A0 0000003C  3D 00 00 00 */	lis r8, lit_3896@ha
/* 80C2B2A4 00000040  C0 28 00 00 */	lfs f1, lit_3896@l(r8)

...
/* 80C2B9B0  4B 73 68 2C */	b _savegpr_29
/* 80C2B9B4  7C 7D 1B 78 */	mr r29, r3
/* 80C2B9B8  3C 60 80 C3 */	lis r3, lit_3775@ha
/* 80C2B9BC  3B C3 E1 10 */	addi r30, r3, lit_3775@l
/* 80C2B9C0  C0 3E 00 98 */	lfs f1, 0x98(r30)	/* effective address: 80C2E1A8 */
/* 80C2B9C4  C0 1D 05 2C */	lfs f0, 0x52c(r29)
/* 80C2B9C8  EC 41 00 32 */	fmuls f2, f1, f0
/* 80C2B9CC  C0 3E 00 54 */	lfs f1, 0x54(r30)	/* effective address: 80C2E164 */
/* 80C2B9D0  D0 21 00 4C */	stfs f1, 0x4c(r1)
/* 80C2B9D4  C0 1E 00 9C */	lfs f0, 0x9c(r30)	/* effective address: 80C2E1AC */
/* 80C2B9D8  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 80C2B9DC  D0 41 00 54 */	stfs f2, 0x54(r1)
/* 80C2B9E0  D0 21 00 40 */	stfs f1, 0x40(r1)
/* 80C2B9E4  C0 1E 00 A0 */	lfs f0, 0xa0(r30)	/* effective address: 80C2E1B0 */
/* 80C2B9E8  D0 01 00 44 */	stfs f0, 0x44(r1)
/* 80C2B9EC  D0 21 00 48 */	stfs f1, 0x48(r1)
/* 80C2B9F0  D0 21 00 34 */	stfs f1, 0x34(r1)
/* 80C2B9F4  C0 1E 00 4C */	lfs f0, 0x4c(r30)	/* effective address: 80C2E15C */
/* 80C2B9F8  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 80C2B9FC  C0 1E 00 64 */	lfs f0, 0x64(r30)	/* effective address: 80C2E174 */
/* 80C2BA00  D0 01 00 3C */	stfs f0, 0x3c(r1)
/* 80C2BA04  38 61 00 DC */	addi r3, r1, 0xdc
/* 80C2BA08  4B 44 C2 60 */	b __ct__11dBgS_LinChkFv
/* 80C2BA0C  38 61 00 6C */	addi r3, r1, 0x6c
/* 80C2BA10  4B 44 C2 58 */	b __ct__11dBgS_LinChkFv
/* 80C2BA14  38 61 01 34 */	addi r3, r1, 0x134
/* 80C2BA18  4B 44 D4 50 */	b SetObj__16dBgS_PolyPassChkFv
/* 80C2BA1C  38 61 00 C4 */	addi r3, r1, 0xc4
/* 80C2BA20  4B 44 D4 48 */	b SetObj__16dBgS_PolyPassChkFv
/* 80C2BA24  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80C2BA28  4B 3E 13 3C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C2BA2C  38 7D 07 2A */	addi r3, r29, 0x72a
/* 80C2BA30  4B 3E 15 14 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C2BA34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2BA38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2BA3C  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 80C2BA40  4B 3E 09 F4 */	b mDoMtx_YrotM__FPA4_fs
/* 80C2BA44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2BA48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2BA4C  38 81 00 4C */	addi r4, r1, 0x4c
/* 80C2BA50  7C 85 23 78 */	mr r5, r4
/* 80C2BA54  4B 71 B3 18 */	b PSMTXMultVec
/* 80C2BA58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2BA5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2BA60  38 81 00 40 */	addi r4, r1, 0x40
/* 80C2BA64  7C 85 23 78 */	mr r5, r4
/* 80C2BA68  4B 71 B3 04 */	b PSMTXMultVec
...
/* 80C2BA7C  4B 44 C2 E8 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C2BA80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C2BA84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C2BA88  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 80C2BA8C  7F E3 FB 78 */	mr r3, r31
/* 80C2BA90  38 81 00 DC */	addi r4, r1, 0xdc
/* 80C2BA94  4B 44 89 20 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 80C2BAA8  3C 60 80 C3 */	lis r3, __vt__8cM3dGPla@ha
/* 80C2BAAC  38 03 E2 C0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C2BAC0  4B 44 8C 84 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 80C2BAC4  C0 21 00 58 */	lfs f1, 0x58(r1)
/* 80C2BAC8  C0 41 00 60 */	lfs f2, 0x60(r1)
/* 80C2BACC  4B 63 BB A8 */	b cM_atan2s__Fff
...
/* 80C2BB00  4B 71 B8 9C */	b PSVECSquareDistance
...
/* 80C2BB70  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2BB74  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C2BBE0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2BBE4  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80C2BC2C  4B 71 B7 70 */	b PSVECSquareDistance
...
/* 80C2BC9C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2BCA0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C2BD10  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C2BD14:
...
/* 80C2BD48  4B 63 B9 2C */	b cM_atan2s__Fff
...
/* 80C2BD5C  4B 63 B9 18 */	b cM_atan2s__Fff
...
lbl_80C2BD78:
/* 80C2BD78  3C 60 80 C3 */	lis r3, __vt__8cM3dGPla@ha
/* 80C2BD7C  38 03 E2 C0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C2BDA4  4B 64 48 64 */	b cLib_addCalcAngleS2__FPssss

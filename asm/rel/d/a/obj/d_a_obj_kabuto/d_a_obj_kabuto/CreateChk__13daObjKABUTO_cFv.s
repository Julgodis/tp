...
/* 80C2D5B8 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C2D5BC 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C2D5C0 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C2D5C4 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C2D5C8 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C2E200 */
/* 80C2D5CC 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4) /* 80C2E200 */
/* 80C2D5D0 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C2D5D4 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C2D5D8 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80C2D5F0 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C2E200 */
/* 80C2D5F4 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C2E200 */
/* 80C2D5F8 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C2D5FC 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C2D600 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C2D604 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
lbl_80C2D620:
/* 80C2D620 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80C2E218 */
/* 80C2D624 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80C2E218 */
/* 80C2D628 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80C2D62C 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C2D630 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C2D644 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C2D648 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C2D65C 0000003C  3C 60 00 00 */	lis r3, l_kab_itemno@ha /* 80C2E1E0 */
/* 80C2D660 00000040  38 63 00 00 */	addi r3, r3, l_kab_itemno@l /* 80C2E1E0 */
...
/* 80C2D688 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C2D68C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C2D690 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C2D694 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C2D698 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C2E200 */
/* 80C2D69C 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C2E200 */
/* 80C2D6A0 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C2D6A4 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C2D6A8 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C2D6AC 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80C2D6CC 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C2D6D0 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C2D6D4 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C2D6D8 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C2D6DC 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80C2E200 */
/* 80C2D6E0 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80C2E200 */
/* 80C2D6E4 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C2D6E8 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C2D6EC 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C2D6F0 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

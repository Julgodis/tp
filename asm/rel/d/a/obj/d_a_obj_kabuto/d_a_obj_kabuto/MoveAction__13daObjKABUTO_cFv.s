...
/* 80C2BFF8  4B 73 61 E0 */	b _savegpr_28
/* 80C2BFFC  7C 7C 1B 78 */	mr r28, r3
/* 80C2C000  3C 60 80 C3 */	lis r3, lit_3775@ha
/* 80C2C004  3B E3 E1 10 */	addi r31, r3, lit_3775@l
...
/* 80C2C040  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C2C044  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C2C048  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80C2C064  4B 44 BC 04 */	b __ct__11dBgS_LinChkFv
...
lbl_80C2C090:
/* 80C2C090  3C 60 80 C3 */	lis r3, stringBase0@ha
/* 80C2C094  38 63 E2 18 */	addi r3, r3, stringBase0@l
/* 80C2C098  38 80 00 06 */	li r4, 6
/* 80C2C09C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C2C0A0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C2C0A4  3C A5 00 02 */	addis r5, r5, 2
/* 80C2C0A8  38 C0 00 80 */	li r6, 0x80
/* 80C2C0AC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C2C0B0  4B 41 02 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2C0D0  4B 3E 4D A0 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C2C120  4B 3E 0D EC */	b ZXYrotS__14mDoMtx_stack_cFRC5csXyz
/* 80C2C124  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C2C128  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C2C12C  38 81 00 38 */	addi r4, r1, 0x38
/* 80C2C130  7C 85 23 78 */	mr r5, r4
/* 80C2C134  4B 71 AC 38 */	b PSMTXMultVec
/* 80C2C138  C0 3F 00 8C */	lfs f1, 0x8c(r31)
/* 80C2C13C  4B 63 B8 18 */	b cM_rndF__Ff
...
/* 80C2C168  4B 63 B7 EC */	b cM_rndF__Ff
...
/* 80C2C18C  4B 63 B7 C8 */	b cM_rndF__Ff
...
/* 80C2C1AC  4B 63 B7 A8 */	b cM_rndF__Ff
...
/* 80C2C27C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2C280  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C2C2EC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2C2F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C2C2F4:
...
/* 80C2C320  4B 64 42 E8 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C2C338  4B 64 42 D0 */	b cLib_addCalcAngleS2__FPssss
lbl_80C2C33C:
/* 80C2C33C  7F A3 EB 78 */	mr r3, r29
/* 80C2C340  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 80C2C344  4B 71 B0 58 */	b PSVECSquareDistance
...
/* 80C2C3B4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2C3B8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80C2C424  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C2C428  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80C2C42C:
...
/* 80C2C470  4B 64 47 94 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80C2C488  4B 64 49 38 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 80C2C4E8  3C 60 80 C3 */	lis r3, stringBase0@ha
/* 80C2C4EC  38 63 E2 18 */	addi r3, r3, stringBase0@l
/* 80C2C4F0  38 80 00 07 */	li r4, 7
/* 80C2C4F4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C2C4F8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C2C4FC  3C A5 00 02 */	addis r5, r5, 2
/* 80C2C500  38 C0 00 80 */	li r6, 0x80
/* 80C2C504  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C2C508  4B 40 FD E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2C528  4B 3E 49 48 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 80C2C56C  3C 60 80 C3 */	lis r3, stringBase0@ha
/* 80C2C570  38 63 E2 18 */	addi r3, r3, stringBase0@l
/* 80C2C574  38 80 00 06 */	li r4, 6
/* 80C2C578  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C2C57C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80C2C580  3C A5 00 02 */	addis r5, r5, 2
/* 80C2C584  38 C0 00 80 */	li r6, 0x80
/* 80C2C588  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80C2C58C  4B 40 FD 60 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C2C5AC  4B 3E 48 C4 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
lbl_80C2C5B0:
...
/* 80C2C5D0  4B 63 A5 64 */	b __mi__4cXyzCFRC3Vec
...
/* 80C2C5F0  4B 63 B3 9C */	b cM_rndFX__Ff
...
/* 80C2C604  4B 63 B3 88 */	b cM_rndFX__Ff
...
/* 80C2C644  4B 63 B3 10 */	b cM_rndF__Ff
...
/* 80C2C6B4  4B 64 3F 54 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C2C6C8  4B 64 3F 40 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C2C6E0  4B 64 3F 28 */	b cLib_addCalcAngleS2__FPssss
...
/* 80C2C6F4  4B 64 3F 14 */	b cLib_addCalcAngleS2__FPssss
lbl_80C2C6F8:
...
/* 80C2C710  4B 64 44 80 */	b cLib_chaseAngleS__FPsss
lbl_80C2C714:
...
/* 80C2C760  4B 64 3E A8 */	b cLib_addCalcAngleS2__FPssss
lbl_80C2C764:
...
/* 80C2C7AC  4B 44 B5 30 */	b __dt__11dBgS_LinChkFv
/* 80C2C7B0  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80C2C7B4  4B 73 5A 70 */	b _restgpr_28

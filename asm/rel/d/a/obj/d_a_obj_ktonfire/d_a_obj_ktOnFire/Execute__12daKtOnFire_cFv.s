...
/* 8058CA40  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8058CA44  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8058CA74  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8058CA78  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8058CB18  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8058CB48  88 03 00 04 */	lbz r0, 4(r3)	/* effective address: 8058D0D0 */
...
/* 8058CBAC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8058CBDC  88 03 00 04 */	lbz r0, 4(r3)	/* effective address: 8058D0D0 */
...
/* 8058CC10  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8058CC14  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8058CC30  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8058CC34  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 8058CC38  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 8058CD4C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8058CDA0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8058CDA4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_8058CDC0:
/* 8058CDC0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8058CDC4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l

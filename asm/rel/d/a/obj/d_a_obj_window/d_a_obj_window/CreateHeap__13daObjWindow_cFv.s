...
/* 80D38900  4B 62 98 DC */	b _savegpr_29
/* 80D38904  7C 7F 1B 78 */	mr r31, r3
/* 80D38908  3C 60 80 D4 */	lis r3, l_arcName@ha
/* 80D3890C  38 63 92 84 */	addi r3, r3, l_arcName@l
/* 80D38910  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D39284 */
/* 80D38914  38 80 00 09 */	li r4, 9
/* 80D38918  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D3891C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D38930  4B 30 39 BC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D38940  4B 2D C3 14 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80D38964  3C 60 80 D4 */	lis r3, l_bck@ha
/* 80D38968  38 63 92 2C */	addi r3, r3, l_bck@l
/* 80D3896C  7C 83 00 2E */	lwzx r4, r3, r0
/* 80D38970  2C 04 00 00 */	cmpwi r4, 0
/* 80D38974  40 81 00 90 */	ble lbl_80D38A04
/* 80D38978  3C 60 80 D4 */	lis r3, l_arcName@ha
/* 80D3897C  38 63 92 84 */	addi r3, r3, l_arcName@l
/* 80D38980  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D39284 */
/* 80D38984  7F C5 F3 78 */	mr r5, r30
/* 80D38988  38 C0 00 80 */	li r6, 0x80
/* 80D3898C  4B 30 39 60 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D38990  7C 7D 1B 78 */	mr r29, r3
/* 80D38994  38 60 00 1C */	li r3, 0x1c
/* 80D38998  4B 59 62 B4 */	b __nw__FUl
/* 80D3899C  7C 7E 1B 79 */	or. r30, r3, r3
/* 80D389A0  41 82 00 20 */	beq lbl_80D389C0
/* 80D389A4  3C 80 80 D4 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D389A8  38 04 93 34 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D389AC  90 1E 00 00 */	stw r0, 0(r30)
/* 80D389B0  38 80 00 00 */	li r4, 0
/* 80D389B4  4B 5E FA 48 */	b init__12J3DFrameCtrlFs
...
/* 80D389DC  3C E0 80 D4 */	lis r7, lit_3696@ha
/* 80D389E0  C0 27 92 48 */	lfs f1, lit_3696@l(r7)
/* 80D389E4  38 E0 00 00 */	li r7, 0
/* 80D389E8  39 00 FF FF */	li r8, -1
/* 80D389EC  39 20 00 00 */	li r9, 0
/* 80D389F0  4B 2D 4D EC */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80D38A0C  4B 62 98 1C */	b _restgpr_29

...
/* 80D44FC0  4B 61 D2 1C */	b _savegpr_29
/* 80D44FC4  7C 7F 1B 78 */	mr r31, r3
/* 80D44FC8  3C 60 80 D4 */	lis r3, l_arcName@ha
/* 80D44FCC  38 63 55 F0 */	addi r3, r3, l_arcName@l
/* 80D44FD0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D455F0 */
/* 80D44FD4  38 80 00 06 */	li r4, 6
/* 80D44FD8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D44FDC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D44FF0  4B 2F 72 FC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D45000  4B 2C FC 54 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D4501C:
/* 80D4501C  3C 60 80 D4 */	lis r3, l_arcName@ha
/* 80D45020  38 63 55 F0 */	addi r3, r3, l_arcName@l
/* 80D45024  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D455F0 */
/* 80D45028  38 80 00 05 */	li r4, 5
/* 80D4502C  7F A5 EB 78 */	mr r5, r29
/* 80D45030  38 C0 00 80 */	li r6, 0x80
/* 80D45034  4B 2F 72 B8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D45048  4B 2C FC 0C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D45064:
/* 80D45064  3C 60 80 D4 */	lis r3, l_arcName@ha
/* 80D45068  38 63 55 F0 */	addi r3, r3, l_arcName@l
/* 80D4506C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D455F0 */
/* 80D45070  38 80 00 09 */	li r4, 9
/* 80D45074  7F A5 EB 78 */	mr r5, r29
/* 80D45078  38 C0 00 80 */	li r6, 0x80
/* 80D4507C  4B 2F 72 70 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D45094  3D 00 80 D4 */	lis r8, lit_3903@ha
/* 80D45098  C0 28 55 D0 */	lfs f1, lit_3903@l(r8)
/* 80D4509C  39 00 00 00 */	li r8, 0
/* 80D450A0  39 20 FF FF */	li r9, -1
/* 80D450A4  4B 2C 86 68 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80D450B8:
/* 80D450B8  3C 60 80 D4 */	lis r3, lit_3816@ha
/* 80D450BC  C0 03 55 CC */	lfs f0, lit_3816@l(r3)
/* 80D450C0  D0 1F 05 BC */	stfs f0, 0x5bc(r31)
/* 80D450C4  38 60 00 01 */	li r3, 1
lbl_80D450C8:
/* 80D450C8  39 61 00 20 */	addi r11, r1, 0x20
/* 80D450CC  4B 61 D1 5C */	b _restgpr_29

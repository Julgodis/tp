...
/* 8059C580  4B CC BC 54 */	b ChkUsed__9cBgW_BgIdCFv
/* 8059C584  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8059C588  41 82 00 18 */	beq lbl_8059C5A0
/* 8059C58C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8059C590  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8059C594  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8059C598  80 9F 05 B8 */	lwz r4, 0x5b8(r31)
/* 8059C59C  4B AD 7C B4 */	b Release__4cBgSFP9dBgW_Base
lbl_8059C5A0:
/* 8059C5A0  38 7F 05 A0 */	addi r3, r31, 0x5a0
/* 8059C5A4  3C 80 80 5A */	lis r4, l_arcName@ha
/* 8059C5A8  38 84 C6 FC */	addi r4, r4, l_arcName@l
/* 8059C5AC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 8059C6FC */
/* 8059C5B0  4B A9 0A 58 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc

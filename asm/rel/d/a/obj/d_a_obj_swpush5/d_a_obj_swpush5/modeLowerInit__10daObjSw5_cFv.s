...
/* 8059C254 00000018  3C 60 80 5A */	lis r3, l_dzbIdx@ha
/* 8059C258 0000001C  3B E3 C6 A4 */	addi r31, r3, l_dzbIdx@l
/* 8059C25C 00000020  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8059C260 00000024  7C 03 07 74 */	extsb r3, r0
/* 8059C264 00000028  4B A9 0E 08 */	b dComIfGp_getReverb__Fi
...
/* 8059C278 0000003C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8059C27C 00000040  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8059C280 00000044  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8059C290 00000054  C0 3F 00 20 */	lfs f1, 0x20(r31)	/* effective address: 8059C6C4 */
/* 8059C294 00000058  FC 40 08 90 */	fmr f2, f1
/* 8059C298 0000005C  C0 7F 00 24 */	lfs f3, 0x24(r31)	/* effective address: 8059C6C8 */
/* 8059C29C 00000060  FC 80 18 90 */	fmr f4, f3
/* 8059C2A0 00000064  39 00 00 00 */	li r8, 0
/* 8059C2A4 00000068  4B D0 F6 E0 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8059C2A8 0000006C  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 8059C6B0 */

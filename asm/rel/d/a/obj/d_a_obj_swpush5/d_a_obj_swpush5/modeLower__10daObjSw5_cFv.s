...
/* 8059C2E4  3C 60 80 5A */	lis r3, l_dzbIdx@ha
/* 8059C2E8  38 63 C6 A4 */	addi r3, r3, l_dzbIdx@l
/* 8059C2EC  C0 23 00 14 */	lfs f1, 0x14(r3)	/* effective address: 8059C6B8 */
...
/* 8059C310  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8059C314  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8059C328  4B AD 36 FC */	b StartShock__12dVibration_cFii4cXyz
/* 8059C32C  7F E3 FB 78 */	mr r3, r31
/* 8059C330  48 00 00 35 */	bl modeWaitUpperInit__10daObjSw5_cFv
/* 8059C334  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8059C338  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8059C34C  4B A9 8E B4 */	b onSwitch__10dSv_info_cFii
lbl_8059C350:

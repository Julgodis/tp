...
/* 80CA195C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CA1960  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80CA1964  80 64 5D AC */	lwz r3, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80CA1968  A8 63 04 DE */	lha r3, 0x4de(r3)	/* effective address: 804004DE */
/* 80CA196C  38 03 C0 00 */	addi r0, r3, -16384
/* 80CA1970  B0 1F 04 DE */	sth r0, 0x4de(r31)
/* 80CA1974  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80CA1978  38 63 32 A0 */	addi r3, r3, stringBase0@l
/* 80CA197C  38 63 00 06 */	addi r3, r3, 6
/* 80CA1980  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80CA1984  4B 6C 70 10 */	b strcmp
/* 80CA1988  2C 03 00 00 */	cmpwi r3, 0
/* 80CA198C  40 82 00 54 */	bne lbl_80CA19E0
/* 80CA1990  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CA1994  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CA1998  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
...
/* 80CA19B0  3C 60 80 CA */	lis r3, lit_4318@ha
/* 80CA19B4  38 83 33 58 */	addi r4, r3, lit_4318@l
/* 80CA19B8  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80CA3358 */
/* 80CA19BC  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80CA335C */
/* 80CA19C0  90 61 00 14 */	stw r3, 0x14(r1)
/* 80CA19C4  90 01 00 18 */	stw r0, 0x18(r1)
/* 80CA19C8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80CA3360 */
...
lbl_80CA19E0:
/* 80CA19E0  3C 60 80 CA */	lis r3, lit_4321@ha
/* 80CA19E4  38 83 33 64 */	addi r4, r3, lit_4321@l
/* 80CA19E8  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80CA3364 */
/* 80CA19EC  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80CA3368 */
/* 80CA19F0  90 61 00 08 */	stw r3, 8(r1)
/* 80CA19F4  90 01 00 0C */	stw r0, 0xc(r1)
/* 80CA19F8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80CA336C */

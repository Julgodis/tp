...
/* 80CA0A44  4B 6C 17 98 */	b _savegpr_29
/* 80CA0A48  7C 7F 1B 78 */	mr r31, r3
/* 80CA0A4C  3C 60 80 CA */	lis r3, lit_3774@ha
/* 80CA0A50  3B C3 31 BC */	addi r30, r3, lit_3774@l
...
/* 80CA0A84  4B 3D 71 E4 */	b __ct__11dBgS_LinChkFv
...
/* 80CA0AB0  4B 36 C2 B4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CA0AB4  38 7F 07 D4 */	addi r3, r31, 0x7d4
/* 80CA0AB8  4B 36 C4 8C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CA0ABC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CA0AC0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CA0AC4  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 80CA0AC8  4B 36 B9 6C */	b mDoMtx_YrotM__FPA4_fs
/* 80CA0ACC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CA0AD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CA0AD4  38 81 00 3C */	addi r4, r1, 0x3c
/* 80CA0AD8  7C 85 23 78 */	mr r5, r4
/* 80CA0ADC  4B 6A 62 90 */	b PSMTXMultVec
/* 80CA0AE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CA0AE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CA0AE8  38 81 00 30 */	addi r4, r1, 0x30
/* 80CA0AEC  7C 85 23 78 */	mr r5, r4
/* 80CA0AF0  4B 6A 62 7C */	b PSMTXMultVec
/* 80CA0AF4  38 61 00 B4 */	addi r3, r1, 0xb4
/* 80CA0AF8  4B 3D 83 70 */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80CA0B0C  4B 3D 72 58 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CA0B10  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CA0B14  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CA0B18  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80CA0B1C  7F A3 EB 78 */	mr r3, r29
/* 80CA0B20  38 81 00 5C */	addi r4, r1, 0x5c
/* 80CA0B24  4B 3D 38 90 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80CA0B28  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CA0B2C  41 82 01 8C */	beq lbl_80CA0CB8
/* 80CA0B30  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha
/* 80CA0B34  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80CA0B48  4B 3D 3B FC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CA0B78  4B 6A 68 24 */	b PSVECSquareDistance
...
/* 80CA0BE8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CA0BEC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80CA0C58  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CA0C5C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80CA0C88  4B 5C 69 EC */	b cM_atan2s__Fff
...
/* 80CA0C9C  4B 5C 69 D8 */	b cM_atan2s__Fff
/* 80CA0CA0  7C 03 00 D0 */	neg r0, r3
/* 80CA0CA4  B0 1F 07 DE */	sth r0, 0x7de(r31)
/* 80CA0CA8  B0 1F 07 D8 */	sth r0, 0x7d8(r31)
/* 80CA0CAC  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha
/* 80CA0CB0  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80CA0CDC  4B 5C FE B4 */	b cLib_chaseAngleS__FPsss
/* 80CA0CE0  2C 03 00 00 */	cmpwi r3, 0
/* 80CA0CE4  41 82 00 30 */	beq lbl_80CA0D14
/* 80CA0CE8  3C 60 80 CA */	lis r3, lit_3924@ha
/* 80CA0CEC  38 83 33 10 */	addi r4, r3, lit_3924@l
/* 80CA0CF0  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80CA3310 */
/* 80CA0CF4  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80CA3314 */
/* 80CA0CF8  90 61 00 0C */	stw r3, 0xc(r1)
/* 80CA0CFC  90 01 00 10 */	stw r0, 0x10(r1)
/* 80CA0D00  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80CA3318 */

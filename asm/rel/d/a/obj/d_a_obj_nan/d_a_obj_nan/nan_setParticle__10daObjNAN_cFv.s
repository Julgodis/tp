...
/* 80CA1B6C 0000001C  4B 6C 05 40 */	b __cvt_fp2unsigned
...
/* 80CA1B80 00000030  3C 80 80 CA */	lis r4, lit_3870@ha
/* 80CA1B84 00000034  C0 24 31 D8 */	lfs f1, lit_3870@l(r4)
/* 80CA1B88 00000038  3C 80 80 CA */	lis r4, lit_3868@ha
/* 80CA1B8C 0000003C  C0 44 31 D0 */	lfs f2, lit_3868@l(r4)
/* 80CA1B90 00000040  4B 5C EB B0 */	b cLib_chaseF__FPfff
/* 80CA1B94 00000044  48 00 00 18 */	b lbl_80CA1BAC
lbl_80CA1B98:
/* 80CA1B98 00000000  38 7F 07 E8 */	addi r3, r31, 0x7e8
/* 80CA1B9C 00000004  3C 80 80 CA */	lis r4, lit_3868@ha
/* 80CA1BA0 00000008  C0 24 31 D0 */	lfs f1, lit_3868@l(r4)
/* 80CA1BA4 0000000C  FC 40 08 90 */	fmr f2, f1
/* 80CA1BA8 00000010  4B 5C EB 98 */	b cLib_chaseF__FPfff
lbl_80CA1BAC:
...
/* 80CA1BB8 0000000C  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80CA1BBC 00000010  38 63 32 A0 */	addi r3, r3, stringBase0@l
/* 80CA1BC0 00000014  38 63 00 06 */	addi r3, r3, 6
/* 80CA1BC4 00000018  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80CA1BC8 0000001C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80CA1BCC 00000020  3B C4 4E 00 */	addi r30, r4, 0x4e00
/* 80CA1BD0 00000024  7F C4 F3 78 */	mr r4, r30
/* 80CA1BD4 00000028  4B 6C 6D C0 */	b strcmp
/* 80CA1BD8 0000002C  2C 03 00 00 */	cmpwi r3, 0
/* 80CA1BDC 00000030  40 82 00 34 */	bne lbl_80CA1C10
/* 80CA1BE0 00000034  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80CA1BE4 00000038  38 63 32 A0 */	addi r3, r3, stringBase0@l
/* 80CA1BE8 0000003C  38 63 00 06 */	addi r3, r3, 6
/* 80CA1BEC 00000040  7F C4 F3 78 */	mr r4, r30
/* 80CA1BF0 00000044  4B 6C 6D A4 */	b strcmp
/* 80CA1BF4 00000048  2C 03 00 00 */	cmpwi r3, 0
/* 80CA1BF8 0000004C  40 82 01 4C */	bne lbl_80CA1D44
/* 80CA1BFC 00000050  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CA1C00 00000054  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CA1C04 00000058  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80CA1C08 0000005C  2C 00 00 03 */	cmpwi r0, 3
/* 80CA1C0C 00000060  41 82 01 38 */	beq lbl_80CA1D44
lbl_80CA1C10:
/* 80CA1C10 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CA1C14 00000004  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l
/* 80CA1C18 00000008  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80CA1C5C 0000004C  3D 60 80 CA */	lis r11, lit_3868@ha
/* 80CA1C60 00000050  C0 2B 31 D0 */	lfs f1, lit_3868@l(r11)
/* 80CA1C64 00000054  4B 3A B8 68 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80CA1C68 00000058  90 7F 05 70 */	stw r3, 0x570(r31)
/* 80CA1C6C 0000005C  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
/* 80CA1C70 00000060  38 63 02 10 */	addi r3, r3, 0x210
/* 80CA1C74 00000064  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80CA1C78 00000068  4B 3A 9C A0 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
lbl_80CA1C98:
/* 80CA1C98 00000000  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80CA1CDC 00000044  3D 60 80 CA */	lis r11, lit_3868@ha
/* 80CA1CE0 00000048  C0 2B 31 D0 */	lfs f1, lit_3868@l(r11)
/* 80CA1CE4 0000004C  4B 3A B7 E8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80CA1CE8 00000050  90 7F 05 74 */	stw r3, 0x574(r31)
/* 80CA1CEC 00000054  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
/* 80CA1CF0 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 80CA1CF4 0000005C  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80CA1CF8 00000060  4B 3A 9C 20 */	b getEmitter__Q213dPa_control_c7level_cFUl

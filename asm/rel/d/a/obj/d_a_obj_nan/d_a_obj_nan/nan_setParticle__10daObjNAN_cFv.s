...
/* 80CA1B6C  4B 6C 05 40 */	b __cvt_fp2unsigned
...
/* 80CA1B80  3C 80 80 CA */	lis r4, lit_3870@ha
/* 80CA1B84  C0 24 31 D8 */	lfs f1, lit_3870@l(r4)
/* 80CA1B88  3C 80 80 CA */	lis r4, lit_3868@ha
/* 80CA1B8C  C0 44 31 D0 */	lfs f2, lit_3868@l(r4)
/* 80CA1B90  4B 5C EB B0 */	b cLib_chaseF__FPfff
/* 80CA1B94  48 00 00 18 */	b lbl_80CA1BAC
lbl_80CA1B98:
/* 80CA1B98  38 7F 07 E8 */	addi r3, r31, 0x7e8
/* 80CA1B9C  3C 80 80 CA */	lis r4, lit_3868@ha
/* 80CA1BA0  C0 24 31 D0 */	lfs f1, lit_3868@l(r4)
/* 80CA1BA4  FC 40 08 90 */	fmr f2, f1
/* 80CA1BA8  4B 5C EB 98 */	b cLib_chaseF__FPfff
lbl_80CA1BAC:
/* 80CA1BAC  88 1F 07 FA */	lbz r0, 0x7fa(r31)
/* 80CA1BB0  28 00 00 02 */	cmplwi r0, 2
/* 80CA1BB4  41 82 01 90 */	beq lbl_80CA1D44
/* 80CA1BB8  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80CA1BBC  38 63 32 A0 */	addi r3, r3, stringBase0@l
/* 80CA1BC0  38 63 00 06 */	addi r3, r3, 6
/* 80CA1BC4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80CA1BC8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80CA1BCC  3B C4 4E 00 */	addi r30, r4, 0x4e00
/* 80CA1BD0  7F C4 F3 78 */	mr r4, r30
/* 80CA1BD4  4B 6C 6D C0 */	b strcmp
/* 80CA1BD8  2C 03 00 00 */	cmpwi r3, 0
/* 80CA1BDC  40 82 00 34 */	bne lbl_80CA1C10
/* 80CA1BE0  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80CA1BE4  38 63 32 A0 */	addi r3, r3, stringBase0@l
/* 80CA1BE8  38 63 00 06 */	addi r3, r3, 6
/* 80CA1BEC  7F C4 F3 78 */	mr r4, r30
/* 80CA1BF0  4B 6C 6D A4 */	b strcmp
/* 80CA1BF4  2C 03 00 00 */	cmpwi r3, 0
/* 80CA1BF8  40 82 01 4C */	bne lbl_80CA1D44
/* 80CA1BFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CA1C00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CA1C04  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80CA1C08  2C 00 00 03 */	cmpwi r0, 3
/* 80CA1C0C  41 82 01 38 */	beq lbl_80CA1D44
lbl_80CA1C10:
/* 80CA1C10  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CA1C14  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80CA1C18  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80CA1C5C  3D 60 80 CA */	lis r11, lit_3868@ha
/* 80CA1C60  C0 2B 31 D0 */	lfs f1, lit_3868@l(r11)
/* 80CA1C64  4B 3A B8 68 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80CA1C78  4B 3A 9C A0 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80CA1CDC  3D 60 80 CA */	lis r11, lit_3868@ha
/* 80CA1CE0  C0 2B 31 D0 */	lfs f1, lit_3868@l(r11)
/* 80CA1CE4  4B 3A B7 E8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80CA1CF8  4B 3A 9C 20 */	b getEmitter__Q213dPa_control_c7level_cFUl

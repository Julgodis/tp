...
/* 80CA0E94  4B 6C 13 48 */	b _savegpr_29
/* 80CA0E98  7C 7F 1B 78 */	mr r31, r3
/* 80CA0E9C  3C 60 80 CA */	lis r3, lit_3774@ha
/* 80CA0EA0  3B C3 31 BC */	addi r30, r3, lit_3774@l
...
/* 80CA0EE4  4B 3D 6D 84 */	b __ct__11dBgS_LinChkFv
...
/* 80CA0F10  4B 36 BE 54 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CA0F14  38 7F 04 DC */	addi r3, r31, 0x4dc
/* 80CA0F18  4B 36 C0 2C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80CA0F1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CA0F20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CA0F24  38 81 00 3C */	addi r4, r1, 0x3c
/* 80CA0F28  7C 85 23 78 */	mr r5, r4
/* 80CA0F2C  4B 6A 5E 40 */	b PSMTXMultVec
/* 80CA0F30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CA0F34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CA0F38  38 81 00 30 */	addi r4, r1, 0x30
/* 80CA0F3C  7C 85 23 78 */	mr r5, r4
/* 80CA0F40  4B 6A 5E 2C */	b PSMTXMultVec
/* 80CA0F44  38 61 00 B4 */	addi r3, r1, 0xb4
/* 80CA0F48  4B 3D 7F 20 */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80CA0F5C  4B 3D 6E 08 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80CA0F60  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CA0F64  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CA0F68  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80CA0F6C  7F A3 EB 78 */	mr r3, r29
/* 80CA0F70  38 81 00 5C */	addi r4, r1, 0x5c
/* 80CA0F74  4B 3D 34 40 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80CA0F78  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80CA0F7C  41 82 01 DC */	beq lbl_80CA1158
/* 80CA0F80  3C 60 80 CA */	lis r3, __vt__8cM3dGPla@ha
/* 80CA0F84  38 03 34 68 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80CA0F98  4B 3D 37 AC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CA0FC8  4B 6A 63 D4 */	b PSVECSquareDistance
...
/* 80CA1038  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CA103C  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80CA10A8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CA10AC  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80CA10F0  4B 5C 65 84 */	b cM_atan2s__Fff
...
/* 80CA1104  4B 5C 65 70 */	b cM_atan2s__Fff
...
/* 80CA1120  3C 60 80 CA */	lis r3, lit_4034@ha
/* 80CA1124  38 83 33 1C */	addi r4, r3, lit_4034@l
/* 80CA1128  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80CA331C */
/* 80CA112C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80CA3320 */
/* 80CA1130  90 61 00 0C */	stw r3, 0xc(r1)
/* 80CA1134  90 01 00 10 */	stw r0, 0x10(r1)
/* 80CA1138  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80CA3324 */

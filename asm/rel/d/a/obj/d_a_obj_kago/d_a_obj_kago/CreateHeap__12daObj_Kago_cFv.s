...
lbl_80C323F8:
/* 80C323F8 00000000  3C 60 00 00 */	lis r3, l_bmdData@ha /* 80C33DC0 */
/* 80C323FC 00000004  38 83 00 00 */	addi r4, r3, l_bmdData@l /* 80C33DC0 */
/* 80C32400 00000008  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80C32404 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80C32408 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha /* 80C33DD0 */
/* 80C3240C 00000014  38 63 00 00 */	addi r3, r3, l_resNameList@l /* 80C33DD0 */
/* 80C32410 00000018  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C32414 0000001C  80 84 00 08 */	lwz r4, 8(r4)
/* 80C32418 00000020  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C3241C 00000024  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
lbl_80C32434:
/* 80C32434 00000000  3C 60 00 00 */	lis r3, l_bmdData@ha /* 80C33DC0 */
/* 80C32438 00000004  38 83 00 00 */	addi r4, r3, l_bmdData@l /* 80C33DC0 */
/* 80C3243C 00000008  80 04 00 04 */	lwz r0, 4(r4)
/* 80C32440 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80C32444 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha /* 80C33DD0 */
/* 80C32448 00000014  38 63 00 00 */	addi r3, r3, l_resNameList@l /* 80C33DD0 */
/* 80C3244C 00000018  7C 63 00 2E */	lwzx r3, r3, r0
/* 80C32450 0000001C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C32454 00000020  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C32458 00000024  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */

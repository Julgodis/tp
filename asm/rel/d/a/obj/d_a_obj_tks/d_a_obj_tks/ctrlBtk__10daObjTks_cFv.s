...
/* 80D11908 00000020  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80D1190C 00000024  38 84 00 00 */	addi r4, r4, l_arcName@l
/* 80D11910 00000028  80 84 00 00 */	lwz r4, 0(r4)
/* 80D11914 0000002C  3C A0 00 00 */	lis r5, l_btkGetParamList@ha
/* 80D11918 00000030  38 A5 00 00 */	addi r5, r5, l_btkGetParamList@l
...
/* 80D11930 00000048  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80D11934 0000004C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
/* 80D11938 00000050  A8 9F 08 FE */	lha r4, 0x8fe(r31)
/* 80D1193C 00000054  48 00 05 65 */	bl func_80D11EA0
/* 80D11940 00000058  3C 60 00 00 */	lis r3, lit_4324@ha
/* 80D11944 0000005C  C0 43 00 00 */	lfs f2, lit_4324@l(r3)
/* 80D11948 00000060  3C 60 00 00 */	lis r3, lit_5057@ha
/* 80D1194C 00000064  C0 03 00 00 */	lfs f0, lit_5057@l(r3)
...
/* 80D11960 00000078  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80D11964 0000007C  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
/* 80D11968 00000080  A8 9F 08 FC */	lha r4, 0x8fc(r31)
/* 80D1196C 00000084  48 00 05 35 */	bl func_80D11EA0
/* 80D11970 00000088  3C 60 00 00 */	lis r3, lit_5057@ha
/* 80D11974 0000008C  C0 03 00 00 */	lfs f0, lit_5057@l(r3)

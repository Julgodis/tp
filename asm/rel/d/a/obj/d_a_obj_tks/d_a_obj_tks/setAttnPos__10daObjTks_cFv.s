...
/* 80D119D4  3C 60 80 D1 */	lis r3, m__16daObjTks_Param_c@ha
/* 80D119D8  3B E3 27 3C */	addi r31, r3, m__16daObjTks_Param_c@l
...
/* 80D11A5C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D11A60  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80D11A64  4B 63 4A 4C */	b PSMTXCopy
/* 80D11A68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D11A6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D11A70  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80D11A74  D0 1E 08 E4 */	stfs f0, 0x8e4(r30)
/* 80D11A78  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80D11A7C  D0 1E 08 E8 */	stfs f0, 0x8e8(r30)
/* 80D11A80  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80D11A84  D0 1E 08 EC */	stfs f0, 0x8ec(r30)
/* 80D11A88  38 81 00 30 */	addi r4, r1, 0x30
/* 80D11A8C  38 BE 05 38 */	addi r5, r30, 0x538
/* 80D11A90  4B 63 52 DC */	b PSMTXMultVec
/* 80D11A94  C0 1F 00 B4 */	lfs f0, 0xb4(r31)
/* 80D11A98  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80D11A9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D11AA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D11AA4  38 81 00 30 */	addi r4, r1, 0x30
/* 80D11AA8  7C 85 23 78 */	mr r5, r4
/* 80D11AAC  4B 63 52 C0 */	b PSMTXMultVec
/* 80D11AB0  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80D11AB4  38 81 00 30 */	addi r4, r1, 0x30
/* 80D11AB8  4B 55 F1 BC */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80D11ABC  B0 7E 09 02 */	sth r3, 0x902(r30)
/* 80D11AC0  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80D11AC4  38 81 00 30 */	addi r4, r1, 0x30
/* 80D11AC8  4B 55 F1 3C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80D11AE4  4B 55 50 50 */	b __mi__4cXyzCFRC3Vec
...
/* 80D11B14  4B 55 5B 60 */	b cM_atan2s__Fff
...
/* 80D11B40  4B 63 55 F8 */	b PSVECSquareMag
...
/* 80D11BB0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D11BB4  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80D11C20  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D11C24  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80D11C28  48 00 00 08 */	b lbl_80D11C30
lbl_80D11C2C:
/* 80D11C2C  FC 40 08 90 */	fmr f2, f1
lbl_80D11C30:
/* 80D11C30  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80D11C34  4B 55 5A 40 */	b cM_atan2s__Fff
...
/* 80D11C84  4B 55 D5 58 */	b SetC__8cM3dGCylFRC4cXyz
/* 80D11C88  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D11C8C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D11C90  38 63 23 3C */	addi r3, r3, 0x233c
/* 80D11C94  38 9E 0C 7C */	addi r4, r30, 0xc7c
/* 80D11C98  4B 55 2F 10 */	b Set__4cCcSFP8cCcD_Obj
lbl_80D11C9C:

...
/* 80C76D3C 0000002C  4B 40 18 E8 */	b __ct__16dBgS_MoveBgActorFv
/* 80C76D40 00000030  3C 60 80 C7 */	lis r3, __vt__10daTenbin_c@ha
/* 80C76D44 00000034  38 03 7A 88 */	addi r0, r3, __vt__10daTenbin_c@l
...
/* 80C76D5C 00000004  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C76D60 00000008  38 84 79 FC */	addi r4, r4, stringBase0@l
/* 80C76D64 0000000C  4B 3B 61 58 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C76D78 00000020  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C76D7C 00000024  38 84 79 FC */	addi r4, r4, stringBase0@l
/* 80C76D80 00000028  38 A0 00 08 */	li r5, 8
/* 80C76D84 0000002C  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C76D88 00000030  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C76D8C 00000034  38 E0 6A 00 */	li r7, 0x6a00
/* 80C76D90 00000038  39 00 00 00 */	li r8, 0
/* 80C76D94 0000003C  4B 40 1A 28 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C76DB4 0000000C  3C 60 80 C7 */	lis r3, l_cull_box@ha
/* 80C76DB8 00000010  38 83 7A 08 */	addi r4, r3, l_cull_box@l
/* 80C76DBC 00000014  C0 A4 00 10 */	lfs f5, 0x10(r4)	/* effective address: 80C77A18 */
/* 80C76DC0 00000018  7F C3 F3 78 */	mr r3, r30
/* 80C76DC4 0000001C  C0 24 00 00 */	lfs f1, 0(r4)	/* effective address: 80C77A08 */
/* 80C76DC8 00000020  C0 44 00 04 */	lfs f2, 4(r4)	/* effective address: 80C77A0C */
/* 80C76DCC 00000024  C0 64 00 08 */	lfs f3, 8(r4)	/* effective address: 80C77A10 */
/* 80C76DD0 00000028  C0 84 00 0C */	lfs f4, 0xc(r4)	/* effective address: 80C77A14 */
/* 80C76DD4 0000002C  FC C0 28 90 */	fmr f6, f5
/* 80C76DD8 00000030  4B 3A 37 70 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80C76DDC 00000034  3C 60 80 C7 */	lis r3, rideCallBackLeft__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C76DE0 00000038  38 03 70 78 */	addi r0, r3, rideCallBackLeft__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
/* 80C76DE4 0000003C  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80C76DE8 00000040  90 03 00 B4 */	stw r0, 0xb4(r3)
/* 80C76DEC 00000044  3C 60 80 C7 */	lis r3, rideCallBackRight__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@ha
/* 80C76DF0 00000048  38 03 6E E0 */	addi r0, r3, rideCallBackRight__10daTenbin_cFP4dBgWP10fopAc_ac_cP10fopAc_ac_c@l
...
/* 80C76E18 00000070  3C 60 80 C7 */	lis r3, lit_3670@ha
/* 80C76E1C 00000074  C0 03 79 B8 */	lfs f0, lit_3670@l(r3)
...
/* 80C76E98 000000F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C76E9C 000000F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C76EA0 000000F8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C76EA4 000000FC  7F C5 F3 78 */	mr r5, r30
/* 80C76EA8 00000100  4B 3F DB 60 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80C76EAC 00000104  80 7E 06 1C */	lwz r3, 0x61c(r30)
/* 80C76EB0 00000108  4B 40 4B 10 */	b Move__4dBgWFv
lbl_80C76EB4:
/* 80C76EB4 00000000  7F C3 F3 78 */	mr r3, r30
/* 80C76EB8 00000004  4B 40 1A 98 */	b MoveBGExecute__16dBgS_MoveBgActorFv

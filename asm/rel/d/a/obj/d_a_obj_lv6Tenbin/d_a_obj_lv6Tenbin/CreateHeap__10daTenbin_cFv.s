...
/* 80C76BE4  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C76BE8  38 63 79 FC */	addi r3, r3, stringBase0@l
/* 80C76BEC  38 80 00 05 */	li r4, 5
/* 80C76BF0  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C76BF4  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C76C08  4B 3C 56 E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C76C18  4B 39 E0 3C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C76C34:
/* 80C76C34  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C76C38  38 63 79 FC */	addi r3, r3, stringBase0@l
/* 80C76C3C  38 80 00 04 */	li r4, 4
/* 80C76C40  7F C5 F3 78 */	mr r5, r30
/* 80C76C44  38 C0 00 80 */	li r6, 0x80
/* 80C76C48  4B 3C 56 A4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C76C58  4B 39 DF FC */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C76C9C  3C 60 80 C7 */	lis r3, stringBase0@ha
/* 80C76CA0  38 63 79 FC */	addi r3, r3, stringBase0@l
/* 80C76CA4  38 80 00 08 */	li r4, 8
/* 80C76CA8  7F C5 F3 78 */	mr r5, r30
/* 80C76CAC  38 C0 00 80 */	li r6, 0x80
/* 80C76CB0  4B 3C 56 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C76CC4  4B 40 32 74 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
/* 80C76CC8  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C76CCC  40 82 00 18 */	bne lbl_80C76CE4
/* 80C76CD0  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C76CD4  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l

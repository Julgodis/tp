...
/* 80C97BC8 0000001C  4B FF EA B1 */	bl _unresolved
/* 80C97BCC 00000020  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C97BD0 00000024  41 82 00 18 */	beq lbl_80C97BE8
/* 80C97BD4 00000028  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C97BD8 0000002C  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C97BDC 00000030  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C97BE0 00000034  38 9F 05 88 */	addi r4, r31, 0x588
/* 80C97BE4 00000038  4B FF EA 95 */	bl _unresolved
lbl_80C97BE8:
/* 80C97BE8 00000000  38 7F 06 48 */	addi r3, r31, 0x648
/* 80C97BEC 00000004  4B FF EA 8D */	bl _unresolved
/* 80C97BF0 00000008  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C97BF4 0000000C  41 82 00 18 */	beq lbl_80C97C0C
/* 80C97BF8 00000010  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C97BFC 00000014  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C97C00 00000018  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C97C04 0000001C  38 9F 06 48 */	addi r4, r31, 0x648
/* 80C97C08 00000020  4B FF EA 71 */	bl _unresolved
lbl_80C97C0C:
/* 80C97C0C 00000000  38 7F 05 7C */	addi r3, r31, 0x57c
/* 80C97C10 00000004  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C97C14 00000008  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C97C18 0000000C  80 84 00 00 */	lwz r4, 0(r4)
/* 80C97C1C 00000010  4B FF EA 5D */	bl _unresolved
/* 80C97C20 00000014  34 1F 07 7C */	addic. r0, r31, 0x77c
/* 80C97C24 00000018  41 82 00 24 */	beq lbl_80C97C48
/* 80C97C28 0000001C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C97C2C 00000020  38 03 00 00 */	addi r0, r3, 0x0000 /* 0x00000000@l */
...
/* 80C97C3C 00000030  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C97C40 00000034  38 03 00 00 */	addi r0, r3, 0x0000 /* 0x00000000@l */
...
/* 80C97C50 00000008  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C97C54 0000000C  38 03 00 00 */	addi r0, r3, 0x0000 /* 0x00000000@l */
/* 80C97C58 00000010  90 1F 07 3C */	stw r0, 0x73c(r31)
/* 80C97C5C 00000014  38 7F 07 4C */	addi r3, r31, 0x74c
/* 80C97C60 00000018  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C97C64 0000001C  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C97C68 00000020  38 A0 00 0C */	li r5, 0xc
/* 80C97C6C 00000024  38 C0 00 04 */	li r6, 4
/* 80C97C70 00000028  4B FF EA 09 */	bl _unresolved
/* 80C97C74 0000002C  34 1F 07 3C */	addic. r0, r31, 0x73c
/* 80C97C78 00000030  41 82 00 10 */	beq lbl_80C97C88
/* 80C97C7C 00000034  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C97C80 00000038  38 03 00 00 */	addi r0, r3, 0x0000 /* 0x00000000@l */
/* 80C97C84 0000003C  90 1F 07 3C */	stw r0, 0x73c(r31)
lbl_80C97C88:
/* 80C97C88 00000000  38 7F 05 88 */	addi r3, r31, 0x588
/* 80C97C8C 00000004  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C97C90 00000008  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C97C94 0000000C  38 A0 00 C0 */	li r5, 0xc0
/* 80C97C98 00000010  38 C0 00 02 */	li r6, 2
/* 80C97C9C 00000014  4B FF E9 DD */	bl _unresolved
/* 80C97CA0 00000018  7F E3 FB 78 */	mr r3, r31
/* 80C97CA4 0000001C  38 80 00 00 */	li r4, 0
/* 80C97CA8 00000020  4B FF E9 D1 */	bl _unresolved
lbl_80C97CAC:

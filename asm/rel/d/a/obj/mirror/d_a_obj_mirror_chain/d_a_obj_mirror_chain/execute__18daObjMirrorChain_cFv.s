...
/* 80C979A0 00000018  3C 60 00 00 */	lis r3, lit_3915@ha
/* 80C979A4 0000001C  3B E3 00 00 */	addi r31, r3, lit_3915@l
...
lbl_80C979D8:
/* 80C979D8 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C979DC 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C979E0 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C979E4 0000000C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C979E8 00000010  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C97A28 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C97A2C 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C97A68 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C97A6C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C97ACC 00000070  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C97AD0 00000074  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C97AD4 00000078  4B FF EB A5 */	bl PSMTXCopy
/* 80C97AD8 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C97ADC 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C97B04 000000A8  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C97B08 000000AC  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 80C97B4C 00000010  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C97B50 00000014  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C97B54 00000018  4B FF EB 25 */	bl PSMTXCopy
/* 80C97B58 0000001C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C97B5C 00000020  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

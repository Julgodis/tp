...
/* 80C97998 00000010  4B FF EC E1 */	bl _savegpr_29
/* 80C9799C 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C979A0 00000018  3C 60 00 00 */	lis r3, lit_3915@ha /* 80C98028 */
/* 80C979A4 0000001C  3B E3 00 00 */	addi r31, r3, lit_3915@l /* 80C98028 */
...
/* 80C979B4 0000002C  4B FF EC C5 */	bl play__14mDoExt_baseAnmFv
lbl_80C979B8:
...
/* 80C979C4 0000000C  4B FF EC B5 */	bl play__14mDoExt_baseAnmFv
lbl_80C979C8:
...
/* 80C979D4 0000000C  4B FF EC A5 */	bl play__14mDoExt_baseAnmFv
lbl_80C979D8:
/* 80C979D8 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C979DC 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C979E0 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C979E4 0000000C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C979E8 00000010  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
/* 80C979EC 00000014  A0 84 02 C4 */	lhz r4, 0x2c4(r4)
/* 80C979F0 00000018  4B FF EC 89 */	bl isEventBit__11dSv_event_cCFUs
...
/* 80C97A0C 00000034  C0 1F 00 08 */	lfs f0, 8(r31)
...
/* 80C97A28 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C97A2C 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C97A30 0000001C  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80C97A34 00000020  7F A3 EB 78 */	mr r3, r29
/* 80C97A38 00000024  4B FF EC 41 */	bl Release__4cBgSFP9dBgW_Base
...
/* 80C97A48 00000034  4B FF EC 31 */	bl Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80C97A58 00000044  4B FF EC 21 */	bl Move__4dBgWFv
lbl_80C97A5C:
...
/* 80C97A68 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C97A6C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C97A70 00000014  80 63 5D 3C */	lwz r3, 0x5d3c(r3)
...
/* 80C97AB0 00000054  C0 3F 00 20 */	lfs f1, 0x20(r31)
/* 80C97AB4 00000058  4B FF EB C5 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C97ACC 00000070  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C97AD0 00000074  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C97AD4 00000078  4B FF EB A5 */	bl PSMTXCopy
/* 80C97AD8 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C97ADC 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C97AE0 00000084  C0 03 00 0C */	lfs f0, 0xc(r3)
/* 80C97AE4 00000088  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80C97AE8 0000008C  C0 03 00 1C */	lfs f0, 0x1c(r3)
/* 80C97AEC 00000090  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 80C97AF0 00000094  C0 03 00 2C */	lfs f0, 0x2c(r3)
...
/* 80C97B04 000000A8  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 80C97B08 000000AC  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 80C97B0C 000000B0  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C97B20 000000C4  C0 3F 00 20 */	lfs f1, 0x20(r31)
/* 80C97B24 000000C8  FC 40 08 90 */	fmr f2, f1
/* 80C97B28 000000CC  C0 7F 00 48 */	lfs f3, 0x48(r31)
/* 80C97B2C 000000D0  FC 80 18 90 */	fmr f4, f3
/* 80C97B30 000000D4  39 00 00 00 */	li r8, 0
/* 80C97B34 000000D8  4B FF EB 45 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C97B4C 00000010  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C97B50 00000014  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C97B54 00000018  4B FF EB 25 */	bl PSMTXCopy
/* 80C97B58 0000001C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C97B5C 00000020  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C97B60 00000024  C0 43 00 0C */	lfs f2, 0xc(r3)
/* 80C97B64 00000028  D0 41 00 24 */	stfs f2, 0x24(r1)
/* 80C97B68 0000002C  C0 23 00 1C */	lfs f1, 0x1c(r3)
/* 80C97B6C 00000030  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 80C97B70 00000034  C0 03 00 2C */	lfs f0, 0x2c(r3)
...
/* 80C97B90 00000008  4B FF EA E9 */	bl _restgpr_29

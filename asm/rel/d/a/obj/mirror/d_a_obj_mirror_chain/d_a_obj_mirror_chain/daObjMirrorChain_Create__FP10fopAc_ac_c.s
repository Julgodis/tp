...
/* 80C97D5C 00000038  3C 80 00 00 */	lis r4, __ct__4dBgWFv@ha
/* 80C97D60 0000003C  38 84 00 00 */	addi r4, r4, __ct__4dBgWFv@l
/* 80C97D64 00000040  3C A0 00 00 */	lis r5, __dt__4dBgWFv@ha
/* 80C97D68 00000044  38 A5 00 00 */	addi r5, r5, __dt__4dBgWFv@l
...
/* 80C97D78 00000054  3C 60 00 00 */	lis r3, __vt__9J3DPacket@ha
/* 80C97D7C 00000058  38 03 00 00 */	addi r0, r3, __vt__9J3DPacket@l
...
/* 80C97D94 00000070  3C 60 00 00 */	lis r3, __vt__22dScissorBegin_packet_c@ha
/* 80C97D98 00000074  38 03 00 00 */	addi r0, r3, __vt__22dScissorBegin_packet_c@l
/* 80C97D9C 00000078  90 1F 07 3C */	stw r0, 0x73c(r31)
/* 80C97DA0 0000007C  38 7F 07 4C */	addi r3, r31, 0x74c
/* 80C97DA4 00000080  3C 80 00 00 */	lis r4, __ct__4cXyzFv@ha
/* 80C97DA8 00000084  38 84 00 00 */	addi r4, r4, __ct__4cXyzFv@l
/* 80C97DAC 00000088  3C A0 00 00 */	lis r5, __dt__4cXyzFv@ha
/* 80C97DB0 0000008C  38 A5 00 00 */	addi r5, r5, __dt__4cXyzFv@l
...
/* 80C97DC0 0000009C  3C 60 00 00 */	lis r3, __vt__9J3DPacket@ha
/* 80C97DC4 000000A0  38 03 00 00 */	addi r0, r3, __vt__9J3DPacket@l
...
/* 80C97DDC 000000B8  3C 60 00 00 */	lis r3, __vt__20dScissorEnd_packet_c@ha
/* 80C97DE0 000000BC  38 03 00 00 */	addi r0, r3, __vt__20dScissorEnd_packet_c@l
...
/* 80C97DF8 00000004  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80C97DFC 00000008  38 84 00 00 */	addi r4, r4, l_arcName@l
...
/* 80C97E18 00000024  3C 80 00 00 */	lis r4, createSolidHeap__FP10fopAc_ac_c@ha
/* 80C97E1C 00000028  38 84 00 00 */	addi r4, r4, createSolidHeap__FP10fopAc_ac_c@l
...
/* 80C97E44 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C97E48 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C97E4C 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C97E50 00000018  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C97E54 0000001C  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C97E68 00000030  3C 60 00 00 */	lis r3, lit_3917@ha
/* 80C97E6C 00000034  C0 03 00 00 */	lfs f0, lit_3917@l(r3)
...
/* 80C97E9C 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C97EA0 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C97EC0 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C97EC4 0000004C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C97EC8 00000050  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C97ECC 00000054  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C97ED0 00000058  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C97F00 00000004  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C97F04 00000008  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l

...
/* 80C98F14 00000010  4B 6C 92 C8 */	b _savegpr_29
/* 80C98F18 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80C98F1C 00000018  3C 60 80 CA */	lis r3, M_attr__18daObjMirrorScrew_c@ha
/* 80C98F20 0000001C  3B C3 97 5C */	addi r30, r3, M_attr__18daObjMirrorScrew_c@l
/* 80C98F24 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C98F28 00000024  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80C98F2C 00000028  88 1F 4F AD */	lbz r0, 0x4fad(r31)	/* effective address: 8040B16D */
/* 80C98F30 0000002C  28 00 00 00 */	cmplwi r0, 0
/* 80C98F34 00000030  41 82 00 30 */	beq lbl_80C98F64
/* 80C98F38 00000034  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 80C98F90 0000002C  C0 1E 00 20 */	lfs f0, 0x20(r30)	/* effective address: 80C9977C */
...
/* 80C98FA8 0000000C  C0 1E 00 20 */	lfs f0, 0x20(r30)	/* effective address: 80C9977C */
...
/* 80C98FC0 0000000C  C0 1E 00 20 */	lfs f0, 0x20(r30)	/* effective address: 80C9977C */
...
/* 80C98FD8 0000000C  C0 1E 00 20 */	lfs f0, 0x20(r30)	/* effective address: 80C9977C */
...
/* 80C98FEC 00000008  C0 24 00 14 */	lfs f1, 0x14(r4)	/* effective address: 80C99770 */
/* 80C98FF0 0000000C  C0 44 00 10 */	lfs f2, 0x10(r4)	/* effective address: 80C9976C */
/* 80C98FF4 00000010  4B 5D 77 4C */	b cLib_chaseF__FPfff
...
/* 80C9900C 00000028  C0 3E 00 34 */	lfs f1, 0x34(r30)	/* effective address: 80C99790 */
...
/* 80C99044 00000060  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C99048 00000064  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9904C 00000068  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C99060 0000007C  C0 3E 00 20 */	lfs f1, 0x20(r30)	/* effective address: 80C9977C */
/* 80C99064 00000080  FC 40 08 90 */	fmr f2, f1
/* 80C99068 00000084  C0 7E 00 30 */	lfs f3, 0x30(r30)	/* effective address: 80C9978C */
/* 80C9906C 00000088  FC 80 18 90 */	fmr f4, f3
/* 80C99070 0000008C  39 00 00 00 */	li r8, 0
/* 80C99074 00000090  4B 61 34 98 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C99078 00000094  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 80C9907C 00000098  C0 3D 04 AC */	lfs f1, 0x4ac(r29)
/* 80C99080 0000009C  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80C9975C */
...
/* 80C99098 0000000C  C0 3E 00 1C */	lfs f1, 0x1c(r30)	/* effective address: 80C99778 */
/* 80C9909C 00000010  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C990A0 00000014  C0 1E 00 20 */	lfs f0, 0x20(r30)	/* effective address: 80C9977C */
...
/* 80C990C0 00000034  4B 3D 69 64 */	b StartShock__12dVibration_cFii4cXyz
/* 80C990C4 00000038  7F E3 FB 78 */	mr r3, r31
/* 80C990C8 0000003C  38 80 00 1F */	li r4, 0x1f
/* 80C990CC 00000040  4B 3D 6C C8 */	b StopQuake__12dVibration_cFi
...
/* 80C990DC 00000050  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C990E0 00000054  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C990E4 00000058  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C990F8 0000006C  C0 3E 00 20 */	lfs f1, 0x20(r30)	/* effective address: 80C9977C */
/* 80C990FC 00000070  FC 40 08 90 */	fmr f2, f1
/* 80C99100 00000074  C0 7E 00 30 */	lfs f3, 0x30(r30)	/* effective address: 80C9978C */
/* 80C99104 00000078  FC 80 18 90 */	fmr f4, f3
/* 80C99108 0000007C  39 00 00 00 */	li r8, 0
/* 80C9910C 00000080  4B 61 28 78 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C99120 00000094  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C99124 00000098  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C99128 0000009C  88 1D 04 BA */	lbz r0, 0x4ba(r29)
/* 80C9912C 000000A0  7C 05 07 74 */	extsb r5, r0
/* 80C99130 000000A4  4B 39 C0 D0 */	b onSwitch__10dSv_info_cFii
lbl_80C99134:
/* 80C99134 00000000  7F A3 EB 78 */	mr r3, r29
/* 80C99138 00000004  4B 38 0B 44 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80C9913C:
/* 80C9913C 00000000  39 61 00 40 */	addi r11, r1, 0x40
/* 80C99140 00000004  4B 6C 90 E8 */	b _restgpr_29

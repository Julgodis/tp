...
/* 80C981F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C989F0 */
/* 80C981FC  38 80 00 08 */	li r4, 8
/* 80C98200  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C98204  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C9824C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C989F0 */
...
/* 80C9829C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C982A0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C982C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C982C4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C982D4  A0 84 02 D2 */	lhz r4, 0x2d2(r4)	/* effective address: 803A755A */
...
/* 80C982F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C982F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C98304  A0 84 02 C4 */	lhz r4, 0x2c4(r4)	/* effective address: 803A754C */
...
/* 80C98374  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C98378  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C98398  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C9839C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C983AC  A0 84 02 D2 */	lhz r4, 0x2d2(r4)	/* effective address: 803A755A */
...
/* 80C983C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C983CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C983DC  A0 84 02 C4 */	lhz r4, 0x2c4(r4)	/* effective address: 803A754C */
...
/* 80C9842C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C989F0 */
...
/* 80C9846C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80C989F0 */

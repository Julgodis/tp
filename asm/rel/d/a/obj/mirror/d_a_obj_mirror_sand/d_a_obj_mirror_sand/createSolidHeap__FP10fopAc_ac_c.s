...
/* 80C981F0 00000018  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C981F4 0000001C  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C981F8 00000020  80 63 00 00 */	lwz r3, 0(r3)
/* 80C981FC 00000024  38 80 00 08 */	li r4, 8
/* 80C98200 00000028  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C98204 0000002C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
lbl_80C98244:
/* 80C98244 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C98248 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C98274 00000030  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C98278 00000034  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C9829C 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C982A0 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C982C0 00000030  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C982C4 00000034  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C982C8 00000038  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C982CC 0000003C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C982D0 00000040  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C982F0 00000008  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C982F4 0000000C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C982F8 00000010  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C982FC 00000014  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C98300 00000018  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C98320 00000008  3C 60 00 00 */	lis r3, lit_3729@ha
/* 80C98324 0000000C  C0 23 00 00 */	lfs f1, lit_3729@l(r3)
/* 80C98328 00000010  48 00 00 0C */	b lbl_80C98334
lbl_80C9832C:
/* 80C9832C 00000000  3C 60 00 00 */	lis r3, lit_3730@ha
/* 80C98330 00000004  C0 23 00 00 */	lfs f1, lit_3730@l(r3)
lbl_80C98334:
...
/* 80C98374 00000008  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C98378 0000000C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C98398 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C9839C 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C983A0 00000034  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C983A4 00000038  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C983A8 0000003C  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C983C8 00000008  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C983CC 0000000C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C983D0 00000010  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C983D4 00000014  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C983D8 00000018  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C983FC 0000000C  3C 60 00 00 */	lis r3, lit_3732@ha
/* 80C98400 00000010  C8 23 00 00 */	lfd f1, lit_3732@l(r3)
...
lbl_80C98424:
/* 80C98424 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C98428 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
lbl_80C98464:
/* 80C98464 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C98468 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l

...
/* 80C9A4E0  4B 6C 7C FC */	b _savegpr_29
/* 80C9A4E4  7C 7E 1B 78 */	mr r30, r3
/* 80C9A4E8  3C 60 80 CA */	lis r3, l_minPos@ha
/* 80C9A4EC  3B E3 B2 44 */	addi r31, r3, l_minPos@l
/* 80C9A4F0  80 7E 05 80 */	lwz r3, 0x580(r30)
/* 80C9A4F4  4B 37 2F 34 */	b play__14mDoExt_baseAnmFv
...
/* 80C9A534  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C9A538  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C9A53C  4B 6A BF 74 */	b PSMTXCopy
/* 80C9A540  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A544  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A548  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80C9A54C  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 80C9A550  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C9A554  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 80C9A558  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80C9A56C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9A570  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9A574  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9A59C  4B 61 1F 70 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C9A5A0:
/* 80C9A5A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C9A5A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C9A5A8  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C9A5AC  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C9A5B0  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C9A5B4  A0 84 02 C4 */	lhz r4, 0x2c4(r4)	/* effective address: 803A754C */
/* 80C9A5B8  4B 39 A4 04 */	b isEventBit__11dSv_event_cCFUs
/* 80C9A5BC  2C 03 00 00 */	cmpwi r3, 0
/* 80C9A5C0  40 82 00 58 */	bne lbl_80C9A618
/* 80C9A5C4  38 7E 05 9C */	addi r3, r30, 0x59c
/* 80C9A5C8  4B 5C DC 0C */	b ChkUsed__9cBgW_BgIdCFv
...
/* 80C9A5E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C9A5EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C9A600  4B 3D A4 08 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80C9A604  7F A3 EB 78 */	mr r3, r29
/* 80C9A608  38 9E 06 5C */	addi r4, r30, 0x65c
/* 80C9A60C  7F C5 F3 78 */	mr r5, r30
/* 80C9A610  4B 3D A3 F8 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
/* 80C9A614  48 00 01 A0 */	b lbl_80C9A7B4
lbl_80C9A618:
/* 80C9A618  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C9A61C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C9A620  38 63 09 58 */	addi r3, r3, 0x958
/* 80C9A624  38 80 00 79 */	li r4, 0x79
/* 80C9A628  4B 39 A1 E8 */	b onSwitch__12dSv_memBit_cFi
...
/* 80C9A660  4B 5C DB 74 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9A664  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9A668  40 82 00 D0 */	bne lbl_80C9A738
/* 80C9A66C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C9A670  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C9A674  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C9A678  38 9E 07 1C */	addi r4, r30, 0x71c
/* 80C9A67C  7F C5 F3 78 */	mr r5, r30
/* 80C9A680  4B 3D A3 88 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80C9A690  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9A694  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9A698  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9A6C0  4B 61 12 C4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C9A6D8  4B 5C DA FC */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9A6DC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9A6E0  41 82 00 58 */	beq lbl_80C9A738
/* 80C9A6E4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C9A6E8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C9A6EC  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C9A6F0  38 9E 07 1C */	addi r4, r30, 0x71c
/* 80C9A6F4  4B 3D 9B 5C */	b Release__4cBgSFP9dBgW_Base
...
/* 80C9A704  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9A708  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9A70C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9A734  4B 61 12 50 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C9A738:
...
/* 80C9A784  4B 37 2C A4 */	b play__14mDoExt_baseAnmFv
...
/* 80C9A798  4B 37 2C 90 */	b play__14mDoExt_baseAnmFv
/* 80C9A79C  80 7E 05 84 */	lwz r3, 0x584(r30)
/* 80C9A7A0  4B 37 2C 88 */	b play__14mDoExt_baseAnmFv
/* 80C9A7A4  80 7E 05 90 */	lwz r3, 0x590(r30)
/* 80C9A7A8  4B 37 2C 80 */	b play__14mDoExt_baseAnmFv
lbl_80C9A7AC:
/* 80C9A7AC  38 7E 08 75 */	addi r3, r30, 0x875
/* 80C9A7B0  48 00 0A 71 */	bl func_80C9B220
lbl_80C9A7B4:
/* 80C9A7B4  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C9A7B8  4B 37 25 AC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9A7BC  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 80C9A7C0  4B 37 27 84 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C9A7C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A7C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A7CC  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80C9A7D0  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9A7D4  4B 6A BC DC */	b PSMTXCopy
/* 80C9A7D8  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80C9A7DC  28 04 00 00 */	cmplwi r4, 0
/* 80C9A7E0  41 82 00 14 */	beq lbl_80C9A7F4
/* 80C9A7E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A7E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A7EC  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9A7F0  4B 6A BC C0 */	b PSMTXCopy
lbl_80C9A7F4:
/* 80C9A7F4  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80C9A7F8  28 04 00 00 */	cmplwi r4, 0
/* 80C9A7FC  41 82 00 14 */	beq lbl_80C9A810
/* 80C9A800  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A804  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A808  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9A80C  4B 6A BC A4 */	b PSMTXCopy
lbl_80C9A810:
/* 80C9A810  80 9E 05 78 */	lwz r4, 0x578(r30)
/* 80C9A814  28 04 00 00 */	cmplwi r4, 0
/* 80C9A818  41 82 00 14 */	beq lbl_80C9A82C
/* 80C9A81C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A820  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A824  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9A828  4B 6A BC 88 */	b PSMTXCopy
lbl_80C9A82C:
/* 80C9A82C  80 9E 05 7C */	lwz r4, 0x57c(r30)
/* 80C9A830  28 04 00 00 */	cmplwi r4, 0
/* 80C9A834  41 82 00 14 */	beq lbl_80C9A848
/* 80C9A838  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A83C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A840  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9A844  4B 6A BC 6C */	b PSMTXCopy
lbl_80C9A848:
/* 80C9A848  38 7E 05 9C */	addi r3, r30, 0x59c
/* 80C9A84C  4B 5C D9 88 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9A850  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9A854  41 82 00 1C */	beq lbl_80C9A870
/* 80C9A858  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A85C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A860  38 9E 07 DC */	addi r4, r30, 0x7dc
/* 80C9A864  4B 6A BC 4C */	b PSMTXCopy
/* 80C9A868  38 7E 05 9C */	addi r3, r30, 0x59c
/* 80C9A86C  4B 3E 11 54 */	b Move__4dBgWFv
lbl_80C9A870:
/* 80C9A870  38 7E 07 1C */	addi r3, r30, 0x71c
/* 80C9A874  4B 5C D9 60 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9A878  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9A87C  41 82 00 1C */	beq lbl_80C9A898
/* 80C9A880  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A884  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A888  38 9E 08 3C */	addi r4, r30, 0x83c
/* 80C9A88C  4B 6A BC 24 */	b PSMTXCopy
/* 80C9A890  38 7E 07 1C */	addi r3, r30, 0x71c
/* 80C9A894  4B 3E 11 2C */	b Move__4dBgWFv
lbl_80C9A898:
...
/* 80C9A8A8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C9A8AC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C9A8B0  4B 6A BC 00 */	b PSMTXCopy
/* 80C9A8B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A8B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A8BC  80 9E 05 6C */	lwz r4, 0x56c(r30)
/* 80C9A8C0  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9A8C4  4B 6A BB EC */	b PSMTXCopy
/* 80C9A8C8  38 7E 05 9C */	addi r3, r30, 0x59c
/* 80C9A8CC  4B 5C D9 08 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9A8D0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9A8D4  41 82 00 1C */	beq lbl_80C9A8F0
/* 80C9A8D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A8DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A8E0  38 9E 08 0C */	addi r4, r30, 0x80c
/* 80C9A8E4  4B 6A BB CC */	b PSMTXCopy
/* 80C9A8E8  38 7E 06 5C */	addi r3, r30, 0x65c
/* 80C9A8EC  4B 3E 10 D4 */	b Move__4dBgWFv
lbl_80C9A8F0:
/* 80C9A8F0  80 9E 08 6C */	lwz r4, 0x86c(r30)
/* 80C9A8F4  28 04 00 00 */	cmplwi r4, 0
/* 80C9A8F8  41 82 00 C0 */	beq lbl_80C9A9B8
/* 80C9A8FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9A900  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9A904  C0 43 00 0C */	lfs f2, 0xc(r3)	/* effective address: 803DD47C */
/* 80C9A908  D0 41 00 1C */	stfs f2, 0x1c(r1)
/* 80C9A90C  C0 23 00 1C */	lfs f1, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C9A910  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 80C9A914  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80C9A940  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9A944  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9A948  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9A970  4B 61 1B 9C */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C9A984  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9A988  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9A98C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9A9B4  4B 61 1B 58 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C9A9B8:
/* 80C9A9B8  38 60 00 01 */	li r3, 1
/* 80C9A9BC  39 61 00 60 */	addi r11, r1, 0x60
/* 80C9A9C0  4B 6C 78 68 */	b _restgpr_29

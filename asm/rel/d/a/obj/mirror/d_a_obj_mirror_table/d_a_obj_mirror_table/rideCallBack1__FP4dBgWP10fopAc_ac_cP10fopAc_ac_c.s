...
/* 80C9A058  4B 6C 81 74 */	b _savegpr_25
...
/* 80C9A084  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C9A088  4B 6A C4 28 */	b PSMTXCopy
/* 80C9A08C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
...
/* 80C9A0B8  3C 60 80 CA */	lis r3, l_minPos@ha
/* 80C9A0BC  3B 43 B2 44 */	addi r26, r3, l_minPos@l
/* 80C9A0C0  3C 60 80 CA */	lis r3, l_maxPos@ha
...
lbl_80C9A118:
/* 80C9A118  4B 37 2B B0 */	b push__14mDoMtx_stack_cFv
/* 80C9A11C  7F 63 DB 78 */	mr r3, r27
/* 80C9A120  7F C4 F3 78 */	mr r4, r30
/* 80C9A124  38 A1 00 08 */	addi r5, r1, 8
/* 80C9A128  4B 6A CC 44 */	b PSMTXMultVec
/* 80C9A12C  4B 37 2B E8 */	b pop__14mDoMtx_stack_cFv
...
/* 80C9A140  3C 60 80 CA */	lis r3, l_maxPos@ha
/* 80C9A144  C0 03 B2 50 */	lfs f0, l_maxPos@l(r3)
...
/* 80C9A198  3C 60 80 CA */	lis r3, l_minPos@ha
/* 80C9A19C  3B 63 B2 44 */	addi r27, r3, l_minPos@l
/* 80C9A1A0  3C 60 80 CA */	lis r3, l_maxPos@ha
...
lbl_80C9A1C8:
/* 80C9A1C8  4B 37 2B 00 */	b push__14mDoMtx_stack_cFv
/* 80C9A1CC  7F C3 F3 78 */	mr r3, r30
/* 80C9A1D0  7F 24 CB 78 */	mr r4, r25
/* 80C9A1D4  38 A1 00 08 */	addi r5, r1, 8
/* 80C9A1D8  4B 6A CB 94 */	b PSMTXMultVec
/* 80C9A1DC  4B 37 2B 38 */	b pop__14mDoMtx_stack_cFv
...
/* 80C9A1F0  3C 60 80 CA */	lis r3, l_maxPos@ha
/* 80C9A1F4  C0 03 B2 50 */	lfs f0, l_maxPos@l(r3)
...
/* 80C9A24C  4B 6C 7F CC */	b _restgpr_25

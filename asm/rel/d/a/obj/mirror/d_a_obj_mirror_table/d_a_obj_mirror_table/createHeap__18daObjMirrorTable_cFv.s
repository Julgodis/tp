...
/* 80C99948 00000010  4B FF FF B1 */	bl _savegpr_26
/* 80C9994C 00000014  7C 7F 1B 78 */	mr r31, r3
/* 80C99950 00000018  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99954 0000001C  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
/* 80C99958 00000020  80 63 00 00 */	lwz r3, 0(r3)
/* 80C9995C 00000024  38 80 00 15 */	li r4, 0x15
/* 80C99960 00000028  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C99964 0000002C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C99978 00000040  4B FF FF 81 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99988 00000050  4B FF FF 71 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C999A4:
/* 80C999A4 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C999A8 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80C999AC 00000008  3B 83 07 F0 */	addi r28, r3, 0x7f0
/* 80C999B0 0000000C  7F 83 E3 78 */	mr r3, r28
/* 80C999B4 00000010  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80C999B8 00000014  3B A4 00 00 */	addi r29, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
/* 80C999BC 00000018  A0 9D 02 C4 */	lhz r4, 0x2c4(r29)
/* 80C999C0 0000001C  4B FF FF 39 */	bl isEventBit__11dSv_event_cCFUs
/* 80C999C4 00000020  7C 60 1B 79 */	or. r0, r3, r3
/* 80C999C8 00000024  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C999CC 00000028  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C999E8 00000008  4B FF FF 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C999F8 00000018  4B FF FF 01 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80C99A14:
/* 80C99A14 00000000  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99A18 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99A2C 00000018  4B FF FE CD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99A30 0000001C  7C 7A 1B 78 */	mr r26, r3
/* 80C99A34 00000020  38 60 00 1C */	li r3, 0x1c
/* 80C99A38 00000024  4B FF FE C1 */	bl __nw__FUl
/* 80C99A3C 00000028  7C 7B 1B 79 */	or. r27, r3, r3
/* 80C99A40 0000002C  41 82 00 20 */	beq lbl_80C99A60
/* 80C99A44 00000030  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9B2F8 */
/* 80C99A48 00000034  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9B2F8 */
/* 80C99A4C 00000038  90 1B 00 00 */	stw r0, 0(r27)
/* 80C99A50 0000003C  38 80 00 00 */	li r4, 0
/* 80C99A54 00000040  4B FF FE A5 */	bl init__12J3DFrameCtrlFs
...
/* 80C99A74 00000014  3C 60 00 00 */	lis r3, lit_3850@ha /* 80C9B25C */
/* 80C99A78 00000018  C0 23 00 00 */	lfs f1, lit_3850@l(r3) /* 80C9B25C */
/* 80C99A7C 0000001C  48 00 00 0C */	b lbl_80C99A88
lbl_80C99A80:
/* 80C99A80 00000000  3C 60 00 00 */	lis r3, lit_3851@ha /* 80C9B260 */
/* 80C99A84 00000004  C0 23 00 00 */	lfs f1, lit_3851@l(r3) /* 80C9B260 */
lbl_80C99A88:
...
/* 80C99AAC 00000024  4B FF FE 4D */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C99AD4 00000014  3C 60 00 00 */	lis r3, lit_3853@ha /* 80C9B264 */
/* 80C99AD8 00000018  C8 23 00 00 */	lfd f1, lit_3853@l(r3) /* 80C9B264 */
...
lbl_80C99AFC:
/* 80C99AFC 00000000  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99B00 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99B14 00000018  4B FF FD E5 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99B28 0000002C  4B FF FD D1 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80C99B44 00000008  4B FF FD B5 */	bl isEventBit__11dSv_event_cCFUs
/* 80C99B48 0000000C  7C 60 1B 79 */	or. r0, r3, r3
/* 80C99B4C 00000010  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99B50 00000014  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99B6C 00000008  4B FF FD 8D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99B80 0000001C  4B FF FD 79 */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80C99BC0 0000002C  4B FF FD 39 */	bl isEventBit__11dSv_event_cCFUs
/* 80C99BC4 00000030  2C 03 00 00 */	cmpwi r3, 0
/* 80C99BC8 00000034  41 82 03 50 */	beq lbl_80C99F18
/* 80C99BCC 00000038  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99BD0 0000003C  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99BE4 00000050  4B FF FD 15 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99BF8 00000064  4B FF FD 01 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99BFC 00000068  90 7F 05 70 */	stw r3, 0x570(r31)
/* 80C99C00 0000006C  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99C04 00000070  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99C18 00000084  4B FF FC E1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99C1C 00000088  7C 7A 1B 78 */	mr r26, r3
/* 80C99C20 0000008C  38 60 00 18 */	li r3, 0x18
/* 80C99C24 00000090  4B FF FC D5 */	bl __nw__FUl
/* 80C99C28 00000094  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99C2C 00000098  41 82 00 20 */	beq lbl_80C99C4C
/* 80C99C30 0000009C  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9B2F8 */
/* 80C99C34 000000A0  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9B2F8 */
/* 80C99C38 000000A4  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99C3C 000000A8  38 80 00 00 */	li r4, 0
/* 80C99C40 000000AC  4B FF FC B9 */	bl init__12J3DFrameCtrlFs
...
/* 80C99C6C 00000020  3D 00 00 00 */	lis r8, lit_3850@ha /* 80C9B25C */
/* 80C99C70 00000024  C0 28 00 00 */	lfs f1, lit_3850@l(r8) /* 80C9B25C */
/* 80C99C74 00000028  39 00 00 00 */	li r8, 0
/* 80C99C78 0000002C  39 20 FF FF */	li r9, -1
/* 80C99C7C 00000030  4B FF FC 7D */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C99C90:
/* 80C99C90 00000000  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99C94 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99CA8 00000018  4B FF FC 51 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99CBC 0000002C  4B FF FC 3D */	bl Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C99CD0:
/* 80C99CD0 00000000  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99CD4 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99CE8 00000018  4B FF FC 11 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99CF8 00000028  4B FF FC 01 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99CFC 0000002C  90 7F 05 74 */	stw r3, 0x574(r31)
/* 80C99D00 00000030  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99D04 00000034  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99D18 00000048  4B FF FB E1 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99D2C 0000005C  4B FF FB CD */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99D30 00000060  90 7F 05 78 */	stw r3, 0x578(r31)
/* 80C99D34 00000064  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99D38 00000068  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99D4C 0000007C  4B FF FB AD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99D50 00000080  7C 7A 1B 78 */	mr r26, r3
/* 80C99D54 00000084  38 60 00 18 */	li r3, 0x18
/* 80C99D58 00000088  4B FF FB A1 */	bl __nw__FUl
/* 80C99D5C 0000008C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99D60 00000090  41 82 00 20 */	beq lbl_80C99D80
/* 80C99D64 00000094  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9B2F8 */
/* 80C99D68 00000098  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9B2F8 */
/* 80C99D6C 0000009C  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99D70 000000A0  38 80 00 00 */	li r4, 0
/* 80C99D74 000000A4  4B FF FB 85 */	bl init__12J3DFrameCtrlFs
...
/* 80C99DA0 00000020  3D 00 00 00 */	lis r8, lit_3850@ha /* 80C9B25C */
/* 80C99DA4 00000024  C0 28 00 00 */	lfs f1, lit_3850@l(r8) /* 80C9B25C */
/* 80C99DA8 00000028  39 00 00 00 */	li r8, 0
/* 80C99DAC 0000002C  39 20 FF FF */	li r9, -1
/* 80C99DB0 00000030  4B FF FB 49 */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C99DC4:
/* 80C99DC4 00000000  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99DC8 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99DDC 00000018  4B FF FB 1D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C99DF0 0000002C  4B FF FB 09 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl
/* 80C99DF4 00000030  90 7F 05 7C */	stw r3, 0x57c(r31)
/* 80C99DF8 00000034  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99DFC 00000038  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99E10 0000004C  4B FF FA E9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99E14 00000050  7C 7B 1B 78 */	mr r27, r3
/* 80C99E18 00000054  38 60 00 18 */	li r3, 0x18
/* 80C99E1C 00000058  4B FF FA DD */	bl __nw__FUl
/* 80C99E20 0000005C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99E24 00000060  41 82 00 20 */	beq lbl_80C99E44
/* 80C99E28 00000064  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9B2F8 */
/* 80C99E2C 00000068  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9B2F8 */
/* 80C99E30 0000006C  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99E34 00000070  38 80 00 00 */	li r4, 0
/* 80C99E38 00000074  4B FF FA C1 */	bl init__12J3DFrameCtrlFs
...
/* 80C99E64 00000020  3D 00 00 00 */	lis r8, lit_3850@ha /* 80C9B25C */
/* 80C99E68 00000024  C0 28 00 00 */	lfs f1, lit_3850@l(r8) /* 80C9B25C */
/* 80C99E6C 00000028  39 00 00 00 */	li r8, 0
/* 80C99E70 0000002C  39 20 FF FF */	li r9, -1
/* 80C99E74 00000030  4B FF FA 85 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C99E88:
/* 80C99E88 00000000  3C 60 00 00 */	lis r3, l_arcName@ha /* 80C9B2A4 */
/* 80C99E8C 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l /* 80C9B2A4 */
...
/* 80C99EA0 00000018  4B FF FA 59 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80C99EA4 0000001C  7C 7B 1B 78 */	mr r27, r3
/* 80C99EA8 00000020  38 60 00 1C */	li r3, 0x1c
/* 80C99EAC 00000024  4B FF FA 4D */	bl __nw__FUl
/* 80C99EB0 00000028  7C 7C 1B 79 */	or. r28, r3, r3
/* 80C99EB4 0000002C  41 82 00 20 */	beq lbl_80C99ED4
/* 80C99EB8 00000030  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 80C9B2F8 */
/* 80C99EBC 00000034  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 80C9B2F8 */
/* 80C99EC0 00000038  90 1C 00 00 */	stw r0, 0(r28)
/* 80C99EC4 0000003C  38 80 00 00 */	li r4, 0
/* 80C99EC8 00000040  4B FF FA 31 */	bl init__12J3DFrameCtrlFs
...
/* 80C99EF0 0000001C  3C E0 00 00 */	lis r7, lit_3850@ha /* 80C9B25C */
/* 80C99EF4 00000020  C0 27 00 00 */	lfs f1, lit_3850@l(r7) /* 80C9B25C */
/* 80C99EF8 00000024  38 E0 00 00 */	li r7, 0
/* 80C99EFC 00000028  39 00 FF FF */	li r8, -1
/* 80C99F00 0000002C  39 20 00 00 */	li r9, 0
/* 80C99F04 00000030  4B FF F9 F5 */	bl init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80C99F20 00000004  4B FF F9 D9 */	bl _restgpr_26

...
/* 80C99950 00000018  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99954 0000001C  38 63 00 00 */	addi r3, r3, l_arcName@l
/* 80C99958 00000020  80 63 00 00 */	lwz r3, 0(r3)
/* 80C9995C 00000024  38 80 00 15 */	li r4, 0x15
/* 80C99960 00000028  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C99964 0000002C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
lbl_80C999A4:
/* 80C999A4 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C999A8 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C999AC 00000008  3B 83 07 F0 */	addi r28, r3, 0x7f0
/* 80C999B0 0000000C  7F 83 E3 78 */	mr r3, r28
/* 80C999B4 00000010  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C999B8 00000014  3B A4 00 00 */	addi r29, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 80C999C8 00000024  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C999CC 00000028  38 63 00 00 */	addi r3, r3, l_arcName@l
...
lbl_80C99A14:
/* 80C99A14 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99A18 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99A44 00000030  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C99A48 00000034  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C99A74 00000014  3C 60 00 00 */	lis r3, lit_3850@ha
/* 80C99A78 00000018  C0 23 00 00 */	lfs f1, lit_3850@l(r3)
/* 80C99A7C 0000001C  48 00 00 0C */	b lbl_80C99A88
lbl_80C99A80:
/* 80C99A80 00000000  3C 60 00 00 */	lis r3, lit_3851@ha
/* 80C99A84 00000004  C0 23 00 00 */	lfs f1, lit_3851@l(r3)
lbl_80C99A88:
...
/* 80C99AD4 00000014  3C 60 00 00 */	lis r3, lit_3853@ha
/* 80C99AD8 00000018  C8 23 00 00 */	lfd f1, lit_3853@l(r3)
...
lbl_80C99AFC:
/* 80C99AFC 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99B00 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99B4C 00000010  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99B50 00000014  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99BCC 00000038  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99BD0 0000003C  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99C00 0000006C  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99C04 00000070  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99C30 0000009C  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C99C34 000000A0  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C99C6C 00000020  3D 00 00 00 */	lis r8, lit_3850@ha
/* 80C99C70 00000024  C0 28 00 00 */	lfs f1, lit_3850@l(r8)
...
lbl_80C99C90:
/* 80C99C90 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99C94 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
lbl_80C99CD0:
/* 80C99CD0 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99CD4 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99D00 00000030  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99D04 00000034  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99D34 00000064  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99D38 00000068  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99D64 00000094  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C99D68 00000098  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C99DA0 00000020  3D 00 00 00 */	lis r8, lit_3850@ha
/* 80C99DA4 00000024  C0 28 00 00 */	lfs f1, lit_3850@l(r8)
...
lbl_80C99DC4:
/* 80C99DC4 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99DC8 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99DF8 00000034  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99DFC 00000038  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99E28 00000064  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C99E2C 00000068  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C99E64 00000020  3D 00 00 00 */	lis r8, lit_3850@ha
/* 80C99E68 00000024  C0 28 00 00 */	lfs f1, lit_3850@l(r8)
...
lbl_80C99E88:
/* 80C99E88 00000000  3C 60 00 00 */	lis r3, l_arcName@ha
/* 80C99E8C 00000004  38 63 00 00 */	addi r3, r3, l_arcName@l
...
/* 80C99EB8 00000030  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C99EBC 00000034  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l
...
/* 80C99EF0 0000001C  3C E0 00 00 */	lis r7, lit_3850@ha
/* 80C99EF4 00000020  C0 27 00 00 */	lfs f1, lit_3850@l(r7)

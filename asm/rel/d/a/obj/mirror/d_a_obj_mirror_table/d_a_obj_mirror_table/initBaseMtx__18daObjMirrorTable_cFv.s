...
/* 80C9AFF4  4B 37 24 34 */	b play__14mDoExt_baseAnmFv
/* 80C9AFF8  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80C9AFFC  4B 37 1D 68 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80C9B000  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80C9B004  4B 37 1F 40 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C9B008  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B00C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B010  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80C9B014  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9B018  4B 6A B4 98 */	b PSMTXCopy
/* 80C9B01C  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80C9B020  28 04 00 00 */	cmplwi r4, 0
/* 80C9B024  41 82 00 14 */	beq lbl_80C9B038
/* 80C9B028  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B02C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B030  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9B034  4B 6A B4 7C */	b PSMTXCopy
lbl_80C9B038:
/* 80C9B038  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80C9B03C  28 04 00 00 */	cmplwi r4, 0
/* 80C9B040  41 82 00 14 */	beq lbl_80C9B054
/* 80C9B044  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B048  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B04C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9B050  4B 6A B4 60 */	b PSMTXCopy
lbl_80C9B054:
/* 80C9B054  80 9F 05 78 */	lwz r4, 0x578(r31)
/* 80C9B058  28 04 00 00 */	cmplwi r4, 0
/* 80C9B05C  41 82 00 14 */	beq lbl_80C9B070
/* 80C9B060  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B064  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B068  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9B06C  4B 6A B4 44 */	b PSMTXCopy
lbl_80C9B070:
/* 80C9B070  80 9F 05 7C */	lwz r4, 0x57c(r31)
/* 80C9B074  28 04 00 00 */	cmplwi r4, 0
/* 80C9B078  41 82 00 14 */	beq lbl_80C9B08C
/* 80C9B07C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B080  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B084  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9B088  4B 6A B4 28 */	b PSMTXCopy
lbl_80C9B08C:
/* 80C9B08C  38 7F 05 9C */	addi r3, r31, 0x59c
/* 80C9B090  4B 5C D1 44 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9B094  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9B098  41 82 00 1C */	beq lbl_80C9B0B4
/* 80C9B09C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B0A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B0A4  38 9F 07 DC */	addi r4, r31, 0x7dc
/* 80C9B0A8  4B 6A B4 08 */	b PSMTXCopy
/* 80C9B0AC  38 7F 05 9C */	addi r3, r31, 0x59c
/* 80C9B0B0  4B 3E 09 10 */	b Move__4dBgWFv
lbl_80C9B0B4:
/* 80C9B0B4  38 7F 07 1C */	addi r3, r31, 0x71c
/* 80C9B0B8  4B 5C D1 1C */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9B0BC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9B0C0  41 82 00 1C */	beq lbl_80C9B0DC
/* 80C9B0C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B0C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B0CC  38 9F 08 3C */	addi r4, r31, 0x83c
/* 80C9B0D0  4B 6A B3 E0 */	b PSMTXCopy
/* 80C9B0D4  38 7F 07 1C */	addi r3, r31, 0x71c
/* 80C9B0D8  4B 3E 08 E8 */	b Move__4dBgWFv
lbl_80C9B0DC:
...
/* 80C9B0EC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80C9B0F0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80C9B0F4  4B 6A B3 BC */	b PSMTXCopy
/* 80C9B0F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B0FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B100  80 9F 05 6C */	lwz r4, 0x56c(r31)
/* 80C9B104  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9B108  4B 6A B3 A8 */	b PSMTXCopy
/* 80C9B10C  38 7F 05 9C */	addi r3, r31, 0x59c
/* 80C9B110  4B 5C D0 C4 */	b ChkUsed__9cBgW_BgIdCFv
/* 80C9B114  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C9B118  41 82 00 1C */	beq lbl_80C9B134
/* 80C9B11C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B120  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B124  38 9F 08 0C */	addi r4, r31, 0x80c
/* 80C9B128  4B 6A B3 88 */	b PSMTXCopy
/* 80C9B12C  38 7F 06 5C */	addi r3, r31, 0x65c
/* 80C9B130  4B 3E 08 90 */	b Move__4dBgWFv
lbl_80C9B134:
/* 80C9B134  80 9F 08 6C */	lwz r4, 0x86c(r31)
/* 80C9B138  28 04 00 00 */	cmplwi r4, 0
/* 80C9B13C  41 82 00 D0 */	beq lbl_80C9B20C
/* 80C9B140  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9B144  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9B148  C0 43 00 0C */	lfs f2, 0xc(r3)	/* effective address: 803DD47C */
/* 80C9B14C  D0 41 00 10 */	stfs f2, 0x10(r1)
/* 80C9B150  C0 23 00 1C */	lfs f1, 0x1c(r3)	/* effective address: 803DD48C */
/* 80C9B154  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 80C9B158  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80C9B184  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9B188  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9B18C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9B1A0  3D 00 80 CA */	lis r8, lit_3850@ha
/* 80C9B1A4  C0 28 B2 5C */	lfs f1, lit_3850@l(r8)
/* 80C9B1A8  FC 40 08 90 */	fmr f2, f1
/* 80C9B1AC  3D 00 80 CA */	lis r8, lit_4350@ha
/* 80C9B1B0  C0 68 B2 6C */	lfs f3, lit_4350@l(r8)
/* 80C9B1B4  FC 80 18 90 */	fmr f4, f3
/* 80C9B1B8  39 00 00 00 */	li r8, 0
/* 80C9B1BC  4B 61 13 50 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C9B1D0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C9B1D4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C9B1D8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C9B1EC  3D 00 80 CA */	lis r8, lit_3850@ha
/* 80C9B1F0  C0 28 B2 5C */	lfs f1, lit_3850@l(r8)
/* 80C9B1F4  FC 40 08 90 */	fmr f2, f1
/* 80C9B1F8  3D 00 80 CA */	lis r8, lit_4350@ha
/* 80C9B1FC  C0 68 B2 6C */	lfs f3, lit_4350@l(r8)
/* 80C9B200  FC 80 18 90 */	fmr f4, f3
/* 80C9B204  39 00 00 00 */	li r8, 0
/* 80C9B208  4B 61 13 04 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80C9B20C:

...
/* 80CD9B6C  3C 60 80 CE */	lis r3, l_cyl_src@ha
/* 80CD9B70  3B C3 B7 F4 */	addi r30, r3, l_cyl_src@l
/* 80CD9B74  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CD9B78  38 03 BA A0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CD9B7C  90 01 00 5C */	stw r0, 0x5c(r1)
/* 80CD9B80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CD9B84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CD9B88  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80CD9B8C  38 A1 00 4C */	addi r5, r1, 0x4c
/* 80CD9B90  4B 39 AB B4 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80CD9BB8  4B 66 D5 80 */	b PSVECSquareMag
...
/* 80CD9C28  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD9C2C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80CD9C98  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD9C9C  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)
...
/* 80CD9D0C  4B 66 D4 2C */	b PSVECSquareMag
...
/* 80CD9D7C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD9D80  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80CD9DEC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CD9DF0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80CD9DF4:
/* 80CD9DF4  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CD9DF8  38 03 BA A0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80CD9DFC  90 01 00 5C */	stw r0, 0x5c(r1)
/* 80CD9E00  48 00 00 14 */	b lbl_80CD9E14
lbl_80CD9E04:
/* 80CD9E04  3C 60 80 CE */	lis r3, __vt__8cM3dGPla@ha
/* 80CD9E08  38 03 BA A0 */	addi r0, r3, __vt__8cM3dGPla@l

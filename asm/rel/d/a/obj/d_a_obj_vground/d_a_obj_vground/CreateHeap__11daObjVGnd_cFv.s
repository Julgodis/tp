...
/* 80D21510  4B 64 0C C4 */	b _savegpr_27
/* 80D21514  7C 7E 1B 78 */	mr r30, r3
/* 80D21518  3C 60 80 D2 */	lis r3, l_arcName@ha
/* 80D2151C  38 63 1A 24 */	addi r3, r3, l_arcName@l
/* 80D21520  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D21A24 */
/* 80D21524  38 80 00 05 */	li r4, 5
/* 80D21528  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D2152C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D21540  4B 31 AD AC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D21554  4B 2F 37 00 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D21570:
/* 80D21570  3C 60 80 D2 */	lis r3, l_arcName@ha
/* 80D21574  38 63 1A 24 */	addi r3, r3, l_arcName@l
/* 80D21578  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D21A24 */
/* 80D2157C  38 80 00 0B */	li r4, 0xb
/* 80D21580  7F 85 E3 78 */	mr r5, r28
/* 80D21584  38 C0 00 80 */	li r6, 0x80
/* 80D21588  4B 31 AD 64 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D2158C  7C 7B 1B 78 */	mr r27, r3
/* 80D21590  38 60 00 18 */	li r3, 0x18
/* 80D21594  4B 5A D6 B8 */	b __nw__FUl
/* 80D21598  7C 7D 1B 79 */	or. r29, r3, r3
/* 80D2159C  41 82 00 20 */	beq lbl_80D215BC
/* 80D215A0  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D215A4  38 04 1A 78 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D215A8  90 1D 00 00 */	stw r0, 0(r29)
/* 80D215AC  38 80 00 00 */	li r4, 0
/* 80D215B0  4B 60 6E 4C */	b init__12J3DFrameCtrlFs
...
/* 80D215DC  3D 00 80 D2 */	lis r8, lit_3704@ha
/* 80D215E0  C0 28 1A 0C */	lfs f1, lit_3704@l(r8)
/* 80D215E4  39 00 00 00 */	li r8, 0
/* 80D215E8  39 20 FF FF */	li r9, -1
/* 80D215EC  4B 2E C0 50 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80D21600:
/* 80D21600  3C 60 80 D2 */	lis r3, l_arcName@ha
/* 80D21604  38 63 1A 24 */	addi r3, r3, l_arcName@l
/* 80D21608  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D21A24 */
/* 80D2160C  38 80 00 08 */	li r4, 8
/* 80D21610  7F 85 E3 78 */	mr r5, r28
/* 80D21614  38 C0 00 80 */	li r6, 0x80
/* 80D21618  4B 31 AC D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D2161C  7C 7B 1B 78 */	mr r27, r3
/* 80D21620  38 60 00 18 */	li r3, 0x18
/* 80D21624  4B 5A D6 28 */	b __nw__FUl
/* 80D21628  7C 7D 1B 79 */	or. r29, r3, r3
/* 80D2162C  41 82 00 20 */	beq lbl_80D2164C
/* 80D21630  3C 80 80 D2 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D21634  38 04 1A 78 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D21638  90 1D 00 00 */	stw r0, 0(r29)
/* 80D2163C  38 80 00 00 */	li r4, 0
/* 80D21640  4B 60 6D BC */	b init__12J3DFrameCtrlFs
...
/* 80D2166C  3D 00 80 D2 */	lis r8, lit_3704@ha
/* 80D21670  C0 28 1A 0C */	lfs f1, lit_3704@l(r8)
/* 80D21674  39 00 00 00 */	li r8, 0
/* 80D21678  39 20 FF FF */	li r9, -1
/* 80D2167C  4B 2E C0 90 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80D21698  4B 64 0B 88 */	b _restgpr_27

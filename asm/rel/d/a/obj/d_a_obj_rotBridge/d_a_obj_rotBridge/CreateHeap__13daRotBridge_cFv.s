...
/* 80CBEB48  4B 6A 36 94 */	b _savegpr_29
/* 80CBEB4C  7C 7E 1B 78 */	mr r30, r3
/* 80CBEB50  3C 60 80 CC */	lis r3, lit_3626@ha
/* 80CBEB54  3B A3 F6 68 */	addi r29, r3, lit_3626@l
/* 80CBEB58  88 1E 05 AC */	lbz r0, 0x5ac(r30)
/* 80CBEB5C  54 00 10 3A */	slwi r0, r0, 2
/* 80CBEB60  3C 60 80 CC */	lis r3, l_resNameIdx@ha
/* 80CBEB64  38 63 F6 D8 */	addi r3, r3, l_resNameIdx@l
/* 80CBEB68  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CBEB6C  38 9D 00 04 */	addi r4, r29, 4
/* 80CBEB70  7C 84 00 2E */	lwzx r4, r4, r0
/* 80CBEB74  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CBEB78  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80CBEB8C  4B 37 D7 60 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CBEB9C  4B 35 60 B8 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CBEBC0  3C 60 80 CC */	lis r3, l_resNameIdx@ha
/* 80CBEBC4  38 63 F6 D8 */	addi r3, r3, l_resNameIdx@l
...
/* 80CBEBDC  4B 37 D7 10 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CBEC00  4B 34 EB DC */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80CBEC50  3C 60 80 CC */	lis r3, l_resNameIdx@ha
/* 80CBEC54  38 63 F6 D8 */	addi r3, r3, l_resNameIdx@l
...
/* 80CBEC68  4B 37 D6 84 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CBEC7C  4B 3B B2 BC */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80CBECA8  4B 6A 35 80 */	b _restgpr_29

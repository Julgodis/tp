...
/* 80CBBE30 00000018  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CBBE34 0000001C  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80CBBE48 00000030  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CBBE4C 00000034  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80CBBE60 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBBE64 0000004C  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 80CBBE68 00000050  80 04 5F 70 */	lwz r0, 0x5f70(r4)
/* 80CBBE6C 00000054  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80CBBE70 00000058  3B C3 00 00 */	addi r30, r3, j3dSys@l
...
/* 80CBBE88 00000070  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBBE8C 00000074  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CBBEB0 00000098  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CBBEB4 0000009C  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80CBBED4 000000BC  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CBBED8 000000C0  38 63 00 00 */	addi r3, r3, g_env_light@l
...
/* 80CBBEFC 0000000C  3C 60 00 00 */	lis r3, g_env_light@ha
/* 80CBBF00 00000010  38 63 00 00 */	addi r3, r3, g_env_light@l

...
/* 80CBA8C0 00000018  3C 60 00 00 */	lis r3, l_cull_box@ha
/* 80CBA8C4 0000001C  3B E3 00 00 */	addi r31, r3, l_cull_box@l
/* 80CBA8C8 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBA8CC 00000024  3B 63 00 00 */	addi r27, r3, g_dComIfG_gameInfo@l
...
/* 80CBA90C 00000064  3C 60 00 00 */	lis r3, search_coach__FPvPv@ha
/* 80CBA910 00000068  38 63 00 00 */	addi r3, r3, search_coach__FPvPv@l
...
/* 80CBA92C 00000084  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA930 00000088  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA934 0000008C  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80CBA938 00000090  4B FF F3 41 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CBA93C 00000094  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA940 00000098  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBA978 000000D0  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CBA97C 000000D4  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CBA980 000000D8  4B FF F2 F9 */	bl PSMTXCopy
/* 80CBA984 000000DC  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA988 000000E0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBAA18 00000030  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBAA1C 00000034  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80CBAA34 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAA38 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAA3C 00000054  A8 9B 04 E6 */	lha r4, 0x4e6(r27)
/* 80CBAA40 00000058  4B FF F2 39 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CBAA44 0000005C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAA48 00000060  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBAA80 00000098  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CBAA84 0000009C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CBAA88 000000A0  4B FF F1 F1 */	bl PSMTXCopy
/* 80CBAA8C 000000A4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAA90 000000A8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBAB30 00000040  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBAB34 00000044  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_80CBAB68:
/* 80CBAB68 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAB6C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAB70 00000008  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CBAB74 0000000C  4B FF F1 05 */	bl mDoMtx_YrotS__FPA4_fs
/* 80CBAB78 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAB7C 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CBABAC 00000044  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CBABB0 00000048  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CBABB4 0000004C  4B FF F0 C5 */	bl PSMTXCopy
/* 80CBABB8 00000050  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBABBC 00000054  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

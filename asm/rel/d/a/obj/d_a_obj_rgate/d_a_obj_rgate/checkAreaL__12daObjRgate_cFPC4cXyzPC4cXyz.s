...
/* 80CBA8B8 00000010  4B 6A 79 1C */	b _savegpr_27
/* 80CBA8BC 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80CBA8C0 00000018  3C 60 80 CC */	lis r3, l_cull_box@ha
/* 80CBA8C4 0000001C  3B E3 C3 68 */	addi r31, r3, l_cull_box@l
/* 80CBA8C8 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBA8CC 00000024  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l
/* 80CBA8D0 00000028  83 DB 5D AC */	lwz r30, 0x5dac(r27)	/* effective address: 8040BF6C */
/* 80CBA8D4 0000002C  C0 3F 00 5C */	lfs f1, 0x5c(r31)	/* effective address: 80CBC3C4 */
/* 80CBA8D8 00000030  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 80CBA8DC 00000034  D0 21 00 18 */	stfs f1, 0x18(r1)
/* 80CBA8E0 00000038  C0 1F 00 9C */	lfs f0, 0x9c(r31)	/* effective address: 80CBC404 */
/* 80CBA8E4 0000003C  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CBA8E8 00000040  C0 1F 00 A0 */	lfs f0, 0xa0(r31)	/* effective address: 80CBC408 */
/* 80CBA8EC 00000044  D0 01 00 08 */	stfs f0, 8(r1)
/* 80CBA8F0 00000048  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80CBA8F4 0000004C  C0 1F 00 A4 */	lfs f0, 0xa4(r31)	/* effective address: 80CBC40C */
...
/* 80CBA904 0000005C  C0 1F 00 A8 */	lfs f0, 0xa8(r31)	/* effective address: 80CBC410 */
/* 80CBA908 00000060  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80CBA90C 00000064  3C 60 80 CC */	lis r3, search_coach__FPvPv@ha
/* 80CBA910 00000068  38 63 9C 98 */	addi r3, r3, search_coach__FPvPv@l
/* 80CBA914 0000006C  7F A4 EB 78 */	mr r4, r29
/* 80CBA918 00000070  4B 35 EE E0 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80CBA928 00000080  4B 35 24 3C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CBA92C 00000084  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA930 00000088  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA934 0000008C  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 80CBA938 00000090  4B 35 1A FC */	b mDoMtx_YrotM__FPA4_fs
/* 80CBA93C 00000094  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA940 00000098  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA944 0000009C  38 81 00 20 */	addi r4, r1, 0x20
/* 80CBA948 000000A0  7C 85 23 78 */	mr r5, r4
/* 80CBA94C 000000A4  4B 68 C4 20 */	b PSMTXMultVec
...
/* 80CBA970 000000C8  4B 68 BC 40 */	b PSMTXInverse
/* 80CBA974 000000CC  38 61 00 38 */	addi r3, r1, 0x38
/* 80CBA978 000000D0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CBA97C 000000D4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CBA980 000000D8  4B 68 BB 30 */	b PSMTXCopy
/* 80CBA984 000000DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBA988 000000E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBA98C 000000E4  38 81 00 2C */	addi r4, r1, 0x2c
/* 80CBA990 000000E8  7C 85 23 78 */	mr r5, r4
/* 80CBA994 000000EC  4B 68 C3 D8 */	b PSMTXMultVec
...
lbl_80CBA9E8:
/* 80CBA9E8 00000000  80 7B 5D AC */	lwz r3, 0x5dac(r27)	/* effective address: 8040BF6C */
...
/* 80CBAA04 0000001C  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80CBC3C4 */
/* 80CBAA08 00000020  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80CBAA0C 00000024  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80CBAA10 00000028  C0 1F 00 AC */	lfs f0, 0xac(r31)	/* effective address: 80CBC414 */
/* 80CBAA14 0000002C  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80CBAA18 00000030  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBAA1C 00000034  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CBAA20 00000038  83 63 5D B8 */	lwz r27, 0x5db8(r3)	/* effective address: 8040BF78 */
...
/* 80CBAA30 00000048  4B 35 23 34 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80CBAA34 0000004C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAA38 00000050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAA3C 00000054  A8 9B 04 E6 */	lha r4, 0x4e6(r27)
/* 80CBAA40 00000058  4B 35 19 F4 */	b mDoMtx_YrotM__FPA4_fs
/* 80CBAA44 0000005C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAA48 00000060  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAA4C 00000064  38 81 00 20 */	addi r4, r1, 0x20
/* 80CBAA50 00000068  7C 85 23 78 */	mr r5, r4
/* 80CBAA54 0000006C  4B 68 C3 18 */	b PSMTXMultVec
...
/* 80CBAA78 00000090  4B 68 BB 38 */	b PSMTXInverse
/* 80CBAA7C 00000094  38 61 00 38 */	addi r3, r1, 0x38
/* 80CBAA80 00000098  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CBAA84 0000009C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CBAA88 000000A0  4B 68 BA 28 */	b PSMTXCopy
/* 80CBAA8C 000000A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAA90 000000A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAA94 000000AC  38 81 00 2C */	addi r4, r1, 0x2c
/* 80CBAA98 000000B0  7C 85 23 78 */	mr r5, r4
/* 80CBAA9C 000000B4  4B 68 C2 D0 */	b PSMTXMultVec
...
lbl_80CBAAF0:
/* 80CBAAF0 00000000  C0 3F 00 5C */	lfs f1, 0x5c(r31)	/* effective address: 80CBC3C4 */
/* 80CBAAF4 00000004  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 80CBAAF8 00000008  D0 21 00 18 */	stfs f1, 0x18(r1)
/* 80CBAAFC 0000000C  C0 1F 00 9C */	lfs f0, 0x9c(r31)	/* effective address: 80CBC404 */
/* 80CBAB00 00000010  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 80CBAB04 00000014  C0 1F 00 6C */	lfs f0, 0x6c(r31)	/* effective address: 80CBC3D4 */
/* 80CBAB08 00000018  D0 01 00 08 */	stfs f0, 8(r1)
/* 80CBAB0C 0000001C  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 80CBAB10 00000020  C0 1F 00 A8 */	lfs f0, 0xa8(r31)	/* effective address: 80CBC410 */
...
/* 80CBAB30 00000040  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80CBAB34 00000044  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80CBAB38 00000048  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 80CBAB3C 0000004C  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 80CBAB50 00000060  C0 1F 00 B0 */	lfs f0, 0xb0(r31)	/* effective address: 80CBC418 */
...
lbl_80CBAB68:
/* 80CBAB68 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAB6C 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAB70 00000008  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80CBAB74 0000000C  4B 35 18 68 */	b mDoMtx_YrotS__FPA4_fs
/* 80CBAB78 00000010  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBAB7C 00000014  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBAB80 00000018  38 81 00 20 */	addi r4, r1, 0x20
/* 80CBAB84 0000001C  7C 85 23 78 */	mr r5, r4
/* 80CBAB88 00000020  4B 68 C1 E4 */	b PSMTXMultVec
...
/* 80CBAB98 00000030  4B 68 C4 F8 */	b PSVECAdd
/* 80CBAB9C 00000034  38 7D 0C 30 */	addi r3, r29, 0xc30
/* 80CBABA0 00000038  38 81 00 38 */	addi r4, r1, 0x38
/* 80CBABA4 0000003C  4B 68 BA 0C */	b PSMTXInverse
/* 80CBABA8 00000040  38 61 00 38 */	addi r3, r1, 0x38
/* 80CBABAC 00000044  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80CBABB0 00000048  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80CBABB4 0000004C  4B 68 B8 FC */	b PSMTXCopy
/* 80CBABB8 00000050  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CBABBC 00000054  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CBABC0 00000058  38 81 00 2C */	addi r4, r1, 0x2c
/* 80CBABC4 0000005C  7C 85 23 78 */	mr r5, r4
/* 80CBABC8 00000060  4B 68 C1 A4 */	b PSMTXMultVec
...
/* 80CBAC24 00000004  4B 6A 75 FC */	b _restgpr_27

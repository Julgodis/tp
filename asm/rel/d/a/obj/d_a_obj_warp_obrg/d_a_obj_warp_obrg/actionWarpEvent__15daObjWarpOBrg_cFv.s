...
/* 80D2A7DC 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D2A7E0 0000001C  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80D2A80C 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D2A810 0000004C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D2A814 00000050  3B E3 0D D8 */	addi r31, r3, 0xdd8
/* 80D2A818 00000054  7F E3 FB 78 */	mr r3, r31
/* 80D2A81C 00000058  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A820 0000005C  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A830 0000006C  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A834 00000070  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A844 00000080  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A848 00000084  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A858 00000094  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A85C 00000098  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A86C 000000A8  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A870 000000AC  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A880 000000BC  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A884 000000C0  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A894 000000D0  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A898 000000D4  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A8A8 000000E4  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A8AC 000000E8  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A8BC 000000F8  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A8C0 000000FC  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
...
/* 80D2A8D0 0000010C  3C 80 00 00 */	lis r4, tempBitLabels__20dSv_event_tmp_flag_c@ha /* 803790C0 */
/* 80D2A8D4 00000110  38 84 00 00 */	addi r4, r4, tempBitLabels__20dSv_event_tmp_flag_c@l /* 803790C0 */
/* 80D2A8D8 00000114  A0 84 00 6E */	lhz r4, 0x6e(r4)
/* 80D2A8DC 00000118  4B FF F0 BD */	bl offEventBit__11dSv_event_cFUs
/* 80D2A8E0 0000011C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D2A8E4 00000120  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80D2A908 00000144  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D2A90C 00000148  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D2A910 0000014C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D2A914 00000150  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D2A918 00000154  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

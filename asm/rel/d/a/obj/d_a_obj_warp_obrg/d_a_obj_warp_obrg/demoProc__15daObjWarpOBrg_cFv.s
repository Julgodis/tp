...
/* 80D2AA44  4B 63 77 70 */	b _savegpr_19
/* 80D2AA48  7C 7F 1B 78 */	mr r31, r3
/* 80D2AA4C  3C 60 80 D3 */	lis r3, l_bmd_idx@ha
/* 80D2AA50  3B C3 B7 F8 */	addi r30, r3, l_bmd_idx@l
/* 80D2AA54  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 80D2AA58  82 83 10 18 */	lwz r20, m_midnaActor__9daPy_py_c@l(r3)
/* 80D2AA5C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2AA60  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D2AA88  4B 31 D3 88 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 80D2AA8C  7C 7C 1B 78 */	mr r28, r3
/* 80D2AA90  7F A3 EB 78 */	mr r3, r29
/* 80D2AA94  80 9F 06 30 */	lwz r4, 0x630(r31)
/* 80D2AA98  4B 31 D2 B4 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80D2AAD4  3C A0 80 D3 */	lis r5, struct_80D2B8AC+0x0@ha
/* 80D2AAD8  38 A5 B8 AC */	addi r5, r5, struct_80D2B8AC+0x0@l
/* 80D2AADC  38 A5 00 62 */	addi r5, r5, 0x62
/* 80D2AAE0  38 C0 00 03 */	li r6, 3
/* 80D2AAE4  4B 31 D6 08 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80D2AB14  4B 53 D6 C0 */	b ChkUsed__9cBgW_BgIdCFv
...
/* 80D2AB28  4B 34 97 28 */	b Release__4cBgSFP9dBgW_Base
lbl_80D2AB2C:
/* 80D2AB2C  4B 30 4F BC */	b dComIfGp_TransportWarp_check__Fv
/* 80D2AB30  2C 03 00 00 */	cmpwi r3, 0
/* 80D2AB34  41 82 00 20 */	beq lbl_80D2AB54
/* 80D2AB38  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2AB3C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D2AB40  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D2AB44  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D2AB48  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D2AB4C  A0 84 00 FA */	lhz r4, 0xfa(r4)	/* effective address: 803A7382 */
/* 80D2AB50  4B 30 9E 3C */	b onEventBit__11dSv_event_cFUs
lbl_80D2AB54:
...
/* 80D2AB88  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2AB8C  3A E3 61 C0 */	addi r23, r3, struct_804061C0+0x0@l
/* 80D2AB90  3A DE 00 2C */	addi r22, r30, 0x2c
lbl_80D2AB94:
/* 80D2AB94  80 77 5D 3C */	lwz r3, 0x5d3c(r23)	/* effective address: 8040BEFC */
...
/* 80D2ABD4  4B 32 1E BC */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2AC4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2AC50  3A E3 61 C0 */	addi r23, r3, struct_804061C0+0x0@l
/* 80D2AC54  3A DE 00 38 */	addi r22, r30, 0x38
lbl_80D2AC58:
/* 80D2AC58  80 77 5D 3C */	lwz r3, 0x5d3c(r23)	/* effective address: 8040BEFC */
...
/* 80D2AC98  4B 32 1D F8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2ACDC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2ACE0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2ACE4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2AD0C  4B 58 0C 78 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D2AD28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2AD2C  3B 03 D4 70 */	addi r24, r3, now__14mDoMtx_stack_c@l
/* 80D2AD30  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D2AD34  3A C3 61 C0 */	addi r22, r3, struct_804061C0+0x0@l
...
/* 80D2AD94  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D2AD98  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80D2AD9C  4B 61 B7 14 */	b PSMTXCopy
/* 80D2ADA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D2ADA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D2ADA8  38 81 00 4C */	addi r4, r1, 0x4c
/* 80D2ADAC  7C 85 23 78 */	mr r5, r4
/* 80D2ADB0  4B 61 BF BC */	b PSMTXMultVec
/* 80D2ADB4  80 7F 05 A8 */	lwz r3, 0x5a8(r31)
/* 80D2ADB8  80 63 00 84 */	lwz r3, 0x84(r3)
/* 80D2ADBC  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80D2ADC0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D2ADC4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80D2ADC8  4B 61 B6 E8 */	b PSMTXCopy
/* 80D2ADCC  C0 3E 00 4C */	lfs f1, 0x4c(r30)
/* 80D2ADD0  C0 5E 00 98 */	lfs f2, 0x98(r30)
/* 80D2ADD4  FC 60 08 90 */	fmr f3, f1
/* 80D2ADD8  4B 2E 1F C4 */	b transM__14mDoMtx_stack_cFfff
...
/* 80D2ADFC  4B 54 5E 08 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 80D2AE00  7C 73 07 34 */	extsh r19, r3
/* 80D2AE04  38 61 00 4C */	addi r3, r1, 0x4c
/* 80D2AE08  38 81 00 58 */	addi r4, r1, 0x58
/* 80D2AE0C  4B 54 5E 68 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80D2AE60  4B 32 1C 30 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D2AE88  4B 61 C5 14 */	b PSVECSquareDistance
...
/* 80D2AEF8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D2AEFC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80D2AF68  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D2AF6C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80D2AF70:
...
/* 80D2AF98  4B 55 58 48 */	b func_802807E0
lbl_80D2AF9C:
...
/* 80D2AFBC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2AFC0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2AFC4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2AFEC  4B 58 09 98 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D2AFF0:
...
/* 80D2B030  4B 31 D1 4C */	b cutEnd__16dEvent_manager_cFi
/* 80D2B034  48 00 03 70 */	b lbl_80D2B3A4
lbl_80D2B038:
/* 80D2B038  80 7F 05 AC */	lwz r3, 0x5ac(r31)
/* 80D2B03C  4B 2E 23 EC */	b play__14mDoExt_baseAnmFv
/* 80D2B040  7C 73 1B 78 */	mr r19, r3
/* 80D2B044  80 7F 05 B0 */	lwz r3, 0x5b0(r31)
/* 80D2B048  4B 2E 23 E0 */	b play__14mDoExt_baseAnmFv
...
/* 80D2B090  4B 55 57 50 */	b func_802807E0
lbl_80D2B094:
...
/* 80D2B0AC  4B 5F D3 80 */	b checkPass__12J3DFrameCtrlFf
...
/* 80D2B0C4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2B0C8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2B0CC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2B0F4  4B 58 08 90 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D2B0F8  48 00 00 58 */	b lbl_80D2B150
lbl_80D2B0FC:
/* 80D2B0FC  80 7F 05 AC */	lwz r3, 0x5ac(r31)
/* 80D2B100  C0 3E 00 A4 */	lfs f1, 0xa4(r30)
/* 80D2B104  4B 5F D3 28 */	b checkPass__12J3DFrameCtrlFf
...
/* 80D2B11C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2B120  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2B124  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2B14C  4B 58 08 38 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D2B150:
...
/* 80D2B1B0  4B 31 CF CC */	b cutEnd__16dEvent_manager_cFi
...
/* 80D2B1CC  4B 2E 22 5C */	b play__14mDoExt_baseAnmFv
/* 80D2B1D0  7C 73 1B 78 */	mr r19, r3
/* 80D2B1D4  80 7F 05 B0 */	lwz r3, 0x5b0(r31)
/* 80D2B1D8  4B 2E 22 50 */	b play__14mDoExt_baseAnmFv
/* 80D2B1DC  7E 73 18 38 */	and r19, r19, r3
lbl_80D2B1E0:
/* 80D2B1E0  3C 60 80 D3 */	lis r3, l_arcName@ha
/* 80D2B1E4  38 63 B9 34 */	addi r3, r3, l_arcName@l
/* 80D2B1E8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D2B934 */
...
/* 80D2B1FC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D2B200  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80D2B204  3C A5 00 02 */	addis r5, r5, 2
/* 80D2B208  38 C0 00 80 */	li r6, 0x80
/* 80D2B20C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D2B210  4B 31 10 DC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D2B264  4B 5F D1 C8 */	b checkPass__12J3DFrameCtrlFf
...
/* 80D2B27C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D2B280  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D2B284  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D2B2AC  4B 58 06 D8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D2B2B0  48 00 00 40 */	b lbl_80D2B2F0
lbl_80D2B2B4:
/* 80D2B2B4  80 7F 05 AC */	lwz r3, 0x5ac(r31)
/* 80D2B2B8  C0 3E 00 AC */	lfs f1, 0xac(r30)
/* 80D2B2BC  4B 5F D1 70 */	b checkPass__12J3DFrameCtrlFf
...
/* 80D2B2EC  4B 34 47 38 */	b StartShock__12dVibration_cFii4cXyz
lbl_80D2B2F0:
...
/* 80D2B31C  4B 55 54 C4 */	b func_802807E0
lbl_80D2B320:

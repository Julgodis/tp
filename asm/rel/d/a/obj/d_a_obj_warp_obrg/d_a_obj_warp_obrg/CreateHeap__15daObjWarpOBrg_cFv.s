...
/* 80D29BC4  4B 63 86 0C */	b _savegpr_26
/* 80D29BC8  7C 7C 1B 78 */	mr r28, r3
/* 80D29BCC  3C 60 80 D3 */	lis r3, l_bmd_idx@ha
/* 80D29BD0  3B C3 B7 F8 */	addi r30, r3, l_bmd_idx@l
/* 80D29BD4  3C 60 80 D3 */	lis r3, l_arcName@ha
/* 80D29BD8  38 63 B9 34 */	addi r3, r3, l_arcName@l
/* 80D29BDC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D2B934 */
...
/* 80D29BF0  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D29BF4  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D29C08  4B 31 26 E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D29C1C  4B 2E B0 38 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D29C38:
/* 80D29C38  3C 60 80 D3 */	lis r3, l_arcName@ha
/* 80D29C3C  38 63 B9 34 */	addi r3, r3, l_arcName@l
/* 80D29C40  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D2B934 */
...
/* 80D29C5C  4B 31 26 90 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D29C60  7C 7A 1B 78 */	mr r26, r3
/* 80D29C64  38 60 00 1C */	li r3, 0x1c
/* 80D29C68  4B 5A 4F E4 */	b __nw__FUl
/* 80D29C6C  7C 7B 1B 79 */	or. r27, r3, r3
/* 80D29C70  41 82 00 20 */	beq lbl_80D29C90
/* 80D29C74  3C 80 80 D3 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D29C78  38 04 BA 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D29C7C  90 1B 00 00 */	stw r0, 0(r27)
/* 80D29C80  38 80 00 00 */	li r4, 0
/* 80D29C84  4B 5F E7 78 */	b init__12J3DFrameCtrlFs
...
/* 80D29CBC  4B 2E 3B 20 */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 80D29CDC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D29CE0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D29CF4  4B 30 B6 6C */	b isSwitch__10dSv_info_cCFii
...
lbl_80D29D28:
/* 80D29D28  3C 60 80 D3 */	lis r3, l_arcName@ha
/* 80D29D2C  38 63 B9 34 */	addi r3, r3, l_arcName@l
/* 80D29D30  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D2B934 */
...
/* 80D29D4C  4B 31 25 A0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D29D50  7C 7A 1B 78 */	mr r26, r3
/* 80D29D54  38 60 00 18 */	li r3, 0x18
/* 80D29D58  4B 5A 4E F4 */	b __nw__FUl
/* 80D29D5C  7C 7D 1B 79 */	or. r29, r3, r3
/* 80D29D60  41 82 00 20 */	beq lbl_80D29D80
/* 80D29D64  3C 80 80 D3 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D29D68  38 04 BA 50 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D29D6C  90 1D 00 00 */	stw r0, 0(r29)
/* 80D29D70  38 80 00 00 */	li r4, 0
/* 80D29D74  4B 5F E6 88 */	b init__12J3DFrameCtrlFs
...
/* 80D29DAC  4B 2E 38 90 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 80D29DCC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D29DD0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D29DE4  4B 30 B5 7C */	b isSwitch__10dSv_info_cCFii
...
/* 80D29E20  4B 63 83 FC */	b _restgpr_26

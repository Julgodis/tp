...
/* 80D2A1A4  4B 63 80 34 */	b _savegpr_28
/* 80D2A1A8  7C 7C 1B 78 */	mr r28, r3
/* 80D2A1AC  3C 60 80 D3 */	lis r3, l_bmd_idx@ha
/* 80D2A1B0  3B C3 B7 F8 */	addi r30, r3, l_bmd_idx@l
/* 80D2A1B4  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
...
/* 80D2A214  4B 61 D1 88 */	b PSVECSquareDistance
...
/* 80D2A284  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D2A288  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80D2A2F4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80D2A2F8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80D2A2FC:
...
/* 80D2A310  4B 30 57 88 */	b dComIfGp_TargetWarpPt_set__FUc
...
/* 80D2A328  4B 51 FC 68 */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 80D2A350  4B 30 B0 10 */	b isSwitch__10dSv_info_cCFii
...
/* 80D2A3A8  4B 34 95 54 */	b request__10dAttHint_cFP10fopAc_ac_ci
...
/* 80D2A404  4B 58 15 80 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D2A408:
...
/* 80D2A41C  4B 31 D5 DC */	b startCheck__16dEvent_manager_cFs
/* 80D2A420  2C 03 00 00 */	cmpwi r3, 0
/* 80D2A424  41 82 00 90 */	beq lbl_80D2A4B4
/* 80D2A428  7F C3 F3 78 */	mr r3, r30
/* 80D2A42C  4B 31 DF BC */	b getRunEventName__16dEvent_manager_cFv
/* 80D2A430  3C 80 80 D3 */	lis r4, struct_80D2B8AC+0x0@ha
/* 80D2A434  38 84 B8 AC */	addi r4, r4, struct_80D2B8AC+0x0@l
/* 80D2A438  38 84 00 09 */	addi r4, r4, 9
/* 80D2A43C  4B 63 E5 58 */	b strcmp
...
/* 80D2A454  3C 80 80 D3 */	lis r4, l_staff_name@ha
/* 80D2A458  38 84 B9 40 */	addi r4, r4, l_staff_name@l
/* 80D2A45C  7C 84 00 2E */	lwzx r4, r4, r0
/* 80D2A460  38 A0 00 00 */	li r5, 0
/* 80D2A464  38 C0 00 00 */	li r6, 0
/* 80D2A468  4B 31 D6 B4 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80D2A484  3C A0 80 04 */	lis r5, dEv_noFinishSkipProc__FPvi@ha
/* 80D2A488  38 A5 28 DC */	addi r5, r5, dEv_noFinishSkipProc__FPvi@l
/* 80D2A48C  38 C0 00 00 */	li r6, 0
/* 80D2A490  4B 31 84 84 */	b setSkipProc__14dEvt_control_cFPvPFPvi_ii
...
/* 80D2A4B0  4B 31 91 AC */	b setPt2__14dEvt_control_cFPv
lbl_80D2A4B4:
/* 80D2A4B4  39 61 00 20 */	addi r11, r1, 0x20
/* 80D2A4B8  4B 63 7D 6C */	b _restgpr_28

...
/* 80D37068 00000010  4B FF FB 11 */	bl _savegpr_28
/* 80D3706C 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80D37070 00000018  3C 60 00 00 */	lis r3, lit_3883@ha /* 80D3788C */
/* 80D37074 0000001C  3B E3 00 00 */	addi r31, r3, lit_3883@l /* 80D3788C */
...
/* 80D370CC 00000008  3C 60 00 00 */	lis r3, fpcSch_JudgeByID__FPvPv@ha /* 80023590 */
/* 80D370D0 0000000C  38 63 00 00 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l /* 80023590 */
/* 80D370D4 00000010  38 81 00 08 */	addi r4, r1, 8
/* 80D370D8 00000014  4B FF FA A1 */	bl fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80D37108 00000044  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 80D3710C 00000048  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
/* 80D37110 0000004C  80 84 00 00 */	lwz r4, 0(r4)
/* 80D37114 00000050  4B FF FA 65 */	bl PSMTXCopy
...
/* 80D37124 00000060  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80D37128 00000064  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
/* 80D3712C 00000068  7C 43 04 2E */	lfsx f2, r3, r0
/* 80D37130 0000006C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 80D37134 00000070  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 80D37138 00000074  80 63 00 00 */	lwz r3, 0(r3)
/* 80D3713C 00000078  C0 3F 00 18 */	lfs f1, 0x18(r31)
...
/* 80D37158 00000094  4B FF FA 21 */	bl mDoMtx_XrotM__FPA4_fs
/* 80D3715C 00000098  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 80D37160 0000009C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 80D37164 000000A0  80 63 00 00 */	lwz r3, 0(r3)
/* 80D37168 000000A4  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80D3716C 000000A8  38 84 00 24 */	addi r4, r4, 0x24
/* 80D37170 000000AC  4B FF FA 09 */	bl PSMTXCopy
/* 80D37174 000000B0  48 00 00 40 */	b lbl_80D371B4
lbl_80D37178:
/* 80D37178 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D3717C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80D3718C 00000014  4B FF F9 ED */	bl PSMTXTrans
/* 80D37190 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D37194 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D37198 00000020  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80D3719C 00000024  4B FF F9 DD */	bl mDoMtx_YrotM__FPA4_fs
/* 80D371A0 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D371A4 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D371A8 00000030  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80D371AC 00000034  38 84 00 24 */	addi r4, r4, 0x24
/* 80D371B0 00000038  4B FF F9 C9 */	bl PSMTXCopy
lbl_80D371B4:
/* 80D371B4 00000000  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80D371B8 00000004  38 63 00 24 */	addi r3, r3, 0x24
/* 80D371BC 00000008  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D371C0 0000000C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D371C4 00000010  4B FF F9 B5 */	bl PSMTXCopy
/* 80D371C8 00000014  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 80D371CC 00000018  C0 5F 00 20 */	lfs f2, 0x20(r31)
/* 80D371D0 0000001C  C0 7F 00 00 */	lfs f3, 0(r31)
/* 80D371D4 00000020  4B FF F9 A5 */	bl transM__14mDoMtx_stack_cFfff
/* 80D371D8 00000024  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D371DC 00000028  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D371E0 0000002C  38 80 40 00 */	li r4, 0x4000
/* 80D371E4 00000030  4B FF F9 95 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D371E8 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D371EC 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D371F0 0000003C  38 80 08 34 */	li r4, 0x834
/* 80D371F4 00000040  4B FF F9 85 */	bl mDoMtx_XrotM__FPA4_fs
/* 80D371F8 00000044  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D371FC 00000048  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D37200 0000004C  38 80 00 00 */	li r4, 0
/* 80D37204 00000050  4B FF F9 75 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80D37208 00000054  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80D3720C 00000058  80 83 00 04 */	lwz r4, 4(r3)
/* 80D37210 0000005C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D37214 00000060  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D37218 00000064  38 84 00 24 */	addi r4, r4, 0x24
/* 80D3721C 00000068  4B FF F9 5D */	bl PSMTXCopy
/* 80D37220 0000006C  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80D37224 00000070  4B FF F9 55 */	bl play__14mDoExt_baseAnmFv
/* 80D37228 00000074  80 7E 05 7C */	lwz r3, 0x57c(r30)
/* 80D3722C 00000078  4B FF F9 4D */	bl play__14mDoExt_baseAnmFv
...
/* 80D37240 0000008C  4B FF F9 39 */	bl play__14mDoExt_McaMorfFP3VecUlSc
/* 80D37244 00000090  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 80D37248 00000094  4B FF F9 31 */	bl modelCalc__14mDoExt_McaMorfFv
/* 80D3724C 00000098  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80D37250 0000009C  38 63 00 24 */	addi r3, r3, 0x24
/* 80D37254 000000A0  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D37258 000000A4  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D3725C 000000A8  4B FF F9 1D */	bl PSMTXCopy
/* 80D37260 000000AC  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80D37264 000000B0  3B A3 00 00 */	addi r29, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80D37268 000000B4  3B 9E 05 80 */	addi r28, r30, 0x580
/* 80D3726C 000000B8  C0 3F 00 24 */	lfs f1, 0x24(r31)
/* 80D37270 000000BC  C0 5F 00 28 */	lfs f2, 0x28(r31)
/* 80D37274 000000C0  C0 7F 00 00 */	lfs f3, 0(r31)
/* 80D37278 000000C4  4B FF F9 01 */	bl transM__14mDoMtx_stack_cFfff
/* 80D3727C 000000C8  C0 1D 00 0C */	lfs f0, 0xc(r29)
/* 80D37280 000000CC  D0 1C 00 04 */	stfs f0, 4(r28)
/* 80D37284 000000D0  C0 1D 00 1C */	lfs f0, 0x1c(r29)
/* 80D37288 000000D4  D0 1C 00 08 */	stfs f0, 8(r28)
/* 80D3728C 000000D8  C0 1D 00 2C */	lfs f0, 0x2c(r29)
...
/* 80D372BC 00000108  4B FF F8 BD */	bl _restgpr_28

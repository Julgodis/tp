...
/* 80D37070 00000018  3C 60 00 00 */	lis r3, lit_3883@ha
/* 80D37074 0000001C  3B E3 00 00 */	addi r31, r3, lit_3883@l
...
/* 80D370CC 00000008  3C 60 00 00 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80D370D0 0000000C  38 63 00 00 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
...
/* 80D37108 00000044  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 80D3710C 00000048  38 84 00 00 */	addi r4, r4, calc_mtx@l
...
/* 80D37124 00000060  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80D37128 00000064  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
/* 80D3712C 00000068  7C 43 04 2E */	lfsx f2, r3, r0
/* 80D37130 0000006C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80D37134 00000070  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 80D3715C 00000098  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80D37160 0000009C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
lbl_80D37178:
/* 80D37178 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D3717C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D37190 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D37194 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D37198 00000020  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80D3719C 00000024  4B FF F9 DD */	bl mDoMtx_YrotM__FPA4_fs
/* 80D371A0 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D371A4 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D371BC 00000008  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D371C0 0000000C  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80D371D8 00000024  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D371DC 00000028  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D371E0 0000002C  38 80 40 00 */	li r4, 0x4000
/* 80D371E4 00000030  4B FF F9 95 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D371E8 00000034  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D371EC 00000038  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D371F0 0000003C  38 80 08 34 */	li r4, 0x834
/* 80D371F4 00000040  4B FF F9 85 */	bl mDoMtx_XrotM__FPA4_fs
/* 80D371F8 00000044  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D371FC 00000048  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D37210 0000005C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D37214 00000060  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D37254 000000A0  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D37258 000000A4  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80D3725C 000000A8  4B FF F9 1D */	bl PSMTXCopy
/* 80D37260 000000AC  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D37264 000000B0  3B A3 00 00 */	addi r29, r3, now__14mDoMtx_stack_c@l

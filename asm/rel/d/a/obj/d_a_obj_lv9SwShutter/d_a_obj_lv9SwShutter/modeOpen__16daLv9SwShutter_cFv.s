...
/* 80C8D2F8 00000020  3C 60 00 00 */	lis r3, lit_3627@ha /* 80C8D7DC */
/* 80C8D2FC 00000024  3B E3 00 00 */	addi r31, r3, lit_3627@l /* 80C8D7DC */
/* 80C8D300 00000028  38 7E 05 B0 */	addi r3, r30, 0x5b0
/* 80C8D304 0000002C  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80C8D308 00000030  C0 5F 00 14 */	lfs f2, 0x14(r31)
/* 80C8D30C 00000034  3C 80 00 00 */	lis r4, l_HIO@ha /* 80C8D91C */
/* 80C8D310 00000038  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80C8D91C */
/* 80C8D314 0000003C  C0 64 00 04 */	lfs f3, 4(r4)
/* 80C8D318 00000040  C0 9F 00 18 */	lfs f4, 0x18(r31)
/* 80C8D31C 00000044  4B FF FA FD */	bl cLib_addCalc__FPfffff
/* 80C8D320 00000048  FF E0 08 90 */	fmr f31, f1
/* 80C8D324 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C8D328 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C8D338 00000060  4B FF FA E1 */	bl mDoMtx_ZXYrotS__FPA4_fsss
/* 80C8D33C 00000064  C0 3E 05 B0 */	lfs f1, 0x5b0(r30)
/* 80C8D340 00000068  C0 1F 00 0C */	lfs f0, 0xc(r31)
...
/* 80C8D350 00000078  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C8D354 0000007C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C8D358 00000080  38 81 00 10 */	addi r4, r1, 0x10
/* 80C8D35C 00000084  7C 85 23 78 */	mr r5, r4
/* 80C8D360 00000088  4B FF FA B9 */	bl PSMTXMultVec
...
/* 80C8D370 00000098  4B FF FA A9 */	bl PSVECAdd
/* 80C8D374 0000009C  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80C8D378 000000A0  7C 03 07 74 */	extsb r3, r0
/* 80C8D37C 000000A4  4B FF FA 9D */	bl dComIfGp_getReverb__Fi
...
/* 80C8D390 000000B8  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 80C8D394 000000BC  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 80C8D398 000000C0  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C8D3A8 000000D0  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 80C8D3AC 000000D4  FC 40 08 90 */	fmr f2, f1
/* 80C8D3B0 000000D8  C0 7F 00 20 */	lfs f3, 0x20(r31)
/* 80C8D3B4 000000DC  FC 80 18 90 */	fmr f4, f3
/* 80C8D3B8 000000E0  39 00 00 00 */	li r8, 0
/* 80C8D3BC 000000E4  4B FF FA 5D */	bl seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C8D3C0 000000E8  C0 1F 00 0C */	lfs f0, 0xc(r31)
...
/* 80C8D3D4 000000FC  4B FF FA 45 */	bl dComIfGp_getReverb__Fi
...
/* 80C8D3E8 00000110  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 80C8D3EC 00000114  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 80C8D3F0 00000118  80 63 00 00 */	lwz r3, 0(r3)
...
/* 80C8D400 00000128  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 80C8D404 0000012C  FC 40 08 90 */	fmr f2, f1
/* 80C8D408 00000130  C0 7F 00 20 */	lfs f3, 0x20(r31)
/* 80C8D40C 00000134  FC 80 18 90 */	fmr f4, f3
/* 80C8D410 00000138  39 00 00 00 */	li r8, 0
/* 80C8D414 0000013C  4B FF FA 05 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

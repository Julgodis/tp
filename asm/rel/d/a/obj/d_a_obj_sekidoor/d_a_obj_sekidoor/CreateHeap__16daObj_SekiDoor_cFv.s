...
/* 80CCD170  3C 60 80 CD */	lis r3, l_bmdData@ha
/* 80CCD174  38 83 DA 5C */	addi r4, r3, l_bmdData@l
/* 80CCD178  7C 64 2A 14 */	add r3, r4, r5
/* 80CCD17C  80 03 00 04 */	lwz r0, 4(r3)
/* 80CCD180  54 00 10 3A */	slwi r0, r0, 2
/* 80CCD184  3C 60 80 CD */	lis r3, l_resNameList@ha
/* 80CCD188  38 63 DA 6C */	addi r3, r3, l_resNameList@l
/* 80CCD18C  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CCD190  7C 84 28 2E */	lwzx r4, r4, r5
/* 80CCD194  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CCD198  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80CCD19C  3C A5 00 02 */	addis r5, r5, 2
/* 80CCD1A0  38 C0 00 80 */	li r6, 0x80
/* 80CCD1A4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80CCD1A8  4B 36 F1 44 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CCD1C8  4B 34 7A 8C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

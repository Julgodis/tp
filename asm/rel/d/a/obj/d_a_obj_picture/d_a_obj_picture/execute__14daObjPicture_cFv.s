...
/* 80CAE1C8  4B 6B 40 0C */	b _savegpr_27
/* 80CAE1CC  7C 7E 1B 78 */	mr r30, r3
/* 80CAE1D0  3C 80 80 CB */	lis r4, l_dzbIdx@ha
/* 80CAE1D4  3B E4 F0 1C */	addi r31, r4, l_dzbIdx@l
...
/* 80CAE238  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CAE23C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CAE240  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80CAE244  7C 05 07 74 */	extsb r5, r0
/* 80CAE248  4B 38 6F B8 */	b onSwitch__10dSv_info_cFii
...
/* 80CAE258  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CAE25C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CAE260  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CAE288  4B 5F D6 FC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80CAE32C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CAE330  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80CAE344  4B 5B 68 64 */	b Set__4cCcSFP8cCcD_Obj
/* 80CAE348  7F A3 EB 78 */	mr r3, r29
/* 80CAE34C  38 9C 09 EC */	addi r4, r28, 0x9ec
/* 80CAE350  4B 5B 68 58 */	b Set__4cCcSFP8cCcD_Obj
...
/* 80CAE384  4B 36 F9 38 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
...
/* 80CAE3A0  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80CAE3A4  C0 23 0C D0 */	lfs f1, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80CAE3C0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80CAE3C4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80CAE3C8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80CAE3F0  4B 5F D5 94 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80CAE3F4  C0 3F 00 64 */	lfs f1, 0x64(r31)
/* 80CAE3F8  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80CAE3FC  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80CAE468  4B 36 F8 54 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
...
/* 80CAE4F0  4B 3C D4 D0 */	b Move__4dBgWFv
/* 80CAE4F4  38 60 00 01 */	li r3, 1
lbl_80CAE4F8:
/* 80CAE4F8  39 61 00 40 */	addi r11, r1, 0x40
/* 80CAE4FC  4B 6B 3D 24 */	b _restgpr_27

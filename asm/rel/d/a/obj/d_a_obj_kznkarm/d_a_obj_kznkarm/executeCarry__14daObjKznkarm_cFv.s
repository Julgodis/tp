...
/* 80C4FC30 00000044  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C4FC34 00000048  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C4FC60 00000010  4B FF FB D9 */	bl fopAcM_carryOffRevise__FP10fopAc_ac_c
...
/* 80C4FC74 00000004  4B FF FB C5 */	bl transS__14mDoMtx_stack_cFRC4cXyz
...
/* 80C4FC88 00000018  4B FF FB B1 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80C4FC8C 0000001C  3C 60 00 00 */	lis r3, M_attr__14daObjKznkarm_c@ha /* 80C50D08 */
/* 80C4FC90 00000020  38 63 00 00 */	addi r3, r3, M_attr__14daObjKznkarm_c@l /* 80C50D08 */
...
/* 80C4FCA0 00000030  4B FF FB 99 */	bl transM__14mDoMtx_stack_cFfff
/* 80C4FCA4 00000034  48 00 00 4C */	b lbl_80C4FCF0
lbl_80C4FCA8:
/* 80C4FCA8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C4FCAC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C4FCB0 00000008  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C4FCB4 0000000C  4B FF FB 85 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C4FCB8 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C4FCBC 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C4FCC0 00000018  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 80C4FCC4 0000001C  4B FF FB 75 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80C4FCC8 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C4FCCC 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C4FCD0 00000028  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80C4FCD4 0000002C  4B FF FB 65 */	bl mDoMtx_XrotM__FPA4_fs
/* 80C4FCD8 00000030  3C 60 00 00 */	lis r3, M_attr__14daObjKznkarm_c@ha /* 80C50D08 */
/* 80C4FCDC 00000034  38 63 00 00 */	addi r3, r3, M_attr__14daObjKznkarm_c@l /* 80C50D08 */
...
/* 80C4FCEC 00000044  4B FF FB 4D */	bl transM__14mDoMtx_stack_cFfff
lbl_80C4FCF0:
/* 80C4FCF0 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C4FCF4 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C4FCF8 00000008  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80C4FCFC 0000000C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C4FD00 00000010  4B FF FB 39 */	bl PSMTXCopy

...
/* 80C4FDD4 0000000C  3C 60 00 00 */	lis r3, M_attr__14daObjKznkarm_c@ha
/* 80C4FDD8 00000010  3B E3 00 00 */	addi r31, r3, M_attr__14daObjKznkarm_c@l
...
/* 80C4FE54 00000014  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C4FE58 00000018  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
/* 80C4FEEC 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C4FEF0 00000008  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C4FF5C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C4FF60 0000000C  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
/* 80C4FF64 00000010  48 00 00 08 */	b lbl_80C4FF6C
lbl_80C4FF68:
/* 80C4FF68 00000000  FF E0 08 90 */	fmr f31, f1
lbl_80C4FF6C:
/* 80C4FF6C 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C4FF70 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C4FFDC 00000008  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C4FFE0 0000000C  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C50090 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C50094 00000008  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C50100 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C50104 0000000C  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
/* 80C50108 00000010  48 00 00 08 */	b lbl_80C50110
lbl_80C5010C:
/* 80C5010C 00000000  FF E0 08 90 */	fmr f31, f1
lbl_80C50110:
/* 80C50110 00000000  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C50114 00000004  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C50190 0000000C  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha
/* 80C50194 00000010  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C501E0 00000044  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C501E4 00000048  3B 43 00 00 */	addi r26, r3, g_dComIfG_gameInfo@l
/* 80C501E8 0000004C  3C 60 00 00 */	lis r3, data_80C50E90@ha
/* 80C501EC 00000050  3B 63 00 00 */	addi r27, r3, data_80C50E90@l
lbl_80C501F0:
...
/* 80C50264 00000074  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C50268 00000078  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 80C50358 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C5035C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80C503C8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C503CC 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80C503D0:

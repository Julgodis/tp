...
/* 80C139F4  4B 74 E7 E4 */	b _savegpr_28
...
/* 80C13A24  3C 80 80 C1 */	lis r4, stringBase0@ha
/* 80C13A28  38 84 49 F4 */	addi r4, r4, stringBase0@l
/* 80C13A2C  4B 41 94 90 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C13A40  3C 80 80 C1 */	lis r4, stringBase0@ha
/* 80C13A44  38 84 49 F4 */	addi r4, r4, stringBase0@l
/* 80C13A48  38 A0 00 1D */	li r5, 0x1d
/* 80C13A4C  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C13A50  38 C6 5A 24 */	addi r6, r6, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C13A54  38 E0 40 30 */	li r7, 0x4030
/* 80C13A58  39 00 00 00 */	li r8, 0
/* 80C13A5C  4B 46 4D 60 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C13A94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C13A98  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C13A9C  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 80C13AA0  7C 05 07 74 */	extsb r5, r0
/* 80C13AA4  4B 42 18 BC */	b isSwitch__10dSv_info_cCFii
...
/* 80C13AD0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C13AD4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C13AD8  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 80C13ADC  7C 05 07 74 */	extsb r5, r0
/* 80C13AE0  4B 42 18 80 */	b isSwitch__10dSv_info_cCFii
/* 80C13AE4  2C 03 00 00 */	cmpwi r3, 0
/* 80C13AE8  41 82 00 A4 */	beq lbl_80C13B8C
/* 80C13AEC  A8 1C 06 6C */	lha r0, 0x66c(r28)
/* 80C13AF0  3C 60 80 C1 */	lis r3, lit_3891@ha
/* 80C13AF4  C8 23 49 E8 */	lfd f1, lit_3891@l(r3)
...
/* 80C13B3C  4B 3F 9E 90 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C13B40  38 7C 06 D4 */	addi r3, r28, 0x6d4
/* 80C13B44  7F E4 FB 78 */	mr r4, r31
/* 80C13B48  C0 3C 06 E4 */	lfs f1, 0x6e4(r28)
/* 80C13B4C  4B 3F 9E 80 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C13B50  A8 1C 06 00 */	lha r0, 0x600(r28)
/* 80C13B54  3C 60 80 C1 */	lis r3, lit_3891@ha
/* 80C13B58  C8 23 49 E8 */	lfd f1, lit_3891@l(r3)
...
/* 80C13B84  4B 3F 9C 24 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 80C13B88  48 00 01 EC */	b lbl_80C13D74
lbl_80C13B8C:
/* 80C13B8C  A8 1C 06 18 */	lha r0, 0x618(r28)
/* 80C13B90  3C 60 80 C1 */	lis r3, lit_3891@ha
/* 80C13B94  C8 23 49 E8 */	lfd f1, lit_3891@l(r3)
...
/* 80C13D28  4B 3F 9C A4 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C13D2C  38 7C 06 9C */	addi r3, r28, 0x69c
/* 80C13D30  7F E4 FB 78 */	mr r4, r31
/* 80C13D34  C0 3C 06 AC */	lfs f1, 0x6ac(r28)
/* 80C13D38  4B 3F 9C 94 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
/* 80C13D3C  A8 1C 05 E8 */	lha r0, 0x5e8(r28)
/* 80C13D40  3C 60 80 C1 */	lis r3, lit_3891@ha
/* 80C13D44  C8 23 49 E8 */	lfd f1, lit_3891@l(r3)
...
/* 80C13D70  4B 3F 9A 38 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_80C13D74:
/* 80C13D74  80 7C 05 AC */	lwz r3, 0x5ac(r28)
/* 80C13D78  4B 71 3E 5C */	b calcAnmMtx__8J3DModelFv
/* 80C13D7C  80 7C 05 A8 */	lwz r3, 0x5a8(r28)
/* 80C13D80  4B 71 3E 54 */	b calcAnmMtx__8J3DModelFv
lbl_80C13D84:
...
/* 80C13D9C  4B 74 E4 88 */	b _restgpr_28

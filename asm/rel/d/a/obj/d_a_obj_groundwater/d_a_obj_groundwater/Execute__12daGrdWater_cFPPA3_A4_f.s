...
/* 80C14030  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C14034  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C14038  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C1403C  7C 05 07 74 */	extsb r5, r0
/* 80C14040  4B 42 13 20 */	b isSwitch__10dSv_info_cCFii
...
/* 80C14064  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C14068  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C1406C  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C14070  7C 05 07 74 */	extsb r5, r0
/* 80C14074  4B 42 12 EC */	b isSwitch__10dSv_info_cCFii
...
/* 80C140A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C140A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C140A8  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C140AC  7C 05 07 74 */	extsb r5, r0
/* 80C140B0  4B 42 12 B0 */	b isSwitch__10dSv_info_cCFii
...
/* 80C140DC  3C 80 80 C1 */	lis r4, l_mode_func@ha
/* 80C140E0  38 04 4A 58 */	addi r0, r4, l_mode_func@l
/* 80C140E4  7D 80 2A 14 */	add r12, r0, r5
/* 80C140E8  4B 74 DF 9C */	b __ptmf_scall
...
/* 80C14114  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C14118  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C1411C  3C 80 80 C1 */	lis r4, lit_3642@ha
/* 80C14120  C0 24 49 E0 */	lfs f1, lit_3642@l(r4)
...
/* 80C14134  4B 73 27 B4 */	b PSMTXTrans
/* 80C14138  C0 3E 04 EC */	lfs f1, 0x4ec(r30)
/* 80C1413C  C0 5E 04 F0 */	lfs f2, 0x4f0(r30)
/* 80C14140  C0 7E 04 F4 */	lfs f3, 0x4f4(r30)
/* 80C14144  4B 3F 8C F4 */	b scaleM__14mDoMtx_stack_cFfff
/* 80C14148  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C1414C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C14150  38 9E 05 6C */	addi r4, r30, 0x56c
/* 80C14154  4B 73 23 5C */	b PSMTXCopy
...
/* 80C14180  4B 74 E0 A8 */	b _restgpr_29

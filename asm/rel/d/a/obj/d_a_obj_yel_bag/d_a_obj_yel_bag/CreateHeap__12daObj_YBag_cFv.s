...
/* 80D3C8B0  3C 80 80 D4 */	lis r4, l_bmdGetParamList@ha
/* 80D3C8B4  38 A4 DD 94 */	addi r5, r4, l_bmdGetParamList@l
/* 80D3C8B8  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80D3DD94 */
...
/* 80D3C8CC  3C 60 80 D4 */	lis r3, l_resNames@ha
/* 80D3C8D0  38 63 DD B0 */	addi r3, r3, l_resNames@l
/* 80D3C8D4  7C 63 00 2E */	lwzx r3, r3, r0
/* 80D3C8D8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D3C8DC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80D3C8E0  3C A5 00 02 */	addis r5, r5, 2
/* 80D3C8E4  38 C0 00 80 */	li r6, 0x80
/* 80D3C8E8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80D3C8EC  4B 2F FA 00 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
lbl_80D3C8F0:
...
/* 80D3C904  4B 2D 83 50 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl

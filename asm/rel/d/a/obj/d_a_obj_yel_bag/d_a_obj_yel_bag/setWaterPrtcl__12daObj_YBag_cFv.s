...
/* 80D3D958 00000010  4B 62 48 6C */	b _savegpr_23
/* 80D3D95C 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80D3D960 00000018  3C 60 80 D4 */	lis r3, lit_1109@ha
/* 80D3D964 0000001C  3B E3 DE D0 */	addi r31, r3, lit_1109@l
/* 80D3D968 00000020  88 1F 00 5C */	lbz r0, 0x5c(r31)	/* effective address: 80D3DF2C */
/* 80D3D96C 00000024  7C 00 07 75 */	extsb. r0, r0
/* 80D3D970 00000028  40 82 00 34 */	bne lbl_80D3D9A4
/* 80D3D974 0000002C  3C 60 80 D4 */	lis r3, lit_4503@ha
/* 80D3D978 00000030  C0 03 DD 64 */	lfs f0, lit_4503@l(r3)
/* 80D3D97C 00000034  D0 1F 00 60 */	stfs f0, 0x60(r31)	/* effective address: 80D3DF30 */
/* 80D3D980 00000038  38 7F 00 60 */	addi r3, r31, 0x60
/* 80D3D984 0000003C  D0 03 00 04 */	stfs f0, 4(r3)	/* effective address: 80D3DF34 */
/* 80D3D988 00000040  D0 03 00 08 */	stfs f0, 8(r3)	/* effective address: 80D3DF38 */
/* 80D3D98C 00000044  3C 80 80 D4 */	lis r4, __dt__4cXyzFv@ha
/* 80D3D990 00000048  38 84 C3 5C */	addi r4, r4, __dt__4cXyzFv@l
...
/* 80D3D9A0 00000058  98 1F 00 5C */	stb r0, 0x5c(r31)	/* effective address: 80D3DF2C */
lbl_80D3D9A4:
...
/* 80D3D9C8 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D3D9CC 00000028  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l
/* 80D3D9D0 0000002C  3C 60 80 D4 */	lis r3, data_80D3DDF8@ha
/* 80D3D9D4 00000030  3B 43 DD F8 */	addi r26, r3, data_80D3DDF8@l
/* 80D3D9D8 00000034  3C 60 80 D4 */	lis r3, lit_4322@ha
/* 80D3D9DC 00000038  3B 63 DD 20 */	addi r27, r3, lit_4322@l
lbl_80D3D9E0:
/* 80D3D9E0 00000000  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 80D3DA28 00000048  C0 3B 00 00 */	lfs f1, 0(r27)	/* effective address: 80D3DD20 */
/* 80D3DA2C 0000004C  4B 30 FA A0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80D3DA30 00000050  7C 7E C1 2E */	stwx r3, r30, r24
/* 80D3DA34 00000054  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
/* 80D3DA38 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 80D3DA3C 0000005C  7C 9E C0 2E */	lwzx r4, r30, r24
/* 80D3DA40 00000060  4B 30 DE 74 */	b forceOnEventMove__Q213dPa_control_c7level_cFUl
...
/* 80D3DA5C 0000007C  4B 62 47 B4 */	b _restgpr_23

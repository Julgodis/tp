...
/* 80BFA61C 00000010  3C 60 80 C0 */	lis r3, struct_80BFAFE8+0x2@ha
/* 80BFA620 00000014  38 83 AF EA */	addi r4, r3, struct_80BFAFE8+0x2@l
/* 80BFA624 00000018  A8 64 00 00 */	lha r3, 0(r4)	/* effective address: 80BFAFEA */
...
/* 80BFA634 00000028  B0 04 00 00 */	sth r0, 0(r4)	/* effective address: 80BFAFEA */
...
lbl_80BFA648:
/* 80BFA648 00000000  3C 60 80 C0 */	lis r3, struct_80BFAFE8+0x0@ha
/* 80BFA64C 00000004  A0 03 AF E8 */	lhz r0, struct_80BFAFE8+0x0@l(r3)
/* 80BFA650 00000008  28 00 00 00 */	cmplwi r0, 0
/* 80BFA654 0000000C  41 82 00 68 */	beq lbl_80BFA6BC
/* 80BFA658 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80BFA65C 00000014  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80BFA660 00000018  80 1F 5F 1C */	lwz r0, 0x5f1c(r31)	/* effective address: 8040C0DC */
/* 80BFA664 0000001C  54 00 06 F7 */	rlwinm. r0, r0, 0, 0x1b, 0x1b
/* 80BFA668 00000020  40 82 00 20 */	bne lbl_80BFA688
/* 80BFA66C 00000024  80 7F 5D AC */	lwz r3, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 80BFA670 00000028  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 80400628 */
...
lbl_80BFA688:
/* 80BFA688 00000000  80 7F 5F 1C */	lwz r3, 0x5f1c(r31)	/* effective address: 8040C0DC */
...
/* 80BFA6A0 00000004  3C 60 80 C0 */	lis r3, struct_80BFAFE8+0x2@ha
/* 80BFA6A4 00000008  B0 03 AF EA */	sth r0, struct_80BFAFE8+0x2@l(r3)
/* 80BFA6A8 0000000C  48 00 00 1C */	b lbl_80BFA6C4
lbl_80BFA6AC:
/* 80BFA6AC 00000000  38 00 00 10 */	li r0, 0x10
/* 80BFA6B0 00000004  3C 60 80 C0 */	lis r3, struct_80BFAFE8+0x2@ha
/* 80BFA6B4 00000008  B0 03 AF EA */	sth r0, struct_80BFAFE8+0x2@l(r3)
/* 80BFA6B8 0000000C  48 00 00 0C */	b lbl_80BFA6C4
lbl_80BFA6BC:
/* 80BFA6BC 00000000  38 00 00 00 */	li r0, 0
/* 80BFA6C0 00000004  B0 04 00 00 */	sth r0, 0(r4)	/* effective address: 80BFAFEA */
lbl_80BFA6C4:

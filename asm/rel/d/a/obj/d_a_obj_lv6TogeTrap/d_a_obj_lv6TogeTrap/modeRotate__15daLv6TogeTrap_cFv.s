...
/* 80C7BD80 00000010  4B 6E 64 5C */	b _savegpr_29
/* 80C7BD84 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80C7BD88 00000018  3C 60 80 C8 */	lis r3, lit_3631@ha
/* 80C7BD8C 0000001C  3B E3 C6 18 */	addi r31, r3, lit_3631@l
/* 80C7BD90 00000020  38 7E 06 50 */	addi r3, r30, 0x650
/* 80C7BD94 00000024  4B 40 88 C4 */	b ChkCoHit__12dCcD_GObjInfFv
...
/* 80C7BDA4 00000034  4B 40 78 E4 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 80C7BDD4 0000000C  C0 BF 01 04 */	lfs f5, 0x104(r31)	/* effective address: 80C7C71C */
/* 80C7BDD8 00000010  C0 9F 01 38 */	lfs f4, 0x138(r31)	/* effective address: 80C7C750 */
/* 80C7BDDC 00000014  C0 7E 05 D4 */	lfs f3, 0x5d4(r30)
/* 80C7BDE0 00000018  C0 5F 01 3C */	lfs f2, 0x13c(r31)	/* effective address: 80C7C754 */
/* 80C7BDE4 0000001C  C0 3F 01 40 */	lfs f1, 0x140(r31)	/* effective address: 80C7C758 */
...
/* 80C7BE18 00000050  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7BE1C 00000054  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C7BE2C 00000064  4B 39 03 DC */	b mDoMtx_ZXYrotS__FPA4_fsss
/* 80C7BE30 00000068  C0 1E 05 FC */	lfs f0, 0x5fc(r30)
/* 80C7BE34 0000006C  D0 1E 08 C4 */	stfs f0, 0x8c4(r30)
/* 80C7BE38 00000070  C0 1F 00 D0 */	lfs f0, 0xd0(r31)	/* effective address: 80C7C6E8 */
/* 80C7BE3C 00000074  D0 1E 08 C8 */	stfs f0, 0x8c8(r30)
/* 80C7BE40 00000078  D0 1E 08 CC */	stfs f0, 0x8cc(r30)
/* 80C7BE44 0000007C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7BE48 00000080  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7BE4C 00000084  38 9E 08 C4 */	addi r4, r30, 0x8c4
/* 80C7BE50 00000088  7C 85 23 78 */	mr r5, r4
/* 80C7BE54 0000008C  4B 6C AF 18 */	b PSMTXMultVec
...
/* 80C7BE90 000000C8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C7BE94 000000CC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C7BE98 000000D0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C7BEA8 000000E0  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 80C7C61C */
/* 80C7BEAC 000000E4  FC 40 08 90 */	fmr f2, f1
/* 80C7BEB0 000000E8  C0 7F 01 10 */	lfs f3, 0x110(r31)	/* effective address: 80C7C728 */
/* 80C7BEB4 000000EC  FC 80 18 90 */	fmr f4, f3
/* 80C7BEB8 000000F0  39 00 00 00 */	li r8, 0
/* 80C7BEBC 000000F4  4B 63 06 50 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C7BEC0 000000F8  39 61 00 30 */	addi r11, r1, 0x30
/* 80C7BEC4 000000FC  4B 6E 63 64 */	b _restgpr_29

...
/* 80C7BEF0  3C 60 80 C8 */	lis r3, lit_3631@ha
/* 80C7BEF4  3B E3 C6 18 */	addi r31, r3, lit_3631@l
...
lbl_80C7BF0C:
/* 80C7BF0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7BF10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7BF14  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C7BF18  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C7BF1C  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C7BF20  4B 39 02 E8 */	b mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C7BF38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7BF3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7BF40  38 81 00 0C */	addi r4, r1, 0xc
/* 80C7BF44  7C 85 23 78 */	mr r5, r4
/* 80C7BF48  4B 6C AE 24 */	b PSMTXMultVec
/* 80C7BF4C  38 61 00 0C */	addi r3, r1, 0xc
/* 80C7BF50  38 9E 04 D0 */	addi r4, r30, 0x4d0
/* 80C7BF54  7C 65 1B 78 */	mr r5, r3
/* 80C7BF58  4B 6C B1 38 */	b PSVECAdd
...
/* 80C7BF80  4B 3B 10 EC */	b dComIfGp_getReverb__Fi
...
/* 80C7BF94  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C7BF98  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C7BF9C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C7BFC0  4B 62 F9 C4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

...
/* 80C79E7C  C0 05 00 00 */	lfs f0, 0(r5)	/* effective address: 80C7C618 */
/* 80C79E80  D0 03 00 08 */	stfs f0, 8(r3)
/* 80C79E84  C0 05 00 04 */	lfs f0, 4(r5)	/* effective address: 80C7C61C */
/* 80C79E88  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 80C79E8C  38 00 00 0F */	li r0, 0xf
/* 80C79E90  98 03 00 16 */	stb r0, 0x16(r3)
/* 80C79E94  C0 05 00 08 */	lfs f0, 8(r5)	/* effective address: 80C7C620 */
/* 80C79E98  D0 03 00 18 */	stfs f0, 0x18(r3)
/* 80C79E9C  C0 25 00 0C */	lfs f1, 0xc(r5)	/* effective address: 80C7C624 */
/* 80C79EA0  D0 23 00 1C */	stfs f1, 0x1c(r3)
/* 80C79EA4  C0 05 00 10 */	lfs f0, 0x10(r5)	/* effective address: 80C7C628 */
...
/* 80C79EBC  C0 05 00 14 */	lfs f0, 0x14(r5)	/* effective address: 80C7C62C */

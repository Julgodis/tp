...
lbl_80C7C010:
/* 80C7C010 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C7C014 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C7C024 00000014  4B FF DD 95 */	bl mDoMtx_ZXYrotS__FPA4_fsss
/* 80C7C028 00000018  C0 1E 05 FC */	lfs f0, 0x5fc(r30)
/* 80C7C02C 0000001C  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80C7C030 00000020  3C 60 00 00 */	lis r3, lit_3665@ha /* 80C7C6E8 */
/* 80C7C034 00000024  C0 03 00 00 */	lfs f0, lit_3665@l(r3) /* 80C7C6E8 */
/* 80C7C038 00000028  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80C7C03C 0000002C  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80C7C040 00000030  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C7C044 00000034  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C7C048 00000038  38 81 00 20 */	addi r4, r1, 0x20
/* 80C7C04C 0000003C  7C 85 23 78 */	mr r5, r4
/* 80C7C050 00000040  4B FF DD 69 */	bl PSMTXMultVec
...
/* 80C7C060 00000050  4B FF DD 59 */	bl PSVECAdd
...
lbl_80C7C080:
/* 80C7C080 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C7C084 00000004  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C7C0C8 00000048  3D 60 00 00 */	lis r11, lit_3632@ha /* 80C7C61C */
/* 80C7C0CC 0000004C  C0 2B 00 00 */	lfs f1, lit_3632@l(r11) /* 80C7C61C */
/* 80C7C0D0 00000050  4B FF DC E9 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C7C114 00000094  3D 60 00 00 */	lis r11, lit_3632@ha /* 80C7C61C */
/* 80C7C118 00000098  C0 2B 00 00 */	lfs f1, lit_3632@l(r11) /* 80C7C61C */
/* 80C7C11C 0000009C  4B FF DC 9D */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C7C160 000000E0  3D 60 00 00 */	lis r11, lit_3632@ha /* 80C7C61C */
/* 80C7C164 000000E4  C0 2B 00 00 */	lfs f1, lit_3632@l(r11) /* 80C7C61C */
/* 80C7C168 000000E8  4B FF DC 51 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C7C1AC 0000012C  3D 60 00 00 */	lis r11, lit_3632@ha /* 80C7C61C */
/* 80C7C1B0 00000130  C0 2B 00 00 */	lfs f1, lit_3632@l(r11) /* 80C7C61C */
/* 80C7C1B4 00000134  4B FF DC 05 */	bl set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C7C1B8 00000138  7F C3 F3 78 */	mr r3, r30
/* 80C7C1BC 0000013C  4B FF DB FD */	bl fopAcM_delete__FP10fopAc_ac_c

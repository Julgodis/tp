...
/* 80C7BC9C  4B 3B 13 D0 */	b dComIfGp_getReverb__Fi
/* 80C7BCA0  7C 7E 1B 78 */	mr r30, r3
/* 80C7BCA4  C0 3F 05 2C */	lfs f1, 0x52c(r31)
/* 80C7BCA8  4B 6E 64 04 */	b __cvt_fp2unsigned
...
/* 80C7BCBC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C7BCC0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C7BCC4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80C7BCC8  38 81 00 08 */	addi r4, r1, 8
/* 80C7BCCC  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80C7BCD0  7F C7 F3 78 */	mr r7, r30
/* 80C7BCD4  3D 00 80 C8 */	lis r8, lit_3632@ha
/* 80C7BCD8  C0 28 C6 1C */	lfs f1, lit_3632@l(r8)
/* 80C7BCDC  FC 40 08 90 */	fmr f2, f1
/* 80C7BCE0  3D 00 80 C8 */	lis r8, lit_4150@ha
/* 80C7BCE4  C0 68 C7 28 */	lfs f3, lit_4150@l(r8)
/* 80C7BCE8  FC 80 18 90 */	fmr f4, f3
/* 80C7BCEC  39 00 00 00 */	li r8, 0
/* 80C7BCF0  4B 63 08 1C */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C7BD30  3C 60 80 C8 */	lis r3, l_HIO@ha
/* 80C7BD34  38 63 CA 64 */	addi r3, r3, l_HIO@l
/* 80C7BD38  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80C7CA7C */

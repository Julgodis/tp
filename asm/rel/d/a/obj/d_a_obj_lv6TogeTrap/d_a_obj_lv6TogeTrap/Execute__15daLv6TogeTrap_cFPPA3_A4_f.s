...
/* 80C7A768  4B 40 9D E0 */	b GetTgHitGObj__12dCcD_GObjInfFv
...
/* 80C7A794  4B 40 9D E8 */	b GetTgHitObjSe__12dCcD_GObjInfFv
/* 80C7A798  38 80 00 01 */	li r4, 1
/* 80C7A79C  4B 40 9E 14 */	b getHitSeID__12dCcD_GObjInfFUci
...
/* 80C7A7B0  4B 64 3C F4 */	b startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase
...
lbl_80C7A7C8:
/* 80C7A7C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7A7CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7A7D0  A8 9D 04 E4 */	lha r4, 0x4e4(r29)
/* 80C7A7D4  A8 BD 04 E6 */	lha r5, 0x4e6(r29)
/* 80C7A7D8  A8 DD 04 E8 */	lha r6, 0x4e8(r29)
/* 80C7A7DC  4B 39 1A 2C */	b mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C7A7F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C7A7F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C7A7FC  38 81 00 44 */	addi r4, r1, 0x44
/* 80C7A800  38 A1 00 38 */	addi r5, r1, 0x38
/* 80C7A804  4B 6C C5 68 */	b PSMTXMultVec
...
/* 80C7A818  4B 5F 4E F0 */	b SetR__8cM3dGSphFf
...
/* 80C7A854  4B 5E C2 90 */	b __pl__4cXyzCFRC3Vec
...
/* 80C7A884  4B 5F 4D C4 */	b SetC__8cM3dGSphFRC4cXyz
/* 80C7A888  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C7A88C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C7A890  3B 83 23 3C */	addi r28, r3, 0x233c
/* 80C7A894  7F 83 E3 78 */	mr r3, r28
/* 80C7A898  38 9D 06 50 */	addi r4, r29, 0x650
/* 80C7A89C  4B 5E A3 0C */	b Set__4cCcSFP8cCcD_Obj
...
/* 80C7A8E0  4B 5F 49 18 */	b SetH__8cM3dGCylFf
/* 80C7A8E4  7F 83 E3 78 */	mr r3, r28
/* 80C7A8E8  38 9D 07 88 */	addi r4, r29, 0x788
/* 80C7A8EC  4B 5E A2 BC */	b Set__4cCcSFP8cCcD_Obj
/* 80C7A8F0  38 7D 06 30 */	addi r3, r29, 0x630
/* 80C7A8F4  4B 40 8F 3C */	b Move__10dCcD_GSttsFv
/* 80C7A8F8  C0 3F 01 04 */	lfs f1, 0x104(r31)
/* 80C7A8FC  3C 60 80 C8 */	lis r3, l_HIO@ha
/* 80C7A900  38 63 CA 64 */	addi r3, r3, l_HIO@l
/* 80C7A904  C0 03 00 24 */	lfs f0, 0x24(r3)	/* effective address: 80C7CA88 */
...
/* 80C7A938  4B 3B 27 34 */	b dComIfGp_getReverb__Fi
...
/* 80C7A968  4B 6E 78 BC */	b _restgpr_28

...
/* 80D1B008 00000014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D1B00C 00000018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D1B010 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80D1B014 00000020  7F E3 FB 78 */	mr r3, r31
/* 80D1B018 00000024  3C 80 80 D2 */	lis r4, l_musiya_num@ha
/* 80D1B01C 00000028  A0 04 B7 E0 */	lhz r0, l_musiya_num@l(r4)
/* 80D1B020 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B024 00000030  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D1B028 00000034  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D1B02C 00000038  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D1B030 0000003C  4B 31 99 8C */	b isEventBit__11dSv_event_cCFUs
...
/* 80D1B040 0000004C  3C 80 80 D2 */	lis r4, l_musiya_num@ha
/* 80D1B044 00000050  38 84 B7 E0 */	addi r4, r4, l_musiya_num@l
/* 80D1B048 00000054  A0 04 00 02 */	lhz r0, 2(r4)	/* effective address: 80D1B7E2 */
/* 80D1B04C 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B050 0000005C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D1B054 00000060  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D1B058 00000064  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D1B05C 00000068  4B 31 99 60 */	b isEventBit__11dSv_event_cCFUs
...
lbl_80D1B070:
/* 80D1B070 00000000  3C 60 80 D2 */	lis r3, stringBase0@ha
/* 80D1B074 00000004  38 63 B7 E8 */	addi r3, r3, stringBase0@l
/* 80D1B078 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80D1B07C 0000000C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80D1B080 00000010  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80D1B084 00000014  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80D1B088 00000018  4B 64 D9 0C */	b strcmp
/* 80D1B08C 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80D1B090 00000020  40 82 00 CC */	bne lbl_80D1B15C
/* 80D1B094 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D1B098 00000028  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D1B09C 0000002C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80D1B0A0 00000030  2C 00 00 03 */	cmpwi r0, 3
/* 80D1B0A4 00000034  40 82 00 B8 */	bne lbl_80D1B15C
/* 80D1B0A8 00000038  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80D1B0AC 0000003C  3C 60 80 D2 */	lis r3, l_tom_itemno@ha
/* 80D1B0B0 00000040  38 63 B6 E0 */	addi r3, r3, l_tom_itemno@l
/* 80D1B0B4 00000044  7C 63 00 AE */	lbzx r3, r3, r0
/* 80D1B0B8 00000048  4B 4B EE 84 */	b isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
lbl_80D1B0CC:
/* 80D1B0CC 00000000  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80D1B0D0 00000004  28 00 00 00 */	cmplwi r0, 0
/* 80D1B0D4 00000008  40 82 00 3C */	bne lbl_80D1B110
/* 80D1B0D8 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D1B0DC 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D1B0E0 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D1B0E4 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80D1B0E8 0000001C  3C 80 80 D2 */	lis r4, l_musiya_num@ha
/* 80D1B0EC 00000020  38 84 B7 E0 */	addi r4, r4, l_musiya_num@l
/* 80D1B0F0 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80D1B0F4 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B0F8 0000002C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D1B0FC 00000030  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D1B100 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D1B104 00000038  4B 31 98 B8 */	b isEventBit__11dSv_event_cCFUs
/* 80D1B108 0000003C  2C 03 00 00 */	cmpwi r3, 0
/* 80D1B10C 00000040  41 82 00 48 */	beq lbl_80D1B154
lbl_80D1B110:
/* 80D1B110 00000000  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80D1B114 00000004  28 00 00 01 */	cmplwi r0, 1
/* 80D1B118 00000008  40 82 00 44 */	bne lbl_80D1B15C
/* 80D1B11C 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D1B120 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D1B124 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D1B128 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80D1B12C 0000001C  3C 80 80 D2 */	lis r4, l_musiya_num@ha
/* 80D1B130 00000020  38 84 B7 E0 */	addi r4, r4, l_musiya_num@l
/* 80D1B134 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80D1B138 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B13C 0000002C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D1B140 00000030  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D1B144 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D1B148 00000038  4B 31 98 74 */	b isEventBit__11dSv_event_cCFUs

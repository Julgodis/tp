...
/* 80D1B008 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1B00C 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D1B010 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80D1B014 00000020  7F E3 FB 78 */	mr r3, r31
/* 80D1B018 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D1B7E0 */
/* 80D1B01C 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4) /* 80D1B7E0 */
/* 80D1B020 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B024 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D1B028 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80D1B040 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D1B7E0 */
/* 80D1B044 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80D1B7E0 */
/* 80D1B048 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80D1B04C 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B050 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D1B054 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
lbl_80D1B070:
/* 80D1B070 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80D1B7E8 */
/* 80D1B074 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80D1B7E8 */
/* 80D1B078 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80D1B07C 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1B080 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80D1B094 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1B098 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80D1B0AC 0000003C  3C 60 00 00 */	lis r3, l_tom_itemno@ha /* 80D1B6E0 */
/* 80D1B0B0 00000040  38 63 00 00 */	addi r3, r3, l_tom_itemno@l /* 80D1B6E0 */
...
/* 80D1B0D8 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1B0DC 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D1B0E0 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D1B0E4 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80D1B0E8 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D1B7E0 */
/* 80D1B0EC 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80D1B7E0 */
/* 80D1B0F0 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80D1B0F4 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B0F8 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D1B0FC 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80D1B11C 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D1B120 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D1B124 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D1B128 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80D1B12C 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D1B7E0 */
/* 80D1B130 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80D1B7E0 */
/* 80D1B134 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80D1B138 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80D1B13C 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D1B140 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

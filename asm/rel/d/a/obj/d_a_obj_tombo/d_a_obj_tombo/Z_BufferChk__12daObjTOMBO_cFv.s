...
/* 80D1ACAC  3C 60 80 D2 */	lis r3, lit_3775@ha
/* 80D1ACB0  3B E3 B6 D8 */	addi r31, r3, lit_3775@l
...
/* 80D1ACCC  C0 1F 00 4C */	lfs f0, 0x4c(r31)	/* effective address: 80D1B724 */
...
/* 80D1ACE0  4B 2F A6 30 */	b mDoLib_project__FP3VecP3Vec
/* 80D1ACE4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D1ACE8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D1ACEC  80 63 5D 74 */	lwz r3, 0x5d74(r3)	/* effective address: 8040BF34 */
...
/* 80D1AD3C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D1AD40  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D1AD68  4B 33 B2 B0 */	b newData__13dDlst_peekZ_cFssPUl
lbl_80D1AD6C:
/* 80D1AD6C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D1AD70  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D1AD74  80 63 61 B0 */	lwz r3, 0x61b0(r3)	/* effective address: 8040C370 */
/* 80D1AD78  C3 E3 00 C8 */	lfs f31, 0xc8(r3)	/* effective address: 80406288 */
/* 80D1AD7C  C3 C3 00 CC */	lfs f30, 0xcc(r3)	/* effective address: 8040628C */
/* 80D1AD80  38 61 00 08 */	addi r3, r1, 8
/* 80D1AD84  38 81 00 14 */	addi r4, r1, 0x14
/* 80D1AD88  4B 2F A7 64 */	b mDoLib_pos2camera__FP3VecP3Vec

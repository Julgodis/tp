...
/* 80D1A54C 00000028  3C 60 80 D2 */	lis r3, lit_4347@ha
/* 80D1A550 0000002C  C8 23 B7 B8 */	lfd f1, lit_4347@l(r3)
...
/* 80D1A574 00000008  3C 80 80 D2 */	lis r4, lit_3942@ha
/* 80D1A578 0000000C  C0 24 B7 30 */	lfs f1, lit_3942@l(r4)
/* 80D1A57C 00000010  3C 80 80 D2 */	lis r4, lit_3776@ha
/* 80D1A580 00000014  C0 44 B6 DC */	lfs f2, lit_3776@l(r4)
/* 80D1A584 00000018  FC 60 10 90 */	fmr f3, f2
/* 80D1A588 0000001C  4B 55 54 B4 */	b cLib_addCalc2__FPffff
/* 80D1A58C 00000020  48 00 00 1C */	b lbl_80D1A5A8
lbl_80D1A590:
/* 80D1A590 00000000  38 7F 07 58 */	addi r3, r31, 0x758
/* 80D1A594 00000004  3C 80 80 D2 */	lis r4, lit_3776@ha
/* 80D1A598 00000008  C0 24 B6 DC */	lfs f1, lit_3776@l(r4)
/* 80D1A59C 0000000C  FC 40 08 90 */	fmr f2, f1
/* 80D1A5A0 00000010  FC 60 08 90 */	fmr f3, f1
/* 80D1A5A4 00000014  4B 55 54 98 */	b cLib_addCalc2__FPffff
lbl_80D1A5A8:
/* 80D1A5A8 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D1A5AC 00000004  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l
/* 80D1A5B0 00000008  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80D1A5F4 0000004C  3D 60 80 D2 */	lis r11, lit_3776@ha
/* 80D1A5F8 00000050  C0 2B B6 DC */	lfs f1, lit_3776@l(r11)
/* 80D1A5FC 00000054  4B 33 2E D0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80D1A600 00000058  90 7F 05 70 */	stw r3, 0x570(r31)
/* 80D1A604 0000005C  C3 FF 07 58 */	lfs f31, 0x758(r31)
/* 80D1A608 00000060  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
/* 80D1A60C 00000064  38 63 02 10 */	addi r3, r3, 0x210
/* 80D1A610 00000068  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80D1A614 0000006C  4B 33 13 04 */	b getEmitter__Q213dPa_control_c7level_cFUl

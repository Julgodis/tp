...
/* 80C5EFD4  3C 60 80 C6 */	lis r3, lit_3625@ha
/* 80C5EFD8  3B E3 F3 F4 */	addi r31, r3, lit_3625@l
/* 80C5EFDC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5EFE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5EFE4  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80C5EFE8  A8 BE 04 E6 */	lha r5, 0x4e6(r30)
/* 80C5EFEC  A8 DE 04 E8 */	lha r6, 0x4e8(r30)
/* 80C5EFF0  4B 3A D2 18 */	b mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C5F048  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C5F04C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C5F050  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C5F074  4B 64 D4 98 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C5F078  38 7E 05 B4 */	addi r3, r30, 0x5b4
/* 80C5F07C  C0 3E 05 B0 */	lfs f1, 0x5b0(r30)
/* 80C5F080  C0 5F 00 18 */	lfs f2, 0x18(r31)
/* 80C5F084  3C 80 80 C6 */	lis r4, l_HIO@ha
/* 80C5F088  38 84 F5 2C */	addi r4, r4, l_HIO@l
/* 80C5F08C  C0 64 00 04 */	lfs f3, 4(r4)	/* effective address: 80C5F530 */
/* 80C5F090  C0 9F 00 1C */	lfs f4, 0x1c(r31)
/* 80C5F094  4B 61 08 E8 */	b cLib_addCalc__FPfffff

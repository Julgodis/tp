...
/* 80C5C6C0 00000010  4B 70 5B 0C */	b _savegpr_25
/* 80C5C6C4 00000014  7C 7F 1B 78 */	mr r31, r3
/* 80C5C6C8 00000018  4B 54 EB B8 */	b dKy_camera_water_in_status_check__Fv
...
/* 80C5C740 00000010  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C5C744 00000014  3B 63 13 68 */	addi r27, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C5C748 00000018  3C 60 80 C6 */	lis r3, lit_3637@ha
/* 80C5C74C 0000001C  3B 83 C8 80 */	addi r28, r3, lit_3637@l
/* 80C5C750 00000020  3C 60 80 C6 */	lis r3, lit_3710@ha
/* 80C5C754 00000024  3B A3 C8 9C */	addi r29, r3, lit_3710@l
lbl_80C5C758:
/* 80C5C758 00000000  93 41 00 08 */	stw r26, 8(r1)
/* 80C5C75C 00000004  80 7B 00 00 */	lwz r3, 0(r27)	/* effective address: 80451368 */
...
/* 80C5C774 0000001C  C0 3C 00 00 */	lfs f1, 0(r28)	/* effective address: 80C5C880 */
/* 80C5C778 00000020  FC 40 08 90 */	fmr f2, f1
/* 80C5C77C 00000024  C0 7D 00 00 */	lfs f3, 0(r29)	/* effective address: 80C5C89C */
/* 80C5C780 00000028  FC 80 18 90 */	fmr f4, f3
/* 80C5C784 0000002C  39 00 00 00 */	li r8, 0
/* 80C5C788 00000030  4B 64 FD 84 */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C5C7A4 0000004C  4B 70 5A 74 */	b _restgpr_25

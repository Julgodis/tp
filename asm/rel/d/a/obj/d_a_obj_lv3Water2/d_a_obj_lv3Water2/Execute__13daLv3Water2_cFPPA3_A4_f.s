...
/* 80C5A854  4B 70 79 88 */	b _savegpr_29
/* 80C5A858  7C 7F 1B 78 */	mr r31, r3
/* 80C5A85C  7C 9E 23 78 */	mr r30, r4
/* 80C5A860  38 7F 05 C4 */	addi r3, r31, 0x5c4
/* 80C5A864  4B 3B 2B C4 */	b play__14mDoExt_baseAnmFv
/* 80C5A868  38 7F 05 A8 */	addi r3, r31, 0x5a8
/* 80C5A86C  4B 3E E0 00 */	b eventUpdate__17dEvLib_callback_cFv
/* 80C5A870  A8 1F 04 E4 */	lha r0, 0x4e4(r31)
/* 80C5A874  54 04 06 3E */	clrlwi r4, r0, 0x18
/* 80C5A878  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5A87C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5A880  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C5A884  7C 05 07 74 */	extsb r5, r0
/* 80C5A888  4B 3D AA D8 */	b isSwitch__10dSv_info_cCFii
...
/* 80C5A898  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5A89C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5A8A0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C5A8A4  7C 05 07 74 */	extsb r5, r0
/* 80C5A8A8  4B 3D AA B8 */	b isSwitch__10dSv_info_cCFii
...
/* 80C5A8BC  3C 80 80 C6 */	lis r4, l_mode_func@ha
/* 80C5A8C0  38 04 B3 E0 */	addi r0, r4, l_mode_func@l
/* 80C5A8C4  7D 80 2A 14 */	add r12, r0, r5
/* 80C5A8C8  4B 70 77 BC */	b __ptmf_scall
/* 80C5A8CC  60 00 00 00 */	nop 
/* 80C5A8D0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5A8D4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5A8D8  38 80 00 0E */	li r4, 0xe
/* 80C5A8DC  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C5A8E0  7C 05 07 74 */	extsb r5, r0
/* 80C5A8E4  4B 3D AA 7C */	b isSwitch__10dSv_info_cCFii
/* 80C5A8E8  2C 03 00 00 */	cmpwi r3, 0
/* 80C5A8EC  41 82 01 6C */	beq lbl_80C5AA58
/* 80C5A8F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5A8F4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80C5A8F8  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C5A940  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5A944  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5A948  4B 3F 2B 84 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5A998  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5A99C  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5A9A0  4B 3F 2B 2C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5A9F0  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5A9F4  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5A9F8  4B 3F 2A D4 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5AA48  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5AA4C  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5AA50  4B 3F 2A 7C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C5AA54  90 7F 05 FC */	stw r3, 0x5fc(r31)
lbl_80C5AA58:
/* 80C5AA58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5AA5C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5AA60  38 80 00 0F */	li r4, 0xf
/* 80C5AA64  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C5AA68  7C 05 07 74 */	extsb r5, r0
/* 80C5AA6C  4B 3D A8 F4 */	b isSwitch__10dSv_info_cCFii
/* 80C5AA70  2C 03 00 00 */	cmpwi r3, 0
/* 80C5AA74  41 82 01 6C */	beq lbl_80C5ABE0
/* 80C5AA78  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5AA7C  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80C5AA80  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C5AAC8  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5AACC  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5AAD0  4B 3F 29 FC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5AB20  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5AB24  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5AB28  4B 3F 29 A4 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5AB78  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5AB7C  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5AB80  4B 3F 29 4C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5ABD0  3D 60 80 C6 */	lis r11, lit_3682@ha
/* 80C5ABD4  C0 2B B3 70 */	lfs f1, lit_3682@l(r11)
/* 80C5ABD8  4B 3F 28 F4 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C5ABFC  4B 70 76 2C */	b _restgpr_29

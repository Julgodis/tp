...
/* 80C5AE14  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5AE18  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80C5AE1C  80 04 5F A0 */	lwz r0, 0x5fa0(r4)	/* effective address: 8040C160 */
/* 80C5AE20  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80C5AE24  3B A3 4A C8 */	addi r29, r3, j3dSys@l
/* 80C5AE28  90 1D 00 48 */	stw r0, 0x48(r29)	/* effective address: 80434B10 */
/* 80C5AE2C  80 04 5F A4 */	lwz r0, 0x5fa4(r4)	/* effective address: 8040C164 */
/* 80C5AE30  90 1D 00 4C */	stw r0, 0x4c(r29)	/* effective address: 80434B14 */
...
/* 80C5AE74  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5AE78  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5AE7C  80 83 61 B0 */	lwz r4, 0x61b0(r3)	/* effective address: 8040C370 */
...
/* 80C5AEC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5AECC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5AED0  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80C5AED4  90 1D 00 48 */	stw r0, 0x48(r29)
/* 80C5AED8  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

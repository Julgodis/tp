...
/* 80C5A614  4B 41 E0 10 */	b __ct__16dBgS_MoveBgActorFv
/* 80C5A618  3C 60 80 C6 */	lis r3, __vt__17dEvLib_callback_c@ha
/* 80C5A61C  38 03 B4 54 */	addi r0, r3, __vt__17dEvLib_callback_c@l
...
/* 80C5A630  3C 60 80 C6 */	lis r3, __vt__13daLv3Water2_c@ha
/* 80C5A634  38 63 B4 6C */	addi r3, r3, __vt__13daLv3Water2_c@l
/* 80C5A638  90 7F 05 9C */	stw r3, 0x59c(r31)
/* 80C5A63C  38 03 00 28 */	addi r0, r3, 0x28
/* 80C5A640  90 1F 05 A8 */	stw r0, 0x5a8(r31)
/* 80C5A644  3C 60 80 C6 */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80C5A648  38 03 B4 48 */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80C5A64C  94 1F 05 C4 */	stwu r0, 0x5c4(r31)
/* 80C5A650  7F E3 FB 78 */	mr r3, r31
/* 80C5A654  38 80 00 00 */	li r4, 0
/* 80C5A658  4B 6C DD A4 */	b init__12J3DFrameCtrlFs
...
/* 80C5A688  3C 80 80 C6 */	lis r4, l_resNameIdx@ha
/* 80C5A68C  38 84 B3 C4 */	addi r4, r4, l_resNameIdx@l
/* 80C5A690  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C5A694  4B 3D 28 28 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C5A6B0  3C 80 80 C6 */	lis r4, l_resNameIdx@ha
/* 80C5A6B4  38 84 B3 C4 */	addi r4, r4, l_resNameIdx@l
/* 80C5A6B8  7C 84 00 2E */	lwzx r4, r4, r0
/* 80C5A6BC  3C A0 80 C6 */	lis r5, l_dzbIdx@ha
/* 80C5A6C0  38 A5 B3 68 */	addi r5, r5, l_dzbIdx@l
...
/* 80C5A6D4  4B 41 E0 E8 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C5A6F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5A6F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5A6F8  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C5A6FC  7C 05 07 74 */	extsb r5, r0
/* 80C5A700  4B 3D AC 60 */	b isSwitch__10dSv_info_cCFii
...
/* 80C5A710  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5A714  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5A718  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C5A71C  7C 05 07 74 */	extsb r5, r0
/* 80C5A720  4B 3D AC 40 */	b isSwitch__10dSv_info_cCFii
...
/* 80C5A74C  3C 60 80 C6 */	lis r3, lit_3747@ha
/* 80C5A750  C0 43 B3 74 */	lfs f2, lit_3747@l(r3)
/* 80C5A754  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80C5A758  54 00 E5 3E */	rlwinm r0, r0, 0x1c, 0x14, 0x1f
/* 80C5A75C  3C 60 80 C6 */	lis r3, lit_3749@ha
/* 80C5A760  C8 23 B3 7C */	lfd f1, lit_3749@l(r3)
...
/* 80C5A794  3C 60 80 C6 */	lis r3, lit_3747@ha
/* 80C5A798  C0 43 B3 74 */	lfs f2, lit_3747@l(r3)
/* 80C5A79C  80 1E 00 B0 */	lwz r0, 0xb0(r30)
/* 80C5A7A0  54 00 E5 3E */	rlwinm r0, r0, 0x1c, 0x14, 0x1f
/* 80C5A7A4  3C 60 80 C6 */	lis r3, lit_3749@ha
/* 80C5A7A8  C8 23 B3 7C */	lfd f1, lit_3749@l(r3)

...
/* 80CDD5DC  4B 68 4B FC */	b _savegpr_28
/* 80CDD5E0  7C 7F 1B 78 */	mr r31, r3
/* 80CDD5E4  88 03 0B 28 */	lbz r0, 0xb28(r3)
/* 80CDD5E8  54 05 18 38 */	slwi r5, r0, 3
/* 80CDD5EC  3C 60 80 CE */	lis r3, l_bmdData@ha
/* 80CDD5F0  38 83 E3 94 */	addi r4, r3, l_bmdData@l
/* 80CDD5F4  3B 84 00 04 */	addi r28, r4, 4
/* 80CDD5F8  7C 1C 28 2E */	lwzx r0, r28, r5
/* 80CDD5FC  54 00 10 3A */	slwi r0, r0, 2
/* 80CDD600  3C 60 80 CE */	lis r3, l_resNameList@ha
/* 80CDD604  38 63 E3 9C */	addi r3, r3, l_resNameList@l
/* 80CDD608  7C 63 00 2E */	lwzx r3, r3, r0
/* 80CDD60C  7C 84 28 2E */	lwzx r4, r4, r5
/* 80CDD610  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80CDD614  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80CDD628  4B 35 EC C4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CDD648  4B 33 76 0C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80CDD674  3C 60 80 CE */	lis r3, l_resNameList@ha
/* 80CDD678  38 63 E3 9C */	addi r3, r3, l_resNameList@l
...
/* 80CDD68C  4B 35 EC 60 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80CDD6A8  3D 00 80 CE */	lis r8, lit_3892@ha
/* 80CDD6AC  C0 28 E3 64 */	lfs f1, lit_3892@l(r8)
/* 80CDD6B0  39 00 00 00 */	li r8, 0
/* 80CDD6B4  39 20 FF FF */	li r9, -1
/* 80CDD6B8  4B 33 00 54 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80CDD6D4  4B 68 4B 50 */	b _restgpr_28

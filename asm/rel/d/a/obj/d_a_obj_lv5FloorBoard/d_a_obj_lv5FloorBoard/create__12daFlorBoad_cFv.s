...
/* 80C6A820  4B 40 DE 04 */	b __ct__16dBgS_MoveBgActorFv
/* 80C6A824  3C 60 80 C7 */	lis r3, __vt__12daFlorBoad_c@ha
/* 80C6A828  38 03 B2 AC */	addi r0, r3, __vt__12daFlorBoad_c@l
/* 80C6A82C  90 1E 05 9C */	stw r0, 0x59c(r30)
/* 80C6A830  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C6A834  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C6A838  90 1E 05 B8 */	stw r0, 0x5b8(r30)
/* 80C6A83C  38 7E 05 BC */	addi r3, r30, 0x5bc
/* 80C6A840  4B 41 8F 20 */	b __ct__10dCcD_GSttsFv
/* 80C6A844  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C6A848  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C6A860  4B 41 91 C8 */	b __ct__12dCcD_GObjInfFv
/* 80C6A864  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C6A868  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C6A86C  90 1E 01 20 */	stw r0, 0x120(r30)
/* 80C6A870  3C 60 80 C7 */	lis r3, __vt__8cM3dGAab@ha
/* 80C6A874  38 03 B2 A0 */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C6A878  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 80C6A87C  3C 60 80 C7 */	lis r3, __vt__8cM3dGCyl@ha
/* 80C6A880  38 03 B2 94 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 80C6A884  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C6A888  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 80C6A88C  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 80C6A890  90 7E 01 20 */	stw r3, 0x120(r30)
/* 80C6A894  38 03 00 58 */	addi r0, r3, 0x58
/* 80C6A898  90 1E 01 38 */	stw r0, 0x138(r30)
/* 80C6A89C  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 80C6A8A0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 80C6A8D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6A8DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C6A8E0  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80C6A8E4  7C 05 07 74 */	extsb r5, r0
/* 80C6A8E8  4B 3C AA 78 */	b isSwitch__10dSv_info_cCFii
...
/* 80C6A900  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C6A904  38 84 B1 8C */	addi r4, r4, stringBase0@l
/* 80C6A908  4B 3C 25 B4 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C6A91C  3C 80 80 C7 */	lis r4, stringBase0@ha
/* 80C6A920  38 84 B1 8C */	addi r4, r4, stringBase0@l
/* 80C6A924  38 A0 00 07 */	li r5, 7
/* 80C6A928  3C C0 80 07 */	lis r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C6A92C  38 C6 5A D8 */	addi r6, r6, dBgS_MoveBGProc_TypicalRotY__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
/* 80C6A930  38 E0 19 00 */	li r7, 0x1900
/* 80C6A934  39 00 00 00 */	li r8, 0
/* 80C6A938  4B 40 DE 84 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 80C6A964  4B 3A FC 14 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
...
/* 80C6A978  4B 41 8E E8 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80C6A97C  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 80C6A980  3C 80 80 C7 */	lis r4, mCcDCyl__12daFlorBoad_c@ha
/* 80C6A984  38 84 B1 B8 */	addi r4, r4, mCcDCyl__12daFlorBoad_c@l
/* 80C6A988  4B 41 9F 2C */	b Set__8dCcD_CylFRC11dCcD_SrcCyl

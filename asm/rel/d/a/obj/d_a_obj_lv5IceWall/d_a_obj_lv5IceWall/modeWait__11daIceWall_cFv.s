...
/* 80C6BCAC 00000004  4B 6F 65 18 */	b _savegpr_23
/* 80C6BCB0 00000008  7C 7E 1B 78 */	mr r30, r3
/* 80C6BCB4 0000000C  3C 60 80 C7 */	lis r3, lit_3656@ha
/* 80C6BCB8 00000010  3B E3 C6 40 */	addi r31, r3, lit_3656@l
...
/* 80C6BCD0 0000000C  4B 41 87 90 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 80C6BCE0 0000001C  4B 41 88 68 */	b GetTgHitGObj__12dCcD_GObjInfFv
...
/* 80C6BD1C 00000008  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80C6C640 */
...
/* 80C6BD2C 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C6BD30 0000001C  3B 63 61 C0 */	addi r27, r3, g_dComIfG_gameInfo@l
/* 80C6BD34 00000020  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 80C6BD7C 00000068  4B 3E 17 50 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C6BD80 0000006C  90 7E 08 80 */	stw r3, 0x880(r30)
/* 80C6BD84 00000070  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
/* 80C6BD88 00000074  38 63 02 10 */	addi r3, r3, 0x210
/* 80C6BD8C 00000078  80 9E 08 7C */	lwz r4, 0x87c(r30)
/* 80C6BD90 0000007C  4B 3D FB 88 */	b getEmitter__Q213dPa_control_c7level_cFUl
/* 80C6BD94 00000080  28 03 00 00 */	cmplwi r3, 0
/* 80C6BD98 00000084  41 82 00 50 */	beq lbl_80C6BDE8
/* 80C6BD9C 00000088  C0 3F 00 4C */	lfs f1, 0x4c(r31)	/* effective address: 80C6C68C */
...
/* 80C6BDB4 000000A0  C0 3F 00 50 */	lfs f1, 0x50(r31)	/* effective address: 80C6C690 */
...
/* 80C6BDF0 00000008  4B 3C 12 7C */	b dComIfGp_getReverb__Fi
...
/* 80C6BE04 0000001C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C6BE08 00000020  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C6BE0C 00000024  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C6BE1C 00000034  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80C6C640 */
/* 80C6BE20 00000038  FC 40 08 90 */	fmr f2, f1
/* 80C6BE24 0000003C  C0 7F 00 54 */	lfs f3, 0x54(r31)	/* effective address: 80C6C694 */
/* 80C6BE28 00000040  FC 80 18 90 */	fmr f4, f3
/* 80C6BE2C 00000044  39 00 00 00 */	li r8, 0
/* 80C6BE30 00000048  4B 63 FB 54 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80C6BE70 00000088  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C6BE74 0000008C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C6BE78 00000090  88 1E 04 BA */	lbz r0, 0x4ba(r30)
/* 80C6BE7C 00000094  7C 05 07 74 */	extsb r5, r0
/* 80C6BE80 00000098  4B 3C 93 80 */	b onSwitch__10dSv_info_cFii
lbl_80C6BE84:
...
/* 80C6BEB4 00000030  4B 3A E6 C4 */	b fopAcM_setCullSizeBox2__FP10fopAc_ac_cP12J3DModelData
/* 80C6BEB8 00000034  3C 60 80 C7 */	lis r3, l_HIO@ha
/* 80C6BEBC 00000038  38 63 C8 3C */	addi r3, r3, l_HIO@l
/* 80C6BEC0 0000003C  88 03 00 11 */	lbz r0, 0x11(r3)	/* effective address: 80C6C84D */
...
/* 80C6BF00 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C6BF04 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C6BF08 00000010  3B 43 23 3C */	addi r26, r3, 0x233c
/* 80C6BF0C 00000014  C3 5F 00 58 */	lfs f26, 0x58(r31)	/* effective address: 80C6C698 */
/* 80C6BF10 00000018  C3 7F 00 5C */	lfs f27, 0x5c(r31)	/* effective address: 80C6C69C */
/* 80C6BF14 0000001C  CB 9F 00 40 */	lfd f28, 0x40(r31)	/* effective address: 80C6C680 */
/* 80C6BF18 00000020  3F 60 43 30 */	lis r27, 0x4330
/* 80C6BF1C 00000024  C3 BF 00 60 */	lfs f29, 0x60(r31)	/* effective address: 80C6C6A0 */
/* 80C6BF20 00000028  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C6BF24 0000002C  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l
/* 80C6BF28 00000030  C3 DF 00 64 */	lfs f30, 0x64(r31)	/* effective address: 80C6C6A4 */
/* 80C6BF2C 00000034  C3 FF 00 68 */	lfs f31, 0x68(r31)	/* effective address: 80C6C6A8 */
lbl_80C6BF30:
...
/* 80C6BF6C 0000003C  4B 3A 02 9C */	b mDoMtx_ZXYrotS__FPA4_fsss
...
/* 80C6BF7C 0000004C  4B 6D AD F0 */	b PSMTXMultVec
...
/* 80C6BFA4 00000074  4B 6D B0 EC */	b PSVECAdd
...
/* 80C6BFBC 0000008C  4B 60 32 44 */	b SetR__8cM3dGCylFf
...
/* 80C6BFF8 000000C8  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80C6C640 */
...
/* 80C6C008 000000D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C6C00C 000000DC  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l
/* 80C6C010 000000E0  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C6C058 00000128  4B 3E 14 74 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C6C05C 0000012C  90 7E 08 78 */	stw r3, 0x878(r30)
/* 80C6C060 00000130  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C6C0B0 00000180  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80C6C640 */
/* 80C6C0B4 00000184  4B 3E 14 18 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80C6C0B8 00000188  90 7E 08 7C */	stw r3, 0x87c(r30)
/* 80C6C0BC 0000018C  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
/* 80C6C0C0 00000190  38 63 02 10 */	addi r3, r3, 0x210
/* 80C6C0C4 00000194  80 9E 08 7C */	lwz r4, 0x87c(r30)
/* 80C6C0C8 00000198  4B 3D F8 50 */	b getEmitter__Q213dPa_control_c7level_cFUl
/* 80C6C0CC 0000019C  28 03 00 00 */	cmplwi r3, 0
/* 80C6C0D0 000001A0  41 82 00 58 */	beq lbl_80C6C128
/* 80C6C0D4 000001A4  C0 3F 00 6C */	lfs f1, 0x6c(r31)	/* effective address: 80C6C6AC */
...
/* 80C6C0E4 000001B4  C0 3F 00 70 */	lfs f1, 0x70(r31)	/* effective address: 80C6C6B0 */
...
/* 80C6C0F4 000001C4  C0 3F 00 74 */	lfs f1, 0x74(r31)	/* effective address: 80C6C6B4 */
...
/* 80C6C15C 00000008  4B 6F 60 B4 */	b _restgpr_23

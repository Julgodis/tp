...
/* 80C6C1D0  4B 6F 60 0C */	b _savegpr_29
/* 80C6C1D4  7C 7E 1B 78 */	mr r30, r3
/* 80C6C1D8  3C 60 80 C7 */	lis r3, lit_3656@ha
/* 80C6C1DC  3B E3 C6 40 */	addi r31, r3, lit_3656@l
/* 80C6C1E0  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80C6C640 */
/* 80C6C1E4  D0 21 00 3C */	stfs f1, 0x3c(r1)
/* 80C6C1E8  D0 21 00 40 */	stfs f1, 0x40(r1)
/* 80C6C1EC  D0 21 00 44 */	stfs f1, 0x44(r1)
/* 80C6C1F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C6C1F4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80C6C1F8  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C6C240  4B 3E 12 8C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C6C29C  4B 3E 12 30 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C6C2B0  4B 3D F6 68 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80C6C310  4B 3C 0D 5C */	b dComIfGp_getReverb__Fi
...
/* 80C6C324  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80C6C328  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80C6C32C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80C6C350  4B 63 F6 34 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80C6C354  7F C3 F3 78 */	mr r3, r30
/* 80C6C358  4B 3A D9 24 */	b fopAcM_delete__FP10fopAc_ac_c
/* 80C6C35C  39 61 00 60 */	addi r11, r1, 0x60
/* 80C6C360  4B 6F 5E C8 */	b _restgpr_29

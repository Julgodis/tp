...
/* 8057AAA4  4B DE 77 24 */	b _savegpr_24
/* 8057AAA8  7C 7F 1B 78 */	mr r31, r3
/* 8057AAAC  3C 60 80 58 */	lis r3, l_hair_offset@ha
/* 8057AAB0  3B C3 B3 60 */	addi r30, r3, l_hair_offset@l
/* 8057AAB4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057AAB8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057AABC  83 23 5D AC */	lwz r25, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8057AAC0  38 00 02 F2 */	li r0, 0x2f2
/* 8057AAC4  B0 01 00 0A */	sth r0, 0xa(r1)
/* 8057AAC8  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 8057AACC  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 8057AAD0  38 81 00 0A */	addi r4, r1, 0xa
/* 8057AAD4  4B A9 ED 24 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8057AAF0  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 8057AAF4  83 83 10 18 */	lwz r28, m_midnaActor__9daPy_py_c@l(r3)
/* 8057AAF8  38 00 02 1B */	li r0, 0x21b
/* 8057AAFC  B0 01 00 08 */	sth r0, 8(r1)
/* 8057AB00  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 8057AB04  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 8057AB08  38 81 00 08 */	addi r4, r1, 8
/* 8057AB0C  4B A9 EC EC */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8057AB28  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057AB2C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8057AB50  4B AC D2 C0 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 8057AB54  7C 7A 1B 78 */	mr r26, r3
/* 8057AB58  7F 63 DB 78 */	mr r3, r27
/* 8057AB5C  80 9F 05 9C */	lwz r4, 0x59c(r31)
/* 8057AB60  4B AC D1 EC */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8057AB74  3C 60 80 58 */	lis r3, lit_4502@ha
/* 8057AB78  38 63 B8 34 */	addi r3, r3, lit_4502@l
...
/* 8057AB94  3C A0 80 58 */	lis r5, struct_8057B4EC+0x0@ha
/* 8057AB98  38 A5 B4 EC */	addi r5, r5, struct_8057B4EC+0x0@l
/* 8057AB9C  38 A5 01 63 */	addi r5, r5, 0x163
/* 8057ABA0  38 C0 00 03 */	li r6, 3
/* 8057ABA4  4B AC D5 48 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8057ABF0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057ABF4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057ABF8  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8057ABFC  54 00 08 3C */	slwi r0, r0, 1
/* 8057AC00  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 8057AC04  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 8057AC08  7C 84 02 2E */	lhzx r4, r4, r0
/* 8057AC0C  4B AB 9D 80 */	b onEventBit__11dSv_event_cFUs
lbl_8057AC10:
...
/* 8057AD3C  4B A9 20 28 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8057AD40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8057AD44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8057AD48  A8 99 04 E6 */	lha r4, 0x4e6(r25)
/* 8057AD4C  4B A9 16 E8 */	b mDoMtx_YrotM__FPA4_fs
/* 8057AD50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8057AD54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8057AD58  38 9F 05 B0 */	addi r4, r31, 0x5b0
/* 8057AD5C  7C 85 23 78 */	mr r5, r4
/* 8057AD60  4B DC C0 0C */	b PSMTXMultVec
...
/* 8057AD80  3C 80 80 58 */	lis r4, lit_4503@ha
/* 8057AD84  38 84 B8 18 */	addi r4, r4, lit_4503@l
...
lbl_8057AD98:
/* 8057AD98  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057AD9C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057ADA0  38 63 01 00 */	addi r3, r3, 0x100
/* 8057ADA4  38 80 00 00 */	li r4, 0
/* 8057ADA8  4B AB 94 84 */	b onCollectCrystal__20dSv_player_collect_cFUc
/* 8057ADAC  48 00 00 78 */	b lbl_8057AE24
lbl_8057ADB0:
/* 8057ADB0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057ADB4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057ADB8  38 63 01 00 */	addi r3, r3, 0x100
/* 8057ADBC  38 80 00 01 */	li r4, 1
/* 8057ADC0  4B AB 94 6C */	b onCollectCrystal__20dSv_player_collect_cFUc
/* 8057ADC4  48 00 00 60 */	b lbl_8057AE24
lbl_8057ADC8:
/* 8057ADC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057ADCC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057ADD0  38 63 01 00 */	addi r3, r3, 0x100
/* 8057ADD4  38 80 00 02 */	li r4, 2
/* 8057ADD8  4B AB 94 54 */	b onCollectCrystal__20dSv_player_collect_cFUc
/* 8057ADDC  48 00 00 48 */	b lbl_8057AE24
lbl_8057ADE0:
/* 8057ADE0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057ADE4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057ADE8  38 63 01 00 */	addi r3, r3, 0x100
/* 8057ADEC  38 80 00 01 */	li r4, 1
/* 8057ADF0  4B AB 94 80 */	b onCollectMirror__20dSv_player_collect_cFUc
/* 8057ADF4  48 00 00 30 */	b lbl_8057AE24
lbl_8057ADF8:
/* 8057ADF8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057ADFC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057AE00  38 63 01 00 */	addi r3, r3, 0x100
/* 8057AE04  38 80 00 02 */	li r4, 2
/* 8057AE08  4B AB 94 68 */	b onCollectMirror__20dSv_player_collect_cFUc
/* 8057AE0C  48 00 00 18 */	b lbl_8057AE24
lbl_8057AE10:
/* 8057AE10  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8057AE14  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8057AE18  38 63 01 00 */	addi r3, r3, 0x100
/* 8057AE1C  38 80 00 03 */	li r4, 3
/* 8057AE20  4B AB 94 50 */	b onCollectMirror__20dSv_player_collect_cFUc
lbl_8057AE24:
...
/* 8057AE50  4B AC D5 74 */	b setGoal__16dEvent_manager_cFP4cXyz
...
/* 8057AE6C  4B CC F1 24 */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 8057AEC0  3C 60 80 58 */	lis r3, lit_4504@ha
/* 8057AEC4  38 63 B7 EC */	addi r3, r3, lit_4504@l
...
/* 8057AF34  4B CF 4A 48 */	b cLib_addCalc__FPfffff
...
/* 8057AF84  4B AC D1 F8 */	b cutEnd__16dEvent_manager_cFi
lbl_8057AF88:
...
/* 8057AFD8  4B AC D1 A4 */	b cutEnd__16dEvent_manager_cFi
...
/* 8057AFF8  4B CF 57 48 */	b cLib_chaseF__FPfff
...
lbl_8057B018:
/* 8057B018  4B A9 EC A0 */	b fopAcM_delete__FUi
/* 8057B01C  7F 63 DB 78 */	mr r3, r27
/* 8057B020  80 9F 05 9C */	lwz r4, 0x59c(r31)
/* 8057B024  4B AC D1 58 */	b cutEnd__16dEvent_manager_cFi
...
/* 8057B054  4B AC D1 28 */	b cutEnd__16dEvent_manager_cFi
...
/* 8057B06C  4B CC F2 6C */	b doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
...
/* 8057B080  4B AC D0 FC */	b cutEnd__16dEvent_manager_cFi
...
/* 8057B0A4  4B CD 02 1C */	b query005__10dMsgFlow_cFP21mesg_flow_node_branchP10fopAc_ac_ci
...
/* 8057B0B8  4B AC D0 C4 */	b cutEnd__16dEvent_manager_cFi
lbl_8057B0BC:
/* 8057B0BC  38 60 00 01 */	li r3, 1
/* 8057B0C0  39 61 00 70 */	addi r11, r1, 0x70
/* 8057B0C4  4B DE 71 50 */	b _restgpr_24

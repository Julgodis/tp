...
/* 80C3AEF0 0000000C  3C 80 00 00 */	lis r4, lit_3775@ha /* 80C3C674 */
/* 80C3AEF4 00000010  3B C4 00 00 */	addi r30, r4, lit_3775@l /* 80C3C674 */
...
lbl_80C3B008:
/* 80C3B008 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C3B00C 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C3B0D4 00000004  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C3B0D8 00000008  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C3B258 0000009C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C3B25C 000000A0  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80C3B278 000000BC  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80C3C808 */
/* 80C3B27C 000000C0  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80C3C808 */
...
/* 80C3B378 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C3B37C 00000008  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C3B3E8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C3B3EC 0000000C  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C3B438 00000040  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80C3C808 */
/* 80C3B43C 00000044  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80C3C808 */
...
/* 80C3B4C4 0000005C  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80C3C808 */
/* 80C3B4C8 00000060  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80C3C808 */
...
/* 80C3B5C4 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C3B5C8 00000008  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C3B634 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80C3B638 0000000C  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80C3B684 00000040  3C 60 00 00 */	lis r3, __vt__8cM3dGPla@ha /* 80C3C808 */
/* 80C3B688 00000044  38 03 00 00 */	addi r0, r3, __vt__8cM3dGPla@l /* 80C3C808 */
...
/* 80C3B6E4 0000003C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80C3B6E8 00000040  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */

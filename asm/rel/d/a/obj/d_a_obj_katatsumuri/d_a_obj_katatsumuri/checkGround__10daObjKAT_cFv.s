...
/* 80C3A6A8  4B 72 7B 34 */	b _savegpr_29
/* 80C3A6AC  7C 7F 1B 78 */	mr r31, r3
/* 80C3A6B0  3C 60 80 C4 */	lis r3, lit_3775@ha
/* 80C3A6B4  3B C3 C6 74 */	addi r30, r3, lit_3775@l
/* 80C3A6B8  38 61 00 38 */	addi r3, r1, 0x38
/* 80C3A6BC  4B 43 D5 AC */	b __ct__11dBgS_LinChkFv
/* 80C3A6C0  38 61 00 90 */	addi r3, r1, 0x90
/* 80C3A6C4  4B 43 E7 A4 */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C3A6D8  4B 43 D6 8C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C3A6DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C3A6E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C3A6E4  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80C3A6E8  7F A3 EB 78 */	mr r3, r29
/* 80C3A6EC  38 81 00 38 */	addi r4, r1, 0x38
/* 80C3A6F0  4B 43 9C C4 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C3A6F4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C3A6F8  41 82 01 AC */	beq lbl_80C3A8A4
/* 80C3A6FC  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha
/* 80C3A700  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C3A714  4B 43 A0 30 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C3A75C  4B 70 CC 40 */	b PSVECSquareDistance
...
/* 80C3A7CC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C3A7D0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C3A83C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C3A840  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80C3A844  48 00 00 08 */	b lbl_80C3A84C
lbl_80C3A848:
/* 80C3A848  FC 40 08 90 */	fmr f2, f1
lbl_80C3A84C:
/* 80C3A84C  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80C3A850  4B 62 CE 24 */	b cM_atan2s__Fff
...
/* 80C3A868  4B 62 CE 0C */	b cM_atan2s__Fff
...
/* 80C3A87C  4B 62 CD F8 */	b cM_atan2s__Fff
...
/* 80C3A898  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha
/* 80C3A89C  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80C3A8A0  90 01 00 34 */	stw r0, 0x34(r1)
lbl_80C3A8A4:
/* 80C3A8A4  38 61 00 38 */	addi r3, r1, 0x38
/* 80C3A8A8  38 80 FF FF */	li r4, -1
/* 80C3A8AC  4B 43 D4 30 */	b __dt__11dBgS_LinChkFv
/* 80C3A8B0  39 61 00 C0 */	addi r11, r1, 0xc0
/* 80C3A8B4  4B 72 79 74 */	b _restgpr_29

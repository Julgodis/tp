...
/* 80C3AAC4 00000010  4B 72 77 14 */	b _savegpr_28
/* 80C3AAC8 00000014  7C 7F 1B 78 */	mr r31, r3
/* 80C3AACC 00000018  3C 80 80 C4 */	lis r4, lit_3775@ha
/* 80C3AAD0 0000001C  3B C4 C6 74 */	addi r30, r4, lit_3775@l
/* 80C3AAD4 00000020  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C3AAD8 00000024  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80C3AADC 00000028  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C3AAE0 0000002C  7F A4 EB 78 */	mr r4, r29
/* 80C3AAE4 00000030  4B 3D FE 80 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C3AB24 00000070  C0 1E 00 B0 */	lfs f0, 0xb0(r30)	/* effective address: 80C3C724 */
...
/* 80C3AB44 00000090  4B 52 3B 10 */	b posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
...
/* 80C3AB58 000000A4  4B 52 3D 24 */	b bgCheckAfterOffset__20daPy_boomerangMove_cFPC4cXyz
/* 80C3AB5C 000000A8  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)
/* 80C3AB60 000000AC  C0 1E 00 B4 */	lfs f0, 0xb4(r30)	/* effective address: 80C3C728 */
...
/* 80C3AB74 00000004  4B 43 D0 F4 */	b __ct__11dBgS_LinChkFv
/* 80C3AB78 00000008  38 61 00 9C */	addi r3, r1, 0x9c
/* 80C3AB7C 0000000C  4B 43 E2 EC */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C3AB90 00000020  4B 43 D1 D4 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C3AB94 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3AB98 00000028  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80C3ABA8 00000038  4B 43 98 0C */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C3ABAC 0000003C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C3ABB0 00000040  41 82 01 C0 */	beq lbl_80C3AD70
/* 80C3ABB4 00000044  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha
/* 80C3ABB8 00000048  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C3ABCC 0000005C  4B 43 9B 78 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C3AC0C 0000009C  C0 1E 00 58 */	lfs f0, 0x58(r30)	/* effective address: 80C3C6CC */
...
/* 80C3AC38 000000C8  4B 70 C7 64 */	b PSVECSquareDistance
/* 80C3AC3C 000000CC  C0 1E 00 58 */	lfs f0, 0x58(r30)	/* effective address: 80C3C6CC */
...
/* 80C3AC4C 00000008  C8 9E 00 78 */	lfd f4, 0x78(r30)	/* effective address: 80C3C6EC */
/* 80C3AC50 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80C3AC54 00000010  C8 7E 00 80 */	lfd f3, 0x80(r30)	/* effective address: 80C3C6F4 */
...
lbl_80C3AC9C:
/* 80C3AC9C 00000000  C8 1E 00 88 */	lfd f0, 0x88(r30)	/* effective address: 80C3C6FC */
/* 80C3ACA0 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80C3ACA4 00000000  40 80 00 10 */	bge lbl_80C3ACB4
/* 80C3ACA8 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C3ACAC 00000008  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C3AD18 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C3AD1C 0000000C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C3AD2C 00000004  4B 62 C9 48 */	b cM_atan2s__Fff
...
/* 80C3AD44 0000001C  4B 62 C9 30 */	b cM_atan2s__Fff
...
/* 80C3AD58 00000030  4B 62 C9 1C */	b cM_atan2s__Fff
/* 80C3AD5C 00000034  B0 7F 07 F6 */	sth r3, 0x7f6(r31)
/* 80C3AD60 00000038  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha
/* 80C3AD64 0000003C  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80C3AD68 00000040  90 01 00 40 */	stw r0, 0x40(r1)
/* 80C3AD6C 00000044  48 00 00 30 */	b lbl_80C3AD9C
lbl_80C3AD70:
/* 80C3AD70 00000000  C0 3E 00 B8 */	lfs f1, 0xb8(r30)	/* effective address: 80C3C72C */
...
/* 80C3ADAC 00000010  4B 43 CF 30 */	b __dt__11dBgS_LinChkFv
lbl_80C3ADB0:
/* 80C3ADB0 00000000  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80C3ADB4 00000004  4B 72 74 70 */	b _restgpr_28

...
/* 80C3AAC4  4B 72 77 14 */	b _savegpr_28
/* 80C3AAC8  7C 7F 1B 78 */	mr r31, r3
/* 80C3AACC  3C 80 80 C4 */	lis r4, lit_3775@ha
/* 80C3AAD0  3B C4 C6 74 */	addi r30, r4, lit_3775@l
/* 80C3AAD4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80C3AAD8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80C3AADC  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80C3AAE0  7F A4 EB 78 */	mr r4, r29
/* 80C3AAE4  4B 3D FE 80 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C3AB44  4B 52 3B 10 */	b posMove__20daPy_boomerangMove_cFP4cXyzPsP10fopAc_ac_cs
...
/* 80C3AB58  4B 52 3D 24 */	b bgCheckAfterOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80C3AB74  4B 43 D0 F4 */	b __ct__11dBgS_LinChkFv
/* 80C3AB78  38 61 00 9C */	addi r3, r1, 0x9c
/* 80C3AB7C  4B 43 E2 EC */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C3AB90  4B 43 D1 D4 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C3AB94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C3AB98  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C3AB9C  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80C3ABA0  7F 83 E3 78 */	mr r3, r28
/* 80C3ABA4  38 81 00 44 */	addi r4, r1, 0x44
/* 80C3ABA8  4B 43 98 0C */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C3ABAC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C3ABB0  41 82 01 C0 */	beq lbl_80C3AD70
/* 80C3ABB4  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha
/* 80C3ABB8  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C3ABCC  4B 43 9B 78 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80C3AC38  4B 70 C7 64 */	b PSVECSquareDistance
...
/* 80C3ACA8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C3ACAC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80C3AD18  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80C3AD1C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80C3AD20  48 00 00 08 */	b lbl_80C3AD28
lbl_80C3AD24:
/* 80C3AD24  FC 40 08 90 */	fmr f2, f1
lbl_80C3AD28:
/* 80C3AD28  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 80C3AD2C  4B 62 C9 48 */	b cM_atan2s__Fff
...
/* 80C3AD44  4B 62 C9 30 */	b cM_atan2s__Fff
...
/* 80C3AD58  4B 62 C9 1C */	b cM_atan2s__Fff
/* 80C3AD5C  B0 7F 07 F6 */	sth r3, 0x7f6(r31)
/* 80C3AD60  3C 60 80 C4 */	lis r3, __vt__8cM3dGPla@ha
/* 80C3AD64  38 03 C8 08 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80C3ADAC  4B 43 CF 30 */	b __dt__11dBgS_LinChkFv
lbl_80C3ADB0:
/* 80C3ADB0  39 61 00 D0 */	addi r11, r1, 0xd0
/* 80C3ADB4  4B 72 74 70 */	b _restgpr_28

...
/* 80C3AE18  4B 44 97 30 */	b GetTgHitGObj__12dCcD_GObjInfFv
/* 80C3AE1C  38 7F 09 84 */	addi r3, r31, 0x984
/* 80C3AE20  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80C3AE24  4B 52 37 8C */	b initOffset__20daPy_boomerangMove_cFPC4cXyz
...
/* 80C3AE3C  3C 60 80 C4 */	lis r3, lit_3959@ha
/* 80C3AE40  C0 03 C6 CC */	lfs f0, lit_3959@l(r3)
/* 80C3AE44  D0 01 00 08 */	stfs f0, 8(r1)
/* 80C3AE48  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80C3AE4C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80C3AE50  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C3AE54  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C3AE58  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */

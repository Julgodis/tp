...
/* 80C3BAEC 00000014  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C3BAF0 00000018  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C3BAF4 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C3BAF8 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C3BAFC 00000024  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BB00 00000028  A0 04 00 00 */	lhz r0, 0x0000(r4)
/* 80C3BB04 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BB08 00000030  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BB0C 00000034  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BB10 00000038  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BB14 0000003C  4B FF DD C5 */	bl _unresolved
...
/* 80C3BB24 0000004C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BB28 00000050  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BB2C 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80C3BB30 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BB34 0000005C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BB38 00000060  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BB3C 00000064  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BB40 00000068  4B FF DD 99 */	bl _unresolved
...
lbl_80C3BB54:
/* 80C3BB54 00000000  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C3BB58 00000004  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C3BB5C 00000008  38 63 00 04 */	addi r3, r3, 4
/* 80C3BB60 0000000C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BB64 00000010  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BB68 00000014  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C3BB6C 00000018  4B FF DD 6D */	bl _unresolved
/* 80C3BB70 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80C3BB74 00000020  40 82 00 CC */	bne lbl_80C3BC40
/* 80C3BB78 00000024  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C3BB7C 00000028  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
...
/* 80C3BB90 0000003C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C3BB94 00000040  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C3BB98 00000044  7C 63 00 AE */	lbzx r3, r3, r0
/* 80C3BB9C 00000048  4B FF DD 3D */	bl _unresolved
...
/* 80C3BBBC 0000000C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C3BBC0 00000010  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C3BBC4 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C3BBC8 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C3BBCC 0000001C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BBD0 00000020  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BBD4 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C3BBD8 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BBDC 0000002C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BBE0 00000030  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BBE4 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BBE8 00000038  4B FF DC F1 */	bl _unresolved
...
/* 80C3BC00 0000000C  3C 60 00 00 */	lis r3, 0x0000 /* 0x00000000@ha */
/* 80C3BC04 00000010  38 63 00 00 */	addi r3, r3, 0x0000 /* 0x00000000@l */
/* 80C3BC08 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C3BC0C 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C3BC10 0000001C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BC14 00000020  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BC18 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C3BC1C 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BC20 0000002C  3C 80 00 00 */	lis r4, 0x0000 /* 0x00000000@ha */
/* 80C3BC24 00000030  38 84 00 00 */	addi r4, r4, 0x0000 /* 0x00000000@l */
/* 80C3BC28 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BC2C 00000038  4B FF DC AD */	bl _unresolved

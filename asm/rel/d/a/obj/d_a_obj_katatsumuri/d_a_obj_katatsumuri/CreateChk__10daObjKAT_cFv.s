...
/* 80C3BAEC 00000014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3BAF0 00000018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C3BAF4 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80C3BAF8 00000020  7F E3 FB 78 */	mr r3, r31
/* 80C3BAFC 00000024  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C3BB00 00000028  A0 04 C7 54 */	lhz r0, l_musiya_num@l(r4)
/* 80C3BB04 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BB08 00000030  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C3BB0C 00000034  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C3BB10 00000038  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BB14 0000003C  4B 3F 8E A8 */	b isEventBit__11dSv_event_cCFUs
...
/* 80C3BB24 0000004C  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C3BB28 00000050  38 84 C7 54 */	addi r4, r4, l_musiya_num@l
/* 80C3BB2C 00000054  A0 04 00 02 */	lhz r0, 2(r4)	/* effective address: 80C3C756 */
/* 80C3BB30 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BB34 0000005C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C3BB38 00000060  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C3BB3C 00000064  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BB40 00000068  4B 3F 8E 7C */	b isEventBit__11dSv_event_cCFUs
...
lbl_80C3BB54:
/* 80C3BB54 00000000  3C 60 80 C4 */	lis r3, stringBase0@ha
/* 80C3BB58 00000004  38 63 C7 64 */	addi r3, r3, stringBase0@l
/* 80C3BB5C 00000008  38 63 00 04 */	addi r3, r3, 4
/* 80C3BB60 0000000C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C3BB64 00000010  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80C3BB68 00000014  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80C3BB6C 00000018  4B 72 CE 28 */	b strcmp
/* 80C3BB70 0000001C  2C 03 00 00 */	cmpwi r3, 0
/* 80C3BB74 00000020  40 82 00 CC */	bne lbl_80C3BC40
/* 80C3BB78 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3BB7C 00000028  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C3BB80 0000002C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
/* 80C3BB84 00000030  2C 00 00 03 */	cmpwi r0, 3
/* 80C3BB88 00000034  40 82 00 B8 */	bne lbl_80C3BC40
/* 80C3BB8C 00000038  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80C3BB90 0000003C  3C 60 80 C4 */	lis r3, l_kat_itemno@ha
/* 80C3BB94 00000040  38 63 C6 78 */	addi r3, r3, l_kat_itemno@l
/* 80C3BB98 00000044  7C 63 00 AE */	lbzx r3, r3, r0
/* 80C3BB9C 00000048  4B 59 E3 A0 */	b isCatchNotGiveInsect__14dMenu_Insect_cFUc
...
lbl_80C3BBB0:
/* 80C3BBB0 00000000  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80C3BBB4 00000004  28 00 00 00 */	cmplwi r0, 0
/* 80C3BBB8 00000008  40 82 00 3C */	bne lbl_80C3BBF4
/* 80C3BBBC 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3BBC0 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C3BBC4 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C3BBC8 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C3BBCC 0000001C  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C3BBD0 00000020  38 84 C7 54 */	addi r4, r4, l_musiya_num@l
/* 80C3BBD4 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C3BBD8 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BBDC 0000002C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C3BBE0 00000030  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C3BBE4 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BBE8 00000038  4B 3F 8D D4 */	b isEventBit__11dSv_event_cCFUs
/* 80C3BBEC 0000003C  2C 03 00 00 */	cmpwi r3, 0
/* 80C3BBF0 00000040  41 82 00 48 */	beq lbl_80C3BC38
lbl_80C3BBF4:
/* 80C3BBF4 00000000  88 1F 05 81 */	lbz r0, 0x581(r31)	/* effective address: 80406F31 */
/* 80C3BBF8 00000004  28 00 00 01 */	cmplwi r0, 1
/* 80C3BBFC 00000008  40 82 00 44 */	bne lbl_80C3BC40
/* 80C3BC00 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3BC04 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80C3BC08 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80C3BC0C 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80C3BC10 0000001C  3C 80 80 C4 */	lis r4, l_musiya_num@ha
/* 80C3BC14 00000020  38 84 C7 54 */	addi r4, r4, l_musiya_num@l
/* 80C3BC18 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80C3BC1C 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80C3BC20 0000002C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80C3BC24 00000030  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80C3BC28 00000034  7C 84 02 2E */	lhzx r4, r4, r0
/* 80C3BC2C 00000038  4B 3F 8D 90 */	b isEventBit__11dSv_event_cCFUs

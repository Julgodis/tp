...
/* 80C3A9B8  3C 60 80 C4 */	lis r3, lit_4258@ha
/* 80C3A9BC  C8 23 C7 1C */	lfd f1, lit_4258@l(r3)
...
/* 80C3A9E0  3C 80 80 C4 */	lis r4, lit_3959@ha
/* 80C3A9E4  C0 24 C6 CC */	lfs f1, lit_3959@l(r4)
/* 80C3A9E8  3C 80 80 C4 */	lis r4, lit_3775@ha
/* 80C3A9EC  C0 44 C6 74 */	lfs f2, lit_3775@l(r4)
/* 80C3A9F0  FC 60 10 90 */	fmr f3, f2
/* 80C3A9F4  4B 63 50 48 */	b cLib_addCalc2__FPffff
/* 80C3A9F8  48 00 00 1C */	b lbl_80C3AA14
lbl_80C3A9FC:
/* 80C3A9FC  38 7F 08 0C */	addi r3, r31, 0x80c
/* 80C3AA00  3C 80 80 C4 */	lis r4, lit_3775@ha
/* 80C3AA04  C0 24 C6 74 */	lfs f1, lit_3775@l(r4)
/* 80C3AA08  FC 40 08 90 */	fmr f2, f1
/* 80C3AA0C  FC 60 08 90 */	fmr f3, f1
/* 80C3AA10  4B 63 50 2C */	b cLib_addCalc2__FPffff
lbl_80C3AA14:
/* 80C3AA14  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C3AA18  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80C3AA1C  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80C3AA60  3D 60 80 C4 */	lis r11, lit_3775@ha
/* 80C3AA64  C0 2B C6 74 */	lfs f1, lit_3775@l(r11)
/* 80C3AA68  4B 41 2A 64 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C3AA80  4B 41 0E 98 */	b getEmitter__Q213dPa_control_c7level_cFUl

...
/* 80C39A88 00000030  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C39A8C 00000034  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C39A9C 00000044  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C39AA0 00000048  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C39AA4 0000004C  3C 80 00 00 */	lis r4, lit_3812@ha /* 80C3C6C0 */
/* 80C39AA8 00000050  C0 44 00 00 */	lfs f2, lit_3812@l(r4) /* 80C3C6C0 */
/* 80C39AAC 00000054  A8 1C 07 F2 */	lha r0, 0x7f2(r28)
/* 80C39AB0 00000058  3C 80 00 00 */	lis r4, lit_3814@ha /* 80C3C6C4 */
/* 80C39AB4 0000005C  C8 24 00 00 */	lfd f1, lit_3814@l(r4) /* 80C3C6C4 */
...
lbl_80C39AE4:
/* 80C39AE4 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C39AE8 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80C39AFC 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80C39B00 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80C39B04 00000020  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 80C39B08 00000024  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */

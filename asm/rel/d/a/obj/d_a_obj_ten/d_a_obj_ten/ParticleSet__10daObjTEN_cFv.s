...
/* 80D0A17C  3C 60 80 D1 */	lis r3, lit_4458@ha
/* 80D0A180  C8 23 B9 B0 */	lfd f1, lit_4458@l(r3)
...
/* 80D0A1A4  3C 80 80 D1 */	lis r4, lit_3939@ha
/* 80D0A1A8  C0 24 B9 3C */	lfs f1, lit_3939@l(r4)
/* 80D0A1AC  3C 80 80 D1 */	lis r4, lit_3775@ha
/* 80D0A1B0  C0 44 B8 F0 */	lfs f2, lit_3775@l(r4)
/* 80D0A1B4  FC 60 10 90 */	fmr f3, f2
/* 80D0A1B8  4B 56 58 84 */	b cLib_addCalc2__FPffff
/* 80D0A1BC  48 00 00 1C */	b lbl_80D0A1D8
lbl_80D0A1C0:
/* 80D0A1C0  38 7F 06 20 */	addi r3, r31, 0x620
/* 80D0A1C4  3C 80 80 D1 */	lis r4, lit_3775@ha
/* 80D0A1C8  C0 24 B8 F0 */	lfs f1, lit_3775@l(r4)
/* 80D0A1CC  FC 40 08 90 */	fmr f2, f1
/* 80D0A1D0  FC 60 08 90 */	fmr f3, f1
/* 80D0A1D4  4B 56 58 68 */	b cLib_addCalc2__FPffff
lbl_80D0A1D8:
/* 80D0A1D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D0A1DC  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80D0A1E0  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 80D0A224  3D 60 80 D1 */	lis r11, lit_3775@ha
/* 80D0A228  C0 2B B8 F0 */	lfs f1, lit_3775@l(r11)
/* 80D0A22C  4B 34 32 A0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80D0A244  4B 34 16 D4 */	b getEmitter__Q213dPa_control_c7level_cFUl

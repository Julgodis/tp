...
/* 80D0ADDC 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D0ADE0 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D0ADE4 0000001C  3B E3 07 F0 */	addi r31, r3, 0x7f0
/* 80D0ADE8 00000020  7F E3 FB 78 */	mr r3, r31
/* 80D0ADEC 00000024  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D0B9D0 */
/* 80D0ADF0 00000028  A0 04 00 00 */	lhz r0, l_musiya_num@l(r4) /* 80D0B9D0 */
/* 80D0ADF4 0000002C  54 00 08 3C */	slwi r0, r0, 1
/* 80D0ADF8 00000030  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D0ADFC 00000034  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80D0AE14 0000004C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D0B9D0 */
/* 80D0AE18 00000050  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80D0B9D0 */
/* 80D0AE1C 00000054  A0 04 00 02 */	lhz r0, 2(r4)
/* 80D0AE20 00000058  54 00 08 3C */	slwi r0, r0, 1
/* 80D0AE24 0000005C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D0AE28 00000060  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
lbl_80D0AE44:
/* 80D0AE44 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 80D0B9E4 */
/* 80D0AE48 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80D0B9E4 */
/* 80D0AE4C 00000008  38 63 00 06 */	addi r3, r3, 6
/* 80D0AE50 0000000C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D0AE54 00000010  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80D0AE68 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D0AE6C 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80D0AE80 0000003C  3C 60 00 00 */	lis r3, l_ten_itemno@ha /* 80D0B8F4 */
/* 80D0AE84 00000040  38 63 00 00 */	addi r3, r3, l_ten_itemno@l /* 80D0B8F4 */
...
/* 80D0AEAC 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D0AEB0 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D0AEB4 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D0AEB8 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80D0AEBC 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D0B9D0 */
/* 80D0AEC0 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80D0B9D0 */
/* 80D0AEC4 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80D0AEC8 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80D0AECC 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D0AED0 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
...
/* 80D0AEF0 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D0AEF4 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D0AEF8 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D0AEFC 00000018  54 00 0D FC */	rlwinm r0, r0, 1, 0x17, 0x1e
/* 80D0AF00 0000001C  3C 80 00 00 */	lis r4, l_musiya_num@ha /* 80D0B9D0 */
/* 80D0AF04 00000020  38 84 00 00 */	addi r4, r4, l_musiya_num@l /* 80D0B9D0 */
/* 80D0AF08 00000024  7C 04 02 2E */	lhzx r0, r4, r0
/* 80D0AF0C 00000028  54 00 08 3C */	slwi r0, r0, 1
/* 80D0AF10 0000002C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D0AF14 00000030  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */

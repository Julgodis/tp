...
/* 80C3DFC4  4B 72 42 18 */	b _savegpr_29
/* 80C3DFC8  7C 7E 1B 78 */	mr r30, r3
/* 80C3DFCC  3C 60 80 C4 */	lis r3, lit_3648@ha
/* 80C3DFD0  3B E3 F0 58 */	addi r31, r3, lit_3648@l
/* 80C3DFD4  38 7E 04 FC */	addi r3, r30, 0x4fc
/* 80C3DFD8  C0 3F 00 18 */	lfs f1, 0x18(r31)	/* effective address: 80C3F070 */
/* 80C3DFDC  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 80C3F0AC */
/* 80C3DFE0  4B 63 1A A0 */	b cLib_addCalc0__FPfff
/* 80C3DFE4  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80C3DFE8  38 9E 04 F8 */	addi r4, r30, 0x4f8
/* 80C3DFEC  7C 65 1B 78 */	mr r5, r3
/* 80C3DFF0  4B 70 90 A0 */	b PSVECAdd
...
/* 80C3E0C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C3E0C4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80C3E0C8  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80C3E114  4B 40 F3 B8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80C3E134  4B 3D BB 48 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 80C3E17C  4B 40 E9 14 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_80C3E180:
...
/* 80C3E1A8  4B 3D EF 64 */	b fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_80C3E1AC:
/* 80C3E1AC  A8 1E 05 78 */	lha r0, 0x578(r30)
/* 80C3E1B0  1C 00 03 84 */	mulli r0, r0, 0x384
/* 80C3E1B4  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C3E1B8  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C3E1BC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C3E1F0  4B 63 18 4C */	b cLib_addCalc2__FPffff
/* 80C3E1F4  A8 1E 05 78 */	lha r0, 0x578(r30)
/* 80C3E1F8  1C 00 03 E8 */	mulli r0, r0, 0x3e8
/* 80C3E1FC  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C3E200  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C3E204  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C3E25C  4B 63 17 E0 */	b cLib_addCalc2__FPffff
/* 80C3E260  A8 1E 05 78 */	lha r0, 0x578(r30)
/* 80C3E264  1C 00 0F A0 */	mulli r0, r0, 0xfa0
/* 80C3E268  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C3E26C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C3E270  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80C3E2D8  4B 63 17 64 */	b cLib_addCalc2__FPffff
...
/* 80C3E2F4  4B 63 17 48 */	b cLib_addCalc2__FPffff

...
/* 80C3D77C 00000030  3C 60 00 00 */	lis r3, lit_3704@ha
/* 80C3D780 00000034  C0 03 00 00 */	lfs f0, lit_3704@l(r3)
...
/* 80C3D790 00000044  3C 60 00 00 */	lis r3, stringBase0@ha
/* 80C3D794 00000048  38 63 00 00 */	addi r3, r3, stringBase0@l
/* 80C3D798 0000004C  38 83 00 07 */	addi r4, r3, 7
/* 80C3D79C 00000050  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80C3D7A0 00000054  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80C3D7C0 00000074  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C3D7C4 00000078  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80C3D7C8 0000007C  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)
/* 80C3D7CC 00000080  3C 80 00 00 */	lis r4, mEcallback__18dPa_modelEcallBack@ha
/* 80C3D7D0 00000084  38 04 00 00 */	addi r0, r4, mEcallback__18dPa_modelEcallBack@l
...
/* 80C3D810 000000C4  3D 60 00 00 */	lis r11, lit_3704@ha
/* 80C3D814 000000C8  C0 2B 00 00 */	lfs f1, lit_3704@l(r11)
...
/* 80C3D840 000000F4  3C 60 00 00 */	lis r3, data_80C3F06C@ha
/* 80C3D844 000000F8  3B 83 00 00 */	addi r28, r3, data_80C3F06C@l
/* 80C3D848 000000FC  3C 60 00 00 */	lis r3, lit_3704@ha
/* 80C3D84C 00000100  3B A3 00 00 */	addi r29, r3, lit_3704@l
lbl_80C3D850:

...
/* 80C3DBFC  4B 72 45 D4 */	b _savegpr_26
/* 80C3DC00  7C 7B 1B 78 */	mr r27, r3
/* 80C3DC04  38 61 00 C8 */	addi r3, r1, 0xc8
/* 80C3DC08  4B 43 A0 60 */	b __ct__11dBgS_LinChkFv
/* 80C3DC0C  C0 1B 04 D0 */	lfs f0, 0x4d0(r27)
/* 80C3DC10  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 80C3DC14  3C 60 80 C4 */	lis r3, lit_3829@ha
/* 80C3DC18  C0 23 F0 90 */	lfs f1, lit_3829@l(r3)
...
/* 80C3DC40  4B 43 A1 24 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80C3DC44  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C3DC48  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C3DC4C  3B E3 0F 38 */	addi r31, r3, 0xf38
/* 80C3DC50  7F E3 FB 78 */	mr r3, r31
/* 80C3DC54  38 81 00 C8 */	addi r4, r1, 0xc8
/* 80C3DC58  4B 43 67 5C */	b LineCross__4cBgSFP11cBgS_LinChk
/* 80C3DC5C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80C3DC60  41 82 00 18 */	beq lbl_80C3DC78
/* 80C3DC64  C0 21 00 FC */	lfs f1, 0xfc(r1)
/* 80C3DC68  3C 60 80 C4 */	lis r3, lit_3794@ha
/* 80C3DC6C  C0 03 F0 80 */	lfs f0, lit_3794@l(r3)
/* 80C3DC70  EC 01 00 28 */	fsubs f0, f1, f0
/* 80C3DC74  D0 01 00 18 */	stfs f0, 0x18(r1)
lbl_80C3DC78:
/* 80C3DC78  38 61 00 74 */	addi r3, r1, 0x74
/* 80C3DC7C  4B 43 9B 34 */	b __ct__18dBgS_ObjGndChk_SplFv
/* 80C3DC80  3B 41 00 20 */	addi r26, r1, 0x20
/* 80C3DC84  7F 43 D3 78 */	mr r3, r26
/* 80C3DC88  4B 43 98 F4 */	b __ct__11dBgS_GndChkFv
/* 80C3DC8C  3C 60 80 C4 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 80C3DC90  38 63 F2 00 */	addi r3, r3, __vt__14dBgS_ObjGndChk@l
...
/* 80C3DCB4  4B 43 B1 B4 */	b SetObj__16dBgS_PolyPassChkFv
...
/* 80C3DD20  3C 60 80 C4 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 80C3DD24  38 03 F2 00 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l
...
/* 80C3DD40  4B 43 98 B0 */	b __dt__11dBgS_GndChkFv
/* 80C3DD44  38 61 00 74 */	addi r3, r1, 0x74
/* 80C3DD48  38 80 FF FF */	li r4, -1
/* 80C3DD4C  4B 43 9A FC */	b __dt__18dBgS_ObjGndChk_SplFv
/* 80C3DD50  38 61 00 C8 */	addi r3, r1, 0xc8
/* 80C3DD54  38 80 FF FF */	li r4, -1
/* 80C3DD58  4B 43 9F 84 */	b __dt__11dBgS_LinChkFv
/* 80C3DD5C  38 60 00 01 */	li r3, 1
/* 80C3DD60  48 00 00 44 */	b lbl_80C3DDA4
lbl_80C3DD64:
/* 80C3DD64  3C 60 80 C4 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 80C3DD68  38 03 F2 00 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l
...
/* 80C3DD84  4B 43 98 6C */	b __dt__11dBgS_GndChkFv
/* 80C3DD88  38 61 00 74 */	addi r3, r1, 0x74
/* 80C3DD8C  38 80 FF FF */	li r4, -1
/* 80C3DD90  4B 43 9A B8 */	b __dt__18dBgS_ObjGndChk_SplFv
/* 80C3DD94  38 61 00 C8 */	addi r3, r1, 0xc8
/* 80C3DD98  38 80 FF FF */	li r4, -1
/* 80C3DD9C  4B 43 9F 40 */	b __dt__11dBgS_LinChkFv
...
/* 80C3DDB0  4B 72 44 6C */	b _restgpr_26

...
/* 80CF9540  4B 66 8C 8C */	b _savegpr_25
/* 80CF9544  7C 79 1B 78 */	mr r25, r3
/* 80CF9548  3C 60 80 D0 */	lis r3, lit_3734@ha
/* 80CF954C  3B E3 B6 EC */	addi r31, r3, lit_3734@l
/* 80CF9550  83 59 0A 74 */	lwz r26, 0xa74(r25)
/* 80CF9554  3B 7A 00 34 */	addi r27, r26, 0x34
/* 80CF9558  C3 5F 00 3C */	lfs f26, 0x3c(r31)	/* effective address: 80CFB728 */
/* 80CF955C  88 19 0A 62 */	lbz r0, 0xa62(r25)
/* 80CF9560  28 00 00 00 */	cmplwi r0, 0
/* 80CF9564  41 82 00 60 */	beq lbl_80CF95C4
/* 80CF9568  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80CF956C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80CF9570  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80CF9574  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80CF95D8  4B 57 63 A4 */	b cLib_addCalc__FPfffff
...
/* 80CF9600  3C 60 80 3F */	lis r3, mGndCheck__11fopAcM_gc_c@ha
/* 80CF9604  38 63 1C C4 */	addi r3, r3, mGndCheck__11fopAcM_gc_c@l
...
/* 80CF966C  4B 32 46 50 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
...
/* 80CF9690  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80CF9694  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80CF9770  4B 56 D3 C4 */	b __mi__4cXyzCFRC3Vec
...
/* 80CF9790  4B 64 D9 A8 */	b PSVECSquareMag
...
/* 80CF97FC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CF9800  C3 43 0A E0 */	lfs f26, __float_nan@l(r3)
...
/* 80CF986C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80CF9870  C3 43 0A E0 */	lfs f26, __float_nan@l(r3)
...
/* 80CF9884  4B 56 D6 C4 */	b normalizeZP__4cXyzFv
...
/* 80CF98BC  4B 56 D2 C8 */	b __ml__4cXyzCFf
...
/* 80CF98F4  4B 56 D1 F0 */	b __pl__4cXyzCFRC3Vec
...
/* 80CF99AC  4B 66 88 6C */	b _restgpr_25

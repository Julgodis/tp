...
/* 80C9EE38  4B 6C 33 A4 */	b _savegpr_29
/* 80C9EE3C  7C 7E 1B 78 */	mr r30, r3
/* 80C9EE40  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9EE44  38 63 F2 A0 */	addi r3, r3, stringBase0@l
/* 80C9EE48  38 80 00 06 */	li r4, 6
/* 80C9EE4C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C9EE50  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C9EE64  4B 39 D4 88 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9EE74  4B 37 5D E0 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C9EE94  4B 62 FD B8 */	b __nw__FUl
/* 80C9EE98  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C9EE9C  41 82 00 20 */	beq lbl_80C9EEBC
/* 80C9EEA0  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9EEA4  38 04 F2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C9EEA8  90 1D 00 00 */	stw r0, 0(r29)
/* 80C9EEAC  38 80 00 00 */	li r4, 0
/* 80C9EEB0  4B 68 95 4C */	b init__12J3DFrameCtrlFs
...
lbl_80C9EED4:
/* 80C9EED4  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9EED8  38 63 F2 A0 */	addi r3, r3, stringBase0@l
/* 80C9EEDC  38 80 00 09 */	li r4, 9
/* 80C9EEE0  7F E5 FB 78 */	mr r5, r31
/* 80C9EEE4  38 C0 00 80 */	li r6, 0x80
/* 80C9EEE8  4B 39 D4 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9EF08  3D 00 80 CA */	lis r8, lit_3762@ha
/* 80C9EF0C  C0 28 F2 88 */	lfs f1, lit_3762@l(r8)
/* 80C9EF10  39 00 00 00 */	li r8, 0
/* 80C9EF14  39 20 FF FF */	li r9, -1
/* 80C9EF18  4B 36 E7 F4 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 80C9EF30  4B 62 FD 1C */	b __nw__FUl
/* 80C9EF34  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C9EF38  41 82 00 20 */	beq lbl_80C9EF58
/* 80C9EF3C  3C 80 80 CA */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9EF40  38 04 F2 F8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C9EF44  90 1D 00 00 */	stw r0, 0(r29)
/* 80C9EF48  38 80 00 00 */	li r4, 0
/* 80C9EF4C  4B 68 94 B0 */	b init__12J3DFrameCtrlFs
...
lbl_80C9EF70:
/* 80C9EF70  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9EF74  38 63 F2 A0 */	addi r3, r3, stringBase0@l
/* 80C9EF78  38 80 00 0C */	li r4, 0xc
/* 80C9EF7C  7F E5 FB 78 */	mr r5, r31
/* 80C9EF80  38 C0 00 80 */	li r6, 0x80
/* 80C9EF84  4B 39 D3 68 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9EFA4  3D 00 80 CA */	lis r8, lit_3762@ha
/* 80C9EFA8  C0 28 F2 88 */	lfs f1, lit_3762@l(r8)
/* 80C9EFAC  39 00 00 00 */	li r8, 0
/* 80C9EFB0  39 20 FF FF */	li r9, -1
/* 80C9EFB4  4B 36 E6 88 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80C9EFF8:
/* 80C9EFF8  3C 60 80 CA */	lis r3, stringBase0@ha
/* 80C9EFFC  38 63 F2 A0 */	addi r3, r3, stringBase0@l
/* 80C9F000  38 80 00 0F */	li r4, 0xf
/* 80C9F004  7F E5 FB 78 */	mr r5, r31
/* 80C9F008  38 C0 00 80 */	li r6, 0x80
/* 80C9F00C  4B 39 D2 E0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9F020  4B 3D AF 18 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80C9F038:
/* 80C9F038  3C 60 80 07 */	lis r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@ha
/* 80C9F03C  38 03 5A 24 */	addi r0, r3, dBgS_MoveBGProc_Typical__FP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz@l
...
/* 80C9F050  4B 6C 31 D8 */	b _restgpr_29

...
/* 80C9ECA8 00000008  3C 80 00 00 */	lis r4, l_HIO@ha
/* 80C9ECAC 0000000C  38 84 00 00 */	addi r4, r4, l_HIO@l
/* 80C9ECB0 00000010  C0 04 00 0C */	lfs f0, 0xc(r4)
/* 80C9ECB4 00000014  EC 21 00 2A */	fadds f1, f1, f0
/* 80C9ECB8 00000018  3C 80 00 00 */	lis r4, lit_3823@ha
/* 80C9ECBC 0000001C  C0 44 00 00 */	lfs f2, lit_3823@l(r4)
/* 80C9ECC0 00000020  3C 80 00 00 */	lis r4, lit_3824@ha
/* 80C9ECC4 00000024  C0 64 00 00 */	lfs f3, lit_3824@l(r4)
/* 80C9ECC8 00000028  4B FF FE 51 */	bl cLib_addCalc2__FPffff
lbl_80C9ECCC:
/* 80C9ECCC 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ECD0 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C9ECE4 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ECE8 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9ECEC 00000020  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80C9ECF0 00000024  4B FF FE 29 */	bl mDoMtx_YrotM__FPA4_fs
/* 80C9ECF4 00000028  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80C9ECF8 0000002C  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 80C9ED0C 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ED10 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C9ED20 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ED24 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

...
/* 80C9ECC0  3C 80 80 CA */	lis r4, lit_3824@ha
/* 80C9ECC4  C0 64 F2 94 */	lfs f3, lit_3824@l(r4)
/* 80C9ECC8  4B 5D 0D 74 */	b cLib_addCalc2__FPffff
lbl_80C9ECCC:
/* 80C9ECCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ECD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9ECD4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C9ECD8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C9ECDC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C9ECE0  4B 6A 7C 08 */	b PSMTXTrans
/* 80C9ECE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ECE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80C9ED0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ED10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9ED14  80 9F 05 70 */	lwz r4, 0x570(r31)
/* 80C9ED18  38 84 00 24 */	addi r4, r4, 0x24
/* 80C9ED1C  4B 6A 77 94 */	b PSMTXCopy
/* 80C9ED20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C9ED24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C9ED28  38 9F 05 8C */	addi r4, r31, 0x58c
/* 80C9ED2C  4B 6A 77 84 */	b PSMTXCopy
/* 80C9ED30  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 80C9ED34  4B 3D CC 8C */	b Move__4dBgWFv
/* 80C9ED38  80 7F 05 78 */	lwz r3, 0x578(r31)
/* 80C9ED3C  4B 36 E6 EC */	b play__14mDoExt_baseAnmFv
/* 80C9ED40  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80C9ED44  4B 36 E6 E4 */	b play__14mDoExt_baseAnmFv

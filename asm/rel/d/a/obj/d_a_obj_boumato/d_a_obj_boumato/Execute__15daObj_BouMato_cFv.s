...
/* 80BBB844  4B 7A 69 88 */	b _savegpr_25
/* 80BBB848  7C 7F 1B 78 */	mr r31, r3
/* 80BBB84C  3C 60 80 BC */	lis r3, m__21daObj_BouMato_Param_c@ha
/* 80BBB850  3B C3 C4 70 */	addi r30, r3, m__21daObj_BouMato_Param_c@l
/* 80BBB854  38 7F 07 6C */	addi r3, r31, 0x76c
/* 80BBB858  4B 4C 7F D8 */	b Move__10dCcD_GSttsFv
...
lbl_80BBB8F4:
/* 80BBB8F4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BBB8F8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BBB8FC  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80BBB900  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80BBB950  3C 80 80 BC */	lis r4, struct_80BBC518+0x0@ha
/* 80BBB954  38 84 C5 18 */	addi r4, r4, struct_80BBC518+0x0@l
/* 80BBB958  38 84 00 0B */	addi r4, r4, 0xb
/* 80BBB95C  7F E5 FB 78 */	mr r5, r31
/* 80BBB960  38 C0 FF FF */	li r6, -1
/* 80BBB964  4B 48 C1 B8 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80BBB978  4B 48 C8 04 */	b cutEnd__16dEvent_manager_cFi
lbl_80BBB97C:
...
/* 80BBB9C4  4B 4C 7C C4 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 80BBB9F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BBB9F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BBB9F8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80BBB9FC  7C 05 07 74 */	extsb r5, r0
/* 80BBBA00  4B 47 99 60 */	b isSwitch__10dSv_info_cCFii
/* 80BBBA04  2C 03 00 00 */	cmpwi r3, 0
/* 80BBBA08  40 82 00 20 */	bne lbl_80BBBA28
/* 80BBBA0C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BBBA10  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BBBA24  4B 47 97 DC */	b onSwitch__10dSv_info_cFii
lbl_80BBBA28:
/* 80BBBA28  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80BBBA2C  7C 03 07 74 */	extsb r3, r0
/* 80BBBA30  4B 47 16 3C */	b dComIfGp_getReverb__Fi
...
/* 80BBBA44  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BBBA48  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BBBA4C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BBBA70  4B 6E FF 14 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80BBBA74:
/* 80BBBA74  38 7F 08 A4 */	addi r3, r31, 0x8a4
/* 80BBBA78  4B 4C 7C 10 */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 80BBBA90  4B 45 EC 3C */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 80BBBA94  38 7F 05 78 */	addi r3, r31, 0x578
/* 80BBBA98  7F A4 EB 78 */	mr r4, r29
/* 80BBBA9C  4B 4B B0 10 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80BBBB54  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBBB58  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBBB5C  3B B9 0A 24 */	addi r29, r25, 0xa24
/* 80BBBB60  7C 9F EA AE */	lhax r4, r31, r29
/* 80BBBB64  4B 45 08 78 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80BBBB80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBBB84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBBB88  38 81 00 18 */	addi r4, r1, 0x18
/* 80BBBB8C  38 A1 00 0C */	addi r5, r1, 0xc
/* 80BBBB90  4B 78 B1 DC */	b PSMTXMultVec
...
lbl_80BBBBD4:
/* 80BBBBD4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBBBD8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBBBDC  A8 9F 0A 2A */	lha r4, 0xa2a(r31)
/* 80BBBBE0  4B 45 07 FC */	b mDoMtx_YrotS__FPA4_fs
/* 80BBBBE4  3B B9 0A 24 */	addi r29, r25, 0xa24
/* 80BBBBE8  7C 1F EA AE */	lhax r0, r31, r29
/* 80BBBBEC  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80BBBBF0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80BBBBF4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80BBBC18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BBBC1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BBBC20  38 81 00 18 */	addi r4, r1, 0x18
/* 80BBBC24  38 A1 00 0C */	addi r5, r1, 0xc
/* 80BBBC28  4B 78 B1 44 */	b PSMTXMultVec
...
/* 80BBBC90  4B 6B 3D AC */	b cLib_addCalc2__FPffff
...
/* 80BBBCA4  4B 6B 3D 98 */	b cLib_addCalc2__FPffff
...
/* 80BBBCB8  4B 6B 3D 84 */	b cLib_addCalc2__FPffff
...
/* 80BBBD6C  4B 7A 64 AC */	b _restgpr_25

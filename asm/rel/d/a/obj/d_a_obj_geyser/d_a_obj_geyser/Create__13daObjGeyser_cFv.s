...
/* 80BF6FD4  4B 48 C8 8C */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80BF6FD8  38 7F 05 E8 */	addi r3, r31, 0x5e8
/* 80BF6FDC  3C 80 80 C0 */	lis r4, l_cps_src@ha
/* 80BF6FE0  38 84 90 A4 */	addi r4, r4, l_cps_src@l
/* 80BF6FE4  4B 48 D7 EC */	b Set__8dCcD_CpsFRC11dCcD_SrcCps
/* 80BF6FE8  38 1F 05 AC */	addi r0, r31, 0x5ac
/* 80BF6FEC  90 1F 06 2C */	stw r0, 0x62c(r31)
/* 80BF6FF0  3C 60 80 C0 */	lis r3, l_cull_box@ha
/* 80BF6FF4  38 83 90 8C */	addi r4, r3, l_cull_box@l
/* 80BF6FF8  C0 04 00 10 */	lfs f0, 0x10(r4)	/* effective address: 80BF909C */
...
/* 80BF700C  C0 04 00 00 */	lfs f0, 0(r4)	/* effective address: 80BF908C */
/* 80BF7010  EC 20 01 32 */	fmuls f1, f0, f4
/* 80BF7014  C0 04 00 04 */	lfs f0, 4(r4)	/* effective address: 80BF9090 */
/* 80BF7018  EC 40 00 B2 */	fmuls f2, f0, f2
/* 80BF701C  C0 04 00 08 */	lfs f0, 8(r4)	/* effective address: 80BF9094 */
/* 80BF7020  EC 60 01 32 */	fmuls f3, f0, f4
/* 80BF7024  C0 04 00 0C */	lfs f0, 0xc(r4)	/* effective address: 80BF9098 */
/* 80BF7028  EC 80 01 32 */	fmuls f4, f0, f4
/* 80BF702C  FC C0 28 90 */	fmr f6, f5
/* 80BF7030  4B 42 35 18 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80BF7078  4B 41 5C EC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BF707C  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80BF7080  4B 41 5E C4 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80BF7084  C0 3F 04 EC */	lfs f1, 0x4ec(r31)
/* 80BF7088  C0 5F 04 F0 */	lfs f2, 0x4f0(r31)
/* 80BF708C  FC 60 08 90 */	fmr f3, f1
/* 80BF7090  4B 41 5D A8 */	b scaleM__14mDoMtx_stack_cFfff
/* 80BF7094  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF7098  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF709C  80 9F 05 A8 */	lwz r4, 0x5a8(r31)
/* 80BF70A0  38 84 00 24 */	addi r4, r4, 0x24
/* 80BF70A4  4B 74 F4 0C */	b PSMTXCopy
/* 80BF70A8  80 7F 05 68 */	lwz r3, 0x568(r31)
/* 80BF70AC  28 03 00 00 */	cmplwi r3, 0
/* 80BF70B0  41 82 00 18 */	beq lbl_80BF70C8
/* 80BF70B4  4B 48 49 0C */	b Move__4dBgWFv

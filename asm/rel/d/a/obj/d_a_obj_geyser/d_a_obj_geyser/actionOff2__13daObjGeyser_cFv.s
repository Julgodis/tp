...
/* 80BF75D4 00000010  4B 76 AC 08 */	b _savegpr_29
/* 80BF75D8 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80BF75DC 00000018  3C 80 80 C0 */	lis r4, l_dzb@ha
/* 80BF75E0 0000001C  3B E4 8F E8 */	addi r31, r4, l_dzb@l
/* 80BF75E4 00000020  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80BF75E8 00000024  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80BF75EC 00000028  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 80BF7600 0000003C  4B 42 31 E0 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80BF7604 00000040  C0 1F 00 34 */	lfs f0, 0x34(r31)	/* effective address: 80BF901C */
...
lbl_80BF761C:
/* 80BF761C 00000000  C0 3F 00 24 */	lfs f1, 0x24(r31)	/* effective address: 80BF900C */
/* 80BF7620 00000004  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 80BF7624 00000008  D0 21 00 2C */	stfs f1, 0x2c(r1)
/* 80BF7628 0000000C  C0 1F 00 38 */	lfs f0, 0x38(r31)	/* effective address: 80BF9020 */
...
/* 80BF7638 0000001C  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 80BF9024 */
/* 80BF763C 00000020  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80BF7640 00000024  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 80BF7644 00000028  4B 41 57 20 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BF7648 0000002C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF764C 00000030  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF7650 00000034  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80BF7654 00000038  4B 41 4D E0 */	b mDoMtx_YrotM__FPA4_fs
/* 80BF7658 0000003C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF765C 00000040  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF7660 00000044  38 81 00 1C */	addi r4, r1, 0x1c
/* 80BF7664 00000048  7C 85 23 78 */	mr r5, r4
/* 80BF7668 0000004C  4B 74 F7 04 */	b PSMTXMultVec
/* 80BF766C 00000050  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BF7670 00000054  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BF7674 00000058  38 81 00 28 */	addi r4, r1, 0x28
/* 80BF7678 0000005C  7C 85 23 78 */	mr r5, r4
/* 80BF767C 00000060  4B 74 F6 F0 */	b PSMTXMultVec
/* 80BF7680 00000064  3C 60 80 C0 */	lis r3, __vt__8cM3dGLin@ha
/* 80BF7684 00000068  38 03 92 0C */	addi r0, r3, __vt__8cM3dGLin@l
...
/* 80BF7698 0000007C  4B 67 7C 50 */	b SetStartEnd__8cM3dGLinFRC4cXyzRC4cXyz
...
/* 80BF76AC 00000090  4B 67 10 64 */	b cM3d_Len3dSqPntAndSegLine__FPC8cM3dGLinPC3VecP3VecPf
...
/* 80BF76BC 000000A0  C0 1F 00 24 */	lfs f0, 0x24(r31)	/* effective address: 80BF900C */
...
/* 80BF76CC 00000008  C8 7F 00 40 */	lfd f3, 0x40(r31)	/* effective address: 80BF9028 */
/* 80BF76D0 0000000C  FC 23 00 32 */	fmul f1, f3, f0
/* 80BF76D4 00000010  C8 5F 00 48 */	lfd f2, 0x48(r31)	/* effective address: 80BF9030 */
...
lbl_80BF771C:
/* 80BF771C 00000000  C8 1F 00 50 */	lfd f0, 0x50(r31)	/* effective address: 80BF9038 */
/* 80BF7720 00000004  FC 04 00 40 */	fcmpo cr0, f4, f0
/* 80BF7724 00000000  40 80 00 10 */	bge lbl_80BF7734
/* 80BF7728 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BF772C 00000008  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)
...
/* 80BF7798 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80BF779C 0000000C  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)
lbl_80BF77A0:
/* 80BF77A0 00000000  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 80BF9024 */
...
lbl_80BF77B4:
/* 80BF77B4 00000000  3C 60 80 C0 */	lis r3, __vt__8cM3dGLin@ha
/* 80BF77B8 00000004  38 03 92 0C */	addi r0, r3, __vt__8cM3dGLin@l
/* 80BF77BC 00000008  90 01 00 4C */	stw r0, 0x4c(r1)
lbl_80BF77C0:
/* 80BF77C0 00000000  38 7E 07 30 */	addi r3, r30, 0x730
/* 80BF77C4 00000004  C0 3F 00 24 */	lfs f1, 0x24(r31)	/* effective address: 80BF900C */
/* 80BF77C8 00000008  C0 5F 00 58 */	lfs f2, 0x58(r31)	/* effective address: 80BF9040 */
/* 80BF77CC 0000000C  C0 1E 04 F0 */	lfs f0, 0x4f0(r30)
/* 80BF77D0 00000010  EC 42 00 32 */	fmuls f2, f2, f0
/* 80BF77D4 00000014  4B 67 8F 6C */	b cLib_chaseF__FPfff
/* 80BF77D8 00000018  39 61 00 60 */	addi r11, r1, 0x60
/* 80BF77DC 0000001C  4B 76 AA 4C */	b _restgpr_29

...
/* 8047B334  4B EE 6E A8 */	b _savegpr_29
/* 8047B338  7C 7E 1B 78 */	mr r30, r3
/* 8047B33C  3C 60 80 48 */	lis r3, lit_3770@ha
/* 8047B340  3B E3 D8 10 */	addi r31, r3, lit_3770@l
...
lbl_8047B358:
/* 8047B358  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8047B35C  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
lbl_8047B398:
/* 8047B398  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8047B39C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8047B3A0  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 8047B3A4  80 84 00 04 */	lwz r4, 4(r4)
/* 8047B3A8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8047B3AC  4B D2 99 F4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8047B3B0  80 7E 05 74 */	lwz r3, 0x574(r30)
/* 8047B3B4  4B B9 29 10 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 8047B3B8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8047B3BC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8047B3C0  80 9E 05 78 */	lwz r4, 0x578(r30)
/* 8047B3C4  80 84 00 04 */	lwz r4, 4(r4)
/* 8047B3C8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8047B3CC  4B D2 99 D4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8047B3D0  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 8047B3D4  4B B9 28 F0 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_8047B3D8:
...
lbl_8047B3F8:
/* 8047B3F8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8047B3FC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8047B400  38 80 00 00 */	li r4, 0
/* 8047B404  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 8047B408  38 DE 01 0C */	addi r6, r30, 0x10c
/* 8047B40C  4B D2 83 B8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
...
/* 8047B438  4B B9 7A 04 */	b update__19mDoExt_3DlineMat0_cFiR8_GXColorP12dKy_tevstr_c
...
/* 8047B470  4B B9 92 C8 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
...
/* 8047B4B8  4B B9 79 84 */	b update__19mDoExt_3DlineMat0_cFiR8_GXColorP12dKy_tevstr_c
...
/* 8047B4E4  4B B9 92 54 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_8047B4E8:
/* 8047B4E8  38 60 00 01 */	li r3, 1
lbl_8047B4EC:
/* 8047B4EC  39 61 00 20 */	addi r11, r1, 0x20
/* 8047B4F0  4B EE 6D 38 */	b _restgpr_29

...
/* 80BC9C08  3C 60 80 BD */	lis r3, l_cyl_src@ha
/* 80BC9C0C  3B E3 9F FC */	addi r31, r3, l_cyl_src@l
...
/* 80BC9C34  4B 69 D8 28 */	b __apl__5csXyzFR5csXyz
...
/* 80BC9CC4  4B 44 30 A0 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80BC9CC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BC9CCC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BC9CD0  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 80BC9CD4  4B 44 27 60 */	b mDoMtx_YrotM__FPA4_fs
/* 80BC9CD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BC9CDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BC9CE0  A8 9E 0A 84 */	lha r4, 0xa84(r30)
/* 80BC9CE4  4B 44 26 B8 */	b mDoMtx_XrotM__FPA4_fs
/* 80BC9CE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BC9CEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BC9CF0  38 9E 0A 78 */	addi r4, r30, 0xa78
/* 80BC9CF4  7C 85 23 78 */	mr r5, r4
/* 80BC9CF8  4B 77 D0 74 */	b PSMTXMultVec
/* 80BC9CFC  38 7E 0A 78 */	addi r3, r30, 0xa78
/* 80BC9D00  4B 45 3F BC */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80BC9D04  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80BC9D08  41 82 00 DC */	beq lbl_80BC9DE4
/* 80BC9D0C  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80BC9D10  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80BC9D3C  4B 77 D3 9C */	b PSVECScale
...
/* 80BC9D5C  4B 45 00 3C */	b fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc
...
/* 80BC9D74  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BC9D78  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80BC9D8C  4B 4A 5C 98 */	b StartShock__12dVibration_cFii4cXyz
/* 80BC9D90  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80BC9D94  7C 03 07 74 */	extsb r3, r0
/* 80BC9D98  4B 46 32 D4 */	b dComIfGp_getReverb__Fi
...
/* 80BC9DAC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80BC9DB0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80BC9DB4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80BC9DD8  4B 6E 1B AC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc

...
/* 80BB5E58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB5E5C  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80BB5E60  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80BB5E64  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80BB5E68  3B E3 4A C8 */	addi r31, r3, j3dSys@l
/* 80BB5E6C  90 1F 00 48 */	stw r0, 0x48(r31)	/* effective address: 80434B10 */
/* 80BB5E70  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80BB5E74  90 1F 00 4C */	stw r0, 0x4c(r31)	/* effective address: 80434B14 */
/* 80BB5E78  80 7E 05 EC */	lwz r3, 0x5ec(r30)
/* 80BB5E7C  4B 45 7E 48 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80BB5E80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BB5E84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80BB5E88  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80BB5E8C  90 1F 00 48 */	stw r0, 0x48(r31)
/* 80BB5E90  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */

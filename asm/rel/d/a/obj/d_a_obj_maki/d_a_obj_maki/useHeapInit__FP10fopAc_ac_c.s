...
/* 80C90400  4B 6D 1D DC */	b _savegpr_29
/* 80C90404  7C 7E 1B 78 */	mr r30, r3
/* 80C90408  3C 60 80 C9 */	lis r3, stringBase0@ha
/* 80C9040C  38 63 09 60 */	addi r3, r3, stringBase0@l
/* 80C90410  38 80 00 04 */	li r4, 4
/* 80C90414  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80C90418  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80C9042C  4B 3A BE C0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C9043C  4B 38 48 18 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C9045C  4B 63 E7 F0 */	b __nw__FUl
/* 80C90460  7C 7D 1B 79 */	or. r29, r3, r3
/* 80C90464  41 82 00 20 */	beq lbl_80C90484
/* 80C90468  3C 80 80 C9 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80C9046C  38 04 0A 2C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80C90470  90 1D 00 00 */	stw r0, 0(r29)
/* 80C90474  38 80 00 00 */	li r4, 0
/* 80C90478  4B 69 7F 84 */	b init__12J3DFrameCtrlFs
...
lbl_80C9049C:
/* 80C9049C  3C 60 80 C9 */	lis r3, stringBase0@ha
/* 80C904A0  38 63 09 60 */	addi r3, r3, stringBase0@l
/* 80C904A4  38 80 00 08 */	li r4, 8
/* 80C904A8  7F E5 FB 78 */	mr r5, r31
/* 80C904AC  38 C0 00 80 */	li r6, 0x80
/* 80C904B0  4B 3A BE 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C904D0  3D 00 80 C9 */	lis r8, lit_3928@ha
/* 80C904D4  C0 28 09 34 */	lfs f1, lit_3928@l(r8)
/* 80C904D8  39 00 00 00 */	li r8, 0
/* 80C904DC  39 20 FF FF */	li r9, -1
/* 80C904E0  4B 37 D2 2C */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_80C904F4:
/* 80C904F4  3C 60 80 C9 */	lis r3, stringBase0@ha
/* 80C904F8  38 63 09 60 */	addi r3, r3, stringBase0@l
/* 80C904FC  38 80 00 05 */	li r4, 5
/* 80C90500  7F E5 FB 78 */	mr r5, r31
/* 80C90504  38 C0 00 80 */	li r6, 0x80
/* 80C90508  4B 3A BD E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80C90518  4B 38 47 3C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80C90530  4B 6D 1C F8 */	b _restgpr_29

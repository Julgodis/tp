...
/* 80C1B204  4B 74 6F D4 */	b _savegpr_28
/* 80C1B208  7C 7E 1B 78 */	mr r30, r3
/* 80C1B20C  3C 80 80 C2 */	lis r4, lit_3665@ha
/* 80C1B210  3B E4 B6 00 */	addi r31, r4, lit_3665@l
...
/* 80C1B22C  4B 3F D9 38 */	b __ct__10fopAc_ac_cFv
/* 80C1B230  38 7D 05 C0 */	addi r3, r29, 0x5c0
/* 80C1B234  4B 6A 51 94 */	b __ct__10Z2CreatureFv
/* 80C1B238  38 7D 06 B8 */	addi r3, r29, 0x6b8
/* 80C1B23C  4B 45 AC 70 */	b __ct__12dBgS_AcchCirFv
/* 80C1B240  3B 9D 06 F8 */	addi r28, r29, 0x6f8
/* 80C1B244  7F 83 E3 78 */	mr r3, r28
/* 80C1B248  4B 45 AE 58 */	b __ct__9dBgS_AcchFv
/* 80C1B24C  3C 60 80 C2 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80C1B250  38 63 B7 B8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80C1B26C  4B 45 DB FC */	b SetObj__16dBgS_PolyPassChkFv
/* 80C1B270  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80C1B274  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80C1B278  90 1D 08 E8 */	stw r0, 0x8e8(r29)
/* 80C1B27C  38 7D 08 EC */	addi r3, r29, 0x8ec
/* 80C1B280  4B 46 84 E0 */	b __ct__10dCcD_GSttsFv
/* 80C1B284  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80C1B288  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80C1B2A0  4B 46 87 88 */	b __ct__12dCcD_GObjInfFv
/* 80C1B2A4  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80C1B2A8  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80C1B2AC  90 1C 01 20 */	stw r0, 0x120(r28)
/* 80C1B2B0  3C 60 80 C2 */	lis r3, __vt__8cM3dGAab@ha
/* 80C1B2B4  38 03 B7 AC */	addi r0, r3, __vt__8cM3dGAab@l
/* 80C1B2B8  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 80C1B2BC  3C 60 80 C2 */	lis r3, __vt__8cM3dGSph@ha
/* 80C1B2C0  38 03 B7 A0 */	addi r0, r3, __vt__8cM3dGSph@l
/* 80C1B2C4  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80C1B2C8  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 80C1B2CC  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 80C1B2D0  90 7C 01 20 */	stw r3, 0x120(r28)
/* 80C1B2D4  38 03 00 58 */	addi r0, r3, 0x58
/* 80C1B2D8  90 1C 01 34 */	stw r0, 0x134(r28)
/* 80C1B2DC  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 80C1B2E0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 80C1B308  3C 80 80 C2 */	lis r4, stringBase0@ha
/* 80C1B30C  38 84 B7 00 */	addi r4, r4, stringBase0@l
/* 80C1B310  4B 41 1B AC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C1B32C  3C 80 80 C2 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80C1B330  38 84 B1 88 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80C1B334  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 80C1B338  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 80C1B33C  4B 3F F1 74 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80C1B3BC  4B 45 AE 8C */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80C1B3C0  38 7E 06 B8 */	addi r3, r30, 0x6b8
/* 80C1B3C4  C0 3F 00 50 */	lfs f1, 0x50(r31)
/* 80C1B3C8  FC 40 08 90 */	fmr f2, f1
/* 80C1B3CC  4B 45 AB 8C */	b SetWall__12dBgS_AcchCirFff
...
/* 80C1B494  4B 3F EA 5C */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 80C1B4B0  4B 64 C4 A4 */	b cM_rndF__Ff
...
/* 80C1B4D4  4B 74 6D 50 */	b _restgpr_28

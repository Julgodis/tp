...
/* 80C1A4A0  4B 74 7D 3C */	b _savegpr_29
...
/* 80C1A4CC  4B 72 CB C4 */	b PSVECAdd
...
/* 80C1A548  4B 40 2B C4 */	b fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_80C1A54C:
/* 80C1A54C  A8 1E 06 50 */	lha r0, 0x650(r30)
/* 80C1A550  1C 00 03 84 */	mulli r0, r0, 0x384
/* 80C1A554  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C1A558  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C1A55C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C1A590  4B 65 54 AC */	b cLib_addCalc2__FPffff
/* 80C1A594  A8 1E 06 50 */	lha r0, 0x650(r30)
/* 80C1A598  1C 00 03 E8 */	mulli r0, r0, 0x3e8
/* 80C1A59C  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C1A5A0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C1A5A4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80C1A5FC  4B 65 54 40 */	b cLib_addCalc2__FPffff
/* 80C1A600  A8 1E 06 50 */	lha r0, 0x650(r30)
/* 80C1A604  1C 00 0F A0 */	mulli r0, r0, 0xfa0
/* 80C1A608  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80C1A60C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80C1A610  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 80C1A678  4B 65 53 C4 */	b cLib_addCalc2__FPffff
...
/* 80C1A6B4  4B 40 00 5C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80C1A6C8  4B 65 5F 40 */	b cLib_addCalcAngleS2__FPssss
lbl_80C1A6CC:
/* 80C1A6CC  38 7E 09 0C */	addi r3, r30, 0x90c
/* 80C1A6D0  4B 46 9F 88 */	b ChkCoHit__12dCcD_GObjInfFv
...
/* 80C1A6FC  4B 65 53 40 */	b cLib_addCalc2__FPffff
...
/* 80C1A718  4B 65 53 24 */	b cLib_addCalc2__FPffff
...
/* 80C1A72C  4B 65 53 10 */	b cLib_addCalc2__FPffff
lbl_80C1A730:
/* 80C1A730  39 61 00 50 */	addi r11, r1, 0x50
/* 80C1A734  4B 74 7A F4 */	b _restgpr_29

...
/* 80CE12F0  3C 60 80 CE */	lis r3, lit_3779@ha
/* 80CE12F4  3B C3 39 E8 */	addi r30, r3, lit_3779@l
...
/* 80CE1380  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80CE1384  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80CE1388  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80CE138C  4B 66 51 24 */	b PSMTXCopy
...
/* 80CE13A0  4B 58 FA BC */	b MtxTrans__FfffUc
...
/* 80CE13B4  4B 58 FA A8 */	b MtxTrans__FfffUc
/* 80CE13B8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80CE13BC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80CE13C0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80CE13C4  A8 9F 0D C2 */	lha r4, 0xdc2(r31)
/* 80CE13C8  4B 32 AF D4 */	b mDoMtx_XrotM__FPA4_fs
/* 80CE13CC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80CE13D0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80CE13D4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80CE13D8  38 9F 04 E4 */	addi r4, r31, 0x4e4
/* 80CE13DC  4B 32 B8 24 */	b mDoMtx_MtxToRot__FPA4_CfP5csXyz
...
/* 80CE13F0  4B 58 FA 6C */	b MtxTrans__FfffUc
/* 80CE13F4  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80CE13F8  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80CE13FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80CE1400  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80CE1404  38 84 00 24 */	addi r4, r4, 0x24
/* 80CE1408  4B 66 50 A8 */	b PSMTXCopy
...
/* 80CE1424  4B 58 FA C8 */	b MtxPosition__FP4cXyzP4cXyz
/* 80CE1428  38 00 00 00 */	li r0, 0
/* 80CE142C  98 1F 1B 60 */	stb r0, 0x1b60(r31)
/* 80CE1430  48 00 00 94 */	b lbl_80CE14C4
lbl_80CE1434:
/* 80CE1434  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CE1438  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CE143C  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80CE1440  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80CE1444  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80CE1448  4B 66 54 A0 */	b PSMTXTrans
/* 80CE144C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CE1450  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CE1454  A8 9F 0D BE */	lha r4, 0xdbe(r31)
/* 80CE1458  4B 32 AF DC */	b mDoMtx_YrotM__FPA4_fs
/* 80CE145C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CE1460  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CE1464  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80CE1468  4B 32 AF CC */	b mDoMtx_YrotM__FPA4_fs
/* 80CE146C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CE1470  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80CE1484  4B 32 AF 18 */	b mDoMtx_XrotM__FPA4_fs
/* 80CE1488  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CE148C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CE1490  A8 1F 0D BE */	lha r0, 0xdbe(r31)
/* 80CE1494  7C 00 00 D0 */	neg r0, r0
/* 80CE1498  7C 04 07 34 */	extsh r4, r0
/* 80CE149C  4B 32 AF 98 */	b mDoMtx_YrotM__FPA4_fs
/* 80CE14A0  C0 3F 04 EC */	lfs f1, 0x4ec(r31)
/* 80CE14A4  FC 40 08 90 */	fmr f2, f1
/* 80CE14A8  FC 60 08 90 */	fmr f3, f1
/* 80CE14AC  4B 32 B9 8C */	b scaleM__14mDoMtx_stack_cFfff
/* 80CE14B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80CE14B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80CE14B8  80 9F 05 74 */	lwz r4, 0x574(r31)
/* 80CE14BC  38 84 00 24 */	addi r4, r4, 0x24
/* 80CE14C0  4B 66 4F F0 */	b PSMTXCopy
lbl_80CE14C4:

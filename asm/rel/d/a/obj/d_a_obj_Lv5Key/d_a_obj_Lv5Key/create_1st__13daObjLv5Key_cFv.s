...
/* 80B9C5FC  4B 7C 5B E0 */	b _savegpr_29
...
/* 80B9C61C  4B 47 C5 48 */	b __ct__10fopAc_ac_cFv
/* 80B9C620  38 7E 05 6C */	addi r3, r30, 0x56c
/* 80B9C624  4B 72 22 20 */	b __ct__16Z2SoundObjSimpleFv
/* 80B9C628  3B BE 05 94 */	addi r29, r30, 0x594
/* 80B9C62C  3C 60 80 BA */	lis r3, __vt__12J3DFrameCtrl@ha
/* 80B9C630  38 03 CA 8C */	addi r0, r3, __vt__12J3DFrameCtrl@l
/* 80B9C634  90 1E 05 94 */	stw r0, 0x594(r30)
/* 80B9C638  7F A3 EB 78 */	mr r3, r29
/* 80B9C63C  38 80 00 00 */	li r4, 0
/* 80B9C640  4B 78 BD BC */	b init__12J3DFrameCtrlFs
/* 80B9C644  38 00 00 00 */	li r0, 0
/* 80B9C648  90 1D 00 18 */	stw r0, 0x18(r29)
/* 80B9C64C  38 7E 05 B8 */	addi r3, r30, 0x5b8
/* 80B9C650  4B 4D 98 5C */	b __ct__12dBgS_AcchCirFv
/* 80B9C654  3B BE 05 F8 */	addi r29, r30, 0x5f8
/* 80B9C658  7F A3 EB 78 */	mr r3, r29
/* 80B9C65C  4B 4D 9A 44 */	b __ct__9dBgS_AcchFv
/* 80B9C660  3C 60 80 BA */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 80B9C664  38 63 CA 68 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 80B9C680  4B 4D C7 E8 */	b SetObj__16dBgS_PolyPassChkFv
/* 80B9C684  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 80B9C688  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 80B9C68C  90 1E 07 E8 */	stw r0, 0x7e8(r30)
/* 80B9C690  38 7E 07 EC */	addi r3, r30, 0x7ec
/* 80B9C694  4B 4E 70 CC */	b __ct__10dCcD_GSttsFv
/* 80B9C698  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 80B9C69C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 80B9C6B4  4B 4E 73 74 */	b __ct__12dCcD_GObjInfFv
/* 80B9C6B8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 80B9C6BC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 80B9C6C0  90 1D 01 20 */	stw r0, 0x120(r29)
/* 80B9C6C4  3C 60 80 BA */	lis r3, __vt__8cM3dGAab@ha
/* 80B9C6C8  38 03 CA 5C */	addi r0, r3, __vt__8cM3dGAab@l
/* 80B9C6CC  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 80B9C6D0  3C 60 80 BA */	lis r3, __vt__8cM3dGSph@ha
/* 80B9C6D4  38 03 CA 50 */	addi r0, r3, __vt__8cM3dGSph@l
/* 80B9C6D8  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80B9C6DC  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 80B9C6E0  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 80B9C6E4  90 7D 01 20 */	stw r3, 0x120(r29)
/* 80B9C6E8  38 03 00 58 */	addi r0, r3, 0x58
/* 80B9C6EC  90 1D 01 34 */	stw r0, 0x134(r29)
/* 80B9C6F0  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 80B9C6F4  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 80B9C73C  3C 80 80 BA */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80B9C740  38 84 C8 E0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80B9C744  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 80B9C748  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 80B9C74C  4B 47 DD 64 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80B9C784  4B 7C 5A A4 */	b _restgpr_29

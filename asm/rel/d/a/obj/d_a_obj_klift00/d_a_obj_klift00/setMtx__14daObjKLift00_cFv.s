...
/* 8058B0F8 0000000C  3C 60 00 00 */	lis r3, l_bmdidx@ha
/* 8058B0FC 00000010  3B C3 00 00 */	addi r30, r3, l_bmdidx@l
/* 8058B100 00000014  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B104 00000018  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8058B118 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B11C 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8058B134 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B138 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
lbl_8058B148:
/* 8058B148 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B14C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8058B170 00000028  3C 60 00 00 */	lis r3, BaseZ__4cXyz@ha
/* 8058B174 0000002C  3B E3 00 00 */	addi r31, r3, BaseZ__4cXyz@l
/* 8058B178 00000030  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8058B17C 00000034  C3 E3 00 00 */	lfs f31, G_CM3D_F_ABS_MIN@l(r3)
/* 8058B180 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B184 0000003C  3A C3 00 00 */	addi r22, r3, now__14mDoMtx_stack_c@l
...
/* 8058B208 00000014  3C 80 00 00 */	lis r4, BaseZ__4cXyz@ha
/* 8058B20C 00000018  38 84 00 00 */	addi r4, r4, BaseZ__4cXyz@l
...
/* 8058B228 00000034  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8058B22C 00000038  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 8058B358 00000074  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8058B35C 00000078  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 8058B3A4 00000040  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 8058B3A8 00000044  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 8058B42C 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B430 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8058B440 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B444 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8058B454 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B458 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8058B478 00000064  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 8058B47C 00000068  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

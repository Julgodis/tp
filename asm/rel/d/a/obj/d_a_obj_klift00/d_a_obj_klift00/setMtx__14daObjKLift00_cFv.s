...
/* 8058B0F0 00000004  4B FF FE 29 */	bl _savegpr_22
/* 8058B0F4 00000008  7C 7B 1B 78 */	mr r27, r3
/* 8058B0F8 0000000C  3C 60 00 00 */	lis r3, l_bmdidx@ha /* 8058C380 */
/* 8058B0FC 00000010  3B C3 00 00 */	addi r30, r3, l_bmdidx@l /* 8058C380 */
/* 8058B100 00000014  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B104 00000018  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 8058B114 00000028  4B FF FE 05 */	bl PSMTXTrans
/* 8058B118 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B11C 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B120 00000034  A8 9B 04 E6 */	lha r4, 0x4e6(r27)
/* 8058B124 00000038  4B FF FD F5 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 8058B134 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B138 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B13C 00000050  80 9B 06 0C */	lwz r4, 0x60c(r27)
/* 8058B140 00000054  38 84 00 24 */	addi r4, r4, 0x24
/* 8058B144 00000058  4B FF FD D5 */	bl PSMTXCopy
lbl_8058B148:
/* 8058B148 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B14C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B150 00000008  38 9B 05 D8 */	addi r4, r27, 0x5d8
/* 8058B154 0000000C  4B FF FD C5 */	bl PSMTXCopy
...
/* 8058B170 00000028  3C 60 00 00 */	lis r3, BaseZ__4cXyz@ha /* 80430D3C */
/* 8058B174 0000002C  3B E3 00 00 */	addi r31, r3, BaseZ__4cXyz@l /* 80430D3C */
/* 8058B178 00000030  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 8058B17C 00000034  C3 E3 00 00 */	lfs f31, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
/* 8058B180 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B184 0000003C  3A C3 00 00 */	addi r22, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 8058B1B4 00000020  4B FF FD 65 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058B1DC 00000048  4B FF FD 3D */	bl PSVECCrossProduct
/* 8058B1E0 0000004C  38 61 00 80 */	addi r3, r1, 0x80
/* 8058B1E4 00000050  4B FF FD 35 */	bl PSVECSquareMag
...
/* 8058B200 0000000C  4B FF FD 19 */	bl normalize__4cXyzFv
/* 8058B204 00000010  38 61 00 80 */	addi r3, r1, 0x80
/* 8058B208 00000014  3C 80 00 00 */	lis r4, BaseZ__4cXyz@ha /* 80430D3C */
/* 8058B20C 00000018  38 84 00 00 */	addi r4, r4, BaseZ__4cXyz@l /* 80430D3C */
/* 8058B210 0000001C  4B FF FD 09 */	bl PSVECDotProduct
/* 8058B214 00000020  FF C0 08 90 */	fmr f30, f1
/* 8058B218 00000024  38 61 00 74 */	addi r3, r1, 0x74
/* 8058B21C 00000028  4B FF FC FD */	bl PSVECSquareMag
/* 8058B220 0000002C  FC 00 0A 10 */	fabs f0, f1
/* 8058B224 00000030  FC 20 00 18 */	frsp f1, f0
/* 8058B228 00000034  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 8058B22C 00000038  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
...
/* 8058B25C 0000000C  4B FF FC BD */	bl acos
...
/* 8058B26C 0000001C  4B FF FC AD */	bl normalize__4cXyzFv
...
/* 8058B2A8 00000010  4B FF FC 71 */	bl transS__14mDoMtx_stack_cFRC4cXyz
...
/* 8058B2B8 00000020  4B FF FC 61 */	bl PSMTXConcat
/* 8058B2BC 00000024  7E E3 BB 78 */	mr r3, r23
/* 8058B2C0 00000028  7F A4 EB 78 */	mr r4, r29
/* 8058B2C4 0000002C  4B FF FC 55 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 8058B2D4 0000003C  4B FF FC 45 */	bl PSMTXCopy
...
/* 8058B314 00000030  4B FF FC 05 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058B34C 00000068  4B FF FB CD */	bl PSVECSquareMag
/* 8058B350 0000006C  FC 00 0A 10 */	fabs f0, f1
/* 8058B354 00000070  FC 20 00 18 */	frsp f1, f0
/* 8058B358 00000074  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 8058B35C 00000078  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
...
/* 8058B370 0000000C  4B FF FB A9 */	bl normalize__4cXyzFv
...
/* 8058B380 0000001C  4B FF FB 99 */	bl PSVECCrossProduct
/* 8058B384 00000020  38 61 00 68 */	addi r3, r1, 0x68
/* 8058B388 00000024  38 81 00 50 */	addi r4, r1, 0x50
/* 8058B38C 00000028  4B FF FB 8D */	bl PSVECDotProduct
/* 8058B390 0000002C  FF C0 08 90 */	fmr f30, f1
/* 8058B394 00000030  38 61 00 5C */	addi r3, r1, 0x5c
/* 8058B398 00000034  4B FF FB 81 */	bl PSVECSquareMag
/* 8058B39C 00000038  FC 00 0A 10 */	fabs f0, f1
/* 8058B3A0 0000003C  FC 20 00 18 */	frsp f1, f0
/* 8058B3A4 00000040  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 8058B3A8 00000044  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
...
/* 8058B3D8 0000000C  4B FF FB 41 */	bl acos
...
/* 8058B3E8 0000001C  4B FF FB 31 */	bl normalize__4cXyzFv
...
/* 8058B428 00000014  4B FF FA F1 */	bl transS__14mDoMtx_stack_cFRC4cXyz
/* 8058B42C 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B430 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B434 00000020  38 81 00 8C */	addi r4, r1, 0x8c
/* 8058B438 00000024  7C 65 1B 78 */	mr r5, r3
/* 8058B43C 00000028  4B FF FA DD */	bl PSMTXConcat
/* 8058B440 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B444 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B448 00000034  7C 1D 00 D0 */	neg r0, r29
/* 8058B44C 00000038  7C 04 07 34 */	extsh r4, r0
/* 8058B450 0000003C  4B FF FA C9 */	bl mDoMtx_YrotM__FPA4_fs
/* 8058B454 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B458 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B45C 00000048  80 9B 06 08 */	lwz r4, 0x608(r27)
/* 8058B460 0000004C  38 84 00 24 */	addi r4, r4, 0x24
/* 8058B464 00000050  4B FF FA B5 */	bl PSMTXCopy
...
/* 8058B474 00000060  4B FF FA A5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 8058B478 00000064  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8058B47C 00000068  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 8058B480 0000006C  38 9B 05 A8 */	addi r4, r27, 0x5a8
/* 8058B484 00000070  4B FF FA 95 */	bl PSMTXCopy
...
/* 8058B49C 00000008  4B FF FA 7D */	bl _restgpr_22

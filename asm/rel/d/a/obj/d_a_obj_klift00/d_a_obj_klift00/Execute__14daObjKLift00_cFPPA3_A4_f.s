...
/* 8058B994 00000004  4B FF F5 85 */	bl _savegpr_22
/* 8058B998 00000008  7C 7A 1B 78 */	mr r26, r3
/* 8058B99C 0000000C  7C 9B 23 78 */	mr r27, r4
/* 8058B9A0 00000010  3C 60 00 00 */	lis r3, l_bmdidx@ha /* 8058C380 */
/* 8058B9A4 00000014  3B E3 00 00 */	addi r31, r3, l_bmdidx@l /* 8058C380 */
/* 8058B9A8 00000018  C0 3F 00 1C */	lfs f1, 0x1c(r31)
/* 8058B9AC 0000001C  4B FF F5 6D */	bl cM_rndF__Ff
...
/* 8058B9CC 00000004  4B FF F5 4D */	bl dKyw_get_wind_vecpow__Fv
...
/* 8058B9EC 00000024  4B FF F5 2D */	bl cM_rndF__Ff
/* 8058B9F0 00000028  38 61 00 9C */	addi r3, r1, 0x9c
/* 8058B9F4 0000002C  7C 64 1B 78 */	mr r4, r3
/* 8058B9F8 00000030  4B FF F5 21 */	bl PSVECScale
...
/* 8058BA0C 00000044  4B FF F5 0D */	bl PSVECAdd
...
/* 8058BA24 0000005C  4B FF F4 F5 */	bl cM_rndF__Ff
/* 8058BA28 00000060  38 61 00 9C */	addi r3, r1, 0x9c
/* 8058BA2C 00000064  7C 64 1B 78 */	mr r4, r3
/* 8058BA30 00000068  4B FF F4 E9 */	bl PSVECScale
...
/* 8058BA44 0000007C  4B FF F4 D5 */	bl PSVECAdd
lbl_8058BA48:
...
/* 8058BA88 0000001C  4B FF F4 91 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 8058BA98 0000002C  4B FF F4 81 */	bl GetTgHitObj__12dCcD_GObjInfFv
/* 8058BA9C 00000030  7C 77 1B 78 */	mr r23, r3
/* 8058BAA0 00000034  4B FF F4 79 */	bl GetAc__8cCcD_ObjFv
...
/* 8058BAC0 00000054  4B FF F4 59 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058BAE0 00000074  4B FF F4 39 */	bl PSVECSquareMag
/* 8058BAE4 00000078  FC 00 0A 10 */	fabs f0, f1
/* 8058BAE8 0000007C  FC 20 00 18 */	frsp f1, f0
/* 8058BAEC 00000080  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 8058BAF0 00000084  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
...
/* 8058BB04 0000000C  4B FF F4 15 */	bl normalize__4cXyzFv
...
/* 8058BB14 0000001C  4B FF F4 05 */	bl PSVECScale
...
/* 8058BB28 00000030  4B FF F3 F1 */	bl PSVECAdd
lbl_8058BB2C:
...
/* 8058BB40 00000014  4B FF F3 D9 */	bl getHitSeID__12dCcD_GObjInfFUci
/* 8058BB44 00000018  90 61 00 08 */	stw r3, 8(r1)
/* 8058BB48 0000001C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 8058BB4C 00000020  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
...
/* 8058BB78 0000004C  4B FF F3 A1 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_8058BB7C:
...
/* 8058BB94 00000018  3C 60 00 00 */	lis r3, Zero__4cXyz@ha /* 80430CF4 */
/* 8058BB98 0000001C  C4 03 00 00 */	lfsu f0, Zero__4cXyz@l(r3) /* 80430CF4 */
...
/* 8058BC20 00000044  4B FF F2 F9 */	bl PSVECAdd
...
/* 8058BC6C 00000028  4B FF F2 AD */	bl __pl__4cXyzCFRC3Vec
...
/* 8058BC8C 00000048  4B FF F2 8D */	bl __pl__4cXyzCFRC3Vec
...
/* 8058BC9C 00000058  4B FF F2 7D */	bl __ml__4cXyzCFf
...
/* 8058BD08 00000020  4B FF F2 11 */	bl __mi__4cXyzCFRC3Vec
...
/* 8058BD4C 00000004  4B FF F1 CD */	bl PSVECSquareMag
/* 8058BD50 00000008  FC 00 0A 10 */	fabs f0, f1
/* 8058BD54 0000000C  FC 20 00 18 */	frsp f1, f0
/* 8058BD58 00000010  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha /* 80451180 */
/* 8058BD5C 00000014  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3) /* 80451180 */
...
/* 8058BD70 0000000C  4B FF F1 A9 */	bl normalize__4cXyzFv
...
/* 8058BD98 0000000C  4B FF F1 81 */	bl PSVECScale
...
/* 8058BDB0 00000024  4B FF F1 69 */	bl __pl__4cXyzCFRC3Vec
...
/* 8058BDEC 00000060  4B FF F1 2D */	bl __mi__4cXyzCFRC3Vec
...
/* 8058BE58 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8058BE5C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8058BE8C 00000028  4B FF F0 8D */	bl SetC__8cM3dGSphFRC4cXyz
/* 8058BE90 0000002C  7E E3 BB 78 */	mr r3, r23
/* 8058BE94 00000030  38 96 06 60 */	addi r4, r22, 0x660
/* 8058BE98 00000034  4B FF F0 81 */	bl Set__4cCcSFP8cCcD_Obj
lbl_8058BE9C:
...
/* 8058BEB4 00000018  4B FF F0 65 */	bl Move__10dCcD_GSttsFv
...
/* 8058BED8 00000008  4B FF F0 41 */	bl _restgpr_22

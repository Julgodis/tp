...
/* 80BDF17C  4B 78 30 5C */	b _savegpr_28
/* 80BDF180  7C 7F 1B 78 */	mr r31, r3
/* 80BDF184  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80BDF188  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
...
/* 80BDF1AC  4B 46 8C 64 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 80BDF1B0  7C 7E 1B 78 */	mr r30, r3
/* 80BDF1B4  7F 83 E3 78 */	mr r3, r28
/* 80BDF1B8  80 9F 05 DC */	lwz r4, 0x5dc(r31)
/* 80BDF1BC  4B 46 8B 90 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80BDF1E8  3C A0 80 BE */	lis r5, struct_80BDF8EC+0x0@ha
/* 80BDF1EC  38 A5 F8 EC */	addi r5, r5, struct_80BDF8EC+0x0@l
/* 80BDF1F0  38 A5 00 50 */	addi r5, r5, 0x50
/* 80BDF1F4  38 C0 00 03 */	li r6, 3
/* 80BDF1F8  4B 46 8E F4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80BDF254  4B 46 8F 28 */	b cutEnd__16dEvent_manager_cFi
...
/* 80BDF274  3C 80 80 BE */	lis r4, struct_80BDF8EC+0x0@ha
/* 80BDF278  38 84 F8 EC */	addi r4, r4, struct_80BDF8EC+0x0@l
/* 80BDF27C  38 84 00 36 */	addi r4, r4, 0x36
/* 80BDF280  4B 78 97 14 */	b strcmp
/* 80BDF284  2C 03 00 00 */	cmpwi r3, 0
/* 80BDF288  40 82 00 2C */	bne lbl_80BDF2B4
/* 80BDF28C  38 60 00 01 */	li r3, 1
/* 80BDF290  3C 80 80 BE */	lis r4, lit_3719@ha
/* 80BDF294  C0 24 F8 80 */	lfs f1, lit_3719@l(r4)
...
/* 80BDF2AC  4B 44 7E C4 */	b dStage_changeScene__FifUlScsi
/* 80BDF2B0  48 00 00 54 */	b lbl_80BDF304
lbl_80BDF2B4:
/* 80BDF2B4  7F 83 E3 78 */	mr r3, r28
/* 80BDF2B8  3C 80 80 BE */	lis r4, struct_80BDF8EC+0x0@ha
/* 80BDF2BC  38 84 F8 EC */	addi r4, r4, struct_80BDF8EC+0x0@l
/* 80BDF2C0  38 84 00 3E */	addi r4, r4, 0x3e
/* 80BDF2C4  4B 78 96 D0 */	b strcmp
/* 80BDF2C8  2C 03 00 00 */	cmpwi r3, 0
/* 80BDF2CC  40 82 00 38 */	bne lbl_80BDF304
/* 80BDF2D0  38 60 00 02 */	li r3, 2
/* 80BDF2D4  3C 80 80 BE */	lis r4, lit_3719@ha
/* 80BDF2D8  C0 24 F8 80 */	lfs f1, lit_3719@l(r4)

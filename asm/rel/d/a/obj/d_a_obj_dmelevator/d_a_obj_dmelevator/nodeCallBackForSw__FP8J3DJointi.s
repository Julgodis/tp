...
/* 80BDDC00  4B 78 45 D8 */	b _savegpr_28
...
/* 80BDDC30  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80BDDC34  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80BDDC38  4B 76 88 78 */	b PSMTXCopy
/* 80BDDC3C  2C 1F 00 01 */	cmpwi r31, 1
/* 80BDDC40  40 82 00 18 */	bne lbl_80BDDC58
/* 80BDDC44  C0 3C 06 38 */	lfs f1, 0x638(r28)
/* 80BDDC48  3C 60 80 BE */	lis r3, lit_3719@ha
/* 80BDDC4C  C0 43 F8 80 */	lfs f2, lit_3719@l(r3)
/* 80BDDC50  FC 60 10 90 */	fmr f3, f2
/* 80BDDC54  4B 42 F1 48 */	b transM__14mDoMtx_stack_cFfff
lbl_80BDDC58:
/* 80BDDC58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BDDC5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BDDC60  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80BDDC64  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80BDDC68  7C 80 EA 14 */	add r4, r0, r29
/* 80BDDC6C  4B 76 88 44 */	b PSMTXCopy
/* 80BDDC70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80BDDC74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80BDDC78  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80BDDC7C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80BDDC80  4B 76 88 30 */	b PSMTXCopy
lbl_80BDDC84:
/* 80BDDC84  38 60 00 01 */	li r3, 1
/* 80BDDC88  39 61 00 20 */	addi r11, r1, 0x20
/* 80BDDC8C  4B 78 45 98 */	b _restgpr_28

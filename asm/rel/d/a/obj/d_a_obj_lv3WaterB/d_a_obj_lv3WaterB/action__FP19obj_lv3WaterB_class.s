...
/* 80C5B734  3C 60 80 C6 */	lis r3, lit_3724@ha
/* 80C5B738  3B C3 BD 50 */	addi r30, r3, lit_3724@l
...
lbl_80C5B75C:
/* 80C5B75C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5B760  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5B764  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80C5B768  80 9F 05 F4 */	lwz r4, 0x5f4(r31)
/* 80C5B76C  4B 41 8A E4 */	b Release__4cBgSFP9dBgW_Base
...
/* 80C5B78C  4B 54 D0 80 */	b dKy_custom_colset__FUcUcf
...
/* 80C5B7E4  4B 61 42 58 */	b cLib_addCalc2__FPffff
lbl_80C5B7E8:
/* 80C5B7E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5B7EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5B7F0  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80C5B7F4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80C5B7F8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80C5B7FC  4B 6E B0 EC */	b PSMTXTrans
/* 80C5B800  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5B804  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5B808  80 9F 05 78 */	lwz r4, 0x578(r31)
/* 80C5B80C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C5B810  4B 6E AC A0 */	b PSMTXCopy
/* 80C5B814  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5B818  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5B81C  38 9F 05 8C */	addi r4, r31, 0x58c
/* 80C5B820  4B 6E AC 90 */	b PSMTXCopy
/* 80C5B824  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 80C5B828  4B 42 01 98 */	b Move__4dBgWFv
/* 80C5B82C  80 7F 05 7C */	lwz r3, 0x57c(r31)
/* 80C5B830  4B 3B 1B F8 */	b play__14mDoExt_baseAnmFv
/* 80C5B834  80 1F 05 80 */	lwz r0, 0x580(r31)
/* 80C5B838  28 00 00 00 */	cmplwi r0, 0
/* 80C5B83C  41 82 00 48 */	beq lbl_80C5B884
/* 80C5B840  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5B844  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5B848  C0 3E 00 08 */	lfs f1, 8(r30)
/* 80C5B84C  FC 40 08 90 */	fmr f2, f1
/* 80C5B850  FC 60 08 90 */	fmr f3, f1
/* 80C5B854  4B 6E B0 94 */	b PSMTXTrans
/* 80C5B858  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5B85C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5B860  80 9F 05 80 */	lwz r4, 0x580(r31)
/* 80C5B864  38 84 00 24 */	addi r4, r4, 0x24
/* 80C5B868  4B 6E AC 48 */	b PSMTXCopy
/* 80C5B86C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C5B870  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80C5B874  38 9F 05 C4 */	addi r4, r31, 0x5c4
/* 80C5B878  4B 6E AC 38 */	b PSMTXCopy
/* 80C5B87C  80 7F 05 F4 */	lwz r3, 0x5f4(r31)
/* 80C5B880  4B 42 01 40 */	b Move__4dBgWFv
lbl_80C5B884:

...
/* 80C5BBE4  4B 70 65 F8 */	b _savegpr_29
...
/* 80C5BC00  4B 3B CF 64 */	b __ct__10fopAc_ac_cFv
lbl_80C5BC04:
...
/* 80C5BC14  3C 80 80 C6 */	lis r4, stringBase0@ha
/* 80C5BC18  38 84 BD 70 */	addi r4, r4, stringBase0@l
/* 80C5BC1C  4B 3D 12 A0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
/* 80C5BC20  7C 7E 1B 78 */	mr r30, r3
/* 80C5BC24  38 7F 05 70 */	addi r3, r31, 0x570
/* 80C5BC28  3C 80 80 C6 */	lis r4, stringBase0@ha
/* 80C5BC2C  38 84 BD 70 */	addi r4, r4, stringBase0@l
/* 80C5BC30  38 84 00 0A */	addi r4, r4, 0xa
/* 80C5BC34  4B 3D 12 88 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80C5BC4C  3C 80 80 C6 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80C5BC50  38 84 B9 4C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80C5BC54  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 80C5BC58  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 80C5BC5C  4B 3B E8 54 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_80C5BC70:
/* 80C5BC70  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5BC74  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80C5BC88  4B 41 8D 80 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80C5BCA8  4B 41 8D 60 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
lbl_80C5BCBC:
/* 80C5BCBC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80C5BCC0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80C5BCC4  38 63 09 58 */	addi r3, r3, 0x958
/* 80C5BCC8  38 80 00 03 */	li r4, 3
/* 80C5BCCC  4B 3D 8C 68 */	b isDungeonItem__12dSv_memBit_cCFi
/* 80C5BCD0  2C 03 00 00 */	cmpwi r3, 0
/* 80C5BCD4  41 82 00 3C */	beq lbl_80C5BD10
/* 80C5BCD8  3C 60 80 C6 */	lis r3, lit_3752@ha
/* 80C5BCDC  C0 43 BD 60 */	lfs f2, lit_3752@l(r3)
/* 80C5BCE0  C0 3F 04 AC */	lfs f1, 0x4ac(r31)
/* 80C5BCE4  3C 60 80 C6 */	lis r3, lit_3753@ha
/* 80C5BCE8  C0 03 BD 64 */	lfs f0, lit_3753@l(r3)
...
/* 80C5BD34  4B 70 64 F4 */	b _restgpr_29

...
/* 80D5BB48 00000018  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 80D5BB4C 0000001C  80 03 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r3)
...
/* 80D5BB6C 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D5BB70 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D5BB74 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D5BB78 00000018  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80D5BB7C 0000001C  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D5BB80 00000020  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D5BB84 00000024  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D5BB88 00000028  4B 2D 8E 34 */	b isEventBit__11dSv_event_cCFUs
...
/* 80D5BBA8 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D5BBAC 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D5BBB0 00000014  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D5BBB4 00000018  7C 05 07 74 */	extsb r5, r0
/* 80D5BBB8 0000001C  4B 2D 97 A8 */	b isSwitch__10dSv_info_cCFii
...
/* 80D5BBC8 0000002C  4B 2B E0 B4 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 80D5BBE0 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D5BBE4 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D5BBE8 00000014  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80D5BC14 00000040  4B 2D 95 EC */	b onSwitch__10dSv_info_cFii
/* 80D5BC18 00000044  7F E3 FB 78 */	mr r3, r31
/* 80D5BC1C 00000048  4B 2B E0 60 */	b fopAcM_delete__FP10fopAc_ac_c
/* 80D5BC20 0000004C  38 60 00 01 */	li r3, 1
/* 80D5BC24 00000050  48 00 00 CC */	b lbl_80D5BCF0
lbl_80D5BC28:
/* 80D5BC28 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D5BC2C 00000004  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 80D5BC30 00000008  83 C4 5D B4 */	lwz r30, 0x5db4(r4)	/* effective address: 8040BF74 */
...
/* 80D5BC5C 0000000C  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80D5BC60 00000010  4B 2B EE 34 */	b fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80D5BC7C 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D5BC80 00000014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D5BC84 00000018  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D5BC88 0000001C  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 80D5BC8C 00000020  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80D5BC90 00000024  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80D5BC94 00000028  7C 84 02 2E */	lhzx r4, r4, r0
/* 80D5BC98 0000002C  4B 2D 8D 24 */	b isEventBit__11dSv_event_cCFUs
...
/* 80D5BCB0 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D5BCB4 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D5BCB8 00000014  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D5BCBC 00000018  7C 05 07 74 */	extsb r5, r0
/* 80D5BCC0 0000001C  4B 2D 96 A0 */	b isSwitch__10dSv_info_cCFii

...
/* 80D5FC38  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5FC3C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D5FC40  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D5FC44  7C 05 07 74 */	extsb r5, r0
/* 80D5FC48  4B 2D 57 18 */	b isSwitch__10dSv_info_cCFii
...
/* 80D5FC7C  4B 2C FF 04 */	b dComIfGs_onVisitedRoom__Fi
/* 80D5FC80  48 00 01 20 */	b lbl_80D5FDA0
lbl_80D5FC84:
/* 80D5FC84  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5FC88  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D5FC8C  4B 2D 54 1C */	b getSave2__10dSv_save_cFi
/* 80D5FC90  57 E0 C6 3E */	rlwinm r0, r31, 0x18, 0x18, 0x1f
/* 80D5FC94  7C 04 07 74 */	extsb r4, r0
/* 80D5FC98  4B 2D 4E 0C */	b onVisitedRoom__13dSv_memory2_cFi
...
/* 80D5FCC0  4B 2C FF 7C */	b dComIfGs_offVisitedRoom__Fi
/* 80D5FCC4  48 00 00 DC */	b lbl_80D5FDA0
lbl_80D5FCC8:
/* 80D5FCC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5FCCC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D5FCD0  4B 2D 53 D8 */	b getSave2__10dSv_save_cFi
/* 80D5FCD4  57 E0 C6 3E */	rlwinm r0, r31, 0x18, 0x18, 0x1f
/* 80D5FCD8  7C 04 07 74 */	extsb r4, r0
/* 80D5FCDC  4B 2D 4D EC */	b offVisitedRoom__13dSv_memory2_cFi
...
/* 80D5FCF8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5FCFC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D5FD00  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 80D5FD04  7C 05 07 74 */	extsb r5, r0
/* 80D5FD08  4B 2D 56 58 */	b isSwitch__10dSv_info_cCFii
...
/* 80D5FD3C  4B 2C FE 44 */	b dComIfGs_onVisitedRoom__Fi
/* 80D5FD40  48 00 00 60 */	b lbl_80D5FDA0
lbl_80D5FD44:
/* 80D5FD44  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5FD48  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D5FD4C  4B 2D 53 5C */	b getSave2__10dSv_save_cFi
/* 80D5FD50  57 E0 C6 3E */	rlwinm r0, r31, 0x18, 0x18, 0x1f
/* 80D5FD54  7C 04 07 74 */	extsb r4, r0
/* 80D5FD58  4B 2D 4D 4C */	b onVisitedRoom__13dSv_memory2_cFi
...
/* 80D5FD80  4B 2C FE BC */	b dComIfGs_offVisitedRoom__Fi
/* 80D5FD84  48 00 00 1C */	b lbl_80D5FDA0
lbl_80D5FD88:
/* 80D5FD88  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5FD8C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D5FD90  4B 2D 53 18 */	b getSave2__10dSv_save_cFi
/* 80D5FD94  57 E0 C6 3E */	rlwinm r0, r31, 0x18, 0x18, 0x1f
/* 80D5FD98  7C 04 07 74 */	extsb r4, r0
/* 80D5FD9C  4B 2D 4D 2C */	b offVisitedRoom__13dSv_memory2_cFi
lbl_80D5FDA0:

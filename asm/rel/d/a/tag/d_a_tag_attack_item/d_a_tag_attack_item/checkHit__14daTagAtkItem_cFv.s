...
/* 805A2D68 00000010  4B FF FB D1 */	bl _savegpr_29
/* 805A2D6C 00000014  7C 7E 1B 78 */	mr r30, r3
/* 805A2D70 00000018  3C 60 00 00 */	lis r3, lit_3657@ha /* 805A32C8 */
/* 805A2D74 0000001C  3B E3 00 00 */	addi r31, r3, lit_3657@l /* 805A32C8 */
/* 805A2D78 00000020  38 7E 05 C0 */	addi r3, r30, 0x5c0
/* 805A2D7C 00000024  4B FF FB BD */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 805A2D8C 00000034  4B FF FB AD */	bl GetTgHitObj__12dCcD_GObjInfFv
...
lbl_805A2DB4:
/* 805A2DB4 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A2DB8 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A2DBC 00000008  83 A3 5D AC */	lwz r29, 0x5dac(r3)
...
/* 805A2DE4 0000000C  C0 3F 00 08 */	lfs f1, 8(r31)
...
/* 805A2E0C 00000034  4B FF FB 2D */	bl PSVECSquareDistance
/* 805A2E10 00000038  C0 1F 00 08 */	lfs f0, 8(r31)
...
/* 805A2E20 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)
/* 805A2E24 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805A2E28 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)
...
lbl_805A2E70:
/* 805A2E70 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)
/* 805A2E74 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805A2E78 00000000  40 80 00 10 */	bge lbl_805A2E88
/* 805A2E7C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805A2E80 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 805A2EEC 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 805A2EF0 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_805A2EF4:
/* 805A2EF4 00000000  C0 5F 00 00 */	lfs f2, 0(r31)
...
/* 805A2F1C 00000018  C0 3F 00 04 */	lfs f1, 4(r31)
...
/* 805A2F40 00000004  4B FF F9 F9 */	bl _restgpr_29

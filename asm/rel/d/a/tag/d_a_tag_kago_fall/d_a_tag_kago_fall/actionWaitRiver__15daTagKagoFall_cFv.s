...
/* 80D59E34  4B 60 83 A0 */	b _savegpr_27
...
/* 80D59F60  4B 2C 19 A8 */	b fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80D59F78  4B 40 75 58 */	b Stop__9dCamera_cFv
/* 80D59F7C  7F A3 EB 78 */	mr r3, r29
/* 80D59F80  38 80 00 03 */	li r4, 3
/* 80D59F84  4B 40 90 88 */	b SetTrimSize__9dCamera_cFl
/* 80D59F88  4B 42 76 B8 */	b dCam_getBody__Fv
/* 80D59F8C  7C 64 1B 78 */	mr r4, r3
/* 80D59F90  38 61 00 44 */	addi r3, r1, 0x44
/* 80D59F94  4B 42 7E D0 */	b Eye__9dCamera_cFv
...
/* 80D5A044  4B 55 19 40 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 80D5A048  C0 3F 00 10 */	lfs f1, 0x10(r31)
/* 80D5A04C  3C 60 80 45 */	lis r3, g_blackColor@ha
/* 80D5A050  38 63 06 04 */	addi r3, r3, g_blackColor@l
/* 80D5A054  4B 2A DF 84 */	b fadeOut__13mDoGph_gInf_cFfR8_GXColor
...
/* 80D5A098  4B 42 75 A8 */	b dCam_getBody__Fv
/* 80D5A09C  38 81 00 38 */	addi r4, r1, 0x38
/* 80D5A0A0  38 A1 00 2C */	addi r5, r1, 0x2c
/* 80D5A0A4  4B 42 6A 04 */	b Set__9dCamera_cF4cXyz4cXyz
...
/* 80D5A108  4B 42 75 38 */	b dCam_getBody__Fv
/* 80D5A10C  38 81 00 20 */	addi r4, r1, 0x20
/* 80D5A110  38 A1 00 14 */	addi r5, r1, 0x14
/* 80D5A114  4B 42 69 94 */	b Set__9dCamera_cF4cXyz4cXyz
...
/* 80D5A13C  4B 4E FE 54 */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 80D5A16C  4B 4F 01 6C */	b doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
/* 80D5A170  2C 03 00 00 */	cmpwi r3, 0
/* 80D5A174  41 82 00 8C */	beq lbl_80D5A200
/* 80D5A178  4B 4D E2 C8 */	b getSelectCursorPos__12dMsgObject_cFv
...
/* 80D5A1A0  4B 2C CF D0 */	b dStage_changeScene__FifUlScsi
/* 80D5A1A4  48 00 00 54 */	b lbl_80D5A1F8
lbl_80D5A1A8:
/* 80D5A1A8  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 80D5A1AC  8B 63 0D 64 */	lbz r27, struct_80450D64+0x0@l(r3)
/* 80D5A1B0  7F 7B 07 74 */	extsb r27, r27
/* 80D5A1B4  38 60 00 00 */	li r3, 0
/* 80D5A1B8  4B 2D 27 C4 */	b getLayerNo__14dComIfG_play_cFi
...
/* 80D5A1D0  3C 60 80 D6 */	lis r3, stringBase0@ha
/* 80D5A1D4  38 63 A7 08 */	addi r3, r3, stringBase0@l

...
/* 80D59C88 00000030  4B 2B EE DC */	b __ct__10fopAc_ac_cFv
/* 80D59C8C 00000034  38 7E 05 68 */	addi r3, r30, 0x568
/* 80D59C90 00000038  4B 4F 02 70 */	b __ct__10dMsgFlow_cFv
lbl_80D59C94:
...
/* 80D59CA4 00000004  4B 2D 2C D8 */	b getLayerNo__14dComIfG_play_cFi
...
/* 80D59CB8 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D59CBC 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D59CC0 00000020  A8 03 4E 08 */	lha r0, 0x4e08(r3)	/* effective address: 8040AFC8 */
...
/* 80D59CF8 00000004  4B 2D 2C 84 */	b getLayerNo__14dComIfG_play_cFi
...
/* 80D59D14 00000020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D59D18 00000024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D59D28 00000034  4B 5E CB C0 */	b PSMTXTrans
/* 80D59D2C 00000038  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D59D30 0000003C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D59D34 00000040  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80D59D38 00000044  4B 2B 26 FC */	b mDoMtx_YrotM__FPA4_fs
/* 80D59D3C 00000048  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D59D40 0000004C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D59D44 00000050  38 9F 05 B4 */	addi r4, r31, 0x5b4
/* 80D59D48 00000054  4B 5E C8 68 */	b PSMTXInverse
/* 80D59D4C 00000058  C0 1F 04 EC */	lfs f0, 0x4ec(r31)
/* 80D59D50 0000005C  3C 60 80 D6 */	lis r3, lit_3907@ha
/* 80D59D54 00000060  C0 23 A6 EC */	lfs f1, lit_3907@l(r3)
...
/* 80D59D70 0000007C  3C 60 80 D6 */	lis r3, lit_3908@ha
/* 80D59D74 00000080  C0 03 A6 F0 */	lfs f0, lit_3908@l(r3)
...
lbl_80D59D90:
/* 80D59D90 00000000  3C 60 80 D6 */	lis r3, m_master_id@ha
/* 80D59D94 00000004  38 63 A7 10 */	addi r3, r3, m_master_id@l
/* 80D59D98 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D5A710 */
...
lbl_80D59DBC:
/* 80D59DBC 00000000  3C 60 80 D6 */	lis r3, m_master_id@ha
/* 80D59DC0 00000004  90 03 A7 10 */	stw r0, m_master_id@l(r3)
lbl_80D59DC4:

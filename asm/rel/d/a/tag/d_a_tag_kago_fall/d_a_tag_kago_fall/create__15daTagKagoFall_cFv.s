...
/* 80D59CB8 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D59CBC 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80D59D14 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D59D18 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D59D2C 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D59D30 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D59D34 00000040  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80D59D38 00000044  4B FF FF 01 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D59D3C 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D59D40 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D59D50 0000005C  3C 60 00 00 */	lis r3, lit_3907@ha
/* 80D59D54 00000060  C0 23 00 00 */	lfs f1, lit_3907@l(r3)
...
/* 80D59D70 0000007C  3C 60 00 00 */	lis r3, lit_3908@ha
/* 80D59D74 00000080  C0 03 00 00 */	lfs f0, lit_3908@l(r3)
...
lbl_80D59D90:
/* 80D59D90 00000000  3C 60 00 00 */	lis r3, m_master_id@ha
/* 80D59D94 00000004  38 63 00 00 */	addi r3, r3, m_master_id@l
...
lbl_80D59DBC:
/* 80D59DBC 00000000  3C 60 00 00 */	lis r3, m_master_id@ha
/* 80D59DC0 00000004  90 03 00 00 */	stw r0, m_master_id@l(r3)
lbl_80D59DC4:

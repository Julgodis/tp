...
/* 80D63D90  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D63D94  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D63DA8  4B 2D 15 B8 */	b isSwitch__10dSv_info_cCFii
/* 80D63DAC  2C 03 00 00 */	cmpwi r3, 0
/* 80D63DB0  41 82 00 14 */	beq lbl_80D63DC4
/* 80D63DB4  7F E3 FB 78 */	mr r3, r31
/* 80D63DB8  4B 2B 5E C4 */	b fopAcM_delete__FP10fopAc_ac_c
/* 80D63DBC  38 60 00 01 */	li r3, 1
/* 80D63DC0  48 00 00 78 */	b lbl_80D63E38
lbl_80D63DC4:
/* 80D63DC4  7F E3 FB 78 */	mr r3, r31
/* 80D63DC8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80D63DCC  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80D63DD0  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80D63DD4  4B 2B 6C C0 */	b fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80D63DEC  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 80D63DF0  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 80D63DF4  38 81 00 08 */	addi r4, r1, 8
/* 80D63DF8  4B 2B DE 68 */	b fpcLyIt_AllJudge__FPFPvPv_PvPv
...
/* 80D63E30  4B D9 98 A8 */	b setHintEvent__11daNpcTheB_cFlUsi
lbl_80D63E34:

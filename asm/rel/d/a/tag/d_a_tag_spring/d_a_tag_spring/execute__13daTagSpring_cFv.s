...
/* 805A6B84 00000028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A6B88 0000002C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A6B8C 00000030  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A6B90 00000034  7C 05 07 74 */	extsb r5, r0
/* 805A6B94 00000038  4B A8 E7 CC */	b isSwitch__10dSv_info_cCFii
...
lbl_805A6BA8:
/* 805A6BA8 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A6BAC 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A6BB0 00000008  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 805A6BDC 00000018  4B A7 71 A8 */	b waterCheck__11fopAcM_wt_cFPC4cXyz
/* 805A6BE0 0000001C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 805A6BE4 00000020  41 82 00 7C */	beq lbl_805A6C60
/* 805A6BE8 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A6BEC 00000028  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A6BF0 0000002C  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
/* 805A6BF4 00000030  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb
/* 805A6BF8 00000034  40 82 00 18 */	bne lbl_805A6C10
/* 805A6BFC 00000038  3C 60 80 45 */	lis r3, mWaterY__11fopAcM_wt_c@ha
/* 805A6C00 0000003C  C0 23 0C D8 */	lfs f1, mWaterY__11fopAcM_wt_c@l(r3)
...
/* 805A6C38 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A6C3C 0000000C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 805A6C40 00000010  C0 24 5D C0 */	lfs f1, 0x5dc0(r4)	/* effective address: 8040BF80 */
/* 805A6C44 00000014  3C 60 80 5A */	lis r3, lit_3728@ha
/* 805A6C48 00000018  C0 03 6E 6C */	lfs f0, lit_3728@l(r3)
/* 805A6C4C 0000001C  EC 01 00 2A */	fadds f0, f1, f0
/* 805A6C50 00000020  D0 04 5D C0 */	stfs f0, 0x5dc0(r4)	/* effective address: 8040BF80 */
/* 805A6C54 00000024  38 00 00 01 */	li r0, 1
/* 805A6C58 00000028  98 04 5E B6 */	stb r0, 0x5eb6(r4)	/* effective address: 8040C076 */

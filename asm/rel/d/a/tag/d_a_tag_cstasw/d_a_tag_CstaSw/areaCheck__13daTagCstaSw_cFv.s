...
/* 805A21B0 00000010  4B DC 00 2C */	b _savegpr_29
/* 805A21B4 00000014  7C 7D 1B 78 */	mr r29, r3
/* 805A21B8 00000018  3C 60 80 5A */	lis r3, lit_3724@ha
/* 805A21BC 0000001C  3B E3 25 2C */	addi r31, r3, lit_3724@l
/* 805A21C0 00000020  3B C0 00 00 */	li r30, 0
/* 805A21C4 00000024  3C 60 80 5A */	lis r3, searchSekizoAct__13daTagCstaSw_cFPvPv@ha
/* 805A21C8 00000028  38 63 21 50 */	addi r3, r3, searchSekizoAct__13daTagCstaSw_cFPvPv@l
/* 805A21CC 0000002C  7F A4 EB 78 */	mr r4, r29
/* 805A21D0 00000030  4B A7 76 28 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 805A21F0 0000000C  4B CC 49 44 */	b __mi__4cXyzCFRC3Vec
...
/* 805A2210 0000002C  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 805A252C */
...
/* 805A2220 0000003C  4B DA 4F 18 */	b PSVECSquareMag
/* 805A2224 00000040  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 805A252C */
...
/* 805A2234 00000008  C8 9F 00 08 */	lfd f4, 8(r31)	/* effective address: 805A2534 */
/* 805A2238 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 805A223C 00000010  C8 7F 00 10 */	lfd f3, 0x10(r31)	/* effective address: 805A253C */
...
lbl_805A2284:
/* 805A2284 00000000  C8 1F 00 18 */	lfd f0, 0x18(r31)	/* effective address: 805A2544 */
/* 805A2288 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 805A228C 00000000  40 80 00 10 */	bge lbl_805A229C
/* 805A2290 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805A2294 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 805A2300 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 805A2304 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_805A2308:
/* 805A2308 00000000  C0 5F 00 20 */	lfs f2, 0x20(r31)	/* effective address: 805A254C */
...
/* 805A232C 00000004  4B DB FE FC */	b _restgpr_29

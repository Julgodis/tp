...
/* 805A35B0 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A35B4 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A35B8 00000028  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A35BC 0000002C  7C 05 07 74 */	extsb r5, r0
/* 805A35C0 00000030  4B A9 1D A0 */	b isSwitch__10dSv_info_cCFii
...
/* 805A35D8 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A35DC 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A35E0 00000014  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A35E4 00000018  7C 05 07 74 */	extsb r5, r0
/* 805A35E8 0000001C  4B A9 1D 78 */	b isSwitch__10dSv_info_cCFii
...
/* 805A3600 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A3604 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A3608 00000014  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 805A360C 00000018  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
/* 805A3610 0000001C  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6
/* 805A3614 00000020  41 82 00 2C */	beq lbl_805A3640
lbl_805A3618:
/* 805A3618 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A361C 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A3620 00000008  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 805A3630 00000018  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */

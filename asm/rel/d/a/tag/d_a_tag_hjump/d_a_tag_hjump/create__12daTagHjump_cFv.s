...
/* 805A3B34  4B DB E6 A8 */	b _savegpr_29
/* 805A3B38  7C 7D 1B 78 */	mr r29, r3
/* 805A3B3C  3C 80 80 5A */	lis r4, l_arcName@ha
/* 805A3B40  3B E4 42 38 */	addi r31, r4, l_arcName@l
...
/* 805A3B58  4B AD 4A CC */	b __ct__16dBgS_MoveBgActorFv
/* 805A3B5C  3C 60 80 5A */	lis r3, __vt__12daTagHjump_c@ha
/* 805A3B60  38 03 42 BC */	addi r0, r3, __vt__12daTagHjump_c@l
...
/* 805A3BCC  4B A8 92 F0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 805A3BF4  4B AD 4B C8 */	b MoveBGCreate__16dBgS_MoveBgActorFPCciPFP4dBgWPvRC13cBgS_PolyInfobP4cXyzP5csXyzP5csXyz_vUlPA3_A4_f
...
/* 805A3C18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A3C1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A3C20  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 805A3C24  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 805A3C28  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 805A3C2C  4B DA 2C BC */	b PSMTXTrans
/* 805A3C30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A3C34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805A3C38  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 805A3C3C  4B A6 87 F8 */	b mDoMtx_YrotM__FPA4_fs
/* 805A3C40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805A3C44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 805A3CBC  4B A7 68 6C */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 805A3CD0  4B A7 68 68 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 805A3D6C  4B DB E4 BC */	b _restgpr_29

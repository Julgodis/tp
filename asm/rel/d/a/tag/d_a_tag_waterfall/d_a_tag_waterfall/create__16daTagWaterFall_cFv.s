...
/* 80D64B48  4B 2B 40 1C */	b __ct__10fopAc_ac_cFv
lbl_80D64B4C:
/* 80D64B4C  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 80D64B50  60 00 00 08 */	ori r0, r0, 8
/* 80D64B54  90 1F 04 A0 */	stw r0, 0x4a0(r31)
lbl_80D64B58:
/* 80D64B58  3C 60 80 D6 */	lis r3, data_80D64E00@ha
/* 80D64B5C  8C 03 4E 00 */	lbzu r0, data_80D64E00@l(r3)
...
/* 80D64B8C  3C 60 80 D6 */	lis r3, lit_3959@ha
/* 80D64B90  C8 23 4D 84 */	lfd f1, lit_3959@l(r3)
...
/* 80D64BB0  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64BB4  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)
...
/* 80D64BCC  3C 60 80 D6 */	lis r3, lit_3959@ha
/* 80D64BD0  C8 23 4D 84 */	lfd f1, lit_3959@l(r3)
...
/* 80D64BF0  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64BF4  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)
...
/* 80D64C0C  3C 60 80 D6 */	lis r3, lit_3960@ha
/* 80D64C10  C8 23 4D 8C */	lfd f1, lit_3960@l(r3)
...
/* 80D64C34  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64C38  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)
...
lbl_80D64C88:
/* 80D64C88  3C 60 80 D6 */	lis r3, m_master_id@ha
/* 80D64C8C  90 03 4D 94 */	stw r0, m_master_id@l(r3)
/* 80D64C90  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64C94  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)

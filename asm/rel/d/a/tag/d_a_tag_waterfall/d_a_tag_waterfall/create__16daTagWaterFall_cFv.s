...
/* 80D64B48 00000028  4B 2B 40 1C */	b __ct__10fopAc_ac_cFv
lbl_80D64B4C:
...
lbl_80D64B58:
/* 80D64B58 00000000  3C 60 80 D6 */	lis r3, data_80D64E00@ha
/* 80D64B5C 00000004  8C 03 4E 00 */	lbzu r0, data_80D64E00@l(r3)
...
/* 80D64B6C 00000014  98 03 00 00 */	stb r0, 0(r3)	/* effective address: 80D60000 */
/* 80D64B70 00000018  98 1F 05 83 */	stb r0, 0x583(r31)
/* 80D64B74 0000001C  38 00 FF FF */	li r0, -1
/* 80D64B78 00000020  3C 60 80 D6 */	lis r3, l_HIO@ha
/* 80D64B7C 00000024  38 63 4E 10 */	addi r3, r3, l_HIO@l
/* 80D64B80 00000028  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80D64E14 */
lbl_80D64B84:
/* 80D64B84 00000000  80 1F 00 B0 */	lwz r0, 0xb0(r31)
/* 80D64B88 00000004  54 00 04 3E */	clrlwi r0, r0, 0x10
/* 80D64B8C 00000008  3C 60 80 D6 */	lis r3, lit_3959@ha
/* 80D64B90 0000000C  C8 23 4D 84 */	lfd f1, lit_3959@l(r3)
...
/* 80D64BB0 0000002C  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64BB4 00000030  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)
...
/* 80D64BCC 00000008  3C 60 80 D6 */	lis r3, lit_3959@ha
/* 80D64BD0 0000000C  C8 23 4D 84 */	lfd f1, lit_3959@l(r3)
...
/* 80D64BF0 0000002C  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64BF4 00000030  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)
...
/* 80D64C0C 00000008  3C 60 80 D6 */	lis r3, lit_3960@ha
/* 80D64C10 0000000C  C8 23 4D 8C */	lfd f1, lit_3960@l(r3)
...
/* 80D64C34 00000030  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64C38 00000034  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)
...
/* 80D64C5C 0000000C  3C 60 80 D6 */	lis r3, m_master_id@ha
/* 80D64C60 00000010  38 63 4D 94 */	addi r3, r3, m_master_id@l
/* 80D64C64 00000014  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D64D94 */
...
lbl_80D64C88:
/* 80D64C88 00000000  3C 60 80 D6 */	lis r3, m_master_id@ha
/* 80D64C8C 00000004  90 03 4D 94 */	stw r0, m_master_id@l(r3)
/* 80D64C90 00000008  3C 60 80 D6 */	lis r3, lit_3758@ha
/* 80D64C94 0000000C  C0 03 4D 74 */	lfs f0, lit_3758@l(r3)

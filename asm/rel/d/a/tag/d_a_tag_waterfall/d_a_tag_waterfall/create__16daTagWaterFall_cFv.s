...
lbl_80D64B58:
/* 80D64B58 00000000  3C 60 00 00 */	lis r3, data_80D64E00@ha /* 80D64E00 */
/* 80D64B5C 00000004  8C 03 00 00 */	lbzu r0, data_80D64E00@l(r3) /* 80D64E00 */
...
/* 80D64B78 00000020  3C 60 00 00 */	lis r3, l_HIO@ha /* 80D64E10 */
/* 80D64B7C 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80D64E10 */
...
/* 80D64B8C 00000008  3C 60 00 00 */	lis r3, lit_3959@ha /* 80D64D84 */
/* 80D64B90 0000000C  C8 23 00 00 */	lfd f1, lit_3959@l(r3) /* 80D64D84 */
...
/* 80D64BB0 0000002C  3C 60 00 00 */	lis r3, lit_3758@ha /* 80D64D74 */
/* 80D64BB4 00000030  C0 03 00 00 */	lfs f0, lit_3758@l(r3) /* 80D64D74 */
...
/* 80D64BCC 00000008  3C 60 00 00 */	lis r3, lit_3959@ha /* 80D64D84 */
/* 80D64BD0 0000000C  C8 23 00 00 */	lfd f1, lit_3959@l(r3) /* 80D64D84 */
...
/* 80D64BF0 0000002C  3C 60 00 00 */	lis r3, lit_3758@ha /* 80D64D74 */
/* 80D64BF4 00000030  C0 03 00 00 */	lfs f0, lit_3758@l(r3) /* 80D64D74 */
...
/* 80D64C0C 00000008  3C 60 00 00 */	lis r3, lit_3960@ha /* 80D64D8C */
/* 80D64C10 0000000C  C8 23 00 00 */	lfd f1, lit_3960@l(r3) /* 80D64D8C */
...
/* 80D64C34 00000030  3C 60 00 00 */	lis r3, lit_3758@ha /* 80D64D74 */
/* 80D64C38 00000034  C0 03 00 00 */	lfs f0, lit_3758@l(r3) /* 80D64D74 */
...
/* 80D64C5C 0000000C  3C 60 00 00 */	lis r3, m_master_id@ha /* 80D64D94 */
/* 80D64C60 00000010  38 63 00 00 */	addi r3, r3, m_master_id@l /* 80D64D94 */
...
lbl_80D64C88:
/* 80D64C88 00000000  3C 60 00 00 */	lis r3, m_master_id@ha /* 80D64D94 */
/* 80D64C8C 00000004  90 03 00 00 */	stw r0, m_master_id@l(r3) /* 80D64D94 */
/* 80D64C90 00000008  3C 60 00 00 */	lis r3, lit_3758@ha /* 80D64D74 */
/* 80D64C94 0000000C  C0 03 00 00 */	lfs f0, lit_3758@l(r3) /* 80D64D74 */

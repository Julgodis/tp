...
/* 8048F9F8  4B ED 27 D8 */	b _savegpr_26
/* 8048F9FC  7C 7D 1B 78 */	mr r29, r3
/* 8048FA00  3B C0 00 01 */	li r30, 1
/* 8048FA04  3C 80 80 45 */	lis r4, struct_80450D64+0x0@ha
/* 8048FA08  88 04 0D 64 */	lbz r0, struct_80450D64+0x0@l(r4)
/* 8048FA0C  98 03 04 E2 */	stb r0, 0x4e2(r3)
/* 8048FA10  C0 43 04 D8 */	lfs f2, 0x4d8(r3)
/* 8048FA14  3C 80 80 49 */	lis r4, lit_3757@ha
/* 8048FA18  C0 24 01 7C */	lfs f1, lit_3757@l(r4)
...
/* 8048FA4C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8048FA50  3B E4 61 C0 */	addi r31, r4, struct_804061C0+0x0@l
/* 8048FA54  88 1F 4F AD */	lbz r0, 0x4fad(r31)	/* effective address: 8040B16D */
...
/* 8048FA9C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8048FAA0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8048FAA4  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8048FAA8  7C 05 07 74 */	extsb r5, r0
/* 8048FAAC  4B BA 57 54 */	b onSwitch__10dSv_info_cFii
lbl_8048FAB0:
/* 8048FAB0  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 8048FAB4  4B BB 29 B4 */	b reset__14dEvt_control_cFv
...
/* 8048FADC  4B BB 7F 9C */	b endCheck__16dEvent_manager_cFs
...
/* 8048FB10  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8048FB14  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8048FB18  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 8048FB1C  7C 05 07 74 */	extsb r5, r0
/* 8048FB20  4B BA 56 E0 */	b onSwitch__10dSv_info_cFii
lbl_8048FB24:
/* 8048FB24  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 8048FB28  4B BB 29 40 */	b reset__14dEvt_control_cFv
...
/* 8048FB44  4B BB 7F D8 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
/* 8048FB48  7C 7B 1B 78 */	mr r27, r3
/* 8048FB4C  7F 43 D3 78 */	mr r3, r26
/* 8048FB50  7F 64 DB 78 */	mr r4, r27
/* 8048FB54  3C A0 80 49 */	lis r5, mEvtCutTBL__11daTag_Msg_c@ha
/* 8048FB58  38 A5 01 D0 */	addi r5, r5, mEvtCutTBL__11daTag_Msg_c@l
/* 8048FB5C  38 C0 00 02 */	li r6, 2
/* 8048FB60  38 E0 00 00 */	li r7, 0
/* 8048FB64  39 00 00 00 */	li r8, 0
/* 8048FB68  4B BB 82 A8 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
/* 8048FB6C  7C 7C 1B 78 */	mr r28, r3
/* 8048FB70  7F 43 D3 78 */	mr r3, r26
/* 8048FB74  7F 64 DB 78 */	mr r4, r27
/* 8048FB78  4B BB 81 D4 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8048FBAC  4B BB 85 D0 */	b cutEnd__16dEvent_manager_cFi
lbl_8048FBB0:
...
/* 8048FBFC  3C A0 80 49 */	lis r5, l_evtNameTBL@ha
/* 8048FC00  38 A5 01 C8 */	addi r5, r5, l_evtNameTBL@l
/* 8048FC04  7C A5 00 2E */	lwzx r5, r5, r0
/* 8048FC08  38 C0 00 FF */	li r6, 0xff
/* 8048FC0C  4B BB 7B 4C */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 8048FC30  4B B8 BA 4C */	b fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
...
/* 8048FC54  4B ED 25 C8 */	b _restgpr_26

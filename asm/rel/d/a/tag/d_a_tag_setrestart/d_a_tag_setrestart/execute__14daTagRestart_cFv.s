...
/* 80D60570 00000010  4B 60 1C 68 */	b _savegpr_28
/* 80D60574 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80D60578 00000018  3C 60 80 D6 */	lis r3, lit_3650@ha
/* 80D6057C 0000001C  3B E3 07 B4 */	addi r31, r3, lit_3650@l
/* 80D60580 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D60584 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80D60588 00000028  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80D605B0 00000050  4B 5E 6B 04 */	b PSVECSubtract
/* 80D605B4 00000054  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D605B8 00000058  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D605C8 00000068  4B 2A BE 14 */	b mDoMtx_YrotS__FPA4_fs
/* 80D605CC 0000006C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D605D0 00000070  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D605D4 00000074  38 81 00 2C */	addi r4, r1, 0x2c
/* 80D605D8 00000078  7C 85 23 78 */	mr r5, r4
/* 80D605DC 0000007C  4B 5E 67 90 */	b PSMTXMultVec
...
/* 80D60618 00000004  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 80D6061C 00000008  38 63 0D 64 */	addi r3, r3, struct_80450D64+0x0@l
/* 80D60620 0000000C  88 63 00 00 */	lbz r3, 0(r3)	/* effective address: 80450D64 */
...
/* 80D6064C 00000038  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80D607BC */
/* 80D60650 0000003C  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80D60654 00000040  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80D60658 00000044  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80D607B8 */
...
/* 80D60674 00000010  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80D607BC */
/* 80D60678 00000014  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 80D6067C 00000018  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80D60680 0000001C  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80D607B4 */
/* 80D60684 00000020  D0 01 00 28 */	stfs f0, 0x28(r1)
lbl_80D60688:
/* 80D60688 00000000  C0 21 00 24 */	lfs f1, 0x24(r1)
/* 80D6068C 00000004  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80D607B8 */
/* 80D60690 00000008  EC 01 00 2A */	fadds f0, f1, f0
/* 80D60694 0000000C  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80D60698 00000010  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D6069C 00000014  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D606A0 00000018  A8 9D 04 B6 */	lha r4, 0x4b6(r29)
/* 80D606A4 0000001C  4B 2A BD 38 */	b mDoMtx_YrotS__FPA4_fs
/* 80D606A8 00000020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D606AC 00000024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D606B0 00000028  38 81 00 20 */	addi r4, r1, 0x20
/* 80D606B4 0000002C  7C 85 23 78 */	mr r5, r4
/* 80D606B8 00000030  4B 5E 66 B4 */	b PSMTXMultVec
...
/* 80D606C8 00000040  4B 50 64 1C */	b __pl__4cXyzCFRC3Vec
...
/* 80D606E8 00000060  4B 2B D5 D4 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80D606EC 00000064  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D606F0 00000068  41 82 00 10 */	beq lbl_80D60700
/* 80D606F4 0000006C  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80D606F8 00000070  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 80D60708 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D6070C 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80D6071C 0000001C  4B 2D 48 64 */	b setRoom__13dSv_restart_cFRC4cXyzsSc
lbl_80D60720:
...
/* 80D60730 00000010  4B 60 1A F4 */	b _restgpr_28

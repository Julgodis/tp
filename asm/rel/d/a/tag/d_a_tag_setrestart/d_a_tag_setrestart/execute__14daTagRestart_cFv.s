...
/* 80D60570  4B 60 1C 68 */	b _savegpr_28
/* 80D60574  7C 7D 1B 78 */	mr r29, r3
/* 80D60578  3C 60 80 D6 */	lis r3, lit_3650@ha
/* 80D6057C  3B E3 07 B4 */	addi r31, r3, lit_3650@l
/* 80D60580  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D60584  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D60588  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80D605B0  4B 5E 6B 04 */	b PSVECSubtract
/* 80D605B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D605B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D605BC  A8 1D 04 DE */	lha r0, 0x4de(r29)
/* 80D605C0  7C 00 00 D0 */	neg r0, r0
/* 80D605C4  7C 04 07 34 */	extsh r4, r0
/* 80D605C8  4B 2A BE 14 */	b mDoMtx_YrotS__FPA4_fs
/* 80D605CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D605D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D605D4  38 81 00 2C */	addi r4, r1, 0x2c
/* 80D605D8  7C 85 23 78 */	mr r5, r4
/* 80D605DC  4B 5E 67 90 */	b PSMTXMultVec
...
/* 80D60618  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 80D6061C  38 63 0D 64 */	addi r3, r3, struct_80450D64+0x0@l
/* 80D60620  88 63 00 00 */	lbz r3, 0(r3)	/* effective address: 80450D64 */
...
/* 80D60698  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D6069C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D606A0  A8 9D 04 B6 */	lha r4, 0x4b6(r29)
/* 80D606A4  4B 2A BD 38 */	b mDoMtx_YrotS__FPA4_fs
/* 80D606A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D606AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D606B0  38 81 00 20 */	addi r4, r1, 0x20
/* 80D606B4  7C 85 23 78 */	mr r5, r4
/* 80D606B8  4B 5E 66 B4 */	b PSMTXMultVec
/* 80D606BC  38 61 00 08 */	addi r3, r1, 8
/* 80D606C0  38 9D 04 D0 */	addi r4, r29, 0x4d0
/* 80D606C4  38 A1 00 20 */	addi r5, r1, 0x20
/* 80D606C8  4B 50 64 1C */	b __pl__4cXyzCFRC3Vec
...
/* 80D606E8  4B 2B D5 D4 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80D606EC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80D606F0  41 82 00 10 */	beq lbl_80D60700
/* 80D606F4  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80D606F8  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
/* 80D606FC  D0 01 00 18 */	stfs f0, 0x18(r1)
lbl_80D60700:
/* 80D60700  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80D60704  7C 06 07 74 */	extsb r6, r0
/* 80D60708  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D6070C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D60710  38 63 0D B4 */	addi r3, r3, 0xdb4
/* 80D60714  38 81 00 14 */	addi r4, r1, 0x14
/* 80D60718  7F 85 E3 78 */	mr r5, r28
/* 80D6071C  4B 2D 48 64 */	b setRoom__13dSv_restart_cFRC4cXyzsSc
lbl_80D60720:
...
/* 80D60730  4B 60 1A F4 */	b _restgpr_28

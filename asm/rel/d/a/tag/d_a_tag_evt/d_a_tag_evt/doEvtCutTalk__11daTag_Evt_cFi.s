...
/* 8048C134  4B ED 60 A8 */	b _savegpr_29
/* 8048C138  7C 7D 1B 78 */	mr r29, r3
/* 8048C13C  7C 9E 23 78 */	mr r30, r4
/* 8048C140  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8048C144  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8048C148  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 8048C14C  7F E3 FB 78 */	mr r3, r31
/* 8048C150  4B BB BB FC */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8048C164  3C A0 80 49 */	lis r5, struct_8048C3BC+0x0@ha
/* 8048C168  38 A5 C3 BC */	addi r5, r5, struct_8048C3BC+0x0@l
/* 8048C16C  38 A5 00 32 */	addi r5, r5, 0x32
/* 8048C170  38 C0 00 03 */	li r6, 3
/* 8048C174  4B BB BF 78 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8048C190  4B DB DE 00 */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
...
/* 8048C1AC  4B DB E1 2C */	b doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
lbl_8048C1B0:
/* 8048C1B0  39 61 00 20 */	addi r11, r1, 0x20
/* 8048C1B4  4B ED 60 74 */	b _restgpr_29

...
/* 805A38C0 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A38C4 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A38C8 0000002C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 805A38CC 00000030  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 805A38D0 00000034  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 805A38D4 00000038  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
/* 805A38D8 0000003C  7C 84 02 2E */	lhzx r4, r4, r0
/* 805A38DC 00000040  4B FF FE 5D */	bl isEventBit__11dSv_event_cCFUs
...
/* 805A38F4 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A38F8 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A38FC 00000014  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 805A3900 00000018  54 00 0B FC */	rlwinm r0, r0, 1, 0xf, 0x1e
/* 805A3904 0000001C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 805A3908 00000020  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
/* 805A390C 00000024  7C 84 02 2E */	lhzx r4, r4, r0
/* 805A3910 00000028  4B FF FE 29 */	bl isEventBit__11dSv_event_cCFUs
...
/* 805A3928 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A392C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A3930 00000014  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A3934 00000018  7C 05 07 74 */	extsb r5, r0
/* 805A3938 0000001C  4B FF FE 01 */	bl isSwitch__10dSv_info_cCFii
...
/* 805A3950 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A3954 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A3958 00000014  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 805A395C 00000018  7C 05 07 74 */	extsb r5, r0
/* 805A3960 0000001C  4B FF FD D9 */	bl onSwitch__10dSv_info_cFii
lbl_805A3964:
/* 805A3964 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 805A3968 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 805A396C 00000008  83 C3 5D B8 */	lwz r30, 0x5db8(r3)
...
/* 805A3980 0000001C  4B FF FD B9 */	bl __ptmf_scall
...
/* 805A3998 00000034  4B FF FD A1 */	bl fopAcM_delete__FP10fopAc_ac_c
lbl_805A399C:

...
/* 8048A708  4B ED 7A D4 */	b _savegpr_29
/* 8048A70C  7C 7E 1B 78 */	mr r30, r3
/* 8048A710  3C 60 80 49 */	lis r3, lit_3769@ha
/* 8048A714  3B E3 AC 28 */	addi r31, r3, lit_3769@l
/* 8048A718  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8048A71C  7C 05 07 74 */	extsb r5, r0
/* 8048A720  3C 60 80 45 */	lis r3, struct_80450D64+0x0@ha
/* 8048A724  88 03 0D 64 */	lbz r0, struct_80450D64+0x0@l(r3)
...
lbl_8048A76C:
/* 8048A76C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8048A770  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8048A774  4B BA AB EC */	b isSwitch__10dSv_info_cCFii
...
lbl_8048A7A4:
/* 8048A7A4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8048A7A8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8048A7AC  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 8048A7B0  7C 05 07 74 */	extsb r5, r0
/* 8048A7B4  4B BA AB AC */	b isSwitch__10dSv_info_cCFii
...
/* 8048A7E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8048A7EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8048A7F0  80 83 5D B4 */	lwz r4, 0x5db4(r3)	/* effective address: 8040BF74 */
...
/* 8048A904  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8048A908  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)
...
/* 8048A974  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8048A978  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)
lbl_8048A97C:
...
/* 8048A9C4  4B CD 4B 2C */	b setLookPos__9daPy_py_cFP4cXyz
...
/* 8048A9D8  4B ED 78 50 */	b _restgpr_29

...
/* 805A5B7C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 805A5B80  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 805A5B84  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 805A5B9C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5BA0  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
...
/* 805A5C48  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 805A5CC0  98 03 00 C1 */	stb r0, 0xc1(r3)	/* effective address: 80430249 */
lbl_805A5CC4:
...
/* 805A5CE8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 805A5DAC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5DB0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805A5DF4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5DF8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805A5E5C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5E60  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805A5E98  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5E9C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805A5ECC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5ED0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A5ED4  80 83 5D AC */	lwz r4, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 805A5F1C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5F20  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805A5F50  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5F54  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 805A5F80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 805A5F84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 805A5F88  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */

...
/* 805A598C 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A5990 0000001C  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l
/* 805A5994 00000020  88 1E 4F AD */	lbz r0, 0x4fad(r30)	/* effective address: 8040B16D */
...
/* 805A59AC 00000038  80 7E 5D AC */	lwz r3, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 805A59B0 0000003C  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 80400628 */
...
/* 805A59C8 00000054  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 805A59CC 00000058  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 805A59D0 0000005C  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 805A5A0C 00000030  4B A7 5C 70 */	b fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
...
/* 805A5A20 0000000C  4B A7 57 7C */	b fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
/* 805A5A24 00000010  48 00 00 A8 */	b lbl_805A5ACC
lbl_805A5A28:
/* 805A5A28 00000000  80 7E 5D AC */	lwz r3, 0x5dac(r30)	/* effective address: 8040BF6C */
...
/* 805A5A3C 00000014  3C 80 80 5A */	lis r4, stringBase0@ha
/* 805A5A40 00000018  38 84 60 4C */	addi r4, r4, stringBase0@l
/* 805A5A44 0000001C  4B DC 2F 50 */	b strcmp
...
/* 805A5A5C 0000000C  4B AC DE A0 */	b request__10dAttHint_cFP10fopAc_ac_ci
...
/* 805A5A88 00000038  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 805A5A8C 0000003C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 805A5A90 00000040  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 805A5AA4 00000054  3D 00 80 5A */	lis r8, lit_3803@ha
/* 805A5AA8 00000058  C0 28 60 40 */	lfs f1, lit_3803@l(r8)
/* 805A5AAC 0000005C  FC 40 08 90 */	fmr f2, f1
/* 805A5AB0 00000060  3D 00 80 5A */	lis r8, lit_3804@ha
/* 805A5AB4 00000064  C0 68 60 44 */	lfs f3, lit_3804@l(r8)
/* 805A5AB8 00000068  FC 80 18 90 */	fmr f4, f3
/* 805A5ABC 0000006C  39 00 00 00 */	li r8, 0
/* 805A5AC0 00000070  4B D0 5E C4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_805A5AC4:

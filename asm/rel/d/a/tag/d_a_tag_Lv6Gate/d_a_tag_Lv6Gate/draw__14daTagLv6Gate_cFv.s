...
/* 80D506BC  4B 61 1B 1C */	b _savegpr_28
/* 80D506C0  7C 7E 1B 78 */	mr r30, r3
/* 80D506C4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D506C8  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80D5070C  4B 2E 4C 54 */	b isSwitch__10dSv_info_cCFii
/* 80D50710  2C 03 00 00 */	cmpwi r3, 0
/* 80D50714  41 82 00 84 */	beq lbl_80D50798
/* 80D50718  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D5071C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80D50720  80 9E 05 68 */	lwz r4, 0x568(r30)
/* 80D50724  80 84 00 04 */	lwz r4, 4(r4)
/* 80D50728  38 BE 01 0C */	addi r5, r30, 0x10c
/* 80D5072C  4B 45 46 74 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80D50744  4B 2B CF 94 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
...
/* 80D5075C  4B 2B CF 7C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
/* 80D50760  80 7E 05 68 */	lwz r3, 0x568(r30)
/* 80D50764  4B 2B D5 60 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80D5077C  4B 5D F0 38 */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
...
/* 80D50794  4B 5D F0 20 */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_80D50798:
...
/* 80D507F4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80D507F8  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 80D50834  4B 61 19 F0 */	b _restgpr_28

...
/* 80D4FBE8  4B 61 25 F4 */	b _savegpr_29
/* 80D4FBEC  7C 7F 1B 78 */	mr r31, r3
/* 80D4FBF0  3C 80 80 D5 */	lis r4, l_minRelative@ha
/* 80D4FBF4  3B C4 09 08 */	addi r30, r4, l_minRelative@l
...
/* 80D4FC10  4B 2C 8F 54 */	b __ct__10fopAc_ac_cFv
/* 80D4FC14  38 7D 05 78 */	addi r3, r29, 0x578
/* 80D4FC18  3C 80 80 08 */	lis r4, __ct__4dBgWFv@ha
/* 80D4FC1C  38 84 B9 70 */	addi r4, r4, __ct__4dBgWFv@l
/* 80D4FC20  3C A0 80 D5 */	lis r5, __dt__4dBgWFv@ha
/* 80D4FC24  38 A5 FE 5C */	addi r5, r5, __dt__4dBgWFv@l
/* 80D4FC28  38 C0 00 C0 */	li r6, 0xc0
/* 80D4FC2C  38 E0 00 02 */	li r7, 2
/* 80D4FC30  4B 61 21 30 */	b __construct_array
lbl_80D4FC34:
...
/* 80D4FC44  3C 80 80 D5 */	lis r4, l_arcName@ha
/* 80D4FC48  38 84 09 C8 */	addi r4, r4, l_arcName@l
/* 80D4FC4C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80D509C8 */
/* 80D4FC50  4B 2D D2 6C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80D4FC64  3C 80 80 D5 */	lis r4, createSolidHeap__FP10fopAc_ac_c@ha
/* 80D4FC68  38 84 F8 98 */	addi r4, r4, createSolidHeap__FP10fopAc_ac_c@l
/* 80D4FC6C  38 A0 78 00 */	li r5, 0x7800
/* 80D4FC70  4B 2C A8 40 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80D4FCA0  4B 2C A8 A8 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80D4FCBC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D4FCC0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D4FCD4  4B 2E 56 8C */	b isSwitch__10dSv_info_cCFii
...
/* 80D4FD20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD28  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 80D4FD2C  FC 40 08 90 */	fmr f2, f1
/* 80D4FD30  FC 60 08 90 */	fmr f3, f1
/* 80D4FD34  4B 5F 6B B4 */	b PSMTXTrans
/* 80D4FD38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD40  38 80 00 00 */	li r4, 0
/* 80D4FD44  4B 2B C6 F0 */	b mDoMtx_YrotM__FPA4_fs
/* 80D4FD48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD50  38 9F 06 F8 */	addi r4, r31, 0x6f8
/* 80D4FD54  4B 5F 67 5C */	b PSMTXCopy
/* 80D4FD58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD60  80 9F 05 68 */	lwz r4, 0x568(r31)
/* 80D4FD64  38 84 00 24 */	addi r4, r4, 0x24
/* 80D4FD68  4B 5F 67 48 */	b PSMTXCopy
/* 80D4FD6C  38 7F 05 78 */	addi r3, r31, 0x578
/* 80D4FD70  4B 32 BC 50 */	b Move__4dBgWFv
/* 80D4FD74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD7C  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 80D4FD80  C0 5E 00 64 */	lfs f2, 0x64(r30)
/* 80D4FD84  C0 7E 00 68 */	lfs f3, 0x68(r30)
/* 80D4FD88  4B 5F 6B 60 */	b PSMTXTrans
/* 80D4FD8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD94  38 80 00 00 */	li r4, 0
/* 80D4FD98  4B 2B C6 9C */	b mDoMtx_YrotM__FPA4_fs
/* 80D4FD9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FDA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FDA4  38 9F 07 28 */	addi r4, r31, 0x728
/* 80D4FDA8  4B 5F 67 08 */	b PSMTXCopy
/* 80D4FDAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FDB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FDB4  80 9F 05 6C */	lwz r4, 0x56c(r31)
/* 80D4FDB8  38 84 00 24 */	addi r4, r4, 0x24
/* 80D4FDBC  4B 5F 66 F4 */	b PSMTXCopy
/* 80D4FDC0  38 7F 06 38 */	addi r3, r31, 0x638
/* 80D4FDC4  4B 32 BB FC */	b Move__4dBgWFv
/* 80D4FDC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D4FDCC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D4FDE0  4B 2E 55 80 */	b isSwitch__10dSv_info_cCFii
...
/* 80D4FE14  4B 51 75 E0 */	b __ct__5csXyzFsss

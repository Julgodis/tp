...
/* 80D4FBF0 00000018  3C 80 00 00 */	lis r4, l_minRelative@ha
/* 80D4FBF4 0000001C  3B C4 00 00 */	addi r30, r4, l_minRelative@l
...
/* 80D4FC18 00000040  3C 80 00 00 */	lis r4, __ct__4dBgWFv@ha
/* 80D4FC1C 00000044  38 84 00 00 */	addi r4, r4, __ct__4dBgWFv@l
/* 80D4FC20 00000048  3C A0 00 00 */	lis r5, __dt__4dBgWFv@ha
/* 80D4FC24 0000004C  38 A5 00 00 */	addi r5, r5, __dt__4dBgWFv@l
...
/* 80D4FC44 00000004  3C 80 00 00 */	lis r4, l_arcName@ha
/* 80D4FC48 00000008  38 84 00 00 */	addi r4, r4, l_arcName@l
...
/* 80D4FC64 00000024  3C 80 00 00 */	lis r4, createSolidHeap__FP10fopAc_ac_c@ha
/* 80D4FC68 00000028  38 84 00 00 */	addi r4, r4, createSolidHeap__FP10fopAc_ac_c@l
...
/* 80D4FCBC 00000038  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D4FCC0 0000003C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80D4FD20 0000009C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD24 000000A0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D4FD38 000000B4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD3C 000000B8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD40 000000BC  38 80 00 00 */	li r4, 0
/* 80D4FD44 000000C0  4B FF FB 35 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D4FD48 000000C4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD4C 000000C8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD50 000000CC  38 9F 06 F8 */	addi r4, r31, 0x6f8
/* 80D4FD54 000000D0  4B FF FB 25 */	bl PSMTXCopy
/* 80D4FD58 000000D4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD5C 000000D8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D4FD74 000000F0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD78 000000F4  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D4FD8C 00000108  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FD90 0000010C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FD94 00000110  38 80 00 00 */	li r4, 0
/* 80D4FD98 00000114  4B FF FA E1 */	bl mDoMtx_YrotM__FPA4_fs
/* 80D4FD9C 00000118  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FDA0 0000011C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D4FDA4 00000120  38 9F 07 28 */	addi r4, r31, 0x728
/* 80D4FDA8 00000124  4B FF FA D1 */	bl PSMTXCopy
/* 80D4FDAC 00000128  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D4FDB0 0000012C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80D4FDC8 00000144  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80D4FDCC 00000148  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l

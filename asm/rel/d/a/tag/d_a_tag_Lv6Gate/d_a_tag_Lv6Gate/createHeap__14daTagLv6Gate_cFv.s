...
/* 80D4F8C8  4B 61 29 0C */	b _savegpr_27
/* 80D4F8CC  7C 7D 1B 78 */	mr r29, r3
/* 80D4F8D0  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D4F8D4  38 63 09 C8 */	addi r3, r3, l_arcName@l
/* 80D4F8D8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D509C8 */
/* 80D4F8DC  38 80 00 0F */	li r4, 0xf
/* 80D4F8E0  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80D4F8E4  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80D4F8F8  4B 2E C9 F4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4F90C  4B 2C 53 48 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D4F928:
/* 80D4F928  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D4F92C  38 63 09 C8 */	addi r3, r3, l_arcName@l
/* 80D4F930  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D509C8 */
/* 80D4F934  38 80 00 13 */	li r4, 0x13
/* 80D4F938  7F C5 F3 78 */	mr r5, r30
/* 80D4F93C  38 C0 00 80 */	li r6, 0x80
/* 80D4F940  4B 2E C9 AC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D4F944  7C 7B 1B 78 */	mr r27, r3
/* 80D4F948  38 60 00 18 */	li r3, 0x18
/* 80D4F94C  4B 57 F3 00 */	b __nw__FUl
/* 80D4F950  7C 7C 1B 79 */	or. r28, r3, r3
/* 80D4F954  41 82 00 20 */	beq lbl_80D4F974
/* 80D4F958  3C 80 80 D5 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D4F95C  38 04 0A 1C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D4F960  90 1C 00 00 */	stw r0, 0(r28)
/* 80D4F964  38 80 00 00 */	li r4, 0
/* 80D4F968  4B 5D 8A 94 */	b init__12J3DFrameCtrlFs
...
/* 80D4F994  3D 00 80 D5 */	lis r8, lit_3757@ha
/* 80D4F998  C0 28 09 20 */	lfs f1, lit_3757@l(r8)
/* 80D4F99C  39 00 00 00 */	li r8, 0
/* 80D4F9A0  39 20 FF FF */	li r9, -1
/* 80D4F9A4  4B 2B DC 98 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80D4F9B8:
/* 80D4F9B8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D4F9BC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D4F9D0  4B 2E 59 90 */	b isSwitch__10dSv_info_cCFii
...
/* 80D4F9E4  3C 60 80 D5 */	lis r3, lit_3759@ha
/* 80D4F9E8  C8 23 09 28 */	lfd f1, lit_3759@l(r3)
...
lbl_80D4FA08:
/* 80D4FA08  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D4FA0C  38 63 09 C8 */	addi r3, r3, l_arcName@l
/* 80D4FA10  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D509C8 */
/* 80D4FA14  38 80 00 14 */	li r4, 0x14
/* 80D4FA18  7F C5 F3 78 */	mr r5, r30
/* 80D4FA1C  38 C0 00 80 */	li r6, 0x80
/* 80D4FA20  4B 2E C8 CC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80D4FA24  7C 7B 1B 78 */	mr r27, r3
/* 80D4FA28  38 60 00 18 */	li r3, 0x18
/* 80D4FA2C  4B 57 F2 20 */	b __nw__FUl
/* 80D4FA30  7C 7C 1B 79 */	or. r28, r3, r3
/* 80D4FA34  41 82 00 20 */	beq lbl_80D4FA54
/* 80D4FA38  3C 80 80 D5 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80D4FA3C  38 04 0A 1C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80D4FA40  90 1C 00 00 */	stw r0, 0(r28)
/* 80D4FA44  38 80 00 00 */	li r4, 0
/* 80D4FA48  4B 5D 89 B4 */	b init__12J3DFrameCtrlFs
...
/* 80D4FA74  3D 00 80 D5 */	lis r8, lit_3757@ha
/* 80D4FA78  C0 28 09 20 */	lfs f1, lit_3757@l(r8)
/* 80D4FA7C  39 00 00 00 */	li r8, 0
/* 80D4FA80  39 20 FF FF */	li r9, -1
/* 80D4FA84  4B 2B DB B8 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
lbl_80D4FA98:
/* 80D4FA98  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D4FA9C  38 63 09 C8 */	addi r3, r3, l_arcName@l
/* 80D4FAA0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D509C8 */
/* 80D4FAA4  38 80 00 10 */	li r4, 0x10
/* 80D4FAA8  7F C5 F3 78 */	mr r5, r30
/* 80D4FAAC  38 C0 00 80 */	li r6, 0x80
/* 80D4FAB0  4B 2E C8 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4FAC0  4B 2C 51 94 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
lbl_80D4FADC:
/* 80D4FADC  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D4FAE0  38 63 09 C8 */	addi r3, r3, l_arcName@l
/* 80D4FAE4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D509C8 */
/* 80D4FAE8  38 80 00 1B */	li r4, 0x1b
/* 80D4FAEC  7F C5 F3 78 */	mr r5, r30
/* 80D4FAF0  38 C0 00 80 */	li r6, 0x80
/* 80D4FAF4  4B 2E C7 F8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4FB08  4B 32 A4 30 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_80D4FB1C:
/* 80D4FB1C  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D4FB20  38 63 09 C8 */	addi r3, r3, l_arcName@l
/* 80D4FB24  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80D509C8 */
/* 80D4FB28  38 80 00 1C */	li r4, 0x1c
/* 80D4FB2C  7F C5 F3 78 */	mr r5, r30
/* 80D4FB30  38 C0 00 80 */	li r6, 0x80
/* 80D4FB34  4B 2E C7 B8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80D4FB48  4B 32 A3 F0 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
/* 80D4FB5C  4B 61 26 C4 */	b _restgpr_27

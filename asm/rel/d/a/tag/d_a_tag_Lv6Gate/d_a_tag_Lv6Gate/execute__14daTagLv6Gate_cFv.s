...
/* 80D4FEEC  4B 61 22 DC */	b _savegpr_24
/* 80D4FEF0  7C 7F 1B 78 */	mr r31, r3
/* 80D4FEF4  3C 60 80 D5 */	lis r3, l_minRelative@ha
/* 80D4FEF8  3B C3 09 08 */	addi r30, r3, l_minRelative@l
/* 80D4FEFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D4FF00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D4FF04  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80D4FF08  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80D4FF28  3C 80 80 D5 */	lis r4, l_arcName@ha
/* 80D4FF2C  38 84 09 C8 */	addi r4, r4, l_arcName@l
/* 80D4FF30  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80D509C8 */
/* 80D4FF34  38 A0 00 00 */	li r5, 0
/* 80D4FF38  38 C0 00 00 */	li r6, 0
/* 80D4FF3C  4B 2F 7B E0 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80D4FF58  4B 2F 80 04 */	b getMyNowCutName__16dEvent_manager_cFi
/* 80D4FF5C  7C 7B 1B 78 */	mr r27, r3
/* 80D4FF60  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D4FF64  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 80D4FF68  80 7C 5D AC */	lwz r3, 0x5dac(r28)	/* effective address: 8040BF6C */
/* 80D4FF6C  80 03 05 8C */	lwz r0, 0x58c(r3)	/* effective address: 8040058C */
/* 80D4FF70  64 00 80 00 */	oris r0, r0, 0x8000
/* 80D4FF74  90 03 05 8C */	stw r0, 0x58c(r3)	/* effective address: 8040058C */
/* 80D4FF78  7F 43 D3 78 */	mr r3, r26
/* 80D4FF7C  7F 04 C3 78 */	mr r4, r24
/* 80D4FF80  4B 2F 7D CC */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80D4FFDC  3C A0 80 D5 */	lis r5, stringBase0@ha
/* 80D4FFE0  38 A5 09 98 */	addi r5, r5, stringBase0@l
/* 80D4FFE4  38 A5 00 08 */	addi r5, r5, 8
/* 80D4FFE8  4B 2F 29 70 */	b setSkipZev__14dEvt_control_cFPvPc
...
/* 80D50004  4B 2B CD 60 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80D50008  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D5000C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D50010  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80D50014  4B 2B C4 20 */	b mDoMtx_YrotM__FPA4_fs
/* 80D50018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D5001C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D50020  38 81 00 88 */	addi r4, r1, 0x88
/* 80D50024  7C 85 23 78 */	mr r5, r4
/* 80D50028  4B 5F 6D 44 */	b PSMTXMultVec
...
/* 80D5007C  4B 51 73 78 */	b __ct__5csXyzFsss
/* 80D50080  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D50084  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80D50088  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80D500CC  4B 2F C9 C4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80D500D0  48 00 01 94 */	b lbl_80D50264
lbl_80D500D4:
/* 80D500D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D500D8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D500EC  4B 2E 51 14 */	b onSwitch__10dSv_info_cFii
...
/* 80D50114  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D50118  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D5011C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D50144  4B 55 B8 40 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 80D50174  4B 2C 98 48 */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 80D501BC  4B 2C 98 70 */	b fopAcM_SearchByName__FsPP10fopAc_ac_c
...
lbl_80D501F8:
/* 80D501F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D501FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D50210  4B 2E 4F F0 */	b onSwitch__10dSv_info_cFii
...
/* 80D50240  4B 51 7F 94 */	b ChkUsed__9cBgW_BgIdCFv
...
/* 80D50258  4B 32 47 B0 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80D5025C:
/* 80D5025C  80 7F 04 A4 */	lwz r3, 0x4a4(r31)
/* 80D50260  4B 2C 9A 58 */	b fopAcM_delete__FUi
lbl_80D50264:
...
/* 80D50290  4B 2F 7E EC */	b cutEnd__16dEvent_manager_cFi
lbl_80D50294:
...
/* 80D502DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D502E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D502F4  4B 2E 50 6C */	b isSwitch__10dSv_info_cCFii
/* 80D502F8  2C 03 00 00 */	cmpwi r3, 0
/* 80D502FC  40 82 00 84 */	bne lbl_80D50380
/* 80D50300  3C 60 80 D5 */	lis r3, l_arcName@ha
/* 80D50304  80 03 09 C8 */	lwz r0, l_arcName@l(r3)
...
/* 80D50318  4B 2F 64 E8 */	b setObjectArchive__16dEvent_manager_cFPc
/* 80D5031C  7F 03 C3 78 */	mr r3, r24
/* 80D50320  7F E4 FB 78 */	mr r4, r31
/* 80D50324  3C A0 80 D5 */	lis r5, stringBase0@ha
/* 80D50328  38 A5 09 98 */	addi r5, r5, stringBase0@l
/* 80D5032C  38 A5 00 1D */	addi r5, r5, 0x1d
/* 80D50330  38 C0 00 FF */	li r6, 0xff
/* 80D50334  4B 2F 74 24 */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 80D50358  4B 2C B3 24 */	b fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
/* 80D5035C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D50360  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D50374  4B 2E 4E 8C */	b onSwitch__10dSv_info_cFii
/* 80D50378  38 00 00 00 */	li r0, 0
/* 80D5037C  90 1F 05 5C */	stw r0, 0x55c(r31)
lbl_80D50380:
/* 80D50380  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D50384  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D503C0  4B 32 46 48 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
lbl_80D503C4:
/* 80D503C4  80 7F 05 70 */	lwz r3, 0x570(r31)
/* 80D503C8  4B 2B D0 60 */	b play__14mDoExt_baseAnmFv
/* 80D503CC  80 7F 05 74 */	lwz r3, 0x574(r31)
/* 80D503D0  4B 2B D0 58 */	b play__14mDoExt_baseAnmFv
lbl_80D503D4:
/* 80D503D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D503D8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80D503EC  4B 2E 4F 74 */	b isSwitch__10dSv_info_cCFii
...
/* 80D50408  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80D5040C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80D50410  4B 5F 60 A0 */	b PSMTXCopy
/* 80D50414  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D50418  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D5041C  7C 64 1B 78 */	mr r4, r3
/* 80D50420  4B 5F 61 90 */	b PSMTXInverse
/* 80D50424  3B 40 00 00 */	li r26, 0
/* 80D50428  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80D5042C  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 80D50450  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 80D50454  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 80D50458  38 81 00 20 */	addi r4, r1, 0x20
/* 80D5045C  4B 2C 93 9C */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 80D50460  7C 7B 1B 78 */	mr r27, r3
lbl_80D50464:
/* 80D50464  28 1B 00 00 */	cmplwi r27, 0
/* 80D50468  41 82 00 70 */	beq lbl_80D504D8
/* 80D5046C  4B 2B C8 5C */	b push__14mDoMtx_stack_cFv
/* 80D50470  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 80D50474  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80D50478  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80D5047C  38 A1 00 40 */	addi r5, r1, 0x40
/* 80D50480  4B 5F 68 EC */	b PSMTXMultVec
/* 80D50484  4B 2B C8 90 */	b pop__14mDoMtx_stack_cFv
...
/* 80D504F4  4B 51 7C E0 */	b ChkUsed__9cBgW_BgIdCFv
...
/* 80D50508  4B 32 3D 48 */	b Release__4cBgSFP9dBgW_Base
...
/* 80D50530  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D50534  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D50538  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D50560  4B 55 B4 24 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D50564:
...
/* 80D505B4  4B 51 7C 20 */	b ChkUsed__9cBgW_BgIdCFv
...
/* 80D505CC  4B 32 44 3C */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
/* 80D505F4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80D505F8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80D505FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80D50624  4B 55 B3 60 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_80D50628:
...
/* 80D50678  4B 61 1B 9C */	b _restgpr_24

...
/* 80D60BA4 0000002C  4B FF FF B5 */	bl __ct__10fopAc_ac_cFv
/* 80D60BA8 00000030  3C 60 00 00 */	lis r3, __vt__16daTag_ShopItem_c@ha /* 80D61240 */
/* 80D60BAC 00000034  38 03 00 00 */	addi r0, r3, __vt__16daTag_ShopItem_c@l /* 80D61240 */
...
/* 80D60BD0 00000010  3C 60 00 00 */	lis r3, stringBase0@ha /* 80D611E8 */
/* 80D60BD4 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l /* 80D611E8 */
/* 80D60BD8 00000018  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D60BDC 0000001C  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D60BE0 00000020  38 84 4E 00 */	addi r4, r4, 0x4e00
/* 80D60BE4 00000024  4B FF FF 75 */	bl strcmp
/* 80D60BE8 00000028  2C 03 00 00 */	cmpwi r3, 0
/* 80D60BEC 0000002C  40 82 00 68 */	bne lbl_80D60C54
/* 80D60BF0 00000030  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D60BF4 00000034  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D60BF8 00000038  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80D60BFC 0000003C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha /* 803A7288 */
/* 80D60C00 00000040  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l /* 803A7288 */
/* 80D60C04 00000044  A0 84 00 80 */	lhz r4, 0x80(r4)
/* 80D60C08 00000048  4B FF FF 51 */	bl isEventBit__11dSv_event_cCFUs
...
lbl_80D60C1C:
/* 80D60C1C 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D60C20 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D60C24 00000008  C0 23 00 34 */	lfs f1, 0x34(r3)
/* 80D60C28 0000000C  3C 60 00 00 */	lis r3, lit_3684@ha /* 80D611D0 */
/* 80D60C2C 00000010  C0 03 00 00 */	lfs f0, lit_3684@l(r3) /* 80D611D0 */
...
/* 80D60C3C 00000008  3C 60 00 00 */	lis r3, lit_3685@ha /* 80D611D4 */
/* 80D60C40 0000000C  C0 03 00 00 */	lfs f0, lit_3685@l(r3) /* 80D611D4 */
...
/* 80D60C90 0000003C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D60C94 00000040  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D60C98 00000044  3B C3 09 58 */	addi r30, r3, 0x958
/* 80D60C9C 00000048  7F C3 F3 78 */	mr r3, r30
/* 80D60CA0 0000004C  4B FF FE B9 */	bl isSwitch__12dSv_memBit_cCFi
...
/* 80D60CBC 00000068  4B FF FE 9D */	bl onSwitch__12dSv_memBit_cFi
...
/* 80D60CFC 00000028  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D60D00 0000002C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D60D04 00000030  38 63 09 58 */	addi r3, r3, 0x958
/* 80D60D08 00000034  4B FF FE 51 */	bl isSwitch__12dSv_memBit_cCFi
...
/* 80D60D3C 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80D60D40 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80D60D44 00000028  38 63 09 58 */	addi r3, r3, 0x958
/* 80D60D48 0000002C  4B FF FE 11 */	bl isSwitch__12dSv_memBit_cCFi

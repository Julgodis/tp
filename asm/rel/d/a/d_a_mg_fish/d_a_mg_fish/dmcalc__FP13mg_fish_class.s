...
/* 8052DB34 00000004  4B E3 46 84 */	b _savegpr_20
/* 8052DB38 00000008  7C 77 1B 78 */	mr r23, r3
/* 8052DB3C 0000000C  3C 60 80 53 */	lis r3, lit_3679@ha
/* 8052DB40 00000010  3B E3 61 68 */	addi r31, r3, lit_3679@l
...
/* 8052DB70 00000040  C3 1F 00 00 */	lfs f24, 0(r31)	/* effective address: 80536168 */
/* 8052DB74 00000044  48 00 00 08 */	b lbl_8052DB7C
lbl_8052DB78:
/* 8052DB78 00000000  C3 1F 00 58 */	lfs f24, 0x58(r31)	/* effective address: 805361C0 */
lbl_8052DB7C:
/* 8052DB7C 00000000  28 00 00 05 */	cmplwi r0, 5
/* 8052DB80 00000004  41 80 00 0C */	blt lbl_8052DB8C
/* 8052DB84 00000008  C3 1F 00 F4 */	lfs f24, 0xf4(r31)	/* effective address: 8053625C */
/* 8052DB88 0000000C  48 00 00 44 */	b lbl_8052DBCC
lbl_8052DB8C:
/* 8052DB8C 00000000  C0 37 05 2C */	lfs f1, 0x52c(r23)
/* 8052DB90 00000004  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 805361C4 */
/* 8052DB94 00000008  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8052DB98 00000000  40 81 00 0C */	ble lbl_8052DBA4
/* 8052DB9C 00000004  C3 1F 00 F8 */	lfs f24, 0xf8(r31)	/* effective address: 80536260 */
...
/* 8052DBC0 00000008  C3 1F 00 FC */	lfs f24, 0xfc(r31)	/* effective address: 80536264 */
/* 8052DBC4 0000000C  48 00 00 08 */	b lbl_8052DBCC
lbl_8052DBC8:
/* 8052DBC8 00000000  C3 1F 00 F8 */	lfs f24, 0xf8(r31)	/* effective address: 80536260 */
lbl_8052DBCC:
...
/* 8052DBE0 00000014  C3 1F 00 24 */	lfs f24, 0x24(r31)	/* effective address: 8053618C */
lbl_8052DBE4:
/* 8052DBE4 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8052DBE8 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8052DBEC 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8052DBF0 0000000C  A8 97 04 E6 */	lha r4, 0x4e6(r23)
/* 8052DBF4 00000010  4B AD E7 E8 */	b mDoMtx_YrotS__FPA4_fs
/* 8052DBF8 00000014  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8052DBFC 00000018  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8052DC00 0000001C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8052DC04 00000020  A8 97 04 E4 */	lha r4, 0x4e4(r23)
/* 8052DC08 00000024  4B AD E7 94 */	b mDoMtx_XrotM__FPA4_fs
/* 8052DC0C 00000028  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8052DC10 0000002C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8052DC14 00000030  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8052DC18 00000034  A8 97 04 E8 */	lha r4, 0x4e8(r23)
/* 8052DC1C 00000038  4B AD E8 B0 */	b mDoMtx_ZrotM__FPA4_fs
/* 8052DC20 0000003C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8052DC24 00000040  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8052DC28 00000044  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8052DC2C 00000048  A8 97 07 30 */	lha r4, 0x730(r23)
/* 8052DC30 0000004C  4B AD E8 04 */	b mDoMtx_YrotM__FPA4_fs
/* 8052DC34 00000050  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 80536180 */
...
/* 8052DC58 00000074  4B D4 32 94 */	b MtxPosition__FP4cXyzP4cXyz
/* 8052DC5C 00000078  C3 BF 00 00 */	lfs f29, 0(r31)	/* effective address: 80536168 */
/* 8052DC60 0000007C  C0 3F 00 84 */	lfs f1, 0x84(r31)	/* effective address: 805361EC */
...
lbl_8052DC7C:
/* 8052DC7C 00000000  80 64 00 04 */	lwz r3, 4(r4)	/* effective address: 80536230 */
/* 8052DC80 00000004  84 04 00 08 */	lwzu r0, 8(r4)	/* effective address: 80536234 */
...
/* 8052DC90 00000014  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80536230 */
...
/* 8052DCA8 0000002C  C3 7F 01 00 */	lfs f27, 0x100(r31)	/* effective address: 80536268 */
...
/* 8052DCC0 00000044  C3 7F 00 58 */	lfs f27, 0x58(r31)	/* effective address: 805361C0 */
lbl_8052DCC4:
...
/* 8052DCF0 00000010  C3 DF 00 00 */	lfs f30, 0(r31)	/* effective address: 80536168 */
/* 8052DCF4 00000014  C3 FF 00 18 */	lfs f31, 0x18(r31)	/* effective address: 80536180 */
/* 8052DCF8 00000018  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8052DCFC 0000001C  3A 83 9A 20 */	addi r20, r3, sincosTable___5JMath@l
/* 8052DD00 00000020  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8052DD04 00000024  3A A3 07 68 */	addi r21, r3, calc_mtx@l
...
/* 8052DD14 00000008  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 80536180 */
...
/* 8052DD84 00000050  4B D3 98 F0 */	b cM_atan2s__Fff
...
/* 8052DDAC 00000004  4B D3 98 C8 */	b cM_atan2s__Fff
...
/* 8052DDE8 00000040  80 75 00 00 */	lwz r3, 0(r21)	/* effective address: 80450768 */
/* 8052DDEC 00000044  7F 64 DB 78 */	mr r4, r27
/* 8052DDF0 00000048  4B AD E5 EC */	b mDoMtx_YrotS__FPA4_fs
/* 8052DDF4 0000004C  80 75 00 00 */	lwz r3, 0(r21)	/* effective address: 80450768 */
/* 8052DDF8 00000050  7F 84 E3 78 */	mr r4, r28
/* 8052DDFC 00000054  4B AD E5 A0 */	b mDoMtx_XrotM__FPA4_fs
/* 8052DE00 00000058  38 61 00 20 */	addi r3, r1, 0x20
/* 8052DE04 0000005C  38 81 00 14 */	addi r4, r1, 0x14
/* 8052DE08 00000060  4B D4 30 E4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8052DEA4 00000008  4B E3 43 60 */	b _restgpr_20

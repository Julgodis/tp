...
/* 8052C250 00000020  3C 80 80 53 */	lis r4, lit_3679@ha
/* 8052C254 00000024  3B E4 61 68 */	addi r31, r4, lit_3679@l
/* 8052C258 00000028  C3 FF 00 00 */	lfs f31, 0(r31)	/* effective address: 80536168 */
...
lbl_8052C2C8:
/* 8052C2C8 00000000  C0 3F 00 8C */	lfs f1, 0x8c(r31)	/* effective address: 805361F4 */
/* 8052C2CC 00000004  4B D3 B6 C0 */	b cM_rndFX__Ff
/* 8052C2D0 00000008  3C 60 80 53 */	lis r3, swim_path127@ha
/* 8052C2D4 0000000C  38 63 64 E4 */	addi r3, r3, swim_path127@l
...
/* 8052C2F0 00000028  C0 3F 00 90 */	lfs f1, 0x90(r31)	/* effective address: 805361F8 */
/* 8052C2F4 0000002C  4B D3 B6 98 */	b cM_rndFX__Ff
/* 8052C2F8 00000030  3C 60 80 53 */	lis r3, swim_path127@ha
/* 8052C2FC 00000034  38 63 64 E4 */	addi r3, r3, swim_path127@l
...
/* 8052C318 00000050  C0 3F 00 8C */	lfs f1, 0x8c(r31)	/* effective address: 805361F4 */
/* 8052C31C 00000054  4B D3 B6 70 */	b cM_rndFX__Ff
/* 8052C320 00000058  3C 60 80 53 */	lis r3, swim_path127@ha
/* 8052C324 0000005C  38 63 64 E4 */	addi r3, r3, swim_path127@l
...
/* 8052C354 0000000C  4B D3 A7 E0 */	b __mi__4cXyzCFRC3Vec
...
/* 8052C370 00000028  4B D3 B3 04 */	b cM_atan2s__Fff
...
/* 8052C38C 00000044  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 80536180 */
...
/* 8052C3A4 00000004  4B D3 B2 D0 */	b cM_atan2s__Fff
...
/* 8052C3B4 00000014  4B E1 AD 84 */	b PSVECSquareMag
/* 8052C3B8 00000018  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 80536180 */
...
/* 8052C3C8 00000008  C8 9F 00 30 */	lfd f4, 0x30(r31)	/* effective address: 80536198 */
/* 8052C3CC 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8052C3D0 00000010  C8 7F 00 38 */	lfd f3, 0x38(r31)	/* effective address: 805361A0 */
...
lbl_8052C418:
/* 8052C418 00000000  C8 1F 00 40 */	lfd f0, 0x40(r31)	/* effective address: 805361A8 */
/* 8052C41C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8052C420 00000000  40 80 00 10 */	bge lbl_8052C430
/* 8052C424 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8052C428 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8052C494 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8052C498 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8052C49C:
/* 8052C49C 00000000  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 8053617C */
...
/* 8052C4CC 00000028  3C 60 80 53 */	lis r3, swim_path127@ha
/* 8052C4D0 0000002C  38 63 64 E4 */	addi r3, r3, swim_path127@l
...
lbl_8052C500:
/* 8052C500 00000000  C3 FF 00 18 */	lfs f31, 0x18(r31)	/* effective address: 80536180 */
lbl_8052C504:
/* 8052C504 00000000  38 7E 05 2C */	addi r3, r30, 0x52c
/* 8052C508 00000004  FC 20 F8 90 */	fmr f1, f31
/* 8052C50C 00000008  C0 5F 00 00 */	lfs f2, 0(r31)	/* effective address: 80536168 */
/* 8052C510 0000000C  C0 7F 00 80 */	lfs f3, 0x80(r31)	/* effective address: 805361E8 */
/* 8052C514 00000010  4B D4 35 28 */	b cLib_addCalc2__FPffff
...
/* 8052C528 00000024  4B D4 40 E0 */	b cLib_addCalcAngleS2__FPssss
...
/* 8052C53C 00000038  4B D4 40 CC */	b cLib_addCalcAngleS2__FPssss
...
/* 8052C550 0000004C  4B D4 40 B8 */	b cLib_addCalcAngleS2__FPssss
lbl_8052C554:

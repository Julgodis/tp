...
/* 8052AA18  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 8052AA58  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AA74  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AA8C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AAB0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AAD8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AB28  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
...
/* 8052AB50  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AB98  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
...
/* 8052ABB8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052ABD4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052ABF0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AC24  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
...
/* 8052AC44  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AC60  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AC7C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052ACB4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
...
/* 8052ACD4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052ACF0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AD0C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AD50  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8052AD54  4B E1 B7 5C */	b PSMTXCopy
/* 8052AD58  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8052AD5C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8052AD60  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AD74  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8052AD90  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

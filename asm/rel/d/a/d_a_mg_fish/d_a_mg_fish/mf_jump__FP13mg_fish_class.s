...
/* 8052FA64 00000018  3C 60 00 00 */	lis r3, lit_3679@ha
/* 8052FA68 0000001C  3B C3 00 00 */	addi r30, r3, lit_3679@l
/* 8052FA6C 00000020  80 1D 06 4C */	lwz r0, 0x64c(r29)
/* 8052FA70 00000024  90 01 00 18 */	stw r0, 0x18(r1)
/* 8052FA74 00000028  3C 60 00 00 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8052FA78 0000002C  38 63 00 00 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
...
/* 8052FB88 00000014  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 8052FB8C 00000018  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8052FEDC 0000001C  3C 60 00 00 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8052FEE0 00000020  38 63 00 00 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
...
/* 8052FF70 0000004C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 8052FF74 00000050  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 80530088 00000054  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8053008C 00000058  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 80530170 00000084  3C 60 00 00 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80530174 00000088  38 63 00 00 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
...
lbl_8053018C:
/* 8053018C 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80530190 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 80530210 00000084  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80530214 00000088  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80530218 0000008C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 8053021C 00000090  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80530220 00000094  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 805302D4 00000018  3C E0 00 00 */	lis r7, sincosTable___5JMath@ha
/* 805302D8 0000001C  38 E7 00 00 */	addi r7, r7, sincosTable___5JMath@l
...
/* 80530310 00000010  3C E0 00 00 */	lis r7, sincosTable___5JMath@ha
/* 80530314 00000014  38 E7 00 00 */	addi r7, r7, sincosTable___5JMath@l

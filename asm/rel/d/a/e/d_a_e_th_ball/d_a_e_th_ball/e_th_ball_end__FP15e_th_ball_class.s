...
/* 807B6D18  3C 60 80 7B */	lis r3, lit_3746@ha
/* 807B6D1C  3B E3 7E B8 */	addi r31, r3, lit_3746@l
/* 807B6D20  38 7E 05 2C */	addi r3, r30, 0x52c
/* 807B6D24  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 807B7EB8 */
/* 807B6D28  FC 40 08 90 */	fmr f2, f1
/* 807B6D2C  4B AB 8D 54 */	b cLib_addCalc0__FPfff
...
/* 807B6D40  4B 9A 87 B0 */	b setLookPos__9daPy_py_cFP4cXyz
/* 807B6D44  38 7E 19 40 */	addi r3, r30, 0x1940
/* 807B6D48  C0 3F 00 DC */	lfs f1, 0xdc(r31)
/* 807B6D4C  4B AB 89 BC */	b SetR__8cM3dGSphFf
...
/* 807B6D60  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807B6D64  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807B6D68  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 807B6D6C  4B 86 3A 74 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807B6D80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807B6D84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807B6D88  98 03 5E 3C */	stb r0, 0x5e3c(r3)	/* effective address: 8040BFFC */
/* 807B6D8C  38 00 00 00 */	li r0, 0
/* 807B6D90  98 03 5E 57 */	stb r0, 0x5e57(r3)	/* effective address: 8040C017 */
/* 807B6D94  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha
/* 807B6D98  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l
/* 807B6D9C  80 03 00 34 */	lwz r0, 0x34(r3)	/* effective address: 803DD31C */

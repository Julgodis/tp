...
/* 806A65D4  4B CB BB EC */	b _savegpr_22
/* 806A65D8  7C 7E 1B 78 */	mr r30, r3
/* 806A65DC  3C 80 80 6A */	lis r4, lit_3903@ha
/* 806A65E0  3B E4 71 C4 */	addi r31, r4, lit_3903@l
...
/* 806A65FC  4B 97 25 68 */	b __ct__10fopAc_ac_cFv
/* 806A6600  38 7D 05 C4 */	addi r3, r29, 0x5c4
/* 806A6604  4B C1 A9 60 */	b __ct__15Z2CreatureEnemyFv
/* 806A6608  38 7D 06 E8 */	addi r3, r29, 0x6e8
/* 806A660C  4B 9C F8 A0 */	b __ct__12dBgS_AcchCirFv
/* 806A6610  3A DD 07 28 */	addi r22, r29, 0x728
/* 806A6614  7E C3 B3 78 */	mr r3, r22
/* 806A6618  4B 9C FA 88 */	b __ct__9dBgS_AcchFv
/* 806A661C  3C 60 80 6A */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 806A6620  38 63 74 70 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 806A663C  4B 9D 28 2C */	b SetObj__16dBgS_PolyPassChkFv
/* 806A6640  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 806A6644  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 806A6648  90 1D 09 18 */	stw r0, 0x918(r29)
/* 806A664C  38 7D 09 1C */	addi r3, r29, 0x91c
/* 806A6650  4B 9D D1 10 */	b __ct__10dCcD_GSttsFv
/* 806A6654  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 806A6658  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 806A6670  4B 9D D3 B8 */	b __ct__12dCcD_GObjInfFv
/* 806A6674  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 806A6678  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 806A667C  90 1C 01 20 */	stw r0, 0x120(r28)
/* 806A6680  3C 60 80 6A */	lis r3, __vt__8cM3dGAab@ha
/* 806A6684  38 03 74 64 */	addi r0, r3, __vt__8cM3dGAab@l
/* 806A6688  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 806A668C  3C 60 80 6A */	lis r3, __vt__8cM3dGSph@ha
/* 806A6690  38 03 74 58 */	addi r0, r3, __vt__8cM3dGSph@l
/* 806A6694  90 1C 01 34 */	stw r0, 0x134(r28)
/* 806A6698  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 806A669C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 806A66A0  90 7C 01 20 */	stw r3, 0x120(r28)
/* 806A66A4  38 03 00 58 */	addi r0, r3, 0x58
/* 806A66A8  90 1C 01 34 */	stw r0, 0x134(r28)
/* 806A66AC  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 806A66B0  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 806A66CC  3C 80 80 6A */	lis r4, __ct__8dCcD_SphFv@ha
/* 806A66D0  38 84 69 A4 */	addi r4, r4, __ct__8dCcD_SphFv@l
/* 806A66D4  3C A0 80 6A */	lis r5, __dt__8dCcD_SphFv@ha
/* 806A66D8  38 A5 6A 28 */	addi r5, r5, __dt__8dCcD_SphFv@l
/* 806A66DC  38 C0 01 38 */	li r6, 0x138
/* 806A66E0  38 E0 00 03 */	li r7, 3
/* 806A66E4  4B CB B6 7C */	b __construct_array
lbl_806A66E8:
...
/* 806A66F8  3C 80 80 6A */	lis r4, stringBase0@ha
/* 806A66FC  38 84 72 B4 */	addi r4, r4, stringBase0@l
/* 806A6700  38 84 00 05 */	addi r4, r4, 5
/* 806A6704  4B 98 67 B8 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806A6728  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A672C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A6730  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806A6734  7C 05 07 74 */	extsb r5, r0
/* 806A6738  4B 98 EC 28 */	b isSwitch__10dSv_info_cCFii
...
/* 806A6764  3C 80 80 6A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 806A6768  38 84 61 54 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 806A676C  38 A0 20 E0 */	li r5, 0x20e0
/* 806A6770  4B 97 3D 40 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 806A6798  4B 9A B0 54 */	b dPath_GetRoomPath__Fii
...
lbl_806A67B4:
/* 806A67B4  3C 60 80 6A */	lis r3, data_806A74B8@ha
/* 806A67B8  8C 03 74 B8 */	lbzu r0, data_806A74B8@l(r3)
...
/* 806A67D4  3C 60 80 6A */	lis r3, l_HIO@ha
/* 806A67D8  38 63 74 C8 */	addi r3, r3, l_HIO@l
/* 806A67DC  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 806A74CC */
lbl_806A67E0:
...
/* 806A6808  4B 97 3D 20 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 806A681C  4B 97 3D 1C */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806A6868  4B 9D E1 CC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806A68FC  4B 9C F9 4C */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 806A6900  38 7E 06 E8 */	addi r3, r30, 0x6e8
/* 806A6904  C0 3F 00 48 */	lfs f1, 0x48(r31)
/* 806A6908  C0 5F 00 00 */	lfs f2, 0(r31)
/* 806A690C  4B 9C F6 4C */	b SetWall__12dBgS_AcchCirFff
...
/* 806A6924  4B C1 A7 70 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806A6928  38 7E 05 C4 */	addi r3, r30, 0x5c4
/* 806A692C  3C 80 80 6A */	lis r4, stringBase0@ha
/* 806A6930  38 84 72 B4 */	addi r4, r4, stringBase0@l
/* 806A6934  38 84 00 05 */	addi r4, r4, 5
/* 806A6938  4B C1 B2 58 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 806A6950  4B BC 10 04 */	b cM_rndF__Ff
...
/* 806A6990  4B CB B8 7C */	b _restgpr_22

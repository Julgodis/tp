...
/* 806A2C1C 00000040  3C 60 00 00 */	lis r3, lit_4029@ha /* 806A720C */
/* 806A2C20 00000044  C0 03 00 00 */	lfs f0, lit_4029@l(r3) /* 806A720C */
/* 806A2C24 00000048  EC 01 00 2A */	fadds f0, f1, f0
/* 806A2C28 0000004C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 806A2C2C 00000050  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806A2C30 00000054  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 806A2C40 00000064  3C 60 00 00 */	lis r3, lit_3904@ha /* 806A71C8 */
/* 806A2C44 00000068  C0 03 00 00 */	lfs f0, lit_3904@l(r3) /* 806A71C8 */
/* 806A2C48 0000006C  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 806A2C4C 00000070  3C 60 00 00 */	lis r3, lit_4029@ha /* 806A720C */
/* 806A2C50 00000074  C0 03 00 00 */	lfs f0, lit_4029@l(r3) /* 806A720C */
...
/* 806A2C8C 000000B0  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806A2C90 000000B4  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */

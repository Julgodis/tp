...
/* 806A2C00 00000024  4B 9D 50 68 */	b __ct__11dBgS_LinChkFv
...
/* 806A2C1C 00000040  3C 60 80 6A */	lis r3, lit_4029@ha
/* 806A2C20 00000044  C0 03 72 0C */	lfs f0, lit_4029@l(r3)
/* 806A2C24 00000048  EC 01 00 2A */	fadds f0, f1, f0
/* 806A2C28 0000004C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 806A2C2C 00000050  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806A2C30 00000054  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806A2C34 00000058  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806A2C38 0000005C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806A2C3C 00000060  4B 96 97 A0 */	b mDoMtx_YrotS__FPA4_fs
/* 806A2C40 00000064  3C 60 80 6A */	lis r3, lit_3904@ha
/* 806A2C44 00000068  C0 03 71 C8 */	lfs f0, lit_3904@l(r3)
/* 806A2C48 0000006C  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 806A2C4C 00000070  3C 60 80 6A */	lis r3, lit_4029@ha
/* 806A2C50 00000074  C0 03 72 0C */	lfs f0, lit_4029@l(r3)
...
/* 806A2C64 00000088  4B BC E2 88 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806A2C74 00000098  4B CA 44 1C */	b PSVECAdd
...
/* 806A2C88 000000AC  4B 9D 50 DC */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806A2C8C 000000B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806A2C90 000000B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806A2C94 000000B8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806A2C98 000000BC  38 81 00 2C */	addi r4, r1, 0x2c
/* 806A2C9C 000000C0  4B 9D 17 18 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 806A2CB0 000000D4  4B 9D 50 2C */	b __dt__11dBgS_LinChkFv
...
/* 806A2CC4 00000008  4B 9D 50 18 */	b __dt__11dBgS_LinChkFv

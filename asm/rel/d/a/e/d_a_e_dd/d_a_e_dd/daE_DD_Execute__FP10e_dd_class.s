...
/* 806A5A7C  4B CB C7 58 */	b _savegpr_27
/* 806A5A80  7C 7F 1B 78 */	mr r31, r3
/* 806A5A84  3C 60 80 6A */	lis r3, lit_3903@ha
/* 806A5A88  3B A3 71 C4 */	addi r29, r3, lit_3903@l
...
/* 806A5B00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B08  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 806A5B0C  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 806A5B10  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 806A5B14  4B CA 0D D4 */	b PSMTXTrans
/* 806A5B18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B20  A8 9F 06 D8 */	lha r4, 0x6d8(r31)
/* 806A5B24  4B 96 69 10 */	b mDoMtx_YrotM__FPA4_fs
/* 806A5B28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B30  A8 9F 06 D6 */	lha r4, 0x6d6(r31)
/* 806A5B34  4B 96 68 68 */	b mDoMtx_XrotM__FPA4_fs
/* 806A5B38  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B3C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B40  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806A5B44  4B 96 68 F0 */	b mDoMtx_YrotM__FPA4_fs
/* 806A5B48  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B4C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B50  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 806A5B54  4B 96 68 48 */	b mDoMtx_XrotM__FPA4_fs
/* 806A5B58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B60  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 806A5B64  4B 96 69 68 */	b mDoMtx_ZrotM__FPA4_fs
/* 806A5B68  3C 60 80 6A */	lis r3, l_HIO@ha
/* 806A5B6C  3B C3 74 C8 */	addi r30, r3, l_HIO@l
/* 806A5B70  C0 3E 00 08 */	lfs f1, 8(r30)	/* effective address: 806A74D0 */
/* 806A5B74  FC 40 08 90 */	fmr f2, f1
/* 806A5B78  FC 60 08 90 */	fmr f3, f1
/* 806A5B7C  4B 96 72 BC */	b scaleM__14mDoMtx_stack_cFfff
/* 806A5B80  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806A5B84  83 83 00 04 */	lwz r28, 4(r3)
/* 806A5B88  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A5B8C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A5B90  38 9C 00 24 */	addi r4, r28, 0x24
/* 806A5B94  4B CA 09 1C */	b PSMTXCopy
...
/* 806A5BA8  4B 96 78 80 */	b play__14mDoExt_baseAnmFv
...
/* 806A5C08  4B 98 74 64 */	b dComIfGp_getReverb__Fi
/* 806A5C0C  7C 65 1B 78 */	mr r5, r3
/* 806A5C10  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806A5C14  38 80 00 00 */	li r4, 0
/* 806A5C18  4B 96 B4 98 */	b play__16mDoExt_McaMorfSOFUlSc
/* 806A5C1C  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806A5C20  4B 96 B5 CC */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 806A5C38  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806A5C3C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806A5C40  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806A5C44  4B CA 08 6C */	b PSMTXCopy
...
/* 806A5C68  4B BC B2 84 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806A5C84  4B BC B2 68 */	b MtxPosition__FP4cXyzP4cXyz
/* 806A5C88  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 806A5C8C  38 81 00 08 */	addi r4, r1, 8
/* 806A5C90  4B BC 99 B8 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 806A5CA4  4B BC 9A 64 */	b SetR__8cM3dGSphFf
/* 806A5CA8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A5CAC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A5CB0  3B 63 23 3C */	addi r27, r3, 0x233c
/* 806A5CB4  7F 63 DB 78 */	mr r3, r27
/* 806A5CB8  38 9F 0A 74 */	addi r4, r31, 0xa74
/* 806A5CBC  4B BB EE EC */	b Set__4cCcSFP8cCcD_Obj
/* 806A5CC0  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806A5CC4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806A5CC8  38 63 00 60 */	addi r3, r3, 0x60
/* 806A5CCC  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806A5CD0  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806A5CD4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806A5CD8  4B CA 07 D8 */	b PSMTXCopy
...
/* 806A5CF8  4B BC B1 F4 */	b MtxPosition__FP4cXyzP4cXyz
/* 806A5CFC  38 7F 0C D0 */	addi r3, r31, 0xcd0
/* 806A5D00  38 81 00 08 */	addi r4, r1, 8
/* 806A5D04  4B BC 99 44 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 806A5D18  4B BC 99 F0 */	b SetR__8cM3dGSphFf
/* 806A5D1C  7F 63 DB 78 */	mr r3, r27
/* 806A5D20  38 9F 0B AC */	addi r4, r31, 0xbac
/* 806A5D24  4B BB EE 84 */	b Set__4cCcSFP8cCcD_Obj
/* 806A5D28  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806A5D2C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806A5D30  38 63 03 F0 */	addi r3, r3, 0x3f0
/* 806A5D34  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806A5D38  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806A5D3C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806A5D40  4B CA 07 70 */	b PSMTXCopy
...
/* 806A5D5C  4B BC B1 90 */	b MtxPosition__FP4cXyzP4cXyz
/* 806A5D60  38 7F 0E 08 */	addi r3, r31, 0xe08
/* 806A5D64  38 9F 0E 4C */	addi r4, r31, 0xe4c
/* 806A5D68  4B BC 98 E0 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 806A5D7C  4B BC 99 8C */	b SetR__8cM3dGSphFf
/* 806A5D80  7F 63 DB 78 */	mr r3, r27
/* 806A5D84  38 9F 0C E4 */	addi r4, r31, 0xce4
/* 806A5D88  4B BB EE 20 */	b Set__4cCcSFP8cCcD_Obj
...
/* 806A5DF0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806A5DF4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806A5DF8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806A5DFC  A8 9F 06 D8 */	lha r4, 0x6d8(r31)
/* 806A5E00  4B 96 65 DC */	b mDoMtx_YrotS__FPA4_fs
/* 806A5E04  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806A5E08  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806A5E0C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806A5E10  A8 9F 06 D6 */	lha r4, 0x6d6(r31)
/* 806A5E14  4B 96 65 88 */	b mDoMtx_XrotM__FPA4_fs
/* 806A5E18  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806A5E1C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806A5E20  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806A5E34  4B 96 66 00 */	b mDoMtx_YrotM__FPA4_fs
/* 806A5E38  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806A5E3C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806A5E40  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806A5E44  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 806A5E48  4B 96 65 54 */	b mDoMtx_XrotM__FPA4_fs
...
/* 806A5FC8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A5FCC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A5FD0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806A5FD4  80 03 05 70 */	lwz r0, 0x570(r3)	/* effective address: 80406730 */
...
/* 806A6050  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806A6054  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806A6058  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806A605C  4B CA 04 54 */	b PSMTXCopy
...
/* 806A607C  4B BC AE 70 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806A6094  4B 97 6A 44 */	b fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 806A6098  7F E3 FB 78 */	mr r3, r31
/* 806A609C  4B 97 3B E0 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 806A60B0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A60B4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A60B8  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806A60BC  7C 05 07 74 */	extsb r5, r0
/* 806A60C0  4B 98 F1 40 */	b onSwitch__10dSv_info_cFii
lbl_806A60C4:
/* 806A60C4  38 60 00 01 */	li r3, 1
/* 806A60C8  39 61 00 40 */	addi r11, r1, 0x40
/* 806A60CC  4B CB C1 54 */	b _restgpr_27

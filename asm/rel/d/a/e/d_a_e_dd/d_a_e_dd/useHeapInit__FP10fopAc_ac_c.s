...
/* 806A616C 00000004  4B FF C0 6D */	bl _savegpr_22
/* 806A6170 00000008  7C 7B 1B 78 */	mr r27, r3
/* 806A6174 0000000C  38 60 00 58 */	li r3, 0x58
/* 806A6178 00000010  4B FF C0 61 */	bl __nw__FUl
/* 806A617C 00000014  7C 76 1B 79 */	or. r22, r3, r3
/* 806A6180 00000018  41 82 00 9C */	beq lbl_806A621C
/* 806A6184 0000001C  3C 60 00 00 */	lis r3, stringBase0@ha /* 806A72B4 */
/* 806A6188 00000020  38 63 00 00 */	addi r3, r3, stringBase0@l /* 806A72B4 */
/* 806A618C 00000024  38 63 00 05 */	addi r3, r3, 5
/* 806A6190 00000028  38 80 00 15 */	li r4, 0x15
/* 806A6194 0000002C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806A6198 00000030  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 806A61AC 00000044  4B FF C0 2D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806A61B0 00000048  7C 77 1B 78 */	mr r23, r3
/* 806A61B4 0000004C  3C 60 00 00 */	lis r3, stringBase0@ha /* 806A72B4 */
/* 806A61B8 00000050  38 63 00 00 */	addi r3, r3, stringBase0@l /* 806A72B4 */
...
/* 806A61CC 00000064  4B FF C0 0D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A6204 0000009C  3D 20 00 00 */	lis r9, lit_3905@ha /* 806A71CC */
/* 806A6208 000000A0  C0 29 00 00 */	lfs f1, lit_3905@l(r9) /* 806A71CC */
/* 806A620C 000000A4  39 20 00 00 */	li r9, 0
/* 806A6210 000000A8  39 40 FF FF */	li r10, -1
/* 806A6214 000000AC  4B FF BF C5 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806A6248 00000008  3C 60 00 00 */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 806A2378 */
/* 806A624C 0000000C  38 83 00 00 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 806A2378 */
...
/* 806A628C 0000001C  3C 60 00 00 */	lis r3, l_HIO@ha /* 806A74C8 */
/* 806A6290 00000020  3B E3 00 00 */	addi r31, r3, l_HIO@l /* 806A74C8 */
/* 806A6294 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806A6298 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 806A629C 0000002C  3F C3 00 02 */	addis r30, r3, 2
/* 806A62A0 00000030  3C 60 00 00 */	lis r3, lit_3905@ha /* 806A71CC */
/* 806A62A4 00000034  3A E3 00 00 */	addi r23, r3, lit_3905@l /* 806A71CC */
/* 806A62A8 00000038  3C 60 00 00 */	lis r3, stringBase0@ha /* 806A72B4 */
/* 806A62AC 0000003C  3B 03 00 00 */	addi r24, r3, stringBase0@l /* 806A72B4 */
/* 806A62B0 00000040  3C 60 00 00 */	lis r3, data_806A7338@ha /* 806A7338 */
/* 806A62B4 00000044  3B 23 00 00 */	addi r25, r3, data_806A7338@l /* 806A7338 */
/* 806A62B8 00000048  3B DE C2 F8 */	addi r30, r30, -15624
lbl_806A62BC:
/* 806A62BC 00000000  38 60 00 18 */	li r3, 0x18
/* 806A62C0 00000004  4B FF BF 19 */	bl __nw__FUl
/* 806A62C4 00000008  7C 76 1B 79 */	or. r22, r3, r3
/* 806A62C8 0000000C  41 82 00 20 */	beq lbl_806A62E8
/* 806A62CC 00000010  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 806A7494 */
/* 806A62D0 00000014  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 806A7494 */
/* 806A62D4 00000018  90 16 00 00 */	stw r0, 0(r22)
/* 806A62D8 0000001C  38 80 00 00 */	li r4, 0
/* 806A62DC 00000020  4B FF BE FD */	bl init__12J3DFrameCtrlFs
...
/* 806A6318 00000014  C3 F7 00 00 */	lfs f31, 0(r23)
...
lbl_806A632C:
/* 806A632C 00000000  C3 FF 00 24 */	lfs f31, 0x24(r31)
lbl_806A6330:
...
/* 806A6340 00000010  4B FF BE 99 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806A6370 00000040  4B FF BE 69 */	bl init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 806A63A4 00000008  4B FF BE 35 */	bl _restgpr_22

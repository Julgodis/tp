...
/* 806A6DAC  4B CB B4 08 */	b _savegpr_19
/* 806A6DB0  7C 7E 1B 78 */	mr r30, r3
/* 806A6DB4  7C 9A 23 78 */	mr r26, r4
/* 806A6DB8  7C BB 2B 78 */	mr r27, r5
/* 806A6DBC  7C DC 33 78 */	mr r28, r6
/* 806A6DC0  3C 60 80 6A */	lis r3, cNullVec__6Z2Calc@ha
/* 806A6DC4  3A E3 72 C0 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806A6DC8  3C 60 80 6A */	lis r3, lit_3903@ha
/* 806A6DCC  3B E3 71 C4 */	addi r31, r3, lit_3903@l
/* 806A6DD0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A6DD4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A6DD8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806A6DDC  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806A6DE0  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806A6E08  4B B0 57 74 */	b dKy_darkworld_check__Fv
...
/* 806A6E2C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806A6E30  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806A6E34  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806A6E38  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806A6E3C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806A6E40  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806A6E44  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806A6E48  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806A6E4C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806A6E50  4B C9 F6 60 */	b PSMTXCopy
...
/* 806A6E68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A6E6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A6E70  38 81 00 4C */	addi r4, r1, 0x4c
/* 806A6E74  38 A1 00 58 */	addi r5, r1, 0x58
/* 806A6E78  4B C9 FE F4 */	b PSMTXMultVec
/* 806A6E7C  38 61 00 34 */	addi r3, r1, 0x34
/* 806A6E80  38 81 00 58 */	addi r4, r1, 0x58
/* 806A6E84  7F 65 DB 78 */	mr r5, r27
/* 806A6E88  4B BB FC AC */	b __mi__4cXyzCFRC3Vec
...
/* 806A6EA4  4B BC 07 D0 */	b cM_atan2s__Fff
...
/* 806A6ED8  4B BC 07 9C */	b cM_atan2s__Fff
...
/* 806A6EF4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A6EF8  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806A6EFC  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806A6F48  4B 9A 5B 48 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806A6F4C  7C 79 1B 79 */	or. r25, r3, r3
/* 806A6F50  41 82 00 FC */	beq lbl_806A704C
/* 806A6F54  38 61 00 40 */	addi r3, r1, 0x40
/* 806A6F58  4B CA 01 E0 */	b PSVECSquareMag
...
/* 806A6FC8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806A6FCC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806A7038  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806A703C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806A7040:
...
/* 806A7090  4B 9A 5A 00 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A70CC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A70D0  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806A70FC  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806A713C  4B 9A 63 90 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A719C  4B CB B0 64 */	b _restgpr_19

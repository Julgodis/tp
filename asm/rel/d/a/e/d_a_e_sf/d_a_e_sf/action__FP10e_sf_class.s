...
/* 807873D0  4B BD AE 00 */	b _savegpr_26
/* 807873D4  7C 7D 1B 78 */	mr r29, r3
/* 807873D8  3C 80 80 79 */	lis r4, lit_3908@ha
/* 807873DC  3B E4 9C 38 */	addi r31, r4, lit_3908@l
/* 807873E0  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807873E4  3B 44 61 C0 */	addi r26, r4, struct_804061C0+0x0@l
/* 807873E8  83 9A 5D AC */	lwz r28, 0x5dac(r26)	/* effective address: 8040BF6C */
/* 807873EC  38 00 00 00 */	li r0, 0
/* 807873F0  98 03 06 AE */	stb r0, 0x6ae(r3)
/* 807873F4  80 9A 5D AC */	lwz r4, 0x5dac(r26)	/* effective address: 8040BF6C */
/* 807873F8  4B 89 35 6C */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807873FC  D0 3D 06 8C */	stfs f1, 0x68c(r29)
/* 80787400  7F A3 EB 78 */	mr r3, r29
/* 80787404  80 9A 5D AC */	lwz r4, 0x5dac(r26)
/* 80787408  4B 89 33 08 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8078740C  B0 7D 06 90 */	sth r3, 0x690(r29)
/* 80787410  7F A3 EB 78 */	mr r3, r29
/* 80787414  80 9A 5D AC */	lwz r4, 0x5dac(r26)
/* 80787418  4B 89 33 20 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 8078741C  B0 7D 06 92 */	sth r3, 0x692(r29)
/* 80787420  3C 60 80 79 */	lis r3, l_HIO@ha
/* 80787424  38 63 A0 7C */	addi r3, r3, l_HIO@l
/* 80787428  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 8078A090 */
...
/* 8078745C  3C 60 80 79 */	lis r3, lit_5205@ha
/* 80787460  38 63 9E 10 */	addi r3, r3, lit_5205@l
...
/* 80787564  4B B3 A6 18 */	b setLinkSearch__15Z2CreatureEnemyFb
/* 80787568  48 00 00 10 */	b lbl_80787578
lbl_8078756C:
/* 8078756C  38 7D 05 E4 */	addi r3, r29, 0x5e4
/* 80787570  38 80 00 00 */	li r4, 0
/* 80787574  4B B3 A6 08 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_80787578:
...
/* 80787588  4B AE 90 80 */	b cLib_addCalcAngleS2__FPssss
...
/* 807875D4  4B AE 03 80 */	b cM_rndF__Ff
...
/* 807875F4  3C 60 80 79 */	lis r3, l_HIO@ha
/* 807875F8  38 63 A0 7C */	addi r3, r3, l_HIO@l
/* 807875FC  C0 03 00 20 */	lfs f0, 0x20(r3)	/* effective address: 8078A09C */
/* 80787600  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80787604  40 80 00 30 */	bge lbl_80787634
/* 80787608  4B 8F FD CC */	b cc_pl_cut_bit_get__Fv
...
/* 80787644  4B AE 8F C4 */	b cLib_addCalcAngleS2__FPssss
...
/* 80787658  4B AE 8F B0 */	b cLib_addCalcAngleS2__FPssss
...
/* 8078766C  4B AE 8F 9C */	b cLib_addCalcAngleS2__FPssss
...
/* 80787680  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80787684  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80787688  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8078768C  A8 9D 06 E6 */	lha r4, 0x6e6(r29)
/* 80787690  4B 88 4D 4C */	b mDoMtx_YrotS__FPA4_fs
...
lbl_807876C4:
/* 807876C4  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807876C8  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 807876CC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 807876D0  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 807876D4  4B 88 4D 08 */	b mDoMtx_YrotS__FPA4_fs
...
/* 807876F4  4B AE 97 F8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80787710  3C A0 80 79 */	lis r5, l_HIO@ha
/* 80787714  3B 45 A0 7C */	addi r26, r5, l_HIO@l
/* 80787718  C0 3A 00 08 */	lfs f1, 8(r26)	/* effective address: 8078A084 */
/* 8078771C  4B AD F4 68 */	b __ml__4cXyzCFf
/* 80787720  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80787724  38 81 00 2C */	addi r4, r1, 0x2c
/* 80787728  7C 65 1B 78 */	mr r5, r3
/* 8078772C  4B BB F9 64 */	b PSVECAdd
...
/* 807877B8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807877BC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 807877C0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 807877C4  A8 9D 06 C8 */	lha r4, 0x6c8(r29)
/* 807877C8  4B 88 4C 14 */	b mDoMtx_YrotS__FPA4_fs
/* 807877CC  38 61 00 68 */	addi r3, r1, 0x68
/* 807877D0  38 81 00 5C */	addi r4, r1, 0x5c
/* 807877D4  4B AE 97 18 */	b MtxPosition__FP4cXyzP4cXyz
/* 807877D8  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 807877DC  38 81 00 5C */	addi r4, r1, 0x5c
/* 807877E0  7C 65 1B 78 */	mr r5, r3
/* 807877E4  4B BB F8 AC */	b PSVECAdd
/* 807877E8  38 7D 06 C4 */	addi r3, r29, 0x6c4
/* 807877EC  C0 3F 00 08 */	lfs f1, 8(r31)
/* 807877F0  C0 5F 00 B4 */	lfs f2, 0xb4(r31)
/* 807877F4  4B AE 82 8C */	b cLib_addCalc0__FPfff
lbl_807877F8:
/* 807877F8  38 7D 07 5C */	addi r3, r29, 0x75c
/* 807877FC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80787800  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80787804  3B C4 0F 38 */	addi r30, r4, 0xf38
/* 80787808  7F C4 F3 78 */	mr r4, r30
/* 8078780C  4B 8E F2 A0 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80787838  4B AE 01 1C */	b cM_rndF__Ff
...
/* 8078784C  4B AE 01 40 */	b cM_rndFX__Ff
...
/* 80787878  4B AD F2 BC */	b __mi__4cXyzCFRC3Vec
...
/* 807878AC  4B AD F2 88 */	b __mi__4cXyzCFRC3Vec
...
/* 807878D8  4B AD F2 5C */	b __mi__4cXyzCFRC3Vec
...
/* 80787914  4B AD FD 60 */	b cM_atan2s__Fff
...
/* 80787950  4B AD FD 24 */	b cM_atan2s__Fff
...
/* 807879A8  4B AE 8C 60 */	b cLib_addCalcAngleS2__FPssss
...
/* 807879BC  4B AE 8C 4C */	b cLib_addCalcAngleS2__FPssss
lbl_807879C0:
...
/* 807879DC  4B AE 8C 2C */	b cLib_addCalcAngleS2__FPssss
...
/* 807879F0  4B AE 8C 18 */	b cLib_addCalcAngleS2__FPssss
...
/* 80787A0C  4B AE 8B FC */	b cLib_addCalcAngleS2__FPssss
...
/* 80787A2C  4B AD FF 28 */	b cM_rndF__Ff
...
/* 80787A40  4B AD FF 4C */	b cM_rndFX__Ff
...
/* 80787A70  4B AE 8B 98 */	b cLib_addCalcAngleS2__FPssss
...
/* 80787A94  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80787A98  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80787AFC  4B 8E FA 80 */	b __ct__11dBgS_GndChkFv
...
/* 80787B1C  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80787B20  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80787B24  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80787B28  4B BB E9 88 */	b PSMTXCopy
...
/* 80787B44  4B AE 93 A8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80787B68  4B AE 01 C0 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 80787B6C  7F C3 F3 78 */	mr r3, r30
/* 80787B70  38 81 00 74 */	addi r4, r1, 0x74
/* 80787B74  4B 8E C9 2C */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80787BB4  4B AE 01 58 */	b SetPos__11cBgS_GndChkFPC3Vec
/* 80787BB8  7F C3 F3 78 */	mr r3, r30
/* 80787BBC  38 81 00 74 */	addi r4, r1, 0x74
/* 80787BC0  4B 8E C8 E0 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80787BEC  4B AD FA 88 */	b cM_atan2s__Fff
...
/* 80787C38  4B AE 00 D4 */	b SetPos__11cBgS_GndChkFPC3Vec
/* 80787C3C  7F C3 F3 78 */	mr r3, r30
/* 80787C40  38 81 00 74 */	addi r4, r1, 0x74
/* 80787C44  4B 8E C8 5C */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80787C70  4B AD FA 04 */	b cM_atan2s__Fff
...
/* 80787C9C  4B 8E F9 54 */	b __dt__11dBgS_GndChkFv
lbl_80787CA0:
...
/* 80787CB0  4B AE 89 58 */	b cLib_addCalcAngleS2__FPssss
...
/* 80787CC4  4B AE 89 44 */	b cLib_addCalcAngleS2__FPssss
...
/* 80787D44  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80787D48  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80787D4C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80787D50  4B BB E7 60 */	b PSMTXCopy
/* 80787D54  38 61 00 68 */	addi r3, r1, 0x68
/* 80787D58  38 81 00 5C */	addi r4, r1, 0x5c
/* 80787D5C  4B AE 91 90 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80787D80  4B 89 52 A0 */	b fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_80787D84:
...
/* 80787DC4  4B BD A4 58 */	b _restgpr_26

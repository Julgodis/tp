...
/* 8078525C  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 80785284  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
...
/* 8078529C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 807852BC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 807852D0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 807852EC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785308  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785334  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80785338  4B BC 11 78 */	b PSMTXCopy
/* 8078533C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80785340  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80785344  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785358  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8078536C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785380  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8078539C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 807853C8  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807853CC  4B BC 10 E4 */	b PSMTXCopy
/* 807853D0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807853D4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 807853D8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 807853EC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785400  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785414  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80785430  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

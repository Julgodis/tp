...
/* 806B9680  4B CA 8B 5C */	b _savegpr_29
/* 806B9684  7C 7F 1B 78 */	mr r31, r3
/* 806B9688  3C 60 80 6C */	lis r3, lit_3827@ha
/* 806B968C  C0 03 B6 D4 */	lfs f0, lit_3827@l(r3)
...
/* 806B96B0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806B96B4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806B96B8  4B C8 CD F8 */	b PSMTXCopy
/* 806B96BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B96C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B96C4  38 81 00 08 */	addi r4, r1, 8
/* 806B96C8  7C 85 23 78 */	mr r5, r4
/* 806B96CC  4B C8 D6 A0 */	b PSMTXMultVec
/* 806B96D0  38 7F 07 3C */	addi r3, r31, 0x73c
/* 806B96D4  38 81 00 08 */	addi r4, r1, 8
/* 806B96D8  4B BB 5F 70 */	b SetC__8cM3dGSphFRC4cXyz
/* 806B96DC  38 7F 07 3C */	addi r3, r31, 0x73c
/* 806B96E0  3C 80 80 6C */	lis r4, lit_3951@ha
...
/* 806B9710  4B BA B4 98 */	b Set__4cCcSFP8cCcD_Obj
/* 806B9714  3C 60 80 6C */	lis r3, lit_3827@ha
/* 806B9718  C0 03 B6 D4 */	lfs f0, lit_3827@l(r3)
...
/* 806B973C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806B9740  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806B9744  4B C8 CD 6C */	b PSMTXCopy
/* 806B9748  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B974C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B9750  38 81 00 08 */	addi r4, r1, 8
/* 806B9754  7C 85 23 78 */	mr r5, r4
/* 806B9758  4B C8 D6 14 */	b PSMTXMultVec
/* 806B975C  38 7F 08 74 */	addi r3, r31, 0x874
/* 806B9760  38 81 00 08 */	addi r4, r1, 8
/* 806B9764  4B BB 5E E4 */	b SetC__8cM3dGSphFRC4cXyz
/* 806B9768  38 7F 08 74 */	addi r3, r31, 0x874
/* 806B976C  3C 80 80 6C */	lis r4, lit_3951@ha
/* 806B9770  C0 24 B7 84 */	lfs f1, lit_3951@l(r4)
/* 806B9774  C0 1E 00 08 */	lfs f0, 8(r30)
/* 806B9778  EC 21 00 32 */	fmuls f1, f1, f0
/* 806B977C  4B BB 5F 8C */	b SetR__8cM3dGSphFf
/* 806B9780  7F A3 EB 78 */	mr r3, r29
/* 806B9784  38 9F 07 50 */	addi r4, r31, 0x750
/* 806B9788  4B BA B4 20 */	b Set__4cCcSFP8cCcD_Obj
/* 806B978C  39 61 00 30 */	addi r11, r1, 0x30
/* 806B9790  4B CA 8A 98 */	b _restgpr_29

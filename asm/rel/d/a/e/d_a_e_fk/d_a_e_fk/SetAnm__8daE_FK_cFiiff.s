...
/* 806B9A48  4B CA 87 94 */	b _savegpr_29
...
/* 806B9A60  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806B9A64  38 63 B8 1C */	addi r3, r3, stringBase0@l
/* 806B9A68  38 63 00 05 */	addi r3, r3, 5
/* 806B9A6C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806B9A70  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 806B9A74  3C A5 00 02 */	addis r5, r5, 2
/* 806B9A78  38 C0 00 80 */	li r6, 0x80
/* 806B9A7C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806B9A80  4B 98 28 6C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806B9A98  3C C0 80 6C */	lis r6, lit_3827@ha
/* 806B9A9C  C0 66 B6 D4 */	lfs f3, lit_3827@l(r6)
/* 806B9AA0  3C C0 80 6C */	lis r6, lit_4037@ha
/* 806B9AA4  C0 86 B7 A0 */	lfs f4, lit_4037@l(r6)
/* 806B9AA8  4B 95 73 C8 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806B9AC4  4B CA 87 64 */	b _restgpr_29

...
/* 80698F98  4B CC 92 40 */	b _savegpr_28
/* 80698F9C  7C 7D 1B 78 */	mr r29, r3
/* 80698FA0  3C 60 80 6A */	lis r3, lit_3788@ha
/* 80698FA4  3B C3 9C B0 */	addi r30, r3, lit_3788@l
...
/* 80698FFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80699000  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80699004  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 80699008  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 8069900C  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 80699010  4B CA D8 D8 */	b PSMTXTrans
/* 80699014  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80699018  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069901C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80699020  4B 97 34 14 */	b mDoMtx_YrotM__FPA4_fs
/* 80699024  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80699028  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069902C  A8 9D 04 E4 */	lha r4, 0x4e4(r29)
/* 80699030  4B 97 33 6C */	b mDoMtx_XrotM__FPA4_fs
/* 80699034  3C 60 80 6A */	lis r3, l_HIO@ha
/* 80699038  3B E3 9E 98 */	addi r31, r3, l_HIO@l
/* 8069903C  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 80699EA0 */
/* 80699040  FC 40 08 90 */	fmr f2, f1
/* 80699044  FC 60 08 90 */	fmr f3, f1
/* 80699048  4B 97 3D F0 */	b scaleM__14mDoMtx_stack_cFfff
/* 8069904C  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 80699050  83 83 00 04 */	lwz r28, 4(r3)
/* 80699054  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80699058  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069905C  38 9C 00 24 */	addi r4, r28, 0x24
/* 80699060  4B CA D4 50 */	b PSMTXCopy
/* 80699064  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80699068  7C 03 07 74 */	extsb r3, r0
/* 8069906C  4B 99 40 00 */	b dComIfGp_getReverb__Fi
/* 80699070  7C 65 1B 78 */	mr r5, r3
/* 80699074  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 80699078  38 80 00 00 */	li r4, 0
/* 8069907C  4B 97 80 34 */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 80699098  4B C8 F3 94 */	b checkPass__12J3DFrameCtrlFf
...
/* 806990B0  4B C8 F3 7C */	b checkPass__12J3DFrameCtrlFf
...
/* 806990EC  4B 97 81 00 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 806990F0  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806990F4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806990F8  38 63 00 30 */	addi r3, r3, 0x30
/* 806990FC  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80699100  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80699104  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80699108  4B CA D3 A8 */	b PSMTXCopy
...
/* 80699124  4B BD 7D C8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80699168  4B BD 7D 84 */	b MtxPosition__FP4cXyzP4cXyz
/* 8069916C  38 7D 0A 10 */	addi r3, r29, 0xa10
/* 80699170  38 81 00 0C */	addi r4, r1, 0xc
/* 80699174  4B BD 64 D4 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 80699188  4B BD 65 80 */	b SetR__8cM3dGSphFf
/* 8069918C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80699190  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80699194  38 63 23 3C */	addi r3, r3, 0x233c
/* 80699198  38 9D 08 EC */	addi r4, r29, 0x8ec
/* 8069919C  4B BC BA 0C */	b Set__4cCcSFP8cCcD_Obj
/* 806991A0  38 60 00 01 */	li r3, 1
/* 806991A4  39 61 00 40 */	addi r11, r1, 0x40
/* 806991A8  4B CC 90 7C */	b _restgpr_28

...
/* 806C1508  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C150C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C1510  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 806C156C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806C1570  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806C1574  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806C1578  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
...
/* 806C162C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C1630  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806C1634  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806C1804  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C1808  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806C1834  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */

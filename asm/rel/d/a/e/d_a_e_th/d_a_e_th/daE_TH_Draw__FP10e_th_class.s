...
/* 807B0BE0 00000010  4B BB 15 F0 */	b _savegpr_26
/* 807B0BE4 00000014  7C 7D 1B 78 */	mr r29, r3
/* 807B0BE8 00000018  3C 60 80 7B */	lis r3, lit_3906@ha
/* 807B0BEC 0000001C  3B E3 44 9C */	addi r31, r3, lit_3906@l
...
lbl_807B0C0C:
/* 807B0C0C 00000000  3C 60 80 43 */	lis r3, g_env_light@ha
/* 807B0C10 00000004  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 807B0C20 00000014  4B 9F 2B A4 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 807B0C24 00000018  3C 60 80 43 */	lis r3, g_env_light@ha
/* 807B0C28 0000001C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 807B0C2C 00000020  80 9E 00 04 */	lwz r4, 4(r30)
/* 807B0C30 00000024  38 BD 01 0C */	addi r5, r29, 0x10c
/* 807B0C34 00000028  4B 9F 41 6C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 807B0CF8 00000004  4B 86 04 C8 */	b entryDL__16mDoExt_McaMorfSOFv
/* 807B0CFC 00000008  C0 5D 04 D8 */	lfs f2, 0x4d8(r29)
/* 807B0D00 0000000C  C0 1F 00 74 */	lfs f0, 0x74(r31)	/* effective address: 807B4510 */
...
/* 807B0D2C 00000038  C0 3F 00 78 */	lfs f1, 0x78(r31)	/* effective address: 807B4514 */
/* 807B0D30 0000003C  C0 5F 00 04 */	lfs f2, 4(r31)	/* effective address: 807B44A0 */
...
/* 807B0D44 00000050  C0 BF 00 08 */	lfs f5, 8(r31)	/* effective address: 807B44A4 */
/* 807B0D48 00000054  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 807B0D4C 00000058  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 807B0D50 0000005C  4B 87 DB C0 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 807B0D68 00000004  4B BB 14 B4 */	b _restgpr_26

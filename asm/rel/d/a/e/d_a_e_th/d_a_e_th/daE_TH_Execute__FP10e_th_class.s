...
/* 807B301C  4B BA F1 B4 */	b _savegpr_26
/* 807B3020  7C 7F 1B 78 */	mr r31, r3
/* 807B3024  3C 60 80 7B */	lis r3, lit_3906@ha
/* 807B3028  3B A3 44 9C */	addi r29, r3, lit_3906@l
/* 807B302C  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 807B3030  38 83 0C 98 */	addi r4, r3, struct_80450C98+0x0@l
/* 807B3034  88 64 00 00 */	lbz r3, 0(r4)	/* effective address: 80450C98 */
...
/* 807B30B4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807B30B8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807B30BC  38 84 0F 38 */	addi r4, r4, 0xf38
/* 807B30C0  4B 8C 39 EC */	b CrrPos__9dBgS_AcchFR4dBgS
/* 807B30C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807B30C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807B30CC  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 807B30D0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 807B30D4  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 807B30D8  4B B9 38 10 */	b PSMTXTrans
/* 807B30DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807B30E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807B30E4  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 807B30E8  4B 85 93 4C */	b mDoMtx_YrotM__FPA4_fs
/* 807B30EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807B30F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807B30F4  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 807B30F8  4B 85 92 A4 */	b mDoMtx_XrotM__FPA4_fs
/* 807B30FC  3C 60 80 7B */	lis r3, l_HIO@ha
/* 807B3100  3B C3 48 80 */	addi r30, r3, l_HIO@l
/* 807B3104  C0 3E 00 08 */	lfs f1, 8(r30)	/* effective address: 807B4888 */
/* 807B3108  FC 40 08 90 */	fmr f2, f1
/* 807B310C  FC 60 08 90 */	fmr f3, f1
/* 807B3110  4B 85 9D 28 */	b scaleM__14mDoMtx_stack_cFfff
/* 807B3114  C0 3D 00 74 */	lfs f1, 0x74(r29)
/* 807B3118  C0 5D 00 04 */	lfs f2, 4(r29)
/* 807B311C  FC 60 08 90 */	fmr f3, f1
/* 807B3120  4B 85 9C 7C */	b transM__14mDoMtx_stack_cFfff
/* 807B3124  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 807B3128  83 83 00 04 */	lwz r28, 4(r3)
/* 807B312C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807B3130  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807B3134  38 9C 00 24 */	addi r4, r28, 0x24
/* 807B3138  4B B9 33 78 */	b PSMTXCopy
/* 807B313C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 807B3140  7C 03 07 74 */	extsb r3, r0
/* 807B3144  4B 87 9F 28 */	b dComIfGp_getReverb__Fi
/* 807B3148  7C 65 1B 78 */	mr r5, r3
/* 807B314C  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 807B3150  38 80 00 00 */	li r4, 0
/* 807B3154  4B 85 DF 5C */	b play__16mDoExt_McaMorfSOFUlSc
/* 807B3158  7F E3 FB 78 */	mr r3, r31
/* 807B315C  4B FF FC 91 */	bl anm_se_set__FP10e_th_class
/* 807B3160  80 7F 05 CC */	lwz r3, 0x5cc(r31)
/* 807B3164  4B 85 E0 88 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 807B3168  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 807B316C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807B3170  38 63 00 C0 */	addi r3, r3, 0xc0
/* 807B3174  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807B3178  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807B317C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807B3180  4B B9 33 30 */	b PSMTXCopy
...
/* 807B319C  4B AB DD 50 */	b MtxPosition__FP4cXyzP4cXyz
/* 807B31A0  38 7F 0A 6C */	addi r3, r31, 0xa6c
/* 807B31A4  38 9F 0D 14 */	addi r4, r31, 0xd14
/* 807B31A8  4B AB C4 A0 */	b SetC__8cM3dGSphFRC4cXyz
/* 807B31AC  38 7F 0A 6C */	addi r3, r31, 0xa6c
/* 807B31B0  C0 3D 00 70 */	lfs f1, 0x70(r29)
/* 807B31B4  4B AB C5 54 */	b SetR__8cM3dGSphFf
/* 807B31B8  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 807B31BC  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807B31C0  38 63 00 30 */	addi r3, r3, 0x30
/* 807B31C4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807B31C8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807B31CC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807B31D0  4B B9 32 E0 */	b PSMTXCopy
...
/* 807B31EC  4B AB DD 00 */	b MtxPosition__FP4cXyzP4cXyz
/* 807B31F0  38 7F 0B A4 */	addi r3, r31, 0xba4
/* 807B31F4  38 81 00 08 */	addi r4, r1, 8
/* 807B31F8  4B AB C4 50 */	b SetC__8cM3dGSphFRC4cXyz
/* 807B31FC  38 7F 0B A4 */	addi r3, r31, 0xba4
/* 807B3200  C0 3D 00 7C */	lfs f1, 0x7c(r29)
/* 807B3204  4B AB C5 04 */	b SetR__8cM3dGSphFf
/* 807B3208  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 807B320C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807B3210  38 63 00 60 */	addi r3, r3, 0x60
/* 807B3214  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807B3218  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807B321C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807B3220  4B B9 32 90 */	b PSMTXCopy
...
/* 807B32E8  4B AB C3 60 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 807B330C  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807B3310  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807B3314  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807B3318  4B B9 31 98 */	b PSMTXCopy
...
/* 807B3334  4B AB DB B8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807B3370  4B AB DB 7C */	b MtxPosition__FP4cXyzP4cXyz
/* 807B3374  38 7F 0B A4 */	addi r3, r31, 0xba4
/* 807B3378  38 81 00 08 */	addi r4, r1, 8
/* 807B337C  4B AB C2 CC */	b SetC__8cM3dGSphFRC4cXyz
lbl_807B3380:
...
/* 807B33B8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807B33BC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 807B3410  4B AB 17 98 */	b Set__4cCcSFP8cCcD_Obj
...
/* 807B3430  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807B3434  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807B3438  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807B343C  4B B9 30 74 */	b PSMTXCopy
...
/* 807B345C  4B AB DA 90 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807B3480  4B AB DA 6C */	b MtxPosition__FP4cXyzP4cXyz
/* 807B3484  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 807B3488  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807B348C  38 63 03 30 */	addi r3, r3, 0x330
/* 807B3490  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807B3494  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807B3498  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807B349C  4B B9 30 14 */	b PSMTXCopy
...
/* 807B34C0  4B AB DA 2C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807B34E4  4B AB DA 08 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807B3500  4B BA ED 1C */	b _restgpr_26

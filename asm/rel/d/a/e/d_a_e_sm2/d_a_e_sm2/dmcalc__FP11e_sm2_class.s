...
/* 8079A5A0 00000004  4B FF E5 19 */	bl _savegpr_22
/* 8079A5A4 00000008  7C 7A 1B 78 */	mr r26, r3
/* 8079A5A8 0000000C  3C 60 00 00 */	lis r3, lit_3790@ha /* 8079D5B0 */
/* 8079A5AC 00000010  3B E3 00 00 */	addi r31, r3, lit_3790@l /* 8079D5B0 */
/* 8079A5B0 00000014  3B BA 07 14 */	addi r29, r26, 0x714
/* 8079A5B4 00000018  3B 9A 07 6E */	addi r28, r26, 0x76e
/* 8079A5B8 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8079A5BC 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8079A5C0 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 8079A5C4 00000028  A8 9A 04 E6 */	lha r4, 0x4e6(r26)
/* 8079A5C8 0000002C  4B FF E4 F1 */	bl mDoMtx_YrotS__FPA4_fs
/* 8079A5CC 00000030  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8079A5D0 00000034  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8079A5D4 00000038  80 63 00 00 */	lwz r3, 0(r3)
/* 8079A5D8 0000003C  A8 9A 04 E4 */	lha r4, 0x4e4(r26)
/* 8079A5DC 00000040  4B FF E4 DD */	bl mDoMtx_XrotM__FPA4_fs
/* 8079A5E0 00000044  C0 1F 00 04 */	lfs f0, 4(r31)
/* 8079A5E4 00000048  D0 01 00 44 */	stfs f0, 0x44(r1)
/* 8079A5E8 0000004C  D0 01 00 48 */	stfs f0, 0x48(r1)
/* 8079A5EC 00000050  C0 3F 00 D8 */	lfs f1, 0xd8(r31)
...
/* 8079A604 00000068  C0 1F 00 DC */	lfs f0, 0xdc(r31)
...
/* 8079A628 00000014  C0 1F 00 E0 */	lfs f0, 0xe0(r31)
...
/* 8079A644 0000000C  C0 1F 00 84 */	lfs f0, 0x84(r31)
...
/* 8079A65C 00000008  C0 1F 00 E4 */	lfs f0, 0xe4(r31)
...
/* 8079A66C 00000008  4B FF E4 4D */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8079A67C 00000018  C0 3F 00 04 */	lfs f1, 4(r31)
...
/* 8079A698 00000014  C0 3F 00 84 */	lfs f1, 0x84(r31)
/* 8079A69C 00000018  48 00 00 08 */	b lbl_8079A6A4
lbl_8079A6A0:
/* 8079A6A0 00000000  C0 3F 00 E8 */	lfs f1, 0xe8(r31)
lbl_8079A6A4:
/* 8079A6A4 00000000  38 7A 06 AC */	addi r3, r26, 0x6ac
/* 8079A6A8 00000004  C0 5F 00 08 */	lfs f2, 8(r31)
/* 8079A6AC 00000008  C0 7F 00 EC */	lfs f3, 0xec(r31)
/* 8079A6B0 0000000C  4B FF E4 09 */	bl cLib_addCalc2__FPffff
/* 8079A6B4 00000010  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 8079A6E0 0000003C  3C 60 00 00 */	lis r3, data_8079D87C@ha /* 8079D87C */
/* 8079A6E4 00000040  38 63 00 00 */	addi r3, r3, data_8079D87C@l /* 8079D87C */
/* 8079A6E8 00000044  7F 63 02 AE */	lhax r27, r3, r0
lbl_8079A6EC:
/* 8079A6EC 00000000  C3 BF 00 04 */	lfs f29, 4(r31)
/* 8079A6F0 00000004  D3 A1 00 44 */	stfs f29, 0x44(r1)
/* 8079A6F4 00000008  D3 A1 00 48 */	stfs f29, 0x48(r1)
/* 8079A6F8 0000000C  C3 DF 00 00 */	lfs f30, 0(r31)
...
/* 8079A718 0000002C  C3 FF 00 08 */	lfs f31, 8(r31)
/* 8079A71C 00000030  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8079A720 00000034  3B 03 00 00 */	addi r24, r3, calc_mtx@l /* 80450768 */
lbl_8079A724:
...
/* 8079A740 0000001C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 8079A744 00000020  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
/* 8079A748 00000024  7F 83 04 2E */	lfsx f28, r3, r0
/* 8079A74C 00000028  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8079A750 0000002C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8079A754 00000030  80 63 00 00 */	lwz r3, 0(r3)
/* 8079A758 00000034  A8 9A 04 E6 */	lha r4, 0x4e6(r26)
/* 8079A75C 00000038  4B FF E3 5D */	bl mDoMtx_YrotS__FPA4_fs
/* 8079A760 0000003C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8079A764 00000040  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8079A768 00000044  80 63 00 00 */	lwz r3, 0(r3)
/* 8079A76C 00000048  A8 9A 04 E4 */	lha r4, 0x4e4(r26)
/* 8079A770 0000004C  4B FF E3 49 */	bl mDoMtx_XrotM__FPA4_fs
/* 8079A774 00000050  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8079A778 00000054  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8079A77C 00000058  80 63 00 00 */	lwz r3, 0(r3)
/* 8079A780 0000005C  C0 1F 00 F0 */	lfs f0, 0xf0(r31)
...
/* 8079A794 00000070  4B FF E3 25 */	bl mDoMtx_YrotM__FPA4_fs
/* 8079A798 00000074  C0 1F 00 04 */	lfs f0, 4(r31)
/* 8079A79C 00000078  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8079A7A0 0000007C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8079A7A4 00000080  C0 7F 00 F4 */	lfs f3, 0xf4(r31)
/* 8079A7A8 00000084  C0 5F 00 F8 */	lfs f2, 0xf8(r31)
/* 8079A7AC 00000088  88 1A 06 AA */	lbz r0, 0x6aa(r26)
/* 8079A7B0 0000008C  C8 3F 00 B8 */	lfd f1, 0xb8(r31)
...
/* 8079A7DC 000000B8  4B FF E2 DD */	bl MtxPosition__FP4cXyzP4cXyz
lbl_8079A7E0:
...
/* 8079A800 00000020  4B FF E2 B9 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz
/* 8079A804 00000024  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8079A808 00000028  41 82 00 24 */	beq lbl_8079A82C
/* 8079A80C 0000002C  C0 3F 00 40 */	lfs f1, 0x40(r31)
/* 8079A810 00000030  C0 1A 08 34 */	lfs f0, 0x834(r26)
/* 8079A814 00000034  EC 21 00 32 */	fmuls f1, f1, f0
/* 8079A818 00000038  3C 60 00 00 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 80450CD0 */
/* 8079A81C 0000003C  C0 03 00 00 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3) /* 80450CD0 */
...
lbl_8079A82C:
/* 8079A82C 00000000  C0 3F 00 40 */	lfs f1, 0x40(r31)
...
/* 8079A8C4 00000030  4B FF E1 F5 */	bl cM_atan2s__Fff
...
/* 8079A8EC 00000004  4B FF E1 CD */	bl cM_atan2s__Fff
/* 8079A8F0 00000008  7C 03 00 D0 */	neg r0, r3
/* 8079A8F4 0000000C  7C 17 07 34 */	extsh r23, r0
/* 8079A8F8 00000010  80 78 00 00 */	lwz r3, 0(r24)
/* 8079A8FC 00000014  7E C4 B3 78 */	mr r4, r22
/* 8079A900 00000018  4B FF E1 B9 */	bl mDoMtx_YrotS__FPA4_fs
/* 8079A904 0000001C  80 78 00 00 */	lwz r3, 0(r24)
/* 8079A908 00000020  7E E4 BB 78 */	mr r4, r23
/* 8079A90C 00000024  4B FF E1 AD */	bl mDoMtx_XrotM__FPA4_fs
/* 8079A910 00000028  38 61 00 44 */	addi r3, r1, 0x44
/* 8079A914 0000002C  38 81 00 38 */	addi r4, r1, 0x38
/* 8079A918 00000030  4B FF E1 A1 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8079A9A0 00000008  4B FF E1 19 */	bl _restgpr_22

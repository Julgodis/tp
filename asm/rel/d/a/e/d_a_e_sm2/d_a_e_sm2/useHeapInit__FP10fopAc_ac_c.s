...
/* 8079C194 00000010  4B FF C9 25 */	bl _savegpr_29
/* 8079C198 00000014  7C 7F 1B 78 */	mr r31, r3
/* 8079C19C 00000018  38 60 00 58 */	li r3, 0x58
/* 8079C1A0 0000001C  4B FF C9 19 */	bl __nw__FUl
/* 8079C1A4 00000020  7C 7E 1B 79 */	or. r30, r3, r3
/* 8079C1A8 00000024  41 82 00 78 */	beq lbl_8079C220
/* 8079C1AC 00000028  3C 60 00 00 */	lis r3, stringBase0@ha /* 8079D718 */
/* 8079C1B0 0000002C  38 63 00 00 */	addi r3, r3, stringBase0@l /* 8079D718 */
/* 8079C1B4 00000030  38 63 00 07 */	addi r3, r3, 7
/* 8079C1B8 00000034  38 80 00 08 */	li r4, 8
/* 8079C1BC 00000038  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8079C1C0 0000003C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8079C1D0 0000004C  4B FF C8 E9 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8079C208 00000084  3D 20 00 00 */	lis r9, lit_3792@ha /* 8079D5B8 */
/* 8079C20C 00000088  C0 29 00 00 */	lfs f1, lit_3792@l(r9) /* 8079D5B8 */
/* 8079C210 0000008C  39 20 00 00 */	li r9, 0
/* 8079C214 00000090  39 40 FF FF */	li r10, -1
/* 8079C218 00000094  4B FF C8 A1 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8079C24C 00000008  4B FF C8 6D */	bl create__21mDoExt_invisibleModelFP8J3DModelUc
...
/* 8079C270 00000010  3C 60 00 00 */	lis r3, nodeCallBack__FP8J3DJointi@ha /* 80798C48 */
/* 8079C274 00000014  38 83 00 00 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l /* 80798C48 */
...
/* 8079C2C0 00000020  4B FF C7 F9 */	bl __nw__FUl
/* 8079C2C4 00000024  7C 7E 1B 79 */	or. r30, r3, r3
/* 8079C2C8 00000028  41 82 00 20 */	beq lbl_8079C2E8
/* 8079C2CC 0000002C  3C 80 00 00 */	lis r4, __vt__12J3DFrameCtrl@ha /* 8079DB1C */
/* 8079C2D0 00000030  38 04 00 00 */	addi r0, r4, __vt__12J3DFrameCtrl@l /* 8079DB1C */
/* 8079C2D4 00000034  90 1E 00 00 */	stw r0, 0(r30)
/* 8079C2D8 00000038  38 80 00 00 */	li r4, 0
/* 8079C2DC 0000003C  4B FF C7 DD */	bl init__12J3DFrameCtrlFs
...
lbl_8079C300:
/* 8079C300 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 8079D718 */
/* 8079C304 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 8079D718 */
/* 8079C308 00000008  38 63 00 07 */	addi r3, r3, 7
/* 8079C30C 0000000C  38 80 00 0B */	li r4, 0xb
/* 8079C310 00000010  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8079C314 00000014  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8079C328 00000028  4B FF C7 91 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8079C34C 0000004C  3D 00 00 00 */	lis r8, lit_3791@ha /* 8079D5B4 */
/* 8079C350 00000050  C0 28 00 00 */	lfs f1, lit_3791@l(r8) /* 8079D5B4 */
/* 8079C354 00000054  39 00 00 00 */	li r8, 0
/* 8079C358 00000058  39 20 FF FF */	li r9, -1
/* 8079C35C 0000005C  4B FF C7 5D */	bl init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 8079C374 00000004  4B FF C7 45 */	bl __nw__FUl
/* 8079C378 00000008  7C 7E 1B 79 */	or. r30, r3, r3
/* 8079C37C 0000000C  41 82 00 6C */	beq lbl_8079C3E8
/* 8079C380 00000010  3C 60 00 00 */	lis r3, stringBase0@ha /* 8079D718 */
/* 8079C384 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l /* 8079D718 */
...
/* 8079C398 00000028  4B FF C7 21 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8079C3D0 00000060  3D 20 00 00 */	lis r9, lit_3792@ha /* 8079D5B8 */
/* 8079C3D4 00000064  C0 29 00 00 */	lfs f1, lit_3792@l(r9) /* 8079D5B8 */
/* 8079C3D8 00000068  39 20 00 00 */	li r9, 0
/* 8079C3DC 0000006C  39 40 FF FF */	li r10, -1
/* 8079C3E0 00000070  4B FF C6 D9 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8079C414 00000008  4B FF C6 A5 */	bl create__21mDoExt_invisibleModelFP8J3DModelUc
...
/* 8079C424 00000004  4B FF C6 95 */	bl _restgpr_29

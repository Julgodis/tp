...
/* 8079C194  4B BC 60 48 */	b _savegpr_29
/* 8079C198  7C 7F 1B 78 */	mr r31, r3
/* 8079C19C  38 60 00 58 */	li r3, 0x58
/* 8079C1A0  4B B3 2A AC */	b __nw__FUl
/* 8079C1A4  7C 7E 1B 79 */	or. r30, r3, r3
/* 8079C1A8  41 82 00 78 */	beq lbl_8079C220
/* 8079C1AC  3C 60 80 7A */	lis r3, stringBase0@ha
/* 8079C1B0  38 63 D7 18 */	addi r3, r3, stringBase0@l
/* 8079C1B4  38 63 00 07 */	addi r3, r3, 7
/* 8079C1B8  38 80 00 08 */	li r4, 8
/* 8079C1BC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8079C1C0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8079C1C4  3C A5 00 02 */	addis r5, r5, 2
/* 8079C1C8  38 C0 00 80 */	li r6, 0x80
/* 8079C1CC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8079C1D0  4B 8A 01 1C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8079C208  3D 20 80 7A */	lis r9, lit_3792@ha
/* 8079C20C  C0 29 D5 B8 */	lfs f1, lit_3792@l(r9)
/* 8079C210  39 20 00 00 */	li r9, 0
/* 8079C214  39 40 FF FF */	li r10, -1
/* 8079C218  4B 87 45 B8 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8079C24C  4B 87 22 F0 */	b create__21mDoExt_invisibleModelFP8J3DModelUc
...
/* 8079C270  3C 60 80 7A */	lis r3, nodeCallBack__FP8J3DJointi@ha
/* 8079C274  38 83 8C 48 */	addi r4, r3, nodeCallBack__FP8J3DJointi@l
...
/* 8079C2C0  4B B3 29 8C */	b __nw__FUl
/* 8079C2C4  7C 7E 1B 79 */	or. r30, r3, r3
/* 8079C2C8  41 82 00 20 */	beq lbl_8079C2E8
/* 8079C2CC  3C 80 80 7A */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8079C2D0  38 04 DB 1C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8079C2D4  90 1E 00 00 */	stw r0, 0(r30)
/* 8079C2D8  38 80 00 00 */	li r4, 0
/* 8079C2DC  4B B8 C1 20 */	b init__12J3DFrameCtrlFs
...
lbl_8079C300:
/* 8079C300  3C 60 80 7A */	lis r3, stringBase0@ha
/* 8079C304  38 63 D7 18 */	addi r3, r3, stringBase0@l
/* 8079C308  38 63 00 07 */	addi r3, r3, 7
/* 8079C30C  38 80 00 0B */	li r4, 0xb
/* 8079C310  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8079C314  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8079C328  4B 89 FF C4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8079C34C  3D 00 80 7A */	lis r8, lit_3791@ha
/* 8079C350  C0 28 D5 B4 */	lfs f1, lit_3791@l(r8)
/* 8079C354  39 00 00 00 */	li r8, 0
/* 8079C358  39 20 FF FF */	li r9, -1
/* 8079C35C  4B 87 12 E0 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 8079C374  4B B3 28 D8 */	b __nw__FUl
/* 8079C378  7C 7E 1B 79 */	or. r30, r3, r3
/* 8079C37C  41 82 00 6C */	beq lbl_8079C3E8
/* 8079C380  3C 60 80 7A */	lis r3, stringBase0@ha
/* 8079C384  38 63 D7 18 */	addi r3, r3, stringBase0@l
...
/* 8079C398  4B 89 FF 54 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8079C3D0  3D 20 80 7A */	lis r9, lit_3792@ha
/* 8079C3D4  C0 29 D5 B8 */	lfs f1, lit_3792@l(r9)
/* 8079C3D8  39 20 00 00 */	li r9, 0
/* 8079C3DC  39 40 FF FF */	li r10, -1
/* 8079C3E0  4B 87 43 F0 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl

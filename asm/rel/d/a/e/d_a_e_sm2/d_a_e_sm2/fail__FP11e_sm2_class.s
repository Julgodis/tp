...
/* 8079A3C4 00000018  3C 60 80 7A */	lis r3, lit_3790@ha
/* 8079A3C8 0000001C  3B E3 D5 B0 */	addi r31, r3, lit_3790@l
/* 8079A3CC 00000020  38 00 00 0A */	li r0, 0xa
/* 8079A3D0 00000024  B0 1E 06 8C */	sth r0, 0x68c(r30)
/* 8079A3D4 00000028  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 8079D5B4 */
...
/* 8079A408 00000004  C0 3F 00 6C */	lfs f1, 0x6c(r31)	/* effective address: 8079D61C */
/* 8079A40C 00000008  C0 5F 00 CC */	lfs f2, 0xcc(r31)	/* effective address: 8079D67C */
/* 8079A410 0000000C  FC 60 10 90 */	fmr f3, f2
/* 8079A414 00000010  4B AD 56 28 */	b cLib_addCalc2__FPffff
/* 8079A418 00000014  C0 3E 06 B0 */	lfs f1, 0x6b0(r30)
/* 8079A41C 00000018  C0 1F 00 D0 */	lfs f0, 0xd0(r31)	/* effective address: 8079D680 */
...
/* 8079A42C 00000008  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 8079D5B8 */
/* 8079A430 0000000C  C0 5F 00 D4 */	lfs f2, 0xd4(r31)	/* effective address: 8079D684 */
/* 8079A434 00000010  4B AD 56 4C */	b cLib_addCalc0__FPfff
/* 8079A438 00000014  C0 3E 06 C4 */	lfs f1, 0x6c4(r30)
/* 8079A43C 00000018  C0 1F 00 CC */	lfs f0, 0xcc(r31)	/* effective address: 8079D67C */
...
/* 8079A454 00000004  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 8079D5D8 */
...
lbl_8079A494:
/* 8079A494 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8079A498 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8079A4A8 00000014  3C A0 80 7A */	lis r5, data_8079D874@ha
/* 8079A4AC 00000018  38 A5 D8 74 */	addi r5, r5, data_8079D874@l
/* 8079A4B0 0000001C  7C A5 00 AE */	lbzx r5, r5, r0
/* 8079A4B4 00000020  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 8079D5B0 */
/* 8079A4B8 00000024  C0 5F 00 30 */	lfs f2, 0x30(r31)	/* effective address: 8079D5E0 */
/* 8079A4BC 00000028  C0 7F 00 A4 */	lfs f3, 0xa4(r31)	/* effective address: 8079D654 */
/* 8079A4C0 0000002C  38 C0 50 00 */	li r6, 0x5000
/* 8079A4C4 00000030  38 E0 00 01 */	li r7, 1
/* 8079A4C8 00000034  4B 8D 95 40 */	b request__11dAttCatch_cFP10fopAc_ac_cUcfffsi
...
/* 8079A4F0 00000014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8079A4F4 00000018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8079A4F8 0000001C  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8079A4FC 00000020  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
/* 8079A500 00000024  81 8C 00 20 */	lwz r12, 0x20(r12)
/* 8079A504 00000028  7D 89 03 A6 */	mtctr r12
/* 8079A508 0000002C  4E 80 04 21 */	bctrl 
/* 8079A50C 00000030  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8079A510 00000034  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8079A514 00000038  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8079A518 0000003C  4B BA BF 98 */	b PSMTXCopy
/* 8079A51C 00000040  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 8079D5B4 */
...
/* 8079A534 00000058  4B AD 69 B8 */	b MtxPosition__FP4cXyzP4cXyz
/* 8079A538 0000005C  7F C3 F3 78 */	mr r3, r30
/* 8079A53C 00000060  38 81 00 08 */	addi r4, r1, 8
/* 8079A540 00000064  C0 3F 00 78 */	lfs f1, 0x78(r31)	/* effective address: 8079D628 */

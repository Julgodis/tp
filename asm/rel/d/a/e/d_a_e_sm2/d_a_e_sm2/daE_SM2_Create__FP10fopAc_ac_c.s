...
/* 8079C490  4B BC 5D 38 */	b _savegpr_24
/* 8079C494  7C 7F 1B 78 */	mr r31, r3
/* 8079C498  3C 80 80 7A */	lis r4, lit_3790@ha
/* 8079C49C  3B C4 D5 B0 */	addi r30, r4, lit_3790@l
...
/* 8079C4B8  4B 87 C6 AC */	b __ct__10fopAc_ac_cFv
/* 8079C4BC  38 7D 05 DC */	addi r3, r29, 0x5dc
/* 8079C4C0  4B B2 4A A4 */	b __ct__15Z2CreatureEnemyFv
/* 8079C4C4  38 7D 07 08 */	addi r3, r29, 0x708
/* 8079C4C8  3C 80 80 7A */	lis r4, __ct__4cXyzFv@ha
/* 8079C4CC  38 84 CE 48 */	addi r4, r4, __ct__4cXyzFv@l
/* 8079C4D0  3C A0 80 7A */	lis r5, __dt__4cXyzFv@ha
/* 8079C4D4  38 A5 D5 60 */	addi r5, r5, __dt__4cXyzFv@l
/* 8079C4D8  38 C0 00 0C */	li r6, 0xc
/* 8079C4DC  38 E0 00 08 */	li r7, 8
/* 8079C4E0  4B BC 58 80 */	b __construct_array
/* 8079C4E4  38 7D 07 68 */	addi r3, r29, 0x768
/* 8079C4E8  3C 80 80 7A */	lis r4, __ct__5csXyzFv@ha
/* 8079C4EC  38 84 CE 44 */	addi r4, r4, __ct__5csXyzFv@l
/* 8079C4F0  3C A0 80 7A */	lis r5, __dt__5csXyzFv@ha
/* 8079C4F4  38 A5 D5 24 */	addi r5, r5, __dt__5csXyzFv@l
/* 8079C4F8  38 C0 00 06 */	li r6, 6
/* 8079C4FC  38 E0 00 08 */	li r7, 8
/* 8079C500  4B BC 58 60 */	b __construct_array
/* 8079C504  38 7D 07 98 */	addi r3, r29, 0x798
/* 8079C508  3C 80 80 7A */	lis r4, __ct__4cXyzFv@ha
/* 8079C50C  38 84 CE 48 */	addi r4, r4, __ct__4cXyzFv@l
/* 8079C510  3C A0 80 7A */	lis r5, __dt__4cXyzFv@ha
/* 8079C514  38 A5 D5 60 */	addi r5, r5, __dt__4cXyzFv@l
/* 8079C518  38 C0 00 0C */	li r6, 0xc
/* 8079C51C  38 E0 00 08 */	li r7, 8
/* 8079C520  4B BC 58 40 */	b __construct_array
/* 8079C524  38 7D 07 F8 */	addi r3, r29, 0x7f8
/* 8079C528  3C 80 80 7A */	lis r4, __ct__5csXyzFv@ha
/* 8079C52C  38 84 CE 44 */	addi r4, r4, __ct__5csXyzFv@l
/* 8079C530  3C A0 80 7A */	lis r5, __dt__5csXyzFv@ha
/* 8079C534  38 A5 D5 24 */	addi r5, r5, __dt__5csXyzFv@l
/* 8079C538  38 C0 00 06 */	li r6, 6
/* 8079C53C  38 E0 00 08 */	li r7, 8
/* 8079C540  4B BC 58 20 */	b __construct_array
/* 8079C544  38 7D 08 54 */	addi r3, r29, 0x854
/* 8079C548  4B 8D 99 64 */	b __ct__12dBgS_AcchCirFv
/* 8079C54C  3B 1D 08 94 */	addi r24, r29, 0x894
/* 8079C550  7F 03 C3 78 */	mr r3, r24
/* 8079C554  4B 8D 9B 4C */	b __ct__9dBgS_AcchFv
/* 8079C558  3C 60 80 7A */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 8079C55C  38 63 DA F8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 8079C578  4B 8D C8 F0 */	b SetObj__16dBgS_PolyPassChkFv
/* 8079C57C  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8079C580  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8079C584  90 1D 0A 84 */	stw r0, 0xa84(r29)
/* 8079C588  38 7D 0A 88 */	addi r3, r29, 0xa88
/* 8079C58C  4B 8E 71 D4 */	b __ct__10dCcD_GSttsFv
/* 8079C590  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8079C594  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8079C5A8  3C 80 80 7A */	lis r4, __ct__8dCcD_SphFv@ha
/* 8079C5AC  38 84 CB F4 */	addi r4, r4, __ct__8dCcD_SphFv@l
/* 8079C5B0  3C A0 80 7A */	lis r5, __dt__8dCcD_SphFv@ha
/* 8079C5B4  38 A5 CB 28 */	addi r5, r5, __dt__8dCcD_SphFv@l
/* 8079C5B8  38 C0 01 38 */	li r6, 0x138
/* 8079C5BC  38 E0 00 04 */	li r7, 4
/* 8079C5C0  4B BC 57 A0 */	b __construct_array
lbl_8079C5C4:
...
/* 8079C5D4  3C 80 80 7A */	lis r4, stringBase0@ha
/* 8079C5D8  38 84 D7 18 */	addi r4, r4, stringBase0@l
/* 8079C5DC  38 84 00 07 */	addi r4, r4, 7
/* 8079C5E0  4B 89 08 DC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8079C600  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8079C604  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8079C608  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8079C60C  7C 05 07 74 */	extsb r5, r0
/* 8079C610  4B 89 8D 50 */	b isSwitch__10dSv_info_cCFii
...
lbl_8079C664:
/* 8079C664  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8079C668  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8079C66C  38 63 00 CC */	addi r3, r3, 0xcc
/* 8079C670  38 80 00 30 */	li r4, 0x30
/* 8079C674  4B 89 78 54 */	b isFirstBit__21dSv_player_get_item_cCFUc
...
/* 8079C6A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8079C6A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8079C6A8  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8079C6AC  3C 80 80 7A */	lis r4, stringBase0@ha
/* 8079C6B0  38 84 D7 18 */	addi r4, r4, stringBase0@l
/* 8079C6B4  38 84 00 0D */	addi r4, r4, 0xd
/* 8079C6B8  4B BC C2 DC */	b strcmp
/* 8079C6BC  2C 03 00 00 */	cmpwi r3, 0
/* 8079C6C0  40 82 00 1C */	bne lbl_8079C6DC
/* 8079C6C4  C0 3E 01 3C */	lfs f1, 0x13c(r30)
/* 8079C6C8  4B AC B2 8C */	b cM_rndF__Ff
...
/* 8079C6E8  3C 60 80 43 */	lis r3, g_Counter@ha
/* 8079C6EC  80 03 0C D8 */	lwz r0, g_Counter@l(r3)
...
/* 8079C808  3C 80 80 7A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 8079C80C  38 84 C1 84 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 8079C810  38 A0 20 D0 */	li r5, 0x20d0
/* 8079C814  4B 87 DC 9C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8079C83C  4B B2 48 58 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 8079C840  38 7F 05 DC */	addi r3, r31, 0x5dc
/* 8079C844  3C 80 80 7A */	lis r4, stringBase0@ha
/* 8079C848  38 84 D7 18 */	addi r4, r4, stringBase0@l
/* 8079C84C  38 84 00 07 */	addi r4, r4, 7
/* 8079C850  4B B2 53 40 */	b setEnemyName__15Z2CreatureEnemyFPCc
/* 8079C854  38 1F 05 DC */	addi r0, r31, 0x5dc
/* 8079C858  90 1F 0F 94 */	stw r0, 0xf94(r31)
/* 8079C85C  C0 3E 00 4C */	lfs f1, 0x4c(r30)
/* 8079C860  4B AC B0 F4 */	b cM_rndF__Ff
...
/* 8079C92C  4B 87 DB FC */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 8079C940  4B 87 DB F8 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 8079C96C  4B 8D 98 DC */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8079C970  38 7F 08 54 */	addi r3, r31, 0x854
/* 8079C974  C0 3E 00 30 */	lfs f1, 0x30(r30)
/* 8079C978  C0 5E 00 80 */	lfs f2, 0x80(r30)
/* 8079C97C  4B 8D 95 DC */	b SetWall__12dBgS_AcchCirFff
...
/* 8079C9A8  4B 8E 80 8C */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 8079C9F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8079C9FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8079CA00  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8079CA04  3C 80 80 7A */	lis r4, stringBase0@ha
/* 8079CA08  38 84 D7 18 */	addi r4, r4, stringBase0@l
/* 8079CA0C  38 84 00 15 */	addi r4, r4, 0x15
/* 8079CA10  4B BC BF 84 */	b strcmp
...
/* 8079CA50  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8079CA54  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8079CA58  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8079CA5C  3C 80 80 7A */	lis r4, stringBase0@ha
/* 8079CA60  38 84 D7 18 */	addi r4, r4, stringBase0@l
/* 8079CA64  38 84 00 15 */	addi r4, r4, 0x15
/* 8079CA68  4B BC BF 2C */	b strcmp
...
/* 8079CABC  4B AC AE 98 */	b cM_rndF__Ff
...
/* 8079CAD4  4B AC AE 80 */	b cM_rndF__Ff
...
/* 8079CB14  4B BC 57 00 */	b _restgpr_24

...
/* 806E9DDC  4B C7 83 D8 */	b _savegpr_19
/* 806E9DE0  7C 7E 1B 78 */	mr r30, r3
/* 806E9DE4  7C 9A 23 78 */	mr r26, r4
/* 806E9DE8  7C BB 2B 78 */	mr r27, r5
/* 806E9DEC  7C DC 33 78 */	mr r28, r6
/* 806E9DF0  3C 60 80 6F */	lis r3, cNullVec__6Z2Calc@ha
/* 806E9DF4  3A E3 A2 E8 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806E9DF8  3C 60 80 6F */	lis r3, lit_3905@ha
/* 806E9DFC  3B E3 A1 F4 */	addi r31, r3, lit_3905@l
/* 806E9E00  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E9E04  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E9E08  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806E9E0C  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806E9E10  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806E9E38  4B AC 27 44 */	b dKy_darkworld_check__Fv
...
/* 806E9E5C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806E9E60  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806E9E64  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806E9E68  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806E9E6C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806E9E70  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806E9E74  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806E9E78  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806E9E7C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806E9E80  4B C5 C6 30 */	b PSMTXCopy
...
/* 806E9E98  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E9E9C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E9EA0  38 81 00 4C */	addi r4, r1, 0x4c
/* 806E9EA4  38 A1 00 58 */	addi r5, r1, 0x58
/* 806E9EA8  4B C5 CE C4 */	b PSMTXMultVec
/* 806E9EAC  38 61 00 34 */	addi r3, r1, 0x34
/* 806E9EB0  38 81 00 58 */	addi r4, r1, 0x58
/* 806E9EB4  7F 65 DB 78 */	mr r5, r27
/* 806E9EB8  4B B7 CC 7C */	b __mi__4cXyzCFRC3Vec
...
/* 806E9ED4  4B B7 D7 A0 */	b cM_atan2s__Fff
...
/* 806E9F08  4B B7 D7 6C */	b cM_atan2s__Fff
...
/* 806E9F24  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E9F28  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806E9F2C  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806E9F78  4B 96 2B 18 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806E9F7C  7C 79 1B 79 */	or. r25, r3, r3
/* 806E9F80  41 82 00 FC */	beq lbl_806EA07C
/* 806E9F84  38 61 00 40 */	addi r3, r1, 0x40
/* 806E9F88  4B C5 D1 B0 */	b PSVECSquareMag
...
/* 806E9FF8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E9FFC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806EA068  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EA06C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806EA070:
...
/* 806EA0C0  4B 96 29 D0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806EA0FC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806EA100  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806EA12C  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806EA16C  4B 96 33 60 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806EA1CC  4B C7 80 34 */	b _restgpr_19

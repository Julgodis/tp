...
/* 806E6EF0 00000018  3C 80 80 6F */	lis r4, lit_3905@ha
/* 806E6EF4 0000001C  3B E4 A1 F4 */	addi r31, r4, lit_3905@l
...
/* 806E6F24 00000010  C0 3F 00 50 */	lfs f1, 0x50(r31)	/* effective address: 806EA244 */
/* 806E6F28 00000014  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 806EA1FC */
...
lbl_806E6F60:
/* 806E6F60 00000000  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 806EA250 */
...
/* 806E6F74 00000014  4B B7 FB C0 */	b __mi__4cXyzCFRC3Vec
...
/* 806E6F90 00000030  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806EA1F8 */
/* 806E6F94 00000034  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 806E6F98 00000038  38 61 00 20 */	addi r3, r1, 0x20
/* 806E6F9C 0000003C  4B C6 01 9C */	b PSVECSquareMag
/* 806E6FA0 00000040  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806EA1F8 */
...
/* 806E6FB0 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 806EA204 */
/* 806E6FB4 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 806E6FB8 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 806EA20C */
...
lbl_806E7000:
/* 806E7000 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 806EA214 */
/* 806E7004 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806E7008 00000000  40 80 00 10 */	bge lbl_806E7018
/* 806E700C 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E7010 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806E707C 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E7080 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806E7084:
/* 806E7084 00000000  C0 5F 00 64 */	lfs f2, 0x64(r31)	/* effective address: 806EA258 */
...
/* 806E709C 00000008  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 806EA254 */
...
/* 806E70AC 00000018  4B A7 83 78 */	b checkNowWolfEyeUp__9daPy_py_cFv
...
/* 806E70C8 00000034  3C 60 80 6F */	lis r3, l_HIO@ha
/* 806E70CC 00000038  38 63 A4 F8 */	addi r3, r3, l_HIO@l
/* 806E70D0 0000003C  A8 03 00 10 */	lha r0, 0x10(r3)	/* effective address: 806EA508 */
/* 806E70D4 00000040  7C 04 00 00 */	cmpw r4, r0
/* 806E70D8 00000044  40 80 00 10 */	bge lbl_806E70E8
/* 806E70DC 00000048  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806EA1F8 */
...
/* 806E7100 00000004  4B B8 00 28 */	b atan2sX_Z__4cXyzCFv
/* 806E7104 00000008  B0 7E 04 DE */	sth r3, 0x4de(r30)
/* 806E7108 0000000C  38 61 00 20 */	addi r3, r1, 0x20
/* 806E710C 00000010  4B C6 00 2C */	b PSVECSquareMag
/* 806E7110 00000014  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806EA1F8 */
...
/* 806E7120 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 806EA204 */
/* 806E7124 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 806E7128 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 806EA20C */
...
lbl_806E7170:
/* 806E7170 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 806EA214 */
/* 806E7174 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806E7178 00000000  40 80 00 10 */	bge lbl_806E7188
/* 806E717C 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E7180 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806E71EC 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E71F0 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806E71F4:
/* 806E71F4 00000000  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 806EA250 */

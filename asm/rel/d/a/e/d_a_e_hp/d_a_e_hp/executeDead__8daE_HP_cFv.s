...
/* 806E7EA4  4B C7 A3 38 */	b _savegpr_29
...
/* 806E7F54  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E7F58  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E7F5C  88 1F 04 BA */	lbz r0, 0x4ba(r31)
/* 806E7F60  7C 05 07 74 */	extsb r5, r0
/* 806E7F64  4B 94 D2 9C */	b onSwitch__10dSv_info_cFii
lbl_806E7F68:
/* 806E7F68  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E7F6C  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 806E7F70  88 64 01 0C */	lbz r3, 0x10c(r4)	/* effective address: 804062CC */
...
/* 806E7F98  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E7F9C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E7FA0  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 806E7FA4  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 806E7FA8  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 806E7FAC  A0 84 03 92 */	lhz r4, 0x392(r4)	/* effective address: 803A761A */
/* 806E7FB0  4B 94 C9 DC */	b onEventBit__11dSv_event_cFUs
lbl_806E7FB4:
/* 806E7FB4  80 7F 07 14 */	lwz r3, 0x714(r31)
/* 806E7FB8  38 03 00 01 */	addi r0, r3, 1
/* 806E7FBC  90 1F 07 14 */	stw r0, 0x714(r31)
lbl_806E7FC0:
/* 806E7FC0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E7FC4  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 806E7FC8  88 1E 4F AD */	lbz r0, 0x4fad(r30)	/* effective address: 8040B16D */
...
/* 806E7FEC  4B 95 FA 8C */	b endCheck__16dEvent_manager_cFs
/* 806E7FF0  2C 03 00 00 */	cmpwi r3, 0
/* 806E7FF4  41 82 00 10 */	beq lbl_806E8004
/* 806E7FF8  38 7E 4E C8 */	addi r3, r30, 0x4ec8
/* 806E7FFC  4B 95 A4 6C */	b reset__14dEvt_control_cFv
/* 806E8000  48 00 01 34 */	b lbl_806E8134
lbl_806E8004:
/* 806E8004  7F A3 EB 78 */	mr r3, r29
/* 806E8008  4B 96 03 E0 */	b getRunEventName__16dEvent_manager_cFv
/* 806E800C  3C 80 80 6F */	lis r4, stringBase0@ha
/* 806E8010  38 84 A2 CC */	addi r4, r4, stringBase0@l
/* 806E8014  38 84 00 05 */	addi r4, r4, 5
/* 806E8018  4B C8 09 7C */	b strcmp
...
/* 806E8040  4B 95 B6 4C */	b setPtT__14dEvt_control_cFPv
/* 806E8044  7F A3 EB 78 */	mr r3, r29
/* 806E8048  80 9F 07 84 */	lwz r4, 0x784(r31)
/* 806E804C  4B 95 B6 A0 */	b setPtI_Id__14dEvt_control_cFUi
...
/* 806E8084  4B 93 4A 54 */	b fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 806E8088  7F E3 FB 78 */	mr r3, r31
/* 806E808C  4B 93 1B F0 */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 806E80C0  4B 93 3B 28 */	b fopAcM_createItemForPresentDemo__FPC4cXyziUciiPC5csXyzPC4cXyz
/* 806E80C4  90 7F 07 84 */	stw r3, 0x784(r31)
lbl_806E80C8:
/* 806E80C8  80 7F 07 84 */	lwz r3, 0x784(r31)
/* 806E80CC  4B 93 92 D0 */	b fpcEx_IsExist__FUi
/* 806E80D0  2C 03 00 00 */	cmpwi r3, 0
/* 806E80D4  41 82 00 60 */	beq lbl_806E8134
/* 806E80D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E80DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E80E0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806E80E4  A0 03 00 FA */	lhz r0, 0xfa(r3)	/* effective address: 804062BA */
...
/* 806E80FC  3C A0 80 6F */	lis r5, stringBase0@ha
/* 806E8100  38 A5 A2 CC */	addi r5, r5, stringBase0@l
/* 806E8104  38 A5 00 05 */	addi r5, r5, 5
/* 806E8108  38 C0 00 FF */	li r6, 0xff
/* 806E810C  4B 95 F6 4C */	b getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc
...
/* 806E8130  4B 93 35 4C */	b fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs
lbl_806E8134:
/* 806E8134  39 61 00 20 */	addi r11, r1, 0x20
/* 806E8138  4B C7 A0 F0 */	b _restgpr_29

...
/* 806E6C8C  3C 80 80 6F */	lis r4, lit_3905@ha
/* 806E6C90  3B E4 A1 F4 */	addi r31, r4, lit_3905@l
...
/* 806E6D10  4B B7 FE 24 */	b __mi__4cXyzCFRC3Vec
...
/* 806E6D30  4B C6 04 08 */	b PSVECSquareMag
...
/* 806E6DA0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E6DA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806E6E10  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E6E14  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806E6E18:
...
/* 806E6E4C  4B A7 85 D8 */	b checkNowWolfEyeUp__9daPy_py_cFv
...
/* 806E6E68  3C 60 80 6F */	lis r3, l_HIO@ha
/* 806E6E6C  38 63 A4 F8 */	addi r3, r3, l_HIO@l
/* 806E6E70  A8 03 00 10 */	lha r0, 0x10(r3)	/* effective address: 806EA508 */
...
/* 806E6E9C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806E6EA0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 806E6EA4  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 806E6EA8  4B 93 38 68 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806E6EBC  4B B8 97 4C */	b cLib_addCalcAngleS2__FPssss

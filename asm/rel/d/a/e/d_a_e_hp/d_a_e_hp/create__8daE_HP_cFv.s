...
/* 806E952C  4B C7 8C AC */	b _savegpr_28
/* 806E9530  7C 7C 1B 78 */	mr r28, r3
/* 806E9534  3C 80 80 6F */	lis r4, cNullVec__6Z2Calc@ha
/* 806E9538  3B C4 A2 E8 */	addi r30, r4, cNullVec__6Z2Calc@l
/* 806E953C  3C 80 80 6F */	lis r4, lit_3905@ha
/* 806E9540  3B E4 A1 F4 */	addi r31, r4, lit_3905@l
...
/* 806E956C  3C 80 80 6F */	lis r4, stringBase0@ha
/* 806E9570  38 84 A2 CC */	addi r4, r4, stringBase0@l
/* 806E9574  4B 94 39 48 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806E95E0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E95E4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E95E8  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 806E95EC  7C 05 07 74 */	extsb r5, r0
/* 806E95F0  4B 94 BD 70 */	b isSwitch__10dSv_info_cCFii
...
/* 806E9610  3C 80 80 6F */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 806E9614  38 84 94 FC */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 806E9618  38 A0 3B 30 */	li r5, 0x3b30
/* 806E961C  4B 93 0E 94 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_806E9630:
/* 806E9630  3C 60 80 6F */	lis r3, data_806EA4E8@ha
/* 806E9634  8C 03 A4 E8 */	lbzu r0, data_806EA4E8@l(r3)
...
/* 806E9650  3C 60 80 6F */	lis r3, l_HIO@ha
/* 806E9654  38 63 A4 F8 */	addi r3, r3, l_HIO@l
/* 806E9658  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 806EA4FC */
lbl_806E965C:
...
/* 806E96B8  4B 93 0E 70 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 806E96CC  4B 93 0E 6C */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806E96F8  4B 98 CB 50 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 806E9714  4B 98 C8 44 */	b SetWall__12dBgS_AcchCirFff
...
/* 806E9728  4B 99 A1 38 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 806E9778  4B 99 B2 BC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806E978C  4B 99 B1 28 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 806E97A0  4B 99 B1 14 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 806E97C0  4B BD 78 D4 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 806E97D8  4B BD 78 BC */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806E97DC  88 9C 07 7C */	lbz r4, 0x77c(r28)
/* 806E97E0  28 04 00 FF */	cmplwi r4, 0xff
/* 806E97E4  41 82 00 20 */	beq lbl_806E9804
/* 806E97E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E97EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E97F0  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 806E97F4  7C 05 07 74 */	extsb r5, r0
/* 806E97F8  4B 94 BB 68 */	b isSwitch__10dSv_info_cCFii
...
/* 806E9810  4B AB 62 A8 */	b dKy_daynight_check__Fv
...
/* 806E982C  4B BD 83 64 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 806E9840  3C 80 80 6F */	lis r4, stringBase0@ha
/* 806E9844  38 84 A2 CC */	addi r4, r4, stringBase0@l
/* 806E9848  38 84 00 15 */	addi r4, r4, 0x15
/* 806E984C  4B BD 83 44 */	b setEnemyName__15Z2CreatureEnemyFPCc
lbl_806E9850:
...
/* 806E9888  4B AB 62 30 */	b dKy_daynight_check__Fv
...
/* 806E98EC  4B C7 89 38 */	b _restgpr_28

...
/* 806E89D0  4B C7 98 08 */	b _savegpr_28
/* 806E89D4  7C 7E 1B 78 */	mr r30, r3
/* 806E89D8  3C 60 80 6F */	lis r3, lit_3905@ha
/* 806E89DC  3B E3 A1 F4 */	addi r31, r3, lit_3905@l
/* 806E89E0  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806E89E4  83 83 00 04 */	lwz r28, 4(r3)
/* 806E89E8  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 806E89EC  4B 92 43 78 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 806E89F0  C0 3F 00 04 */	lfs f1, 4(r31)
/* 806E89F4  C0 5E 07 68 */	lfs f2, 0x768(r30)
/* 806E89F8  FC 60 08 90 */	fmr f3, f1
/* 806E89FC  4B 92 43 A0 */	b transM__14mDoMtx_stack_cFfff
/* 806E8A00  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 806E8A04  4B 92 45 40 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806E8A08  38 7E 07 72 */	addi r3, r30, 0x772
/* 806E8A0C  4B 92 45 38 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806E8A10  3C 60 80 6F */	lis r3, l_HIO@ha
/* 806E8A14  3B A3 A4 F8 */	addi r29, r3, l_HIO@l
/* 806E8A18  C0 3D 00 08 */	lfs f1, 8(r29)	/* effective address: 806EA500 */
/* 806E8A1C  FC 40 08 90 */	fmr f2, f1
/* 806E8A20  FC 60 08 90 */	fmr f3, f1
/* 806E8A24  4B 92 44 14 */	b scaleM__14mDoMtx_stack_cFfff
/* 806E8A28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E8A2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E8A30  38 9C 00 24 */	addi r4, r28, 0x24
/* 806E8A34  4B C5 DA 7C */	b PSMTXCopy
/* 806E8A38  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806E8A3C  4B 92 87 B0 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 806E8A64  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806E8A68  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806E8A6C  4B C5 DA 44 */	b PSMTXCopy
...
/* 806E8A84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E8A88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E8A8C  38 81 00 30 */	addi r4, r1, 0x30
/* 806E8A90  38 BE 07 44 */	addi r5, r30, 0x744
/* 806E8A94  4B C5 E2 D8 */	b PSMTXMultVec
/* 806E8A98  38 7E 07 44 */	addi r3, r30, 0x744
/* 806E8A9C  4B 92 42 C8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 806E8AA0  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 806E8AA4  4B 92 44 A0 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806E8AA8  C0 3D 00 08 */	lfs f1, 8(r29)
/* 806E8AAC  FC 40 08 90 */	fmr f2, f1
/* 806E8AB0  FC 60 08 90 */	fmr f3, f1
/* 806E8AB4  4B 92 43 84 */	b scaleM__14mDoMtx_stack_cFfff
/* 806E8AB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E8ABC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E8AC0  80 9E 05 C0 */	lwz r4, 0x5c0(r30)
/* 806E8AC4  38 84 00 24 */	addi r4, r4, 0x24
/* 806E8AC8  4B C5 D9 E8 */	b PSMTXCopy
...
/* 806E8AEC  4B B7 E0 48 */	b __mi__4cXyzCFRC3Vec
...
/* 806E8B0C  4B C5 E6 2C */	b PSVECSquareMag
...
/* 806E8B7C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E8B80  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806E8BEC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E8BF0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806E8BF4:
...
/* 806E8C20  4B B8 6E 1C */	b cLib_addCalc2__FPffff
...
/* 806E8C5C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806E8C60  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 806E8C88  4B B8 79 80 */	b cLib_addCalcAngleS2__FPssss
...
/* 806E8CC4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806E8CC8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 806E8D14  4B A7 67 10 */	b checkNowWolfEyeUp__9daPy_py_cFv
/* 806E8D18  2C 03 00 00 */	cmpwi r3, 0
/* 806E8D1C  41 82 00 AC */	beq lbl_806E8DC8
/* 806E8D20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E8D24  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 806E8D28  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 806E8D74  4B 96 47 58 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806E8D88  4B 96 2B 90 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806E8DB4  4B B9 7A 54 */	b func_80280808
...
/* 806E8DCC  4B C7 94 58 */	b _restgpr_28

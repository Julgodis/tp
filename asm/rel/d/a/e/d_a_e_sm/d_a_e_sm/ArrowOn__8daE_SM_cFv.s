...
/* 80796B1C 0000000C  4B FF B6 7D */	bl _savegpr_25
/* 80796B20 00000010  7C 7D 1B 78 */	mr r29, r3
/* 80796B24 00000014  3C 60 00 00 */	lis r3, lit_3920@ha /* 807985E0 */
/* 80796B28 00000018  3B E3 00 00 */	addi r31, r3, lit_3920@l /* 807985E0 */
...
/* 80796B70 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796B74 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80796B84 00000024  4B FF B6 15 */	bl PSMTXTrans
/* 80796B88 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796B8C 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796B90 00000030  A8 9D 09 B2 */	lha r4, 0x9b2(r29)
/* 80796B94 00000034  4B FF B6 05 */	bl mDoMtx_YrotM__FPA4_fs
...
/* 80796BAC 0000004C  4B FF B5 ED */	bl scaleM__14mDoMtx_stack_cFfff
/* 80796BB0 00000050  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796BB4 00000054  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80796BE4 00000084  4B FF B5 B5 */	bl transM__14mDoMtx_stack_cFfff
/* 80796BE8 00000088  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796BEC 0000008C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796BF0 00000090  A8 9D 09 B4 */	lha r4, 0x9b4(r29)
/* 80796BF4 00000094  4B FF B5 A5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80796BF8 00000098  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796BFC 0000009C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796C00 000000A0  A8 9D 09 B4 */	lha r4, 0x9b4(r29)
/* 80796C04 000000A4  4B FF B5 95 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80796C1C 000000BC  4B FF B5 7D */	bl scaleM__14mDoMtx_stack_cFfff
/* 80796C20 000000C0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796C24 000000C4  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80796C34 000000D4  4B FF B5 65 */	bl mDoMtx_XrotM__FPA4_fs
/* 80796C38 000000D8  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796C3C 000000DC  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80796C4C 000000EC  4B FF B5 4D */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80796C5C 000000FC  4B FF B5 3D */	bl transM__14mDoMtx_stack_cFfff
...
/* 80796C6C 0000010C  4B FF B5 2D */	bl transM__14mDoMtx_stack_cFfff
/* 80796C70 00000110  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796C74 00000114  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796C78 00000118  7F 5D DA 14 */	add r26, r29, r27
/* 80796C7C 0000011C  A8 9A 08 0A */	lha r4, 0x80a(r26)
/* 80796C80 00000120  4B FF B5 19 */	bl mDoMtx_YrotM__FPA4_fs
/* 80796C84 00000124  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796C88 00000128  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796C8C 0000012C  A8 9A 08 08 */	lha r4, 0x808(r26)
/* 80796C90 00000130  4B FF B5 09 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80796CA4 00000144  4B FF B4 F5 */	bl transM__14mDoMtx_stack_cFfff
/* 80796CA8 00000148  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796CAC 0000014C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796CB0 00000150  A8 9A 08 BE */	lha r4, 0x8be(r26)
/* 80796CB4 00000154  4B FF B4 E5 */	bl mDoMtx_YrotM__FPA4_fs
/* 80796CB8 00000158  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796CBC 0000015C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796CC0 00000160  A8 9A 08 BC */	lha r4, 0x8bc(r26)
/* 80796CC4 00000164  4B FF B4 D5 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 80796CD8 00000178  4B FF B4 C1 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80796D20 000001C0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80796D24 000001C4  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80796D28 000001C8  80 84 05 68 */	lwz r4, 0x568(r4)
/* 80796D2C 000001CC  38 84 00 24 */	addi r4, r4, 0x24
/* 80796D30 000001D0  4B FF B4 69 */	bl PSMTXCopy
lbl_80796D34:
...
/* 80796D6C 00000008  4B FF B4 2D */	bl _restgpr_25

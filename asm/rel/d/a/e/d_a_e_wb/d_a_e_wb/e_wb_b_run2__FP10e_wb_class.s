...
/* 807D566C  4B B8 CB 58 */	b _savegpr_23
/* 807D5670  7C 7A 1B 78 */	mr r26, r3
/* 807D5674  3C 80 80 7E */	lis r4, lit_3882@ha
/* 807D5678  3B C4 29 8C */	addi r30, r4, lit_3882@l
/* 807D567C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807D5680  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807D5684  83 04 5D AC */	lwz r24, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 807D5688  7F 04 C3 78 */	mr r4, r24
/* 807D568C  4B 84 52 D8 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807D5718  4B B5 2D 14 */	b checkPass__12J3DFrameCtrlFf
...
/* 807D5748  4B B5 2C E4 */	b checkPass__12J3DFrameCtrlFf
...
/* 807D57BC  3C 60 80 7E */	lis r3, b_path2@ha
/* 807D57C0  3B E3 36 9C */	addi r31, r3, b_path2@l
...
/* 807D57D8  4B A9 13 5C */	b __mi__4cXyzCFRC3Vec
...
/* 807D5800  4B A9 13 34 */	b __mi__4cXyzCFRC3Vec
...
/* 807D5820  4B B7 19 18 */	b PSVECSquareMag
...
/* 807D588C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D5890  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)
...
/* 807D58FC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D5900  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)
/* 807D5904  48 00 00 08 */	b lbl_807D590C
lbl_807D5908:
/* 807D5908  FF A0 08 90 */	fmr f29, f1
lbl_807D590C:
/* 807D590C  38 61 00 54 */	addi r3, r1, 0x54
/* 807D5910  4B B7 18 28 */	b PSVECSquareMag
...
/* 807D597C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D5980  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807D59EC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D59F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807D59F4:
...
/* 807D5A18  4B A9 1F 3C */	b cM_rndF__Ff
...
/* 807D5A4C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807D5A50  3B E3 07 68 */	addi r31, r3, calc_mtx@l
/* 807D5A54  C3 7E 01 24 */	lfs f27, 0x124(r30)
/* 807D5A58  3C 60 80 7E */	lis r3, b_path2@ha
/* 807D5A5C  3B 23 36 9C */	addi r25, r3, b_path2@l
lbl_807D5A60:
/* 807D5A60  80 7F 00 00 */	lwz r3, 0(r31)	/* effective address: 80450768 */
/* 807D5A64  7F 84 07 34 */	extsh r4, r28
/* 807D5A68  4B 83 69 74 */	b mDoMtx_YrotS__FPA4_fs
/* 807D5A6C  D3 61 00 80 */	stfs f27, 0x80(r1)
/* 807D5A70  38 61 00 78 */	addi r3, r1, 0x78
/* 807D5A74  38 81 00 6C */	addi r4, r1, 0x6c
/* 807D5A78  4B A9 B4 74 */	b MtxPosition__FP4cXyzP4cXyz
/* 807D5A7C  38 61 00 6C */	addi r3, r1, 0x6c
/* 807D5A80  38 98 04 D0 */	addi r4, r24, 0x4d0
/* 807D5A84  7C 65 1B 78 */	mr r5, r3
/* 807D5A88  4B B7 16 08 */	b PSVECAdd
...
/* 807D5AC8  3C 80 80 7E */	lis r4, b_path2@ha
/* 807D5ACC  38 04 36 9C */	addi r0, r4, b_path2@l
/* 807D5AD0  7C 80 2A 14 */	add r4, r0, r5
/* 807D5AD4  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 807D5AD8  4B A9 10 5C */	b __mi__4cXyzCFRC3Vec
...
/* 807D5B00  4B B7 16 38 */	b PSVECSquareMag
...
/* 807D5B70  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D5B74  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807D5BE0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D5BE4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807D5BE8:
...
/* 807D5C08  3C 80 80 7E */	lis r4, b_path2@ha
/* 807D5C0C  38 04 36 9C */	addi r0, r4, b_path2@l
/* 807D5C10  7C 80 2A 14 */	add r4, r0, r5
/* 807D5C14  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 807D5C18  4B A9 0F 1C */	b __mi__4cXyzCFRC3Vec
...
/* 807D5C34  4B A9 1A 40 */	b cM_atan2s__Fff
...
/* 807D5C90  3C 80 80 7E */	lis r4, b_path2@ha
/* 807D5C94  38 04 36 9C */	addi r0, r4, b_path2@l
/* 807D5C98  7C 80 2A 14 */	add r4, r0, r5
/* 807D5C9C  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 807D5CA0  4B A9 0E 94 */	b __mi__4cXyzCFRC3Vec
...
/* 807D5CBC  4B A9 19 B8 */	b cM_atan2s__Fff
...
/* 807D5CD4  4B A9 A9 34 */	b cLib_addCalcAngleS2__FPssss
...
/* 807D5CE8  4B A9 A9 20 */	b cLib_addCalcAngleS2__FPssss
/* 807D5CEC  C3 7E 00 D8 */	lfs f27, 0xd8(r30)
/* 807D5CF0  3C 60 80 7E */	lis r3, l_HIO@ha
/* 807D5CF4  38 63 35 C8 */	addi r3, r3, l_HIO@l
/* 807D5CF8  C3 83 00 2C */	lfs f28, 0x2c(r3)	/* effective address: 807E35F4 */
...
/* 807D5D8C  4B A9 9C B0 */	b cLib_addCalc2__FPffff
...
/* 807D5DB0  4B A9 A8 58 */	b cLib_addCalcAngleS2__FPssss
...
/* 807D5DD0  4B A9 9C 6C */	b cLib_addCalc2__FPffff
...
/* 807D5EA8  4B B8 C3 68 */	b _restgpr_23

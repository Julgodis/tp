...
/* 807D6C44 00000018  3C 60 00 00 */	lis r3, lit_1109@ha /* 807E3578 */
/* 807D6C48 0000001C  3B E3 00 00 */	addi r31, r3, lit_1109@l /* 807E3578 */
/* 807D6C4C 00000020  3C 60 00 00 */	lis r3, lit_3882@ha /* 807E298C */
/* 807D6C50 00000024  38 63 00 00 */	addi r3, r3, lit_3882@l /* 807E298C */
/* 807D6C54 00000028  88 1F 01 90 */	lbz r0, 0x190(r31)
/* 807D6C58 0000002C  7C 00 07 75 */	extsb. r0, r0
/* 807D6C5C 00000030  40 82 00 44 */	bne lbl_807D6CA0
/* 807D6C60 00000034  C0 43 01 50 */	lfs f2, 0x150(r3)
/* 807D6C64 00000038  D0 41 00 08 */	stfs f2, 8(r1)
/* 807D6C68 0000003C  C0 23 01 54 */	lfs f1, 0x154(r3)
/* 807D6C6C 00000040  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 807D6C70 00000044  C0 03 01 58 */	lfs f0, 0x158(r3)
/* 807D6C74 00000048  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 807D6C78 0000004C  D0 5F 01 94 */	stfs f2, 0x194(r31)
/* 807D6C7C 00000050  38 7F 01 94 */	addi r3, r31, 0x194
/* 807D6C80 00000054  D0 23 00 04 */	stfs f1, 4(r3)
/* 807D6C84 00000058  D0 03 00 08 */	stfs f0, 8(r3)
/* 807D6C88 0000005C  3C 80 00 00 */	lis r4, __dt__4cXyzFv@ha /* 807D2B48 */
/* 807D6C8C 00000060  38 84 00 00 */	addi r4, r4, __dt__4cXyzFv@l /* 807D2B48 */
...
/* 807D6C9C 00000070  98 1F 01 90 */	stb r0, 0x190(r31)
lbl_807D6CA0:
...
/* 807D6CC4 00000024  4B FF B7 35 */	bl fopAcM_create__FsUlPC4cXyziPC5csXyzPC4cXyzSc

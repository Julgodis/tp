...
/* 807D2F28  4B B8 F2 A0 */	b _savegpr_24
/* 807D2F2C  7C 7B 1B 78 */	mr r27, r3
/* 807D2F30  3C 60 80 7E */	lis r3, lit_3882@ha
/* 807D2F34  3B C3 29 8C */	addi r30, r3, lit_3882@l
...
/* 807D2F64  3C 60 80 43 */	lis r3, g_env_light@ha
/* 807D2F68  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 807D2F6C  38 80 00 00 */	li r4, 0
/* 807D2F70  38 BB 04 D0 */	addi r5, r27, 0x4d0
/* 807D2F74  38 DB 01 0C */	addi r6, r27, 0x10c
/* 807D2F78  4B 9D 08 4C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 807D2F7C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 807D2F80  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 807D2F84  80 99 00 04 */	lwz r4, 4(r25)
/* 807D2F88  38 BB 01 0C */	addi r5, r27, 0x10c
/* 807D2F8C  4B 9D 1E 14 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 807D2F90  80 7B 05 E0 */	lwz r3, 0x5e0(r27)
/* 807D2F94  4B 83 E2 2C */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 807D300C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 807D3010  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 807D3014  4B 85 B8 FC */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 807D3018  90 7B 06 94 */	stw r3, 0x694(r27)
/* 807D301C  3C 60 80 7E */	lis r3, l_HIO@ha
/* 807D3020  38 63 35 C8 */	addi r3, r3, l_HIO@l
/* 807D3024  88 03 00 59 */	lbz r0, 0x59(r3)	/* effective address: 807E3621 */
...
/* 807D3048  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807D304C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807D3050  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807D3054  4B B7 34 5C */	b PSMTXCopy
/* 807D3058  4B A9 DE C4 */	b MtxPush__Fv
/* 807D305C  3B 80 00 00 */	li r28, 0
/* 807D3060  80 1B 14 34 */	lwz r0, 0x1434(r27)
/* 807D3064  90 01 00 0C */	stw r0, 0xc(r1)
/* 807D3068  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 807D306C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 807D3070  38 81 00 0C */	addi r4, r1, 0xc
/* 807D3074  4B 84 67 84 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
lbl_807D30B8:
/* 807D30B8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807D30BC  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
/* 807D30C0  83 1A 5D B4 */	lwz r24, 0x5db4(r26)	/* effective address: 8040BF74 */
...
/* 807D3100  4B 91 A0 F0 */	b checkHorseNotGrab__9daAlink_cCFv
...
/* 807D3148  4B A9 DD A4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807D3170  4B A9 DD E8 */	b MtxPull__Fv
/* 807D3174  38 61 00 40 */	addi r3, r1, 0x40
/* 807D3178  38 81 00 34 */	addi r4, r1, 0x34
/* 807D317C  4B A9 DD 70 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807D319C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807D31A0  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
/* 807D31A4  83 19 5D B4 */	lwz r24, 0x5db4(r25)	/* effective address: 8040BF74 */
...
/* 807D31EC  4B 91 9E E8 */	b getHorseReinHandPos__9daAlink_cFP4cXyzP4cXyz
...
/* 807D3254  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807D3258  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807D325C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807D3260  4B B7 32 50 */	b PSMTXCopy
...
/* 807D3280  4B A9 DC 6C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807D3294  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807D3298  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807D329C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807D32A0  4B B7 32 10 */	b PSMTXCopy
...
/* 807D32C0  4B A9 DC 2C */	b MtxPosition__FP4cXyzP4cXyz
lbl_807D32C4:
...
/* 807D3314  4B A9 C7 28 */	b cLib_addCalc2__FPffff
...
/* 807D3328  4B A9 C7 14 */	b cLib_addCalc2__FPffff
...
/* 807D333C  4B A9 C7 00 */	b cLib_addCalc2__FPffff
...
/* 807D3350  4B A9 C6 EC */	b cLib_addCalc2__FPffff
...
/* 807D3364  4B A9 C6 D8 */	b cLib_addCalc2__FPffff
...
/* 807D3378  4B A9 C6 C4 */	b cLib_addCalc2__FPffff
...
/* 807D33BC  4B B7 3D 7C */	b PSVECSquareMag
...
/* 807D342C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D3430  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807D349C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807D34A0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807D34A4:
...
/* 807D3504  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807D3508  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807D350C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807D3510  4B B7 2F A0 */	b PSMTXCopy
...
/* 807D3534  4B A9 D9 B8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807D3580  3C A0 80 7E */	lis r5, data_807E2F78@ha
/* 807D3584  38 A5 2F 78 */	addi r5, r5, data_807E2F78@l
/* 807D3588  38 DB 01 0C */	addi r6, r27, 0x10c
/* 807D358C  4B 84 0A 24 */	b update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 807D35A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807D35AC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 807D35C4  4B 84 11 74 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 807D35C8  38 7B 16 0C */	addi r3, r27, 0x160c
/* 807D35CC  38 80 00 10 */	li r4, 0x10
/* 807D35D0  3C A0 80 7E */	lis r5, data_807E2F78@ha
/* 807D35D4  38 A5 2F 78 */	addi r5, r5, data_807E2F78@l
/* 807D35D8  38 DB 01 0C */	addi r6, r27, 0x10c
/* 807D35DC  4B 84 09 D4 */	b update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 807D3608  4B 84 11 30 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
/* 807D360C  38 7B 16 48 */	addi r3, r27, 0x1648
/* 807D3610  38 80 00 02 */	li r4, 2
/* 807D3614  3C A0 80 7E */	lis r5, data_807E2F78@ha
/* 807D3618  38 A5 2F 78 */	addi r5, r5, data_807E2F78@l
/* 807D361C  38 DB 01 0C */	addi r6, r27, 0x10c
/* 807D3620  4B 84 09 90 */	b update__19mDoExt_3DlineMat1_cFiR8_GXColorP12dKy_tevstr_c
...
/* 807D364C  4B 84 10 EC */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_807D3650:
/* 807D3650  38 60 00 01 */	li r3, 1
lbl_807D3654:
/* 807D3654  39 61 00 70 */	addi r11, r1, 0x70
/* 807D3658  4B B8 EB BC */	b _restgpr_24

...
/* 807D2BB4 00000004  4B B8 F6 10 */	b _savegpr_23
/* 807D2BB8 00000008  7C 7E 1B 78 */	mr r30, r3
/* 807D2BBC 0000000C  7C BF 2B 78 */	mr r31, r5
/* 807D2BC0 00000010  3C 60 80 7E */	lis r3, lit_3882@ha
/* 807D2BC4 00000014  38 63 29 8C */	addi r3, r3, lit_3882@l
...
/* 807D2BEC 0000003C  C0 03 00 48 */	lfs f0, 0x48(r3)	/* effective address: 807E29D4 */
...
/* 807D2C00 00000050  C0 03 00 5C */	lfs f0, 0x5c(r3)	/* effective address: 807E29E8 */
/* 807D2C04 00000054  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 807D2C08 00000058  48 00 00 0C */	b lbl_807D2C14
lbl_807D2C0C:
/* 807D2C0C 00000000  C0 03 00 50 */	lfs f0, 0x50(r3)	/* effective address: 807E29DC */
...
/* 807D2C1C 00000008  C3 E3 00 48 */	lfs f31, 0x48(r3)	/* effective address: 807E29D4 */
/* 807D2C20 0000000C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807D2C24 00000010  3B A3 07 68 */	addi r29, r3, calc_mtx@l
lbl_807D2C28:
...
/* 807D2C54 0000002C  4B A9 4A 20 */	b cM_atan2s__Fff
...
/* 807D2C7C 00000004  4B A9 49 F8 */	b cM_atan2s__Fff
/* 807D2C80 00000008  7C 03 00 D0 */	neg r0, r3
/* 807D2C84 0000000C  7C 1A 07 34 */	extsh r26, r0
/* 807D2C88 00000010  80 7D 00 00 */	lwz r3, 0(r29)	/* effective address: 80450768 */
/* 807D2C8C 00000014  7F 24 CB 78 */	mr r4, r25
/* 807D2C90 00000018  4B 83 97 4C */	b mDoMtx_YrotS__FPA4_fs
/* 807D2C94 0000001C  80 7D 00 00 */	lwz r3, 0(r29)	/* effective address: 80450768 */
/* 807D2C98 00000020  7F 44 D3 78 */	mr r4, r26
/* 807D2C9C 00000024  4B 83 97 00 */	b mDoMtx_XrotM__FPA4_fs
/* 807D2CA0 00000028  38 61 00 14 */	addi r3, r1, 0x14
/* 807D2CA4 0000002C  38 81 00 08 */	addi r4, r1, 8
/* 807D2CA8 00000030  4B A9 E2 44 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807D2D7C 00000008  4B B8 F4 94 */	b _restgpr_23

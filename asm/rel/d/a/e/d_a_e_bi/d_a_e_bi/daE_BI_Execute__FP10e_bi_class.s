...
/* 8068C3E0  4B CD 5D F8 */	b _savegpr_28
/* 8068C3E4  7C 7F 1B 78 */	mr r31, r3
/* 8068C3E8  3C 80 80 69 */	lis r4, lit_3903@ha
/* 8068C3EC  3B C4 D7 EC */	addi r30, r4, lit_3903@l
...
/* 8068C440  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8068C444  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8068C448  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8068C44C  4B 9E A6 60 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8068C4D8  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8068C4DC  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8068C4E0  38 81 00 08 */	addi r4, r1, 8
/* 8068C4E4  4B 98 D3 14 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 8068C4E8  7C 7D 1B 79 */	or. r29, r3, r3
/* 8068C4EC  41 82 01 9C */	beq lbl_8068C688
/* 8068C4F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C4F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8068C514  4B CB A3 D4 */	b PSMTXTrans
/* 8068C518  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C51C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C520  A8 9D 05 A0 */	lha r4, 0x5a0(r29)
/* 8068C524  4B 97 FF 10 */	b mDoMtx_YrotM__FPA4_fs
/* 8068C528  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C52C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C530  A8 9D 05 A2 */	lha r4, 0x5a2(r29)
/* 8068C534  4B 97 FE 68 */	b mDoMtx_XrotM__FPA4_fs
/* 8068C538  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C53C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C540  A8 1D 05 A0 */	lha r0, 0x5a0(r29)
/* 8068C544  7C 00 00 D0 */	neg r0, r0
/* 8068C548  7C 04 07 34 */	extsh r4, r0
/* 8068C54C  4B 97 FE E8 */	b mDoMtx_YrotM__FPA4_fs
/* 8068C550  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C554  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C558  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8068C55C  4B 97 FE D8 */	b mDoMtx_YrotM__FPA4_fs
/* 8068C560  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C564  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 8068C578  4B 97 FE 24 */	b mDoMtx_XrotM__FPA4_fs
/* 8068C57C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C580  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C584  A8 9D 04 E8 */	lha r4, 0x4e8(r29)
/* 8068C588  4B 97 FF 44 */	b mDoMtx_ZrotM__FPA4_fs
/* 8068C58C  C0 3F 0B B0 */	lfs f1, 0xbb0(r31)
/* 8068C590  C0 5F 0B B4 */	lfs f2, 0xbb4(r31)
/* 8068C594  C0 7F 0B B8 */	lfs f3, 0xbb8(r31)
/* 8068C598  4B 98 08 04 */	b transM__14mDoMtx_stack_cFfff
...
/* 8068C5AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C5B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C5B4  38 81 00 2C */	addi r4, r1, 0x2c
/* 8068C5B8  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8068C5BC  4B CB A7 B0 */	b PSMTXMultVec
...
lbl_8068C5DC:
/* 8068C5DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C5E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C5E4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8068C5E8  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8068C5EC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8068C5F0  4B CB A2 F8 */	b PSMTXTrans
...
/* 8068C60C  4B 98 07 90 */	b transM__14mDoMtx_stack_cFfff
/* 8068C610  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C614  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C618  A8 9F 06 A6 */	lha r4, 0x6a6(r31)
/* 8068C61C  4B 97 FE 18 */	b mDoMtx_YrotM__FPA4_fs
/* 8068C620  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C624  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C628  A8 9F 06 A2 */	lha r4, 0x6a2(r31)
/* 8068C62C  4B 97 FD 70 */	b mDoMtx_XrotM__FPA4_fs
/* 8068C630  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C634  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C638  A8 1F 06 A6 */	lha r0, 0x6a6(r31)
/* 8068C63C  7C 00 00 D0 */	neg r0, r0
/* 8068C640  7C 04 07 34 */	extsh r4, r0
/* 8068C644  4B 97 FD F0 */	b mDoMtx_YrotM__FPA4_fs
/* 8068C648  C0 3E 00 04 */	lfs f1, 4(r30)
/* 8068C64C  C0 5E 00 AC */	lfs f2, 0xac(r30)
/* 8068C650  FC 60 08 90 */	fmr f3, f1
/* 8068C654  4B 98 07 48 */	b transM__14mDoMtx_stack_cFfff
lbl_8068C658:
/* 8068C658  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C65C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C660  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8068C664  4B 97 FD D0 */	b mDoMtx_YrotM__FPA4_fs
/* 8068C668  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C66C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C670  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 8068C674  4B 97 FD 28 */	b mDoMtx_XrotM__FPA4_fs
/* 8068C678  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C67C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C680  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 8068C684  4B 97 FE 48 */	b mDoMtx_ZrotM__FPA4_fs
lbl_8068C688:
/* 8068C688  3C 60 80 69 */	lis r3, l_HIO@ha
/* 8068C68C  38 63 DB 2C */	addi r3, r3, l_HIO@l
/* 8068C690  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 8068DB34 */
...
/* 8068C6A4  4B 98 07 94 */	b scaleM__14mDoMtx_stack_cFfff
/* 8068C6A8  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 8068C6AC  83 A3 00 04 */	lwz r29, 4(r3)
/* 8068C6B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8068C6B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8068C6B8  38 9D 00 24 */	addi r4, r29, 0x24
/* 8068C6BC  4B CB 9D F4 */	b PSMTXCopy
/* 8068C6C0  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 8068C6C4  7C 03 07 74 */	extsb r3, r0
/* 8068C6C8  4B 9A 09 A4 */	b dComIfGp_getReverb__Fi
/* 8068C6CC  7C 65 1B 78 */	mr r5, r3
/* 8068C6D0  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 8068C6D4  38 80 00 00 */	li r4, 0
/* 8068C6D8  4B 98 49 D8 */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 8068C6F4  4B C9 BD 38 */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C70C  4B C9 BD 20 */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C764  4B C9 BC C8 */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C7B4  4B C9 BC 78 */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C7F8  4B C9 BC 34 */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C810  4B C9 BC 1C */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C860  4B C9 BB CC */	b checkPass__12J3DFrameCtrlFf
...
/* 8068C89C  4B 98 49 50 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 8068C8A0  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 8068C8A4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8068C8A8  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8068C8AC  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8068C8B0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8068C8B4  4B CB 9B FC */	b PSMTXCopy
...
/* 8068C8D4  4B BE 46 18 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8068C904  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8068C908  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8068C90C  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 8068C97C  4B BE 28 7C */	b SetH__8cM3dGCylFf
...
/* 8068C99C  4B BE 45 50 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8068C9C4  4B BE 28 34 */	b SetH__8cM3dGCylFf
lbl_8068C9C8:
/* 8068C9C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8068C9CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8068C9D0  3B 83 23 3C */	addi r28, r3, 0x233c
/* 8068C9D4  7F 83 E3 78 */	mr r3, r28
/* 8068C9D8  38 9F 06 F0 */	addi r4, r31, 0x6f0
/* 8068C9DC  4B BD 81 CC */	b Set__4cCcSFP8cCcD_Obj
...
/* 8068C9F8  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8068C9FC  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8068CA00  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8068CA04  4B CB 9A AC */	b PSMTXCopy
/* 8068CA08  38 61 00 2C */	addi r3, r1, 0x2c
/* 8068CA0C  38 81 00 20 */	addi r4, r1, 0x20
/* 8068CA10  4B BE 44 DC */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8068CA70  4B 98 D2 0C */	b fopAcM_delete__FP10fopAc_ac_c
lbl_8068CA74:
...
/* 8068CA84  4B CD 57 A0 */	b _restgpr_28

...
/* 8068C1F8 00000010  4B CD 5F DC */	b _savegpr_27
...
/* 8068C208 00000020  4B 9E B3 74 */	b __ct__11dBgS_GndChkFv
/* 8068C20C 00000024  3C 60 80 69 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 8068C210 00000028  38 63 DA 98 */	addi r3, r3, __vt__14dBgS_ObjGndChk@l
...
/* 8068C234 0000004C  4B 9E CC 34 */	b SetObj__16dBgS_PolyPassChkFv
/* 8068C238 00000050  C0 1C 04 D0 */	lfs f0, 0x4d0(r28)
/* 8068C23C 00000054  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8068C240 00000058  3C 60 80 69 */	lis r3, lit_4738@ha
/* 8068C244 0000005C  C0 23 D8 90 */	lfs f1, lit_4738@l(r3)
...
/* 8068C264 0000007C  4B BD BA A8 */	b SetPos__11cBgS_GndChkFPC3Vec
/* 8068C268 00000080  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8068C26C 00000084  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8068C270 00000088  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8068C274 0000008C  7F 64 DB 78 */	mr r4, r27
/* 8068C278 00000090  4B 9E 82 28 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8068C288 000000A0  3C 60 80 69 */	lis r3, s_fw_sub__FPvPv@ha
/* 8068C28C 000000A4  38 63 C0 68 */	addi r3, r3, s_fw_sub__FPvPv@l
/* 8068C290 000000A8  7F 84 E3 78 */	mr r4, r28
/* 8068C294 000000AC  4B 99 50 A4 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 8068C2AC 000000C4  4B BD A8 88 */	b __mi__4cXyzCFRC3Vec
...
/* 8068C2C8 000000E0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8068C2CC 000000E4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8068C2D0 000000E8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8068C2E0 000000F8  4B 98 00 FC */	b mDoMtx_YrotS__FPA4_fs
/* 8068C2E4 000000FC  38 61 00 20 */	addi r3, r1, 0x20
/* 8068C2E8 00000100  38 9C 0B B0 */	addi r4, r28, 0xbb0
/* 8068C2EC 00000104  4B BE 4C 00 */	b MtxPosition__FP4cXyzP4cXyz
...
lbl_8068C314:
/* 8068C314 00000000  3C 60 80 69 */	lis r3, __vt__14dBgS_ObjGndChk@ha
/* 8068C318 00000004  38 03 DA 98 */	addi r0, r3, __vt__14dBgS_ObjGndChk@l
...
/* 8068C334 00000020  4B 9E B2 BC */	b __dt__11dBgS_GndChkFv
/* 8068C338 00000024  39 61 00 A0 */	addi r11, r1, 0xa0
/* 8068C33C 00000028  4B CD 5E E4 */	b _restgpr_27

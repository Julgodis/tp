...
/* 807EF304  4B B7 2E B0 */	b _savegpr_19
/* 807EF308  7C 7E 1B 78 */	mr r30, r3
/* 807EF30C  7C 9A 23 78 */	mr r26, r4
/* 807EF310  7C BB 2B 78 */	mr r27, r5
/* 807EF314  7C DC 33 78 */	mr r28, r6
/* 807EF318  3C 60 80 7F */	lis r3, cNullVec__6Z2Calc@ha
/* 807EF31C  3A E3 F8 CC */	addi r23, r3, cNullVec__6Z2Calc@l
/* 807EF320  3C 60 80 7F */	lis r3, lit_3905@ha
/* 807EF324  3B E3 F7 70 */	addi r31, r3, lit_3905@l
/* 807EF328  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807EF32C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807EF330  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807EF334  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 807EF338  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 807EF360  4B 9B D2 1C */	b dKy_darkworld_check__Fv
...
/* 807EF384  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 807EF388  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 807EF38C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 807EF390  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 807EF394  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 807EF398  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 807EF39C  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 807EF3A0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807EF3A4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807EF3A8  4B B5 71 08 */	b PSMTXCopy
...
/* 807EF3C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807EF3C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807EF3C8  38 81 00 4C */	addi r4, r1, 0x4c
/* 807EF3CC  38 A1 00 58 */	addi r5, r1, 0x58
/* 807EF3D0  4B B5 79 9C */	b PSMTXMultVec
/* 807EF3D4  38 61 00 34 */	addi r3, r1, 0x34
/* 807EF3D8  38 81 00 58 */	addi r4, r1, 0x58
/* 807EF3DC  7F 65 DB 78 */	mr r5, r27
/* 807EF3E0  4B A7 77 54 */	b __mi__4cXyzCFRC3Vec
...
/* 807EF3FC  4B A7 82 78 */	b cM_atan2s__Fff
...
/* 807EF430  4B A7 82 44 */	b cM_atan2s__Fff
...
/* 807EF44C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807EF450  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 807EF454  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 807EF4A0  4B 85 D5 F0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807EF4A4  7C 79 1B 79 */	or. r25, r3, r3
/* 807EF4A8  41 82 00 FC */	beq lbl_807EF5A4
/* 807EF4AC  38 61 00 40 */	addi r3, r1, 0x40
/* 807EF4B0  4B B5 7C 88 */	b PSVECSquareMag
...
/* 807EF520  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807EF524  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807EF590  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807EF594  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807EF598:
...
/* 807EF5E8  4B 85 D4 A8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807EF624  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807EF628  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 807EF654  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 807EF694  4B 85 DE 38 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807EF6F4  4B B7 2B 0C */	b _restgpr_19

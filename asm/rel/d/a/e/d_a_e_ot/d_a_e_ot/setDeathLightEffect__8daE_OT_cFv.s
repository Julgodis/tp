...
/* 8073AA50  4B C2 77 80 */	b _savegpr_26
/* 8073AA54  7C 7F 1B 78 */	mr r31, r3
/* 8073AA58  3B 40 00 00 */	li r26, 0
/* 8073AA5C  3B C0 00 00 */	li r30, 0
/* 8073AA60  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8073AA64  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 8073AA68  3C 60 80 74 */	lis r3, data_8073D148@ha
/* 8073AA6C  3B 83 D1 48 */	addi r28, r3, data_8073D148@l
/* 8073AA70  3C 60 80 74 */	lis r3, lit_3912@ha
/* 8073AA74  3B A3 CE B0 */	addi r29, r3, lit_3912@l
lbl_8073AA78:
/* 8073AA78  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 8073AAB4  C0 3D 00 00 */	lfs f1, 0(r29)	/* effective address: 8073CEB0 */
/* 8073AAB8  4B 91 1F D8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8073AAD4  4B 8F 25 98 */	b dComIfGp_getReverb__Fi
...
/* 8073AAE8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8073AAEC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8073AAF0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8073AAF4  38 81 00 20 */	addi r4, r1, 0x20
/* 8073AAF8  38 BF 05 38 */	addi r5, r31, 0x538
/* 8073AAFC  38 C0 00 00 */	li r6, 0
/* 8073AB00  3D 00 80 74 */	lis r8, lit_3912@ha
/* 8073AB04  C0 28 CE B0 */	lfs f1, lit_3912@l(r8)
/* 8073AB08  FC 40 08 90 */	fmr f2, f1
/* 8073AB0C  3D 00 80 74 */	lis r8, lit_3986@ha
/* 8073AB10  C0 68 CE E4 */	lfs f3, lit_3986@l(r8)
/* 8073AB14  FC 80 18 90 */	fmr f4, f3
/* 8073AB18  39 00 00 00 */	li r8, 0
/* 8073AB1C  4B B7 0E 68 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 8073AB20  39 61 00 40 */	addi r11, r1, 0x40
/* 8073AB24  4B C2 76 F8 */	b _restgpr_26

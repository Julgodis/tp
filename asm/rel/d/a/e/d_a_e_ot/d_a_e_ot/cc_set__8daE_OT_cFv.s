...
/* 8073BE20  4B C2 63 B8 */	b _savegpr_28
/* 8073BE24  7C 7E 1B 78 */	mr r30, r3
/* 8073BE28  3C 60 80 74 */	lis r3, lit_3910@ha
/* 8073BE2C  3B E3 CE A8 */	addi r31, r3, lit_3910@l
...
/* 8073BE40  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8073BE44  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8073BE48  4B C0 A6 68 */	b PSMTXCopy
...
/* 8073BE60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8073BE64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8073BE68  38 81 00 14 */	addi r4, r1, 0x14
/* 8073BE6C  38 BE 05 38 */	addi r5, r30, 0x538
/* 8073BE70  4B C0 AE FC */	b PSMTXMultVec
...
/* 8073BEA4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8073BEA8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8073BEAC  4B C0 A6 04 */	b PSMTXCopy
...
/* 8073BEC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8073BEC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8073BECC  38 81 00 14 */	addi r4, r1, 0x14
/* 8073BED0  38 A1 00 08 */	addi r5, r1, 8
/* 8073BED4  4B C0 AE 98 */	b PSMTXMultVec
/* 8073BED8  38 7E 0A 10 */	addi r3, r30, 0xa10
/* 8073BEDC  38 81 00 08 */	addi r4, r1, 8
/* 8073BEE0  4B B3 37 68 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 8073BF04  4B B2 8C A4 */	b Set__4cCcSFP8cCcD_Obj
/* 8073BF08  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 8073BF0C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8073BF10  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8073BF14  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8073BF18  4B C0 A5 98 */	b PSMTXCopy

...
/* 8073C0FC  4B C2 60 DC */	b _savegpr_28
/* 8073C100  7C 7E 1B 78 */	mr r30, r3
/* 8073C104  3C 60 80 74 */	lis r3, stringBase0@ha
/* 8073C108  38 63 CF 6C */	addi r3, r3, stringBase0@l
/* 8073C10C  38 80 00 0E */	li r4, 0xe
/* 8073C110  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8073C114  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8073C128  4B 90 01 C4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8073C12C  7C 7C 1B 78 */	mr r28, r3
/* 8073C130  38 60 00 58 */	li r3, 0x58
/* 8073C134  4B B9 2B 18 */	b __nw__FUl
/* 8073C138  7C 7D 1B 79 */	or. r29, r3, r3
/* 8073C13C  41 82 00 68 */	beq lbl_8073C1A4
/* 8073C140  3C 60 80 74 */	lis r3, stringBase0@ha
/* 8073C144  38 63 CF 6C */	addi r3, r3, stringBase0@l
/* 8073C148  38 80 00 06 */	li r4, 6
/* 8073C14C  7F E5 FB 78 */	mr r5, r31
/* 8073C150  38 C0 00 80 */	li r6, 0x80
/* 8073C154  4B 90 01 98 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8073C18C  3D 20 80 74 */	lis r9, lit_3912@ha
/* 8073C190  C0 29 CE B0 */	lfs f1, lit_3912@l(r9)
/* 8073C194  39 20 00 00 */	li r9, 0
/* 8073C198  39 40 FF FF */	li r10, -1
/* 8073C19C  4B 8D 46 34 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_8073C1C8:
/* 8073C1C8  3C 60 80 74 */	lis r3, stringBase0@ha
/* 8073C1CC  38 63 CF 6C */	addi r3, r3, stringBase0@l
/* 8073C1D0  38 80 00 0B */	li r4, 0xb
/* 8073C1D4  7F E5 FB 78 */	mr r5, r31
/* 8073C1D8  38 C0 00 80 */	li r6, 0x80
/* 8073C1DC  4B 90 01 10 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8073C1EC  4B 8D 8A 68 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8073C20C  4B B9 2A 40 */	b __nw__FUl
/* 8073C210  7C 7D 1B 79 */	or. r29, r3, r3
/* 8073C214  41 82 00 20 */	beq lbl_8073C234
/* 8073C218  3C 80 80 74 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8073C21C  38 04 D2 4C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8073C220  90 1D 00 00 */	stw r0, 0(r29)
/* 8073C224  38 80 00 00 */	li r4, 0
/* 8073C228  4B BE C1 D4 */	b init__12J3DFrameCtrlFs
...
lbl_8073C24C:
/* 8073C24C  3C 60 80 74 */	lis r3, stringBase0@ha
/* 8073C250  38 63 CF 6C */	addi r3, r3, stringBase0@l
/* 8073C254  38 80 00 11 */	li r4, 0x11
/* 8073C258  7F E5 FB 78 */	mr r5, r31
/* 8073C25C  38 C0 00 80 */	li r6, 0x80
/* 8073C260  4B 90 00 8C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8073C280  3D 00 80 74 */	lis r8, lit_3912@ha
/* 8073C284  C0 28 CE B0 */	lfs f1, lit_3912@l(r8)
/* 8073C288  39 00 00 00 */	li r8, 0
/* 8073C28C  39 20 FF FF */	li r9, -1
/* 8073C290  4B 8D 13 AC */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 8073C294  30 03 FF FF */	addic r0, r3, -1
/* 8073C298  7C 60 19 10 */	subfe r3, r0, r3
lbl_8073C29C:
/* 8073C29C  39 61 00 30 */	addi r11, r1, 0x30
/* 8073C2A0  4B C2 5F 84 */	b _restgpr_28

...
/* 8073A848 00000010  4B C2 79 7C */	b _savegpr_23
/* 8073A84C 00000014  7C 7D 1B 78 */	mr r29, r3
/* 8073A850 00000018  3C 60 80 74 */	lis r3, lit_1109@ha
/* 8073A854 0000001C  3B E3 D2 70 */	addi r31, r3, lit_1109@l
...
/* 8073A870 00000038  88 1F 00 7C */	lbz r0, 0x7c(r31)	/* effective address: 8073D2EC */
/* 8073A874 0000003C  7C 00 07 75 */	extsb. r0, r0
/* 8073A878 00000040  40 82 00 34 */	bne lbl_8073A8AC
/* 8073A87C 00000044  3C 60 80 74 */	lis r3, lit_4125@ha
/* 8073A880 00000048  C0 03 CE EC */	lfs f0, lit_4125@l(r3)
/* 8073A884 0000004C  D0 1F 00 80 */	stfs f0, 0x80(r31)	/* effective address: 8073D2F0 */
/* 8073A888 00000050  38 7F 00 80 */	addi r3, r31, 0x80
/* 8073A88C 00000054  D0 03 00 04 */	stfs f0, 4(r3)	/* effective address: 8073D2F4 */
/* 8073A890 00000058  D0 03 00 08 */	stfs f0, 8(r3)	/* effective address: 8073D2F8 */
/* 8073A894 0000005C  3C 80 80 74 */	lis r4, __dt__4cXyzFv@ha
/* 8073A898 00000060  38 84 CE 58 */	addi r4, r4, __dt__4cXyzFv@l
...
/* 8073A8A8 00000070  98 1F 00 7C */	stb r0, 0x7c(r31)	/* effective address: 8073D2EC */
lbl_8073A8AC:
/* 8073A8AC 00000000  3B C0 00 00 */	li r30, 0
/* 8073A8B0 00000004  3B 80 00 00 */	li r28, 0
/* 8073A8B4 00000008  3B 60 00 00 */	li r27, 0
/* 8073A8B8 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8073A8BC 00000010  3B 03 61 C0 */	addi r24, r3, g_dComIfG_gameInfo@l
/* 8073A8C0 00000014  3C 60 80 74 */	lis r3, data_8073D13C@ha
/* 8073A8C4 00000018  3B 23 D1 3C */	addi r25, r3, data_8073D13C@l
/* 8073A8C8 0000001C  3C 60 80 74 */	lis r3, lit_3912@ha
/* 8073A8CC 00000020  3B 43 CE B0 */	addi r26, r3, lit_3912@l
lbl_8073A8D0:
/* 8073A8D0 00000000  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 8073A918 00000048  C0 3A 00 00 */	lfs f1, 0(r26)	/* effective address: 8073CEB0 */
/* 8073A91C 0000004C  4B 91 2B B0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8073A920 00000050  7C 7D B9 2E */	stwx r3, r29, r23
/* 8073A924 00000054  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
/* 8073A928 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 8073A92C 0000005C  7C 9D B8 2E */	lwzx r4, r29, r23
/* 8073A930 00000060  4B 91 0F E8 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 8073A988 00000044  4B C2 78 88 */	b _restgpr_23

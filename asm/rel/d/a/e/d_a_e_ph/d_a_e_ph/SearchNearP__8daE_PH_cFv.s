...
/* 8073DBF4 00000004  4B C2 45 E8 */	b _savegpr_29
/* 8073DBF8 00000008  7C 7D 1B 78 */	mr r29, r3
/* 8073DBFC 0000000C  3C 60 80 74 */	lis r3, lit_3767@ha
/* 8073DC00 00000010  3B E3 1B F4 */	addi r31, r3, lit_3767@l
/* 8073DC04 00000014  C3 DF 00 5C */	lfs f30, 0x5c(r31)	/* effective address: 80741C50 */
/* 8073DC08 00000018  3B C0 00 00 */	li r30, 0
/* 8073DC0C 0000001C  C3 FF 00 00 */	lfs f31, 0(r31)	/* effective address: 80741BF4 */
/* 8073DC10 00000020  48 00 01 B0 */	b lbl_8073DDC0
lbl_8073DC14:
/* 8073DC14 00000000  7F C4 F3 78 */	mr r4, r30
/* 8073DC18 00000004  4B 91 3B 98 */	b dPath_GetPnt__FPC5dPathi
...
/* 8073DC30 0000001C  C0 23 00 0C */	lfs f1, 0xc(r3)	/* effective address: 8074000C */
/* 8073DC34 00000020  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80740004 */
...
/* 8073DC4C 00000038  4B C0 97 50 */	b PSVECSquareDistance
...
/* 8073DC5C 00000008  C8 9F 00 60 */	lfd f4, 0x60(r31)	/* effective address: 80741C54 */
/* 8073DC60 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8073DC64 00000010  C8 7F 00 68 */	lfd f3, 0x68(r31)	/* effective address: 80741C5C */
...
lbl_8073DCAC:
/* 8073DCAC 00000000  C8 1F 00 70 */	lfd f0, 0x70(r31)	/* effective address: 80741C64 */
/* 8073DCB0 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8073DCB4 00000000  40 80 00 10 */	bge lbl_8073DCC4
/* 8073DCB8 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8073DCBC 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8073DD28 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8073DD2C 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8073DD30:
...
/* 8073DDE4 00000008  4B C2 44 44 */	b _restgpr_29

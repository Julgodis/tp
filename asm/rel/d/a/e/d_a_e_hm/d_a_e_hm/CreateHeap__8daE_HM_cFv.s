...
/* 806E044C  4B C8 1D 8C */	b _savegpr_28
/* 806E0450  7C 7D 1B 78 */	mr r29, r3
/* 806E0454  3C 60 80 6E */	lis r3, stringBase0@ha
/* 806E0458  38 63 5A 74 */	addi r3, r3, stringBase0@l
/* 806E045C  38 80 00 11 */	li r4, 0x11
/* 806E0460  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806E0464  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 806E0478  4B 95 BE 74 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806E047C  7C 7E 1B 78 */	mr r30, r3
/* 806E0480  38 60 00 58 */	li r3, 0x58
/* 806E0484  4B BE E7 C8 */	b __nw__FUl
/* 806E0488  7C 7C 1B 79 */	or. r28, r3, r3
/* 806E048C  41 82 00 68 */	beq lbl_806E04F4
/* 806E0490  3C 60 80 6E */	lis r3, stringBase0@ha
/* 806E0494  38 63 5A 74 */	addi r3, r3, stringBase0@l
/* 806E0498  38 80 00 0D */	li r4, 0xd
/* 806E049C  7F E5 FB 78 */	mr r5, r31
/* 806E04A0  38 C0 00 80 */	li r6, 0x80
/* 806E04A4  4B 95 BE 48 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806E04DC  3D 20 80 6E */	lis r9, lit_3793@ha
/* 806E04E0  C0 29 59 28 */	lfs f1, lit_3793@l(r9)
/* 806E04E4  39 20 00 00 */	li r9, 0
/* 806E04E8  39 40 FF FF */	li r10, -1
/* 806E04EC  4B 93 02 E4 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806E051C  4B BE E7 30 */	b __nw__FUl
/* 806E0520  7C 7C 1B 79 */	or. r28, r3, r3
/* 806E0524  41 82 00 20 */	beq lbl_806E0544
/* 806E0528  3C 80 80 6E */	lis r4, __vt__12J3DFrameCtrl@ha
/* 806E052C  38 04 5B B8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 806E0530  90 1C 00 00 */	stw r0, 0(r28)
/* 806E0534  38 80 00 00 */	li r4, 0
/* 806E0538  4B C4 7E C4 */	b init__12J3DFrameCtrlFs
...
lbl_806E055C:
/* 806E055C  3C 60 80 6E */	lis r3, stringBase0@ha
/* 806E0560  38 63 5A 74 */	addi r3, r3, stringBase0@l
/* 806E0564  38 80 00 14 */	li r4, 0x14
/* 806E0568  7F E5 FB 78 */	mr r5, r31
/* 806E056C  38 C0 00 80 */	li r6, 0x80
/* 806E0570  4B 95 BD 7C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806E058C  3D 00 80 6E */	lis r8, lit_3793@ha
/* 806E0590  C0 28 59 28 */	lfs f1, lit_3793@l(r8)
/* 806E0594  39 00 00 00 */	li r8, 0
/* 806E0598  39 20 FF FF */	li r9, -1
/* 806E059C  4B 92 D1 70 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 806E05B4  4B BE E6 98 */	b __nw__FUl
/* 806E05B8  7C 7C 1B 79 */	or. r28, r3, r3
/* 806E05BC  41 82 00 20 */	beq lbl_806E05DC
/* 806E05C0  3C 80 80 6E */	lis r4, __vt__12J3DFrameCtrl@ha
/* 806E05C4  38 04 5B B8 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 806E05C8  90 1C 00 00 */	stw r0, 0(r28)
/* 806E05CC  38 80 00 00 */	li r4, 0
/* 806E05D0  4B C4 7E 2C */	b init__12J3DFrameCtrlFs
...
lbl_806E05F4:
/* 806E05F4  3C 60 80 6E */	lis r3, stringBase0@ha
/* 806E05F8  38 63 5A 74 */	addi r3, r3, stringBase0@l
/* 806E05FC  38 80 00 17 */	li r4, 0x17
/* 806E0600  7F E5 FB 78 */	mr r5, r31
/* 806E0604  38 C0 00 80 */	li r6, 0x80
/* 806E0608  4B 95 BC E4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806E0624  3D 00 80 6E */	lis r8, lit_3793@ha
/* 806E0628  C0 28 59 28 */	lfs f1, lit_3793@l(r8)
/* 806E062C  39 00 00 00 */	li r8, 0
/* 806E0630  39 20 FF FF */	li r9, -1
/* 806E0634  4B 92 D0 08 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 806E0638  30 03 FF FF */	addic r0, r3, -1
/* 806E063C  7C 60 19 10 */	subfe r3, r0, r3
lbl_806E0640:
/* 806E0640  39 61 00 30 */	addi r11, r1, 0x30
/* 806E0644  4B C8 1B E0 */	b _restgpr_28

...
/* 806E487C  4B C7 D9 58 */	b _savegpr_27
/* 806E4880  7C 7F 1B 78 */	mr r31, r3
/* 806E4884  3C 60 80 6E */	lis r3, lit_3791@ha
/* 806E4888  3B A3 59 20 */	addi r29, r3, lit_3791@l
/* 806E488C  C0 3D 00 04 */	lfs f1, 4(r29)	/* effective address: 806E5924 */
/* 806E4890  D0 21 00 64 */	stfs f1, 0x64(r1)
/* 806E4894  D0 21 00 68 */	stfs f1, 0x68(r1)
/* 806E4898  C0 1D 00 F4 */	lfs f0, 0xf4(r29)	/* effective address: 806E5A14 */
...
/* 806E48B0  4B 99 33 B8 */	b __ct__11dBgS_LinChkFv
...
/* 806E48C4  4B B8 C4 FC */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 806E48D8  4B 99 34 8C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806E48DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E48E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E48E4  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 806E48E8  7F 83 E3 78 */	mr r3, r28
/* 806E48EC  38 81 00 A4 */	addi r4, r1, 0xa4
/* 806E48F0  4B 98 FA C4 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 806E4904  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha
/* 806E4908  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 806E491C  4B 98 FE 28 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 806E495C  4B C6 2A 40 */	b PSVECSquareDistance
...
/* 806E49CC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E49D0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 806E4A3C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E4A40  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 806E4A44  48 00 00 08 */	b lbl_806E4A4C
lbl_806E4A48:
/* 806E4A48  FC 40 08 90 */	fmr f2, f1
lbl_806E4A4C:
/* 806E4A4C  C0 21 00 90 */	lfs f1, 0x90(r1)
/* 806E4A50  4B B8 2C 24 */	b cM_atan2s__Fff
...
/* 806E4A64  4B B8 2C 10 */	b cM_atan2s__Fff
...
/* 806E4A84  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha
/* 806E4A88  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l
/* 806E4A8C  90 01 00 A0 */	stw r0, 0xa0(r1)
/* 806E4A90  38 61 00 A4 */	addi r3, r1, 0xa4
/* 806E4A94  38 80 FF FF */	li r4, -1
/* 806E4A98  4B 99 32 44 */	b __dt__11dBgS_LinChkFv
...
/* 806E4AD0  4B B8 C2 F0 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 806E4AE4  4B 99 32 80 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806E4AE8  7F 83 E3 78 */	mr r3, r28
/* 806E4AEC  38 81 00 A4 */	addi r4, r1, 0xa4
/* 806E4AF0  4B 98 F8 C4 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 806E4AF4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 806E4AF8  41 82 01 A0 */	beq lbl_806E4C98
/* 806E4AFC  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha
/* 806E4B00  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 806E4B14  4B 98 FC 30 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 806E4B54  4B C6 28 48 */	b PSVECSquareDistance
...
/* 806E4BC4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E4BC8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 806E4C34  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E4C38  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 806E4C3C  48 00 00 08 */	b lbl_806E4C44
lbl_806E4C40:
/* 806E4C40  FC 40 08 90 */	fmr f2, f1
lbl_806E4C44:
/* 806E4C44  C0 21 00 7C */	lfs f1, 0x7c(r1)
/* 806E4C48  4B B8 2A 2C */	b cM_atan2s__Fff
...
/* 806E4C5C  4B B8 2A 18 */	b cM_atan2s__Fff
...
/* 806E4C7C  3C 60 80 6E */	lis r3, __vt__8cM3dGPla@ha
/* 806E4C80  38 03 5B AC */	addi r0, r3, __vt__8cM3dGPla@l
/* 806E4C84  90 01 00 8C */	stw r0, 0x8c(r1)
/* 806E4C88  38 61 00 A4 */	addi r3, r1, 0xa4
/* 806E4C8C  38 80 FF FF */	li r4, -1
/* 806E4C90  4B 99 30 4C */	b __dt__11dBgS_LinChkFv
...
/* 806E4CB0  4B 99 30 2C */	b __dt__11dBgS_LinChkFv
lbl_806E4CB4:
/* 806E4CB4  39 61 01 30 */	addi r11, r1, 0x130
/* 806E4CB8  4B C7 D5 68 */	b _restgpr_27

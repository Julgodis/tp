...
/* 806E54CC  4B C7 CC E8 */	b _savegpr_19
/* 806E54D0  7C 7E 1B 78 */	mr r30, r3
/* 806E54D4  7C 9A 23 78 */	mr r26, r4
/* 806E54D8  7C BB 2B 78 */	mr r27, r5
/* 806E54DC  7C DC 33 78 */	mr r28, r6
/* 806E54E0  3C 60 80 6E */	lis r3, cNullVec__6Z2Calc@ha
/* 806E54E4  3A E3 5A 7C */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806E54E8  3C 60 80 6E */	lis r3, lit_3791@ha
/* 806E54EC  3B E3 59 20 */	addi r31, r3, lit_3791@l
/* 806E54F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E54F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806E54F8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806E54FC  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806E5500  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806E5528  4B AC 70 54 */	b dKy_darkworld_check__Fv
...
/* 806E554C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806E5550  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806E5554  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806E5558  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806E555C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806E5560  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806E5564  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806E5568  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806E556C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806E5570  4B C6 0F 40 */	b PSMTXCopy
...
/* 806E5588  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806E558C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806E5590  38 81 00 4C */	addi r4, r1, 0x4c
/* 806E5594  38 A1 00 58 */	addi r5, r1, 0x58
/* 806E5598  4B C6 17 D4 */	b PSMTXMultVec
/* 806E559C  38 61 00 34 */	addi r3, r1, 0x34
/* 806E55A0  38 81 00 58 */	addi r4, r1, 0x58
/* 806E55A4  7F 65 DB 78 */	mr r5, r27
/* 806E55A8  4B B8 15 8C */	b __mi__4cXyzCFRC3Vec
...
/* 806E55C4  4B B8 20 B0 */	b cM_atan2s__Fff
...
/* 806E55F8  4B B8 20 7C */	b cM_atan2s__Fff
...
/* 806E5614  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E5618  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806E561C  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806E5668  4B 96 74 28 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806E566C  7C 79 1B 79 */	or. r25, r3, r3
/* 806E5670  41 82 00 FC */	beq lbl_806E576C
/* 806E5674  38 61 00 40 */	addi r3, r1, 0x40
/* 806E5678  4B C6 1A C0 */	b PSVECSquareMag
...
/* 806E56E8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E56EC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806E5758  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806E575C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806E5760:
...
/* 806E57B0  4B 96 72 E0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806E57EC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806E57F0  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806E581C  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806E585C  4B 96 7C 70 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806E58BC  4B C7 C9 44 */	b _restgpr_19

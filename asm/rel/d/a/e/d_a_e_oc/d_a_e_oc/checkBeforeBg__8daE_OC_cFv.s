...
/* 8072D374  4B C3 4E 68 */	b _savegpr_29
/* 8072D378  7C 7E 1B 78 */	mr r30, r3
/* 8072D37C  3C 60 80 73 */	lis r3, lit_3911@ha
/* 8072D380  3B E3 5B 28 */	addi r31, r3, lit_3911@l
/* 8072D384  38 61 00 38 */	addi r3, r1, 0x38
/* 8072D388  4B 94 A8 E0 */	b __ct__11dBgS_LinChkFv
/* 8072D38C  3C 60 80 73 */	lis r3, __vt__8cM3dGPla@ha
/* 8072D390  38 03 5F E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8072D3D0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8072D3D4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8072D418  4B 94 A9 4C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8072D41C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8072D420  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8072D424  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 8072D428  7F A3 EB 78 */	mr r3, r29
/* 8072D42C  38 81 00 38 */	addi r4, r1, 0x38
/* 8072D430  4B 94 6F 84 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 8072D448  4B 94 72 FC */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 8072D44C  38 81 00 68 */	addi r4, r1, 0x68
/* 8072D450  38 61 00 18 */	addi r3, r1, 0x18
/* 8072D454  4B C1 9F 48 */	b PSVECSquareDistance
...
/* 8072D4C4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072D4C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8072D534  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072D538  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8072D53C:
/* 8072D53C  C0 1F 00 00 */	lfs f0, 0(r31)
/* 8072D540  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8072D544  40 80 00 24 */	bge lbl_8072D568
/* 8072D548  3C 60 80 73 */	lis r3, __vt__8cM3dGPla@ha
/* 8072D54C  38 03 5F E0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8072D550  90 01 00 34 */	stw r0, 0x34(r1)
/* 8072D554  38 61 00 38 */	addi r3, r1, 0x38
/* 8072D558  38 80 FF FF */	li r4, -1
/* 8072D55C  4B 94 A7 80 */	b __dt__11dBgS_LinChkFv
...
/* 8072D570  4B B3 A1 04 */	b cM_atan2s__Fff

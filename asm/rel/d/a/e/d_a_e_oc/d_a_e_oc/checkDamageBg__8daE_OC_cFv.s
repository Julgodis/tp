...
/* 8072D9AC  3C 60 80 73 */	lis r3, lit_3911@ha
/* 8072D9B0  3B C3 5B 28 */	addi r30, r3, lit_3911@l
...
/* 8072D9CC  C0 1E 00 AC */	lfs f0, 0xac(r30)	/* effective address: 80735BD4 */
/* 8072D9D0  EC 01 00 2A */	fadds f0, f1, f0
/* 8072D9D4  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 8072D9D8  38 61 00 14 */	addi r3, r1, 0x14
/* 8072D9DC  4B 8D F3 88 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8072D9E0  38 7F 06 88 */	addi r3, r31, 0x688
/* 8072D9E4  4B 8D F5 60 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8072D9E8  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 8072D9EC  4B 8D F5 58 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 8072D9F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8072D9F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8072D9F8  A8 9F 06 D8 */	lha r4, 0x6d8(r31)
/* 8072D9FC  4B 8D EA 38 */	b mDoMtx_YrotM__FPA4_fs
/* 8072DA00  C0 3E 00 04 */	lfs f1, 4(r30)
/* 8072DA04  FC 40 08 90 */	fmr f2, f1
/* 8072DA08  C0 7E 00 B0 */	lfs f3, 0xb0(r30)
/* 8072DA0C  4B 8D F3 90 */	b transM__14mDoMtx_stack_cFfff
/* 8072DA10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8072DA14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8072DA18  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 8072DA1C  D0 01 00 08 */	stfs f0, 8(r1)
/* 8072DA20  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 8072DA24  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 8072DA28  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 8072DA2C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8072DA30  38 61 00 34 */	addi r3, r1, 0x34
/* 8072DA34  4B 94 A2 34 */	b __ct__11dBgS_LinChkFv
...
/* 8072DA48  4B 94 A3 1C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8072DA4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8072DA50  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8072DA54  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 8072DA58  7F C3 F3 78 */	mr r3, r30
/* 8072DA5C  38 81 00 34 */	addi r4, r1, 0x34
/* 8072DA60  4B 94 69 54 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 8072DA78  3C 60 80 73 */	lis r3, __vt__8cM3dGPla@ha
/* 8072DA7C  38 03 5F E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8072DA90  4B 94 6C B4 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 8072DA94  C0 21 00 20 */	lfs f1, 0x20(r1)
/* 8072DA98  C0 41 00 28 */	lfs f2, 0x28(r1)
/* 8072DA9C  4B B3 9B D8 */	b cM_atan2s__Fff
...
lbl_8072DAD0:
/* 8072DAD0  3C 60 80 73 */	lis r3, __vt__8cM3dGPla@ha
/* 8072DAD4  38 03 5F E0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8072DAF4  4B 94 A1 E8 */	b __dt__11dBgS_LinChkFv

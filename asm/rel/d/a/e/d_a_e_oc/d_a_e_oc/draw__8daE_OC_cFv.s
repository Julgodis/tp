...
/* 8072C744  4B C3 5A 8C */	b _savegpr_26
/* 8072C748  7C 7F 1B 78 */	mr r31, r3
/* 8072C74C  3C 60 80 73 */	lis r3, lit_3911@ha
/* 8072C750  3B C3 5B 28 */	addi r30, r3, lit_3911@l
/* 8072C754  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 8072C758  83 A3 00 04 */	lwz r29, 4(r3)
/* 8072C75C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8072C760  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8072C764  38 80 00 00 */	li r4, 0
/* 8072C768  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8072C76C  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8072C770  4B A7 70 54 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8072C774  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8072C778  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8072C77C  80 9D 00 04 */	lwz r4, 4(r29)
/* 8072C780  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8072C784  4B A7 86 1C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8072C85C  4B 8E 49 64 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 8072C8AC  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 8072C8B0  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 8072C8B4  4B 90 20 5C */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 8072C8C8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8072C8CC  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 8072C8F8  4B 92 96 24 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_8072C8FC:
/* 8072C8FC  38 60 00 01 */	li r3, 1
lbl_8072C900:
/* 8072C900  39 61 00 50 */	addi r11, r1, 0x50
/* 8072C904  4B C3 59 18 */	b _restgpr_26

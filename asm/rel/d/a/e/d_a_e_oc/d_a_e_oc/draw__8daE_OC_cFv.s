...
/* 8072C744 00000010  4B FF FD F5 */	bl _savegpr_26
/* 8072C748 00000014  7C 7F 1B 78 */	mr r31, r3
/* 8072C74C 00000018  3C 60 00 00 */	lis r3, lit_3911@ha /* 80735B28 */
/* 8072C750 0000001C  3B C3 00 00 */	addi r30, r3, lit_3911@l /* 80735B28 */
/* 8072C754 00000020  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 8072C758 00000024  83 A3 00 04 */	lwz r29, 4(r3)
/* 8072C75C 00000028  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8072C760 0000002C  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
...
/* 8072C770 0000003C  4B FF FD C9 */	bl settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8072C774 00000040  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8072C778 00000044  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8072C77C 00000048  80 9D 00 04 */	lwz r4, 4(r29)
/* 8072C780 0000004C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8072C784 00000050  4B FF FD B5 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8072C85C 00000004  4B FF FC DD */	bl entryDL__16mDoExt_McaMorfSOFv
...
/* 8072C8AC 00000054  3D 40 00 00 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha /* 804248D0 */
/* 8072C8B0 00000058  39 4A 00 00 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l /* 804248D0 */
/* 8072C8B4 0000005C  4B FF FC 85 */	bl dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 8072C8C8 00000070  3C 60 00 00 */	lis r3, g_env_light@ha /* 8042CA54 */
/* 8072C8CC 00000074  38 63 00 00 */	addi r3, r3, g_env_light@l /* 8042CA54 */
/* 8072C8D0 00000078  80 84 00 04 */	lwz r4, 4(r4)
/* 8072C8D4 0000007C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 8072C8D8 00000080  4B FF FC 61 */	bl setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8072C8DC 00000084  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 8072C8E0 00000088  4B FF FC 59 */	bl mDoExt_modelUpdateDL__FP8J3DModel
/* 8072C8E4 0000008C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8072C8E8 00000090  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8072C8F8 000000A0  4B FF FC 41 */	bl addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_8072C8FC:
/* 8072C8FC 00000000  38 60 00 01 */	li r3, 1
lbl_8072C900:
/* 8072C900 00000000  39 61 00 50 */	addi r11, r1, 0x50
/* 8072C904 00000004  4B FF FC 35 */	bl _restgpr_26

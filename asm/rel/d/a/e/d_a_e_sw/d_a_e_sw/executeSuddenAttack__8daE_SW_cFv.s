...
/* 807AB320  4B BB 6E BC */	b _savegpr_29
/* 807AB324  7C 7E 1B 78 */	mr r30, r3
/* 807AB328  3C 80 80 7B */	lis r4, lit_3909@ha
/* 807AB32C  3B E4 FD 2C */	addi r31, r4, lit_3909@l
/* 807AB330  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807AB334  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807AB338  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 807AB3A4  4B B9 BF F8 */	b PSVECSquareDistance
...
/* 807AB414  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807AB418  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807AB484  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807AB488  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807AB48C:
...
/* 807AB524  3C 60 80 7B */	lis r3, struct_807B0200+0x0@ha
/* 807AB528  98 03 02 00 */	stb r0, struct_807B0200+0x0@l(r3)
...
/* 807AB53C  4B AC 52 04 */	b cLib_chaseF__FPfff
...
/* 807AB550  4B AC 50 B8 */	b cLib_addCalcAngleS2__FPssss
/* 807AB554  C0 3F 00 00 */	lfs f1, 0(r31)
/* 807AB558  4B AB C4 34 */	b cM_rndFX__Ff
...
/* 807AB598  3C 60 80 7B */	lis r3, struct_807B0200+0x0@ha
/* 807AB59C  98 03 02 00 */	stb r0, struct_807B0200+0x0@l(r3)
...
/* 807AB5B0  4B BB 6C 78 */	b _restgpr_29

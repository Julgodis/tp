...
/* 807ADA20 00000018  3C 80 00 00 */	lis r4, cNullVec__6Z2Calc@ha
/* 807ADA24 0000001C  3B C4 00 00 */	addi r30, r4, cNullVec__6Z2Calc@l
/* 807ADA28 00000020  3C 80 00 00 */	lis r4, lit_3909@ha
/* 807ADA2C 00000024  3B E4 00 00 */	addi r31, r4, lit_3909@l
/* 807ADA30 00000028  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 807ADA34 0000002C  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
/* 807ADB70 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 807ADB74 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 807ADBE0 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 807ADBE4 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_807ADBE8:
/* 807ADBE8 00000000  3C 60 00 00 */	lis r3, l_HIO@ha
/* 807ADBEC 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 807ADCCC 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 807ADCD0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 807ADD3C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 807ADD40 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_807ADD44:
/* 807ADD44 00000000  3C 60 00 00 */	lis r3, l_HIO@ha
/* 807ADD48 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l

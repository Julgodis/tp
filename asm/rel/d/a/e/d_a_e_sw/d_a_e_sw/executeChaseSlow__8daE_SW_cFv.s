...
/* 807A8334  4B BB 9E A4 */	b _savegpr_28
/* 807A8338  7C 7D 1B 78 */	mr r29, r3
/* 807A833C  3C 60 80 7B */	lis r3, lit_3909@ha
/* 807A8340  3B E3 FD 2C */	addi r31, r3, lit_3909@l
/* 807A8344  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A8348  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 807A834C  83 DC 5D AC */	lwz r30, 0x5dac(r28)	/* effective address: 8040BF6C */
...
/* 807A8368  C0 3F 00 68 */	lfs f1, 0x68(r31)	/* effective address: 807AFD94 */
/* 807A836C  C0 1E 05 2C */	lfs f0, 0x52c(r30)
/* 807A8370  EF E1 00 2A */	fadds f31, f1, f0
/* 807A8374  C0 1F 00 6C */	lfs f0, 0x6c(r31)	/* effective address: 807AFD98 */
...
/* 807A8428  4B B9 EF 74 */	b PSVECSquareDistance
...
/* 807A8498  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807A849C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807A8508  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807A850C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807A8510:
...
/* 807A8564  4B B9 EE 38 */	b PSVECSquareDistance
...
/* 807A85D4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807A85D8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807A8644  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807A8648  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807A864C:
...
/* 807A86A8  4B AB F2 AC */	b cM_rndF__Ff
...
/* 807A86D0  4B AB F1 9C */	b cM_rnd__Fv
...
/* 807A8708  4B AB F2 84 */	b cM_rndFX__Ff
...
/* 807A8728  4B AB F2 64 */	b cM_rndFX__Ff
...
/* 807A8780  4B AC 86 40 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 807A8784  38 61 00 58 */	addi r3, r1, 0x58
/* 807A8788  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A878C  4B AC 84 78 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A87D0  4B AC 7F 70 */	b cLib_chaseF__FPfff
/* 807A87D4  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 807A87D8  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A87DC  4B AC 84 28 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A87F0  4B AC 7E 18 */	b cLib_addCalcAngleS2__FPssss
...
/* 807A8840  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A8844  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807A8848  3B 83 56 B8 */	addi r28, r3, 0x56b8
/* 807A884C  7F 83 E3 78 */	mr r3, r28
/* 807A8850  4B 8C AF 94 */	b LockonTruth__12dAttention_cFv
...
/* 807A8864  4B 8C AC D8 */	b LockonTarget__12dAttention_cFl
/* 807A8868  7C 03 E8 40 */	cmplw r3, r29
/* 807A886C  40 82 00 08 */	bne lbl_807A8874
/* 807A8870  3B C0 00 01 */	li r30, 1
lbl_807A8874:
/* 807A8874  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A8878  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807A887C  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 807A8898  4B AC 85 8C */	b cLib_distanceAngleS__Fss
...
lbl_807A88B0:
/* 807A88B0  3C 60 80 7B */	lis r3, struct_807B0200+0x0@ha
/* 807A88B4  8C 03 02 00 */	lbzu r0, struct_807B0200+0x0@l(r3)
...
/* 807A88E4  4B AB F0 70 */	b cM_rndF__Ff
...
/* 807A8958  4B AC 84 68 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 807A895C  38 61 00 58 */	addi r3, r1, 0x58
/* 807A8960  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A8964  4B AC 82 A0 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A89AC  4B AC 7D 94 */	b cLib_chaseF__FPfff
/* 807A89B0  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 807A89B4  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A89B8  4B AC 82 4C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A89CC  4B AC 7C 3C */	b cLib_addCalcAngleS2__FPssss
...
/* 807A89E0  4B AB EF 74 */	b cM_rndF__Ff
...
/* 807A89F4  4B AB EF 98 */	b cM_rndFX__Ff
...
/* 807A8A14  4B AB EF 78 */	b cM_rndFX__Ff
...
/* 807A8A70  4B AC 83 50 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 807A8A74  38 61 00 58 */	addi r3, r1, 0x58
/* 807A8A78  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A8A7C  4B AC 81 88 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A8AC4  4B AC 7C 7C */	b cLib_chaseF__FPfff
/* 807A8AC8  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 807A8ACC  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A8AD0  4B AC 81 34 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807A8AE4  4B AC 7B 24 */	b cLib_addCalcAngleS2__FPssss
...
/* 807A8B10  4B AC 7C 30 */	b cLib_chaseF__FPfff
...
/* 807A8B24  4B AC 7A E4 */	b cLib_addCalcAngleS2__FPssss
/* 807A8B28  C0 3D 06 C8 */	lfs f1, 0x6c8(r29)
/* 807A8B2C  3C 60 80 7B */	lis r3, l_HIO@ha
/* 807A8B30  38 63 02 10 */	addi r3, r3, l_HIO@l
/* 807A8B34  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 807B0224 */
...
/* 807A8B64  3C 60 80 7B */	lis r3, struct_807B0200+0x0@ha
/* 807A8B68  98 83 02 00 */	stb r4, struct_807B0200+0x0@l(r3)
...
/* 807A8B84  4B BB 96 A0 */	b _restgpr_28

...
/* 807ACCC0 00000010  4B FF A6 B9 */	bl _savegpr_29
/* 807ACCC4 00000014  7C 7D 1B 78 */	mr r29, r3
/* 807ACCC8 00000018  3C 60 00 00 */	lis r3, cNullVec__6Z2Calc@ha /* 807AFE7C */
/* 807ACCCC 0000001C  3B E3 00 00 */	addi r31, r3, cNullVec__6Z2Calc@l /* 807AFE7C */
/* 807ACCD0 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807ACCD4 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 807ACCD8 00000028  83 C3 5D AC */	lwz r30, 0x5dac(r3)
/* 807ACCDC 0000002C  38 7D 09 6C */	addi r3, r29, 0x96c
/* 807ACCE0 00000030  4B FF A6 99 */	bl Move__10dCcD_GSttsFv
...
/* 807ACCF0 00000040  80 7F 01 78 */	lwz r3, 0x178(r31)
/* 807ACCF4 00000044  80 1F 01 7C */	lwz r0, 0x17c(r31)
/* 807ACCF8 00000048  90 61 00 68 */	stw r3, 0x68(r1)
/* 807ACCFC 0000004C  90 01 00 6C */	stw r0, 0x6c(r1)
/* 807ACD00 00000050  80 1F 01 80 */	lwz r0, 0x180(r31)
...
/* 807ACD10 00000060  4B FF A6 69 */	bl __ptmf_cmpr
/* 807ACD14 00000064  2C 03 00 00 */	cmpwi r3, 0
/* 807ACD18 00000068  41 82 02 C8 */	beq lbl_807ACFE0
/* 807ACD1C 0000006C  80 7F 01 84 */	lwz r3, 0x184(r31)
/* 807ACD20 00000070  80 1F 01 88 */	lwz r0, 0x188(r31)
/* 807ACD24 00000074  90 61 00 5C */	stw r3, 0x5c(r1)
/* 807ACD28 00000078  90 01 00 60 */	stw r0, 0x60(r1)
/* 807ACD2C 0000007C  80 1F 01 8C */	lwz r0, 0x18c(r31)
...
/* 807ACD3C 0000008C  4B FF A6 3D */	bl __ptmf_cmpr
...
/* 807ACD80 00000034  80 7F 01 90 */	lwz r3, 0x190(r31)
/* 807ACD84 00000038  80 1F 01 94 */	lwz r0, 0x194(r31)
/* 807ACD88 0000003C  90 61 00 50 */	stw r3, 0x50(r1)
/* 807ACD8C 00000040  90 01 00 54 */	stw r0, 0x54(r1)
/* 807ACD90 00000044  80 1F 01 98 */	lwz r0, 0x198(r31)
...
/* 807ACDAC 00000004  4B FF A5 CD */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 807ACDBC 00000014  4B FF A5 BD */	bl GetTgHitObj__12dCcD_GObjInfFv
...
/* 807ACE08 00000008  4B FF A5 71 */	bl cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 807ACEA0 0000000C  80 7F 01 9C */	lwz r3, 0x19c(r31)
/* 807ACEA4 00000010  80 1F 01 A0 */	lwz r0, 0x1a0(r31)
/* 807ACEA8 00000014  90 61 00 44 */	stw r3, 0x44(r1)
/* 807ACEAC 00000018  90 01 00 48 */	stw r0, 0x48(r1)
/* 807ACEB0 0000001C  80 1F 01 A4 */	lwz r0, 0x1a4(r31)
...
/* 807ACEEC 0000000C  80 7F 01 A8 */	lwz r3, 0x1a8(r31)
/* 807ACEF0 00000010  80 1F 01 AC */	lwz r0, 0x1ac(r31)
/* 807ACEF4 00000014  90 61 00 38 */	stw r3, 0x38(r1)
/* 807ACEF8 00000018  90 01 00 3C */	stw r0, 0x3c(r1)
/* 807ACEFC 0000001C  80 1F 01 B0 */	lwz r0, 0x1b0(r31)
...
/* 807ACF1C 00000008  80 7F 01 B4 */	lwz r3, 0x1b4(r31)
/* 807ACF20 0000000C  80 1F 01 B8 */	lwz r0, 0x1b8(r31)
/* 807ACF24 00000010  90 61 00 2C */	stw r3, 0x2c(r1)
/* 807ACF28 00000014  90 01 00 30 */	stw r0, 0x30(r1)
/* 807ACF2C 00000018  80 1F 01 BC */	lwz r0, 0x1bc(r31)
...
lbl_807ACF5C:
/* 807ACF5C 00000000  80 7F 01 C0 */	lwz r3, 0x1c0(r31)
/* 807ACF60 00000004  80 1F 01 C4 */	lwz r0, 0x1c4(r31)
/* 807ACF64 00000008  90 61 00 20 */	stw r3, 0x20(r1)
/* 807ACF68 0000000C  90 01 00 24 */	stw r0, 0x24(r1)
/* 807ACF6C 00000010  80 1F 01 C8 */	lwz r0, 0x1c8(r31)
...
/* 807ACF7C 00000020  4B FF A3 FD */	bl __ptmf_cmpr
/* 807ACF80 00000024  2C 03 00 00 */	cmpwi r3, 0
/* 807ACF84 00000028  41 82 00 5C */	beq lbl_807ACFE0
/* 807ACF88 0000002C  80 7F 01 CC */	lwz r3, 0x1cc(r31)
/* 807ACF8C 00000030  80 1F 01 D0 */	lwz r0, 0x1d0(r31)
/* 807ACF90 00000034  90 61 00 14 */	stw r3, 0x14(r1)
/* 807ACF94 00000038  90 01 00 18 */	stw r0, 0x18(r1)
/* 807ACF98 0000003C  80 1F 01 D4 */	lwz r0, 0x1d4(r31)
...
/* 807ACFBC 0000000C  80 7F 01 D8 */	lwz r3, 0x1d8(r31)
/* 807ACFC0 00000010  80 1F 01 DC */	lwz r0, 0x1dc(r31)
/* 807ACFC4 00000014  90 61 00 08 */	stw r3, 8(r1)
/* 807ACFC8 00000018  90 01 00 0C */	stw r0, 0xc(r1)
/* 807ACFCC 0000001C  80 1F 01 E0 */	lwz r0, 0x1e0(r31)
...
/* 807ACFE4 00000004  4B FF A3 95 */	bl _restgpr_29

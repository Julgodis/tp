...
/* 807AF02C  4B BB 31 B0 */	b _savegpr_29
/* 807AF030  7C 7E 1B 78 */	mr r30, r3
/* 807AF034  3C 80 80 7B */	lis r4, lit_3909@ha
/* 807AF038  3B E4 FD 2C */	addi r31, r4, lit_3909@l
...
/* 807AF12C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807AF130  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807AF134  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 807AF138  4B 85 D2 A4 */	b mDoMtx_YrotS__FPA4_fs
...
/* 807AF154  4B 85 DC 48 */	b transM__14mDoMtx_stack_cFfff
...
/* 807AF168  4B 85 DC 34 */	b transM__14mDoMtx_stack_cFfff
lbl_807AF16C:
/* 807AF16C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807AF170  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807AF174  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 807AF178  D0 01 00 40 */	stfs f0, 0x40(r1)
/* 807AF17C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 807AF180  D0 01 00 44 */	stfs f0, 0x44(r1)
/* 807AF184  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
lbl_807AF1A4:
/* 807AF1A4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807AF1A8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807AF1AC  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 807AF1FC  4B AC 13 44 */	b cLib_addCalcAngleS__FPsssss
...
/* 807AF234  3C 60 80 7B */	lis r3, lit_7081@ha
/* 807AF238  38 83 01 2C */	addi r4, r3, lit_7081@l
/* 807AF23C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 807B012C */
/* 807AF240  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 807B0130 */
/* 807AF244  90 61 00 28 */	stw r3, 0x28(r1)
/* 807AF248  90 01 00 2C */	stw r0, 0x2c(r1)
/* 807AF24C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 807B0134 */
...
/* 807AF298  4B B9 81 04 */	b PSVECSquareDistance
...
/* 807AF308  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807AF30C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807AF378  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807AF37C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807AF380:
...
/* 807AF390  4B 8C 88 D8 */	b __ct__11dBgS_LinChkFv
...
/* 807AF3A4  4B 8C 89 C0 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807AF3A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807AF3AC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807AF3B0  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 807AF3B4  7F A3 EB 78 */	mr r3, r29
/* 807AF3B8  38 81 00 60 */	addi r4, r1, 0x60
/* 807AF3BC  4B 8C 4F F8 */	b LineCross__4cBgSFP11cBgS_LinChk
/* 807AF3C0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 807AF3C4  41 82 00 84 */	beq lbl_807AF448
/* 807AF3C8  3C 60 80 7B */	lis r3, __vt__8cM3dGPla@ha
/* 807AF3CC  38 03 01 38 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 807AF3E0  4B 8C 53 64 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 807AF43C  3C 60 80 7B */	lis r3, __vt__8cM3dGPla@ha
/* 807AF440  38 03 01 38 */	addi r0, r3, __vt__8cM3dGPla@l
/* 807AF444  90 01 00 5C */	stw r0, 0x5c(r1)
lbl_807AF448:
/* 807AF448  38 61 00 60 */	addi r3, r1, 0x60
/* 807AF44C  38 80 FF FF */	li r4, -1
/* 807AF450  4B 8C 88 8C */	b __dt__11dBgS_LinChkFv
lbl_807AF454:
/* 807AF454  39 61 00 E0 */	addi r11, r1, 0xe0
/* 807AF458  4B BB 2D D0 */	b _restgpr_29

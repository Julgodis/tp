...
/* 807AADDC  4B BB 74 00 */	b _savegpr_29
/* 807AADE0  7C 7E 1B 78 */	mr r30, r3
/* 807AADE4  3C 60 80 7B */	lis r3, lit_3909@ha
/* 807AADE8  3B E3 FD 2C */	addi r31, r3, lit_3909@l
/* 807AADEC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807AADF0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807AADF4  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 807AAE78  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807AAE7C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807AAE80  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 807AAE84  4B 86 F8 8C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807AAE9C  4B BB A2 34 */	b abs
/* 807AAEA0  2C 03 20 00 */	cmpwi r3, 0x2000
/* 807AAEA4  40 80 00 B4 */	bge lbl_807AAF58
/* 807AAEA8  38 00 00 00 */	li r0, 0
/* 807AAEAC  3C 60 80 7B */	lis r3, struct_807B0200+0x1@ha
/* 807AAEB0  98 03 02 01 */	stb r0, struct_807B0200+0x1@l(r3)
/* 807AAEB4  3C 60 80 7B */	lis r3, s_child_sub__FPvPv@ha
/* 807AAEB8  38 63 AD 28 */	addi r3, r3, s_child_sub__FPvPv@l
/* 807AAEBC  7F C4 F3 78 */	mr r4, r30
/* 807AAEC0  4B 87 64 78 */	b fpcEx_Search__FPFPvPv_PvPv
/* 807AAEC4  3C 60 80 7B */	lis r3, struct_807B0200+0x1@ha
/* 807AAEC8  38 63 02 01 */	addi r3, r3, struct_807B0200+0x1@l
/* 807AAECC  88 63 00 00 */	lbz r3, 0(r3)	/* effective address: 807B0201 */
...
/* 807AAEE0  3C 60 80 7B */	lis r3, struct_807B0200+0x2@ha
/* 807AAEE4  88 03 02 02 */	lbz r0, struct_807B0200+0x2@l(r3)
/* 807AAEE8  28 00 00 04 */	cmplwi r0, 4
/* 807AAEEC  41 80 00 1C */	blt lbl_807AAF08
/* 807AAEF0  4B AB C9 7C */	b cM_rnd__Fv
...
/* 807AAF54  4B 86 EF 9C */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
lbl_807AAF58:
/* 807AAF58  39 61 00 20 */	addi r11, r1, 0x20
/* 807AAF5C  4B BB 72 CC */	b _restgpr_29

...
/* 80502AE4 00000010  4B FF E4 15 */	bl _savegpr_29
/* 80502AE8 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80502AEC 00000018  3C 60 00 00 */	lis r3, lit_3999@ha /* 805046DC */
/* 80502AF0 0000001C  3B E3 00 00 */	addi r31, r3, lit_3999@l /* 805046DC */
/* 80502AF4 00000020  38 7E 04 FC */	addi r3, r30, 0x4fc
/* 80502AF8 00000024  C0 3F 00 00 */	lfs f1, 0(r31)
/* 80502AFC 00000028  C0 5F 00 B0 */	lfs f2, 0xb0(r31)
/* 80502B00 0000002C  4B FF E3 F9 */	bl cLib_addCalc0__FPfff
...
/* 80502B10 0000003C  4B FF E3 E9 */	bl PSVECAdd
/* 80502B14 00000040  C0 1E 04 F8 */	lfs f0, 0x4f8(r30)
/* 80502B18 00000044  C0 3F 00 30 */	lfs f1, 0x30(r31)
...
/* 80502B50 0000007C  C0 3F 00 B4 */	lfs f1, 0xb4(r31)
...
/* 80502B70 00000010  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 80502B74 00000014  4B FF E3 85 */	bl fopAcM_effHamonSet__FPUlPC4cXyzff
lbl_80502B78:
...
/* 80502B84 0000000C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80502B88 00000010  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80502B98 00000020  C0 1F 00 74 */	lfs f0, 0x74(r31)
/* 80502B9C 00000024  EC 41 00 28 */	fsubs f2, f1, f0
/* 80502BA0 00000028  C0 3F 00 BC */	lfs f1, 0xbc(r31)
...
/* 80502BB4 0000003C  C0 5F 00 A4 */	lfs f2, 0xa4(r31)
/* 80502BB8 00000040  C0 7F 00 48 */	lfs f3, 0x48(r31)
/* 80502BBC 00000044  4B FF E3 3D */	bl cLib_addCalc2__FPffff
...
/* 80502BCC 00000054  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 80502BD0 00000058  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
/* 80502C1C 000000A4  C0 3F 00 24 */	lfs f1, 0x24(r31)
/* 80502C20 000000A8  C0 5F 00 A4 */	lfs f2, 0xa4(r31)
/* 80502C24 000000AC  C0 7F 00 80 */	lfs f3, 0x80(r31)
/* 80502C28 000000B0  4B FF E2 D1 */	bl cLib_addCalc2__FPffff
...
/* 80502C40 000000C8  4B FF E2 B9 */	bl ChkCoHit__12dCcD_GObjInfFv
...
/* 80502C58 000000E0  C0 3F 00 28 */	lfs f1, 0x28(r31)
/* 80502C5C 000000E4  C0 1D 00 00 */	lfs f0, 0(r29)
/* 80502C60 000000E8  EC 21 00 32 */	fmuls f1, f1, f0
/* 80502C64 000000EC  C0 5F 00 A4 */	lfs f2, 0xa4(r31)
/* 80502C68 000000F0  C0 7F 00 00 */	lfs f3, 0(r31)
/* 80502C6C 000000F4  4B FF E2 8D */	bl cLib_addCalc2__FPffff
/* 80502C70 000000F8  38 7E 05 00 */	addi r3, r30, 0x500
/* 80502C74 000000FC  C0 3F 00 28 */	lfs f1, 0x28(r31)
/* 80502C78 00000100  C0 1D 00 08 */	lfs f0, 8(r29)
/* 80502C7C 00000104  EC 21 00 32 */	fmuls f1, f1, f0
/* 80502C80 00000108  C0 5F 00 A4 */	lfs f2, 0xa4(r31)
/* 80502C84 0000010C  C0 7F 00 00 */	lfs f3, 0(r31)
/* 80502C88 00000110  4B FF E2 71 */	bl cLib_addCalc2__FPffff
/* 80502C8C 00000114  38 7E 0A A8 */	addi r3, r30, 0xaa8
/* 80502C90 00000118  C0 3F 00 94 */	lfs f1, 0x94(r31)
/* 80502C94 0000011C  C0 5F 00 A4 */	lfs f2, 0xa4(r31)
/* 80502C98 00000120  C0 7F 00 3C */	lfs f3, 0x3c(r31)
/* 80502C9C 00000124  4B FF E2 5D */	bl cLib_addCalc2__FPffff
lbl_80502CA0:
...
/* 80502CB0 00000010  4B FF E2 49 */	bl cLib_addCalcAngleS2__FPssss
...
/* 80502CF0 00000014  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 80502D04 00000004  4B FF E1 F5 */	bl ChkTgHit__12dCcD_GObjInfFv
...
/* 80502D1C 00000004  4B FF E1 DD */	bl _restgpr_29

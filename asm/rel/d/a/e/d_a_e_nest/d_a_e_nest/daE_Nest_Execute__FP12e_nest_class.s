...
/* 805039C4 00000004  4B E5 E8 0C */	b _savegpr_26
/* 805039C8 00000008  7C 7E 1B 78 */	mr r30, r3
/* 805039CC 0000000C  3C 60 80 50 */	lis r3, lit_3999@ha
/* 805039D0 00000010  3B E3 46 DC */	addi r31, r3, lit_3999@l
...
/* 80503A14 00000010  4B B2 96 58 */	b dComIfGp_getReverb__Fi
...
/* 80503A40 0000003C  3C 60 80 50 */	lis r3, shot_b_sub__FPvPv@ha
/* 80503A44 00000040  38 63 36 68 */	addi r3, r3, shot_b_sub__FPvPv@l
/* 80503A48 00000044  7F C4 F3 78 */	mr r4, r30
/* 80503A4C 00000048  4B B1 D8 EC */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 80503A64 00000060  4B D6 30 D0 */	b __mi__4cXyzCFRC3Vec
...
/* 80503A84 00000080  4B E4 36 B4 */	b PSVECSquareMag
/* 80503A88 00000084  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 805046E0 */
...
/* 80503A98 00000008  C8 9F 00 08 */	lfd f4, 8(r31)	/* effective address: 805046E4 */
/* 80503A9C 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80503AA0 00000010  C8 7F 00 10 */	lfd f3, 0x10(r31)	/* effective address: 805046EC */
...
lbl_80503AE8:
/* 80503AE8 00000000  C8 1F 00 18 */	lfd f0, 0x18(r31)	/* effective address: 805046F4 */
/* 80503AEC 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80503AF0 00000000  40 80 00 10 */	bge lbl_80503B00
/* 80503AF4 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80503AF8 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80503B64 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80503B68 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80503B6C:
/* 80503B6C 00000000  C0 1F 00 8C */	lfs f0, 0x8c(r31)	/* effective address: 80504768 */
...
/* 80503B80 0000000C  C3 5F 00 04 */	lfs f26, 4(r31)	/* effective address: 805046E0 */
lbl_80503B84:
...
/* 80503B9C 00000010  C0 3F 00 F4 */	lfs f1, 0xf4(r31)	/* effective address: 805047D0 */
/* 80503BA0 00000014  4B D6 3D EC */	b cM_rndFX__Ff
...
/* 80503BB4 00000028  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80503BB8 0000002C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80503BBC 00000030  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80503BC0 00000034  A8 9C 00 36 */	lha r4, 0x36(r28)
/* 80503BC4 00000038  4B B0 88 18 */	b mDoMtx_YrotS__FPA4_fs
/* 80503BC8 0000003C  C0 5F 00 04 */	lfs f2, 4(r31)	/* effective address: 805046E0 */
/* 80503BCC 00000040  D0 41 00 30 */	stfs f2, 0x30(r1)
/* 80503BD0 00000044  C0 3F 00 90 */	lfs f1, 0x90(r31)	/* effective address: 8050476C */
...
/* 80503BEC 00000060  4B D6 D3 00 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80503BFC 00000070  4B E4 34 94 */	b PSVECAdd
/* 80503C00 00000074  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 805046E0 */
/* 80503C04 00000078  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80503C08 0000007C  C0 3F 00 7C */	lfs f1, 0x7c(r31)	/* effective address: 80504758 */
/* 80503C0C 00000080  4B D6 3D 48 */	b cM_rndF__Ff
/* 80503C10 00000084  C0 1F 00 90 */	lfs f0, 0x90(r31)	/* effective address: 8050476C */
...
/* 80503C24 00000098  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 805046E0 */
...
/* 80503C34 000000A8  4B D6 D2 B8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80503C8C 0000003C  C3 FF 00 D8 */	lfs f31, 0xd8(r31)	/* effective address: 805047B4 */
/* 80503C90 00000040  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80503C94 00000044  3B 83 07 68 */	addi r28, r3, calc_mtx@l
/* 80503C98 00000048  C3 5F 00 04 */	lfs f26, 4(r31)	/* effective address: 805046E0 */
/* 80503C9C 0000004C  C3 7F 00 90 */	lfs f27, 0x90(r31)	/* effective address: 8050476C */
/* 80503CA0 00000050  C3 9F 00 F8 */	lfs f28, 0xf8(r31)	/* effective address: 805047D4 */
/* 80503CA4 00000054  C3 BF 00 48 */	lfs f29, 0x48(r31)	/* effective address: 80504724 */
/* 80503CA8 00000058  C3 DF 00 60 */	lfs f30, 0x60(r31)	/* effective address: 8050473C */
lbl_80503CAC:
/* 80503CAC 00000000  38 00 00 01 */	li r0, 1
/* 80503CB0 00000004  98 1B 00 53 */	stb r0, 0x53(r27)
/* 80503CB4 00000008  C0 3F 00 EC */	lfs f1, 0xec(r31)	/* effective address: 805047C8 */
/* 80503CB8 0000000C  4B D6 3C 9C */	b cM_rndF__Ff
...
/* 80503D00 00000054  80 7C 00 00 */	lwz r3, 0(r28)	/* effective address: 80450768 */
/* 80503D04 00000058  A8 9B 00 36 */	lha r4, 0x36(r27)
/* 80503D08 0000005C  4B B0 86 D4 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80503D2C 00000080  4B D6 D1 C0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80503D3C 00000090  4B E4 33 54 */	b PSVECAdd
/* 80503D40 00000094  D3 41 00 30 */	stfs f26, 0x30(r1)
/* 80503D44 00000098  C0 3F 00 AC */	lfs f1, 0xac(r31)	/* effective address: 80504788 */
/* 80503D48 0000009C  4B D6 3C 0C */	b cM_rndF__Ff
...
/* 80503D5C 000000B0  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 805046DC */
/* 80503D60 000000B4  4B D6 3B F4 */	b cM_rndF__Ff
...
/* 80503D7C 000000D0  4B D6 D1 70 */	b MtxPosition__FP4cXyzP4cXyz
/* 80503D80 000000D4  38 00 00 00 */	li r0, 0
/* 80503D84 000000D8  98 1B 00 52 */	stb r0, 0x52(r27)
/* 80503D88 000000DC  C0 3F 00 FC */	lfs f1, 0xfc(r31)	/* effective address: 805047D8 */
/* 80503D8C 000000E0  4B D6 3B C8 */	b cM_rndF__Ff
...
/* 80503E10 00000008  4B E5 E4 0C */	b _restgpr_26

...
/* 804FE608 0000000C  4B E6 3B BC */	b _savegpr_23
/* 804FE60C 00000010  7C 7D 1B 78 */	mr r29, r3
/* 804FE610 00000014  3C 60 80 50 */	lis r3, lit_3788@ha
/* 804FE614 00000018  38 63 0B 04 */	addi r3, r3, lit_3788@l
...
/* 804FE630 00000034  C0 23 00 04 */	lfs f1, 4(r3)	/* effective address: 80500B08 */
...
/* 804FE644 00000048  C3 C3 00 34 */	lfs f30, 0x34(r3)	/* effective address: 80500B38 */
...
/* 804FE664 00000068  C3 C3 00 B0 */	lfs f30, 0xb0(r3)	/* effective address: 80500BB4 */
/* 804FE668 0000006C  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 804FE66C 00000070  C0 03 00 D8 */	lfs f0, 0xd8(r3)	/* effective address: 80500BDC */
...
lbl_804FE67C:
/* 804FE67C 00000000  C0 03 00 DC */	lfs f0, 0xdc(r3)	/* effective address: 80500BE0 */
...
/* 804FE698 00000014  C3 83 00 04 */	lfs f28, 4(r3)	/* effective address: 80500B08 */
/* 804FE69C 00000018  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FE6A0 0000001C  3B 23 07 68 */	addi r25, r3, calc_mtx@l
lbl_804FE6A4:
...
/* 804FE6C0 0000001C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804FE6C4 00000020  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804FE6FC 00000010  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 804FE700 00000014  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 804FE730 00000044  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FE734 00000048  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FE738 0000004C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FE73C 00000050  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 804FE740 00000054  4B B0 DC 9C */	b mDoMtx_YrotS__FPA4_fs
/* 804FE744 00000058  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FE748 0000005C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FE74C 00000060  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FE750 00000064  3C 80 80 50 */	lis r4, data_80500C78@ha
/* 804FE754 00000068  38 04 0C 78 */	addi r0, r4, data_80500C78@l
...
/* 804FE76C 00000080  4B B0 DC 30 */	b mDoMtx_XrotM__FPA4_fs
/* 804FE770 00000084  48 00 00 38 */	b lbl_804FE7A8
lbl_804FE774:
/* 804FE774 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FE778 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FE77C 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FE780 0000000C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 804FE784 00000010  4B B0 DC 58 */	b mDoMtx_YrotS__FPA4_fs
/* 804FE788 00000014  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FE78C 00000018  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FE790 0000001C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FE794 00000020  3C 80 80 50 */	lis r4, data_80500C78@ha
/* 804FE798 00000024  38 04 0C 78 */	addi r0, r4, data_80500C78@l
/* 804FE79C 00000028  7C 80 E2 14 */	add r4, r0, r28
/* 804FE7A0 0000002C  A8 84 FF FE */	lha r4, -2(r4)
/* 804FE7A4 00000030  4B B0 DB F8 */	b mDoMtx_XrotM__FPA4_fs
lbl_804FE7A8:
...
/* 804FE7B8 00000010  4B D7 26 EC */	b MtxScale__FfffUc
/* 804FE7BC 00000014  38 61 00 20 */	addi r3, r1, 0x20
/* 804FE7C0 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 804FE7C4 0000001C  4B D7 27 28 */	b MtxPosition__FP4cXyzP4cXyz
lbl_804FE7C8:
...
/* 804FE814 0000004C  4B D6 8E 60 */	b cM_atan2s__Fff
...
/* 804FE83C 00000004  4B D6 8E 38 */	b cM_atan2s__Fff
/* 804FE840 00000008  7C 03 00 D0 */	neg r0, r3
/* 804FE844 0000000C  7C 18 07 34 */	extsh r24, r0
/* 804FE848 00000010  80 79 00 00 */	lwz r3, 0(r25)	/* effective address: 80450768 */
/* 804FE84C 00000014  7E E4 BB 78 */	mr r4, r23
/* 804FE850 00000018  4B B0 DB 8C */	b mDoMtx_YrotS__FPA4_fs
/* 804FE854 0000001C  80 79 00 00 */	lwz r3, 0(r25)	/* effective address: 80450768 */
/* 804FE858 00000020  7F 04 C3 78 */	mr r4, r24
/* 804FE85C 00000024  4B B0 DB 40 */	b mDoMtx_XrotM__FPA4_fs
/* 804FE860 00000028  38 61 00 38 */	addi r3, r1, 0x38
/* 804FE864 0000002C  38 81 00 2C */	addi r4, r1, 0x2c
/* 804FE868 00000030  4B D7 26 84 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 804FE878 00000040  4B D6 82 6C */	b __pl__4cXyzCFRC3Vec
...
/* 804FE8E4 00000008  4B E6 39 2C */	b _restgpr_23

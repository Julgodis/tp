...
/* 804FF224  4B E6 2F 9C */	b _savegpr_22
/* 804FF228  7C 79 1B 78 */	mr r25, r3
/* 804FF22C  7C 9A 23 78 */	mr r26, r4
/* 804FF230  3C 60 80 50 */	lis r3, lit_3788@ha
/* 804FF234  3B A3 0B 04 */	addi r29, r3, lit_3788@l
...
/* 804FF280  4B D7 07 BC */	b cLib_addCalc2__FPffff
/* 804FF284  3B 60 00 00 */	li r27, 0
/* 804FF288  3B 00 00 00 */	li r24, 0
/* 804FF28C  3A E0 00 00 */	li r23, 0
/* 804FF290  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 804FF294  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
lbl_804FF298:
...
/* 804FF2F4  4B B4 E1 D8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804FF30C  4B B4 C6 0C */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804FF320  4B D7 F9 40 */	b deleteAllParticle__14JPABaseEmitterFv
/* 804FF324  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)
/* 804FF328  38 63 02 10 */	addi r3, r3, 0x210
/* 804FF32C  7C 99 B0 2E */	lwzx r4, r25, r22
/* 804FF330  4B B4 C5 84 */	b forceOnEventMove__Q213dPa_control_c7level_cFUl
...
/* 804FF354  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804FF358  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804FF35C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804FF360  4B E4 71 50 */	b PSMTXCopy
...
/* 804FF374  4B D7 1B 30 */	b MtxScale__FfffUc
/* 804FF378  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FF37C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FF380  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FF384  38 9F 00 68 */	addi r4, r31, 0x68
/* 804FF388  38 BF 00 98 */	addi r5, r31, 0x98
/* 804FF38C  38 DF 00 A4 */	addi r6, r31, 0xa4
/* 804FF390  4B D8 14 78 */	b func_80280808
...
/* 804FF3F8  4B B1 E8 C4 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 804FF3FC  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 804FF400  41 82 00 10 */	beq lbl_804FF410
/* 804FF404  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 804FF408  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 804FF45C  4B B4 E0 70 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804FF4BC  4B B4 E0 10 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804FF4D0  4B B4 C4 48 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804FF4E8  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804FF4EC  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804FF4F0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804FF4F4  4B E4 6F BC */	b PSMTXCopy
/* 804FF4F8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FF4FC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FF500  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FF504  38 97 00 68 */	addi r4, r23, 0x68
/* 804FF508  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 804FF50C  4B D8 12 D4 */	b func_802807E0
...
/* 804FF568  4B B4 DF 64 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 804FF57C  4B B4 C3 9C */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 804FF594  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 804FF598  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 804FF59C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 804FF5A0  4B E4 6F 10 */	b PSMTXCopy
/* 804FF5A4  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804FF5A8  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804FF5AC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804FF5B0  38 97 00 68 */	addi r4, r23, 0x68
/* 804FF5B4  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 804FF5B8  4B D8 12 28 */	b func_802807E0
lbl_804FF5BC:
/* 804FF5BC  38 00 00 00 */	li r0, 0
/* 804FF5C0  98 19 12 31 */	stb r0, 0x1231(r25)
lbl_804FF5C4:
/* 804FF5C4  39 61 00 60 */	addi r11, r1, 0x60
/* 804FF5C8  4B E6 2C 44 */	b _restgpr_22

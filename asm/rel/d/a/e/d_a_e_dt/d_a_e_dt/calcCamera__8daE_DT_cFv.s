...
/* 806B3B18  4B CA E6 C0 */	b _savegpr_28
/* 806B3B1C  7C 7F 1B 78 */	mr r31, r3
/* 806B3B20  3C 60 80 6B */	lis r3, lit_3792@ha
/* 806B3B24  3B C3 5C D4 */	addi r30, r3, lit_3792@l
/* 806B3B28  38 61 00 B4 */	addi r3, r1, 0xb4
/* 806B3B2C  4B 9C 41 3C */	b __ct__11dBgS_LinChkFv
/* 806B3B30  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806B3B34  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 806B3B38  80 9C 5D AC */	lwz r4, 0x5dac(r28)	/* effective address: 8040BF6C */
...
/* 806B3B54  88 1C 5D B0 */	lbz r0, 0x5db0(r28)	/* effective address: 8040BF70 */
...
/* 806B3BA4  4B 96 6B 6C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806B3BA8  7C 64 1B 78 */	mr r4, r3
/* 806B3BAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3BB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3BB4  4B 95 88 28 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B3BD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3BD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3BD8  38 81 00 60 */	addi r4, r1, 0x60
/* 806B3BDC  38 A1 00 54 */	addi r5, r1, 0x54
/* 806B3BE0  4B C9 31 8C */	b PSMTXMultVec
/* 806B3BE4  38 61 00 54 */	addi r3, r1, 0x54
/* 806B3BE8  38 81 00 78 */	addi r4, r1, 0x78
/* 806B3BEC  7C 65 1B 78 */	mr r5, r3
/* 806B3BF0  4B C9 34 A0 */	b PSVECAdd
...
/* 806B3C04  4B 9C 41 60 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806B3C08  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806B3C0C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806B3C10  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806B3C14  38 81 00 B4 */	addi r4, r1, 0xb4
/* 806B3C18  4B 9C 07 9C */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 806B3C48  4B 96 6A C8 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806B3C4C  7C 64 1B 78 */	mr r4, r3
/* 806B3C50  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3C54  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3C58  4B 95 87 84 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B3C74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3C78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3C7C  38 81 00 60 */	addi r4, r1, 0x60
/* 806B3C80  38 A1 00 54 */	addi r5, r1, 0x54
/* 806B3C84  4B C9 30 E8 */	b PSMTXMultVec
/* 806B3C88  38 61 00 54 */	addi r3, r1, 0x54
/* 806B3C8C  38 81 00 78 */	addi r4, r1, 0x78
/* 806B3C90  7C 65 1B 78 */	mr r5, r3
/* 806B3C94  4B C9 33 FC */	b PSVECAdd
lbl_806B3C98:
...
/* 806B3CA8  4B AA D8 28 */	b Stop__9dCamera_cFv
/* 806B3CAC  3C 60 80 6B */	lis r3, l_HIO@ha
/* 806B3CB0  38 63 62 AC */	addi r3, r3, l_HIO@l
/* 806B3CB4  C0 03 00 28 */	lfs f0, 0x28(r3)	/* effective address: 806B62D4 */
...
/* 806B3D18  4B 9C 3F C4 */	b __dt__11dBgS_LinChkFv
...
/* 806B3D54  4B BB CE B0 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806B3D58  7C 64 07 34 */	extsh r4, r3
/* 806B3D5C  38 61 00 08 */	addi r3, r1, 8
/* 806B3D60  4B BB D2 38 */	b __ct__7cSAngleFs
...
/* 806B3DA8  4B AC CD 00 */	b Set__9dCamera_cF4cXyz4cXyz
/* 806B3DAC  48 00 03 08 */	b lbl_806B40B4
lbl_806B3DB0:
/* 806B3DB0  7F E3 FB 78 */	mr r3, r31
/* 806B3DB4  80 9C 5D AC */	lwz r4, 0x5dac(r28)
/* 806B3DB8  4B 96 69 58 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806B3DBC  7C 64 1B 78 */	mr r4, r3
/* 806B3DC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3DC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3DC8  4B 95 86 14 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B3E44  4B AC CD D4 */	b Reset__9dCamera_cF4cXyz4cXyz
/* 806B3E48  38 7D 02 48 */	addi r3, r29, 0x248
/* 806B3E4C  4B AA D6 60 */	b Start__9dCamera_cFv
...
/* 806B3E60  4B AA D6 70 */	b Stop__9dCamera_cFv
...
/* 806B3E9C  4B BB CF 24 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 806B3EA0  38 61 00 90 */	addi r3, r1, 0x90
/* 806B3EA4  38 81 00 78 */	addi r4, r1, 0x78
/* 806B3EA8  4B BB CD 5C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806B3EAC  7C 7C 07 34 */	extsh r28, r3
/* 806B3EB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3EB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3EB8  7F 84 E3 78 */	mr r4, r28
/* 806B3EBC  4B 95 85 20 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B3ED8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3EDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3EE0  38 81 00 60 */	addi r4, r1, 0x60
/* 806B3EE4  38 A1 00 9C */	addi r5, r1, 0x9c
/* 806B3EE8  4B C9 2E 84 */	b PSMTXMultVec
/* 806B3EEC  38 61 00 9C */	addi r3, r1, 0x9c
/* 806B3EF0  38 81 00 78 */	addi r4, r1, 0x78
/* 806B3EF4  7C 65 1B 78 */	mr r5, r3
/* 806B3EF8  4B C9 31 98 */	b PSVECAdd
/* 806B3EFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3F00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3F04  7F 84 E3 78 */	mr r4, r28
/* 806B3F08  4B 95 84 D4 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B3F20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3F24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3F28  38 81 00 60 */	addi r4, r1, 0x60
/* 806B3F2C  38 A1 00 A8 */	addi r5, r1, 0xa8
/* 806B3F30  4B C9 2E 3C */	b PSMTXMultVec
/* 806B3F34  38 61 00 A8 */	addi r3, r1, 0xa8
/* 806B3F38  38 81 00 90 */	addi r4, r1, 0x90
/* 806B3F3C  7C 65 1B 78 */	mr r5, r3
/* 806B3F40  4B C9 31 50 */	b PSVECAdd
...
/* 806B3F54  4B 9C 3E 10 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806B3F58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806B3F5C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806B3F60  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806B3F64  38 81 00 B4 */	addi r4, r1, 0xb4
/* 806B3F68  4B 9C 04 4C */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 806B3FA8  4B BB CE 18 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 806B3FAC  38 61 00 90 */	addi r3, r1, 0x90
/* 806B3FB0  38 81 00 78 */	addi r4, r1, 0x78
/* 806B3FB4  4B BB CC 50 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806B3FB8  A8 1F 07 3A */	lha r0, 0x73a(r31)
/* 806B3FBC  7C 00 1A 14 */	add r0, r0, r3
/* 806B3FC0  7C 1C 07 34 */	extsh r28, r0
/* 806B3FC4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3FC8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3FCC  7F 84 E3 78 */	mr r4, r28
/* 806B3FD0  4B 95 84 0C */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B3FEC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B3FF0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B3FF4  38 81 00 60 */	addi r4, r1, 0x60
/* 806B3FF8  38 A1 00 54 */	addi r5, r1, 0x54
/* 806B3FFC  4B C9 2D 70 */	b PSMTXMultVec
/* 806B4000  38 61 00 54 */	addi r3, r1, 0x54
/* 806B4004  38 81 00 78 */	addi r4, r1, 0x78
/* 806B4008  7C 65 1B 78 */	mr r5, r3
/* 806B400C  4B C9 30 84 */	b PSVECAdd
/* 806B4010  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B4014  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B4018  7F 84 E3 78 */	mr r4, r28
/* 806B401C  4B 95 83 C0 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806B4034  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806B4038  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806B403C  38 81 00 60 */	addi r4, r1, 0x60
/* 806B4040  38 A1 00 6C */	addi r5, r1, 0x6c
/* 806B4044  4B C9 2D 28 */	b PSMTXMultVec
/* 806B4048  38 61 00 6C */	addi r3, r1, 0x6c
/* 806B404C  38 81 00 90 */	addi r4, r1, 0x90
/* 806B4050  7C 65 1B 78 */	mr r5, r3
/* 806B4054  4B C9 30 3C */	b PSVECAdd
...
/* 806B409C  4B AC CA 44 */	b Set__9dCamera_cF4cXyz4cXyzfs
/* 806B40A0  48 00 00 14 */	b lbl_806B40B4
lbl_806B40A4:
/* 806B40A4  38 7D 02 48 */	addi r3, r29, 0x248
/* 806B40A8  4B AA D4 04 */	b Start__9dCamera_cFv
...
/* 806B40BC  4B 9C 3C 20 */	b __dt__11dBgS_LinChkFv
lbl_806B40C0:
/* 806B40C0  39 61 01 40 */	addi r11, r1, 0x140
/* 806B40C4  4B CA E1 60 */	b _restgpr_28

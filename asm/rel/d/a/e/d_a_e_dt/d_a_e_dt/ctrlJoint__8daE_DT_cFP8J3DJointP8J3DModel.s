...
/* 806AD9B4 00000024  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806AD9B8 00000028  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 806AD9C8 00000038  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 806AD9CC 0000003C  38 A3 00 00 */	addi r5, r3, sincosTable___5JMath@l /* 80439A20 */
/* 806AD9D0 00000040  7C 45 04 2E */	lfsx f2, r5, r0
/* 806AD9D4 00000044  3C 60 00 00 */	lis r3, lit_3868@ha /* 806B5CFC */
/* 806AD9D8 00000048  C0 23 00 00 */	lfs f1, lit_3868@l(r3) /* 806B5CFC */
...
/* 806AD9F8 00000068  3C 60 00 00 */	lis r3, lit_3870@ha /* 806B5D04 */
/* 806AD9FC 0000006C  C8 43 00 00 */	lfd f2, lit_3870@l(r3) /* 806B5D04 */
...
/* 806ADA64 000000D4  3C 60 00 00 */	lis r3, lit_3874@ha /* 806B5FBC */
/* 806ADA68 000000D8  38 63 00 00 */	addi r3, r3, lit_3874@l /* 806B5FBC */
...
/* 806ADA84 00000008  4B FF FD F5 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806ADA88 0000000C  3C 60 00 00 */	lis r3, lit_3868@ha /* 806B5CFC */
/* 806ADA8C 00000010  C0 23 00 00 */	lfs f1, lit_3868@l(r3) /* 806B5CFC */
/* 806ADA90 00000014  FC 40 08 90 */	fmr f2, f1
/* 806ADA94 00000018  FC 60 F8 90 */	fmr f3, f31
/* 806ADA98 0000001C  4B FF FD E1 */	bl scaleM__14mDoMtx_stack_cFfff
...
/* 806ADAAC 0000000C  4B FF FD CD */	bl scaleM__14mDoMtx_stack_cFfff
/* 806ADAB0 00000010  3C 60 00 00 */	lis r3, lit_3868@ha /* 806B5CFC */
/* 806ADAB4 00000014  C0 23 00 00 */	lfs f1, lit_3868@l(r3) /* 806B5CFC */
/* 806ADAB8 00000018  FC 40 08 90 */	fmr f2, f1
/* 806ADABC 0000001C  FC 60 F8 90 */	fmr f3, f31
/* 806ADAC0 00000020  4B FF FD B9 */	bl scaleM__14mDoMtx_stack_cFfff
/* 806ADAC4 00000024  48 00 00 8C */	b lbl_806ADB50
lbl_806ADAC8:
/* 806ADAC8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADACC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADAD0 00000008  4B FF FD A9 */	bl mDoMtx_YrotM__FPA4_fs
/* 806ADAD4 0000000C  48 00 00 7C */	b lbl_806ADB50
lbl_806ADAD8:
/* 806ADAD8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADADC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADAE0 00000008  7C 04 00 D0 */	neg r0, r4
/* 806ADAE4 0000000C  7C 04 07 34 */	extsh r4, r0
/* 806ADAE8 00000010  4B FF FD 91 */	bl mDoMtx_YrotM__FPA4_fs
/* 806ADAEC 00000014  48 00 00 64 */	b lbl_806ADB50
lbl_806ADAF0:
/* 806ADAF0 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADAF4 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADAF8 00000008  7C A4 2B 78 */	mr r4, r5
/* 806ADAFC 0000000C  4B FF FD 7D */	bl mDoMtx_YrotM__FPA4_fs
/* 806ADB00 00000010  48 00 00 50 */	b lbl_806ADB50
lbl_806ADB04:
/* 806ADB04 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADB08 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADB0C 00000008  7C 05 00 D0 */	neg r0, r5
/* 806ADB10 0000000C  7C 04 07 34 */	extsh r4, r0
/* 806ADB14 00000010  4B FF FD 65 */	bl mDoMtx_YrotM__FPA4_fs
/* 806ADB18 00000014  48 00 00 38 */	b lbl_806ADB50
lbl_806ADB1C:
/* 806ADB1C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADB20 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADB24 00000008  A8 9C 07 34 */	lha r4, 0x734(r28)
/* 806ADB28 0000000C  4B FF FD 51 */	bl mDoMtx_ZrotM__FPA4_fs
/* 806ADB2C 00000010  48 00 00 24 */	b lbl_806ADB50
lbl_806ADB30:
/* 806ADB30 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADB34 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADB38 00000008  A8 9C 07 44 */	lha r4, 0x744(r28)
/* 806ADB3C 0000000C  4B FF FD 3D */	bl mDoMtx_YrotM__FPA4_fs
/* 806ADB40 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADB44 00000014  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADB48 00000018  A8 9C 07 42 */	lha r4, 0x742(r28)
/* 806ADB4C 0000001C  4B FF FD 2D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_806ADB50:
/* 806ADB50 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADB54 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 806ADB68 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806ADB6C 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806ADB70 00000020  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 806ADB74 00000024  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */

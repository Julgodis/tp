...
/* 806B40F0  3C 60 80 6B */	lis r3, lit_3792@ha
/* 806B40F4  3B E3 5C D4 */	addi r31, r3, lit_3792@l
...
/* 806B4134  4B C9 2F 5C */	b PSVECAdd
...
/* 806B41D4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806B41D8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806B41DC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806B4204  4B BF 77 80 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806B4224  4B C9 2F 14 */	b PSVECSquareMag
...
/* 806B4294  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806B4298  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 806B4304  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806B4308  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 806B430C  48 00 00 08 */	b lbl_806B4314
lbl_806B4310:
/* 806B4310  FC 40 08 90 */	fmr f2, f1
lbl_806B4314:
/* 806B4314  C0 3E 06 BC */	lfs f1, 0x6bc(r30)
/* 806B4318  4B BB 33 5C */	b cM_atan2s__Fff
...
/* 806B4334  4B BB C2 0C */	b cLib_addCalcAngleS__FPsssss
...
/* 806B434C  4B BB C1 F4 */	b cLib_addCalcAngleS__FPsssss
...
/* 806B4364  4B BB C1 DC */	b cLib_addCalcAngleS__FPsssss
...
/* 806B4394  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806B4398  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 806B44AC  4B BB C6 E4 */	b cLib_chaseAngleS__FPsss
...
/* 806B44FC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806B4500  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806B4504  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806B4508  7C 05 07 74 */	extsb r5, r0
/* 806B450C  4B 98 0E 54 */	b isSwitch__10dSv_info_cCFii
/* 806B4510  2C 03 00 00 */	cmpwi r3, 0
/* 806B4514  40 82 00 1C */	bne lbl_806B4530
/* 806B4518  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806B451C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806B4520  88 9E 07 7A */	lbz r4, 0x77a(r30)
/* 806B4524  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806B4528  7C 05 07 74 */	extsb r5, r0
/* 806B452C  4B 98 0C D4 */	b onSwitch__10dSv_info_cFii
lbl_806B4530:
...
/* 806B4554  4B BB BF EC */	b cLib_addCalcAngleS__FPsssss
...
/* 806B456C  4B BB BF D4 */	b cLib_addCalcAngleS__FPsssss
...
/* 806B45E0  4B BB BF 60 */	b cLib_addCalcAngleS__FPsssss
...
/* 806B45F8  4B BB BF 48 */	b cLib_addCalcAngleS__FPsssss
...
/* 806B46B4  4B BB C0 8C */	b cLib_chaseF__FPfff
...
/* 806B46D0  4B BB C0 70 */	b cLib_chaseF__FPfff
...
/* 806B46EC  4B BB C0 54 */	b cLib_chaseF__FPfff
...
/* 806B4708  4B BB C0 38 */	b cLib_chaseF__FPfff
lbl_806B470C:

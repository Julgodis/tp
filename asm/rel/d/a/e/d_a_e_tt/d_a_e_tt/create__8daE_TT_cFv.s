...
/* 807C13CC 00000018  3C 80 00 00 */	lis r4, lit_3908@ha /* 807C1FB8 */
/* 807C13D0 0000001C  3B E4 00 00 */	addi r31, r4, lit_3908@l /* 807C1FB8 */
...
/* 807C1404 00000050  3C 60 00 00 */	lis r3, __vt__14dBgS_ObjGndChk@ha /* 807C235C */
/* 807C1408 00000054  38 63 00 00 */	addi r3, r3, __vt__14dBgS_ObjGndChk@l /* 807C235C */
...
/* 807C1430 0000007C  3C 60 00 00 */	lis r3, __vt__18dBgS_ObjGndChk_All@ha /* 803AB6E8 */
/* 807C1434 00000080  38 63 00 00 */	addi r3, r3, __vt__18dBgS_ObjGndChk_All@l /* 803AB6E8 */
...
/* 807C1474 000000C0  3C 60 00 00 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 807C2338 */
/* 807C1478 000000C4  38 63 00 00 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 807C2338 */
...
/* 807C1498 000000E4  3C 60 00 00 */	lis r3, __vt__9cCcD_Stts@ha /* 803C3728 */
/* 807C149C 000000E8  38 03 00 00 */	addi r0, r3, __vt__9cCcD_Stts@l /* 803C3728 */
...
/* 807C14AC 000000F8  3C 60 00 00 */	lis r3, __vt__9dCcD_Stts@ha /* 803AC2E4 */
/* 807C14B0 000000FC  38 63 00 00 */	addi r3, r3, __vt__9dCcD_Stts@l /* 803AC2E4 */
...
/* 807C14CC 00000118  3C 60 00 00 */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 803C36D0 */
/* 807C14D0 0000011C  38 03 00 00 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 803C36D0 */
/* 807C14D4 00000120  90 1C 01 20 */	stw r0, 0x120(r28)
/* 807C14D8 00000124  3C 60 00 00 */	lis r3, __vt__8cM3dGAab@ha /* 807C232C */
/* 807C14DC 00000128  38 03 00 00 */	addi r0, r3, __vt__8cM3dGAab@l /* 807C232C */
/* 807C14E0 0000012C  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 807C14E4 00000130  3C 60 00 00 */	lis r3, __vt__8cM3dGSph@ha /* 807C2320 */
/* 807C14E8 00000134  38 03 00 00 */	addi r0, r3, __vt__8cM3dGSph@l /* 807C2320 */
/* 807C14EC 00000138  90 1C 01 34 */	stw r0, 0x134(r28)
/* 807C14F0 0000013C  3C 60 00 00 */	lis r3, __vt__12cCcD_SphAttr@ha /* 803C3540 */
/* 807C14F4 00000140  38 63 00 00 */	addi r3, r3, __vt__12cCcD_SphAttr@l /* 803C3540 */
...
/* 807C1504 00000150  3C 60 00 00 */	lis r3, __vt__8dCcD_Sph@ha /* 803ABFC0 */
/* 807C1508 00000154  38 63 00 00 */	addi r3, r3, __vt__8dCcD_Sph@l /* 803ABFC0 */
...
/* 807C1540 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807C1544 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 807C1590 0000000C  3C 60 00 00 */	lis r3, stringBase0@ha /* 807C20B0 */
/* 807C1594 00000010  38 63 00 00 */	addi r3, r3, stringBase0@l /* 807C20B0 */
...
lbl_807C15A4:
/* 807C15A4 00000000  3C 60 00 00 */	lis r3, stringBase0@ha /* 807C20B0 */
/* 807C15A8 00000004  38 63 00 00 */	addi r3, r3, stringBase0@l /* 807C20B0 */
...
/* 807C1630 0000001C  3C 80 00 00 */	lis r4, stringBase0@ha /* 807C20B0 */
/* 807C1634 00000020  38 84 00 00 */	addi r4, r4, stringBase0@l /* 807C20B0 */
...
/* 807C164C 00000038  3C 80 00 00 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 807C1394 */
/* 807C1650 0000003C  38 84 00 00 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 807C1394 */
...
lbl_807C166C:
/* 807C166C 00000000  3C 60 00 00 */	lis r3, struct_807C23DC+0x1@ha /* 807C23DD */
/* 807C1670 00000004  8C 03 00 00 */	lbzu r0, struct_807C23DC+0x1@l(r3) /* 807C23DD */
...
/* 807C168C 00000020  3C 60 00 00 */	lis r3, l_HIO@ha /* 807C23EC */
/* 807C1690 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l /* 807C23EC */
...
/* 807C174C 000000B4  3C 80 00 00 */	lis r4, data_807C2100@ha /* 807C2100 */
/* 807C1750 000000B8  38 84 00 00 */	addi r4, r4, data_807C2100@l /* 807C2100 */
...
/* 807C177C 000000E4  3C 80 00 00 */	lis r4, stringBase0@ha /* 807C20B0 */
/* 807C1780 000000E8  38 84 00 00 */	addi r4, r4, stringBase0@l /* 807C20B0 */

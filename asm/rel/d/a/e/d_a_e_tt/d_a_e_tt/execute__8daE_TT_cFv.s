...
/* 807C103C 00000018  3C 60 80 7C */	lis r3, lit_3908@ha
/* 807C1040 0000001C  3B C3 1F B8 */	addi r30, r3, lit_3908@l
...
/* 807C10C0 0000002C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807C10C4 00000030  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807C10C8 00000034  4B B8 53 E8 */	b PSMTXCopy
/* 807C10CC 00000038  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 807C1FBC */
/* 807C10D0 0000003C  C0 5E 00 78 */	lfs f2, 0x78(r30)	/* effective address: 807C2030 */
/* 807C10D4 00000040  FC 60 08 90 */	fmr f3, f1
/* 807C10D8 00000044  4B 84 BC C4 */	b transM__14mDoMtx_stack_cFfff
/* 807C10DC 00000048  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C10E0 0000004C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C10E4 00000050  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 807C10E8 00000054  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 807C10EC 00000058  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 807C10F0 0000005C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 807C10F4 00000060  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 807C10F8 00000064  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 807C10FC 00000068  C0 1E 00 08 */	lfs f0, 8(r30)	/* effective address: 807C1FC0 */

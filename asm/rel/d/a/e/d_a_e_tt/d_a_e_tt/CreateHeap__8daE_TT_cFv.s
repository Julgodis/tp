...
/* 807C122C 00000010  4B FF C4 ED */	bl _savegpr_29
...
/* 807C1248 0000002C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807C124C 00000030  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 807C125C 00000040  4B FF C4 BD */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807C1270 00000008  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807C1274 0000000C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 807C1284 0000001C  4B FF C4 95 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 807C1288 00000020  7C 7D 1B 78 */	mr r29, r3
lbl_807C128C:
/* 807C128C 00000000  38 60 00 58 */	li r3, 0x58
/* 807C1290 00000004  4B FF C4 89 */	bl __nw__FUl
/* 807C1294 00000008  7C 7E 1B 79 */	or. r30, r3, r3
/* 807C1298 0000000C  41 82 00 74 */	beq lbl_807C130C
/* 807C129C 00000010  3C 60 00 00 */	lis r3, stringBase0@ha /* 807C20B0 */
/* 807C12A0 00000014  38 63 00 00 */	addi r3, r3, stringBase0@l /* 807C20B0 */
/* 807C12A4 00000018  38 80 00 0E */	li r4, 0xe
/* 807C12A8 0000001C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807C12AC 00000020  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 807C12BC 00000030  4B FF C4 5D */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807C12F4 00000068  3D 20 00 00 */	lis r9, lit_3910@ha /* 807C1FC0 */
/* 807C12F8 0000006C  C0 29 00 00 */	lfs f1, lit_3910@l(r9) /* 807C1FC0 */
/* 807C12FC 00000070  39 20 00 00 */	li r9, 0
/* 807C1300 00000074  39 40 FF FF */	li r10, -1
/* 807C1304 00000078  4B FF C4 15 */	bl __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 807C1344 00000014  3C 60 00 00 */	lis r3, JointCallBack__8daE_TT_cFP8J3DJointi@ha /* 807BD8E0 */
/* 807C1348 00000018  38 83 00 00 */	addi r4, r3, JointCallBack__8daE_TT_cFP8J3DJointi@l /* 807BD8E0 */
...
/* 807C1380 00000004  4B FF C3 99 */	bl _restgpr_29

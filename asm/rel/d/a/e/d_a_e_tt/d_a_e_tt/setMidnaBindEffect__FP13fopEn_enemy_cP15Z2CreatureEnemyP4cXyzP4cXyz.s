...
/* 807C1B64  4B BA 06 50 */	b _savegpr_19
/* 807C1B68  7C 7E 1B 78 */	mr r30, r3
/* 807C1B6C  7C 9A 23 78 */	mr r26, r4
/* 807C1B70  7C BB 2B 78 */	mr r27, r5
/* 807C1B74  7C DC 33 78 */	mr r28, r6
/* 807C1B78  3C 60 80 7C */	lis r3, cNullVec__6Z2Calc@ha
/* 807C1B7C  3A E3 20 C8 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 807C1B80  3C 60 80 7C */	lis r3, lit_3908@ha
/* 807C1B84  3B E3 1F B8 */	addi r31, r3, lit_3908@l
/* 807C1B88  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807C1B8C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807C1B90  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807C1B94  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 807C1B98  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 807C1BC0  4B 9E A9 BC */	b dKy_darkworld_check__Fv
...
/* 807C1BE4  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 807C1BE8  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 807C1BEC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 807C1BF0  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 807C1BF4  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 807C1BF8  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 807C1BFC  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 807C1C00  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807C1C04  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807C1C08  4B B8 48 A8 */	b PSMTXCopy
...
/* 807C1C20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C1C24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C1C28  38 81 00 4C */	addi r4, r1, 0x4c
/* 807C1C2C  38 A1 00 58 */	addi r5, r1, 0x58
/* 807C1C30  4B B8 51 3C */	b PSMTXMultVec
/* 807C1C34  38 61 00 34 */	addi r3, r1, 0x34
/* 807C1C38  38 81 00 58 */	addi r4, r1, 0x58
/* 807C1C3C  7F 65 DB 78 */	mr r5, r27
/* 807C1C40  4B AA 4E F4 */	b __mi__4cXyzCFRC3Vec
...
/* 807C1C5C  4B AA 5A 18 */	b cM_atan2s__Fff
...
/* 807C1C90  4B AA 59 E4 */	b cM_atan2s__Fff
...
/* 807C1CAC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807C1CB0  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 807C1CB4  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 807C1D00  4B 88 AD 90 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807C1D04  7C 79 1B 79 */	or. r25, r3, r3
/* 807C1D08  41 82 00 FC */	beq lbl_807C1E04
/* 807C1D0C  38 61 00 40 */	addi r3, r1, 0x40
/* 807C1D10  4B B8 54 28 */	b PSVECSquareMag
...
/* 807C1D80  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807C1D84  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807C1DF0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807C1DF4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807C1DF8:
...
/* 807C1E48  4B 88 AC 48 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807C1E84  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807C1E88  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 807C1EB4  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 807C1EF4  4B 88 B5 D8 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807C1F54  4B BA 02 AC */	b _restgpr_19

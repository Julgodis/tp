...
/* 807C034C  4B BA 1E 90 */	b _savegpr_29
/* 807C0350  7C 7E 1B 78 */	mr r30, r3
/* 807C0354  3C 80 80 7C */	lis r4, lit_3908@ha
/* 807C0358  3B E4 1F B8 */	addi r31, r4, lit_3908@l
...
/* 807C03A0  4B B6 80 8C */	b checkPass__12J3DFrameCtrlFf
...
/* 807C03D8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807C03DC  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 807C03E0  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 807C03E4  4B 85 A3 2C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807C03FC  4B AB 01 44 */	b cLib_addCalcAngleS__FPsssss
...
/* 807C0454  4B 85 A5 10 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807C0480  4B 85 A4 E4 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807C04A4  4B 85 A2 6C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807C04DC  3C 60 80 7C */	lis r3, l_HIO@ha
/* 807C04E0  38 63 23 EC */	addi r3, r3, l_HIO@l
/* 807C04E4  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 807C2400 */
/* 807C04E8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 807C04EC  40 81 00 2C */	ble lbl_807C0518
/* 807C04F0  3C 60 80 7C */	lis r3, m_attack_tt@ha
/* 807C04F4  80 03 24 04 */	lwz r0, m_attack_tt@l(r3)
...
/* 807C0510  3C 60 80 7C */	lis r3, m_attack_tt@ha
/* 807C0514  93 C3 24 04 */	stw r30, m_attack_tt@l(r3)
lbl_807C0518:
/* 807C0518  39 61 00 30 */	addi r11, r1, 0x30
/* 807C051C  4B BA 1D 0C */	b _restgpr_29

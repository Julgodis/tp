...
/* 8069F988  4B CC 28 3C */	b _savegpr_23
/* 8069F98C  7C 7D 1B 78 */	mr r29, r3
/* 8069F990  3C 80 80 6A */	lis r4, lit_3902@ha
/* 8069F994  3B C4 19 0C */	addi r30, r4, lit_3902@l
/* 8069F998  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8069F99C  3B E4 61 C0 */	addi r31, r4, struct_804061C0+0x0@l
/* 8069F9A0  83 5F 5D AC */	lwz r26, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 8069F9A4  7F 44 D3 78 */	mr r4, r26
/* 8069F9A8  4B 97 AD 68 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8069F9BC  4B BC 71 78 */	b __mi__4cXyzCFRC3Vec
/* 8069F9C0  38 61 00 2C */	addi r3, r1, 0x2c
/* 8069F9C4  4B CA 77 74 */	b PSVECSquareMag
...
/* 8069FA34  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8069FA38  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8069FAA4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8069FAA8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8069FAAC:
...
/* 8069FB30  3C 60 80 6A */	lis r3, lit_5647@ha
/* 8069FB34  38 63 1B 94 */	addi r3, r3, lit_5647@l
...
/* 8069FCA8  4B C2 1E D4 */	b setLinkSearch__15Z2CreatureEnemyFb
/* 8069FCAC  48 00 00 10 */	b lbl_8069FCBC
lbl_8069FCB0:
/* 8069FCB0  38 7D 05 BC */	addi r3, r29, 0x5bc
/* 8069FCB4  38 80 00 00 */	li r4, 0
/* 8069FCB8  4B C2 1E C4 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_8069FCBC:
...
/* 8069FCF8  4B BC 6E 3C */	b __mi__4cXyzCFRC3Vec
...
/* 8069FD18  4B CA 74 20 */	b PSVECSquareMag
...
/* 8069FD88  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8069FD8C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8069FDF8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8069FDFC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8069FE00:
...
/* 8069FE38  4B BC FC 04 */	b cLib_addCalc2__FPffff
...
/* 8069FE64  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8069FE68  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8069FE6C  38 81 00 10 */	addi r4, r1, 0x10
/* 8069FE70  4B 97 99 88 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8069FE8C  4B 97 07 3C */	b play__14mDoExt_McaMorfFP3VecUlSc
lbl_8069FE90:
...
/* 8069FEA0  4B BC FB 9C */	b cLib_addCalc2__FPffff
...
/* 8069FEE4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069FEE8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8069FF40  4B BC F7 08 */	b SetC__8cM3dGSphFRC4cXyz
/* 8069FF44  7F E3 FB 78 */	mr r3, r31
/* 8069FF48  C0 3E 00 4C */	lfs f1, 0x4c(r30)
/* 8069FF4C  4B BC F7 BC */	b SetR__8cM3dGSphFf
...
/* 8069FFA8  4B BC FA D8 */	b cLib_addCalc0__FPfff
...
/* 8069FFE8  4B CC 22 28 */	b _restgpr_23

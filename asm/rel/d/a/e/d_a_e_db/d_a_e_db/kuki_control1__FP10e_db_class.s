...
/* 8069DBA8 0000000C  4B CC 46 1C */	b _savegpr_23
/* 8069DBAC 00000010  7C 7D 1B 78 */	mr r29, r3
/* 8069DBB0 00000014  3C 60 80 6A */	lis r3, lit_3902@ha
/* 8069DBB4 00000018  38 63 19 0C */	addi r3, r3, lit_3902@l
...
/* 8069DBD0 00000034  C0 23 00 04 */	lfs f1, 4(r3)	/* effective address: 806A1910 */
...
/* 8069DBE4 00000048  C3 C3 00 38 */	lfs f30, 0x38(r3)	/* effective address: 806A1944 */
...
/* 8069DC04 00000068  C3 C3 00 A8 */	lfs f30, 0xa8(r3)	/* effective address: 806A19B4 */
/* 8069DC08 0000006C  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 8069DC0C 00000070  C0 03 00 E8 */	lfs f0, 0xe8(r3)	/* effective address: 806A19F4 */
...
/* 8069DC28 0000000C  C3 C3 00 A8 */	lfs f30, 0xa8(r3)	/* effective address: 806A19B4 */
/* 8069DC2C 00000010  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 8069DC30 00000014  C0 03 00 4C */	lfs f0, 0x4c(r3)	/* effective address: 806A1958 */
...
lbl_8069DC40:
/* 8069DC40 00000000  C0 03 00 EC */	lfs f0, 0xec(r3)	/* effective address: 806A19F8 */
...
/* 8069DC5C 00000014  C3 83 00 04 */	lfs f28, 4(r3)	/* effective address: 806A1910 */
/* 8069DC60 00000018  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069DC64 0000001C  3B 23 07 68 */	addi r25, r3, calc_mtx@l
lbl_8069DC68:
...
/* 8069DC8C 00000010  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8069DC90 00000014  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8069DCC8 00000010  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8069DCCC 00000014  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8069DCFC 00000044  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069DD00 00000048  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069DD04 0000004C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069DD08 00000050  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8069DD0C 00000054  4B 96 E6 D0 */	b mDoMtx_YrotS__FPA4_fs
/* 8069DD10 00000058  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069DD14 0000005C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069DD18 00000060  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069DD1C 00000064  3C 80 80 6A */	lis r4, data_806A1AB0@ha
/* 8069DD20 00000068  38 04 1A B0 */	addi r0, r4, data_806A1AB0@l
...
/* 8069DD38 00000080  4B 96 E6 64 */	b mDoMtx_XrotM__FPA4_fs
/* 8069DD3C 00000084  48 00 00 38 */	b lbl_8069DD74
lbl_8069DD40:
/* 8069DD40 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069DD44 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069DD48 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069DD4C 0000000C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 8069DD50 00000010  4B 96 E6 8C */	b mDoMtx_YrotS__FPA4_fs
/* 8069DD54 00000014  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069DD58 00000018  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069DD5C 0000001C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069DD60 00000020  3C 80 80 6A */	lis r4, data_806A1AB0@ha
/* 8069DD64 00000024  38 04 1A B0 */	addi r0, r4, data_806A1AB0@l
/* 8069DD68 00000028  7C 80 E2 14 */	add r4, r0, r28
/* 8069DD6C 0000002C  A8 84 FF FE */	lha r4, -2(r4)
/* 8069DD70 00000030  4B 96 E6 2C */	b mDoMtx_XrotM__FPA4_fs
lbl_8069DD74:
...
/* 8069DD84 00000010  4B BD 31 20 */	b MtxScale__FfffUc
/* 8069DD88 00000014  38 61 00 20 */	addi r3, r1, 0x20
/* 8069DD8C 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 8069DD90 0000001C  4B BD 31 5C */	b MtxPosition__FP4cXyzP4cXyz
lbl_8069DD94:
...
/* 8069DDE0 0000004C  4B BC 98 94 */	b cM_atan2s__Fff
...
/* 8069DE08 00000004  4B BC 98 6C */	b cM_atan2s__Fff
/* 8069DE0C 00000008  7C 03 00 D0 */	neg r0, r3
/* 8069DE10 0000000C  7C 18 07 34 */	extsh r24, r0
/* 8069DE14 00000010  80 79 00 00 */	lwz r3, 0(r25)	/* effective address: 80450768 */
/* 8069DE18 00000014  7E E4 BB 78 */	mr r4, r23
/* 8069DE1C 00000018  4B 96 E5 C0 */	b mDoMtx_YrotS__FPA4_fs
/* 8069DE20 0000001C  80 79 00 00 */	lwz r3, 0(r25)	/* effective address: 80450768 */
/* 8069DE24 00000020  7F 04 C3 78 */	mr r4, r24
/* 8069DE28 00000024  4B 96 E5 74 */	b mDoMtx_XrotM__FPA4_fs
/* 8069DE2C 00000028  38 61 00 38 */	addi r3, r1, 0x38
/* 8069DE30 0000002C  38 81 00 2C */	addi r4, r1, 0x2c
/* 8069DE34 00000030  4B BD 30 B8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8069DE44 00000040  4B BC 8C A0 */	b __pl__4cXyzCFRC3Vec
...
/* 8069DEB0 00000008  4B CC 43 60 */	b _restgpr_23

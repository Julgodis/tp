...
/* 806A147C  4B CC 0D 38 */	b _savegpr_19
/* 806A1480  7C 7E 1B 78 */	mr r30, r3
/* 806A1484  7C 9A 23 78 */	mr r26, r4
/* 806A1488  7C BB 2B 78 */	mr r27, r5
/* 806A148C  7C DC 33 78 */	mr r28, r6
/* 806A1490  3C 60 80 6A */	lis r3, cNullVec__6Z2Calc@ha
/* 806A1494  3A E3 1A 74 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806A1498  3C 60 80 6A */	lis r3, lit_3902@ha
/* 806A149C  3B E3 19 0C */	addi r31, r3, lit_3902@l
/* 806A14A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A14A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A14A8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806A14AC  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806A14B0  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806A14D8  4B B0 B0 A4 */	b dKy_darkworld_check__Fv
...
/* 806A14FC  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806A1500  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806A1504  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806A1508  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806A150C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806A1510  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806A1514  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806A1518  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806A151C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806A1520  4B CA 4F 90 */	b PSMTXCopy
...
/* 806A1538  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806A153C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806A1540  38 81 00 4C */	addi r4, r1, 0x4c
/* 806A1544  38 A1 00 58 */	addi r5, r1, 0x58
/* 806A1548  4B CA 58 24 */	b PSMTXMultVec
/* 806A154C  38 61 00 34 */	addi r3, r1, 0x34
/* 806A1550  38 81 00 58 */	addi r4, r1, 0x58
/* 806A1554  7F 65 DB 78 */	mr r5, r27
/* 806A1558  4B BC 55 DC */	b __mi__4cXyzCFRC3Vec
...
/* 806A1574  4B BC 61 00 */	b cM_atan2s__Fff
...
/* 806A15A8  4B BC 60 CC */	b cM_atan2s__Fff
...
/* 806A15C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A15C8  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806A15CC  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806A1618  4B 9A B4 78 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806A161C  7C 79 1B 79 */	or. r25, r3, r3
/* 806A1620  41 82 00 FC */	beq lbl_806A171C
/* 806A1624  38 61 00 40 */	addi r3, r1, 0x40
/* 806A1628  4B CA 5B 10 */	b PSVECSquareMag
...
/* 806A1698  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806A169C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806A1708  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806A170C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806A1710:
...
/* 806A1760  4B 9A B3 30 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A179C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A17A0  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806A17CC  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806A180C  4B 9A BC C0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806A186C  4B CC 09 94 */	b _restgpr_19

...
/* 8069AC00  4B CC 75 DC */	b _savegpr_29
...
/* 8069AC1C  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8069AC20  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8069AC24  38 81 00 08 */	addi r4, r1, 8
/* 8069AC28  4B 97 EB D0 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 8069AC2C  7C 7F 1B 79 */	or. r31, r3, r3
/* 8069AC30  41 82 00 5C */	beq lbl_8069AC8C
/* 8069AC34  3C 60 80 6A */	lis r3, stringBase0@ha
/* 8069AC38  38 63 1A 6C */	addi r3, r3, stringBase0@l
/* 8069AC3C  7F A4 EB 78 */	mr r4, r29
/* 8069AC40  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8069AC44  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8069AC48  3C A5 00 02 */	addis r5, r5, 2
/* 8069AC4C  38 C0 00 80 */	li r6, 0x80
/* 8069AC50  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8069AC54  4B 9A 16 98 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8069AC6C  3C C0 80 6A */	lis r6, lit_3903@ha
/* 8069AC70  C0 66 19 10 */	lfs f3, lit_3903@l(r6)
/* 8069AC74  3C C0 80 6A */	lis r6, lit_3938@ha
/* 8069AC78  C0 86 19 40 */	lfs f4, lit_3938@l(r6)
/* 8069AC7C  38 C0 00 00 */	li r6, 0
/* 8069AC80  4B 97 56 FC */	b setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv
...
/* 8069ACA4  4B CC 75 84 */	b _restgpr_29

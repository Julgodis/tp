...
/* 8069E524  4B CC 3C A0 */	b _savegpr_23
/* 8069E528  7C 7C 1B 78 */	mr r28, r3
/* 8069E52C  3C 60 80 6A */	lis r3, lit_3902@ha
/* 8069E530  3B C3 19 0C */	addi r30, r3, lit_3902@l
/* 8069E534  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069E538  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 8069E53C  83 7F 5D AC */	lwz r27, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 8069E540  38 00 00 00 */	li r0, 0
/* 8069E544  90 1C 10 10 */	stw r0, 0x1010(r28)
/* 8069E548  38 61 00 5C */	addi r3, r1, 0x5c
/* 8069E54C  4B 9D 92 64 */	b __ct__18dBgS_ObjGndChk_SplFv
...
/* 8069E57C  4B BC 97 AC */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 8069E580  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069E584  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8069E588  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 8069E58C  7F A3 EB 78 */	mr r3, r29
/* 8069E590  38 81 00 5C */	addi r4, r1, 0x5c
/* 8069E594  4B 9D 5F 0C */	b GroundCross__4cBgSFP11cBgS_GndChk
/* 8069E598  FF E0 08 90 */	fmr f31, f1
/* 8069E59C  7F 83 E3 78 */	mr r3, r28
/* 8069E5A0  80 9F 5D AC */	lwz r4, 0x5dac(r31)
/* 8069E5A4  4B 97 C2 3C */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8069E5C4  3C 60 80 6A */	lis r3, lit_5359@ha
/* 8069E5C8  38 63 1A C8 */	addi r3, r3, lit_5359@l
...
/* 8069E624  4B 9E 64 54 */	b StartCAt__8dCcD_SphFR4cXyz
/* 8069E628  C0 3E 00 00 */	lfs f1, 0(r30)
/* 8069E62C  4B BC 93 28 */	b cM_rndF__Ff
...
/* 8069E664  4B 97 E9 BC */	b fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 8069E67C  4B BD 1F 8C */	b cLib_addCalcAngleS2__FPssss
...
/* 8069E72C  4B BC 92 28 */	b cM_rndF__Ff
...
/* 8069E7A0  4B BC 83 94 */	b __mi__4cXyzCFRC3Vec
...
/* 8069E7C4  4B BC 8E B0 */	b cM_atan2s__Fff
...
/* 8069E7D8  4B BD 1E 30 */	b cLib_addCalcAngleS2__FPssss
/* 8069E7DC  38 61 00 50 */	addi r3, r1, 0x50
/* 8069E7E0  4B CA 89 58 */	b PSVECSquareMag
...
/* 8069E850  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8069E854  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8069E8C0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8069E8C4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8069E8C8:
...
/* 8069E93C  4B BD 11 44 */	b cLib_addCalc0__FPfff
...
/* 8069E958  4B BD 10 E4 */	b cLib_addCalc2__FPffff
...
/* 8069E974  4B BD 10 C8 */	b cLib_addCalc2__FPffff
...
/* 8069E988  4B BD 1C 80 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EA70  4B BC 8E E4 */	b cM_rndF__Ff
...
/* 8069EAB0  4B BD 1B 58 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EAC4  4B BD 1B 44 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EAFC  4B 9E 57 C4 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 8069EBC0  4B 97 E4 60 */	b fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 8069EC00  4B AC 08 F0 */	b setLookPos__9daPy_py_cFP4cXyz
...
/* 8069EC1C  4B 9D 7E 90 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8069EC48  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069EC4C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8069EC50  C0 23 5D C0 */	lfs f1, 0x5dc0(r3)	/* effective address: 8040BF80 */
/* 8069EC54  C0 1E 00 34 */	lfs f0, 0x34(r30)
/* 8069EC58  EC 01 00 2A */	fadds f0, f1, f0
/* 8069EC5C  D0 03 5D C0 */	stfs f0, 0x5dc0(r3)	/* effective address: 8040BF80 */
/* 8069EC60  38 00 00 00 */	li r0, 0
/* 8069EC64  98 03 5E B6 */	stb r0, 0x5eb6(r3)	/* effective address: 8040C076 */
lbl_8069EC68:
...
/* 8069EC98  4B 9D 0D 8C */	b StartShock__12dVibration_cFii4cXyz
lbl_8069EC9C:
...
/* 8069ECAC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069ECB0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069ECB4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069ECB8  7E E4 BB 78 */	mr r4, r23
/* 8069ECBC  4B 96 D7 20 */	b mDoMtx_YrotS__FPA4_fs
...
/* 8069ED04  4B BD 19 04 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069ED18  4B BD 0D 24 */	b cLib_addCalc2__FPffff
...
/* 8069ED2C  4B BD 0D 10 */	b cLib_addCalc2__FPffff
...
/* 8069ED40  4B BD 0C FC */	b cLib_addCalc2__FPffff
...
/* 8069ED54  4B BD 0C E8 */	b cLib_addCalc2__FPffff
...
/* 8069ED64  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8069ED68  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8069EDB4  4B BD 18 54 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EDC8  4B BD 18 40 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EF08  4B BD 17 00 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EF1C  4B BD 16 EC */	b cLib_addCalcAngleS2__FPssss
/* 8069EF20  A8 1C 06 68 */	lha r0, 0x668(r28)
/* 8069EF24  1C 00 03 E8 */	mulli r0, r0, 0x3e8
/* 8069EF28  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 8069EF2C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8069EF30  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8069EF58  4B BD 16 B0 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EF7C  4B 97 DB 5C */	b fopAcM_createDisappear__FPC10fopAc_ac_cPC4cXyzUcUcUc
/* 8069EF80  7F 83 E3 78 */	mr r3, r28
/* 8069EF84  4B 97 AC F8 */	b fopAcM_delete__FP10fopAc_ac_c
/* 8069EF88  A0 9C 04 94 */	lhz r4, 0x494(r28)
/* 8069EF8C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069EF90  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8069EF94  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 8069EF98  7C 05 07 74 */	extsb r5, r0
/* 8069EF9C  4B 99 66 A8 */	b onActor__10dSv_info_cFii
...
/* 8069EFB0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069EFB4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8069EFB8  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 8069EFBC  7C 05 07 74 */	extsb r5, r0
/* 8069EFC0  4B 99 62 40 */	b onSwitch__10dSv_info_cFii
lbl_8069EFC4:
...
/* 8069EFE8  4B BD 16 20 */	b cLib_addCalcAngleS2__FPssss
...
/* 8069EFFC  4B BD 16 0C */	b cLib_addCalcAngleS2__FPssss
...
/* 8069F01C  4B BD 0A 20 */	b cLib_addCalc2__FPffff
lbl_8069F020:
...
/* 8069F048  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8069F04C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
lbl_8069F070:
/* 8069F070  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069F074  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069F078  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069F07C  A8 1C 04 E6 */	lha r0, 0x4e6(r28)
/* 8069F080  7C 04 02 14 */	add r0, r4, r0
/* 8069F084  7C 04 07 34 */	extsh r4, r0
/* 8069F088  4B 96 D3 54 */	b mDoMtx_YrotS__FPA4_fs
...
/* 8069F0A8  4B BD 1E 44 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8069F0C8  4B CA 7F C8 */	b PSVECAdd
...
/* 8069F114  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8069F118  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8069F11C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8069F120  A8 9C 08 5C */	lha r4, 0x85c(r28)
/* 8069F124  4B 96 D2 B8 */	b mDoMtx_YrotS__FPA4_fs
/* 8069F128  38 61 00 50 */	addi r3, r1, 0x50
/* 8069F12C  38 81 00 44 */	addi r4, r1, 0x44
/* 8069F130  4B BD 1D BC */	b MtxPosition__FP4cXyzP4cXyz
/* 8069F134  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 8069F138  38 81 00 44 */	addi r4, r1, 0x44
/* 8069F13C  7C 65 1B 78 */	mr r5, r3
/* 8069F140  4B CA 7F 50 */	b PSVECAdd
lbl_8069F144:
...
/* 8069F184  3C 60 80 6A */	lis r3, l_HIO@ha
/* 8069F188  38 63 1D A8 */	addi r3, r3, l_HIO@l
/* 8069F18C  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 806A1DB0 */
...
/* 8069F1B4  4B 9D 78 F8 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8069F260  4B BC 86 F4 */	b cM_rndF__Ff
...
/* 8069F2B4  4B 98 05 C8 */	b fopKyM_createWpillar__FPC4cXyzfi
...
/* 8069F300  4B 97 A9 7C */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 8069F314  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8069F318  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8069F31C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 8069F320  7C 05 07 74 */	extsb r5, r0
/* 8069F324  4B 99 5E DC */	b onSwitch__10dSv_info_cFii
lbl_8069F328:
/* 8069F328  38 61 00 5C */	addi r3, r1, 0x5c
/* 8069F32C  38 80 FF FF */	li r4, -1
/* 8069F330  4B 9D 85 18 */	b __dt__18dBgS_ObjGndChk_SplFv
...
/* 8069F34C  4B CC 2E C4 */	b _restgpr_23

...
/* 806A0B64  4B CC 16 64 */	b _savegpr_24
/* 806A0B68  7C 7F 1B 78 */	mr r31, r3
/* 806A0B6C  3C 80 80 6A */	lis r4, cNullVec__6Z2Calc@ha
/* 806A0B70  3B A4 1A 74 */	addi r29, r4, cNullVec__6Z2Calc@l
/* 806A0B74  3C 80 80 6A */	lis r4, lit_3902@ha
/* 806A0B78  3B C4 19 0C */	addi r30, r4, lit_3902@l
...
/* 806A0B94  4B 97 7F D0 */	b __ct__10fopAc_ac_cFv
/* 806A0B98  38 79 05 BC */	addi r3, r25, 0x5bc
/* 806A0B9C  4B C2 03 C8 */	b __ct__15Z2CreatureEnemyFv
/* 806A0BA0  38 79 06 9C */	addi r3, r25, 0x69c
/* 806A0BA4  3C 80 80 6A */	lis r4, __ct__4cXyzFv@ha
/* 806A0BA8  38 84 13 8C */	addi r4, r4, __ct__4cXyzFv@l
/* 806A0BAC  3C A0 80 6A */	lis r5, __dt__4cXyzFv@ha
/* 806A0BB0  38 A5 18 BC */	addi r5, r5, __dt__4cXyzFv@l
/* 806A0BB4  38 C0 00 0C */	li r6, 0xc
/* 806A0BB8  38 E0 00 0C */	li r7, 0xc
/* 806A0BBC  4B CC 11 A4 */	b __construct_array
/* 806A0BC0  38 79 07 2C */	addi r3, r25, 0x72c
/* 806A0BC4  3C 80 80 6A */	lis r4, __ct__5csXyzFv@ha
/* 806A0BC8  38 84 13 88 */	addi r4, r4, __ct__5csXyzFv@l
/* 806A0BCC  3C A0 80 6A */	lis r5, __dt__5csXyzFv@ha
/* 806A0BD0  38 A5 18 80 */	addi r5, r5, __dt__5csXyzFv@l
/* 806A0BD4  38 C0 00 06 */	li r6, 6
/* 806A0BD8  38 E0 00 0C */	li r7, 0xc
/* 806A0BDC  4B CC 11 84 */	b __construct_array
/* 806A0BE0  3C 60 80 6A */	lis r3, __vt__18mDoExt_3DlineMat_c@ha
/* 806A0BE4  38 03 1D 70 */	addi r0, r3, __vt__18mDoExt_3DlineMat_c@l
/* 806A0BE8  90 19 08 04 */	stw r0, 0x804(r25)
/* 806A0BEC  3C 60 80 3A */	lis r3, __vt__19mDoExt_3DlineMat1_c@ha
/* 806A0BF0  38 03 32 48 */	addi r0, r3, __vt__19mDoExt_3DlineMat1_c@l
/* 806A0BF4  90 19 08 04 */	stw r0, 0x804(r25)
/* 806A0BF8  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 806A0BFC  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 806A0C00  90 19 08 80 */	stw r0, 0x880(r25)
/* 806A0C04  38 79 08 84 */	addi r3, r25, 0x884
/* 806A0C08  4B 9E 2B 58 */	b __ct__10dCcD_GSttsFv
/* 806A0C0C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 806A0C10  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 806A0C28  4B 9E 2E 00 */	b __ct__12dCcD_GObjInfFv
/* 806A0C2C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 806A0C30  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 806A0C34  90 18 01 20 */	stw r0, 0x120(r24)
/* 806A0C38  3C 60 80 6A */	lis r3, __vt__8cM3dGAab@ha
/* 806A0C3C  38 03 1D 64 */	addi r0, r3, __vt__8cM3dGAab@l
/* 806A0C40  90 18 01 1C */	stw r0, 0x11c(r24)
/* 806A0C44  3C 60 80 6A */	lis r3, __vt__8cM3dGSph@ha
/* 806A0C48  38 03 1D 58 */	addi r0, r3, __vt__8cM3dGSph@l
/* 806A0C4C  90 18 01 34 */	stw r0, 0x134(r24)
/* 806A0C50  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 806A0C54  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 806A0C58  90 78 01 20 */	stw r3, 0x120(r24)
/* 806A0C5C  3B 83 00 58 */	addi r28, r3, 0x58
/* 806A0C60  93 98 01 34 */	stw r28, 0x134(r24)
/* 806A0C64  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 806A0C68  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 806A0C88  4B 9E 2D A0 */	b __ct__12dCcD_GObjInfFv
/* 806A0C8C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 806A0C90  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 806A0C94  90 18 01 20 */	stw r0, 0x120(r24)
/* 806A0C98  3C 60 80 6A */	lis r3, __vt__8cM3dGAab@ha
/* 806A0C9C  38 03 1D 64 */	addi r0, r3, __vt__8cM3dGAab@l
/* 806A0CA0  90 18 01 1C */	stw r0, 0x11c(r24)
/* 806A0CA4  3C 60 80 6A */	lis r3, __vt__8cM3dGSph@ha
/* 806A0CA8  38 03 1D 58 */	addi r0, r3, __vt__8cM3dGSph@l
/* 806A0CAC  90 18 01 34 */	stw r0, 0x134(r24)
/* 806A0CB0  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 806A0CB4  38 03 35 40 */	addi r0, r3, __vt__12cCcD_SphAttr@l
/* 806A0CB8  90 18 01 20 */	stw r0, 0x120(r24)
/* 806A0CBC  93 98 01 34 */	stw r28, 0x134(r24)
/* 806A0CC0  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 806A0CC4  38 03 BF C0 */	addi r0, r3, __vt__8dCcD_Sph@l
...
/* 806A0CD8  3C 80 80 6A */	lis r4, __ct__8dCcD_SphFv@ha
/* 806A0CDC  38 84 11 4C */	addi r4, r4, __ct__8dCcD_SphFv@l
/* 806A0CE0  3C A0 80 6A */	lis r5, __dt__8dCcD_SphFv@ha
/* 806A0CE4  38 A5 11 D0 */	addi r5, r5, __dt__8dCcD_SphFv@l
/* 806A0CE8  38 C0 01 38 */	li r6, 0x138
/* 806A0CEC  38 E0 00 04 */	li r7, 4
/* 806A0CF0  4B CC 10 70 */	b __construct_array
/* 806A0CF4  38 79 10 1C */	addi r3, r25, 0x101c
/* 806A0CF8  4B 9D 51 B4 */	b __ct__12dBgS_AcchCirFv
/* 806A0CFC  3B 19 10 5C */	addi r24, r25, 0x105c
/* 806A0D00  7F 03 C3 78 */	mr r3, r24
/* 806A0D04  4B 9D 53 9C */	b __ct__9dBgS_AcchFv
/* 806A0D08  3C 60 80 6A */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 806A0D0C  38 63 1D 34 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 806A0D28  4B 9D 81 40 */	b SetObj__16dBgS_PolyPassChkFv
lbl_806A0D2C:
...
/* 806A0D3C  3C 80 80 6A */	lis r4, stringBase0@ha
/* 806A0D40  38 84 1A 6C */	addi r4, r4, stringBase0@l
/* 806A0D44  4B 98 C1 78 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806A0D64  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806A0D68  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806A0D6C  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806A0D70  7C 05 07 74 */	extsb r5, r0
/* 806A0D74  4B 99 45 EC */	b isSwitch__10dSv_info_cCFii
...
/* 806A0E10  3C 80 80 6A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 806A0E14  38 84 09 60 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 806A0E18  38 A0 40 60 */	li r5, 0x4060
/* 806A0E1C  4B 97 96 94 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_806A0E30:
/* 806A0E30  3C 60 80 6A */	lis r3, data_806A1D98@ha
/* 806A0E34  8C 03 1D 98 */	lbzu r0, data_806A1D98@l(r3)
...
/* 806A0E50  3C 60 80 6A */	lis r3, l_HIO@ha
/* 806A0E54  38 63 1D A8 */	addi r3, r3, l_HIO@l
/* 806A0E58  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 806A1DAC */
lbl_806A0E5C:
...
/* 806A0E84  4B 97 96 A4 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 806A0E98  4B 97 96 A0 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806A0EB8  4B 9E 29 A8 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 806A0EBC  38 7F 08 A4 */	addi r3, r31, 0x8a4
/* 806A0EC0  38 9D 01 8C */	addi r4, r29, 0x18c
/* 806A0EC4  4B 9E 3B 70 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806A0ED8  4B 9E 3B 5C */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806A0EF8  4B 9E 3B 3C */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806A0F38  4B 9D 53 10 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 806A0F3C  38 7F 10 1C */	addi r3, r31, 0x101c
/* 806A0F40  C0 3E 00 4C */	lfs f1, 0x4c(r30)
/* 806A0F44  C0 5E 00 A8 */	lfs f2, 0xa8(r30)
/* 806A0F48  4B 9D 50 10 */	b SetWall__12dBgS_AcchCirFff
...
/* 806A0F60  4B C2 01 34 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806A0F64  38 7F 05 BC */	addi r3, r31, 0x5bc
/* 806A0F68  3C 80 80 6A */	lis r4, stringBase0@ha
/* 806A0F6C  38 84 1A 6C */	addi r4, r4, stringBase0@l
/* 806A0F70  4B C2 0C 20 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 806A0F90  4B BC 69 C4 */	b cM_rndF__Ff
...
/* 806A0FA4  3C 60 80 6A */	lis r3, l_HIO@ha
/* 806A0FA8  38 63 1D A8 */	addi r3, r3, l_HIO@l
/* 806A0FAC  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 806A1DB4 */
...
/* 806A1040  4B 97 8E B0 */	b fopAcM_createChild__FsUiUlPC4cXyziPC5csXyzPC4cXyzScPFPv_i
...
/* 806A1058  4B CC 11 BC */	b _restgpr_24

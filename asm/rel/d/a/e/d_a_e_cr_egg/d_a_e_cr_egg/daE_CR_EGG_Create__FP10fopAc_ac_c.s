...
/* 8069A58C  4B CC 7C 50 */	b _savegpr_29
...
/* 8069A5AC  4B 97 E5 B8 */	b __ct__10fopAc_ac_cFv
/* 8069A5B0  38 7E 05 BC */	addi r3, r30, 0x5bc
/* 8069A5B4  4B C2 5E 14 */	b __ct__10Z2CreatureFv
/* 8069A5B8  38 7E 06 5C */	addi r3, r30, 0x65c
/* 8069A5BC  4B 9D B8 F0 */	b __ct__12dBgS_AcchCirFv
/* 8069A5C0  3B BE 06 9C */	addi r29, r30, 0x69c
/* 8069A5C4  7F A3 EB 78 */	mr r3, r29
/* 8069A5C8  4B 9D BA D8 */	b __ct__9dBgS_AcchFv
/* 8069A5CC  3C 60 80 6A */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 8069A5D0  38 63 A9 C8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 8069A5EC  4B 9D E8 7C */	b SetObj__16dBgS_PolyPassChkFv
/* 8069A5F0  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8069A5F4  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8069A5F8  90 1E 08 8C */	stw r0, 0x88c(r30)
/* 8069A5FC  38 7E 08 90 */	addi r3, r30, 0x890
/* 8069A600  4B 9E 91 60 */	b __ct__10dCcD_GSttsFv
/* 8069A604  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8069A608  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8069A620  4B 9E 94 08 */	b __ct__12dCcD_GObjInfFv
/* 8069A624  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 8069A628  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8069A62C  90 1D 01 20 */	stw r0, 0x120(r29)
/* 8069A630  3C 60 80 6A */	lis r3, __vt__8cM3dGAab@ha
/* 8069A634  38 03 A9 BC */	addi r0, r3, __vt__8cM3dGAab@l
/* 8069A638  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 8069A63C  3C 60 80 6A */	lis r3, __vt__8cM3dGSph@ha
/* 8069A640  38 03 A9 B0 */	addi r0, r3, __vt__8cM3dGSph@l
/* 8069A644  90 1D 01 34 */	stw r0, 0x134(r29)
/* 8069A648  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 8069A64C  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 8069A650  90 7D 01 20 */	stw r3, 0x120(r29)
/* 8069A654  38 03 00 58 */	addi r0, r3, 0x58
/* 8069A658  90 1D 01 34 */	stw r0, 0x134(r29)
/* 8069A65C  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 8069A660  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 8069A688  3C 80 80 6A */	lis r4, stringBase0@ha
/* 8069A68C  38 84 A9 0C */	addi r4, r4, stringBase0@l
/* 8069A690  4B 99 28 2C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8069A6E0  3C 80 80 6A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 8069A6E4  38 84 A5 10 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 8069A6E8  38 A0 08 20 */	li r5, 0x820
/* 8069A6EC  4B 97 FD C4 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8069A74C  4B C2 5D E4 */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 8069A778  4B 9D BA D0 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8069A77C  38 7F 06 5C */	addi r3, r31, 0x65c
/* 8069A780  3C 80 80 6A */	lis r4, lit_3730@ha
/* 8069A784  C0 24 A9 04 */	lfs f1, lit_3730@l(r4)
/* 8069A788  FC 40 08 90 */	fmr f2, f1
/* 8069A78C  4B 9D B7 CC */	b SetWall__12dBgS_AcchCirFff
...
/* 8069A7A0  4B CC 7A 88 */	b _restgpr_29

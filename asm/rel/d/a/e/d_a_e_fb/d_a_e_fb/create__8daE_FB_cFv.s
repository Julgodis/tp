...
/* 806B88F0  4B CA 98 E8 */	b _savegpr_28
/* 806B88F4  7C 7C 1B 78 */	mr r28, r3
/* 806B88F8  3C 80 80 6C */	lis r4, lit_1109@ha
/* 806B88FC  3B C4 91 B0 */	addi r30, r4, lit_1109@l
/* 806B8900  3C 80 80 6C */	lis r4, lit_3662@ha
/* 806B8904  3B E4 8F 8C */	addi r31, r4, lit_3662@l
...
/* 806B8964  3C 80 80 6C */	lis r4, stringBase0@ha
/* 806B8968  38 84 90 28 */	addi r4, r4, stringBase0@l
/* 806B896C  4B 97 45 50 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806B89C4  4B 9C AE 9C */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 806B89C8  38 7C 0B 68 */	addi r3, r28, 0xb68
/* 806B89CC  3C 80 80 6C */	lis r4, data_806B9074@ha
/* 806B89D0  38 84 90 74 */	addi r4, r4, data_806B9074@l
/* 806B89D4  4B 9C C0 60 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806B8A00  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806B8A04  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806B8A08  88 1C 04 BA */	lbz r0, 0x4ba(r28)
/* 806B8A0C  7C 05 07 74 */	extsb r5, r0
/* 806B8A10  4B 97 C9 50 */	b isSwitch__10dSv_info_cCFii
...
/* 806B8A28  3C 80 80 6C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 806B8A2C  38 84 88 C0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 806B8A30  38 A0 28 30 */	li r5, 0x2830
/* 806B8A34  4B 96 1A 7C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 806B8AB0  4B 96 1A 78 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 806B8AC4  4B 96 1A 74 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806B8AF0  4B 9B D7 58 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 806B8B0C  4B 9B D4 4C */	b SetWall__12dBgS_AcchCirFff
/* 806B8B10  38 7C 06 E4 */	addi r3, r28, 0x6e4
/* 806B8B14  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806B8B18  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 806B8B1C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806B8B20  4B 9B DF 8C */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 806B8B34  4B 9C AD 2C */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 806B8B50  3C 80 80 6C */	lis r4, data_806B9034@ha
/* 806B8B54  38 84 90 34 */	addi r4, r4, data_806B9034@l
/* 806B8B58  4B 9C BE DC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
/* 806B8B5C  38 1C 08 BC */	addi r0, r28, 0x8bc
/* 806B8B60  90 1C 09 3C */	stw r0, 0x93c(r28)
/* 806B8B64  38 7C 0A 30 */	addi r3, r28, 0xa30
/* 806B8B68  3C 80 80 6C */	lis r4, data_806B9034@ha
/* 806B8B6C  38 84 90 34 */	addi r4, r4, data_806B9034@l
/* 806B8B70  4B 9C BE C4 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
/* 806B8B74  38 1C 08 BC */	addi r0, r28, 0x8bc
/* 806B8B78  90 1C 0A 74 */	stw r0, 0xa74(r28)
/* 806B8B7C  38 7C 0B 68 */	addi r3, r28, 0xb68
/* 806B8B80  3C 80 80 6C */	lis r4, data_806B9074@ha
/* 806B8B84  38 84 90 74 */	addi r4, r4, data_806B9074@l
/* 806B8B88  4B 9C BE AC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806B8BA8  4B C0 84 EC */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806B8BAC  38 7C 05 C4 */	addi r3, r28, 0x5c4
/* 806B8BB0  3C 80 80 6C */	lis r4, stringBase0@ha
/* 806B8BB4  38 84 90 28 */	addi r4, r4, stringBase0@l
/* 806B8BB8  38 84 00 05 */	addi r4, r4, 5
/* 806B8BBC  4B C0 8F D4 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 806B8C08  4B CA 96 1C */	b _restgpr_28

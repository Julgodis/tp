...
/* 806B6F58 00000018  3C 60 80 6C */	lis r3, lit_3662@ha
/* 806B6F5C 0000001C  3B C3 8F 8C */	addi r30, r3, lit_3662@l
...
lbl_806B6F9C:
/* 806B6F9C 00000000  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806B6FA0 00000004  38 63 91 FC */	addi r3, r3, l_HIO@l
/* 806B6FA4 00000008  A8 03 00 10 */	lha r0, 0x10(r3)	/* effective address: 806B920C */
...
/* 806B6FB8 0000000C  C0 3E 00 20 */	lfs f1, 0x20(r30)	/* effective address: 806B8FAC */
/* 806B6FBC 00000010  C0 5E 00 14 */	lfs f2, 0x14(r30)	/* effective address: 806B8FA0 */
...
/* 806B6FE0 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806B6FE4 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806B6FE8 00000014  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806B6FEC 00000018  C0 03 04 D4 */	lfs f0, 0x4d4(r3)	/* effective address: 80406694 */
/* 806B6FF0 0000001C  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)
/* 806B6FF4 00000020  EC 40 08 28 */	fsubs f2, f0, f1
/* 806B6FF8 00000024  C0 3E 00 24 */	lfs f1, 0x24(r30)	/* effective address: 806B8FB0 */
/* 806B6FFC 00000028  FC 02 08 40 */	fcmpo cr0, f2, f1
/* 806B7000 00000000  41 81 00 DC */	bgt lbl_806B70DC
/* 806B7004 00000004  C0 1E 00 28 */	lfs f0, 0x28(r30)	/* effective address: 806B8FB4 */
...
/* 806B7020 00000008  C0 23 04 D0 */	lfs f1, 0x4d0(r3)	/* effective address: 80406690 */
/* 806B7024 0000000C  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 806B8FB8 */
...
lbl_806B7034:
/* 806B7034 00000000  C0 23 04 D0 */	lfs f1, 0x4d0(r3)	/* effective address: 80406690 */
/* 806B7038 00000004  C0 1E 00 30 */	lfs f0, 0x30(r30)	/* effective address: 806B8FBC */
...
/* 806B709C 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806B70A0 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806B70A4 00000010  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806B70A8 00000014  C0 03 04 D4 */	lfs f0, 0x4d4(r3)	/* effective address: 80406694 */
/* 806B70AC 00000018  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)
/* 806B70B0 0000001C  EC 20 08 28 */	fsubs f1, f0, f1
/* 806B70B4 00000020  C0 1E 00 24 */	lfs f0, 0x24(r30)	/* effective address: 806B8FB0 */
/* 806B70B8 00000024  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806B70BC 00000000  41 81 00 20 */	bgt lbl_806B70DC
/* 806B70C0 00000004  C0 1E 00 34 */	lfs f0, 0x34(r30)	/* effective address: 806B8FC0 */

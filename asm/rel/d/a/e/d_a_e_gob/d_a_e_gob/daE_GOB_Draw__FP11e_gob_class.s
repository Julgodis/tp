...
/* 806D843C 00000010  4B C8 9D A0 */	b _savegpr_29
/* 806D8440 00000014  7C 7D 1B 78 */	mr r29, r3
/* 806D8444 00000018  3C 60 80 6E */	lis r3, lit_3763@ha
/* 806D8448 0000001C  3B E3 EE 38 */	addi r31, r3, lit_3763@l
/* 806D844C 00000020  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806D8450 00000024  83 C3 00 04 */	lwz r30, 4(r3)
/* 806D8454 00000028  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806D8458 0000002C  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 806D8468 0000003C  4B AC B3 5C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806D846C 00000040  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806D8470 00000044  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806D8474 00000048  80 9E 00 04 */	lwz r4, 4(r30)
/* 806D8478 0000004C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806D847C 00000050  4B AC C9 24 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806D8480 00000054  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806D8484 00000058  4B 93 8D 3C */	b entryDL__16mDoExt_McaMorfSOFv
/* 806D8488 0000005C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806D848C 00000060  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806D8490 00000064  38 63 09 58 */	addi r3, r3, 0x958
/* 806D8494 00000068  38 80 00 07 */	li r4, 7
/* 806D8498 0000006C  4B 95 C4 9C */	b isDungeonItem__12dSv_memBit_cCFi
/* 806D849C 00000070  2C 03 00 00 */	cmpwi r3, 0
/* 806D84A0 00000074  40 82 00 24 */	bne lbl_806D84C4
/* 806D84A4 00000078  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806D84A8 0000007C  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 806D84B8 0000008C  4B AC C8 E8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806D84BC 00000090  80 7D 06 4C */	lwz r3, 0x64c(r29)
/* 806D84C0 00000094  4B 93 58 04 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_806D84C4:
/* 806D84C4 00000000  C0 5D 04 D8 */	lfs f2, 0x4d8(r29)
/* 806D84C8 00000004  C0 1F 00 10 */	lfs f0, 0x10(r31)	/* effective address: 806DEE48 */
...
/* 806D84F4 00000030  C0 3F 00 14 */	lfs f1, 0x14(r31)	/* effective address: 806DEE4C */
/* 806D84F8 00000034  C0 5F 00 18 */	lfs f2, 0x18(r31)	/* effective address: 806DEE50 */
...
/* 806D850C 00000048  C0 BF 00 1C */	lfs f5, 0x1c(r31)	/* effective address: 806DEE54 */
/* 806D8510 0000004C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806D8514 00000050  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806D8518 00000054  4B 95 63 F8 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806D8528 00000064  4B C8 9D 00 */	b _restgpr_29

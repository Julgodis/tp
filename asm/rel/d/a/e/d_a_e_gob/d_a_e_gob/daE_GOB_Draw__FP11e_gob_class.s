...
/* 806D843C  4B C8 9D A0 */	b _savegpr_29
/* 806D8440  7C 7D 1B 78 */	mr r29, r3
/* 806D8444  3C 60 80 6E */	lis r3, lit_3763@ha
/* 806D8448  3B E3 EE 38 */	addi r31, r3, lit_3763@l
/* 806D844C  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 806D8450  83 C3 00 04 */	lwz r30, 4(r3)
/* 806D8454  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806D8458  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806D845C  38 80 00 00 */	li r4, 0
/* 806D8460  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806D8464  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806D8468  4B AC B3 5C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806D846C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806D8470  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 806D84A4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806D84A8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806D84AC  80 9D 06 4C */	lwz r4, 0x64c(r29)
/* 806D84B0  80 84 00 04 */	lwz r4, 4(r4)
/* 806D84B4  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806D84B8  4B AC C8 E8 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806D84BC  80 7D 06 4C */	lwz r3, 0x64c(r29)
/* 806D84C0  4B 93 58 04 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_806D84C4:
...
/* 806D8510  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806D8514  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806D8518  4B 95 63 F8 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806D851C  90 7D 06 50 */	stw r3, 0x650(r29)
/* 806D8520  38 60 00 01 */	li r3, 1
/* 806D8524  39 61 00 30 */	addi r11, r1, 0x30
/* 806D8528  4B C8 9D 00 */	b _restgpr_29

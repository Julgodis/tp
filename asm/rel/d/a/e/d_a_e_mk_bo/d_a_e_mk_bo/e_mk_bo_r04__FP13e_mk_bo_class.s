...
/* 8071DBB0 00000010  4B C4 46 2C */	b _savegpr_29
/* 8071DBB4 00000014  7C 7D 1B 78 */	mr r29, r3
/* 8071DBB8 00000018  3C 60 80 72 */	lis r3, lit_3776@ha
/* 8071DBBC 0000001C  3B C3 F6 40 */	addi r30, r3, lit_3776@l
/* 8071DBC0 00000020  80 1D 04 A4 */	lwz r0, 0x4a4(r29)
/* 8071DBC4 00000024  90 01 00 0C */	stw r0, 0xc(r1)
/* 8071DBC8 00000028  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8071DBCC 0000002C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8071DBD0 00000030  38 81 00 0C */	addi r4, r1, 0xc
/* 8071DBD4 00000034  4B 8F BC 24 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8071DC84 0000001C  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 8071F66C */
...
/* 8071DC9C 00000034  4B B4 8E 98 */	b __mi__4cXyzCFRC3Vec
...
/* 8071DCB8 00000050  4B B4 99 BC */	b cM_atan2s__Fff
...
/* 8071DCCC 00000064  4B B5 29 3C */	b cLib_addCalcAngleS2__FPssss
...
/* 8071DCE4 0000007C  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 8071F640 */
...
/* 8071DCFC 00000004  4B B4 99 78 */	b cM_atan2s__Fff
...
/* 8071DD14 0000001C  4B B5 28 F4 */	b cLib_addCalcAngleS2__FPssss
...
/* 8071DD28 00000030  4B B5 28 E0 */	b cLib_addCalcAngleS2__FPssss
...
/* 8071DD3C 00000044  4B B5 28 CC */	b cLib_addCalcAngleS2__FPssss
/* 8071DD40 00000048  38 61 00 1C */	addi r3, r1, 0x1c
/* 8071DD44 0000004C  4B C2 93 F4 */	b PSVECSquareMag
/* 8071DD48 00000050  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 8071F640 */
...
/* 8071DD58 00000008  C8 9E 00 10 */	lfd f4, 0x10(r30)	/* effective address: 8071F650 */
/* 8071DD5C 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8071DD60 00000010  C8 7E 00 18 */	lfd f3, 0x18(r30)	/* effective address: 8071F658 */
...
lbl_8071DDA8:
/* 8071DDA8 00000000  C8 1E 00 20 */	lfd f0, 0x20(r30)	/* effective address: 8071F660 */
/* 8071DDAC 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8071DDB0 00000000  40 80 00 10 */	bge lbl_8071DDC0
/* 8071DDB4 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8071DDB8 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8071DE24 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8071DE28 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8071DE2C:
...
/* 8071DE38 0000000C  C0 1E 00 30 */	lfs f0, 0x30(r30)	/* effective address: 8071F670 */
...
lbl_8071DE58:
/* 8071DE58 00000000  C0 1E 00 34 */	lfs f0, 0x34(r30)	/* effective address: 8071F674 */
...
lbl_8071DE6C:
/* 8071DE6C 00000000  C0 1E 00 40 */	lfs f0, 0x40(r30)	/* effective address: 8071F680 */
/* 8071DE70 00000004  D0 1D 05 2C */	stfs f0, 0x52c(r29)
/* 8071DE74 00000008  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8071DE78 0000000C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8071DE7C 00000010  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8071DE80 00000014  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 8071DE84 00000018  4B 8E E5 58 */	b mDoMtx_YrotS__FPA4_fs
/* 8071DE88 0000001C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8071DE8C 00000020  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8071DE90 00000024  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8071DE94 00000028  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 8071DE98 0000002C  4B 8E E5 04 */	b mDoMtx_XrotM__FPA4_fs
/* 8071DE9C 00000030  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 8071F640 */
...
/* 8071DEB8 0000004C  4B B5 30 34 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8071DEC8 0000005C  4B C2 91 C8 */	b PSVECAdd
...
/* 8071DED8 0000006C  C0 3E 00 44 */	lfs f1, 0x44(r30)	/* effective address: 8071F684 */
/* 8071DEDC 00000070  C0 5E 00 04 */	lfs f2, 4(r30)	/* effective address: 8071F644 */
/* 8071DEE0 00000074  C0 7E 00 48 */	lfs f3, 0x48(r30)	/* effective address: 8071F688 */
/* 8071DEE4 00000078  4B B5 1B 58 */	b cLib_addCalc2__FPffff
/* 8071DEE8 0000007C  38 60 00 02 */	li r3, 2
lbl_8071DEEC:
/* 8071DEEC 00000000  39 61 00 40 */	addi r11, r1, 0x40
/* 8071DEF0 00000004  4B C4 43 38 */	b _restgpr_29

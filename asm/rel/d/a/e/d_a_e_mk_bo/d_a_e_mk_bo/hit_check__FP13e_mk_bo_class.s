...
/* 8071CE40  4B C4 53 9C */	b _savegpr_29
/* 8071CE44  7C 7D 1B 78 */	mr r29, r3
/* 8071CE48  3C 60 80 72 */	lis r3, lit_3776@ha
/* 8071CE4C  3B E3 F6 40 */	addi r31, r3, lit_3776@l
/* 8071CE50  80 1D 04 A4 */	lwz r0, 0x4a4(r29)
/* 8071CE54  90 01 00 08 */	stw r0, 8(r1)
/* 8071CE58  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8071CE5C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8071CE60  38 81 00 08 */	addi r4, r1, 8
/* 8071CE64  4B 8F C9 94 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 8071CE68  7C 7E 1B 78 */	mr r30, r3
/* 8071CE6C  38 7D 08 58 */	addi r3, r29, 0x858
/* 8071CE70  4B 96 75 F0 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 8071CEA8  4B 96 74 18 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 8071CECC  4B 96 75 94 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 8071CF08  4B 96 73 B8 */	b ChkAtHit__12dCcD_GObjInfFv
/* 8071CF0C  28 03 00 00 */	cmplwi r3, 0
/* 8071CF10  41 82 00 78 */	beq lbl_8071CF88
/* 8071CF14  38 7D 08 58 */	addi r3, r29, 0x858
/* 8071CF18  4B 96 74 40 */	b GetAtHitObj__12dCcD_GObjInfFv
/* 8071CF1C  4B B4 6B 2C */	b GetAc__8cCcD_ObjFv
...
/* 8071CF34  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8071CF38  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8071CF3C  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8071CF40  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 8071CF6C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8071CF70  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8071CF84  4B 95 2A A0 */	b StartShock__12dVibration_cFii4cXyz
lbl_8071CF88:
...
/* 8071CFE4  4B B4 9B 50 */	b __mi__4cXyzCFRC3Vec
...
/* 8071D000  4B B4 A6 74 */	b cM_atan2s__Fff
...
/* 8071D034  4B B4 A6 40 */	b cM_atan2s__Fff
...
/* 8071D068  4B 8F FF B8 */	b fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_8071D06C:
/* 8071D06C  39 61 00 50 */	addi r11, r1, 0x50
/* 8071D070  4B C4 51 B8 */	b _restgpr_29

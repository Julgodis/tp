...
/* 80691324  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 80691354  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80691358  4B CB 51 58 */	b PSMTXCopy
/* 8069135C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80691360  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80691364  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80691378  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8069138C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806913A0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806913BC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806913EC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806913F0  4B CB 50 C0 */	b PSMTXCopy
/* 806913F4  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806913F8  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806913FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 80691410  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 8069142C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

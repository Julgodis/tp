...
/* 807FC824  4B B6 59 90 */	b _savegpr_19
/* 807FC828  7C 7E 1B 78 */	mr r30, r3
/* 807FC82C  7C 9A 23 78 */	mr r26, r4
/* 807FC830  7C BB 2B 78 */	mr r27, r5
/* 807FC834  7C DC 33 78 */	mr r28, r6
/* 807FC838  3C 60 80 80 */	lis r3, cNullVec__6Z2Calc@ha
/* 807FC83C  3A E3 CD FC */	addi r23, r3, cNullVec__6Z2Calc@l
/* 807FC840  3C 60 80 80 */	lis r3, lit_3801@ha
/* 807FC844  3B E3 CC B4 */	addi r31, r3, lit_3801@l
/* 807FC848  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807FC84C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807FC850  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807FC854  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 807FC858  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 807FC880  4B 9A FC FC */	b dKy_darkworld_check__Fv
...
/* 807FC8A4  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 807FC8A8  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 807FC8AC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 807FC8B0  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 807FC8B4  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 807FC8B8  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 807FC8BC  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 807FC8C0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807FC8C4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807FC8C8  4B B4 9B E8 */	b PSMTXCopy
...
/* 807FC8E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807FC8E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807FC8E8  38 81 00 4C */	addi r4, r1, 0x4c
/* 807FC8EC  38 A1 00 58 */	addi r5, r1, 0x58
/* 807FC8F0  4B B4 A4 7C */	b PSMTXMultVec
/* 807FC8F4  38 61 00 34 */	addi r3, r1, 0x34
/* 807FC8F8  38 81 00 58 */	addi r4, r1, 0x58
/* 807FC8FC  7F 65 DB 78 */	mr r5, r27
/* 807FC900  4B A6 A2 34 */	b __mi__4cXyzCFRC3Vec
...
/* 807FC91C  4B A6 AD 58 */	b cM_atan2s__Fff
...
/* 807FC950  4B A6 AD 24 */	b cM_atan2s__Fff
...
/* 807FC96C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807FC970  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 807FC974  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 807FC9C0  4B 85 00 D0 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807FC9C4  7C 79 1B 79 */	or. r25, r3, r3
/* 807FC9C8  41 82 00 FC */	beq lbl_807FCAC4
/* 807FC9CC  38 61 00 40 */	addi r3, r1, 0x40
/* 807FC9D0  4B B4 A7 68 */	b PSVECSquareMag
...
/* 807FCA40  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807FCA44  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807FCAB0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807FCAB4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807FCAB8:
...
/* 807FCB08  4B 84 FF 88 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807FCB44  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807FCB48  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 807FCB74  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 807FCBB4  4B 85 09 18 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807FCC14  4B B6 55 EC */	b _restgpr_19

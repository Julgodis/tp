...
/* 8074D520 0000000C  3C 60 00 00 */	lis r3, lit_3917@ha /* 807576FC */
/* 8074D524 00000010  3B C3 00 00 */	addi r30, r3, lit_3917@l /* 807576FC */
/* 8074D528 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8074D52C 00000018  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 8074D560 0000000C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 8074D564 00000010  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
lbl_8074D64C:
/* 8074D64C 00000000  3C 60 00 00 */	lis r3, l_HIO@ha /* 80757E5C */
/* 8074D650 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80757E5C */
...
/* 8074D6D4 00000004  3C 60 00 00 */	lis r3, l_HIO@ha /* 80757E5C */
/* 8074D6D8 00000008  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80757E5C */
...
/* 8074D7EC 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8074D7F0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 8074D85C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8074D860 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_8074D864:
...
/* 8074D948 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8074D94C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 8074D9B8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8074D9BC 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_8074D9C0:
/* 8074D9C0 00000000  3C 60 00 00 */	lis r3, l_HIO@ha /* 80757E5C */
/* 8074D9C4 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80757E5C */
...
/* 8074DA34 0000002C  3C 80 00 00 */	lis r4, l_HIO@ha /* 80757E5C */
/* 8074DA38 00000030  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80757E5C */
...
/* 8074DA54 0000000C  3C 80 00 00 */	lis r4, l_HIO@ha /* 80757E5C */
/* 8074DA58 00000010  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80757E5C */
...
/* 8074DA68 00000004  3C 80 00 00 */	lis r4, l_HIO@ha /* 80757E5C */
/* 8074DA6C 00000008  38 84 00 00 */	addi r4, r4, l_HIO@l /* 80757E5C */
...
/* 8074DB30 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8074DB34 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 8074DBA0 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8074DBA4 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_8074DBA8:
/* 8074DBA8 00000000  3C 60 00 00 */	lis r3, l_HIO@ha /* 80757E5C */
/* 8074DBAC 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80757E5C */

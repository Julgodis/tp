...
/* 8074D518  4B C1 4C B8 */	b _savegpr_26
...
/* 8074D560  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8074D564  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8074D690  4B B1 A2 C4 */	b cM_rndF__Ff
...
/* 8074D750  4B B1 93 E4 */	b __mi__4cXyzCFRC3Vec
...
/* 8074D770  4B B1 99 B8 */	b atan2sX_Z__4cXyzCFv
/* 8074D774  7C 7B 07 34 */	extsh r27, r3
/* 8074D778  38 61 00 48 */	addi r3, r1, 0x48
/* 8074D77C  4B BF 99 BC */	b PSVECSquareMag
...
/* 8074D7EC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8074D7F0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8074D85C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8074D860  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8074D864:
...
/* 8074D8A0  4B 8C CE 70 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8074D8B8  4B B1 92 7C */	b __mi__4cXyzCFRC3Vec
...
/* 8074D8D8  4B BF 98 60 */	b PSVECSquareMag
...
/* 8074D948  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8074D94C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8074D9B8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8074D9BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8074D9C0:
...
/* 8074DA04  4B B2 2C 04 */	b cLib_addCalcAngleS2__FPssss
lbl_8074DA08:
...
/* 8074DA18  4B B2 20 24 */	b cLib_addCalc2__FPffff
...
/* 8074DAA0  4B B1 90 94 */	b __mi__4cXyzCFRC3Vec
...
/* 8074DAC0  4B BF 96 78 */	b PSVECSquareMag
...
/* 8074DB30  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8074DB34  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8074DBA0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8074DBA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8074DBA8:
...
/* 8074DC00  4B 8C CB 10 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c

...
/* 8074DC60 0000000C  3C 80 00 00 */	lis r4, lit_3917@ha
/* 8074DC64 00000010  3B C4 00 00 */	addi r30, r4, lit_3917@l
/* 8074DC68 00000014  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 8074DC6C 00000018  3B E4 00 00 */	addi r31, r4, g_dComIfG_gameInfo@l
...
/* 8074DD2C 00000018  3C 60 00 00 */	lis r3, l_HIO@ha
/* 8074DD30 0000001C  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 8074DF48 00000044  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8074DF4C 00000048  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8074DF74 00000014  3C 60 00 00 */	lis r3, mAttackNo@ha
/* 8074DF78 00000018  A8 03 00 00 */	lha r0, mAttackNo@l(r3)
...
/* 8074E048 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8074E04C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8074E0B8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8074E0BC 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8074E0C0:
/* 8074E0C0 00000000  3C 60 00 00 */	lis r3, l_HIO@ha
/* 8074E0C4 00000004  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 8074E130 0000004C  3C 80 00 00 */	lis r4, l_HIO@ha
/* 8074E134 00000050  38 84 00 00 */	addi r4, r4, l_HIO@l

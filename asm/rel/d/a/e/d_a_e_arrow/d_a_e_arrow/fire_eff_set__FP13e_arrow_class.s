...
/* 8067C884  4B CE 59 3C */	b _savegpr_22
/* 8067C888  7C 78 1B 78 */	mr r24, r3
/* 8067C88C  3C 60 80 68 */	lis r3, lit_3983@ha
/* 8067C890  3B 83 E8 80 */	addi r28, r3, lit_3983@l
/* 8067C894  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8067C898  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8067C89C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8067C8A0  A8 98 04 E6 */	lha r4, 0x4e6(r24)
/* 8067C8A4  4B 98 FB 38 */	b mDoMtx_YrotS__FPA4_fs
/* 8067C8A8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8067C8AC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8067C8B0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8067C8B4  A8 98 04 E4 */	lha r4, 0x4e4(r24)
/* 8067C8B8  4B 98 FA E4 */	b mDoMtx_XrotM__FPA4_fs
...
/* 8067C97C  4B CC A7 5C */	b PSVECScale
...
/* 8067C990  4B CC A7 48 */	b PSVECScale
lbl_8067C994:
/* 8067C994  3B 20 00 00 */	li r25, 0
/* 8067C998  3A E0 00 00 */	li r23, 0
/* 8067C99C  3A C0 00 00 */	li r22, 0
/* 8067C9A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8067C9A4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
...
/* 8067CA00  4B 9D 0A CC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8067CA9C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8067CAA0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8067CB0C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8067CB10  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8067CB14:
/* 8067CB14  C0 1C 00 20 */	lfs f0, 0x20(r28)
/* 8067CB18  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8067CB1C  40 81 00 18 */	ble lbl_8067CB34
/* 8067CB20  3C 60 80 45 */	lis r3, mParticleTracePCB__13dPa_control_c@ha
/* 8067CB24  38 03 0E C8 */	addi r0, r3, mParticleTracePCB__13dPa_control_c@l
...
/* 8067CB54  4B CE 56 B8 */	b _restgpr_22

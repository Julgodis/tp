...
/* 8067C884 00000010  4B FF FE B5 */	bl _savegpr_22
/* 8067C888 00000014  7C 78 1B 78 */	mr r24, r3
/* 8067C88C 00000018  3C 60 00 00 */	lis r3, lit_3983@ha /* 8067E880 */
/* 8067C890 0000001C  3B 83 00 00 */	addi r28, r3, lit_3983@l /* 8067E880 */
/* 8067C894 00000020  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8067C898 00000024  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8067C89C 00000028  80 63 00 00 */	lwz r3, 0(r3)
/* 8067C8A0 0000002C  A8 98 04 E6 */	lha r4, 0x4e6(r24)
/* 8067C8A4 00000030  4B FF FE 95 */	bl mDoMtx_YrotS__FPA4_fs
/* 8067C8A8 00000034  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 8067C8AC 00000038  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 8067C8B0 0000003C  80 63 00 00 */	lwz r3, 0(r3)
/* 8067C8B4 00000040  A8 98 04 E4 */	lha r4, 0x4e4(r24)
/* 8067C8B8 00000044  4B FF FE 81 */	bl mDoMtx_XrotM__FPA4_fs
/* 8067C8BC 00000048  C0 1C 00 0C */	lfs f0, 0xc(r28)
...
/* 8067C8D4 00000060  C0 1C 00 10 */	lfs f0, 0x10(r28)
/* 8067C8D8 00000064  D0 01 00 3C */	stfs f0, 0x3c(r1)
/* 8067C8DC 00000068  48 00 00 0C */	b lbl_8067C8E8
lbl_8067C8E0:
/* 8067C8E0 00000000  C0 1C 00 14 */	lfs f0, 0x14(r28)
...
/* 8067C8F0 00000008  4B FF FE 49 */	bl MtxPosition__FP4cXyzP4cXyz
...
/* 8067C900 00000018  4B FF FE 39 */	bl PSVECAdd
...
/* 8067C978 0000003C  C0 3C 00 18 */	lfs f1, 0x18(r28)
/* 8067C97C 00000040  4B FF FD BD */	bl PSVECScale
...
/* 8067C98C 00000008  C0 3C 00 1C */	lfs f1, 0x1c(r28)
/* 8067C990 0000000C  4B FF FD A9 */	bl PSVECScale
lbl_8067C994:
/* 8067C994 00000000  3B 20 00 00 */	li r25, 0
/* 8067C998 00000004  3A E0 00 00 */	li r23, 0
/* 8067C99C 00000008  3A C0 00 00 */	li r22, 0
/* 8067C9A0 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8067C9A4 00000010  3B A3 00 00 */	addi r29, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
lbl_8067C9B4:
/* 8067C9B4 00000000  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)
...
/* 8067C9FC 00000048  C0 3C 00 20 */	lfs f1, 0x20(r28)
/* 8067CA00 0000004C  4B FF FD 39 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8067CA10 0000005C  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)
/* 8067CA14 00000060  38 63 02 10 */	addi r3, r3, 0x210
/* 8067CA18 00000064  7C 98 F8 2E */	lwzx r4, r24, r31
/* 8067CA1C 00000068  4B FF FD 1D */	bl getEmitter__Q213dPa_control_c7level_cFUl
...
/* 8067CA2C 00000078  4B FF FD 0D */	bl PSVECSquareMag
/* 8067CA30 0000007C  C0 1C 00 0C */	lfs f0, 0xc(r28)
...
/* 8067CA40 00000008  C8 9C 00 28 */	lfd f4, 0x28(r28)
/* 8067CA44 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8067CA48 00000010  C8 7C 00 30 */	lfd f3, 0x30(r28)
...
lbl_8067CA90:
/* 8067CA90 00000000  C8 1C 00 38 */	lfd f0, 0x38(r28)
/* 8067CA94 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8067CA98 00000000  40 80 00 10 */	bge lbl_8067CAA8
/* 8067CA9C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8067CAA0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 8067CB0C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 8067CB10 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_8067CB14:
/* 8067CB14 00000000  C0 1C 00 20 */	lfs f0, 0x20(r28)
/* 8067CB18 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8067CB1C 00000000  40 81 00 18 */	ble lbl_8067CB34
/* 8067CB20 00000004  3C 60 00 00 */	lis r3, mParticleTracePCB__13dPa_control_c@ha /* 80450EC8 */
/* 8067CB24 00000008  38 03 00 00 */	addi r0, r3, mParticleTracePCB__13dPa_control_c@l /* 80450EC8 */
...
/* 8067CB54 0000000C  4B FF FB E5 */	bl _restgpr_22

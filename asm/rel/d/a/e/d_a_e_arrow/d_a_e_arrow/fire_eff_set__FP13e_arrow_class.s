...
/* 8067C88C 00000018  3C 60 00 00 */	lis r3, lit_3983@ha
/* 8067C890 0000001C  3B 83 00 00 */	addi r28, r3, lit_3983@l
/* 8067C894 00000020  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 8067C898 00000024  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 8067C8A8 00000034  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 8067C8AC 00000038  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 8067C9A0 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8067C9A4 00000010  3B A3 00 00 */	addi r29, r3, g_dComIfG_gameInfo@l
...
/* 8067CA9C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8067CAA0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8067CB0C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8067CB10 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8067CB14:
...
/* 8067CB20 00000004  3C 60 00 00 */	lis r3, mParticleTracePCB__13dPa_control_c@ha
/* 8067CB24 00000008  38 03 00 00 */	addi r0, r3, mParticleTracePCB__13dPa_control_c@l

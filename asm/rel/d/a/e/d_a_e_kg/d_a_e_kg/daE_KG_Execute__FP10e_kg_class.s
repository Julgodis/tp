...
/* 806F94E0  4B C6 8C F8 */	b _savegpr_28
/* 806F94E4  7C 7D 1B 78 */	mr r29, r3
/* 806F94E8  3C 60 80 70 */	lis r3, lit_3788@ha
/* 806F94EC  3B C3 A3 A4 */	addi r30, r3, lit_3788@l
...
/* 806F9544  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806F9548  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806F954C  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 806F9550  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 806F9554  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 806F9558  4B C4 D3 90 */	b PSMTXTrans
/* 806F955C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806F9560  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806F9564  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 806F9568  4B 91 2E CC */	b mDoMtx_YrotM__FPA4_fs
/* 806F956C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806F9570  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806F9574  A8 9D 04 E4 */	lha r4, 0x4e4(r29)
/* 806F9578  4B 91 2E 24 */	b mDoMtx_XrotM__FPA4_fs
/* 806F957C  3C 60 80 70 */	lis r3, l_HIO@ha
/* 806F9580  3B E3 A5 F8 */	addi r31, r3, l_HIO@l
/* 806F9584  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806FA600 */
/* 806F9588  FC 40 08 90 */	fmr f2, f1
/* 806F958C  FC 60 08 90 */	fmr f3, f1
/* 806F9590  4B 91 38 A8 */	b scaleM__14mDoMtx_stack_cFfff
/* 806F9594  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806F9598  83 83 00 04 */	lwz r28, 4(r3)
/* 806F959C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806F95A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806F95A4  38 9C 00 24 */	addi r4, r28, 0x24
/* 806F95A8  4B C4 CF 08 */	b PSMTXCopy
/* 806F95AC  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 806F95B0  7C 03 07 74 */	extsb r3, r0
/* 806F95B4  4B 93 3A B8 */	b dComIfGp_getReverb__Fi
/* 806F95B8  7C 65 1B 78 */	mr r5, r3
/* 806F95BC  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806F95C0  38 80 00 00 */	li r4, 0
/* 806F95C4  4B 91 7A EC */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 806F95E0  4B 91 7C 0C */	b modelCalc__16mDoExt_McaMorfSOFv
/* 806F95E4  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806F95E8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806F95EC  38 63 00 30 */	addi r3, r3, 0x30
/* 806F95F0  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806F95F4  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806F95F8  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806F95FC  4B C4 CE B4 */	b PSMTXCopy
...
/* 806F961C  4B B7 78 D0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806F9678  4B B7 78 74 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806F96A0  4B B7 5F A8 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 806F96B4  4B B7 60 54 */	b SetR__8cM3dGSphFf
/* 806F96B8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806F96BC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806F96C0  38 63 23 3C */	addi r3, r3, 0x233c
/* 806F96C4  38 9D 08 F8 */	addi r4, r29, 0x8f8
/* 806F96C8  4B B6 B4 E0 */	b Set__4cCcSFP8cCcD_Obj
...
/* 806F96F4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806F96F8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806F96FC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806F9700  4B C4 CD B0 */	b PSMTXCopy
...
/* 806F971C  4B B7 77 D0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806F9730  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806F9734  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806F9738  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 806F9784  4B 95 3D 48 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806F9788  90 7D 0A 58 */	stw r3, 0xa58(r29)
lbl_806F978C:
/* 806F978C  38 60 00 01 */	li r3, 1
/* 806F9790  39 61 00 70 */	addi r11, r1, 0x70
/* 806F9794  4B C6 8A 90 */	b _restgpr_28

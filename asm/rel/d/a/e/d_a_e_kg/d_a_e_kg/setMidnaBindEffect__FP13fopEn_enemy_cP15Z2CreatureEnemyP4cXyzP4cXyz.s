...
/* 806F9F8C  4B C6 82 28 */	b _savegpr_19
/* 806F9F90  7C 7E 1B 78 */	mr r30, r3
/* 806F9F94  7C 9A 23 78 */	mr r26, r4
/* 806F9F98  7C BB 2B 78 */	mr r27, r5
/* 806F9F9C  7C DC 33 78 */	mr r28, r6
/* 806F9FA0  3C 60 80 70 */	lis r3, cNullVec__6Z2Calc@ha
/* 806F9FA4  3A E3 A4 74 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806F9FA8  3C 60 80 70 */	lis r3, lit_3788@ha
/* 806F9FAC  3B E3 A3 A4 */	addi r31, r3, lit_3788@l
/* 806F9FB0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806F9FB4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806F9FB8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806F9FBC  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806F9FC0  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806F9FE8  4B AB 25 94 */	b dKy_darkworld_check__Fv
...
/* 806FA00C  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806FA010  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806FA014  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806FA018  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806FA01C  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806FA020  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806FA024  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806FA028  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806FA02C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806FA030  4B C4 C4 80 */	b PSMTXCopy
...
/* 806FA048  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FA04C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FA050  38 81 00 4C */	addi r4, r1, 0x4c
/* 806FA054  38 A1 00 58 */	addi r5, r1, 0x58
/* 806FA058  4B C4 CD 14 */	b PSMTXMultVec
/* 806FA05C  38 61 00 34 */	addi r3, r1, 0x34
/* 806FA060  38 81 00 58 */	addi r4, r1, 0x58
/* 806FA064  7F 65 DB 78 */	mr r5, r27
/* 806FA068  4B B6 CA CC */	b __mi__4cXyzCFRC3Vec
...
/* 806FA084  4B B6 D5 F0 */	b cM_atan2s__Fff
...
/* 806FA0B8  4B B6 D5 BC */	b cM_atan2s__Fff
...
/* 806FA0D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806FA0D8  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806FA0DC  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806FA128  4B 95 29 68 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806FA12C  7C 79 1B 79 */	or. r25, r3, r3
/* 806FA130  41 82 00 FC */	beq lbl_806FA22C
/* 806FA134  38 61 00 40 */	addi r3, r1, 0x40
/* 806FA138  4B C4 D0 00 */	b PSVECSquareMag
...
/* 806FA1A8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806FA1AC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806FA218  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806FA21C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806FA220:
...
/* 806FA270  4B 95 28 20 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806FA2AC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806FA2B0  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806FA2DC  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806FA31C  4B 95 31 B0 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806FA37C  4B C6 7E 84 */	b _restgpr_19

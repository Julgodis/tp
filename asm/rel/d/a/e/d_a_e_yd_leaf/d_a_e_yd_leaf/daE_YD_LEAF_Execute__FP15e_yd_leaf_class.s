...
/* 807F7ED8  3C 60 80 80 */	lis r3, lit_3707@ha
/* 807F7EDC  3B C3 81 E8 */	addi r30, r3, lit_3707@l
/* 807F7EE0  88 1F 05 BA */	lbz r0, 0x5ba(r31)
/* 807F7EE4  7C 00 07 75 */	extsb. r0, r0
/* 807F7EE8  40 82 00 54 */	bne lbl_807F7F3C
/* 807F7EEC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807F7EF0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807F7EF4  85 83 4E 20 */	lwzu r12, 0x4e20(r3)	/* effective address: 8040AFE0 */
/* 807F7EF8  81 8C 00 BC */	lwz r12, 0xbc(r12)
/* 807F7EFC  7D 89 03 A6 */	mtctr r12
/* 807F7F00  4E 80 04 21 */	bctrl 
/* 807F7F04  80 03 00 0C */	lwz r0, 0xc(r3)	/* effective address: 804061CC */
...
/* 807F7F18  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 807F7F1C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 807F7F20  38 81 00 08 */	addi r4, r1, 8
/* 807F7F24  4B 82 18 D4 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 807F7F48  4B A7 7B 38 */	b cLib_addCalc0__FPfff
...
/* 807F7F64  4B 82 1D 18 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_807F7F68:
/* 807F7F68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807F7F6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807F7F70  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 807F7F74  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 807F7F78  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 807F7F7C  4B B4 E9 6C */	b PSMTXTrans
/* 807F7F80  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807F7F84  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807F7F88  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 807F7F8C  4B 81 44 A8 */	b mDoMtx_YrotM__FPA4_fs
/* 807F7F90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807F7F94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807F7F98  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 807F7F9C  4B 81 44 00 */	b mDoMtx_XrotM__FPA4_fs
/* 807F7FA0  C0 3F 04 F0 */	lfs f1, 0x4f0(r31)
/* 807F7FA4  FC 40 08 90 */	fmr f2, f1
/* 807F7FA8  FC 60 08 90 */	fmr f3, f1
/* 807F7FAC  4B 81 4E 8C */	b scaleM__14mDoMtx_stack_cFfff
/* 807F7FB0  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 807F7FB4  80 83 00 04 */	lwz r4, 4(r3)
/* 807F7FB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807F7FBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807F7FC0  38 84 00 24 */	addi r4, r4, 0x24
/* 807F7FC4  4B B4 E4 EC */	b PSMTXCopy
/* 807F7FC8  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 807F7FCC  4B 81 86 E0 */	b modelCalc__14mDoExt_McaMorfFv

...
/* 806CBC78  3C 80 80 6D */	lis r4, l_actionmenu__8daE_GE_c@ha
/* 806CBC7C  38 04 D1 E8 */	addi r0, r4, l_actionmenu__8daE_GE_c@l
/* 806CBC80  7D 80 2A 14 */	add r12, r0, r5
/* 806CBC84  4B C9 64 00 */	b __ptmf_scall
...
/* 806CBCA8  3C 80 80 6D */	lis r4, lit_3905@ha
/* 806CBCAC  C0 24 D0 04 */	lfs f1, lit_3905@l(r4)
/* 806CBCB0  4B C5 C7 7C */	b checkPass__12J3DFrameCtrlFf
...
/* 806CBCFC  4B BF 5E 80 */	b setLinkSearch__15Z2CreatureEnemyFb
/* 806CBD00  48 00 00 10 */	b lbl_806CBD10
lbl_806CBD04:
/* 806CBD04  38 7F 05 B8 */	addi r3, r31, 0x5b8
/* 806CBD08  38 80 00 00 */	li r4, 0
/* 806CBD0C  4B BF 5E 70 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_806CBD10:
...
/* 806CBD20  3C 60 80 6D */	lis r3, lit_4468@ha
/* 806CBD24  C0 03 D0 90 */	lfs f0, lit_4468@l(r3)
...
/* 806CBD48  3C 60 80 6D */	lis r3, lit_4168@ha
/* 806CBD4C  C8 23 D0 70 */	lfd f1, lit_4168@l(r3)
...
/* 806CBD6C  3C 60 80 6D */	lis r3, lit_4468@ha
/* 806CBD70  C0 03 D0 90 */	lfs f0, lit_4468@l(r3)
...
/* 806CBDAC  4B BA 4D E4 */	b cLib_chaseAngleS__FPsss
lbl_806CBDB0:
/* 806CBDB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CBDB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CBDB8  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 806CBDBC  4B 94 06 20 */	b mDoMtx_YrotS__FPA4_fs
/* 806CBDC0  C0 3F 05 2C */	lfs f1, 0x52c(r31)
/* 806CBDC4  3C 60 80 6D */	lis r3, lit_3905@ha
/* 806CBDC8  C0 03 D0 04 */	lfs f0, lit_3905@l(r3)
/* 806CBDCC  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 806CBDD0  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 806CBDD4  D0 21 00 20 */	stfs f1, 0x20(r1)
/* 806CBDD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CBDDC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CBDE0  38 81 00 18 */	addi r4, r1, 0x18
/* 806CBDE4  38 A1 00 0C */	addi r5, r1, 0xc
/* 806CBDE8  4B C7 AF 84 */	b PSMTXMultVec
...
/* 806CBE08  4B C7 B2 88 */	b PSVECAdd
...
/* 806CBE6C  4B 96 12 00 */	b dComIfGp_getReverb__Fi
/* 806CBE70  7C 65 1B 78 */	mr r5, r3
/* 806CBE74  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 806CBE78  38 80 00 00 */	li r4, 0
/* 806CBE7C  4B 94 52 34 */	b play__16mDoExt_McaMorfSOFUlSc

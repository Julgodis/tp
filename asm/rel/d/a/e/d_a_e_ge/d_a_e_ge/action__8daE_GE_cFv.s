...
/* 806CBC78 00000040  3C 80 80 6D */	lis r4, l_actionmenu__8daE_GE_c@ha
/* 806CBC7C 00000044  38 04 D1 E8 */	addi r0, r4, l_actionmenu__8daE_GE_c@l
/* 806CBC80 00000048  7D 80 2A 14 */	add r12, r0, r5
/* 806CBC84 0000004C  4B C9 64 00 */	b __ptmf_scall
...
/* 806CBCA8 0000001C  3C 80 80 6D */	lis r4, lit_3905@ha
/* 806CBCAC 00000020  C0 24 D0 04 */	lfs f1, lit_3905@l(r4)
/* 806CBCB0 00000024  4B C5 C7 7C */	b checkPass__12J3DFrameCtrlFf
...
/* 806CBCFC 00000014  4B BF 5E 80 */	b setLinkSearch__15Z2CreatureEnemyFb
...
/* 806CBD0C 00000008  4B BF 5E 70 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_806CBD10:
...
/* 806CBD20 00000010  3C 60 80 6D */	lis r3, lit_4468@ha
/* 806CBD24 00000014  C0 03 D0 90 */	lfs f0, lit_4468@l(r3)
...
/* 806CBD48 00000010  3C 60 80 6D */	lis r3, lit_4168@ha
/* 806CBD4C 00000014  C8 23 D0 70 */	lfd f1, lit_4168@l(r3)
...
/* 806CBD6C 00000034  3C 60 80 6D */	lis r3, lit_4468@ha
/* 806CBD70 00000038  C0 03 D0 90 */	lfs f0, lit_4468@l(r3)
...
/* 806CBDAC 00000008  4B BA 4D E4 */	b cLib_chaseAngleS__FPsss
lbl_806CBDB0:
/* 806CBDB0 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CBDB4 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CBDB8 00000008  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 806CBDBC 0000000C  4B 94 06 20 */	b mDoMtx_YrotS__FPA4_fs
/* 806CBDC0 00000010  C0 3F 05 2C */	lfs f1, 0x52c(r31)
/* 806CBDC4 00000014  3C 60 80 6D */	lis r3, lit_3905@ha
/* 806CBDC8 00000018  C0 03 D0 04 */	lfs f0, lit_3905@l(r3)
...
/* 806CBDD8 00000028  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CBDDC 0000002C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CBDE0 00000030  38 81 00 18 */	addi r4, r1, 0x18
/* 806CBDE4 00000034  38 A1 00 0C */	addi r5, r1, 0xc
/* 806CBDE8 00000038  4B C7 AF 84 */	b PSMTXMultVec
...
/* 806CBE08 00000058  4B C7 B2 88 */	b PSVECAdd
...
/* 806CBE54 00000010  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 806CBE58 00000014  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 806CBE5C 00000018  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806CBE60 0000001C  4B 9A AC 4C */	b CrrPos__9dBgS_AcchFR4dBgS
lbl_806CBE64:
/* 806CBE64 00000000  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806CBE68 00000004  7C 03 07 74 */	extsb r3, r0
/* 806CBE6C 00000008  4B 96 12 00 */	b dComIfGp_getReverb__Fi
...
/* 806CBE7C 00000018  4B 94 52 34 */	b play__16mDoExt_McaMorfSOFUlSc

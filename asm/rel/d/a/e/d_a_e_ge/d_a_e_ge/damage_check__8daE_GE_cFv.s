...
/* 806C8148 00000018  3C 60 80 6D */	lis r3, lit_3904@ha
/* 806C814C 0000001C  3B E3 D0 00 */	addi r31, r3, lit_3904@l
...
/* 806C8160 00000030  4B 9B B6 D0 */	b Move__10dCcD_GSttsFv
...
/* 806C817C 0000004C  4B 9B C2 E4 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 806C818C 0000005C  4B 9B C3 6C */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 806C819C 00000004  4B 9B C2 C4 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 806C81AC 00000014  4B 9B C3 4C */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 806C81C8 00000014  4B 9B FA 3C */	b cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 806C8268 00000014  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806C826C 00000018  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806C8270 0000001C  4B C7 E2 40 */	b PSMTXCopy
/* 806C8274 00000020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C8278 00000024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C827C 00000028  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 806C8280 0000002C  D0 01 00 08 */	stfs f0, 8(r1)
/* 806C8284 00000030  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 806C8288 00000034  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 806C828C 00000038  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 806C8290 0000003C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 806C8294 00000040  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806C8298 00000044  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806C829C 00000048  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 806C82B8 00000064  4B 98 3F 60 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 806C82D8 00000084  C0 3F 00 58 */	lfs f1, 0x58(r31)	/* effective address: 806CD058 */
/* 806C82DC 00000088  4B B9 F6 78 */	b cM_rndF__Ff
/* 806C82E0 0000008C  C0 1F 00 38 */	lfs f0, 0x38(r31)	/* effective address: 806CD038 */
/* 806C82E4 00000090  EC 00 08 2A */	fadds f0, f0, f1
/* 806C82E8 00000094  D0 1E 05 2C */	stfs f0, 0x52c(r30)
/* 806C82EC 00000098  C0 3F 00 58 */	lfs f1, 0x58(r31)	/* effective address: 806CD058 */
/* 806C82F0 0000009C  4B B9 F6 64 */	b cM_rndF__Ff
/* 806C82F4 000000A0  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 806CD05C */
...
lbl_806C8304:
/* 806C8304 00000000  3C 60 80 6C */	lis r3, s_ge_surprise__FPvPv@ha
/* 806C8308 00000004  38 63 7E 7C */	addi r3, r3, s_ge_surprise__FPvPv@l
/* 806C830C 00000008  7F C4 F3 78 */	mr r4, r30
/* 806C8310 0000000C  4B 95 90 28 */	b fpcEx_Search__FPFPvPv_PvPv
/* 806C8314 00000010  C0 3F 00 58 */	lfs f1, 0x58(r31)	/* effective address: 806CD058 */
/* 806C8318 00000014  4B B9 F6 3C */	b cM_rndF__Ff
/* 806C831C 00000018  C0 5F 00 58 */	lfs f2, 0x58(r31)	/* effective address: 806CD058 */
...
/* 806C832C 00000028  4B B9 F6 28 */	b cM_rndF__Ff
/* 806C8330 0000002C  C0 1F 00 60 */	lfs f0, 0x60(r31)	/* effective address: 806CD060 */
...
/* 806C834C 00000010  C0 1F 00 64 */	lfs f0, 0x64(r31)	/* effective address: 806CD064 */

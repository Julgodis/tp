...
/* 806C8148  3C 60 80 6D */	lis r3, lit_3904@ha
/* 806C814C  3B E3 D0 00 */	addi r31, r3, lit_3904@l
...
/* 806C8160  4B 9B B6 D0 */	b Move__10dCcD_GSttsFv
...
/* 806C81C8  4B 9B FA 3C */	b cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 806C8268  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806C826C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806C8270  4B C7 E2 40 */	b PSMTXCopy
/* 806C8274  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C8278  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C827C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 806C8280  D0 01 00 08 */	stfs f0, 8(r1)
/* 806C8284  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 806C8288  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 806C828C  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 806C8290  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 806C8294  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C8298  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C829C  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 806C82B8  4B 98 3F 60 */	b setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl
...
/* 806C82DC  4B B9 F6 78 */	b cM_rndF__Ff
...
/* 806C82F0  4B B9 F6 64 */	b cM_rndF__Ff
...
lbl_806C8304:
/* 806C8304  3C 60 80 6C */	lis r3, s_ge_surprise__FPvPv@ha
/* 806C8308  38 63 7E 7C */	addi r3, r3, s_ge_surprise__FPvPv@l
/* 806C830C  7F C4 F3 78 */	mr r4, r30
/* 806C8310  4B 95 90 28 */	b fpcEx_Search__FPFPvPv_PvPv
/* 806C8314  C0 3F 00 58 */	lfs f1, 0x58(r31)
/* 806C8318  4B B9 F6 3C */	b cM_rndF__Ff
...
/* 806C832C  4B B9 F6 28 */	b cM_rndF__Ff

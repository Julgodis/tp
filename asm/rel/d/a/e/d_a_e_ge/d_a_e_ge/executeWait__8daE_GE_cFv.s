...
/* 806C89D8 00000018  3C 60 00 00 */	lis r3, lit_3904@ha /* 806CD000 */
/* 806C89DC 0000001C  3B E3 00 00 */	addi r31, r3, lit_3904@l /* 806CD000 */
/* 806C89E0 00000020  3C 60 00 00 */	lis r3, s_arrow_sub__FPvPv@ha /* 806C7DB8 */
/* 806C89E4 00000024  38 63 00 00 */	addi r3, r3, s_arrow_sub__FPvPv@l /* 806C7DB8 */
/* 806C89E8 00000028  7F C4 F3 78 */	mr r4, r30
/* 806C89EC 0000002C  4B FF EF CD */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806C8A28 00000008  C0 3F 00 84 */	lfs f1, 0x84(r31)
/* 806C8A2C 0000000C  38 A0 00 02 */	li r5, 2
/* 806C8A30 00000010  C0 5F 00 08 */	lfs f2, 8(r31)
...
/* 806C8A40 00000020  C0 3F 00 30 */	lfs f1, 0x30(r31)
/* 806C8A44 00000024  4B FF EF 75 */	bl cM_rndF__Ff
/* 806C8A48 00000028  C0 1F 00 30 */	lfs f0, 0x30(r31)
...
/* 806C8A60 00000040  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 806C8A94 00000010  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806C8A98 00000014  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
/* 806C8A9C 00000018  80 84 5D AC */	lwz r4, 0x5dac(r4)
/* 806C8AA0 0000001C  4B FF EF 19 */	bl fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806C8AA4 00000020  3C 60 00 00 */	lis r3, l_HIO@ha /* 806CD368 */
/* 806C8AA8 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l /* 806CD368 */
/* 806C8AAC 00000028  C0 03 00 08 */	lfs f0, 8(r3)
...
/* 806C8AC0 0000000C  C0 3F 00 84 */	lfs f1, 0x84(r31)
/* 806C8AC4 00000010  38 A0 00 00 */	li r5, 0
/* 806C8AC8 00000014  C0 5F 00 08 */	lfs f2, 8(r31)
...
/* 806C8AD8 00000024  3C 60 00 00 */	lis r3, s_ge_caw__FPvPv@ha /* 806C7F44 */
/* 806C8ADC 00000028  38 63 00 00 */	addi r3, r3, s_ge_caw__FPvPv@l /* 806C7F44 */
/* 806C8AE0 0000002C  7F C4 F3 78 */	mr r4, r30
/* 806C8AE4 00000030  4B FF EE D5 */	bl fpcEx_Search__FPFPvPv_PvPv
...
/* 806C8AF4 00000008  C0 3F 00 88 */	lfs f1, 0x88(r31)
/* 806C8AF8 0000000C  4B FF EE C1 */	bl checkPass__12J3DFrameCtrlFf
...
/* 806C8B40 00000014  C0 3F 00 04 */	lfs f1, 4(r31)
...
/* 806C8B74 00000008  C0 3F 00 84 */	lfs f1, 0x84(r31)
/* 806C8B78 0000000C  38 A0 00 00 */	li r5, 0
/* 806C8B7C 00000010  C0 5F 00 08 */	lfs f2, 8(r31)
...
/* 806C8B98 00000008  C0 3F 00 88 */	lfs f1, 0x88(r31)
/* 806C8B9C 0000000C  4B FF EE 1D */	bl checkPass__12J3DFrameCtrlFf
...
/* 806C8BE4 00000014  C0 3F 00 04 */	lfs f1, 4(r31)

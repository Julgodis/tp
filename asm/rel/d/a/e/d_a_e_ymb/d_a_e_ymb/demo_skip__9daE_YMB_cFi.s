...
/* 8081DC1C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC20  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC24  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081DC28  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081DC2C  38 80 00 01 */	li r4, 1
/* 8081DC30  4B A9 65 34 */	b setBattleBgmOff__8Z2SeqMgrFb
/* 8081DC34  48 00 01 14 */	b lbl_8081DD48
lbl_8081DC38:
/* 8081DC38  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8081DC3C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8081DC40  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8081DC44  38 80 00 1F */	li r4, 0x1f
/* 8081DC48  4B 85 21 4C */	b StopQuake__12dVibration_cFi
...
/* 8081DC5C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC60  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC64  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081DC68  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081DC6C  4B A9 1C 18 */	b subBgmStop__8Z2SeqMgrFv
/* 8081DC70  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC74  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC78  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081DC7C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081DC80  38 80 00 00 */	li r4, 0
/* 8081DC84  4B A9 64 E0 */	b setBattleBgmOff__8Z2SeqMgrFb
/* 8081DC88  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC8C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC90  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8081DCA8  4B AA 1C D8 */	b setForceBattleArea__13Z2SoundObjMgrFbUsUsUs
/* 8081DCAC  C0 1F 06 A0 */	lfs f0, 0x6a0(r31)
/* 8081DCB0  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)
/* 8081DCB4  3C 60 80 82 */	lis r3, lit_3910@ha
/* 8081DCB8  C0 03 18 C4 */	lfs f0, lit_3910@l(r3)
/* 8081DCBC  D0 1F 05 2C */	stfs f0, 0x52c(r31)
/* 8081DCC0  D0 1F 04 FC */	stfs f0, 0x4fc(r31)
/* 8081DCC4  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 8081DCC8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8081DCCC  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8081DCD0  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8081DCD4  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 8081DCD8  4B A5 2F 2C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 8081DCDC  B0 7F 04 E6 */	sth r3, 0x4e6(r31)
/* 8081DCE0  48 00 00 68 */	b lbl_8081DD48
lbl_8081DCE4:
/* 8081DCE4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8081DCE8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8081DCEC  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8081DCF0  38 80 00 1F */	li r4, 0x1f
/* 8081DCF4  4B 85 20 A0 */	b StopQuake__12dVibration_cFi
lbl_8081DCF8:
...
/* 8081DD1C  3C 60 80 82 */	lis r3, lit_3910@ha
/* 8081DD20  C0 03 18 C4 */	lfs f0, lit_3910@l(r3)
/* 8081DD24  D0 1F 05 2C */	stfs f0, 0x52c(r31)
/* 8081DD28  D0 1F 04 FC */	stfs f0, 0x4fc(r31)
/* 8081DD2C  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 8081DD30  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8081DD34  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8081DD38  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8081DD3C  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 8081DD40  4B A5 2E C4 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 8081DD44  B0 7F 04 E6 */	sth r3, 0x4e6(r31)
lbl_8081DD48:
/* 8081DD48  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8081DD4C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8081DD50  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 8081DDA0  4B 96 2E 78 */	b Reset__9dCamera_cF4cXyz4cXyz
/* 8081DDA4  38 7E 02 48 */	addi r3, r30, 0x248
/* 8081DDA8  4B 94 37 04 */	b Start__9dCamera_cFv
/* 8081DDAC  38 7E 02 48 */	addi r3, r30, 0x248
/* 8081DDB0  38 80 00 00 */	li r4, 0
/* 8081DDB4  4B 94 52 58 */	b SetTrimSize__9dCamera_cFl
/* 8081DDB8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8081DDBC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8081DDC0  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8081DDC4  4B 82 46 A4 */	b reset__14dEvt_control_cFv

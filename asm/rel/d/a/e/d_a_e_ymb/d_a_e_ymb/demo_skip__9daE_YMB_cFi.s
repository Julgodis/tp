...
/* 8081DC1C 0000000C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC20 00000010  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC24 00000014  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081DC28 00000018  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081DC2C 0000001C  38 80 00 01 */	li r4, 1
/* 8081DC30 00000020  4B A9 65 34 */	b setBattleBgmOff__8Z2SeqMgrFb
/* 8081DC34 00000024  48 00 01 14 */	b lbl_8081DD48
lbl_8081DC38:
/* 8081DC38 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DC3C 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8081DC40 00000008  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8081DC44 0000000C  38 80 00 1F */	li r4, 0x1f
/* 8081DC48 00000010  4B 85 21 4C */	b StopQuake__12dVibration_cFi
...
/* 8081DC5C 00000024  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC60 00000028  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC64 0000002C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081DC68 00000030  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081DC6C 00000034  4B A9 1C 18 */	b subBgmStop__8Z2SeqMgrFv
/* 8081DC70 00000038  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC74 0000003C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC78 00000040  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081DC7C 00000044  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081DC80 00000048  38 80 00 00 */	li r4, 0
/* 8081DC84 0000004C  4B A9 64 E0 */	b setBattleBgmOff__8Z2SeqMgrFb
/* 8081DC88 00000050  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC8C 00000054  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081DC90 00000058  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8081DCA8 00000070  4B AA 1C D8 */	b setForceBattleArea__13Z2SoundObjMgrFbUsUsUs
/* 8081DCAC 00000074  C0 1F 06 A0 */	lfs f0, 0x6a0(r31)
/* 8081DCB0 00000078  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)
/* 8081DCB4 0000007C  3C 60 80 82 */	lis r3, lit_3910@ha
/* 8081DCB8 00000080  C0 03 18 C4 */	lfs f0, lit_3910@l(r3)
...
/* 8081DCC8 00000090  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 8081DCCC 00000094  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 8081DCD0 00000098  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8081DCD4 0000009C  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 8081DCD8 000000A0  4B A5 2F 2C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 8081DCDC 000000A4  B0 7F 04 E6 */	sth r3, 0x4e6(r31)
/* 8081DCE0 000000A8  48 00 00 68 */	b lbl_8081DD48
lbl_8081DCE4:
/* 8081DCE4 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DCE8 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8081DCEC 00000008  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 8081DCF0 0000000C  38 80 00 1F */	li r4, 0x1f
/* 8081DCF4 00000010  4B 85 20 A0 */	b StopQuake__12dVibration_cFi
lbl_8081DCF8:
...
/* 8081DD1C 00000024  3C 60 80 82 */	lis r3, lit_3910@ha
/* 8081DD20 00000028  C0 03 18 C4 */	lfs f0, lit_3910@l(r3)
...
/* 8081DD30 00000038  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 8081DD34 0000003C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 8081DD38 00000040  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8081DD3C 00000044  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 8081DD40 00000048  4B A5 2E C4 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 8081DD44 0000004C  B0 7F 04 E6 */	sth r3, 0x4e6(r31)
lbl_8081DD48:
/* 8081DD48 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DD4C 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8081DD50 00000008  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 8081DDA0 00000058  4B 96 2E 78 */	b Reset__9dCamera_cF4cXyz4cXyz
/* 8081DDA4 0000005C  38 7E 02 48 */	addi r3, r30, 0x248
/* 8081DDA8 00000060  4B 94 37 04 */	b Start__9dCamera_cFv
/* 8081DDAC 00000064  38 7E 02 48 */	addi r3, r30, 0x248
/* 8081DDB0 00000068  38 80 00 00 */	li r4, 0
/* 8081DDB4 0000006C  4B 94 52 58 */	b SetTrimSize__9dCamera_cFl
/* 8081DDB8 00000070  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DDBC 00000074  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8081DDC0 00000078  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 8081DDC4 0000007C  4B 82 46 A4 */	b reset__14dEvt_control_cFv

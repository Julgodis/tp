...
/* 8081DC1C 0000000C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC20 00000010  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
lbl_8081DC38:
/* 8081DC38 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DC3C 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8081DC5C 00000024  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC60 00000028  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 8081DC70 00000038  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC74 0000003C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 8081DC88 00000050  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081DC8C 00000054  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
...
/* 8081DCB4 0000007C  3C 60 00 00 */	lis r3, lit_3910@ha
/* 8081DCB8 00000080  C0 03 00 00 */	lfs f0, lit_3910@l(r3)
...
/* 8081DCC8 00000090  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 8081DCCC 00000094  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
lbl_8081DCE4:
/* 8081DCE4 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DCE8 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8081DD1C 00000024  3C 60 00 00 */	lis r3, lit_3910@ha
/* 8081DD20 00000028  C0 03 00 00 */	lfs f0, lit_3910@l(r3)
...
/* 8081DD30 00000038  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 8081DD34 0000003C  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
lbl_8081DD48:
/* 8081DD48 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DD4C 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8081DDB8 00000070  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081DDBC 00000074  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l

...
/* 8081FFA0  3C 60 80 82 */	lis r3, lit_3791@ha
/* 8081FFA4  3B C3 18 AC */	addi r30, r3, lit_3791@l
/* 8081FFA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8081FFAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8081FFB0  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8081FFB4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8081FFB8  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8081FFBC  4B B2 69 2C */	b PSMTXTrans
...
/* 8081FFEC  4B 7E CD B0 */	b transM__14mDoMtx_stack_cFfff
/* 8081FFF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8081FFF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8081FFF8  A8 9F 06 EA */	lha r4, 0x6ea(r31)
/* 8081FFFC  4B 7E C3 A0 */	b mDoMtx_XrotM__FPA4_fs
/* 80820000  C0 3E 00 18 */	lfs f1, 0x18(r30)
/* 80820004  FC 40 08 90 */	fmr f2, f1
/* 80820008  C0 7E 01 B8 */	lfs f3, 0x1b8(r30)
/* 8082000C  4B 7E CD 90 */	b transM__14mDoMtx_stack_cFfff
/* 80820010  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 80820014  80 83 00 04 */	lwz r4, 4(r3)
/* 80820018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8082001C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80820020  38 84 00 24 */	addi r4, r4, 0x24
/* 80820024  4B B2 64 8C */	b PSMTXCopy
/* 80820028  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 8082002C  4B 7F 11 C0 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 80820044  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80820048  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8082004C  4B B2 64 64 */	b PSMTXCopy
/* 80820050  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80820054  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80820058  38 80 00 00 */	li r4, 0
/* 8082005C  38 A0 C0 00 */	li r5, -16384
/* 80820060  38 C0 00 00 */	li r6, 0
/* 80820064  4B 7E C2 3C */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80820068  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8082006C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80820070  38 9F 07 68 */	addi r4, r31, 0x768
/* 80820074  4B B2 64 3C */	b PSMTXCopy
/* 80820078  80 7F 07 98 */	lwz r3, 0x798(r31)
/* 8082007C  28 03 00 00 */	cmplwi r3, 0
/* 80820080  41 82 00 08 */	beq lbl_80820088
/* 80820084  4B 85 B9 3C */	b Move__4dBgWFv
lbl_80820088:

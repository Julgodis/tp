...
/* 8081C4FC  4B B4 5C D8 */	b _savegpr_27
...
/* 8081C574  4B A4 A5 C0 */	b __mi__4cXyzCFRC3Vec
...
/* 8081C590  4B A4 B0 E4 */	b cM_atan2s__Fff
...
/* 8081C5C4  4B A4 B0 B0 */	b cM_atan2s__Fff
...
/* 8081C5F8  38 04 1C F8 */	addi r0, r4, data_80821CF8@l
/* 8081C5FC  90 01 00 10 */	stw r0, 0x10(r1)
/* 8081C600  3C 80 80 82 */	lis r4, data_80821CFC@ha
/* 8081C604  38 04 1C FC */	addi r0, r4, data_80821CFC@l
...
/* 8081C630  4B 83 04 60 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8081C634  7C 7B 1B 79 */	or. r27, r3, r3
/* 8081C638  41 82 00 FC */	beq lbl_8081C734
/* 8081C63C  38 61 00 3C */	addi r3, r1, 0x3c
/* 8081C640  4B B2 AA F8 */	b PSVECSquareMag
...
/* 8081C6B0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8081C6B4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8081C720  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8081C724  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8081C728:
...
/* 8081C74C  3C 80 80 82 */	lis r4, data_80821CF8@ha
/* 8081C750  38 04 1C F8 */	addi r0, r4, data_80821CF8@l
/* 8081C754  90 01 00 10 */	stw r0, 0x10(r1)
/* 8081C758  3C 80 80 82 */	lis r4, data_80821CFC@ha
/* 8081C75C  38 04 1C FC */	addi r0, r4, data_80821CFC@l
...
/* 8081C788  4B 83 03 08 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8081C7BC  4B B4 5A 64 */	b _restgpr_27

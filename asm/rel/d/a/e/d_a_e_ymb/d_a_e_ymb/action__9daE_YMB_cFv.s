...
/* 8081FAD8 00000010  4B FF 65 A1 */	bl _savegpr_29
/* 8081FADC 00000014  7C 7D 1B 78 */	mr r29, r3
/* 8081FAE0 00000018  3C 60 00 00 */	lis r3, lit_3791@ha
/* 8081FAE4 0000001C  3B E3 00 00 */	addi r31, r3, lit_3791@l
/* 8081FAE8 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8081FAEC 00000024  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8081FAF0 00000028  83 C3 5D AC */	lwz r30, 0x5dac(r3)
...
/* 8081FB4C 00000004  C0 1F 00 18 */	lfs f0, 0x18(r31)
...
/* 8081FC5C 00000018  3C 60 00 00 */	lis r3, lit_7867@ha
/* 8081FC60 0000001C  38 63 00 00 */	addi r3, r3, lit_7867@l
...
/* 8081FC74 00000030  7F A3 EB 78 */	mr r3, r29
/* 8081FC78 00000034  4B FF 85 7D */	bl executeWait__9daE_YMB_cFv
/* 8081FC7C 00000038  48 00 00 90 */	b lbl_8081FD0C
/* 8081FC80 0000003C  7F A3 EB 78 */	mr r3, r29
/* 8081FC84 00000040  4B FF 8E 65 */	bl executeFly__9daE_YMB_cFv
/* 8081FC88 00000044  48 00 00 84 */	b lbl_8081FD0C
/* 8081FC8C 00000048  7F A3 EB 78 */	mr r3, r29
/* 8081FC90 0000004C  4B FF 99 81 */	bl executeFlyAttack__9daE_YMB_cFv
/* 8081FC94 00000050  48 00 00 78 */	b lbl_8081FD0C
/* 8081FC98 00000054  7F A3 EB 78 */	mr r3, r29
/* 8081FC9C 00000058  4B FF A3 35 */	bl executeRunAway__9daE_YMB_cFv
/* 8081FCA0 0000005C  48 00 00 6C */	b lbl_8081FD0C
/* 8081FCA4 00000060  7F A3 EB 78 */	mr r3, r29
/* 8081FCA8 00000064  4B FF AA 71 */	bl executeGuard__9daE_YMB_cFv
/* 8081FCAC 00000068  48 00 00 60 */	b lbl_8081FD0C
/* 8081FCB0 0000006C  7F A3 EB 78 */	mr r3, r29
/* 8081FCB4 00000070  4B FF AB D9 */	bl executeSwim__9daE_YMB_cFv
/* 8081FCB8 00000074  48 00 00 54 */	b lbl_8081FD0C
/* 8081FCBC 00000078  7F A3 EB 78 */	mr r3, r29
/* 8081FCC0 0000007C  4B FF BA CD */	bl executeWaterJump__9daE_YMB_cFv
/* 8081FCC4 00000080  48 00 00 48 */	b lbl_8081FD0C
/* 8081FCC8 00000084  7F A3 EB 78 */	mr r3, r29
/* 8081FCCC 00000088  4B FF C2 1D */	bl executeDamage__9daE_YMB_cFv
/* 8081FCD0 0000008C  48 00 00 3C */	b lbl_8081FD0C
/* 8081FCD4 00000090  7F A3 EB 78 */	mr r3, r29
/* 8081FCD8 00000094  4B FF D1 95 */	bl executeDown__9daE_YMB_cFv
/* 8081FCDC 00000098  48 00 00 30 */	b lbl_8081FD0C
/* 8081FCE0 0000009C  7F A3 EB 78 */	mr r3, r29
/* 8081FCE4 000000A0  4B FF D8 B1 */	bl executeDeath__9daE_YMB_cFv
/* 8081FCE8 000000A4  48 00 00 24 */	b lbl_8081FD0C
/* 8081FCEC 000000A8  7F A3 EB 78 */	mr r3, r29
/* 8081FCF0 000000AC  4B FF E1 95 */	bl executeLakeDemo__9daE_YMB_cFv
/* 8081FCF4 000000B0  48 00 00 18 */	b lbl_8081FD0C
/* 8081FCF8 000000B4  7F A3 EB 78 */	mr r3, r29
/* 8081FCFC 000000B8  4B FF E8 B9 */	bl executeStartDemo__9daE_YMB_cFv
/* 8081FD00 000000BC  48 00 00 0C */	b lbl_8081FD0C
/* 8081FD04 000000C0  7F A3 EB 78 */	mr r3, r29
/* 8081FD08 000000C4  4B FF F5 D9 */	bl executeBattleDemo__9daE_YMB_cFv
lbl_8081FD0C:
/* 8081FD0C 00000000  38 7D 05 C4 */	addi r3, r29, 0x5c4
/* 8081FD10 00000004  38 80 00 00 */	li r4, 0
/* 8081FD14 00000008  4B FF 63 65 */	bl setLinkSearch__15Z2CreatureEnemyFb
/* 8081FD18 0000000C  7F A3 EB 78 */	mr r3, r29
/* 8081FD1C 00000010  38 80 00 00 */	li r4, 0
/* 8081FD20 00000014  4B FF 63 59 */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8081FD48 0000000C  C0 3F 00 18 */	lfs f1, 0x18(r31)
...
/* 8081FD70 00000034  4B FF 63 09 */	bl PSVECSquareDistance
/* 8081FD74 00000038  C0 1F 00 18 */	lfs f0, 0x18(r31)
...
/* 8081FD84 00000008  C8 9F 00 40 */	lfd f4, 0x40(r31)
/* 8081FD88 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 8081FD8C 00000010  C8 7F 00 48 */	lfd f3, 0x48(r31)
...
lbl_8081FDD4:
/* 8081FDD4 00000000  C8 1F 00 50 */	lfd f0, 0x50(r31)
/* 8081FDD8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8081FDDC 00000000  40 80 00 10 */	bge lbl_8081FDEC
/* 8081FDE0 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081FDE4 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8081FE50 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081FE54 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8081FE58:
/* 8081FE58 00000000  C0 1F 00 58 */	lfs f0, 0x58(r31)
...
/* 8081FEB4 0000000C  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081FEB8 00000010  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081FEBC 00000014  80 63 00 00 */	lwz r3, 0(r3)
/* 8081FEC0 00000018  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081FEC4 0000001C  38 80 00 03 */	li r4, 3
/* 8081FEC8 00000020  4B FF 61 B1 */	bl changeSubBgmStatus__8Z2SeqMgrFl
lbl_8081FECC:
...
/* 8081FEE8 0000001C  C0 1F 00 18 */	lfs f0, 0x18(r31)
...
/* 8081FEF8 00000008  C0 3F 00 28 */	lfs f1, 0x28(r31)
/* 8081FEFC 0000000C  C0 5F 00 04 */	lfs f2, 4(r31)
/* 8081FF00 00000010  4B FF 61 79 */	bl cLib_chaseF__FPfff
...
lbl_8081FF10:
/* 8081FF10 00000000  C0 3F 00 84 */	lfs f1, 0x84(r31)
/* 8081FF14 00000004  C0 1F 00 0C */	lfs f0, 0xc(r31)
/* 8081FF18 00000008  EC 02 00 24 */	fdivs f0, f2, f0
/* 8081FF1C 0000000C  EC 21 00 2A */	fadds f1, f1, f0
/* 8081FF20 00000010  C0 1F 00 04 */	lfs f0, 4(r31)
...
/* 8081FF34 00000004  C0 5F 00 04 */	lfs f2, 4(r31)
/* 8081FF38 00000008  4B FF 61 41 */	bl cLib_chaseF__FPfff
...
/* 8081FF54 00000008  4B FF 61 25 */	bl dComIfGp_getReverb__Fi
...
/* 8081FF64 00000018  4B FF 61 15 */	bl play__16mDoExt_McaMorfSOFUlSc
/* 8081FF68 0000001C  80 7D 05 C0 */	lwz r3, 0x5c0(r29)
/* 8081FF6C 00000020  4B FF 61 0D */	bl play__14mDoExt_baseAnmFv
/* 8081FF70 00000024  39 61 00 40 */	addi r11, r1, 0x40
/* 8081FF74 00000028  4B FF 61 05 */	bl _restgpr_29

...
/* 8081FAD8  4B B4 27 04 */	b _savegpr_29
/* 8081FADC  7C 7D 1B 78 */	mr r29, r3
/* 8081FAE0  3C 60 80 82 */	lis r3, lit_3791@ha
/* 8081FAE4  3B E3 18 AC */	addi r31, r3, lit_3791@l
/* 8081FAE8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8081FAEC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8081FAF0  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 8081FC5C  3C 60 80 82 */	lis r3, lit_7867@ha
/* 8081FC60  38 63 1D 40 */	addi r3, r3, lit_7867@l
...
/* 8081FD14  4B AA 1E 68 */	b setLinkSearch__15Z2CreatureEnemyFb
/* 8081FD18  7F A3 EB 78 */	mr r3, r29
/* 8081FD1C  38 80 00 00 */	li r4, 0
/* 8081FD20  4B 7F A9 AC */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
...
/* 8081FD70  4B B2 76 2C */	b PSVECSquareDistance
...
/* 8081FDE0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8081FDE4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8081FE50  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8081FE54  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8081FE58:
...
/* 8081FEB4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8081FEB8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8081FEBC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8081FEC0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8081FEC4  38 80 00 03 */	li r4, 3
/* 8081FEC8  4B A9 1F 2C */	b changeSubBgmStatus__8Z2SeqMgrFl
lbl_8081FECC:
...
/* 8081FF00  4B A5 08 40 */	b cLib_chaseF__FPfff
...
/* 8081FF38  4B A5 08 08 */	b cLib_chaseF__FPfff
...
/* 8081FF54  4B 80 D1 18 */	b dComIfGp_getReverb__Fi
/* 8081FF58  7C 65 1B 78 */	mr r5, r3
/* 8081FF5C  80 7D 05 BC */	lwz r3, 0x5bc(r29)
/* 8081FF60  38 80 00 00 */	li r4, 0
/* 8081FF64  4B 7F 11 4C */	b play__16mDoExt_McaMorfSOFUlSc
/* 8081FF68  80 7D 05 C0 */	lwz r3, 0x5c0(r29)
/* 8081FF6C  4B 7E D4 BC */	b play__14mDoExt_baseAnmFv
/* 8081FF70  39 61 00 40 */	addi r11, r1, 0x40
/* 8081FF74  4B B4 22 B4 */	b _restgpr_29

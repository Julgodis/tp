...
/* 80780970  4B BE 18 44 */	b _savegpr_19
/* 80780974  7C 7E 1B 78 */	mr r30, r3
/* 80780978  7C 9A 23 78 */	mr r26, r4
/* 8078097C  7C BB 2B 78 */	mr r27, r5
/* 80780980  7C DC 33 78 */	mr r28, r6
/* 80780984  3C 60 80 78 */	lis r3, cNullVec__6Z2Calc@ha
/* 80780988  3A E3 0F A8 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 8078098C  3C 60 80 78 */	lis r3, lit_3903@ha
/* 80780990  3B E3 0D C4 */	addi r31, r3, lit_3903@l
/* 80780994  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80780998  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8078099C  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807809A0  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 807809A4  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 807809CC  4B A2 BB B0 */	b dKy_darkworld_check__Fv
...
/* 807809F0  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 807809F4  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 807809F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 807809FC  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 80780A00  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 80780A04  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 80780A08  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 80780A0C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80780A10  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80780A14  4B BC 5A 9C */	b PSMTXCopy
...
/* 80780A2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80780A30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80780A34  38 81 00 4C */	addi r4, r1, 0x4c
/* 80780A38  38 A1 00 58 */	addi r5, r1, 0x58
/* 80780A3C  4B BC 63 30 */	b PSMTXMultVec
/* 80780A40  38 61 00 34 */	addi r3, r1, 0x34
/* 80780A44  38 81 00 58 */	addi r4, r1, 0x58
/* 80780A48  7F 65 DB 78 */	mr r5, r27
/* 80780A4C  4B AE 60 E8 */	b __mi__4cXyzCFRC3Vec
...
/* 80780A68  4B AE 6C 0C */	b cM_atan2s__Fff
...
/* 80780A9C  4B AE 6B D8 */	b cM_atan2s__Fff
...
/* 80780AB8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80780ABC  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 80780AC0  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 80780B0C  4B 8C BF 84 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80780B10  7C 79 1B 79 */	or. r25, r3, r3
/* 80780B14  41 82 00 FC */	beq lbl_80780C10
/* 80780B18  38 61 00 40 */	addi r3, r1, 0x40
/* 80780B1C  4B BC 66 1C */	b PSVECSquareMag
...
/* 80780B8C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80780B90  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80780BFC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80780C00  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80780C04:
...
/* 80780C54  4B 8C BE 3C */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80780C90  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80780C94  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 80780CC0  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 80780D00  4B 8C C7 CC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80780D60  4B BE 14 A0 */	b _restgpr_19

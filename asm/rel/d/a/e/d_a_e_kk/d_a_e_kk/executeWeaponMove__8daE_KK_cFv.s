...
/* 806FD2A4  4B C6 4F 2C */	b _savegpr_26
/* 806FD2A8  7C 7D 1B 78 */	mr r29, r3
/* 806FD2AC  3C 60 80 70 */	lis r3, lit_3792@ha
/* 806FD2B0  3B E3 F5 E8 */	addi r31, r3, lit_3792@l
/* 806FD2B4  38 00 00 00 */	li r0, 0
/* 806FD2B8  90 01 00 1C */	stw r0, 0x1c(r1)
/* 806FD2BC  38 61 00 50 */	addi r3, r1, 0x50
/* 806FD2C0  4B 97 A9 A8 */	b __ct__11dBgS_LinChkFv
...
/* 806FD2D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806FD2DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806FD2E0  4B C4 91 D0 */	b PSMTXCopy
/* 806FD2E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FD2E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FD2EC  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 806FD2F0  D0 01 00 44 */	stfs f0, 0x44(r1)
/* 806FD2F4  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 806FD2F8  D0 01 00 48 */	stfs f0, 0x48(r1)
/* 806FD2FC  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 806FD318  4B 91 C6 A4 */	b fopAcM_SearchByID__FUiPP10fopAc_ac_c
...
/* 806FD334  4B 91 C9 48 */	b fopAcM_delete__FP10fopAc_ac_c
/* 806FD338  38 61 00 50 */	addi r3, r1, 0x50
/* 806FD33C  38 80 FF FF */	li r4, -1
/* 806FD340  4B 97 A9 9C */	b __dt__11dBgS_LinChkFv
...
/* 806FD39C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806FD3A0  3B 64 61 C0 */	addi r27, r4, struct_804061C0+0x0@l
/* 806FD3A4  80 9B 5D AC */	lwz r4, 0x5dac(r27)	/* effective address: 8040BF6C */
/* 806FD3A8  4B 91 D3 90 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806FD3AC  B0 7D 04 DC */	sth r3, 0x4dc(r29)
/* 806FD3B0  7F A3 EB 78 */	mr r3, r29
/* 806FD3B4  80 9B 5D AC */	lwz r4, 0x5dac(r27)
/* 806FD3B8  4B 91 D3 80 */	b fopAcM_searchActorAngleX__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806FD3E4  4B 91 D3 FC */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806FD3E8  C0 5F 00 80 */	lfs f2, 0x80(r31)
/* 806FD3EC  3C 60 80 70 */	lis r3, l_HIO@ha
/* 806FD3F0  3B 83 F8 90 */	addi r28, r3, l_HIO@l
/* 806FD3F4  C0 1C 00 10 */	lfs f0, 0x10(r28)	/* effective address: 806FF8A0 */
...
/* 806FD414  4B 91 D3 CC */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806FD4D8  4B 98 6D E8 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 806FD518  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806FD51C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806FD520  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806FD548  4B BA E4 3C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806FD55C  4B 91 C7 20 */	b fopAcM_delete__FP10fopAc_ac_c
/* 806FD560  38 61 00 50 */	addi r3, r1, 0x50
/* 806FD564  38 80 FF FF */	li r4, -1
/* 806FD568  4B 97 A7 74 */	b __dt__11dBgS_LinChkFv
/* 806FD56C  48 00 03 AC */	b lbl_806FD918
lbl_806FD570:
/* 806FD570  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806FD574  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806FD578  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806FD57C  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 806FD580  4B 90 EE 5C */	b mDoMtx_YrotS__FPA4_fs
/* 806FD584  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806FD588  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806FD58C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806FD590  A8 9D 04 DC */	lha r4, 0x4dc(r29)
/* 806FD594  4B 90 EE 08 */	b mDoMtx_XrotM__FPA4_fs
...
/* 806FD5B8  4B B7 39 34 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806FD5D8  4B B7 30 30 */	b cLib_addCalcAngleS2__FPssss
...
/* 806FD5FC  4B B7 30 0C */	b cLib_addCalcAngleS2__FPssss
lbl_806FD600:
...
/* 806FD610  4B 97 A7 54 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
...
/* 806FD62C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806FD630  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806FD634  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806FD638  38 81 00 50 */	addi r4, r1, 0x50
/* 806FD63C  4B 97 6D 78 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 806FD68C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806FD690  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806FD694  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806FD6BC  4B BA E2 C8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_806FD6C0:
...
/* 806FD6D0  4B 98 61 90 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 806FD6D4  C0 3F 00 80 */	lfs f1, 0x80(r31)
/* 806FD6D8  4B B6 A2 7C */	b cM_rndF__Ff
...
/* 806FD720  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806FD724  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806FD728  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806FD750  4B BA E2 34 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806FD754  7F A3 EB 78 */	mr r3, r29
/* 806FD758  4B 91 C5 24 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_806FD75C:
/* 806FD75C  38 7D 0B 00 */	addi r3, r29, 0xb00
/* 806FD760  4B 98 6D 00 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 806FD778  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806FD77C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806FD780  4B C4 8D 30 */	b PSMTXCopy
...
/* 806FD798  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FD79C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FD7A0  38 81 00 20 */	addi r4, r1, 0x20
/* 806FD7A4  38 BD 06 80 */	addi r5, r29, 0x680
/* 806FD7A8  4B C4 95 C4 */	b PSMTXMultVec
...
/* 806FD7D8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806FD7DC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806FD7E0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806FD808  4B BA E1 7C */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806FD80C  7F A3 EB 78 */	mr r3, r29
/* 806FD810  4B 91 C4 6C */	b fopAcM_delete__FP10fopAc_ac_c
/* 806FD814  38 61 00 50 */	addi r3, r1, 0x50
/* 806FD818  38 80 FF FF */	li r4, -1
/* 806FD81C  4B 97 A4 C0 */	b __dt__11dBgS_LinChkFv
...
/* 806FD838  4B 98 6C 28 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 806FD850  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806FD854  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806FD858  4B C4 8C 58 */	b PSMTXCopy
...
/* 806FD870  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806FD874  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806FD878  38 81 00 20 */	addi r4, r1, 0x20
/* 806FD87C  38 BD 06 80 */	addi r5, r29, 0x680
/* 806FD880  4B C4 94 EC */	b PSMTXMultVec
...
/* 806FD8B0  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806FD8B4  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806FD8B8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806FD8E0  4B BA E0 A4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 806FD8E4  7F A3 EB 78 */	mr r3, r29
/* 806FD8E8  4B 91 C3 94 */	b fopAcM_delete__FP10fopAc_ac_c
/* 806FD8EC  38 61 00 50 */	addi r3, r1, 0x50
/* 806FD8F0  38 80 FF FF */	li r4, -1
/* 806FD8F4  4B 97 A3 E8 */	b __dt__11dBgS_LinChkFv
...
/* 806FD914  4B 97 A3 C8 */	b __dt__11dBgS_LinChkFv
lbl_806FD918:
/* 806FD918  39 61 00 F0 */	addi r11, r1, 0xf0
/* 806FD91C  4B C6 49 00 */	b _restgpr_26

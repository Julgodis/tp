...
/* 8074A6DC  4B C1 7B 00 */	b _savegpr_29
/* 8074A6E0  7C 7E 1B 78 */	mr r30, r3
/* 8074A6E4  3C 60 80 75 */	lis r3, lit_3910@ha
/* 8074A6E8  3B E3 BF 3C */	addi r31, r3, lit_3910@l
...
/* 8074A704  3C 60 80 75 */	lis r3, l_HIO@ha
/* 8074A708  38 83 C3 94 */	addi r4, r3, l_HIO@l
/* 8074A70C  C0 04 00 38 */	lfs f0, 0x38(r4)	/* effective address: 8074C3CC */
...
/* 8074A720  C0 04 00 3C */	lfs f0, 0x3c(r4)	/* effective address: 8074C3D0 */
...
/* 8074A734  C0 04 00 40 */	lfs f0, 0x40(r4)	/* effective address: 8074C3D4 */
...
/* 8074A74C  C0 24 00 48 */	lfs f1, 0x48(r4)	/* effective address: 8074C3DC */
/* 8074A750  C0 5F 00 28 */	lfs f2, 0x28(r31)
/* 8074A754  4B B2 5F EC */	b cLib_chaseF__FPfff
...
/* 8074A768  4B A5 F5 F8 */	b dKy_BossLight_set__FP4cXyzP8_GXColorfUc
lbl_8074A76C:
/* 8074A76C  80 7E 07 04 */	lwz r3, 0x704(r30)
/* 8074A770  83 A3 00 04 */	lwz r29, 4(r3)
/* 8074A774  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8074A778  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8074A77C  38 80 00 00 */	li r4, 0
/* 8074A780  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 8074A784  38 DE 01 0C */	addi r6, r30, 0x10c
/* 8074A788  4B A5 90 3C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8074A78C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8074A790  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8074A794  80 9D 00 04 */	lwz r4, 4(r29)
/* 8074A798  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8074A79C  4B A5 A6 04 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8074A7BC  4B 8C 2E 2C */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
/* 8074A7C0  80 7E 07 04 */	lwz r3, 0x704(r30)
/* 8074A7C4  4B 8C 69 FC */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 8074A810  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 8074A814  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 8074A818  4B 8E 40 F8 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 8074A81C  90 7E 07 1C */	stw r3, 0x71c(r30)
/* 8074A820  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8074A824  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8074A828  80 9E 07 0C */	lwz r4, 0x70c(r30)
/* 8074A82C  80 84 00 04 */	lwz r4, 4(r4)
/* 8074A830  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8074A834  4B A5 A5 6C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8074A838  80 7E 07 0C */	lwz r3, 0x70c(r30)
/* 8074A83C  4B 8C 34 88 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 8074A840  80 7E 07 10 */	lwz r3, 0x710(r30)
/* 8074A844  80 83 00 04 */	lwz r4, 4(r3)
/* 8074A848  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8074A84C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8074A850  80 84 00 04 */	lwz r4, 4(r4)
/* 8074A854  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8074A858  4B A5 A5 48 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8074A894  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A898  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A89C  A8 04 00 14 */	lha r0, 0x14(r4)	/* effective address: 8074C3A8 */
...
/* 8074A8BC  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A8C0  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A8C4  A8 04 00 16 */	lha r0, 0x16(r4)	/* effective address: 8074C3AA */
...
/* 8074A8E4  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A8E8  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A8EC  A8 04 00 18 */	lha r0, 0x18(r4)	/* effective address: 8074C3AC */
...
/* 8074A90C  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A910  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A914  A8 04 00 20 */	lha r0, 0x20(r4)	/* effective address: 8074C3B4 */
...
/* 8074A934  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A938  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A93C  A8 04 00 1A */	lha r0, 0x1a(r4)	/* effective address: 8074C3AE */
...
/* 8074A95C  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A960  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A964  A8 04 00 1C */	lha r0, 0x1c(r4)	/* effective address: 8074C3B0 */
...
/* 8074A984  3C 80 80 75 */	lis r4, l_HIO@ha
/* 8074A988  38 84 C3 94 */	addi r4, r4, l_HIO@l
/* 8074A98C  A8 04 00 1E */	lha r0, 0x1e(r4)	/* effective address: 8074C3B2 */
...
/* 8074AA7C  4B 8C 5C 04 */	b entryDL__14mDoExt_McaMorfFv
/* 8074AA80  80 7E 07 08 */	lwz r3, 0x708(r30)
/* 8074AA84  80 83 00 04 */	lwz r4, 4(r3)
/* 8074AA88  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8074AA8C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8074AA90  80 84 00 04 */	lwz r4, 4(r4)
/* 8074AA94  38 BE 01 0C */	addi r5, r30, 0x10c
/* 8074AA98  4B A5 A3 08 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 8074AA9C  80 7E 07 08 */	lwz r3, 0x708(r30)
/* 8074AAA0  4B 8C 5B E0 */	b entryDL__14mDoExt_McaMorfFv
/* 8074AAA4  38 60 00 01 */	li r3, 1
/* 8074AAA8  39 61 00 40 */	addi r11, r1, 0x40
/* 8074AAAC  4B C1 77 7C */	b _restgpr_29

...
/* 8074B4EC  4B C1 6C EC */	b _savegpr_28
/* 8074B4F0  7C 7D 1B 78 */	mr r29, r3
/* 8074B4F4  3C 80 80 75 */	lis r4, lit_3910@ha
/* 8074B4F8  3B E4 BF 3C */	addi r31, r4, lit_3910@l
...
/* 8074B514  4B 8C D6 50 */	b __ct__10fopAc_ac_cFv
/* 8074B518  38 7E 06 3C */	addi r3, r30, 0x63c
/* 8074B51C  4B AF E9 E4 */	b __ct__10dMsgFlow_cFv
/* 8074B520  38 7E 07 20 */	addi r3, r30, 0x720
/* 8074B524  4B B7 5A 40 */	b __ct__15Z2CreatureEnemyFv
/* 8074B528  38 7E 07 C4 */	addi r3, r30, 0x7c4
/* 8074B52C  4B 92 A9 80 */	b __ct__12dBgS_AcchCirFv
/* 8074B530  3B 9E 08 04 */	addi r28, r30, 0x804
/* 8074B534  7F 83 E3 78 */	mr r3, r28
/* 8074B538  4B 92 AB 68 */	b __ct__9dBgS_AcchFv
/* 8074B53C  3C 60 80 75 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 8074B540  38 63 C2 C8 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 8074B55C  4B 92 D9 0C */	b SetObj__16dBgS_PolyPassChkFv
/* 8074B560  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8074B564  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8074B568  90 1E 09 F4 */	stw r0, 0x9f4(r30)
/* 8074B56C  38 7E 09 F8 */	addi r3, r30, 0x9f8
/* 8074B570  4B 93 81 F0 */	b __ct__10dCcD_GSttsFv
/* 8074B574  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8074B578  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8074B590  4B 93 84 98 */	b __ct__12dCcD_GObjInfFv
/* 8074B594  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 8074B598  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8074B59C  90 1C 01 20 */	stw r0, 0x120(r28)
/* 8074B5A0  3C 60 80 75 */	lis r3, __vt__8cM3dGAab@ha
/* 8074B5A4  38 03 C2 BC */	addi r0, r3, __vt__8cM3dGAab@l
/* 8074B5A8  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 8074B5AC  3C 60 80 75 */	lis r3, __vt__8cM3dGCyl@ha
/* 8074B5B0  38 03 C2 B0 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 8074B5B4  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8074B5B8  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 8074B5BC  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
/* 8074B5C0  90 7C 01 20 */	stw r3, 0x120(r28)
/* 8074B5C4  38 03 00 58 */	addi r0, r3, 0x58
/* 8074B5C8  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8074B5CC  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 8074B5D0  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 8074B5F8  3C 80 80 75 */	lis r4, stringBase0@ha
/* 8074B5FC  38 84 C1 48 */	addi r4, r4, stringBase0@l
/* 8074B600  4B 8E 18 BC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8074B614  3C 80 80 74 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 8074B618  38 84 23 D0 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 8074B61C  38 A0 45 E0 */	li r5, 0x45e0
/* 8074B620  4B 8C EE 90 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8074B634:
/* 8074B634  3C 60 80 75 */	lis r3, struct_8074C384+0x1@ha
/* 8074B638  8C 03 C3 85 */	lbzu r0, struct_8074C384+0x1@l(r3)
...
/* 8074B680  4B 90 61 6C */	b dPath_GetRoomPath__Fii
...
/* 8074B6C4  4B 8C EE 64 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 8074B714  4B 92 AB 34 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 8074B72C  4B B7 59 68 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
...
/* 8074B778  3C 80 80 75 */	lis r4, stringBase0@ha
/* 8074B77C  38 84 C1 48 */	addi r4, r4, stringBase0@l
/* 8074B780  4B B7 64 10 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 8074B79C  3C 60 80 74 */	lis r3, JointCallBack__FP8J3DJointi@ha
/* 8074B7A0  38 03 25 B4 */	addi r0, r3, JointCallBack__FP8J3DJointi@l
/* 8074B7A4  90 04 00 04 */	stw r0, 4(r4)
/* 8074B7A8  38 60 00 00 */	li r3, 0
/* 8074B7AC  4B 8E 11 D0 */	b getLayerNo__14dComIfG_play_cFi
/* 8074B7B0  2C 03 00 02 */	cmpwi r3, 2
/* 8074B7B4  41 82 00 14 */	beq lbl_8074B7C8
/* 8074B7B8  38 60 00 00 */	li r3, 0
/* 8074B7BC  4B 8E 11 C0 */	b getLayerNo__14dComIfG_play_cFi
...
/* 8074B820  4B C1 6A 04 */	b _restgpr_28

...
/* 8074B4F4 00000018  3C 80 00 00 */	lis r4, lit_3910@ha /* 8074BF3C */
/* 8074B4F8 0000001C  3B E4 00 00 */	addi r31, r4, lit_3910@l /* 8074BF3C */
...
/* 8074B53C 00000060  3C 60 00 00 */	lis r3, __vt__12dBgS_ObjAcch@ha /* 8074C2C8 */
/* 8074B540 00000064  38 63 00 00 */	addi r3, r3, __vt__12dBgS_ObjAcch@l /* 8074C2C8 */
...
/* 8074B560 00000084  3C 60 00 00 */	lis r3, __vt__9cCcD_Stts@ha /* 803C3728 */
/* 8074B564 00000088  38 03 00 00 */	addi r0, r3, __vt__9cCcD_Stts@l /* 803C3728 */
...
/* 8074B574 00000098  3C 60 00 00 */	lis r3, __vt__9dCcD_Stts@ha /* 803AC2E4 */
/* 8074B578 0000009C  38 63 00 00 */	addi r3, r3, __vt__9dCcD_Stts@l /* 803AC2E4 */
...
/* 8074B594 000000B8  3C 60 00 00 */	lis r3, __vt__14cCcD_ShapeAttr@ha /* 803C36D0 */
/* 8074B598 000000BC  38 03 00 00 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l /* 803C36D0 */
/* 8074B59C 000000C0  90 1C 01 20 */	stw r0, 0x120(r28)
/* 8074B5A0 000000C4  3C 60 00 00 */	lis r3, __vt__8cM3dGAab@ha /* 8074C2BC */
/* 8074B5A4 000000C8  38 03 00 00 */	addi r0, r3, __vt__8cM3dGAab@l /* 8074C2BC */
/* 8074B5A8 000000CC  90 1C 01 1C */	stw r0, 0x11c(r28)
/* 8074B5AC 000000D0  3C 60 00 00 */	lis r3, __vt__8cM3dGCyl@ha /* 8074C2B0 */
/* 8074B5B0 000000D4  38 03 00 00 */	addi r0, r3, __vt__8cM3dGCyl@l /* 8074C2B0 */
/* 8074B5B4 000000D8  90 1C 01 38 */	stw r0, 0x138(r28)
/* 8074B5B8 000000DC  3C 60 00 00 */	lis r3, __vt__12cCcD_CylAttr@ha /* 803C35A4 */
/* 8074B5BC 000000E0  38 63 00 00 */	addi r3, r3, __vt__12cCcD_CylAttr@l /* 803C35A4 */
...
/* 8074B5CC 000000F0  3C 60 00 00 */	lis r3, __vt__8dCcD_Cyl@ha /* 803AC050 */
/* 8074B5D0 000000F4  38 63 00 00 */	addi r3, r3, __vt__8dCcD_Cyl@l /* 803AC050 */
...
/* 8074B5F8 00000004  3C 80 00 00 */	lis r4, stringBase0@ha /* 8074C148 */
/* 8074B5FC 00000008  38 84 00 00 */	addi r4, r4, stringBase0@l /* 8074C148 */
...
/* 8074B614 00000020  3C 80 00 00 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 807423D0 */
/* 8074B618 00000024  38 84 00 00 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 807423D0 */
...
lbl_8074B634:
/* 8074B634 00000000  3C 60 00 00 */	lis r3, struct_8074C384+0x1@ha /* 8074C385 */
/* 8074B638 00000004  8C 03 00 00 */	lbzu r0, struct_8074C384+0x1@l(r3) /* 8074C385 */
...
/* 8074B654 00000020  3C 60 00 00 */	lis r3, l_HIO@ha /* 8074C394 */
/* 8074B658 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l /* 8074C394 */
...
/* 8074B778 00000118  3C 80 00 00 */	lis r4, stringBase0@ha /* 8074C148 */
/* 8074B77C 0000011C  38 84 00 00 */	addi r4, r4, stringBase0@l /* 8074C148 */
...
/* 8074B79C 0000013C  3C 60 00 00 */	lis r3, JointCallBack__FP8J3DJointi@ha /* 807425B4 */
/* 8074B7A0 00000140  38 03 00 00 */	addi r0, r3, JointCallBack__FP8J3DJointi@l /* 807425B4 */

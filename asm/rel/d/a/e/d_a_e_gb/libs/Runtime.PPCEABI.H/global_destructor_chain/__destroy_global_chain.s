...
/* 806C1CA4 00000010  3C 60 80 6C */	lis r3, __global_destructor_chain@ha
/* 806C1CA8 00000014  3B E3 79 20 */	addi r31, r3, __global_destructor_chain@l
/* 806C1CAC 00000018  48 00 00 20 */	b lbl_806C1CCC
lbl_806C1CB0:
/* 806C1CB0 00000000  80 05 00 00 */	lwz r0, 0(r5)
/* 806C1CB4 00000004  90 1F 00 00 */	stw r0, 0(r31)	/* effective address: 806C7920 */
...
lbl_806C1CCC:
/* 806C1CCC 00000000  80 BF 00 00 */	lwz r5, 0(r31)	/* effective address: 806C7920 */

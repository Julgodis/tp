...
/* 806C33E0 00000018  3C 80 80 6C */	lis r4, lit_3906@ha
/* 806C33E4 0000001C  3B E4 74 E8 */	addi r31, r4, lit_3906@l
...
/* 806C3428 0000000C  C0 3F 00 3C */	lfs f1, 0x3c(r31)	/* effective address: 806C7524 */
/* 806C342C 00000010  38 A0 00 02 */	li r5, 2
/* 806C3430 00000014  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 806C74F0 */
...
lbl_806C3444:
/* 806C3444 00000000  C0 1F 00 B0 */	lfs f0, 0xb0(r31)	/* effective address: 806C7598 */
/* 806C3448 00000004  D0 1E 04 D0 */	stfs f0, 0x4d0(r30)
/* 806C344C 00000008  C0 1F 00 B4 */	lfs f0, 0xb4(r31)	/* effective address: 806C759C */
/* 806C3450 0000000C  D0 1E 04 D4 */	stfs f0, 0x4d4(r30)
/* 806C3454 00000010  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 806C75A0 */
...
/* 806C346C 00000004  C0 3F 00 BC */	lfs f1, 0xbc(r31)	/* effective address: 806C75A4 */
/* 806C3470 00000008  C0 5F 00 70 */	lfs f2, 0x70(r31)	/* effective address: 806C7558 */
/* 806C3474 0000000C  C0 7F 00 44 */	lfs f3, 0x44(r31)	/* effective address: 806C752C */
/* 806C3478 00000010  4B BA C5 C4 */	b cLib_addCalc2__FPffff
/* 806C347C 00000014  48 00 00 C4 */	b lbl_806C3540
lbl_806C3480:
/* 806C3480 00000000  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C3484 00000004  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C3488 00000008  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C348C 0000000C  A8 9E 04 B6 */	lha r4, 0x4b6(r30)
/* 806C3490 00000010  4B 94 8F 4C */	b mDoMtx_YrotS__FPA4_fs
/* 806C3494 00000014  C0 1F 00 68 */	lfs f0, 0x68(r31)	/* effective address: 806C7550 */
/* 806C3498 00000018  D0 01 00 08 */	stfs f0, 8(r1)
/* 806C349C 0000001C  C0 1F 00 C0 */	lfs f0, 0xc0(r31)	/* effective address: 806C75A8 */
/* 806C34A0 00000020  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 806C34A4 00000024  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806C74EC */
...
/* 806C34B4 00000034  4B BA DA 38 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806C34C4 00000044  4B C8 3B CC */	b PSVECAdd
/* 806C34C8 00000048  38 7E 04 D0 */	addi r3, r30, 0x4d0
/* 806C34CC 0000004C  C0 3E 06 A8 */	lfs f1, 0x6a8(r30)
/* 806C34D0 00000050  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 806C753C */
/* 806C34D4 00000054  C0 7F 00 C4 */	lfs f3, 0xc4(r31)	/* effective address: 806C75AC */
/* 806C34D8 00000058  4B BA C5 64 */	b cLib_addCalc2__FPffff
/* 806C34DC 0000005C  38 7E 04 D4 */	addi r3, r30, 0x4d4
/* 806C34E0 00000060  C0 3E 06 AC */	lfs f1, 0x6ac(r30)
/* 806C34E4 00000064  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 806C753C */
/* 806C34E8 00000068  C0 7F 00 C4 */	lfs f3, 0xc4(r31)	/* effective address: 806C75AC */
/* 806C34EC 0000006C  4B BA C5 50 */	b cLib_addCalc2__FPffff
/* 806C34F0 00000070  38 7E 04 D8 */	addi r3, r30, 0x4d8
/* 806C34F4 00000074  C0 3E 06 B0 */	lfs f1, 0x6b0(r30)
/* 806C34F8 00000078  C0 5F 00 54 */	lfs f2, 0x54(r31)	/* effective address: 806C753C */
/* 806C34FC 0000007C  C0 7F 00 C4 */	lfs f3, 0xc4(r31)	/* effective address: 806C75AC */
/* 806C3500 00000080  4B BA C5 3C */	b cLib_addCalc2__FPffff
...
/* 806C3514 00000094  4B BA D0 F4 */	b cLib_addCalcAngleS2__FPssss
...
/* 806C3528 000000A8  4B BA D0 E0 */	b cLib_addCalcAngleS2__FPssss
...
/* 806C353C 000000BC  4B BA D0 CC */	b cLib_addCalcAngleS2__FPssss
lbl_806C3540:

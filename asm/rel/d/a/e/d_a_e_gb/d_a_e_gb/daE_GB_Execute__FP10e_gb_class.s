...
/* 806C5A0C  4B C9 C7 B4 */	b _savegpr_22
/* 806C5A10  7C 7F 1B 78 */	mr r31, r3
/* 806C5A14  3C 60 80 6C */	lis r3, lit_3906@ha
/* 806C5A18  3B C3 74 E8 */	addi r30, r3, lit_3906@l
...
/* 806C5A98  4B 96 75 D4 */	b dComIfGp_getReverb__Fi
...
/* 806C5AC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5AC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5AC8  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 806C5ACC  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 806C5AD0  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 806C5AD4  4B C8 0E 14 */	b PSMTXTrans
/* 806C5AD8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5ADC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5AE0  A8 9F 09 50 */	lha r4, 0x950(r31)
/* 806C5AE4  4B 94 69 50 */	b mDoMtx_YrotM__FPA4_fs
/* 806C5AE8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5AEC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5AF0  A8 9F 09 52 */	lha r4, 0x952(r31)
/* 806C5AF4  4B 94 68 A8 */	b mDoMtx_XrotM__FPA4_fs
/* 806C5AF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5AFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5B00  A8 1F 09 50 */	lha r0, 0x950(r31)
/* 806C5B04  7C 00 00 D0 */	neg r0, r0
/* 806C5B08  7C 04 07 34 */	extsh r4, r0
/* 806C5B0C  4B 94 69 28 */	b mDoMtx_YrotM__FPA4_fs
/* 806C5B10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5B14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5B18  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806C5B1C  4B 94 69 18 */	b mDoMtx_YrotM__FPA4_fs
/* 806C5B20  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5B24  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5B28  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 806C5B2C  4B 94 68 70 */	b mDoMtx_XrotM__FPA4_fs
/* 806C5B30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5B34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5B38  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 806C5B3C  4B 94 69 90 */	b mDoMtx_ZrotM__FPA4_fs
/* 806C5B40  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806C5B44  3B A3 79 38 */	addi r29, r3, l_HIO@l
/* 806C5B48  C0 3D 00 08 */	lfs f1, 8(r29)	/* effective address: 806C7940 */
/* 806C5B4C  FC 40 08 90 */	fmr f2, f1
/* 806C5B50  FC 60 08 90 */	fmr f3, f1
/* 806C5B54  4B 94 72 E4 */	b scaleM__14mDoMtx_stack_cFfff
/* 806C5B58  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 806C5B5C  83 83 00 04 */	lwz r28, 4(r3)
/* 806C5B60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5B64  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5B68  38 9C 00 24 */	addi r4, r28, 0x24
/* 806C5B6C  4B C8 09 44 */	b PSMTXCopy
/* 806C5B70  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806C5B74  7C 03 07 74 */	extsb r3, r0
/* 806C5B78  4B 96 74 F4 */	b dComIfGp_getReverb__Fi
...
/* 806C5B8C  4B 94 AA 3C */	b play__14mDoExt_McaMorfFP3VecUlSc
/* 806C5B90  80 7F 05 B8 */	lwz r3, 0x5b8(r31)
/* 806C5B94  4B 94 AB 18 */	b modelCalc__14mDoExt_McaMorfFv
/* 806C5B98  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806C5B9C  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806C5BA0  38 63 00 90 */	addi r3, r3, 0x90
/* 806C5BA4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806C5BA8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806C5BAC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806C5BB0  4B C8 09 00 */	b PSMTXCopy
...
/* 806C5BE0  4B BA B3 0C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806C5C18  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C5C1C  3A E3 61 C0 */	addi r23, r3, struct_804061C0+0x0@l
/* 806C5C20  80 77 5D 3C */	lwz r3, 0x5d3c(r23)	/* effective address: 8040BEFC */
...
/* 806C5C6C  4B 98 78 60 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806C5C80  4B 98 5C 98 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806C5CA4  4B BB AB 64 */	b func_80280808
...
/* 806C5CC4  4B C6 27 68 */	b checkPass__12J3DFrameCtrlFf
...
/* 806C5D04  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C5D08  3A E3 61 C0 */	addi r23, r3, struct_804061C0+0x0@l
/* 806C5D0C  80 77 5D 3C */	lwz r3, 0x5d3c(r23)	/* effective address: 8040BEFC */
...
/* 806C5D58  4B 98 77 74 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806C5D6C  4B 98 5B AC */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806C5D90  4B BB AA 78 */	b func_80280808
...
/* 806C5DBC  4B C6 26 70 */	b checkPass__12J3DFrameCtrlFf
...
/* 806C5E0C  4B BA B0 E0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806C5E34  4B BA 98 14 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 806C5E48  4B A9 9A 80 */	b checkBoomerangChargeTime__9daPy_py_cFv
...
/* 806C5E64  4B BA 98 A4 */	b SetR__8cM3dGSphFf
...
/* 806C5E7C  4B BA 98 8C */	b SetR__8cM3dGSphFf
lbl_806C5E80:
/* 806C5E80  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C5E84  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C5E88  3B 83 23 3C */	addi r28, r3, 0x233c
/* 806C5E8C  7F 83 E3 78 */	mr r3, r28
/* 806C5E90  38 9F 09 AC */	addi r4, r31, 0x9ac
/* 806C5E94  4B B9 ED 14 */	b Set__4cCcSFP8cCcD_Obj
...
lbl_806C5EC8:
/* 806C5EC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5ECC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5ED0  C0 3F 04 A8 */	lfs f1, 0x4a8(r31)
/* 806C5ED4  C0 5F 04 AC */	lfs f2, 0x4ac(r31)
/* 806C5ED8  C0 7F 04 B0 */	lfs f3, 0x4b0(r31)
/* 806C5EDC  4B C8 0A 0C */	b PSMTXTrans
/* 806C5EE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5EE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5EE8  A8 9F 04 B6 */	lha r4, 0x4b6(r31)
/* 806C5EEC  4B 94 65 48 */	b mDoMtx_YrotM__FPA4_fs
/* 806C5EF0  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806C5EF4  3A E3 79 38 */	addi r23, r3, l_HIO@l
/* 806C5EF8  C0 37 00 0C */	lfs f1, 0xc(r23)	/* effective address: 806C7944 */
/* 806C5EFC  FC 40 08 90 */	fmr f2, f1
/* 806C5F00  FC 60 08 90 */	fmr f3, f1
/* 806C5F04  4B 94 6F 34 */	b scaleM__14mDoMtx_stack_cFfff
/* 806C5F08  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 806C5F0C  83 03 00 04 */	lwz r24, 4(r3)
/* 806C5F10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C5F14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C5F18  38 98 00 24 */	addi r4, r24, 0x24
/* 806C5F1C  4B C8 05 94 */	b PSMTXCopy
...
/* 806C5F30  4B 94 A6 98 */	b play__14mDoExt_McaMorfFP3VecUlSc
/* 806C5F34  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806C5F38  4B 94 74 F0 */	b play__14mDoExt_baseAnmFv
/* 806C5F3C  80 7F 05 BC */	lwz r3, 0x5bc(r31)
/* 806C5F40  4B 94 A7 6C */	b modelCalc__14mDoExt_McaMorfFv
...
/* 806C5F64  4B C6 24 C8 */	b checkPass__12J3DFrameCtrlFf
...
/* 806C5F7C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806C5F80  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806C5F84  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806C5FAC  4B BE 59 D8 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_806C5FB0:
...
/* 806C6014  4B BA 91 C8 */	b SetC__8cM3dGCylFRC4cXyz
...
/* 806C6028  4B BA 91 D8 */	b SetR__8cM3dGCylFf
...
/* 806C603C  4B BA 91 BC */	b SetH__8cM3dGCylFf
/* 806C6040  7F 83 E3 78 */	mr r3, r28
/* 806C6044  38 9F 0A E4 */	addi r4, r31, 0xae4
/* 806C6048  4B B9 EB 60 */	b Set__4cCcSFP8cCcD_Obj
...
/* 806C60C8  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806C60CC  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806C60D0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806C60D4  4B C8 03 DC */	b PSMTXCopy
...
/* 806C60F4  4B BA AD F8 */	b MtxPosition__FP4cXyzP4cXyz
lbl_806C60F8:
/* 806C60F8  80 1F 06 6C */	lwz r0, 0x66c(r31)
/* 806C60FC  28 00 00 00 */	cmplwi r0, 0
/* 806C6100  41 82 01 0C */	beq lbl_806C620C
/* 806C6104  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C6108  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C610C  C0 3F 06 74 */	lfs f1, 0x674(r31)
/* 806C6110  C0 5F 06 78 */	lfs f2, 0x678(r31)
/* 806C6114  C0 7F 06 7C */	lfs f3, 0x67c(r31)
/* 806C6118  4B C8 07 D0 */	b PSMTXTrans
/* 806C611C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C6120  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C6124  A8 9F 06 84 */	lha r4, 0x684(r31)
/* 806C6128  4B 94 63 0C */	b mDoMtx_YrotM__FPA4_fs
/* 806C612C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C6130  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C6134  A8 9F 06 86 */	lha r4, 0x686(r31)
/* 806C6138  4B 94 62 64 */	b mDoMtx_XrotM__FPA4_fs
/* 806C613C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C6140  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C6144  38 80 40 00 */	li r4, 0x4000
/* 806C6148  4B 94 62 54 */	b mDoMtx_XrotM__FPA4_fs
/* 806C614C  C0 3E 01 C4 */	lfs f1, 0x1c4(r30)
/* 806C6150  FC 40 08 90 */	fmr f2, f1
/* 806C6154  FC 60 08 90 */	fmr f3, f1
/* 806C6158  4B 94 6C E0 */	b scaleM__14mDoMtx_stack_cFfff
/* 806C615C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C6160  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C6164  80 9F 06 6C */	lwz r4, 0x66c(r31)
/* 806C6168  38 84 00 24 */	addi r4, r4, 0x24
/* 806C616C  4B C8 03 44 */	b PSMTXCopy
...
/* 806C6194  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C6198  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
/* 806C619C  3C 60 80 6C */	lis r3, data_806C77C4@ha
/* 806C61A0  3B 23 77 C4 */	addi r25, r3, data_806C77C4@l
lbl_806C61A4:
/* 806C61A4  80 7A 5D 3C */	lwz r3, 0x5d3c(r26)	/* effective address: 8040BEFC */
...
/* 806C61F0  4B 98 72 DC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806C63A0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806C63A4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 806C63D4  4B BA AA 88 */	b MtxTrans__FfffUc
/* 806C63D8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C63DC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C63E0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C63E4  7E DF D2 14 */	add r22, r31, r26
/* 806C63E8  A8 96 07 BC */	lha r4, 0x7bc(r22)
/* 806C63EC  4B 94 5F B0 */	b mDoMtx_XrotM__FPA4_fs
/* 806C63F0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C63F4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C63F8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806C640C  4B 94 60 28 */	b mDoMtx_YrotM__FPA4_fs
...
/* 806C6428  4B BA AA 7C */	b MtxScale__FfffUc
...
/* 806C643C  4B BA AA 20 */	b MtxTrans__FfffUc
/* 806C6440  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C6444  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C6448  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C644C  80 9C 08 28 */	lwz r4, 0x828(r28)
/* 806C6450  38 84 00 24 */	addi r4, r4, 0x24
/* 806C6454  4B C8 00 5C */	b PSMTXCopy
lbl_806C6458:
...
/* 806C648C  4B C9 BD 80 */	b _restgpr_22

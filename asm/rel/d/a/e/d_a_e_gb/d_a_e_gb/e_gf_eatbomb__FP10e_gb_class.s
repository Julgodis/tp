...
/* 806C4698 00000010  4B C9 DB 30 */	b _savegpr_24
/* 806C469C 00000014  7C 7D 1B 78 */	mr r29, r3
/* 806C46A0 00000018  3C 80 80 6C */	lis r4, lit_3906@ha
/* 806C46A4 0000001C  3B E4 74 E8 */	addi r31, r4, lit_3906@l
...
/* 806C46D4 00000004  C0 3F 00 38 */	lfs f1, 0x38(r31)	/* effective address: 806C7520 */
/* 806C46D8 00000008  38 A0 00 00 */	li r5, 0
/* 806C46DC 0000000C  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 806C74F0 */
...
/* 806C46F0 00000020  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806C46F4 00000024  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806C46F8 00000028  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806C470C 0000003C  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806C74F0 */
/* 806C4710 00000040  FC 40 08 90 */	fmr f2, f1
/* 806C4714 00000044  C0 7F 00 30 */	lfs f3, 0x30(r31)	/* effective address: 806C7518 */
/* 806C4718 00000048  FC 80 18 90 */	fmr f4, f3
/* 806C471C 0000004C  39 00 00 00 */	li r8, 0
/* 806C4720 00000050  4B BE 72 64 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806C4740 00000014  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 806C74EC */
...
/* 806C4764 00000010  C0 3F 00 7C */	lfs f1, 0x7c(r31)	/* effective address: 806C7564 */
/* 806C4768 00000014  38 A0 00 00 */	li r5, 0
/* 806C476C 00000018  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 806C74F0 */
...
/* 806C4780 0000002C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806C4784 00000030  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806C4788 00000034  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806C479C 00000048  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806C74F0 */
/* 806C47A0 0000004C  FC 40 08 90 */	fmr f2, f1
/* 806C47A4 00000050  C0 7F 00 30 */	lfs f3, 0x30(r31)	/* effective address: 806C7518 */
/* 806C47A8 00000054  FC 80 18 90 */	fmr f4, f3
/* 806C47AC 00000058  39 00 00 00 */	li r8, 0
/* 806C47B0 0000005C  4B BE 71 D4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806C47D4 00000014  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 806C74EC */
...
/* 806C4800 00000018  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 806C74F0 */
...
/* 806C4824 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806C4828 0000001C  3B 23 61 C0 */	addi r25, r3, g_dComIfG_gameInfo@l
/* 806C482C 00000020  3C 60 80 6C */	lis r3, data_806C77B8@ha
/* 806C4830 00000024  3B 43 77 B8 */	addi r26, r3, data_806C77B8@l
lbl_806C4834:
/* 806C4834 00000000  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806C487C 00000048  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806C74F0 */
/* 806C4880 0000004C  4B 98 8C 4C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806C4884 00000050  7C 7D C1 2E */	stwx r3, r29, r24
/* 806C4888 00000054  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
/* 806C488C 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 806C4890 0000005C  7C 9D C0 2E */	lwzx r4, r29, r24
/* 806C4894 00000060  4B 98 70 84 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 806C48BC 00000088  4B BB BF 24 */	b func_802807E0
lbl_806C48C0:
...
/* 806C48D8 00000004  4B C9 D9 3C */	b _restgpr_24

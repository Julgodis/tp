...
/* 806C6BAC 00000018  4B 95 1F B8 */	b __ct__10fopAc_ac_cFv
/* 806C6BB0 0000001C  38 7F 05 C4 */	addi r3, r31, 0x5c4
/* 806C6BB4 00000020  4B BF A3 B0 */	b __ct__15Z2CreatureEnemyFv
/* 806C6BB8 00000024  38 7F 06 E4 */	addi r3, r31, 0x6e4
/* 806C6BBC 00000028  3C 80 80 6C */	lis r4, __ct__4cXyzFv@ha
/* 806C6BC0 0000002C  38 84 6F 4C */	addi r4, r4, __ct__4cXyzFv@l
/* 806C6BC4 00000030  3C A0 80 6C */	lis r5, __dt__4cXyzFv@ha
/* 806C6BC8 00000034  38 A5 74 7C */	addi r5, r5, __dt__4cXyzFv@l
/* 806C6BCC 00000038  38 C0 00 0C */	li r6, 0xc
/* 806C6BD0 0000003C  38 E0 00 12 */	li r7, 0x12
/* 806C6BD4 00000040  4B C9 B1 8C */	b __construct_array
/* 806C6BD8 00000044  38 7F 07 BC */	addi r3, r31, 0x7bc
/* 806C6BDC 00000048  3C 80 80 6C */	lis r4, __ct__5csXyzFv@ha
/* 806C6BE0 0000004C  38 84 6F 48 */	addi r4, r4, __ct__5csXyzFv@l
/* 806C6BE4 00000050  3C A0 80 6C */	lis r5, __dt__5csXyzFv@ha
/* 806C6BE8 00000054  38 A5 74 40 */	addi r5, r5, __dt__5csXyzFv@l
/* 806C6BEC 00000058  38 C0 00 06 */	li r6, 6
/* 806C6BF0 0000005C  38 E0 00 12 */	li r7, 0x12
/* 806C6BF4 00000060  4B C9 B1 6C */	b __construct_array
/* 806C6BF8 00000064  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 806C6BFC 00000068  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 806C6C00 0000006C  90 1F 09 88 */	stw r0, 0x988(r31)
/* 806C6C04 00000070  38 7F 09 8C */	addi r3, r31, 0x98c
/* 806C6C08 00000074  4B 9B CB 58 */	b __ct__10dCcD_GSttsFv
/* 806C6C0C 00000078  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 806C6C10 0000007C  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 806C6C28 00000094  4B 9B CE 00 */	b __ct__12dCcD_GObjInfFv
/* 806C6C2C 00000098  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 806C6C30 0000009C  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 806C6C34 000000A0  90 1E 01 20 */	stw r0, 0x120(r30)
/* 806C6C38 000000A4  3C 60 80 6C */	lis r3, __vt__8cM3dGAab@ha
/* 806C6C3C 000000A8  38 03 78 FC */	addi r0, r3, __vt__8cM3dGAab@l
/* 806C6C40 000000AC  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 806C6C44 000000B0  3C 60 80 6C */	lis r3, __vt__8cM3dGSph@ha
/* 806C6C48 000000B4  38 03 78 F0 */	addi r0, r3, __vt__8cM3dGSph@l
/* 806C6C4C 000000B8  90 1E 01 34 */	stw r0, 0x134(r30)
/* 806C6C50 000000BC  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 806C6C54 000000C0  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
...
/* 806C6C64 000000D0  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 806C6C68 000000D4  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 806C6C88 000000F4  4B 9B CD A0 */	b __ct__12dCcD_GObjInfFv
/* 806C6C8C 000000F8  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 806C6C90 000000FC  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 806C6C94 00000100  90 1E 01 20 */	stw r0, 0x120(r30)
/* 806C6C98 00000104  3C 60 80 6C */	lis r3, __vt__8cM3dGAab@ha
/* 806C6C9C 00000108  38 03 78 FC */	addi r0, r3, __vt__8cM3dGAab@l
/* 806C6CA0 0000010C  90 1E 01 1C */	stw r0, 0x11c(r30)
/* 806C6CA4 00000110  3C 60 80 6C */	lis r3, __vt__8cM3dGCyl@ha
/* 806C6CA8 00000114  38 03 78 E4 */	addi r0, r3, __vt__8cM3dGCyl@l
/* 806C6CAC 00000118  90 1E 01 38 */	stw r0, 0x138(r30)
/* 806C6CB0 0000011C  3C 60 80 3C */	lis r3, __vt__12cCcD_CylAttr@ha
/* 806C6CB4 00000120  38 63 35 A4 */	addi r3, r3, __vt__12cCcD_CylAttr@l
...
/* 806C6CC4 00000130  3C 60 80 3B */	lis r3, __vt__8dCcD_Cyl@ha
/* 806C6CC8 00000134  38 63 C0 50 */	addi r3, r3, __vt__8dCcD_Cyl@l
...
/* 806C6CE4 00000150  4B 9A F1 C8 */	b __ct__12dBgS_AcchCirFv
/* 806C6CE8 00000154  3B DF 0C 88 */	addi r30, r31, 0xc88
/* 806C6CEC 00000158  7F C3 F3 78 */	mr r3, r30
/* 806C6CF0 0000015C  4B 9A F3 B0 */	b __ct__9dBgS_AcchFv
/* 806C6CF4 00000160  3C 60 80 6C */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 806C6CF8 00000164  38 63 78 C0 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 806C6D14 00000180  4B 9B 21 54 */	b SetObj__16dBgS_PolyPassChkFv

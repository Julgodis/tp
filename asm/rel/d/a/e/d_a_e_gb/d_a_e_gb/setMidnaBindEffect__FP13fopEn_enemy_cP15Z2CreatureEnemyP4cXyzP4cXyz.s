...
/* 806C703C  4B C9 B1 78 */	b _savegpr_19
/* 806C7040  7C 7E 1B 78 */	mr r30, r3
/* 806C7044  7C 9A 23 78 */	mr r26, r4
/* 806C7048  7C BB 2B 78 */	mr r27, r5
/* 806C704C  7C DC 33 78 */	mr r28, r6
/* 806C7050  3C 60 80 6C */	lis r3, cNullVec__6Z2Calc@ha
/* 806C7054  3A E3 76 C4 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806C7058  3C 60 80 6C */	lis r3, lit_3906@ha
/* 806C705C  3B E3 74 E8 */	addi r31, r3, lit_3906@l
/* 806C7060  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C7064  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C7068  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806C706C  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806C7070  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806C7098  4B AE 54 E4 */	b dKy_darkworld_check__Fv
...
/* 806C70BC  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806C70C0  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806C70C4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806C70C8  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806C70CC  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806C70D0  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806C70D4  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806C70D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806C70DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806C70E0  4B C7 F3 D0 */	b PSMTXCopy
...
/* 806C70F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806C70FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806C7100  38 81 00 4C */	addi r4, r1, 0x4c
/* 806C7104  38 A1 00 58 */	addi r5, r1, 0x58
/* 806C7108  4B C7 FC 64 */	b PSMTXMultVec
/* 806C710C  38 61 00 34 */	addi r3, r1, 0x34
/* 806C7110  38 81 00 58 */	addi r4, r1, 0x58
/* 806C7114  7F 65 DB 78 */	mr r5, r27
/* 806C7118  4B B9 FA 1C */	b __mi__4cXyzCFRC3Vec
...
/* 806C7134  4B BA 05 40 */	b cM_atan2s__Fff
...
/* 806C7168  4B BA 05 0C */	b cM_atan2s__Fff
...
/* 806C7184  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C7188  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806C718C  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806C71D8  4B 98 58 B8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806C71DC  7C 79 1B 79 */	or. r25, r3, r3
/* 806C71E0  41 82 00 FC */	beq lbl_806C72DC
/* 806C71E4  38 61 00 40 */	addi r3, r1, 0x40
/* 806C71E8  4B C7 FF 50 */	b PSVECSquareMag
...
/* 806C7258  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806C725C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806C72C8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806C72CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806C72D0:
...
/* 806C7320  4B 98 57 70 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806C735C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C7360  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806C738C  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806C73CC  4B 98 61 00 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806C742C  4B C9 AD D4 */	b _restgpr_19

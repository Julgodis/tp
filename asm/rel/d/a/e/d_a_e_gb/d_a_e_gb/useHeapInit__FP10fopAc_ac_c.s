...
/* 806C6534  4B C9 BC 9C */	b _savegpr_26
/* 806C6538  7C 7F 1B 78 */	mr r31, r3
/* 806C653C  38 60 00 54 */	li r3, 0x54
/* 806C6540  4B C0 87 0C */	b __nw__FUl
/* 806C6544  7C 7C 1B 79 */	or. r28, r3, r3
/* 806C6548  41 82 00 9C */	beq lbl_806C65E4
/* 806C654C  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C6550  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C6554  38 80 00 11 */	li r4, 0x11
/* 806C6558  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806C655C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 806C6570  4B 97 5D 7C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806C6574  7C 7D 1B 78 */	mr r29, r3
/* 806C6578  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C657C  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C6580  38 80 00 1D */	li r4, 0x1d
/* 806C6584  7F 65 DB 78 */	mr r5, r27
/* 806C6588  38 C0 00 80 */	li r6, 0x80
/* 806C658C  4B 97 5D 60 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C65CC  3D 20 80 6C */	lis r9, lit_3908@ha
/* 806C65D0  C0 29 74 F0 */	lfs f1, lit_3908@l(r9)
/* 806C65D4  39 20 00 00 */	li r9, 0
/* 806C65D8  39 40 FF FF */	li r10, -1
/* 806C65DC  4B 94 96 70 */	b __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 806C660C  4B C0 86 40 */	b __nw__FUl
/* 806C6610  7C 7C 1B 79 */	or. r28, r3, r3
/* 806C6614  41 82 00 9C */	beq lbl_806C66B0
/* 806C6618  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C661C  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C6620  38 80 00 1A */	li r4, 0x1a
/* 806C6624  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806C6628  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 806C663C  4B 97 5C B0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806C6640  7C 7D 1B 78 */	mr r29, r3
/* 806C6644  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C6648  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C664C  38 80 00 1F */	li r4, 0x1f
/* 806C6650  7F 65 DB 78 */	mr r5, r27
/* 806C6654  38 C0 00 80 */	li r6, 0x80
/* 806C6658  4B 97 5C 94 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C6698  3D 20 80 6C */	lis r9, lit_3908@ha
/* 806C669C  C0 29 74 F0 */	lfs f1, lit_3908@l(r9)
/* 806C66A0  39 20 00 00 */	li r9, 0
/* 806C66A4  39 40 FF FF */	li r10, -1
/* 806C66A8  4B 94 95 A4 */	b __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 806C66E0  4B C0 85 6C */	b __nw__FUl
/* 806C66E4  7C 7C 1B 79 */	or. r28, r3, r3
/* 806C66E8  41 82 00 20 */	beq lbl_806C6708
/* 806C66EC  3C 80 80 6C */	lis r4, __vt__12J3DFrameCtrl@ha
/* 806C66F0  38 04 79 08 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 806C66F4  90 1C 00 00 */	stw r0, 0(r28)
/* 806C66F8  38 80 00 00 */	li r4, 0
/* 806C66FC  4B C6 1D 00 */	b init__12J3DFrameCtrlFs
...
lbl_806C6720:
/* 806C6720  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C6724  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C6728  38 80 00 23 */	li r4, 0x23
/* 806C672C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806C6730  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 806C6744  4B 97 5B A8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C6768  3D 00 80 6C */	lis r8, lit_3908@ha
/* 806C676C  C0 28 74 F0 */	lfs f1, lit_3908@l(r8)
/* 806C6770  39 00 00 00 */	li r8, 0
/* 806C6774  39 20 FF FF */	li r9, -1
/* 806C6778  4B 94 6F 94 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
lbl_806C678C:
/* 806C678C  3C 60 80 6C */	lis r3, lit_3907@ha
/* 806C6790  C0 03 74 EC */	lfs f0, lit_3907@l(r3)
/* 806C6794  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 806C6798  D0 03 00 0C */	stfs f0, 0xc(r3)
/* 806C679C  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C67A0  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C67A4  38 80 00 20 */	li r4, 0x20
/* 806C67A8  7F C5 F3 78 */	mr r5, r30
/* 806C67AC  38 C0 00 80 */	li r6, 0x80
/* 806C67B0  4B 97 5B 3C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C67C4  3C 60 80 6C */	lis r3, lit_3908@ha
/* 806C67C8  C3 E3 74 F0 */	lfs f31, lit_3908@l(r3)
lbl_806C67CC:
/* 806C67CC  7F 63 DB 78 */	mr r3, r27
/* 806C67D0  3C 80 00 08 */	lis r4, 8
/* 806C67D4  38 BC 00 84 */	addi r5, r28, 0x0084 /* 0x11000084@l */
/* 806C67D8  4B 94 E4 7C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 806C680C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C6810  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C6814  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 806C6818  3C 80 80 6C */	lis r4, stringBase0@ha
/* 806C681C  38 84 76 B8 */	addi r4, r4, stringBase0@l
/* 806C6820  38 84 00 05 */	addi r4, r4, 5
/* 806C6824  4B CA 21 70 */	b strcmp
/* 806C6828  2C 03 00 00 */	cmpwi r3, 0
/* 806C682C  40 82 00 44 */	bne lbl_806C6870
/* 806C6830  3C 60 80 6C */	lis r3, stringBase0@ha
/* 806C6834  38 63 76 B8 */	addi r3, r3, stringBase0@l
/* 806C6838  38 80 00 1E */	li r4, 0x1e
/* 806C683C  7F C5 F3 78 */	mr r5, r30
/* 806C6840  38 C0 00 80 */	li r6, 0x80
/* 806C6844  4B 97 5A A8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806C6854  4B 94 E4 00 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 806C6880  4B C9 B9 9C */	b _restgpr_26

...
/* 806C3F24 00000004  4B C9 E2 AC */	b _savegpr_26
/* 806C3F28 00000008  7C 7E 1B 78 */	mr r30, r3
/* 806C3F2C 0000000C  3C 60 80 6C */	lis r3, lit_3906@ha
/* 806C3F30 00000010  3B E3 74 E8 */	addi r31, r3, lit_3906@l
/* 806C3F34 00000014  38 61 00 24 */	addi r3, r1, 0x24
/* 806C3F38 00000018  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 806C3F3C 0000001C  3B 64 61 C0 */	addi r27, r4, g_dComIfG_gameInfo@l
/* 806C3F40 00000020  80 9B 5D AC */	lwz r4, 0x5dac(r27)	/* effective address: 8040BF6C */
/* 806C3F44 00000024  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 806C3F48 00000028  38 BE 04 D0 */	addi r5, r30, 0x4d0
/* 806C3F4C 0000002C  4B BA 2B E8 */	b __mi__4cXyzCFRC3Vec
...
/* 806C3F68 00000048  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 806C74E8 */
/* 806C3F6C 0000004C  EC 03 00 2A */	fadds f0, f3, f0
/* 806C3F70 00000050  D0 01 00 4C */	stfs f0, 0x4c(r1)
/* 806C3F74 00000054  4B BA 37 00 */	b cM_atan2s__Fff
...
/* 806C3F90 00000070  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806C74EC */
...
/* 806C3FA8 00000004  4B BA 36 CC */	b cM_atan2s__Fff
...
/* 806C3FB8 00000014  80 9B 5D AC */	lwz r4, 0x5dac(r27)	/* effective address: 8040BF6C */
/* 806C3FBC 00000018  4B 95 68 24 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 806C3FE4 00000040  4B BA 2B 50 */	b __mi__4cXyzCFRC3Vec
...
/* 806C4000 0000005C  4B BA 36 74 */	b cM_atan2s__Fff
/* 806C4004 00000060  7C 64 1B 78 */	mr r4, r3
/* 806C4008 00000064  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C400C 00000068  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C4010 0000006C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C4014 00000070  4B 94 83 C8 */	b mDoMtx_YrotS__FPA4_fs
/* 806C4018 00000074  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806C74EC */
/* 806C401C 00000078  D0 01 00 48 */	stfs f0, 0x48(r1)
/* 806C4020 0000007C  C0 1F 00 44 */	lfs f0, 0x44(r31)	/* effective address: 806C752C */
/* 806C4024 00000080  D0 01 00 4C */	stfs f0, 0x4c(r1)
/* 806C4028 00000084  C0 1F 00 94 */	lfs f0, 0x94(r31)	/* effective address: 806C757C */
...
/* 806C4038 00000094  4B BA CE B4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806C4048 000000A4  4B C8 30 48 */	b PSVECAdd
...
/* 806C4068 000000C4  3C 60 80 6C */	lis r3, lit_4803@ha
/* 806C406C 000000C8  38 63 77 8C */	addi r3, r3, lit_4803@l
...
/* 806C4138 00000010  4B BF DA 44 */	b setLinkSearch__15Z2CreatureEnemyFb
...
/* 806C4148 00000008  4B BF DA 34 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_806C414C:
...
/* 806C4158 0000000C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C415C 00000010  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C4160 00000014  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C4164 00000018  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 806C4168 0000001C  4B 94 82 74 */	b mDoMtx_YrotS__FPA4_fs
/* 806C416C 00000020  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C4170 00000024  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C4174 00000028  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C4178 0000002C  A8 9E 04 DC */	lha r4, 0x4dc(r30)
/* 806C417C 00000030  4B 94 82 20 */	b mDoMtx_XrotM__FPA4_fs
/* 806C4180 00000034  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806C74EC */
...
/* 806C419C 00000050  4B BA CD 50 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806C41AC 00000060  4B C8 2E E4 */	b PSVECAdd
...
/* 806C41BC 00000008  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806C41C0 0000000C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806C41C4 00000010  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806C41C8 00000014  A8 9E 04 DE */	lha r4, 0x4de(r30)
/* 806C41CC 00000018  4B 94 82 10 */	b mDoMtx_YrotS__FPA4_fs
/* 806C41D0 0000001C  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806C74EC */
...
/* 806C41EC 00000038  4B BA CD 00 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806C420C 00000058  4B C8 2E 84 */	b PSVECAdd
/* 806C4210 0000005C  C0 3E 04 FC */	lfs f1, 0x4fc(r30)
/* 806C4214 00000060  C0 1F 00 3C */	lfs f0, 0x3c(r31)	/* effective address: 806C7524 */
...
/* 806C4234 00000014  C3 FF 00 94 */	lfs f31, 0x94(r31)	/* effective address: 806C757C */
/* 806C4238 00000018  48 00 00 08 */	b lbl_806C4240
lbl_806C423C:
/* 806C423C 00000000  C3 FF 00 D0 */	lfs f31, 0xd0(r31)	/* effective address: 806C75B8 */
lbl_806C4240:
/* 806C4240 00000000  38 7E 0C 88 */	addi r3, r30, 0xc88
/* 806C4244 00000004  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 806C4248 00000008  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 806C424C 0000000C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806C4250 00000010  4B 9B 28 5C */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 806C42A0 0000000C  4B BA 28 94 */	b __mi__4cXyzCFRC3Vec
...
/* 806C42C0 0000002C  4B C8 2E 78 */	b PSVECSquareMag
/* 806C42C4 00000030  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806C74EC */
...
/* 806C42D4 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 806C74F8 */
/* 806C42D8 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 806C42DC 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 806C7500 */
...
lbl_806C4324:
/* 806C4324 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 806C7508 */
/* 806C4328 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806C432C 00000000  40 80 00 10 */	bge lbl_806C433C
/* 806C4330 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806C4334 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806C43A0 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806C43A4 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806C43A8:
/* 806C43A8 00000000  C0 5E 09 40 */	lfs f2, 0x940(r30)
/* 806C43AC 00000004  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 806C753C */
...
/* 806C43C0 00000018  C0 3F 00 DC */	lfs f1, 0xdc(r31)	/* effective address: 806C75C4 */
/* 806C43C4 0000001C  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806C43C8 00000020  38 63 79 38 */	addi r3, r3, l_HIO@l
/* 806C43CC 00000024  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 806C7940 */
...
/* 806C43E4 00000004  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806C74F0 */
/* 806C43E8 00000008  FC 40 08 90 */	fmr f2, f1
/* 806C43EC 0000000C  C0 7F 00 28 */	lfs f3, 0x28(r31)	/* effective address: 806C7510 */
/* 806C43F0 00000010  4B BA B6 4C */	b cLib_addCalc2__FPffff
...
/* 806C4410 00000030  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806C74F0 */
/* 806C4414 00000034  FC 40 08 90 */	fmr f2, f1
/* 806C4418 00000038  C0 7F 00 58 */	lfs f3, 0x58(r31)	/* effective address: 806C7540 */
/* 806C441C 0000003C  4B BA B6 20 */	b cLib_addCalc2__FPffff
/* 806C4420 00000040  C0 3E 09 4C */	lfs f1, 0x94c(r30)
/* 806C4424 00000044  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 806C753C */
...
/* 806C4458 0000002C  4B BA C1 B0 */	b cLib_addCalcAngleS2__FPssss
/* 806C445C 00000030  48 00 00 30 */	b lbl_806C448C
lbl_806C4460:
/* 806C4460 00000000  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806C4464 00000004  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 806C449C 00000010  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 806C74F0 */
/* 806C44A0 00000014  C0 5F 00 94 */	lfs f2, 0x94(r31)	/* effective address: 806C757C */
/* 806C44A4 00000018  4B BA B5 DC */	b cLib_addCalc0__FPfff
...
lbl_806C44B4:
/* 806C44B4 00000000  C0 1F 00 7C */	lfs f0, 0x7c(r31)	/* effective address: 806C7564 */
...
/* 806C44E4 00000008  4B C9 DD 38 */	b _restgpr_26

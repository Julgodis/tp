...
/* 806C3F2C 0000000C  3C 60 00 00 */	lis r3, lit_3906@ha /* 806C74E8 */
/* 806C3F30 00000010  3B E3 00 00 */	addi r31, r3, lit_3906@l /* 806C74E8 */
/* 806C3F34 00000014  38 61 00 24 */	addi r3, r1, 0x24
/* 806C3F38 00000018  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806C3F3C 0000001C  3B 64 00 00 */	addi r27, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 806C4008 00000064  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806C400C 00000068  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 806C4068 000000C4  3C 60 00 00 */	lis r3, lit_4803@ha /* 806C778C */
/* 806C406C 000000C8  38 63 00 00 */	addi r3, r3, lit_4803@l /* 806C778C */
...
/* 806C4158 0000000C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806C415C 00000010  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 806C416C 00000020  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806C4170 00000024  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 806C41BC 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806C41C0 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 806C4244 00000004  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806C4248 00000008  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 806C4330 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 806C4334 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
...
/* 806C43A0 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 806C43A4 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3) /* 80450AE0 */
lbl_806C43A8:
...
/* 806C43C4 0000001C  3C 60 00 00 */	lis r3, l_HIO@ha /* 806C7938 */
/* 806C43C8 00000020  38 63 00 00 */	addi r3, r3, l_HIO@l /* 806C7938 */
...
lbl_806C4460:
/* 806C4460 00000000  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 806C4464 00000004  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */

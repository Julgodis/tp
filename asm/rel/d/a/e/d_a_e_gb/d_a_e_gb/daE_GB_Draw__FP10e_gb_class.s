...
/* 806C1EAC  4B CA 03 20 */	b _savegpr_25
/* 806C1EB0  7C 7D 1B 78 */	mr r29, r3
/* 806C1EB4  3C 60 80 6C */	lis r3, lit_3906@ha
/* 806C1EB8  3B E3 74 E8 */	addi r31, r3, lit_3906@l
/* 806C1EBC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C1EC0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806C1EC4  38 80 00 00 */	li r4, 0
/* 806C1EC8  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 806C1ECC  38 DD 01 0C */	addi r6, r29, 0x10c
/* 806C1ED0  4B AE 18 F4 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806C1ED4  80 7D 05 BC */	lwz r3, 0x5bc(r29)
/* 806C1ED8  83 63 00 04 */	lwz r27, 4(r3)
/* 806C1EDC  7F 7E DB 78 */	mr r30, r27
/* 806C1EE0  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C1EE4  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806C1EE8  80 9B 00 04 */	lwz r4, 4(r27)
/* 806C1EEC  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806C1EF0  4B AE 2E B0 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806C1F04  4B 94 B8 A4 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
/* 806C1F08  80 7D 05 BC */	lwz r3, 0x5bc(r29)
/* 806C1F0C  4B 94 E7 74 */	b entryDL__14mDoExt_McaMorfFv
/* 806C1F10  80 9D 06 6C */	lwz r4, 0x66c(r29)
/* 806C1F14  28 04 00 00 */	cmplwi r4, 0
/* 806C1F18  41 82 00 20 */	beq lbl_806C1F38
/* 806C1F1C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C1F20  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806C1F24  80 84 00 04 */	lwz r4, 4(r4)
/* 806C1F28  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806C1F2C  4B AE 2E 74 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806C1F30  80 7D 06 6C */	lwz r3, 0x66c(r29)
/* 806C1F34  4B 94 BD 90 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_806C1F38:
...
/* 806C1F5C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C1F60  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806C1F64  80 84 00 04 */	lwz r4, 4(r4)
/* 806C1F68  38 BD 01 0C */	addi r5, r29, 0x10c
/* 806C1F6C  4B AE 2E 34 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806C1F70  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 806C1F74  4B 94 E7 0C */	b entryDL__14mDoExt_McaMorfFv
/* 806C1F78  3B 20 00 00 */	li r25, 0
/* 806C1F7C  3B 80 00 00 */	li r28, 0
/* 806C1F80  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806C1F84  3B 63 CA 54 */	addi r27, r3, g_env_light@l
lbl_806C1F88:
...
/* 806C1FA4  4B AE 2D FC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 806C1FA8  7C 7D D0 2E */	lwzx r3, r29, r26
/* 806C1FAC  4B 94 BD 18 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_806C1FB0:
...
/* 806C200C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806C2010  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806C2014  4B 96 C8 FC */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 806C2048  4B 99 3E D4 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_806C204C:
...
/* 806C2064  4B CA 01 B4 */	b _restgpr_25

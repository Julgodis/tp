...
/* 806C452C 00000010  4B C9 DC B0 */	b _savegpr_29
/* 806C4530 00000014  7C 7F 1B 78 */	mr r31, r3
/* 806C4534 00000018  3C 60 80 6C */	lis r3, lit_3906@ha
/* 806C4538 0000001C  3B C3 74 E8 */	addi r30, r3, lit_3906@l
...
/* 806C4594 00000014  C0 3E 00 74 */	lfs f1, 0x74(r30)	/* effective address: 806C755C */
/* 806C4598 00000018  38 A0 00 00 */	li r5, 0
/* 806C459C 0000001C  C0 5E 00 08 */	lfs f2, 8(r30)	/* effective address: 806C74F0 */
...
/* 806C45B0 00000030  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806C45B4 00000034  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806C45B8 00000038  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 806C45CC 0000004C  C0 3E 00 08 */	lfs f1, 8(r30)	/* effective address: 806C74F0 */
/* 806C45D0 00000050  FC 40 08 90 */	fmr f2, f1
/* 806C45D4 00000054  C0 7E 00 30 */	lfs f3, 0x30(r30)	/* effective address: 806C7518 */
/* 806C45D8 00000058  FC 80 18 90 */	fmr f4, f3
/* 806C45DC 0000005C  39 00 00 00 */	li r8, 0
/* 806C45E0 00000060  4B BE 73 A4 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 806C4600 00000010  C0 3E 00 04 */	lfs f1, 4(r30)	/* effective address: 806C74EC */
...
/* 806C4624 00000010  C0 3E 00 7C */	lfs f1, 0x7c(r30)	/* effective address: 806C7564 */
/* 806C4628 00000014  38 A0 00 02 */	li r5, 2
/* 806C462C 00000018  C0 5E 00 08 */	lfs f2, 8(r30)	/* effective address: 806C74F0 */
...
/* 806C4648 00000008  3C 60 80 6C */	lis r3, s_b_sub__FPvPv@ha
/* 806C464C 0000000C  38 63 3C 44 */	addi r3, r3, s_b_sub__FPvPv@l
/* 806C4650 00000010  7F E4 FB 78 */	mr r4, r31
/* 806C4654 00000014  4B 95 CC E4 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 806C4674 00000004  4B C9 DB B4 */	b _restgpr_29

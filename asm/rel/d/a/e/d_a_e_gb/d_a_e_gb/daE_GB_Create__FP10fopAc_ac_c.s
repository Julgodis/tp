...
/* 806C68EC  4B C9 B8 F0 */	b _savegpr_29
/* 806C68F0  7C 7E 1B 78 */	mr r30, r3
/* 806C68F4  3C 80 80 6C */	lis r4, lit_3906@ha
/* 806C68F8  3B E4 74 E8 */	addi r31, r4, lit_3906@l
...
/* 806C6924  3C 80 80 6C */	lis r4, stringBase0@ha
/* 806C6928  38 84 76 B8 */	addi r4, r4, stringBase0@l
/* 806C692C  4B 96 65 90 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806C694C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C6950  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C6954  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 806C6958  7C 05 07 74 */	extsb r5, r0
/* 806C695C  4B 96 EA 04 */	b isSwitch__10dSv_info_cCFii
...
/* 806C69A0  3C 80 80 6C */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 806C69A4  38 84 65 1C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 806C69A8  3C A0 00 05 */	lis r5, 0x0005 /* 0x0004B000@ha */
/* 806C69AC  38 A5 B0 00 */	addi r5, r5, 0xB000 /* 0x0004B000@l */
/* 806C69B0  4B 95 3B 00 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_806C69C4:
/* 806C69C4  3C 60 80 6C */	lis r3, data_806C7928@ha
/* 806C69C8  8C 03 79 28 */	lbzu r0, data_806C7928@l(r3)
...
/* 806C69E4  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806C69E8  38 63 79 38 */	addi r3, r3, l_HIO@l
/* 806C69EC  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 806C793C */
lbl_806C69F0:
...
/* 806C6A7C  4B 9A F7 CC */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 806C6A80  38 7E 0C 48 */	addi r3, r30, 0xc48
/* 806C6A84  C0 3F 00 94 */	lfs f1, 0x94(r31)
/* 806C6A88  FC 40 08 90 */	fmr f2, f1
/* 806C6A8C  4B 9A F4 CC */	b SetWall__12dBgS_AcchCirFff
...
/* 806C6AB0  4B BF A5 E4 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806C6AB4  38 7E 05 C4 */	addi r3, r30, 0x5c4
/* 806C6AB8  3C 80 80 6C */	lis r4, stringBase0@ha
/* 806C6ABC  38 84 76 B8 */	addi r4, r4, stringBase0@l
/* 806C6AC0  4B BF B0 D0 */	b setEnemyName__15Z2CreatureEnemyFPCc
/* 806C6AC4  C0 3F 01 CC */	lfs f1, 0x1cc(r31)
/* 806C6AC8  4B BA 0E 8C */	b cM_rndF__Ff
...
/* 806C6AF4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806C6AF8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806C6AFC  4B 96 E8 64 */	b isSwitch__10dSv_info_cCFii
...
/* 806C6B30  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 806C6B34  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 806C6B38  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 806C6B3C  C0 03 04 14 */	lfs f0, 0x414(r3)	/* effective address: 8045177C */
/* 806C6B40  38 00 00 21 */	li r0, 0x21
/* 806C6B44  90 03 04 20 */	stw r0, 0x420(r3)	/* effective address: 80451788 */
/* 806C6B48  C0 7F 00 04 */	lfs f3, 4(r31)
/* 806C6B4C  EC 43 00 28 */	fsubs f2, f3, f0
/* 806C6B50  80 03 04 20 */	lwz r0, 0x420(r3)	/* effective address: 80451788 */
...
/* 806C6B70  D0 03 04 18 */	stfs f0, 0x418(r3)	/* effective address: 80451780 */
/* 806C6B74  D0 63 04 1C */	stfs f3, 0x41c(r3)	/* effective address: 80451784 */
lbl_806C6B78:
/* 806C6B78  7F A3 EB 78 */	mr r3, r29
lbl_806C6B7C:
/* 806C6B7C  39 61 00 30 */	addi r11, r1, 0x30
/* 806C6B80  4B C9 B6 A8 */	b _restgpr_29

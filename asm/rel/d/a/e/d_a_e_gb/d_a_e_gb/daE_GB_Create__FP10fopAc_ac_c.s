...
/* 806C68F4 00000018  3C 80 00 00 */	lis r4, lit_3906@ha /* 806C74E8 */
/* 806C68F8 0000001C  3B E4 00 00 */	addi r31, r4, lit_3906@l /* 806C74E8 */
...
/* 806C6924 00000004  3C 80 00 00 */	lis r4, stringBase0@ha /* 806C76B8 */
/* 806C6928 00000008  38 84 00 00 */	addi r4, r4, stringBase0@l /* 806C76B8 */
...
/* 806C694C 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806C6950 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 806C69A0 00000030  3C 80 00 00 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha /* 806C651C */
/* 806C69A4 00000034  38 84 00 00 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l /* 806C651C */
...
lbl_806C69C4:
/* 806C69C4 00000000  3C 60 00 00 */	lis r3, data_806C7928@ha /* 806C7928 */
/* 806C69C8 00000004  8C 03 00 00 */	lbzu r0, data_806C7928@l(r3) /* 806C7928 */
...
/* 806C69E4 00000020  3C 60 00 00 */	lis r3, l_HIO@ha /* 806C7938 */
/* 806C69E8 00000024  38 63 00 00 */	addi r3, r3, l_HIO@l /* 806C7938 */
...
/* 806C6A1C 0000002C  3C 80 00 00 */	lis r4, data_806C77C8@ha /* 806C77C8 */
/* 806C6A20 00000030  38 84 00 00 */	addi r4, r4, data_806C77C8@l /* 806C77C8 */
...
/* 806C6A34 00000044  3C 80 00 00 */	lis r4, data_806C7808@ha /* 806C7808 */
/* 806C6A38 00000048  38 84 00 00 */	addi r4, r4, data_806C7808@l /* 806C7808 */
...
/* 806C6AB8 000000C8  3C 80 00 00 */	lis r4, stringBase0@ha /* 806C76B8 */
/* 806C6ABC 000000CC  38 84 00 00 */	addi r4, r4, stringBase0@l /* 806C76B8 */
...
/* 806C6AF4 00000104  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806C6AF8 00000108  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 806C6B30 00000014  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 806C6B34 00000018  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */

...
/* 8072B7D4  4B C3 6A 08 */	b _savegpr_29
...
/* 8072B7F4  4B 8E D3 70 */	b __ct__10fopAc_ac_cFv
/* 8072B7F8  38 7E 05 F4 */	addi r3, r30, 0x5f4
/* 8072B7FC  4B B9 57 68 */	b __ct__15Z2CreatureEnemyFv
/* 8072B800  38 7E 06 B0 */	addi r3, r30, 0x6b0
/* 8072B804  4B 94 A6 A8 */	b __ct__12dBgS_AcchCirFv
/* 8072B808  3B BE 06 F0 */	addi r29, r30, 0x6f0
/* 8072B80C  7F A3 EB 78 */	mr r3, r29
/* 8072B810  4B 94 A8 90 */	b __ct__9dBgS_AcchFv
/* 8072B814  3C 60 80 73 */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 8072B818  38 63 C3 B0 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 8072B834  4B 94 D6 34 */	b SetObj__16dBgS_PolyPassChkFv
/* 8072B838  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 8072B83C  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 8072B840  90 1E 08 E4 */	stw r0, 0x8e4(r30)
/* 8072B844  38 7E 08 E8 */	addi r3, r30, 0x8e8
/* 8072B848  4B 95 7F 18 */	b __ct__10dCcD_GSttsFv
/* 8072B84C  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 8072B850  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 8072B868  4B 95 81 C0 */	b __ct__12dCcD_GObjInfFv
/* 8072B86C  3C 60 80 3C */	lis r3, __vt__14cCcD_ShapeAttr@ha
/* 8072B870  38 03 36 D0 */	addi r0, r3, __vt__14cCcD_ShapeAttr@l
/* 8072B874  90 1D 01 20 */	stw r0, 0x120(r29)
/* 8072B878  3C 60 80 73 */	lis r3, __vt__8cM3dGAab@ha
/* 8072B87C  38 03 C3 A4 */	addi r0, r3, __vt__8cM3dGAab@l
/* 8072B880  90 1D 01 1C */	stw r0, 0x11c(r29)
/* 8072B884  3C 60 80 73 */	lis r3, __vt__8cM3dGSph@ha
/* 8072B888  38 03 C3 98 */	addi r0, r3, __vt__8cM3dGSph@l
/* 8072B88C  90 1D 01 34 */	stw r0, 0x134(r29)
/* 8072B890  3C 60 80 3C */	lis r3, __vt__12cCcD_SphAttr@ha
/* 8072B894  38 63 35 40 */	addi r3, r3, __vt__12cCcD_SphAttr@l
/* 8072B898  90 7D 01 20 */	stw r3, 0x120(r29)
/* 8072B89C  38 03 00 58 */	addi r0, r3, 0x58
/* 8072B8A0  90 1D 01 34 */	stw r0, 0x134(r29)
/* 8072B8A4  3C 60 80 3B */	lis r3, __vt__8dCcD_Sph@ha
/* 8072B8A8  38 63 BF C0 */	addi r3, r3, __vt__8dCcD_Sph@l
...
/* 8072B8D0  3C 80 80 73 */	lis r4, stringBase0@ha
/* 8072B8D4  38 84 C2 40 */	addi r4, r4, stringBase0@l
/* 8072B8D8  4B 90 15 E4 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8072B90C  3C 80 80 73 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 8072B910  38 84 B6 80 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 8072B914  38 A0 17 E0 */	li r5, 0x17e0
/* 8072B918  4B 8E EB 98 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_8072B92C:
/* 8072B92C  3C 60 80 73 */	lis r3, struct_8072C424+0x1@ha
/* 8072B930  8C 03 C4 25 */	lbzu r0, struct_8072C424+0x1@l(r3)
...
/* 8072B94C  3C 60 80 73 */	lis r3, l_HIO@ha
/* 8072B950  38 63 C4 34 */	addi r3, r3, l_HIO@l
/* 8072B954  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 8072C438 */
lbl_8072B958:
...
/* 8072B9C8  4B 94 A8 80 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 8072B9CC  38 7F 06 B0 */	addi r3, r31, 0x6b0
/* 8072B9D0  3C 80 80 73 */	lis r4, lit_3814@ha
/* 8072B9D4  C0 24 C1 BC */	lfs f1, lit_3814@l(r4)
/* 8072B9D8  FC 40 08 90 */	fmr f2, f1
/* 8072B9DC  4B 94 A5 7C */	b SetWall__12dBgS_AcchCirFff
...
/* 8072B9F4  4B B9 56 A0 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 8072B9F8  38 7F 05 F4 */	addi r3, r31, 0x5f4
/* 8072B9FC  3C 80 80 73 */	lis r4, stringBase0@ha
/* 8072BA00  38 84 C2 40 */	addi r4, r4, stringBase0@l
/* 8072BA04  38 84 00 05 */	addi r4, r4, 5
/* 8072BA08  4B B9 61 88 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 8072BA1C  3C 60 80 73 */	lis r3, lit_3937@ha
/* 8072BA20  C0 23 C1 CC */	lfs f1, lit_3937@l(r3)
/* 8072BA24  4B B3 BF 30 */	b cM_rndF__Ff
...
/* 8072BA40  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8072BA44  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8072BA48  38 80 00 00 */	li r4, 0
/* 8072BA4C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8072BA50  38 DF 01 0C */	addi r6, r31, 0x10c
/* 8072BA54  4B A7 7D 70 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_8072BA58:
/* 8072BA58  7F C3 F3 78 */	mr r3, r30
lbl_8072BA5C:
/* 8072BA5C  39 61 00 30 */	addi r11, r1, 0x30
/* 8072BA60  4B C3 67 C8 */	b _restgpr_29

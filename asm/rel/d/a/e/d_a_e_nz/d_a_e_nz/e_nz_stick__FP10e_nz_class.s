...
/* 8072A690 00000010  4B C3 7B 4C */	b _savegpr_29
/* 8072A694 00000014  7C 7D 1B 78 */	mr r29, r3
/* 8072A698 00000018  3C 80 80 73 */	lis r4, lit_3789@ha
/* 8072A69C 0000001C  3B E4 C1 80 */	addi r31, r4, lit_3789@l
...
/* 8072A6C4 00000004  C0 3F 00 48 */	lfs f1, 0x48(r31)	/* effective address: 8072C1C8 */
/* 8072A6C8 00000008  38 A0 00 02 */	li r5, 2
/* 8072A6CC 0000000C  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 8072C188 */
...
/* 8072A6DC 0000001C  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 8072C184 */
/* 8072A6E0 00000020  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 8072A6E4 00000024  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 8072C188 */
/* 8072A6E8 00000028  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8072A6EC 0000002C  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 8072A6F0 00000030  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8072A6F4 00000034  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8072A708 00000048  4B 94 53 1C */	b StartShock__12dVibration_cFii4cXyz
...
/* 8072A718 00000008  C0 3F 00 80 */	lfs f1, 0x80(r31)	/* effective address: 8072C200 */
/* 8072A71C 0000000C  4B BF DD 10 */	b checkPass__12J3DFrameCtrlFf
...
lbl_8072A754:
/* 8072A754 00000000  3C 60 80 73 */	lis r3, data_8072C454@ha
/* 8072A758 00000004  88 83 C4 54 */	lbz r4, data_8072C454@l(r3)
/* 8072A75C 00000008  3C 60 80 73 */	lis r3, stick_bit@ha
/* 8072A760 0000000C  38 63 C2 84 */	addi r3, r3, stick_bit@l
/* 8072A764 00000010  38 00 00 08 */	li r0, 8
/* 8072A768 00000014  7C 09 03 A6 */	mtctr r0
lbl_8072A76C:
/* 8072A76C 00000000  88 03 00 00 */	lbz r0, 0(r3)	/* effective address: 8072C284 */
...
/* 8072A794 00000014  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8072A798 00000018  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8072A79C 0000001C  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 8072A7A0 00000020  80 03 05 70 */	lwz r0, 0x570(r3)	/* effective address: 80406730 */
/* 8072A7A4 00000024  64 00 40 00 */	oris r0, r0, 0x4000
/* 8072A7A8 00000028  90 03 05 70 */	stw r0, 0x570(r3)	/* effective address: 80406730 */
lbl_8072A7AC:
/* 8072A7AC 00000000  39 61 00 30 */	addi r11, r1, 0x30
/* 8072A7B0 00000004  4B C3 7A 78 */	b _restgpr_29

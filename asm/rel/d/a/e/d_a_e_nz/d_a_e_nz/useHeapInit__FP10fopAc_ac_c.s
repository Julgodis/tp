...
/* 8072B690  4B C3 6B 48 */	b _savegpr_28
/* 8072B694  7C 7F 1B 78 */	mr r31, r3
/* 8072B698  38 60 00 58 */	li r3, 0x58
/* 8072B69C  4B BA 35 B0 */	b __nw__FUl
/* 8072B6A0  7C 7E 1B 79 */	or. r30, r3, r3
/* 8072B6A4  41 82 00 94 */	beq lbl_8072B738
/* 8072B6A8  3C 60 80 73 */	lis r3, stringBase0@ha
/* 8072B6AC  38 63 C2 40 */	addi r3, r3, stringBase0@l
/* 8072B6B0  38 80 00 0A */	li r4, 0xa
/* 8072B6B4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8072B6B8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8072B6CC  4B 91 0C 20 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8072B6D0  7C 7D 1B 78 */	mr r29, r3
/* 8072B6D4  3C 60 80 73 */	lis r3, stringBase0@ha
/* 8072B6D8  38 63 C2 40 */	addi r3, r3, stringBase0@l
/* 8072B6DC  38 80 00 0D */	li r4, 0xd
/* 8072B6E0  7F 85 E3 78 */	mr r5, r28
/* 8072B6E4  38 C0 00 80 */	li r6, 0x80
/* 8072B6E8  4B 91 0C 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8072B720  3D 20 80 73 */	lis r9, lit_3791@ha
/* 8072B724  C0 29 C1 88 */	lfs f1, lit_3791@l(r9)
/* 8072B728  39 20 00 00 */	li r9, 0
/* 8072B72C  39 40 FF FF */	li r10, -1
/* 8072B730  4B 8E 50 A0 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_8072B75C:
/* 8072B75C  3C 60 80 73 */	lis r3, lit_3790@ha
/* 8072B760  C0 23 C1 84 */	lfs f1, lit_3790@l(r3)
/* 8072B764  FC 40 08 90 */	fmr f2, f1
/* 8072B768  FC 60 08 90 */	fmr f3, f1
/* 8072B76C  38 60 00 00 */	li r3, 0
/* 8072B770  4B B4 57 34 */	b MtxScale__FfffUc
/* 8072B774  80 7F 05 E0 */	lwz r3, 0x5e0(r31)
/* 8072B778  80 83 00 04 */	lwz r4, 4(r3)
/* 8072B77C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8072B780  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8072B784  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8072B788  38 84 00 24 */	addi r4, r4, 0x24
/* 8072B78C  4B C1 AD 24 */	b PSMTXCopy

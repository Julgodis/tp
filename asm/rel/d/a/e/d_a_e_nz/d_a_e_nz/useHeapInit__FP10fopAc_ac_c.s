...
/* 8072B690 00000010  4B C3 6B 48 */	b _savegpr_28
/* 8072B694 00000014  7C 7F 1B 78 */	mr r31, r3
/* 8072B698 00000018  38 60 00 58 */	li r3, 0x58
/* 8072B69C 0000001C  4B BA 35 B0 */	b __nw__FUl
/* 8072B6A0 00000020  7C 7E 1B 79 */	or. r30, r3, r3
/* 8072B6A4 00000024  41 82 00 94 */	beq lbl_8072B738
/* 8072B6A8 00000028  3C 60 80 73 */	lis r3, stringBase0@ha
/* 8072B6AC 0000002C  38 63 C2 40 */	addi r3, r3, stringBase0@l
/* 8072B6B0 00000030  38 80 00 0A */	li r4, 0xa
/* 8072B6B4 00000034  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 8072B6B8 00000038  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 8072B6CC 0000004C  4B 91 0C 20 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8072B6D0 00000050  7C 7D 1B 78 */	mr r29, r3
/* 8072B6D4 00000054  3C 60 80 73 */	lis r3, stringBase0@ha
/* 8072B6D8 00000058  38 63 C2 40 */	addi r3, r3, stringBase0@l
/* 8072B6DC 0000005C  38 80 00 0D */	li r4, 0xd
/* 8072B6E0 00000060  7F 85 E3 78 */	mr r5, r28
/* 8072B6E4 00000064  38 C0 00 80 */	li r6, 0x80
/* 8072B6E8 00000068  4B 91 0C 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8072B720 000000A0  3D 20 80 73 */	lis r9, lit_3791@ha
/* 8072B724 000000A4  C0 29 C1 88 */	lfs f1, lit_3791@l(r9)
/* 8072B728 000000A8  39 20 00 00 */	li r9, 0
/* 8072B72C 000000AC  39 40 FF FF */	li r10, -1
/* 8072B730 000000B0  4B 8E 50 A0 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
lbl_8072B75C:
/* 8072B75C 00000000  3C 60 80 73 */	lis r3, lit_3790@ha
/* 8072B760 00000004  C0 23 C1 84 */	lfs f1, lit_3790@l(r3)
/* 8072B764 00000008  FC 40 08 90 */	fmr f2, f1
/* 8072B768 0000000C  FC 60 08 90 */	fmr f3, f1
/* 8072B76C 00000010  38 60 00 00 */	li r3, 0
/* 8072B770 00000014  4B B4 57 34 */	b MtxScale__FfffUc
/* 8072B774 00000018  80 7F 05 E0 */	lwz r3, 0x5e0(r31)
/* 8072B778 0000001C  80 83 00 04 */	lwz r4, 4(r3)
/* 8072B77C 00000020  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8072B780 00000024  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8072B784 00000028  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8072B788 0000002C  38 84 00 24 */	addi r4, r4, 0x24
/* 8072B78C 00000030  4B C1 AD 24 */	b PSMTXCopy
...
/* 8072B7A0 00000044  4B 8E 2D 9C */	b create__21mDoExt_invisibleModelFP8J3DModelUc
...
/* 8072B7B0 00000004  4B C3 6A 74 */	b _restgpr_28

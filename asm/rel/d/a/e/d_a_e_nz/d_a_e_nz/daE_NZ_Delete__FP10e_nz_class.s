...
/* 8072B5F4  3C 80 80 73 */	lis r4, stringBase0@ha
/* 8072B5F8  38 84 C2 40 */	addi r4, r4, stringBase0@l
/* 8072B5FC  4B 90 1A 0C */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 8072B610  3C 60 80 73 */	lis r3, struct_8072C424+0x1@ha
/* 8072B614  98 03 C4 25 */	stb r0, struct_8072C424+0x1@l(r3)
lbl_8072B618:
...
/* 8072B628  4B 8E 5C E8 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_8072B62C:
/* 8072B62C  88 DF 06 AC */	lbz r6, 0x6ac(r31)
/* 8072B630  7C C0 07 75 */	extsb. r0, r6
/* 8072B634  41 82 00 34 */	beq lbl_8072B668
/* 8072B638  3C 60 80 73 */	lis r3, data_8072C454@ha
/* 8072B63C  38 A3 C4 54 */	addi r5, r3, data_8072C454@l
/* 8072B640  88 85 00 00 */	lbz r4, 0(r5)	/* effective address: 8072C454 */
/* 8072B644  3C 60 80 73 */	lis r3, stick_bit@ha
/* 8072B648  38 63 C2 84 */	addi r3, r3, stick_bit@l
...
/* 8072B65C  98 05 00 00 */	stb r0, 0(r5)	/* effective address: 8072C454 */

...
/* 8072B5F4 00000018  3C 80 80 73 */	lis r4, stringBase0@ha
/* 8072B5F8 0000001C  38 84 C2 40 */	addi r4, r4, stringBase0@l
/* 8072B5FC 00000020  4B 90 1A 0C */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 8072B610 00000034  3C 60 80 73 */	lis r3, struct_8072C424+0x1@ha
/* 8072B614 00000038  98 03 C4 25 */	stb r0, struct_8072C424+0x1@l(r3)
lbl_8072B618:
...
/* 8072B628 00000010  4B 8E 5C E8 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_8072B62C:
...
/* 8072B638 0000000C  3C 60 80 73 */	lis r3, data_8072C454@ha
/* 8072B63C 00000010  38 A3 C4 54 */	addi r5, r3, data_8072C454@l
/* 8072B640 00000014  88 85 00 00 */	lbz r4, 0(r5)	/* effective address: 8072C454 */
/* 8072B644 00000018  3C 60 80 73 */	lis r3, stick_bit@ha
/* 8072B648 0000001C  38 63 C2 84 */	addi r3, r3, stick_bit@l
...
/* 8072B65C 00000030  98 05 00 00 */	stb r0, 0(r5)	/* effective address: 8072C454 */

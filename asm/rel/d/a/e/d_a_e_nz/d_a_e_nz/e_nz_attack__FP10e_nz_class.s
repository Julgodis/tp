...
/* 8072A054  4B C3 81 88 */	b _savegpr_29
/* 8072A058  7C 7D 1B 78 */	mr r29, r3
/* 8072A05C  3C 80 80 73 */	lis r4, lit_3789@ha
/* 8072A060  3B E4 C1 80 */	addi r31, r4, lit_3789@l
...
/* 8072A0E8  4B B3 CA 4C */	b __mi__4cXyzCFRC3Vec
...
/* 8072A104  4B B3 D5 70 */	b cM_atan2s__Fff
...
/* 8072A138  4B B3 D5 3C */	b cM_atan2s__Fff
...
/* 8072A1C4  4B B3 C9 70 */	b __mi__4cXyzCFRC3Vec
...
/* 8072A1E4  4B C1 CF 54 */	b PSVECSquareMag
...
/* 8072A254  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072A258  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8072A2C4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072A2C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8072A2CC:
...
/* 8072A2F8  4B B3 C8 3C */	b __mi__4cXyzCFRC3Vec
...
/* 8072A318  4B C1 CE 20 */	b PSVECSquareMag
...
/* 8072A388  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072A38C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8072A3F8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072A3FC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8072A400:
...
/* 8072A458  4B B4 55 E4 */	b cLib_addCalc2__FPffff
...
/* 8072A46C  4B B4 55 D0 */	b cLib_addCalc2__FPffff
...
/* 8072A4B0  4B C1 CC 88 */	b PSVECSquareMag
...
/* 8072A520  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072A524  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8072A590  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8072A594  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8072A598:
...
/* 8072A5C8  4B B4 60 40 */	b cLib_addCalcAngleS2__FPssss
...
/* 8072A5F0  4B B3 D3 64 */	b cM_rndF__Ff
...
/* 8072A66C  4B C3 7B BC */	b _restgpr_29

...
/* 806951E0 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 806951E4 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80695220 00000058  3C 60 00 00 */	lis r3, lit_3945@ha /* 80697CA8 */
/* 80695224 0000005C  C0 03 00 00 */	lfs f0, lit_3945@l(r3) /* 80697CA8 */
...
lbl_80695258:
/* 80695258 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 8069525C 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 80695278 00000020  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 8069527C 00000024  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
/* 80695280 00000028  80 84 00 00 */	lwz r4, 0(r4)
/* 80695284 0000002C  4B FF F8 75 */	bl PSMTXCopy
/* 80695288 00000030  3C 60 00 00 */	lis r3, lit_3945@ha /* 80697CA8 */
/* 8069528C 00000034  C0 03 00 00 */	lfs f0, lit_3945@l(r3) /* 80697CA8 */
...
/* 806952D0 00000078  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806952D4 0000007C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 806952E8 00000090  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806952EC 00000094  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 806952F0 00000098  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 806952F4 0000009C  4B FF F8 05 */	bl mDoMtx_YrotM__FPA4_fs
/* 806952F8 000000A0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806952FC 000000A4  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80695318 000000C0  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 8069531C 000000C4  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 8069533C 000000E4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80695340 000000E8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80695344 000000EC  A8 9D 00 40 */	lha r4, 0x40(r29)
/* 80695348 000000F0  4B FF F7 B1 */	bl mDoMtx_ZrotM__FPA4_fs
/* 8069534C 000000F4  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80695350 000000F8  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80695354 000000FC  38 80 C0 00 */	li r4, -16384
/* 80695358 00000100  4B FF F7 A1 */	bl mDoMtx_XrotM__FPA4_fs
/* 8069535C 00000104  3C 60 00 00 */	lis r3, l_HIO@ha /* 80697E7C */
/* 80695360 00000108  38 63 00 00 */	addi r3, r3, l_HIO@l /* 80697E7C */
...
/* 8069537C 00000124  3C 60 00 00 */	lis r3, lit_3945@ha /* 80697CA8 */
/* 80695380 00000128  C0 23 00 00 */	lfs f1, lit_3945@l(r3) /* 80697CA8 */
/* 80695384 0000012C  3C 60 00 00 */	lis r3, lit_4019@ha /* 80697CD0 */
/* 80695388 00000130  C0 43 00 00 */	lfs f2, lit_4019@l(r3) /* 80697CD0 */
...
/* 806953A0 00000148  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806953A4 0000014C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
lbl_806953B8:
/* 806953B8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 806953BC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */

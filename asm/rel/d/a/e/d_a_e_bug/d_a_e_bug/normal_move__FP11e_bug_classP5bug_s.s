...
/* 80696850 00000004  4B CC B9 84 */	b _savegpr_27
/* 80696854 00000008  7C 7C 1B 78 */	mr r28, r3
/* 80696858 0000000C  7C 9D 23 78 */	mr r29, r4
/* 8069685C 00000010  3C 60 80 69 */	lis r3, lit_3829@ha
/* 80696860 00000014  3B E3 7C A0 */	addi r31, r3, lit_3829@l
/* 80696864 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80696868 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8069686C 00000020  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80696888 0000003C  C0 3F 00 54 */	lfs f1, 0x54(r31)	/* effective address: 80697CF4 */
/* 8069688C 00000040  4B BD 10 C8 */	b cM_rndF__Ff
/* 80696890 00000044  C0 1F 00 B8 */	lfs f0, 0xb8(r31)	/* effective address: 80697D58 */
...
/* 806968A8 0000005C  C0 3F 00 50 */	lfs f1, 0x50(r31)	/* effective address: 80697CF0 */
/* 806968AC 00000060  4B BD 10 E0 */	b cM_rndFX__Ff
/* 806968B0 00000064  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 80697CC8 */
...
/* 806968C4 00000008  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806968C8 0000000C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 806968CC 00000010  7C 23 04 2E */	lfsx f1, r3, r0
/* 806968D0 00000014  C0 1F 00 BC */	lfs f0, 0xbc(r31)	/* effective address: 80697D5C */
...
/* 80696910 00000054  3C 60 80 69 */	lis r3, data_80697EAC@ha
/* 80696914 00000058  88 03 7E AC */	lbz r0, data_80697EAC@l(r3)
...
/* 8069692C 00000070  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80697CA8 */
...
lbl_80696940:
/* 80696940 00000000  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80697CFC */
...
/* 80696958 00000008  4B BD 0D 1C */	b cM_atan2s__Fff
...
/* 80696978 00000028  4B BD 9C 90 */	b cLib_addCalcAngleS2__FPssss
...
/* 806969AC 00000008  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806969B0 0000000C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80696A10 0000000C  4B BD 01 24 */	b __mi__4cXyzCFRC3Vec
...
/* 80696A38 00000034  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80697CA8 */
...
/* 80696A60 00000014  4B CB 06 D8 */	b PSVECSquareMag
/* 80696A64 00000018  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80697CA8 */
...
/* 80696A74 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 80697CB0 */
/* 80696A78 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80696A7C 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 80697CB8 */
...
lbl_80696AC4:
/* 80696AC4 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 80697CC0 */
/* 80696AC8 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80696ACC 00000000  40 80 00 10 */	bge lbl_80696ADC
/* 80696AD0 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80696AD4 00000008  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)
...
/* 80696B40 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80696B44 0000000C  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)
...
/* 80696B5C 0000000C  3C 60 80 69 */	lis r3, data_80697EAC@ha
/* 80696B60 00000010  88 03 7E AC */	lbz r0, data_80697EAC@l(r3)
...
/* 80696B78 00000028  C0 1F 00 C0 */	lfs f0, 0xc0(r31)	/* effective address: 80697D60 */
...
/* 80696B8C 0000000C  4B BD 0A E8 */	b cM_atan2s__Fff
...
/* 80696BB0 00000030  C0 3F 00 28 */	lfs f1, 0x28(r31)	/* effective address: 80697CC8 */
/* 80696BB4 00000034  4B BD 0D A0 */	b cM_rndF__Ff
/* 80696BB8 00000038  C0 1F 00 80 */	lfs f0, 0x80(r31)	/* effective address: 80697D20 */
/* 80696BBC 0000003C  EC 00 08 2A */	fadds f0, f0, f1
/* 80696BC0 00000040  D0 1D 00 34 */	stfs f0, 0x34(r29)
/* 80696BC4 00000044  C0 1F 00 70 */	lfs f0, 0x70(r31)	/* effective address: 80697D10 */
...
lbl_80696C04:
/* 80696C04 00000000  C0 1F 00 88 */	lfs f0, 0x88(r31)	/* effective address: 80697D28 */
/* 80696C08 00000004  EC 20 07 72 */	fmuls f1, f0, f29
/* 80696C0C 00000008  C0 1F 00 94 */	lfs f0, 0x94(r31)	/* effective address: 80697D34 */
...
lbl_80696C20:
/* 80696C20 00000000  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 80697CCC */
...
/* 80696C34 00000004  C0 5F 00 C4 */	lfs f2, 0xc4(r31)	/* effective address: 80697D64 */
/* 80696C38 00000008  C0 7F 00 30 */	lfs f3, 0x30(r31)	/* effective address: 80697CD0 */
/* 80696C3C 0000000C  4B BD 8E 00 */	b cLib_addCalc2__FPffff
/* 80696C40 00000010  80 7D 00 08 */	lwz r3, 8(r29)
/* 80696C44 00000014  3B 63 00 01 */	addi r27, r3, 1
/* 80696C48 00000018  C3 BF 00 08 */	lfs f29, 8(r31)	/* effective address: 80697CA8 */
...
/* 80696CA8 0000000C  4B BD 09 CC */	b cM_atan2s__Fff
/* 80696CAC 00000010  7C 64 1B 78 */	mr r4, r3
/* 80696CB0 00000014  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80696CB4 00000018  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80696CB8 0000001C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80696CBC 00000020  4B 97 57 20 */	b mDoMtx_YrotS__FPA4_fs
/* 80696CC0 00000024  C0 1F 00 08 */	lfs f0, 8(r31)	/* effective address: 80697CA8 */
/* 80696CC4 00000028  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80696CC8 0000002C  D0 01 00 2C */	stfs f0, 0x2c(r1)
/* 80696CCC 00000030  C0 1F 00 C8 */	lfs f0, 0xc8(r31)	/* effective address: 80697D68 */
...
/* 80696CDC 00000040  4B BD A2 10 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80696D18 00000004  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 80697CA8 */
...
/* 80696D28 00000008  3C 60 80 69 */	lis r3, data_80697EAC@ha
/* 80696D2C 0000000C  88 03 7E AC */	lbz r0, data_80697EAC@l(r3)
/* 80696D30 00000010  7C 00 07 75 */	extsb. r0, r0
/* 80696D34 00000014  40 82 00 C4 */	bne lbl_80696DF8
/* 80696D38 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80696D3C 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80696D40 00000020  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
/* 80696D44 00000024  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17
/* 80696D48 00000028  40 82 00 B0 */	bne lbl_80696DF8
/* 80696D4C 0000002C  C0 1F 00 60 */	lfs f0, 0x60(r31)	/* effective address: 80697D00 */
...
/* 80696D64 00000008  C0 1F 00 CC */	lfs f0, 0xcc(r31)	/* effective address: 80697D6C */
...
/* 80696D7C 00000010  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 80697CA4 */
/* 80696D80 00000014  4B BD 0B D4 */	b cM_rndF__Ff
/* 80696D84 00000018  C0 1F 00 50 */	lfs f0, 0x50(r31)	/* effective address: 80697CF0 */
/* 80696D88 00000074  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80696D8C 00000000  40 80 00 28 */	bge lbl_80696DB4
/* 80696D90 00000004  C0 3F 00 54 */	lfs f1, 0x54(r31)	/* effective address: 80697CF4 */
/* 80696D94 00000008  4B BD 0B C0 */	b cM_rndF__Ff
/* 80696D98 0000000C  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 80697CF4 */
...
lbl_80696DB4:
/* 80696DB4 00000000  C0 3F 00 54 */	lfs f1, 0x54(r31)	/* effective address: 80697CF4 */
/* 80696DB8 00000004  4B BD 0B 9C */	b cM_rndF__Ff
/* 80696DBC 00000008  C0 1F 00 54 */	lfs f0, 0x54(r31)	/* effective address: 80697CF4 */
...
lbl_80696DD8:
/* 80696DD8 00000000  C0 3F 00 D0 */	lfs f1, 0xd0(r31)	/* effective address: 80697D70 */
/* 80696DDC 00000004  4B BD 0B 78 */	b cM_rndF__Ff
/* 80696DE0 00000008  C0 1F 00 58 */	lfs f0, 0x58(r31)	/* effective address: 80697CF8 */
...
lbl_80696E34:
/* 80696E34 00000000  C0 3F 00 38 */	lfs f1, 0x38(r31)	/* effective address: 80697CD8 */
/* 80696E38 00000004  4B BD 0B 1C */	b cM_rndF__Ff
/* 80696E3C 00000008  C0 1F 00 38 */	lfs f0, 0x38(r31)	/* effective address: 80697CD8 */
...
/* 80696E70 00000008  4B CC B3 B0 */	b _restgpr_27

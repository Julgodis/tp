...
/* 80695080  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80695084  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80695088  C0 3F 00 18 */	lfs f1, 0x18(r31)
/* 8069508C  C0 5F 00 1C */	lfs f2, 0x1c(r31)
/* 80695090  C0 7F 00 20 */	lfs f3, 0x20(r31)
/* 80695094  4B CB 18 54 */	b PSMTXTrans
/* 80695098  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069509C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806950A0  A8 9F 00 3E */	lha r4, 0x3e(r31)
/* 806950A4  4B 97 73 90 */	b mDoMtx_YrotM__FPA4_fs
/* 806950A8  38 61 00 08 */	addi r3, r1, 8
/* 806950AC  38 9F 00 18 */	addi r4, r31, 0x18
/* 806950B0  38 BF 00 0C */	addi r5, r31, 0xc
/* 806950B4  4B BD 1A 80 */	b __mi__4cXyzCFRC3Vec
...
/* 806950DC  3C 60 80 69 */	lis r3, lit_3945@ha
/* 806950E0  C0 03 7C A8 */	lfs f0, lit_3945@l(r3)
...
/* 806950F8  4B BD 25 7C */	b cM_atan2s__Fff
...
/* 80695120  4B BD B4 E8 */	b cLib_addCalcAngleS2__FPssss
/* 80695124  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80695128  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8069512C  A8 9F 00 40 */	lha r4, 0x40(r31)
/* 80695130  4B 97 73 9C */	b mDoMtx_ZrotM__FPA4_fs
/* 80695134  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80695138  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80695160  4B 97 7C D8 */	b scaleM__14mDoMtx_stack_cFfff
/* 80695164  3C 60 80 69 */	lis r3, lit_3945@ha
/* 80695168  C0 23 7C A8 */	lfs f1, lit_3945@l(r3)
/* 8069516C  3C 60 80 69 */	lis r3, lit_4019@ha
/* 80695170  C0 43 7C D0 */	lfs f2, lit_4019@l(r3)
/* 80695174  FC 60 08 90 */	fmr f3, f1
/* 80695178  4B 97 7C 24 */	b transM__14mDoMtx_stack_cFfff
/* 8069517C  88 1F 00 52 */	lbz r0, 0x52(r31)
/* 80695180  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e
/* 80695184  41 82 00 1C */	beq lbl_806951A0
/* 80695188  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8069518C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80695190  80 9F 00 00 */	lwz r4, 0(r31)
/* 80695194  38 84 00 24 */	addi r4, r4, 0x24
/* 80695198  4B CB 13 18 */	b PSMTXCopy
/* 8069519C  48 00 00 18 */	b lbl_806951B4
lbl_806951A0:
/* 806951A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806951A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806951A8  80 9F 00 04 */	lwz r4, 4(r31)
/* 806951AC  38 84 00 24 */	addi r4, r4, 0x24
/* 806951B0  4B CB 13 00 */	b PSMTXCopy
lbl_806951B4:

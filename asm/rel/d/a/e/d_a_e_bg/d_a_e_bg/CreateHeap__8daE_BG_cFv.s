...
/* 80689A1C  4B CD 87 BC */	b _savegpr_28
/* 80689A20  7C 7D 1B 78 */	mr r29, r3
/* 80689A24  3C 60 80 69 */	lis r3, stringBase0@ha
/* 80689A28  38 63 A3 08 */	addi r3, r3, stringBase0@l
/* 80689A2C  38 80 00 0A */	li r4, 0xa
/* 80689A30  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80689A34  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80689A48  4B 9B 28 A4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80689A4C  7C 7E 1B 78 */	mr r30, r3
/* 80689A50  38 60 00 58 */	li r3, 0x58
/* 80689A54  4B C4 51 F8 */	b __nw__FUl
/* 80689A58  7C 7C 1B 79 */	or. r28, r3, r3
/* 80689A5C  41 82 00 68 */	beq lbl_80689AC4
/* 80689A60  3C 60 80 69 */	lis r3, stringBase0@ha
/* 80689A64  38 63 A3 08 */	addi r3, r3, stringBase0@l
/* 80689A68  38 80 00 07 */	li r4, 7
/* 80689A6C  7F E5 FB 78 */	mr r5, r31
/* 80689A70  38 C0 00 80 */	li r6, 0x80
/* 80689A74  4B 9B 28 78 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80689AAC  3D 20 80 69 */	lis r9, lit_3891@ha
/* 80689AB0  C0 29 A2 68 */	lfs f1, lit_3891@l(r9)
/* 80689AB4  39 20 00 00 */	li r9, 0
/* 80689AB8  39 40 FF FF */	li r10, -1
/* 80689ABC  4B 98 6D 14 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80689AF0  3C 60 80 68 */	lis r3, JointCallBack__8daE_BG_cFP8J3DJointi@ha
/* 80689AF4  38 83 59 48 */	addi r4, r3, JointCallBack__8daE_BG_cFP8J3DJointi@l
...
/* 80689B28  4B C4 51 24 */	b __nw__FUl
/* 80689B2C  7C 7C 1B 79 */	or. r28, r3, r3
/* 80689B30  41 82 00 20 */	beq lbl_80689B50
/* 80689B34  3C 80 80 69 */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80689B38  38 04 A4 98 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80689B3C  90 1C 00 00 */	stw r0, 0(r28)
/* 80689B40  38 80 00 00 */	li r4, 0
/* 80689B44  4B C9 E8 B8 */	b init__12J3DFrameCtrlFs
...
lbl_80689B68:
/* 80689B68  3C 60 80 69 */	lis r3, stringBase0@ha
/* 80689B6C  38 63 A3 08 */	addi r3, r3, stringBase0@l
...
/* 80689B80  4B 9B 27 6C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80689B9C  3D 00 80 69 */	lis r8, lit_3891@ha
/* 80689BA0  C0 28 A2 68 */	lfs f1, lit_3891@l(r8)
/* 80689BA4  39 00 00 00 */	li r8, 0
/* 80689BA8  39 20 FF FF */	li r9, -1
/* 80689BAC  4B 98 3B 60 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
/* 80689BB0  30 03 FF FF */	addic r0, r3, -1
/* 80689BB4  7C 60 19 10 */	subfe r3, r0, r3
lbl_80689BB8:
/* 80689BB8  39 61 00 30 */	addi r11, r1, 0x30
/* 80689BBC  4B CD 86 68 */	b _restgpr_28

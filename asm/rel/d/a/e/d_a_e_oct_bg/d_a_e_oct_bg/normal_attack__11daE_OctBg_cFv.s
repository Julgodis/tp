...
/* 80737C58 00000010  4B C2 A5 80 */	b _savegpr_28
/* 80737C5C 00000014  7C 7C 1B 78 */	mr r28, r3
/* 80737C60 00000018  3C 60 80 74 */	lis r3, lit_3768@ha
/* 80737C64 0000001C  3B C3 9D 60 */	addi r30, r3, lit_3768@l
/* 80737C68 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80737C6C 00000024  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 80737C70 00000028  83 BF 5D AC */	lwz r29, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 80737C88 00000040  3C 60 80 74 */	lis r3, data_8073A172@ha
/* 80737C8C 00000044  38 83 A1 72 */	addi r4, r3, data_8073A172@l
/* 80737C90 00000048  88 64 00 00 */	lbz r3, 0(r4)	/* effective address: 8073A172 */
/* 80737C94 0000004C  38 03 00 01 */	addi r0, r3, 1
/* 80737C98 00000050  98 04 00 00 */	stb r0, 0(r4)	/* effective address: 8073A172 */
/* 80737C9C 00000054  C0 3E 00 3C */	lfs f1, 0x3c(r30)	/* effective address: 80739D9C */
/* 80737CA0 00000058  4B B2 FC EC */	b cM_rndFX__Ff
/* 80737CA4 0000005C  C0 1E 00 A0 */	lfs f0, 0xa0(r30)	/* effective address: 80739E00 */
...
/* 80737CDC 00000010  3C 60 80 74 */	lis r3, data_8073A172@ha
/* 80737CE0 00000014  38 83 A1 72 */	addi r4, r3, data_8073A172@l
/* 80737CE4 00000018  88 64 00 00 */	lbz r3, 0(r4)	/* effective address: 8073A172 */
/* 80737CE8 0000001C  38 03 FF FF */	addi r0, r3, -1
/* 80737CEC 00000020  98 04 00 00 */	stb r0, 0(r4)	/* effective address: 8073A172 */
...
/* 80737D14 00000020  80 1F 5F 18 */	lwz r0, 0x5f18(r31)	/* effective address: 8040C0D8 */
/* 80737D18 00000024  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb
/* 80737D1C 00000028  41 82 00 14 */	beq lbl_80737D30
/* 80737D20 0000002C  C0 1E 00 A0 */	lfs f0, 0xa0(r30)	/* effective address: 80739E00 */
...
lbl_80737D30:
/* 80737D30 00000000  C0 1E 00 A4 */	lfs f0, 0xa4(r30)	/* effective address: 80739E04 */
...
/* 80737D44 00000008  4B B3 8E C0 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80737D68 0000002C  4B B3 8E 28 */	b cLib_chaseAngleS__FPsss
/* 80737D6C 00000030  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80737D70 00000034  38 81 00 48 */	addi r4, r1, 0x48
/* 80737D74 00000038  4B B3 8F 00 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80737D88 0000004C  4B B3 8E 08 */	b cLib_chaseAngleS__FPsss
/* 80737D8C 00000050  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80737D90 00000054  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80737DA8 0000006C  C0 1E 00 A8 */	lfs f0, 0xa8(r30)	/* effective address: 80739E08 */
/* 80737DAC 00000070  EC 20 00 72 */	fmuls f1, f0, f1
/* 80737DB0 00000074  C0 5E 00 74 */	lfs f2, 0x74(r30)	/* effective address: 80739DD4 */
/* 80737DB4 00000078  4B B3 89 8C */	b cLib_chaseF__FPfff
/* 80737DB8 0000007C  A8 1C 04 DC */	lha r0, 0x4dc(r28)
/* 80737DBC 00000080  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80737DC0 00000084  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80737DC4 00000088  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 80737DC8 0000008C  7C 23 04 2E */	lfsx f1, r3, r0
/* 80737DCC 00000090  38 7C 04 FC */	addi r3, r28, 0x4fc
/* 80737DD0 00000094  C0 1E 00 AC */	lfs f0, 0xac(r30)	/* effective address: 80739E0C */
/* 80737DD4 00000098  EC 20 00 72 */	fmuls f1, f0, f1
/* 80737DD8 0000009C  C0 5E 00 74 */	lfs f2, 0x74(r30)	/* effective address: 80739DD4 */
/* 80737DDC 000000A0  4B B3 89 64 */	b cLib_chaseF__FPfff
/* 80737DE0 000000A4  7F 83 E3 78 */	mr r3, r28
/* 80737DE4 000000A8  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 80737DE8 000000AC  4B 8E 29 28 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80737E0C 000000D0  4B B3 87 34 */	b cLib_addCalcAngleS__FPsssss
...
/* 80737E64 00000020  80 1F 5F 18 */	lwz r0, 0x5f18(r31)	/* effective address: 8040C0D8 */
/* 80737E68 00000024  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb
/* 80737E6C 00000028  41 82 00 14 */	beq lbl_80737E80
/* 80737E70 0000002C  C0 1E 00 A0 */	lfs f0, 0xa0(r30)	/* effective address: 80739E00 */
...
lbl_80737E80:
/* 80737E80 00000000  C0 1E 00 A4 */	lfs f0, 0xa4(r30)	/* effective address: 80739E04 */
...
/* 80737E94 00000008  4B B3 8D 70 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80737EB8 0000002C  4B B3 8C D8 */	b cLib_chaseAngleS__FPsss
/* 80737EBC 00000030  38 7C 04 D0 */	addi r3, r28, 0x4d0
/* 80737EC0 00000034  38 81 00 3C */	addi r4, r1, 0x3c
/* 80737EC4 00000038  4B B3 8D B0 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80737ED8 0000004C  4B B3 8C B8 */	b cLib_chaseAngleS__FPsss
/* 80737EDC 00000050  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80737EE0 00000054  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80737EF8 0000006C  C0 1E 00 90 */	lfs f0, 0x90(r30)	/* effective address: 80739DF0 */
/* 80737EFC 00000070  EC 20 00 72 */	fmuls f1, f0, f1
/* 80737F00 00000074  C0 5E 00 74 */	lfs f2, 0x74(r30)	/* effective address: 80739DD4 */
/* 80737F04 00000078  4B B3 88 3C */	b cLib_chaseF__FPfff
/* 80737F08 0000007C  A8 1C 04 DC */	lha r0, 0x4dc(r28)
/* 80737F0C 00000080  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 80737F10 00000084  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80737F14 00000088  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 80737F18 0000008C  7C 23 04 2E */	lfsx f1, r3, r0
/* 80737F1C 00000090  38 7C 04 FC */	addi r3, r28, 0x4fc
/* 80737F20 00000094  C0 1E 00 94 */	lfs f0, 0x94(r30)	/* effective address: 80739DF4 */
/* 80737F24 00000098  EC 20 00 72 */	fmuls f1, f0, f1
/* 80737F28 0000009C  C0 5E 00 74 */	lfs f2, 0x74(r30)	/* effective address: 80739DD4 */
/* 80737F2C 000000A0  4B B3 88 14 */	b cLib_chaseF__FPfff
/* 80737F30 000000A4  7F 83 E3 78 */	mr r3, r28
/* 80737F34 000000A8  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 80737F38 000000AC  4B 8E 27 D8 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80737F5C 000000D0  4B B3 85 E4 */	b cLib_addCalcAngleS__FPsssss
...
/* 80737F7C 000000F0  C0 3E 00 30 */	lfs f1, 0x30(r30)	/* effective address: 80739D90 */
...
/* 80737FA4 00000118  4B C0 F3 F8 */	b PSVECSquareDistance
/* 80737FA8 0000011C  C0 1E 00 30 */	lfs f0, 0x30(r30)	/* effective address: 80739D90 */
...
/* 80737FB8 00000008  C8 9E 00 48 */	lfd f4, 0x48(r30)	/* effective address: 80739DA8 */
/* 80737FBC 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80737FC0 00000010  C8 7E 00 50 */	lfd f3, 0x50(r30)	/* effective address: 80739DB0 */
...
lbl_80738008:
/* 80738008 00000000  C8 1E 00 58 */	lfd f0, 0x58(r30)	/* effective address: 80739DB8 */
/* 8073800C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80738010 00000000  40 80 00 10 */	bge lbl_80738020
/* 80738014 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80738018 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80738084 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80738088 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8073808C:
/* 8073808C 00000000  3C 60 80 74 */	lis r3, l_HIO@ha
/* 80738090 00000004  38 63 A1 4C */	addi r3, r3, l_HIO@l
/* 80738094 00000008  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 8073A154 */
...
/* 807380A8 0000000C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 8073A158 */
...
/* 807380B8 00000008  3C 60 80 74 */	lis r3, lit_4476@ha
/* 807380BC 0000000C  38 83 9F 78 */	addi r4, r3, lit_4476@l
/* 807380C0 00000010  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80739F78 */
/* 807380C4 00000014  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80739F7C */
/* 807380C8 00000018  90 61 00 30 */	stw r3, 0x30(r1)
/* 807380CC 0000001C  90 01 00 34 */	stw r0, 0x34(r1)
/* 807380D0 00000020  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80739F80 */
...
lbl_807380E8:
/* 807380E8 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 807380EC 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 807380F0 00000008  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
lbl_80738108:
/* 80738108 00000000  3C 60 80 74 */	lis r3, lit_4481@ha
/* 8073810C 00000004  38 83 9F 84 */	addi r4, r3, lit_4481@l
/* 80738110 00000008  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80739F84 */
/* 80738114 0000000C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80739F88 */
/* 80738118 00000010  90 61 00 24 */	stw r3, 0x24(r1)
/* 8073811C 00000014  90 01 00 28 */	stw r0, 0x28(r1)
/* 80738120 00000018  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80739F8C */
...
/* 80738138 00000004  4B C2 A0 EC */	b _restgpr_28

...
/* 8050C650 00000020  3C 60 80 52 */	lis r3, lit_4208@ha
/* 8050C654 00000024  3B E3 85 84 */	addi r31, r3, lit_4208@l
/* 8050C658 00000028  C3 FF 00 04 */	lfs f31, 4(r31)	/* effective address: 80518588 */
...
/* 8050C6B8 00000030  C0 3F 00 A8 */	lfs f1, 0xa8(r31)	/* effective address: 8051862C */
/* 8050C6BC 00000034  38 A0 00 00 */	li r5, 0
/* 8050C6C0 00000038  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 8051858C */
...
/* 8050C6D0 00000048  3C 60 80 52 */	lis r3, data_80519200@ha
/* 8050C6D4 0000004C  88 03 92 00 */	lbz r0, data_80519200@l(r3)
...
/* 8050C74C 00000010  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 80518588 */
/* 8050C750 00000014  38 A0 00 02 */	li r5, 2
/* 8050C754 00000018  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 8051858C */
...
lbl_8050C77C:
/* 8050C77C 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8050C780 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8050C784 00000008  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 8050C788 0000000C  3C 80 80 52 */	lis r4, stringBase0@ha
/* 8050C78C 00000010  38 84 89 68 */	addi r4, r4, stringBase0@l
/* 8050C790 00000014  38 84 00 0E */	addi r4, r4, 0xe
/* 8050C794 00000018  4B E5 C2 00 */	b strcmp
...
/* 8050C7B0 00000004  C0 3F 00 AC */	lfs f1, 0xac(r31)	/* effective address: 80518630 */
/* 8050C7B4 00000008  4B FF F9 79 */	bl gake_check__FP10e_rd_classf
/* 8050C7B8 0000000C  B0 7E 05 CC */	sth r3, 0x5cc(r30)
lbl_8050C7BC:
/* 8050C7BC 00000000  3C 60 80 51 */	lis r3, s_bikkuri_sub__FPvPv@ha
/* 8050C7C0 00000004  38 63 C2 D8 */	addi r3, r3, s_bikkuri_sub__FPvPv@l
/* 8050C7C4 00000008  7F C4 F3 78 */	mr r4, r30
/* 8050C7C8 0000000C  4B B1 4B 70 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 8050C800 00000028  C3 FF 00 DC */	lfs f31, 0xdc(r31)	/* effective address: 80518660 */
...
/* 8050C814 0000003C  4B D6 3D F4 */	b cLib_addCalcAngleS2__FPssss
...
/* 8050C83C 00000004  C0 3F 00 64 */	lfs f1, 0x64(r31)	/* effective address: 805185E8 */
...
/* 8050C86C 00000034  C0 1F 00 70 */	lfs f0, 0x70(r31)	/* effective address: 805185F4 */
...
/* 8050C894 0000000C  3C 60 80 51 */	lis r3, s_saku_sub__FPvPv@ha
/* 8050C898 00000010  38 63 C4 B0 */	addi r3, r3, s_saku_sub__FPvPv@l
/* 8050C89C 00000014  7F C4 F3 78 */	mr r4, r30
/* 8050C8A0 00000018  4B B1 4A 98 */	b fpcEx_Search__FPFPvPv_PvPv
/* 8050C8A4 0000001C  28 03 00 00 */	cmplwi r3, 0
/* 8050C8A8 00000020  41 82 00 08 */	beq lbl_8050C8B0
/* 8050C8AC 00000024  48 70 8C 80 */	b BreakSet__13daObjH_Saku_cFv
lbl_8050C8B0:
/* 8050C8B0 00000000  C3 FF 00 4C */	lfs f31, 0x4c(r31)	/* effective address: 805185D0 */
...
/* 8050C8C0 00000010  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80518588 */
...
/* 8050C8FC 00000008  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8050C900 0000000C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8050C910 0000001C  C0 1F 01 1C */	lfs f0, 0x11c(r31)	/* effective address: 805186A0 */
...
/* 8050C98C 00000010  4B D6 3C 7C */	b cLib_addCalcAngleS2__FPssss
...
/* 8050C9A0 00000024  4B D6 3C 68 */	b cLib_addCalcAngleS2__FPssss
...
/* 8050C9BC 00000040  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80518584 */
...
/* 8050CA24 0000001C  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80518588 */
...
/* 8050CA38 00000008  C0 5F 00 08 */	lfs f2, 8(r31)	/* effective address: 8051858C */
/* 8050CA3C 0000000C  C0 7F 00 4C */	lfs f3, 0x4c(r31)	/* effective address: 805185D0 */
/* 8050CA40 00000010  4B D6 2F FC */	b cLib_addCalc2__FPffff
lbl_8050CA44:

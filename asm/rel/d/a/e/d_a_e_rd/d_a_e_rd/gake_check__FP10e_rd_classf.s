...
/* 8050C15C  4B E5 60 74 */	b _savegpr_26
/* 8050C160  FF 80 08 90 */	fmr f28, f1
/* 8050C164  3C 80 80 52 */	lis r4, lit_4208@ha
/* 8050C168  3B C4 85 84 */	addi r30, r4, lit_4208@l
/* 8050C16C  7C 7C 1B 78 */	mr r28, r3
/* 8050C170  38 61 00 90 */	addi r3, r1, 0x90
/* 8050C174  4B B6 B4 08 */	b __ct__11dBgS_GndChkFv
/* 8050C178  38 61 00 20 */	addi r3, r1, 0x20
/* 8050C17C  4B B6 BA EC */	b __ct__11dBgS_LinChkFv
/* 8050C180  AB 7C 04 E6 */	lha r27, 0x4e6(r28)
/* 8050C184  3B 40 00 00 */	li r26, 0
/* 8050C188  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8050C18C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8050C190  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 8050C194  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8050C198  3B E3 07 68 */	addi r31, r3, calc_mtx@l
/* 8050C19C  C3 BE 00 04 */	lfs f29, 4(r30)
/* 8050C1A0  C3 DE 00 00 */	lfs f30, 0(r30)
/* 8050C1A4  C3 FE 00 3C */	lfs f31, 0x3c(r30)
lbl_8050C1A8:
/* 8050C1A8  80 7F 00 00 */	lwz r3, 0(r31)	/* effective address: 80450768 */
/* 8050C1AC  7F 64 DB 78 */	mr r4, r27
/* 8050C1B0  4B B0 02 2C */	b mDoMtx_YrotS__FPA4_fs
...
/* 8050C238  4B B6 BB 2C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 8050C23C  7F A3 EB 78 */	mr r3, r29
/* 8050C240  38 81 00 20 */	addi r4, r1, 0x20
/* 8050C244  4B B6 81 70 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 8050C258  4B B6 BA 84 */	b __dt__11dBgS_LinChkFv
/* 8050C25C  38 61 00 90 */	addi r3, r1, 0x90
/* 8050C260  38 80 FF FF */	li r4, -1
/* 8050C264  4B B6 B3 8C */	b __dt__11dBgS_GndChkFv
...
/* 8050C28C  4B B6 BA 50 */	b __dt__11dBgS_LinChkFv
/* 8050C290  38 61 00 90 */	addi r3, r1, 0x90
/* 8050C294  38 80 FF FF */	li r4, -1
/* 8050C298  4B B6 B3 58 */	b __dt__11dBgS_GndChkFv
...
/* 8050C2C4  4B E5 5F 58 */	b _restgpr_26

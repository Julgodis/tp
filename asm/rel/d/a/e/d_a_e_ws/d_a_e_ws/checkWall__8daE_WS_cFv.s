...
/* 807E6408  4B B7 BD D0 */	b _savegpr_28
/* 807E640C  7C 7F 1B 78 */	mr r31, r3
/* 807E6410  3C 60 80 7E */	lis r3, lit_3802@ha
/* 807E6414  3B A3 73 00 */	addi r29, r3, lit_3802@l
/* 807E6418  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 807E641C  4B 82 69 48 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 807E6420  38 7F 06 6E */	addi r3, r31, 0x66e
/* 807E6424  4B 82 6B 20 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 807E6428  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 807E642C  4B 82 6B 18 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 807E6430  C0 3D 00 04 */	lfs f1, 4(r29)
/* 807E6434  C0 5D 00 00 */	lfs f2, 0(r29)
/* 807E6438  FC 60 08 90 */	fmr f3, f1
/* 807E643C  4B 82 69 60 */	b transM__14mDoMtx_stack_cFfff
/* 807E6440  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E6444  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 807E6448  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 807E644C  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 807E6450  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 807E6454  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 807E6458  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 807E646C  4B 82 69 30 */	b transM__14mDoMtx_stack_cFfff
...
/* 807E648C  4B 89 17 DC */	b __ct__11dBgS_LinChkFv
...
/* 807E64A0  4B 89 18 C4 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807E64A4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807E64A8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807E64AC  3B C3 0F 38 */	addi r30, r3, 0xf38
/* 807E64B0  7F C3 F3 78 */	mr r3, r30
/* 807E64B4  38 81 00 44 */	addi r4, r1, 0x44
/* 807E64B8  4B 88 DE FC */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 807E64DC  4B 88 E9 24 */	b GetWallCode__4dBgSFRC13cBgS_PolyInfo
...
/* 807E64F0  4B 88 E9 10 */	b GetWallCode__4dBgSFRC13cBgS_PolyInfo
...
/* 807E6504  4B 89 17 D8 */	b __dt__11dBgS_LinChkFv
...
/* 807E6528  3C 60 80 7E */	lis r3, __vt__8cM3dGPla@ha
/* 807E652C  38 03 75 94 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 807E6540  4B 88 E2 04 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
/* 807E6544  C0 21 00 30 */	lfs f1, 0x30(r1)
/* 807E6548  C0 41 00 38 */	lfs f2, 0x38(r1)
/* 807E654C  4B A8 11 28 */	b cM_atan2s__Fff
...
/* 807E6570  4B B6 0B C8 */	b PSVECSquareMag
...
/* 807E65E0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807E65E4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807E6650  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807E6654  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807E6658:
/* 807E6658  C0 41 00 34 */	lfs f2, 0x34(r1)
/* 807E665C  4B A8 10 18 */	b cM_atan2s__Fff
/* 807E6660  B0 7F 06 68 */	sth r3, 0x668(r31)
/* 807E6664  3C 60 80 7E */	lis r3, __vt__8cM3dGPla@ha
/* 807E6668  38 03 75 94 */	addi r0, r3, __vt__8cM3dGPla@l
/* 807E666C  90 01 00 40 */	stw r0, 0x40(r1)
/* 807E6670  38 61 00 44 */	addi r3, r1, 0x44
/* 807E6674  38 80 FF FF */	li r4, -1
/* 807E6678  4B 89 16 64 */	b __dt__11dBgS_LinChkFv
...
/* 807E668C  4B 89 16 50 */	b __dt__11dBgS_LinChkFv
/* 807E6690  38 60 00 00 */	li r3, 0
lbl_807E6694:
/* 807E6694  39 61 00 D0 */	addi r11, r1, 0xd0
/* 807E6698  4B B7 BB 8C */	b _restgpr_28

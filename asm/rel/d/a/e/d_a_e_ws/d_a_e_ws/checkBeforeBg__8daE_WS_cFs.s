...
/* 807E5FC8  4B B7 C2 10 */	b _savegpr_28
/* 807E5FCC  7C 7F 1B 78 */	mr r31, r3
/* 807E5FD0  7C 9C 23 78 */	mr r28, r4
/* 807E5FD4  3C 60 80 7E */	lis r3, lit_3802@ha
/* 807E5FD8  3B C3 73 00 */	addi r30, r3, lit_3802@l
/* 807E5FDC  38 61 00 88 */	addi r3, r1, 0x88
/* 807E5FE0  4B 89 1C 88 */	b __ct__11dBgS_LinChkFv
...
/* 807E5FFC  4B 89 1C E0 */	b __dt__11dBgS_LinChkFv
/* 807E6000  38 60 00 00 */	li r3, 0
/* 807E6004  48 00 03 DC */	b lbl_807E63E0
lbl_807E6008:
/* 807E6008  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E600C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6010  A8 9F 06 6A */	lha r4, 0x66a(r31)
/* 807E6014  4B 82 63 C8 */	b mDoMtx_YrotS__FPA4_fs
/* 807E6018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E601C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6020  A8 9F 06 68 */	lha r4, 0x668(r31)
/* 807E6024  4B 82 63 78 */	b mDoMtx_XrotM__FPA4_fs
/* 807E6028  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E602C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6030  7F 84 E3 78 */	mr r4, r28
/* 807E6034  4B 82 64 00 */	b mDoMtx_YrotM__FPA4_fs
...
/* 807E6054  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E6058  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E605C  38 81 00 68 */	addi r4, r1, 0x68
/* 807E6060  38 A1 00 44 */	addi r5, r1, 0x44
/* 807E6064  4B B6 0D 08 */	b PSMTXMultVec
/* 807E6068  38 61 00 44 */	addi r3, r1, 0x44
/* 807E606C  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 807E6070  7C 65 1B 78 */	mr r5, r3
/* 807E6074  4B B6 10 1C */	b PSVECAdd
/* 807E6078  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E607C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6080  A8 9F 06 6A */	lha r4, 0x66a(r31)
/* 807E6084  4B 82 63 58 */	b mDoMtx_YrotS__FPA4_fs
/* 807E6088  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E608C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6090  A8 9F 06 68 */	lha r4, 0x668(r31)
/* 807E6094  4B 82 63 08 */	b mDoMtx_XrotM__FPA4_fs
/* 807E6098  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E609C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E60A0  7F 84 E3 78 */	mr r4, r28
/* 807E60A4  4B 82 63 90 */	b mDoMtx_YrotM__FPA4_fs
...
/* 807E60C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E60C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E60CC  38 81 00 68 */	addi r4, r1, 0x68
/* 807E60D0  38 A1 00 5C */	addi r5, r1, 0x5c
/* 807E60D4  4B B6 0C 98 */	b PSMTXMultVec
...
/* 807E60FC  4B A8 09 E8 */	b __pl__4cXyzCFRC3Vec
...
/* 807E6128  4B 89 1C 3C */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807E612C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807E6130  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807E6134  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 807E6138  7F A3 EB 78 */	mr r3, r29
/* 807E613C  38 81 00 88 */	addi r4, r1, 0x88
/* 807E6140  4B 88 E2 74 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 807E6154  4B 89 1B 88 */	b __dt__11dBgS_LinChkFv
...
/* 807E6190  3C 60 80 7E */	lis r3, l_HIO@ha
/* 807E6194  38 63 75 C8 */	addi r3, r3, l_HIO@l
/* 807E6198  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 807E75E0 */
...
/* 807E61B4  4B A8 09 30 */	b __pl__4cXyzCFRC3Vec
...
/* 807E61E0  4B 89 1B 84 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807E61E4  7F A3 EB 78 */	mr r3, r29
/* 807E61E8  38 81 00 88 */	addi r4, r1, 0x88
/* 807E61EC  4B 88 E1 C8 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 807E6200  4B 89 1A DC */	b __dt__11dBgS_LinChkFv
/* 807E6204  38 60 00 01 */	li r3, 1
/* 807E6208  48 00 01 D8 */	b lbl_807E63E0
lbl_807E620C:
/* 807E620C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E6210  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6214  A8 9F 06 6A */	lha r4, 0x66a(r31)
/* 807E6218  4B 82 61 C4 */	b mDoMtx_YrotS__FPA4_fs
/* 807E621C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E6220  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6224  A8 9F 06 68 */	lha r4, 0x668(r31)
/* 807E6228  4B 82 61 74 */	b mDoMtx_XrotM__FPA4_fs
/* 807E622C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E6230  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6234  7F 84 E3 78 */	mr r4, r28
/* 807E6238  4B 82 61 FC */	b mDoMtx_YrotM__FPA4_fs
...
/* 807E6260  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E6264  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E6268  38 81 00 68 */	addi r4, r1, 0x68
/* 807E626C  38 A1 00 5C */	addi r5, r1, 0x5c
/* 807E6270  4B B6 0A FC */	b PSMTXMultVec
/* 807E6274  38 61 00 14 */	addi r3, r1, 0x14
/* 807E6278  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 807E627C  38 A1 00 5C */	addi r5, r1, 0x5c
/* 807E6280  4B A8 08 64 */	b __pl__4cXyzCFRC3Vec
...
/* 807E62C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807E62C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807E62C8  38 81 00 38 */	addi r4, r1, 0x38
/* 807E62CC  38 A1 00 5C */	addi r5, r1, 0x5c
/* 807E62D0  4B B6 0A 9C */	b PSMTXMultVec
/* 807E62D4  38 61 00 08 */	addi r3, r1, 8
/* 807E62D8  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 807E62DC  38 A1 00 5C */	addi r5, r1, 0x5c
/* 807E62E0  4B A8 08 04 */	b __pl__4cXyzCFRC3Vec
...
/* 807E630C  4B 89 1A 58 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 807E6310  7F A3 EB 78 */	mr r3, r29
/* 807E6314  38 81 00 88 */	addi r4, r1, 0x88
/* 807E6318  4B 88 E0 9C */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 807E632C  4B 89 19 B0 */	b __dt__11dBgS_LinChkFv
...
/* 807E6350  4B 88 EA B0 */	b GetWallCode__4dBgSFRC13cBgS_PolyInfo
...
/* 807E6364  4B 88 EA 9C */	b GetWallCode__4dBgSFRC13cBgS_PolyInfo
...
/* 807E6378  4B 89 19 64 */	b __dt__11dBgS_LinChkFv
/* 807E637C  38 60 00 01 */	li r3, 1
/* 807E6380  48 00 00 60 */	b lbl_807E63E0
lbl_807E6384:
/* 807E6384  3C 60 80 7E */	lis r3, __vt__8cM3dGPla@ha
/* 807E6388  38 03 75 94 */	addi r0, r3, __vt__8cM3dGPla@l

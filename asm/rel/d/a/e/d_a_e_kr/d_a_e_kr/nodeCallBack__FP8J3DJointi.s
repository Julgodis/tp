...
/* 806FF9CC 00000020  3C 60 00 00 */	lis r3, j3dSys@ha
/* 806FF9D0 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l
...
/* 806FF9F4 00000048  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 806FF9F8 0000004C  38 84 00 00 */	addi r4, r4, calc_mtx@l
...
lbl_806FFA14:
/* 806FFA14 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFA18 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFA34 00000020  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFA38 00000024  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFA48 00000034  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFA4C 00000038  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFA74 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFA78 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFAA4 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFAA8 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFAD0 00000010  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFAD4 00000014  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFAF0 00000030  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFAF4 00000034  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFB20 00000010  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFB24 00000014  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFB40 00000030  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFB44 00000034  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFB64 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFB68 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFB84 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFB88 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFBAC 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFBB0 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFBD4 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFBD8 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
lbl_806FFC04:
/* 806FFC04 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFC08 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFC18 00000014  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFC1C 00000018  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFC40 00000014  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFC44 00000018  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFC5C 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFC60 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFC78 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFC7C 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 806FFC80 00000010  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFC84 00000014  4B FF FC 95 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_806FFC88:
/* 806FFC88 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFC8C 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 806FFCA4 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 806FFCA8 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 806FFCAC 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFCB0 00000028  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806FFCB4 0000002C  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l

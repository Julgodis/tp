...
/* 806FF9BC 00000010  4B FF FF 5D */	bl _savegpr_28
...
/* 806FF9CC 00000020  3C 60 00 00 */	lis r3, j3dSys@ha /* 80434AC8 */
/* 806FF9D0 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l /* 80434AC8 */
/* 806FF9D4 00000028  83 C3 00 38 */	lwz r30, 0x38(r3)
...
/* 806FF9F4 00000048  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 806FF9F8 0000004C  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
/* 806FF9FC 00000050  80 84 00 00 */	lwz r4, 0(r4)
/* 806FFA00 00000054  4B FF FF 19 */	bl PSMTXCopy
...
lbl_806FFA14:
/* 806FFA14 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFA18 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFA1C 00000008  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFA30 0000001C  4B FF FE E9 */	bl mDoMtx_YrotM__FPA4_fs
/* 806FFA34 00000020  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFA38 00000024  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFA3C 00000028  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFA40 0000002C  A8 9C 0E 7C */	lha r4, 0xe7c(r28)
/* 806FFA44 00000030  4B FF FE D5 */	bl mDoMtx_XrotM__FPA4_fs
/* 806FFA48 00000034  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFA4C 00000038  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFA50 0000003C  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFA64 00000050  4B FF FE B5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 806FFA74 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFA78 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFA7C 00000010  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFA94 00000028  4B FF FE 85 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 806FFAA4 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFAA8 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFAAC 00000010  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFABC 00000020  4B FF FE 5D */	bl mDoMtx_ZrotM__FPA4_fs
lbl_806FFAC0:
...
/* 806FFAD0 00000010  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFAD4 00000014  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFAD8 00000018  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFAEC 0000002C  4B FF FE 2D */	bl mDoMtx_ZrotM__FPA4_fs
/* 806FFAF0 00000030  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFAF4 00000034  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFAF8 00000038  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFB08 00000048  4B FF FE 11 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 806FFB20 00000010  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFB24 00000014  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFB28 00000018  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFB3C 0000002C  4B FF FD DD */	bl mDoMtx_ZrotM__FPA4_fs
/* 806FFB40 00000030  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFB44 00000034  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFB48 00000038  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFB58 00000048  4B FF FD C1 */	bl mDoMtx_XrotM__FPA4_fs
lbl_806FFB5C:
/* 806FFB5C 00000000  2C 1F 00 03 */	cmpwi r31, 3
/* 806FFB60 00000004  40 82 00 1C */	bne lbl_806FFB7C
/* 806FFB64 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFB68 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFB6C 00000010  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFB70 00000014  A8 9C 0E AC */	lha r4, 0xeac(r28)
/* 806FFB74 00000018  4B FF FD A5 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 806FFB84 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFB88 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFB8C 00000010  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFB9C 00000020  4B FF FD 7D */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 806FFBAC 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFBB0 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFBB4 00000010  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFBC4 00000020  4B FF FD 55 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 806FFBD4 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFBD8 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFBDC 00000010  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFBEC 00000020  4B FF FD 2D */	bl mDoMtx_ZrotM__FPA4_fs
...
lbl_806FFC04:
/* 806FFC04 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFC08 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFC0C 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFC10 0000000C  A8 9C 0E B6 */	lha r4, 0xeb6(r28)
/* 806FFC14 00000010  4B FF FD 05 */	bl mDoMtx_YrotM__FPA4_fs
/* 806FFC18 00000014  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFC1C 00000018  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFC20 0000001C  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFC24 00000020  A8 9C 0E B6 */	lha r4, 0xeb6(r28)
/* 806FFC28 00000024  4B FF FC F1 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_806FFC2C:
...
/* 806FFC40 00000014  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFC44 00000018  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFC48 0000001C  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFC4C 00000020  4B FF FC CD */	bl mDoMtx_YrotM__FPA4_fs
...
/* 806FFC5C 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFC60 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFC64 00000010  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFC68 00000014  4B FF FC B1 */	bl mDoMtx_XrotM__FPA4_fs
...
/* 806FFC78 00000008  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFC7C 0000000C  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFC80 00000010  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFC84 00000014  4B FF FC 95 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_806FFC88:
/* 806FFC88 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFC8C 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFC90 00000008  80 63 00 00 */	lwz r3, 0(r3)
...
/* 806FFCA0 00000018  4B FF FC 79 */	bl PSMTXCopy
/* 806FFCA4 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 806FFCA8 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
/* 806FFCAC 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 806FFCB0 00000028  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 806FFCB4 0000002C  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */
/* 806FFCB8 00000030  4B FF FC 61 */	bl PSMTXCopy
lbl_806FFCBC:
/* 806FFCBC 00000000  38 60 00 01 */	li r3, 1
/* 806FFCC0 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 806FFCC4 00000008  4B FF FC 55 */	bl _restgpr_28

...
/* 806D3620  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806D3624  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 806D372C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 806D7C58 */
/* 806D3730  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 806D7C5C */
/* 806D3734  90 61 00 0C */	stw r3, 0xc(r1)
/* 806D3738  90 01 00 10 */	stw r0, 0x10(r1)
/* 806D373C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 806D7C60 */
...
/* 806D3764  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806D3768  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l

...
/* 806D35FC 00000018  3C 60 80 6D */	lis r3, lit_3906@ha
/* 806D3600 0000001C  3B C3 79 A0 */	addi r30, r3, lit_3906@l
...
/* 806D3610 0000002C  3C 60 80 6D */	lis r3, stringBase0@ha
/* 806D3614 00000030  38 63 7A F0 */	addi r3, r3, stringBase0@l
/* 806D3618 00000034  38 63 00 05 */	addi r3, r3, 5
/* 806D361C 00000038  38 80 00 06 */	li r4, 6
/* 806D3620 0000003C  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha
/* 806D3624 00000040  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 806D3634 00000050  4B 96 8C B8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D3644 00000060  C0 3E 00 78 */	lfs f1, 0x78(r30)	/* effective address: 806D7A18 */
/* 806D3648 00000064  C0 5E 00 08 */	lfs f2, 8(r30)	/* effective address: 806D79A8 */
/* 806D364C 00000068  C0 7E 00 04 */	lfs f3, 4(r30)	/* effective address: 806D79A4 */
/* 806D3650 0000006C  C0 9E 00 44 */	lfs f4, 0x44(r30)	/* effective address: 806D79E4 */
/* 806D3654 00000070  4B 93 D8 1C */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D3678 00000094  3C 60 80 6D */	lis r3, struct_806D7F1C+0x3@ha
/* 806D367C 00000098  98 03 7F 1F */	stb r0, struct_806D7F1C+0x3@l(r3)
/* 806D3680 0000009C  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 806D79A4 */
/* 806D3684 000000A0  D0 1F 05 2C */	stfs f0, 0x52c(r31)
/* 806D3688 000000A4  C0 1E 00 54 */	lfs f0, 0x54(r30)	/* effective address: 806D79F4 */
/* 806D368C 000000A8  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 806D3690 000000AC  C0 1E 00 4C */	lfs f0, 0x4c(r30)	/* effective address: 806D79EC */
...
/* 806D36EC 0000000C  C0 3E 00 E0 */	lfs f1, 0xe0(r30)	/* effective address: 806D7A80 */
/* 806D36F0 00000010  C0 5E 00 08 */	lfs f2, 8(r30)	/* effective address: 806D79A8 */
/* 806D36F4 00000014  C0 7E 00 A0 */	lfs f3, 0xa0(r30)	/* effective address: 806D7A40 */
/* 806D36F8 00000018  4B B9 C3 44 */	b cLib_addCalc2__FPffff
...
/* 806D3714 00000034  C0 3E 00 E0 */	lfs f1, 0xe0(r30)	/* effective address: 806D7A80 */
...
/* 806D3724 00000044  3C 60 80 6D */	lis r3, lit_4863@ha
/* 806D3728 00000048  38 83 7C 58 */	addi r4, r3, lit_4863@l
/* 806D372C 0000004C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 806D7C58 */
/* 806D3730 00000050  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 806D7C5C */
/* 806D3734 00000054  90 61 00 0C */	stw r3, 0xc(r1)
/* 806D3738 00000058  90 01 00 10 */	stw r0, 0x10(r1)
/* 806D373C 0000005C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 806D7C60 */
...
/* 806D375C 00000008  4B 94 6F 70 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D3760 0000000C  38 7F 05 F4 */	addi r3, r31, 0x5f4
/* 806D3764 00000010  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 806D3768 00000014  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 806D376C 00000018  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D3770 0000001C  4B 9A 33 3C */	b CrrPos__9dBgS_AcchFR4dBgS
lbl_806D3774:

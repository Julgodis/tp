...
/* 806D4654  4B C8 DB 7C */	b _savegpr_26
/* 806D4658  7C 7C 1B 78 */	mr r28, r3
/* 806D465C  3C 80 80 6D */	lis r4, lit_3906@ha
/* 806D4660  3B E4 79 A0 */	addi r31, r4, lit_3906@l
...
/* 806D4678  3C 60 80 6D */	lis r3, stringBase0@ha
/* 806D467C  38 63 7A F0 */	addi r3, r3, stringBase0@l
/* 806D4680  38 63 00 05 */	addi r3, r3, 5
/* 806D4684  38 80 00 0A */	li r4, 0xa
/* 806D4688  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806D468C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 806D4690  3C A5 00 02 */	addis r5, r5, 2
/* 806D4694  38 C0 00 80 */	li r6, 0x80
/* 806D4698  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D469C  4B 96 7C 50 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D46BC  4B 93 C7 B4 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D46EC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806D46F0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 806D46F4  83 C4 5D AC */	lwz r30, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 806D470C  4B 94 5F C0 */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 806D4710  38 7C 05 F4 */	addi r3, r28, 0x5f4
/* 806D4714  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806D4718  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 806D471C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D4720  4B 9A 23 8C */	b CrrPos__9dBgS_AcchFR4dBgS
/* 806D4724  3C 60 80 6D */	lis r3, s_obj_sub2__FPvPv@ha
/* 806D4728  38 63 14 E0 */	addi r3, r3, s_obj_sub2__FPvPv@l
/* 806D472C  7F 84 E3 78 */	mr r4, r28
/* 806D4730  4B 94 CC 08 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 806D4744  4B B9 C4 C0 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806D4748  B0 7C 0A 1E */	sth r3, 0xa1e(r28)
/* 806D474C  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806D4750  4B B9 32 3C */	b cM_rndFX__Ff
/* 806D4754  D0 3C 05 2C */	stfs f1, 0x52c(r28)
/* 806D4758  3C 60 80 6D */	lis r3, lit_5255@ha
/* 806D475C  38 83 7D 00 */	addi r4, r3, lit_5255@l
/* 806D4760  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 806D7D00 */
/* 806D4764  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 806D7D04 */
/* 806D4768  90 61 00 44 */	stw r3, 0x44(r1)
/* 806D476C  90 01 00 48 */	stw r0, 0x48(r1)
/* 806D4770  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 806D7D08 */
...
/* 806D47BC  4B C7 2B E0 */	b PSVECSquareDistance
...
/* 806D482C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806D4830  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 806D489C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806D48A0  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 806D48E0  4B C7 2A BC */	b PSVECSquareDistance
...
/* 806D4950  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806D4954  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)
...
/* 806D49C0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806D49C4  C3 A3 0A E0 */	lfs f29, __float_nan@l(r3)
...
/* 806D49D8  4B B9 C2 2C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806D49DC  7C 7D 07 34 */	extsh r29, r3
/* 806D49E0  38 61 00 50 */	addi r3, r1, 0x50
/* 806D49E4  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 806D49E8  4B B9 C2 1C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806D49EC  7C 7B 1B 78 */	mr r27, r3
/* 806D49F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806D49F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806D49F8  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 806D4A60  4B B9 2E F4 */	b cM_rndF__Ff
...
/* 806D4A80  4B B9 2E D4 */	b cM_rndF__Ff
...
/* 806D4B04  4B B9 2E 50 */	b cM_rndF__Ff
...
/* 806D4B24  4B B9 2E 68 */	b cM_rndFX__Ff
...
/* 806D4B68  4B B9 2D EC */	b cM_rndF__Ff
...
/* 806D4B88  4B B9 2E 04 */	b cM_rndFX__Ff
...
/* 806D4BE4  4B B9 B9 5C */	b cLib_addCalcAngleS__FPsssss
...
/* 806D4BFC  4B B9 B9 44 */	b cLib_addCalcAngleS__FPsssss
...
/* 806D4C1C  4B B9 BB 24 */	b cLib_chaseF__FPfff
...
/* 806D4C30  4B B9 BB 10 */	b cLib_chaseF__FPfff
lbl_806D4C34:
/* 806D4C34  A8 1C 0A 5E */	lha r0, 0xa5e(r28)
/* 806D4C38  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 806D4C3C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806D4C40  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 806D4C44  7C 43 04 2E */	lfsx f2, r3, r0
/* 806D4C48  C0 3F 00 A4 */	lfs f1, 0xa4(r31)
/* 806D4C4C  3C 60 80 6D */	lis r3, l_HIO@ha
/* 806D4C50  38 83 7E C4 */	addi r4, r3, l_HIO@l
/* 806D4C54  C0 04 00 10 */	lfs f0, 0x10(r4)	/* effective address: 806D7ED4 */
...
/* 806D4C7C  A8 04 00 24 */	lha r0, 0x24(r4)	/* effective address: 806D7EE8 */
...
/* 806D4D08  4B C8 D5 14 */	b _restgpr_26

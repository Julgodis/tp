...
/* 806D399C  4B C8 E8 40 */	b _savegpr_29
/* 806D39A0  7C 7D 1B 78 */	mr r29, r3
/* 806D39A4  3C 60 80 6D */	lis r3, cNullVec__6Z2Calc@ha
/* 806D39A8  3B C3 7A FC */	addi r30, r3, cNullVec__6Z2Calc@l
/* 806D39AC  3C 60 80 6D */	lis r3, lit_3906@ha
/* 806D39B0  3B E3 79 A0 */	addi r31, r3, lit_3906@l
...
/* 806D39DC  3C 60 80 6D */	lis r3, stringBase0@ha
/* 806D39E0  38 63 7A F0 */	addi r3, r3, stringBase0@l
/* 806D39E4  38 80 00 06 */	li r4, 6
/* 806D39E8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806D39EC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 806D39F0  3C A5 00 02 */	addis r5, r5, 2
/* 806D39F4  38 C0 00 80 */	li r6, 0x80
/* 806D39F8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D39FC  4B 96 88 F0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D3A1C  4B 93 D4 54 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
...
/* 806D3A3C  3C 60 80 6D */	lis r3, stringBase0@ha
/* 806D3A40  38 63 7A F0 */	addi r3, r3, stringBase0@l
/* 806D3A44  38 63 00 05 */	addi r3, r3, 5
/* 806D3A48  38 80 00 0A */	li r4, 0xa
/* 806D3A4C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806D3A50  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 806D3A54  3C A5 00 02 */	addis r5, r5, 2
/* 806D3A58  38 C0 00 80 */	li r6, 0x80
/* 806D3A5C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 806D3A60  4B 96 88 8C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806D3A80  4B 93 D3 F0 */	b setAnm__16mDoExt_McaMorfSOFP15J3DAnmTransformiffff
lbl_806D3A84:
/* 806D3A84  38 00 00 00 */	li r0, 0
/* 806D3A88  90 1D 08 18 */	stw r0, 0x818(r29)
/* 806D3A8C  C0 3F 00 34 */	lfs f1, 0x34(r31)
/* 806D3A90  4B B9 3E FC */	b cM_rndFX__Ff
...
/* 806D3AE0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806D3AE4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
lbl_806D3B1C:
/* 806D3B1C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 806D3B20  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 806D3B48  4B 94 6B 18 */	b fopAcM_posMove__FP10fopAc_ac_cPC4cXyz
/* 806D3B4C  38 7D 05 F4 */	addi r3, r29, 0x5f4
/* 806D3B50  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806D3B54  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 806D3B58  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806D3B5C  4B 9A 2F 50 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 806D3B74  4B B9 C9 CC */	b cLib_addCalcAngleS__FPsssss
...
/* 806D3B98  4B B9 C9 A8 */	b cLib_addCalcAngleS__FPsssss
/* 806D3B9C  80 1D 06 20 */	lwz r0, 0x620(r29)
/* 806D3BA0  54 00 06 B5 */	rlwinm. r0, r0, 0, 0x1a, 0x1a
/* 806D3BA4  41 82 03 08 */	beq lbl_806D3EAC
/* 806D3BA8  3C 60 80 6D */	lis r3, s_obj_sub2__FPvPv@ha
/* 806D3BAC  38 63 14 E0 */	addi r3, r3, s_obj_sub2__FPvPv@l
/* 806D3BB0  7F A4 EB 78 */	mr r4, r29
/* 806D3BB4  4B 94 D7 84 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 806D3BC8  4B B9 D0 3C */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806D3BCC  B0 7D 0A 1E */	sth r3, 0xa1e(r29)
/* 806D3BD0  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806D3BD4  4B B9 3D B8 */	b cM_rndFX__Ff
...
/* 806D3C74  4B B9 C8 CC */	b cLib_addCalcAngleS__FPsssss
...
/* 806D3C8C  4B B9 C8 B4 */	b cLib_addCalcAngleS__FPsssss
/* 806D3C90  3C 60 80 6D */	lis r3, s_obj_sub2__FPvPv@ha
/* 806D3C94  38 63 14 E0 */	addi r3, r3, s_obj_sub2__FPvPv@l
/* 806D3C98  7F A4 EB 78 */	mr r4, r29
/* 806D3C9C  4B 94 D6 9C */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 806D3CB0  4B B9 CF 54 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806D3CB4  B0 7D 0A 1E */	sth r3, 0xa1e(r29)
/* 806D3CB8  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806D3CBC  4B B9 3C D0 */	b cM_rndFX__Ff
...
/* 806D3D28  4B B9 C8 18 */	b cLib_addCalcAngleS__FPsssss
...
/* 806D3D40  4B B9 C8 00 */	b cLib_addCalcAngleS__FPsssss
...
lbl_806D3E54:
/* 806D3E54  3C 60 80 6D */	lis r3, s_obj_sub2__FPvPv@ha
/* 806D3E58  38 63 14 E0 */	addi r3, r3, s_obj_sub2__FPvPv@l
/* 806D3E5C  7F A4 EB 78 */	mr r4, r29
/* 806D3E60  4B 94 D4 D8 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 806D3E74  4B B9 CD 90 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 806D3E78  B0 7D 0A 1E */	sth r3, 0xa1e(r29)
/* 806D3E7C  C0 3F 00 6C */	lfs f1, 0x6c(r31)
/* 806D3E80  4B B9 3B 0C */	b cM_rndFX__Ff
...
/* 806D3EB0  4B C8 E3 78 */	b _restgpr_29

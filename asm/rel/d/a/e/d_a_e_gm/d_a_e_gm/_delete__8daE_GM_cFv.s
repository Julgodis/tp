...
/* 806D6998  3C 60 80 6D */	lis r3, lit_1109@ha
/* 806D699C  3B E3 7E 78 */	addi r31, r3, lit_1109@l
...
/* 806D69B0  3C 80 80 6D */	lis r4, stringBase0@ha
/* 806D69B4  38 84 7A F0 */	addi r4, r4, stringBase0@l
/* 806D69B8  38 84 00 05 */	addi r4, r4, 5
/* 806D69BC  4B 95 66 4C */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 806D69C0  48 00 00 14 */	b lbl_806D69D4
lbl_806D69C4:
/* 806D69C4  38 7E 05 AC */	addi r3, r30, 0x5ac
/* 806D69C8  3C 80 80 6D */	lis r4, stringBase0@ha
/* 806D69CC  38 84 7A F0 */	addi r4, r4, stringBase0@l
/* 806D69D0  4B 95 66 38 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
lbl_806D69D4:
...
lbl_806D69F4:
/* 806D69F4  3C 60 80 6D */	lis r3, data_806D7B34@ha
/* 806D69F8  38 63 7B 34 */	addi r3, r3, data_806D7B34@l
/* 806D69FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 806D7B34 */
...
/* 806D6A20  3C 60 80 6D */	lis r3, data_806D7B34@ha
/* 806D6A24  90 03 7B 34 */	stw r0, data_806D7B34@l(r3)
/* 806D6A28  38 00 00 00 */	li r0, 0
/* 806D6A2C  98 1F 00 A4 */	stb r0, 0xa4(r31)
lbl_806D6A30:
/* 806D6A30  3C 60 80 6D */	lis r3, data_806D7B38@ha
/* 806D6A34  38 63 7B 38 */	addi r3, r3, data_806D7B38@l
/* 806D6A38  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 806D7B38 */
...
/* 806D6A5C  3C 60 80 6D */	lis r3, data_806D7B38@ha
/* 806D6A60  90 03 7B 38 */	stw r0, data_806D7B38@l(r3)
lbl_806D6A64:
...
/* 806D6A88  4B 93 A8 88 */	b stopZelAnime__16mDoExt_McaMorfSOFv
lbl_806D6A8C:

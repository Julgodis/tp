...
/* 8078C490 0000000C  3C 60 80 79 */	lis r3, lit_3767@ha
/* 8078C494 00000010  3B E3 DD A4 */	addi r31, r3, lit_3767@l
...
/* 8078C4A4 00000020  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 8078DDA4 */
...
/* 8078C4C4 00000040  4B AD A6 70 */	b __mi__4cXyzCFRC3Vec
...
/* 8078C4E0 0000005C  4B AD B1 94 */	b cM_atan2s__Fff
/* 8078C4E4 00000060  7C 64 1B 78 */	mr r4, r3
/* 8078C4E8 00000064  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8078C4EC 00000068  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8078C4F0 0000006C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8078C4F4 00000070  4B 87 FE E8 */	b mDoMtx_YrotS__FPA4_fs
/* 8078C4F8 00000074  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 8078DE04 */
/* 8078C4FC 00000078  4B AD B4 90 */	b cM_rndFX__Ff
/* 8078C500 0000007C  D0 21 00 24 */	stfs f1, 0x24(r1)
/* 8078C504 00000080  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 8078DDA8 */
/* 8078C508 00000084  4B AD B4 4C */	b cM_rndF__Ff
/* 8078C50C 00000088  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 8078DDA8 */
/* 8078C510 0000008C  EC 00 08 2A */	fadds f0, f0, f1
/* 8078C514 00000090  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 8078C518 00000094  C0 3F 00 60 */	lfs f1, 0x60(r31)	/* effective address: 8078DE04 */
/* 8078C51C 00000098  4B AD B4 38 */	b cM_rndF__Ff
/* 8078C520 0000009C  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 8078DDC0 */
...
/* 8078C534 000000B0  4B AE 49 B8 */	b MtxPosition__FP4cXyzP4cXyz
/* 8078C538 000000B4  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 8078DDC0 */
/* 8078C53C 000000B8  4B AD B4 18 */	b cM_rndF__Ff
/* 8078C540 000000BC  C0 1F 00 48 */	lfs f0, 0x48(r31)	/* effective address: 8078DDEC */
...
lbl_8078C560:
/* 8078C560 00000000  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 8078DDC0 */
/* 8078C564 00000004  4B AD B3 F0 */	b cM_rndF__Ff
/* 8078C568 00000008  C0 1F 00 48 */	lfs f0, 0x48(r31)	/* effective address: 8078DDEC */
...
lbl_8078C588:
/* 8078C588 00000000  C0 3F 00 B8 */	lfs f1, 0xb8(r31)	/* effective address: 8078DE5C */
/* 8078C58C 00000004  4B AD B4 00 */	b cM_rndFX__Ff
...
/* 8078C5E0 0000000C  4B BB AA B0 */	b PSVECAdd
/* 8078C5E4 00000010  C0 3E 04 FC */	lfs f1, 0x4fc(r30)
/* 8078C5E8 00000014  C0 1F 00 BC */	lfs f0, 0xbc(r31)	/* effective address: 8078DE60 */
/* 8078C5EC 00000018  EC 01 00 28 */	fsubs f0, f1, f0
/* 8078C5F0 0000001C  D0 1E 04 FC */	stfs f0, 0x4fc(r30)
/* 8078C5F4 00000020  C0 3F 00 40 */	lfs f1, 0x40(r31)	/* effective address: 8078DDE4 */
/* 8078C5F8 00000024  3C 60 80 79 */	lis r3, l_HIO@ha
/* 8078C5FC 00000028  38 63 E0 EC */	addi r3, r3, l_HIO@l
/* 8078C600 0000002C  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 8078E0F4 */
...
/* 8078C62C 00000058  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 8078C630 0000005C  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 8078C634 00000060  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8078C638 00000064  4B 8E A4 74 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8078C664 00000004  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 8078DDBC */
...
/* 8078C67C 0000001C  C0 3F 00 90 */	lfs f1, 0x90(r31)	/* effective address: 8078DE34 */
/* 8078C680 00000020  4B AD B2 D4 */	b cM_rndF__Ff
/* 8078C684 00000024  C0 1F 00 44 */	lfs f0, 0x44(r31)	/* effective address: 8078DDE8 */
...
/* 8078C69C 0000003C  C0 3F 00 8C */	lfs f1, 0x8c(r31)	/* effective address: 8078DE30 */
/* 8078C6A0 00000040  4B AD B2 B4 */	b cM_rndF__Ff
/* 8078C6A4 00000044  C0 1F 00 8C */	lfs f0, 0x8c(r31)	/* effective address: 8078DE30 */
...
/* 8078C6D8 00000078  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8078C6DC 0000007C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8078C6E0 00000080  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8078C6E4 00000084  A8 9E 06 88 */	lha r4, 0x688(r30)
/* 8078C6E8 00000088  4B 87 FC F4 */	b mDoMtx_YrotS__FPA4_fs
/* 8078C6EC 0000008C  C0 1F 00 18 */	lfs f0, 0x18(r31)	/* effective address: 8078DDBC */
/* 8078C6F0 00000090  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 8078C6F4 00000094  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 8078C6F8 00000098  C0 1F 00 10 */	lfs f0, 0x10(r31)	/* effective address: 8078DDB4 */
...
/* 8078C708 000000A8  4B AE 47 E4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8078C72C 000000CC  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 8078DDA8 */
...
/* 8078C758 000000F8  4B 88 FA E8 */	b fopAcM_createItem__FPC4cXyziiiPC5csXyzPC4cXyzi
lbl_8078C75C:

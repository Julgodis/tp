...
/* 8078C088 0000000C  3C 60 00 00 */	lis r3, lit_3767@ha
/* 8078C08C 00000010  3B E3 00 00 */	addi r31, r3, lit_3767@l
/* 8078C090 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8078C094 00000018  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_8078C10C:
/* 8078C10C 00000000  3C 60 00 00 */	lis r3, m_cpadInfo__8mDoCPd_c@ha
/* 8078C110 00000004  38 63 00 00 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l
...
/* 8078C188 0000000C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8078C18C 00000010  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 8078C210 0000000C  3C 60 00 00 */	lis r3, stick_pt@ha
/* 8078C214 00000010  38 A3 00 00 */	addi r5, r3, stick_pt@l
/* 8078C218 00000014  80 85 00 00 */	lwz r4, 0(r5)
/* 8078C21C 00000018  3C 60 00 00 */	lis r3, stick_bit@ha
/* 8078C220 0000001C  38 63 00 00 */	addi r3, r3, stick_bit@l
...
/* 8078C250 00000008  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 8078C254 0000000C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8078C258 00000010  80 63 5D B4 */	lwz r3, 0x5db4(r3)
/* 8078C25C 00000014  3C 80 00 00 */	lis r4, stick_d@ha
/* 8078C260 00000018  38 84 00 00 */	addi r4, r4, stick_d@l
...
/* 8078C28C 00000044  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 8078C290 00000048  38 84 00 00 */	addi r4, r4, calc_mtx@l
/* 8078C294 0000004C  80 84 00 00 */	lwz r4, 0(r4)
/* 8078C298 00000050  4B FF DF 01 */	bl PSMTXCopy
/* 8078C29C 00000054  3C 60 00 00 */	lis r3, stick_d@ha
/* 8078C2A0 00000058  38 63 00 00 */	addi r3, r3, stick_d@l
...
/* 8078C3B4 0000016C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 8078C3B8 00000170  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 8078C418 000001D0  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 8078C41C 000001D4  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l

...
/* 804F5F0C 00000004  4B E6 C2 B8 */	b _savegpr_23
/* 804F5F10 00000008  7C 7D 1B 78 */	mr r29, r3
/* 804F5F14 0000000C  7C 9A 23 78 */	mr r26, r4
/* 804F5F18 00000010  7C BB 2B 78 */	mr r27, r5
/* 804F5F1C 00000014  3C 60 80 50 */	lis r3, lit_3777@ha
/* 804F5F20 00000018  3B C3 A6 BC */	addi r30, r3, lit_3777@l
/* 804F5F24 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804F5F28 00000020  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 804F5F2C 00000024  83 9F 5D AC */	lwz r28, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 804F5F48 00000040  4B D7 0B EC */	b __mi__4cXyzCFRC3Vec
...
/* 804F5F68 00000060  4B E5 11 D0 */	b PSVECSquareMag
/* 804F5F6C 00000064  C0 1E 00 3C */	lfs f0, 0x3c(r30)	/* effective address: 804FA6F8 */
...
/* 804F5F7C 00000008  C8 9E 00 70 */	lfd f4, 0x70(r30)	/* effective address: 804FA72C */
/* 804F5F80 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 804F5F84 00000010  C8 7E 00 78 */	lfd f3, 0x78(r30)	/* effective address: 804FA734 */
...
lbl_804F5FCC:
/* 804F5FCC 00000000  C8 1E 00 80 */	lfd f0, 0x80(r30)	/* effective address: 804FA73C */
/* 804F5FD0 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 804F5FD4 00000000  40 80 00 10 */	bge lbl_804F5FE4
/* 804F5FD8 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804F5FDC 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 804F6048 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 804F604C 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_804F6050:
...
/* 804F6068 00000018  CB FE 00 A0 */	lfd f31, 0xa0(r30)	/* effective address: 804FA75C */
...
/* 804F60B4 00000040  4B D7 0A D0 */	b __ml__4cXyzCFf
...
/* 804F60C4 00000050  4B E5 0F CC */	b PSVECAdd
...
/* 804F6128 00000058  4B D7 0A 0C */	b __mi__4cXyzCFRC3Vec
...
/* 804F6144 00000074  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 804F6158 00000088  C0 1E 00 60 */	lfs f0, 0x60(r30)	/* effective address: 804FA71C */
/* 804F615C 0000008C  FC 03 00 40 */	fcmpo cr0, f3, f0
/* 804F6160 00000000  40 81 01 90 */	ble lbl_804F62F0
/* 804F6164 00000004  4B D7 15 10 */	b cM_atan2s__Fff
/* 804F6168 00000008  7C 64 1B 78 */	mr r4, r3
/* 804F616C 0000000C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804F6170 00000010  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804F6174 00000014  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804F6178 00000018  4B B1 62 64 */	b mDoMtx_YrotS__FPA4_fs
/* 804F617C 0000001C  C0 1E 00 3C */	lfs f0, 0x3c(r30)	/* effective address: 804FA6F8 */
/* 804F6180 00000020  D0 01 00 58 */	stfs f0, 0x58(r1)
/* 804F6184 00000024  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 804F6188 00000028  C0 5E 01 64 */	lfs f2, 0x164(r30)	/* effective address: 804FA820 */
/* 804F618C 0000002C  C0 3A 61 74 */	lfs f1, 0x6174(r26)
/* 804F6190 00000030  C0 1E 00 60 */	lfs f0, 0x60(r30)	/* effective address: 804FA71C */
...
/* 804F61A8 00000048  4B D7 AD 44 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 804F61B8 00000058  4B E5 0E FC */	b PSVECSubtract
/* 804F61BC 0000005C  48 00 01 34 */	b lbl_804F62F0
lbl_804F61C0:
/* 804F61C0 00000000  C0 7A 61 74 */	lfs f3, 0x6174(r26)
/* 804F61C4 00000004  C0 1E 00 BC */	lfs f0, 0xbc(r30)	/* effective address: 804FA778 */
...
/* 804F61E8 0000001C  C0 1E 00 C4 */	lfs f0, 0xc4(r30)	/* effective address: 804FA780 */
/* 804F61EC 00000020  EF FF 00 32 */	fmuls f31, f31, f0
/* 804F61F0 00000024  4B D7 14 84 */	b cM_atan2s__Fff
...
/* 804F6224 0000000C  C0 1E 00 3C */	lfs f0, 0x3c(r30)	/* effective address: 804FA6F8 */
...
/* 804F6244 00000014  C3 FE 00 E8 */	lfs f31, 0xe8(r30)	/* effective address: 804FA7A4 */
/* 804F6248 00000018  48 00 00 08 */	b lbl_804F6250
lbl_804F624C:
/* 804F624C 00000000  C3 FE 00 BC */	lfs f31, 0xbc(r30)	/* effective address: 804FA778 */
lbl_804F6250:
...
/* 804F6280 00000028  4B D7 08 B4 */	b __mi__4cXyzCFRC3Vec
...
/* 804F629C 00000044  4B D7 13 D8 */	b cM_atan2s__Fff
/* 804F62A0 00000048  7C 64 1B 78 */	mr r4, r3
/* 804F62A4 0000004C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 804F62A8 00000050  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 804F62AC 00000054  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 804F62B0 00000058  4B B1 61 2C */	b mDoMtx_YrotS__FPA4_fs
/* 804F62B4 0000005C  C0 1E 00 3C */	lfs f0, 0x3c(r30)	/* effective address: 804FA6F8 */
/* 804F62B8 00000060  D0 01 00 58 */	stfs f0, 0x58(r1)
/* 804F62BC 00000064  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 804F62C0 00000068  C0 3E 01 64 */	lfs f1, 0x164(r30)	/* effective address: 804FA820 */
...
/* 804F62DC 00000084  4B D7 AC 10 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 804F62EC 00000094  4B E5 0D C8 */	b PSVECSubtract
lbl_804F62F0:
...
/* 804F6340 00000010  C0 1E 00 3C */	lfs f0, 0x3c(r30)	/* effective address: 804FA6F8 */
...
/* 804F635C 00000014  4B C6 91 94 */	b setLookPos__9daPy_py_cFP4cXyz
lbl_804F6360:
...
/* 804F6388 00000028  4B C6 90 F0 */	b setFmChainPos__9daPy_py_cFP10fopAc_ac_cP4cXyzi
...
/* 804F63A4 00000044  4B C6 91 7C */	b setPlayerSe__9daPy_py_cFUl
/* 804F63A8 00000048  C0 3E 00 3C */	lfs f1, 0x3c(r30)	/* effective address: 804FA6F8 */
/* 804F63AC 0000004C  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 804F63B0 00000050  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 804FA6BC */
/* 804F63B4 00000054  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 804F63B8 00000058  D0 21 00 14 */	stfs f1, 0x14(r1)
/* 804F63BC 0000005C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804F63C0 00000060  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 804F63D4 00000074  4B B7 96 50 */	b StartShock__12dVibration_cFii4cXyz
...
/* 804F6404 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 804F6408 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 804F640C 00000010  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 804F6410 00000014  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 804F6414 00000018  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 804F6418 0000001C  A0 84 05 3A */	lhz r4, 0x53a(r4)	/* effective address: 803A77C2 */
/* 804F641C 00000020  4B B3 E5 70 */	b onEventBit__11dSv_event_cFUs
...
/* 804F6454 00000030  4B C6 90 24 */	b setFmChainPos__9daPy_py_cFP10fopAc_ac_cP4cXyzi
...
/* 804F6494 00000008  4B E6 BD 7C */	b _restgpr_23

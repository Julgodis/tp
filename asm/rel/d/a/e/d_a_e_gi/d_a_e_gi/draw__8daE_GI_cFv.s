...
/* 806CD5F0  4B C9 4B E4 */	b _savegpr_27
/* 806CD5F4  7C 7F 1B 78 */	mr r31, r3
/* 806CD5F8  3C 60 80 6D */	lis r3, lit_3907@ha
/* 806CD5FC  3B C3 0E 60 */	addi r30, r3, lit_3907@l
/* 806CD600  80 7F 05 B4 */	lwz r3, 0x5b4(r31)
/* 806CD604  83 A3 00 04 */	lwz r29, 4(r3)
/* 806CD608  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806CD60C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806CD610  38 80 00 00 */	li r4, 0
/* 806CD614  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 806CD618  38 DF 01 0C */	addi r6, r31, 0x10c
/* 806CD61C  4B AD 61 A8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 806CD620  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806CD624  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 806CD628  80 9D 00 04 */	lwz r4, 4(r29)
/* 806CD62C  38 BF 01 0C */	addi r5, r31, 0x10c
/* 806CD630  4B AD 77 70 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 806CD794  4B 94 3A 2C */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 806CD7E4  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 806CD7E8  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 806CD7EC  4B 96 11 24 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 806CD7F0  90 7F 06 78 */	stw r3, 0x678(r31)
/* 806CD7F4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 806CD7F8  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 806CD828  4B 98 86 F4 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
/* 806CD82C  38 60 00 01 */	li r3, 1
/* 806CD830  39 61 00 60 */	addi r11, r1, 0x60
/* 806CD834  4B C9 49 EC */	b _restgpr_27

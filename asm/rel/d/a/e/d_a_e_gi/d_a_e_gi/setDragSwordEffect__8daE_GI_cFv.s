...
/* 806CDFC8 00000018  3C 60 80 6D */	lis r3, lit_3907@ha
/* 806CDFCC 0000001C  3B C3 0E 60 */	addi r30, r3, lit_3907@l
/* 806CDFD0 00000020  3C 60 80 6D */	lis r3, l_HIO@ha
/* 806CDFD4 00000024  38 63 11 38 */	addi r3, r3, l_HIO@l
/* 806CDFD8 00000028  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 806D1140 */
...
/* 806CDFF0 00000040  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806CDFF4 00000044  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806CDFF8 00000048  4B C7 84 B8 */	b PSMTXCopy
/* 806CDFFC 0000004C  C0 3E 00 78 */	lfs f1, 0x78(r30)	/* effective address: 806D0ED8 */
/* 806CE000 00000050  C0 5E 00 7C */	lfs f2, 0x7c(r30)	/* effective address: 806D0EDC */
/* 806CE004 00000054  C0 7E 00 04 */	lfs f3, 4(r30)	/* effective address: 806D0E64 */
/* 806CE008 00000058  4B 93 ED 94 */	b transM__14mDoMtx_stack_cFfff
/* 806CE00C 0000005C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806CE010 00000060  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806CE014 00000064  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 806CE018 00000068  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 806CE01C 0000006C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 806CE020 00000070  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 806CE024 00000074  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 806CE028 00000078  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 806CE02C 0000007C  38 61 00 30 */	addi r3, r1, 0x30
/* 806CE030 00000080  4B 9A 95 4C */	b __ct__11dBgS_GndChkFv
/* 806CE034 00000084  38 61 00 30 */	addi r3, r1, 0x30
/* 806CE038 00000088  38 81 00 18 */	addi r4, r1, 0x18
/* 806CE03C 0000008C  4B B9 9C EC */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 806CE040 00000090  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806CE044 00000094  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806CE048 00000098  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806CE04C 0000009C  38 81 00 30 */	addi r4, r1, 0x30
/* 806CE050 000000A0  4B 9A 64 50 */	b GroundCross__4cBgSFP11cBgS_GndChk
/* 806CE054 000000A4  C0 1E 00 80 */	lfs f0, 0x80(r30)	/* effective address: 806D0EE0 */
...
/* 806CE07C 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806CE080 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 806CE084 00000020  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 806CE0A8 00000044  4B 97 F5 FC */	b setPoly__13dPa_control_cFUlUsR13cBgS_PolyInfoPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyziP18dPa_levelEcallBackScPC4cXyz
...
/* 806CE0B8 00000054  4B 9A 95 38 */	b __dt__11dBgS_GndChkFv

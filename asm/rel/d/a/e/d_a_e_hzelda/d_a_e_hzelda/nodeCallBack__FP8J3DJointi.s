...
/* 806F0E2C  4B C7 13 AC */	b _savegpr_28
/* 806F0E30  2C 04 00 00 */	cmpwi r4, 0
/* 806F0E34  40 82 01 B4 */	bne lbl_806F0FE8
/* 806F0E38  A3 83 00 14 */	lhz r28, 0x14(r3)
/* 806F0E3C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 806F0E40  38 63 4A C8 */	addi r3, r3, j3dSys@l
/* 806F0E44  83 E3 00 38 */	lwz r31, 0x38(r3)	/* effective address: 80434B00 */
...
/* 806F0E64  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806F0E68  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806F0E6C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806F0E70  4B C5 56 40 */	b PSMTXCopy
/* 806F0E74  2C 1C 00 03 */	cmpwi r28, 3
/* 806F0E78  40 82 00 4C */	bne lbl_806F0EC4
/* 806F0E7C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0E80  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0E84  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0E98  4B 91 B5 04 */	b mDoMtx_XrotM__FPA4_fs
/* 806F0E9C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0EA0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0EA4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0EBC  4B 91 B6 10 */	b mDoMtx_ZrotM__FPA4_fs
/* 806F0EC0  48 00 00 F4 */	b lbl_806F0FB4
lbl_806F0EC4:
/* 806F0EC4  2C 1C 00 04 */	cmpwi r28, 4
/* 806F0EC8  40 82 00 48 */	bne lbl_806F0F10
/* 806F0ECC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0ED0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0ED4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0EE8  4B 91 B4 B4 */	b mDoMtx_XrotM__FPA4_fs
/* 806F0EEC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0EF0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0EF4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0F08  4B 91 B5 C4 */	b mDoMtx_ZrotM__FPA4_fs
/* 806F0F0C  48 00 00 A8 */	b lbl_806F0FB4
lbl_806F0F10:
/* 806F0F10  2C 1C 00 13 */	cmpwi r28, 0x13
/* 806F0F14  40 82 00 28 */	bne lbl_806F0F3C
/* 806F0F18  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0F1C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0F20  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0F34  4B 91 B5 00 */	b mDoMtx_YrotM__FPA4_fs
/* 806F0F38  48 00 00 7C */	b lbl_806F0FB4
lbl_806F0F3C:
/* 806F0F3C  2C 1C 00 1A */	cmpwi r28, 0x1a
/* 806F0F40  40 82 00 2C */	bne lbl_806F0F6C
/* 806F0F44  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0F48  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0F4C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0F64  4B 91 B4 D0 */	b mDoMtx_YrotM__FPA4_fs
/* 806F0F68  48 00 00 4C */	b lbl_806F0FB4
lbl_806F0F6C:
/* 806F0F6C  2C 1C 00 20 */	cmpwi r28, 0x20
/* 806F0F70  40 82 00 44 */	bne lbl_806F0FB4
/* 806F0F74  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0F78  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0F7C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0F90  4B 91 B4 A4 */	b mDoMtx_YrotM__FPA4_fs
/* 806F0F94  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0F98  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0F9C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 806F0FB0  4B 91 B5 1C */	b mDoMtx_ZrotM__FPA4_fs
lbl_806F0FB4:
/* 806F0FB4  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0FB8  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0FBC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806F0FC0  80 9F 00 84 */	lwz r4, 0x84(r31)
/* 806F0FC4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 806F0FC8  7C 80 F2 14 */	add r4, r0, r30
/* 806F0FCC  4B C5 54 E4 */	b PSMTXCopy
/* 806F0FD0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806F0FD4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806F0FD8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806F0FDC  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 806F0FE0  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 806F0FE4  4B C5 54 CC */	b PSMTXCopy
lbl_806F0FE8:
/* 806F0FE8  38 60 00 01 */	li r3, 1
/* 806F0FEC  39 61 00 30 */	addi r11, r1, 0x30
/* 806F0FF0  4B C7 12 34 */	b _restgpr_28

...
/* 807FD788  4B B6 4A 54 */	b _savegpr_29
...
/* 807FD7A4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 807FD7A8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 807FD7AC  38 81 00 08 */	addi r4, r1, 8
/* 807FD7B0  4B 81 C0 48 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 807FD7B4  7C 7F 1B 79 */	or. r31, r3, r3
/* 807FD7B8  41 82 00 5C */	beq lbl_807FD814
/* 807FD7BC  3C 60 80 80 */	lis r3, stringBase0@ha
/* 807FD7C0  38 63 43 DC */	addi r3, r3, stringBase0@l
/* 807FD7C4  7F A4 EB 78 */	mr r4, r29
/* 807FD7C8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 807FD7CC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 807FD7D0  3C A5 00 02 */	addis r5, r5, 2
/* 807FD7D4  38 C0 00 80 */	li r6, 0x80
/* 807FD7D8  38 A5 C2 F8 */	addi r5, r5, -15624
/* 807FD7DC  4B 83 EB 10 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 807FD7F4  3C C0 80 80 */	lis r6, lit_3903@ha
/* 807FD7F8  C0 66 42 80 */	lfs f3, lit_3903@l(r6)
/* 807FD7FC  3C C0 80 80 */	lis r6, lit_3986@ha
/* 807FD800  C0 86 42 B4 */	lfs f4, lit_3986@l(r6)
/* 807FD804  38 C0 00 00 */	li r6, 0
/* 807FD808  4B 81 2B 74 */	b setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv
...
/* 807FD82C  4B B6 49 FC */	b _restgpr_29

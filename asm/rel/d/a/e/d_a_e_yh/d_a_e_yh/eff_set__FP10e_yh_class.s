...
/* 8080286C 00000010  4B B5 F9 58 */	b _savegpr_23
/* 80802870 00000014  7C 79 1B 78 */	mr r25, r3
/* 80802874 00000018  3C 60 80 80 */	lis r3, lit_3902@ha
/* 80802878 0000001C  3B 83 42 7C */	addi r28, r3, lit_3902@l
...
/* 808028B8 0000000C  C0 3C 00 04 */	lfs f1, 4(r28)	/* effective address: 80804280 */
/* 808028BC 00000010  48 00 00 08 */	b lbl_808028C4
lbl_808028C0:
/* 808028C0 00000000  C0 3C 00 08 */	lfs f1, 8(r28)	/* effective address: 80804284 */
lbl_808028C4:
/* 808028C4 00000000  C0 5C 00 08 */	lfs f2, 8(r28)	/* effective address: 80804284 */
...
lbl_808028EC:
/* 808028EC 00000000  C0 3C 00 04 */	lfs f1, 4(r28)	/* effective address: 80804280 */
/* 808028F0 00000004  D0 39 12 58 */	stfs f1, 0x1258(r25)
lbl_808028F4:
/* 808028F4 00000000  38 79 12 58 */	addi r3, r25, 0x1258
/* 808028F8 00000004  C0 5C 00 08 */	lfs f2, 8(r28)	/* effective address: 80804284 */
/* 808028FC 00000008  C0 7C 00 7C */	lfs f3, 0x7c(r28)	/* effective address: 808042F8 */
/* 80802900 0000000C  4B A6 D1 3C */	b cLib_addCalc2__FPffff
/* 80802904 00000010  3B 40 00 00 */	li r26, 0
/* 80802908 00000014  3B 00 00 00 */	li r24, 0
/* 8080290C 00000018  3A E0 00 00 */	li r23, 0
/* 80802910 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80802914 00000020  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l
/* 80802918 00000024  3C 60 80 80 */	lis r3, data_80804560@ha
/* 8080291C 00000028  3B C3 45 60 */	addi r30, r3, data_80804560@l
lbl_80802920:
/* 80802920 00000000  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80802968 00000048  C0 3C 00 08 */	lfs f1, 8(r28)	/* effective address: 80804284 */
/* 8080296C 0000004C  4B 84 AB 60 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80802970 00000050  7C 79 F9 2E */	stwx r3, r25, r31
/* 80802974 00000054  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
/* 80802978 00000058  38 63 02 10 */	addi r3, r3, 0x210
/* 8080297C 0000005C  7C 99 F8 2E */	lwzx r4, r25, r31
/* 80802980 00000060  4B 84 8F 98 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80802994 00000074  3C 60 80 80 */	lis r3, data_80804568@ha
/* 80802998 00000078  38 63 45 68 */	addi r3, r3, data_80804568@l
...
/* 808029A8 00000088  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 808029AC 0000008C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 808029B0 00000090  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 808029B4 00000094  4B B4 3A FC */	b PSMTXCopy
...
/* 808029C8 000000A8  4B A6 E4 DC */	b MtxScale__FfffUc
/* 808029CC 000000AC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 808029D0 000000B0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 808029D4 000000B4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 808029E4 000000C4  4B A7 DE 24 */	b func_80280808
...
/* 80802A3C 00000044  C0 1C 00 00 */	lfs f0, 0(r28)	/* effective address: 8080427C */
...
/* 80802A4C 00000054  4B 81 B2 70 */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80802A50 00000058  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80802A54 0000005C  41 82 00 10 */	beq lbl_80802A64
/* 80802A58 00000060  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80802A5C 00000064  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
/* 80802A60 00000068  D0 01 00 24 */	stfs f0, 0x24(r1)
lbl_80802A64:
/* 80802A64 00000000  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80802AAC 00000048  C0 3C 00 08 */	lfs f1, 8(r28)	/* effective address: 80804284 */
/* 80802AB0 0000004C  4B 84 AA 1C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 80802AC4 00000008  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80802B0C 00000050  C0 3C 00 08 */	lfs f1, 8(r28)	/* effective address: 80804284 */
/* 80802B10 00000054  4B 84 A9 BC */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80802B14 00000058  90 79 12 4C */	stw r3, 0x124c(r25)
/* 80802B18 0000005C  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
/* 80802B1C 00000060  38 63 02 10 */	addi r3, r3, 0x210
/* 80802B20 00000064  80 99 12 4C */	lwz r4, 0x124c(r25)
/* 80802B24 00000068  4B 84 8D F4 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80802B3C 00000080  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80802B40 00000084  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80802B44 00000088  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80802B48 0000008C  4B B4 39 68 */	b PSMTXCopy
/* 80802B4C 00000090  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80802B50 00000094  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80802B54 00000098  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80802B58 0000009C  38 97 00 68 */	addi r4, r23, 0x68
/* 80802B5C 000000A0  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 80802B60 000000A4  4B A7 DC 80 */	b func_802807E0
...
/* 80802B70 00000008  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
...
/* 80802BB8 00000050  C0 3C 00 08 */	lfs f1, 8(r28)	/* effective address: 80804284 */
/* 80802BBC 00000054  4B 84 A9 10 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 80802BC0 00000058  90 79 12 54 */	stw r3, 0x1254(r25)
/* 80802BC4 0000005C  80 7D 5D 3C */	lwz r3, 0x5d3c(r29)	/* effective address: 8040BEFC */
/* 80802BC8 00000060  38 63 02 10 */	addi r3, r3, 0x210
/* 80802BCC 00000064  80 99 12 54 */	lwz r4, 0x1254(r25)
/* 80802BD0 00000068  4B 84 8D 48 */	b getEmitter__Q213dPa_control_c7level_cFUl
...
/* 80802BE8 00000080  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80802BEC 00000084  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80802BF0 00000088  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80802BF4 0000008C  4B B4 38 BC */	b PSMTXCopy
/* 80802BF8 00000090  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80802BFC 00000094  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80802C00 00000098  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80802C04 0000009C  38 97 00 68 */	addi r4, r23, 0x68
/* 80802C08 000000A0  38 B7 00 A4 */	addi r5, r23, 0xa4
/* 80802C0C 000000A4  4B A7 DB D4 */	b func_802807E0
lbl_80802C10:
...
/* 80802C1C 00000004  4B B5 F5 F4 */	b _restgpr_23

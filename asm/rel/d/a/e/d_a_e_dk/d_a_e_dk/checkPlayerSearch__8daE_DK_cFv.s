...
/* 806AA8C0  4B CB 79 1C */	b _savegpr_29
/* 806AA8C4  7C 7F 1B 78 */	mr r31, r3
/* 806AA8C8  3C 60 80 6B */	lis r3, lit_3764@ha
/* 806AA8CC  3B A3 D5 38 */	addi r29, r3, lit_3764@l
/* 806AA8D0  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 806AA8D4  38 9F 04 A8 */	addi r4, r31, 0x4a8
/* 806AA8D8  4B C9 CA C4 */	b PSVECSquareDistance
...
/* 806AA948  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806AA94C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806AA9B8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806AA9BC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806AA9C0:
...
/* 806AAA58  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806AAA5C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806AAAC8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806AAACC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806AAAD0:
...
/* 806AAAF4  4B 97 23 08 */	b fopAcM_otherBgCheck__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806AAAF8  7C 60 00 34 */	cntlzw r0, r3
/* 806AAAFC  54 03 D9 7E */	srwi r3, r0, 5
lbl_806AAB00:
/* 806AAB00  39 61 00 20 */	addi r11, r1, 0x20
/* 806AAB04  4B CB 77 24 */	b _restgpr_29

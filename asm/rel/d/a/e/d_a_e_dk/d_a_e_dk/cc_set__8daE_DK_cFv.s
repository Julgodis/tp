...
/* 806AC764  4B CB 5A 74 */	b _savegpr_28
/* 806AC768  7C 7D 1B 78 */	mr r29, r3
/* 806AC76C  3C 60 80 6B */	lis r3, lit_3764@ha
/* 806AC770  3B C3 D5 38 */	addi r30, r3, lit_3764@l
...
/* 806AC788  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806AC78C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806AC790  4B C9 9D 20 */	b PSMTXCopy
/* 806AC794  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806AC798  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 806AC79C  7F E3 FB 78 */	mr r3, r31
/* 806AC7A0  C0 3F 00 0C */	lfs f1, 0xc(r31)	/* effective address: 803DD47C */
/* 806AC7A4  C0 5F 00 1C */	lfs f2, 0x1c(r31)	/* effective address: 803DD48C */
/* 806AC7A8  C0 7F 00 2C */	lfs f3, 0x2c(r31)	/* effective address: 803DD49C */
/* 806AC7AC  4B C9 A1 3C */	b PSMTXTrans
...
/* 806AC81C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806AC820  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806AC824  4B C9 9C 8C */	b PSMTXCopy
/* 806AC828  C0 3E 00 20 */	lfs f1, 0x20(r30)
/* 806AC82C  C0 5E 00 D0 */	lfs f2, 0xd0(r30)
/* 806AC830  FC 60 08 90 */	fmr f3, f1
/* 806AC834  4B 96 05 68 */	b transM__14mDoMtx_stack_cFfff
...
/* 806AC858  4B BC 2D F0 */	b SetC__8cM3dGSphFRC4cXyz
/* 806AC85C  38 7D 0A 88 */	addi r3, r29, 0xa88
/* 806AC860  C0 3E 00 C0 */	lfs f1, 0xc0(r30)
/* 806AC864  4B BC 2E A4 */	b SetR__8cM3dGSphFf
/* 806AC868  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806AC86C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806AC870  3B 83 23 3C */	addi r28, r3, 0x233c
/* 806AC874  7F 83 E3 78 */	mr r3, r28
/* 806AC878  38 9D 09 64 */	addi r4, r29, 0x964
/* 806AC87C  4B BB 83 2C */	b Set__4cCcSFP8cCcD_Obj
...
/* 806AC890  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806AC894  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806AC898  4B C9 9C 18 */	b PSMTXCopy
/* 806AC89C  C0 3E 00 20 */	lfs f1, 0x20(r30)
/* 806AC8A0  C0 5E 00 D4 */	lfs f2, 0xd4(r30)
/* 806AC8A4  FC 60 08 90 */	fmr f3, f1
/* 806AC8A8  4B 96 04 F4 */	b transM__14mDoMtx_stack_cFfff
...
/* 806AC8F8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806AC8FC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806AC900  4B C9 9B B0 */	b PSMTXCopy
/* 806AC904  C0 3E 00 20 */	lfs f1, 0x20(r30)
/* 806AC908  C0 5E 00 A0 */	lfs f2, 0xa0(r30)
/* 806AC90C  FC 60 08 90 */	fmr f3, f1
/* 806AC910  4B 96 04 8C */	b transM__14mDoMtx_stack_cFfff

...
/* 806ACAB4  4B CB 57 0C */	b _savegpr_22
/* 806ACAB8  7C 7E 1B 78 */	mr r30, r3
/* 806ACABC  3C 60 80 6B */	lis r3, lit_3764@ha
/* 806ACAC0  3B A3 D5 38 */	addi r29, r3, lit_3764@l
/* 806ACAC4  3C 60 80 6B */	lis r3, stringBase0@ha
/* 806ACAC8  38 63 D6 28 */	addi r3, r3, stringBase0@l
/* 806ACACC  38 80 00 12 */	li r4, 0x12
/* 806ACAD0  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 806ACAD4  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 806ACAE8  4B 98 F8 04 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806ACAEC  7C 77 1B 78 */	mr r23, r3
/* 806ACAF0  38 60 00 58 */	li r3, 0x58
/* 806ACAF4  4B C2 21 58 */	b __nw__FUl
/* 806ACAF8  7C 76 1B 79 */	or. r22, r3, r3
/* 806ACAFC  41 82 00 64 */	beq lbl_806ACB60
/* 806ACB00  3C 60 80 6B */	lis r3, stringBase0@ha
/* 806ACB04  38 63 D6 28 */	addi r3, r3, stringBase0@l
/* 806ACB08  38 80 00 0F */	li r4, 0xf
/* 806ACB0C  7F E5 FB 78 */	mr r5, r31
/* 806ACB10  38 C0 00 80 */	li r6, 0x80
/* 806ACB14  4B 98 F7 D8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806ACB58  4B 96 3C 78 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806ACB8C  3C 60 80 6B */	lis r3, stringBase0@ha
/* 806ACB90  3B 63 D6 28 */	addi r27, r3, stringBase0@l
/* 806ACB94  3B 9D 00 0C */	addi r28, r29, 0xc
/* 806ACB98  3A FD 00 14 */	addi r23, r29, 0x14
lbl_806ACB9C:
/* 806ACB9C  38 60 00 18 */	li r3, 0x18
/* 806ACBA0  4B C2 20 AC */	b __nw__FUl
/* 806ACBA4  7C 76 1B 79 */	or. r22, r3, r3
/* 806ACBA8  41 82 00 20 */	beq lbl_806ACBC8
/* 806ACBAC  3C 80 80 6B */	lis r4, __vt__12J3DFrameCtrl@ha
/* 806ACBB0  38 04 D7 D4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 806ACBB4  90 16 00 00 */	stw r0, 0(r22)
/* 806ACBB8  38 80 00 00 */	li r4, 0
/* 806ACBBC  4B C7 B8 40 */	b init__12J3DFrameCtrlFs
...
/* 806ACBF4  4B 98 F6 F8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806ACC24  4B 96 0A E8 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
...
/* 806ACC3C  4B C2 20 10 */	b __nw__FUl
/* 806ACC40  7C 76 1B 79 */	or. r22, r3, r3
/* 806ACC44  41 82 00 20 */	beq lbl_806ACC64
/* 806ACC48  3C 80 80 6B */	lis r4, __vt__12J3DFrameCtrl@ha
/* 806ACC4C  38 04 D7 D4 */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 806ACC50  90 16 00 00 */	stw r0, 0(r22)
/* 806ACC54  38 80 00 00 */	li r4, 0
/* 806ACC58  4B C7 B7 A4 */	b init__12J3DFrameCtrlFs
...
/* 806ACC8C  4B 98 F6 60 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806ACCBC  4B 96 09 80 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
...
/* 806ACCE0  3C 60 80 6B */	lis r3, stringBase0@ha
/* 806ACCE4  38 63 D6 28 */	addi r3, r3, stringBase0@l
/* 806ACCE8  38 80 00 13 */	li r4, 0x13
/* 806ACCEC  7F E5 FB 78 */	mr r5, r31
/* 806ACCF0  38 C0 00 80 */	li r6, 0x80
/* 806ACCF4  4B 98 F5 F8 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 806ACCF8  7C 77 1B 78 */	mr r23, r3
/* 806ACCFC  38 60 00 58 */	li r3, 0x58
/* 806ACD00  4B C2 1F 4C */	b __nw__FUl
/* 806ACD04  7C 76 1B 79 */	or. r22, r3, r3
/* 806ACD08  41 82 00 64 */	beq lbl_806ACD6C
/* 806ACD0C  3C 60 80 6B */	lis r3, stringBase0@ha
/* 806ACD10  38 63 D6 28 */	addi r3, r3, stringBase0@l
/* 806ACD14  38 80 00 0C */	li r4, 0xc
/* 806ACD18  7F E5 FB 78 */	mr r5, r31
/* 806ACD1C  38 C0 00 80 */	li r6, 0x80
/* 806ACD20  4B 98 F5 CC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 806ACD64  4B 96 3A 6C */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 806ACD98  4B CB 54 74 */	b _restgpr_22

...
/* 806AC5CC  4B CB 5C 0C */	b _savegpr_28
/* 806AC5D0  7C 7E 1B 78 */	mr r30, r3
/* 806AC5D4  3C 60 80 6B */	lis r3, lit_3764@ha
/* 806AC5D8  3B E3 D5 38 */	addi r31, r3, lit_3764@l
/* 806AC5DC  88 1E 06 A2 */	lbz r0, 0x6a2(r30)
/* 806AC5E0  28 00 00 00 */	cmplwi r0, 0
/* 806AC5E4  40 82 00 30 */	bne lbl_806AC614
/* 806AC5E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806AC5EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 806AC604  4B C9 A2 E4 */	b PSMTXTrans
/* 806AC608  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 806AC60C  4B 96 09 38 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806AC610  48 00 00 24 */	b lbl_806AC634
lbl_806AC614:
/* 806AC614  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806AC618  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 806AC630  4B C9 A2 B8 */	b PSMTXTrans
lbl_806AC634:
/* 806AC634  3C 60 80 6B */	lis r3, l_HIO@ha
/* 806AC638  3B A3 D8 08 */	addi r29, r3, l_HIO@l
/* 806AC63C  C0 3D 00 08 */	lfs f1, 8(r29)	/* effective address: 806AD810 */
/* 806AC640  FC 40 08 90 */	fmr f2, f1
/* 806AC644  FC 60 08 90 */	fmr f3, f1
/* 806AC648  4B 96 07 F0 */	b scaleM__14mDoMtx_stack_cFfff
/* 806AC64C  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806AC650  83 83 00 04 */	lwz r28, 4(r3)
/* 806AC654  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806AC658  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806AC65C  38 9C 00 24 */	addi r4, r28, 0x24
/* 806AC660  4B C9 9E 50 */	b PSMTXCopy
/* 806AC664  80 7E 05 B4 */	lwz r3, 0x5b4(r30)
/* 806AC668  4B 96 4B 84 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 806AC684  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806AC688  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806AC68C  4B C9 9E 24 */	b PSMTXCopy
/* 806AC690  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806AC694  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806AC698  C0 23 00 0C */	lfs f1, 0xc(r3)	/* effective address: 803DD47C */
/* 806AC69C  C0 43 00 1C */	lfs f2, 0x1c(r3)	/* effective address: 803DD48C */
/* 806AC6A0  C0 63 00 2C */	lfs f3, 0x2c(r3)	/* effective address: 803DD49C */
/* 806AC6A4  4B C9 A2 44 */	b PSMTXTrans
/* 806AC6A8  38 7E 04 E4 */	addi r3, r30, 0x4e4
/* 806AC6AC  4B 96 08 98 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 806AC6B0  C0 3F 00 20 */	lfs f1, 0x20(r31)
/* 806AC6B4  C0 5F 00 C8 */	lfs f2, 0xc8(r31)
/* 806AC6B8  FC 60 08 90 */	fmr f3, f1
/* 806AC6BC  4B 96 06 E0 */	b transM__14mDoMtx_stack_cFfff
/* 806AC6C0  48 00 00 4C */	b lbl_806AC70C
lbl_806AC6C4:
/* 806AC6C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806AC6C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l

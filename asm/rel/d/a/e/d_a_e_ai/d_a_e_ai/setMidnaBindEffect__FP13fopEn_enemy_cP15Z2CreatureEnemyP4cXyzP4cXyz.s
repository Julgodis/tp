...
/* 8067BFE4  4B CE 61 D0 */	b _savegpr_19
/* 8067BFE8  7C 7E 1B 78 */	mr r30, r3
/* 8067BFEC  7C 9A 23 78 */	mr r26, r4
/* 8067BFF0  7C BB 2B 78 */	mr r27, r5
/* 8067BFF4  7C DC 33 78 */	mr r28, r6
/* 8067BFF8  3C 60 80 68 */	lis r3, cNullVec__6Z2Calc@ha
/* 8067BFFC  3A E3 C5 40 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 8067C000  3C 60 80 68 */	lis r3, lit_3789@ha
/* 8067C004  3B E3 C3 FC */	addi r31, r3, lit_3789@l
/* 8067C008  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8067C00C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8067C010  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8067C014  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 8067C018  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 8067C040  4B B3 05 3C */	b dKy_darkworld_check__Fv
...
/* 8067C064  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 8067C068  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 8067C06C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 8067C070  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 8067C074  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 8067C078  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 8067C07C  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 8067C080  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8067C084  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8067C088  4B CC A4 28 */	b PSMTXCopy
...
/* 8067C0A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8067C0A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8067C0A8  38 81 00 4C */	addi r4, r1, 0x4c
/* 8067C0AC  38 A1 00 58 */	addi r5, r1, 0x58
/* 8067C0B0  4B CC AC BC */	b PSMTXMultVec
/* 8067C0B4  38 61 00 34 */	addi r3, r1, 0x34
/* 8067C0B8  38 81 00 58 */	addi r4, r1, 0x58
/* 8067C0BC  7F 65 DB 78 */	mr r5, r27
/* 8067C0C0  4B BE AA 74 */	b __mi__4cXyzCFRC3Vec
...
/* 8067C0DC  4B BE B5 98 */	b cM_atan2s__Fff
...
/* 8067C110  4B BE B5 64 */	b cM_atan2s__Fff
...
/* 8067C12C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8067C130  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 8067C134  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 8067C180  4B 9D 09 10 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8067C184  7C 79 1B 79 */	or. r25, r3, r3
/* 8067C188  41 82 00 FC */	beq lbl_8067C284
/* 8067C18C  38 61 00 40 */	addi r3, r1, 0x40
/* 8067C190  4B CC AF A8 */	b PSVECSquareMag
...
/* 8067C200  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8067C204  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8067C270  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8067C274  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8067C278:
...
/* 8067C2C8  4B 9D 07 C8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8067C304  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8067C308  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 8067C334  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 8067C374  4B 9D 11 58 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8067C3D4  4B CE 5E 2C */	b _restgpr_19

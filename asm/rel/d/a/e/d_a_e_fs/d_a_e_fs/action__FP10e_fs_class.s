...
/* 806BD0B8  4B CA 51 1C */	b _savegpr_27
/* 806BD0BC  7C 7C 1B 78 */	mr r28, r3
/* 806BD0C0  3C 80 80 6C */	lis r4, lit_3917@ha
/* 806BD0C4  3B A4 E4 8C */	addi r29, r4, lit_3917@l
/* 806BD0C8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806BD0CC  3B C4 61 C0 */	addi r30, r4, struct_804061C0+0x0@l
/* 806BD0D0  80 9E 5D AC */	lwz r4, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 806BD0D4  4B 95 D6 3C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BD0D8  B0 7C 05 C6 */	sth r3, 0x5c6(r28)
/* 806BD0DC  7F 83 E3 78 */	mr r3, r28
/* 806BD0E0  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 806BD0E4  4B 95 D8 80 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 806BD0E8  D0 3C 05 C8 */	stfs f1, 0x5c8(r28)
/* 806BD0EC  80 1C 04 A4 */	lwz r0, 0x4a4(r28)
/* 806BD0F0  90 01 00 0C */	stw r0, 0xc(r1)
/* 806BD0F4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 806BD0F8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 806BD0FC  38 81 00 0C */	addi r4, r1, 0xc
/* 806BD100  4B 95 C6 F8 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 806BD118  3C 60 80 6C */	lis r3, lit_4546@ha
/* 806BD11C  38 63 E5 DC */	addi r3, r3, lit_4546@l
...
lbl_806BD150:
/* 806BD150  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806BD154  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806BD158  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 806BD174  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 806BD178  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 806BD17C  38 81 00 08 */	addi r4, r1, 8
/* 806BD180  4B 95 C6 78 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 806BD204  4B C0 49 78 */	b setLinkSearch__15Z2CreatureEnemyFb
/* 806BD208  48 00 00 10 */	b lbl_806BD218
lbl_806BD20C:
/* 806BD20C  38 7C 05 D4 */	addi r3, r28, 0x5d4
/* 806BD210  38 80 00 00 */	li r4, 0
/* 806BD214  4B C0 49 68 */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_806BD218:
/* 806BD218  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 806BD21C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 806BD220  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 806BD224  A8 9C 04 DE */	lha r4, 0x4de(r28)
/* 806BD228  4B 94 F1 B4 */	b mDoMtx_YrotS__FPA4_fs
...
/* 806BD248  4B BB 3C A4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806BD268  4B C8 9E 28 */	b PSVECAdd
...
/* 806BD2EC  4B 9C 6F D4 */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 806BD310  A8 64 00 00 */	lha r3, 0(r4)	/* effective address: 806BE79E */
/* 806BD314  38 03 00 01 */	addi r0, r3, 1
/* 806BD318  B0 04 00 00 */	sth r0, 0(r4)	/* effective address: 806BE79E */
...
/* 806BD334  4B 97 06 FC */	b dComIfGs_isZoneSwitch__Fii
...
/* 806BD34C  4B 97 06 00 */	b dComIfGs_onZoneSwitch__Fii
lbl_806BD350:
...
/* 806BD36C  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806BD370  38 63 E7 B0 */	addi r3, r3, l_HIO@l
/* 806BD374  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 806BE7C8 */
...
/* 806BD390  4B 95 C8 EC */	b fopAcM_delete__FP10fopAc_ac_c
...
/* 806BD3C4  4B 95 C8 B8 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_806BD3C8:
/* 806BD3C8  39 61 00 40 */	addi r11, r1, 0x40
/* 806BD3CC  4B CA 4E 54 */	b _restgpr_27

...
/* 806BD3F0  4B CA 4D E8 */	b _savegpr_28
/* 806BD3F4  7C 7D 1B 78 */	mr r29, r3
/* 806BD3F8  3C 60 80 6C */	lis r3, lit_3917@ha
/* 806BD3FC  3B E3 E4 8C */	addi r31, r3, lit_3917@l
...
/* 806BD4A8  4B BA 96 DC */	b __ml__4cXyzCFf
/* 806BD4AC  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 806BD4B0  38 81 00 08 */	addi r4, r1, 8
/* 806BD4B4  7C 65 1B 78 */	mr r5, r3
/* 806BD4B8  4B C8 9B D8 */	b PSVECAdd
lbl_806BD4BC:
/* 806BD4BC  38 7D 06 D4 */	addi r3, r29, 0x6d4
/* 806BD4C0  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 806BD4C4  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 806BD4C8  38 84 0F 38 */	addi r4, r4, 0xf38
/* 806BD4CC  4B 9B 95 E0 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 806BD510  4B BB 1C CC */	b SetC__8cM3dGCylFRC4cXyz
/* 806BD514  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806BD518  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806BD51C  3B C3 23 3C */	addi r30, r3, 0x233c
/* 806BD520  7F C3 F3 78 */	mr r3, r30
/* 806BD524  38 9D 08 E8 */	addi r4, r29, 0x8e8
/* 806BD528  4B BA 76 80 */	b Set__4cCcSFP8cCcD_Obj
/* 806BD52C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806BD530  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806BD534  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 806BD538  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 806BD53C  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 806BD540  4B C8 93 A8 */	b PSMTXTrans
/* 806BD544  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806BD548  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806BD54C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 806BD550  4B 94 EE E4 */	b mDoMtx_YrotM__FPA4_fs
/* 806BD554  3C 60 80 6C */	lis r3, l_HIO@ha
/* 806BD558  38 63 E7 B0 */	addi r3, r3, l_HIO@l
/* 806BD55C  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 806BE7B8 */
/* 806BD560  FC 40 08 90 */	fmr f2, f1
/* 806BD564  FC 60 08 90 */	fmr f3, f1
/* 806BD568  4B 94 F8 D0 */	b scaleM__14mDoMtx_stack_cFfff
/* 806BD56C  80 7D 05 D0 */	lwz r3, 0x5d0(r29)
/* 806BD570  83 83 00 04 */	lwz r28, 4(r3)
/* 806BD574  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806BD578  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806BD57C  38 9C 00 24 */	addi r4, r28, 0x24
/* 806BD580  4B C8 8F 30 */	b PSMTXCopy
/* 806BD584  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 806BD588  7C 03 07 74 */	extsb r3, r0
/* 806BD58C  4B 96 FA E0 */	b dComIfGp_getReverb__Fi
/* 806BD590  7C 65 1B 78 */	mr r5, r3
/* 806BD594  80 7D 05 D0 */	lwz r3, 0x5d0(r29)
/* 806BD598  38 80 00 00 */	li r4, 0
/* 806BD59C  4B 95 3B 14 */	b play__16mDoExt_McaMorfSOFUlSc
/* 806BD5A0  80 7D 05 D0 */	lwz r3, 0x5d0(r29)
/* 806BD5A4  4B 95 3C 48 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 806BD5A8  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 806BD5AC  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806BD5B0  38 63 02 10 */	addi r3, r3, 0x210
/* 806BD5B4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806BD5B8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806BD5BC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806BD5C0  4B C8 8E F0 */	b PSMTXCopy
...
/* 806BD5DC  4B BB 39 10 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 806BD614  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 806BD618  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 806BD61C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 806BD620  4B C8 8E 90 */	b PSMTXCopy
...
/* 806BD63C  4B BB 38 B0 */	b MtxPosition__FP4cXyzP4cXyz

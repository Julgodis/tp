...
/* 806BE038  4B CA 41 7C */	b _savegpr_19
/* 806BE03C  7C 7E 1B 78 */	mr r30, r3
/* 806BE040  7C 9A 23 78 */	mr r26, r4
/* 806BE044  7C BB 2B 78 */	mr r27, r5
/* 806BE048  7C DC 33 78 */	mr r28, r6
/* 806BE04C  3C 60 80 6C */	lis r3, cNullVec__6Z2Calc@ha
/* 806BE050  3A E3 E5 80 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 806BE054  3C 60 80 6C */	lis r3, lit_3917@ha
/* 806BE058  3B E3 E4 8C */	addi r31, r3, lit_3917@l
/* 806BE05C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806BE060  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806BE064  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 806BE068  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 806BE06C  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 806BE094  4B AE E4 E8 */	b dKy_darkworld_check__Fv
...
/* 806BE0B8  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 806BE0BC  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 806BE0C0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 806BE0C4  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 806BE0C8  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 806BE0CC  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 806BE0D0  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 806BE0D4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806BE0D8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806BE0DC  4B C8 83 D4 */	b PSMTXCopy
...
/* 806BE0F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806BE0F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806BE0FC  38 81 00 4C */	addi r4, r1, 0x4c
/* 806BE100  38 A1 00 58 */	addi r5, r1, 0x58
/* 806BE104  4B C8 8C 68 */	b PSMTXMultVec
/* 806BE108  38 61 00 34 */	addi r3, r1, 0x34
/* 806BE10C  38 81 00 58 */	addi r4, r1, 0x58
/* 806BE110  7F 65 DB 78 */	mr r5, r27
/* 806BE114  4B BA 8A 20 */	b __mi__4cXyzCFRC3Vec
...
/* 806BE130  4B BA 95 44 */	b cM_atan2s__Fff
...
/* 806BE164  4B BA 95 10 */	b cM_atan2s__Fff
...
/* 806BE180  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806BE184  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 806BE188  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 806BE1D4  4B 98 E8 BC */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 806BE1D8  7C 79 1B 79 */	or. r25, r3, r3
/* 806BE1DC  41 82 00 FC */	beq lbl_806BE2D8
/* 806BE1E0  38 61 00 40 */	addi r3, r1, 0x40
/* 806BE1E4  4B C8 8F 54 */	b PSVECSquareMag
...
/* 806BE254  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806BE258  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806BE2C4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806BE2C8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806BE2CC:
...
/* 806BE31C  4B 98 E7 74 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806BE358  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806BE35C  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 806BE388  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 806BE3C8  4B 98 F1 04 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 806BE428  4B CA 3D D8 */	b _restgpr_19

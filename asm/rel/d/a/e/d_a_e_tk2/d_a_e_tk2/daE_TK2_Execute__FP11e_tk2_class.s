...
/* 807BB138  4B BA 70 9C */	b _savegpr_27
/* 807BB13C  7C 7C 1B 78 */	mr r28, r3
/* 807BB140  3C 60 80 7C */	lis r3, lit_3762@ha
/* 807BB144  3B C3 BD A8 */	addi r30, r3, lit_3762@l
...
/* 807BB158  4B 8B C6 58 */	b __ct__18dBgS_ObjGndChk_SplFv
...
/* 807BB188  4B AA CB A0 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 807BB18C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807BB190  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807BB194  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807BB198  38 81 00 6C */	addi r4, r1, 0x6c
/* 807BB19C  4B 8B 93 04 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807BB1B4  4B 8B C6 94 */	b __dt__18dBgS_ObjGndChk_SplFv
lbl_807BB1B8:
...
/* 807BB214  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807BB218  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807BB21C  38 84 0F 38 */	addi r4, r4, 0xf38
/* 807BB220  4B 8B B8 8C */	b CrrPos__9dBgS_AcchFR4dBgS
/* 807BB224  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807BB228  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807BB22C  C0 3C 04 D0 */	lfs f1, 0x4d0(r28)
/* 807BB230  C0 5C 04 D4 */	lfs f2, 0x4d4(r28)
/* 807BB234  C0 7C 04 D8 */	lfs f3, 0x4d8(r28)
/* 807BB238  4B B8 B6 B0 */	b PSMTXTrans
/* 807BB23C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807BB240  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807BB244  A8 9C 04 E6 */	lha r4, 0x4e6(r28)
/* 807BB248  4B 85 11 EC */	b mDoMtx_YrotM__FPA4_fs
/* 807BB24C  3C 60 80 7C */	lis r3, l_HIO@ha
/* 807BB250  3B E3 BF 50 */	addi r31, r3, l_HIO@l
/* 807BB254  C0 3F 00 08 */	lfs f1, 8(r31)	/* effective address: 807BBF58 */
/* 807BB258  FC 40 08 90 */	fmr f2, f1
/* 807BB25C  FC 60 08 90 */	fmr f3, f1
/* 807BB260  4B 85 1B D8 */	b scaleM__14mDoMtx_stack_cFfff
/* 807BB264  80 7C 05 B8 */	lwz r3, 0x5b8(r28)
/* 807BB268  83 A3 00 04 */	lwz r29, 4(r3)
/* 807BB26C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807BB270  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807BB274  38 9D 00 24 */	addi r4, r29, 0x24
/* 807BB278  4B B8 B2 38 */	b PSMTXCopy
/* 807BB27C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 807BB280  7C 03 07 74 */	extsb r3, r0
/* 807BB284  4B 87 1D E8 */	b dComIfGp_getReverb__Fi
/* 807BB288  7C 65 1B 78 */	mr r5, r3
/* 807BB28C  80 7C 05 B8 */	lwz r3, 0x5b8(r28)
/* 807BB290  38 80 00 00 */	li r4, 0
/* 807BB294  4B 85 5E 1C */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 807BB2B0  4B B6 D1 7C */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB2C8  4B B6 D1 64 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB2E0  4B B6 D1 4C */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB2F8  4B B6 D1 34 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB310  4B B6 D1 1C */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB360  4B B6 D0 CC */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB3A8  4B B6 D0 84 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB3F8  4B B6 D0 34 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB448  4B B6 CF E4 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB490  4B B6 CF 9C */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB4E0  4B B6 CF 4C */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB52C  4B B6 CF 00 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB578  4B B6 CE B4 */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB590  4B B6 CE 9C */	b checkPass__12J3DFrameCtrlFf
...
/* 807BB5C8  4B 85 5C 24 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 807BB5CC  80 7D 00 84 */	lwz r3, 0x84(r29)
/* 807BB5D0  80 63 00 0C */	lwz r3, 0xc(r3)
/* 807BB5D4  38 63 00 90 */	addi r3, r3, 0x90
/* 807BB5D8  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807BB5DC  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807BB5E0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807BB5E4  4B B8 AE CC */	b PSMTXCopy
...
/* 807BB600  4B AB 58 EC */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807BB648  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 807BB64C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 807BB650  38 81 00 20 */	addi r4, r1, 0x20
/* 807BB654  4B 85 E1 A4 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 807BB690  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807BB694  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 807BB698  80 7B 5D 3C */	lwz r3, 0x5d3c(r27)	/* effective address: 8040BEFC */
...
/* 807BB6DC  4B 89 13 B4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807BB724  4B 89 13 6C */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807BB768  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807BB76C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807BB770  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807BB774  4B B8 AD 3C */	b PSMTXCopy
...
/* 807BB790  4B AB 57 5C */	b MtxPosition__FP4cXyzP4cXyz
/* 807BB794  38 7C 0A 14 */	addi r3, r28, 0xa14
/* 807BB798  38 81 00 54 */	addi r4, r1, 0x54
/* 807BB79C  4B AB 3E AC */	b SetC__8cM3dGSphFRC4cXyz
...
/* 807BB7B0  4B AB 3F 58 */	b SetR__8cM3dGSphFf
/* 807BB7B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807BB7B8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807BB7BC  38 63 23 3C */	addi r3, r3, 0x233c
/* 807BB7C0  38 9C 08 F0 */	addi r4, r28, 0x8f0
/* 807BB7C4  4B AA 93 E4 */	b Set__4cCcSFP8cCcD_Obj
/* 807BB7C8  38 60 00 01 */	li r3, 1
/* 807BB7CC  39 61 00 E0 */	addi r11, r1, 0xe0
/* 807BB7D0  4B BA 6A 50 */	b _restgpr_27

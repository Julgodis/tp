...
/* 807A63B4  4B BB BE 00 */	b _savegpr_19
/* 807A63B8  7C 7E 1B 78 */	mr r30, r3
/* 807A63BC  7C 9A 23 78 */	mr r26, r4
/* 807A63C0  7C BB 2B 78 */	mr r27, r5
/* 807A63C4  7C DC 33 78 */	mr r28, r6
/* 807A63C8  3C 60 80 7A */	lis r3, cNullVec__6Z2Calc@ha
/* 807A63CC  3A E3 69 EC */	addi r23, r3, cNullVec__6Z2Calc@l
/* 807A63D0  3C 60 80 7A */	lis r3, lit_3903@ha
/* 807A63D4  3B E3 68 24 */	addi r31, r3, lit_3903@l
/* 807A63D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A63DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807A63E0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807A63E4  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 807A63E8  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 807A6410  4B A0 61 6C */	b dKy_darkworld_check__Fv
...
/* 807A6434  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 807A6438  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 807A643C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 807A6440  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 807A6444  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 807A6448  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 807A644C  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 807A6450  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807A6454  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807A6458  4B BA 00 58 */	b PSMTXCopy
...
/* 807A6470  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807A6474  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807A6478  38 81 00 4C */	addi r4, r1, 0x4c
/* 807A647C  38 A1 00 58 */	addi r5, r1, 0x58
/* 807A6480  4B BA 08 EC */	b PSMTXMultVec
/* 807A6484  38 61 00 34 */	addi r3, r1, 0x34
/* 807A6488  38 81 00 58 */	addi r4, r1, 0x58
/* 807A648C  7F 65 DB 78 */	mr r5, r27
/* 807A6490  4B AC 06 A4 */	b __mi__4cXyzCFRC3Vec
...
/* 807A64AC  4B AC 11 C8 */	b cM_atan2s__Fff
...
/* 807A64E0  4B AC 11 94 */	b cM_atan2s__Fff
...
/* 807A64FC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A6500  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 807A6504  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 807A6550  4B 8A 65 40 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807A6554  7C 79 1B 79 */	or. r25, r3, r3
/* 807A6558  41 82 00 FC */	beq lbl_807A6654
/* 807A655C  38 61 00 40 */	addi r3, r1, 0x40
/* 807A6560  4B BA 0B D8 */	b PSVECSquareMag
...
/* 807A65D0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807A65D4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807A6640  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807A6644  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807A6648:
...
/* 807A6698  4B 8A 63 F8 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807A66D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A66D8  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 807A6704  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 807A6744  4B 8A 6D 88 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807A67A4  4B BB BA 5C */	b _restgpr_19

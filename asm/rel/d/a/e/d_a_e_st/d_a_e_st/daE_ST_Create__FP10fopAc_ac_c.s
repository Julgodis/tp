...
/* 807A587C  4B BB C9 58 */	b _savegpr_27
/* 807A5880  7C 7C 1B 78 */	mr r28, r3
/* 807A5884  3C 80 80 7A */	lis r4, lit_1109@ha
/* 807A5888  3B A4 6D A0 */	addi r29, r4, lit_1109@l
/* 807A588C  3C 80 80 7A */	lis r4, cNullVec__6Z2Calc@ha
/* 807A5890  3B C4 69 EC */	addi r30, r4, cNullVec__6Z2Calc@l
/* 807A5894  3C 80 80 7A */	lis r4, lit_3903@ha
/* 807A5898  3B E4 68 24 */	addi r31, r4, lit_3903@l
...
/* 807A58C4  3C 80 80 7A */	lis r4, stringBase0@ha
/* 807A58C8  38 84 69 E0 */	addi r4, r4, stringBase0@l
/* 807A58CC  4B 88 75 F0 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 807A5974  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A5978  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807A597C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 807A5980  7C 05 07 74 */	extsb r5, r0
/* 807A5984  4B 88 F9 DC */	b isSwitch__10dSv_info_cCFii
...
/* 807A5A8C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807A5A90  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807A5A94  38 63 4E 00 */	addi r3, r3, 0x4e00
/* 807A5A98  3C 80 80 7A */	lis r4, stringBase0@ha
/* 807A5A9C  38 84 69 E0 */	addi r4, r4, stringBase0@l
/* 807A5AA0  38 84 00 05 */	addi r4, r4, 5
/* 807A5AA4  4B BC 2E F0 */	b strcmp
...
/* 807A5AC8  3C 80 80 7A */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 807A5ACC  38 84 54 2C */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 807A5AD0  38 A0 28 00 */	li r5, 0x2800
/* 807A5AD4  4B 87 49 DC */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 807A5B34  4B 87 49 F4 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 807A5B48  4B 87 49 F0 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 807A5B7C  4B 8D DC E4 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 807A5B80  38 7C 0A 5C */	addi r3, r28, 0xa5c
/* 807A5B84  38 9E 01 98 */	addi r4, r30, 0x198
/* 807A5B88  4B 8D EE AC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807A5B9C  4B 8D EE 98 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807A5BB0  4B 8D EE 84 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807A5BD0  4B 8D EC E4 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 807A5BFC  4B B1 B4 98 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 807A5C00  38 7C 05 D0 */	addi r3, r28, 0x5d0
/* 807A5C04  3C 80 80 7A */	lis r4, stringBase0@ha
/* 807A5C08  38 84 69 E0 */	addi r4, r4, stringBase0@l
/* 807A5C0C  4B B1 BF 84 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 807A5C54  4B 8D 05 F4 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 807A5C58  38 7C 08 00 */	addi r3, r28, 0x800
/* 807A5C5C  C0 3F 01 58 */	lfs f1, 0x158(r31)
/* 807A5C60  FC 40 08 90 */	fmr f2, f1
/* 807A5C64  4B 8D 02 F4 */	b SetWall__12dBgS_AcchCirFff
...
/* 807A5C94  4B AC 1C C0 */	b cM_rndF__Ff
...
/* 807A5CE0  4B BB C5 40 */	b _restgpr_27

...
/* 8079F444  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8079F448  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8079F44C  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8079F450  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 8079F454  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8079F458  4B AC 76 DC */	b __mi__4cXyzCFRC3Vec
...
/* 8079F474  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8079F478  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8079F47C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8079F480  A8 1F 06 9C */	lha r0, 0x69c(r31)
/* 8079F484  7C 00 00 D0 */	neg r0, r0
/* 8079F488  7C 04 07 34 */	extsh r4, r0
/* 8079F48C  4B 86 CE B8 */	b mDoMtx_XrotS__FPA4_fs
/* 8079F490  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8079F494  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8079F498  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8079F49C  A8 1F 06 9E */	lha r0, 0x69e(r31)
/* 8079F4A0  7C 00 00 D0 */	neg r0, r0
/* 8079F4A4  7C 04 07 34 */	extsh r4, r0
/* 8079F4A8  4B 86 CF 8C */	b mDoMtx_YrotM__FPA4_fs
/* 8079F4AC  38 61 00 20 */	addi r3, r1, 0x20
/* 8079F4B0  38 81 00 14 */	addi r4, r1, 0x14
/* 8079F4B4  4B AD 1A 38 */	b MtxPosition__FP4cXyzP4cXyz
/* 8079F4B8  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 8079F4BC  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 8079F4C0  4B AC 81 B4 */	b cM_atan2s__Fff

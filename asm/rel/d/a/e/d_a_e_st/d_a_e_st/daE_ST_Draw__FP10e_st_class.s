...
/* 8079E1B4  4B BC 40 1C */	b _savegpr_26
/* 8079E1B8  7C 7D 1B 78 */	mr r29, r3
/* 8079E1BC  3C 60 80 7A */	lis r3, lit_3903@ha
/* 8079E1C0  3B E3 68 24 */	addi r31, r3, lit_3903@l
/* 8079E1C4  80 7D 05 CC */	lwz r3, 0x5cc(r29)
/* 8079E1C8  83 C3 00 04 */	lwz r30, 4(r3)
/* 8079E1CC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8079E1D0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8079E1D4  38 80 00 00 */	li r4, 0
/* 8079E1D8  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 8079E1DC  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8079E1E0  4B A0 55 E4 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8079E1E4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8079E1E8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8079E1EC  80 9E 00 04 */	lwz r4, 4(r30)
/* 8079E1F0  38 BD 01 0C */	addi r5, r29, 0x10c
/* 8079E1F4  4B A0 6B AC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 8079E2B8  4B 87 2F 08 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 8079E2E0  4B 87 F9 DC */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 8079E2E4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 8079E2E8  41 82 00 64 */	beq lbl_8079E34C
/* 8079E2EC  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 8079E2F0  C0 83 0C D0 */	lfs f4, mGroundY__11fopAcM_gc_c@l(r3)
...
/* 8079E324  3C E0 80 3F */	lis r7, mGndCheck__11fopAcM_gc_c@ha
/* 8079E328  38 E7 1C C4 */	addi r7, r7, mGndCheck__11fopAcM_gc_c@l
...
/* 8079E33C  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 8079E340  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 8079E344  4B 89 05 CC */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 8079E380  4B 87 4A BC */	b update__19mDoExt_3DlineMat0_cFiR8_GXColorP12dKy_tevstr_c
...
/* 8079E3B8  4B 87 63 80 */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
...
/* 8079E3F0  4B 87 4A 4C */	b update__19mDoExt_3DlineMat0_cFiR8_GXColorP12dKy_tevstr_c
...
/* 8079E41C  4B 87 63 1C */	b setMat__26mDoExt_3DlineMatSortPacketFP18mDoExt_3DlineMat_c
lbl_8079E420:
/* 8079E420  38 60 00 01 */	li r3, 1
/* 8079E424  39 61 00 50 */	addi r11, r1, 0x50
/* 8079E428  4B BC 3D F4 */	b _restgpr_26

...
/* 807A2B20 00000020  3C 80 00 00 */	lis r4, lit_3903@ha /* 807A6824 */
/* 807A2B24 00000024  3B E4 00 00 */	addi r31, r4, lit_3903@l /* 807A6824 */
/* 807A2B28 00000028  C3 FF 00 04 */	lfs f31, 4(r31)
...
/* 807A2B64 0000000C  C0 3F 00 5C */	lfs f1, 0x5c(r31)
/* 807A2B68 00000010  38 A0 00 02 */	li r5, 2
/* 807A2B6C 00000014  C0 5F 00 08 */	lfs f2, 8(r31)
/* 807A2B70 00000018  4B FF B2 DD */	bl anm_init__FP10e_st_classifUcf
/* 807A2B74 0000001C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 807A2B78 00000020  4B FF B1 E1 */	bl cM_rndF__Ff
/* 807A2B7C 00000024  C0 1F 00 84 */	lfs f0, 0x84(r31)
...
/* 807A2BB4 00000014  C0 3F 00 4C */	lfs f1, 0x4c(r31)
/* 807A2BB8 00000018  4B FF B1 A1 */	bl cM_rndFX__Ff
...
/* 807A2BC8 00000028  C0 3F 00 4C */	lfs f1, 0x4c(r31)
/* 807A2BCC 0000002C  4B FF B1 8D */	bl cM_rndFX__Ff
...
/* 807A2BF8 00000058  4B FF B1 61 */	bl cM_atan2s__Fff
...
/* 807A2C28 00000024  C0 3F 00 78 */	lfs f1, 0x78(r31)
/* 807A2C2C 00000028  38 A0 00 02 */	li r5, 2
/* 807A2C30 0000002C  C0 5F 00 08 */	lfs f2, 8(r31)
...
/* 807A2C40 0000003C  C0 3F 00 00 */	lfs f1, 0(r31)
/* 807A2C44 00000040  4B FF B1 15 */	bl cM_rndF__Ff
/* 807A2C48 00000044  C0 1F 00 84 */	lfs f0, 0x84(r31)
...
/* 807A2C78 00000014  C0 3F 00 78 */	lfs f1, 0x78(r31)
/* 807A2C7C 00000018  38 A0 00 02 */	li r5, 2
/* 807A2C80 0000001C  C0 5F 00 08 */	lfs f2, 8(r31)
/* 807A2C84 00000020  4B FF B1 C9 */	bl anm_init__FP10e_st_classifUcf
/* 807A2C88 00000024  48 00 00 2C */	b lbl_807A2CB4
lbl_807A2C8C:
/* 807A2C8C 00000000  C0 3F 00 2C */	lfs f1, 0x2c(r31)
/* 807A2C90 00000004  3C 60 00 00 */	lis r3, l_HIO@ha /* 807A6DF4 */
/* 807A2C94 00000008  38 63 00 00 */	addi r3, r3, l_HIO@l /* 807A6DF4 */
/* 807A2C98 0000000C  C0 03 00 08 */	lfs f0, 8(r3)
...
/* 807A2CBC 00000008  C0 5F 00 08 */	lfs f2, 8(r31)
/* 807A2CC0 0000000C  FC 60 10 90 */	fmr f3, f2
/* 807A2CC4 00000010  4B FF B0 95 */	bl cLib_addCalc2__FPffff
...
/* 807A2CD8 00000024  4B FF B0 81 */	bl cLib_addCalcAngleS2__FPssss
/* 807A2CDC 00000028  7F C3 F3 78 */	mr r3, r30
/* 807A2CE0 0000002C  3C 80 00 00 */	lis r4, l_HIO@ha /* 807A6DF4 */
/* 807A2CE4 00000030  38 84 00 00 */	addi r4, r4, l_HIO@l /* 807A6DF4 */
/* 807A2CE8 00000034  C0 24 00 0C */	lfs f1, 0xc(r4)

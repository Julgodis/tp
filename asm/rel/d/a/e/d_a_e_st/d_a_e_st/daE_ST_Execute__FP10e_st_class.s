...
/* 807A4A60 0000000C  3C 80 00 00 */	lis r4, lit_3903@ha /* 807A6824 */
/* 807A4A64 00000010  3B C4 00 00 */	addi r30, r4, lit_3903@l /* 807A6824 */
/* 807A4A68 00000014  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807A4A6C 00000018  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 807A4A7C 00000028  3C 60 00 00 */	lis r3, l_HIO@ha /* 807A6DF4 */
/* 807A4A80 0000002C  38 63 00 00 */	addi r3, r3, l_HIO@l /* 807A6DF4 */
/* 807A4A84 00000030  C3 E3 00 08 */	lfs f31, 8(r3)
/* 807A4A88 00000034  3C 60 00 00 */	lis r3, small@ha /* 807A6DE0 */
/* 807A4A8C 00000038  80 03 00 00 */	lwz r0, small@l(r3) /* 807A6DE0 */
...
/* 807A4B28 0000002C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4B2C 00000030  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4B40 00000044  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4B44 00000048  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4B5C 00000060  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4B60 00000064  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4B78 0000007C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4B7C 00000080  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4B80 00000084  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 807A4B84 00000088  4B FF 91 D5 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4B88 0000008C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4B8C 00000090  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4B90 00000094  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 807A4B94 00000098  4B FF 91 C5 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4B98 0000009C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4B9C 000000A0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4BB8 000000BC  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4BBC 000000C0  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4BEC 00000004  3C 60 00 00 */	lis r3, calc_mtx@ha /* 80450768 */
/* 807A4BF0 00000008  38 63 00 00 */	addi r3, r3, calc_mtx@l /* 80450768 */
...
/* 807A4C18 00000030  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha /* 80439A20 */
/* 807A4C1C 00000034  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l /* 80439A20 */
...
lbl_807A4C74:
/* 807A4C74 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4C78 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4CB4 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4CB8 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4CBC 00000048  A8 9F 07 F2 */	lha r4, 0x7f2(r31)
/* 807A4CC0 0000004C  4B FF 90 99 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4CC4 00000050  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4CC8 00000054  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4CCC 00000058  7F 84 E3 78 */	mr r4, r28
/* 807A4CD0 0000005C  4B FF 90 89 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4CD4 00000060  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4CD8 00000064  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4CF4 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4CF8 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4CFC 00000010  A8 9F 06 9E */	lha r4, 0x69e(r31)
/* 807A4D00 00000014  4B FF 90 59 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4D04 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D08 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D0C 00000020  A8 9F 06 9C */	lha r4, 0x69c(r31)
/* 807A4D10 00000024  4B FF 90 49 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4D14 00000028  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D18 0000002C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D1C 00000030  A8 9F 06 A4 */	lha r4, 0x6a4(r31)
/* 807A4D20 00000034  4B FF 90 39 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4D24 00000038  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D28 0000003C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D2C 00000040  A8 9F 06 A2 */	lha r4, 0x6a2(r31)
/* 807A4D30 00000044  4B FF 90 29 */	bl mDoMtx_ZrotM__FPA4_fs
/* 807A4D34 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D38 0000004C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D3C 00000050  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 807A4D40 00000054  4B FF 90 19 */	bl mDoMtx_YrotM__FPA4_fs
/* 807A4D44 00000058  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D48 0000005C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D4C 00000060  A8 9F 04 DC */	lha r4, 0x4dc(r31)
/* 807A4D50 00000064  4B FF 90 09 */	bl mDoMtx_XrotM__FPA4_fs
/* 807A4D54 00000068  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D58 0000006C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 807A4D74 00000088  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D78 0000008C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D7C 00000090  38 9D 00 24 */	addi r4, r29, 0x24
/* 807A4D80 00000094  4B FF 8F D9 */	bl PSMTXCopy
/* 807A4D84 00000098  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 807A4D88 0000009C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 807A4D8C 000000A0  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 807A4D90 000000A4  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
...
/* 807A4FD8 00000024  3C 60 00 00 */	lis r3, m_cpadInfo__8mDoCPd_c@ha /* 803DD2E8 */
/* 807A4FDC 00000028  38 63 00 00 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l /* 803DD2E8 */
...
/* 807A500C 0000000C  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 807A5010 00000010  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
...
/* 807A50B0 00000018  3C 80 00 00 */	lis r4, calc_mtx@ha /* 80450768 */
/* 807A50B4 0000001C  38 84 00 00 */	addi r4, r4, calc_mtx@l /* 80450768 */
...
lbl_807A5150:
/* 807A5150 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807A5154 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 807A5378 00000018  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 807A537C 0000001C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */

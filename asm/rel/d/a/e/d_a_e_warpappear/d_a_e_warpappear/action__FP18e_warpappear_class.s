...
/* 807CFFF4 0000000C  3C 60 00 00 */	lis r3, lit_3864@ha
/* 807CFFF8 00000010  3B C3 00 00 */	addi r30, r3, lit_3864@l
/* 807CFFFC 00000014  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 807D0000 00000018  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l
...
/* 807D0094 0000001C  3C 60 00 00 */	lis r3, entry_no@ha
/* 807D0098 00000020  90 03 00 00 */	stw r0, entry_no@l(r3)
/* 807D009C 00000024  3C 60 00 00 */	lis r3, s_s1entry_sub__FPvPv@ha
/* 807D00A0 00000028  38 63 00 00 */	addi r3, r3, s_s1entry_sub__FPvPv@l
/* 807D00A4 0000002C  7F A4 EB 78 */	mr r4, r29
/* 807D00A8 00000030  4B FF F7 11 */	bl fpcEx_Search__FPFPvPv_PvPv
lbl_807D00AC:
/* 807D00AC 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 807D00B0 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 807D00B4 00000008  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 807D00B8 0000000C  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 807D00BC 00000010  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
/* 807D00D0 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 807D00D4 00000028  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 807D010C 00000008  3C 60 00 00 */	lis r3, s_s1_sub__FPvPv@ha
/* 807D0110 0000000C  38 63 00 00 */	addi r3, r3, s_s1_sub__FPvPv@l
...
/* 807D013C 00000004  3C 60 00 00 */	lis r3, entry_no@ha
/* 807D0140 00000008  90 03 00 00 */	stw r0, entry_no@l(r3)
/* 807D0144 0000000C  3C 60 00 00 */	lis r3, s_s1entry_sub__FPvPv@ha
/* 807D0148 00000010  38 63 00 00 */	addi r3, r3, s_s1entry_sub__FPvPv@l
...
/* 807D0170 00000038  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 807D0174 0000003C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 807D020C 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 807D0210 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
lbl_807D025C:
/* 807D025C 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 807D0260 00000004  3B 83 00 00 */	addi r28, r3, g_dComIfG_gameInfo@l

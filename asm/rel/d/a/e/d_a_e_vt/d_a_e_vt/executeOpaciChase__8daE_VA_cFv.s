...
/* 807C9C9C  4B B9 85 38 */	b _savegpr_27
/* 807C9CA0  7C 7B 1B 78 */	mr r27, r3
/* 807C9CA4  3C 80 80 7D */	lis r4, lit_3907@ha
/* 807C9CA8  3B A4 EC A8 */	addi r29, r4, lit_3907@l
/* 807C9CAC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807C9CB0  3B C4 61 C0 */	addi r30, r4, struct_804061C0+0x0@l
/* 807C9CB4  80 9E 5D AC */	lwz r4, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 807C9CB8  4B 85 0A 58 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807C9CBC  7C 7C 1B 78 */	mr r28, r3
/* 807C9CC0  38 7B 04 A8 */	addi r3, r27, 0x4a8
/* 807C9CC4  38 9B 04 D0 */	addi r4, r27, 0x4d0
/* 807C9CC8  4B AA 6F 3C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807C9D1C  4B A9 DC 38 */	b cM_rndF__Ff
...
/* 807C9D5C  4B A9 DB 10 */	b cM_rnd__Fv
...
/* 807C9DD0  3C 60 80 7D */	lis r3, l_HIO@ha
/* 807C9DD4  38 63 F4 C4 */	addi r3, r3, l_HIO@l
/* 807C9DD8  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 807CF4D8 */
...
/* 807C9DF0  4B AA 6F D0 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 807C9DF4  38 7B 04 D0 */	addi r3, r27, 0x4d0
/* 807C9DF8  38 9B 12 F8 */	addi r4, r27, 0x12f8
/* 807C9DFC  4B AA 6E 08 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807C9E40  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807C9E44  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807C9E48  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 807C9E4C  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 807C9E9C  4B AA 68 A4 */	b cLib_chaseF__FPfff
...
/* 807C9EC0  4B AA 68 80 */	b cLib_chaseF__FPfff
...
/* 807C9EFC  4B AA 68 44 */	b cLib_chaseF__FPfff
/* 807C9F00  C0 1D 00 04 */	lfs f0, 4(r29)
/* 807C9F04  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 807C9F08  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 807C9F0C  3C 60 80 7D */	lis r3, l_HIO@ha
/* 807C9F10  38 63 F4 C4 */	addi r3, r3, l_HIO@l
/* 807C9F14  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 807CF4D8 */
...
/* 807C9F2C  4B AA 6E 94 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
...
/* 807C9F4C  4B B7 D1 EC */	b PSVECSquareMag
...
/* 807C9FBC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807C9FC0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807CA02C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807CA030  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807CA034:
...
/* 807CA048  4B A9 D6 2C */	b cM_atan2s__Fff
/* 807CA04C  C0 3D 01 B8 */	lfs f1, 0x1b8(r29)
/* 807CA050  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 807CA054  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 807CA058  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 807CA08C  4B AA 64 B4 */	b cLib_addCalcAngleS__FPsssss
/* 807CA090  38 7B 04 D0 */	addi r3, r27, 0x4d0
/* 807CA094  38 9B 12 F8 */	addi r4, r27, 0x12f8
/* 807CA098  4B AA 6B 6C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 807CA1C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CA1C4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CA1C8  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 807CA1CC  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 807CA20C  4B AA 63 34 */	b cLib_addCalcAngleS__FPsssss
...
/* 807CA224  4B AA 63 1C */	b cLib_addCalcAngleS__FPsssss
/* 807CA228  7F 63 DB 78 */	mr r3, r27
/* 807CA22C  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 807CA230  4B 85 05 B0 */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 807CA234  3C 60 80 7D */	lis r3, l_HIO@ha
/* 807CA238  3B 83 F4 C4 */	addi r28, r3, l_HIO@l
/* 807CA23C  C0 1C 00 0C */	lfs f0, 0xc(r28)	/* effective address: 807CF4D0 */
...
/* 807CA254  4B AA 64 EC */	b cLib_chaseF__FPfff
/* 807CA258  48 00 00 F4 */	b lbl_807CA34C
lbl_807CA25C:
/* 807CA25C  7F 63 DB 78 */	mr r3, r27
/* 807CA260  80 9E 5D AC */	lwz r4, 0x5dac(r30)
/* 807CA264  4B 85 05 7C */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807CA288  4B AA 64 B8 */	b cLib_chaseF__FPfff
...
/* 807CA2C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CA2C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CA2CC  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 807CA2D0  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 807CA308  4B AA 62 38 */	b cLib_addCalcAngleS__FPsssss
...
/* 807CA350  4B B9 7E D0 */	b _restgpr_27

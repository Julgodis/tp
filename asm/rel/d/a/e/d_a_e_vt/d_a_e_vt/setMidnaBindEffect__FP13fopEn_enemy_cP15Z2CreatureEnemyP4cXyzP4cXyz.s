...
/* 807CE800  4B B9 39 B4 */	b _savegpr_19
/* 807CE804  7C 7E 1B 78 */	mr r30, r3
/* 807CE808  7C 9A 23 78 */	mr r26, r4
/* 807CE80C  7C BB 2B 78 */	mr r27, r5
/* 807CE810  7C DC 33 78 */	mr r28, r6
/* 807CE814  3C 60 80 7D */	lis r3, cNullVec__6Z2Calc@ha
/* 807CE818  3A E3 EF 08 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 807CE81C  3C 60 80 7D */	lis r3, lit_3907@ha
/* 807CE820  3B E3 EC A8 */	addi r31, r3, lit_3907@l
/* 807CE824  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CE828  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CE82C  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807CE830  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 807CE834  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 807CE85C  4B 9D DD 20 */	b dKy_darkworld_check__Fv
...
/* 807CE880  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 807CE884  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 807CE888  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 807CE88C  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 807CE890  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 807CE894  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 807CE898  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 807CE89C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CE8A0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CE8A4  4B B7 7C 0C */	b PSMTXCopy
...
/* 807CE8BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CE8C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CE8C4  38 81 00 4C */	addi r4, r1, 0x4c
/* 807CE8C8  38 A1 00 58 */	addi r5, r1, 0x58
/* 807CE8CC  4B B7 84 A0 */	b PSMTXMultVec
/* 807CE8D0  38 61 00 34 */	addi r3, r1, 0x34
/* 807CE8D4  38 81 00 58 */	addi r4, r1, 0x58
/* 807CE8D8  7F 65 DB 78 */	mr r5, r27
/* 807CE8DC  4B A9 82 58 */	b __mi__4cXyzCFRC3Vec
...
/* 807CE8F8  4B A9 8D 7C */	b cM_atan2s__Fff
...
/* 807CE92C  4B A9 8D 48 */	b cM_atan2s__Fff
...
/* 807CE948  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CE94C  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 807CE950  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 807CE99C  4B 87 E0 F4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 807CE9A0  7C 79 1B 79 */	or. r25, r3, r3
/* 807CE9A4  41 82 00 FC */	beq lbl_807CEAA0
/* 807CE9A8  38 61 00 40 */	addi r3, r1, 0x40
/* 807CE9AC  4B B7 87 8C */	b PSVECSquareMag
...
/* 807CEA1C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807CEA20  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807CEA8C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807CEA90  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807CEA94:
...
/* 807CEAE4  4B 87 DF AC */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807CEB20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CEB24  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 807CEB50  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 807CEB90  4B 87 E9 3C */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807CEBF0  4B B9 36 10 */	b _restgpr_19

...
/* 807C7AA4 00000018  3C 60 00 00 */	lis r3, lit_3907@ha /* 807CECA8 */
/* 807C7AA8 0000001C  3B C3 00 00 */	addi r30, r3, lit_3907@l /* 807CECA8 */
...
lbl_807C7AD4:
/* 807C7AD4 00000000  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 807C7AD8 00000004  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 807C7ADC 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 807C7AE0 0000000C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 807C7AE4 00000010  38 80 00 02 */	li r4, 2
/* 807C7AE8 00000014  4B FF AA 71 */	bl changeSubBgmStatus__8Z2SeqMgrFl
...
/* 807C7AFC 00000028  C0 1E 00 04 */	lfs f0, 4(r30)
...
/* 807C7B14 00000040  C0 3E 00 A0 */	lfs f1, 0xa0(r30)
/* 807C7B18 00000044  C0 5E 00 08 */	lfs f2, 8(r30)
...
/* 807C7B34 00000060  4B FF AA 25 */	bl dComIfGs_isOneZoneSwitch__Fii
...
/* 807C7B4C 00000078  4B FF AA 0D */	bl dComIfGs_onOneZoneSwitch__Fii
lbl_807C7B50:
/* 807C7B50 00000000  38 7F 04 D4 */	addi r3, r31, 0x4d4
/* 807C7B54 00000004  C0 3E 00 04 */	lfs f1, 4(r30)
/* 807C7B58 00000008  C0 5E 00 80 */	lfs f2, 0x80(r30)
/* 807C7B5C 0000000C  C0 7E 00 A0 */	lfs f3, 0xa0(r30)
/* 807C7B60 00000010  C0 9E 00 08 */	lfs f4, 8(r30)
/* 807C7B64 00000014  4B FF A9 F5 */	bl cLib_addCalc__FPfffff
...
/* 807C7B80 00000030  C0 3E 00 48 */	lfs f1, 0x48(r30)
/* 807C7B84 00000034  C0 5E 00 08 */	lfs f2, 8(r30)
...
/* 807C7BC4 00000004  C0 3E 00 04 */	lfs f1, 4(r30)
/* 807C7BC8 00000008  C0 5E 00 80 */	lfs f2, 0x80(r30)
/* 807C7BCC 0000000C  C0 7E 00 A0 */	lfs f3, 0xa0(r30)
/* 807C7BD0 00000010  C0 9E 00 08 */	lfs f4, 8(r30)
/* 807C7BD4 00000014  4B FF A9 85 */	bl cLib_addCalc__FPfffff
...
/* 807C7BF0 00000030  C0 3E 00 04 */	lfs f1, 4(r30)
...
lbl_807C7C1C:
/* 807C7C1C 00000000  4B FF A9 3D */	bl checkNowWolfEyeUp__9daPy_py_cFv
...
/* 807C7C34 00000018  3C 60 00 00 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha /* 80451368 */
/* 807C7C38 0000001C  38 63 00 00 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l /* 80451368 */
/* 807C7C3C 00000020  80 63 00 00 */	lwz r3, 0(r3)
/* 807C7C40 00000024  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 807C7C44 00000028  38 80 00 01 */	li r4, 1
/* 807C7C48 0000002C  4B FF A9 11 */	bl changeSubBgmStatus__8Z2SeqMgrFl

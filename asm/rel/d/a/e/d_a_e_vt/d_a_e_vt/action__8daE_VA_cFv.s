...
/* 807CC014  4B B9 61 C8 */	b _savegpr_29
/* 807CC018  7C 7E 1B 78 */	mr r30, r3
/* 807CC01C  3C 80 80 7D */	lis r4, lit_3907@ha
/* 807CC020  3B E4 EC A8 */	addi r31, r4, lit_3907@l
...
/* 807CC108  3C 60 80 7D */	lis r3, lit_8207@ha
/* 807CC10C  38 63 F3 30 */	addi r3, r3, lit_8207@l
...
/* 807CC228  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CC22C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CC230  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807CC234  80 03 05 88 */	lwz r0, 0x588(r3)	/* effective address: 80406748 */
/* 807CC238  64 00 02 00 */	oris r0, r0, 0x200
/* 807CC23C  90 03 05 88 */	stw r0, 0x588(r3)	/* effective address: 80406748 */
lbl_807CC240:
/* 807CC240  88 1E 13 8E */	lbz r0, 0x138e(r30)
/* 807CC244  28 00 00 00 */	cmplwi r0, 0
/* 807CC248  40 82 00 24 */	bne lbl_807CC26C
/* 807CC24C  4B 99 31 D8 */	b checkNowWolfEyeUp__9daPy_py_cFv
...
lbl_807CC26C:
/* 807CC26C  4B 99 31 B8 */	b checkNowWolfEyeUp__9daPy_py_cFv
...
/* 807CC290  4B 84 E4 3C */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 807CC294  38 7E 14 F8 */	addi r3, r30, 0x14f8
/* 807CC298  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 807CC29C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 807CC2A0  38 84 0F 38 */	addi r4, r4, 0xf38
/* 807CC2A4  4B 8A A8 08 */	b CrrPos__9dBgS_AcchFR4dBgS
...
lbl_807CC2E0:
/* 807CC2E0  4B 99 31 44 */	b checkNowWolfEyeUp__9daPy_py_cFv
...
/* 807CC2F8  4B AA 44 48 */	b cLib_chaseF__FPfff
...
/* 807CC404  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 807CC408  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l
...
/* 807CC448  4B AA 40 F8 */	b cLib_addCalcAngleS__FPsssss
...
/* 807CC494  4B 86 0B D8 */	b dComIfGp_getReverb__Fi
/* 807CC498  7C 65 1B 78 */	mr r5, r3
/* 807CC49C  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 807CC4A0  38 80 00 00 */	li r4, 0
/* 807CC4A4  4B 84 4C 0C */	b play__16mDoExt_McaMorfSOFUlSc
lbl_807CC4A8:
/* 807CC4A8  80 7E 12 4C */	lwz r3, 0x124c(r30)
/* 807CC4AC  4B 84 0F 7C */	b play__14mDoExt_baseAnmFv
/* 807CC4B0  80 7E 12 50 */	lwz r3, 0x1250(r30)
/* 807CC4B4  4B 84 0F 74 */	b play__14mDoExt_baseAnmFv
/* 807CC4B8  39 61 00 30 */	addi r11, r1, 0x30
/* 807CC4BC  4B B9 5D 6C */	b _restgpr_29

...
/* 807C268C 00000010  4B B9 FB 4C */	b _savegpr_28
...
/* 807C26AC 00000030  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807C26B0 00000034  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807C26B4 00000038  4B B8 3D FC */	b PSMTXCopy
...
/* 807C270C 0000001C  4B 84 A6 58 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 807C2710 00000020  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C2714 00000024  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C2718 00000028  A8 9D 13 0C */	lha r4, 0x130c(r29)
/* 807C271C 0000002C  4B 84 9D 18 */	b mDoMtx_YrotM__FPA4_fs
/* 807C2720 00000030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C2724 00000034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C2728 00000038  A8 9D 13 0E */	lha r4, 0x130e(r29)
/* 807C272C 0000003C  4B 84 9D A0 */	b mDoMtx_ZrotM__FPA4_fs
/* 807C2730 00000040  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C2734 00000044  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 807C2744 00000054  4B 84 9D 88 */	b mDoMtx_ZrotM__FPA4_fs
/* 807C2748 00000058  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C274C 0000005C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C2750 00000060  7C 9D E2 14 */	add r4, r29, r28
/* 807C2754 00000064  A8 84 14 08 */	lha r4, 0x1408(r4)
/* 807C2758 00000068  4B 84 9C DC */	b mDoMtx_YrotM__FPA4_fs
/* 807C275C 0000006C  3C 60 80 7D */	lis r3, l_HIO@ha
/* 807C2760 00000070  38 63 F4 C4 */	addi r3, r3, l_HIO@l
/* 807C2764 00000074  C0 23 00 08 */	lfs f1, 8(r3)	/* effective address: 807CF4CC */
/* 807C2768 00000078  FC 40 08 90 */	fmr f2, f1
/* 807C276C 0000007C  FC 60 08 90 */	fmr f3, f1
/* 807C2770 00000080  4B 84 A6 C8 */	b scaleM__14mDoMtx_stack_cFfff
/* 807C2774 00000084  48 00 00 90 */	b lbl_807C2804
lbl_807C2778:
/* 807C2778 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C277C 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C2780 00000008  A8 9D 13 98 */	lha r4, 0x1398(r29)
/* 807C2784 0000000C  4B 84 9C B0 */	b mDoMtx_YrotM__FPA4_fs
...
/* 807C2794 0000001C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C2798 00000020  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C279C 00000024  A8 9D 13 94 */	lha r4, 0x1394(r29)
/* 807C27A0 00000028  4B 84 9B FC */	b mDoMtx_XrotM__FPA4_fs
/* 807C27A4 0000002C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C27A8 00000030  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C27AC 00000034  A8 9D 13 96 */	lha r4, 0x1396(r29)
/* 807C27B0 00000038  4B 84 9D 1C */	b mDoMtx_ZrotM__FPA4_fs
/* 807C27B4 0000003C  48 00 00 50 */	b lbl_807C2804
lbl_807C27B8:
/* 807C27B8 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C27BC 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C27C0 00000008  A8 9D 13 98 */	lha r4, 0x1398(r29)
/* 807C27C4 0000000C  4B 84 9C 70 */	b mDoMtx_YrotM__FPA4_fs
...
/* 807C27D4 0000001C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C27D8 00000020  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C27DC 00000024  A8 9D 13 94 */	lha r4, 0x1394(r29)
/* 807C27E0 00000028  4B 84 9B BC */	b mDoMtx_XrotM__FPA4_fs
...
/* 807C27F4 0000000C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C27F8 00000010  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C27FC 00000014  A8 9D 13 96 */	lha r4, 0x1396(r29)
/* 807C2800 00000018  4B 84 9C CC */	b mDoMtx_ZrotM__FPA4_fs
lbl_807C2804:
/* 807C2804 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C2808 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 807C2818 00000014  4B B8 3C 98 */	b PSMTXCopy
/* 807C281C 00000018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807C2820 0000001C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807C2824 00000020  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 807C2828 00000024  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 807C282C 00000028  4B B8 3C 84 */	b PSMTXCopy
/* 807C2830 0000002C  38 60 00 01 */	li r3, 1
/* 807C2834 00000030  39 61 00 20 */	addi r11, r1, 0x20
/* 807C2838 00000034  4B B9 F9 EC */	b _restgpr_28

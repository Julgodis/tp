...
/* 807CC4E8  4B B9 5C DC */	b _savegpr_23
/* 807CC4EC  7C 7D 1B 78 */	mr r29, r3
/* 807CC4F0  3C 60 80 7D */	lis r3, lit_3907@ha
/* 807CC4F4  3B E3 EC A8 */	addi r31, r3, lit_3907@l
/* 807CC4F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC4FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC500  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 807CC504  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)
/* 807CC508  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 807CC50C  4B B7 A3 DC */	b PSMTXTrans
/* 807CC510  38 7D 04 E4 */	addi r3, r29, 0x4e4
/* 807CC514  4B 84 0A 30 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 807CC518  C0 3F 00 04 */	lfs f1, 4(r31)
/* 807CC51C  C0 5F 00 CC */	lfs f2, 0xcc(r31)
/* 807CC520  FC 60 08 90 */	fmr f3, f1
/* 807CC524  4B 84 08 78 */	b transM__14mDoMtx_stack_cFfff
/* 807CC528  38 7D 13 04 */	addi r3, r29, 0x1304
/* 807CC52C  4B 84 0A 18 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 807CC530  C0 3F 00 04 */	lfs f1, 4(r31)
/* 807CC534  C0 5F 01 E4 */	lfs f2, 0x1e4(r31)
/* 807CC538  FC 60 08 90 */	fmr f3, f1
/* 807CC53C  4B 84 08 60 */	b transM__14mDoMtx_stack_cFfff
/* 807CC540  3C 60 80 7D */	lis r3, l_HIO@ha
/* 807CC544  3B 03 F4 C4 */	addi r24, r3, l_HIO@l
/* 807CC548  C0 38 00 08 */	lfs f1, 8(r24)	/* effective address: 807CF4CC */
/* 807CC54C  FC 40 08 90 */	fmr f2, f1
/* 807CC550  FC 60 08 90 */	fmr f3, f1
/* 807CC554  4B 84 08 E4 */	b scaleM__14mDoMtx_stack_cFfff
/* 807CC558  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 807CC55C  83 23 00 04 */	lwz r25, 4(r3)
/* 807CC560  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC564  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC568  38 99 00 24 */	addi r4, r25, 0x24
/* 807CC56C  4B B7 9F 44 */	b PSMTXCopy
...
/* 807CC584  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC588  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC58C  38 84 00 24 */	addi r4, r4, 0x24
/* 807CC590  4B B7 9F 20 */	b PSMTXCopy
/* 807CC594  80 7D 05 B8 */	lwz r3, 0x5b8(r29)
/* 807CC598  4B 84 4C 54 */	b modelCalc__16mDoExt_McaMorfSOFv
lbl_807CC59C:
/* 807CC59C  38 00 00 00 */	li r0, 0
/* 807CC5A0  98 1D 13 8B */	stb r0, 0x138b(r29)
/* 807CC5A4  80 7D 05 B4 */	lwz r3, 0x5b4(r29)
/* 807CC5A8  4B 84 4C 44 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 807CC5C0  4B 84 4C 2C */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 807CC5EC  4B B7 9E C4 */	b PSMTXCopy
...
/* 807CC620  4B 84 07 44 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 807CC624  C0 3F 00 04 */	lfs f1, 4(r31)
/* 807CC628  C0 5F 00 B0 */	lfs f2, 0xb0(r31)
/* 807CC62C  FC 60 08 90 */	fmr f3, f1
/* 807CC630  4B 84 07 6C */	b transM__14mDoMtx_stack_cFfff
/* 807CC634  38 7D 12 38 */	addi r3, r29, 0x1238
/* 807CC638  4B 84 09 0C */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 807CC63C  C0 3F 00 04 */	lfs f1, 4(r31)
/* 807CC640  C0 5F 00 B4 */	lfs f2, 0xb4(r31)
/* 807CC644  FC 60 08 90 */	fmr f3, f1
/* 807CC648  4B 84 07 54 */	b transM__14mDoMtx_stack_cFfff
/* 807CC64C  C0 3F 00 04 */	lfs f1, 4(r31)
/* 807CC650  C0 5F 00 B8 */	lfs f2, 0xb8(r31)
/* 807CC654  FC 60 08 90 */	fmr f3, f1
/* 807CC658  4B 84 07 44 */	b transM__14mDoMtx_stack_cFfff
/* 807CC65C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC660  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC664  A8 9D 12 3E */	lha r4, 0x123e(r29)
/* 807CC668  4B 83 FD 34 */	b mDoMtx_XrotM__FPA4_fs
/* 807CC66C  C0 3F 00 04 */	lfs f1, 4(r31)
/* 807CC670  C0 5F 00 BC */	lfs f2, 0xbc(r31)
/* 807CC674  FC 60 08 90 */	fmr f3, f1
/* 807CC678  4B 84 07 24 */	b transM__14mDoMtx_stack_cFfff
/* 807CC67C  C0 38 00 08 */	lfs f1, 8(r24)
/* 807CC680  FC 40 08 90 */	fmr f2, f1
/* 807CC684  FC 60 08 90 */	fmr f3, f1
/* 807CC688  4B 84 07 B0 */	b scaleM__14mDoMtx_stack_cFfff
/* 807CC68C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC690  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC694  80 9D 05 BC */	lwz r4, 0x5bc(r29)
/* 807CC698  38 84 00 24 */	addi r4, r4, 0x24
/* 807CC69C  4B B7 9E 14 */	b PSMTXCopy
...
/* 807CC6B8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CC6BC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CC6C0  4B B7 9D F0 */	b PSMTXCopy
/* 807CC6C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC6C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC6CC  80 9D 05 BC */	lwz r4, 0x5bc(r29)
/* 807CC6D0  38 84 00 24 */	addi r4, r4, 0x24
/* 807CC6D4  4B B7 9D DC */	b PSMTXCopy
/* 807CC6D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC6DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC6E0  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 807CC6E4  D0 1D 12 2C */	stfs f0, 0x122c(r29)
/* 807CC6E8  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 807CC6EC  D0 1D 12 30 */	stfs f0, 0x1230(r29)
/* 807CC6F0  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 807CC704  3C 60 80 7D */	lis r3, data_807CF0AC@ha
/* 807CC708  3B 03 F0 AC */	addi r24, r3, data_807CF0AC@l
/* 807CC70C  3C 60 80 7D */	lis r3, data_807CF0D4@ha
/* 807CC710  3B 23 F0 D4 */	addi r25, r3, data_807CF0D4@l
/* 807CC714  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC718  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l
lbl_807CC71C:
...
/* 807CC788  4B A9 A3 AC */	b __mi__4cXyzCFRC3Vec
...
/* 807CC828  4B B7 9C 88 */	b PSMTXCopy
...
/* 807CC850  4B B9 59 C0 */	b _restgpr_23

...
/* 807CC874  4B B9 59 54 */	b _savegpr_24
/* 807CC878  7C 7F 1B 78 */	mr r31, r3
/* 807CC87C  3C 60 80 7D */	lis r3, lit_3907@ha
/* 807CC880  3B C3 EC A8 */	addi r30, r3, lit_3907@l
...
/* 807CC8A4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CC8A8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CC8AC  4B B7 9C 04 */	b PSMTXCopy
/* 807CC8B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC8B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC8B8  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 807CC8BC  D0 1F 05 38 */	stfs f0, 0x538(r31)
/* 807CC8C0  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 807CC8C4  D0 1F 05 3C */	stfs f0, 0x53c(r31)
/* 807CC8C8  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 807CC910  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CC914  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CC918  4B B7 9B 98 */	b PSMTXCopy
/* 807CC91C  C0 3E 01 E8 */	lfs f1, 0x1e8(r30)
/* 807CC920  C0 5E 01 C8 */	lfs f2, 0x1c8(r30)
/* 807CC924  C0 7E 00 70 */	lfs f3, 0x70(r30)
/* 807CC928  4B 84 04 74 */	b transM__14mDoMtx_stack_cFfff
/* 807CC92C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC930  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 807CC934  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 807CC938  D0 1F 05 38 */	stfs f0, 0x538(r31)
/* 807CC93C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 807CC940  D0 1F 05 3C */	stfs f0, 0x53c(r31)
/* 807CC944  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 807CC988  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CC98C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CC990  4B B7 9B 20 */	b PSMTXCopy
/* 807CC994  C0 3E 00 04 */	lfs f1, 4(r30)
/* 807CC998  C0 5E 00 50 */	lfs f2, 0x50(r30)
/* 807CC99C  FC 60 08 90 */	fmr f3, f1
/* 807CC9A0  4B 84 03 FC */	b transM__14mDoMtx_stack_cFfff
/* 807CC9A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CC9A8  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l
/* 807CC9AC  C0 1D 00 0C */	lfs f0, 0xc(r29)	/* effective address: 803DD47C */
/* 807CC9B0  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 807CC9B4  C0 1D 00 1C */	lfs f0, 0x1c(r29)	/* effective address: 803DD48C */
/* 807CC9B8  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 807CC9BC  C0 1D 00 2C */	lfs f0, 0x2c(r29)	/* effective address: 803DD49C */
/* 807CC9C0  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 807CC9C4  38 7F 1C 9C */	addi r3, r31, 0x1c9c
/* 807CC9C8  38 81 00 20 */	addi r4, r1, 0x20
/* 807CC9CC  4B AA 2C 7C */	b SetC__8cM3dGSphFRC4cXyz
...
/* 807CC9E4  4B AA 2D 24 */	b SetR__8cM3dGSphFf
/* 807CC9E8  48 00 00 10 */	b lbl_807CC9F8
lbl_807CC9EC:
/* 807CC9EC  38 7F 1C 9C */	addi r3, r31, 0x1c9c
/* 807CC9F0  C0 3E 00 70 */	lfs f1, 0x70(r30)
/* 807CC9F4  4B AA 2D 14 */	b SetR__8cM3dGSphFf
lbl_807CC9F8:
/* 807CC9F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CC9FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CCA00  3B 83 23 3C */	addi r28, r3, 0x233c
/* 807CCA04  7F 83 E3 78 */	mr r3, r28
/* 807CCA08  38 9F 1B 78 */	addi r4, r31, 0x1b78
/* 807CCA0C  4B A9 81 9C */	b Set__4cCcSFP8cCcD_Obj
...
/* 807CCA20  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CCA24  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CCA28  4B B7 9A 88 */	b PSMTXCopy
/* 807CCA2C  C0 3E 00 04 */	lfs f1, 4(r30)
/* 807CCA30  FC 40 08 90 */	fmr f2, f1
/* 807CCA34  FC 60 08 90 */	fmr f3, f1
/* 807CCA38  4B 84 03 64 */	b transM__14mDoMtx_stack_cFfff
...
/* 807CCA5C  4B AA 27 80 */	b SetC__8cM3dGCylFRC4cXyz
/* 807CCA60  38 7F 1D D4 */	addi r3, r31, 0x1dd4
/* 807CCA64  C0 3E 01 08 */	lfs f1, 0x108(r30)
/* 807CCA68  4B AA 27 90 */	b SetH__8cM3dGCylFf
...
/* 807CCAB4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CCAB8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CCABC  4B B7 99 F4 */	b PSMTXCopy
...
/* 807CCB28  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CCB2C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CCB30  4B B7 99 80 */	b PSMTXCopy
...
/* 807CCBC0  4B 84 01 DC */	b transM__14mDoMtx_stack_cFfff
...
/* 807CCBEC  4B AA 2A 5C */	b SetC__8cM3dGSphFRC4cXyz
...
/* 807CCC7C  4B AA 29 CC */	b SetC__8cM3dGSphFRC4cXyz
...
/* 807CCCC8  4B AA 29 80 */	b SetC__8cM3dGSphFRC4cXyz
lbl_807CCCCC:
...
/* 807CCCDC  4B AA 2A 2C */	b SetR__8cM3dGSphFf
/* 807CCCE0  7F 83 E3 78 */	mr r3, r28
/* 807CCCE4  38 98 25 44 */	addi r4, r24, 0x2544
/* 807CCCE8  4B A9 7E C0 */	b Set__4cCcSFP8cCcD_Obj
...
/* 807CCD10  4B B9 55 04 */	b _restgpr_24

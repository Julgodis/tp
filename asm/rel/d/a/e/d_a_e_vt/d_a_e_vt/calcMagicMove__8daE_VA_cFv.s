...
/* 807CB8DC  4B B9 68 D0 */	b _savegpr_17
/* 807CB8E0  7C 7E 1B 78 */	mr r30, r3
/* 807CB8E4  3C 60 80 7D */	lis r3, lit_3907@ha
/* 807CB8E8  3B 03 EC A8 */	addi r24, r3, lit_3907@l
/* 807CB8EC  3B E0 00 00 */	li r31, 0
/* 807CB8F0  3B A0 00 00 */	li r29, 0
/* 807CB8F4  3B 80 00 00 */	li r28, 0
/* 807CB8F8  3B 60 00 00 */	li r27, 0
/* 807CB8FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 807CB900  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l
/* 807CB904  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CB908  3B 43 61 C0 */	addi r26, r3, struct_804061C0+0x0@l
...
/* 807CB97C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 807CB980  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 807CB984  4B B7 AB 2C */	b PSMTXCopy
/* 807CB988  C0 38 01 A8 */	lfs f1, 0x1a8(r24)
/* 807CB98C  C0 58 01 DC */	lfs f2, 0x1dc(r24)
/* 807CB990  C0 78 00 AC */	lfs f3, 0xac(r24)
/* 807CB994  4B 84 14 08 */	b transM__14mDoMtx_stack_cFfff
...
/* 807CBA28  4B AA 51 DC */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 807CBA2C  7C 71 1B 78 */	mr r17, r3
/* 807CBA30  7E 83 A3 78 */	mr r3, r20
/* 807CBA34  38 81 00 10 */	addi r4, r1, 0x10
/* 807CBA38  4B AA 52 3C */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 807CBA3C  C0 38 00 70 */	lfs f1, 0x70(r24)
/* 807CBA40  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c
/* 807CBA44  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 807CBA48  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 807CBA98  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 807CBA9C  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 807CBAA0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 807CBAD0  4B AE 0A 3C */	b seStartLevel__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 807CBAF4  4B AA 3B 54 */	b SetC__8cM3dGSphFRC4cXyz
/* 807CBAF8  7E 23 8B 78 */	mr r3, r17
/* 807CBAFC  C0 38 00 70 */	lfs f1, 0x70(r24)
/* 807CBB00  4B AA 3C 08 */	b SetR__8cM3dGSphFf
...
/* 807CBB14  4B A9 90 94 */	b Set__4cCcSFP8cCcD_Obj
...
/* 807CBB34  4B 8B 87 8C */	b ChkAtHit__12dCcD_GObjInfFv
...
/* 807CBB4C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 807CBB50  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 807CBB54  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 807CBB7C  4B AD FE 08 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 807CBBC0  4B B7 B4 D0 */	b PSVECAdd
/* 807CBBC4  38 71 17 50 */	addi r3, r17, 0x1750
/* 807CBBC8  7E C4 B3 78 */	mr r4, r22
/* 807CBBCC  4B 8A AE E0 */	b CrrPos__9dBgS_AcchFR4dBgS
lbl_807CBBD0:
...
/* 807CBBEC  4B B9 66 0C */	b _restgpr_17

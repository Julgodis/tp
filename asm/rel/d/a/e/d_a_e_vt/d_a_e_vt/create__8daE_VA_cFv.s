...
/* 807CD678  4B B9 4B 48 */	b _savegpr_22
/* 807CD67C  7C 7C 1B 78 */	mr r28, r3
/* 807CD680  3C 80 80 7D */	lis r4, cNullVec__6Z2Calc@ha
/* 807CD684  3B E4 EF 08 */	addi r31, r4, cNullVec__6Z2Calc@l
/* 807CD688  3C 80 80 7D */	lis r4, lit_3907@ha
/* 807CD68C  3B C4 EC A8 */	addi r30, r4, lit_3907@l
...
/* 807CD6B8  3C 80 80 7D */	lis r4, stringBase0@ha
/* 807CD6BC  38 84 EE FC */	addi r4, r4, stringBase0@l
/* 807CD6C0  4B 85 F7 FC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 807CD6D4  3C 80 80 7D */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 807CD6D8  38 84 D6 48 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 807CD6DC  3C A0 00 02 */	lis r5, 0x0002 /* 0x000216A0@ha */
/* 807CD6E0  38 A5 16 A0 */	addi r5, r5, 0x16A0 /* 0x000216A0@l */
/* 807CD6E4  4B 84 CD CC */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
lbl_807CD6F8:
/* 807CD6F8  3C 60 80 7D */	lis r3, struct_807CF4B4+0x1@ha
/* 807CD6FC  8C 03 F4 B5 */	lbzu r0, struct_807CF4B4+0x1@l(r3)
...
/* 807CD71C  3C 60 80 7D */	lis r3, l_HIO@ha
/* 807CD720  38 63 F4 C4 */	addi r3, r3, l_HIO@l
/* 807CD724  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 807CF4C8 */
lbl_807CD728:
...
/* 807CD744  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CD748  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CD74C  88 1C 04 E2 */	lbz r0, 0x4e2(r28)
/* 807CD750  7C 05 07 74 */	extsb r5, r0
/* 807CD754  4B 86 7C 0C */	b isSwitch__10dSv_info_cCFii
/* 807CD758  2C 03 00 00 */	cmpwi r3, 0
/* 807CD75C  41 82 00 24 */	beq lbl_807CD780
/* 807CD760  38 00 00 04 */	li r0, 4
/* 807CD764  3C 60 80 43 */	lis r3, g_env_light@ha
/* 807CD768  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 807CD76C  98 03 12 C8 */	stb r0, 0x12c8(r3)	/* effective address: 8042DD1C */
/* 807CD770  98 03 12 C2 */	stb r0, 0x12c2(r3)	/* effective address: 8042DD16 */
/* 807CD774  98 03 12 C3 */	stb r0, 0x12c3(r3)	/* effective address: 8042DD17 */
...
/* 807CD7A0  4B 84 CD 88 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 807CD7B4  4B 84 CD 84 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 807CD7E0  4B 8A 8A 68 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 807CD7E4  38 7C 14 B8 */	addi r3, r28, 0x14b8
/* 807CD7E8  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 807CD7EC  C0 5E 00 30 */	lfs f2, 0x30(r30)
/* 807CD7F0  4B 8A 87 68 */	b SetWall__12dBgS_AcchCirFff
...
/* 807CD83C  4B 8A 8A 0C */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 807CD840  7E E3 BB 78 */	mr r3, r23
/* 807CD844  C0 3E 00 04 */	lfs f1, 4(r30)
/* 807CD848  C0 5E 01 98 */	lfs f2, 0x198(r30)
/* 807CD84C  4B 8A 87 0C */	b SetWall__12dBgS_AcchCirFff
...
/* 807CD884  4B 8B 5F DC */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 807CD888  38 7C 1B 78 */	addi r3, r28, 0x1b78
/* 807CD88C  38 9F 00 38 */	addi r4, r31, 0x38
/* 807CD890  4B 8B 71 A4 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807CD8B0  4B 8B 70 04 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 807CD8E0  4B 8B 71 54 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807CD908  4B 8B 5F 58 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 807CD924  4B 8B 71 10 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807CD948  4B 8B 70 EC */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807CD960  4B 8B 70 D4 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 807CD984  4B AF 37 10 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 807CD988  38 7C 12 54 */	addi r3, r28, 0x1254
/* 807CD98C  3C 80 80 7D */	lis r4, stringBase0@ha
/* 807CD990  38 84 EE FC */	addi r4, r4, stringBase0@l
/* 807CD994  38 84 00 05 */	addi r4, r4, 5
/* 807CD998  4B AF 41 F8 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 807CD9CC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 807CD9D0  3B E3 CA 54 */	addi r31, r3, g_env_light@l
/* 807CD9D4  98 1F 12 C8 */	stb r0, 0x12c8(r31)	/* effective address: 8042DD1C */
/* 807CD9D8  98 1F 12 C2 */	stb r0, 0x12c2(r31)	/* effective address: 8042DD16 */
/* 807CD9DC  98 1F 12 C3 */	stb r0, 0x12c3(r31)	/* effective address: 8042DD17 */
/* 807CD9E0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CD9E4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807CD9E8  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 807CD9EC  C0 23 04 D8 */	lfs f1, 0x4d8(r3)	/* effective address: 80406698 */
...
/* 807CDA00  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 807CDA04  98 83 0C 98 */	stb r4, struct_80450C98+0x0@l(r3)
lbl_807CDA08:
/* 807CDA08  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 807CDA0C  88 03 0C 98 */	lbz r0, struct_80450C98+0x0@l(r3)
...
/* 807CDA24  4B 86 00 78 */	b dComIfGs_onOneZoneSwitch__Fii
/* 807CDA28  38 00 00 00 */	li r0, 0
/* 807CDA2C  3C 60 80 45 */	lis r3, struct_80450C98+0x0@ha
/* 807CDA30  98 03 0C 98 */	stb r0, struct_80450C98+0x0@l(r3)
...
/* 807CDA44  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 807CDA48  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 807CDA4C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 807CDA5C  4B AE 1A 40 */	b subBgmStart__8Z2SeqMgrFUl
/* 807CDA60  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 807CDA64  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 807CDA68  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 807CDA6C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 807CDA70  38 80 00 01 */	li r4, 1
/* 807CDA74  4B AE 43 80 */	b changeSubBgmStatus__8Z2SeqMgrFl
...
/* 807CDAC4  4B B9 47 48 */	b _restgpr_22

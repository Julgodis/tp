...
/* 807CCF74  4B B9 52 64 */	b _savegpr_28
/* 807CCF78  7C 7C 1B 78 */	mr r28, r3
/* 807CCF7C  38 7C 05 AC */	addi r3, r28, 0x5ac
/* 807CCF80  3C 80 80 7D */	lis r4, stringBase0@ha
/* 807CCF84  38 84 EE FC */	addi r4, r4, stringBase0@l
/* 807CCF88  4B 86 00 80 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
...
/* 807CCFA0  3C 60 80 7D */	lis r3, struct_807CF4B4+0x1@ha
/* 807CCFA4  98 03 F4 B5 */	stb r0, struct_807CF4B4+0x1@l(r3)
lbl_807CCFA8:
/* 807CCFA8  3B A0 00 00 */	li r29, 0
/* 807CCFAC  3B E0 00 00 */	li r31, 0
/* 807CCFB0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807CCFB4  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
lbl_807CCFB8:
/* 807CCFB8  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)	/* effective address: 8040BEFC */
...
/* 807CCFCC  4B 87 E9 4C */	b getEmitter__Q213dPa_control_c7level_cFUl
/* 807CCFD0  28 03 00 00 */	cmplwi r3, 0
/* 807CCFD4  41 82 00 08 */	beq lbl_807CCFDC
/* 807CCFD8  4B AB 1C 88 */	b deleteAllParticle__14JPABaseEmitterFv
lbl_807CCFDC:
...
/* 807CD014  4B B9 52 10 */	b _restgpr_28

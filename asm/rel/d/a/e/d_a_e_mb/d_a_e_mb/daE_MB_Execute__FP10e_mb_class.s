...
/* 807076A8  4B C5 AB 28 */	b _savegpr_26
/* 807076AC  7C 7F 1B 78 */	mr r31, r3
/* 807076B0  3C 60 80 71 */	lis r3, lit_1109@ha
/* 807076B4  3B A3 8B F0 */	addi r29, r3, lit_1109@l
/* 807076B8  3C 60 80 71 */	lis r3, lit_3764@ha
/* 807076BC  3B C3 8A 10 */	addi r30, r3, lit_3764@l
/* 807076C0  4B 91 0B E8 */	b cDmrNowMidnaTalk__Fv
...
/* 80707744  4B B5 F3 F0 */	b __mi__4cXyzCFRC3Vec
...
/* 80707764  4B C3 F9 D4 */	b PSVECSquareMag
...
/* 807077D4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807077D8  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80707844  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80707848  C3 E3 0A E0 */	lfs f31, __float_nan@l(r3)
...
/* 80707860  4B B5 F2 D4 */	b __mi__4cXyzCFRC3Vec
...
/* 80707880  4B C3 F8 B8 */	b PSVECSquareMag
...
/* 807078F0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807078F4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80707960  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80707964  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80707968:
...
/* 80707998  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 8070799C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80707A64  4B B6 8B A4 */	b cLib_addCalcAngleS2__FPssss
lbl_80707A68:
/* 80707A68  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707A6C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80707A8C  4B C3 EE 5C */	b PSMTXTrans
/* 80707A90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707A94  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707A98  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80707A9C  4B 90 49 98 */	b mDoMtx_YrotM__FPA4_fs
/* 80707AA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707AA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707AA8  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 80707AAC  4B 90 48 F0 */	b mDoMtx_XrotM__FPA4_fs
/* 80707AB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707AB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707AB8  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 80707ABC  4B 90 4A 10 */	b mDoMtx_ZrotM__FPA4_fs
...
/* 80707AD0  4B 90 53 68 */	b scaleM__14mDoMtx_stack_cFfff
/* 80707AD4  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 80707AD8  80 83 00 04 */	lwz r4, 4(r3)
/* 80707ADC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707AE0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707AE4  38 84 00 24 */	addi r4, r4, 0x24
/* 80707AE8  4B C3 E9 C8 */	b PSMTXCopy
/* 80707AEC  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 80707AF0  7C 03 07 74 */	extsb r3, r0
/* 80707AF4  4B 92 55 78 */	b dComIfGp_getReverb__Fi
/* 80707AF8  7C 65 1B 78 */	mr r5, r3
/* 80707AFC  80 7F 05 C8 */	lwz r3, 0x5c8(r31)
/* 80707B00  38 80 00 00 */	li r4, 0
/* 80707B04  4B 90 95 AC */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 80707B18  4B B5 FE 3C */	b cM_rndF__Ff
...
/* 80707B8C  4B 90 96 60 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 80707BA4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80707BA8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80707BAC  4B C3 E9 04 */	b PSMTXCopy
...
/* 80707BC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707BC4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707BC8  38 81 00 D0 */	addi r4, r1, 0xd0
/* 80707BCC  38 BF 05 DC */	addi r5, r31, 0x5dc
/* 80707BD0  4B C3 F1 9C */	b PSMTXMultVec
...
/* 80707C14  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80707C18  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80707C1C  4B C3 E8 94 */	b PSMTXCopy
/* 80707C20  C0 3E 00 84 */	lfs f1, 0x84(r30)
/* 80707C24  C0 5E 00 88 */	lfs f2, 0x88(r30)
/* 80707C28  C0 7E 00 2C */	lfs f3, 0x2c(r30)
/* 80707C2C  4B 90 51 70 */	b transM__14mDoMtx_stack_cFfff
/* 80707C30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707C34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707C38  38 80 FE 0C */	li r4, -500
/* 80707C3C  4B 90 47 60 */	b mDoMtx_XrotM__FPA4_fs
/* 80707C40  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707C44  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707C48  38 80 50 14 */	li r4, 0x5014
/* 80707C4C  4B 90 48 80 */	b mDoMtx_ZrotM__FPA4_fs
/* 80707C50  80 7F 06 90 */	lwz r3, 0x690(r31)
/* 80707C54  80 83 00 04 */	lwz r4, 4(r3)
/* 80707C58  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707C5C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707C60  38 84 00 24 */	addi r4, r4, 0x24
/* 80707C64  4B C3 E8 4C */	b PSMTXCopy
/* 80707C68  80 7F 06 90 */	lwz r3, 0x690(r31)
/* 80707C6C  4B 90 8A 40 */	b modelCalc__14mDoExt_McaMorfFv
/* 80707C70  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707C74  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707C78  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80707C7C  D0 01 00 C4 */	stfs f0, 0xc4(r1)
/* 80707C80  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80707C84  D0 01 00 C8 */	stfs f0, 0xc8(r1)
/* 80707C88  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80707C8C  D0 01 00 CC */	stfs f0, 0xcc(r1)
/* 80707C90  38 7F 08 54 */	addi r3, r31, 0x854
/* 80707C94  38 81 00 C4 */	addi r4, r1, 0xc4
/* 80707C98  4B B6 79 B0 */	b SetC__8cM3dGSphFRC4cXyz
/* 80707C9C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80707CA0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80707CA4  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
...
/* 80707CE8  4B 97 C7 78 */	b ChkTgHit__12dCcD_GObjInfFv
...
/* 80707D00  4B 97 C7 F8 */	b GetTgHitObj__12dCcD_GObjInfFv
/* 80707D04  90 7F 08 68 */	stw r3, 0x868(r31)
/* 80707D08  7F E3 FB 78 */	mr r3, r31
/* 80707D0C  38 9F 08 68 */	addi r4, r31, 0x868
/* 80707D10  4B 97 FE F4 */	b cc_at_check__FP10fopAc_ac_cP11dCcU_AtInfo
...
/* 80707D50  4B 91 20 B4 */	b fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv
...
/* 80707D88  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80707D8C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80707D90  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80707D94  4B 91 29 7C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
/* 80707D98  7C 64 1B 78 */	mr r4, r3
/* 80707D9C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80707DA0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80707DA4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80707DA8  4B 90 46 34 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80707DFC  4B 90 87 CC */	b play__14mDoExt_McaMorfFP3VecUlSc
...
/* 80707E14  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80707E18  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80707E1C  4B C3 E6 94 */	b PSMTXCopy
/* 80707E20  80 7F 06 94 */	lwz r3, 0x694(r31)
/* 80707E24  80 83 00 04 */	lwz r4, 4(r3)
/* 80707E28  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80707E2C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80707E30  38 84 00 24 */	addi r4, r4, 0x24
/* 80707E34  4B C3 E6 7C */	b PSMTXCopy
/* 80707E38  80 7F 06 94 */	lwz r3, 0x694(r31)
/* 80707E3C  4B 90 88 70 */	b modelCalc__14mDoExt_McaMorfFv
...
/* 80707E60  4B B6 77 E8 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 80707ED8  4B B6 77 70 */	b SetC__8cM3dGSphFRC4cXyz
lbl_80707EDC:
/* 80707EDC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80707EE0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80707EE4  38 63 23 3C */	addi r3, r3, 0x233c
/* 80707EE8  38 9F 07 30 */	addi r4, r31, 0x730
/* 80707EEC  4B B5 CC BC */	b Set__4cCcSFP8cCcD_Obj
...
/* 80707FA8  4B B5 EB 8C */	b __mi__4cXyzCFRC3Vec
...
/* 80707FD0  4B B6 7A B0 */	b cLib_addCalc0__FPfff
...
/* 80707FF0  4B B5 EB 44 */	b __mi__4cXyzCFRC3Vec
...
/* 8070801C  4B B5 EB 18 */	b __mi__4cXyzCFRC3Vec
...
/* 80708070  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80708074  3B A3 9A 20 */	addi r29, r3, sincosTable___5JMath@l
lbl_80708078:
...
/* 80708134  4B C5 A0 E8 */	b _restgpr_26

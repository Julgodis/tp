...
/* 8076D014  4B BF 51 C0 */	b _savegpr_27
/* 8076D018  7C 7F 1B 78 */	mr r31, r3
/* 8076D01C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8076D020  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 8076D024  88 1D 4F AD */	lbz r0, 0x4fad(r29)	/* effective address: 8040B16D */
...
/* 8076D03C  3C 60 80 78 */	lis r3, S_find@ha
/* 8076D040  A8 03 A8 D4 */	lha r0, S_find@l(r3)
/* 8076D044  2C 00 00 00 */	cmpwi r0, 0
/* 8076D048  41 82 00 0C */	beq lbl_8076D054
/* 8076D04C  3C 60 80 78 */	lis r3, lit_4663@ha
/* 8076D050  C0 23 9E 88 */	lfs f1, lit_4663@l(r3)
lbl_8076D054:
...
/* 8076D0BC  4B 91 75 9C */	b ChkCoHit__12dCcD_GObjInfFv
/* 8076D0C0  28 03 00 00 */	cmplwi r3, 0
/* 8076D0C4  41 82 00 24 */	beq lbl_8076D0E8
/* 8076D0C8  7F 83 E3 78 */	mr r3, r28
/* 8076D0CC  4B 91 76 24 */	b GetCoHitObj__12dCcD_GObjInfFv
/* 8076D0D0  4B AF 69 78 */	b GetAc__8cCcD_ObjFv
...
/* 8076D100  4B BF 51 20 */	b _restgpr_27

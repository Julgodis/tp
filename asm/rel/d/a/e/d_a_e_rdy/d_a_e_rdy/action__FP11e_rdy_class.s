...
/* 8077425C  4B BE DF 6C */	b _savegpr_24
/* 80774260  7C 7F 1B 78 */	mr r31, r3
/* 80774264  3C 80 80 78 */	lis r4, lit_4018@ha
/* 80774268  3B C4 9D FC */	addi r30, r4, lit_4018@l
/* 8077426C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80774270  3B 24 61 C0 */	addi r25, r4, struct_804061C0+0x0@l
/* 80774274  83 99 5D AC */	lwz r28, 0x5dac(r25)	/* effective address: 8040BF6C */
/* 80774278  38 00 00 00 */	li r0, 0
/* 8077427C  98 03 0A 98 */	stb r0, 0xa98(r3)
/* 80774280  80 99 5D AC */	lwz r4, 0x5dac(r25)	/* effective address: 8040BF6C */
/* 80774284  4B 8A 65 5C */	b fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 807742C0  4B 8A 64 50 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80774320  3C 60 80 78 */	lis r3, lit_7918@ha
/* 80774324  38 63 A3 64 */	addi r3, r3, lit_7918@l
...
/* 8077446C  4B A3 40 08 */	b dKy_Sound_get__Fv
...
/* 807744AC  4B AF 26 88 */	b __mi__4cXyzCFRC3Vec
...
/* 807744CC  4B BD 2C 6C */	b PSVECSquareMag
...
/* 8077453C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80774540  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 807745AC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 807745B0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_807745B4:
...
/* 807745FC  3C 60 80 78 */	lis r3, S_find_pos@ha
/* 80774600  D4 03 A8 E4 */	stfsu f0, S_find_pos@l(r3)
/* 80774604  C0 1A 00 04 */	lfs f0, 4(r26)
/* 80774608  D0 03 00 04 */	stfs f0, 4(r3)	/* effective address: 80780004 */
/* 8077460C  C0 1A 00 08 */	lfs f0, 8(r26)
/* 80774610  D0 03 00 08 */	stfs f0, 8(r3)	/* effective address: 80780008 */
lbl_80774614:
/* 80774614  7F 60 07 75 */	extsb. r0, r27
/* 80774618  41 82 00 88 */	beq lbl_807746A0
/* 8077461C  38 61 02 00 */	addi r3, r1, 0x200
/* 80774620  4B 90 31 90 */	b __ct__18dBgS_ObjGndChk_SplFv
...
/* 80774650  4B AF 36 D8 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 80774654  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80774658  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8077465C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80774660  38 81 02 00 */	addi r4, r1, 0x200
/* 80774664  4B 8F FE 3C */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 8077469C  4B 90 31 AC */	b __dt__18dBgS_ObjGndChk_SplFv
lbl_807746A0:
...
/* 807746B0  4B B4 D4 CC */	b setLinkSearch__15Z2CreatureEnemyFb
/* 807746B4  48 00 00 10 */	b lbl_807746C4
lbl_807746B8:
/* 807746B8  38 7F 05 D0 */	addi r3, r31, 0x5d0
/* 807746BC  38 80 00 00 */	li r4, 0
/* 807746C0  4B B4 D4 BC */	b setLinkSearch__15Z2CreatureEnemyFb
lbl_807746C4:
...
/* 807746D4  4B AF BF 34 */	b cLib_addCalcAngleS2__FPssss
...
/* 807746E8  4B AF BF 20 */	b cLib_addCalcAngleS2__FPssss
...
/* 807746FC  4B AF BF 0C */	b cLib_addCalcAngleS2__FPssss
...
/* 80774724  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80774728  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8077472C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80774730  A8 9F 0A DE */	lha r4, 0xade(r31)
/* 80774734  4B 89 7C A8 */	b mDoMtx_YrotS__FPA4_fs
...
lbl_8077475C:
/* 8077475C  3C 60 80 78 */	lis r3, l_HIO@ha
/* 80774760  38 63 A8 84 */	addi r3, r3, l_HIO@l
/* 80774764  C0 23 00 40 */	lfs f1, 0x40(r3)	/* effective address: 8077A8C4 */
...
lbl_8077477C:
/* 8077477C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80774780  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80774784  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80774788  A8 9F 04 DE */	lha r4, 0x4de(r31)
/* 8077478C  4B 89 7C 50 */	b mDoMtx_YrotS__FPA4_fs
...
/* 807747B4  4B AF C7 38 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807747D4  4B BD 28 BC */	b PSVECAdd
...
/* 8077483C  4B AF B2 44 */	b cLib_addCalc0__FPfff
...
/* 80774864  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80774868  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8077486C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80774870  A8 9F 0A C4 */	lha r4, 0xac4(r31)
/* 80774874  4B 89 7B 68 */	b mDoMtx_YrotS__FPA4_fs
/* 80774878  38 61 00 DC */	addi r3, r1, 0xdc
/* 8077487C  38 81 00 D0 */	addi r4, r1, 0xd0
/* 80774880  4B AF C6 6C */	b MtxPosition__FP4cXyzP4cXyz
/* 80774884  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 80774888  38 81 00 D0 */	addi r4, r1, 0xd0
/* 8077488C  7C 65 1B 78 */	mr r5, r3
/* 80774890  4B BD 28 00 */	b PSVECAdd
/* 80774894  38 7F 0A C0 */	addi r3, r31, 0xac0
/* 80774898  C0 3E 00 08 */	lfs f1, 8(r30)
/* 8077489C  C0 5E 00 AC */	lfs f2, 0xac(r30)
/* 807748A0  4B AF B1 E0 */	b cLib_addCalc0__FPfff
/* 807748A4  48 00 03 40 */	b lbl_80774BE4
lbl_807748A8:
/* 807748A8  80 1F 0A 5C */	lwz r0, 0xa5c(r31)
/* 807748AC  90 01 00 28 */	stw r0, 0x28(r1)
/* 807748B0  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 807748B4  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 807748B8  38 81 00 28 */	addi r4, r1, 0x28
/* 807748BC  4B 8A 4F 3C */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80774904  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80774908  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8077490C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80774910  4B BD 1B A0 */	b PSMTXCopy
...
/* 80774934  4B AF C5 B8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 807749B4  4B AF 21 80 */	b __mi__4cXyzCFRC3Vec
...
/* 807749D0  4B AF 2C A4 */	b cM_atan2s__Fff
/* 807749D4  7C 64 1B 78 */	mr r4, r3
/* 807749D8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807749DC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 807749E0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 807749E4  4B 89 79 F8 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80774A14  4B AF 2C 60 */	b cM_atan2s__Fff
/* 80774A18  7C 03 00 D0 */	neg r0, r3
/* 80774A1C  7C 04 07 34 */	extsh r4, r0
/* 80774A20  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80774A24  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80774A28  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80774A2C  4B 89 79 70 */	b mDoMtx_XrotM__FPA4_fs
...
/* 80774A8C  4B BD 26 AC */	b PSVECSquareMag
...
/* 80774AFC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80774B00  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80774B6C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80774B70  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80774B74:
...
/* 80774BA4  4B AF BA 64 */	b cLib_addCalcAngleS2__FPssss
lbl_80774BA8:
...
lbl_80774C0C:
/* 80774C0C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 80774C10  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80774C14  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80774C18  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80774C1C  4B 89 77 C0 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80774CEC  4B AF 1E 48 */	b __mi__4cXyzCFRC3Vec
...
/* 80774D14  4B AF 29 60 */	b cM_atan2s__Fff
...
/* 80774D50  4B AF 29 24 */	b cM_atan2s__Fff
...
/* 80774DB8  4B AF B8 50 */	b cLib_addCalcAngleS2__FPssss
...
/* 80774DD8  4B AF 2C F4 */	b cM_rndF2__Ff
...
/* 80774DEC  4B AF 2D 18 */	b cM_rndFX2__Ff
...
/* 80774E4C  4B AF B7 BC */	b cLib_addCalcAngleS2__FPssss
...
/* 80774E7C  4B AF 27 F8 */	b cM_atan2s__Fff
...
/* 80774EC8  4B AF B7 40 */	b cLib_addCalcAngleS2__FPssss
...
/* 80774EE4  4B AF B7 24 */	b cLib_addCalcAngleS2__FPssss
...
/* 80774EF8  4B AF B7 10 */	b cLib_addCalcAngleS2__FPssss
...
/* 80774F14  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80774F18  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80774F60  4B AF AB 20 */	b cLib_addCalc0__FPfff
...
/* 80774F88  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80774F8C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80774FC4  4B AF AA BC */	b cLib_addCalc0__FPfff
...
lbl_807750E8:
/* 807750E8  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 807750EC  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 807750F0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 807750F4  4B 89 72 E8 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80775114  4B AF BD D8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80775174  3C 60 80 78 */	lis r3, data_8077A344@ha
/* 80775178  3B A3 A3 44 */	addi r29, r3, data_8077A344@l
lbl_8077517C:
...
/* 80775190  4B AF B4 78 */	b cLib_addCalcAngleS2__FPssss
...
/* 807751A4  4B AF B4 64 */	b cLib_addCalcAngleS2__FPssss
...
/* 807751B8  4B AF B4 50 */	b cLib_addCalcAngleS2__FPssss
...
/* 80775210  4B AF B3 F8 */	b cLib_addCalcAngleS2__FPssss
...
/* 80775244  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80775248  38 03 9A 20 */	addi r0, r3, sincosTable___5JMath@l
...
/* 80775294  4B AF A7 EC */	b cLib_addCalc0__FPfff
...
/* 807752A8  4B AF B3 60 */	b cLib_addCalcAngleS2__FPssss
...
/* 807752BC  4B AF B3 4C */	b cLib_addCalcAngleS2__FPssss
...
/* 807752F8  4B 90 22 84 */	b __ct__11dBgS_GndChkFv
...
/* 80775310  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80775314  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80775318  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8077531C  4B BD 11 94 */	b PSMTXCopy
...
/* 80775338  4B AF BB B4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8077535C  4B AF 29 CC */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 80775360  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80775364  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80775368  3B 03 0F 38 */	addi r24, r3, 0xf38
/* 8077536C  7F 03 C3 78 */	mr r3, r24
/* 80775370  38 81 01 AC */	addi r4, r1, 0x1ac
/* 80775374  4B 8F F1 2C */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807753B8  4B AF 29 54 */	b SetPos__11cBgS_GndChkFPC3Vec
/* 807753BC  7F 03 C3 78 */	mr r3, r24
/* 807753C0  38 81 01 AC */	addi r4, r1, 0x1ac
/* 807753C4  4B 8F F0 DC */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 807753F0  4B AF 22 84 */	b cM_atan2s__Fff
...
/* 80775440  4B AF 28 CC */	b SetPos__11cBgS_GndChkFPC3Vec
/* 80775444  7F 03 C3 78 */	mr r3, r24
/* 80775448  38 81 01 AC */	addi r4, r1, 0x1ac
/* 8077544C  4B 8F F0 54 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80775478  4B AF 21 FC */	b cM_atan2s__Fff
...
/* 80775498  4B 90 27 D0 */	b __ct__11dBgS_LinChkFv
...
/* 807754E4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 807754E8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 807754EC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 807754F0  4B BD 0F C0 */	b PSMTXCopy
/* 807754F4  38 61 00 A0 */	addi r3, r1, 0xa0
/* 807754F8  38 81 00 88 */	addi r4, r1, 0x88
/* 807754FC  4B AF B9 F0 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80775520  4B 90 28 44 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 80775524  7F 03 C3 78 */	mr r3, r24
/* 80775528  38 81 01 3C */	addi r4, r1, 0x13c
/* 8077552C  4B 8F EE 88 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 80775544  4B AF 15 F0 */	b __mi__4cXyzCFRC3Vec
...
/* 80775560  4B AF 21 14 */	b cM_atan2s__Fff
/* 80775564  7C 64 1B 78 */	mr r4, r3
/* 80775568  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8077556C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 80775570  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 80775574  4B 89 6E 68 */	b mDoMtx_YrotS__FPA4_fs
...
/* 807755B8  4B 90 27 24 */	b __dt__11dBgS_LinChkFv
/* 807755BC  38 61 01 AC */	addi r3, r1, 0x1ac
/* 807755C0  38 80 FF FF */	li r4, -1
/* 807755C4  4B 90 20 2C */	b __dt__11dBgS_GndChkFv
lbl_807755C8:
...
/* 807755D8  4B AF B0 30 */	b cLib_addCalcAngleS2__FPssss
...
/* 807755EC  4B AF B0 1C */	b cLib_addCalcAngleS2__FPssss
...
/* 80775610  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80775614  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80775618  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 80775658  4B 8D 74 38 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
lbl_8077565C:
...
/* 8077567C  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80775680  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80775684  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80775688  4B BD 0E 28 */	b PSMTXCopy
...
/* 807756A4  4B AF B8 48 */	b MtxPosition__FP4cXyzP4cXyz
/* 807756A8  38 61 00 E8 */	addi r3, r1, 0xe8
/* 807756AC  4B 90 21 04 */	b __ct__18dBgS_ObjGndChk_SplFv
...
/* 807756DC  4B AF 26 4C */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 807756E0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 807756E4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 807756E8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 807756EC  38 81 00 E8 */	addi r4, r1, 0xe8
/* 807756F0  4B 8F ED B0 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 80775730  4B AF 1C C4 */	b __ct__5csXyzFsss
/* 80775734  3B A0 00 00 */	li r29, 0
/* 80775738  3B 40 00 00 */	li r26, 0
/* 8077573C  3B 60 00 00 */	li r27, 0
/* 80775740  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80775744  3B 83 61 C0 */	addi r28, r3, struct_804061C0+0x0@l
/* 80775748  3C 60 80 78 */	lis r3, data_8077A35C@ha
/* 8077574C  3B 23 A3 5C */	addi r25, r3, data_8077A35C@l
lbl_80775750:
/* 80775750  80 7C 5D 3C */	lwz r3, 0x5d3c(r28)	/* effective address: 8040BEFC */
...
/* 8077579C  4B 8D 7D 30 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 807757D8  4B 8A 78 48 */	b fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
lbl_807757DC:
...
/* 807757EC  4B 90 20 5C */	b __dt__18dBgS_ObjGndChk_SplFv
lbl_807757F0:
...
/* 80775818  4B BE C9 FC */	b _restgpr_24

...
/* 8076B008  4B BF 71 AC */	b _savegpr_19
/* 8076B00C  7C 7E 1B 78 */	mr r30, r3
/* 8076B010  7C 9A 23 78 */	mr r26, r4
/* 8076B014  7C BB 2B 78 */	mr r27, r5
/* 8076B018  7C DC 33 78 */	mr r28, r6
/* 8076B01C  3C 60 80 77 */	lis r3, cNullVec__6Z2Calc@ha
/* 8076B020  3A E3 B6 F8 */	addi r23, r3, cNullVec__6Z2Calc@l
/* 8076B024  3C 60 80 77 */	lis r3, lit_4007@ha
/* 8076B028  3B E3 B4 5C */	addi r31, r3, lit_4007@l
/* 8076B02C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8076B030  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8076B034  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8076B038  3C 80 80 45 */	lis r4, m_midnaActor__9daPy_py_c@ha
/* 8076B03C  80 04 10 18 */	lwz r0, m_midnaActor__9daPy_py_c@l(r4)
...
/* 8076B064  4B A4 15 18 */	b dKy_darkworld_check__Fv
...
/* 8076B088  3C 60 80 45 */	lis r3, m_midnaActor__9daPy_py_c@ha
/* 8076B08C  38 63 10 18 */	addi r3, r3, m_midnaActor__9daPy_py_c@l
/* 8076B090  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451018 */
/* 8076B094  80 63 05 74 */	lwz r3, 0x574(r3)	/* effective address: 8045158C */
/* 8076B098  80 63 00 84 */	lwz r3, 0x84(r3)	/* effective address: 8045109C */
/* 8076B09C  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 80451024 */
/* 8076B0A0  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 8076B0A4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8076B0A8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8076B0AC  4B BD B4 04 */	b PSMTXCopy
...
/* 8076B0C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8076B0C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8076B0CC  38 81 00 4C */	addi r4, r1, 0x4c
/* 8076B0D0  38 A1 00 58 */	addi r5, r1, 0x58
/* 8076B0D4  4B BD BC 98 */	b PSMTXMultVec
/* 8076B0D8  38 61 00 34 */	addi r3, r1, 0x34
/* 8076B0DC  38 81 00 58 */	addi r4, r1, 0x58
/* 8076B0E0  7F 65 DB 78 */	mr r5, r27
/* 8076B0E4  4B AF BA 50 */	b __mi__4cXyzCFRC3Vec
...
/* 8076B100  4B AF C5 74 */	b cM_atan2s__Fff
...
/* 8076B134  4B AF C5 40 */	b cM_atan2s__Fff
...
/* 8076B150  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8076B154  3B 03 61 C0 */	addi r24, r3, struct_804061C0+0x0@l
/* 8076B158  80 78 5D 3C */	lwz r3, 0x5d3c(r24)	/* effective address: 8040BEFC */
...
/* 8076B1A4  4B 8E 18 EC */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
/* 8076B1A8  7C 79 1B 79 */	or. r25, r3, r3
/* 8076B1AC  41 82 00 FC */	beq lbl_8076B2A8
/* 8076B1B0  38 61 00 40 */	addi r3, r1, 0x40
/* 8076B1B4  4B BD BF 84 */	b PSVECSquareMag
...
/* 8076B224  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8076B228  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8076B294  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8076B298  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8076B29C:
...
/* 8076B2EC  4B 8E 17 A4 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8076B328  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8076B32C  3B 23 61 C0 */	addi r25, r3, struct_804061C0+0x0@l
...
/* 8076B358  80 79 5D 3C */	lwz r3, 0x5d3c(r25)	/* effective address: 8040BEFC */
...
/* 8076B398  4B 8E 21 34 */	b set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8076B3F8  4B BF 6E 08 */	b _restgpr_19

...
/* 806EFC28  4B C7 25 B0 */	b _savegpr_28
/* 806EFC2C  7C 7F 1B 78 */	mr r31, r3
/* 806EFC30  3C 80 80 6F */	lis r4, lit_3966@ha
/* 806EFC34  3B C4 08 60 */	addi r30, r4, lit_3966@l
...
/* 806EFC50  4B 92 8F 14 */	b __ct__10fopAc_ac_cFv
/* 806EFC54  38 7C 05 C8 */	addi r3, r28, 0x5c8
/* 806EFC58  4B BD 13 0C */	b __ct__15Z2CreatureEnemyFv
/* 806EFC5C  3B BC 06 F8 */	addi r29, r28, 0x6f8
/* 806EFC60  7F A3 EB 78 */	mr r3, r29
/* 806EFC64  3C 80 80 3A */	lis r4, j3dDefaultLightInfo@ha
/* 806EFC68  38 84 1E C8 */	addi r4, r4, j3dDefaultLightInfo@l
/* 806EFC6C  4B C3 5A 58 */	b __as__12J3DLightInfoFRC12J3DLightInfo
/* 806EFC70  38 7D 00 74 */	addi r3, r29, 0x74
/* 806EFC74  3C 80 80 6F */	lis r4, __ct__11J3DLightObjFv@ha
/* 806EFC78  38 84 02 C8 */	addi r4, r4, __ct__11J3DLightObjFv@l
/* 806EFC7C  38 A0 00 00 */	li r5, 0
/* 806EFC80  38 C0 00 74 */	li r6, 0x74
/* 806EFC84  38 E0 00 06 */	li r7, 6
/* 806EFC88  4B C7 20 D8 */	b __construct_array
/* 806EFC8C  38 7C 0A B8 */	addi r3, r28, 0xab8
/* 806EFC90  4B 98 62 1C */	b __ct__12dBgS_AcchCirFv
/* 806EFC94  3B BC 0A F8 */	addi r29, r28, 0xaf8
/* 806EFC98  7F A3 EB 78 */	mr r3, r29
/* 806EFC9C  4B 98 64 04 */	b __ct__9dBgS_AcchFv
/* 806EFCA0  3C 60 80 6F */	lis r3, __vt__12dBgS_ObjAcch@ha
/* 806EFCA4  38 63 0A F4 */	addi r3, r3, __vt__12dBgS_ObjAcch@l
...
/* 806EFCC0  4B 98 91 A8 */	b SetObj__16dBgS_PolyPassChkFv
/* 806EFCC4  3C 60 80 3C */	lis r3, __vt__9cCcD_Stts@ha
/* 806EFCC8  38 03 37 28 */	addi r0, r3, __vt__9cCcD_Stts@l
/* 806EFCCC  90 1C 0C E8 */	stw r0, 0xce8(r28)
/* 806EFCD0  38 7C 0C EC */	addi r3, r28, 0xcec
/* 806EFCD4  4B 99 3A 8C */	b __ct__10dCcD_GSttsFv
/* 806EFCD8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 806EFCDC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 806EFCF0  3C 80 80 6F */	lis r4, __ct__8dCcD_SphFv@ha
/* 806EFCF4  38 84 00 78 */	addi r4, r4, __ct__8dCcD_SphFv@l
/* 806EFCF8  3C A0 80 6F */	lis r5, __dt__8dCcD_SphFv@ha
/* 806EFCFC  38 A5 FF AC */	addi r5, r5, __dt__8dCcD_SphFv@l
/* 806EFD00  38 C0 01 38 */	li r6, 0x138
/* 806EFD04  38 E0 00 04 */	li r7, 4
/* 806EFD08  4B C7 20 58 */	b __construct_array
lbl_806EFD0C:
...
/* 806EFD24  4B AB 8B C8 */	b dKy_tevstr_init__FP12dKy_tevstr_cScUc
/* 806EFD28  38 7F 05 AC */	addi r3, r31, 0x5ac
/* 806EFD2C  3C 80 80 6F */	lis r4, stringBase0@ha
/* 806EFD30  38 84 09 5C */	addi r4, r4, stringBase0@l
/* 806EFD34  4B 93 D1 88 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806EFD54  3C 60 80 6F */	lis r3, stringBase0@ha
/* 806EFD58  38 63 09 5C */	addi r3, r3, stringBase0@l
/* 806EFD5C  38 03 00 0B */	addi r0, r3, 0xb
/* 806EFD60  90 1F 06 BC */	stw r0, 0x6bc(r31)
/* 806EFD64  48 00 00 14 */	b lbl_806EFD78
lbl_806EFD68:
/* 806EFD68  3C 60 80 6F */	lis r3, stringBase0@ha
/* 806EFD6C  38 63 09 5C */	addi r3, r3, stringBase0@l
...
/* 806EFD80  4B 93 D1 3C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 806EFD94  3C 80 80 6F */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 806EFD98  38 84 FB 34 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 806EFD9C  38 A0 2C 20 */	li r5, 0x2c20
/* 806EFDA0  4B 92 A7 10 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 806EFDC0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806EFDC4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806EFDC8  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806EFDCC  7F E5 FB 78 */	mr r5, r31
/* 806EFDD0  4B 98 4C 38 */	b Regist__4dBgSFP9dBgW_BaseP10fopAc_ac_c
...
lbl_806EFDE4:
/* 806EFDE4  3C 60 80 6F */	lis r3, struct_806F0B6C+0x1@ha
/* 806EFDE8  8C 03 0B 6D */	lbzu r0, struct_806F0B6C+0x1@l(r3)
...
/* 806EFE04  3C 60 80 6F */	lis r3, l_HIO@ha
/* 806EFE08  38 63 0B 7C */	addi r3, r3, l_HIO@l
/* 806EFE0C  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 806F0B80 */
lbl_806EFE10:
...
/* 806EFE30  4B 92 A6 F8 */	b fopAcM_SetMin__FP10fopAc_ac_cfff
...
/* 806EFE44  4B 92 A6 F4 */	b fopAcM_SetMax__FP10fopAc_ac_cfff
...
/* 806EFE70  4B 98 63 D8 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 806EFE74  38 7F 0A B8 */	addi r3, r31, 0xab8
/* 806EFE78  C0 3E 00 50 */	lfs f1, 0x50(r30)
/* 806EFE7C  C0 5E 00 E8 */	lfs f2, 0xe8(r30)
/* 806EFE80  4B 98 60 D8 */	b SetWall__12dBgS_AcchCirFff
...
/* 806EFEA0  4B 99 39 C0 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 806EFEA4  38 7F 0D 0C */	addi r3, r31, 0xd0c
/* 806EFEA8  3C 80 80 6F */	lis r4, data_806F09E8@ha
/* 806EFEAC  38 84 09 E8 */	addi r4, r4, data_806F09E8@l
/* 806EFEB0  4B 99 4B 84 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
/* 806EFEB4  38 7F 0E 44 */	addi r3, r31, 0xe44
/* 806EFEB8  3C 80 80 6F */	lis r4, data_806F0A28@ha
/* 806EFEBC  38 84 0A 28 */	addi r4, r4, data_806F0A28@l
/* 806EFEC0  4B 99 4B 74 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
/* 806EFEC4  38 7F 0F 7C */	addi r3, r31, 0xf7c
/* 806EFEC8  3C 80 80 6F */	lis r4, data_806F0A28@ha
/* 806EFECC  38 84 0A 28 */	addi r4, r4, data_806F0A28@l
/* 806EFED0  4B 99 4B 64 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
/* 806EFED4  38 7F 10 B4 */	addi r3, r31, 0x10b4
/* 806EFED8  3C 80 80 6F */	lis r4, data_806F0A28@ha
/* 806EFEDC  38 84 0A 28 */	addi r4, r4, data_806F0A28@l
/* 806EFEE0  4B 99 4B 54 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 806EFF14  4B BD 11 80 */	b init__15Z2CreatureEnemyFP3VecP3VecUcUc
/* 806EFF18  38 7F 05 C8 */	addi r3, r31, 0x5c8
/* 806EFF1C  3C 80 80 6F */	lis r4, stringBase0@ha
/* 806EFF20  38 84 09 5C */	addi r4, r4, stringBase0@l
/* 806EFF24  38 84 00 12 */	addi r4, r4, 0x12
/* 806EFF28  4B BD 1C 68 */	b setEnemyName__15Z2CreatureEnemyFPCc
...
/* 806EFF58  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806EFF5C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806EFF60  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 806EFF64  7C 05 07 74 */	extsb r5, r0
/* 806EFF68  4B 94 53 F8 */	b isSwitch__10dSv_info_cCFii
...
/* 806EFF98  4B C7 22 8C */	b _restgpr_28

...
/* 806EF154  4B C7 30 88 */	b _savegpr_29
/* 806EF158  7C 7E 1B 78 */	mr r30, r3
/* 806EF15C  3C 60 80 6F */	lis r3, lit_3966@ha
/* 806EF160  3B E3 08 60 */	addi r31, r3, lit_3966@l
/* 806EF164  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
...
/* 806EF1E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806EF1E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806EF1EC  38 9D 00 24 */	addi r4, r29, 0x24
/* 806EF1F0  4B C5 72 C0 */	b PSMTXCopy
/* 806EF1F4  80 7E 05 BC */	lwz r3, 0x5bc(r30)
/* 806EF1F8  4B 92 1F F4 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 806EF214  4B C5 72 9C */	b PSMTXCopy
...
/* 806EF248  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806EF24C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806EF250  4B C5 72 60 */	b PSMTXCopy
/* 806EF254  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806EF258  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806EF25C  38 80 C0 00 */	li r4, -16384
/* 806EF260  4B 91 D2 6C */	b mDoMtx_ZrotM__FPA4_fs
/* 806EF264  C0 3F 00 04 */	lfs f1, 4(r31)
/* 806EF268  C0 5F 00 A8 */	lfs f2, 0xa8(r31)
/* 806EF26C  FC 60 08 90 */	fmr f3, f1
/* 806EF270  4B 91 DB 2C */	b transM__14mDoMtx_stack_cFfff
/* 806EF274  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806EF278  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806EF27C  38 9E 0A 84 */	addi r4, r30, 0xa84
/* 806EF280  4B C5 72 30 */	b PSMTXCopy
/* 806EF284  48 00 00 1C */	b lbl_806EF2A0
lbl_806EF288:
/* 806EF288  38 7E 04 A8 */	addi r3, r30, 0x4a8
/* 806EF28C  4B 91 DA D8 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 806EF290  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806EF294  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 806EF298  38 9E 0A 84 */	addi r4, r30, 0xa84
/* 806EF29C  4B C5 72 14 */	b PSMTXCopy
lbl_806EF2A0:
/* 806EF2A0  80 7E 0A B4 */	lwz r3, 0xab4(r30)
/* 806EF2A4  28 03 00 00 */	cmplwi r3, 0
/* 806EF2A8  41 82 00 08 */	beq lbl_806EF2B0
/* 806EF2AC  4B 98 C7 14 */	b Move__4dBgWFv
lbl_806EF2B0:
/* 806EF2B0  39 61 00 20 */	addi r11, r1, 0x20
/* 806EF2B4  4B C7 2F 74 */	b _restgpr_29

...
/* 806EAB78 00000010  4B C7 76 60 */	b _savegpr_28
/* 806EAB7C 00000014  7C 7C 1B 78 */	mr r28, r3
/* 806EAB80 00000018  3C 60 80 6F */	lis r3, lit_1109@ha
/* 806EAB84 0000001C  3B C3 0B 30 */	addi r30, r3, lit_1109@l
/* 806EAB88 00000020  3C 60 80 6F */	lis r3, lit_3966@ha
/* 806EAB8C 00000024  3B E3 08 60 */	addi r31, r3, lit_3966@l
/* 806EAB90 00000028  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 806EAB94 0000002C  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l
/* 806EAB98 00000030  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 806EABB8 00000008  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 806F0B8C */
/* 806EABBC 0000000C  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806EABC0 00000000  41 80 00 10 */	blt lbl_806EABD0
/* 806EABC4 00000004  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 806F0B90 */
...
lbl_806EABD8:
/* 806EABD8 00000000  80 04 5F 18 */	lwz r0, 0x5f18(r4)	/* effective address: 8040C0D8 */
...
/* 806EAC18 00000040  4B C5 C7 84 */	b PSVECSquareDistance
/* 806EAC1C 00000044  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806F0864 */
...
/* 806EAC2C 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 806F0870 */
/* 806EAC30 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 806EAC34 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 806F0878 */
...
lbl_806EAC7C:
/* 806EAC7C 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 806F0880 */
/* 806EAC80 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806EAC84 00000000  40 80 00 10 */	bge lbl_806EAC94
/* 806EAC88 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EAC8C 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806EACF8 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EACFC 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806EAD00:
/* 806EAD00 00000000  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 806F08BC */
...
/* 806EAD18 00000004  90 1E 00 90 */	stw r0, 0x90(r30)	/* effective address: 806F0BC0 */
/* 806EAD1C 00000008  90 1E 00 8C */	stw r0, 0x8c(r30)	/* effective address: 806F0BBC */
/* 806EAD20 0000000C  90 1E 00 88 */	stw r0, 0x88(r30)	/* effective address: 806F0BB8 */
/* 806EAD24 00000010  3C 60 80 6F */	lis r3, s_obj_sub__FPvPv@ha
/* 806EAD28 00000014  38 63 A9 B8 */	addi r3, r3, s_obj_sub__FPvPv@l
/* 806EAD2C 00000018  7F 84 E3 78 */	mr r4, r28
/* 806EAD30 0000001C  4B 93 66 08 */	b fpcEx_Search__FPFPvPv_PvPv
/* 806EAD34 00000020  80 1E 00 88 */	lwz r0, 0x88(r30)	/* effective address: 806F0BB8 */
/* 806EAD38 00000024  28 00 00 00 */	cmplwi r0, 0
/* 806EAD3C 00000028  40 82 00 1C */	bne lbl_806EAD58
/* 806EAD40 0000002C  80 1E 00 8C */	lwz r0, 0x8c(r30)	/* effective address: 806F0BBC */
/* 806EAD44 00000030  28 00 00 00 */	cmplwi r0, 0
/* 806EAD48 00000034  40 82 00 10 */	bne lbl_806EAD58
/* 806EAD4C 00000038  80 1E 00 90 */	lwz r0, 0x90(r30)	/* effective address: 806F0BC0 */
...
/* 806EAD9C 0000003C  C0 3F 00 04 */	lfs f1, 4(r31)	/* effective address: 806F0864 */
...
/* 806EADC4 00000064  4B C5 C5 D8 */	b PSVECSquareDistance
/* 806EADC8 00000068  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 806F0864 */
...
/* 806EADD8 00000008  C8 9F 00 10 */	lfd f4, 0x10(r31)	/* effective address: 806F0870 */
/* 806EADDC 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 806EADE0 00000010  C8 7F 00 18 */	lfd f3, 0x18(r31)	/* effective address: 806F0878 */
...
lbl_806EAE28:
/* 806EAE28 00000000  C8 1F 00 20 */	lfd f0, 0x20(r31)	/* effective address: 806F0880 */
/* 806EAE2C 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 806EAE30 00000000  40 80 00 10 */	bge lbl_806EAE40
/* 806EAE34 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EAE38 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806EAEA4 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EAEA8 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806EAEAC:
/* 806EAEAC 00000000  C0 1F 00 40 */	lfs f0, 0x40(r31)	/* effective address: 806F08A0 */
...
/* 806EAEC8 00000004  4B C7 73 5C */	b _restgpr_28

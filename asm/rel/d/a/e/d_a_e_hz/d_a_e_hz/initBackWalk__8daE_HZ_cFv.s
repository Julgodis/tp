...
/* 806EC078  4B C7 61 60 */	b _savegpr_28
/* 806EC07C  7C 7F 1B 78 */	mr r31, r3
/* 806EC080  3C 80 80 6F */	lis r4, lit_3966@ha
/* 806EC084  3B C4 08 60 */	addi r30, r4, lit_3966@l
/* 806EC088  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 806F0864 */
...
/* 806EC0BC  4B B7 AA 78 */	b __mi__4cXyzCFRC3Vec
...
/* 806EC0DC  4B C5 B0 5C */	b PSVECSquareMag
...
/* 806EC14C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EC150  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 806EC1BC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 806EC1C0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_806EC1C4:
...
/* 806EC21C  4B B8 49 E8 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 806EC254  4B B8 4B 6C */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
/* 806EC258  38 61 00 60 */	addi r3, r1, 0x60
/* 806EC25C  4B 98 BA 0C */	b __ct__11dBgS_LinChkFv
...
/* 806EC280  4B B7 A8 64 */	b __pl__4cXyzCFRC3Vec
...
/* 806EC2A8  4B B7 A8 3C */	b __pl__4cXyzCFRC3Vec
...
/* 806EC2D4  4B 98 BA 90 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 806EC2D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806EC2DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806EC2E0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 806EC2E4  38 81 00 60 */	addi r4, r1, 0x60
/* 806EC2E8  4B 98 80 CC */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 806EC320  4B B8 4A A0 */	b cLib_offsetPos__FP4cXyzPC4cXyzsPC4cXyz
lbl_806EC324:
/* 806EC324  38 61 00 60 */	addi r3, r1, 0x60
/* 806EC328  38 80 FF FF */	li r4, -1
/* 806EC32C  4B 98 B9 B0 */	b __dt__11dBgS_LinChkFv
lbl_806EC330:
/* 806EC330  39 61 00 E0 */	addi r11, r1, 0xe0
/* 806EC334  4B C7 5E F0 */	b _restgpr_28

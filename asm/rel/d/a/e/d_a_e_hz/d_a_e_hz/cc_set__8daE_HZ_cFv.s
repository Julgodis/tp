...
/* 806EF2D8  4B C7 2F 00 */	b _savegpr_28
...
/* 806EF328  3C 60 80 6F */	lis r3, lit_4505@ha
/* 806EF32C  C0 03 08 D4 */	lfs f0, lit_4505@l(r3)
...
/* 806EF344  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806EF348  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806EF34C  4B C5 71 64 */	b PSMTXCopy
/* 806EF350  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 806EF354  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 806EF358  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 803DD47C */
/* 806EF35C  D0 01 00 08 */	stfs f0, 8(r1)
/* 806EF360  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 803DD48C */
/* 806EF364  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 806EF368  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 803DD49C */
/* 806EF36C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 806EF370  38 7C 0E 30 */	addi r3, r28, 0xe30
/* 806EF374  38 81 00 08 */	addi r4, r1, 8
/* 806EF378  4B B8 02 D0 */	b SetC__8cM3dGSphFRC4cXyz
/* 806EF37C  38 7C 0E 30 */	addi r3, r28, 0xe30
/* 806EF380  3C 80 80 6F */	lis r4, lit_6030@ha
/* 806EF384  C0 24 09 4C */	lfs f1, lit_6030@l(r4)
/* 806EF388  4B B8 03 80 */	b SetR__8cM3dGSphFf
/* 806EF38C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 806EF390  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 806EF394  3B A3 23 3C */	addi r29, r3, 0x233c
/* 806EF398  7F A3 EB 78 */	mr r3, r29
/* 806EF39C  38 9C 0D 0C */	addi r4, r28, 0xd0c
/* 806EF3A0  4B B7 58 08 */	b Set__4cCcSFP8cCcD_Obj
/* 806EF3A4  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 806EF3A8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806EF3AC  38 63 00 30 */	addi r3, r3, 0x30
/* 806EF3B0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806EF3B4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806EF3B8  4B C5 70 F8 */	b PSMTXCopy
...
/* 806EF3DC  4B B8 02 6C */	b SetC__8cM3dGSphFRC4cXyz
/* 806EF3E0  38 7C 0F 68 */	addi r3, r28, 0xf68
/* 806EF3E4  3C 80 80 6F */	lis r4, lit_6030@ha
/* 806EF3E8  C0 24 09 4C */	lfs f1, lit_6030@l(r4)
/* 806EF3EC  4B B8 03 1C */	b SetR__8cM3dGSphFf
/* 806EF3F0  7F A3 EB 78 */	mr r3, r29
/* 806EF3F4  38 9C 0E 44 */	addi r4, r28, 0xe44
/* 806EF3F8  4B B7 57 B0 */	b Set__4cCcSFP8cCcD_Obj
/* 806EF3FC  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 806EF400  80 63 00 0C */	lwz r3, 0xc(r3)
/* 806EF404  38 63 03 60 */	addi r3, r3, 0x360
/* 806EF408  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 806EF40C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 806EF410  4B C5 70 A0 */	b PSMTXCopy
...
/* 806EF434  4B B8 02 14 */	b SetC__8cM3dGSphFRC4cXyz
/* 806EF438  38 7C 10 A0 */	addi r3, r28, 0x10a0
/* 806EF43C  3C 80 80 6F */	lis r4, lit_6030@ha
/* 806EF440  C0 24 09 4C */	lfs f1, lit_6030@l(r4)
/* 806EF444  4B B8 02 C4 */	b SetR__8cM3dGSphFf
/* 806EF448  7F A3 EB 78 */	mr r3, r29
/* 806EF44C  38 9C 0F 7C */	addi r4, r28, 0xf7c
/* 806EF450  4B B7 57 58 */	b Set__4cCcSFP8cCcD_Obj
lbl_806EF454:
/* 806EF454  39 61 00 30 */	addi r11, r1, 0x30
/* 806EF458  4B C7 2D CC */	b _restgpr_28

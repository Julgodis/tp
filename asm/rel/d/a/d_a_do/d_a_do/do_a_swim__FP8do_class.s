...
/* 8066C8A4 00000010  4B CF 59 38 */	b _savegpr_29
/* 8066C8A8 00000014  7C 7E 1B 78 */	mr r30, r3
/* 8066C8AC 00000018  3C 60 80 67 */	lis r3, lit_3662@ha
/* 8066C8B0 0000001C  3B E3 ED E8 */	addi r31, r3, lit_3662@l
/* 8066C8B4 00000020  C0 1F 00 80 */	lfs f0, 0x80(r31)	/* effective address: 8066EE68 */
/* 8066C8B8 00000024  D0 1E 06 48 */	stfs f0, 0x648(r30)
/* 8066C8BC 00000028  38 7E 05 2C */	addi r3, r30, 0x52c
/* 8066C8C0 0000002C  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 8066EDE8 */
/* 8066C8C4 00000030  FC 40 08 90 */	fmr f2, f1
/* 8066C8C8 00000034  4B C0 31 B8 */	b cLib_addCalc0__FPfff
...
lbl_8066C8F4:
/* 8066C8F4 00000000  3C 60 80 67 */	lis r3, l_HIO@ha
/* 8066C8F8 00000004  38 63 F2 C4 */	addi r3, r3, l_HIO@l
/* 8066C8FC 00000008  A8 03 00 1E */	lha r0, 0x1e(r3)	/* effective address: 8066F2E2 */
...
/* 8066C910 0000001C  C0 3F 00 44 */	lfs f1, 0x44(r31)	/* effective address: 8066EE2C */
/* 8066C914 00000020  38 A0 00 02 */	li r5, 2
/* 8066C918 00000024  C0 5F 00 00 */	lfs f2, 0(r31)	/* effective address: 8066EDE8 */
...
/* 8066C92C 00000008  C0 3F 00 44 */	lfs f1, 0x44(r31)	/* effective address: 8066EE2C */
/* 8066C930 0000000C  38 A0 00 02 */	li r5, 2
/* 8066C934 00000010  C0 5F 00 00 */	lfs f2, 0(r31)	/* effective address: 8066EDE8 */
...
/* 8066C94C 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8066C950 00000014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8066C954 00000018  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8066C990 00000054  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 8066EDE8 */
/* 8066C994 00000058  4B 9E 00 FC */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 8066C9BC 00000080  4B C1 3E 24 */	b func_802807E0
/* 8066C9C0 00000084  C0 1F 00 A4 */	lfs f0, 0xa4(r31)	/* effective address: 8066EE8C */
...
/* 8066CA10 00000014  C0 1F 00 C8 */	lfs f0, 0xc8(r31)	/* effective address: 8066EEB0 */
/* 8066CA14 00000018  D0 1E 06 34 */	stfs f0, 0x634(r30)
/* 8066CA18 0000001C  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 8066EDE8 */
/* 8066CA1C 00000020  D0 1E 06 38 */	stfs f0, 0x638(r30)
/* 8066CA20 00000024  48 00 00 70 */	b lbl_8066CA90
lbl_8066CA24:
/* 8066CA24 00000000  3C 60 80 67 */	lis r3, l_HIO@ha
/* 8066CA28 00000004  38 63 F2 C4 */	addi r3, r3, l_HIO@l
/* 8066CA2C 00000008  A8 03 00 1E */	lha r0, 0x1e(r3)	/* effective address: 8066F2E2 */
/* 8066CA30 0000000C  2C 00 00 01 */	cmpwi r0, 1
/* 8066CA34 00000010  40 82 00 1C */	bne lbl_8066CA50
/* 8066CA38 00000014  C0 3F 00 44 */	lfs f1, 0x44(r31)	/* effective address: 8066EE2C */
...
lbl_8066CA50:
/* 8066CA50 00000000  C0 3F 00 44 */	lfs f1, 0x44(r31)	/* effective address: 8066EE2C */
...
/* 8066CA68 00000004  C0 1F 01 74 */	lfs f0, 0x174(r31)	/* effective address: 8066EF5C */
...
/* 8066CA78 00000008  C0 1F 00 14 */	lfs f0, 0x14(r31)	/* effective address: 8066EDFC */
...
/* 8066CA94 00000004  4B CF 57 94 */	b _restgpr_29

...
/* 8066DE74  4B CF 43 68 */	b _savegpr_29
/* 8066DE78  7C 7F 1B 78 */	mr r31, r3
/* 8066DE7C  3C 60 80 67 */	lis r3, lit_3662@ha
/* 8066DE80  3B A3 ED E8 */	addi r29, r3, lit_3662@l
/* 8066DE84  4B 9A A4 24 */	b cDmrNowMidnaTalk__Fv
...
/* 8066DF0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066DF10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066DF14  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 8066DF18  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 8066DF1C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 8066DF20  4B CD 89 C8 */	b PSMTXTrans
/* 8066DF24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066DF28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066DF2C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8066DF30  4B 99 E5 04 */	b mDoMtx_YrotM__FPA4_fs
/* 8066DF34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066DF38  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066DF3C  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 8066DF40  4B 99 E4 5C */	b mDoMtx_XrotM__FPA4_fs
/* 8066DF44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066DF48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066DF4C  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 8066DF50  4B 99 E5 7C */	b mDoMtx_ZrotM__FPA4_fs
/* 8066DF54  C0 1F 06 7C */	lfs f0, 0x67c(r31)
/* 8066DF58  3C 60 80 67 */	lis r3, l_HIO@ha
/* 8066DF5C  38 63 F2 C4 */	addi r3, r3, l_HIO@l
/* 8066DF60  C0 63 00 08 */	lfs f3, 8(r3)	/* effective address: 8066F2CC */
...
/* 8066DF90  4B 99 EE A8 */	b scaleM__14mDoMtx_stack_cFfff
/* 8066DF94  80 7F 05 D0 */	lwz r3, 0x5d0(r31)
/* 8066DF98  83 C3 00 04 */	lwz r30, 4(r3)
/* 8066DF9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8066DFA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8066DFA4  38 9E 00 24 */	addi r4, r30, 0x24
/* 8066DFA8  4B CD 85 08 */	b PSMTXCopy
...
/* 8066DFBC  4B 9A 26 0C */	b play__14mDoExt_McaMorfFP3VecUlSc
...
/* 8066DFD8  4B CB A4 54 */	b checkPass__12J3DFrameCtrlFf
...
/* 8066E008  4B CB A4 24 */	b checkPass__12J3DFrameCtrlFf
...
/* 8066E044  4B BF 99 10 */	b cM_rndF__Ff
...
/* 8066E0DC  4B 9A 25 D0 */	b modelCalc__14mDoExt_McaMorfFv
/* 8066E0E0  80 7E 00 84 */	lwz r3, 0x84(r30)
/* 8066E0E4  80 63 00 0C */	lwz r3, 0xc(r3)
/* 8066E0E8  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 8066E0EC  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8066E0F0  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8066E0F4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8066E0F8  4B CD 83 B8 */	b PSMTXCopy
...
/* 8066E118  4B C0 2D D4 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8066E168  4B C0 2D 84 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8066E190  4B C0 14 B8 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 8066E1B0  4B C0 15 58 */	b SetR__8cM3dGSphFf
...
/* 8066E1C8  4B C0 15 40 */	b SetR__8cM3dGSphFf
lbl_8066E1CC:
/* 8066E1CC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8066E1D0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8066E1D4  38 63 23 3C */	addi r3, r3, 0x233c
/* 8066E1D8  38 9F 09 10 */	addi r4, r31, 0x910
/* 8066E1DC  4B BF 69 CC */	b Set__4cCcSFP8cCcD_Obj
...
/* 8066E1F4  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8066E1F8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8066E1FC  38 81 00 0C */	addi r4, r1, 0xc
/* 8066E200  4B 9A B5 F8 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8066E22C  4B 9C 99 C8 */	b startControl__8daItem_cFv
...
/* 8066E24C  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8066E250  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8066E254  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8066E258  4B CD 82 58 */	b PSMTXCopy
/* 8066E25C  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8066E260  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8066E264  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8066E268  38 80 00 00 */	li r4, 0
/* 8066E26C  4B 99 E1 C8 */	b mDoMtx_YrotM__FPA4_fs
/* 8066E270  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8066E274  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8066E278  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8066E27C  38 80 00 00 */	li r4, 0
/* 8066E280  4B 99 E1 1C */	b mDoMtx_XrotM__FPA4_fs
/* 8066E284  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8066E288  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8066E28C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8066E290  38 80 00 00 */	li r4, 0
/* 8066E294  4B 99 E2 38 */	b mDoMtx_ZrotM__FPA4_fs
...
/* 8066E2A8  4B C0 2B B4 */	b MtxTrans__FfffUc
...
/* 8066E2C4  4B C0 2C 28 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8066E320  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 8066E324  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 8066E328  38 81 00 08 */	addi r4, r1, 8
/* 8066E32C  4B 9A B4 CC */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 8066E358  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8066E35C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8066E360  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8066E364  4B CD 81 4C */	b PSMTXCopy
/* 8066E368  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8066E36C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8066E370  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8066E374  38 80 40 00 */	li r4, 0x4000
/* 8066E378  4B 99 E0 BC */	b mDoMtx_YrotM__FPA4_fs
...
/* 8066E38C  4B C0 2A D0 */	b MtxTrans__FfffUc
/* 8066E390  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8066E394  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8066E398  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8066E39C  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 8066E3A0  38 84 00 24 */	addi r4, r4, 0x24
/* 8066E3A4  4B CD 81 0C */	b PSMTXCopy
...
/* 8066E3C0  4B C0 2B 2C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8066E3E4  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 8066E3E8  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 8066E3EC  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 8066E3F0  4B CD 80 C0 */	b PSMTXCopy
/* 8066E3F4  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 8066E3F8  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 8066E3FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 8066E400  38 80 40 00 */	li r4, 0x4000
/* 8066E404  4B 99 E0 30 */	b mDoMtx_YrotM__FPA4_fs
...
/* 8066E418  4B C0 2A 44 */	b MtxTrans__FfffUc
...
/* 8066E434  4B C0 2A B8 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 8066E450  4B 9B EC 1C */	b dComIfGp_getReverb__Fi
...
/* 8066E480  4B CF 3D A8 */	b _restgpr_29

...
/* 8045B5F0  4B F0 6B E4 */	b _savegpr_27
/* 8045B5F4  7C 7F 1B 78 */	mr r31, r3
/* 8045B5F8  3C 60 80 46 */	lis r3, l_cyl_src@ha
/* 8045B5FC  3B A3 C9 B8 */	addi r29, r3, l_cyl_src@l
...
/* 8045B618  4B C2 8E 48 */	b ChkTgHit__12dCcD_GObjInfFv
/* 8045B61C  28 03 00 00 */	cmplwi r3, 0
/* 8045B620  41 82 01 74 */	beq lbl_8045B794
/* 8045B624  7F 83 E3 78 */	mr r3, r28
/* 8045B628  4B C2 8E D0 */	b GetTgHitObj__12dCcD_GObjInfFv
...
/* 8045B64C  4B C2 80 3C */	b GetAc__22dCcD_GAtTgCoCommonBaseFv
...
/* 8045B67C  4B E0 B4 B8 */	b __mi__4cXyzCFRC3Vec
...
/* 8045B698  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045B69C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045B6A0  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 8045B6A4  7C 00 00 D0 */	neg r0, r0
/* 8045B6A8  7C 04 07 34 */	extsh r4, r0
/* 8045B6AC  4B BB 0D 30 */	b mDoMtx_YrotS__FPA4_fs
/* 8045B6B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045B6B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045B6B8  38 81 00 44 */	addi r4, r1, 0x44
/* 8045B6BC  7C 85 23 78 */	mr r5, r4
/* 8045B6C0  4B EE B6 AC */	b PSMTXMultVec
/* 8045B6C4  38 7F 04 D0 */	addi r3, r31, 0x4d0
/* 8045B6C8  4B BB 16 9C */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 8045B6CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045B6D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045B6D4  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 8045B6D8  4B BB 0D 5C */	b mDoMtx_YrotM__FPA4_fs
...
lbl_8045B728:
/* 8045B728  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8045B72C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8045B730  38 81 00 38 */	addi r4, r1, 0x38
/* 8045B734  7C 85 23 78 */	mr r5, r4
/* 8045B738  4B EE B6 34 */	b PSMTXMultVec
/* 8045B73C  38 61 00 08 */	addi r3, r1, 8
/* 8045B740  38 81 00 38 */	addi r4, r1, 0x38
/* 8045B744  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 8045B748  4B E0 B3 EC */	b __mi__4cXyzCFRC3Vec
...
/* 8045B764  4B E0 BF 10 */	b cM_atan2s__Fff
...
/* 8045B7CC  4B E0 93 DC */	b Set__4cCcSFP8cCcD_Obj
...
/* 8045B7E8  4B F0 6A 38 */	b _restgpr_27

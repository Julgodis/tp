...
/* 8045C088  4B F0 61 4C */	b _savegpr_27
...
lbl_8045C0D8:
/* 8045C0D8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8045C0DC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8045C0E0  38 80 00 20 */	li r4, 0x20
/* 8045C0E4  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 8045C0E8  38 DC 01 0C */	addi r6, r28, 0x10c
/* 8045C0EC  4B D4 76 D8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 8045C0F0  3B C0 00 00 */	li r30, 0
/* 8045C0F4  3B 60 00 00 */	li r27, 0
/* 8045C0F8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8045C0FC  3B A3 CA 54 */	addi r29, r3, g_env_light@l
lbl_8045C100:
...
/* 8045C128  4B D4 8C 78 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
lbl_8045C12C:
...
/* 8045C144  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8045C148  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 8045C14C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 8045C150  3B E3 4A C8 */	addi r31, r3, j3dSys@l
lbl_8045C154:
/* 8045C154  80 1E 5F 70 */	lwz r0, 0x5f70(r30)	/* effective address: 8040C130 */
/* 8045C158  90 1F 00 48 */	stw r0, 0x48(r31)	/* effective address: 80434B10 */
/* 8045C15C  80 1E 5F 74 */	lwz r0, 0x5f74(r30)	/* effective address: 8040C134 */
/* 8045C160  90 1F 00 4C */	stw r0, 0x4c(r31)	/* effective address: 80434B14 */
...
/* 8045C19C  4B D5 0B 88 */	b dKy_bg_MAxx_proc__FPv
...
/* 8045C1CC  4B BB 15 0C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_8045C1D0:
...
/* 8045C1FC  4B BB 15 AC */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_8045C200:
...
/* 8045C214  4B BB 1A B0 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_8045C218:
...
/* 8045C228  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8045C22C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8045C230  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 8045C234  90 1F 00 48 */	stw r0, 0x48(r31)
/* 8045C238  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
/* 8045C23C  90 1F 00 4C */	stw r0, 0x4c(r31)
/* 8045C240  38 60 00 01 */	li r3, 1
lbl_8045C244:
/* 8045C244  39 61 00 20 */	addi r11, r1, 0x20
/* 8045C248  4B F0 5F D8 */	b _restgpr_27

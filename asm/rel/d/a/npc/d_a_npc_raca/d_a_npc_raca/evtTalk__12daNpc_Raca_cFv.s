...
/* 80AB6C28  3C 80 80 AC */	lis r4, lit_4592@ha
/* 80AB6C2C  38 A4 93 20 */	addi r5, r4, lit_4592@l
/* 80AB6C30  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AB9320 */
/* 80AB6C34  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AB9324 */
/* 80AB6C38  90 81 00 14 */	stw r4, 0x14(r1)
/* 80AB6C3C  90 01 00 18 */	stw r0, 0x18(r1)
/* 80AB6C40  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AB9328 */
...
/* 80AB6C64  4B 8A B4 20 */	b __ptmf_scall
...
/* 80AB6C78  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AB6C7C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AB6C80  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80AB6CA4  4B 59 1B 4C */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AB6CC4  4B 69 35 60 */	b evtChange__8daNpcT_cFv
/* 80AB6CC8  38 60 00 01 */	li r3, 1
/* 80AB6CCC  48 00 00 34 */	b lbl_80AB6D00
lbl_80AB6CD0:
/* 80AB6CD0  3C 60 80 AC */	lis r3, lit_4602@ha
/* 80AB6CD4  38 83 93 2C */	addi r4, r3, lit_4602@l
/* 80AB6CD8  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AB932C */
/* 80AB6CDC  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AB9330 */
/* 80AB6CE0  90 61 00 08 */	stw r3, 8(r1)
/* 80AB6CE4  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AB6CE8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AB9334 */

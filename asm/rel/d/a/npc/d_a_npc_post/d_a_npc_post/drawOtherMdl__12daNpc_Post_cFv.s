...
/* 80AAA72C  4B 8B 7A A4 */	b _savegpr_26
...
/* 80AAA74C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80AAA750  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80AAA754  80 84 00 04 */	lwz r4, 4(r4)
/* 80AAA758  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80AAA75C  4B 6F A6 44 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80AAA77C  4B 87 B1 24 */	b hide__13J3DShapeTableFv
...
/* 80AAA794  4B 87 B1 44 */	b show__13J3DShapeTableFv
lbl_80AAA798:
/* 80AAA798  80 7B 0E 40 */	lwz r3, 0xe40(r27)
/* 80AAA79C  4B 56 6A 24 */	b entryDL__16mDoExt_McaMorfSOFv
/* 80AAA7A0  80 7B 0E 40 */	lwz r3, 0xe40(r27)
/* 80AAA7A4  80 A3 00 04 */	lwz r5, 4(r3)
/* 80AAA7A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AAA7AC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AAA7B0  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 80AAA7B4  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80AAA7B8  4B 5A B7 64 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80AAA7BC:
/* 80AAA7BC  3B 80 00 00 */	li r28, 0
/* 80AAA7C0  3B 40 00 00 */	li r26, 0
/* 80AAA7C4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AAA7C8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80AAA808:
/* 80AAA808  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80AAA80C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80AAA810  80 84 00 04 */	lwz r4, 4(r4)
/* 80AAA814  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80AAA818  4B 6F A5 88 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80AAA81C  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 80AAA820  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80AAA824  3C 60 80 AB */	lis r3, data_80AAD318@ha
/* 80AAA828  38 63 D3 18 */	addi r3, r3, data_80AAD318@l
/* 80AAA82C  7C 03 D0 2E */	lwzx r0, r3, r26
/* 80AAA830  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80AAA834  7C 64 02 14 */	add r3, r4, r0
/* 80AAA838  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AAA83C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AAA840  4B 89 BC 70 */	b PSMTXCopy
/* 80AAA844  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AAA848  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AAA84C  38 81 00 08 */	addi r4, r1, 8
/* 80AAA850  4B 89 BC 60 */	b PSMTXCopy
/* 80AAA854  38 61 00 08 */	addi r3, r1, 8
/* 80AAA858  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80AAA85C  38 84 00 24 */	addi r4, r4, 0x24
/* 80AAA860  4B 89 BC 50 */	b PSMTXCopy
/* 80AAA864  7C 7B E8 2E */	lwzx r3, r27, r29
/* 80AAA868  4B 56 34 5C */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80AAA86C  7F C3 F3 78 */	mr r3, r30
/* 80AAA870  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80AAA874  7C BB E8 2E */	lwzx r5, r27, r29
/* 80AAA878  4B 5A B6 A4 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80AAA87C:
...
/* 80AAA890  4B 8B 79 8C */	b _restgpr_26

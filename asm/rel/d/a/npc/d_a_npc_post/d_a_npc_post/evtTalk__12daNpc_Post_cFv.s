...
/* 80AA9DAC  3C 80 80 AB */	lis r4, lit_4653@ha
/* 80AA9DB0  38 A4 D9 28 */	addi r5, r4, lit_4653@l
/* 80AA9DB4  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AAD928 */
/* 80AA9DB8  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AAD92C */
/* 80AA9DBC  90 81 00 14 */	stw r4, 0x14(r1)
/* 80AA9DC0  90 01 00 18 */	stw r0, 0x18(r1)
/* 80AA9DC4  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AAD930 */
...
/* 80AA9DE8  4B 8B 82 9C */	b __ptmf_scall
...
/* 80AA9DFC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AA9E00  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AA9E04  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80AA9E28  4B 59 E9 C8 */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AA9E48  4B 6A 03 DC */	b evtChange__8daNpcT_cFv
/* 80AA9E4C  38 60 00 01 */	li r3, 1
/* 80AA9E50  48 00 00 34 */	b lbl_80AA9E84
lbl_80AA9E54:
/* 80AA9E54  3C 60 80 AB */	lis r3, lit_4663@ha
/* 80AA9E58  38 83 D9 34 */	addi r4, r3, lit_4663@l
/* 80AA9E5C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AAD934 */
/* 80AA9E60  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AAD938 */
/* 80AA9E64  90 61 00 08 */	stw r3, 8(r1)
/* 80AA9E68  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AA9E6C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AAD93C */

...
/* 809BA740  4B 9A 7A 9C */	b _savegpr_29
...
/* 809BA798  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809BA79C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809BA7B0:
/* 809BA7B0  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809BA7B4  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809BA7D0  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BA7D4  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_809BA7E8:
/* 809BA7E8  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BA7EC  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 809BA7F0  1C 05 02 3C */	mulli r0, r5, 0x23c
/* 809BA7F4  7C 84 02 14 */	add r4, r4, r0
/* 809BA7F8  C0 24 FF 38 */	lfs f1, -0xc8(r4)
lbl_809BA7FC:
/* 809BA7FC  4B 6B B7 5C */	b SetWall__12dBgS_AcchCirFff
...
/* 809BA828  4B 6B BA 20 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 809BA85C  4B 79 E5 2C */	b setEnvTevCol__10daNpcCd2_cFv
/* 809BA860  7F C3 F3 78 */	mr r3, r30
/* 809BA864  4B 79 E5 80 */	b setRoomNo__10daNpcCd2_cFv
...
/* 809BA884  4B 6C 8F DC */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 809BA89C  3C 80 80 39 */	lis r4, m_cylDat__10daNpcCd2_c@ha
/* 809BA8A0  38 84 39 50 */	addi r4, r4, m_cylDat__10daNpcCd2_c@l
/* 809BA8A4  4B 6C A0 10 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 809BA8B8  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BA8BC  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_809BA8D0:
/* 809BA8D0  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BA8D4  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 809BA8D8  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 809BA8DC  7C 84 02 14 */	add r4, r4, r0
/* 809BA8E0  C0 24 FF 34 */	lfs f1, -0xcc(r4)
lbl_809BA8E4:
/* 809BA8E4  4B 8B 49 1C */	b SetR__8cM3dGCylFf
...
/* 809BA8F8  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BA8FC  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_809BA910:
/* 809BA910  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BA914  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 809BA918  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 809BA91C  7C 84 02 14 */	add r4, r4, r0
/* 809BA920  C0 24 FF 30 */	lfs f1, -0xd0(r4)
lbl_809BA924:
/* 809BA924  4B 8B 48 D4 */	b SetH__8cM3dGCylFf
...
/* 809BA94C  4B 8A D0 08 */	b cM_rndF__Ff
...
/* 809BA968  4B 79 D7 88 */	b getAnmP__10daNpcCd2_cFii
...
/* 809BA988  4B 79 E5 78 */	b setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
/* 809BA98C  48 00 00 48 */	b lbl_809BA9D4
lbl_809BA990:
/* 809BA990  C0 3F 00 28 */	lfs f1, 0x28(r31)
/* 809BA994  4B 8A CF C0 */	b cM_rndF__Ff
...
/* 809BA9B0  4B 79 D7 40 */	b getAnmP__10daNpcCd2_cFii
...
/* 809BA9D0  4B 79 E5 30 */	b setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
lbl_809BA9D4:
/* 809BA9D4  80 7E 05 8C */	lwz r3, 0x58c(r30)
/* 809BA9D8  C0 3F 00 2C */	lfs f1, 0x2c(r31)
/* 809BA9DC  4B 65 51 A0 */	b setMorf__13mDoExt_morf_cFf
/* 809BA9E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BA9E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BA9E8  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 809BA9EC  C0 5E 0A D4 */	lfs f2, 0xad4(r30)
/* 809BA9F0  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 809BA9F4  4B 98 BE F4 */	b PSMTXTrans
/* 809BA9F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BA9FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BAA00  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 809BAA04  4B 65 1A 30 */	b mDoMtx_YrotM__FPA4_fs
/* 809BAA08  80 7E 05 8C */	lwz r3, 0x58c(r30)
/* 809BAA0C  80 83 00 04 */	lwz r4, 4(r3)
/* 809BAA10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BAA14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BAA18  38 84 00 24 */	addi r4, r4, 0x24
/* 809BAA1C  4B 98 BA 94 */	b PSMTXCopy
/* 809BAA20  80 7E 05 8C */	lwz r3, 0x58c(r30)
/* 809BAA24  4B 65 67 C8 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 809BAA28  7F C3 F3 78 */	mr r3, r30
/* 809BAA2C  80 9E 0A 98 */	lwz r4, 0xa98(r30)
/* 809BAA30  4B 79 D9 F0 */	b setAttention__10daNpcCd2_cFi
/* 809BAA34  39 61 00 30 */	addi r11, r1, 0x30
/* 809BAA38  4B 9A 77 F0 */	b _restgpr_29

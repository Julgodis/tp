...
/* 809BAB14  4B 9A 76 C8 */	b _savegpr_29
...
/* 809BAB28  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809BAB2C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809BAB40:
/* 809BAB40  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809BAB44  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809BAB68  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BAB6C  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_809BAB80:
/* 809BAB80  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 809BAB84  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 809BAB88  1C 00 02 3C */	mulli r0, r0, 0x23c
/* 809BAB8C  7C 84 02 14 */	add r4, r4, r0
/* 809BAB90  C0 24 FF 3C */	lfs f1, -0xc4(r4)
lbl_809BAB94:
/* 809BAB94  4B 6B B3 AC */	b SetWallR__12dBgS_AcchCirFf
...
/* 809BAC00  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 809BAC04  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 809BAC08  3B A4 0F 38 */	addi r29, r4, 0xf38
/* 809BAC0C  7F A4 EB 78 */	mr r4, r29
/* 809BAC10  4B 6B BE 9C */	b CrrPos__9dBgS_AcchFR4dBgS
/* 809BAC14  3B C0 00 00 */	li r30, 0
/* 809BAC18  3C 60 80 9C */	lis r3, __vt__8cM3dGPla@ha
/* 809BAC1C  38 03 B4 90 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 809BAC30  4B 6B 9B 14 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 809BAC44  4B 66 2F 94 */	b fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
/* 809BAC68  3C 80 80 9C */	lis r4, lit_4182@ha
/* 809BAC6C  C0 44 B4 34 */	lfs f2, lit_4182@l(r4)
/* 809BAC70  3C 80 80 9C */	lis r4, lit_4183@ha
/* 809BAC74  C0 64 B4 38 */	lfs f3, lit_4183@l(r4)
/* 809BAC78  4B 8B 4D C4 */	b cLib_addCalc2__FPffff
/* 809BAC7C  3C 60 80 9C */	lis r3, __vt__8cM3dGPla@ha
/* 809BAC80  38 03 B4 90 */	addi r0, r3, __vt__8cM3dGPla@l
/* 809BAC84  90 01 00 24 */	stw r0, 0x24(r1)
/* 809BAC88  7F E3 FB 78 */	mr r3, r31
/* 809BAC8C  38 80 FF FF */	li r4, -1
/* 809BAC90  4B 79 E1 98 */	b animation__10daNpcCd2_cFi
...
/* 809BACB4  4B 8B 45 28 */	b SetC__8cM3dGCylFRC4cXyz
/* 809BACB8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809BACBC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809BACC0  38 63 23 3C */	addi r3, r3, 0x233c
/* 809BACC4  38 9F 08 8C */	addi r4, r31, 0x88c
/* 809BACC8  4B 8A 9E E0 */	b Set__4cCcSFP8cCcD_Obj
/* 809BACCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BACD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BACD4  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 809BACD8  C0 5D 00 00 */	lfs f2, 0(r29)
/* 809BACDC  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 809BACE0  4B 98 BC 08 */	b PSMTXTrans
/* 809BACE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BACE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BACEC  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 809BACF0  4B 65 17 44 */	b mDoMtx_YrotM__FPA4_fs
/* 809BACF4  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 809BACF8  80 83 00 04 */	lwz r4, 4(r3)
/* 809BACFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BAD00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BAD04  38 84 00 24 */	addi r4, r4, 0x24
/* 809BAD08  4B 98 B7 A8 */	b PSMTXCopy
/* 809BAD0C  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 809BAD10  4B 65 64 DC */	b modelCalc__16mDoExt_McaMorfSOFv
/* 809BAD14  7F E3 FB 78 */	mr r3, r31
/* 809BAD18  80 9F 0A 98 */	lwz r4, 0xa98(r31)
/* 809BAD1C  4B 79 D7 04 */	b setAttention__10daNpcCd2_cFi
/* 809BAD20  38 60 00 01 */	li r3, 1
lbl_809BAD24:
/* 809BAD24  39 61 00 40 */	addi r11, r1, 0x40
/* 809BAD28  4B 9A 75 00 */	b _restgpr_29

...
/* 80A7C590  4B 8E 5C 38 */	b _savegpr_24
/* 80A7C594  7C 7C 1B 78 */	mr r28, r3
/* 80A7C598  3C 80 80 A8 */	lis r4, m__17daNpcMoiR_Param_c@ha
/* 80A7C59C  3B E4 32 AC */	addi r31, r4, m__17daNpcMoiR_Param_c@l
...
/* 80A7C640  4B 5B 11 00 */	b dComIfGs_isStageSwitch__Fii
...
/* 80A7C664  3C 80 80 A8 */	lis r4, struct_80A83840+0x0@ha
/* 80A7C668  38 84 38 40 */	addi r4, r4, struct_80A83840+0x0@l
/* 80A7C66C  38 84 00 4A */	addi r4, r4, 0x4a
/* 80A7C670  4B 8E C3 24 */	b strcmp
/* 80A7C674  2C 03 00 00 */	cmpwi r3, 0
/* 80A7C678  40 82 00 28 */	bne lbl_80A7C6A0
/* 80A7C67C  38 60 01 0B */	li r3, 0x10b
/* 80A7C680  4B 6D 8F B4 */	b daNpcF_chkEvtBit__FUl
...
/* 80A7C6A4  3C 80 80 A8 */	lis r4, struct_80A83840+0x0@ha
/* 80A7C6A8  38 84 38 40 */	addi r4, r4, struct_80A83840+0x0@l
/* 80A7C6AC  38 84 00 52 */	addi r4, r4, 0x52
/* 80A7C6B0  4B 8E C2 E4 */	b strcmp
/* 80A7C6B4  2C 03 00 00 */	cmpwi r3, 0
/* 80A7C6B8  40 82 00 3C */	bne lbl_80A7C6F4
/* 80A7C6BC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A7C6C0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A7C6C4  38 63 09 58 */	addi r3, r3, 0x958
/* 80A7C6C8  38 80 00 14 */	li r4, 0x14
/* 80A7C6CC  4B 5B 81 94 */	b isSwitch__12dSv_memBit_cCFi
...
/* 80A7C70C  3C 60 80 A8 */	lis r3, l_arcNames@ha
/* 80A7C710  3B 03 3A F8 */	addi r24, r3, l_arcNames@l
/* 80A7C714  3C 60 80 A8 */	lis r3, l_loadRes_list@ha
/* 80A7C718  3B 23 3A EC */	addi r25, r3, l_loadRes_list@l
...
/* 80A7C730  4B 5B 07 8C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80A7C7AC  3C 80 80 A8 */	lis r4, createHeapCallBack__11daNpcMoiR_cFP10fopAc_ac_c@ha
/* 80A7C7B0  38 84 D0 CC */	addi r4, r4, createHeapCallBack__11daNpcMoiR_cFP10fopAc_ac_c@l
/* 80A7C7B4  4B 59 DC FC */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80A7C7F4  4B 59 DD 54 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80A7C80C  4B 84 3D 24 */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80A7C820  4B 5F 97 38 */	b SetWall__12dBgS_AcchCirFff
...
/* 80A7C84C  4B 5F 99 FC */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80A7C870  4B 5F A2 3C */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80A7C894  4B 60 6F CC */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80A7C898  38 7C 0C A0 */	addi r3, r28, 0xca0
/* 80A7C89C  3C 80 80 3B */	lis r4, mCcDCyl__8daNpcF_c@ha
/* 80A7C8A0  38 84 37 E0 */	addi r4, r4, mCcDCyl__8daNpcF_c@l
/* 80A7C8A4  4B 60 80 10 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80A7C938  4B 6D 64 4C */	b setEnvTevColor__8daNpcF_cFv
/* 80A7C93C  7F 83 E3 78 */	mr r3, r28
/* 80A7C940  4B 6D 64 A0 */	b setRoomNo__8daNpcF_cFv
/* 80A7C944  80 7C 05 68 */	lwz r3, 0x568(r28)
/* 80A7C948  4B 59 48 A4 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 80A7C964  4B 8E 58 B0 */	b _restgpr_24

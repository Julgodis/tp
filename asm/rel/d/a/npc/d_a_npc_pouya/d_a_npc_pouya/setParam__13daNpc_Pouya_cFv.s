...
/* 80AAEE54  4B 8B 33 88 */	b _savegpr_29
...
/* 80AAEE68  3C 60 80 AB */	lis r3, m__19daNpc_Pouya_Param_c@ha
/* 80AAEE6C  38 63 20 00 */	addi r3, r3, m__19daNpc_Pouya_Param_c@l
/* 80AAEE70  AB C3 00 48 */	lha r30, 0x48(r3)	/* effective address: 80AB2048 */
/* 80AAEE74  AB A3 00 4A */	lha r29, 0x4a(r3)	/* effective address: 80AB204A */
/* 80AAEE78  A8 83 00 4C */	lha r4, 0x4c(r3)	/* effective address: 80AB204C */
/* 80AAEE7C  A8 A3 00 4E */	lha r5, 0x4e(r3)	/* effective address: 80AB204E */
...
/* 80AAEED0  4B 69 DB 48 */	b daNpcT_getDistTableIdx__Fii
...
/* 80AAEEE8  4B 69 DB 30 */	b daNpcT_getDistTableIdx__Fii
/* 80AAEEEC  98 7F 05 47 */	stb r3, 0x547(r31)
/* 80AAEEF0  38 00 00 0A */	li r0, 0xa
/* 80AAEEF4  90 1F 05 5C */	stw r0, 0x55c(r31)
/* 80AAEEF8  3C 60 80 AB */	lis r3, m__19daNpc_Pouya_Param_c@ha
/* 80AAEEFC  38 63 20 00 */	addi r3, r3, m__19daNpc_Pouya_Param_c@l
/* 80AAEF00  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80AB2008 */
/* 80AAEF04  D0 1F 04 EC */	stfs f0, 0x4ec(r31)
/* 80AAEF08  D0 1F 04 F0 */	stfs f0, 0x4f0(r31)
/* 80AAEF0C  D0 1F 04 F4 */	stfs f0, 0x4f4(r31)
/* 80AAEF10  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 80AB2010 */
...
/* 80AAEF24  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 80AB2014 */
/* 80AAEF28  D0 1F 0D EC */	stfs f0, 0xdec(r31)
/* 80AAEF2C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 80AB201C */
/* 80AAEF30  D0 1F 0D F0 */	stfs f0, 0xdf0(r31)
/* 80AAEF34  C0 03 00 50 */	lfs f0, 0x50(r3)	/* effective address: 80AB2050 */
/* 80AAEF38  D0 1F 0D F8 */	stfs f0, 0xdf8(r31)
/* 80AAEF3C  38 7F 08 A0 */	addi r3, r31, 0x8a0
/* 80AAEF40  C0 3F 0D F0 */	lfs f1, 0xdf0(r31)
/* 80AAEF44  4B 5C 6F FC */	b SetWallR__12dBgS_AcchCirFf
/* 80AAEF48  3C 60 80 AB */	lis r3, m__19daNpc_Pouya_Param_c@ha
/* 80AAEF4C  38 63 20 00 */	addi r3, r3, m__19daNpc_Pouya_Param_c@l
/* 80AAEF50  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80AB2018 */
/* 80AAEF54  D0 1F 08 D0 */	stfs f0, 0x8d0(r31)
/* 80AAEF58  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80AB200C */
/* 80AAEF5C  D0 1F 0D E8 */	stfs f0, 0xde8(r31)
/* 80AAEF60  C0 03 00 6C */	lfs f0, 0x6c(r3)	/* effective address: 80AB206C */
/* 80AAEF64  D0 1F 0A 80 */	stfs f0, 0xa80(r31)
/* 80AAEF68  C0 03 00 44 */	lfs f0, 0x44(r3)	/* effective address: 80AB2044 */
/* 80AAEF6C  D0 1F 0A 84 */	stfs f0, 0xa84(r31)
/* 80AAEF70  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80AB2004 */
...
/* 80AAEF90  3C 60 80 AB */	lis r3, lit_4204@ha
/* 80AAEF94  C0 03 20 B8 */	lfs f0, lit_4204@l(r3)
/* 80AAEF98  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 80AAEF9C  39 61 00 20 */	addi r11, r1, 0x20
/* 80AAEFA0  4B 8B 32 88 */	b _restgpr_29

...
/* 80AAEFD0  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AB2A50 */
/* 80AAEFD4  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AB2A54 */
/* 80AAEFD8  90 81 00 08 */	stw r4, 8(r1)
/* 80AAEFDC  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AAEFE0  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AB2A58 */
...
/* 80AAF000  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AAF004  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AAF008  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
lbl_80AAF068:
/* 80AAF068  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AAF06C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80AAF0B4:
/* 80AAF0B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AAF0B8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AAF0BC  88 03 01 0C */	lbz r0, 0x10c(r3)	/* effective address: 804062CC */

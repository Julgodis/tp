...
/* 8095E9D8  4B A0 38 00 */	b _savegpr_28
...
/* 8095E9EC  3C 60 80 96 */	lis r3, lit_4286@ha
/* 8095E9F0  38 83 21 6C */	addi r4, r3, lit_4286@l
/* 8095E9F4  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 8096216C */
/* 8095E9F8  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80962170 */
/* 8095E9FC  90 61 00 08 */	stw r3, 8(r1)
/* 8095EA00  90 01 00 0C */	stw r0, 0xc(r1)
/* 8095EA04  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80962174 */
...
/* 8095EA28  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8095EA2C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8095EA30  4B 9E 7A 80 */	b PSMTXCopy
/* 8095EA34  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8095EA38  3B 83 D4 70 */	addi r28, r3, now__14mDoMtx_stack_c@l
/* 8095EA3C  C0 1C 00 0C */	lfs f0, 0xc(r28)	/* effective address: 803DD47C */
/* 8095EA40  D0 1D 08 54 */	stfs f0, 0x854(r29)
/* 8095EA44  C0 1C 00 1C */	lfs f0, 0x1c(r28)	/* effective address: 803DD48C */
/* 8095EA48  D0 1D 08 58 */	stfs f0, 0x858(r29)
/* 8095EA4C  C0 1C 00 2C */	lfs f0, 0x2c(r28)	/* effective address: 803DD49C */
...
/* 8095EA6C  4B 9E 7A 44 */	b PSMTXCopy
...
/* 8095EA9C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8095EAA0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8095EAA4  4B 9E 7A 0C */	b PSMTXCopy
...
/* 8095EAD0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8095EAD4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8095EAD8  4B 9E 79 D8 */	b PSMTXCopy
...
/* 8095EB04  3C C0 80 96 */	lis r6, m__17daNpcAshB_Param_c@ha
/* 8095EB08  38 C6 20 E4 */	addi r6, r6, m__17daNpcAshB_Param_c@l
/* 8095EB0C  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 80962124 */
/* 8095EB10  4B 7F 48 6C */	b setLookatMtx__8daNpcF_cFiPif
lbl_8095EB14:
/* 8095EB14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8095EB18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8095EB1C  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 8095EB20  80 04 00 0C */	lwz r0, 0xc(r4)
/* 8095EB24  7C 80 E2 14 */	add r4, r0, r28
/* 8095EB28  4B 9E 79 88 */	b PSMTXCopy
/* 8095EB2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8095EB30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8095EB34  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 8095EB38  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 8095EB3C  4B 9E 79 74 */	b PSMTXCopy
...
/* 8095EB6C  4B 6A EE 24 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 8095EB80  4B A0 36 A4 */	b _restgpr_28

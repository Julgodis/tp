...
/* 8096127C  3C 60 80 96 */	lis r3, m__17daNpcAshB_Param_c@ha
/* 80961280  3B E3 20 E4 */	addi r31, r3, m__17daNpcAshB_Param_c@l
...
/* 80961304  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80961308  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8096130C  4B 9E 51 A4 */	b PSMTXCopy
/* 80961310  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80961314  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80961318  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 8096131C  D0 1E 08 E4 */	stfs f0, 0x8e4(r30)
/* 80961320  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80961324  D0 1E 08 E8 */	stfs f0, 0x8e8(r30)
/* 80961328  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 8096132C  D0 1E 08 EC */	stfs f0, 0x8ec(r30)
/* 80961330  38 81 00 30 */	addi r4, r1, 0x30
/* 80961334  38 BE 05 38 */	addi r5, r30, 0x538
/* 80961338  4B 9E 5A 34 */	b PSMTXMultVec
/* 8096133C  C0 1F 00 84 */	lfs f0, 0x84(r31)
/* 80961340  D0 01 00 30 */	stfs f0, 0x30(r1)
/* 80961344  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80961348  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8096134C  38 81 00 30 */	addi r4, r1, 0x30
/* 80961350  7C 85 23 78 */	mr r5, r4
/* 80961354  4B 9E 5A 18 */	b PSMTXMultVec
/* 80961358  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 8096135C  38 81 00 30 */	addi r4, r1, 0x30
/* 80961360  4B 90 F9 14 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80961364  B0 7E 09 02 */	sth r3, 0x902(r30)
/* 80961368  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 8096136C  38 81 00 30 */	addi r4, r1, 0x30
/* 80961370  4B 90 F8 94 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8096138C  4B 90 57 A8 */	b __mi__4cXyzCFRC3Vec
...
/* 809613BC  4B 90 62 B8 */	b cM_atan2s__Fff
...
/* 809613E8  4B 9E 5D 50 */	b PSVECSquareMag
...
/* 80961458  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8096145C  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 809614C8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809614CC  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 809614D0  48 00 00 08 */	b lbl_809614D8
lbl_809614D4:
/* 809614D4  FC 40 08 90 */	fmr f2, f1
lbl_809614D8:
/* 809614D8  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 809614DC  4B 90 61 98 */	b cM_atan2s__Fff

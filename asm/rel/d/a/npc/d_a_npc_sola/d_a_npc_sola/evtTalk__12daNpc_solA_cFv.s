...
/* 80AED51C  3C 80 80 AF */	lis r4, lit_4578@ha
/* 80AED520  38 A4 F2 A4 */	addi r5, r4, lit_4578@l
/* 80AED524  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AEF2A4 */
/* 80AED528  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AEF2A8 */
/* 80AED52C  90 81 00 14 */	stw r4, 0x14(r1)
/* 80AED530  90 01 00 18 */	stw r0, 0x18(r1)
/* 80AED534  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AEF2AC */
...
/* 80AED558  4B 87 4B 2C */	b __ptmf_scall
...
/* 80AED56C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AED570  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AED574  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80AED598  4B 55 B2 58 */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AED5B8  4B 65 CC 6C */	b evtChange__8daNpcT_cFv
/* 80AED5BC  38 60 00 01 */	li r3, 1
/* 80AED5C0  48 00 00 34 */	b lbl_80AED5F4
lbl_80AED5C4:
/* 80AED5C4  3C 60 80 AF */	lis r3, lit_4588@ha
/* 80AED5C8  38 83 F2 B0 */	addi r4, r3, lit_4588@l
/* 80AED5CC  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AEF2B0 */
/* 80AED5D0  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AEF2B4 */
/* 80AED5D4  90 61 00 08 */	stw r3, 8(r1)
/* 80AED5D8  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AED5DC  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AEF2B8 */

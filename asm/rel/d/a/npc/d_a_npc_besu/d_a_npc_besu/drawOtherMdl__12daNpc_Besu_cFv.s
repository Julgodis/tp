...
/* 805394AC  4B E2 8D 30 */	b _savegpr_29
...
/* 805394CC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 805394D0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 805394D4  80 84 00 04 */	lwz r4, 4(r4)
/* 805394D8  38 BE 01 0C */	addi r5, r30, 0x10c
/* 805394DC  4B C6 B8 C4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 805394FC  4B DE C3 A4 */	b hide__13J3DShapeTableFv
...
/* 80539514  4B DE C3 C4 */	b show__13J3DShapeTableFv
lbl_80539518:
/* 80539518  80 7E 0E 40 */	lwz r3, 0xe40(r30)
/* 8053951C  4B AD 7C A4 */	b entryDL__16mDoExt_McaMorfSOFv
/* 80539520  80 7E 0E 40 */	lwz r3, 0xe40(r30)
/* 80539524  80 A3 00 04 */	lwz r5, 4(r3)
/* 80539528  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8053952C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80539530  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 80539534  80 9E 0D 94 */	lwz r4, 0xd94(r30)
/* 80539538  4B B1 C9 E4 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_8053953C:
/* 8053953C  38 00 00 00 */	li r0, 0
/* 80539540  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80539544  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8053956C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80539570  38 63 CA 54 */	addi r3, r3, g_env_light@l
...
/* 8053959C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 805395A0  4B E0 CF 10 */	b PSMTXCopy
/* 805395A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 805395A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 805395AC  38 81 00 08 */	addi r4, r1, 8
/* 805395B0  4B E0 CF 00 */	b PSMTXCopy
/* 805395B4  38 61 00 08 */	addi r3, r1, 8
/* 805395B8  80 9E 0E 48 */	lwz r4, 0xe48(r30)
/* 805395BC  38 84 00 24 */	addi r4, r4, 0x24
/* 805395C0  4B E0 CE F0 */	b PSMTXCopy
/* 805395C4  80 7E 0E 48 */	lwz r3, 0xe48(r30)
/* 805395C8  4B AD 46 FC */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 805395CC  7F E3 FB 78 */	mr r3, r31
/* 805395D0  80 9E 0D 94 */	lwz r4, 0xd94(r30)
/* 805395D4  80 BE 0E 48 */	lwz r5, 0xe48(r30)
/* 805395D8  4B B1 C9 44 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_805395DC:
/* 805395DC  39 61 00 50 */	addi r11, r1, 0x50
/* 805395E0  4B E2 8C 48 */	b _restgpr_29

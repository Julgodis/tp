...
/* 809E9578  4B 97 8C 60 */	b _savegpr_28
...
/* 809E958C  3C 60 80 9F */	lis r3, lit_4470@ha
/* 809E9590  38 83 F2 A4 */	addi r4, r3, lit_4470@l
/* 809E9594  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 809EF2A4 */
/* 809E9598  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 809EF2A8 */
/* 809E959C  90 61 00 08 */	stw r3, 8(r1)
/* 809E95A0  90 01 00 0C */	stw r0, 0xc(r1)
/* 809E95A4  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 809EF2AC */
...
/* 809E95C8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809E95CC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809E95D0  4B 95 CE E0 */	b PSMTXCopy
/* 809E95D4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E95D8  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 809E95DC  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 809E95E0  D0 1F 08 54 */	stfs f0, 0x854(r31)
/* 809E95E4  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 809E95E8  D0 1F 08 58 */	stfs f0, 0x858(r31)
/* 809E95EC  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 809E960C  4B 95 CE A4 */	b PSMTXCopy
...
/* 809E963C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809E9640  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809E9644  4B 95 CE 6C */	b PSMTXCopy
...
/* 809E9670  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809E9674  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809E9678  4B 95 CE 38 */	b PSMTXCopy
...
/* 809E96A8  3C C0 80 9F */	lis r6, m__17daNpc_Grz_Param_c@ha
/* 809E96AC  38 C6 F1 F4 */	addi r6, r6, m__17daNpc_Grz_Param_c@l
/* 809E96B0  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 809EF234 */
/* 809E96B4  4B 76 9C C8 */	b setLookatMtx__8daNpcF_cFiPif
lbl_809E96B8:
/* 809E96B8  2C 1D 00 01 */	cmpwi r29, 1
/* 809E96BC  40 82 00 30 */	bne lbl_809E96EC
/* 809E96C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E96C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E96C8  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809E96CC  7C 00 00 D0 */	neg r0, r0
/* 809E96D0  7C 04 07 34 */	extsh r4, r0
/* 809E96D4  4B 62 2D 60 */	b mDoMtx_YrotM__FPA4_fs
/* 809E96D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E96DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E96E0  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809E96E4  4B 62 2D E8 */	b mDoMtx_ZrotM__FPA4_fs
/* 809E96E8  48 00 00 34 */	b lbl_809E971C
lbl_809E96EC:
/* 809E96EC  2C 1D 00 04 */	cmpwi r29, 4
/* 809E96F0  40 82 00 2C */	bne lbl_809E971C
/* 809E96F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E96F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E96FC  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809E9700  7C 00 00 D0 */	neg r0, r0
/* 809E9704  7C 04 07 34 */	extsh r4, r0
/* 809E9708  4B 62 2D 2C */	b mDoMtx_YrotM__FPA4_fs
/* 809E970C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E9710  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E9714  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809E9718  4B 62 2D B4 */	b mDoMtx_ZrotM__FPA4_fs
lbl_809E971C:
/* 809E971C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E9720  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E9724  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809E9728  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809E972C  7C 80 F2 14 */	add r4, r0, r30
/* 809E9730  4B 95 CD 80 */	b PSMTXCopy
/* 809E9734  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E9738  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E973C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 809E9740  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 809E9744  4B 95 CD 6C */	b PSMTXCopy
...
/* 809E9774  4B 62 42 1C */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809E9788  4B 97 8A 9C */	b _restgpr_28

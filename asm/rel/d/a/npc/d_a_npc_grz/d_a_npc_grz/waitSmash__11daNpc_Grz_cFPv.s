...
/* 809EC86C 00000018  3C 80 00 00 */	lis r4, m__17daNpc_Grz_Param_c@ha
/* 809EC870 0000001C  3B E4 00 00 */	addi r31, r4, m__17daNpc_Grz_Param_c@l
...
/* 809EC90C 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 809EC910 00000020  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 809EC9B4 00000010  3C 60 00 00 */	lis r3, s_sub__FPvPv@ha
/* 809EC9B8 00000014  38 63 00 00 */	addi r3, r3, s_sub__FPvPv@l
...
/* 809EC9F0 0000004C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809EC9F4 00000050  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809EC9F8 00000054  A8 9D 04 DE */	lha r4, 0x4de(r29)
/* 809EC9FC 00000058  4B FF B9 7D */	bl mDoMtx_YrotS__FPA4_fs
/* 809ECA00 0000005C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809ECA04 00000060  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 809ECA4C 000000A8  3C 60 00 00 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 809ECA50 000000AC  C0 03 00 00 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
...
lbl_809ECA8C:
/* 809ECA8C 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 809ECA90 00000004  38 83 00 00 */	addi r4, r3, g_dComIfG_gameInfo@l
...
/* 809ECB44 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 809ECB48 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 809ECBB4 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 809ECBB8 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_809ECBBC:

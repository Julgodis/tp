...
/* 809EA1F4  4B 97 7F D0 */	b _savegpr_23
/* 809EA1F8  7C 7A 1B 78 */	mr r26, r3
/* 809EA1FC  3C 60 80 9F */	lis r3, m__17daNpc_Grz_Param_c@ha
/* 809EA200  3B C3 F1 F4 */	addi r30, r3, m__17daNpc_Grz_Param_c@l
...
lbl_809EA25C:
/* 809EA25C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA260  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809EA264  80 83 5D AC */	lwz r4, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 809EA268  38 61 00 60 */	addi r3, r1, 0x60
/* 809EA26C  38 84 04 D0 */	addi r4, r4, 0x4d0
/* 809EA270  38 BA 04 D0 */	addi r5, r26, 0x4d0
/* 809EA274  4B 87 C8 C0 */	b __mi__4cXyzCFRC3Vec
...
/* 809EA294  4B 95 CE A4 */	b PSVECSquareMag
...
/* 809EA304  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809EA308  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 809EA374  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809EA378  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_809EA37C:
...
/* 809EA39C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA3A0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA3B4  4B 68 56 70 */	b StartShock__12dVibration_cFii4cXyz
...
/* 809EA3DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA3E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA3F4  4B 68 56 30 */	b StartShock__12dVibration_cFii4cXyz
...
/* 809EA41C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA420  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA434  4B 68 55 F0 */	b StartShock__12dVibration_cFii4cXyz
...
/* 809EA45C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA460  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA474  4B 68 55 B0 */	b StartShock__12dVibration_cFii4cXyz
...
/* 809EA49C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA4A0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA4B4  4B 68 55 70 */	b StartShock__12dVibration_cFii4cXyz
...
/* 809EA4DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA4E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA4F4  4B 68 55 30 */	b StartShock__12dVibration_cFii4cXyz
lbl_809EA4F8:
/* 809EA4F8  3B 60 00 00 */	li r27, 0
/* 809EA4FC  3B 20 00 00 */	li r25, 0
/* 809EA500  3B 00 00 00 */	li r24, 0
/* 809EA504  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809EA508  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 809EA50C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA510  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809EA5AC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809EA5B0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809EA5B4  4B 95 BE FC */	b PSMTXCopy
/* 809EA5B8  38 7A 04 EC */	addi r3, r26, 0x4ec
/* 809EA5BC  4B 62 28 B4 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
...
/* 809EA658  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809EA65C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809EA660  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 809EA684  4B 62 26 E0 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 809EA688  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809EA68C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809EA690  A8 9A 08 F2 */	lha r4, 0x8f2(r26)
/* 809EA694  4B 62 1D A0 */	b mDoMtx_YrotM__FPA4_fs
/* 809EA698  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809EA69C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809EA6A0  38 81 00 6C */	addi r4, r1, 0x6c
/* 809EA6A4  7C 85 23 78 */	mr r5, r4
/* 809EA6A8  4B 95 C6 C4 */	b PSMTXMultVec
...
/* 809EA6D4  4B 88 4B 08 */	b SetC__8cM3dGCylFRC4cXyz
...
/* 809EA6EC  4B 88 4B 0C */	b SetH__8cM3dGCylFf

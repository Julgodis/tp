...
/* 80B0D468  4B 85 4D 6C */	b _savegpr_27
...
/* 80B0D488  3C 80 80 B1 */	lis r4, l_bckGetParamList@ha
/* 80B0D48C  38 84 0A 80 */	addi r4, r4, l_bckGetParamList@l
/* 80B0D490  7C A4 E0 2E */	lwzx r5, r4, r28
/* 80B0D494  2C 05 00 00 */	cmpwi r5, 0
/* 80B0D498  41 80 00 18 */	blt lbl_80B0D4B0
/* 80B0D49C  3C 80 80 B1 */	lis r4, l_arcName@ha
/* 80B0D4A0  38 84 0A B8 */	addi r4, r4, l_arcName@l
/* 80B0D4A4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80B10AB8 */
/* 80B0D4A8  4B 64 56 84 */	b getTrnsfrmKeyAnmP__8daNpcF_cFPci
/* 80B0D4AC  48 00 00 08 */	b lbl_80B0D4B4
lbl_80B0D4B0:
/* 80B0D4B0  38 60 00 00 */	li r3, 0
lbl_80B0D4B4:
/* 80B0D4B4  7C 7B 1B 78 */	mr r27, r3
/* 80B0D4B8  3C 60 80 B1 */	lis r3, l_bckGetParamList@ha
/* 80B0D4BC  38 03 0A 80 */	addi r0, r3, l_bckGetParamList@l
...
/* 80B0D548  3C A0 80 B1 */	lis r5, lit_4358@ha
/* 80B0D54C  C0 25 09 64 */	lfs f1, lit_4358@l(r5)
/* 80B0D550  7F 85 E3 78 */	mr r5, r28
/* 80B0D554  38 C0 00 00 */	li r6, 0
/* 80B0D558  38 E0 FF FF */	li r7, -1
/* 80B0D55C  7F E8 FB 78 */	mr r8, r31
/* 80B0D560  4B 64 57 20 */	b setBckAnm__8daNpcF_cFP15J3DAnmTransformfiiib
...
/* 80B0D590  4B 85 4C 90 */	b _restgpr_27

lbl_809DCE78:
/* 809DCE78 00000000  3C 80 00 00 */	lis r4, cNullVec__6Z2Calc@ha /* 809DF2F8 */
/* 809DCE7C 00000004  38 C4 00 00 */	addi r6, r4, cNullVec__6Z2Calc@l /* 809DF2F8 */
/* 809DCE80 00000008  3C 80 00 00 */	lis r4, __ptmf_null@ha /* 803A2180 */
/* 809DCE84 0000000C  38 A4 00 00 */	addi r5, r4, __ptmf_null@l /* 803A2180 */
/* 809DCE88 00000010  80 85 00 00 */	lwz r4, 0(r5)
/* 809DCE8C 00000014  80 05 00 04 */	lwz r0, 4(r5)
/* 809DCE90 00000018  90 83 0D D4 */	stw r4, 0xdd4(r3)
/* 809DCE94 0000001C  90 03 0D D8 */	stw r0, 0xdd8(r3)
/* 809DCE98 00000020  80 05 00 08 */	lwz r0, 8(r5)
/* 809DCE9C 00000024  90 03 0D DC */	stw r0, 0xddc(r3)
/* 809DCEA0 00000028  3C 80 00 00 */	lis r4, m__17daNpc_grO_Param_c@ha /* 809DEF7C */
/* 809DCEA4 0000002C  38 84 00 00 */	addi r4, r4, m__17daNpc_grO_Param_c@l /* 809DEF7C */
/* 809DCEA8 00000030  88 04 00 6A */	lbz r0, 0x6a(r4)
/* 809DCEAC 00000034  28 00 00 00 */	cmplwi r0, 0
/* 809DCEB0 00000038  41 82 00 20 */	beq lbl_809DCED0
/* 809DCEB4 0000003C  80 86 02 78 */	lwz r4, 0x278(r6)
/* 809DCEB8 00000040  80 06 02 7C */	lwz r0, 0x27c(r6)
/* 809DCEBC 00000044  90 83 0D D4 */	stw r4, 0xdd4(r3)
/* 809DCEC0 00000048  90 03 0D D8 */	stw r0, 0xdd8(r3)
/* 809DCEC4 0000004C  80 06 02 80 */	lwz r0, 0x280(r6)

...
/* 809DD99C  3C A0 80 9E */	lis r5, lit_4812@ha
/* 809DD9A0  C0 25 F0 1C */	lfs f1, lit_4812@l(r5)
...
/* 809DD9BC  3C A0 80 9E */	lis r5, lit_4812@ha
/* 809DD9C0  C0 25 F0 1C */	lfs f1, lit_4812@l(r5)
...
/* 809DDA04  4B 77 2C E8 */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 809DDA20  4B 77 6F C0 */	b chkFindPlayer2__8daNpcF_cFis
...
/* 809DDA38  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 809DDA3C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 809DDA40  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 809DDA44  4B 77 2C 78 */	b entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809DDA60  4B 77 2C 80 */	b remove__18daNpcF_ActorMngr_cFv
/* 809DDA64  38 00 00 00 */	li r0, 0
/* 809DDA68  90 1F 09 6C */	stw r0, 0x96c(r31)
lbl_809DDA6C:
/* 809DDA6C  38 7F 0C 7C */	addi r3, r31, 0xc7c
/* 809DDA70  4B 77 2C 7C */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 809DDAB8  4B 77 65 EC */	b step__8daNpcF_cFsiii
...
/* 809DDAE0  4B 77 2C 0C */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 809DDAF4  3C A0 80 15 */	lis r5, srchAttnActor1__8daNpcF_cFPvPv@ha
/* 809DDAF8  38 A5 26 54 */	addi r5, r5, srchAttnActor1__8daNpcF_cFPvPv@l
/* 809DDAFC  3C C0 80 9E */	lis r6, m__17daNpc_grO_Param_c@ha
/* 809DDB00  38 C6 EF 7C */	addi r6, r6, m__17daNpc_grO_Param_c@l
/* 809DDB04  C0 26 00 54 */	lfs f1, 0x54(r6)	/* effective address: 809DEFD0 */
/* 809DDB08  C0 46 00 58 */	lfs f2, 0x58(r6)	/* effective address: 809DEFD4 */
/* 809DDB0C  C0 66 00 5C */	lfs f3, 0x5c(r6)	/* effective address: 809DEFD8 */
/* 809DDB10  C0 86 00 50 */	lfs f4, 0x50(r6)	/* effective address: 809DEFCC */
/* 809DDB14  A8 DF 04 E6 */	lha r6, 0x4e6(r31)
/* 809DDB18  38 E0 00 78 */	li r7, 0x78
/* 809DDB1C  39 00 00 01 */	li r8, 1
/* 809DDB20  4B 77 68 4C */	b getAttnActorP__8daNpcF_cFiPFPvPv_Pvffffsii
/* 809DDB24  7C 64 1B 79 */	or. r4, r3, r3
/* 809DDB28  41 82 00 24 */	beq lbl_809DDB4C
/* 809DDB2C  38 7F 0C 84 */	addi r3, r31, 0xc84
/* 809DDB30  4B 77 2B 8C */	b entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c

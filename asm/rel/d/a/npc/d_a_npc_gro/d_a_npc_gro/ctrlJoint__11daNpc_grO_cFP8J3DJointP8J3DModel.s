...
/* 809DB224  4B 98 6F B4 */	b _savegpr_28
...
/* 809DB238  3C 60 80 9E */	lis r3, lit_4605@ha
/* 809DB23C  38 83 F0 10 */	addi r4, r3, lit_4605@l
/* 809DB240  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 809DF010 */
/* 809DB244  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 809DF014 */
/* 809DB248  90 61 00 08 */	stw r3, 8(r1)
/* 809DB24C  90 01 00 0C */	stw r0, 0xc(r1)
/* 809DB250  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 809DF018 */
...
/* 809DB274  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809DB278  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809DB27C  4B 96 B2 34 */	b PSMTXCopy
/* 809DB280  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB284  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 809DB288  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 809DB28C  D0 1F 08 54 */	stfs f0, 0x854(r31)
/* 809DB290  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 809DB294  D0 1F 08 58 */	stfs f0, 0x858(r31)
/* 809DB298  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 809DB2B8  4B 96 B1 F8 */	b PSMTXCopy
...
/* 809DB2E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809DB2EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809DB2F0  4B 96 B1 C0 */	b PSMTXCopy
...
/* 809DB31C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809DB320  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809DB324  4B 96 B1 8C */	b PSMTXCopy
...
/* 809DB354  3C C0 80 9E */	lis r6, m__17daNpc_grO_Param_c@ha
/* 809DB358  38 C6 EF 7C */	addi r6, r6, m__17daNpc_grO_Param_c@l
/* 809DB35C  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 809DEFBC */
/* 809DB360  4B 77 80 1C */	b setLookatMtx__8daNpcF_cFiPif
lbl_809DB364:
/* 809DB364  2C 1D 00 01 */	cmpwi r29, 1
/* 809DB368  40 82 00 30 */	bne lbl_809DB398
/* 809DB36C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB370  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809DB374  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809DB378  4B 63 11 54 */	b mDoMtx_ZrotM__FPA4_fs
/* 809DB37C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB380  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809DB384  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809DB388  7C 00 00 D0 */	neg r0, r0
/* 809DB38C  7C 04 07 34 */	extsh r4, r0
/* 809DB390  4B 63 10 A4 */	b mDoMtx_YrotM__FPA4_fs
/* 809DB394  48 00 00 34 */	b lbl_809DB3C8
lbl_809DB398:
/* 809DB398  2C 1D 00 04 */	cmpwi r29, 4
/* 809DB39C  40 82 00 2C */	bne lbl_809DB3C8
/* 809DB3A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB3A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809DB3A8  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809DB3AC  4B 63 11 20 */	b mDoMtx_ZrotM__FPA4_fs
/* 809DB3B0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB3B4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809DB3B8  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809DB3BC  7C 00 00 D0 */	neg r0, r0
/* 809DB3C0  7C 04 07 34 */	extsh r4, r0
/* 809DB3C4  4B 63 10 70 */	b mDoMtx_YrotM__FPA4_fs
lbl_809DB3C8:
/* 809DB3C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB3CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809DB3D0  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809DB3D4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809DB3D8  7C 80 F2 14 */	add r4, r0, r30
/* 809DB3DC  4B 96 B0 D4 */	b PSMTXCopy
/* 809DB3E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809DB3E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809DB3E8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 809DB3EC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 809DB3F0  4B 96 B0 C0 */	b PSMTXCopy
...
/* 809DB420  4B 63 25 70 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809DB434  4B 98 6D F0 */	b _restgpr_28

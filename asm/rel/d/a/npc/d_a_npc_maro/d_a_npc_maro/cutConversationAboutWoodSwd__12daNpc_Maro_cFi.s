...
/* 8055DF8C  4B E0 42 48 */	b _savegpr_27
/* 8055DF90  7C 7E 1B 78 */	mr r30, r3
/* 8055DF94  7C 9B 23 78 */	mr r27, r4
/* 8055DF98  3B E0 00 00 */	li r31, 0
/* 8055DF9C  3B 80 FF FF */	li r28, -1
/* 8055DFA0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8055DFA4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8055DFA8  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 8055DFAC  7F A3 EB 78 */	mr r3, r29
/* 8055DFB0  3C A0 80 56 */	lis r5, struct_80564D58+0x0@ha
/* 8055DFB4  38 A5 4D 58 */	addi r5, r5, struct_80564D58+0x0@l
/* 8055DFB8  38 A5 02 1B */	addi r5, r5, 0x21b
/* 8055DFBC  38 C0 00 03 */	li r6, 3
/* 8055DFC0  4B AE A1 2C */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8055DFD8  4B AE 9D 74 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8055E000  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8055E004  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8055E008  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8055E00C  4B AB C7 04 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8055E03C  4B BE 76 C0 */	b remove__18daNpcT_ActorMngr_cFv
/* 8055E040  38 00 00 00 */	li r0, 0
/* 8055E044  90 1E 0B C8 */	stw r0, 0xbc8(r30)
/* 8055E048  3C 60 80 56 */	lis r3, lit_4318@ha
/* 8055E04C  C0 03 4C A0 */	lfs f0, lit_4318@l(r3)
...
/* 8055E08C  4B BE D5 BC */	b step__8daNpcT_cFsiiii
...
/* 8055E0AC  4B BE 77 EC */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055E0B0  93 BE 0B 5C */	stw r29, 0xb5c(r30)
/* 8055E0B4  38 00 00 09 */	li r0, 9
/* 8055E0B8  90 1E 0B 58 */	stw r0, 0xb58(r30)
/* 8055E0BC  3C 60 80 56 */	lis r3, lit_5128@ha
/* 8055E0C0  C0 03 4C CC */	lfs f0, lit_5128@l(r3)
...
/* 8055E0DC  4B BE 77 BC */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8055E0E0  93 BE 0B 80 */	stw r29, 0xb80(r30)
/* 8055E0E4  38 00 00 00 */	li r0, 0
/* 8055E0E8  90 1E 0B 7C */	stw r0, 0xb7c(r30)
/* 8055E0EC  3C 60 80 56 */	lis r3, lit_5128@ha
/* 8055E0F0  C0 03 4C CC */	lfs f0, lit_5128@l(r3)
...
/* 8055E110  4B E0 41 10 */	b _restgpr_27

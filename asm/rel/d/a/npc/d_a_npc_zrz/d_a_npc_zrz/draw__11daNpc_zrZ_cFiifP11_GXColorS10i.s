...
/* 80B94B44  4B 7C D6 94 */	b _savegpr_28
...
/* 80B94B90  3C 60 80 BA */	lis r3, lit_4677@ha
/* 80B94B94  C8 43 B0 8C */	lfd f2, lit_4677@l(r3)
...
lbl_80B94BCC:
/* 80B94BCC  3C 60 80 BA */	lis r3, lit_4522@ha
/* 80B94BD0  C0 43 B0 84 */	lfs f2, lit_4522@l(r3)
lbl_80B94BD4:
/* 80B94BD4  FC 00 12 10 */	fabs f0, f2
/* 80B94BD8  FC 20 00 18 */	frsp f1, f0
/* 80B94BDC  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80B94BE0  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80B94BF4  3C 60 80 BA */	lis r3, lit_4675@ha
/* 80B94BF8  C0 03 B0 88 */	lfs f0, lit_4675@l(r3)
...
lbl_80B94C84:
/* 80B94C84  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B94C88  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B94C8C  38 80 00 07 */	li r4, 7
/* 80B94C90  38 BC 04 D0 */	addi r5, r28, 0x4d0
/* 80B94C94  38 DC 01 0C */	addi r6, r28, 0x10c
/* 80B94C98  4B 60 EB 2C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80B94C9C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B94CA0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B94CA4  80 9F 00 04 */	lwz r4, 4(r31)
/* 80B94CA8  38 BC 01 0C */	addi r5, r28, 0x10c
/* 80B94CAC  4B 61 00 F4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80B94CF0  4B 47 88 F8 */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
lbl_80B94CF4:
...
/* 80B94D0C  4B 47 89 CC */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80B94D10:
...
/* 80B94D28  4B 47 8A 80 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_80B94D2C:
...
/* 80B94D3C  4B 48 86 F0 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
lbl_80B94D40:
/* 80B94D40  4B 61 78 3C */	b dKy_darkworld_check__Fv
/* 80B94D44  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80B94D48  41 82 00 4C */	beq lbl_80B94D94
/* 80B94D4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B94D50  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80B94D54  80 04 5F 88 */	lwz r0, 0x5f88(r4)	/* effective address: 8040C148 */
/* 80B94D58  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80B94D5C  3B A3 4A C8 */	addi r29, r3, j3dSys@l
/* 80B94D60  90 1D 00 48 */	stw r0, 0x48(r29)	/* effective address: 80434B10 */
/* 80B94D64  80 04 5F 8C */	lwz r0, 0x5f8c(r4)	/* effective address: 8040C14C */
/* 80B94D68  90 1D 00 4C */	stw r0, 0x4c(r29)	/* effective address: 80434B14 */
/* 80B94D6C  38 7C 0B DC */	addi r3, r28, 0xbdc
/* 80B94D70  38 80 00 00 */	li r4, 0
/* 80B94D74  4B 47 9A 4C */	b entryDL__21mDoExt_invisibleModelFP4cXyz
/* 80B94D78  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B94D7C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B94D80  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80B94D84  90 1D 00 48 */	stw r0, 0x48(r29)
/* 80B94D88  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
...
/* 80B94D9C  4B 47 9A 24 */	b entryDL__21mDoExt_invisibleModelFP4cXyz
lbl_80B94DA0:
...
/* 80B94DB4  4B 79 A9 44 */	b removeTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern
lbl_80B94DB8:
...
/* 80B94DCC  4B 79 A9 E8 */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_80B94DD0:
...
/* 80B94DE4  4B 79 AA 9C */	b removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
lbl_80B94DE8:
...
/* 80B94E04  4B 7C D4 20 */	b _restgpr_28

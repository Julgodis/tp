...
/* 8056C5C4  4B DF 5C 04 */	b _savegpr_24
/* 8056C5C8  7C 78 1B 78 */	mr r24, r3
/* 8056C5CC  7C 99 23 78 */	mr r25, r4
/* 8056C5D0  3C 60 80 57 */	lis r3, m__18daNpc_Taro_Param_c@ha
/* 8056C5D4  3B E3 16 C8 */	addi r31, r3, m__18daNpc_Taro_Param_c@l
/* 8056C5D8  3B A0 00 00 */	li r29, 0
/* 8056C5DC  3B 80 FF FF */	li r28, -1
/* 8056C5E0  3B 60 00 00 */	li r27, 0
/* 8056C5E4  3B 40 00 00 */	li r26, 0
/* 8056C5E8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056C5EC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056C5F0  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 8056C5F4  7F C3 F3 78 */	mr r3, r30
/* 8056C5F8  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C5FC  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C600  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056C604  38 C0 00 03 */	li r6, 3
/* 8056C608  4B AD BA E4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C620  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C624  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C628  38 A5 02 A0 */	addi r5, r5, 0x2a0
/* 8056C62C  38 C0 00 03 */	li r6, 3
/* 8056C630  4B AD BA BC */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C648  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C64C  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C650  38 A5 02 A6 */	addi r5, r5, 0x2a6
/* 8056C654  38 C0 00 03 */	li r6, 3
/* 8056C658  4B AD BA 94 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C690  4B BD 90 78 */	b getActorP__18daNpcT_ActorMngr_cFv
/* 8056C694  90 61 00 14 */	stw r3, 0x14(r1)
/* 8056C698  38 78 10 D8 */	addi r3, r24, 0x10d8
/* 8056C69C  4B BD 90 6C */	b getActorP__18daNpcT_ActorMngr_cFv
/* 8056C6A0  90 61 00 18 */	stw r3, 0x18(r1)
/* 8056C6A4  38 78 10 C8 */	addi r3, r24, 0x10c8
/* 8056C6A8  4B BD 90 60 */	b getActorP__18daNpcT_ActorMngr_cFv
/* 8056C6AC  90 61 00 1C */	stw r3, 0x1c(r1)
/* 8056C6B0  80 01 00 10 */	lwz r0, 0x10(r1)
/* 8056C6B4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056C6B8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056C6BC  90 04 5E F0 */	stw r0, 0x5ef0(r4)	/* effective address: 8040C0B0 */
/* 8056C6C0  80 01 00 14 */	lwz r0, 0x14(r1)
/* 8056C6C4  90 04 5E F4 */	stw r0, 0x5ef4(r4)	/* effective address: 8040C0B4 */
/* 8056C6C8  80 01 00 18 */	lwz r0, 0x18(r1)
/* 8056C6CC  90 04 5E F8 */	stw r0, 0x5ef8(r4)	/* effective address: 8040C0B8 */
/* 8056C6D0  90 64 5E FC */	stw r3, 0x5efc(r4)	/* effective address: 8040C0BC */
/* 8056C6D4  38 00 00 00 */	li r0, 0
/* 8056C6D8  90 04 5F 00 */	stw r0, 0x5f00(r4)	/* effective address: 8040C0C0 */
/* 8056C6DC  90 04 5F 04 */	stw r0, 0x5f04(r4)	/* effective address: 8040C0C4 */
/* 8056C6E0  90 04 5F 08 */	stw r0, 0x5f08(r4)	/* effective address: 8040C0C8 */
/* 8056C6E4  90 04 5F 0C */	stw r0, 0x5f0c(r4)	/* effective address: 8040C0CC */
/* 8056C6E8  90 04 5F 10 */	stw r0, 0x5f10(r4)	/* effective address: 8040C0D0 */
/* 8056C6EC  90 04 5F 14 */	stw r0, 0x5f14(r4)	/* effective address: 8040C0D4 */
/* 8056C6F0  7F C3 F3 78 */	mr r3, r30
/* 8056C6F4  7F 24 CB 78 */	mr r4, r25
/* 8056C6F8  4B AD B6 54 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8056C728  4B BD F4 C8 */	b initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 8056C768  4B BD 8F 94 */	b remove__18daNpcT_ActorMngr_cFv
...
/* 8056C7B4  4B BD EE 94 */	b step__8daNpcT_cFsiiii
...
/* 8056C7D4  4B BD 90 C4 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056C800  4B BD 90 98 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056C844  4B BD 8E B8 */	b remove__18daNpcT_ActorMngr_cFv
...
/* 8056C884  4B BD F3 F4 */	b talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8056C8B8  4B DF 59 5C */	b _restgpr_24

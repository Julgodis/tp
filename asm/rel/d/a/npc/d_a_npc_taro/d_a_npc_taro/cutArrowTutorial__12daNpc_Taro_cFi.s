...
/* 8056C8DC  4B DF 58 F0 */	b _savegpr_25
...
/* 8056C8F4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056C8F8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056C8FC  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 8056C900  7F E3 FB 78 */	mr r3, r31
/* 8056C904  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C908  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C90C  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056C910  38 C0 00 03 */	li r6, 3
/* 8056C914  4B AD B7 D8 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C92C  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C930  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C934  38 A5 02 A0 */	addi r5, r5, 0x2a0
/* 8056C938  38 C0 00 03 */	li r6, 3
/* 8056C93C  4B AD B7 B0 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C954  4B AD B3 F8 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8056C968  3C 60 80 57 */	lis r3, lit_7781@ha
/* 8056C96C  38 63 31 7C */	addi r3, r3, lit_7781@l
...
/* 8056C984  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056C988  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056C98C  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8056C990  4B BD 8D 50 */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8056C9AC  4B BD 8E EC */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056C9B0  93 9A 0B 5C */	stw r28, 0xb5c(r26)
/* 8056C9B4  38 00 00 1F */	li r0, 0x1f
/* 8056C9B8  90 1A 0B 58 */	stw r0, 0xb58(r26)
/* 8056C9BC  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056C9C0  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CA18  4B BD FA E8 */	b daNpcT_getPlayerInfoFromPlayerList__FiiP4cXyzP5csXyz
/* 8056CA1C  2C 03 00 00 */	cmpwi r3, 0
/* 8056CA20  41 82 00 2C */	beq lbl_8056CA4C
/* 8056CA24  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056CA28  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056CA2C  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 8056CA30  38 81 00 10 */	addi r4, r1, 0x10
/* 8056CA34  A8 A1 00 0A */	lha r5, 0xa(r1)
/* 8056CA38  38 C0 00 00 */	li r6, 0
/* 8056CA3C  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
/* 8056CA40  81 8C 01 54 */	lwz r12, 0x154(r12)
/* 8056CA44  7D 89 03 A6 */	mtctr r12
/* 8056CA48  4E 80 04 21 */	bctrl 
lbl_8056CA4C:
/* 8056CA4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056CA50  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056CA54  80 63 5D B8 */	lwz r3, 0x5db8(r3)	/* effective address: 8040BF78 */
...
/* 8056CA84  4B DF 56 00 */	b __ptmf_scall
/* 8056CA88  60 00 00 00 */	nop 
lbl_8056CA8C:
/* 8056CA8C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8056CA90  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8056CA94  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 8056CAA4  4B D4 29 F8 */	b subBgmStart__8Z2SeqMgrFUl
/* 8056CAA8  38 60 00 3C */	li r3, 0x3c
/* 8056CAAC  4B BE 00 40 */	b daNpcT_onTmpBit__FUl
/* 8056CAB0  38 60 00 3F */	li r3, 0x3f
/* 8056CAB4  4B BE 00 78 */	b daNpcT_offTmpBit__FUl
/* 8056CAB8  38 60 00 40 */	li r3, 0x40
/* 8056CABC  4B BE 00 70 */	b daNpcT_offTmpBit__FUl
/* 8056CAC0  38 60 00 41 */	li r3, 0x41
/* 8056CAC4  4B BE 00 68 */	b daNpcT_offTmpBit__FUl
...
/* 8056CAE0  4B BD 8D B8 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056CAE4  93 9A 0B 5C */	stw r28, 0xb5c(r26)
/* 8056CAE8  38 00 00 1F */	li r0, 0x1f
/* 8056CAEC  90 1A 0B 58 */	stw r0, 0xb58(r26)
/* 8056CAF0  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CAF4  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CB50  4B BD 8B 90 */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8056CB64  4B BD 8B 98 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CB68  38 00 00 00 */	li r0, 0
/* 8056CB6C  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CB70  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CB74  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CBAC  4B BD 8B 50 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CBB0  38 00 00 00 */	li r0, 0
/* 8056CBB4  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CBB8  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CBBC  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CBEC  4B BD 8C AC */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056CBF0  93 3A 0B 5C */	stw r25, 0xb5c(r26)
/* 8056CBF4  38 00 00 1F */	li r0, 0x1f
/* 8056CBF8  90 1A 0B 58 */	stw r0, 0xb58(r26)
/* 8056CBFC  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CC00  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CC1C  4B BD 8C 7C */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056CC20  93 3A 0B 80 */	stw r25, 0xb80(r26)
/* 8056CC24  38 00 00 00 */	li r0, 0
/* 8056CC28  90 1A 0B 7C */	stw r0, 0xb7c(r26)
/* 8056CC2C  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CC30  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
/* 8056CC34  D0 1A 0B 8C */	stfs f0, 0xb8c(r26)
lbl_8056CC38:
/* 8056CC38  93 9A 0D C4 */	stw r28, 0xdc4(r26)
/* 8056CC3C  38 60 00 4C */	li r3, 0x4c
/* 8056CC40  4B BD FE 6C */	b daNpcT_chkEvtBit__FUl
/* 8056CC44  2C 03 00 00 */	cmpwi r3, 0
/* 8056CC48  40 82 00 70 */	bne lbl_8056CCB8
/* 8056CC4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056CC50  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056CC54  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 8056CC78  4B BD 8A 84 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CC7C  38 00 00 00 */	li r0, 0
/* 8056CC80  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CC84  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CC88  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CCAC  4B D0 3F 58 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 8056CCB0  B0 7A 0D C8 */	sth r3, 0xdc8(r26)
/* 8056CCB4  48 00 00 1C */	b lbl_8056CCD0
lbl_8056CCB8:
/* 8056CCB8  7F 43 D3 78 */	mr r3, r26
/* 8056CCBC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056CCC0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056CCC4  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8056CCC8  4B AA DA 48 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8056CCEC  4B BD DD 2C */	b setAngle__8daNpcT_cFs
/* 8056CCF0  38 7A 0B 98 */	addi r3, r26, 0xb98
/* 8056CCF4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056CCF8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056CCFC  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8056CD00  4B BD 89 E0 */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 8056CD04  48 00 00 E4 */	b lbl_8056CDE8
lbl_8056CD08:
/* 8056CD08  7F 43 D3 78 */	mr r3, r26
/* 8056CD0C  A8 9A 04 B6 */	lha r4, 0x4b6(r26)
/* 8056CD10  4B BD DD 08 */	b setAngle__8daNpcT_cFs
...
/* 8056CD24  4B BD 89 D8 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CD28  38 00 00 00 */	li r0, 0
/* 8056CD2C  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CD30  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CD34  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CD78  4B BD 8B 20 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056CD7C  93 3A 0B 5C */	stw r25, 0xb5c(r26)
/* 8056CD80  38 00 00 1F */	li r0, 0x1f
/* 8056CD84  90 1A 0B 58 */	stw r0, 0xb58(r26)
/* 8056CD88  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CD8C  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CDA8  4B BD 8A F0 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8056CDAC  93 3A 0B 80 */	stw r25, 0xb80(r26)
/* 8056CDB0  38 00 00 00 */	li r0, 0
/* 8056CDB4  90 1A 0B 7C */	stw r0, 0xb7c(r26)
/* 8056CDB8  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CDBC  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CDD0  4B BD DC 48 */	b setAngle__8daNpcT_cFs
/* 8056CDD4  38 7A 0B 98 */	addi r3, r26, 0xb98
/* 8056CDD8  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056CDDC  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056CDE0  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8056CDE4  4B BD 88 FC */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
lbl_8056CDE8:
/* 8056CDE8  28 1D 00 0A */	cmplwi r29, 0xa
/* 8056CDEC  41 81 02 B0 */	bgt lbl_8056D09C
/* 8056CDF0  3C 60 80 57 */	lis r3, lit_7782@ha
/* 8056CDF4  38 63 31 50 */	addi r3, r3, lit_7782@l
...
/* 8056CE2C  4B AD AF 20 */	b getIsAddvance__16dEvent_manager_cFi
/* 8056CE30  2C 03 00 00 */	cmpwi r3, 0
/* 8056CE34  40 82 00 A0 */	bne lbl_8056CED4
/* 8056CE38  38 7A 11 60 */	addi r3, r26, 0x1160
/* 8056CE3C  4B BD 88 CC */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 8056CE8C  4B BD 88 70 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CE90  38 00 00 00 */	li r0, 0
/* 8056CE94  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CE98  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CE9C  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CEE0  4B BD FB CC */	b daNpcT_chkEvtBit__FUl
...
/* 8056CEFC  4B BD 88 00 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CF00  38 00 00 00 */	li r0, 0
/* 8056CF04  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CF08  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CF0C  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056CF5C  4B BD E6 EC */	b step__8daNpcT_cFsiiii
...
/* 8056CFA0  4B BD FB 0C */	b daNpcT_chkEvtBit__FUl
/* 8056CFA4  2C 03 00 00 */	cmpwi r3, 0
/* 8056CFA8  40 82 00 70 */	bne lbl_8056D018
/* 8056CFAC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056CFB0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056CFB4  88 03 5D B0 */	lbz r0, 0x5db0(r3)	/* effective address: 8040BF70 */
...
/* 8056CFD8  4B BD 87 24 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056CFDC  38 00 00 00 */	li r0, 0
/* 8056CFE0  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056CFE4  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056CFE8  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056D00C  4B D0 3B F8 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8056D028  4B BD 86 D4 */	b remove__18daNpcT_ActorMngr_cFv
/* 8056D02C  38 00 00 00 */	li r0, 0
/* 8056D030  90 1A 0B C8 */	stw r0, 0xbc8(r26)
/* 8056D034  3C 60 80 57 */	lis r3, lit_4472@ha
/* 8056D038  C0 03 17 AC */	lfs f0, lit_4472@l(r3)
...
/* 8056D058  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056D05C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056D060  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8056D064  4B AA D6 AC */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8056D090  4B BD E5 B8 */	b step__8daNpcT_cFsiiii
...
/* 8056D0A4  4B DF 51 74 */	b _restgpr_25

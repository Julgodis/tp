...
/* 8056C15C  4B DF 60 6C */	b _savegpr_24
/* 8056C160  7C 78 1B 78 */	mr r24, r3
/* 8056C164  7C 99 23 78 */	mr r25, r4
/* 8056C168  3C 60 80 57 */	lis r3, m__18daNpc_Taro_Param_c@ha
/* 8056C16C  3B E3 16 C8 */	addi r31, r3, m__18daNpc_Taro_Param_c@l
/* 8056C170  3B A0 00 00 */	li r29, 0
/* 8056C174  3B 80 FF FF */	li r28, -1
/* 8056C178  3B 60 00 00 */	li r27, 0
/* 8056C17C  3B 40 00 00 */	li r26, 0
/* 8056C180  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8056C184  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8056C188  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 8056C18C  7F C3 F3 78 */	mr r3, r30
/* 8056C190  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C194  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C198  38 A5 02 9C */	addi r5, r5, 0x29c
/* 8056C19C  38 C0 00 03 */	li r6, 3
/* 8056C1A0  4B AD BF 4C */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C1B8  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C1BC  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C1C0  38 A5 02 A6 */	addi r5, r5, 0x2a6
/* 8056C1C4  38 C0 00 03 */	li r6, 3
/* 8056C1C8  4B AD BF 24 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C1E0  3C A0 80 57 */	lis r5, struct_80571908+0x0@ha
/* 8056C1E4  38 A5 19 08 */	addi r5, r5, struct_80571908+0x0@l
/* 8056C1E8  38 A5 02 AC */	addi r5, r5, 0x2ac
/* 8056C1EC  38 C0 00 03 */	li r6, 3
/* 8056C1F0  4B AD BE FC */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8056C218  4B BD 94 F0 */	b getActorP__18daNpcT_ActorMngr_cFv
/* 8056C21C  90 61 00 0C */	stw r3, 0xc(r1)
/* 8056C220  80 01 00 08 */	lwz r0, 8(r1)
/* 8056C224  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8056C228  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8056C22C  90 04 5E F0 */	stw r0, 0x5ef0(r4)	/* effective address: 8040C0B0 */
/* 8056C230  90 64 5E F4 */	stw r3, 0x5ef4(r4)	/* effective address: 8040C0B4 */
/* 8056C234  38 00 00 00 */	li r0, 0
/* 8056C238  90 04 5E F8 */	stw r0, 0x5ef8(r4)	/* effective address: 8040C0B8 */
/* 8056C23C  90 04 5E FC */	stw r0, 0x5efc(r4)	/* effective address: 8040C0BC */
/* 8056C240  90 04 5F 00 */	stw r0, 0x5f00(r4)	/* effective address: 8040C0C0 */
/* 8056C244  90 04 5F 04 */	stw r0, 0x5f04(r4)	/* effective address: 8040C0C4 */
/* 8056C248  90 04 5F 08 */	stw r0, 0x5f08(r4)	/* effective address: 8040C0C8 */
/* 8056C24C  90 04 5F 0C */	stw r0, 0x5f0c(r4)	/* effective address: 8040C0CC */
/* 8056C250  90 04 5F 10 */	stw r0, 0x5f10(r4)	/* effective address: 8040C0D0 */
/* 8056C254  90 04 5F 14 */	stw r0, 0x5f14(r4)	/* effective address: 8040C0D4 */
/* 8056C258  7F C3 F3 78 */	mr r3, r30
/* 8056C25C  7F 24 CB 78 */	mr r4, r25
/* 8056C260  4B AD BA EC */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8056C290  4B BD F9 60 */	b initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8056C294  7F 03 C3 78 */	mr r3, r24
/* 8056C298  80 81 00 0C */	lwz r4, 0xc(r1)
/* 8056C29C  4B AA E4 74 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8056C2B4  4B BD F9 3C */	b initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8056C2B8  7F 03 C3 78 */	mr r3, r24
/* 8056C2BC  80 81 00 0C */	lwz r4, 0xc(r1)
/* 8056C2C0  4B AA E4 50 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8056C300  4B BD 94 08 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 8056C328  4B BD 93 D4 */	b remove__18daNpcT_ActorMngr_cFv
...
/* 8056C360  4B AA C9 80 */	b fopAc_IsActor__FPv
...
/* 8056C374  4B BD 93 6C */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8056C3B4  4B BD F2 94 */	b step__8daNpcT_cFsiiii
...
/* 8056C3D4  4B BD 94 C4 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056C41C  4B BD 92 E0 */	b remove__18daNpcT_ActorMngr_cFv
...
/* 8056C474  4B BD F1 D4 */	b step__8daNpcT_cFsiiii
...
/* 8056C494  4B BD 94 04 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 8056C4B8  4B BD 92 50 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 8056C4E0  4B BD 92 1C */	b remove__18daNpcT_ActorMngr_cFv
...
/* 8056C518  4B AA C7 C8 */	b fopAc_IsActor__FPv
...
/* 8056C52C  4B BD 91 B4 */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
...
/* 8056C564  4B BD F7 14 */	b talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 8056C5A0  4B DF 5C 74 */	b _restgpr_24

...
/* 8096F2F4  4B 9F 2E E0 */	b _savegpr_27
/* 8096F2F8  7C 7D 1B 78 */	mr r29, r3
/* 8096F2FC  7C 9B 23 78 */	mr r27, r4
/* 8096F300  3B E0 00 00 */	li r31, 0
/* 8096F304  3B C0 FF FF */	li r30, -1
/* 8096F308  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8096F30C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8096F310  3B 83 4F F8 */	addi r28, r3, 0x4ff8
/* 8096F314  7F 83 E3 78 */	mr r3, r28
/* 8096F318  3C A0 80 97 */	lis r5, struct_8097299C+0x0@ha
/* 8096F31C  38 A5 29 9C */	addi r5, r5, struct_8097299C+0x0@l
/* 8096F320  38 A5 00 DA */	addi r5, r5, 0xda
/* 8096F324  38 C0 00 03 */	li r6, 3
/* 8096F328  4B 6D 8D C4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8096F340  4B 6D 8A 0C */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8096F378  4B 7D 65 20 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8096F37C  93 9D 0B 5C */	stw r28, 0xb5c(r29)
/* 8096F380  38 00 00 0A */	li r0, 0xa
/* 8096F384  90 1D 0B 58 */	stw r0, 0xb58(r29)
/* 8096F388  3C 60 80 97 */	lis r3, lit_4758@ha
/* 8096F38C  C0 03 29 40 */	lfs f0, lit_4758@l(r3)
...
/* 8096F3A8  4B 7D 64 F0 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 8096F3AC  93 9D 0B 80 */	stw r28, 0xb80(r29)
/* 8096F3B0  38 00 00 00 */	li r0, 0
/* 8096F3B4  90 1D 0B 7C */	stw r0, 0xb7c(r29)
/* 8096F3B8  3C 60 80 97 */	lis r3, lit_4758@ha
/* 8096F3BC  C0 03 29 40 */	lfs f0, lit_4758@l(r3)
...
/* 8096F3D0  4B 7D C8 20 */	b initTalk__8daNpcT_cFiPP10fopAc_ac_c
/* 8096F3D4  38 00 00 00 */	li r0, 0
/* 8096F3D8  98 1D 0F F4 */	stb r0, 0xff4(r29)
/* 8096F3DC  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 8096F3E0  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 8096F3E4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 8096F3E8  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 8096F3EC  4B 94 04 98 */	b subBgmStop__8Z2SeqMgrFv
/* 8096F3F0  38 60 00 1C */	li r3, 0x1c
/* 8096F3F4  4B 7D D6 F8 */	b daNpcT_onTmpBit__FUl
lbl_8096F3F8:
...
/* 8096F420  4B 7D 62 DC */	b remove__18daNpcT_ActorMngr_cFv
/* 8096F424  38 00 00 00 */	li r0, 0
/* 8096F428  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8096F42C  3C 60 80 97 */	lis r3, lit_4328@ha
/* 8096F430  C0 03 29 28 */	lfs f0, lit_4328@l(r3)
...
/* 8096F478  4B 7D C1 D0 */	b step__8daNpcT_cFsiiii
...
/* 8096F490  4B 7D 62 6C */	b remove__18daNpcT_ActorMngr_cFv
/* 8096F494  38 00 00 00 */	li r0, 0
/* 8096F498  90 1D 0B C8 */	stw r0, 0xbc8(r29)
/* 8096F49C  3C 60 80 97 */	lis r3, lit_4328@ha
/* 8096F4A0  C0 03 29 28 */	lfs f0, lit_4328@l(r3)
...
/* 8096F4D0  4B 7D C7 A8 */	b talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci

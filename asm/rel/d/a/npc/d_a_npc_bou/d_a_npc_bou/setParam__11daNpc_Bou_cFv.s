...
/* 8096DDF8  AB 83 00 48 */	lha r28, 0x48(r3)	/* effective address: 809728A8 */
/* 8096DDFC  AB 63 00 4A */	lha r27, 0x4a(r3)	/* effective address: 809728AA */
/* 8096DE00  AB 43 00 4C */	lha r26, 0x4c(r3)	/* effective address: 809728AC */
/* 8096DE04  AB 23 00 4E */	lha r25, 0x4e(r3)	/* effective address: 809728AE */
...
lbl_8096DE34:
/* 8096DE34  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8096DE38  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 8096DE3C  80 7D 5D AC */	lwz r3, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 8096DE40  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 80400628 */
...
/* 8096DEEC  A0 03 00 AC */	lhz r0, 0xac(r3)	/* effective address: 80430234 */
/* 8096DEF0  60 00 00 01 */	ori r0, r0, 1
/* 8096DEF4  B0 03 00 AC */	sth r0, 0xac(r3)	/* effective address: 80430234 */
lbl_8096DEF8:
...
/* 8096DF0C  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80972868 */
/* 8096DF10  D0 1E 04 EC */	stfs f0, 0x4ec(r30)
/* 8096DF14  D0 1E 04 F0 */	stfs f0, 0x4f0(r30)
/* 8096DF18  D0 1E 04 F4 */	stfs f0, 0x4f4(r30)
/* 8096DF1C  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 80972870 */
...
/* 8096DF30  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 80972874 */
/* 8096DF34  D0 1E 0D EC */	stfs f0, 0xdec(r30)
/* 8096DF38  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 8097287C */
/* 8096DF3C  D0 1E 0D F0 */	stfs f0, 0xdf0(r30)
/* 8096DF40  C0 03 00 50 */	lfs f0, 0x50(r3)	/* effective address: 809728B0 */
...
/* 8096DF5C  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80972878 */
/* 8096DF60  D0 1E 08 D0 */	stfs f0, 0x8d0(r30)
/* 8096DF64  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 8097286C */
/* 8096DF68  D0 1E 0D E8 */	stfs f0, 0xde8(r30)
/* 8096DF6C  C0 03 00 6C */	lfs f0, 0x6c(r3)	/* effective address: 809728CC */
/* 8096DF70  D0 1E 0A 80 */	stfs f0, 0xa80(r30)
/* 8096DF74  C0 03 00 44 */	lfs f0, 0x44(r3)	/* effective address: 809728A4 */
/* 8096DF78  D0 1E 0A 84 */	stfs f0, 0xa84(r30)
/* 8096DF7C  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80972864 */

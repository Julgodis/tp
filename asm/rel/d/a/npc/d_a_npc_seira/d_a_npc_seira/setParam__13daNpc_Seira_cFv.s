...
/* 80ACC700  AB 83 00 48 */	lha r28, 0x48(r3)	/* effective address: 80ACFE38 */
/* 80ACC704  AB A3 00 4A */	lha r29, 0x4a(r3)	/* effective address: 80ACFE3A */
/* 80ACC708  AB 63 00 4C */	lha r27, 0x4c(r3)	/* effective address: 80ACFE3C */
/* 80ACC70C  AB C3 00 4E */	lha r30, 0x4e(r3)	/* effective address: 80ACFE3E */
...
lbl_80ACC72C:
/* 80ACC72C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80ACC730  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80ACC734  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80ACC738  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80ACC790  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80ACFDF8 */
/* 80ACC794  D0 1F 04 EC */	stfs f0, 0x4ec(r31)
/* 80ACC798  D0 1F 04 F0 */	stfs f0, 0x4f0(r31)
/* 80ACC79C  D0 1F 04 F4 */	stfs f0, 0x4f4(r31)
/* 80ACC7A0  C0 03 00 10 */	lfs f0, 0x10(r3)	/* effective address: 80ACFE00 */
...
/* 80ACC7B4  C0 03 00 14 */	lfs f0, 0x14(r3)	/* effective address: 80ACFE04 */
/* 80ACC7B8  D0 1F 0D EC */	stfs f0, 0xdec(r31)
/* 80ACC7BC  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 80ACFE0C */
...
/* 80ACC7D8  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80ACFE08 */
/* 80ACC7DC  D0 1F 08 D0 */	stfs f0, 0x8d0(r31)
/* 80ACC7E0  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 80ACFDFC */
/* 80ACC7E4  D0 1F 0D E8 */	stfs f0, 0xde8(r31)
/* 80ACC7E8  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80ACFDF4 */
/* 80ACC7EC  D0 1F 05 30 */	stfs f0, 0x530(r31)
/* 80ACC7F0  C0 03 00 6C */	lfs f0, 0x6c(r3)	/* effective address: 80ACFE5C */
/* 80ACC7F4  D0 1F 0A 80 */	stfs f0, 0xa80(r31)
/* 80ACC7F8  C0 03 00 44 */	lfs f0, 0x44(r3)	/* effective address: 80ACFE34 */

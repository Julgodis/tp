...
/* 809A335C  4B 8C 4E 78 */	b ChkUsed__9cBgW_BgIdCFv
/* 809A3360  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809A3364  41 82 00 18 */	beq lbl_809A337C
/* 809A3368  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A336C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A3370  38 63 0F 38 */	addi r3, r3, 0xf38
/* 809A3374  80 9E 15 1C */	lwz r4, 0x151c(r30)
/* 809A3378  4B 6D 0E D8 */	b Release__4cBgSFP9dBgW_Base
lbl_809A337C:
/* 809A337C  80 7E 1B 34 */	lwz r3, 0x1b34(r30)
/* 809A3380  28 03 00 00 */	cmplwi r3, 0
/* 809A3384  41 82 00 24 */	beq lbl_809A33A8
/* 809A3388  4B 8C 4E 4C */	b ChkUsed__9cBgW_BgIdCFv
/* 809A338C  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809A3390  41 82 00 18 */	beq lbl_809A33A8
/* 809A3394  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A3398  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A339C  38 63 0F 38 */	addi r3, r3, 0xf38
/* 809A33A0  80 9E 1B 34 */	lwz r4, 0x1b34(r30)
/* 809A33A4  4B 6D 0E AC */	b Release__4cBgSFP9dBgW_Base
lbl_809A33A8:
/* 809A33A8  80 7E 04 A4 */	lwz r3, 0x4a4(r30)
/* 809A33AC  4B 67 69 0C */	b fopAcM_delete__FUi
/* 809A33B0  80 7E 25 54 */	lwz r3, 0x2554(r30)
/* 809A33B4  4B 67 69 04 */	b fopAcM_delete__FUi
/* 809A33B8  38 7E 25 48 */	addi r3, r30, 0x2548
/* 809A33BC  3C 80 80 9A */	lis r4, l_arcName@ha
/* 809A33C0  38 84 51 30 */	addi r4, r4, l_arcName@l
/* 809A33C4  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 809A5130 */
/* 809A33C8  4B 68 9C 40 */	b dComIfG_resDelete__FP30request_of_phase_process_classPCc
/* 809A33CC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A33D0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A33D4  38 63 09 58 */	addi r3, r3, 0x958
/* 809A33D8  38 80 00 01 */	li r4, 1
/* 809A33DC  4B 69 13 E8 */	b offTbox__12dSv_memBit_cFi
/* 809A33E0  34 1E 25 0C */	addic. r0, r30, 0x250c
/* 809A33E4  41 82 00 54 */	beq lbl_809A3438
/* 809A33E8  3C 60 80 3B */	lis r3, __vt__9dCcD_Stts@ha
/* 809A33EC  38 63 C2 E4 */	addi r3, r3, __vt__9dCcD_Stts@l
...
/* 809A34BC  3C 80 80 9A */	lis r4, __dt__4cXyzFv@ha
/* 809A34C0  38 84 DA 24 */	addi r4, r4, __dt__4cXyzFv@l
/* 809A34C4  38 A0 00 0C */	li r5, 0xc
/* 809A34C8  38 C0 00 0A */	li r6, 0xa
/* 809A34CC  4B 9B E8 1C */	b __destroy_arr
/* 809A34D0  38 7E 0D 78 */	addi r3, r30, 0xd78
/* 809A34D4  3C 80 80 9A */	lis r4, __dt__4cXyzFv@ha
/* 809A34D8  38 84 DA 24 */	addi r4, r4, __dt__4cXyzFv@l
/* 809A34DC  38 A0 00 0C */	li r5, 0xc
/* 809A34E0  38 C0 00 0A */	li r6, 0xa
/* 809A34E4  4B 9B E8 04 */	b __destroy_arr
lbl_809A34E8:
/* 809A34E8  38 7E 0C 3C */	addi r3, r30, 0xc3c
/* 809A34EC  38 80 FF FF */	li r4, -1
/* 809A34F0  4B 92 1C 24 */	b __dt__14Z2CreatureRideFv
/* 809A34F4  38 7E 07 4C */	addi r3, r30, 0x74c
/* 809A34F8  3C 80 80 9A */	lis r4, __dt__8dCcD_CylFv@ha
/* 809A34FC  38 84 37 98 */	addi r4, r4, __dt__8dCcD_CylFv@l
/* 809A3500  38 A0 01 3C */	li r5, 0x13c
/* 809A3504  38 C0 00 04 */	li r6, 4
/* 809A3508  4B 9B E7 E0 */	b __destroy_arr
/* 809A350C  34 7E 05 74 */	addic. r3, r30, 0x574
/* 809A3510  41 82 00 28 */	beq lbl_809A3538
/* 809A3514  3C 80 80 9A */	lis r4, __vt__12dBgS_ObjAcch@ha
/* 809A3518  38 84 52 38 */	addi r4, r4, __vt__12dBgS_ObjAcch@l

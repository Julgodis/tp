...
/* 809A46EC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809A46F0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809A46F4  4B 9A 1D BC */	b PSMTXCopy
/* 809A46F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A46FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809A4700  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 809A4704  D0 01 00 20 */	stfs f0, 0x20(r1)
/* 809A4708  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 809A470C  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 809A4710  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 809A4714  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 809A4718  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A471C  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 809A4720  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)	/* effective address: 8040BEFC */
...
/* 809A4760  3D 60 80 9A */	lis r11, lit_5111@ha
/* 809A4764  C0 2B 50 2C */	lfs f1, lit_5111@l(r11)
/* 809A4768  4B 6A 83 28 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 809A4794  4B 8D C0 4C */	b func_802807E0
/* 809A4798  38 00 00 00 */	li r0, 0
/* 809A479C  80 7E 1B C8 */	lwz r3, 0x1bc8(r30)
/* 809A47A0  98 03 00 BB */	stb r0, 0xbb(r3)
/* 809A47A4  3C 60 80 9A */	lis r3, lit_4121@ha
/* 809A47A8  C0 03 4F 70 */	lfs f0, lit_4121@l(r3)
/* 809A47AC  80 7E 1B C8 */	lwz r3, 0x1bc8(r30)
/* 809A47B0  D0 03 00 28 */	stfs f0, 0x28(r3)
/* 809A47B4  3C 60 80 45 */	lis r3, mParticleTracePCB__13dPa_control_c@ha
/* 809A47B8  38 03 0E C8 */	addi r0, r3, mParticleTracePCB__13dPa_control_c@l
...
/* 809A4804  3D 60 80 9A */	lis r11, lit_5111@ha
/* 809A4808  C0 2B 50 2C */	lfs f1, lit_5111@l(r11)
/* 809A480C  4B 6A 82 84 */	b set__13dPa_control_cFUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf
...
/* 809A4838  4B 8D BF A8 */	b func_802807E0
/* 809A483C  38 00 00 00 */	li r0, 0
/* 809A4840  80 7E 1B CC */	lwz r3, 0x1bcc(r30)
/* 809A4844  98 03 00 BB */	stb r0, 0xbb(r3)
/* 809A4848  3C 60 80 9A */	lis r3, lit_4121@ha
/* 809A484C  C0 03 4F 70 */	lfs f0, lit_4121@l(r3)
/* 809A4850  80 7E 1B CC */	lwz r3, 0x1bcc(r30)
/* 809A4854  D0 03 00 28 */	stfs f0, 0x28(r3)
/* 809A4858  3C 60 80 45 */	lis r3, mParticleTracePCB__13dPa_control_c@ha
/* 809A485C  38 03 0E C8 */	addi r0, r3, mParticleTracePCB__13dPa_control_c@l

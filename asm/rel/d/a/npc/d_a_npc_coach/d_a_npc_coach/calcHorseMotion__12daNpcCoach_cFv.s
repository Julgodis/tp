...
/* 809A1830 00000004  4B 9C 09 9C */	b _savegpr_25
/* 809A1834 00000008  7C 7D 1B 78 */	mr r29, r3
/* 809A1838 0000000C  3C 60 80 9A */	lis r3, M_attr__12daNpcCoach_c@ha
/* 809A183C 00000010  3B E3 4E D0 */	addi r31, r3, M_attr__12daNpcCoach_c@l
...
/* 809A1870 0000001C  C0 23 00 98 */	lfs f1, 0x98(r3)	/* effective address: 809A4F68 */
...
/* 809A1888 00000010  4B 6A FF 28 */	b dPath_GetPnt__FPC5dPathi
...
/* 809A18AC 00000008  4B 8C F3 58 */	b cLib_targetAngleY__FPC3VecPC3Vec
/* 809A18B0 0000000C  7C 64 1B 78 */	mr r4, r3
/* 809A18B4 00000010  A8 7D 04 DE */	lha r3, 0x4de(r29)
/* 809A18B8 00000014  4B 8C F5 6C */	b cLib_distanceAngleS__Fss
/* 809A18BC 00000018  C0 5F 01 5C */	lfs f2, 0x15c(r31)	/* effective address: 809A502C */
/* 809A18C0 0000001C  7C 03 00 D0 */	neg r0, r3
/* 809A18C4 00000020  C8 3F 01 78 */	lfd f1, 0x178(r31)	/* effective address: 809A5048 */
...
/* 809A18E0 0000003C  C0 1F 01 E4 */	lfs f0, 0x1e4(r31)	/* effective address: 809A50B4 */
/* 809A18E4 00000040  EC 01 00 24 */	fdivs f0, f1, f0
/* 809A18E8 00000044  EC 22 00 2A */	fadds f1, f2, f0
/* 809A18EC 00000048  C0 1F 00 A0 */	lfs f0, 0xa0(r31)	/* effective address: 809A4F70 */
...
/* 809A1914 00000008  C0 5F 01 E8 */	lfs f2, 0x1e8(r31)	/* effective address: 809A50B8 */
/* 809A1918 0000000C  C0 7F 01 EC */	lfs f3, 0x1ec(r31)	/* effective address: 809A50BC */
/* 809A191C 00000010  C0 9F 01 F0 */	lfs f4, 0x1f0(r31)	/* effective address: 809A50C0 */
/* 809A1920 00000014  4B 8C E0 5C */	b cLib_addCalc__FPfffff
/* 809A1924 00000018  48 00 00 18 */	b lbl_809A193C
lbl_809A1928:
/* 809A1928 00000000  38 7D 0C EC */	addi r3, r29, 0xcec
/* 809A192C 00000004  C0 5F 01 F4 */	lfs f2, 0x1f4(r31)	/* effective address: 809A50C4 */
/* 809A1930 00000008  C0 7F 01 90 */	lfs f3, 0x190(r31)	/* effective address: 809A5060 */
/* 809A1934 0000000C  C0 9F 01 F0 */	lfs f4, 0x1f0(r31)	/* effective address: 809A50C0 */
/* 809A1938 00000010  4B 8C E0 44 */	b cLib_addCalc__FPfffff
lbl_809A193C:
/* 809A193C 00000000  C0 3F 00 A0 */	lfs f1, 0xa0(r31)	/* effective address: 809A4F70 */
...
/* 809A195C 00000008  4B 92 3B C0 */	b startWheelSound__15Z2SoundObjCoachFf
lbl_809A1960:
...
/* 809A197C 0000001C  4B 9C 37 54 */	b abs
/* 809A1980 00000020  38 9F 00 00 */	addi r4, r31, 0
/* 809A1984 00000024  A8 84 00 62 */	lha r4, 0x62(r4)	/* effective address: 809A4F32 */
...
/* 809A19B8 00000004  3C 60 80 9A */	lis r3, __vt__8cM3dGPla@ha
/* 809A19BC 00000008  38 03 52 80 */	addi r0, r3, __vt__8cM3dGPla@l
/* 809A19C0 0000000C  90 01 00 30 */	stw r0, 0x30(r1)
/* 809A19C4 00000010  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809A19C8 00000014  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 809A19DC 00000028  4B 6D 2D 68 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 809A19F0 0000003C  4B 67 C1 E8 */	b fopAcM_getPolygonAngle__FPC8cM3dGPlas
/* 809A19F4 00000040  3C 80 80 9A */	lis r4, __vt__8cM3dGPla@ha
/* 809A19F8 00000044  38 04 52 80 */	addi r0, r4, __vt__8cM3dGPla@l
...
/* 809A1A0C 00000004  3C 60 80 9A */	lis r3, __vt__8cM3dGPla@ha
/* 809A1A10 00000008  38 03 52 80 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 809A1A28 00000010  4B 8C EB 18 */	b cLib_addCalcAngleS__FPsssss
/* 809A1A2C 00000014  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809A1A30 00000018  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 809A1A60 00000048  4B 67 8C 6C */	b fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz
/* 809A1A64 0000004C  A8 1D 04 E6 */	lha r0, 0x4e6(r29)
/* 809A1A68 00000050  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c
/* 809A1A6C 00000054  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809A1A70 00000058  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 809A1A80 00000068  C0 5F 01 F8 */	lfs f2, 0x1f8(r31)	/* effective address: 809A50C8 */
...
/* 809A1AA8 00000090  C0 1F 01 FC */	lfs f0, 0x1fc(r31)	/* effective address: 809A50CC */
...
/* 809A1ABC 000000A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809A1AC0 000000A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 809A1AD4 0000000C  4B 8C D7 08 */	b SetC__8cM3dGCylFRC4cXyz
/* 809A1AD8 00000010  7F 43 D3 78 */	mr r3, r26
/* 809A1ADC 00000014  38 99 07 4C */	addi r4, r25, 0x74c
/* 809A1AE0 00000018  4B 8C 30 C8 */	b Set__4cCcSFP8cCcD_Obj
...
/* 809A1B14 0000004C  4B 6D 4F 98 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 809A1B24 0000005C  C0 1F 01 AC */	lfs f0, 0x1ac(r31)	/* effective address: 809A507C */
/* 809A1B28 00000060  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 809A1B2C 00000000  40 81 00 10 */	ble lbl_809A1B3C
/* 809A1B30 00000004  C0 1F 00 A0 */	lfs f0, 0xa0(r31)	/* effective address: 809A4F70 */
...
/* 809A1B40 00000004  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 809A4ED4 */
/* 809A1B44 00000008  D0 1D 05 34 */	stfs f0, 0x534(r29)
lbl_809A1B48:
/* 809A1B48 00000000  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 809A1B4C 00000004  4B 66 B2 18 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 809A1B50 00000008  38 7D 04 E4 */	addi r3, r29, 0x4e4
/* 809A1B54 0000000C  4B 66 B3 F0 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 809A1B58 00000010  80 7D 05 68 */	lwz r3, 0x568(r29)
/* 809A1B5C 00000014  80 83 00 04 */	lwz r4, 4(r3)
/* 809A1B60 00000018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A1B64 0000001C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809A1B68 00000020  38 84 00 24 */	addi r4, r4, 0x24
/* 809A1B6C 00000024  4B 9A 49 44 */	b PSMTXCopy
...
/* 809A1B84 0000003C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809A1B88 00000040  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809A1B8C 00000044  4B 9A 49 24 */	b PSMTXCopy
/* 809A1B90 00000048  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A1B94 0000004C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809A1B98 00000050  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 809A1B9C 00000054  D0 1D 0C D8 */	stfs f0, 0xcd8(r29)
/* 809A1BA0 00000058  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 809A1BA4 0000005C  D0 1D 0C DC */	stfs f0, 0xcdc(r29)
/* 809A1BA8 00000060  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 809A1BCC 00000008  4B 9C 06 4C */	b _restgpr_25

...
/* 809A2758  4B 9B FA 80 */	b _savegpr_28
/* 809A275C  7C 7D 1B 78 */	mr r29, r3
/* 809A2760  3C 60 80 9A */	lis r3, M_attr__12daNpcCoach_c@ha
/* 809A2764  3B E3 4E D0 */	addi r31, r3, M_attr__12daNpcCoach_c@l
...
/* 809A27F0  4B 6A EF C0 */	b dPath_GetPnt__FPC5dPathi
...
/* 809A2814  4B 8C E3 F0 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 809A282C  4B 8C DD 14 */	b cLib_addCalcAngleS__FPsssss
...
/* 809A28A4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A28A8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A28AC  38 63 09 78 */	addi r3, r3, 0x978
/* 809A28B0  88 04 00 02 */	lbz r0, 2(r4)
/* 809A28B4  7C 04 07 74 */	extsb r4, r0
/* 809A28B8  4B 69 23 30 */	b isSwitch__12dSv_danBit_cCFi
...
lbl_809A28F8:
/* 809A28F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A28FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A2900  38 63 09 78 */	addi r3, r3, 0x978
/* 809A2904  88 04 00 02 */	lbz r0, 2(r4)
/* 809A2908  7C 04 07 74 */	extsb r4, r0
/* 809A290C  4B 69 22 8C */	b onSwitch__12dSv_danBit_cFi
lbl_809A2910:
...
/* 809A29AC  3C 60 80 9A */	lis r3, s_sub__FPvPv@ha
/* 809A29B0  38 63 E0 E0 */	addi r3, r3, s_sub__FPvPv@l
/* 809A29B4  7F A4 EB 78 */	mr r4, r29
/* 809A29B8  4B 67 E9 80 */	b fpcEx_Search__FPFPvPv_PvPv
...
/* 809A29F8  3C 60 80 9A */	lis r3, l_arcName@ha
/* 809A29FC  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 809A2A00  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 809A2A04  38 80 00 0C */	li r4, 0xc
/* 809A2A08  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 809A2A0C  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 809A2A10  3C A5 00 02 */	addis r5, r5, 2
/* 809A2A14  38 C0 00 80 */	li r6, 0x80
/* 809A2A18  38 A5 C2 F8 */	addi r5, r5, -15624
/* 809A2A1C  4B 69 98 D0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809A2A40  4B 66 AD 9C */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
/* 809A2AA8  4B 8C 4D C4 */	b cM_rnd__Fv
...
/* 809A2AF8  4B 6A EC B8 */	b dPath_GetPnt__FPC5dPathi
...
/* 809A2B30  4B 9A 48 6C */	b PSVECSquareDistance
...
/* 809A2BA0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809A2BA4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 809A2C10  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809A2C14  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_809A2C18:
...
/* 809A2CDC  4B 6A EA D4 */	b dPath_GetPnt__FPC5dPathi
...
/* 809A2D00  4B 9A 46 9C */	b PSVECSquareDistance
...
/* 809A2D70  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809A2D74  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 809A2DE0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809A2DE4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_809A2DE8:
...
/* 809A2E10  4B 6A E9 A0 */	b dPath_GetPnt__FPC5dPathi
...
/* 809A2E34  4B 8C DD D0 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 809A2E84  4B 9B F3 A0 */	b _restgpr_28

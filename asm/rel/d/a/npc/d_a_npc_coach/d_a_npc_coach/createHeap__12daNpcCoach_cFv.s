...
/* 8099E4D0  4B 9C 3D 08 */	b _savegpr_28
/* 8099E4D4  7C 7F 1B 78 */	mr r31, r3
/* 8099E4D8  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E4DC  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E4E0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E4E4  38 80 00 25 */	li r4, 0x25
/* 8099E4E8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8099E4EC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 8099E500  4B 69 DD EC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8099E504  7C 7D 1B 78 */	mr r29, r3
/* 8099E508  38 60 00 50 */	li r3, 0x50
/* 8099E50C  4B 93 07 40 */	b __nw__FUl
/* 8099E510  7C 7C 1B 79 */	or. r28, r3, r3
/* 8099E514  41 82 00 74 */	beq lbl_8099E588
/* 8099E518  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E51C  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E520  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E524  38 80 00 0F */	li r4, 0xf
/* 8099E528  7F C5 F3 78 */	mr r5, r30
/* 8099E52C  38 C0 00 80 */	li r6, 0x80
/* 8099E530  4B 69 DD BC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E574  3D 40 80 9A */	lis r10, lit_5111@ha
/* 8099E578  C0 2A 50 2C */	lfs f1, lit_5111@l(r10)
/* 8099E57C  39 40 00 00 */	li r10, 0
/* 8099E580  4B 67 2D C8 */	b __ct__15mDoExt_McaMorf2FP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8099E5A4  4B 67 3C 44 */	b stopZelAnime__15mDoExt_McaMorf2Fv
...
/* 8099E5D0  3C 60 80 9A */	lis r3, jointHorseCallBack__FP8J3DJointi@ha
/* 8099E5D4  38 83 D6 D8 */	addi r4, r3, jointHorseCallBack__FP8J3DJointi@l
...
/* 8099E610  4B 93 06 3C */	b __nw__FUl
/* 8099E614  7C 7C 1B 79 */	or. r28, r3, r3
/* 8099E618  41 82 00 20 */	beq lbl_8099E638
/* 8099E61C  3C 80 80 9A */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8099E620  38 04 52 8C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8099E624  90 1C 00 00 */	stw r0, 0(r28)
/* 8099E628  38 80 00 00 */	li r4, 0
/* 8099E62C  4B 98 9D D0 */	b init__12J3DFrameCtrlFs
/* 8099E630  38 00 00 00 */	li r0, 0
/* 8099E634  90 1C 00 14 */	stw r0, 0x14(r28)
lbl_8099E638:
/* 8099E638  93 9F 05 6C */	stw r28, 0x56c(r31)
/* 8099E63C  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E640  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E644  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E648  38 80 00 2D */	li r4, 0x2d
/* 8099E64C  7F C5 F3 78 */	mr r5, r30
/* 8099E650  38 C0 00 80 */	li r6, 0x80
/* 8099E654  4B 69 DC 98 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E674  3D 00 80 9A */	lis r8, lit_5111@ha
/* 8099E678  C0 28 50 2C */	lfs f1, lit_5111@l(r8)
/* 8099E67C  39 00 00 00 */	li r8, 0
/* 8099E680  39 20 FF FF */	li r9, -1
/* 8099E684  4B 66 EE C8 */	b init__13mDoExt_btpAnmFP16J3DMaterialTableP16J3DAnmTexPatterniifss
...
/* 8099E69C  4B 93 05 B0 */	b __nw__FUl
/* 8099E6A0  7C 7D 1B 79 */	or. r29, r3, r3
/* 8099E6A4  41 82 00 20 */	beq lbl_8099E6C4
/* 8099E6A8  3C 80 80 9A */	lis r4, __vt__12J3DFrameCtrl@ha
/* 8099E6AC  38 04 52 8C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 8099E6B0  90 1D 00 00 */	stw r0, 0(r29)
/* 8099E6B4  38 80 00 00 */	li r4, 0
/* 8099E6B8  4B 98 9D 44 */	b init__12J3DFrameCtrlFs
/* 8099E6BC  38 00 00 00 */	li r0, 0
/* 8099E6C0  90 1D 00 18 */	stw r0, 0x18(r29)
lbl_8099E6C4:
/* 8099E6C4  93 BF 05 70 */	stw r29, 0x570(r31)
/* 8099E6C8  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E6CC  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E6D0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E6D4  38 80 00 0C */	li r4, 0xc
/* 8099E6D8  7F C5 F3 78 */	mr r5, r30
/* 8099E6DC  38 C0 00 80 */	li r6, 0x80
/* 8099E6E0  4B 69 DC 0C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E6FC  3C E0 80 9A */	lis r7, lit_5111@ha
/* 8099E700  C0 27 50 2C */	lfs f1, lit_5111@l(r7)
/* 8099E704  38 E0 00 00 */	li r7, 0
/* 8099E708  39 00 FF FF */	li r8, -1
/* 8099E70C  39 20 00 00 */	li r9, 0
/* 8099E710  4B 66 F0 CC */	b init__13mDoExt_bckAnmFP15J3DAnmTransformiifssb
...
lbl_8099E724:
/* 8099E724  3C 60 80 9A */	lis r3, lit_4121@ha
/* 8099E728  C0 03 4F 70 */	lfs f0, lit_4121@l(r3)
/* 8099E72C  D0 1F 0C E4 */	stfs f0, 0xce4(r31)
/* 8099E730  38 00 00 00 */	li r0, 0
/* 8099E734  90 1F 0C F4 */	stw r0, 0xcf4(r31)
/* 8099E738  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E73C  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E740  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E744  38 80 00 39 */	li r4, 0x39
/* 8099E748  7F C5 F3 78 */	mr r5, r30
/* 8099E74C  38 C0 00 80 */	li r6, 0x80
/* 8099E750  4B 69 DB 9C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E768  4B 67 4B F8 */	b init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
lbl_8099E77C:
/* 8099E77C  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E780  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E784  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E788  38 80 00 39 */	li r4, 0x39
/* 8099E78C  7F C5 F3 78 */	mr r5, r30
/* 8099E790  38 C0 00 80 */	li r6, 0x80
/* 8099E794  4B 69 DB 58 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E7AC  4B 67 4B B4 */	b init__19mDoExt_3DlineMat1_cFUsUsP7ResTIMGi
...
lbl_8099E7C0:
/* 8099E7C0  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E7C4  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E7C8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E7CC  38 80 00 24 */	li r4, 0x24
/* 8099E7D0  7F C5 F3 78 */	mr r5, r30
/* 8099E7D4  38 C0 00 80 */	li r6, 0x80
/* 8099E7D8  4B 69 DB 14 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E7E8  4B 67 64 6C */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8099E80C  3C 60 80 9A */	lis r3, jointFrontWheelCallBack__FP8J3DJointi@ha
/* 8099E810  38 83 D7 2C */	addi r4, r3, jointFrontWheelCallBack__FP8J3DJointi@l
...
lbl_8099E888:
/* 8099E888  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E88C  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E890  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E894  38 80 00 33 */	li r4, 0x33
/* 8099E898  7F C5 F3 78 */	mr r5, r30
/* 8099E89C  38 C0 00 80 */	li r6, 0x80
/* 8099E8A0  4B 69 DA 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E8B4  4B 6D B6 84 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_8099E8C8:
/* 8099E8C8  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E8CC  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E8D0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E8D4  38 80 00 23 */	li r4, 0x23
/* 8099E8D8  7F C5 F3 78 */	mr r5, r30
/* 8099E8DC  38 C0 00 80 */	li r6, 0x80
/* 8099E8E0  4B 69 DA 0C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E8F0  4B 67 63 64 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 8099E938  3C 60 80 9A */	lis r3, jointRearWheelCallBack__FP8J3DJointi@ha
/* 8099E93C  38 03 D8 0C */	addi r0, r3, jointRearWheelCallBack__FP8J3DJointi@l
...
/* 8099E95C  3C 60 80 9A */	lis r3, jointCoachCallBack__FP8J3DJointi@ha
/* 8099E960  38 03 D8 EC */	addi r0, r3, jointCoachCallBack__FP8J3DJointi@l
...
lbl_8099E9B4:
/* 8099E9B4  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E9B8  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E9BC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099E9C0  38 80 00 32 */	li r4, 0x32
/* 8099E9C4  7F C5 F3 78 */	mr r5, r30
/* 8099E9C8  38 C0 00 80 */	li r6, 0x80
/* 8099E9CC  4B 69 D9 20 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099E9E0  4B 6D B5 58 */	b Set__4cBgWFP6cBgD_tUlPA3_A4_f
...
lbl_8099E9F4:
/* 8099E9F4  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099E9F8  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099E9FC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099EA00  38 80 00 27 */	li r4, 0x27
/* 8099EA04  7F C5 F3 78 */	mr r5, r30
/* 8099EA08  38 C0 00 80 */	li r6, 0x80
/* 8099EA0C  4B 69 D8 E0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8099EA10  7C 7D 1B 78 */	mr r29, r3
/* 8099EA14  38 60 00 58 */	li r3, 0x58
/* 8099EA18  4B 93 02 34 */	b __nw__FUl
/* 8099EA1C  7C 7C 1B 79 */	or. r28, r3, r3
/* 8099EA20  41 82 00 6C */	beq lbl_8099EA8C
/* 8099EA24  3C 60 80 9A */	lis r3, l_arcName@ha
/* 8099EA28  38 63 51 30 */	addi r3, r3, l_arcName@l
/* 8099EA2C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 809A5130 */
/* 8099EA30  38 80 00 20 */	li r4, 0x20
/* 8099EA34  7F C5 F3 78 */	mr r5, r30
/* 8099EA38  38 C0 00 80 */	li r6, 0x80
/* 8099EA3C  4B 69 D8 B0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 8099EA74  3D 20 80 9A */	lis r9, lit_5111@ha
/* 8099EA78  C0 29 50 2C */	lfs f1, lit_5111@l(r9)
/* 8099EA7C  39 20 00 00 */	li r9, 0
/* 8099EA80  39 40 FF FF */	li r10, -1
/* 8099EA84  4B 67 1D 4C */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8099EAA8  4B 67 28 68 */	b stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 8099EAC4  4B 9C 37 60 */	b _restgpr_28

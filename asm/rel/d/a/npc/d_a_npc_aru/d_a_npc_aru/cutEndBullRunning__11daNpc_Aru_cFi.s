...
/* 80954C1C  4B A0 D5 B4 */	b _savegpr_26
/* 80954C20  7C 7E 1B 78 */	mr r30, r3
/* 80954C24  7C 9A 23 78 */	mr r26, r4
/* 80954C28  3B E0 00 00 */	li r31, 0
/* 80954C2C  3B 60 FF FF */	li r27, -1
/* 80954C30  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80954C34  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80954C38  3B 83 0F 38 */	addi r28, r3, 0xf38
/* 80954C3C  3B BC 40 C0 */	addi r29, r28, 0x40c0
/* 80954C40  7F A3 EB 78 */	mr r3, r29
/* 80954C44  3C A0 80 95 */	lis r5, struct_8095781C+0x0@ha
/* 80954C48  38 A5 78 1C */	addi r5, r5, struct_8095781C+0x0@l
/* 80954C4C  38 A5 00 C8 */	addi r5, r5, 0xc8
/* 80954C50  38 C0 00 03 */	li r6, 3
/* 80954C54  4B 6F 34 98 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80954C6C  4B 6F 30 E0 */	b getIsAddvance__16dEvent_manager_cFi
...
lbl_80954CA4:
/* 80954CA4  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80954CA8  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80954CAC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80954CB0  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80954CB4  4B 95 AB D0 */	b subBgmStop__8Z2SeqMgrFv
/* 80954CB8  48 00 00 AC */	b lbl_80954D64
lbl_80954CBC:
/* 80954CBC  38 60 00 B5 */	li r3, 0xb5
/* 80954CC0  4B 7F 7E AC */	b daNpcT_chkTmpBit__FUl
/* 80954CC4  2C 03 00 00 */	cmpwi r3, 0
/* 80954CC8  41 82 00 9C */	beq lbl_80954D64
/* 80954CCC  38 60 00 B6 */	li r3, 0xb6
/* 80954CD0  4B 7F 7E 1C */	b daNpcT_onTmpBit__FUl
/* 80954CD4  48 00 00 90 */	b lbl_80954D64
lbl_80954CD8:
/* 80954CD8  38 60 00 AF */	li r3, 0xaf
/* 80954CDC  4B 7F 7E 90 */	b daNpcT_chkTmpBit__FUl
/* 80954CE0  2C 03 00 00 */	cmpwi r3, 0
/* 80954CE4  41 82 00 80 */	beq lbl_80954D64
/* 80954CE8  38 60 00 B0 */	li r3, 0xb0
/* 80954CEC  4B 7F 7D 40 */	b daNpcT_onEvtBit__FUl
...
/* 80954E34  3C 80 80 95 */	lis r4, lit_4100@ha
/* 80954E38  C0 24 77 98 */	lfs f1, lit_4100@l(r4)
...
/* 80954E50  4B 6D 23 20 */	b dStage_changeScene__FifUlScsi
...
/* 80954E7C  4B 7F 7C F0 */	b daNpcT_chkTmpBit__FUl
...
/* 80954E98  4B 7F 7C 54 */	b daNpcT_onTmpBit__FUl
lbl_80954E9C:
/* 80954E9C  38 60 00 0C */	li r3, 0xc
/* 80954EA0  3C 80 80 95 */	lis r4, lit_4100@ha
/* 80954EA4  C0 24 77 98 */	lfs f1, lit_4100@l(r4)
...
/* 80954EBC  4B 6D 22 B4 */	b dStage_changeScene__FifUlScsi
/* 80954EC0  48 00 00 70 */	b lbl_80954F30
lbl_80954EC4:
/* 80954EC4  38 60 00 B4 */	li r3, 0xb4
/* 80954EC8  4B 7F 7C A4 */	b daNpcT_chkTmpBit__FUl
/* 80954ECC  2C 03 00 00 */	cmpwi r3, 0
/* 80954ED0  41 82 00 2C */	beq lbl_80954EFC
/* 80954ED4  38 60 00 0A */	li r3, 0xa
/* 80954ED8  3C 80 80 95 */	lis r4, lit_4100@ha
/* 80954EDC  C0 24 77 98 */	lfs f1, lit_4100@l(r4)
...
/* 80954EF4  4B 6D 22 7C */	b dStage_changeScene__FifUlScsi
/* 80954EF8  48 00 00 38 */	b lbl_80954F30
lbl_80954EFC:
/* 80954EFC  38 60 00 B0 */	li r3, 0xb0
/* 80954F00  4B 7F 7C 6C */	b daNpcT_chkTmpBit__FUl
/* 80954F04  2C 03 00 00 */	cmpwi r3, 0
/* 80954F08  41 82 00 28 */	beq lbl_80954F30
/* 80954F0C  38 60 00 07 */	li r3, 7
/* 80954F10  3C 80 80 95 */	lis r4, lit_4100@ha
/* 80954F14  C0 24 77 98 */	lfs f1, lit_4100@l(r4)
...
/* 80954F2C  4B 6D 22 44 */	b dStage_changeScene__FifUlScsi
lbl_80954F30:
/* 80954F30  7F E3 FB 78 */	mr r3, r31
/* 80954F34  39 61 00 20 */	addi r11, r1, 0x20
/* 80954F38  4B A0 D2 E4 */	b _restgpr_26

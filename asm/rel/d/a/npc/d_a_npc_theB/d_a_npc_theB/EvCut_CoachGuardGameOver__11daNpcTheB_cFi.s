...
/* 80B00214  4B 86 1F C4 */	b _savegpr_28
/* 80B00218  7C 7C 1B 78 */	mr r28, r3
/* 80B0021C  7C 9D 23 78 */	mr r29, r4
/* 80B00220  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B00224  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B00228  3B C3 4F F8 */	addi r30, r3, 0x4ff8
/* 80B0022C  7F C3 F3 78 */	mr r3, r30
/* 80B00230  4B 54 7D 2C */	b getMyNowCutName__16dEvent_manager_cFi
/* 80B00234  7C 7F 1B 78 */	mr r31, r3
/* 80B00238  7F C3 F3 78 */	mr r3, r30
/* 80B0023C  7F A4 EB 78 */	mr r4, r29
/* 80B00240  4B 54 7B 0C */	b getIsAddvance__16dEvent_manager_cFi
...
lbl_80B0027C:
/* 80B0027C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80B00280  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80B00284  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 80B0029C  4B 7A ED 74 */	b bgmStart__8Z2SeqMgrFUlUll
/* 80B002A0  48 00 00 68 */	b lbl_80B00308
lbl_80B002A4:
/* 80B002A4  80 1C 04 A4 */	lwz r0, 0x4a4(r28)
/* 80B002A8  90 01 00 0C */	stw r0, 0xc(r1)
/* 80B002AC  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80B002B0  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80B002B4  38 81 00 0C */	addi r4, r1, 0xc
/* 80B002B8  4B 51 95 40 */	b fopAcIt_Judge__FPFPvPv_PvPv
/* 80B002BC  3C 80 80 B0 */	lis r4, lit_4248@ha
/* 80B002C0  C0 24 0D F0 */	lfs f1, lit_4248@l(r4)
/* 80B002C4  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80B002C8  3C 80 80 B0 */	lis r4, lit_5423@ha
/* 80B002CC  C0 04 0F 9C */	lfs f0, lit_5423@l(r4)
...
/* 80B002E0  4B E9 DA 48 */	b setPosAngle__12daNpcCoach_cFR4cXyzR5csXyz
/* 80B002E4  48 00 00 24 */	b lbl_80B00308
lbl_80B002E8:
/* 80B002E8  38 00 00 59 */	li r0, 0x59
/* 80B002EC  B0 01 00 08 */	sth r0, 8(r1)
/* 80B002F0  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 80B002F4  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 80B002F8  38 81 00 08 */	addi r4, r1, 8
/* 80B002FC  4B 52 19 64 */	b fpcLyIt_AllJudge__FPFPvPv_PvPv
...
lbl_80B00338:
/* 80B00338  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B0033C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B00340  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80B00344  80 03 05 78 */	lwz r0, 0x578(r3)	/* effective address: 80406738 */
/* 80B00348  64 00 00 04 */	oris r0, r0, 4
/* 80B0034C  90 03 05 78 */	stw r0, 0x578(r3)	/* effective address: 80406738 */
...
/* 80B00360  4B 86 1E C4 */	b _restgpr_28

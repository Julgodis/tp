...
/* 80AFD2B8  4B 86 4F 20 */	b _savegpr_28
...
/* 80AFD2E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AFD2EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AFD2F0  4B 84 91 C0 */	b PSMTXCopy
/* 80AFD2F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AFD2F8  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 80AFD2FC  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 80AFD300  D0 1D 08 54 */	stfs f0, 0x854(r29)
/* 80AFD304  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 80AFD308  D0 1D 08 58 */	stfs f0, 0x858(r29)
/* 80AFD30C  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 80AFD32C  4B 84 91 84 */	b PSMTXCopy
...
/* 80AFD35C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AFD360  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AFD364  4B 84 91 4C */	b PSMTXCopy
...
lbl_80AFD388:
/* 80AFD388  3C 60 80 B0 */	lis r3, lit_4298@ha
/* 80AFD38C  38 83 0D F4 */	addi r4, r3, lit_4298@l
/* 80AFD390  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80B00DF4 */
/* 80AFD394  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80B00DF8 */
/* 80AFD398  90 61 00 08 */	stw r3, 8(r1)
/* 80AFD39C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AFD3A0  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80B00DFC */
...
/* 80AFD3D4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AFD3D8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AFD3DC  4B 84 90 D4 */	b PSMTXCopy
/* 80AFD3E0  7F A3 EB 78 */	mr r3, r29
/* 80AFD3E4  7F E4 FB 78 */	mr r4, r31
/* 80AFD3E8  38 A1 00 08 */	addi r5, r1, 8
/* 80AFD3EC  3C C0 80 B0 */	lis r6, m__17daNpcTheB_Param_c@ha
/* 80AFD3F0  38 C6 0D 6C */	addi r6, r6, m__17daNpcTheB_Param_c@l
/* 80AFD3F4  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 80B00DAC */
/* 80AFD3F8  4B 65 5F 84 */	b setLookatMtx__8daNpcF_cFiPif
/* 80AFD3FC  2C 1F 00 01 */	cmpwi r31, 1
/* 80AFD400  40 82 00 1C */	bne lbl_80AFD41C
/* 80AFD404  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AFD408  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AFD40C  A8 9D 0E 06 */	lha r4, 0xe06(r29)
/* 80AFD410  A8 BD 0E 08 */	lha r5, 0xe08(r29)
/* 80AFD414  A8 DD 0E 0A */	lha r6, 0xe0a(r29)
/* 80AFD418  4B 50 ED 4C */	b mDoMtx_XYZrotM__FPA4_fsss
lbl_80AFD41C:
/* 80AFD41C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AFD420  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AFD424  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80AFD428  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80AFD42C  7C 80 E2 14 */	add r4, r0, r28
/* 80AFD430  4B 84 90 80 */	b PSMTXCopy
/* 80AFD434  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AFD438  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AFD43C  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80AFD440  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80AFD444  4B 84 90 6C */	b PSMTXCopy
lbl_80AFD448:
...
/* 80AFD474  4B 51 05 1C */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80AFD488  4B 86 4D 9C */	b _restgpr_28

...
/* 80A69BD4 00000020  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80A69BD8 00000024  38 63 00 00 */	addi r3, r3, j3dSys@l
...
/* 80A69BF4 00000040  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 80A69BF8 00000044  38 84 00 00 */	addi r4, r4, calc_mtx@l
...
/* 80A69C0C 00000058  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80A69C10 0000005C  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 80A69C14 00000060  80 63 00 00 */	lwz r3, 0(r3)
/* 80A69C18 00000064  A8 BD 00 52 */	lha r5, 0x52(r29)
/* 80A69C1C 00000068  3C 80 00 00 */	lis r4, lit_3771@ha
/* 80A69C20 0000006C  C0 24 00 00 */	lfs f1, lit_3771@l(r4)
...
/* 80A69C54 0000000C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80A69C58 00000010  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
lbl_80A69C88:
/* 80A69C88 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80A69C8C 00000004  38 63 00 00 */	addi r3, r3, calc_mtx@l
...
/* 80A69CA4 0000001C  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80A69CA8 00000020  38 63 00 00 */	addi r3, r3, calc_mtx@l
/* 80A69CAC 00000024  80 63 00 00 */	lwz r3, 0(r3)
/* 80A69CB0 00000028  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80A69CB4 0000002C  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l

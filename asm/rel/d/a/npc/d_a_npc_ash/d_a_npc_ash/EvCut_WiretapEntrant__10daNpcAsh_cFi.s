...
/* 8095BA90  4B A0 67 44 */	b _savegpr_27
/* 8095BA94  7C 7E 1B 78 */	mr r30, r3
/* 8095BA98  7C 9B 23 78 */	mr r27, r4
/* 8095BA9C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8095BAA0  3B E3 61 C0 */	addi r31, r3, struct_804061C0+0x0@l
/* 8095BAA4  3B 9F 4F F8 */	addi r28, r31, 0x4ff8
/* 8095BAA8  7F 83 E3 78 */	mr r3, r28
/* 8095BAAC  3C A0 80 96 */	lis r5, stringBase0@ha
/* 8095BAB0  38 A5 D9 10 */	addi r5, r5, stringBase0@l
/* 8095BAB4  38 A5 00 7B */	addi r5, r5, 0x7b
/* 8095BAB8  38 C0 00 03 */	li r6, 3
/* 8095BABC  4B 6E C6 30 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 8095BAD8  4B 6E C2 74 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 8095BAFC  3C A0 80 96 */	lis r5, lit_4976@ha
/* 8095BB00  C0 25 D8 84 */	lfs f1, lit_4976@l(r5)
...
/* 8095BB1C  3C A0 80 96 */	lis r5, lit_4976@ha
/* 8095BB20  C0 25 D8 84 */	lfs f1, lit_4976@l(r5)
...
/* 8095BB50  4B 7F 7B C8 */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 8095BB64  3C A0 80 96 */	lis r5, lit_4976@ha
/* 8095BB68  C0 25 D8 84 */	lfs f1, lit_4976@l(r5)
...
/* 8095BB84  3C A0 80 96 */	lis r5, lit_4976@ha
/* 8095BB88  C0 25 D8 84 */	lfs f1, lit_4976@l(r5)
...
/* 8095BBC0  3C A0 80 96 */	lis r5, lit_4976@ha
/* 8095BBC4  C0 25 D8 84 */	lfs f1, lit_4976@l(r5)
...
/* 8095BBDC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8095BBE0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8095BBE4  80 84 4F 94 */	lwz r4, 0x4f94(r4)	/* effective address: 8040B154 */
/* 8095BBE8  4B 6E 77 04 */	b convPId__14dEvt_control_cFUi
...
/* 8095BC24  4B A0 65 FC */	b _restgpr_27

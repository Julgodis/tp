...
/* 8095C5D4  4B A0 5C 08 */	b _savegpr_29
/* 8095C5D8  7C 7D 1B 78 */	mr r29, r3
/* 8095C5DC  3C 60 80 96 */	lis r3, m__16daNpcAsh_Param_c@ha
/* 8095C5E0  3B C3 D6 40 */	addi r30, r3, m__16daNpcAsh_Param_c@l
...
/* 8095C664  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8095C668  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8095C66C  4B 9E 9E 44 */	b PSMTXCopy
/* 8095C670  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8095C674  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 8095C678  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 803DD47C */
/* 8095C67C  D0 1D 08 E4 */	stfs f0, 0x8e4(r29)
/* 8095C680  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 803DD48C */
/* 8095C684  D0 1D 08 E8 */	stfs f0, 0x8e8(r29)
/* 8095C688  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 803DD49C */
...
/* 8095C6F0  4B 90 A4 44 */	b __mi__4cXyzCFRC3Vec
...
/* 8095C720  4B 90 AF 54 */	b cM_atan2s__Fff
...
/* 8095C74C  4B 9E A9 EC */	b PSVECSquareMag
...
/* 8095C7BC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8095C7C0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 8095C82C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8095C830  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 8095C834  48 00 00 08 */	b lbl_8095C83C
lbl_8095C838:
/* 8095C838  FC 40 08 90 */	fmr f2, f1
lbl_8095C83C:
/* 8095C83C  C0 21 00 34 */	lfs f1, 0x34(r1)
/* 8095C840  4B 90 AE 34 */	b cM_atan2s__Fff
...
/* 8095C8A0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8095C8A4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8095C8A8  4B 9E 9C 08 */	b PSMTXCopy

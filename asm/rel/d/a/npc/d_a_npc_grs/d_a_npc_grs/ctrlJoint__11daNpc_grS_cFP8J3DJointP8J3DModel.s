...
/* 809E4D4C  4B 97 D4 8C */	b _savegpr_28
...
/* 809E4D60  3C 60 80 9E */	lis r3, lit_4543@ha
/* 809E4D64  38 83 7E 50 */	addi r4, r3, lit_4543@l
/* 809E4D68  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 809E7E50 */
/* 809E4D6C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 809E7E54 */
/* 809E4D70  90 61 00 08 */	stw r3, 8(r1)
/* 809E4D74  90 01 00 0C */	stw r0, 0xc(r1)
/* 809E4D78  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 809E7E58 */
...
/* 809E4D9C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809E4DA0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809E4DA4  4B 96 17 0C */	b PSMTXCopy
/* 809E4DA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4DAC  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 809E4DB0  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 809E4DB4  D0 1F 08 54 */	stfs f0, 0x854(r31)
/* 809E4DB8  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 809E4DBC  D0 1F 08 58 */	stfs f0, 0x858(r31)
/* 809E4DC0  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 809E4DE0  4B 96 16 D0 */	b PSMTXCopy
...
/* 809E4E10  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809E4E14  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809E4E18  4B 96 16 98 */	b PSMTXCopy
...
/* 809E4E44  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809E4E48  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809E4E4C  4B 96 16 64 */	b PSMTXCopy
...
/* 809E4E7C  3C C0 80 9E */	lis r6, m__17daNpc_grS_Param_c@ha
/* 809E4E80  38 C6 7D CC */	addi r6, r6, m__17daNpc_grS_Param_c@l
/* 809E4E84  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 809E7E0C */
/* 809E4E88  4B 76 E4 F4 */	b setLookatMtx__8daNpcF_cFiPif
lbl_809E4E8C:
/* 809E4E8C  2C 1D 00 01 */	cmpwi r29, 1
/* 809E4E90  40 82 00 30 */	bne lbl_809E4EC0
/* 809E4E94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4E98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E4E9C  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809E4EA0  7C 00 00 D0 */	neg r0, r0
/* 809E4EA4  7C 04 07 34 */	extsh r4, r0
/* 809E4EA8  4B 62 75 8C */	b mDoMtx_YrotM__FPA4_fs
/* 809E4EAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4EB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E4EB4  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809E4EB8  4B 62 76 14 */	b mDoMtx_ZrotM__FPA4_fs
/* 809E4EBC  48 00 00 34 */	b lbl_809E4EF0
lbl_809E4EC0:
/* 809E4EC0  2C 1D 00 04 */	cmpwi r29, 4
/* 809E4EC4  40 82 00 2C */	bne lbl_809E4EF0
/* 809E4EC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4ECC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E4ED0  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809E4ED4  7C 00 00 D0 */	neg r0, r0
/* 809E4ED8  7C 04 07 34 */	extsh r4, r0
/* 809E4EDC  4B 62 75 58 */	b mDoMtx_YrotM__FPA4_fs
/* 809E4EE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4EE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E4EE8  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809E4EEC  4B 62 75 E0 */	b mDoMtx_ZrotM__FPA4_fs
lbl_809E4EF0:
/* 809E4EF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4EF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E4EF8  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809E4EFC  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809E4F00  7C 80 F2 14 */	add r4, r0, r30
/* 809E4F04  4B 96 15 AC */	b PSMTXCopy
/* 809E4F08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809E4F0C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809E4F10  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 809E4F14  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 809E4F18  4B 96 15 98 */	b PSMTXCopy
...
/* 809E4F48  4B 62 8A 48 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809E4F5C  4B 97 D2 C8 */	b _restgpr_28

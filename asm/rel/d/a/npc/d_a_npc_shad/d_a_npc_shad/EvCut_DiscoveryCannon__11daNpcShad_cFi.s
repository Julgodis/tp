...
/* 80ADE608  4B 88 3B C4 */	b _savegpr_25
...
/* 80ADE63C  4B 56 97 10 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80ADE65C  3C 60 80 AE */	lis r3, lit_6550@ha
/* 80ADE660  38 63 2B 5C */	addi r3, r3, lit_6550@l
...
/* 80ADE67C  3C A0 80 04 */	lis r5, dEv_noFinishSkipProc__FPvi@ha
/* 80ADE680  38 A5 28 DC */	addi r5, r5, dEv_noFinishSkipProc__FPvi@l
...
/* 80ADE72C  3C A0 80 AE */	lis r5, struct_80AE24C4+0x0@ha
/* 80ADE730  38 A5 24 C4 */	addi r5, r5, struct_80AE24C4+0x0@l
/* 80ADE734  38 A5 01 52 */	addi r5, r5, 0x152
/* 80ADE738  38 C0 00 01 */	li r6, 1
/* 80ADE73C  4B 56 99 B0 */	b getMySubstanceP__16dEvent_manager_cFiPCci
/* 80ADE740  7C 79 1B 78 */	mr r25, r3
/* 80ADE744  7F 83 E3 78 */	mr r3, r28
/* 80ADE748  7F 64 DB 78 */	mr r4, r27
/* 80ADE74C  3C A0 80 AE */	lis r5, struct_80AE24C4+0x0@ha
/* 80ADE750  38 A5 24 C4 */	addi r5, r5, struct_80AE24C4+0x0@l
/* 80ADE754  38 A5 01 56 */	addi r5, r5, 0x156
/* 80ADE758  38 C0 00 03 */	li r6, 3
/* 80ADE75C  4B 56 99 90 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80ADE7B0  4B 67 5A A0 */	b setAngle__8daNpcF_cFs
lbl_80ADE7B4:
...
/* 80ADE898  4B 67 54 84 */	b initTalk__8daNpcF_cFiPP10fopAc_ac_c
lbl_80ADE89C:
...
/* 80ADE8C0  4B 67 72 28 */	b daNpcF_clearMessageTmpBit__Fv
/* 80ADE8C4  38 60 03 12 */	li r3, 0x312
/* 80ADE8C8  4B 67 6D AC */	b daNpcF_onEvtBit__FUl
/* 80ADE8CC  38 00 00 07 */	li r0, 7
/* 80ADE8D0  B0 1A 09 E6 */	sth r0, 0x9e6(r26)
/* 80ADE8D4  4B 75 90 C0 */	b onKillMessageFlag__12dMsgObject_cFv
/* 80ADE8D8  A0 1A 09 E6 */	lhz r0, 0x9e6(r26)
/* 80ADE8DC  54 00 10 3A */	slwi r0, r0, 2
/* 80ADE8E0  7F 43 D3 78 */	mr r3, r26
/* 80ADE8E4  3C 80 80 AE */	lis r4, l_evtArcs@ha
/* 80ADE8E8  38 84 29 28 */	addi r4, r4, l_evtArcs@l
/* 80ADE8EC  7C 84 00 2E */	lwzx r4, r4, r0
/* 80ADE8F0  3C A0 80 AE */	lis r5, l_evtNames@ha
/* 80ADE8F4  38 A5 28 F0 */	addi r5, r5, l_evtNames@l
...
/* 80ADE908  4B 67 50 4C */	b changeEvent__8daNpcF_cFPcPcUsUs
lbl_80ADE90C:
...
/* 80ADE924  4B 67 4D F4 */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80ADEA60  3C 60 80 AE */	lis r3, lit_6551@ha
/* 80ADEA64  38 63 2B 3C */	addi r3, r3, lit_6551@l
...
/* 80ADEA98  4B 52 E2 CC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80ADEA9C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80ADEAA0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80ADEAA4  A8 9A 04 E6 */	lha r4, 0x4e6(r26)
/* 80ADEAA8  4B 52 D9 8C */	b mDoMtx_YrotM__FPA4_fs
/* 80ADEAAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80ADEAB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80ADEAB4  38 81 00 2C */	addi r4, r1, 0x2c
/* 80ADEAB8  7C 85 23 78 */	mr r5, r4
/* 80ADEABC  4B 86 82 B0 */	b PSMTXMultVec
...
/* 80ADEAF8  3C A0 80 AE */	lis r5, struct_80AE24C4+0x0@ha
/* 80ADEAFC  38 A5 24 C4 */	addi r5, r5, struct_80AE24C4+0x0@l
/* 80ADEB00  38 A5 01 52 */	addi r5, r5, 0x152
/* 80ADEB04  38 C0 00 01 */	li r6, 1
/* 80ADEB08  4B 56 95 E4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80ADEB1C  4B 79 20 E8 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80ADEB8C  4B 67 53 68 */	b turn__8daNpcF_cFsfi
...
/* 80ADEC04  4B 86 87 98 */	b PSVECSquareDistance
...
/* 80ADEC74  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80ADEC78  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80ADECE4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80ADECE8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80ADECEC:
...
/* 80ADED38  4B 67 50 4C */	b talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80ADED54  4B 88 34 C4 */	b _restgpr_25

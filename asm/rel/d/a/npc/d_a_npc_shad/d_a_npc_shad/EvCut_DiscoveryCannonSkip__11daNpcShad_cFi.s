...
/* 80ADED78  4B 88 34 60 */	b _savegpr_28
/* 80ADED7C  7C 7F 1B 78 */	mr r31, r3
/* 80ADED80  7C 9C 23 78 */	mr r28, r4
/* 80ADED84  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80ADED88  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80ADED8C  3B A3 4F F8 */	addi r29, r3, 0x4ff8
/* 80ADED90  7F A3 EB 78 */	mr r3, r29
/* 80ADED94  4B 56 91 C8 */	b getMyNowCutName__16dEvent_manager_cFi
/* 80ADED98  7C 7E 1B 78 */	mr r30, r3
/* 80ADED9C  7F A3 EB 78 */	mr r3, r29
/* 80ADEDA0  7F 84 E3 78 */	mr r4, r28
/* 80ADEDA4  4B 56 8F A8 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80ADEDE8  3C A0 80 AE */	lis r5, struct_80AE24C4+0x0@ha
/* 80ADEDEC  38 A5 24 C4 */	addi r5, r5, struct_80AE24C4+0x0@l
/* 80ADEDF0  38 A5 01 52 */	addi r5, r5, 0x152
/* 80ADEDF4  38 C0 00 01 */	li r6, 1
/* 80ADEDF8  4B 56 92 F4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
/* 80ADEDFC  7C 7E 1B 78 */	mr r30, r3
/* 80ADEE00  7F A3 EB 78 */	mr r3, r29
/* 80ADEE04  7F 84 E3 78 */	mr r4, r28
/* 80ADEE08  3C A0 80 AE */	lis r5, struct_80AE24C4+0x0@ha
/* 80ADEE0C  38 A5 24 C4 */	addi r5, r5, struct_80AE24C4+0x0@l
/* 80ADEE10  38 A5 01 56 */	addi r5, r5, 0x156
/* 80ADEE14  38 C0 00 03 */	li r6, 3
/* 80ADEE18  4B 56 92 D4 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80ADEE6C  4B 67 53 E4 */	b setAngle__8daNpcF_cFs
lbl_80ADEE70:
/* 80ADEE70  7F E3 FB 78 */	mr r3, r31
/* 80ADEE74  38 80 00 0C */	li r4, 0xc
/* 80ADEE78  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADEE7C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80ADEE98  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADEE9C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80ADEEB4  3C 60 80 AE */	lis r3, lit_4498@ha
/* 80ADEEB8  C0 03 20 6C */	lfs f0, lit_4498@l(r3)
...
/* 80ADEED0  4B 88 33 54 */	b _restgpr_28

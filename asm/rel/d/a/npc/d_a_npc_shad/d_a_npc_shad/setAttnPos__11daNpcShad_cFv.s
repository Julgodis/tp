...
/* 80AE0FBC  4B 88 12 20 */	b _savegpr_29
/* 80AE0FC0  7C 7D 1B 78 */	mr r29, r3
/* 80AE0FC4  3C 60 80 AE */	lis r3, m__17daNpcShad_Param_c@ha
/* 80AE0FC8  3B C3 1F DC */	addi r30, r3, m__17daNpcShad_Param_c@l
...
/* 80AE104C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AE1050  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80AE10D8  4B 78 5A 5C */	b __mi__4cXyzCFRC3Vec
...
/* 80AE1108  4B 78 65 6C */	b cM_atan2s__Fff
...
/* 80AE1134  4B 86 60 04 */	b PSVECSquareMag
...
/* 80AE11A4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AE11A8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80AE1214  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AE1218  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80AE121C  48 00 00 08 */	b lbl_80AE1224
lbl_80AE1220:
/* 80AE1220  FC 40 08 90 */	fmr f2, f1
lbl_80AE1224:
/* 80AE1224  C0 21 00 34 */	lfs f1, 0x34(r1)
/* 80AE1228  4B 78 64 4C */	b cM_atan2s__Fff
...
/* 80AE127C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AE1280  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AE1284  4B 86 52 2C */	b PSMTXCopy
...
lbl_80AE12E4:
/* 80AE12E4  4B 78 DF 1C */	b SetR__8cM3dGCylFf
...
/* 80AE130C  4B 88 0F 1C */	b _restgpr_29

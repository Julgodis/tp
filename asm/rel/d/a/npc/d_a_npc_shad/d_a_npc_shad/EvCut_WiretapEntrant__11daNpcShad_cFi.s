...
/* 80ADFE84  4B 88 23 50 */	b _savegpr_27
/* 80ADFE88  7C 7D 1B 78 */	mr r29, r3
/* 80ADFE8C  7C 9B 23 78 */	mr r27, r4
/* 80ADFE90  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80ADFE94  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80ADFE98  3B 9E 4F F8 */	addi r28, r30, 0x4ff8
/* 80ADFE9C  7F 83 E3 78 */	mr r3, r28
/* 80ADFEA0  3C A0 80 AE */	lis r5, struct_80AE24C4+0x0@ha
/* 80ADFEA4  38 A5 24 C4 */	addi r5, r5, struct_80AE24C4+0x0@l
/* 80ADFEA8  38 A5 01 4E */	addi r5, r5, 0x14e
/* 80ADFEAC  38 C0 00 03 */	li r6, 3
/* 80ADFEB0  4B 56 82 3C */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80ADFECC  4B 56 7E 80 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80ADFEF0  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADFEF4  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80ADFF10  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADFF14  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80ADFF44  4B 67 37 D4 */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80ADFF58  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADFF5C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80ADFF78  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADFF7C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80ADFFE0  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80ADFFE4  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80AE0004  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80AE0008  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80AE0028  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80AE002C  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80AE004C  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80AE0050  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80AE0070  3C A0 80 AE */	lis r5, lit_5210@ha
/* 80AE0074  C0 25 24 18 */	lfs f1, lit_5210@l(r5)
...
/* 80AE009C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AE00A0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AE00A4  80 84 4F 94 */	lwz r4, 0x4f94(r4)	/* effective address: 8040B154 */
/* 80AE00A8  4B 56 32 44 */	b convPId__14dEvt_control_cFUi
/* 80AE00AC  7C 03 E8 40 */	cmplw r3, r29
/* 80AE00B0  40 82 00 0C */	bne lbl_80AE00BC
/* 80AE00B4  38 7D 0C 90 */	addi r3, r29, 0xc90
/* 80AE00B8  4B 67 06 34 */	b getActorP__18daNpcF_ActorMngr_cFv
lbl_80AE00BC:
...
/* 80AE00F0  4B 88 21 30 */	b _restgpr_27

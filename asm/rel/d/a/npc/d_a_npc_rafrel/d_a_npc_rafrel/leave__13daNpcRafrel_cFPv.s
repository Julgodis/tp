...
/* 80ABCA50 00000010  4B 8A 57 8C */	b _savegpr_29
/* 80ABCA54 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80ABCA58 00000018  3C 80 80 AC */	lis r4, m__19daNpcRafrel_Param_c@ha
/* 80ABCA5C 0000001C  3B E4 F9 E0 */	addi r31, r4, m__19daNpcRafrel_Param_c@l
/* 80ABCA60 00000020  C0 1F 03 80 */	lfs f0, 0x380(r31)	/* effective address: 80ABFD60 */
/* 80ABCA64 00000024  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80ABCA68 00000028  C0 1F 00 88 */	lfs f0, 0x88(r31)	/* effective address: 80ABFA68 */
/* 80ABCA6C 0000002C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80ABCA70 00000030  C0 1F 03 84 */	lfs f0, 0x384(r31)	/* effective address: 80ABFD64 */
...
/* 80ABCA9C 00000004  C0 3F 03 50 */	lfs f1, 0x350(r31)	/* effective address: 80ABFD30 */
...
/* 80ABCAB8 00000020  C0 3F 03 50 */	lfs f1, 0x350(r31)	/* effective address: 80ABFD30 */
...
/* 80ABCAD8 00000040  C0 1F 00 88 */	lfs f0, 0x88(r31)	/* effective address: 80ABFA68 */
...
/* 80ABCB00 00000014  4B 7B 41 04 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80ABCB14 00000028  C0 5F 03 58 */	lfs f2, 0x358(r31)	/* effective address: 80ABFD38 */
...
/* 80ABCB24 00000038  C8 3F 03 70 */	lfd f1, 0x370(r31)	/* effective address: 80ABFD50 */
...
/* 80ABCB68 0000007C  C0 3F 03 50 */	lfs f1, 0x350(r31)	/* effective address: 80ABFD30 */
...
/* 80ABCB84 00000098  C0 3F 03 50 */	lfs f1, 0x350(r31)	/* effective address: 80ABFD30 */
...
/* 80ABCBF4 00000010  C0 3F 03 5C */	lfs f1, 0x35c(r31)	/* effective address: 80ABFD3C */
/* 80ABCBF8 00000014  38 A0 00 00 */	li r5, 0
/* 80ABCBFC 00000018  4B 69 72 F8 */	b turn__8daNpcF_cFsfi
...
lbl_80ABCC40:
/* 80ABCC40 00000000  C0 1F 03 88 */	lfs f0, 0x388(r31)	/* effective address: 80ABFD68 */
...
/* 80ABCC5C 0000001C  4B 88 A7 40 */	b PSVECSquareDistance
/* 80ABCC60 00000020  C0 1F 00 88 */	lfs f0, 0x88(r31)	/* effective address: 80ABFA68 */
...
/* 80ABCC70 00000008  C8 9F 03 90 */	lfd f4, 0x390(r31)	/* effective address: 80ABFD70 */
/* 80ABCC74 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80ABCC78 00000010  C8 7F 03 98 */	lfd f3, 0x398(r31)	/* effective address: 80ABFD78 */
...
lbl_80ABCCC0:
/* 80ABCCC0 00000000  C8 1F 03 A0 */	lfd f0, 0x3a0(r31)	/* effective address: 80ABFD80 */
/* 80ABCCC4 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80ABCCC8 00000000  40 80 00 10 */	bge lbl_80ABCCD8
/* 80ABCCCC 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80ABCCD0 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80ABCD3C 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80ABCD40 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80ABCD44:
...
/* 80ABCD54 00000004  4B 55 CF 28 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80ABCD58:
/* 80ABCD58 00000000  38 60 00 01 */	li r3, 1
/* 80ABCD5C 00000004  39 61 00 40 */	addi r11, r1, 0x40
/* 80ABCD60 00000008  4B 8A 54 C8 */	b _restgpr_29

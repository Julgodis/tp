...
/* 80ABA4B8  4B 8A 7D 20 */	b _savegpr_28
...
/* 80ABA508  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80ABA50C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80ABA54C  4B 88 BF 64 */	b PSMTXCopy
...
/* 80ABA57C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80ABA580  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80ABA584  4B 88 BF 2C */	b PSMTXCopy
...
/* 80ABA5B0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80ABA5B4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80ABA5B8  4B 88 BE F8 */	b PSMTXCopy
...
/* 80ABA5FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80ABA600  80 9E 00 84 */	lwz r4, 0x84(r30)
/* 80ABA604  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80ABA608  7C 80 E2 14 */	add r4, r0, r28
/* 80ABA60C  4B 88 BE A4 */	b PSMTXCopy
/* 80ABA610  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80ABA614  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80ABA618  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80ABA61C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80ABA620  4B 88 BE 90 */	b PSMTXCopy
...
/* 80ABA650  4B 55 33 40 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80ABA664  4B 8A 7B C0 */	b _restgpr_28

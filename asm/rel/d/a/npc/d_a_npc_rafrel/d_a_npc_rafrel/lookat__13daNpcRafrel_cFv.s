...
/* 80ABEECC  C0 23 00 24 */	lfs f1, 0x24(r3)	/* effective address: 80ABFA04 */
/* 80ABEED0  C0 43 00 20 */	lfs f2, 0x20(r3)	/* effective address: 80ABFA00 */
/* 80ABEED4  C0 63 00 2C */	lfs f3, 0x2c(r3)	/* effective address: 80ABFA0C */
/* 80ABEED8  C0 83 00 28 */	lfs f4, 0x28(r3)	/* effective address: 80ABFA08 */
/* 80ABEEDC  C0 C3 00 34 */	lfs f6, 0x34(r3)	/* effective address: 80ABFA14 */
/* 80ABEEE0  C0 E3 00 30 */	lfs f7, 0x30(r3)	/* effective address: 80ABFA10 */
/* 80ABEEE4  C1 03 00 3C */	lfs f8, 0x3c(r3)	/* effective address: 80ABFA1C */
/* 80ABEEE8  C1 23 00 38 */	lfs f9, 0x38(r3)	/* effective address: 80ABFA18 */
...
/* 80ABEF44  80 64 03 44 */	lwz r3, 0x344(r4)	/* effective address: 80ABFD24 */
/* 80ABEF48  80 04 03 48 */	lwz r0, 0x348(r4)	/* effective address: 80ABFD28 */
/* 80ABEF4C  90 61 00 18 */	stw r3, 0x18(r1)
/* 80ABEF50  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80ABEF54  80 04 03 4C */	lwz r0, 0x34c(r4)	/* effective address: 80ABFD2C */
...
lbl_80ABEFA0:
/* 80ABEFA0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80ABEFA4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80ABEFA8  80 A3 5D AC */	lwz r5, 0x5dac(r3)	/* effective address: 8040BF6C */

...
/* 80ABDB8C  4B 8A 46 48 */	b _savegpr_27
/* 80ABDB90  7C 7D 1B 78 */	mr r29, r3
/* 80ABDB94  7C 9B 23 78 */	mr r27, r4
/* 80ABDB98  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80ABDB9C  3B C3 61 C0 */	addi r30, r3, struct_804061C0+0x0@l
/* 80ABDBA0  3B 9E 4F F8 */	addi r28, r30, 0x4ff8
/* 80ABDBA4  7F 83 E3 78 */	mr r3, r28
/* 80ABDBA8  3C A0 80 AC */	lis r5, struct_80ABFDBC+0x0@ha
/* 80ABDBAC  38 A5 FD BC */	addi r5, r5, struct_80ABFDBC+0x0@l
/* 80ABDBB0  38 A5 00 BE */	addi r5, r5, 0xbe
/* 80ABDBB4  38 C0 00 03 */	li r6, 3
/* 80ABDBB8  4B 58 A5 34 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80ABDBD4  4B 58 A1 78 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80ABDBF8  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDBFC  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDC18  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDC1C  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDC4C  4B 69 5A CC */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80ABDC60  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDC64  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDC80  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDC84  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDCE4  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDCE8  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDD08  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDD0C  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDD2C  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDD30  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDD50  3C A0 80 AC */	lis r5, lit_5080@ha
/* 80ABDD54  C0 25 FD 30 */	lfs f1, lit_5080@l(r5)
...
/* 80ABDD7C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80ABDD80  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80ABDD84  80 84 4F 94 */	lwz r4, 0x4f94(r4)	/* effective address: 8040B154 */
/* 80ABDD88  4B 58 55 64 */	b convPId__14dEvt_control_cFUi
/* 80ABDD8C  7C 03 E8 40 */	cmplw r3, r29
/* 80ABDD90  40 82 00 0C */	bne lbl_80ABDD9C
/* 80ABDD94  38 7D 0C 8C */	addi r3, r29, 0xc8c
/* 80ABDD98  4B 69 29 54 */	b getActorP__18daNpcF_ActorMngr_cFv
lbl_80ABDD9C:
...
/* 80ABDDD0  4B 8A 44 50 */	b _restgpr_27

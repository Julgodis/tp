...
/* 80B7A580  4B 7E 7C 50 */	b _savegpr_26
/* 80B7A584  7C 7B 1B 78 */	mr r27, r3
/* 80B7A588  3C 60 80 B9 */	lis r3, m__17daNpc_zrA_Param_c@ha
/* 80B7A58C  3B E3 C4 58 */	addi r31, r3, m__17daNpc_zrA_Param_c@l
...
/* 80B7A5EC  4B 4B 54 68 */	b dComIfGs_wolfeye_effect_check__Fv
...
/* 80B7A610  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B7A614  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B7A618  38 80 00 04 */	li r4, 4
/* 80B7A61C  38 BB 04 D0 */	addi r5, r27, 0x4d0
/* 80B7A620  38 DB 01 0C */	addi r6, r27, 0x10c
/* 80B7A624  4B 62 91 A0 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80B7A628  48 00 00 1C */	b lbl_80B7A644
lbl_80B7A62C:
/* 80B7A62C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B7A630  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B7A634  38 80 00 00 */	li r4, 0
/* 80B7A638  38 BB 04 D0 */	addi r5, r27, 0x4d0
/* 80B7A63C  38 DB 01 0C */	addi r6, r27, 0x10c
/* 80B7A640  4B 62 91 84 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_80B7A644:
/* 80B7A644  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B7A648  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B7A64C  80 9E 00 04 */	lwz r4, 4(r30)
/* 80B7A650  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80B7A654  4B 62 A7 4C */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80B7A68C  4B 49 30 4C */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80B7A690:
...
/* 80B7A6A8  4B 49 2E 70 */	b entry__13mDoExt_bpkAnmFP16J3DMaterialTablef
lbl_80B7A6AC:
...
/* 80B7A6D0  4B 49 2F 18 */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
lbl_80B7A6D4:
...
/* 80B7A6EC  4B 49 2F EC */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80B7A6F0:
...
/* 80B7A708  4B 49 30 A0 */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_80B7A70C:
...
/* 80B7A71C  4B 4A 2D 10 */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
lbl_80B7A720:
/* 80B7A720  88 1B 09 F4 */	lbz r0, 0x9f4(r27)
/* 80B7A724  28 00 00 00 */	cmplwi r0, 0
/* 80B7A728  41 82 00 48 */	beq lbl_80B7A770
/* 80B7A72C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B7A730  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80B7A734  80 04 5F 88 */	lwz r0, 0x5f88(r4)	/* effective address: 8040C148 */
/* 80B7A738  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80B7A73C  3B 83 4A C8 */	addi r28, r3, j3dSys@l
/* 80B7A740  90 1C 00 48 */	stw r0, 0x48(r28)	/* effective address: 80434B10 */
/* 80B7A744  80 04 5F 8C */	lwz r0, 0x5f8c(r4)	/* effective address: 8040C14C */
/* 80B7A748  90 1C 00 4C */	stw r0, 0x4c(r28)	/* effective address: 80434B14 */
/* 80B7A74C  80 7B 05 68 */	lwz r3, 0x568(r27)
/* 80B7A750  4B 49 6A 70 */	b entryDL__16mDoExt_McaMorfSOFv
/* 80B7A754  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B7A758  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B7A75C  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80B7A760  90 1C 00 48 */	stw r0, 0x48(r28)
/* 80B7A764  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
/* 80B7A768  90 1C 00 4C */	stw r0, 0x4c(r28)
/* 80B7A76C  48 00 00 0C */	b lbl_80B7A778
lbl_80B7A770:
/* 80B7A770  80 7B 05 68 */	lwz r3, 0x568(r27)
/* 80B7A774  4B 49 6A 4C */	b entryDL__16mDoExt_McaMorfSOFv
lbl_80B7A778:
...
/* 80B7A78C  4B 7B 4F 6C */	b removeTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern
lbl_80B7A790:
...
/* 80B7A7A4  4B 7B 50 10 */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_80B7A7A8:
...
/* 80B7A7BC  4B 7B 50 C4 */	b removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
lbl_80B7A7C0:
...
/* 80B7A7D4  4B 7B 4E 78 */	b removeMatColorAnimator__16J3DMaterialTableFP11J3DAnmColor
lbl_80B7A7D8:
...
/* 80B7A7EC  4B 7B 4F C8 */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_80B7A7F0:
...
/* 80B7A824  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80B7A828  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80B7A82C  4B 4B 40 E4 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 80B7A850  4B 7E 79 CC */	b _restgpr_26

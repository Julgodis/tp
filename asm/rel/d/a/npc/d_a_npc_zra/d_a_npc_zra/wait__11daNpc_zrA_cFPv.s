...
/* 80B7F928  3C 60 80 B9 */	lis r3, lit_3939@ha
/* 80B7F92C  C0 03 C5 08 */	lfs f0, lit_3939@l(r3)
...
/* 80B7F97C  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7F980  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7F99C  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7F9A0  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7F9C0  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7F9C4  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7F9E0  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7F9E4  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FA04  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FA08  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FA24  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FA28  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FA48  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FA4C  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FA68  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FA6C  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FA8C  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FA90  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FAAC  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FAB0  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FAD4  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FAD8  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FAF4  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FAF8  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FB18  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FB1C  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FB38  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FB3C  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FB64  3C A0 80 B9 */	lis r5, lit_4437@ha
/* 80B7FB68  C0 25 C5 28 */	lfs f1, lit_4437@l(r5)
...
/* 80B7FBDC  4B 5D 0B 10 */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 80B7FBF8  4B 5D 4D E8 */	b chkFindPlayer2__8daNpcF_cFis
...
/* 80B7FC10  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B7FC14  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B7FC18  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80B7FC1C  4B 5D 0A A0 */	b entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 80B7FC38  4B 5D 0A A8 */	b remove__18daNpcF_ActorMngr_cFv
/* 80B7FC3C  38 00 00 00 */	li r0, 0
/* 80B7FC40  90 1F 09 6C */	stw r0, 0x96c(r31)
lbl_80B7FC44:
/* 80B7FC44  38 7F 13 1C */	addi r3, r31, 0x131c
/* 80B7FC48  4B 5D 0A A4 */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 80B7FCA8  4B 5D 43 FC */	b step__8daNpcF_cFsiii
...
/* 80B7FCD0  4B 5D 43 D4 */	b step__8daNpcF_cFsiii
...
lbl_80B7FCE8:
/* 80B7FCE8  3C 60 80 B9 */	lis r3, lit_3939@ha
/* 80B7FCEC  C0 03 C5 08 */	lfs f0, lit_3939@l(r3)

...
/* 80B8BCF8  4B 7D 64 D8 */	b _savegpr_26
/* 80B8BCFC  7C 7D 1B 78 */	mr r29, r3
/* 80B8BD00  7C 9B 23 78 */	mr r27, r4
/* 80B8BD04  3C 60 80 B9 */	lis r3, m__17daNpc_zrA_Param_c@ha
/* 80B8BD08  3B E3 C4 58 */	addi r31, r3, m__17daNpc_zrA_Param_c@l
/* 80B8BD0C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B8BD10  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80B8BD24  3C A0 80 B9 */	lis r5, struct_80B8CD30+0x0@ha
/* 80B8BD28  38 A5 CD 30 */	addi r5, r5, struct_80B8CD30+0x0@l
/* 80B8BD2C  38 A5 01 5B */	addi r5, r5, 0x15b
/* 80B8BD30  38 C0 00 03 */	li r6, 3
/* 80B8BD34  4B 4B C3 B8 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80B8BD4C  4B 4B C0 00 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80B8BE14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8BE18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8BE1C  A8 9D 08 F2 */	lha r4, 0x8f2(r29)
/* 80B8BE20  4B 48 05 BC */	b mDoMtx_YrotS__FPA4_fs
/* 80B8BE24  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8BE28  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8BE2C  38 9D 15 44 */	addi r4, r29, 0x1544
/* 80B8BE30  7C 85 23 78 */	mr r5, r4
/* 80B8BE34  4B 7B AF 38 */	b PSMTXMultVec
...
/* 80B8BF3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8BF40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8BF44  A8 9D 08 F2 */	lha r4, 0x8f2(r29)
/* 80B8BF48  4B 48 04 94 */	b mDoMtx_YrotS__FPA4_fs
/* 80B8BF4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8BF50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8BF54  38 81 00 70 */	addi r4, r1, 0x70
/* 80B8BF58  7C 85 23 78 */	mr r5, r4
/* 80B8BF5C  4B 7B AE 10 */	b PSMTXMultVec
/* 80B8BF60  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80B8BF64  38 81 00 70 */	addi r4, r1, 0x70
/* 80B8BF68  7C 65 1B 78 */	mr r5, r3
/* 80B8BF6C  4B 7B B1 24 */	b PSVECAdd
...
/* 80B8BFD8  4B 6E 4B B8 */	b cLib_chaseAngleS__FPsss
/* 80B8BFDC  7F A3 EB 78 */	mr r3, r29
/* 80B8BFE0  A8 9D 08 F2 */	lha r4, 0x8f2(r29)
/* 80B8BFE4  4B 5C 82 6C */	b setAngle__8daNpcF_cFs
...
/* 80B8C018  4B 49 18 78 */	b fopAcM_getWaterY__FPC4cXyzPf
...
/* 80B8C038  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80B8C03C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80B8C040  4B 7B A4 70 */	b PSMTXCopy
/* 80B8C044  38 7D 04 EC */	addi r3, r29, 0x4ec
/* 80B8C048  4B 48 0E 28 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80B8C04C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8C050  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8C054  C0 43 00 0C */	lfs f2, 0xc(r3)	/* effective address: 803DD47C */
/* 80B8C058  D0 41 00 64 */	stfs f2, 0x64(r1)
/* 80B8C05C  C0 23 00 1C */	lfs f1, 0x1c(r3)	/* effective address: 803DD48C */
/* 80B8C060  D0 21 00 68 */	stfs f1, 0x68(r1)
/* 80B8C064  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80B8C098  4B 49 37 E4 */	b fopKyM_createWpillar__FPC4cXyzfi
...
/* 80B8C128  4B 7B AF 68 */	b PSVECAdd
...
/* 80B8C158  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8C15C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8C160  A8 9D 08 F2 */	lha r4, 0x8f2(r29)
/* 80B8C164  4B 48 02 78 */	b mDoMtx_YrotS__FPA4_fs
/* 80B8C168  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8C16C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8C170  38 81 00 4C */	addi r4, r1, 0x4c
/* 80B8C174  7C 85 23 78 */	mr r5, r4
/* 80B8C178  4B 7B AB F4 */	b PSMTXMultVec
/* 80B8C17C  38 7D 15 44 */	addi r3, r29, 0x1544
/* 80B8C180  38 81 00 4C */	addi r4, r1, 0x4c
/* 80B8C184  C0 3F 08 28 */	lfs f1, 0x828(r31)
/* 80B8C188  4B 6E 46 24 */	b cLib_chasePos__FP4cXyzRC4cXyzf
/* 80B8C18C  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80B8C190  38 9D 15 44 */	addi r4, r29, 0x1544
/* 80B8C194  7C 65 1B 78 */	mr r5, r3
/* 80B8C198  4B 7B AE F8 */	b PSVECAdd
...
/* 80B8C1D8  4B 6E 4A 9C */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80B8C1DC  B0 61 00 14 */	sth r3, 0x14(r1)
/* 80B8C1E0  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80B8C1E4  38 81 00 40 */	addi r4, r1, 0x40
/* 80B8C1E8  4B 6E 4A 1C */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80B8C2AC  4B 6D A8 88 */	b __mi__4cXyzCFRC3Vec
...
/* 80B8C2CC  4B 7B AE 6C */	b PSVECSquareMag
...
/* 80B8C33C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80B8C340  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80B8C3AC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80B8C3B0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80B8C3B4:
...
/* 80B8C3D4  4B 7D 5E 48 */	b _restgpr_26

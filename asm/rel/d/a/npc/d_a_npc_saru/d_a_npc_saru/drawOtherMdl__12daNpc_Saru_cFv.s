...
/* 80AC1A38  4B 8A 07 98 */	b _savegpr_26
...
/* 80AC1A50  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AC1A54  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80AC1A94:
/* 80AC1A94  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80AC1A98  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80AC1A9C  80 84 00 04 */	lwz r4, 4(r4)
/* 80AC1AA0  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80AC1AA4  4B 6E 32 FC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80AC1AA8  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 80AC1AAC  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80AC1AB0  3C 60 80 AC */	lis r3, data_80AC460C@ha
/* 80AC1AB4  38 63 46 0C */	addi r3, r3, data_80AC460C@l
/* 80AC1AB8  7C 03 D0 2E */	lwzx r0, r3, r26
/* 80AC1ABC  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80AC1AC0  7C 64 02 14 */	add r3, r4, r0
/* 80AC1AC4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AC1AC8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AC1ACC  4B 88 49 E4 */	b PSMTXCopy
/* 80AC1AD0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AC1AD4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AC1AD8  38 81 00 08 */	addi r4, r1, 8
/* 80AC1ADC  4B 88 49 D4 */	b PSMTXCopy
/* 80AC1AE0  38 61 00 08 */	addi r3, r1, 8
/* 80AC1AE4  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80AC1AE8  38 84 00 24 */	addi r4, r4, 0x24
/* 80AC1AEC  4B 88 49 C4 */	b PSMTXCopy
/* 80AC1AF0  7C 7B E8 2E */	lwzx r3, r27, r29
/* 80AC1AF4  4B 54 C1 D0 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80AC1AF8  7F C3 F3 78 */	mr r3, r30
/* 80AC1AFC  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80AC1B00  7C BB E8 2E */	lwzx r5, r27, r29
/* 80AC1B04  4B 59 44 18 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80AC1B08:
...
/* 80AC1B1C  4B 8A 07 00 */	b _restgpr_26

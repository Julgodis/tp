...
/* 80AC18DC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AC18E0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AC18E4  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80AC1944  3C 60 80 AC */	lis r3, lit_4231@ha
/* 80AC1948  C0 03 45 AC */	lfs f0, lit_4231@l(r3)
/* 80AC194C  D0 01 00 08 */	stfs f0, 8(r1)
/* 80AC1950  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80AC1954  3C 60 80 AC */	lis r3, lit_4876@ha
/* 80AC1958  C0 03 46 08 */	lfs f0, lit_4876@l(r3)
/* 80AC195C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80AC1960  C3 FF 0D EC */	lfs f31, 0xdec(r31)
/* 80AC1964  C3 DF 0D F0 */	lfs f30, 0xdf0(r31)
/* 80AC1968  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AC196C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AC1970  A8 9F 0D 7A */	lha r4, 0xd7a(r31)
/* 80AC1974  4B 54 AA 68 */	b mDoMtx_YrotS__FPA4_fs
/* 80AC1978  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AC197C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AC1980  38 81 00 08 */	addi r4, r1, 8
/* 80AC1984  7C 85 23 78 */	mr r5, r4
/* 80AC1988  4B 88 53 E4 */	b PSMTXMultVec
/* 80AC198C  38 61 00 08 */	addi r3, r1, 8
/* 80AC1990  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 80AC1994  7C 65 1B 78 */	mr r5, r3
/* 80AC1998  4B 88 56 F8 */	b PSVECAdd
/* 80AC199C  38 7F 0F 70 */	addi r3, r31, 0xf70
/* 80AC19A0  FC 20 F8 90 */	fmr f1, f31
/* 80AC19A4  4B 7A D8 54 */	b SetH__8cM3dGCylFf
/* 80AC19A8  38 7F 0F 70 */	addi r3, r31, 0xf70
/* 80AC19AC  FC 20 F0 90 */	fmr f1, f30
/* 80AC19B0  4B 7A D8 50 */	b SetR__8cM3dGCylFf
/* 80AC19B4  38 7F 0F 70 */	addi r3, r31, 0xf70
/* 80AC19B8  38 81 00 08 */	addi r4, r1, 8
/* 80AC19BC  4B 7A D8 20 */	b SetC__8cM3dGCylFRC4cXyz
/* 80AC19C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AC19C4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AC19C8  38 63 23 3C */	addi r3, r3, 0x233c
/* 80AC19CC  38 9F 0E 4C */	addi r4, r31, 0xe4c
/* 80AC19D0  4B 7A 31 D8 */	b Set__4cCcSFP8cCcD_Obj
lbl_80AC19D4:

...
/* 80AC1C64 00000018  3C 60 00 00 */	lis r3, m__18daNpc_Saru_Param_c@ha
/* 80AC1C68 0000001C  3B E3 00 00 */	addi r31, r3, m__18daNpc_Saru_Param_c@l
...
/* 80AC1C7C 00000030  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80AC1C80 00000034  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 80AC1C94 0000000C  3C 60 00 00 */	lis r3, l_motionAnmData@ha
/* 80AC1C98 00000010  38 83 00 00 */	addi r4, r3, l_motionAnmData@l
/* 80AC1C9C 00000014  80 04 02 C4 */	lwz r0, 0x2c4(r4)
/* 80AC1CA0 00000018  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1CA4 0000001C  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80AC1CA8 00000020  38 63 00 00 */	addi r3, r3, l_resNameList@l
/* 80AC1CAC 00000024  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC1CB0 00000028  80 84 02 BC */	lwz r4, 0x2bc(r4)
/* 80AC1CB4 0000002C  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80AC1CB8 00000030  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
lbl_80AC1D60:
/* 80AC1D60 00000000  3C 60 00 00 */	lis r3, l_motionAnmData@ha
/* 80AC1D64 00000004  38 83 00 00 */	addi r4, r3, l_motionAnmData@l
/* 80AC1D68 00000008  80 04 03 F8 */	lwz r0, 0x3f8(r4)
/* 80AC1D6C 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1D70 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80AC1D74 00000014  38 63 00 00 */	addi r3, r3, l_resNameList@l
...
lbl_80AC1ED8:
/* 80AC1ED8 00000000  3C 60 00 00 */	lis r3, l_motionAnmData@ha
/* 80AC1EDC 00000004  38 83 00 00 */	addi r4, r3, l_motionAnmData@l
/* 80AC1EE0 00000008  80 04 01 3C */	lwz r0, 0x13c(r4)
/* 80AC1EE4 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1EE8 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80AC1EEC 00000014  38 63 00 00 */	addi r3, r3, l_resNameList@l
...
lbl_80AC1F50:
/* 80AC1F50 00000000  3C 60 00 00 */	lis r3, l_motionAnmData@ha
/* 80AC1F54 00000004  38 83 00 00 */	addi r4, r3, l_motionAnmData@l
/* 80AC1F58 00000008  80 04 04 30 */	lwz r0, 0x430(r4)
/* 80AC1F5C 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC1F60 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80AC1F64 00000014  38 63 00 00 */	addi r3, r3, l_resNameList@l
...
lbl_80AC2054:
/* 80AC2054 00000000  3C 60 00 00 */	lis r3, l_motionAnmData@ha
/* 80AC2058 00000004  38 83 00 00 */	addi r4, r3, l_motionAnmData@l
/* 80AC205C 00000008  80 04 00 5C */	lwz r0, 0x5c(r4)
/* 80AC2060 0000000C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC2064 00000010  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80AC2068 00000014  38 63 00 00 */	addi r3, r3, l_resNameList@l

...
/* 80AC3020  4B 68 8B D0 */	b initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80AC3068  4B 68 8C 10 */	b talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80AC3084  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AC3088  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AC308C  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80AC3090  4B 68 26 50 */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80AC3094  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AC3098  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AC309C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80AC30A0  4B 57 F3 C8 */	b reset__14dEvt_control_cFv
...
/* 80AC30BC  4B 68 26 40 */	b remove__18daNpcT_ActorMngr_cFv
/* 80AC30C0  38 00 00 00 */	li r0, 0
/* 80AC30C4  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AC30C8  3C 60 80 AC */	lis r3, lit_4231@ha
/* 80AC30CC  C0 03 45 AC */	lfs f0, lit_4231@l(r3)
...
/* 80AC3104  4B 68 25 F8 */	b remove__18daNpcT_ActorMngr_cFv
/* 80AC3108  38 00 00 00 */	li r0, 0
/* 80AC310C  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AC3110  3C 60 80 AC */	lis r3, lit_4231@ha
/* 80AC3114  C0 03 45 AC */	lfs f0, lit_4231@l(r3)
...
/* 80AC3140  4B 68 25 BC */	b remove__18daNpcT_ActorMngr_cFv
/* 80AC3144  38 00 00 00 */	li r0, 0
/* 80AC3148  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80AC314C  3C 60 80 AC */	lis r3, lit_4231@ha
/* 80AC3150  C0 03 45 AC */	lfs f0, lit_4231@l(r3)
...
/* 80AC3170  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AC3174  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AC3178  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80AC317C  4B 55 75 94 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AC3198  4B 68 84 B0 */	b step__8daNpcT_cFsiiii
lbl_80AC319C:

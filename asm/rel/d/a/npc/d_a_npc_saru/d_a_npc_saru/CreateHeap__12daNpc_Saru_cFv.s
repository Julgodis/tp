...
/* 80AC083C  4B 8A 19 90 */	b _savegpr_25
/* 80AC0840  7C 7A 1B 78 */	mr r26, r3
/* 80AC0844  3C 60 80 AC */	lis r3, m__18daNpc_Saru_Param_c@ha
/* 80AC0848  3B A3 44 F8 */	addi r29, r3, m__18daNpc_Saru_Param_c@l
...
/* 80AC085C  3C 60 80 AC */	lis r3, l_bmdData@ha
/* 80AC0860  38 83 46 C4 */	addi r4, r3, l_bmdData@l
/* 80AC0864  7C 64 2A 14 */	add r3, r4, r5
/* 80AC0868  80 03 00 04 */	lwz r0, 4(r3)
/* 80AC086C  54 00 10 3A */	slwi r0, r0, 2
/* 80AC0870  3C 60 80 AC */	lis r3, l_resNameList@ha
/* 80AC0874  38 63 46 FC */	addi r3, r3, l_resNameList@l
/* 80AC0878  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC087C  7C 84 28 2E */	lwzx r4, r4, r5
/* 80AC0880  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80AC0884  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80AC0898  4B 57 BA 54 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC08B0  4B 80 E3 9C */	b __nw__FUl
...
/* 80AC08F8  4B 54 FE D8 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80AC0928  3C 60 80 AC */	lis r3, ctrlJointCallBack__12daNpc_Saru_cFP8J3DJointi@ha
/* 80AC092C  38 83 0B 0C */	addi r4, r3, ctrlJointCallBack__12daNpc_Saru_cFP8J3DJointi@l
...
/* 80AC0968  3C 60 80 AC */	lis r3, l_bmdData@ha
/* 80AC096C  3B E3 46 C4 */	addi r31, r3, l_bmdData@l
lbl_80AC0970:
...
/* 80AC0990  3C 60 80 AC */	lis r3, l_resNameList@ha
/* 80AC0994  38 63 46 FC */	addi r3, r3, l_resNameList@l
/* 80AC0998  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC099C  7F 85 E3 78 */	mr r5, r28
/* 80AC09A0  38 C0 00 80 */	li r6, 0x80
/* 80AC09A4  4B 57 B9 48 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AC09C4  4B 55 42 90 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80AC09FC  4B 68 99 8C */	b setFaceMotionAnm__8daNpcT_cFib
...
/* 80AC0A40  4B 8A 17 D8 */	b _restgpr_25

...
/* 80AC3FE8 00000004  4B FF C3 B1 */	bl _savegpr_29
...
/* 80AC3FFC 00000018  3C 60 00 00 */	lis r3, m__18daNpc_Saru_Param_c@ha /* 80AC44F8 */
/* 80AC4000 0000001C  3B C3 00 00 */	addi r30, r3, m__18daNpc_Saru_Param_c@l /* 80AC44F8 */
...
/* 80AC401C 00000038  4B FF C3 7D */	bl __mi__4cXyzCFRC3Vec
...
/* 80AC403C 00000058  C0 1E 00 B4 */	lfs f0, 0xb4(r30)
...
/* 80AC404C 00000068  4B FF C3 4D */	bl PSVECSquareMag
/* 80AC4050 0000006C  C0 1E 00 B4 */	lfs f0, 0xb4(r30)
...
/* 80AC4060 00000008  C8 9E 00 F8 */	lfd f4, 0xf8(r30)
/* 80AC4064 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80AC4068 00000010  C8 7E 01 00 */	lfd f3, 0x100(r30)
...
lbl_80AC40B0:
/* 80AC40B0 00000000  C8 1E 01 08 */	lfd f0, 0x108(r30)
/* 80AC40B4 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80AC40B8 00000000  40 80 00 10 */	bge lbl_80AC40C8
/* 80AC40BC 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80AC40C0 00000008  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80AC412C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80AC4130 0000000C  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80AC4140 00000004  4B FF C2 59 */	bl cM_atan2s__Fff
...
/* 80AC41C4 00000008  4B FF C1 D5 */	bl _restgpr_29

...
/* 80AC2940 00000030  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2944 00000034  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2970 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2974 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC29A4 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC29A8 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC29D4 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC29D8 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2A18 00000034  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2A1C 00000038  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2A48 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2A4C 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2AB8 00000030  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2ABC 00000034  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2AE8 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2AEC 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2B1C 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2B20 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2B4C 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2B50 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2B80 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2B84 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2BB0 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2BB4 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2C88 00000030  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2C8C 00000034  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2CB8 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2CBC 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2CFC 00000038  3C 60 00 00 */	lis r3, lit_4231@ha
/* 80AC2D00 0000003C  C0 03 00 00 */	lfs f0, lit_4231@l(r3)
...
/* 80AC2D5C 00000048  3C 60 00 00 */	lis r3, lit_4231@ha
/* 80AC2D60 0000004C  C0 03 00 00 */	lfs f0, lit_4231@l(r3)
...
/* 80AC2DC0 0000001C  3C 60 00 00 */	lis r3, lit_4231@ha
/* 80AC2DC4 00000020  C0 03 00 00 */	lfs f0, lit_4231@l(r3)
...
/* 80AC2ECC 00000058  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2ED0 0000005C  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2EFC 00000024  3C 60 00 00 */	lis r3, lit_4608@ha
/* 80AC2F00 00000028  C0 03 00 00 */	lfs f0, lit_4608@l(r3)
...
/* 80AC2F38 0000001C  3C 60 00 00 */	lis r3, mFindCount__8daNpcT_c@ha
/* 80AC2F3C 00000020  90 03 00 00 */	stw r0, mFindCount__8daNpcT_c@l(r3)
/* 80AC2F40 00000024  3C 60 00 00 */	lis r3, srchYm__12daNpc_Saru_cFPvPv@ha
/* 80AC2F44 00000028  38 63 00 00 */	addi r3, r3, srchYm__12daNpc_Saru_cFPvPv@l
...
/* 80AC2F58 0000003C  3C 80 00 00 */	lis r4, mFindCount__8daNpcT_c@ha
/* 80AC2F5C 00000040  80 C4 00 00 */	lwz r6, mFindCount__8daNpcT_c@l(r4)
/* 80AC2F60 00000044  3C 80 00 00 */	lis r4, mFindActorPtrs__8daNpcT_c@ha
/* 80AC2F64 00000048  38 A4 00 00 */	addi r5, r4, mFindActorPtrs__8daNpcT_c@l

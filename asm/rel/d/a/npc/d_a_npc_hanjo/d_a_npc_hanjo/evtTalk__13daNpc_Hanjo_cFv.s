...
/* 809FA570  3C 80 80 A0 */	lis r4, lit_4891@ha
/* 809FA574  38 A4 10 60 */	addi r5, r4, lit_4891@l
/* 809FA578  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80A01060 */
/* 809FA57C  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80A01064 */
/* 809FA580  90 81 00 14 */	stw r4, 0x14(r1)
/* 809FA584  90 01 00 18 */	stw r0, 0x18(r1)
/* 809FA588  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80A01068 */
...
/* 809FA5AC  4B 96 7A D8 */	b __ptmf_scall
/* 809FA5B0  60 00 00 00 */	nop 
/* 809FA5B4  48 00 00 30 */	b lbl_809FA5E4
lbl_809FA5B8:
/* 809FA5B8  3C 60 80 A0 */	lis r3, lit_4896@ha
/* 809FA5BC  38 83 10 6C */	addi r4, r3, lit_4896@l
/* 809FA5C0  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80A0106C */
/* 809FA5C4  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80A01070 */
/* 809FA5C8  90 61 00 08 */	stw r3, 8(r1)
/* 809FA5CC  90 01 00 0C */	stw r0, 0xc(r1)
/* 809FA5D0  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80A01074 */

...
/* 809A5434  4B 9B CD 9C */	b _savegpr_26
/* 809A5438  7C 9C 23 78 */	mr r28, r4
/* 809A543C  3C 80 80 9A */	lis r4, lit_1109@ha
/* 809A5440  3B C4 6A 10 */	addi r30, r4, lit_1109@l
/* 809A5444  3C 80 80 9A */	lis r4, lit_3748@ha
/* 809A5448  3B E4 68 A4 */	addi r31, r4, lit_3748@l
/* 809A544C  7C 7A 1B 78 */	mr r26, r3
/* 809A5450  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A5454  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A5458  83 A3 5D AC */	lwz r29, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 809A5498  4B 8C 28 90 */	b SetPos__11cBgS_GndChkFPC4cXyz
/* 809A549C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A54A0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A54A4  3B 63 0F 38 */	addi r27, r3, 0xf38
/* 809A54A8  7F 63 DB 78 */	mr r3, r27
/* 809A54AC  38 9E 00 CC */	addi r4, r30, 0xcc
/* 809A54B0  4B 6C EF F0 */	b GroundCross__4cBgSFP11cBgS_GndChk
...
/* 809A54EC  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 809A54F0  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 809A54F4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 809A54F8  A8 9C 00 46 */	lha r4, 0x46(r28)
/* 809A54FC  4B 66 6E E0 */	b mDoMtx_YrotS__FPA4_fs
...
/* 809A5540  4B 6D 28 24 */	b Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c
/* 809A5544  7F 63 DB 78 */	mr r3, r27
/* 809A5548  38 9E 00 50 */	addi r4, r30, 0x50
/* 809A554C  4B 6C EE 68 */	b LineCross__4cBgSFP11cBgS_LinChk
...
/* 809A5564  4B 8C 24 28 */	b cM_rndFX__Ff
...
/* 809A5594  4B 8C 23 C0 */	b cM_rndF__Ff
...
/* 809A55E8  4B 8C 23 A4 */	b cM_rndFX__Ff
...
/* 809A561C  4B 8C 23 70 */	b cM_rndFX__Ff
...
/* 809A563C  4B 8C 23 50 */	b cM_rndFX__Ff
...
/* 809A5658  4B 8C 22 FC */	b cM_rndF__Ff
...
/* 809A567C  4B 8C 23 10 */	b cM_rndFX__Ff
...
/* 809A56C0  4B 8C 1F B4 */	b cM_atan2s__Fff
...
/* 809A56D4  4B 8C 1F A0 */	b cM_atan2s__Fff
...
/* 809A5704  4B 8C 22 50 */	b cM_rndF__Ff
...
/* 809A5738  4B 8C 22 1C */	b cM_rndF__Ff
...
/* 809A5758  4B 8C 21 FC */	b cM_rndF__Ff
...
/* 809A5784  4B 8C 21 D0 */	b cM_rndF__Ff
...
/* 809A57A4  4B 8C 21 B0 */	b cM_rndF__Ff
...
/* 809A57C4  4B 8C AE 44 */	b cLib_addCalcAngleS2__FPssss
...
/* 809A57D8  4B 8C AE 30 */	b cLib_addCalcAngleS2__FPssss
...
/* 809A57EC  4B 8C A2 50 */	b cLib_addCalc2__FPffff
...
/* 809A5800  4B 8C A2 3C */	b cLib_addCalc2__FPffff
...
/* 809A5814  4B 8C A2 28 */	b cLib_addCalc2__FPffff
...
/* 809A5828  4B 8C A2 14 */	b cLib_addCalc2__FPffff
...
/* 809A5840  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 809A5844  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 809A5848  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 809A584C  A8 9C 00 46 */	lha r4, 0x46(r28)
/* 809A5850  4B 66 6B 8C */	b mDoMtx_YrotS__FPA4_fs
/* 809A5854  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 809A5858  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 809A585C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
/* 809A5860  A8 9C 00 44 */	lha r4, 0x44(r28)
/* 809A5864  4B 66 6B 38 */	b mDoMtx_XrotM__FPA4_fs
/* 809A5868  38 61 00 14 */	addi r3, r1, 0x14
/* 809A586C  38 81 00 08 */	addi r4, r1, 8
/* 809A5870  4B 8C B6 7C */	b MtxPosition__FP4cXyzP4cXyz
/* 809A5874  38 7C 00 08 */	addi r3, r28, 8
/* 809A5878  38 81 00 08 */	addi r4, r1, 8
/* 809A587C  7C 65 1B 78 */	mr r5, r3
/* 809A5880  4B 9A 18 10 */	b PSVECAdd
...
/* 809A58FC  4B 8C 20 58 */	b cM_rndF__Ff
...
/* 809A59C8  4B 9B C8 54 */	b _restgpr_26

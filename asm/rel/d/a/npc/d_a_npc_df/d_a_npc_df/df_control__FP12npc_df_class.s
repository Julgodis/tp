...
/* 809A6110  4B 9B C0 C8 */	b _savegpr_28
/* 809A6114  7C 7C 1B 78 */	mr r28, r3
/* 809A6118  3C 60 80 9A */	lis r3, lit_3748@ha
/* 809A611C  3B E3 68 A4 */	addi r31, r3, lit_3748@l
...
/* 809A61A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A61A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 809A61CC  4B 9A 07 1C */	b PSMTXTrans
/* 809A61D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A61D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809A61D8  A8 9E 00 46 */	lha r4, 0x46(r30)
/* 809A61DC  4B 66 62 58 */	b mDoMtx_YrotM__FPA4_fs
/* 809A61E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A61E4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809A61E8  A8 9E 00 70 */	lha r4, 0x70(r30)
/* 809A61EC  4B 66 61 B0 */	b mDoMtx_XrotM__FPA4_fs
/* 809A61F0  C0 3E 00 58 */	lfs f1, 0x58(r30)
/* 809A61F4  FC 40 08 90 */	fmr f2, f1
/* 809A61F8  FC 60 08 90 */	fmr f3, f1
/* 809A61FC  4B 66 6C 3C */	b scaleM__14mDoMtx_stack_cFfff
...
/* 809A6214  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809A6218  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
/* 809A621C  7C 63 04 2E */	lfsx f3, r3, r0
/* 809A6220  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809A6224  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 809A6300  4B 9B BF 24 */	b _restgpr_28

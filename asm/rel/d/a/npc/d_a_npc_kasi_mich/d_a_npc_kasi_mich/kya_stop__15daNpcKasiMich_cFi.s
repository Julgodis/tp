...
/* 80A28E60 0000000C  3C 80 80 A3 */	lis r4, lit_5201@ha
/* 80A28E64 00000010  38 A4 A6 30 */	addi r5, r4, lit_5201@l
/* 80A28E68 00000014  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80A2A630 */
/* 80A28E6C 00000018  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80A2A634 */
/* 80A28E70 0000001C  90 81 00 14 */	stw r4, 0x14(r1)
/* 80A28E74 00000020  90 01 00 18 */	stw r0, 0x18(r1)
/* 80A28E78 00000024  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80A2A638 */
...
/* 80A28EA0 00000008  3C 80 80 A3 */	lis r4, lit_5219@ha
/* 80A28EA4 0000000C  C0 04 A2 90 */	lfs f0, lit_5219@l(r4)
/* 80A28EA8 00000010  FC 00 08 00 */	fcmpu cr0, f0, f1
/* 80A28EAC 00000014  41 82 00 14 */	beq lbl_80A28EC0
/* 80A28EB0 00000018  3C 80 80 A3 */	lis r4, lit_4247@ha
/* 80A28EB4 0000001C  C0 04 A0 D0 */	lfs f0, lit_4247@l(r4)
/* 80A28EB8 00000020  FC 00 08 00 */	fcmpu cr0, f0, f1
/* 80A28EBC 00000024  40 82 00 2C */	bne lbl_80A28EE8
lbl_80A28EC0:
/* 80A28EC0 00000000  3C 80 80 A3 */	lis r4, lit_5209@ha
/* 80A28EC4 00000004  38 A4 A6 3C */	addi r5, r4, lit_5209@l
/* 80A28EC8 00000008  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80A2A63C */
/* 80A28ECC 0000000C  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80A2A640 */
/* 80A28ED0 00000010  90 81 00 08 */	stw r4, 8(r1)
/* 80A28ED4 00000014  90 01 00 0C */	stw r0, 0xc(r1)
/* 80A28ED8 00000018  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80A2A644 */

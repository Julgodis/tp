...
/* 809B0DF0  4B 9B 13 E4 */	b _savegpr_27
/* 809B0DF4  7C 7F 1B 78 */	mr r31, r3
/* 809B0DF8  3C 60 80 9B */	lis r3, lit_3762@ha
/* 809B0DFC  3B C3 18 48 */	addi r30, r3, lit_3762@l
/* 809B0E00  4B 66 74 A8 */	b cDmrNowMidnaTalk__Fv
...
/* 809B0E7C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809B0E80  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809B0E84  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 809B0E88  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 809B0E8C  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 809B0E90  4B 99 5A 58 */	b PSMTXTrans
/* 809B0E94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809B0E98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809B0E9C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 809B0EA0  4B 65 B5 94 */	b mDoMtx_YrotM__FPA4_fs
/* 809B0EA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809B0EA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809B0EAC  A8 9F 04 E4 */	lha r4, 0x4e4(r31)
/* 809B0EB0  4B 65 B4 EC */	b mDoMtx_XrotM__FPA4_fs
/* 809B0EB4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809B0EB8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809B0EBC  A8 9F 04 E8 */	lha r4, 0x4e8(r31)
/* 809B0EC0  4B 65 B6 0C */	b mDoMtx_ZrotM__FPA4_fs
/* 809B0EC4  3C 60 80 9B */	lis r3, l_HIO@ha
/* 809B0EC8  3B A3 19 F8 */	addi r29, r3, l_HIO@l
/* 809B0ECC  C0 3D 00 08 */	lfs f1, 8(r29)	/* effective address: 809B1A00 */
/* 809B0ED0  FC 40 08 90 */	fmr f2, f1
/* 809B0ED4  FC 60 08 90 */	fmr f3, f1
/* 809B0ED8  4B 65 BF 60 */	b scaleM__14mDoMtx_stack_cFfff
/* 809B0EDC  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 809B0EE0  83 83 00 04 */	lwz r28, 4(r3)
/* 809B0EE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809B0EE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809B0EEC  38 9C 00 24 */	addi r4, r28, 0x24
/* 809B0EF0  4B 99 55 C0 */	b PSMTXCopy
...
/* 809B0F04  4B 65 F6 C4 */	b play__14mDoExt_McaMorfFP3VecUlSc
...
/* 809B0F30  4B 65 F7 7C */	b modelCalc__14mDoExt_McaMorfFv
...
/* 809B0F4C  4B 97 74 E0 */	b checkPass__12J3DFrameCtrlFf
...
/* 809B0F6C  3C 60 80 9B */	lis r3, data_809B18F4@ha
/* 809B0F70  38 63 18 F4 */	addi r3, r3, data_809B18F4@l
/* 809B0F74  7F 63 00 2E */	lwzx r27, r3, r0
/* 809B0F78  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 809B0F7C  7C 03 07 74 */	extsb r3, r0
/* 809B0F80  4B 67 C0 EC */	b dComIfGp_getReverb__Fi
/* 809B0F84  7C 67 1B 78 */	mr r7, r3
/* 809B0F88  93 61 00 10 */	stw r27, 0x10(r1)
/* 809B0F8C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 809B0F90  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 809B0F94  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 809B0FB8  4B 8F A9 CC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
/* 809B0FBC  48 00 00 D0 */	b lbl_809B108C
lbl_809B0FC0:
/* 809B0FC0  88 1F 05 B4 */	lbz r0, 0x5b4(r31)
/* 809B0FC4  54 00 10 3A */	slwi r0, r0, 2
/* 809B0FC8  3C 60 80 9B */	lis r3, data_809B18EC@ha
/* 809B0FCC  38 63 18 EC */	addi r3, r3, data_809B18EC@l
/* 809B0FD0  7F 63 00 2E */	lwzx r27, r3, r0
/* 809B0FD4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 809B0FD8  7C 03 07 74 */	extsb r3, r0
/* 809B0FDC  4B 67 C0 90 */	b dComIfGp_getReverb__Fi
/* 809B0FE0  7C 67 1B 78 */	mr r7, r3
/* 809B0FE4  93 61 00 0C */	stw r27, 0xc(r1)
/* 809B0FE8  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 809B0FEC  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 809B0FF0  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 809B1014  4B 8F A9 70 */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
...
/* 809B1034  4B 97 73 F8 */	b checkPass__12J3DFrameCtrlFf
...
/* 809B1048  4B 67 C0 24 */	b dComIfGp_getReverb__Fi
...
/* 809B105C  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 809B1060  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 809B1064  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
...
/* 809B1088  4B 8F A8 FC */	b seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc
lbl_809B108C:
/* 809B108C  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 809B1090  80 63 00 0C */	lwz r3, 0xc(r3)
/* 809B1094  38 63 01 E0 */	addi r3, r3, 0x1e0
/* 809B1098  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 809B109C  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 809B10A0  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 809B10A4  4B 99 54 0C */	b PSMTXCopy
...
/* 809B10C0  4B 8B FE 2C */	b MtxPosition__FP4cXyzP4cXyz
...
/* 809B10F4  4B 8B E5 54 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 809B1108  4B 8B E6 00 */	b SetR__8cM3dGSphFf
/* 809B110C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809B1110  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809B1114  38 63 23 3C */	addi r3, r3, 0x233c
/* 809B1118  38 9F 08 40 */	addi r4, r31, 0x840
/* 809B111C  4B 8B 3A 8C */	b Set__4cCcSFP8cCcD_Obj
/* 809B1120  88 1F 04 E2 */	lbz r0, 0x4e2(r31)
/* 809B1124  7C 03 07 74 */	extsb r3, r0
/* 809B1128  4B 67 BF 44 */	b dComIfGp_getReverb__Fi
...
/* 809B1158  4B 9B 10 C8 */	b _restgpr_27

...
/* 809AFE48  83 C3 00 38 */	lwz r30, 0x38(r3)	/* effective address: 80434B00 */
...
/* 809AFE78  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 809AFE7C  4B 99 66 34 */	b PSMTXCopy
/* 809AFE80  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 809AFE84  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 809AFE88  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFE9C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFEB8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFEE8  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 809AFEEC  4B 99 65 C4 */	b PSMTXCopy
/* 809AFEF0  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 809AFEF4  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 809AFEF8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFF0C  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFF20  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFF34  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFF50  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFF80  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 809AFF84  4B 99 65 2C */	b PSMTXCopy
/* 809AFF88  3C 60 80 45 */	lis r3, calc_mtx@ha
/* 809AFF8C  38 63 07 68 */	addi r3, r3, calc_mtx@l
/* 809AFF90  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFFA4  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFFB8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFFCC  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */
...
/* 809AFFE8  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80450768 */

...
/* 80B0B5E4  3C 60 80 B1 */	lis r3, lit_3999@ha
/* 80B0B5E8  3B C3 C1 C4 */	addi r30, r3, lit_3999@l
/* 80B0B5EC  88 1F 06 C1 */	lbz r0, 0x6c1(r31)
/* 80B0B5F0  28 00 00 00 */	cmplwi r0, 0
/* 80B0B5F4  41 82 00 68 */	beq lbl_80B0B65C
/* 80B0B5F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B0B5FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B0B600  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)
/* 80B0B604  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)
/* 80B0B608  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80B0B60C  4B 83 B2 DC */	b PSMTXTrans
/* 80B0B610  38 7F 04 E4 */	addi r3, r31, 0x4e4
/* 80B0B614  4B 50 19 30 */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80B0B618  A8 DF 06 A4 */	lha r6, 0x6a4(r31)
/* 80B0B61C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B0B620  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80B0B6AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B0B6B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B0B6B4  38 84 00 24 */	addi r4, r4, 0x24
/* 80B0B6B8  4B 83 AD F8 */	b PSMTXCopy
/* 80B0B6BC  80 7F 05 70 */	lwz r3, 0x570(r31)
/* 80B0B6C0  4B 50 5B 2C */	b modelCalc__16mDoExt_McaMorfSOFv

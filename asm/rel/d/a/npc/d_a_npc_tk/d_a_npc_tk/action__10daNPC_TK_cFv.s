...
/* 80B0B294  4B 85 6F 48 */	b _savegpr_29
/* 80B0B298  7C 7E 1B 78 */	mr r30, r3
/* 80B0B29C  AB E3 04 E6 */	lha r31, 0x4e6(r3)
/* 80B0B2A0  3C 80 80 B1 */	lis r4, lit_4024@ha
/* 80B0B2A4  C0 04 C1 F4 */	lfs f0, lit_4024@l(r4)
...
/* 80B0B2DC  3C 60 80 B1 */	lis r3, lit_7877@ha
/* 80B0B2E0  38 63 C4 9C */	addi r3, r3, lit_7877@l
...
/* 80B0B314  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B0B318  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B0B31C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B0B320  7F C4 F3 78 */	mr r4, r30
/* 80B0B324  3C A0 80 B1 */	lis r5, struct_80B0C3A0+0x0@ha
/* 80B0B328  38 A5 C3 A0 */	addi r5, r5, struct_80B0C3A0+0x0@l
/* 80B0B32C  38 A5 00 38 */	addi r5, r5, 0x38
/* 80B0B330  4B 53 76 28 */	b setSkipZev__14dEvt_control_cFPvPc
...
/* 80B0B350  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B0B354  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B0B358  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80B0B35C  3C A0 80 B1 */	lis r5, struct_80B0C3A0+0x0@ha
/* 80B0B360  38 A5 C3 A0 */	addi r5, r5, struct_80B0C3A0+0x0@l
...
/* 80B0B378  4B 51 01 68 */	b fopAcM_orderOtherEvent__FP10fopAc_ac_cP10fopAc_ac_cPCcUsUsUs
...
/* 80B0B49C  4B 75 C1 D8 */	b cM_atan2s__Fff
/* 80B0B4A0  38 03 C0 00 */	addi r0, r3, -16384
/* 80B0B4A4  7C 04 07 34 */	extsh r4, r0
/* 80B0B4A8  C0 3E 05 2C */	lfs f1, 0x52c(r30)
/* 80B0B4AC  3C 60 80 B1 */	lis r3, lit_4024@ha
/* 80B0B4B0  C0 03 C1 F4 */	lfs f0, lit_4024@l(r3)
...
/* 80B0B4CC  3C 60 80 B1 */	lis r3, lit_4005@ha
/* 80B0B4D0  C0 03 C1 DC */	lfs f0, lit_4005@l(r3)
...
/* 80B0B4F4  3C 60 80 B1 */	lis r3, lit_4525@ha
/* 80B0B4F8  C8 23 C2 6C */	lfd f1, lit_4525@l(r3)
...
/* 80B0B518  3C 60 80 B1 */	lis r3, lit_4005@ha
/* 80B0B51C  C0 03 C1 DC */	lfs f0, lit_4005@l(r3)
...
/* 80B0B588  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B0B58C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B0B590  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80B0B594  4B 56 B5 18 */	b CrrPos__9dBgS_AcchFR4dBgS
lbl_80B0B598:
/* 80B0B598  88 1E 04 E2 */	lbz r0, 0x4e2(r30)
/* 80B0B59C  7C 03 07 74 */	extsb r3, r0
/* 80B0B5A0  4B 52 1A CC */	b dComIfGp_getReverb__Fi
/* 80B0B5A4  7C 65 1B 78 */	mr r5, r3
/* 80B0B5A8  80 7E 05 70 */	lwz r3, 0x570(r30)
/* 80B0B5AC  38 80 00 00 */	li r4, 0
/* 80B0B5B0  4B 50 5B 00 */	b play__16mDoExt_McaMorfSOFUlSc
/* 80B0B5B4  39 61 00 30 */	addi r11, r1, 0x30
/* 80B0B5B8  4B 85 6C 70 */	b _restgpr_29

...
/* 80AF3B58  4B 86 E6 70 */	b _savegpr_24
/* 80AF3B5C  7C 7D 1B 78 */	mr r29, r3
/* 80AF3B60  3C 60 80 AF */	lis r3, lit_1109@ha
/* 80AF3B64  3B C3 5E 30 */	addi r30, r3, lit_1109@l
/* 80AF3B68  3C 60 80 AF */	lis r3, m__22daNpc_SoldierB_Param_c@ha
/* 80AF3B6C  3B E3 5A D4 */	addi r31, r3, m__22daNpc_SoldierB_Param_c@l
/* 80AF3B70  88 1E 00 5C */	lbz r0, 0x5c(r30)	/* effective address: 80AF5E8C */
...
/* 80AF3B94  3C 80 80 AF */	lis r4, __dt__4cXyzFv@ha
/* 80AF3B98  38 84 53 7C */	addi r4, r4, __dt__4cXyzFv@l
...
/* 80AF3BB0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3BB4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3BB8  A8 9D 09 90 */	lha r4, 0x990(r29)
/* 80AF3BBC  4B 51 88 20 */	b mDoMtx_YrotS__FPA4_fs
...
/* 80AF3BD0  4B 77 BE 6C */	b cLib_addCalc2__FPffff
...
/* 80AF3BE4  4B 77 BE 58 */	b cLib_addCalc2__FPffff
/* 80AF3BE8  3B 00 00 00 */	li r24, 0
/* 80AF3BEC  3B 80 00 00 */	li r28, 0
/* 80AF3BF0  3B 60 00 00 */	li r27, 0
/* 80AF3BF4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80AF3BF8  3B 23 9A 20 */	addi r25, r3, sincosTable___5JMath@l
/* 80AF3BFC  C3 DF 00 80 */	lfs f30, 0x80(r31)
/* 80AF3C00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3C04  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l
lbl_80AF3C08:
...
/* 80AF3C38  4B 85 31 34 */	b PSMTXMultVec
...
/* 80AF3C90  4B 77 CA 40 */	b cLib_chaseS__FPsss
...
/* 80AF3CF8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AF3CFC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AF3D00  4B 85 27 B0 */	b PSMTXCopy
/* 80AF3D04  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3D08  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3D0C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80AF3D10  D0 1D 08 E4 */	stfs f0, 0x8e4(r29)
/* 80AF3D14  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80AF3D18  D0 1D 08 E8 */	stfs f0, 0x8e8(r29)
/* 80AF3D1C  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80AF3D20  D0 1D 08 EC */	stfs f0, 0x8ec(r29)
/* 80AF3D24  38 9E 00 60 */	addi r4, r30, 0x60
/* 80AF3D28  38 BD 05 38 */	addi r5, r29, 0x538
/* 80AF3D2C  4B 85 30 40 */	b PSMTXMultVec
/* 80AF3D30  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3D34  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3D38  38 9E 00 60 */	addi r4, r30, 0x60
/* 80AF3D3C  38 A1 00 30 */	addi r5, r1, 0x30
/* 80AF3D40  4B 85 30 2C */	b PSMTXMultVec
/* 80AF3D44  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 80AF3D48  38 81 00 30 */	addi r4, r1, 0x30
/* 80AF3D4C  4B 77 CF 28 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80AF3D50  B0 7D 09 02 */	sth r3, 0x902(r29)
/* 80AF3D54  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 80AF3D58  38 81 00 30 */	addi r4, r1, 0x30
/* 80AF3D5C  4B 77 CE A8 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80AF3D78  4B 77 2D BC */	b __mi__4cXyzCFRC3Vec
...
/* 80AF3DB0  4B 77 38 C4 */	b cM_atan2s__Fff
...
/* 80AF3DDC  4B 85 33 5C */	b PSVECSquareMag
...
/* 80AF3E4C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AF3E50  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80AF3EBC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AF3EC0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80AF3EC4  48 00 00 08 */	b lbl_80AF3ECC
lbl_80AF3EC8:
/* 80AF3EC8  FC 40 08 90 */	fmr f2, f1
lbl_80AF3ECC:
/* 80AF3ECC  C0 21 00 40 */	lfs f1, 0x40(r1)
/* 80AF3ED0  4B 77 37 A4 */	b cM_atan2s__Fff
...
/* 80AF3F10  4B 51 8E 54 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80AF3F14  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3F18  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3F1C  A8 9D 08 F0 */	lha r4, 0x8f0(r29)
/* 80AF3F20  A8 BD 08 F2 */	lha r5, 0x8f2(r29)
/* 80AF3F24  A8 DD 08 F4 */	lha r6, 0x8f4(r29)
/* 80AF3F28  4B 51 83 78 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80AF3F2C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3F30  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3F34  38 81 00 3C */	addi r4, r1, 0x3c
/* 80AF3F38  38 A1 00 48 */	addi r5, r1, 0x48
/* 80AF3F3C  4B 85 2E 30 */	b PSMTXMultVec
...
/* 80AF3FAC  4B 77 B2 30 */	b SetC__8cM3dGCylFRC4cXyz
...
/* 80AF3FC4  4B 77 B2 34 */	b SetH__8cM3dGCylFf
...
/* 80AF3FDC  4B 77 B2 24 */	b SetR__8cM3dGCylFf
/* 80AF3FE0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AF3FE4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AF3FE8  38 63 23 3C */	addi r3, r3, 0x233c
/* 80AF3FEC  38 9D 0C 94 */	addi r4, r29, 0xc94
/* 80AF3FF0  4B 77 0B B8 */	b Set__4cCcSFP8cCcD_Obj
lbl_80AF3FF4:
...
/* 80AF401C  4B 86 E1 F8 */	b _restgpr_24

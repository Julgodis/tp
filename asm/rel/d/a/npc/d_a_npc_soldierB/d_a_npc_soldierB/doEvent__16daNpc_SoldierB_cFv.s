...
/* 80AF4780  4B 86 DA 50 */	b _savegpr_26
/* 80AF4784  7C 7C 1B 78 */	mr r28, r3
/* 80AF4788  3C 60 80 AF */	lis r3, cNullVec__6Z2Calc@ha
/* 80AF478C  3B E3 5C 10 */	addi r31, r3, cNullVec__6Z2Calc@l
/* 80AF4790  3B A0 00 00 */	li r29, 0
/* 80AF4794  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AF4798  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 80AF479C  88 1B 4F AD */	lbz r0, 0x4fad(r27)	/* effective address: 8040B16D */
...
/* 80AF480C  4B 86 D8 78 */	b __ptmf_scall
/* 80AF4810  60 00 00 00 */	nop 
/* 80AF4814  48 00 00 64 */	b lbl_80AF4878
lbl_80AF4818:
/* 80AF4818  38 00 00 00 */	li r0, 0
/* 80AF481C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AF4820  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AF4824  88 63 4F B5 */	lbz r3, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80AF4848  4B 55 3F A8 */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80AF4890  4B 55 32 8C */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80AF48BC  4B 55 35 54 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80AF48D8  4B 86 D7 AC */	b __ptmf_scall
...
/* 80AF48F0  4B 55 38 8C */	b cutEnd__16dEvent_manager_cFi
lbl_80AF48F4:
...
/* 80AF494C  4B 65 ED CC */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80AF496C  3C A0 80 AF */	lis r5, lit_5036@ha
/* 80AF4970  C0 25 5B D8 */	lfs f1, lit_5036@l(r5)
...
/* 80AF49A0  3C 60 80 3A */	lis r3, __ptmf_null@ha
/* 80AF49A4  38 83 21 80 */	addi r4, r3, __ptmf_null@l
/* 80AF49A8  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 803A2180 */
/* 80AF49AC  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 803A2184 */
/* 80AF49B0  90 7C 0D DC */	stw r3, 0xddc(r28)
/* 80AF49B4  90 1C 0D E0 */	stw r0, 0xde0(r28)
/* 80AF49B8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 803A2188 */
...
/* 80AF49D0  4B 86 D8 4C */	b _restgpr_26

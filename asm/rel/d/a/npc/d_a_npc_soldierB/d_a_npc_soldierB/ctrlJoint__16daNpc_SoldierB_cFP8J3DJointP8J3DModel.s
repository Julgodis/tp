...
/* 80AF3644  4B 86 EB 94 */	b _savegpr_28
...
/* 80AF3658  3C 60 80 AF */	lis r3, lit_4477@ha
/* 80AF365C  38 83 5B 58 */	addi r4, r3, lit_4477@l
/* 80AF3660  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AF5B58 */
/* 80AF3664  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AF5B5C */
/* 80AF3668  90 61 00 08 */	stw r3, 8(r1)
/* 80AF366C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AF3670  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AF5B60 */
...
/* 80AF3694  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AF3698  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AF369C  4B 85 2E 14 */	b PSMTXCopy
/* 80AF36A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF36A4  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l
/* 80AF36A8  C0 1F 00 0C */	lfs f0, 0xc(r31)	/* effective address: 803DD47C */
/* 80AF36AC  D0 1C 08 54 */	stfs f0, 0x854(r28)
/* 80AF36B0  C0 1F 00 1C */	lfs f0, 0x1c(r31)	/* effective address: 803DD48C */
/* 80AF36B4  D0 1C 08 58 */	stfs f0, 0x858(r28)
/* 80AF36B8  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 803DD49C */
...
/* 80AF36D8  4B 85 2D D8 */	b PSMTXCopy
...
/* 80AF3708  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AF370C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AF3710  4B 85 2D A0 */	b PSMTXCopy
...
/* 80AF373C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AF3740  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AF3744  4B 85 2D 6C */	b PSMTXCopy
...
/* 80AF3774  3C C0 80 AF */	lis r6, m__22daNpc_SoldierB_Param_c@ha
/* 80AF3778  38 C6 5A D4 */	addi r6, r6, m__22daNpc_SoldierB_Param_c@l
/* 80AF377C  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 80AF5B14 */
/* 80AF3780  4B 65 FB FC */	b setLookatMtx__8daNpcF_cFiPif
lbl_80AF3784:
/* 80AF3784  2C 1E 00 01 */	cmpwi r30, 1
/* 80AF3788  40 82 00 30 */	bne lbl_80AF37B8
/* 80AF378C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3790  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3794  A8 1C 09 0C */	lha r0, 0x90c(r28)
/* 80AF3798  7C 00 00 D0 */	neg r0, r0
/* 80AF379C  7C 04 07 34 */	extsh r4, r0
/* 80AF37A0  4B 51 8C 94 */	b mDoMtx_YrotM__FPA4_fs
/* 80AF37A4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF37A8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF37AC  A8 9C 09 08 */	lha r4, 0x908(r28)
/* 80AF37B0  4B 51 8D 1C */	b mDoMtx_ZrotM__FPA4_fs
/* 80AF37B4  48 00 00 34 */	b lbl_80AF37E8
lbl_80AF37B8:
/* 80AF37B8  2C 1E 00 04 */	cmpwi r30, 4
/* 80AF37BC  40 82 00 2C */	bne lbl_80AF37E8
/* 80AF37C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF37C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF37C8  A8 1C 09 18 */	lha r0, 0x918(r28)
/* 80AF37CC  7C 00 00 D0 */	neg r0, r0
/* 80AF37D0  7C 04 07 34 */	extsh r4, r0
/* 80AF37D4  4B 51 8C 60 */	b mDoMtx_YrotM__FPA4_fs
/* 80AF37D8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF37DC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF37E0  A8 9C 09 14 */	lha r4, 0x914(r28)
/* 80AF37E4  4B 51 8C E8 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80AF37E8:
/* 80AF37E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF37EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF37F0  80 9D 00 84 */	lwz r4, 0x84(r29)
/* 80AF37F4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80AF37F8  7C 80 FA 14 */	add r4, r0, r31
/* 80AF37FC  4B 85 2C B4 */	b PSMTXCopy
/* 80AF3800  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF3804  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF3808  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80AF380C  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80AF3810  4B 85 2C A0 */	b PSMTXCopy
/* 80AF3814  38 60 00 01 */	li r3, 1
/* 80AF3818  39 61 00 30 */	addi r11, r1, 0x30
/* 80AF381C  4B 86 EA 08 */	b _restgpr_28

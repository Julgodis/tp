...
/* 80AF3644 00000010  4B FF F5 D5 */	bl _savegpr_28
...
/* 80AF3658 00000024  3C 60 00 00 */	lis r3, lit_4477@ha /* 80AF5B58 */
/* 80AF365C 00000028  38 83 00 00 */	addi r4, r3, lit_4477@l /* 80AF5B58 */
...
/* 80AF3694 00000060  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF3698 00000064  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80AF369C 00000068  4B FF F5 7D */	bl PSMTXCopy
/* 80AF36A0 0000006C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF36A4 00000070  3B E3 00 00 */	addi r31, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80AF36D8 000000A4  4B FF F5 41 */	bl PSMTXCopy
...
/* 80AF3708 000000D4  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF370C 000000D8  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80AF3710 000000DC  4B FF F5 09 */	bl PSMTXCopy
...
/* 80AF373C 00000010  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF3740 00000014  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80AF3744 00000018  4B FF F4 D5 */	bl PSMTXCopy
...
/* 80AF3774 0000000C  3C C0 00 00 */	lis r6, m__22daNpc_SoldierB_Param_c@ha /* 80AF5AD4 */
/* 80AF3778 00000010  38 C6 00 00 */	addi r6, r6, m__22daNpc_SoldierB_Param_c@l /* 80AF5AD4 */
/* 80AF377C 00000014  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80AF3780 00000018  4B FF F4 99 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80AF3784:
/* 80AF3784 00000000  2C 1E 00 01 */	cmpwi r30, 1
/* 80AF3788 00000004  40 82 00 30 */	bne lbl_80AF37B8
/* 80AF378C 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF3790 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80AF37A0 0000001C  4B FF F4 79 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AF37A4 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF37A8 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80AF37AC 00000028  A8 9C 09 08 */	lha r4, 0x908(r28)
/* 80AF37B0 0000002C  4B FF F4 69 */	bl mDoMtx_ZrotM__FPA4_fs
...
/* 80AF37C0 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF37C4 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80AF37D4 0000001C  4B FF F4 45 */	bl mDoMtx_YrotM__FPA4_fs
/* 80AF37D8 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF37DC 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80AF37E0 00000028  A8 9C 09 14 */	lha r4, 0x914(r28)
/* 80AF37E4 0000002C  4B FF F4 35 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80AF37E8:
/* 80AF37E8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF37EC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80AF37FC 00000014  4B FF F4 1D */	bl PSMTXCopy
/* 80AF3800 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80AF3804 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80AF3808 00000020  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 80AF380C 00000024  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */
/* 80AF3810 00000028  4B FF F4 09 */	bl PSMTXCopy
/* 80AF3814 0000002C  38 60 00 01 */	li r3, 1
/* 80AF3818 00000030  39 61 00 30 */	addi r11, r1, 0x30
/* 80AF381C 00000034  4B FF F3 FD */	bl _restgpr_28

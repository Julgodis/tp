...
/* 80B1C518  4B 84 5C C4 */	b _savegpr_29
/* 80B1C51C  7C 7D 1B 78 */	mr r29, r3
/* 80B1C520  3C 60 80 B2 */	lis r3, cNullVec__6Z2Calc@ha
/* 80B1C524  3B C3 E0 E4 */	addi r30, r3, cNullVec__6Z2Calc@l
/* 80B1C528  3C 60 80 B2 */	lis r3, m__16daNpcTks_Param_c@ha
/* 80B1C52C  3B E3 DD 58 */	addi r31, r3, m__16daNpcTks_Param_c@l
...
/* 80B1C584  4B 84 5A 94 */	b __ptmf_test
...
/* 80B1C598  4B 84 5A EC */	b __ptmf_scall
...
/* 80B1C5C4  4B 84 5A 54 */	b __ptmf_test
...
/* 80B1C5D8  4B 84 5A AC */	b __ptmf_scall
...
/* 80B1C608  4B 84 5A 10 */	b __ptmf_test
...
/* 80B1C61C  4B 84 5A 68 */	b __ptmf_scall
...
/* 80B1C648  4B 84 59 D0 */	b __ptmf_test
...
/* 80B1C65C  4B 84 5A 28 */	b __ptmf_scall
...
/* 80B1C6A8  4B 84 59 70 */	b __ptmf_test
...
/* 80B1C6BC  4B 84 59 C8 */	b __ptmf_scall
...
/* 80B1C6E8  4B 84 59 30 */	b __ptmf_test
...
/* 80B1C6FC  4B 84 59 88 */	b __ptmf_scall
/* 80B1C700  60 00 00 00 */	nop 
lbl_80B1C704:
/* 80B1C704  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B1C708  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B1C70C  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80B1C738  4B 52 6F B4 */	b setPtI_Id__14dEvt_control_cFUi
/* 80B1C73C  38 00 FF FF */	li r0, -1
/* 80B1C740  90 1D 13 68 */	stw r0, 0x1368(r29)
/* 80B1C744  7F A3 EB 78 */	mr r3, r29
/* 80B1C748  4B 4F D5 34 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80B1C74C:
/* 80B1C74C  38 7D 13 4C */	addi r3, r29, 0x134c
/* 80B1C750  4B 84 58 C8 */	b __ptmf_test
...
/* 80B1C764  4B 84 59 20 */	b __ptmf_scall
...
/* 80B1C808  4B 63 69 48 */	b playExpressionAnm__8daNpcF_cFPPPQ28daNpcF_c18daNpcF_anmPlayData
lbl_80B1C80C:
...
/* 80B1CA30  4B 63 68 34 */	b playMotionAnm__8daNpcF_cFPPPQ28daNpcF_c18daNpcF_anmPlayData
lbl_80B1CA34:
...
/* 80B1CA74  4B 4F 46 3C */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 80B1CA8C  4B 4F 46 24 */	b play__16mDoExt_McaMorfSOFUlSc
lbl_80B1CA90:
...
/* 80B1CAC0  4B 84 FC C0 */	b pow
/* 80B1CAC4  FF C0 08 18 */	frsp f30, f1
/* 80B1CAC8  7F A3 EB 78 */	mr r3, r29
/* 80B1CACC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B1CAD0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B1CAD4  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80B1CAD8  4B 4F DF BC */	b fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80B1CB38  4B 84 56 F0 */	b _restgpr_29

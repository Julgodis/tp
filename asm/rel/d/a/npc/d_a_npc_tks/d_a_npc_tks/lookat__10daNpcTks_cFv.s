...
/* 80B1CFE0 00000010  4B FF 75 B9 */	bl _savegpr_28
/* 80B1CFE4 00000014  7C 7C 1B 78 */	mr r28, r3
/* 80B1CFE8 00000018  3C 60 00 00 */	lis r3, m__16daNpcTks_Param_c@ha /* 80B1DD58 */
/* 80B1CFEC 0000001C  38 83 00 00 */	addi r4, r3, m__16daNpcTks_Param_c@l /* 80B1DD58 */
...
/* 80B1D004 00000034  C0 23 00 24 */	lfs f1, 0x24(r3)
/* 80B1D008 00000038  C0 43 00 20 */	lfs f2, 0x20(r3)
/* 80B1D00C 0000003C  C0 63 00 2C */	lfs f3, 0x2c(r3)
/* 80B1D010 00000040  C0 83 00 28 */	lfs f4, 0x28(r3)
...
/* 80B1D020 00000050  C0 C4 00 C4 */	lfs f6, 0xc4(r4)
/* 80B1D024 00000054  48 00 00 08 */	b lbl_80B1D02C
lbl_80B1D028:
/* 80B1D028 00000000  C0 C3 00 34 */	lfs f6, 0x34(r3)
lbl_80B1D02C:
/* 80B1D02C 00000000  28 00 00 00 */	cmplwi r0, 0
/* 80B1D030 00000004  41 82 00 0C */	beq lbl_80B1D03C
/* 80B1D034 00000008  C0 E4 00 C4 */	lfs f7, 0xc4(r4)
/* 80B1D038 0000000C  48 00 00 0C */	b lbl_80B1D044
lbl_80B1D03C:
/* 80B1D03C 00000000  38 64 00 00 */	addi r3, r4, 0
/* 80B1D040 00000004  C0 E3 00 30 */	lfs f7, 0x30(r3)
lbl_80B1D044:
/* 80B1D044 00000000  38 64 00 00 */	addi r3, r4, 0
/* 80B1D048 00000004  C1 03 00 3C */	lfs f8, 0x3c(r3)
/* 80B1D04C 00000008  C1 23 00 38 */	lfs f9, 0x38(r3)
...
/* 80B1D0A8 00000064  80 64 01 B8 */	lwz r3, 0x1b8(r4)
/* 80B1D0AC 00000068  80 04 01 BC */	lwz r0, 0x1bc(r4)
/* 80B1D0B0 0000006C  90 61 00 18 */	stw r3, 0x18(r1)
/* 80B1D0B4 00000070  90 01 00 1C */	stw r0, 0x1c(r1)
/* 80B1D0B8 00000074  80 04 01 C0 */	lwz r0, 0x1c0(r4)
...
lbl_80B1D104:
/* 80B1D104 00000000  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80B1D108 00000004  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80B1D10C 00000008  80 A3 5D AC */	lwz r5, 0x5dac(r3)
/* 80B1D110 0000000C  2C 00 00 03 */	cmpwi r0, 3
/* 80B1D114 00000010  40 82 00 14 */	bne lbl_80B1D128
/* 80B1D118 00000014  C1 04 00 98 */	lfs f8, 0x98(r4)
/* 80B1D11C 00000018  C1 24 00 A0 */	lfs f9, 0xa0(r4)
...
/* 80B1D160 00000038  C0 04 02 EC */	lfs f0, 0x2ec(r4)
...
/* 80B1D1A8 00000014  C0 A4 00 C4 */	lfs f5, 0xc4(r4)
...
/* 80B1D1C0 0000002C  4B FF 73 D9 */	bl setParam__15daNpcF_Lookat_cFffffffffffffsP4cXyz
...
/* 80B1D1E0 0000004C  4B FF 73 B9 */	bl calc__15daNpcF_Lookat_cFP10fopAc_ac_cPA4_fPP5csXyziii
/* 80B1D1E4 00000050  39 61 00 60 */	addi r11, r1, 0x60
/* 80B1D1E8 00000054  4B FF 73 B1 */	bl _restgpr_28

...
/* 80B1C498 00000018  3C 60 80 B2 */	lis r3, m__16daNpcTks_Param_c@ha
/* 80B1C49C 0000001C  3B E3 DD 58 */	addi r31, r3, m__16daNpcTks_Param_c@l
/* 80B1C4A0 00000020  38 7E 07 E4 */	addi r3, r30, 0x7e4
/* 80B1C4A4 00000024  38 9F 00 00 */	addi r4, r31, 0
/* 80B1C4A8 00000028  C0 24 00 1C */	lfs f1, 0x1c(r4)	/* effective address: 80B1DD74 */
/* 80B1C4AC 0000002C  4B 55 9A 94 */	b SetWallR__12dBgS_AcchCirFf
/* 80B1C4B0 00000030  38 7F 00 00 */	addi r3, r31, 0
/* 80B1C4B4 00000034  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80B1DD70 */
...
/* 80B1C4C8 00000048  C0 1F 00 C4 */	lfs f0, 0xc4(r31)	/* effective address: 80B1DE1C */
/* 80B1C4CC 0000004C  48 00 00 08 */	b lbl_80B1C4D4
lbl_80B1C4D0:
/* 80B1C4D0 00000000  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80B1DD5C */
lbl_80B1C4D4:
/* 80B1C4D4 00000000  D0 1E 05 30 */	stfs f0, 0x530(r30)
/* 80B1C4D8 00000004  C0 1F 02 E4 */	lfs f0, 0x2e4(r31)	/* effective address: 80B1E03C */

...
/* 80B1D214  4B 84 4F C4 */	b _savegpr_28
/* 80B1D218  7C 7D 1B 78 */	mr r29, r3
/* 80B1D21C  3C 60 80 B2 */	lis r3, m__16daNpcTks_Param_c@ha
/* 80B1D220  3B E3 DD 58 */	addi r31, r3, m__16daNpcTks_Param_c@l
...
/* 80B1D244  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B1D248  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B1D24C  38 80 00 04 */	li r4, 4
/* 80B1D250  38 BD 11 4C */	addi r5, r29, 0x114c
/* 80B1D254  38 DD 0B DC */	addi r6, r29, 0xbdc
/* 80B1D258  4B 68 65 6C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80B1D25C  48 00 00 1C */	b lbl_80B1D278
lbl_80B1D260:
/* 80B1D260  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B1D264  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B1D268  38 80 00 08 */	li r4, 8
/* 80B1D26C  38 BD 11 4C */	addi r5, r29, 0x114c
/* 80B1D270  38 DD 0B DC */	addi r6, r29, 0xbdc
/* 80B1D274  4B 68 65 50 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_80B1D278:
/* 80B1D278  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80B1D27C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80B1D280  80 9E 00 04 */	lwz r4, 4(r30)
/* 80B1D284  38 BD 0B DC */	addi r5, r29, 0xbdc
/* 80B1D288  4B 68 7B 18 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80B1D28C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B1D290  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80B1D294  80 04 5F 70 */	lwz r0, 0x5f70(r4)	/* effective address: 8040C130 */
/* 80B1D298  3C 60 80 43 */	lis r3, j3dSys@ha
/* 80B1D29C  3B 83 4A C8 */	addi r28, r3, j3dSys@l
/* 80B1D2A0  90 1C 00 48 */	stw r0, 0x48(r28)	/* effective address: 80434B10 */
/* 80B1D2A4  80 04 5F 74 */	lwz r0, 0x5f74(r4)	/* effective address: 8040C134 */
/* 80B1D2A8  90 1C 00 4C */	stw r0, 0x4c(r28)	/* effective address: 80434B14 */
/* 80B1D2AC  80 7D 0B D8 */	lwz r3, 0xbd8(r29)
/* 80B1D2B0  4B 4F 3F 10 */	b entryDL__16mDoExt_McaMorfSOFv
/* 80B1D2B4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B1D2B8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B1D2BC  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 80B1D2C0  90 1C 00 48 */	stw r0, 0x48(r28)
/* 80B1D2C4  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
...
/* 80B1D334  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80B1D338  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80B1D33C  4B 51 15 D4 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
/* 80B1D340  90 7D 11 44 */	stw r3, 0x1144(r29)
lbl_80B1D344:
/* 80B1D344  39 61 00 20 */	addi r11, r1, 0x20
/* 80B1D348  4B 84 4E DC */	b _restgpr_28

...
/* 80B6FD14 00000014  3C 80 80 B7 */	lis r4, lit_4609@ha
/* 80B6FD18 00000018  38 A4 1C B8 */	addi r5, r4, lit_4609@l
/* 80B6FD1C 0000001C  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80B71CB8 */
/* 80B6FD20 00000020  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80B71CBC */
/* 80B6FD24 00000024  90 81 00 14 */	stw r4, 0x14(r1)
/* 80B6FD28 00000028  90 01 00 18 */	stw r0, 0x18(r1)
/* 80B6FD2C 0000002C  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80B71CC0 */
...
/* 80B6FD50 00000050  4B 7F 23 34 */	b __ptmf_scall
...
/* 80B6FD64 00000008  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80B6FD68 0000000C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80B6FD6C 00000010  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80B6FD90 0000000C  4B 4D 8A 60 */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80B6FDB0 0000000C  4B 5D A4 74 */	b evtChange__8daNpcT_cFv
/* 80B6FDB4 00000010  38 60 00 01 */	li r3, 1
/* 80B6FDB8 00000014  48 00 00 34 */	b lbl_80B6FDEC
lbl_80B6FDBC:
/* 80B6FDBC 00000000  3C 60 80 B7 */	lis r3, lit_4619@ha
/* 80B6FDC0 00000004  38 83 1C C4 */	addi r4, r3, lit_4619@l
/* 80B6FDC4 00000008  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80B71CC4 */
/* 80B6FDC8 0000000C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80B71CC8 */
/* 80B6FDCC 00000010  90 61 00 08 */	stw r3, 8(r1)
/* 80B6FDD0 00000014  90 01 00 0C */	stw r0, 0xc(r1)
/* 80B6FDD4 00000018  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80B71CCC */

...
/* 80A8CC8C 0000000C  3C 80 00 00 */	lis r4, lit_3990@ha
/* 80A8CC90 00000010  3B E4 00 00 */	addi r31, r4, lit_3990@l
...
/* 80A8CCC8 00000048  3C 80 00 00 */	lis r4, lit_5659@ha
/* 80A8CCCC 0000004C  38 84 00 00 */	addi r4, r4, lit_5659@l
...
/* 80A8CD68 0000000C  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80A8CD6C 00000010  38 63 00 00 */	addi r3, r3, l_HIO@l
/* 80A8CD70 00000014  C0 03 00 10 */	lfs f0, 0x10(r3)
/* 80A8CD74 00000018  EF E1 00 32 */	fmuls f31, f1, f0
/* 80A8CD78 0000001C  3C 60 00 00 */	lis r3, home_path@ha
/* 80A8CD7C 00000020  38 63 00 00 */	addi r3, r3, home_path@l
...
/* 80A8CDB0 00000054  4B FF BE 89 */	bl PSVECSubtract
/* 80A8CDB4 00000058  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80A8CDB8 0000005C  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 80A8CDBC 00000060  4B FF BE 7D */	bl cM_atan2s__Fff
...
/* 80A8CF58 00000060  3C 80 00 00 */	lis r4, l_HIO@ha
/* 80A8CF5C 00000064  38 84 00 00 */	addi r4, r4, l_HIO@l
...
/* 80A8CFB8 000000C0  3C 60 00 00 */	lis r3, home_path@ha
/* 80A8CFBC 000000C4  38 63 00 00 */	addi r3, r3, home_path@l
...
/* 80A8D070 00000178  4B FF BB C9 */	bl PSVECSubtract
/* 80A8D074 0000017C  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80A8D078 00000180  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 80A8D07C 00000184  4B FF BB BD */	bl cM_atan2s__Fff
...
/* 80A8D0C8 000001D0  3C 60 00 00 */	lis r3, g_Counter@ha
/* 80A8D0CC 000001D4  38 63 00 00 */	addi r3, r3, g_Counter@l
...
/* 80A8D0DC 000001E4  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80A8D0E0 000001E8  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80A8D24C 0000000C  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80A8D250 00000010  38 63 00 00 */	addi r3, r3, l_HIO@l
/* 80A8D254 00000014  C0 03 00 10 */	lfs f0, 0x10(r3)
/* 80A8D258 00000018  EF E1 00 32 */	fmuls f31, f1, f0
/* 80A8D25C 0000001C  3C 60 00 00 */	lis r3, home_path@ha
/* 80A8D260 00000020  38 63 00 00 */	addi r3, r3, home_path@l
...
/* 80A8D29C 0000005C  4B FF B9 9D */	bl PSVECSubtract
/* 80A8D2A0 00000060  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80A8D2A4 00000064  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 80A8D2A8 00000068  4B FF B9 91 */	bl cM_atan2s__Fff
...
/* 80A8D334 00000054  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80A8D338 00000058  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 80A8D364 00000018  3C A0 00 00 */	lis r5, stringBase0@ha
/* 80A8D368 0000001C  38 A5 00 00 */	addi r5, r5, stringBase0@l
...
/* 80A8D378 0000002C  3C C0 00 00 */	lis r6, home_path@ha
/* 80A8D37C 00000030  38 C6 00 00 */	addi r6, r6, home_path@l
...
/* 80A8D394 00000048  3C 60 00 00 */	lis r3, home_path@ha
/* 80A8D398 0000004C  38 63 00 00 */	addi r3, r3, home_path@l
...
/* 80A8D450 0000001C  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80A8D454 00000020  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 80A8D470 0000003C  3C 60 00 00 */	lis r3, home_path@ha
/* 80A8D474 00000040  38 63 00 00 */	addi r3, r3, home_path@l
...
/* 80A8D494 00000060  4B FF B7 A5 */	bl PSVECSubtract
/* 80A8D498 00000064  C0 21 00 14 */	lfs f1, 0x14(r1)
/* 80A8D49C 00000068  C0 41 00 1C */	lfs f2, 0x1c(r1)
/* 80A8D4A0 0000006C  4B FF B7 99 */	bl cM_atan2s__Fff

...
/* 80A91B98  4B 8D 06 44 */	b _savegpr_29
/* 80A91B9C  7C 7E 1B 78 */	mr r30, r3
/* 80A91BA0  3C 80 80 A9 */	lis r4, lit_3990@ha
/* 80A91BA4  3B E4 24 1C */	addi r31, r4, lit_3990@l
...
lbl_80A91BCC:
/* 80A91BCC  4B 71 A9 B0 */	b dKy_darkworld_check__Fv
/* 80A91BD0  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A91BD4  41 82 00 14 */	beq lbl_80A91BE8
/* 80A91BD8  3C 60 80 A9 */	lis r3, stringBase0@ha
/* 80A91BDC  38 03 25 D0 */	addi r0, r3, stringBase0@l
/* 80A91BE0  90 1E 05 E4 */	stw r0, 0x5e4(r30)
/* 80A91BE4  48 00 00 14 */	b lbl_80A91BF8
lbl_80A91BE8:
/* 80A91BE8  3C 60 80 A9 */	lis r3, stringBase0@ha
/* 80A91BEC  38 63 25 D0 */	addi r3, r3, stringBase0@l
...
/* 80A91C00  4B 59 B2 BC */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80A91C54  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A91C58  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A91C5C  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80A91C60  3C 80 80 3A */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80A91C64  38 84 72 88 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
/* 80A91C68  A0 84 03 92 */	lhz r4, 0x392(r4)	/* effective address: 803A761A */
/* 80A91C6C  4B 5A 2D 50 */	b isEventBit__11dSv_event_cCFUs
...
/* 80A91C98  3C 80 80 A9 */	lis r4, useHeapInit__FP10fopAc_ac_c@ha
/* 80A91C9C  38 84 17 98 */	addi r4, r4, useHeapInit__FP10fopAc_ac_c@l
/* 80A91CA0  38 A0 2A 50 */	li r5, 0x2a50
/* 80A91CA4  4B 58 88 0C */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80A91CCC  4B 5B FB 20 */	b dPath_GetRoomPath__Fii
...
/* 80A91D28  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A91D2C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A91D30  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80A91D34  38 80 10 01 */	li r4, 0x1001
/* 80A91D38  4B 5A 2C 84 */	b isEventBit__11dSv_event_cCFUs
...
lbl_80A91EEC:
/* 80A91EEC  3C 60 80 A9 */	lis r3, struct_80A92AC4+0x1@ha
/* 80A91EF0  8C 03 2A C5 */	lbzu r0, struct_80A92AC4+0x1@l(r3)
...
/* 80A91F0C  3C 60 80 A9 */	lis r3, l_HIO@ha
/* 80A91F10  38 63 2A D4 */	addi r3, r3, l_HIO@l
/* 80A91F14  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 80A92AD8 */
lbl_80A91F18:
...
/* 80A91F6C  4B 5F 18 F4 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80A91F70  38 7E 09 5C */	addi r3, r30, 0x95c
/* 80A91F74  3C 80 80 A9 */	lis r4, data_80A92950@ha
/* 80A91F78  38 84 29 50 */	addi r4, r4, data_80A92950@l
/* 80A91F7C  4B 5F 2A B8 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
/* 80A91F80  38 1E 09 20 */	addi r0, r30, 0x920
/* 80A91F84  90 1E 09 A0 */	stw r0, 0x9a0(r30)
/* 80A91F88  38 7E 0A 94 */	addi r3, r30, 0xa94
/* 80A91F8C  3C 80 80 A9 */	lis r4, data_80A92990@ha
/* 80A91F90  38 84 29 90 */	addi r4, r4, data_80A92990@l
/* 80A91F94  4B 5F 2A A0 */	b Set__8dCcD_SphFRC11dCcD_SrcSph
...
/* 80A91FBC  4B 7D 59 98 */	b cM_rndF__Ff
...
/* 80A91FF4  4B 7D 59 60 */	b cM_rndF__Ff
...
/* 80A9208C  4B 5E 41 BC */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80A920AC  4B 5E 3E AC */	b SetWall__12dBgS_AcchCirFff
/* 80A920B0  C0 3F 00 80 */	lfs f1, 0x80(r31)
/* 80A920B4  4B 7D 58 D8 */	b cM_rndFX__Ff
...
/* 80A920D0  3C 60 80 A9 */	lis r3, stringBase0@ha
/* 80A920D4  38 03 25 D0 */	addi r0, r3, stringBase0@l
...
/* 80A92104  4B 8D 01 24 */	b _restgpr_29

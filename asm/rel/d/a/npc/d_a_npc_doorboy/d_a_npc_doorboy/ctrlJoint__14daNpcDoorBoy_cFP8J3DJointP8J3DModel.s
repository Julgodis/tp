...
/* 809AB588 00000010  4B FF F6 71 */	bl _savegpr_28
...
/* 809AB59C 00000024  3C 60 00 00 */	lis r3, lit_4341@ha /* 809ADA30 */
/* 809AB5A0 00000028  38 83 00 00 */	addi r4, r3, lit_4341@l /* 809ADA30 */
/* 809AB5A4 0000002C  80 64 00 00 */	lwz r3, 0(r4)
/* 809AB5A8 00000030  80 04 00 04 */	lwz r0, 4(r4)
/* 809AB5AC 00000034  90 61 00 08 */	stw r3, 8(r1)
/* 809AB5B0 00000038  90 01 00 0C */	stw r0, 0xc(r1)
/* 809AB5B4 0000003C  80 04 00 08 */	lwz r0, 8(r4)
...
/* 809AB5D8 00000060  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809AB5DC 00000064  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 809AB5E0 00000068  4B FF F6 19 */	bl PSMTXCopy
/* 809AB5E4 0000006C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809AB5E8 00000070  3B 83 00 00 */	addi r28, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 809AB5EC 00000074  C0 1C 00 0C */	lfs f0, 0xc(r28)
/* 809AB5F0 00000078  D0 1D 08 54 */	stfs f0, 0x854(r29)
/* 809AB5F4 0000007C  C0 1C 00 1C */	lfs f0, 0x1c(r28)
/* 809AB5F8 00000080  D0 1D 08 58 */	stfs f0, 0x858(r29)
/* 809AB5FC 00000084  C0 1C 00 2C */	lfs f0, 0x2c(r28)
...
/* 809AB61C 000000A4  4B FF F5 DD */	bl PSMTXCopy
/* 809AB620 000000A8  C0 1C 00 0C */	lfs f0, 0xc(r28)
/* 809AB624 000000AC  D0 1D 08 60 */	stfs f0, 0x860(r29)
/* 809AB628 000000B0  C0 1C 00 1C */	lfs f0, 0x1c(r28)
/* 809AB62C 000000B4  D0 1D 08 64 */	stfs f0, 0x864(r29)
/* 809AB630 000000B8  C0 1C 00 2C */	lfs f0, 0x2c(r28)
...
/* 809AB64C 000000D4  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809AB650 000000D8  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 809AB654 000000DC  4B FF F5 A5 */	bl PSMTXCopy
/* 809AB658 000000E0  C0 1C 00 0C */	lfs f0, 0xc(r28)
/* 809AB65C 000000E4  D0 1D 08 6C */	stfs f0, 0x86c(r29)
/* 809AB660 000000E8  C0 1C 00 1C */	lfs f0, 0x1c(r28)
/* 809AB664 000000EC  D0 1D 08 70 */	stfs f0, 0x870(r29)
/* 809AB668 000000F0  C0 1C 00 2C */	lfs f0, 0x2c(r28)
...
/* 809AB680 00000010  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809AB684 00000014  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 809AB688 00000018  4B FF F5 71 */	bl PSMTXCopy
...
/* 809AB6AC 0000000C  3C C0 00 00 */	lis r6, m__20daNpcDoorBoy_Param_c@ha /* 809AD9A8 */
/* 809AB6B0 00000010  38 C6 00 00 */	addi r6, r6, m__20daNpcDoorBoy_Param_c@l /* 809AD9A8 */
/* 809AB6B4 00000014  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 809AB6B8 00000018  4B FF F5 41 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_809AB6BC:
/* 809AB6BC 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809AB6C0 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 809AB6D0 00000014  4B FF F5 29 */	bl PSMTXCopy
/* 809AB6D4 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809AB6D8 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 809AB6DC 00000020  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha /* 80434BE4 */
/* 809AB6E0 00000024  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l /* 80434BE4 */
/* 809AB6E4 00000028  4B FF F5 15 */	bl PSMTXCopy
/* 809AB6E8 0000002C  38 60 00 01 */	li r3, 1
/* 809AB6EC 00000030  39 61 00 30 */	addi r11, r1, 0x30
/* 809AB6F0 00000034  4B FF F5 09 */	bl _restgpr_28

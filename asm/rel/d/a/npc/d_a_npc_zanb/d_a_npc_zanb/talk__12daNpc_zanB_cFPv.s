...
/* 80B6A8BC  4B 5E 13 34 */	b initTalk__8daNpcT_cFiPP10fopAc_ac_c
...
/* 80B6A910  4B 5E 13 68 */	b talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80B6A924  4B 6D FC 04 */	b getEventId__10dMsgFlow_cFPi
...
/* 80B6A938  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B6A93C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B6A940  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80B6A944  4B 5D AD 9C */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 80B6A948  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B6A94C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B6A950  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B6A954  4B 4D 7B 14 */	b reset__14dEvt_control_cFv
...
/* 80B6A970  4B 5D AD 8C */	b remove__18daNpcT_ActorMngr_cFv
/* 80B6A974  38 00 00 00 */	li r0, 0
/* 80B6A978  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6A97C  3C 60 80 B7 */	lis r3, lit_4190@ha
/* 80B6A980  C0 03 BD 6C */	lfs f0, lit_4190@l(r3)
...
/* 80B6A9C4  4B 5D AD 38 */	b remove__18daNpcT_ActorMngr_cFv
/* 80B6A9C8  38 00 00 00 */	li r0, 0
/* 80B6A9CC  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6A9D0  3C 60 80 B7 */	lis r3, lit_4190@ha
/* 80B6A9D4  C0 03 BD 6C */	lfs f0, lit_4190@l(r3)
...
/* 80B6AA00  4B 5D AC FC */	b remove__18daNpcT_ActorMngr_cFv
/* 80B6AA04  38 00 00 00 */	li r0, 0
/* 80B6AA08  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 80B6AA0C  3C 60 80 B7 */	lis r3, lit_4190@ha
/* 80B6AA10  C0 03 BD 6C */	lfs f0, lit_4190@l(r3)
...
/* 80B6AA44  4B 5E 0C 04 */	b step__8daNpcT_cFsiiii
lbl_80B6AA48:

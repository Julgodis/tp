...
/* 8097D144 00000024  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D148 00000028  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D15C:
/* 8097D15C 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D160 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D17C 0000000C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D180 00000010  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D194:
/* 8097D194 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D198 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D1B4 0000000C  4B 8E A2 40 */	b __ct__5csXyzFsss
...
/* 8097D1D4 0000002C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D1D8 00000030  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D1EC:
/* 8097D1EC 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D1F0 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D20C 0000000C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D210 00000010  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D224:
/* 8097D224 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D228 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D244 0000000C  4B 8E A1 B0 */	b __ct__5csXyzFsss
...
/* 8097D264 0000002C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D268 00000030  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D27C:
/* 8097D27C 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D280 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D29C 0000000C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D2A0 00000010  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D2B4:
/* 8097D2B4 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D2B8 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D2D4 0000000C  4B 8E A1 20 */	b __ct__5csXyzFsss
...
/* 8097D2F4 0000002C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D2F8 00000030  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D30C:
/* 8097D30C 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D310 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D32C 0000000C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D330 00000010  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D344:
/* 8097D344 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D348 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D364 0000000C  4B 8E A0 90 */	b __ct__5csXyzFsss
...
/* 8097D384 0000002C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D388 00000030  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D39C:
/* 8097D39C 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D3A0 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D3BC 0000000C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D3C0 00000010  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D3D4:
/* 8097D3D4 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D3D8 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D3F4 0000000C  4B 8E A0 00 */	b __ct__5csXyzFsss
...
/* 8097D414 0000002C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D418 00000030  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D42C:
/* 8097D42C 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D430 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D44C 0000000C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D450 00000010  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D464:
/* 8097D464 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D468 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D484 0000000C  4B 8E 9F 70 */	b __ct__5csXyzFsss
...
/* 8097D498 00000020  3C 60 80 43 */	lis r3, Zero__4cXyz@ha
/* 8097D49C 00000024  3B C3 0C F4 */	addi r30, r3, Zero__4cXyz@l
/* 8097D4A0 00000028  C0 1E 00 00 */	lfs f0, 0(r30)	/* effective address: 80430CF4 */
/* 8097D4A4 0000002C  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 8097D4A8 00000030  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 80430CF8 */
/* 8097D4AC 00000034  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 8097D4B0 00000038  C0 1E 00 08 */	lfs f0, 8(r30)	/* effective address: 80430CFC */
/* 8097D4B4 0000003C  D0 01 00 58 */	stfs f0, 0x58(r1)
/* 8097D4B8 00000040  7F E3 FB 78 */	mr r3, r31
/* 8097D4BC 00000044  4B 7D AB EC */	b isM___10daNpcCd2_cFv
...
/* 8097D524 00000018  4B 8D 3E E8 */	b init__16dNpcLib_lookat_cFP8J3DModelPiP5csXyzP5csXyz
/* 8097D528 0000001C  38 7F 0A F8 */	addi r3, r31, 0xaf8
/* 8097D52C 00000020  4B 7C 81 DC */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 8097D548 0000003C  4B 9C 8F 68 */	b PSMTXCopy
/* 8097D54C 00000040  38 7F 0A F8 */	addi r3, r31, 0xaf8
/* 8097D550 00000044  4B 7C 81 B8 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 8097D580 00000010  4B 9C 8F 30 */	b PSMTXCopy
/* 8097D584 00000014  3C 60 80 43 */	lis r3, Zero__4cXyz@ha
/* 8097D588 00000018  C0 03 0C F4 */	lfs f0, Zero__4cXyz@l(r3)
/* 8097D58C 0000001C  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 8097D590 00000020  C0 1E 00 04 */	lfs f0, 4(r30)	/* effective address: 80430CF8 */
/* 8097D594 00000024  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 8097D598 00000028  C0 1E 00 08 */	lfs f0, 8(r30)	/* effective address: 80430CFC */
...
/* 8097D5D4 00000034  4B 7C 81 34 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 8097D5F8 00000058  4B 8D 3F 3C */	b action__16dNpcLib_lookat_cF4cXyz4cXyzP10fopAc_ac_cPA4_fi

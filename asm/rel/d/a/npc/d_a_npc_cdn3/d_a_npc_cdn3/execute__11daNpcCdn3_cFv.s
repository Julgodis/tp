...
/* 8097D758 00000010  4B 9E 4A 84 */	b _savegpr_29
...
/* 8097D76C 00000024  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D770 00000028  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_8097D784:
/* 8097D784 00000000  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 8097D788 00000004  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 8097D7AC 00000014  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 8097D7B0 00000018  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_8097D7C4:
/* 8097D7C4 00000000  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 8097D7C8 00000004  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_8097D7D8:
/* 8097D7D8 00000000  4B 6F 87 68 */	b SetWallR__12dBgS_AcchCirFf
...
/* 8097D824 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8097D828 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8097D82C 00000020  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 8097D830 00000024  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 8097D840 00000034  4B 69 C4 3C */	b fopAcM_delete__FP10fopAc_ac_c
lbl_8097D844:
...
/* 8097D86C 00000020  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8097D870 00000024  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8097D874 00000028  3B A3 4E 00 */	addi r29, r3, 0x4e00
/* 8097D878 0000002C  7F A3 EB 78 */	mr r3, r29
/* 8097D87C 00000030  3C 80 80 98 */	lis r4, stringBase0@ha
/* 8097D880 00000034  38 84 F5 AC */	addi r4, r4, stringBase0@l
/* 8097D884 00000038  38 84 00 9E */	addi r4, r4, 0x9e
/* 8097D888 0000003C  4B 9E B1 0C */	b strcmp
...
/* 8097D898 0000004C  4B 6A F0 E4 */	b getLayerNo__14dComIfG_play_cFi
...
/* 8097D8B4 0000000C  3C 80 80 98 */	lis r4, stringBase0@ha
/* 8097D8B8 00000010  38 84 F5 AC */	addi r4, r4, stringBase0@l
/* 8097D8BC 00000014  38 84 00 F4 */	addi r4, r4, 0xf4
/* 8097D8C0 00000018  4B 9E B0 D4 */	b strcmp
...
/* 8097D978 0000000C  4B 7E 1A AC */	b checkNowWolfEyeUp__9daPy_py_cFv
...
lbl_8097D99C:
/* 8097D99C 00000000  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8097D9A0 00000004  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8097D9A4 00000008  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 8097DA04 00000014  4B 7E 1A 20 */	b checkNowWolfEyeUp__9daPy_py_cFv
...
/* 8097DA4C 00000010  3C 80 80 98 */	lis r4, lit_5944@ha
/* 8097DA50 00000014  C0 44 F5 A0 */	lfs f2, lit_5944@l(r4)
/* 8097DA54 00000018  3C 80 80 98 */	lis r4, lit_5945@ha
/* 8097DA58 0000001C  C0 64 F5 A4 */	lfs f3, lit_5945@l(r4)
/* 8097DA5C 00000020  4B 8F 1F E0 */	b cLib_addCalc2__FPffff
/* 8097DA60 00000024  7F E3 FB 78 */	mr r3, r31
/* 8097DA64 00000028  38 80 FF FF */	li r4, -1
/* 8097DA68 0000002C  4B 7D B3 C0 */	b animation__10daNpcCd2_cFi
/* 8097DA6C 00000030  38 7F 09 B0 */	addi r3, r31, 0x9b0
/* 8097DA70 00000034  38 9F 04 D0 */	addi r4, r31, 0x4d0
/* 8097DA74 00000038  4B 8F 17 68 */	b SetC__8cM3dGCylFRC4cXyz
...
/* 8097DA84 00000048  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 8097DA88 0000004C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 8097DA8C 00000050  38 63 23 3C */	addi r3, r3, 0x233c
/* 8097DA90 00000054  38 9F 08 8C */	addi r4, r31, 0x88c
/* 8097DA94 00000058  4B 8E 71 14 */	b Set__4cCcSFP8cCcD_Obj
lbl_8097DA98:
...
/* 8097DAA8 00000004  4B 9E 47 80 */	b _restgpr_29

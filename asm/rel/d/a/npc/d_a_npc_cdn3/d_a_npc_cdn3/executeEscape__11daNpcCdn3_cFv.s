...
/* 8097A038  4B 9E 81 A4 */	b _savegpr_29
/* 8097A03C  7C 7E 1B 78 */	mr r30, r3
/* 8097A040  3C 80 80 98 */	lis r4, lit_4037@ha
/* 8097A044  3B E4 F5 40 */	addi r31, r4, lit_4037@l
...
/* 8097A090  4B 7D E0 60 */	b getAnmP__10daNpcCd2_cFii
...
/* 8097A0B0  4B 7D EE 50 */	b setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
/* 8097A0B4  38 7E 05 94 */	addi r3, r30, 0x594
/* 8097A0B8  38 80 00 00 */	li r4, 0
/* 8097A0BC  4B 94 6D 5C */	b playVoice__17Z2CreatureCitizenFi
/* 8097A0C0  38 00 00 01 */	li r0, 1
/* 8097A0C4  90 1E 0B 68 */	stw r0, 0xb68(r30)
lbl_8097A0C8:
/* 8097A0C8  7F C3 F3 78 */	mr r3, r30
/* 8097A0CC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8097A0D0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8097A0D4  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 8097A0D8  4B 6A 06 38 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 8097A0EC  4B 8F 65 1C */	b cLib_addCalcAngleS2__FPssss
...
/* 8097A108  4B 69 FB 74 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_8097A10C:
...
/* 8097A130  4B 7D FA E4 */	b checkPoint__11PathTrace_cF4cXyzf
...
/* 8097A1B4  4B 8F 64 54 */	b cLib_addCalcAngleS2__FPssss
...
/* 8097A1CC  3C 60 80 98 */	lis r3, __vt__8cM3dGPla@ha
/* 8097A1D0  38 03 07 38 */	addi r0, r3, __vt__8cM3dGPla@l
/* 8097A1D4  90 01 00 40 */	stw r0, 0x40(r1)
/* 8097A1D8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8097A1DC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8097A1E0  38 63 0F 38 */	addi r3, r3, 0xf38
/* 8097A1E4  38 9E 07 28 */	addi r4, r30, 0x728
/* 8097A1E8  38 A1 00 30 */	addi r5, r1, 0x30
/* 8097A1EC  4B 6F A5 58 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 8097A200  4B 6A 39 D8 */	b fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
lbl_8097A218:
/* 8097A218  3C 60 80 98 */	lis r3, __vt__8cM3dGPla@ha
/* 8097A21C  38 03 07 38 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 8097A238  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8097A23C  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8097A240  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8097A244  4B 6F C8 68 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8097A25C  4B 9C D1 40 */	b PSVECSquareDistance
...
/* 8097A2CC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8097A2D0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 8097A33C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8097A340  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_8097A344:
...
/* 8097A384  4B 9E 7E A4 */	b _restgpr_29

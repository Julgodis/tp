...
/* 80B8E924  4B 7D 38 B4 */	b _savegpr_28
...
/* 80B8E938  3C 60 80 B9 */	lis r3, lit_4538@ha
/* 80B8E93C  38 83 32 9C */	addi r4, r3, lit_4538@l
/* 80B8E940  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80B9329C */
/* 80B8E944  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80B932A0 */
/* 80B8E948  90 61 00 08 */	stw r3, 8(r1)
/* 80B8E94C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80B8E950  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80B932A4 */
...
/* 80B8E974  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80B8E978  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80B8E97C  4B 7B 7B 34 */	b PSMTXCopy
/* 80B8E980  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8E984  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 80B8E988  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 80B8E98C  D0 1F 08 54 */	stfs f0, 0x854(r31)
/* 80B8E990  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 80B8E994  D0 1F 08 58 */	stfs f0, 0x858(r31)
/* 80B8E998  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 80B8E9B8  4B 7B 7A F8 */	b PSMTXCopy
...
/* 80B8E9E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80B8E9EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80B8E9F0  4B 7B 7A C0 */	b PSMTXCopy
...
/* 80B8EA1C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80B8EA20  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80B8EA24  4B 7B 7A 8C */	b PSMTXCopy
...
/* 80B8EA54  3C C0 80 B9 */	lis r6, m__17daNpc_zrC_Param_c@ha
/* 80B8EA58  38 C6 31 FC */	addi r6, r6, m__17daNpc_zrC_Param_c@l
/* 80B8EA5C  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 80B9323C */
/* 80B8EA60  4B 5C 49 1C */	b setLookatMtx__8daNpcF_cFiPif
lbl_80B8EA64:
/* 80B8EA64  2C 1D 00 01 */	cmpwi r29, 1
/* 80B8EA68  40 82 00 30 */	bne lbl_80B8EA98
/* 80B8EA6C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8EA70  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8EA74  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 80B8EA78  7C 00 00 D0 */	neg r0, r0
/* 80B8EA7C  7C 04 07 34 */	extsh r4, r0
/* 80B8EA80  4B 47 D9 B4 */	b mDoMtx_YrotM__FPA4_fs
/* 80B8EA84  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8EA88  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8EA8C  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 80B8EA90  4B 47 DA 3C */	b mDoMtx_ZrotM__FPA4_fs
/* 80B8EA94  48 00 00 34 */	b lbl_80B8EAC8
lbl_80B8EA98:
/* 80B8EA98  2C 1D 00 04 */	cmpwi r29, 4
/* 80B8EA9C  40 82 00 2C */	bne lbl_80B8EAC8
/* 80B8EAA0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8EAA4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8EAA8  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 80B8EAAC  7C 00 00 D0 */	neg r0, r0
/* 80B8EAB0  7C 04 07 34 */	extsh r4, r0
/* 80B8EAB4  4B 47 D9 80 */	b mDoMtx_YrotM__FPA4_fs
/* 80B8EAB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8EABC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8EAC0  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 80B8EAC4  4B 47 DA 08 */	b mDoMtx_ZrotM__FPA4_fs
lbl_80B8EAC8:
/* 80B8EAC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8EACC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8EAD0  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 80B8EAD4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 80B8EAD8  7C 80 F2 14 */	add r4, r0, r30
/* 80B8EADC  4B 7B 79 D4 */	b PSMTXCopy
/* 80B8EAE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B8EAE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B8EAE8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80B8EAEC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 80B8EAF0  4B 7B 79 C0 */	b PSMTXCopy
...
/* 80B8EB20  4B 47 EE 70 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 80B8EB34  4B 7D 36 F0 */	b _restgpr_28

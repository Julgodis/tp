...
/* 80A6C3C0 00000004  4B 8F 5E 14 */	b _savegpr_27
/* 80A6C3C4 00000008  7C 7E 1B 78 */	mr r30, r3
/* 80A6C3C8 0000000C  3C 60 80 A7 */	lis r3, m__17daNpc_Lud_Param_c@ha
/* 80A6C3CC 00000010  3B E3 FD 7C */	addi r31, r3, m__17daNpc_Lud_Param_c@l
/* 80A6C3D0 00000014  C0 1F 00 E8 */	lfs f0, 0xe8(r31)	/* effective address: 80A6FE64 */
/* 80A6C3D4 00000018  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 80A6C3D8 0000001C  C0 1F 00 EC */	lfs f0, 0xec(r31)	/* effective address: 80A6FE68 */
/* 80A6C3DC 00000020  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 80A6C3E0 00000024  C0 1F 00 C8 */	lfs f0, 0xc8(r31)	/* effective address: 80A6FE44 */
...
/* 80A6C3F4 00000038  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80A6C3F8 0000003C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80A6C3FC 00000040  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80A6C400 00000044  80 03 05 8C */	lwz r0, 0x58c(r3)	/* effective address: 8040674C */
/* 80A6C404 00000048  60 00 02 00 */	ori r0, r0, 0x200
/* 80A6C408 0000004C  90 03 05 8C */	stw r0, 0x58c(r3)	/* effective address: 8040674C */
lbl_80A6C40C:
/* 80A6C40C 00000000  38 7E 0D 08 */	addi r3, r30, 0xd08
/* 80A6C410 00000004  38 80 00 00 */	li r4, 0
/* 80A6C414 00000008  4B 6D BA 28 */	b calc__19daNpcT_DmgStagger_cFi
/* 80A6C418 0000000C  C0 5F 00 F0 */	lfs f2, 0xf0(r31)	/* effective address: 80A6FE6C */
...
/* 80A6C42C 00000020  C8 3F 01 00 */	lfd f1, 0x100(r31)	/* effective address: 80A6FE7C */
...
/* 80A6C4BC 00000054  C0 0A 00 40 */	lfs f0, 0x40(r10)	/* effective address: 80A6FDBC */
...
/* 80A6C4E0 00000078  C0 2A 00 24 */	lfs f1, 0x24(r10)	/* effective address: 80A6FDA0 */
/* 80A6C4E4 0000007C  C0 4A 00 20 */	lfs f2, 0x20(r10)	/* effective address: 80A6FD9C */
/* 80A6C4E8 00000080  C0 7F 00 C8 */	lfs f3, 0xc8(r31)	/* effective address: 80A6FE44 */
/* 80A6C4EC 00000084  FC 80 18 90 */	fmr f4, f3
/* 80A6C4F0 00000088  C0 AA 00 34 */	lfs f5, 0x34(r10)	/* effective address: 80A6FDB0 */
/* 80A6C4F4 0000008C  C0 CA 00 30 */	lfs f6, 0x30(r10)	/* effective address: 80A6FDAC */
/* 80A6C4F8 00000090  C0 EA 00 3C */	lfs f7, 0x3c(r10)	/* effective address: 80A6FDB8 */
/* 80A6C4FC 00000094  C1 0A 00 38 */	lfs f8, 0x38(r10)	/* effective address: 80A6FDB4 */
/* 80A6C500 00000098  39 40 00 00 */	li r10, 0
/* 80A6C504 0000009C  4B 6D A7 D4 */	b setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 80A6C560 00000054  C0 0A 00 40 */	lfs f0, 0x40(r10)	/* effective address: 80A6FDBC */
...
/* 80A6C584 00000078  C0 2A 00 24 */	lfs f1, 0x24(r10)	/* effective address: 80A6FDA0 */
/* 80A6C588 0000007C  C0 4A 00 20 */	lfs f2, 0x20(r10)	/* effective address: 80A6FD9C */
/* 80A6C58C 00000080  C0 6A 00 2C */	lfs f3, 0x2c(r10)	/* effective address: 80A6FDA8 */
/* 80A6C590 00000084  C0 8A 00 28 */	lfs f4, 0x28(r10)	/* effective address: 80A6FDA4 */
/* 80A6C594 00000088  C0 AA 00 34 */	lfs f5, 0x34(r10)	/* effective address: 80A6FDB0 */
/* 80A6C598 0000008C  C0 CA 00 30 */	lfs f6, 0x30(r10)	/* effective address: 80A6FDAC */
/* 80A6C59C 00000090  C0 EA 00 3C */	lfs f7, 0x3c(r10)	/* effective address: 80A6FDB8 */
/* 80A6C5A0 00000094  C1 0A 00 38 */	lfs f8, 0x38(r10)	/* effective address: 80A6FDB4 */
/* 80A6C5A4 00000098  39 40 00 00 */	li r10, 0
/* 80A6C5A8 0000009C  4B 6D A7 30 */	b setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
lbl_80A6C5AC:
/* 80A6C5AC 00000000  38 7E 0B A8 */	addi r3, r30, 0xba8
/* 80A6C5B0 00000004  C0 3F 00 D0 */	lfs f1, 0xd0(r31)	/* effective address: 80A6FE4C */
/* 80A6C5B4 00000008  C0 5F 00 D4 */	lfs f2, 0xd4(r31)	/* effective address: 80A6FE50 */
/* 80A6C5B8 0000000C  FC 60 F8 90 */	fmr f3, f31
/* 80A6C5BC 00000010  4B 6D B6 7C */	b calcJntRad__15daNpcT_JntAnm_cFfff
/* 80A6C5C0 00000014  38 7F 00 00 */	addi r3, r31, 0
/* 80A6C5C4 00000018  C0 03 00 8C */	lfs f0, 0x8c(r3)	/* effective address: 80A6FE08 */
...
/* 80A6C5D4 00000028  4B 6D CB BC */	b setMtx__8daNpcT_cFv
...
/* 80A6C5EC 00000040  4B 5A 4A C4 */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 80A6C604 00000058  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A6C608 0000005C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A6C60C 00000060  4B 8D 9E A4 */	b PSMTXCopy
/* 80A6C610 00000064  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6C614 00000068  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6C618 0000006C  38 81 00 5C */	addi r4, r1, 0x5c
/* 80A6C61C 00000070  4B 8D 9E 94 */	b PSMTXCopy
...
/* 80A6C630 00000084  4B 8D 9E 80 */	b PSMTXCopy
/* 80A6C634 00000088  80 7E 0E 40 */	lwz r3, 0xe40(r30)
/* 80A6C638 0000008C  4B 5A 4B B4 */	b modelCalc__16mDoExt_McaMorfSOFv
lbl_80A6C63C:
...
/* 80A6C668 0000002C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A6C66C 00000030  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A6C670 00000034  4B 8D 9E 40 */	b PSMTXCopy
/* 80A6C674 00000038  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6C678 0000003C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6C67C 00000040  38 81 00 50 */	addi r4, r1, 0x50
/* 80A6C680 00000044  38 BE 05 38 */	addi r5, r30, 0x538
/* 80A6C684 00000048  4B 8D A6 E8 */	b PSMTXMultVec
...
/* 80A6C6B4 00000010  C8 7F 01 00 */	lfd f3, 0x100(r31)	/* effective address: 80A6FE7C */
...
/* 80A6C6D0 0000002C  C0 1F 00 C8 */	lfs f0, 0xc8(r31)	/* effective address: 80A6FE44 */
...
/* 80A6C6EC 00000048  C0 1F 00 D4 */	lfs f0, 0xd4(r31)	/* effective address: 80A6FE50 */
...
/* 80A6C72C 00000020  C0 3F 00 D4 */	lfs f1, 0xd4(r31)	/* effective address: 80A6FE50 */
...
/* 80A6C760 00000054  C0 3F 00 D4 */	lfs f1, 0xd4(r31)	/* effective address: 80A6FE50 */
...
/* 80A6C790 00000020  C0 3F 00 D4 */	lfs f1, 0xd4(r31)	/* effective address: 80A6FE50 */
...
/* 80A6C7C4 00000054  C0 3F 00 D4 */	lfs f1, 0xd4(r31)	/* effective address: 80A6FE50 */
...
lbl_80A6C7EC:
/* 80A6C7EC 00000000  C0 1F 00 F4 */	lfs f0, 0xf4(r31)	/* effective address: 80A6FE70 */
/* 80A6C7F0 00000004  D0 01 00 50 */	stfs f0, 0x50(r1)
/* 80A6C7F4 00000008  C0 1F 00 F8 */	lfs f0, 0xf8(r31)	/* effective address: 80A6FE74 */
/* 80A6C7F8 0000000C  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 80A6C7FC 00000010  C0 1F 00 FC */	lfs f0, 0xfc(r31)	/* effective address: 80A6FE78 */
...
/* 80A6C810 00000024  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A6C814 00000028  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A6C818 0000002C  4B 8D 9C 98 */	b PSMTXCopy
/* 80A6C81C 00000030  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6C820 00000034  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6C824 00000038  38 81 00 50 */	addi r4, r1, 0x50
/* 80A6C828 0000003C  38 BE 05 50 */	addi r5, r30, 0x550
/* 80A6C82C 00000040  4B 8D A5 40 */	b PSMTXMultVec
/* 80A6C830 00000044  48 00 00 68 */	b lbl_80A6C898
lbl_80A6C834:
/* 80A6C834 00000000  C0 1F 00 C8 */	lfs f0, 0xc8(r31)	/* effective address: 80A6FE44 */
...
/* 80A6C844 00000010  C0 1F 00 00 */	lfs f0, 0(r31)	/* effective address: 80A6FD7C */
/* 80A6C848 00000014  D0 01 00 54 */	stfs f0, 0x54(r1)
/* 80A6C84C 00000018  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6C850 0000001C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6C854 00000020  A8 9E 0D 7A */	lha r4, 0xd7a(r30)
/* 80A6C858 00000024  4B 59 FB 84 */	b mDoMtx_YrotS__FPA4_fs
/* 80A6C85C 00000028  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6C860 0000002C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6C864 00000030  38 81 00 50 */	addi r4, r1, 0x50
/* 80A6C868 00000034  7C 85 23 78 */	mr r5, r4
/* 80A6C86C 00000038  4B 8D A5 00 */	b PSMTXMultVec
...
/* 80A6C87C 00000048  4B 7F A2 68 */	b __pl__4cXyzCFRC3Vec
...
/* 80A6C8D8 00000008  4B 8F 59 48 */	b _restgpr_27

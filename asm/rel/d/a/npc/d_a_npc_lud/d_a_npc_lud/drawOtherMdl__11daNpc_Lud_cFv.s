...
/* 80A6CAB4  4B 8F 57 1C */	b _savegpr_26
...
/* 80A6CAD4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A6CAD8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A6CADC  80 84 00 04 */	lwz r4, 4(r4)
/* 80A6CAE0  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80A6CAE4  4B 73 82 BC */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80A6CB04  4B 8B 8D 9C */	b hide__13J3DShapeTableFv
...
/* 80A6CB1C  4B 8B 8D BC */	b show__13J3DShapeTableFv
lbl_80A6CB20:
/* 80A6CB20  80 7B 0E 40 */	lwz r3, 0xe40(r27)
/* 80A6CB24  4B 5A 46 9C */	b entryDL__16mDoExt_McaMorfSOFv
/* 80A6CB28  80 7B 0E 40 */	lwz r3, 0xe40(r27)
/* 80A6CB2C  80 A3 00 04 */	lwz r5, 4(r3)
/* 80A6CB30  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A6CB34  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A6CB38  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 80A6CB3C  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80A6CB40  4B 5E 93 DC */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A6CB44:
/* 80A6CB44  3B 80 00 00 */	li r28, 0
/* 80A6CB48  3B 40 00 00 */	li r26, 0
/* 80A6CB4C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A6CB50  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80A6CB90:
/* 80A6CB90  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A6CB94  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A6CB98  80 84 00 04 */	lwz r4, 4(r4)
/* 80A6CB9C  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80A6CBA0  4B 73 82 00 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A6CBA4  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 80A6CBA8  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80A6CBAC  3C 60 80 A7 */	lis r3, data_80A6FEA8@ha
/* 80A6CBB0  38 63 FE A8 */	addi r3, r3, data_80A6FEA8@l
/* 80A6CBB4  7C 03 D0 2E */	lwzx r0, r3, r26
/* 80A6CBB8  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80A6CBBC  7C 64 02 14 */	add r3, r4, r0
/* 80A6CBC0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A6CBC4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A6CBC8  4B 8D 98 E8 */	b PSMTXCopy
/* 80A6CBCC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A6CBD0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A6CBD4  38 81 00 08 */	addi r4, r1, 8
/* 80A6CBD8  4B 8D 98 D8 */	b PSMTXCopy
/* 80A6CBDC  38 61 00 08 */	addi r3, r1, 8
/* 80A6CBE0  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80A6CBE4  38 84 00 24 */	addi r4, r4, 0x24
/* 80A6CBE8  4B 8D 98 C8 */	b PSMTXCopy
/* 80A6CBEC  7C 7B E8 2E */	lwzx r3, r27, r29
/* 80A6CBF0  4B 5A 10 D4 */	b mDoExt_modelUpdateDL__FP8J3DModel
/* 80A6CBF4  7F C3 F3 78 */	mr r3, r30
/* 80A6CBF8  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80A6CBFC  7C BB E8 2E */	lwzx r5, r27, r29
/* 80A6CC00  4B 5E 93 1C */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A6CC04:
...
/* 80A6CC18  4B 8F 56 04 */	b _restgpr_26

...
/* 80A1C344  4B 94 5E 88 */	b _savegpr_25
/* 80A1C348  7C 7D 1B 78 */	mr r29, r3
/* 80A1C34C  3C 80 80 A2 */	lis r4, lit_3908@ha
/* 80A1C350  3B E4 10 80 */	addi r31, r4, lit_3908@l
...
/* 80A1C3A8  3C 60 80 A2 */	lis r3, l_arcNames@ha
/* 80A1C3AC  3B 43 14 B4 */	addi r26, r3, l_arcNames@l
lbl_80A1C3B0:
/* 80A1C3B0  38 7B 14 14 */	addi r3, r27, 0x1414
/* 80A1C3B4  7C 7D 1A 14 */	add r3, r29, r3
/* 80A1C3B8  7C 9A E0 2E */	lwzx r4, r26, r28
/* 80A1C3BC  4B 61 0B 00 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80A1C3F0  3C 80 80 A2 */	lis r4, createHeapCallBack__15daNpcKasiHana_cFP10fopAc_ac_c@ha
/* 80A1C3F4  38 84 C9 64 */	addi r4, r4, createHeapCallBack__15daNpcKasiHana_cFP10fopAc_ac_c@l
/* 80A1C3F8  38 A0 19 40 */	li r5, 0x1940
/* 80A1C3FC  4B 5F E0 B4 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80A1C43C  4B 5F E1 0C */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80A1C454  4B 8A 48 90 */	b init__17Z2CreatureCitizenFP3VecP3VecUcUc
...
/* 80A1C468  4B 65 9A F0 */	b SetWall__12dBgS_AcchCirFff
...
/* 80A1C494  4B 65 9D B4 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
/* 80A1C498  38 7D 05 D0 */	addi r3, r29, 0x5d0
/* 80A1C49C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A1C4A0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80A1C4A4  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80A1C4A8  4B 65 A6 04 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80A1C4BC  4B 66 73 A4 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80A1C4C0  38 7D 12 C8 */	addi r3, r29, 0x12c8
/* 80A1C4C4  3C 80 80 3B */	lis r4, mCcDCyl__8daNpcF_c@ha
/* 80A1C4C8  38 84 37 E0 */	addi r4, r4, mCcDCyl__8daNpcF_c@l
/* 80A1C4CC  4B 66 83 E8 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80A1C4EC  4B 85 2D 0C */	b SetH__8cM3dGCylFf
/* 80A1C4F0  38 7D 13 EC */	addi r3, r29, 0x13ec
/* 80A1C4F4  C0 3A 00 1C */	lfs f1, 0x1c(r26)
/* 80A1C4F8  4B 85 2D 08 */	b SetR__8cM3dGCylFf
...
/* 80A1C578  4B 73 68 0C */	b setEnvTevColor__8daNpcF_cFv
/* 80A1C57C  7F A3 EB 78 */	mr r3, r29
/* 80A1C580  4B 73 68 60 */	b setRoomNo__8daNpcF_cFv
...
/* 80A1C59C  4B 94 5C 7C */	b _restgpr_25

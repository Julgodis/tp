...
/* 80A1C7FC 00000024  3C 60 00 00 */	lis r3, lit_4839@ha
/* 80A1C800 00000028  38 83 00 00 */	addi r4, r3, lit_4839@l
...
/* 80A1C838 00000060  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A1C83C 00000064  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A1C840 00000068  4B FF E6 D9 */	bl PSMTXCopy
/* 80A1C844 0000006C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A1C848 00000070  3B 83 00 00 */	addi r28, r3, now__14mDoMtx_stack_c@l
...
/* 80A1C8AC 000000D4  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A1C8B0 000000D8  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80A1C8E0 00000010  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A1C8E4 00000014  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80A1C90C 0000000C  3C C0 00 00 */	lis r6, m__21daNpcKasiHana_Param_c@ha
/* 80A1C910 00000010  38 C6 00 00 */	addi r6, r6, m__21daNpcKasiHana_Param_c@l
/* 80A1C914 00000014  C0 26 00 40 */	lfs f1, 0x40(r6)
/* 80A1C918 00000018  4B FF E6 01 */	bl setLookatMtx__8daNpcF_cFiPif
lbl_80A1C91C:
/* 80A1C91C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A1C920 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80A1C934 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A1C938 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A1C93C 00000020  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80A1C940 00000024  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l

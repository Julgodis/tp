...
/* 80A1EFA0  4B 94 32 3C */	b _savegpr_29
/* 80A1EFA4  7C 7E 1B 78 */	mr r30, r3
/* 80A1EFA8  3C 60 80 A2 */	lis r3, cNullVec__6Z2Calc@ha
/* 80A1EFAC  3B E3 13 D4 */	addi r31, r3, cNullVec__6Z2Calc@l
...
/* 80A1EFD4  4B 73 66 60 */	b daNpcF_chkEvtBit__FUl
...
/* 80A1EFE8  3C A0 80 A2 */	lis r5, lit_3998@ha
/* 80A1EFEC  C0 25 10 90 */	lfs f1, lit_3998@l(r5)
...
/* 80A1F010  3C A0 80 A2 */	lis r5, lit_3998@ha
/* 80A1F014  C0 25 10 90 */	lfs f1, lit_3998@l(r5)
...
/* 80A1F038  3C 60 80 A2 */	lis r3, lit_3908@ha
/* 80A1F03C  C0 03 10 80 */	lfs f0, lit_3908@l(r3)
...
lbl_80A1F0D0:
/* 80A1F0D0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A1F0D4  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80A1F0D8  88 1D 4F AD */	lbz r0, 0x4fad(r29)	/* effective address: 8040B16D */
...
/* 80A1F118  4B 62 96 D8 */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80A1F130  4B 62 33 38 */	b reset__14dEvt_control_cFv
...
/* 80A1F178  4B 73 47 04 */	b orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_80A1F17C:
/* 80A1F17C  38 60 00 01 */	li r3, 1
lbl_80A1F180:
/* 80A1F180  39 61 00 30 */	addi r11, r1, 0x30
/* 80A1F184  4B 94 30 A4 */	b _restgpr_29

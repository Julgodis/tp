...
/* 80A3DCFC  4B 92 44 D8 */	b _savegpr_27
/* 80A3DD00  7C 7D 1B 78 */	mr r29, r3
/* 80A3DD04  7C 9B 23 78 */	mr r27, r4
/* 80A3DD08  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A3DD0C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80A3DD20  3C A0 80 A4 */	lis r5, stringBase0@ha
/* 80A3DD24  38 A5 0A F8 */	addi r5, r5, stringBase0@l
/* 80A3DD28  38 A5 02 35 */	addi r5, r5, 0x235
/* 80A3DD2C  38 C0 00 03 */	li r6, 3
/* 80A3DD30  4B 60 A3 BC */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80A3DD48  4B 60 A0 04 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80A3DD94  4B 70 79 68 */	b remove__18daNpcT_ActorMngr_cFv
/* 80A3DD98  38 00 00 00 */	li r0, 0
/* 80A3DD9C  90 1D 0B FC */	stw r0, 0xbfc(r29)
/* 80A3DDA0  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A3DDA4  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A3DDD0  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A3DDD4  3B 84 61 C0 */	addi r28, r4, struct_804061C0+0x0@l
/* 80A3DDD8  80 9C 5D AC */	lwz r4, 0x5dac(r28)	/* effective address: 8040BF6C */
/* 80A3DDDC  4B 5D C9 34 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A3DE04  4B 70 7A 94 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A3DE08  93 9D 0B B4 */	stw r28, 0xbb4(r29)
/* 80A3DE0C  38 00 00 09 */	li r0, 9
/* 80A3DE10  90 1D 0B B0 */	stw r0, 0xbb0(r29)
/* 80A3DE14  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A3DE18  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A3DE34  4B 70 7A 64 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A3DE38  93 9D 0B 90 */	stw r28, 0xb90(r29)
/* 80A3DE3C  38 00 00 01 */	li r0, 1
/* 80A3DE40  90 1D 0B 8C */	stw r0, 0xb8c(r29)
/* 80A3DE44  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A3DE48  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A3DE84  4B 5E 34 D4 */	b fpcEx_SearchByID__FUi
/* 80A3DE88  28 03 00 00 */	cmplwi r3, 0
/* 80A3DE8C  41 82 00 08 */	beq lbl_80A3DE94
/* 80A3DE90  4B 5D BD EC */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80A3DE94:
...
/* 80A3DEB0  4B 92 43 70 */	b _restgpr_27

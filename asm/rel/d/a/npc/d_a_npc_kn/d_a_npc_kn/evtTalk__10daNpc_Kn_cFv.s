...
/* 80A2C250  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80A41840 */
/* 80A2C254  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80A41844 */
/* 80A2C258  90 81 00 14 */	stw r4, 0x14(r1)
/* 80A2C25C  90 01 00 18 */	stw r0, 0x18(r1)
/* 80A2C260  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80A41848 */
...
/* 80A2C294  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A2C298  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A2C29C  88 63 4F B5 */	lbz r3, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80A2C2BC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A2C2C0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80A2C2DC  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80A4184C */
/* 80A2C2E0  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80A41850 */
/* 80A2C2E4  90 61 00 08 */	stw r3, 8(r1)
/* 80A2C2E8  90 01 00 0C */	stw r0, 0xc(r1)
/* 80A2C2EC  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80A41854 */

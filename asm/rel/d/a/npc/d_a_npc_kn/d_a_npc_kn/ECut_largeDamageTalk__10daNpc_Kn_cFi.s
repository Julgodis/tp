...
/* 80A2E27C  4B 93 3F 58 */	b _savegpr_27
/* 80A2E280  7C 7E 1B 78 */	mr r30, r3
/* 80A2E284  7C 9B 23 78 */	mr r27, r4
/* 80A2E288  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A2E28C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80A2E2A0  3C A0 80 A4 */	lis r5, stringBase0@ha
/* 80A2E2A4  38 A5 0A F8 */	addi r5, r5, stringBase0@l
/* 80A2E2A8  38 A5 02 35 */	addi r5, r5, 0x235
/* 80A2E2AC  38 C0 00 03 */	li r6, 3
/* 80A2E2B0  4B 61 9E 3C */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80A2E2C8  4B 61 9A 84 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80A2E308  4B 71 73 F4 */	b remove__18daNpcT_ActorMngr_cFv
/* 80A2E30C  38 00 00 00 */	li r0, 0
/* 80A2E310  90 1E 0B FC */	stw r0, 0xbfc(r30)
/* 80A2E314  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2E318  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A2E334  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2E338  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
lbl_80A2E38C:
/* 80A2E38C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A2E390  3B A3 61 C0 */	addi r29, r3, struct_804061C0+0x0@l
/* 80A2E394  80 7D 5D AC */	lwz r3, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 80A2E398  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 80400628 */
...
/* 80A2E3CC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A2E3D0  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 80A2E3D4  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 80A2E3D8  4B 5E C3 38 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2E3F4  4B 5E C3 1C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2E434  4B 71 74 64 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2E438  93 9E 0B 90 */	stw r28, 0xb90(r30)
/* 80A2E43C  38 00 00 01 */	li r0, 1
/* 80A2E440  90 1E 0B 8C */	stw r0, 0xb8c(r30)
/* 80A2E444  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2E448  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2E464  4B 71 74 34 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2E468  93 9E 0B B4 */	stw r28, 0xbb4(r30)
/* 80A2E46C  38 00 00 00 */	li r0, 0
/* 80A2E470  90 1E 0B B0 */	stw r0, 0xbb0(r30)
/* 80A2E474  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2E478  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2E4C4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A2E4C8  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 80A2E4CC  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 80A2E4D0  4B 5E C2 40 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2E4E4  4B 84 21 24 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A2E514  4B 93 3D 0C */	b _restgpr_27

...
/* 80A2DD80  4B 93 44 54 */	b _savegpr_27
/* 80A2DD84  7C 7E 1B 78 */	mr r30, r3
/* 80A2DD88  7C 9B 23 78 */	mr r27, r4
/* 80A2DD8C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A2DD90  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80A2DDA4  3C A0 80 A4 */	lis r5, stringBase0@ha
/* 80A2DDA8  38 A5 0A F8 */	addi r5, r5, stringBase0@l
/* 80A2DDAC  38 A5 02 35 */	addi r5, r5, 0x235
/* 80A2DDB0  38 C0 00 03 */	li r6, 3
/* 80A2DDB4  4B 61 A3 38 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80A2DDCC  4B 61 9F 80 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80A2DE00  4B 71 78 FC */	b remove__18daNpcT_ActorMngr_cFv
/* 80A2DE04  38 00 00 00 */	li r0, 0
/* 80A2DE08  90 1E 0B FC */	stw r0, 0xbfc(r30)
/* 80A2DE0C  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2DE10  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A2DE2C  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2DE30  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A2DE7C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A2DE80  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 80A2DE84  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 80A2DE88  4B 5E C8 88 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2DEA4  4B 5E C8 6C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2DEE4  4B 71 79 B4 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2DEE8  93 BE 0B 90 */	stw r29, 0xb90(r30)
/* 80A2DEEC  38 00 00 01 */	li r0, 1
/* 80A2DEF0  90 1E 0B 8C */	stw r0, 0xb8c(r30)
/* 80A2DEF4  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2DEF8  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2DF14  4B 71 79 84 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2DF18  93 BE 0B B4 */	stw r29, 0xbb4(r30)
/* 80A2DF1C  38 00 00 00 */	li r0, 0
/* 80A2DF20  90 1E 0B B0 */	stw r0, 0xbb0(r30)
/* 80A2DF24  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2DF28  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2DF70  4B 93 42 B0 */	b _restgpr_27

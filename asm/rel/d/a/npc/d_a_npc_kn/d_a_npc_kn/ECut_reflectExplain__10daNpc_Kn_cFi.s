...
/* 80A3FFC4  4B 92 22 0C */	b _savegpr_26
/* 80A3FFC8  7C 7C 1B 78 */	mr r28, r3
/* 80A3FFCC  7C 9A 23 78 */	mr r26, r4
/* 80A3FFD0  3C 60 80 A4 */	lis r3, mCcDObjData__10daNpc_Kn_c@ha
/* 80A3FFD4  3B E3 08 C8 */	addi r31, r3, mCcDObjData__10daNpc_Kn_c@l
/* 80A3FFD8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A3FFDC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80A3FFF0  3C A0 80 A4 */	lis r5, stringBase0@ha
/* 80A3FFF4  38 A5 0A F8 */	addi r5, r5, stringBase0@l
/* 80A3FFF8  38 A5 02 35 */	addi r5, r5, 0x235
/* 80A3FFFC  38 C0 00 03 */	li r6, 3
/* 80A40000  4B 60 80 EC */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80A40018  4B 60 7D 34 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80A40058  4B 70 CA D4 */	b daNpcT_offTmpBit__FUl
...
/* 80A40070  4B 70 58 28 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A40090  4B 70 58 08 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A400B8  4B 70 56 44 */	b remove__18daNpcT_ActorMngr_cFv
...
/* 80A40150  4B 5C CC 14 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80A40154  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A40158  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A4015C  A8 9C 04 B6 */	lha r4, 0x4b6(r28)
/* 80A40160  4B 5C C2 D4 */	b mDoMtx_YrotM__FPA4_fs
/* 80A40164  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A40168  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A4016C  38 81 00 20 */	addi r4, r1, 0x20
/* 80A40170  7C 85 23 78 */	mr r5, r4
/* 80A40174  4B 90 6B F8 */	b PSMTXMultVec
...
/* 80A401A0  4B 5D DB 1C */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 80A401A4  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 80A401A8  41 82 00 10 */	beq lbl_80A401B8
/* 80A401AC  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 80A401B0  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
/* 80A401B4  D0 01 00 24 */	stfs f0, 0x24(r1)
lbl_80A401B8:
/* 80A401B8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A401BC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A401C0  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
...
/* 80A401DC  81 83 06 28 */	lwz r12, 0x628(r3)	/* effective address: 804067E8 */
...
/* 80A40278  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A4027C  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 80A40280  80 9D 5D AC */	lwz r4, 0x5dac(r29)	/* effective address: 8040BF6C */
/* 80A40284  4B 5D A4 8C */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A402A8  4B 5D A4 68 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A402E4  4B 70 55 B4 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A40310  4B 70 55 88 */	b initialize__22daNpcT_MotionSeqMngr_cFv
...
/* 80A403A4  4B 92 1E 78 */	b _restgpr_26

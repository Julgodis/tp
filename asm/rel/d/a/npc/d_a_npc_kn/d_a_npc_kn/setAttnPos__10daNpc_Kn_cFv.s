...
/* 80A2C57C  4B 93 5C 60 */	b _savegpr_29
/* 80A2C580  7C 7E 1B 78 */	mr r30, r3
/* 80A2C584  3C 60 80 A4 */	lis r3, mCcDObjData__10daNpc_Kn_c@ha
/* 80A2C588  3B E3 08 C8 */	addi r31, r3, mCcDObjData__10daNpc_Kn_c@l
/* 80A2C58C  C0 1F 00 5C */	lfs f0, 0x5c(r31)	/* effective address: 80A40924 */
/* 80A2C590  D0 01 00 28 */	stfs f0, 0x28(r1)
/* 80A2C594  C0 3F 00 38 */	lfs f1, 0x38(r31)	/* effective address: 80A40900 */
...
/* 80A2C5AC  C0 0A 00 40 */	lfs f0, 0x40(r10)	/* effective address: 80A409B0 */
...
/* 80A2C5D0  C0 2A 00 24 */	lfs f1, 0x24(r10)	/* effective address: 80A40994 */
/* 80A2C5D4  C0 4A 00 20 */	lfs f2, 0x20(r10)	/* effective address: 80A40990 */
/* 80A2C5D8  C0 6A 00 2C */	lfs f3, 0x2c(r10)	/* effective address: 80A4099C */
/* 80A2C5DC  C0 8A 00 28 */	lfs f4, 0x28(r10)	/* effective address: 80A40998 */
/* 80A2C5E0  C0 AA 00 34 */	lfs f5, 0x34(r10)	/* effective address: 80A409A4 */
/* 80A2C5E4  C0 CA 00 30 */	lfs f6, 0x30(r10)	/* effective address: 80A409A0 */
/* 80A2C5E8  C0 EA 00 3C */	lfs f7, 0x3c(r10)	/* effective address: 80A409AC */
/* 80A2C5EC  C1 0A 00 38 */	lfs f8, 0x38(r10)	/* effective address: 80A409A8 */
/* 80A2C5F0  39 40 00 00 */	li r10, 0
/* 80A2C5F4  4B 71 A6 E4 */	b setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 80A2C638  4B 71 B6 00 */	b calcJntRad__15daNpcT_JntAnm_cFfff
...
/* 80A2C650  4B 5E 07 14 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80A2C654  38 7E 0D AC */	addi r3, r30, 0xdac
/* 80A2C658  4B 5E 08 EC */	b ZXYrotM__14mDoMtx_stack_cFRC5csXyz
/* 80A2C65C  38 7E 04 EC */	addi r3, r30, 0x4ec
/* 80A2C660  4B 5E 08 10 */	b scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80A2C664  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A2C668  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A2C66C  38 9D 00 24 */	addi r4, r29, 0x24
/* 80A2C670  4B 91 9E 40 */	b PSMTXCopy
/* 80A2C674  93 DD 00 14 */	stw r30, 0x14(r29)
/* 80A2C678  80 7E 05 C0 */	lwz r3, 0x5c0(r30)
/* 80A2C67C  4B 5E 4B 70 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 80A2C694  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A2C698  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A2C69C  4B 91 9E 14 */	b PSMTXCopy
/* 80A2C6A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A2C6A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A2C6A8  38 81 00 28 */	addi r4, r1, 0x28
/* 80A2C6AC  38 BE 05 38 */	addi r5, r30, 0x538
/* 80A2C6B0  4B 91 A6 BC */	b PSMTXMultVec
...
/* 80A2C728  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A2C72C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A2C730  4B 91 9D 80 */	b PSMTXCopy
/* 80A2C734  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A2C738  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A2C73C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80A2C740  D0 1E 05 50 */	stfs f0, 0x550(r30)
/* 80A2C744  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80A2C748  D0 1E 05 54 */	stfs f0, 0x554(r30)
/* 80A2C74C  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80A2C768  4B 93 5A C0 */	b _restgpr_29

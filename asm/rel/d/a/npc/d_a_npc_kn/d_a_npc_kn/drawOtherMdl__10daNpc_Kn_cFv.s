...
/* 80A2CD90  4B 93 54 4C */	b _savegpr_29
/* 80A2CD94  7C 7F 1B 78 */	mr r31, r3
/* 80A2CD98  3C 60 80 A4 */	lis r3, mCcDObjData__10daNpc_Kn_c@ha
/* 80A2CD9C  3B C3 08 C8 */	addi r30, r3, mCcDObjData__10daNpc_Kn_c@l
...
/* 80A2CE10  3C 60 80 45 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 80A2CE14  C0 03 11 80 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
lbl_80A2CE40:
/* 80A2CE40  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A2CE44  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A2CE48  38 80 00 00 */	li r4, 0
/* 80A2CE4C  38 BF 04 D0 */	addi r5, r31, 0x4d0
/* 80A2CE50  38 DF 0E 50 */	addi r6, r31, 0xe50
/* 80A2CE54  4B 77 69 70 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80A2CE58  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A2CE5C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A2CE60  80 9D 00 04 */	lwz r4, 4(r29)
/* 80A2CE64  38 BF 0E 50 */	addi r5, r31, 0xe50
/* 80A2CE68  4B 77 7F 38 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A2CE6C  80 7F 05 C0 */	lwz r3, 0x5c0(r31)
/* 80A2CE70  4B 5E 43 50 */	b entryDL__16mDoExt_McaMorfSOFv
...
/* 80A2CEA8  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80A2CEAC  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80A2CEB0  4B 60 1A 60 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 80A2CEE4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A2CEE8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A2CEEC  4B 91 95 C4 */	b PSMTXCopy
/* 80A2CEF0  38 7F 04 EC */	addi r3, r31, 0x4ec
/* 80A2CEF4  4B 5D FF 7C */	b scaleM__14mDoMtx_stack_cFRC4cXyz
/* 80A2CEF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A2CEFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A2CF00  80 9F 0E 44 */	lwz r4, 0xe44(r31)
/* 80A2CF04  38 84 00 24 */	addi r4, r4, 0x24
/* 80A2CF08  4B 91 95 A8 */	b PSMTXCopy
/* 80A2CF0C  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A2CF10  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A2CF14  80 9F 0E 44 */	lwz r4, 0xe44(r31)
/* 80A2CF18  80 84 00 04 */	lwz r4, 4(r4)
/* 80A2CF1C  38 BF 0E 50 */	addi r5, r31, 0xe50
/* 80A2CF20  4B 77 7E 80 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80A2CF44  4B 5E 0A 88 */	b entry__13mDoExt_bckAnmFP12J3DModelDataf
lbl_80A2CF48:
/* 80A2CF48  80 7F 0E 44 */	lwz r3, 0xe44(r31)
/* 80A2CF4C  4B 5E 0D 78 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80A2CF80  4B 62 8F 9C */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A2CF84:
/* 80A2CF84  39 61 00 30 */	addi r11, r1, 0x30
/* 80A2CF88  4B 93 52 A0 */	b _restgpr_29

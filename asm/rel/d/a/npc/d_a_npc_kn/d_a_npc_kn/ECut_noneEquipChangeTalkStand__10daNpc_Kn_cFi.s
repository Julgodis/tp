...
/* 80A2DF94  4B 93 42 40 */	b _savegpr_27
/* 80A2DF98  7C 7D 1B 78 */	mr r29, r3
/* 80A2DF9C  7C 9B 23 78 */	mr r27, r4
/* 80A2DFA0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A2DFA4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80A2DFB8  3C A0 80 A4 */	lis r5, stringBase0@ha
/* 80A2DFBC  38 A5 0A F8 */	addi r5, r5, stringBase0@l
/* 80A2DFC0  38 A5 02 35 */	addi r5, r5, 0x235
/* 80A2DFC4  38 C0 00 03 */	li r6, 3
/* 80A2DFC8  4B 61 A1 24 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 80A2DFE0  4B 61 9D 6C */	b getIsAddvance__16dEvent_manager_cFi
...
/* 80A2E020  4B 71 76 DC */	b remove__18daNpcT_ActorMngr_cFv
/* 80A2E024  38 00 00 00 */	li r0, 0
/* 80A2E028  90 1D 0B FC */	stw r0, 0xbfc(r29)
/* 80A2E02C  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2E030  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A2E05C  4B 71 78 3C */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2E060  93 9D 0B 90 */	stw r28, 0xb90(r29)
/* 80A2E064  38 00 00 01 */	li r0, 1
/* 80A2E068  90 1D 0B 8C */	stw r0, 0xb8c(r29)
/* 80A2E06C  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2E070  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2E08C  4B 71 78 0C */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2E090  93 9D 0B B4 */	stw r28, 0xbb4(r29)
/* 80A2E094  38 00 00 16 */	li r0, 0x16
/* 80A2E098  90 1D 0B B0 */	stw r0, 0xbb0(r29)
/* 80A2E09C  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2E0A0  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
/* 80A2E0A4  D0 1D 0B C0 */	stfs f0, 0xbc0(r29)
lbl_80A2E0A8:
/* 80A2E0A8  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2E0AC  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A2E0D4  4B 71 76 28 */	b remove__18daNpcT_ActorMngr_cFv
/* 80A2E0D8  38 00 00 00 */	li r0, 0
/* 80A2E0DC  90 1D 0B FC */	stw r0, 0xbfc(r29)
/* 80A2E0E0  3C 60 80 A4 */	lis r3, lit_4204@ha
/* 80A2E0E4  C0 03 09 00 */	lfs f0, lit_4204@l(r3)
...
/* 80A2E164  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A2E168  3B C4 61 C0 */	addi r30, r4, struct_804061C0+0x0@l
/* 80A2E16C  80 9E 5D AC */	lwz r4, 0x5dac(r30)	/* effective address: 8040BF6C */
/* 80A2E170  4B 5E C5 A0 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2E18C  4B 5E C5 84 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A2E1CC  4B 71 76 CC */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2E1D0  93 9D 0B 90 */	stw r28, 0xb90(r29)
/* 80A2E1D4  38 00 00 01 */	li r0, 1
/* 80A2E1D8  90 1D 0B 8C */	stw r0, 0xb8c(r29)
/* 80A2E1DC  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2E1E0  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2E1FC  4B 71 76 9C */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 80A2E200  93 9D 0B B4 */	stw r28, 0xbb4(r29)
/* 80A2E204  38 00 00 00 */	li r0, 0
/* 80A2E208  90 1D 0B B0 */	stw r0, 0xbb0(r29)
/* 80A2E20C  3C 60 80 A4 */	lis r3, lit_4613@ha
/* 80A2E210  C0 03 09 14 */	lfs f0, lit_4613@l(r3)
...
/* 80A2E258  4B 93 3F C8 */	b _restgpr_27

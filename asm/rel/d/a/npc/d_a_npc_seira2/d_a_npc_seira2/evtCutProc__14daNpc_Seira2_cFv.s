...
/* 80AD1E14  4B 89 03 C8 */	b _savegpr_29
/* 80AD1E18  7C 7D 1B 78 */	mr r29, r3
/* 80AD1E1C  3B C0 00 00 */	li r30, 0
/* 80AD1E20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AD1E24  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AD1E28  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 80AD1E2C  7F E3 FB 78 */	mr r3, r31
/* 80AD1E30  3C 80 80 AD */	lis r4, struct_80AD4B5C+0x0@ha
/* 80AD1E34  38 84 4B 5C */	addi r4, r4, struct_80AD4B5C+0x0@l
/* 80AD1E38  38 84 00 24 */	addi r4, r4, 0x24
/* 80AD1E3C  7F A5 EB 78 */	mr r5, r29
/* 80AD1E40  38 C0 FF FF */	li r6, -1
/* 80AD1E44  4B 57 5C D8 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 80AD1E5C  3C A0 80 AD */	lis r5, mCutNameList__14daNpc_Seira2_c@ha
/* 80AD1E60  38 A5 52 B4 */	addi r5, r5, mCutNameList__14daNpc_Seira2_c@l
/* 80AD1E64  38 C0 00 01 */	li r6, 1
/* 80AD1E68  38 E0 00 00 */	li r7, 0
/* 80AD1E6C  39 00 00 00 */	li r8, 0
/* 80AD1E70  4B 57 5F A0 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 80AD1E84  3C A0 80 AD */	lis r5, mCutList__14daNpc_Seira2_c@ha
/* 80AD1E88  38 05 52 B8 */	addi r0, r5, mCutList__14daNpc_Seira2_c@l
/* 80AD1E8C  7D 80 32 14 */	add r12, r0, r6
/* 80AD1E90  4B 89 01 F4 */	b __ptmf_scall
...
/* 80AD1EA8  4B 57 62 D4 */	b cutEnd__16dEvent_manager_cFi
lbl_80AD1EAC:
/* 80AD1EAC  3B C0 00 01 */	li r30, 1
lbl_80AD1EB0:
/* 80AD1EB0  38 7D 0E 78 */	addi r3, r29, 0xe78
/* 80AD1EB4  4B 6C 44 58 */	b Save__16ShopCam_action_cFv
/* 80AD1EB8  7F C3 F3 78 */	mr r3, r30
/* 80AD1EBC  39 61 00 20 */	addi r11, r1, 0x20
/* 80AD1EC0  4B 89 03 68 */	b _restgpr_29

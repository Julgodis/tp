...
/* 80AA39EC  4B 8B E7 F0 */	b _savegpr_29
/* 80AA39F0  7C 7E 1B 78 */	mr r30, r3
/* 80AA39F4  3C 80 80 AA */	lis r4, lit_4109@ha
/* 80AA39F8  3B E4 69 8C */	addi r31, r4, lit_4109@l
...
/* 80AA3A44  4B 6B 46 AC */	b getAnmP__10daNpcCd2_cFii
...
/* 80AA3A64  4B 6B 54 9C */	b setAnm__10daNpcCd2_cFP18J3DAnmTransformKeyffiii
/* 80AA3A68  38 7E 05 94 */	addi r3, r30, 0x594
/* 80AA3A6C  38 80 00 00 */	li r4, 0
/* 80AA3A70  4B 81 D3 A8 */	b playVoice__17Z2CreatureCitizenFi
/* 80AA3A74  38 00 00 01 */	li r0, 1
/* 80AA3A78  90 1E 0B 1C */	stw r0, 0xb1c(r30)
lbl_80AA3A7C:
/* 80AA3A7C  7F C3 F3 78 */	mr r3, r30
/* 80AA3A80  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AA3A84  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AA3A88  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80AA3A8C  4B 57 6C 84 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80AA3AA0  4B 7C CB 68 */	b cLib_addCalcAngleS2__FPssss
...
/* 80AA3ABC  4B 57 61 C0 */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80AA3AC0:
...
/* 80AA3AE4  4B 6B 61 30 */	b checkPoint__11PathTrace_cF4cXyzf
...
/* 80AA3B68  4B 7C CA A0 */	b cLib_addCalcAngleS2__FPssss
...
/* 80AA3B80  3C 60 80 AA */	lis r3, __vt__8cM3dGPla@ha
/* 80AA3B84  38 03 73 C0 */	addi r0, r3, __vt__8cM3dGPla@l
/* 80AA3B88  90 01 00 40 */	stw r0, 0x40(r1)
/* 80AA3B8C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AA3B90  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AA3B94  38 63 0F 38 */	addi r3, r3, 0xf38
/* 80AA3B98  38 9E 07 28 */	addi r4, r30, 0x728
/* 80AA3B9C  38 A1 00 30 */	addi r5, r1, 0x30
/* 80AA3BA0  4B 5D 0B A4 */	b GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla
...
/* 80AA3BB4  4B 57 A0 24 */	b fopAcM_getPolygonAngle__FPC8cM3dGPlas
...
lbl_80AA3BCC:
/* 80AA3BCC  3C 60 80 AA */	lis r3, __vt__8cM3dGPla@ha
/* 80AA3BD0  38 03 73 C0 */	addi r0, r3, __vt__8cM3dGPla@l
...
/* 80AA3BEC  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AA3BF0  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AA3BF4  38 84 0F 38 */	addi r4, r4, 0xf38
/* 80AA3BF8  4B 5D 2E B4 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80AA3C10  4B 8A 37 8C */	b PSVECSquareDistance
...
/* 80AA3C80  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AA3C84  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80AA3CF0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AA3CF4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80AA3CF8:
...
/* 80AA3D38  4B 8B E4 F0 */	b _restgpr_29

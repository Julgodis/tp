...
/* 80AA41F4  4B 8B DF E8 */	b _savegpr_29
/* 80AA41F8  7C 7E 1B 78 */	mr r30, r3
/* 80AA41FC  3C 80 80 AA */	lis r4, lit_4109@ha
/* 80AA4200  3B E4 69 8C */	addi r31, r4, lit_4109@l
/* 80AA4204  C0 1F 00 48 */	lfs f0, 0x48(r31)	/* effective address: 80AA69D4 */
...
/* 80AA421C  C0 3F 00 34 */	lfs f1, 0x34(r31)	/* effective address: 80AA69C0 */
/* 80AA4220  C0 5F 00 38 */	lfs f2, 0x38(r31)	/* effective address: 80AA69C4 */
/* 80AA4224  C0 7F 00 4C */	lfs f3, 0x4c(r31)	/* effective address: 80AA69D8 */
/* 80AA4228  C0 9F 00 50 */	lfs f4, 0x50(r31)	/* effective address: 80AA69DC */
/* 80AA422C  C0 BF 00 40 */	lfs f5, 0x40(r31)	/* effective address: 80AA69CC */
/* 80AA4230  C0 DF 00 08 */	lfs f6, 8(r31)	/* effective address: 80AA6994 */
/* 80AA4234  4B 57 63 14 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80AA4238  80 BE 0A 98 */	lwz r5, 0xa98(r30)
/* 80AA423C  2C 05 00 10 */	cmpwi r5, 0x10
/* 80AA4240  40 80 00 1C */	bge lbl_80AA425C
/* 80AA4244  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 80AA4248  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_80AA425C:
/* 80AA425C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 80AA4260  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 80AA427C  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA4280  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
...
lbl_80AA4294:
/* 80AA4294  3C 80 80 43 */	lis r4, l_Cd2_HIO@ha
/* 80AA4298  38 84 86 1C */	addi r4, r4, l_Cd2_HIO@l
/* 80AA429C  1C 05 02 3C */	mulli r0, r5, 0x23c
/* 80AA42A0  7C 84 02 14 */	add r4, r4, r0
/* 80AA42A4  C0 24 FF 38 */	lfs f1, -0xc8(r4)
lbl_80AA42A8:
/* 80AA42A8  4B 5D 1C B0 */	b SetWall__12dBgS_AcchCirFff
...
/* 80AA42D4  4B 5D 1F 74 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80AA42F4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AA42F8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AA42FC  3B A4 0F 38 */	addi r29, r4, 0xf38
/* 80AA4300  7F A4 EB 78 */	mr r4, r29
/* 80AA4304  4B 5D 27 A8 */	b CrrPos__9dBgS_AcchFR4dBgS
/* 80AA4308  7F C3 F3 78 */	mr r3, r30
/* 80AA430C  4B 6B 4A 7C */	b setEnvTevCol__10daNpcCd2_cFv
/* 80AA4310  7F C3 F3 78 */	mr r3, r30
/* 80AA4314  4B 6B 4A D0 */	b setRoomNo__10daNpcCd2_cFv
...
/* 80AA4348  4B 6B 56 F0 */	b setPath__11PathTrace_cFiiiP4cXyzb
...
/* 80AA4368  4B 56 B8 14 */	b setMorf__13mDoExt_morf_cFf
/* 80AA436C  38 7E 06 38 */	addi r3, r30, 0x638
/* 80AA4370  7F A4 EB 78 */	mr r4, r29
/* 80AA4374  4B 5D 27 38 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80AA4390  4B 8B DE 98 */	b _restgpr_29

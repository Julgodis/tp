...
/* 809D0F9C  4B 99 12 2C */	b _savegpr_24
/* 809D0FA0  7C 7D 1B 78 */	mr r29, r3
/* 809D0FA4  3C 60 80 9D */	lis r3, lit_1109@ha
/* 809D0FA8  3B C3 3E B0 */	addi r30, r3, lit_1109@l
/* 809D0FAC  3C 60 80 9D */	lis r3, m__17daNpc_Grd_Param_c@ha
/* 809D0FB0  3B E3 3A 04 */	addi r31, r3, m__17daNpc_Grd_Param_c@l
/* 809D0FB4  88 1E 00 5C */	lbz r0, 0x5c(r30)	/* effective address: 809D3F0C */
...
/* 809D0FDC  3C 80 80 9D */	lis r4, __dt__4cXyzFv@ha
/* 809D0FE0  38 84 32 A4 */	addi r4, r4, __dt__4cXyzFv@l
...
/* 809D0FF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0FFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D1000  A8 9D 09 90 */	lha r4, 0x990(r29)
/* 809D1004  4B 63 B3 D8 */	b mDoMtx_YrotS__FPA4_fs
...
/* 809D1018  4B 89 EA 24 */	b cLib_addCalc2__FPffff
...
/* 809D102C  4B 89 EA 10 */	b cLib_addCalc2__FPffff
/* 809D1030  3B 00 00 00 */	li r24, 0
/* 809D1034  3B 80 00 00 */	li r28, 0
/* 809D1038  3B 60 00 00 */	li r27, 0
/* 809D103C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 809D1040  3B 23 9A 20 */	addi r25, r3, sincosTable___5JMath@l
/* 809D1044  C3 DF 00 80 */	lfs f30, 0x80(r31)
/* 809D1048  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D104C  3B 43 D4 70 */	addi r26, r3, now__14mDoMtx_stack_c@l
lbl_809D1050:
...
/* 809D1080  4B 97 5C EC */	b PSMTXMultVec
...
/* 809D10D8  4B 89 F5 F8 */	b cLib_chaseS__FPsss
...
/* 809D1120  3C 60 80 9D */	lis r3, ctrlJointCallBack__11daNpc_Grd_cFP8J3DJointi@ha
/* 809D1124  38 83 0B 90 */	addi r4, r3, ctrlJointCallBack__11daNpc_Grd_cFP8J3DJointi@l
...
/* 809D1180  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809D1184  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809D1188  4B 97 53 28 */	b PSMTXCopy
/* 809D118C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D1190  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D1194  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 809D1198  D0 1D 08 E4 */	stfs f0, 0x8e4(r29)
/* 809D119C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 809D11A0  D0 1D 08 E8 */	stfs f0, 0x8e8(r29)
/* 809D11A4  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 809D11A8  D0 1D 08 EC */	stfs f0, 0x8ec(r29)
/* 809D11AC  38 9E 00 60 */	addi r4, r30, 0x60
/* 809D11B0  38 BD 05 38 */	addi r5, r29, 0x538
/* 809D11B4  4B 97 5B B8 */	b PSMTXMultVec
/* 809D11B8  C0 1F 00 80 */	lfs f0, 0x80(r31)
/* 809D11BC  D0 1E 00 60 */	stfs f0, 0x60(r30)
/* 809D11C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D11C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D11C8  38 9E 00 60 */	addi r4, r30, 0x60
/* 809D11CC  38 A1 00 30 */	addi r5, r1, 0x30
/* 809D11D0  4B 97 5B 9C */	b PSMTXMultVec
/* 809D11D4  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 809D11D8  38 81 00 30 */	addi r4, r1, 0x30
/* 809D11DC  4B 89 FA 98 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 809D11E0  B0 7D 09 02 */	sth r3, 0x902(r29)
/* 809D11E4  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 809D11E8  38 81 00 30 */	addi r4, r1, 0x30
/* 809D11EC  4B 89 FA 18 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 809D1208  4B 89 59 2C */	b __mi__4cXyzCFRC3Vec
...
/* 809D1240  4B 89 64 34 */	b cM_atan2s__Fff
...
/* 809D126C  4B 97 5E CC */	b PSVECSquareMag
...
/* 809D12DC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809D12E0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 809D134C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 809D1350  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 809D1354  48 00 00 08 */	b lbl_809D135C
lbl_809D1358:
/* 809D1358  FC 40 08 90 */	fmr f2, f1
lbl_809D135C:
/* 809D135C  C0 21 00 40 */	lfs f1, 0x40(r1)
/* 809D1360  4B 89 63 14 */	b cM_atan2s__Fff
...
/* 809D1390  4B 63 B9 D4 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 809D1394  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D1398  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D139C  A8 9D 08 F0 */	lha r4, 0x8f0(r29)
/* 809D13A0  A8 BD 08 F2 */	lha r5, 0x8f2(r29)
/* 809D13A4  A8 DD 08 F4 */	lha r6, 0x8f4(r29)
/* 809D13A8  4B 63 AE F8 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 809D13AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D13B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D13B4  38 81 00 3C */	addi r4, r1, 0x3c
/* 809D13B8  38 A1 00 48 */	addi r5, r1, 0x48
/* 809D13BC  4B 97 59 B0 */	b PSMTXMultVec
...
/* 809D1438  4B 89 DD A4 */	b SetC__8cM3dGCylFRC4cXyz
...
/* 809D1450  4B 89 DD A8 */	b SetH__8cM3dGCylFf
...
/* 809D1468  4B 89 DD 98 */	b SetR__8cM3dGCylFf
/* 809D146C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809D1470  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809D1474  38 63 23 3C */	addi r3, r3, 0x233c
/* 809D1478  38 9D 0C 94 */	addi r4, r29, 0xc94
/* 809D147C  4B 89 37 2C */	b Set__4cCcSFP8cCcD_Obj
lbl_809D1480:
...
/* 809D14A8  4B 99 0D 6C */	b _restgpr_24

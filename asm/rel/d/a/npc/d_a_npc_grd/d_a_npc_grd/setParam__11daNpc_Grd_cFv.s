...
/* 809D0C20  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809D0C24  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809D0C28  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 809D0C2C  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 809D0C8C  AB A5 00 48 */	lha r29, 0x48(r5)	/* effective address: 809D3A4C */
/* 809D0C90  AB C5 00 4A */	lha r30, 0x4a(r5)	/* effective address: 809D3A4E */
/* 809D0C94  7F E3 FB 78 */	mr r3, r31
/* 809D0C98  A8 85 00 4C */	lha r4, 0x4c(r5)	/* effective address: 809D3A50 */
/* 809D0C9C  A8 A5 00 4E */	lha r5, 0x4e(r5)	/* effective address: 809D3A52 */
...
/* 809D0CD0  C0 04 00 08 */	lfs f0, 8(r4)	/* effective address: 809D3A0C */
...
/* 809D0CE4  C0 24 00 1C */	lfs f1, 0x1c(r4)	/* effective address: 809D3A20 */
...
/* 809D0CF4  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 809D3A1C */
/* 809D0CF8  D0 1F 08 14 */	stfs f0, 0x814(r31)
/* 809D0CFC  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 809D3A08 */

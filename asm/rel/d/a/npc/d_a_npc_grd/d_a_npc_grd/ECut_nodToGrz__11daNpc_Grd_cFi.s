...
/* 809D2CAC  4B 98 F5 24 */	b _savegpr_26
/* 809D2CB0  7C 7D 1B 78 */	mr r29, r3
/* 809D2CB4  7C 9A 23 78 */	mr r26, r4
/* 809D2CB8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809D2CBC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 809D2CD4  3C A0 80 9D */	lis r5, stringBase0@ha
/* 809D2CD8  38 A5 3B F4 */	addi r5, r5, stringBase0@l
/* 809D2CDC  38 A5 00 15 */	addi r5, r5, 0x15
/* 809D2CE0  38 C0 00 03 */	li r6, 3
/* 809D2CE4  4B 67 54 08 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809D2CFC  3C A0 80 9D */	lis r5, stringBase0@ha
/* 809D2D00  38 A5 3B F4 */	addi r5, r5, stringBase0@l
/* 809D2D04  38 A5 00 19 */	addi r5, r5, 0x19
/* 809D2D08  38 C0 00 03 */	li r6, 3
/* 809D2D0C  4B 67 53 E0 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809D2D24  4B 67 50 28 */	b getIsAddvance__16dEvent_manager_cFi
...
lbl_809D2D70:
/* 809D2D70  3C 60 80 9D */	lis r3, s_sub2__FPvPv@ha
/* 809D2D74  38 63 2C 50 */	addi r3, r3, s_sub2__FPvPv@l
/* 809D2D78  7F A4 EB 78 */	mr r4, r29
/* 809D2D7C  4B 64 E5 BC */	b fpcEx_Search__FPFPvPv_PvPv
/* 809D2D80  7C 64 1B 78 */	mr r4, r3
/* 809D2D84  38 7D 0C 88 */	addi r3, r29, 0xc88
/* 809D2D88  4B 77 D9 34 */	b entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
lbl_809D2DA0:
/* 809D2DA0  3C 60 80 9D */	lis r3, s_sub1__FPvPv@ha
/* 809D2DA4  38 63 2C 04 */	addi r3, r3, s_sub1__FPvPv@l
/* 809D2DA8  7F A4 EB 78 */	mr r4, r29
/* 809D2DAC  4B 64 E5 8C */	b fpcEx_Search__FPFPvPv_PvPv
/* 809D2DB0  7C 64 1B 78 */	mr r4, r3
/* 809D2DB4  38 7D 0C 88 */	addi r3, r29, 0xc88
/* 809D2DB8  4B 77 D9 04 */	b entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
...
/* 809D2DD4  3C A0 80 9D */	lis r5, lit_4451@ha
/* 809D2DD8  C0 25 3A 84 */	lfs f1, lit_4451@l(r5)
...
/* 809D2DF4  3C A0 80 9D */	lis r5, lit_4451@ha
/* 809D2DF8  C0 25 3A 84 */	lfs f1, lit_4451@l(r5)
...
/* 809D2E24  4B 78 14 2C */	b setAngle__8daNpcF_cFs
lbl_809D2E28:
...
/* 809D2E84  4B 77 D8 68 */	b getActorP__18daNpcF_ActorMngr_cFv
/* 809D2E88  7C 7C 1B 78 */	mr r28, r3
/* 809D2E8C  2C 1E 00 14 */	cmpwi r30, 0x14
/* 809D2E90  40 82 00 10 */	bne lbl_809D2EA0
/* 809D2E94  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809D2E98  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809D2E9C  83 83 5D AC */	lwz r28, 0x5dac(r3)	/* effective address: 8040BF6C */
lbl_809D2EA0:
...
/* 809D2EC8  4B 64 78 48 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809D2F04  4B 78 11 A0 */	b step__8daNpcF_cFsiii
...
/* 809D2F20  3C A0 80 9D */	lis r5, lit_4710@ha
/* 809D2F24  C0 25 3A 94 */	lfs f1, lit_4710@l(r5)
...
/* 809D2F44  3C A0 80 9D */	lis r5, lit_4710@ha
/* 809D2F48  C0 25 3A 94 */	lfs f1, lit_4710@l(r5)
...
/* 809D2F70  4B 77 D7 7C */	b getActorP__18daNpcF_ActorMngr_cFv
/* 809D2F74  7C 64 1B 78 */	mr r4, r3
/* 809D2F78  7F A3 EB 78 */	mr r3, r29
/* 809D2F7C  4B 64 77 94 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 809D2FD0  4B 78 10 D4 */	b step__8daNpcF_cFsiii
...
/* 809D2FEC  3C A0 80 9D */	lis r5, lit_4710@ha
/* 809D2FF0  C0 25 3A 94 */	lfs f1, lit_4710@l(r5)
...
/* 809D300C  3C A0 80 9D */	lis r5, lit_4710@ha
/* 809D3010  C0 25 3A 94 */	lfs f1, lit_4710@l(r5)
...
/* 809D3044  4B 98 F1 D8 */	b _restgpr_26

...
/* 809D0D2C  4B 99 14 B0 */	b _savegpr_29
/* 809D0D30  7C 7E 1B 78 */	mr r30, r3
/* 809D0D34  3C 80 80 9D */	lis r4, cNullVec__6Z2Calc@ha
/* 809D0D38  3B E4 3C 14 */	addi r31, r4, cNullVec__6Z2Calc@l
...
/* 809D0D70  4B 65 EC E4 */	b dComIfGs_wolfeye_effect_check__Fv
...
lbl_809D0D90:
/* 809D0D90  3C 60 80 9D */	lis r3, m__17daNpc_Grd_Param_c@ha
/* 809D0D94  38 63 3A 04 */	addi r3, r3, m__17daNpc_Grd_Param_c@l
/* 809D0D98  88 03 00 6A */	lbz r0, 0x6a(r3)	/* effective address: 809D3A6E */
/* 809D0D9C  28 00 00 00 */	cmplwi r0, 0
/* 809D0DA0  40 82 00 AC */	bne lbl_809D0E4C
/* 809D0DA4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809D0DA8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809D0DAC  88 63 4F AD */	lbz r3, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 809D0E48  4B 78 2A 34 */	b orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_809D0E4C:
/* 809D0E4C  88 1E 09 EE */	lbz r0, 0x9ee(r30)
/* 809D0E50  28 00 00 00 */	cmplwi r0, 0
/* 809D0E54  41 82 00 1C */	beq lbl_809D0E70
/* 809D0E58  3C 60 80 9D */	lis r3, lit_4451@ha
/* 809D0E5C  C0 03 3A 84 */	lfs f0, lit_4451@l(r3)
...
/* 809D0E88  4B 99 13 A0 */	b _restgpr_29

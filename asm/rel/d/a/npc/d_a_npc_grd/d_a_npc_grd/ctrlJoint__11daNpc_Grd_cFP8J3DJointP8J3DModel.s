...
/* 809D094C  4B 99 18 8C */	b _savegpr_28
...
/* 809D0960  3C 60 80 9D */	lis r3, lit_4503@ha
/* 809D0964  38 83 3A 88 */	addi r4, r3, lit_4503@l
/* 809D0968  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 809D3A88 */
/* 809D096C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 809D3A8C */
/* 809D0970  90 61 00 08 */	stw r3, 8(r1)
/* 809D0974  90 01 00 0C */	stw r0, 0xc(r1)
/* 809D0978  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 809D3A90 */
...
/* 809D099C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809D09A0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809D09A4  4B 97 5B 0C */	b PSMTXCopy
/* 809D09A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D09AC  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 809D09B0  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 809D09B4  D0 1F 08 54 */	stfs f0, 0x854(r31)
/* 809D09B8  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 809D09BC  D0 1F 08 58 */	stfs f0, 0x858(r31)
/* 809D09C0  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 809D09E0  4B 97 5A D0 */	b PSMTXCopy
...
/* 809D0A10  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809D0A14  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809D0A18  4B 97 5A 98 */	b PSMTXCopy
...
/* 809D0A44  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809D0A48  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809D0A4C  4B 97 5A 64 */	b PSMTXCopy
...
/* 809D0A7C  3C C0 80 9D */	lis r6, m__17daNpc_Grd_Param_c@ha
/* 809D0A80  38 C6 3A 04 */	addi r6, r6, m__17daNpc_Grd_Param_c@l
/* 809D0A84  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 809D3A44 */
/* 809D0A88  4B 78 28 F4 */	b setLookatMtx__8daNpcF_cFiPif
lbl_809D0A8C:
/* 809D0A8C  2C 1D 00 01 */	cmpwi r29, 1
/* 809D0A90  40 82 00 30 */	bne lbl_809D0AC0
/* 809D0A94  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0A98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D0A9C  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809D0AA0  7C 00 00 D0 */	neg r0, r0
/* 809D0AA4  7C 04 07 34 */	extsh r4, r0
/* 809D0AA8  4B 63 B9 8C */	b mDoMtx_YrotM__FPA4_fs
/* 809D0AAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0AB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D0AB4  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809D0AB8  4B 63 BA 14 */	b mDoMtx_ZrotM__FPA4_fs
/* 809D0ABC  48 00 00 34 */	b lbl_809D0AF0
lbl_809D0AC0:
/* 809D0AC0  2C 1D 00 04 */	cmpwi r29, 4
/* 809D0AC4  40 82 00 2C */	bne lbl_809D0AF0
/* 809D0AC8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0ACC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D0AD0  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809D0AD4  7C 00 00 D0 */	neg r0, r0
/* 809D0AD8  7C 04 07 34 */	extsh r4, r0
/* 809D0ADC  4B 63 B9 58 */	b mDoMtx_YrotM__FPA4_fs
/* 809D0AE0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0AE4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D0AE8  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809D0AEC  4B 63 B9 E0 */	b mDoMtx_ZrotM__FPA4_fs
lbl_809D0AF0:
/* 809D0AF0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0AF4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D0AF8  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809D0AFC  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809D0B00  7C 80 F2 14 */	add r4, r0, r30
/* 809D0B04  4B 97 59 AC */	b PSMTXCopy
/* 809D0B08  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809D0B0C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809D0B10  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 809D0B14  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 809D0B18  4B 97 59 98 */	b PSMTXCopy
...
/* 809D0B48  4B 63 CE 48 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809D0B5C  4B 99 16 C8 */	b _restgpr_28

...
/* 809A8744  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A8748  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A874C  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 809A8750  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
...
/* 809A8770  4B 79 D1 28 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 809A8774  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 809A8778  38 00 00 09 */	li r0, 9
/* 809A877C  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 809A8780  3C 60 80 9B */	lis r3, lit_4588@ha
/* 809A8784  C0 03 A3 DC */	lfs f0, lit_4588@l(r3)
...
/* 809A87A0  4B 79 D0 F8 */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 809A87A4  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 809A87A8  38 00 00 0B */	li r0, 0xb
/* 809A87AC  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 809A87B0  3C 60 80 9B */	lis r3, lit_4588@ha
/* 809A87B4  C0 03 A3 DC */	lfs f0, lit_4588@l(r3)
...
/* 809A87DC  4B 79 D0 BC */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 809A87E0  93 DF 0B 5C */	stw r30, 0xb5c(r31)
/* 809A87E4  38 00 00 09 */	li r0, 9
/* 809A87E8  90 1F 0B 58 */	stw r0, 0xb58(r31)
/* 809A87EC  3C 60 80 9B */	lis r3, lit_4588@ha
/* 809A87F0  C0 03 A3 DC */	lfs f0, lit_4588@l(r3)
...
/* 809A880C  4B 79 D0 8C */	b initialize__22daNpcT_MotionSeqMngr_cFv
/* 809A8810  93 DF 0B 80 */	stw r30, 0xb80(r31)
/* 809A8814  38 00 00 00 */	li r0, 0
/* 809A8818  90 1F 0B 7C */	stw r0, 0xb7c(r31)
/* 809A881C  3C 60 80 9B */	lis r3, lit_4588@ha
/* 809A8820  C0 03 A3 DC */	lfs f0, lit_4588@l(r3)
...
/* 809A8840  4B 7A 42 6C */	b daNpcT_chkEvtBit__FUl
...
/* 809A8880  4B 79 CE 7C */	b remove__18daNpcT_ActorMngr_cFv
/* 809A8884  38 00 00 00 */	li r0, 0
/* 809A8888  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 809A888C  3C 60 80 9B */	lis r3, lit_4037@ha
/* 809A8890  C0 03 A3 C4 */	lfs f0, lit_4037@l(r3)
...
/* 809A88AC  4B 79 D1 78 */	b checkEndSequence__22daNpcT_MotionSeqMngr_cFv
...
lbl_809A88CC:
/* 809A88CC  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809A88D0  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809A88D4  80 63 5D B4 */	lwz r3, 0x5db4(r3)	/* effective address: 8040BF74 */
/* 809A88D8  80 03 05 74 */	lwz r0, 0x574(r3)	/* effective address: 80406734 */
/* 809A88DC  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6
/* 809A88E0  41 82 00 0C */	beq lbl_809A88EC
/* 809A88E4  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 809A88E8  4B 79 CE 14 */	b remove__18daNpcT_ActorMngr_cFv
lbl_809A88EC:
/* 809A88EC  38 7F 0B 98 */	addi r3, r31, 0xb98
/* 809A88F0  4B 79 CE 18 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 809A890C  4B 79 CD F0 */	b remove__18daNpcT_ActorMngr_cFv
/* 809A8910  38 00 00 00 */	li r0, 0
/* 809A8914  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 809A8918  3C 60 80 9B */	lis r3, lit_4037@ha
/* 809A891C  C0 03 A3 C4 */	lfs f0, lit_4037@l(r3)
...
/* 809A893C  4B 79 CD CC */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 809A8950  4B 7A 22 80 */	b chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs
...
/* 809A896C  4B 79 CD 90 */	b remove__18daNpcT_ActorMngr_cFv
/* 809A8970  38 00 00 00 */	li r0, 0
/* 809A8974  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 809A8978  3C 60 80 9B */	lis r3, lit_4037@ha
/* 809A897C  C0 03 A3 C4 */	lfs f0, lit_4037@l(r3)
...
/* 809A8998  4B 7A 29 A0 */	b srchPlayerActor__8daNpcT_cFv
...
/* 809A89D0  4B 79 CD 2C */	b remove__18daNpcT_ActorMngr_cFv
/* 809A89D4  38 00 00 00 */	li r0, 0
/* 809A89D8  90 1F 0B C8 */	stw r0, 0xbc8(r31)
/* 809A89DC  3C 60 80 9B */	lis r3, lit_4037@ha
/* 809A89E0  C0 03 A3 C4 */	lfs f0, lit_4037@l(r3)
...
/* 809A8A28  4B 7A 2C 20 */	b step__8daNpcT_cFsiiii
...
/* 809A8A4C  4B 7A 1F CC */	b setAngle__8daNpcT_cFs
...
/* 809A8A7C  4B 7A 28 BC */	b srchPlayerActor__8daNpcT_cFv
lbl_809A8A80:

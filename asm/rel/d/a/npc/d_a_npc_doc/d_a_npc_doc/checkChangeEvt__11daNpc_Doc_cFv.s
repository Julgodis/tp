...
/* 809A7AD0 00000014  3C 80 80 9B */	lis r4, lit_4547@ha
/* 809A7AD4 00000018  38 A4 A8 B4 */	addi r5, r4, lit_4547@l
/* 809A7AD8 0000001C  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 809AA8B4 */
/* 809A7ADC 00000020  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 809AA8B8 */
/* 809A7AE0 00000024  90 81 00 08 */	stw r4, 8(r1)
/* 809A7AE4 00000028  90 01 00 0C */	stw r0, 0xc(r1)
/* 809A7AE8 0000002C  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 809AA8BC */
...
/* 809A7B08 0000004C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809A7B0C 00000050  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 809A7B10 00000054  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 809A7B34 0000000C  4B 6A 0C BC */	b ChkPresentEnd__16dEvent_manager_cFv
/* 809A7B38 00000010  2C 03 00 00 */	cmpwi r3, 0
/* 809A7B3C 00000014  41 82 00 68 */	beq lbl_809A7BA4
/* 809A7B40 00000018  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809A7B44 0000001C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 809A7B48 00000020  88 03 4F B6 */	lbz r0, 0x4fb6(r3)	/* effective address: 8040B176 */
...
/* 809A7B74 00000004  4B 7A 4F 38 */	b daNpcT_chkEvtBit__FUl
...
/* 809A7BA0 0000000C  4B 7A 26 84 */	b evtChange__8daNpcT_cFv
lbl_809A7BA4:

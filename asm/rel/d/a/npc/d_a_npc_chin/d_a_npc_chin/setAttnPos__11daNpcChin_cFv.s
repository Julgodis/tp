...
/* 8098D284  3C 60 80 99 */	lis r3, sLoadResPat_Normal@ha
/* 8098D288  3B E3 18 F8 */	addi r31, r3, sLoadResPat_Normal@l
...
/* 8098D310  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8098D314  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8098D318  4B 9B 91 98 */	b PSMTXCopy
/* 8098D31C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8098D320  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8098D324  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 8098D328  D0 1E 08 E4 */	stfs f0, 0x8e4(r30)
/* 8098D32C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 8098D330  D0 1E 08 E8 */	stfs f0, 0x8e8(r30)
/* 8098D334  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 8098D338  D0 1E 08 EC */	stfs f0, 0x8ec(r30)
/* 8098D33C  38 81 00 30 */	addi r4, r1, 0x30
/* 8098D340  38 BE 05 38 */	addi r5, r30, 0x538
/* 8098D344  4B 9B 9A 28 */	b PSMTXMultVec
/* 8098D348  C0 1F 00 84 */	lfs f0, 0x84(r31)
/* 8098D34C  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 8098D350  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8098D354  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8098D358  38 81 00 30 */	addi r4, r1, 0x30
/* 8098D35C  7C 85 23 78 */	mr r5, r4
/* 8098D360  4B 9B 9A 0C */	b PSMTXMultVec
/* 8098D364  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 8098D368  38 81 00 30 */	addi r4, r1, 0x30
/* 8098D36C  4B 8E 39 08 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 8098D370  B0 7E 09 02 */	sth r3, 0x902(r30)
/* 8098D374  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 8098D378  38 81 00 30 */	addi r4, r1, 0x30
/* 8098D37C  4B 8E 38 88 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 8098D398  4B 8D 97 9C */	b __mi__4cXyzCFRC3Vec
...
/* 8098D3C8  4B 8D A2 AC */	b cM_atan2s__Fff
...
/* 8098D3F4  4B 9B 9D 44 */	b PSVECSquareMag
...
/* 8098D464  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8098D468  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 8098D4D4  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8098D4D8  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 8098D4DC  48 00 00 08 */	b lbl_8098D4E4
lbl_8098D4E0:
/* 8098D4E0  FC 40 08 90 */	fmr f2, f1
lbl_8098D4E4:
/* 8098D4E4  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 8098D4E8  4B 8D A1 8C */	b cM_atan2s__Fff

...
/* 8098C520  4B 9D 5C B0 */	b _savegpr_26
/* 8098C524  7C 7D 1B 78 */	mr r29, r3
/* 8098C528  3C 80 80 99 */	lis r4, sLoadResPat_Normal@ha
/* 8098C52C  3B E4 18 F8 */	addi r31, r4, sLoadResPat_Normal@l
...
lbl_8098C554:
/* 8098C554  4B 82 00 28 */	b dKy_darkworld_check__Fv
...
/* 8098C57C  3C 60 80 99 */	lis r3, sLoadResInfo@ha
/* 8098C580  38 63 20 C0 */	addi r3, r3, sLoadResInfo@l
/* 8098C584  7F 43 00 2E */	lwzx r26, r3, r0
/* 8098C588  3B C0 00 05 */	li r30, 5
/* 8098C58C  3B 80 00 00 */	li r28, 0
/* 8098C590  3C 60 80 99 */	lis r3, l_arcNames@ha
/* 8098C594  3B 63 20 A8 */	addi r27, r3, l_arcNames@l
...
/* 8098C5AC  4B 6A 09 10 */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 8098C5F4  4B 81 C1 F0 */	b dKy_change_colpat__FUc
/* 8098C5F8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8098C5FC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 8098C614  4B 6A 8D 4C */	b isSwitch__10dSv_info_cCFii
/* 8098C618  2C 03 00 00 */	cmpwi r3, 0
/* 8098C61C  40 82 00 14 */	bne lbl_8098C630
/* 8098C620  38 60 00 01 */	li r3, 1
/* 8098C624  4B 81 C1 C0 */	b dKy_change_colpat__FUc
/* 8098C628  38 00 00 01 */	li r0, 1
/* 8098C62C  98 1D 0E 24 */	stb r0, 0xe24(r29)
lbl_8098C630:
/* 8098C630  7F A3 EB 78 */	mr r3, r29
/* 8098C634  3C 80 80 99 */	lis r4, createHeapCallBack__11daNpcChin_cFP10fopAc_ac_c@ha
/* 8098C638  38 84 CF B8 */	addi r4, r4, createHeapCallBack__11daNpcChin_cFP10fopAc_ac_c@l
/* 8098C63C  38 A0 46 60 */	li r5, 0x4660
/* 8098C640  4B 68 DE 70 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 8098C694  4B 68 DE B4 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 8098C6B8  4B 68 DE 90 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
lbl_8098C6BC:
...
/* 8098C6D0  4B 93 3E 60 */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 8098C6E4  4B 6E 98 74 */	b SetWall__12dBgS_AcchCirFff
...
/* 8098C710  4B 6E 9B 38 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 8098C730  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 8098C734  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 8098C738  38 84 0F 38 */	addi r4, r4, 0xf38
/* 8098C73C  4B 6E A3 70 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 8098C760  4B 6F 71 00 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 8098C764  38 7D 0C 7C */	addi r3, r29, 0xc7c
/* 8098C768  3C 80 80 3B */	lis r4, mCcDCyl__8daNpcF_c@ha
/* 8098C76C  38 84 37 E0 */	addi r4, r4, mCcDCyl__8daNpcF_c@l
/* 8098C770  4B 6F 81 44 */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 8098C80C  48 26 CC 24 */	b getSphMng__10daGlwSph_cFv
/* 8098C810  90 7D 0E 0C */	stw r3, 0xe0c(r29)
lbl_8098C814:
/* 8098C814  7F A3 EB 78 */	mr r3, r29
/* 8098C818  4B 7C 65 6C */	b setEnvTevColor__8daNpcF_cFv
/* 8098C81C  7F A3 EB 78 */	mr r3, r29
/* 8098C820  4B 7C 65 C0 */	b setRoomNo__8daNpcF_cFv
/* 8098C824  80 7D 05 68 */	lwz r3, 0x568(r29)
/* 8098C828  4B 68 49 C4 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 8098C844  4B 9D 59 D8 */	b _restgpr_26

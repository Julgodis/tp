...
/* 8098C868  4B 9D 59 74 */	b _savegpr_29
...
/* 8098C87C  3C 60 80 99 */	lis r3, l_arcNames@ha
/* 8098C880  38 63 20 A8 */	addi r3, r3, l_arcNames@l
/* 8098C884  80 63 00 0C */	lwz r3, 0xc(r3)	/* effective address: 809920B4 */
/* 8098C888  38 80 00 03 */	li r4, 3
/* 8098C88C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8098C890  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8098C894  3C A5 00 02 */	addis r5, r5, 2
/* 8098C898  38 C0 00 80 */	li r6, 0x80
/* 8098C89C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8098C8A0  4B 6A FA 4C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8098C8A4  7C 7E 1B 78 */	mr r30, r3
/* 8098C8A8  48 00 00 30 */	b lbl_8098C8D8
lbl_8098C8AC:
/* 8098C8AC  3C 60 80 99 */	lis r3, l_arcNames@ha
/* 8098C8B0  38 63 20 A8 */	addi r3, r3, l_arcNames@l
/* 8098C8B4  80 63 00 08 */	lwz r3, 8(r3)	/* effective address: 809920B0 */
/* 8098C8B8  38 80 00 03 */	li r4, 3
/* 8098C8BC  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 8098C8C0  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 8098C8C4  3C A5 00 02 */	addis r5, r5, 2
/* 8098C8C8  38 C0 00 80 */	li r6, 0x80
/* 8098C8CC  38 A5 C2 F8 */	addi r5, r5, -15624
/* 8098C8D0  4B 6A FA 1C */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 8098C8D4  7C 7E 1B 78 */	mr r30, r3
lbl_8098C8D8:
/* 8098C8D8  38 60 00 58 */	li r3, 0x58
/* 8098C8DC  4B 94 23 70 */	b __nw__FUl
...
/* 8098C918  3D 20 80 99 */	lis r9, lit_3884@ha
/* 8098C91C  C0 29 19 78 */	lfs f1, lit_3884@l(r9)
/* 8098C920  39 20 00 00 */	li r9, 0
/* 8098C924  39 40 FF FF */	li r10, -1
/* 8098C928  4B 68 3E A8 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 8098C94C  4B 68 49 C4 */	b stopZelAnime__16mDoExt_McaMorfSOFv
...
/* 8098C974  3C 60 80 99 */	lis r3, ctrlJointCallBack__11daNpcChin_cFP8J3DJointi@ha
/* 8098C978  38 83 CF D8 */	addi r4, r3, ctrlJointCallBack__11daNpcChin_cFP8J3DJointi@l
...
/* 8098C9AC  4B 94 22 A0 */	b __nw__FUl
/* 8098C9B0  7C 7E 1B 79 */	or. r30, r3, r3
/* 8098C9B4  41 82 00 D0 */	beq lbl_8098CA84
/* 8098C9B8  7F DD F3 78 */	mr r29, r30
/* 8098C9BC  3C 60 80 3D */	lis r3, __vt__14J3DMaterialAnm@ha
/* 8098C9C0  38 03 EE 60 */	addi r0, r3, __vt__14J3DMaterialAnm@l
/* 8098C9C4  90 1E 00 00 */	stw r0, 0(r30)
/* 8098C9C8  38 7E 00 04 */	addi r3, r30, 4
/* 8098C9CC  3C 80 80 99 */	lis r4, __ct__14J3DMatColorAnmFv@ha
/* 8098C9D0  38 84 CC CC */	addi r4, r4, __ct__14J3DMatColorAnmFv@l
/* 8098C9D4  3C A0 80 99 */	lis r5, __dt__14J3DMatColorAnmFv@ha
/* 8098C9D8  38 A5 CC 90 */	addi r5, r5, __dt__14J3DMatColorAnmFv@l
/* 8098C9DC  38 C0 00 08 */	li r6, 8
/* 8098C9E0  38 E0 00 02 */	li r7, 2
/* 8098C9E4  4B 9D 53 7C */	b __construct_array
/* 8098C9E8  38 7E 00 14 */	addi r3, r30, 0x14
/* 8098C9EC  3C 80 80 99 */	lis r4, __ct__12J3DTexMtxAnmFv@ha
/* 8098C9F0  38 84 CC 78 */	addi r4, r4, __ct__12J3DTexMtxAnmFv@l
/* 8098C9F4  3C A0 80 99 */	lis r5, __dt__12J3DTexMtxAnmFv@ha
/* 8098C9F8  38 A5 CC 3C */	addi r5, r5, __dt__12J3DTexMtxAnmFv@l
/* 8098C9FC  38 C0 00 08 */	li r6, 8
/* 8098CA00  38 E0 00 08 */	li r7, 8
/* 8098CA04  4B 9D 53 5C */	b __construct_array
/* 8098CA08  38 7E 00 54 */	addi r3, r30, 0x54
/* 8098CA0C  3C 80 80 99 */	lis r4, __ct__11J3DTexNoAnmFv@ha
/* 8098CA10  38 84 CC 18 */	addi r4, r4, __ct__11J3DTexNoAnmFv@l
/* 8098CA14  3C A0 80 99 */	lis r5, __dt__11J3DTexNoAnmFv@ha
/* 8098CA18  38 A5 CB D0 */	addi r5, r5, __dt__11J3DTexNoAnmFv@l
/* 8098CA1C  38 C0 00 0C */	li r6, 0xc
/* 8098CA20  38 E0 00 08 */	li r7, 8
/* 8098CA24  4B 9D 53 3C */	b __construct_array
/* 8098CA28  38 7E 00 B4 */	addi r3, r30, 0xb4
/* 8098CA2C  3C 80 80 99 */	lis r4, __ct__14J3DTevColorAnmFv@ha
/* 8098CA30  38 84 CB B8 */	addi r4, r4, __ct__14J3DTevColorAnmFv@l
/* 8098CA34  3C A0 80 99 */	lis r5, __dt__14J3DTevColorAnmFv@ha
/* 8098CA38  38 A5 CB 7C */	addi r5, r5, __dt__14J3DTevColorAnmFv@l
/* 8098CA3C  38 C0 00 08 */	li r6, 8
/* 8098CA40  38 E0 00 04 */	li r7, 4
/* 8098CA44  4B 9D 53 1C */	b __construct_array
/* 8098CA48  38 7E 00 D4 */	addi r3, r30, 0xd4
/* 8098CA4C  3C 80 80 99 */	lis r4, __ct__15J3DTevKColorAnmFv@ha
/* 8098CA50  38 84 CB 64 */	addi r4, r4, __ct__15J3DTevKColorAnmFv@l
/* 8098CA54  3C A0 80 99 */	lis r5, __dt__15J3DTevKColorAnmFv@ha
/* 8098CA58  38 A5 CB 28 */	addi r5, r5, __dt__15J3DTevKColorAnmFv@l
/* 8098CA5C  38 C0 00 08 */	li r6, 8
/* 8098CA60  38 E0 00 04 */	li r7, 4
/* 8098CA64  4B 9D 52 FC */	b __construct_array
/* 8098CA68  7F C3 F3 78 */	mr r3, r30
/* 8098CA6C  4B 99 F8 B4 */	b initialize__14J3DMaterialAnmFv
/* 8098CA70  3C 60 80 3B */	lis r3, __vt__15daNpcF_MatAnm_c@ha
/* 8098CA74  38 03 39 20 */	addi r0, r3, __vt__15daNpcF_MatAnm_c@l
/* 8098CA78  90 1D 00 00 */	stw r0, 0(r29)
/* 8098CA7C  7F A3 EB 78 */	mr r3, r29
/* 8098CA80  4B 7C 3C B8 */	b initialize__15daNpcF_MatAnm_cFv
lbl_8098CA84:
...
/* 8098CAD0  3C A0 80 99 */	lis r5, lit_3885@ha
/* 8098CAD4  C0 25 19 7C */	lfs f1, lit_3885@l(r5)
...
/* 8098CB14  4B 9D 57 14 */	b _restgpr_29

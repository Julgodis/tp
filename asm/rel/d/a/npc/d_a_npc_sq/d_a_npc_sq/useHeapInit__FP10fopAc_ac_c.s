...
/* 80AF6DC0  4B 86 B4 18 */	b _savegpr_28
/* 80AF6DC4  7C 7F 1B 78 */	mr r31, r3
/* 80AF6DC8  38 60 00 54 */	li r3, 0x54
/* 80AF6DCC  4B 7D 7E 80 */	b __nw__FUl
/* 80AF6DD0  7C 7E 1B 79 */	or. r30, r3, r3
/* 80AF6DD4  41 82 00 9C */	beq lbl_80AF6E70
/* 80AF6DD8  3C 60 80 AF */	lis r3, stringBase0@ha
/* 80AF6DDC  38 63 74 A4 */	addi r3, r3, stringBase0@l
/* 80AF6DE0  38 80 00 09 */	li r4, 9
/* 80AF6DE4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80AF6DE8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80AF6DFC  4B 54 54 F0 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
/* 80AF6E00  7C 7D 1B 78 */	mr r29, r3
/* 80AF6E04  3C 60 80 AF */	lis r3, stringBase0@ha
/* 80AF6E08  38 63 74 A4 */	addi r3, r3, stringBase0@l
/* 80AF6E0C  38 80 00 11 */	li r4, 0x11
/* 80AF6E10  7F 85 E3 78 */	mr r5, r28
/* 80AF6E14  38 C0 00 80 */	li r6, 0x80
/* 80AF6E18  4B 54 54 D4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AF6E58  3D 20 80 AF */	lis r9, lit_3813@ha
/* 80AF6E5C  C0 29 74 20 */	lfs f1, lit_3813@l(r9)
/* 80AF6E60  39 20 00 00 */	li r9, 0
/* 80AF6E64  39 40 FF FF */	li r10, -1
/* 80AF6E68  4B 51 8D E4 */	b __ct__14mDoExt_McaMorfFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiiPvUlUl
...
/* 80AF6E98  4B 7D 7D B4 */	b __nw__FUl
/* 80AF6E9C  7C 7E 1B 79 */	or. r30, r3, r3
/* 80AF6EA0  41 82 00 20 */	beq lbl_80AF6EC0
/* 80AF6EA4  3C 80 80 AF */	lis r4, __vt__12J3DFrameCtrl@ha
/* 80AF6EA8  38 04 75 9C */	addi r0, r4, __vt__12J3DFrameCtrl@l
/* 80AF6EAC  90 1E 00 00 */	stw r0, 0(r30)
/* 80AF6EB0  38 80 00 00 */	li r4, 0
/* 80AF6EB4  4B 83 15 48 */	b init__12J3DFrameCtrlFs
...
lbl_80AF6ED8:
/* 80AF6ED8  3C 60 80 AF */	lis r3, stringBase0@ha
/* 80AF6EDC  38 63 74 A4 */	addi r3, r3, stringBase0@l
/* 80AF6EE0  38 80 00 14 */	li r4, 0x14
/* 80AF6EE4  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80AF6EE8  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 80AF6EEC  3C A5 00 02 */	addis r5, r5, 2
/* 80AF6EF0  38 C0 00 80 */	li r6, 0x80
/* 80AF6EF4  38 A5 C2 F8 */	addi r5, r5, -15624
/* 80AF6EF8  4B 54 53 F4 */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80AF6F1C  3D 00 80 AF */	lis r8, lit_3813@ha
/* 80AF6F20  C0 28 74 20 */	lfs f1, lit_3813@l(r8)
/* 80AF6F24  39 00 00 00 */	li r8, 0
/* 80AF6F28  39 20 FF FF */	li r9, -1
/* 80AF6F2C  4B 51 67 10 */	b init__13mDoExt_btkAnmFP16J3DMaterialTableP19J3DAnmTextureSRTKeyiifss
/* 80AF6F30  30 03 FF FF */	addic r0, r3, -1
/* 80AF6F34  7C 60 19 10 */	subfe r3, r0, r3
lbl_80AF6F38:
/* 80AF6F38  39 61 00 30 */	addi r11, r1, 0x30
/* 80AF6F3C  4B 86 B2 E8 */	b _restgpr_28

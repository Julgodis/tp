...
/* 80AF6B84  4B 86 B6 54 */	b _savegpr_28
/* 80AF6B88  7C 7E 1B 78 */	mr r30, r3
/* 80AF6B8C  3C 60 80 AF */	lis r3, lit_3768@ha
/* 80AF6B90  3B E3 74 08 */	addi r31, r3, lit_3768@l
/* 80AF6B94  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80AF740C */
...
/* 80AF6BE4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF6BE8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF6BEC  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)
/* 80AF6BF0  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)
/* 80AF6BF4  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)
/* 80AF6BF8  4B 84 FC F0 */	b PSMTXTrans
/* 80AF6BFC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF6C00  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF6C04  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80AF6C08  4B 51 58 2C */	b mDoMtx_YrotM__FPA4_fs
/* 80AF6C0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF6C10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF6C14  A8 9E 04 E4 */	lha r4, 0x4e4(r30)
/* 80AF6C18  4B 51 57 84 */	b mDoMtx_XrotM__FPA4_fs
/* 80AF6C1C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF6C20  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF6C24  A8 9E 04 E8 */	lha r4, 0x4e8(r30)
/* 80AF6C28  4B 51 58 A4 */	b mDoMtx_ZrotM__FPA4_fs
/* 80AF6C2C  3C 60 80 AF */	lis r3, l_HIO@ha
/* 80AF6C30  3B A3 75 D0 */	addi r29, r3, l_HIO@l
/* 80AF6C34  C0 3D 00 08 */	lfs f1, 8(r29)	/* effective address: 80AF75D8 */
/* 80AF6C38  FC 40 08 90 */	fmr f2, f1
/* 80AF6C3C  FC 60 08 90 */	fmr f3, f1
/* 80AF6C40  4B 51 61 F8 */	b scaleM__14mDoMtx_stack_cFfff
/* 80AF6C44  80 7E 06 1C */	lwz r3, 0x61c(r30)
/* 80AF6C48  83 83 00 04 */	lwz r28, 4(r3)
/* 80AF6C4C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF6C50  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF6C54  38 9C 00 24 */	addi r4, r28, 0x24
/* 80AF6C58  4B 84 F8 58 */	b PSMTXCopy
...
/* 80AF6C6C  4B 51 99 5C */	b play__14mDoExt_McaMorfFP3VecUlSc
...
/* 80AF6CA0  4B 51 9A 0C */	b modelCalc__14mDoExt_McaMorfFv
/* 80AF6CA4  80 7C 00 84 */	lwz r3, 0x84(r28)
/* 80AF6CA8  80 63 00 0C */	lwz r3, 0xc(r3)
/* 80AF6CAC  38 63 00 60 */	addi r3, r3, 0x60
/* 80AF6CB0  3C 80 80 45 */	lis r4, calc_mtx@ha
/* 80AF6CB4  38 84 07 68 */	addi r4, r4, calc_mtx@l
/* 80AF6CB8  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80450768 */
/* 80AF6CBC  4B 84 F7 F4 */	b PSMTXCopy
/* 80AF6CC0  38 61 00 08 */	addi r3, r1, 8
/* 80AF6CC4  38 9E 05 38 */	addi r4, r30, 0x538
/* 80AF6CC8  4B 77 A2 24 */	b MtxPosition__FP4cXyzP4cXyz
...
/* 80AF6D04  4B 77 89 44 */	b SetC__8cM3dGSphFRC4cXyz
...
/* 80AF6D18  4B 77 89 F0 */	b SetR__8cM3dGSphFf
/* 80AF6D1C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AF6D20  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AF6D24  38 63 23 3C */	addi r3, r3, 0x233c
/* 80AF6D28  38 9E 08 90 */	addi r4, r30, 0x890
/* 80AF6D2C  4B 76 DE 7C */	b Set__4cCcSFP8cCcD_Obj
...
/* 80AF6D40  4B 86 B4 E4 */	b _restgpr_28

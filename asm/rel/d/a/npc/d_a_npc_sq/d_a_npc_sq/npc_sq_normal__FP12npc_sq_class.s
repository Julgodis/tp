...
/* 80AF61C0 00000010  4B 86 C0 1C */	b _savegpr_29
/* 80AF61C4 00000014  7C 7E 1B 78 */	mr r30, r3
/* 80AF61C8 00000018  3C 80 80 AF */	lis r4, lit_3768@ha
/* 80AF61CC 0000001C  3B E4 74 08 */	addi r31, r4, lit_3768@l
/* 80AF61D0 00000020  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 80AF61D4 00000024  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l
/* 80AF61D8 00000028  83 A4 5D AC */	lwz r29, 0x5dac(r4)	/* effective address: 8040BF6C */
...
/* 80AF6208 00000004  C0 3F 00 1C */	lfs f1, 0x1c(r31)	/* effective address: 80AF7424 */
/* 80AF620C 00000008  38 A0 00 02 */	li r5, 2
/* 80AF6210 0000000C  C0 5F 00 18 */	lfs f2, 0x18(r31)	/* effective address: 80AF7420 */
...
/* 80AF623C 00000018  4B 77 A3 CC */	b cLib_addCalcAngleS2__FPssss
...
/* 80AF6254 00000030  C0 3F 00 00 */	lfs f1, 0(r31)	/* effective address: 80AF7408 */
/* 80AF6258 00000034  38 A0 00 02 */	li r5, 2
/* 80AF625C 00000038  C0 5F 00 18 */	lfs f2, 0x18(r31)	/* effective address: 80AF7420 */
/* 80AF6260 0000003C  4B FF FD B1 */	bl anm_init__FP12npc_sq_classifUcf
/* 80AF6264 00000040  C0 1F 00 20 */	lfs f0, 0x20(r31)	/* effective address: 80AF7428 */
/* 80AF6268 00000044  D0 1E 05 2C */	stfs f0, 0x52c(r30)
lbl_80AF626C:
/* 80AF626C 00000000  C0 1F 00 24 */	lfs f0, 0x24(r31)	/* effective address: 80AF742C */
/* 80AF6270 00000004  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80AF6274 00000008  C0 1F 00 28 */	lfs f0, 0x28(r31)	/* effective address: 80AF7430 */
/* 80AF6278 0000000C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 80AF627C 00000010  C0 1F 00 2C */	lfs f0, 0x2c(r31)	/* effective address: 80AF7434 */
...
/* 80AF6290 00000024  4B 85 0E 24 */	b PSVECSubtract
/* 80AF6294 00000028  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80AF740C */
...
/* 80AF62AC 00000040  4B 85 0E 8C */	b PSVECSquareMag
/* 80AF62B0 00000044  C0 1F 00 04 */	lfs f0, 4(r31)	/* effective address: 80AF740C */
...
/* 80AF62C0 00000008  C8 9F 00 30 */	lfd f4, 0x30(r31)	/* effective address: 80AF7438 */
/* 80AF62C4 0000000C  FC 44 00 32 */	fmul f2, f4, f0
/* 80AF62C8 00000010  C8 7F 00 38 */	lfd f3, 0x38(r31)	/* effective address: 80AF7440 */
...
lbl_80AF6310:
/* 80AF6310 00000000  C8 1F 00 40 */	lfd f0, 0x40(r31)	/* effective address: 80AF7448 */
/* 80AF6314 00000004  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 80AF6318 00000000  40 80 00 10 */	bge lbl_80AF6328
/* 80AF631C 00000004  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AF6320 00000008  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80AF638C 00000008  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AF6390 0000000C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80AF6394:
/* 80AF6394 00000000  C0 1F 00 48 */	lfs f0, 0x48(r31)	/* effective address: 80AF7450 */
...
/* 80AF63AC 00000004  4B 86 BE 7C */	b _restgpr_29

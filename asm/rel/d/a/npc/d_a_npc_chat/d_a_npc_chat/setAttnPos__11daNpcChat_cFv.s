...
/* 80982FBC  3C 60 80 98 */	lis r3, l_resMANa@ha
/* 80982FC0  3B C3 69 9C */	addi r30, r3, l_resMANa@l
...
/* 80983004  4B 7C F7 68 */	b setMtx__8daNpcF_cFv
...
/* 80983034  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80983038  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8098303C  4B 9C 34 74 */	b PSMTXCopy
/* 80983040  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80983044  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80983048  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 8098304C  D0 1F 08 E4 */	stfs f0, 0x8e4(r31)
/* 80983050  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80983054  D0 1F 08 E8 */	stfs f0, 0x8e8(r31)
/* 80983058  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 8098305C  D0 1F 08 EC */	stfs f0, 0x8ec(r31)
/* 80983060  38 81 00 08 */	addi r4, r1, 8
/* 80983064  38 BF 05 38 */	addi r5, r31, 0x538
/* 80983068  4B 9C 3D 04 */	b PSMTXMultVec
/* 8098306C  C0 1E 05 78 */	lfs f0, 0x578(r30)
/* 80983070  D0 01 00 08 */	stfs f0, 8(r1)
/* 80983074  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80983078  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8098307C  38 81 00 08 */	addi r4, r1, 8
/* 80983080  7C 85 23 78 */	mr r5, r4
/* 80983084  4B 9C 3C E8 */	b PSMTXMultVec
/* 80983088  38 7F 08 E4 */	addi r3, r31, 0x8e4
/* 8098308C  38 81 00 08 */	addi r4, r1, 8
/* 80983090  4B 8E DB E4 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80983094  B0 7F 09 02 */	sth r3, 0x902(r31)
/* 80983098  38 7F 08 E4 */	addi r3, r31, 0x8e4
/* 8098309C  38 81 00 08 */	addi r4, r1, 8
/* 809830A0  4B 8E DB 64 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 809830BC  4B 8E C1 20 */	b SetC__8cM3dGCylFRC4cXyz
/* 809830C0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809830C4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809830C8  38 63 23 3C */	addi r3, r3, 0x233c
/* 809830CC  38 9F 0C 9C */	addi r4, r31, 0xc9c
/* 809830D0  4B 8E 1A D8 */	b Set__4cCcSFP8cCcD_Obj

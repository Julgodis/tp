...
/* 8098251C  4B 9D FC BC */	b _savegpr_28
...
/* 80982578  3C 60 80 43 */	lis r3, g_env_light@ha
/* 8098257C  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80982580  38 80 00 04 */	li r4, 4
/* 80982584  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80982588  38 DD 01 0C */	addi r6, r29, 0x10c
/* 8098258C  4B 82 12 38 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80982590  48 00 00 1C */	b lbl_809825AC
lbl_80982594:
/* 80982594  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80982598  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 8098259C  38 80 00 00 */	li r4, 0
/* 809825A0  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 809825A4  38 DD 01 0C */	addi r6, r29, 0x10c
/* 809825A8  4B 82 12 1C */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_809825AC:
/* 809825AC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 809825B0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 809825B4  80 9C 00 04 */	lwz r4, 4(r28)
/* 809825B8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 809825BC  4B 82 27 E4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 809825DC  4B 6A D4 78 */	b dComIfGs_wolfeye_effect_check__Fv
...
/* 80982634  4B 68 AF B4 */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
lbl_80982638:
...
/* 80982650  4B 68 B0 88 */	b entry__13mDoExt_btkAnmFP16J3DMaterialTablef
lbl_80982654:
...
/* 8098266C  4B 68 B1 3C */	b entry__13mDoExt_brkAnmFP16J3DMaterialTablef
lbl_80982670:
...
/* 80982680  4B 69 AD AC */	b fopAcM_setEffectMtx__FPC10fopAc_ac_cPC12J3DModelData
lbl_80982684:
/* 80982684  88 1D 09 F4 */	lbz r0, 0x9f4(r29)
/* 80982688  28 00 00 00 */	cmplwi r0, 0
/* 8098268C  41 82 00 48 */	beq lbl_809826D4
/* 80982690  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80982694  38 83 61 C0 */	addi r4, r3, struct_804061C0+0x0@l
/* 80982698  80 04 5F 88 */	lwz r0, 0x5f88(r4)	/* effective address: 8040C148 */
/* 8098269C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 809826A0  3B C3 4A C8 */	addi r30, r3, j3dSys@l
/* 809826A4  90 1E 00 48 */	stw r0, 0x48(r30)	/* effective address: 80434B10 */
/* 809826A8  80 04 5F 8C */	lwz r0, 0x5f8c(r4)	/* effective address: 8040C14C */
/* 809826AC  90 1E 00 4C */	stw r0, 0x4c(r30)	/* effective address: 80434B14 */
/* 809826B0  80 7D 05 68 */	lwz r3, 0x568(r29)
/* 809826B4  4B 68 EB 0C */	b entryDL__16mDoExt_McaMorfSOFv
/* 809826B8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809826BC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809826C0  80 03 5F 80 */	lwz r0, 0x5f80(r3)	/* effective address: 8040C140 */
/* 809826C4  90 1E 00 48 */	stw r0, 0x48(r30)
/* 809826C8  80 03 5F 84 */	lwz r0, 0x5f84(r3)	/* effective address: 8040C144 */
/* 809826CC  90 1E 00 4C */	stw r0, 0x4c(r30)
/* 809826D0  48 00 00 0C */	b lbl_809826DC
lbl_809826D4:
/* 809826D4  80 7D 05 68 */	lwz r3, 0x568(r29)
/* 809826D8  4B 68 EA E8 */	b entryDL__16mDoExt_McaMorfSOFv
lbl_809826DC:
...
/* 809826F0  4B 9A D0 08 */	b removeTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern
lbl_809826F4:
...
/* 80982708  4B 9A D0 AC */	b removeTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey
lbl_8098270C:
...
/* 80982720  4B 9A D1 60 */	b removeTevRegAnimator__16J3DMaterialTableFP15J3DAnmTevRegKey
lbl_80982724:
/* 80982724  38 7D 04 D0 */	addi r3, r29, 0x4d0
/* 80982728  C0 3D 06 68 */	lfs f1, 0x668(r29)
/* 8098272C  3C 80 80 98 */	lis r4, lit_5078@ha
/* 80982730  C0 44 6F 58 */	lfs f2, lit_5078@l(r4)
/* 80982734  38 9D 06 C0 */	addi r4, r29, 0x6c0
/* 80982738  38 A0 00 00 */	li r5, 0
/* 8098273C  3C C0 80 98 */	lis r6, lit_4247@ha
/* 80982740  C0 66 6F 10 */	lfs f3, lit_4247@l(r6)
/* 80982744  3C C0 80 42 */	lis r6, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80982748  38 C6 48 D0 */	addi r6, r6, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 8098274C  4B 6A A9 68 */	b dComIfGd_setSimpleShadow__FP4cXyzffR13cBgS_PolyInfosfP9_GXTexObj
lbl_80982750:
...
/* 8098276C  4B 9D FA B8 */	b _restgpr_28

...
/* 80B3C298  4B 82 5F 40 */	b _savegpr_28
/* 80B3C29C  7C 7C 1B 78 */	mr r28, r3
/* 80B3C2A0  3C 60 80 B4 */	lis r3, m__21daNpcWrestler_Param_c@ha
/* 80B3C2A4  3B E3 16 DC */	addi r31, r3, m__21daNpcWrestler_Param_c@l
/* 80B3C2A8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B3C2AC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B3C2B0  83 C3 5D AC */	lwz r30, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 80B3C2B4  4B 64 53 8C */	b dCam_getBody__Fv
...
/* 80B3C2FC  4B 61 93 F8 */	b daNpcF_onTmpBit__FUl
/* 80B3C300  48 00 00 0C */	b lbl_80B3C30C
lbl_80B3C304:
/* 80B3C304  38 60 00 3E */	li r3, 0x3e
/* 80B3C308  4B 61 93 6C */	b daNpcF_onEvtBit__FUl
lbl_80B3C30C:
...
lbl_80B3C320:
/* 80B3C320  3C 60 80 45 */	lis r3, mAudioMgrPtr__10Z2AudioMgr@ha
/* 80B3C324  38 63 13 68 */	addi r3, r3, mAudioMgrPtr__10Z2AudioMgr@l
/* 80B3C328  80 63 00 00 */	lwz r3, 0(r3)	/* effective address: 80451368 */
/* 80B3C32C  38 63 03 D0 */	addi r3, r3, 0x3d0
/* 80B3C330  38 80 00 05 */	li r4, 5
/* 80B3C334  4B 77 5A C0 */	b changeSubBgmStatus__8Z2SeqMgrFl
...
/* 80B3C384  4B 4D F5 84 */	b fopAcM_orderPotentialEvent__FP10fopAc_ac_cUsUsUs
...
/* 80B3C3A0  4B 62 51 30 */	b Stop__9dCamera_cFv
/* 80B3C3A4  7F A3 EB 78 */	mr r3, r29
/* 80B3C3A8  38 80 00 02 */	li r4, 2
/* 80B3C3AC  4B 62 6C 60 */	b SetTrimSize__9dCamera_cFl
/* 80B3C3B0  38 61 00 98 */	addi r3, r1, 0x98
/* 80B3C3B4  7F A4 EB 78 */	mr r4, r29
/* 80B3C3B8  4B 64 5A E0 */	b Center__9dCamera_cFv
...
/* 80B3C3DC  4B 64 5A 88 */	b Eye__9dCamera_cFv
...
/* 80B3C4A8  4B 61 42 38 */	b remove__18daNpcF_ActorMngr_cFv
...
/* 80B3C4F0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B3C4F4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
/* 80B3C508  4B 53 35 1C */	b StartShock__12dVibration_cFii4cXyz
...
/* 80B3C538  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80B3C53C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80B3C540  4B 80 9F 70 */	b PSMTXCopy
/* 80B3C544  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B3C548  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B3C54C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80B3C550  D0 01 00 A4 */	stfs f0, 0xa4(r1)
/* 80B3C554  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80B3C558  D0 01 00 A8 */	stfs f0, 0xa8(r1)
/* 80B3C55C  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80B3C580  4B 4E 0A A0 */	b fopAcM_effSmokeSet1__FPUlPUlPC4cXyzPC5csXyzfPC12dKy_tevstr_ci
...
/* 80B3C5CC  4B 4D 07 98 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80B3C5D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B3C5D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B3C5D8  A8 9C 08 F2 */	lha r4, 0x8f2(r28)
/* 80B3C5DC  4B 4C FE 58 */	b mDoMtx_YrotM__FPA4_fs
...
lbl_80B3C620:
/* 80B3C620  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B3C624  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B3C628  38 9C 04 D0 */	addi r4, r28, 0x4d0
/* 80B3C62C  7C 85 23 78 */	mr r5, r4
/* 80B3C630  4B 80 A7 3C */	b PSMTXMultVec
...
/* 80B3C678  4B 73 34 40 */	b cLib_addCalcPos__FP4cXyzRC4cXyzfff
...
/* 80B3C694  4B 73 32 E8 */	b cLib_addCalc__FPfffff
...
/* 80B3C6B0  4B 73 32 CC */	b cLib_addCalc__FPfffff
...
/* 80B3C6FC  4B 4D 06 68 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80B3C700  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B3C704  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B3C708  A8 9E 04 E6 */	lha r4, 0x4e6(r30)
/* 80B3C70C  4B 4C FD 28 */	b mDoMtx_YrotM__FPA4_fs
/* 80B3C710  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80B3C714  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80B3C718  38 9C 0E 14 */	addi r4, r28, 0xe14
/* 80B3C71C  7C 85 23 78 */	mr r5, r4
/* 80B3C720  4B 80 A6 4C */	b PSMTXMultVec
...
/* 80B3C7C4  4B 73 31 B8 */	b cLib_addCalc__FPfffff
...
/* 80B3C83C  4B 64 43 DC */	b Reset__9dCamera_cF4cXyz4cXyz
/* 80B3C840  7F A3 EB 78 */	mr r3, r29
/* 80B3C844  4B 62 4C 68 */	b Start__9dCamera_cFv
/* 80B3C848  7F A3 EB 78 */	mr r3, r29
/* 80B3C84C  38 80 00 00 */	li r4, 0
/* 80B3C850  4B 62 67 BC */	b SetTrimSize__9dCamera_cFl
/* 80B3C854  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B3C858  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B3C85C  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B3C860  4B 50 5C 08 */	b reset__14dEvt_control_cFv
...
/* 80B3C87C  3C 60 80 B4 */	lis r3, lit_9717@ha
/* 80B3C880  38 83 2C 48 */	addi r4, r3, lit_9717@l
/* 80B3C884  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80B42C48 */
/* 80B3C888  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80B42C4C */
/* 80B3C88C  90 61 00 2C */	stw r3, 0x2c(r1)
/* 80B3C890  90 01 00 30 */	stw r0, 0x30(r1)
/* 80B3C894  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80B42C50 */
...
/* 80B3C8A8  4B 82 57 70 */	b __ptmf_test
...
/* 80B3C8C0  4B 82 57 C4 */	b __ptmf_scall
...
/* 80B3C8EC  4B 82 57 2C */	b __ptmf_test
...
/* 80B3C904  4B 82 57 80 */	b __ptmf_scall
/* 80B3C908  60 00 00 00 */	nop 
/* 80B3C90C  48 00 00 94 */	b lbl_80B3C9A0
lbl_80B3C910:
/* 80B3C910  3C 60 80 B4 */	lis r3, lit_9720@ha
/* 80B3C914  38 83 2C 54 */	addi r4, r3, lit_9720@l
/* 80B3C918  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80B42C54 */
/* 80B3C91C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80B42C58 */
/* 80B3C920  90 61 00 20 */	stw r3, 0x20(r1)
/* 80B3C924  90 01 00 24 */	stw r0, 0x24(r1)
/* 80B3C928  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80B42C5C */
...
/* 80B3C93C  4B 82 56 DC */	b __ptmf_test
...
/* 80B3C954  4B 82 57 30 */	b __ptmf_scall
...
/* 80B3C980  4B 82 56 98 */	b __ptmf_test
...
/* 80B3C998  4B 82 56 EC */	b __ptmf_scall
...
/* 80B3C9F0  4B 64 40 F0 */	b Set__9dCamera_cF4cXyz4cXyzfs
...
/* 80B3CA18  4B 82 58 0C */	b _restgpr_28

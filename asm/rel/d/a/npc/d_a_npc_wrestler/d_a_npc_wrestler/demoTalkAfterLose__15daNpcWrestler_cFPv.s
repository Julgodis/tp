...
/* 80B3D0D0  4B 82 51 0C */	b _savegpr_29
/* 80B3D0D4  7C 7D 1B 78 */	mr r29, r3
/* 80B3D0D8  3C 80 80 B4 */	lis r4, cNullVec__6Z2Calc@ha
/* 80B3D0DC  3B E4 1D F8 */	addi r31, r4, cNullVec__6Z2Calc@l
...
/* 80B3D114  4B 61 6C 08 */	b initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
lbl_80B3D15C:
/* 80B3D15C  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B3D160  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B3D164  88 04 4F AD */	lbz r0, 0x4fad(r4)	/* effective address: 8040B16D */
...
/* 80B3D188  4B 61 6B FC */	b talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80B3D19C  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D1A0  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D1E0  4B 61 65 38 */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80B3D1F4  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D1F8  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D248  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D24C  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D26C  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D270  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D290  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D294  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D2C4  4B 4D DE D8 */	b fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
...
/* 80B3D2E0  3C 60 80 B4 */	lis r3, lit_4418@ha
/* 80B3D2E4  C0 23 18 94 */	lfs f1, lit_4418@l(r3)
...
/* 80B3D320  4B 61 69 FC */	b initTalk__8daNpcF_cFiPP10fopAc_ac_c
...
lbl_80B3D334:
/* 80B3D334  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80B3D338  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80B3D33C  88 04 4F AD */	lbz r0, 0x4fad(r4)	/* effective address: 8040B16D */
...
/* 80B3D360  4B 61 6A 24 */	b talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 80B3D3A4  4B 61 65 B0 */	b changeEvent__8daNpcF_cFPcPcUsUs
...
/* 80B3D3CC  4B 82 4C 4C */	b __ptmf_test
...
/* 80B3D3E4  4B 82 4C A0 */	b __ptmf_scall
...
/* 80B3D410  4B 82 4C 08 */	b __ptmf_test
...
/* 80B3D428  4B 82 4C 5C */	b __ptmf_scall
...
/* 80B3D450  4B 61 62 C8 */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 80B3D464  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D468  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D4B8  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D4BC  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D4DC  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D4E0  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D500  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D504  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D534  4B 4D DC 68 */	b fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs
/* 80B3D538  48 00 00 30 */	b lbl_80B3D568
lbl_80B3D53C:
/* 80B3D53C  38 80 00 05 */	li r4, 5
/* 80B3D540  3C A0 80 B4 */	lis r5, lit_4799@ha
/* 80B3D544  C0 25 18 A4 */	lfs f1, lit_4799@l(r5)
...
/* 80B3D558  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B3D55C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B3D560  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80B3D564  4B 50 4F 04 */	b reset__14dEvt_control_cFv
lbl_80B3D568:
/* 80B3D568  7F C3 F3 78 */	mr r3, r30
/* 80B3D56C  39 61 00 40 */	addi r11, r1, 0x40
/* 80B3D570  4B 82 4C B8 */	b _restgpr_29

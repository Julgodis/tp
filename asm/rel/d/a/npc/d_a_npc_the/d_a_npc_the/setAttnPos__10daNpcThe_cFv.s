...
/* 80AFAEE0  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha
/* 80AFAEE4  3B E3 BE 0C */	addi r31, r3, m__16daNpcThe_Param_c@l
...
/* 80AFAF68  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AFAF6C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AFAF70  4B 84 B5 40 */	b PSMTXCopy
/* 80AFAF74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AFAF78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AFAF7C  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80AFAF80  D0 1E 08 E4 */	stfs f0, 0x8e4(r30)
/* 80AFAF84  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80AFAF88  D0 1E 08 E8 */	stfs f0, 0x8e8(r30)
/* 80AFAF8C  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80AFAF90  D0 1E 08 EC */	stfs f0, 0x8ec(r30)
/* 80AFAF94  38 81 00 30 */	addi r4, r1, 0x30
/* 80AFAF98  38 BE 05 38 */	addi r5, r30, 0x538
/* 80AFAF9C  4B 84 BD D0 */	b PSMTXMultVec
/* 80AFAFA0  C0 1F 00 7C */	lfs f0, 0x7c(r31)
/* 80AFAFA4  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 80AFAFA8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AFAFAC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AFAFB0  38 81 00 30 */	addi r4, r1, 0x30
/* 80AFAFB4  7C 85 23 78 */	mr r5, r4
/* 80AFAFB8  4B 84 BD B4 */	b PSMTXMultVec
/* 80AFAFBC  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80AFAFC0  38 81 00 30 */	addi r4, r1, 0x30
/* 80AFAFC4  4B 77 5C B0 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80AFAFC8  B0 7E 09 02 */	sth r3, 0x902(r30)
/* 80AFAFCC  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80AFAFD0  38 81 00 30 */	addi r4, r1, 0x30
/* 80AFAFD4  4B 77 5C 30 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80AFAFF0  4B 76 BB 44 */	b __mi__4cXyzCFRC3Vec
...
/* 80AFB020  4B 76 C6 54 */	b cM_atan2s__Fff
...
/* 80AFB04C  4B 84 C0 EC */	b PSVECSquareMag
...
/* 80AFB0BC  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AFB0C0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
...
/* 80AFB12C  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80AFB130  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)
/* 80AFB134  48 00 00 08 */	b lbl_80AFB13C
lbl_80AFB138:
/* 80AFB138  FC 40 08 90 */	fmr f2, f1
lbl_80AFB13C:
/* 80AFB13C  C0 21 00 28 */	lfs f1, 0x28(r1)
/* 80AFB140  4B 76 C5 34 */	b cM_atan2s__Fff
...
/* 80AFB194  4B 77 40 48 */	b SetC__8cM3dGCylFRC4cXyz
/* 80AFB198  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AFB19C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AFB1A0  38 63 23 3C */	addi r3, r3, 0x233c
/* 80AFB1A4  38 9E 0C 94 */	addi r4, r30, 0xc94
/* 80AFB1A8  4B 76 9A 00 */	b Set__4cCcSFP8cCcD_Obj
lbl_80AFB1AC:

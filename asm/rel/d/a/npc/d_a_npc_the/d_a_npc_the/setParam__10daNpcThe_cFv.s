...
/* 80AF9A04 00000010  4B 86 87 D4 */	b _savegpr_28
/* 80AF9A08 00000014  7C 7D 1B 78 */	mr r29, r3
/* 80AF9A0C 00000018  3C 60 80 B0 */	lis r3, cNullVec__6Z2Calc@ha
/* 80AF9A10 0000001C  3B E3 C1 D0 */	addi r31, r3, cNullVec__6Z2Calc@l
/* 80AF9A14 00000020  38 7D 0C 88 */	addi r3, r29, 0xc88
/* 80AF9A18 00000024  4B 65 6C D4 */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 80AF9A30 0000003C  4B 65 A8 70 */	b getEvtAreaTagP__8daNpcF_cFii
/* 80AF9A34 00000040  7C 64 1B 78 */	mr r4, r3
/* 80AF9A38 00000044  38 7D 0C 88 */	addi r3, r29, 0xc88
/* 80AF9A3C 00000048  4B 65 6C 80 */	b entry__18daNpcF_ActorMngr_cFP10fopAc_ac_c
lbl_80AF9A40:
...
/* 80AF9A58 00000018  3C 60 80 3A */	lis r3, __ptmf_null@ha
/* 80AF9A5C 0000001C  38 83 21 80 */	addi r4, r3, __ptmf_null@l
/* 80AF9A60 00000020  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 803A2180 */
/* 80AF9A64 00000024  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 803A2184 */
/* 80AF9A68 00000028  90 7D 0D D0 */	stw r3, 0xdd0(r29)
/* 80AF9A6C 0000002C  90 1D 0D D4 */	stw r0, 0xdd4(r29)
/* 80AF9A70 00000030  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 803A2188 */
/* 80AF9A74 00000034  90 1D 0D D8 */	stw r0, 0xdd8(r29)
/* 80AF9A78 00000038  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha
/* 80AF9A7C 0000003C  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l
/* 80AF9A80 00000040  88 03 00 6A */	lbz r0, 0x6a(r3)	/* effective address: 80AFBE76 */
/* 80AF9A84 00000044  28 00 00 00 */	cmplwi r0, 0
/* 80AF9A88 00000048  41 82 00 20 */	beq lbl_80AF9AA8
/* 80AF9A8C 0000004C  80 7F 02 F8 */	lwz r3, 0x2f8(r31)	/* effective address: 80AFC4C8 */
/* 80AF9A90 00000050  80 1F 02 FC */	lwz r0, 0x2fc(r31)	/* effective address: 80AFC4CC */
/* 80AF9A94 00000054  90 7D 0D D0 */	stw r3, 0xdd0(r29)
/* 80AF9A98 00000058  90 1D 0D D4 */	stw r0, 0xdd4(r29)
/* 80AF9A9C 0000005C  80 1F 03 00 */	lwz r0, 0x300(r31)	/* effective address: 80AFC4D0 */
...
/* 80AF9AB4 0000000C  80 7F 03 04 */	lwz r3, 0x304(r31)	/* effective address: 80AFC4D4 */
/* 80AF9AB8 00000010  80 1F 03 08 */	lwz r0, 0x308(r31)	/* effective address: 80AFC4D8 */
/* 80AF9ABC 00000014  90 7D 0D D0 */	stw r3, 0xdd0(r29)
/* 80AF9AC0 00000018  90 1D 0D D4 */	stw r0, 0xdd4(r29)
/* 80AF9AC4 0000001C  80 1F 03 0C */	lwz r0, 0x30c(r31)	/* effective address: 80AFC4DC */
/* 80AF9AC8 00000020  90 1D 0D D8 */	stw r0, 0xdd8(r29)
/* 80AF9ACC 00000024  48 00 00 1C */	b lbl_80AF9AE8
lbl_80AF9AD0:
/* 80AF9AD0 00000000  80 7F 03 10 */	lwz r3, 0x310(r31)	/* effective address: 80AFC4E0 */
/* 80AF9AD4 00000004  80 1F 03 14 */	lwz r0, 0x314(r31)	/* effective address: 80AFC4E4 */
/* 80AF9AD8 00000008  90 7D 0D D0 */	stw r3, 0xdd0(r29)
/* 80AF9ADC 0000000C  90 1D 0D D4 */	stw r0, 0xdd4(r29)
/* 80AF9AE0 00000010  80 1F 03 18 */	lwz r0, 0x318(r31)	/* effective address: 80AFC4E8 */
...
/* 80AF9AF0 00000008  4B 86 85 58 */	b __ptmf_cmpr
...
/* 80AF9B10 00000008  4B 65 6B A0 */	b initialize__18daNpcF_ActorMngr_cFv
...
lbl_80AF9B38:
/* 80AF9B38 00000000  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha
/* 80AF9B3C 00000004  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l
/* 80AF9B40 00000008  A8 03 00 4A */	lha r0, 0x4a(r3)	/* effective address: 80AFBE56 */
lbl_80AF9B44:
...
lbl_80AF9B58:
/* 80AF9B58 00000000  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha
/* 80AF9B5C 00000004  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l
/* 80AF9B60 00000008  A8 03 00 4E */	lha r0, 0x4e(r3)	/* effective address: 80AFBE5A */
lbl_80AF9B64:
...
/* 80AF9B70 0000000C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80AF9B74 00000010  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80AF9B78 00000014  3B 83 4E 00 */	addi r28, r3, 0x4e00
/* 80AF9B7C 00000018  7F 83 E3 78 */	mr r3, r28
/* 80AF9B80 0000001C  3C 80 80 B0 */	lis r4, stringBase0@ha
/* 80AF9B84 00000020  38 84 C1 58 */	addi r4, r4, stringBase0@l
/* 80AF9B88 00000024  38 84 00 54 */	addi r4, r4, 0x54
/* 80AF9B8C 00000028  4B 86 EE 08 */	b strcmp
/* 80AF9B90 0000002C  2C 03 00 00 */	cmpwi r3, 0
/* 80AF9B94 00000030  40 82 00 30 */	bne lbl_80AF9BC4
/* 80AF9B98 00000034  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 80AF9B9C 00000038  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80AF9BA0 0000003C  88 03 4E 0A */	lbz r0, 0x4e0a(r3)	/* effective address: 8040AFCA */
...
/* 80AF9BB0 0000004C  4B 53 2D CC */	b getLayerNo__14dComIfG_play_cFi
...
/* 80AF9BFC 00000004  3C 80 80 B0 */	lis r4, stringBase0@ha
/* 80AF9C00 00000008  38 84 C1 58 */	addi r4, r4, stringBase0@l
/* 80AF9C04 0000000C  38 84 00 54 */	addi r4, r4, 0x54
/* 80AF9C08 00000010  4B 86 ED 8C */	b strcmp
...
/* 80AF9C18 00000020  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha
/* 80AF9C1C 00000024  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l
/* 80AF9C20 00000028  A8 84 00 4C */	lha r4, 0x4c(r4)	/* effective address: 80AFBE58 */
/* 80AF9C24 0000002C  7F C5 F3 78 */	mr r5, r30
/* 80AF9C28 00000030  4B 65 A6 50 */	b getDistTableIdx__8daNpcF_cFii
...
/* 80AF9C3C 00000044  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha
/* 80AF9C40 00000048  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l
/* 80AF9C44 0000004C  A8 84 00 48 */	lha r4, 0x48(r4)	/* effective address: 80AFBE54 */
/* 80AF9C48 00000050  38 84 00 01 */	addi r4, r4, 1
/* 80AF9C4C 00000054  7F E5 FB 78 */	mr r5, r31
/* 80AF9C50 00000058  4B 65 A6 28 */	b getDistTableIdx__8daNpcF_cFii
...
/* 80AF9C60 00000004  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha
/* 80AF9C64 00000008  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l
/* 80AF9C68 0000000C  A8 84 00 4C */	lha r4, 0x4c(r4)	/* effective address: 80AFBE58 */
/* 80AF9C6C 00000010  7F C5 F3 78 */	mr r5, r30
/* 80AF9C70 00000014  4B 65 A6 08 */	b getDistTableIdx__8daNpcF_cFii
...
/* 80AF9C84 00000028  3C 80 80 B0 */	lis r4, m__16daNpcThe_Param_c@ha
/* 80AF9C88 0000002C  38 84 BE 0C */	addi r4, r4, m__16daNpcThe_Param_c@l
/* 80AF9C8C 00000030  A8 84 00 48 */	lha r4, 0x48(r4)	/* effective address: 80AFBE54 */
/* 80AF9C90 00000034  7F E5 FB 78 */	mr r5, r31
/* 80AF9C94 00000038  4B 65 A5 E4 */	b getDistTableIdx__8daNpcF_cFii
/* 80AF9C98 0000003C  98 7D 05 47 */	stb r3, 0x547(r29)
lbl_80AF9C9C:
/* 80AF9C9C 00000000  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha
/* 80AF9CA0 00000004  38 83 BE 0C */	addi r4, r3, m__16daNpcThe_Param_c@l
/* 80AF9CA4 00000008  C0 04 00 08 */	lfs f0, 8(r4)	/* effective address: 80AFBE14 */
...
/* 80AF9CB8 0000001C  C0 24 00 1C */	lfs f1, 0x1c(r4)	/* effective address: 80AFBE28 */
/* 80AF9CBC 00000020  4B 57 C2 84 */	b SetWallR__12dBgS_AcchCirFf
/* 80AF9CC0 00000024  3C 60 80 B0 */	lis r3, m__16daNpcThe_Param_c@ha
/* 80AF9CC4 00000028  38 63 BE 0C */	addi r3, r3, m__16daNpcThe_Param_c@l
/* 80AF9CC8 0000002C  C0 03 00 18 */	lfs f0, 0x18(r3)	/* effective address: 80AFBE24 */
/* 80AF9CCC 00000030  D0 1D 08 14 */	stfs f0, 0x814(r29)
/* 80AF9CD0 00000034  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80AFBE10 */
/* 80AF9CD4 00000038  D0 1D 05 30 */	stfs f0, 0x530(r29)
/* 80AF9CD8 0000003C  39 61 00 30 */	addi r11, r1, 0x30
/* 80AF9CDC 00000040  4B 86 85 48 */	b _restgpr_28

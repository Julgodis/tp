...
/* 80AA7F88  4B 8B A2 54 */	b _savegpr_29
/* 80AA7F8C  7C 7D 1B 78 */	mr r29, r3
/* 80AA7F90  3C 80 80 AB */	lis r4, lit_3963@ha
/* 80AA7F94  3B E4 8A 18 */	addi r31, r4, lit_3963@l
/* 80AA7F98  C0 1F 00 20 */	lfs f0, 0x20(r31)	/* effective address: 80AA8A38 */
...
/* 80AA7FB0  C0 3F 00 24 */	lfs f1, 0x24(r31)	/* effective address: 80AA8A3C */
/* 80AA7FB4  C0 5F 00 28 */	lfs f2, 0x28(r31)	/* effective address: 80AA8A40 */
/* 80AA7FB8  C0 7F 00 2C */	lfs f3, 0x2c(r31)	/* effective address: 80AA8A44 */
/* 80AA7FBC  C0 9F 00 30 */	lfs f4, 0x30(r31)	/* effective address: 80AA8A48 */
/* 80AA7FC0  C0 BF 00 34 */	lfs f5, 0x34(r31)	/* effective address: 80AA8A4C */
/* 80AA7FC4  C0 DF 00 38 */	lfs f6, 0x38(r31)	/* effective address: 80AA8A50 */
/* 80AA7FC8  4B 57 25 80 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
/* 80AA7FCC  80 BD 09 C4 */	lwz r5, 0x9c4(r29)
/* 80AA7FD0  2C 05 00 10 */	cmpwi r5, 0x10
/* 80AA7FD4  40 80 00 1C */	bge lbl_80AA7FF0
/* 80AA7FD8  3C 60 80 42 */	lis r3, l_Cd_HIO@ha
/* 80AA7FDC  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l
...
lbl_80AA7FF0:
/* 80AA7FF0  3C 60 80 42 */	lis r3, l_Cd_HIO@ha
/* 80AA7FF4  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l
...
/* 80AA8010  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA8014  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8028:
/* 80AA8028  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA802C  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
/* 80AA8030  1C 05 01 64 */	mulli r0, r5, 0x164
/* 80AA8034  7C 84 02 14 */	add r4, r4, r0
/* 80AA8038  C0 24 01 60 */	lfs f1, 0x160(r4)
lbl_80AA803C:
/* 80AA803C  4B 5C DF 1C */	b SetWall__12dBgS_AcchCirFff
...
/* 80AA8068  4B 5C E1 E0 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80AA8094  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AA8098  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80AA809C  3B C4 0F 38 */	addi r30, r4, 0xf38
/* 80AA80A0  7F C4 F3 78 */	mr r4, r30
/* 80AA80A4  4B 5C EA 08 */	b CrrPos__9dBgS_AcchFR4dBgS
/* 80AA80A8  7F A3 EB 78 */	mr r3, r29
/* 80AA80AC  4B 6A EC 70 */	b setEnvTevCol__9daNpcCd_cFv
/* 80AA80B0  7F A3 EB 78 */	mr r3, r29
/* 80AA80B4  4B 6A EC C4 */	b setRoomNo__9daNpcCd_cFv
...
/* 80AA80C8  4B 5D B7 98 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
...
/* 80AA80E0  3C 80 80 39 */	lis r4, m_cylDat__9daNpcCd_c@ha
/* 80AA80E4  38 84 2E 18 */	addi r4, r4, m_cylDat__9daNpcCd_c@l
/* 80AA80E8  4B 5D C7 CC */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80AA80FC  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA8100  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8114:
/* 80AA8114  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA8118  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
/* 80AA811C  1C 00 01 64 */	mulli r0, r0, 0x164
/* 80AA8120  7C 84 02 14 */	add r4, r4, r0
/* 80AA8124  C0 24 01 5C */	lfs f1, 0x15c(r4)
lbl_80AA8128:
/* 80AA8128  4B 7C 70 D8 */	b SetR__8cM3dGCylFf
...
/* 80AA813C  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA8140  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8154:
/* 80AA8154  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA8158  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
/* 80AA815C  1C 00 01 64 */	mulli r0, r0, 0x164
/* 80AA8160  7C 84 02 14 */	add r4, r4, r0
/* 80AA8164  C0 24 01 58 */	lfs f1, 0x158(r4)
lbl_80AA8168:
/* 80AA8168  4B 7C 70 90 */	b SetH__8cM3dGCylFf
...
/* 80AA8194  4B 6B 18 A4 */	b setPath__11PathTrace_cFiiiP4cXyzb
...
/* 80AA81B4  4B 56 79 C8 */	b setMorf__13mDoExt_morf_cFf
/* 80AA81B8  38 7D 06 34 */	addi r3, r29, 0x634
/* 80AA81BC  7F C4 F3 78 */	mr r4, r30
/* 80AA81C0  4B 5C E8 EC */	b CrrPos__9dBgS_AcchFR4dBgS
/* 80AA81C4  C0 1D 06 CC */	lfs f0, 0x6cc(r29)
/* 80AA81C8  D0 1D 04 D4 */	stfs f0, 0x4d4(r29)
/* 80AA81CC  D0 1D 0A 38 */	stfs f0, 0xa38(r29)
/* 80AA81D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA81D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AA81D8  C0 3D 04 D0 */	lfs f1, 0x4d0(r29)
/* 80AA81DC  C0 5D 0A 38 */	lfs f2, 0xa38(r29)
/* 80AA81E0  C0 7D 04 D8 */	lfs f3, 0x4d8(r29)
/* 80AA81E4  4B 89 E7 04 */	b PSMTXTrans
/* 80AA81E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA81EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AA81F0  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 80AA81F4  4B 56 42 40 */	b mDoMtx_YrotM__FPA4_fs
/* 80AA81F8  80 7D 05 8C */	lwz r3, 0x58c(r29)
/* 80AA81FC  80 83 00 04 */	lwz r4, 4(r3)
/* 80AA8200  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA8204  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AA8208  38 84 00 24 */	addi r4, r4, 0x24
/* 80AA820C  4B 89 E2 A4 */	b PSMTXCopy
/* 80AA8210  80 7D 05 8C */	lwz r3, 0x58c(r29)
/* 80AA8214  4B 56 8F D8 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 80AA8218  7F A3 EB 78 */	mr r3, r29
/* 80AA821C  80 9D 09 C4 */	lwz r4, 0x9c4(r29)
/* 80AA8220  4B 6A E1 A8 */	b setAttention__9daNpcCd_cFi
/* 80AA8224  39 61 00 20 */	addi r11, r1, 0x20
/* 80AA8228  4B 8B A0 00 */	b _restgpr_29

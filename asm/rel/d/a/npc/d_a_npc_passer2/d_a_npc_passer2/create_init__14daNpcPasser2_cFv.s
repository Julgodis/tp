...
/* 80AA7F90 00000018  3C 80 00 00 */	lis r4, lit_3963@ha
/* 80AA7F94 0000001C  3B E4 00 00 */	addi r31, r4, lit_3963@l
...
/* 80AA7FD8 00000060  3C 60 00 00 */	lis r3, l_Cd_HIO@ha
/* 80AA7FDC 00000064  38 63 00 00 */	addi r3, r3, l_Cd_HIO@l
...
lbl_80AA7FF0:
/* 80AA7FF0 00000000  3C 60 00 00 */	lis r3, l_Cd_HIO@ha
/* 80AA7FF4 00000004  38 63 00 00 */	addi r3, r3, l_Cd_HIO@l
...
/* 80AA8010 0000000C  3C 80 00 00 */	lis r4, l_Cd_HIO@ha
/* 80AA8014 00000010  38 84 00 00 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8028:
/* 80AA8028 00000000  3C 80 00 00 */	lis r4, l_Cd_HIO@ha
/* 80AA802C 00000004  38 84 00 00 */	addi r4, r4, l_Cd_HIO@l
...
/* 80AA8094 00000058  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 80AA8098 0000005C  38 84 00 00 */	addi r4, r4, g_dComIfG_gameInfo@l
...
/* 80AA80E0 000000A4  3C 80 00 00 */	lis r4, m_cylDat__9daNpcCd_c@ha
/* 80AA80E4 000000A8  38 84 00 00 */	addi r4, r4, m_cylDat__9daNpcCd_c@l
...
/* 80AA80FC 000000C0  3C 80 00 00 */	lis r4, l_Cd_HIO@ha
/* 80AA8100 000000C4  38 84 00 00 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8114:
/* 80AA8114 00000000  3C 80 00 00 */	lis r4, l_Cd_HIO@ha
/* 80AA8118 00000004  38 84 00 00 */	addi r4, r4, l_Cd_HIO@l
...
/* 80AA813C 00000014  3C 80 00 00 */	lis r4, l_Cd_HIO@ha
/* 80AA8140 00000018  38 84 00 00 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8154:
/* 80AA8154 00000000  3C 80 00 00 */	lis r4, l_Cd_HIO@ha
/* 80AA8158 00000004  38 84 00 00 */	addi r4, r4, l_Cd_HIO@l
...
/* 80AA81D0 00000024  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA81D4 00000028  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80AA81E8 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA81EC 00000040  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80AA8200 00000054  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA8204 00000058  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l

...
/* 80AA8314  4B 8B 9E C8 */	b _savegpr_29
...
/* 80AA8328  3C 60 80 42 */	lis r3, l_Cd_HIO@ha
/* 80AA832C  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l
...
lbl_80AA8340:
/* 80AA8340  3C 60 80 42 */	lis r3, l_Cd_HIO@ha
/* 80AA8344  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l
...
/* 80AA8368  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA836C  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
...
lbl_80AA8380:
/* 80AA8380  3C 80 80 42 */	lis r4, l_Cd_HIO@ha
/* 80AA8384  38 84 59 84 */	addi r4, r4, l_Cd_HIO@l
/* 80AA8388  1C 00 01 64 */	mulli r0, r0, 0x164
/* 80AA838C  7C 84 02 14 */	add r4, r4, r0
/* 80AA8390  C0 24 01 64 */	lfs f1, 0x164(r4)
lbl_80AA8394:
/* 80AA8394  4B 5C DB AC */	b SetWallR__12dBgS_AcchCirFf
...
/* 80AA83AC  3C 80 80 AB */	lis r4, lit_4450@ha
/* 80AA83B0  C0 44 8A 54 */	lfs f2, lit_4450@l(r4)
/* 80AA83B4  3C 80 80 AB */	lis r4, lit_4451@ha
/* 80AA83B8  C0 64 8A 58 */	lfs f3, lit_4451@l(r4)
/* 80AA83BC  4B 7C 76 80 */	b cLib_addCalc2__FPffff
/* 80AA83C0  7F E3 FB 78 */	mr r3, r31
/* 80AA83C4  4B 6A E9 F8 */	b animation__9daNpcCd_cFv
/* 80AA83C8  38 7F 09 AC */	addi r3, r31, 0x9ac
/* 80AA83CC  3B BF 04 D0 */	addi r29, r31, 0x4d0
/* 80AA83D0  7F A4 EB 78 */	mr r4, r29
/* 80AA83D4  4B 7C 6E 08 */	b SetC__8cM3dGCylFRC4cXyz
/* 80AA83D8  80 1F 04 A0 */	lwz r0, 0x4a0(r31)
/* 80AA83DC  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d
/* 80AA83E0  40 82 00 18 */	bne lbl_80AA83F8
/* 80AA83E4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AA83E8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AA83EC  38 63 23 3C */	addi r3, r3, 0x233c
/* 80AA83F0  38 9F 08 88 */	addi r4, r31, 0x888
/* 80AA83F4  4B 7B C7 B4 */	b Set__4cCcSFP8cCcD_Obj
lbl_80AA83F8:
/* 80AA83F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA83FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AA8400  C0 3D 00 00 */	lfs f1, 0(r29)
/* 80AA8404  C0 5E 00 00 */	lfs f2, 0(r30)
/* 80AA8408  C0 7F 04 D8 */	lfs f3, 0x4d8(r31)
/* 80AA840C  4B 89 E4 DC */	b PSMTXTrans
/* 80AA8410  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA8414  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AA8418  A8 9F 04 E6 */	lha r4, 0x4e6(r31)
/* 80AA841C  4B 56 40 18 */	b mDoMtx_YrotM__FPA4_fs
/* 80AA8420  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 80AA8424  80 83 00 04 */	lwz r4, 4(r3)
/* 80AA8428  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AA842C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AA8430  38 84 00 24 */	addi r4, r4, 0x24
/* 80AA8434  4B 89 E0 7C */	b PSMTXCopy
/* 80AA8438  80 7F 05 8C */	lwz r3, 0x58c(r31)
/* 80AA843C  4B 56 8D B0 */	b modelCalc__16mDoExt_McaMorfSOFv
/* 80AA8440  7F E3 FB 78 */	mr r3, r31
/* 80AA8444  80 9F 09 C4 */	lwz r4, 0x9c4(r31)
/* 80AA8448  4B 6A DF 80 */	b setAttention__9daNpcCd_cFi
...
/* 80AA84E0  4B 57 17 9C */	b fopAcM_delete__FP10fopAc_ac_c
lbl_80AA84E4:
/* 80AA84E4  38 60 00 01 */	li r3, 1
/* 80AA84E8  39 61 00 20 */	addi r11, r1, 0x20
/* 80AA84EC  4B 8B 9D 3C */	b _restgpr_29

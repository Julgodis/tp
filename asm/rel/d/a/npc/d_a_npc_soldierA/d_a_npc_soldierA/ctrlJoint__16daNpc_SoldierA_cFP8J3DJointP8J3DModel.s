...
/* 80AEFF38 00000024  3C 60 00 00 */	lis r3, lit_4472@ha
/* 80AEFF3C 00000028  38 83 00 00 */	addi r4, r3, lit_4472@l
...
/* 80AEFF74 00000060  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AEFF78 00000064  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80AEFF7C 00000068  4B FF F5 7D */	bl PSMTXCopy
/* 80AEFF80 0000006C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AEFF84 00000070  3B E3 00 00 */	addi r31, r3, now__14mDoMtx_stack_c@l
...
/* 80AEFFE8 000000D4  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AEFFEC 000000D8  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80AF001C 00000010  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80AF0020 00000014  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80AF0054 0000000C  3C C0 00 00 */	lis r6, m__22daNpc_SoldierA_Param_c@ha
/* 80AF0058 00000010  38 C6 00 00 */	addi r6, r6, m__22daNpc_SoldierA_Param_c@l
...
/* 80AF006C 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF0070 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80AF0084 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF0088 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80AF00A0 00000008  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF00A4 0000000C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80AF00B8 00000020  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF00BC 00000024  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF00C0 00000028  A8 9C 09 14 */	lha r4, 0x914(r28)
/* 80AF00C4 0000002C  4B FF F4 35 */	bl mDoMtx_ZrotM__FPA4_fs
lbl_80AF00C8:
/* 80AF00C8 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF00CC 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80AF00E0 00000018  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80AF00E4 0000001C  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80AF00E8 00000020  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80AF00EC 00000024  38 84 00 00 */	addi r4, r4, mCurrentMtx__6J3DSys@l

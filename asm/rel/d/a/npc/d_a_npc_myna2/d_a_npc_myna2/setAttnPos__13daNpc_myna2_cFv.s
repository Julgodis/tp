...
/* 80A84B7C  4B 8D D6 60 */	b _savegpr_29
/* 80A84B80  7C 7D 1B 78 */	mr r29, r3
/* 80A84B84  3C 60 80 A9 */	lis r3, lit_1109@ha
/* 80A84B88  3B C3 8A F8 */	addi r30, r3, lit_1109@l
/* 80A84B8C  3C 60 80 A9 */	lis r3, m__19daNpc_myna2_Param_c@ha
/* 80A84B90  3B E3 84 34 */	addi r31, r3, m__19daNpc_myna2_Param_c@l
/* 80A84B94  88 1E 00 5C */	lbz r0, 0x5c(r30)	/* effective address: 80A88B54 */
...
/* 80A84BBC  3C 80 80 A8 */	lis r4, __dt__4cXyzFv@ha
/* 80A84BC0  38 84 7B BC */	addi r4, r4, __dt__4cXyzFv@l
...
/* 80A84C00  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A84C04  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A84C08  4B 8C 18 A8 */	b PSMTXCopy
/* 80A84C0C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A84C10  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A84C14  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80A84C18  D0 1D 08 E4 */	stfs f0, 0x8e4(r29)
/* 80A84C1C  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80A84C20  D0 1D 08 E8 */	stfs f0, 0x8e8(r29)
/* 80A84C24  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
/* 80A84C28  D0 1D 08 EC */	stfs f0, 0x8ec(r29)
/* 80A84C2C  38 9E 00 60 */	addi r4, r30, 0x60
/* 80A84C30  38 BD 05 38 */	addi r5, r29, 0x538
/* 80A84C34  4B 8C 21 38 */	b PSMTXMultVec
/* 80A84C38  C0 1F 00 9C */	lfs f0, 0x9c(r31)
/* 80A84C3C  38 9E 00 60 */	addi r4, r30, 0x60
/* 80A84C40  D0 04 00 04 */	stfs f0, 4(r4)
/* 80A84C44  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A84C48  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A84C4C  38 A1 00 08 */	addi r5, r1, 8
/* 80A84C50  4B 8C 21 1C */	b PSMTXMultVec
/* 80A84C54  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 80A84C58  38 81 00 08 */	addi r4, r1, 8
/* 80A84C5C  4B 7E C0 18 */	b cLib_targetAngleX__FPC4cXyzPC4cXyz
/* 80A84C60  B0 7D 09 02 */	sth r3, 0x902(r29)
/* 80A84C64  38 7D 08 E4 */	addi r3, r29, 0x8e4
/* 80A84C68  38 81 00 08 */	addi r4, r1, 8
/* 80A84C6C  4B 7E BF 98 */	b cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80A84C88  4B 58 80 DC */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 80A84C8C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A84C90  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A84C94  A8 9D 08 F0 */	lha r4, 0x8f0(r29)
/* 80A84C98  A8 BD 08 F2 */	lha r5, 0x8f2(r29)
/* 80A84C9C  A8 DD 08 F4 */	lha r6, 0x8f4(r29)
/* 80A84CA0  4B 58 76 00 */	b mDoMtx_ZXYrotM__FPA4_fsss
/* 80A84CA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A84CA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A84CAC  38 81 00 14 */	addi r4, r1, 0x14
/* 80A84CB0  38 A1 00 20 */	addi r5, r1, 0x20
/* 80A84CB4  4B 8C 20 B8 */	b PSMTXMultVec
...
/* 80A84D30  4B 7E A4 AC */	b SetC__8cM3dGCylFRC4cXyz
...
/* 80A84D48  4B 7E A4 B0 */	b SetH__8cM3dGCylFf
...
/* 80A84D60  4B 7E A4 A0 */	b SetR__8cM3dGCylFf
/* 80A84D64  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A84D68  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A84D6C  38 63 23 3C */	addi r3, r3, 0x233c
/* 80A84D70  38 9D 0C 84 */	addi r4, r29, 0xc84
/* 80A84D74  4B 7D FE 34 */	b Set__4cCcSFP8cCcD_Obj
lbl_80A84D78:
...
/* 80A84D98  4B 8D D4 90 */	b _restgpr_29

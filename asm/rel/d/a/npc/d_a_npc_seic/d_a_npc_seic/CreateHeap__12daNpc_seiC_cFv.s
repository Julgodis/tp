...
/* 80AC7840 00000018  3C 60 00 00 */	lis r3, l_bmdData@ha
/* 80AC7844 0000001C  38 83 00 00 */	addi r4, r3, l_bmdData@l
/* 80AC7848 00000020  80 04 00 04 */	lwz r0, 4(r4)
/* 80AC784C 00000024  54 00 10 3A */	slwi r0, r0, 2
/* 80AC7850 00000028  3C 60 00 00 */	lis r3, l_resNameList@ha
/* 80AC7854 0000002C  38 63 00 00 */	addi r3, r3, l_resNameList@l
/* 80AC7858 00000030  7C 63 00 2E */	lwzx r3, r3, r0
/* 80AC785C 00000034  80 84 00 00 */	lwz r4, 0(r4)
/* 80AC7860 00000038  3C A0 00 00 */	lis r5, g_dComIfG_gameInfo@ha
/* 80AC7864 0000003C  38 A5 00 00 */	addi r5, r5, g_dComIfG_gameInfo@l
...
/* 80AC78BC 00000094  3D 20 00 00 */	lis r9, lit_4215@ha
/* 80AC78C0 00000098  C0 29 00 00 */	lfs f1, lit_4215@l(r9)
...
/* 80AC7938 00000028  3C A0 00 00 */	lis r5, lit_4089@ha
/* 80AC793C 0000002C  C0 25 00 00 */	lfs f1, lit_4089@l(r5)

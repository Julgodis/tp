...
/* 80AC7D68  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AC93AC */
/* 80AC7D6C  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AC93B0 */
/* 80AC7D70  90 81 00 14 */	stw r4, 0x14(r1)
/* 80AC7D74  90 01 00 18 */	stw r0, 0x18(r1)
/* 80AC7D78  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AC93B4 */
...
/* 80AC7DB0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AC7DB4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AC7DB8  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80AC7E10  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AC93B8 */
/* 80AC7E14  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AC93BC */
/* 80AC7E18  90 61 00 08 */	stw r3, 8(r1)
/* 80AC7E1C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AC7E20  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AC93C0 */

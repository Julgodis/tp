...
/* 80A07DD4  4B 95 A4 00 */	b _savegpr_27
/* 80A07DD8  7C 7B 1B 78 */	mr r27, r3
/* 80A07DDC  3C 80 80 A1 */	lis r4, m__18daNpcImpal_Param_c@ha
/* 80A07DE0  3B E4 C2 70 */	addi r31, r4, m__18daNpcImpal_Param_c@l
...
lbl_80A07E08:
/* 80A07E08  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A07E0C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A07E10  3B A3 0F 38 */	addi r29, r3, 0xf38
/* 80A07E14  3B DD 3E C8 */	addi r30, r29, 0x3ec8
/* 80A07E18  7F C3 F3 78 */	mr r3, r30
/* 80A07E1C  3C 80 80 A1 */	lis r4, struct_80A0C4C8+0x0@ha
/* 80A07E20  38 84 C4 C8 */	addi r4, r4, struct_80A0C4C8+0x0@l
/* 80A07E24  38 84 00 30 */	addi r4, r4, 0x30
/* 80A07E28  4B 96 0B 6C */	b strcmp
/* 80A07E2C  2C 03 00 00 */	cmpwi r3, 0
/* 80A07E30  40 82 00 20 */	bne lbl_80A07E50
/* 80A07E34  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A07E38  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A07E3C  38 63 09 58 */	addi r3, r3, 0x958
/* 80A07E40  38 80 00 61 */	li r4, 0x61
/* 80A07E44  4B 62 CA 1C */	b isSwitch__12dSv_memBit_cCFi
/* 80A07E48  2C 03 00 00 */	cmpwi r3, 0
/* 80A07E4C  40 82 00 3C */	bne lbl_80A07E88
lbl_80A07E50:
/* 80A07E50  7F C3 F3 78 */	mr r3, r30
/* 80A07E54  3C 80 80 A1 */	lis r4, struct_80A0C4C8+0x0@ha
/* 80A07E58  38 84 C4 C8 */	addi r4, r4, struct_80A0C4C8+0x0@l
/* 80A07E5C  38 84 00 38 */	addi r4, r4, 0x38
/* 80A07E60  4B 96 0B 34 */	b strcmp
/* 80A07E64  2C 03 00 00 */	cmpwi r3, 0
/* 80A07E68  40 82 00 28 */	bne lbl_80A07E90
/* 80A07E6C  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A07E70  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A07E74  38 63 09 58 */	addi r3, r3, 0x958
/* 80A07E78  38 80 00 61 */	li r4, 0x61
/* 80A07E7C  4B 62 C9 E4 */	b isSwitch__12dSv_memBit_cCFi
...
lbl_80A07E90:
/* 80A07E90  3C 60 80 A1 */	lis r3, l_arcNames@ha
/* 80A07E94  38 83 C6 C4 */	addi r4, r3, l_arcNames@l
/* 80A07E98  38 7B 0D CC */	addi r3, r27, 0xdcc
/* 80A07E9C  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 80A0C6C4 */
/* 80A07EA0  4B 62 50 1C */	b dComIfG_resLoad__FP30request_of_phase_process_classPCc
...
/* 80A07EBC  3C 80 80 A1 */	lis r4, createHeapCallBack__12daNpcImpal_cFP10fopAc_ac_c@ha
/* 80A07EC0  38 84 87 BC */	addi r4, r4, createHeapCallBack__12daNpcImpal_cFP10fopAc_ac_c@l
/* 80A07EC4  38 A0 3C E0 */	li r5, 0x3ce0
/* 80A07EC8  4B 61 25 E8 */	b fopAcM_entrySolidHeap__FP10fopAc_ac_cPFP10fopAc_ac_c_iUl
...
/* 80A07F18  4B 61 26 30 */	b fopAcM_setCullSizeBox__FP10fopAc_ac_cffffff
...
/* 80A07F30  4B 8B 86 00 */	b init__10Z2CreatureFP3VecP3VecUcUc
...
/* 80A07F44  4B 66 E0 14 */	b SetWall__12dBgS_AcchCirFff
...
/* 80A07F70  4B 66 E2 D8 */	b Set__9dBgS_AcchFP4cXyzP4cXyzP10fopAc_ac_ciP12dBgS_AcchCirP4cXyzP5csXyzP5csXyz
...
/* 80A07F94  4B 66 EB 18 */	b CrrPos__9dBgS_AcchFR4dBgS
...
/* 80A07FB8  4B 67 B8 A8 */	b Init__9dCcD_SttsFiiP10fopAc_ac_c
/* 80A07FBC  38 7B 0C 84 */	addi r3, r27, 0xc84
/* 80A07FC0  3C 80 80 3B */	lis r4, mCcDCyl__8daNpcF_c@ha
/* 80A07FC4  38 84 37 E0 */	addi r4, r4, mCcDCyl__8daNpcF_c@l
/* 80A07FC8  4B 67 C8 EC */	b Set__8dCcD_CylFRC11dCcD_SrcCyl
...
/* 80A0805C  4B 74 AD 28 */	b setEnvTevColor__8daNpcF_cFv
/* 80A08060  7F 63 DB 78 */	mr r3, r27
/* 80A08064  4B 74 AD 7C */	b setRoomNo__8daNpcF_cFv
/* 80A08068  80 7B 05 68 */	lwz r3, 0x568(r27)
/* 80A0806C  4B 60 91 80 */	b modelCalc__16mDoExt_McaMorfSOFv
...
/* 80A08084  3C 80 80 A1 */	lis r4, struct_80A0C4C8+0x0@ha
/* 80A08088  38 84 C4 C8 */	addi r4, r4, struct_80A0C4C8+0x0@l
/* 80A0808C  38 84 00 30 */	addi r4, r4, 0x30
/* 80A08090  4B 96 09 04 */	b strcmp
...
/* 80A080A4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A080A8  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A080AC  88 1B 04 BA */	lbz r0, 0x4ba(r27)
/* 80A080B0  7C 05 07 74 */	extsb r5, r0
/* 80A080B4  4B 62 D2 AC */	b isSwitch__10dSv_info_cCFii
/* 80A080B8  2C 03 00 00 */	cmpwi r3, 0
/* 80A080BC  41 82 00 20 */	beq lbl_80A080DC
/* 80A080C0  38 60 01 16 */	li r3, 0x116
/* 80A080C4  4B 74 D5 70 */	b daNpcF_chkEvtBit__FUl
/* 80A080C8  2C 03 00 00 */	cmpwi r3, 0
/* 80A080CC  40 82 00 10 */	bne lbl_80A080DC
/* 80A080D0  4B 74 DA 18 */	b daNpcF_clearMessageTmpBit__Fv
...
/* 80A080E4  4B 95 A1 3C */	b _restgpr_27

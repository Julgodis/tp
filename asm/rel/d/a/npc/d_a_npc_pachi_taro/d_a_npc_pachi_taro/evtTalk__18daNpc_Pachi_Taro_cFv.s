...
/* 80A9D4E4  3C 80 80 AA */	lis r4, lit_4815@ha
/* 80A9D4E8  38 A4 27 CC */	addi r5, r4, lit_4815@l
/* 80A9D4EC  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AA27CC */
/* 80A9D4F0  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AA27D0 */
/* 80A9D4F4  90 81 00 14 */	stw r4, 0x14(r1)
/* 80A9D4F8  90 01 00 18 */	stw r0, 0x18(r1)
/* 80A9D4FC  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AA27D4 */
...
/* 80A9D520  4B 8C 4B 64 */	b __ptmf_scall
...
/* 80A9D534  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A9D538  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A9D53C  3B C3 4E C8 */	addi r30, r3, 0x4ec8
/* 80A9D540  88 83 4F B5 */	lbz r4, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80A9D564  4B 5A B2 8C */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 80A9D57C  4B 5A 4E EC */	b reset__14dEvt_control_cFv
/* 80A9D580  38 60 00 01 */	li r3, 1
/* 80A9D584  48 00 00 34 */	b lbl_80A9D5B8
lbl_80A9D588:
/* 80A9D588  3C 60 80 AA */	lis r3, lit_4825@ha
/* 80A9D58C  38 83 27 D8 */	addi r4, r3, lit_4825@l
/* 80A9D590  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AA27D8 */
/* 80A9D594  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AA27DC */
/* 80A9D598  90 61 00 08 */	stw r3, 8(r1)
/* 80A9D59C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80A9D5A0  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AA27E0 */

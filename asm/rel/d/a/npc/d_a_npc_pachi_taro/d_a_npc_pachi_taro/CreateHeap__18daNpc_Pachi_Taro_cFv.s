...
/* 80A9C6AC  4B 8C 5B 20 */	b _savegpr_25
/* 80A9C6B0  7C 7F 1B 78 */	mr r31, r3
/* 80A9C6B4  3C 60 80 AA */	lis r3, m__24daNpc_Pachi_Taro_Param_c@ha
/* 80A9C6B8  3B A3 16 04 */	addi r29, r3, m__24daNpc_Pachi_Taro_Param_c@l
...
/* 80A9C6D4  3C 60 80 AA */	lis r3, l_bmdData@ha
/* 80A9C6D8  38 83 19 4C */	addi r4, r3, l_bmdData@l
/* 80A9C6DC  7C 64 2A 14 */	add r3, r4, r5
/* 80A9C6E0  80 03 00 04 */	lwz r0, 4(r3)
/* 80A9C6E4  54 00 10 3A */	slwi r0, r0, 2
/* 80A9C6E8  3C 60 80 AA */	lis r3, l_resNameList@ha
/* 80A9C6EC  38 63 19 CC */	addi r3, r3, l_resNameList@l
/* 80A9C6F0  7C 63 00 2E */	lwzx r3, r3, r0
/* 80A9C6F4  7C 84 28 2E */	lwzx r4, r4, r5
/* 80A9C6F8  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 80A9C6FC  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
...
/* 80A9C710  4B 59 FB DC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80A9C728  4B 83 25 24 */	b __nw__FUl
...
/* 80A9C770  4B 57 40 60 */	b __ct__16mDoExt_McaMorfSOFP12J3DModelDataP25mDoExt_McaMorfCallBack1_cP25mDoExt_McaMorfCallBack2_cP15J3DAnmTransformifiiP10Z2CreatureUlUl
...
/* 80A9C7A0  3C 60 80 AA */	lis r3, ctrlJointCallBack__18daNpc_Pachi_Taro_cFP8J3DJointi@ha
/* 80A9C7A4  38 83 CC E0 */	addi r4, r3, ctrlJointCallBack__18daNpc_Pachi_Taro_cFP8J3DJointi@l
...
/* 80A9C7D8  4B 83 24 74 */	b __nw__FUl
/* 80A9C7DC  7C 7B 1B 79 */	or. r27, r3, r3
/* 80A9C7E0  41 82 00 D0 */	beq lbl_80A9C8B0
/* 80A9C7E4  7F 7A DB 78 */	mr r26, r27
/* 80A9C7E8  3C 60 80 3D */	lis r3, __vt__14J3DMaterialAnm@ha
/* 80A9C7EC  38 03 EE 60 */	addi r0, r3, __vt__14J3DMaterialAnm@l
/* 80A9C7F0  90 1B 00 00 */	stw r0, 0(r27)
/* 80A9C7F4  38 7A 00 04 */	addi r3, r26, 4
/* 80A9C7F8  3C 80 80 AA */	lis r4, __ct__14J3DMatColorAnmFv@ha
/* 80A9C7FC  38 84 CB C0 */	addi r4, r4, __ct__14J3DMatColorAnmFv@l
/* 80A9C800  3C A0 80 AA */	lis r5, __dt__14J3DMatColorAnmFv@ha
/* 80A9C804  38 A5 CB 84 */	addi r5, r5, __dt__14J3DMatColorAnmFv@l
/* 80A9C808  38 C0 00 08 */	li r6, 8
/* 80A9C80C  38 E0 00 02 */	li r7, 2
/* 80A9C810  4B 8C 55 50 */	b __construct_array
/* 80A9C814  38 7A 00 14 */	addi r3, r26, 0x14
/* 80A9C818  3C 80 80 AA */	lis r4, __ct__12J3DTexMtxAnmFv@ha
/* 80A9C81C  38 84 CB 6C */	addi r4, r4, __ct__12J3DTexMtxAnmFv@l
/* 80A9C820  3C A0 80 AA */	lis r5, __dt__12J3DTexMtxAnmFv@ha
/* 80A9C824  38 A5 CB 30 */	addi r5, r5, __dt__12J3DTexMtxAnmFv@l
/* 80A9C828  38 C0 00 08 */	li r6, 8
/* 80A9C82C  38 E0 00 08 */	li r7, 8
/* 80A9C830  4B 8C 55 30 */	b __construct_array
/* 80A9C834  38 7A 00 54 */	addi r3, r26, 0x54
/* 80A9C838  3C 80 80 AA */	lis r4, __ct__11J3DTexNoAnmFv@ha
/* 80A9C83C  38 84 CB 0C */	addi r4, r4, __ct__11J3DTexNoAnmFv@l
/* 80A9C840  3C A0 80 AA */	lis r5, __dt__11J3DTexNoAnmFv@ha
/* 80A9C844  38 A5 CA C4 */	addi r5, r5, __dt__11J3DTexNoAnmFv@l
/* 80A9C848  38 C0 00 0C */	li r6, 0xc
/* 80A9C84C  38 E0 00 08 */	li r7, 8
/* 80A9C850  4B 8C 55 10 */	b __construct_array
/* 80A9C854  38 7A 00 B4 */	addi r3, r26, 0xb4
/* 80A9C858  3C 80 80 AA */	lis r4, __ct__14J3DTevColorAnmFv@ha
/* 80A9C85C  38 84 CA AC */	addi r4, r4, __ct__14J3DTevColorAnmFv@l
/* 80A9C860  3C A0 80 AA */	lis r5, __dt__14J3DTevColorAnmFv@ha
/* 80A9C864  38 A5 CA 70 */	addi r5, r5, __dt__14J3DTevColorAnmFv@l
/* 80A9C868  38 C0 00 08 */	li r6, 8
/* 80A9C86C  38 E0 00 04 */	li r7, 4
/* 80A9C870  4B 8C 54 F0 */	b __construct_array
/* 80A9C874  38 7A 00 D4 */	addi r3, r26, 0xd4
/* 80A9C878  3C 80 80 AA */	lis r4, __ct__15J3DTevKColorAnmFv@ha
/* 80A9C87C  38 84 CA 58 */	addi r4, r4, __ct__15J3DTevKColorAnmFv@l
/* 80A9C880  3C A0 80 AA */	lis r5, __dt__15J3DTevKColorAnmFv@ha
/* 80A9C884  38 A5 CA 1C */	addi r5, r5, __dt__15J3DTevKColorAnmFv@l
/* 80A9C888  38 C0 00 08 */	li r6, 8
/* 80A9C88C  38 E0 00 04 */	li r7, 4
/* 80A9C890  4B 8C 54 D0 */	b __construct_array
/* 80A9C894  7F 43 D3 78 */	mr r3, r26
/* 80A9C898  4B 88 FA 88 */	b initialize__14J3DMaterialAnmFv
/* 80A9C89C  3C 60 80 3B */	lis r3, __vt__15daNpcT_MatAnm_c@ha
/* 80A9C8A0  38 03 3B 6C */	addi r0, r3, __vt__15daNpcT_MatAnm_c@l
/* 80A9C8A4  90 1B 00 00 */	stw r0, 0(r27)
/* 80A9C8A8  7F 63 DB 78 */	mr r3, r27
/* 80A9C8AC  4B 6A 8E B8 */	b initialize__15daNpcT_MatAnm_cFv
lbl_80A9C8B0:
...
/* 80A9C8D4  3C 60 80 AA */	lis r3, l_bmdData@ha
/* 80A9C8D8  3B 83 19 4C */	addi r28, r3, l_bmdData@l
lbl_80A9C8DC:
...
/* 80A9C8FC  3C 60 80 AA */	lis r3, l_resNameList@ha
/* 80A9C900  38 63 19 CC */	addi r3, r3, l_resNameList@l
/* 80A9C904  7C 63 00 2E */	lwzx r3, r3, r0
/* 80A9C908  7F C5 F3 78 */	mr r5, r30
/* 80A9C90C  38 C0 00 80 */	li r6, 0x80
/* 80A9C910  4B 59 F9 DC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 80A9C930  4B 57 83 24 */	b mDoExt_J3DModel__create__FP12J3DModelDataUlUl
...
/* 80A9C974  4B 6A DA 14 */	b setFaceMotionAnm__8daNpcT_cFib
...
/* 80A9C9C4  4B 6A D9 C4 */	b setFaceMotionAnm__8daNpcT_cFib
...
/* 80A9CA08  4B 8C 58 10 */	b _restgpr_25

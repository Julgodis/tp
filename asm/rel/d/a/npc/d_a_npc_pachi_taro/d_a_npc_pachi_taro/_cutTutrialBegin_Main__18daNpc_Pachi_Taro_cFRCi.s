...
/* 80A9EB4C  4B 8C 36 90 */	b _savegpr_29
/* 80A9EB50  7C 7D 1B 78 */	mr r29, r3
/* 80A9EB54  7C 9E 23 78 */	mr r30, r4
/* 80A9EB58  3C 60 80 AA */	lis r3, lit_5507@ha
/* 80A9EB5C  38 83 17 28 */	addi r4, r3, lit_5507@l
/* 80A9EB60  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AA1728 */
/* 80A9EB64  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AA172C */
/* 80A9EB68  90 61 00 08 */	stw r3, 8(r1)
/* 80A9EB6C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80A9EB70  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AA1730 */
/* 80A9EB74  90 01 00 10 */	stw r0, 0x10(r1)
/* 80A9EB78  93 A1 00 08 */	stw r29, 8(r1)
/* 80A9EB7C  38 7D 0F 8C */	addi r3, r29, 0xf8c
/* 80A9EB80  4B 6A 6B 88 */	b getActorP__18daNpcT_ActorMngr_cFv
/* 80A9EB84  90 61 00 0C */	stw r3, 0xc(r1)
/* 80A9EB88  38 7D 0F 94 */	addi r3, r29, 0xf94
/* 80A9EB8C  4B 6A 6B 7C */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 80A9EBBC  4B 6A D0 BC */	b talkProc__8daNpcT_cFPiiPP10fopAc_ac_ci
...
/* 80A9EBD4  4B 7A B9 6C */	b getNowMsgNo__10dMsgFlow_cFv
...
/* 80A9EC00  4B 6A 6B 08 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 80A9EC2C  4B 6A 6A DC */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 80A9EC48  4B 8C 35 E0 */	b _restgpr_29

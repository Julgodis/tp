...
/* 8054C594  4B E1 5C 3C */	b _savegpr_26
/* 8054C598  7C 7D 1B 78 */	mr r29, r3
/* 8054C59C  3C 60 80 55 */	lis r3, lit_1109@ha
/* 8054C5A0  3B C3 F1 A0 */	addi r30, r3, lit_1109@l
/* 8054C5A4  3C 60 80 55 */	lis r3, m__21daNpc_Kakashi_Param_c@ha
/* 8054C5A8  3B E3 EA C4 */	addi r31, r3, m__21daNpc_Kakashi_Param_c@l
...
/* 8054C5DC  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054C5E0  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
...
/* 8054C618  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054C61C  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
...
/* 8054C654  3C 80 80 55 */	lis r4, __dt__4cXyzFv@ha
/* 8054C658  38 84 DD D0 */	addi r4, r4, __dt__4cXyzFv@l
...
/* 8054C6E8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8054C6EC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8054C6F0  4B DF 9D C0 */	b PSMTXCopy
/* 8054C6F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8054C6F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8054C6FC  38 9E 00 98 */	addi r4, r30, 0x98
/* 8054C700  38 A1 00 08 */	addi r5, r1, 8
/* 8054C704  4B DF A6 68 */	b PSMTXMultVec
/* 8054C708  38 7D 10 C4 */	addi r3, r29, 0x10c4
/* 8054C70C  38 81 00 08 */	addi r4, r1, 8
/* 8054C710  4B D2 2F 38 */	b SetC__8cM3dGSphFRC4cXyz
/* 8054C714  38 7D 10 C4 */	addi r3, r29, 0x10c4
/* 8054C718  C0 3F 00 E0 */	lfs f1, 0xe0(r31)
/* 8054C71C  4B D2 2F EC */	b SetR__8cM3dGSphFf
/* 8054C720  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8054C724  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8054C728  38 63 23 3C */	addi r3, r3, 0x233c
/* 8054C72C  38 9D 0F A0 */	addi r4, r29, 0xfa0
/* 8054C730  4B D1 84 78 */	b Set__4cCcSFP8cCcD_Obj
lbl_8054C734:
...
/* 8054C748  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8054C74C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8054C750  4B DF 9D 60 */	b PSMTXCopy
/* 8054C754  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8054C758  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8054C75C  38 9E 00 60 */	addi r4, r30, 0x60
/* 8054C760  38 A1 00 08 */	addi r5, r1, 8
/* 8054C764  4B DF A6 08 */	b PSMTXMultVec
...
/* 8054C778  4B D2 2E D0 */	b SetC__8cM3dGSphFRC4cXyz
/* 8054C77C  38 7D 11 FC */	addi r3, r29, 0x11fc
/* 8054C780  C0 3F 00 E0 */	lfs f1, 0xe0(r31)
/* 8054C784  4B D2 2F 84 */	b SetR__8cM3dGSphFf
/* 8054C788  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8054C78C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8054C790  3B 83 23 3C */	addi r28, r3, 0x233c
/* 8054C794  7F 83 E3 78 */	mr r3, r28
/* 8054C798  38 9D 10 D8 */	addi r4, r29, 0x10d8
/* 8054C79C  4B D1 84 0C */	b Set__4cCcSFP8cCcD_Obj
/* 8054C7A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8054C7A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8054C7A8  38 9E 00 7C */	addi r4, r30, 0x7c
/* 8054C7AC  38 A1 00 08 */	addi r5, r1, 8
/* 8054C7B0  4B DF A5 BC */	b PSMTXMultVec
...
/* 8054C868  4B BF F9 98 */	b daNpcT_chkActorInScreen__FP10fopAc_ac_cfffffffi
...
/* 8054C910  4B E1 59 0C */	b _restgpr_26

...
/* 8054C100  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 8054C104  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 8054C108  3B E3 4F F8 */	addi r31, r3, 0x4ff8
/* 8054C10C  7F E3 FB 78 */	mr r3, r31
/* 8054C110  3C 80 80 55 */	lis r4, struct_8054EBD0+0x0@ha
/* 8054C114  38 84 EB D0 */	addi r4, r4, struct_8054EBD0+0x0@l
/* 8054C118  38 84 01 9E */	addi r4, r4, 0x19e
/* 8054C11C  7F C5 F3 78 */	mr r5, r30
/* 8054C120  38 C0 FF FF */	li r6, -1
/* 8054C124  4B AF B9 F8 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 8054C13C  3C A0 80 55 */	lis r5, mCutNameList__15daNpc_Kakashi_c@ha
/* 8054C140  38 A5 EE F8 */	addi r5, r5, mCutNameList__15daNpc_Kakashi_c@l
/* 8054C144  38 C0 00 04 */	li r6, 4
/* 8054C148  38 E0 00 00 */	li r7, 0
/* 8054C14C  39 00 00 00 */	li r8, 0
/* 8054C150  4B AF BC C0 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 8054C164  3C A0 80 55 */	lis r5, mCutList__15daNpc_Kakashi_c@ha
/* 8054C168  38 05 EF 2C */	addi r0, r5, mCutList__15daNpc_Kakashi_c@l
/* 8054C16C  7D 80 32 14 */	add r12, r0, r6
/* 8054C170  4B E1 5F 14 */	b __ptmf_scall
...
/* 8054C188  4B AF BF F4 */	b cutEnd__16dEvent_manager_cFi
lbl_8054C18C:

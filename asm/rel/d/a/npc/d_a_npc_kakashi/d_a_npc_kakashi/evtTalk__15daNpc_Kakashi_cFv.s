...
/* 8054C050  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 8054EF88 */
/* 8054C054  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 8054EF8C */
/* 8054C058  90 81 00 14 */	stw r4, 0x14(r1)
/* 8054C05C  90 01 00 18 */	stw r0, 0x18(r1)
/* 8054C060  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 8054EF90 */
...
/* 8054C098  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 8054EF94 */
/* 8054C09C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 8054EF98 */
/* 8054C0A0  90 61 00 08 */	stw r3, 8(r1)
/* 8054C0A4  90 01 00 0C */	stw r0, 0xc(r1)
/* 8054C0A8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 8054EF9C */

...
/* 80A0CCE8  4B 95 54 E0 */	b _savegpr_24
/* 80A0CCEC  7C 7D 1B 78 */	mr r29, r3
/* 80A0CCF0  3C 60 80 A1 */	lis r3, lit_3849@ha
/* 80A0CCF4  3B C3 E0 14 */	addi r30, r3, lit_3849@l
...
/* 80A0CD38  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha
/* 80A0CD3C  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l
/* 80A0CD40  38 81 00 14 */	addi r4, r1, 0x14
/* 80A0CD44  4B 60 CA B4 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80A0CD68  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A0CD6C  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A0CD70  4B 93 97 40 */	b PSMTXCopy
...
/* 80A0CDA8  4B 5F FF F4 */	b transM__14mDoMtx_stack_cFfff
/* 80A0CDAC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0CDB0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0CDB4  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80A0CDB8  D0 1D 05 B4 */	stfs f0, 0x5b4(r29)
/* 80A0CDBC  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80A0CDC0  D0 1D 05 B8 */	stfs f0, 0x5b8(r29)
/* 80A0CDC4  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80A0CDDC  4B 86 38 2C */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0CDF0  4B 86 38 18 */	b cLib_addCalcAngleS2__FPssss
/* 80A0CDF4  48 00 00 78 */	b lbl_80A0CE6C
lbl_80A0CDF8:
/* 80A0CDF8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0CDFC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0CE00  A8 9D 05 9A */	lha r4, 0x59a(r29)
/* 80A0CE04  4B 5F F6 30 */	b mDoMtx_YrotM__FPA4_fs
/* 80A0CE08  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80A0CE0C  C0 5D 05 E8 */	lfs f2, 0x5e8(r29)
/* 80A0CE10  C0 7E 00 10 */	lfs f3, 0x10(r30)
/* 80A0CE14  4B 5F FF 88 */	b transM__14mDoMtx_stack_cFfff
/* 80A0CE18  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0CE1C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0CE20  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 80A0CE24  D0 1D 05 B4 */	stfs f0, 0x5b4(r29)
/* 80A0CE28  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 80A0CE2C  D0 1D 05 B8 */	stfs f0, 0x5b8(r29)
/* 80A0CE30  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 80A0CE54  4B 86 37 B4 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0CE68  4B 86 37 A0 */	b cLib_addCalcAngleS2__FPssss
lbl_80A0CE6C:
...
/* 80A0CE88  4B 85 AA CC */	b cM_rndF__Ff
...
/* 80A0CEA8  4B 85 AA E4 */	b cM_rndFX__Ff
...
/* 80A0CEBC  4B 85 AA D0 */	b cM_rndFX__Ff
...
/* 80A0CF00  4B 86 2B 3C */	b cLib_addCalc2__FPffff
...
/* 80A0CF44  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80A0CF48  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80A0CFF4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A0CFF8  38 84 61 C0 */	addi r4, r4, struct_804061C0+0x0@l
/* 80A0CFFC  80 84 5D AC */	lwz r4, 0x5dac(r4)	/* effective address: 8040BF6C */
/* 80A0D000  4B 60 D7 10 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A0D024  4B 85 A9 30 */	b cM_rndF__Ff
...
/* 80A0D050  4B 85 A9 04 */	b cM_rndF__Ff
...
/* 80A0D0A0  4B 85 A8 B4 */	b cM_rndF__Ff
...
/* 80A0D0C0  4B 85 A8 CC */	b cM_rndFX__Ff
...
/* 80A0D0EC  4B 85 A8 68 */	b cM_rndF__Ff
...
/* 80A0D120  4B 85 A8 34 */	b cM_rndF__Ff
...
/* 80A0D144  4B 85 A8 10 */	b cM_rndF__Ff
...
/* 80A0D170  4B 85 A7 E4 */	b cM_rndF__Ff
...
/* 80A0D1D0  4B 85 A7 BC */	b cM_rndFX__Ff
...
/* 80A0D208  4B 85 A7 4C */	b cM_rndF__Ff
...
/* 80A0D25C  4B 86 27 E0 */	b cLib_addCalc2__FPffff
...
/* 80A0D290  4B 85 A6 C4 */	b cM_rndF__Ff
...
/* 80A0D2B0  4B 85 A6 A4 */	b cM_rndF__Ff
...
/* 80A0D334  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha
/* 80A0D338  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l
...
/* 80A0D390  4B 86 26 AC */	b cLib_addCalc2__FPffff
...
/* 80A0D3A4  4B 86 26 98 */	b cLib_addCalc2__FPffff
...
/* 80A0D440  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80A0D444  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80A0D4B0  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80A0D4B4  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80A0D4B8:
...
/* 80A0D508  4B 85 A4 4C */	b cM_rndF__Ff
...
/* 80A0D560  4B 85 A3 F4 */	b cM_rndF__Ff
...
/* 80A0D5A8  4B 86 24 94 */	b cLib_addCalc2__FPffff
...
/* 80A0D5BC  4B 86 24 80 */	b cLib_addCalc2__FPffff
...
/* 80A0D658  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80A0D65C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
...
/* 80A0D6C8  3C 60 80 45 */	lis r3, __float_nan@ha
/* 80A0D6CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
lbl_80A0D6D0:
...
/* 80A0D6E8  4B 85 A2 6C */	b cM_rndF__Ff
...
/* 80A0D708  4B 85 A2 4C */	b cM_rndF__Ff
...
/* 80A0D770  4B 86 2E 98 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0D784  4B 86 2E 84 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0D798  4B 86 2E 70 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0D7AC  4B 85 A1 A8 */	b cM_rndF__Ff
...
/* 80A0D7CC  4B 85 A1 C0 */	b cM_rndFX__Ff
...
/* 80A0D7E4  4B 85 A1 A8 */	b cM_rndFX__Ff
...
/* 80A0D7FC  4B 85 A1 90 */	b cM_rndFX__Ff
...
/* 80A0D834  4B 85 A1 20 */	b cM_rndF__Ff
...
/* 80A0D860  4B 85 A0 F4 */	b cM_rndF__Ff
...
/* 80A0D8D4  4B 86 2D 34 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0D908  4B 85 A0 84 */	b cM_rndFX__Ff
...
/* 80A0D924  4B 85 A0 30 */	b cM_rndF__Ff
...
/* 80A0D954  4B 86 2C B4 */	b cLib_addCalcAngleS2__FPssss
...
/* 80A0D968  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0D96C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80A0D980  4B 93 8F 68 */	b PSMTXTrans
/* 80A0D984  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0D988  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0D98C  A8 1D 04 E6 */	lha r0, 0x4e6(r29)
/* 80A0D990  7C 00 DA 14 */	add r0, r0, r27
/* 80A0D994  7C 04 07 34 */	extsh r4, r0
/* 80A0D998  4B 5F EA 9C */	b mDoMtx_YrotM__FPA4_fs
/* 80A0D99C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0D9A0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0D9A4  A8 1D 04 E4 */	lha r0, 0x4e4(r29)
/* 80A0D9A8  7C 00 E2 14 */	add r0, r0, r28
/* 80A0D9AC  7C 04 07 34 */	extsh r4, r0
/* 80A0D9B0  4B 5F E9 EC */	b mDoMtx_XrotM__FPA4_fs
/* 80A0D9B4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0D9B8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0D9BC  A8 9D 04 E8 */	lha r4, 0x4e8(r29)
/* 80A0D9C0  4B 5F EB 0C */	b mDoMtx_ZrotM__FPA4_fs
/* 80A0D9C4  C0 3E 00 00 */	lfs f1, 0(r30)
/* 80A0D9C8  FC 40 08 90 */	fmr f2, f1
/* 80A0D9CC  C0 7E 00 A4 */	lfs f3, 0xa4(r30)
/* 80A0D9D0  4B 5F F3 CC */	b transM__14mDoMtx_stack_cFfff
/* 80A0D9D4  80 7D 05 F0 */	lwz r3, 0x5f0(r29)
/* 80A0D9D8  80 83 00 04 */	lwz r4, 4(r3)
/* 80A0D9DC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A0D9E0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A0D9E4  38 84 00 24 */	addi r4, r4, 0x24
/* 80A0D9E8  4B 93 8A C8 */	b PSMTXCopy
...
/* 80A0D9FC  4B 60 2B CC */	b play__14mDoExt_McaMorfFP3VecUlSc
/* 80A0DA00  80 7D 05 F0 */	lwz r3, 0x5f0(r29)
/* 80A0DA04  4B 60 2C A8 */	b modelCalc__14mDoExt_McaMorfFv
/* 80A0DA08  88 1D 04 E2 */	lbz r0, 0x4e2(r29)
/* 80A0DA0C  7C 03 07 74 */	extsb r3, r0
/* 80A0DA10  4B 61 F6 5C */	b dComIfGp_getReverb__Fi
...
/* 80A0DA34  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80A0DA38  3B 84 61 C0 */	addi r28, r4, struct_804061C0+0x0@l
/* 80A0DA3C  80 9C 5D AC */	lwz r4, 0x5dac(r28)	/* effective address: 8040BF6C */
/* 80A0DA40  4B 60 CF 24 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A0DA58  4B 75 1A 98 */	b setLookPos__9daPy_py_cFP4cXyz
lbl_80A0DA5C:
...
/* 80A0DA88  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 80A0DA8C  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 80A0DA90  38 81 00 0A */	addi r4, r1, 0xa
/* 80A0DA94  4B 60 BD 64 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
/* 80A0DAA8  3C 60 80 45 */	lis r3, struct_80450C9C+0x1@ha
/* 80A0DAAC  8C 03 0C 9D */	lbzu r0, struct_80450C9C+0x1@l(r3)
/* 80A0DAB0  60 00 00 40 */	ori r0, r0, 0x40
/* 80A0DAB4  98 03 00 00 */	stb r0, 0(r3)	/* effective address: 80450000 */
lbl_80A0DAB8:
...
/* 80A0DAD4  4B 83 C8 04 */	b doFlow__10dMsgFlow_cFP10fopAc_ac_cPP10fopAc_ac_ci
/* 80A0DAD8  2C 03 00 00 */	cmpwi r3, 0
/* 80A0DADC  41 82 00 1C */	beq lbl_80A0DAF8
/* 80A0DAE0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A0DAE4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A0DAE8  38 63 4E C8 */	addi r3, r3, 0x4ec8
/* 80A0DAEC  4B 63 49 7C */	b reset__14dEvt_control_cFv
...
lbl_80A0DB00:
/* 80A0DB00  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A0DB04  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A0DB08  88 03 4F AD */	lbz r0, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 80A0DB2C  4B 85 9E 28 */	b cM_rndF__Ff
...
/* 80A0DB48  3C 60 80 02 */	lis r3, fpcSch_JudgeForPName__FPvPv@ha
/* 80A0DB4C  38 63 35 78 */	addi r3, r3, fpcSch_JudgeForPName__FPvPv@l
/* 80A0DB50  38 81 00 08 */	addi r4, r1, 8
/* 80A0DB54  4B 60 BC A4 */	b fopAcIt_Judge__FPFPvPv_PvPv
...
lbl_80A0DB6C:
/* 80A0DB6C  3C 60 80 45 */	lis r3, struct_80450C9C+0x1@ha
/* 80A0DB70  88 03 0C 9D */	lbz r0, struct_80450C9C+0x1@l(r3)
...
/* 80A0DBB8  4B 83 C3 D8 */	b init__10dMsgFlow_cFP10fopAc_ac_ciiPP10fopAc_ac_c
/* 80A0DBBC  38 00 00 01 */	li r0, 1
/* 80A0DBC0  98 1D 05 F4 */	stb r0, 0x5f4(r29)
/* 80A0DBC4  3C 60 80 45 */	lis r3, struct_80450C9C+0x1@ha
/* 80A0DBC8  38 83 0C 9D */	addi r4, r3, struct_80450C9C+0x1@l
/* 80A0DBCC  88 64 00 00 */	lbz r3, 0(r4)	/* effective address: 80450C9D */
/* 80A0DBD0  38 03 00 01 */	addi r0, r3, 1
/* 80A0DBD4  98 04 00 00 */	stb r0, 0(r4)	/* effective address: 80450C9D */
/* 80A0DBD8  54 00 06 3E */	clrlwi r0, r0, 0x18
/* 80A0DBDC  70 00 00 C3 */	andi. r0, r0, 0xc3
/* 80A0DBE0  98 04 00 00 */	stb r0, 0(r4)	/* effective address: 80450C9D */
lbl_80A0DBE4:
...
/* 80A0DC00  3C 60 80 45 */	lis r3, struct_80450C9C+0x1@ha
/* 80A0DC04  88 03 0C 9D */	lbz r0, struct_80450C9C+0x1@l(r3)
...
/* 80A0DC3C  4B 60 CA D4 */	b fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c
...
/* 80A0DC78  3C 60 80 3E */	lis r3, m_cpadInfo__8mDoCPd_c@ha
/* 80A0DC7C  38 63 D2 E8 */	addi r3, r3, m_cpadInfo__8mDoCPd_c@l
/* 80A0DC80  80 03 00 34 */	lwz r0, 0x34(r3)	/* effective address: 803DD31C */
/* 80A0DC84  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17
/* 80A0DC88  41 82 00 24 */	beq lbl_80A0DCAC
lbl_80A0DC8C:
/* 80A0DC8C  C0 3E 00 60 */	lfs f1, 0x60(r30)
/* 80A0DC90  4B 85 9C C4 */	b cM_rndF__Ff
...
/* 80A0DD5C  4B 95 44 B8 */	b _restgpr_24

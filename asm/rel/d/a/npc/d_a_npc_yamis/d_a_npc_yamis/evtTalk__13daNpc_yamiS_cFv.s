...
/* 80B47454  3C 80 80 B5 */	lis r4, lit_4588@ha
/* 80B47458  38 A4 98 E0 */	addi r5, r4, lit_4588@l
/* 80B4745C  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80B498E0 */
/* 80B47460  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80B498E4 */
/* 80B47464  90 81 00 14 */	stw r4, 0x14(r1)
/* 80B47468  90 01 00 18 */	stw r0, 0x18(r1)
/* 80B4746C  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80B498E8 */
...
/* 80B47490  4B 81 AB F4 */	b __ptmf_scall
/* 80B47494  60 00 00 00 */	nop 
/* 80B47498  48 00 00 74 */	b lbl_80B4750C
lbl_80B4749C:
/* 80B4749C  38 00 00 00 */	li r0, 0
/* 80B474A0  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B474A4  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B474A8  88 63 4F B5 */	lbz r3, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80B474C8  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80B474CC  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80B474D0  38 63 4F F8 */	addi r3, r3, 0x4ff8
/* 80B474D4  4B 50 13 1C */	b ChkPresentEnd__16dEvent_manager_cFv
/* 80B474D8  2C 03 00 00 */	cmpwi r3, 0
/* 80B474DC  41 82 00 30 */	beq lbl_80B4750C
lbl_80B474E0:
/* 80B474E0  3C 60 80 B5 */	lis r3, lit_4596@ha
/* 80B474E4  38 83 98 EC */	addi r4, r3, lit_4596@l
/* 80B474E8  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80B498EC */
/* 80B474EC  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80B498F0 */
/* 80B474F0  90 61 00 08 */	stw r3, 8(r1)
/* 80B474F4  90 01 00 0C */	stw r0, 0xc(r1)
/* 80B474F8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80B498F4 */

...
/* 809B1E08  3C 60 80 9C */	lis r3, data_809B93D0@ha
/* 809B1E0C  38 83 93 D0 */	addi r4, r3, data_809B93D0@l
/* 809B1E10  7C 64 FA 14 */	add r3, r4, r31
/* 809B1E14  80 03 00 08 */	lwz r0, 8(r3)
/* 809B1E18  54 00 10 3A */	slwi r0, r0, 2
/* 809B1E1C  3C 60 80 9C */	lis r3, l_resNameList@ha
/* 809B1E20  38 63 95 F8 */	addi r3, r3, l_resNameList@l
/* 809B1E24  7C 63 00 2E */	lwzx r3, r3, r0
/* 809B1E28  7C 84 F8 2E */	lwzx r4, r4, r31
/* 809B1E2C  3C A0 80 40 */	lis r5, struct_804061C0+0x0@ha
/* 809B1E30  38 A5 61 C0 */	addi r5, r5, struct_804061C0+0x0@l
/* 809B1E34  3C A5 00 02 */	addis r5, r5, 2
/* 809B1E38  38 C0 00 80 */	li r6, 0x80
/* 809B1E3C  38 A5 C2 F8 */	addi r5, r5, -15624
/* 809B1E40  4B 68 A4 AC */	b getRes__14dRes_control_cFPCclP11dRes_info_ci
...
/* 809B1E6C  3C E0 80 9C */	lis r7, data_809B93D0@ha
/* 809B1E70  38 07 93 D0 */	addi r0, r7, data_809B93D0@l
/* 809B1E74  7C E0 FA 14 */	add r7, r0, r31
/* 809B1E78  80 E7 00 04 */	lwz r7, 4(r7)
/* 809B1E7C  3D 00 80 9C */	lis r8, lit_3916@ha
/* 809B1E80  C0 28 93 78 */	lfs f1, lit_3916@l(r8)
/* 809B1E84  39 00 00 00 */	li r8, 0
/* 809B1E88  39 20 FF FF */	li r9, -1
/* 809B1E8C  4B 65 B8 80 */	b init__13mDoExt_brkAnmFP16J3DMaterialTableP15J3DAnmTevRegKeyiifss
lbl_809B1E90:

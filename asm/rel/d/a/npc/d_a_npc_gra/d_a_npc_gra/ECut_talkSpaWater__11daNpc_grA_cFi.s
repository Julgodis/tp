...
/* 809C6624 0000001C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 809C6628 00000020  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 809C663C 00000034  3C A0 00 00 */	lis r5, struct_809CA4B8+0x0@ha /* 809CA4B8 */
/* 809C6640 00000038  38 A5 00 00 */	addi r5, r5, struct_809CA4B8+0x0@l /* 809CA4B8 */
...
/* 809C66B0 00000010  3C 60 00 00 */	lis r3, lit_4611@ha /* 809C9E34 */
/* 809C66B4 00000014  C0 03 00 00 */	lfs f0, lit_4611@l(r3) /* 809C9E34 */
/* 809C66B8 00000018  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 809C66BC 0000001C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 809C66C0 00000020  3C 60 00 00 */	lis r3, lit_7629@ha /* 809CA4A0 */
/* 809C66C4 00000024  C0 03 00 00 */	lfs f0, lit_7629@l(r3) /* 809CA4A0 */
...
/* 809C66D4 00000034  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 809C66D8 00000038  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l /* 804061C0 */
...
/* 809C66EC 0000004C  3C 60 00 00 */	lis r3, lit_4611@ha /* 809C9E34 */
/* 809C66F0 00000050  C0 03 00 00 */	lfs f0, lit_4611@l(r3) /* 809C9E34 */
/* 809C66F4 00000054  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 809C66F8 00000000  40 80 00 20 */	bge lbl_809C6718
/* 809C66FC 00000004  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809C6700 00000008  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
lbl_809C6718:
/* 809C6718 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809C671C 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
lbl_809C6730:
/* 809C6730 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 809C6734 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 809C675C 0000002C  3C 60 00 00 */	lis r3, lit_7629@ha /* 809CA4A0 */
/* 809C6760 00000030  C0 03 00 00 */	lfs f0, lit_7629@l(r3) /* 809CA4A0 */
...
/* 809C677C 0000004C  3C 60 00 00 */	lis r3, mGroundY__11fopAcM_gc_c@ha /* 80450CD0 */
/* 809C6780 00000050  C0 03 00 00 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3) /* 80450CD0 */

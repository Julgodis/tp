...
/* 809C6618 00000010  4B 99 BB BC */	b _savegpr_27
/* 809C661C 00000014  7C 7C 1B 78 */	mr r28, r3
/* 809C6620 00000018  7C 9B 23 78 */	mr r27, r4
/* 809C6624 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809C6628 00000020  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 809C663C 00000034  3C A0 80 9D */	lis r5, struct_809CA4B8+0x0@ha
/* 809C6640 00000038  38 A5 A4 B8 */	addi r5, r5, struct_809CA4B8+0x0@l
/* 809C6644 0000003C  38 A5 01 46 */	addi r5, r5, 0x146
/* 809C6648 00000040  38 C0 00 03 */	li r6, 3
/* 809C664C 00000044  4B 68 1A A0 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809C6664 00000008  4B 68 16 E8 */	b getIsAddvance__16dEvent_manager_cFi
...
/* 809C66AC 0000000C  4B 78 D6 70 */	b initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 809C66B0 00000010  3C 60 80 9D */	lis r3, lit_4611@ha
/* 809C66B4 00000014  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)
/* 809C66B8 00000018  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 809C66BC 0000001C  D0 01 00 18 */	stfs f0, 0x18(r1)
/* 809C66C0 00000020  3C 60 80 9D */	lis r3, lit_7629@ha
/* 809C66C4 00000024  C0 03 A4 A0 */	lfs f0, lit_7629@l(r3)
/* 809C66C8 00000028  D0 01 00 1C */	stfs f0, 0x1c(r1)
/* 809C66CC 0000002C  38 7C 04 A8 */	addi r3, r28, 0x4a8
/* 809C66D0 00000030  4B 64 66 94 */	b transS__14mDoMtx_stack_cFRC4cXyz
/* 809C66D4 00000034  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809C66D8 00000038  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 809C66DC 0000003C  80 7F 5D AC */	lwz r3, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 809C66E0 00000040  C0 23 04 D8 */	lfs f1, 0x4d8(r3)	/* effective address: 804004D8 */
/* 809C66E4 00000044  C0 1C 04 D8 */	lfs f0, 0x4d8(r28)
/* 809C66E8 00000048  EC 21 00 28 */	fsubs f1, f1, f0
/* 809C66EC 0000004C  3C 60 80 9D */	lis r3, lit_4611@ha
/* 809C66F0 00000050  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)
/* 809C66F4 00000054  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 809C66F8 00000000  40 80 00 20 */	bge lbl_809C6718
/* 809C66FC 00000004  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809C6700 00000008  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 809C6710 00000018  4B 64 5D 24 */	b mDoMtx_YrotM__FPA4_fs
/* 809C6714 0000001C  48 00 00 1C */	b lbl_809C6730
lbl_809C6718:
/* 809C6718 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809C671C 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 809C672C 00000014  4B 64 5D 08 */	b mDoMtx_YrotM__FPA4_fs
lbl_809C6730:
/* 809C6730 00000000  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809C6734 00000004  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809C6738 00000008  38 81 00 14 */	addi r4, r1, 0x14
/* 809C673C 0000000C  7C 85 23 78 */	mr r5, r4
/* 809C6740 00000010  4B 98 06 2C */	b PSMTXMultVec
...
/* 809C675C 0000002C  3C 60 80 9D */	lis r3, lit_7629@ha
/* 809C6760 00000030  C0 03 A4 A0 */	lfs f0, lit_7629@l(r3)
...
/* 809C6770 00000040  4B 65 75 4C */	b gndCheck__11fopAcM_gc_cFPC4cXyz
/* 809C6774 00000044  54 60 06 3F */	clrlwi. r0, r3, 0x18
/* 809C6778 00000048  41 82 00 10 */	beq lbl_809C6788
/* 809C677C 0000004C  3C 60 80 45 */	lis r3, mGroundY__11fopAcM_gc_c@ha
/* 809C6780 00000050  C0 03 0C D0 */	lfs f0, mGroundY__11fopAcM_gc_c@l(r3)
/* 809C6784 00000054  D0 01 00 18 */	stfs f0, 0x18(r1)
lbl_809C6788:
/* 809C6788 00000000  83 FF 5D AC */	lwz r31, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 809C678C 00000004  38 61 00 14 */	addi r3, r1, 0x14
/* 809C6790 00000008  38 9C 04 A8 */	addi r4, r28, 0x4a8
/* 809C6794 0000000C  4B 8A A4 A8 */	b cLib_targetAngleY__FRC3VecRC3Vec
...
/* 809C67A8 00000020  81 9F 06 28 */	lwz r12, 0x628(r31)	/* effective address: 804067E8 */
...
/* 809C67E8 00000010  4B 78 D5 9C */	b talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C6808 00000008  4B 99 BA 18 */	b _restgpr_27

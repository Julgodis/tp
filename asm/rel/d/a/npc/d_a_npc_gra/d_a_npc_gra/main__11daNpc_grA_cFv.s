...
/* 809C0048  4B 9A 21 94 */	b _savegpr_29
/* 809C004C  7C 7E 1B 78 */	mr r30, r3
/* 809C0050  3C 80 80 9D */	lis r4, cNullVec__6Z2Calc@ha
/* 809C0054  3B E4 A6 14 */	addi r31, r4, cNullVec__6Z2Calc@l
...
/* 809C0074  4B 79 35 04 */	b hitChk2__8daNpcF_cFP8dCcD_Cylii
/* 809C0078  2C 03 00 00 */	cmpwi r3, 0
/* 809C007C  41 82 00 30 */	beq lbl_809C00AC
/* 809C0080  7F C3 F3 78 */	mr r3, r30
/* 809C0084  3C 80 80 9D */	lis r4, m__17daNpc_grA_Param_c@ha
/* 809C0088  38 84 9D 98 */	addi r4, r4, m__17daNpc_grA_Param_c@l
/* 809C008C  A8 84 00 62 */	lha r4, 0x62(r4)	/* effective address: 809C9DFA */
/* 809C0090  38 A0 00 17 */	li r5, 0x17
/* 809C0094  38 C0 00 00 */	li r6, 0
/* 809C0098  4B 79 35 C0 */	b setDamage__8daNpcF_cFiii
...
/* 809C00DC  4B 9A 1F 3C */	b __ptmf_test
...
/* 809C00F0  4B 9A 1F 58 */	b __ptmf_cmpr
...
/* 809C0108  4B 9A 1F 7C */	b __ptmf_scall
...
/* 809C0154  4B 66 F9 00 */	b dComIfGs_wolfeye_effect_check__Fv
...
lbl_809C0174:
/* 809C0174  3C 60 80 9D */	lis r3, m__17daNpc_grA_Param_c@ha
/* 809C0178  38 63 9D 98 */	addi r3, r3, m__17daNpc_grA_Param_c@l
/* 809C017C  88 03 00 6A */	lbz r0, 0x6a(r3)	/* effective address: 809C9E02 */
/* 809C0180  28 00 00 00 */	cmplwi r0, 0
/* 809C0184  40 82 00 C4 */	bne lbl_809C0248
/* 809C0188  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809C018C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809C0190  88 63 4F AD */	lbz r3, 0x4fad(r3)	/* effective address: 8040B16D */
...
/* 809C0244  4B 79 36 38 */	b orderEvent__8daNpcF_cFiPcUsUsUcUs
lbl_809C0248:
/* 809C0248  88 1E 09 EE */	lbz r0, 0x9ee(r30)
/* 809C024C  28 00 00 00 */	cmplwi r0, 0
/* 809C0250  41 82 00 1C */	beq lbl_809C026C
/* 809C0254  3C 60 80 9D */	lis r3, lit_4611@ha
/* 809C0258  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)
...
/* 809C0284  4B 9A 1F A4 */	b _restgpr_29

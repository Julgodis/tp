...
/* 809C2C4C 00000010  4B 99 F5 84 */	b _savegpr_26
/* 809C2C50 00000014  7C 7B 1B 78 */	mr r27, r3
/* 809C2C54 00000018  3C 60 80 9D */	lis r3, cNullVec__6Z2Calc@ha
/* 809C2C58 0000001C  3B C3 A6 14 */	addi r30, r3, cNullVec__6Z2Calc@l
/* 809C2C5C 00000020  3B 80 00 00 */	li r28, 0
/* 809C2C60 00000024  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809C2C64 00000028  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l
/* 809C2C68 0000002C  88 1F 4F AD */	lbz r0, 0x4fad(r31)	/* effective address: 8040B16D */
...
/* 809C2CA4 0000000C  80 7E 08 B4 */	lwz r3, 0x8b4(r30)	/* effective address: 809CAEC8 */
/* 809C2CA8 00000010  80 1E 08 B8 */	lwz r0, 0x8b8(r30)	/* effective address: 809CAECC */
/* 809C2CAC 00000014  90 61 00 1C */	stw r3, 0x1c(r1)
/* 809C2CB0 00000018  90 01 00 20 */	stw r0, 0x20(r1)
/* 809C2CB4 0000001C  80 1E 08 BC */	lwz r0, 0x8bc(r30)	/* effective address: 809CAED0 */
...
/* 809C2CDC 00000044  4B 99 F3 A8 */	b __ptmf_scall
/* 809C2CE0 00000048  60 00 00 00 */	nop 
/* 809C2CE4 0000004C  48 00 00 C0 */	b lbl_809C2DA4
lbl_809C2CE8:
/* 809C2CE8 00000000  38 00 00 00 */	li r0, 0
/* 809C2CEC 00000004  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809C2CF0 00000008  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 809C2CF4 0000000C  88 63 4F B5 */	lbz r3, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 809C2D18 0000000C  4B 68 5A D8 */	b ChkPresentEnd__16dEvent_manager_cFv
...
/* 809C2D30 0000000C  80 7E 08 C0 */	lwz r3, 0x8c0(r30)	/* effective address: 809CAED4 */
/* 809C2D34 00000010  80 1E 08 C4 */	lwz r0, 0x8c4(r30)	/* effective address: 809CAED8 */
/* 809C2D38 00000014  90 61 00 10 */	stw r3, 0x10(r1)
/* 809C2D3C 00000018  90 01 00 14 */	stw r0, 0x14(r1)
/* 809C2D40 0000001C  80 1E 08 C8 */	lwz r0, 0x8c8(r30)	/* effective address: 809CAEDC */
...
/* 809C2DA0 00000048  4B 79 0B B4 */	b changeEvent__8daNpcF_cFPcPcUsUs
lbl_809C2DA4:
...
/* 809C2DC0 00000014  4B 68 09 2C */	b setPtI_Id__14dEvt_control_cFUi
...
/* 809C2DE8 0000001C  4B 68 4D 34 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 809C2E04 00000010  4B 68 4D 18 */	b getMyStaffId__16dEvent_manager_cFPCcP10fopAc_ac_ci
...
/* 809C2E30 00000024  4B 68 4F E0 */	b getMyActIdx__16dEvent_manager_cFiPCPCciii
...
/* 809C2E4C 00000040  4B 99 F2 38 */	b __ptmf_scall
...
/* 809C2E64 00000058  4B 68 53 18 */	b cutEnd__16dEvent_manager_cFi
lbl_809C2E68:
...
/* 809C2E88 0000001C  4B 68 4B F0 */	b endCheck__16dEvent_manager_cFs
...
/* 809C2EC0 00000004  4B 67 F5 A8 */	b reset__14dEvt_control_cFv
...
/* 809C2EDC 00000020  3C 60 80 9C */	lis r3, s_subCarry__FPvPv@ha
/* 809C2EE0 00000024  38 63 FD 04 */	addi r3, r3, s_subCarry__FPvPv@l
/* 809C2EE4 00000028  7F 64 DB 78 */	mr r4, r27
/* 809C2EE8 0000002C  4B 65 E4 50 */	b fpcEx_Search__FPFPvPv_PvPv
/* 809C2EEC 00000030  48 00 00 5C */	b lbl_809C2F48
lbl_809C2EF0:
/* 809C2EF0 00000000  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 809C2EF4 00000004  4B 67 F5 74 */	b reset__14dEvt_control_cFv
...
/* 809C2F10 00000004  4B 67 F5 58 */	b reset__14dEvt_control_cFv
...
/* 809C2F28 0000001C  4B 65 6D 54 */	b fopAcM_delete__FP10fopAc_ac_c
/* 809C2F2C 00000020  48 00 00 1C */	b lbl_809C2F48
lbl_809C2F30:
/* 809C2F30 00000000  38 7F 4E C8 */	addi r3, r31, 0x4ec8
/* 809C2F34 00000004  4B 67 F5 34 */	b reset__14dEvt_control_cFv
...
/* 809C2F60 00000018  4B 79 07 B8 */	b ctrlMsgAnm__8daNpcF_cFRiRiP10fopAc_ac_ci
...
/* 809C2F80 00000038  3C A0 80 9D */	lis r5, lit_6106@ha
/* 809C2F84 0000003C  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)
...
/* 809C2FA0 00000058  3C A0 80 9D */	lis r5, lit_6106@ha
/* 809C2FA4 0000005C  C0 25 A4 08 */	lfs f1, lit_6106@l(r5)
...
/* 809C3024 00000014  3C 60 80 3A */	lis r3, __ptmf_null@ha
/* 809C3028 00000018  38 83 21 80 */	addi r4, r3, __ptmf_null@l
/* 809C302C 0000001C  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 803A2180 */
/* 809C3030 00000020  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 803A2184 */
/* 809C3034 00000024  90 7B 14 10 */	stw r3, 0x1410(r27)
/* 809C3038 00000028  90 1B 14 14 */	stw r0, 0x1414(r27)
/* 809C303C 0000002C  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 803A2188 */
...
/* 809C305C 00000008  4B 99 F1 C0 */	b _restgpr_26

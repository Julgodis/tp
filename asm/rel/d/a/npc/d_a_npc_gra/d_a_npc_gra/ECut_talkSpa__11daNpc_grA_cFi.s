...
/* 809C3B38 00000010  4B 99 E6 9C */	b _savegpr_27
/* 809C3B3C 00000014  7C 7D 1B 78 */	mr r29, r3
/* 809C3B40 00000018  7C 9B 23 78 */	mr r27, r4
/* 809C3B44 0000001C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha
/* 809C3B48 00000020  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l
...
/* 809C3B58 00000030  3C 60 80 9D */	lis r3, lit_6467@ha
/* 809C3B5C 00000034  38 83 A4 40 */	addi r4, r3, lit_6467@l
/* 809C3B60 00000038  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 809CA440 */
/* 809C3B64 0000003C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 809CA444 */
...
/* 809C3B78 00000050  4B 78 CB 74 */	b getActorP__18daNpcF_ActorMngr_cFv
...
/* 809C3B88 00000060  3C A0 80 9D */	lis r5, struct_809CA4B8+0x0@ha
/* 809C3B8C 00000064  38 A5 A4 B8 */	addi r5, r5, struct_809CA4B8+0x0@l
/* 809C3B90 00000068  38 A5 01 46 */	addi r5, r5, 0x146
/* 809C3B94 0000006C  38 C0 00 03 */	li r6, 3
/* 809C3B98 00000070  4B 68 45 54 */	b getMySubstanceP__16dEvent_manager_cFiPCci
...
/* 809C3BB0 00000008  4B 68 41 9C */	b getIsAddvance__16dEvent_manager_cFi
...
/* 809C3BE4 00000004  4B 78 CB 08 */	b getActorP__18daNpcF_ActorMngr_cFv
/* 809C3BE8 00000008  3B 83 0B A8 */	addi r28, r3, 0xba8
/* 809C3BEC 0000000C  7F 83 E3 78 */	mr r3, r28
/* 809C3BF0 00000010  4B 78 1B 18 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 809C3C18 00000004  4B 78 1A E4 */	b remove__18daNpcT_ActorMngr_cFv
/* 809C3C1C 00000008  38 00 00 00 */	li r0, 0
/* 809C3C20 0000000C  90 1C 00 20 */	stw r0, 0x20(r28)
/* 809C3C24 00000010  3C 60 80 9D */	lis r3, lit_4611@ha
/* 809C3C28 00000014  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)
...
/* 809C3C54 0000000C  4B 65 50 8C */	b fopAc_IsActor__FPv
...
/* 809C3C68 00000020  4B 78 1A 78 */	b entry__18daNpcT_ActorMngr_cFP10fopAc_ac_c
/* 809C3C6C 00000024  3C 60 80 9D */	lis r3, lit_4611@ha
/* 809C3C70 00000028  C0 03 9E 34 */	lfs f0, lit_4611@l(r3)
...
/* 809C3C9C 0000000C  4B 79 00 80 */	b initTalk__8daNpcF_cFiPP10fopAc_ac_c
/* 809C3CA0 00000010  48 00 00 44 */	b lbl_809C3CE4
lbl_809C3CA4:
/* 809C3CA4 00000000  38 60 00 06 */	li r3, 6
/* 809C3CA8 00000004  4B 79 19 8C */	b daNpcF_chkEvtBit__FUl
...
/* 809C3CB8 00000014  4B 79 19 7C */	b daNpcF_chkEvtBit__FUl
...
/* 809C3D20 00000010  4B 79 00 64 */	b talkProc__8daNpcF_cFPiiPP10fopAc_ac_c
...
/* 809C3D64 00000008  4B 99 E4 BC */	b _restgpr_27

...
/* 809BF514  4B 9A 2C C4 */	b _savegpr_28
...
/* 809BF528  3C 60 80 9D */	lis r3, lit_4634@ha
/* 809BF52C  38 83 9E 38 */	addi r4, r3, lit_4634@l
/* 809BF530  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 809C9E38 */
/* 809BF534  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 809C9E3C */
/* 809BF538  90 61 00 08 */	stw r3, 8(r1)
/* 809BF53C  90 01 00 0C */	stw r0, 0xc(r1)
/* 809BF540  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 809C9E40 */
...
/* 809BF564  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809BF568  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809BF56C  4B 98 6F 44 */	b PSMTXCopy
/* 809BF570  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF574  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l
/* 809BF578  C0 1E 00 0C */	lfs f0, 0xc(r30)	/* effective address: 803DD47C */
/* 809BF57C  D0 1F 08 54 */	stfs f0, 0x854(r31)
/* 809BF580  C0 1E 00 1C */	lfs f0, 0x1c(r30)	/* effective address: 803DD48C */
/* 809BF584  D0 1F 08 58 */	stfs f0, 0x858(r31)
/* 809BF588  C0 1E 00 2C */	lfs f0, 0x2c(r30)	/* effective address: 803DD49C */
...
/* 809BF5A8  4B 98 6F 08 */	b PSMTXCopy
...
/* 809BF5D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809BF5DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809BF5E0  4B 98 6E D0 */	b PSMTXCopy
...
/* 809BF60C  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809BF610  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809BF614  4B 98 6E 9C */	b PSMTXCopy
...
/* 809BF644  3C C0 80 9D */	lis r6, m__17daNpc_grA_Param_c@ha
/* 809BF648  38 C6 9D 98 */	addi r6, r6, m__17daNpc_grA_Param_c@l
/* 809BF64C  C0 26 00 40 */	lfs f1, 0x40(r6)	/* effective address: 809C9DD8 */
/* 809BF650  4B 79 3D 2C */	b setLookatMtx__8daNpcF_cFiPif
lbl_809BF654:
/* 809BF654  2C 1D 00 01 */	cmpwi r29, 1
/* 809BF658  40 82 00 30 */	bne lbl_809BF688
/* 809BF65C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF660  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BF664  A8 1F 09 0C */	lha r0, 0x90c(r31)
/* 809BF668  7C 00 00 D0 */	neg r0, r0
/* 809BF66C  7C 04 07 34 */	extsh r4, r0
/* 809BF670  4B 64 CD C4 */	b mDoMtx_YrotM__FPA4_fs
/* 809BF674  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF678  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BF67C  A8 9F 09 08 */	lha r4, 0x908(r31)
/* 809BF680  4B 64 CE 4C */	b mDoMtx_ZrotM__FPA4_fs
/* 809BF684  48 00 00 34 */	b lbl_809BF6B8
lbl_809BF688:
/* 809BF688  2C 1D 00 04 */	cmpwi r29, 4
/* 809BF68C  40 82 00 2C */	bne lbl_809BF6B8
/* 809BF690  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF694  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BF698  A8 1F 09 18 */	lha r0, 0x918(r31)
/* 809BF69C  7C 00 00 D0 */	neg r0, r0
/* 809BF6A0  7C 04 07 34 */	extsh r4, r0
/* 809BF6A4  4B 64 CD 90 */	b mDoMtx_YrotM__FPA4_fs
/* 809BF6A8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF6AC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BF6B0  A8 9F 09 14 */	lha r4, 0x914(r31)
/* 809BF6B4  4B 64 CE 18 */	b mDoMtx_ZrotM__FPA4_fs
lbl_809BF6B8:
/* 809BF6B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF6BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BF6C0  80 9C 00 84 */	lwz r4, 0x84(r28)
/* 809BF6C4  80 04 00 0C */	lwz r0, 0xc(r4)
/* 809BF6C8  7C 80 F2 14 */	add r4, r0, r30
/* 809BF6CC  4B 98 6D E4 */	b PSMTXCopy
/* 809BF6D0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809BF6D4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809BF6D8  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 809BF6DC  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l
/* 809BF6E0  4B 98 6D D0 */	b PSMTXCopy
...
/* 809BF710  4B 64 E2 80 */	b changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform
...
/* 809BF724  4B 9A 2B 00 */	b _restgpr_28

...
/* 809C0D1C 00000038  3C A0 00 00 */	lis r5, l_btpGetParamList@ha
/* 809C0D20 0000003C  38 C5 00 00 */	addi r6, r5, l_btpGetParamList@l
...
/* 809C0D3C 00000058  3C 80 00 00 */	lis r4, l_resNames@ha
/* 809C0D40 0000005C  38 84 00 00 */	addi r4, r4, l_resNames@l
...
/* 809C0D58 00000008  3C 60 00 00 */	lis r3, lit_5405@ha
/* 809C0D5C 0000000C  38 63 00 00 */	addi r3, r3, lit_5405@l
...
/* 809C0D70 00000020  3B E0 00 02 */	li r31, 2
/* 809C0D74 00000024  48 00 00 28 */	b lbl_809C0D9C
/* 809C0D78 00000028  3B E0 00 02 */	li r31, 2
/* 809C0D7C 0000002C  48 00 00 20 */	b lbl_809C0D9C
/* 809C0D80 00000030  3B E0 00 02 */	li r31, 2
/* 809C0D84 00000034  48 00 00 18 */	b lbl_809C0D9C
/* 809C0D88 00000038  3B E0 00 02 */	li r31, 2
/* 809C0D8C 0000003C  48 00 00 10 */	b lbl_809C0D9C
/* 809C0D90 00000040  3B E0 00 02 */	li r31, 2
/* 809C0D94 00000044  48 00 00 08 */	b lbl_809C0D9C
lbl_809C0D98:
...
/* 809C0DBC 00000010  3C C0 00 00 */	lis r6, lit_4610@ha
/* 809C0DC0 00000014  C0 26 00 00 */	lfs f1, lit_4610@l(r6)

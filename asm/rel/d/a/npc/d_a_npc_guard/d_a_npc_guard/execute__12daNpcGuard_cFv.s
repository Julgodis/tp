...
/* 809F205C  4B 97 01 70 */	b _savegpr_25
/* 809F2060  7C 7D 1B 78 */	mr r29, r3
/* 809F2064  3C 60 80 9F */	lis r3, lit_3900@ha
/* 809F2068  3B E3 2C 50 */	addi r31, r3, lit_3900@l
/* 809F206C  80 1D 0A 98 */	lwz r0, 0xa98(r29)
/* 809F2070  2C 00 00 10 */	cmpwi r0, 0x10
/* 809F2074  40 80 00 1C */	bge lbl_809F2090
/* 809F2078  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F207C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F2090:
/* 809F2090  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F2094  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F20C4:
/* 809F20C4  4B 68 3E 7C */	b SetWallR__12dBgS_AcchCirFf
/* 809F20C8  80 1D 0B 0C */	lwz r0, 0xb0c(r29)
/* 809F20CC  2C 00 00 06 */	cmpwi r0, 6
/* 809F20D0  41 82 00 9C */	beq lbl_809F216C
/* 809F20D4  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809F20D8  3B 63 61 C0 */	addi r27, r3, struct_804061C0+0x0@l
/* 809F20DC  80 1B 5F 1C */	lwz r0, 0x5f1c(r27)	/* effective address: 8040C0DC */
...
/* 809F210C  4B 62 88 58 */	b fopAcM_searchActorDistanceXZ__FPC10fopAc_ac_cPC10fopAc_ac_c
...
lbl_809F2130:
/* 809F2130  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 809F2134  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 809F2138  80 63 5D AC */	lwz r3, 0x5dac(r3)	/* effective address: 8040BF6C */
/* 809F213C  88 03 05 68 */	lbz r0, 0x568(r3)	/* effective address: 80406728 */
...
/* 809F2184  4B 87 D8 B8 */	b cLib_addCalc2__FPffff
/* 809F2188  80 7D 05 8C */	lwz r3, 0x58c(r29)
/* 809F218C  38 80 00 00 */	li r4, 0
/* 809F2190  38 A0 00 00 */	li r5, 0
/* 809F2194  4B 61 EF 1C */	b play__16mDoExt_McaMorfSOFUlSc
...
/* 809F21AC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809F21B0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809F21B4  4B 95 42 FC */	b PSMTXCopy
/* 809F21B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809F21BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 809F21C0  C0 03 00 0C */	lfs f0, 0xc(r3)	/* effective address: 803DD47C */
/* 809F21C4  D0 01 00 08 */	stfs f0, 8(r1)
/* 809F21C8  C0 03 00 1C */	lfs f0, 0x1c(r3)	/* effective address: 803DD48C */
/* 809F21CC  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 809F21D0  C0 03 00 2C */	lfs f0, 0x2c(r3)	/* effective address: 803DD49C */
...
/* 809F2224  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 809F2228  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 809F222C  4B 95 42 84 */	b PSMTXCopy
/* 809F2230  80 9D 0A 98 */	lwz r4, 0xa98(r29)
/* 809F2234  2C 04 00 10 */	cmpwi r4, 0x10
/* 809F2238  40 80 00 1C */	bge lbl_809F2254
/* 809F223C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F2240  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F2254:
/* 809F2254  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F2258  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F2270  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F2274  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F2288:
/* 809F2288  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F228C  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F22A4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F22A8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F22BC:
/* 809F22BC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F22C0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
/* 809F22C4  1C 04 02 3C */	mulli r0, r4, 0x23c
/* 809F22C8  7C 63 02 14 */	add r3, r3, r0
/* 809F22CC  C0 23 FF 18 */	lfs f1, -0xe8(r3)
lbl_809F22D0:
/* 809F22D0  4B 61 AB 68 */	b scaleM__14mDoMtx_stack_cFfff
/* 809F22D4  3B 40 00 00 */	li r26, 0
/* 809F22D8  7F 5C D3 78 */	mr r28, r26
/* 809F22DC  C3 FF 00 20 */	lfs f31, 0x20(r31)
/* 809F22E0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 809F22E4  3B 63 D4 70 */	addi r27, r3, now__14mDoMtx_stack_c@l
lbl_809F22E8:
...
/* 809F2360  4B 96 FE B8 */	b _restgpr_25

...
/* 809F189C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F18A0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F18B4:
/* 809F18B4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F18B8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F18D4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F18D8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F18EC:
/* 809F18EC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F18F0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F190C  4B 87 5A E8 */	b __ct__5csXyzFsss
...
/* 809F192C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1930  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1944:
/* 809F1944  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1948  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1964  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1968  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F197C:
/* 809F197C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1980  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F199C  4B 87 5A 58 */	b __ct__5csXyzFsss
...
/* 809F19BC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F19C0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F19D4:
/* 809F19D4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F19D8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F19F4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F19F8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1A0C:
/* 809F1A0C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1A10  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1A2C  4B 87 59 C8 */	b __ct__5csXyzFsss
...
/* 809F1A4C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1A50  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1A64:
/* 809F1A64  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1A68  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1A84  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1A88  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1A9C:
/* 809F1A9C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1AA0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1ABC  4B 87 59 38 */	b __ct__5csXyzFsss
...
/* 809F1ADC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1AE0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1AF4:
/* 809F1AF4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1AF8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1B14  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1B18  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1B2C:
/* 809F1B2C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1B30  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1B4C  4B 87 58 A8 */	b __ct__5csXyzFsss
...
/* 809F1B6C  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1B70  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1B84:
/* 809F1B84  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1B88  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1BA4  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1BA8  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
lbl_809F1BBC:
/* 809F1BBC  3C 60 80 43 */	lis r3, l_Cd2_HIO@ha
/* 809F1BC0  38 63 86 1C */	addi r3, r3, l_Cd2_HIO@l
...
/* 809F1BDC  4B 87 58 18 */	b __ct__5csXyzFsss
...
/* 809F1C7C  4B 85 F7 90 */	b init__16dNpcLib_lookat_cFP8J3DModelPiP5csXyzP5csXyz
/* 809F1C80  38 7F 0B 00 */	addi r3, r31, 0xb00
/* 809F1C84  4B 75 3A 84 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 809F1CA0  4B 95 48 10 */	b PSMTXCopy
/* 809F1CA4  38 7F 0B 00 */	addi r3, r31, 0xb00
/* 809F1CA8  4B 75 3A 60 */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 809F1CD8  4B 95 47 D8 */	b PSMTXCopy
/* 809F1CDC  3C 60 80 43 */	lis r3, Zero__4cXyz@ha
/* 809F1CE0  C0 03 0C F4 */	lfs f0, Zero__4cXyz@l(r3)
...
/* 809F1D2C  4B 75 39 DC */	b getActorP__18daNpcT_ActorMngr_cFv
...
/* 809F1D50  4B 85 F7 E4 */	b action__16dNpcLib_lookat_cF4cXyz4cXyzP10fopAc_ac_cPA4_fi

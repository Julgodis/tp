...
/* 8099BF38  4B 9C 62 9C */	b _savegpr_27
/* 8099BF3C  7C 7E 1B 78 */	mr r30, r3
/* 8099BF40  3C 60 80 9A */	lis r3, m__19daNpcClerkt_Param_c@ha
/* 8099BF44  3B E3 D2 44 */	addi r31, r3, m__19daNpcClerkt_Param_c@l
/* 8099BF48  C0 1F 00 C8 */	lfs f0, 0xc8(r31)	/* effective address: 8099D30C */
/* 8099BF4C  D0 01 00 34 */	stfs f0, 0x34(r1)
/* 8099BF50  C0 1F 00 CC */	lfs f0, 0xcc(r31)	/* effective address: 8099D310 */
/* 8099BF54  D0 01 00 38 */	stfs f0, 0x38(r1)
/* 8099BF58  C0 3F 00 AC */	lfs f1, 0xac(r31)	/* effective address: 8099D2F0 */
/* 8099BF5C  D0 21 00 3C */	stfs f1, 0x3c(r1)
/* 8099BF60  D0 21 00 28 */	stfs f1, 0x28(r1)
/* 8099BF64  C0 1F 00 D0 */	lfs f0, 0xd0(r31)	/* effective address: 8099D314 */
...
/* 8099BF78  4B 7A BE C4 */	b calc__19daNpcT_DmgStagger_cFi
...
/* 8099C04C  4B 7A AC 8C */	b setParam__15daNpcT_JntAnm_cFP10fopAc_ac_cP8J3DModelP4cXyziiiffffffffffP4cXyz
...
/* 8099C060  4B 7A BB D8 */	b calcJntRad__15daNpcT_JntAnm_cFfff
...
/* 8099C074  3C 60 80 9A */	lis r3, ctrlJointCallBack__13daNpcClerkT_cFP8J3DJointi@ha
/* 8099C078  38 83 AB 34 */	addi r4, r3, ctrlJointCallBack__13daNpcClerkT_cFP8J3DJointi@l
...
/* 8099C0A8  4B 7A D0 E8 */	b setMtx__8daNpcT_cFv
...
/* 8099C0D8  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 8099C0DC  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 8099C0E0  4B 9A A3 D0 */	b PSMTXCopy
/* 8099C0E4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 8099C0E8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 8099C0EC  38 81 00 34 */	addi r4, r1, 0x34
/* 8099C0F0  38 BE 05 38 */	addi r5, r30, 0x538
/* 8099C0F4  4B 9A AC 78 */	b PSMTXMultVec
...
/* 8099C18C  4B 9C 60 94 */	b _restgpr_27

...
/* 80A760F8  4B 8E C0 D8 */	b _savegpr_26
...
/* 80A76110  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A76114  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
...
lbl_80A761AC:
/* 80A761AC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A761B0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A761B4  80 84 00 04 */	lwz r4, 4(r4)
/* 80A761B8  38 BB 01 0C */	addi r5, r27, 0x10c
/* 80A761BC  4B 72 EB E4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A761C0  80 7F 00 84 */	lwz r3, 0x84(r31)
/* 80A761C4  80 83 00 0C */	lwz r4, 0xc(r3)
/* 80A761C8  3C 60 80 A8 */	lis r3, data_80A7B068@ha
/* 80A761CC  38 63 B0 68 */	addi r3, r3, data_80A7B068@l
/* 80A761D0  7C 03 D0 2E */	lwzx r0, r3, r26
/* 80A761D4  1C 00 00 30 */	mulli r0, r0, 0x30
/* 80A761D8  7C 64 02 14 */	add r3, r4, r0
/* 80A761DC  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A761E0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A761E4  4B 8D 02 CC */	b PSMTXCopy
/* 80A761E8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A761EC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A761F0  38 81 00 08 */	addi r4, r1, 8
/* 80A761F4  4B 8D 02 BC */	b PSMTXCopy
/* 80A761F8  38 61 00 08 */	addi r3, r1, 8
/* 80A761FC  7C 9B E8 2E */	lwzx r4, r27, r29
/* 80A76200  38 84 00 24 */	addi r4, r4, 0x24
/* 80A76204  4B 8D 02 AC */	b PSMTXCopy
...
/* 80A76240  4B 59 7A 84 */	b mDoExt_modelUpdateDL__FP8J3DModel
...
/* 80A7626C  4B 59 7A 58 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_80A76270:
/* 80A76270  7F C3 F3 78 */	mr r3, r30
/* 80A76274  80 9B 0D 94 */	lwz r4, 0xd94(r27)
/* 80A76278  7C BB E8 2E */	lwzx r5, r27, r29
/* 80A7627C  4B 5D FC A0 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A76280:
...
/* 80A76294  4B 8E BF 88 */	b _restgpr_26

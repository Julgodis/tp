...
/* 80AEB4D8  4B 87 6D 04 */	b _savegpr_29
/* 80AEB4DC  7C 7E 1B 78 */	mr r30, r3
/* 80AEB4E0  3B E0 00 01 */	li r31, 1
/* 80AEB4E4  3C 80 80 40 */	lis r4, struct_804061C0+0x0@ha
/* 80AEB4E8  3B A4 61 C0 */	addi r29, r4, struct_804061C0+0x0@l
/* 80AEB4EC  88 1D 4F AD */	lbz r0, 0x4fad(r29)	/* effective address: 8040B16D */
...
/* 80AEB508  3C 80 80 AF */	lis r4, lit_4132@ha
/* 80AEB50C  38 A4 BC 8C */	addi r5, r4, lit_4132@l
/* 80AEB510  80 85 00 00 */	lwz r4, 0(r5)	/* effective address: 80AEBC8C */
/* 80AEB514  80 05 00 04 */	lwz r0, 4(r5)	/* effective address: 80AEBC90 */
/* 80AEB518  90 81 00 14 */	stw r4, 0x14(r1)
/* 80AEB51C  90 01 00 18 */	stw r0, 0x18(r1)
/* 80AEB520  80 05 00 08 */	lwz r0, 8(r5)	/* effective address: 80AEBC94 */
...
/* 80AEB544  4B 87 6B 40 */	b __ptmf_scall
/* 80AEB548  60 00 00 00 */	nop 
/* 80AEB54C  7C 7F 1B 78 */	mr r31, r3
/* 80AEB550  48 00 00 74 */	b lbl_80AEB5C4
lbl_80AEB554:
/* 80AEB554  38 00 00 00 */	li r0, 0
/* 80AEB558  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80AEB55C  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80AEB560  88 63 4F B5 */	lbz r3, 0x4fb5(r3)	/* effective address: 8040B175 */
...
/* 80AEB584  4B 55 D2 6C */	b ChkPresentEnd__16dEvent_manager_cFv
/* 80AEB588  2C 03 00 00 */	cmpwi r3, 0
/* 80AEB58C  41 82 00 38 */	beq lbl_80AEB5C4
lbl_80AEB590:
/* 80AEB590  3C 60 80 AF */	lis r3, lit_4140@ha
/* 80AEB594  38 83 BC 98 */	addi r4, r3, lit_4140@l
/* 80AEB598  80 64 00 00 */	lwz r3, 0(r4)	/* effective address: 80AEBC98 */
/* 80AEB59C  80 04 00 04 */	lwz r0, 4(r4)	/* effective address: 80AEBC9C */
/* 80AEB5A0  90 61 00 08 */	stw r3, 8(r1)
/* 80AEB5A4  90 01 00 0C */	stw r0, 0xc(r1)
/* 80AEB5A8  80 04 00 08 */	lwz r0, 8(r4)	/* effective address: 80AEBCA0 */
...
/* 80AEB5D4  4B 87 6C 54 */	b _restgpr_29

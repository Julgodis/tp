...
/* 80A49670  4B 91 8B 6C */	b _savegpr_29
/* 80A49674  7C 7D 1B 78 */	mr r29, r3
/* 80A49678  3C 60 80 A6 */	lis r3, lit_4030@ha
/* 80A4967C  3B E3 DE FC */	addi r31, r3, lit_4030@l
...
/* 80A496A8  3C 60 80 A6 */	lis r3, stringBase0@ha
/* 80A496AC  38 03 E4 38 */	addi r0, r3, stringBase0@l
/* 80A496B0  7C 04 00 40 */	cmplw r4, r0
/* 80A496B4  40 82 00 20 */	bne lbl_80A496D4
/* 80A496B8  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A496BC  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A496C0  38 80 00 04 */	li r4, 4
/* 80A496C4  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80A496C8  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80A496CC  4B 75 A0 F8 */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
/* 80A496D0  48 00 00 1C */	b lbl_80A496EC
lbl_80A496D4:
/* 80A496D4  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A496D8  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A496DC  38 80 00 00 */	li r4, 0
/* 80A496E0  38 BD 04 D0 */	addi r5, r29, 0x4d0
/* 80A496E4  38 DD 01 0C */	addi r6, r29, 0x10c
/* 80A496E8  4B 75 A0 DC */	b settingTevStruct__18dScnKy_env_light_cFiP4cXyzP12dKy_tevstr_c
lbl_80A496EC:
/* 80A496EC  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A496F0  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A496F4  80 9E 00 04 */	lwz r4, 4(r30)
/* 80A496F8  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80A496FC  4B 75 B6 A4 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
...
/* 80A49728  4B 5C 3E C0 */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
...
/* 80A4974C  4B 5C 3E 9C */	b entry__13mDoExt_btpAnmFP16J3DMaterialTables
lbl_80A49750:
/* 80A49750  80 7D 05 CC */	lwz r3, 0x5cc(r29)
/* 80A49754  4B 5C 7A 6C */	b entryDL__16mDoExt_McaMorfSOFv
/* 80A49758  88 1D 0C 17 */	lbz r0, 0xc17(r29)
/* 80A4975C  7C 00 07 75 */	extsb. r0, r0
/* 80A49760  41 82 00 24 */	beq lbl_80A49784
/* 80A49764  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A49768  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A4976C  80 9D 0C 00 */	lwz r4, 0xc00(r29)
/* 80A49770  80 84 00 04 */	lwz r4, 4(r4)
/* 80A49774  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80A49778  4B 75 B6 28 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A4977C  80 7D 0C 00 */	lwz r3, 0xc00(r29)
/* 80A49780  4B 5C 45 44 */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_80A49784:
/* 80A49784  80 9D 0B FC */	lwz r4, 0xbfc(r29)
/* 80A49788  28 04 00 00 */	cmplwi r4, 0
/* 80A4978C  41 82 00 20 */	beq lbl_80A497AC
/* 80A49790  3C 60 80 43 */	lis r3, g_env_light@ha
/* 80A49794  38 63 CA 54 */	addi r3, r3, g_env_light@l
/* 80A49798  80 84 00 04 */	lwz r4, 4(r4)
/* 80A4979C  38 BD 01 0C */	addi r5, r29, 0x10c
/* 80A497A0  4B 75 B6 00 */	b setLightTevColorType_MAJI__18dScnKy_env_light_cFP12J3DModelDataP12dKy_tevstr_c
/* 80A497A4  80 7D 0B FC */	lwz r3, 0xbfc(r29)
/* 80A497A8  4B 5C 45 1C */	b mDoExt_modelUpdateDL__FP8J3DModel
lbl_80A497AC:
...
/* 80A497F8  3D 40 80 42 */	lis r10, mSimpleTexObj__21dDlst_shadowControl_c@ha
/* 80A497FC  39 4A 48 D0 */	addi r10, r10, mSimpleTexObj__21dDlst_shadowControl_c@l
/* 80A49800  4B 5E 51 10 */	b dComIfGd_setShadow__FUlScP8J3DModelP4cXyzffffR13cBgS_PolyInfoP12dKy_tevstr_csfP9_GXTexObj
...
/* 80A49814  3C 60 80 40 */	lis r3, struct_804061C0+0x0@ha
/* 80A49818  38 63 61 C0 */	addi r3, r3, struct_804061C0+0x0@l
/* 80A4981C  38 63 61 C0 */	addi r3, r3, 0x61c0
/* 80A49820  80 9D 05 EC */	lwz r4, 0x5ec(r29)
/* 80A49824  80 BD 0C 00 */	lwz r5, 0xc00(r29)
/* 80A49828  4B 60 C6 F4 */	b addReal__21dDlst_shadowControl_cFUlP8J3DModel
lbl_80A4982C:
/* 80A4982C  38 60 00 01 */	li r3, 1
lbl_80A49830:
/* 80A49830  39 61 00 30 */	addi r11, r1, 0x30
/* 80A49834  4B 91 89 F4 */	b _restgpr_29

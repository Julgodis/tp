...
/* 80A5B62C 00000018  3C 60 00 00 */	lis r3, lit_4030@ha
/* 80A5B630 0000001C  3B C3 00 00 */	addi r30, r3, lit_4030@l
...
/* 80A5B648 00000034  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A5B64C 00000038  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
/* 80A5B650 0000003C  4B FE D8 A9 */	bl PSMTXCopy
/* 80A5B654 00000040  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A5B658 00000044  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80A5B688 00000074  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A5B68C 00000078  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80A5B6A8 00000094  3C 60 00 00 */	lis r3, l_HIO@ha
/* 80A5B6AC 00000098  38 63 00 00 */	addi r3, r3, l_HIO@l
...
/* 80A5B6C0 000000AC  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80A5B6C4 000000B0  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80A5B6C8 000000B4  80 63 5D AC */	lwz r3, 0x5dac(r3)
/* 80A5B6CC 000000B8  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A5B6D0 000000BC  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l
...
/* 80A5B6F8 00000008  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80A5B6FC 0000000C  3B E3 00 00 */	addi r31, r3, g_dComIfG_gameInfo@l
...
/* 80A5B738 00000048  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80A5B73C 0000004C  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l
/* 80A5B740 00000050  38 63 07 F0 */	addi r3, r3, 0x7f0
/* 80A5B744 00000054  3C 80 00 00 */	lis r4, saveBitLabels__16dSv_event_flag_c@ha
/* 80A5B748 00000058  38 84 00 00 */	addi r4, r4, saveBitLabels__16dSv_event_flag_c@l
...
lbl_80A5B7D0:
/* 80A5B7D0 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A5B7D4 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80A5B7F4 00000024  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 80A5B7F8 00000028  38 63 00 00 */	addi r3, r3, sincosTable___5JMath@l
...
lbl_80A5B84C:
/* 80A5B84C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A5B850 00000004  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
/* 80A5B854 00000008  4B FE D6 A5 */	bl mDoMtx_ZrotM__FPA4_fs
/* 80A5B858 0000000C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80A5B85C 00000010  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l
...
/* 80A5B86C 00000020  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 80A5B870 00000024  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l

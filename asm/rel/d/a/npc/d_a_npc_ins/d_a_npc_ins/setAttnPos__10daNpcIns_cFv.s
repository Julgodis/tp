...
/* 80A12EBC 00000018  3C 60 00 00 */	lis r3, l_insectParams@ha /* 80A13DAC */
/* 80A12EC0 0000001C  3B E3 00 00 */	addi r31, r3, l_insectParams@l /* 80A13DAC */
...
/* 80A12F44 00000044  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80A12F48 00000048  38 84 00 00 */	addi r4, r4, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80A12F4C 0000004C  4B FF B2 6D */	bl PSMTXCopy
/* 80A12F50 00000050  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80A12F54 00000054  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
...
/* 80A12F78 00000078  4B FF B2 41 */	bl PSMTXMultVec
/* 80A12F7C 0000007C  C0 1F 01 44 */	lfs f0, 0x144(r31)
/* 80A12F80 00000080  D0 01 00 24 */	stfs f0, 0x24(r1)
/* 80A12F84 00000084  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha /* 803DD470 */
/* 80A12F88 00000088  38 63 00 00 */	addi r3, r3, now__14mDoMtx_stack_c@l /* 803DD470 */
/* 80A12F8C 0000008C  38 81 00 24 */	addi r4, r1, 0x24
/* 80A12F90 00000090  7C 85 23 78 */	mr r5, r4
/* 80A12F94 00000094  4B FF B2 25 */	bl PSMTXMultVec
/* 80A12F98 00000098  38 7E 08 E4 */	addi r3, r30, 0x8e4
/* 80A12F9C 0000009C  38 81 00 24 */	addi r4, r1, 0x24
/* 80A12FA0 000000A0  4B FF B2 19 */	bl cLib_targetAngleX__FPC4cXyzPC4cXyz
...
/* 80A12FB0 000000B0  4B FF B2 09 */	bl cLib_targetAngleY__FPC3VecPC3Vec
...
/* 80A12FF4 000000F4  4B FF B1 C5 */	bl PSVECSubtract
...
/* 80A13014 00000114  4B FF B1 A5 */	bl cM_atan2s__Fff
...
/* 80A13040 00000140  4B FF B1 79 */	bl PSVECSquareMag
...
/* 80A130B0 00000004  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80A130B4 00000008  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80A13120 00000008  3C 60 00 00 */	lis r3, __float_nan@ha /* 80450AE0 */
/* 80A13124 0000000C  C0 43 00 00 */	lfs f2, __float_nan@l(r3) /* 80450AE0 */
...
/* 80A13134 00000004  4B FF B0 85 */	bl cM_atan2s__Fff
...
/* 80A1317C 00000028  4B FF B0 3D */	bl SetC__8cM3dGCylFRC4cXyz
/* 80A13180 0000002C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha /* 804061C0 */
/* 80A13184 00000030  38 63 00 00 */	addi r3, r3, g_dComIfG_gameInfo@l /* 804061C0 */
/* 80A13188 00000034  38 63 23 3C */	addi r3, r3, 0x233c
/* 80A1318C 00000038  38 9E 0C 8C */	addi r4, r30, 0xc8c
/* 80A13190 0000003C  4B FF B0 29 */	bl Set__4cCcSFP8cCcD_Obj

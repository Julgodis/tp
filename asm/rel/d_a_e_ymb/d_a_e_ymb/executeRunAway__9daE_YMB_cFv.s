...
/* 80819FE8 00000018  3C 80 00 00 */	lis r4, LIT_3791@ha
/* 80819FEC 0000001C  3B C4 00 00 */	addi r30, LIT_3791@l
/* 80819FF0 00000020  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 80819FF4 00000024  38 84 00 00 */	addi r4, g_dComIfG_gameInfo@l
...
/* 8081A148 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081A14C 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8081A1B8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081A1BC 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8081A1C0:
...
/* 8081A284 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081A288 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8081A2F4 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081A2F8 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8081A2FC:
...
/* 8081A464 00000024  3C 80 00 00 */	lis r4, l_HIO@ha
/* 8081A468 00000028  38 84 00 00 */	addi r4, l_HIO@l
...
/* 8081A478 00000038  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 8081A47C 0000003C  38 63 00 00 */	addi r3, sincosTable___5JMath@l
...
/* 8081A4D0 00000090  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 8081A4D4 00000094  38 63 00 00 */	addi r3, sincosTable___5JMath@l
...
/* 8081A59C 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081A5A0 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 8081A60C 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 8081A610 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_8081A614:

...
/* 80CC29C0 00000010  4B FF FF 39 */	bl _savegpr_29
...
/* 80CC29D0 00000020  3C 60 00 00 */	lis r3, j3dSys@ha
/* 80CC29D4 00000024  38 63 00 00 */	addi r3, j3dSys@l
...
/* 80CC2A00 00000050  3C 80 00 00 */	lis r4, calc_mtx@ha
/* 80CC2A04 00000054  38 84 00 00 */	addi r4, calc_mtx@l
/* 80CC2A08 00000058  80 84 00 00 */	lwz r4, 0(r4)
/* 80CC2A0C 0000005C  4B FF FE ED */	bl PSMTXCopy
/* 80CC2A10 00000060  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80CC2A14 00000064  38 63 00 00 */	addi r3, calc_mtx@l
/* 80CC2A18 00000068  80 63 00 00 */	lwz r3, 0(r3)
/* 80CC2A1C 0000006C  A8 9D 06 70 */	lha r4, 0x670(r29)
/* 80CC2A20 00000070  4B FF FE D9 */	bl mDoMtx_YrotM__FPA4_fs
/* 80CC2A24 00000074  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80CC2A28 00000078  38 63 00 00 */	addi r3, calc_mtx@l
...
/* 80CC2A3C 0000008C  4B FF FE BD */	bl PSMTXCopy
/* 80CC2A40 00000090  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 80CC2A44 00000094  38 63 00 00 */	addi r3, calc_mtx@l
/* 80CC2A48 00000098  80 63 00 00 */	lwz r3, 0(r3)
/* 80CC2A4C 0000009C  3C 80 00 00 */	lis r4, mCurrentMtx__6J3DSys@ha
/* 80CC2A50 000000A0  38 84 00 00 */	addi r4, mCurrentMtx__6J3DSys@l
/* 80CC2A54 000000A4  4B FF FE A5 */	bl PSMTXCopy
lbl_80CC2A58:
/* 80CC2A58 00000000  38 60 00 01 */	li r3, 1
/* 80CC2A5C 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 80CC2A60 00000008  4B FF FE 99 */	bl _restgpr_29

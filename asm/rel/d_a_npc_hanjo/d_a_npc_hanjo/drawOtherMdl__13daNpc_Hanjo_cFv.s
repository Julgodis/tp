...
/* 809FB2E4 00000018  3C 60 00 00 */	lis r3, m__19daNpc_Hanjo_Param_c@ha
/* 809FB2E8 0000001C  3B C3 00 00 */	addi r30, m__19daNpc_Hanjo_Param_c@l
...
/* 809FB32C 00000008  3C 60 00 00 */	lis r3, g_env_light@ha
/* 809FB330 0000000C  38 63 00 00 */	addi r3, g_env_light@l
...
/* 809FB354 00000030  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 809FB358 00000034  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 809FB35C 00000038  4B FF DC 9D */	bl PSMTXCopy
/* 809FB360 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809FB364 00000040  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 809FB3A8 00000014  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 809FB3AC 00000018  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 809FB3DC 00000010  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809FB3E0 00000014  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 809FB42C 00000004  3C 80 00 00 */	lis r4, l_motionAnmData@ha
/* 809FB430 00000008  38 A4 00 00 */	addi r5, l_motionAnmData@l
/* 809FB434 0000000C  80 05 01 90 */	lwz r0, 0x190(r5)
/* 809FB438 00000010  54 00 10 3A */	slwi r0, r0, 2
/* 809FB43C 00000014  3C 80 00 00 */	lis r4, l_resNameList@ha
/* 809FB440 00000018  38 84 00 00 */	addi r4, l_resNameList@l
...
/* 809FB460 00000038  3C 60 00 00 */	lis r3, g_env_light@ha
/* 809FB464 0000003C  38 63 00 00 */	addi r3, g_env_light@l
...
/* 809FB484 0000005C  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 809FB488 00000060  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
/* 809FB48C 00000064  4B FF DB 6D */	bl PSMTXCopy
/* 809FB490 00000068  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809FB494 0000006C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 809FB4B8 00000090  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809FB4BC 00000094  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 809FB4F8 00000018  3C 60 00 00 */	lis r3, G_CM3D_F_ABS_MIN@ha
/* 809FB4FC 0000001C  C0 03 00 00 */	lfs f0, G_CM3D_F_ABS_MIN@l(r3)
...
/* 809FB510 0000000C  3C 60 00 00 */	lis r3, g_env_light@ha
/* 809FB514 00000010  38 63 00 00 */	addi r3, g_env_light@l
...
/* 809FB530 0000002C  3C 80 00 00 */	lis r4, now__14mDoMtx_stack_c@ha
/* 809FB534 00000030  38 84 00 00 */	addi r4, now__14mDoMtx_stack_c@l
...
/* 809FB54C 00000048  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 809FB550 0000004C  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l

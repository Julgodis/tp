...
/* 80C2613C 00000018  3C 80 00 00 */	lis r4, LIT_3841@ha
/* 80C26140 0000001C  3B E4 00 00 */	addi r31, LIT_3841@l
...
lbl_80C2616C:
/* 80C2616C 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C26170 00000004  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
...
/* 80C26180 00000014  4B FF FE 79 */	bl PSMTXTrans
...
/* 80C2619C 00000030  4B FF FE 5D */	bl transM__14mDoMtx_stack_cFfff
/* 80C261A0 00000034  80 7E 05 78 */	lwz r3, 0x578(r30)
/* 80C261A4 00000038  4B FF FE 55 */	bl play__14mDoExt_baseAnmFv
/* 80C261A8 0000003C  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C261AC 00000040  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80C261B0 00000044  80 9E 05 74 */	lwz r4, 0x574(r30)
/* 80C261B4 00000048  38 84 00 24 */	addi r4, r4, 0x24
/* 80C261B8 0000004C  4B FF FE 41 */	bl PSMTXCopy
/* 80C261BC 00000050  48 00 00 30 */	b lbl_80C261EC
lbl_80C261C0:
/* 80C261C0 00000000  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C261C4 00000004  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80C261C8 00000008  80 9E 05 70 */	lwz r4, 0x570(r30)
/* 80C261CC 0000000C  38 84 00 24 */	addi r4, r4, 0x24
/* 80C261D0 00000010  4B FF FE 29 */	bl PSMTXCopy
/* 80C261D4 00000014  3C 60 00 00 */	lis r3, now__14mDoMtx_stack_c@ha
/* 80C261D8 00000018  38 63 00 00 */	addi r3, now__14mDoMtx_stack_c@l
/* 80C261DC 0000001C  38 9E 05 88 */	addi r4, r30, 0x588
/* 80C261E0 00000020  4B FF FE 19 */	bl PSMTXCopy
/* 80C261E4 00000024  80 7E 05 B8 */	lwz r3, 0x5b8(r30)
/* 80C261E8 00000028  4B FF FE 11 */	bl Move__4dBgWFv
lbl_80C261EC:

...
/* 80C98AFC 00000018  3C 60 00 00 */	lis r3, M_attr__18daObjMirrorScrew_c@ha
/* 80C98B00 0000001C  3B C3 00 00 */	addi r30, M_attr__18daObjMirrorScrew_c@l
...
/* 80C98B14 00000030  C8 3E 00 28 */	lfd f1, 0x28(r30)
...
/* 80C98B54 00000010  C0 3E 00 1C */	lfs f1, 0x1c(r30)
/* 80C98B58 00000014  D0 21 00 08 */	stfs f1, 8(r1)
/* 80C98B5C 00000018  C0 1E 00 20 */	lfs f0, 0x20(r30)
/* 80C98B60 0000001C  D0 01 00 0C */	stfs f0, 0xc(r1)
/* 80C98B64 00000020  D0 21 00 10 */	stfs f1, 0x10(r1)
/* 80C98B68 00000024  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C98B6C 00000028  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C98B80 0000003C  4B FF FF 39 */	bl StartQuake__12dVibration_cFii4cXyz
/* 80C98B84 00000040  80 9F 05 CC */	lwz r4, 0x5cc(r31)
/* 80C98B88 00000044  38 7E 00 00 */	addi r3, r30, 0
/* 80C98B8C 00000048  80 03 00 08 */	lwz r0, 8(r3)
...
/* 80C98BA8 00000064  3C 60 00 00 */	lis r3, ActionTable__18daObjMirrorScrew_c@ha
/* 80C98BAC 00000068  38 03 00 00 */	addi r0, ActionTable__18daObjMirrorScrew_c@l
...
/* 80C98BC0 0000007C  4B FF FE F9 */	bl __ptmf_scall
...
/* 80C98BD4 00000008  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C98BD8 0000000C  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
/* 80C98BDC 00000010  38 63 5B D4 */	addi r3, r3, 0x5bd4
/* 80C98BE0 00000014  38 80 00 1F */	li r4, 0x1f
/* 80C98BE4 00000018  4B FF FE D5 */	bl StopQuake__12dVibration_cFi
lbl_80C98BE8:

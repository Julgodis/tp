...
/* 80C07D58 0000000C  3C 80 00 00 */	lis r4, m__17daObj_GrA_Param_c@ha
/* 80C07D5C 00000010  3B C4 00 00 */	addi r30, m__17daObj_GrA_Param_c@l
/* 80C07D60 00000014  3C 80 00 00 */	lis r4, cNullVec__6Z2Calc@ha
/* 80C07D64 00000018  3B E4 00 00 */	addi r31, cNullVec__6Z2Calc@l
/* 80C07D68 0000001C  3C 80 00 00 */	lis r4, g_dComIfG_gameInfo@ha
/* 80C07D6C 00000020  38 84 00 00 */	addi r4, g_dComIfG_gameInfo@l
...
/* 80C07E1C 0000001C  3C 60 00 00 */	lis r3, s_sub__FPvPv@ha
/* 80C07E20 00000020  38 63 00 00 */	addi r3, s_sub__FPvPv@l
...
/* 80C07F48 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C07F4C 00000008  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C07FB8 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C07FBC 0000000C  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C08010 0000003C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C08014 00000040  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C08048 00000074  3C 60 00 00 */	lis r3, g_dComIfGoat_gameInfo@ha
/* 80C0804C 00000078  93 83 00 00 */	stw r28, g_dComIfGoat_gameInfo@l(r3)
...
/* 80C08100 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C08104 00000008  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
...
/* 80C08170 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C08174 0000000C  C0 23 00 00 */	lfs f1, __float_nan@l(r3)
lbl_80C08178:
...
/* 80C081D8 00000020  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C081DC 00000024  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C08210 00000058  3C 60 00 00 */	lis r3, g_dComIfGoat_gameInfo@ha
/* 80C08214 0000005C  93 83 00 00 */	stw r28, g_dComIfGoat_gameInfo@l(r3)
...
/* 80C082C4 00000004  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C082C8 00000008  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C08334 00000008  3C 60 00 00 */	lis r3, __float_nan@ha
/* 80C08338 0000000C  C3 E3 00 00 */	lfs f31, __float_nan@l(r3)
...
/* 80C0838C 0000003C  3C 60 00 00 */	lis r3, g_dComIfG_gameInfo@ha
/* 80C08390 00000040  38 63 00 00 */	addi r3, g_dComIfG_gameInfo@l
...
/* 80C083C4 00000074  3C 60 00 00 */	lis r3, g_dComIfGoat_gameInfo@ha
/* 80C083C8 00000078  93 83 00 00 */	stw r28, g_dComIfGoat_gameInfo@l(r3)
lbl_80C083CC:

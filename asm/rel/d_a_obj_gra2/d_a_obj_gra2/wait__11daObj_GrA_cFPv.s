...
/* 80C031FC 00000018  3C 80 00 00 */	lis r4, cNullVec__6Z2Calc@ha
/* 80C03200 0000001C  3B E4 00 00 */	addi r31, cNullVec__6Z2Calc@l
...
/* 80C03254 00000004  3C A0 00 00 */	lis r5, m__17daObj_GrA_Param_c@ha
/* 80C03258 00000008  38 A5 00 00 */	addi r5, m__17daObj_GrA_Param_c@l
/* 80C0325C 0000000C  C0 25 00 0C */	lfs f1, 0xc(r5)
...
/* 80C0326C 0000001C  3C A0 00 00 */	lis r5, LIT_4618@ha
/* 80C03270 00000020  C0 25 00 00 */	lfs f1, LIT_4618@l(r5)
/* 80C03274 00000024  4B FF E5 39 */	bl setFaceMotion__11daObj_GrA_cFif
/* 80C03278 00000028  80 7F 03 04 */	lwz r3, 0x304(r31)
/* 80C0327C 0000002C  80 1F 03 08 */	lwz r0, 0x308(r31)
/* 80C03280 00000030  90 61 00 2C */	stw r3, 0x2c(r1)
/* 80C03284 00000034  90 01 00 30 */	stw r0, 0x30(r1)
/* 80C03288 00000038  80 1F 03 0C */	lwz r0, 0x30c(r31)
...
/* 80C032A4 00000004  3C A0 00 00 */	lis r5, m__17daObj_GrA_Param_c@ha
/* 80C032A8 00000008  38 A5 00 00 */	addi r5, m__17daObj_GrA_Param_c@l
/* 80C032AC 0000000C  C0 25 00 0C */	lfs f1, 0xc(r5)
...
/* 80C032BC 0000001C  3C A0 00 00 */	lis r5, LIT_4618@ha
/* 80C032C0 00000020  C0 25 00 00 */	lfs f1, LIT_4618@l(r5)
/* 80C032C4 00000024  4B FF E4 E9 */	bl setFaceMotion__11daObj_GrA_cFif
/* 80C032C8 00000028  80 7F 03 10 */	lwz r3, 0x310(r31)
/* 80C032CC 0000002C  80 1F 03 14 */	lwz r0, 0x314(r31)
/* 80C032D0 00000030  90 61 00 20 */	stw r3, 0x20(r1)
/* 80C032D4 00000034  90 01 00 24 */	stw r0, 0x24(r1)
/* 80C032D8 00000038  80 1F 03 18 */	lwz r0, 0x318(r31)
...
lbl_80C032FC:
/* 80C032FC 00000000  80 9F 03 1C */	lwz r4, 0x31c(r31)
/* 80C03300 00000004  80 1F 03 20 */	lwz r0, 0x320(r31)
/* 80C03304 00000008  90 81 00 14 */	stw r4, 0x14(r1)
/* 80C03308 0000000C  90 01 00 18 */	stw r0, 0x18(r1)
/* 80C0330C 00000010  80 1F 03 24 */	lwz r0, 0x324(r31)
...
lbl_80C03320:
/* 80C03320 00000000  80 9F 03 28 */	lwz r4, 0x328(r31)
/* 80C03324 00000004  80 1F 03 2C */	lwz r0, 0x32c(r31)
/* 80C03328 00000008  90 81 00 08 */	stw r4, 8(r1)
/* 80C0332C 0000000C  90 01 00 0C */	stw r0, 0xc(r1)
/* 80C03330 00000010  80 1F 03 30 */	lwz r0, 0x330(r31)

...
/* 804FE608 0000000C  4B FF D6 D1 */	bl _savegpr_23
/* 804FE60C 00000010  7C 7D 1B 78 */	mr r29, r3
/* 804FE610 00000014  3C 60 00 00 */	lis r3, LIT_3788@ha
/* 804FE614 00000018  38 63 00 00 */	addi r3, LIT_3788@l
...
/* 804FE69C 00000018  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804FE6A0 0000001C  3B 23 00 00 */	addi r25, calc_mtx@l
lbl_804FE6A4:
...
/* 804FE6C0 0000001C  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 804FE6C4 00000020  38 63 00 00 */	addi r3, sincosTable___5JMath@l
...
/* 804FE6FC 00000010  3C 60 00 00 */	lis r3, sincosTable___5JMath@ha
/* 804FE700 00000014  38 63 00 00 */	addi r3, sincosTable___5JMath@l
...
/* 804FE730 00000044  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804FE734 00000048  38 63 00 00 */	addi r3, calc_mtx@l
/* 804FE738 0000004C  80 63 00 00 */	lwz r3, 0(r3)
/* 804FE73C 00000050  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 804FE740 00000054  4B FF D5 99 */	bl mDoMtx_YrotS__FPA4_fs
/* 804FE744 00000058  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804FE748 0000005C  38 63 00 00 */	addi r3, calc_mtx@l
/* 804FE74C 00000060  80 63 00 00 */	lwz r3, 0(r3)
/* 804FE750 00000064  3C 80 00 00 */	lis r4, data_80500C78@ha
/* 804FE754 00000068  38 04 00 00 */	addi r0, data_80500C78@l
...
/* 804FE76C 00000080  4B FF D5 6D */	bl mDoMtx_XrotM__FPA4_fs
/* 804FE770 00000084  48 00 00 38 */	b lbl_804FE7A8
lbl_804FE774:
/* 804FE774 00000000  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804FE778 00000004  38 63 00 00 */	addi r3, calc_mtx@l
/* 804FE77C 00000008  80 63 00 00 */	lwz r3, 0(r3)
/* 804FE780 0000000C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)
/* 804FE784 00000010  4B FF D5 55 */	bl mDoMtx_YrotS__FPA4_fs
/* 804FE788 00000014  3C 60 00 00 */	lis r3, calc_mtx@ha
/* 804FE78C 00000018  38 63 00 00 */	addi r3, calc_mtx@l
/* 804FE790 0000001C  80 63 00 00 */	lwz r3, 0(r3)
/* 804FE794 00000020  3C 80 00 00 */	lis r4, data_80500C78@ha
/* 804FE798 00000024  38 04 00 00 */	addi r0, data_80500C78@l
/* 804FE79C 00000028  7C 80 E2 14 */	add r4, r0, r28
/* 804FE7A0 0000002C  A8 84 FF FE */	lha r4, -2(r4)
/* 804FE7A4 00000030  4B FF D5 35 */	bl mDoMtx_XrotM__FPA4_fs
lbl_804FE7A8:
...
/* 804FE7B8 00000010  4B FF D5 21 */	bl MtxScale__FfffUc
/* 804FE7BC 00000014  38 61 00 20 */	addi r3, r1, 0x20
/* 804FE7C0 00000018  38 81 00 14 */	addi r4, r1, 0x14
/* 804FE7C4 0000001C  4B FF D5 15 */	bl MtxPosition__FP4cXyzP4cXyz
lbl_804FE7C8:
...
/* 804FE814 0000004C  4B FF D4 C5 */	bl cM_atan2s__Fff
...
/* 804FE83C 00000004  4B FF D4 9D */	bl cM_atan2s__Fff
...
/* 804FE878 00000040  4B FF D4 61 */	bl __pl__4cXyzCFRC3Vec
...
/* 804FE8E4 00000008  4B FF D3 F5 */	bl _restgpr_23

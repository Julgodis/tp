...
/* 8034404C  38 03 C5 70 */	addi r0, r3, Ecb@l                       /* constant-address: 8044C570, symbol: Ecb */
/* 80344050  7F C0 22 14 */	add r30, r0, r4                         
/* 80344054  4B FF 96 A1 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80344058  7C 7D 1B 78 */	mr r29, r3                              
/* 8034405C  80 1E 00 0C */	lwz r0, 0xc(r30)                        
/* 80344060  54 00 06 F7 */	rlwinm. r0, r0, 0, 0x1b, 0x1b           
/* 80344064  41 82 00 7C */	beq lbl_803440E0                         /* constant-address: 803440E0, symbol: lbl_803440E0 */
/* 80344068  28 1C 00 00 */	cmplwi r28, 0                           
/* 8034406C  41 82 00 64 */	beq lbl_803440D0                         /* constant-address: 803440D0, symbol: lbl_803440D0 */
...
/* 80344080  40 81 00 28 */	ble lbl_803440A8                         /* constant-address: 803440A8, symbol: lbl_803440A8 */
lbl_80344084:
/* 80344084  80 03 00 28 */	lwz r0, 0x28(r3)                        
/* 80344088  7C 00 F8 40 */	cmplw r0, r31                           
/* 8034408C  40 82 00 14 */	bne lbl_803440A0                         /* constant-address: 803440A0, symbol: lbl_803440A0 */
/* 80344090  7F A3 EB 78 */	mr r3, r29                              
/* 80344094  4B FF 96 89 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 80344098  38 60 00 00 */	li r3, 0                                
/* 8034409C  48 00 00 6C */	b lbl_80344108                           /* constant-address: 80344108, symbol: lbl_80344108 */
lbl_803440A0:
/* 803440A0  38 63 00 08 */	addi r3, r3, 8                          
/* 803440A4  42 00 FF E0 */	bdnz lbl_80344084                        /* constant-address: 80344084, symbol: lbl_80344084 */
lbl_803440A8:
...
/* 803440D4  4B FF 96 49 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 803440D8  38 60 00 00 */	li r3, 0                                
/* 803440DC  48 00 00 2C */	b lbl_80344108                           /* constant-address: 80344108, symbol: lbl_80344108 */
lbl_803440E0:
...
/* 803440F8  4B FF EB 15 */	bl SetExiInterruptMask                   /* constant-address: 80342C0C, symbol: SetExiInterruptMask */
/* 803440FC  7F A3 EB 78 */	mr r3, r29                              
/* 80344100  4B FF 96 1D */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

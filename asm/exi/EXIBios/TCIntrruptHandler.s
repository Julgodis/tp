...
/* 80343B98  38 63 55 56 */	addi r3, r3, 0x5556 /* 0x55555556@l */   /* constant-address: 55555556 */
...
/* 80343BB0  38 03 C5 70 */	addi r0, r3, Ecb@l                       /* constant-address: 8044C570, symbol: Ecb */
/* 80343BB4  7F E0 22 14 */	add r31, r0, r4                         
/* 80343BB8  3C 00 80 00 */	lis r0, 0x8000                          
/* 80343BBC  7C 03 2C 30 */	srw r3, r0, r5                          
/* 80343BC0  4B FF 9E FD */	bl __OSMaskInterrupts                    /* constant-address: 8033DABC, symbol: __OSMaskInterrupts */
/* 80343BC4  1C FE 00 14 */	mulli r7, r30, 0x14                     
/* 80343BC8  3C C0 CC 00 */	lis r6, 0xCC00 /* 0xCC006800@ha */      
/* 80343BCC  38 66 68 00 */	addi r3, r6, 0x6800 /* 0xCC006800@l */   /* constant-address: CC006800 */
...
/* 80343BF0  41 82 01 74 */	beq lbl_80343D64                         /* constant-address: 80343D64, symbol: lbl_80343D64 */
...
/* 80343C04  41 82 01 2C */	beq lbl_80343D30                         /* constant-address: 80343D30, symbol: lbl_80343D30 */
/* 80343C08  80 1F 00 0C */	lwz r0, 0xc(r31)                        
/* 80343C0C  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 80343C10  41 82 01 14 */	beq lbl_80343D24                         /* constant-address: 80343D24, symbol: lbl_80343D24 */
/* 80343C14  80 7F 00 10 */	lwz r3, 0x10(r31)                       
/* 80343C18  2C 03 00 00 */	cmpwi r3, 0                             
/* 80343C1C  41 82 01 08 */	beq lbl_80343D24                         /* constant-address: 80343D24, symbol: lbl_80343D24 */
/* 80343C20  80 BF 00 14 */	lwz r5, 0x14(r31)                       
/* 80343C24  38 06 68 00 */	addi r0, r6, 0x6800                      /* constant-address: CC006800 */
/* 80343C28  7C C0 3A 14 */	add r6, r0, r7                          
/* 80343C2C  80 06 00 10 */	lwz r0, 0x10(r6)                        
/* 80343C30  40 81 00 F4 */	ble lbl_80343D24                         /* constant-address: 80343D24, symbol: lbl_80343D24 */
/* 80343C34  38 E3 FF F8 */	addi r7, r3, -8                         
/* 80343C38  2C 03 00 08 */	cmpwi r3, 8                             
/* 80343C3C  40 81 00 BC */	ble lbl_80343CF8                         /* constant-address: 80343CF8, symbol: lbl_80343CF8 */
...
/* 80343C50  40 81 00 A8 */	ble lbl_80343CF8                         /* constant-address: 80343CF8, symbol: lbl_80343CF8 */
lbl_80343C54:
...
/* 80343CF4  42 00 FF 60 */	bdnz lbl_80343C54                        /* constant-address: 80343C54, symbol: lbl_80343C54 */
lbl_80343CF8:
/* 80343CF8  7C C4 18 50 */	subf r6, r4, r3                         
/* 80343CFC  7C C9 03 A6 */	mtctr r6                                
/* 80343D00  7C 04 18 00 */	cmpw r4, r3                             
/* 80343D04  40 80 00 20 */	bge lbl_80343D24                         /* constant-address: 80343D24, symbol: lbl_80343D24 */
lbl_80343D08:
...
/* 80343D20  42 00 FF E8 */	bdnz lbl_80343D08                        /* constant-address: 80343D08, symbol: lbl_80343D08 */
lbl_80343D24:
...
/* 80343D34  4B FF 82 CD */	bl OSClearContext                        /* constant-address: 8033C000, symbol: OSClearContext */
/* 80343D38  38 61 00 20 */	addi r3, r1, 0x20                       
/* 80343D3C  4B FF 80 FD */	bl OSSetCurrentContext                   /* constant-address: 8033BE38, symbol: OSSetCurrentContext */
...
/* 80343D58  4B FF 82 A9 */	bl OSClearContext                        /* constant-address: 8033C000, symbol: OSClearContext */
/* 80343D5C  7F 83 E3 78 */	mr r3, r28                              
/* 80343D60  4B FF 80 D9 */	bl OSSetCurrentContext                   /* constant-address: 8033BE38, symbol: OSSetCurrentContext */
lbl_80343D64:

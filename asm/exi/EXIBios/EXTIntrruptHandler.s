...
/* 80343DB0  38 63 55 56 */	addi r3, r3, 0x5556 /* 0x55555556@l */   /* constant-address: 55555556 */
...
/* 80343DCC  4B FF 9C F1 */	bl __OSMaskInterrupts                    /* constant-address: 8033DABC, symbol: __OSMaskInterrupts */
/* 80343DD0  57 C4 30 32 */	slwi r4, r30, 6                         
/* 80343DD4  3C 60 80 45 */	lis r3, Ecb@ha                          
/* 80343DD8  38 03 C5 70 */	addi r0, r3, Ecb@l                       /* constant-address: 8044C570, symbol: Ecb */
...
/* 80343DF4  41 82 00 40 */	beq lbl_80343E34                         /* constant-address: 80343E34, symbol: lbl_80343E34 */
/* 80343DF8  38 61 00 10 */	addi r3, r1, 0x10                       
/* 80343DFC  4B FF 82 05 */	bl OSClearContext                        /* constant-address: 8033C000, symbol: OSClearContext */
/* 80343E00  38 61 00 10 */	addi r3, r1, 0x10                       
/* 80343E04  4B FF 80 35 */	bl OSSetCurrentContext                   /* constant-address: 8033BE38, symbol: OSSetCurrentContext */
...
/* 80343E28  4B FF 81 D9 */	bl OSClearContext                        /* constant-address: 8033C000, symbol: OSClearContext */
/* 80343E2C  7F E3 FB 78 */	mr r3, r31                              
/* 80343E30  4B FF 80 09 */	bl OSSetCurrentContext                   /* constant-address: 8033BE38, symbol: OSSetCurrentContext */
lbl_80343E34:

...
/* 8015BED0  48 00 0B E9 */	bl move_proc_call__8daItem_cFv           /* constant-address: 8015CAB8, symbol: move_proc_call__8daItem_cFv */
/* 8015BED4  38 7F 04 EC */	addi r3, r31, 0x4ec                     
/* 8015BED8  38 9F 09 30 */	addi r4, r31, 0x930                     
/* 8015BEDC  48 10 B1 91 */	bl __ne__4cXyzCFRC3Vec                   /* constant-address: 8026706C, symbol: __ne__4cXyzCFRC3Vec */
/* 8015BEE0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8015BEE4  41 82 00 70 */	beq lbl_8015BF54                         /* constant-address: 8015BF54, symbol: lbl_8015BF54 */
/* 8015BEE8  7F E3 FB 78 */	mr r3, r31                              
/* 8015BEEC  4B FF F1 CD */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
...
/* 8015BF00  4B FF F1 B9 */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
...
/* 8015BF14  4B FF F1 A5 */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
...
/* 8015BF30  48 11 48 11 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
/* 8015BF34  38 7F 04 F0 */	addi r3, r31, 0x4f0                     
/* 8015BF38  C0 3F 09 34 */	lfs f1, 0x934(r31)                      
/* 8015BF3C  FC 40 F0 90 */	fmr f2, f30                             
/* 8015BF40  48 11 48 01 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
/* 8015BF44  38 7F 04 F4 */	addi r3, r31, 0x4f4                     
/* 8015BF48  C0 3F 09 38 */	lfs f1, 0x938(r31)                      
/* 8015BF4C  FC 40 E8 90 */	fmr f2, f29                             
/* 8015BF50  48 11 47 F1 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
lbl_8015BF54:
/* 8015BF54  A8 1F 09 42 */	lha r0, 0x942(r31)                      
/* 8015BF58  2C 00 00 00 */	cmpwi r0, 0                             
/* 8015BF5C  40 82 00 40 */	bne lbl_8015BF9C                         /* constant-address: 8015BF9C, symbol: lbl_8015BF9C */
/* 8015BF60  A8 1F 09 44 */	lha r0, 0x944(r31)                      
/* 8015BF64  2C 00 00 00 */	cmpwi r0, 0                             
/* 8015BF68  40 82 00 0C */	bne lbl_8015BF74                         /* constant-address: 8015BF74, symbol: lbl_8015BF74 */
/* 8015BF6C  7F E3 FB 78 */	mr r3, r31                              
/* 8015BF70  48 00 15 11 */	bl deleteItem__8daItem_cFv               /* constant-address: 8015D480, symbol: deleteItem__8daItem_cFv */
lbl_8015BF74:
/* 8015BF74  7F E3 FB 78 */	mr r3, r31                              
/* 8015BF78  4B FF F1 41 */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
...
/* 8015BF90  40 82 00 0C */	bne lbl_8015BF9C                         /* constant-address: 8015BF9C, symbol: lbl_8015BF9C */
/* 8015BF94  7F E3 FB 78 */	mr r3, r31                              
/* 8015BF98  4B ED BA ED */	bl changeDraw__12daItemBase_cFv          /* constant-address: 80037A84, symbol: changeDraw__12daItemBase_cFv */
lbl_8015BF9C:
/* 8015BF9C  38 7F 09 04 */	addi r3, r31, 0x904                     
/* 8015BFA0  38 9F 04 D0 */	addi r4, r31, 0x4d0                     
/* 8015BFA4  48 11 32 39 */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
/* 8015BFA8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015BFAC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015BFB0  38 63 23 3C */	addi r3, r3, 0x233c                      /* constant-address: 804084FC, symbol: None */
/* 8015BFB4  38 9F 07 E0 */	addi r4, r31, 0x7e0                     
/* 8015BFB8  48 10 8B F1 */	bl Set__4cCcSFP8cCcD_Obj                 /* constant-address: 80264BA8, symbol: Set__4cCcSFP8cCcD_Obj */

...
/* 8015D58C  C0 02 9B 50 */	lfs f0, lit_3857(r2)                     /* constant-address: 80453550, symbol: lit_3857 */
/* 8015D590  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8015D594  4C 40 13 82 */	cror 2, 0, 2                            
/* 8015D598  40 82 00 20 */	bne lbl_8015D5B8                         /* constant-address: 8015D5B8, symbol: lbl_8015D5B8 */
/* 8015D59C  D0 1F 05 30 */	stfs f0, 0x530(r31)                     
/* 8015D5A0  4B FF DB 19 */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
/* 8015D5A4  C0 23 00 20 */	lfs f1, 0x20(r3)                        
/* 8015D5A8  C0 02 9B 50 */	lfs f0, lit_3857(r2)                     /* constant-address: 80453550, symbol: lit_3857 */
...
/* 8015D5C0  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015D5C4  38 84 0F 38 */	addi r4, r4, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 8015D5C8  4B F1 94 E5 */	bl CrrPos__9dBgS_AcchFR4dBgS             /* constant-address: 80076AAC, symbol: CrrPos__9dBgS_AcchFR4dBgS */
/* 8015D5CC  80 7F 05 B8 */	lwz r3, 0x5b8(r31)                      
/* 8015D5D0  54 60 06 31 */	rlwinm. r0, r3, 0, 0x18, 0x18           
/* 8015D5D4  40 82 00 0C */	bne lbl_8015D5E0                         /* constant-address: 8015D5E0, symbol: lbl_8015D5E0 */
/* 8015D5D8  54 60 06 B5 */	rlwinm. r0, r3, 0, 0x1a, 0x1a           
/* 8015D5DC  41 82 00 34 */	beq lbl_8015D610                         /* constant-address: 8015D610, symbol: lbl_8015D610 */
lbl_8015D5E0:
...
/* 8015D5F4  C0 22 9B 50 */	lfs f1, lit_3857(r2)                     /* constant-address: 80453550, symbol: lit_3857 */
/* 8015D5F8  D0 3F 04 F8 */	stfs f1, 0x4f8(r31)                     
/* 8015D5FC  C0 02 9B BC */	lfs f0, lit_4923(r2)                     /* constant-address: 804535BC, symbol: lit_4923 */
/* 8015D600  D0 1F 04 FC */	stfs f0, 0x4fc(r31)                     
/* 8015D604  D0 3F 05 00 */	stfs f1, 0x500(r31)                     
/* 8015D608  D0 3F 05 2C */	stfs f1, 0x52c(r31)                     
/* 8015D60C  48 00 00 48 */	b lbl_8015D654                           /* constant-address: 8015D654, symbol: lbl_8015D654 */
lbl_8015D610:
/* 8015D610  C0 02 9B 50 */	lfs f0, lit_3857(r2)                     /* constant-address: 80453550, symbol: lit_3857 */
/* 8015D614  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8015D618  40 80 00 3C */	bge lbl_8015D654                         /* constant-address: 8015D654, symbol: lbl_8015D654 */
/* 8015D61C  7F E3 FB 78 */	mr r3, r31                              
/* 8015D620  4B FF DA 99 */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
/* 8015D624  C3 E3 00 24 */	lfs f31, 0x24(r3)                       
/* 8015D628  7F E3 FB 78 */	mr r3, r31                              
/* 8015D62C  4B FF DA 8D */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
...
/* 8015D644  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */

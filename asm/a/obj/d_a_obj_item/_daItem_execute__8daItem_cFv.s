...
/* 8015BAC8  48 00 1E 95 */	bl CountTimer__8daItem_cFv               /* constant-address: 8015D95C, symbol: CountTimer__8daItem_cFv */
...
/* 8015BAE8  38 63 ED 78 */	addi r3, r3, item_info__10dItem_data@l   /* constant-address: 803AED78, symbol: item_info__10dItem_data */
...
/* 8015BB00  C8 22 9B 88 */	lfd f1, lit_4072(r2)                     /* constant-address: 80453588, symbol: lit_4072 */
...
/* 8015BB18  C0 02 9B 70 */	lfs f0, lit_3923(r2)                     /* constant-address: 80453570, symbol: lit_3923 */
...
/* 8015BB44  4B F2 89 1D */	bl ChkTgHit__12dCcD_GObjInfFv            /* constant-address: 80084460, symbol: ChkTgHit__12dCcD_GObjInfFv */
/* 8015BB48  28 03 00 00 */	cmplwi r3, 0                            
/* 8015BB4C  41 82 00 38 */	beq lbl_8015BB84                         /* constant-address: 8015BB84, symbol: lbl_8015BB84 */
/* 8015BB50  38 7F 07 E0 */	addi r3, r31, 0x7e0                     
/* 8015BB54  4B F2 89 A5 */	bl GetTgHitObj__12dCcD_GObjInfFv         /* constant-address: 800844F8, symbol: GetTgHitObj__12dCcD_GObjInfFv */
/* 8015BB58  28 03 00 00 */	cmplwi r3, 0                            
/* 8015BB5C  41 82 00 28 */	beq lbl_8015BB84                         /* constant-address: 8015BB84, symbol: lbl_8015BB84 */
/* 8015BB60  80 03 00 10 */	lwz r0, 0x10(r3)                        
/* 8015BB64  54 00 04 63 */	rlwinm. r0, r0, 0, 0x11, 0x11           
/* 8015BB68  41 82 00 1C */	beq lbl_8015BB84                         /* constant-address: 8015BB84, symbol: lbl_8015BB84 */
/* 8015BB6C  38 7F 09 78 */	addi r3, r31, 0x978                     
/* 8015BB70  3C 80 00 04 */	lis r4, 0x0004 /* 0x00040009@ha */      
/* 8015BB74  38 84 00 09 */	addi r4, r4, 0x0009 /* 0x00040009@l */   /* constant-address: 00040009 */
/* 8015BB78  38 A0 00 00 */	li r5, 0                                
/* 8015BB7C  38 C0 00 00 */	li r6, 0                                
/* 8015BB80  48 16 29 25 */	bl startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase /* constant-address: 802BE4A4, symbol: startCollisionSE__14Z2SoundObjBaseFUlUlP14Z2SoundObjBase */
lbl_8015BB84:
...
/* 8015BB90  38 03 9E 98 */	addi r0, r3, mFuncPtr__8daItem_c@l       /* constant-address: 803B9E98, symbol: mFuncPtr__8daItem_c */
/* 8015BB94  7C 60 22 14 */	add r3, r0, r4                          
/* 8015BB98  48 20 64 81 */	bl __ptmf_test                           /* constant-address: 80362018, symbol: __ptmf_test */
/* 8015BB9C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8015BBA0  41 82 00 24 */	beq lbl_8015BBC4                         /* constant-address: 8015BBC4, symbol: lbl_8015BBC4 */
...
/* 8015BBB4  38 04 9E 98 */	addi r0, r4, mFuncPtr__8daItem_c@l       /* constant-address: 803B9E98, symbol: mFuncPtr__8daItem_c */
/* 8015BBB8  7D 80 2A 14 */	add r12, r0, r5                         
/* 8015BBBC  48 20 64 C9 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 8015BBC0  60 00 00 00 */	nop                                     
lbl_8015BBC4:
/* 8015BBC4  88 1F 09 5F */	lbz r0, 0x95f(r31)                      
/* 8015BBC8  28 00 00 00 */	cmplwi r0, 0                            
/* 8015BBCC  41 82 00 38 */	beq lbl_8015BC04                         /* constant-address: 8015BC04, symbol: lbl_8015BC04 */
/* 8015BBD0  80 1F 04 9C */	lwz r0, 0x49c(r31)                      
/* 8015BBD4  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb             
/* 8015BBD8  40 82 00 2C */	bne lbl_8015BC04                         /* constant-address: 8015BC04, symbol: lbl_8015BC04 */
/* 8015BBDC  7F E3 FB 78 */	mr r3, r31                              
/* 8015BBE0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha           
/* 8015BBE4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015BBE8  80 84 5D AC */	lwz r4, 0x5dac(r4)                       /* constant-address: 8040BF6C, symbol: None */
/* 8015BBEC  4B EB EB F5 */	bl fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c /* constant-address: 8001A7E0, symbol: fopAcM_searchActorDistance__FPC10fopAc_ac_cPC10fopAc_ac_c */
/* 8015BBF0  C0 02 9B 90 */	lfs f0, lit_4320(r2)                     /* constant-address: 80453590, symbol: lit_4320 */
/* 8015BBF4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015BBF8  40 80 00 0C */	bge lbl_8015BC04                         /* constant-address: 8015BC04, symbol: lbl_8015BC04 */
/* 8015BBFC  7F E3 FB 78 */	mr r3, r31                              
/* 8015BC00  48 00 12 ED */	bl itemGetNextExecute__8daItem_cFv       /* constant-address: 8015CEEC, symbol: itemGetNextExecute__8daItem_cFv */
lbl_8015BC04:
/* 8015BC04  80 1F 04 9C */	lwz r0, 0x49c(r31)                      
/* 8015BC08  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb             
/* 8015BC0C  41 82 00 B0 */	beq lbl_8015BCBC                         /* constant-address: 8015BCBC, symbol: lbl_8015BCBC */
...
/* 8015BC30  41 82 00 24 */	beq lbl_8015BC54                         /* constant-address: 8015BC54, symbol: lbl_8015BC54 */
/* 8015BC34  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8015BC38  80 63 00 28 */	lwz r3, 0x28(r3)                        
/* 8015BC3C  80 63 00 00 */	lwz r3, 0(r3)                           
/* 8015BC40  C0 22 9B 70 */	lfs f1, lit_3923(r2)                     /* constant-address: 80453570, symbol: lit_3923 */
...
/* 8015BC58  4B EB 11 0D */	bl transS__14mDoMtx_stack_cFRC4cXyz      /* constant-address: 8000CD64, symbol: transS__14mDoMtx_stack_cFRC4cXyz */
/* 8015BC5C  38 7F 04 E4 */	addi r3, r31, 0x4e4                     
/* 8015BC60  4B EB 12 E5 */	bl ZXYrotM__14mDoMtx_stack_cFRC5csXyz    /* constant-address: 8000CF44, symbol: ZXYrotM__14mDoMtx_stack_cFRC5csXyz */
/* 8015BC64  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8015BC68  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8015BC6C  7C 64 1B 78 */	mr r4, r3                               
/* 8015BC70  48 1E A9 41 */	bl PSMTXInverse                          /* constant-address: 803465B0, symbol: PSMTXInverse */
/* 8015BC74  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8015BC78  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8015BC7C  38 81 00 08 */	addi r4, r1, 8                          
/* 8015BC80  7C 85 23 78 */	mr r5, r4                               
/* 8015BC84  48 1E B0 E9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 8015BC88  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015BC8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015BC90  80 63 5D AC */	lwz r3, 0x5dac(r3)                       /* constant-address: 8040BF6C, symbol: None */
/* 8015BC94  28 1F 00 00 */	cmplwi r31, 0                           
/* 8015BC98  41 82 00 0C */	beq lbl_8015BCA4                         /* constant-address: 8015BCA4, symbol: lbl_8015BCA4 */
/* 8015BC9C  80 9F 00 04 */	lwz r4, 4(r31)                          
/* 8015BCA0  48 00 00 08 */	b lbl_8015BCA8                           /* constant-address: 8015BCA8, symbol: lbl_8015BCA8 */
lbl_8015BCA4:
...
/* 8015BCC0  C0 22 9B 7C */	lfs f1, lit_4069(r2)                     /* constant-address: 8045357C, symbol: lit_4069 */
...
/* 8015BCD8  4B FE 93 65 */	bl animPlay__12daItemBase_cFffffff       /* constant-address: 8014503C, symbol: animPlay__12daItemBase_cFffffff */
/* 8015BCDC  7F E3 FB 78 */	mr r3, r31                              
/* 8015BCE0  4B FF F4 29 */	bl setBaseMtx__8daItem_cFv               /* constant-address: 8015B108, symbol: setBaseMtx__8daItem_cFv */
/* 8015BCE4  88 1F 04 E2 */	lbz r0, 0x4e2(r31)                      
/* 8015BCE8  7C 03 07 74 */	extsb r3, r0                            
/* 8015BCEC  4B ED 13 81 */	bl dComIfGp_getReverb__Fi                /* constant-address: 8002D06C, symbol: dComIfGp_getReverb__Fi */
...
/* 8015BD38  41 82 00 0C */	beq lbl_8015BD44                         /* constant-address: 8015BD44, symbol: lbl_8015BD44 */
/* 8015BD3C  28 00 00 07 */	cmplwi r0, 7                            
/* 8015BD40  40 82 00 2C */	bne lbl_8015BD6C                         /* constant-address: 8015BD6C, symbol: lbl_8015BD6C */
lbl_8015BD44:
...
/* 8015BD60  C0 02 9B 94 */	lfs f0, lit_4321(r2)                     /* constant-address: 80453594, symbol: lit_4321 */

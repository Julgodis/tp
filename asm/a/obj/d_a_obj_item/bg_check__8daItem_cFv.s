...
/* 8015D750  41 82 00 34 */	beq lbl_8015D784                         /* constant-address: 8015D784, symbol: lbl_8015D784 */
/* 8015D754  C0 3F 05 2C */	lfs f1, 0x52c(r31)                      
/* 8015D758  C0 02 9B C4 */	lfs f0, lit_5050(r2)                     /* constant-address: 804535C4, symbol: lit_5050 */
/* 8015D75C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015D760  40 81 00 14 */	ble lbl_8015D774                         /* constant-address: 8015D774, symbol: lbl_8015D774 */
/* 8015D764  38 7F 04 F8 */	addi r3, r31, 0x4f8                     
/* 8015D768  38 9F 07 64 */	addi r4, r31, 0x764                     
/* 8015D76C  C0 22 9B 7C */	lfs f1, lit_4069(r2)                     /* constant-address: 8045357C, symbol: lit_4069 */
/* 8015D770  4B FF D6 5D */	bl Reflect__FP4cXyzRC13cBgS_PolyInfof    /* constant-address: 8015ADCC, symbol: Reflect__FP4cXyzRC13cBgS_PolyInfof */
lbl_8015D774:
/* 8015D774  C0 3F 04 F8 */	lfs f1, 0x4f8(r31)                      
/* 8015D778  C0 5F 05 00 */	lfs f2, 0x500(r31)                      
/* 8015D77C  48 10 9E F9 */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */
/* 8015D780  B0 7F 04 DE */	sth r3, 0x4de(r31)                      
lbl_8015D784:
/* 8015D784  80 1F 05 B8 */	lwz r0, 0x5b8(r31)                      
/* 8015D788  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18           
/* 8015D78C  41 82 00 94 */	beq lbl_8015D820                         /* constant-address: 8015D820, symbol: lbl_8015D820 */
...
/* 8015D7AC  C0 02 9B C4 */	lfs f0, lit_5050(r2)                     /* constant-address: 804535C4, symbol: lit_5050 */
/* 8015D7B0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015D7B4  40 81 00 1C */	ble lbl_8015D7D0                         /* constant-address: 8015D7D0, symbol: lbl_8015D7D0 */
/* 8015D7B8  7F E3 FB 78 */	mr r3, r31                              
/* 8015D7BC  4B FF D8 FD */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
/* 8015D7C0  C0 23 00 04 */	lfs f1, 4(r3)                           
/* 8015D7C4  38 61 00 08 */	addi r3, r1, 8                          
/* 8015D7C8  38 9F 07 64 */	addi r4, r31, 0x764                     
/* 8015D7CC  4B FF D6 01 */	bl Reflect__FP4cXyzRC13cBgS_PolyInfof    /* constant-address: 8015ADCC, symbol: Reflect__FP4cXyzRC13cBgS_PolyInfof */
lbl_8015D7D0:
/* 8015D7D0  7F E3 FB 78 */	mr r3, r31                              
/* 8015D7D4  4B FF D8 E5 */	bl getData__12daItemBase_cFv             /* constant-address: 8015B0B8, symbol: getData__12daItemBase_cFv */
...
/* 8015D7F0  C0 02 9B C8 */	lfs f0, lit_5051(r2)                     /* constant-address: 804535C8, symbol: lit_5051 */
/* 8015D7F4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015D7F8  40 80 00 0C */	bge lbl_8015D804                         /* constant-address: 8015D804, symbol: lbl_8015D804 */
/* 8015D7FC  C0 02 9B 50 */	lfs f0, lit_3857(r2)                     /* constant-address: 80453550, symbol: lit_3857 */
/* 8015D800  D0 1F 05 2C */	stfs f0, 0x52c(r31)                     
lbl_8015D804:
/* 8015D804  88 7F 09 4B */	lbz r3, 0x94b(r31)                      
/* 8015D808  28 03 00 64 */	cmplwi r3, 0x64                         
/* 8015D80C  40 80 00 0C */	bge lbl_8015D818                         /* constant-address: 8015D818, symbol: lbl_8015D818 */
/* 8015D810  38 03 00 01 */	addi r0, r3, 1                          
/* 8015D814  98 1F 09 4B */	stb r0, 0x94b(r31)                      
lbl_8015D818:
/* 8015D818  7F E3 FB 78 */	mr r3, r31                              
/* 8015D81C  48 00 00 19 */	bl set_bound_se__8daItem_cFv             /* constant-address: 8015D834, symbol: set_bound_se__8daItem_cFv */
lbl_8015D820:

...
/* 8015C14C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015C150  80 83 5D AC */	lwz r4, 0x5dac(r3)                       /* constant-address: 8040BF6C, symbol: None */
/* 8015C154  38 61 00 08 */	addi r3, r1, 8                          
/* 8015C158  48 00 1E 81 */	bl getItemPos__9daPy_py_cCFv             /* constant-address: 8015DFD8, symbol: getItemPos__9daPy_py_cCFv */
...
/* 8015C174  C0 02 9B 98 */	lfs f0, lit_4404(r2)                     /* constant-address: 80453598, symbol: lit_4404 */
...
/* 8015C190  4B EB E5 3D */	bl fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz /* constant-address: 8001A6CC, symbol: fopAcM_posMoveF__FP10fopAc_ac_cPC4cXyz */
/* 8015C194  C0 1F 04 D4 */	lfs f0, 0x4d4(r31)                      
/* 8015C198  C0 21 00 18 */	lfs f1, 0x18(r1)                        
/* 8015C19C  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8015C1A0  40 80 00 08 */	bge lbl_8015C1A8                         /* constant-address: 8015C1A8, symbol: lbl_8015C1A8 */
/* 8015C1A4  D0 3F 04 D4 */	stfs f1, 0x4d4(r31)                     
lbl_8015C1A8:
/* 8015C1A8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015C1AC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015C1B0  80 63 5D 74 */	lwz r3, 0x5d74(r3)                       /* constant-address: 8040BF34, symbol: None */
...
/* 8015C1E0  40 80 00 0C */	bge lbl_8015C1EC                         /* constant-address: 8015C1EC, symbol: lbl_8015C1EC */
/* 8015C1E4  7F E3 FB 78 */	mr r3, r31                              
/* 8015C1E8  4B EB DA 95 */	bl fopAcM_delete__FP10fopAc_ac_c         /* constant-address: 80019C7C, symbol: fopAcM_delete__FP10fopAc_ac_c */
lbl_8015C1EC:

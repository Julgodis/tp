...
/* 8015D980  80 0D 81 28 */	lwz r0, m_timer_max__8daItem_c(r13)      /* constant-address: 804506A8, symbol: m_timer_max__8daItem_c */
/* 8015D984  7C 03 00 00 */	cmpw r3, r0                             
/* 8015D988  40 80 00 0C */	bge lbl_8015D994                         /* constant-address: 8015D994, symbol: lbl_8015D994 */
/* 8015D98C  38 03 00 01 */	addi r0, r3, 1                          
/* 8015D990  B0 1F 09 28 */	sth r0, 0x928(r31)                      
lbl_8015D994:
/* 8015D994  7F E3 FB 78 */	mr r3, r31                              
/* 8015D998  4B FF F9 D9 */	bl checkCountTimer__8daItem_cFv          /* constant-address: 8015D370, symbol: checkCountTimer__8daItem_cFv */
/* 8015D99C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8015D9A0  41 82 00 30 */	beq lbl_8015D9D0                         /* constant-address: 8015D9D0, symbol: lbl_8015D9D0 */
/* 8015D9A4  A8 7F 09 42 */	lha r3, 0x942(r31)                      
/* 8015D9A8  2C 03 00 00 */	cmpwi r3, 0                             
/* 8015D9AC  40 81 00 10 */	ble lbl_8015D9BC                         /* constant-address: 8015D9BC, symbol: lbl_8015D9BC */
/* 8015D9B0  38 03 FF FF */	addi r0, r3, -1                         
/* 8015D9B4  B0 1F 09 42 */	sth r0, 0x942(r31)                      
/* 8015D9B8  48 00 00 18 */	b lbl_8015D9D0                           /* constant-address: 8015D9D0, symbol: lbl_8015D9D0 */
lbl_8015D9BC:
/* 8015D9BC  A8 7F 09 44 */	lha r3, 0x944(r31)                      
/* 8015D9C0  2C 03 00 00 */	cmpwi r3, 0                             
/* 8015D9C4  40 81 00 0C */	ble lbl_8015D9D0                         /* constant-address: 8015D9D0, symbol: lbl_8015D9D0 */
/* 8015D9C8  38 03 FF FF */	addi r0, r3, -1                         
/* 8015D9CC  B0 1F 09 44 */	sth r0, 0x944(r31)                      
lbl_8015D9D0:
/* 8015D9D0  38 7F 09 5E */	addi r3, r31, 0x95e                     
/* 8015D9D4  4B FE 41 15 */	bl func_80141AE8                         /* constant-address: 80141AE8, symbol: func_80141AE8 */

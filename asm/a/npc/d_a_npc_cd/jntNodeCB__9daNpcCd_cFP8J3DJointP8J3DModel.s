...
/* 80157094  48 20 B1 45 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 801570B8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 801570BC  48 1E F3 F5 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 801570C0  80 1C 09 C4 */	lwz r0, 0x9c4(r28)                      
/* 801570C4  C0 42 9A D0 */	lfs f2, lit_4582(r2)                     /* constant-address: 804534D0, symbol: lit_4582 */
/* 801570C8  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 801570CC  40 80 00 24 */	bge lbl_801570F0                         /* constant-address: 801570F0, symbol: lbl_801570F0 */
/* 801570D0  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 801570D4  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 801570EC  48 00 00 20 */	b lbl_8015710C                           /* constant-address: 8015710C, symbol: lbl_8015710C */
lbl_801570F0:
/* 801570F0  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 801570F4  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157110  C8 22 9A C8 */	lfd f1, lit_4375(r2)                     /* constant-address: 804534C8, symbol: lit_4375 */
...
/* 8015713C  C0 42 9A D0 */	lfs f2, lit_4582(r2)                     /* constant-address: 804534D0, symbol: lit_4582 */
/* 80157140  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 80157144  40 80 00 24 */	bge lbl_80157168                         /* constant-address: 80157168, symbol: lbl_80157168 */
/* 80157148  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 8015714C  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157164  48 00 00 20 */	b lbl_80157184                           /* constant-address: 80157184, symbol: lbl_80157184 */
lbl_80157168:
/* 80157168  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 8015716C  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157188  C8 22 9A C8 */	lfd f1, lit_4375(r2)                     /* constant-address: 804534C8, symbol: lit_4375 */
...
/* 801571B4  C0 42 9A D0 */	lfs f2, lit_4582(r2)                     /* constant-address: 804534D0, symbol: lit_4582 */
/* 801571B8  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 801571BC  40 80 00 24 */	bge lbl_801571E0                         /* constant-address: 801571E0, symbol: lbl_801571E0 */
/* 801571C0  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 801571C4  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 801571DC  48 00 00 20 */	b lbl_801571FC                           /* constant-address: 801571FC, symbol: lbl_801571FC */
lbl_801571E0:
/* 801571E0  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 801571E4  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157200  C8 22 9A C8 */	lfd f1, lit_4375(r2)                     /* constant-address: 804534C8, symbol: lit_4375 */
...
/* 80157230  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 80157234  4B EB 50 6D */	bl mDoMtx_ZXYrotM__FPA4_fsss             /* constant-address: 8000C2A0, symbol: mDoMtx_ZXYrotM__FPA4_fsss */
/* 80157238  80 1C 09 C4 */	lwz r0, 0x9c4(r28)                      
/* 8015723C  C0 22 9A C0 */	lfs f1, lit_4373(r2)                     /* constant-address: 804534C0, symbol: lit_4373 */
/* 80157240  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 80157244  40 80 00 24 */	bge lbl_80157268                         /* constant-address: 80157268, symbol: lbl_80157268 */
/* 80157248  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 8015724C  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157264  48 00 00 20 */	b lbl_80157284                           /* constant-address: 80157284, symbol: lbl_80157284 */
lbl_80157268:
/* 80157268  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 8015726C  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157288  C0 22 9A C0 */	lfs f1, lit_4373(r2)                     /* constant-address: 804534C0, symbol: lit_4373 */
/* 8015728C  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 80157290  40 80 00 24 */	bge lbl_801572B4                         /* constant-address: 801572B4, symbol: lbl_801572B4 */
/* 80157294  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 80157298  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 801572B0  48 00 00 20 */	b lbl_801572D0                           /* constant-address: 801572D0, symbol: lbl_801572D0 */
lbl_801572B4:
/* 801572B4  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 801572B8  38 83 59 84 */	addi r4, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 801572D4  C0 22 9A C0 */	lfs f1, lit_4373(r2)                     /* constant-address: 804534C0, symbol: lit_4373 */
/* 801572D8  2C 00 00 10 */	cmpwi r0, 0x10                          
/* 801572DC  40 80 00 24 */	bge lbl_80157300                         /* constant-address: 80157300, symbol: lbl_80157300 */
/* 801572E0  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 801572E4  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 801572FC  48 00 00 20 */	b lbl_8015731C                           /* constant-address: 8015731C, symbol: lbl_8015731C */
lbl_80157300:
/* 80157300  3C 60 80 42 */	lis r3, l_Cd_HIO@ha                     
/* 80157304  38 63 59 84 */	addi r3, r3, l_Cd_HIO@l                  /* constant-address: 80425984, symbol: l_Cd_HIO */
...
/* 80157320  4B EB 5A 7D */	bl transM__14mDoMtx_stack_cFfff          /* constant-address: 8000CD9C, symbol: transM__14mDoMtx_stack_cFfff */
/* 80157324  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 80157328  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8015732C  80 9D 00 84 */	lwz r4, 0x84(r29)                       
/* 80157330  80 04 00 0C */	lwz r0, 0xc(r4)                         
/* 80157334  7C 80 F2 14 */	add r4, r0, r30                         
/* 80157338  48 1E F1 79 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 8015733C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 80157340  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 80157344  3C 80 80 43 */	lis r4, mCurrentMtx__6J3DSys@ha         
/* 80157348  38 84 4B E4 */	addi r4, r4, mCurrentMtx__6J3DSys@l      /* constant-address: 80434BE4, symbol: mCurrentMtx__6J3DSys */
/* 8015734C  48 1E F1 65 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 80157350  38 60 00 01 */	li r3, 1                                
/* 80157354  39 61 00 50 */	addi r11, r1, 0x50                      
/* 80157358  48 20 AE CD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

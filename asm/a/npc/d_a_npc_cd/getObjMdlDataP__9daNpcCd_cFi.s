...
/* 801575A8  38 03 2C E8 */	addi r0, r3, l_objTbl@l                  /* constant-address: 80392CE8, symbol: l_objTbl */
/* 801575AC  7C 60 22 14 */	add r3, r0, r4                          
/* 801575B0  41 82 00 10 */	beq lbl_801575C0                         /* constant-address: 801575C0, symbol: lbl_801575C0 */
/* 801575B4  3C 60 80 39 */	lis r3, l_objTWTbl@ha                   
/* 801575B8  38 03 2D 30 */	addi r0, r3, l_objTWTbl@l                /* constant-address: 80392D30, symbol: l_objTWTbl */
/* 801575BC  7C 60 22 14 */	add r3, r0, r4                          
lbl_801575C0:
/* 801575C0  80 83 00 04 */	lwz r4, 4(r3)                           
/* 801575C4  2C 04 00 00 */	cmpwi r4, 0                             
/* 801575C8  40 81 00 24 */	ble lbl_801575EC                         /* constant-address: 801575EC, symbol: lbl_801575EC */
/* 801575CC  80 63 00 00 */	lwz r3, 0(r3)                           
/* 801575D0  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha           
/* 801575D4  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801575D8  3C A5 00 02 */	addis r5, r5, 2                         
/* 801575DC  38 C0 00 80 */	li r6, 0x80                             
/* 801575E0  38 A5 C2 F8 */	addi r5, r5, -15624                     
/* 801575E4  4B EE 4D 09 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci /* constant-address: 8003C2EC, symbol: getRes__14dRes_control_cFPCclP11dRes_info_ci */

...
/* 80159C44  4B EF 7B 6D */	bl dPath_GetPnt__FPC5dPathi              /* constant-address: 800517B0, symbol: dPath_GetPnt__FPC5dPathi */
/* 80159C48  C0 5F 00 08 */	lfs f2, 8(r31)                          
/* 80159C4C  C0 1F 00 00 */	lfs f0, 0(r31)                          
/* 80159C50  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 80159C54  C0 22 9A E4 */	lfs f1, lit_4585(r2)                     /* constant-address: 804534E4, symbol: lit_4585 */
...
/* 80159C7C  48 1E D7 21 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 80159C80  C0 02 9A E4 */	lfs f0, lit_4585(r2)                     /* constant-address: 804534E4, symbol: lit_4585 */
/* 80159C84  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80159C88  40 81 00 58 */	ble lbl_80159CE0                         /* constant-address: 80159CE0, symbol: lbl_80159CE0 */
/* 80159C8C  FC 00 08 34 */	frsqrte f0, f1                          
/* 80159C90  C8 82 9B 28 */	lfd f4, lit_5051(r2)                     /* constant-address: 80453528, symbol: lit_5051 */
/* 80159C94  FC 44 00 32 */	fmul f2, f4, f0                         
/* 80159C98  C8 62 9B 30 */	lfd f3, lit_5052(r2)                     /* constant-address: 80453530, symbol: lit_5052 */
...
/* 80159CDC  48 00 00 88 */	b lbl_80159D64                           /* constant-address: 80159D64, symbol: lbl_80159D64 */
lbl_80159CE0:
/* 80159CE0  C8 02 9B 38 */	lfd f0, lit_5053(r2)                     /* constant-address: 80453538, symbol: lit_5053 */
/* 80159CE4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80159CE8  40 80 00 10 */	bge lbl_80159CF8                         /* constant-address: 80159CF8, symbol: lbl_80159CF8 */
/* 80159CEC  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 80159CF0  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 80159CF4  48 00 00 70 */	b lbl_80159D64                           /* constant-address: 80159D64, symbol: lbl_80159D64 */
lbl_80159CF8:
...
/* 80159D0C  41 82 00 14 */	beq lbl_80159D20                         /* constant-address: 80159D20, symbol: lbl_80159D20 */
/* 80159D10  40 80 00 40 */	bge lbl_80159D50                         /* constant-address: 80159D50, symbol: lbl_80159D50 */
/* 80159D14  2C 03 00 00 */	cmpwi r3, 0                             
/* 80159D18  41 82 00 20 */	beq lbl_80159D38                         /* constant-address: 80159D38, symbol: lbl_80159D38 */
/* 80159D1C  48 00 00 34 */	b lbl_80159D50                           /* constant-address: 80159D50, symbol: lbl_80159D50 */
lbl_80159D20:
/* 80159D20  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 80159D24  41 82 00 0C */	beq lbl_80159D30                         /* constant-address: 80159D30, symbol: lbl_80159D30 */
/* 80159D28  38 00 00 01 */	li r0, 1                                
/* 80159D2C  48 00 00 28 */	b lbl_80159D54                           /* constant-address: 80159D54, symbol: lbl_80159D54 */
lbl_80159D30:
/* 80159D30  38 00 00 02 */	li r0, 2                                
/* 80159D34  48 00 00 20 */	b lbl_80159D54                           /* constant-address: 80159D54, symbol: lbl_80159D54 */
lbl_80159D38:
/* 80159D38  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 80159D3C  41 82 00 0C */	beq lbl_80159D48                         /* constant-address: 80159D48, symbol: lbl_80159D48 */
/* 80159D40  38 00 00 05 */	li r0, 5                                
/* 80159D44  48 00 00 10 */	b lbl_80159D54                           /* constant-address: 80159D54, symbol: lbl_80159D54 */
lbl_80159D48:
/* 80159D48  38 00 00 03 */	li r0, 3                                
/* 80159D4C  48 00 00 08 */	b lbl_80159D54                           /* constant-address: 80159D54, symbol: lbl_80159D54 */
lbl_80159D50:
/* 80159D50  38 00 00 04 */	li r0, 4                                
lbl_80159D54:
/* 80159D54  2C 00 00 01 */	cmpwi r0, 1                             
/* 80159D58  40 82 00 0C */	bne lbl_80159D64                         /* constant-address: 80159D64, symbol: lbl_80159D64 */
/* 80159D5C  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 80159D60  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_80159D64:
/* 80159D64  FC 01 F8 40 */	fcmpo cr0, f1, f31                      
/* 80159D68  41 80 00 10 */	blt lbl_80159D78                         /* constant-address: 80159D78, symbol: lbl_80159D78 */
/* 80159D6C  C0 02 9A E8 */	lfs f0, lit_4586(r2)                     /* constant-address: 804534E8, symbol: lit_4586 */
/* 80159D70  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80159D74  40 80 00 0C */	bge lbl_80159D80                         /* constant-address: 80159D80, symbol: lbl_80159D80 */
lbl_80159D78:
/* 80159D78  38 60 00 01 */	li r3, 1                                
/* 80159D7C  48 00 00 24 */	b lbl_80159DA0                           /* constant-address: 80159DA0, symbol: lbl_80159DA0 */
lbl_80159D80:
...
/* 80159D90  C0 02 9A E4 */	lfs f0, lit_4585(r2)                     /* constant-address: 804534E4, symbol: lit_4585 */

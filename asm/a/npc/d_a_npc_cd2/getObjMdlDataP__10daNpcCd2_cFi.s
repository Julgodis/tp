...
/* 8015996C  38 03 35 20 */	addi r0, r3, l_objTbl@l                  /* constant-address: 80393520, symbol: l_objTbl */
/* 80159970  7C 60 22 14 */	add r3, r0, r4                          
/* 80159974  41 82 00 10 */	beq lbl_80159984                         /* constant-address: 80159984, symbol: lbl_80159984 */
/* 80159978  3C 60 80 39 */	lis r3, l_objTWTbl@ha                   
/* 8015997C  38 03 35 88 */	addi r0, r3, l_objTWTbl@l                /* constant-address: 80393588, symbol: l_objTWTbl */
/* 80159980  7C 60 22 14 */	add r3, r0, r4                          
lbl_80159984:
/* 80159984  80 83 00 04 */	lwz r4, 4(r3)                           
/* 80159988  2C 04 00 00 */	cmpwi r4, 0                             
/* 8015998C  40 81 00 24 */	ble lbl_801599B0                         /* constant-address: 801599B0, symbol: lbl_801599B0 */
/* 80159990  80 63 00 00 */	lwz r3, 0(r3)                           
/* 80159994  3C A0 80 40 */	lis r5, g_dComIfG_gameInfo@ha           
/* 80159998  38 A5 61 C0 */	addi r5, r5, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015999C  3C A5 00 02 */	addis r5, r5, 2                         
/* 801599A0  38 C0 00 80 */	li r6, 0x80                             
/* 801599A4  38 A5 C2 F8 */	addi r5, r5, -15624                     
/* 801599A8  4B EE 29 45 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci /* constant-address: 8003C2EC, symbol: getRes__14dRes_control_cFPCclP11dRes_info_ci */

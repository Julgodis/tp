...
/* 8001F3D4  40 82 00 6C */	bne lbl_8001F440                         /* constant-address: 8001F440, symbol: lbl_8001F440 */
/* 8001F3D8  83 C3 00 10 */	lwz r30, 0x10(r3)                       
/* 8001F3DC  38 6D 87 68 */	la r3, fopKy_KANKYO_TYPE(r13) /* 80450CE8-_SDA_BASE_ */ /* constant-address: 80450CE8, symbol: fopKy_KANKYO_TYPE */
/* 8001F3E0  48 00 12 7D */	bl fpcBs_MakeOfType__FPi                 /* constant-address: 8002065C, symbol: fpcBs_MakeOfType__FPi */
...
/* 8001F3F8  48 00 10 FD */	bl fopDwTg_Init__FP16create_tag_classPv  /* constant-address: 800204F4, symbol: fopDwTg_Init__FP16create_tag_classPv */
/* 8001F3FC  80 7F 00 AC */	lwz r3, 0xac(r31)                       
/* 8001F400  28 03 00 00 */	cmplwi r3, 0                            
/* 8001F404  41 82 00 3C */	beq lbl_8001F440                         /* constant-address: 8001F440, symbol: lbl_8001F440 */
...
/* 8001F448  48 00 30 85 */	bl fpcMtd_Create__FP20process_method_classPv /* constant-address: 800224CC, symbol: fpcMtd_Create__FP20process_method_classPv */
/* 8001F44C  7C 7E 1B 78 */	mr r30, r3                              
/* 8001F450  2C 1E 00 04 */	cmpwi r30, 4                            
/* 8001F454  40 82 00 18 */	bne lbl_8001F46C                         /* constant-address: 8001F46C, symbol: lbl_8001F46C */
/* 8001F458  7F E3 FB 78 */	mr r3, r31                              
/* 8001F45C  48 00 25 A5 */	bl fpcLf_GetPriority__FPC14leafdraw_class /* constant-address: 80021A00, symbol: fpcLf_GetPriority__FPC14leafdraw_class */
/* 8001F460  7C 64 07 34 */	extsh r4, r3                            
/* 8001F464  38 7F 00 C4 */	addi r3, r31, 0xc4                      
/* 8001F468  48 00 10 45 */	bl fopDwTg_ToDrawQ__FP16create_tag_classi /* constant-address: 800204AC, symbol: fopDwTg_ToDrawQ__FP16create_tag_classi */
lbl_8001F46C:

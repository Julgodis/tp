...
/* 8001906C  40 82 03 30 */	bne lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 80019070  83 C3 00 10 */	lwz r30, 0x10(r3)                       
/* 80019074  38 6D 87 38 */	la r3, g_fopAc_type(r13) /* 80450CB8-_SDA_BASE_ */ /* constant-address: 80450CB8, symbol: g_fopAc_type */
/* 80019078  48 00 75 E5 */	bl fpcBs_MakeOfType__FPi                 /* constant-address: 8002065C, symbol: fpcBs_MakeOfType__FPi */
...
/* 80019090  48 00 07 F1 */	bl fopAcTg_Init__FP16create_tag_classPv  /* constant-address: 80019880, symbol: fopAcTg_Init__FP16create_tag_classPv */
/* 80019094  38 7F 00 C4 */	addi r3, r31, 0xc4                      
/* 80019098  48 00 07 9D */	bl fopAcTg_ToActorQ__FP16create_tag_class /* constant-address: 80019834, symbol: fopAcTg_ToActorQ__FP16create_tag_class */
/* 8001909C  38 7F 00 D8 */	addi r3, r31, 0xd8                      
/* 800190A0  7F E4 FB 78 */	mr r4, r31                              
/* 800190A4  48 00 74 51 */	bl fopDwTg_Init__FP16create_tag_classPv  /* constant-address: 800204F4, symbol: fopDwTg_Init__FP16create_tag_classPv */
...
/* 800190C8  41 82 00 D4 */	beq lbl_8001919C                         /* constant-address: 8001919C, symbol: lbl_8001919C */
...
/* 8001912C  C0 42 81 D0 */	lfs f2, lit_4431(r2)                     /* constant-address: 80451BD0, symbol: lit_4431 */
/* 80019130  88 04 00 1A */	lbz r0, 0x1a(r4)                        
/* 80019134  C8 22 81 D8 */	lfd f1, lit_4434(r2)                     /* constant-address: 80451BD8, symbol: lit_4434 */
...
/* 80019234  C0 02 81 D4 */	lfs f0, lit_4432(r2)                     /* constant-address: 80451BD4, symbol: lit_4432 */
...
/* 800192AC  48 18 F6 41 */	bl dKy_tevstr_init__FP12dKy_tevstr_cScUc /* constant-address: 801A88EC, symbol: dKy_tevstr_init__FP12dKy_tevstr_cScUc */
/* 800192B0  88 8D 87 E4 */	lbz r4, struct_80450D64+0x0(r13)         /* constant-address: 80450D64, symbol: struct_80450D64+0x0 */
/* 800192B4  7C 84 07 75 */	extsb. r4, r4                           
/* 800192B8  41 80 00 24 */	blt lbl_800192DC                         /* constant-address: 800192DC, symbol: lbl_800192DC */
/* 800192BC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800192C0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800192C4  38 63 4E C4 */	addi r3, r3, 0x4ec4                      /* constant-address: 8040B084, symbol: None */
/* 800192C8  48 00 B0 BD */	bl getStatusRoomDt__20dStage_roomControl_cFi /* constant-address: 80024384, symbol: getStatusRoomDt__20dStage_roomControl_cFi */
/* 800192CC  81 83 00 00 */	lwz r12, 0(r3)                           /* constant-address: 8040B084, symbol: None */
...
/* 800192E8  41 80 00 28 */	blt lbl_80019310                         /* constant-address: 80019310, symbol: lbl_80019310 */
/* 800192EC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800192F0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800192F4  38 63 4E C4 */	addi r3, r3, 0x4ec4                      /* constant-address: 8040B084, symbol: None */
/* 800192F8  7C 84 07 74 */	extsb r4, r4                            
/* 800192FC  48 00 B0 89 */	bl getStatusRoomDt__20dStage_roomControl_cFi /* constant-address: 80024384, symbol: getStatusRoomDt__20dStage_roomControl_cFi */
/* 80019300  81 83 00 00 */	lwz r12, 0(r3)                           /* constant-address: 8040B084, symbol: None */
...
/* 80019314  41 82 00 88 */	beq lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 80019318  80 03 00 00 */	lwz r0, 0(r3)                            /* constant-address: 00000000 */
/* 8001931C  54 00 00 85 */	rlwinm. r0, r0, 0, 2, 2                 
/* 80019320  40 82 00 40 */	bne lbl_80019360                         /* constant-address: 80019360, symbol: lbl_80019360 */
/* 80019324  88 83 00 1B */	lbz r4, 0x1b(r3)                         /* constant-address: 0000001B */
/* 80019328  28 04 00 FF */	cmplwi r4, 0xff                         
/* 8001932C  41 82 00 70 */	beq lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 80019330  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80019334  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80019338  88 BF 04 BA */	lbz r5, 0x4ba(r31)                      
/* 8001933C  7C A5 07 74 */	extsb r5, r5                            
/* 80019340  48 01 C0 21 */	bl isSwitch__10dSv_info_cCFii            /* constant-address: 80035360, symbol: isSwitch__10dSv_info_cCFii */
/* 80019344  2C 03 00 00 */	cmpwi r3, 0                             
/* 80019348  41 82 00 54 */	beq lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 8001934C  88 1E 00 2C */	lbz r0, 0x2c(r30)                       
/* 80019350  28 00 00 02 */	cmplwi r0, 2                            
/* 80019354  40 82 00 48 */	bne lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 80019358  38 60 00 05 */	li r3, 5                                
/* 8001935C  48 00 00 88 */	b lbl_800193E4                           /* constant-address: 800193E4, symbol: lbl_800193E4 */
lbl_80019360:
/* 80019360  88 83 00 1B */	lbz r4, 0x1b(r3)                         /* constant-address: 0000001B */
/* 80019364  28 04 00 FF */	cmplwi r4, 0xff                         
/* 80019368  41 82 00 34 */	beq lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 8001936C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80019370  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80019374  88 BF 04 BA */	lbz r5, 0x4ba(r31)                      
/* 80019378  7C A5 07 74 */	extsb r5, r5                            
/* 8001937C  48 01 BF E5 */	bl isSwitch__10dSv_info_cCFii            /* constant-address: 80035360, symbol: isSwitch__10dSv_info_cCFii */
/* 80019380  2C 03 00 00 */	cmpwi r3, 0                             
/* 80019384  40 82 00 18 */	bne lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 80019388  88 1E 00 2C */	lbz r0, 0x2c(r30)                       
/* 8001938C  28 00 00 02 */	cmplwi r0, 2                            
/* 80019390  40 82 00 0C */	bne lbl_8001939C                         /* constant-address: 8001939C, symbol: lbl_8001939C */
/* 80019394  38 60 00 05 */	li r3, 5                                
/* 80019398  48 00 00 4C */	b lbl_800193E4                           /* constant-address: 800193E4, symbol: lbl_800193E4 */
lbl_8001939C:
/* 8001939C  80 7F 00 EC */	lwz r3, 0xec(r31)                       
/* 800193A0  7F E4 FB 78 */	mr r4, r31                              
/* 800193A4  48 00 91 29 */	bl fpcMtd_Create__FP20process_method_classPv /* constant-address: 800224CC, symbol: fpcMtd_Create__FP20process_method_classPv */
/* 800193A8  7C 7E 1B 78 */	mr r30, r3                              
/* 800193AC  2C 1E 00 04 */	cmpwi r30, 4                            
/* 800193B0  40 82 00 1C */	bne lbl_800193CC                         /* constant-address: 800193CC, symbol: lbl_800193CC */
/* 800193B4  7F E3 FB 78 */	mr r3, r31                              
/* 800193B8  48 00 86 49 */	bl fpcLf_GetPriority__FPC14leafdraw_class /* constant-address: 80021A00, symbol: fpcLf_GetPriority__FPC14leafdraw_class */
/* 800193BC  7C 64 07 34 */	extsh r4, r3                            
/* 800193C0  38 7F 00 D8 */	addi r3, r31, 0xd8                      
/* 800193C4  48 00 70 E9 */	bl fopDwTg_ToDrawQ__FP16create_tag_classi /* constant-address: 800204AC, symbol: fopDwTg_ToDrawQ__FP16create_tag_classi */
/* 800193C8  48 00 00 18 */	b lbl_800193E0                           /* constant-address: 800193E0, symbol: lbl_800193E0 */
lbl_800193CC:
/* 800193CC  2C 1E 00 05 */	cmpwi r30, 5                            
/* 800193D0  40 82 00 10 */	bne lbl_800193E0                         /* constant-address: 800193E0, symbol: lbl_800193E0 */

...
/* 8001F5A8  40 82 00 70 */	bne lbl_8001F618                         /* constant-address: 8001F618, symbol: lbl_8001F618 */
/* 8001F5AC  83 C3 00 10 */	lwz r30, 0x10(r3)                       
/* 8001F5B0  38 6D 87 70 */	la r3, fopMsg_MSG_TYPE(r13) /* 80450CF0-_SDA_BASE_ */ /* constant-address: 80450CF0, symbol: fopMsg_MSG_TYPE */
/* 8001F5B4  48 00 10 A9 */	bl fpcBs_MakeOfType__FPi                 /* constant-address: 8002065C, symbol: fpcBs_MakeOfType__FPi */
...
/* 8001F5CC  48 00 0F 29 */	bl fopDwTg_Init__FP16create_tag_classPv  /* constant-address: 800204F4, symbol: fopDwTg_Init__FP16create_tag_classPv */
/* 8001F5D0  7F E3 FB 78 */	mr r3, r31                              
/* 8001F5D4  48 00 04 71 */	bl fopMsgM_GetAppend__FPv                /* constant-address: 8001FA44, symbol: fopMsgM_GetAppend__FPv */
/* 8001F5D8  28 03 00 00 */	cmplwi r3, 0                            
/* 8001F5DC  41 82 00 3C */	beq lbl_8001F618                         /* constant-address: 8001F618, symbol: lbl_8001F618 */
...
/* 8001F620  48 00 2E AD */	bl fpcMtd_Create__FP20process_method_classPv /* constant-address: 800224CC, symbol: fpcMtd_Create__FP20process_method_classPv */
/* 8001F624  7C 7E 1B 78 */	mr r30, r3                              
/* 8001F628  2C 1E 00 04 */	cmpwi r30, 4                            
/* 8001F62C  40 82 00 18 */	bne lbl_8001F644                         /* constant-address: 8001F644, symbol: lbl_8001F644 */
/* 8001F630  7F E3 FB 78 */	mr r3, r31                              
/* 8001F634  48 00 23 CD */	bl fpcLf_GetPriority__FPC14leafdraw_class /* constant-address: 80021A00, symbol: fpcLf_GetPriority__FPC14leafdraw_class */
/* 8001F638  7C 64 07 34 */	extsh r4, r3                            
/* 8001F63C  38 7F 00 C4 */	addi r3, r31, 0xc4                      
/* 8001F640  48 00 0E 6D */	bl fopDwTg_ToDrawQ__FP16create_tag_classi /* constant-address: 800204AC, symbol: fopDwTg_ToDrawQ__FP16create_tag_classi */
lbl_8001F644:

...
/* 8001FA7C  48 34 27 55 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8001FA9C  48 24 37 8D */	bl memalignB__3cMlFiUl                   /* constant-address: 80263228, symbol: memalignB__3cMlFiUl */
/* 8001FAA0  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8001FAA4  40 82 00 0C */	bne lbl_8001FAB0                         /* constant-address: 8001FAB0, symbol: lbl_8001FAB0 */
/* 8001FAA8  38 60 00 00 */	li r3, 0                                
/* 8001FAAC  48 00 00 8C */	b lbl_8001FB38                           /* constant-address: 8001FB38, symbol: lbl_8001FB38 */
lbl_8001FAB0:
/* 8001FAB0  93 5F 00 00 */	stw r26, 0(r31)                         
/* 8001FAB4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8001FAB8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8001FABC  80 03 5D BC */	lwz r0, 0x5dbc(r3)                       /* constant-address: 8040BF7C, symbol: None */
/* 8001FAC0  28 00 00 00 */	cmplwi r0, 0                            
/* 8001FAC4  41 82 00 0C */	beq lbl_8001FAD0                         /* constant-address: 8001FAD0, symbol: lbl_8001FAD0 */
/* 8001FAC8  7F 43 D3 78 */	mr r3, r26                              
/* 8001FACC  48 21 87 A1 */	bl setTalkActor__12dMsgObject_cFP10fopAc_ac_c /* constant-address: 8023826C, symbol: setTalkActor__12dMsgObject_cFP10fopAc_ac_c */
lbl_8001FAD0:
/* 8001FAD0  28 1C 00 00 */	cmplwi r28, 0                           
/* 8001FAD4  41 82 00 0C */	beq lbl_8001FAE0                         /* constant-address: 8001FAE0, symbol: lbl_8001FAE0 */
/* 8001FAD8  80 1C 00 00 */	lwz r0, 0(r28)                          
/* 8001FADC  90 1F 00 10 */	stw r0, 0x10(r31)                       
lbl_8001FAE0:
/* 8001FAE0  28 1D 00 00 */	cmplwi r29, 0                           
/* 8001FAE4  41 82 00 0C */	beq lbl_8001FAF0                         /* constant-address: 8001FAF0, symbol: lbl_8001FAF0 */
/* 8001FAE8  80 1D 00 00 */	lwz r0, 0(r29)                          
/* 8001FAEC  90 1F 00 14 */	stw r0, 0x14(r31)                       
lbl_8001FAF0:
/* 8001FAF0  28 1B 00 00 */	cmplwi r27, 0                           
/* 8001FAF4  41 82 00 20 */	beq lbl_8001FB14                         /* constant-address: 8001FB14, symbol: lbl_8001FB14 */
...
/* 8001FB10  48 00 00 20 */	b lbl_8001FB30                           /* constant-address: 8001FB30, symbol: lbl_8001FB30 */
lbl_8001FB14:
/* 8001FB14  C0 02 82 70 */	lfs f0, lit_3902(r2)                     /* constant-address: 80451C70, symbol: lit_3902 */
...
/* 8001FB3C  48 34 26 E1 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

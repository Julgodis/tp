...
/* 8001FB80  48 34 26 55 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8001FBB0  48 24 36 79 */	bl memalignB__3cMlFiUl                   /* constant-address: 80263228, symbol: memalignB__3cMlFiUl */
/* 8001FBB4  28 03 00 00 */	cmplwi r3, 0                            
/* 8001FBB8  40 82 00 0C */	bne lbl_8001FBC4                         /* constant-address: 8001FBC4, symbol: lbl_8001FBC4 */
/* 8001FBBC  38 60 00 00 */	li r3, 0                                
/* 8001FBC0  48 00 00 54 */	b lbl_8001FC14                           /* constant-address: 8001FC14, symbol: lbl_8001FC14 */
lbl_8001FBC4:
/* 8001FBC4  38 00 00 00 */	li r0, 0                                
/* 8001FBC8  90 03 00 00 */	stw r0, 0(r3)                            /* constant-address: 0000FFFC */
/* 8001FBCC  90 03 00 10 */	stw r0, 0x10(r3)                         /* constant-address: 0001000C */
/* 8001FBD0  90 03 00 14 */	stw r0, 0x14(r3)                         /* constant-address: 00010010 */
/* 8001FBD4  C0 02 82 70 */	lfs f0, lit_3902(r2)                     /* constant-address: 80451C70, symbol: lit_3902 */
/* 8001FBD8  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 8001FBDC  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 8001FBE0  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 8001FBE4  D0 03 00 04 */	stfs f0, 4(r3)                           /* constant-address: 00010000 */
/* 8001FBE8  D0 03 00 08 */	stfs f0, 8(r3)                           /* constant-address: 00010004 */
/* 8001FBEC  D0 03 00 0C */	stfs f0, 0xc(r3)                         /* constant-address: 00010008 */
/* 8001FBF0  93 E3 00 18 */	stw r31, 0x18(r3)                        /* constant-address: 00010014 */
/* 8001FBF4  93 63 00 1C */	stw r27, 0x1c(r3)                        /* constant-address: 00010018 */
/* 8001FBF8  93 83 00 20 */	stw r28, 0x20(r3)                        /* constant-address: 0001001C */
/* 8001FBFC  9B A3 00 24 */	stb r29, 0x24(r3)                        /* constant-address: 00010020 */
/* 8001FC00  9B C3 00 25 */	stb r30, 0x25(r3)                        /* constant-address: 00010021 */
/* 8001FC04  D3 83 00 28 */	stfs f28, 0x28(r3)                       /* constant-address: 00010024 */
/* 8001FC08  D3 A3 00 2C */	stfs f29, 0x2c(r3)                       /* constant-address: 00010028 */
/* 8001FC0C  D3 C3 00 30 */	stfs f30, 0x30(r3)                       /* constant-address: 0001002C */
/* 8001FC10  D3 E3 00 34 */	stfs f31, 0x34(r3)                       /* constant-address: 00010030 */
lbl_8001FC14:
...
/* 8001FC38  48 34 25 E9 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

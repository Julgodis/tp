...
/* ###################################################################################### */
.section .text, "ax"
/* 8001E140 0030 .text      fopCam_Draw__FP12camera_class  fopCam_Draw__FP12camera_class  */
.global fopCam_Draw__FP12camera_class
...
/* 8001E164 0001B0A4  40 82 00 0C */	bne func_8001E170
/* 8001E168 0001B0A8  80 64 02 24 */	lwz r3, 0x224(r4)
/* 8001E16C 0001B0AC  48 00 38 B9 */	bl fpcLf_DrawMethod__FP21leafdraw_method_classPv

/* 8001E170 0010 .text      func_8001E170                  func_8001E170                  */
...
/* 8001E180 0038 .text      fopCam_Execute__FP12camera_class fopCam_Execute__FP12camera_class */
.global fopCam_Execute__FP12camera_class
...
/* 8001E1A0 0001B0E0  40 82 00 18 */	bne func_8001E1B8
/* 8001E1A4 0001B0E4  88 0D 8B A4 */	lbz r0, sym_80451124-_SDA_BASE_(r13)
/* 8001E1A8 0001B0E8  7C 00 07 75 */	extsb. r0, r0
/* 8001E1AC 0001B0EC  40 82 00 0C */	bne func_8001E1B8
/* 8001E1B0 0001B0F0  80 64 02 24 */	lwz r3, 0x224(r4)
/* 8001E1B4 0001B0F4  48 00 42 AD */	bl fpcMtd_Execute__FP20process_method_classPv

/* 8001E1B8 0010 .text      func_8001E1B8                  func_8001E1B8                  */
.global func_8001E1B8
func_8001E1B8:
...
/* 8001E1C8 0038 .text      fopCam_IsDelete__FP12camera_class fopCam_IsDelete__FP12camera_class */
.global fopCam_IsDelete__FP12camera_class
...
/* 8001E21C 0038 .text      fopCam_Delete__FP12camera_class fopCam_Delete__FP12camera_class */
.global fopCam_Delete__FP12camera_class
...
/* 8001E270 0050 .text      fopCam_Create__FPv             fopCam_Create__FPv             */
.global fopCam_Create__FPv
fopCam_Create__FPv:
...
/* 8001E290 0001B1D0  40 82 00 30 */	bne func_8001E2C0
...
/* 8001E2B4 0001B1F4  41 82 00 0C */	beq func_8001E2C0
/* 8001E2B8 0001B1F8  80 03 00 00 */	lwz r0, 0(r3)
/* 8001E2BC 0001B1FC  90 1F 00 B0 */	stw r0, 0xb0(r31)

/* 8001E2C0 002C .text      func_8001E2C0                  func_8001E2C0                  */
.global func_8001E2C0
func_8001E2C0:
...
/* 8001E2D4 0001B214  40 82 00 18 */	bne func_8001E2EC
...
/* 8001E2EC 001C .text      func_8001E2EC                  func_8001E2EC                  */
.global func_8001E2EC
func_8001E2EC:
...
/* ###################################################################################### */
.section .data, "aw"
/* 803A3860 0014 .data      g_fopCam_Method                g_fopCam_Method                */
.global g_fopCam_Method
g_fopCam_Method:

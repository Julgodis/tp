...
/* 8001AC54  38 A3 88 80 */	addi r5, r3, lit_4932@l                  /* constant-address: 80378880, symbol: lit_4932 */
/* 8001AC58  80 65 00 00 */	lwz r3, 0(r5)                            /* constant-address: 80378880, symbol: lit_4932 */
/* 8001AC5C  80 05 00 04 */	lwz r0, 4(r5)                            /* constant-address: 80378884, symbol: None */
/* 8001AC60  90 61 00 14 */	stw r3, 0x14(r1)                        
/* 8001AC64  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 8001AC68  80 05 00 08 */	lwz r0, 8(r5)                            /* constant-address: 80378888, symbol: None */
...
/* 8001AC80  38 A3 88 8C */	addi r5, r3, lit_4933@l                  /* constant-address: 8037888C, symbol: lit_4933 */
/* 8001AC84  80 65 00 00 */	lwz r3, 0(r5)                            /* constant-address: 8037888C, symbol: lit_4933 */
/* 8001AC88  80 05 00 04 */	lwz r0, 4(r5)                            /* constant-address: 80378890, symbol: None */
/* 8001AC8C  90 61 00 08 */	stw r3, 8(r1)                           
/* 8001AC90  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 8001AC94  80 05 00 08 */	lwz r0, 8(r5)                            /* constant-address: 80378894, symbol: None */
...
/* 8001ACAC  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8001ACB0  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 8001ACB4  48 32 B8 31 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 8001ACB8  3C 60 80 3E */	lis r3, mClipper__14mDoLib_clipper@ha   
/* 8001ACBC  38 63 D8 E4 */	addi r3, r3, mClipper__14mDoLib_clipper@l /* constant-address: 803DD8E4, symbol: mClipper__14mDoLib_clipper */
/* 8001ACC0  38 81 00 20 */	addi r4, r1, 0x20                       
/* 8001ACC4  38 A1 00 08 */	addi r5, r1, 8                          
/* 8001ACC8  38 C1 00 14 */	addi r6, r1, 0x14                       
/* 8001ACCC  48 25 8D 79 */	bl clip__11J3DUClipperCFPA4_CfP3VecP3Vec /* constant-address: 80273A44, symbol: clip__11J3DUClipperCFPA4_CfP3VecP3Vec */

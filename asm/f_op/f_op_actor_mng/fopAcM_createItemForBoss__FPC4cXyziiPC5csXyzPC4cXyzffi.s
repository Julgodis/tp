...
/* 8001C134  4B FF DC D1 */	bl fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv /* constant-address: 80019E04, symbol: fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv */
/* 8001C138  28 03 00 00 */	cmplwi r3, 0                            
/* 8001C13C  41 82 00 0C */	beq lbl_8001C148                         /* constant-address: 8001C148, symbol: lbl_8001C148 */
/* 8001C140  D3 C3 05 2C */	stfs f30, 0x52c(r3)                      /* constant-address: 00000747 */
/* 8001C144  D3 E3 04 FC */	stfs f31, 0x4fc(r3)                      /* constant-address: 00000717 */
lbl_8001C148:
/* 8001C148  28 03 00 00 */	cmplwi r3, 0                            
/* 8001C14C  41 82 00 0C */	beq lbl_8001C158                         /* constant-address: 8001C158, symbol: lbl_8001C158 */
/* 8001C150  80 63 00 04 */	lwz r3, 4(r3)                            /* constant-address: 0000021F */
/* 8001C154  48 00 00 08 */	b lbl_8001C15C                           /* constant-address: 8001C15C, symbol: lbl_8001C15C */
lbl_8001C158:

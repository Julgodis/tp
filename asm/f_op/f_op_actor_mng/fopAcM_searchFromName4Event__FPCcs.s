...
/* 8001D7D8  48 34 B3 55 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 8001D7DC  38 61 00 08 */	addi r3, r1, 8                          
/* 8001D7E0  38 80 00 3A */	li r4, 0x3a                             
/* 8001D7E4  48 34 B1 41 */	bl strchr                                /* constant-address: 80368924, symbol: strchr */
/* 8001D7E8  28 03 00 00 */	cmplwi r3, 0                            
/* 8001D7EC  41 82 00 5C */	beq lbl_8001D848                         /* constant-address: 8001D848, symbol: lbl_8001D848 */
...
/* 8001D800  48 00 00 3C */	b lbl_8001D83C                           /* constant-address: 8001D83C, symbol: lbl_8001D83C */
lbl_8001D804:
/* 8001D804  7C 63 07 74 */	extsb r3, r3                            
/* 8001D808  2C 03 00 30 */	cmpwi r3, 0x30                          
/* 8001D80C  41 80 00 0C */	blt lbl_8001D818                         /* constant-address: 8001D818, symbol: lbl_8001D818 */
/* 8001D810  2C 03 00 39 */	cmpwi r3, 0x39                          
/* 8001D814  40 81 00 10 */	ble lbl_8001D824                         /* constant-address: 8001D824, symbol: lbl_8001D824 */
lbl_8001D818:
/* 8001D818  38 00 FF FF */	li r0, -1                               
/* 8001D81C  B0 01 00 26 */	sth r0, 0x26(r1)                        
/* 8001D820  48 00 00 28 */	b lbl_8001D848                           /* constant-address: 8001D848, symbol: lbl_8001D848 */
lbl_8001D824:
...
/* 8001D844  40 82 FF C0 */	bne lbl_8001D804                         /* constant-address: 8001D804, symbol: lbl_8001D804 */
lbl_8001D848:
/* 8001D848  38 61 00 08 */	addi r3, r1, 8                          
/* 8001D84C  48 00 75 75 */	bl dStage_searchName__FPCc               /* constant-address: 80024DC0, symbol: dStage_searchName__FPCc */
/* 8001D850  28 03 00 00 */	cmplwi r3, 0                            
/* 8001D854  40 82 00 0C */	bne lbl_8001D860                         /* constant-address: 8001D860, symbol: lbl_8001D860 */
/* 8001D858  38 60 00 00 */	li r3, 0                                
/* 8001D85C  48 00 00 24 */	b lbl_8001D880                           /* constant-address: 8001D880, symbol: lbl_8001D880 */
lbl_8001D860:
...
/* 8001D870  3C 60 80 02 */	lis r3, fopAcM_findObject4EventCB__FP10fopAc_ac_cPv@ha
/* 8001D874  38 63 D6 F0 */	addi r3, r3, fopAcM_findObject4EventCB__FP10fopAc_ac_cPv@l /* constant-address: 8001D6F0, symbol: fopAcM_findObject4EventCB__FP10fopAc_ac_cPv */
/* 8001D878  38 81 00 08 */	addi r4, r1, 8                          
/* 8001D87C  4B FF BF 7D */	bl fopAcIt_Judge__FPFPvPv_PvPv           /* constant-address: 800197F8, symbol: fopAcIt_Judge__FPFPvPv_PvPv */
lbl_8001D880:

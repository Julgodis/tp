...
/* 8001D218  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8001D21C  83 E3 5D AC */	lwz r31, 0x5dac(r3)                      /* constant-address: 8040BF6C, symbol: None */
/* 8001D220  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 8001D224  48 05 AA 45 */	bl __ct__11dBgS_LinChkFv                 /* constant-address: 80077C68, symbol: __ct__11dBgS_LinChkFv */
...
/* 8001D248  80 6D 81 E8 */	lwz r3, calc_mtx(r13)                    /* constant-address: 80450768, symbol: calc_mtx */
/* 8001D24C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)                      
/* 8001D250  4B FE F1 8D */	bl mDoMtx_YrotS__FPA4_fs                 /* constant-address: 8000C3DC, symbol: mDoMtx_YrotS__FPA4_fs */
/* 8001D254  C0 02 82 04 */	lfs f0, lit_4645(r2)                     /* constant-address: 80451C04, symbol: lit_4645 */
...
/* 8001D26C  C0 02 82 54 */	lfs f0, lit_6174(r2)                     /* constant-address: 80451C54, symbol: lit_6174 */
/* 8001D270  D0 01 00 28 */	stfs f0, 0x28(r1)                       
/* 8001D274  38 61 00 20 */	addi r3, r1, 0x20                       
/* 8001D278  38 81 00 08 */	addi r4, r1, 8                          
/* 8001D27C  48 25 3C 71 */	bl MtxPosition__FP4cXyzP4cXyz            /* constant-address: 80270EEC, symbol: MtxPosition__FP4cXyzP4cXyz */
/* 8001D280  38 61 00 08 */	addi r3, r1, 8                          
/* 8001D284  38 9F 04 D0 */	addi r4, r31, 0x4d0                     
/* 8001D288  7C 65 1B 78 */	mr r5, r3                               
/* 8001D28C  48 32 9E 05 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
...
/* 8001D2A0  48 05 AA C5 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c /* constant-address: 80077D64, symbol: Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c */
/* 8001D2A4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8001D2A8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8001D2AC  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 8001D2B0  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 8001D2B4  48 05 71 01 */	bl LineCross__4cBgSFP11cBgS_LinChk       /* constant-address: 800743B4, symbol: LineCross__4cBgSFP11cBgS_LinChk */
/* 8001D2B8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8001D2BC  41 82 00 48 */	beq lbl_8001D304                         /* constant-address: 8001D304, symbol: lbl_8001D304 */
...
/* 8001D2E8  C0 02 82 04 */	lfs f0, lit_4645(r2)                     /* constant-address: 80451C04, symbol: lit_4645 */
/* 8001D2EC  D0 1E 05 2C */	stfs f0, 0x52c(r30)                     
/* 8001D2F0  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 8001D2F4  38 80 FF FF */	li r4, -1                               
/* 8001D2F8  48 05 A9 E5 */	bl __dt__11dBgS_LinChkFv                 /* constant-address: 80077CDC, symbol: __dt__11dBgS_LinChkFv */
/* 8001D2FC  38 60 00 01 */	li r3, 1                                
/* 8001D300  48 00 00 14 */	b lbl_8001D314                           /* constant-address: 8001D314, symbol: lbl_8001D314 */
lbl_8001D304:
/* 8001D304  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 8001D308  38 80 FF FF */	li r4, -1                               
/* 8001D30C  48 05 A9 D1 */	bl __dt__11dBgS_LinChkFv                 /* constant-address: 80077CDC, symbol: __dt__11dBgS_LinChkFv */

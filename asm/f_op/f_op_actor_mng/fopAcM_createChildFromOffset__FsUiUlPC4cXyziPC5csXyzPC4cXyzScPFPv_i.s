...
/* 80019F88  48 34 82 3D */	bl _savegpr_23                           /* constant-address: 803621C4, symbol: _savegpr_23 */
...
/* 80019FB8  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l   /* constant-address: 80023590, symbol: fpcSch_JudgeByID__FPvPv */
/* 80019FBC  38 81 00 08 */	addi r4, r1, 8                          
/* 80019FC0  4B FF F8 39 */	bl fopAcIt_Judge__FPFPvPv_PvPv           /* constant-address: 800197F8, symbol: fopAcIt_Judge__FPFPvPv_PvPv */
/* 80019FC4  A8 A3 04 DE */	lha r5, 0x4de(r3)                        /* constant-address: 80023A6E, symbol: None */
/* 80019FC8  28 17 00 00 */	cmplwi r23, 0                           
/* 80019FCC  40 82 00 24 */	bne lbl_80019FF0                         /* constant-address: 80019FF0, symbol: lbl_80019FF0 */
/* 80019FD0  3C 80 80 43 */	lis r4, Zero__4cXyz@ha                  
/* 80019FD4  C4 04 0C F4 */	lfsu f0, Zero__4cXyz@l(r4)               /* constant-address: 80430CF4, symbol: Zero__4cXyz */
/* 80019FD8  D0 01 00 28 */	stfs f0, 0x28(r1)                       
/* 80019FDC  C0 04 00 04 */	lfs f0, 4(r4)                            /* constant-address: 80430CF8, symbol: None */
/* 80019FE0  D0 01 00 2C */	stfs f0, 0x2c(r1)                       
/* 80019FE4  C0 04 00 08 */	lfs f0, 8(r4)                            /* constant-address: 80430CFC, symbol: None */
/* 80019FE8  D0 01 00 30 */	stfs f0, 0x30(r1)                       
/* 80019FEC  48 00 00 1C */	b lbl_8001A008                           /* constant-address: 8001A008, symbol: lbl_8001A008 */
lbl_80019FF0:
...
/* 8001A00C  40 82 00 24 */	bne lbl_8001A030                         /* constant-address: 8001A030, symbol: lbl_8001A030 */
/* 8001A010  A8 0D 8B E0 */	lha r0, Zero__5csXyz(r13)                /* constant-address: 80451160, symbol: Zero__5csXyz */
/* 8001A014  B0 01 00 14 */	sth r0, 0x14(r1)                        
/* 8001A018  38 8D 8B E0 */	la r4, Zero__5csXyz(r13) /* 80451160-_SDA_BASE_ */ /* constant-address: 80451160, symbol: Zero__5csXyz */
/* 8001A01C  A8 04 00 02 */	lha r0, 2(r4)                            /* constant-address: 80451162, symbol: None */
/* 8001A020  B0 01 00 16 */	sth r0, 0x16(r1)                        
/* 8001A024  A8 04 00 04 */	lha r0, 4(r4)                            /* constant-address: 80451164, symbol: data_80451164 */
/* 8001A028  B0 01 00 18 */	sth r0, 0x18(r1)                        
/* 8001A02C  48 00 00 1C */	b lbl_8001A048                           /* constant-address: 8001A048, symbol: lbl_8001A048 */
lbl_8001A030:
...
lbl_8001A048:
/* 8001A048  C0 83 04 D0 */	lfs f4, 0x4d0(r3)                        /* constant-address: 80023A60, symbol: None */
/* 8001A04C  D0 81 00 1C */	stfs f4, 0x1c(r1)                       
/* 8001A050  C0 63 04 D4 */	lfs f3, 0x4d4(r3)                        /* constant-address: 80023A64, symbol: None */
/* 8001A054  D0 61 00 20 */	stfs f3, 0x20(r1)                       
/* 8001A058  C0 43 04 D8 */	lfs f2, 0x4d8(r3)                        /* constant-address: 80023A68, symbol: None */
...
/* 8001A088  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 8001A0D4  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 8001A0F4  4B FF FA 29 */	bl createAppend__FUsUlPC4cXyziPC5csXyzPC4cXyzScUi /* constant-address: 80019B1C, symbol: createAppend__FUsUlPC4cXyziPC5csXyzPC4cXyzScUi */
/* 8001A0F8  7C 7A 1B 79 */	or. r26, r3, r3                         
/* 8001A0FC  40 82 00 0C */	bne lbl_8001A108                         /* constant-address: 8001A108, symbol: lbl_8001A108 */
/* 8001A100  38 60 FF FF */	li r3, -1                               
/* 8001A104  48 00 00 1C */	b lbl_8001A120                           /* constant-address: 8001A120, symbol: lbl_8001A120 */
lbl_8001A108:
/* 8001A108  48 00 75 ED */	bl fpcLy_CurrentLayer__Fv                /* constant-address: 800216F4, symbol: fpcLy_CurrentLayer__Fv */
/* 8001A10C  7F 24 CB 78 */	mr r4, r25                              
/* 8001A110  7F E5 FB 78 */	mr r5, r31                              
/* 8001A114  38 C0 00 00 */	li r6, 0                                
/* 8001A118  7F 47 D3 78 */	mr r7, r26                              
/* 8001A11C  48 00 9C 79 */	bl fpcSCtRq_Request__FP11layer_classsPFPvPv_iPvPv /* constant-address: 80023D94, symbol: fpcSCtRq_Request__FP11layer_classsPFPvPv_iPvPv */
lbl_8001A120:
/* 8001A120  39 61 00 60 */	addi r11, r1, 0x60                      
/* 8001A124  48 34 80 ED */	bl _restgpr_23                           /* constant-address: 80362210, symbol: _restgpr_23 */

...
/* 8001C3F0  48 34 5D DD */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 8001C410  80 0D 8B E0 */	lwz r0, Zero__5csXyz(r13)                /* constant-address: 80451160, symbol: Zero__5csXyz */
/* 8001C414  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 8001C418  A0 0D 8B E4 */	lhz r0, data_80451164(r13)               /* constant-address: 80451164, symbol: data_80451164 */
/* 8001C41C  B0 01 00 14 */	sth r0, 0x14(r1)                        
/* 8001C420  2C 1C 00 FF */	cmpwi r28, 0xff                         
/* 8001C424  40 82 00 0C */	bne lbl_8001C430                         /* constant-address: 8001C430, symbol: lbl_8001C430 */
/* 8001C428  38 60 00 00 */	li r3, 0                                
/* 8001C42C  48 00 01 6C */	b lbl_8001C598                           /* constant-address: 8001C598, symbol: lbl_8001C598 */
lbl_8001C430:
/* 8001C430  28 1E 00 00 */	cmplwi r30, 0                           
/* 8001C434  41 82 00 20 */	beq lbl_8001C454                         /* constant-address: 8001C454, symbol: lbl_8001C454 */
...
/* 8001C450  48 00 00 1C */	b lbl_8001C46C                           /* constant-address: 8001C46C, symbol: lbl_8001C46C */
lbl_8001C454:
/* 8001C454  C0 22 82 2C */	lfs f1, lit_5711(r2)                     /* constant-address: 80451C2C, symbol: lit_5711 */
/* 8001C458  48 24 B5 35 */	bl cM_rndFX__Ff                          /* constant-address: 8026798C, symbol: cM_rndFX__Ff */
...
/* 8001C478  48 07 F3 4D */	bl check_itemno__Fi                      /* constant-address: 8009B7C4, symbol: check_itemno__Fi */
...
/* 8001C494  41 82 00 D8 */	beq lbl_8001C56C                         /* constant-address: 8001C56C, symbol: lbl_8001C56C */
/* 8001C498  40 80 00 14 */	bge lbl_8001C4AC                         /* constant-address: 8001C4AC, symbol: lbl_8001C4AC */
/* 8001C49C  2C 1C 00 1E */	cmpwi r28, 0x1e                         
/* 8001C4A0  41 82 00 18 */	beq lbl_8001C4B8                         /* constant-address: 8001C4B8, symbol: lbl_8001C4B8 */
/* 8001C4A4  40 80 00 74 */	bge lbl_8001C518                         /* constant-address: 8001C518, symbol: lbl_8001C518 */
/* 8001C4A8  48 00 00 C4 */	b lbl_8001C56C                           /* constant-address: 8001C56C, symbol: lbl_8001C56C */
lbl_8001C4AC:
/* 8001C4AC  2C 1C 00 23 */	cmpwi r28, 0x23                         
/* 8001C4B0  40 80 00 BC */	bge lbl_8001C56C                         /* constant-address: 8001C56C, symbol: lbl_8001C56C */
/* 8001C4B4  48 00 00 34 */	b lbl_8001C4E8                           /* constant-address: 8001C4E8, symbol: lbl_8001C4E8 */
lbl_8001C4B8:
...
/* 8001C4E0  4B FF D9 25 */	bl fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv /* constant-address: 80019E04, symbol: fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv */
/* 8001C4E4  48 00 00 B4 */	b lbl_8001C598                           /* constant-address: 8001C598, symbol: lbl_8001C598 */
lbl_8001C4E8:
...
/* 8001C510  4B FF D8 F5 */	bl fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv /* constant-address: 80019E04, symbol: fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv */
/* 8001C514  48 00 00 84 */	b lbl_8001C598                           /* constant-address: 8001C598, symbol: lbl_8001C598 */
lbl_8001C518:
...
/* 8001C544  4B FF D8 C1 */	bl fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv /* constant-address: 80019E04, symbol: fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv */
/* 8001C548  C0 22 82 2C */	lfs f1, lit_5711(r2)                     /* constant-address: 80451C2C, symbol: lit_5711 */
/* 8001C54C  48 24 B4 41 */	bl cM_rndFX__Ff                          /* constant-address: 8026798C, symbol: cM_rndFX__Ff */
...
/* 8001C568  41 80 FF B8 */	blt lbl_8001C520                         /* constant-address: 8001C520, symbol: lbl_8001C520 */
lbl_8001C56C:
...
/* 8001C594  4B FF D8 71 */	bl fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv /* constant-address: 80019E04, symbol: fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv */
lbl_8001C598:
/* 8001C598  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8001C59C  48 34 5C 7D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

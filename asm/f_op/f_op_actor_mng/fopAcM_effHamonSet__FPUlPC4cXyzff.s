...
/* 8001D124  48 34 50 B1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8001D148  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8001D14C  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
lbl_8001D150:
/* 8001D150  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)                      /* constant-address: 8040BEFC, symbol: None */
...
/* 8001D180  38 C2 82 50 */	la r6, data_80451C50(r2) /* 80451C50-_SDA2_BASE_ */ /* constant-address: 80451C50, symbol: data_80451C50 */
...
/* 8001D198  C0 22 82 38 */	lfs f1, lit_5810(r2)                     /* constant-address: 80451C38, symbol: lit_5810 */
/* 8001D19C  48 03 03 31 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf /* constant-address: 8004D4CC, symbol: set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf */
/* 8001D1A0  90 7B 00 00 */	stw r3, 0(r27)                          
/* 8001D1A4  80 7E 5D 3C */	lwz r3, 0x5d3c(r30)                      /* constant-address: 8040BEFC, symbol: None */
/* 8001D1A8  38 63 02 10 */	addi r3, r3, 0x210                      
/* 8001D1AC  80 9B 00 00 */	lwz r4, 0(r27)                          
/* 8001D1B0  48 02 E7 69 */	bl getEmitter__Q213dPa_control_c7level_cFUl /* constant-address: 8004B918, symbol: getEmitter__Q213dPa_control_c7level_cFUl */
/* 8001D1B4  28 03 00 00 */	cmplwi r3, 0                            
/* 8001D1B8  41 82 00 08 */	beq lbl_8001D1C0                         /* constant-address: 8001D1C0, symbol: lbl_8001D1C0 */
...
/* 8001D1D0  41 80 FF 80 */	blt lbl_8001D150                         /* constant-address: 8001D150, symbol: lbl_8001D150 */
/* 8001D1D4  E3 E1 00 58 */	psq_l f31, 88(r1), 0, 0 /* qr0 */       
/* 8001D1D8  CB E1 00 50 */	lfd f31, 0x50(r1)                       
/* 8001D1DC  39 61 00 50 */	addi r11, r1, 0x50                      
/* 8001D1E0  48 34 50 41 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

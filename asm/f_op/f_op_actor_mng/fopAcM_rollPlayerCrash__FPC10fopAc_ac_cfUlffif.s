...
/* 8001AB00  48 34 76 D5 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8001AB18  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8001AB1C  80 9F 5D AC */	lwz r4, 0x5dac(r31)                      /* constant-address: 8040BF6C, symbol: None */
/* 8001AB20  7C 9E 23 78 */	mr r30, r4                              
/* 8001AB24  80 7F 5D B4 */	lwz r3, 0x5db4(r31)                      /* constant-address: 8040BF74, symbol: None */
/* 8001AB28  7C 04 18 40 */	cmplw r4, r3                            
/* 8001AB2C  41 82 00 0C */	beq lbl_8001AB38                         /* constant-address: 8001AB38, symbol: lbl_8001AB38 */
/* 8001AB30  38 60 00 00 */	li r3, 0                                
/* 8001AB34  48 00 00 E4 */	b lbl_8001AC18                           /* constant-address: 8001AC18, symbol: lbl_8001AC18 */
lbl_8001AB38:
/* 8001AB38  C0 02 82 20 */	lfs f0, lit_4922(r2)                     /* constant-address: 80451C20, symbol: lit_4922 */
/* 8001AB3C  EF E0 08 2A */	fadds f31, f0, f1                       
/* 8001AB40  80 03 05 74 */	lwz r0, 0x574(r3)                       
/* 8001AB44  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 8001AB48  41 82 00 0C */	beq lbl_8001AB54                         /* constant-address: 8001AB54, symbol: lbl_8001AB54 */
/* 8001AB4C  C0 02 82 24 */	lfs f0, lit_4923(r2)                     /* constant-address: 80451C24, symbol: lit_4923 */
...
/* 8001AB64  40 81 00 B0 */	ble lbl_8001AC14                         /* constant-address: 8001AC14, symbol: lbl_8001AC14 */
/* 8001AB68  FC 00 10 40 */	fcmpo cr0, f0, f2                       
/* 8001AB6C  40 80 00 A8 */	bge lbl_8001AC14                         /* constant-address: 8001AC14, symbol: lbl_8001AC14 */
...
/* 8001AB88  40 82 00 20 */	bne lbl_8001ABA8                         /* constant-address: 8001ABA8, symbol: lbl_8001ABA8 */
...
/* 8001ABA4  41 82 00 70 */	beq lbl_8001AC14                         /* constant-address: 8001AC14, symbol: lbl_8001AC14 */
lbl_8001ABA8:
/* 8001ABA8  7F 63 DB 78 */	mr r3, r27                              
/* 8001ABAC  80 9F 5D AC */	lwz r4, 0x5dac(r31)                      /* constant-address: 8040BF6C, symbol: None */
/* 8001ABB0  4B FF FE E5 */	bl fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c /* constant-address: 8001AA94, symbol: fopAcM_searchActorDistanceXZ2__FPC10fopAc_ac_cPC10fopAc_ac_c */
/* 8001ABB4  EC 1F 07 F2 */	fmuls f0, f31, f31                      
/* 8001ABB8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8001ABBC  40 80 00 58 */	bge lbl_8001AC14                         /* constant-address: 8001AC14, symbol: lbl_8001AC14 */
/* 8001ABC0  7F 63 DB 78 */	mr r3, r27                              
/* 8001ABC4  80 9F 5D AC */	lwz r4, 0x5dac(r31)                      /* constant-address: 8040BF6C, symbol: None */
/* 8001ABC8  4B FF FB 49 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c /* constant-address: 8001A710, symbol: fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c */
/* 8001ABCC  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha         
/* 8001ABD0  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 8001ABEC  40 80 00 28 */	bge lbl_8001AC14                         /* constant-address: 8001AC14, symbol: lbl_8001AC14 */
...
/* 8001AC10  48 00 00 08 */	b lbl_8001AC18                           /* constant-address: 8001AC18, symbol: lbl_8001AC18 */
lbl_8001AC14:
...
/* 8001AC2C  48 34 75 F5 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

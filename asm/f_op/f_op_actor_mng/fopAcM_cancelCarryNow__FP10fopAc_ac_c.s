...
/* 8001CBBC  41 82 00 8C */	beq lbl_8001CC48                         /* constant-address: 8001CC48, symbol: lbl_8001CC48 */
...
/* 8001CBD4  41 82 00 3C */	beq lbl_8001CC10                         /* constant-address: 8001CC10, symbol: lbl_8001CC10 */
/* 8001CBD8  3C 60 80 3F */	lis r3, mStatus__20dStage_roomControl_c@ha
/* 8001CBDC  38 63 60 94 */	addi r3, r3, mStatus__20dStage_roomControl_c@l /* constant-address: 803F6094, symbol: mStatus__20dStage_roomControl_c */
...
/* 8001CBF4  48 00 20 BD */	bl fopScnM_SearchByID__FUi               /* constant-address: 8001ECB0, symbol: fopScnM_SearchByID__FUi */
/* 8001CBF8  28 03 00 00 */	cmplwi r3, 0                            
/* 8001CBFC  41 82 00 14 */	beq lbl_8001CC10                         /* constant-address: 8001CC10, symbol: lbl_8001CC10 */
/* 8001CC00  7F E3 FB 78 */	mr r3, r31                              
/* 8001CC04  88 1F 04 E2 */	lbz r0, 0x4e2(r31)                      
/* 8001CC08  7C 04 07 74 */	extsb r4, r0                            
/* 8001CC0C  4B FF CD 29 */	bl fopAcM_setRoomLayer__FPvi             /* constant-address: 80019934, symbol: fopAcM_setRoomLayer__FPvi */
lbl_8001CC10:
/* 8001CC10  38 00 00 00 */	li r0, 0                                
/* 8001CC14  B0 1F 04 E8 */	sth r0, 0x4e8(r31)                      
/* 8001CC18  B0 1F 04 E4 */	sth r0, 0x4e4(r31)                      
/* 8001CC1C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8001CC20  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8001CC24  88 03 4F AD */	lbz r0, 0x4fad(r3)                       /* constant-address: 8040B16D, symbol: None */
/* 8001CC28  28 00 00 00 */	cmplwi r0, 0                            
/* 8001CC2C  41 82 00 1C */	beq lbl_8001CC48                         /* constant-address: 8001CC48, symbol: lbl_8001CC48 */
/* 8001CC30  88 1F 04 96 */	lbz r0, 0x496(r31)                      
/* 8001CC34  28 00 00 02 */	cmplwi r0, 2                            
/* 8001CC38  41 82 00 10 */	beq lbl_8001CC48                         /* constant-address: 8001CC48, symbol: lbl_8001CC48 */

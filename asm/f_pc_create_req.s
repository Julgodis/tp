...
.section .text, "ax"
/* 80020ACC 001C .text fpcCtRq_isCreatingByID__FP10create_tagPUi fpcCtRq_isCreatingByID__FP10create_tagPUi */
.global fpcCtRq_isCreatingByID__FP10create_tagPUi
fpcCtRq_isCreatingByID__FP10create_tagPUi:
...
/* 80020AE8 0038 .text fpcCtRq_IsCreatingByID__FUi fpcCtRq_IsCreatingByID__FUi */
.global fpcCtRq_IsCreatingByID__FUi
fpcCtRq_IsCreatingByID__FUi:
...
/* 80020AF8 0001DA38  3C 60 80 02 */	lis r3, fpcCtRq_isCreatingByID__FP10create_tagPUi@ha
/* 80020AFC 0001DA3C  38 63 0A CC */	addi r3, r3, fpcCtRq_isCreatingByID__FP10create_tagPUi@l
/* 80020B00 0001DA40  38 81 00 08 */	addi r4, r1, 8
/* 80020B04 0001DA44  4B FF FF 01 */	bl fpcCtIt_Judge__FPFPvPv_PvPv
...
/* 80020B20 003C .text fpcCtRq_CreateQTo__FP14create_request fpcCtRq_CreateQTo__FP14create_request */
.global fpcCtRq_CreateQTo__FP14create_request
fpcCtRq_CreateQTo__FP14create_request:
...
/* 80020B34 0001DA74  48 00 03 31 */	bl fpcCtTg_CreateQTo__FP10create_tag
/* 80020B38 0001DA78  80 7F 00 44 */	lwz r3, 0x44(r31)
/* 80020B3C 0001DA7C  48 00 0B 89 */	bl fpcLy_CreatedMesg__FP11layer_class
/* 80020B40 0001DA80  38 7F 00 18 */	addi r3, r31, 0x18
/* 80020B44 0001DA84  48 00 0A 45 */	bl fpcLy_CancelQTo__FP24process_method_tag_class
...
/* 80020B5C 0044 .text fpcCtRq_ToCreateQ__FP14create_request fpcCtRq_ToCreateQ__FP14create_request */
.global fpcCtRq_ToCreateQ__FP14create_request
fpcCtRq_ToCreateQ__FP14create_request:
...
/* 80020B74 0001DAB4  48 00 0B 41 */	bl fpcLy_CreatingMesg__FP11layer_class
/* 80020B78 0001DAB8  80 7F 00 44 */	lwz r3, 0x44(r31)
/* 80020B7C 0001DABC  38 9F 00 18 */	addi r4, r31, 0x18
/* 80020B80 0001DAC0  48 00 0A 29 */	bl fpcLy_ToCancelQ__FP11layer_classP24process_method_tag_class
/* 80020B84 0001DAC4  7F E3 FB 78 */	mr r3, r31
/* 80020B88 0001DAC8  48 00 02 B1 */	bl fpcCtTg_ToCreateQ__FP10create_tag
...
/* 80020BA0 0074 .text fpcCtRq_Delete__FP14create_request fpcCtRq_Delete__FP14create_request */
.global fpcCtRq_Delete__FP14create_request
fpcCtRq_Delete__FP14create_request:
...
/* 80020BB4 0001DAF4  4B FF FF 6D */	bl fpcCtRq_CreateQTo__FP14create_request
...
/* 80020BCC 0001DB0C  48 00 18 5D */	bl fpcMtd_Method__FPFPv_iPv
...
/* 80020C14 0098 .text fpcCtRq_Cancel__FP14create_request fpcCtRq_Cancel__FP14create_request */
.global fpcCtRq_Cancel__FP14create_request
fpcCtRq_Cancel__FP14create_request:
...
/* 80020C4C 0001DB8C  48 00 06 59 */	bl fpcDt_Delete__FPv
...
/* 80020C74 0001DBB4  48 00 17 B5 */	bl fpcMtd_Method__FPFPv_iPv
...
/* 80020C8C 0001DBCC  4B FF FF 15 */	bl fpcCtRq_Delete__FP14create_request
...
/* 80020CAC 001C .text fpcCtRq_IsDoing__FP14create_request fpcCtRq_IsDoing__FP14create_request */
.global fpcCtRq_IsDoing__FP14create_request
fpcCtRq_IsDoing__FP14create_request:
...
/* 80020CC8 00BC .text fpcCtRq_Do__FP14create_request fpcCtRq_Do__FP14create_request */
.global fpcCtRq_Do__FP14create_request
fpcCtRq_Do__FP14create_request:
...
/* 80020D3C 0001DC7C  48 00 07 D5 */	bl fpcEx_ToExecuteQ__FP18base_process_class
...
/* 80020D4C 0001DC8C  4B FF FE C9 */	bl fpcCtRq_Cancel__FP14create_request
/* 80020D50 0001DC90  48 00 00 20 */	b lbl_80020D70
lbl_80020D54:
/* 80020D54 0001DC94  7F E3 FB 78 */	mr r3, r31
/* 80020D58 0001DC98  4B FF FE 49 */	bl fpcCtRq_Delete__FP14create_request
/* 80020D5C 0001DC9C  48 00 00 14 */	b lbl_80020D70
lbl_80020D60:
/* 80020D60 0001DCA0  7F E3 FB 78 */	mr r3, r31
/* 80020D64 0001DCA4  4B FF FE B1 */	bl fpcCtRq_Cancel__FP14create_request
...
/* 80020D84 002C .text fpcCtRq_Handler__Fv fpcCtRq_Handler__Fv */
.global fpcCtRq_Handler__Fv
fpcCtRq_Handler__Fv:
...
/* 80020D90 0001DCD0  3C 60 80 02 */	lis r3, fpcCtRq_Do__FP14create_request@ha
/* 80020D94 0001DCD4  38 63 0C C8 */	addi r3, r3, fpcCtRq_Do__FP14create_request@l
/* 80020D98 0001DCD8  38 80 00 00 */	li r4, 0
/* 80020D9C 0001DCDC  4B FF FC 2D */	bl fpcCtIt_Method__FPFPvPv_iPv
...
/* 80020DB0 0088 .text fpcCtRq_Create__FP11layer_classUlP27create_request_method_class fpcCtRq_Create__FP11layer_classUlP27create_request_method_class */
.global fpcCtRq_Create__FP11layer_classUlP27create_request_method_class
...
/* 80020DD0 0001DD10  48 24 24 59 */	bl memalignB__3cMlFiUl
...
/* 80020DE0 0001DD20  48 00 00 A5 */	bl fpcCtTg_Init__FP10create_tagPv
/* 80020DE4 0001DD24  38 7F 00 18 */	addi r3, r31, 0x18
/* 80020DE8 0001DD28  3C 80 80 02 */	lis r4, fpcCtRq_Cancel__FP14create_request@ha
/* 80020DEC 0001DD2C  38 84 0C 14 */	addi r4, r4, fpcCtRq_Cancel__FP14create_request@l
/* 80020DF0 0001DD30  7F E5 FB 78 */	mr r5, r31
/* 80020DF4 0001DD34  48 00 2A 05 */	bl fpcMtdTg_Init__FP24process_method_tag_classPFPv_iPv
/* 80020DF8 0001DD38  93 BF 00 44 */	stw r29, 0x44(r31)
/* 80020DFC 0001DD3C  93 DF 00 34 */	stw r30, 0x34(r31)
/* 80020E00 0001DD40  4B FF F8 9D */	bl fpcBs_MakeOfId__Fv
...
/* 80020E18 0001DD58  4B FF FD 45 */	bl fpcCtRq_ToCreateQ__FP14create_request
lbl_80020E1C:

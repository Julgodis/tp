...
/* 8009C200  48 2C 5F D9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8009C204  7C 7D 1B 78 */	mr r29, r3                              
/* 8009C208  7C 9C 23 78 */	mr r28, r4                              
/* 8009C20C  7C BF 2B 78 */	mr r31, r5                              
/* 8009C210  48 00 01 51 */	bl getFirstData__7dTres_cFUc             /* constant-address: 8009C360, symbol: getFirstData__7dTres_cFUc */
/* 8009C214  3C 80 80 42 */	lis r4, mTypeGroupListAll__7dTres_c@ha  
/* 8009C218  38 84 54 38 */	addi r4, r4, mTypeGroupListAll__7dTres_c@l /* constant-address: 80425438, symbol: mTypeGroupListAll__7dTres_c */
...
/* 8009C238  48 00 00 24 */	b lbl_8009C25C                           /* constant-address: 8009C25C, symbol: lbl_8009C25C */
lbl_8009C23C:
/* 8009C23C  88 03 00 00 */	lbz r0, 0(r3)                           
/* 8009C240  7C 1C 00 00 */	cmpw r28, r0                            
/* 8009C244  40 82 00 10 */	bne lbl_8009C254                         /* constant-address: 8009C254, symbol: lbl_8009C254 */
/* 8009C248  88 03 00 02 */	lbz r0, 2(r3)                           
/* 8009C24C  7C 00 F8 38 */	and r0, r0, r31                         
/* 8009C250  98 03 00 02 */	stb r0, 2(r3)                           
lbl_8009C254:
/* 8009C254  48 00 01 49 */	bl getNextData__7dTres_cFPQ27dTres_c15typeGroupData_c /* constant-address: 8009C39C, symbol: getNextData__7dTres_cFPQ27dTres_c15typeGroupData_c */
/* 8009C258  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
lbl_8009C25C:
/* 8009C25C  7C 1D F0 00 */	cmpw r29, r30                           
/* 8009C260  41 80 FF DC */	blt lbl_8009C23C                         /* constant-address: 8009C23C, symbol: lbl_8009C23C */
/* 8009C264  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8009C268  48 2C 5F BD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

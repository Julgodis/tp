...
/* 8009BCC4  48 2C 65 0D */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 8009BCC8  7C 7B 1B 78 */	mr r27, r3                              
/* 8009BCCC  7C 9C 23 78 */	mr r28, r4                              
/* 8009BCD0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8009BCD4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8009BCD8  85 83 4E 20 */	lwzu r12, 0x4e20(r3)                     /* constant-address: 8040AFE0, symbol: None */
/* 8009BCDC  81 8C 00 BC */	lwz r12, 0xbc(r12)                      
/* 8009BCE0  7D 89 03 A6 */	mtctr r12                               
/* 8009BCE4  4E 80 04 21 */	bctrl                                   
/* 8009BCE8  80 03 00 0C */	lwz r0, 0xc(r3)                          /* constant-address: 8040AFEC, symbol: None */
/* 8009BCEC  54 00 87 7E */	rlwinm r0, r0, 0x10, 0x1d, 0x1f         
/* 8009BCF0  28 00 00 03 */	cmplwi r0, 3                            
/* 8009BCF4  41 82 01 1C */	beq lbl_8009BE10                         /* constant-address: 8009BE10, symbol: lbl_8009BE10 */
/* 8009BCF8  4B FF FF 75 */	bl reset__7dTres_cFv                     /* constant-address: 8009BC6C, symbol: reset__7dTres_cFv */
/* 8009BCFC  83 FB 00 04 */	lwz r31, 4(r27)                         
/* 8009BD00  80 6D 8A 18 */	lwz r3, mTypeGroupData__7dTres_c(r13)    /* constant-address: 80450F98, symbol: mTypeGroupData__7dTres_c */
/* 8009BD04  A0 0D 8A 1C */	lhz r0, mNum__7dTres_c(r13)              /* constant-address: 80450F9C, symbol: mNum__7dTres_c */
...
/* 8009BD18  3B 43 54 38 */	addi r26, r3, mTypeGroupListAll__7dTres_c@l /* constant-address: 80425438, symbol: mTypeGroupListAll__7dTres_c */
/* 8009BD1C  48 00 00 E8 */	b lbl_8009BE04                           /* constant-address: 8009BE04, symbol: lbl_8009BE04 */
lbl_8009BD20:
...
/* 8009BD88  48 00 07 29 */	bl getTypeToTypeGroupNo__7dTres_cFUc     /* constant-address: 8009C4B0, symbol: getTypeToTypeGroupNo__7dTres_cFUc */
...
/* 8009BDAC  40 82 00 08 */	bne lbl_8009BDB4                         /* constant-address: 8009BDB4, symbol: lbl_8009BDB4 */
/* 8009BDB0  93 C4 00 00 */	stw r30, 0(r4)                          
lbl_8009BDB4:
/* 8009BDB4  80 64 00 04 */	lwz r3, 4(r4)                           
/* 8009BDB8  28 03 00 00 */	cmplwi r3, 0                            
/* 8009BDBC  41 82 00 08 */	beq lbl_8009BDC4                         /* constant-address: 8009BDC4, symbol: lbl_8009BDC4 */
...
/* 8009BDDC  41 82 00 08 */	beq lbl_8009BDE4                         /* constant-address: 8009BDE4, symbol: lbl_8009BDE4 */
/* 8009BDE0  48 00 00 0C */	b lbl_8009BDEC                           /* constant-address: 8009BDEC, symbol: lbl_8009BDEC */
lbl_8009BDE4:
/* 8009BDE4  7F C3 F3 78 */	mr r3, r30                              
/* 8009BDE8  48 00 00 41 */	bl checkTreasureBox__7dTres_cFPQ27dTres_c6data_s /* constant-address: 8009BE28, symbol: checkTreasureBox__7dTres_cFPQ27dTres_c6data_s */
lbl_8009BDEC:
/* 8009BDEC  A0 6D 8A 1C */	lhz r3, mNum__7dTres_c(r13)              /* constant-address: 80450F9C, symbol: mNum__7dTres_c */
/* 8009BDF0  38 03 00 01 */	addi r0, r3, 1                          
/* 8009BDF4  B0 0D 8A 1C */	sth r0, mNum__7dTres_c(r13)              /* constant-address: 80450F9C, symbol: mNum__7dTres_c */
/* 8009BDF8  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
...
/* 8009BE0C  41 80 FF 14 */	blt lbl_8009BD20                         /* constant-address: 8009BD20, symbol: lbl_8009BD20 */
lbl_8009BE10:
/* 8009BE10  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8009BE14  48 2C 64 09 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

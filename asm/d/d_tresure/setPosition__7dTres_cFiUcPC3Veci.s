...
/* 8009C3DC  48 2C 5D F9 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8009C3F4  4B FF FF 6D */	bl getFirstData__7dTres_cFUc             /* constant-address: 8009C360, symbol: getFirstData__7dTres_cFUc */
/* 8009C3F8  7C 7F 1B 78 */	mr r31, r3                              
/* 8009C3FC  3C 60 80 42 */	lis r3, mTypeGroupListAll__7dTres_c@ha  
/* 8009C400  38 63 54 38 */	addi r3, r3, mTypeGroupListAll__7dTres_c@l /* constant-address: 80425438, symbol: mTypeGroupListAll__7dTres_c */
...
/* 8009C41C  40 81 00 68 */	ble lbl_8009C484                         /* constant-address: 8009C484, symbol: lbl_8009C484 */
lbl_8009C420:
/* 8009C420  88 1F 00 00 */	lbz r0, 0(r31)                          
/* 8009C424  7C 1B 00 00 */	cmpw r27, r0                            
/* 8009C428  40 82 00 54 */	bne lbl_8009C47C                         /* constant-address: 8009C47C, symbol: lbl_8009C47C */
...
/* 8009C448  41 80 00 08 */	blt lbl_8009C450                         /* constant-address: 8009C450, symbol: lbl_8009C450 */
...
/* 8009C45C  4B FA 29 05 */	bl correctionOriginPos__10dMapInfo_nFScP3Vec /* constant-address: 8003ED60, symbol: correctionOriginPos__10dMapInfo_nFScP3Vec */
...
/* 8009C478  48 00 00 0C */	b lbl_8009C484                           /* constant-address: 8009C484, symbol: lbl_8009C484 */
lbl_8009C47C:
/* 8009C47C  83 FF 00 14 */	lwz r31, 0x14(r31)                      
/* 8009C480  42 00 FF A0 */	bdnz lbl_8009C420                        /* constant-address: 8009C420, symbol: lbl_8009C420 */
lbl_8009C484:
/* 8009C484  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8009C488  48 2C 5D 99 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

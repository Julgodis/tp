...
/* 8009BE38  48 2C 63 99 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 8009BE3C  7C 7D 1B 78 */	mr r29, r3                              
/* 8009BE40  88 03 00 10 */	lbz r0, 0x10(r3)                        
/* 8009BE44  28 00 00 FF */	cmplwi r0, 0xff                         
/* 8009BE48  41 82 03 08 */	beq lbl_8009C150                         /* constant-address: 8009C150, symbol: lbl_8009C150 */
/* 8009BE4C  88 7D 00 03 */	lbz r3, 3(r29)                          
/* 8009BE50  28 03 00 FF */	cmplwi r3, 0xff                         
/* 8009BE54  41 82 02 FC */	beq lbl_8009C150                         /* constant-address: 8009C150, symbol: lbl_8009C150 */
/* 8009BE58  38 80 FF FF */	li r4, -1                               
/* 8009BE5C  4B FB 59 91 */	bl dPath_GetRoomPath__Fii                /* constant-address: 800517EC, symbol: dPath_GetRoomPath__Fii */
/* 8009BE60  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8009BE64  41 82 02 EC */	beq lbl_8009C150                         /* constant-address: 8009C150, symbol: lbl_8009C150 */
/* 8009BE68  88 1D 00 12 */	lbz r0, 0x12(r29)                       
/* 8009BE6C  28 00 00 00 */	cmplwi r0, 0                            
/* 8009BE70  40 82 02 80 */	bne lbl_8009C0F0                         /* constant-address: 8009C0F0, symbol: lbl_8009C0F0 */
/* 8009BE74  3B 60 00 00 */	li r27, 0                               
/* 8009BE78  3B 40 00 00 */	li r26, 0                               
/* 8009BE7C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8009BE80  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
...
/* 8009BE9C  4B F9 94 C5 */	bl isSwitch__10dSv_info_cCFii            /* constant-address: 80035360, symbol: isSwitch__10dSv_info_cCFii */
...
/* 8009BEC0  41 80 FF C8 */	blt lbl_8009BE88                         /* constant-address: 8009BE88, symbol: lbl_8009BE88 */
/* 8009BEC4  7F 60 07 35 */	extsh. r0, r27                          
/* 8009BEC8  41 82 01 FC */	beq lbl_8009C0C4                         /* constant-address: 8009C0C4, symbol: lbl_8009C0C4 */
/* 8009BECC  C0 42 91 E8 */	lfs f2, lit_3839(r2)                     /* constant-address: 80452BE8, symbol: lit_3839 */
/* 8009BED0  38 1B FF FF */	addi r0, r27, -1                        
/* 8009BED4  1C 60 00 18 */	mulli r3, r0, 0x18                      
/* 8009BED8  38 03 00 0C */	addi r0, r3, 0xc                        
/* 8009BEDC  C8 22 92 08 */	lfd f1, lit_3845(r2)                     /* constant-address: 80452C08, symbol: lit_3845 */
...
/* 8009BF54  C0 02 91 EC */	lfs f0, lit_3840(r2)                     /* constant-address: 80452BEC, symbol: lit_3840 */
...
/* 8009BF74  48 2A B4 29 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 8009BF78  C0 02 91 EC */	lfs f0, lit_3840(r2)                     /* constant-address: 80452BEC, symbol: lit_3840 */
/* 8009BF7C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8009BF80  40 81 00 58 */	ble lbl_8009BFD8                         /* constant-address: 8009BFD8, symbol: lbl_8009BFD8 */
/* 8009BF84  FC 00 08 34 */	frsqrte f0, f1                          
/* 8009BF88  C8 82 91 F0 */	lfd f4, lit_3841(r2)                     /* constant-address: 80452BF0, symbol: lit_3841 */
/* 8009BF8C  FC 44 00 32 */	fmul f2, f4, f0                         
/* 8009BF90  C8 62 91 F8 */	lfd f3, lit_3842(r2)                     /* constant-address: 80452BF8, symbol: lit_3842 */
...
/* 8009BFD4  48 00 00 88 */	b lbl_8009C05C                           /* constant-address: 8009C05C, symbol: lbl_8009C05C */
lbl_8009BFD8:
/* 8009BFD8  C8 02 92 00 */	lfd f0, lit_3843(r2)                     /* constant-address: 80452C00, symbol: lit_3843 */
/* 8009BFDC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8009BFE0  40 80 00 10 */	bge lbl_8009BFF0                         /* constant-address: 8009BFF0, symbol: lbl_8009BFF0 */
/* 8009BFE4  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8009BFE8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8009BFEC  48 00 00 70 */	b lbl_8009C05C                           /* constant-address: 8009C05C, symbol: lbl_8009C05C */
lbl_8009BFF0:
...
/* 8009C004  41 82 00 14 */	beq lbl_8009C018                         /* constant-address: 8009C018, symbol: lbl_8009C018 */
/* 8009C008  40 80 00 40 */	bge lbl_8009C048                         /* constant-address: 8009C048, symbol: lbl_8009C048 */
/* 8009C00C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8009C010  41 82 00 20 */	beq lbl_8009C030                         /* constant-address: 8009C030, symbol: lbl_8009C030 */
/* 8009C014  48 00 00 34 */	b lbl_8009C048                           /* constant-address: 8009C048, symbol: lbl_8009C048 */
lbl_8009C018:
/* 8009C018  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8009C01C  41 82 00 0C */	beq lbl_8009C028                         /* constant-address: 8009C028, symbol: lbl_8009C028 */
/* 8009C020  38 00 00 01 */	li r0, 1                                
/* 8009C024  48 00 00 28 */	b lbl_8009C04C                           /* constant-address: 8009C04C, symbol: lbl_8009C04C */
lbl_8009C028:
/* 8009C028  38 00 00 02 */	li r0, 2                                
/* 8009C02C  48 00 00 20 */	b lbl_8009C04C                           /* constant-address: 8009C04C, symbol: lbl_8009C04C */
lbl_8009C030:
/* 8009C030  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8009C034  41 82 00 0C */	beq lbl_8009C040                         /* constant-address: 8009C040, symbol: lbl_8009C040 */
/* 8009C038  38 00 00 05 */	li r0, 5                                
/* 8009C03C  48 00 00 10 */	b lbl_8009C04C                           /* constant-address: 8009C04C, symbol: lbl_8009C04C */
lbl_8009C040:
/* 8009C040  38 00 00 03 */	li r0, 3                                
/* 8009C044  48 00 00 08 */	b lbl_8009C04C                           /* constant-address: 8009C04C, symbol: lbl_8009C04C */
lbl_8009C048:
/* 8009C048  38 00 00 04 */	li r0, 4                                
lbl_8009C04C:
/* 8009C04C  2C 00 00 01 */	cmpwi r0, 1                             
/* 8009C050  40 82 00 0C */	bne lbl_8009C05C                         /* constant-address: 8009C05C, symbol: lbl_8009C05C */
/* 8009C054  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8009C058  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_8009C05C:
/* 8009C05C  C0 02 91 EC */	lfs f0, lit_3840(r2)                     /* constant-address: 80452BEC, symbol: lit_3840 */
/* 8009C060  D0 01 00 24 */	stfs f0, 0x24(r1)                       
/* 8009C064  D0 01 00 28 */	stfs f0, 0x28(r1)                       
/* 8009C068  D0 21 00 2C */	stfs f1, 0x2c(r1)                       
/* 8009C06C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8009C070  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8009C074  7F C4 F3 78 */	mr r4, r30                              
/* 8009C078  4B F7 03 65 */	bl mDoMtx_YrotS__FPA4_fs                 /* constant-address: 8000C3DC, symbol: mDoMtx_YrotS__FPA4_fs */
/* 8009C07C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8009C080  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8009C084  38 81 00 24 */	addi r4, r1, 0x24                       
/* 8009C088  7C 85 23 78 */	mr r5, r4                               
/* 8009C08C  48 2A AC E1 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 8009C090  38 61 00 24 */	addi r3, r1, 0x24                       
/* 8009C094  38 81 00 3C */	addi r4, r1, 0x3c                       
/* 8009C098  7C 65 1B 78 */	mr r5, r3                               
/* 8009C09C  48 2A AF F5 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
...
/* 8009C0C0  48 00 00 20 */	b lbl_8009C0E0                           /* constant-address: 8009C0E0, symbol: lbl_8009C0E0 */
lbl_8009C0C4:
...
/* 8009C0E8  4B FA 2C 79 */	bl correctionOriginPos__10dMapInfo_nFScP3Vec /* constant-address: 8003ED60, symbol: correctionOriginPos__10dMapInfo_nFScP3Vec */
/* 8009C0EC  48 00 00 64 */	b lbl_8009C150                           /* constant-address: 8009C150, symbol: lbl_8009C150 */
lbl_8009C0F0:
/* 8009C0F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8009C0F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8009C0F8  88 9D 00 10 */	lbz r4, 0x10(r29)                       
/* 8009C0FC  88 BD 00 01 */	lbz r5, 1(r29)                          
/* 8009C100  7C A5 07 74 */	extsb r5, r5                            
/* 8009C104  4B F9 92 5D */	bl isSwitch__10dSv_info_cCFii            /* constant-address: 80035360, symbol: isSwitch__10dSv_info_cCFii */
/* 8009C108  2C 03 00 00 */	cmpwi r3, 0                             
/* 8009C10C  41 82 00 1C */	beq lbl_8009C128                         /* constant-address: 8009C128, symbol: lbl_8009C128 */
...
/* 8009C124  48 00 00 08 */	b lbl_8009C12C                           /* constant-address: 8009C12C, symbol: lbl_8009C12C */
lbl_8009C128:
...
/* 8009C14C  4B FA 2C 15 */	bl correctionOriginPos__10dMapInfo_nFScP3Vec /* constant-address: 8003ED60, symbol: correctionOriginPos__10dMapInfo_nFScP3Vec */
lbl_8009C150:
/* 8009C150  39 61 00 70 */	addi r11, r1, 0x70                      
/* 8009C154  48 2C 60 C9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

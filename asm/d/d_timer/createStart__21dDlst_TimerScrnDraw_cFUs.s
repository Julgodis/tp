...
/* 8026058C  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 80260590  54 84 04 3E */	clrlwi r4, r4, 0x10                     
/* 80260594  38 A1 00 08 */	addi r5, r1, 8                          
/* 80260598  38 C0 00 00 */	li r6, 0                                
/* 8026059C  4B FB BC B5 */	bl getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c /* constant-address: 8021C250, symbol: getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c */
/* 802605A0  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 802605A4  3C 80 69 6E */	lis r4, 0x696E /* 0x696E5F73@ha */      
/* 802605A8  38 C4 5F 73 */	addi r6, r4, 0x5F73 /* 0x696E5F73@l */   /* constant-address: 696E5F73 */
/* 802605AC  3C 80 67 65 */	lis r4, 0x6765 /* 0x6765745F@ha */      
/* 802605B0  38 A4 74 5F */	addi r5, r4, 0x745F /* 0x6765745F@l */   /* constant-address: 6765745F */
...
/* 802605C4  48 0A 00 95 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 802605C8  38 81 00 08 */	addi r4, r1, 8                          
/* 802605CC  48 10 85 61 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 802605D0  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 802605D4  3C 80 74 5F */	lis r4, 0x745F /* 0x745F696E@ha */      
/* 802605D8  38 C4 69 6E */	addi r6, r4, 0x696E /* 0x745F696E@l */   /* constant-address: 745F696E */
...
/* 802605F0  48 0A 00 69 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 802605F4  38 81 00 08 */	addi r4, r1, 8                          
/* 802605F8  48 10 85 35 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 802605FC  88 1F 03 DC */	lbz r0, 0x3dc(r31)                      
/* 80260600  28 00 00 00 */	cmplwi r0, 0                            
/* 80260604  40 82 00 74 */	bne lbl_80260678                         /* constant-address: 80260678, symbol: lbl_80260678 */
/* 80260608  C0 02 B5 70 */	lfs f0, lit_5227(r2)                     /* constant-address: 80454F70, symbol: lit_5227 */
/* 8026060C  54 00 25 36 */	rlwinm r0, r0, 4, 0x14, 0x1b            
/* 80260610  7C 7F 02 14 */	add r3, r31, r0                         
/* 80260614  D0 03 00 80 */	stfs f0, 0x80(r3)                       
/* 80260618  C0 02 B5 50 */	lfs f0, lit_4125(r2)                     /* constant-address: 80454F50, symbol: lit_4125 */
...
/* 80260674  48 00 00 08 */	b lbl_8026067C                           /* constant-address: 8026067C, symbol: lbl_8026067C */
lbl_80260678:

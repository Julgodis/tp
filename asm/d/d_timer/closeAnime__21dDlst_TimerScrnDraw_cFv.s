...
/* 8025FFD8  41 81 01 D0 */	bgt lbl_802601A8                         /* constant-address: 802601A8, symbol: lbl_802601A8 */
/* 8025FFDC  7C A0 07 34 */	extsh r0, r5                            
/* 8025FFE0  C8 62 B5 58 */	lfd f3, lit_4627(r2)                     /* constant-address: 80454F58, symbol: lit_4627 */
...
/* 80260010  C0 42 B5 6C */	lfs f2, lit_5143(r2)                     /* constant-address: 80454F6C, symbol: lit_5143 */
...
/* 8026004C  C0 02 B5 68 */	lfs f0, lit_5094(r2)                     /* constant-address: 80454F68, symbol: lit_5094 */
/* 80260050  EF C0 01 32 */	fmuls f30, f0, f4                       
/* 80260054  80 1E 00 18 */	lwz r0, 0x18(r30)                       
/* 80260058  28 00 00 00 */	cmplwi r0, 0                            
/* 8026005C  41 82 00 8C */	beq lbl_802600E8                         /* constant-address: 802600E8, symbol: lbl_802600E8 */
/* 80260060  88 1E 03 E2 */	lbz r0, 0x3e2(r30)                      
/* 80260064  28 00 00 00 */	cmplwi r0, 0                            
/* 80260068  41 82 00 2C */	beq lbl_80260094                         /* constant-address: 80260094, symbol: lbl_80260094 */
/* 8026006C  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 80260070  28 00 00 00 */	cmplwi r0, 0                            
/* 80260074  40 82 00 20 */	bne lbl_80260094                         /* constant-address: 80260094, symbol: lbl_80260094 */
/* 80260078  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8026007C  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80260080  C0 04 0B 84 */	lfs f0, 0xb84(r4)                        /* constant-address: 8042F74C, symbol: None */
/* 80260084  EC 20 F0 2A */	fadds f1, f0, f30                       
/* 80260088  C0 44 0B 88 */	lfs f2, 0xb88(r4)                        /* constant-address: 8042F750, symbol: None */
/* 8026008C  4B FF F9 A1 */	bl setTimerPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA2C, symbol: setTimerPos__21dDlst_TimerScrnDraw_cFff */
/* 80260090  48 00 00 2C */	b lbl_802600BC                           /* constant-address: 802600BC, symbol: lbl_802600BC */
lbl_80260094:
/* 80260094  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 80260098  54 05 10 3A */	slwi r5, r0, 2                          
/* 8026009C  7F C3 F3 78 */	mr r3, r30                              
/* 802600A0  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 802600A4  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 802600B8  4B FF F9 75 */	bl setTimerPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA2C, symbol: setTimerPos__21dDlst_TimerScrnDraw_cFff */
lbl_802600BC:
/* 802600BC  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 802600C0  C0 3E 03 B0 */	lfs f1, 0x3b0(r30)                      
/* 802600C4  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 802600C8  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 802600E4  4B FF 56 ED */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_802600E8:
/* 802600E8  80 1E 00 14 */	lwz r0, 0x14(r30)                       
/* 802600EC  28 00 00 00 */	cmplwi r0, 0                            
/* 802600F0  41 82 00 58 */	beq lbl_80260148                         /* constant-address: 80260148, symbol: lbl_80260148 */
/* 802600F4  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 802600F8  54 05 10 3A */	slwi r5, r0, 2                          
/* 802600FC  7F C3 F3 78 */	mr r3, r30                              
/* 80260100  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 80260104  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 80260118  4B FF F9 55 */	bl setCounterPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA6C, symbol: setCounterPos__21dDlst_TimerScrnDraw_cFff */
/* 8026011C  80 7E 00 14 */	lwz r3, 0x14(r30)                       
/* 80260120  C0 3E 03 B0 */	lfs f1, 0x3b0(r30)                      
/* 80260124  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 80260128  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 80260144  4B FF 56 8D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_80260148:
/* 80260148  80 1E 00 1C */	lwz r0, 0x1c(r30)                       
/* 8026014C  28 00 00 00 */	cmplwi r0, 0                            
/* 80260150  41 82 00 58 */	beq lbl_802601A8                         /* constant-address: 802601A8, symbol: lbl_802601A8 */
/* 80260154  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 80260158  54 05 10 3A */	slwi r5, r0, 2                          
/* 8026015C  7F C3 F3 78 */	mr r3, r30                              
/* 80260160  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 80260164  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 80260178  4B FF F9 21 */	bl setImagePos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA98, symbol: setImagePos__21dDlst_TimerScrnDraw_cFff */
/* 8026017C  80 7E 00 1C */	lwz r3, 0x1c(r30)                       
/* 80260180  C0 3E 03 B0 */	lfs f1, 0x3b0(r30)                      
/* 80260184  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 80260188  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 802601A4  4B FF 56 2D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_802601A8:
/* 802601A8  80 1E 03 D8 */	lwz r0, 0x3d8(r30)                      
/* 802601AC  2C 00 00 07 */	cmpwi r0, 7                             
/* 802601B0  41 80 00 08 */	blt lbl_802601B8                         /* constant-address: 802601B8, symbol: lbl_802601B8 */

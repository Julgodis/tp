...
/* 8025FB94  48 10 26 49 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8025FB98  7C 7D 1B 78 */	mr r29, r3                              
/* 8025FB9C  88 03 03 DE */	lbz r0, 0x3de(r3)                       
/* 8025FBA0  28 00 00 00 */	cmplwi r0, 0                            
/* 8025FBA4  40 82 03 CC */	bne lbl_8025FF70                         /* constant-address: 8025FF70, symbol: lbl_8025FF70 */
/* 8025FBA8  80 7D 03 D8 */	lwz r3, 0x3d8(r29)                      
/* 8025FBAC  3B C2 B5 60 */	la r30, data_80454F60(r2) /* 80454F60-_SDA2_BASE_ */ /* constant-address: 80454F60, symbol: data_80454F60 */
/* 8025FBB0  A8 1E 00 04 */	lha r0, 4(r30)                           /* constant-address: 80454F64, symbol: None */
/* 8025FBB4  7C 03 00 00 */	cmpw r3, r0                             
/* 8025FBB8  41 81 00 10 */	bgt lbl_8025FBC8                         /* constant-address: 8025FBC8, symbol: lbl_8025FBC8 */
/* 8025FBBC  38 03 00 01 */	addi r0, r3, 1                          
/* 8025FBC0  90 1D 03 D8 */	stw r0, 0x3d8(r29)                      
/* 8025FBC4  48 00 00 0C */	b lbl_8025FBD0                           /* constant-address: 8025FBD0, symbol: lbl_8025FBD0 */
lbl_8025FBC8:
/* 8025FBC8  38 00 00 01 */	li r0, 1                                
/* 8025FBCC  98 1D 03 DE */	stb r0, 0x3de(r29)                      
lbl_8025FBD0:
/* 8025FBD0  80 1D 03 D8 */	lwz r0, 0x3d8(r29)                      
/* 8025FBD4  3B E2 B5 60 */	la r31, data_80454F60(r2) /* 80454F60-_SDA2_BASE_ */ /* constant-address: 80454F60, symbol: data_80454F60 */
/* 8025FBD8  A8 9F 00 02 */	lha r4, 2(r31)                           /* constant-address: 80454F62, symbol: None */
/* 8025FBDC  7C 00 20 00 */	cmpw r0, r4                             
/* 8025FBE0  41 81 01 AC */	bgt lbl_8025FD8C                         /* constant-address: 8025FD8C, symbol: lbl_8025FD8C */
/* 8025FBE4  7C 00 07 34 */	extsh r0, r0                            
/* 8025FBE8  C8 62 B5 58 */	lfd f3, lit_4627(r2)                     /* constant-address: 80454F58, symbol: lit_4627 */
...
/* 8025FC44  C0 22 B5 68 */	lfs f1, lit_5094(r2)                     /* constant-address: 80454F68, symbol: lit_5094 */
/* 8025FC48  C0 02 B5 4C */	lfs f0, lit_4124(r2)                     /* constant-address: 80454F4C, symbol: lit_4124 */
...
/* 8025FC5C  41 82 01 18 */	beq lbl_8025FD74                         /* constant-address: 8025FD74, symbol: lbl_8025FD74 */
/* 8025FC60  88 1D 03 E2 */	lbz r0, 0x3e2(r29)                      
/* 8025FC64  28 00 00 00 */	cmplwi r0, 0                            
/* 8025FC68  41 82 00 30 */	beq lbl_8025FC98                         /* constant-address: 8025FC98, symbol: lbl_8025FC98 */
/* 8025FC6C  88 1D 03 DD */	lbz r0, 0x3dd(r29)                      
/* 8025FC70  28 00 00 00 */	cmplwi r0, 0                            
/* 8025FC74  40 82 00 24 */	bne lbl_8025FC98                         /* constant-address: 8025FC98, symbol: lbl_8025FC98 */
/* 8025FC78  7F A3 EB 78 */	mr r3, r29                              
/* 8025FC7C  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FC80  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025FC84  C0 04 0B 84 */	lfs f0, 0xb84(r4)                        /* constant-address: 8042F74C, symbol: None */
/* 8025FC88  EC 20 08 2A */	fadds f1, f0, f1                        
/* 8025FC8C  C0 44 0B 88 */	lfs f2, 0xb88(r4)                        /* constant-address: 8042F750, symbol: None */
/* 8025FC90  4B FF FD 9D */	bl setTimerPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA2C, symbol: setTimerPos__21dDlst_TimerScrnDraw_cFff */
/* 8025FC94  48 00 00 2C */	b lbl_8025FCC0                           /* constant-address: 8025FCC0, symbol: lbl_8025FCC0 */
lbl_8025FC98:
/* 8025FC98  88 1D 03 DD */	lbz r0, 0x3dd(r29)                      
/* 8025FC9C  54 05 10 3A */	slwi r5, r0, 2                          
/* 8025FCA0  7F A3 EB 78 */	mr r3, r29                              
/* 8025FCA4  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FCA8  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FCBC  4B FF FD 71 */	bl setTimerPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA2C, symbol: setTimerPos__21dDlst_TimerScrnDraw_cFff */
lbl_8025FCC0:
/* 8025FCC0  80 7D 00 18 */	lwz r3, 0x18(r29)                       
/* 8025FCC4  C0 3D 03 B0 */	lfs f1, 0x3b0(r29)                      
/* 8025FCC8  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FCCC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FCE8  4B FF 5A E9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 8025FCEC  88 1D 03 E2 */	lbz r0, 0x3e2(r29)                      
/* 8025FCF0  28 00 00 00 */	cmplwi r0, 0                            
/* 8025FCF4  41 82 00 44 */	beq lbl_8025FD38                         /* constant-address: 8025FD38, symbol: lbl_8025FD38 */
/* 8025FCF8  88 1D 03 DD */	lbz r0, 0x3dd(r29)                      
/* 8025FCFC  28 00 00 00 */	cmplwi r0, 0                            
/* 8025FD00  40 82 00 38 */	bne lbl_8025FD38                         /* constant-address: 8025FD38, symbol: lbl_8025FD38 */
/* 8025FD04  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025FD08  38 83 EB C8 */	addi r4, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025FD0C  C0 24 0B 80 */	lfs f1, 0xb80(r4)                        /* constant-address: 8042F748, symbol: None */
/* 8025FD10  80 7D 00 18 */	lwz r3, 0x18(r29)                       
/* 8025FD14  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8025FD18  C0 04 0B 7C */	lfs f0, 0xb7c(r4)                        /* constant-address: 8042F744, symbol: None */
...
/* 8025FD34  48 00 00 40 */	b lbl_8025FD74                           /* constant-address: 8025FD74, symbol: lbl_8025FD74 */
lbl_8025FD38:
/* 8025FD38  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025FD3C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FD78  A8 1F 00 02 */	lha r0, 2(r31)                           /* constant-address: 80454F62, symbol: None */
/* 8025FD7C  7C 03 00 00 */	cmpw r3, r0                             
/* 8025FD80  40 82 00 0C */	bne lbl_8025FD8C                         /* constant-address: 8025FD8C, symbol: lbl_8025FD8C */
/* 8025FD84  38 00 00 01 */	li r0, 1                                
/* 8025FD88  98 1D 03 DF */	stb r0, 0x3df(r29)                      
lbl_8025FD8C:
/* 8025FD8C  80 7D 03 D8 */	lwz r3, 0x3d8(r29)                      
/* 8025FD90  A8 82 B5 60 */	lha r4, data_80454F60(r2)                /* constant-address: 80454F60, symbol: data_80454F60 */
/* 8025FD94  7C 03 20 00 */	cmpw r3, r4                             
/* 8025FD98  40 81 01 D8 */	ble lbl_8025FF70                         /* constant-address: 8025FF70, symbol: lbl_8025FF70 */
/* 8025FD9C  A8 1E 00 04 */	lha r0, 4(r30)                           /* constant-address: 80454F64, symbol: None */
/* 8025FDA0  7C 03 00 00 */	cmpw r3, r0                             
/* 8025FDA4  41 81 01 CC */	bgt lbl_8025FF70                         /* constant-address: 8025FF70, symbol: lbl_8025FF70 */
/* 8025FDA8  7C 04 18 50 */	subf r0, r4, r3                         
/* 8025FDAC  7C 00 07 34 */	extsh r0, r0                            
/* 8025FDB0  A8 9F 00 02 */	lha r4, 2(r31)                           /* constant-address: 80454F62, symbol: None */
/* 8025FDB4  C8 62 B5 58 */	lfd f3, lit_4627(r2)                     /* constant-address: 80454F58, symbol: lit_4627 */
...
/* 8025FE10  C0 22 B5 68 */	lfs f1, lit_5094(r2)                     /* constant-address: 80454F68, symbol: lit_5094 */
/* 8025FE14  C0 02 B5 4C */	lfs f0, lit_4124(r2)                     /* constant-address: 80454F4C, symbol: lit_4124 */
...
/* 8025FE28  41 82 00 94 */	beq lbl_8025FEBC                         /* constant-address: 8025FEBC, symbol: lbl_8025FEBC */
/* 8025FE2C  88 1D 03 DD */	lbz r0, 0x3dd(r29)                      
/* 8025FE30  54 05 10 3A */	slwi r5, r0, 2                          
/* 8025FE34  7F A3 EB 78 */	mr r3, r29                              
/* 8025FE38  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FE3C  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FE50  4B FF FC 1D */	bl setCounterPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA6C, symbol: setCounterPos__21dDlst_TimerScrnDraw_cFff */
/* 8025FE54  80 7D 00 14 */	lwz r3, 0x14(r29)                       
/* 8025FE58  C0 3D 03 B0 */	lfs f1, 0x3b0(r29)                      
/* 8025FE5C  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FE60  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FE7C  4B FF 59 55 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 8025FE80  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025FE84  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FEC4  41 82 00 94 */	beq lbl_8025FF58                         /* constant-address: 8025FF58, symbol: lbl_8025FF58 */
/* 8025FEC8  88 1D 03 DD */	lbz r0, 0x3dd(r29)                      
/* 8025FECC  54 05 10 3A */	slwi r5, r0, 2                          
/* 8025FED0  7F A3 EB 78 */	mr r3, r29                              
/* 8025FED4  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FED8  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FEEC  4B FF FB AD */	bl setImagePos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA98, symbol: setImagePos__21dDlst_TimerScrnDraw_cFff */
/* 8025FEF0  80 7D 00 1C */	lwz r3, 0x1c(r29)                       
/* 8025FEF4  C0 3D 03 B0 */	lfs f1, 0x3b0(r29)                      
/* 8025FEF8  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025FEFC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FF18  4B FF 58 B9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 8025FF1C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025FF20  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025FF5C  A8 1E 00 04 */	lha r0, 4(r30)                           /* constant-address: 80454F64, symbol: None */
/* 8025FF60  7C 03 00 00 */	cmpw r3, r0                             
/* 8025FF64  40 82 00 0C */	bne lbl_8025FF70                         /* constant-address: 8025FF70, symbol: lbl_8025FF70 */
...
/* 8025FF84  48 10 22 A5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 8025DBF0  48 10 45 ED */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8025DC04  41 82 00 BC */	beq lbl_8025DCC0                         /* constant-address: 8025DCC0, symbol: lbl_8025DCC0 */
/* 8025DC08  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 8025DC0C  54 05 10 3A */	slwi r5, r0, 2                          
/* 8025DC10  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025DC14  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DC18  7C 80 2A 14 */	add r4, r0, r5                          
/* 8025DC1C  C0 24 0A A4 */	lfs f1, 0xaa4(r4)                       
/* 8025DC20  C0 44 0A B0 */	lfs f2, 0xab0(r4)                       
/* 8025DC24  48 00 1D DD */	bl setParentPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA00, symbol: setParentPos__21dDlst_TimerScrnDraw_cFff */
/* 8025DC28  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DC2C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025DC68  41 82 00 58 */	beq lbl_8025DCC0                         /* constant-address: 8025DCC0, symbol: lbl_8025DCC0 */
/* 8025DC6C  88 1E 03 E0 */	lbz r0, 0x3e0(r30)                      
/* 8025DC70  28 00 00 00 */	cmplwi r0, 0                            
/* 8025DC74  41 82 00 4C */	beq lbl_8025DCC0                         /* constant-address: 8025DCC0, symbol: lbl_8025DCC0 */
/* 8025DC78  C0 1E 03 B0 */	lfs f0, 0x3b0(r30)                      
/* 8025DC7C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DC80  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DC84  3B A3 0A BC */	addi r29, r3, 0xabc                      /* constant-address: 8042F684, symbol: None */
...
/* 8025DC98  41 82 00 28 */	beq lbl_8025DCC0                         /* constant-address: 8025DCC0, symbol: lbl_8025DCC0 */
/* 8025DC9C  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 8025DCA0  28 03 00 00 */	cmplwi r3, 0                            
/* 8025DCA4  41 82 00 08 */	beq lbl_8025DCAC                         /* constant-address: 8025DCAC, symbol: lbl_8025DCAC */
/* 8025DCA8  4B FF 7B 29 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_8025DCAC:
...
/* 8025DCC8  41 82 01 44 */	beq lbl_8025DE0C                         /* constant-address: 8025DE0C, symbol: lbl_8025DE0C */
/* 8025DCCC  88 1E 03 E2 */	lbz r0, 0x3e2(r30)                      
/* 8025DCD0  28 00 00 00 */	cmplwi r0, 0                            
/* 8025DCD4  41 82 00 2C */	beq lbl_8025DD00                         /* constant-address: 8025DD00, symbol: lbl_8025DD00 */
/* 8025DCD8  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 8025DCDC  28 00 00 00 */	cmplwi r0, 0                            
/* 8025DCE0  40 82 00 20 */	bne lbl_8025DD00                         /* constant-address: 8025DD00, symbol: lbl_8025DD00 */
/* 8025DCE4  7F C3 F3 78 */	mr r3, r30                              
/* 8025DCE8  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8025DCEC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DCF0  C0 24 0B 84 */	lfs f1, 0xb84(r4)                        /* constant-address: 8042F74C, symbol: None */
/* 8025DCF4  C0 44 0B 88 */	lfs f2, 0xb88(r4)                        /* constant-address: 8042F750, symbol: None */
/* 8025DCF8  48 00 1D 35 */	bl setTimerPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA2C, symbol: setTimerPos__21dDlst_TimerScrnDraw_cFff */
/* 8025DCFC  48 00 00 28 */	b lbl_8025DD24                           /* constant-address: 8025DD24, symbol: lbl_8025DD24 */
lbl_8025DD00:
...
/* 8025DD10  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DD14  7C 80 2A 14 */	add r4, r0, r5                          
/* 8025DD18  C0 24 0A E0 */	lfs f1, 0xae0(r4)                       
/* 8025DD1C  C0 44 0A EC */	lfs f2, 0xaec(r4)                       
/* 8025DD20  48 00 1D 0D */	bl setTimerPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA2C, symbol: setTimerPos__21dDlst_TimerScrnDraw_cFff */
lbl_8025DD24:
/* 8025DD24  88 1E 03 E2 */	lbz r0, 0x3e2(r30)                      
/* 8025DD28  28 00 00 00 */	cmplwi r0, 0                            
/* 8025DD2C  41 82 00 44 */	beq lbl_8025DD70                         /* constant-address: 8025DD70, symbol: lbl_8025DD70 */
/* 8025DD30  88 1E 03 DD */	lbz r0, 0x3dd(r30)                      
/* 8025DD34  28 00 00 00 */	cmplwi r0, 0                            
/* 8025DD38  40 82 00 38 */	bne lbl_8025DD70                         /* constant-address: 8025DD70, symbol: lbl_8025DD70 */
/* 8025DD3C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DD40  38 83 EB C8 */	addi r4, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DD44  C0 24 0B 80 */	lfs f1, 0xb80(r4)                        /* constant-address: 8042F748, symbol: None */
/* 8025DD48  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 8025DD4C  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8025DD50  C0 04 0B 7C */	lfs f0, 0xb7c(r4)                        /* constant-address: 8042F744, symbol: None */
...
/* 8025DD6C  48 00 00 40 */	b lbl_8025DDAC                           /* constant-address: 8025DDAC, symbol: lbl_8025DDAC */
lbl_8025DD70:
/* 8025DD70  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DD74  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025DDB4  41 82 00 58 */	beq lbl_8025DE0C                         /* constant-address: 8025DE0C, symbol: lbl_8025DE0C */
/* 8025DDB8  C0 1E 03 B4 */	lfs f0, 0x3b4(r30)                      
/* 8025DDBC  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DDC0  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DDC4  3B A3 0A F8 */	addi r29, r3, 0xaf8                      /* constant-address: 8042F6C0, symbol: None */
...
/* 8025DDD8  40 82 00 0C */	bne lbl_8025DDE4                         /* constant-address: 8025DDE4, symbol: lbl_8025DDE4 */
/* 8025DDDC  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 8025DDE0  41 82 00 2C */	beq lbl_8025DE0C                         /* constant-address: 8025DE0C, symbol: lbl_8025DE0C */
lbl_8025DDE4:
/* 8025DDE4  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 8025DDE8  28 03 00 00 */	cmplwi r3, 0                            
/* 8025DDEC  41 82 00 10 */	beq lbl_8025DDFC                         /* constant-address: 8025DDFC, symbol: lbl_8025DDFC */
/* 8025DDF0  C0 1E 03 B0 */	lfs f0, 0x3b0(r30)                      
/* 8025DDF4  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 8025DDF8  4B FF 79 D9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_8025DDFC:
...
/* 8025DE14  41 82 00 C4 */	beq lbl_8025DED8                         /* constant-address: 8025DED8, symbol: lbl_8025DED8 */
...
/* 8025DE28  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DE2C  7C 80 2A 14 */	add r4, r0, r5                          
/* 8025DE30  C0 24 0B 1C */	lfs f1, 0xb1c(r4)                       
/* 8025DE34  C0 44 0B 28 */	lfs f2, 0xb28(r4)                       
/* 8025DE38  48 00 1C 35 */	bl setCounterPos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA6C, symbol: setCounterPos__21dDlst_TimerScrnDraw_cFff */
/* 8025DE3C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DE40  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025DE80  41 82 00 58 */	beq lbl_8025DED8                         /* constant-address: 8025DED8, symbol: lbl_8025DED8 */
/* 8025DE84  C0 1E 03 B8 */	lfs f0, 0x3b8(r30)                      
/* 8025DE88  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DE8C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DE90  3B A3 0B 34 */	addi r29, r3, 0xb34                      /* constant-address: 8042F6FC, symbol: None */
...
/* 8025DEA4  40 82 00 0C */	bne lbl_8025DEB0                         /* constant-address: 8025DEB0, symbol: lbl_8025DEB0 */
/* 8025DEA8  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 8025DEAC  41 82 00 2C */	beq lbl_8025DED8                         /* constant-address: 8025DED8, symbol: lbl_8025DED8 */
lbl_8025DEB0:
/* 8025DEB0  80 7E 00 14 */	lwz r3, 0x14(r30)                       
/* 8025DEB4  28 03 00 00 */	cmplwi r3, 0                            
/* 8025DEB8  41 82 00 10 */	beq lbl_8025DEC8                         /* constant-address: 8025DEC8, symbol: lbl_8025DEC8 */
/* 8025DEBC  C0 1E 03 B0 */	lfs f0, 0x3b0(r30)                      
/* 8025DEC0  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 8025DEC4  4B FF 79 0D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_8025DEC8:
...
/* 8025DEE0  41 82 00 C4 */	beq lbl_8025DFA4                         /* constant-address: 8025DFA4, symbol: lbl_8025DFA4 */
...
/* 8025DEF4  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DEF8  7C 80 2A 14 */	add r4, r0, r5                          
/* 8025DEFC  C0 24 0B 58 */	lfs f1, 0xb58(r4)                       
/* 8025DF00  C0 44 0B 64 */	lfs f2, 0xb64(r4)                       
/* 8025DF04  48 00 1B 95 */	bl setImagePos__21dDlst_TimerScrnDraw_cFff /* constant-address: 8025FA98, symbol: setImagePos__21dDlst_TimerScrnDraw_cFff */
/* 8025DF08  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DF0C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8025DF4C  41 82 00 58 */	beq lbl_8025DFA4                         /* constant-address: 8025DFA4, symbol: lbl_8025DFA4 */
/* 8025DF50  C0 1E 03 BC */	lfs f0, 0x3bc(r30)                      
/* 8025DF54  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8025DF58  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8025DF5C  3B A3 0B 70 */	addi r29, r3, 0xb70                      /* constant-address: 8042F738, symbol: None */
...
/* 8025DF70  40 82 00 0C */	bne lbl_8025DF7C                         /* constant-address: 8025DF7C, symbol: lbl_8025DF7C */
/* 8025DF74  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 8025DF78  41 82 00 2C */	beq lbl_8025DFA4                         /* constant-address: 8025DFA4, symbol: lbl_8025DFA4 */
lbl_8025DF7C:
/* 8025DF7C  80 7E 00 1C */	lwz r3, 0x1c(r30)                       
/* 8025DF80  28 03 00 00 */	cmplwi r3, 0                            
/* 8025DF84  41 82 00 10 */	beq lbl_8025DF94                         /* constant-address: 8025DF94, symbol: lbl_8025DF94 */
/* 8025DF88  C0 1E 03 B0 */	lfs f0, 0x3b0(r30)                      
/* 8025DF8C  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 8025DF90  4B FF 78 41 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_8025DF94:
...
/* 8025DFA8  48 10 42 81 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

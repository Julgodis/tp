...
/* 8025EB60  41 82 00 08 */	beq lbl_8025EB68                         /* constant-address: 8025EB68, symbol: lbl_8025EB68 */
/* 8025EB64  98 A7 00 B0 */	stb r5, 0xb0(r7)                        
lbl_8025EB68:
/* 8025EB68  38 84 00 04 */	addi r4, r4, 4                          
/* 8025EB6C  42 00 FF E8 */	bdnz lbl_8025EB54                        /* constant-address: 8025EB54, symbol: lbl_8025EB54 */
/* 8025EB70  39 08 00 01 */	addi r8, r8, 1                           /* constant-address: 00000001 */
/* 8025EB74  2C 08 00 02 */	cmpwi r8, 2                             
/* 8025EB78  38 63 00 08 */	addi r3, r3, 8                           /* constant-address: 00000008 */
/* 8025EB7C  41 80 FF C8 */	blt lbl_8025EB44                         /* constant-address: 8025EB44, symbol: lbl_8025EB44 */
/* 8025EB80  80 1E 03 C8 */	lwz r0, 0x3c8(r30)                      
/* 8025EB84  2C 00 00 08 */	cmpwi r0, 8                             
/* 8025EB88  40 82 00 58 */	bne lbl_8025EBE0                         /* constant-address: 8025EBE0, symbol: lbl_8025EBE0 */
/* 8025EB8C  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 8025EB90  3C 80 73 6C */	lis r4, 0x736C /* 0x736C5F73@ha */      
/* 8025EB94  38 C4 5F 73 */	addi r6, r4, 0x5F73 /* 0x736C5F73@l */   /* constant-address: 736C5F73 */
...
/* 8025EBBC  38 C4 73 6C */	addi r6, r4, 0x736C /* 0x6E5F736C@l */   /* constant-address: 6E5F736C */
...
/* 8025EBDC  48 00 00 68 */	b lbl_8025EC44                           /* constant-address: 8025EC44, symbol: lbl_8025EC44 */
lbl_8025EBE0:
/* 8025EBE0  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 8025EBE4  3C 80 73 6C */	lis r4, 0x736C /* 0x736C5F73@ha */      
/* 8025EBE8  38 C4 5F 73 */	addi r6, r4, 0x5F73 /* 0x736C5F73@l */   /* constant-address: 736C5F73 */
...
/* 8025EC0C  38 C4 73 6C */	addi r6, r4, 0x736C /* 0x635F736C@l */   /* constant-address: 635F736C */
...
/* 8025EC28  41 82 00 0C */	beq lbl_8025EC34                         /* constant-address: 8025EC34, symbol: lbl_8025EC34 */
/* 8025EC2C  38 00 00 00 */	li r0, 0                                
/* 8025EC30  98 1F 00 B0 */	stb r0, 0xb0(r31)                       
lbl_8025EC34:
/* 8025EC34  28 03 00 00 */	cmplwi r3, 0                            
/* 8025EC38  41 82 00 0C */	beq lbl_8025EC44                         /* constant-address: 8025EC44, symbol: lbl_8025EC44 */

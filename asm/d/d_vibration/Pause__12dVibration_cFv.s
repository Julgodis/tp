...
/* 8006FF54  41 82 00 90 */	beq lbl_8006FFE4                         /* constant-address: 8006FFE4, symbol: lbl_8006FFE4 */
/* 8006FF58  80 1F 00 54 */	lwz r0, 0x54(r31)                       
/* 8006FF5C  2C 00 FF FF */	cmpwi r0, -1                            
/* 8006FF60  40 82 00 10 */	bne lbl_8006FF70                         /* constant-address: 8006FF70, symbol: lbl_8006FF70 */
/* 8006FF64  80 1F 00 70 */	lwz r0, 0x70(r31)                       
/* 8006FF68  2C 00 FF FF */	cmpwi r0, -1                            
/* 8006FF6C  41 82 00 30 */	beq lbl_8006FF9C                         /* constant-address: 8006FF9C, symbol: lbl_8006FF9C */
lbl_8006FF70:
/* 8006FF70  3C 60 80 3E */	lis r3, m_gamePad__8mDoCPd_c@ha         
/* 8006FF74  80 83 D2 D8 */	lwz r4, m_gamePad__8mDoCPd_c@l(r3)       /* constant-address: 803DD2D8, symbol: m_gamePad__8mDoCPd_c */
/* 8006FF78  38 64 00 68 */	addi r3, r4, 0x68                       
/* 8006FF7C  A8 84 00 7C */	lha r4, 0x7c(r4)                        
/* 8006FF80  48 27 19 C9 */	bl stopPatternedRumble__Q210JUTGamePad7CRumbleFs /* constant-address: 802E1948, symbol: stopPatternedRumble__Q210JUTGamePad7CRumbleFs */
/* 8006FF84  3C 60 80 3E */	lis r3, m_gamePad__8mDoCPd_c@ha         
/* 8006FF88  38 63 D2 D8 */	addi r3, r3, m_gamePad__8mDoCPd_c@l      /* constant-address: 803DD2D8, symbol: m_gamePad__8mDoCPd_c */
/* 8006FF8C  80 63 00 00 */	lwz r3, 0(r3)                            /* constant-address: 803DD2D8, symbol: m_gamePad__8mDoCPd_c */
/* 8006FF90  A8 63 00 7C */	lha r3, 0x7c(r3)                        
/* 8006FF94  38 80 00 01 */	li r4, 1                                
/* 8006FF98  48 27 16 F5 */	bl stopMotor__Q210JUTGamePad7CRumbleFib  /* constant-address: 802E168C, symbol: stopMotor__Q210JUTGamePad7CRumbleFib */
lbl_8006FF9C:
...
/* 8006FFBC  41 82 00 0C */	beq lbl_8006FFC8                         /* constant-address: 8006FFC8, symbol: lbl_8006FFC8 */
...
/* 8006FFD0  41 82 00 0C */	beq lbl_8006FFDC                         /* constant-address: 8006FFDC, symbol: lbl_8006FFDC */

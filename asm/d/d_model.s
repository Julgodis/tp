...
/* ###################################################################################### */
.section .text, "ax"
/* 8009C4FC 00EC .text      draw__6dMdl_cFv                draw__6dMdl_cFv                */
.global draw__6dMdl_cFv
draw__6dMdl_cFv:
...
/* 8009C51C 0009945C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 8009C520 00099460  38 63 4A C8 */	addi r3, r3, j3dSys@l
...
/* 8009C53C 0009947C  90 0D 90 50 */	stw r0, sOldVcdVatCmd__8J3DShape-_SDA_BASE_(r13)
...
/* 8009C570 000994B0  80 02 D1 70 */	lwz r0, d_d_model__LIT_3621-_SDA2_BASE_(r2)
...
/* 8009C5B0 000994F0  80 0D 80 88 */	lwz r0, g_whiteColor-_SDA_BASE_(r13)
...
/* 8009C5DC 0009951C  3C 60 80 43 */	lis r3, j3dSys@ha
/* 8009C5E0 00099520  3B C3 4A C8 */	addi r30, r3, j3dSys@l
/* 8009C5E4 00099524  48 00 00 44 */	b func_8009C628

/* 8009C5E8 0040 .text      func_8009C5E8                  func_8009C5E8                  */
.global func_8009C5E8
func_8009C5E8:
...
/* 8009C628 0028 .text      func_8009C628                  func_8009C628                  */
.global func_8009C628
func_8009C628:
/* 8009C628 00099568  28 1C 00 00 */	cmplwi r28, 0
/* 8009C62C 0009956C  40 82 FF BC */	bne func_8009C5E8
...
/* 8009C650 0018 .text      create__6dMdl_cFP12J3DModelDataUsP12dKy_tevstr_c create__6dMdl_cFP12J3DModelDataUsP12dKy_tevstr_c */
...
/* 8009C668 0050 .text      entryObj__6dMdl_cFP10dMdl_obj_c entryObj__6dMdl_cFP10dMdl_obj_c */
.global entryObj__6dMdl_cFP10dMdl_obj_c
entryObj__6dMdl_cFP10dMdl_obj_c:
...
/* 8009C68C 000995CC  40 82 00 2C */	bne func_8009C6B8
...
/* 8009C6B8 0024 .text      func_8009C6B8                  func_8009C6B8                  */
.global func_8009C6B8
func_8009C6B8:
...
/* 8009C6DC 0014 .text      search__10dMdl_mng_cFP12J3DModelDataUsP12dKy_tevstr_c search__10dMdl_mng_cFP12J3DModelDataUsP12dKy_tevstr_c */
...
/* 8009C6EC 0009962C  40 81 00 30 */	ble func_8009C71C

/* 8009C6F0 0024 .text      func_8009C6F0                  func_8009C6F0                  */
.global func_8009C6F0
func_8009C6F0:
/* 8009C6F0 00099630  80 03 00 10 */	lwz r0, 0x10(r3)
/* 8009C6F4 00099634  7C 00 20 40 */	cmplw r0, r4
/* 8009C6F8 00099638  40 82 00 1C */	bne func_8009C714
/* 8009C6FC 0009963C  A0 03 00 18 */	lhz r0, 0x18(r3)
/* 8009C700 00099640  7C 05 00 40 */	cmplw r5, r0
/* 8009C704 00099644  40 82 00 10 */	bne func_8009C714
/* 8009C708 00099648  80 03 00 14 */	lwz r0, 0x14(r3)
/* 8009C70C 0009964C  7C 00 30 40 */	cmplw r0, r6
/* 8009C710 00099650  4D 82 00 20 */	beqlr 

/* 8009C714 0008 .text      func_8009C714                  func_8009C714                  */
.global func_8009C714
func_8009C714:
/* 8009C714 00099654  38 63 00 20 */	addi r3, r3, 0x20
/* 8009C718 00099658  42 00 FF D8 */	bdnz func_8009C6F0

/* 8009C71C 0008 .text      func_8009C71C                  func_8009C71C                  */
.global func_8009C71C
func_8009C71C:
/* 8009C71C 0009965C  38 60 00 00 */	li r3, 0
/* 8009C720 00099660  4E 80 00 20 */	blr 

/* 8009C724 0044 .text      entry__10dMdl_mng_cFP12J3DModelDataUsP12dKy_tevstr_c entry__10dMdl_mng_cFP12J3DModelDataUsP12dKy_tevstr_c */
...
/* 8009C750 00099690  40 82 00 40 */	bne func_8009C790
/* 8009C754 00099694  88 1B 00 80 */	lbz r0, 0x80(r27)
/* 8009C758 00099698  28 00 00 04 */	cmplwi r0, 4
/* 8009C75C 0009969C  41 80 00 0C */	blt func_8009C768
/* 8009C760 000996A0  38 60 00 00 */	li r3, 0
/* 8009C764 000996A4  48 00 00 30 */	b func_8009C794

/* 8009C768 0028 .text      func_8009C768                  func_8009C768                  */
.global func_8009C768
func_8009C768:
...
/* 8009C790 0004 .text      func_8009C790                  func_8009C790                  */
.global func_8009C790
func_8009C790:
/* 8009C790 000996D0  7F E3 FB 78 */	mr r3, r31

/* 8009C794 0018 .text      func_8009C794                  func_8009C794                  */
.global func_8009C794
func_8009C794:
...
/* 8009C7AC 0044 .text      create__10dMdl_mng_cFv         create__10dMdl_mng_cFv         */
...
/* 8009C7C8 00099708  41 82 00 28 */	beq func_8009C7F0
...
/* 8009C7F0 0018 .text      func_8009C7F0                  func_8009C7F0                  */
.global func_8009C7F0
func_8009C7F0:
/* 8009C7F0 00099730  93 ED 8A 20 */	stw r31, m_myObj__10dMdl_mng_c-_SDA_BASE_(r13)
...
/* 8009C808 0034 .text      __dt__6dMdl_cFv                __dt__6dMdl_cFv                */
...
/* 8009C81C 0009975C  41 82 00 30 */	beq func_8009C84C
/* 8009C820 00099760  3C 60 80 3B */	lis r3, __vt__6dMdl_c@ha
/* 8009C824 00099764  38 03 F9 78 */	addi r0, r3, __vt__6dMdl_c@l
/* 8009C828 00099768  90 1F 00 00 */	stw r0, 0(r31)
/* 8009C82C 0009976C  41 82 00 10 */	beq func_8009C83C
/* 8009C830 00099770  3C 60 80 3D */	lis r3, __vt__9J3DPacket@ha
/* 8009C834 00099774  38 03 D9 7C */	addi r0, r3, __vt__9J3DPacket@l
/* 8009C838 00099778  90 1F 00 00 */	stw r0, 0(r31)

/* 8009C83C 0010 .text      func_8009C83C                  func_8009C83C                  */
.global func_8009C83C
func_8009C83C:
/* 8009C83C 0009977C  7C 80 07 35 */	extsh. r0, r4
/* 8009C840 00099780  40 81 00 0C */	ble func_8009C84C
/* 8009C844 00099784  7F E3 FB 78 */	mr r3, r31
/* 8009C848 00099788  48 23 24 F5 */	bl __dl__FPv

/* 8009C84C 0018 .text      func_8009C84C                  func_8009C84C                  */
.global func_8009C84C
func_8009C84C:
...
/* 8009C864 0040 .text      remove__10dMdl_mng_cFv         remove__10dMdl_mng_cFv         */
...
/* 8009C874 000997B4  83 ED 8A 20 */	lwz r31, m_myObj__10dMdl_mng_c-_SDA_BASE_(r13)
/* 8009C878 000997B8  28 1F 00 00 */	cmplwi r31, 0
/* 8009C87C 000997BC  41 82 00 30 */	beq func_8009C8AC
/* 8009C880 000997C0  41 82 00 24 */	beq func_8009C8A4
...
/* 8009C8A4 0008 .text      func_8009C8A4                  func_8009C8A4                  */
.global func_8009C8A4
func_8009C8A4:
/* 8009C8A4 000997E4  38 00 00 00 */	li r0, 0
/* 8009C8A8 000997E8  90 0D 8A 20 */	stw r0, m_myObj__10dMdl_mng_c-_SDA_BASE_(r13)

/* 8009C8AC 0014 .text      func_8009C8AC                  func_8009C8AC                  */
...
/* 8009C8C0 0018 .text      reset__10dMdl_mng_cFv          reset__10dMdl_mng_cFv          */
.global reset__10dMdl_mng_cFv
reset__10dMdl_mng_cFv:
/* 8009C8C0 00099800  80 6D 8A 20 */	lwz r3, m_myObj__10dMdl_mng_c-_SDA_BASE_(r13)
...
/* 8009C8D8 0028 .text      entry__10dMdl_mng_cFP12J3DModelDataUsi entry__10dMdl_mng_cFP12J3DModelDataUsi */
.global entry__10dMdl_mng_cFP12J3DModelDataUsi
...
/* 8009C8EC 0009982C  80 6D 8A 20 */	lwz r3, m_myObj__10dMdl_mng_c-_SDA_BASE_(r13)
/* 8009C8F0 00099830  28 03 00 00 */	cmplwi r3, 0
/* 8009C8F4 00099834  40 82 00 0C */	bne func_8009C900
/* 8009C8F8 00099838  38 60 00 00 */	li r3, 0
/* 8009C8FC 0009983C  48 00 00 24 */	b func_8009C920

/* 8009C900 0020 .text      func_8009C900                  func_8009C900                  */
.global func_8009C900
func_8009C900:
/* 8009C900 00099840  1C A5 04 04 */	mulli r5, r5, 0x404
/* 8009C904 00099844  3C 80 80 3F */	lis r4, mStatus__20dStage_roomControl_c@ha
/* 8009C908 00099848  38 04 60 94 */	addi r0, r4, mStatus__20dStage_roomControl_c@l
...
/* 8009C920 0010 .text      func_8009C920                  func_8009C920                  */
.global func_8009C920
func_8009C920:
...
/* 8009C930 0034 .text      __ct__6dMdl_cFv                __ct__6dMdl_cFv                */
.global __ct__6dMdl_cFv
__ct__6dMdl_cFv:
/* 8009C930 00099870  3C 80 80 3D */	lis r4, __vt__9J3DPacket@ha
/* 8009C934 00099874  38 04 D9 7C */	addi r0, r4, __vt__9J3DPacket@l
...
/* 8009C94C 0009988C  3C 80 80 3B */	lis r4, __vt__6dMdl_c@ha
/* 8009C950 00099890  38 04 F9 78 */	addi r0, r4, __vt__6dMdl_c@l
...
/* ###################################################################################### */
.section .data, "aw"
/* 803AF978 0014 .data      __vt__6dMdl_c                  __vt__6dMdl_c                  */
.global __vt__6dMdl_c
__vt__6dMdl_c:
...
/* ###################################################################################### */
.section .sbss, "aw"
/* 80450FA0 0004 .sbss      m_myObj__10dMdl_mng_c          m_myObj__10dMdl_mng_c          */
.global m_myObj__10dMdl_mng_c
m_myObj__10dMdl_mng_c:
.skip 0x4
.skip 0x4 /* padding */
...
/* 80456B70 0004 .sbss2     d_d_model__LIT_3621            @3621                          */
.global d_d_model__LIT_3621
d_d_model__LIT_3621:
.skip 0x4
.skip 0x4 /* padding */

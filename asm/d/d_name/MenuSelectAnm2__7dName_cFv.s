...
/* 8024FEC4  48 11 23 19 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8024FEC8  7C 7D 1B 78 */	mr r29, r3                              
/* 8024FECC  88 83 02 B0 */	lbz r4, 0x2b0(r3)                       
/* 8024FED0  48 00 11 79 */	bl getMenuPosIdx__7dName_cFUc            /* constant-address: 80251048, symbol: getMenuPosIdx__7dName_cFUc */
/* 8024FED4  7C 7E 1B 78 */	mr r30, r3                              
/* 8024FED8  7F A3 EB 78 */	mr r3, r29                              
/* 8024FEDC  88 9D 02 A9 */	lbz r4, 0x2a9(r29)                      
/* 8024FEE0  48 00 11 69 */	bl getMenuPosIdx__7dName_cFUc            /* constant-address: 80251048, symbol: getMenuPosIdx__7dName_cFUc */
/* 8024FEE4  7C 7F 1B 78 */	mr r31, r3                              
/* 8024FEE8  38 60 00 01 */	li r3, 1                                
/* 8024FEEC  7C 1E F8 00 */	cmpw r30, r31                           
/* 8024FEF0  41 82 00 2C */	beq lbl_8024FF1C                         /* constant-address: 8024FF1C, symbol: lbl_8024FF1C */
...
/* 8024FF08  38 A5 07 34 */	addi r5, r5, g_nmHIO@l                   /* constant-address: 80430734, symbol: g_nmHIO */
/* 8024FF0C  C0 25 00 08 */	lfs f1, 8(r5)                            /* constant-address: 8043073C, symbol: None */
/* 8024FF10  C0 42 B3 C0 */	lfs f2, lit_3820(r2)                     /* constant-address: 80454DC0, symbol: lit_3820 */
/* 8024FF14  38 A0 00 00 */	li r5, 0                                
/* 8024FF18  48 00 48 B5 */	bl scaleAnime__8CPaneMgrFsffUc           /* constant-address: 802547CC, symbol: scaleAnime__8CPaneMgrFsffUc */
lbl_8024FF1C:
/* 8024FF1C  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8024FF20  28 00 00 01 */	cmplwi r0, 1                            
/* 8024FF24  40 82 00 64 */	bne lbl_8024FF88                         /* constant-address: 8024FF88, symbol: lbl_8024FF88 */
/* 8024FF28  7C 1E F8 00 */	cmpw r30, r31                           
/* 8024FF2C  41 82 00 44 */	beq lbl_8024FF70                         /* constant-address: 8024FF70, symbol: lbl_8024FF70 */
...
/* 8024FF74  4B FF FA 21 */	bl selectCursorMove__7dName_cFv          /* constant-address: 8024F994, symbol: selectCursorMove__7dName_cFv */
...
/* 8024FF8C  48 11 22 9D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

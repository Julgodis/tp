...
/* 8024ECAC  41 80 00 0C */	blt lbl_8024ECB8                         /* constant-address: 8024ECB8, symbol: lbl_8024ECB8 */
/* 8024ECB0  7C 00 20 50 */	subf r0, r0, r4                         
/* 8024ECB4  90 03 00 28 */	stw r0, 0x28(r3)                        
lbl_8024ECB8:
/* 8024ECB8  80 03 00 28 */	lwz r0, 0x28(r3)                        
/* 8024ECBC  C8 22 B3 C8 */	lfd f1, lit_3936(r2)                     /* constant-address: 80454DC8, symbol: lit_3936 */
...
/* 8024ECFC  41 80 00 0C */	blt lbl_8024ED08                         /* constant-address: 8024ED08, symbol: lbl_8024ED08 */
/* 8024ED00  7C 00 20 50 */	subf r0, r0, r4                         
/* 8024ED04  90 03 00 30 */	stw r0, 0x30(r3)                        
lbl_8024ED08:
/* 8024ED08  80 03 00 30 */	lwz r0, 0x30(r3)                        
/* 8024ED0C  C8 22 B3 C8 */	lfd f1, lit_3936(r2)                     /* constant-address: 80454DC8, symbol: lit_3936 */
...
/* 8024ED34  48 0A A9 5D */	bl animation__9J2DScreenFv               /* constant-address: 802F9690, symbol: animation__9J2DScreenFv */

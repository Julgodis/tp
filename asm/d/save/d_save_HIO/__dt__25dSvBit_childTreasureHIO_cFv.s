...
/* 8025C888  41 82 00 34 */	beq lbl_8025C8BC                         /* constant-address: 8025C8BC, symbol: lbl_8025C8BC */
/* 8025C88C  3C 60 80 3C */	lis r3, __vt__25dSvBit_childTreasureHIO_c@ha
/* 8025C890  38 03 33 90 */	addi r0, r3, __vt__25dSvBit_childTreasureHIO_c@l /* constant-address: 803C3390, symbol: __vt__25dSvBit_childTreasureHIO_c */
/* 8025C894  90 1F 00 00 */	stw r0, 0(r31)                          
/* 8025C898  34 1F 00 08 */	addic. r0, r31, 8                       
/* 8025C89C  41 82 00 10 */	beq lbl_8025C8AC                         /* constant-address: 8025C8AC, symbol: lbl_8025C8AC */
/* 8025C8A0  3C 60 80 3C */	lis r3, __vt__29dSvBit_childTbPerfectionHIO_c@ha
/* 8025C8A4  38 03 33 24 */	addi r0, r3, __vt__29dSvBit_childTbPerfectionHIO_c@l /* constant-address: 803C3324, symbol: __vt__29dSvBit_childTbPerfectionHIO_c */
/* 8025C8A8  90 1F 00 08 */	stw r0, 8(r31)                          
lbl_8025C8AC:
/* 8025C8AC  7C 80 07 35 */	extsh. r0, r4                           
/* 8025C8B0  40 81 00 0C */	ble lbl_8025C8BC                         /* constant-address: 8025C8BC, symbol: lbl_8025C8BC */
/* 8025C8B4  7F E3 FB 78 */	mr r3, r31                              
/* 8025C8B8  48 07 24 85 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_8025C8BC:

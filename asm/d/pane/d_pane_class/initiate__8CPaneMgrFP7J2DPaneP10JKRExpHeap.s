...
/* 80253C2C  41 82 00 0C */	beq lbl_80253C38                         /* constant-address: 80253C38, symbol: lbl_80253C38 */
/* 80253C30  90 BE 00 08 */	stw r5, 8(r30)                          
/* 80253C34  48 00 00 0C */	b lbl_80253C40                           /* constant-address: 80253C40, symbol: lbl_80253C40 */
lbl_80253C38:
/* 80253C38  4B DB B5 B5 */	bl mDoExt_getCurrentHeap__Fv             /* constant-address: 8000F1EC, symbol: mDoExt_getCurrentHeap__Fv */
...
/* 80253C60  41 82 00 94 */	beq lbl_80253CF4                         /* constant-address: 80253CF4, symbol: lbl_80253CF4 */
/* 80253C64  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 80253C68  48 0A 3E 25 */	bl getFirstChildPane__7J2DPaneFv         /* constant-address: 802F7A8C, symbol: getFirstChildPane__7J2DPaneFv */
/* 80253C6C  7C 64 1B 78 */	mr r4, r3                               
/* 80253C70  7F C3 F3 78 */	mr r3, r30                              
/* 80253C74  48 00 1D ED */	bl childPaneCount__13CPaneMgrAlphaFP7J2DPane /* constant-address: 80255A60, symbol: childPaneCount__13CPaneMgrAlphaFP7J2DPane */
/* 80253C78  88 1E 00 19 */	lbz r0, 0x19(r30)                       
/* 80253C7C  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 80253C80  41 82 00 38 */	beq lbl_80253CB8                         /* constant-address: 80253CB8, symbol: lbl_80253CB8 */
...
/* 80253C94  48 07 A8 41 */	bl alloc__7JKRHeapFUli                   /* constant-address: 802CE4D4, symbol: alloc__7JKRHeapFUli */
...
/* 80253CA8  48 0A 3D E5 */	bl getFirstChildPane__7J2DPaneFv         /* constant-address: 802F7A8C, symbol: getFirstChildPane__7J2DPaneFv */
/* 80253CAC  7C 64 1B 78 */	mr r4, r3                               
/* 80253CB0  7F C3 F3 78 */	mr r3, r30                              
/* 80253CB4  48 00 03 65 */	bl childPaneGetSize__8CPaneMgrFP7J2DPane /* constant-address: 80254018, symbol: childPaneGetSize__8CPaneMgrFP7J2DPane */
lbl_80253CB8:
/* 80253CB8  88 1E 00 19 */	lbz r0, 0x19(r30)                       
/* 80253CBC  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 80253CC0  41 82 00 34 */	beq lbl_80253CF4                         /* constant-address: 80253CF4, symbol: lbl_80253CF4 */
/* 80253CC4  80 7E 00 08 */	lwz r3, 8(r30)                          
/* 80253CC8  A8 9E 00 14 */	lha r4, 0x14(r30)                       
/* 80253CCC  38 A0 00 20 */	li r5, 0x20                             
/* 80253CD0  48 07 A8 05 */	bl alloc__7JKRHeapFUli                   /* constant-address: 802CE4D4, symbol: alloc__7JKRHeapFUli */
...
/* 80253CE4  48 0A 3D A9 */	bl getFirstChildPane__7J2DPaneFv         /* constant-address: 802F7A8C, symbol: getFirstChildPane__7J2DPaneFv */
/* 80253CE8  7C 64 1B 78 */	mr r4, r3                               
/* 80253CEC  7F C3 F3 78 */	mr r3, r30                              
/* 80253CF0  48 00 1D DD */	bl childPaneGetAlpha__13CPaneMgrAlphaFP7J2DPane /* constant-address: 80255ACC, symbol: childPaneGetAlpha__13CPaneMgrAlphaFP7J2DPane */
lbl_80253CF4:
/* 80253CF4  7F E3 FB 78 */	mr r3, r31                              
/* 80253CF8  48 0A 34 09 */	bl getBounds__7J2DPaneFv                 /* constant-address: 802F7100, symbol: getBounds__7J2DPaneFv */
/* 80253CFC  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 80253D00  D0 1E 00 24 */	stfs f0, 0x24(r30)                      
/* 80253D04  7F E3 FB 78 */	mr r3, r31                              
/* 80253D08  48 0A 33 F9 */	bl getBounds__7J2DPaneFv                 /* constant-address: 802F7100, symbol: getBounds__7J2DPaneFv */
/* 80253D0C  C0 03 00 04 */	lfs f0, 4(r3)                           
/* 80253D10  D0 1E 00 28 */	stfs f0, 0x28(r30)                      
/* 80253D14  7F C3 F3 78 */	mr r3, r30                              
/* 80253D18  48 00 05 D1 */	bl getGlobalPosX__8CPaneMgrFv            /* constant-address: 802542E8, symbol: getGlobalPosX__8CPaneMgrFv */
/* 80253D1C  D0 3E 00 2C */	stfs f1, 0x2c(r30)                      
/* 80253D20  7F C3 F3 78 */	mr r3, r30                              
/* 80253D24  48 00 06 41 */	bl getGlobalPosY__8CPaneMgrFv            /* constant-address: 80254364, symbol: getGlobalPosY__8CPaneMgrFv */
...
/* 80253DA0  40 82 00 10 */	bne lbl_80253DB0                         /* constant-address: 80253DB0, symbol: lbl_80253DB0 */
/* 80253DA4  38 00 00 FF */	li r0, 0xff                             
/* 80253DA8  98 1E 00 18 */	stb r0, 0x18(r30)                       
/* 80253DAC  48 00 00 0C */	b lbl_80253DB8                           /* constant-address: 80253DB8, symbol: lbl_80253DB8 */
lbl_80253DB0:
...
/* 80253DE4  38 05 58 33 */	addi r0, r5, 0x5833 /* 0x54425833@l */   /* constant-address: 54425833 */
/* 80253DE8  7C 06 00 00 */	cmpw r6, r0                             
/* 80253DEC  40 80 00 34 */	bge lbl_80253E20                         /* constant-address: 80253E20, symbol: lbl_80253E20 */
/* 80253DF0  3C 60 50 49 */	lis r3, 0x5049 /* 0x50494333@ha */      
/* 80253DF4  38 03 43 33 */	addi r0, r3, 0x4333 /* 0x50494333@l */   /* constant-address: 50494333 */
/* 80253DF8  7C 06 00 00 */	cmpw r6, r0                             
/* 80253DFC  40 80 00 14 */	bge lbl_80253E10                         /* constant-address: 80253E10, symbol: lbl_80253E10 */
/* 80253E00  38 03 43 31 */	addi r0, r3, 0x4331                      /* constant-address: 50494331 */
/* 80253E04  7C 06 00 00 */	cmpw r6, r0                             
/* 80253E08  40 80 00 B8 */	bge lbl_80253EC0                         /* constant-address: 80253EC0, symbol: lbl_80253EC0 */
/* 80253E0C  48 00 01 B4 */	b lbl_80253FC0                           /* constant-address: 80253FC0, symbol: lbl_80253FC0 */
lbl_80253E10:
/* 80253E10  38 05 58 31 */	addi r0, r5, 0x5831                      /* constant-address: 54425831 */
/* 80253E14  7C 06 00 00 */	cmpw r6, r0                             
/* 80253E18  40 80 01 28 */	bge lbl_80253F40                         /* constant-address: 80253F40, symbol: lbl_80253F40 */
/* 80253E1C  48 00 01 A4 */	b lbl_80253FC0                           /* constant-address: 80253FC0, symbol: lbl_80253FC0 */
lbl_80253E20:
/* 80253E20  3C 60 57 49 */	lis r3, 0x5749 /* 0x57494E33@ha */      
/* 80253E24  38 03 4E 33 */	addi r0, r3, 0x4E33 /* 0x57494E33@l */   /* constant-address: 57494E33 */
/* 80253E28  7C 06 00 00 */	cmpw r6, r0                             
/* 80253E2C  40 80 01 94 */	bge lbl_80253FC0                         /* constant-address: 80253FC0, symbol: lbl_80253FC0 */
/* 80253E30  38 03 4E 31 */	addi r0, r3, 0x4e31                      /* constant-address: 57494E31 */
/* 80253E34  7C 06 00 00 */	cmpw r6, r0                             
/* 80253E38  40 80 00 08 */	bge lbl_80253E40                         /* constant-address: 80253E40, symbol: lbl_80253E40 */
/* 80253E3C  48 00 01 84 */	b lbl_80253FC0                           /* constant-address: 80253FC0, symbol: lbl_80253FC0 */
lbl_80253E40:
...
/* 80253EBC  48 00 01 2C */	b lbl_80253FE8                           /* constant-address: 80253FE8, symbol: lbl_80253FE8 */
lbl_80253EC0:
...
/* 80253F3C  48 00 00 AC */	b lbl_80253FE8                           /* constant-address: 80253FE8, symbol: lbl_80253FE8 */
lbl_80253F40:
...
/* 80253FBC  48 00 00 2C */	b lbl_80253FE8                           /* constant-address: 80253FE8, symbol: lbl_80253FE8 */
lbl_80253FC0:

...
/* 8009C734  48 2C 5A A1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 8009C738  7C 7B 1B 78 */	mr r27, r3                              
/* 8009C73C  7C 9C 23 78 */	mr r28, r4                              
/* 8009C740  7C BD 2B 78 */	mr r29, r5                              
/* 8009C744  7C DE 33 78 */	mr r30, r6                              
/* 8009C748  4B FF FF 95 */	bl search__10dMdl_mng_cFP12J3DModelDataUsP12dKy_tevstr_c /* constant-address: 8009C6DC, symbol: search__10dMdl_mng_cFP12J3DModelDataUsP12dKy_tevstr_c */
/* 8009C74C  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8009C750  40 82 00 40 */	bne lbl_8009C790                         /* constant-address: 8009C790, symbol: lbl_8009C790 */
/* 8009C754  88 1B 00 80 */	lbz r0, 0x80(r27)                       
/* 8009C758  28 00 00 04 */	cmplwi r0, 4                            
/* 8009C75C  41 80 00 0C */	blt lbl_8009C768                         /* constant-address: 8009C768, symbol: lbl_8009C768 */
/* 8009C760  38 60 00 00 */	li r3, 0                                
/* 8009C764  48 00 00 30 */	b lbl_8009C794                           /* constant-address: 8009C794, symbol: lbl_8009C794 */
lbl_8009C768:
...
/* 8009C780  4B FF FE D1 */	bl create__6dMdl_cFP12J3DModelDataUsP12dKy_tevstr_c /* constant-address: 8009C650, symbol: create__6dMdl_cFP12J3DModelDataUsP12dKy_tevstr_c */
...
/* 8009C798  48 2C 5A 89 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

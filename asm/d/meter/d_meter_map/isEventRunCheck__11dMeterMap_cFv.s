...
/* 8020D6B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8020D6B4  88 03 4F AD */	lbz r0, 0x4fad(r3)                       /* constant-address: 8040B16D, symbol: None */
/* 8020D6B8  28 00 00 00 */	cmplwi r0, 0                            
/* 8020D6BC  41 82 00 0C */	beq lbl_8020D6C8                         /* constant-address: 8020D6C8, symbol: lbl_8020D6C8 */
/* 8020D6C0  38 60 00 01 */	li r3, 1                                
/* 8020D6C4  48 00 00 54 */	b lbl_8020D718                           /* constant-address: 8020D718, symbol: lbl_8020D718 */
lbl_8020D6C8:
/* 8020D6C8  48 02 AB 65 */	bl getStatus__12dMsgObject_cFv           /* constant-address: 8023822C, symbol: getStatus__12dMsgObject_cFv */
...
/* 8020D6E0  41 82 00 0C */	beq lbl_8020D6EC                         /* constant-address: 8020D6EC, symbol: lbl_8020D6EC */
/* 8020D6E4  38 60 00 01 */	li r3, 1                                
/* 8020D6E8  48 00 00 30 */	b lbl_8020D718                           /* constant-address: 8020D718, symbol: lbl_8020D718 */
lbl_8020D6EC:
/* 8020D6EC  80 9F 00 30 */	lwz r4, 0x30(r31)                       
/* 8020D6F0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8020D6F4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8020D6F8  88 63 4F AD */	lbz r3, 0x4fad(r3)                       /* constant-address: 8040B16D, symbol: None */

...
/* 8021A72C  48 14 7A A1 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 8021A744  40 82 00 08 */	bne lbl_8021A74C                         /* constant-address: 8021A74C, symbol: lbl_8021A74C */
...
/* 8021A758  40 82 00 10 */	bne lbl_8021A768                         /* constant-address: 8021A768, symbol: lbl_8021A768 */
/* 8021A75C  38 00 00 01 */	li r0, 1                                
/* 8021A760  98 1F 07 6C */	stb r0, 0x76c(r31)                      
/* 8021A764  48 00 00 0C */	b lbl_8021A770                           /* constant-address: 8021A770, symbol: lbl_8021A770 */
lbl_8021A768:
...
/* 8021A7AC  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 8021A7B0  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
...
/* 8021A7D0  48 00 27 39 */	bl readItemTexture__13dMeter2Info_cFUcPvP10J2DPicturePvP10J2DPicturePvP10J2DPicturePvP10J2DPicturei /* constant-address: 8021CF08, symbol: readItemTexture__13dMeter2Info_cFUcPvP10J2DPicturePvP10J2DPicturePvP10J2DPicturePvP10J2DPicturei */
/* 8021A7D4  2C 03 00 01 */	cmpwi r3, 1                             
/* 8021A7D8  41 81 00 14 */	bgt lbl_8021A7EC                         /* constant-address: 8021A7EC, symbol: lbl_8021A7EC */
/* 8021A7DC  38 00 00 00 */	li r0, 0                                
/* 8021A7E0  80 7D 05 18 */	lwz r3, 0x518(r29)                      
/* 8021A7E4  98 03 00 B0 */	stb r0, 0xb0(r3)                        
/* 8021A7E8  48 00 00 10 */	b lbl_8021A7F8                           /* constant-address: 8021A7F8, symbol: lbl_8021A7F8 */
lbl_8021A7EC:
/* 8021A7EC  38 00 00 01 */	li r0, 1                                
/* 8021A7F0  80 7D 05 18 */	lwz r3, 0x518(r29)                      
/* 8021A7F4  98 03 00 B0 */	stb r0, 0xb0(r3)                        
lbl_8021A7F8:
/* 8021A7F8  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8021A7FC  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8021A800  88 03 05 68 */	lbz r0, 0x568(r3)                        /* constant-address: 8042F130, symbol: None */
/* 8021A804  28 00 00 01 */	cmplwi r0, 1                            
/* 8021A808  40 82 00 2C */	bne lbl_8021A834                         /* constant-address: 8021A834, symbol: lbl_8021A834 */
/* 8021A80C  88 03 05 69 */	lbz r0, 0x569(r3)                        /* constant-address: 8042F131, symbol: None */
/* 8021A810  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021A828  C0 02 AE D8 */	lfs f0, lit_8548(r2)                     /* constant-address: 804548D8, symbol: lit_8548 */
/* 8021A82C  EC 81 00 24 */	fdivs f4, f1, f0                        
/* 8021A830  48 00 00 3C */	b lbl_8021A86C                           /* constant-address: 8021A86C, symbol: lbl_8021A86C */
lbl_8021A834:
/* 8021A834  3C 60 80 3B */	lis r3, item_resource__10dItem_data@ha  
/* 8021A838  38 63 C5 A0 */	addi r3, r3, item_resource__10dItem_data@l /* constant-address: 803AC5A0, symbol: item_resource__10dItem_data */
...
/* 8021A84C  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021A864  C0 02 AE D8 */	lfs f0, lit_8548(r2)                     /* constant-address: 804548D8, symbol: lit_8548 */
...
/* 8021A884  C8 42 AE C0 */	lfd f2, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021A8A0  C0 22 AE DC */	lfs f1, lit_8549(r2)                     /* constant-address: 804548DC, symbol: lit_8549 */
...
/* 8021A8F4  C0 22 AE 94 */	lfs f1, lit_4922(r2)                     /* constant-address: 80454894, symbol: lit_4922 */
...
/* 8021A94C  40 82 00 28 */	bne lbl_8021A974                         /* constant-address: 8021A974, symbol: lbl_8021A974 */
...
/* 8021A96C  48 03 9C 45 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 8021A970  48 00 00 24 */	b lbl_8021A994                           /* constant-address: 8021A994, symbol: lbl_8021A994 */
lbl_8021A974:
...
/* 8021A990  48 03 9C 21 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
lbl_8021A994:
...
/* 8021A9B4  48 14 78 65 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

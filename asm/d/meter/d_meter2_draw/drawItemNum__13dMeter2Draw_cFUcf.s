...
/* 8021AEE0  48 14 72 F9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8021AEE4  7C 7C 1B 78 */	mr r28, r3                              
/* 8021AEE8  7C 9E 23 78 */	mr r30, r4                              
/* 8021AEEC  C0 02 AE 84 */	lfs f0, lit_4183(r2)                     /* constant-address: 80454884, symbol: lit_4183 */
/* 8021AEF0  FC 00 08 00 */	fcmpu cr0, f0, f1                       
/* 8021AEF4  40 82 00 14 */	bne lbl_8021AF08                         /* constant-address: 8021AF08, symbol: lbl_8021AF08 */
/* 8021AEF8  57 C0 15 BA */	rlwinm r0, r30, 2, 0x16, 0x1d           
/* 8021AEFC  7C 7C 02 14 */	add r3, r28, r0                         
/* 8021AF00  80 63 03 2C */	lwz r3, 0x32c(r3)                       
/* 8021AF04  48 03 A9 25 */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
lbl_8021AF08:
/* 8021AF08  3B A0 00 00 */	li r29, 0                               
/* 8021AF0C  3B E0 00 00 */	li r31, 0                               
/* 8021AF10  C0 02 AE CC */	lfs f0, lit_8207(r2)                     /* constant-address: 804548CC, symbol: lit_8207 */
...
/* 8021AF54  41 80 FF D4 */	blt lbl_8021AF28                         /* constant-address: 8021AF28, symbol: lbl_8021AF28 */
/* 8021AF58  E3 E1 00 28 */	psq_l f31, 40(r1), 0, 0 /* qr0 */       
/* 8021AF5C  CB E1 00 20 */	lfd f31, 0x20(r1)                       
/* 8021AF60  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8021AF64  48 14 72 C1 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

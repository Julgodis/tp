...
/* 802156EC  41 81 00 10 */	bgt lbl_802156FC                         /* constant-address: 802156FC, symbol: lbl_802156FC */
/* 802156F0  C0 02 AE 80 */	lfs f0, lit_4182(r2)                     /* constant-address: 80454880, symbol: lit_4182 */
/* 802156F4  D0 03 06 00 */	stfs f0, 0x600(r3)                      
/* 802156F8  48 00 00 5C */	b lbl_80215754                           /* constant-address: 80215754, symbol: lbl_80215754 */
lbl_802156FC:
...
/* 8021570C  40 80 00 0C */	bge lbl_80215718                         /* constant-address: 80215718, symbol: lbl_80215718 */
/* 80215710  38 00 00 00 */	li r0, 0                                
/* 80215714  B0 03 07 44 */	sth r0, 0x744(r3)                       
lbl_80215718:
/* 80215718  A8 03 07 44 */	lha r0, 0x744(r3)                       
/* 8021571C  C8 22 AE A0 */	lfd f1, lit_4925(r2)                     /* constant-address: 804548A0, symbol: lit_4925 */
...
/* 80215738  C0 02 AE BC */	lfs f0, lit_6210(r2)                     /* constant-address: 804548BC, symbol: lit_6210 */
/* 8021573C  EC 21 00 24 */	fdivs f1, f1, f0                        
/* 80215740  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 80215744  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80215748  C0 04 00 18 */	lfs f0, 0x18(r4)                         /* constant-address: 8042EBE0, symbol: None */

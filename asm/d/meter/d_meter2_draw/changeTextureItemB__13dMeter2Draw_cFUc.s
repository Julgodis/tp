...
/* 8021A478  48 14 7D 65 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8021A490  40 82 00 0C */	bne lbl_8021A49C                         /* constant-address: 8021A49C, symbol: lbl_8021A49C */
/* 8021A494  3B E0 00 02 */	li r31, 2                               
/* 8021A498  48 00 00 28 */	b lbl_8021A4C0                           /* constant-address: 8021A4C0, symbol: lbl_8021A4C0 */
lbl_8021A49C:
/* 8021A49C  38 1E FF D8 */	addi r0, r30, -40                       
/* 8021A4A0  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 8021A4A4  28 00 00 01 */	cmplwi r0, 1                            
/* 8021A4A8  40 81 00 14 */	ble lbl_8021A4BC                         /* constant-address: 8021A4BC, symbol: lbl_8021A4BC */
/* 8021A4AC  28 03 00 3F */	cmplwi r3, 0x3f                         
/* 8021A4B0  41 82 00 0C */	beq lbl_8021A4BC                         /* constant-address: 8021A4BC, symbol: lbl_8021A4BC */
/* 8021A4B4  28 03 00 49 */	cmplwi r3, 0x49                         
/* 8021A4B8  40 82 00 08 */	bne lbl_8021A4C0                         /* constant-address: 8021A4C0, symbol: lbl_8021A4C0 */
lbl_8021A4BC:
/* 8021A4BC  3B E0 00 01 */	li r31, 1                               
lbl_8021A4C0:
/* 8021A4C0  88 1D 07 6B */	lbz r0, 0x76b(r29)                      
/* 8021A4C4  28 00 00 00 */	cmplwi r0, 0                            
/* 8021A4C8  40 82 00 10 */	bne lbl_8021A4D8                         /* constant-address: 8021A4D8, symbol: lbl_8021A4D8 */
/* 8021A4CC  38 00 00 01 */	li r0, 1                                
/* 8021A4D0  98 1D 07 6B */	stb r0, 0x76b(r29)                      
/* 8021A4D4  48 00 00 0C */	b lbl_8021A4E0                           /* constant-address: 8021A4E0, symbol: lbl_8021A4E0 */
lbl_8021A4D8:
...
/* 8021A4E8  48 00 13 29 */	bl setItemParamB__13dMeter2Draw_cFUc     /* constant-address: 8021B810, symbol: setItemParamB__13dMeter2Draw_cFUc */
...
/* 8021A51C  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
...
/* 8021A534  48 00 29 D5 */	bl readItemTexture__13dMeter2Info_cFUcPvP10J2DPicturePvP10J2DPicturePvP10J2DPicturePvP10J2DPicturei /* constant-address: 8021CF08, symbol: readItemTexture__13dMeter2Info_cFUcPvP10J2DPicturePvP10J2DPicturePvP10J2DPicturePvP10J2DPicturei */
/* 8021A538  2C 03 00 01 */	cmpwi r3, 1                             
/* 8021A53C  41 81 00 14 */	bgt lbl_8021A550                         /* constant-address: 8021A550, symbol: lbl_8021A550 */
/* 8021A540  38 00 00 00 */	li r0, 0                                
/* 8021A544  80 7D 05 14 */	lwz r3, 0x514(r29)                      
/* 8021A548  98 03 00 B0 */	stb r0, 0xb0(r3)                        
/* 8021A54C  48 00 00 10 */	b lbl_8021A55C                           /* constant-address: 8021A55C, symbol: lbl_8021A55C */
lbl_8021A550:
...
/* 8021A560  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8021A564  88 03 05 68 */	lbz r0, 0x568(r3)                        /* constant-address: 8042F130, symbol: None */
/* 8021A568  28 00 00 01 */	cmplwi r0, 1                            
/* 8021A56C  40 82 00 2C */	bne lbl_8021A598                         /* constant-address: 8021A598, symbol: lbl_8021A598 */
/* 8021A570  88 03 05 69 */	lbz r0, 0x569(r3)                        /* constant-address: 8042F131, symbol: None */
/* 8021A574  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021A58C  C0 02 AE D8 */	lfs f0, lit_8548(r2)                     /* constant-address: 804548D8, symbol: lit_8548 */
/* 8021A590  EC 81 00 24 */	fdivs f4, f1, f0                        
/* 8021A594  48 00 00 3C */	b lbl_8021A5D0                           /* constant-address: 8021A5D0, symbol: lbl_8021A5D0 */
lbl_8021A598:
/* 8021A598  3C 60 80 3B */	lis r3, item_resource__10dItem_data@ha  
/* 8021A59C  38 63 C5 A0 */	addi r3, r3, item_resource__10dItem_data@l /* constant-address: 803AC5A0, symbol: item_resource__10dItem_data */
...
/* 8021A5B0  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021A5C8  C0 02 AE D8 */	lfs f0, lit_8548(r2)                     /* constant-address: 804548D8, symbol: lit_8548 */
...
/* 8021A5EC  C8 42 AE C0 */	lfd f2, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021A608  C0 22 AE DC */	lfs f1, lit_8549(r2)                     /* constant-address: 804548DC, symbol: lit_8549 */
...
/* 8021A65C  C0 22 AE 94 */	lfs f1, lit_4922(r2)                     /* constant-address: 80454894, symbol: lit_4922 */
...
/* 8021A6B8  38 04 EB C8 */	addi r0, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 8021A6E4  48 03 9E CD */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 8021A708  48 14 7B 21 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

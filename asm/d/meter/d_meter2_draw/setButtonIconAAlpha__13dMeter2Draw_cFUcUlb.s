...
/* 802195C4  48 14 8C 0D */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 802195C8  7C 7E 1B 78 */	mr r30, r3                              
/* 802195CC  80 63 03 00 */	lwz r3, 0x300(r3)                       
/* 802195D0  48 03 C0 7D */	bl isVisible__13CPaneMgrAlphaFv          /* constant-address: 8025564C, symbol: isVisible__13CPaneMgrAlphaFv */
/* 802195D4  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802195D8  41 82 01 88 */	beq lbl_80219760                         /* constant-address: 80219760, symbol: lbl_80219760 */
/* 802195DC  80 7E 03 00 */	lwz r3, 0x300(r30)                      
/* 802195E0  88 03 00 18 */	lbz r0, 0x18(r3)                        
/* 802195E4  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 802195E8  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 802195EC  C0 43 00 A8 */	lfs f2, 0xa8(r3)                         /* constant-address: 8042EC70, symbol: None */
/* 802195F0  C0 23 00 18 */	lfs f1, 0x18(r3)                         /* constant-address: 8042EBE0, symbol: None */
/* 802195F4  C0 03 00 84 */	lfs f0, 0x84(r3)                         /* constant-address: 8042EC4C, symbol: None */
/* 802195F8  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802195FC  EC 42 00 32 */	fmuls f2, f2, f0                        
/* 80219600  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 8021962C  48 03 C1 FD */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 80219630  FF E0 08 90 */	fmr f31, f1                             
/* 80219634  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 80219638  3B E3 01 88 */	addi r31, r3, g_meter2_info@l            /* constant-address: 80430188, symbol: g_meter2_info */
/* 8021963C  A0 1F 00 AE */	lhz r0, 0xae(r31)                        /* constant-address: 80430236, symbol: None */
/* 80219640  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 80219644  40 82 00 24 */	bne lbl_80219668                         /* constant-address: 80219668, symbol: lbl_80219668 */
/* 80219648  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8021964C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80219650  88 03 5E 4A */	lbz r0, 0x5e4a(r3)                       /* constant-address: 8040C00A, symbol: None */
/* 80219654  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d           
/* 80219658  40 82 00 10 */	bne lbl_80219668                         /* constant-address: 80219668, symbol: lbl_80219668 */
/* 8021965C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 80219660  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80219664  8B 63 04 2B */	lbz r27, 0x42b(r3)                       /* constant-address: 8042EFF3, symbol: None */
lbl_80219668:
/* 80219668  80 7E 03 00 */	lwz r3, 0x300(r30)                      
/* 8021966C  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 80219670  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 802196B4  3B 63 EB C8 */	addi r27, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 802196B8  CB C2 AE C0 */	lfd f30, lit_6293(r2)                    /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 802196CC  A0 1F 00 AE */	lhz r0, 0xae(r31)                        /* constant-address: 80430236, symbol: None */
/* 802196D0  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 802196D4  40 82 00 48 */	bne lbl_8021971C                         /* constant-address: 8021971C, symbol: lbl_8021971C */
/* 802196D8  C8 22 AE C0 */	lfd f1, lit_6293(r2)                     /* constant-address: 804548C0, symbol: lit_6293 */
...
/* 802196F0  88 1B 04 2C */	lbz r0, 0x42c(r27)                       /* constant-address: 8042EFF4, symbol: None */
...
/* 80219704  C0 02 AE CC */	lfs f0, lit_8207(r2)                     /* constant-address: 804548CC, symbol: lit_8207 */
...
/* 80219750  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
/* 80219754  2C 1A 00 05 */	cmpwi r26, 5                            
/* 80219758  3B BD 00 04 */	addi r29, r29, 4                         /* constant-address: 00000004 */
/* 8021975C  41 80 FF 64 */	blt lbl_802196C0                         /* constant-address: 802196C0, symbol: lbl_802196C0 */
lbl_80219760:
...
/* 80219774  48 14 8A A9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

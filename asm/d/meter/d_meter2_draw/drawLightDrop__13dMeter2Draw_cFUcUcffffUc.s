...
/* 80215B48  48 14 C6 85 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 80215B70  3B E3 EB C8 */	addi r31, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
...
/* 80215B84  41 82 00 28 */	beq lbl_80215BAC                         /* constant-address: 80215BAC, symbol: lbl_80215BAC */
/* 80215B88  C0 1F 0E C4 */	lfs f0, 0xec4(r31)                       /* constant-address: 8042FA8C, symbol: None */
...
/* 80215BA8  48 00 00 4C */	b lbl_80215BF4                           /* constant-address: 80215BF4, symbol: lbl_80215BF4 */
lbl_80215BAC:
/* 80215BAC  C0 1F 0E C4 */	lfs f0, 0xec4(r31)                       /* constant-address: 8042FA8C, symbol: None */
...
/* 80215BD0  C0 1F 0E C4 */	lfs f0, 0xec4(r31)                       /* constant-address: 8042FA8C, symbol: None */
...
/* 80215BF8  40 80 00 58 */	bge lbl_80215C50                         /* constant-address: 80215C50, symbol: lbl_80215C50 */
/* 80215BFC  80 1F 0E B4 */	lwz r0, 0xeb4(r31)                       /* constant-address: 8042FA7C, symbol: None */
/* 80215C00  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 80215C04  80 1F 0E B8 */	lwz r0, 0xeb8(r31)                       /* constant-address: 8042FA80, symbol: None */
...
/* 80215C30  48 03 FB F9 */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 80215C34  80 7E 01 F4 */	lwz r3, 0x1f4(r30)                      
/* 80215C38  48 03 FB 99 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 80215C3C  80 7A 01 EC */	lwz r3, 0x1ec(r26)                      
/* 80215C40  48 03 FB E9 */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 80215C44  80 7E 01 F8 */	lwz r3, 0x1f8(r30)                      
/* 80215C48  48 03 FB 89 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 80215C4C  48 00 00 64 */	b lbl_80215CB0                           /* constant-address: 80215CB0, symbol: lbl_80215CB0 */
lbl_80215C50:
/* 80215C50  80 1F 0E BC */	lwz r0, 0xebc(r31)                       /* constant-address: 8042FA84, symbol: None */
/* 80215C54  90 01 00 08 */	stw r0, 8(r1)                           
/* 80215C58  80 1F 0E C0 */	lwz r0, 0xec0(r31)                       /* constant-address: 8042FA88, symbol: None */
...
/* 80215C84  48 03 FB A5 */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 80215C88  C0 02 AE C8 */	lfs f0, lit_6524(r2)                     /* constant-address: 804548C8, symbol: lit_6524 */
/* 80215C8C  EC 20 00 72 */	fmuls f1, f0, f1                        
/* 80215C90  80 7E 01 F4 */	lwz r3, 0x1f4(r30)                      
/* 80215C94  48 03 FB 3D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 80215C98  80 7A 01 EC */	lwz r3, 0x1ec(r26)                      
/* 80215C9C  48 03 FB 8D */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 80215CA0  C0 02 AE C8 */	lfs f0, lit_6524(r2)                     /* constant-address: 804548C8, symbol: lit_6524 */
/* 80215CA4  EC 20 00 72 */	fmuls f1, f0, f1                        
/* 80215CA8  80 7E 01 F8 */	lwz r3, 0x1f8(r30)                      
/* 80215CAC  48 03 FB 25 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_80215CB0:
/* 80215CB0  3B 9C 00 01 */	addi r28, r28, 1                        
/* 80215CB4  2C 1C 00 10 */	cmpwi r28, 0x10                         
/* 80215CB8  3B 39 00 0C */	addi r25, r25, 0xc                      
/* 80215CBC  41 80 FE BC */	blt lbl_80215B78                         /* constant-address: 80215B78, symbol: lbl_80215B78 */
/* 80215CC0  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 80215CC4  28 00 00 01 */	cmplwi r0, 1                            
/* 80215CC8  40 82 00 30 */	bne lbl_80215CF8                         /* constant-address: 80215CF8, symbol: lbl_80215CF8 */
/* 80215CCC  9B 7A 07 60 */	stb r27, 0x760(r26)                     
/* 80215CD0  38 00 FF FF */	li r0, -1                               
/* 80215CD4  B0 1A 07 56 */	sth r0, 0x756(r26)                      
/* 80215CD8  C0 22 AE 80 */	lfs f1, lit_4182(r2)                     /* constant-address: 80454880, symbol: lit_4182 */
...
/* 80215CEC  40 82 00 0C */	bne lbl_80215CF8                         /* constant-address: 80215CF8, symbol: lbl_80215CF8 */
/* 80215CF0  C0 02 AE 98 */	lfs f0, lit_4923(r2)                     /* constant-address: 80454898, symbol: lit_4923 */
/* 80215CF4  D0 03 06 28 */	stfs f0, 0x628(r3)                      
lbl_80215CF8:
/* 80215CF8  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 80215CFC  28 00 00 02 */	cmplwi r0, 2                            
/* 80215D00  40 82 00 28 */	bne lbl_80215D28                         /* constant-address: 80215D28, symbol: lbl_80215D28 */
/* 80215D04  9B 7A 07 60 */	stb r27, 0x760(r26)                     
/* 80215D08  38 00 00 00 */	li r0, 0                                
/* 80215D0C  B0 1A 07 56 */	sth r0, 0x756(r26)                      
/* 80215D10  C0 22 AE 80 */	lfs f1, lit_4182(r2)                     /* constant-address: 80454880, symbol: lit_4182 */
/* 80215D14  C0 1A 06 2C */	lfs f0, 0x62c(r26)                      
/* 80215D18  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 80215D1C  40 82 00 0C */	bne lbl_80215D28                         /* constant-address: 80215D28, symbol: lbl_80215D28 */
/* 80215D20  C0 02 AE 98 */	lfs f0, lit_4923(r2)                     /* constant-address: 80454898, symbol: lit_4923 */
...
/* 80215D68  48 03 E8 49 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 80215D90  48 14 C4 89 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

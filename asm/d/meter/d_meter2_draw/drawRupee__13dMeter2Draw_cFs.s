...
/* 8021633C  48 14 BE 8D */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 80216340  7C 7F 1B 78 */	mr r31, r3                              
/* 80216344  7C 98 23 78 */	mr r24, r4                              
/* 80216348  80 63 02 D8 */	lwz r3, 0x2d8(r3)                       
/* 8021634C  48 03 F2 BD */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
/* 80216350  80 7F 02 DC */	lwz r3, 0x2dc(r31)                      
/* 80216354  48 03 F2 B5 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
...
/* 80216370  40 80 00 18 */	bge lbl_80216388                         /* constant-address: 80216388, symbol: lbl_80216388 */
/* 80216374  80 7F 02 D8 */	lwz r3, 0x2d8(r31)                      
/* 80216378  48 03 F2 91 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
/* 8021637C  80 7F 02 DC */	lwz r3, 0x2dc(r31)                      
/* 80216380  48 03 F2 89 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
/* 80216384  48 00 00 64 */	b lbl_802163E8                           /* constant-address: 802163E8, symbol: lbl_802163E8 */
lbl_80216388:
/* 80216388  80 7F 02 D8 */	lwz r3, 0x2d8(r31)                      
/* 8021638C  48 03 F2 3D */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
/* 80216390  80 7F 02 DC */	lwz r3, 0x2dc(r31)                      
/* 80216394  48 03 F2 35 */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
/* 80216398  7F E3 FB 78 */	mr r3, r31                              
/* 8021639C  7F 44 D3 78 */	mr r4, r26                              
/* 802163A0  48 00 3E FD */	bl getNumberTexture__13dMeter2Draw_cFi   /* constant-address: 8021A29C, symbol: getNumberTexture__13dMeter2Draw_cFi */
...
/* 802163FC  48 00 3E A1 */	bl getNumberTexture__13dMeter2Draw_cFi   /* constant-address: 8021A29C, symbol: getNumberTexture__13dMeter2Draw_cFi */
...
/* 80216458  48 00 3E 45 */	bl getNumberTexture__13dMeter2Draw_cFi   /* constant-address: 8021A29C, symbol: getNumberTexture__13dMeter2Draw_cFi */
...
/* 802164A8  48 00 3D F5 */	bl getNumberTexture__13dMeter2Draw_cFi   /* constant-address: 8021A29C, symbol: getNumberTexture__13dMeter2Draw_cFi */
...
/* 802164F0  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 802164F4  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 802164F8  C0 23 03 3C */	lfs f1, 0x33c(r3)                        /* constant-address: 8042EF04, symbol: None */
...
/* 80216528  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8021652C  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80216530  C0 24 03 40 */	lfs f1, 0x340(r4)                        /* constant-address: 8042EF08, symbol: None */
/* 80216534  C0 44 03 44 */	lfs f2, 0x344(r4)                        /* constant-address: 8042EF0C, symbol: None */
/* 80216538  48 03 E0 79 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 8021653C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 80216540  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80216544  C0 03 03 4C */	lfs f0, 0x34c(r3)                        /* constant-address: 8042EF14, symbol: None */
...
/* 8021656C  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 80216570  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80216574  C0 24 03 50 */	lfs f1, 0x350(r4)                        /* constant-address: 8042EF18, symbol: None */
/* 80216578  C0 44 03 54 */	lfs f2, 0x354(r4)                        /* constant-address: 8042EF1C, symbol: None */
/* 8021657C  48 03 E0 35 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 80216580  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 80216584  3B A3 EB C8 */	addi r29, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 80216588  C0 1D 03 74 */	lfs f0, 0x374(r29)                       /* constant-address: 8042EF3C, symbol: None */
...
/* 802165B0  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 802165B4  3B 84 EB C8 */	addi r28, r4, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 802165B8  C0 3C 03 6C */	lfs f1, 0x36c(r28)                       /* constant-address: 8042EF34, symbol: None */
/* 802165BC  C0 5C 03 70 */	lfs f2, 0x370(r28)                       /* constant-address: 8042EF38, symbol: None */
/* 802165C0  48 03 DF F1 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 802165C4  C0 1D 03 74 */	lfs f0, 0x374(r29)                       /* constant-address: 8042EF3C, symbol: None */
...
/* 802165EC  C0 3C 03 6C */	lfs f1, 0x36c(r28)                       /* constant-address: 8042EF34, symbol: None */
/* 802165F0  C0 5C 03 70 */	lfs f2, 0x370(r28)                       /* constant-address: 8042EF38, symbol: None */
/* 802165F4  48 03 DF BD */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 802165F8  3B 20 00 00 */	li r25, 0                               
/* 802165FC  3B C0 00 00 */	li r30, 0                               
/* 80216600  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 80216604  3B 83 EB C8 */	addi r28, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
lbl_80216608:
/* 80216608  3B 00 00 00 */	li r24, 0                               
/* 8021660C  3B A0 00 00 */	li r29, 0                               
/* 80216610  7F 7F F2 14 */	add r27, r31, r30                       
lbl_80216614:
/* 80216614  C0 1C 03 7C */	lfs f0, 0x37c(r28)                       /* constant-address: 8042EF44, symbol: None */
...
/* 80216640  C0 3C 03 80 */	lfs f1, 0x380(r28)                       /* constant-address: 8042EF48, symbol: None */
/* 80216644  C0 5C 03 84 */	lfs f2, 0x384(r28)                       /* constant-address: 8042EF4C, symbol: None */
/* 80216648  48 03 DF 69 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 8021664C  3B 18 00 01 */	addi r24, r24, 1                        
/* 80216650  2C 18 00 02 */	cmpwi r24, 2                            
/* 80216654  3B BD 00 04 */	addi r29, r29, 4                        
/* 80216658  41 80 FF BC */	blt lbl_80216614                         /* constant-address: 80216614, symbol: lbl_80216614 */
/* 8021665C  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
/* 80216660  2C 19 00 04 */	cmpwi r25, 4                            
/* 80216664  3B DE 00 08 */	addi r30, r30, 8                         /* constant-address: 00000008 */
/* 80216668  41 80 FF A0 */	blt lbl_80216608                         /* constant-address: 80216608, symbol: lbl_80216608 */
/* 8021666C  39 61 00 30 */	addi r11, r1, 0x30                      
/* 80216670  48 14 BB A5 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

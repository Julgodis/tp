...
/* 8021AB94  48 14 76 35 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 8021ABAC  40 81 00 08 */	ble lbl_8021ABB4                         /* constant-address: 8021ABB4, symbol: lbl_8021ABB4 */
...
/* 8021ABCC  40 82 00 3C */	bne lbl_8021AC08                         /* constant-address: 8021AC08, symbol: lbl_8021AC08 */
...
/* 8021AC04  48 00 00 68 */	b lbl_8021AC6C                           /* constant-address: 8021AC6C, symbol: lbl_8021AC6C */
lbl_8021AC08:
/* 8021AC08  28 03 00 00 */	cmplwi r3, 0                            
/* 8021AC0C  40 82 00 38 */	bne lbl_8021AC44                         /* constant-address: 8021AC44, symbol: lbl_8021AC44 */
...
/* 8021AC40  48 00 00 2C */	b lbl_8021AC6C                           /* constant-address: 8021AC6C, symbol: lbl_8021AC6C */
lbl_8021AC44:
...
/* 8021ACBC  41 80 FF CC */	blt lbl_8021AC88                         /* constant-address: 8021AC88, symbol: lbl_8021AC88 */
/* 8021ACC0  57 9C 06 3E */	clrlwi r28, r28, 0x18                   
/* 8021ACC4  28 1C 00 64 */	cmplwi r28, 0x64                        
/* 8021ACC8  40 80 00 C8 */	bge lbl_8021AD90                         /* constant-address: 8021AD90, symbol: lbl_8021AD90 */
/* 8021ACCC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8021ACD0  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8021ACD4  83 5D 5D 30 */	lwz r26, 0x5d30(r29)                     /* constant-address: 8040BEF0, symbol: None */
/* 8021ACD8  38 00 00 0A */	li r0, 0xa                              
/* 8021ACDC  7C 7C 03 D6 */	divw r3, r28, r0                        
/* 8021ACE0  48 00 35 E9 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 8021ACE4  7C 65 1B 78 */	mr r5, r3                               
/* 8021ACE8  7F 43 D3 78 */	mr r3, r26                              
/* 8021ACEC  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 8021ACF0  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 8021AD24  83 5D 5D 30 */	lwz r26, 0x5d30(r29)                     /* constant-address: 8040BEF0, symbol: None */
...
/* 8021AD38  48 00 35 91 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 8021AD3C  7C 65 1B 78 */	mr r5, r3                               
/* 8021AD40  7F 43 D3 78 */	mr r3, r26                              
/* 8021AD44  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 8021AD48  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 8021AD8C  48 00 01 24 */	b lbl_8021AEB0                           /* constant-address: 8021AEB0, symbol: lbl_8021AEB0 */
lbl_8021AD90:
/* 8021AD90  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8021AD94  3B A3 61 C0 */	addi r29, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8021AD98  83 5D 5D 30 */	lwz r26, 0x5d30(r29)                     /* constant-address: 8040BEF0, symbol: None */
/* 8021AD9C  38 00 00 64 */	li r0, 0x64                             
/* 8021ADA0  7C 7C 03 D6 */	divw r3, r28, r0                        
/* 8021ADA4  48 00 35 25 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 8021ADA8  7C 65 1B 78 */	mr r5, r3                               
/* 8021ADAC  7F 43 D3 78 */	mr r3, r26                              
/* 8021ADB0  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 8021ADB4  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 8021ADFC  83 5D 5D 30 */	lwz r26, 0x5d30(r29)                     /* constant-address: 8040BEF0, symbol: None */
/* 8021AE00  38 00 00 0A */	li r0, 0xa                              
/* 8021AE04  7C 7C 03 D6 */	divw r3, r28, r0                        
/* 8021AE08  48 00 34 C1 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 8021AE0C  7C 65 1B 78 */	mr r5, r3                               
/* 8021AE10  7F 43 D3 78 */	mr r3, r26                              
/* 8021AE14  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 8021AE18  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 8021AE4C  83 5D 5D 30 */	lwz r26, 0x5d30(r29)                     /* constant-address: 8040BEF0, symbol: None */
...
/* 8021AE60  48 00 34 69 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 8021AE64  7C 65 1B 78 */	mr r5, r3                               
/* 8021AE68  7F 43 D3 78 */	mr r3, r26                              
/* 8021AE6C  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 8021AE70  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 8021AEB4  48 14 73 61 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

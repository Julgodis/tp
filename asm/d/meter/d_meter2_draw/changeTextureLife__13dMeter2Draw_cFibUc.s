...
/* 802147F4  48 14 D9 DD */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 80214808  41 82 01 A0 */	beq lbl_802149A8                         /* constant-address: 802149A8, symbol: lbl_802149A8 */
/* 8021480C  57 40 06 3E */	clrlwi r0, r26, 0x18                    
/* 80214810  28 00 00 FF */	cmplwi r0, 0xff                         
/* 80214814  40 82 00 24 */	bne lbl_80214838                         /* constant-address: 80214838, symbol: lbl_80214838 */
/* 80214818  57 FC 18 38 */	slwi r28, r31, 3                        
/* 8021481C  7C 7E E2 14 */	add r3, r30, r28                        
/* 80214820  80 63 03 A0 */	lwz r3, 0x3a0(r3)                       
/* 80214824  48 04 0D A5 */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
/* 80214828  7C 7E E2 14 */	add r3, r30, r28                        
/* 8021482C  80 63 03 A4 */	lwz r3, 0x3a4(r3)                       
/* 80214830  48 04 0D 99 */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
/* 80214834  48 00 01 90 */	b lbl_802149C4                           /* constant-address: 802149C4, symbol: lbl_802149C4 */
lbl_80214838:
/* 80214838  57 FC 18 38 */	slwi r28, r31, 3                        
/* 8021483C  7C 7E E2 14 */	add r3, r30, r28                        
/* 80214840  80 63 03 A0 */	lwz r3, 0x3a0(r3)                       
/* 80214844  48 04 0D C5 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
/* 80214848  7C 7E E2 14 */	add r3, r30, r28                        
/* 8021484C  80 63 03 A4 */	lwz r3, 0x3a4(r3)                       
/* 80214850  48 04 0D B9 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
...
/* 80214864  40 82 00 38 */	bne lbl_8021489C                         /* constant-address: 8021489C, symbol: lbl_8021489C */
/* 80214868  80 7E 00 78 */	lwz r3, 0x78(r30)                       
/* 8021486C  3C 80 80 3A */	lis r4, data_80398878@ha                
/* 80214870  38 04 88 78 */	addi r0, r4, data_80398878@l             /* constant-address: 80398878, symbol: data_80398878 */
...
/* 80214898  48 00 00 34 */	b lbl_802148CC                           /* constant-address: 802148CC, symbol: lbl_802148CC */
lbl_8021489C:
/* 8021489C  80 7E 00 78 */	lwz r3, 0x78(r30)                       
/* 802148A0  3C 80 80 3A */	lis r4, data_80398878@ha                
/* 802148A4  38 04 88 78 */	addi r0, r4, data_80398878@l             /* constant-address: 80398878, symbol: data_80398878 */
...
/* 802148D8  41 80 FF 88 */	blt lbl_80214860                         /* constant-address: 80214860, symbol: lbl_80214860 */
...
/* 80214900  3C 80 80 3A */	lis r4, data_80398898@ha                
/* 80214904  38 04 88 98 */	addi r0, r4, data_80398898@l             /* constant-address: 80398898, symbol: data_80398898 */
...
/* 8021492C  3C 80 80 3A */	lis r4, data_80398898@ha                
/* 80214930  84 A4 88 98 */	lwzu r5, data_80398898@l(r4)             /* constant-address: 80398898, symbol: data_80398898 */
/* 80214934  80 C4 00 04 */	lwz r6, 4(r4)                            /* constant-address: 8039889C, symbol: None */
...
/* 802149A4  48 00 00 20 */	b lbl_802149C4                           /* constant-address: 802149C4, symbol: lbl_802149C4 */
lbl_802149A8:
/* 802149A8  57 FC 18 38 */	slwi r28, r31, 3                        
/* 802149AC  7C 7E E2 14 */	add r3, r30, r28                        
/* 802149B0  80 63 03 A0 */	lwz r3, 0x3a0(r3)                       
/* 802149B4  48 04 0C 55 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
/* 802149B8  7C 7E E2 14 */	add r3, r30, r28                        
/* 802149BC  80 63 03 A4 */	lwz r3, 0x3a4(r3)                       
/* 802149C0  48 04 0C 49 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
lbl_802149C4:
...
/* 802149E0  48 14 D8 3D */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

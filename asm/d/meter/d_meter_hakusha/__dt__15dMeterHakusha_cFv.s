...
/* 8020C3A0  41 82 00 44 */	beq lbl_8020C3E4                         /* constant-address: 8020C3E4, symbol: lbl_8020C3E4 */
/* 8020C3A4  3C 80 80 3C */	lis r4, __vt__15dMeterHakusha_c@ha      
/* 8020C3A8  38 04 F2 B8 */	addi r0, r4, __vt__15dMeterHakusha_c@l   /* constant-address: 803BF2B8, symbol: __vt__15dMeterHakusha_c */
...
/* 8020C3C4  41 82 00 10 */	beq lbl_8020C3D4                         /* constant-address: 8020C3D4, symbol: lbl_8020C3D4 */
/* 8020C3C8  3C 60 80 3C */	lis r3, __vt__11dMeterSub_c@ha          
/* 8020C3CC  38 03 B6 D4 */	addi r0, r3, __vt__11dMeterSub_c@l       /* constant-address: 803BB6D4, symbol: __vt__11dMeterSub_c */
/* 8020C3D0  90 1E 00 00 */	stw r0, 0(r30)                          
lbl_8020C3D4:
/* 8020C3D4  7F E0 07 35 */	extsh. r0, r31                          
/* 8020C3D8  40 81 00 0C */	ble lbl_8020C3E4                         /* constant-address: 8020C3E4, symbol: lbl_8020C3E4 */
/* 8020C3DC  7F C3 F3 78 */	mr r3, r30                              
/* 8020C3E0  48 0C 29 5D */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_8020C3E4:

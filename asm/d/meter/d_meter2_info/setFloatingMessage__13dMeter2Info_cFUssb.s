...
/* 8021C0E4  38 E7 61 C0 */	addi r7, r7, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8021C0E8  88 07 4F AD */	lbz r0, 0x4fad(r7)                       /* constant-address: 8040B16D, symbol: None */
/* 8021C0EC  28 00 00 00 */	cmplwi r0, 0                            
/* 8021C0F0  41 82 00 0C */	beq lbl_8021C0FC                         /* constant-address: 8021C0FC, symbol: lbl_8021C0FC */
/* 8021C0F4  38 60 00 00 */	li r3, 0                                
/* 8021C0F8  4E 80 00 20 */	blr                                     
lbl_8021C0FC:
/* 8021C0FC  3C E0 00 01 */	lis r7, 0x0001 /* 0x0000FFFF@ha */      
/* 8021C100  38 07 FF FF */	addi r0, r7, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */

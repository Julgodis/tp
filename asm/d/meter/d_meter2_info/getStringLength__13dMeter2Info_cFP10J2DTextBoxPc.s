...
/* 8021C6D4  48 14 5B 09 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8021C6D8  7C 9F 23 78 */	mr r31, r4                              
/* 8021C6DC  7C BD 2B 78 */	mr r29, r5                              
/* 8021C6E0  C3 A2 AF 98 */	lfs f29, lit_3916(r2)                    /* constant-address: 80454998, symbol: lit_3916 */
...
/* 8021C708  48 00 00 98 */	b lbl_8021C7A0                           /* constant-address: 8021C7A0, symbol: lbl_8021C7A0 */
lbl_8021C70C:
/* 8021C70C  7C 80 07 74 */	extsb r0, r4                            
/* 8021C710  2C 00 00 0A */	cmpwi r0, 0xa                           
/* 8021C714  40 82 00 18 */	bne lbl_8021C72C                         /* constant-address: 8021C72C, symbol: lbl_8021C72C */
/* 8021C718  FC 1C E8 40 */	fcmpo cr0, f28, f29                     
/* 8021C71C  40 80 00 08 */	bge lbl_8021C724                         /* constant-address: 8021C724, symbol: lbl_8021C724 */
/* 8021C720  FF 80 E8 90 */	fmr f28, f29                            
lbl_8021C724:
/* 8021C724  C3 A2 AF 98 */	lfs f29, lit_3916(r2)                    /* constant-address: 80454998, symbol: lit_3916 */
/* 8021C728  48 00 00 74 */	b lbl_8021C79C                           /* constant-address: 8021C79C, symbol: lbl_8021C79C */
lbl_8021C72C:
...
/* 8021C75C  C8 42 AF B8 */	lfd f2, lit_4108(r2)                     /* constant-address: 804549B8, symbol: lit_4108 */
...
/* 8021C7A8  40 82 FF 64 */	bne lbl_8021C70C                         /* constant-address: 8021C70C, symbol: lbl_8021C70C */
/* 8021C7AC  FC 1C E8 40 */	fcmpo cr0, f28, f29                     
/* 8021C7B0  40 80 00 08 */	bge lbl_8021C7B8                         /* constant-address: 8021C7B8, symbol: lbl_8021C7B8 */
...
/* 8021C7E0  48 14 5A 49 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

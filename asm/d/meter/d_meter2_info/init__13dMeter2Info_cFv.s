...
/* 8021BE78  48 14 63 5D */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8021BEB4  42 00 FF F4 */	bdnz lbl_8021BEA8                        /* constant-address: 8021BEA8, symbol: lbl_8021BEA8 */
...
/* 8021BEDC  C0 22 AF 98 */	lfs f1, lit_3916(r2)                     /* constant-address: 80454998, symbol: lit_3916 */
/* 8021BEE0  D0 3F 00 54 */	stfs f1, 0x54(r31)                      
/* 8021BEE4  D0 3F 00 58 */	stfs f1, 0x58(r31)                      
/* 8021BEE8  D0 3F 00 5C */	stfs f1, 0x5c(r31)                      
/* 8021BEEC  C0 02 AF 9C */	lfs f0, lit_3917(r2)                     /* constant-address: 8045499C, symbol: lit_3917 */
/* 8021BEF0  D0 1F 00 60 */	stfs f0, 0x60(r31)                      
/* 8021BEF4  C0 02 AF A0 */	lfs f0, lit_3918(r2)                     /* constant-address: 804549A0, symbol: lit_3918 */
/* 8021BEF8  D0 1F 00 64 */	stfs f0, 0x64(r31)                      
/* 8021BEFC  C0 02 AF A4 */	lfs f0, lit_3919(r2)                     /* constant-address: 804549A4, symbol: lit_3919 */
/* 8021BF00  D0 1F 00 68 */	stfs f0, 0x68(r31)                      
/* 8021BF04  C0 02 AF A8 */	lfs f0, lit_3920(r2)                     /* constant-address: 804549A8, symbol: lit_3920 */
/* 8021BF08  D0 1F 00 6C */	stfs f0, 0x6c(r31)                      
/* 8021BF0C  C0 02 AF AC */	lfs f0, lit_3921(r2)                     /* constant-address: 804549AC, symbol: lit_3921 */
/* 8021BF10  D0 1F 00 70 */	stfs f0, 0x70(r31)                      
/* 8021BF14  C0 02 AF B0 */	lfs f0, lit_3922(r2)                     /* constant-address: 804549B0, symbol: lit_3922 */
...
/* 8021BF50  38 03 FF FF */	addi r0, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 8021BF80  48 00 0A 5D */	bl resetWarpStatus__13dMeter2Info_cFv    /* constant-address: 8021C9DC, symbol: resetWarpStatus__13dMeter2Info_cFv */
...
/* 8021BF98  C0 02 AF 98 */	lfs f0, lit_3916(r2)                     /* constant-address: 80454998, symbol: lit_3916 */
...
/* 8021BFB0  38 84 91 68 */	addi r4, r4, d_meter_d_meter2_info__stringBase0@l /* constant-address: 80399168, symbol: d_meter_d_meter2_info__stringBase0 */
...
/* 8021BFC8  48 00 0C 45 */	bl setWarpInfo__13dMeter2Info_cFPCcRC4cXyzsUcUcUc /* constant-address: 8021CC0C, symbol: setWarpInfo__13dMeter2Info_cFPCcRC4cXyzsUcUcUc */
...
/* 8021BFDC  48 00 1D 81 */	bl changeWater__13dMeter2Info_cFUc       /* constant-address: 8021DD5C, symbol: changeWater__13dMeter2Info_cFUc */
/* 8021BFE0  3B 9C 00 01 */	addi r28, r28, 1                        
/* 8021BFE4  2C 1C 00 04 */	cmpwi r28, 4                            
/* 8021BFE8  41 80 FF E8 */	blt lbl_8021BFD0                         /* constant-address: 8021BFD0, symbol: lbl_8021BFD0 */
...
/* 8021C014  42 00 FF E8 */	bdnz lbl_8021BFFC                        /* constant-address: 8021BFFC, symbol: lbl_8021BFFC */
...
/* 8021C054  38 84 91 68 */	addi r4, r4, d_meter_d_meter2_info__stringBase0@l /* constant-address: 80399168, symbol: d_meter_d_meter2_info__stringBase0 */
/* 8021C058  48 00 22 39 */	bl setSaveStageName__13dMeter2Info_cFPCc /* constant-address: 8021E290, symbol: setSaveStageName__13dMeter2Info_cFPCc */
...
/* 8021C08C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8021C090  3B 83 01 14 */	addi r28, r3, 0x114                      /* constant-address: 804062D4, symbol: None */
lbl_8021C094:
/* 8021C094  7F 83 E3 78 */	mr r3, r28                              
/* 8021C098  57 64 06 3E */	clrlwi r4, r27, 0x18                    
/* 8021C09C  4B E1 83 01 */	bl isLightDropGetFlag__16dSv_light_drop_cCFUc /* constant-address: 8003439C, symbol: isLightDropGetFlag__16dSv_light_drop_cCFUc */
/* 8021C0A0  2C 03 00 00 */	cmpwi r3, 0                             
/* 8021C0A4  41 82 00 10 */	beq lbl_8021C0B4                         /* constant-address: 8021C0B4, symbol: lbl_8021C0B4 */
/* 8021C0A8  38 1B 00 E3 */	addi r0, r27, 0xe3                       /* constant-address: 000000E3 */
/* 8021C0AC  7F DF 01 AE */	stbx r30, r31, r0                       
/* 8021C0B0  48 00 00 0C */	b lbl_8021C0BC                           /* constant-address: 8021C0BC, symbol: lbl_8021C0BC */
lbl_8021C0B4:
...
/* 8021C0C4  41 80 FF D0 */	blt lbl_8021C094                         /* constant-address: 8021C094, symbol: lbl_8021C094 */
/* 8021C0C8  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8021C0CC  48 14 61 55 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

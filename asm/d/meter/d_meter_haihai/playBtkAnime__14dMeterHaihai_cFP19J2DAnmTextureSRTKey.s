...
/* 8020C09C  41 82 01 18 */	beq lbl_8020C1B4                         /* constant-address: 8020C1B4, symbol: lbl_8020C1B4 */
/* 8020C0A0  28 1F 00 00 */	cmplwi r31, 0                           
/* 8020C0A4  41 82 00 98 */	beq lbl_8020C13C                         /* constant-address: 8020C13C, symbol: lbl_8020C13C */
/* 8020C0A8  88 1E 00 28 */	lbz r0, 0x28(r30)                       
/* 8020C0AC  28 00 00 04 */	cmplwi r0, 4                            
/* 8020C0B0  40 82 00 20 */	bne lbl_8020C0D0                         /* constant-address: 8020C0D0, symbol: lbl_8020C0D0 */
/* 8020C0B4  C0 3E 00 1C */	lfs f1, 0x1c(r30)                       
/* 8020C0B8  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020C0BC  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020C0C0  C0 03 05 38 */	lfs f0, 0x538(r3)                        /* constant-address: 8042F100, symbol: None */
/* 8020C0C4  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8020C0C8  D0 1E 00 1C */	stfs f0, 0x1c(r30)                      
/* 8020C0CC  48 00 00 1C */	b lbl_8020C0E8                           /* constant-address: 8020C0E8, symbol: lbl_8020C0E8 */
lbl_8020C0D0:
/* 8020C0D0  C0 3E 00 1C */	lfs f1, 0x1c(r30)                       
/* 8020C0D4  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020C0D8  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020C0DC  C0 03 05 08 */	lfs f0, 0x508(r3)                        /* constant-address: 8042F0D0, symbol: None */
...
/* 8020C0F0  C8 22 AD F8 */	lfd f1, lit_4189(r2)                     /* constant-address: 804547F8, symbol: lit_4189 */
...
/* 8020C114  40 82 00 30 */	bne lbl_8020C144                         /* constant-address: 8020C144, symbol: lbl_8020C144 */
...
/* 8020C138  48 00 00 0C */	b lbl_8020C144                           /* constant-address: 8020C144, symbol: lbl_8020C144 */
lbl_8020C13C:
/* 8020C13C  C0 02 AD F0 */	lfs f0, lit_4165(r2)                     /* constant-address: 804547F0, symbol: lit_4165 */
...
/* 8020C154  38 C4 30 30 */	addi r6, r4, 0x3030 /* 0x6A693030@l */   /* constant-address: 6A693030 */
...
/* 8020C188  38 C4 30 31 */	addi r6, r4, 0x3031 /* 0x6A693031@l */   /* constant-address: 6A693031 */

...
/* 8020BF24  41 82 01 3C */	beq lbl_8020C060                         /* constant-address: 8020C060, symbol: lbl_8020C060 */
/* 8020BF28  28 1F 00 00 */	cmplwi r31, 0                           
/* 8020BF2C  41 82 00 98 */	beq lbl_8020BFC4                         /* constant-address: 8020BFC4, symbol: lbl_8020BFC4 */
/* 8020BF30  88 1E 00 28 */	lbz r0, 0x28(r30)                       
/* 8020BF34  28 00 00 04 */	cmplwi r0, 4                            
/* 8020BF38  40 82 00 20 */	bne lbl_8020BF58                         /* constant-address: 8020BF58, symbol: lbl_8020BF58 */
/* 8020BF3C  C0 3E 00 18 */	lfs f1, 0x18(r30)                       
/* 8020BF40  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020BF44  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020BF48  C0 03 05 34 */	lfs f0, 0x534(r3)                        /* constant-address: 8042F0FC, symbol: None */
/* 8020BF4C  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8020BF50  D0 1E 00 18 */	stfs f0, 0x18(r30)                      
/* 8020BF54  48 00 00 1C */	b lbl_8020BF70                           /* constant-address: 8020BF70, symbol: lbl_8020BF70 */
lbl_8020BF58:
/* 8020BF58  C0 3E 00 18 */	lfs f1, 0x18(r30)                       
/* 8020BF5C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020BF60  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020BF64  C0 03 05 04 */	lfs f0, 0x504(r3)                        /* constant-address: 8042F0CC, symbol: None */
...
/* 8020BF78  C8 22 AD F8 */	lfd f1, lit_4189(r2)                     /* constant-address: 804547F8, symbol: lit_4189 */
...
/* 8020BF9C  40 82 00 30 */	bne lbl_8020BFCC                         /* constant-address: 8020BFCC, symbol: lbl_8020BFCC */
...
/* 8020BFC0  48 00 00 0C */	b lbl_8020BFCC                           /* constant-address: 8020BFCC, symbol: lbl_8020BFCC */
lbl_8020BFC4:
/* 8020BFC4  C0 02 AD F0 */	lfs f0, lit_4165(r2)                     /* constant-address: 804547F0, symbol: lit_4165 */
...
/* 8020BFDC  38 C4 69 6D */	addi r6, r4, 0x696D /* 0x616E696D@l */   /* constant-address: 616E696D */
...
/* 8020C010  38 C4 69 6D */	addi r6, r4, 0x696D /* 0x616E696D@l */   /* constant-address: 616E696D */
...
/* 8020C028  48 0E BF A5 */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
/* 8020C02C  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 8020C030  3C 80 61 6E */	lis r4, 0x616E /* 0x616E696D@ha */      
/* 8020C034  38 C4 69 6D */	addi r6, r4, 0x696D /* 0x616E696D@l */   /* constant-address: 616E696D */

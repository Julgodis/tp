...
/* 8020B1A4 00000014  89 03 5E 81 */	lbz r8, 0x5e81(r3)	/* effective address: 8040C041 */
/* 8020B1A8 00000018  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 8020B1AC 0000001C  38 C3 EB C8 */	addi r6, r3, g_drawHIO@l
/* 8020B1B0 00000020  8B C6 05 50 */	lbz r30, 0x550(r6)	/* effective address: 8042F118 */
...
/* 8020B1F8 00000010  89 03 5E 81 */	lbz r8, 0x5e81(r3)	/* effective address: 8040C041 */
/* 8020B1FC 00000014  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 8020B200 00000018  38 63 EB C8 */	addi r3, r3, g_drawHIO@l
/* 8020B204 0000001C  8B C3 05 24 */	lbz r30, 0x524(r3)	/* effective address: 8042F0EC */
/* 8020B208 00000020  C0 23 05 0C */	lfs f1, 0x50c(r3)	/* effective address: 8042F0D4 */
/* 8020B20C 00000024  C0 02 AD B4 */	lfs f0, lit_3890(r2)
/* 8020B210 00000028  EC 01 00 28 */	fsubs f0, f1, f0
/* 8020B214 0000002C  D0 01 00 10 */	stfs f0, 0x10(r1)
/* 8020B218 00000030  C0 23 05 14 */	lfs f1, 0x514(r3)	/* effective address: 8042F0DC */
/* 8020B21C 00000034  C0 02 AD B8 */	lfs f0, lit_3891(r2)
/* 8020B220 00000038  EC 01 00 28 */	fsubs f0, f1, f0
/* 8020B224 0000003C  D0 01 00 08 */	stfs f0, 8(r1)
/* 8020B228 00000040  C0 23 05 10 */	lfs f1, 0x510(r3)	/* effective address: 8042F0D8 */
/* 8020B22C 00000044  C0 02 AD BC */	lfs f0, lit_3892(r2)
/* 8020B230 00000048  EC 01 00 28 */	fsubs f0, f1, f0
/* 8020B234 0000004C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8020B238 00000050  C0 03 05 18 */	lfs f0, 0x518(r3)	/* effective address: 8042F0E0 */
...
/* 8020B24C 00000008  89 03 5E 81 */	lbz r8, 0x5e81(r3)	/* effective address: 8040C041 */
/* 8020B250 0000000C  3C 60 80 43 */	lis r3, g_drawHIO@ha
/* 8020B254 00000010  38 C3 EB C8 */	addi r6, r3, g_drawHIO@l
/* 8020B258 00000014  8B C6 05 24 */	lbz r30, 0x524(r6)	/* effective address: 8042F0EC */
...
/* 8020B2A8 00000008  C0 22 AD C0 */	lfs f1, lit_3893(r2)
...
/* 8020B2B8 00000018  C0 22 AD C4 */	lfs f1, lit_3894(r2)
...
/* 8020B2F8 00000058  C0 02 AD C8 */	lfs f0, lit_3895(r2)
...
/* 8020B324 00000084  80 84 5F 50 */	lwz r4, 0x5f50(r4)	/* effective address: 8040C110 */
...
/* 8020B344 00000008  C0 22 AD C0 */	lfs f1, lit_3893(r2)
...
/* 8020B354 00000018  C0 22 AD C4 */	lfs f1, lit_3894(r2)
...
/* 8020B394 00000058  C0 02 AD C8 */	lfs f0, lit_3895(r2)
...
/* 8020B3C0 00000084  80 84 5F 50 */	lwz r4, 0x5f50(r4)	/* effective address: 8040C110 */
...
/* 8020B3E0 00000008  C0 22 AD C0 */	lfs f1, lit_3893(r2)
...
/* 8020B3F0 00000018  C0 22 AD C4 */	lfs f1, lit_3894(r2)
...
/* 8020B430 00000058  C0 02 AD C8 */	lfs f0, lit_3895(r2)
...
/* 8020B45C 00000084  80 84 5F 50 */	lwz r4, 0x5f50(r4)	/* effective address: 8040C110 */
...
/* 8020B47C 00000008  C0 22 AD C0 */	lfs f1, lit_3893(r2)
...
/* 8020B48C 00000018  C0 22 AD C4 */	lfs f1, lit_3894(r2)
...
/* 8020B4CC 00000058  C0 02 AD C8 */	lfs f0, lit_3895(r2)
...
/* 8020B4F8 00000084  80 84 5F 50 */	lwz r4, 0x5f50(r4)	/* effective address: 8040C110 */

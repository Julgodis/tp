...
/* 8020F1E0  41 82 02 94 */	beq lbl_8020F474                         /* constant-address: 8020F474, symbol: lbl_8020F474 */
/* 8020F1E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8020F1E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8020F1EC  88 03 5E B5 */	lbz r0, 0x5eb5(r3)                       /* constant-address: 8040C075, symbol: None */
/* 8020F1F0  28 00 00 00 */	cmplwi r0, 0                            
/* 8020F1F4  40 82 02 80 */	bne lbl_8020F474                         /* constant-address: 8020F474, symbol: lbl_8020F474 */
/* 8020F1F8  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 8020F210  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020F214  38 83 EB C8 */	addi r4, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020F218  A8 04 0C 02 */	lha r0, 0xc02(r4)                        /* constant-address: 8042F7CA, symbol: None */
/* 8020F21C  C8 62 AE 70 */	lfd f3, lit_3824(r2)                     /* constant-address: 80454870, symbol: lit_3824 */
...
/* 8020F238  C0 22 AE 5C */	lfs f1, lit_3819(r2)                     /* constant-address: 8045485C, symbol: lit_3819 */
/* 8020F23C  A8 04 0C 00 */	lha r0, 0xc00(r4)                        /* constant-address: 8042F7C8, symbol: None */
...
/* 8020F260  C0 02 AE 58 */	lfs f0, lit_3762(r2)                     /* constant-address: 80454858, symbol: lit_3762 */
/* 8020F264  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8020F268  40 81 02 0C */	ble lbl_8020F474                         /* constant-address: 8020F474, symbol: lbl_8020F474 */
/* 8020F26C  FC 02 F8 40 */	fcmpo cr0, f2, f31                      
/* 8020F270  40 80 02 04 */	bge lbl_8020F474                         /* constant-address: 8020F474, symbol: lbl_8020F474 */
/* 8020F274  C3 C2 AE 60 */	lfs f30, lit_3820(r2)                    /* constant-address: 80454860, symbol: lit_3820 */
/* 8020F278  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8020F27C  40 80 00 30 */	bge lbl_8020F2AC                         /* constant-address: 8020F2AC, symbol: lbl_8020F2AC */
/* 8020F280  C0 04 0B FC */	lfs f0, 0xbfc(r4)                        /* constant-address: 8042F7C4, symbol: None */
...
/* 8020F294  40 81 00 08 */	ble lbl_8020F29C                         /* constant-address: 8020F29C, symbol: lbl_8020F29C */
/* 8020F298  D0 3E 00 2C */	stfs f1, 0x2c(r30)                      
lbl_8020F29C:
/* 8020F29C  7F C3 F3 78 */	mr r3, r30                              
/* 8020F2A0  C0 3E 00 2C */	lfs f1, 0x2c(r30)                       
/* 8020F2A4  48 00 03 C9 */	bl playBckAnimation__14dMeterString_cFf  /* constant-address: 8020F66C, symbol: playBckAnimation__14dMeterString_cFf */
/* 8020F2A8  48 00 00 9C */	b lbl_8020F344                           /* constant-address: 8020F344, symbol: lbl_8020F344 */
lbl_8020F2AC:
/* 8020F2AC  FC 02 20 40 */	fcmpo cr0, f2, f4                       
/* 8020F2B0  40 80 00 10 */	bge lbl_8020F2C0                         /* constant-address: 8020F2C0, symbol: lbl_8020F2C0 */
/* 8020F2B4  EC 02 F0 2A */	fadds f0, f2, f30                       
/* 8020F2B8  D0 1E 00 2C */	stfs f0, 0x2c(r30)                      
/* 8020F2BC  48 00 00 88 */	b lbl_8020F344                           /* constant-address: 8020F344, symbol: lbl_8020F344 */
lbl_8020F2C0:
/* 8020F2C0  FC 02 F8 40 */	fcmpo cr0, f2, f31                      
/* 8020F2C4  40 80 00 80 */	bge lbl_8020F344                         /* constant-address: 8020F344, symbol: lbl_8020F344 */
...
/* 8020F2E4  A8 84 0C 02 */	lha r4, 0xc02(r4)                        /* constant-address: 8042F7CA, symbol: None */
...
/* 8020F34C  48 04 64 85 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 8020F350  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 8020F354  A8 1E 00 38 */	lha r0, 0x38(r30)                       
/* 8020F358  C8 42 AE 70 */	lfd f2, lit_3824(r2)                     /* constant-address: 80454870, symbol: lit_3824 */
...
/* 8020F374  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 8020F378  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020F37C  C0 04 0B F4 */	lfs f0, 0xbf4(r4)                        /* constant-address: 8042F7BC, symbol: None */
...
/* 8020F39C  C0 04 0B F8 */	lfs f0, 0xbf8(r4)                        /* constant-address: 8042F7C0, symbol: None */
/* 8020F3A0  EC 42 00 2A */	fadds f2, f2, f0                        
/* 8020F3A4  48 04 52 0D */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 8020F3A8  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020F3AC  38 83 EB C8 */	addi r4, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020F3B0  C0 24 0B F0 */	lfs f1, 0xbf0(r4)                        /* constant-address: 8042F7B8, symbol: None */
/* 8020F3B4  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 8020F3B8  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8020F3BC  C0 04 0B EC */	lfs f0, 0xbec(r4)                        /* constant-address: 8042F7B4, symbol: None */
...
/* 8020F3DC  C0 22 AE 58 */	lfs f1, lit_3762(r2)                     /* constant-address: 80454858, symbol: lit_3762 */
/* 8020F3E0  FC 40 08 90 */	fmr f2, f1                              
/* 8020F3E4  7F E4 FB 78 */	mr r4, r31                              
/* 8020F3E8  48 0E 9A ED */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
/* 8020F3EC  C0 3E 00 30 */	lfs f1, 0x30(r30)                       
/* 8020F3F0  C0 02 AE 58 */	lfs f0, lit_3762(r2)                     /* constant-address: 80454858, symbol: lit_3762 */
/* 8020F3F4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8020F3F8  40 81 00 10 */	ble lbl_8020F408                         /* constant-address: 8020F408, symbol: lbl_8020F408 */
/* 8020F3FC  7F C3 F3 78 */	mr r3, r30                              
/* 8020F400  48 00 02 ED */	bl drawPikari__14dMeterString_cFv        /* constant-address: 8020F6EC, symbol: drawPikari__14dMeterString_cFv */
/* 8020F404  48 00 00 54 */	b lbl_8020F458                           /* constant-address: 8020F458, symbol: lbl_8020F458 */
lbl_8020F408:
/* 8020F408  C0 02 AE 64 */	lfs f0, lit_3821(r2)                     /* constant-address: 80454864, symbol: lit_3821 */
/* 8020F40C  FC 00 08 00 */	fcmpu cr0, f0, f1                       
/* 8020F410  40 82 00 48 */	bne lbl_8020F458                         /* constant-address: 8020F458, symbol: lbl_8020F458 */
/* 8020F414  C0 5E 00 2C */	lfs f2, 0x2c(r30)                       
/* 8020F418  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 8020F41C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020F420  A8 03 0C 1C */	lha r0, 0xc1c(r3)                        /* constant-address: 8042F7E4, symbol: None */
/* 8020F424  C8 22 AE 70 */	lfd f1, lit_3824(r2)                     /* constant-address: 80454870, symbol: lit_3824 */
...
/* 8020F444  40 81 00 14 */	ble lbl_8020F458                         /* constant-address: 8020F458, symbol: lbl_8020F458 */
/* 8020F448  C0 22 AE 68 */	lfs f1, lit_3822(r2)                     /* constant-address: 80454868, symbol: lit_3822 */
/* 8020F44C  C0 03 0C 18 */	lfs f0, 0xc18(r3)                        /* constant-address: 8042F7E0, symbol: None */
...
/* 8020F464  40 82 00 10 */	bne lbl_8020F474                         /* constant-address: 8020F474, symbol: lbl_8020F474 */
/* 8020F468  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 8020F46C  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8020F470  48 00 D7 91 */	bl resetMeterString__13dMeter2Info_cFv   /* constant-address: 8021CC00, symbol: resetMeterString__13dMeter2Info_cFv */
lbl_8020F474:

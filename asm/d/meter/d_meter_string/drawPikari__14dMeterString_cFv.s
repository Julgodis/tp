...
/* 8020F73C  48 15 2A 89 */	bl _savegpr_23                           /* constant-address: 803621C4, symbol: _savegpr_23 */
...
/* 8020F75C  48 04 57 61 */	bl getGlobalVtxCenter__8CPaneMgrFP7J2DPanebs /* constant-address: 80254EBC, symbol: getGlobalVtxCenter__8CPaneMgrFP7J2DPanebs */
...
/* 8020F780  48 0F 0E D9 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 8020F784  7C 7B 1B 78 */	mr r27, r3                              
/* 8020F788  3B 40 00 00 */	li r26, 0                               
/* 8020F78C  C3 22 AE 58 */	lfs f25, lit_3762(r2)                    /* constant-address: 80454858, symbol: lit_3762 */
...
/* 8020F7A0  4B E0 52 51 */	bl mDoExt_getMesgFont__Fv                /* constant-address: 800149F0, symbol: mDoExt_getMesgFont__Fv */
/* 8020F7A4  7C 79 1B 78 */	mr r25, r3                              
/* 8020F7A8  C3 82 AE 60 */	lfs f28, lit_3820(r2)                    /* constant-address: 80454860, symbol: lit_3820 */
/* 8020F7AC  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8020F7B0  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8020F7B4  48 00 00 10 */	b lbl_8020F7C4                           /* constant-address: 8020F7C4, symbol: lbl_8020F7C4 */
lbl_8020F7B8:
/* 8020F7B8  C0 03 00 CC */	lfs f0, 0xcc(r3)                        
/* 8020F7BC  EF 9C 00 32 */	fmuls f28, f28, f0                      
/* 8020F7C0  48 0E 83 3D */	bl getParentPane__7J2DPaneFv             /* constant-address: 802F7AFC, symbol: getParentPane__7J2DPaneFv */
lbl_8020F7C4:
/* 8020F7C4  28 03 00 00 */	cmplwi r3, 0                            
/* 8020F7C8  40 82 FF F0 */	bne lbl_8020F7B8                         /* constant-address: 8020F7B8, symbol: lbl_8020F7B8 */
/* 8020F7CC  CB 62 AE 70 */	lfd f27, lit_3824(r2)                    /* constant-address: 80454870, symbol: lit_3824 */
/* 8020F7D0  3F 80 43 30 */	lis r28, 0x4330                         
/* 8020F7D4  48 00 00 C4 */	b lbl_8020F898                           /* constant-address: 8020F898, symbol: lbl_8020F898 */
lbl_8020F7D8:
/* 8020F7D8  54 64 06 3E */	clrlwi r4, r3, 0x18                     
/* 8020F7DC  7F 40 07 35 */	extsh. r0, r26                          
/* 8020F7E0  40 81 00 18 */	ble lbl_8020F7F8                         /* constant-address: 8020F7F8, symbol: lbl_8020F7F8 */
...
/* 8020F7FC  48 00 02 8D */	bl isLeadByte__14dMeterString_cFi        /* constant-address: 8020FA88, symbol: isLeadByte__14dMeterString_cFi */
/* 8020F800  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8020F804  41 82 00 24 */	beq lbl_8020F828                         /* constant-address: 8020F828, symbol: lbl_8020F828 */
...
/* 8020F820  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
/* 8020F824  48 00 00 08 */	b lbl_8020F82C                           /* constant-address: 8020F82C, symbol: lbl_8020F82C */
lbl_8020F828:
...
/* 8020F8A4  40 82 FF 34 */	bne lbl_8020F7D8                         /* constant-address: 8020F7D8, symbol: lbl_8020F7D8 */
/* 8020F8A8  C0 21 00 30 */	lfs f1, 0x30(r1)                        
/* 8020F8AC  C0 02 AE 7C */	lfs f0, lit_3979(r2)                     /* constant-address: 8045487C, symbol: lit_3979 */
...
/* 8020F8C0  3B 83 EB C8 */	addi r28, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 8020F8C4  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 8020F8C8  3B A3 01 88 */	addi r29, r3, g_meter2_info@l            /* constant-address: 80430188, symbol: g_meter2_info */
/* 8020F8CC  C3 41 00 34 */	lfs f26, 0x34(r1)                       
/* 8020F8D0  CB 62 AE 70 */	lfd f27, lit_3824(r2)                    /* constant-address: 80454870, symbol: lit_3824 */
/* 8020F8D4  3F C0 43 30 */	lis r30, 0x4330                         
/* 8020F8D8  48 00 01 40 */	b lbl_8020FA18                           /* constant-address: 8020FA18, symbol: lbl_8020FA18 */
lbl_8020F8DC:
/* 8020F8DC  D3 C1 00 20 */	stfs f30, 0x20(r1)                      
/* 8020F8E0  7C 9B C0 AE */	lbzx r4, r27, r24                       
/* 8020F8E4  7F 40 07 35 */	extsh. r0, r26                          
/* 8020F8E8  40 81 00 18 */	ble lbl_8020F900                         /* constant-address: 8020F900, symbol: lbl_8020F900 */
...
/* 8020F904  48 00 01 85 */	bl isLeadByte__14dMeterString_cFi        /* constant-address: 8020FA88, symbol: isLeadByte__14dMeterString_cFi */
/* 8020F908  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8020F90C  41 82 00 24 */	beq lbl_8020F930                         /* constant-address: 8020F930, symbol: lbl_8020F930 */
...
/* 8020F928  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
/* 8020F92C  48 00 00 08 */	b lbl_8020F934                           /* constant-address: 8020F934, symbol: lbl_8020F934 */
lbl_8020F930:
...
/* 8020F9A0  41 82 00 70 */	beq lbl_8020FA10                         /* constant-address: 8020FA10, symbol: lbl_8020FA10 */
/* 8020F9A4  3C 17 00 00 */	addis r0, r23, 0                        
/* 8020F9A8  28 00 81 40 */	cmplwi r0, 0x8140                       
/* 8020F9AC  41 82 00 64 */	beq lbl_8020FA10                         /* constant-address: 8020FA10, symbol: lbl_8020FA10 */
/* 8020F9B0  80 1C 0C 10 */	lwz r0, 0xc10(r28)                       /* constant-address: 8042F7D8, symbol: None */
/* 8020F9B4  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 8020F9B8  80 1C 0C 14 */	lwz r0, 0xc14(r28)                       /* constant-address: 8042F7DC, symbol: None */
/* 8020F9BC  90 01 00 14 */	stw r0, 0x14(r1)                        
/* 8020F9C0  80 1C 0C 08 */	lwz r0, 0xc08(r28)                       /* constant-address: 8042F7D0, symbol: None */
/* 8020F9C4  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 8020F9C8  80 1C 0C 0C */	lwz r0, 0xc0c(r28)                       /* constant-address: 8042F7D4, symbol: None */
/* 8020F9CC  90 01 00 1C */	stw r0, 0x1c(r1)                        
/* 8020F9D0  80 7D 00 1C */	lwz r3, 0x1c(r29)                        /* constant-address: 804301A4, symbol: None */
/* 8020F9D4  80 63 01 0C */	lwz r3, 0x10c(r3)                       
/* 8020F9D8  C0 02 AE 7C */	lfs f0, lit_3979(r2)                     /* constant-address: 8045487C, symbol: lit_3979 */
...
/* 8020F9F0  C0 7C 0C 04 */	lfs f3, 0xc04(r28)                       /* constant-address: 8042F7CC, symbol: None */
...
/* 8020FA04  C0 9C 0C 18 */	lfs f4, 0xc18(r28)                       /* constant-address: 8042F7E0, symbol: None */
/* 8020FA08  39 20 00 00 */	li r9, 0                                
/* 8020FA0C  48 00 46 D1 */	bl drawPikari__13dMeter2Draw_cFffPffQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorfUc /* constant-address: 802140DC, symbol: drawPikari__13dMeter2Draw_cFffPffQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorfUc */
lbl_8020FA10:
/* 8020FA10  EF BD C0 2A */	fadds f29, f29, f24                     
/* 8020FA14  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
lbl_8020FA18:
/* 8020FA18  7F 58 07 34 */	extsh r24, r26                          
/* 8020FA1C  7C 1B C0 AE */	lbzx r0, r27, r24                       
/* 8020FA20  7C 00 07 75 */	extsb. r0, r0                           
/* 8020FA24  40 82 FE B8 */	bne lbl_8020F8DC                         /* constant-address: 8020F8DC, symbol: lbl_8020F8DC */
...
/* 8020FA74  48 15 27 9D */	bl _restgpr_23                           /* constant-address: 80362210, symbol: _restgpr_23 */

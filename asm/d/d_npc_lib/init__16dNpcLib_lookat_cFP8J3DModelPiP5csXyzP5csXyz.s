...
/* 8025141C  48 11 0D A5 */	bl _savegpr_22                           /* constant-address: 803621C0, symbol: _savegpr_22 */
...
/* 80251450  42 00 FF F4 */	bdnz lbl_80251444                        /* constant-address: 80251444, symbol: lbl_80251444 */
...
/* 80251468  3B E3 D4 70 */	addi r31, r3, now__14mDoMtx_stack_c@l    /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
lbl_8025146C:
/* 8025146C  7F BA B0 2E */	lwzx r29, r26, r22                      
/* 80251470  2C 1D 00 00 */	cmpwi r29, 0                            
/* 80251474  41 80 00 A8 */	blt lbl_8025151C                         /* constant-address: 8025151C, symbol: lbl_8025151C */
...
/* 8025148C  48 0F 50 25 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
...
/* 802514A0  C0 1F 00 0C */	lfs f0, 0xc(r31)                         /* constant-address: 803DD47C, symbol: None */
/* 802514A4  D0 03 00 00 */	stfs f0, 0(r3)                          
/* 802514A8  C0 1F 00 1C */	lfs f0, 0x1c(r31)                        /* constant-address: 803DD48C, symbol: None */
/* 802514AC  D0 03 00 04 */	stfs f0, 4(r3)                          
/* 802514B0  C0 1F 00 2C */	lfs f0, 0x2c(r31)                        /* constant-address: 803DD49C, symbol: None */
/* 802514B4  D0 03 00 08 */	stfs f0, 8(r3)                          
/* 802514B8  38 16 00 BC */	addi r0, r22, 0xbc                       /* constant-address: 000000BC */
...
/* 80251508  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
/* 8025150C  2C 1E 00 03 */	cmpwi r30, 3                            
/* 80251510  3A F7 00 06 */	addi r23, r23, 6                         /* constant-address: 00000006 */
/* 80251514  3A D6 00 04 */	addi r22, r22, 4                         /* constant-address: 00000004 */
/* 80251518  41 80 FF 54 */	blt lbl_8025146C                         /* constant-address: 8025146C, symbol: lbl_8025146C */
lbl_8025151C:
/* 8025151C  39 61 00 30 */	addi r11, r1, 0x30                      
/* 80251520  48 11 0C ED */	bl _restgpr_22                           /* constant-address: 8036220C, symbol: _restgpr_22 */

...
/* 8019C328  41 82 00 48 */	beq lbl_8019C370                         /* constant-address: 8019C370, symbol: lbl_8019C370 */
/* 8019C32C  3C 60 80 3C */	lis r3, __vt__12dMenu_save_c@ha         
/* 8019C330  38 03 BD 78 */	addi r0, r3, __vt__12dMenu_save_c@l      /* constant-address: 803BBD78, symbol: __vt__12dMenu_save_c */
/* 8019C334  90 1F 00 00 */	stw r0, 0(r31)                          
/* 8019C338  34 1F 00 18 */	addic. r0, r31, 0x18                    
/* 8019C33C  41 82 00 10 */	beq lbl_8019C34C                         /* constant-address: 8019C34C, symbol: lbl_8019C34C */
/* 8019C340  3C 60 80 3C */	lis r3, __vt__16dDlst_MenuSave_c@ha     
/* 8019C344  38 03 E7 64 */	addi r0, r3, __vt__16dDlst_MenuSave_c@l  /* constant-address: 803BE764, symbol: __vt__16dDlst_MenuSave_c */
/* 8019C348  90 1F 00 18 */	stw r0, 0x18(r31)                       
lbl_8019C34C:
/* 8019C34C  34 1F 00 10 */	addic. r0, r31, 0x10                    
/* 8019C350  41 82 00 10 */	beq lbl_8019C360                         /* constant-address: 8019C360, symbol: lbl_8019C360 */
/* 8019C354  3C 60 80 3C */	lis r3, __vt__23dDlst_MenuSaveExplain_c@ha
/* 8019C358  38 03 E7 74 */	addi r0, r3, __vt__23dDlst_MenuSaveExplain_c@l /* constant-address: 803BE774, symbol: __vt__23dDlst_MenuSaveExplain_c */
/* 8019C35C  90 1F 00 10 */	stw r0, 0x10(r31)                       
lbl_8019C360:
/* 8019C360  7C 80 07 35 */	extsh. r0, r4                           
/* 8019C364  40 81 00 0C */	ble lbl_8019C370                         /* constant-address: 8019C370, symbol: lbl_8019C370 */
/* 8019C368  7F E3 FB 78 */	mr r3, r31                              
/* 8019C36C  48 13 29 D1 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_8019C370:

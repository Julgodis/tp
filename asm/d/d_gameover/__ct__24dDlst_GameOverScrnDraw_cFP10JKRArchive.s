...
/* 8019B960  38 03 6F 88 */	addi r0, r3, __vt__12dDlst_base_c@l      /* constant-address: 803A6F88, symbol: __vt__12dDlst_base_c */
/* 8019B964  90 1F 00 00 */	stw r0, 0(r31)                          
/* 8019B968  3C 60 80 3C */	lis r3, __vt__24dDlst_GameOverScrnDraw_c@ha
/* 8019B96C  38 03 BD 68 */	addi r0, r3, __vt__24dDlst_GameOverScrnDraw_c@l /* constant-address: 803BBD68, symbol: __vt__24dDlst_GameOverScrnDraw_c */
...
/* 8019B980  48 13 32 CD */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8019B984  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8019B988  41 82 00 0C */	beq lbl_8019B994                         /* constant-address: 8019B994, symbol: lbl_8019B994 */
/* 8019B98C  48 15 CB 0D */	bl __ct__9J2DScreenFv                    /* constant-address: 802F8498, symbol: __ct__9J2DScreenFv */
...
/* 8019B9A0  38 84 4C 28 */	addi r4, r4, d_d_gameover__stringBase0@l /* constant-address: 80394C28, symbol: d_d_gameover__stringBase0 */
/* 8019B9A4  38 84 00 0E */	addi r4, r4, 0xe                         /* constant-address: 80394C36, symbol: None */
/* 8019B9A8  3C A0 00 10 */	lis r5, 0x10                            
/* 8019B9AC  7F C6 F3 78 */	mr r6, r30                              
/* 8019B9B0  48 15 CC 99 */	bl setPriority__9J2DScreenFPCcUlP10JKRArchive /* constant-address: 802F8648, symbol: setPriority__9J2DScreenFPCcUlP10JKRArchive */
/* 8019B9B4  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 8019B9B8  48 0B 97 31 */	bl dPaneClass_showNullPane__FP9J2DScreen /* constant-address: 802550E8, symbol: dPaneClass_showNullPane__FP9J2DScreen */
...
/* 8019B9D4  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8019B9D8  88 03 00 C2 */	lbz r0, 0xc2(r3)                         /* constant-address: 8043024A, symbol: None */
/* 8019B9DC  28 00 00 00 */	cmplwi r0, 0                            
/* 8019B9E0  41 82 00 74 */	beq lbl_8019BA54                         /* constant-address: 8019BA54, symbol: lbl_8019BA54 */
/* 8019B9E4  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 8019B9E8  3C 80 62 61 */	lis r4, 0x6261 /* 0x62617365@ha */      
/* 8019B9EC  38 C4 73 65 */	addi r6, r4, 0x7365 /* 0x62617365@l */   /* constant-address: 62617365 */
...
/* 8019BA0C  C0 22 A1 84 */	lfs f1, lit_3869(r2)                     /* constant-address: 80453B84, symbol: lit_3869 */
/* 8019BA10  C0 0D 86 5C */	lfs f0, mFadeRate__13mDoGph_gInf_c(r13)  /* constant-address: 80450BDC, symbol: mFadeRate__13mDoGph_gInf_c */
/* 8019BA14  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8019BA18  40 82 00 3C */	bne lbl_8019BA54                         /* constant-address: 8019BA54, symbol: lbl_8019BA54 */
/* 8019BA1C  80 0D 80 14 */	lwz r0, mFadeColor__13mDoGph_gInf_c(r13) /* constant-address: 80450594, symbol: mFadeColor__13mDoGph_gInf_c */
...
/* 8019BA5C  38 C4 5F 62 */	addi r6, r4, 0x5F62 /* 0x73655F62@l */   /* constant-address: 73655F62 */
...
/* 8019BA9C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8019BAA0  80 63 5D 30 */	lwz r3, 0x5d30(r3)                       /* constant-address: 8040BEF0, symbol: None */
/* 8019BAA4  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 8019BAA8  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
/* 8019BAAC  3C A0 80 39 */	lis r5, d_d_gameover__stringBase0@ha    
/* 8019BAB0  38 A5 4C 28 */	addi r5, r5, d_d_gameover__stringBase0@l /* constant-address: 80394C28, symbol: d_d_gameover__stringBase0 */
/* 8019BAB4  38 A5 00 22 */	addi r5, r5, 0x22                        /* constant-address: 80394C4A, symbol: None */
...
/* 8019BAD0  48 13 31 7D */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8019BAD4  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8019BAD8  41 82 00 40 */	beq lbl_8019BB18                         /* constant-address: 8019BB18, symbol: lbl_8019BB18 */
/* 8019BADC  C0 22 A1 80 */	lfs f1, lit_3868(r2)                     /* constant-address: 80453B80, symbol: lit_3868 */
/* 8019BAE0  D0 21 00 24 */	stfs f1, 0x24(r1)                       
/* 8019BAE4  C0 02 A1 A0 */	lfs f0, lit_4290(r2)                     /* constant-address: 80453BA0, symbol: lit_4290 */
/* 8019BAE8  D0 01 00 28 */	stfs f0, 0x28(r1)                       
/* 8019BAEC  D0 21 00 2C */	stfs f1, 0x2c(r1)                       
/* 8019BAF0  C0 02 A1 A4 */	lfs f0, lit_4291(r2)                     /* constant-address: 80453BA4, symbol: lit_4291 */
/* 8019BAF4  D0 01 00 30 */	stfs f0, 0x30(r1)                       
/* 8019BAF8  3C 80 43 54 */	lis r4, 0x4354 /* 0x43543031@ha */      
/* 8019BAFC  38 C4 30 31 */	addi r6, r4, 0x3031 /* 0x43543031@l */   /* constant-address: 43543031 */
...
/* 8019BB10  48 16 0C F1 */	bl func_802FC800                         /* constant-address: 802FC800, symbol: func_802FC800 */
...
/* 8019BB50  38 C4 30 30 */	addi r6, r4, 0x3030 /* 0x645F3030@l */   /* constant-address: 645F3030 */
/* 8019BB54  3C 80 00 67 */	lis r4, 0x0067 /* 0x00676F6C@ha */      
/* 8019BB58  38 A4 6F 6C */	addi r5, r4, 0x6F6C /* 0x00676F6C@l */   /* constant-address: 00676F6C */
...
/* 8019BB70  4B E7 90 31 */	bl mDoExt_getSubFont__Fv                 /* constant-address: 80014BA0, symbol: mDoExt_getSubFont__Fv */
...
/* 8019BB90  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8019BB94  38 80 03 81 */	li r4, 0x381                            
/* 8019BB98  38 A1 00 34 */	addi r5, r1, 0x34                       
/* 8019BB9C  38 C0 00 00 */	li r6, 0                                
/* 8019BBA0  48 08 06 B1 */	bl getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c /* constant-address: 8021C250, symbol: getString__13dMeter2Info_cFUlPcP14JMSMesgEntry_c */
/* 8019BBA4  7F C3 F3 78 */	mr r3, r30                              
/* 8019BBA8  38 81 00 34 */	addi r4, r1, 0x34                       
/* 8019BBAC  4C C6 31 82 */	crclr 6                                 
/* 8019BBB0  48 16 4A B1 */	bl setString__10J2DTextBoxFPCce          /* constant-address: 80300660, symbol: setString__10J2DTextBoxFPCce */
/* 8019BBB4  38 60 00 24 */	li r3, 0x24                             
/* 8019BBB8  48 13 30 95 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8019BBBC  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8019BBC0  41 82 00 14 */	beq lbl_8019BBD4                         /* constant-address: 8019BBD4, symbol: lbl_8019BBD4 */
/* 8019BBC4  38 80 00 06 */	li r4, 6                                
/* 8019BBC8  38 A0 00 FF */	li r5, 0xff                             
/* 8019BBCC  48 0A 9D 69 */	bl __ct__15dMsgScrnLight_cFUcUc          /* constant-address: 80245934, symbol: __ct__15dMsgScrnLight_cFUcUc */
/* 8019BBD0  7C 60 1B 78 */	mr r0, r3                               
lbl_8019BBD4:
/* 8019BBD4  90 1F 00 0C */	stw r0, 0xc(r31)                        
/* 8019BBD8  C0 02 A1 80 */	lfs f0, lit_3868(r2)                     /* constant-address: 80453B80, symbol: lit_3868 */

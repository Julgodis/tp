...
/* 8019BD0C  48 1C 64 BD */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 8019BD10  7C 7E 1B 78 */	mr r30, r3                              
/* 8019BD14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8019BD18  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8019BD1C  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 8019BD38  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8019BD3C  88 03 00 C2 */	lbz r0, 0xc2(r3)                         /* constant-address: 8043024A, symbol: None */
/* 8019BD40  28 00 00 01 */	cmplwi r0, 1                            
/* 8019BD44  41 82 00 0C */	beq lbl_8019BD50                         /* constant-address: 8019BD50, symbol: lbl_8019BD50 */
/* 8019BD48  28 00 00 02 */	cmplwi r0, 2                            
/* 8019BD4C  40 82 00 CC */	bne lbl_8019BE18                         /* constant-address: 8019BE18, symbol: lbl_8019BE18 */
lbl_8019BD50:
/* 8019BD50  C0 22 A1 84 */	lfs f1, lit_3869(r2)                     /* constant-address: 80453B84, symbol: lit_3869 */
/* 8019BD54  C0 0D 86 5C */	lfs f0, mFadeRate__13mDoGph_gInf_c(r13)  /* constant-address: 80450BDC, symbol: mFadeRate__13mDoGph_gInf_c */
/* 8019BD58  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8019BD5C  40 82 00 3C */	bne lbl_8019BD98                         /* constant-address: 8019BD98, symbol: lbl_8019BD98 */
/* 8019BD60  80 0D 80 14 */	lwz r0, mFadeColor__13mDoGph_gInf_c(r13) /* constant-address: 80450594, symbol: mFadeColor__13mDoGph_gInf_c */
...
/* 8019BDE8  C0 22 A1 80 */	lfs f1, lit_3868(r2)                     /* constant-address: 80453B80, symbol: lit_3868 */
/* 8019BDEC  FC 40 08 90 */	fmr f2, f1                              
/* 8019BDF0  C0 62 A1 AC */	lfs f3, lit_4374(r2)                     /* constant-address: 80453BAC, symbol: lit_4374 */
/* 8019BDF4  C0 82 A1 B0 */	lfs f4, lit_4375(r2)                     /* constant-address: 80453BB0, symbol: lit_4375 */
...
/* 8019BE14  48 00 00 F4 */	b lbl_8019BF08                           /* constant-address: 8019BF08, symbol: lbl_8019BF08 */
lbl_8019BE18:
...
/* 8019BE28  38 63 CA 2C */	addi r3, r3, l_HIO@l                     /* constant-address: 8042CA2C, symbol: l_HIO */
/* 8019BE2C  88 03 00 14 */	lbz r0, 0x14(r3)                         /* constant-address: 8042CA40, symbol: None */
/* 8019BE30  98 01 00 28 */	stb r0, 0x28(r1)                        
/* 8019BE34  88 03 00 15 */	lbz r0, 0x15(r3)                         /* constant-address: 8042CA41, symbol: None */
/* 8019BE38  98 01 00 29 */	stb r0, 0x29(r1)                        
/* 8019BE3C  88 03 00 16 */	lbz r0, 0x16(r3)                         /* constant-address: 8042CA42, symbol: None */
/* 8019BE40  98 01 00 2A */	stb r0, 0x2a(r1)                        
/* 8019BE44  88 03 00 17 */	lbz r0, 0x17(r3)                         /* constant-address: 8042CA43, symbol: None */
/* 8019BE48  98 01 00 2B */	stb r0, 0x2b(r1)                        
/* 8019BE4C  88 03 00 18 */	lbz r0, 0x18(r3)                         /* constant-address: 8042CA44, symbol: None */
/* 8019BE50  98 01 00 24 */	stb r0, 0x24(r1)                        
/* 8019BE54  88 03 00 19 */	lbz r0, 0x19(r3)                         /* constant-address: 8042CA45, symbol: None */
/* 8019BE58  98 01 00 25 */	stb r0, 0x25(r1)                        
/* 8019BE5C  88 03 00 1A */	lbz r0, 0x1a(r3)                         /* constant-address: 8042CA46, symbol: None */
/* 8019BE60  98 01 00 26 */	stb r0, 0x26(r1)                        
/* 8019BE64  88 03 00 1B */	lbz r0, 0x1b(r3)                         /* constant-address: 8042CA47, symbol: None */
/* 8019BE68  98 01 00 27 */	stb r0, 0x27(r1)                        
/* 8019BE6C  80 7E 00 08 */	lwz r3, 8(r30)                          
/* 8019BE70  C0 22 A1 80 */	lfs f1, lit_3868(r2)                     /* constant-address: 80453B80, symbol: lit_3868 */
/* 8019BE74  FC 40 08 90 */	fmr f2, f1                              
/* 8019BE78  C0 62 A1 AC */	lfs f3, lit_4374(r2)                     /* constant-address: 80453BAC, symbol: lit_4374 */
/* 8019BE7C  C0 82 A1 B0 */	lfs f4, lit_4375(r2)                     /* constant-address: 80453BB0, symbol: lit_4375 */
...
/* 8019BEA8  3B 23 CA 2C */	addi r25, r3, l_HIO@l                    /* constant-address: 8042CA2C, symbol: l_HIO */
/* 8019BEAC  83 41 00 24 */	lwz r26, 0x24(r1)                       
/* 8019BEB0  83 61 00 28 */	lwz r27, 0x28(r1)                       
/* 8019BEB4  C3 E2 A1 B4 */	lfs f31, lit_4376(r2)                    /* constant-address: 80453BB4, symbol: lit_4376 */
/* 8019BEB8  3C 60 80 3C */	lis r3, data_803BBD0C@ha                
/* 8019BEBC  3B 83 BD 0C */	addi r28, r3, data_803BBD0C@l            /* constant-address: 803BBD0C, symbol: data_803BBD0C */
lbl_8019BEC0:
/* 8019BEC0  93 41 00 10 */	stw r26, 0x10(r1)                       
/* 8019BEC4  93 61 00 14 */	stw r27, 0x14(r1)                       
/* 8019BEC8  C0 79 00 08 */	lfs f3, 8(r25)                           /* constant-address: 8042CA34, symbol: None */
...
/* 8019BEDC  C0 42 A1 B8 */	lfs f2, lit_4377(r2)                     /* constant-address: 80453BB8, symbol: lit_4377 */
/* 8019BEE0  FC 80 18 90 */	fmr f4, f3                              
/* 8019BEE4  C0 B9 00 0C */	lfs f5, 0xc(r25)                         /* constant-address: 8042CA38, symbol: None */
/* 8019BEE8  C0 D9 00 10 */	lfs f6, 0x10(r25)                        /* constant-address: 8042CA3C, symbol: None */
/* 8019BEEC  38 A1 00 14 */	addi r5, r1, 0x14                       
/* 8019BEF0  38 C1 00 10 */	addi r6, r1, 0x10                       
/* 8019BEF4  48 0A A0 9D */	bl draw__15dMsgScrnLight_cFPfffffffQ28JUtility6TColorQ28JUtility6TColor /* constant-address: 80245F90, symbol: draw__15dMsgScrnLight_cFPfffffffQ28JUtility6TColorQ28JUtility6TColor */
/* 8019BEF8  3B 18 00 01 */	addi r24, r24, 1                        
/* 8019BEFC  2C 18 00 08 */	cmpwi r24, 8                            
/* 8019BF00  3B BD 00 04 */	addi r29, r29, 4                        
/* 8019BF04  41 80 FF BC */	blt lbl_8019BEC0                         /* constant-address: 8019BEC0, symbol: lbl_8019BEC0 */
lbl_8019BF08:
/* 8019BF08  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 8019BF0C  C0 22 A1 80 */	lfs f1, lit_3868(r2)                     /* constant-address: 80453B80, symbol: lit_3868 */
/* 8019BF10  FC 40 08 90 */	fmr f2, f1                              
/* 8019BF14  7F E4 FB 78 */	mr r4, r31                              
/* 8019BF18  48 15 CF BD */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
/* 8019BF1C  E3 E1 00 68 */	psq_l f31, 104(r1), 0, 0 /* qr0 */      
/* 8019BF20  CB E1 00 60 */	lfd f31, 0x60(r1)                       
/* 8019BF24  39 61 00 60 */	addi r11, r1, 0x60                      
/* 8019BF28  48 1C 62 ED */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

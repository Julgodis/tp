...
/* 80253454  38 83 6F 88 */	addi r4, r3, __vt__12dDlst_base_c@l      /* constant-address: 803A6F88, symbol: __vt__12dDlst_base_c */
/* 80253458  90 9F 00 D8 */	stw r4, 0xd8(r31)                       
/* 8025345C  3C 60 80 3C */	lis r3, __vt__16dDlst_snapShot_c@ha     
/* 80253460  38 03 2D EC */	addi r0, r3, __vt__16dDlst_snapShot_c@l  /* constant-address: 803C2DEC, symbol: __vt__16dDlst_snapShot_c */
...
/* 80253470  38 03 2D DC */	addi r0, r3, __vt__15dOvlpFd3_dlst_c@l   /* constant-address: 803C2DDC, symbol: __vt__15dOvlpFd3_dlst_c */
/* 80253474  90 1F 00 DC */	stw r0, 0xdc(r31)                       
/* 80253478  3C 60 80 3C */	lis r3, lit_3812@ha                     
/* 8025347C  38 83 2D 70 */	addi r4, r3, lit_3812@l                  /* constant-address: 803C2D70, symbol: lit_3812 */
/* 80253480  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 803C2D70, symbol: lit_3812 */
/* 80253484  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803C2D74, symbol: None */
/* 80253488  90 7F 00 CC */	stw r3, 0xcc(r31)                       
/* 8025348C  90 1F 00 D0 */	stw r0, 0xd0(r31)                       
/* 80253490  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803C2D78, symbol: None */
/* 80253494  90 1F 00 D4 */	stw r0, 0xd4(r31)                       
/* 80253498  38 00 00 00 */	li r0, 0                                
/* 8025349C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 802534A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 802534A4  98 03 5E B8 */	stb r0, 0x5eb8(r3)                       /* constant-address: 8040C078, symbol: None */
/* 802534A8  38 00 00 02 */	li r0, 2                                
/* 802534AC  98 1F 01 1D */	stb r0, 0x11d(r31)                      
/* 802534B0  88 03 4E 1E */	lbz r0, 0x4e1e(r3)                       /* constant-address: 8040AFDE, symbol: None */
/* 802534B4  98 1F 01 1F */	stb r0, 0x11f(r31)                      
/* 802534B8  88 1F 01 1F */	lbz r0, 0x11f(r31)                      
/* 802534BC  28 00 00 00 */	cmplwi r0, 0                            
/* 802534C0  40 82 00 0C */	bne lbl_802534CC                         /* constant-address: 802534CC, symbol: lbl_802534CC */
/* 802534C4  38 00 00 01 */	li r0, 1                                
/* 802534C8  98 1F 01 1F */	stb r0, 0x11f(r31)                      
lbl_802534CC:
/* 802534CC  4B F2 E1 75 */	bl dCam_getBody__Fv                      /* constant-address: 80181640, symbol: dCam_getBody__Fv */
/* 802534D0  4B F0 E0 01 */	bl Stop__9dCamera_cFv                    /* constant-address: 801614D0, symbol: Stop__9dCamera_cFv */
/* 802534D4  88 1F 01 1F */	lbz r0, 0x11f(r31)                      
/* 802534D8  7C 03 0E 70 */	srawi r3, r0, 1                         
/* 802534DC  38 83 00 5A */	addi r4, r3, 0x5a                       
/* 802534E0  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 802534E4  80 63 00 04 */	lwz r3, 4(r3)                           
/* 802534E8  28 03 00 00 */	cmplwi r3, 0                            
/* 802534EC  41 82 00 14 */	beq lbl_80253500                         /* constant-address: 80253500, symbol: lbl_80253500 */

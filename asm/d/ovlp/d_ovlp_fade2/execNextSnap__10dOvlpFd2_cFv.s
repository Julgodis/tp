...
/* 80252BD8  48 00 02 99 */	bl func_80252E70                         /* constant-address: 80252E70, symbol: func_80252E70 */
/* 80252BDC  7C 60 07 75 */	extsb. r0, r3                           
/* 80252BE0  40 82 00 74 */	bne lbl_80252C54                         /* constant-address: 80252C54, symbol: lbl_80252C54 */
/* 80252BE4  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
...
/* 80252C04  40 82 00 50 */	bne lbl_80252C54                         /* constant-address: 80252C54, symbol: lbl_80252C54 */
...
/* 80252C28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80252C2C  98 03 5D 44 */	stb r0, 0x5d44(r3)                       /* constant-address: 8040BF04, symbol: None */
/* 80252C30  98 83 5E B8 */	stb r4, 0x5eb8(r3)                       /* constant-address: 8040C078, symbol: None */
/* 80252C34  3C 60 80 3C */	lis r3, lit_3765@ha                     
/* 80252C38  38 83 2D 14 */	addi r4, r3, lit_3765@l                  /* constant-address: 803C2D14, symbol: lit_3765 */
/* 80252C3C  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 803C2D14, symbol: lit_3765 */
/* 80252C40  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803C2D18, symbol: None */
/* 80252C44  90 7F 00 CC */	stw r3, 0xcc(r31)                       
/* 80252C48  90 1F 00 D0 */	stw r0, 0xd0(r31)                       
/* 80252C4C  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803C2D1C, symbol: None */

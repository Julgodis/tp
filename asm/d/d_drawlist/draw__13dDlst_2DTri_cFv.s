...
/* 80051B08  38 E3 9A 20 */	addi r7, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 80051BA8  42 00 FF 90 */	bdnz lbl_80051B38                        /* constant-address: 80051B38, symbol: lbl_80051B38 */
/* 80051BAC  48 30 99 E1 */	bl GXClearVtxDesc                        /* constant-address: 8035B58C, symbol: GXClearVtxDesc */
/* 80051BB0  38 60 00 09 */	li r3, 9                                
/* 80051BB4  38 80 00 01 */	li r4, 1                                
/* 80051BB8  48 30 93 01 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
...
/* 80051BD0  48 30 99 F5 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
/* 80051BD4  38 60 00 01 */	li r3, 1                                
/* 80051BD8  48 30 BF 59 */	bl GXSetNumChans                         /* constant-address: 8035DB30, symbol: GXSetNumChans */
...
/* 80051BF8  48 30 BF 75 */	bl GXSetChanCtrl                         /* constant-address: 8035DB6C, symbol: GXSetChanCtrl */
...
/* 80051C0C  48 30 BE 3D */	bl GXSetChanMatColor                     /* constant-address: 8035DA48, symbol: GXSetChanMatColor */
/* 80051C10  38 60 00 00 */	li r3, 0                                
/* 80051C14  48 30 A1 E9 */	bl GXSetNumTexGens                       /* constant-address: 8035BDFC, symbol: GXSetNumTexGens */
/* 80051C18  38 60 00 01 */	li r3, 1                                
/* 80051C1C  48 30 DC 75 */	bl GXSetNumTevStages                     /* constant-address: 8035F890, symbol: GXSetNumTevStages */
/* 80051C20  38 60 00 00 */	li r3, 0                                
/* 80051C24  38 80 00 FF */	li r4, 0xff                             
/* 80051C28  38 A0 00 FF */	li r5, 0xff                             
/* 80051C2C  38 C0 00 04 */	li r6, 4                                
/* 80051C30  48 30 DA C5 */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
/* 80051C34  38 60 00 00 */	li r3, 0                                
/* 80051C38  38 80 00 04 */	li r4, 4                                
/* 80051C3C  48 30 D5 5D */	bl GXSetTevOp                            /* constant-address: 8035F198, symbol: GXSetTevOp */
/* 80051C40  38 60 00 01 */	li r3, 1                                
/* 80051C44  38 80 00 04 */	li r4, 4                                
/* 80051C48  38 A0 00 05 */	li r5, 5                                
/* 80051C4C  38 C0 00 0F */	li r6, 0xf                              
/* 80051C50  48 30 DF A1 */	bl GXSetBlendMode                        /* constant-address: 8035FBF0, symbol: GXSetBlendMode */
/* 80051C54  3C 60 80 3A */	lis r3, g_mDoMtx_identity@ha            
/* 80051C58  38 63 2F D8 */	addi r3, r3, g_mDoMtx_identity@l         /* constant-address: 803A2FD8, symbol: g_mDoMtx_identity */
/* 80051C5C  38 80 00 00 */	li r4, 0                                
/* 80051C60  48 30 E5 ED */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
/* 80051C64  38 60 00 00 */	li r3, 0                                
/* 80051C68  48 30 E6 85 */	bl GXSetCurrentMtx                       /* constant-address: 803602EC, symbol: GXSetCurrentMtx */
/* 80051C6C  38 60 00 90 */	li r3, 0x90                             
/* 80051C70  38 80 00 00 */	li r4, 0                                
/* 80051C74  38 A0 00 03 */	li r5, 3                                
/* 80051C78  48 30 AA ED */	bl GXBegin                               /* constant-address: 8035C764, symbol: GXBegin */
/* 80051C7C  A8 01 00 14 */	lha r0, 0x14(r1)                        
/* 80051C80  3C 80 CC 01 */	lis r4, 0xCC01 /* 0xCC008000@ha */      
/* 80051C84  B0 04 80 00 */	sth r0, 0x8000(r4)                       /* constant-address: CC008000 */
/* 80051C88  A8 01 00 0C */	lha r0, 0xc(r1)                         
/* 80051C8C  B0 04 80 00 */	sth r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051C90  38 60 00 00 */	li r3, 0                                
/* 80051C94  B0 64 80 00 */	sth r3, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051C98  A8 01 00 16 */	lha r0, 0x16(r1)                        
/* 80051C9C  B0 04 80 00 */	sth r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051CA0  A8 01 00 0E */	lha r0, 0xe(r1)                         
/* 80051CA4  B0 04 80 00 */	sth r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051CA8  B0 64 80 00 */	sth r3, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051CAC  A8 01 00 18 */	lha r0, 0x18(r1)                        
/* 80051CB0  B0 04 80 00 */	sth r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051CB4  A8 01 00 10 */	lha r0, 0x10(r1)                        
/* 80051CB8  B0 04 80 00 */	sth r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051CBC  B0 64 80 00 */	sth r3, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80051CC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80051CC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80051CC8  80 63 5F 50 */	lwz r3, 0x5f50(r3)                       /* constant-address: 8040C110, symbol: None */

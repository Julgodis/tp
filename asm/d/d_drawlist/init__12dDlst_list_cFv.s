...
/* 800563A0  48 30 BE 39 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 800563A4  7C 7F 1B 78 */	mr r31, r3                              
/* 800563A8  7F FE FB 78 */	mr r30, r31                             
/* 800563AC  3C 60 80 38 */	lis r3, data_8037A178@ha                
/* 800563B0  38 03 A1 78 */	addi r0, r3, data_8037A178@l             /* constant-address: 8037A178, symbol: data_8037A178 */
...
/* 800563C4  4B FF E0 B5 */	bl J3DDrawBuffer__create__FUl            /* constant-address: 80054478, symbol: J3DDrawBuffer__create__FUl */
...
/* 800563D8  41 80 FF E4 */	blt lbl_800563BC                         /* constant-address: 800563BC, symbol: lbl_800563BC */
/* 800563DC  3C 60 80 38 */	lis r3, data_8037A1A4@ha                
/* 800563E0  38 03 A1 A4 */	addi r0, r3, data_8037A1A4@l             /* constant-address: 8037A1A4, symbol: data_8037A1A4 */
...
/* 80056408  42 00 FF EC */	bdnz lbl_800563F4                        /* constant-address: 800563F4, symbol: lbl_800563F4 */
/* 8005640C  38 A2 86 C4 */	la r5, data_804520C4(r2) /* 804520C4-_SDA2_BASE_ */ /* constant-address: 804520C4, symbol: data_804520C4 */
...
/* 80056430  42 00 FF EC */	bdnz lbl_8005641C                        /* constant-address: 8005641C, symbol: lbl_8005641C */
/* 80056434  80 1F 00 1C */	lwz r0, 0x1c(r31)                       
/* 80056438  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8005643C  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 80056440  90 03 00 48 */	stw r0, 0x48(r3)                         /* constant-address: 80434B10, symbol: None */
/* 80056444  80 1F 00 20 */	lwz r0, 0x20(r31)                       
/* 80056448  90 03 00 4C */	stw r0, 0x4c(r3)                         /* constant-address: 80434B14, symbol: None */
...
/* 80056470  4B FF F2 15 */	bl init__21dDlst_shadowControl_cFv       /* constant-address: 80055684, symbol: init__21dDlst_shadowControl_cFv */
/* 80056474  39 61 00 20 */	addi r11, r1, 0x20                      
/* 80056478  48 30 BD AD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

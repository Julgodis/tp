...
/* 80056090  48 30 C1 4D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 80056094  7C 7D 1B 78 */	mr r29, r3                              
/* 80056098  3B FD 00 04 */	addi r31, r29, 4                        
/* 8005609C  3B C0 00 00 */	li r30, 0                               
/* 800560A0  48 00 00 24 */	b lbl_800560C4                           /* constant-address: 800560C4, symbol: lbl_800560C4 */
lbl_800560A4:
...
/* 800560B8  48 30 64 05 */	bl GXPeekZ                               /* constant-address: 8035C4BC, symbol: GXPeekZ */
/* 800560BC  3B FF 00 08 */	addi r31, r31, 8                        
/* 800560C0  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_800560C4:
/* 800560C4  88 1D 00 00 */	lbz r0, 0(r29)                          
/* 800560C8  7C 1E 00 00 */	cmpw r30, r0                            
/* 800560CC  41 80 FF D8 */	blt lbl_800560A4                         /* constant-address: 800560A4, symbol: lbl_800560A4 */
/* 800560D0  38 00 00 00 */	li r0, 0                                
/* 800560D4  98 1D 00 00 */	stb r0, 0(r29)                          
/* 800560D8  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800560DC  48 30 C1 4D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

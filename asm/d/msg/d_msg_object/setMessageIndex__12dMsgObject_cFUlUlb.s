...
/* 80233D14  48 12 E4 C1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 80233D28  48 00 02 B1 */	bl getRevoMessageIndex__12dMsgObject_cFUl /* constant-address: 80233FD8, symbol: getRevoMessageIndex__12dMsgObject_cFUl */
/* 80233D2C  7C 7E 1B 78 */	mr r30, r3                              
/* 80233D30  88 1D 04 CC */	lbz r0, 0x4cc(r29)                      
/* 80233D34  28 00 00 00 */	cmplwi r0, 0                            
/* 80233D38  40 82 00 0C */	bne lbl_80233D44                         /* constant-address: 80233D44, symbol: lbl_80233D44 */
...
/* 80233D60  41 82 00 2C */	beq lbl_80233D8C                         /* constant-address: 80233D8C, symbol: lbl_80233D8C */
/* 80233D64  28 04 00 00 */	cmplwi r4, 0                            
/* 80233D68  41 82 00 24 */	beq lbl_80233D8C                         /* constant-address: 80233D8C, symbol: lbl_80233D8C */
/* 80233D6C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80233D70  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80233D74  38 63 4E C8 */	addi r3, r3, 0x4ec8                      /* constant-address: 8040B088, symbol: None */
/* 80233D78  4B E0 F9 15 */	bl setPtT__14dEvt_control_cFPv           /* constant-address: 8004368C, symbol: setPtT__14dEvt_control_cFPv */
...
/* 80233D94  48 00 03 A9 */	bl getMessageGroup__12dMsgObject_cFUl    /* constant-address: 8023413C, symbol: getMessageGroup__12dMsgObject_cFUl */
/* 80233D98  48 00 43 2D */	bl changeGroup__12dMsgObject_cFs         /* constant-address: 802380C4, symbol: changeGroup__12dMsgObject_cFs */
...
/* 80233DC8  48 00 01 BD */	bl getMessageIndex__12dMsgObject_cFUl    /* constant-address: 80233F84, symbol: getMessageIndex__12dMsgObject_cFUl */
...
/* 80233DDC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80233DE0  90 03 5E EC */	stw r0, 0x5eec(r3)                       /* constant-address: 8040C0AC, symbol: None */
/* 80233DE4  80 9D 01 5C */	lwz r4, 0x15c(r29)                      
/* 80233DE8  28 04 03 E8 */	cmplwi r4, 0x3e8                        
/* 80233DEC  40 82 00 14 */	bne lbl_80233E00                         /* constant-address: 80233E00, symbol: lbl_80233E00 */
/* 80233DF0  38 00 00 00 */	li r0, 0                                
/* 80233DF4  80 7D 01 18 */	lwz r3, 0x118(r29)                      
/* 80233DF8  90 03 05 C4 */	stw r0, 0x5c4(r3)                       
/* 80233DFC  48 00 00 40 */	b lbl_80233E3C                           /* constant-address: 80233E3C, symbol: lbl_80233E3C */
lbl_80233E00:
/* 80233E00  7F A3 EB 78 */	mr r3, r29                              
/* 80233E04  48 00 01 81 */	bl getMessageIndex__12dMsgObject_cFUl    /* constant-address: 80233F84, symbol: getMessageIndex__12dMsgObject_cFUl */
/* 80233E08  28 03 02 64 */	cmplwi r3, 0x264                        
/* 80233E0C  40 82 00 14 */	bne lbl_80233E20                         /* constant-address: 80233E20, symbol: lbl_80233E20 */
/* 80233E10  38 00 00 00 */	li r0, 0                                
/* 80233E14  80 7D 01 18 */	lwz r3, 0x118(r29)                      
/* 80233E18  90 03 05 C4 */	stw r0, 0x5c4(r3)                       
/* 80233E1C  48 00 00 20 */	b lbl_80233E3C                           /* constant-address: 80233E3C, symbol: lbl_80233E3C */
lbl_80233E20:
...
/* 80233E40  41 82 00 18 */	beq lbl_80233E58                         /* constant-address: 80233E58, symbol: lbl_80233E58 */
...
/* 80233E54  48 07 3A A1 */	bl setMessageID__Q28JMessage8TControlFUlUlPb /* constant-address: 802A78F4, symbol: setMessageID__Q28JMessage8TControlFUlUlPb */
lbl_80233E58:
/* 80233E58  39 61 00 20 */	addi r11, r1, 0x20                      
/* 80233E5C  48 12 E3 C5 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

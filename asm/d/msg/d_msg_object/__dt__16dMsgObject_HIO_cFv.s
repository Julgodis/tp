...
/* 80238BF0  41 82 00 34 */	beq lbl_80238C24                         /* constant-address: 80238C24, symbol: lbl_80238C24 */
/* 80238BF4  3C 60 80 3C */	lis r3, __vt__16dMsgObject_HIO_c@ha     
/* 80238BF8  38 03 0B D8 */	addi r0, r3, __vt__16dMsgObject_HIO_c@l  /* constant-address: 803C0BD8, symbol: __vt__16dMsgObject_HIO_c */
/* 80238BFC  90 1F 00 00 */	stw r0, 0(r31)                          
/* 80238C00  34 1F 03 5C */	addic. r0, r31, 0x35c                   
/* 80238C04  41 82 00 10 */	beq lbl_80238C14                         /* constant-address: 80238C14, symbol: lbl_80238C14 */
/* 80238C08  3C 60 80 3C */	lis r3, __vt__20dMsgObject_HowlHIO_c@ha 
/* 80238C0C  38 03 0B E4 */	addi r0, r3, __vt__20dMsgObject_HowlHIO_c@l /* constant-address: 803C0BE4, symbol: __vt__20dMsgObject_HowlHIO_c */
/* 80238C10  90 1F 03 5C */	stw r0, 0x35c(r31)                      
lbl_80238C14:
/* 80238C14  7C 80 07 35 */	extsh. r0, r4                           
/* 80238C18  40 81 00 0C */	ble lbl_80238C24                         /* constant-address: 80238C24, symbol: lbl_80238C24 */
/* 80238C1C  7F E3 FB 78 */	mr r3, r31                              
/* 80238C20  48 09 61 1D */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_80238C24:

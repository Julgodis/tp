...
/* 80231F20  4B FF DC 05 */	bl getLineCountNowPage__26jmessage_string_tReferenceFv /* constant-address: 8022FB24, symbol: getLineCountNowPage__26jmessage_string_tReferenceFv */
/* 80231F24  7C 60 07 35 */	extsh. r0, r3                           
/* 80231F28  41 80 00 F0 */	blt lbl_80232018                         /* constant-address: 80232018, symbol: lbl_80232018 */
/* 80231F2C  80 7F 00 38 */	lwz r3, 0x38(r31)                       
/* 80231F30  80 83 00 08 */	lwz r4, 8(r3)                           
/* 80231F34  28 04 00 00 */	cmplwi r4, 0                            
/* 80231F38  41 82 00 E0 */	beq lbl_80232018                         /* constant-address: 80232018, symbol: lbl_80232018 */
/* 80231F3C  88 03 00 84 */	lbz r0, 0x84(r3)                        
/* 80231F40  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 80231F44  40 82 00 10 */	bne lbl_80231F54                         /* constant-address: 80231F54, symbol: lbl_80231F54 */
/* 80231F48  88 04 01 30 */	lbz r0, 0x130(r4)                       
/* 80231F4C  54 00 F7 BF */	rlwinm. r0, r0, 0x1e, 0x1e, 0x1f        
/* 80231F50  40 82 00 C8 */	bne lbl_80232018                         /* constant-address: 80232018, symbol: lbl_80232018 */
lbl_80231F54:
...
/* 80231F68  4B FF DB BD */	bl getLineCountNowPage__26jmessage_string_tReferenceFv /* constant-address: 8022FB24, symbol: getLineCountNowPage__26jmessage_string_tReferenceFv */
/* 80231F6C  7C 60 07 34 */	extsh r0, r3                            
/* 80231F70  C8 22 B0 70 */	lfd f1, lit_4198(r2)                     /* constant-address: 80454A70, symbol: lit_4198 */
...
/* 80231F98  C0 22 B0 5C */	lfs f1, lit_4026(r2)                     /* constant-address: 80454A5C, symbol: lit_4026 */
/* 80231F9C  EC 1F 00 28 */	fsubs f0, f31, f0                       
/* 80231FA0  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 80231FA4  EC 21 00 2A */	fadds f1, f1, f0                        
/* 80231FA8  C0 02 B0 64 */	lfs f0, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
/* 80231FAC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80231FB0  4C 41 13 82 */	cror 2, 1, 2                            
/* 80231FB4  40 82 00 64 */	bne lbl_80232018                         /* constant-address: 80232018, symbol: lbl_80232018 */
...
/* 80231FD4  41 82 00 44 */	beq lbl_80232018                         /* constant-address: 80232018, symbol: lbl_80232018 */
/* 80231FD8  38 61 00 08 */	addi r3, r1, 8                          
/* 80231FDC  38 80 00 0F */	li r4, 0xf                              
/* 80231FE0  3C A0 80 3A */	lis r5, d_msg_d_msg_class__stringBase0@ha
/* 80231FE4  38 A5 96 10 */	addi r5, r5, d_msg_d_msg_class__stringBase0@l /* constant-address: 80399610, symbol: d_msg_d_msg_class__stringBase0 */
/* 80231FE8  38 A5 00 10 */	addi r5, r5, 0x10                        /* constant-address: 80399620, symbol: None */
...
/* 80231FFC  48 13 45 C1 */	bl snprintf                              /* constant-address: 803665BC, symbol: snprintf */
/* 80232000  7F E3 FB 78 */	mr r3, r31                              
/* 80232004  38 81 00 08 */	addi r4, r1, 8                          
/* 80232008  48 00 00 3D */	bl do_strcat__35jmessage_string_tRenderingProcessorFPc /* constant-address: 80232044, symbol: do_strcat__35jmessage_string_tRenderingProcessorFPc */
/* 8023200C  7F E3 FB 78 */	mr r3, r31                              
/* 80232010  38 81 00 08 */	addi r4, r1, 8                          
/* 80232014  48 00 02 4D */	bl do_rubystrcat__35jmessage_string_tRenderingProcessorFPc /* constant-address: 80232260, symbol: do_rubystrcat__35jmessage_string_tRenderingProcessorFPc */
lbl_80232018:

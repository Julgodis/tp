...
/* 80229ADC  48 13 86 ED */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 80229AF0  4B FF FC C1 */	bl resetCharactor__19jmessage_tReferenceFv /* constant-address: 802297B0, symbol: resetCharactor__19jmessage_tReferenceFv */
/* 80229AF4  3B C0 00 00 */	li r30, 0                               
/* 80229AF8  93 DC 05 B8 */	stw r30, 0x5b8(r28)                     
/* 80229AFC  C0 02 B0 64 */	lfs f0, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
...
/* 80229B1C  C3 E2 B0 60 */	lfs f31, lit_4027(r2)                    /* constant-address: 80454A60, symbol: lit_4027 */
...
/* 80229B58  4B FF F3 49 */	bl isPlaceName__19jmessage_tReferenceFv  /* constant-address: 80228EA0, symbol: isPlaceName__19jmessage_tReferenceFv */
/* 80229B5C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80229B60  40 82 00 30 */	bne lbl_80229B90                         /* constant-address: 80229B90, symbol: lbl_80229B90 */
/* 80229B64  7F 83 E3 78 */	mr r3, r28                              
/* 80229B68  4B FF F4 09 */	bl isStaffRoll__19jmessage_tReferenceFv  /* constant-address: 80228F70, symbol: isStaffRoll__19jmessage_tReferenceFv */
/* 80229B6C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80229B70  40 82 00 20 */	bne lbl_80229B90                         /* constant-address: 80229B90, symbol: lbl_80229B90 */
/* 80229B74  7F 83 E3 78 */	mr r3, r28                              
/* 80229B78  4B FF F3 5D */	bl isBossName__19jmessage_tReferenceFv   /* constant-address: 80228ED4, symbol: isBossName__19jmessage_tReferenceFv */
/* 80229B7C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80229B80  40 82 00 10 */	bne lbl_80229B90                         /* constant-address: 80229B90, symbol: lbl_80229B90 */
/* 80229B84  88 1C 12 46 */	lbz r0, 0x1246(r28)                     
/* 80229B88  28 00 00 09 */	cmplwi r0, 9                            
/* 80229B8C  40 82 00 10 */	bne lbl_80229B9C                         /* constant-address: 80229B9C, symbol: lbl_80229B9C */
lbl_80229B90:
/* 80229B90  38 00 00 01 */	li r0, 1                                
/* 80229B94  98 1D 12 1A */	stb r0, 0x121a(r29)                     
/* 80229B98  48 00 00 2C */	b lbl_80229BC4                           /* constant-address: 80229BC4, symbol: lbl_80229BC4 */
lbl_80229B9C:
/* 80229B9C  A0 1A 00 04 */	lhz r0, 4(r26)                          
/* 80229BA0  28 00 02 A5 */	cmplwi r0, 0x2a5                        
/* 80229BA4  40 82 00 0C */	bne lbl_80229BB0                         /* constant-address: 80229BB0, symbol: lbl_80229BB0 */
...
/* 80229BB8  40 82 00 0C */	bne lbl_80229BC4                         /* constant-address: 80229BC4, symbol: lbl_80229BC4 */
...
/* 80229BD4  41 80 FF 50 */	blt lbl_80229B24                         /* constant-address: 80229B24, symbol: lbl_80229B24 */
/* 80229BD8  38 C0 00 00 */	li r6, 0                                
/* 80229BDC  38 60 00 00 */	li r3, 0                                
/* 80229BE0  C0 02 B0 60 */	lfs f0, lit_4027(r2)                     /* constant-address: 80454A60, symbol: lit_4027 */
...
/* 80229C14  42 00 FF DC */	bdnz lbl_80229BF0                        /* constant-address: 80229BF0, symbol: lbl_80229BF0 */
...
/* 80229C48  4B FF F1 99 */	bl getLineMax__19jmessage_tReferenceFv   /* constant-address: 80228DE0, symbol: getLineMax__19jmessage_tReferenceFv */
/* 80229C4C  98 79 00 4A */	stb r3, 0x4a(r25)                       
/* 80229C50  7F 83 E3 78 */	mr r3, r28                              
/* 80229C54  4B FF FA F1 */	bl resetWord__19jmessage_tReferenceFv    /* constant-address: 80229744, symbol: resetWord__19jmessage_tReferenceFv */
...
/* 80229C70  40 82 00 08 */	bne lbl_80229C78                         /* constant-address: 80229C78, symbol: lbl_80229C78 */
/* 80229C74  48 00 D9 9D */	bl resetSelectBomBag__12dMsgObject_cFv   /* constant-address: 80237610, symbol: resetSelectBomBag__12dMsgObject_cFv */
lbl_80229C78:
/* 80229C78  C0 22 B0 64 */	lfs f1, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
/* 80229C7C  C0 1C 04 54 */	lfs f0, 0x454(r28)                      
/* 80229C80  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 80229C84  41 82 00 10 */	beq lbl_80229C94                         /* constant-address: 80229C94, symbol: lbl_80229C94 */
/* 80229C88  7F 23 CB 78 */	mr r3, r25                              
/* 80229C8C  C0 39 00 38 */	lfs f1, 0x38(r25)                       
/* 80229C90  48 00 14 21 */	bl do_scale__26jmessage_tMeasureProcessorFf /* constant-address: 8022B0B0, symbol: do_scale__26jmessage_tMeasureProcessorFf */
lbl_80229C94:
/* 80229C94  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */       
/* 80229C98  CB E1 00 30 */	lfd f31, 0x30(r1)                       
/* 80229C9C  39 61 00 30 */	addi r11, r1, 0x30                      
/* 80229CA0  48 13 85 75 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

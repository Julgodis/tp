...
/* 8022EB14  48 13 36 C1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8022EB54  C0 22 B0 94 */	lfs f1, lit_6781(r2)                     /* constant-address: 80454A94, symbol: lit_6781 */
...
/* 8022EB9C  40 82 00 0C */	bne lbl_8022EBA8                         /* constant-address: 8022EBA8, symbol: lbl_8022EBA8 */
/* 8022EBA0  80 DF 01 20 */	lwz r6, 0x120(r31)                      
/* 8022EBA4  48 00 00 08 */	b lbl_8022EBAC                           /* constant-address: 8022EBAC, symbol: lbl_8022EBAC */
lbl_8022EBA8:
/* 8022EBA8  7F 86 E3 78 */	mr r6, r28                              
lbl_8022EBAC:
/* 8022EBAC  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 8022EBB0  28 00 00 1E */	cmplwi r0, 0x1e                         
/* 8022EBB4  40 82 00 10 */	bne lbl_8022EBC4                         /* constant-address: 8022EBC4, symbol: lbl_8022EBC4 */
...
/* 8022EC18  41 82 00 38 */	beq lbl_8022EC50                         /* constant-address: 8022EC50, symbol: lbl_8022EC50 */
/* 8022EC1C  C0 7F 00 44 */	lfs f3, 0x44(r31)                       
/* 8022EC20  7F E3 FB 78 */	mr r3, r31                              
/* 8022EC24  C0 82 B0 5C */	lfs f4, lit_4026(r2)                     /* constant-address: 80454A5C, symbol: lit_4026 */
...
/* 8022EC48  C0 A2 B0 64 */	lfs f5, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
/* 8022EC4C  48 00 0B 39 */	bl getCharInfo__28jmessage_tRenderingProcessorFfffff /* constant-address: 8022F784, symbol: getCharInfo__28jmessage_tRenderingProcessorFfffff */
lbl_8022EC50:
/* 8022EC50  C0 42 B0 5C */	lfs f2, lit_4026(r2)                     /* constant-address: 80454A5C, symbol: lit_4026 */
/* 8022EC54  C0 3F 00 44 */	lfs f1, 0x44(r31)                       
/* 8022EC58  C0 02 B0 64 */	lfs f0, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
...
/* 8022EC80  C8 22 B0 70 */	lfd f1, lit_4198(r2)                     /* constant-address: 80454A70, symbol: lit_4198 */
...
/* 8022ECAC  3C A0 80 3A */	lis r5, d_msg_d_msg_class__stringBase0@ha
/* 8022ECB0  38 A5 96 10 */	addi r5, r5, d_msg_d_msg_class__stringBase0@l /* constant-address: 80399610, symbol: d_msg_d_msg_class__stringBase0 */
/* 8022ECB4  38 A5 00 08 */	addi r5, r5, 8                           /* constant-address: 80399618, symbol: None */
/* 8022ECB8  4C C6 31 82 */	crclr 6                                 
/* 8022ECBC  48 13 79 01 */	bl snprintf                              /* constant-address: 803665BC, symbol: snprintf */
...
/* 8022ECD4  48 00 02 2D */	bl do_strcat__28jmessage_tRenderingProcessorFPcbbb /* constant-address: 8022EF00, symbol: do_strcat__28jmessage_tRenderingProcessorFPcbbb */
...
/* 8022ECFC  48 13 35 25 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

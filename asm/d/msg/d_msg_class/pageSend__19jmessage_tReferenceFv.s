...
/* 80229088  42 00 FF E8 */	bdnz lbl_80229070                        /* constant-address: 80229070, symbol: lbl_80229070 */
...
/* 802290B0  41 82 00 08 */	beq lbl_802290B8                         /* constant-address: 802290B8, symbol: lbl_802290B8 */
/* 802290B4  98 83 12 4A */	stb r4, 0x124a(r3)                      
lbl_802290B8:
/* 802290B8  88 03 12 51 */	lbz r0, 0x1251(r3)                      
/* 802290BC  98 03 12 52 */	stb r0, 0x1252(r3)                      
/* 802290C0  C0 62 B0 60 */	lfs f3, lit_4027(r2)                     /* constant-address: 80454A60, symbol: lit_4027 */
/* 802290C4  D0 63 04 64 */	stfs f3, 0x464(r3)                      
/* 802290C8  88 03 12 47 */	lbz r0, 0x1247(r3)                      
/* 802290CC  28 00 00 08 */	cmplwi r0, 8                            
/* 802290D0  40 82 00 44 */	bne lbl_80229114                         /* constant-address: 80229114, symbol: lbl_80229114 */
/* 802290D4  C0 42 B0 64 */	lfs f2, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
/* 802290D8  3C 80 80 43 */	lis r4, g_MsgObject_HIO_c@ha            
/* 802290DC  38 84 02 8C */	addi r4, r4, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 802290E0  A8 04 03 16 */	lha r0, 0x316(r4)                        /* constant-address: 804305A2, symbol: None */
/* 802290E4  C8 22 B0 70 */	lfd f1, lit_4198(r2)                     /* constant-address: 80454A70, symbol: lit_4198 */
...
/* 80229110  48 00 00 48 */	b lbl_80229158                           /* constant-address: 80229158, symbol: lbl_80229158 */
lbl_80229114:
/* 80229114  28 00 00 09 */	cmplwi r0, 9                            
/* 80229118  40 82 00 40 */	bne lbl_80229158                         /* constant-address: 80229158, symbol: lbl_80229158 */
/* 8022911C  C0 42 B0 64 */	lfs f2, lit_4028(r2)                     /* constant-address: 80454A64, symbol: lit_4028 */
/* 80229120  3C 80 80 43 */	lis r4, g_MsgObject_HIO_c@ha            
/* 80229124  38 84 02 8C */	addi r4, r4, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 80229128  A8 04 03 18 */	lha r0, 0x318(r4)                        /* constant-address: 804305A4, symbol: None */
/* 8022912C  C8 22 B0 70 */	lfd f1, lit_4198(r2)                     /* constant-address: 80454A70, symbol: lit_4198 */

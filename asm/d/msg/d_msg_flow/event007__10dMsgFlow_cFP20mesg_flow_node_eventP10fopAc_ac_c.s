...
/* 8024C6A4  4B FF EA 8D */	bl getParam__10dMsgFlow_cFPUc            /* constant-address: 8024B130, symbol: getParam__10dMsgFlow_cFPUc */
/* 8024C6A8  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha           
/* 8024C6AC  38 A4 61 C0 */	addi r5, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8024C6B0  A8 85 5D CC */	lha r4, 0x5dcc(r5)                       /* constant-address: 8040BF8C, symbol: None */
/* 8024C6B4  7C 03 00 D0 */	neg r0, r3                              
/* 8024C6B8  7C 00 07 34 */	extsh r0, r0                            
/* 8024C6BC  7C 04 02 14 */	add r0, r4, r0                          
/* 8024C6C0  B0 05 5D CC */	sth r0, 0x5dcc(r5)                       /* constant-address: 8040BF8C, symbol: None */

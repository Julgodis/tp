...
/* 8024D6E0  4B FF DA 11 */	bl getParam__10dMsgFlow_cFPUsPUsPUc      /* constant-address: 8024B0F0, symbol: getParam__10dMsgFlow_cFPUsPUsPUc */
...
/* 8024D6F4  40 82 00 74 */	bne lbl_8024D768                         /* constant-address: 8024D768, symbol: lbl_8024D768 */
/* 8024D6F8  A0 01 00 08 */	lhz r0, 8(r1)                           
/* 8024D6FC  28 00 00 00 */	cmplwi r0, 0                            
/* 8024D700  40 82 00 1C */	bne lbl_8024D71C                         /* constant-address: 8024D71C, symbol: lbl_8024D71C */
...
/* 8024D718  48 00 00 28 */	b lbl_8024D740                           /* constant-address: 8024D740, symbol: lbl_8024D740 */
lbl_8024D71C:
/* 8024D71C  88 0D 80 8C */	lbz r0, g_saftyWhiteColor(r13)           /* constant-address: 8045060C, symbol: g_saftyWhiteColor */
/* 8024D720  98 01 00 0C */	stb r0, 0xc(r1)                         
/* 8024D724  38 6D 80 8C */	la r3, g_saftyWhiteColor(r13) /* 8045060C-_SDA_BASE_ */ /* constant-address: 8045060C, symbol: g_saftyWhiteColor */
/* 8024D728  88 03 00 01 */	lbz r0, 1(r3)                            /* constant-address: 8045060D, symbol: None */
/* 8024D72C  98 01 00 0D */	stb r0, 0xd(r1)                         
/* 8024D730  88 03 00 02 */	lbz r0, 2(r3)                            /* constant-address: 8045060E, symbol: None */
/* 8024D734  98 01 00 0E */	stb r0, 0xe(r1)                         
/* 8024D738  88 03 00 03 */	lbz r0, 3(r3)                            /* constant-address: 8045060F, symbol: None */
/* 8024D73C  98 01 00 0F */	stb r0, 0xf(r1)                         
lbl_8024D740:
/* 8024D740  C0 42 B3 AC */	lfs f2, lit_6613(r2)                     /* constant-address: 80454DAC, symbol: lit_6613 */
/* 8024D744  C8 22 B3 90 */	lfd f1, lit_5116(r2)                     /* constant-address: 80454D90, symbol: lit_5116 */
...
/* 8024D764  4B DB A8 75 */	bl fadeOut__13mDoGph_gInf_cFfR8_GXColor  /* constant-address: 80007FD8, symbol: fadeOut__13mDoGph_gInf_cFfR8_GXColor */
lbl_8024D768:
/* 8024D768  38 7F 00 3C */	addi r3, r31, 0x3c                      
/* 8024D76C  48 00 03 45 */	bl func_8024DAB0                         /* constant-address: 8024DAB0, symbol: func_8024DAB0 */

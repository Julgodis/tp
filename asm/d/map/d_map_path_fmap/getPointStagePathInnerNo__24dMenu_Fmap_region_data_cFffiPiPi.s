...
/* 8003DBA8  48 32 45 F9 */	bl __save_gpr                            /* constant-address: 803621A0, symbol: __save_gpr */
...
/* 8003DBD8  C0 02 84 20 */	lfs f0, lit_3894(r2)                     /* constant-address: 80451E20, symbol: lit_3894 */
/* 8003DBDC  D0 01 00 30 */	stfs f0, 0x30(r1)                       
/* 8003DBE0  D0 01 00 24 */	stfs f0, 0x24(r1)                       
/* 8003DBE4  83 03 00 00 */	lwz r24, 0(r3)                          
/* 8003DBE8  48 00 02 7C */	b lbl_8003DE64                           /* constant-address: 8003DE64, symbol: lbl_8003DE64 */
lbl_8003DBEC:
/* 8003DBEC  80 78 00 08 */	lwz r3, 8(r24)                          
/* 8003DBF0  28 03 00 00 */	cmplwi r3, 0                            
/* 8003DBF4  41 82 02 68 */	beq lbl_8003DE5C                         /* constant-address: 8003DE5C, symbol: lbl_8003DE5C */
/* 8003DBF8  88 03 00 02 */	lbz r0, 2(r3)                           
/* 8003DBFC  90 01 00 38 */	stw r0, 0x38(r1)                        
/* 8003DC00  83 38 00 0C */	lwz r25, 0xc(r24)                       
/* 8003DC04  48 00 02 50 */	b lbl_8003DE54                           /* constant-address: 8003DE54, symbol: lbl_8003DE54 */
lbl_8003DC08:
/* 8003DC08  80 01 00 08 */	lwz r0, 8(r1)                           
/* 8003DC0C  7C 00 A8 00 */	cmpw r0, r21                            
/* 8003DC10  41 82 00 14 */	beq lbl_8003DC24                         /* constant-address: 8003DC24, symbol: lbl_8003DC24 */
/* 8003DC14  7F 03 C3 78 */	mr r3, r24                              
/* 8003DC18  4B FF FD 45 */	bl isArrival__23dMenu_Fmap_stage_data_cFv /* constant-address: 8003D95C, symbol: isArrival__23dMenu_Fmap_stage_data_cFv */
/* 8003DC1C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8003DC20  41 82 02 30 */	beq lbl_8003DE50                         /* constant-address: 8003DE50, symbol: lbl_8003DE50 */
lbl_8003DC24:
/* 8003DC24  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8003DC28  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8003DC2C  80 81 00 38 */	lwz r4, 0x38(r1)                        
/* 8003DC30  4B FF 74 79 */	bl getSave2__10dSv_save_cFi              /* constant-address: 800350A8, symbol: getSave2__10dSv_save_cFi */
/* 8003DC34  88 99 00 10 */	lbz r4, 0x10(r25)                       
/* 8003DC38  4B FF 6E B5 */	bl isVisitedRoom__13dSv_memory2_cFi      /* constant-address: 80034AEC, symbol: isVisitedRoom__13dSv_memory2_cFi */
/* 8003DC3C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8003DC40  41 82 02 10 */	beq lbl_8003DE50                         /* constant-address: 8003DE50, symbol: lbl_8003DE50 */
...
/* 8003DC64  41 82 01 EC */	beq lbl_8003DE50                         /* constant-address: 8003DE50, symbol: lbl_8003DE50 */
/* 8003DC68  80 63 00 08 */	lwz r3, 8(r3)                           
/* 8003DC6C  28 03 00 00 */	cmplwi r3, 0                            
/* 8003DC70  41 82 01 E0 */	beq lbl_8003DE50                         /* constant-address: 8003DE50, symbol: lbl_8003DE50 */
/* 8003DC74  83 63 00 04 */	lwz r27, 4(r3)                          
/* 8003DC78  83 43 00 08 */	lwz r26, 8(r3)                          
/* 8003DC7C  28 1B 00 00 */	cmplwi r27, 0                           
/* 8003DC80  41 82 01 D0 */	beq lbl_8003DE50                         /* constant-address: 8003DE50, symbol: lbl_8003DE50 */
...
/* 8003DCAC  48 00 01 90 */	b lbl_8003DE3C                           /* constant-address: 8003DE3C, symbol: lbl_8003DE3C */
lbl_8003DCB0:
...
/* 8003DCC0  41 82 01 74 */	beq lbl_8003DE34                         /* constant-address: 8003DE34, symbol: lbl_8003DE34 */
/* 8003DCC4  3A 20 00 00 */	li r17, 0                               
/* 8003DCC8  48 00 01 58 */	b lbl_8003DE20                           /* constant-address: 8003DE20, symbol: lbl_8003DE20 */
lbl_8003DCCC:
/* 8003DCCC  89 DC 00 02 */	lbz r14, 2(r28)                         
/* 8003DCD0  2C 0E 00 00 */	cmpwi r14, 0                            
/* 8003DCD4  40 81 01 44 */	ble lbl_8003DE18                         /* constant-address: 8003DE18, symbol: lbl_8003DE18 */
/* 8003DCD8  83 BC 00 08 */	lwz r29, 8(r28)                         
/* 8003DCDC  28 1D 00 00 */	cmplwi r29, 0                           
/* 8003DCE0  41 82 01 38 */	beq lbl_8003DE18                         /* constant-address: 8003DE18, symbol: lbl_8003DE18 */
/* 8003DCE4  3A 00 00 00 */	li r16, 0                               
/* 8003DCE8  48 00 01 20 */	b lbl_8003DE08                           /* constant-address: 8003DE08, symbol: lbl_8003DE08 */
lbl_8003DCEC:
/* 8003DCEC  88 1D 00 01 */	lbz r0, 1(r29)                          
/* 8003DCF0  28 00 00 03 */	cmplwi r0, 3                            
/* 8003DCF4  40 82 01 0C */	bne lbl_8003DE00                         /* constant-address: 8003DE00, symbol: lbl_8003DE00 */
/* 8003DCF8  8A FD 00 02 */	lbz r23, 2(r29)                         
/* 8003DCFC  2C 17 00 03 */	cmpwi r23, 3                            
/* 8003DD00  41 80 01 00 */	blt lbl_8003DE00                         /* constant-address: 8003DE00, symbol: lbl_8003DE00 */
...
/* 8003DD28  C3 82 84 20 */	lfs f28, lit_3894(r2)                    /* constant-address: 80451E20, symbol: lit_3894 */
...
/* 8003DD84  48 30 94 31 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
...
/* 8003DD98  40 82 00 0C */	bne lbl_8003DDA4                         /* constant-address: 8003DDA4, symbol: lbl_8003DDA4 */
/* 8003DD9C  38 60 00 00 */	li r3, 0                                
/* 8003DDA0  48 00 00 08 */	b lbl_8003DDA8                           /* constant-address: 8003DDA8, symbol: lbl_8003DDA8 */
lbl_8003DDA4:
/* 8003DDA4  38 60 FF FF */	li r3, -1                               
lbl_8003DDA8:
/* 8003DDA8  2C 16 00 02 */	cmpwi r22, 2                            
/* 8003DDAC  40 81 00 18 */	ble lbl_8003DDC4                         /* constant-address: 8003DDC4, symbol: lbl_8003DDC4 */
/* 8003DDB0  80 01 00 40 */	lwz r0, 0x40(r1)                        
/* 8003DDB4  7C 03 00 00 */	cmpw r3, r0                             
/* 8003DDB8  41 82 00 0C */	beq lbl_8003DDC4                         /* constant-address: 8003DDC4, symbol: lbl_8003DDC4 */
/* 8003DDBC  3A 80 00 01 */	li r20, 1                               
/* 8003DDC0  48 00 00 28 */	b lbl_8003DDE8                           /* constant-address: 8003DDE8, symbol: lbl_8003DDE8 */
lbl_8003DDC4:
...
/* 8003DDD8  3A D6 00 01 */	addi r22, r22, 1                         /* constant-address: 00000003 */
/* 8003DDDC  7C 16 B8 00 */	cmpw r22, r23                           
/* 8003DDE0  3B DE 00 02 */	addi r30, r30, 2                        
/* 8003DDE4  40 81 FF 4C */	ble lbl_8003DD30                         /* constant-address: 8003DD30, symbol: lbl_8003DD30 */
lbl_8003DDE8:
/* 8003DDE8  56 80 06 3F */	clrlwi. r0, r20, 0x18                   
/* 8003DDEC  40 82 00 14 */	bne lbl_8003DE00                         /* constant-address: 8003DE00, symbol: lbl_8003DE00 */
...
lbl_8003DE00:
/* 8003DE00  3A 10 00 01 */	addi r16, r16, 1                         /* constant-address: 00000001 */
/* 8003DE04  3B BD 00 08 */	addi r29, r29, 8                        
lbl_8003DE08:
/* 8003DE08  56 60 06 3F */	clrlwi. r0, r19, 0x18                   
/* 8003DE0C  40 82 00 0C */	bne lbl_8003DE18                         /* constant-address: 8003DE18, symbol: lbl_8003DE18 */
/* 8003DE10  7C 10 70 00 */	cmpw r16, r14                           
/* 8003DE14  41 80 FE D8 */	blt lbl_8003DCEC                         /* constant-address: 8003DCEC, symbol: lbl_8003DCEC */
lbl_8003DE18:
/* 8003DE18  3A 31 00 01 */	addi r17, r17, 1                         /* constant-address: 00000001 */
/* 8003DE1C  3B 9C 00 14 */	addi r28, r28, 0x14                     
lbl_8003DE20:
/* 8003DE20  56 60 06 3F */	clrlwi. r0, r19, 0x18                   
/* 8003DE24  40 82 00 10 */	bne lbl_8003DE34                         /* constant-address: 8003DE34, symbol: lbl_8003DE34 */
/* 8003DE28  80 01 00 4C */	lwz r0, 0x4c(r1)                        
/* 8003DE2C  7C 11 00 00 */	cmpw r17, r0                            
/* 8003DE30  41 80 FE 9C */	blt lbl_8003DCCC                         /* constant-address: 8003DCCC, symbol: lbl_8003DCCC */
lbl_8003DE34:
/* 8003DE34  3A 52 00 01 */	addi r18, r18, 1                         /* constant-address: 00000001 */
/* 8003DE38  3B 7B 00 08 */	addi r27, r27, 8                        
lbl_8003DE3C:
/* 8003DE3C  56 60 06 3F */	clrlwi. r0, r19, 0x18                   
/* 8003DE40  40 82 00 10 */	bne lbl_8003DE50                         /* constant-address: 8003DE50, symbol: lbl_8003DE50 */
/* 8003DE44  80 01 00 48 */	lwz r0, 0x48(r1)                        
/* 8003DE48  7C 12 00 00 */	cmpw r18, r0                            
/* 8003DE4C  41 80 FE 64 */	blt lbl_8003DCB0                         /* constant-address: 8003DCB0, symbol: lbl_8003DCB0 */
lbl_8003DE50:
/* 8003DE50  83 39 00 08 */	lwz r25, 8(r25)                         
lbl_8003DE54:
/* 8003DE54  28 19 00 00 */	cmplwi r25, 0                           
/* 8003DE58  40 82 FD B0 */	bne lbl_8003DC08                         /* constant-address: 8003DC08, symbol: lbl_8003DC08 */
lbl_8003DE5C:
/* 8003DE5C  83 18 00 10 */	lwz r24, 0x10(r24)                      
/* 8003DE60  3A B5 00 01 */	addi r21, r21, 1                         /* constant-address: 00000001 */
lbl_8003DE64:
/* 8003DE64  28 18 00 00 */	cmplwi r24, 0                           
/* 8003DE68  40 82 FD 84 */	bne lbl_8003DBEC                         /* constant-address: 8003DBEC, symbol: lbl_8003DBEC */
/* 8003DE6C  80 01 00 0C */	lwz r0, 0xc(r1)                         
/* 8003DE70  28 00 00 00 */	cmplwi r0, 0                            
/* 8003DE74  41 82 00 10 */	beq lbl_8003DE84                         /* constant-address: 8003DE84, symbol: lbl_8003DE84 */
...
/* 8003DE8C  41 82 00 10 */	beq lbl_8003DE9C                         /* constant-address: 8003DE9C, symbol: lbl_8003DE9C */
...
/* 8003DECC  48 32 43 21 */	bl __restore_gpr                         /* constant-address: 803621EC, symbol: __restore_gpr */

...
/* 8003E3FC  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8003E400  38 84 4E 00 */	addi r4, r4, 0x4e00                      /* constant-address: 8040AFC0, symbol: None */
/* 8003E404  48 32 A5 91 */	bl strcmp                                /* constant-address: 80368994, symbol: strcmp */
/* 8003E408  2C 03 00 00 */	cmpwi r3, 0                             
/* 8003E40C  40 82 00 30 */	bne lbl_8003E43C                         /* constant-address: 8003E43C, symbol: lbl_8003E43C */
/* 8003E410  80 7E 00 28 */	lwz r3, 0x28(r30)                       
/* 8003E414  28 03 00 00 */	cmplwi r3, 0                            
/* 8003E418  41 82 00 5C */	beq lbl_8003E474                         /* constant-address: 8003E474, symbol: lbl_8003E474 */
/* 8003E41C  48 05 DF 81 */	bl getNextData__7dTres_cFPQ27dTres_c15typeGroupData_c /* constant-address: 8009C39C, symbol: getNextData__7dTres_cFPQ27dTres_c15typeGroupData_c */
/* 8003E420  90 7E 00 28 */	stw r3, 0x28(r30)                       
/* 8003E424  80 1E 00 28 */	lwz r0, 0x28(r30)                       
/* 8003E428  28 00 00 00 */	cmplwi r0, 0                            
/* 8003E42C  41 82 00 48 */	beq lbl_8003E474                         /* constant-address: 8003E474, symbol: lbl_8003E474 */
/* 8003E430  90 1E 00 2C */	stw r0, 0x2c(r30)                       
/* 8003E434  3B E0 00 00 */	li r31, 0                               
/* 8003E438  48 00 00 3C */	b lbl_8003E474                           /* constant-address: 8003E474, symbol: lbl_8003E474 */
lbl_8003E43C:
/* 8003E43C  80 7E 00 24 */	lwz r3, 0x24(r30)                       
/* 8003E440  28 03 00 00 */	cmplwi r3, 0                            
/* 8003E444  41 82 00 30 */	beq lbl_8003E474                         /* constant-address: 8003E474, symbol: lbl_8003E474 */
...
/* 8003E458  41 82 00 1C */	beq lbl_8003E474                         /* constant-address: 8003E474, symbol: lbl_8003E474 */
...
/* 8003E46C  41 82 00 08 */	beq lbl_8003E474                         /* constant-address: 8003E474, symbol: lbl_8003E474 */

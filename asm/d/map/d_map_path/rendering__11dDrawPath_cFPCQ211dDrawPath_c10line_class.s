...
/* 8003C980  41 82 00 A8 */	beq lbl_8003CA28                         /* constant-address: 8003CA28, symbol: lbl_8003CA28 */
...
/* 8003C9A0  40 81 00 88 */	ble lbl_8003CA28                         /* constant-address: 8003CA28, symbol: lbl_8003CA28 */
/* 8003C9A4  88 1F 00 02 */	lbz r0, 2(r31)                          
/* 8003C9A8  28 00 00 02 */	cmplwi r0, 2                            
/* 8003C9AC  41 80 00 7C */	blt lbl_8003CA28                         /* constant-address: 8003CA28, symbol: lbl_8003CA28 */
/* 8003C9B0  54 63 06 3E */	clrlwi r3, r3, 0x18                     
/* 8003C9B4  38 80 00 00 */	li r4, 0                                
/* 8003C9B8  48 31 FF 05 */	bl GXSetLineWidth                        /* constant-address: 8035C8BC, symbol: GXSetLineWidth */
...
/* 8003C9EC  48 32 29 91 */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
/* 8003C9F0  38 60 00 B0 */	li r3, 0xb0                             
/* 8003C9F4  38 80 00 00 */	li r4, 0                                
/* 8003C9F8  88 BF 00 02 */	lbz r5, 2(r31)                          
/* 8003C9FC  48 31 FD 69 */	bl GXBegin                               /* constant-address: 8035C764, symbol: GXBegin */
...
/* 8003CA14  40 81 00 14 */	ble lbl_8003CA28                         /* constant-address: 8003CA28, symbol: lbl_8003CA28 */
lbl_8003CA18:
/* 8003CA18  A0 04 00 00 */	lhz r0, 0(r4)                           
/* 8003CA1C  B0 03 80 00 */	sth r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 8003CA20  38 84 00 02 */	addi r4, r4, 2                          
/* 8003CA24  42 00 FF F4 */	bdnz lbl_8003CA18                        /* constant-address: 8003CA18, symbol: lbl_8003CA18 */
lbl_8003CA28:

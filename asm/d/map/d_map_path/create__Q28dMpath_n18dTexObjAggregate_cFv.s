...
/* 8003C86C  48 32 59 65 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8003C880  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8003C884  3F 83 00 02 */	addis r28, r3, 2                        
/* 8003C888  3C 60 80 38 */	lis r3, d_map_d_map_path__stringBase0@ha
/* 8003C88C  3B A3 9C 4C */	addi r29, r3, d_map_d_map_path__stringBase0@l /* constant-address: 80379C4C, symbol: d_map_d_map_path__stringBase0 */
/* 8003C890  3C 60 80 38 */	lis r3, data_80379C30@ha                
/* 8003C894  3B C3 9C 30 */	addi r30, r3, data_80379C30@l            /* constant-address: 80379C30, symbol: data_80379C30 */
/* 8003C898  3B 9C C2 F8 */	addi r28, r28, -15624                   
lbl_8003C89C:
/* 8003C89C  38 60 00 20 */	li r3, 0x20                             
/* 8003C8A0  48 29 23 AD */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
...
/* 8003C8B8  4B FF FA 35 */	bl getRes__14dRes_control_cFPCclP11dRes_info_ci /* constant-address: 8003C2EC, symbol: getRes__14dRes_control_cFPCclP11dRes_info_ci */
/* 8003C8BC  7C 9A F8 2E */	lwzx r4, r26, r31                       
/* 8003C8C0  38 A0 00 00 */	li r5, 0                                
/* 8003C8C4  38 C0 00 00 */	li r6, 0                                
/* 8003C8C8  4B FD 88 75 */	bl mDoLib_setResTimgObj__FPC7ResTIMGP9_GXTexObjUlP10_GXTlutObj /* constant-address: 8001513C, symbol: mDoLib_setResTimgObj__FPC7ResTIMGP9_GXTexObjUlP10_GXTlutObj */
/* 8003C8CC  3B 7B 00 01 */	addi r27, r27, 1                        
/* 8003C8D0  2C 1B 00 07 */	cmpwi r27, 7                            
/* 8003C8D4  3B FF 00 04 */	addi r31, r31, 4                        
/* 8003C8D8  41 80 FF C4 */	blt lbl_8003C89C                         /* constant-address: 8003C89C, symbol: lbl_8003C89C */
/* 8003C8DC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8003C8E0  48 32 59 3D */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

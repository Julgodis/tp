...
/* 80041240  48 31 B5 25 */	bl GXBegin                               /* constant-address: 8035C764, symbol: GXBegin */
/* 80041244  38 C0 00 00 */	li r6, 0                                
/* 80041248  C0 5F 00 08 */	lfs f2, 8(r31)                          
/* 8004124C  3C 60 80 38 */	lis r3, data_80379D3C@ha                
/* 80041250  38 83 9D 3C */	addi r4, r3, data_80379D3C@l             /* constant-address: 80379D3C, symbol: data_80379D3C */
/* 80041254  C0 3F 00 00 */	lfs f1, 0(r31)                          
/* 80041258  3C 60 CC 01 */	lis r3, 0xcc01                          
/* 8004125C  48 00 00 34 */	b lbl_80041290                           /* constant-address: 80041290, symbol: lbl_80041290 */
lbl_80041260:
...
/* 80041280  D0 03 80 00 */	stfs f0, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80041284  D0 63 80 00 */	stfs f3, -0x8000(r3)                     /* constant-address: CC008000 */
/* 80041288  98 C3 80 00 */	stb r6, -0x8000(r3)                      /* constant-address: CC008000 */
/* 8004128C  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
lbl_80041290:
/* 80041290  54 C0 06 3E */	clrlwi r0, r6, 0x18                     
/* 80041294  28 00 00 04 */	cmplwi r0, 4                            
/* 80041298  41 80 FF C8 */	blt lbl_80041260                         /* constant-address: 80041260, symbol: lbl_80041260 */

...
/* 8003EE78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8003EE7C  80 63 5D AC */	lwz r3, 0x5dac(r3)                       /* constant-address: 8040BF6C, symbol: None */
/* 8003EE80  28 03 00 00 */	cmplwi r3, 0                            
/* 8003EE84  41 82 00 20 */	beq lbl_8003EEA4                         /* constant-address: 8003EEA4, symbol: lbl_8003EEA4 */
...
/* 8003EEA0  48 00 00 14 */	b lbl_8003EEB4                           /* constant-address: 8003EEB4, symbol: lbl_8003EEB4 */
lbl_8003EEA4:
/* 8003EEA4  C0 02 84 28 */	lfs f0, lit_3796(r2)                     /* constant-address: 80451E28, symbol: lit_3796 */
/* 8003EEA8  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 8003EEAC  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 8003EEB0  D0 01 00 10 */	stfs f0, 0x10(r1)                       
lbl_8003EEB4:
/* 8003EEB4  88 0D 87 E4 */	lbz r0, struct_80450D64+0x0(r13)         /* constant-address: 80450D64, symbol: struct_80450D64+0x0 */
/* 8003EEB8  7C 00 07 74 */	extsb r0, r0                            
/* 8003EEBC  3C 60 80 3F */	lis r3, mStatus__20dStage_roomControl_c@ha
/* 8003EEC0  38 63 60 94 */	addi r3, r3, mStatus__20dStage_roomControl_c@l /* constant-address: 803F6094, symbol: mStatus__20dStage_roomControl_c */
...
/* 8003EED4  41 82 00 1C */	beq lbl_8003EEF0                         /* constant-address: 8003EEF0, symbol: lbl_8003EEF0 */
/* 8003EED8  7F E3 FB 78 */	mr r3, r31                              
/* 8003EEDC  38 81 00 08 */	addi r4, r1, 8                          
/* 8003EEE0  4B FF FF 0D */	bl rotAngle__10dMapInfo_nFPC21dStage_FileList2_dt_cP3Vec /* constant-address: 8003EDEC, symbol: rotAngle__10dMapInfo_nFPC21dStage_FileList2_dt_cP3Vec */
/* 8003EEE4  7F E3 FB 78 */	mr r3, r31                              
/* 8003EEE8  38 81 00 08 */	addi r4, r1, 8                          
/* 8003EEEC  4B FF FE D5 */	bl offsetPlus__10dMapInfo_nFPC21dStage_FileList2_dt_cP3Vec /* constant-address: 8003EDC0, symbol: offsetPlus__10dMapInfo_nFPC21dStage_FileList2_dt_cP3Vec */
lbl_8003EEF0:

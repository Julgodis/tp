...
/* 8003F448  4B FF FE 05 */	bl getFloorParameter__10dMapInfo_nFfPScPfPfPfPf /* constant-address: 8003F24C, symbol: getFloorParameter__10dMapInfo_nFfPScPfPfPfPf */
/* 8003F44C  C0 01 00 10 */	lfs f0, 0x10(r1)                        
/* 8003F450  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8003F454  40 80 00 80 */	bge lbl_8003F4D4                         /* constant-address: 8003F4D4, symbol: lbl_8003F4D4 */
/* 8003F458  C0 41 00 0C */	lfs f2, 0xc(r1)                         
/* 8003F45C  FC 1F 10 40 */	fcmpo cr0, f31, f2                      
/* 8003F460  4C 41 13 82 */	cror 2, 1, 2                            
/* 8003F464  40 82 00 7C */	bne lbl_8003F4E0                         /* constant-address: 8003F4E0, symbol: lbl_8003F4E0 */
/* 8003F468  80 0D 88 DC */	lwz r0, mNowStayRoomNo__10dMapInfo_c(r13) /* constant-address: 80450E5C, symbol: mNowStayRoomNo__10dMapInfo_c */
/* 8003F46C  7C 1F 00 00 */	cmpw r31, r0                            
/* 8003F470  40 82 00 3C */	bne lbl_8003F4AC                         /* constant-address: 8003F4AC, symbol: lbl_8003F4AC */
/* 8003F474  88 0D 88 E0 */	lbz r0, data_80450E60(r13)               /* constant-address: 80450E60, symbol: data_80450E60 */
/* 8003F478  28 00 00 00 */	cmplwi r0, 0                            
/* 8003F47C  41 82 00 30 */	beq lbl_8003F4AC                         /* constant-address: 8003F4AC, symbol: lbl_8003F4AC */
/* 8003F480  88 AD 88 D8 */	lbz r5, data_80450E58(r13)               /* constant-address: 80450E58, symbol: data_80450E58 */
...
/* 8003F494  41 82 00 10 */	beq lbl_8003F4A4                         /* constant-address: 8003F4A4, symbol: lbl_8003F4A4 */
/* 8003F498  38 03 00 01 */	addi r0, r3, 1                          
/* 8003F49C  7C 04 00 00 */	cmpw r4, r0                             
/* 8003F4A0  40 82 00 0C */	bne lbl_8003F4AC                         /* constant-address: 8003F4AC, symbol: lbl_8003F4AC */
lbl_8003F4A4:
/* 8003F4A4  98 A1 00 08 */	stb r5, 8(r1)                           
/* 8003F4A8  48 00 00 38 */	b lbl_8003F4E0                           /* constant-address: 8003F4E0, symbol: lbl_8003F4E0 */
lbl_8003F4AC:
/* 8003F4AC  C0 22 84 2C */	lfs f1, lit_3887(r2)                     /* constant-address: 80451E2C, symbol: lit_3887 */
...
/* 8003F4C0  40 82 00 20 */	bne lbl_8003F4E0                         /* constant-address: 8003F4E0, symbol: lbl_8003F4E0 */
/* 8003F4C4  88 61 00 08 */	lbz r3, 8(r1)                           
/* 8003F4C8  38 03 00 01 */	addi r0, r3, 1                          
/* 8003F4CC  98 01 00 08 */	stb r0, 8(r1)                           
/* 8003F4D0  48 00 00 10 */	b lbl_8003F4E0                           /* constant-address: 8003F4E0, symbol: lbl_8003F4E0 */
lbl_8003F4D4:
...
/* 8003F4E4  41 82 00 68 */	beq lbl_8003F54C                         /* constant-address: 8003F54C, symbol: lbl_8003F54C */
/* 8003F4E8  2C 1F 00 00 */	cmpwi r31, 0                            
/* 8003F4EC  41 80 00 60 */	blt lbl_8003F54C                         /* constant-address: 8003F54C, symbol: lbl_8003F54C */
/* 8003F4F0  2C 1F 00 40 */	cmpwi r31, 0x40                         
/* 8003F4F4  40 80 00 58 */	bge lbl_8003F54C                         /* constant-address: 8003F54C, symbol: lbl_8003F54C */
/* 8003F4F8  3C 60 80 3F */	lis r3, mStatus__20dStage_roomControl_c@ha
/* 8003F4FC  38 63 60 94 */	addi r3, r3, mStatus__20dStage_roomControl_c@l /* constant-address: 803F6094, symbol: mStatus__20dStage_roomControl_c */
...
/* 8003F510  41 82 00 3C */	beq lbl_8003F54C                         /* constant-address: 8003F54C, symbol: lbl_8003F54C */
...
/* 8003F530  40 80 00 08 */	bge lbl_8003F538                         /* constant-address: 8003F538, symbol: lbl_8003F538 */
...
/* 8003F544  40 81 00 08 */	ble lbl_8003F54C                         /* constant-address: 8003F54C, symbol: lbl_8003F54C */

...
/* 800412E0  48 32 0E F5 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 800412E4  7C BC 2B 78 */	mr r28, r5                              
/* 800412E8  7C DB 33 78 */	mr r27, r6                              
/* 800412EC  C0 02 84 B8 */	lfs f0, lit_4731(r2)                     /* constant-address: 80451EB8, symbol: lit_4731 */
/* 800412F0  EC 61 00 24 */	fdivs f3, f1, f0                        
/* 800412F4  C0 23 00 08 */	lfs f1, 8(r3)                           
/* 800412F8  A0 03 00 20 */	lhz r0, 0x20(r3)                        
/* 800412FC  C8 42 84 40 */	lfd f2, lit_4211(r2)                     /* constant-address: 80451E40, symbol: lit_4211 */
...
/* 80041340  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 80041344  C0 24 00 00 */	lfs f1, 0(r4)                           
/* 80041348  C0 42 84 28 */	lfs f2, lit_3796(r2)                     /* constant-address: 80451E28, symbol: lit_3796 */
/* 8004134C  C0 64 00 08 */	lfs f3, 8(r4)                           
/* 80041350  48 30 55 99 */	bl PSMTXTrans                            /* constant-address: 803468E8, symbol: PSMTXTrans */
/* 80041354  FC 20 F8 90 */	fmr f1, f31                             
/* 80041358  C0 42 84 38 */	lfs f2, lit_4202(r2)                     /* constant-address: 80451E38, symbol: lit_4202 */
/* 8004135C  FC 60 F0 90 */	fmr f3, f30                             
/* 80041360  4B FC BA D9 */	bl scaleM__14mDoMtx_stack_cFfff          /* constant-address: 8000CE38, symbol: scaleM__14mDoMtx_stack_cFfff */
/* 80041364  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 80041368  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8004136C  7F 84 E3 78 */	mr r4, r28                              
/* 80041370  4B FC B0 C5 */	bl mDoMtx_YrotM__FPA4_fs                 /* constant-address: 8000C434, symbol: mDoMtx_YrotM__FPA4_fs */
/* 80041374  3B 80 00 00 */	li r28, 0                               
/* 80041378  3B E0 00 00 */	li r31, 0                               
/* 8004137C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 80041380  3B A3 D4 70 */	addi r29, r3, now__14mDoMtx_stack_c@l    /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 80041384  3C 60 80 38 */	lis r3, data_80379D5C@ha                
/* 80041388  3B C3 9D 5C */	addi r30, r3, data_80379D5C@l            /* constant-address: 80379D5C, symbol: data_80379D5C */
lbl_8004138C:
...
/* 8004139C  48 30 59 D1 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800413A0  3B 9C 00 01 */	addi r28, r28, 1                        
/* 800413A4  2C 1C 00 03 */	cmpwi r28, 3                            
/* 800413A8  3B FF 00 0C */	addi r31, r31, 0xc                      
/* 800413AC  41 80 FF E0 */	blt lbl_8004138C                         /* constant-address: 8004138C, symbol: lbl_8004138C */
/* 800413B0  48 31 A1 DD */	bl GXClearVtxDesc                        /* constant-address: 8035B58C, symbol: GXClearVtxDesc */
/* 800413B4  38 60 00 09 */	li r3, 9                                
/* 800413B8  38 80 00 01 */	li r4, 1                                
/* 800413BC  48 31 9A FD */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
...
/* 800413D4  48 31 A1 F1 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
/* 800413D8  57 60 16 3A */	rlwinm r0, r27, 2, 0x18, 0x1d           
/* 800413DC  98 0D 80 B8 */	stb r0, data_80450638(r13)               /* constant-address: 80450638, symbol: data_80450638 */
/* 800413E0  80 0D 80 B8 */	lwz r0, data_80450638(r13)               /* constant-address: 80450638, symbol: data_80450638 */
/* 800413E4  90 01 00 08 */	stw r0, 8(r1)                           
/* 800413E8  38 60 00 01 */	li r3, 1                                
/* 800413EC  38 81 00 08 */	addi r4, r1, 8                          
/* 800413F0  48 31 DF 8D */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
/* 800413F4  38 60 00 90 */	li r3, 0x90                             
/* 800413F8  38 80 00 00 */	li r4, 0                                
/* 800413FC  38 A0 00 03 */	li r5, 3                                
/* 80041400  48 31 B3 65 */	bl GXBegin                               /* constant-address: 8035C764, symbol: GXBegin */
...
/* 80041420  D0 04 80 00 */	stfs f0, 0x8000(r4)                      /* constant-address: CC008000 */
/* 80041424  C0 05 00 08 */	lfs f0, 8(r5)                           
/* 80041428  D0 04 80 00 */	stfs f0, -0x8000(r4)                     /* constant-address: CC008000 */
/* 8004142C  38 63 00 0C */	addi r3, r3, 0xc                        
/* 80041430  42 00 FF E4 */	bdnz lbl_80041414                        /* constant-address: 80041414, symbol: lbl_80041414 */
...
/* 80041448  48 32 0D D9 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

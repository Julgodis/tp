...
/* 8003FF30  C0 02 84 4C */	lfs f0, lit_4264(r2)                     /* constant-address: 80451E4C, symbol: lit_4264 */
/* 8003FF34  D0 01 00 28 */	stfs f0, 0x28(r1)                       
/* 8003FF38  D0 41 00 14 */	stfs f2, 0x14(r1)                       
/* 8003FF3C  D0 21 00 18 */	stfs f1, 0x18(r1)                       
/* 8003FF40  C0 02 84 50 */	lfs f0, lit_4265(r2)                     /* constant-address: 80451E50, symbol: lit_4265 */
/* 8003FF44  D0 01 00 1C */	stfs f0, 0x1c(r1)                       
/* 8003FF48  C0 22 84 28 */	lfs f1, lit_3796(r2)                     /* constant-address: 80451E28, symbol: lit_3796 */
/* 8003FF4C  D0 21 00 08 */	stfs f1, 8(r1)                          
/* 8003FF50  C0 02 84 54 */	lfs f0, lit_4266(r2)                     /* constant-address: 80451E54, symbol: lit_4266 */
...
/* 8003FF70  4B FC C7 A1 */	bl mDoMtx_lookAt__FPA4_fPC3VecPC3VecPC3Vecs /* constant-address: 8000C710, symbol: mDoMtx_lookAt__FPA4_fPC3VecPC3VecPC3Vecs */
/* 8003FF74  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 8003FF78  38 80 00 00 */	li r4, 0                                
/* 8003FF7C  48 32 02 D1 */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
/* 8003FF80  48 31 B6 0D */	bl GXClearVtxDesc                        /* constant-address: 8035B58C, symbol: GXClearVtxDesc */
/* 8003FF84  38 60 00 09 */	li r3, 9                                
/* 8003FF88  38 80 00 03 */	li r4, 3                                
/* 8003FF8C  48 31 AF 2D */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
...
/* 8003FFA4  48 31 B6 21 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
/* 8003FFA8  38 60 00 01 */	li r3, 1                                
/* 8003FFAC  38 80 00 08 */	li r4, 8                                
/* 8003FFB0  48 31 BE 89 */	bl GXSetMisc                             /* constant-address: 8035BE38, symbol: GXSetMisc */

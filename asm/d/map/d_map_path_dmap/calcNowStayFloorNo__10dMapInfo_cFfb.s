...
/* 8003F5A4  4B FF FC A9 */	bl getFloorParameter__10dMapInfo_nFfPScPfPfPfPf /* constant-address: 8003F24C, symbol: getFloorParameter__10dMapInfo_nFfPScPfPfPfPf */
/* 8003F5A8  88 0D 88 E0 */	lbz r0, data_80450E60(r13)               /* constant-address: 80450E60, symbol: data_80450E60 */
/* 8003F5AC  28 00 00 00 */	cmplwi r0, 0                            
/* 8003F5B0  41 82 00 5C */	beq lbl_8003F60C                         /* constant-address: 8003F60C, symbol: lbl_8003F60C */
/* 8003F5B4  C0 01 00 10 */	lfs f0, 0x10(r1)                        
/* 8003F5B8  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8003F5BC  40 80 00 40 */	bge lbl_8003F5FC                         /* constant-address: 8003F5FC, symbol: lbl_8003F5FC */
/* 8003F5C0  C0 01 00 0C */	lfs f0, 0xc(r1)                         
/* 8003F5C4  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8003F5C8  4C 41 13 82 */	cror 2, 1, 2                            
/* 8003F5CC  40 82 00 6C */	bne lbl_8003F638                         /* constant-address: 8003F638, symbol: lbl_8003F638 */
/* 8003F5D0  88 AD 88 D8 */	lbz r5, data_80450E58(r13)               /* constant-address: 80450E58, symbol: data_80450E58 */
...
/* 8003F5E4  41 82 00 10 */	beq lbl_8003F5F4                         /* constant-address: 8003F5F4, symbol: lbl_8003F5F4 */
/* 8003F5E8  38 03 00 01 */	addi r0, r3, 1                          
/* 8003F5EC  7C 04 00 00 */	cmpw r4, r0                             
/* 8003F5F0  40 82 00 48 */	bne lbl_8003F638                         /* constant-address: 8003F638, symbol: lbl_8003F638 */
lbl_8003F5F4:
/* 8003F5F4  98 A1 00 08 */	stb r5, 8(r1)                           
/* 8003F5F8  48 00 00 40 */	b lbl_8003F638                           /* constant-address: 8003F638, symbol: lbl_8003F638 */
lbl_8003F5FC:
/* 8003F5FC  88 61 00 08 */	lbz r3, 8(r1)                           
/* 8003F600  38 03 00 01 */	addi r0, r3, 1                          
/* 8003F604  98 01 00 08 */	stb r0, 8(r1)                           
/* 8003F608  48 00 00 30 */	b lbl_8003F638                           /* constant-address: 8003F638, symbol: lbl_8003F638 */
lbl_8003F60C:
/* 8003F60C  C0 42 84 2C */	lfs f2, lit_3887(r2)                     /* constant-address: 80451E2C, symbol: lit_3887 */
...
/* 8003F628  40 82 00 10 */	bne lbl_8003F638                         /* constant-address: 8003F638, symbol: lbl_8003F638 */
...
/* 8003F63C  41 82 00 6C */	beq lbl_8003F6A8                         /* constant-address: 8003F6A8, symbol: lbl_8003F6A8 */
/* 8003F640  80 0D 88 DC */	lwz r0, mNowStayRoomNo__10dMapInfo_c(r13) /* constant-address: 80450E5C, symbol: mNowStayRoomNo__10dMapInfo_c */
/* 8003F644  2C 00 00 00 */	cmpwi r0, 0                             
/* 8003F648  41 80 00 60 */	blt lbl_8003F6A8                         /* constant-address: 8003F6A8, symbol: lbl_8003F6A8 */
/* 8003F64C  2C 00 00 40 */	cmpwi r0, 0x40                          
/* 8003F650  40 80 00 58 */	bge lbl_8003F6A8                         /* constant-address: 8003F6A8, symbol: lbl_8003F6A8 */
/* 8003F654  3C 60 80 3F */	lis r3, mStatus__20dStage_roomControl_c@ha
/* 8003F658  38 63 60 94 */	addi r3, r3, mStatus__20dStage_roomControl_c@l /* constant-address: 803F6094, symbol: mStatus__20dStage_roomControl_c */
...
/* 8003F66C  41 82 00 3C */	beq lbl_8003F6A8                         /* constant-address: 8003F6A8, symbol: lbl_8003F6A8 */
...
/* 8003F68C  40 80 00 08 */	bge lbl_8003F694                         /* constant-address: 8003F694, symbol: lbl_8003F694 */
...
/* 8003F6A0  40 81 00 08 */	ble lbl_8003F6A8                         /* constant-address: 8003F6A8, symbol: lbl_8003F6A8 */

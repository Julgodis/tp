...
/* 800284E4  80 8D 88 00 */	lwz r4, m_res__22dMap_HIO_prm_res_dst_s(r13) /* constant-address: 80450D80, symbol: m_res__22dMap_HIO_prm_res_dst_s */
/* 800284E8  A8 C4 01 AA */	lha r6, 0x1aa(r4)                       
/* 800284EC  3C A0 80 43 */	lis r5, g_Counter@ha                    
/* 800284F0  38 A5 0C D8 */	addi r5, r5, g_Counter@l                 /* constant-address: 80430CD8, symbol: g_Counter */
/* 800284F4  80 A5 00 00 */	lwz r5, 0(r5)                            /* constant-address: 80430CD8, symbol: g_Counter */
/* 800284F8  7C 05 33 96 */	divwu r0, r5, r6                        
/* 800284FC  7C 00 31 D6 */	mullw r0, r0, r6                        
/* 80028500  7C 00 28 50 */	subf r0, r0, r5                         
/* 80028504  C8 02 82 B0 */	lfd f0, lit_3749(r2)                     /* constant-address: 80451CB0, symbol: lit_3749 */
...
/* 8002851C  C8 42 82 B8 */	lfd f2, lit_3751(r2)                     /* constant-address: 80451CB8, symbol: lit_3751 */
...
/* 80028538  C0 62 82 A0 */	lfs f3, lit_3745(r2)                     /* constant-address: 80451CA0, symbol: lit_3745 */
/* 8002853C  C0 22 82 A4 */	lfs f1, lit_3746(r2)                     /* constant-address: 80451CA4, symbol: lit_3746 */
/* 80028540  EC 41 00 B2 */	fmuls f2, f1, f2                        
/* 80028544  C0 22 82 A8 */	lfs f1, lit_3747(r2)                     /* constant-address: 80451CA8, symbol: lit_3747 */
...
/* 80028560  38 A5 9A 20 */	addi r5, r5, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800286C4  80 6D 88 00 */	lwz r3, m_res__22dMap_HIO_prm_res_dst_s(r13) /* constant-address: 80450D80, symbol: m_res__22dMap_HIO_prm_res_dst_s */
/* 800286C8  A8 A3 01 AC */	lha r5, 0x1ac(r3)                       
/* 800286CC  3C 80 80 43 */	lis r4, g_Counter@ha                    
/* 800286D0  38 84 0C D8 */	addi r4, r4, g_Counter@l                 /* constant-address: 80430CD8, symbol: g_Counter */
/* 800286D4  80 84 00 00 */	lwz r4, 0(r4)                            /* constant-address: 80430CD8, symbol: g_Counter */
/* 800286D8  7C 04 2B 96 */	divwu r0, r4, r5                        
/* 800286DC  7C 00 29 D6 */	mullw r0, r0, r5                        
/* 800286E0  7C 00 20 50 */	subf r0, r0, r4                         
/* 800286E4  C8 02 82 B0 */	lfd f0, lit_3749(r2)                     /* constant-address: 80451CB0, symbol: lit_3749 */
...
/* 800286FC  C8 42 82 B8 */	lfd f2, lit_3751(r2)                     /* constant-address: 80451CB8, symbol: lit_3751 */
...
/* 80028718  C0 62 82 A0 */	lfs f3, lit_3745(r2)                     /* constant-address: 80451CA0, symbol: lit_3745 */
/* 8002871C  C0 22 82 A4 */	lfs f1, lit_3746(r2)                     /* constant-address: 80451CA4, symbol: lit_3746 */
/* 80028720  EC 41 00 B2 */	fmuls f2, f1, f2                        
/* 80028724  C0 22 82 A8 */	lfs f1, lit_3747(r2)                     /* constant-address: 80451CA8, symbol: lit_3747 */
...
/* 80028740  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800288AC  48 01 75 6D */	bl draw__16renderingDAmap_cFv            /* constant-address: 8003FE18, symbol: draw__16renderingDAmap_cFv */

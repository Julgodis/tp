...
/* 8019A17C  38 06 B9 74 */	addi r0, r6, process@l                   /* constant-address: 803BB974, symbol: process */
/* 8019A180  7D 80 3A 14 */	add r12, r0, r7                         
/* 8019A184  48 1C 7F 01 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
...
/* 8019A198  41 82 00 0C */	beq lbl_8019A1A4                         /* constant-address: 8019A1A4, symbol: lbl_8019A1A4 */
...
/* 8019A1AC  41 82 00 10 */	beq lbl_8019A1BC                         /* constant-address: 8019A1BC, symbol: lbl_8019A1BC */
/* 8019A1B0  48 08 48 21 */	bl dMeter2Info_set2DVibration__Fv        /* constant-address: 8021E9D0, symbol: dMeter2Info_set2DVibration__Fv */
/* 8019A1B4  38 00 00 00 */	li r0, 0                                
/* 8019A1B8  98 1F 0F 7A */	stb r0, 0xf7a(r31)                      
lbl_8019A1BC:
/* 8019A1BC  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8019A1C0  41 82 00 40 */	beq lbl_8019A200                         /* constant-address: 8019A200, symbol: lbl_8019A200 */
/* 8019A1C4  38 00 00 00 */	li r0, 0                                
/* 8019A1C8  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 8019A1CC  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8019A1D0  98 03 00 BD */	stb r0, 0xbd(r3)                         /* constant-address: 80430245, symbol: None */
/* 8019A1D4  88 1F 0F 70 */	lbz r0, 0xf70(r31)                      
/* 8019A1D8  28 00 00 00 */	cmplwi r0, 0                            
/* 8019A1DC  41 82 00 10 */	beq lbl_8019A1EC                         /* constant-address: 8019A1EC, symbol: lbl_8019A1EC */
/* 8019A1E0  7F E3 FB 78 */	mr r3, r31                              
/* 8019A1E4  38 80 00 00 */	li r4, 0                                
/* 8019A1E8  48 00 01 5D */	bl setSeq__13dShopSystem_cFUc            /* constant-address: 8019A344, symbol: setSeq__13dShopSystem_cFUc */
lbl_8019A1EC:
/* 8019A1EC  2C 1E 00 02 */	cmpwi r30, 2                            
/* 8019A1F0  41 82 00 10 */	beq lbl_8019A200                         /* constant-address: 8019A200, symbol: lbl_8019A200 */
...
/* 8019A20C  41 82 00 10 */	beq lbl_8019A21C                         /* constant-address: 8019A21C, symbol: lbl_8019A21C */

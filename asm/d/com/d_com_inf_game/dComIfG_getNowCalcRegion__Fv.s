...
/* 8002EC70  48 33 35 5D */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 8002EC74  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8002EC78  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8002EC7C  80 7E 5C 68 */	lwz r3, 0x5c68(r30)                      /* constant-address: 8040BE28, symbol: None */
...
/* 8002EC8C  38 C6 8F 38 */	addi r6, r6, d_com_d_com_inf_game__stringBase0@l /* constant-address: 80378F38, symbol: d_com_d_com_inf_game__stringBase0 */
/* 8002EC90  38 C6 01 52 */	addi r6, r6, 0x152                       /* constant-address: 8037908A, symbol: None */
...
/* 8002ECD0  42 00 FF F8 */	bdnz lbl_8002ECC8                        /* constant-address: 8002ECC8, symbol: lbl_8002ECC8 */
/* 8002ECD4  3B 20 00 00 */	li r25, 0                               
/* 8002ECD8  3B E0 00 00 */	li r31, 0                               
/* 8002ECDC  48 00 00 78 */	b lbl_8002ED54                           /* constant-address: 8002ED54, symbol: lbl_8002ED54 */
lbl_8002ECE0:
/* 8002ECE0  38 61 00 60 */	addi r3, r1, 0x60                       
/* 8002ECE4  48 19 79 49 */	bl dMenuFmap_getStartStageName__FPv      /* constant-address: 801C662C, symbol: dMenuFmap_getStartStageName__FPv */
/* 8002ECE8  7F BB FA 14 */	add r29, r27, r31                       
/* 8002ECEC  7F A4 EB 78 */	mr r4, r29                              
/* 8002ECF0  48 33 9C A5 */	bl strcmp                                /* constant-address: 80368994, symbol: strcmp */
/* 8002ECF4  2C 03 00 00 */	cmpwi r3, 0                             
/* 8002ECF8  40 82 00 54 */	bne lbl_8002ED4C                         /* constant-address: 8002ED4C, symbol: lbl_8002ED4C */
/* 8002ECFC  88 9D 00 08 */	lbz r4, 8(r29)                          
/* 8002ED00  28 04 00 FF */	cmplwi r4, 0xff                         
/* 8002ED04  40 82 00 38 */	bne lbl_8002ED3C                         /* constant-address: 8002ED3C, symbol: lbl_8002ED3C */
...
/* 8002ED20  40 82 00 0C */	bne lbl_8002ED2C                         /* constant-address: 8002ED2C, symbol: lbl_8002ED2C */
...
/* 8002ED34  42 00 FF E4 */	bdnz lbl_8002ED18                        /* constant-address: 8002ED18, symbol: lbl_8002ED18 */
/* 8002ED38  48 00 00 10 */	b lbl_8002ED48                           /* constant-address: 8002ED48, symbol: lbl_8002ED48 */
lbl_8002ED3C:
...
lbl_8002ED4C:
/* 8002ED4C  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
/* 8002ED50  3B FF 00 14 */	addi r31, r31, 0x14                      /* constant-address: 00000014 */
lbl_8002ED54:
/* 8002ED54  88 1C 00 00 */	lbz r0, 0(r28)                          
/* 8002ED58  7C 19 00 00 */	cmpw r25, r0                            
/* 8002ED5C  41 80 FF 84 */	blt lbl_8002ECE0                         /* constant-address: 8002ECE0, symbol: lbl_8002ECE0 */
/* 8002ED60  80 7E 5C 68 */	lwz r3, 0x5c68(r30)                      /* constant-address: 8040BE28, symbol: None */
...
/* 8002ED78  41 82 00 48 */	beq lbl_8002EDC0                         /* constant-address: 8002EDC0, symbol: lbl_8002EDC0 */
/* 8002ED7C  38 00 FF FF */	li r0, -1                               
/* 8002ED80  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8002ED84  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8002ED88  80 63 5D B4 */	lwz r3, 0x5db4(r3)                       /* constant-address: 8040BF74, symbol: None */
/* 8002ED8C  28 03 00 00 */	cmplwi r3, 0                            
/* 8002ED90  41 82 00 0C */	beq lbl_8002ED9C                         /* constant-address: 8002ED9C, symbol: lbl_8002ED9C */
/* 8002ED94  88 03 04 E2 */	lbz r0, 0x4e2(r3)                       
/* 8002ED98  7C 00 07 74 */	extsb r0, r0                            
lbl_8002ED9C:
/* 8002ED9C  2C 00 00 00 */	cmpwi r0, 0                             
/* 8002EDA0  40 80 00 14 */	bge lbl_8002EDB4                         /* constant-address: 8002EDB4, symbol: lbl_8002EDB4 */
/* 8002EDA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8002EDA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8002EDAC  88 03 4E 0A */	lbz r0, 0x4e0a(r3)                       /* constant-address: 8040AFCA, symbol: None */
/* 8002EDB0  7C 00 07 74 */	extsb r0, r0                            
lbl_8002EDB4:
/* 8002EDB4  38 61 00 20 */	addi r3, r1, 0x20                       
/* 8002EDB8  7C 63 00 AE */	lbzx r3, r3, r0                         
/* 8002EDBC  48 00 00 08 */	b lbl_8002EDC4                           /* constant-address: 8002EDC4, symbol: lbl_8002EDC4 */
lbl_8002EDC0:
/* 8002EDC0  38 60 00 FF */	li r3, 0xff                             
lbl_8002EDC4:
/* 8002EDC4  81 41 00 00 */	lwz r10, 0(r1)                          
/* 8002EDC8  7D 4B 53 78 */	mr r11, r10                             
/* 8002EDCC  48 33 34 4D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 8002D1BC  48 33 50 1D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8002D1D4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8002D1D8  85 83 4E 20 */	lwzu r12, 0x4e20(r3)                     /* constant-address: 8040AFE0, symbol: None */
...
/* 8002D1EC  40 82 00 0C */	bne lbl_8002D1F8                         /* constant-address: 8002D1F8, symbol: lbl_8002D1F8 */
/* 8002D1F0  38 60 00 00 */	li r3, 0                                
/* 8002D1F4  48 00 00 50 */	b lbl_8002D244                           /* constant-address: 8002D244, symbol: lbl_8002D244 */
lbl_8002D1F8:
/* 8002D1F8  80 83 00 04 */	lwz r4, 4(r3)                            /* constant-address: 8040AFE4, symbol: None */
/* 8002D1FC  80 03 00 00 */	lwz r0, 0(r3)                            /* constant-address: 8040AFE0, symbol: None */
/* 8002D200  7C 09 03 A6 */	mtctr r0                                
/* 8002D204  2C 00 00 00 */	cmpwi r0, 0                             
/* 8002D208  40 81 00 38 */	ble lbl_8002D240                         /* constant-address: 8002D240, symbol: lbl_8002D240 */
lbl_8002D20C:
/* 8002D20C  88 04 00 0A */	lbz r0, 0xa(r4)                         
/* 8002D210  7C 1C 00 00 */	cmpw r28, r0                            
/* 8002D214  40 82 00 24 */	bne lbl_8002D238                         /* constant-address: 8002D238, symbol: lbl_8002D238 */
...
/* 8002D234  48 00 00 10 */	b lbl_8002D244                           /* constant-address: 8002D244, symbol: lbl_8002D244 */
lbl_8002D238:
/* 8002D238  38 84 00 0C */	addi r4, r4, 0xc                        
/* 8002D23C  42 00 FF D0 */	bdnz lbl_8002D20C                        /* constant-address: 8002D20C, symbol: lbl_8002D20C */
lbl_8002D240:
/* 8002D240  38 60 00 00 */	li r3, 0                                
lbl_8002D244:
/* 8002D244  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8002D248  48 33 4F DD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

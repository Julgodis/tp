...
/* 801AE1B8  3B C3 CA 54 */	addi r30, r3, g_env_light@l              /* constant-address: 8042CA54, symbol: g_env_light */
/* 801AE1BC  88 1E 0E D5 */	lbz r0, 0xed5(r30)                       /* constant-address: 8042D929, symbol: None */
/* 801AE1C0  28 00 00 0A */	cmplwi r0, 0xa                          
/* 801AE1C4  40 80 00 1C */	bge lbl_801AE1E0                         /* constant-address: 801AE1E0, symbol: lbl_801AE1E0 */
/* 801AE1C8  38 7F 01 64 */	addi r3, r31, 0x164                     
/* 801AE1CC  C0 22 A4 80 */	lfs f1, lit_3923(r2)                     /* constant-address: 80453E80, symbol: lit_3923 */
/* 801AE1D0  C0 42 A4 84 */	lfs f2, lit_3924(r2)                     /* constant-address: 80453E84, symbol: lit_3924 */
/* 801AE1D4  C0 62 A4 88 */	lfs f3, lit_3925(r2)                     /* constant-address: 80453E88, symbol: lit_3925 */
/* 801AE1D8  C0 82 A4 8C */	lfs f4, lit_3926(r2)                     /* constant-address: 80453E8C, symbol: lit_3926 */
/* 801AE1DC  48 0C 17 A1 */	bl cLib_addCalc__FPfffff                 /* constant-address: 8026F97C, symbol: cLib_addCalc__FPfffff */
lbl_801AE1E0:
/* 801AE1E0  C0 1F 01 64 */	lfs f0, 0x164(r31)                      
/* 801AE1E4  D0 1F 01 14 */	stfs f0, 0x114(r31)                     
/* 801AE1E8  38 7F 01 08 */	addi r3, r31, 0x108                     
/* 801AE1EC  4B E5 F2 3D */	bl play__14mDoExt_baseAnmFv              /* constant-address: 8000D428, symbol: play__14mDoExt_baseAnmFv */
/* 801AE1F0  2C 03 00 00 */	cmpwi r3, 0                             
/* 801AE1F4  41 82 00 20 */	beq lbl_801AE214                         /* constant-address: 801AE214, symbol: lbl_801AE214 */
/* 801AE1F8  3C 60 80 43 */	lis r3, g_mEnvSeMgr@ha                  
/* 801AE1FC  38 63 DD 70 */	addi r3, r3, g_mEnvSeMgr@l               /* constant-address: 8042DD70, symbol: g_mEnvSeMgr */
/* 801AE200  38 9F 01 44 */	addi r4, r31, 0x144                     
/* 801AE204  38 A0 00 00 */	li r5, 0                                
/* 801AE208  48 11 9C 61 */	bl startFarThunderSe__10Z2EnvSeMgrFP3VecSc /* constant-address: 802C7E68, symbol: startFarThunderSe__10Z2EnvSeMgrFP3VecSc */
/* 801AE20C  7F E3 FB 78 */	mr r3, r31                              
/* 801AE210  4B E7 15 39 */	bl fopKyM_Delete__FPv                    /* constant-address: 8001F748, symbol: fopKyM_Delete__FPv */
lbl_801AE214:
/* 801AE214  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801AE218  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801AE21C  80 63 61 B0 */	lwz r3, 0x61b0(r3)                       /* constant-address: 8040C370, symbol: None */
/* 801AE220  28 03 00 00 */	cmplwi r3, 0                            
/* 801AE224  41 82 00 30 */	beq lbl_801AE254                         /* constant-address: 801AE254, symbol: lbl_801AE254 */
/* 801AE228  C0 23 00 D0 */	lfs f1, 0xd0(r3)                        
/* 801AE22C  C0 02 A4 90 */	lfs f0, lit_3927(r2)                     /* constant-address: 80453E90, symbol: lit_3927 */
/* 801AE230  EC 61 00 24 */	fdivs f3, f1, f0                        
/* 801AE234  C0 02 A4 7C */	lfs f0, lit_3885(r2)                     /* constant-address: 80453E7C, symbol: lit_3885 */
/* 801AE238  FC 03 00 40 */	fcmpo cr0, f3, f0                       
/* 801AE23C  4C 41 13 82 */	cror 2, 1, 2                            
/* 801AE240  40 82 00 08 */	bne lbl_801AE248                         /* constant-address: 801AE248, symbol: lbl_801AE248 */
/* 801AE244  FC 60 00 90 */	fmr f3, f0                              
lbl_801AE248:
/* 801AE248  EC 03 00 F2 */	fmuls f0, f3, f3                        
/* 801AE24C  EC 63 00 32 */	fmuls f3, f3, f0                        
/* 801AE250  48 00 00 08 */	b lbl_801AE258                           /* constant-address: 801AE258, symbol: lbl_801AE258 */
lbl_801AE254:
/* 801AE254  C0 62 A4 7C */	lfs f3, lit_3885(r2)                     /* constant-address: 80453E7C, symbol: lit_3885 */
lbl_801AE258:
/* 801AE258  C0 1F 01 64 */	lfs f0, 0x164(r31)                      
/* 801AE25C  EC 63 00 32 */	fmuls f3, f3, f0                        
/* 801AE260  88 1E 0E D5 */	lbz r0, 0xed5(r30)                       /* constant-address: 8042D929, symbol: None */
/* 801AE264  28 00 00 0A */	cmplwi r0, 0xa                          
/* 801AE268  40 80 00 78 */	bge lbl_801AE2E0                         /* constant-address: 801AE2E0, symbol: lbl_801AE2E0 */
...
/* 801AE278  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 801AE27C  7C 83 04 2E */	lfsx f4, r3, r0                         
/* 801AE280  C0 3F 01 38 */	lfs f1, 0x138(r31)                      
/* 801AE284  C0 42 A4 94 */	lfs f2, lit_3928(r2)                     /* constant-address: 80453E94, symbol: lit_3928 */
...
/* 801AE2DC  48 00 00 7C */	b lbl_801AE358                           /* constant-address: 801AE358, symbol: lbl_801AE358 */
lbl_801AE2E0:
...
/* 801AE2EC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 801AE2F0  7C 83 04 2E */	lfsx f4, r3, r0                         
/* 801AE2F4  C0 3F 01 38 */	lfs f1, 0x138(r31)                      
/* 801AE2F8  C0 42 A4 98 */	lfs f2, lit_3929(r2)                     /* constant-address: 80453E98, symbol: lit_3929 */

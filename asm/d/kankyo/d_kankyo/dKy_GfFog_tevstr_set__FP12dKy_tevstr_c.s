...
/* 801A8708  C0 62 A2 48 */	lfs f3, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
/* 801A870C  C0 82 A3 A8 */	lfs f4, lit_8647(r2)                     /* constant-address: 80453DA8, symbol: lit_8647 */
...
/* 801A872C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801A8730  80 63 61 B0 */	lwz r3, 0x61b0(r3)                       /* constant-address: 8040C370, symbol: None */
/* 801A8734  28 03 00 00 */	cmplwi r3, 0                            
/* 801A8738  41 82 00 38 */	beq lbl_801A8770                         /* constant-address: 801A8770, symbol: lbl_801A8770 */
/* 801A873C  C0 43 00 C8 */	lfs f2, 0xc8(r3)                        
/* 801A8740  C0 02 A2 0C */	lfs f0, lit_4409(r2)                     /* constant-address: 80453C0C, symbol: lit_4409 */
/* 801A8744  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 801A8748  4C 41 13 82 */	cror 2, 1, 2                            
/* 801A874C  40 82 00 24 */	bne lbl_801A8770                         /* constant-address: 801A8770, symbol: lbl_801A8770 */
/* 801A8750  C0 23 00 CC */	lfs f1, 0xcc(r3)                        
/* 801A8754  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801A8758  4C 41 13 82 */	cror 2, 1, 2                            
/* 801A875C  40 82 00 14 */	bne lbl_801A8770                         /* constant-address: 801A8770, symbol: lbl_801A8770 */
/* 801A8760  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 801A8764  40 80 00 0C */	bge lbl_801A8770                         /* constant-address: 801A8770, symbol: lbl_801A8770 */
...
/* 801A8788  48 12 57 15 */	bl GFSetFog__F10_GXFogTypeffff8_GXColor  /* constant-address: 802CDE9C, symbol: GFSetFog__F10_GXFogTypeffff8_GXColor */
/* 801A878C  48 00 00 15 */	bl GxXFog_set__Fv                        /* constant-address: 801A87A0, symbol: GxXFog_set__Fv */

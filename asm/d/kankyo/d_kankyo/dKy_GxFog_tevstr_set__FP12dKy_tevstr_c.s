...
/* 801A8660  C0 62 A2 48 */	lfs f3, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
/* 801A8664  C0 82 A3 A8 */	lfs f4, lit_8647(r2)                     /* constant-address: 80453DA8, symbol: lit_8647 */
...
/* 801A8680  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801A8684  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801A8688  80 63 61 B0 */	lwz r3, 0x61b0(r3)                       /* constant-address: 8040C370, symbol: None */
/* 801A868C  28 03 00 00 */	cmplwi r3, 0                            
/* 801A8690  41 82 00 38 */	beq lbl_801A86C8                         /* constant-address: 801A86C8, symbol: lbl_801A86C8 */
/* 801A8694  C0 43 00 C8 */	lfs f2, 0xc8(r3)                        
/* 801A8698  C0 02 A2 0C */	lfs f0, lit_4409(r2)                     /* constant-address: 80453C0C, symbol: lit_4409 */
/* 801A869C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 801A86A0  4C 41 13 82 */	cror 2, 1, 2                            
/* 801A86A4  40 82 00 24 */	bne lbl_801A86C8                         /* constant-address: 801A86C8, symbol: lbl_801A86C8 */
/* 801A86A8  C0 23 00 CC */	lfs f1, 0xcc(r3)                        
/* 801A86AC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801A86B0  4C 41 13 82 */	cror 2, 1, 2                            
/* 801A86B4  40 82 00 14 */	bne lbl_801A86C8                         /* constant-address: 801A86C8, symbol: lbl_801A86C8 */
/* 801A86B8  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 801A86BC  40 80 00 0C */	bge lbl_801A86C8                         /* constant-address: 801A86C8, symbol: lbl_801A86C8 */
...
/* 801A86E0  48 1B 71 D9 */	bl GXSetFog                              /* constant-address: 8035F8B8, symbol: GXSetFog */
/* 801A86E4  48 00 00 BD */	bl GxXFog_set__Fv                        /* constant-address: 801A87A0, symbol: GxXFog_set__Fv */

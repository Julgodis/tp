...
/* 8019CE8C  48 0C 9C A9 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 8019CEAC  C0 02 A2 0C */	lfs f0, lit_4409(r2)                     /* constant-address: 80453C0C, symbol: lit_4409 */
/* 8019CEB0  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 8019CEB4  D0 21 00 14 */	stfs f1, 0x14(r1)                       
/* 8019CEB8  38 61 00 0C */	addi r3, r1, 0xc                        
/* 8019CEBC  48 1A A2 7D */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 8019CEC0  C0 02 A2 0C */	lfs f0, lit_4409(r2)                     /* constant-address: 80453C0C, symbol: lit_4409 */
/* 8019CEC4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8019CEC8  40 81 00 58 */	ble lbl_8019CF20                         /* constant-address: 8019CF20, symbol: lbl_8019CF20 */
/* 8019CECC  FC 00 08 34 */	frsqrte f0, f1                          
/* 8019CED0  C8 82 A2 10 */	lfd f4, lit_4410(r2)                     /* constant-address: 80453C10, symbol: lit_4410 */
/* 8019CED4  FC 44 00 32 */	fmul f2, f4, f0                         
/* 8019CED8  C8 62 A2 18 */	lfd f3, lit_4411(r2)                     /* constant-address: 80453C18, symbol: lit_4411 */
...
/* 8019CF1C  48 00 00 90 */	b lbl_8019CFAC                           /* constant-address: 8019CFAC, symbol: lbl_8019CFAC */
lbl_8019CF20:
/* 8019CF20  C8 02 A2 20 */	lfd f0, lit_4412(r2)                     /* constant-address: 80453C20, symbol: lit_4412 */
/* 8019CF24  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8019CF28  40 80 00 10 */	bge lbl_8019CF38                         /* constant-address: 8019CF38, symbol: lbl_8019CF38 */
/* 8019CF2C  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8019CF30  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8019CF34  48 00 00 78 */	b lbl_8019CFAC                           /* constant-address: 8019CFAC, symbol: lbl_8019CFAC */
lbl_8019CF38:
...
/* 8019CF4C  41 82 00 14 */	beq lbl_8019CF60                         /* constant-address: 8019CF60, symbol: lbl_8019CF60 */
/* 8019CF50  40 80 00 40 */	bge lbl_8019CF90                         /* constant-address: 8019CF90, symbol: lbl_8019CF90 */
/* 8019CF54  2C 03 00 00 */	cmpwi r3, 0                             
/* 8019CF58  41 82 00 20 */	beq lbl_8019CF78                         /* constant-address: 8019CF78, symbol: lbl_8019CF78 */
/* 8019CF5C  48 00 00 34 */	b lbl_8019CF90                           /* constant-address: 8019CF90, symbol: lbl_8019CF90 */
lbl_8019CF60:
/* 8019CF60  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8019CF64  41 82 00 0C */	beq lbl_8019CF70                         /* constant-address: 8019CF70, symbol: lbl_8019CF70 */
/* 8019CF68  38 00 00 01 */	li r0, 1                                
/* 8019CF6C  48 00 00 28 */	b lbl_8019CF94                           /* constant-address: 8019CF94, symbol: lbl_8019CF94 */
lbl_8019CF70:
/* 8019CF70  38 00 00 02 */	li r0, 2                                
/* 8019CF74  48 00 00 20 */	b lbl_8019CF94                           /* constant-address: 8019CF94, symbol: lbl_8019CF94 */
lbl_8019CF78:
/* 8019CF78  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8019CF7C  41 82 00 0C */	beq lbl_8019CF88                         /* constant-address: 8019CF88, symbol: lbl_8019CF88 */
/* 8019CF80  38 00 00 05 */	li r0, 5                                
/* 8019CF84  48 00 00 10 */	b lbl_8019CF94                           /* constant-address: 8019CF94, symbol: lbl_8019CF94 */
lbl_8019CF88:
/* 8019CF88  38 00 00 03 */	li r0, 3                                
/* 8019CF8C  48 00 00 08 */	b lbl_8019CF94                           /* constant-address: 8019CF94, symbol: lbl_8019CF94 */
lbl_8019CF90:
/* 8019CF90  38 00 00 04 */	li r0, 4                                
lbl_8019CF94:
/* 8019CF94  2C 00 00 01 */	cmpwi r0, 1                             
/* 8019CF98  40 82 00 10 */	bne lbl_8019CFA8                         /* constant-address: 8019CFA8, symbol: lbl_8019CFA8 */
/* 8019CF9C  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8019CFA0  C0 43 0A E0 */	lfs f2, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8019CFA4  48 00 00 08 */	b lbl_8019CFAC                           /* constant-address: 8019CFAC, symbol: lbl_8019CFAC */
lbl_8019CFA8:
/* 8019CFA8  FC 40 08 90 */	fmr f2, f1                              
lbl_8019CFAC:
/* 8019CFAC  C0 01 00 28 */	lfs f0, 0x28(r1)                        
/* 8019CFB0  FC 20 00 50 */	fneg f1, f0                             
/* 8019CFB4  48 0C A6 C1 */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */
/* 8019CFB8  B0 7E 00 00 */	sth r3, 0(r30)                          
/* 8019CFBC  C0 21 00 24 */	lfs f1, 0x24(r1)                        
/* 8019CFC0  C0 41 00 2C */	lfs f2, 0x2c(r1)                        
/* 8019CFC4  48 0C A6 B1 */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */

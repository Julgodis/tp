...
/* 801AAC68 0000000C  D0 07 0C 18 */	stfs f0, 0xc18(r7)
/* 801AAC6C 00000010  C0 03 00 04 */	lfs f0, 4(r3)
/* 801AAC70 00000014  D0 07 0C 1C */	stfs f0, 0xc1c(r7)
/* 801AAC74 00000018  C0 03 00 08 */	lfs f0, 8(r3)
/* 801AAC78 0000001C  D0 07 0C 20 */	stfs f0, 0xc20(r7)
/* 801AAC7C 00000020  88 04 00 00 */	lbz r0, 0(r4)
/* 801AAC80 00000024  98 07 0C 24 */	stb r0, 0xc24(r7)
/* 801AAC84 00000028  88 04 00 01 */	lbz r0, 1(r4)
/* 801AAC88 0000002C  98 07 0C 25 */	stb r0, 0xc25(r7)
/* 801AAC8C 00000030  88 04 00 02 */	lbz r0, 2(r4)
/* 801AAC90 00000034  98 07 0C 26 */	stb r0, 0xc26(r7)
/* 801AAC94 00000038  38 00 00 FF */	li r0, 0xff
/* 801AAC98 0000003C  98 07 0C 27 */	stb r0, 0xc27(r7)
/* 801AAC9C 00000040  D0 87 0C 28 */	stfs f4, 0xc28(r7)
/* 801AACA0 00000044  C0 02 A2 90 */	lfs f0, d_kankyo_d_kankyo__LIT_5191(r2)
/* 801AACA4 00000048  D0 07 0C 2C */	stfs f0, 0xc2c(r7)
/* 801AACA8 0000004C  D0 67 0C 30 */	stfs f3, 0xc30(r7)
/* 801AACAC 00000050  D0 27 0C 34 */	stfs f1, 0xc34(r7)
/* 801AACB0 00000054  C0 02 A2 2C */	lfs f0, d_kankyo_d_kankyo__LIT_4442(r2)
/* 801AACB4 00000058  EC 00 10 2A */	fadds f0, f0, f2
/* 801AACB8 0000005C  D0 07 0C 38 */	stfs f0, 0xc38(r7)
/* 801AACBC 00000060  98 A7 0C 3C */	stb r5, 0xc3c(r7)
/* 801AACC0 00000064  98 C7 0C 3D */	stb r6, 0xc3d(r7)
/* 801AACC4 00000068  88 07 13 09 */	lbz r0, 0x1309(r7)
...
/* 801AACEC 00000004  C0 22 A2 48 */	lfs f1, d_kankyo_d_kankyo__LIT_4505(r2)
/* 801AACF0 00000008  C0 42 A3 88 */	lfs f2, LIT_7026(r2)
/* 801AACF4 0000000C  48 00 00 30 */	b lbl_801AAD24
lbl_801AACF8:
/* 801AACF8 00000000  C0 02 A2 8C */	lfs f0, d_kankyo_d_kankyo__LIT_5106(r2)
/* 801AACFC 00000004  C0 22 A2 48 */	lfs f1, d_kankyo_d_kankyo__LIT_4505(r2)
...
lbl_801AAD18:
/* 801AAD18 00000000  C0 02 A1 FC */	lfs f0, d_kankyo_d_kankyo__LIT_4360(r2)
/* 801AAD1C 00000004  C0 22 A2 58 */	lfs f1, d_kankyo_d_kankyo__LIT_4509(r2)

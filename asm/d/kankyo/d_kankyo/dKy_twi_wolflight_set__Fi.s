...
/* 8019CFF4  48 1C 51 E9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8019CFF8  7C 7D 1B 78 */	mr r29, r3                              
/* 8019CFFC  3C 60 80 43 */	lis r3, g_env_light@ha                  
/* 8019D000  3B E3 CA 54 */	addi r31, r3, g_env_light@l              /* constant-address: 8042CA54, symbol: g_env_light */
/* 8019D004  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8019D008  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8019D00C  83 C3 5D 74 */	lwz r30, 0x5d74(r3)                      /* constant-address: 8040BF34, symbol: None */
/* 8019D010  28 1E 00 00 */	cmplwi r30, 0                           
/* 8019D014  41 82 01 74 */	beq lbl_8019D188                         /* constant-address: 8019D188, symbol: lbl_8019D188 */
...
/* 8019D028  4B FF FE 35 */	bl dKy_pos2_get_angle__FP4cXyzP4cXyzPsPs /* constant-address: 8019CE5C, symbol: dKy_pos2_get_angle__FP4cXyzP4cXyzPsPs */
/* 8019D02C  38 7E 00 E4 */	addi r3, r30, 0xe4                      
/* 8019D030  38 9E 00 D8 */	addi r4, r30, 0xd8                      
/* 8019D034  38 A1 00 0C */	addi r5, r1, 0xc                        
/* 8019D038  4B EB E7 29 */	bl dKyr_get_vectle_calc__FP4cXyzP4cXyzP4cXyz /* constant-address: 8005B760, symbol: dKyr_get_vectle_calc__FP4cXyzP4cXyzP4cXyz */
/* 8019D03C  C0 3E 00 D8 */	lfs f1, 0xd8(r30)                       
/* 8019D040  C0 42 A1 F4 */	lfs f2, lit_4358(r2)                     /* constant-address: 80453BF4, symbol: lit_4358 */
...
/* 8019D088  38 63 CA 54 */	addi r3, r3, g_env_light@l               /* constant-address: 8042CA54, symbol: g_env_light */
/* 8019D08C  88 03 13 09 */	lbz r0, 0x1309(r3)                       /* constant-address: 8042DD5D, symbol: None */
/* 8019D090  2C 00 00 02 */	cmpwi r0, 2                             
/* 8019D094  38 64 0C 1C */	addi r3, r4, 0xc1c                      
/* 8019D098  41 82 00 4C */	beq lbl_8019D0E4                         /* constant-address: 8019D0E4, symbol: lbl_8019D0E4 */
/* 8019D09C  40 80 00 14 */	bge lbl_8019D0B0                         /* constant-address: 8019D0B0, symbol: lbl_8019D0B0 */
/* 8019D0A0  2C 00 00 00 */	cmpwi r0, 0                             
/* 8019D0A4  41 82 00 18 */	beq lbl_8019D0BC                         /* constant-address: 8019D0BC, symbol: lbl_8019D0BC */
/* 8019D0A8  40 80 00 28 */	bge lbl_8019D0D0                         /* constant-address: 8019D0D0, symbol: lbl_8019D0D0 */
/* 8019D0AC  48 00 00 60 */	b lbl_8019D10C                           /* constant-address: 8019D10C, symbol: lbl_8019D10C */
lbl_8019D0B0:
/* 8019D0B0  2C 00 00 04 */	cmpwi r0, 4                             
/* 8019D0B4  40 80 00 58 */	bge lbl_8019D10C                         /* constant-address: 8019D10C, symbol: lbl_8019D10C */
/* 8019D0B8  48 00 00 40 */	b lbl_8019D0F8                           /* constant-address: 8019D0F8, symbol: lbl_8019D0F8 */
lbl_8019D0BC:
/* 8019D0BC  C0 23 00 00 */	lfs f1, 0(r3)                           
/* 8019D0C0  C0 02 A1 FC */	lfs f0, lit_4360(r2)                     /* constant-address: 80453BFC, symbol: lit_4360 */
/* 8019D0C4  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8019D0C8  D0 03 00 00 */	stfs f0, 0(r3)                          
/* 8019D0CC  48 00 00 50 */	b lbl_8019D11C                           /* constant-address: 8019D11C, symbol: lbl_8019D11C */
lbl_8019D0D0:
/* 8019D0D0  C0 23 00 00 */	lfs f1, 0(r3)                           
/* 8019D0D4  C0 02 A1 D8 */	lfs f0, lit_4351(r2)                     /* constant-address: 80453BD8, symbol: lit_4351 */
/* 8019D0D8  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8019D0DC  D0 03 00 00 */	stfs f0, 0(r3)                          
/* 8019D0E0  48 00 00 3C */	b lbl_8019D11C                           /* constant-address: 8019D11C, symbol: lbl_8019D11C */
lbl_8019D0E4:
/* 8019D0E4  C0 23 00 00 */	lfs f1, 0(r3)                           
/* 8019D0E8  C0 02 A1 E0 */	lfs f0, lit_4353(r2)                     /* constant-address: 80453BE0, symbol: lit_4353 */
/* 8019D0EC  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8019D0F0  D0 03 00 00 */	stfs f0, 0(r3)                          
/* 8019D0F4  48 00 00 28 */	b lbl_8019D11C                           /* constant-address: 8019D11C, symbol: lbl_8019D11C */
lbl_8019D0F8:
/* 8019D0F8  C0 23 00 00 */	lfs f1, 0(r3)                           
/* 8019D0FC  C0 02 A1 FC */	lfs f0, lit_4360(r2)                     /* constant-address: 80453BFC, symbol: lit_4360 */
/* 8019D100  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8019D104  D0 03 00 00 */	stfs f0, 0(r3)                          
/* 8019D108  48 00 00 14 */	b lbl_8019D11C                           /* constant-address: 8019D11C, symbol: lbl_8019D11C */
lbl_8019D10C:
/* 8019D10C  C0 23 00 00 */	lfs f1, 0(r3)                           
/* 8019D110  C0 02 A1 D8 */	lfs f0, lit_4351(r2)                     /* constant-address: 80453BD8, symbol: lit_4351 */
...
/* 8019D128  C0 42 A2 28 */	lfs f2, lit_4441(r2)                     /* constant-address: 80453C28, symbol: lit_4441 */
/* 8019D12C  7C 00 07 34 */	extsh r0, r0                            
/* 8019D130  7C 00 00 D0 */	neg r0, r0                              
/* 8019D134  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 8019D17C  C0 02 A2 2C */	lfs f0, lit_4442(r2)                     /* constant-address: 80453C2C, symbol: lit_4442 */
/* 8019D180  EC 00 08 2A */	fadds f0, f0, f1                        
/* 8019D184  D0 03 0C 38 */	stfs f0, 0xc38(r3)                      
lbl_8019D188:
/* 8019D188  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8019D18C  48 1C 50 9D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

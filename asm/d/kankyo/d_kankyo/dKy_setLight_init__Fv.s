...
/* 801A5E7C  48 1B C3 45 */	bl _savegpr_22                           /* constant-address: 803621C0, symbol: _savegpr_22 */
/* 801A5E80  38 A0 00 00 */	li r5, 0                                
/* 801A5E84  38 C0 00 00 */	li r6, 0                                
/* 801A5E88  3C 60 80 3C */	lis r3, lightStatusBase@ha              
/* 801A5E8C  38 E3 BD C4 */	addi r7, r3, lightStatusBase@l           /* constant-address: 803BBDC4, symbol: lightStatusBase */
/* 801A5E90  80 67 00 00 */	lwz r3, 0(r7)                            /* constant-address: 803BBDC4, symbol: lightStatusBase */
/* 801A5E94  80 07 00 04 */	lwz r0, 4(r7)                            /* constant-address: 803BBDC8, symbol: None */
/* 801A5E98  90 61 00 24 */	stw r3, 0x24(r1)                        
/* 801A5E9C  90 01 00 28 */	stw r0, 0x28(r1)                        
/* 801A5EA0  80 07 00 08 */	lwz r0, 8(r7)                            /* constant-address: 803BBDCC, symbol: None */
/* 801A5EA4  90 01 00 2C */	stw r0, 0x2c(r1)                        
/* 801A5EA8  80 67 00 0C */	lwz r3, 0xc(r7)                          /* constant-address: 803BBDD0, symbol: None */
/* 801A5EAC  80 07 00 10 */	lwz r0, 0x10(r7)                         /* constant-address: 803BBDD4, symbol: None */
/* 801A5EB0  90 61 00 18 */	stw r3, 0x18(r1)                        
/* 801A5EB4  90 01 00 1C */	stw r0, 0x1c(r1)                        
/* 801A5EB8  80 07 00 14 */	lwz r0, 0x14(r7)                         /* constant-address: 803BBDD8, symbol: None */
/* 801A5EBC  90 01 00 20 */	stw r0, 0x20(r1)                        
/* 801A5EC0  80 07 00 18 */	lwz r0, 0x18(r7)                         /* constant-address: 803BBDDC, symbol: None */
/* 801A5EC4  90 01 00 08 */	stw r0, 8(r1)                           
/* 801A5EC8  80 07 00 1C */	lwz r0, 0x1c(r7)                         /* constant-address: 803BBDE0, symbol: None */
/* 801A5ECC  C0 07 00 20 */	lfs f0, 0x20(r7)                         /* constant-address: 803BBDE4, symbol: None */
/* 801A5ED0  C0 27 00 24 */	lfs f1, 0x24(r7)                         /* constant-address: 803BBDE8, symbol: None */
/* 801A5ED4  C0 47 00 28 */	lfs f2, 0x28(r7)                         /* constant-address: 803BBDEC, symbol: None */
/* 801A5ED8  C0 67 00 2C */	lfs f3, 0x2c(r7)                         /* constant-address: 803BBDF0, symbol: None */
/* 801A5EDC  C0 87 00 30 */	lfs f4, 0x30(r7)                         /* constant-address: 803BBDF4, symbol: None */
/* 801A5EE0  C0 A7 00 34 */	lfs f5, 0x34(r7)                         /* constant-address: 803BBDF8, symbol: None */
/* 801A5EE4  80 87 00 38 */	lwz r4, 0x38(r7)                         /* constant-address: 803BBDFC, symbol: None */
/* 801A5EE8  80 67 00 3C */	lwz r3, 0x3c(r7)                         /* constant-address: 803BBE00, symbol: None */
/* 801A5EEC  90 81 00 0C */	stw r4, 0xc(r1)                         
/* 801A5EF0  90 61 00 10 */	stw r3, 0x10(r1)                        
/* 801A5EF4  80 67 00 40 */	lwz r3, 0x40(r7)                         /* constant-address: 803BBE04, symbol: None */
/* 801A5EF8  90 61 00 14 */	stw r3, 0x14(r1)                        
/* 801A5EFC  C0 C7 00 44 */	lfs f6, 0x44(r7)                         /* constant-address: 803BBE08, symbol: None */
/* 801A5F00  80 67 00 48 */	lwz r3, 0x48(r7)                         /* constant-address: 803BBE0C, symbol: None */
/* 801A5F04  C0 E7 00 4C */	lfs f7, 0x4c(r7)                         /* constant-address: 803BBE10, symbol: None */
/* 801A5F08  C1 07 00 50 */	lfs f8, 0x50(r7)                         /* constant-address: 803BBE14, symbol: None */
/* 801A5F0C  80 87 00 54 */	lwz r4, 0x54(r7)                         /* constant-address: 803BBE18, symbol: None */
/* 801A5F10  39 41 00 6C */	addi r10, r1, 0x6c                      
/* 801A5F14  39 27 00 54 */	addi r9, r7, 0x54                        /* constant-address: 803BBE18, symbol: None */
...
/* 801A5F30  42 00 FF F0 */	bdnz lbl_801A5F20                        /* constant-address: 801A5F20, symbol: lbl_801A5F20 */
/* 801A5F34  3C E0 80 3C */	lis r7, lightStatusBase@ha              
/* 801A5F38  38 E7 BD C4 */	addi r7, r7, lightStatusBase@l           /* constant-address: 803BBDC4, symbol: lightStatusBase */
/* 801A5F3C  C1 27 00 88 */	lfs f9, 0x88(r7)                         /* constant-address: 803BBE4C, symbol: None */
/* 801A5F40  C1 47 00 8C */	lfs f10, 0x8c(r7)                        /* constant-address: 803BBE50, symbol: None */
/* 801A5F44  C1 67 00 90 */	lfs f11, 0x90(r7)                        /* constant-address: 803BBE54, symbol: None */
/* 801A5F48  C1 87 00 94 */	lfs f12, 0x94(r7)                        /* constant-address: 803BBE58, symbol: None */
/* 801A5F4C  39 41 00 2C */	addi r10, r1, 0x2c                      
/* 801A5F50  39 27 00 94 */	addi r9, r7, 0x94                        /* constant-address: 803BBE58, symbol: None */
...
/* 801A5F6C  42 00 FF F0 */	bdnz lbl_801A5F5C                        /* constant-address: 801A5F5C, symbol: lbl_801A5F5C */
/* 801A5F70  3C E0 80 3C */	lis r7, lightStatusBase@ha              
/* 801A5F74  38 E7 BD C4 */	addi r7, r7, lightStatusBase@l           /* constant-address: 803BBDC4, symbol: lightStatusBase */
/* 801A5F78  C1 A7 00 D8 */	lfs f13, 0xd8(r7)                        /* constant-address: 803BBE9C, symbol: None */
/* 801A5F7C  C3 E7 00 DC */	lfs f31, 0xdc(r7)                        /* constant-address: 803BBEA0, symbol: None */
/* 801A5F80  C3 C7 00 E0 */	lfs f30, 0xe0(r7)                        /* constant-address: 803BBEA4, symbol: None */
/* 801A5F84  C3 A7 00 E4 */	lfs f29, 0xe4(r7)                        /* constant-address: 803BBEA8, symbol: None */
/* 801A5F88  3C E0 80 43 */	lis r7, lightStatusData@ha              
/* 801A5F8C  3A E7 E0 7C */	addi r23, r7, lightStatusData@l          /* constant-address: 8042E07C, symbol: lightStatusData */
...
/* 801A6034  42 00 FF F0 */	bdnz lbl_801A6024                        /* constant-address: 801A6024, symbol: lbl_801A6024 */
...
/* 801A6068  42 00 FF F0 */	bdnz lbl_801A6058                        /* constant-address: 801A6058, symbol: lbl_801A6058 */
...
/* 801A607C  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
/* 801A6080  2C 05 00 08 */	cmpwi r5, 8                             
/* 801A6084  38 C6 00 E8 */	addi r6, r6, 0xe8                        /* constant-address: 000000E8 */
/* 801A6088  41 80 FF 30 */	blt lbl_801A5FB8                         /* constant-address: 801A5FB8, symbol: lbl_801A5FB8 */
...
/* 801A60A8  48 1B C1 65 */	bl _restgpr_22                           /* constant-address: 8036220C, symbol: _restgpr_22 */

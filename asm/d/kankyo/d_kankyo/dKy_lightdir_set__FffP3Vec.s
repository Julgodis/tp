...
/* 8019D1D0  C0 02 A2 38 */	lfs f0, lit_4477(r2)                     /* constant-address: 80453C38, symbol: lit_4477 */
/* 8019D1D4  EF C1 00 24 */	fdivs f30, f1, f0                       
/* 8019D1D8  EF A2 00 24 */	fdivs f29, f2, f0                       
/* 8019D1DC  FC 20 E8 90 */	fmr f1, f29                             
/* 8019D1E0  48 0C A4 05 */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
/* 8019D1E4  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha         
/* 8019D1E8  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 8019D1EC  3B E4 00 04 */	addi r31, r4, 4                          /* constant-address: 80439A24, symbol: None */
/* 8019D1F0  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c            
/* 8019D1F4  7F FF 04 2E */	lfsx f31, r31, r0                       
/* 8019D1F8  FC 20 F0 90 */	fmr f1, f30                             
/* 8019D1FC  48 0C A3 E9 */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
...
/* 8019D214  48 0C A3 D1 */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
/* 8019D218  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c            
/* 8019D21C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 8019D220  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 8019D224  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 8019D228  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 8019D22C  FC 20 E8 90 */	fmr f1, f29                             
/* 8019D230  48 0C A3 B5 */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
/* 8019D234  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c            
/* 8019D238  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 8019D23C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 8019D240  7F E3 04 2E */	lfsx f31, r3, r0                        
/* 8019D244  FC 20 F0 90 */	fmr f1, f30                             
/* 8019D248  48 0C A3 9D */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
...
/* 8019D260  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8019D264  38 81 00 20 */	addi r4, r1, 0x20                       
/* 8019D268  4B E6 F7 49 */	bl mDoMtx_inverseTranspose__FPA4_CfPA4_f /* constant-address: 8000C9B0, symbol: mDoMtx_inverseTranspose__FPA4_CfPA4_f */
/* 8019D26C  38 61 00 20 */	addi r3, r1, 0x20                       
/* 8019D270  38 81 00 08 */	addi r4, r1, 8                          
/* 8019D274  38 A1 00 14 */	addi r5, r1, 0x14                       
/* 8019D278  48 1A 9A F5 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */

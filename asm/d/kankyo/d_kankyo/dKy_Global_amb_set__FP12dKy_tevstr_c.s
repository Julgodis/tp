...
/* 801A761C  41 82 00 0C */	beq lbl_801A7628                         /* constant-address: 801A7628, symbol: lbl_801A7628 */
/* 801A7620  28 00 00 03 */	cmplwi r0, 3                            
/* 801A7624  40 82 00 54 */	bne lbl_801A7678                         /* constant-address: 801A7678, symbol: lbl_801A7678 */
lbl_801A7628:
/* 801A7628  48 00 4F 55 */	bl dKy_darkworld_check__Fv               /* constant-address: 801AC57C, symbol: dKy_darkworld_check__Fv */
/* 801A762C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801A7630  41 82 00 80 */	beq lbl_801A76B0                         /* constant-address: 801A76B0, symbol: lbl_801A76B0 */
/* 801A7634  88 1F 03 7A */	lbz r0, 0x37a(r31)                      
/* 801A7638  28 00 00 02 */	cmplwi r0, 2                            
/* 801A763C  40 82 00 20 */	bne lbl_801A765C                         /* constant-address: 801A765C, symbol: lbl_801A765C */
...
/* 801A7658  48 00 00 58 */	b lbl_801A76B0                           /* constant-address: 801A76B0, symbol: lbl_801A76B0 */
lbl_801A765C:
...
/* 801A7674  48 00 00 3C */	b lbl_801A76B0                           /* constant-address: 801A76B0, symbol: lbl_801A76B0 */
lbl_801A7678:
/* 801A7678  28 00 00 01 */	cmplwi r0, 1                            
/* 801A767C  41 80 00 0C */	blt lbl_801A7688                         /* constant-address: 801A7688, symbol: lbl_801A7688 */
/* 801A7680  28 00 00 07 */	cmplwi r0, 7                            
/* 801A7684  40 81 00 18 */	ble lbl_801A769C                         /* constant-address: 801A769C, symbol: lbl_801A769C */
lbl_801A7688:
/* 801A7688  28 00 00 09 */	cmplwi r0, 9                            
/* 801A768C  40 82 00 24 */	bne lbl_801A76B0                         /* constant-address: 801A76B0, symbol: lbl_801A76B0 */
/* 801A7690  48 00 4E ED */	bl dKy_darkworld_check__Fv               /* constant-address: 801AC57C, symbol: dKy_darkworld_check__Fv */
/* 801A7694  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801A7698  41 82 00 18 */	beq lbl_801A76B0                         /* constant-address: 801A76B0, symbol: lbl_801A76B0 */
lbl_801A769C:
...
/* 801A76C0  48 1B 62 A1 */	bl GXSetChanAmbColor                     /* constant-address: 8035D960, symbol: GXSetChanAmbColor */

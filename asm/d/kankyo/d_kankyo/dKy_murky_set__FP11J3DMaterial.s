...
/* 801AC93C  38 83 CA 54 */	addi r4, r3, g_env_light@l               /* constant-address: 8042CA54, symbol: g_env_light */
/* 801AC940  80 A4 0E 78 */	lwz r5, 0xe78(r4)                        /* constant-address: 8042D8CC, symbol: None */
/* 801AC944  80 C4 0E 74 */	lwz r6, 0xe74(r4)                        /* constant-address: 8042D8C8, symbol: None */
/* 801AC948  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801AC94C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801AC950  83 E3 5D 74 */	lwz r31, 0x5d74(r3)                      /* constant-address: 8040BF34, symbol: None */
/* 801AC954  A8 04 11 10 */	lha r0, 0x1110(r4)                       /* constant-address: 8042DB64, symbol: None */
/* 801AC958  B0 01 00 0C */	sth r0, 0xc(r1)                         
/* 801AC95C  A8 04 11 12 */	lha r0, 0x1112(r4)                       /* constant-address: 8042DB66, symbol: None */
/* 801AC960  B0 01 00 0E */	sth r0, 0xe(r1)                         
/* 801AC964  A8 04 11 14 */	lha r0, 0x1114(r4)                       /* constant-address: 8042DB68, symbol: None */
/* 801AC968  B0 01 00 10 */	sth r0, 0x10(r1)                        
/* 801AC96C  A8 04 11 1E */	lha r0, 0x111e(r4)                       /* constant-address: 8042DB72, symbol: None */
/* 801AC970  B0 01 00 12 */	sth r0, 0x12(r1)                        
/* 801AC974  A8 04 11 16 */	lha r0, 0x1116(r4)                       /* constant-address: 8042DB6A, symbol: None */
/* 801AC978  98 01 00 0B */	stb r0, 0xb(r1)                         
/* 801AC97C  A8 04 13 00 */	lha r0, 0x1300(r4)                       /* constant-address: 8042DD54, symbol: None */
/* 801AC980  2C 00 FF FF */	cmpwi r0, -1                            
/* 801AC984  41 82 00 38 */	beq lbl_801AC9BC                         /* constant-address: 801AC9BC, symbol: lbl_801AC9BC */
/* 801AC988  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 801AC9A4  C0 02 A2 48 */	lfs f0, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
...
/* 801AC9C0  38 63 CA 54 */	addi r3, r3, g_env_light@l               /* constant-address: 8042CA54, symbol: g_env_light */
/* 801AC9C4  A8 03 13 02 */	lha r0, 0x1302(r3)                       /* constant-address: 8042DD56, symbol: None */
/* 801AC9C8  2C 00 FF FF */	cmpwi r0, -1                            
/* 801AC9CC  41 82 00 3C */	beq lbl_801ACA08                         /* constant-address: 801ACA08, symbol: lbl_801ACA08 */
/* 801AC9D0  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 801AC9EC  C0 02 A2 48 */	lfs f0, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
...
/* 801ACA0C  41 82 00 68 */	beq lbl_801ACA74                         /* constant-address: 801ACA74, symbol: lbl_801ACA74 */
/* 801ACA10  C0 86 00 5C */	lfs f4, 0x5c(r6)                        
/* 801ACA14  C0 02 A3 10 */	lfs f0, lit_6042(r2)                     /* constant-address: 80453D10, symbol: lit_6042 */
/* 801ACA18  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 801ACA1C  40 81 00 58 */	ble lbl_801ACA74                         /* constant-address: 801ACA74, symbol: lbl_801ACA74 */
/* 801ACA20  A8 01 00 12 */	lha r0, 0x12(r1)                        
/* 801ACA24  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 801ACA40  C0 22 A2 48 */	lfs f1, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
...
/* 801ACA78  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801ACA7C  38 63 4E 00 */	addi r3, r3, 0x4e00                      /* constant-address: 8040AFC0, symbol: None */
/* 801ACA80  3C 80 80 39 */	lis r4, d_kankyo_d_kankyo__stringBase0@ha
/* 801ACA84  38 84 4C 6C */	addi r4, r4, d_kankyo_d_kankyo__stringBase0@l /* constant-address: 80394C6C, symbol: d_kankyo_d_kankyo__stringBase0 */
/* 801ACA88  38 84 02 61 */	addi r4, r4, 0x261                       /* constant-address: 80394ECD, symbol: None */
/* 801ACA8C  48 1B BF 09 */	bl strcmp                                /* constant-address: 80368994, symbol: strcmp */
/* 801ACA90  2C 03 00 00 */	cmpwi r3, 0                             
/* 801ACA94  40 82 01 E0 */	bne lbl_801ACC74                         /* constant-address: 801ACC74, symbol: lbl_801ACC74 */
/* 801ACA98  3C 60 80 43 */	lis r3, g_env_light@ha                  
/* 801ACA9C  38 63 CA 54 */	addi r3, r3, g_env_light@l               /* constant-address: 8042CA54, symbol: g_env_light */
/* 801ACAA0  80 63 10 4C */	lwz r3, 0x104c(r3)                       /* constant-address: 8042DAA0, symbol: None */
/* 801ACAA4  28 03 00 00 */	cmplwi r3, 0                            
/* 801ACAA8  41 82 00 10 */	beq lbl_801ACAB8                         /* constant-address: 801ACAB8, symbol: lbl_801ACAB8 */
/* 801ACAAC  C0 22 A2 48 */	lfs f1, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
...
/* 801ACAD0  C8 42 A2 30 */	lfd f2, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 801ACB10  C0 22 A4 00 */	lfs f1, lit_10483(r2)                    /* constant-address: 80453E00, symbol: lit_10483 */
...
/* 801ACB4C  C0 22 A4 04 */	lfs f1, lit_10484(r2)                    /* constant-address: 80453E04, symbol: lit_10484 */
...
/* 801ACB8C  41 82 00 5C */	beq lbl_801ACBE8                         /* constant-address: 801ACBE8, symbol: lbl_801ACBE8 */
/* 801ACB90  C0 3F 00 E0 */	lfs f1, 0xe0(r31)                       
/* 801ACB94  C0 02 A1 E4 */	lfs f0, lit_4354(r2)                     /* constant-address: 80453BE4, symbol: lit_4354 */
/* 801ACB98  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801ACB9C  40 80 00 4C */	bge lbl_801ACBE8                         /* constant-address: 801ACBE8, symbol: lbl_801ACBE8 */
/* 801ACBA0  C0 62 A2 6C */	lfs f3, lit_4732(r2)                     /* constant-address: 80453C6C, symbol: lit_4732 */
/* 801ACBA4  C0 02 A4 08 */	lfs f0, lit_10485(r2)                    /* constant-address: 80453E08, symbol: lit_10485 */
/* 801ACBA8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801ACBAC  40 80 00 0C */	bge lbl_801ACBB8                         /* constant-address: 801ACBB8, symbol: lbl_801ACBB8 */
/* 801ACBB0  C0 02 A2 48 */	lfs f0, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
/* 801ACBB4  48 00 00 18 */	b lbl_801ACBCC                           /* constant-address: 801ACBCC, symbol: lbl_801ACBCC */
lbl_801ACBB8:
/* 801ACBB8  C0 42 A2 48 */	lfs f2, lit_4505(r2)                     /* constant-address: 80453C48, symbol: lit_4505 */
/* 801ACBBC  EC 21 00 28 */	fsubs f1, f1, f0                        
/* 801ACBC0  C0 02 A2 78 */	lfs f0, lit_4852(r2)                     /* constant-address: 80453C78, symbol: lit_4852 */
...
/* 801ACBE4  48 00 00 0C */	b lbl_801ACBF0                           /* constant-address: 801ACBF0, symbol: lbl_801ACBF0 */
lbl_801ACBE8:
/* 801ACBE8  38 00 00 00 */	li r0, 0                                
/* 801ACBEC  B0 01 00 12 */	sth r0, 0x12(r1)                        
lbl_801ACBF0:
/* 801ACBF0  A8 81 00 12 */	lha r4, 0x12(r1)                        
/* 801ACBF4  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 801ACC3C  C0 42 A4 0C */	lfs f2, lit_10486(r2)                    /* constant-address: 80453E0C, symbol: lit_10486 */
/* 801ACC40  C8 22 A2 80 */	lfd f1, lit_4964(r2)                     /* constant-address: 80453C80, symbol: lit_4964 */

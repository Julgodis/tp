...
/* 801A60F8  48 1B C0 D5 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 801A60FC  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 801A6100  38 03 4A C8 */	addi r0, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
...
/* 801A6118  3B 83 E0 7C */	addi r28, r3, lightStatusData@l          /* constant-address: 8042E07C, symbol: lightStatusData */
/* 801A611C  C3 E2 A2 0C */	lfs f31, lit_4409(r2)                    /* constant-address: 80453C0C, symbol: lit_4409 */
/* 801A6120  3C 60 80 3C */	lis r3, lightMaskData@ha                
/* 801A6124  3B A3 BE AC */	addi r29, r3, lightMaskData@l            /* constant-address: 803BBEAC, symbol: lightMaskData */
lbl_801A6128:
...
/* 801A6138  48 1A 0C 35 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 801A614C  48 1B 77 61 */	bl GXInitLightPos                        /* constant-address: 8035D8AC, symbol: GXInitLightPos */
...
/* 801A6160  48 1B 77 5D */	bl GXInitLightDir                        /* constant-address: 8035D8BC, symbol: GXInitLightDir */
...
/* 801A6174  48 1B 77 65 */	bl GXInitLightColor                      /* constant-address: 8035D8D8, symbol: GXInitLightColor */
/* 801A6178  C0 19 00 4C */	lfs f0, 0x4c(r25)                       
/* 801A617C  FC 00 F8 40 */	fcmpo cr0, f0, f31                      
/* 801A6180  4C 40 13 82 */	cror 2, 0, 2                            
/* 801A6184  40 82 00 0C */	bne lbl_801A6190                         /* constant-address: 801A6190, symbol: lbl_801A6190 */
/* 801A6188  C0 02 A3 10 */	lfs f0, lit_6042(r2)                     /* constant-address: 80453D10, symbol: lit_6042 */
...
/* 801A61A0  48 1B 76 3D */	bl GXInitLightDistAttn                   /* constant-address: 8035D7DC, symbol: GXInitLightDistAttn */
/* 801A61A4  38 61 00 18 */	addi r3, r1, 0x18                       
/* 801A61A8  C0 39 00 44 */	lfs f1, 0x44(r25)                       
/* 801A61AC  80 99 00 48 */	lwz r4, 0x48(r25)                       
/* 801A61B0  48 1B 74 9D */	bl GXInitLightSpot                       /* constant-address: 8035D64C, symbol: GXInitLightSpot */
/* 801A61B4  38 61 00 18 */	addi r3, r1, 0x18                       
/* 801A61B8  7C 9D FA 2E */	lhzx r4, r29, r31                       
/* 801A61BC  48 1B 77 29 */	bl GXLoadLightObjImm                     /* constant-address: 8035D8E4, symbol: GXLoadLightObjImm */
...
/* 801A61D0  41 80 FF 58 */	blt lbl_801A6128                         /* constant-address: 801A6128, symbol: lbl_801A6128 */
/* 801A61D4  E3 E1 00 88 */	psq_l f31, 136(r1), 0, 0 /* qr0 */      
/* 801A61D8  CB E1 00 80 */	lfd f31, 0x80(r1)                       
/* 801A61DC  39 61 00 80 */	addi r11, r1, 0x80                      
/* 801A61E0  48 1B C0 39 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

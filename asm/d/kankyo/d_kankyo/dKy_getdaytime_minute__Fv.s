...
/* 8019FA44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8019FA48  C0 03 00 34 */	lfs f0, 0x34(r3)                         /* constant-address: 804061F4, symbol: None */
/* 8019FA4C  C0 62 A2 BC */	lfs f3, lit_5554(r2)                     /* constant-address: 80453CBC, symbol: lit_5554 */
/* 8019FA50  C0 42 A2 70 */	lfs f2, lit_4850(r2)                     /* constant-address: 80453C70, symbol: lit_4850 */
...
/* 8019FA68  38 63 E1 C0 */	addi r3, r3, 0xE1C0 /* 0x00E4E1C0@l */   /* constant-address: 00E4E1C0 */
/* 8019FA6C  7C 04 1B D6 */	divw r0, r4, r3                         
/* 8019FA70  7C 00 19 D6 */	mullw r0, r0, r3                        
/* 8019FA74  7C 00 20 50 */	subf r0, r0, r4                         
/* 8019FA78  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 8019FA98  C0 02 A2 AC */	lfs f0, lit_5347(r2)                     /* constant-address: 80453CAC, symbol: lit_5347 */

...
/* 801A4C20  48 1B D5 AD */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 801A4C40  3B E3 CA 54 */	addi r31, r3, g_env_light@l              /* constant-address: 8042CA54, symbol: g_env_light */
/* 801A4C44  48 00 01 3C */	b lbl_801A4D80                           /* constant-address: 801A4D80, symbol: lbl_801A4D80 */
lbl_801A4C48:
...
/* 801A4C60  41 82 00 10 */	beq lbl_801A4C70                         /* constant-address: 801A4C70, symbol: lbl_801A4C70 */
/* 801A4C64  7C 00 E0 00 */	cmpw r0, r28                            
/* 801A4C68  40 82 00 08 */	bne lbl_801A4C70                         /* constant-address: 801A4C70, symbol: lbl_801A4C70 */
/* 801A4C6C  38 A0 00 02 */	li r5, 2                                
lbl_801A4C70:
/* 801A4C70  7F A3 EB 78 */	mr r3, r29                              
/* 801A4C74  7F 44 D3 78 */	mr r4, r26                              
/* 801A4C78  4B FF F7 A9 */	bl setLightTevColorType_MAJI_sub__FP11J3DMaterialP12dKy_tevstr_ci /* constant-address: 801A4420, symbol: setLightTevColorType_MAJI_sub__FP11J3DMaterialP12dKy_tevstr_ci */
/* 801A4C7C  7F C3 F3 78 */	mr r3, r30                              
/* 801A4C80  57 84 04 3E */	clrlwi r4, r28, 0x10                    
/* 801A4C84  48 13 9E 75 */	bl getName__10JUTNameTabCFUs             /* constant-address: 802DEAF8, symbol: getName__10JUTNameTabCFUs */
/* 801A4C88  88 03 00 03 */	lbz r0, 3(r3)                           
/* 801A4C8C  2C 00 00 4D */	cmpwi r0, 0x4d                          
/* 801A4C90  40 82 00 34 */	bne lbl_801A4CC4                         /* constant-address: 801A4CC4, symbol: lbl_801A4CC4 */
/* 801A4C94  88 03 00 04 */	lbz r0, 4(r3)                           
/* 801A4C98  2C 00 00 41 */	cmpwi r0, 0x41                          
/* 801A4C9C  40 82 00 28 */	bne lbl_801A4CC4                         /* constant-address: 801A4CC4, symbol: lbl_801A4CC4 */
/* 801A4CA0  88 03 00 05 */	lbz r0, 5(r3)                           
/* 801A4CA4  2C 00 00 30 */	cmpwi r0, 0x30                          
/* 801A4CA8  40 82 00 1C */	bne lbl_801A4CC4                         /* constant-address: 801A4CC4, symbol: lbl_801A4CC4 */
/* 801A4CAC  88 03 00 06 */	lbz r0, 6(r3)                           
/* 801A4CB0  7C 00 07 74 */	extsb r0, r0                            
/* 801A4CB4  2C 00 00 30 */	cmpwi r0, 0x30                          
/* 801A4CB8  41 82 00 24 */	beq lbl_801A4CDC                         /* constant-address: 801A4CDC, symbol: lbl_801A4CDC */
/* 801A4CBC  2C 00 00 31 */	cmpwi r0, 0x31                          
/* 801A4CC0  41 82 00 1C */	beq lbl_801A4CDC                         /* constant-address: 801A4CDC, symbol: lbl_801A4CDC */
lbl_801A4CC4:
/* 801A4CC4  88 03 00 05 */	lbz r0, 5(r3)                           
/* 801A4CC8  2C 00 00 31 */	cmpwi r0, 0x31                          
/* 801A4CCC  40 82 00 B0 */	bne lbl_801A4D7C                         /* constant-address: 801A4D7C, symbol: lbl_801A4D7C */
/* 801A4CD0  88 03 00 06 */	lbz r0, 6(r3)                           
/* 801A4CD4  2C 00 00 36 */	cmpwi r0, 0x36                          
/* 801A4CD8  40 82 00 A4 */	bne lbl_801A4D7C                         /* constant-address: 801A4D7C, symbol: lbl_801A4D7C */
lbl_801A4CDC:
/* 801A4CDC  88 03 00 06 */	lbz r0, 6(r3)                           
/* 801A4CE0  2C 00 00 30 */	cmpwi r0, 0x30                          
/* 801A4CE4  40 82 00 38 */	bne lbl_801A4D1C                         /* constant-address: 801A4D1C, symbol: lbl_801A4D1C */
/* 801A4CE8  88 1F 12 F8 */	lbz r0, 0x12f8(r31)                      /* constant-address: 8042DD4C, symbol: None */
...
/* 801A4D38  41 82 00 44 */	beq lbl_801A4D7C                         /* constant-address: 801A4D7C, symbol: lbl_801A4D7C */
...
/* 801A4D58  41 82 00 24 */	beq lbl_801A4D7C                         /* constant-address: 801A4D7C, symbol: lbl_801A4D7C */
/* 801A4D5C  80 9F 0E D0 */	lwz r4, 0xed0(r31)                       /* constant-address: 8042D924, symbol: None */
/* 801A4D60  28 04 00 00 */	cmplwi r4, 0                            
/* 801A4D64  41 82 00 18 */	beq lbl_801A4D7C                         /* constant-address: 801A4D7C, symbol: lbl_801A4D7C */
/* 801A4D68  C0 04 11 50 */	lfs f0, 0x1150(r4)                      
/* 801A4D6C  D0 03 00 1C */	stfs f0, 0x1c(r3)                       
/* 801A4D70  80 9F 0E D0 */	lwz r4, 0xed0(r31)                       /* constant-address: 8042D924, symbol: None */
...
/* 801A4D84  40 80 FE C4 */	bge lbl_801A4C48                         /* constant-address: 801A4C48, symbol: lbl_801A4C48 */
/* 801A4D88  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801A4D8C  48 1B D4 8D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

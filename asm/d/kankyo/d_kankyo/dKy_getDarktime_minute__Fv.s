...
/* 8019FB40  38 63 CA 54 */	addi r3, r3, g_env_light@l               /* constant-address: 8042CA54, symbol: g_env_light */
/* 8019FB44  48 00 00 89 */	bl getDarkDaytime__18dScnKy_env_light_cFv /* constant-address: 8019FBCC, symbol: getDarkDaytime__18dScnKy_env_light_cFv */
/* 8019FB48  C0 62 A2 BC */	lfs f3, lit_5554(r2)                     /* constant-address: 80453CBC, symbol: lit_5554 */
/* 8019FB4C  C0 42 A2 70 */	lfs f2, lit_4850(r2)                     /* constant-address: 80453C70, symbol: lit_4850 */
...
/* 8019FB64  38 63 E1 C0 */	addi r3, r3, 0xE1C0 /* 0x00E4E1C0@l */   /* constant-address: 00E4E1C0 */
/* 8019FB68  7C 04 1B D6 */	divw r0, r4, r3                         
/* 8019FB6C  7C 00 19 D6 */	mullw r0, r0, r3                        
/* 8019FB70  7C 00 20 50 */	subf r0, r0, r4                         
/* 8019FB74  C8 22 A2 30 */	lfd f1, lit_4444(r2)                     /* constant-address: 80453C30, symbol: lit_4444 */
...
/* 8019FB94  C0 02 A2 AC */	lfs f0, lit_5347(r2)                     /* constant-address: 80453CAC, symbol: lit_5347 */

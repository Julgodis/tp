...
/* 8005A364 00000024  3C 80 80 38 */	lis r4, stringBase0@ha
/* 8005A368 00000028  38 84 A3 68 */	addi r4, r4, stringBase0@l
...
/* 8005A380 00000040  3C 80 80 38 */	lis r4, stringBase0@ha
/* 8005A384 00000044  38 84 A3 68 */	addi r4, r4, stringBase0@l
...
/* 8005A39C 0000005C  3C 80 80 38 */	lis r4, stringBase0@ha
/* 8005A3A0 00000060  38 84 A3 68 */	addi r4, r4, stringBase0@l
...
/* 8005A3C0 00000080  C0 03 11 D8 */	lfs f0, 0x11d8(r3)	/* effective address: 8042DC2C */
...
/* 8005A3DC 00000010  3C 80 80 38 */	lis r4, stringBase0@ha
/* 8005A3E0 00000014  38 84 A3 68 */	addi r4, r4, stringBase0@l
...
/* 8005A3FC 00000030  C0 23 12 44 */	lfs f1, 0x1244(r3)	/* effective address: 8042DC98 */
/* 8005A400 00000034  C0 02 87 10 */	lfs f0, lit_4765(r2)
...
/* 8005A424 00000004  3C 80 80 38 */	lis r4, stringBase0@ha
/* 8005A428 00000008  38 84 A3 68 */	addi r4, r4, stringBase0@l
...
/* 8005A444 00000024  88 03 12 C9 */	lbz r0, 0x12c9(r3)	/* effective address: 8042DD1D */
...
/* 8005A468 0000000C  C0 22 86 E4 */	lfs f1, lit_4379(r2)
/* 8005A46C 00000010  C0 42 87 68 */	lfs f2, lit_5362(r2)
/* 8005A470 00000014  C0 62 87 6C */	lfs f3, lit_5363(r2)
/* 8005A474 00000018  C0 82 87 24 */	lfs f4, lit_4770(r2)
...
/* 8005A488 0000002C  98 03 0E B5 */	stb r0, 0xeb5(r3)	/* effective address: 8042D909 */
/* 8005A48C 00000030  38 00 00 31 */	li r0, 0x31
/* 8005A490 00000034  90 03 0E B8 */	stw r0, 0xeb8(r3)	/* effective address: 8042D90C */
...
/* 8005A4C0 00000028  C0 02 87 20 */	lfs f0, lit_4769(r2)
...
/* 8005A4D8 00000010  80 03 0E B8 */	lwz r0, 0xeb8(r3)	/* effective address: 8042D90C */
...
/* 8005A4F0 00000004  3C 80 80 38 */	lis r4, stringBase0@ha
/* 8005A4F4 00000008  38 84 A3 68 */	addi r4, r4, stringBase0@l
...
/* 8005A510 00000024  88 03 12 FE */	lbz r0, 0x12fe(r3)	/* effective address: 8042DD52 */
...
/* 8005A538 00000014  90 03 0E AC */	stw r0, 0xeac(r3)	/* effective address: 8042D900 */
...
/* 8005A54C 0000000C  90 03 0E AC */	stw r0, 0xeac(r3)	/* effective address: 8042D900 */
lbl_8005A550:
...
/* 8005A55C 0000000C  98 03 0E A9 */	stb r0, 0xea9(r3)	/* effective address: 8042D8FD */
lbl_8005A560:

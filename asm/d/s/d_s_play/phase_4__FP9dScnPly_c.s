...
/* 8025A684 00000030  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8025A6B8 00000008  80 63 5D 3C */	lwz r3, 0x5d3c(r3)	/* effective address: 8040BEFC */
...
/* 8025A6DC 00000018  90 04 5C F8 */	stw r0, 0x5cf8(r4)	/* effective address: 8040BEB8 */
...
/* 8025A70C 00000014  81 9E 14 00 */	lwz r12, 0x1400(r30)	/* effective address: 804084F8 */
...
/* 8025A774 0000007C  90 BF 5D AC */	stw r5, 0x5dac(r31)	/* effective address: 8040BF6C */
/* 8025A778 00000080  98 BF 5D B0 */	stb r5, 0x5db0(r31)	/* effective address: 8040BF70 */
...
/* 8025A7A0 00000018  C0 22 B5 28 */	lfs f1, lit_4068(r2)
/* 8025A7A4 0000001C  FC 40 08 90 */	fmr f2, f1
/* 8025A7A8 00000020  C0 62 B5 30 */	lfs f3, lit_4804(r2)
/* 8025A7AC 00000024  C0 82 B5 34 */	lfs f4, lit_4805(r2)
/* 8025A7B0 00000028  FC A0 08 90 */	fmr f5, f1
/* 8025A7B4 0000002C  C0 C2 B5 38 */	lfs f6, lit_4806(r2)
/* 8025A7B8 00000030  4B DF 73 09 */	bl setViewPort__14dDlst_window_cFffffff
/* 8025A7BC 00000034  7F 83 E3 78 */	mr r3, r28
/* 8025A7C0 00000038  C0 22 B5 28 */	lfs f1, lit_4068(r2)
/* 8025A7C4 0000003C  FC 40 08 90 */	fmr f2, f1
/* 8025A7C8 00000040  C0 62 B5 30 */	lfs f3, lit_4804(r2)
/* 8025A7CC 00000044  C0 82 B5 34 */	lfs f4, lit_4805(r2)
...
/* 8025A7E0 00000058  98 83 5D 70 */	stb r4, 0x5d70(r3)	/* effective address: 8040BF30 */
/* 8025A7E4 0000005C  38 00 00 02 */	li r0, 2
/* 8025A7E8 00000060  98 03 5D 71 */	stb r0, 0x5d71(r3)	/* effective address: 8040BF31 */
/* 8025A7EC 00000064  90 83 5D 74 */	stw r4, 0x5d74(r3)	/* effective address: 8040BF34 */
/* 8025A7F0 00000068  98 83 5D 78 */	stb r4, 0x5d78(r3)	/* effective address: 8040BF38 */
/* 8025A7F4 0000006C  98 83 5D 79 */	stb r4, 0x5d79(r3)	/* effective address: 8040BF39 */
/* 8025A7F8 00000070  38 00 FF FF */	li r0, -1
/* 8025A7FC 00000074  98 03 5D 7A */	stb r0, 0x5d7a(r3)	/* effective address: 8040BF3A */
/* 8025A800 00000078  90 83 5D 7C */	stw r4, 0x5d7c(r3)	/* effective address: 8040BF3C */
/* 8025A804 0000007C  90 83 61 A8 */	stw r4, 0x61a8(r3)	/* effective address: 8040C368 */
/* 8025A808 00000080  90 83 61 AC */	stw r4, 0x61ac(r3)	/* effective address: 8040C36C */
/* 8025A80C 00000084  90 83 61 B0 */	stw r4, 0x61b0(r3)	/* effective address: 8040C370 */
...
/* 8025A828 000000A0  90 64 5E BC */	stw r3, 0x5ebc(r4)	/* effective address: 8040C07C */
...
/* 8025A844 000000BC  90 64 5E C8 */	stw r3, 0x5ec8(r4)	/* effective address: 8040C088 */
...
/* 8025A88C 00000104  98 03 01 EB */	stb r0, 0x1eb(r3)	/* effective address: 804063AB */
/* 8025A890 00000108  38 00 00 0C */	li r0, 0xc
/* 8025A894 0000010C  B0 03 00 02 */	sth r0, 2(r3)	/* effective address: 804061C2 */
...
/* 8025A918 00000048  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 804307A0 */
/* 8025A91C 0000004C  3C 60 80 43 */	lis r3, g_save_bit_HIO@ha
/* 8025A920 00000050  38 63 07 EC */	addi r3, r3, g_save_bit_HIO@l
/* 8025A924 00000054  98 03 00 04 */	stb r0, 4(r3)	/* effective address: 804307F0 */
/* 8025A928 00000058  34 7E 47 80 */	addic. r3, r30, 0x4780
/* 8025A92C 0000005C  41 82 00 10 */	beq lbl_8025A93C
/* 8025A930 00000060  80 9F 5D AC */	lwz r4, 0x5dac(r31)	/* effective address: 8040BF6C */
...
/* 8025A9A4 00000068  80 84 00 00 */	lwz r4, 0(r4)	/* effective address: 8039A2C8 */

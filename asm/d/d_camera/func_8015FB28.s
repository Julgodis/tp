...
/* 8015FB38  40 82 00 28 */	bne lbl_8015FB60                         /* constant-address: 8015FB60, symbol: lbl_8015FB60 */
/* 8015FB3C  C0 45 00 00 */	lfs f2, 0(r5)                           
/* 8015FB40  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8015FB44  40 80 00 0C */	bge lbl_8015FB50                         /* constant-address: 8015FB50, symbol: lbl_8015FB50 */
/* 8015FB48  38 60 00 00 */	li r3, 0                                
/* 8015FB4C  4E 80 00 20 */	blr                                     
lbl_8015FB50:
/* 8015FB50  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8015FB54  40 81 00 38 */	ble lbl_8015FB8C                         /* constant-address: 8015FB8C, symbol: lbl_8015FB8C */
...
/* 8015FB6C  40 82 00 0C */	bne lbl_8015FB78                         /* constant-address: 8015FB78, symbol: lbl_8015FB78 */
/* 8015FB70  38 60 00 00 */	li r3, 0                                
/* 8015FB74  4E 80 00 20 */	blr                                     
lbl_8015FB78:
/* 8015FB78  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8015FB7C  4C 41 13 82 */	cror 2, 1, 2                            
/* 8015FB80  40 82 00 0C */	bne lbl_8015FB8C                         /* constant-address: 8015FB8C, symbol: lbl_8015FB8C */
...
/* 8015FB9C  40 82 00 28 */	bne lbl_8015FBC4                         /* constant-address: 8015FBC4, symbol: lbl_8015FBC4 */
/* 8015FBA0  C0 45 00 08 */	lfs f2, 8(r5)                           
/* 8015FBA4  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8015FBA8  40 80 00 0C */	bge lbl_8015FBB4                         /* constant-address: 8015FBB4, symbol: lbl_8015FBB4 */
/* 8015FBAC  38 60 00 00 */	li r3, 0                                
/* 8015FBB0  4E 80 00 20 */	blr                                     
lbl_8015FBB4:
/* 8015FBB4  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8015FBB8  40 81 00 38 */	ble lbl_8015FBF0                         /* constant-address: 8015FBF0, symbol: lbl_8015FBF0 */
...
/* 8015FBD0  40 82 00 0C */	bne lbl_8015FBDC                         /* constant-address: 8015FBDC, symbol: lbl_8015FBDC */
/* 8015FBD4  38 60 00 00 */	li r3, 0                                
/* 8015FBD8  4E 80 00 20 */	blr                                     
lbl_8015FBDC:
/* 8015FBDC  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8015FBE0  4C 41 13 82 */	cror 2, 1, 2                            
/* 8015FBE4  40 82 00 0C */	bne lbl_8015FBF0                         /* constant-address: 8015FBF0, symbol: lbl_8015FBF0 */

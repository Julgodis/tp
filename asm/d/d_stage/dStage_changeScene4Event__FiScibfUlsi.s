...
/* 80027308  48 33 AE C1 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 80027330  40 82 00 20 */	bne lbl_80027350                         /* constant-address: 80027350, symbol: lbl_80027350 */
/* 80027334  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80027338  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8002733C  85 83 4E 20 */	lwzu r12, 0x4e20(r3)                     /* constant-address: 8040AFE0, symbol: None */
/* 80027340  81 8C 00 C4 */	lwz r12, 0xc4(r12)                      
/* 80027344  7D 89 03 A6 */	mtctr r12                               
/* 80027348  4E 80 04 21 */	bctrl                                   
/* 8002734C  48 00 00 24 */	b lbl_80027370                           /* constant-address: 80027370, symbol: lbl_80027370 */
lbl_80027350:
/* 80027350  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80027354  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80027358  38 63 4E C4 */	addi r3, r3, 0x4ec4                      /* constant-address: 8040B084, symbol: None */
/* 8002735C  4B FF D0 29 */	bl getStatusRoomDt__20dStage_roomControl_cFi /* constant-address: 80024384, symbol: getStatusRoomDt__20dStage_roomControl_cFi */
/* 80027360  81 83 00 00 */	lwz r12, 0(r3)                           /* constant-address: 8040B084, symbol: None */
...
/* 80027374  40 82 00 28 */	bne lbl_8002739C                         /* constant-address: 8002739C, symbol: lbl_8002739C */
/* 80027378  3C 60 80 38 */	lis r3, d_d_stage__stringBase0@ha       
/* 8002737C  38 83 8A 50 */	addi r4, r3, d_d_stage__stringBase0@l    /* constant-address: 80378A50, symbol: d_d_stage__stringBase0 */
/* 80027380  38 64 01 3F */	addi r3, r4, 0x13f                       /* constant-address: 80378B8F, symbol: None */
/* 80027384  38 84 01 63 */	addi r4, r4, 0x163                       /* constant-address: 80378BB3, symbol: None */
/* 80027388  38 A0 13 01 */	li r5, 0x1301                           
/* 8002738C  4C C6 31 82 */	crclr 6                                 
/* 80027390  4B FD F8 7D */	bl OSReport_Error                        /* constant-address: 80006C0C, symbol: OSReport_Error */
/* 80027394  38 60 00 00 */	li r3, 0                                
/* 80027398  48 00 00 F8 */	b lbl_80027490                           /* constant-address: 80027490, symbol: lbl_80027490 */
lbl_8002739C:
/* 8002739C  80 63 00 04 */	lwz r3, 4(r3)                            /* constant-address: 8040B088, symbol: None */
/* 800273A0  1C 18 00 0D */	mulli r0, r24, 0xd                      
/* 800273A4  7F C3 02 14 */	add r30, r3, r0                         
/* 800273A8  2C 1D FF FF */	cmpwi r29, -1                           
/* 800273AC  40 82 00 0C */	bne lbl_800273B8                         /* constant-address: 800273B8, symbol: lbl_800273B8 */
/* 800273B0  8B FE 00 0C */	lbz r31, 0xc(r30)                       
/* 800273B4  48 00 00 08 */	b lbl_800273BC                           /* constant-address: 800273BC, symbol: lbl_800273BC */
lbl_800273B8:
/* 800273B8  7F BF EB 78 */	mr r31, r29                             
lbl_800273BC:
/* 800273BC  2C 1D FF FF */	cmpwi r29, -1                           
/* 800273C0  40 82 00 10 */	bne lbl_800273D0                         /* constant-address: 800273D0, symbol: lbl_800273D0 */
/* 800273C4  88 1E 00 0B */	lbz r0, 0xb(r30)                        
/* 800273C8  54 18 DF 7E */	rlwinm r24, r0, 0x1b, 0x1d, 0x1f        
/* 800273CC  48 00 00 08 */	b lbl_800273D4                           /* constant-address: 800273D4, symbol: lbl_800273D4 */
lbl_800273D0:
...
/* 800273F0  41 80 00 08 */	blt lbl_800273F8                         /* constant-address: 800273F8, symbol: lbl_800273F8 */
/* 800273F4  3B A0 FF FF */	li r29, -1                              
lbl_800273F8:
/* 800273F8  2C 1D FF FF */	cmpwi r29, -1                           
/* 800273FC  40 82 00 10 */	bne lbl_8002740C                         /* constant-address: 8002740C, symbol: lbl_8002740C */
/* 80027400  2C 1C FF FF */	cmpwi r28, -1                           
/* 80027404  41 82 00 08 */	beq lbl_8002740C                         /* constant-address: 8002740C, symbol: lbl_8002740C */
/* 80027408  7F 9D E3 78 */	mr r29, r28                             
lbl_8002740C:
/* 8002740C  2C 04 00 1F */	cmpwi r4, 0x1f                          
/* 80027410  40 80 00 2C */	bge lbl_8002743C                         /* constant-address: 8002743C, symbol: lbl_8002743C */
/* 80027414  C0 42 82 94 */	lfs f2, lit_5315(r2)                     /* constant-address: 80451C94, symbol: lit_5315 */
/* 80027418  C8 22 82 98 */	lfd f1, lit_5317(r2)                     /* constant-address: 80451C98, symbol: lit_5317 */
...
/* 80027438  48 18 17 21 */	bl dKy_set_nexttime__Ff                  /* constant-address: 801A8B58, symbol: dKy_set_nexttime__Ff */
lbl_8002743C:
...
/* 80027488  48 00 5E 75 */	bl dComIfGp_setNextStage__FPCcsScScfUliScsii /* constant-address: 8002D2FC, symbol: dComIfGp_setNextStage__FPCcsScScfUliScsii */
...
/* 8002749C  48 33 AD 79 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

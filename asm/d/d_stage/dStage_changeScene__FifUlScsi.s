...
/* 80027188  48 33 B0 45 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 800271A8  40 82 00 20 */	bne lbl_800271C8                         /* constant-address: 800271C8, symbol: lbl_800271C8 */
/* 800271AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800271B0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800271B4  85 83 4E 20 */	lwzu r12, 0x4e20(r3)                     /* constant-address: 8040AFE0, symbol: None */
/* 800271B8  81 8C 00 C4 */	lwz r12, 0xc4(r12)                      
/* 800271BC  7D 89 03 A6 */	mtctr r12                               
/* 800271C0  4E 80 04 21 */	bctrl                                   
/* 800271C4  48 00 00 24 */	b lbl_800271E8                           /* constant-address: 800271E8, symbol: lbl_800271E8 */
lbl_800271C8:
/* 800271C8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800271CC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800271D0  38 63 4E C4 */	addi r3, r3, 0x4ec4                      /* constant-address: 8040B084, symbol: None */
/* 800271D4  4B FF D1 B1 */	bl getStatusRoomDt__20dStage_roomControl_cFi /* constant-address: 80024384, symbol: getStatusRoomDt__20dStage_roomControl_cFi */
/* 800271D8  81 83 00 00 */	lwz r12, 0(r3)                           /* constant-address: 8040B084, symbol: None */
...
/* 800271EC  40 82 00 0C */	bne lbl_800271F8                         /* constant-address: 800271F8, symbol: lbl_800271F8 */
/* 800271F0  38 60 00 00 */	li r3, 0                                
/* 800271F4  48 00 00 CC */	b lbl_800272C0                           /* constant-address: 800272C0, symbol: lbl_800272C0 */
lbl_800271F8:
/* 800271F8  80 63 00 04 */	lwz r3, 4(r3)                            /* constant-address: 8040B088, symbol: None */
...
/* 80027228  41 80 00 08 */	blt lbl_80027230                         /* constant-address: 80027230, symbol: lbl_80027230 */
/* 8002722C  3B 20 FF FF */	li r25, -1                              
lbl_80027230:
/* 80027230  2C 19 FF FF */	cmpwi r25, -1                           
/* 80027234  40 82 00 10 */	bne lbl_80027244                         /* constant-address: 80027244, symbol: lbl_80027244 */
/* 80027238  2C 1F FF FF */	cmpwi r31, -1                           
/* 8002723C  41 82 00 08 */	beq lbl_80027244                         /* constant-address: 80027244, symbol: lbl_80027244 */
/* 80027240  7F F9 FB 78 */	mr r25, r31                             
lbl_80027244:
/* 80027244  2C 04 00 1F */	cmpwi r4, 0x1f                          
/* 80027248  40 80 00 2C */	bge lbl_80027274                         /* constant-address: 80027274, symbol: lbl_80027274 */
/* 8002724C  C0 42 82 94 */	lfs f2, lit_5315(r2)                     /* constant-address: 80451C94, symbol: lit_5315 */
/* 80027250  C8 22 82 98 */	lfd f1, lit_5317(r2)                     /* constant-address: 80451C98, symbol: lit_5317 */
...
/* 80027270  48 18 18 E9 */	bl dKy_set_nexttime__Ff                  /* constant-address: 801A8B58, symbol: dKy_set_nexttime__Ff */
lbl_80027274:
...
/* 800272B8  48 00 60 45 */	bl dComIfGp_setNextStage__FPCcsScScfUliScsii /* constant-address: 8002D2FC, symbol: dComIfGp_setNextStage__FPCcsScScfUliScsii */
...
/* 800272CC  48 33 AF 4D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

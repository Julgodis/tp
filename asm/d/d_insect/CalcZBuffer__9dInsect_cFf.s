...
/* 8015E2B4  C0 02 9B E0 */	lfs f0, lit_3871(r2)                     /* constant-address: 804535E0, symbol: lit_3871 */
...
/* 8015E2C8  4B EB 70 49 */	bl mDoLib_project__FP3VecP3Vec           /* constant-address: 80015310, symbol: mDoLib_project__FP3VecP3Vec */
/* 8015E2CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015E2D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015E2D4  80 63 5D 74 */	lwz r3, 0x5d74(r3)                       /* constant-address: 8040BF34, symbol: None */
/* 8015E2D8  28 03 00 00 */	cmplwi r3, 0                            
/* 8015E2DC  41 82 00 0C */	beq lbl_8015E2E8                         /* constant-address: 8015E2E8, symbol: lbl_8015E2E8 */
/* 8015E2E0  C0 63 0B 68 */	lfs f3, 0xb68(r3)                       
/* 8015E2E4  48 00 00 08 */	b lbl_8015E2EC                           /* constant-address: 8015E2EC, symbol: lbl_8015E2EC */
lbl_8015E2E8:
/* 8015E2E8  C0 62 9B E4 */	lfs f3, lit_3872(r2)                     /* constant-address: 804535E4, symbol: lit_3872 */
lbl_8015E2EC:
/* 8015E2EC  C0 21 00 14 */	lfs f1, 0x14(r1)                        
/* 8015E2F0  C0 02 9B E4 */	lfs f0, lit_3872(r2)                     /* constant-address: 804535E4, symbol: lit_3872 */
/* 8015E2F4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E2F8  40 81 00 60 */	ble lbl_8015E358                         /* constant-address: 8015E358, symbol: lbl_8015E358 */
/* 8015E2FC  C0 02 9B E8 */	lfs f0, lit_3873(r2)                     /* constant-address: 804535E8, symbol: lit_3873 */
/* 8015E300  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E304  40 80 00 54 */	bge lbl_8015E358                         /* constant-address: 8015E358, symbol: lbl_8015E358 */
/* 8015E308  C0 41 00 18 */	lfs f2, 0x18(r1)                        
/* 8015E30C  FC 02 18 40 */	fcmpo cr0, f2, f3                       
/* 8015E310  40 81 00 48 */	ble lbl_8015E358                         /* constant-address: 8015E358, symbol: lbl_8015E358 */
/* 8015E314  C0 02 9B EC */	lfs f0, lit_3874(r2)                     /* constant-address: 804535EC, symbol: lit_3874 */
/* 8015E318  EC 00 18 28 */	fsubs f0, f0, f3                        
/* 8015E31C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8015E320  40 80 00 38 */	bge lbl_8015E358                         /* constant-address: 8015E358, symbol: lbl_8015E358 */
/* 8015E324  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015E328  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
...
/* 8015E350  4B EF 7C C9 */	bl newData__13dDlst_peekZ_cFssPUl        /* constant-address: 80056018, symbol: newData__13dDlst_peekZ_cFssPUl */
/* 8015E354  48 00 00 0C */	b lbl_8015E360                           /* constant-address: 8015E360, symbol: lbl_8015E360 */
lbl_8015E358:
/* 8015E358  38 00 00 00 */	li r0, 0                                
/* 8015E35C  90 1F 05 78 */	stw r0, 0x578(r31)                      
lbl_8015E360:
/* 8015E360  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015E364  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015E368  80 63 61 B0 */	lwz r3, 0x61b0(r3)                       /* constant-address: 8040C370, symbol: None */
...
/* 8015E37C  4B EB 71 71 */	bl mDoLib_pos2camera__FP3VecP3Vec        /* constant-address: 800154EC, symbol: mDoLib_pos2camera__FP3VecP3Vec */
/* 8015E380  C0 01 00 1C */	lfs f0, 0x1c(r1)                        
/* 8015E384  EC 20 E8 2A */	fadds f1, f0, f29                       
/* 8015E388  D0 21 00 1C */	stfs f1, 0x1c(r1)                       
/* 8015E38C  C0 02 9B E4 */	lfs f0, lit_3872(r2)                     /* constant-address: 804535E4, symbol: lit_3872 */
/* 8015E390  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8015E394  40 82 00 0C */	bne lbl_8015E3A0                         /* constant-address: 8015E3A0, symbol: lbl_8015E3A0 */
/* 8015E398  C0 02 9B F0 */	lfs f0, lit_3875(r2)                     /* constant-address: 804535F0, symbol: lit_3875 */
/* 8015E39C  D0 01 00 1C */	stfs f0, 0x1c(r1)                       
lbl_8015E3A0:
/* 8015E3A0  C0 62 9B F4 */	lfs f3, lit_3876(r2)                     /* constant-address: 804535F4, symbol: lit_3876 */
/* 8015E3A4  C0 42 9B F8 */	lfs f2, lit_3877(r2)                     /* constant-address: 804535F8, symbol: lit_3877 */

...
/* 8018D69C  48 1D 4B 35 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 8018D6A0  7C 7A 1B 78 */	mr r26, r3                              
/* 8018D6A4  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 8018D6A8  28 00 00 FF */	cmplwi r0, 0xff                         
/* 8018D6AC  40 82 00 0C */	bne lbl_8018D6B8                         /* constant-address: 8018D6B8, symbol: lbl_8018D6B8 */
/* 8018D6B0  38 60 00 01 */	li r3, 1                                
/* 8018D6B4  48 00 00 98 */	b lbl_8018D74C                           /* constant-address: 8018D74C, symbol: lbl_8018D74C */
lbl_8018D6B8:
...
/* 8018D6DC  48 0C 81 9D */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018D6FC  48 0C 81 7D */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018D71C  48 0C 81 5D */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018D720  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 8018D724  28 00 00 01 */	cmplwi r0, 1                            
/* 8018D728  40 82 00 20 */	bne lbl_8018D748                         /* constant-address: 8018D748, symbol: lbl_8018D748 */
/* 8018D72C  57 E0 06 3E */	clrlwi r0, r31, 0x18                    
/* 8018D730  28 00 00 01 */	cmplwi r0, 1                            
/* 8018D734  40 82 00 14 */	bne lbl_8018D748                         /* constant-address: 8018D748, symbol: lbl_8018D748 */
/* 8018D738  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018D73C  28 00 00 01 */	cmplwi r0, 1                            
/* 8018D740  40 82 00 08 */	bne lbl_8018D748                         /* constant-address: 8018D748, symbol: lbl_8018D748 */
/* 8018D744  3B 60 00 01 */	li r27, 1                               
lbl_8018D748:
/* 8018D748  7F 63 DB 78 */	mr r3, r27                              
lbl_8018D74C:
/* 8018D74C  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8018D750  48 1D 4A CD */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

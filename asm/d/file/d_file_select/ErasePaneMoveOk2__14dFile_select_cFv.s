...
/* 8018A2EC  48 1D 7E F1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8018A2F0  7C 7F 1B 78 */	mr r31, r3                              
/* 8018A2F4  48 00 2F 69 */	bl headerTxtChangeAnm__14dFile_select_cFv /* constant-address: 8018D25C, symbol: headerTxtChangeAnm__14dFile_select_cFv */
...
/* 8018A310  38 84 C9 EC */	addi r4, r4, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A314  88 84 00 07 */	lbz r4, 7(r4)                            /* constant-address: 8042C9F3, symbol: None */
/* 8018A318  38 A0 00 00 */	li r5, 0                                
/* 8018A31C  38 C0 00 FF */	li r6, 0xff                             
/* 8018A320  38 E0 00 00 */	li r7, 0                                
/* 8018A324  48 0C B5 55 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018A328  7C 7E 1B 78 */	mr r30, r3                              
/* 8018A32C  7F E3 FB 78 */	mr r3, r31                              
/* 8018A330  88 9F 02 65 */	lbz r4, 0x265(r31)                      
/* 8018A334  48 00 33 59 */	bl selectWakuAlpahAnm__14dFile_select_cFUc /* constant-address: 8018D68C, symbol: selectWakuAlpahAnm__14dFile_select_cFUc */
...
/* 8018A354  40 82 00 44 */	bne lbl_8018A398                         /* constant-address: 8018A398, symbol: lbl_8018A398 */
/* 8018A358  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 8018A35C  28 00 00 01 */	cmplwi r0, 1                            
/* 8018A360  40 82 00 38 */	bne lbl_8018A398                         /* constant-address: 8018A398, symbol: lbl_8018A398 */
/* 8018A364  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018A368  28 00 00 01 */	cmplwi r0, 1                            
/* 8018A36C  40 82 00 2C */	bne lbl_8018A398                         /* constant-address: 8018A398, symbol: lbl_8018A398 */
/* 8018A370  28 04 00 01 */	cmplwi r4, 1                            
/* 8018A374  40 82 00 24 */	bne lbl_8018A398                         /* constant-address: 8018A398, symbol: lbl_8018A398 */
/* 8018A378  3C 60 80 43 */	lis r3, g_fsHIO@ha                      
/* 8018A37C  38 63 C9 EC */	addi r3, r3, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A380  88 03 00 0A */	lbz r0, 0xa(r3)                          /* constant-address: 8042C9F6, symbol: None */
...
/* 8018A39C  48 1D 7E 8D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

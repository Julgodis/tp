...
/* 8018F664  48 00 06 CD */	bl errorTxtChangeAnm__14dFile_select_cFv /* constant-address: 8018FD30, symbol: errorTxtChangeAnm__14dFile_select_cFv */
/* 8018F668  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018F66C  28 00 00 01 */	cmplwi r0, 1                            
/* 8018F670  40 82 00 58 */	bne lbl_8018F6C8                         /* constant-address: 8018F6C8, symbol: lbl_8018F6C8 */
/* 8018F674  3C 60 80 3A */	lis r3, __ptmf_null@ha                  
/* 8018F678  38 83 21 80 */	addi r4, r3, __ptmf_null@l               /* constant-address: 803A2180, symbol: __ptmf_null */
/* 8018F67C  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 803A2180, symbol: __ptmf_null */
/* 8018F680  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A2184, symbol: None */
/* 8018F684  90 7F 02 84 */	stw r3, 0x284(r31)                      
/* 8018F688  90 1F 02 88 */	stw r0, 0x288(r31)                      
/* 8018F68C  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803A2188, symbol: None */
/* 8018F690  90 1F 02 8C */	stw r0, 0x28c(r31)                      
/* 8018F694  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 803A2180, symbol: __ptmf_null */
/* 8018F698  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 803A2184, symbol: None */
/* 8018F69C  90 7F 02 90 */	stw r3, 0x290(r31)                      
/* 8018F6A0  90 1F 02 94 */	stw r0, 0x294(r31)                      
/* 8018F6A4  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 803A2188, symbol: None */

...
/* 8018EBE8  41 82 00 10 */	beq lbl_8018EBF8                         /* constant-address: 8018EBF8, symbol: lbl_8018EBF8 */
/* 8018EBEC  38 03 FF FF */	addi r0, r3, -1                         
/* 8018EBF0  B0 1F 03 AC */	sth r0, 0x3ac(r31)                      
/* 8018EBF4  48 00 00 44 */	b lbl_8018EC38                           /* constant-address: 8018EC38, symbol: lbl_8018EC38 */
lbl_8018EBF8:
/* 8018EBF8  38 00 00 01 */	li r0, 1                                
/* 8018EBFC  98 1F 23 75 */	stb r0, 0x2375(r31)                     
/* 8018EC00  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 8018EC04  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8018EC08  28 03 00 00 */	cmplwi r3, 0                            
/* 8018EC0C  41 82 00 18 */	beq lbl_8018EC24                         /* constant-address: 8018EC24, symbol: lbl_8018EC24 */
...
/* 8018EC30  80 6D 86 F8 */	lwz r3, mResetData__6mDoRst(r13)         /* constant-address: 80450C78, symbol: mResetData__6mDoRst */

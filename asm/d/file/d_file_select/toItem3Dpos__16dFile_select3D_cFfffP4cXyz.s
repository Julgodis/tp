...
/* 80191018  C0 82 9F BC */	lfs f4, lit_8978(r2)                     /* constant-address: 804539BC, symbol: lit_8978 */
/* 8019101C  C0 02 9F 48 */	lfs f0, lit_4778(r2)                     /* constant-address: 80453948, symbol: lit_4778 */
/* 80191020  EC 21 00 28 */	fsubs f1, f1, f0                        
/* 80191024  C0 02 9F A4 */	lfs f0, lit_6879(r2)                     /* constant-address: 804539A4, symbol: lit_6879 */
/* 80191028  EC 01 00 24 */	fdivs f0, f1, f0                        
/* 8019102C  EC 04 00 32 */	fmuls f0, f4, f0                        
/* 80191030  C0 62 9F 40 */	lfs f3, lit_4611(r2)                     /* constant-address: 80453940, symbol: lit_4611 */
/* 80191034  EF A0 18 28 */	fsubs f29, f0, f3                       
/* 80191038  C0 02 9F C0 */	lfs f0, lit_8979(r2)                     /* constant-address: 804539C0, symbol: lit_8979 */
/* 8019103C  EC 22 00 28 */	fsubs f1, f2, f0                        
/* 80191040  C0 02 9F A8 */	lfs f0, lit_6880(r2)                     /* constant-address: 804539A8, symbol: lit_6880 */
...
/* 80191054  48 00 00 81 */	bl calcViewMtx__16dFile_select3D_cFPA4_f /* constant-address: 801910D4, symbol: calcViewMtx__16dFile_select3D_cFPA4_f */
/* 80191058  38 61 00 44 */	addi r3, r1, 0x44                       
/* 8019105C  38 81 00 14 */	addi r4, r1, 0x14                       
/* 80191060  48 1B 55 51 */	bl PSMTXInverse                          /* constant-address: 803465B0, symbol: PSMTXInverse */
/* 80191064  C8 22 9F C8 */	lfd f1, lit_8980(r2)                     /* constant-address: 804539C8, symbol: lit_8980 */
/* 80191068  48 1D B6 01 */	bl tan                                   /* constant-address: 8036C668, symbol: tan */
/* 8019106C  FC 40 08 18 */	frsp f2, f1                             
/* 80191070  FC 60 F8 50 */	fneg f3, f31                            
/* 80191074  EC 3D 07 F2 */	fmuls f1, f29, f31                      
/* 80191078  C0 02 9F D0 */	lfs f0, lit_8981(r2)                     /* constant-address: 804539D0, symbol: lit_8981 */
...
/* 801910A4  48 1B 5C C9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */

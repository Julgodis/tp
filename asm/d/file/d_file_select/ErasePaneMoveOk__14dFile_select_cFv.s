...
/* 8018A1A4  48 1D 80 39 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8018A1C0  3B C4 C9 EC */	addi r30, r4, g_fsHIO@l                  /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A1C4  88 9E 00 09 */	lbz r4, 9(r30)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A1C8  38 A0 00 FF */	li r5, 0xff                             
/* 8018A1CC  38 C0 00 00 */	li r6, 0                                
/* 8018A1D0  38 E0 00 00 */	li r7, 0                                
/* 8018A1D4  48 0C B6 A5 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018A1EC  41 82 00 2C */	beq lbl_8018A218                         /* constant-address: 8018A218, symbol: lbl_8018A218 */
/* 8018A1F0  54 80 10 3A */	slwi r0, r4, 2                          
/* 8018A1F4  7C 7F 02 14 */	add r3, r31, r0                         
/* 8018A1F8  80 63 02 2C */	lwz r3, 0x22c(r3)                       
/* 8018A1FC  88 9E 00 09 */	lbz r4, 9(r30)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A200  38 A0 00 FF */	li r5, 0xff                             
/* 8018A204  38 C0 00 00 */	li r6, 0                                
/* 8018A208  38 E0 00 00 */	li r7, 0                                
/* 8018A20C  48 0C B6 6D */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018A210  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018A214  48 00 00 28 */	b lbl_8018A23C                           /* constant-address: 8018A23C, symbol: lbl_8018A23C */
lbl_8018A218:
/* 8018A218  54 80 10 3A */	slwi r0, r4, 2                          
/* 8018A21C  7C 7F 02 14 */	add r3, r31, r0                         
/* 8018A220  80 63 02 20 */	lwz r3, 0x220(r3)                       
/* 8018A224  88 9E 00 09 */	lbz r4, 9(r30)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A228  38 A0 00 FF */	li r5, 0xff                             
/* 8018A22C  38 C0 00 00 */	li r6, 0                                
/* 8018A230  38 E0 00 00 */	li r7, 0                                
/* 8018A234  48 0C B6 45 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018A238  54 60 06 3E */	clrlwi r0, r3, 0x18                     
lbl_8018A23C:
/* 8018A23C  2C 1D 00 01 */	cmpwi r29, 1                            
/* 8018A240  40 82 00 84 */	bne lbl_8018A2C4                         /* constant-address: 8018A2C4, symbol: lbl_8018A2C4 */
/* 8018A244  2C 00 00 01 */	cmpwi r0, 1                             
/* 8018A248  40 82 00 7C */	bne lbl_8018A2C4                         /* constant-address: 8018A2C4, symbol: lbl_8018A2C4 */
/* 8018A24C  38 00 00 00 */	li r0, 0                                
/* 8018A250  98 1F 02 08 */	stb r0, 0x208(r31)                      
/* 8018A254  7F E3 FB 78 */	mr r3, r31                              
/* 8018A258  48 00 2D ED */	bl setSaveData__14dFile_select_cFv       /* constant-address: 8018D044, symbol: setSaveData__14dFile_select_cFv */
/* 8018A25C  7F E3 FB 78 */	mr r3, r31                              
/* 8018A260  88 9F 02 65 */	lbz r4, 0x265(r31)                      
/* 8018A264  4B FF BE 25 */	bl makeRecInfo__14dFile_select_cFUc      /* constant-address: 80186088, symbol: makeRecInfo__14dFile_select_cFUc */
/* 8018A268  7F E3 FB 78 */	mr r3, r31                              
/* 8018A26C  38 80 00 4B */	li r4, 0x4b                             
/* 8018A270  38 A0 00 00 */	li r5, 0                                
/* 8018A274  38 C0 00 00 */	li r6, 0                                
/* 8018A278  48 00 2E 6D */	bl headerTxtSet__14dFile_select_cFUsUcUc /* constant-address: 8018D0E4, symbol: headerTxtSet__14dFile_select_cFUsUcUc */
/* 8018A27C  80 7F 00 6C */	lwz r3, 0x6c(r31)                       
/* 8018A280  48 00 7E 8D */	bl closeInit__15dFile_warning_cFv        /* constant-address: 8019210C, symbol: closeInit__15dFile_warning_cFv */
...
/* 8018A2B0  38 E7 C9 EC */	addi r7, r7, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A2B4  88 E7 00 07 */	lbz r7, 7(r7)                            /* constant-address: 8042C9F3, symbol: None */
/* 8018A2B8  48 00 33 99 */	bl selectWakuAlpahAnmInit__14dFile_select_cFUcUcUcUc /* constant-address: 8018D650, symbol: selectWakuAlpahAnmInit__14dFile_select_cFUcUcUcUc */
/* 8018A2BC  38 00 00 26 */	li r0, 0x26                             
/* 8018A2C0  98 1F 02 6F */	stb r0, 0x26f(r31)                      
lbl_8018A2C4:
/* 8018A2C4  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8018A2C8  48 1D 7F 61 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 80186FA8  48 1D B2 35 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 80186FBC  41 82 00 CC */	beq lbl_80187088                         /* constant-address: 80187088, symbol: lbl_80187088 */
/* 80186FC0  54 00 15 BA */	rlwinm r0, r0, 2, 0x16, 0x1d            
/* 80186FC4  7C BE 02 14 */	add r5, r30, r0                         
/* 80186FC8  80 85 03 4C */	lwz r4, 0x34c(r5)                       
/* 80186FCC  3C 60 80 3C */	lis r3, MenuSelStartFrameTbl@ha         
/* 80186FD0  38 63 A8 84 */	addi r3, r3, MenuSelStartFrameTbl@l      /* constant-address: 803BA884, symbol: MenuSelStartFrameTbl */
/* 80186FD4  7C 03 00 2E */	lwzx r0, r3, r0                         
/* 80186FD8  7C 04 00 00 */	cmpw r4, r0                             
/* 80186FDC  41 82 00 AC */	beq lbl_80187088                         /* constant-address: 80187088, symbol: lbl_80187088 */
/* 80186FE0  40 81 00 30 */	ble lbl_80187010                         /* constant-address: 80187010, symbol: lbl_80187010 */
...
/* 80187004  40 80 00 34 */	bge lbl_80187038                         /* constant-address: 80187038, symbol: lbl_80187038 */
/* 80187008  90 65 03 4C */	stw r3, 0x34c(r5)                       
/* 8018700C  48 00 00 2C */	b lbl_80187038                           /* constant-address: 80187038, symbol: lbl_80187038 */
lbl_80187010:
...
/* 80187030  40 81 00 08 */	ble lbl_80187038                         /* constant-address: 80187038, symbol: lbl_80187038 */
...
/* 80187048  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80187080  48 17 0F 4D */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
...
/* 80187098  41 82 00 D8 */	beq lbl_80187170                         /* constant-address: 80187170, symbol: lbl_80187170 */
/* 8018709C  54 00 15 BA */	rlwinm r0, r0, 2, 0x16, 0x1d            
/* 801870A0  7C BE 02 14 */	add r5, r30, r0                         
/* 801870A4  80 85 03 4C */	lwz r4, 0x34c(r5)                       
/* 801870A8  3C 60 80 3C */	lis r3, MenuSelEndFrameTbl@ha           
/* 801870AC  38 63 A8 90 */	addi r3, r3, MenuSelEndFrameTbl@l        /* constant-address: 803BA890, symbol: MenuSelEndFrameTbl */
/* 801870B0  7C 03 00 2E */	lwzx r0, r3, r0                         
/* 801870B4  7C 04 00 00 */	cmpw r4, r0                             
/* 801870B8  41 82 00 AC */	beq lbl_80187164                         /* constant-address: 80187164, symbol: lbl_80187164 */
/* 801870BC  40 80 00 30 */	bge lbl_801870EC                         /* constant-address: 801870EC, symbol: lbl_801870EC */
...
/* 801870E0  40 81 00 34 */	ble lbl_80187114                         /* constant-address: 80187114, symbol: lbl_80187114 */
/* 801870E4  90 65 03 4C */	stw r3, 0x34c(r5)                       
/* 801870E8  48 00 00 2C */	b lbl_80187114                           /* constant-address: 80187114, symbol: lbl_80187114 */
lbl_801870EC:
...
/* 8018710C  40 80 00 08 */	bge lbl_80187114                         /* constant-address: 80187114, symbol: lbl_80187114 */
...
/* 80187124  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 8018715C  48 17 0E 71 */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
/* 80187160  3B A0 00 00 */	li r29, 0                               
lbl_80187164:
/* 80187164  7F C3 F3 78 */	mr r3, r30                              
/* 80187168  88 9E 02 66 */	lbz r4, 0x266(r30)                      
/* 8018716C  48 00 67 5D */	bl menuWakuAlpahAnm__14dFile_select_cFUc /* constant-address: 8018D8C8, symbol: menuWakuAlpahAnm__14dFile_select_cFUc */
lbl_80187170:
/* 80187170  57 E0 06 3E */	clrlwi r0, r31, 0x18                    
/* 80187174  28 00 00 01 */	cmplwi r0, 1                            
/* 80187178  40 82 00 8C */	bne lbl_80187204                         /* constant-address: 80187204, symbol: lbl_80187204 */
/* 8018717C  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 80187180  28 00 00 01 */	cmplwi r0, 1                            
/* 80187184  40 82 00 80 */	bne lbl_80187204                         /* constant-address: 80187204, symbol: lbl_80187204 */
/* 80187188  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018718C  28 00 00 01 */	cmplwi r0, 1                            
/* 80187190  40 82 00 74 */	bne lbl_80187204                         /* constant-address: 80187204, symbol: lbl_80187204 */
/* 80187194  88 1E 02 67 */	lbz r0, 0x267(r30)                      
/* 80187198  28 00 00 FF */	cmplwi r0, 0xff                         
/* 8018719C  41 82 00 30 */	beq lbl_801871CC                         /* constant-address: 801871CC, symbol: lbl_801871CC */
...
/* 801871C8  48 00 68 49 */	bl menuCursorShow__14dFile_select_cFv    /* constant-address: 8018DA10, symbol: menuCursorShow__14dFile_select_cFv */
lbl_801871CC:
/* 801871CC  88 1E 02 66 */	lbz r0, 0x266(r30)                      
/* 801871D0  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801871D4  41 82 00 28 */	beq lbl_801871FC                         /* constant-address: 801871FC, symbol: lbl_801871FC */
...
/* 80187208  48 1D B0 21 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

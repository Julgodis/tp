...
/* 8018FD40  48 1D 24 99 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8018FD44  7C 7F 1B 78 */	mr r31, r3                              
/* 8018FD48  88 03 01 49 */	lbz r0, 0x149(r3)                       
/* 8018FD4C  28 00 00 00 */	cmplwi r0, 0                            
/* 8018FD50  41 82 00 0C */	beq lbl_8018FD5C                         /* constant-address: 8018FD5C, symbol: lbl_8018FD5C */
/* 8018FD54  38 60 00 01 */	li r3, 1                                
/* 8018FD58  48 00 00 A8 */	b lbl_8018FE00                           /* constant-address: 8018FE00, symbol: lbl_8018FE00 */
lbl_8018FD5C:
...
/* 8018FD74  3B A4 C9 EC */	addi r29, r4, g_fsHIO@l                  /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018FD78  88 9D 00 07 */	lbz r4, 7(r29)                           /* constant-address: 8042C9F3, symbol: None */
/* 8018FD7C  38 A0 00 FF */	li r5, 0xff                             
/* 8018FD80  38 C0 00 00 */	li r6, 0                                
/* 8018FD84  38 E0 00 00 */	li r7, 0                                
/* 8018FD88  48 0C 5A F1 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018FDA4  88 9D 00 07 */	lbz r4, 7(r29)                           /* constant-address: 8042C9F3, symbol: None */
/* 8018FDA8  38 A0 00 00 */	li r5, 0                                
/* 8018FDAC  38 C0 00 FF */	li r6, 0xff                             
/* 8018FDB0  38 E0 00 00 */	li r7, 0                                
/* 8018FDB4  48 0C 5A C5 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018FDB8  3C 80 80 43 */	lis r4, g_meter2_info@ha                
/* 8018FDBC  38 84 01 88 */	addi r4, r4, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8018FDC0  A8 84 00 94 */	lha r4, 0x94(r4)                         /* constant-address: 8043021C, symbol: None */
/* 8018FDC4  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 8018FDC8  28 00 00 01 */	cmplwi r0, 1                            
/* 8018FDCC  40 82 00 30 */	bne lbl_8018FDFC                         /* constant-address: 8018FDFC, symbol: lbl_8018FDFC */
/* 8018FDD0  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018FDD4  28 00 00 01 */	cmplwi r0, 1                            
/* 8018FDD8  40 82 00 24 */	bne lbl_8018FDFC                         /* constant-address: 8018FDFC, symbol: lbl_8018FDFC */
/* 8018FDDC  2C 04 00 00 */	cmpwi r4, 0                             
/* 8018FDE0  40 82 00 1C */	bne lbl_8018FDFC                         /* constant-address: 8018FDFC, symbol: lbl_8018FDFC */
...
/* 8018FE04  48 1D 24 21 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

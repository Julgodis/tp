...
/* 80184684  41 80 00 0C */	blt lbl_80184690                         /* constant-address: 80184690, symbol: lbl_80184690 */
/* 80184688  7C 00 20 50 */	subf r0, r0, r4                         
/* 8018468C  90 03 01 CC */	stw r0, 0x1cc(r3)                       
lbl_80184690:
/* 80184690  80 03 01 CC */	lwz r0, 0x1cc(r3)                       
/* 80184694  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 801846D4  41 80 00 0C */	blt lbl_801846E0                         /* constant-address: 801846E0, symbol: lbl_801846E0 */
/* 801846D8  7C 00 20 50 */	subf r0, r0, r4                         
/* 801846DC  90 03 01 D4 */	stw r0, 0x1d4(r3)                       
lbl_801846E0:
/* 801846E0  80 03 01 D4 */	lwz r0, 0x1d4(r3)                       
/* 801846E4  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80184724  41 80 00 0C */	blt lbl_80184730                         /* constant-address: 80184730, symbol: lbl_80184730 */
/* 80184728  7C 00 20 50 */	subf r0, r0, r4                         
/* 8018472C  90 03 03 1C */	stw r0, 0x31c(r3)                       
lbl_80184730:
/* 80184730  80 03 03 1C */	lwz r0, 0x31c(r3)                       
/* 80184734  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80184774  41 80 00 0C */	blt lbl_80184780                         /* constant-address: 80184780, symbol: lbl_80184780 */
/* 80184778  7C 00 20 50 */	subf r0, r0, r4                         
/* 8018477C  90 03 03 24 */	stw r0, 0x324(r3)                       
lbl_80184780:
/* 80184780  80 03 03 24 */	lwz r0, 0x324(r3)                       
/* 80184784  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 801847C4  41 80 00 0C */	blt lbl_801847D0                         /* constant-address: 801847D0, symbol: lbl_801847D0 */
/* 801847C8  7C 00 20 50 */	subf r0, r0, r4                         
/* 801847CC  90 03 03 34 */	stw r0, 0x334(r3)                       
lbl_801847D0:
/* 801847D0  80 03 03 34 */	lwz r0, 0x334(r3)                       
/* 801847D4  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80184814  41 80 00 0C */	blt lbl_80184820                         /* constant-address: 80184820, symbol: lbl_80184820 */
/* 80184818  7C 00 20 50 */	subf r0, r0, r4                         
/* 8018481C  90 03 03 3C */	stw r0, 0x33c(r3)                       
lbl_80184820:
/* 80184820  80 03 03 3C */	lwz r0, 0x33c(r3)                       
/* 80184824  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80184864  41 80 00 0C */	blt lbl_80184870                         /* constant-address: 80184870, symbol: lbl_80184870 */
/* 80184868  7C 00 20 50 */	subf r0, r0, r4                         
/* 8018486C  90 03 03 A4 */	stw r0, 0x3a4(r3)                       
lbl_80184870:
/* 80184870  80 03 03 A4 */	lwz r0, 0x3a4(r3)                       
/* 80184874  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */

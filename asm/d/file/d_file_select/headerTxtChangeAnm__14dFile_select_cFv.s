...
/* 8018D26C  48 1D 4F 6D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8018D270  7C 7F 1B 78 */	mr r31, r3                              
/* 8018D274  88 03 02 1D */	lbz r0, 0x21d(r3)                       
/* 8018D278  28 00 00 00 */	cmplwi r0, 0                            
/* 8018D27C  41 82 00 0C */	beq lbl_8018D288                         /* constant-address: 8018D288, symbol: lbl_8018D288 */
/* 8018D280  38 60 00 01 */	li r3, 1                                
/* 8018D284  48 00 00 A8 */	b lbl_8018D32C                           /* constant-address: 8018D32C, symbol: lbl_8018D32C */
lbl_8018D288:
...
/* 8018D2A0  3B A4 C9 EC */	addi r29, r4, g_fsHIO@l                  /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018D2A4  88 9D 00 07 */	lbz r4, 7(r29)                           /* constant-address: 8042C9F3, symbol: None */
/* 8018D2A8  38 A0 00 FF */	li r5, 0xff                             
/* 8018D2AC  38 C0 00 00 */	li r6, 0                                
/* 8018D2B0  38 E0 00 00 */	li r7, 0                                
/* 8018D2B4  48 0C 85 C5 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018D2D0  88 9D 00 07 */	lbz r4, 7(r29)                           /* constant-address: 8042C9F3, symbol: None */
/* 8018D2D4  38 A0 00 00 */	li r5, 0                                
/* 8018D2D8  38 C0 00 FF */	li r6, 0xff                             
/* 8018D2DC  38 E0 00 00 */	li r7, 0                                
/* 8018D2E0  48 0C 85 99 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018D2E4  3C 80 80 43 */	lis r4, g_meter2_info@ha                
/* 8018D2E8  38 84 01 88 */	addi r4, r4, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 8018D2EC  A8 84 00 94 */	lha r4, 0x94(r4)                         /* constant-address: 8043021C, symbol: None */
/* 8018D2F0  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 8018D2F4  28 00 00 01 */	cmplwi r0, 1                            
/* 8018D2F8  40 82 00 30 */	bne lbl_8018D328                         /* constant-address: 8018D328, symbol: lbl_8018D328 */
/* 8018D2FC  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018D300  28 00 00 01 */	cmplwi r0, 1                            
/* 8018D304  40 82 00 24 */	bne lbl_8018D328                         /* constant-address: 8018D328, symbol: lbl_8018D328 */
/* 8018D308  2C 04 00 00 */	cmpwi r4, 0                             
/* 8018D30C  40 82 00 1C */	bne lbl_8018D328                         /* constant-address: 8018D328, symbol: lbl_8018D328 */
...
/* 8018D330  48 1D 4E F5 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

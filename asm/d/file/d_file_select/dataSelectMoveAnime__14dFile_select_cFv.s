...
/* 80185DF0  48 1D C3 E1 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 80185E0C  41 82 00 DC */	beq lbl_80185EE8                         /* constant-address: 80185EE8, symbol: lbl_80185EE8 */
...
/* 80185E20  38 84 C9 EC */	addi r4, r4, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 80185E24  88 84 00 06 */	lbz r4, 6(r4)                            /* constant-address: 8042C9F2, symbol: None */
/* 80185E28  38 A0 00 FF */	li r5, 0xff                             
/* 80185E2C  38 C0 00 00 */	li r6, 0                                
/* 80185E30  38 E0 00 01 */	li r7, 1                                
/* 80185E34  48 0C FA 45 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 80185E38  7C 7F 1B 78 */	mr r31, r3                              
/* 80185E3C  7F 43 D3 78 */	mr r3, r26                              
/* 80185E40  88 9A 02 64 */	lbz r4, 0x264(r26)                      
/* 80185E44  48 00 78 49 */	bl selectWakuAlpahAnm__14dFile_select_cFUc /* constant-address: 8018D68C, symbol: selectWakuAlpahAnm__14dFile_select_cFUc */
...
/* 80185E60  38 63 A8 54 */	addi r3, r3, SelStartFrameTbl@l          /* constant-address: 803BA854, symbol: SelStartFrameTbl */
/* 80185E64  7C 03 00 2E */	lwzx r0, r3, r0                         
/* 80185E68  7C 04 00 00 */	cmpw r4, r0                             
/* 80185E6C  41 82 00 7C */	beq lbl_80185EE8                         /* constant-address: 80185EE8, symbol: lbl_80185EE8 */
...
/* 80185E90  40 80 00 08 */	bge lbl_80185E98                         /* constant-address: 80185E98, symbol: lbl_80185E98 */
...
/* 80185EA8  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80185EE0  48 17 20 ED */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
...
/* 80185EF8  41 82 00 CC */	beq lbl_80185FC4                         /* constant-address: 80185FC4, symbol: lbl_80185FC4 */
...
/* 80185F0C  38 84 C9 EC */	addi r4, r4, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 80185F10  88 84 00 06 */	lbz r4, 6(r4)                            /* constant-address: 8042C9F2, symbol: None */
/* 80185F14  38 A0 00 00 */	li r5, 0                                
/* 80185F18  38 C0 00 FF */	li r6, 0xff                             
/* 80185F1C  38 E0 00 01 */	li r7, 1                                
/* 80185F20  48 0C F9 59 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 80185F3C  38 63 A8 60 */	addi r3, r3, SelEndFrameTbl@l            /* constant-address: 803BA860, symbol: SelEndFrameTbl */
/* 80185F40  7C 03 00 2E */	lwzx r0, r3, r0                         
/* 80185F44  7C 04 00 00 */	cmpw r4, r0                             
/* 80185F48  41 82 00 7C */	beq lbl_80185FC4                         /* constant-address: 80185FC4, symbol: lbl_80185FC4 */
...
/* 80185F6C  40 81 00 08 */	ble lbl_80185F74                         /* constant-address: 80185F74, symbol: lbl_80185F74 */
...
/* 80185F84  C8 22 9F 38 */	lfd f1, lit_4342(r2)                     /* constant-address: 80453938, symbol: lit_4342 */
...
/* 80185FBC  48 17 20 11 */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
/* 80185FC0  3B 60 00 00 */	li r27, 0                               
lbl_80185FC4:
/* 80185FC4  57 E0 06 3E */	clrlwi r0, r31, 0x18                    
/* 80185FC8  28 00 00 01 */	cmplwi r0, 1                            
/* 80185FCC  40 82 00 A4 */	bne lbl_80186070                         /* constant-address: 80186070, symbol: lbl_80186070 */
/* 80185FD0  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 80185FD4  28 00 00 01 */	cmplwi r0, 1                            
/* 80185FD8  40 82 00 98 */	bne lbl_80186070                         /* constant-address: 80186070, symbol: lbl_80186070 */
/* 80185FDC  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 80185FE0  28 00 00 01 */	cmplwi r0, 1                            
/* 80185FE4  40 82 00 8C */	bne lbl_80186070                         /* constant-address: 80186070, symbol: lbl_80186070 */
/* 80185FE8  57 80 06 3E */	clrlwi r0, r28, 0x18                    
/* 80185FEC  28 00 00 01 */	cmplwi r0, 1                            
/* 80185FF0  40 82 00 80 */	bne lbl_80186070                         /* constant-address: 80186070, symbol: lbl_80186070 */
/* 80185FF4  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 80185FF8  28 00 00 01 */	cmplwi r0, 1                            
/* 80185FFC  40 82 00 74 */	bne lbl_80186070                         /* constant-address: 80186070, symbol: lbl_80186070 */
/* 80186000  88 1A 02 65 */	lbz r0, 0x265(r26)                      
/* 80186004  28 00 00 FF */	cmplwi r0, 0xff                         
/* 80186008  41 82 00 30 */	beq lbl_80186038                         /* constant-address: 80186038, symbol: lbl_80186038 */
...
/* 80186034  48 00 77 31 */	bl selFileCursorShow__14dFile_select_cFv /* constant-address: 8018D764, symbol: selFileCursorShow__14dFile_select_cFv */
lbl_80186038:
/* 80186038  88 1A 02 64 */	lbz r0, 0x264(r26)                      
/* 8018603C  28 00 00 FF */	cmplwi r0, 0xff                         
/* 80186040  41 82 00 28 */	beq lbl_80186068                         /* constant-address: 80186068, symbol: lbl_80186068 */
...
/* 80186074  48 1D C1 A9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

...
/* 8018A708  48 1D 7A D1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8018A724  3B 84 C9 EC */	addi r28, r4, g_fsHIO@l                  /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A728  88 9C 00 09 */	lbz r4, 9(r28)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A72C  38 A0 00 FF */	li r5, 0xff                             
/* 8018A730  38 C0 00 00 */	li r6, 0                                
/* 8018A734  38 E0 00 00 */	li r7, 0                                
/* 8018A738  48 0C B1 41 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018A750  88 9C 00 09 */	lbz r4, 9(r28)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A754  38 A0 00 FF */	li r5, 0xff                             
/* 8018A758  38 C0 00 00 */	li r6, 0                                
/* 8018A75C  38 E0 00 00 */	li r7, 0                                
/* 8018A760  48 0C B1 19 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018A778  40 82 00 10 */	bne lbl_8018A788                         /* constant-address: 8018A788, symbol: lbl_8018A788 */
/* 8018A77C  88 03 02 58 */	lbz r0, 0x258(r3)                       
/* 8018A780  28 00 00 00 */	cmplwi r0, 0                            
/* 8018A784  41 82 00 28 */	beq lbl_8018A7AC                         /* constant-address: 8018A7AC, symbol: lbl_8018A7AC */
lbl_8018A788:
/* 8018A788  54 80 10 3A */	slwi r0, r4, 2                          
/* 8018A78C  7C 7F 02 14 */	add r3, r31, r0                         
/* 8018A790  80 63 02 2C */	lwz r3, 0x22c(r3)                       
/* 8018A794  88 9C 00 09 */	lbz r4, 9(r28)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A798  38 A0 00 FF */	li r5, 0xff                             
/* 8018A79C  38 C0 00 00 */	li r6, 0                                
/* 8018A7A0  38 E0 00 00 */	li r7, 0                                
/* 8018A7A4  48 0C B0 D5 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018A7A8  48 00 00 24 */	b lbl_8018A7CC                           /* constant-address: 8018A7CC, symbol: lbl_8018A7CC */
lbl_8018A7AC:
/* 8018A7AC  54 80 10 3A */	slwi r0, r4, 2                          
/* 8018A7B0  7C 7F 02 14 */	add r3, r31, r0                         
/* 8018A7B4  80 63 02 20 */	lwz r3, 0x220(r3)                       
/* 8018A7B8  88 9C 00 09 */	lbz r4, 9(r28)                           /* constant-address: 8042C9F5, symbol: None */
/* 8018A7BC  38 A0 00 FF */	li r5, 0xff                             
/* 8018A7C0  38 C0 00 00 */	li r6, 0                                
/* 8018A7C4  38 E0 00 00 */	li r7, 0                                
/* 8018A7C8  48 0C B0 B1 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
lbl_8018A7CC:
/* 8018A7CC  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 8018A7D0  28 00 00 01 */	cmplwi r0, 1                            
/* 8018A7D4  40 82 00 7C */	bne lbl_8018A850                         /* constant-address: 8018A850, symbol: lbl_8018A850 */
/* 8018A7D8  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 8018A7DC  28 00 00 01 */	cmplwi r0, 1                            
/* 8018A7E0  40 82 00 70 */	bne lbl_8018A850                         /* constant-address: 8018A850, symbol: lbl_8018A850 */
/* 8018A7E4  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018A7E8  28 00 00 01 */	cmplwi r0, 1                            
/* 8018A7EC  40 82 00 64 */	bne lbl_8018A850                         /* constant-address: 8018A850, symbol: lbl_8018A850 */
...
/* 8018A808  48 00 28 DD */	bl headerTxtSet__14dFile_select_cFUsUcUc /* constant-address: 8018D0E4, symbol: headerTxtSet__14dFile_select_cFUsUcUc */
/* 8018A80C  80 7F 00 6C */	lwz r3, 0x6c(r31)                       
/* 8018A810  48 00 78 FD */	bl closeInit__15dFile_warning_cFv        /* constant-address: 8019210C, symbol: closeInit__15dFile_warning_cFv */
/* 8018A814  7F E3 FB 78 */	mr r3, r31                              
/* 8018A818  48 00 28 2D */	bl setSaveData__14dFile_select_cFv       /* constant-address: 8018D044, symbol: setSaveData__14dFile_select_cFv */
...
/* 8018A854  48 1D 79 D1 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

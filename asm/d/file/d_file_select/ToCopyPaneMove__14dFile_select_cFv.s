...
/* 801879C8  48 1D A8 0D */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801879CC  7C 7F 1B 78 */	mr r31, r3                              
/* 801879D0  48 00 58 8D */	bl headerTxtChangeAnm__14dFile_select_cFv /* constant-address: 8018D25C, symbol: headerTxtChangeAnm__14dFile_select_cFv */
/* 801879D4  7C 7B 1B 78 */	mr r27, r3                              
/* 801879D8  7F E3 FB 78 */	mr r3, r31                              
/* 801879DC  4B FF F2 D1 */	bl menuMoveAnm__14dFile_select_cFv       /* constant-address: 80186CAC, symbol: menuMoveAnm__14dFile_select_cFv */
/* 801879E0  7C 7C 1B 78 */	mr r28, r3                              
/* 801879E4  7F E3 FB 78 */	mr r3, r31                              
/* 801879E8  4B FF E0 C5 */	bl selectDataMoveAnm__14dFile_select_cFv /* constant-address: 80185AAC, symbol: selectDataMoveAnm__14dFile_select_cFv */
/* 801879EC  7C 7D 1B 78 */	mr r29, r3                              
/* 801879F0  7F E3 FB 78 */	mr r3, r31                              
/* 801879F4  88 9F 02 65 */	lbz r4, 0x265(r31)                      
/* 801879F8  48 00 5C 95 */	bl selectWakuAlpahAnm__14dFile_select_cFUc /* constant-address: 8018D68C, symbol: selectWakuAlpahAnm__14dFile_select_cFUc */
/* 801879FC  7C 7E 1B 78 */	mr r30, r3                              
/* 80187A00  7F E3 FB 78 */	mr r3, r31                              
/* 80187A04  48 00 87 21 */	bl nameMoveAnm__14dFile_select_cFv       /* constant-address: 80190124, symbol: nameMoveAnm__14dFile_select_cFv */
/* 80187A08  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 80187A0C  28 00 00 01 */	cmplwi r0, 1                            
/* 80187A10  40 82 00 B4 */	bne lbl_80187AC4                         /* constant-address: 80187AC4, symbol: lbl_80187AC4 */
/* 80187A14  57 80 06 3E */	clrlwi r0, r28, 0x18                    
/* 80187A18  28 00 00 01 */	cmplwi r0, 1                            
/* 80187A1C  40 82 00 A8 */	bne lbl_80187AC4                         /* constant-address: 80187AC4, symbol: lbl_80187AC4 */
/* 80187A20  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 80187A24  28 00 00 01 */	cmplwi r0, 1                            
/* 80187A28  40 82 00 9C */	bne lbl_80187AC4                         /* constant-address: 80187AC4, symbol: lbl_80187AC4 */
/* 80187A2C  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 80187A30  28 00 00 01 */	cmplwi r0, 1                            
/* 80187A34  40 82 00 90 */	bne lbl_80187AC4                         /* constant-address: 80187AC4, symbol: lbl_80187AC4 */
/* 80187A38  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 80187A3C  28 00 00 01 */	cmplwi r0, 1                            
/* 80187A40  40 82 00 84 */	bne lbl_80187AC4                         /* constant-address: 80187AC4, symbol: lbl_80187AC4 */
...
/* 80187A6C  48 0C D4 51 */	bl getGlobalVtxCenter__8CPaneMgrFP7J2DPanebs /* constant-address: 80254EBC, symbol: getGlobalVtxCenter__8CPaneMgrFP7J2DPanebs */
...
/* 80187AAC  48 00 D6 49 */	bl setPos__16dSelect_cursor_cFffP7J2DPaneb /* constant-address: 801950F4, symbol: setPos__16dSelect_cursor_cFffP7J2DPaneb */
/* 80187AB0  80 7F 00 64 */	lwz r3, 0x64(r31)                       
/* 80187AB4  C0 22 9F 40 */	lfs f1, lit_4611(r2)                     /* constant-address: 80453940, symbol: lit_4611 */
/* 80187AB8  48 00 D7 E9 */	bl setAlphaRate__16dSelect_cursor_cFf    /* constant-address: 801952A0, symbol: setAlphaRate__16dSelect_cursor_cFf */
/* 80187ABC  38 00 00 16 */	li r0, 0x16                             
/* 80187AC0  98 1F 02 6F */	stb r0, 0x26f(r31)                      
lbl_80187AC4:
/* 80187AC4  39 61 00 40 */	addi r11, r1, 0x40                      
/* 80187AC8  48 1D A7 59 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

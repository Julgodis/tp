...
/* 8018FF04  48 1D 22 D1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8018FF18  3B A3 C9 EC */	addi r29, r3, g_fsHIO@l                  /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018FF1C  3B E1 00 08 */	addi r31, r1, 8                         
lbl_8018FF20:
/* 8018FF20  7C BB F2 14 */	add r5, r27, r30                        
/* 8018FF24  80 65 00 BC */	lwz r3, 0xbc(r5)                        
/* 8018FF28  88 9D 00 05 */	lbz r4, 5(r29)                           /* constant-address: 8042C9F1, symbol: None */
/* 8018FF2C  C0 25 00 C8 */	lfs f1, 0xc8(r5)                        
/* 8018FF30  C0 45 00 D4 */	lfs f2, 0xd4(r5)                        
/* 8018FF34  38 A0 00 00 */	li r5, 0                                
/* 8018FF38  48 0C 48 95 */	bl scaleAnime__8CPaneMgrFsffUc           /* constant-address: 802547CC, symbol: scaleAnime__8CPaneMgrFsffUc */
...
/* 8018FF50  41 80 FF D0 */	blt lbl_8018FF20                         /* constant-address: 8018FF20, symbol: lbl_8018FF20 */
/* 8018FF54  88 01 00 08 */	lbz r0, 8(r1)                           
/* 8018FF58  28 00 00 01 */	cmplwi r0, 1                            
/* 8018FF5C  40 82 00 24 */	bne lbl_8018FF80                         /* constant-address: 8018FF80, symbol: lbl_8018FF80 */
/* 8018FF60  88 01 00 09 */	lbz r0, 9(r1)                           
/* 8018FF64  28 00 00 01 */	cmplwi r0, 1                            
/* 8018FF68  40 82 00 18 */	bne lbl_8018FF80                         /* constant-address: 8018FF80, symbol: lbl_8018FF80 */
/* 8018FF6C  88 01 00 0A */	lbz r0, 0xa(r1)                         
/* 8018FF70  28 00 00 01 */	cmplwi r0, 1                            
/* 8018FF74  40 82 00 0C */	bne lbl_8018FF80                         /* constant-address: 8018FF80, symbol: lbl_8018FF80 */
/* 8018FF78  38 60 00 01 */	li r3, 1                                
/* 8018FF7C  48 00 00 08 */	b lbl_8018FF84                           /* constant-address: 8018FF84, symbol: lbl_8018FF84 */
lbl_8018FF80:
/* 8018FF80  38 60 00 00 */	li r3, 0                                
lbl_8018FF84:
/* 8018FF84  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8018FF88  48 1D 22 99 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

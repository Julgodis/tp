...
/* 8018C534  48 1D 5C 95 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 8018C538  7C 7F 1B 78 */	mr r31, r3                              
/* 8018C53C  3C 60 80 3C */	lis r3, cNullVec__6Z2Calc@ha            
/* 8018C540  3B C3 A8 48 */	addi r30, r3, cNullVec__6Z2Calc@l        /* constant-address: 803BA848, symbol: cNullVec__6Z2Calc */
/* 8018C544  38 60 01 18 */	li r3, 0x118                            
/* 8018C548  48 14 27 05 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C54C  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C550  41 82 00 0C */	beq lbl_8018C55C                         /* constant-address: 8018C55C, symbol: lbl_8018C55C */
/* 8018C554  48 16 BF 45 */	bl __ct__9J2DScreenFv                    /* constant-address: 802F8498, symbol: __ct__9J2DScreenFv */
...
/* 8018C568  38 84 43 88 */	addi r4, r4, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C56C  38 84 01 D8 */	addi r4, r4, 0x1d8                       /* constant-address: 80394560, symbol: None */
/* 8018C570  3C A0 01 10 */	lis r5, 0x110                           
/* 8018C574  80 DF 00 08 */	lwz r6, 8(r31)                          
/* 8018C578  48 16 C0 D1 */	bl setPriority__9J2DScreenFPCcUlP10JKRArchive /* constant-address: 802F8648, symbol: setPriority__9J2DScreenFPCcUlP10JKRArchive */
/* 8018C57C  80 7F 00 4C */	lwz r3, 0x4c(r31)                       
/* 8018C580  48 0C 8B 69 */	bl dPaneClass_showNullPane__FP9J2DScreen /* constant-address: 802550E8, symbol: dPaneClass_showNullPane__FP9J2DScreen */
/* 8018C584  3C 60 80 39 */	lis r3, d_file_d_file_select__stringBase0@ha
/* 8018C588  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C58C  38 63 01 FC */	addi r3, r3, 0x1fc                       /* constant-address: 80394584, symbol: None */
/* 8018C590  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018C594  48 14 7C DD */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018C598  7C 7A 1B 78 */	mr r26, r3                              
/* 8018C59C  48 17 C4 D1 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
/* 8018C5A0  90 7F 03 10 */	stw r3, 0x310(r31)                      
/* 8018C5A4  7F 43 D3 78 */	mr r3, r26                              
/* 8018C5A8  48 17 C4 C5 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
/* 8018C5AC  90 7F 03 14 */	stw r3, 0x314(r31)                      
/* 8018C5B0  7F 43 D3 78 */	mr r3, r26                              
/* 8018C5B4  48 17 C4 B9 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018C610  3B 9E 06 C0 */	addi r28, r30, 0x6c0                     /* constant-address: 803BAF08, symbol: data_803BAF08 */
lbl_8018C614:
/* 8018C614  38 60 00 6C */	li r3, 0x6c                             
/* 8018C618  48 14 26 35 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C61C  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C620  41 82 00 28 */	beq lbl_8018C648                         /* constant-address: 8018C648, symbol: lbl_8018C648 */
/* 8018C624  80 9F 00 4C */	lwz r4, 0x4c(r31)                       
/* 8018C628  38 1E 06 B0 */	addi r0, r30, 0x6b0                      /* constant-address: 803BAEF8, symbol: data_803BAEF8 */
...
/* 8018C640  48 0C 73 45 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018C654  48 14 25 F9 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C658  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C65C  41 82 00 28 */	beq lbl_8018C684                         /* constant-address: 8018C684, symbol: lbl_8018C684 */
/* 8018C660  80 9F 00 4C */	lwz r4, 0x4c(r31)                       
/* 8018C664  38 1E 06 D0 */	addi r0, r30, 0x6d0                      /* constant-address: 803BAF18, symbol: data_803BAF18 */
...
/* 8018C67C  48 0C 73 09 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018C6B8  4B E8 83 39 */	bl mDoExt_getMesgFont__Fv                /* constant-address: 800149F0, symbol: mDoExt_getMesgFont__Fv */
...
/* 8018C6D8  38 8D 81 48 */	la r4, data_804506C8(r13) /* 804506C8-_SDA_BASE_ */ /* constant-address: 804506C8, symbol: data_804506C8 */
/* 8018C6DC  7C 84 E8 AE */	lbzx r4, r4, r29                         /* constant-address: 804506C8, symbol: data_804506C8 */
/* 8018C6E0  4B E9 39 E1 */	bl fopMsgM_messageGet__FPcUl             /* constant-address: 800200C0, symbol: fopMsgM_messageGet__FPcUl */
...
/* 8018C6F4  48 17 3F 6D */	bl setString__10J2DTextBoxFPCce          /* constant-address: 80300660, symbol: setString__10J2DTextBoxFPCce */
/* 8018C6F8  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
/* 8018C6FC  2C 1D 00 02 */	cmpwi r29, 2                            
/* 8018C700  3B 5A 00 04 */	addi r26, r26, 4                         /* constant-address: 00000004 */
/* 8018C704  3B 7B 00 08 */	addi r27, r27, 8                         /* constant-address: 00000008 */
/* 8018C708  41 80 FF 0C */	blt lbl_8018C614                         /* constant-address: 8018C614, symbol: lbl_8018C614 */
/* 8018C70C  3C 60 80 39 */	lis r3, d_file_d_file_select__stringBase0@ha
/* 8018C710  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C714  38 63 02 20 */	addi r3, r3, 0x220                       /* constant-address: 803945A8, symbol: None */
/* 8018C718  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018C71C  48 14 7B 55 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018C720  48 17 C3 4D */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018C74C  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C750  38 63 02 44 */	addi r3, r3, 0x244                       /* constant-address: 803945CC, symbol: None */
/* 8018C754  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018C758  48 14 7B 19 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018C75C  48 17 C3 11 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018C794  48 14 24 B9 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C798  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C79C  41 82 00 28 */	beq lbl_8018C7C4                         /* constant-address: 8018C7C4, symbol: lbl_8018C7C4 */
/* 8018C7A0  80 9F 00 4C */	lwz r4, 0x4c(r31)                       
/* 8018C7A4  38 1E 06 E0 */	addi r0, r30, 0x6e0                      /* constant-address: 803BAF28, symbol: data_803BAF28 */
...
/* 8018C7BC  48 0C 71 C9 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018C7D0  48 14 24 7D */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C7D4  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C7D8  41 82 00 28 */	beq lbl_8018C800                         /* constant-address: 8018C800, symbol: lbl_8018C800 */
/* 8018C7DC  80 9F 00 4C */	lwz r4, 0x4c(r31)                       
/* 8018C7E0  38 1E 06 F0 */	addi r0, r30, 0x6f0                      /* constant-address: 803BAF38, symbol: data_803BAF38 */
...
/* 8018C7F8  48 0C 71 8D */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
/* 8018C7FC  7C 60 1B 78 */	mr r0, r3                               
lbl_8018C800:
/* 8018C800  90 1D 01 A8 */	stw r0, 0x1a8(r29)                      
/* 8018C804  38 60 00 6C */	li r3, 0x6c                             
/* 8018C808  48 14 24 45 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C80C  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C810  41 82 00 28 */	beq lbl_8018C838                         /* constant-address: 8018C838, symbol: lbl_8018C838 */
/* 8018C814  80 9F 00 4C */	lwz r4, 0x4c(r31)                       
/* 8018C818  38 1E 07 00 */	addi r0, r30, 0x700                      /* constant-address: 803BAF48, symbol: data_803BAF48 */
...
/* 8018C830  48 0C 71 55 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018C8C8  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 8018C8CC  2C 1C 00 02 */	cmpwi r28, 2                            
/* 8018C8D0  3B 7B 00 04 */	addi r27, r27, 4                         /* constant-address: 00000004 */
/* 8018C8D4  3B 5A 00 08 */	addi r26, r26, 8                         /* constant-address: 00000008 */
/* 8018C8D8  41 80 FE B8 */	blt lbl_8018C790                         /* constant-address: 8018C790, symbol: lbl_8018C790 */
/* 8018C8DC  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8018C8E0  48 1D 59 35 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

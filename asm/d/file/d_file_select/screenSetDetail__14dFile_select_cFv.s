...
/* 8018CCE8  48 14 1F 65 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CCEC  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CCF0  41 82 00 0C */	beq lbl_8018CCFC                         /* constant-address: 8018CCFC, symbol: lbl_8018CCFC */
/* 8018CCF4  48 16 B7 A5 */	bl __ct__9J2DScreenFv                    /* constant-address: 802F8498, symbol: __ct__9J2DScreenFv */
/* 8018CCF8  7C 60 1B 78 */	mr r0, r3                               
lbl_8018CCFC:
/* 8018CCFC  90 1F 00 28 */	stw r0, 0x28(r31)                       
/* 8018CD00  80 7F 00 28 */	lwz r3, 0x28(r31)                       
/* 8018CD04  3C 80 80 39 */	lis r4, d_file_d_file_select__stringBase0@ha
/* 8018CD08  38 84 43 88 */	addi r4, r4, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018CD0C  38 84 02 F4 */	addi r4, r4, 0x2f4                       /* constant-address: 8039467C, symbol: None */
/* 8018CD10  3C A0 01 10 */	lis r5, 0x110                           
/* 8018CD14  80 DF 00 08 */	lwz r6, 8(r31)                          
/* 8018CD18  48 16 B9 31 */	bl setPriority__9J2DScreenFPCcUlP10JKRArchive /* constant-address: 802F8648, symbol: setPriority__9J2DScreenFPCcUlP10JKRArchive */
/* 8018CD1C  3C 60 80 39 */	lis r3, d_file_d_file_select__stringBase0@ha
/* 8018CD20  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018CD24  38 63 03 12 */	addi r3, r3, 0x312                       /* constant-address: 8039469A, symbol: None */
/* 8018CD28  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018CD2C  48 14 75 45 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018CD30  48 17 BD 3D */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018CD60  38 C4 6C 6C */	addi r6, r4, 0x6C6C /* 0x5F616C6C@l */   /* constant-address: 5F616C6C */
...
/* 8018CD80  48 14 1E CD */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CD84  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CD88  41 82 00 28 */	beq lbl_8018CDB0                         /* constant-address: 8018CDB0, symbol: lbl_8018CDB0 */
/* 8018CD8C  80 9F 00 28 */	lwz r4, 0x28(r31)                       
/* 8018CD90  3C A0 5F 70 */	lis r5, 0x5F70 /* 0x5F705F6E@ha */      
/* 8018CD94  38 C5 5F 6E */	addi r6, r5, 0x5F6E /* 0x5F705F6E@l */   /* constant-address: 5F705F6E */
/* 8018CD98  3C A0 6D 73 */	lis r5, 0x6D73 /* 0x6D736574@ha */      
/* 8018CD9C  38 A5 65 74 */	addi r5, r5, 0x6574 /* 0x6D736574@l */   /* constant-address: 6D736574 */
/* 8018CDA0  38 E0 00 00 */	li r7, 0                                
/* 8018CDA4  39 00 00 00 */	li r8, 0                                
/* 8018CDA8  48 0C 6B DD */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018CDC8  38 C4 5F 6E */	addi r6, r4, 0x5F6E /* 0x75625F6E@l */   /* constant-address: 75625F6E */
/* 8018CDCC  3C 80 00 77 */	lis r4, 0x0077 /* 0x00775F73@ha */      
/* 8018CDD0  38 A4 5F 73 */	addi r5, r4, 0x5F73 /* 0x00775F73@l */   /* constant-address: 00775F73 */
...
/* 8018CDF4  38 C4 5F 6E */	addi r6, r4, 0x5F6E /* 0x696E5F6E@l */   /* constant-address: 696E5F6E */
/* 8018CDF8  3C 80 00 64 */	lis r4, 0x0064 /* 0x00645F77@ha */      
/* 8018CDFC  38 A4 5F 77 */	addi r5, r4, 0x5F77 /* 0x00645F77@l */   /* constant-address: 00645F77 */
...
/* 8018CE14  38 84 34 33 */	addi r4, r4, 0x3433 /* 0x6E5F3433@l */   /* constant-address: 6E5F3433 */

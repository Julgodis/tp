...
/* 80190978  C0 02 9F B8 */	lfs f0, lit_8608(r2)                     /* constant-address: 804539B8, symbol: lit_8608 */
/* 8019097C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80190980  4C 40 13 82 */	cror 2, 0, 2                            
/* 80190984  40 82 00 08 */	bne lbl_8019098C                         /* constant-address: 8019098C, symbol: lbl_8019098C */
/* 80190988  C0 22 9F 48 */	lfs f1, lit_4778(r2)                     /* constant-address: 80453948, symbol: lit_4778 */
lbl_8019098C:
...
/* 801909A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 801909A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 801909A8  C0 3F 03 A4 */	lfs f1, 0x3a4(r31)                      
/* 801909AC  C0 5F 03 A8 */	lfs f2, 0x3a8(r31)                      
/* 801909B0  C0 7F 03 AC */	lfs f3, 0x3ac(r31)                      
/* 801909B4  48 1B 5F 35 */	bl PSMTXTrans                            /* constant-address: 803468E8, symbol: PSMTXTrans */
/* 801909B8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 801909BC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 801909C0  A8 9F 03 B0 */	lha r4, 0x3b0(r31)                      
/* 801909C4  A8 BF 03 B2 */	lha r5, 0x3b2(r31)                      
/* 801909C8  A8 DF 03 B4 */	lha r6, 0x3b4(r31)                      
/* 801909CC  4B E7 B7 99 */	bl mDoMtx_XYZrotM__FPA4_fsss             /* constant-address: 8000C164, symbol: mDoMtx_XYZrotM__FPA4_fsss */
...
/* 801909EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 801909F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 801909F4  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 801909F8  38 84 00 24 */	addi r4, r4, 0x24                       
/* 801909FC  48 1B 5A B5 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */

...
/* 8018DBDC  48 1D 45 F1 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 8018DC00  41 82 00 E8 */	beq lbl_8018DCE8                         /* constant-address: 8018DCE8, symbol: lbl_8018DCE8 */
...
/* 8018DC24  48 0C 7C 55 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018DC44  48 0C 7C 35 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018DC64  48 0C 7C 15 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
...
/* 8018DCE4  48 0C 6B D9 */	bl colorAnime__8CPaneMgrFsQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorUc /* constant-address: 802548BC, symbol: colorAnime__8CPaneMgrFsQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorQ28JUtility6TColorUc */
lbl_8018DCE8:
/* 8018DCE8  57 80 06 3E */	clrlwi r0, r28, 0x18                    
/* 8018DCEC  28 00 00 01 */	cmplwi r0, 1                            
/* 8018DCF0  40 82 00 2C */	bne lbl_8018DD1C                         /* constant-address: 8018DD1C, symbol: lbl_8018DD1C */
/* 8018DCF4  57 60 06 3E */	clrlwi r0, r27, 0x18                    
/* 8018DCF8  28 00 00 01 */	cmplwi r0, 1                            
/* 8018DCFC  40 82 00 20 */	bne lbl_8018DD1C                         /* constant-address: 8018DD1C, symbol: lbl_8018DD1C */
/* 8018DD00  57 40 06 3E */	clrlwi r0, r26, 0x18                    
/* 8018DD04  28 00 00 01 */	cmplwi r0, 1                            
/* 8018DD08  40 82 00 14 */	bne lbl_8018DD1C                         /* constant-address: 8018DD1C, symbol: lbl_8018DD1C */
/* 8018DD0C  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018DD10  28 00 00 01 */	cmplwi r0, 1                            
/* 8018DD14  40 82 00 08 */	bne lbl_8018DD1C                         /* constant-address: 8018DD1C, symbol: lbl_8018DD1C */
/* 8018DD18  3B A0 00 01 */	li r29, 1                               
lbl_8018DD1C:
/* 8018DD1C  7F A3 EB 78 */	mr r3, r29                              
/* 8018DD20  39 61 00 50 */	addi r11, r1, 0x50                      
/* 8018DD24  48 1D 44 F5 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 8018A880  48 00 29 DD */	bl headerTxtChangeAnm__14dFile_select_cFv /* constant-address: 8018D25C, symbol: headerTxtChangeAnm__14dFile_select_cFv */
...
/* 8018A898  40 82 00 10 */	bne lbl_8018A8A8                         /* constant-address: 8018A8A8, symbol: lbl_8018A8A8 */
/* 8018A89C  88 03 02 58 */	lbz r0, 0x258(r3)                       
/* 8018A8A0  28 00 00 00 */	cmplwi r0, 0                            
/* 8018A8A4  41 82 00 30 */	beq lbl_8018A8D4                         /* constant-address: 8018A8D4, symbol: lbl_8018A8D4 */
lbl_8018A8A8:
...
/* 8018A8B8  38 84 C9 EC */	addi r4, r4, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A8BC  88 84 00 07 */	lbz r4, 7(r4)                            /* constant-address: 8042C9F3, symbol: None */
/* 8018A8C0  38 A0 00 00 */	li r5, 0                                
/* 8018A8C4  38 C0 00 FF */	li r6, 0xff                             
/* 8018A8C8  38 E0 00 00 */	li r7, 0                                
/* 8018A8CC  48 0C AF AD */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 8018A8D0  48 00 00 2C */	b lbl_8018A8FC                           /* constant-address: 8018A8FC, symbol: lbl_8018A8FC */
lbl_8018A8D4:
...
/* 8018A8E4  38 84 C9 EC */	addi r4, r4, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A8E8  88 84 00 07 */	lbz r4, 7(r4)                            /* constant-address: 8042C9F3, symbol: None */
/* 8018A8EC  38 A0 00 00 */	li r5, 0                                
/* 8018A8F0  38 C0 00 FF */	li r6, 0xff                             
/* 8018A8F4  38 E0 00 00 */	li r7, 0                                
/* 8018A8F8  48 0C AF 81 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
lbl_8018A8FC:
...
/* 8018A918  40 82 00 30 */	bne lbl_8018A948                         /* constant-address: 8018A948, symbol: lbl_8018A948 */
/* 8018A91C  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8018A920  28 00 00 01 */	cmplwi r0, 1                            
/* 8018A924  40 82 00 24 */	bne lbl_8018A948                         /* constant-address: 8018A948, symbol: lbl_8018A948 */
/* 8018A928  28 04 00 01 */	cmplwi r4, 1                            
/* 8018A92C  40 82 00 1C */	bne lbl_8018A948                         /* constant-address: 8018A948, symbol: lbl_8018A948 */
/* 8018A930  3C 60 80 43 */	lis r3, g_fsHIO@ha                      
/* 8018A934  38 63 C9 EC */	addi r3, r3, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018A938  88 03 00 0A */	lbz r0, 0xa(r3)                          /* constant-address: 8042C9F6, symbol: None */

...
/* 8018C904  48 1D 58 C5 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 8018C908  7C 7F 1B 78 */	mr r31, r3                              
/* 8018C90C  3C 60 80 3C */	lis r3, cNullVec__6Z2Calc@ha            
/* 8018C910  3B 83 A8 48 */	addi r28, r3, cNullVec__6Z2Calc@l        /* constant-address: 803BA848, symbol: cNullVec__6Z2Calc */
/* 8018C914  38 60 01 18 */	li r3, 0x118                            
/* 8018C918  48 14 23 35 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018C91C  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018C920  41 82 00 0C */	beq lbl_8018C92C                         /* constant-address: 8018C92C, symbol: lbl_8018C92C */
/* 8018C924  48 16 BB 75 */	bl __ct__9J2DScreenFv                    /* constant-address: 802F8498, symbol: __ct__9J2DScreenFv */
/* 8018C928  7C 60 1B 78 */	mr r0, r3                               
lbl_8018C92C:
/* 8018C92C  90 1F 00 58 */	stw r0, 0x58(r31)                       
/* 8018C930  80 7F 00 58 */	lwz r3, 0x58(r31)                       
/* 8018C934  3C 80 80 39 */	lis r4, d_file_d_file_select__stringBase0@ha
/* 8018C938  38 84 43 88 */	addi r4, r4, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C93C  38 84 02 68 */	addi r4, r4, 0x268                       /* constant-address: 803945F0, symbol: None */
/* 8018C940  3C A0 01 10 */	lis r5, 0x110                           
/* 8018C944  80 DF 00 08 */	lwz r6, 8(r31)                          
/* 8018C948  48 16 BD 01 */	bl setPriority__9J2DScreenFPCcUlP10JKRArchive /* constant-address: 802F8648, symbol: setPriority__9J2DScreenFPCcUlP10JKRArchive */
/* 8018C94C  80 7F 00 58 */	lwz r3, 0x58(r31)                       
/* 8018C950  48 0C 87 99 */	bl dPaneClass_showNullPane__FP9J2DScreen /* constant-address: 802550E8, symbol: dPaneClass_showNullPane__FP9J2DScreen */
/* 8018C954  3C 60 80 39 */	lis r3, d_file_d_file_select__stringBase0@ha
/* 8018C958  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C95C  38 63 02 8B */	addi r3, r3, 0x28b                       /* constant-address: 80394613, symbol: None */
/* 8018C960  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018C964  48 14 79 0D */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018C968  7C 79 1B 78 */	mr r25, r3                              
/* 8018C96C  48 17 C1 01 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
/* 8018C970  90 7F 03 28 */	stw r3, 0x328(r31)                      
/* 8018C974  7F 23 CB 78 */	mr r3, r25                              
/* 8018C978  48 17 C0 F5 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018C9B0  3C 60 80 39 */	lis r3, d_file_d_file_select__stringBase0@ha
/* 8018C9B4  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C9B8  38 63 02 AE */	addi r3, r3, 0x2ae                       /* constant-address: 80394636, symbol: None */
/* 8018C9BC  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018C9C0  48 14 78 B1 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018C9C4  48 17 C0 A9 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018C9EC  3C 60 80 39 */	lis r3, d_file_d_file_select__stringBase0@ha
/* 8018C9F0  38 63 43 88 */	addi r3, r3, d_file_d_file_select__stringBase0@l /* constant-address: 80394388, symbol: d_file_d_file_select__stringBase0 */
/* 8018C9F4  38 63 02 D1 */	addi r3, r3, 0x2d1                       /* constant-address: 80394659, symbol: None */
/* 8018C9F8  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8018C9FC  48 14 78 75 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8018CA00  48 17 C0 6D */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8018CA30  38 C4 5F 6E */	addi r6, r4, 0x5F6E /* 0x6E755F6E@l */   /* constant-address: 6E755F6E */
/* 8018CA34  3C 80 00 77 */	lis r4, 0x0077 /* 0x00776D65@ha */      
/* 8018CA38  38 A4 6D 65 */	addi r5, r4, 0x6D65 /* 0x00776D65@l */   /* constant-address: 00776D65 */
...
/* 8018CA68  C0 02 9F AC */	lfs f0, lit_7146(r2)                     /* constant-address: 804539AC, symbol: lit_7146 */
/* 8018CA6C  80 7F 03 28 */	lwz r3, 0x328(r31)                      
/* 8018CA70  D0 03 00 08 */	stfs f0, 8(r3)                          
/* 8018CA74  80 7F 01 18 */	lwz r3, 0x118(r31)                      
/* 8018CA78  48 16 B5 55 */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
/* 8018CA7C  3B 60 00 00 */	li r27, 0                               
/* 8018CA80  3B 40 00 00 */	li r26, 0                               
/* 8018CA84  3B C0 00 00 */	li r30, 0                               
/* 8018CA88  3B 3C 07 70 */	addi r25, r28, 0x770                     /* constant-address: 803BAFB8, symbol: data_803BAFB8 */
lbl_8018CA8C:
/* 8018CA8C  38 60 00 6C */	li r3, 0x6c                             
/* 8018CA90  48 14 21 BD */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CA94  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CA98  41 82 00 28 */	beq lbl_8018CAC0                         /* constant-address: 8018CAC0, symbol: lbl_8018CAC0 */
/* 8018CA9C  80 9F 00 58 */	lwz r4, 0x58(r31)                       
/* 8018CAA0  38 1C 07 58 */	addi r0, r28, 0x758                      /* constant-address: 803BAFA0, symbol: data_803BAFA0 */
...
/* 8018CAB8  48 0C 6E CD */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018CACC  48 14 21 81 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CAD0  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CAD4  41 82 00 28 */	beq lbl_8018CAFC                         /* constant-address: 8018CAFC, symbol: lbl_8018CAFC */
/* 8018CAD8  80 9F 00 58 */	lwz r4, 0x58(r31)                       
/* 8018CADC  38 1C 07 88 */	addi r0, r28, 0x788                      /* constant-address: 803BAFD0, symbol: data_803BAFD0 */
...
/* 8018CAF4  48 0C 6E 91 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018CB30  4B E8 7E C1 */	bl mDoExt_getMesgFont__Fv                /* constant-address: 800149F0, symbol: mDoExt_getMesgFont__Fv */
...
/* 8018CB50  38 8D 81 4C */	la r4, data_804506CC(r13) /* 804506CC-_SDA_BASE_ */ /* constant-address: 804506CC, symbol: data_804506CC */
/* 8018CB54  7C 84 D8 AE */	lbzx r4, r4, r27                         /* constant-address: 804506CC, symbol: data_804506CC */
/* 8018CB58  4B E9 35 69 */	bl fopMsgM_messageGet__FPcUl             /* constant-address: 800200C0, symbol: fopMsgM_messageGet__FPcUl */
...
/* 8018CB6C  48 17 3A F5 */	bl setString__10J2DTextBoxFPCce          /* constant-address: 80300660, symbol: setString__10J2DTextBoxFPCce */
/* 8018CB70  38 60 00 6C */	li r3, 0x6c                             
/* 8018CB74  48 14 20 D9 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CB78  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CB7C  41 82 00 28 */	beq lbl_8018CBA4                         /* constant-address: 8018CBA4, symbol: lbl_8018CBA4 */
/* 8018CB80  80 9F 00 58 */	lwz r4, 0x58(r31)                       
/* 8018CB84  38 1C 07 10 */	addi r0, r28, 0x710                      /* constant-address: 803BAF58, symbol: data_803BAF58 */
...
/* 8018CB9C  48 0C 6D E9 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
/* 8018CBA0  7C 60 1B 78 */	mr r0, r3                               
lbl_8018CBA4:
/* 8018CBA4  90 1D 03 64 */	stw r0, 0x364(r29)                      
/* 8018CBA8  38 60 00 6C */	li r3, 0x6c                             
/* 8018CBAC  48 14 20 A1 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CBB0  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CBB4  41 82 00 28 */	beq lbl_8018CBDC                         /* constant-address: 8018CBDC, symbol: lbl_8018CBDC */
/* 8018CBB8  80 9F 00 58 */	lwz r4, 0x58(r31)                       
/* 8018CBBC  38 1C 07 28 */	addi r0, r28, 0x728                      /* constant-address: 803BAF70, symbol: data_803BAF70 */
...
/* 8018CBD4  48 0C 6D B1 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
/* 8018CBD8  7C 60 1B 78 */	mr r0, r3                               
lbl_8018CBDC:
/* 8018CBDC  90 1D 03 70 */	stw r0, 0x370(r29)                      
/* 8018CBE0  38 60 00 6C */	li r3, 0x6c                             
/* 8018CBE4  48 14 20 69 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8018CBE8  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8018CBEC  41 82 00 28 */	beq lbl_8018CC14                         /* constant-address: 8018CC14, symbol: lbl_8018CC14 */
/* 8018CBF0  80 9F 00 58 */	lwz r4, 0x58(r31)                       
/* 8018CBF4  38 1C 07 40 */	addi r0, r28, 0x740                      /* constant-address: 803BAF88, symbol: data_803BAF88 */
...
/* 8018CC0C  48 0C 6D 79 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
...
/* 8018CCA4  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
/* 8018CCA8  2C 1B 00 03 */	cmpwi r27, 3                            
/* 8018CCAC  3B 5A 00 04 */	addi r26, r26, 4                         /* constant-address: 00000004 */
/* 8018CCB0  3B DE 00 08 */	addi r30, r30, 8                         /* constant-address: 00000008 */
/* 8018CCB4  41 80 FD D8 */	blt lbl_8018CA8C                         /* constant-address: 8018CA8C, symbol: lbl_8018CA8C */
/* 8018CCB8  39 61 00 50 */	addi r11, r1, 0x50                      
/* 8018CCBC  48 1D 55 59 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

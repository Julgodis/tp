...
/* 8018FE88  40 82 00 50 */	bne lbl_8018FED8                         /* constant-address: 8018FED8, symbol: lbl_8018FED8 */
/* 8018FE8C  C0 02 9F 48 */	lfs f0, lit_4778(r2)                     /* constant-address: 80453948, symbol: lit_4778 */
/* 8018FE90  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8018FE94  40 81 00 1C */	ble lbl_8018FEB0                         /* constant-address: 8018FEB0, symbol: lbl_8018FEB0 */
/* 8018FE98  54 06 15 BA */	rlwinm r6, r0, 2, 0x16, 0x1d            
/* 8018FE9C  3C A0 80 43 */	lis r5, g_fsHIO@ha                      
/* 8018FEA0  38 05 C9 EC */	addi r0, r5, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
/* 8018FEA4  7C A0 32 14 */	add r5, r0, r6                          
/* 8018FEA8  C0 05 00 10 */	lfs f0, 0x10(r5)                        
/* 8018FEAC  D0 07 00 C8 */	stfs f0, 0xc8(r7)                       
lbl_8018FEB0:
/* 8018FEB0  C0 02 9F 48 */	lfs f0, lit_4778(r2)                     /* constant-address: 80453948, symbol: lit_4778 */
/* 8018FEB4  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8018FEB8  40 81 00 20 */	ble lbl_8018FED8                         /* constant-address: 8018FED8, symbol: lbl_8018FED8 */
/* 8018FEBC  88 03 02 65 */	lbz r0, 0x265(r3)                       
/* 8018FEC0  54 06 10 3A */	slwi r6, r0, 2                          
/* 8018FEC4  3C A0 80 43 */	lis r5, g_fsHIO@ha                      
/* 8018FEC8  38 05 C9 EC */	addi r0, r5, g_fsHIO@l                   /* constant-address: 8042C9EC, symbol: g_fsHIO */
...
/* 8018FEEC  42 00 FF 88 */	bdnz lbl_8018FE74                        /* constant-address: 8018FE74, symbol: lbl_8018FE74 */

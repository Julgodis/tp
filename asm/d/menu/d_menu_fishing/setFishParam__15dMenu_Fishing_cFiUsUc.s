...
/* 801C606C  48 19 C1 5D */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 801C6084  4B FF FF 95 */	bl getFigure__15dMenu_Fishing_cFi        /* constant-address: 801C6018, symbol: getFigure__15dMenu_Fishing_cFi */
/* 801C6088  7C 7B 1B 78 */	mr r27, r3                              
/* 801C608C  7F A3 EB 78 */	mr r3, r29                              
/* 801C6090  57 04 06 3E */	clrlwi r4, r24, 0x18                    
/* 801C6094  4B FF FF 85 */	bl getFigure__15dMenu_Fishing_cFi        /* constant-address: 801C6018, symbol: getFigure__15dMenu_Fishing_cFi */
/* 801C6098  57 05 06 3E */	clrlwi r5, r24, 0x18                    
/* 801C609C  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha           
/* 801C60A0  3B 24 61 C0 */	addi r25, r4, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
...
/* 801C60C0  90 B9 5E 0C */	stw r5, 0x5e0c(r25)                      /* constant-address: 8040BFCC, symbol: None */
...
/* 801C60F4  48 13 A5 65 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 801C60F8  7C 64 1B 78 */	mr r4, r3                               
/* 801C60FC  7F C3 F3 78 */	mr r3, r30                              
/* 801C6100  48 1A 2A 2D */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C6104  38 C0 00 00 */	li r6, 0                                
/* 801C6108  38 81 00 08 */	addi r4, r1, 8                          
/* 801C610C  7C 7E D2 14 */	add r3, r30, r26                        
/* 801C6110  48 00 00 14 */	b lbl_801C6124                           /* constant-address: 801C6124, symbol: lbl_801C6124 */
lbl_801C6114:
/* 801C6114  98 A4 00 00 */	stb r5, 0(r4)                           
/* 801C6118  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
...
/* 801C612C  40 82 FF E8 */	bne lbl_801C6114                         /* constant-address: 801C6114, symbol: lbl_801C6114 */
...
/* 801C6140  48 13 A5 19 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 801C6144  38 81 00 28 */	addi r4, r1, 0x28                       
/* 801C6148  48 1A 29 E5 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C614C  80 7F 01 84 */	lwz r3, 0x184(r31)                      
/* 801C6150  48 13 A5 09 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 801C6154  38 81 00 08 */	addi r4, r1, 8                          
/* 801C6158  48 1A 29 D5 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C615C  93 19 5E 0C */	stw r24, 0x5e0c(r25)                     /* constant-address: 8040BFCC, symbol: None */
...
/* 801C6190  48 13 A4 C9 */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 801C6194  7C 64 1B 78 */	mr r4, r3                               
/* 801C6198  38 61 00 28 */	addi r3, r1, 0x28                       
/* 801C619C  48 1A 29 91 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C61A0  38 C0 00 00 */	li r6, 0                                
/* 801C61A4  38 81 00 08 */	addi r4, r1, 8                          
/* 801C61A8  7C 7E DA 14 */	add r3, r30, r27                        
/* 801C61AC  48 00 00 14 */	b lbl_801C61C0                           /* constant-address: 801C61C0, symbol: lbl_801C61C0 */
lbl_801C61B0:
/* 801C61B0  98 A4 00 00 */	stb r5, 0(r4)                           
/* 801C61B4  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
...
/* 801C61C8  40 82 FF E8 */	bne lbl_801C61B0                         /* constant-address: 801C61B0, symbol: lbl_801C61B0 */
...
/* 801C61DC  48 13 A4 7D */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 801C61E0  38 81 00 28 */	addi r4, r1, 0x28                       
/* 801C61E4  48 1A 29 49 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C61E8  80 7F 01 B4 */	lwz r3, 0x1b4(r31)                      
/* 801C61EC  48 13 A4 6D */	bl getStringPtr__10J2DTextBoxCFv         /* constant-address: 80300658, symbol: getStringPtr__10J2DTextBoxCFv */
/* 801C61F0  38 81 00 08 */	addi r4, r1, 8                          
/* 801C61F4  48 1A 29 39 */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C61F8  39 61 00 70 */	addi r11, r1, 0x70                      
/* 801C61FC  48 19 C0 19 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

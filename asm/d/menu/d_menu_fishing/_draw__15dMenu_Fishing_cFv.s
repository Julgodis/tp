...
/* 801C516C  41 82 00 80 */	beq lbl_801C51EC                         /* constant-address: 801C51EC, symbol: lbl_801C51EC */
/* 801C5170  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801C5174  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801C5178  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 801C5198  C0 22 A7 08 */	lfs f1, lit_3904(r2)                     /* constant-address: 80454108, symbol: lit_3904 */
/* 801C519C  FC 40 08 90 */	fmr f2, f1                              
/* 801C51A0  C0 62 A7 0C */	lfs f3, lit_3905(r2)                     /* constant-address: 8045410C, symbol: lit_3905 */
/* 801C51A4  C0 82 A7 10 */	lfs f4, lit_3906(r2)                     /* constant-address: 80454110, symbol: lit_3906 */
...
/* 801C51C8  C0 22 A7 08 */	lfs f1, lit_3904(r2)                     /* constant-address: 80454108, symbol: lit_3904 */
/* 801C51CC  FC 40 08 90 */	fmr f2, f1                              
/* 801C51D0  7F E4 FB 78 */	mr r4, r31                              
/* 801C51D4  48 13 3D 01 */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
/* 801C51D8  80 7E 00 1C */	lwz r3, 0x1c(r30)                       
/* 801C51DC  C0 22 A7 08 */	lfs f1, lit_3904(r2)                     /* constant-address: 80454108, symbol: lit_3904 */
/* 801C51E0  FC 40 08 90 */	fmr f2, f1                              
/* 801C51E4  7F E4 FB 78 */	mr r4, r31                              
/* 801C51E8  48 13 3C ED */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
lbl_801C51EC:

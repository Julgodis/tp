...
/* 801C5D4C  48 19 C4 7D */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 801C5D50  7C 7F 1B 78 */	mr r31, r3                              
/* 801C5D54  38 60 01 18 */	li r3, 0x118                            
/* 801C5D58  48 10 8E F5 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 801C5D5C  7C 60 1B 79 */	or. r0, r3, r3                          
/* 801C5D60  41 82 00 0C */	beq lbl_801C5D6C                         /* constant-address: 801C5D6C, symbol: lbl_801C5D6C */
/* 801C5D64  48 13 27 35 */	bl __ct__9J2DScreenFv                    /* constant-address: 802F8498, symbol: __ct__9J2DScreenFv */
...
/* 801C5D78  38 84 60 68 */	addi r4, r4, d_menu_d_menu_fishing__stringBase0@l /* constant-address: 80396068, symbol: d_menu_d_menu_fishing__stringBase0 */
/* 801C5D7C  38 84 00 3F */	addi r4, r4, 0x3f                        /* constant-address: 803960A7, symbol: None */
/* 801C5D80  3C A0 00 02 */	lis r5, 2                               
/* 801C5D84  80 DF 00 08 */	lwz r6, 8(r31)                          
/* 801C5D88  48 13 28 C1 */	bl setPriority__9J2DScreenFPCcUlP10JKRArchive /* constant-address: 802F8648, symbol: setPriority__9J2DScreenFPCcUlP10JKRArchive */
...
/* 801C5DB0  42 00 FF F0 */	bdnz lbl_801C5DA0                        /* constant-address: 801C5DA0, symbol: lbl_801C5DA0 */
/* 801C5DB4  80 7F 00 1C */	lwz r3, 0x1c(r31)                       
/* 801C5DB8  48 08 F3 31 */	bl dPaneClass_showNullPane__FP9J2DScreen /* constant-address: 802550E8, symbol: dPaneClass_showNullPane__FP9J2DScreen */
...
/* 801C5DCC  3B 43 60 18 */	addi r26, r3, data_80396018@l            /* constant-address: 80396018, symbol: data_80396018 */
/* 801C5DD0  3C 60 80 39 */	lis r3, data_80396040@ha                
/* 801C5DD4  3B 63 60 40 */	addi r27, r3, data_80396040@l            /* constant-address: 80396040, symbol: data_80396040 */
/* 801C5DD8  3C 60 80 39 */	lis r3, d_menu_d_menu_fishing__stringBase0@ha
/* 801C5DDC  3B 83 60 68 */	addi r28, r3, d_menu_d_menu_fishing__stringBase0@l /* constant-address: 80396068, symbol: d_menu_d_menu_fishing__stringBase0 */
lbl_801C5DE0:
...
/* 801C5E2C  4B E4 EB C5 */	bl mDoExt_getMesgFont__Fv                /* constant-address: 800149F0, symbol: mDoExt_getMesgFont__Fv */
...
/* 801C5E48  4B E4 EB A9 */	bl mDoExt_getMesgFont__Fv                /* constant-address: 800149F0, symbol: mDoExt_getMesgFont__Fv */
...
/* 801C5E6C  38 BC 00 3E */	addi r5, r28, 0x3e                       /* constant-address: 803960A6, symbol: None */
/* 801C5E70  4C C6 31 82 */	crclr 6                                 
/* 801C5E74  48 13 A8 D9 */	bl setString__10J2DTextBoxFsPCce         /* constant-address: 8030074C, symbol: setString__10J2DTextBoxFsPCce */
/* 801C5E78  80 79 00 34 */	lwz r3, 0x34(r25)                       
/* 801C5E7C  38 80 00 20 */	li r4, 0x20                             
/* 801C5E80  38 BC 00 3E */	addi r5, r28, 0x3e                       /* constant-address: 803960A6, symbol: None */
/* 801C5E84  4C C6 31 82 */	crclr 6                                 
/* 801C5E88  48 13 A8 C5 */	bl setString__10J2DTextBoxFsPCce         /* constant-address: 8030074C, symbol: setString__10J2DTextBoxFsPCce */
...
/* 801C5E9C  41 80 FF 44 */	blt lbl_801C5DE0                         /* constant-address: 801C5DE0, symbol: lbl_801C5DE0 */
/* 801C5EA0  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801C5EA4  48 19 C3 71 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

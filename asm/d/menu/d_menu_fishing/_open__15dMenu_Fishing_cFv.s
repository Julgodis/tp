...
/* 801C5308  40 82 00 1C */	bne lbl_801C5324                         /* constant-address: 801C5324, symbol: lbl_801C5324 */
/* 801C530C  3C 60 80 39 */	lis r3, d_menu_d_menu_fishing__stringBase0@ha
/* 801C5310  38 63 60 68 */	addi r3, r3, d_menu_d_menu_fishing__stringBase0@l /* constant-address: 80396068, symbol: d_menu_d_menu_fishing__stringBase0 */
/* 801C5314  38 80 00 00 */	li r4, 0                                
/* 801C5318  38 A0 00 00 */	li r5, 0                                
/* 801C531C  4B E5 0A F9 */	bl create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap /* constant-address: 80015E14, symbol: create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap */
/* 801C5320  90 7F 00 14 */	stw r3, 0x14(r31)                       
lbl_801C5324:
/* 801C5324  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 801C5328  28 03 00 00 */	cmplwi r3, 0                            
/* 801C532C  40 82 00 60 */	bne lbl_801C538C                         /* constant-address: 801C538C, symbol: lbl_801C538C */
/* 801C5330  80 9F 00 14 */	lwz r4, 0x14(r31)                       
/* 801C5334  88 04 00 0C */	lbz r0, 0xc(r4)                         
/* 801C5338  2C 00 00 00 */	cmpwi r0, 0                             
/* 801C533C  41 82 00 48 */	beq lbl_801C5384                         /* constant-address: 801C5384, symbol: lbl_801C5384 */
/* 801C5340  28 03 00 00 */	cmplwi r3, 0                            
/* 801C5344  40 82 00 48 */	bne lbl_801C538C                         /* constant-address: 801C538C, symbol: lbl_801C538C */
...
/* 801C5358  41 82 00 18 */	beq lbl_801C5370                         /* constant-address: 801C5370, symbol: lbl_801C5370 */
...
/* 801C537C  4B FF FC D1 */	bl _create__15dMenu_Fishing_cFv          /* constant-address: 801C504C, symbol: _create__15dMenu_Fishing_cFv */
/* 801C5380  48 00 00 0C */	b lbl_801C538C                           /* constant-address: 801C538C, symbol: lbl_801C538C */
lbl_801C5384:
/* 801C5384  38 60 00 00 */	li r3, 0                                
/* 801C5388  48 00 00 CC */	b lbl_801C5454                           /* constant-address: 801C5454, symbol: lbl_801C5454 */
lbl_801C538C:
/* 801C538C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C5390  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C5394  A8 83 09 A4 */	lha r4, 0x9a4(r3)                        /* constant-address: 8042F56C, symbol: None */
/* 801C5398  A8 63 09 A6 */	lha r3, 0x9a6(r3)                        /* constant-address: 8042F56E, symbol: None */
/* 801C539C  B0 9F 01 F8 */	sth r4, 0x1f8(r31)                      
/* 801C53A0  A8 1F 01 F8 */	lha r0, 0x1f8(r31)                      
/* 801C53A4  7C 00 20 00 */	cmpw r0, r4                             
/* 801C53A8  41 80 00 48 */	blt lbl_801C53F0                         /* constant-address: 801C53F0, symbol: lbl_801C53F0 */
...
/* 801C53C0  C0 02 A7 14 */	lfs f0, lit_4010(r2)                     /* constant-address: 80454114, symbol: lit_4010 */
...
/* 801C53E0  C0 22 A7 14 */	lfs f1, lit_4010(r2)                     /* constant-address: 80454114, symbol: lit_4010 */
/* 801C53E4  48 09 03 ED */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801C53E8  38 60 00 01 */	li r3, 1                                
/* 801C53EC  48 00 00 68 */	b lbl_801C5454                           /* constant-address: 801C5454, symbol: lbl_801C5454 */
lbl_801C53F0:
/* 801C53F0  C8 42 A7 18 */	lfd f2, lit_4012(r2)                     /* constant-address: 80454118, symbol: lit_4012 */
...
/* 801C544C  48 09 03 85 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */

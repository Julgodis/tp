...
/* 801C6220  48 19 BF AD */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 801C6224  7C 7F 1B 78 */	mr r31, r3                              
/* 801C6228  7C 9A 23 78 */	mr r26, r4                              
/* 801C622C  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 801C6230  40 82 00 18 */	bne lbl_801C6248                         /* constant-address: 801C6248, symbol: lbl_801C6248 */
/* 801C6234  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C6238  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C623C  88 03 09 D8 */	lbz r0, 0x9d8(r3)                        /* constant-address: 8042F5A0, symbol: None */
/* 801C6240  28 00 00 00 */	cmplwi r0, 0                            
/* 801C6244  41 82 01 F4 */	beq lbl_801C6438                         /* constant-address: 801C6438, symbol: lbl_801C6438 */
lbl_801C6248:
/* 801C6248  3B 60 00 00 */	li r27, 0                               
/* 801C624C  3B 20 00 00 */	li r25, 0                               
/* 801C6250  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C6254  3B C3 EB C8 */	addi r30, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
lbl_801C6258:
...
/* 801C626C  48 08 E3 45 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C62A0  48 08 E3 11 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C62D4  48 08 E2 DD */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C6308  48 08 E2 A9 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C633C  48 08 E2 75 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C6370  48 08 E2 41 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C63A4  48 08 E2 0D */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C63D8  41 80 FE 80 */	blt lbl_801C6258                         /* constant-address: 801C6258, symbol: lbl_801C6258 */
/* 801C63DC  3B C0 00 00 */	li r30, 0                               
/* 801C63E0  3B 60 00 00 */	li r27, 0                               
/* 801C63E4  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C63E8  3B 23 EB C8 */	addi r25, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
lbl_801C63EC:
...
/* 801C6400  48 08 E1 B1 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
...
/* 801C6434  41 80 FF B8 */	blt lbl_801C63EC                         /* constant-address: 801C63EC, symbol: lbl_801C63EC */
lbl_801C6438:
/* 801C6438  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C643C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C6440  88 03 06 B4 */	lbz r0, 0x6b4(r3)                        /* constant-address: 8042F27C, symbol: None */
/* 801C6444  28 00 00 00 */	cmplwi r0, 0                            
/* 801C6448  40 82 00 0C */	bne lbl_801C6454                         /* constant-address: 801C6454, symbol: lbl_801C6454 */
/* 801C644C  57 40 06 3F */	clrlwi. r0, r26, 0x18                   
/* 801C6450  41 82 01 34 */	beq lbl_801C6584                         /* constant-address: 801C6584, symbol: lbl_801C6584 */
lbl_801C6454:
/* 801C6454  80 7F 00 FC */	lwz r3, 0xfc(r31)                       
/* 801C6458  28 03 00 00 */	cmplwi r3, 0                            
/* 801C645C  41 82 00 44 */	beq lbl_801C64A0                         /* constant-address: 801C64A0, symbol: lbl_801C64A0 */
/* 801C6460  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801C6464  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C6468  C0 24 06 60 */	lfs f1, 0x660(r4)                        /* constant-address: 8042F228, symbol: None */
/* 801C646C  C0 44 06 64 */	lfs f2, 0x664(r4)                        /* constant-address: 8042F22C, symbol: None */
/* 801C6470  48 08 E1 41 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 801C6474  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C6478  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C647C  C0 03 06 68 */	lfs f0, 0x668(r3)                        /* constant-address: 8042F230, symbol: None */
...
/* 801C64A8  41 82 00 44 */	beq lbl_801C64EC                         /* constant-address: 801C64EC, symbol: lbl_801C64EC */
/* 801C64AC  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801C64B0  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C64B4  C0 24 06 6C */	lfs f1, 0x66c(r4)                        /* constant-address: 8042F234, symbol: None */
/* 801C64B8  C0 44 06 70 */	lfs f2, 0x670(r4)                        /* constant-address: 8042F238, symbol: None */
/* 801C64BC  48 08 E0 F5 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 801C64C0  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C64C4  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C64C8  C0 03 06 74 */	lfs f0, 0x674(r3)                        /* constant-address: 8042F23C, symbol: None */
...
/* 801C64F4  41 82 00 44 */	beq lbl_801C6538                         /* constant-address: 801C6538, symbol: lbl_801C6538 */
/* 801C64F8  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801C64FC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C6500  C0 24 06 78 */	lfs f1, 0x678(r4)                        /* constant-address: 8042F240, symbol: None */
/* 801C6504  C0 44 06 7C */	lfs f2, 0x67c(r4)                        /* constant-address: 8042F244, symbol: None */
/* 801C6508  48 08 E0 A9 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 801C650C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C6510  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C6514  C0 03 06 80 */	lfs f0, 0x680(r3)                        /* constant-address: 8042F248, symbol: None */
...
/* 801C6540  41 82 00 44 */	beq lbl_801C6584                         /* constant-address: 801C6584, symbol: lbl_801C6584 */
/* 801C6544  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801C6548  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C654C  C0 24 06 84 */	lfs f1, 0x684(r4)                        /* constant-address: 8042F24C, symbol: None */
/* 801C6550  C0 44 06 88 */	lfs f2, 0x688(r4)                        /* constant-address: 8042F250, symbol: None */
/* 801C6554  48 08 E0 5D */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 801C6558  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801C655C  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801C6560  C0 03 06 8C */	lfs f0, 0x68c(r3)                        /* constant-address: 8042F254, symbol: None */
...
/* 801C6588  48 19 BC 91 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 801FCE14  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 801FCE18  80 63 00 04 */	lwz r3, 4(r3)                           
/* 801FCE1C  28 03 00 00 */	cmplwi r3, 0                            
/* 801FCE20  41 82 00 18 */	beq lbl_801FCE38                         /* constant-address: 801FCE38, symbol: lbl_801FCE38 */
...
lbl_801FCE38:
/* 801FCE38  80 0D 80 84 */	lwz r0, g_blackColor(r13)                /* constant-address: 80450604, symbol: g_blackColor */
/* 801FCE3C  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 801FCE40  90 01 00 08 */	stw r0, 8(r1)                           
/* 801FCE44  80 6D 86 48 */	lwz r3, mFader__13mDoGph_gInf_c(r13)     /* constant-address: 80450BC8, symbol: mFader__13mDoGph_gInf_c */

...
/* 801FD158  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801FD15C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801FD160  80 03 5E BC */	lwz r0, 0x5ebc(r3)                       /* constant-address: 8040C07C, symbol: None */
/* 801FD164  90 1E 01 00 */	stw r0, 0x100(r30)                      
/* 801FD168  38 60 00 30 */	li r3, 0x30                             
/* 801FD16C  48 0D 1A E1 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 801FD170  7C 60 1B 79 */	or. r0, r3, r3                          
/* 801FD174  41 82 00 2C */	beq lbl_801FD1A0                         /* constant-address: 801FD1A0, symbol: lbl_801FD1A0 */
/* 801FD178  38 80 00 05 */	li r4, 5                                
/* 801FD17C  38 A0 00 02 */	li r5, 2                                
/* 801FD180  38 C0 00 01 */	li r6, 1                                
/* 801FD184  38 E0 00 01 */	li r7, 1                                
/* 801FD188  C0 22 AA D4 */	lfs f1, lit_6086(r2)                     /* constant-address: 804544D4, symbol: lit_6086 */
/* 801FD18C  C0 42 AA D8 */	lfs f2, lit_6087(r2)                     /* constant-address: 804544D8, symbol: lit_6087 */
/* 801FD190  39 00 00 00 */	li r8, 0                                
/* 801FD194  39 20 08 00 */	li r9, 0x800                            
/* 801FD198  4B E3 4E AD */	bl __ct__9STControlFssssffss             /* constant-address: 80032044, symbol: __ct__9STControlFssssffss */
...
/* 801FD1B4  48 0D 1A 99 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 801FD1B8  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 801FD1BC  41 82 00 34 */	beq lbl_801FD1F0                         /* constant-address: 801FD1F0, symbol: lbl_801FD1F0 */
/* 801FD1C0  38 80 00 05 */	li r4, 5                                
/* 801FD1C4  38 A0 00 02 */	li r5, 2                                
/* 801FD1C8  38 C0 00 03 */	li r6, 3                                
/* 801FD1CC  38 E0 00 02 */	li r7, 2                                
/* 801FD1D0  C0 22 AA D4 */	lfs f1, lit_6086(r2)                     /* constant-address: 804544D4, symbol: lit_6086 */
/* 801FD1D4  C0 42 AA D8 */	lfs f2, lit_6087(r2)                     /* constant-address: 804544D8, symbol: lit_6087 */
/* 801FD1D8  39 00 00 00 */	li r8, 0                                
/* 801FD1DC  39 20 20 00 */	li r9, 0x2000                           
/* 801FD1E0  4B E3 4E 65 */	bl __ct__9STControlFssssffss             /* constant-address: 80032044, symbol: __ct__9STControlFssssffss */
/* 801FD1E4  3C 60 80 3A */	lis r3, __vt__10CSTControl@ha           
/* 801FD1E8  38 03 72 50 */	addi r0, r3, __vt__10CSTControl@l        /* constant-address: 803A7250, symbol: __vt__10CSTControl */
...
/* 801FD208  C0 22 AA D4 */	lfs f1, lit_6086(r2)                     /* constant-address: 804544D4, symbol: lit_6086 */
/* 801FD20C  C0 42 AA D8 */	lfs f2, lit_6087(r2)                     /* constant-address: 804544D8, symbol: lit_6087 */
/* 801FD210  39 00 00 00 */	li r8, 0                                
/* 801FD214  39 20 20 00 */	li r9, 0x2000                           
/* 801FD218  4B E3 4E 71 */	bl setWaitParm__9STControlFssssffss      /* constant-address: 80032088, symbol: setWaitParm__9STControlFssssffss */
...
/* 801FD250  C0 02 AA C0 */	lfs f0, lit_4152(r2)                     /* constant-address: 804544C0, symbol: lit_4152 */
...
/* 801FD2A8  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 801FD2AC  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 801FD2B0  88 03 00 B9 */	lbz r0, 0xb9(r3)                         /* constant-address: 80430241, symbol: None */
/* 801FD2B4  98 03 00 BA */	stb r0, 0xba(r3)                         /* constant-address: 80430242, symbol: None */
/* 801FD2B8  98 83 00 B9 */	stb r4, 0xb9(r3)                         /* constant-address: 80430241, symbol: None */

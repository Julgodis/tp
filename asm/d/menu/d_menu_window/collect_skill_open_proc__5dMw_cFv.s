...
/* 801FBA3C  40 82 00 30 */	bne lbl_801FBA6C                         /* constant-address: 801FBA6C, symbol: lbl_801FBA6C */
/* 801FBA40  4B FF C0 01 */	bl _open__13dMenu_Skill_cFv              /* constant-address: 801F7A40, symbol: _open__13dMenu_Skill_cFv */
/* 801FBA44  88 1F 01 52 */	lbz r0, 0x152(r31)                      
/* 801FBA48  28 00 00 00 */	cmplwi r0, 0                            
/* 801FBA4C  40 82 00 20 */	bne lbl_801FBA6C                         /* constant-address: 801FBA6C, symbol: lbl_801FBA6C */
/* 801FBA50  80 7F 01 30 */	lwz r3, 0x130(r31)                      
/* 801FBA54  4B FF BE FD */	bl isSync__13dMenu_Skill_cFv             /* constant-address: 801F7950, symbol: isSync__13dMenu_Skill_cFv */
/* 801FBA58  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801FBA5C  41 82 00 10 */	beq lbl_801FBA6C                         /* constant-address: 801FBA6C, symbol: lbl_801FBA6C */
/* 801FBA60  48 00 14 19 */	bl dMw_fade_in__5dMw_cFv                 /* constant-address: 801FCE78, symbol: dMw_fade_in__5dMw_cFv */
...
/* 801FBA78  40 82 00 20 */	bne lbl_801FBA98                         /* constant-address: 801FBA98, symbol: lbl_801FBA98 */
/* 801FBA7C  88 1F 01 52 */	lbz r0, 0x152(r31)                      
/* 801FBA80  28 00 00 01 */	cmplwi r0, 1                            
/* 801FBA84  40 82 00 14 */	bne lbl_801FBA98                         /* constant-address: 801FBA98, symbol: lbl_801FBA98 */

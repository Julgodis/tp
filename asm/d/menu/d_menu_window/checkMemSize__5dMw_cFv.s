...
/* 801FD0F0  40 81 00 3C */	ble lbl_801FD12C                         /* constant-address: 801FD12C, symbol: lbl_801FD12C */
/* 801FD0F4  80 7F 01 00 */	lwz r3, 0x100(r31)                      
/* 801FD0F8  48 0D 16 8D */	bl getTotalFreeSize__7JKRHeapFv          /* constant-address: 802CE784, symbol: getTotalFreeSize__7JKRHeapFv */
/* 801FD0FC  80 1F 01 38 */	lwz r0, 0x138(r31)                      
/* 801FD100  7C 00 18 51 */	subf. r0, r0, r3                        
/* 801FD104  40 80 00 08 */	bge lbl_801FD10C                         /* constant-address: 801FD10C, symbol: lbl_801FD10C */
/* 801FD108  1C 00 FF FF */	mulli r0, r0, -1                        
lbl_801FD10C:
/* 801FD10C  2C 00 00 20 */	cmpwi r0, 0x20                          
/* 801FD110  40 81 00 14 */	ble lbl_801FD124                         /* constant-address: 801FD124, symbol: lbl_801FD124 */
/* 801FD114  3C 60 80 39 */	lis r3, d_menu_d_menu_window__stringBase0@ha
/* 801FD118  38 63 7E 38 */	addi r3, r3, d_menu_d_menu_window__stringBase0@l /* constant-address: 80397E38, symbol: d_menu_d_menu_window__stringBase0 */
/* 801FD11C  4C C6 31 82 */	crclr 6                                 
/* 801FD120  4B E0 9A ED */	bl OSReport_Error                        /* constant-address: 80006C0C, symbol: OSReport_Error */
lbl_801FD124:

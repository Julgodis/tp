...
/* 801FCE84  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 801FCE88  80 63 00 04 */	lwz r3, 4(r3)                           
/* 801FCE8C  28 03 00 00 */	cmplwi r3, 0                            
/* 801FCE90  41 82 00 18 */	beq lbl_801FCEA8                         /* constant-address: 801FCEA8, symbol: lbl_801FCEA8 */
...
lbl_801FCEA8:
/* 801FCEA8  80 0D 80 84 */	lwz r0, g_blackColor(r13)                /* constant-address: 80450604, symbol: g_blackColor */
/* 801FCEAC  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 801FCEB0  90 01 00 08 */	stw r0, 8(r1)                           
/* 801FCEB4  80 6D 86 48 */	lwz r3, mFader__13mDoGph_gInf_c(r13)     /* constant-address: 80450BC8, symbol: mFader__13mDoGph_gInf_c */

...
/* 801FC280  41 82 00 84 */	beq lbl_801FC304                         /* constant-address: 801FC304, symbol: lbl_801FC304 */
/* 801FC284  4B FC B8 79 */	bl isSync__12dMenu_Fmap_cFv              /* constant-address: 801C7AFC, symbol: isSync__12dMenu_Fmap_cFv */
/* 801FC288  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801FC28C  40 82 00 0C */	bne lbl_801FC298                         /* constant-address: 801FC298, symbol: lbl_801FC298 */
/* 801FC290  38 60 00 00 */	li r3, 0                                
/* 801FC294  48 00 00 A8 */	b lbl_801FC33C                           /* constant-address: 801FC33C, symbol: lbl_801FC33C */
lbl_801FC298:
/* 801FC298  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC29C  4B FC EF 41 */	bl getProcess__12dMenu_Fmap_cFv          /* constant-address: 801CB1DC, symbol: getProcess__12dMenu_Fmap_cFv */
/* 801FC2A0  98 7F 01 4E */	stb r3, 0x14e(r31)                      
/* 801FC2A4  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC2A8  4B FC EF 59 */	bl getRegionCursor__12dMenu_Fmap_cFv     /* constant-address: 801CB200, symbol: getRegionCursor__12dMenu_Fmap_cFv */
/* 801FC2AC  98 7F 01 4F */	stb r3, 0x14f(r31)                      
/* 801FC2B0  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC2B4  4B FC EF 7D */	bl getStageCursor__12dMenu_Fmap_cFv      /* constant-address: 801CB230, symbol: getStageCursor__12dMenu_Fmap_cFv */
/* 801FC2B8  98 7F 01 50 */	stb r3, 0x150(r31)                      
/* 801FC2BC  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC2C0  4B FC EF A1 */	bl getStageTransX__12dMenu_Fmap_cFv      /* constant-address: 801CB260, symbol: getStageTransX__12dMenu_Fmap_cFv */
/* 801FC2C4  D0 3F 01 3C */	stfs f1, 0x13c(r31)                     
/* 801FC2C8  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC2CC  4B FC EF C5 */	bl getStageTransZ__12dMenu_Fmap_cFv      /* constant-address: 801CB290, symbol: getStageTransZ__12dMenu_Fmap_cFv */
/* 801FC2D0  D0 3F 01 40 */	stfs f1, 0x140(r31)                     
/* 801FC2D4  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC2D8  4B FC B1 CD */	bl _delete__12dMenu_Fmap_cFv             /* constant-address: 801C74A4, symbol: _delete__12dMenu_Fmap_cFv */
/* 801FC2DC  80 7F 01 1C */	lwz r3, 0x11c(r31)                      
/* 801FC2E0  28 03 00 00 */	cmplwi r3, 0                            
/* 801FC2E4  41 82 00 18 */	beq lbl_801FC2FC                         /* constant-address: 801FC2FC, symbol: lbl_801FC2FC */
...
/* 801FC30C  41 82 00 24 */	beq lbl_801FC330                         /* constant-address: 801FC330, symbol: lbl_801FC330 */
/* 801FC310  41 82 00 18 */	beq lbl_801FC328                         /* constant-address: 801FC328, symbol: lbl_801FC328 */
...
/* 801FC334  48 00 0D A1 */	bl checkMemSize__5dMw_cFv                /* constant-address: 801FD0D4, symbol: checkMemSize__5dMw_cFv */

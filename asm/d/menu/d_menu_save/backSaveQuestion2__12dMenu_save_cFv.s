...
/* 801F1A64  41 82 00 10 */	beq lbl_801F1A74                         /* constant-address: 801F1A74, symbol: lbl_801F1A74 */
/* 801F1A68  38 04 FF FF */	addi r0, r4, -1                         
/* 801F1A6C  98 1F 01 BD */	stb r0, 0x1bd(r31)                      
/* 801F1A70  48 00 00 B4 */	b lbl_801F1B24                           /* constant-address: 801F1B24, symbol: lbl_801F1B24 */
lbl_801F1A74:
/* 801F1A74  88 1F 01 BC */	lbz r0, 0x1bc(r31)                      
/* 801F1A78  28 00 00 04 */	cmplwi r0, 4                            
/* 801F1A7C  40 82 00 38 */	bne lbl_801F1AB4                         /* constant-address: 801F1AB4, symbol: lbl_801F1AB4 */
/* 801F1A80  88 1F 21 A2 */	lbz r0, 0x21a2(r31)                     
/* 801F1A84  28 00 00 01 */	cmplwi r0, 1                            
/* 801F1A88  40 82 00 24 */	bne lbl_801F1AAC                         /* constant-address: 801F1AAC, symbol: lbl_801F1AAC */
...
/* 801F1AA4  48 00 1A 19 */	bl msgTxtSet__12dMenu_save_cFUsb         /* constant-address: 801F34BC, symbol: msgTxtSet__12dMenu_save_cFUsb */
/* 801F1AA8  48 00 00 10 */	b lbl_801F1AB8                           /* constant-address: 801F1AB8, symbol: lbl_801F1AB8 */
lbl_801F1AAC:
/* 801F1AAC  4B FF FE FD */	bl backSaveQuestionInitSet__12dMenu_save_cFv /* constant-address: 801F19A8, symbol: backSaveQuestionInitSet__12dMenu_save_cFv */
/* 801F1AB0  48 00 00 08 */	b lbl_801F1AB8                           /* constant-address: 801F1AB8, symbol: lbl_801F1AB8 */
lbl_801F1AB4:
/* 801F1AB4  4B FF FE F5 */	bl backSaveQuestionInitSet__12dMenu_save_cFv /* constant-address: 801F19A8, symbol: backSaveQuestionInitSet__12dMenu_save_cFv */
lbl_801F1AB8:
/* 801F1AB8  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 801F1ABC  80 63 00 04 */	lwz r3, 4(r3)                           
/* 801F1AC0  28 03 00 00 */	cmplwi r3, 0                            
/* 801F1AC4  41 82 00 18 */	beq lbl_801F1ADC                         /* constant-address: 801F1ADC, symbol: lbl_801F1ADC */
...
/* 801F1AFC  40 82 00 24 */	bne lbl_801F1B20                         /* constant-address: 801F1B20, symbol: lbl_801F1B20 */
/* 801F1B00  88 1F 21 A2 */	lbz r0, 0x21a2(r31)                     
/* 801F1B04  28 00 00 01 */	cmplwi r0, 1                            
/* 801F1B08  40 82 00 10 */	bne lbl_801F1B18                         /* constant-address: 801F1B18, symbol: lbl_801F1B18 */
/* 801F1B0C  38 00 00 05 */	li r0, 5                                
/* 801F1B10  98 1F 01 B2 */	stb r0, 0x1b2(r31)                      
/* 801F1B14  48 00 00 10 */	b lbl_801F1B24                           /* constant-address: 801F1B24, symbol: lbl_801F1B24 */
lbl_801F1B18:
/* 801F1B18  98 7F 01 B2 */	stb r3, 0x1b2(r31)                      
/* 801F1B1C  48 00 00 08 */	b lbl_801F1B24                           /* constant-address: 801F1B24, symbol: lbl_801F1B24 */
lbl_801F1B20:

...
/* 801F1574  41 82 00 98 */	beq lbl_801F160C                         /* constant-address: 801F160C, symbol: lbl_801F160C */
/* 801F1578  88 03 00 60 */	lbz r0, 0x60(r3)                        
/* 801F157C  28 00 00 00 */	cmplwi r0, 0                            
/* 801F1580  40 82 00 8C */	bne lbl_801F160C                         /* constant-address: 801F160C, symbol: lbl_801F160C */
/* 801F1584  88 1F 01 BC */	lbz r0, 0x1bc(r31)                      
/* 801F1588  28 00 00 04 */	cmplwi r0, 4                            
/* 801F158C  40 82 00 4C */	bne lbl_801F15D8                         /* constant-address: 801F15D8, symbol: lbl_801F15D8 */
/* 801F1590  3C 60 80 43 */	lis r3, g_msHIO@ha                      
/* 801F1594  38 63 E8 4C */	addi r3, r3, g_msHIO@l                   /* constant-address: 8042E84C, symbol: g_msHIO */
/* 801F1598  88 03 00 0B */	lbz r0, 0xb(r3)                          /* constant-address: 8042E857, symbol: None */
/* 801F159C  98 1F 01 BD */	stb r0, 0x1bd(r31)                      
/* 801F15A0  88 9F 01 BD */	lbz r4, 0x1bd(r31)                      
/* 801F15A4  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 801F15A8  80 63 00 04 */	lwz r3, 4(r3)                           
/* 801F15AC  28 03 00 00 */	cmplwi r3, 0                            
/* 801F15B0  41 82 00 14 */	beq lbl_801F15C4                         /* constant-address: 801F15C4, symbol: lbl_801F15C4 */
...
/* 801F15D4  48 00 00 38 */	b lbl_801F160C                           /* constant-address: 801F160C, symbol: lbl_801F160C */
lbl_801F15D8:
/* 801F15D8  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 801F15DC  80 63 00 04 */	lwz r3, 4(r3)                           
/* 801F15E0  28 03 00 00 */	cmplwi r3, 0                            
/* 801F15E4  41 82 00 18 */	beq lbl_801F15FC                         /* constant-address: 801F15FC, symbol: lbl_801F15FC */

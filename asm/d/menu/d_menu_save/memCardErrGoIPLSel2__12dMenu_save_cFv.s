...
/* 801F1EFC  48 00 2F 4D */	bl errYesNoSelect__12dMenu_save_cFUcUc   /* constant-address: 801F4E48, symbol: errYesNoSelect__12dMenu_save_cFUcUc */
/* 801F1F00  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801F1F04  41 82 00 68 */	beq lbl_801F1F6C                         /* constant-address: 801F1F6C, symbol: lbl_801F1F6C */
/* 801F1F08  88 1F 01 B6 */	lbz r0, 0x1b6(r31)                      
/* 801F1F0C  28 00 00 00 */	cmplwi r0, 0                            
/* 801F1F10  41 82 00 54 */	beq lbl_801F1F64                         /* constant-address: 801F1F64, symbol: lbl_801F1F64 */
/* 801F1F14  38 00 00 01 */	li r0, 1                                
/* 801F1F18  98 1F 01 BF */	stb r0, 0x1bf(r31)                      
/* 801F1F1C  3C 60 80 43 */	lis r3, g_msHIO@ha                      
/* 801F1F20  38 63 E8 4C */	addi r3, r3, g_msHIO@l                   /* constant-address: 8042E84C, symbol: g_msHIO */
/* 801F1F24  88 03 00 0B */	lbz r0, 0xb(r3)                          /* constant-address: 8042E857, symbol: None */
/* 801F1F28  98 1F 01 BD */	stb r0, 0x1bd(r31)                      
/* 801F1F2C  88 9F 01 BD */	lbz r4, 0x1bd(r31)                      
/* 801F1F30  80 6D 8C 40 */	lwz r3, sManager__10JFWDisplay(r13)      /* constant-address: 804511C0, symbol: sManager__10JFWDisplay */
/* 801F1F34  80 63 00 04 */	lwz r3, 4(r3)                           
/* 801F1F38  28 03 00 00 */	cmplwi r3, 0                            
/* 801F1F3C  41 82 00 14 */	beq lbl_801F1F50                         /* constant-address: 801F1F50, symbol: lbl_801F1F50 */
...
/* 801F1F60  48 00 00 0C */	b lbl_801F1F6C                           /* constant-address: 801F1F6C, symbol: lbl_801F1F6C */
lbl_801F1F64:
/* 801F1F64  7F E3 FB 78 */	mr r3, r31                              
/* 801F1F68  4B FF FB D1 */	bl closeSelect__12dMenu_save_cFv         /* constant-address: 801F1B38, symbol: closeSelect__12dMenu_save_cFv */
lbl_801F1F6C:

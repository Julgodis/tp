...
/* 801D3BCC  48 18 E6 0D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 801D3BD0  7C 7C 1B 78 */	mr r28, r3                              
/* 801D3BD4  80 63 0D 88 */	lwz r3, 0xd88(r3)                       
/* 801D3BD8  28 03 00 00 */	cmplwi r3, 0                            
/* 801D3BDC  41 82 00 C4 */	beq lbl_801D3CA0                         /* constant-address: 801D3CA0, symbol: lbl_801D3CA0 */
/* 801D3BE0  3B C3 00 04 */	addi r30, r3, 4                         
/* 801D3BE4  3B A0 00 00 */	li r29, 0                               
/* 801D3BE8  3B E0 00 00 */	li r31, 0                               
/* 801D3BEC  48 00 00 A8 */	b lbl_801D3C94                           /* constant-address: 801D3C94, symbol: lbl_801D3C94 */
lbl_801D3BF0:
...
/* 801D3C04  40 82 00 88 */	bne lbl_801D3C8C                         /* constant-address: 801D3C8C, symbol: lbl_801D3C8C */
...
/* 801D3C44  4B FF D0 D5 */	bl calcAllMapPos2D__18dMenu_Fmap2DBack_cFffPfPf /* constant-address: 801D0D18, symbol: calcAllMapPos2D__18dMenu_Fmap2DBack_cFffPfPf */
...
/* 801D3C6C  C0 42 A7 F0 */	lfs f2, lit_4204(r2)                     /* constant-address: 804541F0, symbol: lit_4204 */
/* 801D3C70  EC 20 10 28 */	fsubs f1, f0, f2                        
/* 801D3C74  C0 01 00 10 */	lfs f0, 0x10(r1)                        
/* 801D3C78  EC 40 10 28 */	fsubs f2, f0, f2                        
/* 801D3C7C  C0 62 A7 F4 */	lfs f3, lit_4205(r2)                     /* constant-address: 804541F4, symbol: lit_4205 */
/* 801D3C80  FC 80 18 90 */	fmr f4, f3                              
/* 801D3C84  38 61 00 0C */	addi r3, r1, 0xc                        
/* 801D3C88  48 11 5E 3D */	bl J2DFillBox__FffffQ28JUtility6TColor   /* constant-address: 802E9AC4, symbol: J2DFillBox__FffffQ28JUtility6TColor */
lbl_801D3C8C:
/* 801D3C8C  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
/* 801D3C90  3B FF 00 14 */	addi r31, r31, 0x14                      /* constant-address: 00000014 */
lbl_801D3C94:
/* 801D3C94  88 1C 12 25 */	lbz r0, 0x1225(r28)                     
/* 801D3C98  7C 1D 00 00 */	cmpw r29, r0                            
/* 801D3C9C  41 80 FF 54 */	blt lbl_801D3BF0                         /* constant-address: 801D3BF0, symbol: lbl_801D3BF0 */
lbl_801D3CA0:
/* 801D3CA0  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801D3CA4  48 18 E5 81 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

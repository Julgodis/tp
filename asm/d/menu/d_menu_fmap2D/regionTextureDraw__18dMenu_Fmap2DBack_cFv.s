...
/* 801D2DC4 00000000  39 61 00 60 */	addi r11, r1, 0x60
/* 801D2DC8 00000004  48 18 F4 05 */	bl _savegpr_25
/* 801D2DCC 00000008  7C 7E 1B 78 */	mr r30, r3
/* 801D2DD0 0000000C  4B FF FB 01 */	bl getMapScissorAreaCenterPosY__18dMenu_Fmap2DBack_cFv
/* 801D2DD4 00000010  FF C0 08 90 */	fmr f30, f1
/* 801D2DD8 00000014  7F C3 F3 78 */	mr r3, r30
/* 801D2DDC 00000018  4B FF FA A5 */	bl getMapScissorAreaCenterPosX__18dMenu_Fmap2DBack_cFv
/* 801D2DE0 0000001C  7F C3 F3 78 */	mr r3, r30
/* 801D2DE4 00000020  FC 40 F0 90 */	fmr f2, f30
/* 801D2DE8 00000024  38 81 00 2C */	addi r4, r1, 0x2c
/* 801D2DEC 00000028  38 A1 00 28 */	addi r5, r1, 0x28
/* 801D2DF0 0000002C  4B FF E1 8D */	bl calcAllMapPosWorld__18dMenu_Fmap2DBack_cFffPfPf
/* 801D2DF4 00000030  7F C3 F3 78 */	mr r3, r30
/* 801D2DF8 00000034  C0 21 00 2C */	lfs f1, 0x2c(r1)
/* 801D2DFC 00000038  C0 1E 0F C8 */	lfs f0, 0xfc8(r30)
/* 801D2E00 0000003C  EC 21 00 2A */	fadds f1, f1, f0
/* 801D2E04 00000040  C0 41 00 28 */	lfs f2, 0x28(r1)
/* 801D2E08 00000044  C0 1E 0F CC */	lfs f0, 0xfcc(r30)
/* 801D2E0C 00000048  EC 42 00 2A */	fadds f2, f2, f0
/* 801D2E10 0000004C  38 81 00 24 */	addi r4, r1, 0x24
/* 801D2E14 00000050  38 A1 00 20 */	addi r5, r1, 0x20
/* 801D2E18 00000054  4B FF DF 01 */	bl calcAllMapPos2D__18dMenu_Fmap2DBack_cFffPfPf
/* 801D2E1C 00000058  7F C3 F3 78 */	mr r3, r30
/* 801D2E20 0000005C  4B FF FA 61 */	bl getMapScissorAreaCenterPosX__18dMenu_Fmap2DBack_cFv
/* 801D2E24 00000060  C0 01 00 24 */	lfs f0, 0x24(r1)
/* 801D2E28 00000064  EF E1 00 28 */	fsubs f31, f1, f0
/* 801D2E2C 00000068  7F C3 F3 78 */	mr r3, r30
/* 801D2E30 0000006C  4B FF FA A1 */	bl getMapScissorAreaCenterPosY__18dMenu_Fmap2DBack_cFv
/* 801D2E34 00000070  C0 01 00 20 */	lfs f0, 0x20(r1)
/* 801D2E38 00000074  EF C1 00 28 */	fsubs f30, f1, f0
/* 801D2E3C 00000078  8B BE 12 27 */	lbz r29, 0x1227(r30)
/* 801D2E40 0000007C  C0 22 A7 D0 */	lfs f1, lit_3970(r2)
/* 801D2E44 00000080  C0 1E 0F A0 */	lfs f0, 0xfa0(r30)
/* 801D2E48 00000084  FC 01 00 00 */	fcmpu cr0, f1, f0
/* 801D2E4C 00000088  40 82 00 0C */	bne lbl_801D2E58
/* 801D2E50 0000008C  8B FE 12 26 */	lbz r31, 0x1226(r30)
/* 801D2E54 00000090  48 00 00 08 */	b lbl_801D2E5C
lbl_801D2E58:
...
/* 801D2E64 00000008  88 03 03 02 */	lbz r0, 0x302(r3)	/* effective address: 8042FF62 */
...
/* 801D2F50 0000002C  C0 62 A7 E8 */	lfs f3, lit_4202(r2)
lbl_801D2F54:
/* 801D2F54 00000000  80 7B 0C B4 */	lwz r3, 0xcb4(r27)
/* 801D2F58 00000004  C0 5E 0F A4 */	lfs f2, 0xfa4(r30)
/* 801D2F5C 00000008  C0 22 A7 E4 */	lfs f1, lit_4201(r2)
...
/* 801D3070 00000000  CB E1 00 70 */	lfd f31, 0x70(r1)
/* 801D3074 00000008  E3 C1 00 68 */	psq_l f30, 104(r1), 0, 0 /* qr0 */
/* 801D3078 00000000  CB C1 00 60 */	lfd f30, 0x60(r1)
/* 801D307C 00000004  39 61 00 60 */	addi r11, r1, 0x60
/* 801D3080 00000008  48 18 F1 99 */	bl _restgpr_25
/* 801D3084 0000000C  80 01 00 84 */	lwz r0, 0x84(r1)
/* 801D3088 00000010  7C 08 03 A6 */	mtlr r0
/* 801D308C 00000014  38 21 00 80 */	addi r1, r1, 0x80
/* 801D3090 00000018  4E 80 00 20 */	blr 

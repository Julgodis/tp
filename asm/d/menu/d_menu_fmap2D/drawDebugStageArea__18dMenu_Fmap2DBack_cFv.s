...
/* 801D53E0  48 18 CD F5 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 801D548C  41 82 01 60 */	beq lbl_801D55EC                         /* constant-address: 801D55EC, symbol: lbl_801D55EC */
/* 801D5490  80 1B 12 40 */	lwz r0, 0x1240(r27)                     
/* 801D5494  28 00 00 00 */	cmplwi r0, 0                            
/* 801D5498  41 82 01 54 */	beq lbl_801D55EC                         /* constant-address: 801D55EC, symbol: lbl_801D55EC */
/* 801D549C  3B A0 00 00 */	li r29, 0                               
/* 801D54A0  3C 60 80 43 */	lis r3, g_fmapHIO@ha                    
/* 801D54A4  3B C3 FC 60 */	addi r30, r3, g_fmapHIO@l                /* constant-address: 8042FC60, symbol: g_fmapHIO */
/* 801D54A8  CB 22 A8 08 */	lfd f25, lit_4496(r2)                    /* constant-address: 80454208, symbol: lit_4496 */
/* 801D54AC  3F E0 43 30 */	lis r31, 0x4330                         
/* 801D54B0  C3 42 A8 28 */	lfs f26, lit_5633(r2)                    /* constant-address: 80454228, symbol: lit_5633 */
/* 801D54B4  C3 62 A7 E0 */	lfs f27, lit_4200(r2)                    /* constant-address: 804541E0, symbol: lit_4200 */
/* 801D54B8  C3 C2 A8 24 */	lfs f30, lit_5632(r2)                    /* constant-address: 80454224, symbol: lit_5632 */
/* 801D54BC  C3 E2 A7 D0 */	lfs f31, lit_3970(r2)                    /* constant-address: 804541D0, symbol: lit_3970 */
/* 801D54C0  C3 02 A7 F0 */	lfs f24, lit_4204(r2)                    /* constant-address: 804541F0, symbol: lit_4204 */
/* 801D54C4  C3 82 A7 DC */	lfs f28, lit_4199(r2)                    /* constant-address: 804541DC, symbol: lit_4199 */
/* 801D54C8  48 00 01 08 */	b lbl_801D55D0                           /* constant-address: 801D55D0, symbol: lbl_801D55D0 */
lbl_801D54CC:
...
/* 801D5500  48 00 00 A8 */	b lbl_801D55A8                           /* constant-address: 801D55A8, symbol: lbl_801D55A8 */
lbl_801D5504:
...
/* 801D5534  4B FF 8E 8D */	bl getPointStagePathInnerNo__15renderingFmap_cFP24dMenu_Fmap_region_data_cffiPiPi /* constant-address: 801CE3C0, symbol: getPointStagePathInnerNo__15renderingFmap_cFP24dMenu_Fmap_region_data_cffiPiPi */
/* 801D5538  80 81 00 24 */	lwz r4, 0x24(r1)                        
/* 801D553C  2C 04 00 00 */	cmpwi r4, 0                             
/* 801D5540  41 80 00 5C */	blt lbl_801D559C                         /* constant-address: 801D559C, symbol: lbl_801D559C */
...
/* 801D5568  C8 42 A8 08 */	lfd f2, lit_4496(r2)                     /* constant-address: 80454208, symbol: lit_4496 */
...
/* 801D5584  C0 02 A7 F0 */	lfs f0, lit_4204(r2)                     /* constant-address: 804541F0, symbol: lit_4204 */
/* 801D5588  EC 42 00 28 */	fsubs f2, f2, f0                        
/* 801D558C  C0 62 A7 F4 */	lfs f3, lit_4205(r2)                     /* constant-address: 804541F4, symbol: lit_4205 */
/* 801D5590  FC 80 18 90 */	fmr f4, f3                              
/* 801D5594  38 61 00 08 */	addi r3, r1, 8                          
/* 801D5598  48 11 45 2D */	bl J2DFillBox__FffffQ28JUtility6TColor   /* constant-address: 802E9AC4, symbol: J2DFillBox__FffffQ28JUtility6TColor */
lbl_801D559C:
/* 801D559C  88 1E 03 04 */	lbz r0, 0x304(r30)                       /* constant-address: 8042FF64, symbol: None */
...
/* 801D55C0  41 80 FF 44 */	blt lbl_801D5504                         /* constant-address: 801D5504, symbol: lbl_801D5504 */
/* 801D55C4  88 1E 03 04 */	lbz r0, 0x304(r30)                       /* constant-address: 8042FF64, symbol: None */
...
/* 801D55E8  41 80 FE E4 */	blt lbl_801D54CC                         /* constant-address: 801D54CC, symbol: lbl_801D54CC */
lbl_801D55EC:
...
/* 801D5638  48 18 CB E9 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

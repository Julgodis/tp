lbl_801D77C4:
/* 801D77C4 00000000  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 801D77C8 00000004  7C 08 02 A6 */	mflr r0
/* 801D77CC 00000008  90 01 00 24 */	stw r0, 0x24(r1)
/* 801D77D0 0000000C  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 801D77D4 00000010  93 C1 00 18 */	stw r30, 0x18(r1)
/* 801D77D8 00000014  7C 9E 23 78 */	mr r30, r4
/* 801D77DC 00000018  AB E4 00 16 */	lha r31, 0x16(r4)
/* 801D77E0 0000001C  7F E0 07 35 */	extsh. r0, r31
...
lbl_801D77FC:
/* 801D77FC 00000000  38 9F FF FF */	addi r4, r31, -1
/* 801D7800 00000004  7C 80 07 35 */	extsh. r0, r4
/* 801D7804 00000008  40 80 00 08 */	bge lbl_801D780C
/* 801D7808 0000000C  38 80 00 00 */	li r4, 0
lbl_801D780C:
...
lbl_801D7840:
/* 801D7840 00000000  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 801D7844 00000004  83 C1 00 18 */	lwz r30, 0x18(r1)
/* 801D7848 00000008  80 01 00 24 */	lwz r0, 0x24(r1)
/* 801D784C 0000000C  7C 08 03 A6 */	mtlr r0
/* 801D7850 00000010  38 21 00 20 */	addi r1, r1, 0x20
/* 801D7854 00000014  4E 80 00 20 */	blr 

...
/* 801C27C4  48 19 FA 0D */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 801C27C8  7C 7A 1B 79 */	or. r26, r3, r3                         
/* 801C27CC  7C 9B 23 78 */	mr r27, r4                              
/* 801C27D0  41 82 00 EC */	beq lbl_801C28BC                         /* constant-address: 801C28BC, symbol: lbl_801C28BC */
/* 801C27D4  3C 60 80 3C */	lis r3, __vt__16dMenuMapCommon_c@ha     
/* 801C27D8  38 03 D0 2C */	addi r0, r3, __vt__16dMenuMapCommon_c@l  /* constant-address: 803BD02C, symbol: __vt__16dMenuMapCommon_c */
...
/* 801C27F8  41 82 00 20 */	beq lbl_801C2818                         /* constant-address: 801C2818, symbol: lbl_801C2818 */
/* 801C27FC  41 82 00 18 */	beq lbl_801C2814                         /* constant-address: 801C2814, symbol: lbl_801C2814 */
...
/* 801C2824  41 80 FF C8 */	blt lbl_801C27EC                         /* constant-address: 801C27EC, symbol: lbl_801C27EC */
/* 801C2828  80 7A 00 60 */	lwz r3, 0x60(r26)                       
/* 801C282C  28 03 00 00 */	cmplwi r3, 0                            
/* 801C2830  41 82 00 24 */	beq lbl_801C2854                         /* constant-address: 801C2854, symbol: lbl_801C2854 */
/* 801C2834  41 82 00 18 */	beq lbl_801C284C                         /* constant-address: 801C284C, symbol: lbl_801C284C */
...
/* 801C285C  41 82 00 24 */	beq lbl_801C2880                         /* constant-address: 801C2880, symbol: lbl_801C2880 */
/* 801C2860  41 82 00 18 */	beq lbl_801C2878                         /* constant-address: 801C2878, symbol: lbl_801C2878 */
...
/* 801C2888  41 82 00 24 */	beq lbl_801C28AC                         /* constant-address: 801C28AC, symbol: lbl_801C28AC */
/* 801C288C  41 82 00 18 */	beq lbl_801C28A4                         /* constant-address: 801C28A4, symbol: lbl_801C28A4 */
...
/* 801C28B0  40 81 00 0C */	ble lbl_801C28BC                         /* constant-address: 801C28BC, symbol: lbl_801C28BC */
/* 801C28B4  7F 43 D3 78 */	mr r3, r26                              
/* 801C28B8  48 10 C4 85 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_801C28BC:
/* 801C28BC  7F 43 D3 78 */	mr r3, r26                              
/* 801C28C0  39 61 00 20 */	addi r11, r1, 0x20                      
/* 801C28C4  48 19 F9 59 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

...
/* 801C4548  41 80 00 14 */	blt lbl_801C455C                         /* constant-address: 801C455C, symbol: lbl_801C455C */
...
/* 801C4564  40 80 00 10 */	bge lbl_801C4574                         /* constant-address: 801C4574, symbol: lbl_801C4574 */
/* 801C4568  C0 02 A6 DC */	lfs f0, lit_3882(r2)                     /* constant-address: 804540DC, symbol: lit_3882 */
/* 801C456C  D0 03 0C 78 */	stfs f0, 0xc78(r3)                      
/* 801C4570  48 00 00 88 */	b lbl_801C45F8                           /* constant-address: 801C45F8, symbol: lbl_801C45F8 */
lbl_801C4574:
/* 801C4574  C8 62 A6 F8 */	lfd f3, lit_4119(r2)                     /* constant-address: 804540F8, symbol: lit_4119 */
...
/* 801C45A8  C0 02 A6 E8 */	lfs f0, lit_4012(r2)                     /* constant-address: 804540E8, symbol: lit_4012 */
/* 801C45AC  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 801C45B0  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 801C45B4  4C 40 13 82 */	cror 2, 0, 2                            
/* 801C45B8  40 82 00 24 */	bne lbl_801C45DC                         /* constant-address: 801C45DC, symbol: lbl_801C45DC */
...
/* 801C45D8  48 00 00 20 */	b lbl_801C45F8                           /* constant-address: 801C45F8, symbol: lbl_801C45F8 */
lbl_801C45DC:

...
/* 801C460C  C0 02 A6 DC */	lfs f0, lit_3882(r2)                     /* constant-address: 804540DC, symbol: lit_3882 */
/* 801C4610  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801C4614  40 81 00 08 */	ble lbl_801C461C                         /* constant-address: 801C461C, symbol: lbl_801C461C */
/* 801C4618  38 C0 00 01 */	li r6, 1                                
lbl_801C461C:
/* 801C461C  3C 80 80 43 */	lis r4, g_fmapHIO@ha                    
/* 801C4620  38 A4 FC 60 */	addi r5, r4, g_fmapHIO@l                 /* constant-address: 8042FC60, symbol: g_fmapHIO */
/* 801C4624  A8 E5 04 84 */	lha r7, 0x484(r5)                        /* constant-address: 804300E4, symbol: None */
...
/* 801C4658  41 80 00 0C */	blt lbl_801C4664                         /* constant-address: 801C4664, symbol: lbl_801C4664 */
/* 801C465C  7C 07 00 50 */	subf r0, r7, r0                         
/* 801C4660  B0 03 0C 74 */	sth r0, 0xc74(r3)                       
lbl_801C4664:
/* 801C4664  A8 03 0C 74 */	lha r0, 0xc74(r3)                       
/* 801C4668  C8 62 A6 F8 */	lfd f3, lit_4119(r2)                     /* constant-address: 804540F8, symbol: lit_4119 */
...
/* 801C4698  C0 02 A6 E8 */	lfs f0, lit_4012(r2)                     /* constant-address: 804540E8, symbol: lit_4012 */
/* 801C469C  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 801C46A0  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 801C46A4  4C 40 13 82 */	cror 2, 0, 2                            
/* 801C46A8  40 82 00 20 */	bne lbl_801C46C8                         /* constant-address: 801C46C8, symbol: lbl_801C46C8 */
...
/* 801C46C4  48 00 00 1C */	b lbl_801C46E0                           /* constant-address: 801C46E0, symbol: lbl_801C46E0 */
lbl_801C46C8:
...
lbl_801C46E0:
/* 801C46E0  C8 22 A7 00 */	lfd f1, lit_4140(r2)                     /* constant-address: 80454100, symbol: lit_4140 */
...
/* 801C46FC  C8 22 A6 F8 */	lfd f1, lit_4119(r2)                     /* constant-address: 804540F8, symbol: lit_4119 */

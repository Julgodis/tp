...
/* 801D8970  40 82 00 20 */	bne lbl_801D8990                         /* constant-address: 801D8990, symbol: lbl_801D8990 */
/* 801D8974  3C 60 80 39 */	lis r3, d_menu_d_menu_insect__stringBase0@ha
/* 801D8978  38 63 68 C0 */	addi r3, r3, d_menu_d_menu_insect__stringBase0@l /* constant-address: 803968C0, symbol: d_menu_d_menu_insect__stringBase0 */
/* 801D897C  38 63 00 10 */	addi r3, r3, 0x10                        /* constant-address: 803968D0, symbol: None */
/* 801D8980  38 80 00 00 */	li r4, 0                                
/* 801D8984  38 A0 00 00 */	li r5, 0                                
/* 801D8988  4B E3 D4 8D */	bl create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap /* constant-address: 80015E14, symbol: create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap */
/* 801D898C  90 7F 00 14 */	stw r3, 0x14(r31)                       
lbl_801D8990:
/* 801D8990  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 801D8994  28 03 00 00 */	cmplwi r3, 0                            
/* 801D8998  40 82 00 60 */	bne lbl_801D89F8                         /* constant-address: 801D89F8, symbol: lbl_801D89F8 */
/* 801D899C  80 9F 00 14 */	lwz r4, 0x14(r31)                       
/* 801D89A0  88 04 00 0C */	lbz r0, 0xc(r4)                         
/* 801D89A4  2C 00 00 00 */	cmpwi r0, 0                             
/* 801D89A8  41 82 00 48 */	beq lbl_801D89F0                         /* constant-address: 801D89F0, symbol: lbl_801D89F0 */
/* 801D89AC  28 03 00 00 */	cmplwi r3, 0                            
/* 801D89B0  40 82 00 48 */	bne lbl_801D89F8                         /* constant-address: 801D89F8, symbol: lbl_801D89F8 */
...
/* 801D89C4  41 82 00 18 */	beq lbl_801D89DC                         /* constant-address: 801D89DC, symbol: lbl_801D89DC */
...
/* 801D89E8  4B FF FC 71 */	bl _create__14dMenu_Insect_cFv           /* constant-address: 801D8658, symbol: _create__14dMenu_Insect_cFv */
/* 801D89EC  48 00 00 0C */	b lbl_801D89F8                           /* constant-address: 801D89F8, symbol: lbl_801D89F8 */
lbl_801D89F0:
/* 801D89F0  38 60 00 00 */	li r3, 0                                
/* 801D89F4  48 00 01 1C */	b lbl_801D8B10                           /* constant-address: 801D8B10, symbol: lbl_801D8B10 */
lbl_801D89F8:
/* 801D89F8  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801D89FC  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801D8A00  A8 83 0A 14 */	lha r4, 0xa14(r3)                        /* constant-address: 8042F5DC, symbol: None */
/* 801D8A04  A8 63 0A 16 */	lha r3, 0xa16(r3)                        /* constant-address: 8042F5DE, symbol: None */
/* 801D8A08  B0 9F 00 F0 */	sth r4, 0xf0(r31)                       
/* 801D8A0C  A8 1F 00 F0 */	lha r0, 0xf0(r31)                       
/* 801D8A10  7C 00 20 00 */	cmpw r0, r4                             
/* 801D8A14  41 80 00 78 */	blt lbl_801D8A8C                         /* constant-address: 801D8A8C, symbol: lbl_801D8A8C */
...
/* 801D8A2C  C0 02 A8 38 */	lfs f0, lit_3834(r2)                     /* constant-address: 80454238, symbol: lit_3834 */
...
/* 801D8A4C  C0 22 A8 38 */	lfs f1, lit_3834(r2)                     /* constant-address: 80454238, symbol: lit_3834 */
/* 801D8A50  48 07 CD 81 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801D8A54  7F E3 FB 78 */	mr r3, r31                              
/* 801D8A58  48 00 17 95 */	bl setCursorPos__14dMenu_Insect_cFv      /* constant-address: 801DA1EC, symbol: setCursorPos__14dMenu_Insect_cFv */
/* 801D8A5C  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801D8A60  C0 22 A8 38 */	lfs f1, lit_3834(r2)                     /* constant-address: 80454238, symbol: lit_3834 */
/* 801D8A64  4B FB C8 3D */	bl setAlphaRate__16dSelect_cursor_cFf    /* constant-address: 801952A0, symbol: setAlphaRate__16dSelect_cursor_cFf */
/* 801D8A68  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801D8A6C  C0 22 A8 38 */	lfs f1, lit_3834(r2)                     /* constant-address: 80454238, symbol: lit_3834 */
/* 801D8A70  4B FB C7 59 */	bl setScale__16dSelect_cursor_cFf        /* constant-address: 801951C8, symbol: setScale__16dSelect_cursor_cFf */
...
/* 801D8A88  48 00 00 88 */	b lbl_801D8B10                           /* constant-address: 801D8B10, symbol: lbl_801D8B10 */
lbl_801D8A8C:
/* 801D8A8C  C8 42 A8 60 */	lfd f2, lit_4020(r2)                     /* constant-address: 80454260, symbol: lit_4020 */
...
/* 801D8AE8  48 07 CC E9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801D8AEC  7F E3 FB 78 */	mr r3, r31                              
/* 801D8AF0  48 00 16 FD */	bl setCursorPos__14dMenu_Insect_cFv      /* constant-address: 801DA1EC, symbol: setCursorPos__14dMenu_Insect_cFv */
/* 801D8AF4  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801D8AF8  FC 20 F8 90 */	fmr f1, f31                             
/* 801D8AFC  4B FB C7 A5 */	bl setAlphaRate__16dSelect_cursor_cFf    /* constant-address: 801952A0, symbol: setAlphaRate__16dSelect_cursor_cFf */
/* 801D8B00  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801D8B04  FC 20 F8 90 */	fmr f1, f31                             
/* 801D8B08  4B FB C6 C1 */	bl setScale__16dSelect_cursor_cFf        /* constant-address: 801951C8, symbol: setScale__16dSelect_cursor_cFf */

...
/* 801D95D8  48 07 C2 A1 */	bl alphaAnime__13CPaneMgrAlphaFsUcUcUc   /* constant-address: 80255878, symbol: alphaAnime__13CPaneMgrAlphaFsUcUcUc */
/* 801D95DC  7C 7F 1B 78 */	mr r31, r3                              
/* 801D95E0  88 1E 00 F6 */	lbz r0, 0xf6(r30)                       
/* 801D95E4  28 00 00 01 */	cmplwi r0, 1                            
/* 801D95E8  40 82 00 28 */	bne lbl_801D9610                         /* constant-address: 801D9610, symbol: lbl_801D9610 */
/* 801D95EC  7F C3 F3 78 */	mr r3, r30                              
/* 801D95F0  88 9E 00 F4 */	lbz r4, 0xf4(r30)                       
/* 801D95F4  88 BE 00 F5 */	lbz r5, 0xf5(r30)                       
/* 801D95F8  48 00 08 29 */	bl isGiveInsect__14dMenu_Insect_cFii     /* constant-address: 801D9E20, symbol: isGiveInsect__14dMenu_Insect_cFii */
/* 801D95FC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801D9600  40 82 00 10 */	bne lbl_801D9610                         /* constant-address: 801D9610, symbol: lbl_801D9610 */
/* 801D9604  80 7E 00 1C */	lwz r3, 0x1c(r30)                       
/* 801D9608  48 06 10 79 */	bl selAnimeEnd__17dMsgScrn3Select_cFv    /* constant-address: 8023A680, symbol: selAnimeEnd__17dMsgScrn3Select_cFv */
/* 801D960C  48 00 00 08 */	b lbl_801D9614                           /* constant-address: 801D9614, symbol: lbl_801D9614 */
lbl_801D9610:
/* 801D9610  38 60 00 01 */	li r3, 1                                
lbl_801D9614:
/* 801D9614  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 801D9618  41 82 00 14 */	beq lbl_801D962C                         /* constant-address: 801D962C, symbol: lbl_801D962C */
/* 801D961C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801D9620  41 82 00 0C */	beq lbl_801D962C                         /* constant-address: 801D962C, symbol: lbl_801D962C */

...
/* 801AEDD0  38 04 C3 1C */	addi r0, r4, map_move_process@l          /* constant-address: 803BC31C, symbol: map_move_process */
/* 801AEDD4  7D 80 2A 14 */	add r12, r0, r5                         
/* 801AEDD8  48 1B 32 AD */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801AEDDC  60 00 00 00 */	nop                                     
/* 801AEDE0  88 1E 01 00 */	lbz r0, 0x100(r30)                      
/* 801AEDE4  7C 1F 00 40 */	cmplw r31, r0                           
/* 801AEDE8  41 82 00 20 */	beq lbl_801AEE08                         /* constant-address: 801AEE08, symbol: lbl_801AEE08 */
/* 801AEDEC  7F C3 F3 78 */	mr r3, r30                              
/* 801AEDF0  1C A0 00 0C */	mulli r5, r0, 0xc                       
/* 801AEDF4  3C 80 80 3C */	lis r4, map_init_process@ha             
/* 801AEDF8  38 04 C2 8C */	addi r0, r4, map_init_process@l          /* constant-address: 803BC28C, symbol: map_init_process */
/* 801AEDFC  7D 80 2A 14 */	add r12, r0, r5                         
/* 801AEE00  48 1B 32 85 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801AEE04  60 00 00 00 */	nop                                     
lbl_801AEE08:
/* 801AEE08  7F C3 F3 78 */	mr r3, r30                              
/* 801AEE0C  38 80 00 00 */	li r4, 0                                
/* 801AEE10  48 00 0B F1 */	bl setHIO__19dMenu_Calibration_cFb       /* constant-address: 801AFA00, symbol: setHIO__19dMenu_Calibration_cFb */

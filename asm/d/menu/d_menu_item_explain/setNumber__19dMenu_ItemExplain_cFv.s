...
/* 801DC80C  48 18 59 C5 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 801DC810  7C 7E 1B 78 */	mr r30, r3                              
/* 801DC814  88 C3 00 DF */	lbz r6, 0xdf(r3)                        
/* 801DC818  28 06 00 00 */	cmplwi r6, 0                            
/* 801DC81C  40 82 00 2C */	bne lbl_801DC848                         /* constant-address: 801DC848, symbol: lbl_801DC848 */
...
/* 801DC840  42 00 FF F0 */	bdnz lbl_801DC830                        /* constant-address: 801DC830, symbol: lbl_801DC830 */
/* 801DC844  48 00 02 F8 */	b lbl_801DCB3C                           /* constant-address: 801DCB3C, symbol: lbl_801DCB3C */
lbl_801DC848:
...
/* 801DC86C  42 00 FF F0 */	bdnz lbl_801DC85C                        /* constant-address: 801DC85C, symbol: lbl_801DC85C */
/* 801DC870  2C 1F 00 64 */	cmpwi r31, 0x64                         
/* 801DC874  40 81 00 08 */	ble lbl_801DC87C                         /* constant-address: 801DC87C, symbol: lbl_801DC87C */
...
/* 801DC88C  40 82 00 3C */	bne lbl_801DC8C8                         /* constant-address: 801DC8C8, symbol: lbl_801DC8C8 */
...
/* 801DC8C4  48 00 00 68 */	b lbl_801DC92C                           /* constant-address: 801DC92C, symbol: lbl_801DC92C */
lbl_801DC8C8:
/* 801DC8C8  2C 1F 00 00 */	cmpwi r31, 0                            
/* 801DC8CC  40 82 00 38 */	bne lbl_801DC904                         /* constant-address: 801DC904, symbol: lbl_801DC904 */
...
/* 801DC900  48 00 00 2C */	b lbl_801DC92C                           /* constant-address: 801DC92C, symbol: lbl_801DC92C */
lbl_801DC904:
...
/* 801DC970  41 80 FF CC */	blt lbl_801DC93C                         /* constant-address: 801DC93C, symbol: lbl_801DC93C */
/* 801DC974  2C 1F 00 64 */	cmpwi r31, 0x64                         
/* 801DC978  40 80 00 BC */	bge lbl_801DCA34                         /* constant-address: 801DCA34, symbol: lbl_801DCA34 */
/* 801DC97C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801DC980  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801DC984  83 7C 5D 30 */	lwz r27, 0x5d30(r28)                     /* constant-address: 8040BEF0, symbol: None */
/* 801DC988  38 00 00 0A */	li r0, 0xa                              
/* 801DC98C  7C 7F 03 D6 */	divw r3, r31, r0                        
/* 801DC990  48 04 19 39 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 801DC994  7C 65 1B 78 */	mr r5, r3                               
/* 801DC998  7F 63 DB 78 */	mr r3, r27                              
/* 801DC99C  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 801DC9A0  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 801DC9D0  83 7C 5D 30 */	lwz r27, 0x5d30(r28)                     /* constant-address: 8040BEF0, symbol: None */
...
/* 801DC9E4  48 04 18 E5 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 801DC9E8  7C 65 1B 78 */	mr r5, r3                               
/* 801DC9EC  7F 63 DB 78 */	mr r3, r27                              
/* 801DC9F0  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 801DC9F4  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 801DCA30  48 00 01 0C */	b lbl_801DCB3C                           /* constant-address: 801DCB3C, symbol: lbl_801DCB3C */
lbl_801DCA34:
/* 801DCA34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801DCA38  3B 83 61 C0 */	addi r28, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801DCA3C  83 7C 5D 30 */	lwz r27, 0x5d30(r28)                     /* constant-address: 8040BEF0, symbol: None */
/* 801DCA40  38 00 00 64 */	li r0, 0x64                             
/* 801DCA44  7C 7F 03 D6 */	divw r3, r31, r0                        
/* 801DCA48  48 04 18 81 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 801DCA4C  7C 65 1B 78 */	mr r5, r3                               
/* 801DCA50  7F 63 DB 78 */	mr r3, r27                              
/* 801DCA54  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 801DCA58  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 801DCA9C  83 7C 5D 30 */	lwz r27, 0x5d30(r28)                     /* constant-address: 8040BEF0, symbol: None */
/* 801DCAA0  38 00 00 0A */	li r0, 0xa                              
/* 801DCAA4  7C 7D 03 D6 */	divw r3, r29, r0                        
/* 801DCAA8  48 04 18 21 */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 801DCAAC  7C 65 1B 78 */	mr r5, r3                               
/* 801DCAB0  7F 63 DB 78 */	mr r3, r27                              
/* 801DCAB4  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 801DCAB8  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 801DCAE8  83 7C 5D 30 */	lwz r27, 0x5d30(r28)                     /* constant-address: 8040BEF0, symbol: None */
...
/* 801DCAFC  48 04 17 CD */	bl dMeter2Info_getNumberTextureName__Fi  /* constant-address: 8021E2C8, symbol: dMeter2Info_getNumberTextureName__Fi */
/* 801DCB00  7C 65 1B 78 */	mr r5, r3                               
/* 801DCB04  7F 63 DB 78 */	mr r3, r27                              
/* 801DCB08  3C 80 54 49 */	lis r4, 0x5449 /* 0x54494D47@ha */      
/* 801DCB0C  38 84 4D 47 */	addi r4, r4, 0x4D47 /* 0x54494D47@l */   /* constant-address: 54494D47 */
...
/* 801DCB40  48 18 56 DD */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

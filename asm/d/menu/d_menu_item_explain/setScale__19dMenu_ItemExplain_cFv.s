...
/* 801DCBD0  41 82 00 AC */	beq lbl_801DCC7C                         /* constant-address: 801DCC7C, symbol: lbl_801DCC7C */
/* 801DCBD4  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801DCBD8  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DCBDC  88 04 05 68 */	lbz r0, 0x568(r4)                        /* constant-address: 8042F130, symbol: None */
/* 801DCBE0  28 00 00 01 */	cmplwi r0, 1                            
/* 801DCBE4  40 82 00 2C */	bne lbl_801DCC10                         /* constant-address: 801DCC10, symbol: lbl_801DCC10 */
/* 801DCBE8  88 04 05 69 */	lbz r0, 0x569(r4)                        /* constant-address: 8042F131, symbol: None */
/* 801DCBEC  C8 22 A8 D8 */	lfd f1, lit_4950(r2)                     /* constant-address: 804542D8, symbol: lit_4950 */
...
/* 801DCC04  C0 02 A8 D4 */	lfs f0, lit_4948(r2)                     /* constant-address: 804542D4, symbol: lit_4948 */
/* 801DCC08  EC 61 00 24 */	fdivs f3, f1, f0                        
/* 801DCC0C  48 00 00 08 */	b lbl_801DCC14                           /* constant-address: 801DCC14, symbol: lbl_801DCC14 */
lbl_801DCC10:
/* 801DCC10  C0 62 A8 C4 */	lfs f3, lit_4348(r2)                     /* constant-address: 804542C4, symbol: lit_4348 */
lbl_801DCC14:
/* 801DCC14  80 A3 00 88 */	lwz r5, 0x88(r3)                        
/* 801DCC18  A0 05 00 04 */	lhz r0, 4(r5)                           
/* 801DCC1C  C8 42 A8 D8 */	lfd f2, lit_4950(r2)                     /* constant-address: 804542D8, symbol: lit_4950 */
...
/* 801DCC34  C0 22 A8 BC */	lfs f1, lit_4346(r2)                     /* constant-address: 804542BC, symbol: lit_4346 */

...
/* 801DB830  48 18 69 A9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 801DB854  41 82 01 9C */	beq lbl_801DB9F0                         /* constant-address: 801DB9F0, symbol: lbl_801DB9F0 */
/* 801DB858  7C 1D 03 78 */	mr r29, r0                              
/* 801DB85C  3B 80 FF FF */	li r28, -1                              
/* 801DB860  28 00 00 26 */	cmplwi r0, 0x26                         
/* 801DB864  40 82 00 B4 */	bne lbl_801DB918                         /* constant-address: 801DB918, symbol: lbl_801DB918 */
/* 801DB868  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801DB86C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801DB870  3B C3 4E 20 */	addi r30, r3, 0x4e20                     /* constant-address: 8040AFE0, symbol: None */
/* 801DB874  7F C3 F3 78 */	mr r3, r30                              
/* 801DB878  81 9E 00 00 */	lwz r12, 0(r30)                          /* constant-address: 8040AFE0, symbol: None */
/* 801DB87C  81 8C 00 BC */	lwz r12, 0xbc(r12)                      
/* 801DB880  7D 89 03 A6 */	mtctr r12                               
/* 801DB884  4E 80 04 21 */	bctrl                                   
/* 801DB888  88 03 00 09 */	lbz r0, 9(r3)                            /* constant-address: 8040AFE9, symbol: None */
/* 801DB88C  54 00 FE FE */	rlwinm r0, r0, 0x1f, 0x1b, 0x1f         
/* 801DB890  2C 00 00 11 */	cmpwi r0, 0x11                          
/* 801DB894  40 82 00 5C */	bne lbl_801DB8F0                         /* constant-address: 801DB8F0, symbol: lbl_801DB8F0 */
...
/* 801DB8AC  4B EB C6 35 */	bl checkItemGet__FUci                    /* constant-address: 80097EE0, symbol: checkItemGet__FUci */
/* 801DB8B0  2C 03 00 00 */	cmpwi r3, 0                             
/* 801DB8B4  41 82 00 08 */	beq lbl_801DB8BC                         /* constant-address: 801DB8BC, symbol: lbl_801DB8BC */
/* 801DB8B8  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
lbl_801DB8BC:
/* 801DB8BC  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
/* 801DB8C0  2C 1E 00 03 */	cmpwi r30, 3                            
/* 801DB8C4  41 80 FF DC */	blt lbl_801DB8A0                         /* constant-address: 801DB8A0, symbol: lbl_801DB8A0 */
/* 801DB8C8  2C 1D 00 01 */	cmpwi r29, 1                            
/* 801DB8CC  40 82 00 08 */	bne lbl_801DB8D4                         /* constant-address: 801DB8D4, symbol: lbl_801DB8D4 */
/* 801DB8D0  3B 80 00 43 */	li r28, 0x43                            
lbl_801DB8D4:
/* 801DB8D4  2C 1D 00 02 */	cmpwi r29, 2                            
/* 801DB8D8  40 82 00 10 */	bne lbl_801DB8E8                         /* constant-address: 801DB8E8, symbol: lbl_801DB8E8 */
/* 801DB8DC  3B A0 00 FA */	li r29, 0xfa                            
/* 801DB8E0  3B 80 00 44 */	li r28, 0x44                            
/* 801DB8E4  48 00 00 34 */	b lbl_801DB918                           /* constant-address: 801DB918, symbol: lbl_801DB918 */
lbl_801DB8E8:
/* 801DB8E8  3B A0 00 FD */	li r29, 0xfd                            
/* 801DB8EC  48 00 00 2C */	b lbl_801DB918                           /* constant-address: 801DB918, symbol: lbl_801DB918 */
lbl_801DB8F0:
/* 801DB8F0  7F C3 F3 78 */	mr r3, r30                              
/* 801DB8F4  81 9E 00 00 */	lwz r12, 0(r30)                          /* constant-address: 8040AFE0, symbol: None */
/* 801DB8F8  81 8C 00 BC */	lwz r12, 0xbc(r12)                      
/* 801DB8FC  7D 89 03 A6 */	mtctr r12                               
/* 801DB900  4E 80 04 21 */	bctrl                                   
/* 801DB904  88 03 00 09 */	lbz r0, 9(r3)                            /* constant-address: 8040AFE9, symbol: None */
/* 801DB908  54 00 FE FE */	rlwinm r0, r0, 0x1f, 0x1b, 0x1f         
/* 801DB90C  2C 00 00 14 */	cmpwi r0, 0x14                          
/* 801DB910  40 82 00 08 */	bne lbl_801DB918                         /* constant-address: 801DB918, symbol: lbl_801DB918 */
...
/* 801DB93C  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
...
/* 801DB954  48 04 15 B5 */	bl readItemTexture__13dMeter2Info_cFUcPvP10J2DPicturePvP10J2DPicturePvP10J2DPicturePvP10J2DPicturei /* constant-address: 8021CF08, symbol: readItemTexture__13dMeter2Info_cFUcPvP10J2DPicturePvP10J2DPicturePvP10J2DPicturePvP10J2DPicturei */
/* 801DB958  7C 7E 1B 78 */	mr r30, r3                              
/* 801DB95C  80 7F 00 38 */	lwz r3, 0x38(r31)                       
/* 801DB960  48 07 9C 69 */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
/* 801DB964  39 00 00 00 */	li r8, 0                                
/* 801DB968  38 60 00 00 */	li r3, 0                                
/* 801DB96C  38 FE FF FF */	addi r7, r30, -1                         /* constant-address: 80430187 */
...
/* 801DB984  40 80 00 14 */	bge lbl_801DB998                         /* constant-address: 801DB998, symbol: lbl_801DB998 */
/* 801DB988  38 03 00 7C */	addi r0, r3, 0x7c                       
/* 801DB98C  7C 9F 00 2E */	lwzx r4, r31, r0                        
/* 801DB990  98 C4 00 B0 */	stb r6, 0xb0(r4)                        
/* 801DB994  48 00 00 10 */	b lbl_801DB9A4                           /* constant-address: 801DB9A4, symbol: lbl_801DB9A4 */
lbl_801DB998:
/* 801DB998  38 03 00 7C */	addi r0, r3, 0x7c                        /* constant-address: 0000007C */
...
/* 801DB9AC  42 00 FF D4 */	bdnz lbl_801DB980                        /* constant-address: 801DB980, symbol: lbl_801DB980 */
/* 801DB9B0  7F E3 FB 78 */	mr r3, r31                              
/* 801DB9B4  48 00 0E 49 */	bl setNumber__19dMenu_ItemExplain_cFv    /* constant-address: 801DC7FC, symbol: setNumber__19dMenu_ItemExplain_cFv */
/* 801DB9B8  80 7F 00 70 */	lwz r3, 0x70(r31)                       
/* 801DB9BC  3C 80 62 61 */	lis r4, 0x6261 /* 0x6261636B@ha */      
/* 801DB9C0  38 C4 63 6B */	addi r6, r4, 0x636B /* 0x6261636B@l */   /* constant-address: 6261636B */
/* 801DB9C4  3C 80 69 5F */	lis r4, 0x695F /* 0x695F695F@ha */      
/* 801DB9C8  38 A4 69 5F */	addi r5, r4, 0x695F /* 0x695F695F@l */   /* constant-address: 695F695F */
...
/* 801DB9EC  48 00 00 6C */	b lbl_801DBA58                           /* constant-address: 801DBA58, symbol: lbl_801DBA58 */
lbl_801DB9F0:
/* 801DB9F0  80 7F 00 38 */	lwz r3, 0x38(r31)                       
/* 801DB9F4  48 07 9C 15 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
...
/* 801DBA18  42 00 FF F0 */	bdnz lbl_801DBA08                        /* constant-address: 801DBA08, symbol: lbl_801DBA08 */
/* 801DBA1C  7F E3 FB 78 */	mr r3, r31                              
/* 801DBA20  48 00 0D DD */	bl setNumber__19dMenu_ItemExplain_cFv    /* constant-address: 801DC7FC, symbol: setNumber__19dMenu_ItemExplain_cFv */
/* 801DBA24  80 7F 00 70 */	lwz r3, 0x70(r31)                       
/* 801DBA28  3C 80 62 61 */	lis r4, 0x6261 /* 0x6261636B@ha */      
/* 801DBA2C  38 C4 63 6B */	addi r6, r4, 0x636B /* 0x6261636B@l */   /* constant-address: 6261636B */
/* 801DBA30  3C 80 69 5F */	lis r4, 0x695F /* 0x695F695F@ha */      
/* 801DBA34  38 A4 69 5F */	addi r5, r4, 0x695F /* 0x695F695F@l */   /* constant-address: 695F695F */
...
/* 801DBA60  41 82 00 08 */	beq lbl_801DBA68                         /* constant-address: 801DBA68, symbol: lbl_801DBA68 */
/* 801DBA64  48 06 03 D1 */	bl arwAnimeInit__15dMsgScrnArrow_cFv     /* constant-address: 8023BE34, symbol: arwAnimeInit__15dMsgScrnArrow_cFv */
lbl_801DBA68:
/* 801DBA68  38 00 00 51 */	li r0, 0x51                             
/* 801DBA6C  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 801DBA70  80 6D 8D E8 */	lwz r3, mAudioMgrPtr__10Z2AudioMgr(r13)  /* constant-address: 80451368, symbol: mAudioMgrPtr__10Z2AudioMgr */
/* 801DBA74  38 81 00 18 */	addi r4, r1, 0x18                       
/* 801DBA78  38 A0 00 00 */	li r5, 0                                
/* 801DBA7C  38 C0 00 00 */	li r6, 0                                
/* 801DBA80  38 E0 00 00 */	li r7, 0                                
/* 801DBA84  C0 22 A8 C4 */	lfs f1, lit_4348(r2)                     /* constant-address: 804542C4, symbol: lit_4348 */
/* 801DBA88  FC 40 08 90 */	fmr f2, f1                              
/* 801DBA8C  C0 62 A8 B0 */	lfs f3, lit_4304(r2)                     /* constant-address: 804542B0, symbol: lit_4304 */
/* 801DBA90  FC 80 18 90 */	fmr f4, f3                              
/* 801DBA94  39 00 00 00 */	li r8, 0                                
/* 801DBA98  48 0C FE ED */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc /* constant-address: 802AB984, symbol: seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc */
/* 801DBA9C  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801DBAA0  48 18 67 85 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

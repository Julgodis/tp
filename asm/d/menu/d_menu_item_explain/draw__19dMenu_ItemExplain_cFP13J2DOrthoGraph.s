...
/* 801DB524  48 18 6C AD */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 801DB538  41 82 01 F4 */	beq lbl_801DB72C                         /* constant-address: 801DB72C, symbol: lbl_801DB72C */
/* 801DB53C  3B 40 00 00 */	li r26, 0                               
/* 801DB540  3B A0 00 00 */	li r29, 0                               
/* 801DB544  3C 60 80 43 */	lis r3, g_ringHIO@ha                    
/* 801DB548  3B 83 FA FC */	addi r28, r3, g_ringHIO@l                /* constant-address: 8042FAFC, symbol: g_ringHIO */
lbl_801DB54C:
/* 801DB54C  3B 7D 00 3C */	addi r27, r29, 0x3c                     
/* 801DB550  7C 7E D8 2E */	lwzx r3, r30, r27                       
/* 801DB554  28 03 00 00 */	cmplwi r3, 0                            
/* 801DB558  41 82 00 44 */	beq lbl_801DB59C                         /* constant-address: 801DB59C, symbol: lbl_801DB59C */
/* 801DB55C  C0 1C 00 FC */	lfs f0, 0xfc(r28)                        /* constant-address: 8042FBF8, symbol: None */
...
/* 801DB584  C0 1C 00 F4 */	lfs f0, 0xf4(r28)                        /* constant-address: 8042FBF0, symbol: None */
/* 801DB588  EC 21 00 2A */	fadds f1, f1, f0                        
/* 801DB58C  C0 5E 00 D8 */	lfs f2, 0xd8(r30)                       
/* 801DB590  C0 1C 00 F8 */	lfs f0, 0xf8(r28)                        /* constant-address: 8042FBF4, symbol: None */
/* 801DB594  EC 42 00 2A */	fadds f2, f2, f0                        
/* 801DB598  48 07 90 19 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
lbl_801DB59C:
/* 801DB59C  3B 5A 00 01 */	addi r26, r26, 1                        
/* 801DB5A0  2C 1A 00 02 */	cmpwi r26, 2                            
/* 801DB5A4  3B BD 00 04 */	addi r29, r29, 4                        
/* 801DB5A8  41 80 FF A4 */	blt lbl_801DB54C                         /* constant-address: 801DB54C, symbol: lbl_801DB54C */
/* 801DB5AC  3C 60 80 43 */	lis r3, g_ringHIO@ha                    
/* 801DB5B0  38 63 FA FC */	addi r3, r3, g_ringHIO@l                 /* constant-address: 8042FAFC, symbol: g_ringHIO */
/* 801DB5B4  C0 03 01 0C */	lfs f0, 0x10c(r3)                        /* constant-address: 8042FC08, symbol: None */
...
/* 801DB5E0  38 84 FA FC */	addi r4, r4, g_ringHIO@l                 /* constant-address: 8042FAFC, symbol: g_ringHIO */
/* 801DB5E4  C0 24 01 04 */	lfs f1, 0x104(r4)                        /* constant-address: 8042FC00, symbol: None */
/* 801DB5E8  C0 44 01 08 */	lfs f2, 0x108(r4)                        /* constant-address: 8042FC04, symbol: None */
/* 801DB5EC  48 07 8F C5 */	bl paneTrans__8CPaneMgrFff               /* constant-address: 802545B0, symbol: paneTrans__8CPaneMgrFff */
/* 801DB5F0  80 7E 00 B4 */	lwz r3, 0xb4(r30)                       
/* 801DB5F4  28 03 00 00 */	cmplwi r3, 0                            
/* 801DB5F8  41 82 00 30 */	beq lbl_801DB628                         /* constant-address: 801DB628, symbol: lbl_801DB628 */
/* 801DB5FC  C0 22 A8 88 */	lfs f1, lit_4062(r2)                     /* constant-address: 80454288, symbol: lit_4062 */
/* 801DB600  FC 40 08 90 */	fmr f2, f1                              
/* 801DB604  C0 62 A8 A8 */	lfs f3, lit_4302(r2)                     /* constant-address: 804542A8, symbol: lit_4302 */
/* 801DB608  C0 82 A8 AC */	lfs f4, lit_4303(r2)                     /* constant-address: 804542AC, symbol: lit_4303 */
...
/* 801DB634  41 82 00 84 */	beq lbl_801DB6B8                         /* constant-address: 801DB6B8, symbol: lbl_801DB6B8 */
...
/* 801DB684  41 80 FF C0 */	blt lbl_801DB644                         /* constant-address: 801DB644, symbol: lbl_801DB644 */
...
/* 801DB6BC  C0 22 A8 88 */	lfs f1, lit_4062(r2)                     /* constant-address: 80454288, symbol: lit_4062 */
/* 801DB6C0  FC 40 08 90 */	fmr f2, f1                              
/* 801DB6C4  7F E4 FB 78 */	mr r4, r31                              
/* 801DB6C8  48 11 D8 0D */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
/* 801DB6CC  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 801DB6D0  80 83 00 04 */	lwz r4, 4(r3)                           
/* 801DB6D4  80 7E 00 0C */	lwz r3, 0xc(r30)                        
/* 801DB6D8  C0 22 A8 B0 */	lfs f1, lit_4304(r2)                     /* constant-address: 804542B0, symbol: lit_4304 */
...
/* 801DB6F0  48 00 00 55 */	bl drawKantera__19dMenu_ItemExplain_cFv  /* constant-address: 801DB744, symbol: drawKantera__19dMenu_ItemExplain_cFv */
/* 801DB6F4  80 7E 00 9C */	lwz r3, 0x9c(r30)                       
/* 801DB6F8  28 03 00 00 */	cmplwi r3, 0                            
/* 801DB6FC  41 82 00 20 */	beq lbl_801DB71C                         /* constant-address: 801DB71C, symbol: lbl_801DB71C */
/* 801DB700  C0 22 A8 B4 */	lfs f1, lit_4305(r2)                     /* constant-address: 804542B4, symbol: lit_4305 */
/* 801DB704  C0 42 A8 B8 */	lfs f2, lit_4306(r2)                     /* constant-address: 804542B8, symbol: lit_4306 */
/* 801DB708  48 05 E6 91 */	bl translate__17dMsgScrn3Select_cFff     /* constant-address: 80239D98, symbol: translate__17dMsgScrn3Select_cFff */
/* 801DB70C  80 7E 00 9C */	lwz r3, 0x9c(r30)                       
/* 801DB710  C0 22 A8 88 */	lfs f1, lit_4062(r2)                     /* constant-address: 80454288, symbol: lit_4062 */
/* 801DB714  FC 40 08 90 */	fmr f2, f1                              
/* 801DB718  48 05 E6 BD */	bl draw__17dMsgScrn3Select_cFff          /* constant-address: 80239DD4, symbol: draw__17dMsgScrn3Select_cFff */
lbl_801DB71C:
/* 801DB71C  80 7E 00 98 */	lwz r3, 0x98(r30)                       
/* 801DB720  28 03 00 00 */	cmplwi r3, 0                            
/* 801DB724  41 82 00 08 */	beq lbl_801DB72C                         /* constant-address: 801DB72C, symbol: lbl_801DB72C */
/* 801DB728  48 06 06 99 */	bl draw__15dMsgScrnArrow_cFv             /* constant-address: 8023BDC0, symbol: draw__15dMsgScrnArrow_cFv */
lbl_801DB72C:
/* 801DB72C  39 61 00 20 */	addi r11, r1, 0x20                      
/* 801DB730  48 18 6A ED */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

...
/* 801EDA30  4B FE DA 41 */	bl move__19dMenu_ItemExplain_cFv         /* constant-address: 801DB470, symbol: move__19dMenu_ItemExplain_cFv */
/* 801EDA34  80 7E 03 70 */	lwz r3, 0x370(r30)                      
/* 801EDA38  88 03 00 E3 */	lbz r0, 0xe3(r3)                        
/* 801EDA3C  28 00 00 01 */	cmplwi r0, 1                            
/* 801EDA40  40 82 00 14 */	bne lbl_801EDA54                         /* constant-address: 801EDA54, symbol: lbl_801EDA54 */
/* 801EDA44  7F C3 F3 78 */	mr r3, r30                              
/* 801EDA48  88 9E 06 B3 */	lbz r4, 0x6b3(r30)                      
/* 801EDA4C  48 00 0B F9 */	bl setCombineBomb__12dMenu_Ring_cFi      /* constant-address: 801EE644, symbol: setCombineBomb__12dMenu_Ring_cFi */
/* 801EDA50  48 00 00 60 */	b lbl_801EDAB0                           /* constant-address: 801EDAB0, symbol: lbl_801EDAB0 */
lbl_801EDA54:
/* 801EDA54  28 00 00 02 */	cmplwi r0, 2                            
/* 801EDA58  40 82 00 58 */	bne lbl_801EDAB0                         /* constant-address: 801EDAB0, symbol: lbl_801EDAB0 */
...
/* 801EDA6C  48 00 06 F1 */	bl getItemMaxNum__12dMenu_Ring_cFUc      /* constant-address: 801EE15C, symbol: getItemMaxNum__12dMenu_Ring_cFUc */
...
/* 801EDA84  48 00 05 D5 */	bl getItemNum__12dMenu_Ring_cFUc         /* constant-address: 801EE058, symbol: getItemNum__12dMenu_Ring_cFUc */
...
/* 801EDAA4  4B FE E8 9D */	bl openExplain__19dMenu_ItemExplain_cFUcUcUcb /* constant-address: 801DC340, symbol: openExplain__19dMenu_ItemExplain_cFUcUcUcb */
/* 801EDAA8  38 00 00 00 */	li r0, 0                                
/* 801EDAAC  98 1E 06 B0 */	stb r0, 0x6b0(r30)                      
lbl_801EDAB0:
/* 801EDAB0  80 7E 03 70 */	lwz r3, 0x370(r30)                      
/* 801EDAB4  4B FE EC F9 */	bl getAlphaRatio__19dMenu_ItemExplain_cFv /* constant-address: 801DC7AC, symbol: getAlphaRatio__19dMenu_ItemExplain_cFv */
/* 801EDAB8  FF E0 08 90 */	fmr f31, f1                             
/* 801EDABC  80 7E 00 28 */	lwz r3, 0x28(r30)                       
/* 801EDAC0  48 06 7D 11 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801EDAC4  80 7E 01 B8 */	lwz r3, 0x1b8(r30)                      
/* 801EDAC8  C0 22 AA 10 */	lfs f1, lit_5683(r2)                     /* constant-address: 80454410, symbol: lit_5683 */
/* 801EDACC  C0 02 A9 9C */	lfs f0, lit_4305(r2)                     /* constant-address: 8045439C, symbol: lit_4305 */

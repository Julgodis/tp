...
/* 801EB65C  C0 02 A9 D0 */	lfs f0, lit_4739(r2)                     /* constant-address: 804543D0, symbol: lit_4739 */
/* 801EB660  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801EB664  4C 41 13 82 */	cror 2, 1, 2                            
/* 801EB668  40 82 02 18 */	bne lbl_801EB880                         /* constant-address: 801EB880, symbol: lbl_801EB880 */
...
/* 801EB6B0  41 82 00 0C */	beq lbl_801EB6BC                         /* constant-address: 801EB6BC, symbol: lbl_801EB6BC */
/* 801EB6B4  80 FF 06 34 */	lwz r7, 0x634(r31)                      
/* 801EB6B8  48 00 00 18 */	b lbl_801EB6D0                           /* constant-address: 801EB6D0, symbol: lbl_801EB6D0 */
lbl_801EB6BC:
...
/* 801EB6DC  40 81 00 30 */	ble lbl_801EB70C                         /* constant-address: 801EB70C, symbol: lbl_801EB70C */
lbl_801EB6E0:
/* 801EB6E0  7C 05 38 00 */	cmpw r5, r7                             
/* 801EB6E4  41 80 00 28 */	blt lbl_801EB70C                         /* constant-address: 801EB70C, symbol: lbl_801EB70C */
...
/* 801EB6FC  40 82 00 08 */	bne lbl_801EB704                         /* constant-address: 801EB704, symbol: lbl_801EB704 */
/* 801EB700  54 04 06 3E */	clrlwi r4, r0, 0x18                     
lbl_801EB704:
/* 801EB704  7C 89 23 78 */	mr r9, r4                               
/* 801EB708  42 00 FF D8 */	bdnz lbl_801EB6E0                        /* constant-address: 801EB6E0, symbol: lbl_801EB6E0 */
lbl_801EB70C:
/* 801EB70C  88 FF 06 A8 */	lbz r7, 0x6a8(r31)                      
/* 801EB710  55 25 06 3E */	clrlwi r5, r9, 0x18                     
/* 801EB714  7C 07 28 40 */	cmplw r7, r5                            
/* 801EB718  41 82 01 8C */	beq lbl_801EB8A4                         /* constant-address: 801EB8A4, symbol: lbl_801EB8A4 */
/* 801EB71C  3C 80 80 3E */	lis r4, m_cpadInfo__8mDoCPd_c@ha        
/* 801EB720  38 84 D2 E8 */	addi r4, r4, m_cpadInfo__8mDoCPd_c@l     /* constant-address: 803DD2E8, symbol: m_cpadInfo__8mDoCPd_c */
/* 801EB724  80 04 00 30 */	lwz r0, 0x30(r4)                         /* constant-address: 803DD318, symbol: None */
/* 801EB728  54 00 06 73 */	rlwinm. r0, r0, 0, 0x19, 0x19           
/* 801EB72C  41 82 00 38 */	beq lbl_801EB764                         /* constant-address: 801EB764, symbol: lbl_801EB764 */
...
/* 801EB760  48 00 00 D0 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB764:
/* 801EB764  7C 07 40 40 */	cmplw r7, r8                            
/* 801EB768  41 80 00 68 */	blt lbl_801EB7D0                         /* constant-address: 801EB7D0, symbol: lbl_801EB7D0 */
/* 801EB76C  7C 08 38 50 */	subf r0, r8, r7                         
/* 801EB770  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 801EB774  7C 05 00 40 */	cmplw r5, r0                            
/* 801EB778  41 80 00 2C */	blt lbl_801EB7A4                         /* constant-address: 801EB7A4, symbol: lbl_801EB7A4 */
/* 801EB77C  7C 05 38 40 */	cmplw r5, r7                            
/* 801EB780  40 80 00 24 */	bge lbl_801EB7A4                         /* constant-address: 801EB7A4, symbol: lbl_801EB7A4 */
/* 801EB784  28 07 00 00 */	cmplwi r7, 0                            
/* 801EB788  40 82 00 10 */	bne lbl_801EB798                         /* constant-address: 801EB798, symbol: lbl_801EB798 */
/* 801EB78C  38 06 FF FF */	addi r0, r6, -1                         
/* 801EB790  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB794  48 00 00 9C */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB798:
/* 801EB798  38 07 FF FF */	addi r0, r7, -1                         
/* 801EB79C  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB7A0  48 00 00 90 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB7A4:
/* 801EB7A4  38 06 FF FF */	addi r0, r6, -1                         
/* 801EB7A8  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 801EB7AC  7C 07 00 40 */	cmplw r7, r0                            
/* 801EB7B0  40 82 00 10 */	bne lbl_801EB7C0                         /* constant-address: 801EB7C0, symbol: lbl_801EB7C0 */
/* 801EB7B4  38 00 00 00 */	li r0, 0                                
/* 801EB7B8  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB7BC  48 00 00 74 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB7C0:
/* 801EB7C0  88 9F 06 A8 */	lbz r4, 0x6a8(r31)                      
/* 801EB7C4  38 04 00 01 */	addi r0, r4, 1                          
/* 801EB7C8  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB7CC  48 00 00 64 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB7D0:
/* 801EB7D0  7C 07 42 14 */	add r0, r7, r8                          
/* 801EB7D4  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 801EB7D8  7C 05 38 40 */	cmplw r5, r7                            
/* 801EB7DC  40 81 00 34 */	ble lbl_801EB810                         /* constant-address: 801EB810, symbol: lbl_801EB810 */
/* 801EB7E0  7C 05 00 40 */	cmplw r5, r0                            
/* 801EB7E4  41 81 00 2C */	bgt lbl_801EB810                         /* constant-address: 801EB810, symbol: lbl_801EB810 */
/* 801EB7E8  38 06 FF FF */	addi r0, r6, -1                         
/* 801EB7EC  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 801EB7F0  7C 07 00 40 */	cmplw r7, r0                            
/* 801EB7F4  40 82 00 10 */	bne lbl_801EB804                         /* constant-address: 801EB804, symbol: lbl_801EB804 */
/* 801EB7F8  38 00 00 00 */	li r0, 0                                
/* 801EB7FC  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB800  48 00 00 30 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB804:
/* 801EB804  38 07 00 01 */	addi r0, r7, 1                          
/* 801EB808  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB80C  48 00 00 24 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB810:
/* 801EB810  28 07 00 00 */	cmplwi r7, 0                            
/* 801EB814  40 82 00 10 */	bne lbl_801EB824                         /* constant-address: 801EB824, symbol: lbl_801EB824 */
/* 801EB818  38 06 FF FF */	addi r0, r6, -1                         
/* 801EB81C  98 1F 06 A8 */	stb r0, 0x6a8(r31)                      
/* 801EB820  48 00 00 10 */	b lbl_801EB830                           /* constant-address: 801EB830, symbol: lbl_801EB830 */
lbl_801EB824:
...
/* 801EB84C  40 82 00 2C */	bne lbl_801EB878                         /* constant-address: 801EB878, symbol: lbl_801EB878 */
/* 801EB850  7C 60 07 35 */	extsh. r0, r3                           
/* 801EB854  40 80 00 24 */	bge lbl_801EB878                         /* constant-address: 801EB878, symbol: lbl_801EB878 */
/* 801EB858  88 1F 06 A8 */	lbz r0, 0x6a8(r31)                      
/* 801EB85C  28 00 00 00 */	cmplwi r0, 0                            
/* 801EB860  40 82 00 10 */	bne lbl_801EB870                         /* constant-address: 801EB870, symbol: lbl_801EB870 */
/* 801EB864  38 00 00 00 */	li r0, 0                                
/* 801EB868  98 1F 06 D3 */	stb r0, 0x6d3(r31)                      
/* 801EB86C  48 00 00 0C */	b lbl_801EB878                           /* constant-address: 801EB878, symbol: lbl_801EB878 */
lbl_801EB870:
/* 801EB870  38 00 00 01 */	li r0, 1                                
/* 801EB874  98 1F 06 D3 */	stb r0, 0x6d3(r31)                      
lbl_801EB878:
/* 801EB878  38 60 00 01 */	li r3, 1                                
/* 801EB87C  48 00 00 2C */	b lbl_801EB8A8                           /* constant-address: 801EB8A8, symbol: lbl_801EB8A8 */
lbl_801EB880:
/* 801EB880  38 00 00 00 */	li r0, 0                                
/* 801EB884  B0 1F 06 80 */	sth r0, 0x680(r31)                      
/* 801EB888  7F E3 FB 78 */	mr r3, r31                              
/* 801EB88C  48 00 3B F9 */	bl dpdMove__12dMenu_Ring_cFv             /* constant-address: 801EF484, symbol: dpdMove__12dMenu_Ring_cFv */
/* 801EB890  88 1F 06 C2 */	lbz r0, 0x6c2(r31)                      
/* 801EB894  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801EB898  41 82 00 0C */	beq lbl_801EB8A4                         /* constant-address: 801EB8A4, symbol: lbl_801EB8A4 */
/* 801EB89C  38 60 00 00 */	li r3, 0                                
/* 801EB8A0  48 00 00 08 */	b lbl_801EB8A8                           /* constant-address: 801EB8A8, symbol: lbl_801EB8A8 */
lbl_801EB8A4:

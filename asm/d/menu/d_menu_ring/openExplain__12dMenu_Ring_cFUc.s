...
/* 801EF4AC  40 82 00 70 */	bne lbl_801EF51C                         /* constant-address: 801EF51C, symbol: lbl_801EF51C */
/* 801EF4B0  88 1E 06 D0 */	lbz r0, 0x6d0(r30)                      
/* 801EF4B4  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801EF4B8  40 82 00 64 */	bne lbl_801EF51C                         /* constant-address: 801EF51C, symbol: lbl_801EF51C */
/* 801EF4BC  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 801EF4C0  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801EF4C4  41 82 00 50 */	beq lbl_801EF514                         /* constant-address: 801EF514, symbol: lbl_801EF514 */
/* 801EF4C8  88 1E 06 A8 */	lbz r0, 0x6a8(r30)                      
/* 801EF4CC  7C 9E 02 14 */	add r4, r30, r0                         
/* 801EF4D0  88 84 06 90 */	lbz r4, 0x690(r4)                       
/* 801EF4D4  4B FF EC 89 */	bl getItemMaxNum__12dMenu_Ring_cFUc      /* constant-address: 801EE15C, symbol: getItemMaxNum__12dMenu_Ring_cFUc */
...
/* 801EF4EC  4B FF EB 6D */	bl getItemNum__12dMenu_Ring_cFUc         /* constant-address: 801EE058, symbol: getItemNum__12dMenu_Ring_cFUc */
...
/* 801EF50C  4B FE CE 35 */	bl openExplain__19dMenu_ItemExplain_cFUcUcUcb /* constant-address: 801DC340, symbol: openExplain__19dMenu_ItemExplain_cFUcUcUcb */
/* 801EF510  48 00 00 38 */	b lbl_801EF548                           /* constant-address: 801EF548, symbol: lbl_801EF548 */
lbl_801EF514:
/* 801EF514  38 60 00 00 */	li r3, 0                                
/* 801EF518  48 00 00 30 */	b lbl_801EF548                           /* constant-address: 801EF548, symbol: lbl_801EF548 */
lbl_801EF51C:
/* 801EF51C  88 1E 06 D0 */	lbz r0, 0x6d0(r30)                      
/* 801EF520  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801EF524  41 82 00 08 */	beq lbl_801EF52C                         /* constant-address: 801EF52C, symbol: lbl_801EF52C */
/* 801EF528  7C 05 03 78 */	mr r5, r0                               
lbl_801EF52C:
/* 801EF52C  54 A0 15 BA */	rlwinm r0, r5, 2, 0x16, 0x1d            
/* 801EF530  80 7E 03 70 */	lwz r3, 0x370(r30)                      
/* 801EF534  38 82 AA 24 */	la r4, data_80454424(r2) /* 80454424-_SDA2_BASE_ */ /* constant-address: 80454424, symbol: data_80454424 */
/* 801EF538  7C 84 00 2E */	lwzx r4, r4, r0                         
/* 801EF53C  38 A2 AA 2C */	la r5, data_8045442C(r2) /* 8045442C-_SDA2_BASE_ */ /* constant-address: 8045442C, symbol: data_8045442C */
/* 801EF540  7C A5 00 2E */	lwzx r5, r5, r0                         
/* 801EF544  4B FE D1 F5 */	bl openExplainTx__19dMenu_ItemExplain_cFUlUl /* constant-address: 801DC738, symbol: openExplainTx__19dMenu_ItemExplain_cFUlUl */
lbl_801EF548:

...
/* 801B3D04  48 1A E4 D1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801B3D08  7C 7D 1B 78 */	mr r29, r3                              
/* 801B3D0C  7C 9E 23 78 */	mr r30, r4                              
/* 801B3D10  2C 1E FF FF */	cmpwi r30, -1                           
/* 801B3D14  40 82 01 80 */	bne lbl_801B3E94                         /* constant-address: 801B3E94, symbol: lbl_801B3E94 */
/* 801B3D18  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801B3D1C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801B3D20  88 83 00 15 */	lbz r4, 0x15(r3)                         /* constant-address: 804061D5, symbol: None */
/* 801B3D24  88 7D 02 5C */	lbz r3, 0x25c(r29)                      
/* 801B3D28  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 801B3D2C  7C 03 00 40 */	cmplw r3, r0                            
/* 801B3D30  41 82 02 94 */	beq lbl_801B3FC4                         /* constant-address: 801B3FC4, symbol: lbl_801B3FC4 */
/* 801B3D34  98 9D 02 5C */	stb r4, 0x25c(r29)                      
/* 801B3D38  88 1D 02 5C */	lbz r0, 0x25c(r29)                      
/* 801B3D3C  2C 00 00 2C */	cmpwi r0, 0x2c                          
/* 801B3D40  41 82 00 1C */	beq lbl_801B3D5C                         /* constant-address: 801B3D5C, symbol: lbl_801B3D5C */
/* 801B3D44  40 80 00 1C */	bge lbl_801B3D60                         /* constant-address: 801B3D60, symbol: lbl_801B3D60 */
/* 801B3D48  2C 00 00 2A */	cmpwi r0, 0x2a                          
/* 801B3D4C  40 80 00 08 */	bge lbl_801B3D54                         /* constant-address: 801B3D54, symbol: lbl_801B3D54 */
/* 801B3D50  48 00 00 10 */	b lbl_801B3D60                           /* constant-address: 801B3D60, symbol: lbl_801B3D60 */
lbl_801B3D54:
/* 801B3D54  3B C0 00 00 */	li r30, 0                               
/* 801B3D58  48 00 00 08 */	b lbl_801B3D60                           /* constant-address: 801B3D60, symbol: lbl_801B3D60 */
lbl_801B3D5C:
...
/* 801B3D70  40 82 00 90 */	bne lbl_801B3E00                         /* constant-address: 801B3E00, symbol: lbl_801B3E00 */
/* 801B3D74  38 1C 02 40 */	addi r0, r28, 0x240                     
/* 801B3D78  7C 1D 00 AE */	lbzx r0, r29, r0                        
/* 801B3D7C  28 00 00 00 */	cmplwi r0, 0                            
/* 801B3D80  41 82 00 80 */	beq lbl_801B3E00                         /* constant-address: 801B3E00, symbol: lbl_801B3E00 */
...
/* 801B3DC0  3C 80 80 39 */	lis r4, data_803950A8@ha                
/* 801B3DC4  38 04 50 A8 */	addi r0, r4, data_803950A8@l             /* constant-address: 803950A8, symbol: data_803950A8 */
...
/* 801B3DFC  48 00 00 80 */	b lbl_801B3E7C                           /* constant-address: 801B3E7C, symbol: lbl_801B3E7C */
lbl_801B3E00:
...
/* 801B3E40  3C 80 80 39 */	lis r4, data_803950A8@ha                
/* 801B3E44  38 04 50 A8 */	addi r0, r4, data_803950A8@l             /* constant-address: 803950A8, symbol: data_803950A8 */
...
/* 801B3E8C  41 80 FE E0 */	blt lbl_801B3D6C                         /* constant-address: 801B3D6C, symbol: lbl_801B3D6C */
/* 801B3E90  48 00 01 34 */	b lbl_801B3FC4                           /* constant-address: 801B3FC4, symbol: lbl_801B3FC4 */
lbl_801B3E94:
...
/* 801B3EA4  40 82 00 90 */	bne lbl_801B3F34                         /* constant-address: 801B3F34, symbol: lbl_801B3F34 */
/* 801B3EA8  38 1B 02 40 */	addi r0, r27, 0x240                      /* constant-address: 00000240 */
/* 801B3EAC  7C 1D 00 AE */	lbzx r0, r29, r0                        
/* 801B3EB0  28 00 00 00 */	cmplwi r0, 0                            
/* 801B3EB4  41 82 00 80 */	beq lbl_801B3F34                         /* constant-address: 801B3F34, symbol: lbl_801B3F34 */
...
/* 801B3EF4  3C 80 80 39 */	lis r4, data_803950A8@ha                
/* 801B3EF8  38 04 50 A8 */	addi r0, r4, data_803950A8@l             /* constant-address: 803950A8, symbol: data_803950A8 */
...
/* 801B3F30  48 00 00 80 */	b lbl_801B3FB0                           /* constant-address: 801B3FB0, symbol: lbl_801B3FB0 */
lbl_801B3F34:
...
/* 801B3F74  3C 80 80 39 */	lis r4, data_803950A8@ha                
/* 801B3F78  38 04 50 A8 */	addi r0, r4, data_803950A8@l             /* constant-address: 803950A8, symbol: data_803950A8 */
...
/* 801B3FC0  41 80 FE E0 */	blt lbl_801B3EA0                         /* constant-address: 801B3EA0, symbol: lbl_801B3EA0 */
lbl_801B3FC4:
/* 801B3FC4  39 61 00 60 */	addi r11, r1, 0x60                      
/* 801B3FC8  48 1A E2 59 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 801AFE50  41 82 00 38 */	beq lbl_801AFE88                         /* constant-address: 801AFE88, symbol: lbl_801AFE88 */
/* 801AFE54  3C 60 80 3C */	lis r3, __vt__17dMenu_Collect2D_c@ha    
/* 801AFE58  38 03 C7 C4 */	addi r0, r3, __vt__17dMenu_Collect2D_c@l /* constant-address: 803BC7C4, symbol: __vt__17dMenu_Collect2D_c */
/* 801AFE5C  90 1E 00 00 */	stw r0, 0(r30)                          
/* 801AFE60  80 7E 00 08 */	lwz r3, 8(r30)                          
/* 801AFE64  28 03 00 00 */	cmplwi r3, 0                            
/* 801AFE68  41 82 00 10 */	beq lbl_801AFE78                         /* constant-address: 801AFE78, symbol: lbl_801AFE78 */
/* 801AFE6C  4B E5 F3 41 */	bl mDoExt_destroyExpHeap__FP10JKRExpHeap /* constant-address: 8000F1AC, symbol: mDoExt_destroyExpHeap__FP10JKRExpHeap */
/* 801AFE70  38 00 00 00 */	li r0, 0                                
/* 801AFE74  90 1E 00 08 */	stw r0, 8(r30)                          
lbl_801AFE78:
/* 801AFE78  7F E0 07 35 */	extsh. r0, r31                          
/* 801AFE7C  40 81 00 0C */	ble lbl_801AFE88                         /* constant-address: 801AFE88, symbol: lbl_801AFE88 */
/* 801AFE80  7F C3 F3 78 */	mr r3, r30                              
/* 801AFE84  48 11 EE B9 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_801AFE88:

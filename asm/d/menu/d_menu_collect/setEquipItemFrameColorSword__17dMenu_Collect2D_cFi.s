...
/* 801B39E0  48 1A E7 F5 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801B39E4  7C 7D 1B 78 */	mr r29, r3                              
/* 801B39E8  7C 9E 23 78 */	mr r30, r4                              
/* 801B39EC  2C 1E FF FF */	cmpwi r30, -1                           
/* 801B39F0  40 82 01 BC */	bne lbl_801B3BAC                         /* constant-address: 801B3BAC, symbol: lbl_801B3BAC */
/* 801B39F4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801B39F8  38 A3 61 C0 */	addi r5, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801B39FC  88 85 00 14 */	lbz r4, 0x14(r5)                         /* constant-address: 804061D4, symbol: None */
/* 801B3A00  88 7D 02 5B */	lbz r3, 0x25b(r29)                      
/* 801B3A04  54 80 06 3E */	clrlwi r0, r4, 0x18                     
/* 801B3A08  7C 03 00 40 */	cmplw r3, r0                            
/* 801B3A0C  41 82 02 D0 */	beq lbl_801B3CDC                         /* constant-address: 801B3CDC, symbol: lbl_801B3CDC */
/* 801B3A10  98 9D 02 5B */	stb r4, 0x25b(r29)                      
/* 801B3A14  88 1D 02 5B */	lbz r0, 0x25b(r29)                      
/* 801B3A18  2C 00 00 3F */	cmpwi r0, 0x3f                          
/* 801B3A1C  41 82 00 34 */	beq lbl_801B3A50                         /* constant-address: 801B3A50, symbol: lbl_801B3A50 */
/* 801B3A20  40 80 00 1C */	bge lbl_801B3A3C                         /* constant-address: 801B3A3C, symbol: lbl_801B3A3C */
/* 801B3A24  2C 00 00 29 */	cmpwi r0, 0x29                          
/* 801B3A28  41 82 00 30 */	beq lbl_801B3A58                         /* constant-address: 801B3A58, symbol: lbl_801B3A58 */
/* 801B3A2C  40 80 00 4C */	bge lbl_801B3A78                         /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
/* 801B3A30  2C 00 00 28 */	cmpwi r0, 0x28                          
/* 801B3A34  40 80 00 14 */	bge lbl_801B3A48                         /* constant-address: 801B3A48, symbol: lbl_801B3A48 */
/* 801B3A38  48 00 00 40 */	b lbl_801B3A78                           /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
lbl_801B3A3C:
/* 801B3A3C  2C 00 00 49 */	cmpwi r0, 0x49                          
/* 801B3A40  41 82 00 20 */	beq lbl_801B3A60                         /* constant-address: 801B3A60, symbol: lbl_801B3A60 */
/* 801B3A44  48 00 00 34 */	b lbl_801B3A78                           /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
lbl_801B3A48:
/* 801B3A48  3B C0 00 00 */	li r30, 0                               
/* 801B3A4C  48 00 00 2C */	b lbl_801B3A78                           /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
lbl_801B3A50:
/* 801B3A50  3B C0 00 00 */	li r30, 0                               
/* 801B3A54  48 00 00 24 */	b lbl_801B3A78                           /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
lbl_801B3A58:
/* 801B3A58  3B C0 00 01 */	li r30, 1                               
/* 801B3A5C  48 00 00 1C */	b lbl_801B3A78                           /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
lbl_801B3A60:
/* 801B3A60  38 65 00 CC */	addi r3, r5, 0xcc                        /* constant-address: 8040628C, symbol: None */
/* 801B3A64  38 80 00 49 */	li r4, 0x49                             
/* 801B3A68  4B E8 04 61 */	bl isFirstBit__21dSv_player_get_item_cCFUc /* constant-address: 80033EC8, symbol: isFirstBit__21dSv_player_get_item_cCFUc */
/* 801B3A6C  2C 03 00 00 */	cmpwi r3, 0                             
/* 801B3A70  41 82 00 08 */	beq lbl_801B3A78                         /* constant-address: 801B3A78, symbol: lbl_801B3A78 */
...
/* 801B3A88  40 82 00 90 */	bne lbl_801B3B18                         /* constant-address: 801B3B18, symbol: lbl_801B3B18 */
/* 801B3A8C  38 1C 02 3F */	addi r0, r28, 0x23f                     
/* 801B3A90  7C 1D 00 AE */	lbzx r0, r29, r0                        
/* 801B3A94  28 00 00 00 */	cmplwi r0, 0                            
/* 801B3A98  41 82 00 80 */	beq lbl_801B3B18                         /* constant-address: 801B3B18, symbol: lbl_801B3B18 */
...
/* 801B3AD8  3C 80 80 39 */	lis r4, data_80395098@ha                
/* 801B3ADC  38 04 50 98 */	addi r0, r4, data_80395098@l             /* constant-address: 80395098, symbol: data_80395098 */
...
/* 801B3B14  48 00 00 80 */	b lbl_801B3B94                           /* constant-address: 801B3B94, symbol: lbl_801B3B94 */
lbl_801B3B18:
...
/* 801B3B58  3C 80 80 39 */	lis r4, data_80395098@ha                
/* 801B3B5C  38 04 50 98 */	addi r0, r4, data_80395098@l             /* constant-address: 80395098, symbol: data_80395098 */
...
/* 801B3BA4  41 80 FE E0 */	blt lbl_801B3A84                         /* constant-address: 801B3A84, symbol: lbl_801B3A84 */
/* 801B3BA8  48 00 01 34 */	b lbl_801B3CDC                           /* constant-address: 801B3CDC, symbol: lbl_801B3CDC */
lbl_801B3BAC:
...
/* 801B3BBC  40 82 00 90 */	bne lbl_801B3C4C                         /* constant-address: 801B3C4C, symbol: lbl_801B3C4C */
/* 801B3BC0  38 1B 02 3F */	addi r0, r27, 0x23f                      /* constant-address: 0000023F */
/* 801B3BC4  7C 1D 00 AE */	lbzx r0, r29, r0                        
/* 801B3BC8  28 00 00 00 */	cmplwi r0, 0                            
/* 801B3BCC  41 82 00 80 */	beq lbl_801B3C4C                         /* constant-address: 801B3C4C, symbol: lbl_801B3C4C */
...
/* 801B3C0C  3C 80 80 39 */	lis r4, data_80395098@ha                
/* 801B3C10  38 04 50 98 */	addi r0, r4, data_80395098@l             /* constant-address: 80395098, symbol: data_80395098 */
...
/* 801B3C48  48 00 00 80 */	b lbl_801B3CC8                           /* constant-address: 801B3CC8, symbol: lbl_801B3CC8 */
lbl_801B3C4C:
...
/* 801B3C8C  3C 80 80 39 */	lis r4, data_80395098@ha                
/* 801B3C90  38 04 50 98 */	addi r0, r4, data_80395098@l             /* constant-address: 80395098, symbol: data_80395098 */
...
/* 801B3CD8  41 80 FE E0 */	blt lbl_801B3BB8                         /* constant-address: 801B3BB8, symbol: lbl_801B3BB8 */
lbl_801B3CDC:
/* 801B3CDC  39 61 00 60 */	addi r11, r1, 0x60                      
/* 801B3CE0  48 1A E5 41 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

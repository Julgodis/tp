...
/* 801B7024  48 1A B1 B9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 801B7028  7C 7F 1B 78 */	mr r31, r3                              
/* 801B702C  3C 60 80 39 */	lis r3, lit_3778@ha                     
/* 801B7030  3B A3 4F 78 */	addi r29, r3, lit_3778@l                 /* constant-address: 80394F78, symbol: lit_3778 */
/* 801B7034  48 00 04 01 */	bl getCrystalNum__17dMenu_Collect3D_cFv  /* constant-address: 801B7434, symbol: getCrystalNum__17dMenu_Collect3D_cFv */
/* 801B7038  54 7E 06 3F */	clrlwi. r30, r3, 0x18                   
/* 801B703C  54 67 15 BA */	rlwinm r7, r3, 2, 0x16, 0x1d            
/* 801B7040  38 7D 03 40 */	addi r3, r29, 0x340                      /* constant-address: 803952B8, symbol: data_803952B8 */
/* 801B7044  7C 03 3C 2E */	lfsx f0, r3, r7                         
/* 801B7048  D0 1F 03 C4 */	stfs f0, 0x3c4(r31)                     
/* 801B704C  38 7D 03 54 */	addi r3, r29, 0x354                      /* constant-address: 803952CC, symbol: data_803952CC */
/* 801B7050  7C 03 3C 2E */	lfsx f0, r3, r7                         
/* 801B7054  D0 1F 03 C8 */	stfs f0, 0x3c8(r31)                     
/* 801B7058  38 7D 03 68 */	addi r3, r29, 0x368                      /* constant-address: 803952E0, symbol: data_803952E0 */
/* 801B705C  7C 03 3C 2E */	lfsx f0, r3, r7                         
/* 801B7060  D0 1F 03 CC */	stfs f0, 0x3cc(r31)                     
/* 801B7064  C0 02 A5 28 */	lfs f0, lit_4481(r2)                     /* constant-address: 80453F28, symbol: lit_4481 */
...
/* 801B7090  41 82 01 1C */	beq lbl_801B71AC                         /* constant-address: 801B71AC, symbol: lbl_801B71AC */
/* 801B7094  7F E3 FB 78 */	mr r3, r31                              
/* 801B7098  3C 80 80 39 */	lis r4, d_menu_d_menu_collect__stringBase0@ha
/* 801B709C  38 84 53 30 */	addi r4, r4, d_menu_d_menu_collect__stringBase0@l /* constant-address: 80395330, symbol: d_menu_d_menu_collect__stringBase0 */
/* 801B70A0  38 84 01 26 */	addi r4, r4, 0x126                       /* constant-address: 80395456, symbol: None */
/* 801B70A4  3C A0 80 3C */	lis r5, data_803BC71C@ha                
/* 801B70A8  38 05 C7 1C */	addi r0, r5, data_803BC71C@l             /* constant-address: 803BC71C, symbol: data_803BC71C */
/* 801B70AC  7C A0 3A 14 */	add r5, r0, r7                          
/* 801B70B0  80 A5 FF FC */	lwz r5, -4(r5)                          
/* 801B70B4  3C C0 80 3C */	lis r6, data_803BC72C@ha                
/* 801B70B8  38 06 C7 2C */	addi r0, r6, data_803BC72C@l             /* constant-address: 803BC72C, symbol: data_803BC72C */
/* 801B70BC  7C C0 3A 14 */	add r6, r0, r7                          
/* 801B70C0  80 C6 FF FC */	lwz r6, -4(r6)                          
/* 801B70C4  4B FF F9 6D */	bl setJ3D__17dMenu_Collect3D_cFPCcPCcPCc /* constant-address: 801B6A30, symbol: setJ3D__17dMenu_Collect3D_cFPCcPCcPCc */
/* 801B70C8  2C 1E 00 02 */	cmpwi r30, 2                            
/* 801B70CC  41 82 00 60 */	beq lbl_801B712C                         /* constant-address: 801B712C, symbol: lbl_801B712C */
/* 801B70D0  40 80 00 10 */	bge lbl_801B70E0                         /* constant-address: 801B70E0, symbol: lbl_801B70E0 */
/* 801B70D4  2C 1E 00 01 */	cmpwi r30, 1                            
/* 801B70D8  40 80 00 14 */	bge lbl_801B70EC                         /* constant-address: 801B70EC, symbol: lbl_801B70EC */
/* 801B70DC  48 00 00 D0 */	b lbl_801B71AC                           /* constant-address: 801B71AC, symbol: lbl_801B71AC */
lbl_801B70E0:
/* 801B70E0  2C 1E 00 04 */	cmpwi r30, 4                            
/* 801B70E4  40 80 00 C8 */	bge lbl_801B71AC                         /* constant-address: 801B71AC, symbol: lbl_801B71AC */
/* 801B70E8  48 00 00 84 */	b lbl_801B716C                           /* constant-address: 801B716C, symbol: lbl_801B716C */
lbl_801B70EC:
...
/* 801B71B0  48 1A B0 79 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

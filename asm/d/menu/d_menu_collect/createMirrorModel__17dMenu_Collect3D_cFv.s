...
/* 801B71D4  48 1A B0 09 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 801B71D8  7C 7F 1B 78 */	mr r31, r3                              
/* 801B71DC  3C 60 80 39 */	lis r3, lit_3778@ha                     
/* 801B71E0  3B A3 4F 78 */	addi r29, r3, lit_3778@l                 /* constant-address: 80394F78, symbol: lit_3778 */
/* 801B71E4  48 00 02 B9 */	bl getMirrorNum__17dMenu_Collect3D_cFv   /* constant-address: 801B749C, symbol: getMirrorNum__17dMenu_Collect3D_cFv */
/* 801B71E8  54 7E 06 3F */	clrlwi. r30, r3, 0x18                   
/* 801B71EC  54 67 15 BA */	rlwinm r7, r3, 2, 0x16, 0x1d            
/* 801B71F0  38 7D 03 7C */	addi r3, r29, 0x37c                      /* constant-address: 803952F4, symbol: data_803952F4 */
/* 801B71F4  7C 03 3C 2E */	lfsx f0, r3, r7                         
/* 801B71F8  D0 1F 03 C4 */	stfs f0, 0x3c4(r31)                     
/* 801B71FC  38 7D 03 90 */	addi r3, r29, 0x390                      /* constant-address: 80395308, symbol: data_80395308 */
/* 801B7200  7C 03 3C 2E */	lfsx f0, r3, r7                         
/* 801B7204  D0 1F 03 C8 */	stfs f0, 0x3c8(r31)                     
/* 801B7208  38 7D 03 A4 */	addi r3, r29, 0x3a4                      /* constant-address: 8039531C, symbol: data_8039531C */
/* 801B720C  7C 03 3C 2E */	lfsx f0, r3, r7                         
/* 801B7210  D0 1F 03 CC */	stfs f0, 0x3cc(r31)                     
/* 801B7214  C0 02 A5 28 */	lfs f0, lit_4481(r2)                     /* constant-address: 80453F28, symbol: lit_4481 */
...
/* 801B7240  41 82 01 DC */	beq lbl_801B741C                         /* constant-address: 801B741C, symbol: lbl_801B741C */
/* 801B7244  7F E3 FB 78 */	mr r3, r31                              
/* 801B7248  3C 80 80 39 */	lis r4, d_menu_d_menu_collect__stringBase0@ha
/* 801B724C  38 84 53 30 */	addi r4, r4, d_menu_d_menu_collect__stringBase0@l /* constant-address: 80395330, symbol: d_menu_d_menu_collect__stringBase0 */
/* 801B7250  38 84 01 CF */	addi r4, r4, 0x1cf                       /* constant-address: 803954FF, symbol: None */
/* 801B7254  3C A0 80 3C */	lis r5, data_803BC73C@ha                
/* 801B7258  38 05 C7 3C */	addi r0, r5, data_803BC73C@l             /* constant-address: 803BC73C, symbol: data_803BC73C */
/* 801B725C  7C A0 3A 14 */	add r5, r0, r7                          
/* 801B7260  80 A5 FF FC */	lwz r5, -4(r5)                          
/* 801B7264  3C C0 80 3C */	lis r6, data_803BC74C@ha                
/* 801B7268  38 06 C7 4C */	addi r0, r6, data_803BC74C@l             /* constant-address: 803BC74C, symbol: data_803BC74C */
/* 801B726C  7C C0 3A 14 */	add r6, r0, r7                          
/* 801B7270  80 C6 FF FC */	lwz r6, -4(r6)                          
/* 801B7274  4B FF F7 BD */	bl setJ3D__17dMenu_Collect3D_cFPCcPCcPCc /* constant-address: 801B6A30, symbol: setJ3D__17dMenu_Collect3D_cFPCcPCcPCc */
/* 801B7278  2C 1E 00 02 */	cmpwi r30, 2                            
/* 801B727C  41 82 00 A0 */	beq lbl_801B731C                         /* constant-address: 801B731C, symbol: lbl_801B731C */
/* 801B7280  40 80 00 10 */	bge lbl_801B7290                         /* constant-address: 801B7290, symbol: lbl_801B7290 */
/* 801B7284  2C 1E 00 01 */	cmpwi r30, 1                            
/* 801B7288  40 80 00 14 */	bge lbl_801B729C                         /* constant-address: 801B729C, symbol: lbl_801B729C */
/* 801B728C  48 00 01 90 */	b lbl_801B741C                           /* constant-address: 801B741C, symbol: lbl_801B741C */
lbl_801B7290:
/* 801B7290  2C 1E 00 04 */	cmpwi r30, 4                            
/* 801B7294  40 80 01 88 */	bge lbl_801B741C                         /* constant-address: 801B741C, symbol: lbl_801B741C */
/* 801B7298  48 00 01 04 */	b lbl_801B739C                           /* constant-address: 801B739C, symbol: lbl_801B739C */
lbl_801B729C:
...
/* 801B7420  48 1A AE 09 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

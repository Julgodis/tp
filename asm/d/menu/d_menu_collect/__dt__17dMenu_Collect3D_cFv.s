...
/* 801B6554  41 82 00 38 */	beq lbl_801B658C                         /* constant-address: 801B658C, symbol: lbl_801B658C */
/* 801B6558  3C 60 80 3C */	lis r3, __vt__17dMenu_Collect3D_c@ha    
/* 801B655C  38 03 C7 90 */	addi r0, r3, __vt__17dMenu_Collect3D_c@l /* constant-address: 803BC790, symbol: __vt__17dMenu_Collect3D_c */
/* 801B6560  90 1E 00 00 */	stw r0, 0(r30)                          
/* 801B6564  80 7E 00 08 */	lwz r3, 8(r30)                          
/* 801B6568  28 03 00 00 */	cmplwi r3, 0                            
/* 801B656C  41 82 00 10 */	beq lbl_801B657C                         /* constant-address: 801B657C, symbol: lbl_801B657C */
/* 801B6570  4B E5 8C 1D */	bl mDoExt_destroySolidHeap__FP12JKRSolidHeap /* constant-address: 8000F18C, symbol: mDoExt_destroySolidHeap__FP12JKRSolidHeap */
/* 801B6574  38 00 00 00 */	li r0, 0                                
/* 801B6578  90 1E 00 08 */	stw r0, 8(r30)                          
lbl_801B657C:
/* 801B657C  7F E0 07 35 */	extsh. r0, r31                          
/* 801B6580  40 81 00 0C */	ble lbl_801B658C                         /* constant-address: 801B658C, symbol: lbl_801B658C */
/* 801B6584  7F C3 F3 78 */	mr r3, r30                              
/* 801B6588  48 11 87 B5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_801B658C:

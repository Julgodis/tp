...
/* 801AFD60  38 03 6F 88 */	addi r0, r3, __vt__12dDlst_base_c@l      /* constant-address: 803A6F88, symbol: __vt__12dDlst_base_c */
/* 801AFD64  90 1F 00 00 */	stw r0, 0(r31)                          
/* 801AFD68  3C 60 80 3C */	lis r3, __vt__17dMenu_Collect2D_c@ha    
/* 801AFD6C  38 03 C7 C4 */	addi r0, r3, __vt__17dMenu_Collect2D_c@l /* constant-address: 803BC7C4, symbol: __vt__17dMenu_Collect2D_c */
...
/* 801AFD8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801AFD90  80 63 5D B4 */	lwz r3, 0x5db4(r3)                       /* constant-address: 8040BF74, symbol: None */
/* 801AFD94  80 03 05 74 */	lwz r0, 0x574(r3)                       
/* 801AFD98  54 00 01 8C */	rlwinm r0, r0, 0, 6, 6                  
/* 801AFD9C  90 1F 00 40 */	stw r0, 0x40(r31)                       
/* 801AFDA0  C0 02 A5 28 */	lfs f0, lit_4481(r2)                     /* constant-address: 80453F28, symbol: lit_4481 */
/* 801AFDA4  D0 1F 00 7C */	stfs f0, 0x7c(r31)                      
/* 801AFDA8  D0 1F 00 80 */	stfs f0, 0x80(r31)                      
/* 801AFDAC  D0 1F 00 84 */	stfs f0, 0x84(r31)                      
/* 801AFDB0  C0 02 A5 2C */	lfs f0, lit_4482(r2)                     /* constant-address: 80453F2C, symbol: lit_4482 */
...
/* 801AFDD0  42 00 FF EC */	bdnz lbl_801AFDBC                        /* constant-address: 801AFDBC, symbol: lbl_801AFDBC */
/* 801AFDD4  C0 22 A5 28 */	lfs f1, lit_4481(r2)                     /* constant-address: 80453F28, symbol: lit_4481 */
/* 801AFDD8  D0 3F 00 54 */	stfs f1, 0x54(r31)                      
/* 801AFDDC  D0 3F 00 58 */	stfs f1, 0x58(r31)                      
/* 801AFDE0  C0 02 A5 2C */	lfs f0, lit_4482(r2)                     /* constant-address: 80453F2C, symbol: lit_4482 */
...
/* 801AFE08  38 63 60 00 */	addi r3, r3, 0x6000 /* 0x00046000@l */   /* constant-address: 00046000 */
/* 801AFE0C  80 9F 00 04 */	lwz r4, 4(r31)                          
/* 801AFE10  38 A0 00 00 */	li r5, 0                                
/* 801AFE14  48 11 F0 19 */	bl create__10JKRExpHeapFUlP7JKRHeapb     /* constant-address: 802CEE2C, symbol: create__10JKRExpHeapFUlP7JKRHeapb */

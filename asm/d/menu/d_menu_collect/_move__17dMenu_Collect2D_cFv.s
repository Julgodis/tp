...
/* 801B5CF8  38 04 C6 38 */	addi r0, r4, process@l                   /* constant-address: 803BC638, symbol: process */
/* 801B5CFC  7D 80 2A 14 */	add r12, r0, r5                         
/* 801B5D00  48 1A C3 85 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801B5D04  60 00 00 00 */	nop                                     
/* 801B5D08  88 1E 02 2C */	lbz r0, 0x22c(r30)                      
/* 801B5D0C  7C 00 F8 40 */	cmplw r0, r31                           
/* 801B5D10  41 82 00 20 */	beq lbl_801B5D30                         /* constant-address: 801B5D30, symbol: lbl_801B5D30 */
/* 801B5D14  7F C3 F3 78 */	mr r3, r30                              
/* 801B5D18  1C A0 00 0C */	mulli r5, r0, 0xc                       
/* 801B5D1C  3C 80 80 3C */	lis r4, init@ha                         
/* 801B5D20  38 04 C4 70 */	addi r0, r4, init@l                      /* constant-address: 803BC470, symbol: init */
/* 801B5D24  7D 80 2A 14 */	add r12, r0, r5                         
/* 801B5D28  48 1A C3 5D */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801B5D2C  60 00 00 00 */	nop                                     
lbl_801B5D30:
/* 801B5D30  7F C3 F3 78 */	mr r3, r30                              
/* 801B5D34  80 9E 00 2C */	lwz r4, 0x2c(r30)                       
/* 801B5D38  4B FF BF A9 */	bl btkAnimeLoop0__17dMenu_Collect2D_cFP19J2DAnmTextureSRTKey /* constant-address: 801B1CE0, symbol: btkAnimeLoop0__17dMenu_Collect2D_cFP19J2DAnmTextureSRTKey */
/* 801B5D3C  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 801B5D40  48 14 39 51 */	bl animation__9J2DScreenFv               /* constant-address: 802F9690, symbol: animation__9J2DScreenFv */
/* 801B5D44  7F C3 F3 78 */	mr r3, r30                              
/* 801B5D48  4B FF C1 95 */	bl setBackAlpha__17dMenu_Collect2D_cFv   /* constant-address: 801B1EDC, symbol: setBackAlpha__17dMenu_Collect2D_cFv */
/* 801B5D4C  7F C3 F3 78 */	mr r3, r30                              
/* 801B5D50  38 80 00 00 */	li r4, 0                                
/* 801B5D54  4B FF E5 85 */	bl setHIO__17dMenu_Collect2D_cFb         /* constant-address: 801B42D8, symbol: setHIO__17dMenu_Collect2D_cFb */

...
/* 801E1048  48 18 11 85 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 801E1064  3C 60 80 3C */	lis r3, letter_data__12dMenu_Letter@ha  
/* 801E1068  3B A3 F8 1C */	addi r29, r3, letter_data__12dMenu_Letter@l /* constant-address: 803BF81C, symbol: letter_data__12dMenu_Letter */
/* 801E106C  48 00 00 D4 */	b lbl_801E1140                           /* constant-address: 801E1140, symbol: lbl_801E1140 */
lbl_801E1070:
/* 801E1070  38 19 03 AC */	addi r0, r25, 0x3ac                      /* constant-address: 000003AC */
...
/* 801E1138  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
/* 801E113C  3B 7B 00 10 */	addi r27, r27, 0x10                      /* constant-address: 00000010 */
lbl_801E1140:
/* 801E1140  88 1C 03 73 */	lbz r0, 0x373(r28)                      
/* 801E1144  7C 19 00 00 */	cmpw r25, r0                            
/* 801E1148  41 80 FF 28 */	blt lbl_801E1070                         /* constant-address: 801E1070, symbol: lbl_801E1070 */
/* 801E114C  3B A0 00 00 */	li r29, 0                               
/* 801E1150  3B 60 00 00 */	li r27, 0                               
/* 801E1154  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801E1158  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801E115C  3B E3 01 1C */	addi r31, r3, 0x11c                      /* constant-address: 804062DC, symbol: None */
lbl_801E1160:
/* 801E1160  88 1C 03 73 */	lbz r0, 0x373(r28)                      
/* 801E1164  7C 1D 00 00 */	cmpw r29, r0                            
/* 801E1168  40 80 00 4C */	bge lbl_801E11B4                         /* constant-address: 801E11B4, symbol: lbl_801E11B4 */
/* 801E116C  7F E3 FB 78 */	mr r3, r31                              
/* 801E1170  38 1D 03 AC */	addi r0, r29, 0x3ac                      /* constant-address: 000003AC */
/* 801E1174  7C 9E 00 AE */	lbzx r4, r30, r0                        
/* 801E1178  38 04 FF FF */	addi r0, r4, -1                         
/* 801E117C  54 04 06 3E */	clrlwi r4, r0, 0x18                     
/* 801E1180  4B E5 33 1D */	bl isLetterReadFlag__17dSv_letter_info_cCFi /* constant-address: 8003449C, symbol: isLetterReadFlag__17dSv_letter_info_cCFi */
/* 801E1184  2C 03 00 00 */	cmpwi r3, 0                             
/* 801E1188  40 82 00 18 */	bne lbl_801E11A0                         /* constant-address: 801E11A0, symbol: lbl_801E11A0 */
/* 801E118C  38 80 00 01 */	li r4, 1                                
/* 801E1190  38 1B 00 BC */	addi r0, r27, 0xbc                       /* constant-address: 000000BC */
/* 801E1194  7C 7C 00 2E */	lwzx r3, r28, r0                        
/* 801E1198  98 83 00 B0 */	stb r4, 0xb0(r3)                        
/* 801E119C  48 00 00 28 */	b lbl_801E11C4                           /* constant-address: 801E11C4, symbol: lbl_801E11C4 */
lbl_801E11A0:
/* 801E11A0  38 80 00 00 */	li r4, 0                                
/* 801E11A4  38 1B 00 BC */	addi r0, r27, 0xbc                       /* constant-address: 000000BC */
/* 801E11A8  7C 7C 00 2E */	lwzx r3, r28, r0                        
/* 801E11AC  98 83 00 B0 */	stb r4, 0xb0(r3)                        
/* 801E11B0  48 00 00 14 */	b lbl_801E11C4                           /* constant-address: 801E11C4, symbol: lbl_801E11C4 */
lbl_801E11B4:
...
/* 801E11D0  41 80 FF 90 */	blt lbl_801E1160                         /* constant-address: 801E1160, symbol: lbl_801E1160 */
/* 801E11D4  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801E11D8  48 18 10 41 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

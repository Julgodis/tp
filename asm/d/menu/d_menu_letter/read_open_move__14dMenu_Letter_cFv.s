...
/* 801DE57C  48 18 3C 59 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801DE580  7C 7F 1B 78 */	mr r31, r3                              
/* 801DE584  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801DE588  3B A3 EB C8 */	addi r29, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DE58C  A8 9D 07 5A */	lha r4, 0x75a(r29)                       /* constant-address: 8042F322, symbol: None */
...
/* 801DE5A4  41 80 00 7C */	blt lbl_801DE620                         /* constant-address: 801DE620, symbol: lbl_801DE620 */
...
lbl_801DE5B8:
/* 801DE5B8  C0 1D 07 4C */	lfs f0, 0x74c(r29)                       /* constant-address: 8042F314, symbol: None */
...
/* 801DE5E4  C0 22 A8 E4 */	lfs f1, lit_3828(r2)                     /* constant-address: 804542E4, symbol: lit_3828 */
/* 801DE5E8  48 07 71 E9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DE5EC  3B 7B 00 01 */	addi r27, r27, 1                        
/* 801DE5F0  2C 1B 00 02 */	cmpwi r27, 2                            
/* 801DE5F4  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DE5F8  41 80 FF C0 */	blt lbl_801DE5B8                         /* constant-address: 801DE5B8, symbol: lbl_801DE5B8 */
/* 801DE5FC  80 7F 02 B4 */	lwz r3, 0x2b4(r31)                      
/* 801DE600  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801DE604  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DE608  88 84 07 85 */	lbz r4, 0x785(r4)                        /* constant-address: 8042F34D, symbol: None */
...
/* 801DE61C  48 00 00 D0 */	b lbl_801DE6EC                           /* constant-address: 801DE6EC, symbol: lbl_801DE6EC */
lbl_801DE620:
/* 801DE620  C8 42 A9 10 */	lfd f2, lit_4171(r2)                     /* constant-address: 80454310, symbol: lit_4171 */
...
lbl_801DE65C:
/* 801DE65C  C0 1D 07 4C */	lfs f0, 0x74c(r29)                       /* constant-address: 8042F314, symbol: None */
...
/* 801DE690  48 07 71 41 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DE694  3B 7B 00 01 */	addi r27, r27, 1                        
/* 801DE698  2C 1B 00 02 */	cmpwi r27, 2                            
/* 801DE69C  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DE6A0  41 80 FF BC */	blt lbl_801DE65C                         /* constant-address: 801DE65C, symbol: lbl_801DE65C */
/* 801DE6A4  80 7F 02 B4 */	lwz r3, 0x2b4(r31)                      
/* 801DE6A8  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801DE6AC  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DE6B0  88 04 07 85 */	lbz r0, 0x785(r4)                        /* constant-address: 8042F34D, symbol: None */
/* 801DE6B4  C8 22 A9 08 */	lfd f1, lit_4058(r2)                     /* constant-address: 80454308, symbol: lit_4058 */
...
/* 801DE6F8  48 18 3B 29 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

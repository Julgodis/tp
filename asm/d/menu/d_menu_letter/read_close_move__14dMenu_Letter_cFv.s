...
/* 801DEE84  48 18 33 51 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801DEE88  7C 7F 1B 78 */	mr r31, r3                              
/* 801DEE8C  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801DEE90  3B A3 EB C8 */	addi r29, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DEE94  A8 9D 07 5E */	lha r4, 0x75e(r29)                       /* constant-address: 8042F326, symbol: None */
...
/* 801DEEAC  41 81 00 78 */	bgt lbl_801DEF24                         /* constant-address: 801DEF24, symbol: lbl_801DEF24 */
/* 801DEEB0  3B C0 00 00 */	li r30, 0                               
/* 801DEEB4  9B DF 03 6D */	stb r30, 0x36d(r31)                     
/* 801DEEB8  3B 80 00 00 */	li r28, 0                               
/* 801DEEBC  C3 E2 A8 E0 */	lfs f31, lit_3827(r2)                    /* constant-address: 804542E0, symbol: lit_3827 */
lbl_801DEEC0:
...
/* 801DEEE8  C0 22 A8 E0 */	lfs f1, lit_3827(r2)                     /* constant-address: 804542E0, symbol: lit_3827 */
/* 801DEEEC  48 07 68 E5 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DEEF0  3B 9C 00 01 */	addi r28, r28, 1                        
/* 801DEEF4  2C 1C 00 02 */	cmpwi r28, 2                            
/* 801DEEF8  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DEEFC  41 80 FF C4 */	blt lbl_801DEEC0                         /* constant-address: 801DEEC0, symbol: lbl_801DEEC0 */
/* 801DEF00  80 7F 02 B4 */	lwz r3, 0x2b4(r31)                      
/* 801DEF04  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801DEF08  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DEF0C  88 84 07 85 */	lbz r4, 0x785(r4)                        /* constant-address: 8042F34D, symbol: None */
...
/* 801DEF20  48 00 00 D0 */	b lbl_801DEFF0                           /* constant-address: 801DEFF0, symbol: lbl_801DEFF0 */
lbl_801DEF24:
/* 801DEF24  C8 42 A9 10 */	lfd f2, lit_4171(r2)                     /* constant-address: 80454310, symbol: lit_4171 */
...
lbl_801DEF60:
/* 801DEF60  C0 1D 07 4C */	lfs f0, 0x74c(r29)                       /* constant-address: 8042F314, symbol: None */
...
/* 801DEF94  48 07 68 3D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DEF98  3B 7B 00 01 */	addi r27, r27, 1                        
/* 801DEF9C  2C 1B 00 02 */	cmpwi r27, 2                            
/* 801DEFA0  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DEFA4  41 80 FF BC */	blt lbl_801DEF60                         /* constant-address: 801DEF60, symbol: lbl_801DEF60 */
/* 801DEFA8  80 7F 02 B4 */	lwz r3, 0x2b4(r31)                      
/* 801DEFAC  3C 80 80 43 */	lis r4, g_drawHIO@ha                    
/* 801DEFB0  38 84 EB C8 */	addi r4, r4, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DEFB4  88 04 07 85 */	lbz r0, 0x785(r4)                        /* constant-address: 8042F34D, symbol: None */
/* 801DEFB8  C8 22 A9 08 */	lfd f1, lit_4058(r2)                     /* constant-address: 80454308, symbol: lit_4058 */
...
/* 801DEFFC  48 18 32 25 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 801DED1C  48 18 34 BD */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 801DED20  7C 7F 1B 78 */	mr r31, r3                              
/* 801DED24  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801DED28  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DED2C  A8 83 07 5A */	lha r4, 0x75a(r3)                        /* constant-address: 8042F322, symbol: None */
...
/* 801DED44  41 80 00 4C */	blt lbl_801DED90                         /* constant-address: 801DED90, symbol: lbl_801DED90 */
...
/* 801DED60  C0 22 A8 E4 */	lfs f1, lit_3828(r2)                     /* constant-address: 804542E4, symbol: lit_3828 */
/* 801DED64  48 07 6A 6D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DED68  80 7D 02 F4 */	lwz r3, 0x2f4(r29)                      
/* 801DED6C  28 03 00 00 */	cmplwi r3, 0                            
/* 801DED70  41 82 00 0C */	beq lbl_801DED7C                         /* constant-address: 801DED7C, symbol: lbl_801DED7C */
/* 801DED74  C0 22 A8 E4 */	lfs f1, lit_3828(r2)                     /* constant-address: 804542E4, symbol: lit_3828 */
/* 801DED78  48 07 6A 59 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_801DED7C:
/* 801DED7C  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 801DED80  2C 1C 00 02 */	cmpwi r28, 2                            
/* 801DED84  3B DE 00 04 */	addi r30, r30, 4                         /* constant-address: 00000004 */
/* 801DED88  41 80 FF D0 */	blt lbl_801DED58                         /* constant-address: 801DED58, symbol: lbl_801DED58 */
/* 801DED8C  48 00 00 74 */	b lbl_801DEE00                           /* constant-address: 801DEE00, symbol: lbl_801DEE00 */
lbl_801DED90:
/* 801DED90  C8 42 A9 10 */	lfd f2, lit_4171(r2)                     /* constant-address: 80454310, symbol: lit_4171 */
...
/* 801DEDD8  48 07 69 F9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DEDDC  80 7D 02 F4 */	lwz r3, 0x2f4(r29)                      
/* 801DEDE0  28 03 00 00 */	cmplwi r3, 0                            
/* 801DEDE4  41 82 00 0C */	beq lbl_801DEDF0                         /* constant-address: 801DEDF0, symbol: lbl_801DEDF0 */
/* 801DEDE8  FC 20 F8 90 */	fmr f1, f31                             
/* 801DEDEC  48 07 69 E5 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_801DEDF0:
/* 801DEDF0  3B 9C 00 01 */	addi r28, r28, 1                        
/* 801DEDF4  2C 1C 00 02 */	cmpwi r28, 2                            
/* 801DEDF8  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DEDFC  41 80 FF D0 */	blt lbl_801DEDCC                         /* constant-address: 801DEDCC, symbol: lbl_801DEDCC */
lbl_801DEE00:
/* 801DEE00  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */       
/* 801DEE04  CB E1 00 30 */	lfd f31, 0x30(r1)                       
/* 801DEE08  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801DEE0C  48 18 34 19 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

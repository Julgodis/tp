...
/* 801DDA8C  48 18 47 49 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801DDA90  7C 7F 1B 78 */	mr r31, r3                              
/* 801DDA94  80 03 00 14 */	lwz r0, 0x14(r3)                        
/* 801DDA98  28 00 00 00 */	cmplwi r0, 0                            
/* 801DDA9C  40 82 00 1C */	bne lbl_801DDAB8                         /* constant-address: 801DDAB8, symbol: lbl_801DDAB8 */
/* 801DDAA0  3C 60 80 39 */	lis r3, d_menu_d_menu_letter__stringBase0@ha
/* 801DDAA4  38 63 6D C0 */	addi r3, r3, d_menu_d_menu_letter__stringBase0@l /* constant-address: 80396DC0, symbol: d_menu_d_menu_letter__stringBase0 */
/* 801DDAA8  38 80 00 00 */	li r4, 0                                
/* 801DDAAC  38 A0 00 00 */	li r5, 0                                
/* 801DDAB0  4B E3 83 65 */	bl create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap /* constant-address: 80015E14, symbol: create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap */
/* 801DDAB4  90 7F 00 14 */	stw r3, 0x14(r31)                       
lbl_801DDAB8:
/* 801DDAB8  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 801DDABC  28 03 00 00 */	cmplwi r3, 0                            
/* 801DDAC0  40 82 00 60 */	bne lbl_801DDB20                         /* constant-address: 801DDB20, symbol: lbl_801DDB20 */
/* 801DDAC4  80 9F 00 14 */	lwz r4, 0x14(r31)                       
/* 801DDAC8  88 04 00 0C */	lbz r0, 0xc(r4)                         
/* 801DDACC  2C 00 00 00 */	cmpwi r0, 0                             
/* 801DDAD0  41 82 00 48 */	beq lbl_801DDB18                         /* constant-address: 801DDB18, symbol: lbl_801DDB18 */
/* 801DDAD4  28 03 00 00 */	cmplwi r3, 0                            
/* 801DDAD8  40 82 00 48 */	bne lbl_801DDB20                         /* constant-address: 801DDB20, symbol: lbl_801DDB20 */
...
/* 801DDAEC  41 82 00 18 */	beq lbl_801DDB04                         /* constant-address: 801DDB04, symbol: lbl_801DDB04 */
...
/* 801DDB10  4B FF F8 5D */	bl _create__14dMenu_Letter_cFv           /* constant-address: 801DD36C, symbol: _create__14dMenu_Letter_cFv */
/* 801DDB14  48 00 00 0C */	b lbl_801DDB20                           /* constant-address: 801DDB20, symbol: lbl_801DDB20 */
lbl_801DDB18:
/* 801DDB18  38 60 00 00 */	li r3, 0                                
/* 801DDB1C  48 00 01 5C */	b lbl_801DDC78                           /* constant-address: 801DDC78, symbol: lbl_801DDC78 */
lbl_801DDB20:
/* 801DDB20  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801DDB24  3B A3 EB C8 */	addi r29, r3, g_drawHIO@l                /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DDB28  A8 9D 07 58 */	lha r4, 0x758(r29)                       /* constant-address: 8042F320, symbol: None */
/* 801DDB2C  A8 7D 07 5C */	lha r3, 0x75c(r29)                       /* constant-address: 8042F324, symbol: None */
/* 801DDB30  B0 9F 03 68 */	sth r4, 0x368(r31)                      
/* 801DDB34  A8 1F 03 68 */	lha r0, 0x368(r31)                      
/* 801DDB38  7C 00 20 00 */	cmpw r0, r4                             
/* 801DDB3C  41 80 00 94 */	blt lbl_801DDBD0                         /* constant-address: 801DDBD0, symbol: lbl_801DDBD0 */
...
lbl_801DDB54:
/* 801DDB54  C0 1D 07 40 */	lfs f0, 0x740(r29)                       /* constant-address: 8042F308, symbol: None */
...
/* 801DDB80  C0 22 A8 E4 */	lfs f1, lit_3828(r2)                     /* constant-address: 804542E4, symbol: lit_3828 */
/* 801DDB84  48 07 7C 4D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DDB88  3B 7B 00 01 */	addi r27, r27, 1                        
/* 801DDB8C  2C 1B 00 03 */	cmpwi r27, 3                            
/* 801DDB90  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DDB94  41 80 FF C0 */	blt lbl_801DDB54                         /* constant-address: 801DDB54, symbol: lbl_801DDB54 */
/* 801DDB98  7F E3 FB 78 */	mr r3, r31                              
/* 801DDB9C  48 00 2F 89 */	bl setCursorPos__14dMenu_Letter_cFv      /* constant-address: 801E0B24, symbol: setCursorPos__14dMenu_Letter_cFv */
/* 801DDBA0  80 7F 03 0C */	lwz r3, 0x30c(r31)                      
/* 801DDBA4  C0 22 A8 E4 */	lfs f1, lit_3828(r2)                     /* constant-address: 804542E4, symbol: lit_3828 */
/* 801DDBA8  4B FB 76 F9 */	bl setAlphaRate__16dSelect_cursor_cFf    /* constant-address: 801952A0, symbol: setAlphaRate__16dSelect_cursor_cFf */
/* 801DDBAC  80 7F 03 0C */	lwz r3, 0x30c(r31)                      
/* 801DDBB0  C0 22 A8 E4 */	lfs f1, lit_3828(r2)                     /* constant-address: 804542E4, symbol: lit_3828 */
/* 801DDBB4  4B FB 76 15 */	bl setScale__16dSelect_cursor_cFf        /* constant-address: 801951C8, symbol: setScale__16dSelect_cursor_cFf */
...
/* 801DDBCC  48 00 00 AC */	b lbl_801DDC78                           /* constant-address: 801DDC78, symbol: lbl_801DDC78 */
lbl_801DDBD0:
/* 801DDBD0  C8 42 A9 10 */	lfd f2, lit_4171(r2)                     /* constant-address: 80454310, symbol: lit_4171 */
...
lbl_801DDC0C:
/* 801DDC0C  C0 1D 07 40 */	lfs f0, 0x740(r29)                       /* constant-address: 8042F308, symbol: None */
...
/* 801DDC40  48 07 7B 91 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DDC44  3B 7B 00 01 */	addi r27, r27, 1                        
/* 801DDC48  2C 1B 00 03 */	cmpwi r27, 3                            
/* 801DDC4C  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DDC50  41 80 FF BC */	blt lbl_801DDC0C                         /* constant-address: 801DDC0C, symbol: lbl_801DDC0C */
/* 801DDC54  7F E3 FB 78 */	mr r3, r31                              
/* 801DDC58  48 00 2E CD */	bl setCursorPos__14dMenu_Letter_cFv      /* constant-address: 801E0B24, symbol: setCursorPos__14dMenu_Letter_cFv */
/* 801DDC5C  80 7F 03 0C */	lwz r3, 0x30c(r31)                      
/* 801DDC60  FC 20 F8 90 */	fmr f1, f31                             
/* 801DDC64  4B FB 76 3D */	bl setAlphaRate__16dSelect_cursor_cFf    /* constant-address: 801952A0, symbol: setAlphaRate__16dSelect_cursor_cFf */
/* 801DDC68  80 7F 03 0C */	lwz r3, 0x30c(r31)                      
/* 801DDC6C  FC 20 F8 90 */	fmr f1, f31                             
/* 801DDC70  4B FB 75 59 */	bl setScale__16dSelect_cursor_cFf        /* constant-address: 801951C8, symbol: setScale__16dSelect_cursor_cFf */
...
/* 801DDC84  48 18 45 9D */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

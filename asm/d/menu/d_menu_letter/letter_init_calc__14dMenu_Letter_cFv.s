...
/* 801DD970  48 00 3D 09 */	bl getLetterNum__14dMenu_Letter_cFv      /* constant-address: 801E1678, symbol: getLetterNum__14dMenu_Letter_cFv */
/* 801DD974  98 7F 03 75 */	stb r3, 0x375(r31)                      
/* 801DD978  38 C0 00 00 */	li r6, 0                                
/* 801DD97C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801DD980  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801DD984  38 A3 01 1C */	addi r5, r3, 0x11c                       /* constant-address: 804062DC, symbol: None */
...
/* 801DD99C  40 80 00 1C */	bge lbl_801DD9B8                         /* constant-address: 801DD9B8, symbol: lbl_801DD9B8 */
...
/* 801DD9B4  48 00 00 0C */	b lbl_801DD9C0                           /* constant-address: 801DD9C0, symbol: lbl_801DD9C0 */
lbl_801DD9B8:
/* 801DD9B8  38 06 03 AC */	addi r0, r6, 0x3ac                       /* constant-address: 000003AC */
/* 801DD9BC  7C 7F 01 AE */	stbx r3, r31, r0                        
lbl_801DD9C0:
/* 801DD9C0  38 C6 00 01 */	addi r6, r6, 1                          
/* 801DD9C4  42 00 FF D0 */	bdnz lbl_801DD994                        /* constant-address: 801DD994, symbol: lbl_801DD994 */
/* 801DD9C8  88 1F 03 75 */	lbz r0, 0x375(r31)                      
/* 801DD9CC  28 00 00 06 */	cmplwi r0, 6                            
/* 801DD9D0  40 80 00 0C */	bge lbl_801DD9DC                         /* constant-address: 801DD9DC, symbol: lbl_801DD9DC */
/* 801DD9D4  98 1F 03 73 */	stb r0, 0x373(r31)                      
/* 801DD9D8  48 00 00 0C */	b lbl_801DD9E4                           /* constant-address: 801DD9E4, symbol: lbl_801DD9E4 */
lbl_801DD9DC:
...
/* 801DD9F8  40 82 00 0C */	bne lbl_801DDA04                         /* constant-address: 801DDA04, symbol: lbl_801DDA04 */
/* 801DD9FC  98 7F 03 74 */	stb r3, 0x374(r31)                      
/* 801DDA00  48 00 00 0C */	b lbl_801DDA0C                           /* constant-address: 801DDA0C, symbol: lbl_801DDA0C */
lbl_801DDA04:

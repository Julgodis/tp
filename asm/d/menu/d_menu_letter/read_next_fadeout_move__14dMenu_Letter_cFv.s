...
/* 801DEAAC  48 18 37 2D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 801DEAB0  7C 7F 1B 78 */	mr r31, r3                              
/* 801DEAB4  3C 60 80 43 */	lis r3, g_drawHIO@ha                    
/* 801DEAB8  38 63 EB C8 */	addi r3, r3, g_drawHIO@l                 /* constant-address: 8042EBC8, symbol: g_drawHIO */
/* 801DEABC  A8 83 07 5C */	lha r4, 0x75c(r3)                        /* constant-address: 8042F324, symbol: None */
...
/* 801DEAD4  41 81 00 74 */	bgt lbl_801DEB48                         /* constant-address: 801DEB48, symbol: lbl_801DEB48 */
...
/* 801DEAF0  C0 22 A8 E0 */	lfs f1, lit_3827(r2)                     /* constant-address: 804542E0, symbol: lit_3827 */
/* 801DEAF4  48 07 6C DD */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DEAF8  80 7D 02 F4 */	lwz r3, 0x2f4(r29)                      
/* 801DEAFC  28 03 00 00 */	cmplwi r3, 0                            
/* 801DEB00  41 82 00 0C */	beq lbl_801DEB0C                         /* constant-address: 801DEB0C, symbol: lbl_801DEB0C */
/* 801DEB04  C0 22 A8 E0 */	lfs f1, lit_3827(r2)                     /* constant-address: 804542E0, symbol: lit_3827 */
/* 801DEB08  48 07 6C C9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_801DEB0C:
/* 801DEB0C  3B 9C 00 01 */	addi r28, r28, 1                        
/* 801DEB10  2C 1C 00 02 */	cmpwi r28, 2                            
/* 801DEB14  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DEB18  41 80 FF D0 */	blt lbl_801DEAE8                         /* constant-address: 801DEAE8, symbol: lbl_801DEAE8 */
/* 801DEB1C  88 1F 03 E4 */	lbz r0, 0x3e4(r31)                      
/* 801DEB20  28 00 00 00 */	cmplwi r0, 0                            
/* 801DEB24  41 82 00 14 */	beq lbl_801DEB38                         /* constant-address: 801DEB38, symbol: lbl_801DEB38 */
/* 801DEB28  88 7F 03 E3 */	lbz r3, 0x3e3(r31)                      
/* 801DEB2C  38 03 00 01 */	addi r0, r3, 1                          
/* 801DEB30  98 1F 03 E3 */	stb r0, 0x3e3(r31)                      
/* 801DEB34  48 00 00 84 */	b lbl_801DEBB8                           /* constant-address: 801DEBB8, symbol: lbl_801DEBB8 */
lbl_801DEB38:
/* 801DEB38  88 7F 03 E3 */	lbz r3, 0x3e3(r31)                      
/* 801DEB3C  38 03 FF FF */	addi r0, r3, -1                         
/* 801DEB40  98 1F 03 E3 */	stb r0, 0x3e3(r31)                      
/* 801DEB44  48 00 00 74 */	b lbl_801DEBB8                           /* constant-address: 801DEBB8, symbol: lbl_801DEBB8 */
lbl_801DEB48:
/* 801DEB48  C8 42 A9 10 */	lfd f2, lit_4171(r2)                     /* constant-address: 80454310, symbol: lit_4171 */
...
/* 801DEB90  48 07 6C 41 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 801DEB94  80 7D 02 F4 */	lwz r3, 0x2f4(r29)                      
/* 801DEB98  28 03 00 00 */	cmplwi r3, 0                            
/* 801DEB9C  41 82 00 0C */	beq lbl_801DEBA8                         /* constant-address: 801DEBA8, symbol: lbl_801DEBA8 */
/* 801DEBA0  FC 20 F8 90 */	fmr f1, f31                             
/* 801DEBA4  48 07 6C 2D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_801DEBA8:
/* 801DEBA8  3B 9C 00 01 */	addi r28, r28, 1                        
/* 801DEBAC  2C 1C 00 02 */	cmpwi r28, 2                            
/* 801DEBB0  3B DE 00 04 */	addi r30, r30, 4                        
/* 801DEBB4  41 80 FF D0 */	blt lbl_801DEB84                         /* constant-address: 801DEB84, symbol: lbl_801DEB84 */
lbl_801DEBB8:
/* 801DEBB8  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */       
/* 801DEBBC  CB E1 00 30 */	lfd f31, 0x30(r1)                       
/* 801DEBC0  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801DEBC4  48 18 36 61 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

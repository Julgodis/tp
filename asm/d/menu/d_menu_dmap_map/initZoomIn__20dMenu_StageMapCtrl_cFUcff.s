...
/* 801C1D68  40 80 00 0C */	bge lbl_801C1D74                         /* constant-address: 801C1D74, symbol: lbl_801C1D74 */
/* 801C1D6C  D0 1E 00 AC */	stfs f0, 0xac(r30)                      
/* 801C1D70  48 00 00 14 */	b lbl_801C1D84                           /* constant-address: 801C1D84, symbol: lbl_801C1D84 */
lbl_801C1D74:
/* 801C1D74  C0 1E 00 CC */	lfs f0, 0xcc(r30)                       
/* 801C1D78  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801C1D7C  40 81 00 08 */	ble lbl_801C1D84                         /* constant-address: 801C1D84, symbol: lbl_801C1D84 */
...
/* 801C1D90  40 80 00 0C */	bge lbl_801C1D9C                         /* constant-address: 801C1D9C, symbol: lbl_801C1D9C */
/* 801C1D94  D0 1E 00 B0 */	stfs f0, 0xb0(r30)                      
/* 801C1D98  48 00 00 14 */	b lbl_801C1DAC                           /* constant-address: 801C1DAC, symbol: lbl_801C1DAC */
lbl_801C1D9C:
/* 801C1D9C  C0 1E 00 D4 */	lfs f0, 0xd4(r30)                       
/* 801C1DA0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801C1DA4  40 81 00 08 */	ble lbl_801C1DAC                         /* constant-address: 801C1DAC, symbol: lbl_801C1DAC */
...
/* 801C1DC8  38 04 CC E4 */	addi r0, r4, init_process@l              /* constant-address: 803BCCE4, symbol: init_process */
/* 801C1DCC  7D 80 2A 14 */	add r12, r0, r5                         
/* 801C1DD0  48 1A 02 B5 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */

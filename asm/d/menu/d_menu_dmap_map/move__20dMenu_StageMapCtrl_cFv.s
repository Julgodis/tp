...
/* 801C2254  3C 80 80 3C */	lis r4, move_process@ha                 
/* 801C2258  38 04 CD 44 */	addi r0, r4, move_process@l              /* constant-address: 803BCD44, symbol: move_process */
/* 801C225C  7D 80 2A 14 */	add r12, r0, r5                         
/* 801C2260  48 19 FE 25 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801C2264  60 00 00 00 */	nop                                     
/* 801C2268  88 1E 00 F5 */	lbz r0, 0xf5(r30)                       
/* 801C226C  7C 00 F8 40 */	cmplw r0, r31                           
/* 801C2270  41 82 00 20 */	beq lbl_801C2290                         /* constant-address: 801C2290, symbol: lbl_801C2290 */
/* 801C2274  7F C3 F3 78 */	mr r3, r30                              
/* 801C2278  1C A0 00 0C */	mulli r5, r0, 0xc                       
/* 801C227C  3C 80 80 3C */	lis r4, init_process@ha                 
/* 801C2280  38 04 CC E4 */	addi r0, r4, init_process@l              /* constant-address: 803BCCE4, symbol: init_process */
/* 801C2284  7D 80 2A 14 */	add r12, r0, r5                         
/* 801C2288  48 19 FD FD */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */

...
/* 801C1008  48 1A 11 C5 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 801C1028  48 00 00 D0 */	b lbl_801C10F8                           /* constant-address: 801C10F8, symbol: lbl_801C10F8 */
lbl_801C102C:
...
/* 801C104C  88 0D 87 E4 */	lbz r0, struct_80450D64+0x0(r13)         /* constant-address: 80450D64, symbol: struct_80450D64+0x0 */
...
/* 801C107C  41 82 00 64 */	beq lbl_801C10E0                         /* constant-address: 801C10E0, symbol: lbl_801C10E0 */
...
/* 801C1094  48 00 00 95 */	bl cnvPosTo2Dpos__20dMenu_StageMapCtrl_cCFffPfPf /* constant-address: 801C1128, symbol: cnvPosTo2Dpos__20dMenu_StageMapCtrl_cCFffPfPf */
/* 801C1098  28 1D 00 00 */	cmplwi r29, 0                           
/* 801C109C  41 82 00 18 */	beq lbl_801C10B4                         /* constant-address: 801C10B4, symbol: lbl_801C10B4 */
...
/* 801C10B8  41 82 00 10 */	beq lbl_801C10C8                         /* constant-address: 801C10C8, symbol: lbl_801C10C8 */
...
/* 801C10CC  41 82 00 10 */	beq lbl_801C10DC                         /* constant-address: 801C10DC, symbol: lbl_801C10DC */
...
/* 801C10E4  4B ED B2 B9 */	bl getNextData__7dTres_cFPQ27dTres_c15typeGroupData_c /* constant-address: 8009C39C, symbol: getNextData__7dTres_cFPQ27dTres_c15typeGroupData_c */
...
/* 801C1100  41 82 00 0C */	beq lbl_801C110C                         /* constant-address: 801C110C, symbol: lbl_801C110C */
/* 801C1104  57 20 06 3F */	clrlwi. r0, r25, 0x18                   
/* 801C1108  41 82 FF 24 */	beq lbl_801C102C                         /* constant-address: 801C102C, symbol: lbl_801C102C */
lbl_801C110C:
/* 801C110C  7F 23 CB 78 */	mr r3, r25                              
/* 801C1110  39 61 00 40 */	addi r11, r1, 0x40                      
/* 801C1114  48 1A 11 05 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 801C236C  48 19 FE 65 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 801C2388  88 0D 87 E4 */	lbz r0, struct_80450D64+0x0(r13)         /* constant-address: 80450D64, symbol: struct_80450D64+0x0 */
...
/* 801C23AC  4B E7 D3 B5 */	bl getTopBottomFloorNo__8dMpath_cFPScPSc /* constant-address: 8003F760, symbol: getTopBottomFloorNo__8dMpath_cFPScPSc */
...
/* 801C23C8  40 81 00 08 */	ble lbl_801C23D0                         /* constant-address: 801C23D0, symbol: lbl_801C23D0 */
/* 801C23CC  98 1A 00 EF */	stb r0, 0xef(r26)                       
lbl_801C23D0:
/* 801C23D0  57 A0 04 3E */	clrlwi r0, r29, 0x10                    
/* 801C23D4  C8 22 A6 B0 */	lfd f1, lit_4170(r2)                     /* constant-address: 804540B0, symbol: lit_4170 */
...
/* 801C2420  4B FF E8 B9 */	bl _create__15dMenu_DmapMap_cFUsUsUsUsPv /* constant-address: 801C0CD8, symbol: _create__15dMenu_DmapMap_cFUsUsUsUsPv */
...
/* 801C2458  C0 42 A6 C8 */	lfs f2, lit_4460(r2)                     /* constant-address: 804540C8, symbol: lit_4460 */
/* 801C245C  C0 0D 89 00 */	lfs f0, mAllSizeX__8dMpath_c(r13)        /* constant-address: 80450E80, symbol: mAllSizeX__8dMpath_c */
/* 801C2460  EC 22 00 32 */	fmuls f1, f2, f0                        
/* 801C2464  C0 0D 89 04 */	lfs f0, mAllSizeZ__8dMpath_c(r13)        /* constant-address: 80450E84, symbol: mAllSizeZ__8dMpath_c */
/* 801C2468  EC 42 00 32 */	fmuls f2, f2, f0                        
/* 801C246C  C0 62 A6 CC */	lfs f3, lit_4461(r2)                     /* constant-address: 804540CC, symbol: lit_4461 */
/* 801C2470  C0 82 A6 D0 */	lfs f4, lit_4462(r2)                     /* constant-address: 804540D0, symbol: lit_4462 */
...
/* 801C24BC  D0 0D 8B 0C */	stfs f0, m_zoomCenterMinX__20dMenu_StageMapCtrl_c(r13) /* constant-address: 8045108C, symbol: m_zoomCenterMinX__20dMenu_StageMapCtrl_c */
/* 801C24C0  C0 1A 00 CC */	lfs f0, 0xcc(r26)                       
/* 801C24C4  D0 0D 8B 10 */	stfs f0, m_zoomCenterMaxX__20dMenu_StageMapCtrl_c(r13) /* constant-address: 80451090, symbol: m_zoomCenterMaxX__20dMenu_StageMapCtrl_c */
/* 801C24C8  C0 1A 00 D0 */	lfs f0, 0xd0(r26)                       
/* 801C24CC  D0 0D 8B 14 */	stfs f0, m_zoomCenterMinZ__20dMenu_StageMapCtrl_c(r13) /* constant-address: 80451094, symbol: m_zoomCenterMinZ__20dMenu_StageMapCtrl_c */
/* 801C24D0  C0 1A 00 D4 */	lfs f0, 0xd4(r26)                       
/* 801C24D4  D0 0D 8B 18 */	stfs f0, m_zoomCenterMaxZ__20dMenu_StageMapCtrl_c(r13) /* constant-address: 80451098, symbol: m_zoomCenterMaxZ__20dMenu_StageMapCtrl_c */
...
/* 801C24F0  38 04 CC E4 */	addi r0, r4, init_process@l              /* constant-address: 803BCCE4, symbol: init_process */
/* 801C24F4  7D 80 2A 14 */	add r12, r0, r5                         
/* 801C24F8  48 19 FB 8D */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801C24FC  60 00 00 00 */	nop                                     
/* 801C2500  39 61 00 30 */	addi r11, r1, 0x30                      
/* 801C2504  48 19 FD 19 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

...
/* 801C2084  41 82 00 64 */	beq lbl_801C20E8                         /* constant-address: 801C20E8, symbol: lbl_801C20E8 */
/* 801C2088  88 1F 00 F8 */	lbz r0, 0xf8(r31)                       
/* 801C208C  28 00 00 00 */	cmplwi r0, 0                            
/* 801C2090  40 82 00 28 */	bne lbl_801C20B8                         /* constant-address: 801C20B8, symbol: lbl_801C20B8 */
/* 801C2094  C0 3F 00 B4 */	lfs f1, 0xb4(r31)                       
/* 801C2098  FC 00 0A 10 */	fabs f0, f1                             
/* 801C209C  FC 40 00 18 */	frsp f2, f0                             
/* 801C20A0  C0 02 A6 C4 */	lfs f0, lit_4395(r2)                     /* constant-address: 804540C4, symbol: lit_4395 */
/* 801C20A4  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 801C20A8  40 81 00 10 */	ble lbl_801C20B8                         /* constant-address: 801C20B8, symbol: lbl_801C20B8 */
...
/* 801C20C0  40 82 00 28 */	bne lbl_801C20E8                         /* constant-address: 801C20E8, symbol: lbl_801C20E8 */
/* 801C20C4  C0 3F 00 B8 */	lfs f1, 0xb8(r31)                       
/* 801C20C8  FC 00 0A 10 */	fabs f0, f1                             
/* 801C20CC  FC 40 00 18 */	frsp f2, f0                             
/* 801C20D0  C0 02 A6 C4 */	lfs f0, lit_4395(r2)                     /* constant-address: 804540C4, symbol: lit_4395 */
/* 801C20D4  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 801C20D8  40 81 00 10 */	ble lbl_801C20E8                         /* constant-address: 801C20E8, symbol: lbl_801C20E8 */
...
/* 801C20F0  40 82 00 34 */	bne lbl_801C2124                         /* constant-address: 801C2124, symbol: lbl_801C2124 */
...
/* 801C2104  40 82 00 08 */	bne lbl_801C210C                         /* constant-address: 801C210C, symbol: lbl_801C210C */
...
/* 801C211C  40 82 00 08 */	bne lbl_801C2124                         /* constant-address: 801C2124, symbol: lbl_801C2124 */
/* 801C2120  D0 3F 00 AC */	stfs f1, 0xac(r31)                      
lbl_801C2124:
/* 801C2124  88 1F 00 F9 */	lbz r0, 0xf9(r31)                       
/* 801C2128  28 00 00 00 */	cmplwi r0, 0                            
/* 801C212C  40 82 00 34 */	bne lbl_801C2160                         /* constant-address: 801C2160, symbol: lbl_801C2160 */
...
/* 801C2140  40 82 00 08 */	bne lbl_801C2148                         /* constant-address: 801C2148, symbol: lbl_801C2148 */
...
/* 801C2158  40 82 00 08 */	bne lbl_801C2160                         /* constant-address: 801C2160, symbol: lbl_801C2160 */
...
/* 801C2170  C0 02 A6 60 */	lfs f0, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
/* 801C2174  D0 1F 00 B4 */	stfs f0, 0xb4(r31)                      
/* 801C2178  D0 1F 00 B8 */	stfs f0, 0xb8(r31)                      
/* 801C217C  7F E3 FB 78 */	mr r3, r31                              
/* 801C2180  4B FF F1 35 */	bl moveFloor__20dMenu_StageMapCtrl_cFv   /* constant-address: 801C12B4, symbol: moveFloor__20dMenu_StageMapCtrl_cFv */

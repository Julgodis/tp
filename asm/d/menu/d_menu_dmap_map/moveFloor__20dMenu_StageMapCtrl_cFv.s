...
/* 801C12D8  40 82 01 88 */	bne lbl_801C1460                         /* constant-address: 801C1460, symbol: lbl_801C1460 */
/* 801C12DC  88 1F 00 F1 */	lbz r0, 0xf1(r31)                       
/* 801C12E0  28 00 00 00 */	cmplwi r0, 0                            
/* 801C12E4  40 82 01 7C */	bne lbl_801C1460                         /* constant-address: 801C1460, symbol: lbl_801C1460 */
/* 801C12E8  88 1F 00 EA */	lbz r0, 0xea(r31)                       
/* 801C12EC  7C 00 07 75 */	extsb. r0, r0                           
/* 801C12F0  41 82 03 DC */	beq lbl_801C16CC                         /* constant-address: 801C16CC, symbol: lbl_801C16CC */
/* 801C12F4  88 1F 00 F0 */	lbz r0, 0xf0(r31)                       
/* 801C12F8  98 1F 00 F3 */	stb r0, 0xf3(r31)                       
/* 801C12FC  C0 42 A6 60 */	lfs f2, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
/* 801C1300  D0 5F 00 90 */	stfs f2, 0x90(r31)                      
/* 801C1304  88 7F 00 EA */	lbz r3, 0xea(r31)                       
/* 801C1308  7C 60 07 75 */	extsb. r0, r3                           
/* 801C130C  40 81 00 A4 */	ble lbl_801C13B0                         /* constant-address: 801C13B0, symbol: lbl_801C13B0 */
...
/* 801C1324  40 80 01 30 */	bge lbl_801C1454                         /* constant-address: 801C1454, symbol: lbl_801C1454 */
/* 801C1328  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C13AC  48 00 00 A8 */	b lbl_801C1454                           /* constant-address: 801C1454, symbol: lbl_801C1454 */
lbl_801C13B0:
/* 801C13B0  7C 60 07 75 */	extsb. r0, r3                           
/* 801C13B4  40 80 00 A0 */	bge lbl_801C1454                         /* constant-address: 801C1454, symbol: lbl_801C1454 */
...
/* 801C13CC  40 81 00 88 */	ble lbl_801C1454                         /* constant-address: 801C1454, symbol: lbl_801C1454 */
/* 801C13D0  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C145C  48 00 02 70 */	b lbl_801C16CC                           /* constant-address: 801C16CC, symbol: lbl_801C16CC */
lbl_801C1460:
/* 801C1460  88 1F 00 F1 */	lbz r0, 0xf1(r31)                       
/* 801C1464  28 00 00 00 */	cmplwi r0, 0                            
/* 801C1468  41 82 02 64 */	beq lbl_801C16CC                         /* constant-address: 801C16CC, symbol: lbl_801C16CC */
/* 801C146C  88 7F 00 EA */	lbz r3, 0xea(r31)                       
/* 801C1470  7C 60 07 75 */	extsb. r0, r3                           
/* 801C1474  41 82 02 58 */	beq lbl_801C16CC                         /* constant-address: 801C16CC, symbol: lbl_801C16CC */
/* 801C1478  7C 60 07 75 */	extsb. r0, r3                           
/* 801C147C  40 81 01 1C */	ble lbl_801C1598                         /* constant-address: 801C1598, symbol: lbl_801C1598 */
...
/* 801C1494  40 80 02 20 */	bge lbl_801C16B4                         /* constant-address: 801C16B4, symbol: lbl_801C16B4 */
/* 801C1498  C0 3F 00 C4 */	lfs f1, 0xc4(r31)                       
/* 801C149C  48 1A AC 61 */	bl floor                                 /* constant-address: 8036C0FC, symbol: floor */
/* 801C14A0  FC 40 08 18 */	frsp f2, f1                             
/* 801C14A4  88 1F 00 E7 */	lbz r0, 0xe7(r31)                       
/* 801C14A8  7C 04 07 74 */	extsb r4, r0                            
/* 801C14AC  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C14CC  40 82 00 20 */	bne lbl_801C14EC                         /* constant-address: 801C14EC, symbol: lbl_801C14EC */
...
/* 801C14E8  41 82 00 14 */	beq lbl_801C14FC                         /* constant-address: 801C14FC, symbol: lbl_801C14FC */
lbl_801C14EC:
/* 801C14EC  C0 3F 00 90 */	lfs f1, 0x90(r31)                       
/* 801C14F0  C0 02 A6 94 */	lfs f0, lit_3837(r2)                     /* constant-address: 80454094, symbol: lit_3837 */
/* 801C14F4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801C14F8  40 81 00 48 */	ble lbl_801C1540                         /* constant-address: 801C1540, symbol: lbl_801C1540 */
lbl_801C14FC:
/* 801C14FC  C0 5F 00 90 */	lfs f2, 0x90(r31)                       
/* 801C1500  88 1F 00 F0 */	lbz r0, 0xf0(r31)                       
/* 801C1504  C8 22 A6 B0 */	lfd f1, lit_4170(r2)                     /* constant-address: 804540B0, symbol: lit_4170 */
...
/* 801C1554  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C1570  C0 02 A6 60 */	lfs f0, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
...
/* 801C1594  48 00 01 20 */	b lbl_801C16B4                           /* constant-address: 801C16B4, symbol: lbl_801C16B4 */
lbl_801C1598:
/* 801C1598  7C 60 07 75 */	extsb. r0, r3                           
/* 801C159C  40 80 01 18 */	bge lbl_801C16B4                         /* constant-address: 801C16B4, symbol: lbl_801C16B4 */
...
/* 801C15B4  40 81 01 00 */	ble lbl_801C16B4                         /* constant-address: 801C16B4, symbol: lbl_801C16B4 */
/* 801C15B8  C0 3F 00 C4 */	lfs f1, 0xc4(r31)                       
/* 801C15BC  48 1A AB 41 */	bl floor                                 /* constant-address: 8036C0FC, symbol: floor */
/* 801C15C0  FC 40 08 18 */	frsp f2, f1                             
/* 801C15C4  88 1F 00 E7 */	lbz r0, 0xe7(r31)                       
/* 801C15C8  7C 04 07 74 */	extsb r4, r0                            
/* 801C15CC  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C15EC  40 82 00 20 */	bne lbl_801C160C                         /* constant-address: 801C160C, symbol: lbl_801C160C */
...
/* 801C1608  41 82 00 14 */	beq lbl_801C161C                         /* constant-address: 801C161C, symbol: lbl_801C161C */
lbl_801C160C:
/* 801C160C  C0 3F 00 90 */	lfs f1, 0x90(r31)                       
/* 801C1610  C0 02 A6 94 */	lfs f0, lit_3837(r2)                     /* constant-address: 80454094, symbol: lit_3837 */
/* 801C1614  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801C1618  40 81 00 48 */	ble lbl_801C1660                         /* constant-address: 801C1660, symbol: lbl_801C1660 */
lbl_801C161C:
/* 801C161C  C0 5F 00 90 */	lfs f2, 0x90(r31)                       
/* 801C1620  88 1F 00 F0 */	lbz r0, 0xf0(r31)                       
/* 801C1624  C8 22 A6 B0 */	lfd f1, lit_4170(r2)                     /* constant-address: 804540B0, symbol: lit_4170 */
...
/* 801C1674  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C1690  C0 02 A6 60 */	lfs f0, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
...
lbl_801C16B4:
/* 801C16B4  C0 02 A6 60 */	lfs f0, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
...
/* 801C16D4  41 82 00 BC */	beq lbl_801C1790                         /* constant-address: 801C1790, symbol: lbl_801C1790 */
/* 801C16D8  88 7F 00 F0 */	lbz r3, 0xf0(r31)                       
/* 801C16DC  88 1F 00 F3 */	lbz r0, 0xf3(r31)                       
/* 801C16E0  7C 00 18 50 */	subf r0, r0, r3                         
/* 801C16E4  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C1700  C8 22 A6 B0 */	lfd f1, lit_4170(r2)                     /* constant-address: 804540B0, symbol: lit_4170 */
...
/* 801C171C  48 1A A7 A1 */	bl ceil                                  /* constant-address: 8036BEBC, symbol: ceil */
...
/* 801C1738  48 1A A7 85 */	bl ceil                                  /* constant-address: 8036BEBC, symbol: ceil */
...
/* 801C1754  48 1A A9 A9 */	bl floor                                 /* constant-address: 8036C0FC, symbol: floor */
/* 801C1758  FC 00 08 18 */	frsp f0, f1                             
/* 801C175C  EC 3F 00 28 */	fsubs f1, f31, f0                       
/* 801C1760  C8 42 A6 A0 */	lfd f2, lit_3947(r2)                     /* constant-address: 804540A0, symbol: lit_3947 */
/* 801C1764  48 1A AF FD */	bl fmod                                  /* constant-address: 8036C760, symbol: fmod */
...
/* 801C1784  40 82 00 0C */	bne lbl_801C1790                         /* constant-address: 801C1790, symbol: lbl_801C1790 */
...
/* 801C1798  41 82 00 C4 */	beq lbl_801C185C                         /* constant-address: 801C185C, symbol: lbl_801C185C */
...
/* 801C17AC  41 82 00 8C */	beq lbl_801C1838                         /* constant-address: 801C1838, symbol: lbl_801C1838 */
/* 801C17B0  88 1F 00 F1 */	lbz r0, 0xf1(r31)                       
/* 801C17B4  28 00 00 00 */	cmplwi r0, 0                            
/* 801C17B8  41 82 00 80 */	beq lbl_801C1838                         /* constant-address: 801C1838, symbol: lbl_801C1838 */
/* 801C17BC  88 9F 00 F0 */	lbz r4, 0xf0(r31)                       
/* 801C17C0  7C 03 20 50 */	subf r0, r3, r4                         
/* 801C17C4  C8 22 A6 A8 */	lfd f1, lit_4168(r2)                     /* constant-address: 804540A8, symbol: lit_4168 */
...
/* 801C17E0  C8 22 A6 B0 */	lfd f1, lit_4170(r2)                     /* constant-address: 804540B0, symbol: lit_4170 */
...
/* 801C17FC  48 1A A6 C1 */	bl ceil                                  /* constant-address: 8036BEBC, symbol: ceil */
...
/* 801C1818  48 1A A6 A5 */	bl ceil                                  /* constant-address: 8036BEBC, symbol: ceil */
...
/* 801C1834  48 00 00 28 */	b lbl_801C185C                           /* constant-address: 801C185C, symbol: lbl_801C185C */
lbl_801C1838:
/* 801C1838  C0 02 A6 60 */	lfs f0, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
/* 801C183C  D0 1F 00 90 */	stfs f0, 0x90(r31)                      
/* 801C1840  C0 3F 00 C4 */	lfs f1, 0xc4(r31)                       
/* 801C1844  48 1A A6 79 */	bl ceil                                  /* constant-address: 8036BEBC, symbol: ceil */

...
/* 801C1B30  C0 02 A6 60 */	lfs f0, lit_3803(r2)                     /* constant-address: 80454060, symbol: lit_3803 */
...
/* 801C1B40  38 84 60 94 */	addi r4, r4, mStatus__20dStage_roomControl_c@l /* constant-address: 803F6094, symbol: mStatus__20dStage_roomControl_c */
...
/* 801C1B5C  41 82 00 10 */	beq lbl_801C1B6C                         /* constant-address: 801C1B6C, symbol: lbl_801C1B6C */
/* 801C1B60  38 81 00 0C */	addi r4, r1, 0xc                        
/* 801C1B64  38 A1 00 08 */	addi r5, r1, 8                          
/* 801C1B68  4B E7 D6 35 */	bl getRoomCenter__10dMapInfo_nFiPfPf     /* constant-address: 8003F19C, symbol: getRoomCenter__10dMapInfo_nFiPfPf */
lbl_801C1B6C:
/* 801C1B6C  28 1E 00 00 */	cmplwi r30, 0                           
/* 801C1B70  41 82 00 0C */	beq lbl_801C1B7C                         /* constant-address: 801C1B7C, symbol: lbl_801C1B7C */
/* 801C1B74  C0 01 00 0C */	lfs f0, 0xc(r1)                         
/* 801C1B78  D0 1E 00 00 */	stfs f0, 0(r30)                         
lbl_801C1B7C:
/* 801C1B7C  28 1F 00 00 */	cmplwi r31, 0                           
/* 801C1B80  41 82 00 0C */	beq lbl_801C1B8C                         /* constant-address: 801C1B8C, symbol: lbl_801C1B8C */

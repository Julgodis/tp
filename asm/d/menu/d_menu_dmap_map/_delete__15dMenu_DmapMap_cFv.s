...
/* 801C0D14  48 1A 14 C5 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 801C0D30  41 82 00 08 */	beq lbl_801C0D38                         /* constant-address: 801C0D38, symbol: lbl_801C0D38 */
/* 801C0D34  48 10 E0 2D */	bl __dla__FPv                            /* constant-address: 802CED60, symbol: __dla__FPv */
lbl_801C0D38:
/* 801C0D38  80 7E 00 74 */	lwz r3, 0x74(r30)                       
/* 801C0D3C  28 03 00 00 */	cmplwi r3, 0                            
/* 801C0D40  41 82 00 08 */	beq lbl_801C0D48                         /* constant-address: 801C0D48, symbol: lbl_801C0D48 */
/* 801C0D44  48 10 E0 1D */	bl __dla__FPv                            /* constant-address: 802CED60, symbol: __dla__FPv */
lbl_801C0D48:
/* 801C0D48  3B BD 00 01 */	addi r29, r29, 1                        
/* 801C0D4C  2C 1D 00 02 */	cmpwi r29, 2                            
/* 801C0D50  3B FF 00 04 */	addi r31, r31, 4                        
/* 801C0D54  41 80 FF D0 */	blt lbl_801C0D24                         /* constant-address: 801C0D24, symbol: lbl_801C0D24 */
/* 801C0D58  39 61 00 20 */	addi r11, r1, 0x20                      
/* 801C0D5C  48 1A 14 C9 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 801BFA0C  40 82 00 18 */	bne lbl_801BFA24                         /* constant-address: 801BFA24, symbol: lbl_801BFA24 */
/* 801BFA10  88 03 0D D5 */	lbz r0, 0xdd5(r3)                       
/* 801BFA14  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801BFA18  40 82 00 0C */	bne lbl_801BFA24                         /* constant-address: 801BFA24, symbol: lbl_801BFA24 */
/* 801BFA1C  80 7E 00 F0 */	lwz r3, 0xf0(r30)                       
/* 801BFA20  4B E7 27 7D */	bl checkTrigger__9STControlFv            /* constant-address: 8003219C, symbol: checkTrigger__9STControlFv */
lbl_801BFA24:
...
/* 801BFA34  38 04 C9 9C */	addi r0, r4, floor_move_process@l        /* constant-address: 803BC99C, symbol: floor_move_process */
/* 801BFA38  7D 80 2A 14 */	add r12, r0, r5                         
/* 801BFA3C  48 1A 26 49 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801BFA40  60 00 00 00 */	nop                                     
/* 801BFA44  88 1E 01 7D */	lbz r0, 0x17d(r30)                      
/* 801BFA48  7C 00 F8 40 */	cmplw r0, r31                           
/* 801BFA4C  41 82 00 20 */	beq lbl_801BFA6C                         /* constant-address: 801BFA6C, symbol: lbl_801BFA6C */
/* 801BFA50  7F C3 F3 78 */	mr r3, r30                              
/* 801BFA54  1C A0 00 0C */	mulli r5, r0, 0xc                       
/* 801BFA58  3C 80 80 3C */	lis r4, floor_init_process@ha           
/* 801BFA5C  38 04 C9 6C */	addi r0, r4, floor_init_process@l        /* constant-address: 803BC96C, symbol: floor_init_process */
/* 801BFA60  7D 80 2A 14 */	add r12, r0, r5                         
/* 801BFA64  48 1A 26 21 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */

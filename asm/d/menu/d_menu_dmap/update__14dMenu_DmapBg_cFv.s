...
/* 801BB354  41 82 00 C0 */	beq lbl_801BB414                         /* constant-address: 801BB414, symbol: lbl_801BB414 */
/* 801BB358  88 03 00 0C */	lbz r0, 0xc(r3)                         
/* 801BB35C  2C 00 00 00 */	cmpwi r0, 0                             
/* 801BB360  41 82 00 B4 */	beq lbl_801BB414                         /* constant-address: 801BB414, symbol: lbl_801BB414 */
/* 801BB364  80 1F 0D 20 */	lwz r0, 0xd20(r31)                      
/* 801BB368  28 00 00 00 */	cmplwi r0, 0                            
/* 801BB36C  40 82 00 A8 */	bne lbl_801BB414                         /* constant-address: 801BB414, symbol: lbl_801BB414 */
...
/* 801BB380  41 82 00 18 */	beq lbl_801BB398                         /* constant-address: 801BB398, symbol: lbl_801BB398 */
...
/* 801BB3A8  38 84 57 60 */	addi r4, r4, d_menu_d_menu_dmap__stringBase0@l /* constant-address: 80395760, symbol: d_menu_d_menu_dmap__stringBase0 */
/* 801BB3AC  38 84 00 AD */	addi r4, r4, 0xad                        /* constant-address: 8039580D, symbol: None */
...
/* 801BB3C8  48 11 38 85 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 801BB3CC  7C 60 1B 79 */	or. r0, r3, r3                          
/* 801BB3D0  41 82 00 10 */	beq lbl_801BB3E0                         /* constant-address: 801BB3E0, symbol: lbl_801BB3E0 */
/* 801BB3D4  7F C4 F3 78 */	mr r4, r30                              
/* 801BB3D8  48 14 13 31 */	bl __ct__10J2DPictureFPC7ResTIMG         /* constant-address: 802FC708, symbol: __ct__10J2DPictureFPC7ResTIMG */
...
/* 801BB3EC  38 84 57 60 */	addi r4, r4, d_menu_d_menu_dmap__stringBase0@l /* constant-address: 80395760, symbol: d_menu_d_menu_dmap__stringBase0 */
/* 801BB3F0  38 84 00 B8 */	addi r4, r4, 0xb8                        /* constant-address: 80395818, symbol: None */
...
/* 801BB410  4B E4 81 31 */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
lbl_801BB414:
/* 801BB414  80 1F 0D 24 */	lwz r0, 0xd24(r31)                      
/* 801BB418  28 00 00 00 */	cmplwi r0, 0                            
/* 801BB41C  41 82 00 30 */	beq lbl_801BB44C                         /* constant-address: 801BB44C, symbol: lbl_801BB44C */
/* 801BB420  C0 5F 0D BC */	lfs f2, 0xdbc(r31)                      
/* 801BB424  C0 22 A6 20 */	lfs f1, lit_4643(r2)                     /* constant-address: 80454020, symbol: lit_4643 */
/* 801BB428  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 801BB42C  40 80 00 20 */	bge lbl_801BB44C                         /* constant-address: 801BB44C, symbol: lbl_801BB44C */
/* 801BB430  C0 02 A6 40 */	lfs f0, lit_4848(r2)                     /* constant-address: 80454040, symbol: lit_4848 */
...
/* 801BB444  40 81 00 08 */	ble lbl_801BB44C                         /* constant-address: 801BB44C, symbol: lbl_801BB44C */

...
/* 801C0448  41 82 00 48 */	beq lbl_801C0490                         /* constant-address: 801C0490, symbol: lbl_801C0490 */
/* 801C044C  3C 60 80 3C */	lis r3, __vt__20dMenu_StageMapCtrl_c@ha 
/* 801C0450  38 03 CA EC */	addi r0, r3, __vt__20dMenu_StageMapCtrl_c@l /* constant-address: 803BCAEC, symbol: __vt__20dMenu_StageMapCtrl_c */
/* 801C0454  90 1E 00 00 */	stw r0, 0(r30)                          
/* 801C0458  41 82 00 28 */	beq lbl_801C0480                         /* constant-address: 801C0480, symbol: lbl_801C0480 */
/* 801C045C  3C 60 80 3C */	lis r3, __vt__15dMenu_DmapMap_c@ha      
/* 801C0460  38 03 CA E0 */	addi r0, r3, __vt__15dMenu_DmapMap_c@l   /* constant-address: 803BCAE0, symbol: __vt__15dMenu_DmapMap_c */
...
/* 801C0470  38 84 03 80 */	addi r4, r4, __dt__15renderingDmap_cFv@l /* constant-address: 801C0380, symbol: __dt__15renderingDmap_cFv */
/* 801C0474  38 A0 00 38 */	li r5, 0x38                             
/* 801C0478  38 C0 00 02 */	li r6, 2                                
/* 801C047C  48 1A 18 6D */	bl __destroy_arr                         /* constant-address: 80361CE8, symbol: __destroy_arr */
lbl_801C0480:
/* 801C0480  7F E0 07 35 */	extsh. r0, r31                          
/* 801C0484  40 81 00 0C */	ble lbl_801C0490                         /* constant-address: 801C0490, symbol: lbl_801C0490 */
/* 801C0488  7F C3 F3 78 */	mr r3, r30                              
/* 801C048C  48 10 E8 B1 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_801C0490:

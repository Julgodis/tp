...
/* 801BB49C  38 09 CB 10 */	addi r0, r9, __vt__12dMenu_Dmap_c@l      /* constant-address: 803BCB10, symbol: __vt__12dMenu_Dmap_c */
/* 801BB4A0  90 03 00 00 */	stw r0, 0(r3)                           
/* 801BB4A4  39 40 00 00 */	li r10, 0                               
/* 801BB4A8  3D 20 80 43 */	lis r9, g_meter2_info@ha                
/* 801BB4AC  39 29 01 88 */	addi r9, r9, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 801BB4B0  99 49 00 F2 */	stb r10, 0xf2(r9)                        /* constant-address: 8043027A, symbol: None */
/* 801BB4B4  90 6D 8B 00 */	stw r3, myclass__12dMenu_Dmap_c(r13)     /* constant-address: 80451080, symbol: myclass__12dMenu_Dmap_c */
...
/* 801BB4F8  42 00 FF F4 */	bdnz lbl_801BB4EC                        /* constant-address: 801BB4EC, symbol: lbl_801BB4EC */
...
/* 801BB520  42 00 FF EC */	bdnz lbl_801BB50C                        /* constant-address: 801BB50C, symbol: lbl_801BB50C */
...
/* 801BB540  42 00 FF F4 */	bdnz lbl_801BB534                        /* constant-address: 801BB534, symbol: lbl_801BB534 */
...
/* 801BB568  42 00 FF F0 */	bdnz lbl_801BB558                        /* constant-address: 801BB558, symbol: lbl_801BB558 */
/* 801BB56C  38 00 00 00 */	li r0, 0                                
/* 801BB570  90 03 00 98 */	stw r0, 0x98(r3)                        
/* 801BB574  90 03 00 04 */	stw r0, 4(r3)                           
/* 801BB578  C0 22 A5 E8 */	lfs f1, lit_3962(r2)                     /* constant-address: 80453FE8, symbol: lit_3962 */
...
/* 801BB590  40 82 00 14 */	bne lbl_801BB5A4                         /* constant-address: 801BB5A4, symbol: lbl_801BB5A4 */
/* 801BB594  C0 02 A6 44 */	lfs f0, lit_4926(r2)                     /* constant-address: 80454044, symbol: lit_4926 */
/* 801BB598  D0 03 01 04 */	stfs f0, 0x104(r3)                      
/* 801BB59C  D0 23 01 08 */	stfs f1, 0x108(r3)                      
/* 801BB5A0  48 00 00 54 */	b lbl_801BB5F4                           /* constant-address: 801BB5F4, symbol: lbl_801BB5F4 */
lbl_801BB5A4:
/* 801BB5A4  28 00 00 03 */	cmplwi r0, 3                            
/* 801BB5A8  40 82 00 14 */	bne lbl_801BB5BC                         /* constant-address: 801BB5BC, symbol: lbl_801BB5BC */
/* 801BB5AC  C0 02 A6 24 */	lfs f0, lit_4784(r2)                     /* constant-address: 80454024, symbol: lit_4784 */
/* 801BB5B0  D0 03 01 04 */	stfs f0, 0x104(r3)                      
/* 801BB5B4  D0 23 01 08 */	stfs f1, 0x108(r3)                      
/* 801BB5B8  48 00 00 3C */	b lbl_801BB5F4                           /* constant-address: 801BB5F4, symbol: lbl_801BB5F4 */
lbl_801BB5BC:
/* 801BB5BC  28 00 00 02 */	cmplwi r0, 2                            
/* 801BB5C0  40 82 00 14 */	bne lbl_801BB5D4                         /* constant-address: 801BB5D4, symbol: lbl_801BB5D4 */
/* 801BB5C4  D0 23 01 04 */	stfs f1, 0x104(r3)                      
/* 801BB5C8  C0 02 A6 48 */	lfs f0, lit_4927(r2)                     /* constant-address: 80454048, symbol: lit_4927 */
/* 801BB5CC  D0 03 01 08 */	stfs f0, 0x108(r3)                      
/* 801BB5D0  48 00 00 24 */	b lbl_801BB5F4                           /* constant-address: 801BB5F4, symbol: lbl_801BB5F4 */
lbl_801BB5D4:
/* 801BB5D4  28 00 00 00 */	cmplwi r0, 0                            
/* 801BB5D8  40 82 00 14 */	bne lbl_801BB5EC                         /* constant-address: 801BB5EC, symbol: lbl_801BB5EC */
/* 801BB5DC  D0 23 01 04 */	stfs f1, 0x104(r3)                      
/* 801BB5E0  C0 02 A6 28 */	lfs f0, lit_4785(r2)                     /* constant-address: 80454028, symbol: lit_4785 */
/* 801BB5E4  D0 03 01 08 */	stfs f0, 0x108(r3)                      
/* 801BB5E8  48 00 00 0C */	b lbl_801BB5F4                           /* constant-address: 801BB5F4, symbol: lbl_801BB5F4 */
lbl_801BB5EC:
/* 801BB5EC  D0 23 01 04 */	stfs f1, 0x104(r3)                      
/* 801BB5F0  D0 23 01 08 */	stfs f1, 0x108(r3)                      
lbl_801BB5F4:
/* 801BB5F4  C0 02 A5 E8 */	lfs f0, lit_3962(r2)                     /* constant-address: 80453FE8, symbol: lit_3962 */

...
/* 801C0258  80 6D 8D E8 */	lwz r3, mAudioMgrPtr__10Z2AudioMgr(r13)  /* constant-address: 80451368, symbol: mAudioMgrPtr__10Z2AudioMgr */
/* 801C025C  38 81 00 08 */	addi r4, r1, 8                          
/* 801C0260  38 A0 00 00 */	li r5, 0                                
/* 801C0264  38 C0 00 00 */	li r6, 0                                
/* 801C0268  38 E0 00 00 */	li r7, 0                                
/* 801C026C  C0 22 A5 EC */	lfs f1, lit_3963(r2)                     /* constant-address: 80453FEC, symbol: lit_3963 */
/* 801C0270  FC 40 08 90 */	fmr f2, f1                              
/* 801C0274  C0 62 A6 5C */	lfs f3, lit_6181(r2)                     /* constant-address: 8045405C, symbol: lit_6181 */
/* 801C0278  FC 80 18 90 */	fmr f4, f3                              
/* 801C027C  39 00 00 00 */	li r8, 0                                
/* 801C0280  48 0E B7 05 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc /* constant-address: 802AB984, symbol: seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc */
/* 801C0284  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 801C0288  38 80 00 0A */	li r4, 0xa                              
/* 801C028C  48 00 1C A1 */	bl initZoomOut__20dMenu_StageMapCtrl_cFUc /* constant-address: 801C1F2C, symbol: initZoomOut__20dMenu_StageMapCtrl_cFUc */
/* 801C0290  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 801C0294  C0 22 A5 EC */	lfs f1, lit_3963(r2)                     /* constant-address: 80453FEC, symbol: lit_3963 */
/* 801C0298  C0 42 A5 E8 */	lfs f2, lit_3962(r2)                     /* constant-address: 80453FE8, symbol: lit_3962 */
/* 801C029C  38 80 00 0A */	li r4, 0xa                              
/* 801C02A0  4B FF 86 9D */	bl iconScaleAnmInit__14dMenu_DmapBg_cFffUc /* constant-address: 801B893C, symbol: iconScaleAnmInit__14dMenu_DmapBg_cFffUc */
...
/* 801C02B8  40 82 00 18 */	bne lbl_801C02D0                         /* constant-address: 801C02D0, symbol: lbl_801C02D0 */
/* 801C02BC  88 03 00 F9 */	lbz r0, 0xf9(r3)                        
/* 801C02C0  28 00 00 01 */	cmplwi r0, 1                            
/* 801C02C4  40 82 00 0C */	bne lbl_801C02D0                         /* constant-address: 801C02D0, symbol: lbl_801C02D0 */

...
/* 801C9520  C0 02 A7 24 */	lfs f0, lit_3995(r2)                     /* constant-address: 80454124, symbol: lit_3995 */
...
/* 801C953C  48 00 33 21 */	bl setTitleName__12dMenu_Fmap_cFUl       /* constant-address: 801CC85C, symbol: setTitleName__12dMenu_Fmap_cFUl */
...
/* 801C9550  40 82 00 10 */	bne lbl_801C9560                         /* constant-address: 801C9560, symbol: lbl_801C9560 */
/* 801C9554  7F E3 FB 78 */	mr r3, r31                              
/* 801C9558  48 00 33 55 */	bl setAreaNameZero__12dMenu_Fmap_cFv     /* constant-address: 801CC8AC, symbol: setAreaNameZero__12dMenu_Fmap_cFv */
/* 801C955C  48 00 00 20 */	b lbl_801C957C                           /* constant-address: 801C957C, symbol: lbl_801C957C */
lbl_801C9560:
...
/* 801C9578  48 00 33 09 */	bl setAreaName__12dMenu_Fmap_cFUl        /* constant-address: 801CC880, symbol: setAreaName__12dMenu_Fmap_cFUl */
lbl_801C957C:
...
/* 801C95A4  C0 22 A7 28 */	lfs f1, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C95A8  48 00 E1 6D */	bl setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf /* constant-address: 801D7714, symbol: setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf */
/* 801C95AC  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C95B0  38 80 00 02 */	li r4, 2                                
/* 801C95B4  C0 22 A7 28 */	lfs f1, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C95B8  48 00 E1 5D */	bl setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf /* constant-address: 801D7714, symbol: setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf */
/* 801C95BC  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C95C0  38 80 05 22 */	li r4, 0x522                            
/* 801C95C4  38 A0 00 FF */	li r5, 0xff                             
/* 801C95C8  48 00 DC 49 */	bl setBButtonString__17dMenu_Fmap2DTop_cFUlUc /* constant-address: 801D7210, symbol: setBButtonString__17dMenu_Fmap2DTop_cFUlUc */
/* 801C95CC  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C95D0  38 80 00 00 */	li r4, 0                                
/* 801C95D4  38 A0 00 FF */	li r5, 0xff                             
/* 801C95D8  48 00 DC FD */	bl setAButtonString__17dMenu_Fmap2DTop_cFUlUc /* constant-address: 801D72D4, symbol: setAButtonString__17dMenu_Fmap2DTop_cFUlUc */
/* 801C95DC  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C95E0  38 80 05 29 */	li r4, 0x529                            
/* 801C95E4  38 A0 00 FF */	li r5, 0xff                             
/* 801C95E8  48 00 DB 01 */	bl setZButtonString__17dMenu_Fmap2DTop_cFUlUc /* constant-address: 801D70E8, symbol: setZButtonString__17dMenu_Fmap2DTop_cFUlUc */
/* 801C95EC  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C95F0  38 80 05 28 */	li r4, 0x528                            
/* 801C95F4  48 00 DE F9 */	bl set3DStickString__17dMenu_Fmap2DTop_cFUl /* constant-address: 801D74EC, symbol: set3DStickString__17dMenu_Fmap2DTop_cFUl */
/* 801C95F8  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C95FC  38 80 03 F9 */	li r4, 0x3f9                            
/* 801C9600  48 00 DD 99 */	bl setCrossLRString__17dMenu_Fmap2DTop_cFUl /* constant-address: 801D7398, symbol: setCrossLRString__17dMenu_Fmap2DTop_cFUl */

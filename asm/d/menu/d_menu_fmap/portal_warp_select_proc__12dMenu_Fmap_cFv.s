...
/* 801C90C8  48 07 47 11 */	bl move__17dMsgScrnExplain_cFv           /* constant-address: 8023D7D8, symbol: move__17dMsgScrnExplain_cFv */
...
/* 801C90DC  40 82 00 D0 */	bne lbl_801C91AC                         /* constant-address: 801C91AC, symbol: lbl_801C91AC */
/* 801C90E0  48 00 E5 E1 */	bl deleteExplain__17dMenu_Fmap2DTop_cFv  /* constant-address: 801D76C0, symbol: deleteExplain__17dMenu_Fmap2DTop_cFv */
/* 801C90E4  3C 60 80 43 */	lis r3, g_meter2_info@ha                
/* 801C90E8  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 801C90EC  88 03 00 C0 */	lbz r0, 0xc0(r3)                         /* constant-address: 80430248, symbol: None */
/* 801C90F0  28 00 00 03 */	cmplwi r0, 3                            
/* 801C90F4  40 82 00 90 */	bne lbl_801C9184                         /* constant-address: 801C9184, symbol: lbl_801C9184 */
...
/* 801C9160  48 05 3A AD */	bl setWarpInfo__13dMeter2Info_cFPCcRC4cXyzsUcUcUc /* constant-address: 8021CC0C, symbol: setWarpInfo__13dMeter2Info_cFPCcRC4cXyzsUcUcUc */
/* 801C9164  88 1F 03 08 */	lbz r0, 0x308(r31)                      
/* 801C9168  1C 00 00 1C */	mulli r0, r0, 0x1c                      
/* 801C916C  7C 7E 00 AE */	lbzx r3, r30, r0                        
/* 801C9170  4B E6 69 3D */	bl dComIfGp_SelectWarpPt_set__FUc        /* constant-address: 8002FAAC, symbol: dComIfGp_SelectWarpPt_set__FUc */
/* 801C9174  7F E3 FB 78 */	mr r3, r31                              
/* 801C9178  38 80 00 08 */	li r4, 8                                
/* 801C917C  48 00 25 55 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
/* 801C9180  48 00 00 2C */	b lbl_801C91AC                           /* constant-address: 801C91AC, symbol: lbl_801C91AC */
lbl_801C9184:
/* 801C9184  88 1F 03 01 */	lbz r0, 0x301(r31)                      
/* 801C9188  28 00 00 10 */	cmplwi r0, 0x10                         
/* 801C918C  40 82 00 14 */	bne lbl_801C91A0                         /* constant-address: 801C91A0, symbol: lbl_801C91A0 */
/* 801C9190  7F E3 FB 78 */	mr r3, r31                              
/* 801C9194  38 80 00 10 */	li r4, 0x10                             
/* 801C9198  48 00 25 39 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
/* 801C919C  48 00 00 10 */	b lbl_801C91AC                           /* constant-address: 801C91AC, symbol: lbl_801C91AC */
lbl_801C91A0:
/* 801C91A0  7F E3 FB 78 */	mr r3, r31                              
/* 801C91A4  38 80 00 08 */	li r4, 8                                
/* 801C91A8  48 00 25 29 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
lbl_801C91AC:
...
/* 801C91BC  48 00 25 25 */	bl setFlash__12dMenu_Fmap_cFUcb          /* constant-address: 801CB6E0, symbol: setFlash__12dMenu_Fmap_cFUcb */

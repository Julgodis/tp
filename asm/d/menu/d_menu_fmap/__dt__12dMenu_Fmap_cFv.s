...
/* 801C6AD8  48 19 B6 FD */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 801C6ADC  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 801C6AE0  7C 9F 23 78 */	mr r31, r4                              
/* 801C6AE4  41 82 02 64 */	beq lbl_801C6D48                         /* constant-address: 801C6D48, symbol: lbl_801C6D48 */
/* 801C6AE8  3C 60 80 3C */	lis r3, __vt__12dMenu_Fmap_c@ha         
/* 801C6AEC  38 03 D6 64 */	addi r0, r3, __vt__12dMenu_Fmap_c@l      /* constant-address: 803BD664, symbol: __vt__12dMenu_Fmap_c */
/* 801C6AF0  90 1E 00 00 */	stw r0, 0(r30)                          
/* 801C6AF4  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 801C6AF8  48 10 7C 8D */	bl getTotalFreeSize__7JKRHeapFv          /* constant-address: 802CE784, symbol: getTotalFreeSize__7JKRHeapFv */
/* 801C6AFC  80 9E 00 8C */	lwz r4, 0x8c(r30)                       
/* 801C6B00  28 04 00 00 */	cmplwi r4, 0                            
/* 801C6B04  41 82 00 14 */	beq lbl_801C6B18                         /* constant-address: 801C6B18, symbol: lbl_801C6B18 */
/* 801C6B08  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 801C6B0C  48 10 7A 3D */	bl free__7JKRHeapFPv                     /* constant-address: 802CE548, symbol: free__7JKRHeapFPv */
...
/* 801C6B20  41 82 00 14 */	beq lbl_801C6B34                         /* constant-address: 801C6B34, symbol: lbl_801C6B34 */
/* 801C6B24  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 801C6B28  48 10 7A 21 */	bl free__7JKRHeapFPv                     /* constant-address: 802CE548, symbol: free__7JKRHeapFPv */
...
/* 801C6B40  40 82 00 34 */	bne lbl_801C6B74                         /* constant-address: 801C6B74, symbol: lbl_801C6B74 */
/* 801C6B44  3B 9D 00 94 */	addi r28, r29, 0x94                     
/* 801C6B48  7C 9E E0 2E */	lwzx r4, r30, r28                       
/* 801C6B4C  28 04 00 00 */	cmplwi r4, 0                            
/* 801C6B50  41 82 00 18 */	beq lbl_801C6B68                         /* constant-address: 801C6B68, symbol: lbl_801C6B68 */
...
/* 801C6B70  48 00 00 34 */	b lbl_801C6BA4                           /* constant-address: 801C6BA4, symbol: lbl_801C6BA4 */
lbl_801C6B74:
/* 801C6B74  3B 9D 00 94 */	addi r28, r29, 0x94                      /* constant-address: 00000094 */
/* 801C6B78  7C 9E E0 2E */	lwzx r4, r30, r28                       
/* 801C6B7C  28 04 00 00 */	cmplwi r4, 0                            
/* 801C6B80  41 82 00 24 */	beq lbl_801C6BA4                         /* constant-address: 801C6BA4, symbol: lbl_801C6BA4 */
...
/* 801C6BB0  41 80 FF 8C */	blt lbl_801C6B3C                         /* constant-address: 801C6B3C, symbol: lbl_801C6B3C */
/* 801C6BB4  7F C3 F3 78 */	mr r3, r30                              
/* 801C6BB8  48 00 5A 65 */	bl removeAreaData__12dMenu_Fmap_cFv      /* constant-address: 801CC61C, symbol: removeAreaData__12dMenu_Fmap_cFv */
/* 801C6BBC  80 7E 00 14 */	lwz r3, 0x14(r30)                       
/* 801C6BC0  28 03 00 00 */	cmplwi r3, 0                            
/* 801C6BC4  41 82 00 24 */	beq lbl_801C6BE8                         /* constant-address: 801C6BE8, symbol: lbl_801C6BE8 */
/* 801C6BC8  41 82 00 18 */	beq lbl_801C6BE0                         /* constant-address: 801C6BE0, symbol: lbl_801C6BE0 */
...
/* 801C6BF0  41 82 00 24 */	beq lbl_801C6C14                         /* constant-address: 801C6C14, symbol: lbl_801C6C14 */
/* 801C6BF4  41 82 00 18 */	beq lbl_801C6C0C                         /* constant-address: 801C6C0C, symbol: lbl_801C6C0C */
...
/* 801C6C1C  41 82 00 30 */	beq lbl_801C6C4C                         /* constant-address: 801C6C4C, symbol: lbl_801C6C4C */
/* 801C6C20  48 00 82 1D */	bl _delete__15dMenu_FmapMap_cFv          /* constant-address: 801CEE3C, symbol: _delete__15dMenu_FmapMap_cFv */
/* 801C6C24  80 7E 00 B8 */	lwz r3, 0xb8(r30)                       
/* 801C6C28  28 03 00 00 */	cmplwi r3, 0                            
/* 801C6C2C  41 82 00 18 */	beq lbl_801C6C44                         /* constant-address: 801C6C44, symbol: lbl_801C6C44 */
...
lbl_801C6C4C:
/* 801C6C4C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801C6C50  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801C6C54  80 63 5C BC */	lwz r3, 0x5cbc(r3)                       /* constant-address: 8040BE7C, symbol: None */
...
/* 801C6C70  41 82 00 14 */	beq lbl_801C6C84                         /* constant-address: 801C6C84, symbol: lbl_801C6C84 */
...
/* 801C6C88  90 0D 8B 2C */	stw r0, MyClass__12dMenu_Fmap_c(r13)     /* constant-address: 804510AC, symbol: MyClass__12dMenu_Fmap_c */
/* 801C6C8C  80 1E 00 08 */	lwz r0, 8(r30)                          
/* 801C6C90  28 00 00 00 */	cmplwi r0, 0                            
/* 801C6C94  41 82 00 2C */	beq lbl_801C6CC0                         /* constant-address: 801C6CC0, symbol: lbl_801C6CC0 */
/* 801C6C98  48 07 0E BD */	bl getTalkHeap__12dMsgObject_cFv         /* constant-address: 80237B54, symbol: getTalkHeap__12dMsgObject_cFv */
/* 801C6C9C  80 1E 00 08 */	lwz r0, 8(r30)                          
/* 801C6CA0  7C 03 00 40 */	cmplw r3, r0                            
/* 801C6CA4  40 82 00 0C */	bne lbl_801C6CB0                         /* constant-address: 801C6CB0, symbol: lbl_801C6CB0 */
/* 801C6CA8  38 60 00 00 */	li r3, 0                                
/* 801C6CAC  48 07 0E 35 */	bl setTalkHeap__12dMsgObject_cFPv        /* constant-address: 80237AE0, symbol: setTalkHeap__12dMsgObject_cFPv */
lbl_801C6CB0:
/* 801C6CB0  80 7E 00 08 */	lwz r3, 8(r30)                          
/* 801C6CB4  4B E4 84 F9 */	bl mDoExt_destroyExpHeap__FP10JKRExpHeap /* constant-address: 8000F1AC, symbol: mDoExt_destroyExpHeap__FP10JKRExpHeap */
...
/* 801C6CC8  41 82 00 40 */	beq lbl_801C6D08                         /* constant-address: 801C6D08, symbol: lbl_801C6D08 */
...
/* 801C6CE8  41 82 00 18 */	beq lbl_801C6D00                         /* constant-address: 801C6D00, symbol: lbl_801C6D00 */
...
/* 801C6D10  41 82 00 1C */	beq lbl_801C6D2C                         /* constant-address: 801C6D2C, symbol: lbl_801C6D2C */
...
/* 801C6D34  48 08 32 15 */	bl __dt__10dMsgFlow_cFv                  /* constant-address: 80249F48, symbol: __dt__10dMsgFlow_cFv */
/* 801C6D38  7F E0 07 35 */	extsh. r0, r31                          
/* 801C6D3C  40 81 00 0C */	ble lbl_801C6D48                         /* constant-address: 801C6D48, symbol: lbl_801C6D48 */
/* 801C6D40  7F C3 F3 78 */	mr r3, r30                              
/* 801C6D44  48 10 7F F9 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_801C6D48:
/* 801C6D48  7F C3 F3 78 */	mr r3, r30                              
/* 801C6D4C  39 61 00 20 */	addi r11, r1, 0x20                      
/* 801C6D50  48 19 B4 D1 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 801CAAE4  40 82 00 38 */	bne lbl_801CAB1C                         /* constant-address: 801CAB1C, symbol: lbl_801CAB1C */
/* 801CAAE8  38 00 00 BC */	li r0, 0xbc                             
/* 801CAAEC  90 01 00 08 */	stw r0, 8(r1)                           
/* 801CAAF0  80 6D 8D E8 */	lwz r3, mAudioMgrPtr__10Z2AudioMgr(r13)  /* constant-address: 80451368, symbol: mAudioMgrPtr__10Z2AudioMgr */
/* 801CAAF4  38 81 00 08 */	addi r4, r1, 8                          
/* 801CAAF8  38 A0 00 00 */	li r5, 0                                
/* 801CAAFC  38 C0 00 00 */	li r6, 0                                
/* 801CAB00  38 E0 00 00 */	li r7, 0                                
/* 801CAB04  C0 22 A7 24 */	lfs f1, lit_3995(r2)                     /* constant-address: 80454124, symbol: lit_3995 */
/* 801CAB08  FC 40 08 90 */	fmr f2, f1                              
/* 801CAB0C  C0 62 A7 54 */	lfs f3, lit_4541(r2)                     /* constant-address: 80454154, symbol: lit_4541 */
/* 801CAB10  FC 80 18 90 */	fmr f4, f3                              
/* 801CAB14  39 00 00 00 */	li r8, 0                                
/* 801CAB18  48 0E 0E 6D */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc /* constant-address: 802AB984, symbol: seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc */
lbl_801CAB1C:
/* 801CAB1C  A8 7F 02 14 */	lha r3, 0x214(r31)                      
/* 801CAB20  7C 60 07 35 */	extsh. r0, r3                           
/* 801CAB24  40 81 00 50 */	ble lbl_801CAB74                         /* constant-address: 801CAB74, symbol: lbl_801CAB74 */
/* 801CAB28  C8 22 A7 40 */	lfd f1, lit_4358(r2)                     /* constant-address: 80454140, symbol: lit_4358 */
...
/* 801CAB44  C0 02 A7 3C */	lfs f0, lit_4353(r2)                     /* constant-address: 8045413C, symbol: lit_4353 */
...
/* 801CAB58  48 00 69 21 */	bl zoomMapCalc2__18dMenu_Fmap2DBack_cFf  /* constant-address: 801D1478, symbol: zoomMapCalc2__18dMenu_Fmap2DBack_cFf */
/* 801CAB5C  A8 1F 02 14 */	lha r0, 0x214(r31)                      
/* 801CAB60  2C 00 00 0A */	cmpwi r0, 0xa                           
/* 801CAB64  41 80 00 10 */	blt lbl_801CAB74                         /* constant-address: 801CAB74, symbol: lbl_801CAB74 */
/* 801CAB68  7F E3 FB 78 */	mr r3, r31                              
/* 801CAB6C  38 80 00 1A */	li r4, 0x1a                             
/* 801CAB70  48 00 0B 61 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
lbl_801CAB74:

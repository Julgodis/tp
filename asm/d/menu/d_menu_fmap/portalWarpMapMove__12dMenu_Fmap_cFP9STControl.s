...
/* 801CC8FC  48 19 58 D1 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 801CC900  7C 7B 1B 78 */	mr r27, r3                              
/* 801CC904  80 63 00 14 */	lwz r3, 0x14(r3)                        
/* 801CC908  48 00 82 25 */	bl regionMapMove__18dMenu_Fmap2DBack_cFP9STControl /* constant-address: 801D4B2C, symbol: regionMapMove__18dMenu_Fmap2DBack_cFP9STControl */
...
/* 801CC92C  48 00 00 C0 */	b lbl_801CC9EC                           /* constant-address: 801CC9EC, symbol: lbl_801CC9EC */
lbl_801CC930:
...
/* 801CC948  40 82 00 9C */	bne lbl_801CC9E4                         /* constant-address: 801CC9E4, symbol: lbl_801CC9E4 */
/* 801CC94C  7F 63 DB 78 */	mr r3, r27                              
/* 801CC950  88 99 00 0E */	lbz r4, 0xe(r25)                        
/* 801CC954  88 B9 00 0F */	lbz r5, 0xf(r25)                        
/* 801CC958  48 00 06 59 */	bl checkDrawPortalIcon__12dMenu_Fmap_cFii /* constant-address: 801CCFB0, symbol: checkDrawPortalIcon__12dMenu_Fmap_cFii */
/* 801CC95C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801CC960  41 82 00 84 */	beq lbl_801CC9E4                         /* constant-address: 801CC9E4, symbol: lbl_801CC9E4 */
...
/* 801CC978  48 00 43 A1 */	bl calcAllMapPos2D__18dMenu_Fmap2DBack_cFffPfPf /* constant-address: 801D0D18, symbol: calcAllMapPos2D__18dMenu_Fmap2DBack_cFffPfPf */
...
/* 801CC998  C0 02 A7 60 */	lfs f0, lit_6855(r2)                     /* constant-address: 80454160, symbol: lit_6855 */
/* 801CC99C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801CC9A0  4C 40 13 82 */	cror 2, 0, 2                            
/* 801CC9A4  40 82 00 40 */	bne lbl_801CC9E4                         /* constant-address: 801CC9E4, symbol: lbl_801CC9E4 */
...
/* 801CC9BC  4B FF FE C5 */	bl setAreaName__12dMenu_Fmap_cFUl        /* constant-address: 801CC880, symbol: setAreaName__12dMenu_Fmap_cFUl */
/* 801CC9C0  7F 63 DB 78 */	mr r3, r27                              
/* 801CC9C4  38 99 00 02 */	addi r4, r25, 2                         
/* 801CC9C8  48 00 09 B9 */	bl searchPortalStageID__12dMenu_Fmap_cFPc /* constant-address: 801CD380, symbol: searchPortalStageID__12dMenu_Fmap_cFPc */
/* 801CC9CC  7C 64 1B 78 */	mr r4, r3                               
/* 801CC9D0  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 801CC9D4  28 00 00 FF */	cmplwi r0, 0xff                         
/* 801CC9D8  41 82 00 0C */	beq lbl_801CC9E4                         /* constant-address: 801CC9E4, symbol: lbl_801CC9E4 */
/* 801CC9DC  80 7B 00 14 */	lwz r3, 0x14(r27)                       
/* 801CC9E0  48 00 53 95 */	bl setSpotCursor__18dMenu_Fmap2DBack_cFUc /* constant-address: 801D1D74, symbol: setSpotCursor__18dMenu_Fmap2DBack_cFUc */
lbl_801CC9E4:
/* 801CC9E4  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 801CC9E8  3B 5A 00 1C */	addi r26, r26, 0x1c                      /* constant-address: 0000001C */
lbl_801CC9EC:
/* 801CC9EC  88 1F 00 08 */	lbz r0, 8(r31)                          
/* 801CC9F0  7C 1C 00 00 */	cmpw r28, r0                            
/* 801CC9F4  41 80 FF 3C */	blt lbl_801CC930                         /* constant-address: 801CC930, symbol: lbl_801CC930 */
/* 801CC9F8  57 A3 06 3E */	clrlwi r3, r29, 0x18                    
/* 801CC9FC  28 03 00 FF */	cmplwi r3, 0xff                         
/* 801CCA00  41 82 00 48 */	beq lbl_801CCA48                         /* constant-address: 801CCA48, symbol: lbl_801CCA48 */
/* 801CCA04  88 1B 03 08 */	lbz r0, 0x308(r27)                      
/* 801CCA08  7C 03 00 40 */	cmplw r3, r0                            
/* 801CCA0C  41 82 00 38 */	beq lbl_801CCA44                         /* constant-address: 801CCA44, symbol: lbl_801CCA44 */
/* 801CCA10  38 00 00 46 */	li r0, 0x46                             
/* 801CCA14  90 01 00 08 */	stw r0, 8(r1)                           
/* 801CCA18  80 6D 8D E8 */	lwz r3, mAudioMgrPtr__10Z2AudioMgr(r13)  /* constant-address: 80451368, symbol: mAudioMgrPtr__10Z2AudioMgr */
/* 801CCA1C  38 81 00 08 */	addi r4, r1, 8                          
/* 801CCA20  38 A0 00 00 */	li r5, 0                                
/* 801CCA24  38 C0 00 00 */	li r6, 0                                
/* 801CCA28  38 E0 00 00 */	li r7, 0                                
/* 801CCA2C  C0 22 A7 24 */	lfs f1, lit_3995(r2)                     /* constant-address: 80454124, symbol: lit_3995 */
/* 801CCA30  FC 40 08 90 */	fmr f2, f1                              
/* 801CCA34  C0 62 A7 54 */	lfs f3, lit_4541(r2)                     /* constant-address: 80454154, symbol: lit_4541 */
/* 801CCA38  FC 80 18 90 */	fmr f4, f3                              
/* 801CCA3C  39 00 00 00 */	li r8, 0                                
/* 801CCA40  48 0D EF 45 */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc /* constant-address: 802AB984, symbol: seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc */
lbl_801CCA44:
...
/* 801CCA5C  48 19 57 BD */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

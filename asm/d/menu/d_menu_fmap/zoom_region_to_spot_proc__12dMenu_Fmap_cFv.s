...
/* 801C9328  C8 22 A7 40 */	lfd f1, lit_4358(r2)                     /* constant-address: 80454140, symbol: lit_4358 */
...
/* 801C9344  C0 02 A7 3C */	lfs f0, lit_4353(r2)                     /* constant-address: 8045413C, symbol: lit_4353 */
...
/* 801C9358  48 00 81 21 */	bl zoomMapCalc2__18dMenu_Fmap2DBack_cFf  /* constant-address: 801D1478, symbol: zoomMapCalc2__18dMenu_Fmap2DBack_cFf */
/* 801C935C  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C9360  38 80 00 01 */	li r4, 1                                
/* 801C9364  C0 22 A7 28 */	lfs f1, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C9368  48 00 E3 AD */	bl setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf /* constant-address: 801D7714, symbol: setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf */
/* 801C936C  A8 1F 02 14 */	lha r0, 0x214(r31)                      
/* 801C9370  2C 00 00 0A */	cmpwi r0, 0xa                           
/* 801C9374  41 80 00 10 */	blt lbl_801C9384                         /* constant-address: 801C9384, symbol: lbl_801C9384 */
/* 801C9378  7F E3 FB 78 */	mr r3, r31                              
/* 801C937C  38 80 00 0D */	li r4, 0xd                              
/* 801C9380  48 00 23 51 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
lbl_801C9384:
/* 801C9384  80 1F 02 04 */	lwz r0, 0x204(r31)                      
/* 801C9388  2C 00 00 00 */	cmpwi r0, 0                             
/* 801C938C  41 80 00 18 */	blt lbl_801C93A4                         /* constant-address: 801C93A4, symbol: lbl_801C93A4 */
/* 801C9390  7F E3 FB 78 */	mr r3, r31                              
/* 801C9394  54 04 06 3E */	clrlwi r4, r0, 0x18                     
/* 801C9398  38 A0 00 01 */	li r5, 1                                
/* 801C939C  48 00 23 45 */	bl setFlash__12dMenu_Fmap_cFUcb          /* constant-address: 801CB6E0, symbol: setFlash__12dMenu_Fmap_cFUcb */
/* 801C93A0  48 00 00 18 */	b lbl_801C93B8                           /* constant-address: 801C93B8, symbol: lbl_801C93B8 */
lbl_801C93A4:

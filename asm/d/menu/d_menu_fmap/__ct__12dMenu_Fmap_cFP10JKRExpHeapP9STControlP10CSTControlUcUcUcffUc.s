...
/* 801C6704  48 19 BA C5 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 801C6734  38 03 D6 64 */	addi r0, r3, __vt__12dMenu_Fmap_c@l      /* constant-address: 803BD664, symbol: __vt__12dMenu_Fmap_c */
/* 801C6738  90 1D 00 00 */	stw r0, 0(r29)                          
/* 801C673C  38 7D 00 C4 */	addi r3, r29, 0xc4                      
/* 801C6740  48 08 37 C1 */	bl __ct__10dMsgFlow_cFv                  /* constant-address: 80249F00, symbol: __ct__10dMsgFlow_cFv */
/* 801C6744  93 AD 8B 2C */	stw r29, MyClass__12dMenu_Fmap_c(r13)    /* constant-address: 804510AC, symbol: MyClass__12dMenu_Fmap_c */
...
/* 801C67C0  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
...
/* 801C6804  42 00 FF E4 */	bdnz lbl_801C67E8                        /* constant-address: 801C67E8, symbol: lbl_801C67E8 */
/* 801C6808  38 00 00 00 */	li r0, 0                                
/* 801C680C  98 1D 03 05 */	stb r0, 0x305(r29)                      
/* 801C6810  38 60 00 00 */	li r3, 0                                
/* 801C6814  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
...
/* 801C6844  42 00 FF DC */	bdnz lbl_801C6820                        /* constant-address: 801C6820, symbol: lbl_801C6820 */
/* 801C6848  3C 60 00 03 */	lis r3, 0x0003 /* 0x00032000@ha */      
/* 801C684C  38 63 20 00 */	addi r3, r3, 0x2000 /* 0x00032000@l */   /* constant-address: 00032000 */
/* 801C6850  80 9D 00 04 */	lwz r4, 4(r29)                          
/* 801C6854  38 A0 00 00 */	li r5, 0                                
/* 801C6858  48 10 85 D5 */	bl create__10JKRExpHeapFUlP7JKRHeapb     /* constant-address: 802CEE2C, symbol: create__10JKRExpHeapFUlP7JKRHeapb */
...
/* 801C687C  38 84 60 E8 */	addi r4, r4, d_menu_d_menu_fmap__stringBase0@l /* constant-address: 803960E8, symbol: d_menu_d_menu_fmap__stringBase0 */
/* 801C6880  48 1A 22 AD */	bl strcpy                                /* constant-address: 80368B2C, symbol: strcpy */
/* 801C6884  3C 60 80 43 */	lis r3, g_fmapHIO@ha                    
/* 801C6888  38 63 FC 60 */	addi r3, r3, g_fmapHIO@l                 /* constant-address: 8042FC60, symbol: g_fmapHIO */
/* 801C688C  80 83 00 08 */	lwz r4, 8(r3)                            /* constant-address: 8042FC68, symbol: None */
/* 801C6890  28 04 00 00 */	cmplwi r4, 0                            
/* 801C6894  41 82 00 20 */	beq lbl_801C68B4                         /* constant-address: 801C68B4, symbol: lbl_801C68B4 */
/* 801C6898  88 04 00 30 */	lbz r0, 0x30(r4)                        
/* 801C689C  28 00 00 00 */	cmplwi r0, 0                            
/* 801C68A0  41 82 00 14 */	beq lbl_801C68B4                         /* constant-address: 801C68B4, symbol: lbl_801C68B4 */
/* 801C68A4  9B DD 03 00 */	stb r30, 0x300(r29)                     
/* 801C68A8  80 03 00 08 */	lwz r0, 8(r3)                            /* constant-address: 8042FC68, symbol: None */
/* 801C68AC  90 1D 00 64 */	stw r0, 0x64(r29)                       
/* 801C68B0  48 00 00 14 */	b lbl_801C68C4                           /* constant-address: 801C68C4, symbol: lbl_801C68C4 */
lbl_801C68B4:
/* 801C68B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801C68B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801C68BC  80 03 5C 68 */	lwz r0, 0x5c68(r3)                       /* constant-address: 8040BE28, symbol: None */
...
/* 801C68D8  38 63 01 88 */	addi r3, r3, g_meter2_info@l             /* constant-address: 80430188, symbol: g_meter2_info */
/* 801C68DC  88 03 00 BF */	lbz r0, 0xbf(r3)                         /* constant-address: 80430247, symbol: None */
/* 801C68E0  28 00 00 04 */	cmplwi r0, 4                            
/* 801C68E4  40 82 00 18 */	bne lbl_801C68FC                         /* constant-address: 801C68FC, symbol: lbl_801C68FC */
...
/* 801C68F8  48 00 00 90 */	b lbl_801C6988                           /* constant-address: 801C6988, symbol: lbl_801C6988 */
lbl_801C68FC:
/* 801C68FC  28 00 00 05 */	cmplwi r0, 5                            
/* 801C6900  40 82 00 18 */	bne lbl_801C6918                         /* constant-address: 801C6918, symbol: lbl_801C6918 */
...
/* 801C6914  48 00 00 74 */	b lbl_801C6988                           /* constant-address: 801C6988, symbol: lbl_801C6988 */
lbl_801C6918:
/* 801C6918  28 00 00 08 */	cmplwi r0, 8                            
/* 801C691C  40 82 00 18 */	bne lbl_801C6934                         /* constant-address: 801C6934, symbol: lbl_801C6934 */
...
/* 801C6930  48 00 00 58 */	b lbl_801C6988                           /* constant-address: 801C6988, symbol: lbl_801C6988 */
lbl_801C6934:
/* 801C6934  28 00 00 03 */	cmplwi r0, 3                            
/* 801C6938  40 82 00 18 */	bne lbl_801C6950                         /* constant-address: 801C6950, symbol: lbl_801C6950 */
...
/* 801C694C  48 00 00 3C */	b lbl_801C6988                           /* constant-address: 801C6988, symbol: lbl_801C6988 */
lbl_801C6950:
/* 801C6950  28 00 00 07 */	cmplwi r0, 7                            
/* 801C6954  40 82 00 1C */	bne lbl_801C6970                         /* constant-address: 801C6970, symbol: lbl_801C6970 */
...
/* 801C696C  48 00 00 1C */	b lbl_801C6988                           /* constant-address: 801C6988, symbol: lbl_801C6988 */
lbl_801C6970:
/* 801C6970  28 00 00 09 */	cmplwi r0, 9                            
/* 801C6974  40 82 00 14 */	bne lbl_801C6988                         /* constant-address: 801C6988, symbol: lbl_801C6988 */
...
/* 801C6990  40 82 00 18 */	bne lbl_801C69A8                         /* constant-address: 801C69A8, symbol: lbl_801C69A8 */
/* 801C6994  C0 02 A7 2C */	lfs f0, lit_4159(r2)                     /* constant-address: 8045412C, symbol: lit_4159 */
/* 801C6998  D0 1D 01 1C */	stfs f0, 0x11c(r29)                     
/* 801C699C  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C69A0  D0 1D 01 20 */	stfs f0, 0x120(r29)                     
/* 801C69A4  48 00 00 64 */	b lbl_801C6A08                           /* constant-address: 801C6A08, symbol: lbl_801C6A08 */
lbl_801C69A8:
/* 801C69A8  28 00 00 03 */	cmplwi r0, 3                            
/* 801C69AC  40 82 00 18 */	bne lbl_801C69C4                         /* constant-address: 801C69C4, symbol: lbl_801C69C4 */
/* 801C69B0  C0 02 A7 30 */	lfs f0, lit_4160(r2)                     /* constant-address: 80454130, symbol: lit_4160 */
/* 801C69B4  D0 1D 01 1C */	stfs f0, 0x11c(r29)                     
/* 801C69B8  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C69BC  D0 1D 01 20 */	stfs f0, 0x120(r29)                     
/* 801C69C0  48 00 00 48 */	b lbl_801C6A08                           /* constant-address: 801C6A08, symbol: lbl_801C6A08 */
lbl_801C69C4:
/* 801C69C4  28 00 00 02 */	cmplwi r0, 2                            
/* 801C69C8  40 82 00 18 */	bne lbl_801C69E0                         /* constant-address: 801C69E0, symbol: lbl_801C69E0 */
/* 801C69CC  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C69D0  D0 1D 01 1C */	stfs f0, 0x11c(r29)                     
/* 801C69D4  C0 02 A7 34 */	lfs f0, lit_4161(r2)                     /* constant-address: 80454134, symbol: lit_4161 */
/* 801C69D8  D0 1D 01 20 */	stfs f0, 0x120(r29)                     
/* 801C69DC  48 00 00 2C */	b lbl_801C6A08                           /* constant-address: 801C6A08, symbol: lbl_801C6A08 */
lbl_801C69E0:
/* 801C69E0  28 00 00 00 */	cmplwi r0, 0                            
/* 801C69E4  40 82 00 18 */	bne lbl_801C69FC                         /* constant-address: 801C69FC, symbol: lbl_801C69FC */
/* 801C69E8  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C69EC  D0 1D 01 1C */	stfs f0, 0x11c(r29)                     
/* 801C69F0  C0 02 A7 38 */	lfs f0, lit_4162(r2)                     /* constant-address: 80454138, symbol: lit_4162 */
/* 801C69F4  D0 1D 01 20 */	stfs f0, 0x120(r29)                     
/* 801C69F8  48 00 00 10 */	b lbl_801C6A08                           /* constant-address: 801C6A08, symbol: lbl_801C6A08 */
lbl_801C69FC:
/* 801C69FC  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C6A00  D0 1D 01 1C */	stfs f0, 0x11c(r29)                     
/* 801C6A04  D0 1D 01 20 */	stfs f0, 0x120(r29)                     
lbl_801C6A08:
/* 801C6A08  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
...
/* 801C6A5C  42 00 FF D8 */	bdnz lbl_801C6A34                        /* constant-address: 801C6A34, symbol: lbl_801C6A34 */
...
/* 801C6A7C  42 00 FF F4 */	bdnz lbl_801C6A70                        /* constant-address: 801C6A70, symbol: lbl_801C6A70 */
/* 801C6A80  C0 02 A7 28 */	lfs f0, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
...
/* 801C6A98  48 00 60 2D */	bl resetRoomDataBit__12dMenu_Fmap_cFv    /* constant-address: 801CCAC4, symbol: resetRoomDataBit__12dMenu_Fmap_cFv */
...
/* 801C6AB4  48 19 B7 61 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

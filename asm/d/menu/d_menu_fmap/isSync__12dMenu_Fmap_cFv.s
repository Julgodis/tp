...
/* 801C7B04  41 82 00 18 */	beq lbl_801C7B1C                         /* constant-address: 801C7B1C, symbol: lbl_801C7B1C */
/* 801C7B08  88 03 00 0C */	lbz r0, 0xc(r3)                         
/* 801C7B0C  2C 00 00 00 */	cmpwi r0, 0                             
/* 801C7B10  40 82 00 0C */	bne lbl_801C7B1C                         /* constant-address: 801C7B1C, symbol: lbl_801C7B1C */

...
/* 801C8540  48 00 43 1D */	bl setTitleName__12dMenu_Fmap_cFUl       /* constant-address: 801CC85C, symbol: setTitleName__12dMenu_Fmap_cFUl */
...
/* 801C8554  40 82 00 10 */	bne lbl_801C8564                         /* constant-address: 801C8564, symbol: lbl_801C8564 */
/* 801C8558  7F E3 FB 78 */	mr r3, r31                              
/* 801C855C  48 00 43 51 */	bl setAreaNameZero__12dMenu_Fmap_cFv     /* constant-address: 801CC8AC, symbol: setAreaNameZero__12dMenu_Fmap_cFv */
/* 801C8560  48 00 00 20 */	b lbl_801C8580                           /* constant-address: 801C8580, symbol: lbl_801C8580 */
lbl_801C8564:
...
/* 801C857C  48 00 43 05 */	bl setAreaName__12dMenu_Fmap_cFUl        /* constant-address: 801CC880, symbol: setAreaName__12dMenu_Fmap_cFUl */
lbl_801C8580:
...
/* 801C859C  C0 22 A7 28 */	lfs f1, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C85A0  48 00 F1 75 */	bl setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf /* constant-address: 801D7714, symbol: setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf */
/* 801C85A4  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C85A8  38 80 05 22 */	li r4, 0x522                            
/* 801C85AC  38 A0 00 FF */	li r5, 0xff                             
/* 801C85B0  48 00 EC 61 */	bl setBButtonString__17dMenu_Fmap2DTop_cFUlUc /* constant-address: 801D7210, symbol: setBButtonString__17dMenu_Fmap2DTop_cFUlUc */
/* 801C85B4  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C85B8  38 80 05 27 */	li r4, 0x527                            
/* 801C85BC  38 A0 00 FF */	li r5, 0xff                             
/* 801C85C0  48 00 ED 15 */	bl setAButtonString__17dMenu_Fmap2DTop_cFUlUc /* constant-address: 801D72D4, symbol: setAButtonString__17dMenu_Fmap2DTop_cFUlUc */
/* 801C85C4  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C85C8  38 80 05 29 */	li r4, 0x529                            
/* 801C85CC  38 A0 00 FF */	li r5, 0xff                             
/* 801C85D0  48 00 EB 19 */	bl setZButtonString__17dMenu_Fmap2DTop_cFUlUc /* constant-address: 801D70E8, symbol: setZButtonString__17dMenu_Fmap2DTop_cFUlUc */
/* 801C85D4  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C85D8  38 80 05 28 */	li r4, 0x528                            
/* 801C85DC  48 00 EF 11 */	bl set3DStickString__17dMenu_Fmap2DTop_cFUl /* constant-address: 801D74EC, symbol: set3DStickString__17dMenu_Fmap2DTop_cFUl */
/* 801C85E0  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C85E4  38 80 03 F9 */	li r4, 0x3f9                            
/* 801C85E8  48 00 ED B1 */	bl setCrossLRString__17dMenu_Fmap2DTop_cFUl /* constant-address: 801D7398, symbol: setCrossLRString__17dMenu_Fmap2DTop_cFUl */

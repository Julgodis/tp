...
/* 801CC2C0  48 19 5E E5 */	bl _savegpr_15                           /* constant-address: 803621A4, symbol: _savegpr_15 */
...
/* 801CC2F0  48 00 05 6D */	bl setTitleName__12dMenu_Fmap_cFUl       /* constant-address: 801CC85C, symbol: setTitleName__12dMenu_Fmap_cFUl */
...
/* 801CC308  3A 83 FC 60 */	addi r20, r3, g_fmapHIO@l                /* constant-address: 8042FC60, symbol: g_fmapHIO */
/* 801CC30C  48 00 01 80 */	b lbl_801CC48C                           /* constant-address: 801CC48C, symbol: lbl_801CC48C */
lbl_801CC310:
/* 801CC310  7E 1D BA 14 */	add r16, r29, r23                       
/* 801CC314  88 90 00 00 */	lbz r4, 0(r16)                          
/* 801CC318  80 79 00 14 */	lwz r3, 0x14(r25)                       
/* 801CC31C  38 1C 12 1C */	addi r0, r28, 0x121c                     /* constant-address: 0000121C */
...
/* 801CC34C  40 82 01 20 */	bne lbl_801CC46C                         /* constant-address: 801CC46C, symbol: lbl_801CC46C */
/* 801CC350  3B 40 00 00 */	li r26, 0                               
/* 801CC354  2C 1B 00 07 */	cmpwi r27, 7                            
/* 801CC358  40 82 00 24 */	bne lbl_801CC37C                         /* constant-address: 801CC37C, symbol: lbl_801CC37C */
...
/* 801CC368  38 84 60 E8 */	addi r4, r4, d_menu_d_menu_fmap__stringBase0@l /* constant-address: 803960E8, symbol: d_menu_d_menu_fmap__stringBase0 */
/* 801CC36C  38 84 00 66 */	addi r4, r4, 0x66                        /* constant-address: 8039614E, symbol: None */
/* 801CC370  4C C6 31 82 */	crclr 6                                 
/* 801CC374  48 19 A1 69 */	bl sprintf                               /* constant-address: 803664DC, symbol: sprintf */
/* 801CC378  48 00 00 1C */	b lbl_801CC394                           /* constant-address: 801CC394, symbol: lbl_801CC394 */
lbl_801CC37C:
/* 801CC37C  38 61 00 10 */	addi r3, r1, 0x10                       
/* 801CC380  3C 80 80 39 */	lis r4, d_menu_d_menu_fmap__stringBase0@ha
/* 801CC384  38 84 60 E8 */	addi r4, r4, d_menu_d_menu_fmap__stringBase0@l /* constant-address: 803960E8, symbol: d_menu_d_menu_fmap__stringBase0 */
/* 801CC388  38 84 00 76 */	addi r4, r4, 0x76                        /* constant-address: 8039615E, symbol: None */
/* 801CC38C  4C C6 31 82 */	crclr 6                                 
/* 801CC390  48 19 A1 4D */	bl sprintf                               /* constant-address: 803664DC, symbol: sprintf */
lbl_801CC394:
...
/* 801CC3AC  4B FF FC E9 */	bl readFieldMapData__12dMenu_Fmap_cFPPvPCcbb /* constant-address: 801CC094, symbol: readFieldMapData__12dMenu_Fmap_cFPPvPCcbb */
/* 801CC3B0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801CC3B4  41 82 00 B8 */	beq lbl_801CC46C                         /* constant-address: 801CC46C, symbol: lbl_801CC46C */
/* 801CC3B8  88 14 03 09 */	lbz r0, 0x309(r20)                       /* constant-address: 8042FF69, symbol: None */
/* 801CC3BC  28 00 00 00 */	cmplwi r0, 0                            
/* 801CC3C0  40 82 00 40 */	bne lbl_801CC400                         /* constant-address: 801CC400, symbol: lbl_801CC400 */
...
/* 801CC3F8  48 00 44 0D */	bl setRegionTexData__18dMenu_Fmap2DBack_cFUcP7ResTIMGfffffffff /* constant-address: 801D0804, symbol: setRegionTexData__18dMenu_Fmap2DBack_cFUcP7ResTIMGfffffffff */
/* 801CC3FC  48 00 00 54 */	b lbl_801CC450                           /* constant-address: 801CC450, symbol: lbl_801CC450 */
lbl_801CC400:
...
/* 801CC44C  48 00 43 B9 */	bl setRegionTexData__18dMenu_Fmap2DBack_cFUcP7ResTIMGfffffffff /* constant-address: 801D0804, symbol: setRegionTexData__18dMenu_Fmap2DBack_cFUcP7ResTIMGfffffffff */
lbl_801CC450:
/* 801CC450  A0 70 00 02 */	lhz r3, 2(r16)                          
/* 801CC454  38 16 02 18 */	addi r0, r22, 0x218                      /* constant-address: 00000218 */
...
lbl_801CC46C:
/* 801CC46C  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
/* 801CC470  2C 1B 00 08 */	cmpwi r27, 8                            
/* 801CC474  3A D6 00 02 */	addi r22, r22, 2                         /* constant-address: 00000002 */
/* 801CC478  3A B5 00 04 */	addi r21, r21, 4                         /* constant-address: 00000004 */
/* 801CC47C  41 80 FE C4 */	blt lbl_801CC340                         /* constant-address: 801CC340, symbol: lbl_801CC340 */
/* 801CC480  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 801CC484  3B 18 00 04 */	addi r24, r24, 4                         /* constant-address: 00000004 */
/* 801CC488  3A F7 00 28 */	addi r23, r23, 0x28                      /* constant-address: 00000028 */
lbl_801CC48C:
/* 801CC48C  88 1F 00 00 */	lbz r0, 0(r31)                          
/* 801CC490  7C 1C 00 00 */	cmpw r28, r0                            
/* 801CC494  41 80 FE 7C */	blt lbl_801CC310                         /* constant-address: 801CC310, symbol: lbl_801CC310 */
/* 801CC498  80 79 00 14 */	lwz r3, 0x14(r25)                       
/* 801CC49C  48 00 96 29 */	bl calcDrawPriority__18dMenu_Fmap2DBack_cFv /* constant-address: 801D5AC4, symbol: calcDrawPriority__18dMenu_Fmap2DBack_cFv */
/* 801CC4A0  80 79 00 14 */	lwz r3, 0x14(r25)                       
/* 801CC4A4  48 00 46 25 */	bl calcAllMapPos__18dMenu_Fmap2DBack_cFv /* constant-address: 801D0AC8, symbol: calcAllMapPos__18dMenu_Fmap2DBack_cFv */
...
/* 801CC4D0  48 00 03 B1 */	bl setAreaName__12dMenu_Fmap_cFUl        /* constant-address: 801CC880, symbol: setAreaName__12dMenu_Fmap_cFUl */
/* 801CC4D4  39 61 00 70 */	addi r11, r1, 0x70                      
/* 801CC4D8  48 19 5D 19 */	bl _restgpr_15                           /* constant-address: 803621F0, symbol: _restgpr_15 */

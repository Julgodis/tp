...
/* 801C944C  C8 22 A7 40 */	lfd f1, lit_4358(r2)                     /* constant-address: 80454140, symbol: lit_4358 */
...
/* 801C9468  C0 02 A7 3C */	lfs f0, lit_4353(r2)                     /* constant-address: 8045413C, symbol: lit_4353 */
...
/* 801C947C  48 00 7F FD */	bl zoomMapCalc2__18dMenu_Fmap2DBack_cFf  /* constant-address: 801D1478, symbol: zoomMapCalc2__18dMenu_Fmap2DBack_cFf */
/* 801C9480  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 801C9484  38 80 00 01 */	li r4, 1                                
/* 801C9488  C0 22 A7 28 */	lfs f1, lit_4158(r2)                     /* constant-address: 80454128, symbol: lit_4158 */
/* 801C948C  48 00 E2 89 */	bl setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf /* constant-address: 801D7714, symbol: setArrowAlphaRatio__17dMenu_Fmap2DTop_cFUcf */
/* 801C9490  A8 1F 02 14 */	lha r0, 0x214(r31)                      
/* 801C9494  2C 00 00 00 */	cmpwi r0, 0                             
/* 801C9498  41 81 00 2C */	bgt lbl_801C94C4                         /* constant-address: 801C94C4, symbol: lbl_801C94C4 */
/* 801C949C  88 1F 03 07 */	lbz r0, 0x307(r31)                      
/* 801C94A0  28 00 00 01 */	cmplwi r0, 1                            
/* 801C94A4  40 82 00 14 */	bne lbl_801C94B8                         /* constant-address: 801C94B8, symbol: lbl_801C94B8 */
/* 801C94A8  7F E3 FB 78 */	mr r3, r31                              
/* 801C94AC  38 80 00 08 */	li r4, 8                                
/* 801C94B0  48 00 22 21 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
/* 801C94B4  48 00 00 10 */	b lbl_801C94C4                           /* constant-address: 801C94C4, symbol: lbl_801C94C4 */
lbl_801C94B8:
/* 801C94B8  7F E3 FB 78 */	mr r3, r31                              
/* 801C94BC  38 80 00 06 */	li r4, 6                                
/* 801C94C0  48 00 22 11 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
lbl_801C94C4:
/* 801C94C4  80 1F 02 04 */	lwz r0, 0x204(r31)                      
/* 801C94C8  2C 00 00 00 */	cmpwi r0, 0                             
/* 801C94CC  41 80 00 18 */	blt lbl_801C94E4                         /* constant-address: 801C94E4, symbol: lbl_801C94E4 */
/* 801C94D0  7F E3 FB 78 */	mr r3, r31                              
/* 801C94D4  54 04 06 3E */	clrlwi r4, r0, 0x18                     
/* 801C94D8  38 A0 00 01 */	li r5, 1                                
/* 801C94DC  48 00 22 05 */	bl setFlash__12dMenu_Fmap_cFUcb          /* constant-address: 801CB6E0, symbol: setFlash__12dMenu_Fmap_cFUcb */
/* 801C94E0  48 00 00 18 */	b lbl_801C94F8                           /* constant-address: 801C94F8, symbol: lbl_801C94F8 */
lbl_801C94E4:

...
/* 801CACA4  40 82 00 38 */	bne lbl_801CACDC                         /* constant-address: 801CACDC, symbol: lbl_801CACDC */
/* 801CACA8  38 00 00 BC */	li r0, 0xbc                             
/* 801CACAC  90 01 00 08 */	stw r0, 8(r1)                           
/* 801CACB0  80 6D 8D E8 */	lwz r3, mAudioMgrPtr__10Z2AudioMgr(r13)  /* constant-address: 80451368, symbol: mAudioMgrPtr__10Z2AudioMgr */
/* 801CACB4  38 81 00 08 */	addi r4, r1, 8                          
/* 801CACB8  38 A0 00 00 */	li r5, 0                                
/* 801CACBC  38 C0 00 00 */	li r6, 0                                
/* 801CACC0  38 E0 00 00 */	li r7, 0                                
/* 801CACC4  C0 22 A7 24 */	lfs f1, lit_3995(r2)                     /* constant-address: 80454124, symbol: lit_3995 */
/* 801CACC8  FC 40 08 90 */	fmr f2, f1                              
/* 801CACCC  C0 62 A7 54 */	lfs f3, lit_4541(r2)                     /* constant-address: 80454154, symbol: lit_4541 */
/* 801CACD0  FC 80 18 90 */	fmr f4, f3                              
/* 801CACD4  39 00 00 00 */	li r8, 0                                
/* 801CACD8  48 0E 0C AD */	bl seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc /* constant-address: 802AB984, symbol: seStart__7Z2SeMgrF10JAISoundIDPC3VecUlScffffUc */
lbl_801CACDC:
/* 801CACDC  A8 7F 02 14 */	lha r3, 0x214(r31)                      
/* 801CACE0  7C 60 07 35 */	extsh. r0, r3                           
/* 801CACE4  40 81 00 50 */	ble lbl_801CAD34                         /* constant-address: 801CAD34, symbol: lbl_801CAD34 */
/* 801CACE8  C8 22 A7 40 */	lfd f1, lit_4358(r2)                     /* constant-address: 80454140, symbol: lit_4358 */
...
/* 801CAD04  C0 02 A7 3C */	lfs f0, lit_4353(r2)                     /* constant-address: 8045413C, symbol: lit_4353 */
...
/* 801CAD18  48 00 67 61 */	bl zoomMapCalc2__18dMenu_Fmap2DBack_cFf  /* constant-address: 801D1478, symbol: zoomMapCalc2__18dMenu_Fmap2DBack_cFf */
/* 801CAD1C  A8 1F 02 14 */	lha r0, 0x214(r31)                      
/* 801CAD20  2C 00 00 0A */	cmpwi r0, 0xa                           
/* 801CAD24  41 80 00 10 */	blt lbl_801CAD34                         /* constant-address: 801CAD34, symbol: lbl_801CAD34 */
/* 801CAD28  7F E3 FB 78 */	mr r3, r31                              
/* 801CAD2C  38 80 00 1C */	li r4, 0x1c                             
/* 801CAD30  48 00 09 A1 */	bl setProcess__12dMenu_Fmap_cFUc         /* constant-address: 801CB6D0, symbol: setProcess__12dMenu_Fmap_cFUc */
lbl_801CAD34:

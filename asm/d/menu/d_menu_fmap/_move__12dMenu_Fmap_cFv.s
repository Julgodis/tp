...
/* 801C74E4 0000003C  3C 80 80 3C */	lis r4, move_process@ha
/* 801C74E8 00000040  38 04 D4 D4 */	addi r0, r4, move_process@l
...
/* 801C750C 00000064  88 84 00 10 */	lbz r4, 0x10(r4)	/* effective address: 8042E83C */
...
/* 801C7520 00000078  C0 24 00 08 */	lfs f1, 8(r4)	/* effective address: 8042E834 */
...
/* 801C7534 0000008C  88 84 00 11 */	lbz r4, 0x11(r4)	/* effective address: 8042E83D */
...
/* 801C754C 000000A4  C0 25 00 0C */	lfs f1, 0xc(r5)	/* effective address: 8042E838 */
...
/* 801C7568 000000C0  3C 80 80 3C */	lis r4, init_process@ha
/* 801C756C 000000C4  38 04 D2 04 */	addi r0, r4, init_process@l
...
/* 801C75D4 00000030  88 03 02 FF */	lbz r0, 0x2ff(r3)	/* effective address: 8042FF5F */
...
lbl_801C75E8:
/* 801C75E8 00000000  C0 22 A7 24 */	lfs f1, lit_3995(r2)
...
/* 801C75FC 00000014  C0 42 A7 48 */	lfs f2, lit_4397(r2)
/* 801C7600 00000018  C0 62 A7 4C */	lfs f3, lit_4398(r2)
/* 801C7604 0000001C  48 0A 84 39 */	bl cLib_addCalc2__FPffff
/* 801C7608 00000020  C0 1F 01 A8 */	lfs f0, 0x1a8(r31)
/* 801C760C 00000024  C0 22 A7 24 */	lfs f1, lit_3995(r2)
...
/* 801C761C 00000034  C0 02 A7 50 */	lfs f0, lit_4399(r2)

...
/* 801CEEAC  88 02 A7 94 */	lbz r0, m_other__22dMfm_HIO_prm_res_src_s(r2) /* constant-address: 80454194, symbol: m_other__22dMfm_HIO_prm_res_src_s */
/* 801CEEB0  54 04 F8 7E */	srwi r4, r0, 1                          
/* 801CEEB4  7C 03 20 00 */	cmpw r3, r4                             
/* 801CEEB8  40 80 00 40 */	bge lbl_801CEEF8                         /* constant-address: 801CEEF8, symbol: lbl_801CEEF8 */
/* 801CEEBC  7C 03 20 50 */	subf r0, r3, r4                         
/* 801CEEC0  C8 42 A7 A8 */	lfd f2, lit_4108(r2)                     /* constant-address: 804541A8, symbol: lit_4108 */
...
/* 801CEEF4  48 00 00 3C */	b lbl_801CEF30                           /* constant-address: 801CEF30, symbol: lbl_801CEF30 */
lbl_801CEEF8:
/* 801CEEF8  7C 04 18 50 */	subf r0, r4, r3                         
/* 801CEEFC  C8 42 A7 A8 */	lfd f2, lit_4108(r2)                     /* constant-address: 804541A8, symbol: lit_4108 */
...
/* 801CEF34  C0 02 A7 84 */	lfs f0, lit_3711(r2)                     /* constant-address: 80454184, symbol: lit_3711 */
/* 801CEF38  EC 20 08 28 */	fsubs f1, f0, f1                        
/* 801CEF3C  4B FF FB E1 */	bl setPointColor__15dMenu_FmapMap_cFf    /* constant-address: 801CEB1C, symbol: setPointColor__15dMenu_FmapMap_cFf */
/* 801CEF40  80 BF 00 C4 */	lwz r5, 0xc4(r31)                       
/* 801CEF44  A8 85 01 68 */	lha r4, 0x168(r5)                       
/* 801CEF48  3C 60 80 43 */	lis r3, g_Counter@ha                    
/* 801CEF4C  38 63 0C D8 */	addi r3, r3, g_Counter@l                 /* constant-address: 80430CD8, symbol: g_Counter */
/* 801CEF50  80 63 00 00 */	lwz r3, 0(r3)                            /* constant-address: 80430CD8, symbol: g_Counter */
/* 801CEF54  7C 03 23 96 */	divwu r0, r3, r4                        
/* 801CEF58  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 801CEF5C  7C 00 18 50 */	subf r0, r0, r3                         
/* 801CEF60  C8 22 A7 78 */	lfd f1, lit_3689(r2)                     /* constant-address: 80454178, symbol: lit_3689 */
...
/* 801CEF78  C8 22 A7 A8 */	lfd f1, lit_4108(r2)                     /* constant-address: 804541A8, symbol: lit_4108 */
...
/* 801CEF94  C0 42 A7 98 */	lfs f2, lit_4104(r2)                     /* constant-address: 80454198, symbol: lit_4104 */
/* 801CEF98  C0 02 A7 9C */	lfs f0, lit_4105(r2)                     /* constant-address: 8045419C, symbol: lit_4105 */
/* 801CEF9C  EC 20 00 72 */	fmuls f1, f0, f1                        
/* 801CEFA0  C0 02 A7 A0 */	lfs f0, lit_4106(r2)                     /* constant-address: 804541A0, symbol: lit_4106 */
...
/* 801CEFBC  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 801CEFD8  4B FF F0 F5 */	bl twoColorLineInterporation__FRC8_GXColorRC8_GXColorfR8_GXColor /* constant-address: 801CE0CC, symbol: twoColorLineInterporation__FRC8_GXColorRC8_GXColorfR8_GXColor */
/* 801CEFDC  7F E3 FB 78 */	mr r3, r31                              
/* 801CEFE0  38 80 00 19 */	li r4, 0x19                             
/* 801CEFE4  38 A1 00 08 */	addi r5, r1, 8                          
/* 801CEFE8  4B FF FA C5 */	bl setFmapPaletteColor__15dMenu_FmapMap_cFQ215renderingFmap_c9palette_eRC8_GXColor /* constant-address: 801CEAAC, symbol: setFmapPaletteColor__15dMenu_FmapMap_cFQ215renderingFmap_c9palette_eRC8_GXColor */
/* 801CEFEC  80 BF 00 C4 */	lwz r5, 0xc4(r31)                       
/* 801CEFF0  A8 85 01 6A */	lha r4, 0x16a(r5)                       
/* 801CEFF4  3C 60 80 43 */	lis r3, g_Counter@ha                    
/* 801CEFF8  38 63 0C D8 */	addi r3, r3, g_Counter@l                 /* constant-address: 80430CD8, symbol: g_Counter */
/* 801CEFFC  80 63 00 00 */	lwz r3, 0(r3)                            /* constant-address: 80430CD8, symbol: g_Counter */
/* 801CF000  7C 03 23 96 */	divwu r0, r3, r4                        
/* 801CF004  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 801CF008  7C 00 18 50 */	subf r0, r0, r3                         
/* 801CF00C  C8 22 A7 78 */	lfd f1, lit_3689(r2)                     /* constant-address: 80454178, symbol: lit_3689 */
...
/* 801CF024  C8 22 A7 A8 */	lfd f1, lit_4108(r2)                     /* constant-address: 804541A8, symbol: lit_4108 */
...
/* 801CF048  C0 42 A7 98 */	lfs f2, lit_4104(r2)                     /* constant-address: 80454198, symbol: lit_4104 */
/* 801CF04C  C0 02 A7 9C */	lfs f0, lit_4105(r2)                     /* constant-address: 8045419C, symbol: lit_4105 */
/* 801CF050  EC 20 00 72 */	fmuls f1, f0, f1                        
/* 801CF054  C0 02 A7 A0 */	lfs f0, lit_4106(r2)                     /* constant-address: 804541A0, symbol: lit_4106 */
...
/* 801CF070  38 A5 9A 20 */	addi r5, r5, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 801CF084  4B FF F0 49 */	bl twoColorLineInterporation__FRC8_GXColorRC8_GXColorfR8_GXColor /* constant-address: 801CE0CC, symbol: twoColorLineInterporation__FRC8_GXColorRC8_GXColorfR8_GXColor */
/* 801CF088  7F E3 FB 78 */	mr r3, r31                              
/* 801CF08C  38 80 00 1A */	li r4, 0x1a                             
/* 801CF090  38 A1 00 08 */	addi r5, r1, 8                          
/* 801CF094  4B FF FA 19 */	bl setFmapPaletteColor__15dMenu_FmapMap_cFQ215renderingFmap_c9palette_eRC8_GXColor /* constant-address: 801CEAAC, symbol: setFmapPaletteColor__15dMenu_FmapMap_cFQ215renderingFmap_c9palette_eRC8_GXColor */
/* 801CF098  7F E3 FB 78 */	mr r3, r31                              
/* 801CF09C  4B E6 DD 11 */	bl renderingMap__15dRenderingMap_cFv     /* constant-address: 8003CDAC, symbol: renderingMap__15dRenderingMap_cFv */

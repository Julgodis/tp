...
/* 801CE4F8  4B E6 09 69 */	bl dComIfGp_getNowLevel__Fv              /* constant-address: 8002EE60, symbol: dComIfGp_getNowLevel__Fv */
/* 801CE4FC  54 63 06 3E */	clrlwi r3, r3, 0x18                     
/* 801CE500  80 1E 00 A0 */	lwz r0, 0xa0(r30)                       
/* 801CE504  7C 00 18 00 */	cmpw r0, r3                             
/* 801CE508  40 82 00 28 */	bne lbl_801CE530                         /* constant-address: 801CE530, symbol: lbl_801CE530 */
/* 801CE50C  80 7E 00 98 */	lwz r3, 0x98(r30)                       
/* 801CE510  80 1E 00 90 */	lwz r0, 0x90(r30)                       
/* 801CE514  7C 03 00 00 */	cmpw r3, r0                             
/* 801CE518  40 82 00 18 */	bne lbl_801CE530                         /* constant-address: 801CE530, symbol: lbl_801CE530 */
/* 801CE51C  80 7E 00 9C */	lwz r3, 0x9c(r30)                       
/* 801CE520  88 0D 87 E4 */	lbz r0, struct_80450D64+0x0(r13)         /* constant-address: 80450D64, symbol: struct_80450D64+0x0 */
/* 801CE524  7C 00 07 74 */	extsb r0, r0                            
/* 801CE528  7C 03 00 00 */	cmpw r3, r0                             
/* 801CE52C  41 82 00 14 */	beq lbl_801CE540                         /* constant-address: 801CE540, symbol: lbl_801CE540 */
lbl_801CE530:
/* 801CE530  80 7E 00 84 */	lwz r3, 0x84(r30)                       
/* 801CE534  4B E6 F2 E5 */	bl isArrival__22dMenu_Fmap_room_data_cFv /* constant-address: 8003D818, symbol: isArrival__22dMenu_Fmap_room_data_cFv */
/* 801CE538  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801CE53C  41 82 00 08 */	beq lbl_801CE544                         /* constant-address: 801CE544, symbol: lbl_801CE544 */
lbl_801CE540:

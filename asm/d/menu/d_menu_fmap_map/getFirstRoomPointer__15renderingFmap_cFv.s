...
/* 801CE6C4  48 00 00 99 */	bl getFirstRegion__15renderingFmap_cFv   /* constant-address: 801CE75C, symbol: getFirstRegion__15renderingFmap_cFv */
/* 801CE6C8  80 1E 00 84 */	lwz r0, 0x84(r30)                       
/* 801CE6CC  28 00 00 00 */	cmplwi r0, 0                            
/* 801CE6D0  41 82 00 70 */	beq lbl_801CE740                         /* constant-address: 801CE740, symbol: lbl_801CE740 */
/* 801CE6D4  80 7E 00 88 */	lwz r3, 0x88(r30)                       
/* 801CE6D8  28 03 00 00 */	cmplwi r3, 0                            
/* 801CE6DC  41 82 00 30 */	beq lbl_801CE70C                         /* constant-address: 801CE70C, symbol: lbl_801CE70C */
/* 801CE6E0  83 E3 00 08 */	lwz r31, 8(r3)                          
/* 801CE6E4  48 00 00 28 */	b lbl_801CE70C                           /* constant-address: 801CE70C, symbol: lbl_801CE70C */
lbl_801CE6E8:
/* 801CE6E8  80 1E 00 88 */	lwz r0, 0x88(r30)                       
/* 801CE6EC  28 00 00 00 */	cmplwi r0, 0                            
/* 801CE6F0  41 82 00 1C */	beq lbl_801CE70C                         /* constant-address: 801CE70C, symbol: lbl_801CE70C */
...
/* 801CE714  41 82 00 1C */	beq lbl_801CE730                         /* constant-address: 801CE730, symbol: lbl_801CE730 */
/* 801CE718  28 1F 00 00 */	cmplwi r31, 0                           
/* 801CE71C  41 82 FF CC */	beq lbl_801CE6E8                         /* constant-address: 801CE6E8, symbol: lbl_801CE6E8 */
/* 801CE720  7F C3 F3 78 */	mr r3, r30                              
/* 801CE724  4B FF FD B9 */	bl isDrawRoom__15renderingFmap_cFv       /* constant-address: 801CE4DC, symbol: isDrawRoom__15renderingFmap_cFv */
/* 801CE728  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801CE72C  41 82 FF BC */	beq lbl_801CE6E8                         /* constant-address: 801CE6E8, symbol: lbl_801CE6E8 */
lbl_801CE730:
/* 801CE730  28 1F 00 00 */	cmplwi r31, 0                           
/* 801CE734  41 82 00 0C */	beq lbl_801CE740                         /* constant-address: 801CE740, symbol: lbl_801CE740 */
/* 801CE738  7F C3 F3 78 */	mr r3, r30                              
/* 801CE73C  4B FF FE B1 */	bl roomSetteing__15renderingFmap_cFv     /* constant-address: 801CE5EC, symbol: roomSetteing__15renderingFmap_cFv */
lbl_801CE740:

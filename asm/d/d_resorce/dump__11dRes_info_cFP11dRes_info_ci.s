...
/* 8003BE48  48 32 63 85 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
/* 8003BE4C  7C 7C 1B 78 */	mr r28, r3                              
/* 8003BE50  7C 9D 23 78 */	mr r29, r4                              
/* 8003BE54  3C 60 80 38 */	lis r3, d_d_resorce__stringBase0@ha     
/* 8003BE58  38 63 98 B8 */	addi r3, r3, d_d_resorce__stringBase0@l  /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003BE5C  38 63 01 80 */	addi r3, r3, 0x180                       /* constant-address: 80379A38, symbol: None */
/* 8003BE60  7F 84 E3 78 */	mr r4, r28                              
/* 8003BE64  7F A5 EB 78 */	mr r5, r29                              
/* 8003BE68  4C C6 31 82 */	crclr 6                                 
/* 8003BE6C  48 2A C7 5D */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 8003BE70  3C 60 80 38 */	lis r3, d_d_resorce__stringBase0@ha     
/* 8003BE74  38 63 98 B8 */	addi r3, r3, d_d_resorce__stringBase0@l  /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003BE78  38 63 01 9B */	addi r3, r3, 0x19b                       /* constant-address: 80379A53, symbol: None */
/* 8003BE7C  4C C6 31 82 */	crclr 6                                 
/* 8003BE80  48 2A C7 49 */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 8003BE84  3B E0 00 00 */	li r31, 0                               
/* 8003BE88  3B C0 00 00 */	li r30, 0                               
/* 8003BE8C  3B 20 00 00 */	li r25, 0                               
/* 8003BE90  48 00 00 A8 */	b lbl_8003BF38                           /* constant-address: 8003BF38, symbol: lbl_8003BF38 */
lbl_8003BE94:
/* 8003BE94  A0 1C 00 0C */	lhz r0, 0xc(r28)                        
/* 8003BE98  2C 00 00 00 */	cmpwi r0, 0                             
/* 8003BE9C  41 82 00 94 */	beq lbl_8003BF30                         /* constant-address: 8003BF30, symbol: lbl_8003BF30 */
/* 8003BEA0  80 7C 00 14 */	lwz r3, 0x14(r28)                       
/* 8003BEA4  4B FF FB F9 */	bl getArcHeader__FP10JKRArchive          /* constant-address: 8003BA9C, symbol: getArcHeader__FP10JKRArchive */
/* 8003BEA8  38 80 00 00 */	li r4, 0                                
/* 8003BEAC  48 29 28 05 */	bl getSize__7JKRHeapFPvP7JKRHeap         /* constant-address: 802CE6B0, symbol: getSize__7JKRHeapFPvP7JKRHeap */
/* 8003BEB0  7C 7B 1B 78 */	mr r27, r3                              
/* 8003BEB4  80 7C 00 1C */	lwz r3, 0x1c(r28)                       
/* 8003BEB8  38 80 00 00 */	li r4, 0                                
/* 8003BEBC  48 29 27 F5 */	bl getSize__7JKRHeapFPvP7JKRHeap         /* constant-address: 802CE6B0, symbol: getSize__7JKRHeapFPvP7JKRHeap */
/* 8003BEC0  7C 7A 1B 78 */	mr r26, r3                              
/* 8003BEC4  3C 60 80 38 */	lis r3, d_d_resorce__stringBase0@ha     
/* 8003BEC8  38 63 98 B8 */	addi r3, r3, d_d_resorce__stringBase0@l  /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003BECC  38 63 01 D1 */	addi r3, r3, 0x1d1                       /* constant-address: 80379A89, symbol: None */
/* 8003BED0  7F 24 CB 78 */	mr r4, r25                              
/* 8003BED4  C8 62 83 F8 */	lfd f3, lit_4277(r2)                     /* constant-address: 80451DF8, symbol: lit_4277 */
...
/* 8003BEF0  C0 42 84 00 */	lfs f2, lit_4333(r2)                     /* constant-address: 80451E00, symbol: lit_4333 */
...
/* 8003BF24  48 2A C6 A5 */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 8003BF28  7F FF DA 14 */	add r31, r31, r27                       
/* 8003BF2C  7F DE D2 14 */	add r30, r30, r26                       
lbl_8003BF30:
/* 8003BF30  3B 9C 00 24 */	addi r28, r28, 0x24                     
/* 8003BF34  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
lbl_8003BF38:
/* 8003BF38  7C 19 E8 00 */	cmpw r25, r29                           
/* 8003BF3C  41 80 FF 58 */	blt lbl_8003BE94                         /* constant-address: 8003BE94, symbol: lbl_8003BE94 */
/* 8003BF40  3C 60 80 38 */	lis r3, d_d_resorce__stringBase0@ha     
/* 8003BF44  38 63 98 B8 */	addi r3, r3, d_d_resorce__stringBase0@l  /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003BF48  38 63 01 F1 */	addi r3, r3, 0x1f1                       /* constant-address: 80379AA9, symbol: None */
/* 8003BF4C  C8 62 83 F8 */	lfd f3, lit_4277(r2)                     /* constant-address: 80451DF8, symbol: lit_4277 */
...
/* 8003BF68  C0 42 84 00 */	lfs f2, lit_4333(r2)                     /* constant-address: 80451E00, symbol: lit_4333 */
...
/* 8003BF94  48 2A C6 35 */	bl JUTReportConsole_f                    /* constant-address: 802E85C8, symbol: JUTReportConsole_f */
/* 8003BF98  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8003BF9C  48 32 62 7D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

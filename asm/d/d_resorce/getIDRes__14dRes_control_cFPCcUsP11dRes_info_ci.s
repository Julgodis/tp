...
/* 8003C420  4B FF FE 69 */	bl getResInfoLoaded__14dRes_control_cFPCcP11dRes_info_ci /* constant-address: 8003C288, symbol: getResInfoLoaded__14dRes_control_cFPCcP11dRes_info_ci */
/* 8003C424  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8003C428  40 82 00 08 */	bne lbl_8003C430                         /* constant-address: 8003C430, symbol: lbl_8003C430 */
/* 8003C42C  48 00 00 2C */	b lbl_8003C458                           /* constant-address: 8003C458, symbol: lbl_8003C458 */
lbl_8003C430:
/* 8003C430  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8003C434  7F C4 F3 78 */	mr r4, r30                              
/* 8003C438  4B FD 2D E9 */	bl mDoExt_resIDToIndex__FP10JKRArchiveUs /* constant-address: 8000F220, symbol: mDoExt_resIDToIndex__FP10JKRArchiveUs */
/* 8003C43C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8003C440  40 80 00 0C */	bge lbl_8003C44C                         /* constant-address: 8003C44C, symbol: lbl_8003C44C */
/* 8003C444  38 60 00 00 */	li r3, 0                                
/* 8003C448  48 00 00 10 */	b lbl_8003C458                           /* constant-address: 8003C458, symbol: lbl_8003C458 */
lbl_8003C44C:

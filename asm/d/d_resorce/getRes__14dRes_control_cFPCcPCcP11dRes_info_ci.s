...
/* 8003C38C  48 32 5E 51 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8003C390  7C 9D 23 78 */	mr r29, r4                              
/* 8003C394  7C A4 2B 78 */	mr r4, r5                               
/* 8003C398  7C C5 33 78 */	mr r5, r6                               
/* 8003C39C  4B FF FE ED */	bl getResInfoLoaded__14dRes_control_cFPCcP11dRes_info_ci /* constant-address: 8003C288, symbol: getResInfoLoaded__14dRes_control_cFPCcP11dRes_info_ci */
/* 8003C3A0  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8003C3A4  40 82 00 08 */	bne lbl_8003C3AC                         /* constant-address: 8003C3AC, symbol: lbl_8003C3AC */
/* 8003C3A8  48 00 00 40 */	b lbl_8003C3E8                           /* constant-address: 8003C3E8, symbol: lbl_8003C3E8 */
lbl_8003C3AC:
/* 8003C3AC  83 DF 00 14 */	lwz r30, 0x14(r31)                      
/* 8003C3B0  7F C3 F3 78 */	mr r3, r30                              
/* 8003C3B4  7F A4 EB 78 */	mr r4, r29                              
/* 8003C3B8  48 29 A2 F5 */	bl findNameResource__10JKRArchiveCFPCc   /* constant-address: 802D66AC, symbol: findNameResource__10JKRArchiveCFPCc */
/* 8003C3BC  28 03 00 00 */	cmplwi r3, 0                            
/* 8003C3C0  41 82 00 24 */	beq lbl_8003C3E4                         /* constant-address: 8003C3E4, symbol: lbl_8003C3E4 */
...
/* 8003C3E0  48 00 00 08 */	b lbl_8003C3E8                           /* constant-address: 8003C3E8, symbol: lbl_8003C3E8 */
lbl_8003C3E4:
/* 8003C3E4  38 60 00 00 */	li r3, 0                                
lbl_8003C3E8:
/* 8003C3E8  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8003C3EC  48 32 5E 3D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

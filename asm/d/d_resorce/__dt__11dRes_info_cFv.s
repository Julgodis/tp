...
/* 8003A29C  41 82 00 90 */	beq lbl_8003A32C                         /* constant-address: 8003A32C, symbol: lbl_8003A32C */
/* 8003A2A0  80 1E 00 10 */	lwz r0, 0x10(r30)                       
/* 8003A2A4  28 00 00 00 */	cmplwi r0, 0                            
/* 8003A2A8  41 82 00 2C */	beq lbl_8003A2D4                         /* constant-address: 8003A2D4, symbol: lbl_8003A2D4 */
/* 8003A2AC  41 82 00 1C */	beq lbl_8003A2C8                         /* constant-address: 8003A2C8, symbol: lbl_8003A2C8 */
...
/* 8003A2D0  48 00 00 4C */	b lbl_8003A31C                           /* constant-address: 8003A31C, symbol: lbl_8003A31C */
lbl_8003A2D4:
/* 8003A2D4  80 1E 00 14 */	lwz r0, 0x14(r30)                       
/* 8003A2D8  28 00 00 00 */	cmplwi r0, 0                            
/* 8003A2DC  41 82 00 40 */	beq lbl_8003A31C                         /* constant-address: 8003A31C, symbol: lbl_8003A31C */
/* 8003A2E0  48 00 16 B9 */	bl deleteArchiveRes__11dRes_info_cFv     /* constant-address: 8003B998, symbol: deleteArchiveRes__11dRes_info_cFv */
/* 8003A2E4  80 7E 00 1C */	lwz r3, 0x1c(r30)                       
/* 8003A2E8  28 03 00 00 */	cmplwi r3, 0                            
/* 8003A2EC  41 82 00 24 */	beq lbl_8003A310                         /* constant-address: 8003A310, symbol: lbl_8003A310 */
/* 8003A2F0  4B FD 4E 9D */	bl mDoExt_destroySolidHeap__FP12JKRSolidHeap /* constant-address: 8000F18C, symbol: mDoExt_destroySolidHeap__FP12JKRSolidHeap */
...
/* 8003A320  40 81 00 0C */	ble lbl_8003A32C                         /* constant-address: 8003A32C, symbol: lbl_8003A32C */
/* 8003A324  7F C3 F3 78 */	mr r3, r30                              
/* 8003A328  48 29 4A 15 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_8003A32C:

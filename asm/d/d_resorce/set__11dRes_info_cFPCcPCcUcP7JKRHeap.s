...
/* 8003A358  48 32 7E 81 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8003A378  41 82 00 4C */	beq lbl_8003A3C4                         /* constant-address: 8003A3C4, symbol: lbl_8003A3C4 */
/* 8003A37C  38 61 00 08 */	addi r3, r1, 8                          
/* 8003A380  38 80 00 28 */	li r4, 0x28                             
/* 8003A384  3C A0 80 38 */	lis r5, d_d_resorce__stringBase0@ha     
/* 8003A388  38 A5 98 B8 */	addi r5, r5, d_d_resorce__stringBase0@l  /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003A38C  7D 06 43 78 */	mr r6, r8                               
/* 8003A390  7F A7 EB 78 */	mr r7, r29                              
/* 8003A394  4C C6 31 82 */	crclr 6                                 
/* 8003A398  48 32 C2 25 */	bl snprintf                              /* constant-address: 803665BC, symbol: snprintf */
/* 8003A39C  38 61 00 08 */	addi r3, r1, 8                          
/* 8003A3A0  7F C4 F3 78 */	mr r4, r30                              
/* 8003A3A4  7F E5 FB 78 */	mr r5, r31                              
/* 8003A3A8  4B FD BA 6D */	bl create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap /* constant-address: 80015E14, symbol: create__24mDoDvdThd_mountArchive_cFPCcUcP7JKRHeap */
/* 8003A3AC  90 7C 00 10 */	stw r3, 0x10(r28)                       
/* 8003A3B0  80 1C 00 10 */	lwz r0, 0x10(r28)                       
/* 8003A3B4  28 00 00 00 */	cmplwi r0, 0                            
/* 8003A3B8  40 82 00 0C */	bne lbl_8003A3C4                         /* constant-address: 8003A3C4, symbol: lbl_8003A3C4 */
/* 8003A3BC  38 60 00 00 */	li r3, 0                                
/* 8003A3C0  48 00 00 18 */	b lbl_8003A3D8                           /* constant-address: 8003A3D8, symbol: lbl_8003A3D8 */
lbl_8003A3C4:
/* 8003A3C4  7F 83 E3 78 */	mr r3, r28                              
/* 8003A3C8  7F A4 EB 78 */	mr r4, r29                              
/* 8003A3CC  38 A0 00 0A */	li r5, 0xa                              
/* 8003A3D0  48 32 E7 19 */	bl strncpy                               /* constant-address: 80368AE8, symbol: strncpy */
/* 8003A3D4  38 60 00 01 */	li r3, 1                                
lbl_8003A3D8:
/* 8003A3D8  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8003A3DC  48 32 7E 49 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

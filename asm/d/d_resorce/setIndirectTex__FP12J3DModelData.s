...
/* 8003A4A0  48 32 7D 35 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 8003A4A4  83 C3 00 6C */	lwz r30, 0x6c(r3)                       
/* 8003A4A8  28 1E 00 00 */	cmplwi r30, 0                           
/* 8003A4AC  41 82 03 58 */	beq lbl_8003A804                         /* constant-address: 8003A804, symbol: lbl_8003A804 */
/* 8003A4B0  83 A3 00 70 */	lwz r29, 0x70(r3)                       
/* 8003A4B4  28 1D 00 00 */	cmplwi r29, 0                           
/* 8003A4B8  41 82 03 4C */	beq lbl_8003A804                         /* constant-address: 8003A804, symbol: lbl_8003A804 */
/* 8003A4BC  3B 60 00 00 */	li r27, 0                               
/* 8003A4C0  3C 60 80 38 */	lis r3, d_d_resorce__stringBase0@ha     
/* 8003A4C4  3B E3 98 B8 */	addi r31, r3, d_d_resorce__stringBase0@l /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003A4C8  48 00 03 2C */	b lbl_8003A7F4                           /* constant-address: 8003A7F4, symbol: lbl_8003A7F4 */
lbl_8003A4CC:
/* 8003A4CC  7F A3 EB 78 */	mr r3, r29                              
/* 8003A4D0  7F 64 DB 78 */	mr r4, r27                              
/* 8003A4D4  48 2A 46 25 */	bl getName__10JUTNameTabCFUs             /* constant-address: 802DEAF8, symbol: getName__10JUTNameTabCFUs */
/* 8003A4D8  7C 7C 1B 78 */	mr r28, r3                              
/* 8003A4DC  38 9F 00 09 */	addi r4, r31, 9                          /* constant-address: 803798C1, symbol: None */
/* 8003A4E0  38 A0 00 0C */	li r5, 0xc                              
/* 8003A4E4  48 32 BB A9 */	bl memcmp                                /* constant-address: 8036608C, symbol: memcmp */
/* 8003A4E8  2C 03 00 00 */	cmpwi r3, 0                             
/* 8003A4EC  40 82 00 F4 */	bne lbl_8003A5E0                         /* constant-address: 8003A5E0, symbol: lbl_8003A5E0 */
/* 8003A4F0  80 8D 86 4C */	lwz r4, mFrameBufferTimg__13mDoGph_gInf_c(r13) /* constant-address: 80450BCC, symbol: mFrameBufferTimg__13mDoGph_gInf_c */
...
/* 8003A5E4  38 9F 00 15 */	addi r4, r31, 0x15                       /* constant-address: 803798CD, symbol: None */
/* 8003A5E8  38 A0 00 06 */	li r5, 6                                
/* 8003A5EC  48 32 BA A1 */	bl memcmp                                /* constant-address: 8036608C, symbol: memcmp */
/* 8003A5F0  2C 03 00 00 */	cmpwi r3, 0                             
/* 8003A5F4  40 82 00 F4 */	bne lbl_8003A6E8                         /* constant-address: 8003A6E8, symbol: lbl_8003A6E8 */
/* 8003A5F8  80 8D 86 4C */	lwz r4, mFrameBufferTimg__13mDoGph_gInf_c(r13) /* constant-address: 80450BCC, symbol: mFrameBufferTimg__13mDoGph_gInf_c */
...
/* 8003A6EC  38 9F 00 1B */	addi r4, r31, 0x1b                       /* constant-address: 803798D3, symbol: None */
/* 8003A6F0  38 A0 00 08 */	li r5, 8                                
/* 8003A6F4  48 32 B9 99 */	bl memcmp                                /* constant-address: 8036608C, symbol: memcmp */
/* 8003A6F8  2C 03 00 00 */	cmpwi r3, 0                             
/* 8003A6FC  40 82 00 F4 */	bne lbl_8003A7F0                         /* constant-address: 8003A7F0, symbol: lbl_8003A7F0 */
/* 8003A700  80 8D 86 54 */	lwz r4, mZbufferTimg__13mDoGph_gInf_c(r13) /* constant-address: 80450BD4, symbol: mZbufferTimg__13mDoGph_gInf_c */
...
lbl_8003A7F0:
/* 8003A7F0  3B 7B 00 01 */	addi r27, r27, 1                         /* constant-address: 00000001 */
lbl_8003A7F4:
/* 8003A7F4  57 63 04 3E */	clrlwi r3, r27, 0x10                    
/* 8003A7F8  A0 1E 00 00 */	lhz r0, 0(r30)                          
/* 8003A7FC  7C 03 00 40 */	cmplw r3, r0                            
/* 8003A800  41 80 FC CC */	blt lbl_8003A4CC                         /* constant-address: 8003A4CC, symbol: lbl_8003A4CC */
lbl_8003A804:
/* 8003A804  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8003A808  48 32 7A 19 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

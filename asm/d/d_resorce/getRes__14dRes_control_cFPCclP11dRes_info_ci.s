...
/* 8003C310  4B FF FF 79 */	bl getResInfoLoaded__14dRes_control_cFPCcP11dRes_info_ci /* constant-address: 8003C288, symbol: getResInfoLoaded__14dRes_control_cFPCcP11dRes_info_ci */
/* 8003C314  28 03 00 00 */	cmplwi r3, 0                            
/* 8003C318  40 82 00 08 */	bne lbl_8003C320                         /* constant-address: 8003C320, symbol: lbl_8003C320 */
/* 8003C31C  48 00 00 48 */	b lbl_8003C364                           /* constant-address: 8003C364, symbol: lbl_8003C364 */
lbl_8003C320:
...
/* 8003C330  41 80 00 28 */	blt lbl_8003C358                         /* constant-address: 8003C358, symbol: lbl_8003C358 */
/* 8003C334  3C 60 80 38 */	lis r3, d_d_resorce__stringBase0@ha     
/* 8003C338  38 63 98 B8 */	addi r3, r3, d_d_resorce__stringBase0@l  /* constant-address: 803798B8, symbol: d_d_resorce__stringBase0 */
/* 8003C33C  38 63 02 E8 */	addi r3, r3, 0x2e8                       /* constant-address: 80379BA0, symbol: None */
/* 8003C340  7F C4 F3 78 */	mr r4, r30                              
/* 8003C344  7F E5 FB 78 */	mr r5, r31                              
/* 8003C348  4C C6 31 82 */	crclr 6                                 
/* 8003C34C  4B FC A8 C1 */	bl OSReport_Error                        /* constant-address: 80006C0C, symbol: OSReport_Error */
/* 8003C350  38 60 00 00 */	li r3, 0                                
/* 8003C354  48 00 00 10 */	b lbl_8003C364                           /* constant-address: 8003C364, symbol: lbl_8003C364 */
lbl_8003C358:

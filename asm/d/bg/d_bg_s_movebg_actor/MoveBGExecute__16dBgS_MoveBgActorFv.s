...
/* 80078990  40 82 00 50 */	bne lbl_800789E0                         /* constant-address: 800789E0, symbol: lbl_800789E0 */
/* 80078994  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 80078998  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8007899C  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)                      
/* 800789A0  C0 5E 04 D4 */	lfs f2, 0x4d4(r30)                      
/* 800789A4  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)                      
/* 800789A8  48 2C DF 41 */	bl PSMTXTrans                            /* constant-address: 803468E8, symbol: PSMTXTrans */
/* 800789AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800789B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800789B4  A8 9E 04 E6 */	lha r4, 0x4e6(r30)                      
/* 800789B8  4B F9 3A 7D */	bl mDoMtx_YrotM__FPA4_fs                 /* constant-address: 8000C434, symbol: mDoMtx_YrotM__FPA4_fs */
/* 800789BC  C0 3E 04 EC */	lfs f1, 0x4ec(r30)                      
/* 800789C0  C0 5E 04 F0 */	lfs f2, 0x4f0(r30)                      
/* 800789C4  C0 7E 04 F4 */	lfs f3, 0x4f4(r30)                      
/* 800789C8  4B F9 44 71 */	bl scaleM__14mDoMtx_stack_cFfff          /* constant-address: 8000CE38, symbol: scaleM__14mDoMtx_stack_cFfff */
/* 800789CC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800789D0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800789D4  38 9E 05 6C */	addi r4, r30, 0x56c                     
/* 800789D8  48 2C DA D9 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 800789DC  48 00 00 0C */	b lbl_800789E8                           /* constant-address: 800789E8, symbol: lbl_800789E8 */
lbl_800789E0:
/* 800789E0  38 9E 05 6C */	addi r4, r30, 0x56c                     
/* 800789E4  48 2C DA CD */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
lbl_800789E8:
/* 800789E8  80 7E 05 68 */	lwz r3, 0x568(r30)                      
/* 800789EC  28 03 00 00 */	cmplwi r3, 0                            
/* 800789F0  41 82 00 08 */	beq lbl_800789F8                         /* constant-address: 800789F8, symbol: lbl_800789F8 */
/* 800789F4  48 00 2F CD */	bl Move__4dBgWFv                         /* constant-address: 8007B9C0, symbol: Move__4dBgWFv */
lbl_800789F8:

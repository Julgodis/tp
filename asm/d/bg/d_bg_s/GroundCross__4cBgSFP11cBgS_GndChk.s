...
/* 800744B0  48 2E DD 2D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 800744B4  7C 7E 1B 78 */	mr r30, r3                              
/* 800744B8  7C 9D 23 78 */	mr r29, r4                              
/* 800744BC  C0 02 8C B8 */	lfs f0, lit_3738(r2)                     /* constant-address: 804526B8, symbol: lit_3738 */
/* 800744C0  D0 04 00 34 */	stfs f0, 0x34(r4)                       
/* 800744C4  38 7D 00 14 */	addi r3, r29, 0x14                      
/* 800744C8  48 1F 3C 59 */	bl ClearPi__13cBgS_PolyInfoFv            /* constant-address: 80268120, symbol: ClearPi__13cBgS_PolyInfoFv */
/* 800744CC  7F A3 EB 78 */	mr r3, r29                              
/* 800744D0  48 1F 38 75 */	bl PreCheck__11cBgS_GndChkFv             /* constant-address: 80267D44, symbol: PreCheck__11cBgS_GndChkFv */
...
/* 800744E4  41 82 00 68 */	beq lbl_8007454C                         /* constant-address: 8007454C, symbol: lbl_8007454C */
...
/* 80074500  40 82 00 4C */	bne lbl_8007454C                         /* constant-address: 8007454C, symbol: lbl_8007454C */
/* 80074504  7F A3 EB 78 */	mr r3, r29                              
/* 80074508  80 9F 00 08 */	lwz r4, 8(r31)                          
/* 8007450C  48 1F 36 D1 */	bl ChkSameActorPid__8cBgS_ChkCFUi        /* constant-address: 80267BDC, symbol: ChkSameActorPid__8cBgS_ChkCFUi */
/* 80074510  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80074514  40 82 00 38 */	bne lbl_8007454C                         /* constant-address: 8007454C, symbol: lbl_8007454C */
...
/* 80074534  41 82 00 18 */	beq lbl_8007454C                         /* constant-address: 8007454C, symbol: lbl_8007454C */
...
/* 80074548  48 1F 3C 25 */	bl SetActorInfo__13cBgS_PolyInfoFiPvUi   /* constant-address: 8026816C, symbol: SetActorInfo__13cBgS_PolyInfoFiPvUi */
lbl_8007454C:
/* 8007454C  3B DE 00 01 */	addi r30, r30, 1                        
/* 80074550  2C 1E 01 00 */	cmpwi r30, 0x100                        
/* 80074554  3B FF 00 14 */	addi r31, r31, 0x14                     
/* 80074558  41 80 FF 84 */	blt lbl_800744DC                         /* constant-address: 800744DC, symbol: lbl_800744DC */
/* 8007455C  C0 3D 00 34 */	lfs f1, 0x34(r29)                       
/* 80074560  39 61 00 20 */	addi r11, r1, 0x20                      
/* 80074564  48 2E DC C5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 80075574  48 2E CC 61 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 80075578  7C 7C 1B 78 */	mr r28, r3                              
/* 8007557C  7C 9B 23 78 */	mr r27, r4                              
/* 80075580  3B E0 00 00 */	li r31, 0                               
/* 80075584  7F 63 DB 78 */	mr r3, r27                              
/* 80075588  48 00 37 85 */	bl Init__14dBgS_SplGrpChkFv              /* constant-address: 80078D0C, symbol: Init__14dBgS_SplGrpChkFv */
...
/* 8007559C  41 82 00 C0 */	beq lbl_8007565C                         /* constant-address: 8007565C, symbol: lbl_8007565C */
...
/* 800755B8  40 82 00 A4 */	bne lbl_8007565C                         /* constant-address: 8007565C, symbol: lbl_8007565C */
/* 800755BC  38 7B 00 10 */	addi r3, r27, 0x10                      
/* 800755C0  80 9E 00 08 */	lwz r4, 8(r30)                          
/* 800755C4  48 1F 26 19 */	bl ChkSameActorPid__8cBgS_ChkCFUi        /* constant-address: 80267BDC, symbol: ChkSameActorPid__8cBgS_ChkCFUi */
/* 800755C8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800755CC  40 82 00 90 */	bne lbl_8007565C                         /* constant-address: 8007565C, symbol: lbl_8007565C */
/* 800755D0  83 9E 00 00 */	lwz r28, 0(r30)                         
/* 800755D4  80 1B 00 50 */	lwz r0, 0x50(r27)                       
/* 800755D8  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d           
/* 800755DC  41 82 00 3C */	beq lbl_80075618                         /* constant-address: 80075618, symbol: lbl_80075618 */
...
/* 800755F8  41 82 00 64 */	beq lbl_8007565C                         /* constant-address: 8007565C, symbol: lbl_8007565C */
...
/* 80075614  40 82 00 48 */	bne lbl_8007565C                         /* constant-address: 8007565C, symbol: lbl_8007565C */
lbl_80075618:
...
/* 80075634  41 82 00 28 */	beq lbl_8007565C                         /* constant-address: 8007565C, symbol: lbl_8007565C */
...
/* 8007564C  48 1F 2B 21 */	bl SetActorInfo__13cBgS_PolyInfoFiPvUi   /* constant-address: 8026816C, symbol: SetActorInfo__13cBgS_PolyInfoFiPvUi */
...
/* 80075668  41 80 FF 2C */	blt lbl_80075594                         /* constant-address: 80075594, symbol: lbl_80075594 */
/* 8007566C  7F E3 FB 78 */	mr r3, r31                              
/* 80075670  39 61 00 20 */	addi r11, r1, 0x20                      
/* 80075674  48 2E CB AD */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

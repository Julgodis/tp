...
/* 8007D340  48 2E 4E 95 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8007D368  48 1F 19 21 */	bl CrossY__8cM3dGAabCFPC4cXyz            /* constant-address: 8026EC88, symbol: CrossY__8cM3dGAabCFPC4cXyz */
/* 8007D36C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007D370  41 82 00 2C */	beq lbl_8007D39C                         /* constant-address: 8007D39C, symbol: lbl_8007D39C */
/* 8007D374  38 7C 00 04 */	addi r3, r28, 4                         
/* 8007D378  C0 3E 00 4C */	lfs f1, 0x4c(r30)                       
/* 8007D37C  48 1F 19 55 */	bl UnderPlaneYUnder__8cM3dGAabCFf        /* constant-address: 8026ECD0, symbol: UnderPlaneYUnder__8cM3dGAabCFf */
/* 8007D380  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007D384  41 82 00 18 */	beq lbl_8007D39C                         /* constant-address: 8007D39C, symbol: lbl_8007D39C */
/* 8007D388  38 7C 00 04 */	addi r3, r28, 4                         
/* 8007D38C  C0 3E 00 40 */	lfs f1, 0x40(r30)                       
/* 8007D390  48 1F 19 55 */	bl TopPlaneYUnder__8cM3dGAabCFf          /* constant-address: 8026ECE4, symbol: TopPlaneYUnder__8cM3dGAabCFf */
/* 8007D394  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007D398  41 82 00 0C */	beq lbl_8007D3A4                         /* constant-address: 8007D3A4, symbol: lbl_8007D3A4 */
lbl_8007D39C:
/* 8007D39C  38 60 00 00 */	li r3, 0                                
/* 8007D3A0  48 00 00 B8 */	b lbl_8007D458                           /* constant-address: 8007D458, symbol: lbl_8007D458 */
lbl_8007D3A4:
...
/* 8007D3C8  41 82 00 0C */	beq lbl_8007D3D4                         /* constant-address: 8007D3D4, symbol: lbl_8007D3D4 */
/* 8007D3CC  38 60 00 00 */	li r3, 0                                
/* 8007D3D0  48 00 00 88 */	b lbl_8007D458                           /* constant-address: 8007D458, symbol: lbl_8007D458 */
lbl_8007D3D4:
...
/* 8007D3F0  41 82 00 1C */	beq lbl_8007D40C                         /* constant-address: 8007D40C, symbol: lbl_8007D40C */
/* 8007D3F4  7F A3 EB 78 */	mr r3, r29                              
/* 8007D3F8  7F C4 F3 78 */	mr r4, r30                              
/* 8007D3FC  4B FF FE 0D */	bl RoofChkRp__4dBgWFP12dBgS_RoofChki     /* constant-address: 8007D208, symbol: RoofChkRp__4dBgWFP12dBgS_RoofChki */
/* 8007D400  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007D404  41 82 00 08 */	beq lbl_8007D40C                         /* constant-address: 8007D40C, symbol: lbl_8007D40C */
...
/* 8007D418  41 82 00 3C */	beq lbl_8007D454                         /* constant-address: 8007D454, symbol: lbl_8007D454 */
...
/* 8007D42C  4B FF FF 05 */	bl RoofChkGrpRp__4dBgWFP12dBgS_RoofChkii /* constant-address: 8007D330, symbol: RoofChkGrpRp__4dBgWFP12dBgS_RoofChkii */
/* 8007D430  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007D434  41 82 00 08 */	beq lbl_8007D43C                         /* constant-address: 8007D43C, symbol: lbl_8007D43C */
...
/* 8007D450  4B FF FF C0 */	b lbl_8007D410                           /* constant-address: 8007D410, symbol: lbl_8007D410 */
lbl_8007D454:
/* 8007D454  7F 83 E3 78 */	mr r3, r28                              
lbl_8007D458:
/* 8007D458  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8007D45C  48 2E 4D C5 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

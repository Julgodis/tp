...
/* 8007C968  48 2E 58 5D */	bl _savegpr_23                           /* constant-address: 803621C4, symbol: _savegpr_23 */
/* 8007C96C  7C 78 1B 78 */	mr r24, r3                              
/* 8007C970  7C 99 23 78 */	mr r25, r4                              
/* 8007C974  38 00 00 00 */	li r0, 0                                
/* 8007C978  90 0D 8A 00 */	stw r0, l_start(r13)                     /* constant-address: 80450F80, symbol: l_start */
/* 8007C97C  90 0D 8A 04 */	stw r0, l_wcsbuf_num(r13)                /* constant-address: 80450F84, symbol: l_wcsbuf_num */
/* 8007C980  A0 A3 00 92 */	lhz r5, 0x92(r3)                        
/* 8007C984  38 C0 00 01 */	li r6, 1                                
/* 8007C988  4B FF FE 81 */	bl WallCorrectGrpRpSort__4dBgWFP9dBgS_Acchii /* constant-address: 8007C808, symbol: WallCorrectGrpRpSort__4dBgWFP9dBgS_Acchii */
/* 8007C98C  3B E0 00 00 */	li r31, 0                               
/* 8007C990  83 CD 8A 00 */	lwz r30, l_start(r13)                    /* constant-address: 80450F80, symbol: l_start */
/* 8007C994  C3 E2 8C F8 */	lfs f31, lit_3717(r2)                    /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007C998  C3 C2 8D 04 */	lfs f30, lit_3937(r2)                    /* constant-address: 80452704, symbol: lit_3937 */
lbl_8007C99C:
/* 8007C99C  28 1E 00 00 */	cmplwi r30, 0                           
/* 8007C9A0  41 82 06 D8 */	beq lbl_8007D078                         /* constant-address: 8007D078, symbol: lbl_8007D078 */
...
/* 8007C9CC  40 81 00 0C */	ble lbl_8007C9D8                         /* constant-address: 8007C9D8, symbol: lbl_8007C9D8 */
...
/* 8007C9F4  48 00 06 70 */	b lbl_8007D064                           /* constant-address: 8007D064, symbol: lbl_8007D064 */
lbl_8007C9F8:
/* 8007C9F8  80 79 00 8C */	lwz r3, 0x8c(r25)                       
/* 8007C9FC  38 17 00 34 */	addi r0, r23, 0x34                       /* constant-address: 00000034 */
...
/* 8007CA30  40 82 00 38 */	bne lbl_8007CA68                         /* constant-address: 8007CA68, symbol: lbl_8007CA68 */
/* 8007CA34  C3 03 00 30 */	lfs f24, 0x30(r3)                       
/* 8007CA38  7F 23 CB 78 */	mr r3, r25                              
/* 8007CA3C  4B FF A7 A9 */	bl GetSpeedY__9dBgS_AcchFv               /* constant-address: 800771E4, symbol: GetSpeedY__9dBgS_AcchFv */
/* 8007CA40  FE E0 08 90 */	fmr f23, f1                             
/* 8007CA44  7F 23 CB 78 */	mr r3, r25                              
/* 8007CA48  38 81 00 30 */	addi r4, r1, 0x30                       
/* 8007CA4C  4B FF A7 B5 */	bl GetWallAddY__9dBgS_AcchFR3Vec         /* constant-address: 80077200, symbol: GetWallAddY__9dBgS_AcchFR3Vec */
...
/* 8007CA64  48 00 00 08 */	b lbl_8007CA6C                           /* constant-address: 8007CA6C, symbol: lbl_8007CA6C */
lbl_8007CA68:
...
/* 8007CABC  40 81 00 14 */	ble lbl_8007CAD0                         /* constant-address: 8007CAD0, symbol: lbl_8007CAD0 */
/* 8007CAC0  FC 01 F8 40 */	fcmpo cr0, f1, f31                      
/* 8007CAC4  40 81 00 0C */	ble lbl_8007CAD0                         /* constant-address: 8007CAD0, symbol: lbl_8007CAD0 */
/* 8007CAC8  FC 00 F8 40 */	fcmpo cr0, f0, f31                      
/* 8007CACC  41 81 05 90 */	bgt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
lbl_8007CAD0:
/* 8007CAD0  C0 22 8C F8 */	lfs f1, lit_3717(r2)                     /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007CAD4  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8007CAD8  40 80 00 1C */	bge lbl_8007CAF4                         /* constant-address: 8007CAF4, symbol: lbl_8007CAF4 */
/* 8007CADC  C0 01 00 28 */	lfs f0, 0x28(r1)                        
/* 8007CAE0  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CAE4  40 80 00 10 */	bge lbl_8007CAF4                         /* constant-address: 8007CAF4, symbol: lbl_8007CAF4 */
/* 8007CAE8  C0 01 00 2C */	lfs f0, 0x2c(r1)                        
/* 8007CAEC  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CAF0  41 80 05 6C */	blt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
lbl_8007CAF4:
/* 8007CAF4  38 60 00 00 */	li r3, 0                                
/* 8007CAF8  FC 00 12 10 */	fabs f0, f2                             
/* 8007CAFC  FC 20 00 18 */	frsp f1, f0                             
/* 8007CB00  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007CB04  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8007CB08  40 80 00 08 */	bge lbl_8007CB10                         /* constant-address: 8007CB10, symbol: lbl_8007CB10 */
...
/* 8007CB1C  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007CB20  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8007CB24  40 80 00 08 */	bge lbl_8007CB2C                         /* constant-address: 8007CB2C, symbol: lbl_8007CB2C */
/* 8007CB28  38 63 00 01 */	addi r3, r3, 1                           /* constant-address: 00000001 */
lbl_8007CB2C:
/* 8007CB2C  C0 01 00 2C */	lfs f0, 0x2c(r1)                        
/* 8007CB30  FC 00 02 10 */	fabs f0, f0                             
/* 8007CB34  FC 20 00 18 */	frsp f1, f0                             
/* 8007CB38  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007CB3C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8007CB40  40 80 00 08 */	bge lbl_8007CB48                         /* constant-address: 8007CB48, symbol: lbl_8007CB48 */
/* 8007CB44  38 63 00 01 */	addi r3, r3, 1                          
lbl_8007CB48:
/* 8007CB48  2C 03 00 01 */	cmpwi r3, 1                             
/* 8007CB4C  41 82 05 10 */	beq lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CB50  C0 41 00 24 */	lfs f2, 0x24(r1)                        
/* 8007CB54  C0 22 8C F8 */	lfs f1, lit_3717(r2)                     /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007CB58  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8007CB5C  40 81 00 24 */	ble lbl_8007CB80                         /* constant-address: 8007CB80, symbol: lbl_8007CB80 */
/* 8007CB60  C0 01 00 28 */	lfs f0, 0x28(r1)                        
/* 8007CB64  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CB68  4C 40 13 82 */	cror 2, 0, 2                            
/* 8007CB6C  40 82 00 14 */	bne lbl_8007CB80                         /* constant-address: 8007CB80, symbol: lbl_8007CB80 */
/* 8007CB70  C0 01 00 2C */	lfs f0, 0x2c(r1)                        
/* 8007CB74  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CB78  4C 40 13 82 */	cror 2, 0, 2                            
/* 8007CB7C  41 82 00 30 */	beq lbl_8007CBAC                         /* constant-address: 8007CBAC, symbol: lbl_8007CBAC */
lbl_8007CB80:
/* 8007CB80  C0 22 8C F8 */	lfs f1, lit_3717(r2)                     /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007CB84  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8007CB88  40 80 00 34 */	bge lbl_8007CBBC                         /* constant-address: 8007CBBC, symbol: lbl_8007CBBC */
/* 8007CB8C  C0 01 00 28 */	lfs f0, 0x28(r1)                        
/* 8007CB90  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CB94  4C 41 13 82 */	cror 2, 1, 2                            
/* 8007CB98  40 82 00 24 */	bne lbl_8007CBBC                         /* constant-address: 8007CBBC, symbol: lbl_8007CBBC */
/* 8007CB9C  C0 01 00 2C */	lfs f0, 0x2c(r1)                        
/* 8007CBA0  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CBA4  4C 41 13 82 */	cror 2, 1, 2                            
/* 8007CBA8  40 82 00 14 */	bne lbl_8007CBBC                         /* constant-address: 8007CBBC, symbol: lbl_8007CBBC */
lbl_8007CBAC:
/* 8007CBAC  38 A0 00 00 */	li r5, 0                                
/* 8007CBB0  38 80 00 01 */	li r4, 1                                
/* 8007CBB4  38 C0 00 02 */	li r6, 2                                
/* 8007CBB8  48 00 00 74 */	b lbl_8007CC2C                           /* constant-address: 8007CC2C, symbol: lbl_8007CC2C */
lbl_8007CBBC:
/* 8007CBBC  C0 61 00 28 */	lfs f3, 0x28(r1)                        
/* 8007CBC0  C0 22 8C F8 */	lfs f1, lit_3717(r2)                     /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007CBC4  FC 03 08 40 */	fcmpo cr0, f3, f1                       
/* 8007CBC8  40 81 00 20 */	ble lbl_8007CBE8                         /* constant-address: 8007CBE8, symbol: lbl_8007CBE8 */
/* 8007CBCC  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8007CBD0  4C 40 13 82 */	cror 2, 0, 2                            
/* 8007CBD4  40 82 00 14 */	bne lbl_8007CBE8                         /* constant-address: 8007CBE8, symbol: lbl_8007CBE8 */
/* 8007CBD8  C0 01 00 2C */	lfs f0, 0x2c(r1)                        
/* 8007CBDC  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CBE0  4C 40 13 82 */	cror 2, 0, 2                            
/* 8007CBE4  41 82 00 2C */	beq lbl_8007CC10                         /* constant-address: 8007CC10, symbol: lbl_8007CC10 */
lbl_8007CBE8:
/* 8007CBE8  C0 22 8C F8 */	lfs f1, lit_3717(r2)                     /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007CBEC  FC 03 08 40 */	fcmpo cr0, f3, f1                       
/* 8007CBF0  40 80 00 30 */	bge lbl_8007CC20                         /* constant-address: 8007CC20, symbol: lbl_8007CC20 */
/* 8007CBF4  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8007CBF8  4C 41 13 82 */	cror 2, 1, 2                            
/* 8007CBFC  40 82 00 24 */	bne lbl_8007CC20                         /* constant-address: 8007CC20, symbol: lbl_8007CC20 */
/* 8007CC00  C0 01 00 2C */	lfs f0, 0x2c(r1)                        
/* 8007CC04  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CC08  4C 41 13 82 */	cror 2, 1, 2                            
/* 8007CC0C  40 82 00 14 */	bne lbl_8007CC20                         /* constant-address: 8007CC20, symbol: lbl_8007CC20 */
lbl_8007CC10:
/* 8007CC10  38 A0 00 01 */	li r5, 1                                
/* 8007CC14  38 80 00 00 */	li r4, 0                                
/* 8007CC18  38 C0 00 02 */	li r6, 2                                
/* 8007CC1C  48 00 00 10 */	b lbl_8007CC2C                           /* constant-address: 8007CC2C, symbol: lbl_8007CC2C */
lbl_8007CC20:
...
/* 8007CC58  C0 2D 8C 00 */	lfs f1, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007CC5C  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CC60  41 80 03 FC */	blt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CC64  FC 00 2A 10 */	fabs f0, f5                             
/* 8007CC68  FC 00 00 18 */	frsp f0, f0                             
/* 8007CC6C  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8007CC70  41 80 03 EC */	blt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
...
/* 8007CCC8  40 82 00 38 */	bne lbl_8007CD00                         /* constant-address: 8007CD00, symbol: lbl_8007CD00 */
...
/* 8007CCFC  48 00 00 70 */	b lbl_8007CD6C                           /* constant-address: 8007CD6C, symbol: lbl_8007CD6C */
lbl_8007CD00:
/* 8007CD00  2C 05 00 01 */	cmpwi r5, 1                             
/* 8007CD04  40 82 00 38 */	bne lbl_8007CD3C                         /* constant-address: 8007CD3C, symbol: lbl_8007CD3C */
...
/* 8007CD38  48 00 00 34 */	b lbl_8007CD6C                           /* constant-address: 8007CD6C, symbol: lbl_8007CD6C */
lbl_8007CD3C:
...
/* 8007CDAC  48 1E B8 81 */	bl cM3d_Len2dSqPntAndSegLine__FffffffPfPfPf /* constant-address: 8026862C, symbol: cM3d_Len2dSqPntAndSegLine__FffffffPfPfPf */
...
/* 8007CDD0  38 17 00 28 */	addi r0, r23, 0x28                       /* constant-address: 00000028 */
/* 8007CDD4  7F A4 04 2E */	lfsx f29, r4, r0                        
/* 8007CDD8  C0 41 00 20 */	lfs f2, 0x20(r1)                        
/* 8007CDDC  FC 02 E8 40 */	fcmpo cr0, f2, f29                      
/* 8007CDE0  41 81 02 7C */	bgt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
...
/* 8007CDF8  C0 02 8C F8 */	lfs f0, lit_3717(r2)                     /* constant-address: 804526F8, symbol: lit_3717 */
/* 8007CDFC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8007CE00  41 80 02 5C */	blt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CE04  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8007CE08  28 00 00 01 */	cmplwi r0, 1                            
/* 8007CE0C  40 82 00 74 */	bne lbl_8007CE80                         /* constant-address: 8007CE80, symbol: lbl_8007CE80 */
/* 8007CE10  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8007CE14  40 81 00 0C */	ble lbl_8007CE20                         /* constant-address: 8007CE20, symbol: lbl_8007CE20 */
...
/* 8007CE30  4B FF EB BD */	bl positionWallCorrect__4dBgWFP9dBgS_AcchfR8cM3dGPlaP4cXyzf /* constant-address: 8007B9EC, symbol: positionWallCorrect__4dBgWFP9dBgS_AcchfR8cM3dGPlaP4cXyzf */
/* 8007CE34  7F 23 CB 78 */	mr r3, r25                              
/* 8007CE38  4B FF A4 B1 */	bl CalcMovePosWork__9dBgS_AcchFv         /* constant-address: 800772E8, symbol: CalcMovePosWork__9dBgS_AcchFv */
/* 8007CE3C  80 99 00 8C */	lwz r4, 0x8c(r25)                       
/* 8007CE40  38 77 00 10 */	addi r3, r23, 0x10                       /* constant-address: 00000010 */
...
/* 8007CE5C  4B FF A4 2D */	bl SetWallPolyIndex__9dBgS_AcchFii       /* constant-address: 80077288, symbol: SetWallPolyIndex__9dBgS_AcchFii */
/* 8007CE60  C0 3C 00 00 */	lfs f1, 0(r28)                          
/* 8007CE64  C0 5C 00 08 */	lfs f2, 8(r28)                          
/* 8007CE68  48 1E A8 0D */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */
/* 8007CE6C  80 99 00 8C */	lwz r4, 0x8c(r25)                       
/* 8007CE70  38 17 00 3C */	addi r0, r23, 0x3c                       /* constant-address: 0000003C */
/* 8007CE74  7C 64 03 2E */	sthx r3, r4, r0                         
/* 8007CE78  3B E0 00 01 */	li r31, 1                               
/* 8007CE7C  48 00 01 E0 */	b lbl_8007D05C                           /* constant-address: 8007D05C, symbol: lbl_8007D05C */
lbl_8007CE80:
...
/* 8007CE98  48 1E B7 7D */	bl cM3d_Len2dSq__Fffff                   /* constant-address: 80268614, symbol: cM3d_Len2dSq__Fffff */
...
/* 8007CEB4  48 1E B7 61 */	bl cM3d_Len2dSq__Fffff                   /* constant-address: 80268614, symbol: cM3d_Len2dSq__Fffff */
...
/* 8007CECC  40 80 00 CC */	bge lbl_8007CF98                         /* constant-address: 8007CF98, symbol: lbl_8007CF98 */
/* 8007CED0  FC 17 E8 40 */	fcmpo cr0, f23, f29                     
/* 8007CED4  41 81 01 88 */	bgt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CED8  EC 17 E8 28 */	fsubs f0, f23, f29                      
/* 8007CEDC  FC 00 02 10 */	fabs f0, f0                             
/* 8007CEE0  FC 20 00 18 */	frsp f1, f0                             
/* 8007CEE4  C0 02 8D 10 */	lfs f0, lit_4962(r2)                     /* constant-address: 80452710, symbol: lit_4962 */
/* 8007CEE8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8007CEEC  41 80 01 70 */	blt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CEF0  80 19 00 8C */	lwz r0, 0x8c(r25)                       
/* 8007CEF4  38 77 00 14 */	addi r3, r23, 0x14                       /* constant-address: 00000014 */
...
/* 8007CF0C  48 1E B3 55 */	bl cM2d_CrossCirLin__FR8cM2dGCirffffPfPf /* constant-address: 80268260, symbol: cM2d_CrossCirLin__FR8cM2dGCirffffPfPf */
...
/* 8007CF44  4B FF A3 A5 */	bl CalcMovePosWork__9dBgS_AcchFv         /* constant-address: 800772E8, symbol: CalcMovePosWork__9dBgS_AcchFv */
/* 8007CF48  80 99 00 8C */	lwz r4, 0x8c(r25)                       
/* 8007CF4C  38 77 00 10 */	addi r3, r23, 0x10                       /* constant-address: 00000010 */
...
/* 8007CF68  4B FF A3 21 */	bl SetWallPolyIndex__9dBgS_AcchFii       /* constant-address: 80077288, symbol: SetWallPolyIndex__9dBgS_AcchFii */
/* 8007CF6C  C0 3C 00 00 */	lfs f1, 0(r28)                          
/* 8007CF70  C0 5C 00 08 */	lfs f2, 8(r28)                          
/* 8007CF74  48 1E A7 01 */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */
/* 8007CF78  80 99 00 8C */	lwz r4, 0x8c(r25)                       
/* 8007CF7C  38 17 00 3C */	addi r0, r23, 0x3c                       /* constant-address: 0000003C */
...
/* 8007CF94  48 00 00 C8 */	b lbl_8007D05C                           /* constant-address: 8007D05C, symbol: lbl_8007D05C */
lbl_8007CF98:
/* 8007CF98  FC 01 E8 40 */	fcmpo cr0, f1, f29                      
/* 8007CF9C  41 81 00 C0 */	bgt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CFA0  EC 01 E8 28 */	fsubs f0, f1, f29                       
/* 8007CFA4  FC 00 02 10 */	fabs f0, f0                             
/* 8007CFA8  FC 20 00 18 */	frsp f1, f0                             
/* 8007CFAC  C0 02 8D 10 */	lfs f0, lit_4962(r2)                     /* constant-address: 80452710, symbol: lit_4962 */
/* 8007CFB0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8007CFB4  41 80 00 A8 */	blt lbl_8007D05C                         /* constant-address: 8007D05C, symbol: lbl_8007D05C */
/* 8007CFB8  80 19 00 8C */	lwz r0, 0x8c(r25)                       
/* 8007CFBC  38 77 00 14 */	addi r3, r23, 0x14                       /* constant-address: 00000014 */
...
/* 8007CFD4  48 1E B2 8D */	bl cM2d_CrossCirLin__FR8cM2dGCirffffPfPf /* constant-address: 80268260, symbol: cM2d_CrossCirLin__FR8cM2dGCirffffPfPf */
...
/* 8007D00C  4B FF A2 DD */	bl CalcMovePosWork__9dBgS_AcchFv         /* constant-address: 800772E8, symbol: CalcMovePosWork__9dBgS_AcchFv */
/* 8007D010  80 99 00 8C */	lwz r4, 0x8c(r25)                       
/* 8007D014  38 77 00 10 */	addi r3, r23, 0x10                       /* constant-address: 00000010 */
...
/* 8007D030  4B FF A2 59 */	bl SetWallPolyIndex__9dBgS_AcchFii       /* constant-address: 80077288, symbol: SetWallPolyIndex__9dBgS_AcchFii */
/* 8007D034  C0 3C 00 00 */	lfs f1, 0(r28)                          
/* 8007D038  C0 5C 00 08 */	lfs f2, 8(r28)                          
/* 8007D03C  48 1E A6 39 */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */
/* 8007D040  80 99 00 8C */	lwz r4, 0x8c(r25)                       
/* 8007D044  38 17 00 3C */	addi r0, r23, 0x3c                       /* constant-address: 0000003C */
...
lbl_8007D05C:
/* 8007D05C  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
/* 8007D060  3A F7 00 40 */	addi r23, r23, 0x40                      /* constant-address: 00000040 */
lbl_8007D064:
/* 8007D064  80 19 00 88 */	lwz r0, 0x88(r25)                       
/* 8007D068  7C 1A 00 00 */	cmpw r26, r0                            
/* 8007D06C  41 80 F9 8C */	blt lbl_8007C9F8                         /* constant-address: 8007C9F8, symbol: lbl_8007C9F8 */
/* 8007D070  83 DE 00 08 */	lwz r30, 8(r30)                         
/* 8007D074  4B FF F9 28 */	b lbl_8007C99C                           /* constant-address: 8007C99C, symbol: lbl_8007C99C */
lbl_8007D078:
...
/* 8007D0C8  48 2E 51 49 */	bl _restgpr_23                           /* constant-address: 80362210, symbol: _restgpr_23 */

...
/* 8007C818  48 2E 59 C1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8007C840  48 1E C2 CD */	bl cM3d_Cross_AabCyl__FPC8cM3dGAabPC8cM3dGCyl /* constant-address: 80268B0C, symbol: cM3d_Cross_AabCyl__FPC8cM3dGAabPC8cM3dGCyl */
/* 8007C844  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C848  40 82 00 0C */	bne lbl_8007C854                         /* constant-address: 8007C854, symbol: lbl_8007C854 */
/* 8007C84C  38 60 00 00 */	li r3, 0                                
/* 8007C850  48 00 00 A8 */	b lbl_8007C8F8                           /* constant-address: 8007C8F8, symbol: lbl_8007C8F8 */
lbl_8007C854:
...
/* 8007C878  41 82 00 0C */	beq lbl_8007C884                         /* constant-address: 8007C884, symbol: lbl_8007C884 */
/* 8007C87C  38 60 00 00 */	li r3, 0                                
/* 8007C880  48 00 00 78 */	b lbl_8007C8F8                           /* constant-address: 8007C8F8, symbol: lbl_8007C8F8 */
lbl_8007C884:
...
/* 8007C89C  41 82 00 10 */	beq lbl_8007C8AC                         /* constant-address: 8007C8AC, symbol: lbl_8007C8AC */
/* 8007C8A0  7F A3 EB 78 */	mr r3, r29                              
/* 8007C8A4  7F C4 F3 78 */	mr r4, r30                              
/* 8007C8A8  4B FF FE 6D */	bl WallCorrectRpSort__4dBgWFP9dBgS_Acchi /* constant-address: 8007C714, symbol: WallCorrectRpSort__4dBgWFP9dBgS_Acchi */
lbl_8007C8AC:
...
/* 8007C8C4  41 82 00 30 */	beq lbl_8007C8F4                         /* constant-address: 8007C8F4, symbol: lbl_8007C8F4 */
...
/* 8007C8D8  4B FF FF 31 */	bl WallCorrectGrpRpSort__4dBgWFP9dBgS_Acchii /* constant-address: 8007C808, symbol: WallCorrectGrpRpSort__4dBgWFP9dBgS_Acchii */
...
/* 8007C8F0  4B FF FF CC */	b lbl_8007C8BC                           /* constant-address: 8007C8BC, symbol: lbl_8007C8BC */
lbl_8007C8F4:
/* 8007C8F4  38 60 00 00 */	li r3, 0                                
lbl_8007C8F8:
/* 8007C8F8  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8007C8FC  48 2E 59 29 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

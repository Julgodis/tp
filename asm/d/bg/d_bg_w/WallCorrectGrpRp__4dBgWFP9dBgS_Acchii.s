...
/* 8007C370  48 2E 5E 65 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8007C398  48 1E C7 75 */	bl cM3d_Cross_AabCyl__FPC8cM3dGAabPC8cM3dGCyl /* constant-address: 80268B0C, symbol: cM3d_Cross_AabCyl__FPC8cM3dGAabPC8cM3dGCyl */
/* 8007C39C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C3A0  40 82 00 0C */	bne lbl_8007C3AC                         /* constant-address: 8007C3AC, symbol: lbl_8007C3AC */
/* 8007C3A4  38 60 00 00 */	li r3, 0                                
/* 8007C3A8  48 00 00 C4 */	b lbl_8007C46C                           /* constant-address: 8007C46C, symbol: lbl_8007C46C */
lbl_8007C3AC:
...
/* 8007C3D0  41 82 00 0C */	beq lbl_8007C3DC                         /* constant-address: 8007C3DC, symbol: lbl_8007C3DC */
/* 8007C3D4  38 60 00 00 */	li r3, 0                                
/* 8007C3D8  48 00 00 94 */	b lbl_8007C46C                           /* constant-address: 8007C46C, symbol: lbl_8007C46C */
lbl_8007C3DC:
...
/* 8007C3F8  41 82 00 1C */	beq lbl_8007C414                         /* constant-address: 8007C414, symbol: lbl_8007C414 */
/* 8007C3FC  7F 83 E3 78 */	mr r3, r28                              
/* 8007C400  7F A4 EB 78 */	mr r4, r29                              
/* 8007C404  4B FF FE 31 */	bl WallCorrectRp__4dBgWFP9dBgS_Acchi     /* constant-address: 8007C234, symbol: WallCorrectRp__4dBgWFP9dBgS_Acchi */
/* 8007C408  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C40C  41 82 00 08 */	beq lbl_8007C414                         /* constant-address: 8007C414, symbol: lbl_8007C414 */
...
/* 8007C42C  41 82 00 3C */	beq lbl_8007C468                         /* constant-address: 8007C468, symbol: lbl_8007C468 */
...
/* 8007C440  4B FF FF 21 */	bl WallCorrectGrpRp__4dBgWFP9dBgS_Acchii /* constant-address: 8007C360, symbol: WallCorrectGrpRp__4dBgWFP9dBgS_Acchii */
/* 8007C444  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C448  41 82 00 08 */	beq lbl_8007C450                         /* constant-address: 8007C450, symbol: lbl_8007C450 */
...
/* 8007C464  4B FF FF C0 */	b lbl_8007C424                           /* constant-address: 8007C424, symbol: lbl_8007C424 */
lbl_8007C468:
/* 8007C468  7F E3 FB 78 */	mr r3, r31                              
lbl_8007C46C:
/* 8007C46C  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8007C470  48 2E 5D B1 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

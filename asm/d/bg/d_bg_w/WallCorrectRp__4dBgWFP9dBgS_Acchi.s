...
/* 8007C244  48 2E 5F 8D */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8007C264  48 1E C8 A9 */	bl cM3d_Cross_AabCyl__FPC8cM3dGAabPC8cM3dGCyl /* constant-address: 80268B0C, symbol: cM3d_Cross_AabCyl__FPC8cM3dGAabPC8cM3dGCyl */
/* 8007C268  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C26C  40 82 00 0C */	bne lbl_8007C278                         /* constant-address: 8007C278, symbol: lbl_8007C278 */
/* 8007C270  38 60 00 00 */	li r3, 0                                
/* 8007C274  48 00 00 D4 */	b lbl_8007C348                           /* constant-address: 8007C348, symbol: lbl_8007C348 */
lbl_8007C278:
...
/* 8007C294  41 82 00 70 */	beq lbl_8007C304                         /* constant-address: 8007C304, symbol: lbl_8007C304 */
...
/* 8007C2B0  41 82 00 1C */	beq lbl_8007C2CC                         /* constant-address: 8007C2CC, symbol: lbl_8007C2CC */
/* 8007C2B4  7F A3 EB 78 */	mr r3, r29                              
/* 8007C2B8  7F C4 F3 78 */	mr r4, r30                              
/* 8007C2BC  4B FF F7 85 */	bl RwgWallCorrect__4dBgWFP9dBgS_AcchUs   /* constant-address: 8007BA40, symbol: RwgWallCorrect__4dBgWFP9dBgS_AcchUs */
/* 8007C2C0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C2C4  41 82 00 08 */	beq lbl_8007C2CC                         /* constant-address: 8007C2CC, symbol: lbl_8007C2CC */
...
/* 8007C2E0  41 82 00 1C */	beq lbl_8007C2FC                         /* constant-address: 8007C2FC, symbol: lbl_8007C2FC */
/* 8007C2E4  7F A3 EB 78 */	mr r3, r29                              
/* 8007C2E8  7F C4 F3 78 */	mr r4, r30                              
/* 8007C2EC  4B FF F7 55 */	bl RwgWallCorrect__4dBgWFP9dBgS_AcchUs   /* constant-address: 8007BA40, symbol: RwgWallCorrect__4dBgWFP9dBgS_AcchUs */
/* 8007C2F0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C2F4  41 82 00 08 */	beq lbl_8007C2FC                         /* constant-address: 8007C2FC, symbol: lbl_8007C2FC */
/* 8007C2F8  3B E0 00 01 */	li r31, 1                               
lbl_8007C2FC:
/* 8007C2FC  7F E3 FB 78 */	mr r3, r31                              
/* 8007C300  48 00 00 48 */	b lbl_8007C348                           /* constant-address: 8007C348, symbol: lbl_8007C348 */
lbl_8007C304:
...
/* 8007C318  41 82 00 1C */	beq lbl_8007C334                         /* constant-address: 8007C334, symbol: lbl_8007C334 */
/* 8007C31C  7F A3 EB 78 */	mr r3, r29                              
/* 8007C320  7F C4 F3 78 */	mr r4, r30                              
/* 8007C324  4B FF FF 11 */	bl WallCorrectRp__4dBgWFP9dBgS_Acchi     /* constant-address: 8007C234, symbol: WallCorrectRp__4dBgWFP9dBgS_Acchi */
/* 8007C328  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007C32C  41 82 00 08 */	beq lbl_8007C334                         /* constant-address: 8007C334, symbol: lbl_8007C334 */
...
/* 8007C340  41 80 FF CC */	blt lbl_8007C30C                         /* constant-address: 8007C30C, symbol: lbl_8007C30C */
/* 8007C344  7F E3 FB 78 */	mr r3, r31                              
lbl_8007C348:
/* 8007C348  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8007C34C  48 2E 5E D1 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

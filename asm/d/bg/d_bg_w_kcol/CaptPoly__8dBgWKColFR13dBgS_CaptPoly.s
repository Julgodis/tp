...
/* 8007FF34  48 2E 22 6D */	bl __save_gpr                            /* constant-address: 803621A0, symbol: __save_gpr */
...
/* 8007FF70  C0 42 8D 20 */	lfs f2, lit_4189(r2)                     /* constant-address: 80452720, symbol: lit_4189 */
...
/* 8007FFB0  48 2E 20 FD */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8007FFB4  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 8007FFB8  40 80 00 08 */	bge lbl_8007FFC0                         /* constant-address: 8007FFC0, symbol: lbl_8007FFC0 */
/* 8007FFBC  3B C0 00 00 */	li r30, 0                               
lbl_8007FFC0:
/* 8007FFC0  C0 01 00 38 */	lfs f0, 0x38(r1)                        
/* 8007FFC4  EC 20 F8 28 */	fsubs f1, f0, f31                       
/* 8007FFC8  48 2E 20 E5 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8007FFDC  40 81 00 08 */	ble lbl_8007FFE4                         /* constant-address: 8007FFE4, symbol: lbl_8007FFE4 */
/* 8007FFE0  7C 1D 03 78 */	mr r29, r0                              
lbl_8007FFE4:
/* 8007FFE4  7C 1E E8 00 */	cmpw r30, r29                           
/* 8007FFE8  40 80 03 28 */	bge lbl_80080310                         /* constant-address: 80080310, symbol: lbl_80080310 */
/* 8007FFEC  C0 01 00 48 */	lfs f0, 0x48(r1)                        
/* 8007FFF0  C3 EE 00 18 */	lfs f31, 0x18(r14)                      
/* 8007FFF4  EC 20 F8 28 */	fsubs f1, f0, f31                       
/* 8007FFF8  48 2E 20 B5 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8007FFFC  7C 7C 1B 79 */	or. r28, r3, r3                         
/* 80080000  40 80 00 08 */	bge lbl_80080008                         /* constant-address: 80080008, symbol: lbl_80080008 */
/* 80080004  3B 80 00 00 */	li r28, 0                               
lbl_80080008:
/* 80080008  C0 01 00 3C */	lfs f0, 0x3c(r1)                        
/* 8008000C  EC 20 F8 28 */	fsubs f1, f0, f31                       
/* 80080010  48 2E 20 9D */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 80080024  40 81 00 08 */	ble lbl_8008002C                         /* constant-address: 8008002C, symbol: lbl_8008002C */
/* 80080028  7C 1B 03 78 */	mr r27, r0                              
lbl_8008002C:
/* 8008002C  7C 1C D8 00 */	cmpw r28, r27                           
/* 80080030  40 80 02 E0 */	bge lbl_80080310                         /* constant-address: 80080310, symbol: lbl_80080310 */
/* 80080034  C0 01 00 4C */	lfs f0, 0x4c(r1)                        
/* 80080038  C3 EE 00 1C */	lfs f31, 0x1c(r14)                      
/* 8008003C  EC 20 F8 28 */	fsubs f1, f0, f31                       
/* 80080040  48 2E 20 6D */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 80080044  7C 71 1B 79 */	or. r17, r3, r3                         
/* 80080048  40 80 00 08 */	bge lbl_80080050                         /* constant-address: 80080050, symbol: lbl_80080050 */
/* 8008004C  3A 20 00 00 */	li r17, 0                               
lbl_80080050:
/* 80080050  C0 01 00 40 */	lfs f0, 0x40(r1)                        
/* 80080054  EC 20 F8 28 */	fsubs f1, f0, f31                       
/* 80080058  48 2E 20 55 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8008006C  40 81 00 08 */	ble lbl_80080074                         /* constant-address: 80080074, symbol: lbl_80080074 */
/* 80080070  7C 1A 03 78 */	mr r26, r0                              
lbl_80080074:
/* 80080074  7C 11 D0 00 */	cmpw r17, r26                           
/* 80080078  40 80 02 98 */	bge lbl_80080310                         /* constant-address: 80080310, symbol: lbl_80080310 */
/* 8008007C  3A E0 00 00 */	li r23, 0                               
/* 80080080  3A C0 00 00 */	li r22, 0                               
/* 80080084  7E 35 8B 78 */	mr r21, r17                             
/* 80080088  3C 60 80 42 */	lis r3, data_80424F70@ha                
/* 8008008C  3B E3 4F 70 */	addi r31, r3, data_80424F70@l            /* constant-address: 80424F70, symbol: data_80424F70 */
lbl_80080090:
/* 80080090  3C 60 00 0F */	lis r3, 0x000F /* 0x000F4240@ha */      
/* 80080094  3B 03 42 40 */	addi r24, r3, 0x4240 /* 0x000F4240@l */  /* constant-address: 000F4240 */
/* 80080098  7F 94 E3 78 */	mr r20, r28                             
lbl_8008009C:
/* 8008009C  3C 60 00 0F */	lis r3, 0x000F /* 0x000F4240@ha */      
/* 800800A0  3B 23 42 40 */	addi r25, r3, 0x4240 /* 0x000F4240@l */  /* constant-address: 000F4240 */
...
/* 800800E0  48 00 00 28 */	b lbl_80080108                           /* constant-address: 80080108, symbol: lbl_80080108 */
lbl_800800E4:
...
/* 80080114  40 80 FF D0 */	bge lbl_800800E4                         /* constant-address: 800800E4, symbol: lbl_800800E4 */
...
/* 8008014C  40 80 00 08 */	bge lbl_80080154                         /* constant-address: 80080154, symbol: lbl_80080154 */
/* 80080150  7C 18 03 78 */	mr r24, r0                              
lbl_80080154:
/* 80080154  7C 04 C8 00 */	cmpw r4, r25                            
/* 80080158  40 80 00 08 */	bge lbl_80080160                         /* constant-address: 80080160, symbol: lbl_80080160 */
/* 8008015C  7C 99 23 78 */	mr r25, r4                              
lbl_80080160:
/* 80080160  7C 04 70 00 */	cmpw r4, r14                            
/* 80080164  40 81 00 18 */	ble lbl_8008017C                         /* constant-address: 8008017C, symbol: lbl_8008017C */
/* 80080168  A0 12 00 02 */	lhz r0, 2(r18)                          
/* 8008016C  28 00 00 00 */	cmplwi r0, 0                            
/* 80080170  41 82 00 0C */	beq lbl_8008017C                         /* constant-address: 8008017C, symbol: lbl_8008017C */
/* 80080174  7C 8E 23 78 */	mr r14, r4                              
/* 80080178  7E 57 93 78 */	mr r23, r18                             
lbl_8008017C:
/* 8008017C  7C 12 B0 40 */	cmplw r18, r22                          
/* 80080180  41 82 01 64 */	beq lbl_800802E4                         /* constant-address: 800802E4, symbol: lbl_800802E4 */
/* 80080184  48 00 01 54 */	b lbl_800802D8                           /* constant-address: 800802D8, symbol: lbl_800802D8 */
lbl_80080188:
...
/* 800801B4  4B FF E9 BD */	bl getPolyCode__8dBgWKColCFiP5dBgPc      /* constant-address: 8007EB70, symbol: getPolyCode__8dBgWKColCFiP5dBgPc */
...
/* 800801E4  4B FF E9 E1 */	bl chkPolyThrough__8dBgWKColCFP5dBgPcP16cBgS_PolyPassChkP15cBgS_GrpPassChkR4cXyz /* constant-address: 8007EBC4, symbol: chkPolyThrough__8dBgWKColCFP5dBgPcP16cBgS_PolyPassChkP15cBgS_GrpPassChkR4cXyz */
/* 800801E8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800801EC  40 82 00 EC */	bne lbl_800802D8                         /* constant-address: 800802D8, symbol: lbl_800802D8 */
...
/* 80080204  4B FF E7 A1 */	bl GetTriPnt__8dBgWKColCFiP3VecP3VecP3Vec /* constant-address: 8007E9A4, symbol: GetTriPnt__8dBgWKColCFiP3VecP3VecP3Vec */
/* 80080208  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8008020C  41 82 00 CC */	beq lbl_800802D8                         /* constant-address: 800802D8, symbol: lbl_800802D8 */
/* 80080210  C0 01 00 20 */	lfs f0, 0x20(r1)                        
/* 80080214  3C 60 80 42 */	lis r3, data_80424F70@ha                
/* 80080218  D0 03 4F 70 */	stfs f0, data_80424F70@l(r3)             /* constant-address: 80424F70, symbol: data_80424F70 */
/* 8008021C  C0 01 00 24 */	lfs f0, 0x24(r1)                        
/* 80080220  D0 1F 00 04 */	stfs f0, 4(r31)                          /* constant-address: 80424F74, symbol: None */
/* 80080224  C0 01 00 28 */	lfs f0, 0x28(r1)                        
/* 80080228  D0 1F 00 08 */	stfs f0, 8(r31)                          /* constant-address: 80424F78, symbol: None */
/* 8008022C  C0 01 00 14 */	lfs f0, 0x14(r1)                        
/* 80080230  D0 1F 00 0C */	stfs f0, 0xc(r31)                        /* constant-address: 80424F7C, symbol: None */
/* 80080234  C0 01 00 18 */	lfs f0, 0x18(r1)                        
/* 80080238  D0 1F 00 10 */	stfs f0, 0x10(r31)                       /* constant-address: 80424F80, symbol: None */
/* 8008023C  C0 01 00 1C */	lfs f0, 0x1c(r1)                        
/* 80080240  D0 1F 00 14 */	stfs f0, 0x14(r31)                       /* constant-address: 80424F84, symbol: None */
/* 80080244  C0 01 00 08 */	lfs f0, 8(r1)                           
/* 80080248  D0 1F 00 18 */	stfs f0, 0x18(r31)                       /* constant-address: 80424F88, symbol: None */
/* 8008024C  C0 01 00 0C */	lfs f0, 0xc(r1)                         
/* 80080250  D0 1F 00 1C */	stfs f0, 0x1c(r31)                       /* constant-address: 80424F8C, symbol: None */
/* 80080254  C0 01 00 10 */	lfs f0, 0x10(r1)                        
/* 80080258  D0 1F 00 20 */	stfs f0, 0x20(r31)                       /* constant-address: 80424F90, symbol: None */
/* 8008025C  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 80080260  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
...
/* 80080274  4B FF E6 4D */	bl GetTriPla__8dBgWKColCFi               /* constant-address: 8007E8C0, symbol: GetTriPla__8dBgWKColCFi */
...
/* 8008029C  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800802A0  90 01 00 60 */	stw r0, 0x60(r1)                        
/* 800802A4  7E 03 83 78 */	mr r3, r16                              
/* 800802A8  3C 80 80 42 */	lis r4, data_80424F70@ha                
/* 800802AC  38 84 4F 70 */	addi r4, r4, data_80424F70@l             /* constant-address: 80424F70, symbol: data_80424F70 */
...
/* 800802D0  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800802D4  90 01 00 74 */	stw r0, 0x74(r1)                        
lbl_800802D8:
/* 800802D8  A4 12 00 02 */	lhzu r0, 2(r18)                         
/* 800802DC  28 00 00 00 */	cmplwi r0, 0                            
/* 800802E0  40 82 FE A8 */	bne lbl_80080188                         /* constant-address: 80080188, symbol: lbl_80080188 */
lbl_800802E4:
/* 800802E4  80 01 00 8C */	lwz r0, 0x8c(r1)                        
/* 800802E8  7E 73 02 14 */	add r19, r19, r0                        
/* 800802EC  7C 13 E8 40 */	cmplw r19, r29                          
/* 800802F0  40 81 FD BC */	ble lbl_800800AC                         /* constant-address: 800800AC, symbol: lbl_800800AC */
/* 800802F4  7E F6 BB 78 */	mr r22, r23                             
/* 800802F8  7E 94 CA 14 */	add r20, r20, r25                       
/* 800802FC  7C 14 D8 40 */	cmplw r20, r27                          
/* 80080300  40 81 FD 9C */	ble lbl_8008009C                         /* constant-address: 8008009C, symbol: lbl_8008009C */
/* 80080304  7E B5 C2 14 */	add r21, r21, r24                       
/* 80080308  7C 15 D0 40 */	cmplw r21, r26                          
/* 8008030C  40 81 FD 84 */	ble lbl_80080090                         /* constant-address: 80080090, symbol: lbl_80080090 */
lbl_80080310:
/* 80080310  E3 E1 00 E8 */	psq_l f31, 232(r1), 0, 0 /* qr0 */      
/* 80080314  CB E1 00 E0 */	lfd f31, 0xe0(r1)                       
/* 80080318  39 61 00 E0 */	addi r11, r1, 0xe0                      
/* 8008031C  48 2E 1E D1 */	bl __restore_gpr                         /* constant-address: 803621EC, symbol: __restore_gpr */

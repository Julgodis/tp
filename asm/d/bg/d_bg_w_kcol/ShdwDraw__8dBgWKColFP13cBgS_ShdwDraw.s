...
/* 8007F9B4  48 2E 27 ED */	bl __save_gpr                            /* constant-address: 803621A0, symbol: __save_gpr */
...
/* 8007F9D8  48 2C 76 DD */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
...
/* 8007F9EC  48 2C 76 C9 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 8007F9F0  C0 01 00 30 */	lfs f0, 0x30(r1)                        
/* 8007F9F4  C0 42 8D 20 */	lfs f2, lit_4189(r2)                     /* constant-address: 80452720, symbol: lit_4189 */
...
/* 8007FA3C  48 2E 26 71 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8007FA40  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 8007FA44  40 80 00 08 */	bge lbl_8007FA4C                         /* constant-address: 8007FA4C, symbol: lbl_8007FA4C */
/* 8007FA48  3B C0 00 00 */	li r30, 0                               
lbl_8007FA4C:
/* 8007FA4C  C0 21 00 24 */	lfs f1, 0x24(r1)                        
/* 8007FA50  48 2E 26 5D */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8007FA68  40 81 00 08 */	ble lbl_8007FA70                         /* constant-address: 8007FA70, symbol: lbl_8007FA70 */
/* 8007FA6C  7C 1D 03 78 */	mr r29, r0                              
lbl_8007FA70:
/* 8007FA70  7C 1E E8 00 */	cmpw r30, r29                           
/* 8007FA74  40 80 04 74 */	bge lbl_8007FEE8                         /* constant-address: 8007FEE8, symbol: lbl_8007FEE8 */
/* 8007FA78  C0 21 00 34 */	lfs f1, 0x34(r1)                        
/* 8007FA7C  48 2E 26 31 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8007FA80  7C 7C 1B 79 */	or. r28, r3, r3                         
/* 8007FA84  40 80 00 08 */	bge lbl_8007FA8C                         /* constant-address: 8007FA8C, symbol: lbl_8007FA8C */
/* 8007FA88  3B 80 00 00 */	li r28, 0                               
lbl_8007FA8C:
/* 8007FA8C  C0 21 00 28 */	lfs f1, 0x28(r1)                        
/* 8007FA90  48 2E 26 1D */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8007FAA4  40 81 00 08 */	ble lbl_8007FAAC                         /* constant-address: 8007FAAC, symbol: lbl_8007FAAC */
/* 8007FAA8  7C 1B 03 78 */	mr r27, r0                              
lbl_8007FAAC:
/* 8007FAAC  7C 1C D8 00 */	cmpw r28, r27                           
/* 8007FAB0  40 80 04 38 */	bge lbl_8007FEE8                         /* constant-address: 8007FEE8, symbol: lbl_8007FEE8 */
/* 8007FAB4  C0 21 00 38 */	lfs f1, 0x38(r1)                        
/* 8007FAB8  48 2E 25 F5 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8007FABC  7C 6E 1B 79 */	or. r14, r3, r3                         
/* 8007FAC0  40 80 00 08 */	bge lbl_8007FAC8                         /* constant-address: 8007FAC8, symbol: lbl_8007FAC8 */
/* 8007FAC4  39 C0 00 00 */	li r14, 0                               
lbl_8007FAC8:
/* 8007FAC8  C0 21 00 2C */	lfs f1, 0x2c(r1)                        
/* 8007FACC  48 2E 25 E1 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8007FAE0  40 81 00 08 */	ble lbl_8007FAE8                         /* constant-address: 8007FAE8, symbol: lbl_8007FAE8 */
/* 8007FAE4  7C 1A 03 78 */	mr r26, r0                              
lbl_8007FAE8:
/* 8007FAE8  7C 0E D0 00 */	cmpw r14, r26                           
/* 8007FAEC  40 80 03 FC */	bge lbl_8007FEE8                         /* constant-address: 8007FEE8, symbol: lbl_8007FEE8 */
...
/* 8007FB10  40 80 00 10 */	bge lbl_8007FB20                         /* constant-address: 8007FB20, symbol: lbl_8007FB20 */
lbl_8007FB14:
/* 8007FB14  90 65 00 00 */	stw r3, 0(r5)                           
/* 8007FB18  38 A5 00 04 */	addi r5, r5, 4                          
/* 8007FB1C  42 00 FF F8 */	bdnz lbl_8007FB14                        /* constant-address: 8007FB14, symbol: lbl_8007FB14 */
lbl_8007FB20:
...
/* 8007FB4C  39 C3 42 40 */	addi r14, r3, 0x4240 /* 0x000F4240@l */  /* constant-address: 000F4240 */
/* 8007FB50  7F 92 E3 78 */	mr r18, r28                             
lbl_8007FB54:
/* 8007FB54  3C 60 00 0F */	lis r3, 0x000F /* 0x000F4240@ha */      
/* 8007FB58  38 03 42 40 */	addi r0, r3, 0x4240 /* 0x000F4240@l */   /* constant-address: 000F4240 */
...
/* 8007FBA4  48 00 00 28 */	b lbl_8007FBCC                           /* constant-address: 8007FBCC, symbol: lbl_8007FBCC */
lbl_8007FBA8:
...
/* 8007FBD8  40 80 FF D0 */	bge lbl_8007FBA8                         /* constant-address: 8007FBA8, symbol: lbl_8007FBA8 */
...
/* 8007FC10  40 80 00 08 */	bge lbl_8007FC18                         /* constant-address: 8007FC18, symbol: lbl_8007FC18 */
/* 8007FC14  7C 0E 03 78 */	mr r14, r0                              
lbl_8007FC18:
/* 8007FC18  80 01 08 B0 */	lwz r0, 0x8b0(r1)                       
/* 8007FC1C  7C 04 00 00 */	cmpw r4, r0                             
/* 8007FC20  40 80 00 08 */	bge lbl_8007FC28                         /* constant-address: 8007FC28, symbol: lbl_8007FC28 */
/* 8007FC24  90 81 08 B0 */	stw r4, 0x8b0(r1)                       
lbl_8007FC28:
/* 8007FC28  A0 10 00 02 */	lhz r0, 2(r16)                          
/* 8007FC2C  28 00 00 00 */	cmplwi r0, 0                            
/* 8007FC30  41 82 00 54 */	beq lbl_8007FC84                         /* constant-address: 8007FC84, symbol: lbl_8007FC84 */
/* 8007FC34  7C 04 B8 00 */	cmpw r4, r23                            
/* 8007FC38  40 81 00 4C */	ble lbl_8007FC84                         /* constant-address: 8007FC84, symbol: lbl_8007FC84 */
/* 8007FC3C  7C 04 C0 00 */	cmpw r4, r24                            
/* 8007FC40  40 81 00 3C */	ble lbl_8007FC7C                         /* constant-address: 8007FC7C, symbol: lbl_8007FC7C */
/* 8007FC44  7C 04 C8 00 */	cmpw r4, r25                            
/* 8007FC48  40 81 00 20 */	ble lbl_8007FC68                         /* constant-address: 8007FC68, symbol: lbl_8007FC68 */
...
/* 8007FC64  48 00 00 20 */	b lbl_8007FC84                           /* constant-address: 8007FC84, symbol: lbl_8007FC84 */
lbl_8007FC68:
...
/* 8007FC78  48 00 00 0C */	b lbl_8007FC84                           /* constant-address: 8007FC84, symbol: lbl_8007FC84 */
lbl_8007FC7C:
...
/* 8007FC8C  41 82 02 24 */	beq lbl_8007FEB0                         /* constant-address: 8007FEB0, symbol: lbl_8007FEB0 */
/* 8007FC90  80 01 08 A8 */	lwz r0, 0x8a8(r1)                       
/* 8007FC94  7C 10 00 40 */	cmplw r16, r0                           
/* 8007FC98  41 82 02 18 */	beq lbl_8007FEB0                         /* constant-address: 8007FEB0, symbol: lbl_8007FEB0 */
/* 8007FC9C  80 01 08 A4 */	lwz r0, 0x8a4(r1)                       
/* 8007FCA0  7C 10 00 40 */	cmplw r16, r0                           
/* 8007FCA4  40 82 02 00 */	bne lbl_8007FEA4                         /* constant-address: 8007FEA4, symbol: lbl_8007FEA4 */
/* 8007FCA8  48 00 02 08 */	b lbl_8007FEB0                           /* constant-address: 8007FEB0, symbol: lbl_8007FEB0 */
/* 8007FCAC  48 00 01 F8 */	b lbl_8007FEA4                           /* constant-address: 8007FEA4, symbol: lbl_8007FEA4 */
lbl_8007FCB0:
...
/* 8007FCD4  40 82 01 D0 */	bne lbl_8007FEA4                         /* constant-address: 8007FEA4, symbol: lbl_8007FEA4 */
...
/* 8007FCF0  4B FF EE 81 */	bl getPolyCode__8dBgWKColCFiP5dBgPc      /* constant-address: 8007EB70, symbol: getPolyCode__8dBgWKColCFiP5dBgPc */
/* 8007FCF4  7D E3 7B 78 */	mr r3, r15                              
/* 8007FCF8  38 81 00 64 */	addi r4, r1, 0x64                       
/* 8007FCFC  48 00 02 05 */	bl ChkShdwDrawThrough__8dBgWKColFP5dBgPc /* constant-address: 8007FF00, symbol: ChkShdwDrawThrough__8dBgWKColFP5dBgPc */
/* 8007FD00  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8007FD04  40 82 01 A0 */	bne lbl_8007FEA4                         /* constant-address: 8007FEA4, symbol: lbl_8007FEA4 */
...
/* 8007FD80  48 2C 74 35 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8007FD84  38 61 00 18 */	addi r3, r1, 0x18                       
/* 8007FD88  80 81 08 9C */	lwz r4, 0x89c(r1)                       
/* 8007FD8C  48 2C 74 09 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 8007FD90  FC 00 0A 10 */	fabs f0, f1                             
/* 8007FD94  FC 40 00 18 */	frsp f2, f0                             
/* 8007FD98  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007FD9C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8007FDA0  41 80 01 04 */	blt lbl_8007FEA4                         /* constant-address: 8007FEA4, symbol: lbl_8007FEA4 */
...
/* 8007FDB4  48 2C 73 25 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8007FDB8  38 61 00 18 */	addi r3, r1, 0x18                       
/* 8007FDBC  38 81 00 78 */	addi r4, r1, 0x78                       
/* 8007FDC0  38 A1 00 90 */	addi r5, r1, 0x90                       
/* 8007FDC4  48 2C 72 CD */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
...
/* 8007FDE4  48 2C 73 D1 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8007FDE8  38 61 00 0C */	addi r3, r1, 0xc                        
/* 8007FDEC  80 81 08 9C */	lwz r4, 0x89c(r1)                       
/* 8007FDF0  48 2C 73 A5 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 8007FDF4  FC 00 0A 10 */	fabs f0, f1                             
/* 8007FDF8  FC 40 00 18 */	frsp f2, f0                             
/* 8007FDFC  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007FE00  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8007FE04  41 80 00 A0 */	blt lbl_8007FEA4                         /* constant-address: 8007FEA4, symbol: lbl_8007FEA4 */
...
/* 8007FE18  48 2C 72 C1 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8007FE1C  38 61 00 0C */	addi r3, r1, 0xc                        
/* 8007FE20  38 81 00 78 */	addi r4, r1, 0x78                       
/* 8007FE24  38 A1 00 84 */	addi r5, r1, 0x84                       
/* 8007FE28  48 2C 72 69 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
/* 8007FE2C  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 8007FE30  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
...
/* 8007FE44  4B FF EA 7D */	bl GetTriPla__8dBgWKColCFi               /* constant-address: 8007E8C0, symbol: GetTriPla__8dBgWKColCFi */
...
/* 8007FE68  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 8007FE6C  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
...
/* 8007FE98  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 8007FE9C  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 8007FEA0  90 01 00 60 */	stw r0, 0x60(r1)                        
lbl_8007FEA4:
/* 8007FEA4  A4 10 00 02 */	lhzu r0, 2(r16)                         
/* 8007FEA8  28 00 00 00 */	cmplwi r0, 0                            
/* 8007FEAC  40 82 FE 04 */	bne lbl_8007FCB0                         /* constant-address: 8007FCB0, symbol: lbl_8007FCB0 */
lbl_8007FEB0:
/* 8007FEB0  80 01 08 B4 */	lwz r0, 0x8b4(r1)                       
/* 8007FEB4  7E 31 02 14 */	add r17, r17, r0                        
/* 8007FEB8  7C 11 E8 40 */	cmplw r17, r29                          
/* 8007FEBC  40 81 FC B4 */	ble lbl_8007FB70                         /* constant-address: 8007FB70, symbol: lbl_8007FB70 */
...
/* 8007FED8  40 81 FC 7C */	ble lbl_8007FB54                         /* constant-address: 8007FB54, symbol: lbl_8007FB54 */
/* 8007FEDC  7E 73 72 14 */	add r19, r19, r14                       
/* 8007FEE0  7C 13 D0 40 */	cmplw r19, r26                          
/* 8007FEE4  40 81 FC 64 */	ble lbl_8007FB48                         /* constant-address: 8007FB48, symbol: lbl_8007FB48 */
lbl_8007FEE8:
/* 8007FEE8  39 61 09 00 */	addi r11, r1, 0x900                     
/* 8007FEEC  48 2E 23 01 */	bl __restore_gpr                         /* constant-address: 803621EC, symbol: __restore_gpr */

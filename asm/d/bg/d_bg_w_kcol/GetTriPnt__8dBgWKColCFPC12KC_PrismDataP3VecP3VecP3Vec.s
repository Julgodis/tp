...
/* 8007E9E4  48 2E 37 E9 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 8007EA60  48 2C 87 55 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8007EA64  7F 43 D3 78 */	mr r3, r26                              
/* 8007EA68  7F 64 DB 78 */	mr r4, r27                              
/* 8007EA6C  38 A1 00 08 */	addi r5, r1, 8                          
/* 8007EA70  48 2C 87 45 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8007EA74  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8007EA78  7F 24 CB 78 */	mr r4, r25                              
/* 8007EA7C  48 2C 87 19 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 8007EA80  FC 00 0A 10 */	fabs f0, f1                             
/* 8007EA84  FC 40 00 18 */	frsp f2, f0                             
/* 8007EA88  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007EA8C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8007EA90  40 80 00 0C */	bge lbl_8007EA9C                         /* constant-address: 8007EA9C, symbol: lbl_8007EA9C */
/* 8007EA94  38 60 00 00 */	li r3, 0                                
/* 8007EA98  48 00 00 78 */	b lbl_8007EB10                           /* constant-address: 8007EB10, symbol: lbl_8007EB10 */
lbl_8007EA9C:
...
/* 8007EAAC  48 2C 86 2D */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8007EAB0  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8007EAB4  7F A4 EB 78 */	mr r4, r29                              
/* 8007EAB8  7F E5 FB 78 */	mr r5, r31                              
/* 8007EABC  48 2C 85 D5 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
/* 8007EAC0  38 61 00 08 */	addi r3, r1, 8                          
/* 8007EAC4  7F 24 CB 78 */	mr r4, r25                              
/* 8007EAC8  48 2C 86 CD */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 8007EACC  FC 00 0A 10 */	fabs f0, f1                             
/* 8007EAD0  FC 40 00 18 */	frsp f2, f0                             
/* 8007EAD4  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8007EAD8  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8007EADC  40 80 00 0C */	bge lbl_8007EAE8                         /* constant-address: 8007EAE8, symbol: lbl_8007EAE8 */
/* 8007EAE0  38 60 00 00 */	li r3, 0                                
/* 8007EAE4  48 00 00 2C */	b lbl_8007EB10                           /* constant-address: 8007EB10, symbol: lbl_8007EB10 */
lbl_8007EAE8:
...
/* 8007EAF8  48 2C 85 E1 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8007EAFC  38 61 00 08 */	addi r3, r1, 8                          
/* 8007EB00  7F A4 EB 78 */	mr r4, r29                              
/* 8007EB04  7F C5 F3 78 */	mr r5, r30                              
/* 8007EB08  48 2C 85 89 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
/* 8007EB0C  38 60 00 01 */	li r3, 1                                
lbl_8007EB10:
/* 8007EB10  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8007EB14  48 2E 37 05 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

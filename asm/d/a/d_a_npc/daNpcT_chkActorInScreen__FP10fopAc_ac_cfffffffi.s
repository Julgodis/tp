...
/* 8014C23C  41 82 01 14 */	beq lbl_8014C350                         /* constant-address: 8014C350, symbol: lbl_8014C350 */
...
/* 8014C2A0  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha        
/* 8014C2A4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8014C2A8  48 1F A2 09 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 8014C2AC  C0 22 99 D8 */	lfs f1, lit_4116(r2)                     /* constant-address: 804533D8, symbol: lit_4116 */
/* 8014C2B0  FC 40 E8 90 */	fmr f2, f29                             
/* 8014C2B4  FC 60 08 90 */	fmr f3, f1                              
/* 8014C2B8  4B EC 0A E5 */	bl transM__14mDoMtx_stack_cFfff          /* constant-address: 8000CD9C, symbol: transM__14mDoMtx_stack_cFfff */
/* 8014C2BC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8014C2C0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8014C2C4  38 81 00 14 */	addi r4, r1, 0x14                       
/* 8014C2C8  7C 85 23 78 */	mr r5, r4                               
/* 8014C2CC  38 C0 00 08 */	li r6, 8                                
/* 8014C2D0  48 1F AA F1 */	bl PSMTXMultVecArray                     /* constant-address: 80346DC0, symbol: PSMTXMultVecArray */
/* 8014C2D4  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8014C2D8  41 82 00 0C */	beq lbl_8014C2E4                         /* constant-address: 8014C2E4, symbol: lbl_8014C2E4 */
/* 8014C2DC  38 60 00 00 */	li r3, 0                                
/* 8014C2E0  48 00 00 74 */	b lbl_8014C354                           /* constant-address: 8014C354, symbol: lbl_8014C354 */
lbl_8014C2E4:
/* 8014C2E4  3B C0 00 00 */	li r30, 0                               
/* 8014C2E8  3B E0 00 00 */	li r31, 0                               
/* 8014C2EC  C3 A2 99 D8 */	lfs f29, lit_4116(r2)                    /* constant-address: 804533D8, symbol: lit_4116 */
/* 8014C2F0  C3 C2 9A 88 */	lfs f30, lit_7550(r2)                    /* constant-address: 80453488, symbol: lit_7550 */
/* 8014C2F4  C3 E2 9A 8C */	lfs f31, lit_7551(r2)                    /* constant-address: 8045348C, symbol: lit_7551 */
lbl_8014C2F8:
/* 8014C2F8  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8014C2FC  7C 63 FA 14 */	add r3, r3, r31                         
/* 8014C300  38 81 00 08 */	addi r4, r1, 8                          
/* 8014C304  4B EC 90 0D */	bl mDoLib_project__FP3VecP3Vec           /* constant-address: 80015310, symbol: mDoLib_project__FP3VecP3Vec */
/* 8014C308  C0 01 00 08 */	lfs f0, 8(r1)                           
/* 8014C30C  FC 1D 00 40 */	fcmpo cr0, f29, f0                      
/* 8014C310  40 80 00 20 */	bge lbl_8014C330                         /* constant-address: 8014C330, symbol: lbl_8014C330 */
/* 8014C314  FC 00 F0 40 */	fcmpo cr0, f0, f30                      
/* 8014C318  40 80 00 18 */	bge lbl_8014C330                         /* constant-address: 8014C330, symbol: lbl_8014C330 */
/* 8014C31C  C0 01 00 0C */	lfs f0, 0xc(r1)                         
/* 8014C320  FC 1D 00 40 */	fcmpo cr0, f29, f0                      
/* 8014C324  40 80 00 0C */	bge lbl_8014C330                         /* constant-address: 8014C330, symbol: lbl_8014C330 */
/* 8014C328  FC 00 F8 40 */	fcmpo cr0, f0, f31                      
/* 8014C32C  41 80 00 0C */	blt lbl_8014C338                         /* constant-address: 8014C338, symbol: lbl_8014C338 */
lbl_8014C330:
/* 8014C330  38 60 00 00 */	li r3, 0                                
/* 8014C334  48 00 00 20 */	b lbl_8014C354                           /* constant-address: 8014C354, symbol: lbl_8014C354 */
lbl_8014C338:
/* 8014C338  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
/* 8014C33C  2C 1E 00 08 */	cmpwi r30, 8                            
/* 8014C340  3B FF 00 0C */	addi r31, r31, 0xc                       /* constant-address: 0000000C */
/* 8014C344  41 80 FF B4 */	blt lbl_8014C2F8                         /* constant-address: 8014C2F8, symbol: lbl_8014C2F8 */
/* 8014C348  38 60 00 01 */	li r3, 1                                
/* 8014C34C  48 00 00 08 */	b lbl_8014C354                           /* constant-address: 8014C354, symbol: lbl_8014C354 */
lbl_8014C350:

...
/* 8014B658  48 21 6B 81 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8014B670  41 80 00 1C */	blt lbl_8014B68C                         /* constant-address: 8014B68C, symbol: lbl_8014B68C */
/* 8014B674  7C 83 07 34 */	extsh r3, r4                            
/* 8014B678  A8 1D 0D 7A */	lha r0, 0xd7a(r29)                      
/* 8014B67C  7C 03 00 00 */	cmpw r3, r0                             
/* 8014B680  41 82 00 0C */	beq lbl_8014B68C                         /* constant-address: 8014B68C, symbol: lbl_8014B68C */
...
/* 8014B694  40 82 00 E4 */	bne lbl_8014B778                         /* constant-address: 8014B778, symbol: lbl_8014B778 */
/* 8014B698  A8 1D 0D 7A */	lha r0, 0xd7a(r29)                      
/* 8014B69C  7C 00 20 50 */	subf r0, r0, r4                         
/* 8014B6A0  7C 03 07 35 */	extsh. r3, r0                           
/* 8014B6A4  40 82 00 10 */	bne lbl_8014B6B4                         /* constant-address: 8014B6B4, symbol: lbl_8014B6B4 */
/* 8014B6A8  38 00 00 02 */	li r0, 2                                
/* 8014B6AC  B0 1D 0D D8 */	sth r0, 0xdd8(r29)                      
/* 8014B6B0  48 00 01 24 */	b lbl_8014B7D4                           /* constant-address: 8014B7D4, symbol: lbl_8014B7D4 */
lbl_8014B6B4:
...
/* 8014B6C8  C0 42 9A 68 */	lfs f2, lit_7089(r2)                     /* constant-address: 80453468, symbol: lit_7089 */
/* 8014B6CC  C8 22 99 E0 */	lfd f1, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014B704  40 81 00 54 */	ble lbl_8014B758                         /* constant-address: 8014B758, symbol: lbl_8014B758 */
/* 8014B708  83 9D 0B 5C */	lwz r28, 0xb5c(r29)                     
/* 8014B70C  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8014B710  41 80 00 20 */	blt lbl_8014B730                         /* constant-address: 8014B730, symbol: lbl_8014B730 */
/* 8014B714  38 7D 0B 50 */	addi r3, r29, 0xb50                     
/* 8014B718  4B FF A1 81 */	bl initialize__22daNpcT_MotionSeqMngr_cFv /* constant-address: 80145898, symbol: initialize__22daNpcT_MotionSeqMngr_cFv */
/* 8014B71C  93 9D 0B 5C */	stw r28, 0xb5c(r29)                     
/* 8014B720  7C 1E E2 14 */	add r0, r30, r28                        
/* 8014B724  90 1D 0B 58 */	stw r0, 0xb58(r29)                      
/* 8014B728  C0 02 99 E8 */	lfs f0, lit_4148(r2)                     /* constant-address: 804533E8, symbol: lit_4148 */
/* 8014B72C  D0 1D 0B 68 */	stfs f0, 0xb68(r29)                     
lbl_8014B730:
/* 8014B730  83 9D 0B 80 */	lwz r28, 0xb80(r29)                     
/* 8014B734  2C 1F 00 00 */	cmpwi r31, 0                            
/* 8014B738  41 80 00 20 */	blt lbl_8014B758                         /* constant-address: 8014B758, symbol: lbl_8014B758 */
/* 8014B73C  38 7D 0B 74 */	addi r3, r29, 0xb74                     
/* 8014B740  4B FF A1 59 */	bl initialize__22daNpcT_MotionSeqMngr_cFv /* constant-address: 80145898, symbol: initialize__22daNpcT_MotionSeqMngr_cFv */
/* 8014B744  93 9D 0B 80 */	stw r28, 0xb80(r29)                     
/* 8014B748  7C 1F E2 14 */	add r0, r31, r28                        
/* 8014B74C  90 1D 0B 7C */	stw r0, 0xb7c(r29)                      
/* 8014B750  C0 02 99 E8 */	lfs f0, lit_4148(r2)                     /* constant-address: 804533E8, symbol: lit_4148 */
...
/* 8014B774  48 00 00 60 */	b lbl_8014B7D4                           /* constant-address: 8014B7D4, symbol: lbl_8014B7D4 */
lbl_8014B778:
/* 8014B778  2C 03 00 01 */	cmpwi r3, 1                             
/* 8014B77C  40 82 00 58 */	bne lbl_8014B7D4                         /* constant-address: 8014B7D4, symbol: lbl_8014B7D4 */
...
/* 8014B790  4B FF FD 15 */	bl turn__8daNpcT_cFsii                   /* constant-address: 8014B4A4, symbol: turn__8daNpcT_cFsii */
/* 8014B794  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014B798  41 82 00 2C */	beq lbl_8014B7C4                         /* constant-address: 8014B7C4, symbol: lbl_8014B7C4 */
...
/* 8014B7C0  48 00 00 14 */	b lbl_8014B7D4                           /* constant-address: 8014B7D4, symbol: lbl_8014B7D4 */
lbl_8014B7C4:
...
/* 8014B7F4  48 21 6A 31 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

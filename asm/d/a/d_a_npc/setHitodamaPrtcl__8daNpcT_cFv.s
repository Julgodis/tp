...
/* 8014C040  48 21 61 91 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8014C068  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 8014C06C  7C 23 04 2E */	lfsx f1, r3, r0                         
/* 8014C070  C0 02 9A 6C */	lfs f0, lit_7090(r2)                     /* constant-address: 8045346C, symbol: lit_7090 */
...
/* 8014C088  C0 02 9A 84 */	lfs f0, lit_7442(r2)                     /* constant-address: 80453484, symbol: lit_7442 */
...
/* 8014C130  3B 43 61 C0 */	addi r26, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
lbl_8014C134:
/* 8014C134  80 7A 5D 3C */	lwz r3, 0x5d3c(r26)                      /* constant-address: 8040BEFC, symbol: None */
...
/* 8014C168  38 C2 9A 80 */	la r6, data_80453480(r2) /* 80453480-_SDA2_BASE_ */ /* constant-address: 80453480, symbol: data_80453480 */
...
/* 8014C180  C0 22 99 DC */	lfs f1, lit_4140(r2)                     /* constant-address: 804533DC, symbol: lit_4140 */
/* 8014C184  4B F0 13 49 */	bl set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf /* constant-address: 8004D4CC, symbol: set__13dPa_control_cFUlUcUsPC4cXyzPC12dKy_tevstr_cPC5csXyzPC4cXyzUcP18dPa_levelEcallBackScPC8_GXColorPC8_GXColorPC4cXyzf */
/* 8014C188  7C 7E D9 2E */	stwx r3, r30, r27                       
/* 8014C18C  80 7A 5D 3C */	lwz r3, 0x5d3c(r26)                      /* constant-address: 8040BEFC, symbol: None */
/* 8014C190  38 63 02 10 */	addi r3, r3, 0x210                      
/* 8014C194  7C 9E D8 2E */	lwzx r4, r30, r27                       
/* 8014C198  4B EF F7 81 */	bl getEmitter__Q213dPa_control_c7level_cFUl /* constant-address: 8004B918, symbol: getEmitter__Q213dPa_control_c7level_cFUl */
/* 8014C19C  7C 7B 1B 79 */	or. r27, r3, r3                         
/* 8014C1A0  41 82 00 34 */	beq lbl_8014C1D4                         /* constant-address: 8014C1D4, symbol: lbl_8014C1D4 */
/* 8014C1A4  4B EE 38 B1 */	bl dComIfGs_wolfeye_effect_check__Fv     /* constant-address: 8002FA54, symbol: dComIfGs_wolfeye_effect_check__Fv */
...
lbl_8014C1D4:
/* 8014C1D4  3B FF 00 01 */	addi r31, r31, 1                         /* constant-address: 00000001 */
/* 8014C1D8  2C 1F 00 02 */	cmpwi r31, 2                            
/* 8014C1DC  3B BD 00 02 */	addi r29, r29, 2                         /* constant-address: 00000002 */
/* 8014C1E0  3B 9C 00 04 */	addi r28, r28, 4                         /* constant-address: 00000004 */
/* 8014C1E4  41 80 FF 50 */	blt lbl_8014C134                         /* constant-address: 8014C134, symbol: lbl_8014C134 */
/* 8014C1E8  39 61 00 50 */	addi r11, r1, 0x50                      
/* 8014C1EC  48 21 60 31 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

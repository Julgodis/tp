...
/* 8014C510  48 21 5C BD */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 8014C528  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014C52C  38 63 4E C4 */	addi r3, r3, 0x4ec4                      /* constant-address: 8040B084, symbol: None */
/* 8014C530  4B ED 7E 55 */	bl getStatusRoomDt__20dStage_roomControl_cFi /* constant-address: 80024384, symbol: getStatusRoomDt__20dStage_roomControl_cFi */
/* 8014C534  7C 7F 1B 78 */	mr r31, r3                              
/* 8014C538  81 83 00 00 */	lwz r12, 0(r3)                           /* constant-address: 8040B084, symbol: None */
/* 8014C53C  81 8C 00 20 */	lwz r12, 0x20(r12)                      
/* 8014C540  7D 89 03 A6 */	mtctr r12                               
/* 8014C544  4E 80 04 21 */	bctrl                                   
/* 8014C548  83 A3 00 04 */	lwz r29, 4(r3)                           /* constant-address: 8040B088, symbol: None */
/* 8014C54C  3B 80 00 00 */	li r28, 0                               
/* 8014C550  48 00 00 54 */	b lbl_8014C5A4                           /* constant-address: 8014C5A4, symbol: lbl_8014C5A4 */
lbl_8014C554:
/* 8014C554  A8 1D 00 1C */	lha r0, 0x1c(r29)                       
/* 8014C558  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 8014C55C  7C 19 00 00 */	cmpw r25, r0                            
/* 8014C560  40 82 00 3C */	bne lbl_8014C59C                         /* constant-address: 8014C59C, symbol: lbl_8014C59C */
...
/* 8014C598  48 00 00 2C */	b lbl_8014C5C4                           /* constant-address: 8014C5C4, symbol: lbl_8014C5C4 */
lbl_8014C59C:
/* 8014C59C  3B BD 00 20 */	addi r29, r29, 0x20                     
/* 8014C5A0  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
lbl_8014C5A4:
/* 8014C5A4  7F E3 FB 78 */	mr r3, r31                              
/* 8014C5A8  81 9F 00 00 */	lwz r12, 0(r31)                          /* constant-address: 8040B084, symbol: None */
...
/* 8014C5C0  41 80 FF 94 */	blt lbl_8014C554                         /* constant-address: 8014C554, symbol: lbl_8014C554 */
lbl_8014C5C4:
/* 8014C5C4  7F C3 F3 78 */	mr r3, r30                              
/* 8014C5C8  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8014C5CC  48 21 5C 4D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

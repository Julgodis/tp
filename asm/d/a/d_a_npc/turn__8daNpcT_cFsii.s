...
/* 8014B4B0  40 82 00 A8 */	bne lbl_8014B558                         /* constant-address: 8014B558, symbol: lbl_8014B558 */
/* 8014B4B4  C0 22 9A 68 */	lfs f1, lit_7089(r2)                     /* constant-address: 80453468, symbol: lit_7089 */
/* 8014B4B8  A8 03 0D D4 */	lha r0, 0xdd4(r3)                       
/* 8014B4BC  7C 00 20 50 */	subf r0, r0, r4                         
/* 8014B4C0  7C 00 07 34 */	extsh r0, r0                            
/* 8014B4C4  C8 42 99 E0 */	lfd f2, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014B4F4  C0 02 9A 4C */	lfs f0, lit_6775(r2)                     /* constant-address: 8045344C, symbol: lit_6775 */
...
/* 8014B548  C0 02 9A 6C */	lfs f0, lit_7090(r2)                     /* constant-address: 8045346C, symbol: lit_7090 */
/* 8014B54C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8014B550  40 80 00 08 */	bge lbl_8014B558                         /* constant-address: 8014B558, symbol: lbl_8014B558 */
...
/* 8014B564  40 82 00 18 */	bne lbl_8014B57C                         /* constant-address: 8014B57C, symbol: lbl_8014B57C */
/* 8014B568  7C 05 38 50 */	subf r0, r5, r7                         
/* 8014B56C  7C 00 07 35 */	extsh. r0, r0                           
/* 8014B570  38 C0 FF FF */	li r6, -1                               
/* 8014B574  41 80 00 08 */	blt lbl_8014B57C                         /* constant-address: 8014B57C, symbol: lbl_8014B57C */
...
/* 8014B588  40 82 00 18 */	bne lbl_8014B5A0                         /* constant-address: 8014B5A0, symbol: lbl_8014B5A0 */
/* 8014B58C  3C A0 00 01 */	lis r5, 0x0001 /* 0x0000FFFF@ha */      
/* 8014B590  38 05 FF FF */	addi r0, r5, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 8014B5AC  38 A5 9A 20 */	addi r5, r5, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 8014B5B0  7C 45 04 2E */	lfsx f2, r5, r0                         
/* 8014B5B4  C8 22 99 E0 */	lfd f1, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014B5E0  C0 22 9A 70 */	lfs f1, lit_7091(r2)                     /* constant-address: 80453470, symbol: lit_7091 */
...
/* 8014B60C  40 80 00 14 */	bge lbl_8014B620                         /* constant-address: 8014B620, symbol: lbl_8014B620 */
/* 8014B610  A8 03 0D D4 */	lha r0, 0xdd4(r3)                       
/* 8014B614  7C 00 2A 14 */	add r0, r0, r5                          
/* 8014B618  B0 03 0D 7A */	sth r0, 0xd7a(r3)                       
/* 8014B61C  48 00 00 10 */	b lbl_8014B62C                           /* constant-address: 8014B62C, symbol: lbl_8014B62C */
lbl_8014B620:

...
/* 8014ABE0  48 21 75 FD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8014ABF8  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8014ABFC  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8014AC00  40 80 00 0C */	bge lbl_8014AC0C                         /* constant-address: 8014AC0C, symbol: lbl_8014AC0C */
/* 8014AC04  38 60 00 00 */	li r3, 0                                
/* 8014AC08  48 00 00 D0 */	b lbl_8014ACD8                           /* constant-address: 8014ACD8, symbol: lbl_8014ACD8 */
lbl_8014AC0C:
/* 8014AC0C  C0 02 9A 4C */	lfs f0, lit_6775(r2)                     /* constant-address: 8045344C, symbol: lit_6775 */
/* 8014AC10  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8014AC14  40 80 00 C0 */	bge lbl_8014ACD4                         /* constant-address: 8014ACD4, symbol: lbl_8014ACD4 */
/* 8014AC18  C0 02 9A 20 */	lfs f0, lit_5239(r2)                     /* constant-address: 80453420, symbol: lit_5239 */
...
/* 8014AC38  48 00 07 B5 */	bl getAttnPos__8daNpcT_cFP10fopAc_ac_c   /* constant-address: 8014B3EC, symbol: getAttnPos__8daNpcT_cFP10fopAc_ac_c */
...
/* 8014AC60  48 11 BE D5 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
/* 8014AC64  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8014AC68  38 81 00 1C */	addi r4, r1, 0x1c                       
/* 8014AC6C  48 12 6C 15 */	bl __ct__7cSGlobeFRC4cXyz                /* constant-address: 80271880, symbol: __ct__7cSGlobeFRC4cXyz */
/* 8014AC70  38 61 00 1A */	addi r3, r1, 0x1a                       
/* 8014AC74  48 12 64 75 */	bl Inv__7cSAngleCFv                      /* constant-address: 802710E8, symbol: Inv__7cSAngleCFv */
/* 8014AC78  7C 64 1B 78 */	mr r4, r3                               
/* 8014AC7C  38 61 00 0C */	addi r3, r1, 0xc                        
/* 8014AC80  48 12 63 19 */	bl __ct__7cSAngleFs                      /* constant-address: 80270F98, symbol: __ct__7cSAngleFs */
/* 8014AC84  38 61 00 08 */	addi r3, r1, 8                          
/* 8014AC88  38 81 00 0C */	addi r4, r1, 0xc                        
/* 8014AC8C  7F C5 07 34 */	extsh r5, r30                           
/* 8014AC90  48 12 65 99 */	bl __mi__7cSAngleCFs                     /* constant-address: 80271228, symbol: __mi__7cSAngleCFs */
/* 8014AC94  38 61 00 10 */	addi r3, r1, 0x10                       
/* 8014AC98  38 81 00 08 */	addi r4, r1, 8                          
/* 8014AC9C  48 12 62 CD */	bl __ct__7cSAngleFRC7cSAngle             /* constant-address: 80270F68, symbol: __ct__7cSAngleFRC7cSAngle */
/* 8014ACA0  A8 01 00 10 */	lha r0, 0x10(r1)                        
/* 8014ACA4  7C 00 07 35 */	extsh. r0, r0                           
/* 8014ACA8  40 80 00 0C */	bge lbl_8014ACB4                         /* constant-address: 8014ACB4, symbol: lbl_8014ACB4 */
...
/* 8014ACD0  48 00 00 08 */	b lbl_8014ACD8                           /* constant-address: 8014ACD8, symbol: lbl_8014ACD8 */
lbl_8014ACD4:
/* 8014ACD4  38 60 00 01 */	li r3, 1                                
lbl_8014ACD8:
/* 8014ACD8  39 61 00 60 */	addi r11, r1, 0x60                      
/* 8014ACDC  48 21 75 4D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

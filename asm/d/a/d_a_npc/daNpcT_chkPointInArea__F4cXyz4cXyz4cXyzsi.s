...
/* 8014C3B4  48 21 5E 25 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8014C3B8  7C 7C 1B 78 */	mr r28, r3                              
/* 8014C3BC  7C 9D 23 78 */	mr r29, r4                              
/* 8014C3C0  7C BE 2B 78 */	mr r30, r5                              
/* 8014C3C4  7C FF 3B 78 */	mr r31, r7                              
/* 8014C3C8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8014C3CC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8014C3D0  7C 06 00 D0 */	neg r0, r6                              
/* 8014C3D4  7C 04 07 34 */	extsh r4, r0                            
/* 8014C3D8  4B EC 00 05 */	bl mDoMtx_YrotS__FPA4_fs                 /* constant-address: 8000C3DC, symbol: mDoMtx_YrotS__FPA4_fs */
...
/* 8014C3F4  4B EC 09 A9 */	bl transM__14mDoMtx_stack_cFfff          /* constant-address: 8000CD9C, symbol: transM__14mDoMtx_stack_cFfff */
/* 8014C3F8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8014C3FC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8014C400  7F 84 E3 78 */	mr r4, r28                              
/* 8014C404  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 8014C408  48 1F A9 65 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 8014C440  41 82 00 50 */	beq lbl_8014C490                         /* constant-address: 8014C490, symbol: lbl_8014C490 */
/* 8014C444  38 61 00 08 */	addi r3, r1, 8                          
/* 8014C448  7F 84 E3 78 */	mr r4, r28                              
/* 8014C44C  7F A5 EB 78 */	mr r5, r29                              
/* 8014C450  48 11 A6 E5 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 8014C46C  C0 02 99 D8 */	lfs f0, lit_4116(r2)                     /* constant-address: 804533D8, symbol: lit_4116 */
/* 8014C470  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8014C474  4C 40 13 82 */	cror 2, 0, 2                            
/* 8014C478  40 82 00 10 */	bne lbl_8014C488                         /* constant-address: 8014C488, symbol: lbl_8014C488 */
/* 8014C47C  C0 1E 00 04 */	lfs f0, 4(r30)                          
/* 8014C480  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8014C484  41 80 00 0C */	blt lbl_8014C490                         /* constant-address: 8014C490, symbol: lbl_8014C490 */
lbl_8014C488:
/* 8014C488  38 60 00 00 */	li r3, 0                                
/* 8014C48C  48 00 00 3C */	b lbl_8014C4C8                           /* constant-address: 8014C4C8, symbol: lbl_8014C4C8 */
lbl_8014C490:
...
/* 8014C4AC  C0 02 99 DC */	lfs f0, lit_4140(r2)                     /* constant-address: 804533DC, symbol: lit_4140 */
/* 8014C4B0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8014C4B4  4C 40 13 82 */	cror 2, 0, 2                            
/* 8014C4B8  40 82 00 0C */	bne lbl_8014C4C4                         /* constant-address: 8014C4C4, symbol: lbl_8014C4C4 */
/* 8014C4BC  38 60 00 01 */	li r3, 1                                
/* 8014C4C0  48 00 00 08 */	b lbl_8014C4C8                           /* constant-address: 8014C4C8, symbol: lbl_8014C4C8 */
lbl_8014C4C4:
...
/* 8014C4EC  48 21 5D 39 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

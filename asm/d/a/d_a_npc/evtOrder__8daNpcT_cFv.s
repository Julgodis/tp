...
/* 8014A0D4  48 21 EB 11 */	bl strlen                                /* constant-address: 80368BE4, symbol: strlen */
/* 8014A0D8  28 03 00 00 */	cmplwi r3, 0                            
/* 8014A0DC  41 82 00 B8 */	beq lbl_8014A194                         /* constant-address: 8014A194, symbol: lbl_8014A194 */
...
/* 8014A100  48 21 EA E5 */	bl strlen                                /* constant-address: 80368BE4, symbol: strlen */
/* 8014A104  28 03 00 00 */	cmplwi r3, 0                            
/* 8014A108  41 82 00 3C */	beq lbl_8014A144                         /* constant-address: 8014A144, symbol: lbl_8014A144 */
...
/* 8014A134  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014A138  38 63 4F F8 */	addi r3, r3, 0x4ff8                      /* constant-address: 8040B1B8, symbol: None */
/* 8014A13C  80 9F 01 00 */	lwz r4, 0x100(r31)                      
/* 8014A140  4B EF C6 C1 */	bl setObjectArchive__16dEvent_manager_cFPc /* constant-address: 80046800, symbol: setObjectArchive__16dEvent_manager_cFPc */
lbl_8014A144:
/* 8014A144  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8014A148  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014A14C  38 63 4F F8 */	addi r3, r3, 0x4ff8                      /* constant-address: 8040B1B8, symbol: None */
...
/* 8014A168  4B EF D5 F1 */	bl getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc /* constant-address: 80047758, symbol: getEventIdx__16dEvent_manager_cFP10fopAc_ac_cPCcUc */
...
/* 8014A180  38 C6 FF FF */	addi r6, r6, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 8014A184  38 E0 00 28 */	li r7, 0x28                             
/* 8014A188  39 00 00 01 */	li r8, 1                                
/* 8014A18C  4B ED 14 F1 */	bl fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs /* constant-address: 8001B67C, symbol: fopAcM_orderOtherEventId__FP10fopAc_ac_csUcUsUsUs */
/* 8014A190  48 00 00 80 */	b lbl_8014A210                           /* constant-address: 8014A210, symbol: lbl_8014A210 */
lbl_8014A194:
/* 8014A194  88 1F 0A 89 */	lbz r0, 0xa89(r31)                      
/* 8014A198  28 00 00 00 */	cmplwi r0, 0                            
/* 8014A19C  41 82 00 10 */	beq lbl_8014A1AC                         /* constant-address: 8014A1AC, symbol: lbl_8014A1AC */
/* 8014A1A0  48 01 52 85 */	bl checkNowWolfEyeUp__9daPy_py_cFv       /* constant-address: 8015F424, symbol: checkNowWolfEyeUp__9daPy_py_cFv */
/* 8014A1A4  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014A1A8  41 82 00 68 */	beq lbl_8014A210                         /* constant-address: 8014A210, symbol: lbl_8014A210 */
lbl_8014A1AC:
/* 8014A1AC  80 7F 05 5C */	lwz r3, 0x55c(r31)                      
/* 8014A1B0  54 60 07 39 */	rlwinm. r0, r3, 0, 0x1c, 0x1c           
/* 8014A1B4  40 82 00 0C */	bne lbl_8014A1C0                         /* constant-address: 8014A1C0, symbol: lbl_8014A1C0 */
/* 8014A1B8  54 60 07 BD */	rlwinm. r0, r3, 0, 0x1e, 0x1e           
/* 8014A1BC  41 82 00 54 */	beq lbl_8014A210                         /* constant-address: 8014A210, symbol: lbl_8014A210 */
lbl_8014A1C0:
...
/* 8014A1E4  41 82 00 10 */	beq lbl_8014A1F4                         /* constant-address: 8014A1F4, symbol: lbl_8014A1F4 */
...
/* 8014A1FC  41 82 00 14 */	beq lbl_8014A210                         /* constant-address: 8014A210, symbol: lbl_8014A210 */
/* 8014A200  7F E3 FB 78 */	mr r3, r31                              
/* 8014A204  38 80 00 00 */	li r4, 0                                
/* 8014A208  38 A0 00 00 */	li r5, 0                                
/* 8014A20C  4B ED 0F 91 */	bl fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs /* constant-address: 8001B19C, symbol: fopAcM_orderSpeakEvent__FP10fopAc_ac_cUsUs */
lbl_8014A210:

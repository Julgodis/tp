...
/* 8014B03C  3B C3 61 C0 */	addi r30, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014B040  80 7E 5D B4 */	lwz r3, 0x5db4(r30)                      /* constant-address: 8040BF74, symbol: None */
/* 8014B044  80 03 05 74 */	lwz r0, 0x574(r3)                       
/* 8014B048  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 8014B04C  41 82 00 60 */	beq lbl_8014B0AC                         /* constant-address: 8014B0AC, symbol: lbl_8014B0AC */
/* 8014B050  3B E0 00 00 */	li r31, 0                               
/* 8014B054  80 7E 5D AC */	lwz r3, 0x5dac(r30)                      /* constant-address: 8040BF6C, symbol: None */
...
/* 8014B06C  40 82 00 38 */	bne lbl_8014B0A4                         /* constant-address: 8014B0A4, symbol: lbl_8014B0A4 */
/* 8014B070  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8014B074  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014B078  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 8014B07C  54 00 01 09 */	rlwinm. r0, r0, 0, 4, 4                 
/* 8014B080  40 82 00 24 */	bne lbl_8014B0A4                         /* constant-address: 8014B0A4, symbol: lbl_8014B0A4 */
/* 8014B084  80 7E 5D AC */	lwz r3, 0x5dac(r30)                      /* constant-address: 8040BF6C, symbol: None */
...
/* 8014B09C  40 82 00 08 */	bne lbl_8014B0A4                         /* constant-address: 8014B0A4, symbol: lbl_8014B0A4 */
/* 8014B0A0  3B E0 00 01 */	li r31, 1                               
lbl_8014B0A4:
/* 8014B0A4  57 E3 06 3E */	clrlwi r3, r31, 0x18                    
/* 8014B0A8  48 00 00 08 */	b lbl_8014B0B0                           /* constant-address: 8014B0B0, symbol: lbl_8014B0B0 */
lbl_8014B0AC:

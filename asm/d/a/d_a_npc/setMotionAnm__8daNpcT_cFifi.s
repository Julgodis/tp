...
/* 8014A640  48 21 7B 91 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8014A69C  42 00 FF F0 */	bdnz lbl_8014A68C                        /* constant-address: 8014A68C, symbol: lbl_8014A68C */
...
/* 8014A6E4  42 00 FF F0 */	bdnz lbl_8014A6D4                        /* constant-address: 8014A6D4, symbol: lbl_8014A6D4 */
...
/* 8014A6F8  41 82 00 4C */	beq lbl_8014A744                         /* constant-address: 8014A744, symbol: lbl_8014A744 */
...
/* 8014A73C  4B FF D9 59 */	bl getTrnsfrmKeyAnmP__8daNpcT_cFPCci     /* constant-address: 80148094, symbol: getTrnsfrmKeyAnmP__8daNpcT_cFPCci */
/* 8014A740  7C 7F 1B 78 */	mr r31, r3                              
lbl_8014A744:
/* 8014A744  28 1F 00 00 */	cmplwi r31, 0                           
/* 8014A748  41 82 00 7C */	beq lbl_8014A7C4                         /* constant-address: 8014A7C4, symbol: lbl_8014A7C4 */
/* 8014A74C  2C 1C 00 00 */	cmpwi r28, 0                            
/* 8014A750  41 82 00 30 */	beq lbl_8014A780                         /* constant-address: 8014A780, symbol: lbl_8014A780 */
/* 8014A754  80 7A 05 78 */	lwz r3, 0x578(r26)                      
/* 8014A758  80 03 00 08 */	lwz r0, 8(r3)                           
/* 8014A75C  7C 1F 00 40 */	cmplw r31, r0                           
/* 8014A760  40 82 00 20 */	bne lbl_8014A780                         /* constant-address: 8014A780, symbol: lbl_8014A780 */
...
/* 8014A77C  48 00 00 48 */	b lbl_8014A7C4                           /* constant-address: 8014A7C4, symbol: lbl_8014A7C4 */
lbl_8014A780:
/* 8014A780  7F 43 D3 78 */	mr r3, r26                              
/* 8014A784  7F E4 FB 78 */	mr r4, r31                              
/* 8014A788  C0 22 99 DC */	lfs f1, lit_4140(r2)                     /* constant-address: 804533DC, symbol: lit_4140 */
...
/* 8014A79C  4B FF DA 69 */	bl setMcaMorfAnm__8daNpcT_cFP18J3DAnmTransformKeyffiii /* constant-address: 80148204, symbol: setMcaMorfAnm__8daNpcT_cFP18J3DAnmTransformKeyffiii */
/* 8014A7A0  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014A7A4  41 82 00 1C */	beq lbl_8014A7C0                         /* constant-address: 8014A7C0, symbol: lbl_8014A7C0 */
...
/* 8014A7BC  48 00 00 08 */	b lbl_8014A7C4                           /* constant-address: 8014A7C4, symbol: lbl_8014A7C4 */
lbl_8014A7C0:
/* 8014A7C0  3B E0 00 00 */	li r31, 0                               
lbl_8014A7C4:
/* 8014A7C4  28 1F 00 00 */	cmplwi r31, 0                           
/* 8014A7C8  40 82 00 18 */	bne lbl_8014A7E0                         /* constant-address: 8014A7E0, symbol: lbl_8014A7E0 */
/* 8014A7CC  80 01 00 50 */	lwz r0, 0x50(r1)                        
/* 8014A7D0  2C 00 FF FF */	cmpwi r0, -1                            
/* 8014A7D4  41 82 00 0C */	beq lbl_8014A7E0                         /* constant-address: 8014A7E0, symbol: lbl_8014A7E0 */
/* 8014A7D8  38 60 00 00 */	li r3, 0                                
/* 8014A7DC  48 00 01 0C */	b lbl_8014A8E8                           /* constant-address: 8014A8E8, symbol: lbl_8014A8E8 */
lbl_8014A7E0:
...
/* 8014A7F4  41 82 00 5C */	beq lbl_8014A850                         /* constant-address: 8014A850, symbol: lbl_8014A850 */
...
/* 8014A848  4B FF D8 C5 */	bl getTexSRTKeyAnmP__8daNpcT_cFPCci      /* constant-address: 8014810C, symbol: getTexSRTKeyAnmP__8daNpcT_cFPCci */
/* 8014A84C  7C 7E 1B 78 */	mr r30, r3                              
lbl_8014A850:
/* 8014A850  28 1E 00 00 */	cmplwi r30, 0                           
/* 8014A854  41 82 00 58 */	beq lbl_8014A8AC                         /* constant-address: 8014A8AC, symbol: lbl_8014A8AC */
/* 8014A858  2C 1D 00 00 */	cmpwi r29, 0                            
/* 8014A85C  41 82 00 14 */	beq lbl_8014A870                         /* constant-address: 8014A870, symbol: lbl_8014A870 */
/* 8014A860  80 1A 0D 98 */	lwz r0, 0xd98(r26)                      
/* 8014A864  60 00 00 80 */	ori r0, r0, 0x80                        
/* 8014A868  90 1A 0D 98 */	stw r0, 0xd98(r26)                      
/* 8014A86C  48 00 00 40 */	b lbl_8014A8AC                           /* constant-address: 8014A8AC, symbol: lbl_8014A8AC */
lbl_8014A870:
...
/* 8014A884  C0 22 99 DC */	lfs f1, lit_4140(r2)                     /* constant-address: 804533DC, symbol: lit_4140 */
/* 8014A888  80 C1 00 60 */	lwz r6, 0x60(r1)                        
/* 8014A88C  4B FF DA AD */	bl setBtkAnm__8daNpcT_cFP19J3DAnmTextureSRTKeyP12J3DModelDatafi /* constant-address: 80148338, symbol: setBtkAnm__8daNpcT_cFP19J3DAnmTextureSRTKeyP12J3DModelDatafi */
/* 8014A890  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014A894  41 82 00 14 */	beq lbl_8014A8A8                         /* constant-address: 8014A8A8, symbol: lbl_8014A8A8 */
/* 8014A898  80 1A 0D 98 */	lwz r0, 0xd98(r26)                      
/* 8014A89C  60 00 00 82 */	ori r0, r0, 0x82                        
/* 8014A8A0  90 1A 0D 98 */	stw r0, 0xd98(r26)                      
/* 8014A8A4  48 00 00 08 */	b lbl_8014A8AC                           /* constant-address: 8014A8AC, symbol: lbl_8014A8AC */
lbl_8014A8A8:
/* 8014A8A8  3B C0 00 00 */	li r30, 0                               
lbl_8014A8AC:
/* 8014A8AC  28 1E 00 00 */	cmplwi r30, 0                           
/* 8014A8B0  40 82 00 14 */	bne lbl_8014A8C4                         /* constant-address: 8014A8C4, symbol: lbl_8014A8C4 */
/* 8014A8B4  2C 1F FF FF */	cmpwi r31, -1                           
/* 8014A8B8  41 82 00 0C */	beq lbl_8014A8C4                         /* constant-address: 8014A8C4, symbol: lbl_8014A8C4 */
/* 8014A8BC  38 60 00 00 */	li r3, 0                                
/* 8014A8C0  48 00 00 28 */	b lbl_8014A8E8                           /* constant-address: 8014A8E8, symbol: lbl_8014A8E8 */
lbl_8014A8C4:
...
/* 8014A8F4  48 21 79 29 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

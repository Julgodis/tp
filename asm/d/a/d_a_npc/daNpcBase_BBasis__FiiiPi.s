...
/* 8014D69C  48 21 4B 31 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 8014D6B0  41 82 01 00 */	beq lbl_8014D7B0                         /* constant-address: 8014D7B0, symbol: lbl_8014D7B0 */
...
/* 8014D6D4  C8 22 99 E0 */	lfd f1, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014D6F0  C0 02 99 D8 */	lfs f0, lit_4116(r2)                     /* constant-address: 804533D8, symbol: lit_4116 */
/* 8014D6F4  FC 00 F8 00 */	fcmpu cr0, f0, f31                      
/* 8014D6F8  41 82 00 3C */	beq lbl_8014D734                         /* constant-address: 8014D734, symbol: lbl_8014D734 */
/* 8014D6FC  38 7B FF FF */	addi r3, r27, -1                        
/* 8014D700  38 9C 00 01 */	addi r4, r28, 1                         
/* 8014D704  4B FF FF 79 */	bl daNpcBase_BBasis__FiiiPi              /* constant-address: 8014D67C, symbol: daNpcBase_BBasis__FiiiPi */
/* 8014D708  80 1A 00 04 */	lwz r0, 4(r26)                          
/* 8014D70C  7C 1D 00 50 */	subf r0, r29, r0                        
/* 8014D710  C8 42 99 E0 */	lfd f2, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014D740  C8 22 99 E0 */	lfd f1, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014D75C  C0 02 99 D8 */	lfs f0, lit_4116(r2)                     /* constant-address: 804533D8, symbol: lit_4116 */
/* 8014D760  FC 00 F0 00 */	fcmpu cr0, f0, f30                      
/* 8014D764  41 82 00 44 */	beq lbl_8014D7A8                         /* constant-address: 8014D7A8, symbol: lbl_8014D7A8 */
...
/* 8014D778  4B FF FF 05 */	bl daNpcBase_BBasis__FiiiPi              /* constant-address: 8014D67C, symbol: daNpcBase_BBasis__FiiiPi */
/* 8014D77C  7C 1E F8 2E */	lwzx r0, r30, r31                       
/* 8014D780  7C 00 E8 50 */	subf r0, r0, r29                        
/* 8014D784  C8 42 99 E0 */	lfd f2, lit_4142(r2)                     /* constant-address: 804533E0, symbol: lit_4142 */
...
/* 8014D7AC  48 00 00 30 */	b lbl_8014D7DC                           /* constant-address: 8014D7DC, symbol: lbl_8014D7DC */
lbl_8014D7B0:
/* 8014D7B0  57 83 10 3A */	slwi r3, r28, 2                         
/* 8014D7B4  7C 1E 18 2E */	lwzx r0, r30, r3                        
/* 8014D7B8  7C 00 E8 00 */	cmpw r0, r29                            
/* 8014D7BC  41 81 00 1C */	bgt lbl_8014D7D8                         /* constant-address: 8014D7D8, symbol: lbl_8014D7D8 */
/* 8014D7C0  7C 7E 1A 14 */	add r3, r30, r3                         
/* 8014D7C4  80 03 00 04 */	lwz r0, 4(r3)                           
/* 8014D7C8  7C 1D 00 00 */	cmpw r29, r0                            
/* 8014D7CC  41 81 00 0C */	bgt lbl_8014D7D8                         /* constant-address: 8014D7D8, symbol: lbl_8014D7D8 */
/* 8014D7D0  C0 22 99 DC */	lfs f1, lit_4140(r2)                     /* constant-address: 804533DC, symbol: lit_4140 */
/* 8014D7D4  48 00 00 08 */	b lbl_8014D7DC                           /* constant-address: 8014D7DC, symbol: lbl_8014D7DC */
lbl_8014D7D8:
/* 8014D7D8  C0 22 99 D8 */	lfs f1, lit_4116(r2)                     /* constant-address: 804533D8, symbol: lit_4116 */
lbl_8014D7DC:
...
/* 8014D7F0  48 21 4A 29 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

...
/* 8014B0F8  48 21 70 D9 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 8014B12C  3B E5 61 C0 */	addi r31, r5, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014B130  80 BF 5D AC */	lwz r5, 0x5dac(r31)                      /* constant-address: 8040BF6C, symbol: None */
/* 8014B134  48 00 02 B9 */	bl getAttnPos__8daNpcT_cFP10fopAc_ac_c   /* constant-address: 8014B3EC, symbol: getAttnPos__8daNpcT_cFP10fopAc_ac_c */
...
/* 8014B154  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8014B158  80 63 5D B4 */	lwz r3, 0x5db4(r3)                       /* constant-address: 8040BF74, symbol: None */
/* 8014B15C  80 03 05 74 */	lwz r0, 0x574(r3)                       
/* 8014B160  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 8014B164  41 82 01 98 */	beq lbl_8014B2FC                         /* constant-address: 8014B2FC, symbol: lbl_8014B2FC */
...
/* 8014B1A8  4B FF FB 49 */	bl chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs /* constant-address: 8014ACF0, symbol: chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs */
/* 8014B1AC  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014B1B0  41 82 00 28 */	beq lbl_8014B1D8                         /* constant-address: 8014B1D8, symbol: lbl_8014B1D8 */
/* 8014B1B4  7F 43 D3 78 */	mr r3, r26                              
/* 8014B1B8  80 9F 5D AC */	lwz r4, 0x5dac(r31)                      /* constant-address: 8040BF6C, symbol: None */
/* 8014B1BC  FC 20 E8 90 */	fmr f1, f29                             
/* 8014B1C0  7F 65 DB 78 */	mr r5, r27                              
/* 8014B1C4  4B FF FA 0D */	bl chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs /* constant-address: 8014ABD0, symbol: chkActorInSight__8daNpcT_cFP10fopAc_ac_cfs */
/* 8014B1C8  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014B1CC  41 82 00 0C */	beq lbl_8014B1D8                         /* constant-address: 8014B1D8, symbol: lbl_8014B1D8 */
/* 8014B1D0  38 60 00 01 */	li r3, 1                                
/* 8014B1D4  48 00 01 2C */	b lbl_8014B300                           /* constant-address: 8014B300, symbol: lbl_8014B300 */
lbl_8014B1D8:
/* 8014B1D8  7F 83 E3 78 */	mr r3, r28                              
/* 8014B1DC  4B FF FE 35 */	bl getDistTable__12dAttention_cFi        /* constant-address: 8014B010, symbol: getDistTable__12dAttention_cFi */
/* 8014B1E0  C3 C3 00 00 */	lfs f30, 0(r3)                          
/* 8014B1E4  7F 83 E3 78 */	mr r3, r28                              
/* 8014B1E8  4B FF FE 29 */	bl getDistTable__12dAttention_cFi        /* constant-address: 8014B010, symbol: getDistTable__12dAttention_cFi */
/* 8014B1EC  C3 E3 00 0C */	lfs f31, 0xc(r3)                        
/* 8014B1F0  7F 83 E3 78 */	mr r3, r28                              
/* 8014B1F4  4B FF FE 1D */	bl getDistTable__12dAttention_cFi        /* constant-address: 8014B010, symbol: getDistTable__12dAttention_cFi */
...
/* 8014B244  4B FF FA AD */	bl chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs /* constant-address: 8014ACF0, symbol: chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs */
/* 8014B248  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014B24C  41 82 00 0C */	beq lbl_8014B258                         /* constant-address: 8014B258, symbol: lbl_8014B258 */
/* 8014B250  38 60 00 01 */	li r3, 1                                
/* 8014B254  48 00 00 AC */	b lbl_8014B300                           /* constant-address: 8014B300, symbol: lbl_8014B300 */
lbl_8014B258:
/* 8014B258  8B FA 05 45 */	lbz r31, 0x545(r26)                     
/* 8014B25C  7F E3 FB 78 */	mr r3, r31                              
/* 8014B260  4B FF FD B1 */	bl getDistTable__12dAttention_cFi        /* constant-address: 8014B010, symbol: getDistTable__12dAttention_cFi */
/* 8014B264  C3 E3 00 00 */	lfs f31, 0(r3)                          
/* 8014B268  7F E3 FB 78 */	mr r3, r31                              
/* 8014B26C  4B FF FD A5 */	bl getDistTable__12dAttention_cFi        /* constant-address: 8014B010, symbol: getDistTable__12dAttention_cFi */
/* 8014B270  C3 C3 00 0C */	lfs f30, 0xc(r3)                        
/* 8014B274  7F E3 FB 78 */	mr r3, r31                              
/* 8014B278  4B FF FD 99 */	bl getDistTable__12dAttention_cFi        /* constant-address: 8014B010, symbol: getDistTable__12dAttention_cFi */
...
/* 8014B2C8  4B FF FA 29 */	bl chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs /* constant-address: 8014ACF0, symbol: chkPointInArea__8daNpcT_cF4cXyz4cXyzfffs */
/* 8014B2CC  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014B2D0  41 82 00 2C */	beq lbl_8014B2FC                         /* constant-address: 8014B2FC, symbol: lbl_8014B2FC */
/* 8014B2D4  2C 1D 00 02 */	cmpwi r29, 2                            
/* 8014B2D8  40 80 00 24 */	bge lbl_8014B2FC                         /* constant-address: 8014B2FC, symbol: lbl_8014B2FC */
/* 8014B2DC  2C 1E 00 00 */	cmpwi r30, 0                            
/* 8014B2E0  41 82 00 1C */	beq lbl_8014B2FC                         /* constant-address: 8014B2FC, symbol: lbl_8014B2FC */
/* 8014B2E4  7F 43 D3 78 */	mr r3, r26                              
/* 8014B2E8  4B FF FD 3D */	bl chkWolfAction__8daNpcT_cFv            /* constant-address: 8014B024, symbol: chkWolfAction__8daNpcT_cFv */
/* 8014B2EC  2C 03 00 00 */	cmpwi r3, 0                             
/* 8014B2F0  41 82 00 0C */	beq lbl_8014B2FC                         /* constant-address: 8014B2FC, symbol: lbl_8014B2FC */
/* 8014B2F4  38 60 00 01 */	li r3, 1                                
/* 8014B2F8  48 00 00 08 */	b lbl_8014B300                           /* constant-address: 8014B300, symbol: lbl_8014B300 */
lbl_8014B2FC:
...
/* 8014B324  48 21 6E F9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

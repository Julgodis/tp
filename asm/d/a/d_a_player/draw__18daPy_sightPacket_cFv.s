...
/* 8015F1B8  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8015F1BC  48 1B 15 81 */	bl reinitGX__6J3DSysFv                   /* constant-address: 8031073C, symbol: reinitGX__6J3DSysFv */
/* 8015F1C0  38 60 00 00 */	li r3, 0                                
/* 8015F1C4  48 1F FF 11 */	bl GXSetNumIndStages                     /* constant-address: 8035F0D4, symbol: GXSetNumIndStages */
/* 8015F1C8  48 1F C3 C5 */	bl GXClearVtxDesc                        /* constant-address: 8035B58C, symbol: GXClearVtxDesc */
/* 8015F1CC  38 60 00 09 */	li r3, 9                                
/* 8015F1D0  38 80 00 01 */	li r4, 1                                
/* 8015F1D4  48 1F BC E5 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
/* 8015F1D8  38 60 00 0D */	li r3, 0xd                              
/* 8015F1DC  38 80 00 01 */	li r4, 1                                
/* 8015F1E0  48 1F BC D9 */	bl GXSetVtxDesc                          /* constant-address: 8035AEB8, symbol: GXSetVtxDesc */
...
/* 8015F1F8  48 1F C3 CD */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
...
/* 8015F210  48 1F C3 B5 */	bl GXSetVtxAttrFmt                       /* constant-address: 8035B5C4, symbol: GXSetVtxAttrFmt */
/* 8015F214  80 02 9C 7C */	lwz r0, lit_4669(r2)                     /* constant-address: 8045367C, symbol: lit_4669 */
/* 8015F218  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 8015F21C  80 02 9C 78 */	lwz r0, lit_4668(r2)                     /* constant-address: 80453678, symbol: lit_4668 */
/* 8015F220  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 8015F224  38 60 00 01 */	li r3, 1                                
/* 8015F228  38 81 00 0C */	addi r4, r1, 0xc                        
/* 8015F22C  48 20 01 51 */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
...
/* 8015F240  48 20 01 3D */	bl GXSetTevColor                         /* constant-address: 8035F37C, symbol: GXSetTevColor */
...
/* 8015F270  48 1F EB D1 */	bl GXInitTexObj                          /* constant-address: 8035DE40, symbol: GXInitTexObj */
/* 8015F274  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8015F278  38 80 00 01 */	li r4, 1                                
/* 8015F27C  38 A0 00 01 */	li r5, 1                                
/* 8015F280  C0 22 9C 00 */	lfs f1, lit_4215(r2)                     /* constant-address: 80453600, symbol: lit_4215 */
...
/* 8015F298  48 1F EE 3D */	bl GXInitTexObjLOD                       /* constant-address: 8035E0D4, symbol: GXInitTexObjLOD */
/* 8015F29C  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8015F2A0  38 80 00 00 */	li r4, 0                                
/* 8015F2A4  48 1F F1 71 */	bl GXLoadTexObj                          /* constant-address: 8035E414, symbol: GXLoadTexObj */
/* 8015F2A8  38 7F 00 14 */	addi r3, r31, 0x14                      
/* 8015F2AC  38 80 00 00 */	li r4, 0                                
/* 8015F2B0  48 20 0F 9D */	bl GXLoadPosMtxImm                       /* constant-address: 8036024C, symbol: GXLoadPosMtxImm */
/* 8015F2B4  38 60 00 00 */	li r3, 0                                
/* 8015F2B8  48 20 10 35 */	bl GXSetCurrentMtx                       /* constant-address: 803602EC, symbol: GXSetCurrentMtx */
/* 8015F2BC  38 60 00 00 */	li r3, 0                                
/* 8015F2C0  38 80 00 00 */	li r4, 0                                
/* 8015F2C4  38 A0 00 00 */	li r5, 0                                
/* 8015F2C8  38 C0 00 FF */	li r6, 0xff                             
/* 8015F2CC  48 20 04 29 */	bl GXSetTevOrder                         /* constant-address: 8035F6F4, symbol: GXSetTevOrder */
/* 8015F2D0  3C 60 80 3C */	lis r3, l_sightDL@ha                    
/* 8015F2D4  38 63 A0 C0 */	addi r3, r3, l_sightDL@l                 /* constant-address: 803BA0C0, symbol: l_sightDL */
/* 8015F2D8  38 80 00 80 */	li r4, 0x80                             
/* 8015F2DC  48 20 0C 15 */	bl GXCallDisplayList                     /* constant-address: 8035FEF0, symbol: GXCallDisplayList */
/* 8015F2E0  38 00 00 00 */	li r0, 0                                
/* 8015F2E4  90 0D 90 50 */	stw r0, sOldVcdVatCmd__8J3DShape(r13)    /* constant-address: 804515D0, symbol: sOldVcdVatCmd__8J3DShape */

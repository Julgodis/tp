...
/* 8015E88C  48 20 39 51 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8015E890  7C 7D 1B 78 */	mr r29, r3                              
/* 8015E894  7C 9E 23 78 */	mr r30, r4                              
/* 8015E898  48 00 10 39 */	bl getThrowBoomerangActor__9daPy_py_cFv  /* constant-address: 8015F8D0, symbol: getThrowBoomerangActor__9daPy_py_cFv */
/* 8015E89C  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8015E8A0  41 82 01 54 */	beq lbl_8015E9F4                         /* constant-address: 8015E9F4, symbol: lbl_8015E9F4 */
...
/* 8015E8C0  C0 22 9C 00 */	lfs f1, lit_4215(r2)                     /* constant-address: 80453600, symbol: lit_4215 */
...
/* 8015E8E8  48 1E 8A B5 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 8015E8EC  C0 02 9C 00 */	lfs f0, lit_4215(r2)                     /* constant-address: 80453600, symbol: lit_4215 */
/* 8015E8F0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E8F4  40 81 00 58 */	ble lbl_8015E94C                         /* constant-address: 8015E94C, symbol: lbl_8015E94C */
/* 8015E8F8  FC 00 08 34 */	frsqrte f0, f1                          
/* 8015E8FC  C8 82 9C 30 */	lfd f4, lit_4379(r2)                     /* constant-address: 80453630, symbol: lit_4379 */
/* 8015E900  FC 44 00 32 */	fmul f2, f4, f0                         
/* 8015E904  C8 62 9C 38 */	lfd f3, lit_4380(r2)                     /* constant-address: 80453638, symbol: lit_4380 */
...
/* 8015E948  48 00 00 88 */	b lbl_8015E9D0                           /* constant-address: 8015E9D0, symbol: lbl_8015E9D0 */
lbl_8015E94C:
/* 8015E94C  C8 02 9C 40 */	lfd f0, lit_4381(r2)                     /* constant-address: 80453640, symbol: lit_4381 */
/* 8015E950  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E954  40 80 00 10 */	bge lbl_8015E964                         /* constant-address: 8015E964, symbol: lbl_8015E964 */
/* 8015E958  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8015E95C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8015E960  48 00 00 70 */	b lbl_8015E9D0                           /* constant-address: 8015E9D0, symbol: lbl_8015E9D0 */
lbl_8015E964:
...
/* 8015E978  41 82 00 14 */	beq lbl_8015E98C                         /* constant-address: 8015E98C, symbol: lbl_8015E98C */
/* 8015E97C  40 80 00 40 */	bge lbl_8015E9BC                         /* constant-address: 8015E9BC, symbol: lbl_8015E9BC */
/* 8015E980  2C 03 00 00 */	cmpwi r3, 0                             
/* 8015E984  41 82 00 20 */	beq lbl_8015E9A4                         /* constant-address: 8015E9A4, symbol: lbl_8015E9A4 */
/* 8015E988  48 00 00 34 */	b lbl_8015E9BC                           /* constant-address: 8015E9BC, symbol: lbl_8015E9BC */
lbl_8015E98C:
/* 8015E98C  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8015E990  41 82 00 0C */	beq lbl_8015E99C                         /* constant-address: 8015E99C, symbol: lbl_8015E99C */
/* 8015E994  38 00 00 01 */	li r0, 1                                
/* 8015E998  48 00 00 28 */	b lbl_8015E9C0                           /* constant-address: 8015E9C0, symbol: lbl_8015E9C0 */
lbl_8015E99C:
/* 8015E99C  38 00 00 02 */	li r0, 2                                
/* 8015E9A0  48 00 00 20 */	b lbl_8015E9C0                           /* constant-address: 8015E9C0, symbol: lbl_8015E9C0 */
lbl_8015E9A4:
/* 8015E9A4  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8015E9A8  41 82 00 0C */	beq lbl_8015E9B4                         /* constant-address: 8015E9B4, symbol: lbl_8015E9B4 */
/* 8015E9AC  38 00 00 05 */	li r0, 5                                
/* 8015E9B0  48 00 00 10 */	b lbl_8015E9C0                           /* constant-address: 8015E9C0, symbol: lbl_8015E9C0 */
lbl_8015E9B4:
/* 8015E9B4  38 00 00 03 */	li r0, 3                                
/* 8015E9B8  48 00 00 08 */	b lbl_8015E9C0                           /* constant-address: 8015E9C0, symbol: lbl_8015E9C0 */
lbl_8015E9BC:
/* 8015E9BC  38 00 00 04 */	li r0, 4                                
lbl_8015E9C0:
/* 8015E9C0  2C 00 00 01 */	cmpwi r0, 1                             
/* 8015E9C4  40 82 00 0C */	bne lbl_8015E9D0                         /* constant-address: 8015E9D0, symbol: lbl_8015E9D0 */
/* 8015E9C8  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8015E9CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_8015E9D0:
...
/* 8015E9EC  48 10 8C 89 */	bl cM_atan2s__Fff                        /* constant-address: 80267674, symbol: cM_atan2s__Fff */
/* 8015E9F0  B0 7D 00 02 */	sth r3, 2(r29)                          
lbl_8015E9F4:
/* 8015E9F4  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8015E9F8  48 20 38 31 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

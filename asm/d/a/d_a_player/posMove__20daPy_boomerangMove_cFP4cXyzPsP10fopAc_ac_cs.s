...
/* 8015E664  48 20 3B 71 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8015E67C  48 00 12 55 */	bl getThrowBoomerangActor__9daPy_py_cFv  /* constant-address: 8015F8D0, symbol: getThrowBoomerangActor__9daPy_py_cFv */
...
/* 8015E69C  C0 02 9C 20 */	lfs f0, lit_4332(r2)                     /* constant-address: 80453620, symbol: lit_4332 */
/* 8015E6A0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E6A4  40 81 00 08 */	ble lbl_8015E6AC                         /* constant-address: 8015E6AC, symbol: lbl_8015E6AC */
/* 8015E6A8  D0 1E 00 08 */	stfs f0, 8(r30)                         
lbl_8015E6AC:
/* 8015E6AC  C0 3E 00 04 */	lfs f1, 4(r30)                          
/* 8015E6B0  C0 02 9C 24 */	lfs f0, lit_4333(r2)                     /* constant-address: 80453624, symbol: lit_4333 */
/* 8015E6B4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E6B8  40 80 00 0C */	bge lbl_8015E6C4                         /* constant-address: 8015E6C4, symbol: lbl_8015E6C4 */
/* 8015E6BC  D0 1E 00 04 */	stfs f0, 4(r30)                         
/* 8015E6C0  48 00 00 14 */	b lbl_8015E6D4                           /* constant-address: 8015E6D4, symbol: lbl_8015E6D4 */
lbl_8015E6C4:
/* 8015E6C4  C0 02 9C 18 */	lfs f0, lit_4249(r2)                     /* constant-address: 80453618, symbol: lit_4249 */
/* 8015E6C8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8015E6CC  40 81 00 08 */	ble lbl_8015E6D4                         /* constant-address: 8015E6D4, symbol: lbl_8015E6D4 */
/* 8015E6D0  D0 1E 00 04 */	stfs f0, 4(r30)                         
lbl_8015E6D4:
/* 8015E6D4  28 03 00 00 */	cmplwi r3, 0                            
/* 8015E6D8  41 82 00 BC */	beq lbl_8015E794                         /* constant-address: 8015E794, symbol: lbl_8015E794 */
/* 8015E6DC  88 03 09 56 */	lbz r0, 0x956(r3)                       
/* 8015E6E0  28 00 00 00 */	cmplwi r0, 0                            
/* 8015E6E4  41 82 00 0C */	beq lbl_8015E6F0                         /* constant-address: 8015E6F0, symbol: lbl_8015E6F0 */
/* 8015E6E8  38 60 00 00 */	li r3, 0                                
/* 8015E6EC  48 00 01 78 */	b lbl_8015E864                           /* constant-address: 8015E864, symbol: lbl_8015E864 */
lbl_8015E6F0:
/* 8015E6F0  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha           
/* 8015E6F4  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015E6F8  88 04 4F AD */	lbz r0, 0x4fad(r4)                       /* constant-address: 8040B16D, symbol: None */
/* 8015E6FC  28 00 00 00 */	cmplwi r0, 0                            
/* 8015E700  41 82 00 10 */	beq lbl_8015E710                         /* constant-address: 8015E710, symbol: lbl_8015E710 */
/* 8015E704  38 00 00 01 */	li r0, 1                                
/* 8015E708  98 1E 00 00 */	stb r0, 0(r30)                          
/* 8015E70C  48 00 00 24 */	b lbl_8015E730                           /* constant-address: 8015E730, symbol: lbl_8015E730 */
lbl_8015E710:
/* 8015E710  A8 0D 8A 9E */	lha r0, struct_8045101C+0x2(r13)         /* constant-address: 8045101E, symbol: struct_8045101C+0x2 */
/* 8015E714  2C 00 00 00 */	cmpwi r0, 0                             
/* 8015E718  41 82 00 18 */	beq lbl_8015E730                         /* constant-address: 8015E730, symbol: lbl_8015E730 */
/* 8015E71C  88 1E 00 00 */	lbz r0, 0(r30)                          
/* 8015E720  28 00 00 00 */	cmplwi r0, 0                            
/* 8015E724  40 82 00 0C */	bne lbl_8015E730                         /* constant-address: 8015E730, symbol: lbl_8015E730 */
/* 8015E728  38 60 00 00 */	li r3, 0                                
/* 8015E72C  48 00 01 38 */	b lbl_8015E864                           /* constant-address: 8015E864, symbol: lbl_8015E864 */
lbl_8015E730:
/* 8015E730  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha         
/* 8015E734  38 A4 9A 20 */	addi r5, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 8015E790  48 00 00 D4 */	b lbl_8015E864                           /* constant-address: 8015E864, symbol: lbl_8015E864 */
lbl_8015E794:
/* 8015E794  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8015E798  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8015E79C  83 A3 5D B4 */	lwz r29, 0x5db4(r3)                      /* constant-address: 8040BF74, symbol: None */
/* 8015E7A0  28 1C 00 00 */	cmplwi r28, 0                           
/* 8015E7A4  41 82 00 18 */	beq lbl_8015E7BC                         /* constant-address: 8015E7BC, symbol: lbl_8015E7BC */
/* 8015E7A8  7F A3 EB 78 */	mr r3, r29                              
/* 8015E7AC  7F 84 E3 78 */	mr r4, r28                              
/* 8015E7B0  4B F8 1B 09 */	bl checkBoomerangCarry__9daAlink_cFP10fopAc_ac_c /* constant-address: 800E02B8, symbol: checkBoomerangCarry__9daAlink_cFP10fopAc_ac_c */
/* 8015E7B4  2C 03 00 00 */	cmpwi r3, 0                             
/* 8015E7B8  40 82 00 A8 */	bne lbl_8015E860                         /* constant-address: 8015E860, symbol: lbl_8015E860 */
lbl_8015E7BC:
/* 8015E7BC  A8 0D 8A 9E */	lha r0, struct_8045101C+0x2(r13)         /* constant-address: 8045101E, symbol: struct_8045101C+0x2 */
/* 8015E7C0  2C 00 00 00 */	cmpwi r0, 0                             
/* 8015E7C4  41 82 00 10 */	beq lbl_8015E7D4                         /* constant-address: 8015E7D4, symbol: lbl_8015E7D4 */
/* 8015E7C8  88 1E 00 00 */	lbz r0, 0(r30)                          
/* 8015E7CC  28 00 00 00 */	cmplwi r0, 0                            
/* 8015E7D0  41 82 00 90 */	beq lbl_8015E860                         /* constant-address: 8015E860, symbol: lbl_8015E860 */
lbl_8015E7D4:
/* 8015E7D4  C0 22 9C 28 */	lfs f1, lit_4334(r2)                     /* constant-address: 80453628, symbol: lit_4334 */
/* 8015E7D8  48 10 91 7D */	bl cM_rndF__Ff                           /* constant-address: 80267954, symbol: cM_rndF__Ff */
/* 8015E7DC  A8 6D 8A 9C */	lha r3, struct_8045101C+0x0(r13)         /* constant-address: 8045101C, symbol: struct_8045101C+0x0 */
/* 8015E7E0  A8 1D 04 E6 */	lha r0, 0x4e6(r29)                      
/* 8015E7E4  7C 03 02 14 */	add r0, r3, r0                          
/* 8015E7E8  C8 42 9C 08 */	lfd f2, lit_4237(r2)                     /* constant-address: 80453608, symbol: lit_4237 */
...
/* 8015E824  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 8015E854  A8 6D 8A 9C */	lha r3, struct_8045101C+0x0(r13)         /* constant-address: 8045101C, symbol: struct_8045101C+0x0 */
/* 8015E858  38 03 20 00 */	addi r0, r3, 0x2000                     
/* 8015E85C  B0 0D 8A 9C */	sth r0, struct_8045101C+0x0(r13)         /* constant-address: 8045101C, symbol: struct_8045101C+0x0 */
lbl_8015E860:
/* 8015E860  38 60 00 00 */	li r3, 0                                
lbl_8015E864:
/* 8015E864  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8015E868  48 20 39 B9 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

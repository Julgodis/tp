...
/* 8015EC68  41 82 00 34 */	beq lbl_8015EC9C                         /* constant-address: 8015EC9C, symbol: lbl_8015EC9C */
/* 8015EC6C  90 61 00 08 */	stw r3, 8(r1)                           
/* 8015EC70  3C 60 80 02 */	lis r3, fpcSch_JudgeByID__FPvPv@ha      
/* 8015EC74  38 63 35 90 */	addi r3, r3, fpcSch_JudgeByID__FPvPv@l   /* constant-address: 80023590, symbol: fpcSch_JudgeByID__FPvPv */
/* 8015EC78  38 81 00 08 */	addi r4, r1, 8                          
/* 8015EC7C  4B EB AB 7D */	bl fopAcIt_Judge__FPFPvPv_PvPv           /* constant-address: 800197F8, symbol: fopAcIt_Judge__FPFPvPv_PvPv */
/* 8015EC80  90 7F 00 04 */	stw r3, 4(r31)                          
/* 8015EC84  80 1F 00 04 */	lwz r0, 4(r31)                          
/* 8015EC88  28 00 00 00 */	cmplwi r0, 0                            
/* 8015EC8C  40 82 00 18 */	bne lbl_8015ECA4                         /* constant-address: 8015ECA4, symbol: lbl_8015ECA4 */
/* 8015EC90  38 00 FF FF */	li r0, -1                               
/* 8015EC94  90 1F 00 00 */	stw r0, 0(r31)                          
/* 8015EC98  48 00 00 0C */	b lbl_8015ECA4                           /* constant-address: 8015ECA4, symbol: lbl_8015ECA4 */
lbl_8015EC9C:

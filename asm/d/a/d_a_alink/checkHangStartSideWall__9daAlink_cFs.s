...
/* 800FA884  48 26 79 55 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 800FA8AC  41 82 00 0C */	beq lbl_800FA8B8                         /* constant-address: 800FA8B8, symbol: lbl_800FA8B8 */
/* 800FA8B0  C0 22 93 BC */	lfs f1, lit_10042(r2)                    /* constant-address: 80452DBC, symbol: lit_10042 */
/* 800FA8B4  48 00 00 08 */	b lbl_800FA8BC                           /* constant-address: 800FA8BC, symbol: lbl_800FA8BC */
lbl_800FA8B8:
/* 800FA8B8  C0 22 92 9C */	lfs f1, lit_5944(r2)                     /* constant-address: 80452C9C, symbol: lit_5944 */
lbl_800FA8BC:
/* 800FA8BC  54 A0 04 38 */	rlwinm r0, r5, 0, 0x10, 0x1c            
/* 800FA8C0  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800FA8C4  38 A3 9A 20 */	addi r5, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800FA8C8  7C 05 04 2E */	lfsx f0, r5, r0                         
/* 800FA8CC  EF E1 00 32 */	fmuls f31, f1, f0                       
/* 800FA8D0  38 C5 00 04 */	addi r6, r5, 4                           /* constant-address: 80439A24, symbol: None */
/* 800FA8D4  7C 06 04 2E */	lfsx f0, r6, r0                         
/* 800FA8D8  EF C1 00 32 */	fmuls f30, f1, f0                       
/* 800FA8DC  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FA8E0  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800FA8E4  90 01 00 30 */	stw r0, 0x30(r1)                        
/* 800FA8E8  C0 3F 04 D8 */	lfs f1, 0x4d8(r31)                      
/* 800FA8EC  C0 62 95 48 */	lfs f3, lit_23416(r2)                    /* constant-address: 80452F48, symbol: lit_23416 */
...
/* 800FA908  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800FA938  C0 22 93 14 */	lfs f1, lit_7307(r2)                     /* constant-address: 80452D14, symbol: lit_7307 */
...
/* 800FA960  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FA964  3B C3 0F 38 */	addi r30, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 800FA968  C3 A2 93 3C */	lfs f29, lit_7808(r2)                    /* constant-address: 80452D3C, symbol: lit_7808 */
lbl_800FA96C:
/* 800FA96C  7F E3 FB 78 */	mr r3, r31                              
/* 800FA970  38 81 00 14 */	addi r4, r1, 0x14                       
/* 800FA974  38 A1 00 08 */	addi r5, r1, 8                          
/* 800FA978  4B FA 78 21 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800FA97C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FA980  41 82 00 48 */	beq lbl_800FA9C8                         /* constant-address: 800FA9C8, symbol: lbl_800FA9C8 */
/* 800FA984  7F C3 F3 78 */	mr r3, r30                              
/* 800FA988  38 9F 1B 5C */	addi r4, r31, 0x1b5c                    
/* 800FA98C  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800FA990  4B F7 9D B5 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 800FA994  38 61 00 20 */	addi r3, r1, 0x20                       
/* 800FA998  48 16 C7 91 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 800FA99C  7F A4 EB 78 */	mr r4, r29                              
/* 800FA9A0  48 17 64 85 */	bl cLib_distanceAngleS__Fss              /* constant-address: 80270E24, symbol: cLib_distanceAngleS__Fss */
/* 800FA9A4  2C 03 54 9F */	cmpwi r3, 0x549f                        
/* 800FA9A8  40 80 00 20 */	bge lbl_800FA9C8                         /* constant-address: 800FA9C8, symbol: lbl_800FA9C8 */
...
/* 800FA9C4  48 00 00 7C */	b lbl_800FAA40                           /* constant-address: 800FAA40, symbol: lbl_800FAA40 */
lbl_800FA9C8:
/* 800FA9C8  7F E3 FB 78 */	mr r3, r31                              
/* 800FA9CC  38 81 00 08 */	addi r4, r1, 8                          
/* 800FA9D0  38 A1 00 14 */	addi r5, r1, 0x14                       
/* 800FA9D4  4B FA 77 C5 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800FA9D8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FA9DC  41 82 00 48 */	beq lbl_800FAA24                         /* constant-address: 800FAA24, symbol: lbl_800FAA24 */
/* 800FA9E0  7F C3 F3 78 */	mr r3, r30                              
/* 800FA9E4  38 9F 1B 5C */	addi r4, r31, 0x1b5c                    
/* 800FA9E8  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800FA9EC  4B F7 9D 59 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 800FA9F0  38 61 00 20 */	addi r3, r1, 0x20                       
/* 800FA9F4  48 16 C7 35 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 800FA9F8  7F A4 EB 78 */	mr r4, r29                              
/* 800FA9FC  48 17 64 29 */	bl cLib_distanceAngleS__Fss              /* constant-address: 80270E24, symbol: cLib_distanceAngleS__Fss */
/* 800FAA00  2C 03 54 9F */	cmpwi r3, 0x549f                        
/* 800FAA04  40 80 00 20 */	bge lbl_800FAA24                         /* constant-address: 800FAA24, symbol: lbl_800FAA24 */
...
/* 800FAA20  48 00 00 20 */	b lbl_800FAA40                           /* constant-address: 800FAA40, symbol: lbl_800FAA40 */
lbl_800FAA24:
...
/* 800FAA34  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 800FAA38  2C 1C 00 02 */	cmpwi r28, 2                            
/* 800FAA3C  41 80 FF 30 */	blt lbl_800FA96C                         /* constant-address: 800FA96C, symbol: lbl_800FA96C */
lbl_800FAA40:
/* 800FAA40  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FAA44  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
...
/* 800FAA68  48 26 77 BD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 8013D948  4B F8 46 25 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
...
/* 8013D960  41 82 00 14 */	beq lbl_8013D974                         /* constant-address: 8013D974, symbol: lbl_8013D974 */
/* 8013D964  38 00 00 01 */	li r0, 1                                
/* 8013D968  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8013D96C  38 A0 00 18 */	li r5, 0x18                             
/* 8013D970  48 00 00 10 */	b lbl_8013D980                           /* constant-address: 8013D980, symbol: lbl_8013D980 */
lbl_8013D974:
...
/* 8013D988  C0 22 92 B8 */	lfs f1, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8013D98C  C0 42 92 C0 */	lfs f2, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8013D990  C0 62 92 C4 */	lfs f3, lit_6109(r2)                     /* constant-address: 80452CC4, symbol: lit_6109 */
/* 8013D994  4B FE BD 71 */	bl setSingleAnimeWolf__9daAlink_cFQ29daAlink_c12daAlink_WANMffsf /* constant-address: 80129704, symbol: setSingleAnimeWolf__9daAlink_cFQ29daAlink_c12daAlink_WANMffsf */
/* 8013D998  38 00 00 00 */	li r0, 0                                
/* 8013D99C  98 1F 1F D4 */	stb r0, 0x1fd4(r31)                     
/* 8013D9A0  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8013D9A4  D0 1F 33 98 */	stfs f0, 0x3398(r31)                    
/* 8013D9A8  7F E3 FB 78 */	mr r3, r31                              
/* 8013D9AC  80 9F 27 F4 */	lwz r4, 0x27f4(r31)                     
/* 8013D9B0  4B ED CD 61 */	bl fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c /* constant-address: 8001A710, symbol: fopAcM_searchActorAngleY__FPC10fopAc_ac_cPC10fopAc_ac_c */
...
/* 8013D9C4  C4 03 56 1C */	lfsu f0, l_wolfBaseAnime@l(r3)           /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8013D9C8  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 8013D9CC  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425620, symbol: None */
/* 8013D9D0  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 8013D9D4  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */
/* 8013D9D8  D0 1F 35 90 */	stfs f0, 0x3590(r31)                    
/* 8013D9DC  38 00 00 0C */	li r0, 0xc                              
/* 8013D9E0  98 1F 2F 99 */	stb r0, 0x2f99(r31)                     
/* 8013D9E4  C0 03 00 00 */	lfs f0, 0(r3)                            /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8013D9E8  D0 1F 34 D4 */	stfs f0, 0x34d4(r31)                    
/* 8013D9EC  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425620, symbol: None */
/* 8013D9F0  D0 1F 34 D8 */	stfs f0, 0x34d8(r31)                    
/* 8013D9F4  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */
...
/* 8013DA08  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 8013DA0C  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 8013DA10  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)                      
/* 8013DA14  C0 42 93 00 */	lfs f2, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
...
/* 8013DA50  41 82 00 10 */	beq lbl_8013DA60                         /* constant-address: 8013DA60, symbol: lbl_8013DA60 */
/* 8013DA54  38 00 00 01 */	li r0, 1                                
/* 8013DA58  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8013DA5C  48 00 00 0C */	b lbl_8013DA68                           /* constant-address: 8013DA68, symbol: lbl_8013DA68 */
lbl_8013DA60:
...
/* 8013DA70  48 02 12 49 */	bl setData__16daPy_actorKeep_cFP10fopAc_ac_c /* constant-address: 8015ECB8, symbol: setData__16daPy_actorKeep_cFP10fopAc_ac_c */

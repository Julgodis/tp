...
/* 80100688  41 80 00 0C */	blt lbl_80100694                         /* constant-address: 80100694, symbol: lbl_80100694 */
...
/* 801006A0  38 62 95 A8 */	la r3, data_80452FA8(r2) /* 80452FA8-_SDA2_BASE_ */ /* constant-address: 80452FA8, symbol: data_80452FA8 */
/* 801006A4  7C 03 02 AE */	lhax r0, r3, r0                         
/* 801006A8  7C 04 02 14 */	add r0, r4, r0                          
/* 801006AC  C0 3E 04 D8 */	lfs f1, 0x4d8(r30)                      
/* 801006B0  C0 42 93 B4 */	lfs f2, lit_10040(r2)                    /* constant-address: 80452DB4, symbol: lit_10040 */
/* 801006B4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 801006B8  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 801006D0  C0 22 95 A4 */	lfs f1, lit_25916(r2)                    /* constant-address: 80452FA4, symbol: lit_25916 */
/* 801006D4  C0 1E 04 D4 */	lfs f0, 0x4d4(r30)                      
/* 801006D8  EC 21 00 2A */	fadds f1, f1, f0                        
/* 801006DC  C0 02 93 30 */	lfs f0, lit_7625(r2)                     /* constant-address: 80452D30, symbol: lit_7625 */
...
/* 80100710  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80100714  3B E3 0F 38 */	addi r31, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 80100718  7F E3 FB 78 */	mr r3, r31                              
/* 8010071C  38 9E 1D 5C */	addi r4, r30, 0x1d5c                    
/* 80100720  4B F7 4D 7D */	bl RoofChk__4dBgSFP12dBgS_RoofChk        /* constant-address: 8007549C, symbol: RoofChk__4dBgSFP12dBgS_RoofChk */
/* 80100724  C0 42 93 00 */	lfs f2, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
/* 80100728  C0 01 00 0C */	lfs f0, 0xc(r1)                         
/* 8010072C  EC 02 00 2A */	fadds f0, f2, f0                        
/* 80100730  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80100734  40 80 00 20 */	bge lbl_80100754                         /* constant-address: 80100754, symbol: lbl_80100754 */
/* 80100738  7F E3 FB 78 */	mr r3, r31                              
/* 8010073C  38 9E 1D 5C */	addi r4, r30, 0x1d5c                    
/* 80100740  4B F7 46 1D */	bl GetMonkeyBarsCode__4dBgSFRC13cBgS_PolyInfo /* constant-address: 80074D5C, symbol: GetMonkeyBarsCode__4dBgSFRC13cBgS_PolyInfo */
/* 80100744  2C 03 00 00 */	cmpwi r3, 0                             
/* 80100748  41 82 00 0C */	beq lbl_80100754                         /* constant-address: 80100754, symbol: lbl_80100754 */
/* 8010074C  38 60 00 01 */	li r3, 1                                
/* 80100750  48 00 00 08 */	b lbl_80100758                           /* constant-address: 80100758, symbol: lbl_80100758 */
lbl_80100754:

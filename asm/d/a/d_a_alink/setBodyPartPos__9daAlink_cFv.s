...
/* 800A832C  3B E3 D6 58 */	addi r31, r3, lit_3757@l                 /* constant-address: 8038D658, symbol: lit_3757 */
/* 800A8330  80 1E 05 74 */	lwz r0, 0x574(r30)                      
/* 800A8334  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 800A8338  41 82 01 04 */	beq lbl_800A843C                         /* constant-address: 800A843C, symbol: lbl_800A843C */
...
/* 800A834C  38 9F 49 1C */	addi r4, r31, 0x491c                     /* constant-address: 80391F74, symbol: data_80391F74 */
/* 800A8350  38 BE 05 38 */	addi r5, r30, 0x538                     
/* 800A8354  48 29 EA 19 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A8380  38 9F 49 10 */	addi r4, r31, 0x4910                     /* constant-address: 80391F68, symbol: data_80391F68 */
/* 800A8384  38 BE 34 E0 */	addi r5, r30, 0x34e0                    
/* 800A8388  48 29 E9 E5 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A839C  38 9F 49 28 */	addi r4, r31, 0x4928                     /* constant-address: 80391F80, symbol: data_80391F80 */
/* 800A83A0  38 BE 05 A4 */	addi r5, r30, 0x5a4                     
/* 800A83A4  48 29 E9 C9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A8438  48 00 02 7C */	b lbl_800A86B4                           /* constant-address: 800A86B4, symbol: lbl_800A86B4 */
lbl_800A843C:
...
/* 800A8454  38 9F 48 F8 */	addi r4, r31, 0x48f8                     /* constant-address: 80391F50, symbol: data_80391F50 */
/* 800A8458  38 BE 05 38 */	addi r5, r30, 0x538                     
/* 800A845C  48 29 E9 11 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A8460  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800A8464  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800A8468  80 83 5F 18 */	lwz r4, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800A846C  54 80 04 A5 */	rlwinm. r0, r4, 0, 0x12, 0x12           
/* 800A8470  41 82 01 24 */	beq lbl_800A8594                         /* constant-address: 800A8594, symbol: lbl_800A8594 */
/* 800A8474  80 03 5F 1C */	lwz r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */
/* 800A8478  74 00 02 01 */	andis. r0, r0, 0x201                    
/* 800A847C  40 82 01 18 */	bne lbl_800A8594                         /* constant-address: 800A8594, symbol: lbl_800A8594 */
/* 800A8480  80 1E 31 A0 */	lwz r0, 0x31a0(r30)                     
/* 800A8484  54 00 03 5B */	rlwinm. r0, r0, 0, 0xd, 0xd             
/* 800A8488  41 82 00 10 */	beq lbl_800A8498                         /* constant-address: 800A8498, symbol: lbl_800A8498 */
/* 800A848C  80 1E 05 70 */	lwz r0, 0x570(r30)                      
/* 800A8490  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17           
/* 800A8494  40 82 01 00 */	bne lbl_800A8594                         /* constant-address: 800A8594, symbol: lbl_800A8594 */
lbl_800A8498:
/* 800A8498  54 80 01 09 */	rlwinm. r0, r4, 0, 4, 4                 
/* 800A849C  40 82 00 F8 */	bne lbl_800A8594                         /* constant-address: 800A8594, symbol: lbl_800A8594 */
/* 800A84A0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A84A4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A84A8  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)                      
/* 800A84AC  C0 5E 38 38 */	lfs f2, 0x3838(r30)                     
/* 800A84B0  C0 7E 04 D8 */	lfs f3, 0x4d8(r30)                      
/* 800A84B4  48 29 E4 35 */	bl PSMTXTrans                            /* constant-address: 803468E8, symbol: PSMTXTrans */
/* 800A84B8  7F C3 F3 78 */	mr r3, r30                              
/* 800A84BC  48 03 9F 41 */	bl concatMagneBootMtx__9daAlink_cFv      /* constant-address: 800E23FC, symbol: concatMagneBootMtx__9daAlink_cFv */
/* 800A84C0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A84C4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A84C8  A8 9E 31 0A */	lha r4, 0x310a(r30)                     
/* 800A84CC  A8 BE 31 0C */	lha r5, 0x310c(r30)                     
/* 800A84D0  38 C0 00 00 */	li r6, 0                                
/* 800A84D4  4B F6 3D CD */	bl mDoMtx_ZXYrotM__FPA4_fsss             /* constant-address: 8000C2A0, symbol: mDoMtx_ZXYrotM__FPA4_fsss */
...
/* 800A84F0  41 82 00 1C */	beq lbl_800A850C                         /* constant-address: 800A850C, symbol: lbl_800A850C */
/* 800A84F4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A84F8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A84FC  38 9F 49 58 */	addi r4, r31, 0x4958                     /* constant-address: 80391FB0, symbol: data_80391FB0 */
/* 800A8500  38 BE 37 68 */	addi r5, r30, 0x3768                    
/* 800A8504  48 29 E8 69 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A8508  48 00 00 A4 */	b lbl_800A85AC                           /* constant-address: 800A85AC, symbol: lbl_800A85AC */
lbl_800A850C:
...
/* 800A8524  41 82 00 1C */	beq lbl_800A8540                         /* constant-address: 800A8540, symbol: lbl_800A8540 */
/* 800A8528  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A852C  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A8530  38 9F 49 40 */	addi r4, r31, 0x4940                     /* constant-address: 80391F98, symbol: data_80391F98 */
/* 800A8534  38 BE 37 68 */	addi r5, r30, 0x3768                    
/* 800A8538  48 29 E8 35 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A853C  48 00 00 70 */	b lbl_800A85AC                           /* constant-address: 800A85AC, symbol: lbl_800A85AC */
lbl_800A8540:
/* 800A8540  38 00 00 00 */	li r0, 0                                
/* 800A8544  88 7E 2F AA */	lbz r3, 0x2faa(r30)                     
/* 800A8548  28 03 00 01 */	cmplwi r3, 1                            
/* 800A854C  41 82 00 0C */	beq lbl_800A8558                         /* constant-address: 800A8558, symbol: lbl_800A8558 */
/* 800A8550  28 03 00 02 */	cmplwi r3, 2                            
/* 800A8554  40 82 00 08 */	bne lbl_800A855C                         /* constant-address: 800A855C, symbol: lbl_800A855C */
lbl_800A8558:
/* 800A8558  38 00 00 01 */	li r0, 1                                
lbl_800A855C:
/* 800A855C  54 00 06 3F */	clrlwi. r0, r0, 0x18                    
/* 800A8560  41 82 00 1C */	beq lbl_800A857C                         /* constant-address: 800A857C, symbol: lbl_800A857C */
/* 800A8564  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A8568  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A856C  38 9F 49 4C */	addi r4, r31, 0x494c                     /* constant-address: 80391FA4, symbol: data_80391FA4 */
/* 800A8570  38 BE 37 68 */	addi r5, r30, 0x3768                    
/* 800A8574  48 29 E7 F9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A8578  48 00 00 34 */	b lbl_800A85AC                           /* constant-address: 800A85AC, symbol: lbl_800A85AC */
lbl_800A857C:
/* 800A857C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A8580  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A8584  38 9F 49 34 */	addi r4, r31, 0x4934                     /* constant-address: 80391F8C, symbol: data_80391F8C */
/* 800A8588  38 BE 37 68 */	addi r5, r30, 0x3768                    
/* 800A858C  48 29 E7 E1 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A8590  48 00 00 1C */	b lbl_800A85AC                           /* constant-address: 800A85AC, symbol: lbl_800A85AC */
lbl_800A8594:
...
/* 800A85C4  38 9F 48 EC */	addi r4, r31, 0x48ec                     /* constant-address: 80391F44, symbol: data_80391F44 */
/* 800A85C8  38 BE 34 E0 */	addi r5, r30, 0x34e0                    
/* 800A85CC  48 29 E7 A1 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A85E8  38 9F 49 04 */	addi r4, r31, 0x4904                     /* constant-address: 80391F5C, symbol: data_80391F5C */
/* 800A85EC  38 BE 05 A4 */	addi r5, r30, 0x5a4                     
/* 800A85F0  48 29 E7 7D */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A8710  41 82 00 B0 */	beq lbl_800A87C0                         /* constant-address: 800A87C0, symbol: lbl_800A87C0 */
/* 800A8714  54 60 07 7B */	rlwinm. r0, r3, 0, 0x1d, 0x1d           
/* 800A8718  41 82 00 14 */	beq lbl_800A872C                         /* constant-address: 800A872C, symbol: lbl_800A872C */
/* 800A871C  C0 3E 34 DC */	lfs f1, 0x34dc(r30)                     
/* 800A8720  C0 1E 35 90 */	lfs f0, 0x3590(r30)                     
/* 800A8724  EC 81 00 28 */	fsubs f4, f1, f0                        
/* 800A8728  48 00 00 08 */	b lbl_800A8730                           /* constant-address: 800A8730, symbol: lbl_800A8730 */
lbl_800A872C:
/* 800A872C  C0 82 92 C0 */	lfs f4, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
lbl_800A8730:
/* 800A8730  54 60 07 FF */	clrlwi. r0, r3, 0x1f                    
/* 800A8734  41 82 00 14 */	beq lbl_800A8748                         /* constant-address: 800A8748, symbol: lbl_800A8748 */
/* 800A8738  C0 3E 34 D4 */	lfs f1, 0x34d4(r30)                     
/* 800A873C  C0 1E 35 88 */	lfs f0, 0x3588(r30)                     
/* 800A8740  EC A1 00 28 */	fsubs f5, f1, f0                        
/* 800A8744  48 00 00 08 */	b lbl_800A874C                           /* constant-address: 800A874C, symbol: lbl_800A874C */
lbl_800A8748:
/* 800A8748  C0 A2 92 C0 */	lfs f5, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
lbl_800A874C:
/* 800A874C  54 60 07 BD */	rlwinm. r0, r3, 0, 0x1e, 0x1e           
/* 800A8750  41 82 00 14 */	beq lbl_800A8764                         /* constant-address: 800A8764, symbol: lbl_800A8764 */
/* 800A8754  C0 3E 33 B0 */	lfs f1, 0x33b0(r30)                     
/* 800A8758  C0 1E 35 8C */	lfs f0, 0x358c(r30)                     
/* 800A875C  EC 41 00 28 */	fsubs f2, f1, f0                        
/* 800A8760  48 00 00 08 */	b lbl_800A8768                           /* constant-address: 800A8768, symbol: lbl_800A8768 */
lbl_800A8764:
/* 800A8764  C0 42 92 C0 */	lfs f2, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
lbl_800A8768:
...
/* 800A8774  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */

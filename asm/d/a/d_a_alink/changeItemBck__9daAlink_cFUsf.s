...
/* 800C00A8  48 09 EF C1 */	bl loadDataIdx__14daPy_anmHeap_cFUs      /* constant-address: 8015F068, symbol: loadDataIdx__14daPy_anmHeap_cFUs */
/* 800C00AC  7C 64 1B 79 */	or. r4, r3, r3                          
/* 800C00B0  41 82 00 0C */	beq lbl_800C00BC                         /* constant-address: 800C00BC, symbol: lbl_800C00BC */
/* 800C00B4  38 7F 07 30 */	addi r3, r31, 0x730                     
/* 800C00B8  4B F4 D8 D9 */	bl changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform /* constant-address: 8000D990, symbol: changeBckOnly__13mDoExt_bckAnmFP15J3DAnmTransform */
lbl_800C00BC:
/* 800C00BC  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C00C0  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 800C00C4  40 80 00 30 */	bge lbl_800C00F4                         /* constant-address: 800C00F4, symbol: lbl_800C00F4 */
/* 800C00C8  80 7F 07 44 */	lwz r3, 0x744(r31)                      
/* 800C00CC  A8 03 00 06 */	lha r0, 6(r3)                           
/* 800C00D0  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800C00F0  48 00 00 08 */	b lbl_800C00F8                           /* constant-address: 800C00F8, symbol: lbl_800C00F8 */
lbl_800C00F4:

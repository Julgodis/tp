...
/* 8011D844  4B FA 55 61 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 8011D848  2C 03 00 00 */	cmpwi r3, 0                             
/* 8011D84C  40 82 00 0C */	bne lbl_8011D858                         /* constant-address: 8011D858, symbol: lbl_8011D858 */
/* 8011D850  38 60 00 01 */	li r3, 1                                
/* 8011D854  48 00 00 90 */	b lbl_8011D8E4                           /* constant-address: 8011D8E4, symbol: lbl_8011D8E4 */
lbl_8011D858:
...
/* 8011D870  C0 22 92 B8 */	lfs f1, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8011D874  C0 42 93 3C */	lfs f2, lit_7808(r2)                     /* constant-address: 80452D3C, symbol: lit_7808 */
/* 8011D878  38 A0 00 0B */	li r5, 0xb                              
/* 8011D87C  C0 62 92 C4 */	lfs f3, lit_6109(r2)                     /* constant-address: 80452CC4, symbol: lit_6109 */
/* 8011D880  48 00 BE 85 */	bl setSingleAnimeWolf__9daAlink_cFQ29daAlink_c12daAlink_WANMffsf /* constant-address: 80129704, symbol: setSingleAnimeWolf__9daAlink_cFQ29daAlink_c12daAlink_WANMffsf */
/* 8011D884  7F E3 FB 78 */	mr r3, r31                              
/* 8011D888  3C 80 00 01 */	lis r4, 0x0001 /* 0x00010033@ha */      
/* 8011D88C  38 84 00 33 */	addi r4, r4, 0x0033 /* 0x00010033@l */   /* constant-address: 00010033 */
...
/* 8011D8AC  C4 03 56 1C */	lfsu f0, l_wolfBaseAnime@l(r3)           /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8011D8B0  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 8011D8B4  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425620, symbol: None */
/* 8011D8B8  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 8011D8BC  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */
/* 8011D8C0  D0 1F 35 90 */	stfs f0, 0x3590(r31)                    
/* 8011D8C4  C0 02 96 68 */	lfs f0, lit_37528(r2)                    /* constant-address: 80453068, symbol: lit_37528 */
...
/* 8011D8D8  C0 02 92 E0 */	lfs f0, lit_6845(r2)                     /* constant-address: 80452CE0, symbol: lit_6845 */

...
/* 80105750  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 80105774  48 16 1E 71 */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
/* 80105778  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c            
/* 8010577C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 80105780  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 80105784  7C 43 04 2E */	lfsx f2, r3, r0                         
/* 80105788  A8 1E 30 08 */	lha r0, 0x3008(r30)                     
/* 8010578C  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 801057F8  4B FF D8 61 */	bl checkSwimUpAction__9daAlink_cFv       /* constant-address: 80103058, symbol: checkSwimUpAction__9daAlink_cFv */
/* 801057FC  2C 03 00 00 */	cmpwi r3, 0                             
/* 80105800  41 82 00 0C */	beq lbl_8010580C                         /* constant-address: 8010580C, symbol: lbl_8010580C */
/* 80105804  38 60 00 01 */	li r3, 1                                
/* 80105808  48 00 00 80 */	b lbl_80105888                           /* constant-address: 80105888, symbol: lbl_80105888 */
lbl_8010580C:
/* 8010580C  7F E3 FB 78 */	mr r3, r31                              
/* 80105810  48 05 8C BD */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 80105814  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80105818  41 82 00 24 */	beq lbl_8010583C                         /* constant-address: 8010583C, symbol: lbl_8010583C */
/* 8010581C  7F C3 F3 78 */	mr r3, r30                              
/* 80105820  4B FF D1 A9 */	bl checkNextActionSwim__9daAlink_cFv     /* constant-address: 801029C8, symbol: checkNextActionSwim__9daAlink_cFv */
/* 80105824  2C 03 00 00 */	cmpwi r3, 0                             
/* 80105828  40 82 00 5C */	bne lbl_80105884                         /* constant-address: 80105884, symbol: lbl_80105884 */
/* 8010582C  7F C3 F3 78 */	mr r3, r30                              
/* 80105830  38 80 00 00 */	li r4, 0                                
/* 80105834  4B FF EA C5 */	bl procSwimWaitInit__9daAlink_cFi        /* constant-address: 801042F8, symbol: procSwimWaitInit__9daAlink_cFi */
/* 80105838  48 00 00 50 */	b lbl_80105888                           /* constant-address: 80105888, symbol: lbl_80105888 */
lbl_8010583C:
/* 8010583C  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 80105840  C0 1E 34 78 */	lfs f0, 0x3478(r30)                     
/* 80105844  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80105848  40 81 00 3C */	ble lbl_80105884                         /* constant-address: 80105884, symbol: lbl_80105884 */
...
/* 8010585C  4B FF D1 6D */	bl checkNextActionSwim__9daAlink_cFv     /* constant-address: 801029C8, symbol: checkNextActionSwim__9daAlink_cFv */
/* 80105860  2C 03 00 00 */	cmpwi r3, 0                             
/* 80105864  40 82 00 20 */	bne lbl_80105884                         /* constant-address: 80105884, symbol: lbl_80105884 */
/* 80105868  C0 3E 33 AC */	lfs f1, 0x33ac(r30)                     
/* 8010586C  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 80105870  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80105874  40 81 00 10 */	ble lbl_80105884                         /* constant-address: 80105884, symbol: lbl_80105884 */
/* 80105878  7F C3 F3 78 */	mr r3, r30                              
/* 8010587C  4B FF ED F5 */	bl procSwimMoveInit__9daAlink_cFv        /* constant-address: 80104670, symbol: procSwimMoveInit__9daAlink_cFv */
/* 80105880  48 00 00 08 */	b lbl_80105888                           /* constant-address: 80105888, symbol: lbl_80105888 */
lbl_80105884:

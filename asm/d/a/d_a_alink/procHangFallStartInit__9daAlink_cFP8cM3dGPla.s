...
/* 800FAEEC  48 26 72 F1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 800FAEF0  7C 7F 1B 78 */	mr r31, r3                              
/* 800FAEF4  7C 9E 23 78 */	mr r30, r4                              
/* 800FAEF8  7F C3 F3 78 */	mr r3, r30                              
/* 800FAEFC  48 16 C2 2D */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 800FAF00  7C 7D 1B 78 */	mr r29, r3                              
/* 800FAF04  C0 3F 04 D0 */	lfs f1, 0x4d0(r31)                      
/* 800FAF08  C0 42 93 2C */	lfs f2, lit_7624(r2)                     /* constant-address: 80452D2C, symbol: lit_7624 */
...
/* 800FAF38  4B FF F9 25 */	bl checkHangStartSideWall__9daAlink_cFs  /* constant-address: 800FA85C, symbol: checkHangStartSideWall__9daAlink_cFs */
/* 800FAF3C  C0 5F 04 D8 */	lfs f2, 0x4d8(r31)                      
/* 800FAF40  C0 22 93 00 */	lfs f1, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
...
/* 800FAF64  48 16 CD C5 */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800FAF68  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800FAF6C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FAF70  3B C3 0F 38 */	addi r30, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 800FAF74  7F C3 F3 78 */	mr r3, r30                              
/* 800FAF78  38 9F 1D 08 */	addi r4, r31, 0x1d08                    
/* 800FAF7C  4B F7 95 25 */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800FAF80  D0 21 00 0C */	stfs f1, 0xc(r1)                        
/* 800FAF84  C0 02 93 A4 */	lfs f0, lit_9138(r2)                     /* constant-address: 80452DA4, symbol: lit_9138 */
/* 800FAF88  FC 40 08 18 */	frsp f2, f1                             
/* 800FAF8C  FC 00 10 00 */	fcmpu cr0, f0, f2                       
/* 800FAF90  41 82 00 24 */	beq lbl_800FAFB4                         /* constant-address: 800FAFB4, symbol: lbl_800FAFB4 */
/* 800FAF94  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)                      
/* 800FAF98  C0 0D 81 14 */	lfs f0, l_autoDownHeight(r13)            /* constant-address: 80450694, symbol: l_autoDownHeight */
/* 800FAF9C  EC 01 00 2A */	fadds f0, f1, f0                        
/* 800FAFA0  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 800FAFA4  40 80 00 0C */	bge lbl_800FAFB0                         /* constant-address: 800FAFB0, symbol: lbl_800FAFB0 */
/* 800FAFA8  38 60 00 00 */	li r3, 0                                
/* 800FAFAC  48 00 01 D0 */	b lbl_800FB17C                           /* constant-address: 800FB17C, symbol: lbl_800FB17C */
lbl_800FAFB0:
/* 800FAFB0  D0 5F 04 D4 */	stfs f2, 0x4d4(r31)                     
lbl_800FAFB4:
/* 800FAFB4  7F BD 07 34 */	extsh r29, r29                          
/* 800FAFB8  38 1D C0 00 */	addi r0, r29, -16384                    
/* 800FAFBC  C0 22 92 9C */	lfs f1, lit_5944(r2)                     /* constant-address: 80452C9C, symbol: lit_5944 */
/* 800FAFC0  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c            
/* 800FAFC4  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800FAFC8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800FAFEC  C0 22 93 00 */	lfs f1, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
...
/* 800FB010  48 16 CD 19 */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800FB014  7F C3 F3 78 */	mr r3, r30                              
/* 800FB018  38 9F 1D 08 */	addi r4, r31, 0x1d08                    
/* 800FB01C  4B F7 94 85 */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800FB020  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)                      
/* 800FB024  C0 02 93 00 */	lfs f0, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
/* 800FB028  EC 02 00 28 */	fsubs f0, f2, f0                        
/* 800FB02C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FB030  40 80 00 70 */	bge lbl_800FB0A0                         /* constant-address: 800FB0A0, symbol: lbl_800FB0A0 */
...
/* 800FB054  48 16 CC D5 */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800FB058  7F C3 F3 78 */	mr r3, r30                              
/* 800FB05C  38 9F 1D 08 */	addi r4, r31, 0x1d08                    
/* 800FB060  4B F7 94 41 */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800FB064  D0 21 00 0C */	stfs f1, 0xc(r1)                        
/* 800FB068  FC 40 08 18 */	frsp f2, f1                             
/* 800FB06C  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)                      
/* 800FB070  C0 02 93 00 */	lfs f0, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
/* 800FB074  EC 01 00 28 */	fsubs f0, f1, f0                        
/* 800FB078  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 800FB07C  40 80 00 0C */	bge lbl_800FB088                         /* constant-address: 800FB088, symbol: lbl_800FB088 */
/* 800FB080  38 60 00 00 */	li r3, 0                                
/* 800FB084  48 00 00 F8 */	b lbl_800FB17C                           /* constant-address: 800FB17C, symbol: lbl_800FB17C */
lbl_800FB088:
...
/* 800FB0C0  4B FB 2A B9 */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
...
/* 800FB0D8  40 82 00 0C */	bne lbl_800FB0E4                         /* constant-address: 800FB0E4, symbol: lbl_800FB0E4 */
/* 800FB0DC  C3 C2 92 C0 */	lfs f30, lit_6108(r2)                    /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FB0E0  48 00 00 10 */	b lbl_800FB0F0                           /* constant-address: 800FB0F0, symbol: lbl_800FB0F0 */
lbl_800FB0E4:
/* 800FB0E4  3C 60 80 39 */	lis r3, m__22daAlinkHIO_wallFall_c0@ha  
/* 800FB0E8  38 63 E1 B8 */	addi r3, r3, m__22daAlinkHIO_wallFall_c0@l /* constant-address: 8038E1B8, symbol: m__22daAlinkHIO_wallFall_c0 */
/* 800FB0EC  C3 C3 00 0C */	lfs f30, 0xc(r3)                         /* constant-address: 8038E1C4, symbol: None */
lbl_800FB0F0:
/* 800FB0F0  7F E3 FB 78 */	mr r3, r31                              
/* 800FB0F4  38 80 00 56 */	li r4, 0x56                             
/* 800FB0F8  4B FC 6E 75 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
...
/* 800FB114  38 A5 E1 B8 */	addi r5, r5, m__22daAlinkHIO_wallFall_c0@l /* constant-address: 8038E1B8, symbol: m__22daAlinkHIO_wallFall_c0 */
/* 800FB118  C0 25 00 04 */	lfs f1, 4(r5)                            /* constant-address: 8038E1BC, symbol: None */
/* 800FB11C  C0 45 00 08 */	lfs f2, 8(r5)                            /* constant-address: 8038E1C0, symbol: None */
/* 800FB120  A8 A5 00 00 */	lha r5, 0(r5)                            /* constant-address: 8038E1B8, symbol: m__22daAlinkHIO_wallFall_c0 */
/* 800FB124  FC 60 F0 90 */	fmr f3, f30                             
/* 800FB128  4B FB 1E E5 */	bl setSingleAnime__9daAlink_cFQ29daAlink_c11daAlink_ANMffsf /* constant-address: 800AD00C, symbol: setSingleAnime__9daAlink_cFQ29daAlink_c11daAlink_ANMffsf */
/* 800FB12C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800FB13C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FB140  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800FB144  60 00 01 00 */	ori r0, r0, 0x100                       
/* 800FB148  90 03 5F 18 */	stw r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800FB14C  7F E3 FB 78 */	mr r3, r31                              
/* 800FB150  3C 80 00 01 */	lis r4, 0x0001 /* 0x0001000B@ha */      
/* 800FB154  38 84 00 0B */	addi r4, r4, 0x000B /* 0x0001000B@l */   /* constant-address: 0001000B */
...
/* 800FB16C  4B FE 4A BD */	bl setBowHangAnime__9daAlink_cFv         /* constant-address: 800DFC28, symbol: setBowHangAnime__9daAlink_cFv */
/* 800FB170  7F E3 FB 78 */	mr r3, r31                              
/* 800FB174  4B FF F5 71 */	bl setHangGroundY__9daAlink_cFv          /* constant-address: 800FA6E4, symbol: setHangGroundY__9daAlink_cFv */
...
/* 800FB190  48 26 70 99 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

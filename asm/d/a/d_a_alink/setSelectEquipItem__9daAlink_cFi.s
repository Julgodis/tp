...
/* 800A4920  48 2B D8 B9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 800A4934  40 82 01 C0 */	bne lbl_800A4AF4                         /* constant-address: 800A4AF4, symbol: lbl_800A4AF4 */
/* 800A4938  83 DC 06 B8 */	lwz r30, 0x6b8(r28)                     
/* 800A493C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800A4940  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800A4944  88 1F 00 14 */	lbz r0, 0x14(r31)                        /* constant-address: 804061D4, symbol: None */
/* 800A4948  28 00 00 3F */	cmplwi r0, 0x3f                         
/* 800A494C  40 82 00 18 */	bne lbl_800A4964                         /* constant-address: 800A4964, symbol: lbl_800A4964 */
...
/* 800A4960  48 00 00 48 */	b lbl_800A49A8                           /* constant-address: 800A49A8, symbol: lbl_800A49A8 */
lbl_800A4964:
/* 800A4964  48 0B AA 35 */	bl checkMasterSwordEquip__9daPy_py_cFv   /* constant-address: 8015F398, symbol: checkMasterSwordEquip__9daPy_py_cFv */
/* 800A4968  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A496C  41 82 00 18 */	beq lbl_800A4984                         /* constant-address: 800A4984, symbol: lbl_800A4984 */
...
/* 800A4980  48 00 00 28 */	b lbl_800A49A8                           /* constant-address: 800A49A8, symbol: lbl_800A49A8 */
lbl_800A4984:
/* 800A4984  88 1F 00 14 */	lbz r0, 0x14(r31)                        /* constant-address: 804061D4, symbol: None */
/* 800A4988  28 00 00 FF */	cmplwi r0, 0xff                         
/* 800A498C  40 82 00 0C */	bne lbl_800A4998                         /* constant-address: 800A4998, symbol: lbl_800A4998 */
...
lbl_800A49A8:
/* 800A49A8  88 1F 00 14 */	lbz r0, 0x14(r31)                        /* constant-address: 804061D4, symbol: None */
/* 800A49AC  28 00 00 FF */	cmplwi r0, 0xff                         
/* 800A49B0  41 82 00 18 */	beq lbl_800A49C8                         /* constant-address: 800A49C8, symbol: lbl_800A49C8 */
/* 800A49B4  28 00 00 3F */	cmplwi r0, 0x3f                         
/* 800A49B8  41 82 00 10 */	beq lbl_800A49C8                         /* constant-address: 800A49C8, symbol: lbl_800A49C8 */
/* 800A49BC  80 1C 05 7C */	lwz r0, 0x57c(r28)                      
/* 800A49C0  54 00 01 CF */	rlwinm. r0, r0, 0, 7, 7                 
/* 800A49C4  41 82 00 20 */	beq lbl_800A49E4                         /* constant-address: 800A49E4, symbol: lbl_800A49E4 */
lbl_800A49C8:
/* 800A49C8  80 7C 06 EC */	lwz r3, 0x6ec(r28)                      
/* 800A49CC  28 03 00 00 */	cmplwi r3, 0                            
/* 800A49D0  41 82 00 2C */	beq lbl_800A49FC                         /* constant-address: 800A49FC, symbol: lbl_800A49FC */
/* 800A49D4  80 03 00 0C */	lwz r0, 0xc(r3)                         
/* 800A49D8  60 00 00 01 */	ori r0, r0, 1                           
/* 800A49DC  90 03 00 0C */	stw r0, 0xc(r3)                         
/* 800A49E0  48 00 00 1C */	b lbl_800A49FC                           /* constant-address: 800A49FC, symbol: lbl_800A49FC */
lbl_800A49E4:
/* 800A49E4  80 7C 06 EC */	lwz r3, 0x6ec(r28)                      
/* 800A49E8  28 03 00 00 */	cmplwi r3, 0                            
/* 800A49EC  41 82 00 10 */	beq lbl_800A49FC                         /* constant-address: 800A49FC, symbol: lbl_800A49FC */
...
/* 800A4A04  40 82 01 20 */	bne lbl_800A4B24                         /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
/* 800A4A08  80 7C 06 B8 */	lwz r3, 0x6b8(r28)                      
/* 800A4A0C  7C 1E 18 40 */	cmplw r30, r3                           
/* 800A4A10  40 82 00 10 */	bne lbl_800A4A20                         /* constant-address: 800A4A20, symbol: lbl_800A4A20 */
/* 800A4A14  80 1C 05 78 */	lwz r0, 0x578(r28)                      
/* 800A4A18  54 00 02 53 */	rlwinm. r0, r0, 0, 9, 9                 
/* 800A4A1C  41 82 01 08 */	beq lbl_800A4B24                         /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
lbl_800A4A20:
/* 800A4A20  7C 1E 18 40 */	cmplw r30, r3                           
/* 800A4A24  41 82 00 0C */	beq lbl_800A4A30                         /* constant-address: 800A4A30, symbol: lbl_800A4A30 */
/* 800A4A28  38 00 00 05 */	li r0, 5                                
/* 800A4A2C  98 1C 2F D6 */	stb r0, 0x2fd6(r28)                     
lbl_800A4A30:
/* 800A4A30  88 1F 00 14 */	lbz r0, 0x14(r31)                        /* constant-address: 804061D4, symbol: None */
/* 800A4A34  28 00 00 3F */	cmplwi r0, 0x3f                         
/* 800A4A38  40 82 00 60 */	bne lbl_800A4A98                         /* constant-address: 800A4A98, symbol: lbl_800A4A98 */
/* 800A4A3C  A0 1C 2F DC */	lhz r0, 0x2fdc(r28)                     
/* 800A4A40  28 00 01 03 */	cmplwi r0, 0x103                        
/* 800A4A44  41 82 00 0C */	beq lbl_800A4A50                         /* constant-address: 800A4A50, symbol: lbl_800A4A50 */
/* 800A4A48  2C 1D 00 00 */	cmpwi r29, 0                            
/* 800A4A4C  41 82 00 28 */	beq lbl_800A4A74                         /* constant-address: 800A4A74, symbol: lbl_800A4A74 */
lbl_800A4A50:
...
/* 800A4A70  48 00 00 B4 */	b lbl_800A4B24                           /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
lbl_800A4A74:
...
/* 800A4A94  48 00 00 90 */	b lbl_800A4B24                           /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
lbl_800A4A98:
/* 800A4A98  A0 1C 2F DC */	lhz r0, 0x2fdc(r28)                     
/* 800A4A9C  28 00 01 03 */	cmplwi r0, 0x103                        
/* 800A4AA0  41 82 00 0C */	beq lbl_800A4AAC                         /* constant-address: 800A4AAC, symbol: lbl_800A4AAC */
/* 800A4AA4  2C 1D 00 00 */	cmpwi r29, 0                            
/* 800A4AA8  41 82 00 28 */	beq lbl_800A4AD0                         /* constant-address: 800A4AD0, symbol: lbl_800A4AD0 */
lbl_800A4AAC:
...
/* 800A4ACC  48 00 00 58 */	b lbl_800A4B24                           /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
lbl_800A4AD0:
...
/* 800A4AF0  48 00 00 34 */	b lbl_800A4B24                           /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
lbl_800A4AF4:
/* 800A4AF4  48 0B A8 A5 */	bl checkMasterSwordEquip__9daPy_py_cFv   /* constant-address: 8015F398, symbol: checkMasterSwordEquip__9daPy_py_cFv */
/* 800A4AF8  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A4AFC  41 82 00 18 */	beq lbl_800A4B14                         /* constant-address: 800A4B14, symbol: lbl_800A4B14 */
...
/* 800A4B10  48 00 00 14 */	b lbl_800A4B24                           /* constant-address: 800A4B24, symbol: lbl_800A4B24 */
lbl_800A4B14:
...
/* 800A4B2C  40 82 00 84 */	bne lbl_800A4BB0                         /* constant-address: 800A4BB0, symbol: lbl_800A4BB0 */
/* 800A4B30  7F 83 E3 78 */	mr r3, r28                              
/* 800A4B34  48 01 B2 7D */	bl checkZoraWearAbility__9daAlink_cCFv   /* constant-address: 800BFDB0, symbol: checkZoraWearAbility__9daAlink_cCFv */
/* 800A4B38  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A4B3C  41 82 00 64 */	beq lbl_800A4BA0                         /* constant-address: 800A4BA0, symbol: lbl_800A4BA0 */
/* 800A4B40  7F 83 E3 78 */	mr r3, r28                              
/* 800A4B44  48 05 CD 4D */	bl checkZoraWearMaskDraw__9daAlink_cFv   /* constant-address: 80101890, symbol: checkZoraWearMaskDraw__9daAlink_cFv */
/* 800A4B48  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A4B4C  41 82 00 34 */	beq lbl_800A4B80                         /* constant-address: 800A4B80, symbol: lbl_800A4B80 */
...
/* 800A4B68  40 82 00 38 */	bne lbl_800A4BA0                         /* constant-address: 800A4BA0, symbol: lbl_800A4BA0 */
...
/* 800A4B7C  48 00 00 24 */	b lbl_800A4BA0                           /* constant-address: 800A4BA0, symbol: lbl_800A4BA0 */
lbl_800A4B80:
...
/* 800A4BA4  48 00 46 A5 */	bl simpleAnmPlay__9daAlink_cFP10J3DAnmBase /* constant-address: 800A9248, symbol: simpleAnmPlay__9daAlink_cFP10J3DAnmBase */
/* 800A4BA8  80 7C 06 80 */	lwz r3, 0x680(r28)                      
/* 800A4BAC  48 00 46 9D */	bl simpleAnmPlay__9daAlink_cFP10J3DAnmBase /* constant-address: 800A9248, symbol: simpleAnmPlay__9daAlink_cFP10J3DAnmBase */
lbl_800A4BB0:
/* 800A4BB0  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800A4BB4  48 2B D6 71 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 800D72CC  48 28 AF 11 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 800D72D0  7C 7D 1B 78 */	mr r29, r3                              
/* 800D72D4  7C 9E 23 79 */	or. r30, r4, r4                         
/* 800D72D8  7C DF 33 78 */	mr r31, r6                              
/* 800D72DC  41 81 00 48 */	bgt lbl_800D7324                         /* constant-address: 800D7324, symbol: lbl_800D7324 */
/* 800D72E0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800D72E4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D72E8  C0 43 5D C0 */	lfs f2, 0x5dc0(r3)                       /* constant-address: 8040BF80, symbol: None */
/* 800D72EC  7C 1E 00 D0 */	neg r0, r30                             
/* 800D72F0  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800D7310  D0 03 5D C0 */	stfs f0, 0x5dc0(r3)                      /* constant-address: 8040BF80, symbol: None */
/* 800D7314  38 00 00 00 */	li r0, 0                                
/* 800D7318  98 03 5E B6 */	stb r0, 0x5eb6(r3)                       /* constant-address: 8040C076, symbol: None */
/* 800D731C  38 60 00 00 */	li r3, 0                                
/* 800D7320  48 00 01 40 */	b lbl_800D7460                           /* constant-address: 800D7460, symbol: lbl_800D7460 */
lbl_800D7324:
/* 800D7324  7C A4 2B 78 */	mr r4, r5                               
/* 800D7328  7C E5 3B 78 */	mr r5, r7                               
/* 800D732C  4B FF FE DD */	bl damageMagnification__9daAlink_cFii    /* constant-address: 800D7208, symbol: damageMagnification__9daAlink_cFii */
/* 800D7330  C8 42 92 B0 */	lfd f2, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800D735C  C0 02 93 30 */	lfs f0, lit_7625(r2)                     /* constant-address: 80452D30, symbol: lit_7625 */
...
/* 800D7380  41 82 00 08 */	beq lbl_800D7388                         /* constant-address: 800D7388, symbol: lbl_800D7388 */
/* 800D7384  3B DE 00 01 */	addi r30, r30, 1                        
lbl_800D7388:
/* 800D7388  80 1D 05 74 */	lwz r0, 0x574(r29)                      
/* 800D738C  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 800D7390  41 82 00 0C */	beq lbl_800D739C                         /* constant-address: 800D739C, symbol: lbl_800D739C */
/* 800D7394  7F A3 EB 78 */	mr r3, r29                              
/* 800D7398  48 05 09 15 */	bl offWolfEyeUp__9daAlink_cFv            /* constant-address: 80127CAC, symbol: offWolfEyeUp__9daAlink_cFv */
lbl_800D739C:
/* 800D739C  7F A3 EB 78 */	mr r3, r29                              
/* 800D73A0  48 00 04 29 */	bl checkMagicArmorNoDamage__9daAlink_cFv /* constant-address: 800D77C8, symbol: checkMagicArmorNoDamage__9daAlink_cFv */
/* 800D73A4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800D73A8  41 82 00 24 */	beq lbl_800D73CC                         /* constant-address: 800D73CC, symbol: lbl_800D73CC */
/* 800D73AC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800D73B0  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D73B4  80 64 5D C4 */	lwz r3, 0x5dc4(r4)                       /* constant-address: 8040BF84, symbol: None */
/* 800D73B8  7C 1E 00 D0 */	neg r0, r30                             
/* 800D73BC  1C 00 00 0A */	mulli r0, r0, 0xa                       
/* 800D73C0  7C 03 02 14 */	add r0, r3, r0                          
/* 800D73C4  90 04 5D C4 */	stw r0, 0x5dc4(r4)                       /* constant-address: 8040BF84, symbol: None */
/* 800D73C8  48 00 00 40 */	b lbl_800D7408                           /* constant-address: 800D7408, symbol: lbl_800D7408 */
lbl_800D73CC:
/* 800D73CC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800D73D0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D73D4  C0 43 5D C0 */	lfs f2, 0x5dc0(r3)                       /* constant-address: 8040BF80, symbol: None */
/* 800D73D8  7C 1E 00 D0 */	neg r0, r30                             
/* 800D73DC  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800D73FC  D0 03 5D C0 */	stfs f0, 0x5dc0(r3)                      /* constant-address: 8040BF80, symbol: None */
/* 800D7400  38 00 00 00 */	li r0, 0                                
/* 800D7404  98 03 5E B6 */	stb r0, 0x5eb6(r3)                       /* constant-address: 8040C076, symbol: None */
lbl_800D7408:
...
/* 800D7420  41 82 00 34 */	beq lbl_800D7454                         /* constant-address: 800D7454, symbol: lbl_800D7454 */
/* 800D7424  3C 60 80 39 */	lis r3, m__20daAlinkHIO_damage_c0@ha    
/* 800D7428  38 63 E5 4C */	addi r3, r3, m__20daAlinkHIO_damage_c0@l /* constant-address: 8038E54C, symbol: m__20daAlinkHIO_damage_c0 */
/* 800D742C  A8 03 00 2A */	lha r0, 0x2a(r3)                         /* constant-address: 8038E576, symbol: None */
...
/* 800D7464  48 28 AD C5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 8012C214  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 8012C218  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 8012C21C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8012C220  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8012C224  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 8012C228  38 9F 1A 60 */	addi r4, r31, 0x1a60                    
/* 8012C22C  38 A1 00 08 */	addi r5, r1, 8                          
/* 8012C230  4B F4 85 15 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 8012C234  38 61 00 08 */	addi r3, r1, 8                          
/* 8012C238  48 13 AE F1 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 8012C23C  B0 7F 04 DE */	sth r3, 0x4de(r31)                      
/* 8012C240  C0 22 92 B8 */	lfs f1, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8012C244  C0 01 00 0C */	lfs f0, 0xc(r1)                         
/* 8012C248  EF E1 00 28 */	fsubs f31, f1, f0                       
/* 8012C24C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8012C250  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8012C254  40 81 00 0C */	ble lbl_8012C260                         /* constant-address: 8012C260, symbol: lbl_8012C260 */
...
/* 8012C270  48 23 8E 61 */	bl abs                                   /* constant-address: 803650D0, symbol: abs */
/* 8012C274  2C 03 40 00 */	cmpwi r3, 0x4000                        
/* 8012C278  41 80 00 14 */	blt lbl_8012C28C                         /* constant-address: 8012C28C, symbol: lbl_8012C28C */
/* 8012C27C  38 00 00 01 */	li r0, 1                                
/* 8012C280  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8012C284  C0 82 97 58 */	lfs f4, lit_45501(r2)                    /* constant-address: 80453158, symbol: lit_45501 */
/* 8012C288  48 00 00 10 */	b lbl_8012C298                           /* constant-address: 8012C298, symbol: lbl_8012C298 */
lbl_8012C28C:
/* 8012C28C  38 00 00 00 */	li r0, 0                                
/* 8012C290  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8012C294  C0 82 93 B8 */	lfs f4, lit_10041(r2)                    /* constant-address: 80452DB8, symbol: lit_10041 */
lbl_8012C298:
...
/* 8012C2E0  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */

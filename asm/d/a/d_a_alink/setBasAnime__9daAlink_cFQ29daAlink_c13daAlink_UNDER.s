...
/* 800BF214  48 2A 2F C9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 800BF23C  41 82 00 88 */	beq lbl_800BF2C4                         /* constant-address: 800BF2C4, symbol: lbl_800BF2C4 */
/* 800BF240  80 9D 1F 2C */	lwz r4, 0x1f2c(r29)                     
/* 800BF244  80 84 00 28 */	lwz r4, 0x28(r4)                        
/* 800BF248  28 04 00 00 */	cmplwi r4, 0                            
/* 800BF24C  40 82 00 0C */	bne lbl_800BF258                         /* constant-address: 800BF258, symbol: lbl_800BF258 */
/* 800BF250  48 00 02 91 */	bl resetBasAnime__9daAlink_cFv           /* constant-address: 800BF4E0, symbol: resetBasAnime__9daAlink_cFv */
/* 800BF254  48 00 01 10 */	b lbl_800BF364                           /* constant-address: 800BF364, symbol: lbl_800BF364 */
lbl_800BF258:
/* 800BF258  A0 7D 30 84 */	lhz r3, 0x3084(r29)                     
/* 800BF25C  A0 1F 00 00 */	lhz r0, 0(r31)                          
/* 800BF260  7C 03 00 40 */	cmplw r3, r0                            
/* 800BF264  40 82 00 34 */	bne lbl_800BF298                         /* constant-address: 800BF298, symbol: lbl_800BF298 */
/* 800BF268  A0 1D 30 86 */	lhz r0, 0x3086(r29)                     
/* 800BF26C  7C 00 28 40 */	cmplw r0, r5                            
/* 800BF270  40 82 00 28 */	bne lbl_800BF298                         /* constant-address: 800BF298, symbol: lbl_800BF298 */
/* 800BF274  C0 3D 33 D4 */	lfs f1, 0x33d4(r29)                     
/* 800BF278  C0 1E 00 0C */	lfs f0, 0xc(r30)                        
/* 800BF27C  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 800BF280  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800BF284  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800BF288  4C 41 13 82 */	cror 2, 1, 2                            
/* 800BF28C  40 82 00 0C */	bne lbl_800BF298                         /* constant-address: 800BF298, symbol: lbl_800BF298 */
/* 800BF290  93 DD 2D 7C */	stw r30, 0x2d7c(r29)                    
/* 800BF294  48 00 00 D0 */	b lbl_800BF364                           /* constant-address: 800BF364, symbol: lbl_800BF364 */
lbl_800BF298:
...
/* 800BF2BC  48 00 00 C1 */	bl initBasAnime__9daAlink_cFv            /* constant-address: 800BF37C, symbol: initBasAnime__9daAlink_cFv */
/* 800BF2C0  48 00 00 A4 */	b lbl_800BF364                           /* constant-address: 800BF364, symbol: lbl_800BF364 */
lbl_800BF2C4:
...
/* 800BF2D4  40 82 00 0C */	bne lbl_800BF2E0                         /* constant-address: 800BF2E0, symbol: lbl_800BF2E0 */
/* 800BF2D8  48 00 02 09 */	bl resetBasAnime__9daAlink_cFv           /* constant-address: 800BF4E0, symbol: resetBasAnime__9daAlink_cFv */
/* 800BF2DC  48 00 00 88 */	b lbl_800BF364                           /* constant-address: 800BF364, symbol: lbl_800BF364 */
lbl_800BF2E0:
/* 800BF2E0  A0 7D 30 84 */	lhz r3, 0x3084(r29)                     
/* 800BF2E4  A0 1F 00 00 */	lhz r0, 0(r31)                          
/* 800BF2E8  7C 03 00 40 */	cmplw r3, r0                            
/* 800BF2EC  40 82 00 34 */	bne lbl_800BF320                         /* constant-address: 800BF320, symbol: lbl_800BF320 */
/* 800BF2F0  A0 1D 30 86 */	lhz r0, 0x3086(r29)                     
/* 800BF2F4  7C 00 28 40 */	cmplw r0, r5                            
/* 800BF2F8  40 82 00 28 */	bne lbl_800BF320                         /* constant-address: 800BF320, symbol: lbl_800BF320 */
/* 800BF2FC  C0 3D 33 D4 */	lfs f1, 0x33d4(r29)                     
/* 800BF300  C0 1E 00 0C */	lfs f0, 0xc(r30)                        
/* 800BF304  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 800BF308  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800BF30C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800BF310  4C 41 13 82 */	cror 2, 1, 2                            
/* 800BF314  40 82 00 0C */	bne lbl_800BF320                         /* constant-address: 800BF320, symbol: lbl_800BF320 */
/* 800BF318  93 DD 2D 7C */	stw r30, 0x2d7c(r29)                    
/* 800BF31C  48 00 00 48 */	b lbl_800BF364                           /* constant-address: 800BF364, symbol: lbl_800BF364 */
lbl_800BF320:
...
/* 800BF334  48 1B 06 09 */	bl cLib_memCpy__FPvPCvUl                 /* constant-address: 8026F93C, symbol: cLib_memCpy__FPvPCvUl */
...
/* 800BF360  48 00 00 1D */	bl initBasAnime__9daAlink_cFv            /* constant-address: 800BF37C, symbol: initBasAnime__9daAlink_cFv */
lbl_800BF364:
/* 800BF364  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800BF368  48 2A 2E C1 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

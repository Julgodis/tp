...
/* 800BB578  48 2A 6C 65 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 800BB598  41 82 00 10 */	beq lbl_800BB5A8                         /* constant-address: 800BB5A8, symbol: lbl_800BB5A8 */
/* 800BB59C  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800BB5A0  28 00 02 A0 */	cmplwi r0, 0x2a0                        
/* 800BB5A4  40 82 00 08 */	bne lbl_800BB5AC                         /* constant-address: 800BB5AC, symbol: lbl_800BB5AC */
lbl_800BB5A8:
/* 800BB5A8  38 60 00 01 */	li r3, 1                                
lbl_800BB5AC:
/* 800BB5AC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800BB5B0  41 82 00 28 */	beq lbl_800BB5D8                         /* constant-address: 800BB5D8, symbol: lbl_800BB5D8 */
/* 800BB5B4  48 00 4D 15 */	bl checkBossRoom__9daAlink_cFv           /* constant-address: 800C02C8, symbol: checkBossRoom__9daAlink_cFv */
/* 800BB5B8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800BB5BC  41 82 00 1C */	beq lbl_800BB5D8                         /* constant-address: 800BB5D8, symbol: lbl_800BB5D8 */
/* 800BB5C0  88 1D 04 E2 */	lbz r0, 0x4e2(r29)                      
/* 800BB5C4  2C 00 00 32 */	cmpwi r0, 0x32                          
/* 800BB5C8  40 82 00 10 */	bne lbl_800BB5D8                         /* constant-address: 800BB5D8, symbol: lbl_800BB5D8 */
/* 800BB5CC  80 1D 05 70 */	lwz r0, 0x570(r29)                      
/* 800BB5D0  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 800BB5D4  40 82 00 50 */	bne lbl_800BB624                         /* constant-address: 800BB624, symbol: lbl_800BB624 */
lbl_800BB5D8:
...
/* 800BB5E4  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800BB614  41 82 00 10 */	beq lbl_800BB624                         /* constant-address: 800BB624, symbol: lbl_800BB624 */
...
/* 800BB630  48 2A 6B F9 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

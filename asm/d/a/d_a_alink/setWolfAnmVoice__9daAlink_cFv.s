...
/* 8012CB24  48 23 56 B5 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8012CB38  40 80 00 8C */	bge lbl_8012CBC4                         /* constant-address: 8012CBC4, symbol: lbl_8012CBC4 */
/* 8012CB3C  80 1C 21 5C */	lwz r0, 0x215c(r28)                     
/* 8012CB40  28 00 00 00 */	cmplwi r0, 0                            
/* 8012CB44  40 82 00 08 */	bne lbl_8012CB4C                         /* constant-address: 8012CB4C, symbol: lbl_8012CB4C */
/* 8012CB48  48 00 00 7C */	b lbl_8012CBC4                           /* constant-address: 8012CBC4, symbol: lbl_8012CBC4 */
lbl_8012CB4C:
/* 8012CB4C  3B A0 00 00 */	li r29, 0                               
/* 8012CB50  CB E2 92 B0 */	lfd f31, lit_6025(r2)                    /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 8012CB64  41 82 00 60 */	beq lbl_8012CBC4                         /* constant-address: 8012CBC4, symbol: lbl_8012CBC4 */
...
/* 8012CB80  48 1F B8 AD */	bl checkPass__12J3DFrameCtrlFf           /* constant-address: 8032842C, symbol: checkPass__12J3DFrameCtrlFf */
/* 8012CB84  2C 03 00 00 */	cmpwi r3, 0                             
/* 8012CB88  41 82 00 2C */	beq lbl_8012CBB4                         /* constant-address: 8012CBB4, symbol: lbl_8012CBB4 */
/* 8012CB8C  7F 83 E3 78 */	mr r3, r28                              
/* 8012CB90  88 1C 2F D8 */	lbz r0, 0x2fd8(r28)                     
/* 8012CB94  54 00 10 3A */	slwi r0, r0, 2                          
/* 8012CB98  3C 80 80 39 */	lis r4, data_80391E48@ha                
/* 8012CB9C  38 84 1E 48 */	addi r4, r4, data_80391E48@l             /* constant-address: 80391E48, symbol: data_80391E48 */
...
lbl_8012CBB4:
/* 8012CBB4  3B BD 00 01 */	addi r29, r29, 1                         /* constant-address: 00000001 */
/* 8012CBB8  2C 1D 00 04 */	cmpwi r29, 4                            
/* 8012CBBC  3B DE 00 01 */	addi r30, r30, 1                        
/* 8012CBC0  41 80 FF 98 */	blt lbl_8012CB58                         /* constant-address: 8012CB58, symbol: lbl_8012CB58 */
lbl_8012CBC4:
/* 8012CBC4  E3 E1 00 28 */	psq_l f31, 40(r1), 0, 0 /* qr0 */       
/* 8012CBC8  CB E1 00 20 */	lfd f31, 0x20(r1)                       
/* 8012CBCC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8012CBD0  48 23 56 55 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

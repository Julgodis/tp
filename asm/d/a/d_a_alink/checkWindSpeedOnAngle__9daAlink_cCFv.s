...
/* 800A7974  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800A7978  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800A797C  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 800A7980  38 61 00 08 */	addi r3, r1, 8                          
/* 800A7984  48 29 F7 B5 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 800A7988  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800A798C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800A7990  41 81 00 0C */	bgt lbl_800A799C                         /* constant-address: 800A799C, symbol: lbl_800A799C */
/* 800A7994  38 60 00 00 */	li r3, 0                                
/* 800A7998  48 00 00 3C */	b lbl_800A79D4                           /* constant-address: 800A79D4, symbol: lbl_800A79D4 */
lbl_800A799C:
/* 800A799C  A8 7E 30 CC */	lha r3, 0x30cc(r30)                     
/* 800A79A0  A8 9E 04 E6 */	lha r4, 0x4e6(r30)                      
/* 800A79A4  48 1C 94 81 */	bl cLib_distanceAngleS__Fss              /* constant-address: 80270E24, symbol: cLib_distanceAngleS__Fss */
/* 800A79A8  3B E0 00 00 */	li r31, 0                               
/* 800A79AC  2C 03 60 00 */	cmpwi r3, 0x6000                        
/* 800A79B0  40 80 00 1C */	bge lbl_800A79CC                         /* constant-address: 800A79CC, symbol: lbl_800A79CC */
/* 800A79B4  2C 03 40 00 */	cmpwi r3, 0x4000                        
/* 800A79B8  41 80 00 18 */	blt lbl_800A79D0                         /* constant-address: 800A79D0, symbol: lbl_800A79D0 */
/* 800A79BC  7F C3 F3 78 */	mr r3, r30                              
/* 800A79C0  48 01 19 D9 */	bl checkWindDashAnime__9daAlink_cCFv     /* constant-address: 800B9398, symbol: checkWindDashAnime__9daAlink_cCFv */
/* 800A79C4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A79C8  41 82 00 08 */	beq lbl_800A79D0                         /* constant-address: 800A79D0, symbol: lbl_800A79D0 */
lbl_800A79CC:

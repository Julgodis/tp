...
/* 800EA968  4B FD 84 3D */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800EA96C  2C 03 00 00 */	cmpwi r3, 0                             
/* 800EA970  40 82 00 0C */	bne lbl_800EA97C                         /* constant-address: 800EA97C, symbol: lbl_800EA97C */
/* 800EA974  38 60 00 00 */	li r3, 0                                
/* 800EA978  48 00 00 9C */	b lbl_800EAA14                           /* constant-address: 800EAA14, symbol: lbl_800EAA14 */
lbl_800EA97C:
/* 800EA97C  7F E3 FB 78 */	mr r3, r31                              
/* 800EA980  38 80 01 3F */	li r4, 0x13f                            
/* 800EA984  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800EA988  4B FC 26 29 */	bl setSingleAnimeBaseMorf__9daAlink_cFQ29daAlink_c11daAlink_ANMf /* constant-address: 800ACFB0, symbol: setSingleAnimeBaseMorf__9daAlink_cFQ29daAlink_c11daAlink_ANMf */
/* 800EA98C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800EA9A0  C4 03 55 14 */	lfsu f0, l_waitBaseAnime@l(r3)           /* constant-address: 80425514, symbol: l_waitBaseAnime */
/* 800EA9A4  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 800EA9A8  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425518, symbol: None */
/* 800EA9AC  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 800EA9B0  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042551C, symbol: None */
...
/* 800EA9F8  4B FD 68 E5 */	bl deleteEquipItem__9daAlink_cFii        /* constant-address: 800C12DC, symbol: deleteEquipItem__9daAlink_cFii */
/* 800EA9FC  80 7F 28 38 */	lwz r3, 0x2838(r31)                     
/* 800EAA00  28 03 00 00 */	cmplwi r3, 0                            
/* 800EAA04  41 82 00 0C */	beq lbl_800EAA10                         /* constant-address: 800EAA10, symbol: lbl_800EAA10 */

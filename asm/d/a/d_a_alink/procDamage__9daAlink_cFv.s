...
/* 800D953C  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800D9560  48 18 E0 85 */	bl cM_rad2s__Ff                          /* constant-address: 802675E4, symbol: cM_rad2s__Ff */
/* 800D9564  54 60 04 38 */	rlwinm r0, r3, 0, 0x10, 0x1c            
/* 800D9568  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800D956C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800D9570  7C 43 04 2E */	lfsx f2, r3, r0                         
/* 800D9574  A8 1E 30 0C */	lha r0, 0x300c(r30)                     
/* 800D9578  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800D95E4  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D95E8  3C 80 80 39 */	lis r4, m__23daAlinkHIO_damNormal_c0@ha 
/* 800D95EC  38 84 E2 4C */	addi r4, r4, m__23daAlinkHIO_damNormal_c0@l /* constant-address: 8038E24C, symbol: m__23daAlinkHIO_damNormal_c0 */
/* 800D95F0  C0 44 00 5C */	lfs f2, 0x5c(r4)                         /* constant-address: 8038E2A8, symbol: None */
/* 800D95F4  48 19 71 4D */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
/* 800D95F8  80 1E 05 74 */	lwz r0, 0x574(r30)                      
/* 800D95FC  54 00 00 43 */	rlwinm. r0, r0, 0, 1, 1                 
/* 800D9600  41 82 00 0C */	beq lbl_800D960C                         /* constant-address: 800D960C, symbol: lbl_800D960C */
/* 800D9604  7F C3 F3 78 */	mr r3, r30                              
/* 800D9608  4B FF D8 1D */	bl freezeTimerDamage__9daAlink_cFv       /* constant-address: 800D6E24, symbol: freezeTimerDamage__9daAlink_cFv */
lbl_800D960C:
/* 800D960C  7F E3 FB 78 */	mr r3, r31                              
/* 800D9610  48 08 4E BD */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800D9614  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800D9618  41 82 00 68 */	beq lbl_800D9680                         /* constant-address: 800D9680, symbol: lbl_800D9680 */
...
/* 800D962C  40 82 00 14 */	bne lbl_800D9640                         /* constant-address: 800D9640, symbol: lbl_800D9640 */
/* 800D9630  7F C3 F3 78 */	mr r3, r30                              
/* 800D9634  38 80 00 00 */	li r4, 0                                
/* 800D9638  4B FE 0A 99 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800D963C  48 00 00 84 */	b lbl_800D96C0                           /* constant-address: 800D96C0, symbol: lbl_800D96C0 */
lbl_800D9640:
/* 800D9640  A8 1E 30 08 */	lha r0, 0x3008(r30)                     
/* 800D9644  2C 00 00 00 */	cmpwi r0, 0                             
/* 800D9648  40 82 00 78 */	bne lbl_800D96C0                         /* constant-address: 800D96C0, symbol: lbl_800D96C0 */
/* 800D964C  7F C3 F3 78 */	mr r3, r30                              
/* 800D9650  3C 80 00 02 */	lis r4, 0x0002 /* 0x00020055@ha */      
/* 800D9654  38 84 00 55 */	addi r4, r4, 0x0055 /* 0x00020055@l */   /* constant-address: 00020055 */
...
/* 800D966C  48 00 1F 45 */	bl procStEscapeInit__9daAlink_cFv        /* constant-address: 800DB5B0, symbol: procStEscapeInit__9daAlink_cFv */
/* 800D9670  80 1E 31 A0 */	lwz r0, 0x31a0(r30)                     
/* 800D9674  60 00 00 08 */	ori r0, r0, 8                           
/* 800D9678  90 1E 31 A0 */	stw r0, 0x31a0(r30)                     
/* 800D967C  48 00 00 44 */	b lbl_800D96C0                           /* constant-address: 800D96C0, symbol: lbl_800D96C0 */
lbl_800D9680:
/* 800D9680  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 800D9684  C0 1E 34 78 */	lfs f0, 0x3478(r30)                     
/* 800D9688  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D968C  40 81 00 34 */	ble lbl_800D96C0                         /* constant-address: 800D96C0, symbol: lbl_800D96C0 */
...
/* 800D96AC  4B FE 0A 25 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800D96B0  2C 03 00 00 */	cmpwi r3, 0                             
/* 800D96B4  40 82 00 0C */	bne lbl_800D96C0                         /* constant-address: 800D96C0, symbol: lbl_800D96C0 */

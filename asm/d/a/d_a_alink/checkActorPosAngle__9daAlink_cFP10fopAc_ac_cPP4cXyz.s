...
/* 800A0878  48 2C 19 61 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 800A087C  7C 7C 1B 78 */	mr r28, r3                              
/* 800A0880  7C 9D 23 79 */	or. r29, r4, r4                         
/* 800A0884  7C BE 2B 78 */	mr r30, r5                              
/* 800A0888  41 82 00 98 */	beq lbl_800A0920                         /* constant-address: 800A0920, symbol: lbl_800A0920 */
/* 800A088C  38 9D 05 38 */	addi r4, r29, 0x538                     
/* 800A0890  4B FF FF 49 */	bl checkAttentionPosAngle__9daAlink_cFP4cXyz /* constant-address: 800A07D8, symbol: checkAttentionPosAngle__9daAlink_cFP4cXyz */
/* 800A0894  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800A0898  41 82 00 88 */	beq lbl_800A0920                         /* constant-address: 800A0920, symbol: lbl_800A0920 */
/* 800A089C  AB FD 00 08 */	lha r31, 8(r29)                         
/* 800A08A0  7F A3 EB 78 */	mr r3, r29                              
/* 800A08A4  48 03 BC A5 */	bl checkEnemyGroup__9daAlink_cFP10fopAc_ac_c /* constant-address: 800DC548, symbol: checkEnemyGroup__9daAlink_cFP10fopAc_ac_c */
/* 800A08A8  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A08AC  41 82 00 24 */	beq lbl_800A08D0                         /* constant-address: 800A08D0, symbol: lbl_800A08D0 */
...
/* 800A08D4  41 82 00 18 */	beq lbl_800A08EC                         /* constant-address: 800A08EC, symbol: lbl_800A08EC */
/* 800A08D8  2C 1F 02 16 */	cmpwi r31, 0x216                        
/* 800A08DC  40 82 00 34 */	bne lbl_800A0910                         /* constant-address: 800A0910, symbol: lbl_800A0910 */
/* 800A08E0  88 1D 0B 01 */	lbz r0, 0xb01(r29)                      
/* 800A08E4  28 00 00 00 */	cmplwi r0, 0                            
/* 800A08E8  40 82 00 28 */	bne lbl_800A0910                         /* constant-address: 800A0910, symbol: lbl_800A0910 */
lbl_800A08EC:
...
/* 800A091C  48 00 00 08 */	b lbl_800A0924                           /* constant-address: 800A0924, symbol: lbl_800A0924 */
lbl_800A0920:
/* 800A0920  38 60 00 00 */	li r3, 0                                
lbl_800A0924:
/* 800A0924  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800A0928  48 2C 18 FD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

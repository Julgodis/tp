...
/* 800C5274  48 09 92 59 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800C5278  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800C527C  41 82 00 1C */	beq lbl_800C5298                         /* constant-address: 800C5298, symbol: lbl_800C5298 */
...
/* 800C5290  4B FF 4E 41 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800C5294  48 00 00 78 */	b lbl_800C530C                           /* constant-address: 800C530C, symbol: lbl_800C530C */
lbl_800C5298:
/* 800C5298  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 800C529C  3C 60 80 39 */	lis r3, m__23daAlinkHIO_frontRoll_c0@ha 
/* 800C52A0  38 63 D7 BC */	addi r3, r3, m__23daAlinkHIO_frontRoll_c0@l /* constant-address: 8038D7BC, symbol: m__23daAlinkHIO_frontRoll_c0 */
/* 800C52A4  C0 03 00 38 */	lfs f0, 0x38(r3)                         /* constant-address: 8038D7F4, symbol: None */
/* 800C52A8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C52AC  40 81 00 28 */	ble lbl_800C52D4                         /* constant-address: 800C52D4, symbol: lbl_800C52D4 */
...
/* 800C52CC  4B FF 4E 05 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800C52D0  48 00 00 3C */	b lbl_800C530C                           /* constant-address: 800C530C, symbol: lbl_800C530C */
lbl_800C52D4:
/* 800C52D4  C0 02 93 48 */	lfs f0, lit_8130(r2)                     /* constant-address: 80452D48, symbol: lit_8130 */
/* 800C52D8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C52DC  4C 41 13 82 */	cror 2, 1, 2                            
/* 800C52E0  40 82 00 18 */	bne lbl_800C52F8                         /* constant-address: 800C52F8, symbol: lbl_800C52F8 */
...
/* 800C52F4  48 00 00 18 */	b lbl_800C530C                           /* constant-address: 800C530C, symbol: lbl_800C530C */
lbl_800C52F8:
/* 800C52F8  C0 02 93 34 */	lfs f0, lit_7710(r2)                     /* constant-address: 80452D34, symbol: lit_7710 */
/* 800C52FC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C5300  40 81 00 0C */	ble lbl_800C530C                         /* constant-address: 800C530C, symbol: lbl_800C530C */

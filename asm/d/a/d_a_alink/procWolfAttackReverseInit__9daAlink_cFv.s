...
/* 8013C8E0  4B F8 56 8D */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 8013C8E4  7F E3 FB 78 */	mr r3, r31                              
/* 8013C8E8  38 80 00 74 */	li r4, 0x74                             
/* 8013C8EC  4B FE CD 8D */	bl setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM /* constant-address: 80129678, symbol: setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM */
/* 8013C8F0  7F E3 FB 78 */	mr r3, r31                              
/* 8013C8F4  38 80 00 9A */	li r4, 0x9a                             
/* 8013C8F8  4B F7 2F A9 */	bl setFaceBasicTexture__9daAlink_cFQ29daAlink_c13daAlink_FTANM /* constant-address: 800AF8A0, symbol: setFaceBasicTexture__9daAlink_cFQ29daAlink_c13daAlink_FTANM */
/* 8013C8FC  3C 60 80 39 */	lis r3, m__22daAlinkHIO_wlAttack_c0@ha  
/* 8013C900  38 63 F7 A4 */	addi r3, r3, m__22daAlinkHIO_wlAttack_c0@l /* constant-address: 8038F7A4, symbol: m__22daAlinkHIO_wlAttack_c0 */
/* 8013C904  C0 03 00 28 */	lfs f0, 0x28(r3)                         /* constant-address: 8038F7CC, symbol: None */
/* 8013C908  D0 1F 33 98 */	stfs f0, 0x3398(r31)                    
/* 8013C90C  C0 03 00 2C */	lfs f0, 0x2c(r3)                         /* constant-address: 8038F7D0, symbol: None */
...
/* 8013C924  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8013C928  D0 21 00 14 */	stfs f1, 0x14(r1)                       
/* 8013C92C  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 8013C93C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8013C940  38 63 5B D4 */	addi r3, r3, 0x5bd4                      /* constant-address: 8040BD94, symbol: None */
/* 8013C944  38 80 00 05 */	li r4, 5                                
/* 8013C948  38 A0 00 0F */	li r5, 0xf                              
/* 8013C94C  38 C1 00 14 */	addi r6, r1, 0x14                       
/* 8013C950  4B F3 30 D5 */	bl StartShock__12dVibration_cFii4cXyz    /* constant-address: 8006FA24, symbol: StartShock__12dVibration_cFii4cXyz */
...
/* 8013C978  41 82 00 0C */	beq lbl_8013C984                         /* constant-address: 8013C984, symbol: lbl_8013C984 */
/* 8013C97C  80 BF 00 04 */	lwz r5, 4(r31)                          
/* 8013C980  48 00 00 08 */	b lbl_8013C988                           /* constant-address: 8013C988, symbol: lbl_8013C988 */
lbl_8013C984:
/* 8013C984  38 A0 FF FF */	li r5, -1                               
lbl_8013C988:
/* 8013C988  38 C0 00 05 */	li r6, 5                                
/* 8013C98C  48 06 B8 35 */	bl dKy_Sound_set__F4cXyziUii             /* constant-address: 801A81C0, symbol: dKy_Sound_set__F4cXyziUii */
/* 8013C990  7F E3 FB 78 */	mr r3, r31                              
/* 8013C994  3C 80 00 02 */	lis r4, 0x0002 /* 0x00020054@ha */      
/* 8013C998  38 84 00 54 */	addi r4, r4, 0x0054 /* 0x00020054@l */   /* constant-address: 00020054 */
...
/* 8013C9BC  C4 03 56 1C */	lfsu f0, l_wolfBaseAnime@l(r3)           /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8013C9C0  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 8013C9C4  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425620, symbol: None */
/* 8013C9C8  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 8013C9CC  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */

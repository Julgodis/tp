...
/* 800C6A60  48 29 B7 75 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 800C6A78  40 82 00 1C */	bne lbl_800C6A94                         /* constant-address: 800C6A94, symbol: lbl_800C6A94 */
...
/* 800C6AA0  41 82 00 1C */	beq lbl_800C6ABC                         /* constant-address: 800C6ABC, symbol: lbl_800C6ABC */
/* 800C6AA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800C6AA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800C6AAC  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800C6AB0  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c           
/* 800C6AB4  40 82 00 08 */	bne lbl_800C6ABC                         /* constant-address: 800C6ABC, symbol: lbl_800C6ABC */
...
/* 800C6AE4  40 82 00 0C */	bne lbl_800C6AF0                         /* constant-address: 800C6AF0, symbol: lbl_800C6AF0 */
/* 800C6AE8  7F 83 E3 78 */	mr r3, r28                              
/* 800C6AEC  48 02 88 A9 */	bl horseGetOffEnd__9daAlink_cFv          /* constant-address: 800EF394, symbol: horseGetOffEnd__9daAlink_cFv */
lbl_800C6AF0:
/* 800C6AF0  7F 83 E3 78 */	mr r3, r28                              
/* 800C6AF4  38 80 00 18 */	li r4, 0x18                             
/* 800C6AF8  4B FF C2 AD */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800C6AFC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800C6B00  40 82 00 0C */	bne lbl_800C6B0C                         /* constant-address: 800C6B0C, symbol: lbl_800C6B0C */
/* 800C6B04  38 60 00 00 */	li r3, 0                                
/* 800C6B08  48 00 01 F8 */	b lbl_800C6D00                           /* constant-address: 800C6D00, symbol: lbl_800C6D00 */
lbl_800C6B0C:
/* 800C6B0C  80 1C 05 70 */	lwz r0, 0x570(r28)                      
/* 800C6B10  54 00 02 11 */	rlwinm. r0, r0, 0, 8, 8                 
/* 800C6B14  41 82 00 10 */	beq lbl_800C6B24                         /* constant-address: 800C6B24, symbol: lbl_800C6B24 */
...
/* 800C6B30  40 82 00 6C */	bne lbl_800C6B9C                         /* constant-address: 800C6B9C, symbol: lbl_800C6B9C */
/* 800C6B34  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800C6B4C  41 82 00 E4 */	beq lbl_800C6C30                         /* constant-address: 800C6C30, symbol: lbl_800C6C30 */
/* 800C6B50  A8 1C 04 E6 */	lha r0, 0x4e6(r28)                      
/* 800C6B54  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c            
/* 800C6B58  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800C6B5C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800C6B60  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 800C6B64  C0 3C 04 D0 */	lfs f1, 0x4d0(r28)                      
/* 800C6B68  C0 42 93 3C */	lfs f2, lit_7808(r2)                     /* constant-address: 80452D3C, symbol: lit_7808 */
...
/* 800C6B98  48 00 00 98 */	b lbl_800C6C30                           /* constant-address: 800C6C30, symbol: lbl_800C6C30 */
lbl_800C6B9C:
/* 800C6B9C  2C 1D 00 04 */	cmpwi r29, 4                            
/* 800C6BA0  40 82 00 90 */	bne lbl_800C6C30                         /* constant-address: 800C6C30, symbol: lbl_800C6C30 */
/* 800C6BA4  A8 1C 2F FE */	lha r0, 0x2ffe(r28)                     
/* 800C6BA8  B0 1C 04 DE */	sth r0, 0x4de(r28)                      
/* 800C6BAC  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C6BB0  D0 21 00 08 */	stfs f1, 8(r1)                          
/* 800C6BB4  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800C6BB8  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800C6BBC  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 800C6BC0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800C6BC4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800C6BC8  38 63 5B D4 */	addi r3, r3, 0x5bd4                      /* constant-address: 8040BD94, symbol: None */
/* 800C6BCC  38 80 00 06 */	li r4, 6                                
/* 800C6BD0  38 A0 00 1F */	li r5, 0x1f                             
/* 800C6BD4  38 C1 00 08 */	addi r6, r1, 8                          
/* 800C6BD8  4B FA 8E 4D */	bl StartShock__12dVibration_cFii4cXyz    /* constant-address: 8006FA24, symbol: StartShock__12dVibration_cFii4cXyz */
...
/* 800C6BF0  48 01 06 CD */	bl setDamagePoint__9daAlink_cFiiii       /* constant-address: 800D72BC, symbol: setDamagePoint__9daAlink_cFiiii */
...
/* 800C6C08  41 82 00 10 */	beq lbl_800C6C18                         /* constant-address: 800C6C18, symbol: lbl_800C6C18 */
...
/* 800C6C3C  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C6C40  FC 40 F8 90 */	fmr f2, f31                             
/* 800C6C44  4B FE 63 9D */	bl setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff /* constant-address: 800ACFE0, symbol: setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff */
/* 800C6C48  7F 83 E3 78 */	mr r3, r28                              
/* 800C6C4C  4B FF 88 95 */	bl resetBasAnime__9daAlink_cFv           /* constant-address: 800BF4E0, symbol: resetBasAnime__9daAlink_cFv */
/* 800C6C50  2C 1D 00 04 */	cmpwi r29, 4                            
/* 800C6C54  41 82 00 4C */	beq lbl_800C6CA0                         /* constant-address: 800C6CA0, symbol: lbl_800C6CA0 */
/* 800C6C58  A8 7C 04 DE */	lha r3, 0x4de(r28)                      
/* 800C6C5C  A8 1C 04 E6 */	lha r0, 0x4e6(r28)                      
/* 800C6C60  7C 03 00 00 */	cmpw r3, r0                             
/* 800C6C64  40 82 00 3C */	bne lbl_800C6CA0                         /* constant-address: 800C6CA0, symbol: lbl_800C6CA0 */
/* 800C6C68  7F 83 E3 78 */	mr r3, r28                              
/* 800C6C6C  48 01 D0 01 */	bl checkGrabAnime__9daAlink_cCFv         /* constant-address: 800E3C6C, symbol: checkGrabAnime__9daAlink_cCFv */
/* 800C6C70  2C 03 00 00 */	cmpwi r3, 0                             
/* 800C6C74  40 82 00 2C */	bne lbl_800C6CA0                         /* constant-address: 800C6CA0, symbol: lbl_800C6CA0 */
/* 800C6C78  C0 3C 33 98 */	lfs f1, 0x3398(r28)                     
/* 800C6C7C  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800C6C80  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C6C84  40 81 00 10 */	ble lbl_800C6C94                         /* constant-address: 800C6C94, symbol: lbl_800C6C94 */
/* 800C6C88  38 00 00 02 */	li r0, 2                                
/* 800C6C8C  B0 1C 30 08 */	sth r0, 0x3008(r28)                     
/* 800C6C90  48 00 00 18 */	b lbl_800C6CA8                           /* constant-address: 800C6CA8, symbol: lbl_800C6CA8 */
lbl_800C6C94:
/* 800C6C94  38 00 00 01 */	li r0, 1                                
/* 800C6C98  B0 1C 30 08 */	sth r0, 0x3008(r28)                     
/* 800C6C9C  48 00 00 0C */	b lbl_800C6CA8                           /* constant-address: 800C6CA8, symbol: lbl_800C6CA8 */
lbl_800C6CA0:
/* 800C6CA0  38 00 00 00 */	li r0, 0                                
/* 800C6CA4  B0 1C 30 08 */	sth r0, 0x3008(r28)                     
lbl_800C6CA8:
/* 800C6CA8  2C 1E 00 00 */	cmpwi r30, 0                            
/* 800C6CAC  41 82 00 18 */	beq lbl_800C6CC4                         /* constant-address: 800C6CC4, symbol: lbl_800C6CC4 */
...
/* 800C6CC0  48 00 00 14 */	b lbl_800C6CD4                           /* constant-address: 800C6CD4, symbol: lbl_800C6CD4 */
lbl_800C6CC4:
...
/* 800C6D0C  48 29 B5 15 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

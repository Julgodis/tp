...
/* 800CE74C  40 82 00 18 */	bne lbl_800CE764                         /* constant-address: 800CE764, symbol: lbl_800CE764 */
/* 800CE750  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800CE754  28 00 01 40 */	cmplwi r0, 0x140                        
/* 800CE758  41 82 00 0C */	beq lbl_800CE764                         /* constant-address: 800CE764, symbol: lbl_800CE764 */
/* 800CE75C  28 00 00 CB */	cmplwi r0, 0xcb                         
/* 800CE760  40 82 00 0C */	bne lbl_800CE76C                         /* constant-address: 800CE76C, symbol: lbl_800CE76C */
lbl_800CE764:
/* 800CE764  7F E3 FB 78 */	mr r3, r31                              
/* 800CE768  48 00 01 20 */	b lbl_800CE888                           /* constant-address: 800CE888, symbol: lbl_800CE888 */
lbl_800CE76C:
/* 800CE76C  3C 60 80 39 */	lis r3, lit_5908@ha                     
/* 800CE770  38 83 17 34 */	addi r4, r3, lit_5908@l                  /* constant-address: 80391734, symbol: lit_5908 */
/* 800CE774  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 80391734, symbol: lit_5908 */
/* 800CE778  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 80391738, symbol: None */
/* 800CE77C  90 61 00 38 */	stw r3, 0x38(r1)                        
/* 800CE780  90 01 00 3C */	stw r0, 0x3c(r1)                        
/* 800CE784  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 8039173C, symbol: None */
/* 800CE788  90 01 00 40 */	stw r0, 0x40(r1)                        
/* 800CE78C  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800CE7C4  41 80 00 10 */	blt lbl_800CE7D4                         /* constant-address: 800CE7D4, symbol: lbl_800CE7D4 */
/* 800CE7C8  C0 02 92 9C */	lfs f0, lit_5944(r2)                     /* constant-address: 80452C9C, symbol: lit_5944 */
/* 800CE7CC  D0 01 00 40 */	stfs f0, 0x40(r1)                       
/* 800CE7D0  48 00 00 0C */	b lbl_800CE7DC                           /* constant-address: 800CE7DC, symbol: lbl_800CE7DC */
lbl_800CE7D4:
/* 800CE7D4  C0 02 92 A0 */	lfs f0, lit_5945(r2)                     /* constant-address: 80452CA0, symbol: lit_5945 */
/* 800CE7D8  D0 01 00 40 */	stfs f0, 0x40(r1)                       
lbl_800CE7DC:
/* 800CE7DC  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 800CE7E0  4B F3 E5 85 */	bl transS__14mDoMtx_stack_cFRC4cXyz      /* constant-address: 8000CD64, symbol: transS__14mDoMtx_stack_cFRC4cXyz */
/* 800CE7E4  7F C3 F3 78 */	mr r3, r30                              
/* 800CE7E8  48 01 3C 15 */	bl concatMagneBootMtx__9daAlink_cFv      /* constant-address: 800E23FC, symbol: concatMagneBootMtx__9daAlink_cFv */
/* 800CE7EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800CE7F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800CE7F4  7F E4 FB 78 */	mr r4, r31                              
/* 800CE7F8  A8 BE 04 E6 */	lha r5, 0x4e6(r30)                      
/* 800CE7FC  38 C0 00 00 */	li r6, 0                                
/* 800CE800  4B F3 DA A1 */	bl mDoMtx_ZXYrotM__FPA4_fsss             /* constant-address: 8000C2A0, symbol: mDoMtx_ZXYrotM__FPA4_fsss */
/* 800CE804  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800CE808  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800CE80C  38 81 00 38 */	addi r4, r1, 0x38                       
/* 800CE810  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800CE814  48 27 85 59 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800CE818  7F C3 F3 78 */	mr r3, r30                              
/* 800CE81C  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 800CE820  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800CE824  4B FD 39 75 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800CE828  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800CE82C  41 82 00 58 */	beq lbl_800CE884                         /* constant-address: 800CE884, symbol: lbl_800CE884 */
/* 800CE830  38 61 00 08 */	addi r3, r1, 8                          
/* 800CE834  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800CE838  38 BE 1B 78 */	addi r5, r30, 0x1b78                    
/* 800CE83C  48 19 82 F9 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800CE860  48 01 3C 1D */	bl multVecMagneBootInvMtx__9daAlink_cFP4cXyz /* constant-address: 800E247C, symbol: multVecMagneBootInvMtx__9daAlink_cFP4cXyz */

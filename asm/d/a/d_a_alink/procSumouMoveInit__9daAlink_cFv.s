...
/* 800EAC6C  4B FD 73 01 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800EAC70  38 00 00 0C */	li r0, 0xc                              
/* 800EAC74  98 1F 2F 99 */	stb r0, 0x2f99(r31)                     
/* 800EAC78  C0 02 93 B8 */	lfs f0, lit_10041(r2)                    /* constant-address: 80452DB8, symbol: lit_10041 */
/* 800EAC7C  D0 1F 34 78 */	stfs f0, 0x3478(r31)                    
/* 800EAC80  88 1F 05 6A */	lbz r0, 0x56a(r31)                      
/* 800EAC84  28 00 00 0F */	cmplwi r0, 0xf                          
/* 800EAC88  41 82 00 0C */	beq lbl_800EAC94                         /* constant-address: 800EAC94, symbol: lbl_800EAC94 */
/* 800EAC8C  28 00 00 10 */	cmplwi r0, 0x10                         
/* 800EAC90  40 82 00 5C */	bne lbl_800EACEC                         /* constant-address: 800EACEC, symbol: lbl_800EACEC */
lbl_800EAC94:
/* 800EAC94  88 1E 04 99 */	lbz r0, 0x499(r30)                      
/* 800EAC98  54 00 06 7F */	clrlwi. r0, r0, 0x19                    
/* 800EAC9C  38 80 01 4A */	li r4, 0x14a                            
/* 800EACA0  41 82 00 08 */	beq lbl_800EACA8                         /* constant-address: 800EACA8, symbol: lbl_800EACA8 */
/* 800EACA4  38 80 01 4B */	li r4, 0x14b                            
lbl_800EACA8:
/* 800EACA8  7C 9E 23 78 */	mr r30, r4                              
/* 800EACAC  7F E3 FB 78 */	mr r3, r31                              
/* 800EACB0  4B FC 22 D1 */	bl setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM /* constant-address: 800ACF80, symbol: setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM */
/* 800EACB4  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800EACD4  C0 02 93 3C */	lfs f0, lit_7808(r2)                     /* constant-address: 80452D3C, symbol: lit_7808 */
/* 800EACD8  D0 1F 34 78 */	stfs f0, 0x3478(r31)                    
/* 800EACDC  3C 60 00 01 */	lis r3, 0x0001 /* 0x0001004D@ha */      
/* 800EACE0  38 03 00 4D */	addi r0, r3, 0x004D /* 0x0001004D@l */   /* constant-address: 0001004D */
/* 800EACE4  90 1F 32 CC */	stw r0, 0x32cc(r31)                     
/* 800EACE8  48 00 00 4C */	b lbl_800EAD34                           /* constant-address: 800EAD34, symbol: lbl_800EAD34 */
lbl_800EACEC:
/* 800EACEC  88 1E 04 99 */	lbz r0, 0x499(r30)                      
/* 800EACF0  54 00 06 7F */	clrlwi. r0, r0, 0x19                    
/* 800EACF4  38 80 01 4C */	li r4, 0x14c                            
/* 800EACF8  41 82 00 08 */	beq lbl_800EAD00                         /* constant-address: 800EAD00, symbol: lbl_800EAD00 */
/* 800EACFC  38 80 01 4D */	li r4, 0x14d                            
lbl_800EAD00:
/* 800EAD00  7C 9E 23 78 */	mr r30, r4                              
/* 800EAD04  7F E3 FB 78 */	mr r3, r31                              
/* 800EAD08  4B FC 22 79 */	bl setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM /* constant-address: 800ACF80, symbol: setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM */
/* 800EAD0C  C0 02 92 BC */	lfs f0, lit_6041(r2)                     /* constant-address: 80452CBC, symbol: lit_6041 */
...
/* 800EAD4C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800EAD64  48 03 64 5D */	bl setFootEffectProcType__9daAlink_cFi   /* constant-address: 801211C0, symbol: setFootEffectProcType__9daAlink_cFi */

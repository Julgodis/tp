...
/* 8010DCA8  4B F0 C1 5D */	bl fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv /* constant-address: 80019E04, symbol: fopAcM_fastCreate__FsUlPC4cXyziPC5csXyzPC4cXyzScPFPv_iPv */
/* 8010DCAC  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8010DCB0  40 82 00 0C */	bne lbl_8010DCBC                         /* constant-address: 8010DCBC, symbol: lbl_8010DCBC */
/* 8010DCB4  38 60 00 00 */	li r3, 0                                
/* 8010DCB8  48 00 00 FC */	b lbl_8010DDB4                           /* constant-address: 8010DDB4, symbol: lbl_8010DDB4 */
lbl_8010DCBC:
/* 8010DCBC  7F C3 F3 78 */	mr r3, r30                              
/* 8010DCC0  38 80 00 A4 */	li r4, 0xa4                             
/* 8010DCC4  4B FB 42 A9 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 8010DCC8  38 7E 28 14 */	addi r3, r30, 0x2814                    
/* 8010DCCC  7F E4 FB 78 */	mr r4, r31                              
/* 8010DCD0  48 05 0F E9 */	bl setData__16daPy_actorKeep_cFP10fopAc_ac_c /* constant-address: 8015ECB8, symbol: setData__16daPy_actorKeep_cFP10fopAc_ac_c */
/* 8010DCD4  7F C3 F3 78 */	mr r3, r30                              
/* 8010DCD8  38 80 00 D7 */	li r4, 0xd7                             
/* 8010DCDC  3C A0 80 39 */	lis r5, m__23daAlinkHIO_smallJump_c0@ha 
/* 8010DCE0  38 C5 E1 1C */	addi r6, r5, m__23daAlinkHIO_smallJump_c0@l /* constant-address: 8038E11C, symbol: m__23daAlinkHIO_smallJump_c0 */
/* 8010DCE4  C0 26 00 04 */	lfs f1, 4(r6)                            /* constant-address: 8038E120, symbol: None */
/* 8010DCE8  C0 42 93 44 */	lfs f2, lit_7977(r2)                     /* constant-address: 80452D44, symbol: lit_7977 */
/* 8010DCEC  A8 A6 00 00 */	lha r5, 0(r6)                            /* constant-address: 8038E11C, symbol: m__23daAlinkHIO_smallJump_c0 */
/* 8010DCF0  C0 66 00 0C */	lfs f3, 0xc(r6)                          /* constant-address: 8038E128, symbol: None */
/* 8010DCF4  4B F9 F3 19 */	bl setSingleAnime__9daAlink_cFQ29daAlink_c11daAlink_ANMffsf /* constant-address: 800AD00C, symbol: setSingleAnime__9daAlink_cFQ29daAlink_c11daAlink_ANMffsf */
/* 8010DCF8  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8010DCFC  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 8010DD00  7F C3 F3 78 */	mr r3, r30                              
/* 8010DD04  38 80 00 00 */	li r4, 0                                
/* 8010DD08  4B FD 48 79 */	bl setHeavyBoots__9daAlink_cFi           /* constant-address: 800E2580, symbol: setHeavyBoots__9daAlink_cFi */
/* 8010DD0C  C0 02 93 28 */	lfs f0, lit_7451(r2)                     /* constant-address: 80452D28, symbol: lit_7451 */
/* 8010DD10  D0 1E 04 FC */	stfs f0, 0x4fc(r30)                     
/* 8010DD14  7F C3 F3 78 */	mr r3, r30                              
/* 8010DD18  3C 80 00 01 */	lis r4, 0x0001 /* 0x00010005@ha */      
/* 8010DD1C  38 84 00 05 */	addi r4, r4, 0x0005 /* 0x00010005@l */   /* constant-address: 00010005 */
...
/* 8010DD38  38 84 00 76 */	addi r4, r4, 0x0076 /* 0x00020076@l */   /* constant-address: 00020076 */
...
/* 8010DD60  4B FB 35 7D */	bl deleteEquipItem__9daAlink_cFii        /* constant-address: 800C12DC, symbol: deleteEquipItem__9daAlink_cFii */
/* 8010DD64  A8 1E 04 E6 */	lha r0, 0x4e6(r30)                      
/* 8010DD68  B0 1E 04 DE */	sth r0, 0x4de(r30)                      
/* 8010DD6C  3C 60 80 42 */	lis r3, l_waitBaseAnime@ha              
/* 8010DD70  C4 03 55 14 */	lfsu f0, l_waitBaseAnime@l(r3)           /* constant-address: 80425514, symbol: l_waitBaseAnime */
/* 8010DD74  D0 1E 35 88 */	stfs f0, 0x3588(r30)                    
/* 8010DD78  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425518, symbol: None */
/* 8010DD7C  D0 1E 35 8C */	stfs f0, 0x358c(r30)                    
/* 8010DD80  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042551C, symbol: None */
/* 8010DD84  D0 1E 35 90 */	stfs f0, 0x3590(r30)                    
/* 8010DD88  C0 1E 35 8C */	lfs f0, 0x358c(r30)                     
/* 8010DD8C  D0 1E 33 B0 */	stfs f0, 0x33b0(r30)                    
/* 8010DD90  C0 03 00 00 */	lfs f0, 0(r3)                            /* constant-address: 80425514, symbol: l_waitBaseAnime */
/* 8010DD94  D0 1E 34 D4 */	stfs f0, 0x34d4(r30)                    
/* 8010DD98  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425518, symbol: None */
/* 8010DD9C  D0 1E 34 D8 */	stfs f0, 0x34d8(r30)                    
/* 8010DDA0  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042551C, symbol: None */

lbl_800F99FC:
/* 800F99FC 00000000  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 800F9A00 00000004  7C 08 02 A6 */	mflr r0
/* 800F9A04 00000008  90 01 00 24 */	stw r0, 0x24(r1)
/* 800F9A08 0000000C  39 61 00 20 */	addi r11, r1, 0x20
/* 800F9A0C 00000010  48 26 87 C9 */	bl _savegpr_27
/* 800F9A10 00000014  7C 7B 1B 78 */	mr r27, r3
/* 800F9A14 00000018  7C 9C 23 78 */	mr r28, r4
/* 800F9A18 0000001C  7C BD 2B 78 */	mr r29, r5
/* 800F9A1C 00000020  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha
/* 800F9A20 00000024  3B E4 61 C0 */	addi r31, r4, g_dComIfG_gameInfo@l
/* 800F9A24 00000028  80 1F 5F 18 */	lwz r0, 0x5f18(r31)	/* effective address: 8040C0D8 */
/* 800F9A28 0000002C  54 1E 9F FE */	rlwinm r30, r0, 0x13, 0x1f, 0x1f
/* 800F9A2C 00000030  38 80 00 37 */	li r4, 0x37
/* 800F9A30 00000034  4B FC 85 3D */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC
/* 800F9A34 00000038  C0 1D 00 00 */	lfs f0, 0(r29)
/* 800F9A38 0000003C  D0 1B 37 C8 */	stfs f0, 0x37c8(r27)
/* 800F9A3C 00000040  C0 1D 00 04 */	lfs f0, 4(r29)
...
/* 800F9A4C 00000050  C0 02 92 B8 */	lfs f0, lit_6040(r2)
...
/* 800F9AA8 00000008  48 26 87 79 */	bl _restgpr_27
/* 800F9AAC 0000000C  80 01 00 24 */	lwz r0, 0x24(r1)
/* 800F9AB0 00000010  7C 08 03 A6 */	mtlr r0
/* 800F9AB4 00000014  38 21 00 20 */	addi r1, r1, 0x20
/* 800F9AB8 00000018  4E 80 00 20 */	blr 

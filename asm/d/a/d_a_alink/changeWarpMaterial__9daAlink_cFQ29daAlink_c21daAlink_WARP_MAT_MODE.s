...
/* 800C1E1C  48 2A 03 BD */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 800C1E20  7C 7D 1B 78 */	mr r29, r3                              
/* 800C1E24  7C 9E 23 78 */	mr r30, r4                              
/* 800C1E28  80 62 98 D8 */	lwz r3, lit_72043(r2)                    /* constant-address: 804532D8, symbol: lit_72043 */
/* 800C1E2C  80 02 98 DC */	lwz r0, data_804532DC(r2)                /* constant-address: 804532DC, symbol: data_804532DC */
...
/* 800C1E98  41 82 00 1C */	beq lbl_800C1EB4                         /* constant-address: 800C1EB4, symbol: lbl_800C1EB4 */
...
/* 800C1EB0  48 00 00 54 */	b lbl_800C1F04                           /* constant-address: 800C1F04, symbol: lbl_800C1F04 */
lbl_800C1EB4:
...
/* 800C1F08  40 82 00 4C */	bne lbl_800C1F54                         /* constant-address: 800C1F54, symbol: lbl_800C1F54 */
/* 800C1F0C  3B 80 00 00 */	li r28, 0                               
/* 800C1F10  3B C0 00 00 */	li r30, 0                               
/* 800C1F14  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800C1F18  3B E3 61 C0 */	addi r31, r3, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
lbl_800C1F1C:
/* 800C1F1C  80 7F 5D 3C */	lwz r3, 0x5d3c(r31)                      /* constant-address: 8040BEFC, symbol: None */
/* 800C1F20  38 63 02 10 */	addi r3, r3, 0x210                      
/* 800C1F24  38 1E 32 40 */	addi r0, r30, 0x3240                    
/* 800C1F28  7C 9D 00 2E */	lwzx r4, r29, r0                        
/* 800C1F2C  4B F8 99 ED */	bl getEmitter__Q213dPa_control_c7level_cFUl /* constant-address: 8004B918, symbol: getEmitter__Q213dPa_control_c7level_cFUl */
/* 800C1F30  28 03 00 00 */	cmplwi r3, 0                            
/* 800C1F34  41 82 00 10 */	beq lbl_800C1F44                         /* constant-address: 800C1F44, symbol: lbl_800C1F44 */
/* 800C1F38  80 03 00 F4 */	lwz r0, 0xf4(r3)                        
/* 800C1F3C  60 00 00 04 */	ori r0, r0, 4                           
/* 800C1F40  90 03 00 F4 */	stw r0, 0xf4(r3)                        
lbl_800C1F44:
/* 800C1F44  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
/* 800C1F48  2C 1C 00 06 */	cmpwi r28, 6                            
/* 800C1F4C  3B DE 00 04 */	addi r30, r30, 4                         /* constant-address: 00000004 */
/* 800C1F50  41 80 FF CC */	blt lbl_800C1F1C                         /* constant-address: 800C1F1C, symbol: lbl_800C1F1C */
lbl_800C1F54:
/* 800C1F54  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800C1F58  48 2A 02 CD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

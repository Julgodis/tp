...
/* 800FEF10  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800FEF14  7F E4 04 2E */	lfsx f31, r4, r0                        
/* 800FEF18  7C 84 02 14 */	add r4, r4, r0                          
/* 800FEF1C  C3 C4 00 04 */	lfs f30, 4(r4)                          
/* 800FEF20  C0 02 92 E0 */	lfs f0, lit_6845(r2)                     /* constant-address: 80452CE0, symbol: lit_6845 */
/* 800FEF24  EF 80 07 B2 */	fmuls f28, f0, f30                      
/* 800FEF28  C0 02 94 0C */	lfs f0, lit_14614(r2)                    /* constant-address: 80452E0C, symbol: lit_14614 */
...
/* 800FEF58  41 82 00 3C */	beq lbl_800FEF94                         /* constant-address: 800FEF94, symbol: lbl_800FEF94 */
...
/* 800FEF78  4B FF FC 19 */	bl checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800FEB90, symbol: checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz */
/* 800FEF7C  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FEF80  41 82 00 14 */	beq lbl_800FEF94                         /* constant-address: 800FEF94, symbol: lbl_800FEF94 */
/* 800FEF84  2C 1F 00 02 */	cmpwi r31, 2                            
/* 800FEF88  40 82 00 0C */	bne lbl_800FEF94                         /* constant-address: 800FEF94, symbol: lbl_800FEF94 */
/* 800FEF8C  38 60 00 01 */	li r3, 1                                
/* 800FEF90  48 00 02 BC */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FEF94:
/* 800FEF94  2C 1F 00 02 */	cmpwi r31, 2                            
/* 800FEF98  41 82 00 4C */	beq lbl_800FEFE4                         /* constant-address: 800FEFE4, symbol: lbl_800FEFE4 */
...
/* 800FEFC8  4B FF FB C9 */	bl checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800FEB90, symbol: checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz */
/* 800FEFCC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FEFD0  41 82 00 14 */	beq lbl_800FEFE4                         /* constant-address: 800FEFE4, symbol: lbl_800FEFE4 */
/* 800FEFD4  2C 1F 00 03 */	cmpwi r31, 3                            
/* 800FEFD8  40 82 00 0C */	bne lbl_800FEFE4                         /* constant-address: 800FEFE4, symbol: lbl_800FEFE4 */
/* 800FEFDC  38 60 00 01 */	li r3, 1                                
/* 800FEFE0  48 00 02 6C */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FEFE4:
...
/* 800FEFF8  41 82 00 48 */	beq lbl_800FF040                         /* constant-address: 800FF040, symbol: lbl_800FF040 */
...
/* 800FF024  4B FF FB 6D */	bl checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800FEB90, symbol: checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz */
/* 800FF028  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF02C  41 82 00 14 */	beq lbl_800FF040                         /* constant-address: 800FF040, symbol: lbl_800FF040 */
/* 800FF030  2C 1F 00 02 */	cmpwi r31, 2                            
/* 800FF034  40 82 00 0C */	bne lbl_800FF040                         /* constant-address: 800FF040, symbol: lbl_800FF040 */
/* 800FF038  38 60 00 01 */	li r3, 1                                
/* 800FF03C  48 00 02 10 */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FF040:
/* 800FF040  2C 1F 00 02 */	cmpwi r31, 2                            
/* 800FF044  41 82 00 4C */	beq lbl_800FF090                         /* constant-address: 800FF090, symbol: lbl_800FF090 */
...
/* 800FF074  4B FF FB 1D */	bl checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800FEB90, symbol: checkBgCorrectClimbMove__9daAlink_cFP4cXyzP4cXyz */
/* 800FF078  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF07C  41 82 00 14 */	beq lbl_800FF090                         /* constant-address: 800FF090, symbol: lbl_800FF090 */
/* 800FF080  2C 1F 00 03 */	cmpwi r31, 3                            
/* 800FF084  40 82 00 0C */	bne lbl_800FF090                         /* constant-address: 800FF090, symbol: lbl_800FF090 */
/* 800FF088  38 60 00 01 */	li r3, 1                                
/* 800FF08C  48 00 01 C0 */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FF090:
/* 800FF090  2C 1F 00 04 */	cmpwi r31, 4                            
/* 800FF094  41 82 00 0C */	beq lbl_800FF0A0                         /* constant-address: 800FF0A0, symbol: lbl_800FF0A0 */
/* 800FF098  38 60 00 00 */	li r3, 0                                
/* 800FF09C  48 00 01 B0 */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FF0A0:
...
/* 800FF0E0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FF0E4  3B E3 0F 38 */	addi r31, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 800FF0E8  7F E3 FB 78 */	mr r3, r31                              
/* 800FF0EC  38 9E 1D 5C */	addi r4, r30, 0x1d5c                    
/* 800FF0F0  4B F7 63 AD */	bl RoofChk__4dBgSFP12dBgS_RoofChk        /* constant-address: 8007549C, symbol: RoofChk__4dBgSFP12dBgS_RoofChk */
...
/* 800FF104  40 80 00 08 */	bge lbl_800FF10C                         /* constant-address: 800FF10C, symbol: lbl_800FF10C */
...
/* 800FF150  4B F7 63 4D */	bl RoofChk__4dBgSFP12dBgS_RoofChk        /* constant-address: 8007549C, symbol: RoofChk__4dBgSFP12dBgS_RoofChk */
...
/* 800FF164  40 80 00 08 */	bge lbl_800FF16C                         /* constant-address: 800FF16C, symbol: lbl_800FF16C */
/* 800FF168  D0 3E 04 D4 */	stfs f1, 0x4d4(r30)                     
lbl_800FF16C:
/* 800FF16C  C0 21 00 08 */	lfs f1, 8(r1)                           
/* 800FF170  C0 42 93 50 */	lfs f2, lit_8247(r2)                     /* constant-address: 80452D50, symbol: lit_8247 */
...
/* 800FF1A4  4B FA 2F F5 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800FF1A8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FF1AC  40 82 00 9C */	bne lbl_800FF248                         /* constant-address: 800FF248, symbol: lbl_800FF248 */
/* 800FF1B0  7F C3 F3 78 */	mr r3, r30                              
/* 800FF1B4  C0 21 00 0C */	lfs f1, 0xc(r1)                         
/* 800FF1B8  4B FF FA B9 */	bl checkClimbRoof__9daAlink_cFf          /* constant-address: 800FEC70, symbol: checkClimbRoof__9daAlink_cFf */
/* 800FF1BC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF1C0  41 82 00 10 */	beq lbl_800FF1D0                         /* constant-address: 800FF1D0, symbol: lbl_800FF1D0 */
/* 800FF1C4  7F C3 F3 78 */	mr r3, r30                              
/* 800FF1C8  48 00 12 1D */	bl procClimbToRoofInit__9daAlink_cFv     /* constant-address: 801003E4, symbol: procClimbToRoofInit__9daAlink_cFv */
/* 800FF1CC  48 00 00 80 */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FF1D0:
/* 800FF1D0  7F C3 F3 78 */	mr r3, r30                              
/* 800FF1D4  38 81 00 14 */	addi r4, r1, 0x14                       
/* 800FF1D8  C0 21 00 0C */	lfs f1, 0xc(r1)                         
/* 800FF1DC  4B FF FB 75 */	bl checkClimbGround__9daAlink_cFP4cXyzf  /* constant-address: 800FED50, symbol: checkClimbGround__9daAlink_cFP4cXyzf */
/* 800FF1E0  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF1E4  41 82 00 40 */	beq lbl_800FF224                         /* constant-address: 800FF224, symbol: lbl_800FF224 */
...
/* 800FF214  38 84 E1 64 */	addi r4, r4, m__23daAlinkHIO_wallCatch_c0@l /* constant-address: 8038E164, symbol: m__23daAlinkHIO_wallCatch_c0 */
/* 800FF218  C0 24 00 30 */	lfs f1, 0x30(r4)                         /* constant-address: 8038E194, symbol: None */
/* 800FF21C  4B FF C9 AD */	bl procHangClimbInit__9daAlink_cFf       /* constant-address: 800FBBC8, symbol: procHangClimbInit__9daAlink_cFf */
/* 800FF220  48 00 00 2C */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FF224:
/* 800FF224  C0 3E 04 D4 */	lfs f1, 0x4d4(r30)                      
/* 800FF228  C0 02 92 E0 */	lfs f0, lit_6845(r2)                     /* constant-address: 80452CE0, symbol: lit_6845 */
...
/* 800FF240  48 00 0E B9 */	bl procClimbWaitInit__9daAlink_cFii      /* constant-address: 801000F8, symbol: procClimbWaitInit__9daAlink_cFii */
/* 800FF244  48 00 00 08 */	b lbl_800FF24C                           /* constant-address: 800FF24C, symbol: lbl_800FF24C */
lbl_800FF248:

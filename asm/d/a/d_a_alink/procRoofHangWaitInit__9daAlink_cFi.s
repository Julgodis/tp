...
/* 80100BD4  4B FC 21 D1 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 80100BD8  2C 03 00 00 */	cmpwi r3, 0                             
/* 80100BDC  40 82 00 0C */	bne lbl_80100BE8                         /* constant-address: 80100BE8, symbol: lbl_80100BE8 */
/* 80100BE0  38 60 00 00 */	li r3, 0                                
/* 80100BE4  48 00 01 3C */	b lbl_80100D20                           /* constant-address: 80100D20, symbol: lbl_80100D20 */
lbl_80100BE8:
/* 80100BE8  88 1E 2F 98 */	lbz r0, 0x2f98(r30)                     
/* 80100BEC  28 00 00 00 */	cmplwi r0, 0                            
/* 80100BF0  41 82 00 0C */	beq lbl_80100BFC                         /* constant-address: 80100BFC, symbol: lbl_80100BFC */
/* 80100BF4  28 00 00 01 */	cmplwi r0, 1                            
/* 80100BF8  40 82 00 C8 */	bne lbl_80100CC0                         /* constant-address: 80100CC0, symbol: lbl_80100CC0 */
lbl_80100BFC:
/* 80100BFC  28 00 00 00 */	cmplwi r0, 0                            
/* 80100C00  40 82 00 64 */	bne lbl_80100C64                         /* constant-address: 80100C64, symbol: lbl_80100C64 */
/* 80100C04  A8 1E 04 E6 */	lha r0, 0x4e6(r30)                      
/* 80100C08  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c            
/* 80100C0C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 80100C10  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 80100C14  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 80100C18  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)                      
/* 80100C1C  C0 42 92 9C */	lfs f2, lit_5944(r2)                     /* constant-address: 80452C9C, symbol: lit_5944 */
...
/* 80100C60  48 00 00 60 */	b lbl_80100CC0                           /* constant-address: 80100CC0, symbol: lbl_80100CC0 */
lbl_80100C64:
/* 80100C64  A8 1E 04 E6 */	lha r0, 0x4e6(r30)                      
/* 80100C68  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c            
/* 80100C6C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 80100C70  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 80100C74  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 80100C78  C0 3E 04 D0 */	lfs f1, 0x4d0(r30)                      
/* 80100C7C  C0 42 92 9C */	lfs f2, lit_5944(r2)                     /* constant-address: 80452C9C, symbol: lit_5944 */
...
/* 80100CC8  3C A0 80 39 */	lis r5, m__22daAlinkHIO_roofHang_c0@ha  
/* 80100CCC  38 A5 EB FC */	addi r5, r5, m__22daAlinkHIO_roofHang_c0@l /* constant-address: 8038EBFC, symbol: m__22daAlinkHIO_roofHang_c0 */
/* 80100CD0  C0 25 00 1C */	lfs f1, 0x1c(r5)                         /* constant-address: 8038EC18, symbol: None */
/* 80100CD4  C0 45 00 20 */	lfs f2, 0x20(r5)                         /* constant-address: 8038EC1C, symbol: None */
/* 80100CD8  4B FA C3 09 */	bl setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff /* constant-address: 800ACFE0, symbol: setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff */
/* 80100CDC  A8 1E 04 E6 */	lha r0, 0x4e6(r30)                      
/* 80100CE0  B0 1E 04 DE */	sth r0, 0x4de(r30)                      
/* 80100CE4  7F C3 F3 78 */	mr r3, r30                              
/* 80100CE8  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80100CEC  C0 5E 05 34 */	lfs f2, 0x534(r30)                      
/* 80100CF0  38 80 00 00 */	li r4, 0                                
/* 80100CF4  4B FB AA 7D */	bl setSpecialGravity__9daAlink_cFffi     /* constant-address: 800BB770, symbol: setSpecialGravity__9daAlink_cFffi */
/* 80100CF8  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80100CFC  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 80100D00  D0 1E 04 FC */	stfs f0, 0x4fc(r30)                     
/* 80100D04  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80100D08  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80100D0C  80 03 5F 1C */	lwz r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */
/* 80100D10  64 00 00 10 */	oris r0, r0, 0x10                       
/* 80100D14  90 03 5F 1C */	stw r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */

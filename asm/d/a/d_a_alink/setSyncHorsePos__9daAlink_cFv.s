...
/* 800ED4F8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800ED4FC  83 E4 5D B8 */	lwz r31, 0x5db8(r4)                      /* constant-address: 8040BF78, symbol: None */
/* 800ED500  28 1F 00 00 */	cmplwi r31, 0                           
/* 800ED504  40 82 00 34 */	bne lbl_800ED538                         /* constant-address: 800ED538, symbol: lbl_800ED538 */
/* 800ED508  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800ED50C  28 00 01 50 */	cmplwi r0, 0x150                        
/* 800ED510  41 82 00 0C */	beq lbl_800ED51C                         /* constant-address: 800ED51C, symbol: lbl_800ED51C */
/* 800ED514  28 00 01 48 */	cmplwi r0, 0x148                        
/* 800ED518  40 82 00 0C */	bne lbl_800ED524                         /* constant-address: 800ED524, symbol: lbl_800ED524 */
lbl_800ED51C:
/* 800ED51C  38 60 00 01 */	li r3, 1                                
/* 800ED520  48 00 02 54 */	b lbl_800ED774                           /* constant-address: 800ED774, symbol: lbl_800ED774 */
lbl_800ED524:
/* 800ED524  4B FF F6 AD */	bl rideGetOff__9daAlink_cFv              /* constant-address: 800ECBD0, symbol: rideGetOff__9daAlink_cFv */
/* 800ED528  7F C3 F3 78 */	mr r3, r30                              
/* 800ED52C  4B FC 83 C1 */	bl checkWaitAction__9daAlink_cFv         /* constant-address: 800B58EC, symbol: checkWaitAction__9daAlink_cFv */
/* 800ED530  38 60 00 00 */	li r3, 0                                
/* 800ED534  48 00 02 40 */	b lbl_800ED774                           /* constant-address: 800ED774, symbol: lbl_800ED774 */
lbl_800ED538:
...
/* 800ED548  41 82 00 44 */	beq lbl_800ED58C                         /* constant-address: 800ED58C, symbol: lbl_800ED58C */
/* 800ED54C  28 00 00 50 */	cmplwi r0, 0x50                         
/* 800ED550  41 82 00 3C */	beq lbl_800ED58C                         /* constant-address: 800ED58C, symbol: lbl_800ED58C */
/* 800ED554  38 80 00 55 */	li r4, 0x55                             
/* 800ED558  4B FB F0 01 */	bl checkUnderMove0BckNoArc__9daAlink_cCFQ29daAlink_c11daAlink_ANM /* constant-address: 800AC558, symbol: checkUnderMove0BckNoArc__9daAlink_cCFQ29daAlink_c11daAlink_ANM */
/* 800ED55C  2C 03 00 00 */	cmpwi r3, 0                             
/* 800ED560  40 82 00 2C */	bne lbl_800ED58C                         /* constant-address: 800ED58C, symbol: lbl_800ED58C */
/* 800ED564  7F C3 F3 78 */	mr r3, r30                              
/* 800ED568  38 80 00 5A */	li r4, 0x5a                             
/* 800ED56C  4B FB EF ED */	bl checkUnderMove0BckNoArc__9daAlink_cCFQ29daAlink_c11daAlink_ANM /* constant-address: 800AC558, symbol: checkUnderMove0BckNoArc__9daAlink_cCFQ29daAlink_c11daAlink_ANM */
/* 800ED570  2C 03 00 00 */	cmpwi r3, 0                             
/* 800ED574  40 82 00 18 */	bne lbl_800ED58C                         /* constant-address: 800ED58C, symbol: lbl_800ED58C */
/* 800ED578  7F C3 F3 78 */	mr r3, r30                              
/* 800ED57C  38 80 00 5B */	li r4, 0x5b                             
/* 800ED580  4B FB EF D9 */	bl checkUnderMove0BckNoArc__9daAlink_cCFQ29daAlink_c11daAlink_ANM /* constant-address: 800AC558, symbol: checkUnderMove0BckNoArc__9daAlink_cCFQ29daAlink_c11daAlink_ANM */
/* 800ED584  2C 03 00 00 */	cmpwi r3, 0                             
/* 800ED588  41 82 01 2C */	beq lbl_800ED6B4                         /* constant-address: 800ED6B4, symbol: lbl_800ED6B4 */
lbl_800ED58C:
/* 800ED58C  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800ED590  28 00 00 4F */	cmplwi r0, 0x4f                         
/* 800ED594  40 82 00 C8 */	bne lbl_800ED65C                         /* constant-address: 800ED65C, symbol: lbl_800ED65C */
...
/* 800ED5AC  38 84 19 54 */	addi r4, r4, data_80391954@l             /* constant-address: 80391954, symbol: data_80391954 */
/* 800ED5B0  38 BE 04 D0 */	addi r5, r30, 0x4d0                     
/* 800ED5B4  48 25 97 B9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800ED5B8  38 60 00 00 */	li r3, 0                                
/* 800ED5BC  88 9F 16 B4 */	lbz r4, 0x16b4(r31)                     
/* 800ED5C0  28 04 00 03 */	cmplwi r4, 3                            
/* 800ED5C4  40 82 00 14 */	bne lbl_800ED5D8                         /* constant-address: 800ED5D8, symbol: lbl_800ED5D8 */
/* 800ED5C8  A8 1F 17 20 */	lha r0, 0x1720(r31)                     
/* 800ED5CC  2C 00 00 00 */	cmpwi r0, 0                             
/* 800ED5D0  40 82 00 08 */	bne lbl_800ED5D8                         /* constant-address: 800ED5D8, symbol: lbl_800ED5D8 */
/* 800ED5D4  38 60 00 01 */	li r3, 1                                
lbl_800ED5D8:
/* 800ED5D8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800ED5DC  40 82 00 A0 */	bne lbl_800ED67C                         /* constant-address: 800ED67C, symbol: lbl_800ED67C */
/* 800ED5E0  28 04 00 02 */	cmplwi r4, 2                            
/* 800ED5E4  41 82 00 98 */	beq lbl_800ED67C                         /* constant-address: 800ED67C, symbol: lbl_800ED67C */
/* 800ED5E8  C0 62 92 98 */	lfs f3, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800ED5EC  C0 5F 05 C0 */	lfs f2, 0x5c0(r31)                      
/* 800ED5F0  A8 1F 05 B8 */	lha r0, 0x5b8(r31)                      
/* 800ED5F4  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800ED618  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800ED61C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 800ED620  40 81 00 08 */	ble lbl_800ED628                         /* constant-address: 800ED628, symbol: lbl_800ED628 */
/* 800ED624  EC 42 00 28 */	fsubs f2, f2, f0                        
lbl_800ED628:
/* 800ED628  A8 1E 1F D8 */	lha r0, 0x1fd8(r30)                     
/* 800ED62C  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800ED658  48 00 00 24 */	b lbl_800ED67C                           /* constant-address: 800ED67C, symbol: lbl_800ED67C */
lbl_800ED65C:
...
/* 800ED670  38 84 19 60 */	addi r4, r4, data_80391960@l             /* constant-address: 80391960, symbol: data_80391960 */
/* 800ED674  38 BE 04 D0 */	addi r5, r30, 0x4d0                     
/* 800ED678  48 25 96 F5 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
lbl_800ED67C:
...
/* 800ED690  4B F1 F5 71 */	bl mDoMtx_MtxToRot__FPA4_CfP5csXyz       /* constant-address: 8000CC00, symbol: mDoMtx_MtxToRot__FPA4_CfP5csXyz */
...
/* 800ED6B0  48 00 00 7C */	b lbl_800ED72C                           /* constant-address: 800ED72C, symbol: lbl_800ED72C */
lbl_800ED6B4:
/* 800ED6B4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800ED6B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
...
/* 800ED6D0  41 82 00 28 */	beq lbl_800ED6F8                         /* constant-address: 800ED6F8, symbol: lbl_800ED6F8 */
/* 800ED6D4  C0 5F 04 D8 */	lfs f2, 0x4d8(r31)                      
/* 800ED6D8  C0 22 94 C4 */	lfs f1, lit_18176(r2)                    /* constant-address: 80452EC4, symbol: lit_18176 */
...
/* 800ED6F4  48 00 00 20 */	b lbl_800ED714                           /* constant-address: 800ED714, symbol: lbl_800ED714 */
lbl_800ED6F8:
...
/* 800ED708  38 84 55 BC */	addi r4, r4, l_localHorseRidePos@l       /* constant-address: 804255BC, symbol: l_localHorseRidePos */
/* 800ED70C  38 BE 04 D0 */	addi r5, r30, 0x4d0                     
/* 800ED710  48 25 96 5D */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
lbl_800ED714:
...
/* 800ED748  4B FC 61 BD */	bl checkZeroSpeedF__9daAlink_cCFv        /* constant-address: 800B3904, symbol: checkZeroSpeedF__9daAlink_cCFv */
/* 800ED74C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800ED750  41 82 00 14 */	beq lbl_800ED764                         /* constant-address: 800ED764, symbol: lbl_800ED764 */
/* 800ED754  80 1E 31 A0 */	lwz r0, 0x31a0(r30)                     
/* 800ED758  60 00 00 01 */	ori r0, r0, 1                           
/* 800ED75C  90 1E 31 A0 */	stw r0, 0x31a0(r30)                     
/* 800ED760  48 00 00 10 */	b lbl_800ED770                           /* constant-address: 800ED770, symbol: lbl_800ED770 */
lbl_800ED764:

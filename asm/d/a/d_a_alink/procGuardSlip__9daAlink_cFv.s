...
/* 800DD8B8  41 82 00 0C */	beq lbl_800DD8C4                         /* constant-address: 800DD8C4, symbol: lbl_800DD8C4 */
/* 800DD8BC  C0 22 92 BC */	lfs f1, lit_6041(r2)                     /* constant-address: 80452CBC, symbol: lit_6041 */
/* 800DD8C0  4B FF F7 49 */	bl setUpperGuardAnime__9daAlink_cFf      /* constant-address: 800DD008, symbol: setUpperGuardAnime__9daAlink_cFf */
lbl_800DD8C4:
/* 800DD8C4  7F E3 FB 78 */	mr r3, r31                              
/* 800DD8C8  38 80 00 00 */	li r4, 0                                
/* 800DD8CC  4B FD 5E 69 */	bl setShapeAngleToAtnActor__9daAlink_cFi /* constant-address: 800B3734, symbol: setShapeAngleToAtnActor__9daAlink_cFi */
/* 800DD8D0  A8 7F 30 0A */	lha r3, 0x300a(r31)                     
/* 800DD8D4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800DD8D8  41 82 00 2C */	beq lbl_800DD904                         /* constant-address: 800DD904, symbol: lbl_800DD904 */
...
/* 800DD908  C0 02 93 D8 */	lfs f0, lit_11470(r2)                    /* constant-address: 80452DD8, symbol: lit_11470 */
/* 800DD90C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800DD910  40 81 00 0C */	ble lbl_800DD91C                         /* constant-address: 800DD91C, symbol: lbl_800DD91C */
...
/* 800DD934  41 82 00 18 */	beq lbl_800DD94C                         /* constant-address: 800DD94C, symbol: lbl_800DD94C */
/* 800DD938  A8 1F 30 10 */	lha r0, 0x3010(r31)                     
/* 800DD93C  2C 00 00 00 */	cmpwi r0, 0                             
/* 800DD940  40 82 00 0C */	bne lbl_800DD94C                         /* constant-address: 800DD94C, symbol: lbl_800DD94C */
/* 800DD944  C3 E2 93 D8 */	lfs f31, lit_11470(r2)                   /* constant-address: 80452DD8, symbol: lit_11470 */
/* 800DD948  48 00 00 08 */	b lbl_800DD950                           /* constant-address: 800DD950, symbol: lbl_800DD950 */
lbl_800DD94C:
/* 800DD94C  C3 E2 93 DC */	lfs f31, lit_11471(r2)                   /* constant-address: 80452DDC, symbol: lit_11471 */
lbl_800DD950:
/* 800DD950  A8 1F 30 10 */	lha r0, 0x3010(r31)                     
/* 800DD954  2C 00 00 00 */	cmpwi r0, 0                             
/* 800DD958  41 82 00 2C */	beq lbl_800DD984                         /* constant-address: 800DD984, symbol: lbl_800DD984 */
...
/* 800DD978  41 82 00 0C */	beq lbl_800DD984                         /* constant-address: 800DD984, symbol: lbl_800DD984 */
/* 800DD97C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800DD980  D0 1F 33 98 */	stfs f0, 0x3398(r31)                    
lbl_800DD984:
/* 800DD984  38 7F 33 98 */	addi r3, r31, 0x3398                    
/* 800DD988  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800DD98C  FC 40 F8 90 */	fmr f2, f31                             
/* 800DD990  48 19 2D B1 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
/* 800DD994  2C 03 00 00 */	cmpwi r3, 0                             
/* 800DD998  41 82 00 58 */	beq lbl_800DD9F0                         /* constant-address: 800DD9F0, symbol: lbl_800DD9F0 */
/* 800DD99C  38 7F 1F D0 */	addi r3, r31, 0x1fd0                    
/* 800DD9A0  48 08 0B 2D */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800DD9A4  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800DD9A8  41 82 00 48 */	beq lbl_800DD9F0                         /* constant-address: 800DD9F0, symbol: lbl_800DD9F0 */
/* 800DD9AC  38 00 00 00 */	li r0, 0                                
/* 800DD9B0  90 1F 08 44 */	stw r0, 0x844(r31)                      
/* 800DD9B4  7F E3 FB 78 */	mr r3, r31                              
/* 800DD9B8  4B FF EC C1 */	bl checkGuardActionChange__9daAlink_cFv  /* constant-address: 800DC678, symbol: checkGuardActionChange__9daAlink_cFv */
/* 800DD9BC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800DD9C0  40 82 00 10 */	bne lbl_800DD9D0                         /* constant-address: 800DD9D0, symbol: lbl_800DD9D0 */
...
/* 800DD9D8  40 82 00 0C */	bne lbl_800DD9E4                         /* constant-address: 800DD9E4, symbol: lbl_800DD9E4 */
/* 800DD9DC  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800DD9E0  D0 1F 1F 50 */	stfs f0, 0x1f50(r31)                    
lbl_800DD9E4:
/* 800DD9E4  7F E3 FB 78 */	mr r3, r31                              
/* 800DD9E8  38 80 00 00 */	li r4, 0                                
/* 800DD9EC  4B FD C6 E5 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
lbl_800DD9F0:

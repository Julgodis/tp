...
/* 800EEF5C  4B FD F9 45 */	bl setBodyAngleToCamera__9daAlink_cFv    /* constant-address: 800CE8A0, symbol: setBodyAngleToCamera__9daAlink_cFv */
/* 800EEF60  80 1E 27 EC */	lwz r0, 0x27ec(r30)                     
/* 800EEF64  28 00 00 00 */	cmplwi r0, 0                            
/* 800EEF68  41 82 00 0C */	beq lbl_800EEF74                         /* constant-address: 800EEF74, symbol: lbl_800EEF74 */
/* 800EEF6C  38 C0 27 10 */	li r6, 0x2710                           
/* 800EEF70  48 00 00 10 */	b lbl_800EEF80                           /* constant-address: 800EEF80, symbol: lbl_800EEF80 */
lbl_800EEF74:
/* 800EEF74  3C 80 80 39 */	lis r4, m__19daAlinkHIO_horse_c0@ha     
/* 800EEF78  38 84 E5 A4 */	addi r4, r4, m__19daAlinkHIO_horse_c0@l  /* constant-address: 8038E5A4, symbol: m__19daAlinkHIO_horse_c0 */
/* 800EEF7C  A8 C4 00 58 */	lha r6, 0x58(r4)                         /* constant-address: 8038E5FC, symbol: None */
lbl_800EEF80:
/* 800EEF80  3C 80 80 39 */	lis r4, m__19daAlinkHIO_horse_c0@ha     
/* 800EEF84  38 84 E5 A4 */	addi r4, r4, m__19daAlinkHIO_horse_c0@l  /* constant-address: 8038E5A4, symbol: m__19daAlinkHIO_horse_c0 */
/* 800EEF88  A8 04 00 5A */	lha r0, 0x5a(r4)                         /* constant-address: 8038E5FE, symbol: None */
/* 800EEF8C  A8 BE 05 9C */	lha r5, 0x59c(r30)                      
/* 800EEF90  7C 05 00 00 */	cmpw r5, r0                             
/* 800EEF94  40 80 00 08 */	bge lbl_800EEF9C                         /* constant-address: 800EEF9C, symbol: lbl_800EEF9C */
/* 800EEF98  48 00 00 1C */	b lbl_800EEFB4                           /* constant-address: 800EEFB4, symbol: lbl_800EEFB4 */
lbl_800EEF9C:
/* 800EEF9C  7C A4 07 34 */	extsh r4, r5                            
/* 800EEFA0  7C C0 07 34 */	extsh r0, r6                            
/* 800EEFA4  7C 04 00 00 */	cmpw r4, r0                             
/* 800EEFA8  40 81 00 08 */	ble lbl_800EEFB0                         /* constant-address: 800EEFB0, symbol: lbl_800EEFB0 */
...
/* 800EEFD0  41 82 00 34 */	beq lbl_800EF004                         /* constant-address: 800EF004, symbol: lbl_800EF004 */
/* 800EEFD4  2C 05 C0 00 */	cmpwi r5, -16384                        
/* 800EEFD8  40 80 00 0C */	bge lbl_800EEFE4                         /* constant-address: 800EEFE4, symbol: lbl_800EEFE4 */
/* 800EEFDC  38 00 C0 00 */	li r0, -16384                           
/* 800EEFE0  48 00 00 18 */	b lbl_800EEFF8                           /* constant-address: 800EEFF8, symbol: lbl_800EEFF8 */
lbl_800EEFE4:
/* 800EEFE4  7C A0 07 34 */	extsh r0, r5                            
/* 800EEFE8  2C 00 40 00 */	cmpwi r0, 0x4000                        
/* 800EEFEC  38 00 40 00 */	li r0, 0x4000                           
/* 800EEFF0  41 81 00 08 */	bgt lbl_800EEFF8                         /* constant-address: 800EEFF8, symbol: lbl_800EEFF8 */
/* 800EEFF4  7C A0 2B 78 */	mr r0, r5                               
lbl_800EEFF8:
/* 800EEFF8  7C 00 07 34 */	extsh r0, r0                            
/* 800EEFFC  90 1E 31 90 */	stw r0, 0x3190(r30)                     
/* 800EF000  48 00 00 08 */	b lbl_800EF008                           /* constant-address: 800EF008, symbol: lbl_800EF008 */
lbl_800EF004:
...
/* 800EF020  40 82 00 18 */	bne lbl_800EF038                         /* constant-address: 800EF038, symbol: lbl_800EF038 */

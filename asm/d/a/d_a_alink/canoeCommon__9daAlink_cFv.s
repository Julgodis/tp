...
/* 800F4800  40 82 00 10 */	bne lbl_800F4810                         /* constant-address: 800F4810, symbol: lbl_800F4810 */
/* 800F4804  38 80 00 00 */	li r4, 0                                
/* 800F4808  4B FC 58 C9 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800F480C  48 00 00 F8 */	b lbl_800F4904                           /* constant-address: 800F4904, symbol: lbl_800F4904 */
lbl_800F4810:
/* 800F4810  4B FF FD 8D */	bl setSyncCanoePos__9daAlink_cFv         /* constant-address: 800F459C, symbol: setSyncCanoePos__9daAlink_cFv */
/* 800F4814  80 7F 28 18 */	lwz r3, 0x2818(r31)                     
/* 800F4818  88 03 14 40 */	lbz r0, 0x1440(r3)                      
/* 800F481C  28 00 00 03 */	cmplwi r0, 3                            
/* 800F4820  40 82 00 E0 */	bne lbl_800F4900                         /* constant-address: 800F4900, symbol: lbl_800F4900 */
/* 800F4824  80 7F 1F 2C */	lwz r3, 0x1f2c(r31)                     
/* 800F4828  80 1F 1F 44 */	lwz r0, 0x1f44(r31)                     
/* 800F482C  7C 03 00 40 */	cmplw r3, r0                            
/* 800F4830  41 82 00 0C */	beq lbl_800F483C                         /* constant-address: 800F483C, symbol: lbl_800F483C */
/* 800F4834  C3 FF 20 24 */	lfs f31, 0x2024(r31)                    
/* 800F4838  48 00 00 08 */	b lbl_800F4840                           /* constant-address: 800F4840, symbol: lbl_800F4840 */
lbl_800F483C:
...
/* 800F484C  4B FB 7C 05 */	bl getMainBckData__9daAlink_cCFQ29daAlink_c11daAlink_ANM /* constant-address: 800AC450, symbol: getMainBckData__9daAlink_cCFQ29daAlink_c11daAlink_ANM */
/* 800F4850  A0 63 00 02 */	lhz r3, 2(r3)                           
/* 800F4854  57 C0 04 3E */	clrlwi r0, r30, 0x10                    
/* 800F4858  7C 00 18 40 */	cmplw r0, r3                            
/* 800F485C  41 82 00 24 */	beq lbl_800F4880                         /* constant-address: 800F4880, symbol: lbl_800F4880 */
/* 800F4860  A3 DF 1F 94 */	lhz r30, 0x1f94(r31)                    
/* 800F4864  7F E3 FB 78 */	mr r3, r31                              
/* 800F4868  38 80 00 DE */	li r4, 0xde                             
/* 800F486C  4B FB 7B E5 */	bl getMainBckData__9daAlink_cCFQ29daAlink_c11daAlink_ANM /* constant-address: 800AC450, symbol: getMainBckData__9daAlink_cCFQ29daAlink_c11daAlink_ANM */
/* 800F4870  A0 63 00 02 */	lhz r3, 2(r3)                           
/* 800F4874  57 C0 04 3E */	clrlwi r0, r30, 0x10                    
/* 800F4878  7C 00 18 40 */	cmplw r0, r3                            
/* 800F487C  40 82 00 10 */	bne lbl_800F488C                         /* constant-address: 800F488C, symbol: lbl_800F488C */
lbl_800F4880:
/* 800F4880  3C 60 00 02 */	lis r3, 0x0002 /* 0x00020022@ha */      
/* 800F4884  38 83 00 22 */	addi r4, r3, 0x0022 /* 0x00020022@l */   /* constant-address: 00020022 */
/* 800F4888  48 00 00 0C */	b lbl_800F4894                           /* constant-address: 800F4894, symbol: lbl_800F4894 */
lbl_800F488C:
/* 800F488C  3C 60 00 02 */	lis r3, 0x0002 /* 0x00020021@ha */      
/* 800F4890  38 83 00 21 */	addi r4, r3, 0x0021 /* 0x00020021@l */   /* constant-address: 00020021 */
lbl_800F4894:
/* 800F4894  FC 00 FA 10 */	fabs f0, f31                            
/* 800F4898  C0 42 94 B8 */	lfs f2, lit_17592(r2)                    /* constant-address: 80452EB8, symbol: lit_17592 */
/* 800F489C  3C 60 80 39 */	lis r3, m__19daAlinkHIO_canoe_c0@ha     
/* 800F48A0  38 63 E6 10 */	addi r3, r3, m__19daAlinkHIO_canoe_c0@l  /* constant-address: 8038E610, symbol: m__19daAlinkHIO_canoe_c0 */
/* 800F48A4  C0 63 00 18 */	lfs f3, 0x18(r3)                         /* constant-address: 8038E628, symbol: None */
/* 800F48A8  FC 00 00 18 */	frsp f0, f0                             
/* 800F48AC  EC 20 18 28 */	fsubs f1, f0, f3                        
/* 800F48B0  C0 03 00 30 */	lfs f0, 0x30(r3)                         /* constant-address: 8038E640, symbol: None */
...
/* 800F48D0  40 80 00 0C */	bge lbl_800F48DC                         /* constant-address: 800F48DC, symbol: lbl_800F48DC */
/* 800F48D4  38 A0 00 00 */	li r5, 0                                
/* 800F48D8  48 00 00 14 */	b lbl_800F48EC                           /* constant-address: 800F48EC, symbol: lbl_800F48EC */
lbl_800F48DC:
/* 800F48DC  2C 00 00 7F */	cmpwi r0, 0x7f                          
/* 800F48E0  38 A0 00 7F */	li r5, 0x7f                             
/* 800F48E4  41 81 00 08 */	bgt lbl_800F48EC                         /* constant-address: 800F48EC, symbol: lbl_800F48EC */
...
/* 800F48FC  48 1C FD F5 */	bl startLinkSwordSound__14Z2CreatureLinkF10JAISoundIDUlSc /* constant-address: 802C46F0, symbol: startLinkSwordSound__14Z2CreatureLinkF10JAISoundIDUlSc */
lbl_800F4900:

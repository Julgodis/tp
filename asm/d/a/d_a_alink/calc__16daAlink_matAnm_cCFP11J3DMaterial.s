...
/* 8009D91C  48 2C 48 BD */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8009D920  7C 7E 1B 78 */	mr r30, r3                              
/* 8009D924  7C 9F 23 78 */	mr r31, r4                              
/* 8009D928  48 28 EA 9D */	bl calc__14J3DMaterialAnmCFP11J3DMaterial /* constant-address: 8032C3C4, symbol: calc__14J3DMaterialAnmCFP11J3DMaterial */
/* 8009D92C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8009D930  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8009D934  80 63 5D B4 */	lwz r3, 0x5db4(r3)                       /* constant-address: 8040BF74, symbol: None */
/* 8009D938  80 03 05 78 */	lwz r0, 0x578(r3)                       
/* 8009D93C  54 00 02 53 */	rlwinm. r0, r0, 0, 9, 9                 
/* 8009D940  40 82 01 08 */	bne lbl_8009DA48                         /* constant-address: 8009DA48, symbol: lbl_8009DA48 */
...
/* 8009D95C  41 82 00 DC */	beq lbl_8009DA38                         /* constant-address: 8009DA38, symbol: lbl_8009DA38 */
...
/* 8009D978  88 8D 8A 49 */	lbz r4, struct_80450FC8+0x1(r13)         /* constant-address: 80450FC9, symbol: struct_80450FC8+0x1 */
/* 8009D97C  28 04 00 00 */	cmplwi r4, 0                            
/* 8009D980  41 82 00 8C */	beq lbl_8009DA0C                         /* constant-address: 8009DA0C, symbol: lbl_8009DA0C */
/* 8009D984  80 1E 01 04 */	lwz r0, 0x104(r30)                      
/* 8009D988  2C 00 00 00 */	cmpwi r0, 0                             
/* 8009D98C  40 82 00 6C */	bne lbl_8009D9F8                         /* constant-address: 8009D9F8, symbol: lbl_8009D9F8 */
/* 8009D990  C0 42 92 B8 */	lfs f2, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8009D994  38 04 00 01 */	addi r0, r4, 1                          
/* 8009D998  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 8009D9F4  48 00 00 34 */	b lbl_8009DA28                           /* constant-address: 8009DA28, symbol: lbl_8009DA28 */
lbl_8009D9F8:
...
/* 8009DA08  48 00 00 20 */	b lbl_8009DA28                           /* constant-address: 8009DA28, symbol: lbl_8009DA28 */
lbl_8009DA0C:
/* 8009DA0C  88 0D 8A 48 */	lbz r0, struct_80450FC8+0x0(r13)         /* constant-address: 80450FC8, symbol: struct_80450FC8+0x0 */
/* 8009DA10  28 00 00 00 */	cmplwi r0, 0                            
/* 8009DA14  41 82 00 14 */	beq lbl_8009DA28                         /* constant-address: 8009DA28, symbol: lbl_8009DA28 */
...
/* 8009DA44  41 80 FF 08 */	blt lbl_8009D94C                         /* constant-address: 8009D94C, symbol: lbl_8009D94C */
lbl_8009DA48:
/* 8009DA48  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8009DA4C  48 2C 47 D9 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

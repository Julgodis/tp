...
/* 800D7504  48 28 AC D9 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 800D7520  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D7524  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800D7528  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 800D752C  38 61 00 08 */	addi r3, r1, 8                          
/* 800D7530  48 26 FC 09 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 800D7534  80 1D 05 84 */	lwz r0, 0x584(r29)                      
/* 800D7538  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 800D753C  41 82 00 54 */	beq lbl_800D7590                         /* constant-address: 800D7590, symbol: lbl_800D7590 */
/* 800D7540  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800D7544  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800D755C  C0 42 93 9C */	lfs f2, lit_9053(r2)                     /* constant-address: 80452D9C, symbol: lit_9053 */
/* 800D7560  EC 22 00 32 */	fmuls f1, f2, f0                        
/* 800D7564  D0 21 00 2C */	stfs f1, 0x2c(r1)                       
/* 800D7568  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800D758C  48 00 01 10 */	b lbl_800D769C                           /* constant-address: 800D769C, symbol: lbl_800D769C */
lbl_800D7590:
/* 800D7590  C0 02 93 A0 */	lfs f0, lit_9054(r2)                     /* constant-address: 80452DA0, symbol: lit_9054 */
/* 800D7594  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D7598  40 80 01 04 */	bge lbl_800D769C                         /* constant-address: 800D769C, symbol: lbl_800D769C */
/* 800D759C  38 7E 00 9C */	addi r3, r30, 0x9c                      
/* 800D75A0  4B FA C0 E9 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv     /* constant-address: 80083688, symbol: GetAc__22dCcD_GAtTgCoCommonBaseFv */
/* 800D75A4  28 03 00 00 */	cmplwi r3, 0                            
/* 800D75A8  41 82 00 3C */	beq lbl_800D75E4                         /* constant-address: 800D75E4, symbol: lbl_800D75E4 */
/* 800D75AC  38 7E 00 9C */	addi r3, r30, 0x9c                      
/* 800D75B0  4B FA C0 D9 */	bl GetAc__22dCcD_GAtTgCoCommonBaseFv     /* constant-address: 80083688, symbol: GetAc__22dCcD_GAtTgCoCommonBaseFv */
...
/* 800D75C4  48 18 F5 71 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800D75E0  48 00 00 2C */	b lbl_800D760C                           /* constant-address: 800D760C, symbol: lbl_800D760C */
lbl_800D75E4:
/* 800D75E4  38 61 00 14 */	addi r3, r1, 0x14                       
/* 800D75E8  38 9D 04 D0 */	addi r4, r29, 0x4d0                     
/* 800D75EC  38 BE 00 D4 */	addi r5, r30, 0xd4                      
/* 800D75F0  48 18 F5 45 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800D7610  48 26 FB 29 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 800D7614  C0 02 93 A0 */	lfs f0, lit_9054(r2)                     /* constant-address: 80452DA0, symbol: lit_9054 */
/* 800D7618  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D761C  40 80 00 40 */	bge lbl_800D765C                         /* constant-address: 800D765C, symbol: lbl_800D765C */
...
/* 800D762C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800D7630  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 800D7634  C0 22 93 9C */	lfs f1, lit_9053(r2)                     /* constant-address: 80452D9C, symbol: lit_9053 */
/* 800D7638  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 800D763C  D0 01 00 2C */	stfs f0, 0x2c(r1)                       
/* 800D7640  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800D7658  48 00 00 2C */	b lbl_800D7684                           /* constant-address: 800D7684, symbol: lbl_800D7684 */
lbl_800D765C:
/* 800D765C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D7660  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D7664  40 81 00 0C */	ble lbl_800D7670                         /* constant-address: 800D7670, symbol: lbl_800D7670 */
...
/* 800D7678  C0 02 93 30 */	lfs f0, lit_7625(r2)                     /* constant-address: 80452D30, symbol: lit_7625 */
/* 800D767C  EC 20 08 24 */	fdivs f1, f0, f1                        
/* 800D7680  48 26 FA 59 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
lbl_800D7684:
...
/* 800D76A4  48 00 AD D9 */	bl multVecMagneBootInvMtx__9daAlink_cFP4cXyz /* constant-address: 800E247C, symbol: multVecMagneBootInvMtx__9daAlink_cFP4cXyz */
/* 800D76A8  7F E3 FB 78 */	mr r3, r31                              
/* 800D76AC  39 61 00 50 */	addi r11, r1, 0x50                      
/* 800D76B0  48 28 AB 79 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

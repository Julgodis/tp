...
/* 800AC620  48 2B 5B A9 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 800AC638  4B FF FE 19 */	bl getMainBckData__9daAlink_cCFQ29daAlink_c11daAlink_ANM /* constant-address: 800AC450, symbol: getMainBckData__9daAlink_cCFQ29daAlink_c11daAlink_ANM */
...
/* 800AC664  4B FF 76 A9 */	bl getAnimeResource__9daAlink_cFP14daPy_anmHeap_cUsUl /* constant-address: 800A3D0C, symbol: getAnimeResource__9daAlink_cFP14daPy_anmHeap_cUsUl */
/* 800AC668  90 7F 00 00 */	stw r3, 0(r31)                          
/* 800AC66C  80 1F 00 00 */	lwz r0, 0(r31)                          
/* 800AC670  28 00 00 00 */	cmplwi r0, 0                            
/* 800AC674  41 82 00 0C */	beq lbl_800AC680                         /* constant-address: 800AC680, symbol: lbl_800AC680 */
/* 800AC678  3B E0 00 01 */	li r31, 1                               
/* 800AC67C  48 00 00 18 */	b lbl_800AC694                           /* constant-address: 800AC694, symbol: lbl_800AC694 */
lbl_800AC680:
...
/* 800AC6A0  41 82 00 54 */	beq lbl_800AC6F4                         /* constant-address: 800AC6F4, symbol: lbl_800AC6F4 */
/* 800AC6A4  3C 18 FF FF */	addis r0, r24, 0xffff                   
/* 800AC6A8  28 00 08 00 */	cmplwi r0, 0x800                        
/* 800AC6AC  40 82 00 0C */	bne lbl_800AC6B8                         /* constant-address: 800AC6B8, symbol: lbl_800AC6B8 */
...
/* 800AC6C4  4B FF 76 49 */	bl getAnimeResource__9daAlink_cFP14daPy_anmHeap_cUsUl /* constant-address: 800A3D0C, symbol: getAnimeResource__9daAlink_cFP14daPy_anmHeap_cUsUl */
/* 800AC6C8  90 7D 00 00 */	stw r3, 0(r29)                          
/* 800AC6CC  80 1D 00 00 */	lwz r0, 0(r29)                          
/* 800AC6D0  28 00 00 00 */	cmplwi r0, 0                            
/* 800AC6D4  41 82 00 0C */	beq lbl_800AC6E0                         /* constant-address: 800AC6E0, symbol: lbl_800AC6E0 */
/* 800AC6D8  63 FF 00 01 */	ori r31, r31, 1                          /* constant-address: 00000001 */
/* 800AC6DC  48 00 00 40 */	b lbl_800AC71C                           /* constant-address: 800AC71C, symbol: lbl_800AC71C */
lbl_800AC6E0:
...
/* 800AC6F0  48 00 00 2C */	b lbl_800AC71C                           /* constant-address: 800AC71C, symbol: lbl_800AC71C */
lbl_800AC6F4:
/* 800AC6F4  7C 9C CA 14 */	add r4, r28, r25                        
/* 800AC6F8  A0 04 1F 94 */	lhz r0, 0x1f94(r4)                      
/* 800AC6FC  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 800AC700  41 82 00 08 */	beq lbl_800AC708                         /* constant-address: 800AC708, symbol: lbl_800AC708 */
/* 800AC704  63 FF 00 01 */	ori r31, r31, 1                          /* constant-address: 00000001 */
lbl_800AC708:
/* 800AC708  38 00 00 00 */	li r0, 0                                
/* 800AC70C  90 1D 00 00 */	stw r0, 0(r29)                          
/* 800AC710  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 800AC714  38 03 FF FF */	addi r0, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 800AC718  B0 04 1F 94 */	sth r0, 0x1f94(r4)                      
lbl_800AC71C:
/* 800AC71C  7F E3 FB 78 */	mr r3, r31                              
/* 800AC720  39 61 00 30 */	addi r11, r1, 0x30                      
/* 800AC724  48 2B 5A F1 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

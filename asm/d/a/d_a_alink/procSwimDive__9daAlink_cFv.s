...
/* 80104AC4  40 82 00 10 */	bne lbl_80104AD4                         /* constant-address: 80104AD4, symbol: lbl_80104AD4 */
/* 80104AC8  38 80 00 4C */	li r4, 0x4c                             
/* 80104ACC  4B FA E7 85 */	bl setDoStatus__9daAlink_cFUc            /* constant-address: 800B3250, symbol: setDoStatus__9daAlink_cFUc */
/* 80104AD0  48 00 00 3C */	b lbl_80104B0C                           /* constant-address: 80104B0C, symbol: lbl_80104B0C */
lbl_80104AD4:
/* 80104AD4  80 1F 05 70 */	lwz r0, 0x570(r31)                      
/* 80104AD8  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17           
/* 80104ADC  41 82 00 30 */	beq lbl_80104B0C                         /* constant-address: 80104B0C, symbol: lbl_80104B0C */
/* 80104AE0  C0 3E 00 10 */	lfs f1, 0x10(r30)                       
/* 80104AE4  C0 02 93 78 */	lfs f0, lit_8676(r2)                     /* constant-address: 80452D78, symbol: lit_8676 */
/* 80104AE8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80104AEC  40 81 00 20 */	ble lbl_80104B0C                         /* constant-address: 80104B0C, symbol: lbl_80104B0C */
...
/* 80104B20  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80104B24  3C 80 80 39 */	lis r4, m__18daAlinkHIO_swim_c0@ha      
/* 80104B28  38 84 ED 2C */	addi r4, r4, m__18daAlinkHIO_swim_c0@l   /* constant-address: 8038ED2C, symbol: m__18daAlinkHIO_swim_c0 */
/* 80104B2C  C0 44 00 80 */	lfs f2, 0x80(r4)                         /* constant-address: 8038EDAC, symbol: None */
/* 80104B30  4B FA ED F5 */	bl setNormalSpeedF__9daAlink_cFff        /* constant-address: 800B3924, symbol: setNormalSpeedF__9daAlink_cFff */
...
/* 80104B48  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 80104B4C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80104B50  40 81 00 08 */	ble lbl_80104B58                         /* constant-address: 80104B58, symbol: lbl_80104B58 */
/* 80104B54  D0 1F 34 78 */	stfs f0, 0x3478(r31)                    
lbl_80104B58:
/* 80104B58  7F C3 F3 78 */	mr r3, r30                              
/* 80104B5C  C0 22 94 64 */	lfs f1, lit_14954(r2)                    /* constant-address: 80452E64, symbol: lit_14954 */
/* 80104B60  48 22 38 CD */	bl checkPass__12J3DFrameCtrlFf           /* constant-address: 8032842C, symbol: checkPass__12J3DFrameCtrlFf */
/* 80104B64  2C 03 00 00 */	cmpwi r3, 0                             
/* 80104B68  41 82 00 38 */	beq lbl_80104BA0                         /* constant-address: 80104BA0, symbol: lbl_80104BA0 */
/* 80104B6C  A8 1F 30 0C */	lha r0, 0x300c(r31)                     
/* 80104B70  2C 00 00 00 */	cmpwi r0, 0                             
/* 80104B74  41 82 00 2C */	beq lbl_80104BA0                         /* constant-address: 80104BA0, symbol: lbl_80104BA0 */
...
/* 80104B94  C0 22 93 A8 */	lfs f1, lit_9652(r2)                     /* constant-address: 80452DA8, symbol: lit_9652 */
/* 80104B98  38 80 00 00 */	li r4, 0                                
/* 80104B9C  4B F1 AC E1 */	bl fopKyM_createWpillar__FPC4cXyzfi      /* constant-address: 8001F87C, symbol: fopKyM_createWpillar__FPC4cXyzfi */
lbl_80104BA0:
/* 80104BA0  C0 7F 1A 08 */	lfs f3, 0x1a08(r31)                     
/* 80104BA4  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)                      
/* 80104BA8  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 80104BBC  40 81 00 0C */	ble lbl_80104BC8                         /* constant-address: 80104BC8, symbol: lbl_80104BC8 */
/* 80104BC0  EC 01 18 2A */	fadds f0, f1, f3                        
/* 80104BC4  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)                     
lbl_80104BC8:
/* 80104BC8  7F C3 F3 78 */	mr r3, r30                              
/* 80104BCC  48 05 99 01 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 80104BD0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80104BD4  41 82 00 60 */	beq lbl_80104C34                         /* constant-address: 80104C34, symbol: lbl_80104C34 */
/* 80104BD8  3C 60 80 39 */	lis r3, m__18daAlinkHIO_swim_c0@ha      
/* 80104BDC  38 63 ED 2C */	addi r3, r3, m__18daAlinkHIO_swim_c0@l   /* constant-address: 8038ED2C, symbol: m__18daAlinkHIO_swim_c0 */
/* 80104BE0  C0 03 00 84 */	lfs f0, 0x84(r3)                         /* constant-address: 8038EDB0, symbol: None */
/* 80104BE4  D0 1F 04 FC */	stfs f0, 0x4fc(r31)                     
/* 80104BE8  A8 1F 30 0C */	lha r0, 0x300c(r31)                     
/* 80104BEC  2C 00 00 00 */	cmpwi r0, 0                             
/* 80104BF0  41 82 00 1C */	beq lbl_80104C0C                         /* constant-address: 80104C0C, symbol: lbl_80104C0C */
...
/* 80104C24  4B FA 8F 55 */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
/* 80104C28  7F E3 FB 78 */	mr r3, r31                              
/* 80104C2C  4B FF FA 45 */	bl procSwimMoveInit__9daAlink_cFv        /* constant-address: 80104670, symbol: procSwimMoveInit__9daAlink_cFv */
/* 80104C30  48 00 00 08 */	b lbl_80104C38                           /* constant-address: 80104C38, symbol: lbl_80104C38 */
lbl_80104C34:

...
/* 8013B838 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 8013B83C 00000004  40 82 00 98 */	bne lbl_8013B8D4
/* 8013B840 00000008  83 FE 28 10 */	lwz r31, 0x2810(r30)
/* 8013B844 0000000C  28 1F 00 00 */	cmplwi r31, 0
/* 8013B848 00000010  41 82 00 80 */	beq lbl_8013B8C8
/* 8013B84C 00000014  A0 1F 05 8E */	lhz r0, 0x58e(r31)
/* 8013B850 00000018  54 00 07 FF */	clrlwi. r0, r0, 0x1f
/* 8013B854 0000001C  41 82 00 74 */	beq lbl_8013B8C8
/* 8013B858 00000020  C0 5E 05 40 */	lfs f2, 0x540(r30)
/* 8013B85C 00000024  C0 1E 05 38 */	lfs f0, 0x538(r30)
/* 8013B860 00000028  D0 01 00 08 */	stfs f0, 8(r1)
/* 8013B864 0000002C  D0 21 00 0C */	stfs f1, 0xc(r1)
/* 8013B868 00000030  D0 41 00 10 */	stfs f2, 0x10(r1)
/* 8013B86C 00000034  C0 5F 05 70 */	lfs f2, 0x570(r31)
/* 8013B870 00000038  C0 1F 05 68 */	lfs f0, 0x568(r31)
/* 8013B874 0000003C  D0 01 00 14 */	stfs f0, 0x14(r1)
/* 8013B878 00000040  D0 21 00 18 */	stfs f1, 0x18(r1)
/* 8013B87C 00000044  D0 41 00 1C */	stfs f2, 0x1c(r1)
/* 8013B880 00000048  38 61 00 08 */	addi r3, r1, 8
/* 8013B884 0000004C  38 81 00 14 */	addi r4, r1, 0x14
/* 8013B888 00000050  48 20 BB 15 */	bl PSVECSquareDistance
/* 8013B88C 00000054  C0 02 93 5C */	lfs f0, lit_8322(r2)
/* 8013B890 00000088  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8013B894 00000000  40 80 00 34 */	bge lbl_8013B8C8
/* 8013B898 00000004  C0 3F 04 D4 */	lfs f1, 0x4d4(r31)
/* 8013B89C 00000008  C0 1E 04 D4 */	lfs f0, 0x4d4(r30)
/* 8013B8A0 0000000C  EC 01 00 28 */	fsubs f0, f1, f0
/* 8013B8A4 00000010  FC 00 02 10 */	fabs f0, f0
/* 8013B8A8 00000014  FC 20 00 18 */	frsp f1, f0
/* 8013B8AC 00000018  C0 02 93 00 */	lfs f0, lit_6895(r2)
/* 8013B8B0 000000A8  FC 01 00 40 */	fcmpo cr0, f1, f0
/* 8013B8B4 00000000  40 80 00 14 */	bge lbl_8013B8C8
/* 8013B8B8 00000004  7F C3 F3 78 */	mr r3, r30
/* 8013B8BC 00000008  7F E4 FB 78 */	mr r4, r31
/* 8013B8C0 0000000C  48 00 00 A5 */	bl procWolfDownAtLandInit__9daAlink_cFP13fopEn_enemy_c
/* 8013B8C4 00000010  48 00 00 84 */	b lbl_8013B948
lbl_8013B8C8:

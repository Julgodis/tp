...
/* 8012FC48  48 23 25 95 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8012FC5C  4B F9 23 11 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
...
/* 8012FC78  38 A5 F3 F0 */	addi r5, r5, m__21daAlinkHIO_wlSlide_c0@l /* constant-address: 8038F3F0, symbol: m__21daAlinkHIO_wlSlide_c0 */
/* 8012FC7C  4B FF 9B CD */	bl setSingleAnimeWolfParam__9daAlink_cFQ29daAlink_c12daAlink_WANMPC16daAlinkHIO_anm_c /* constant-address: 80129848, symbol: setSingleAnimeWolfParam__9daAlink_cFQ29daAlink_c12daAlink_WANMPC16daAlinkHIO_anm_c */
/* 8012FC80  7F A3 EB 78 */	mr r3, r29                              
/* 8012FC84  3C 80 00 01 */	lis r4, 0x0001 /* 0x000100B0@ha */      
/* 8012FC88  38 84 00 B0 */	addi r4, r4, 0x00B0 /* 0x000100B0@l */   /* constant-address: 000100B0 */
...
/* 8012FC9C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8012FCA0  D0 1D 33 98 */	stfs f0, 0x3398(r29)                    
/* 8012FCA4  3C 60 80 39 */	lis r3, m__21daAlinkHIO_wlSlide_c0@ha   
/* 8012FCA8  38 63 F3 F0 */	addi r3, r3, m__21daAlinkHIO_wlSlide_c0@l /* constant-address: 8038F3F0, symbol: m__21daAlinkHIO_wlSlide_c0 */
/* 8012FCAC  C0 03 00 54 */	lfs f0, 0x54(r3)                         /* constant-address: 8038F444, symbol: None */
/* 8012FCB0  D0 1D 05 94 */	stfs f0, 0x594(r29)                     
/* 8012FCB4  3C 60 80 42 */	lis r3, l_wolfBaseAnime@ha              
/* 8012FCB8  C4 03 56 1C */	lfsu f0, l_wolfBaseAnime@l(r3)           /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8012FCBC  D0 1D 35 88 */	stfs f0, 0x3588(r29)                    
/* 8012FCC0  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425620, symbol: None */
/* 8012FCC4  D0 1D 35 8C */	stfs f0, 0x358c(r29)                    
/* 8012FCC8  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */
/* 8012FCCC  D0 1D 35 90 */	stfs f0, 0x3590(r29)                    
/* 8012FCD0  C0 42 92 B8 */	lfs f2, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8012FCD4  A8 1D 1F D8 */	lha r0, 0x1fd8(r29)                     
/* 8012FCD8  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 8012FD18  48 23 25 11 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

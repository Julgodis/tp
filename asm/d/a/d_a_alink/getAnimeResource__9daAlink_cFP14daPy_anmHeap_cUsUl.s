...
/* 800A3D2C  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 800A3D30  B0 01 00 0A */	sth r0, 0xa(r1)                         
/* 800A3D34  38 81 00 0A */	addi r4, r1, 0xa                        
/* 800A3D38  38 A1 00 08 */	addi r5, r1, 8                          
/* 800A3D3C  4B FF FF A9 */	bl setIdxMask__9daAlink_cFPUsPUs         /* constant-address: 800A3CE4, symbol: setIdxMask__9daAlink_cFPUsPUs */
/* 800A3D40  A0 A1 00 0A */	lhz r5, 0xa(r1)                         
/* 800A3D44  28 05 FF FF */	cmplwi r5, 0xffff                       
/* 800A3D48  40 82 00 14 */	bne lbl_800A3D5C                         /* constant-address: 800A3D5C, symbol: lbl_800A3D5C */
/* 800A3D4C  7F E3 FB 78 */	mr r3, r31                              
/* 800A3D50  A0 81 00 08 */	lhz r4, 8(r1)                           
/* 800A3D54  48 0B B3 15 */	bl loadDataIdx__14daPy_anmHeap_cFUs      /* constant-address: 8015F068, symbol: loadDataIdx__14daPy_anmHeap_cFUs */
/* 800A3D58  48 00 00 10 */	b lbl_800A3D68                           /* constant-address: 800A3D68, symbol: lbl_800A3D68 */
lbl_800A3D5C:
/* 800A3D5C  7F E3 FB 78 */	mr r3, r31                              
/* 800A3D60  A0 81 00 08 */	lhz r4, 8(r1)                           
/* 800A3D64  48 0B B3 B5 */	bl loadDataDemoRID__14daPy_anmHeap_cFUsUs /* constant-address: 8015F118, symbol: loadDataDemoRID__14daPy_anmHeap_cFUsUs */
lbl_800A3D68:

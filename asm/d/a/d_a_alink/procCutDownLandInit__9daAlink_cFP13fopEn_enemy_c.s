...
/* 800D58C0  4B FE C6 AD */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800D58C4  7F E3 FB 78 */	mr r3, r31                              
/* 800D58C8  48 00 17 19 */	bl checkCutLandDamage__9daAlink_cFv      /* constant-address: 800D6FE0, symbol: checkCutLandDamage__9daAlink_cFv */
/* 800D58CC  7F E3 FB 78 */	mr r3, r31                              
/* 800D58D0  38 80 00 7A */	li r4, 0x7a                             
/* 800D58D4  3C A0 80 39 */	lis r5, m__21daAlinkHIO_cutDown_c0@ha   
/* 800D58D8  38 A5 DD 44 */	addi r5, r5, m__21daAlinkHIO_cutDown_c0@l /* constant-address: 8038DD44, symbol: m__21daAlinkHIO_cutDown_c0 */
/* 800D58DC  38 A5 00 28 */	addi r5, r5, 0x28                        /* constant-address: 8038DD6C, symbol: None */
/* 800D58E0  4B FD 78 15 */	bl setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c /* constant-address: 800AD0F4, symbol: setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c */
/* 800D58E4  80 1F 06 14 */	lwz r0, 0x614(r31)                      
/* 800D58E8  28 00 00 51 */	cmplwi r0, 0x51                         
/* 800D58EC  41 82 00 7C */	beq lbl_800D5968                         /* constant-address: 800D5968, symbol: lbl_800D5968 */
/* 800D58F0  28 1E 00 00 */	cmplwi r30, 0                           
/* 800D58F4  41 82 01 14 */	beq lbl_800D5A08                         /* constant-address: 800D5A08, symbol: lbl_800D5A08 */
/* 800D58F8  A0 1E 05 8E */	lhz r0, 0x58e(r30)                      
/* 800D58FC  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 800D5900  41 82 01 08 */	beq lbl_800D5A08                         /* constant-address: 800D5A08, symbol: lbl_800D5A08 */
/* 800D5904  C0 5F 05 C4 */	lfs f2, 0x5c4(r31)                      
/* 800D5908  C0 1F 05 BC */	lfs f0, 0x5bc(r31)                      
/* 800D590C  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 800D5910  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800D5938  48 27 1A 65 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 800D593C  C0 02 93 5C */	lfs f0, lit_8322(r2)                     /* constant-address: 80452D5C, symbol: lit_8322 */
/* 800D5940  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D5944  40 80 00 C4 */	bge lbl_800D5A08                         /* constant-address: 800D5A08, symbol: lbl_800D5A08 */
...
/* 800D595C  C0 02 93 50 */	lfs f0, lit_8247(r2)                     /* constant-address: 80452D50, symbol: lit_8247 */
/* 800D5960  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D5964  40 80 00 A4 */	bge lbl_800D5A08                         /* constant-address: 800D5A08, symbol: lbl_800D5A08 */
lbl_800D5968:
/* 800D5968  38 00 00 01 */	li r0, 1                                
/* 800D596C  B0 1F 30 0E */	sth r0, 0x300e(r31)                     
/* 800D5970  28 1E 00 00 */	cmplwi r30, 0                           
/* 800D5974  41 82 00 4C */	beq lbl_800D59C0                         /* constant-address: 800D59C0, symbol: lbl_800D59C0 */
...
/* 800D5994  48 19 1A 61 */	bl __ct__5csXyzFsss                      /* constant-address: 802673F4, symbol: __ct__5csXyzFsss */
/* 800D5998  38 DE 05 68 */	addi r6, r30, 0x568                     
/* 800D599C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800D59A0  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D59A4  80 63 5D 3C */	lwz r3, 0x5d3c(r3)                       /* constant-address: 8040BEFC, symbol: None */
...
/* 800D59BC  4B F7 68 5D */	bl setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl /* constant-address: 8004C218, symbol: setHitMark__13dPa_control_cFUsP10fopAc_ac_cPC4cXyzPC5csXyzPC4cXyzUl */
lbl_800D59C0:
/* 800D59C0  3B C0 00 20 */	li r30, 0x20                            
/* 800D59C4  3C 60 80 39 */	lis r3, m__21daAlinkHIO_cutDown_c0@ha   
/* 800D59C8  38 63 DD 44 */	addi r3, r3, m__21daAlinkHIO_cutDown_c0@l /* constant-address: 8038DD44, symbol: m__21daAlinkHIO_cutDown_c0 */
/* 800D59CC  A8 03 00 64 */	lha r0, 0x64(r3)                         /* constant-address: 8038DDA8, symbol: None */
/* 800D59D0  B0 1F 30 08 */	sth r0, 0x3008(r31)                     
/* 800D59D4  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D59D8  D0 21 00 28 */	stfs f1, 0x28(r1)                       
/* 800D59DC  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800D59EC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D59F0  38 63 5B D4 */	addi r3, r3, 0x5bd4                      /* constant-address: 8040BD94, symbol: None */
/* 800D59F4  38 80 00 04 */	li r4, 4                                
/* 800D59F8  38 A0 00 1F */	li r5, 0x1f                             
/* 800D59FC  38 C1 00 28 */	addi r6, r1, 0x28                       
/* 800D5A00  4B F9 A0 25 */	bl StartShock__12dVibration_cFii4cXyz    /* constant-address: 8006FA24, symbol: StartShock__12dVibration_cFii4cXyz */
/* 800D5A04  48 00 00 20 */	b lbl_800D5A24                           /* constant-address: 800D5A24, symbol: lbl_800D5A24 */
lbl_800D5A08:
...
/* 800D5A18  38 63 DD 44 */	addi r3, r3, m__21daAlinkHIO_cutDown_c0@l /* constant-address: 8038DD44, symbol: m__21daAlinkHIO_cutDown_c0 */
/* 800D5A1C  A8 03 00 66 */	lha r0, 0x66(r3)                         /* constant-address: 8038DDAA, symbol: None */
...
/* 800D5A2C  38 84 00 01 */	addi r4, r4, 0x0001 /* 0x00040001@l */   /* constant-address: 00040001 */
...
/* 800D5A4C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800D5A70  48 04 B7 51 */	bl setFootEffectProcType__9daAlink_cFi   /* constant-address: 801211C0, symbol: setFootEffectProcType__9daAlink_cFi */
...
/* 800D5A8C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D5A90  80 03 5F 1C */	lwz r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */
/* 800D5A94  64 00 00 40 */	oris r0, r0, 0x40                       
/* 800D5A98  90 03 5F 1C */	stw r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */
/* 800D5A9C  3C 60 80 42 */	lis r3, l_halfAtnWaitBaseAnime@ha       
/* 800D5AA0  C4 03 55 44 */	lfsu f0, l_halfAtnWaitBaseAnime@l(r3)    /* constant-address: 80425544, symbol: l_halfAtnWaitBaseAnime */
/* 800D5AA4  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 800D5AA8  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425548, symbol: None */
/* 800D5AAC  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 800D5AB0  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042554C, symbol: None */

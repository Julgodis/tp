...
/* 800AD73C  48 2B 4A A1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 800AD75C  41 82 00 10 */	beq lbl_800AD76C                         /* constant-address: 800AD76C, symbol: lbl_800AD76C */
/* 800AD760  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD764  28 00 02 A0 */	cmplwi r0, 0x2a0                        
/* 800AD768  40 82 00 08 */	bne lbl_800AD770                         /* constant-address: 800AD770, symbol: lbl_800AD770 */
lbl_800AD76C:
/* 800AD76C  38 60 00 01 */	li r3, 1                                
lbl_800AD770:
/* 800AD770  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD774  41 82 00 18 */	beq lbl_800AD78C                         /* constant-address: 800AD78C, symbol: lbl_800AD78C */
/* 800AD778  38 00 00 00 */	li r0, 0                                
/* 800AD77C  98 1D 2F A3 */	stb r0, 0x2fa3(r29)                     
/* 800AD780  38 7D 28 44 */	addi r3, r29, 0x2844                    
/* 800AD784  48 0B 15 79 */	bl clearData__16daPy_actorKeep_cFv       /* constant-address: 8015ECFC, symbol: clearData__16daPy_actorKeep_cFv */
/* 800AD788  48 00 00 4C */	b lbl_800AD7D4                           /* constant-address: 800AD7D4, symbol: lbl_800AD7D4 */
lbl_800AD78C:
/* 800AD78C  80 1D 31 A0 */	lwz r0, 0x31a0(r29)                     
/* 800AD790  54 00 02 D7 */	rlwinm. r0, r0, 0, 0xb, 0xb             
/* 800AD794  40 82 00 40 */	bne lbl_800AD7D4                         /* constant-address: 800AD7D4, symbol: lbl_800AD7D4 */
/* 800AD798  7F A3 EB 78 */	mr r3, r29                              
/* 800AD79C  48 03 64 D1 */	bl checkGrabAnime__9daAlink_cCFv         /* constant-address: 800E3C6C, symbol: checkGrabAnime__9daAlink_cCFv */
/* 800AD7A0  2C 03 00 00 */	cmpwi r3, 0                             
/* 800AD7A4  40 82 00 2C */	bne lbl_800AD7D0                         /* constant-address: 800AD7D0, symbol: lbl_800AD7D0 */
/* 800AD7A8  38 60 00 00 */	li r3, 0                                
/* 800AD7AC  A0 1D 1F BC */	lhz r0, 0x1fbc(r29)                     
/* 800AD7B0  28 00 02 DA */	cmplwi r0, 0x2da                        
/* 800AD7B4  41 82 00 10 */	beq lbl_800AD7C4                         /* constant-address: 800AD7C4, symbol: lbl_800AD7C4 */
/* 800AD7B8  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD7BC  28 00 02 DB */	cmplwi r0, 0x2db                        
/* 800AD7C0  40 82 00 08 */	bne lbl_800AD7C8                         /* constant-address: 800AD7C8, symbol: lbl_800AD7C8 */
lbl_800AD7C4:
/* 800AD7C4  38 60 00 01 */	li r3, 1                                
lbl_800AD7C8:
/* 800AD7C8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD7CC  41 82 00 08 */	beq lbl_800AD7D4                         /* constant-address: 800AD7D4, symbol: lbl_800AD7D4 */
lbl_800AD7D0:
/* 800AD7D0  3B E0 00 01 */	li r31, 1                               
lbl_800AD7D4:
/* 800AD7D4  A0 1D 1F BC */	lhz r0, 0x1fbc(r29)                     
/* 800AD7D8  28 00 02 62 */	cmplwi r0, 0x262                        
/* 800AD7DC  40 82 00 14 */	bne lbl_800AD7F0                         /* constant-address: 800AD7F0, symbol: lbl_800AD7F0 */
/* 800AD7E0  80 1D 05 70 */	lwz r0, 0x570(r29)                      
/* 800AD7E4  54 00 03 DA */	rlwinm r0, r0, 0, 0xf, 0xd              
/* 800AD7E8  90 1D 05 70 */	stw r0, 0x570(r29)                      
/* 800AD7EC  48 00 00 30 */	b lbl_800AD81C                           /* constant-address: 800AD81C, symbol: lbl_800AD81C */
lbl_800AD7F0:
/* 800AD7F0  38 60 00 00 */	li r3, 0                                
/* 800AD7F4  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD7F8  28 00 02 BD */	cmplwi r0, 0x2bd                        
/* 800AD7FC  41 82 00 0C */	beq lbl_800AD808                         /* constant-address: 800AD808, symbol: lbl_800AD808 */
/* 800AD800  28 00 02 BE */	cmplwi r0, 0x2be                        
/* 800AD804  40 82 00 08 */	bne lbl_800AD80C                         /* constant-address: 800AD80C, symbol: lbl_800AD80C */
lbl_800AD808:
/* 800AD808  38 60 00 01 */	li r3, 1                                
lbl_800AD80C:
/* 800AD80C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD810  41 82 00 0C */	beq lbl_800AD81C                         /* constant-address: 800AD81C, symbol: lbl_800AD81C */
/* 800AD814  7F A3 EB 78 */	mr r3, r29                              
/* 800AD818  48 08 B3 ED */	bl resetWolfEnemyBiteAll__9daAlink_cFv   /* constant-address: 80138C04, symbol: resetWolfEnemyBiteAll__9daAlink_cFv */
lbl_800AD81C:
...
/* 800AD82C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800AD830  D0 03 1F 40 */	stfs f0, 0x1f40(r3)                     
/* 800AD834  3C 60 00 01 */	lis r3, 0x0001 /* 0x0000FFFF@ha */      
/* 800AD838  38 83 FF FF */	addi r4, r3, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
...
/* 800AD858  48 27 AB A5 */	bl init__12J3DFrameCtrlFs                /* constant-address: 803283FC, symbol: init__12J3DFrameCtrlFs */
/* 800AD85C  7F A3 EB 78 */	mr r3, r29                              
/* 800AD860  FC 20 F8 90 */	fmr f1, f31                             
/* 800AD864  4B FF FA 75 */	bl setUpperAnimeMorf__9daAlink_cFf       /* constant-address: 800AD2D8, symbol: setUpperAnimeMorf__9daAlink_cFf */
/* 800AD868  2C 1E 00 02 */	cmpwi r30, 2                            
/* 800AD86C  40 82 00 0C */	bne lbl_800AD878                         /* constant-address: 800AD878, symbol: lbl_800AD878 */
/* 800AD870  7F A3 EB 78 */	mr r3, r29                              
/* 800AD874  48 00 24 49 */	bl resetFacePriAnime__9daAlink_cFv       /* constant-address: 800AFCBC, symbol: resetFacePriAnime__9daAlink_cFv */
lbl_800AD878:
...
/* 800AD888  48 03 12 5D */	bl deleteArrow__9daAlink_cFv             /* constant-address: 800DEAE4, symbol: deleteArrow__9daAlink_cFv */
/* 800AD88C  7F A3 EB 78 */	mr r3, r29                              
/* 800AD890  48 03 23 E1 */	bl setBowNormalAnime__9daAlink_cFv       /* constant-address: 800DFC70, symbol: setBowNormalAnime__9daAlink_cFv */
/* 800AD894  80 9D 05 74 */	lwz r4, 0x574(r29)                      
/* 800AD898  3C 60 EB E9 */	lis r3, 0xEBE9 /* 0xEBE8FFB5@ha */      
/* 800AD89C  38 03 FF B5 */	addi r0, r3, 0xFFB5 /* 0xEBE8FFB5@l */   /* constant-address: EBE8FFB5 */
/* 800AD8A0  7C 80 00 38 */	and r0, r4, r0                          
/* 800AD8A4  90 1D 05 74 */	stw r0, 0x574(r29)                      
/* 800AD8A8  2C 1F 00 00 */	cmpwi r31, 0                            
/* 800AD8AC  41 82 00 0C */	beq lbl_800AD8B8                         /* constant-address: 800AD8B8, symbol: lbl_800AD8B8 */
/* 800AD8B0  7F A3 EB 78 */	mr r3, r29                              
/* 800AD8B4  48 03 73 21 */	bl freeGrabItem__9daAlink_cFv            /* constant-address: 800E4BD4, symbol: freeGrabItem__9daAlink_cFv */
lbl_800AD8B8:
...
/* 800AD8CC  48 00 98 C5 */	bl cancelItemUseQuake__9daAlink_cFi      /* constant-address: 800B7190, symbol: cancelItemUseQuake__9daAlink_cFi */
...
/* 800AD8E0  48 2B 49 49 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

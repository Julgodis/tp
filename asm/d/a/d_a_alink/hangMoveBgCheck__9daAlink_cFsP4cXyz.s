...
/* 800FA090  48 26 81 39 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 800FA0A4  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800FA0A8  90 01 00 60 */	stw r0, 0x60(r1)                        
/* 800FA0AC  80 1D 31 A0 */	lwz r0, 0x31a0(r29)                     
/* 800FA0B0  54 00 03 DF */	rlwinm. r0, r0, 0, 0xf, 0xf             
/* 800FA0B4  41 82 00 14 */	beq lbl_800FA0C8                         /* constant-address: 800FA0C8, symbol: lbl_800FA0C8 */
/* 800FA0B8  C0 3D 04 D4 */	lfs f1, 0x4d4(r29)                      
/* 800FA0BC  C0 1D 05 98 */	lfs f0, 0x598(r29)                      
/* 800FA0C0  EF E1 00 2A */	fadds f31, f1, f0                       
/* 800FA0C4  48 00 00 08 */	b lbl_800FA0CC                           /* constant-address: 800FA0CC, symbol: lbl_800FA0CC */
lbl_800FA0C8:
...
/* 800FA0D8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800FA0DC  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 800FA0E0  C0 22 95 48 */	lfs f1, lit_23416(r2)                    /* constant-address: 80452F48, symbol: lit_23416 */
/* 800FA0E4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 800FA0E8  38 A3 00 04 */	addi r5, r3, 4                           /* constant-address: 80439A24, symbol: None */
/* 800FA0EC  7C 45 04 2E */	lfsx f2, r5, r0                         
/* 800FA0F0  EC 21 00 B2 */	fmuls f1, f1, f2                        
/* 800FA0F4  28 1E 00 00 */	cmplwi r30, 0                           
/* 800FA0F8  41 82 00 60 */	beq lbl_800FA158                         /* constant-address: 800FA158, symbol: lbl_800FA158 */
...
/* 800FA12C  C0 62 92 E0 */	lfs f3, lit_6845(r2)                     /* constant-address: 80452CE0, symbol: lit_6845 */
...
/* 800FA154  48 00 00 48 */	b lbl_800FA19C                           /* constant-address: 800FA19C, symbol: lbl_800FA19C */
lbl_800FA158:
...
/* 800FA16C  C0 62 93 D4 */	lfs f3, lit_11442(r2)                    /* constant-address: 80452DD4, symbol: lit_11442 */
...
/* 800FA1D8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FA1DC  3B 43 0F 38 */	addi r26, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 800FA1E0  3B 3D 1B 78 */	addi r25, r29, 0x1b78                   
/* 800FA1E4  3C 60 80 39 */	lis r3, data_803919F0@ha                
/* 800FA1E8  3B 63 19 F0 */	addi r27, r3, data_803919F0@l            /* constant-address: 803919F0, symbol: data_803919F0 */
lbl_800FA1EC:
...
/* 800FA208  4B FA 7F 91 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800FA20C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FA210  41 82 00 E0 */	beq lbl_800FA2F0                         /* constant-address: 800FA2F0, symbol: lbl_800FA2F0 */
/* 800FA214  7F 43 D3 78 */	mr r3, r26                              
/* 800FA218  38 9D 1B 5C */	addi r4, r29, 0x1b5c                    
/* 800FA21C  38 A1 00 50 */	addi r5, r1, 0x50                       
/* 800FA220  4B F7 A5 25 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 800FA224  C0 21 00 54 */	lfs f1, 0x54(r1)                        
/* 800FA228  48 16 DF E9 */	bl cBgW_CheckBWall__Ff                   /* constant-address: 80268210, symbol: cBgW_CheckBWall__Ff */
/* 800FA22C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FA230  41 82 00 C0 */	beq lbl_800FA2F0                         /* constant-address: 800FA2F0, symbol: lbl_800FA2F0 */
/* 800FA234  38 61 00 50 */	addi r3, r1, 0x50                       
/* 800FA238  48 16 CE F1 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 800FA23C  A8 9D 04 E6 */	lha r4, 0x4e6(r29)                      
/* 800FA240  48 17 6B E5 */	bl cLib_distanceAngleS__Fss              /* constant-address: 80270E24, symbol: cLib_distanceAngleS__Fss */
/* 800FA244  2C 03 54 9F */	cmpwi r3, 0x549f                        
/* 800FA248  40 80 00 A8 */	bge lbl_800FA2F0                         /* constant-address: 800FA2F0, symbol: lbl_800FA2F0 */
/* 800FA24C  28 1E 00 00 */	cmplwi r30, 0                           
/* 800FA250  40 82 00 18 */	bne lbl_800FA268                         /* constant-address: 800FA268, symbol: lbl_800FA268 */
/* 800FA254  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FA258  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800FA25C  90 01 00 60 */	stw r0, 0x60(r1)                        
/* 800FA260  38 60 00 01 */	li r3, 1                                
/* 800FA264  48 00 00 AC */	b lbl_800FA310                           /* constant-address: 800FA310, symbol: lbl_800FA310 */
lbl_800FA268:
/* 800FA268  38 61 00 20 */	addi r3, r1, 0x20                       
/* 800FA26C  7F 24 CB 78 */	mr r4, r25                              
/* 800FA270  38 A1 00 38 */	addi r5, r1, 0x38                       
/* 800FA274  48 16 C8 C1 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800FA294  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FA298  D0 01 00 18 */	stfs f0, 0x18(r1)                       
/* 800FA29C  D0 21 00 1C */	stfs f1, 0x1c(r1)                       
/* 800FA2A0  38 61 00 14 */	addi r3, r1, 0x14                       
/* 800FA2A4  48 24 CE 95 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
...
/* 800FA2B8  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FA2BC  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800FA2C0  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 800FA2C4  38 61 00 08 */	addi r3, r1, 8                          
/* 800FA2C8  48 24 CE 71 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 800FA2CC  FC 1E 08 40 */	fcmpo cr0, f30, f1                      
/* 800FA2D0  40 81 00 20 */	ble lbl_800FA2F0                         /* constant-address: 800FA2F0, symbol: lbl_800FA2F0 */
...
/* 800FA2FC  41 80 FE F0 */	blt lbl_800FA1EC                         /* constant-address: 800FA1EC, symbol: lbl_800FA1EC */
/* 800FA300  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FA304  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
...
/* 800FA324  48 26 7E F1 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

...
/* 800D16A0  48 29 0B 31 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 800D16C4  4B FF F8 99 */	bl getSwordAtType__9daAlink_cFv          /* constant-address: 800D0F5C, symbol: getSwordAtType__9daAlink_cFv */
...
/* 800D16D4  3C 80 80 40 */	lis r4, g_dComIfG_gameInfo@ha           
/* 800D16D8  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D16DC  88 04 00 14 */	lbz r0, 0x14(r4)                         /* constant-address: 804061D4, symbol: None */
/* 800D16E0  28 00 00 3F */	cmplwi r0, 0x3f                         
/* 800D16E4  40 82 00 24 */	bne lbl_800D1708                         /* constant-address: 800D1708, symbol: lbl_800D1708 */
/* 800D16E8  57 A0 06 3E */	clrlwi r0, r29, 0x18                    
/* 800D16EC  28 00 00 0E */	cmplwi r0, 0xe                          
/* 800D16F0  41 82 00 14 */	beq lbl_800D1704                         /* constant-address: 800D1704, symbol: lbl_800D1704 */
/* 800D16F4  28 00 00 01 */	cmplwi r0, 1                            
/* 800D16F8  41 82 00 0C */	beq lbl_800D1704                         /* constant-address: 800D1704, symbol: lbl_800D1704 */
/* 800D16FC  28 00 00 10 */	cmplwi r0, 0x10                         
/* 800D1700  40 82 00 08 */	bne lbl_800D1708                         /* constant-address: 800D1708, symbol: lbl_800D1708 */
lbl_800D1704:
/* 800D1704  3B A0 00 05 */	li r29, 5                               
lbl_800D1708:
/* 800D1708  2C 1B 00 00 */	cmpwi r27, 0                            
/* 800D170C  40 82 00 10 */	bne lbl_800D171C                         /* constant-address: 800D171C, symbol: lbl_800D171C */
/* 800D1710  38 00 00 00 */	li r0, 0                                
/* 800D1714  98 1A 2F D0 */	stb r0, 0x2fd0(r26)                     
/* 800D1718  48 00 00 0C */	b lbl_800D1724                           /* constant-address: 800D1724, symbol: lbl_800D1724 */
lbl_800D171C:
...
/* 800D1760  42 00 FF E0 */	bdnz lbl_800D1740                        /* constant-address: 800D1740, symbol: lbl_800D1740 */
...
/* 800D1774  48 29 0A A9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

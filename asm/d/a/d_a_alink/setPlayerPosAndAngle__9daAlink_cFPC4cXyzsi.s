...
/* 800B222C  48 2A FF AD */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 800B2230  7C 7F 1B 78 */	mr r31, r3                              
/* 800B2234  7C 9C 23 78 */	mr r28, r4                              
/* 800B2238  7C BD 2B 78 */	mr r29, r5                              
/* 800B223C  7C DE 33 78 */	mr r30, r6                              
/* 800B2240  48 06 39 E1 */	bl checkEventRun__9daAlink_cCFv          /* constant-address: 80115C20, symbol: checkEventRun__9daAlink_cCFv */
/* 800B2244  2C 03 00 00 */	cmpwi r3, 0                             
/* 800B2248  40 82 00 18 */	bne lbl_800B2260                         /* constant-address: 800B2260, symbol: lbl_800B2260 */
/* 800B224C  2C 1E 00 00 */	cmpwi r30, 0                            
/* 800B2250  40 82 00 10 */	bne lbl_800B2260                         /* constant-address: 800B2260, symbol: lbl_800B2260 */
/* 800B2254  88 1F 05 6A */	lbz r0, 0x56a(r31)                      
/* 800B2258  28 00 00 00 */	cmplwi r0, 0                            
/* 800B225C  41 82 01 88 */	beq lbl_800B23E4                         /* constant-address: 800B23E4, symbol: lbl_800B23E4 */
lbl_800B2260:
/* 800B2260  28 1C 00 00 */	cmplwi r28, 0                           
/* 800B2264  41 82 00 78 */	beq lbl_800B22DC                         /* constant-address: 800B22DC, symbol: lbl_800B22DC */
...
/* 800B22D0  41 82 00 0C */	beq lbl_800B22DC                         /* constant-address: 800B22DC, symbol: lbl_800B22DC */
/* 800B22D4  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800B22F4  41 82 00 0C */	beq lbl_800B2300                         /* constant-address: 800B2300, symbol: lbl_800B2300 */
/* 800B22F8  28 00 00 E2 */	cmplwi r0, 0xe2                         
/* 800B22FC  40 82 00 2C */	bne lbl_800B2328                         /* constant-address: 800B2328, symbol: lbl_800B2328 */
lbl_800B2300:
/* 800B2300  80 1F 05 74 */	lwz r0, 0x574(r31)                      
/* 800B2304  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 800B2308  40 82 00 20 */	bne lbl_800B2328                         /* constant-address: 800B2328, symbol: lbl_800B2328 */
/* 800B230C  80 1F 31 98 */	lwz r0, 0x3198(r31)                     
/* 800B2310  2C 00 00 00 */	cmpwi r0, 0                             
/* 800B2314  41 82 00 14 */	beq lbl_800B2328                         /* constant-address: 800B2328, symbol: lbl_800B2328 */
...
/* 800B2330  41 82 00 1C */	beq lbl_800B234C                         /* constant-address: 800B234C, symbol: lbl_800B234C */
/* 800B2334  C0 3F 36 AC */	lfs f1, 0x36ac(r31)                     
/* 800B2338  48 1B 5E AD */	bl cBgW_CheckBGround__Ff                 /* constant-address: 802681E4, symbol: cBgW_CheckBGround__Ff */
/* 800B233C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800B2340  41 82 00 0C */	beq lbl_800B234C                         /* constant-address: 800B234C, symbol: lbl_800B234C */
...
/* 800B2364  41 82 00 28 */	beq lbl_800B238C                         /* constant-address: 800B238C, symbol: lbl_800B238C */
/* 800B2368  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800B236C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800B2370  80 63 5D B8 */	lwz r3, 0x5db8(r3)                       /* constant-address: 8040BF78, symbol: None */
/* 800B2374  38 9F 04 D0 */	addi r4, r31, 0x4d0                     
/* 800B2378  A8 BF 04 E6 */	lha r5, 0x4e6(r31)                      
/* 800B237C  39 83 18 E0 */	addi r12, r3, 0x18e0                    
/* 800B2380  48 2A FD 05 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 800B2384  60 00 00 00 */	nop                                     
/* 800B2388  48 00 00 54 */	b lbl_800B23DC                           /* constant-address: 800B23DC, symbol: lbl_800B23DC */
lbl_800B238C:
...
/* 800B23A4  41 82 00 38 */	beq lbl_800B23DC                         /* constant-address: 800B23DC, symbol: lbl_800B23DC */
...
/* 800B23D4  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800B23D8  D0 03 04 FC */	stfs f0, 0x4fc(r3)                      
lbl_800B23DC:
/* 800B23DC  38 7F 08 14 */	addi r3, r31, 0x814                     
/* 800B23E0  48 1B 15 7D */	bl ClrCcMove__9cCcD_SttsFv               /* constant-address: 8026395C, symbol: ClrCcMove__9cCcD_SttsFv */
lbl_800B23E4:
/* 800B23E4  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800B23E8  48 2A FE 3D */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

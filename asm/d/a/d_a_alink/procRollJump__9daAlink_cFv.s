...
/* 800C6948  41 82 00 10 */	beq lbl_800C6958                         /* constant-address: 800C6958, symbol: lbl_800C6958 */
/* 800C694C  38 80 00 00 */	li r4, 0                                
/* 800C6950  4B FE F3 7D */	bl checkLandAction__9daAlink_cFi         /* constant-address: 800B5CCC, symbol: checkLandAction__9daAlink_cFi */
/* 800C6954  48 00 00 E0 */	b lbl_800C6A34                           /* constant-address: 800C6A34, symbol: lbl_800C6A34 */
lbl_800C6958:
/* 800C6958  C0 3F 04 FC */	lfs f1, 0x4fc(r31)                      
/* 800C695C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C6960  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C6964  40 80 00 1C */	bge lbl_800C6980                         /* constant-address: 800C6980, symbol: lbl_800C6980 */
/* 800C6968  38 80 00 03 */	li r4, 3                                
/* 800C696C  3C A0 80 39 */	lis r5, m__22daAlinkHIO_autoJump_c0@ha  
/* 800C6970  38 A5 E0 68 */	addi r5, r5, m__22daAlinkHIO_autoJump_c0@l /* constant-address: 8038E068, symbol: m__22daAlinkHIO_autoJump_c0 */
/* 800C6974  C0 25 00 84 */	lfs f1, 0x84(r5)                         /* constant-address: 8038E0EC, symbol: None */
/* 800C6978  48 00 00 D1 */	bl procFallInit__9daAlink_cFif           /* constant-address: 800C6A48, symbol: procFallInit__9daAlink_cFif */
/* 800C697C  48 00 00 B4 */	b lbl_800C6A30                           /* constant-address: 800C6A30, symbol: lbl_800C6A30 */
lbl_800C6980:
/* 800C6980  A8 BF 04 E4 */	lha r5, 0x4e4(r31)                      
/* 800C6984  3C 80 80 39 */	lis r4, m__22daAlinkHIO_autoJump_c0@ha  
/* 800C6988  38 84 E0 68 */	addi r4, r4, m__22daAlinkHIO_autoJump_c0@l /* constant-address: 8038E068, symbol: m__22daAlinkHIO_autoJump_c0 */
/* 800C698C  A8 04 00 54 */	lha r0, 0x54(r4)                         /* constant-address: 8038E0BC, symbol: None */
...
/* 800C69A0  41 81 00 3C */	bgt lbl_800C69DC                         /* constant-address: 800C69DC, symbol: lbl_800C69DC */
/* 800C69A4  A8 1F 30 0C */	lha r0, 0x300c(r31)                     
/* 800C69A8  2C 00 00 00 */	cmpwi r0, 0                             
/* 800C69AC  41 82 00 28 */	beq lbl_800C69D4                         /* constant-address: 800C69D4, symbol: lbl_800C69D4 */
/* 800C69B0  3C 80 00 02 */	lis r4, 0x0002 /* 0x0002005C@ha */      
/* 800C69B4  38 84 00 5C */	addi r4, r4, 0x005C /* 0x0002005C@l */   /* constant-address: 0002005C */
...
/* 800C69D0  48 00 00 0C */	b lbl_800C69DC                           /* constant-address: 800C69DC, symbol: lbl_800C69DC */
lbl_800C69D4:
/* 800C69D4  38 00 00 01 */	li r0, 1                                
/* 800C69D8  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
lbl_800C69DC:
/* 800C69DC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800C69E0  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800C6A04  38 84 E0 68 */	addi r4, r4, m__22daAlinkHIO_autoJump_c0@l /* constant-address: 8038E068, symbol: m__22daAlinkHIO_autoJump_c0 */
/* 800C6A08  C0 24 00 88 */	lfs f1, 0x88(r4)                         /* constant-address: 8038E0F0, symbol: None */
/* 800C6A0C  C0 1F 33 A8 */	lfs f0, 0x33a8(r31)                     
/* 800C6A10  EC 00 00 B2 */	fmuls f0, f0, f2                        
/* 800C6A14  EC 21 00 32 */	fmuls f1, f1, f0                        
/* 800C6A18  C0 44 00 8C */	lfs f2, 0x8c(r4)                         /* constant-address: 8038E0F4, symbol: None */
/* 800C6A1C  48 1A 9D 25 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */

...
/* 80125138  48 23 D0 99 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 80125150  3B E3 0C F4 */	addi r31, r3, Zero__4cXyz@l              /* constant-address: 80430CF4, symbol: Zero__4cXyz */
lbl_80125154:
/* 80125154  88 1E 00 00 */	lbz r0, 0(r30)                          
/* 80125158  28 00 00 00 */	cmplwi r0, 0                            
/* 8012515C  41 82 01 84 */	beq lbl_801252E0                         /* constant-address: 801252E0, symbol: lbl_801252E0 */
...
/* 80125180  48 22 1B ED */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 80125184  C0 3B 33 B4 */	lfs f1, 0x33b4(r27)                     
/* 80125188  C0 01 00 24 */	lfs f0, 0x24(r1)                        
/* 8012518C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80125190  40 81 00 14 */	ble lbl_801251A4                         /* constant-address: 801251A4, symbol: lbl_801251A4 */
/* 80125194  7F 63 DB 78 */	mr r3, r27                              
/* 80125198  7F 84 E3 78 */	mr r4, r28                              
/* 8012519C  4B FF FC 8D */	bl clearFirePointDamageEffect__9daAlink_cFi /* constant-address: 80124E28, symbol: clearFirePointDamageEffect__9daAlink_cFi */
/* 801251A0  48 00 01 40 */	b lbl_801252E0                           /* constant-address: 801252E0, symbol: lbl_801252E0 */
lbl_801251A4:
/* 801251A4  80 1E 00 04 */	lwz r0, 4(r30)                          
/* 801251A8  28 00 00 00 */	cmplwi r0, 0                            
/* 801251AC  40 82 00 28 */	bne lbl_801251D4                         /* constant-address: 801251D4, symbol: lbl_801251D4 */
/* 801251B0  3C 60 80 43 */	lis r3, Zero__4cXyz@ha                  
/* 801251B4  C0 03 0C F4 */	lfs f0, Zero__4cXyz@l(r3)                /* constant-address: 80430CF4, symbol: Zero__4cXyz */
/* 801251B8  D0 1E 00 24 */	stfs f0, 0x24(r30)                      
/* 801251BC  C0 1F 00 04 */	lfs f0, 4(r31)                           /* constant-address: 80430CF8, symbol: None */
/* 801251C0  D0 1E 00 28 */	stfs f0, 0x28(r30)                      
/* 801251C4  C0 1F 00 08 */	lfs f0, 8(r31)                           /* constant-address: 80430CFC, symbol: None */
/* 801251C8  D0 1E 00 2C */	stfs f0, 0x2c(r30)                      
/* 801251CC  3B 40 00 01 */	li r26, 1                               
/* 801251D0  48 00 00 40 */	b lbl_80125210                           /* constant-address: 80125210, symbol: lbl_80125210 */
lbl_801251D4:
/* 801251D4  38 61 00 14 */	addi r3, r1, 0x14                       
/* 801251D8  38 81 00 20 */	addi r4, r1, 0x20                       
/* 801251DC  38 BE 00 0C */	addi r5, r30, 0xc                       
/* 801251E0  48 14 19 55 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
/* 801251E4  38 61 00 08 */	addi r3, r1, 8                          
/* 801251E8  38 81 00 14 */	addi r4, r1, 0x14                       
/* 801251EC  C0 22 94 D0 */	lfs f1, lit_18847(r2)                    /* constant-address: 80452ED0, symbol: lit_18847 */
/* 801251F0  48 14 19 95 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 80125224  4B FF B3 5D */	bl setEmitter__9daAlink_cFPUlUsPC4cXyzPC5csXyz /* constant-address: 80120580, symbol: setEmitter__9daAlink_cFPUlUsPC4cXyzPC5csXyz */
/* 80125228  28 03 00 00 */	cmplwi r3, 0                            
/* 8012522C  41 82 00 40 */	beq lbl_8012526C                         /* constant-address: 8012526C, symbol: lbl_8012526C */
/* 80125230  38 A0 00 00 */	li r5, 0                                
/* 80125234  80 03 00 F4 */	lwz r0, 0xf4(r3)                        
/* 80125238  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c           
/* 8012523C  41 82 00 18 */	beq lbl_80125254                         /* constant-address: 80125254, symbol: lbl_80125254 */
/* 80125240  80 83 00 D0 */	lwz r4, 0xd0(r3)                        
/* 80125244  80 03 00 DC */	lwz r0, 0xdc(r3)                        
/* 80125248  7C 04 02 15 */	add. r0, r4, r0                         
/* 8012524C  40 82 00 08 */	bne lbl_80125254                         /* constant-address: 80125254, symbol: lbl_80125254 */
/* 80125250  38 A0 00 01 */	li r5, 1                                
lbl_80125254:
/* 80125254  54 A0 06 3F */	clrlwi. r0, r5, 0x18                    
/* 80125258  41 82 00 14 */	beq lbl_8012526C                         /* constant-address: 8012526C, symbol: lbl_8012526C */
/* 8012525C  7F 63 DB 78 */	mr r3, r27                              
/* 80125260  7F 84 E3 78 */	mr r4, r28                              
/* 80125264  4B FF FB C5 */	bl clearFirePointDamageEffect__9daAlink_cFi /* constant-address: 80124E28, symbol: clearFirePointDamageEffect__9daAlink_cFi */
/* 80125268  48 00 00 78 */	b lbl_801252E0                           /* constant-address: 801252E0, symbol: lbl_801252E0 */
lbl_8012526C:
/* 8012526C  2C 1A 00 00 */	cmpwi r26, 0                            
/* 80125270  41 82 00 1C */	beq lbl_8012528C                         /* constant-address: 8012528C, symbol: lbl_8012528C */
/* 80125274  28 03 00 00 */	cmplwi r3, 0                            
/* 80125278  41 82 00 14 */	beq lbl_8012528C                         /* constant-address: 8012528C, symbol: lbl_8012528C */
/* 8012527C  38 0D 89 48 */	la r0, mParticleTracePCB__13dPa_control_c(r13) /* 80450EC8-_SDA_BASE_ */ /* constant-address: 80450EC8, symbol: mParticleTracePCB__13dPa_control_c */
...
/* 801252A0  4B FF B2 E1 */	bl setEmitter__9daAlink_cFPUlUsPC4cXyzPC5csXyz /* constant-address: 80120580, symbol: setEmitter__9daAlink_cFPUlUsPC4cXyzPC5csXyz */
/* 801252A4  2C 1A 00 00 */	cmpwi r26, 0                            
/* 801252A8  41 82 00 1C */	beq lbl_801252C4                         /* constant-address: 801252C4, symbol: lbl_801252C4 */
/* 801252AC  28 03 00 00 */	cmplwi r3, 0                            
/* 801252B0  41 82 00 14 */	beq lbl_801252C4                         /* constant-address: 801252C4, symbol: lbl_801252C4 */
/* 801252B4  38 0D 89 48 */	la r0, mParticleTracePCB__13dPa_control_c(r13) /* 80450EC8-_SDA_BASE_ */ /* constant-address: 80450EC8, symbol: mParticleTracePCB__13dPa_control_c */
...
/* 801252EC  41 80 FE 68 */	blt lbl_80125154                         /* constant-address: 80125154, symbol: lbl_80125154 */
/* 801252F0  2C 1D 00 00 */	cmpwi r29, 0                            
/* 801252F4  40 82 00 10 */	bne lbl_80125304                         /* constant-address: 80125304, symbol: lbl_80125304 */
/* 801252F8  88 1B 2F CB */	lbz r0, 0x2fcb(r27)                     
/* 801252FC  28 00 00 00 */	cmplwi r0, 0                            
/* 80125300  41 82 00 20 */	beq lbl_80125320                         /* constant-address: 80125320, symbol: lbl_80125320 */
lbl_80125304:
/* 80125304  7F 63 DB 78 */	mr r3, r27                              
/* 80125308  3C 80 00 02 */	lis r4, 0x0002 /* 0x00020041@ha */      
/* 8012530C  38 84 00 41 */	addi r4, r4, 0x0041 /* 0x00020041@l */   /* constant-address: 00020041 */
...
/* 80125324  48 23 CE F9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

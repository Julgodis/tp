...
/* 80100478  4B FF E3 F1 */	bl setMoveBGClimbCorrect__9daAlink_cFv   /* constant-address: 800FE868, symbol: setMoveBGClimbCorrect__9daAlink_cFv */
/* 8010047C  2C 03 00 00 */	cmpwi r3, 0                             
/* 80100480  41 82 00 0C */	beq lbl_8010048C                         /* constant-address: 8010048C, symbol: lbl_8010048C */
/* 80100484  38 60 00 01 */	li r3, 1                                
/* 80100488  48 00 01 30 */	b lbl_801005B8                           /* constant-address: 801005B8, symbol: lbl_801005B8 */
lbl_8010048C:
/* 8010048C  38 00 00 02 */	li r0, 2                                
/* 80100490  98 1F 2F 99 */	stb r0, 0x2f99(r31)                     
/* 80100494  38 7F 1F D0 */	addi r3, r31, 0x1fd0                    
/* 80100498  48 05 E0 35 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 8010049C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 801004A0  41 82 01 14 */	beq lbl_801005B4                         /* constant-address: 801005B4, symbol: lbl_801005B4 */
...
/* 801004D4  4B FA D6 A5 */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
/* 801004D8  80 7F 20 60 */	lwz r3, 0x2060(r31)                     
/* 801004DC  80 63 00 1C */	lwz r3, 0x1c(r3)                        
/* 801004E0  C0 23 00 1C */	lfs f1, 0x1c(r3)                        
/* 801004E4  C0 02 92 BC */	lfs f0, lit_6041(r2)                     /* constant-address: 80452CBC, symbol: lit_6041 */
...
/* 801004F4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 8010050C  C0 42 93 54 */	lfs f2, lit_8248(r2)                     /* constant-address: 80452D54, symbol: lit_8248 */
...
/* 80100550  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80100554  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 80100558  38 9F 1D 5C */	addi r4, r31, 0x1d5c                    
/* 8010055C  4B F7 4F 41 */	bl RoofChk__4dBgSFP12dBgS_RoofChk        /* constant-address: 8007549C, symbol: RoofChk__4dBgSFP12dBgS_RoofChk */
/* 80100560  D0 21 00 0C */	stfs f1, 0xc(r1)                        
/* 80100564  FC 60 08 18 */	frsp f3, f1                             
/* 80100568  C0 42 95 94 */	lfs f2, lit_25113(r2)                    /* constant-address: 80452F94, symbol: lit_25113 */
/* 8010056C  C0 22 95 A4 */	lfs f1, lit_25916(r2)                    /* constant-address: 80452FA4, symbol: lit_25916 */
...
/* 80100580  40 80 00 1C */	bge lbl_8010059C                         /* constant-address: 8010059C, symbol: lbl_8010059C */
...
/* 80100594  48 00 04 7D */	bl procRoofHangStartInit__9daAlink_cFRC13cBgS_PolyInfoRC4cXyzi /* constant-address: 80100A10, symbol: procRoofHangStartInit__9daAlink_cFRC13cBgS_PolyInfoRC4cXyzi */
/* 80100598  48 00 00 1C */	b lbl_801005B4                           /* constant-address: 801005B4, symbol: lbl_801005B4 */
lbl_8010059C:
/* 8010059C  7F E3 FB 78 */	mr r3, r31                              
/* 801005A0  38 80 00 01 */	li r4, 1                                
/* 801005A4  3C A0 80 39 */	lis r5, m__22daAlinkHIO_autoJump_c0@ha  
/* 801005A8  38 A5 E0 68 */	addi r5, r5, m__22daAlinkHIO_autoJump_c0@l /* constant-address: 8038E068, symbol: m__22daAlinkHIO_autoJump_c0 */
/* 801005AC  C0 25 00 70 */	lfs f1, 0x70(r5)                         /* constant-address: 8038E0D8, symbol: None */
/* 801005B0  4B FC 64 99 */	bl procFallInit__9daAlink_cFif           /* constant-address: 800C6A48, symbol: procFallInit__9daAlink_cFif */
lbl_801005B4:

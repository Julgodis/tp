...
/* 800AC794  48 2B 5A 35 */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
...
/* 800AC7CC  40 82 00 0C */	bne lbl_800AC7D8                         /* constant-address: 800AC7D8, symbol: lbl_800AC7D8 */
/* 800AC7D0  C3 E2 92 C0 */	lfs f31, lit_6108(r2)                    /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800AC7D4  48 00 00 2C */	b lbl_800AC800                           /* constant-address: 800AC800, symbol: lbl_800AC800 */
lbl_800AC7D8:
/* 800AC7D8  C0 5F 00 10 */	lfs f2, 0x10(r31)                       
/* 800AC7DC  A8 1F 00 08 */	lha r0, 8(r31)                          
/* 800AC7E0  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800AC808  4B FF FF 31 */	bl setDoubleAnimeBlendRatio__9daAlink_cFf /* constant-address: 800AC738, symbol: setDoubleAnimeBlendRatio__9daAlink_cFf */
/* 800AC80C  A8 19 00 06 */	lha r0, 6(r25)                          
/* 800AC810  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800AC844  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800AC884  4B FF FB 11 */	bl setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff /* constant-address: 800AC394, symbol: setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff */
...
/* 800AC8B8  4B FF FA DD */	bl setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff /* constant-address: 800AC394, symbol: setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff */
...
/* 800AC8D0  41 82 00 60 */	beq lbl_800AC930                         /* constant-address: 800AC930, symbol: lbl_800AC930 */
/* 800AC8D4  A8 1A 00 06 */	lha r0, 6(r26)                          
/* 800AC8D8  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800AC920  4B FF FA 75 */	bl setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff /* constant-address: 800AC394, symbol: setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff */
/* 800AC924  C0 18 20 28 */	lfs f0, 0x2028(r24)                     
/* 800AC928  D0 1A 00 08 */	stfs f0, 8(r26)                         
/* 800AC92C  48 00 00 08 */	b lbl_800AC934                           /* constant-address: 800AC934, symbol: lbl_800AC934 */
lbl_800AC930:
/* 800AC930  93 38 1F 44 */	stw r25, 0x1f44(r24)                    
lbl_800AC934:
/* 800AC934  28 1C 00 00 */	cmplwi r28, 0                           
/* 800AC938  41 82 00 60 */	beq lbl_800AC998                         /* constant-address: 800AC998, symbol: lbl_800AC998 */
/* 800AC93C  A8 1C 00 06 */	lha r0, 6(r28)                          
/* 800AC940  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800AC988  4B FF FA 0D */	bl setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff /* constant-address: 800AC394, symbol: setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff */
/* 800AC98C  C0 18 20 40 */	lfs f0, 0x2040(r24)                     
/* 800AC990  D0 1C 00 08 */	stfs f0, 8(r28)                         
/* 800AC994  48 00 00 08 */	b lbl_800AC99C                           /* constant-address: 800AC99C, symbol: lbl_800AC99C */
lbl_800AC998:
/* 800AC998  93 78 1F 4C */	stw r27, 0x1f4c(r24)                    
lbl_800AC99C:
/* 800AC99C  2C 1D 00 04 */	cmpwi r29, 4                            
/* 800AC9A0  41 82 00 0C */	beq lbl_800AC9AC                         /* constant-address: 800AC9AC, symbol: lbl_800AC9AC */
/* 800AC9A4  2C 1D 00 02 */	cmpwi r29, 2                            
/* 800AC9A8  40 82 00 14 */	bne lbl_800AC9BC                         /* constant-address: 800AC9BC, symbol: lbl_800AC9BC */
lbl_800AC9AC:
/* 800AC9AC  7F 03 C3 78 */	mr r3, r24                              
/* 800AC9B0  38 80 00 00 */	li r4, 0                                
/* 800AC9B4  48 01 28 51 */	bl setBasAnime__9daAlink_cFQ29daAlink_c13daAlink_UNDER /* constant-address: 800BF204, symbol: setBasAnime__9daAlink_cFQ29daAlink_c13daAlink_UNDER */
/* 800AC9B8  48 00 00 10 */	b lbl_800AC9C8                           /* constant-address: 800AC9C8, symbol: lbl_800AC9C8 */
lbl_800AC9BC:
/* 800AC9BC  7F 03 C3 78 */	mr r3, r24                              
/* 800AC9C0  38 80 00 01 */	li r4, 1                                
/* 800AC9C4  48 01 28 41 */	bl setBasAnime__9daAlink_cFQ29daAlink_c13daAlink_UNDER /* constant-address: 800BF204, symbol: setBasAnime__9daAlink_cFQ29daAlink_c13daAlink_UNDER */
lbl_800AC9C8:
...
/* 800ACA00  48 2B 58 15 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

...
/* 800A07F8  41 82 00 0C */	beq lbl_800A0804                         /* constant-address: 800A0804, symbol: lbl_800A0804 */
/* 800A07FC  38 60 00 01 */	li r3, 1                                
/* 800A0800  48 00 00 50 */	b lbl_800A0850                           /* constant-address: 800A0850, symbol: lbl_800A0850 */
lbl_800A0804:
/* 800A0804  80 1E 31 A0 */	lwz r0, 0x31a0(r30)                     
/* 800A0808  54 00 05 6B */	rlwinm. r0, r0, 0, 0x15, 0x15           
/* 800A080C  40 82 00 10 */	bne lbl_800A081C                         /* constant-address: 800A081C, symbol: lbl_800A081C */
/* 800A0810  80 1E 05 88 */	lwz r0, 0x588(r30)                      
/* 800A0814  54 00 05 6B */	rlwinm. r0, r0, 0, 0x15, 0x15           
/* 800A0818  41 82 00 14 */	beq lbl_800A082C                         /* constant-address: 800A082C, symbol: lbl_800A082C */
lbl_800A081C:
/* 800A081C  3C 60 80 39 */	lis r3, m__19daAlinkHIO_horse_c0@ha     
/* 800A0820  38 63 E5 A4 */	addi r3, r3, m__19daAlinkHIO_horse_c0@l  /* constant-address: 8038E5A4, symbol: m__19daAlinkHIO_horse_c0 */
/* 800A0824  AB E3 00 52 */	lha r31, 0x52(r3)                        /* constant-address: 8038E5F6, symbol: None */
/* 800A0828  48 00 00 08 */	b lbl_800A0830                           /* constant-address: 800A0830, symbol: lbl_800A0830 */
lbl_800A082C:
/* 800A082C  3B E0 60 00 */	li r31, 0x6000                          
lbl_800A0830:
/* 800A0830  38 7E 34 E0 */	addi r3, r30, 0x34e0                    
/* 800A0834  48 1D 03 D1 */	bl cLib_targetAngleY__FPC3VecPC3Vec      /* constant-address: 80270C04, symbol: cLib_targetAngleY__FPC3VecPC3Vec */
/* 800A0838  A8 9E 2F E6 */	lha r4, 0x2fe6(r30)                     
/* 800A083C  48 1D 05 E9 */	bl cLib_distanceAngleS__Fss              /* constant-address: 80270E24, symbol: cLib_distanceAngleS__Fss */

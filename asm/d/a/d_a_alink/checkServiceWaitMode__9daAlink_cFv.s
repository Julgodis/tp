...
/* 800B47C8  48 06 14 59 */	bl checkEventRun__9daAlink_cCFv          /* constant-address: 80115C20, symbol: checkEventRun__9daAlink_cCFv */
/* 800B47CC  7C 60 00 34 */	cntlzw r0, r3                           
/* 800B47D0  54 03 D9 7E */	srwi r3, r0, 5                          
/* 800B47D4  54 00 DE 3F */	rlwinm. r0, r0, 0x1b, 0x18, 0x1f        
/* 800B47D8  41 82 00 14 */	beq lbl_800B47EC                         /* constant-address: 800B47EC, symbol: lbl_800B47EC */
...
/* 800B47F0  41 82 00 18 */	beq lbl_800B4808                         /* constant-address: 800B4808, symbol: lbl_800B4808 */
/* 800B47F4  7F E3 FB 78 */	mr r3, r31                              
/* 800B47F8  48 00 4A 5D */	bl checkNoUpperAnime__9daAlink_cCFv      /* constant-address: 800B9254, symbol: checkNoUpperAnime__9daAlink_cCFv */
...
/* 800B480C  41 82 00 3C */	beq lbl_800B4848                         /* constant-address: 800B4848, symbol: lbl_800B4848 */
/* 800B4810  C0 3F 35 C0 */	lfs f1, 0x35c0(r31)                     
/* 800B4814  C0 1F 35 B8 */	lfs f0, 0x35b8(r31)                     
/* 800B4818  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 800B481C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800B4820  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800B4824  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 800B4828  38 61 00 08 */	addi r3, r1, 8                          
/* 800B482C  48 29 29 0D */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 800B4830  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800B484C  41 82 00 10 */	beq lbl_800B485C                         /* constant-address: 800B485C, symbol: lbl_800B485C */
...
/* 800B4860  41 82 00 10 */	beq lbl_800B4870                         /* constant-address: 800B4870, symbol: lbl_800B4870 */
...
/* 800B4874  41 82 00 10 */	beq lbl_800B4884                         /* constant-address: 800B4884, symbol: lbl_800B4884 */
...
/* 800B4888  41 82 00 14 */	beq lbl_800B489C                         /* constant-address: 800B489C, symbol: lbl_800B489C */
/* 800B488C  7F E3 FB 78 */	mr r3, r31                              
/* 800B4890  48 03 F4 C9 */	bl checkFishingRodAndLureItem__9daAlink_cCFv /* constant-address: 800F3D58, symbol: checkFishingRodAndLureItem__9daAlink_cCFv */
/* 800B4894  7C 60 00 34 */	cntlzw r0, r3                           
/* 800B4898  54 03 D9 7E */	srwi r3, r0, 5                          
lbl_800B489C:
/* 800B489C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800B48A0  41 82 00 1C */	beq lbl_800B48BC                         /* constant-address: 800B48BC, symbol: lbl_800B48BC */
/* 800B48A4  C0 3F 2B A8 */	lfs f1, 0x2ba8(r31)                     
/* 800B48A8  C0 02 94 0C */	lfs f0, lit_14614(r2)                    /* constant-address: 80452E0C, symbol: lit_14614 */

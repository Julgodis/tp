...
/* 80136528  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8013652C  3C 80 80 39 */	lis r4, m__25daAlinkHIO_wlDamNormal_c0@ha
/* 80136530  38 84 F2 3C */	addi r4, r4, m__25daAlinkHIO_wlDamNormal_c0@l /* constant-address: 8038F23C, symbol: m__25daAlinkHIO_wlDamNormal_c0 */
/* 80136534  C0 44 00 58 */	lfs f2, 0x58(r4)                         /* constant-address: 8038F294, symbol: None */
/* 80136538  48 13 A2 09 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
...
/* 8013654C  41 82 00 0C */	beq lbl_80136558                         /* constant-address: 80136558, symbol: lbl_80136558 */
/* 80136550  7F C3 F3 78 */	mr r3, r30                              
/* 80136554  4B FA 08 D1 */	bl freezeTimerDamage__9daAlink_cFv       /* constant-address: 800D6E24, symbol: freezeTimerDamage__9daAlink_cFv */
lbl_80136558:
/* 80136558  7F E3 FB 78 */	mr r3, r31                              
/* 8013655C  48 02 7F 71 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 80136560  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80136564  41 82 00 70 */	beq lbl_801365D4                         /* constant-address: 801365D4, symbol: lbl_801365D4 */
...
/* 80136578  40 82 00 14 */	bne lbl_8013658C                         /* constant-address: 8013658C, symbol: lbl_8013658C */
/* 8013657C  7F C3 F3 78 */	mr r3, r30                              
/* 80136580  38 80 00 00 */	li r4, 0                                
/* 80136584  4B FF 35 C1 */	bl checkNextActionWolf__9daAlink_cFi     /* constant-address: 80129B44, symbol: checkNextActionWolf__9daAlink_cFi */
/* 80136588  48 00 00 80 */	b lbl_80136608                           /* constant-address: 80136608, symbol: lbl_80136608 */
lbl_8013658C:
/* 8013658C  A8 1E 30 08 */	lha r0, 0x3008(r30)                     
/* 80136590  2C 00 00 00 */	cmpwi r0, 0                             
/* 80136594  40 82 00 74 */	bne lbl_80136608                         /* constant-address: 80136608, symbol: lbl_80136608 */
/* 80136598  7F C3 F3 78 */	mr r3, r30                              
/* 8013659C  3C 80 00 02 */	lis r4, 0x0002 /* 0x00020055@ha */      
/* 801365A0  38 84 00 55 */	addi r4, r4, 0x0055 /* 0x00020055@l */   /* constant-address: 00020055 */
...
/* 801365C0  48 00 4C E1 */	bl procWolfRollAttackInit__9daAlink_cFii /* constant-address: 8013B2A0, symbol: procWolfRollAttackInit__9daAlink_cFii */
/* 801365C4  80 1E 31 A0 */	lwz r0, 0x31a0(r30)                     
/* 801365C8  60 00 00 08 */	ori r0, r0, 8                           
/* 801365CC  90 1E 31 A0 */	stw r0, 0x31a0(r30)                     
/* 801365D0  48 00 00 38 */	b lbl_80136608                           /* constant-address: 80136608, symbol: lbl_80136608 */
lbl_801365D4:
/* 801365D4  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 801365D8  C0 1E 34 78 */	lfs f0, 0x3478(r30)                     
/* 801365DC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 801365E0  40 81 00 28 */	ble lbl_80136608                         /* constant-address: 80136608, symbol: lbl_80136608 */
...
/* 801365F4  4B FF 35 51 */	bl checkNextActionWolf__9daAlink_cFi     /* constant-address: 80129B44, symbol: checkNextActionWolf__9daAlink_cFi */
/* 801365F8  2C 03 00 00 */	cmpwi r3, 0                             
/* 801365FC  40 82 00 0C */	bne lbl_80136608                         /* constant-address: 80136608, symbol: lbl_80136608 */

...
/* 800FF71C  4B FF F1 4D */	bl setMoveBGClimbCorrect__9daAlink_cFv   /* constant-address: 800FE868, symbol: setMoveBGClimbCorrect__9daAlink_cFv */
/* 800FF720  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF724  41 82 00 0C */	beq lbl_800FF730                         /* constant-address: 800FF730, symbol: lbl_800FF730 */
/* 800FF728  38 60 00 01 */	li r3, 1                                
/* 800FF72C  48 00 00 D4 */	b lbl_800FF800                           /* constant-address: 800FF800, symbol: lbl_800FF800 */
lbl_800FF730:
...
/* 800FF754  48 16 74 31 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 800FF768  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800FF76C  EC 20 08 28 */	fsubs f1, f0, f1                        
/* 800FF770  48 16 74 15 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
/* 800FF774  38 61 00 08 */	addi r3, r1, 8                          
/* 800FF778  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800FF77C  38 A1 00 14 */	addi r5, r1, 0x14                       
/* 800FF780  48 16 73 65 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
...
/* 800FF7A8  4B FF E9 CD */	bl setClimbShapeOffset__9daAlink_cFv     /* constant-address: 800FE174, symbol: setClimbShapeOffset__9daAlink_cFv */
/* 800FF7AC  7F C3 F3 78 */	mr r3, r30                              
/* 800FF7B0  4B FF DE 35 */	bl checkLadderFall__9daAlink_cFv         /* constant-address: 800FD5E4, symbol: checkLadderFall__9daAlink_cFv */
/* 800FF7B4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF7B8  40 82 00 44 */	bne lbl_800FF7FC                         /* constant-address: 800FF7FC, symbol: lbl_800FF7FC */
/* 800FF7BC  7F E3 FB 78 */	mr r3, r31                              
/* 800FF7C0  48 05 ED 0D */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800FF7C4  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FF7C8  40 82 00 24 */	bne lbl_800FF7EC                         /* constant-address: 800FF7EC, symbol: lbl_800FF7EC */
/* 800FF7CC  C0 3E 33 AC */	lfs f1, 0x33ac(r30)                     
/* 800FF7D0  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 800FF7D4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FF7D8  40 81 00 24 */	ble lbl_800FF7FC                         /* constant-address: 800FF7FC, symbol: lbl_800FF7FC */
/* 800FF7DC  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 800FF7E0  C0 1E 34 78 */	lfs f0, 0x3478(r30)                     
/* 800FF7E4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FF7E8  40 81 00 14 */	ble lbl_800FF7FC                         /* constant-address: 800FF7FC, symbol: lbl_800FF7FC */
lbl_800FF7EC:
/* 800FF7EC  7F C3 F3 78 */	mr r3, r30                              
/* 800FF7F0  38 80 00 00 */	li r4, 0                                
/* 800FF7F4  38 A0 00 00 */	li r5, 0                                
/* 800FF7F8  48 00 09 01 */	bl procClimbWaitInit__9daAlink_cFii      /* constant-address: 801000F8, symbol: procClimbWaitInit__9daAlink_cFii */
lbl_800FF7FC:

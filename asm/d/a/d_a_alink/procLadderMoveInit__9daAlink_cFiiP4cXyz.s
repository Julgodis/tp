...
/* 800FDDA4 00000000  39 61 00 20 */	addi r11, r1, 0x20
/* 800FDDA8 00000004  48 26 44 2D */	bl _savegpr_27
/* 800FDDAC 00000008  7C 7B 1B 78 */	mr r27, r3
/* 800FDDB0 0000000C  7C 9C 23 78 */	mr r28, r4
/* 800FDDB4 00000010  7C BD 2B 78 */	mr r29, r5
/* 800FDDB8 00000014  7C DE 33 78 */	mr r30, r6
/* 800FDDBC 00000018  80 03 31 A0 */	lwz r0, 0x31a0(r3)
/* 800FDDC0 0000001C  54 1F FF FE */	rlwinm r31, r0, 0x1f, 0x1f, 0x1f
/* 800FDDC4 00000020  4B FF F4 C5 */	bl getLadderMoveAnmSpeed__9daAlink_cFv
/* 800FDDC8 00000024  FF E0 08 90 */	fmr f31, f1
/* 800FDDCC 00000028  7F 63 DB 78 */	mr r3, r27
/* 800FDDD0 0000002C  38 80 00 6B */	li r4, 0x6b
/* 800FDDD4 00000030  4B FC 41 99 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC
/* 800FDDD8 00000034  2C 1F 00 00 */	cmpwi r31, 0
/* 800FDDDC 00000038  40 82 00 3C */	bne lbl_800FDE18
/* 800FDDE0 0000003C  2C 1D 00 00 */	cmpwi r29, 0
/* 800FDDE4 00000040  40 82 00 18 */	bne lbl_800FDDFC
/* 800FDDE8 00000044  C0 22 95 84 */	lfs f1, lit_24618(r2)
/* 800FDDEC 00000048  C0 1E 00 04 */	lfs f0, 4(r30)
/* 800FDDF0 0000004C  EC 01 00 2A */	fadds f0, f1, f0
/* 800FDDF4 00000050  D0 1B 37 CC */	stfs f0, 0x37cc(r27)
/* 800FDDF8 00000054  48 00 00 28 */	b lbl_800FDE20
lbl_800FDDFC:
/* 800FDDFC 00000000  C0 02 92 BC */	lfs f0, lit_6041(r2)
...
/* 800FDE5C 00000000  4C 41 13 82 */	cror 2, 1, 2
/* 800FDE60 00000004  40 82 00 0C */	bne lbl_800FDE6C
/* 800FDE64 00000008  38 80 00 A0 */	li r4, 0xa0
/* 800FDE68 0000000C  48 00 00 30 */	b lbl_800FDE98
lbl_800FDE6C:
...
/* 800FDE84 00000000  4C 41 13 82 */	cror 2, 1, 2
/* 800FDE88 00000004  40 82 00 0C */	bne lbl_800FDE94
/* 800FDE8C 00000008  38 80 00 9F */	li r4, 0x9f
/* 800FDE90 0000000C  48 00 00 08 */	b lbl_800FDE98
lbl_800FDE94:
...
/* 800FDEA8 00000010  C0 45 00 50 */	lfs f2, 0x50(r5)	/* effective address: 8038EBDC */
...
/* 800FDEC4 0000002C  C0 02 92 BC */	lfs f0, lit_6041(r2)
...
/* 800FDED8 00000008  C0 02 92 B8 */	lfs f0, lit_6040(r2)
...
/* 800FDF20 00000040  80 03 5F 18 */	lwz r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
/* 800FDF24 00000044  64 00 02 00 */	oris r0, r0, 0x200
/* 800FDF28 00000048  90 03 5F 18 */	stw r0, 0x5f18(r3)	/* effective address: 8040C0D8 */
/* 800FDF2C 0000004C  38 60 00 01 */	li r3, 1
/* 800FDF30 00000050  E3 E1 00 28 */	psq_l f31, 40(r1), 0, 0 /* qr0 */
/* 800FDF34 00000000  CB E1 00 20 */	lfd f31, 0x20(r1)
/* 800FDF38 00000004  39 61 00 20 */	addi r11, r1, 0x20
/* 800FDF3C 00000008  48 26 42 E5 */	bl _restgpr_27
/* 800FDF40 0000000C  80 01 00 34 */	lwz r0, 0x34(r1)
/* 800FDF44 00000010  7C 08 03 A6 */	mtlr r0
/* 800FDF48 00000014  38 21 00 30 */	addi r1, r1, 0x30
/* 800FDF4C 00000018  4E 80 00 20 */	blr 

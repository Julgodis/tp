...
/* 800C518C  4B FF CD E1 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800C5190  7F C3 F3 78 */	mr r3, r30                              
/* 800C5194  38 80 00 25 */	li r4, 0x25                             
/* 800C5198  3C A0 80 39 */	lis r5, m__23daAlinkHIO_frontRoll_c0@ha 
/* 800C519C  38 A5 D7 BC */	addi r5, r5, m__23daAlinkHIO_frontRoll_c0@l /* constant-address: 8038D7BC, symbol: m__23daAlinkHIO_frontRoll_c0 */
/* 800C51A0  38 A5 00 28 */	addi r5, r5, 0x28                        /* constant-address: 8038D7E4, symbol: None */
/* 800C51A4  4B FE 7F 51 */	bl setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c /* constant-address: 800AD0F4, symbol: setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c */
/* 800C51A8  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C51AC  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 800C51B0  2C 1F 00 00 */	cmpwi r31, 0                            
/* 800C51B4  40 82 00 20 */	bne lbl_800C51D4                         /* constant-address: 800C51D4, symbol: lbl_800C51D4 */
/* 800C51B8  7F C3 F3 78 */	mr r3, r30                              
/* 800C51BC  88 9E 2F A4 */	lbz r4, 0x2fa4(r30)                     
/* 800C51C0  4B FF CB 2D */	bl setFrontRollCrashShock__9daAlink_cFUc /* constant-address: 800C1CEC, symbol: setFrontRollCrashShock__9daAlink_cFUc */
/* 800C51C4  80 1E 05 80 */	lwz r0, 0x580(r30)                      
/* 800C51C8  60 00 20 00 */	ori r0, r0, 0x2000                      
/* 800C51CC  90 1E 05 80 */	stw r0, 0x580(r30)                      
/* 800C51D0  48 00 00 14 */	b lbl_800C51E4                           /* constant-address: 800C51E4, symbol: lbl_800C51E4 */
lbl_800C51D4:
/* 800C51D4  C0 02 92 C4 */	lfs f0, lit_6109(r2)                     /* constant-address: 80452CC4, symbol: lit_6109 */
...
/* 800C51E8  C4 03 55 44 */	lfsu f0, l_halfAtnWaitBaseAnime@l(r3)    /* constant-address: 80425544, symbol: l_halfAtnWaitBaseAnime */
/* 800C51EC  D0 1E 35 88 */	stfs f0, 0x3588(r30)                    
/* 800C51F0  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425548, symbol: None */
/* 800C51F4  D0 1E 35 8C */	stfs f0, 0x358c(r30)                    
/* 800C51F8  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042554C, symbol: None */
...
/* 800C5210  48 05 BF B1 */	bl setFootEffectProcType__9daAlink_cFi   /* constant-address: 801211C0, symbol: setFootEffectProcType__9daAlink_cFi */

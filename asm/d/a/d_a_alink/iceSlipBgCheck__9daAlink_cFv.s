...
/* 800A6DF8  41 82 02 34 */	beq lbl_800A702C                         /* constant-address: 800A702C, symbol: lbl_800A702C */
/* 800A6DFC  80 1F 31 A0 */	lwz r0, 0x31a0(r31)                     
/* 800A6E00  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 800A6E04  41 82 02 28 */	beq lbl_800A702C                         /* constant-address: 800A702C, symbol: lbl_800A702C */
/* 800A6E08  C0 3F 35 CC */	lfs f1, 0x35cc(r31)                     
/* 800A6E0C  C0 1F 35 C4 */	lfs f0, 0x35c4(r31)                     
/* 800A6E10  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800A6E14  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800A6E18  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 800A6E1C  D0 21 00 14 */	stfs f1, 0x14(r1)                       
/* 800A6E20  38 61 00 0C */	addi r3, r1, 0xc                        
/* 800A6E24  48 2A 03 15 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 800A6E28  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800A6E2C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800A6E30  40 81 00 58 */	ble lbl_800A6E88                         /* constant-address: 800A6E88, symbol: lbl_800A6E88 */
/* 800A6E34  FC 00 08 34 */	frsqrte f0, f1                          
/* 800A6E38  C8 82 92 E8 */	lfd f4, lit_6846(r2)                     /* constant-address: 80452CE8, symbol: lit_6846 */
/* 800A6E3C  FC 44 00 32 */	fmul f2, f4, f0                         
/* 800A6E40  C8 62 92 F0 */	lfd f3, lit_6847(r2)                     /* constant-address: 80452CF0, symbol: lit_6847 */
...
/* 800A6E84  48 00 00 90 */	b lbl_800A6F14                           /* constant-address: 800A6F14, symbol: lbl_800A6F14 */
lbl_800A6E88:
/* 800A6E88  C8 02 92 F8 */	lfd f0, lit_6848(r2)                     /* constant-address: 80452CF8, symbol: lit_6848 */
/* 800A6E8C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800A6E90  40 80 00 10 */	bge lbl_800A6EA0                         /* constant-address: 800A6EA0, symbol: lbl_800A6EA0 */
/* 800A6E94  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 800A6E98  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)               /* constant-address: 80450AE0, symbol: __float_nan */
/* 800A6E9C  48 00 00 78 */	b lbl_800A6F14                           /* constant-address: 800A6F14, symbol: lbl_800A6F14 */
lbl_800A6EA0:
...
/* 800A6EB4  41 82 00 14 */	beq lbl_800A6EC8                         /* constant-address: 800A6EC8, symbol: lbl_800A6EC8 */
/* 800A6EB8  40 80 00 40 */	bge lbl_800A6EF8                         /* constant-address: 800A6EF8, symbol: lbl_800A6EF8 */
/* 800A6EBC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A6EC0  41 82 00 20 */	beq lbl_800A6EE0                         /* constant-address: 800A6EE0, symbol: lbl_800A6EE0 */
/* 800A6EC4  48 00 00 34 */	b lbl_800A6EF8                           /* constant-address: 800A6EF8, symbol: lbl_800A6EF8 */
lbl_800A6EC8:
/* 800A6EC8  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 800A6ECC  41 82 00 0C */	beq lbl_800A6ED8                         /* constant-address: 800A6ED8, symbol: lbl_800A6ED8 */
/* 800A6ED0  38 00 00 01 */	li r0, 1                                
/* 800A6ED4  48 00 00 28 */	b lbl_800A6EFC                           /* constant-address: 800A6EFC, symbol: lbl_800A6EFC */
lbl_800A6ED8:
/* 800A6ED8  38 00 00 02 */	li r0, 2                                
/* 800A6EDC  48 00 00 20 */	b lbl_800A6EFC                           /* constant-address: 800A6EFC, symbol: lbl_800A6EFC */
lbl_800A6EE0:
/* 800A6EE0  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 800A6EE4  41 82 00 0C */	beq lbl_800A6EF0                         /* constant-address: 800A6EF0, symbol: lbl_800A6EF0 */
/* 800A6EE8  38 00 00 05 */	li r0, 5                                
/* 800A6EEC  48 00 00 10 */	b lbl_800A6EFC                           /* constant-address: 800A6EFC, symbol: lbl_800A6EFC */
lbl_800A6EF0:
/* 800A6EF0  38 00 00 03 */	li r0, 3                                
/* 800A6EF4  48 00 00 08 */	b lbl_800A6EFC                           /* constant-address: 800A6EFC, symbol: lbl_800A6EFC */
lbl_800A6EF8:
/* 800A6EF8  38 00 00 04 */	li r0, 4                                
lbl_800A6EFC:
/* 800A6EFC  2C 00 00 01 */	cmpwi r0, 1                             
/* 800A6F00  40 82 00 10 */	bne lbl_800A6F10                         /* constant-address: 800A6F10, symbol: lbl_800A6F10 */
/* 800A6F04  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 800A6F08  C3 C3 0A E0 */	lfs f30, __float_nan@l(r3)               /* constant-address: 80450AE0, symbol: __float_nan */
/* 800A6F0C  48 00 00 08 */	b lbl_800A6F14                           /* constant-address: 800A6F14, symbol: lbl_800A6F14 */
lbl_800A6F10:
/* 800A6F10  FF C0 08 90 */	fmr f30, f1                             
lbl_800A6F14:
/* 800A6F14  C0 02 93 A0 */	lfs f0, lit_9054(r2)                     /* constant-address: 80452DA0, symbol: lit_9054 */
/* 800A6F18  FC 1E 00 40 */	fcmpo cr0, f30, f0                      
/* 800A6F1C  40 81 01 10 */	ble lbl_800A702C                         /* constant-address: 800A702C, symbol: lbl_800A702C */
/* 800A6F20  C0 7F 37 A0 */	lfs f3, 0x37a0(r31)                     
/* 800A6F24  C0 22 93 30 */	lfs f1, lit_7625(r2)                     /* constant-address: 80452D30, symbol: lit_7625 */
...
/* 800A6F68  41 82 00 40 */	beq lbl_800A6FA8                         /* constant-address: 800A6FA8, symbol: lbl_800A6FA8 */
/* 800A6F6C  38 7F 35 C4 */	addi r3, r31, 0x35c4                    
/* 800A6F70  48 1C 01 B9 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 800A6F74  A8 1F 04 E6 */	lha r0, 0x4e6(r31)                      
/* 800A6F78  7C 00 18 50 */	subf r0, r0, r3                         
/* 800A6F7C  C0 02 94 68 */	lfs f0, lit_14955(r2)                    /* constant-address: 80452E68, symbol: lit_14955 */
/* 800A6F80  EC 20 F8 28 */	fsubs f1, f0, f31                       
/* 800A6F84  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800A6F88  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
lbl_800A6FA8:
/* 800A6FA8  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800A6FE8  4B FF B1 B1 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800A6FEC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800A6FF0  41 82 00 3C */	beq lbl_800A702C                         /* constant-address: 800A702C, symbol: lbl_800A702C */
/* 800A6FF4  38 7F 1B 5C */	addi r3, r31, 0x1b5c                    
/* 800A6FF8  4B FC ED 15 */	bl dBgS_CheckBWallPoly__FRC13cBgS_PolyInfo /* constant-address: 80075D0C, symbol: dBgS_CheckBWallPoly__FRC13cBgS_PolyInfo */
/* 800A6FFC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800A7000  41 82 00 2C */	beq lbl_800A702C                         /* constant-address: 800A702C, symbol: lbl_800A702C */

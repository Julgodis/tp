...
/* 800A29EC  48 2B F7 DD */	bl _savegpr_24                           /* constant-address: 803621C8, symbol: _savegpr_24 */
/* 800A29F0  7C 79 1B 78 */	mr r25, r3                              
/* 800A29F4  3C 60 80 39 */	lis r3, lit_3757@ha                     
/* 800A29F8  3B A3 D6 58 */	addi r29, r3, lit_3757@l                 /* constant-address: 8038D658, symbol: lit_3757 */
/* 800A29FC  3B 99 29 04 */	addi r28, r25, 0x2904                   
/* 800A2A00  3B C0 00 00 */	li r30, 0                               
/* 800A2A04  3B 00 00 00 */	li r24, 0                               
/* 800A2A08  3B 62 98 2C */	la r27, data_8045322C(r2) /* 8045322C-_SDA2_BASE_ */ /* constant-address: 8045322C, symbol: data_8045322C */
lbl_800A2A0C:
...
/* 800A2A20  7C 1B C2 2E */	lhzx r0, r27, r24                        /* constant-address: 8045322C, symbol: data_8045322C */
...
/* 800A2A38  48 2A 3A 79 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 800A2A3C  3B FF 00 01 */	addi r31, r31, 1                        
/* 800A2A40  2C 1F 00 03 */	cmpwi r31, 3                            
/* 800A2A44  3B 5A 00 30 */	addi r26, r26, 0x30                     
/* 800A2A48  41 80 FF CC */	blt lbl_800A2A14                         /* constant-address: 800A2A14, symbol: lbl_800A2A14 */
/* 800A2A4C  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
/* 800A2A50  2C 1E 00 02 */	cmpwi r30, 2                            
/* 800A2A54  3B 18 00 02 */	addi r24, r24, 2                         /* constant-address: 00000002 */
/* 800A2A58  3B 9C 00 A4 */	addi r28, r28, 0xa4                     
/* 800A2A5C  41 80 FF B0 */	blt lbl_800A2A0C                         /* constant-address: 800A2A0C, symbol: lbl_800A2A0C */
/* 800A2A60  80 79 20 60 */	lwz r3, 0x2060(r25)                     
/* 800A2A64  88 03 00 00 */	lbz r0, 0(r3)                           
/* 800A2A68  28 00 00 00 */	cmplwi r0, 0                            
/* 800A2A6C  40 82 00 0C */	bne lbl_800A2A78                         /* constant-address: 800A2A78, symbol: lbl_800A2A78 */
/* 800A2A70  38 60 00 00 */	li r3, 0                                
/* 800A2A74  48 00 01 98 */	b lbl_800A2C0C                           /* constant-address: 800A2C0C, symbol: lbl_800A2C0C */
lbl_800A2A78:
/* 800A2A78  3B 79 29 04 */	addi r27, r25, 0x2904                   
/* 800A2A7C  A0 19 2F E8 */	lhz r0, 0x2fe8(r25)                     
/* 800A2A80  28 00 00 3B */	cmplwi r0, 0x3b                         
/* 800A2A84  40 82 00 34 */	bne lbl_800A2AB8                         /* constant-address: 800A2AB8, symbol: lbl_800A2AB8 */
...
/* 800A2A98  40 82 00 14 */	bne lbl_800A2AAC                         /* constant-address: 800A2AAC, symbol: lbl_800A2AAC */
/* 800A2A9C  A8 79 04 E6 */	lha r3, 0x4e6(r25)                      
/* 800A2AA0  38 03 C0 00 */	addi r0, r3, -16384                     
/* 800A2AA4  B0 19 04 E6 */	sth r0, 0x4e6(r25)                      
/* 800A2AA8  48 00 00 10 */	b lbl_800A2AB8                           /* constant-address: 800A2AB8, symbol: lbl_800A2AB8 */
lbl_800A2AAC:
...
/* 800A2AC0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A2AC4  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l    /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A2AC8  7F DF F3 78 */	mr r31, r30                             
lbl_800A2ACC:
/* 800A2ACC  38 62 98 2C */	la r3, data_8045322C(r2) /* 8045322C-_SDA2_BASE_ */ /* constant-address: 8045322C, symbol: data_8045322C */
...
/* 800A2B00  4B FF B1 6D */	bl setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz /* constant-address: 8009DC6C, symbol: setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz */
/* 800A2B04  7F C3 F3 78 */	mr r3, r30                              
/* 800A2B08  38 9D 48 80 */	addi r4, r29, 0x4880                     /* constant-address: 80391ED8, symbol: data_80391ED8 */
/* 800A2B0C  38 A1 00 08 */	addi r5, r1, 8                          
/* 800A2B10  48 2A 42 5D */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A2B4C  4B FF B1 21 */	bl setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz /* constant-address: 8009DC6C, symbol: setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz */
/* 800A2B50  7F C3 F3 78 */	mr r3, r30                              
/* 800A2B54  38 9D 48 8C */	addi r4, r29, 0x488c                     /* constant-address: 80391EE4, symbol: data_80391EE4 */
/* 800A2B58  38 A1 00 08 */	addi r5, r1, 8                          
/* 800A2B5C  48 2A 42 11 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A2B94  4B FF B0 D9 */	bl setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz /* constant-address: 8009DC6C, symbol: setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz */
/* 800A2B98  7F E3 FB 78 */	mr r3, r31                              
/* 800A2B9C  38 9D 48 98 */	addi r4, r29, 0x4898                     /* constant-address: 80391EF0, symbol: data_80391EF0 */
/* 800A2BA0  38 A1 00 08 */	addi r5, r1, 8                          
/* 800A2BA4  48 2A 41 C9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
...
/* 800A2BDC  4B FF B0 91 */	bl setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz /* constant-address: 8009DC6C, symbol: setMatrixWorldAxisRot__9daAlink_cFPA4_fsssiPC4cXyz */
...
/* 800A2BF0  41 80 FE DC */	blt lbl_800A2ACC                         /* constant-address: 800A2ACC, symbol: lbl_800A2ACC */
/* 800A2BF4  A0 19 2F E8 */	lhz r0, 0x2fe8(r25)                     
/* 800A2BF8  28 00 00 3B */	cmplwi r0, 0x3b                         
/* 800A2BFC  40 82 00 0C */	bne lbl_800A2C08                         /* constant-address: 800A2C08, symbol: lbl_800A2C08 */
...
/* 800A2C10  48 2B F6 05 */	bl _restgpr_24                           /* constant-address: 80362214, symbol: _restgpr_24 */

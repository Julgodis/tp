...
/* 80140584  40 82 00 B0 */	bne lbl_80140634                         /* constant-address: 80140634, symbol: lbl_80140634 */
...
/* 801405CC  38 63 EF F0 */	addi r3, r3, daAlink_wolfModelCallBack__FP8J3DJointi@l /* constant-address: 8009EFF0, symbol: daAlink_wolfModelCallBack__FP8J3DJointi */
/* 801405D0  48 00 00 1C */	b lbl_801405EC                           /* constant-address: 801405EC, symbol: lbl_801405EC */
lbl_801405D4:
...
/* 801405E8  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
lbl_801405EC:
/* 801405EC  54 C0 04 3E */	clrlwi r0, r6, 0x10                     
/* 801405F0  28 00 00 28 */	cmplwi r0, 0x28                         
/* 801405F4  41 80 FF E0 */	blt lbl_801405D4                         /* constant-address: 801405D4, symbol: lbl_801405D4 */
/* 801405F8  2C 04 00 00 */	cmpwi r4, 0                             
/* 801405FC  41 82 00 98 */	beq lbl_80140694                         /* constant-address: 80140694, symbol: lbl_80140694 */
/* 80140600  80 9F 21 54 */	lwz r4, 0x2154(r31)                     
/* 80140604  28 04 00 00 */	cmplwi r4, 0                            
/* 80140608  41 82 00 10 */	beq lbl_80140618                         /* constant-address: 80140618, symbol: lbl_80140618 */
/* 8014060C  80 7F 06 C0 */	lwz r3, 0x6c0(r31)                      
/* 80140610  38 63 00 58 */	addi r3, r3, 0x58                       
/* 80140614  48 1E F5 B5 */	bl entryTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern /* constant-address: 8032FBC8, symbol: entryTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern */
lbl_80140618:
/* 80140618  80 9F 21 58 */	lwz r4, 0x2158(r31)                     
/* 8014061C  28 04 00 00 */	cmplwi r4, 0                            
/* 80140620  41 82 00 74 */	beq lbl_80140694                         /* constant-address: 80140694, symbol: lbl_80140694 */
/* 80140624  80 7F 06 C0 */	lwz r3, 0x6c0(r31)                      
/* 80140628  38 63 00 58 */	addi r3, r3, 0x58                       
/* 8014062C  48 1E F6 99 */	bl entryTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey /* constant-address: 8032FCC4, symbol: entryTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey */
/* 80140630  48 00 00 64 */	b lbl_80140694                           /* constant-address: 80140694, symbol: lbl_80140694 */
lbl_80140634:
...
/* 8014066C  48 00 00 1C */	b lbl_80140688                           /* constant-address: 80140688, symbol: lbl_80140688 */
lbl_80140670:
...
/* 80140684  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
lbl_80140688:
/* 80140688  54 A0 04 3E */	clrlwi r0, r5, 0x10                     
/* 8014068C  28 00 00 28 */	cmplwi r0, 0x28                         
/* 80140690  41 80 FF E0 */	blt lbl_80140670                         /* constant-address: 80140670, symbol: lbl_80140670 */
lbl_80140694:

...
/* 800D0E20  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D0E24  88 03 00 14 */	lbz r0, 0x14(r3)                         /* constant-address: 804061D4, symbol: None */
/* 800D0E28  28 00 00 49 */	cmplwi r0, 0x49                         
/* 800D0E2C  40 82 00 4C */	bne lbl_800D0E78                         /* constant-address: 800D0E78, symbol: lbl_800D0E78 */
/* 800D0E30  85 83 4E 20 */	lwzu r12, 0x4e20(r3)                     /* constant-address: 8040AFE0, symbol: None */
/* 800D0E34  81 8C 00 BC */	lwz r12, 0xbc(r12)                      
/* 800D0E38  7D 89 03 A6 */	mtctr r12                               
/* 800D0E3C  4E 80 04 21 */	bctrl                                   
/* 800D0E40  88 03 00 09 */	lbz r0, 9(r3)                            /* constant-address: 8040AFE9, symbol: None */
/* 800D0E44  54 00 FE FE */	rlwinm r0, r0, 0x1f, 0x1b, 0x1f         
/* 800D0E48  2C 00 00 17 */	cmpwi r0, 0x17                          
/* 800D0E4C  41 82 00 1C */	beq lbl_800D0E68                         /* constant-address: 800D0E68, symbol: lbl_800D0E68 */
/* 800D0E50  3C 60 80 0D */	lis r3, daAlink_searchNightStalker__FP10fopAc_ac_cPv@ha
/* 800D0E54  38 63 0D 38 */	addi r3, r3, daAlink_searchNightStalker__FP10fopAc_ac_cPv@l /* constant-address: 800D0D38, symbol: daAlink_searchNightStalker__FP10fopAc_ac_cPv */
/* 800D0E58  38 80 00 00 */	li r4, 0                                
/* 800D0E5C  4B F4 89 9D */	bl fopAcIt_Judge__FPFPvPv_PvPv           /* constant-address: 800197F8, symbol: fopAcIt_Judge__FPFPvPv_PvPv */
/* 800D0E60  28 03 00 00 */	cmplwi r3, 0                            
/* 800D0E64  41 82 00 14 */	beq lbl_800D0E78                         /* constant-address: 800D0E78, symbol: lbl_800D0E78 */
lbl_800D0E68:
/* 800D0E68  80 1F 05 7C */	lwz r0, 0x57c(r31)                      
/* 800D0E6C  64 00 00 10 */	oris r0, r0, 0x10                       
/* 800D0E70  90 1F 05 7C */	stw r0, 0x57c(r31)                      
/* 800D0E74  48 00 00 10 */	b lbl_800D0E84                           /* constant-address: 800D0E84, symbol: lbl_800D0E84 */
lbl_800D0E78:

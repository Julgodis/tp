...
/* 800F45B4  48 26 DC 29 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 800F45C8  40 82 00 40 */	bne lbl_800F4608                         /* constant-address: 800F4608, symbol: lbl_800F4608 */
...
/* 800F45D8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800F45DC  48 25 1E D5 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 800F45E0  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800F45E4  FC 40 08 90 */	fmr f2, f1                              
/* 800F45E8  C0 62 95 18 */	lfs f3, lit_20824(r2)                    /* constant-address: 80452F18, symbol: lit_20824 */
/* 800F45EC  4B F1 87 B1 */	bl transM__14mDoMtx_stack_cFfff          /* constant-address: 8000CD9C, symbol: transM__14mDoMtx_stack_cFfff */
/* 800F45F0  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800F45F4  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800F45F8  80 9E 38 4C */	lwz r4, 0x384c(r30)                     
/* 800F45FC  38 BE 04 D0 */	addi r5, r30, 0x4d0                     
/* 800F4600  48 25 27 6D */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800F4604  48 00 00 18 */	b lbl_800F461C                           /* constant-address: 800F461C, symbol: lbl_800F461C */
lbl_800F4608:
...
/* 800F4618  48 25 27 55 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
lbl_800F461C:
...
/* 800F463C  41 82 00 1C */	beq lbl_800F4658                         /* constant-address: 800F4658, symbol: lbl_800F4658 */
/* 800F4640  28 00 00 99 */	cmplwi r0, 0x99                         
/* 800F4644  41 82 00 14 */	beq lbl_800F4658                         /* constant-address: 800F4658, symbol: lbl_800F4658 */
/* 800F4648  28 00 00 9C */	cmplwi r0, 0x9c                         
/* 800F464C  41 82 00 0C */	beq lbl_800F4658                         /* constant-address: 800F4658, symbol: lbl_800F4658 */
/* 800F4650  28 00 00 9E */	cmplwi r0, 0x9e                         
/* 800F4654  40 82 00 44 */	bne lbl_800F4698                         /* constant-address: 800F4698, symbol: lbl_800F4698 */
lbl_800F4658:
...
/* 800F4678  48 17 BE C9 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
...
/* 800F4690  48 17 BE B1 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
/* 800F4694  48 00 00 2C */	b lbl_800F46C0                           /* constant-address: 800F46C0, symbol: lbl_800F46C0 */
lbl_800F4698:
...
/* 800F46DC  48 17 BE 65 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
/* 800F46E0  C0 3F 05 2C */	lfs f1, 0x52c(r31)                      
/* 800F46E4  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800F46E8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800F46EC  40 80 00 10 */	bge lbl_800F46FC                         /* constant-address: 800F46FC, symbol: lbl_800F46FC */
/* 800F46F0  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800F46F4  28 00 00 8F */	cmplwi r0, 0x8f                         
/* 800F46F8  41 82 00 1C */	beq lbl_800F4714                         /* constant-address: 800F4714, symbol: lbl_800F4714 */
lbl_800F46FC:
/* 800F46FC  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800F4700  28 00 00 90 */	cmplwi r0, 0x90                         
/* 800F4704  40 82 00 34 */	bne lbl_800F4738                         /* constant-address: 800F4738, symbol: lbl_800F4738 */
/* 800F4708  A8 1E 30 0E */	lha r0, 0x300e(r30)                     
/* 800F470C  2C 00 00 01 */	cmpwi r0, 1                             
/* 800F4710  40 82 00 28 */	bne lbl_800F4738                         /* constant-address: 800F4738, symbol: lbl_800F4738 */
lbl_800F4714:
/* 800F4714  A8 1E 30 12 */	lha r0, 0x3012(r30)                     
/* 800F4718  2C 00 00 00 */	cmpwi r0, 0                             
/* 800F471C  40 82 00 10 */	bne lbl_800F472C                         /* constant-address: 800F472C, symbol: lbl_800F472C */
/* 800F4720  38 80 50 00 */	li r4, 0x5000                           
/* 800F4724  C3 E2 92 B8 */	lfs f31, lit_6040(r2)                    /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800F4728  48 00 00 64 */	b lbl_800F478C                           /* constant-address: 800F478C, symbol: lbl_800F478C */
lbl_800F472C:
/* 800F472C  38 80 B0 00 */	li r4, -20480                           
/* 800F4730  C3 E2 92 BC */	lfs f31, lit_6041(r2)                    /* constant-address: 80452CBC, symbol: lit_6041 */
/* 800F4734  48 00 00 58 */	b lbl_800F478C                           /* constant-address: 800F478C, symbol: lbl_800F478C */
lbl_800F4738:
/* 800F4738  7F C3 F3 78 */	mr r3, r30                              
/* 800F473C  4B FC 4B 19 */	bl checkNoUpperAnime__9daAlink_cCFv      /* constant-address: 800B9254, symbol: checkNoUpperAnime__9daAlink_cCFv */
/* 800F4740  2C 03 00 00 */	cmpwi r3, 0                             
/* 800F4744  40 82 00 10 */	bne lbl_800F4754                         /* constant-address: 800F4754, symbol: lbl_800F4754 */
/* 800F4748  38 80 00 00 */	li r4, 0                                
/* 800F474C  C3 E2 92 C0 */	lfs f31, lit_6108(r2)                    /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800F4750  48 00 00 3C */	b lbl_800F478C                           /* constant-address: 800F478C, symbol: lbl_800F478C */
lbl_800F4754:
/* 800F4754  38 80 00 00 */	li r4, 0                                
/* 800F4758  C0 42 94 78 */	lfs f2, lit_15460(r2)                    /* constant-address: 80452E78, symbol: lit_15460 */
...
/* 800F476C  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800F479C  48 06 B1 E1 */	bl daPy_addCalcShort__FPsssss            /* constant-address: 8015F97C, symbol: daPy_addCalcShort__FPsssss */
...
/* 800F47B0  C0 42 93 F8 */	lfs f2, lit_13700(r2)                    /* constant-address: 80452DF8, symbol: lit_13700 */
/* 800F47B4  48 17 BF 8D */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
/* 800F47B8  E3 E1 00 28 */	psq_l f31, 40(r1), 0, 0 /* qr0 */       
/* 800F47BC  CB E1 00 20 */	lfd f31, 0x20(r1)                       
/* 800F47C0  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800F47C4  48 26 DA 65 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 800FF2C0  40 82 01 3C */	bne lbl_800FF3FC                         /* constant-address: 800FF3FC, symbol: lbl_800FF3FC */
...
/* 800FF2D4  48 16 8A 55 */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800FF2D8  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800FF2DC  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FF2E0  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 800FF2E4  38 9F 1D 08 */	addi r4, r31, 0x1d08                    
/* 800FF2E8  4B F7 51 B9 */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
...
/* 800FF2FC  40 80 00 0C */	bge lbl_800FF308                         /* constant-address: 800FF308, symbol: lbl_800FF308 */
/* 800FF300  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)                     
/* 800FF304  48 00 00 18 */	b lbl_800FF31C                           /* constant-address: 800FF31C, symbol: lbl_800FF31C */
lbl_800FF308:
/* 800FF308  C0 02 93 3C */	lfs f0, lit_7808(r2)                     /* constant-address: 80452D3C, symbol: lit_7808 */
/* 800FF30C  EC 00 08 2A */	fadds f0, f0, f1                        
/* 800FF310  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)                     
/* 800FF314  38 60 00 00 */	li r3, 0                                
/* 800FF318  48 00 01 0C */	b lbl_800FF424                           /* constant-address: 800FF424, symbol: lbl_800FF424 */
lbl_800FF31C:
...
/* 800FF328  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800FF32C  7C C3 04 2E */	lfsx f6, r3, r0                         
/* 800FF330  7C 63 02 14 */	add r3, r3, r0                          
/* 800FF334  C0 E3 00 04 */	lfs f7, 4(r3)                           
/* 800FF338  C0 22 93 3C */	lfs f1, lit_7808(r2)                     /* constant-address: 80452D3C, symbol: lit_7808 */
/* 800FF33C  C0 1F 05 98 */	lfs f0, 0x598(r31)                      
/* 800FF340  EC 01 00 2A */	fadds f0, f1, f0                        
/* 800FF344  C0 42 93 B4 */	lfs f2, lit_10040(r2)                    /* constant-address: 80452DB4, symbol: lit_10040 */
/* 800FF348  EF E0 10 28 */	fsubs f31, f0, f2                       
/* 800FF34C  C0 7F 37 F4 */	lfs f3, 0x37f4(r31)                     
/* 800FF350  C0 22 92 E0 */	lfs f1, lit_6845(r2)                     /* constant-address: 80452CE0, symbol: lit_6845 */
...
/* 800FF37C  C0 22 93 68 */	lfs f1, lit_8472(r2)                     /* constant-address: 80452D68, symbol: lit_8472 */
...
/* 800FF39C  C3 A2 92 C0 */	lfs f29, lit_6108(r2)                    /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FF3A0  C3 C2 94 64 */	lfs f30, lit_14954(r2)                   /* constant-address: 80452E64, symbol: lit_14954 */
/* 800FF3A4  48 00 00 44 */	b lbl_800FF3E8                           /* constant-address: 800FF3E8, symbol: lbl_800FF3E8 */
lbl_800FF3A8:
/* 800FF3A8  7F E3 FB 78 */	mr r3, r31                              
/* 800FF3AC  38 81 00 14 */	addi r4, r1, 0x14                       
/* 800FF3B0  38 A1 00 08 */	addi r5, r1, 8                          
/* 800FF3B4  4B FA 2D E5 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800FF3B8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FF3BC  41 82 00 18 */	beq lbl_800FF3D4                         /* constant-address: 800FF3D4, symbol: lbl_800FF3D4 */
/* 800FF3C0  7F E3 FB 78 */	mr r3, r31                              
/* 800FF3C4  38 9F 1B 5C */	addi r4, r31, 0x1b5c                    
/* 800FF3C8  4B FF EC 91 */	bl checkClimbCode__9daAlink_cFR13cBgS_PolyInfo /* constant-address: 800FE058, symbol: checkClimbCode__9daAlink_cFR13cBgS_PolyInfo */
/* 800FF3CC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800FF3D0  40 82 00 20 */	bne lbl_800FF3F0                         /* constant-address: 800FF3F0, symbol: lbl_800FF3F0 */
lbl_800FF3D4:
...
/* 800FF3EC  41 80 FF BC */	blt lbl_800FF3A8                         /* constant-address: 800FF3A8, symbol: lbl_800FF3A8 */
lbl_800FF3F0:
...
/* 800FF408  4B FC 1E D5 */	bl deleteEquipItem__9daAlink_cFii        /* constant-address: 800C12DC, symbol: deleteEquipItem__9daAlink_cFii */
...
/* 800FF41C  48 00 00 35 */	bl procClimbUpStartInit__9daAlink_cFi    /* constant-address: 800FF450, symbol: procClimbUpStartInit__9daAlink_cFi */

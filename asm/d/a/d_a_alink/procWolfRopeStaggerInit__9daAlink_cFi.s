...
/* 80133074  4B F8 EE F9 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 80133078  2C 1F 00 04 */	cmpwi r31, 4                            
/* 8013307C  40 82 00 24 */	bne lbl_801330A0                         /* constant-address: 801330A0, symbol: lbl_801330A0 */
/* 80133080  7F C3 F3 78 */	mr r3, r30                              
/* 80133084  38 80 00 25 */	li r4, 0x25                             
/* 80133088  4B FF 65 F1 */	bl setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM /* constant-address: 80129678, symbol: setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM */
/* 8013308C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80133090  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 80133094  38 00 00 01 */	li r0, 1                                
/* 80133098  B0 1E 30 0E */	sth r0, 0x300e(r30)                     
/* 8013309C  48 00 00 34 */	b lbl_801330D0                           /* constant-address: 801330D0, symbol: lbl_801330D0 */
lbl_801330A0:
/* 801330A0  7F C3 F3 78 */	mr r3, r30                              
/* 801330A4  38 80 00 26 */	li r4, 0x26                             
/* 801330A8  4B FF 65 D1 */	bl setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM /* constant-address: 80129678, symbol: setSingleAnimeWolfBase__9daAlink_cFQ29daAlink_c12daAlink_WANM */
/* 801330AC  3C 60 80 42 */	lis r3, l_wolfRopeBaseAnime@ha          
/* 801330B0  C4 03 56 34 */	lfsu f0, l_wolfRopeBaseAnime@l(r3)       /* constant-address: 80425634, symbol: l_wolfRopeBaseAnime */
/* 801330B4  D0 1E 35 88 */	stfs f0, 0x3588(r30)                    
/* 801330B8  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425638, symbol: None */
/* 801330BC  D0 1E 35 8C */	stfs f0, 0x358c(r30)                    
/* 801330C0  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042563C, symbol: None */
...
/* 801330D8  4B FF E9 19 */	bl initWolfRopeShapeAngle__9daAlink_cFv  /* constant-address: 801319F0, symbol: initWolfRopeShapeAngle__9daAlink_cFv */
/* 801330DC  B0 7E 30 0C */	sth r3, 0x300c(r30)                     
/* 801330E0  7F C3 F3 78 */	mr r3, r30                              
/* 801330E4  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 801330E8  C0 5E 05 34 */	lfs f2, 0x534(r30)                      
/* 801330EC  38 80 00 00 */	li r4, 0                                
/* 801330F0  4B F8 86 81 */	bl setSpecialGravity__9daAlink_cFffi     /* constant-address: 800BB770, symbol: setSpecialGravity__9daAlink_cFffi */
/* 801330F4  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 80133110  41 82 00 10 */	beq lbl_80133120                         /* constant-address: 80133120, symbol: lbl_80133120 */
/* 80133114  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 80133118  28 00 02 DB */	cmplwi r0, 0x2db                        
/* 8013311C  40 82 00 08 */	bne lbl_80133124                         /* constant-address: 80133124, symbol: lbl_80133124 */
lbl_80133120:
/* 80133120  38 60 00 01 */	li r3, 1                                
lbl_80133124:
/* 80133124  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80133128  41 82 00 0C */	beq lbl_80133134                         /* constant-address: 80133134, symbol: lbl_80133134 */

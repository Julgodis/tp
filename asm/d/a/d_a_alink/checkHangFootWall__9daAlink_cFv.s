...
/* 800FA5E4  3C 80 80 44 */	lis r4, sincosTable___5JMath@ha         
/* 800FA5E8  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800FA5FC  C0 42 92 E0 */	lfs f2, lit_6845(r2)                     /* constant-address: 80452CE0, symbol: lit_6845 */
/* 800FA600  EC 02 01 F2 */	fmuls f0, f2, f7                        
/* 800FA604  EC A3 00 28 */	fsubs f5, f3, f0                        
/* 800FA608  C0 23 04 D4 */	lfs f1, 0x4d4(r3)                       
/* 800FA60C  C0 02 95 50 */	lfs f0, lit_23595(r2)                    /* constant-address: 80452F50, symbol: lit_23595 */
...
/* 800FA648  4B FA 7B 51 */	bl commonLineCheck__9daAlink_cFP4cXyzP4cXyz /* constant-address: 800A2198, symbol: commonLineCheck__9daAlink_cFP4cXyzP4cXyz */
/* 800FA64C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FA650  41 82 00 70 */	beq lbl_800FA6C0                         /* constant-address: 800FA6C0, symbol: lbl_800FA6C0 */
/* 800FA654  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FA658  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800FA65C  90 01 00 30 */	stw r0, 0x30(r1)                        
/* 800FA660  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800FA664  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FA668  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 800FA66C  38 9F 1B 5C */	addi r4, r31, 0x1b5c                    
/* 800FA670  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800FA674  4B F7 A0 D1 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 800FA678  C0 01 00 24 */	lfs f0, 0x24(r1)                        
/* 800FA67C  FC 00 02 10 */	fabs f0, f0                             
/* 800FA680  FC 20 00 18 */	frsp f1, f0                             
/* 800FA684  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 800FA688  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FA68C  4C 40 13 82 */	cror 2, 0, 2                            
/* 800FA690  40 82 00 24 */	bne lbl_800FA6B4                         /* constant-address: 800FA6B4, symbol: lbl_800FA6B4 */
/* 800FA694  80 1F 05 78 */	lwz r0, 0x578(r31)                      
/* 800FA698  60 00 20 00 */	ori r0, r0, 0x2000                      
/* 800FA69C  90 1F 05 78 */	stw r0, 0x578(r31)                      
/* 800FA6A0  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FA6A4  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800FA6A8  90 01 00 30 */	stw r0, 0x30(r1)                        
/* 800FA6AC  38 60 00 01 */	li r3, 1                                
/* 800FA6B0  48 00 00 20 */	b lbl_800FA6D0                           /* constant-address: 800FA6D0, symbol: lbl_800FA6D0 */
lbl_800FA6B4:
/* 800FA6B4  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800FA6B8  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */

...
/* 800FC5C0  40 82 00 0C */	bne lbl_800FC5CC                         /* constant-address: 800FC5CC, symbol: lbl_800FC5CC */
/* 800FC5C4  38 60 00 00 */	li r3, 0                                
/* 800FC5C8  48 00 00 D8 */	b lbl_800FC6A0                           /* constant-address: 800FC6A0, symbol: lbl_800FC6A0 */
lbl_800FC5CC:
/* 800FC5CC  A8 03 00 08 */	lha r0, 8(r3)                           
/* 800FC5D0  2C 00 00 F7 */	cmpwi r0, 0xf7                          
/* 800FC5D4  40 82 00 28 */	bne lbl_800FC5FC                         /* constant-address: 800FC5FC, symbol: lbl_800FC5FC */
...
/* 800FC5F0  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800FC5F4  48 24 9E BD */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 800FC5F8  48 00 00 24 */	b lbl_800FC61C                           /* constant-address: 800FC61C, symbol: lbl_800FC61C */
lbl_800FC5FC:
...
/* 800FC614  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800FC618  48 24 9E 99 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
lbl_800FC61C:
/* 800FC61C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800FC620  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800FC624  C0 03 00 0C */	lfs f0, 0xc(r3)                          /* constant-address: 803DD47C, symbol: None */
/* 800FC628  D0 1F 04 D0 */	stfs f0, 0x4d0(r31)                     
/* 800FC62C  C0 03 00 1C */	lfs f0, 0x1c(r3)                         /* constant-address: 803DD48C, symbol: None */
/* 800FC630  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)                     
/* 800FC634  C0 03 00 2C */	lfs f0, 0x2c(r3)                         /* constant-address: 803DD49C, symbol: None */
/* 800FC638  D0 1F 04 D8 */	stfs f0, 0x4d8(r31)                     
/* 800FC63C  38 9F 04 E4 */	addi r4, r31, 0x4e4                     
/* 800FC640  4B F1 05 C1 */	bl mDoMtx_MtxToRot__FPA4_CfP5csXyz       /* constant-address: 8000CC00, symbol: mDoMtx_MtxToRot__FPA4_CfP5csXyz */
/* 800FC644  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800FC648  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800FC64C  3C 80 80 43 */	lis r4, BaseY__4cXyz@ha                 
/* 800FC650  38 84 0D 24 */	addi r4, r4, BaseY__4cXyz@l              /* constant-address: 80430D24, symbol: BaseY__4cXyz */
/* 800FC654  38 A1 00 08 */	addi r5, r1, 8                          
/* 800FC658  48 24 A7 F5 */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
/* 800FC65C  C0 21 00 0C */	lfs f1, 0xc(r1)                         
/* 800FC660  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FC664  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FC668  40 80 00 34 */	bge lbl_800FC69C                         /* constant-address: 800FC69C, symbol: lbl_800FC69C */
...
/* 800FC684  38 03 80 00 */	addi r0, r3, 0x8000 /* 0x00008000@l */   /* constant-address: 00008000 */

...
/* 80124FB4  48 23 D2 21 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 80124FD8  41 82 00 10 */	beq lbl_80124FE8                         /* constant-address: 80124FE8, symbol: lbl_80124FE8 */
/* 80124FDC  38 63 00 01 */	addi r3, r3, 1                           /* constant-address: 00000001 */
/* 80124FE0  3B FF 00 30 */	addi r31, r31, 0x30                     
/* 80124FE4  42 00 FF EC */	bdnz lbl_80124FD0                        /* constant-address: 80124FD0, symbol: lbl_80124FD0 */
lbl_80124FE8:
/* 80124FE8  2C 03 00 04 */	cmpwi r3, 4                             
/* 80124FEC  41 82 01 24 */	beq lbl_80125110                         /* constant-address: 80125110, symbol: lbl_80125110 */
/* 80124FF0  7F C3 F3 78 */	mr r3, r30                              
/* 80124FF4  7C A4 2B 78 */	mr r4, r5                               
/* 80124FF8  4B FB 24 FD */	bl getDamageVec__9daAlink_cFP12dCcD_GObjInf /* constant-address: 800D74F4, symbol: getDamageVec__9daAlink_cFP12dCcD_GObjInf */
/* 80124FFC  7C 7C 1B 78 */	mr r28, r3                              
/* 80125000  48 14 21 29 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 80125004  7C 7D 1B 78 */	mr r29, r3                              
/* 80125008  7F 83 E3 78 */	mr r3, r28                              
/* 8012500C  48 14 21 45 */	bl atan2sY_XZ__4cXyzCFv                  /* constant-address: 80267150, symbol: atan2sY_XZ__4cXyzCFv */
...
/* 80125020  48 14 23 D5 */	bl __ct__5csXyzFsss                      /* constant-address: 802673F4, symbol: __ct__5csXyzFsss */
...
/* 8012503C  4B F1 1C 09 */	bl getHitmarkPosAndAngle__9dJntCol_cCFPC4cXyzPC5csXyzP4cXyzP5csXyzi /* constant-address: 80036C44, symbol: getHitmarkPosAndAngle__9dJntCol_cCFPC4cXyzPC5csXyzP4cXyzP5csXyzi */
/* 80125040  2C 03 FF FF */	cmpwi r3, -1                            
/* 80125044  41 82 00 CC */	beq lbl_80125110                         /* constant-address: 80125110, symbol: lbl_80125110 */
/* 80125048  80 1E 05 74 */	lwz r0, 0x574(r30)                      
/* 8012504C  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 80125050  40 82 00 20 */	bne lbl_80125070                         /* constant-address: 80125070, symbol: lbl_80125070 */
/* 80125054  2C 03 00 01 */	cmpwi r3, 1                             
/* 80125058  41 82 00 B8 */	beq lbl_80125110                         /* constant-address: 80125110, symbol: lbl_80125110 */
/* 8012505C  2C 03 00 0F */	cmpwi r3, 0xf                           
/* 80125060  41 82 00 B0 */	beq lbl_80125110                         /* constant-address: 80125110, symbol: lbl_80125110 */
/* 80125064  2C 03 00 10 */	cmpwi r3, 0x10                          
/* 80125068  40 82 00 08 */	bne lbl_80125070                         /* constant-address: 80125070, symbol: lbl_80125070 */
/* 8012506C  48 00 00 A4 */	b lbl_80125110                           /* constant-address: 80125110, symbol: lbl_80125110 */
lbl_80125070:
...
/* 801250A0  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)               /* constant-address: 80430CF4, symbol: Zero__4cXyz */
/* 801250A4  D0 1F 00 24 */	stfs f0, 0x24(r31)                      
/* 801250A8  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80430CF8, symbol: None */
/* 801250AC  D0 1F 00 28 */	stfs f0, 0x28(r31)                      
/* 801250B0  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80430CFC, symbol: None */
...
/* 801250E4  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 801250E8  48 22 13 C9 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 801250EC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 801250F0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 801250F4  7C 64 1B 78 */	mr r4, r3                               
/* 801250F8  48 22 14 B9 */	bl PSMTXInverse                          /* constant-address: 803465B0, symbol: PSMTXInverse */
/* 801250FC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 80125100  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 80125104  38 81 00 18 */	addi r4, r1, 0x18                       
/* 80125108  38 BF 00 18 */	addi r5, r31, 0x18                      
/* 8012510C  48 22 1C 61 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
lbl_80125110:
/* 80125110  39 61 00 40 */	addi r11, r1, 0x40                      
/* 80125114  48 23 D1 0D */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

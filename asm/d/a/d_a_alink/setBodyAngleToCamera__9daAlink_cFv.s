...
/* 800CE8B8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
...
/* 800CE8D0  41 82 02 0C */	beq lbl_800CEADC                         /* constant-address: 800CEADC, symbol: lbl_800CEADC */
...
/* 800CE8F4  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 800CE8F8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800CE8FC  40 81 01 08 */	ble lbl_800CEA04                         /* constant-address: 800CEA04, symbol: lbl_800CEA04 */
/* 800CE900  C0 02 92 A8 */	lfs f0, lit_6022(r2)                     /* constant-address: 80452CA8, symbol: lit_6022 */
...
/* 800CE914  41 82 00 0C */	beq lbl_800CE920                         /* constant-address: 800CE920, symbol: lbl_800CE920 */
/* 800CE918  C0 02 92 AC */	lfs f0, lit_6023(r2)                     /* constant-address: 80452CAC, symbol: lit_6023 */
/* 800CE91C  EC 84 00 32 */	fmuls f4, f4, f0                        
lbl_800CE920:
/* 800CE920  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800CE924  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800CE928  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800CE92C  54 00 02 95 */	rlwinm. r0, r0, 0, 0xa, 0xa             
/* 800CE930  41 82 00 18 */	beq lbl_800CE948                         /* constant-address: 800CE948, symbol: lbl_800CE948 */
...
/* 800CE954  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800CE958  7C 63 04 2E */	lfsx f3, r3, r0                         
/* 800CE95C  A8 1F 04 E6 */	lha r0, 0x4e6(r31)                      
/* 800CE960  C8 42 92 B0 */	lfd f2, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800CE9D8  4B FE 31 91 */	bl checkNotItemSinkLimit__9daAlink_cFv   /* constant-address: 800B1B68, symbol: checkNotItemSinkLimit__9daAlink_cFv */
/* 800CE9DC  2C 03 00 00 */	cmpwi r3, 0                             
/* 800CE9E0  41 82 00 2C */	beq lbl_800CEA0C                         /* constant-address: 800CEA0C, symbol: lbl_800CEA0C */
/* 800CE9E4  A8 61 00 08 */	lha r3, 8(r1)                           
/* 800CE9E8  7C 60 07 35 */	extsh. r0, r3                           
/* 800CE9EC  40 81 00 20 */	ble lbl_800CEA0C                         /* constant-address: 800CEA0C, symbol: lbl_800CEA0C */
/* 800CE9F0  A8 1F 05 9C */	lha r0, 0x59c(r31)                      
/* 800CE9F4  7C 03 00 00 */	cmpw r3, r0                             
/* 800CE9F8  40 81 00 14 */	ble lbl_800CEA0C                         /* constant-address: 800CEA0C, symbol: lbl_800CEA0C */
/* 800CE9FC  B0 01 00 08 */	sth r0, 8(r1)                           
/* 800CEA00  48 00 00 0C */	b lbl_800CEA0C                           /* constant-address: 800CEA0C, symbol: lbl_800CEA0C */
lbl_800CEA04:
/* 800CEA04  A8 1F 05 9C */	lha r0, 0x59c(r31)                      
/* 800CEA08  B0 01 00 08 */	sth r0, 8(r1)                           
lbl_800CEA0C:
/* 800CEA0C  7F E3 FB 78 */	mr r3, r31                              
/* 800CEA10  4B FE 31 59 */	bl checkNotItemSinkLimit__9daAlink_cFv   /* constant-address: 800B1B68, symbol: checkNotItemSinkLimit__9daAlink_cFv */
/* 800CEA14  2C 03 00 00 */	cmpwi r3, 0                             
/* 800CEA18  41 82 00 28 */	beq lbl_800CEA40                         /* constant-address: 800CEA40, symbol: lbl_800CEA40 */
/* 800CEA1C  A8 01 00 08 */	lha r0, 8(r1)                           
/* 800CEA20  2C 00 00 00 */	cmpwi r0, 0                             
/* 800CEA24  40 81 00 1C */	ble lbl_800CEA40                         /* constant-address: 800CEA40, symbol: lbl_800CEA40 */
...
/* 800CEA3C  48 1A 1B 05 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
lbl_800CEA40:
/* 800CEA40  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800CEA44  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800CEA48  80 83 5F 18 */	lwz r4, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800CEA4C  3C 60 00 20 */	lis r3, 0x0020 /* 0x00202000@ha */      
/* 800CEA50  38 03 20 00 */	addi r0, r3, 0x2000 /* 0x00202000@l */   /* constant-address: 00202000 */
/* 800CEA54  7C 80 00 39 */	and. r0, r4, r0                         
/* 800CEA58  40 82 00 18 */	bne lbl_800CEA70                         /* constant-address: 800CEA70, symbol: lbl_800CEA70 */
/* 800CEA5C  A0 1F 2F DC */	lhz r0, 0x2fdc(r31)                     
/* 800CEA60  28 00 00 42 */	cmplwi r0, 0x42                         
/* 800CEA64  40 82 00 0C */	bne lbl_800CEA70                         /* constant-address: 800CEA70, symbol: lbl_800CEA70 */
/* 800CEA68  38 C0 D8 F0 */	li r6, -10000                           
/* 800CEA6C  48 00 00 10 */	b lbl_800CEA7C                           /* constant-address: 800CEA7C, symbol: lbl_800CEA7C */
lbl_800CEA70:
/* 800CEA70  3C 60 80 39 */	lis r3, m__18daAlinkHIO_item_c0@ha      
/* 800CEA74  38 63 EB 50 */	addi r3, r3, m__18daAlinkHIO_item_c0@l   /* constant-address: 8038EB50, symbol: m__18daAlinkHIO_item_c0 */
/* 800CEA78  A8 C3 00 2C */	lha r6, 0x2c(r3)                         /* constant-address: 8038EB7C, symbol: None */
lbl_800CEA7C:
/* 800CEA7C  3C 60 80 39 */	lis r3, m__18daAlinkHIO_item_c0@ha      
/* 800CEA80  38 63 EB 50 */	addi r3, r3, m__18daAlinkHIO_item_c0@l   /* constant-address: 8038EB50, symbol: m__18daAlinkHIO_item_c0 */
/* 800CEA84  A8 A3 00 2A */	lha r5, 0x2a(r3)                         /* constant-address: 8038EB7A, symbol: None */
/* 800CEA88  A8 81 00 08 */	lha r4, 8(r1)                           
/* 800CEA8C  7C C0 07 34 */	extsh r0, r6                            
/* 800CEA90  7C 04 00 00 */	cmpw r4, r0                             
/* 800CEA94  40 80 00 0C */	bge lbl_800CEAA0                         /* constant-address: 800CEAA0, symbol: lbl_800CEAA0 */
/* 800CEA98  7C C4 33 78 */	mr r4, r6                               
/* 800CEA9C  48 00 00 18 */	b lbl_800CEAB4                           /* constant-address: 800CEAB4, symbol: lbl_800CEAB4 */
lbl_800CEAA0:
/* 800CEAA0  7C 83 07 34 */	extsh r3, r4                            
/* 800CEAA4  7C A0 07 34 */	extsh r0, r5                            
/* 800CEAA8  7C 03 00 00 */	cmpw r3, r0                             
/* 800CEAAC  40 81 00 08 */	ble lbl_800CEAB4                         /* constant-address: 800CEAB4, symbol: lbl_800CEAB4 */
...
/* 800CEAC0  4B FF FC 69 */	bl checkBodyAngleX__9daAlink_cFs         /* constant-address: 800CE728, symbol: checkBodyAngleX__9daAlink_cFs */
...
/* 800CEAD8  48 00 00 08 */	b lbl_800CEAE0                           /* constant-address: 800CEAE0, symbol: lbl_800CEAE0 */
lbl_800CEADC:

...
/* 8010BDA8  4B FB 61 C5 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 8010BDAC  80 1F 05 70 */	lwz r0, 0x570(r31)                      
/* 8010BDB0  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17           
/* 8010BDB4  40 82 00 10 */	bne lbl_8010BDC4                         /* constant-address: 8010BDC4, symbol: lbl_8010BDC4 */
...
/* 8010BDD4  40 82 00 08 */	bne lbl_8010BDDC                         /* constant-address: 8010BDDC, symbol: lbl_8010BDDC */
/* 8010BDD8  38 80 01 29 */	li r4, 0x129                            
lbl_8010BDDC:
/* 8010BDDC  4B FA 11 A5 */	bl setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM /* constant-address: 800ACF80, symbol: setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM */
/* 8010BDE0  38 00 00 00 */	li r0, 0                                
/* 8010BDE4  B0 1F 05 9C */	sth r0, 0x59c(r31)                      
/* 8010BDE8  7F E3 FB 78 */	mr r3, r31                              
/* 8010BDEC  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8010BDF0  C0 5F 05 34 */	lfs f2, 0x534(r31)                      
/* 8010BDF4  38 80 00 00 */	li r4, 0                                
/* 8010BDF8  4B FA F9 79 */	bl setSpecialGravity__9daAlink_cFffi     /* constant-address: 800BB770, symbol: setSpecialGravity__9daAlink_cFffi */
/* 8010BDFC  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 8010BE0C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8010BE10  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 8010BE14  54 00 03 98 */	rlwinm r0, r0, 0, 0xe, 0xc              
/* 8010BE18  90 03 5F 18 */	stw r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 8010BE1C  80 03 5F 1C */	lwz r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */
/* 8010BE20  60 00 00 10 */	ori r0, r0, 0x10                        
/* 8010BE24  90 03 5F 1C */	stw r0, 0x5f1c(r3)                       /* constant-address: 8040C0DC, symbol: None */
/* 8010BE28  7F E3 FB 78 */	mr r3, r31                              
/* 8010BE2C  3C 80 00 01 */	lis r4, 0x0001 /* 0x00010006@ha */      
/* 8010BE30  38 84 00 06 */	addi r4, r4, 0x0006 /* 0x00010006@l */   /* constant-address: 00010006 */
...
/* 8010BE78  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)               /* constant-address: 80430CF4, symbol: Zero__4cXyz */
/* 8010BE7C  D0 1F 37 D4 */	stfs f0, 0x37d4(r31)                    
/* 8010BE80  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80430CF8, symbol: None */
/* 8010BE84  D0 1F 37 D8 */	stfs f0, 0x37d8(r31)                    
/* 8010BE88  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80430CFC, symbol: None */
...
/* 8010BED4  48 00 00 1D */	bl procHookshotFly__9daAlink_cFv         /* constant-address: 8010BEF0, symbol: procHookshotFly__9daAlink_cFv */

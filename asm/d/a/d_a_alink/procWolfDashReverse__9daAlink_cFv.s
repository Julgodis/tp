...
/* 8012DA80  40 82 00 0C */	bne lbl_8012DA8C                         /* constant-address: 8012DA8C, symbol: lbl_8012DA8C */
...
/* 8012DA94  40 82 00 4C */	bne lbl_8012DAE0                         /* constant-address: 8012DAE0, symbol: lbl_8012DAE0 */
/* 8012DA98  7F C3 F3 78 */	mr r3, r30                              
/* 8012DA9C  48 03 0A 31 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 8012DAA0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8012DAA4  41 82 00 14 */	beq lbl_8012DAB8                         /* constant-address: 8012DAB8, symbol: lbl_8012DAB8 */
/* 8012DAA8  7F E3 FB 78 */	mr r3, r31                              
/* 8012DAAC  38 80 00 00 */	li r4, 0                                
/* 8012DAB0  4B FF C0 95 */	bl checkNextActionWolf__9daAlink_cFi     /* constant-address: 80129B44, symbol: checkNextActionWolf__9daAlink_cFi */
/* 8012DAB4  48 00 00 D8 */	b lbl_8012DB8C                           /* constant-address: 8012DB8C, symbol: lbl_8012DB8C */
lbl_8012DAB8:
/* 8012DAB8  C0 3E 00 10 */	lfs f1, 0x10(r30)                       
/* 8012DABC  3C 60 80 39 */	lis r3, m__20daAlinkHIO_wlMove_c0@ha    
/* 8012DAC0  38 63 EE 28 */	addi r3, r3, m__20daAlinkHIO_wlMove_c0@l /* constant-address: 8038EE28, symbol: m__20daAlinkHIO_wlMove_c0 */
/* 8012DAC4  C0 03 00 4C */	lfs f0, 0x4c(r3)                         /* constant-address: 8038EE74, symbol: None */
/* 8012DAC8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8012DACC  40 81 00 C0 */	ble lbl_8012DB8C                         /* constant-address: 8012DB8C, symbol: lbl_8012DB8C */
/* 8012DAD0  7F E3 FB 78 */	mr r3, r31                              
/* 8012DAD4  38 80 00 01 */	li r4, 1                                
/* 8012DAD8  4B FF C0 6D */	bl checkNextActionWolf__9daAlink_cFi     /* constant-address: 80129B44, symbol: checkNextActionWolf__9daAlink_cFi */
/* 8012DADC  48 00 00 B0 */	b lbl_8012DB8C                           /* constant-address: 8012DB8C, symbol: lbl_8012DB8C */
lbl_8012DAE0:
/* 8012DAE0  A8 1F 30 0C */	lha r0, 0x300c(r31)                     
/* 8012DAE4  2C 00 00 00 */	cmpwi r0, 0                             
/* 8012DAE8  41 82 00 10 */	beq lbl_8012DAF8                         /* constant-address: 8012DAF8, symbol: lbl_8012DAF8 */
/* 8012DAEC  38 00 00 00 */	li r0, 0                                
/* 8012DAF0  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8012DAF4  48 00 00 98 */	b lbl_8012DB8C                           /* constant-address: 8012DB8C, symbol: lbl_8012DB8C */
lbl_8012DAF8:
/* 8012DAF8  80 1F 19 9C */	lwz r0, 0x199c(r31)                     
/* 8012DAFC  54 00 06 B5 */	rlwinm. r0, r0, 0, 0x1a, 0x1a           
/* 8012DB00  40 82 00 10 */	bne lbl_8012DB10                         /* constant-address: 8012DB10, symbol: lbl_8012DB10 */
/* 8012DB04  80 1F 05 90 */	lwz r0, 0x590(r31)                      
/* 8012DB08  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17           
/* 8012DB0C  41 82 00 80 */	beq lbl_8012DB8C                         /* constant-address: 8012DB8C, symbol: lbl_8012DB8C */
lbl_8012DB10:
/* 8012DB10  28 03 00 00 */	cmplwi r3, 0                            
/* 8012DB14  41 82 00 78 */	beq lbl_8012DB8C                         /* constant-address: 8012DB8C, symbol: lbl_8012DB8C */
/* 8012DB18  7F E3 FB 78 */	mr r3, r31                              
/* 8012DB1C  38 80 00 00 */	li r4, 0                                
/* 8012DB20  4B FF BD 5D */	bl checkWolfLandAction__9daAlink_cFi     /* constant-address: 8012987C, symbol: checkWolfLandAction__9daAlink_cFi */
/* 8012DB24  2C 03 00 00 */	cmpwi r3, 0                             
/* 8012DB28  41 82 00 0C */	beq lbl_8012DB34                         /* constant-address: 8012DB34, symbol: lbl_8012DB34 */
/* 8012DB2C  38 60 00 01 */	li r3, 1                                
/* 8012DB30  48 00 00 60 */	b lbl_8012DB90                           /* constant-address: 8012DB90, symbol: lbl_8012DB90 */
lbl_8012DB34:
/* 8012DB34  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8012DB38  D0 1F 33 98 */	stfs f0, 0x3398(r31)                    
/* 8012DB3C  3C 60 80 39 */	lis r3, m__20daAlinkHIO_wlMove_c0@ha    
/* 8012DB40  38 63 EE 28 */	addi r3, r3, m__20daAlinkHIO_wlMove_c0@l /* constant-address: 8038EE28, symbol: m__20daAlinkHIO_wlMove_c0 */
/* 8012DB44  C0 23 00 40 */	lfs f1, 0x40(r3)                         /* constant-address: 8038EE68, symbol: None */
...
/* 8012DB64  A8 03 00 3C */	lha r0, 0x3c(r3)                         /* constant-address: 8038EE64, symbol: None */

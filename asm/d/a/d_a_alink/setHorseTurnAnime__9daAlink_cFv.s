...
/* 800EDA94  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800EDA98  83 E3 5D B8 */	lwz r31, 0x5db8(r3)                      /* constant-address: 8040BF78, symbol: None */
/* 800EDA9C  A0 1F 16 C4 */	lhz r0, 0x16c4(r31)                     
/* 800EDAA0  28 00 00 0C */	cmplwi r0, 0xc                          
/* 800EDAA4  40 82 00 0C */	bne lbl_800EDAB0                         /* constant-address: 800EDAB0, symbol: lbl_800EDAB0 */
/* 800EDAA8  38 80 00 45 */	li r4, 0x45                             
/* 800EDAAC  48 00 00 4C */	b lbl_800EDAF8                           /* constant-address: 800EDAF8, symbol: lbl_800EDAF8 */
lbl_800EDAB0:
/* 800EDAB0  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800EDAB4  28 00 00 0B */	cmplwi r0, 0xb                          
/* 800EDAB8  40 82 00 0C */	bne lbl_800EDAC4                         /* constant-address: 800EDAC4, symbol: lbl_800EDAC4 */
/* 800EDABC  38 80 00 46 */	li r4, 0x46                             
/* 800EDAC0  48 00 00 38 */	b lbl_800EDAF8                           /* constant-address: 800EDAF8, symbol: lbl_800EDAF8 */
lbl_800EDAC4:
/* 800EDAC4  28 00 00 0A */	cmplwi r0, 0xa                          
/* 800EDAC8  40 82 00 0C */	bne lbl_800EDAD4                         /* constant-address: 800EDAD4, symbol: lbl_800EDAD4 */
/* 800EDACC  38 80 00 47 */	li r4, 0x47                             
/* 800EDAD0  48 00 00 28 */	b lbl_800EDAF8                           /* constant-address: 800EDAF8, symbol: lbl_800EDAF8 */
lbl_800EDAD4:
/* 800EDAD4  28 00 00 15 */	cmplwi r0, 0x15                         
/* 800EDAD8  40 82 00 0C */	bne lbl_800EDAE4                         /* constant-address: 800EDAE4, symbol: lbl_800EDAE4 */
/* 800EDADC  38 80 00 42 */	li r4, 0x42                             
/* 800EDAE0  48 00 00 18 */	b lbl_800EDAF8                           /* constant-address: 800EDAF8, symbol: lbl_800EDAF8 */
lbl_800EDAE4:
/* 800EDAE4  28 00 00 14 */	cmplwi r0, 0x14                         
/* 800EDAE8  40 82 00 0C */	bne lbl_800EDAF4                         /* constant-address: 800EDAF4, symbol: lbl_800EDAF4 */
/* 800EDAEC  38 80 00 44 */	li r4, 0x44                             
/* 800EDAF0  48 00 00 08 */	b lbl_800EDAF8                           /* constant-address: 800EDAF8, symbol: lbl_800EDAF8 */
lbl_800EDAF4:
/* 800EDAF4  38 80 00 43 */	li r4, 0x43                             
lbl_800EDAF8:
/* 800EDAF8  7F C3 F3 78 */	mr r3, r30                              
/* 800EDAFC  C0 3F 17 50 */	lfs f1, 0x1750(r31)                     
/* 800EDB00  4B FB F4 B1 */	bl setSingleAnimeBaseMorf__9daAlink_cFQ29daAlink_c11daAlink_ANMf /* constant-address: 800ACFB0, symbol: setSingleAnimeBaseMorf__9daAlink_cFQ29daAlink_c11daAlink_ANMf */
...
/* 800EDB20  41 82 00 10 */	beq lbl_800EDB30                         /* constant-address: 800EDB30, symbol: lbl_800EDB30 */

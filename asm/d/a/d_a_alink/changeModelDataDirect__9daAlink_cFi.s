...
/* 8014036C  40 82 00 EC */	bne lbl_80140458                         /* constant-address: 80140458, symbol: lbl_80140458 */
...
/* 801403B4  38 63 EC 28 */	addi r3, r3, daAlink_modelCallBack__FP8J3DJointi@l /* constant-address: 8009EC28, symbol: daAlink_modelCallBack__FP8J3DJointi */
/* 801403B8  48 00 00 1C */	b lbl_801403D4                           /* constant-address: 801403D4, symbol: lbl_801403D4 */
lbl_801403BC:
...
/* 801403D0  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000001 */
lbl_801403D4:
/* 801403D4  54 C0 04 3E */	clrlwi r0, r6, 0x10                     
/* 801403D8  28 00 00 23 */	cmplwi r0, 0x23                         
/* 801403DC  41 80 FF E0 */	blt lbl_801403BC                         /* constant-address: 801403BC, symbol: lbl_801403BC */
...
/* 801403F0  38 A3 EF 38 */	addi r5, r3, daAlink_headModelCallBack__FP8J3DJointi@l /* constant-address: 8009EF38, symbol: daAlink_headModelCallBack__FP8J3DJointi */
/* 801403F4  48 00 00 18 */	b lbl_8014040C                           /* constant-address: 8014040C, symbol: lbl_8014040C */
lbl_801403F8:
...
/* 80140408  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000002 */
lbl_8014040C:
/* 8014040C  54 E3 04 3E */	clrlwi r3, r7, 0x10                     
/* 80140410  A0 06 00 2C */	lhz r0, 0x2c(r6)                        
/* 80140414  7C 03 00 40 */	cmplw r3, r0                            
/* 80140418  41 80 FF E0 */	blt lbl_801403F8                         /* constant-address: 801403F8, symbol: lbl_801403F8 */
/* 8014041C  2C 04 00 00 */	cmpwi r4, 0                             
/* 80140420  41 82 01 1C */	beq lbl_8014053C                         /* constant-address: 8014053C, symbol: lbl_8014053C */
/* 80140424  80 9F 21 54 */	lwz r4, 0x2154(r31)                     
/* 80140428  28 04 00 00 */	cmplwi r4, 0                            
/* 8014042C  41 82 00 10 */	beq lbl_8014043C                         /* constant-address: 8014043C, symbol: lbl_8014043C */
/* 80140430  80 7F 06 C0 */	lwz r3, 0x6c0(r31)                      
/* 80140434  38 63 00 58 */	addi r3, r3, 0x58                       
/* 80140438  48 1E F7 91 */	bl entryTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern /* constant-address: 8032FBC8, symbol: entryTexNoAnimator__16J3DMaterialTableFP16J3DAnmTexPattern */
lbl_8014043C:
/* 8014043C  80 9F 21 58 */	lwz r4, 0x2158(r31)                     
/* 80140440  28 04 00 00 */	cmplwi r4, 0                            
/* 80140444  41 82 00 F8 */	beq lbl_8014053C                         /* constant-address: 8014053C, symbol: lbl_8014053C */
/* 80140448  80 7F 06 C0 */	lwz r3, 0x6c0(r31)                      
/* 8014044C  38 63 00 58 */	addi r3, r3, 0x58                       
/* 80140450  48 1E F8 75 */	bl entryTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey /* constant-address: 8032FCC4, symbol: entryTexMtxAnimator__16J3DMaterialTableFP19J3DAnmTextureSRTKey */
/* 80140454  48 00 00 E8 */	b lbl_8014053C                           /* constant-address: 8014053C, symbol: lbl_8014053C */
lbl_80140458:
...
/* 801404A0  48 00 00 1C */	b lbl_801404BC                           /* constant-address: 801404BC, symbol: lbl_801404BC */
lbl_801404A4:
...
/* 801404B8  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
lbl_801404BC:
/* 801404BC  54 A0 04 3E */	clrlwi r0, r5, 0x10                     
/* 801404C0  28 00 00 23 */	cmplwi r0, 0x23                         
/* 801404C4  41 80 FF E0 */	blt lbl_801404A4                         /* constant-address: 801404A4, symbol: lbl_801404A4 */
...
/* 801404D8  48 00 00 18 */	b lbl_801404F0                           /* constant-address: 801404F0, symbol: lbl_801404F0 */
lbl_801404DC:
...
/* 801404EC  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000002 */
lbl_801404F0:
/* 801404F0  54 C3 04 3E */	clrlwi r3, r6, 0x10                     
/* 801404F4  A0 05 00 2C */	lhz r0, 0x2c(r5)                        
/* 801404F8  7C 03 00 40 */	cmplw r3, r0                            
/* 801404FC  41 80 FF E0 */	blt lbl_801404DC                         /* constant-address: 801404DC, symbol: lbl_801404DC */
/* 80140500  80 1F 05 78 */	lwz r0, 0x578(r31)                      
/* 80140504  54 00 02 D9 */	rlwinm. r0, r0, 0, 0xb, 0xc             
/* 80140508  40 82 00 34 */	bne lbl_8014053C                         /* constant-address: 8014053C, symbol: lbl_8014053C */
/* 8014050C  38 C0 00 06 */	li r6, 6                                
/* 80140510  3C 60 80 0A */	lis r3, daAlink_headModelCallBack__FP8J3DJointi@ha
/* 80140514  38 63 EF 38 */	addi r3, r3, daAlink_headModelCallBack__FP8J3DJointi@l /* constant-address: 8009EF38, symbol: daAlink_headModelCallBack__FP8J3DJointi */
/* 80140518  48 00 00 18 */	b lbl_80140530                           /* constant-address: 80140530, symbol: lbl_80140530 */
lbl_8014051C:
...
/* 8014052C  38 C6 00 01 */	addi r6, r6, 1                           /* constant-address: 00000007 */
lbl_80140530:
/* 80140530  54 C0 04 3E */	clrlwi r0, r6, 0x10                     
/* 80140534  28 00 00 08 */	cmplwi r0, 8                            
/* 80140538  41 80 FF E4 */	blt lbl_8014051C                         /* constant-address: 8014051C, symbol: lbl_8014051C */
lbl_8014053C:

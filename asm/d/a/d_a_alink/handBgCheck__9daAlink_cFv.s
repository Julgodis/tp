...
/* 800A39D0  48 2B E7 F5 */	bl _savegpr_23                           /* constant-address: 803621C4, symbol: _savegpr_23 */
...
/* 800A39E4  41 82 02 88 */	beq lbl_800A3C6C                         /* constant-address: 800A3C6C, symbol: lbl_800A3C6C */
/* 800A39E8  80 1C 31 A0 */	lwz r0, 0x31a0(r28)                     
/* 800A39EC  54 00 06 73 */	rlwinm. r0, r0, 0, 0x19, 0x19           
/* 800A39F0  40 82 00 08 */	bne lbl_800A39F8                         /* constant-address: 800A39F8, symbol: lbl_800A39F8 */
/* 800A39F4  48 00 02 78 */	b lbl_800A3C6C                           /* constant-address: 800A3C6C, symbol: lbl_800A3C6C */
lbl_800A39F8:
/* 800A39F8  A0 1C 2F E8 */	lhz r0, 0x2fe8(r28)                     
/* 800A39FC  28 00 00 5A */	cmplwi r0, 0x5a                         
/* 800A3A00  40 82 00 28 */	bne lbl_800A3A28                         /* constant-address: 800A3A28, symbol: lbl_800A3A28 */
/* 800A3A04  C0 3C 1F E0 */	lfs f1, 0x1fe0(r28)                     
/* 800A3A08  C0 02 93 34 */	lfs f0, lit_7710(r2)                     /* constant-address: 80452D34, symbol: lit_7710 */
/* 800A3A0C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800A3A10  4C 41 13 82 */	cror 2, 1, 2                            
/* 800A3A14  40 82 00 14 */	bne lbl_800A3A28                         /* constant-address: 800A3A28, symbol: lbl_800A3A28 */
/* 800A3A18  38 9C 2B A4 */	addi r4, r28, 0x2ba4                    
/* 800A3A1C  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800A3A20  4B FF F2 05 */	bl setMatrixOffset__9daAlink_cFPff       /* constant-address: 800A2C24, symbol: setMatrixOffset__9daAlink_cFPff */
/* 800A3A24  48 00 02 48 */	b lbl_800A3C6C                           /* constant-address: 800A3C6C, symbol: lbl_800A3C6C */
lbl_800A3A28:
...
/* 800A3A38  4B F6 93 2D */	bl transS__14mDoMtx_stack_cFRC4cXyz      /* constant-address: 8000CD64, symbol: transS__14mDoMtx_stack_cFRC4cXyz */
/* 800A3A3C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A3A40  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A3A44  A8 9C 04 E6 */	lha r4, 0x4e6(r28)                      
/* 800A3A48  4B F6 89 ED */	bl mDoMtx_YrotM__FPA4_fs                 /* constant-address: 8000C434, symbol: mDoMtx_YrotM__FPA4_fs */
/* 800A3A4C  3A E0 00 00 */	li r23, 0                               
/* 800A3A50  3B 60 00 00 */	li r27, 0                               
/* 800A3A54  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800A3A58  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800A3A5C  3B 03 0F 38 */	addi r24, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 800A3A60  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A3A64  3B 23 D4 70 */	addi r25, r3, now__14mDoMtx_stack_c@l    /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A3A68  3C 60 80 39 */	lis r3, data_80391F2C@ha                
/* 800A3A6C  3B 43 1F 2C */	addi r26, r3, data_80391F2C@l            /* constant-address: 80391F2C, symbol: data_80391F2C */
/* 800A3A70  C3 E2 93 A4 */	lfs f31, lit_9138(r2)                    /* constant-address: 80452DA4, symbol: lit_9138 */
lbl_800A3A74:
/* 800A3A74  7F 23 CB 78 */	mr r3, r25                              
/* 800A3A78  7C 9A DA 14 */	add r4, r26, r27                        
/* 800A3A7C  7F E5 FB 78 */	mr r5, r31                              
/* 800A3A80  48 2A 32 ED */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A3A84  C0 5F 00 08 */	lfs f2, 8(r31)                          
/* 800A3A88  C0 3F 00 04 */	lfs f1, 4(r31)                          
/* 800A3A8C  C0 0D 81 10 */	lfs f0, l_autoUpHeight(r13)              /* constant-address: 80450690, symbol: l_autoUpHeight */
...
/* 800A3AAC  48 1C 42 7D */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800A3AB0  7F 03 C3 78 */	mr r3, r24                              
/* 800A3AB4  38 9C 1D 08 */	addi r4, r28, 0x1d08                    
/* 800A3AB8  4B FD 09 E9 */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800A3ABC  FC 1F 08 00 */	fcmpu cr0, f31, f1                      
/* 800A3AC0  41 82 00 64 */	beq lbl_800A3B24                         /* constant-address: 800A3B24, symbol: lbl_800A3B24 */
/* 800A3AC4  C0 01 00 1C */	lfs f0, 0x1c(r1)                        
/* 800A3AC8  EC 60 08 28 */	fsubs f3, f0, f1                        
/* 800A3ACC  C0 4D 81 10 */	lfs f2, l_autoUpHeight(r13)              /* constant-address: 80450690, symbol: l_autoUpHeight */
/* 800A3AD0  C0 0D 81 14 */	lfs f0, l_autoDownHeight(r13)            /* constant-address: 80450694, symbol: l_autoDownHeight */
/* 800A3AD4  EC 02 00 28 */	fsubs f0, f2, f0                        
/* 800A3AD8  FC 03 00 40 */	fcmpo cr0, f3, f0                       
/* 800A3ADC  40 80 00 48 */	bge lbl_800A3B24                         /* constant-address: 800A3B24, symbol: lbl_800A3B24 */
/* 800A3AE0  D0 3D 00 00 */	stfs f1, 0(r29)                         
/* 800A3AE4  7F 03 C3 78 */	mr r3, r24                              
/* 800A3AE8  38 9C 1D 1C */	addi r4, r28, 0x1d1c                    
/* 800A3AEC  4B FD 14 05 */	bl GetGroundCode__4dBgSFRC13cBgS_PolyInfo /* constant-address: 80074EF0, symbol: GetGroundCode__4dBgSFRC13cBgS_PolyInfo */
/* 800A3AF0  2C 03 00 08 */	cmpwi r3, 8                             
/* 800A3AF4  41 82 00 24 */	beq lbl_800A3B18                         /* constant-address: 800A3B18, symbol: lbl_800A3B18 */
...
/* 800A3B0C  48 00 C5 8D */	bl getGroundAngle__9daAlink_cFP13cBgS_PolyInfos /* constant-address: 800B0098, symbol: getGroundAngle__9daAlink_cFP13cBgS_PolyInfos */
/* 800A3B10  B0 7E 00 00 */	sth r3, 0(r30)                          
/* 800A3B14  48 00 00 20 */	b lbl_800A3B34                           /* constant-address: 800A3B34, symbol: lbl_800A3B34 */
lbl_800A3B18:
/* 800A3B18  38 00 00 00 */	li r0, 0                                
/* 800A3B1C  B0 1E 00 00 */	sth r0, 0(r30)                          
/* 800A3B20  48 00 00 14 */	b lbl_800A3B34                           /* constant-address: 800A3B34, symbol: lbl_800A3B34 */
lbl_800A3B24:
...
/* 800A3B4C  41 80 FF 28 */	blt lbl_800A3A74                         /* constant-address: 800A3A74, symbol: lbl_800A3A74 */
/* 800A3B50  A0 1C 2F E8 */	lhz r0, 0x2fe8(r28)                     
/* 800A3B54  28 00 00 56 */	cmplwi r0, 0x56                         
/* 800A3B58  40 82 00 1C */	bne lbl_800A3B74                         /* constant-address: 800A3B74, symbol: lbl_800A3B74 */
/* 800A3B5C  38 00 00 00 */	li r0, 0                                
/* 800A3B60  C0 21 00 14 */	lfs f1, 0x14(r1)                        
/* 800A3B64  C0 02 93 18 */	lfs f0, lit_7308(r2)                     /* constant-address: 80452D18, symbol: lit_7308 */
/* 800A3B68  EC 01 00 2A */	fadds f0, f1, f0                        
/* 800A3B6C  D0 01 00 14 */	stfs f0, 0x14(r1)                       
/* 800A3B70  48 00 00 20 */	b lbl_800A3B90                           /* constant-address: 800A3B90, symbol: lbl_800A3B90 */
lbl_800A3B74:
/* 800A3B74  C0 21 00 14 */	lfs f1, 0x14(r1)                        
/* 800A3B78  C0 01 00 10 */	lfs f0, 0x10(r1)                        
/* 800A3B7C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800A3B80  40 80 00 0C */	bge lbl_800A3B8C                         /* constant-address: 800A3B8C, symbol: lbl_800A3B8C */
/* 800A3B84  38 00 00 00 */	li r0, 0                                
/* 800A3B88  48 00 00 08 */	b lbl_800A3B90                           /* constant-address: 800A3B90, symbol: lbl_800A3B90 */
lbl_800A3B8C:
...
/* 800A3BAC  4B FF F0 79 */	bl setMatrixOffset__9daAlink_cFPff       /* constant-address: 800A2C24, symbol: setMatrixOffset__9daAlink_cFPff */
...
/* 800A3BC4  C3 E2 92 BC */	lfs f31, lit_6041(r2)                    /* constant-address: 80452CBC, symbol: lit_6041 */
lbl_800A3BC8:
...
/* 800A3BDC  40 80 00 24 */	bge lbl_800A3C00                         /* constant-address: 800A3C00, symbol: lbl_800A3C00 */
...
/* 800A3BF4  4B FF F0 ED */	bl setLegAngle__9daAlink_cFfP18daAlink_footData_cPsPsi /* constant-address: 800A2CE0, symbol: setLegAngle__9daAlink_cFfP18daAlink_footData_cPsPsi */
/* 800A3BF8  2C 03 00 00 */	cmpwi r3, 0                             
/* 800A3BFC  40 82 00 10 */	bne lbl_800A3C0C                         /* constant-address: 800A3C0C, symbol: lbl_800A3C0C */
lbl_800A3C00:
...
/* 800A3C20  48 1C C9 21 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
...
/* 800A3C38  48 1C C9 09 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
...
/* 800A3C50  48 1C C8 F1 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
...
/* 800A3C68  41 80 FF 60 */	blt lbl_800A3BC8                         /* constant-address: 800A3BC8, symbol: lbl_800A3BC8 */
lbl_800A3C6C:
/* 800A3C6C  E3 E1 00 78 */	psq_l f31, 120(r1), 0, 0 /* qr0 */      
/* 800A3C70  CB E1 00 70 */	lfd f31, 0x70(r1)                       
/* 800A3C74  39 61 00 70 */	addi r11, r1, 0x70                      
/* 800A3C78  48 2B E5 99 */	bl _restgpr_23                           /* constant-address: 80362210, symbol: _restgpr_23 */

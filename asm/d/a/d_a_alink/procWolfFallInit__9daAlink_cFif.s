...
/* 8012EDFC  4B F9 3F A9 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 8012EE00  2C 03 00 00 */	cmpwi r3, 0                             
/* 8012EE04  40 82 00 0C */	bne lbl_8012EE10                         /* constant-address: 8012EE10, symbol: lbl_8012EE10 */
/* 8012EE08  38 60 00 00 */	li r3, 0                                
/* 8012EE0C  48 00 01 8C */	b lbl_8012EF98                           /* constant-address: 8012EF98, symbol: lbl_8012EF98 */
lbl_8012EE10:
/* 8012EE10  38 00 00 00 */	li r0, 0                                
/* 8012EE14  B0 1E 30 12 */	sth r0, 0x3012(r30)                     
/* 8012EE18  2C 1F 00 01 */	cmpwi r31, 1                            
/* 8012EE1C  40 82 00 1C */	bne lbl_8012EE38                         /* constant-address: 8012EE38, symbol: lbl_8012EE38 */
/* 8012EE20  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 8012EE34  48 00 00 8C */	b lbl_8012EEC0                           /* constant-address: 8012EEC0, symbol: lbl_8012EEC0 */
lbl_8012EE38:
/* 8012EE38  2C 1F 00 04 */	cmpwi r31, 4                            
/* 8012EE3C  40 82 00 84 */	bne lbl_8012EEC0                         /* constant-address: 8012EEC0, symbol: lbl_8012EEC0 */
/* 8012EE40  A8 1E 2F FE */	lha r0, 0x2ffe(r30)                     
/* 8012EE44  B0 1E 04 DE */	sth r0, 0x4de(r30)                      
/* 8012EE48  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8012EE4C  D0 21 00 08 */	stfs f1, 8(r1)                          
/* 8012EE50  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8012EE54  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 8012EE58  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 8012EE5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8012EE60  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8012EE64  38 63 5B D4 */	addi r3, r3, 0x5bd4                      /* constant-address: 8040BD94, symbol: None */
/* 8012EE68  38 80 00 06 */	li r4, 6                                
/* 8012EE6C  38 A0 00 1F */	li r5, 0x1f                             
/* 8012EE70  38 C1 00 08 */	addi r6, r1, 8                          
/* 8012EE74  4B F4 0B B1 */	bl StartShock__12dVibration_cFii4cXyz    /* constant-address: 8006FA24, symbol: StartShock__12dVibration_cFii4cXyz */
/* 8012EE78  7F C3 F3 78 */	mr r3, r30                              
/* 8012EE7C  80 9E 31 8C */	lwz r4, 0x318c(r30)                     
/* 8012EE80  4B FA 85 F9 */	bl setDamagePointNormal__9daAlink_cFi    /* constant-address: 800D7478, symbol: setDamagePointNormal__9daAlink_cFi */
...
/* 8012EE98  41 82 00 10 */	beq lbl_8012EEA8                         /* constant-address: 8012EEA8, symbol: lbl_8012EEA8 */
...
/* 8012EEC8  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8012EECC  FC 40 F8 90 */	fmr f2, f31                             
/* 8012EED0  4B FF A8 09 */	bl setSingleAnimeWolfBaseSpeed__9daAlink_cFQ29daAlink_c12daAlink_WANMff /* constant-address: 801296D8, symbol: setSingleAnimeWolfBaseSpeed__9daAlink_cFQ29daAlink_c12daAlink_WANMff */
/* 8012EED4  A8 1E 1F D8 */	lha r0, 0x1fd8(r30)                     
/* 8012EED8  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 8012EEF4  C0 02 93 E4 */	lfs f0, lit_12328(r2)                    /* constant-address: 80452DE4, symbol: lit_12328 */
...
/* 8012EF0C  3C 60 80 42 */	lis r3, l_wolfBaseAnime@ha              
/* 8012EF10  C4 03 56 1C */	lfsu f0, l_wolfBaseAnime@l(r3)           /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8012EF14  D0 1E 35 88 */	stfs f0, 0x3588(r30)                    
/* 8012EF18  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425620, symbol: None */
/* 8012EF1C  D0 1E 35 8C */	stfs f0, 0x358c(r30)                    
/* 8012EF20  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */
...
/* 8012EF34  4B F9 05 AD */	bl resetBasAnime__9daAlink_cFv           /* constant-address: 800BF4E0, symbol: resetBasAnime__9daAlink_cFv */
...
/* 8012EF48  41 82 00 3C */	beq lbl_8012EF84                         /* constant-address: 8012EF84, symbol: lbl_8012EF84 */
/* 8012EF4C  A8 7E 04 DE */	lha r3, 0x4de(r30)                      
/* 8012EF50  A8 1E 04 E6 */	lha r0, 0x4e6(r30)                      
/* 8012EF54  7C 03 00 00 */	cmpw r3, r0                             
/* 8012EF58  40 82 00 2C */	bne lbl_8012EF84                         /* constant-address: 8012EF84, symbol: lbl_8012EF84 */
/* 8012EF5C  C0 3E 33 98 */	lfs f1, 0x3398(r30)                     
/* 8012EF60  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 8012EF64  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8012EF68  40 81 00 10 */	ble lbl_8012EF78                         /* constant-address: 8012EF78, symbol: lbl_8012EF78 */
/* 8012EF6C  38 00 00 02 */	li r0, 2                                
/* 8012EF70  B0 1E 30 08 */	sth r0, 0x3008(r30)                     
/* 8012EF74  48 00 00 18 */	b lbl_8012EF8C                           /* constant-address: 8012EF8C, symbol: lbl_8012EF8C */
lbl_8012EF78:
/* 8012EF78  38 00 00 01 */	li r0, 1                                
/* 8012EF7C  B0 1E 30 08 */	sth r0, 0x3008(r30)                     
/* 8012EF80  48 00 00 0C */	b lbl_8012EF8C                           /* constant-address: 8012EF8C, symbol: lbl_8012EF8C */
lbl_8012EF84:

...
/* 8010B660  41 82 00 98 */	beq lbl_8010B6F8                         /* constant-address: 8010B6F8, symbol: lbl_8010B6F8 */
/* 8010B664  38 7E 28 54 */	addi r3, r30, 0x2854                    
/* 8010B668  48 05 36 51 */	bl setData__16daPy_actorKeep_cFP10fopAc_ac_c /* constant-address: 8015ECB8, symbol: setData__16daPy_actorKeep_cFP10fopAc_ac_c */
/* 8010B66C  38 61 00 08 */	addi r3, r1, 8                          
/* 8010B670  38 9E 38 04 */	addi r4, r30, 0x3804                    
/* 8010B674  38 BF 04 D0 */	addi r5, r31, 0x4d0                     
/* 8010B678  48 15 B4 BD */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 8010B698  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8010B69C  A8 1F 04 E4 */	lha r0, 0x4e4(r31)                      
/* 8010B6A0  7C 00 00 D0 */	neg r0, r0                              
/* 8010B6A4  7C 04 07 34 */	extsh r4, r0                            
/* 8010B6A8  4B F0 0C 9D */	bl mDoMtx_XrotS__FPA4_fs                 /* constant-address: 8000C344, symbol: mDoMtx_XrotS__FPA4_fs */
/* 8010B6AC  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8010B6B0  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8010B6B4  A8 1F 04 E6 */	lha r0, 0x4e6(r31)                      
/* 8010B6B8  7C 00 00 D0 */	neg r0, r0                              
/* 8010B6BC  7C 04 07 34 */	extsh r4, r0                            
/* 8010B6C0  4B F0 0D 75 */	bl mDoMtx_YrotM__FPA4_fs                 /* constant-address: 8000C434, symbol: mDoMtx_YrotM__FPA4_fs */
/* 8010B6C4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 8010B6C8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 8010B6CC  38 9E 37 C8 */	addi r4, r30, 0x37c8                    
/* 8010B6D0  7C 85 23 78 */	mr r5, r4                               
/* 8010B6D4  48 23 B7 79 */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
...
/* 8010B6F4  48 00 00 14 */	b lbl_8010B708                           /* constant-address: 8010B708, symbol: lbl_8010B708 */
lbl_8010B6F8:
/* 8010B6F8  38 7E 28 54 */	addi r3, r30, 0x2854                    
/* 8010B6FC  48 05 36 01 */	bl clearData__16daPy_actorKeep_cFv       /* constant-address: 8015ECFC, symbol: clearData__16daPy_actorKeep_cFv */

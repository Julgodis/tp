...
/* 8012F9E4  C0 A2 93 14 */	lfs f5, lit_7307(r2)                     /* constant-address: 80452D14, symbol: lit_7307 */
/* 8012F9E8  C0 82 92 98 */	lfs f4, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 8012F9EC  C0 63 34 78 */	lfs f3, 0x3478(r3)                      
/* 8012F9F0  C0 43 1F E0 */	lfs f2, 0x1fe0(r3)                      
/* 8012F9F4  A8 03 1F D6 */	lha r0, 0x1fd6(r3)                      
/* 8012F9F8  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 8012FA28  C4 03 56 1C */	lfsu f0, l_wolfBaseAnime@l(r3)           /* constant-address: 8042561C, symbol: l_wolfBaseAnime */
/* 8012FA2C  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 8012FA30  D0 1E 35 88 */	stfs f0, 0x3588(r30)                    
/* 8012FA34  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80425624, symbol: None */
/* 8012FA38  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 8012FA3C  D0 1E 35 90 */	stfs f0, 0x3590(r30)                    
/* 8012FA40  7F E3 FB 78 */	mr r3, r31                              
/* 8012FA44  48 02 EA 89 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 8012FA48  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8012FA4C  41 82 00 1C */	beq lbl_8012FA68                         /* constant-address: 8012FA68, symbol: lbl_8012FA68 */
/* 8012FA50  80 1E 19 9C */	lwz r0, 0x199c(r30)                     
/* 8012FA54  54 00 06 B5 */	rlwinm. r0, r0, 0, 0x1a, 0x1a           
/* 8012FA58  41 82 00 10 */	beq lbl_8012FA68                         /* constant-address: 8012FA68, symbol: lbl_8012FA68 */
/* 8012FA5C  7F C3 F3 78 */	mr r3, r30                              
/* 8012FA60  48 00 00 B9 */	bl procWolfSlipTurnLandInit__9daAlink_cFv /* constant-address: 8012FB18, symbol: procWolfSlipTurnLandInit__9daAlink_cFv */
/* 8012FA64  48 00 00 9C */	b lbl_8012FB00                           /* constant-address: 8012FB00, symbol: lbl_8012FB00 */
lbl_8012FA68:
/* 8012FA68  80 1E 31 A0 */	lwz r0, 0x31a0(r30)                     
/* 8012FA6C  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 8012FA70  40 82 00 28 */	bne lbl_8012FA98                         /* constant-address: 8012FA98, symbol: lbl_8012FA98 */
/* 8012FA74  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 8012FA78  C0 02 95 48 */	lfs f0, lit_23416(r2)                    /* constant-address: 80452F48, symbol: lit_23416 */
/* 8012FA7C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8012FA80  40 81 00 18 */	ble lbl_8012FA98                         /* constant-address: 8012FA98, symbol: lbl_8012FA98 */
/* 8012FA84  C0 1E 34 7C */	lfs f0, 0x347c(r30)                     
/* 8012FA88  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 8012FA8C  7F C3 F3 78 */	mr r3, r30                              
/* 8012FA90  4B F8 4E 41 */	bl setJumpMode__9daAlink_cFv             /* constant-address: 800B48D0, symbol: setJumpMode__9daAlink_cFv */
/* 8012FA94  48 00 00 68 */	b lbl_8012FAFC                           /* constant-address: 8012FAFC, symbol: lbl_8012FAFC */
lbl_8012FA98:
/* 8012FA98  28 00 00 00 */	cmplwi r0, 0                            
/* 8012FA9C  41 82 00 60 */	beq lbl_8012FAFC                         /* constant-address: 8012FAFC, symbol: lbl_8012FAFC */
...
/* 8012FAAC  38 63 EE 28 */	addi r3, r3, m__20daAlinkHIO_wlMove_c0@l /* constant-address: 8038EE28, symbol: m__20daAlinkHIO_wlMove_c0 */
/* 8012FAB0  C0 03 00 C0 */	lfs f0, 0xc0(r3)                         /* constant-address: 8038EEE8, symbol: None */
/* 8012FAB4  EC 01 00 28 */	fsubs f0, f1, f0                        
/* 8012FAB8  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8012FABC  40 80 00 40 */	bge lbl_8012FAFC                         /* constant-address: 8012FAFC, symbol: lbl_8012FAFC */
/* 8012FAC0  7F C3 F3 78 */	mr r3, r30                              
/* 8012FAC4  38 80 00 00 */	li r4, 0                                
/* 8012FAC8  38 A0 80 00 */	li r5, -32768                           
/* 8012FACC  38 C0 00 00 */	li r6, 0                                
/* 8012FAD0  4B F7 E0 A9 */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
...
/* 8012FAF0  38 A5 EE 28 */	addi r5, r5, m__20daAlinkHIO_wlMove_c0@l /* constant-address: 8038EE28, symbol: m__20daAlinkHIO_wlMove_c0 */
/* 8012FAF4  C0 25 00 C4 */	lfs f1, 0xc4(r5)                         /* constant-address: 8038EEEC, symbol: None */
/* 8012FAF8  4B FF F2 D9 */	bl procWolfFallInit__9daAlink_cFif       /* constant-address: 8012EDD0, symbol: procWolfFallInit__9daAlink_cFif */
lbl_8012FAFC:

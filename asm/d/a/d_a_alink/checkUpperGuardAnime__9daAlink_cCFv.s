...
/* 800DCE14  41 82 00 3C */	beq lbl_800DCE50                         /* constant-address: 800DCE50, symbol: lbl_800DCE50 */
/* 800DCE18  48 03 8E 09 */	bl checkEventRun__9daAlink_cCFv          /* constant-address: 80115C20, symbol: checkEventRun__9daAlink_cCFv */
/* 800DCE1C  2C 03 00 00 */	cmpwi r3, 0                             
/* 800DCE20  40 82 00 30 */	bne lbl_800DCE50                         /* constant-address: 800DCE50, symbol: lbl_800DCE50 */
/* 800DCE24  80 1E 05 70 */	lwz r0, 0x570(r30)                      
/* 800DCE28  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 800DCE2C  40 82 00 24 */	bne lbl_800DCE50                         /* constant-address: 800DCE50, symbol: lbl_800DCE50 */
/* 800DCE30  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800DCE34  28 00 00 1F */	cmplwi r0, 0x1f                         
/* 800DCE38  41 82 00 18 */	beq lbl_800DCE50                         /* constant-address: 800DCE50, symbol: lbl_800DCE50 */
/* 800DCE3C  28 00 00 25 */	cmplwi r0, 0x25                         
/* 800DCE40  41 82 00 10 */	beq lbl_800DCE50                         /* constant-address: 800DCE50, symbol: lbl_800DCE50 */
/* 800DCE44  28 00 00 1E */	cmplwi r0, 0x1e                         
/* 800DCE48  41 82 00 08 */	beq lbl_800DCE50                         /* constant-address: 800DCE50, symbol: lbl_800DCE50 */

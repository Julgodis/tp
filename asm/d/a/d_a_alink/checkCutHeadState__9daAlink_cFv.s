...
/* 800D2904  48 28 F8 CD */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
...
/* 800D2934  40 82 00 10 */	bne lbl_800D2944                         /* constant-address: 800D2944, symbol: lbl_800D2944 */
/* 800D2938  28 1B 00 00 */	cmplwi r27, 0                           
/* 800D293C  41 82 00 08 */	beq lbl_800D2944                         /* constant-address: 800D2944, symbol: lbl_800D2944 */
/* 800D2940  3B E0 00 01 */	li r31, 1                               
lbl_800D2944:
/* 800D2944  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 800D2948  41 82 00 40 */	beq lbl_800D2988                         /* constant-address: 800D2988, symbol: lbl_800D2988 */
/* 800D294C  3B E0 00 01 */	li r31, 1                               
/* 800D2950  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800D2954  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D2958  38 63 07 F0 */	addi r3, r3, 0x7f0                       /* constant-address: 804069B0, symbol: None */
/* 800D295C  38 80 29 01 */	li r4, 0x2901                           
/* 800D2960  4B F6 20 5D */	bl isEventBit__11dSv_event_cCFUs         /* constant-address: 800349BC, symbol: isEventBit__11dSv_event_cCFUs */
/* 800D2964  2C 03 00 00 */	cmpwi r3, 0                             
/* 800D2968  40 82 00 14 */	bne lbl_800D297C                         /* constant-address: 800D297C, symbol: lbl_800D297C */
/* 800D296C  80 1A 05 7C */	lwz r0, 0x57c(r26)                      
/* 800D2970  54 00 06 73 */	rlwinm. r0, r0, 0, 0x19, 0x19           
/* 800D2974  40 82 00 08 */	bne lbl_800D297C                         /* constant-address: 800D297C, symbol: lbl_800D297C */
/* 800D2978  3B E0 00 00 */	li r31, 0                               
lbl_800D297C:
/* 800D297C  57 E0 06 3F */	clrlwi. r0, r31, 0x18                   
/* 800D2980  41 82 00 08 */	beq lbl_800D2988                         /* constant-address: 800D2988, symbol: lbl_800D2988 */
/* 800D2984  3B 80 00 01 */	li r28, 1                               
lbl_800D2988:
/* 800D2988  57 80 06 3F */	clrlwi. r0, r28, 0x18                   
/* 800D298C  41 82 00 14 */	beq lbl_800D29A0                         /* constant-address: 800D29A0, symbol: lbl_800D29A0 */
/* 800D2990  88 1B 04 96 */	lbz r0, 0x496(r27)                      
/* 800D2994  28 00 00 02 */	cmplwi r0, 2                            
/* 800D2998  40 82 00 08 */	bne lbl_800D29A0                         /* constant-address: 800D29A0, symbol: lbl_800D29A0 */
/* 800D299C  3B A0 00 01 */	li r29, 1                               
lbl_800D29A0:
/* 800D29A0  57 A0 06 3F */	clrlwi. r0, r29, 0x18                   
/* 800D29A4  41 82 00 14 */	beq lbl_800D29B8                         /* constant-address: 800D29B8, symbol: lbl_800D29B8 */
/* 800D29A8  A0 1B 05 8E */	lhz r0, 0x58e(r27)                      
/* 800D29AC  54 00 06 31 */	rlwinm. r0, r0, 0, 0x18, 0x18           
/* 800D29B0  41 82 00 08 */	beq lbl_800D29B8                         /* constant-address: 800D29B8, symbol: lbl_800D29B8 */
/* 800D29B4  3B C0 00 01 */	li r30, 1                               
lbl_800D29B8:
/* 800D29B8  57 C3 06 3E */	clrlwi r3, r30, 0x18                    
/* 800D29BC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800D29C0  48 28 F8 5D */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

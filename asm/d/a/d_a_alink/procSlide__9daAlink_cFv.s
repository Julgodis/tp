...
/* 800C4538  38 04 37 C0 */	addi r0, r4, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800C453C  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 800C4540  38 81 00 08 */	addi r4, r1, 8                          
/* 800C4544  4B FE DA 95 */	bl getSlidePolygon__9daAlink_cFP8cM3dGPla /* constant-address: 800B1FD8, symbol: getSlidePolygon__9daAlink_cFP8cM3dGPla */
/* 800C4548  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800C454C  41 82 02 24 */	beq lbl_800C4770                         /* constant-address: 800C4770, symbol: lbl_800C4770 */
/* 800C4550  38 61 00 08 */	addi r3, r1, 8                          
/* 800C4554  48 1A 2B D5 */	bl atan2sX_Z__4cXyzCFv                   /* constant-address: 80267128, symbol: atan2sX_Z__4cXyzCFv */
/* 800C4558  7C 7F 1B 78 */	mr r31, r3                              
/* 800C455C  80 1E 31 98 */	lwz r0, 0x3198(r30)                     
/* 800C4560  2C 00 00 00 */	cmpwi r0, 0                             
/* 800C4564  41 82 00 DC */	beq lbl_800C4640                         /* constant-address: 800C4640, symbol: lbl_800C4640 */
...
/* 800C457C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800C4590  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 800C4594  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C4598  40 81 00 68 */	ble lbl_800C4600                         /* constant-address: 800C4600, symbol: lbl_800C4600 */
/* 800C459C  A8 1E 30 0C */	lha r0, 0x300c(r30)                     
/* 800C45A0  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800C45BC  C0 02 94 FC */	lfs f0, lit_20400(r2)                    /* constant-address: 80452EFC, symbol: lit_20400 */
...
/* 800C45DC  40 80 00 0C */	bge lbl_800C45E8                         /* constant-address: 800C45E8, symbol: lbl_800C45E8 */
/* 800C45E0  38 00 F0 00 */	li r0, -4096                            
/* 800C45E4  48 00 00 14 */	b lbl_800C45F8                           /* constant-address: 800C45F8, symbol: lbl_800C45F8 */
lbl_800C45E8:
/* 800C45E8  2C 00 10 00 */	cmpwi r0, 0x1000                        
/* 800C45EC  38 00 10 00 */	li r0, 0x1000                           
/* 800C45F0  41 81 00 08 */	bgt lbl_800C45F8                         /* constant-address: 800C45F8, symbol: lbl_800C45F8 */
/* 800C45F4  7C 60 1B 78 */	mr r0, r3                               
lbl_800C45F8:
/* 800C45F8  B0 1E 30 0C */	sth r0, 0x300c(r30)                     
/* 800C45FC  48 00 00 14 */	b lbl_800C4610                           /* constant-address: 800C4610, symbol: lbl_800C4610 */
lbl_800C4600:
/* 800C4600  38 7E 30 0C */	addi r3, r30, 0x300c                    
/* 800C4604  38 80 00 00 */	li r4, 0                                
/* 800C4608  38 A0 00 40 */	li r5, 0x40                             
/* 800C460C  48 1A C0 C5 */	bl cLib_chaseS__FPsss                    /* constant-address: 802706D0, symbol: cLib_chaseS__FPsss */
lbl_800C4610:
/* 800C4610  A8 1E 30 0C */	lha r0, 0x300c(r30)                     
/* 800C4614  7F FF 02 14 */	add r31, r31, r0                        
/* 800C4618  38 7E 30 10 */	addi r3, r30, 0x3010                    
/* 800C461C  C0 02 98 E0 */	lfs f0, lit_73057(r2)                    /* constant-address: 804532E0, symbol: lit_73057 */
...
/* 800C463C  48 1A BF 05 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
lbl_800C4640:
...
/* 800C4654  48 1A BE ED */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
/* 800C4658  80 1E 31 98 */	lwz r0, 0x3198(r30)                     
/* 800C465C  2C 00 00 00 */	cmpwi r0, 0                             
/* 800C4660  41 82 00 14 */	beq lbl_800C4674                         /* constant-address: 800C4674, symbol: lbl_800C4674 */
/* 800C4664  A8 9E 04 DE */	lha r4, 0x4de(r30)                      
/* 800C4668  38 00 00 04 */	li r0, 4                                
/* 800C466C  98 1E 2F 9D */	stb r0, 0x2f9d(r30)                     
/* 800C4670  48 00 00 1C */	b lbl_800C468C                           /* constant-address: 800C468C, symbol: lbl_800C468C */
lbl_800C4674:
...
/* 800C469C  48 1A BE A5 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
/* 800C46A0  80 1E 31 98 */	lwz r0, 0x3198(r30)                     
/* 800C46A4  2C 00 00 00 */	cmpwi r0, 0                             
/* 800C46A8  41 82 00 14 */	beq lbl_800C46BC                         /* constant-address: 800C46BC, symbol: lbl_800C46BC */
/* 800C46AC  C0 3E 1F E0 */	lfs f1, 0x1fe0(r30)                     
/* 800C46B0  C0 02 93 44 */	lfs f0, lit_7977(r2)                     /* constant-address: 80452D44, symbol: lit_7977 */
/* 800C46B4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C46B8  40 81 00 C4 */	ble lbl_800C477C                         /* constant-address: 800C477C, symbol: lbl_800C477C */
lbl_800C46BC:
/* 800C46BC  3C 60 80 39 */	lis r3, m__19daAlinkHIO_slide_c0@ha     
/* 800C46C0  38 63 D8 CC */	addi r3, r3, m__19daAlinkHIO_slide_c0@l  /* constant-address: 8038D8CC, symbol: m__19daAlinkHIO_slide_c0 */
/* 800C46C4  C0 A3 00 54 */	lfs f5, 0x54(r3)                         /* constant-address: 8038D920, symbol: None */
/* 800C46C8  C0 DE 05 94 */	lfs f6, 0x594(r30)                      
/* 800C46CC  80 1E 05 70 */	lwz r0, 0x570(r30)                      
/* 800C46D0  54 00 02 11 */	rlwinm. r0, r0, 0, 8, 8                 
/* 800C46D4  41 82 00 10 */	beq lbl_800C46E4                         /* constant-address: 800C46E4, symbol: lbl_800C46E4 */
/* 800C46D8  C0 02 94 A8 */	lfs f0, lit_16570(r2)                    /* constant-address: 80452EA8, symbol: lit_16570 */
...
/* 800C46E8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800C4704  C0 42 92 B8 */	lfs f2, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800C4708  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800C4734  40 81 00 08 */	ble lbl_800C473C                         /* constant-address: 800C473C, symbol: lbl_800C473C */
/* 800C4738  D0 DE 33 98 */	stfs f6, 0x3398(r30)                    
lbl_800C473C:
/* 800C473C  80 1E 31 98 */	lwz r0, 0x3198(r30)                     
/* 800C4740  2C 00 00 00 */	cmpwi r0, 0                             
/* 800C4744  41 82 00 18 */	beq lbl_800C475C                         /* constant-address: 800C475C, symbol: lbl_800C475C */
/* 800C4748  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800C4764  38 84 00 17 */	addi r4, r4, 0x0017 /* 0x00030017@l */   /* constant-address: 00030017 */
/* 800C4768  4B FF AA 65 */	bl seStartMapInfoLevel__9daAlink_cFUl    /* constant-address: 800BF1CC, symbol: seStartMapInfoLevel__9daAlink_cFUl */
/* 800C476C  48 00 00 10 */	b lbl_800C477C                           /* constant-address: 800C477C, symbol: lbl_800C477C */
lbl_800C4770:
/* 800C4770  7F C3 F3 78 */	mr r3, r30                              
/* 800C4774  80 9E 31 98 */	lwz r4, 0x3198(r30)                     
/* 800C4778  48 00 00 35 */	bl procSlideLandInit__9daAlink_cFi       /* constant-address: 800C47AC, symbol: procSlideLandInit__9daAlink_cFi */
lbl_800C477C:
/* 800C477C  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800C4780  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */

...
/* 8010DB50  41 82 00 60 */	beq lbl_8010DBB0                         /* constant-address: 8010DBB0, symbol: lbl_8010DBB0 */
/* 8010DB54  80 BF 28 18 */	lwz r5, 0x2818(r31)                     
/* 8010DB58  28 05 00 00 */	cmplwi r5, 0                            
/* 8010DB5C  41 82 00 54 */	beq lbl_8010DBB0                         /* constant-address: 8010DBB0, symbol: lbl_8010DBB0 */
...
/* 8010DB70  40 82 00 18 */	bne lbl_8010DB88                         /* constant-address: 8010DB88, symbol: lbl_8010DB88 */
/* 8010DB74  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 8010DB78  C0 05 05 78 */	lfs f0, 0x578(r5)                       
/* 8010DB7C  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8010DB80  41 82 00 08 */	beq lbl_8010DB88                         /* constant-address: 8010DB88, symbol: lbl_8010DB88 */
/* 8010DB84  7C 64 1B 78 */	mr r4, r3                               
lbl_8010DB88:
/* 8010DB88  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 8010DB8C  40 82 00 14 */	bne lbl_8010DBA0                         /* constant-address: 8010DBA0, symbol: lbl_8010DBA0 */
/* 8010DB90  88 05 0A 6F */	lbz r0, 0xa6f(r5)                       
/* 8010DB94  28 00 00 00 */	cmplwi r0, 0                            
/* 8010DB98  40 82 00 08 */	bne lbl_8010DBA0                         /* constant-address: 8010DBA0, symbol: lbl_8010DBA0 */
/* 8010DB9C  38 60 00 01 */	li r3, 1                                
lbl_8010DBA0:
/* 8010DBA0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8010DBA4  41 82 00 0C */	beq lbl_8010DBB0                         /* constant-address: 8010DBB0, symbol: lbl_8010DBB0 */
/* 8010DBA8  38 60 00 01 */	li r3, 1                                
/* 8010DBAC  48 00 00 08 */	b lbl_8010DBB4                           /* constant-address: 8010DBB4, symbol: lbl_8010DBB4 */
lbl_8010DBB0:

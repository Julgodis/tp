...
/* 80104680  48 25 DB 59 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 801046B0  4B FB D8 BD */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 801046B4  80 1F 05 70 */	lwz r0, 0x570(r31)                      
/* 801046B8  54 00 02 11 */	rlwinm. r0, r0, 0, 8, 8                 
/* 801046BC  41 82 00 10 */	beq lbl_801046CC                         /* constant-address: 801046CC, symbol: lbl_801046CC */
...
/* 801046D0  40 82 00 1C */	bne lbl_801046EC                         /* constant-address: 801046EC, symbol: lbl_801046EC */
/* 801046D4  3C 60 80 39 */	lis r3, m__18daAlinkHIO_swim_c0@ha      
/* 801046D8  38 63 ED 2C */	addi r3, r3, m__18daAlinkHIO_swim_c0@l   /* constant-address: 8038ED2C, symbol: m__18daAlinkHIO_swim_c0 */
/* 801046DC  C0 03 00 60 */	lfs f0, 0x60(r3)                         /* constant-address: 8038ED8C, symbol: None */
...
/* 801046F0  40 82 00 0C */	bne lbl_801046FC                         /* constant-address: 801046FC, symbol: lbl_801046FC */
/* 801046F4  57 A0 06 3F */	clrlwi. r0, r29, 0x18                   
/* 801046F8  41 82 00 4C */	beq lbl_80104744                         /* constant-address: 80104744, symbol: lbl_80104744 */
lbl_801046FC:
/* 801046FC  38 00 00 C7 */	li r0, 0xc7                             
/* 80104700  90 1F 31 98 */	stw r0, 0x3198(r31)                     
/* 80104704  57 A0 06 3F */	clrlwi. r0, r29, 0x18                   
/* 80104708  41 82 00 44 */	beq lbl_8010474C                         /* constant-address: 8010474C, symbol: lbl_8010474C */
...
/* 8010473C  4B FA 94 3D */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
/* 80104740  48 00 00 0C */	b lbl_8010474C                           /* constant-address: 8010474C, symbol: lbl_8010474C */
lbl_80104744:
...
/* 80104758  4B FF EF 41 */	bl setSwimMoveAnime__9daAlink_cFv        /* constant-address: 80103698, symbol: setSwimMoveAnime__9daAlink_cFv */
/* 8010475C  80 1F 05 70 */	lwz r0, 0x570(r31)                      
/* 80104760  54 00 05 EF */	rlwinm. r0, r0, 0, 0x17, 0x17           
/* 80104764  41 82 00 14 */	beq lbl_80104778                         /* constant-address: 80104778, symbol: lbl_80104778 */
/* 80104768  C0 1F 33 B4 */	lfs f0, 0x33b4(r31)                     
/* 8010476C  D0 1F 04 D4 */	stfs f0, 0x4d4(r31)                     
/* 80104770  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80104774  D0 1F 04 FC */	stfs f0, 0x4fc(r31)                     
lbl_80104778:
/* 80104778  7F E3 FB 78 */	mr r3, r31                              
/* 8010477C  4B FF D1 B9 */	bl swimDeleteItem__9daAlink_cFv          /* constant-address: 80101934, symbol: swimDeleteItem__9daAlink_cFv */
/* 80104780  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80104784  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80104788  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 8010478C  64 00 00 10 */	oris r0, r0, 0x10                       
/* 80104790  90 03 5F 18 */	stw r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
...
/* 801047A4  48 25 DA 81 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 800AD408  48 2B 4D C5 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 800AD430  40 82 00 54 */	bne lbl_800AD484                         /* constant-address: 800AD484, symbol: lbl_800AD484 */
/* 800AD434  48 00 28 89 */	bl resetFacePriAnime__9daAlink_cFv       /* constant-address: 800AFCBC, symbol: resetFacePriAnime__9daAlink_cFv */
/* 800AD438  80 9A 05 74 */	lwz r4, 0x574(r26)                      
/* 800AD43C  3C 60 EB E9 */	lis r3, 0xEBE9 /* 0xEBE8FFB5@ha */      
/* 800AD440  38 03 FF B5 */	addi r0, r3, 0xFFB5 /* 0xEBE8FFB5@l */   /* constant-address: EBE8FFB5 */
...
/* 800AD454  48 00 9D 3D */	bl cancelItemUseQuake__9daAlink_cFi      /* constant-address: 800B7190, symbol: cancelItemUseQuake__9daAlink_cFi */
/* 800AD458  38 60 00 00 */	li r3, 0                                
/* 800AD45C  A0 1A 1F BC */	lhz r0, 0x1fbc(r26)                     
/* 800AD460  28 00 00 62 */	cmplwi r0, 0x62                         
/* 800AD464  41 82 00 10 */	beq lbl_800AD474                         /* constant-address: 800AD474, symbol: lbl_800AD474 */
/* 800AD468  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD46C  28 00 02 A0 */	cmplwi r0, 0x2a0                        
/* 800AD470  40 82 00 08 */	bne lbl_800AD478                         /* constant-address: 800AD478, symbol: lbl_800AD478 */
lbl_800AD474:
/* 800AD474  38 60 00 01 */	li r3, 1                                
lbl_800AD478:
/* 800AD478  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD47C  41 82 00 08 */	beq lbl_800AD484                         /* constant-address: 800AD484, symbol: lbl_800AD484 */
/* 800AD480  3B E0 00 01 */	li r31, 1                               
lbl_800AD484:
/* 800AD484  A0 1A 1F BC */	lhz r0, 0x1fbc(r26)                     
/* 800AD488  28 00 02 62 */	cmplwi r0, 0x262                        
/* 800AD48C  40 82 00 10 */	bne lbl_800AD49C                         /* constant-address: 800AD49C, symbol: lbl_800AD49C */
...
/* 800AD4B4  4B FF 68 59 */	bl getAnimeResource__9daAlink_cFP14daPy_anmHeap_cUsUl /* constant-address: 800A3D0C, symbol: getAnimeResource__9daAlink_cFP14daPy_anmHeap_cUsUl */
/* 800AD4B8  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 800AD4BC  40 82 00 10 */	bne lbl_800AD4CC                         /* constant-address: 800AD4CC, symbol: lbl_800AD4CC */
...
/* 800AD4D8  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800AD4EC  40 80 00 08 */	bge lbl_800AD4F4                         /* constant-address: 800AD4F4, symbol: lbl_800AD4F4 */
/* 800AD4F0  AB BE 00 06 */	lha r29, 6(r30)                         
lbl_800AD4F4:
/* 800AD4F4  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800AD4F8  FC 1C 00 40 */	fcmpo cr0, f28, f0                      
/* 800AD4FC  40 80 00 28 */	bge lbl_800AD524                         /* constant-address: 800AD524, symbol: lbl_800AD524 */
/* 800AD500  7F A0 07 34 */	extsh r0, r29                           
/* 800AD504  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800AD520  48 00 00 08 */	b lbl_800AD528                           /* constant-address: 800AD528, symbol: lbl_800AD528 */
lbl_800AD524:
/* 800AD524  FF E0 E8 90 */	fmr f31, f29                            
lbl_800AD528:
/* 800AD528  7F 43 D3 78 */	mr r3, r26                              
/* 800AD52C  48 01 28 85 */	bl checkZoraWearAbility__9daAlink_cCFv   /* constant-address: 800BFDB0, symbol: checkZoraWearAbility__9daAlink_cCFv */
/* 800AD530  2C 03 00 00 */	cmpwi r3, 0                             
/* 800AD534  40 82 00 58 */	bne lbl_800AD58C                         /* constant-address: 800AD58C, symbol: lbl_800AD58C */
/* 800AD538  7F 43 D3 78 */	mr r3, r26                              
/* 800AD53C  48 00 BE 05 */	bl checkEquipAnime__9daAlink_cCFv        /* constant-address: 800B9340, symbol: checkEquipAnime__9daAlink_cCFv */
/* 800AD540  2C 03 00 00 */	cmpwi r3, 0                             
/* 800AD544  40 82 00 14 */	bne lbl_800AD558                         /* constant-address: 800AD558, symbol: lbl_800AD558 */
/* 800AD548  7F 43 D3 78 */	mr r3, r26                              
/* 800AD54C  48 02 39 81 */	bl checkCutDashAnime__9daAlink_cCFv      /* constant-address: 800D0ECC, symbol: checkCutDashAnime__9daAlink_cCFv */
/* 800AD550  2C 03 00 00 */	cmpwi r3, 0                             
/* 800AD554  41 82 00 38 */	beq lbl_800AD58C                         /* constant-address: 800AD58C, symbol: lbl_800AD58C */
lbl_800AD558:
/* 800AD558  80 7A 05 70 */	lwz r3, 0x570(r26)                      
/* 800AD55C  54 60 02 11 */	rlwinm. r0, r3, 0, 8, 8                 
/* 800AD560  40 82 00 0C */	bne lbl_800AD56C                         /* constant-address: 800AD56C, symbol: lbl_800AD56C */
/* 800AD564  54 60 05 EF */	rlwinm. r0, r3, 0, 0x17, 0x17           
/* 800AD568  40 82 00 24 */	bne lbl_800AD58C                         /* constant-address: 800AD58C, symbol: lbl_800AD58C */
lbl_800AD56C:
...
/* 800AD574  C0 43 00 28 */	lfs f2, 0x28(r3)                         /* constant-address: 8038E81C, symbol: None */
/* 800AD578  C0 22 92 B8 */	lfs f1, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800AD57C  C0 03 00 2C */	lfs f0, 0x2c(r3)                         /* constant-address: 8038E820, symbol: None */
...
/* 800AD5B8  4B FF ED DD */	bl setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff /* constant-address: 800AC394, symbol: setFrameCtrl__9daAlink_cFP16daPy_frameCtrl_cUcssff */
/* 800AD5BC  D3 FE 00 08 */	stfs f31, 8(r30)                        
/* 800AD5C0  7F 43 D3 78 */	mr r3, r26                              
/* 800AD5C4  FC 20 F0 90 */	fmr f1, f30                             
/* 800AD5C8  4B FF FD 11 */	bl setUpperAnimeMorf__9daAlink_cFf       /* constant-address: 800AD2D8, symbol: setUpperAnimeMorf__9daAlink_cFf */
/* 800AD5CC  7F 43 D3 78 */	mr r3, r26                              
/* 800AD5D0  48 03 14 19 */	bl checkBowAnime__9daAlink_cCFv          /* constant-address: 800DE9E8, symbol: checkBowAnime__9daAlink_cCFv */
/* 800AD5D4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800AD5D8  40 82 00 14 */	bne lbl_800AD5EC                         /* constant-address: 800AD5EC, symbol: lbl_800AD5EC */
/* 800AD5DC  7F 43 D3 78 */	mr r3, r26                              
/* 800AD5E0  48 03 26 91 */	bl setBowNormalAnime__9daAlink_cFv       /* constant-address: 800DFC70, symbol: setBowNormalAnime__9daAlink_cFv */
/* 800AD5E4  7F 43 D3 78 */	mr r3, r26                              
/* 800AD5E8  48 03 14 FD */	bl deleteArrow__9daAlink_cFv             /* constant-address: 800DEAE4, symbol: deleteArrow__9daAlink_cFv */
lbl_800AD5EC:
/* 800AD5EC  7F 43 D3 78 */	mr r3, r26                              
/* 800AD5F0  48 03 66 AD */	bl checkGrabAnimeAndThrow__9daAlink_cCFv /* constant-address: 800E3C9C, symbol: checkGrabAnimeAndThrow__9daAlink_cCFv */
/* 800AD5F4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800AD5F8  40 82 00 34 */	bne lbl_800AD62C                         /* constant-address: 800AD62C, symbol: lbl_800AD62C */
/* 800AD5FC  38 60 00 00 */	li r3, 0                                
/* 800AD600  A0 1A 1F BC */	lhz r0, 0x1fbc(r26)                     
/* 800AD604  28 00 02 DA */	cmplwi r0, 0x2da                        
/* 800AD608  41 82 00 10 */	beq lbl_800AD618                         /* constant-address: 800AD618, symbol: lbl_800AD618 */
/* 800AD60C  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD610  28 00 02 DB */	cmplwi r0, 0x2db                        
/* 800AD614  40 82 00 08 */	bne lbl_800AD61C                         /* constant-address: 800AD61C, symbol: lbl_800AD61C */
lbl_800AD618:
/* 800AD618  38 60 00 01 */	li r3, 1                                
lbl_800AD61C:
/* 800AD61C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD620  40 82 00 0C */	bne lbl_800AD62C                         /* constant-address: 800AD62C, symbol: lbl_800AD62C */
/* 800AD624  7F 43 D3 78 */	mr r3, r26                              
/* 800AD628  48 03 75 AD */	bl freeGrabItem__9daAlink_cFv            /* constant-address: 800E4BD4, symbol: freeGrabItem__9daAlink_cFv */
lbl_800AD62C:
/* 800AD62C  38 60 00 00 */	li r3, 0                                
/* 800AD630  A0 1A 1F BC */	lhz r0, 0x1fbc(r26)                     
/* 800AD634  28 00 02 BD */	cmplwi r0, 0x2bd                        
/* 800AD638  41 82 00 10 */	beq lbl_800AD648                         /* constant-address: 800AD648, symbol: lbl_800AD648 */
/* 800AD63C  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD640  28 00 02 BE */	cmplwi r0, 0x2be                        
/* 800AD644  40 82 00 08 */	bne lbl_800AD64C                         /* constant-address: 800AD64C, symbol: lbl_800AD64C */
lbl_800AD648:
/* 800AD648  38 60 00 01 */	li r3, 1                                
lbl_800AD64C:
/* 800AD64C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD650  40 82 00 18 */	bne lbl_800AD668                         /* constant-address: 800AD668, symbol: lbl_800AD668 */
/* 800AD654  80 1A 05 78 */	lwz r0, 0x578(r26)                      
/* 800AD658  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c           
/* 800AD65C  41 82 00 0C */	beq lbl_800AD668                         /* constant-address: 800AD668, symbol: lbl_800AD668 */
/* 800AD660  7F 43 D3 78 */	mr r3, r26                              
/* 800AD664  48 08 B5 A1 */	bl resetWolfEnemyBiteAll__9daAlink_cFv   /* constant-address: 80138C04, symbol: resetWolfEnemyBiteAll__9daAlink_cFv */
lbl_800AD668:
/* 800AD668  2C 1F 00 00 */	cmpwi r31, 0                            
/* 800AD66C  41 82 00 3C */	beq lbl_800AD6A8                         /* constant-address: 800AD6A8, symbol: lbl_800AD6A8 */
/* 800AD670  38 60 00 00 */	li r3, 0                                
/* 800AD674  A0 1A 1F BC */	lhz r0, 0x1fbc(r26)                     
/* 800AD678  28 00 00 62 */	cmplwi r0, 0x62                         
/* 800AD67C  41 82 00 10 */	beq lbl_800AD68C                         /* constant-address: 800AD68C, symbol: lbl_800AD68C */
/* 800AD680  54 00 04 3E */	clrlwi r0, r0, 0x10                     
/* 800AD684  28 00 02 A0 */	cmplwi r0, 0x2a0                        
/* 800AD688  40 82 00 08 */	bne lbl_800AD690                         /* constant-address: 800AD690, symbol: lbl_800AD690 */
lbl_800AD68C:
/* 800AD68C  38 60 00 01 */	li r3, 1                                
lbl_800AD690:
/* 800AD690  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800AD694  40 82 00 14 */	bne lbl_800AD6A8                         /* constant-address: 800AD6A8, symbol: lbl_800AD6A8 */
/* 800AD698  38 00 00 00 */	li r0, 0                                
/* 800AD69C  98 1A 2F A3 */	stb r0, 0x2fa3(r26)                     
/* 800AD6A0  38 7A 28 44 */	addi r3, r26, 0x2844                    
/* 800AD6A4  48 0B 16 59 */	bl clearData__16daPy_actorKeep_cFv       /* constant-address: 8015ECFC, symbol: clearData__16daPy_actorKeep_cFv */
lbl_800AD6A8:
...
/* 800AD6DC  48 2B 4B 3D */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

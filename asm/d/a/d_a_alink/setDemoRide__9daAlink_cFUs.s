...
/* 80118964  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80118968  80 63 5D B8 */	lwz r3, 0x5db8(r3)                       /* constant-address: 8040BF78, symbol: None */
/* 8011896C  54 80 04 3E */	clrlwi r0, r4, 0x10                     
/* 80118970  28 00 00 01 */	cmplwi r0, 1                            
/* 80118974  40 82 00 48 */	bne lbl_801189BC                         /* constant-address: 801189BC, symbol: lbl_801189BC */
/* 80118978  28 03 00 00 */	cmplwi r3, 0                            
/* 8011897C  41 82 00 68 */	beq lbl_801189E4                         /* constant-address: 801189E4, symbol: lbl_801189E4 */
/* 80118980  80 1F 31 A0 */	lwz r0, 0x31a0(r31)                     
/* 80118984  54 00 05 6B */	rlwinm. r0, r0, 0, 0x15, 0x15           
/* 80118988  40 82 00 5C */	bne lbl_801189E4                         /* constant-address: 801189E4, symbol: lbl_801189E4 */
...
/* 8011899C  48 24 96 E9 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 801189A0  60 00 00 00 */	nop                                     
/* 801189A4  3C 60 80 42 */	lis r3, l_horseBaseAnime@ha             
/* 801189A8  38 03 55 8C */	addi r0, r3, l_horseBaseAnime@l          /* constant-address: 8042558C, symbol: l_horseBaseAnime */
/* 801189AC  90 1F 38 4C */	stw r0, 0x384c(r31)                     
/* 801189B0  38 00 00 01 */	li r0, 1                                
/* 801189B4  98 1F 2F AA */	stb r0, 0x2faa(r31)                     
/* 801189B8  48 00 00 2C */	b lbl_801189E4                           /* constant-address: 801189E4, symbol: lbl_801189E4 */
lbl_801189BC:
/* 801189BC  28 03 00 00 */	cmplwi r3, 0                            
/* 801189C0  41 82 00 10 */	beq lbl_801189D0                         /* constant-address: 801189D0, symbol: lbl_801189D0 */
/* 801189C4  39 83 18 F8 */	addi r12, r3, 0x18f8                    
/* 801189C8  48 24 96 BD */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */

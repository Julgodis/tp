...
/* 800ABBD0  48 1B AF 15 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
/* 800ABBD4  38 61 00 50 */	addi r3, r1, 0x50                       
/* 800ABBD8  38 81 00 5C */	addi r4, r1, 0x5c                       
/* 800ABBDC  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800ABBE0  48 1B AF A5 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 800ABC08  40 81 00 10 */	ble lbl_800ABC18                         /* constant-address: 800ABC18, symbol: lbl_800ABC18 */
/* 800ABC0C  D0 01 00 6C */	stfs f0, 0x6c(r1)                       
/* 800ABC10  EF E1 00 28 */	fsubs f31, f1, f0                       
/* 800ABC14  48 00 00 0C */	b lbl_800ABC20                           /* constant-address: 800ABC20, symbol: lbl_800ABC20 */
lbl_800ABC18:
/* 800ABC18  D0 21 00 6C */	stfs f1, 0x6c(r1)                       
/* 800ABC1C  EF E0 08 28 */	fsubs f31, f0, f1                       
lbl_800ABC20:
/* 800ABC20  C0 62 93 B4 */	lfs f3, lit_10040(r2)                    /* constant-address: 80452DB4, symbol: lit_10040 */
/* 800ABC24  FC 1F 18 40 */	fcmpo cr0, f31, f3                      
/* 800ABC28  40 80 00 20 */	bge lbl_800ABC48                         /* constant-address: 800ABC48, symbol: lbl_800ABC48 */
/* 800ABC2C  C0 41 00 6C */	lfs f2, 0x6c(r1)                        
/* 800ABC30  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800ABC50  48 1C 35 8D */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
/* 800ABC54  38 7F 0B EC */	addi r3, r31, 0xbec                     
/* 800ABC58  FC 20 F8 90 */	fmr f1, f31                             
/* 800ABC5C  48 1C 35 9D */	bl SetH__8cM3dGCylFf                     /* constant-address: 8026F1F8, symbol: SetH__8cM3dGCylFf */
/* 800ABC60  38 61 00 44 */	addi r3, r1, 0x44                       
/* 800ABC64  38 9F 05 E0 */	addi r4, r31, 0x5e0                     
/* 800ABC68  38 BF 05 EC */	addi r5, r31, 0x5ec                     
/* 800ABC6C  48 1B AE 79 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
/* 800ABC70  38 61 00 38 */	addi r3, r1, 0x38                       
/* 800ABC74  38 81 00 44 */	addi r4, r1, 0x44                       
/* 800ABC78  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800ABC7C  48 1B AF 09 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
/* 800ABC80  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 800ABC84  38 81 00 38 */	addi r4, r1, 0x38                       
/* 800ABC88  38 A1 00 74 */	addi r5, r1, 0x74                       
/* 800ABC8C  48 1B AE 59 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
/* 800ABC90  38 61 00 20 */	addi r3, r1, 0x20                       
/* 800ABC94  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 800ABC98  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800ABC9C  48 1B AE E9 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 800ABCC4  40 81 00 08 */	ble lbl_800ABCCC                         /* constant-address: 800ABCCC, symbol: lbl_800ABCCC */
/* 800ABCC8  48 00 00 08 */	b lbl_800ABCD0                           /* constant-address: 800ABCD0, symbol: lbl_800ABCD0 */
lbl_800ABCCC:
/* 800ABCCC  FC 00 08 90 */	fmr f0, f1                              
lbl_800ABCD0:
/* 800ABCD0  C0 21 00 78 */	lfs f1, 0x78(r1)                        
/* 800ABCD4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800ABCD8  40 81 00 10 */	ble lbl_800ABCE8                         /* constant-address: 800ABCE8, symbol: lbl_800ABCE8 */
/* 800ABCDC  D0 01 00 6C */	stfs f0, 0x6c(r1)                       
/* 800ABCE0  EF E1 00 28 */	fsubs f31, f1, f0                       
/* 800ABCE4  48 00 00 0C */	b lbl_800ABCF0                           /* constant-address: 800ABCF0, symbol: lbl_800ABCF0 */
lbl_800ABCE8:
/* 800ABCE8  D0 21 00 6C */	stfs f1, 0x6c(r1)                       
/* 800ABCEC  EF E0 08 28 */	fsubs f31, f0, f1                       
lbl_800ABCF0:
/* 800ABCF0  C0 62 93 B4 */	lfs f3, lit_10040(r2)                    /* constant-address: 80452DB4, symbol: lit_10040 */
/* 800ABCF4  FC 1F 18 40 */	fcmpo cr0, f31, f3                      
/* 800ABCF8  40 80 00 20 */	bge lbl_800ABD18                         /* constant-address: 800ABD18, symbol: lbl_800ABD18 */
/* 800ABCFC  C0 41 00 6C */	lfs f2, 0x6c(r1)                        
/* 800ABD00  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800ABD20  48 1C 34 BD */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
/* 800ABD24  38 7F 09 74 */	addi r3, r31, 0x974                     
/* 800ABD28  FC 20 F8 90 */	fmr f1, f31                             
/* 800ABD2C  48 1C 34 CD */	bl SetH__8cM3dGCylFf                     /* constant-address: 8026F1F8, symbol: SetH__8cM3dGCylFf */
/* 800ABD30  38 61 00 14 */	addi r3, r1, 0x14                       
/* 800ABD34  38 9F 09 74 */	addi r4, r31, 0x974                     
/* 800ABD38  38 BF 0B EC */	addi r5, r31, 0xbec                     
/* 800ABD3C  48 1B AD A9 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
/* 800ABD40  38 61 00 08 */	addi r3, r1, 8                          
/* 800ABD44  38 81 00 14 */	addi r4, r1, 0x14                       
/* 800ABD48  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800ABD4C  48 1B AE 39 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 800ABD68  C0 42 92 98 */	lfs f2, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800ABD84  48 1C 34 59 */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
/* 800ABD88  38 7F 0A B0 */	addi r3, r31, 0xab0                     
/* 800ABD8C  FC 20 F8 90 */	fmr f1, f31                             
/* 800ABD90  48 1C 34 69 */	bl SetH__8cM3dGCylFf                     /* constant-address: 8026F1F8, symbol: SetH__8cM3dGCylFf */

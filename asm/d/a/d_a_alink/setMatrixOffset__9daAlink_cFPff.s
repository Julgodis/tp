...
/* 800A2C48  41 82 00 1C */	beq lbl_800A2C64                         /* constant-address: 800A2C64, symbol: lbl_800A2C64 */
/* 800A2C4C  7F E3 FB 78 */	mr r3, r31                              
/* 800A2C50  C0 42 92 98 */	lfs f2, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800A2C54  C0 62 97 B4 */	lfs f3, lit_52234(r2)                    /* constant-address: 804531B4, symbol: lit_52234 */
/* 800A2C58  C0 82 93 D8 */	lfs f4, lit_11470(r2)                    /* constant-address: 80452DD8, symbol: lit_11470 */
/* 800A2C5C  48 1C CD 21 */	bl cLib_addCalc__FPfffff                 /* constant-address: 8026F97C, symbol: cLib_addCalc__FPfffff */
/* 800A2C60  48 00 00 10 */	b lbl_800A2C70                           /* constant-address: 800A2C70, symbol: lbl_800A2C70 */
lbl_800A2C64:
/* 800A2C64  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 800A2C68  28 00 01 3D */	cmplwi r0, 0x13d                        
/* 800A2C6C  41 82 00 5C */	beq lbl_800A2CC8                         /* constant-address: 800A2CC8, symbol: lbl_800A2CC8 */
lbl_800A2C70:
...
/* 800A2C98  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A2C9C  A8 9E 04 E4 */	lha r4, 0x4e4(r30)                      
/* 800A2CA0  4B F6 96 A5 */	bl mDoMtx_XrotS__FPA4_fs                 /* constant-address: 8000C344, symbol: mDoMtx_XrotS__FPA4_fs */
/* 800A2CA4  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A2CA8  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A2CAC  38 9E 2B B8 */	addi r4, r30, 0x2bb8                    
/* 800A2CB0  7C 65 1B 78 */	mr r5, r3                               
/* 800A2CB4  48 2A 38 31 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 800A2CB8  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A2CBC  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A2CC0  38 9E 2B E8 */	addi r4, r30, 0x2be8                    
/* 800A2CC4  48 2A 37 ED */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
lbl_800A2CC8:

...
/* 800F8FA8  4B FB A4 ED */	bl getDirectionFromAngle__9daAlink_cFs   /* constant-address: 800B3494, symbol: getDirectionFromAngle__9daAlink_cFs */
...
/* 800F8FB8  38 84 9A 20 */	addi r4, r4, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800F8FBC  7C 84 04 2E */	lfsx f4, r4, r0                         
/* 800F8FC0  38 84 00 04 */	addi r4, r4, 4                           /* constant-address: 80439A24, symbol: None */
/* 800F8FC4  7C 04 04 2E */	lfsx f0, r4, r0                         
/* 800F8FC8  2C 03 00 02 */	cmpwi r3, 2                             
/* 800F8FCC  40 82 00 7C */	bne lbl_800F9048                         /* constant-address: 800F9048, symbol: lbl_800F9048 */
/* 800F8FD0  80 1F 31 98 */	lwz r0, 0x3198(r31)                     
/* 800F8FD4  54 00 07 7B */	rlwinm. r0, r0, 0, 0x1d, 0x1d           
/* 800F8FD8  41 82 00 70 */	beq lbl_800F9048                         /* constant-address: 800F9048, symbol: lbl_800F9048 */
/* 800F8FDC  C0 3F 37 C8 */	lfs f1, 0x37c8(r31)                     
/* 800F8FE0  C0 62 93 2C */	lfs f3, lit_7624(r2)                     /* constant-address: 80452D2C, symbol: lit_7624 */
/* 800F8FE4  C0 42 93 54 */	lfs f2, lit_8248(r2)                     /* constant-address: 80452D54, symbol: lit_8248 */
...
/* 800F9024  40 82 00 10 */	bne lbl_800F9034                         /* constant-address: 800F9034, symbol: lbl_800F9034 */
/* 800F9028  38 00 00 01 */	li r0, 1                                
/* 800F902C  B0 1F 30 0E */	sth r0, 0x300e(r31)                     
/* 800F9030  48 00 00 0C */	b lbl_800F903C                           /* constant-address: 800F903C, symbol: lbl_800F903C */
lbl_800F9034:
...
/* 800F9044  48 00 01 B8 */	b lbl_800F91FC                           /* constant-address: 800F91FC, symbol: lbl_800F91FC */
lbl_800F9048:
/* 800F9048  2C 03 00 03 */	cmpwi r3, 3                             
/* 800F904C  40 82 00 7C */	bne lbl_800F90C8                         /* constant-address: 800F90C8, symbol: lbl_800F90C8 */
/* 800F9050  80 1F 31 98 */	lwz r0, 0x3198(r31)                     
/* 800F9054  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c           
/* 800F9058  41 82 00 70 */	beq lbl_800F90C8                         /* constant-address: 800F90C8, symbol: lbl_800F90C8 */
/* 800F905C  C0 3F 37 C8 */	lfs f1, 0x37c8(r31)                     
/* 800F9060  C0 62 93 2C */	lfs f3, lit_7624(r2)                     /* constant-address: 80452D2C, symbol: lit_7624 */
/* 800F9064  C0 42 93 54 */	lfs f2, lit_8248(r2)                     /* constant-address: 80452D54, symbol: lit_8248 */
...
/* 800F90A4  40 82 00 10 */	bne lbl_800F90B4                         /* constant-address: 800F90B4, symbol: lbl_800F90B4 */
/* 800F90A8  38 00 00 01 */	li r0, 1                                
/* 800F90AC  B0 1F 30 0E */	sth r0, 0x300e(r31)                     
/* 800F90B0  48 00 00 0C */	b lbl_800F90BC                           /* constant-address: 800F90BC, symbol: lbl_800F90BC */
lbl_800F90B4:
...
/* 800F90C4  48 00 01 38 */	b lbl_800F91FC                           /* constant-address: 800F91FC, symbol: lbl_800F91FC */
lbl_800F90C8:
/* 800F90C8  80 1F 31 98 */	lwz r0, 0x3198(r31)                     
/* 800F90CC  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 800F90D0  41 82 00 90 */	beq lbl_800F9160                         /* constant-address: 800F9160, symbol: lbl_800F9160 */
/* 800F90D4  A8 1F 04 DE */	lha r0, 0x4de(r31)                      
/* 800F90D8  7C 05 00 00 */	cmpw r5, r0                             
/* 800F90DC  40 82 00 0C */	bne lbl_800F90E8                         /* constant-address: 800F90E8, symbol: lbl_800F90E8 */
/* 800F90E0  2C 03 00 00 */	cmpwi r3, 0                             
/* 800F90E4  41 82 00 14 */	beq lbl_800F90F8                         /* constant-address: 800F90F8, symbol: lbl_800F90F8 */
lbl_800F90E8:
/* 800F90E8  7C 05 00 00 */	cmpw r5, r0                             
/* 800F90EC  41 82 00 74 */	beq lbl_800F9160                         /* constant-address: 800F9160, symbol: lbl_800F9160 */
/* 800F90F0  2C 03 00 01 */	cmpwi r3, 1                             
/* 800F90F4  40 82 00 6C */	bne lbl_800F9160                         /* constant-address: 800F9160, symbol: lbl_800F9160 */
lbl_800F90F8:
/* 800F90F8  54 00 04 38 */	rlwinm r0, r0, 0, 0x10, 0x1c            
/* 800F90FC  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800F9100  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800F9104  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 800F9108  C0 3F 37 C8 */	lfs f1, 0x37c8(r31)                     
/* 800F910C  C0 62 93 2C */	lfs f3, lit_7624(r2)                     /* constant-address: 80452D2C, symbol: lit_7624 */
/* 800F9110  C0 42 93 54 */	lfs f2, lit_8248(r2)                     /* constant-address: 80452D54, symbol: lit_8248 */
...
/* 800F915C  48 00 00 A0 */	b lbl_800F91FC                           /* constant-address: 800F91FC, symbol: lbl_800F91FC */
lbl_800F9160:
/* 800F9160  A8 1F 04 DE */	lha r0, 0x4de(r31)                      
/* 800F9164  7C 05 00 00 */	cmpw r5, r0                             
/* 800F9168  40 82 00 0C */	bne lbl_800F9174                         /* constant-address: 800F9174, symbol: lbl_800F9174 */
/* 800F916C  2C 03 00 01 */	cmpwi r3, 1                             
/* 800F9170  41 82 00 14 */	beq lbl_800F9184                         /* constant-address: 800F9184, symbol: lbl_800F9184 */
lbl_800F9174:
/* 800F9174  7C 05 00 00 */	cmpw r5, r0                             
/* 800F9178  41 82 00 84 */	beq lbl_800F91FC                         /* constant-address: 800F91FC, symbol: lbl_800F91FC */
/* 800F917C  2C 03 00 00 */	cmpwi r3, 0                             
/* 800F9180  40 82 00 7C */	bne lbl_800F91FC                         /* constant-address: 800F91FC, symbol: lbl_800F91FC */
lbl_800F9184:
...
/* 800F91A0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800F91A4  7C 03 04 2E */	lfsx f0, r3, r0                         
/* 800F91A8  C0 3F 37 C8 */	lfs f1, 0x37c8(r31)                     
/* 800F91AC  C0 62 93 2C */	lfs f3, lit_7624(r2)                     /* constant-address: 80452D2C, symbol: lit_7624 */
/* 800F91B0  C0 42 93 54 */	lfs f2, lit_8248(r2)                     /* constant-address: 80452D54, symbol: lit_8248 */

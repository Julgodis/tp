...
/* 800AB890  48 2B 69 45 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 800AB8A8  3C 80 80 39 */	lis r4, data_80392034@ha                
/* 800AB8AC  38 84 20 34 */	addi r4, r4, data_80392034@l             /* constant-address: 80392034, symbol: data_80392034 */
/* 800AB8B0  38 A1 00 44 */	addi r5, r1, 0x44                       
/* 800AB8B4  48 29 B4 B9 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800AB8B8  38 7F 0F B8 */	addi r3, r31, 0xfb8                     
/* 800AB8BC  38 81 00 44 */	addi r4, r1, 0x44                       
/* 800AB8C0  4B FD 92 05 */	bl MoveCAt__8dCcD_SphFR4cXyz             /* constant-address: 80084AC4, symbol: MoveCAt__8dCcD_SphFR4cXyz */
...
/* 800AB900  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800AB930  40 81 00 08 */	ble lbl_800AB938                         /* constant-address: 800AB938, symbol: lbl_800AB938 */
/* 800AB934  48 00 00 08 */	b lbl_800AB93C                           /* constant-address: 800AB93C, symbol: lbl_800AB93C */
lbl_800AB938:
...
/* 800AB94C  40 80 00 0C */	bge lbl_800AB958                         /* constant-address: 800AB958, symbol: lbl_800AB958 */
...
/* 800AB960  48 1C 38 7D */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
...
/* 800AB9A0  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800AB9D4  40 81 00 08 */	ble lbl_800AB9DC                         /* constant-address: 800AB9DC, symbol: lbl_800AB9DC */
/* 800AB9D8  48 00 00 08 */	b lbl_800AB9E0                           /* constant-address: 800AB9E0, symbol: lbl_800AB9E0 */
lbl_800AB9DC:
...
/* 800AB9F0  40 80 00 0C */	bge lbl_800AB9FC                         /* constant-address: 800AB9FC, symbol: lbl_800AB9FC */
...
/* 800ABA04  48 1C 37 D9 */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
/* 800ABA08  38 61 00 14 */	addi r3, r1, 0x14                       
/* 800ABA0C  38 9F 09 74 */	addi r4, r31, 0x974                     
/* 800ABA10  38 BF 0B EC */	addi r5, r31, 0xbec                     
/* 800ABA14  48 1B B0 D1 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
/* 800ABA18  38 61 00 08 */	addi r3, r1, 8                          
/* 800ABA1C  38 81 00 14 */	addi r4, r1, 0x14                       
/* 800ABA20  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
/* 800ABA24  48 1B B1 61 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 800ABA40  C0 42 92 98 */	lfs f2, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800ABA60  48 1C 37 7D */	bl SetC__8cM3dGCylFRC4cXyz               /* constant-address: 8026F1DC, symbol: SetC__8cM3dGCylFRC4cXyz */
/* 800ABA64  3B 60 00 00 */	li r27, 0                               
/* 800ABA68  3B C0 00 00 */	li r30, 0                               
/* 800ABA6C  3B A0 00 00 */	li r29, 0                               
/* 800ABA70  C3 E2 93 78 */	lfs f31, lit_8676(r2)                    /* constant-address: 80452D78, symbol: lit_8676 */
...
/* 800ABA90  48 1C 37 69 */	bl SetH__8cM3dGCylFf                     /* constant-address: 8026F1F8, symbol: SetH__8cM3dGCylFf */
...
/* 800ABAA4  41 80 FF D4 */	blt lbl_800ABA78                         /* constant-address: 800ABA78, symbol: lbl_800ABA78 */
/* 800ABAA8  C0 5F 09 78 */	lfs f2, 0x978(r31)                      
/* 800ABAAC  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800ABACC  48 2B 67 55 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

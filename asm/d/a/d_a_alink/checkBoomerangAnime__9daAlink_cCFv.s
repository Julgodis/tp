...
/* 800E0460  41 82 00 0C */	beq lbl_800E046C                         /* constant-address: 800E046C, symbol: lbl_800E046C */
/* 800E0464  28 00 01 02 */	cmplwi r0, 0x102                        
/* 800E0468  40 82 00 14 */	bne lbl_800E047C                         /* constant-address: 800E047C, symbol: lbl_800E047C */
lbl_800E046C:
/* 800E046C  A0 03 1F BC */	lhz r0, 0x1fbc(r3)                      
/* 800E0470  28 00 00 54 */	cmplwi r0, 0x54                         
/* 800E0474  40 82 00 08 */	bne lbl_800E047C                         /* constant-address: 800E047C, symbol: lbl_800E047C */
/* 800E0478  38 80 00 01 */	li r4, 1                                
lbl_800E047C:
/* 800E047C  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 800E0480  40 82 00 10 */	bne lbl_800E0490                         /* constant-address: 800E0490, symbol: lbl_800E0490 */
/* 800E0484  48 00 00 29 */	bl checkBoomerangThrowAnime__9daAlink_cCFv /* constant-address: 800E04AC, symbol: checkBoomerangThrowAnime__9daAlink_cCFv */
/* 800E0488  2C 03 00 00 */	cmpwi r3, 0                             
/* 800E048C  41 82 00 08 */	beq lbl_800E0494                         /* constant-address: 800E0494, symbol: lbl_800E0494 */
lbl_800E0490:

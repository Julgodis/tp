...
/* 800BBD64  41 82 01 78 */	beq lbl_800BBEDC                         /* constant-address: 800BBEDC, symbol: lbl_800BBEDC */
...
/* 800BBD84  3C A0 80 3E */	lis r5, now__14mDoMtx_stack_c@ha        
/* 800BBD88  38 A5 D4 70 */	addi r5, r5, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800BBD8C  48 28 A7 59 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 800BBD90  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800BBD94  3B C3 D4 70 */	addi r30, r3, now__14mDoMtx_stack_c@l    /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800BBD98  C0 1E 00 0C */	lfs f0, 0xc(r30)                         /* constant-address: 803DD47C, symbol: None */
/* 800BBD9C  D0 01 00 20 */	stfs f0, 0x20(r1)                       
/* 800BBDA0  C0 1E 00 1C */	lfs f0, 0x1c(r30)                        /* constant-address: 803DD48C, symbol: None */
/* 800BBDA4  D0 01 00 24 */	stfs f0, 0x24(r1)                       
/* 800BBDA8  C0 1E 00 2C */	lfs f0, 0x2c(r30)                        /* constant-address: 803DD49C, symbol: None */
...
/* 800BBDD0  48 28 A7 15 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 800BBDD4  C0 1E 00 0C */	lfs f0, 0xc(r30)                         /* constant-address: 803DD47C, symbol: None */
/* 800BBDD8  D0 01 00 2C */	stfs f0, 0x2c(r1)                       
/* 800BBDDC  C0 3E 00 1C */	lfs f1, 0x1c(r30)                        /* constant-address: 803DD48C, symbol: None */
/* 800BBDE0  D0 21 00 30 */	stfs f1, 0x30(r1)                       
/* 800BBDE4  C0 1E 00 2C */	lfs f0, 0x2c(r30)                        /* constant-address: 803DD49C, symbol: None */
/* 800BBDE8  D0 01 00 34 */	stfs f0, 0x34(r1)                       
/* 800BBDEC  C0 01 00 24 */	lfs f0, 0x24(r1)                        
/* 800BBDF0  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 800BBDF4  40 80 00 0C */	bge lbl_800BBE00                         /* constant-address: 800BBE00, symbol: lbl_800BBE00 */
/* 800BBDF8  38 00 00 00 */	li r0, 0                                
/* 800BBDFC  48 00 00 08 */	b lbl_800BBE04                           /* constant-address: 800BBE04, symbol: lbl_800BBE04 */
lbl_800BBE00:
...
/* 800BBE1C  48 1A AD 19 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800BBE48  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800BBE4C  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800BBE84  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800BBE88  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800BBE8C  40 80 00 88 */	bge lbl_800BBF14                         /* constant-address: 800BBF14, symbol: lbl_800BBF14 */
/* 800BBE90  C0 3F 33 AC */	lfs f1, 0x33ac(r31)                     
/* 800BBE94  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 800BBE98  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800BBE9C  40 81 00 78 */	ble lbl_800BBF14                         /* constant-address: 800BBF14, symbol: lbl_800BBF14 */
...
/* 800BBEB4  C0 02 93 F8 */	lfs f0, lit_13700(r2)                    /* constant-address: 80452DF8, symbol: lit_13700 */
/* 800BBEB8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800BBEBC  40 80 00 58 */	bge lbl_800BBF14                         /* constant-address: 800BBF14, symbol: lbl_800BBF14 */
/* 800BBEC0  C0 02 94 A8 */	lfs f0, lit_16570(r2)                    /* constant-address: 80452EA8, symbol: lit_16570 */
/* 800BBEC4  EC 40 00 B2 */	fmuls f2, f0, f2                        
/* 800BBEC8  C0 22 93 A8 */	lfs f1, lit_9652(r2)                     /* constant-address: 80452DA8, symbol: lit_9652 */
/* 800BBECC  C0 1F 33 A0 */	lfs f0, 0x33a0(r31)                     
/* 800BBED0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 800BBED4  EC 42 00 2A */	fadds f2, f2, f0                        
/* 800BBED8  48 00 00 3C */	b lbl_800BBF14                           /* constant-address: 800BBF14, symbol: lbl_800BBF14 */
lbl_800BBEDC:
/* 800BBEDC  C0 42 92 C0 */	lfs f2, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800BBF10  42 00 FF DC */	bdnz lbl_800BBEEC                        /* constant-address: 800BBEEC, symbol: lbl_800BBEEC */
lbl_800BBF14:
...
/* 800BBF48  42 00 FF D8 */	bdnz lbl_800BBF20                        /* constant-address: 800BBF20, symbol: lbl_800BBF20 */

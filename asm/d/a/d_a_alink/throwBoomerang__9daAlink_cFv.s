...
/* 800E06C8  48 28 1B 15 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 800E06F0  41 82 00 94 */	beq lbl_800E0784                         /* constant-address: 800E0784, symbol: lbl_800E0784 */
...
/* 800E0720  41 82 00 14 */	beq lbl_800E0734                         /* constant-address: 800E0734, symbol: lbl_800E0734 */
/* 800E0724  7F E3 FB 78 */	mr r3, r31                              
/* 800E0728  39 9F 0D CC */	addi r12, r31, 0xdcc                    
/* 800E072C  48 28 19 59 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
...
/* 800E0750  38 83 61 C0 */	addi r4, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800E0754  80 04 5F 18 */	lwz r0, 0x5f18(r4)                       /* constant-address: 8040C0D8, symbol: None */
/* 800E0758  64 03 00 40 */	oris r3, r0, 0x40                       
/* 800E075C  90 64 5F 18 */	stw r3, 0x5f18(r4)                       /* constant-address: 8040C0D8, symbol: None */
/* 800E0760  38 00 40 00 */	li r0, 0x4000                           
/* 800E0764  B0 0D 8A 9C */	sth r0, struct_8045101C+0x0(r13)         /* constant-address: 8045101C, symbol: struct_8045101C+0x0 */
/* 800E0768  54 60 03 56 */	rlwinm r0, r3, 0, 0xd, 0xb              
/* 800E076C  90 04 5F 18 */	stw r0, 0x5f18(r4)                       /* constant-address: 8040C0D8, symbol: None */
/* 800E0770  38 00 FF FF */	li r0, -1                               
/* 800E0774  B0 1D 30 8E */	sth r0, 0x308e(r29)                     
/* 800E0778  38 00 00 00 */	li r0, 0                                
/* 800E077C  B0 0D 8A 9E */	sth r0, struct_8045101C+0x2(r13)         /* constant-address: 8045101E, symbol: struct_8045101C+0x2 */
/* 800E0780  48 00 00 44 */	b lbl_800E07C4                           /* constant-address: 800E07C4, symbol: lbl_800E07C4 */
lbl_800E0784:
/* 800E0784  3C 60 80 39 */	lis r3, m__20daAlinkHIO_pickUp_c0@ha    
/* 800E0788  38 63 E8 40 */	addi r3, r3, m__20daAlinkHIO_pickUp_c0@l /* constant-address: 8038E840, symbol: m__20daAlinkHIO_pickUp_c0 */
/* 800E078C  C0 03 00 28 */	lfs f0, 0x28(r3)                         /* constant-address: 8038E868, symbol: None */
/* 800E0790  D0 1F 05 2C */	stfs f0, 0x52c(r31)                     
/* 800E0794  C0 03 00 2C */	lfs f0, 0x2c(r3)                         /* constant-address: 8038E86C, symbol: None */
...
/* 800E07A8  4B F3 C3 F9 */	bl fopAcM_cancelCarryNow__FP10fopAc_ac_c /* constant-address: 8001CBA0, symbol: fopAcM_cancelCarryNow__FP10fopAc_ac_c */
...
/* 800E07C8  48 07 E5 35 */	bl clearData__16daPy_actorKeep_cFv       /* constant-address: 8015ECFC, symbol: clearData__16daPy_actorKeep_cFv */
...
/* 800E0800  41 82 00 3C */	beq lbl_800E083C                         /* constant-address: 800E083C, symbol: lbl_800E083C */
...
/* 800E081C  41 82 00 14 */	beq lbl_800E0830                         /* constant-address: 800E0830, symbol: lbl_800E0830 */
/* 800E0820  7F A3 EB 78 */	mr r3, r29                              
/* 800E0824  38 80 00 00 */	li r4, 0                                
/* 800E0828  48 01 49 BD */	bl procCanoeWaitInit__9daAlink_cFi       /* constant-address: 800F51E4, symbol: procCanoeWaitInit__9daAlink_cFi */
/* 800E082C  48 00 00 80 */	b lbl_800E08AC                           /* constant-address: 800E08AC, symbol: lbl_800E08AC */
lbl_800E0830:
/* 800E0830  7F A3 EB 78 */	mr r3, r29                              
/* 800E0834  48 01 01 4D */	bl procHorseWaitInit__9daAlink_cFv       /* constant-address: 800F0980, symbol: procHorseWaitInit__9daAlink_cFv */
/* 800E0838  48 00 00 74 */	b lbl_800E08AC                           /* constant-address: 800E08AC, symbol: lbl_800E08AC */
lbl_800E083C:
/* 800E083C  80 1D 19 9C */	lwz r0, 0x199c(r29)                     
/* 800E0840  54 00 06 B5 */	rlwinm. r0, r0, 0, 0x1a, 0x1a           
/* 800E0844  41 82 00 68 */	beq lbl_800E08AC                         /* constant-address: 800E08AC, symbol: lbl_800E08AC */
/* 800E0848  2C 1E 00 00 */	cmpwi r30, 0                            
/* 800E084C  41 82 00 60 */	beq lbl_800E08AC                         /* constant-address: 800E08AC, symbol: lbl_800E08AC */
/* 800E0850  80 1D 27 EC */	lwz r0, 0x27ec(r29)                     
/* 800E0854  28 00 00 00 */	cmplwi r0, 0                            
/* 800E0858  40 82 00 14 */	bne lbl_800E086C                         /* constant-address: 800E086C, symbol: lbl_800E086C */
/* 800E085C  28 1F 00 00 */	cmplwi r31, 0                           
/* 800E0860  41 82 00 0C */	beq lbl_800E086C                         /* constant-address: 800E086C, symbol: lbl_800E086C */
/* 800E0864  93 FD 27 EC */	stw r31, 0x27ec(r29)                    
/* 800E0868  93 FD 27 F4 */	stw r31, 0x27f4(r29)                    
lbl_800E086C:
/* 800E086C  7F A3 EB 78 */	mr r3, r29                              
/* 800E0870  4B FD 30 95 */	bl checkZeroSpeedF__9daAlink_cCFv        /* constant-address: 800B3904, symbol: checkZeroSpeedF__9daAlink_cCFv */
/* 800E0874  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800E0878  41 82 00 18 */	beq lbl_800E0890                         /* constant-address: 800E0890, symbol: lbl_800E0890 */
/* 800E087C  38 00 00 03 */	li r0, 3                                
/* 800E0880  98 1D 2F 98 */	stb r0, 0x2f98(r29)                     
/* 800E0884  7F A3 EB 78 */	mr r3, r29                              
/* 800E0888  4B FE 30 45 */	bl procAtnActorWaitInit__9daAlink_cFv    /* constant-address: 800C38CC, symbol: procAtnActorWaitInit__9daAlink_cFv */
/* 800E088C  48 00 00 0C */	b lbl_800E0898                           /* constant-address: 800E0898, symbol: lbl_800E0898 */
lbl_800E0890:
/* 800E0890  7F A3 EB 78 */	mr r3, r29                              
/* 800E0894  4B FE 31 59 */	bl procAtnActorMoveInit__9daAlink_cFv    /* constant-address: 800C39EC, symbol: procAtnActorMoveInit__9daAlink_cFv */
lbl_800E0898:
/* 800E0898  80 7D 20 60 */	lwz r3, 0x2060(r29)                     
/* 800E089C  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800E08A0  38 80 00 00 */	li r4, 0                                
/* 800E08A4  38 A0 00 23 */	li r5, 0x23                             
/* 800E08A8  4B F2 EF A1 */	bl initOldFrameMorf__22mDoExt_MtxCalcOldFrameFfUsUs /* constant-address: 8000F848, symbol: initOldFrameMorf__22mDoExt_MtxCalcOldFrameFfUsUs */
lbl_800E08AC:
/* 800E08AC  39 61 00 20 */	addi r11, r1, 0x20                      
/* 800E08B0  48 28 19 79 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

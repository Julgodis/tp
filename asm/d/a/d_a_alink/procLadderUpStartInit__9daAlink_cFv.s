...
/* 800FD664  41 82 00 14 */	beq lbl_800FD678                         /* constant-address: 800FD678, symbol: lbl_800FD678 */
/* 800FD668  38 80 00 67 */	li r4, 0x67                             
/* 800FD66C  38 A0 00 00 */	li r5, 0                                
/* 800FD670  4B FC 57 6D */	bl procPreActionUnequipInit__9daAlink_cFiP10fopAc_ac_c /* constant-address: 800C2DDC, symbol: procPreActionUnequipInit__9daAlink_cFiP10fopAc_ac_c */
/* 800FD674  48 00 01 28 */	b lbl_800FD79C                           /* constant-address: 800FD79C, symbol: lbl_800FD79C */
lbl_800FD678:
/* 800FD678  38 80 00 67 */	li r4, 0x67                             
/* 800FD67C  4B FC 48 F1 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800FD680  7F E3 FB 78 */	mr r3, r31                              
/* 800FD684  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FD688  C0 5F 05 34 */	lfs f2, 0x534(r31)                      
/* 800FD68C  38 80 00 00 */	li r4, 0                                
/* 800FD690  4B FB E0 E1 */	bl setSpecialGravity__9daAlink_cFffi     /* constant-address: 800BB770, symbol: setSpecialGravity__9daAlink_cFffi */
/* 800FD694  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800FD6B0  38 A5 EB 8C */	addi r5, r5, m__20daAlinkHIO_ladder_c0@l /* constant-address: 8038EB8C, symbol: m__20daAlinkHIO_ladder_c0 */
/* 800FD6B4  C0 25 00 28 */	lfs f1, 0x28(r5)                         /* constant-address: 8038EBB4, symbol: None */
/* 800FD6B8  C0 45 00 2C */	lfs f2, 0x2c(r5)                         /* constant-address: 8038EBB8, symbol: None */
/* 800FD6BC  4B FA F9 25 */	bl setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff /* constant-address: 800ACFE0, symbol: setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff */
/* 800FD6C0  38 00 00 10 */	li r0, 0x10                             
/* 800FD6C4  98 1F 2F 99 */	stb r0, 0x2f99(r31)                     
/* 800FD6C8  3C 60 80 42 */	lis r3, l_waitBaseAnime@ha              
/* 800FD6CC  C4 03 55 14 */	lfsu f0, l_waitBaseAnime@l(r3)           /* constant-address: 80425514, symbol: l_waitBaseAnime */
/* 800FD6D0  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 800FD6D4  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425518, symbol: None */
/* 800FD6D8  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 800FD6DC  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042551C, symbol: None */
/* 800FD6E0  D0 1F 35 90 */	stfs f0, 0x3590(r31)                    
/* 800FD6E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800FD6E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FD6EC  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800FD6F0  64 00 02 00 */	oris r0, r0, 0x200                      
/* 800FD6F4  90 03 5F 18 */	stw r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
...
/* 800FD704  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800FD718  C0 42 93 D4 */	lfs f2, lit_11442(r2)                    /* constant-address: 80452DD4, symbol: lit_11442 */
...
/* 800FD75C  C0 42 93 94 */	lfs f2, lit_8785(r2)                     /* constant-address: 80452D94, symbol: lit_8785 */
/* 800FD760  EC 02 00 F2 */	fmuls f0, f2, f3                        
/* 800FD764  EC 01 00 2A */	fadds f0, f1, f0                        
/* 800FD768  D0 1F 37 C8 */	stfs f0, 0x37c8(r31)                    
/* 800FD76C  C0 22 94 28 */	lfs f1, lit_14621(r2)                    /* constant-address: 80452E28, symbol: lit_14621 */

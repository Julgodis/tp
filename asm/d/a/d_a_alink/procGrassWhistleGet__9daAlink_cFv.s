...
/* 801119F8  48 04 CA D5 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 801119FC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80111A00  41 82 00 24 */	beq lbl_80111A24                         /* constant-address: 80111A24, symbol: lbl_80111A24 */
...
/* 80111A1C  48 00 00 81 */	bl procGrassWhistleWaitInit__9daAlink_cFiiisP4cXyz /* constant-address: 80111A9C, symbol: procGrassWhistleWaitInit__9daAlink_cFiiisP4cXyz */
/* 80111A20  48 00 00 60 */	b lbl_80111A80                           /* constant-address: 80111A80, symbol: lbl_80111A80 */
lbl_80111A24:
/* 80111A24  A0 1E 2F DC */	lhz r0, 0x2fdc(r30)                     
/* 80111A28  28 00 00 FF */	cmplwi r0, 0xff                         
/* 80111A2C  40 82 00 54 */	bne lbl_80111A80                         /* constant-address: 80111A80, symbol: lbl_80111A80 */
/* 80111A30  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 80111A34  C0 02 93 34 */	lfs f0, lit_7710(r2)                     /* constant-address: 80452D34, symbol: lit_7710 */
/* 80111A38  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80111A3C  4C 41 13 82 */	cror 2, 1, 2                            
/* 80111A40  40 82 00 40 */	bne lbl_80111A80                         /* constant-address: 80111A80, symbol: lbl_80111A80 */
/* 80111A44  7F C3 F3 78 */	mr r3, r30                              
/* 80111A48  A8 9E 30 0C */	lha r4, 0x300c(r30)                     
/* 80111A4C  4B FF FD 39 */	bl setGrassWhistleModel__9daAlink_cFi    /* constant-address: 80111784, symbol: setGrassWhistleModel__9daAlink_cFi */
/* 80111A50  80 7E 28 10 */	lwz r3, 0x2810(r30)                     
/* 80111A54  28 03 00 00 */	cmplwi r3, 0                            
/* 80111A58  41 82 00 28 */	beq lbl_80111A80                         /* constant-address: 80111A80, symbol: lbl_80111A80 */
/* 80111A5C  38 80 00 00 */	li r4, 0                                
/* 80111A60  4B F0 B0 E9 */	bl fopAcM_setCarryNow__FP10fopAc_ac_ci   /* constant-address: 8001CB48, symbol: fopAcM_setCarryNow__FP10fopAc_ac_ci */
/* 80111A64  7F C3 F3 78 */	mr r3, r30                              
/* 80111A68  3C 80 00 02 */	lis r4, 0x0002 /* 0x00020056@ha */      
/* 80111A6C  38 84 00 56 */	addi r4, r4, 0x0056 /* 0x00020056@l */   /* constant-address: 00020056 */

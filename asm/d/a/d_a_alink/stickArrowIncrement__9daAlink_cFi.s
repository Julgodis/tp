...
/* 800DC7BC  40 82 00 F0 */	bne lbl_800DC8AC                         /* constant-address: 800DC8AC, symbol: lbl_800DC8AC */
...
/* 800DC7EC  41 82 00 34 */	beq lbl_800DC820                         /* constant-address: 800DC820, symbol: lbl_800DC820 */
/* 800DC7F0  39 2A 2F 7C */	addi r9, r10, 0x2f7c                    
/* 800DC7F4  7C FE 48 AE */	lbzx r7, r30, r9                        
/* 800DC7F8  28 07 00 00 */	cmplwi r7, 0                            
/* 800DC7FC  41 82 00 0C */	beq lbl_800DC808                         /* constant-address: 800DC808, symbol: lbl_800DC808 */
/* 800DC800  2C 04 00 00 */	cmpwi r4, 0                             
/* 800DC804  41 82 00 14 */	beq lbl_800DC818                         /* constant-address: 800DC818, symbol: lbl_800DC818 */
lbl_800DC808:
/* 800DC808  7C DE 41 2E */	stwx r6, r30, r8                        
/* 800DC80C  7C BE 49 AE */	stbx r5, r30, r9                        
/* 800DC810  3B FF 00 01 */	addi r31, r31, 1                         /* constant-address: 00000001 */
/* 800DC814  48 00 00 0C */	b lbl_800DC820                           /* constant-address: 800DC820, symbol: lbl_800DC820 */
lbl_800DC818:
...
/* 800DC828  42 00 FF B4 */	bdnz lbl_800DC7DC                        /* constant-address: 800DC7DC, symbol: lbl_800DC7DC */
/* 800DC82C  7F E0 07 35 */	extsh. r0, r31                          
/* 800DC830  41 82 00 7C */	beq lbl_800DC8AC                         /* constant-address: 800DC8AC, symbol: lbl_800DC8AC */
/* 800DC834  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800DC838  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800DC83C  88 03 00 15 */	lbz r0, 0x15(r3)                         /* constant-address: 804061D5, symbol: None */
/* 800DC840  28 00 00 FF */	cmplwi r0, 0xff                         
/* 800DC844  41 82 00 5C */	beq lbl_800DC8A0                         /* constant-address: 800DC8A0, symbol: lbl_800DC8A0 */
/* 800DC848  38 60 00 43 */	li r3, 0x43                             
/* 800DC84C  38 80 00 01 */	li r4, 1                                
/* 800DC850  4B FB B6 91 */	bl checkItemGet__FUci                    /* constant-address: 80097EE0, symbol: checkItemGet__FUci */
/* 800DC854  2C 03 00 00 */	cmpwi r3, 0                             
/* 800DC858  41 82 00 48 */	beq lbl_800DC8A0                         /* constant-address: 800DC8A0, symbol: lbl_800DC8A0 */
/* 800DC85C  7F E0 07 34 */	extsh r0, r31                           
/* 800DC860  2C 00 00 01 */	cmpwi r0, 1                             
/* 800DC864  38 80 00 0E */	li r4, 0xe                              
/* 800DC868  40 82 00 08 */	bne lbl_800DC870                         /* constant-address: 800DC870, symbol: lbl_800DC870 */
/* 800DC86C  38 80 00 11 */	li r4, 0x11                             
lbl_800DC870:
/* 800DC870  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800DC874  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800DC878  A8 03 5D F4 */	lha r0, 0x5df4(r3)                       /* constant-address: 8040BFB4, symbol: None */
/* 800DC87C  7C 00 FA 14 */	add r0, r0, r31                         
/* 800DC880  B0 03 5D F4 */	sth r0, 0x5df4(r3)                       /* constant-address: 8040BFB4, symbol: None */
...
/* 800DC894  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800DC898  FC 40 08 90 */	fmr f2, f1                              
/* 800DC89C  4B F3 F9 61 */	bl fopAcM_createItemForSimpleDemo__FPC4cXyziiPC5csXyzPC4cXyzff /* constant-address: 8001C1FC, symbol: fopAcM_createItemForSimpleDemo__FPC4cXyziiPC5csXyzPC4cXyzff */
lbl_800DC8A0:

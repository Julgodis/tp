...
/* 800C856C  4B FF A8 39 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800C8570  2C 03 00 00 */	cmpwi r3, 0                             
/* 800C8574  40 82 00 0C */	bne lbl_800C8580                         /* constant-address: 800C8580, symbol: lbl_800C8580 */
/* 800C8578  38 60 00 00 */	li r3, 0                                
/* 800C857C  48 00 00 44 */	b lbl_800C85C0                           /* constant-address: 800C85C0, symbol: lbl_800C85C0 */
lbl_800C8580:
/* 800C8580  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800C85B0  38 84 D6 64 */	addi r4, r4, m__19daAlinkHIO_basic_c0@l  /* constant-address: 8038D664, symbol: m__19daAlinkHIO_basic_c0 */
/* 800C85B4  C0 24 00 18 */	lfs f1, 0x18(r4)                         /* constant-address: 8038D67C, symbol: None */
/* 800C85B8  4B FE 58 5D */	bl setBlendMoveAnime__9daAlink_cFf       /* constant-address: 800ADE14, symbol: setBlendMoveAnime__9daAlink_cFf */

...
/* 800C48B4  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C48B8  C0 42 93 24 */	lfs f2, lit_7450(r2)                     /* constant-address: 80452D24, symbol: lit_7450 */
/* 800C48BC  48 1A BE 85 */	bl cLib_chaseF__FPfff                    /* constant-address: 80270740, symbol: cLib_chaseF__FPfff */
/* 800C48C0  80 1E 31 98 */	lwz r0, 0x3198(r30)                     
/* 800C48C4  2C 00 00 00 */	cmpwi r0, 0                             
/* 800C48C8  41 82 00 0C */	beq lbl_800C48D4                         /* constant-address: 800C48D4, symbol: lbl_800C48D4 */
/* 800C48CC  38 00 00 04 */	li r0, 4                                
/* 800C48D0  98 1E 2F 99 */	stb r0, 0x2f99(r30)                     
lbl_800C48D4:
/* 800C48D4  7F E3 FB 78 */	mr r3, r31                              
/* 800C48D8  48 09 9B F5 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800C48DC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800C48E0  41 82 00 1C */	beq lbl_800C48FC                         /* constant-address: 800C48FC, symbol: lbl_800C48FC */
...
/* 800C48F4  4B FF 57 DD */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800C48F8  48 00 00 38 */	b lbl_800C4930                           /* constant-address: 800C4930, symbol: lbl_800C4930 */
lbl_800C48FC:
/* 800C48FC  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 800C4900  C0 1E 34 78 */	lfs f0, 0x3478(r30)                     
/* 800C4904  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800C4908  40 81 00 28 */	ble lbl_800C4930                         /* constant-address: 800C4930, symbol: lbl_800C4930 */
...
/* 800C4920  4B FF 57 B1 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800C4924  2C 03 00 00 */	cmpwi r3, 0                             
/* 800C4928  40 82 00 08 */	bne lbl_800C4930                         /* constant-address: 800C4930, symbol: lbl_800C4930 */

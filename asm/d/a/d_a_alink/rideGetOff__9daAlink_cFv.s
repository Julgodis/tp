...
/* 800ECBF8  41 82 00 34 */	beq lbl_800ECC2C                         /* constant-address: 800ECC2C, symbol: lbl_800ECC2C */
/* 800ECBFC  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800ECC00  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800ECC04  80 63 5D B8 */	lwz r3, 0x5db8(r3)                       /* constant-address: 8040BF78, symbol: None */
/* 800ECC08  28 03 00 00 */	cmplwi r3, 0                            
/* 800ECC0C  41 82 00 10 */	beq lbl_800ECC1C                         /* constant-address: 800ECC1C, symbol: lbl_800ECC1C */
/* 800ECC10  39 83 18 F8 */	addi r12, r3, 0x18f8                    
/* 800ECC14  48 27 54 71 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 800ECC18  60 00 00 00 */	nop                                     
lbl_800ECC1C:
/* 800ECC1C  38 7F 2C A8 */	addi r3, r31, 0x2ca8                    
/* 800ECC20  38 80 00 00 */	li r4, 0                                
/* 800ECC24  48 1D 6E 49 */	bl setRiding__14Z2CreatureLinkFb         /* constant-address: 802C3A6C, symbol: setRiding__14Z2CreatureLinkFb */
/* 800ECC28  48 00 00 FC */	b lbl_800ECD24                           /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
lbl_800ECC2C:
...
/* 800ECC44  41 82 00 18 */	beq lbl_800ECC5C                         /* constant-address: 800ECC5C, symbol: lbl_800ECC5C */
/* 800ECC48  80 7F 28 18 */	lwz r3, 0x2818(r31)                     
/* 800ECC4C  28 03 00 00 */	cmplwi r3, 0                            
/* 800ECC50  41 82 00 D4 */	beq lbl_800ECD24                         /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
/* 800ECC54  4B F4 B0 A1 */	bl getOff__10e_wb_classFv                /* constant-address: 80037CF4, symbol: getOff__10e_wb_classFv */
/* 800ECC58  48 00 00 CC */	b lbl_800ECD24                           /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
lbl_800ECC5C:
...
/* 800ECC74  41 82 00 38 */	beq lbl_800ECCAC                         /* constant-address: 800ECCAC, symbol: lbl_800ECCAC */
/* 800ECC78  80 7F 28 18 */	lwz r3, 0x2818(r31)                     
/* 800ECC7C  28 03 00 00 */	cmplwi r3, 0                            
/* 800ECC80  41 82 00 0C */	beq lbl_800ECC8C                         /* constant-address: 800ECC8C, symbol: lbl_800ECC8C */
...
/* 800ECC94  38 84 00 77 */	addi r4, r4, 0x0077 /* 0x00020077@l */   /* constant-address: 00020077 */
...
/* 800ECCA8  48 00 00 7C */	b lbl_800ECD24                           /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
lbl_800ECCAC:
...
/* 800ECCC4  41 82 00 1C */	beq lbl_800ECCE0                         /* constant-address: 800ECCE0, symbol: lbl_800ECCE0 */
/* 800ECCC8  A0 1F 2F DC */	lhz r0, 0x2fdc(r31)                     
/* 800ECCCC  28 00 01 0B */	cmplwi r0, 0x10b                        
/* 800ECCD0  40 82 00 54 */	bne lbl_800ECD24                         /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
/* 800ECCD4  38 00 00 FF */	li r0, 0xff                             
/* 800ECCD8  B0 1F 2F DC */	sth r0, 0x2fdc(r31)                     
/* 800ECCDC  48 00 00 48 */	b lbl_800ECD24                           /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
lbl_800ECCE0:
...
/* 800ECCF8  41 82 00 2C */	beq lbl_800ECD24                         /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
...
/* 800ECD0C  48 02 8F 15 */	bl checkEventRun__9daAlink_cCFv          /* constant-address: 80115C20, symbol: checkEventRun__9daAlink_cCFv */
/* 800ECD10  2C 03 00 00 */	cmpwi r3, 0                             
/* 800ECD14  41 82 00 10 */	beq lbl_800ECD24                         /* constant-address: 800ECD24, symbol: lbl_800ECD24 */
...
/* 800ECD3C  41 82 00 14 */	beq lbl_800ECD50                         /* constant-address: 800ECD50, symbol: lbl_800ECD50 */
/* 800ECD40  7F E3 FB 78 */	mr r3, r31                              
/* 800ECD44  48 02 8E DD */	bl checkEventRun__9daAlink_cCFv          /* constant-address: 80115C20, symbol: checkEventRun__9daAlink_cCFv */
/* 800ECD48  2C 03 00 00 */	cmpwi r3, 0                             
/* 800ECD4C  41 82 00 0C */	beq lbl_800ECD58                         /* constant-address: 800ECD58, symbol: lbl_800ECD58 */
lbl_800ECD50:
/* 800ECD50  38 7F 28 14 */	addi r3, r31, 0x2814                    
/* 800ECD54  48 07 1F A9 */	bl clearData__16daPy_actorKeep_cFv       /* constant-address: 8015ECFC, symbol: clearData__16daPy_actorKeep_cFv */
lbl_800ECD58:

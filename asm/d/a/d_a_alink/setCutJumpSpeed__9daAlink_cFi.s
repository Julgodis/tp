...
/* 800D2CA4  41 82 00 30 */	beq lbl_800D2CD4                         /* constant-address: 800D2CD4, symbol: lbl_800D2CD4 */
/* 800D2CA8  C0 3F 33 98 */	lfs f1, 0x3398(r31)                     
/* 800D2CAC  3C 60 80 39 */	lis r3, m__24daAlinkHIO_magneBoots_c0@ha
/* 800D2CB0  38 63 E7 F4 */	addi r3, r3, m__24daAlinkHIO_magneBoots_c0@l /* constant-address: 8038E7F4, symbol: m__24daAlinkHIO_magneBoots_c0 */
/* 800D2CB4  C0 03 00 3C */	lfs f0, 0x3c(r3)                         /* constant-address: 8038E830, symbol: None */
/* 800D2CB8  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 800D2CBC  D0 1F 33 98 */	stfs f0, 0x3398(r31)                    
/* 800D2CC0  C0 3F 04 FC */	lfs f1, 0x4fc(r31)                      
/* 800D2CC4  C0 03 00 38 */	lfs f0, 0x38(r3)                         /* constant-address: 8038E82C, symbol: None */
/* 800D2CC8  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 800D2CCC  D0 1F 04 FC */	stfs f0, 0x4fc(r31)                     
/* 800D2CD0  48 00 00 28 */	b lbl_800D2CF8                           /* constant-address: 800D2CF8, symbol: lbl_800D2CF8 */
lbl_800D2CD4:
/* 800D2CD4  38 80 00 01 */	li r4, 1                                
/* 800D2CD8  38 A0 00 01 */	li r5, 1                                
/* 800D2CDC  4B FE 87 DD */	bl checkHeavyStateOn__9daAlink_cFii      /* constant-address: 800BB4B8, symbol: checkHeavyStateOn__9daAlink_cFii */
/* 800D2CE0  2C 03 00 00 */	cmpwi r3, 0                             
/* 800D2CE4  41 82 00 14 */	beq lbl_800D2CF8                         /* constant-address: 800D2CF8, symbol: lbl_800D2CF8 */
/* 800D2CE8  C0 3F 04 FC */	lfs f1, 0x4fc(r31)                      
/* 800D2CEC  C0 02 93 0C */	lfs f0, lit_7305(r2)                     /* constant-address: 80452D0C, symbol: lit_7305 */
...
/* 800D2D00  41 82 02 38 */	beq lbl_800D2F38                         /* constant-address: 800D2F38, symbol: lbl_800D2F38 */
/* 800D2D04  2C 1E 00 00 */	cmpwi r30, 0                            
/* 800D2D08  40 82 02 30 */	bne lbl_800D2F38                         /* constant-address: 800D2F38, symbol: lbl_800D2F38 */
/* 800D2D0C  38 7F 04 D0 */	addi r3, r31, 0x4d0                     
/* 800D2D10  38 84 05 38 */	addi r4, r4, 0x538                      
/* 800D2D14  48 19 DE F1 */	bl cLib_targetAngleY__FPC3VecPC3Vec      /* constant-address: 80270C04, symbol: cLib_targetAngleY__FPC3VecPC3Vec */
/* 800D2D18  B0 7F 04 E6 */	sth r3, 0x4e6(r31)                      
/* 800D2D1C  3C 60 80 44 */	lis r3, sincosTable___5JMath@ha         
/* 800D2D20  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800D2D3C  C0 42 93 10 */	lfs f2, lit_7306(r2)                     /* constant-address: 80452D10, symbol: lit_7306 */
/* 800D2D40  EC 02 00 32 */	fmuls f0, f2, f0                        
/* 800D2D44  EC 81 00 28 */	fsubs f4, f1, f0                        
/* 800D2D48  C0 22 93 00 */	lfs f1, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
...
/* 800D2D74  4B F4 AF 49 */	bl gndCheck__11fopAcM_gc_cFPC4cXyz       /* constant-address: 8001DCBC, symbol: gndCheck__11fopAcM_gc_cFPC4cXyz */
/* 800D2D78  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800D2D7C  41 82 00 10 */	beq lbl_800D2D8C                         /* constant-address: 800D2D8C, symbol: lbl_800D2D8C */
/* 800D2D80  C0 0D 87 50 */	lfs f0, mGroundY__11fopAcM_gc_c(r13)     /* constant-address: 80450CD0, symbol: mGroundY__11fopAcM_gc_c */
/* 800D2D84  D0 01 00 28 */	stfs f0, 0x28(r1)                       
/* 800D2D88  48 00 00 10 */	b lbl_800D2D98                           /* constant-address: 800D2D98, symbol: lbl_800D2D98 */
lbl_800D2D8C:
...
/* 800D2DA4  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800D2DA8  EC A0 08 24 */	fdivs f5, f0, f1                        
/* 800D2DAC  C0 61 00 28 */	lfs f3, 0x28(r1)                        
/* 800D2DB0  C0 5F 04 D4 */	lfs f2, 0x4d4(r31)                      
/* 800D2DB4  C0 22 92 98 */	lfs f1, lit_5943(r2)                     /* constant-address: 80452C98, symbol: lit_5943 */
...
/* 800D2DCC  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D2DD0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D2DD4  40 81 00 08 */	ble lbl_800D2DDC                         /* constant-address: 800D2DDC, symbol: lbl_800D2DDC */
/* 800D2DD8  FC 20 00 90 */	fmr f1, f0                              
lbl_800D2DDC:
/* 800D2DDC  C0 02 93 14 */	lfs f0, lit_7307(r2)                     /* constant-address: 80452D14, symbol: lit_7307 */
/* 800D2DE0  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 800D2DE4  EC 20 01 72 */	fmuls f1, f0, f5                        
/* 800D2DE8  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D2DEC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D2DF0  40 81 00 0C */	ble lbl_800D2DFC                         /* constant-address: 800D2DFC, symbol: lbl_800D2DFC */
...
/* 800D2E10  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800D2E38  48 27 45 65 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 800D2E3C  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800D2E40  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D2E44  40 81 00 58 */	ble lbl_800D2E9C                         /* constant-address: 800D2E9C, symbol: lbl_800D2E9C */
/* 800D2E48  FC 00 08 34 */	frsqrte f0, f1                          
/* 800D2E4C  C8 82 92 E8 */	lfd f4, lit_6846(r2)                     /* constant-address: 80452CE8, symbol: lit_6846 */
/* 800D2E50  FC 44 00 32 */	fmul f2, f4, f0                         
/* 800D2E54  C8 62 92 F0 */	lfd f3, lit_6847(r2)                     /* constant-address: 80452CF0, symbol: lit_6847 */
...
/* 800D2E98  48 00 00 88 */	b lbl_800D2F20                           /* constant-address: 800D2F20, symbol: lbl_800D2F20 */
lbl_800D2E9C:
/* 800D2E9C  C8 02 92 F8 */	lfd f0, lit_6848(r2)                     /* constant-address: 80452CF8, symbol: lit_6848 */
/* 800D2EA0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D2EA4  40 80 00 10 */	bge lbl_800D2EB4                         /* constant-address: 800D2EB4, symbol: lbl_800D2EB4 */
/* 800D2EA8  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 800D2EAC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 800D2EB0  48 00 00 70 */	b lbl_800D2F20                           /* constant-address: 800D2F20, symbol: lbl_800D2F20 */
lbl_800D2EB4:
...
/* 800D2EC8  41 82 00 14 */	beq lbl_800D2EDC                         /* constant-address: 800D2EDC, symbol: lbl_800D2EDC */
/* 800D2ECC  40 80 00 40 */	bge lbl_800D2F0C                         /* constant-address: 800D2F0C, symbol: lbl_800D2F0C */
/* 800D2ED0  2C 03 00 00 */	cmpwi r3, 0                             
/* 800D2ED4  41 82 00 20 */	beq lbl_800D2EF4                         /* constant-address: 800D2EF4, symbol: lbl_800D2EF4 */
/* 800D2ED8  48 00 00 34 */	b lbl_800D2F0C                           /* constant-address: 800D2F0C, symbol: lbl_800D2F0C */
lbl_800D2EDC:
/* 800D2EDC  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 800D2EE0  41 82 00 0C */	beq lbl_800D2EEC                         /* constant-address: 800D2EEC, symbol: lbl_800D2EEC */
/* 800D2EE4  38 00 00 01 */	li r0, 1                                
/* 800D2EE8  48 00 00 28 */	b lbl_800D2F10                           /* constant-address: 800D2F10, symbol: lbl_800D2F10 */
lbl_800D2EEC:
/* 800D2EEC  38 00 00 02 */	li r0, 2                                
/* 800D2EF0  48 00 00 20 */	b lbl_800D2F10                           /* constant-address: 800D2F10, symbol: lbl_800D2F10 */
lbl_800D2EF4:
/* 800D2EF4  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 800D2EF8  41 82 00 0C */	beq lbl_800D2F04                         /* constant-address: 800D2F04, symbol: lbl_800D2F04 */
/* 800D2EFC  38 00 00 05 */	li r0, 5                                
/* 800D2F00  48 00 00 10 */	b lbl_800D2F10                           /* constant-address: 800D2F10, symbol: lbl_800D2F10 */
lbl_800D2F04:
/* 800D2F04  38 00 00 03 */	li r0, 3                                
/* 800D2F08  48 00 00 08 */	b lbl_800D2F10                           /* constant-address: 800D2F10, symbol: lbl_800D2F10 */
lbl_800D2F0C:
/* 800D2F0C  38 00 00 04 */	li r0, 4                                
lbl_800D2F10:
/* 800D2F10  2C 00 00 01 */	cmpwi r0, 1                             
/* 800D2F14  40 82 00 0C */	bne lbl_800D2F20                         /* constant-address: 800D2F20, symbol: lbl_800D2F20 */
/* 800D2F18  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 800D2F1C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_800D2F20:
/* 800D2F20  C0 02 93 18 */	lfs f0, lit_7308(r2)                     /* constant-address: 80452D18, symbol: lit_7308 */
/* 800D2F24  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D2F28  40 81 00 08 */	ble lbl_800D2F30                         /* constant-address: 800D2F30, symbol: lbl_800D2F30 */

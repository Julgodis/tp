...
/* 800EC550  4B FD 68 55 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800EC554  2C 03 00 00 */	cmpwi r3, 0                             
/* 800EC558  40 82 00 0C */	bne lbl_800EC564                         /* constant-address: 800EC564, symbol: lbl_800EC564 */
/* 800EC55C  38 60 00 00 */	li r3, 0                                
/* 800EC560  48 00 00 80 */	b lbl_800EC5E0                           /* constant-address: 800EC5E0, symbol: lbl_800EC5E0 */
lbl_800EC564:
/* 800EC564  7F E3 FB 78 */	mr r3, r31                              
/* 800EC568  38 80 01 5D */	li r4, 0x15d                            
/* 800EC56C  4B FC 0A 15 */	bl setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM /* constant-address: 800ACF80, symbol: setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM */
/* 800EC570  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800EC574  D0 1F 33 98 */	stfs f0, 0x3398(r31)                    
/* 800EC578  3C 60 80 42 */	lis r3, l_waitBaseAnime@ha              
/* 800EC57C  C4 03 55 14 */	lfsu f0, l_waitBaseAnime@l(r3)           /* constant-address: 80425514, symbol: l_waitBaseAnime */
/* 800EC580  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 800EC584  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425518, symbol: None */
/* 800EC588  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 800EC58C  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042551C, symbol: None */
...
/* 800EC5C8  48 03 4B F9 */	bl setFootEffectProcType__9daAlink_cFi   /* constant-address: 801211C0, symbol: setFootEffectProcType__9daAlink_cFi */
/* 800EC5CC  7F E3 FB 78 */	mr r3, r31                              
/* 800EC5D0  38 80 00 00 */	li r4, 0                                
/* 800EC5D4  38 A0 00 01 */	li r5, 1                                
/* 800EC5D8  4B FD 4D 05 */	bl deleteEquipItem__9daAlink_cFii        /* constant-address: 800C12DC, symbol: deleteEquipItem__9daAlink_cFii */

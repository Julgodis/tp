...
/* 800BF518  48 2A 2C C1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 800BF52C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
...
/* 800BF560  48 09 F6 59 */	bl checkHookshotItem__9daPy_py_cFi       /* constant-address: 8015EBB8, symbol: checkHookshotItem__9daPy_py_cFi */
/* 800BF564  2C 03 00 00 */	cmpwi r3, 0                             
/* 800BF568  40 82 00 10 */	bne lbl_800BF578                         /* constant-address: 800BF578, symbol: lbl_800BF578 */
/* 800BF56C  A0 7D 2F DC */	lhz r3, 0x2fdc(r29)                     
/* 800BF570  28 03 00 4B */	cmplwi r3, 0x4b                         
/* 800BF574  40 82 00 0C */	bne lbl_800BF580                         /* constant-address: 800BF580, symbol: lbl_800BF580 */
lbl_800BF578:
/* 800BF578  3B E1 00 2C */	addi r31, r1, 0x2c                      
/* 800BF57C  48 00 00 20 */	b lbl_800BF59C                           /* constant-address: 800BF59C, symbol: lbl_800BF59C */
lbl_800BF580:
/* 800BF580  48 09 F6 11 */	bl checkBowItem__9daPy_py_cFi            /* constant-address: 8015EB90, symbol: checkBowItem__9daPy_py_cFi */
/* 800BF584  2C 03 00 00 */	cmpwi r3, 0                             
/* 800BF588  41 82 00 14 */	beq lbl_800BF59C                         /* constant-address: 800BF59C, symbol: lbl_800BF59C */
/* 800BF58C  80 7D 28 28 */	lwz r3, 0x2828(r29)                     
/* 800BF590  28 03 00 00 */	cmplwi r3, 0                            
/* 800BF594  41 82 00 08 */	beq lbl_800BF59C                         /* constant-address: 800BF59C, symbol: lbl_800BF59C */
...
/* 800BF5B0  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
/* 800BF5B4  38 83 00 04 */	addi r4, r3, 4                           /* constant-address: 80439A24, symbol: None */
...
/* 800BF5F4  41 82 00 14 */	beq lbl_800BF608                         /* constant-address: 800BF608, symbol: lbl_800BF608 */
/* 800BF5F8  38 7D 2C 48 */	addi r3, r29, 0x2c48                    
/* 800BF5FC  38 81 00 38 */	addi r4, r1, 0x38                       
/* 800BF600  7C 85 23 78 */	mr r5, r4                               
/* 800BF604  48 28 78 49 */	bl PSMTXMultVecSR                        /* constant-address: 80346E4C, symbol: PSMTXMultVecSR */
lbl_800BF608:
/* 800BF608  38 61 00 20 */	addi r3, r1, 0x20                       
/* 800BF60C  38 81 00 38 */	addi r4, r1, 0x38                       
/* 800BF610  FC 20 F8 90 */	fmr f1, f31                             
/* 800BF614  48 1A 75 71 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
/* 800BF618  38 61 00 14 */	addi r3, r1, 0x14                       
/* 800BF61C  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800BF620  7F E5 FB 78 */	mr r5, r31                              
/* 800BF624  48 1A 74 C1 */	bl __pl__4cXyzCFRC3Vec                   /* constant-address: 80266AE4, symbol: __pl__4cXyzCFRC3Vec */
...
/* 800BF644  48 09 F5 75 */	bl checkHookshotItem__9daPy_py_cFi       /* constant-address: 8015EBB8, symbol: checkHookshotItem__9daPy_py_cFi */
/* 800BF648  2C 03 00 00 */	cmpwi r3, 0                             
/* 800BF64C  41 82 00 84 */	beq lbl_800BF6D0                         /* constant-address: 800BF6D0, symbol: lbl_800BF6D0 */
...
/* 800BF660  4B FB 87 05 */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c /* constant-address: 80077D64, symbol: Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c */
/* 800BF664  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800BF668  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800BF66C  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 800BF670  38 9D 1B B8 */	addi r4, r29, 0x1bb8                    
/* 800BF674  4B FB 4D 41 */	bl LineCross__4cBgSFP11cBgS_LinChk       /* constant-address: 800743B4, symbol: LineCross__4cBgSFP11cBgS_LinChk */
/* 800BF678  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800BF67C  41 82 00 30 */	beq lbl_800BF6AC                         /* constant-address: 800BF6AC, symbol: lbl_800BF6AC */
...
/* 800BF6A8  48 00 00 D4 */	b lbl_800BF77C                           /* constant-address: 800BF77C, symbol: lbl_800BF77C */
lbl_800BF6AC:
/* 800BF6AC  38 61 00 08 */	addi r3, r1, 8                          
/* 800BF6B0  38 81 00 38 */	addi r4, r1, 0x38                       
/* 800BF6B4  C0 22 93 50 */	lfs f1, lit_8247(r2)                     /* constant-address: 80452D50, symbol: lit_8247 */
/* 800BF6B8  48 1A 74 CD */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
/* 800BF6BC  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 800BF6C0  38 81 00 08 */	addi r4, r1, 8                          
/* 800BF6C4  7C 65 1B 78 */	mr r5, r3                               
/* 800BF6C8  48 28 79 ED */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 800BF6CC  48 00 00 18 */	b lbl_800BF6E4                           /* constant-address: 800BF6E4, symbol: lbl_800BF6E4 */
lbl_800BF6D0:
/* 800BF6D0  A0 1D 2F DC */	lhz r0, 0x2fdc(r29)                     
/* 800BF6D4  28 00 00 46 */	cmplwi r0, 0x46                         
/* 800BF6D8  40 82 00 0C */	bne lbl_800BF6E4                         /* constant-address: 800BF6E4, symbol: lbl_800BF6E4 */
/* 800BF6DC  38 60 00 00 */	li r3, 0                                
/* 800BF6E0  48 00 00 9C */	b lbl_800BF77C                           /* constant-address: 800BF77C, symbol: lbl_800BF77C */
lbl_800BF6E4:
/* 800BF6E4  A0 9D 2F DC */	lhz r4, 0x2fdc(r29)                     
/* 800BF6E8  28 04 00 40 */	cmplwi r4, 0x40                         
/* 800BF6EC  40 82 00 0C */	bne lbl_800BF6F8                         /* constant-address: 800BF6F8, symbol: lbl_800BF6F8 */
/* 800BF6F0  3B 9D 1C 28 */	addi r28, r29, 0x1c28                   
/* 800BF6F4  48 00 00 34 */	b lbl_800BF728                           /* constant-address: 800BF728, symbol: lbl_800BF728 */
lbl_800BF6F8:
/* 800BF6F8  A0 1D 2F E8 */	lhz r0, 0x2fe8(r29)                     
/* 800BF6FC  28 00 00 BC */	cmplwi r0, 0xbc                         
/* 800BF700  40 82 00 0C */	bne lbl_800BF70C                         /* constant-address: 800BF70C, symbol: lbl_800BF70C */
/* 800BF704  3B 9D 1B 48 */	addi r28, r29, 0x1b48                   
/* 800BF708  48 00 00 20 */	b lbl_800BF728                           /* constant-address: 800BF728, symbol: lbl_800BF728 */
lbl_800BF70C:
/* 800BF70C  7F A3 EB 78 */	mr r3, r29                              
/* 800BF710  48 01 F0 71 */	bl checkBowAndSlingItem__9daAlink_cFi    /* constant-address: 800DE780, symbol: checkBowAndSlingItem__9daAlink_cFi */
/* 800BF714  2C 03 00 00 */	cmpwi r3, 0                             
/* 800BF718  41 82 00 0C */	beq lbl_800BF724                         /* constant-address: 800BF724, symbol: lbl_800BF724 */
/* 800BF71C  3B 9D 1C 98 */	addi r28, r29, 0x1c98                   
/* 800BF720  48 00 00 08 */	b lbl_800BF728                           /* constant-address: 800BF728, symbol: lbl_800BF728 */
lbl_800BF724:
...
/* 800BF738  4B FB 86 2D */	bl Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c /* constant-address: 80077D64, symbol: Set__11dBgS_LinChkFPC4cXyzPC4cXyzPC10fopAc_ac_c */
/* 800BF73C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800BF740  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800BF744  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 800BF748  7F 84 E3 78 */	mr r4, r28                              
/* 800BF74C  4B FB 4C 69 */	bl LineCross__4cBgSFP11cBgS_LinChk       /* constant-address: 800743B4, symbol: LineCross__4cBgSFP11cBgS_LinChk */
/* 800BF750  54 63 06 3F */	clrlwi. r3, r3, 0x18                    
/* 800BF754  41 82 00 28 */	beq lbl_800BF77C                         /* constant-address: 800BF77C, symbol: lbl_800BF77C */
...
/* 800BF788  48 2A 2A 9D */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

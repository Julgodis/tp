...
/* 80138A5C  C0 22 93 44 */	lfs f1, lit_7977(r2)                     /* constant-address: 80452D44, symbol: lit_7977 */
/* 80138A60  48 1E F9 CD */	bl checkPass__12J3DFrameCtrlFf           /* constant-address: 8032842C, symbol: checkPass__12J3DFrameCtrlFf */
/* 80138A64  2C 03 00 00 */	cmpwi r3, 0                             
/* 80138A68  41 82 00 4C */	beq lbl_80138AB4                         /* constant-address: 80138AB4, symbol: lbl_80138AB4 */
/* 80138A6C  A8 1E 30 0C */	lha r0, 0x300c(r30)                     
/* 80138A70  2C 00 00 00 */	cmpwi r0, 0                             
/* 80138A74  40 82 00 24 */	bne lbl_80138A98                         /* constant-address: 80138A98, symbol: lbl_80138A98 */
/* 80138A78  7F C3 F3 78 */	mr r3, r30                              
/* 80138A7C  3C 80 00 02 */	lis r4, 0x0002 /* 0x0002000C@ha */      
/* 80138A80  38 84 00 0C */	addi r4, r4, 0x000C /* 0x0002000C@l */   /* constant-address: 0002000C */
...
/* 80138A94  48 00 00 20 */	b lbl_80138AB4                           /* constant-address: 80138AB4, symbol: lbl_80138AB4 */
lbl_80138A98:
/* 80138A98  7F C3 F3 78 */	mr r3, r30                              
/* 80138A9C  3C 80 00 02 */	lis r4, 0x0002 /* 0x00020053@ha */      
/* 80138AA0  38 84 00 53 */	addi r4, r4, 0x0053 /* 0x00020053@l */   /* constant-address: 00020053 */
...
/* 80138ACC  4B FE B1 25 */	bl setWolfSwimEndEffect__9daAlink_cFPP14JPABaseEmitterPP14JPABaseEmitter /* constant-address: 80123BF0, symbol: setWolfSwimEndEffect__9daAlink_cFPP14JPABaseEmitterPP14JPABaseEmitter */
/* 80138AD0  7F E3 FB 78 */	mr r3, r31                              
/* 80138AD4  48 02 59 F9 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 80138AD8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80138ADC  41 82 00 14 */	beq lbl_80138AF0                         /* constant-address: 80138AF0, symbol: lbl_80138AF0 */
/* 80138AE0  7F C3 F3 78 */	mr r3, r30                              
/* 80138AE4  38 80 00 00 */	li r4, 0                                
/* 80138AE8  4B FF 10 5D */	bl checkNextActionWolf__9daAlink_cFi     /* constant-address: 80129B44, symbol: checkNextActionWolf__9daAlink_cFi */
/* 80138AEC  48 00 00 28 */	b lbl_80138B14                           /* constant-address: 80138B14, symbol: lbl_80138B14 */
lbl_80138AF0:
/* 80138AF0  C0 3F 00 10 */	lfs f1, 0x10(r31)                       
/* 80138AF4  3C 60 80 39 */	lis r3, m__20daAlinkHIO_wlSwim_c0@ha    
/* 80138AF8  38 63 F8 B4 */	addi r3, r3, m__20daAlinkHIO_wlSwim_c0@l /* constant-address: 8038F8B4, symbol: m__20daAlinkHIO_wlSwim_c0 */
/* 80138AFC  C0 03 00 24 */	lfs f0, 0x24(r3)                         /* constant-address: 8038F8D8, symbol: None */
/* 80138B00  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80138B04  40 81 00 10 */	ble lbl_80138B14                         /* constant-address: 80138B14, symbol: lbl_80138B14 */
/* 80138B08  7F C3 F3 78 */	mr r3, r30                              
/* 80138B0C  38 80 00 01 */	li r4, 1                                
/* 80138B10  4B FF 10 35 */	bl checkNextActionWolf__9daAlink_cFi     /* constant-address: 80129B44, symbol: checkNextActionWolf__9daAlink_cFi */
lbl_80138B14:
/* 80138B14  A0 1E 2F E8 */	lhz r0, 0x2fe8(r30)                     
/* 80138B18  28 00 01 2A */	cmplwi r0, 0x12a                        
/* 80138B1C  41 82 00 34 */	beq lbl_80138B50                         /* constant-address: 80138B50, symbol: lbl_80138B50 */
/* 80138B20  80 61 00 0C */	lwz r3, 0xc(r1)                         
/* 80138B24  28 03 00 00 */	cmplwi r3, 0                            
/* 80138B28  41 82 00 10 */	beq lbl_80138B38                         /* constant-address: 80138B38, symbol: lbl_80138B38 */
...
/* 80138B40  41 82 00 10 */	beq lbl_80138B50                         /* constant-address: 80138B50, symbol: lbl_80138B50 */

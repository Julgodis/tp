...
/* 80111328  40 82 00 74 */	bne lbl_8011139C                         /* constant-address: 8011139C, symbol: lbl_8011139C */
/* 8011132C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 80111330  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80111334  A0 03 00 08 */	lhz r0, 8(r3)                            /* constant-address: 804061C8, symbol: None */
/* 80111338  28 00 00 00 */	cmplwi r0, 0                            
/* 8011133C  41 82 00 34 */	beq lbl_80111370                         /* constant-address: 80111370, symbol: lbl_80111370 */
/* 80111340  3C 60 00 02 */	lis r3, 0x0002 /* 0x00020059@ha */      
/* 80111344  38 03 00 59 */	addi r0, r3, 0x0059 /* 0x00020059@l */   /* constant-address: 00020059 */
...
/* 8011136C  48 00 00 30 */	b lbl_8011139C                           /* constant-address: 8011139C, symbol: lbl_8011139C */
lbl_80111370:
/* 80111370  3C 60 00 02 */	lis r3, 0x0002 /* 0x0002005D@ha */      
/* 80111374  38 03 00 5D */	addi r0, r3, 0x005D /* 0x0002005D@l */   /* constant-address: 0002005D */
...
/* 801113A4  38 84 00 1D */	addi r4, r4, 0x001D /* 0x0001001D@l */   /* constant-address: 0001001D */
...
/* 801113BC  4B F7 2F 5D */	bl ResetAtHit__12dCcD_GObjInfFv          /* constant-address: 80084318, symbol: ResetAtHit__12dCcD_GObjInfFv */
/* 801113C0  7F E3 FB 78 */	mr r3, r31                              
/* 801113C4  48 00 48 5D */	bl checkEventRun__9daAlink_cCFv          /* constant-address: 80115C20, symbol: checkEventRun__9daAlink_cCFv */
/* 801113C8  2C 03 00 00 */	cmpwi r3, 0                             
/* 801113CC  40 82 00 28 */	bne lbl_801113F4                         /* constant-address: 801113F4, symbol: lbl_801113F4 */
/* 801113D0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 801113D4  38 A3 61 C0 */	addi r5, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 801113D8  80 85 5D D4 */	lwz r4, 0x5dd4(r5)                       /* constant-address: 8040BF94, symbol: None */
/* 801113DC  3C 60 80 39 */	lis r3, m__23daAlinkHIO_kandelaar_c0@ha 
/* 801113E0  38 63 E7 7C */	addi r3, r3, m__23daAlinkHIO_kandelaar_c0@l /* constant-address: 8038E77C, symbol: m__23daAlinkHIO_kandelaar_c0 */
/* 801113E4  A8 03 00 4A */	lha r0, 0x4a(r3)                         /* constant-address: 8038E7C6, symbol: None */
/* 801113E8  7C 00 00 D0 */	neg r0, r0                              
/* 801113EC  7C 04 02 14 */	add r0, r4, r0                          
/* 801113F0  90 05 5D D4 */	stw r0, 0x5dd4(r5)                       /* constant-address: 8040BF94, symbol: None */
lbl_801113F4:
...
/* 80111404  C0 22 93 00 */	lfs f1, lit_6895(r2)                     /* constant-address: 80452D00, symbol: lit_6895 */
/* 80111408  48 15 E3 01 */	bl SetR__8cM3dGSphFf                     /* constant-address: 8026F708, symbol: SetR__8cM3dGSphFf */

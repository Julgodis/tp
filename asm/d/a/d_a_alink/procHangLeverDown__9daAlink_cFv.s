...
/* 800FC3A0  48 26 5E 3D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 800FC3A4  7C 7F 1B 78 */	mr r31, r3                              
/* 800FC3A8  83 C3 28 10 */	lwz r30, 0x2810(r3)                     
/* 800FC3AC  28 1E 00 00 */	cmplwi r30, 0                           
/* 800FC3B0  40 82 00 10 */	bne lbl_800FC3C0                         /* constant-address: 800FC3C0, symbol: lbl_800FC3C0 */
/* 800FC3B4  38 80 00 00 */	li r4, 0                                
/* 800FC3B8  4B FB DD 19 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800FC3BC  48 00 01 94 */	b lbl_800FC550                           /* constant-address: 800FC550, symbol: lbl_800FC550 */
lbl_800FC3C0:
/* 800FC3C0  3B BF 1F D0 */	addi r29, r31, 0x1fd0                   
/* 800FC3C4  80 1F 31 98 */	lwz r0, 0x3198(r31)                     
/* 800FC3C8  2C 00 00 91 */	cmpwi r0, 0x91                          
/* 800FC3CC  40 82 00 F0 */	bne lbl_800FC4BC                         /* constant-address: 800FC4BC, symbol: lbl_800FC4BC */
/* 800FC3D0  7F A3 EB 78 */	mr r3, r29                              
/* 800FC3D4  48 06 20 F9 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800FC3D8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FC3DC  41 82 00 BC */	beq lbl_800FC498                         /* constant-address: 800FC498, symbol: lbl_800FC498 */
...
/* 800FC3F4  38 83 9A 20 */	addi r4, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800FC40C  C0 42 93 8C */	lfs f2, lit_8783(r2)                     /* constant-address: 80452D8C, symbol: lit_8783 */
...
/* 800FC460  38 A5 E1 64 */	addi r5, r5, m__23daAlinkHIO_wallCatch_c0@l /* constant-address: 8038E164, symbol: m__23daAlinkHIO_wallCatch_c0 */
/* 800FC464  4B FB 0C 91 */	bl setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c /* constant-address: 800AD0F4, symbol: setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c */
/* 800FC468  7F E3 FB 78 */	mr r3, r31                              
/* 800FC46C  3C 80 00 01 */	lis r4, 0x0001 /* 0x00010057@ha */      
/* 800FC470  38 84 00 57 */	addi r4, r4, 0x0057 /* 0x00010057@l */   /* constant-address: 00010057 */
...
/* 800FC494  48 00 00 B8 */	b lbl_800FC54C                           /* constant-address: 800FC54C, symbol: lbl_800FC54C */
lbl_800FC498:
...
/* 800FC4AC  48 17 40 95 */	bl cLib_addCalcAngleS__FPsssss           /* constant-address: 80270540, symbol: cLib_addCalcAngleS__FPsssss */
/* 800FC4B0  A8 1F 04 E6 */	lha r0, 0x4e6(r31)                      
/* 800FC4B4  B0 1F 04 DE */	sth r0, 0x4de(r31)                      
/* 800FC4B8  48 00 00 94 */	b lbl_800FC54C                           /* constant-address: 800FC54C, symbol: lbl_800FC54C */
lbl_800FC4BC:
/* 800FC4BC  2C 00 00 92 */	cmpwi r0, 0x92                          
/* 800FC4C0  40 82 00 34 */	bne lbl_800FC4F4                         /* constant-address: 800FC4F4, symbol: lbl_800FC4F4 */
/* 800FC4C4  7F A3 EB 78 */	mr r3, r29                              
/* 800FC4C8  48 06 20 05 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800FC4CC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FC4D0  41 82 00 7C */	beq lbl_800FC54C                         /* constant-address: 800FC54C, symbol: lbl_800FC54C */
/* 800FC4D4  7F E3 FB 78 */	mr r3, r31                              
/* 800FC4D8  38 80 01 87 */	li r4, 0x187                            
/* 800FC4DC  4B FB 0A A5 */	bl setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM /* constant-address: 800ACF80, symbol: setSingleAnimeBase__9daAlink_cFQ29daAlink_c11daAlink_ANM */
...
/* 800FC4F0  48 00 00 5C */	b lbl_800FC54C                           /* constant-address: 800FC54C, symbol: lbl_800FC54C */
lbl_800FC4F4:
/* 800FC4F4  7F A3 EB 78 */	mr r3, r29                              
/* 800FC4F8  48 06 1F D5 */	bl checkAnmEnd__16daPy_frameCtrl_cFv     /* constant-address: 8015E4CC, symbol: checkAnmEnd__16daPy_frameCtrl_cFv */
/* 800FC4FC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800FC500  41 82 00 14 */	beq lbl_800FC514                         /* constant-address: 800FC514, symbol: lbl_800FC514 */
/* 800FC504  7F E3 FB 78 */	mr r3, r31                              
/* 800FC508  38 80 00 00 */	li r4, 0                                
/* 800FC50C  4B FB DB C5 */	bl checkNextAction__9daAlink_cFi         /* constant-address: 800BA0D0, symbol: checkNextAction__9daAlink_cFi */
/* 800FC510  48 00 00 3C */	b lbl_800FC54C                           /* constant-address: 800FC54C, symbol: lbl_800FC54C */
lbl_800FC514:
/* 800FC514  C0 3D 00 10 */	lfs f1, 0x10(r29)                       
/* 800FC518  C0 02 95 54 */	lfs f0, lit_24322(r2)                    /* constant-address: 80452F54, symbol: lit_24322 */
/* 800FC51C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FC520  4C 41 13 82 */	cror 2, 1, 2                            
/* 800FC524  40 82 00 10 */	bne lbl_800FC534                         /* constant-address: 800FC534, symbol: lbl_800FC534 */
/* 800FC528  38 00 00 04 */	li r0, 4                                
/* 800FC52C  98 1F 2F 92 */	stb r0, 0x2f92(r31)                     
/* 800FC530  48 00 00 1C */	b lbl_800FC54C                           /* constant-address: 800FC54C, symbol: lbl_800FC54C */
lbl_800FC534:
/* 800FC534  C0 02 95 58 */	lfs f0, lit_24323(r2)                    /* constant-address: 80452F58, symbol: lit_24323 */
/* 800FC538  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800FC53C  4C 41 13 82 */	cror 2, 1, 2                            
/* 800FC540  40 82 00 0C */	bne lbl_800FC54C                         /* constant-address: 800FC54C, symbol: lbl_800FC54C */
...
/* 800FC554  48 26 5C D5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

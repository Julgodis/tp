...
/* 800A680C  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800A6810  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 800A6814  40 80 00 08 */	bge lbl_800A681C                         /* constant-address: 800A681C, symbol: lbl_800A681C */
/* 800A6818  48 00 00 18 */	b lbl_800A6830                           /* constant-address: 800A6830, symbol: lbl_800A6830 */
lbl_800A681C:
/* 800A681C  C0 22 92 B8 */	lfs f1, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800A6820  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 800A6824  40 81 00 08 */	ble lbl_800A682C                         /* constant-address: 800A682C, symbol: lbl_800A682C */
/* 800A6828  48 00 00 08 */	b lbl_800A6830                           /* constant-address: 800A6830, symbol: lbl_800A6830 */
lbl_800A682C:
...
/* 800A683C  41 82 02 08 */	beq lbl_800A6A44                         /* constant-address: 800A6A44, symbol: lbl_800A6A44 */
/* 800A6840  3C 60 80 3A */	lis r3, __vt__8cM3dGPla@ha              
/* 800A6844  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800A6848  90 01 00 48 */	stw r0, 0x48(r1)                        
/* 800A684C  38 7F 04 D0 */	addi r3, r31, 0x4d0                     
/* 800A6850  4B F6 65 15 */	bl transS__14mDoMtx_stack_cFRC4cXyz      /* constant-address: 8000CD64, symbol: transS__14mDoMtx_stack_cFRC4cXyz */
/* 800A6854  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A6858  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A685C  A8 9F 04 E6 */	lha r4, 0x4e6(r31)                      
/* 800A6860  4B F6 5B D5 */	bl mDoMtx_YrotM__FPA4_fs                 /* constant-address: 8000C434, symbol: mDoMtx_YrotM__FPA4_fs */
/* 800A6864  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A6868  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A686C  3C 80 80 39 */	lis r4, l_crawlFrontUpOffset@ha         
/* 800A6870  38 84 FA 78 */	addi r4, r4, l_crawlFrontUpOffset@l      /* constant-address: 8038FA78, symbol: l_crawlFrontUpOffset */
/* 800A6874  38 A1 00 2C */	addi r5, r1, 0x2c                       
/* 800A6878  48 2A 04 F5 */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A687C  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800A6880  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800A6884  3C 80 80 39 */	lis r4, l_crawlBackUpOffset@ha          
/* 800A6888  38 84 FA 90 */	addi r4, r4, l_crawlBackUpOffset@l       /* constant-address: 8038FA90, symbol: l_crawlBackUpOffset */
/* 800A688C  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800A6890  48 2A 04 DD */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
/* 800A6894  38 7F 1D 08 */	addi r3, r31, 0x1d08                    
/* 800A6898  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 800A689C  48 1C 14 8D */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800A68A0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800A68A4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800A68A8  3B C3 0F 38 */	addi r30, r3, 0xf38                      /* constant-address: 804070F8, symbol: None */
/* 800A68AC  7F C3 F3 78 */	mr r3, r30                              
/* 800A68B0  38 9F 1D 08 */	addi r4, r31, 0x1d08                    
/* 800A68B4  4B FC DB ED */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800A68B8  D0 21 00 30 */	stfs f1, 0x30(r1)                       
/* 800A68BC  C0 42 93 A4 */	lfs f2, lit_9138(r2)                     /* constant-address: 80452DA4, symbol: lit_9138 */
/* 800A68C0  FC 00 08 18 */	frsp f0, f1                             
/* 800A68C4  FC 02 00 00 */	fcmpu cr0, f2, f0                       
/* 800A68C8  41 82 00 18 */	beq lbl_800A68E0                         /* constant-address: 800A68E0, symbol: lbl_800A68E0 */
/* 800A68CC  7F C3 F3 78 */	mr r3, r30                              
/* 800A68D0  38 9F 1D 1C */	addi r4, r31, 0x1d1c                    
/* 800A68D4  38 A1 00 38 */	addi r5, r1, 0x38                       
/* 800A68D8  4B FC DE 6D */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 800A68DC  48 00 00 08 */	b lbl_800A68E4                           /* constant-address: 800A68E4, symbol: lbl_800A68E4 */
lbl_800A68E0:
/* 800A68E0  38 60 00 00 */	li r3, 0                                
lbl_800A68E4:
/* 800A68E4  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800A68E8  41 82 00 0C */	beq lbl_800A68F4                         /* constant-address: 800A68F4, symbol: lbl_800A68F4 */
/* 800A68EC  C3 E1 00 3C */	lfs f31, 0x3c(r1)                       
/* 800A68F0  48 00 00 08 */	b lbl_800A68F8                           /* constant-address: 800A68F8, symbol: lbl_800A68F8 */
lbl_800A68F4:
/* 800A68F4  C3 E2 92 BC */	lfs f31, lit_6041(r2)                    /* constant-address: 80452CBC, symbol: lit_6041 */
lbl_800A68F8:
/* 800A68F8  38 7F 1D 08 */	addi r3, r31, 0x1d08                    
/* 800A68FC  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800A6900  48 1C 14 29 */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800A6904  7F C3 F3 78 */	mr r3, r30                              
/* 800A6908  38 9F 1D 08 */	addi r4, r31, 0x1d08                    
/* 800A690C  4B FC DB 95 */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800A6910  D0 21 00 24 */	stfs f1, 0x24(r1)                       
/* 800A6914  C0 42 93 A4 */	lfs f2, lit_9138(r2)                     /* constant-address: 80452DA4, symbol: lit_9138 */
/* 800A6918  FC 00 08 18 */	frsp f0, f1                             
/* 800A691C  FC 02 00 00 */	fcmpu cr0, f2, f0                       
/* 800A6920  41 82 00 18 */	beq lbl_800A6938                         /* constant-address: 800A6938, symbol: lbl_800A6938 */
/* 800A6924  7F C3 F3 78 */	mr r3, r30                              
/* 800A6928  38 9F 1D 1C */	addi r4, r31, 0x1d1c                    
/* 800A692C  38 A1 00 38 */	addi r5, r1, 0x38                       
/* 800A6930  4B FC DE 15 */	bl GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla /* constant-address: 80074744, symbol: GetTriPla__4cBgSCFRC13cBgS_PolyInfoP8cM3dGPla */
/* 800A6934  48 00 00 08 */	b lbl_800A693C                           /* constant-address: 800A693C, symbol: lbl_800A693C */
lbl_800A6938:
/* 800A6938  38 60 00 00 */	li r3, 0                                
lbl_800A693C:
/* 800A693C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800A6940  41 82 00 0C */	beq lbl_800A694C                         /* constant-address: 800A694C, symbol: lbl_800A694C */
/* 800A6944  C3 C1 00 3C */	lfs f30, 0x3c(r1)                       
/* 800A6948  48 00 00 08 */	b lbl_800A6950                           /* constant-address: 800A6950, symbol: lbl_800A6950 */
lbl_800A694C:
/* 800A694C  C3 C2 92 BC */	lfs f30, lit_6041(r2)                    /* constant-address: 80452CBC, symbol: lit_6041 */
lbl_800A6950:
/* 800A6950  38 61 00 08 */	addi r3, r1, 8                          
/* 800A6954  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 800A6958  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800A695C  48 1C 01 D9 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800A697C  48 1C 07 D5 */	bl atan2sY_XZ__4cXyzCFv                  /* constant-address: 80267150, symbol: atan2sY_XZ__4cXyzCFv */
/* 800A6980  7C 7E 1B 78 */	mr r30, r3                              
/* 800A6984  A8 9F 04 E4 */	lha r4, 0x4e4(r31)                      
/* 800A6988  48 1C A4 9D */	bl cLib_distanceAngleS__Fss              /* constant-address: 80270E24, symbol: cLib_distanceAngleS__Fss */
/* 800A698C  2C 03 10 00 */	cmpwi r3, 0x1000                        
/* 800A6990  40 80 00 6C */	bge lbl_800A69FC                         /* constant-address: 800A69FC, symbol: lbl_800A69FC */
/* 800A6994  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800A6998  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 800A699C  40 81 00 60 */	ble lbl_800A69FC                         /* constant-address: 800A69FC, symbol: lbl_800A69FC */
/* 800A69A0  FC 1E 00 40 */	fcmpo cr0, f30, f0                      
/* 800A69A4  40 81 00 58 */	ble lbl_800A69FC                         /* constant-address: 800A69FC, symbol: lbl_800A69FC */
/* 800A69A8  EC 1F F0 28 */	fsubs f0, f31, f30                      
/* 800A69AC  FC 00 02 10 */	fabs f0, f0                             
/* 800A69B0  FC 20 00 18 */	frsp f1, f0                             
/* 800A69B4  C0 02 92 A4 */	lfs f0, lit_6021(r2)                     /* constant-address: 80452CA4, symbol: lit_6021 */
/* 800A69B8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800A69BC  40 81 00 40 */	ble lbl_800A69FC                         /* constant-address: 800A69FC, symbol: lbl_800A69FC */
/* 800A69C0  7F C0 07 34 */	extsh r0, r30                           
/* 800A69C4  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800A69F8  48 00 00 3C */	b lbl_800A6A34                           /* constant-address: 800A6A34, symbol: lbl_800A6A34 */
lbl_800A69FC:
/* 800A69FC  A8 1F 2F F0 */	lha r0, 0x2ff0(r31)                     
/* 800A6A00  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800A6A38  38 03 37 C0 */	addi r0, r3, __vt__8cM3dGPla@l           /* constant-address: 803A37C0, symbol: __vt__8cM3dGPla */
/* 800A6A3C  90 01 00 48 */	stw r0, 0x48(r1)                        
/* 800A6A40  48 00 00 3C */	b lbl_800A6A7C                           /* constant-address: 800A6A7C, symbol: lbl_800A6A7C */
lbl_800A6A44:
/* 800A6A44  A8 1F 2F F0 */	lha r0, 0x2ff0(r31)                     
/* 800A6A48  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800A6A90  48 00 96 09 */	bl getGroundAngle__9daAlink_cFP13cBgS_PolyInfos /* constant-address: 800B0098, symbol: getGroundAngle__9daAlink_cFP13cBgS_PolyInfos */
/* 800A6A94  7C 60 07 34 */	extsh r0, r3                            
/* 800A6A98  C8 22 92 B0 */	lfd f1, lit_6025(r2)                     /* constant-address: 80452CB0, symbol: lit_6025 */
...
/* 800A6AD4  40 82 00 10 */	bne lbl_800A6AE4                         /* constant-address: 800A6AE4, symbol: lbl_800A6AE4 */

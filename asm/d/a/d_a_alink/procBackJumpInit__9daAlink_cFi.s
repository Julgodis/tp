...
/* 800C57B4  48 29 CA 21 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 800C57D8  48 01 76 19 */	bl checkUpperGuardAnime__9daAlink_cCFv   /* constant-address: 800DCDF0, symbol: checkUpperGuardAnime__9daAlink_cCFv */
...
/* 800C57F8  4B FF C7 75 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800C57FC  2C 1B 00 00 */	cmpwi r27, 0                            
/* 800C5800  41 82 00 54 */	beq lbl_800C5854                         /* constant-address: 800C5854, symbol: lbl_800C5854 */
/* 800C5804  7F C3 F3 78 */	mr r3, r30                              
/* 800C5808  38 80 00 26 */	li r4, 0x26                             
/* 800C580C  3C A0 80 39 */	lis r5, m__21daAlinkHIO_cutDown_c0@ha   
/* 800C5810  38 A5 DD 44 */	addi r5, r5, m__21daAlinkHIO_cutDown_c0@l /* constant-address: 8038DD44, symbol: m__21daAlinkHIO_cutDown_c0 */
/* 800C5814  38 A5 00 50 */	addi r5, r5, 0x50                        /* constant-address: 8038DD94, symbol: None */
/* 800C5818  4B FE 78 DD */	bl setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c /* constant-address: 800AD0F4, symbol: setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c */
/* 800C581C  3C 60 80 39 */	lis r3, m__21daAlinkHIO_cutDown_c0@ha   
/* 800C5820  38 63 DD 44 */	addi r3, r3, m__21daAlinkHIO_cutDown_c0@l /* constant-address: 8038DD44, symbol: m__21daAlinkHIO_cutDown_c0 */
/* 800C5824  C0 03 00 6C */	lfs f0, 0x6c(r3)                         /* constant-address: 8038DDB0, symbol: None */
/* 800C5828  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 800C582C  C0 03 00 70 */	lfs f0, 0x70(r3)                         /* constant-address: 8038DDB4, symbol: None */
/* 800C5830  D0 1E 04 FC */	stfs f0, 0x4fc(r30)                     
/* 800C5834  7F C3 F3 78 */	mr r3, r30                              
/* 800C5838  3C 80 00 01 */	lis r4, 0x0001 /* 0x00010095@ha */      
/* 800C583C  38 84 00 95 */	addi r4, r4, 0x0095 /* 0x00010095@l */   /* constant-address: 00010095 */
...
/* 800C5850  48 00 00 4C */	b lbl_800C589C                           /* constant-address: 800C589C, symbol: lbl_800C589C */
lbl_800C5854:
/* 800C5854  7F C3 F3 78 */	mr r3, r30                              
/* 800C5858  38 80 00 26 */	li r4, 0x26                             
/* 800C585C  3C A0 80 39 */	lis r5, m__22daAlinkHIO_backJump_c0@ha  
/* 800C5860  38 A5 D8 2C */	addi r5, r5, m__22daAlinkHIO_backJump_c0@l /* constant-address: 8038D82C, symbol: m__22daAlinkHIO_backJump_c0 */
/* 800C5864  4B FE 78 91 */	bl setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c /* constant-address: 800AD0F4, symbol: setSingleAnimeParam__9daAlink_cFQ29daAlink_c11daAlink_ANMPC16daAlinkHIO_anm_c */
/* 800C5868  3C 60 80 39 */	lis r3, m__22daAlinkHIO_backJump_c0@ha  
/* 800C586C  38 63 D8 2C */	addi r3, r3, m__22daAlinkHIO_backJump_c0@l /* constant-address: 8038D82C, symbol: m__22daAlinkHIO_backJump_c0 */
/* 800C5870  C0 03 00 28 */	lfs f0, 0x28(r3)                         /* constant-address: 8038D854, symbol: None */
/* 800C5874  D0 1E 33 98 */	stfs f0, 0x3398(r30)                    
/* 800C5878  C0 03 00 2C */	lfs f0, 0x2c(r3)                         /* constant-address: 8038D858, symbol: None */
/* 800C587C  D0 1E 04 FC */	stfs f0, 0x4fc(r30)                     
/* 800C5880  7F C3 F3 78 */	mr r3, r30                              
/* 800C5884  3C 80 00 01 */	lis r4, 0x0001 /* 0x00010007@ha */      
/* 800C5888  38 84 00 07 */	addi r4, r4, 0x0007 /* 0x00010007@l */   /* constant-address: 00010007 */
...
/* 800C58A8  41 82 00 1C */	beq lbl_800C58C4                         /* constant-address: 800C58C4, symbol: lbl_800C58C4 */
...
/* 800C58C0  48 00 00 0C */	b lbl_800C58CC                           /* constant-address: 800C58CC, symbol: lbl_800C58CC */
lbl_800C58C4:
/* 800C58C4  38 00 00 00 */	li r0, 0                                
/* 800C58C8  B0 1E 30 08 */	sth r0, 0x3008(r30)                     
lbl_800C58CC:
/* 800C58CC  2C 1C 00 00 */	cmpwi r28, 0                            
/* 800C58D0  41 82 00 4C */	beq lbl_800C591C                         /* constant-address: 800C591C, symbol: lbl_800C591C */
...
/* 800C58F4  4B FE 82 85 */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
/* 800C58F8  80 7E 20 60 */	lwz r3, 0x2060(r30)                     
/* 800C58FC  80 63 00 1C */	lwz r3, 0x1c(r3)                        
/* 800C5900  C0 23 00 1C */	lfs f1, 0x1c(r3)                        
/* 800C5904  C0 02 95 1C */	lfs f0, lit_20991(r2)                    /* constant-address: 80452F1C, symbol: lit_20991 */
...
/* 800C5938  41 82 00 10 */	beq lbl_800C5948                         /* constant-address: 800C5948, symbol: lbl_800C5948 */
...
/* 800C5950  48 29 C8 D1 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

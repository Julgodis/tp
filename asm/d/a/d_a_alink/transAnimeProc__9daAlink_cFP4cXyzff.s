...
/* 800BB7C0  48 2A 6A 15 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 800BB828  41 82 00 74 */	beq lbl_800BB89C                         /* constant-address: 800BB89C, symbol: lbl_800BB89C */
...
/* 800BB84C  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
...
/* 800BB8A8  41 80 FF 70 */	blt lbl_800BB818                         /* constant-address: 800BB818, symbol: lbl_800BB818 */
...
/* 800BB8BC  40 82 00 EC */	bne lbl_800BB9A8                         /* constant-address: 800BB9A8, symbol: lbl_800BB9A8 */
/* 800BB8C0  38 61 00 08 */	addi r3, r1, 8                          
/* 800BB8C4  38 9D 04 D0 */	addi r4, r29, 0x4d0                     
/* 800BB8C8  38 BD 37 98 */	addi r5, r29, 0x3798                    
/* 800BB8CC  48 1A B2 69 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 800BB8F0  40 82 00 18 */	bne lbl_800BB908                         /* constant-address: 800BB908, symbol: lbl_800BB908 */
/* 800BB8F4  A0 1D 2F E8 */	lhz r0, 0x2fe8(r29)                     
/* 800BB8F8  28 00 00 1B */	cmplwi r0, 0x1b                         
/* 800BB8FC  41 82 00 0C */	beq lbl_800BB908                         /* constant-address: 800BB908, symbol: lbl_800BB908 */
/* 800BB900  28 00 01 04 */	cmplwi r0, 0x104                        
/* 800BB904  40 82 00 4C */	bne lbl_800BB950                         /* constant-address: 800BB950, symbol: lbl_800BB950 */
lbl_800BB908:
...
/* 800BB918  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800BB9A4  48 00 03 5C */	b lbl_800BBD00                           /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
lbl_800BB9A8:
/* 800BB9A8  28 00 00 40 */	cmplwi r0, 0x40                         
/* 800BB9AC  41 82 00 24 */	beq lbl_800BB9D0                         /* constant-address: 800BB9D0, symbol: lbl_800BB9D0 */
/* 800BB9B0  28 00 00 90 */	cmplwi r0, 0x90                         
/* 800BB9B4  41 82 00 1C */	beq lbl_800BB9D0                         /* constant-address: 800BB9D0, symbol: lbl_800BB9D0 */
/* 800BB9B8  28 00 00 80 */	cmplwi r0, 0x80                         
/* 800BB9BC  41 82 00 14 */	beq lbl_800BB9D0                         /* constant-address: 800BB9D0, symbol: lbl_800BB9D0 */
/* 800BB9C0  28 00 00 A0 */	cmplwi r0, 0xa0                         
/* 800BB9C4  41 82 00 0C */	beq lbl_800BB9D0                         /* constant-address: 800BB9D0, symbol: lbl_800BB9D0 */
/* 800BB9C8  28 00 00 70 */	cmplwi r0, 0x70                         
/* 800BB9CC  40 82 02 40 */	bne lbl_800BBC0C                         /* constant-address: 800BBC0C, symbol: lbl_800BBC0C */
lbl_800BB9D0:
/* 800BB9D0  28 00 00 80 */	cmplwi r0, 0x80                         
/* 800BB9D4  40 82 00 24 */	bne lbl_800BB9F8                         /* constant-address: 800BB9F8, symbol: lbl_800BB9F8 */
/* 800BB9D8  C0 21 00 70 */	lfs f1, 0x70(r1)                        
/* 800BB9DC  C0 1F 00 18 */	lfs f0, 0x18(r31)                       
/* 800BB9E0  EC 21 00 28 */	fsubs f1, f1, f0                        
/* 800BB9E4  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800BB9E8  D0 01 00 2C */	stfs f0, 0x2c(r1)                       
/* 800BB9EC  D0 21 00 30 */	stfs f1, 0x30(r1)                       
/* 800BB9F0  D0 01 00 34 */	stfs f0, 0x34(r1)                       
/* 800BB9F4  48 00 00 C0 */	b lbl_800BBAB4                           /* constant-address: 800BBAB4, symbol: lbl_800BBAB4 */
lbl_800BB9F8:
/* 800BB9F8  28 00 00 A0 */	cmplwi r0, 0xa0                         
/* 800BB9FC  40 82 00 54 */	bne lbl_800BBA50                         /* constant-address: 800BBA50, symbol: lbl_800BBA50 */
...
/* 800BBA4C  48 00 00 68 */	b lbl_800BBAB4                           /* constant-address: 800BBAB4, symbol: lbl_800BBAB4 */
lbl_800BBA50:
/* 800BBA50  28 00 00 90 */	cmplwi r0, 0x90                         
/* 800BBA54  40 82 00 30 */	bne lbl_800BBA84                         /* constant-address: 800BBA84, symbol: lbl_800BBA84 */
...
/* 800BBA74  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800BBA78  D0 01 00 30 */	stfs f0, 0x30(r1)                       
/* 800BBA7C  D0 41 00 34 */	stfs f2, 0x34(r1)                       
/* 800BBA80  48 00 00 34 */	b lbl_800BBAB4                           /* constant-address: 800BBAB4, symbol: lbl_800BBAB4 */
lbl_800BBA84:
...
/* 800BBAEC  41 82 00 38 */	beq lbl_800BBB24                         /* constant-address: 800BBB24, symbol: lbl_800BBB24 */
/* 800BBAF0  38 7D 2C 48 */	addi r3, r29, 0x2c48                    
/* 800BBAF4  3C 80 80 3E */	lis r4, now__14mDoMtx_stack_c@ha        
/* 800BBAF8  38 84 D4 70 */	addi r4, r4, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800BBAFC  48 28 A9 B5 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 800BBB00  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800BBB04  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800BBB08  A8 9D 04 E6 */	lha r4, 0x4e6(r29)                      
/* 800BBB0C  4B F5 09 29 */	bl mDoMtx_YrotM__FPA4_fs                 /* constant-address: 8000C434, symbol: mDoMtx_YrotM__FPA4_fs */
/* 800BBB10  3C 60 80 3E */	lis r3, now__14mDoMtx_stack_c@ha        
/* 800BBB14  38 63 D4 70 */	addi r3, r3, now__14mDoMtx_stack_c@l     /* constant-address: 803DD470, symbol: now__14mDoMtx_stack_c */
/* 800BBB18  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 800BBB1C  38 A1 00 20 */	addi r5, r1, 0x20                       
/* 800BBB20  48 28 B2 4D */	bl PSMTXMultVec                          /* constant-address: 80346D6C, symbol: PSMTXMultVec */
lbl_800BBB24:
/* 800BBB24  38 7D 04 D0 */	addi r3, r29, 0x4d0                     
/* 800BBB28  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800BBB2C  7C 65 1B 78 */	mr r5, r3                               
/* 800BBB30  48 28 B5 85 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 800BBB34  38 7D 37 98 */	addi r3, r29, 0x3798                    
/* 800BBB38  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800BBB3C  7C 65 1B 78 */	mr r5, r3                               
/* 800BBB40  48 28 B5 75 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 800BBB44  88 1D 2F 99 */	lbz r0, 0x2f99(r29)                     
/* 800BBB48  28 00 00 A0 */	cmplwi r0, 0xa0                         
/* 800BBB4C  40 82 00 20 */	bne lbl_800BBB6C                         /* constant-address: 800BBB6C, symbol: lbl_800BBB6C */
/* 800BBB50  A0 1D 2F E8 */	lhz r0, 0x2fe8(r29)                     
/* 800BBB54  28 00 00 12 */	cmplwi r0, 0x12                         
/* 800BBB58  40 82 00 14 */	bne lbl_800BBB6C                         /* constant-address: 800BBB6C, symbol: lbl_800BBB6C */
/* 800BBB5C  38 7D 34 F8 */	addi r3, r29, 0x34f8                    
/* 800BBB60  38 81 00 20 */	addi r4, r1, 0x20                       
/* 800BBB64  7C 65 1B 78 */	mr r5, r3                               
/* 800BBB68  48 28 B5 4D */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
lbl_800BBB6C:
/* 800BBB6C  88 1D 2F 99 */	lbz r0, 0x2f99(r29)                     
/* 800BBB70  28 00 00 70 */	cmplwi r0, 0x70                         
/* 800BBB74  40 82 00 70 */	bne lbl_800BBBE4                         /* constant-address: 800BBBE4, symbol: lbl_800BBBE4 */
...
/* 800BBBA0  48 1A C1 89 */	bl SetPos__11cBgS_GndChkFPC4cXyz         /* constant-address: 80267D28, symbol: SetPos__11cBgS_GndChkFPC4cXyz */
/* 800BBBA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800BBBA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800BBBAC  38 63 0F 38 */	addi r3, r3, 0xf38                       /* constant-address: 804070F8, symbol: None */
/* 800BBBB0  38 9D 1D 08 */	addi r4, r29, 0x1d08                    
/* 800BBBB4  4B FB 88 ED */	bl GroundCross__4cBgSFP11cBgS_GndChk     /* constant-address: 800744A0, symbol: GroundCross__4cBgSFP11cBgS_GndChk */
/* 800BBBB8  C0 5D 04 D4 */	lfs f2, 0x4d4(r29)                      
/* 800BBBBC  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 800BBBC0  40 80 00 24 */	bge lbl_800BBBE4                         /* constant-address: 800BBBE4, symbol: lbl_800BBBE4 */
...
/* 800BBBF4  41 82 01 0C */	beq lbl_800BBD00                         /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
...
/* 800BBC08  48 00 00 F8 */	b lbl_800BBD00                           /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
lbl_800BBC0C:
/* 800BBC0C  28 00 00 20 */	cmplwi r0, 0x20                         
/* 800BBC10  41 82 00 0C */	beq lbl_800BBC1C                         /* constant-address: 800BBC1C, symbol: lbl_800BBC1C */
/* 800BBC14  28 00 00 30 */	cmplwi r0, 0x30                         
/* 800BBC18  40 82 00 24 */	bne lbl_800BBC3C                         /* constant-address: 800BBC3C, symbol: lbl_800BBC3C */
lbl_800BBC1C:
...
/* 800BBC2C  41 82 00 D4 */	beq lbl_800BBD00                         /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
/* 800BBC30  C0 01 00 6C */	lfs f0, 0x6c(r1)                        
/* 800BBC34  D0 1F 00 14 */	stfs f0, 0x14(r31)                      
/* 800BBC38  48 00 00 C8 */	b lbl_800BBD00                           /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
lbl_800BBC3C:
/* 800BBC3C  28 00 00 10 */	cmplwi r0, 0x10                         
/* 800BBC40  40 82 00 94 */	bne lbl_800BBCD4                         /* constant-address: 800BBCD4, symbol: lbl_800BBCD4 */
/* 800BBC44  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800BBC80  41 82 00 10 */	beq lbl_800BBC90                         /* constant-address: 800BBC90, symbol: lbl_800BBC90 */
/* 800BBC84  38 00 00 06 */	li r0, 6                                
/* 800BBC88  98 1D 2F 99 */	stb r0, 0x2f99(r29)                     
/* 800BBC8C  48 00 00 0C */	b lbl_800BBC98                           /* constant-address: 800BBC98, symbol: lbl_800BBC98 */
lbl_800BBC90:
...
/* 800BBCA0  41 82 00 0C */	beq lbl_800BBCAC                         /* constant-address: 800BBCAC, symbol: lbl_800BBCAC */
/* 800BBCA4  28 00 00 7C */	cmplwi r0, 0x7c                         
/* 800BBCA8  40 82 00 14 */	bne lbl_800BBCBC                         /* constant-address: 800BBCBC, symbol: lbl_800BBCBC */
lbl_800BBCAC:
/* 800BBCAC  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800BBCB0  D0 1E 00 04 */	stfs f0, 4(r30)                         
/* 800BBCB4  D0 1D 33 B0 */	stfs f0, 0x33b0(r29)                    
/* 800BBCB8  48 00 00 48 */	b lbl_800BBD00                           /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
lbl_800BBCBC:
/* 800BBCBC  28 00 00 DD */	cmplwi r0, 0xdd                         
/* 800BBCC0  40 82 00 40 */	bne lbl_800BBD00                         /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
/* 800BBCC4  C0 02 95 E0 */	lfs f0, lit_28016(r2)                    /* constant-address: 80452FE0, symbol: lit_28016 */
/* 800BBCC8  D0 1D 33 B0 */	stfs f0, 0x33b0(r29)                    
/* 800BBCCC  D0 1E 00 04 */	stfs f0, 4(r30)                         
/* 800BBCD0  48 00 00 30 */	b lbl_800BBD00                           /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
lbl_800BBCD4:
/* 800BBCD4  54 00 07 39 */	rlwinm. r0, r0, 0, 0x1c, 0x1c           
/* 800BBCD8  41 82 00 28 */	beq lbl_800BBD00                         /* constant-address: 800BBD00, symbol: lbl_800BBD00 */
...
/* 800BBD2C  48 2A 64 F5 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

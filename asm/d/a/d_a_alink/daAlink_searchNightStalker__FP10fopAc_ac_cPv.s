...
/* 800D0D58  40 82 00 7C */	bne lbl_800D0DD4                         /* constant-address: 800D0DD4, symbol: lbl_800D0DD4 */
/* 800D0D5C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800D0D60  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800D0D64  83 E3 5D B4 */	lwz r31, 0x5db4(r3)                      /* constant-address: 8040BF74, symbol: None */
/* 800D0D68  C0 5F 04 D8 */	lfs f2, 0x4d8(r31)                      
/* 800D0D6C  C0 1F 04 D0 */	lfs f0, 0x4d0(r31)                      
/* 800D0D70  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 800D0D74  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800D0D9C  48 27 66 01 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 800D0DA0  C0 02 92 CC */	lfs f0, lit_6237(r2)                     /* constant-address: 80452CCC, symbol: lit_6237 */
/* 800D0DA4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D0DA8  40 80 00 44 */	bge lbl_800D0DEC                         /* constant-address: 800D0DEC, symbol: lbl_800D0DEC */
...
/* 800D0DC0  C0 02 92 D0 */	lfs f0, lit_6238(r2)                     /* constant-address: 80452CD0, symbol: lit_6238 */
/* 800D0DC4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 800D0DC8  40 80 00 24 */	bge lbl_800D0DEC                         /* constant-address: 800D0DEC, symbol: lbl_800D0DEC */
/* 800D0DCC  7F C3 F3 78 */	mr r3, r30                              
/* 800D0DD0  48 00 00 20 */	b lbl_800D0DF0                           /* constant-address: 800D0DF0, symbol: lbl_800D0DF0 */
lbl_800D0DD4:
/* 800D0DD4  2C 00 02 0E */	cmpwi r0, 0x20e                         
/* 800D0DD8  40 82 00 14 */	bne lbl_800D0DEC                         /* constant-address: 800D0DEC, symbol: lbl_800D0DEC */
/* 800D0DDC  88 1E 27 40 */	lbz r0, 0x2740(r30)                     
/* 800D0DE0  28 00 00 00 */	cmplwi r0, 0                            
/* 800D0DE4  41 82 00 08 */	beq lbl_800D0DEC                         /* constant-address: 800D0DEC, symbol: lbl_800D0DEC */
/* 800D0DE8  48 00 00 08 */	b lbl_800D0DF0                           /* constant-address: 800D0DF0, symbol: lbl_800D0DF0 */
lbl_800D0DEC:

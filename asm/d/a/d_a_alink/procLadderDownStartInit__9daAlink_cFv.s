...
/* 800FD9F4  41 82 00 14 */	beq lbl_800FDA08                         /* constant-address: 800FDA08, symbol: lbl_800FDA08 */
/* 800FD9F8  38 80 00 69 */	li r4, 0x69                             
/* 800FD9FC  38 A0 00 00 */	li r5, 0                                
/* 800FDA00  4B FC 53 DD */	bl procPreActionUnequipInit__9daAlink_cFiP10fopAc_ac_c /* constant-address: 800C2DDC, symbol: procPreActionUnequipInit__9daAlink_cFiP10fopAc_ac_c */
/* 800FDA04  48 00 01 5C */	b lbl_800FDB60                           /* constant-address: 800FDB60, symbol: lbl_800FDB60 */
lbl_800FDA08:
/* 800FDA08  38 80 00 69 */	li r4, 0x69                             
/* 800FDA0C  4B FC 45 61 */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C1F6C, symbol: commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 800FDA10  7F E3 FB 78 */	mr r3, r31                              
/* 800FDA14  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800FDA18  C0 5F 05 34 */	lfs f2, 0x534(r31)                      
/* 800FDA1C  38 80 00 00 */	li r4, 0                                
/* 800FDA20  4B FB DD 51 */	bl setSpecialGravity__9daAlink_cFffi     /* constant-address: 800BB770, symbol: setSpecialGravity__9daAlink_cFffi */
/* 800FDA24  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
...
/* 800FDA58  38 A5 EB 8C */	addi r5, r5, m__20daAlinkHIO_ladder_c0@l /* constant-address: 8038EB8C, symbol: m__20daAlinkHIO_ladder_c0 */
/* 800FDA5C  C0 25 00 38 */	lfs f1, 0x38(r5)                         /* constant-address: 8038EBC4, symbol: None */
/* 800FDA60  C0 45 00 3C */	lfs f2, 0x3c(r5)                         /* constant-address: 8038EBC8, symbol: None */
/* 800FDA64  4B FA F5 7D */	bl setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff /* constant-address: 800ACFE0, symbol: setSingleAnimeBaseSpeed__9daAlink_cFQ29daAlink_c11daAlink_ANMff */
/* 800FDA68  38 00 00 10 */	li r0, 0x10                             
/* 800FDA6C  98 1F 2F 99 */	stb r0, 0x2f99(r31)                     
/* 800FDA70  3C 60 80 42 */	lis r3, l_waitBaseAnime@ha              
/* 800FDA74  C4 03 55 14 */	lfsu f0, l_waitBaseAnime@l(r3)           /* constant-address: 80425514, symbol: l_waitBaseAnime */
/* 800FDA78  D0 1F 35 88 */	stfs f0, 0x3588(r31)                    
/* 800FDA7C  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80425518, symbol: None */
/* 800FDA80  D0 1F 35 8C */	stfs f0, 0x358c(r31)                    
/* 800FDA84  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8042551C, symbol: None */
/* 800FDA88  D0 1F 35 90 */	stfs f0, 0x3590(r31)                    
/* 800FDA8C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800FDA90  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800FDA94  80 03 5F 18 */	lwz r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800FDA98  64 00 02 00 */	oris r0, r0, 0x200                      
/* 800FDA9C  90 03 5F 18 */	stw r0, 0x5f18(r3)                       /* constant-address: 8040C0D8, symbol: None */
/* 800FDAA0  7F E3 FB 78 */	mr r3, r31                              
/* 800FDAA4  38 80 00 00 */	li r4, 0                                
/* 800FDAA8  38 A0 80 00 */	li r5, -32768                           
/* 800FDAAC  38 C0 00 00 */	li r6, 0                                
/* 800FDAB0  4B FB 00 C9 */	bl setOldRootQuaternion__9daAlink_cFsss  /* constant-address: 800ADB78, symbol: setOldRootQuaternion__9daAlink_cFsss */
...
/* 800FDAD8  38 63 9A 20 */	addi r3, r3, sincosTable___5JMath@l      /* constant-address: 80439A20, symbol: sincosTable___5JMath */
...
/* 800FDAEC  C0 42 93 D4 */	lfs f2, lit_11442(r2)                    /* constant-address: 80452DD4, symbol: lit_11442 */
...
/* 800FDB18  C0 62 93 98 */	lfs f3, lit_8786(r2)                     /* constant-address: 80452D98, symbol: lit_8786 */
/* 800FDB1C  EC 03 01 32 */	fmuls f0, f3, f4                        
/* 800FDB20  EC 01 00 28 */	fsubs f0, f1, f0                        
/* 800FDB24  D0 1F 37 C8 */	stfs f0, 0x37c8(r31)                    
/* 800FDB28  C0 42 94 28 */	lfs f2, lit_14621(r2)                    /* constant-address: 80452E28, symbol: lit_14621 */
/* 800FDB2C  C0 3F 34 F0 */	lfs f1, 0x34f0(r31)                     
/* 800FDB30  C0 02 95 8C */	lfs f0, lit_24852(r2)                    /* constant-address: 80452F8C, symbol: lit_24852 */

...
/* 800CB560  38 84 61 C0 */	addi r4, r4, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800CB564  88 04 00 15 */	lbz r0, 0x15(r4)                         /* constant-address: 804061D5, symbol: None */
/* 800CB568  28 00 00 FF */	cmplwi r0, 0xff                         
/* 800CB56C  41 82 00 14 */	beq lbl_800CB580                         /* constant-address: 800CB580, symbol: lbl_800CB580 */
/* 800CB570  88 03 2F D1 */	lbz r0, 0x2fd1(r3)                      
/* 800CB574  28 00 00 00 */	cmplwi r0, 0                            
/* 800CB578  40 82 00 08 */	bne lbl_800CB580                         /* constant-address: 800CB580, symbol: lbl_800CB580 */
/* 800CB57C  38 C0 00 01 */	li r6, 1                                
lbl_800CB580:
/* 800CB580  54 C0 06 3F */	clrlwi. r0, r6, 0x18                    
/* 800CB584  41 82 00 14 */	beq lbl_800CB598                         /* constant-address: 800CB598, symbol: lbl_800CB598 */
/* 800CB588  80 03 05 78 */	lwz r0, 0x578(r3)                       
/* 800CB58C  74 00 04 08 */	andis. r0, r0, 0x408                    
/* 800CB590  40 82 00 08 */	bne lbl_800CB598                         /* constant-address: 800CB598, symbol: lbl_800CB598 */
/* 800CB594  38 A0 00 01 */	li r5, 1                                
lbl_800CB598:
/* 800CB598  54 A0 06 3F */	clrlwi. r0, r5, 0x18                    
/* 800CB59C  41 82 00 40 */	beq lbl_800CB5DC                         /* constant-address: 800CB5DC, symbol: lbl_800CB5DC */
/* 800CB5A0  3B C0 00 01 */	li r30, 1                               
/* 800CB5A4  80 03 05 74 */	lwz r0, 0x574(r3)                       
/* 800CB5A8  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 800CB5AC  41 82 00 24 */	beq lbl_800CB5D0                         /* constant-address: 800CB5D0, symbol: lbl_800CB5D0 */
/* 800CB5B0  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800CB5B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800CB5B8  38 63 07 F0 */	addi r3, r3, 0x7f0                       /* constant-address: 804069B0, symbol: None */
/* 800CB5BC  38 80 0C 08 */	li r4, 0xc08                            
/* 800CB5C0  4B F6 93 FD */	bl isEventBit__11dSv_event_cCFUs         /* constant-address: 800349BC, symbol: isEventBit__11dSv_event_cCFUs */
/* 800CB5C4  2C 03 00 00 */	cmpwi r3, 0                             
/* 800CB5C8  41 82 00 08 */	beq lbl_800CB5D0                         /* constant-address: 800CB5D0, symbol: lbl_800CB5D0 */
/* 800CB5CC  3B C0 00 00 */	li r30, 0                               
lbl_800CB5D0:
/* 800CB5D0  57 C0 06 3F */	clrlwi. r0, r30, 0x18                   
/* 800CB5D4  41 82 00 08 */	beq lbl_800CB5DC                         /* constant-address: 800CB5DC, symbol: lbl_800CB5DC */

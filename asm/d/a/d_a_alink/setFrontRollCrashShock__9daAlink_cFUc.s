...
/* 800C1D08  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800C1D0C  D0 21 00 18 */	stfs f1, 0x18(r1)                       
/* 800C1D10  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800C1D14  D0 01 00 1C */	stfs f0, 0x1c(r1)                       
/* 800C1D18  D0 21 00 20 */	stfs f1, 0x20(r1)                       
/* 800C1D1C  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800C1D20  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800C1D24  38 63 5B D4 */	addi r3, r3, 0x5bd4                      /* constant-address: 8040BD94, symbol: None */
/* 800C1D28  38 80 00 05 */	li r4, 5                                
/* 800C1D2C  38 A0 00 0F */	li r5, 0xf                              
/* 800C1D30  38 C1 00 18 */	addi r6, r1, 0x18                       
/* 800C1D34  4B FA DC F1 */	bl StartShock__12dVibration_cFii4cXyz    /* constant-address: 8006FA24, symbol: StartShock__12dVibration_cFii4cXyz */
/* 800C1D38  3C 60 00 02 */	lis r3, 0x0002 /* 0x00020016@ha */      
/* 800C1D3C  38 03 00 16 */	addi r0, r3, 0x0016 /* 0x00020016@l */   /* constant-address: 00020016 */
...
/* 800C1D54  48 20 1E 81 */	bl startLinkSound__14Z2CreatureLinkF10JAISoundIDUlSc /* constant-address: 802C3BD4, symbol: startLinkSound__14Z2CreatureLinkF10JAISoundIDUlSc */
...
/* 800C1D7C  41 82 00 0C */	beq lbl_800C1D88                         /* constant-address: 800C1D88, symbol: lbl_800C1D88 */
/* 800C1D80  80 BE 00 04 */	lwz r5, 4(r30)                          
/* 800C1D84  48 00 00 08 */	b lbl_800C1D8C                           /* constant-address: 800C1D8C, symbol: lbl_800C1D8C */
lbl_800C1D88:
/* 800C1D88  38 A0 FF FF */	li r5, -1                               
lbl_800C1D8C:
/* 800C1D8C  38 C0 00 05 */	li r6, 5                                
/* 800C1D90  48 0E 64 31 */	bl dKy_Sound_set__F4cXyziUii             /* constant-address: 801A81C0, symbol: dKy_Sound_set__F4cXyziUii */

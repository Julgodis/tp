...
/* 800B5C88  41 82 00 08 */	beq lbl_800B5C90                         /* constant-address: 800B5C90, symbol: lbl_800B5C90 */
/* 800B5C8C  38 80 00 03 */	li r4, 3                                
lbl_800B5C90:
/* 800B5C90  C0 22 92 C0 */	lfs f1, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 800B5C94  D0 21 00 08 */	stfs f1, 8(r1)                          
/* 800B5C98  C0 02 92 B8 */	lfs f0, lit_6040(r2)                     /* constant-address: 80452CB8, symbol: lit_6040 */
/* 800B5C9C  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 800B5CA0  D0 21 00 10 */	stfs f1, 0x10(r1)                       
/* 800B5CA4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 800B5CA8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 800B5CAC  38 63 5B D4 */	addi r3, r3, 0x5bd4                      /* constant-address: 8040BD94, symbol: None */
/* 800B5CB0  38 A0 00 0F */	li r5, 0xf                              
/* 800B5CB4  38 C1 00 08 */	addi r6, r1, 8                          
/* 800B5CB8  4B FB 9D 6D */	bl StartShock__12dVibration_cFii4cXyz    /* constant-address: 8006FA24, symbol: StartShock__12dVibration_cFii4cXyz */

...
/* 800F9D90 00000000  39 61 00 50 */	addi r11, r1, 0x50
/* 800F9D94 00000004  48 26 84 41 */	bl _savegpr_27
/* 800F9D98 00000008  7C 7F 1B 78 */	mr r31, r3
/* 800F9D9C 0000000C  7C 9B 23 78 */	mr r27, r4
/* 800F9DA0 00000010  7C BC 2B 78 */	mr r28, r5
/* 800F9DA4 00000014  7C DD 33 78 */	mr r29, r6
/* 800F9DA8 00000018  C3 E3 1F E0 */	lfs f31, 0x1fe0(r3)
/* 800F9DAC 0000001C  38 80 00 38 */	li r4, 0x38
/* 800F9DB0 00000020  4B FC 81 BD */	bl commonProcInit__9daAlink_cFQ29daAlink_c12daAlink_PROC
/* 800F9DB4 00000024  A8 1F 04 E6 */	lha r0, 0x4e6(r31)
/* 800F9DB8 00000028  B0 1F 04 DE */	sth r0, 0x4de(r31)
/* 800F9DBC 0000002C  38 00 00 0C */	li r0, 0xc
/* 800F9DC0 00000030  98 1F 2F 99 */	stb r0, 0x2f99(r31)
/* 800F9DC4 00000034  3C 60 80 39 */	lis r3, m__20daAlinkHIO_crouch_c0@ha
/* 800F9DC8 00000038  3B C3 E0 1C */	addi r30, r3, m__20daAlinkHIO_crouch_c0@l
/* 800F9DCC 0000003C  7F E3 FB 78 */	mr r3, r31
/* 800F9DD0 00000040  38 80 00 34 */	li r4, 0x34
/* 800F9DD4 00000044  C0 3E 00 18 */	lfs f1, 0x18(r30)	/* effective address: 8038E034 */
/* 800F9DD8 00000048  C0 5E 00 1C */	lfs f2, 0x1c(r30)	/* effective address: 8038E038 */
...
/* 800F9E38 00000000  4C 40 13 82 */	cror 2, 0, 2
/* 800F9E3C 00000004  40 82 00 14 */	bne lbl_800F9E50
/* 800F9E40 00000008  90 61 00 2C */	stw r3, 0x2c(r1)
/* 800F9E44 0000000C  90 01 00 28 */	stw r0, 0x28(r1)
/* 800F9E48 00000010  C8 01 00 28 */	lfd f0, 0x28(r1)
/* 800F9E4C 00000014  EF E0 08 28 */	fsubs f31, f0, f1
lbl_800F9E50:
...
/* 800F9EB4 00000008  48 00 00 08 */	b lbl_800F9EBC
lbl_800F9EB8:
...
/* 800F9EFC 00000040  C0 03 00 04 */	lfs f0, 4(r3)	/* effective address: 80420004 */
/* 800F9F00 00000044  D0 1F 35 8C */	stfs f0, 0x358c(r31)
/* 800F9F04 00000048  C0 03 00 08 */	lfs f0, 8(r3)	/* effective address: 80420008 */
...
/* 800F9F14 00000000  CB E1 00 50 */	lfd f31, 0x50(r1)
/* 800F9F18 00000004  39 61 00 50 */	addi r11, r1, 0x50
/* 800F9F1C 00000008  48 26 83 05 */	bl _restgpr_27
/* 800F9F20 0000000C  80 01 00 64 */	lwz r0, 0x64(r1)
/* 800F9F24 00000010  7C 08 03 A6 */	mtlr r0
/* 800F9F28 00000014  38 21 00 60 */	addi r1, r1, 0x60
/* 800F9F2C 00000018  4E 80 00 20 */	blr 

...
/* 80120DD0  48 24 13 F1 */	bl _savegpr_22                           /* constant-address: 803621C0, symbol: _savegpr_22 */
/* 80120DD4  7C 78 1B 78 */	mr r24, r3                              
/* 80120DD8  3C 60 80 39 */	lis r3, lit_3757@ha                     
/* 80120DDC  3B A3 D6 58 */	addi r29, r3, lit_3757@l                 /* constant-address: 8038D658, symbol: lit_3757 */
/* 80120DE0  3B 20 00 00 */	li r25, 0                               
/* 80120DE4  3A E0 00 00 */	li r23, 0                               
/* 80120DE8  3C 60 80 3B */	lis r3, m_typeFourData__8dPaPoF_c@ha    
/* 80120DEC  3B C3 86 D0 */	addi r30, r3, m_typeFourData__8dPaPoF_c@l /* constant-address: 803A86D0, symbol: m_typeFourData__8dPaPoF_c */
/* 80120DF0  3C 60 80 3B */	lis r3, m_emitterFourData__8dPaPoF_c@ha 
/* 80120DF4  3B E3 87 48 */	addi r31, r3, m_emitterFourData__8dPaPoF_c@l /* constant-address: 803A8748, symbol: m_emitterFourData__8dPaPoF_c */
lbl_80120DF8:
...
/* 80120E10  48 24 12 75 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 80120E14  60 00 00 00 */	nop                                     
/* 80120E18  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 80120E1C  40 82 00 A4 */	bne lbl_80120EC0                         /* constant-address: 80120EC0, symbol: lbl_80120EC0 */
...
/* 80120E30  48 24 12 55 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 80120E34  60 00 00 00 */	nop                                     
/* 80120E38  28 03 00 00 */	cmplwi r3, 0                            
/* 80120E3C  41 82 01 80 */	beq lbl_80120FBC                         /* constant-address: 80120FBC, symbol: lbl_80120FBC */
/* 80120E40  80 18 05 74 */	lwz r0, 0x574(r24)                      
/* 80120E44  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 80120E48  41 82 00 38 */	beq lbl_80120E80                         /* constant-address: 80120E80, symbol: lbl_80120E80 */
/* 80120E4C  38 9D 45 A8 */	addi r4, r29, 0x45a8                     /* constant-address: 80391C00, symbol: data_80391C00 */
/* 80120E50  E0 04 00 00 */	psq_l f0, 0(r4), 0, 0 /* qr0 */         
/* 80120E54  C0 44 00 08 */	lfs f2, 8(r4)                            /* constant-address: 80391C08, symbol: None */
...
/* 80120E7C  48 00 01 40 */	b lbl_80120FBC                           /* constant-address: 80120FBC, symbol: lbl_80120FBC */
lbl_80120E80:
/* 80120E80  C0 02 94 64 */	lfs f0, lit_14954(r2)                    /* constant-address: 80452E64, symbol: lit_14954 */
/* 80120E84  D0 03 00 28 */	stfs f0, 0x28(r3)                       
/* 80120E88  38 00 00 19 */	li r0, 0x19                             
/* 80120E8C  B0 03 00 54 */	sth r0, 0x54(r3)                        
/* 80120E90  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80120E94  D0 03 00 3C */	stfs f0, 0x3c(r3)                       
/* 80120E98  38 9D 45 90 */	addi r4, r29, 0x4590                     /* constant-address: 80391BE8, symbol: data_80391BE8 */
/* 80120E9C  E0 24 00 00 */	psq_l f1, 0(r4), 0, 0 /* qr0 */         
/* 80120EA0  C0 04 00 08 */	lfs f0, 8(r4)                            /* constant-address: 80391BF0, symbol: None */
...
/* 80120EBC  48 00 01 00 */	b lbl_80120FBC                           /* constant-address: 80120FBC, symbol: lbl_80120FBC */
lbl_80120EC0:
/* 80120EC0  28 00 00 01 */	cmplwi r0, 1                            
/* 80120EC4  40 82 00 84 */	bne lbl_80120F48                         /* constant-address: 80120F48, symbol: lbl_80120F48 */
...
/* 80120ED8  48 24 11 AD */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 80120EDC  60 00 00 00 */	nop                                     
/* 80120EE0  28 03 00 00 */	cmplwi r3, 0                            
/* 80120EE4  41 82 00 D8 */	beq lbl_80120FBC                         /* constant-address: 80120FBC, symbol: lbl_80120FBC */
/* 80120EE8  80 18 05 74 */	lwz r0, 0x574(r24)                      
/* 80120EEC  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 80120EF0  41 82 00 38 */	beq lbl_80120F28                         /* constant-address: 80120F28, symbol: lbl_80120F28 */
/* 80120EF4  38 9D 45 A8 */	addi r4, r29, 0x45a8                     /* constant-address: 80391C00, symbol: data_80391C00 */
/* 80120EF8  E0 04 00 00 */	psq_l f0, 0(r4), 0, 0 /* qr0 */         
/* 80120EFC  C0 44 00 08 */	lfs f2, 8(r4)                            /* constant-address: 80391C08, symbol: None */
...
/* 80120F24  48 00 00 98 */	b lbl_80120FBC                           /* constant-address: 80120FBC, symbol: lbl_80120FBC */
lbl_80120F28:
/* 80120F28  C0 22 93 8C */	lfs f1, lit_8783(r2)                     /* constant-address: 80452D8C, symbol: lit_8783 */
/* 80120F2C  D0 23 00 28 */	stfs f1, 0x28(r3)                       
/* 80120F30  38 00 00 19 */	li r0, 0x19                             
/* 80120F34  B0 03 00 54 */	sth r0, 0x54(r3)                        
/* 80120F38  C0 02 92 C0 */	lfs f0, lit_6108(r2)                     /* constant-address: 80452CC0, symbol: lit_6108 */
/* 80120F3C  D0 03 00 3C */	stfs f0, 0x3c(r3)                       
/* 80120F40  D0 23 00 38 */	stfs f1, 0x38(r3)                       
/* 80120F44  48 00 00 78 */	b lbl_80120FBC                           /* constant-address: 80120FBC, symbol: lbl_80120FBC */
lbl_80120F48:
/* 80120F48  28 00 00 02 */	cmplwi r0, 2                            
/* 80120F4C  40 82 00 70 */	bne lbl_80120FBC                         /* constant-address: 80120FBC, symbol: lbl_80120FBC */
/* 80120F50  80 18 05 74 */	lwz r0, 0x574(r24)                      
/* 80120F54  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 80120F58  41 82 00 64 */	beq lbl_80120FBC                         /* constant-address: 80120FBC, symbol: lbl_80120FBC */
/* 80120F5C  3A C0 00 00 */	li r22, 0                               
/* 80120F60  38 7D 45 9C */	addi r3, r29, 0x459c                     /* constant-address: 80391BF4, symbol: data_80391BF4 */
/* 80120F64  E3 C3 00 00 */	psq_l f30, 0(r3), 0, 0 /* qr0 */        
/* 80120F68  C3 E3 00 08 */	lfs f31, 8(r3)                           /* constant-address: 80391BFC, symbol: None */
lbl_80120F6C:
...
/* 80120F7C  48 24 11 09 */	bl __ptmf_scall                          /* constant-address: 80362084, symbol: __ptmf_scall */
/* 80120F80  60 00 00 00 */	nop                                     
/* 80120F84  28 03 00 00 */	cmplwi r3, 0                            
/* 80120F88  41 82 00 34 */	beq lbl_80120FBC                         /* constant-address: 80120FBC, symbol: lbl_80120FBC */
...
/* 80120FB0  3A D6 00 01 */	addi r22, r22, 1                         /* constant-address: 00000001 */
/* 80120FB4  2C 16 00 04 */	cmpwi r22, 4                            
/* 80120FB8  41 80 FF B4 */	blt lbl_80120F6C                         /* constant-address: 80120F6C, symbol: lbl_80120F6C */
lbl_80120FBC:
/* 80120FBC  3B 5A 00 01 */	addi r26, r26, 1                        
/* 80120FC0  2C 1A 00 02 */	cmpwi r26, 2                            
/* 80120FC4  41 80 FE 40 */	blt lbl_80120E04                         /* constant-address: 80120E04, symbol: lbl_80120E04 */
/* 80120FC8  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
/* 80120FCC  2C 19 00 05 */	cmpwi r25, 5                            
/* 80120FD0  3A F7 00 0C */	addi r23, r23, 0xc                       /* constant-address: 0000000C */
/* 80120FD4  41 80 FE 24 */	blt lbl_80120DF8                         /* constant-address: 80120DF8, symbol: lbl_80120DF8 */
...
/* 80120FEC  48 24 12 21 */	bl _restgpr_22                           /* constant-address: 8036220C, symbol: _restgpr_22 */

...
/* 8011D31C  4B FA 5A 89 */	bl commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC /* constant-address: 800C2DA4, symbol: commonProcInitNotSameProc__9daAlink_cFQ29daAlink_c12daAlink_PROC */
/* 8011D320  2C 03 00 00 */	cmpwi r3, 0                             
/* 8011D324  40 82 00 0C */	bne lbl_8011D330                         /* constant-address: 8011D330, symbol: lbl_8011D330 */
/* 8011D328  38 60 00 01 */	li r3, 1                                
/* 8011D32C  48 00 00 8C */	b lbl_8011D3B8                           /* constant-address: 8011D3B8, symbol: lbl_8011D3B8 */
lbl_8011D330:
/* 8011D330  80 1F 05 74 */	lwz r0, 0x574(r31)                      
/* 8011D334  54 00 01 8D */	rlwinm. r0, r0, 0, 6, 6                 
/* 8011D338  41 82 00 10 */	beq lbl_8011D348                         /* constant-address: 8011D348, symbol: lbl_8011D348 */
/* 8011D33C  38 00 00 01 */	li r0, 1                                
/* 8011D340  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8011D344  48 00 00 70 */	b lbl_8011D3B4                           /* constant-address: 8011D3B4, symbol: lbl_8011D3B4 */
lbl_8011D348:
/* 8011D348  7F E3 FB 78 */	mr r3, r31                              
/* 8011D34C  38 80 00 D2 */	li r4, 0xd2                             
/* 8011D350  4B F8 FF F1 */	bl setUpperAnimeBase__9daAlink_cFUs      /* constant-address: 800AD340, symbol: setUpperAnimeBase__9daAlink_cFUs */
...
/* 8011D36C  4B F9 27 3D */	bl setFacePriTexture__9daAlink_cFQ29daAlink_c13daAlink_FTANM /* constant-address: 800AFAA8, symbol: setFacePriTexture__9daAlink_cFQ29daAlink_c13daAlink_FTANM */
...
/* 8011D380  38 C6 FF FF */	addi r6, r6, 0xFFFF /* 0x0000FFFF@l */   /* constant-address: 0000FFFF */
/* 8011D384  4B F9 21 2D */	bl setFaceBck__9daAlink_cFUsiUs          /* constant-address: 800AF4B0, symbol: setFaceBck__9daAlink_cFUsiUs */
/* 8011D388  38 00 00 00 */	li r0, 0                                
/* 8011D38C  B0 1F 30 0C */	sth r0, 0x300c(r31)                     
/* 8011D390  C0 02 92 BC */	lfs f0, lit_6041(r2)                     /* constant-address: 80452CBC, symbol: lit_6041 */

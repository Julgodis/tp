...
/* 8014504C  48 21 D0 F1 */	bl _savefpr_27                           /* constant-address: 8036213C, symbol: _savefpr_27 */
...
/* 80145074  41 82 00 30 */	beq lbl_801450A4                         /* constant-address: 801450A4, symbol: lbl_801450A4 */
...
/* 80145090  40 82 00 14 */	bne lbl_801450A4                         /* constant-address: 801450A4, symbol: lbl_801450A4 */
/* 80145094  80 7F 05 80 */	lwz r3, 0x580(r31)                      
/* 80145098  D3 C3 00 0C */	stfs f30, 0xc(r3)                       
/* 8014509C  80 7F 05 80 */	lwz r3, 0x580(r31)                      
/* 801450A0  4B EC 83 89 */	bl play__14mDoExt_baseAnmFv              /* constant-address: 8000D428, symbol: play__14mDoExt_baseAnmFv */
lbl_801450A4:
/* 801450A4  80 1F 05 88 */	lwz r0, 0x588(r31)                      
/* 801450A8  28 00 00 00 */	cmplwi r0, 0                            
/* 801450AC  41 82 00 34 */	beq lbl_801450E0                         /* constant-address: 801450E0, symbol: lbl_801450E0 */
...
/* 801450CC  40 82 00 14 */	bne lbl_801450E0                         /* constant-address: 801450E0, symbol: lbl_801450E0 */
/* 801450D0  80 7F 05 88 */	lwz r3, 0x588(r31)                      
/* 801450D4  D3 E3 00 0C */	stfs f31, 0xc(r3)                       
/* 801450D8  80 7F 05 88 */	lwz r3, 0x588(r31)                      
/* 801450DC  4B EC 83 4D */	bl play__14mDoExt_baseAnmFv              /* constant-address: 8000D428, symbol: play__14mDoExt_baseAnmFv */
lbl_801450E0:
/* 801450E0  80 7F 05 78 */	lwz r3, 0x578(r31)                      
/* 801450E4  28 03 00 00 */	cmplwi r3, 0                            
/* 801450E8  41 82 00 10 */	beq lbl_801450F8                         /* constant-address: 801450F8, symbol: lbl_801450F8 */
/* 801450EC  D3 63 00 0C */	stfs f27, 0xc(r3)                       
/* 801450F0  80 7F 05 78 */	lwz r3, 0x578(r31)                      
/* 801450F4  4B EC 83 35 */	bl play__14mDoExt_baseAnmFv              /* constant-address: 8000D428, symbol: play__14mDoExt_baseAnmFv */
lbl_801450F8:
/* 801450F8  80 7F 05 7C */	lwz r3, 0x57c(r31)                      
/* 801450FC  28 03 00 00 */	cmplwi r3, 0                            
/* 80145100  41 82 00 10 */	beq lbl_80145110                         /* constant-address: 80145110, symbol: lbl_80145110 */
/* 80145104  D3 83 00 0C */	stfs f28, 0xc(r3)                       
/* 80145108  80 7F 05 7C */	lwz r3, 0x57c(r31)                      
/* 8014510C  4B EC 83 1D */	bl play__14mDoExt_baseAnmFv              /* constant-address: 8000D428, symbol: play__14mDoExt_baseAnmFv */
lbl_80145110:
/* 80145110  80 7F 05 84 */	lwz r3, 0x584(r31)                      
/* 80145114  28 03 00 00 */	cmplwi r3, 0                            
/* 80145118  41 82 00 10 */	beq lbl_80145128                         /* constant-address: 80145128, symbol: lbl_80145128 */
/* 8014511C  D3 A3 00 0C */	stfs f29, 0xc(r3)                       
/* 80145120  80 7F 05 84 */	lwz r3, 0x584(r31)                      
/* 80145124  4B EC 83 05 */	bl play__14mDoExt_baseAnmFv              /* constant-address: 8000D428, symbol: play__14mDoExt_baseAnmFv */
lbl_80145128:
/* 80145128  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8014512C  48 21 D0 5D */	bl _restfpr_27                           /* constant-address: 80362188, symbol: _restfpr_27 */

...
/* 800735F4  48 00 01 F1 */	bl LockonTruth__12dAttention_cFv         /* constant-address: 800737E4, symbol: LockonTruth__12dAttention_cFv */
/* 800735F8  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 800735FC  40 82 00 0C */	bne lbl_80073608                         /* constant-address: 80073608, symbol: lbl_80073608 */
/* 80073600  C0 22 8C 50 */	lfs f1, lit_4071(r2)                     /* constant-address: 80452650, symbol: lit_4071 */
/* 80073604  48 00 00 B0 */	b lbl_800736B4                           /* constant-address: 800736B4, symbol: lbl_800736B4 */
lbl_80073608:
...
/* 80073618  48 00 02 4D */	bl getActor__10dAttList_cFv              /* constant-address: 80073864, symbol: getActor__10dAttList_cFv */
/* 8007361C  7C 64 1B 79 */	or. r4, r3, r3                          
/* 80073620  40 82 00 0C */	bne lbl_8007362C                         /* constant-address: 8007362C, symbol: lbl_8007362C */
/* 80073624  C0 22 8C 50 */	lfs f1, lit_4071(r2)                     /* constant-address: 80452650, symbol: lit_4071 */
/* 80073628  48 00 00 8C */	b lbl_800736B4                           /* constant-address: 800736B4, symbol: lbl_800736B4 */
lbl_8007362C:
...
/* 80073650  48 1F 34 E5 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
/* 80073654  38 61 00 10 */	addi r3, r1, 0x10                       
/* 80073658  38 81 00 18 */	addi r4, r1, 0x18                       
/* 8007365C  48 1F E2 25 */	bl __ct__7cSGlobeFRC4cXyz                /* constant-address: 80271880, symbol: __ct__7cSGlobeFRC4cXyz */
...
/* 80073670  48 1F DB B9 */	bl __mi__7cSAngleCFs                     /* constant-address: 80271228, symbol: __mi__7cSAngleCFs */
/* 80073674  38 61 00 0C */	addi r3, r1, 0xc                        
/* 80073678  38 81 00 08 */	addi r4, r1, 8                          
/* 8007367C  48 1F D8 ED */	bl __ct__7cSAngleFRC7cSAngle             /* constant-address: 80270F68, symbol: __ct__7cSAngleFRC7cSAngle */
/* 80073680  1F FF 00 1C */	mulli r31, r31, 0x1c                    
/* 80073684  3C 60 80 3B */	lis r3, dist_table__12dAttention_c@ha   
/* 80073688  38 03 9C 70 */	addi r0, r3, dist_table__12dAttention_c@l /* constant-address: 803A9C70, symbol: dist_table__12dAttention_c */
/* 8007368C  7C 60 FA 14 */	add r3, r0, r31                         
/* 80073690  C0 23 00 08 */	lfs f1, 8(r3)                           
/* 80073694  A8 61 00 0C */	lha r3, 0xc(r1)                         
/* 80073698  C0 42 8C 58 */	lfs f2, lit_4073(r2)                     /* constant-address: 80452658, symbol: lit_4073 */
/* 8007369C  4B FF D5 A5 */	bl distace_angle_adjust__Ffsf            /* constant-address: 80070C40, symbol: distace_angle_adjust__Ffsf */
/* 800736A0  3C 60 80 3B */	lis r3, dist_table__12dAttention_c@ha   
/* 800736A4  38 03 9C 70 */	addi r0, r3, dist_table__12dAttention_c@l /* constant-address: 803A9C70, symbol: dist_table__12dAttention_c */

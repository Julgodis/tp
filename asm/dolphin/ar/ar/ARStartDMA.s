...
/* 80350600  4B FE D0 F5 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80350604  3C C0 CC 00 */	lis r6, 0xCC00 /* 0xCC005020@ha */      
/* 80350608  A0 06 50 20 */	lhz r0, 0x5020(r6)                       /* constant-address: CC005020 */
/* 8035060C  39 06 50 00 */	addi r8, r6, 0x5000                      /* constant-address: CC005000 */
/* 80350610  39 26 50 00 */	addi r9, r6, 0x5000                      /* constant-address: CC005000 */
/* 80350614  54 04 00 2A */	rlwinm r4, r0, 0, 0, 0x15               
/* 80350618  57 80 84 3E */	srwi r0, r28, 0x10                      
/* 8035061C  7C 80 03 78 */	or r0, r4, r0                           
/* 80350620  B0 06 50 20 */	sth r0, 0x5020(r6)                       /* constant-address: CC005020 */
/* 80350624  57 80 04 3E */	clrlwi r0, r28, 0x10                    
/* 80350628  38 86 50 00 */	addi r4, r6, 0x5000                      /* constant-address: CC005000 */
/* 8035062C  A0 A6 50 22 */	lhz r5, 0x5022(r6)                       /* constant-address: CC005022 */
/* 80350630  54 A5 06 DE */	rlwinm r5, r5, 0, 0x1b, 0xf             
/* 80350634  7C A0 03 78 */	or r0, r5, r0                           
/* 80350638  B0 06 50 22 */	sth r0, 0x5022(r6)                       /* constant-address: CC005022 */
/* 8035063C  38 A6 50 00 */	addi r5, r6, 0x5000                      /* constant-address: CC005000 */
/* 80350640  57 C0 84 3E */	srwi r0, r30, 0x10                      
/* 80350644  A0 C6 50 24 */	lhz r6, 0x5024(r6)                       /* constant-address: CC005024 */
/* 80350648  54 C6 00 2A */	rlwinm r6, r6, 0, 0, 0x15               
/* 8035064C  7C C0 03 78 */	or r0, r6, r0                           
/* 80350650  B0 08 00 24 */	sth r0, 0x24(r8)                         /* constant-address: CC005024 */
/* 80350654  57 C0 04 3E */	clrlwi r0, r30, 0x10                    
/* 80350658  A0 C9 00 26 */	lhz r6, 0x26(r9)                         /* constant-address: CC005026 */
/* 8035065C  54 C6 06 DE */	rlwinm r6, r6, 0, 0x1b, 0xf             
/* 80350660  7C C0 03 78 */	or r0, r6, r0                           
/* 80350664  B0 09 00 26 */	sth r0, 0x26(r9)                         /* constant-address: CC005026 */
/* 80350668  57 E6 84 3E */	srwi r6, r31, 0x10                      
/* 8035066C  57 E0 04 3E */	clrlwi r0, r31, 0x10                    
/* 80350670  A0 E4 00 28 */	lhz r7, 0x28(r4)                         /* constant-address: CC005028 */
/* 80350674  54 E7 04 5E */	rlwinm r7, r7, 0, 0x11, 0xf             
/* 80350678  53 A7 78 20 */	rlwimi r7, r29, 0xf, 0, 0x10            
/* 8035067C  B0 E4 00 28 */	sth r7, 0x28(r4)                         /* constant-address: CC005028 */
/* 80350680  A0 E4 00 28 */	lhz r7, 0x28(r4)                         /* constant-address: CC005028 */
/* 80350684  54 E7 00 2A */	rlwinm r7, r7, 0, 0, 0x15               
/* 80350688  7C E6 33 78 */	or r6, r7, r6                           
/* 8035068C  B0 C4 00 28 */	sth r6, 0x28(r4)                         /* constant-address: CC005028 */
/* 80350690  A0 85 00 2A */	lhz r4, 0x2a(r5)                         /* constant-address: CC00502A */
/* 80350694  54 84 06 DE */	rlwinm r4, r4, 0, 0x1b, 0xf             
/* 80350698  7C 80 03 78 */	or r0, r4, r0                           
/* 8035069C  B0 05 00 2A */	sth r0, 0x2a(r5)                         /* constant-address: CC00502A */
/* 803506A0  4B FE D0 7D */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

...
/* 8034DF0C  40 80 00 14 */	bge lbl_8034DF20                         /* constant-address: 8034DF20, symbol: lbl_8034DF20 */
/* 8034DF10  7C 00 30 00 */	cmpw r0, r6                             
/* 8034DF14  40 80 00 0C */	bge lbl_8034DF20                         /* constant-address: 8034DF20, symbol: lbl_8034DF20 */
/* 8034DF18  39 00 00 00 */	li r8, 0                                
/* 8034DF1C  48 00 00 18 */	b lbl_8034DF34                           /* constant-address: 8034DF34, symbol: lbl_8034DF34 */
lbl_8034DF20:
/* 8034DF20  2C 00 00 00 */	cmpwi r0, 0                             
/* 8034DF24  40 81 00 0C */	ble lbl_8034DF30                         /* constant-address: 8034DF30, symbol: lbl_8034DF30 */
/* 8034DF28  7D 06 00 50 */	subf r8, r6, r0                         
/* 8034DF2C  48 00 00 08 */	b lbl_8034DF34                           /* constant-address: 8034DF34, symbol: lbl_8034DF34 */
lbl_8034DF30:
/* 8034DF30  7D 00 32 14 */	add r8, r0, r6                          
lbl_8034DF34:
/* 8034DF34  7C 07 48 00 */	cmpw r7, r9                             
/* 8034DF38  40 80 00 14 */	bge lbl_8034DF4C                         /* constant-address: 8034DF4C, symbol: lbl_8034DF4C */
/* 8034DF3C  7C 09 30 00 */	cmpw r9, r6                             
/* 8034DF40  40 80 00 0C */	bge lbl_8034DF4C                         /* constant-address: 8034DF4C, symbol: lbl_8034DF4C */
/* 8034DF44  39 20 00 00 */	li r9, 0                                
/* 8034DF48  48 00 00 18 */	b lbl_8034DF60                           /* constant-address: 8034DF60, symbol: lbl_8034DF60 */
lbl_8034DF4C:
/* 8034DF4C  2C 09 00 00 */	cmpwi r9, 0                             
/* 8034DF50  40 81 00 0C */	ble lbl_8034DF5C                         /* constant-address: 8034DF5C, symbol: lbl_8034DF5C */
/* 8034DF54  7D 26 48 50 */	subf r9, r6, r9                         
/* 8034DF58  48 00 00 08 */	b lbl_8034DF60                           /* constant-address: 8034DF60, symbol: lbl_8034DF60 */
lbl_8034DF5C:
...
/* 8034DF78  40 80 01 04 */	bge lbl_8034E07C                         /* constant-address: 8034E07C, symbol: lbl_8034E07C */
/* 8034DF7C  6C A5 80 00 */	xoris r5, r5, 0x8000                    
/* 8034DF80  C8 E2 CB 78 */	lfd f7, lit_164(r2)                      /* constant-address: 80456578, symbol: lit_164 */
/* 8034DF84  90 A1 00 3C */	stw r5, 0x3c(r1)                        
/* 8034DF88  3C 00 43 30 */	lis r0, 0x4330                          
/* 8034DF8C  C0 02 CB 60 */	lfs f0, lit_160(r2)                      /* constant-address: 80456560, symbol: lit_160 */
...
/* 8034DFA0  40 81 00 B0 */	ble lbl_8034E050                         /* constant-address: 8034E050, symbol: lbl_8034E050 */
/* 8034DFA4  90 A1 00 3C */	stw r5, 0x3c(r1)                        
/* 8034DFA8  C8 C2 CB 68 */	lfd f6, lit_161(r2)                      /* constant-address: 80456568, symbol: lit_161 */
/* 8034DFAC  90 01 00 38 */	stw r0, 0x38(r1)                        
/* 8034DFB0  C8 A2 CB 70 */	lfd f5, lit_162(r2)                      /* constant-address: 80456570, symbol: lit_162 */
...
/* 8034E04C  48 00 00 14 */	b lbl_8034E060                           /* constant-address: 8034E060, symbol: lbl_8034E060 */
lbl_8034E050:

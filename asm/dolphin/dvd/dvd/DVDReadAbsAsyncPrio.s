...
/* 8034AD6C  80 0D 84 6C */	lwz r0, autoInvalidation(r13)            /* constant-address: 804509EC, symbol: autoInvalidation */
/* 8034AD70  2C 00 00 00 */	cmpwi r0, 0                             
/* 8034AD74  41 82 00 30 */	beq lbl_8034ADA4                         /* constant-address: 8034ADA4, symbol: lbl_8034ADA4 */
/* 8034AD78  80 7D 00 08 */	lwz r3, 8(r29)                          
/* 8034AD7C  28 03 00 01 */	cmplwi r3, 1                            
/* 8034AD80  41 82 00 18 */	beq lbl_8034AD98                         /* constant-address: 8034AD98, symbol: lbl_8034AD98 */
/* 8034AD84  38 03 FF FC */	addi r0, r3, -4                         
/* 8034AD88  28 00 00 01 */	cmplwi r0, 1                            
/* 8034AD8C  40 81 00 0C */	ble lbl_8034AD98                         /* constant-address: 8034AD98, symbol: lbl_8034AD98 */
/* 8034AD90  28 03 00 0E */	cmplwi r3, 0xe                          
/* 8034AD94  40 82 00 10 */	bne lbl_8034ADA4                         /* constant-address: 8034ADA4, symbol: lbl_8034ADA4 */
lbl_8034AD98:
/* 8034AD98  80 7D 00 18 */	lwz r3, 0x18(r29)                       
/* 8034AD9C  80 9D 00 14 */	lwz r4, 0x14(r29)                       
/* 8034ADA0  4B FF 07 E1 */	bl DCInvalidateRange                     /* constant-address: 8033B580, symbol: DCInvalidateRange */
lbl_8034ADA4:
/* 8034ADA4  4B FF 29 51 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8034ADBC  48 00 0A F1 */	bl __DVDPushWaitingQueue                 /* constant-address: 8034B8AC, symbol: __DVDPushWaitingQueue */
/* 8034ADC0  80 0D 91 F8 */	lwz r0, executing(r13)                   /* constant-address: 80451778, symbol: executing */
/* 8034ADC4  3B E3 00 00 */	addi r31, r3, 0                         
/* 8034ADC8  28 00 00 00 */	cmplwi r0, 0                            
/* 8034ADCC  40 82 00 14 */	bne lbl_8034ADE0                         /* constant-address: 8034ADE0, symbol: lbl_8034ADE0 */
/* 8034ADD0  80 0D 92 04 */	lwz r0, PauseFlag(r13)                   /* constant-address: 80451784, symbol: PauseFlag */
/* 8034ADD4  2C 00 00 00 */	cmpwi r0, 0                             
/* 8034ADD8  40 82 00 08 */	bne lbl_8034ADE0                         /* constant-address: 8034ADE0, symbol: lbl_8034ADE0 */
/* 8034ADDC  4B FF F2 D1 */	bl stateReady                            /* constant-address: 8034A0AC, symbol: stateReady */
lbl_8034ADE0:
/* 8034ADE0  7F C3 F3 78 */	mr r3, r30                              
/* 8034ADE4  4B FF 29 39 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

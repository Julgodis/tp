...
/* 80348C58  83 ED 91 E8 */	lwz r31, currentDirectory(r13)           /* constant-address: 80451768, symbol: currentDirectory */
/* 80348C5C  38 7F 00 00 */	addi r3, r31, 0                         
/* 80348C60  4B FF FD 1D */	bl entryToPath                           /* constant-address: 8034897C, symbol: entryToPath */
/* 80348C64  7C 03 F0 40 */	cmplw r3, r30                           
/* 80348C68  40 82 00 14 */	bne lbl_80348C7C                         /* constant-address: 80348C7C, symbol: lbl_80348C7C */
/* 80348C6C  38 00 00 00 */	li r0, 0                                
/* 80348C70  7C 7D F2 14 */	add r3, r29, r30                        
/* 80348C74  98 03 FF FF */	stb r0, -1(r3)                          
/* 80348C78  48 00 00 5C */	b lbl_80348CD4                           /* constant-address: 80348CD4, symbol: lbl_80348CD4 */
lbl_80348C7C:
/* 80348C7C  1C 1F 00 0C */	mulli r0, r31, 0xc                      
/* 80348C80  80 8D 91 DC */	lwz r4, FstStart(r13)                    /* constant-address: 8045175C, symbol: FstStart */
/* 80348C84  7C 04 00 2E */	lwzx r0, r4, r0                         
/* 80348C88  54 00 00 0F */	rlwinm. r0, r0, 0, 0, 7                 
/* 80348C8C  40 82 00 0C */	bne lbl_80348C98                         /* constant-address: 80348C98, symbol: lbl_80348C98 */
/* 80348C90  38 00 00 00 */	li r0, 0                                
/* 80348C94  48 00 00 08 */	b lbl_80348C9C                           /* constant-address: 80348C9C, symbol: lbl_80348C9C */
lbl_80348C98:
/* 80348C98  38 00 00 01 */	li r0, 1                                
lbl_80348C9C:
/* 80348C9C  2C 00 00 00 */	cmpwi r0, 0                             
/* 80348CA0  41 82 00 28 */	beq lbl_80348CC8                         /* constant-address: 80348CC8, symbol: lbl_80348CC8 */
/* 80348CA4  38 1E FF FF */	addi r0, r30, -1                        
/* 80348CA8  7C 03 00 40 */	cmplw r3, r0                            
/* 80348CAC  40 82 00 10 */	bne lbl_80348CBC                         /* constant-address: 80348CBC, symbol: lbl_80348CBC */
/* 80348CB0  38 00 00 00 */	li r0, 0                                
/* 80348CB4  7C 1D 19 AE */	stbx r0, r29, r3                        
/* 80348CB8  48 00 00 1C */	b lbl_80348CD4                           /* constant-address: 80348CD4, symbol: lbl_80348CD4 */
lbl_80348CBC:

...
/* 80348D7C  41 80 00 10 */	blt lbl_80348D8C                         /* constant-address: 80348D8C, symbol: lbl_80348D8C */
/* 80348D80  80 1A 00 34 */	lwz r0, 0x34(r26)                       
/* 80348D84  7C 1D 00 40 */	cmplw r29, r0                           
/* 80348D88  40 81 00 1C */	ble lbl_80348DA4                         /* constant-address: 80348DA4, symbol: lbl_80348DA4 */
lbl_80348D8C:
/* 80348D8C  3C 60 80 3D */	lis r3, lit_239@ha                      
/* 80348D90  4C C6 31 82 */	crclr 6                                 
/* 80348D94  38 A3 14 80 */	addi r5, r3, lit_239@l                   /* constant-address: 803D1480, symbol: lit_239 */
/* 80348D98  38 6D 84 60 */	la r3, lit_118(r13) /* 804509E0-_SDA_BASE_ */ /* constant-address: 804509E0, symbol: lit_118 */
/* 80348D9C  38 80 02 EE */	li r4, 0x2ee                            
/* 80348DA0  4B CB E0 DD */	bl OSPanic                               /* constant-address: 80006E7C, symbol: OSPanic */
lbl_80348DA4:
/* 80348DA4  7C 9D E2 15 */	add. r4, r29, r28                       
/* 80348DA8  41 80 00 14 */	blt lbl_80348DBC                         /* constant-address: 80348DBC, symbol: lbl_80348DBC */
/* 80348DAC  80 7A 00 34 */	lwz r3, 0x34(r26)                       
/* 80348DB0  38 03 00 20 */	addi r0, r3, 0x20                       
/* 80348DB4  7C 04 00 40 */	cmplw r4, r0                            
/* 80348DB8  41 80 00 1C */	blt lbl_80348DD4                         /* constant-address: 80348DD4, symbol: lbl_80348DD4 */
lbl_80348DBC:
/* 80348DBC  3C 60 80 3D */	lis r3, lit_239@ha                      
/* 80348DC0  4C C6 31 82 */	crclr 6                                 
/* 80348DC4  38 A3 14 80 */	addi r5, r3, lit_239@l                   /* constant-address: 803D1480, symbol: lit_239 */
/* 80348DC8  38 6D 84 60 */	la r3, lit_118(r13) /* 804509E0-_SDA_BASE_ */ /* constant-address: 804509E0, symbol: lit_118 */
/* 80348DCC  38 80 02 F4 */	li r4, 0x2f4                            
/* 80348DD0  4B CB E0 AD */	bl OSPanic                               /* constant-address: 80006E7C, symbol: OSPanic */
lbl_80348DD4:
/* 80348DD4  93 DA 00 38 */	stw r30, 0x38(r26)                      
/* 80348DD8  3C 60 80 35 */	lis r3, cbForReadAsync@ha               
/* 80348DDC  38 E3 8E 14 */	addi r7, r3, cbForReadAsync@l            /* constant-address: 80348E14, symbol: cbForReadAsync */
...
/* 80348DF8  48 00 1F 35 */	bl DVDReadAbsAsyncPrio                   /* constant-address: 8034AD2C, symbol: DVDReadAbsAsyncPrio */

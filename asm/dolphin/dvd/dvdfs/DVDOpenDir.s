...
/* 80348F9C  4B FF F5 8D */	bl DVDConvertPathToEntrynum              /* constant-address: 80348528, symbol: DVDConvertPathToEntrynum */
/* 80348FA0  2C 03 00 00 */	cmpwi r3, 0                             
/* 80348FA4  40 80 00 34 */	bge lbl_80348FD8                         /* constant-address: 80348FD8, symbol: lbl_80348FD8 */
/* 80348FA8  80 6D 91 E8 */	lwz r3, currentDirectory(r13)            /* constant-address: 80451768, symbol: currentDirectory */
/* 80348FAC  38 81 00 10 */	addi r4, r1, 0x10                       
/* 80348FB0  38 A0 00 80 */	li r5, 0x80                             
/* 80348FB4  4B FF FB 29 */	bl DVDConvertEntrynumToPath              /* constant-address: 80348ADC, symbol: DVDConvertEntrynumToPath */
/* 80348FB8  3C 60 80 3D */	lis r3, lit_311@ha                      
/* 80348FBC  4C C6 31 82 */	crclr 6                                 
/* 80348FC0  38 63 14 E4 */	addi r3, r3, lit_311@l                   /* constant-address: 803D14E4, symbol: lit_311 */
/* 80348FC4  38 9E 00 00 */	addi r4, r30, 0                         
/* 80348FC8  38 A1 00 10 */	addi r5, r1, 0x10                       
/* 80348FCC  4B CB DA F1 */	bl OSReport                              /* constant-address: 80006ABC, symbol: OSReport */
/* 80348FD0  38 60 00 00 */	li r3, 0                                
/* 80348FD4  48 00 00 54 */	b lbl_80349028                           /* constant-address: 80349028, symbol: lbl_80349028 */
lbl_80348FD8:
/* 80348FD8  1C A3 00 0C */	mulli r5, r3, 0xc                       
/* 80348FDC  80 8D 91 DC */	lwz r4, FstStart(r13)                    /* constant-address: 8045175C, symbol: FstStart */
/* 80348FE0  7C 04 28 2E */	lwzx r0, r4, r5                         
/* 80348FE4  54 00 00 0F */	rlwinm. r0, r0, 0, 0, 7                 
/* 80348FE8  40 82 00 0C */	bne lbl_80348FF4                         /* constant-address: 80348FF4, symbol: lbl_80348FF4 */
/* 80348FEC  38 00 00 00 */	li r0, 0                                
/* 80348FF0  48 00 00 08 */	b lbl_80348FF8                           /* constant-address: 80348FF8, symbol: lbl_80348FF8 */
lbl_80348FF4:
/* 80348FF4  38 00 00 01 */	li r0, 1                                
lbl_80348FF8:
/* 80348FF8  2C 00 00 00 */	cmpwi r0, 0                             
/* 80348FFC  40 82 00 0C */	bne lbl_80349008                         /* constant-address: 80349008, symbol: lbl_80349008 */
/* 80349000  38 60 00 00 */	li r3, 0                                
/* 80349004  48 00 00 24 */	b lbl_80349028                           /* constant-address: 80349028, symbol: lbl_80349028 */
lbl_80349008:
...
/* 80349018  80 0D 91 DC */	lwz r0, FstStart(r13)                    /* constant-address: 8045175C, symbol: FstStart */

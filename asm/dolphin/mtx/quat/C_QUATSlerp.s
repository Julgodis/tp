...
/* 8034756C  C0 02 CB 50 */	lfs f0, lit_130(r2)                      /* constant-address: 80456550, symbol: lit_130 */
/* 80347570  EC 66 01 72 */	fmuls f3, f6, f5                        
/* 80347574  C3 C2 CB 54 */	lfs f30, lit_133(r2)                     /* constant-address: 80456554, symbol: lit_133 */
/* 80347578  EC 22 08 2A */	fadds f1, f2, f1                        
/* 8034757C  EC 23 08 2A */	fadds f1, f3, f1                        
/* 80347580  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80347584  40 80 00 0C */	bge lbl_80347590                         /* constant-address: 80347590, symbol: lbl_80347590 */
/* 80347588  FC 20 08 50 */	fneg f1, f1                             
/* 8034758C  FF C0 F0 50 */	fneg f30, f30                           
lbl_80347590:
/* 80347590  C0 02 CB 5C */	lfs f0, lit_261(r2)                      /* constant-address: 8045655C, symbol: lit_261 */
/* 80347594  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80347598  4C 40 13 82 */	cror 2, 0, 2                            
/* 8034759C  40 82 00 3C */	bne lbl_803475D8                         /* constant-address: 803475D8, symbol: lbl_803475D8 */
/* 803475A0  48 02 54 91 */	bl acosf                                 /* constant-address: 8036CA30, symbol: acosf */
/* 803475A4  FF 60 08 90 */	fmr f27, f1                             
/* 803475A8  48 02 54 41 */	bl sinf                                  /* constant-address: 8036C9E8, symbol: sinf */
/* 803475AC  C0 02 CB 54 */	lfs f0, lit_133(r2)                      /* constant-address: 80456554, symbol: lit_133 */
/* 803475B0  FF 80 08 90 */	fmr f28, f1                             
/* 803475B4  EC 00 E8 28 */	fsubs f0, f0, f29                       
/* 803475B8  EC 20 06 F2 */	fmuls f1, f0, f27                       
/* 803475BC  48 02 54 2D */	bl sinf                                  /* constant-address: 8036C9E8, symbol: sinf */
/* 803475C0  EF E1 E0 24 */	fdivs f31, f1, f28                      
/* 803475C4  EC 3D 06 F2 */	fmuls f1, f29, f27                      
/* 803475C8  48 02 54 21 */	bl sinf                                  /* constant-address: 8036C9E8, symbol: sinf */
/* 803475CC  EC 01 E0 24 */	fdivs f0, f1, f28                       
/* 803475D0  EF DE 00 32 */	fmuls f30, f30, f0                      
/* 803475D4  48 00 00 10 */	b lbl_803475E4                           /* constant-address: 803475E4, symbol: lbl_803475E4 */
lbl_803475D8:
/* 803475D8  C0 02 CB 54 */	lfs f0, lit_133(r2)                      /* constant-address: 80456554, symbol: lit_133 */

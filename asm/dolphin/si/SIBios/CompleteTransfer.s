...
/* 80344C14  3B C3 64 00 */	addi r30, r3, 0x6400 /* 0xCC006400@l */  /* constant-address: CC006400 */
/* 80344C18  93 A1 00 14 */	stw r29, 0x14(r1)                       
/* 80344C1C  3B BE 00 34 */	addi r29, r30, 0x34                      /* constant-address: CC006434 */
/* 80344C20  93 81 00 10 */	stw r28, 0x10(r1)                       
/* 80344C24  80 03 64 34 */	lwz r0, 0x6434(r3)                       /* constant-address: CC006434 */
/* 80344C28  83 83 64 38 */	lwz r28, 0x6438(r3)                      /* constant-address: CC006438 */
/* 80344C2C  3C 60 80 3D */	lis r3, lit_1@ha                        
/* 80344C30  64 00 80 00 */	oris r0, r0, 0x8000                     
/* 80344C34  54 00 00 3C */	rlwinm r0, r0, 0, 0, 0x1e               
/* 80344C38  90 1E 00 34 */	stw r0, 0x34(r30)                        /* constant-address: CC006434 */
/* 80344C3C  3B E3 11 B8 */	addi r31, r3, lit_1@l                    /* constant-address: 803D11B8, symbol: lit_1 */
/* 80344C40  80 1F 00 44 */	lwz r0, 0x44(r31)                        /* constant-address: 803D11FC, symbol: Si */
/* 80344C44  2C 00 FF FF */	cmpwi r0, -1                            
/* 80344C48  41 82 02 74 */	beq lbl_80344EBC                         /* constant-address: 80344EBC, symbol: lbl_80344EBC */
/* 80344C4C  4B FF DA D1 */	bl __OSGetSystemTime                     /* constant-address: 8034271C, symbol: __OSGetSystemTime */
/* 80344C50  80 DF 00 44 */	lwz r6, 0x44(r31)                        /* constant-address: 803D11FC, symbol: Si */
/* 80344C54  3C A0 80 45 */	lis r5, XferTime@ha                     
/* 80344C58  38 05 C7 70 */	addi r0, r5, XferTime@l                  /* constant-address: 8044C770, symbol: XferTime */
/* 80344C5C  54 C5 18 38 */	slwi r5, r6, 3                          
/* 80344C60  7C A0 2A 14 */	add r5, r0, r5                          
/* 80344C64  90 85 00 04 */	stw r4, 4(r5)                           
/* 80344C68  38 DF 00 4C */	addi r6, r31, 0x4c                       /* constant-address: 803D1204, symbol: None */
/* 80344C6C  38 80 00 00 */	li r4, 0                                
/* 80344C70  90 65 00 00 */	stw r3, 0(r5)                           
/* 80344C74  80 1F 00 4C */	lwz r0, 0x4c(r31)                        /* constant-address: 803D1204, symbol: None */
/* 80344C78  80 BF 00 50 */	lwz r5, 0x50(r31)                        /* constant-address: 803D1208, symbol: None */
/* 80344C7C  54 07 F0 BE */	srwi r7, r0, 2                          
/* 80344C80  28 07 00 00 */	cmplwi r7, 0                            
/* 80344C84  40 81 00 A0 */	ble lbl_80344D24                         /* constant-address: 80344D24, symbol: lbl_80344D24 */
/* 80344C88  28 07 00 08 */	cmplwi r7, 8                            
/* 80344C8C  38 67 FF F8 */	addi r3, r7, -8                         
/* 80344C90  40 81 02 34 */	ble lbl_80344EC4                         /* constant-address: 80344EC4, symbol: lbl_80344EC4 */
...
/* 80344CA4  40 81 02 20 */	ble lbl_80344EC4                         /* constant-address: 80344EC4, symbol: lbl_80344EC4 */
lbl_80344CA8:
...
/* 80344CF4  42 00 FF B4 */	bdnz lbl_80344CA8                        /* constant-address: 80344CA8, symbol: lbl_80344CA8 */
/* 80344CF8  48 00 01 CC */	b lbl_80344EC4                           /* constant-address: 80344EC4, symbol: lbl_80344EC4 */
lbl_80344CFC:
/* 80344CFC  7C 04 38 50 */	subf r0, r4, r7                         
/* 80344D00  7C 04 38 40 */	cmplw r4, r7                            
/* 80344D04  7C 09 03 A6 */	mtctr r0                                
/* 80344D08  40 80 00 1C */	bge lbl_80344D24                         /* constant-address: 80344D24, symbol: lbl_80344D24 */
lbl_80344D0C:
...
/* 80344D20  42 00 FF EC */	bdnz lbl_80344D0C                        /* constant-address: 80344D0C, symbol: lbl_80344D0C */
lbl_80344D24:
/* 80344D24  80 06 00 00 */	lwz r0, 0(r6)                            /* constant-address: 803D1204, symbol: None */
/* 80344D28  54 03 07 BF */	clrlwi. r3, r0, 0x1e                    
/* 80344D2C  41 82 01 10 */	beq lbl_80344E3C                         /* constant-address: 80344E3C, symbol: lbl_80344E3C */
/* 80344D30  3C C0 CC 00 */	lis r6, 0xCC00 /* 0xCC006400@ha */      
/* 80344D34  38 C6 64 00 */	addi r6, r6, 0x6400 /* 0xCC006400@l */   /* constant-address: CC006400 */
...
/* 80344D48  40 81 00 F4 */	ble lbl_80344E3C                         /* constant-address: 80344E3C, symbol: lbl_80344E3C */
/* 80344D4C  28 03 00 08 */	cmplwi r3, 8                            
/* 80344D50  38 E3 FF F8 */	addi r7, r3, -8                         
/* 80344D54  40 81 00 BC */	ble lbl_80344E10                         /* constant-address: 80344E10, symbol: lbl_80344E10 */
...
/* 80344D68  40 81 00 A8 */	ble lbl_80344E10                         /* constant-address: 80344E10, symbol: lbl_80344E10 */
lbl_80344D6C:
...
/* 80344E0C  42 00 FF 60 */	bdnz lbl_80344D6C                        /* constant-address: 80344D6C, symbol: lbl_80344D6C */
lbl_80344E10:
/* 80344E10  7C 04 18 50 */	subf r0, r4, r3                         
/* 80344E14  7C 04 18 40 */	cmplw r4, r3                            
/* 80344E18  7C 09 03 A6 */	mtctr r0                                
/* 80344E1C  40 80 00 20 */	bge lbl_80344E3C                         /* constant-address: 80344E3C, symbol: lbl_80344E3C */
lbl_80344E20:
...
/* 80344E38  42 00 FF E8 */	bdnz lbl_80344E20                        /* constant-address: 80344E20, symbol: lbl_80344E20 */
lbl_80344E3C:
/* 80344E3C  80 1D 00 00 */	lwz r0, 0(r29)                           /* constant-address: CC006434 */
/* 80344E40  54 00 00 85 */	rlwinm. r0, r0, 0, 2, 2                 
/* 80344E44  41 82 00 4C */	beq lbl_80344E90                         /* constant-address: 80344E90, symbol: lbl_80344E90 */
/* 80344E48  80 7F 00 44 */	lwz r3, 0x44(r31)                        /* constant-address: 803D11FC, symbol: Si */
...
/* 80344E60  41 82 00 20 */	beq lbl_80344E80                         /* constant-address: 80344E80, symbol: lbl_80344E80 */
...
/* 80344E74  40 82 00 0C */	bne lbl_80344E80                         /* constant-address: 80344E80, symbol: lbl_80344E80 */
/* 80344E78  38 00 00 08 */	li r0, 8                                
/* 80344E7C  90 03 00 00 */	stw r0, 0(r3)                           
lbl_80344E80:
/* 80344E80  28 1C 00 00 */	cmplwi r28, 0                           
/* 80344E84  40 82 00 30 */	bne lbl_80344EB4                         /* constant-address: 80344EB4, symbol: lbl_80344EB4 */
/* 80344E88  3B 80 00 04 */	li r28, 4                               
/* 80344E8C  48 00 00 28 */	b lbl_80344EB4                           /* constant-address: 80344EB4, symbol: lbl_80344EB4 */
lbl_80344E90:
/* 80344E90  4B FF D8 8D */	bl __OSGetSystemTime                     /* constant-address: 8034271C, symbol: __OSGetSystemTime */
/* 80344E94  80 DF 00 44 */	lwz r6, 0x44(r31)                        /* constant-address: 803D11FC, symbol: Si */
/* 80344E98  3C A0 80 45 */	lis r5, TypeTime@ha                     
/* 80344E9C  38 05 C7 50 */	addi r0, r5, TypeTime@l                  /* constant-address: 8044C750, symbol: TypeTime */
...
/* 80344EB8  90 1F 00 44 */	stw r0, 0x44(r31)                        /* constant-address: 803D11FC, symbol: Si */
lbl_80344EBC:
/* 80344EBC  7F 83 E3 78 */	mr r3, r28                              
/* 80344EC0  48 00 00 18 */	b lbl_80344ED8                           /* constant-address: 80344ED8, symbol: lbl_80344ED8 */
lbl_80344EC4:
/* 80344EC4  3C 60 CC 00 */	lis r3, 0xCC00 /* 0xCC006400@ha */      
/* 80344EC8  54 80 10 3A */	slwi r0, r4, 2                          
/* 80344ECC  38 63 64 00 */	addi r3, r3, 0x6400 /* 0xCC006400@l */   /* constant-address: CC006400 */
/* 80344ED0  7C 63 02 14 */	add r3, r3, r0                          
/* 80344ED4  4B FF FE 28 */	b lbl_80344CFC                           /* constant-address: 80344CFC, symbol: lbl_80344CFC */
lbl_80344ED8:

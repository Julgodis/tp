...
/* 80345BA4  3A E3 C6 30 */	addi r23, r3, Packet@l                   /* constant-address: 8044C630, symbol: Packet */
...
/* 80345BCC  4B FF 7B 29 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80345BD0  80 16 00 00 */	lwz r0, 0(r22)                          
/* 80345BD4  3A A3 00 00 */	addi r21, r3, 0                          /* constant-address: 80450000, symbol: None */
/* 80345BD8  2C 00 FF FF */	cmpwi r0, -1                            
/* 80345BDC  40 82 00 14 */	bne lbl_80345BF0                         /* constant-address: 80345BF0, symbol: lbl_80345BF0 */
/* 80345BE0  3C 60 80 3D */	lis r3, Si@ha                           
/* 80345BE4  80 03 11 FC */	lwz r0, Si@l(r3)                         /* constant-address: 803D11FC, symbol: Si */
/* 80345BE8  7C 00 C0 00 */	cmpw r0, r24                            
/* 80345BEC  40 82 00 14 */	bne lbl_80345C00                         /* constant-address: 80345C00, symbol: lbl_80345C00 */
lbl_80345BF0:
/* 80345BF0  7E A3 AB 78 */	mr r3, r21                              
/* 80345BF4  4B FF 7B 29 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 80345BF8  38 60 00 00 */	li r3, 0                                
/* 80345BFC  48 00 00 E8 */	b lbl_80345CE4                           /* constant-address: 80345CE4, symbol: lbl_80345CE4 */
lbl_80345C00:
/* 80345C00  4B FF CB 1D */	bl __OSGetSystemTime                     /* constant-address: 8034271C, symbol: __OSGetSystemTime */
...
/* 80345C14  40 82 00 10 */	bne lbl_80345C24                         /* constant-address: 80345C24, symbol: lbl_80345C24 */
/* 80345C18  3A 64 00 00 */	addi r19, r4, 0                         
/* 80345C1C  3A 83 00 00 */	addi r20, r3, 0                          /* constant-address: 803D0000, symbol: None */
/* 80345C20  48 00 00 1C */	b lbl_80345C3C                           /* constant-address: 80345C3C, symbol: lbl_80345C3C */
lbl_80345C24:
...
/* 80345C54  41 82 00 30 */	beq lbl_80345C84                         /* constant-address: 80345C84, symbol: lbl_80345C84 */
...
/* 80345C6C  38 E4 5B 00 */	addi r7, r4, AlarmHandler@l              /* constant-address: 80345B00, symbol: AlarmHandler */
/* 80345C70  38 DE 00 00 */	addi r6, r30, 0                         
/* 80345C74  38 BF 00 00 */	addi r5, r31, 0                         
/* 80345C78  38 63 00 80 */	addi r3, r3, 0x80                       
/* 80345C7C  4B FF 4E DD */	bl OSSetAlarm                            /* constant-address: 8033AB58, symbol: OSSetAlarm */
/* 80345C80  48 00 00 38 */	b lbl_80345CB8                           /* constant-address: 80345CB8, symbol: lbl_80345CB8 */
lbl_80345C84:
...
/* 80345C9C  4B FF F8 AD */	bl __SITransfer                          /* constant-address: 80345548, symbol: __SITransfer */
/* 80345CA0  2C 03 00 00 */	cmpwi r3, 0                             
/* 80345CA4  41 82 00 14 */	beq lbl_80345CB8                         /* constant-address: 80345CB8, symbol: lbl_80345CB8 */
/* 80345CA8  7E A3 AB 78 */	mr r3, r21                              
/* 80345CAC  4B FF 7A 71 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 80345CB0  38 60 00 01 */	li r3, 1                                
/* 80345CB4  48 00 00 30 */	b lbl_80345CE4                           /* constant-address: 80345CE4, symbol: lbl_80345CE4 */
lbl_80345CB8:
...
/* 80345CDC  4B FF 7A 41 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

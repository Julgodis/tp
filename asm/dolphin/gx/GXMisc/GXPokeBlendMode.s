lbl_8035C3E4:
/* 8035C3E4  80 ED 93 A8 */	lwz r7, __peReg(r13)                     /* constant-address: 80451928, symbol: __peReg */
/* 8035C3E8  2C 03 00 01 */	cmpwi r3, 1                             
/* 8035C3EC  39 20 00 01 */	li r9, 1                                
/* 8035C3F0  A1 47 00 02 */	lhz r10, 2(r7)                          
/* 8035C3F4  41 82 00 10 */	beq lbl_8035C404                         /* constant-address: 8035C404, symbol: lbl_8035C404 */
/* 8035C3F8  2C 03 00 03 */	cmpwi r3, 3                             
/* 8035C3FC  41 82 00 08 */	beq lbl_8035C404                         /* constant-address: 8035C404, symbol: lbl_8035C404 */
/* 8035C400  39 20 00 00 */	li r9, 0                                
lbl_8035C404:
/* 8035C404  20 03 00 03 */	subfic r0, r3, 3                        
/* 8035C408  80 ED 93 A8 */	lwz r7, __peReg(r13)                     /* constant-address: 80451928, symbol: __peReg */

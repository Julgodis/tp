...
/* 8035BF38  80 62 CB 80 */	lwz r3, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035BF3C  88 03 05 AA */	lbz r0, 0x5aa(r3)                       
/* 8035BF40  28 00 00 00 */	cmplwi r0, 0                            
/* 8035BF44  41 82 00 B0 */	beq lbl_8035BFF4                         /* constant-address: 8035BFF4, symbol: lbl_8035BFF4 */
/* 8035BF48  4B FF EF 69 */	bl GXGetGPFifo                           /* constant-address: 8035AEB0, symbol: GXGetGPFifo */
/* 8035BF4C  28 03 00 00 */	cmplwi r3, 0                            
/* 8035BF50  41 82 00 A4 */	beq lbl_8035BFF4                         /* constant-address: 8035BFF4, symbol: lbl_8035BFF4 */
/* 8035BF54  80 6D 93 AC */	lwz r3, __memReg(r13)                    /* constant-address: 8045192C, symbol: __memReg */
...
/* 8035BF74  40 82 FF F0 */	bne lbl_8035BF64                         /* constant-address: 8035BF64, symbol: lbl_8035BF64 */
/* 8035BF78  54 80 80 1E */	slwi r0, r4, 0x10                       
/* 8035BF7C  7C 1B 1B 78 */	or r27, r0, r3                          
lbl_8035BF80:
/* 8035BF80  4B FE 67 7D */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
lbl_8035BF98:
/* 8035BF98  4B FE 67 65 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 8035BFB8  41 82 FF E0 */	beq lbl_8035BF98                         /* constant-address: 8035BF98, symbol: lbl_8035BF98 */
/* 8035BFBC  80 6D 93 AC */	lwz r3, __memReg(r13)                    /* constant-address: 8045192C, symbol: __memReg */
...
/* 8035BFDC  40 82 FF F0 */	bne lbl_8035BFCC                         /* constant-address: 8035BFCC, symbol: lbl_8035BFCC */
...
/* 8035BFF0  40 82 FF 90 */	bne lbl_8035BF80                         /* constant-address: 8035BF80, symbol: lbl_8035BF80 */
lbl_8035BFF4:
/* 8035BFF4  3C 60 CC 00 */	lis r3, 0xCC00 /* 0xCC003000@ha */      
/* 8035BFF8  38 00 00 01 */	li r0, 1                                
/* 8035BFFC  3B 63 30 00 */	addi r27, r3, 0x3000 /* 0xCC003000@l */  /* constant-address: CC003000 */
/* 8035C000  94 1B 00 18 */	stwu r0, 0x18(r27)                       /* constant-address: CC003018 */
/* 8035C004  4B FE 66 F9 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
/* 8035C008  38 00 00 00 */	li r0, 0                                
/* 8035C00C  3B E4 00 00 */	addi r31, r4, 0                         
/* 8035C010  3B C3 00 00 */	addi r30, r3, 0                          /* constant-address: CC000000 */
/* 8035C014  6C 1C 80 00 */	xoris r28, r0, 0x8000                   
/* 8035C018  3B A0 00 32 */	li r29, 0x32                            
lbl_8035C01C:
/* 8035C01C  4B FE 66 E1 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 8035C03C  41 82 FF E0 */	beq lbl_8035C01C                         /* constant-address: 8035C01C, symbol: lbl_8035C01C */
/* 8035C040  3B C0 00 00 */	li r30, 0                               
/* 8035C044  93 DB 00 00 */	stw r30, 0(r27)                          /* constant-address: CC003018 */
/* 8035C048  4B FE 66 B5 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
lbl_8035C05C:
/* 8035C05C  4B FE 66 A1 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 8035C07C  41 82 FF E0 */	beq lbl_8035C05C                         /* constant-address: 8035C05C, symbol: lbl_8035C05C */

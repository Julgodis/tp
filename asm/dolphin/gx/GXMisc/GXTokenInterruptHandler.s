...
/* 8035C53C  80 0D 93 E8 */	lwz r0, TokenCB(r13)                     /* constant-address: 80451968, symbol: TokenCB */
/* 8035C540  80 6D 93 A8 */	lwz r3, __peReg(r13)                     /* constant-address: 80451928, symbol: __peReg */
/* 8035C544  28 00 00 00 */	cmplwi r0, 0                            
/* 8035C548  A3 E3 00 0E */	lhz r31, 0xe(r3)                        
/* 8035C54C  41 82 00 34 */	beq lbl_8035C580                         /* constant-address: 8035C580, symbol: lbl_8035C580 */
/* 8035C550  38 61 00 10 */	addi r3, r1, 0x10                       
/* 8035C554  4B FD FA AD */	bl OSClearContext                        /* constant-address: 8033C000, symbol: OSClearContext */
/* 8035C558  38 61 00 10 */	addi r3, r1, 0x10                       
/* 8035C55C  4B FD F8 DD */	bl OSSetCurrentContext                   /* constant-address: 8033BE38, symbol: OSSetCurrentContext */
/* 8035C560  81 8D 93 E8 */	lwz r12, TokenCB(r13)                    /* constant-address: 80451968, symbol: TokenCB */
...
/* 8035C574  4B FD FA 8D */	bl OSClearContext                        /* constant-address: 8033C000, symbol: OSClearContext */
/* 8035C578  7F C3 F3 78 */	mr r3, r30                              
/* 8035C57C  4B FD F8 BD */	bl OSSetCurrentContext                   /* constant-address: 8033BE38, symbol: OSSetCurrentContext */
lbl_8035C580:
/* 8035C580  80 6D 93 A8 */	lwz r3, __peReg(r13)                     /* constant-address: 80451928, symbol: __peReg */

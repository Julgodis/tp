...
/* 8035CFB0  C0 02 CB A8 */	lfs f0, lit_179(r2)                      /* constant-address: 804565A8, symbol: lit_179 */
/* 8035CFB4  EC 20 08 24 */	fdivs f1, f0, f1                        
/* 8035CFB8  48 00 50 F5 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 8035CFBC  54 67 05 FE */	clrlwi r7, r3, 0x17                     
/* 8035CFC0  80 62 CB 80 */	lwz r3, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035CFC4  38 00 00 61 */	li r0, 0x61                             
/* 8035CFC8  3C 80 CC 01 */	lis r4, 0xCC01 /* 0xCC008000@ha */      
/* 8035CFCC  20 A7 01 00 */	subfic r5, r7, 0x100                    
/* 8035CFD0  98 04 80 00 */	stb r0, 0x8000(r4)                       /* constant-address: CC008000 */
...
/* 8035CFEC  90 C4 80 00 */	stw r6, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 8035D024  40 81 00 30 */	ble lbl_8035D054                         /* constant-address: 8035D054, symbol: lbl_8035D054 */
/* 8035D028  28 07 01 00 */	cmplwi r7, 0x100                        
/* 8035D02C  40 80 00 28 */	bge lbl_8035D054                         /* constant-address: 8035D054, symbol: lbl_8035D054 */
/* 8035D030  48 00 00 08 */	b lbl_8035D038                           /* constant-address: 8035D038, symbol: lbl_8035D038 */
lbl_8035D034:
/* 8035D034  54 84 F8 7E */	srwi r4, r4, 1                          
lbl_8035D038:
/* 8035D038  54 80 07 FF */	clrlwi. r0, r4, 0x1f                    
/* 8035D03C  41 82 FF F8 */	beq lbl_8035D034                         /* constant-address: 8035D034, symbol: lbl_8035D034 */
/* 8035D040  7C 05 23 96 */	divwu r0, r5, r4                        
/* 8035D044  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 8035D048  7C 00 28 51 */	subf. r0, r0, r5                        
/* 8035D04C  40 82 00 08 */	bne lbl_8035D054                         /* constant-address: 8035D054, symbol: lbl_8035D054 */
/* 8035D050  38 63 00 01 */	addi r3, r3, 1                          
lbl_8035D054:
/* 8035D054  28 03 04 00 */	cmplwi r3, 0x400                        
/* 8035D058  40 81 00 08 */	ble lbl_8035D060                         /* constant-address: 8035D060, symbol: lbl_8035D060 */

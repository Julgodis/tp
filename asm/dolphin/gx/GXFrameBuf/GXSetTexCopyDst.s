...
/* 8035CB58  80 E2 CB 80 */	lwz r7, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035CB5C  98 07 02 00 */	stb r0, 0x200(r7)                       
/* 8035CB60  38 E4 00 00 */	addi r7, r4, 0                          
/* 8035CB64  40 82 00 08 */	bne lbl_8035CB6C                         /* constant-address: 8035CB6C, symbol: lbl_8035CB6C */
/* 8035CB68  3B E0 00 0B */	li r31, 0xb                             
lbl_8035CB6C:
/* 8035CB6C  2C 05 00 26 */	cmpwi r5, 0x26                          
/* 8035CB70  41 82 00 1C */	beq lbl_8035CB8C                         /* constant-address: 8035CB8C, symbol: lbl_8035CB8C */
/* 8035CB74  40 80 00 30 */	bge lbl_8035CBA4                         /* constant-address: 8035CBA4, symbol: lbl_8035CBA4 */
/* 8035CB78  2C 05 00 04 */	cmpwi r5, 4                             
/* 8035CB7C  40 80 00 28 */	bge lbl_8035CBA4                         /* constant-address: 8035CBA4, symbol: lbl_8035CBA4 */
/* 8035CB80  2C 05 00 00 */	cmpwi r5, 0                             
/* 8035CB84  40 80 00 08 */	bge lbl_8035CB8C                         /* constant-address: 8035CB8C, symbol: lbl_8035CB8C */
/* 8035CB88  48 00 00 1C */	b lbl_8035CBA4                           /* constant-address: 8035CBA4, symbol: lbl_8035CBA4 */
lbl_8035CB8C:
/* 8035CB8C  80 82 CB 80 */	lwz r4, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035CBA0  48 00 00 18 */	b lbl_8035CBB8                           /* constant-address: 8035CBB8, symbol: lbl_8035CBB8 */
lbl_8035CBA4:
/* 8035CBA4  80 82 CB 80 */	lwz r4, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035CBBC  80 82 CB 80 */	lwz r4, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035CBF8  48 00 11 81 */	bl __GetImageTileCount                   /* constant-address: 8035DD78, symbol: __GetImageTileCount */
/* 8035CBFC  80 E2 CB 80 */	lwz r7, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */

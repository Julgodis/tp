...
/* 8035D0F4  41 82 00 F8 */	beq lbl_8035D1EC                         /* constant-address: 8035D1EC, symbol: lbl_8035D1EC */
...
/* 8035D1E8  48 00 00 24 */	b lbl_8035D20C                           /* constant-address: 8035D20C, symbol: lbl_8035D20C */
lbl_8035D1EC:
...
/* 8035D1FC  38 63 66 66 */	addi r3, r3, 0x6666 /* 0x01666666@l */   /* constant-address: 01666666 */
/* 8035D200  38 E7 66 66 */	addi r7, r7, 0x6666 /* 0x02666666@l */   /* constant-address: 02666666 */
/* 8035D204  39 08 66 66 */	addi r8, r8, 0x6666 /* 0x03666666@l */   /* constant-address: 03666666 */
/* 8035D208  39 24 66 66 */	addi r9, r4, 0x6666 /* 0x04666666@l */   /* constant-address: 04666666 */
lbl_8035D20C:
/* 8035D20C  39 40 00 61 */	li r10, 0x61                            
/* 8035D210  3C 80 CC 01 */	lis r4, 0xCC01 /* 0xCC008000@ha */      
/* 8035D214  99 44 80 00 */	stb r10, 0x8000(r4)                      /* constant-address: CC008000 */
/* 8035D218  54 A0 06 3F */	clrlwi. r0, r5, 0x18                    
/* 8035D21C  38 00 00 53 */	li r0, 0x53                             
/* 8035D220  90 64 80 00 */	stw r3, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035D224  38 60 00 00 */	li r3, 0                                
/* 8035D228  50 03 C0 0E */	rlwimi r3, r0, 0x18, 0, 7               
/* 8035D22C  99 44 80 00 */	stb r10, -0x8000(r4)                     /* constant-address: CC008000 */
/* 8035D230  38 00 00 54 */	li r0, 0x54                             
/* 8035D234  38 A0 00 00 */	li r5, 0                                
/* 8035D238  90 E4 80 00 */	stw r7, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035D23C  50 05 C0 0E */	rlwimi r5, r0, 0x18, 0, 7               
/* 8035D240  39 63 00 00 */	addi r11, r3, 0                         
/* 8035D244  99 44 80 00 */	stb r10, -0x8000(r4)                     /* constant-address: CC008000 */
/* 8035D248  38 05 00 00 */	addi r0, r5, 0                          
/* 8035D24C  91 04 80 00 */	stw r8, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035D250  99 44 80 00 */	stb r10, -0x8000(r4)                     /* constant-address: CC008000 */
/* 8035D254  91 24 80 00 */	stw r9, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035D258  41 82 00 40 */	beq lbl_8035D298                         /* constant-address: 8035D298, symbol: lbl_8035D298 */
...
/* 8035D294  48 00 00 2C */	b lbl_8035D2C0                           /* constant-address: 8035D2C0, symbol: lbl_8035D2C0 */
lbl_8035D298:
...
/* 8035D2C4  80 62 CB 80 */	lwz r3, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035D2C8  3C A0 CC 01 */	lis r5, 0xCC01 /* 0xCC008000@ha */      
/* 8035D2CC  98 C5 80 00 */	stb r6, 0x8000(r5)                       /* constant-address: CC008000 */
/* 8035D2D0  38 80 00 00 */	li r4, 0                                
/* 8035D2D4  91 65 80 00 */	stw r11, -0x8000(r5)                     /* constant-address: CC008000 */
/* 8035D2D8  98 C5 80 00 */	stb r6, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035D2DC  90 05 80 00 */	stw r0, -0x8000(r5)                      /* constant-address: CC008000 */

...
/* 8035CCF0  C0 02 CB A8 */	lfs f0, lit_179(r2)                      /* constant-address: 804565A8, symbol: lit_179 */
/* 8035CCF4  EC 20 08 24 */	fdivs f1, f0, f1                        
/* 8035CCF8  48 00 53 B5 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8035CD18  40 81 00 30 */	ble lbl_8035CD48                         /* constant-address: 8035CD48, symbol: lbl_8035CD48 */
/* 8035CD1C  28 04 01 00 */	cmplwi r4, 0x100                        
/* 8035CD20  40 80 00 28 */	bge lbl_8035CD48                         /* constant-address: 8035CD48, symbol: lbl_8035CD48 */
/* 8035CD24  48 00 00 08 */	b lbl_8035CD2C                           /* constant-address: 8035CD2C, symbol: lbl_8035CD2C */
lbl_8035CD28:
/* 8035CD28  54 84 F8 7E */	srwi r4, r4, 1                          
lbl_8035CD2C:
/* 8035CD2C  54 80 07 FF */	clrlwi. r0, r4, 0x1f                    
/* 8035CD30  41 82 FF F8 */	beq lbl_8035CD28                         /* constant-address: 8035CD28, symbol: lbl_8035CD28 */
/* 8035CD34  7C 05 23 96 */	divwu r0, r5, r4                        
/* 8035CD38  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 8035CD3C  7C 00 28 51 */	subf. r0, r0, r5                        
/* 8035CD40  40 82 00 08 */	bne lbl_8035CD48                         /* constant-address: 8035CD48, symbol: lbl_8035CD48 */
/* 8035CD44  38 63 00 01 */	addi r3, r3, 1                          
lbl_8035CD48:
/* 8035CD48  28 03 04 00 */	cmplwi r3, 0x400                        
/* 8035CD4C  40 81 00 08 */	ble lbl_8035CD54                         /* constant-address: 8035CD54, symbol: lbl_8035CD54 */

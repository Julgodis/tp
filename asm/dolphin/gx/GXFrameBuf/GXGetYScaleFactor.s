...
/* 8035CDB0  C8 62 CB B0 */	lfd f3, lit_234(r2)                      /* constant-address: 804565B0, symbol: lit_234 */
/* 8035CDB4  C8 41 00 30 */	lfd f2, 0x30(r1)                        
/* 8035CDB8  C8 21 00 28 */	lfd f1, 0x28(r1)                        
/* 8035CDBC  EC 42 18 28 */	fsubs f2, f2, f3                        
/* 8035CDC0  C0 02 CB A8 */	lfs f0, lit_179(r2)                      /* constant-address: 804565A8, symbol: lit_179 */
...
/* 8035CDD4  48 00 52 D9 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8035CDF0  40 81 00 30 */	ble lbl_8035CE20                         /* constant-address: 8035CE20, symbol: lbl_8035CE20 */
/* 8035CDF4  28 04 01 00 */	cmplwi r4, 0x100                        
/* 8035CDF8  40 80 00 28 */	bge lbl_8035CE20                         /* constant-address: 8035CE20, symbol: lbl_8035CE20 */
/* 8035CDFC  48 00 00 08 */	b lbl_8035CE04                           /* constant-address: 8035CE04, symbol: lbl_8035CE04 */
lbl_8035CE00:
/* 8035CE00  54 84 F8 7E */	srwi r4, r4, 1                          
lbl_8035CE04:
/* 8035CE04  54 80 07 FF */	clrlwi. r0, r4, 0x1f                    
/* 8035CE08  41 82 FF F8 */	beq lbl_8035CE00                         /* constant-address: 8035CE00, symbol: lbl_8035CE00 */
/* 8035CE0C  7C 1F 23 96 */	divwu r0, r31, r4                       
/* 8035CE10  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 8035CE14  7C 00 F8 51 */	subf. r0, r0, r31                       
/* 8035CE18  40 82 00 08 */	bne lbl_8035CE20                         /* constant-address: 8035CE20, symbol: lbl_8035CE20 */
/* 8035CE1C  38 63 00 01 */	addi r3, r3, 1                          
lbl_8035CE20:
/* 8035CE20  28 03 04 00 */	cmplwi r3, 0x400                        
/* 8035CE24  40 81 00 08 */	ble lbl_8035CE2C                         /* constant-address: 8035CE2C, symbol: lbl_8035CE2C */
/* 8035CE28  38 60 04 00 */	li r3, 0x400                            
lbl_8035CE2C:
/* 8035CE2C  CB E2 CB B0 */	lfd f31, lit_234(r2)                     /* constant-address: 804565B0, symbol: lit_234 */
/* 8035CE30  7C 60 1B 78 */	mr r0, r3                               
/* 8035CE34  C3 C2 CB A8 */	lfs f30, lit_179(r2)                     /* constant-address: 804565A8, symbol: lit_179 */
/* 8035CE38  57 3D 04 3E */	clrlwi r29, r25, 0x10                   
/* 8035CE3C  57 7A 04 3E */	clrlwi r26, r27, 0x10                   
/* 8035CE40  3F 20 43 30 */	lis r25, 0x4330                         
/* 8035CE44  48 00 00 88 */	b lbl_8035CECC                           /* constant-address: 8035CECC, symbol: lbl_8035CECC */
lbl_8035CE48:
...
/* 8035CE78  48 00 52 35 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8035CE8C  40 81 00 30 */	ble lbl_8035CEBC                         /* constant-address: 8035CEBC, symbol: lbl_8035CEBC */
/* 8035CE90  28 04 01 00 */	cmplwi r4, 0x100                        
/* 8035CE94  40 80 00 28 */	bge lbl_8035CEBC                         /* constant-address: 8035CEBC, symbol: lbl_8035CEBC */
/* 8035CE98  48 00 00 08 */	b lbl_8035CEA0                           /* constant-address: 8035CEA0, symbol: lbl_8035CEA0 */
lbl_8035CE9C:
/* 8035CE9C  54 84 F8 7E */	srwi r4, r4, 1                          
lbl_8035CEA0:
/* 8035CEA0  54 80 07 FF */	clrlwi. r0, r4, 0x1f                    
/* 8035CEA4  41 82 FF F8 */	beq lbl_8035CE9C                         /* constant-address: 8035CE9C, symbol: lbl_8035CE9C */
/* 8035CEA8  7C 1F 23 96 */	divwu r0, r31, r4                       
/* 8035CEAC  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 8035CEB0  7C 00 F8 51 */	subf. r0, r0, r31                       
/* 8035CEB4  40 82 00 08 */	bne lbl_8035CEBC                         /* constant-address: 8035CEBC, symbol: lbl_8035CEBC */
/* 8035CEB8  38 63 00 01 */	addi r3, r3, 1                          
lbl_8035CEBC:
/* 8035CEBC  28 03 04 00 */	cmplwi r3, 0x400                        
/* 8035CEC0  40 81 00 08 */	ble lbl_8035CEC8                         /* constant-address: 8035CEC8, symbol: lbl_8035CEC8 */
/* 8035CEC4  38 60 04 00 */	li r3, 0x400                            
lbl_8035CEC8:
/* 8035CEC8  7C 60 1B 78 */	mr r0, r3                               
lbl_8035CECC:
/* 8035CECC  7C 00 E8 40 */	cmplw r0, r29                           
/* 8035CED0  41 81 FF 78 */	bgt lbl_8035CE48                         /* constant-address: 8035CE48, symbol: lbl_8035CE48 */
/* 8035CED4  FF A0 E0 90 */	fmr f29, f28                            
/* 8035CED8  CB C2 CB B0 */	lfd f30, lit_234(r2)                     /* constant-address: 804565B0, symbol: lit_234 */
/* 8035CEDC  C3 E2 CB A8 */	lfs f31, lit_179(r2)                     /* constant-address: 804565A8, symbol: lit_179 */
/* 8035CEE0  57 7B 04 3E */	clrlwi r27, r27, 0x10                   
/* 8035CEE4  3F 40 43 30 */	lis r26, 0x4330                         
/* 8035CEE8  48 00 00 8C */	b lbl_8035CF74                           /* constant-address: 8035CF74, symbol: lbl_8035CF74 */
lbl_8035CEEC:
...
/* 8035CF20  48 00 51 8D */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
...
/* 8035CF34  40 81 00 30 */	ble lbl_8035CF64                         /* constant-address: 8035CF64, symbol: lbl_8035CF64 */
/* 8035CF38  28 04 01 00 */	cmplwi r4, 0x100                        
/* 8035CF3C  40 80 00 28 */	bge lbl_8035CF64                         /* constant-address: 8035CF64, symbol: lbl_8035CF64 */
/* 8035CF40  48 00 00 08 */	b lbl_8035CF48                           /* constant-address: 8035CF48, symbol: lbl_8035CF48 */
lbl_8035CF44:
/* 8035CF44  54 84 F8 7E */	srwi r4, r4, 1                          
lbl_8035CF48:
/* 8035CF48  54 80 07 FF */	clrlwi. r0, r4, 0x1f                    
/* 8035CF4C  41 82 FF F8 */	beq lbl_8035CF44                         /* constant-address: 8035CF44, symbol: lbl_8035CF44 */
/* 8035CF50  7C 1F 23 96 */	divwu r0, r31, r4                       
/* 8035CF54  7C 00 21 D6 */	mullw r0, r0, r4                        
/* 8035CF58  7C 00 F8 51 */	subf. r0, r0, r31                       
/* 8035CF5C  40 82 00 08 */	bne lbl_8035CF64                         /* constant-address: 8035CF64, symbol: lbl_8035CF64 */
/* 8035CF60  38 63 00 01 */	addi r3, r3, 1                          
lbl_8035CF64:
/* 8035CF64  28 03 04 00 */	cmplwi r3, 0x400                        
/* 8035CF68  40 81 00 08 */	ble lbl_8035CF70                         /* constant-address: 8035CF70, symbol: lbl_8035CF70 */
/* 8035CF6C  38 60 04 00 */	li r3, 0x400                            
lbl_8035CF70:
/* 8035CF70  7C 60 1B 78 */	mr r0, r3                               
lbl_8035CF74:
/* 8035CF74  7C 00 E8 40 */	cmplw r0, r29                           
/* 8035CF78  41 80 FF 74 */	blt lbl_8035CEEC                         /* constant-address: 8035CEEC, symbol: lbl_8035CEEC */

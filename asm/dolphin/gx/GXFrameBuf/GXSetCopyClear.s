...
/* 8035D088  80 A2 CB 80 */	lwz r5, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035D08C  50 06 44 2E */	rlwimi r6, r0, 8, 0x10, 0x17            
/* 8035D090  99 28 80 00 */	stb r9, 0x8000(r8)                       /* constant-address: CC008000 */
/* 8035D094  38 00 00 4F */	li r0, 0x4f                             
/* 8035D098  50 06 C0 0E */	rlwimi r6, r0, 0x18, 0, 7               
/* 8035D09C  90 C8 80 00 */	stw r6, -0x8000(r8)                      /* constant-address: CC008000 */
...
/* 8035D0C0  99 28 80 00 */	stb r9, -0x8000(r8)                      /* constant-address: CC008000 */
/* 8035D0C4  50 CB C0 0E */	rlwimi r11, r6, 0x18, 0, 7              
/* 8035D0C8  91 68 80 00 */	stw r11, -0x8000(r8)                     /* constant-address: CC008000 */
/* 8035D0CC  50 8A 02 3E */	rlwimi r10, r4, 0, 8, 0x1f              
/* 8035D0D0  50 0A C0 0E */	rlwimi r10, r0, 0x18, 0, 7              
/* 8035D0D4  99 28 80 00 */	stb r9, -0x8000(r8)                      /* constant-address: CC008000 */
/* 8035D0D8  38 00 00 00 */	li r0, 0                                
/* 8035D0DC  91 48 80 00 */	stw r10, -0x8000(r8)                     /* constant-address: CC008000 */

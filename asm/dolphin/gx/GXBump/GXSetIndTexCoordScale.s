...
/* 8035EEA8  41 82 00 AC */	beq lbl_8035EF54                         /* constant-address: 8035EF54, symbol: lbl_8035EF54 */
/* 8035EEAC  40 80 00 14 */	bge lbl_8035EEC0                         /* constant-address: 8035EEC0, symbol: lbl_8035EEC0 */
/* 8035EEB0  2C 03 00 00 */	cmpwi r3, 0                             
/* 8035EEB4  41 82 00 18 */	beq lbl_8035EECC                         /* constant-address: 8035EECC, symbol: lbl_8035EECC */
/* 8035EEB8  40 80 00 58 */	bge lbl_8035EF10                         /* constant-address: 8035EF10, symbol: lbl_8035EF10 */
/* 8035EEBC  48 00 01 1C */	b lbl_8035EFD8                           /* constant-address: 8035EFD8, symbol: lbl_8035EFD8 */
lbl_8035EEC0:
/* 8035EEC0  2C 03 00 04 */	cmpwi r3, 4                             
/* 8035EEC4  40 80 01 14 */	bge lbl_8035EFD8                         /* constant-address: 8035EFD8, symbol: lbl_8035EFD8 */
/* 8035EEC8  48 00 00 D0 */	b lbl_8035EF98                           /* constant-address: 8035EF98, symbol: lbl_8035EF98 */
lbl_8035EECC:
/* 8035EECC  81 02 CB 80 */	lwz r8, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035EF00  98 03 80 00 */	stb r0, 0x8000(r3)                       /* constant-address: CC008000 */
/* 8035EF04  80 08 01 28 */	lwz r0, 0x128(r8)                       
/* 8035EF08  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 8035EF0C  48 00 00 CC */	b lbl_8035EFD8                           /* constant-address: 8035EFD8, symbol: lbl_8035EFD8 */
lbl_8035EF10:
/* 8035EF10  81 02 CB 80 */	lwz r8, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035EF44  98 03 80 00 */	stb r0, 0x8000(r3)                       /* constant-address: CC008000 */
/* 8035EF48  80 08 01 28 */	lwz r0, 0x128(r8)                       
/* 8035EF4C  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 8035EF50  48 00 00 88 */	b lbl_8035EFD8                           /* constant-address: 8035EFD8, symbol: lbl_8035EFD8 */
lbl_8035EF54:
/* 8035EF54  81 02 CB 80 */	lwz r8, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035EF88  98 03 80 00 */	stb r0, 0x8000(r3)                       /* constant-address: CC008000 */
/* 8035EF8C  80 08 01 2C */	lwz r0, 0x12c(r8)                       
/* 8035EF90  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
/* 8035EF94  48 00 00 44 */	b lbl_8035EFD8                           /* constant-address: 8035EFD8, symbol: lbl_8035EFD8 */
lbl_8035EF98:
/* 8035EF98  81 02 CB 80 */	lwz r8, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035EFCC  98 03 80 00 */	stb r0, 0x8000(r3)                       /* constant-address: CC008000 */
/* 8035EFD0  80 08 01 2C */	lwz r0, 0x12c(r8)                       
/* 8035EFD4  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
lbl_8035EFD8:
/* 8035EFD8  80 62 CB 80 */	lwz r3, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */

...
/* 8035FAD0  41 82 00 E4 */	beq lbl_8035FBB4                         /* constant-address: 8035FBB4, symbol: lbl_8035FBB4 */
...
/* 8035FAF8  98 05 80 00 */	stb r0, 0x8000(r5)                       /* constant-address: CC008000 */
...
/* 8035FB10  91 05 80 00 */	stw r8, -0x8000(r5)                      /* constant-address: CC008000 */
...
/* 8035FB2C  98 05 80 00 */	stb r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035FB30  50 E8 62 26 */	rlwimi r8, r7, 0xc, 8, 0x13             
/* 8035FB34  50 C8 C0 0E */	rlwimi r8, r6, 0x18, 0, 7               
/* 8035FB38  91 05 80 00 */	stw r8, -0x8000(r5)                      /* constant-address: CC008000 */
...
/* 8035FB54  98 05 80 00 */	stb r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035FB58  50 E8 62 26 */	rlwimi r8, r7, 0xc, 8, 0x13             
/* 8035FB5C  50 C8 C0 0E */	rlwimi r8, r6, 0x18, 0, 7               
/* 8035FB60  91 05 80 00 */	stw r8, -0x8000(r5)                      /* constant-address: CC008000 */
...
/* 8035FB7C  98 05 80 00 */	stb r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035FB80  50 E8 62 26 */	rlwimi r8, r7, 0xc, 8, 0x13             
/* 8035FB84  50 C8 C0 0E */	rlwimi r8, r6, 0x18, 0, 7               
/* 8035FB88  91 05 80 00 */	stw r8, -0x8000(r5)                      /* constant-address: CC008000 */
...
/* 8035FBA4  98 05 80 00 */	stb r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035FBA8  50 E8 62 26 */	rlwimi r8, r7, 0xc, 8, 0x13             
/* 8035FBAC  50 C8 C0 0E */	rlwimi r8, r6, 0x18, 0, 7               
/* 8035FBB0  91 05 80 00 */	stw r8, -0x8000(r5)                      /* constant-address: CC008000 */
lbl_8035FBB4:
/* 8035FBB4  54 85 04 3E */	clrlwi r5, r4, 0x10                     
/* 8035FBB8  80 82 CB 80 */	lwz r4, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035FBD4  98 03 80 00 */	stb r0, 0x8000(r3)                       /* constant-address: CC008000 */
/* 8035FBD8  38 00 00 E8 */	li r0, 0xe8                             
/* 8035FBDC  50 05 C0 0E */	rlwimi r5, r0, 0x18, 0, 7               
/* 8035FBE0  90 A3 80 00 */	stw r5, -0x8000(r3)                      /* constant-address: CC008000 */

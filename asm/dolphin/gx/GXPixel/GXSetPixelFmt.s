...
/* 8035FD08  80 E2 CB 80 */	lwz r7, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035FD0C  54 66 10 3A */	slwi r6, r3, 2                          
/* 8035FD10  38 05 28 38 */	addi r0, r5, data_803D2838@l             /* constant-address: 803D2838, symbol: data_803D2838 */
...
/* 8035FD40  41 82 00 44 */	beq lbl_8035FD84                         /* constant-address: 8035FD84, symbol: lbl_8035FD84 */
/* 8035FD44  38 00 00 61 */	li r0, 0x61                             
/* 8035FD48  3C 80 CC 01 */	lis r4, 0xCC01 /* 0xCC008000@ha */      
/* 8035FD4C  98 04 80 00 */	stb r0, 0x8000(r4)                       /* constant-address: CC008000 */
/* 8035FD50  2C 03 00 02 */	cmpwi r3, 2                             
/* 8035FD54  90 A4 80 00 */	stw r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035FD58  40 82 00 0C */	bne lbl_8035FD64                         /* constant-address: 8035FD64, symbol: lbl_8035FD64 */
/* 8035FD5C  38 00 00 01 */	li r0, 1                                
/* 8035FD60  48 00 00 08 */	b lbl_8035FD68                           /* constant-address: 8035FD68, symbol: lbl_8035FD68 */
lbl_8035FD64:
/* 8035FD64  38 00 00 00 */	li r0, 0                                
lbl_8035FD68:
/* 8035FD68  80 A2 CB 80 */	lwz r5, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035FD8C  40 82 00 3C */	bne lbl_8035FDC8                         /* constant-address: 8035FDC8, symbol: lbl_8035FDC8 */
/* 8035FD90  80 C2 CB 80 */	lwz r6, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035FDBC  98 03 80 00 */	stb r0, 0x8000(r3)                       /* constant-address: CC008000 */
/* 8035FDC0  80 06 01 D4 */	lwz r0, 0x1d4(r6)                       
/* 8035FDC4  90 03 80 00 */	stw r0, -0x8000(r3)                      /* constant-address: CC008000 */
lbl_8035FDC8:
/* 8035FDC8  80 62 CB 80 */	lwz r3, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */

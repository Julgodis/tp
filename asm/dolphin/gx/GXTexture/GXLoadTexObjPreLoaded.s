...
/* 8035E29C  38 ED 85 20 */	la r7, GXTexImage0Ids(r13) /* 80450AA0-_SDA_BASE_ */ /* constant-address: 80450AA0, symbol: GXTexImage0Ids */
/* 8035E2A0  90 01 00 04 */	stw r0, 4(r1)                           
/* 8035E2A4  38 CD 85 28 */	la r6, GXTexImage1Ids(r13) /* 80450AA8-_SDA_BASE_ */ /* constant-address: 80450AA8, symbol: GXTexImage1Ids */
/* 8035E2A8  94 21 FF C0 */	stwu r1, -0x40(r1)                      
/* 8035E2AC  93 E1 00 3C */	stw r31, 0x3c(r1)                       
/* 8035E2B0  3B E5 00 00 */	addi r31, r5, 0                         
/* 8035E2B4  38 AD 85 10 */	la r5, GXTexMode0Ids(r13) /* 80450A90-_SDA_BASE_ */ /* constant-address: 80450A90, symbol: GXTexMode0Ids */
...
/* 8035E2D8  38 6D 85 18 */	la r3, GXTexMode1Ids(r13) /* 80450A98-_SDA_BASE_ */ /* constant-address: 80450A98, symbol: GXTexMode1Ids */
/* 8035E2DC  50 05 C0 0E */	rlwimi r5, r0, 0x18, 0, 7               
/* 8035E2E0  90 BE 00 00 */	stw r5, 0(r30)                          
/* 8035E2E4  38 AD 85 30 */	la r5, GXTexImage2Ids(r13) /* 80450AB0-_SDA_BASE_ */ /* constant-address: 80450AB0, symbol: GXTexImage2Ids */
/* 8035E2E8  7C 03 F8 AE */	lbzx r0, r3, r31                        
/* 8035E2EC  38 6D 85 38 */	la r3, GXTexImage3Ids(r13) /* 80450AB8-_SDA_BASE_ */ /* constant-address: 80450AB8, symbol: GXTexImage3Ids */
...
/* 8035E33C  9B 9D 80 00 */	stb r28, 0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E340  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 8035E344  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E348  9B 9D 80 00 */	stb r28, -0x8000(r29)                    /* constant-address: CC008000 */
/* 8035E34C  80 1E 00 04 */	lwz r0, 4(r30)                          
/* 8035E350  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E354  9B 9D 80 00 */	stb r28, -0x8000(r29)                    /* constant-address: CC008000 */
/* 8035E358  80 1E 00 08 */	lwz r0, 8(r30)                          
/* 8035E35C  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E360  9B 9D 80 00 */	stb r28, -0x8000(r29)                    /* constant-address: CC008000 */
/* 8035E364  80 04 00 00 */	lwz r0, 0(r4)                           
/* 8035E368  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E36C  9B 9D 80 00 */	stb r28, -0x8000(r29)                    /* constant-address: CC008000 */
/* 8035E370  80 04 00 04 */	lwz r0, 4(r4)                           
/* 8035E374  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E378  9B 9D 80 00 */	stb r28, -0x8000(r29)                    /* constant-address: CC008000 */
/* 8035E37C  80 1E 00 0C */	lwz r0, 0xc(r30)                        
/* 8035E380  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
/* 8035E384  88 1E 00 1F */	lbz r0, 0x1f(r30)                       
/* 8035E388  54 00 07 BD */	rlwinm. r0, r0, 0, 0x1e, 0x1e           
/* 8035E38C  40 82 00 38 */	bne lbl_8035E3C4                         /* constant-address: 8035E3C4, symbol: lbl_8035E3C4 */
/* 8035E390  80 82 CB 80 */	lwz r4, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035E3A4  38 8D 85 40 */	la r4, GXTexTlutIds(r13) /* 80450AC0-_SDA_BASE_ */ /* constant-address: 80450AC0, symbol: GXTexTlutIds */
...
/* 8035E3B8  9B 9D 80 00 */	stb r28, -0x8000(r29)                    /* constant-address: CC008000 */
/* 8035E3BC  80 03 00 04 */	lwz r0, 4(r3)                           
/* 8035E3C0  90 1D 80 00 */	stw r0, -0x8000(r29)                     /* constant-address: CC008000 */
lbl_8035E3C4:
/* 8035E3C4  80 A2 CB 80 */	lwz r5, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */

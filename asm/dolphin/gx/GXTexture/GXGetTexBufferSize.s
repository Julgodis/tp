...
/* 8035DC28  41 81 00 40 */	bgt lbl_8035DC68                         /* constant-address: 8035DC68, symbol: lbl_8035DC68 */
/* 8035DC2C  3D 00 80 3D */	lis r8, lit_104@ha                      
/* 8035DC30  39 08 25 98 */	addi r8, r8, lit_104@l                   /* constant-address: 803D2598, symbol: lit_104 */
...
/* 8035DC4C  48 00 00 24 */	b lbl_8035DC70                           /* constant-address: 8035DC70, symbol: lbl_8035DC70 */
/* 8035DC50  38 00 00 03 */	li r0, 3                                
/* 8035DC54  39 00 00 02 */	li r8, 2                                
/* 8035DC58  48 00 00 18 */	b lbl_8035DC70                           /* constant-address: 8035DC70, symbol: lbl_8035DC70 */
/* 8035DC5C  38 00 00 02 */	li r0, 2                                
/* 8035DC60  39 00 00 02 */	li r8, 2                                
/* 8035DC64  48 00 00 0C */	b lbl_8035DC70                           /* constant-address: 8035DC70, symbol: lbl_8035DC70 */
lbl_8035DC68:
/* 8035DC68  39 00 00 00 */	li r8, 0                                
/* 8035DC6C  38 00 00 00 */	li r0, 0                                
lbl_8035DC70:
/* 8035DC70  28 05 00 06 */	cmplwi r5, 6                            
/* 8035DC74  41 82 00 0C */	beq lbl_8035DC80                         /* constant-address: 8035DC80, symbol: lbl_8035DC80 */
/* 8035DC78  28 05 00 16 */	cmplwi r5, 0x16                         
/* 8035DC7C  40 82 00 0C */	bne lbl_8035DC88                         /* constant-address: 8035DC88, symbol: lbl_8035DC88 */
lbl_8035DC80:
/* 8035DC80  38 A0 00 40 */	li r5, 0x40                             
/* 8035DC84  48 00 00 08 */	b lbl_8035DC8C                           /* constant-address: 8035DC8C, symbol: lbl_8035DC8C */
lbl_8035DC88:
/* 8035DC88  38 A0 00 20 */	li r5, 0x20                             
lbl_8035DC8C:
/* 8035DC8C  54 C6 06 3E */	clrlwi r6, r6, 0x18                     
/* 8035DC90  28 06 00 01 */	cmplwi r6, 1                            
/* 8035DC94  40 82 00 A0 */	bne lbl_8035DD34                         /* constant-address: 8035DD34, symbol: lbl_8035DD34 */
...
/* 8035DCBC  40 81 00 AC */	ble lbl_8035DD68                         /* constant-address: 8035DD68, symbol: lbl_8035DD68 */
lbl_8035DCC0:
...
/* 8035DCE8  40 82 00 0C */	bne lbl_8035DCF4                         /* constant-address: 8035DCF4, symbol: lbl_8035DCF4 */
/* 8035DCEC  28 0C 00 01 */	cmplwi r12, 1                           
/* 8035DCF0  41 82 00 78 */	beq lbl_8035DD68                         /* constant-address: 8035DD68, symbol: lbl_8035DD68 */
lbl_8035DCF4:
/* 8035DCF4  54 63 04 3E */	clrlwi r3, r3, 0x10                     
/* 8035DCF8  28 03 00 01 */	cmplwi r3, 1                            
/* 8035DCFC  40 81 00 0C */	ble lbl_8035DD08                         /* constant-address: 8035DD08, symbol: lbl_8035DD08 */
/* 8035DD00  7D 66 0E 70 */	srawi r6, r11, 1                        
/* 8035DD04  48 00 00 08 */	b lbl_8035DD0C                           /* constant-address: 8035DD0C, symbol: lbl_8035DD0C */
lbl_8035DD08:
...
/* 8035DD18  40 81 00 0C */	ble lbl_8035DD24                         /* constant-address: 8035DD24, symbol: lbl_8035DD24 */
/* 8035DD1C  7D 84 0E 70 */	srawi r4, r12, 1                        
/* 8035DD20  48 00 00 08 */	b lbl_8035DD28                           /* constant-address: 8035DD28, symbol: lbl_8035DD28 */
lbl_8035DD24:
/* 8035DD24  38 80 00 01 */	li r4, 1                                
lbl_8035DD28:
/* 8035DD28  54 84 04 3E */	clrlwi r4, r4, 0x10                     
/* 8035DD2C  42 00 FF 94 */	bdnz lbl_8035DCC0                        /* constant-address: 8035DCC0, symbol: lbl_8035DCC0 */
/* 8035DD30  48 00 00 38 */	b lbl_8035DD68                           /* constant-address: 8035DD68, symbol: lbl_8035DD68 */
lbl_8035DD34:

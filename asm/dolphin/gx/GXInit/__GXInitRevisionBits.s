...
/* 803594D4  48 00 00 04 */	b lbl_803594D8                           /* constant-address: 803594D8, symbol: lbl_803594D8 */
lbl_803594D8:
...
/* 803594EC  48 00 00 04 */	b lbl_803594F0                           /* constant-address: 803594F0, symbol: lbl_803594F0 */
lbl_803594F0:
/* 803594F0  48 00 00 04 */	b lbl_803594F4                           /* constant-address: 803594F4, symbol: lbl_803594F4 */
lbl_803594F4:
/* 803594F4  81 22 CB 80 */	lwz r9, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 80359528  98 A4 80 00 */	stb r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035952C  98 64 80 00 */	stb r3, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 80359544  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 80359564  98 A4 80 00 */	stb r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 80359568  98 64 80 00 */	stb r3, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 80359580  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 803595A0  98 A4 80 00 */	stb r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 803595A4  98 64 80 00 */	stb r3, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 803595BC  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 803595D8  98 A4 80 00 */	stb r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 803595DC  98 64 80 00 */	stb r3, -0x8000(r4)                      /* constant-address: CC008000 */
/* 803595E0  7C 09 30 2E */	lwzx r0, r9, r6                         
/* 803595E4  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 803595E8  42 00 FF 0C */	bdnz lbl_803594F4                        /* constant-address: 803594F4, symbol: lbl_803594F4 */
...
/* 80359628  98 C5 80 00 */	stb r6, 0x8000(r5)                       /* constant-address: CC008000 */
/* 8035962C  38 00 10 00 */	li r0, 0x1000                           
/* 80359630  90 05 80 00 */	stw r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 80359634  50 67 2E B4 */	rlwimi r7, r3, 5, 0x1a, 0x1a            
/* 80359638  50 68 17 7A */	rlwimi r8, r3, 2, 0x1d, 0x1d            
/* 8035963C  90 E5 80 00 */	stw r7, -0x8000(r5)                      /* constant-address: CC008000 */
/* 80359640  38 80 10 12 */	li r4, 0x1012                           
/* 80359644  50 69 07 FE */	rlwimi r9, r3, 0, 0x1f, 0x1f            
/* 80359648  98 C5 80 00 */	stb r6, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035964C  50 68 1F 38 */	rlwimi r8, r3, 3, 0x1c, 0x1c            
/* 80359650  38 60 00 58 */	li r3, 0x58                             
/* 80359654  90 85 80 00 */	stw r4, -0x8000(r5)                      /* constant-address: CC008000 */
/* 80359658  38 00 00 61 */	li r0, 0x61                             
/* 8035965C  50 68 C0 0E */	rlwimi r8, r3, 0x18, 0, 7               
/* 80359660  91 25 80 00 */	stw r9, -0x8000(r5)                      /* constant-address: CC008000 */
/* 80359664  98 05 80 00 */	stb r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 80359668  91 05 80 00 */	stw r8, -0x8000(r5)                      /* constant-address: CC008000 */

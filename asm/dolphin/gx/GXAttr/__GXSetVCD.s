...
/* 8035B3B0  80 82 CB 80 */	lwz r4, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
/* 8035B3B4  3C A0 CC 01 */	lis r5, 0xCC01 /* 0xCC008000@ha */      
/* 8035B3B8  98 C5 80 00 */	stb r6, 0x8000(r5)                       /* constant-address: CC008000 */
/* 8035B3BC  38 60 00 50 */	li r3, 0x50                             
/* 8035B3C0  38 00 00 60 */	li r0, 0x60                             
/* 8035B3C4  98 65 80 00 */	stb r3, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035B3C8  80 64 00 14 */	lwz r3, 0x14(r4)                        
/* 8035B3CC  90 65 80 00 */	stw r3, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035B3D0  98 C5 80 00 */	stb r6, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035B3D4  98 05 80 00 */	stb r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035B3D8  80 04 00 18 */	lwz r0, 0x18(r4)                        
/* 8035B3DC  90 05 80 00 */	stw r0, -0x8000(r5)                      /* constant-address: CC008000 */
/* 8035B3E0  88 04 04 D5 */	lbz r0, 0x4d5(r4)                       
/* 8035B3E4  28 00 00 00 */	cmplwi r0, 0                            
/* 8035B3E8  41 82 00 0C */	beq lbl_8035B3F4                         /* constant-address: 8035B3F4, symbol: lbl_8035B3F4 */
/* 8035B3EC  38 E0 00 02 */	li r7, 2                                
/* 8035B3F0  48 00 00 1C */	b lbl_8035B40C                           /* constant-address: 8035B40C, symbol: lbl_8035B40C */
lbl_8035B3F4:
/* 8035B3F4  88 04 04 D4 */	lbz r0, 0x4d4(r4)                       
/* 8035B3F8  28 00 00 00 */	cmplwi r0, 0                            
/* 8035B3FC  41 82 00 0C */	beq lbl_8035B408                         /* constant-address: 8035B408, symbol: lbl_8035B408 */
/* 8035B400  38 E0 00 01 */	li r7, 1                                
/* 8035B404  48 00 00 08 */	b lbl_8035B40C                           /* constant-address: 8035B40C, symbol: lbl_8035B40C */
lbl_8035B408:
/* 8035B408  38 E0 00 00 */	li r7, 0                                
lbl_8035B40C:
/* 8035B40C  80 A2 CB 80 */	lwz r5, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */
...
/* 8035B428  98 04 80 00 */	stb r0, 0x8000(r4)                       /* constant-address: CC008000 */
...
/* 8035B440  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
...
/* 8035B458  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */

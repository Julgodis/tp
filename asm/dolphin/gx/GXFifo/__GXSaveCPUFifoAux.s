...
/* 8035AAD4  4B FE 2C 21 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8035AAD8  80 8D 93 A0 */	lwz r4, __piReg(r13)                     /* constant-address: 80451920, symbol: __piReg */
/* 8035AADC  80 84 00 0C */	lwz r4, 0xc(r4)                         
/* 8035AAE0  3C 04 80 00 */	addis r0, r4, 0x8000                    
/* 8035AAE4  90 1F 00 00 */	stw r0, 0(r31)                          
/* 8035AAE8  80 8D 93 A0 */	lwz r4, __piReg(r13)                     /* constant-address: 80451920, symbol: __piReg */
/* 8035AAEC  80 84 00 10 */	lwz r4, 0x10(r4)                        
/* 8035AAF0  3C 04 80 00 */	addis r0, r4, 0x8000                    
/* 8035AAF4  90 1F 00 04 */	stw r0, 4(r31)                          
/* 8035AAF8  80 8D 93 A0 */	lwz r4, __piReg(r13)                     /* constant-address: 80451920, symbol: __piReg */
...
/* 8035AB0C  88 0D 93 D4 */	lbz r0, data_80451954(r13)               /* constant-address: 80451954, symbol: data_80451954 */
/* 8035AB10  28 00 00 00 */	cmplwi r0, 0                            
/* 8035AB14  41 82 00 34 */	beq lbl_8035AB48                         /* constant-address: 8035AB48, symbol: lbl_8035AB48 */
/* 8035AB18  80 8D 93 A4 */	lwz r4, __cpReg(r13)                     /* constant-address: 80451924, symbol: __cpReg */
...
/* 8035AB30  80 8D 93 A4 */	lwz r4, __cpReg(r13)                     /* constant-address: 80451924, symbol: __cpReg */
...
/* 8035AB44  48 00 00 2C */	b lbl_8035AB70                           /* constant-address: 8035AB70, symbol: lbl_8035AB70 */
lbl_8035AB48:
...
/* 8035AB60  40 80 00 10 */	bge lbl_8035AB70                         /* constant-address: 8035AB70, symbol: lbl_8035AB70 */
/* 8035AB64  80 1F 00 08 */	lwz r0, 8(r31)                          
/* 8035AB68  7C 04 02 14 */	add r0, r4, r0                          
/* 8035AB6C  90 1F 00 1C */	stw r0, 0x1c(r31)                       
lbl_8035AB70:
/* 8035AB70  4B FE 2B AD */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

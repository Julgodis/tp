...
/* 8035AD6C  48 00 01 45 */	bl GXGetGPFifo                           /* constant-address: 8035AEB0, symbol: GXGetGPFifo */
/* 8035AD70  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8035AD74  41 82 00 C4 */	beq lbl_8035AE38                         /* constant-address: 8035AE38, symbol: lbl_8035AE38 */
/* 8035AD78  48 00 01 31 */	bl GXGetCPUFifo                          /* constant-address: 8035AEA8, symbol: GXGetCPUFifo */
...
/* 8035ADA4  42 00 FF F0 */	bdnz lbl_8035AD94                        /* constant-address: 8035AD94, symbol: lbl_8035AD94 */
/* 8035ADA8  4B FE 29 4D */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8035ADC4  40 80 00 10 */	bge lbl_8035ADD4                         /* constant-address: 8035ADD4, symbol: lbl_8035ADD4 */
/* 8035ADC8  80 01 00 1C */	lwz r0, 0x1c(r1)                        
/* 8035ADCC  7C 04 02 14 */	add r0, r4, r0                          
/* 8035ADD0  90 01 00 30 */	stw r0, 0x30(r1)                        
lbl_8035ADD4:
/* 8035ADD4  4B FE 29 49 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8035ADD8  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8035ADDC  4B FF FB 11 */	bl GXSetGPFifo                           /* constant-address: 8035A8EC, symbol: GXSetGPFifo */
/* 8035ADE0  7C 1E F8 40 */	cmplw r30, r31                          
/* 8035ADE4  40 82 00 0C */	bne lbl_8035ADF0                         /* constant-address: 8035ADF0, symbol: lbl_8035ADF0 */
/* 8035ADE8  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8035ADEC  4B FF F9 D9 */	bl GXSetCPUFifo                          /* constant-address: 8035A7C4, symbol: GXSetCPUFifo */
lbl_8035ADF0:
/* 8035ADF0  4B FE 29 05 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8035AE0C  40 80 00 10 */	bge lbl_8035AE1C                         /* constant-address: 8035AE1C, symbol: lbl_8035AE1C */
/* 8035AE10  80 1F 00 08 */	lwz r0, 8(r31)                          
/* 8035AE14  7C 04 02 14 */	add r0, r4, r0                          
/* 8035AE18  90 1F 00 1C */	stw r0, 0x1c(r31)                       
lbl_8035AE1C:
/* 8035AE1C  4B FE 29 01 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8035AE20  7F E3 FB 78 */	mr r3, r31                              
/* 8035AE24  4B FF FA C9 */	bl GXSetGPFifo                           /* constant-address: 8035A8EC, symbol: GXSetGPFifo */
/* 8035AE28  7C 1E F8 40 */	cmplw r30, r31                          
/* 8035AE2C  40 82 00 0C */	bne lbl_8035AE38                         /* constant-address: 8035AE38, symbol: lbl_8035AE38 */
/* 8035AE30  7F C3 F3 78 */	mr r3, r30                              
/* 8035AE34  4B FF F9 91 */	bl GXSetCPUFifo                          /* constant-address: 8035A7C4, symbol: GXSetCPUFifo */
lbl_8035AE38:

...
/* 8035DB8C  40 82 00 08 */	bne lbl_8035DB94                         /* constant-address: 8035DB94, symbol: lbl_8035DB94 */
...
/* 8035DBC4  98 A4 80 00 */	stb r5, 0x8000(r4)                       /* constant-address: CC008000 */
/* 8035DBC8  38 0B 10 0E */	addi r0, r11, 0x100e                    
/* 8035DBCC  50 EA 3C 68 */	rlwimi r10, r7, 7, 0x11, 0x14           
/* 8035DBD0  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035DBD4  2C 03 00 04 */	cmpwi r3, 4                             
/* 8035DBD8  91 44 80 00 */	stw r10, -0x8000(r4)                     /* constant-address: CC008000 */
/* 8035DBDC  40 82 00 18 */	bne lbl_8035DBF4                         /* constant-address: 8035DBF4, symbol: lbl_8035DBF4 */
/* 8035DBE0  98 A4 80 00 */	stb r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035DBE4  38 00 10 10 */	li r0, 0x1010                           
/* 8035DBE8  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035DBEC  91 44 80 00 */	stw r10, -0x8000(r4)                     /* constant-address: CC008000 */
/* 8035DBF0  48 00 00 1C */	b lbl_8035DC0C                           /* constant-address: 8035DC0C, symbol: lbl_8035DC0C */
lbl_8035DBF4:
/* 8035DBF4  2C 03 00 05 */	cmpwi r3, 5                             
/* 8035DBF8  40 82 00 14 */	bne lbl_8035DC0C                         /* constant-address: 8035DC0C, symbol: lbl_8035DC0C */
/* 8035DBFC  98 A4 80 00 */	stb r5, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035DC00  38 00 10 11 */	li r0, 0x1011                           
/* 8035DC04  90 04 80 00 */	stw r0, -0x8000(r4)                      /* constant-address: CC008000 */
/* 8035DC08  91 44 80 00 */	stw r10, -0x8000(r4)                     /* constant-address: CC008000 */
lbl_8035DC0C:
/* 8035DC0C  80 62 CB 80 */	lwz r3, __GXData(r2)                     /* constant-address: 80456580, symbol: __GXData */

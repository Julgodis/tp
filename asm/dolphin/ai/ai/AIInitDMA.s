...
/* 8034FCD0  4B FE DA 25 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8034FCD4  3C 80 CC 00 */	lis r4, 0xCC00 /* 0xCC005030@ha */      
/* 8034FCD8  A0 04 50 30 */	lhz r0, 0x5030(r4)                       /* constant-address: CC005030 */
/* 8034FCDC  38 A4 50 00 */	addi r5, r4, 0x5000                      /* constant-address: CC005000 */
/* 8034FCE0  38 C4 50 00 */	addi r6, r4, 0x5000                      /* constant-address: CC005000 */
/* 8034FCE4  38 E4 50 00 */	addi r7, r4, 0x5000                      /* constant-address: CC005000 */
/* 8034FCE8  54 04 00 2A */	rlwinm r4, r0, 0, 0, 0x15               
/* 8034FCEC  57 C0 84 3E */	srwi r0, r30, 0x10                      
/* 8034FCF0  7C 80 03 78 */	or r0, r4, r0                           
/* 8034FCF4  B0 05 00 30 */	sth r0, 0x30(r5)                         /* constant-address: CC005030 */
/* 8034FCF8  57 C0 04 3E */	clrlwi r0, r30, 0x10                    
/* 8034FCFC  A0 86 00 32 */	lhz r4, 0x32(r6)                         /* constant-address: CC005032 */
/* 8034FD00  54 84 06 DE */	rlwinm r4, r4, 0, 0x1b, 0xf             
/* 8034FD04  7C 80 03 78 */	or r0, r4, r0                           
/* 8034FD08  B0 06 00 32 */	sth r0, 0x32(r6)                         /* constant-address: CC005032 */
/* 8034FD0C  57 E0 DC 3E */	rlwinm r0, r31, 0x1b, 0x10, 0x1f        
/* 8034FD10  A0 87 00 36 */	lhz r4, 0x36(r7)                         /* constant-address: CC005036 */
/* 8034FD14  54 84 00 20 */	rlwinm r4, r4, 0, 0, 0x10               
/* 8034FD18  7C 80 03 78 */	or r0, r4, r0                           
/* 8034FD1C  B0 07 00 36 */	sth r0, 0x36(r7)                         /* constant-address: CC005036 */
/* 8034FD20  4B FE D9 FD */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

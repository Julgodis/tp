...
/* 80357FC0  4B FF BB F5 */	bl __CARDGetControlBlock                 /* constant-address: 80353BB4, symbol: __CARDGetControlBlock */
/* 80357FC4  2C 03 00 00 */	cmpwi r3, 0                             
/* 80357FC8  40 80 00 08 */	bge lbl_80357FD0                         /* constant-address: 80357FD0, symbol: lbl_80357FD0 */
/* 80357FCC  48 00 00 D4 */	b lbl_803580A0                           /* constant-address: 803580A0, symbol: lbl_803580A0 */
lbl_80357FD0:
/* 80357FD0  83 41 00 14 */	lwz r26, 0x14(r1)                       
/* 80357FD4  80 1A 00 00 */	lwz r0, 0(r26)                          
/* 80357FD8  2C 00 00 00 */	cmpwi r0, 0                             
/* 80357FDC  40 82 00 0C */	bne lbl_80357FE8                         /* constant-address: 80357FE8, symbol: lbl_80357FE8 */
/* 80357FE0  3B 40 FF FD */	li r26, -3                              
/* 80357FE4  48 00 00 5C */	b lbl_80358040                           /* constant-address: 80358040, symbol: lbl_80358040 */
lbl_80357FE8:
/* 80357FE8  7F 43 D3 78 */	mr r3, r26                              
/* 80357FEC  4B FF D7 91 */	bl __CARDGetDirBlock                     /* constant-address: 8035577C, symbol: __CARDGetDirBlock */
...
/* 80358000  4B FF FC DD */	bl __CARDAccess                          /* constant-address: 80357CDC, symbol: __CARDAccess */
/* 80358004  2C 03 00 00 */	cmpwi r3, 0                             
/* 80358008  41 80 00 24 */	blt lbl_8035802C                         /* constant-address: 8035802C, symbol: lbl_8035802C */
/* 8035800C  38 7B 00 00 */	addi r3, r27, 0                         
/* 80358010  38 99 00 00 */	addi r4, r25, 0                         
/* 80358014  4B FF FC 61 */	bl __CARDCompareFileName                 /* constant-address: 80357C74, symbol: __CARDCompareFileName */
/* 80358018  2C 03 00 00 */	cmpwi r3, 0                             
/* 8035801C  41 82 00 10 */	beq lbl_8035802C                         /* constant-address: 8035802C, symbol: lbl_8035802C */
/* 80358020  3B FC 00 00 */	addi r31, r28, 0                        
/* 80358024  3B 40 00 00 */	li r26, 0                               
/* 80358028  48 00 00 18 */	b lbl_80358040                           /* constant-address: 80358040, symbol: lbl_80358040 */
lbl_8035802C:
/* 8035802C  3B 9C 00 01 */	addi r28, r28, 1                        
/* 80358030  2C 1C 00 7F */	cmpwi r28, 0x7f                         
/* 80358034  3B 7B 00 40 */	addi r27, r27, 0x40                     
/* 80358038  41 80 FF C0 */	blt lbl_80357FF8                         /* constant-address: 80357FF8, symbol: lbl_80357FF8 */
/* 8035803C  3B 40 FF FC */	li r26, -4                              
lbl_80358040:
/* 80358040  2C 1A 00 00 */	cmpwi r26, 0                            
/* 80358044  41 80 00 50 */	blt lbl_80358094                         /* constant-address: 80358094, symbol: lbl_80358094 */
/* 80358048  80 61 00 14 */	lwz r3, 0x14(r1)                        
/* 8035804C  4B FF D7 31 */	bl __CARDGetDirBlock                     /* constant-address: 8035577C, symbol: __CARDGetDirBlock */
...
/* 80358060  41 80 00 14 */	blt lbl_80358074                         /* constant-address: 80358074, symbol: lbl_80358074 */
/* 80358064  80 61 00 14 */	lwz r3, 0x14(r1)                        
/* 80358068  A0 03 00 10 */	lhz r0, 0x10(r3)                        
/* 8035806C  7C 04 00 40 */	cmplw r4, r0                            
/* 80358070  41 80 00 0C */	blt lbl_8035807C                         /* constant-address: 8035807C, symbol: lbl_8035807C */
lbl_80358074:
/* 80358074  3B 40 FF FA */	li r26, -6                              
/* 80358078  48 00 00 1C */	b lbl_80358094                           /* constant-address: 80358094, symbol: lbl_80358094 */
lbl_8035807C:
...
/* 8035809C  4B FF BB D1 */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
lbl_803580A0:

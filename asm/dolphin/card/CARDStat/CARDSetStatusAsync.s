...
/* 80358FC8  41 80 00 40 */	blt lbl_80359008                         /* constant-address: 80359008, symbol: lbl_80359008 */
/* 80358FCC  2C 1F 00 7F */	cmpwi r31, 0x7f                         
/* 80358FD0  40 80 00 38 */	bge lbl_80359008                         /* constant-address: 80359008, symbol: lbl_80359008 */
/* 80358FD4  80 7D 00 30 */	lwz r3, 0x30(r29)                       
/* 80358FD8  3C 03 00 01 */	addis r0, r3, 1                         
/* 80358FDC  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 80358FE0  41 82 00 0C */	beq lbl_80358FEC                         /* constant-address: 80358FEC, symbol: lbl_80358FEC */
/* 80358FE4  28 03 02 00 */	cmplwi r3, 0x200                        
/* 80358FE8  40 80 00 20 */	bge lbl_80359008                         /* constant-address: 80359008, symbol: lbl_80359008 */
lbl_80358FEC:
/* 80358FEC  80 7D 00 38 */	lwz r3, 0x38(r29)                       
/* 80358FF0  3C 03 00 01 */	addis r0, r3, 1                         
/* 80358FF4  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 80358FF8  41 82 00 18 */	beq lbl_80359010                         /* constant-address: 80359010, symbol: lbl_80359010 */
/* 80358FFC  54 60 04 FE */	clrlwi r0, r3, 0x13                     
/* 80359000  28 00 1F C0 */	cmplwi r0, 0x1fc0                       
/* 80359004  40 81 00 0C */	ble lbl_80359010                         /* constant-address: 80359010, symbol: lbl_80359010 */
lbl_80359008:
/* 80359008  38 60 FF 80 */	li r3, -128                             
/* 8035900C  48 00 00 E4 */	b lbl_803590F0                           /* constant-address: 803590F0, symbol: lbl_803590F0 */
lbl_80359010:
/* 80359010  38 7C 00 00 */	addi r3, r28, 0                         
/* 80359014  38 81 00 18 */	addi r4, r1, 0x18                       
/* 80359018  4B FF AB 9D */	bl __CARDGetControlBlock                 /* constant-address: 80353BB4, symbol: __CARDGetControlBlock */
/* 8035901C  2C 03 00 00 */	cmpwi r3, 0                             
/* 80359020  40 80 00 08 */	bge lbl_80359028                         /* constant-address: 80359028, symbol: lbl_80359028 */
/* 80359024  48 00 00 CC */	b lbl_803590F0                           /* constant-address: 803590F0, symbol: lbl_803590F0 */
lbl_80359028:
/* 80359028  80 61 00 18 */	lwz r3, 0x18(r1)                        
/* 8035902C  4B FF C7 51 */	bl __CARDGetDirBlock                     /* constant-address: 8035577C, symbol: __CARDGetDirBlock */
...
/* 80359040  4B FF ED 31 */	bl __CARDIsWritable                      /* constant-address: 80357D70, symbol: __CARDIsWritable */
/* 80359044  7C 64 1B 79 */	or. r4, r3, r3                          
/* 80359048  40 80 00 10 */	bge lbl_80359058                         /* constant-address: 80359058, symbol: lbl_80359058 */
/* 8035904C  80 61 00 18 */	lwz r3, 0x18(r1)                        
/* 80359050  4B FF AC 1D */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
/* 80359054  48 00 00 9C */	b lbl_803590F0                           /* constant-address: 803590F0, symbol: lbl_803590F0 */
lbl_80359058:
...
/* 80359088  4B FF FC 09 */	bl UpdateIconOffsets                     /* constant-address: 80358C90, symbol: UpdateIconOffsets */
/* 8035908C  80 7F 00 2C */	lwz r3, 0x2c(r31)                       
/* 80359090  3C 03 00 01 */	addis r0, r3, 1                         
/* 80359094  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 80359098  40 82 00 14 */	bne lbl_803590AC                         /* constant-address: 803590AC, symbol: lbl_803590AC */
...
/* 803590B0  80 03 00 F8 */	lwz r0, 0x00F8(r3)                       /* constant-address: 800000F8 */
/* 803590B4  54 1D F0 BE */	srwi r29, r0, 2                         
/* 803590B8  4B FE 96 45 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
/* 803590BC  38 DD 00 00 */	addi r6, r29, 0                         
/* 803590C0  38 A0 00 00 */	li r5, 0                                
/* 803590C4  48 00 92 61 */	bl __div2i                               /* constant-address: 80362324, symbol: __div2i */
/* 803590C8  90 9F 00 28 */	stw r4, 0x28(r31)                       
/* 803590CC  38 7C 00 00 */	addi r3, r28, 0                         
/* 803590D0  38 9E 00 00 */	addi r4, r30, 0                         
/* 803590D4  4B FF C8 49 */	bl __CARDUpdateDir                       /* constant-address: 8035591C, symbol: __CARDUpdateDir */
/* 803590D8  7C 7C 1B 79 */	or. r28, r3, r3                         
/* 803590DC  40 80 00 10 */	bge lbl_803590EC                         /* constant-address: 803590EC, symbol: lbl_803590EC */
/* 803590E0  80 61 00 18 */	lwz r3, 0x18(r1)                        
/* 803590E4  7F 84 E3 78 */	mr r4, r28                              
/* 803590E8  4B FF AB 85 */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
lbl_803590EC:

...
/* 803587B8  40 82 00 0C */	bne lbl_803587C4                         /* constant-address: 803587C4, symbol: lbl_803587C4 */
/* 803587BC  57 E0 05 FF */	clrlwi. r0, r31, 0x17                   
/* 803587C0  41 82 00 0C */	beq lbl_803587CC                         /* constant-address: 803587CC, symbol: lbl_803587CC */
lbl_803587C4:
/* 803587C4  38 60 FF 80 */	li r3, -128                             
/* 803587C8  48 00 00 E4 */	b lbl_803588AC                           /* constant-address: 803588AC, symbol: lbl_803588AC */
lbl_803587CC:
...
/* 803587DC  4B FF FC C5 */	bl __CARDSeek                            /* constant-address: 803584A0, symbol: __CARDSeek */
/* 803587E0  2C 03 00 00 */	cmpwi r3, 0                             
/* 803587E4  40 80 00 08 */	bge lbl_803587EC                         /* constant-address: 803587EC, symbol: lbl_803587EC */
/* 803587E8  48 00 00 C4 */	b lbl_803588AC                           /* constant-address: 803588AC, symbol: lbl_803588AC */
lbl_803587EC:
/* 803587EC  80 61 00 1C */	lwz r3, 0x1c(r1)                        
/* 803587F0  4B FF CF 8D */	bl __CARDGetDirBlock                     /* constant-address: 8035577C, symbol: __CARDGetDirBlock */
...
/* 80358804  4B FF F6 A1 */	bl __CARDIsReadable                      /* constant-address: 80357EA4, symbol: __CARDIsReadable */
/* 80358808  7C 64 1B 79 */	or. r4, r3, r3                          
/* 8035880C  40 80 00 10 */	bge lbl_8035881C                         /* constant-address: 8035881C, symbol: lbl_8035881C */
/* 80358810  80 61 00 1C */	lwz r3, 0x1c(r1)                        
/* 80358814  4B FF B4 59 */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
/* 80358818  48 00 00 94 */	b lbl_803588AC                           /* constant-address: 803588AC, symbol: lbl_803588AC */
lbl_8035881C:
/* 8035881C  38 7E 00 00 */	addi r3, r30, 0                         
/* 80358820  38 9F 00 00 */	addi r4, r31, 0                         
/* 80358824  4B FE 2D 5D */	bl DCInvalidateRange                     /* constant-address: 8033B580, symbol: DCInvalidateRange */
/* 80358828  28 1C 00 00 */	cmplwi r28, 0                           
/* 8035882C  41 82 00 0C */	beq lbl_80358838                         /* constant-address: 80358838, symbol: lbl_80358838 */
/* 80358830  7F 80 E3 78 */	mr r0, r28                              
/* 80358834  48 00 00 0C */	b lbl_80358840                           /* constant-address: 80358840, symbol: lbl_80358840 */
lbl_80358838:
/* 80358838  3C 60 80 35 */	lis r3, __CARDDefaultApiCallback@ha     
/* 8035883C  38 03 2A 30 */	addi r0, r3, __CARDDefaultApiCallback@l  /* constant-address: 80352A30, symbol: __CARDDefaultApiCallback */
lbl_80358840:
...
/* 80358864  40 80 00 08 */	bge lbl_8035886C                         /* constant-address: 8035886C, symbol: lbl_8035886C */
...
/* 80358880  38 E4 86 58 */	addi r7, r4, ReadCallback@l              /* constant-address: 80358658, symbol: ReadCallback */
/* 80358884  38 BF 00 00 */	addi r5, r31, 0                         
/* 80358888  38 DE 00 00 */	addi r6, r30, 0                         
/* 8035888C  7C 88 02 14 */	add r4, r8, r0                          
/* 80358890  4B FF C9 D1 */	bl __CARDRead                            /* constant-address: 80355260, symbol: __CARDRead */
/* 80358894  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 80358898  40 80 00 10 */	bge lbl_803588A8                         /* constant-address: 803588A8, symbol: lbl_803588A8 */
/* 8035889C  80 61 00 1C */	lwz r3, 0x1c(r1)                        
/* 803588A0  7F A4 EB 78 */	mr r4, r29                              
/* 803588A4  4B FF B3 C9 */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
lbl_803588A8:

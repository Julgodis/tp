...
/* 80357368  38 03 CB C0 */	addi r0, r3, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
/* 8035736C  7F E0 2A 14 */	add r31, r0, r5                         
/* 80357370  4B FE 63 85 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80357374  80 1F 00 00 */	lwz r0, 0(r31)                          
/* 80357378  3B C3 00 00 */	addi r30, r3, 0                          /* constant-address: 80450000, symbol: None */
/* 8035737C  2C 00 00 00 */	cmpwi r0, 0                             
/* 80357380  41 82 00 30 */	beq lbl_803573B0                         /* constant-address: 803573B0, symbol: lbl_803573B0 */
/* 80357384  38 7C 00 00 */	addi r3, r28, 0                         
/* 80357388  38 80 00 00 */	li r4, 0                                
/* 8035738C  4B FE BF F1 */	bl EXISetExiCallback                     /* constant-address: 8034337C, symbol: EXISetExiCallback */
/* 80357390  7F 83 E3 78 */	mr r3, r28                              
/* 80357394  4B FE C4 19 */	bl EXIDetach                             /* constant-address: 803437AC, symbol: EXIDetach */
/* 80357398  38 7F 00 E0 */	addi r3, r31, 0xe0                      
/* 8035739C  4B FE 38 A1 */	bl OSCancelAlarm                         /* constant-address: 8033AC3C, symbol: OSCancelAlarm */
...
/* 803573B4  4B FE 63 69 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

...
/* 803573F8  4B FF C7 BD */	bl __CARDGetControlBlock                 /* constant-address: 80353BB4, symbol: __CARDGetControlBlock */
/* 803573FC  2C 03 00 00 */	cmpwi r3, 0                             
/* 80357400  40 80 00 08 */	bge lbl_80357408                         /* constant-address: 80357408, symbol: lbl_80357408 */
/* 80357404  48 00 00 64 */	b lbl_80357468                           /* constant-address: 80357468, symbol: lbl_80357468 */
lbl_80357408:
/* 80357408  1C 9D 01 10 */	mulli r4, r29, 0x110                    
/* 8035740C  3C 60 80 45 */	lis r3, __CARDBlock@ha                  
/* 80357410  38 03 CB C0 */	addi r0, r3, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
/* 80357414  7F C0 22 14 */	add r30, r0, r4                         
/* 80357418  4B FE 62 DD */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8035741C  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 80357420  3B E3 00 00 */	addi r31, r3, 0                          /* constant-address: 80450000, symbol: None */
/* 80357424  2C 00 00 00 */	cmpwi r0, 0                             
/* 80357428  41 82 00 34 */	beq lbl_8035745C                         /* constant-address: 8035745C, symbol: lbl_8035745C */
/* 8035742C  38 7D 00 00 */	addi r3, r29, 0                         
/* 80357430  38 80 00 00 */	li r4, 0                                
/* 80357434  4B FE BF 49 */	bl EXISetExiCallback                     /* constant-address: 8034337C, symbol: EXISetExiCallback */
/* 80357438  7F A3 EB 78 */	mr r3, r29                              
/* 8035743C  4B FE C3 71 */	bl EXIDetach                             /* constant-address: 803437AC, symbol: EXIDetach */
/* 80357440  38 7E 00 E0 */	addi r3, r30, 0xe0                      
/* 80357444  4B FE 37 F9 */	bl OSCancelAlarm                         /* constant-address: 8033AC3C, symbol: OSCancelAlarm */
...
/* 80357460  4B FE 62 BD */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

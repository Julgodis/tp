...
/* 80353BD0  38 05 CB C0 */	addi r0, r5, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
...
/* 80353BE4  41 80 00 18 */	blt lbl_80353BFC                         /* constant-address: 80353BFC, symbol: lbl_80353BFC */
/* 80353BE8  2C 03 00 02 */	cmpwi r3, 2                             
/* 80353BEC  40 80 00 10 */	bge lbl_80353BFC                         /* constant-address: 80353BFC, symbol: lbl_80353BFC */
/* 80353BF0  80 1E 01 0C */	lwz r0, 0x10c(r30)                      
/* 80353BF4  28 00 00 00 */	cmplwi r0, 0                            
/* 80353BF8  40 82 00 0C */	bne lbl_80353C04                         /* constant-address: 80353C04, symbol: lbl_80353C04 */
lbl_80353BFC:
/* 80353BFC  38 60 FF 80 */	li r3, -128                             
/* 80353C00  48 00 00 50 */	b lbl_80353C50                           /* constant-address: 80353C50, symbol: lbl_80353C50 */
lbl_80353C04:
/* 80353C04  4B FE 9A F1 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80353C08  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 80353C0C  2C 00 00 00 */	cmpwi r0, 0                             
/* 80353C10  40 82 00 0C */	bne lbl_80353C1C                         /* constant-address: 80353C1C, symbol: lbl_80353C1C */
/* 80353C14  3B E0 FF FD */	li r31, -3                              
/* 80353C18  48 00 00 30 */	b lbl_80353C48                           /* constant-address: 80353C48, symbol: lbl_80353C48 */
lbl_80353C1C:
/* 80353C1C  80 1E 00 04 */	lwz r0, 4(r30)                          
/* 80353C20  2C 00 FF FF */	cmpwi r0, -1                            
/* 80353C24  40 82 00 0C */	bne lbl_80353C30                         /* constant-address: 80353C30, symbol: lbl_80353C30 */
/* 80353C28  3B E0 FF FF */	li r31, -1                              
/* 80353C2C  48 00 00 1C */	b lbl_80353C48                           /* constant-address: 80353C48, symbol: lbl_80353C48 */
lbl_80353C30:
...
lbl_80353C48:
/* 80353C48  4B FE 9A D5 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

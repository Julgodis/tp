...
/* 80353540  4B FE A1 B5 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80353544  1C BB 01 10 */	mulli r5, r27, 0x110                    
/* 80353548  3C 80 80 45 */	lis r4, __CARDBlock@ha                  
/* 8035354C  38 04 CB C0 */	addi r0, r4, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
...
/* 80353560  40 82 00 0C */	bne lbl_8035356C                         /* constant-address: 8035356C, symbol: lbl_8035356C */
/* 80353564  3B A0 FF FD */	li r29, -3                              
/* 80353568  48 00 01 C0 */	b lbl_80353728                           /* constant-address: 80353728, symbol: lbl_80353728 */
lbl_8035356C:
/* 8035356C  28 1C 00 00 */	cmplwi r28, 0                           
/* 80353570  41 82 00 08 */	beq lbl_80353578                         /* constant-address: 80353578, symbol: lbl_80353578 */
/* 80353574  93 9F 00 C8 */	stw r28, 0xc8(r31)                      
lbl_80353578:
/* 80353578  28 1D 00 00 */	cmplwi r29, 0                           
/* 8035357C  41 82 00 08 */	beq lbl_80353584                         /* constant-address: 80353584, symbol: lbl_80353584 */
/* 80353580  93 BF 00 CC */	stw r29, 0xcc(r31)                      
lbl_80353584:
/* 80353584  3C 60 80 35 */	lis r3, UnlockedCallback@ha             
/* 80353588  38 03 34 14 */	addi r0, r3, UnlockedCallback@l          /* constant-address: 80353414, symbol: UnlockedCallback */
/* 8035358C  3C 60 80 35 */	lis r3, __CARDUnlockedHandler@ha        
/* 80353590  90 1F 00 DC */	stw r0, 0xdc(r31)                       
/* 80353594  38 A3 2D 00 */	addi r5, r3, __CARDUnlockedHandler@l     /* constant-address: 80352D00, symbol: __CARDUnlockedHandler */
/* 80353598  38 7B 00 00 */	addi r3, r27, 0                         
/* 8035359C  38 80 00 00 */	li r4, 0                                
/* 803535A0  4B FF 0A 89 */	bl EXILock                               /* constant-address: 80344028, symbol: EXILock */
/* 803535A4  2C 03 00 00 */	cmpwi r3, 0                             
/* 803535A8  40 82 00 0C */	bne lbl_803535B4                         /* constant-address: 803535B4, symbol: lbl_803535B4 */
/* 803535AC  3B A0 FF FF */	li r29, -1                              
/* 803535B0  48 00 01 78 */	b lbl_80353728                           /* constant-address: 80353728, symbol: lbl_80353728 */
lbl_803535B4:
...
/* 803535C8  4B FF 02 A1 */	bl EXISelect                             /* constant-address: 80343868, symbol: EXISelect */
/* 803535CC  2C 03 00 00 */	cmpwi r3, 0                             
/* 803535D0  40 82 00 14 */	bne lbl_803535E4                         /* constant-address: 803535E4, symbol: lbl_803535E4 */
/* 803535D4  7F 63 DB 78 */	mr r3, r27                              
/* 803535D8  4B FF 0B 45 */	bl EXIUnlock                             /* constant-address: 8034411C, symbol: EXIUnlock */
/* 803535DC  3B A0 FF FD */	li r29, -3                              
/* 803535E0  48 00 01 48 */	b lbl_80353728                           /* constant-address: 80353728, symbol: lbl_80353728 */
lbl_803535E4:
/* 803535E4  38 7F 00 E0 */	addi r3, r31, 0xe0                      
/* 803535E8  4B FE 76 55 */	bl OSCancelAlarm                         /* constant-address: 8033AC3C, symbol: OSCancelAlarm */
/* 803535EC  88 1F 00 94 */	lbz r0, 0x94(r31)                       
/* 803535F0  2C 00 00 F3 */	cmpwi r0, 0xf3                          
/* 803535F4  41 82 01 30 */	beq lbl_80353724                         /* constant-address: 80353724, symbol: lbl_80353724 */
/* 803535F8  40 80 00 14 */	bge lbl_8035360C                         /* constant-address: 8035360C, symbol: lbl_8035360C */
/* 803535FC  2C 00 00 F1 */	cmpwi r0, 0xf1                          
/* 80353600  41 82 00 C0 */	beq lbl_803536C0                         /* constant-address: 803536C0, symbol: lbl_803536C0 */
/* 80353604  40 80 00 14 */	bge lbl_80353618                         /* constant-address: 80353618, symbol: lbl_80353618 */
/* 80353608  48 00 01 1C */	b lbl_80353724                           /* constant-address: 80353724, symbol: lbl_80353724 */
lbl_8035360C:
/* 8035360C  2C 00 00 F5 */	cmpwi r0, 0xf5                          
/* 80353610  40 80 01 14 */	bge lbl_80353724                         /* constant-address: 80353724, symbol: lbl_80353724 */
/* 80353614  48 00 00 3C */	b lbl_80353650                           /* constant-address: 80353650, symbol: lbl_80353650 */
lbl_80353618:
/* 80353618  3C 60 80 00 */	lis r3, 0x8000 /* 0x800000F8@ha */      
/* 8035361C  80 03 00 F8 */	lwz r0, 0x00F8(r3)                       /* constant-address: 800000F8 */
...
/* 8035362C  38 84 4D D3 */	addi r4, r4, 0x4DD3 /* 0x10624DD3@l */   /* constant-address: 10624DD3 */
/* 80353630  7C 04 00 16 */	mulhwu r0, r4, r0                       
/* 80353634  54 00 D1 BE */	srwi r0, r0, 6                          
/* 80353638  1C C0 00 64 */	mulli r6, r0, 0x64                      
/* 8035363C  38 E3 30 D0 */	addi r7, r3, TimeoutHandler@l            /* constant-address: 803530D0, symbol: TimeoutHandler */
/* 80353640  38 7F 00 E0 */	addi r3, r31, 0xe0                      
/* 80353644  38 A0 00 00 */	li r5, 0                                
/* 80353648  4B FE 75 11 */	bl OSSetAlarm                            /* constant-address: 8033AB58, symbol: OSSetAlarm */
/* 8035364C  48 00 00 D8 */	b lbl_80353724                           /* constant-address: 80353724, symbol: lbl_80353724 */
lbl_80353650:
/* 80353650  A0 1F 00 0A */	lhz r0, 0xa(r31)                        
/* 80353654  28 00 00 80 */	cmplwi r0, 0x80                         
/* 80353658  40 81 00 68 */	ble lbl_803536C0                         /* constant-address: 803536C0, symbol: lbl_803536C0 */
/* 8035365C  3C 60 80 00 */	lis r3, 0x8000 /* 0x800000F8@ha */      
/* 80353660  A0 9F 00 10 */	lhz r4, 0x10(r31)                       
/* 80353664  80 63 00 F8 */	lwz r3, 0x00F8(r3)                       /* constant-address: 800000F8 */
...
/* 8035369C  38 E3 30 D0 */	addi r7, r3, TimeoutHandler@l            /* constant-address: 803530D0, symbol: TimeoutHandler */
...
/* 803536B8  4B FE 74 A1 */	bl OSSetAlarm                            /* constant-address: 8033AB58, symbol: OSSetAlarm */
/* 803536BC  48 00 00 68 */	b lbl_80353724                           /* constant-address: 80353724, symbol: lbl_80353724 */
lbl_803536C0:
/* 803536C0  3C 60 80 00 */	lis r3, 0x8000 /* 0x800000F8@ha */      
/* 803536C4  80 9F 00 0C */	lwz r4, 0xc(r31)                        
/* 803536C8  80 03 00 F8 */	lwz r0, 0x00F8(r3)                       /* constant-address: 800000F8 */
...
/* 80353704  38 E3 30 D0 */	addi r7, r3, TimeoutHandler@l            /* constant-address: 803530D0, symbol: TimeoutHandler */
...
/* 80353720  4B FE 74 39 */	bl OSSetAlarm                            /* constant-address: 8033AB58, symbol: OSSetAlarm */
lbl_80353724:
/* 80353724  3B A0 00 00 */	li r29, 0                               
lbl_80353728:
/* 80353728  7F C3 F3 78 */	mr r3, r30                              
/* 8035372C  4B FE 9F F1 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

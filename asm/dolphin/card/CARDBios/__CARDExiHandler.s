...
/* 80352B64  38 03 CB C0 */	addi r0, r3, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
/* 80352B68  7F C0 22 14 */	add r30, r0, r4                         
/* 80352B6C  38 7E 00 E0 */	addi r3, r30, 0xe0                      
/* 80352B70  4B FE 80 CD */	bl OSCancelAlarm                         /* constant-address: 8033AC3C, symbol: OSCancelAlarm */
/* 80352B74  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 80352B78  2C 00 00 00 */	cmpwi r0, 0                             
/* 80352B7C  41 82 00 C0 */	beq lbl_80352C3C                         /* constant-address: 80352C3C, symbol: lbl_80352C3C */
/* 80352B80  38 7F 00 00 */	addi r3, r31, 0                         
/* 80352B84  38 80 00 00 */	li r4, 0                                
/* 80352B88  38 A0 00 00 */	li r5, 0                                
/* 80352B8C  4B FF 14 9D */	bl EXILock                               /* constant-address: 80344028, symbol: EXILock */
/* 80352B90  2C 03 00 00 */	cmpwi r3, 0                             
/* 80352B94  40 82 00 0C */	bne lbl_80352BA0                         /* constant-address: 80352BA0, symbol: lbl_80352BA0 */
/* 80352B98  3B A0 FF 80 */	li r29, -128                            
/* 80352B9C  48 00 00 78 */	b lbl_80352C14                           /* constant-address: 80352C14, symbol: lbl_80352C14 */
lbl_80352BA0:
/* 80352BA0  38 7F 00 00 */	addi r3, r31, 0                         
/* 80352BA4  38 81 00 10 */	addi r4, r1, 0x10                       
/* 80352BA8  48 00 02 9D */	bl __CARDReadStatus                      /* constant-address: 80352E44, symbol: __CARDReadStatus */
/* 80352BAC  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 80352BB0  41 80 00 5C */	blt lbl_80352C0C                         /* constant-address: 80352C0C, symbol: lbl_80352C0C */
/* 80352BB4  7F E3 FB 78 */	mr r3, r31                              
/* 80352BB8  48 00 04 6D */	bl __CARDClearStatus                     /* constant-address: 80353024, symbol: __CARDClearStatus */
/* 80352BBC  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 80352BC0  41 80 00 4C */	blt lbl_80352C0C                         /* constant-address: 80352C0C, symbol: lbl_80352C0C */
/* 80352BC4  88 01 00 10 */	lbz r0, 0x10(r1)                        
/* 80352BC8  54 00 06 F9 */	rlwinm. r0, r0, 0, 0x1b, 0x1c           
/* 80352BCC  41 82 00 0C */	beq lbl_80352BD8                         /* constant-address: 80352BD8, symbol: lbl_80352BD8 */
/* 80352BD0  38 00 FF FB */	li r0, -5                               
/* 80352BD4  48 00 00 08 */	b lbl_80352BDC                           /* constant-address: 80352BDC, symbol: lbl_80352BDC */
lbl_80352BD8:
/* 80352BD8  38 00 00 00 */	li r0, 0                                
lbl_80352BDC:
/* 80352BDC  7C 1D 03 78 */	mr r29, r0                              
/* 80352BE0  2C 1D FF FB */	cmpwi r29, -5                           
/* 80352BE4  40 82 00 28 */	bne lbl_80352C0C                         /* constant-address: 80352C0C, symbol: lbl_80352C0C */
/* 80352BE8  80 7E 00 A8 */	lwz r3, 0xa8(r30)                       
/* 80352BEC  34 03 FF FF */	addic. r0, r3, -1                       
/* 80352BF0  90 1E 00 A8 */	stw r0, 0xa8(r30)                       
/* 80352BF4  40 81 00 18 */	ble lbl_80352C0C                         /* constant-address: 80352C0C, symbol: lbl_80352C0C */
/* 80352BF8  7F E3 FB 78 */	mr r3, r31                              
/* 80352BFC  48 00 05 79 */	bl Retry                                 /* constant-address: 80353174, symbol: Retry */
/* 80352C00  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 80352C04  41 80 00 10 */	blt lbl_80352C14                         /* constant-address: 80352C14, symbol: lbl_80352C14 */
/* 80352C08  48 00 00 34 */	b lbl_80352C3C                           /* constant-address: 80352C3C, symbol: lbl_80352C3C */
lbl_80352C0C:
/* 80352C0C  7F E3 FB 78 */	mr r3, r31                              
/* 80352C10  4B FF 15 0D */	bl EXIUnlock                             /* constant-address: 8034411C, symbol: EXIUnlock */
lbl_80352C14:
/* 80352C14  80 1E 00 CC */	lwz r0, 0xcc(r30)                       
/* 80352C18  28 00 00 00 */	cmplwi r0, 0                            
/* 80352C1C  7C 0C 03 78 */	mr r12, r0                              
/* 80352C20  41 82 00 1C */	beq lbl_80352C3C                         /* constant-address: 80352C3C, symbol: lbl_80352C3C */

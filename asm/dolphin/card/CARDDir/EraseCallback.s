...
/* 80355878  38 03 CB C0 */	addi r0, r3, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
/* 8035587C  7C 9D 23 79 */	or. r29, r4, r4                         
/* 80355880  7F C0 2A 14 */	add r30, r0, r5                         
/* 80355884  41 80 00 3C */	blt lbl_803558C0                         /* constant-address: 803558C0, symbol: lbl_803558C0 */
/* 80355888  80 BE 00 84 */	lwz r5, 0x84(r30)                       
/* 8035588C  3C 60 80 35 */	lis r3, WriteCallback@ha                
/* 80355890  80 1E 00 80 */	lwz r0, 0x80(r30)                       
/* 80355894  38 E3 57 84 */	addi r7, r3, WriteCallback@l             /* constant-address: 80355784, symbol: WriteCallback */
...
/* 803558B4  4B FF FA F9 */	bl __CARDWrite                           /* constant-address: 803553AC, symbol: __CARDWrite */
/* 803558B8  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 803558BC  40 80 00 44 */	bge lbl_80355900                         /* constant-address: 80355900, symbol: lbl_80355900 */
lbl_803558C0:
/* 803558C0  80 1E 00 D0 */	lwz r0, 0xd0(r30)                       
/* 803558C4  28 00 00 00 */	cmplwi r0, 0                            
/* 803558C8  40 82 00 10 */	bne lbl_803558D8                         /* constant-address: 803558D8, symbol: lbl_803558D8 */
/* 803558CC  38 7E 00 00 */	addi r3, r30, 0                         
/* 803558D0  38 9D 00 00 */	addi r4, r29, 0                         
/* 803558D4  4B FF E3 99 */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
lbl_803558D8:
/* 803558D8  80 1E 00 D8 */	lwz r0, 0xd8(r30)                       
/* 803558DC  28 00 00 00 */	cmplwi r0, 0                            
/* 803558E0  7C 0C 03 78 */	mr r12, r0                              
/* 803558E4  41 82 00 1C */	beq lbl_80355900                         /* constant-address: 80355900, symbol: lbl_80355900 */

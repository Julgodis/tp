...
/* 80355948  38 03 CB C0 */	addi r0, r3, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
/* 8035594C  7F C0 2A 14 */	add r30, r0, r5                         
/* 80355950  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 80355954  2C 00 00 00 */	cmpwi r0, 0                             
/* 80355958  40 82 00 0C */	bne lbl_80355964                         /* constant-address: 80355964, symbol: lbl_80355964 */
/* 8035595C  38 60 FF FD */	li r3, -3                               
/* 80355960  48 00 00 60 */	b lbl_803559C0                           /* constant-address: 803559C0, symbol: lbl_803559C0 */
lbl_80355964:
...
/* 80355988  48 00 00 59 */	bl __CARDCheckSum                        /* constant-address: 803559E0, symbol: __CARDCheckSum */
/* 8035598C  38 7F 00 00 */	addi r3, r31, 0                         
/* 80355990  38 80 20 00 */	li r4, 0x2000                           
/* 80355994  4B FE 5C 49 */	bl DCStoreRange                          /* constant-address: 8033B5DC, symbol: DCStoreRange */
/* 80355998  93 BE 00 D8 */	stw r29, 0xd8(r30)                      
/* 8035599C  3C 60 80 35 */	lis r3, EraseCallback@ha                
/* 803559A0  38 A3 58 54 */	addi r5, r3, EraseCallback@l             /* constant-address: 80355854, symbol: EraseCallback */
...
/* 803559BC  4B FF DF FD */	bl __CARDEraseSector                     /* constant-address: 803539B8, symbol: __CARDEraseSector */
lbl_803559C0:

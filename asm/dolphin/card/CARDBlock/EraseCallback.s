...
/* 80355514  38 03 CB C0 */	addi r0, r3, __CARDBlock@l               /* constant-address: 8044CBC0, symbol: __CARDBlock */
/* 80355518  7C 9D 23 79 */	or. r29, r4, r4                         
/* 8035551C  7F C0 2A 14 */	add r30, r0, r5                         
/* 80355520  41 80 00 3C */	blt lbl_8035555C                         /* constant-address: 8035555C, symbol: lbl_8035555C */
/* 80355524  80 BE 00 88 */	lwz r5, 0x88(r30)                       
/* 80355528  3C 60 80 35 */	lis r3, WriteCallback@ha                
/* 8035552C  80 1E 00 80 */	lwz r0, 0x80(r30)                       
/* 80355530  38 E3 54 1C */	addi r7, r3, WriteCallback@l             /* constant-address: 8035541C, symbol: WriteCallback */
...
/* 80355550  4B FF FE 5D */	bl __CARDWrite                           /* constant-address: 803553AC, symbol: __CARDWrite */
/* 80355554  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 80355558  40 80 00 44 */	bge lbl_8035559C                         /* constant-address: 8035559C, symbol: lbl_8035559C */
lbl_8035555C:
/* 8035555C  80 1E 00 D0 */	lwz r0, 0xd0(r30)                       
/* 80355560  28 00 00 00 */	cmplwi r0, 0                            
/* 80355564  40 82 00 10 */	bne lbl_80355574                         /* constant-address: 80355574, symbol: lbl_80355574 */
/* 80355568  38 7E 00 00 */	addi r3, r30, 0                         
/* 8035556C  38 9D 00 00 */	addi r4, r29, 0                         
/* 80355570  4B FF E6 FD */	bl __CARDPutControlBlock                 /* constant-address: 80353C6C, symbol: __CARDPutControlBlock */
lbl_80355574:
/* 80355574  80 1E 00 D8 */	lwz r0, 0xd8(r30)                       
/* 80355578  28 00 00 00 */	cmplwi r0, 0                            
/* 8035557C  7C 0C 03 78 */	mr r12, r0                              
/* 80355580  41 82 00 1C */	beq lbl_8035559C                         /* constant-address: 8035559C, symbol: lbl_8035559C */

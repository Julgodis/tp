lbl_8034DB40:
/* 8034DB40  81 2D 92 A8 */	lwz r9, CurrTiming(r13)                  /* constant-address: 80451828, symbol: CurrTiming */
/* 8034DB44  3C E0 80 45 */	lis r7, HorVer@ha                       
/* 8034DB48  38 E7 CB 18 */	addi r7, r7, HorVer@l                    /* constant-address: 8044CB18, symbol: HorVer */
/* 8034DB4C  A0 09 00 1A */	lhz r0, 0x1a(r9)                        
/* 8034DB50  39 03 FF FF */	addi r8, r3, -1                         
/* 8034DB54  80 E7 00 24 */	lwz r7, 0x24(r7)                         /* constant-address: 8044CB3C, symbol: None */
...
/* 8034DB6C  40 82 00 C0 */	bne lbl_8034DC2C                         /* constant-address: 8034DC2C, symbol: lbl_8034DC2C */
/* 8034DB70  A1 49 00 18 */	lhz r10, 0x18(r9)                       
/* 8034DB74  7C 00 50 40 */	cmplw r0, r10                           
/* 8034DB78  40 80 00 58 */	bge lbl_8034DBD0                         /* constant-address: 8034DBD0, symbol: lbl_8034DBD0 */
...
/* 8034DB90  40 80 00 10 */	bge lbl_8034DBA0                         /* constant-address: 8034DBA0, symbol: lbl_8034DBA0 */
/* 8034DB94  38 00 FF FF */	li r0, -1                               
/* 8034DB98  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DB9C  48 00 01 B4 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DBA0:
/* 8034DBA0  A0 89 00 08 */	lhz r4, 8(r9)                           
/* 8034DBA4  7C 84 50 50 */	subf r4, r4, r10                        
/* 8034DBA8  7C 00 20 40 */	cmplw r0, r4                            
/* 8034DBAC  41 80 00 10 */	blt lbl_8034DBBC                         /* constant-address: 8034DBBC, symbol: lbl_8034DBBC */
/* 8034DBB0  38 00 FF FF */	li r0, -1                               
/* 8034DBB4  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DBB8  48 00 01 98 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DBBC:
...
/* 8034DBCC  48 00 01 84 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DBD0:
...
/* 8034DBE8  40 80 00 10 */	bge lbl_8034DBF8                         /* constant-address: 8034DBF8, symbol: lbl_8034DBF8 */
/* 8034DBEC  38 00 FF FF */	li r0, -1                               
/* 8034DBF0  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DBF4  48 00 01 5C */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DBF8:
/* 8034DBF8  A0 89 00 0A */	lhz r4, 0xa(r9)                         
/* 8034DBFC  7C 84 50 50 */	subf r4, r4, r10                        
/* 8034DC00  7C 00 20 40 */	cmplw r0, r4                            
/* 8034DC04  41 80 00 10 */	blt lbl_8034DC14                         /* constant-address: 8034DC14, symbol: lbl_8034DC14 */
/* 8034DC08  38 00 FF FF */	li r0, -1                               
/* 8034DC0C  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DC10  48 00 01 40 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DC14:
...
/* 8034DC28  48 00 01 28 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DC2C:
/* 8034DC2C  28 07 00 01 */	cmplwi r7, 1                            
/* 8034DC30  40 82 00 68 */	bne lbl_8034DC98                         /* constant-address: 8034DC98, symbol: lbl_8034DC98 */
/* 8034DC34  A0 E9 00 18 */	lhz r7, 0x18(r9)                        
/* 8034DC38  7C 00 38 40 */	cmplw r0, r7                            
/* 8034DC3C  41 80 00 08 */	blt lbl_8034DC44                         /* constant-address: 8034DC44, symbol: lbl_8034DC44 */
...
/* 8034DC58  40 80 00 10 */	bge lbl_8034DC68                         /* constant-address: 8034DC68, symbol: lbl_8034DC68 */
/* 8034DC5C  38 00 FF FF */	li r0, -1                               
/* 8034DC60  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DC64  48 00 00 EC */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DC68:
/* 8034DC68  A0 89 00 08 */	lhz r4, 8(r9)                           
/* 8034DC6C  7C 84 38 50 */	subf r4, r4, r7                         
/* 8034DC70  7C 00 20 40 */	cmplw r0, r4                            
/* 8034DC74  41 80 00 10 */	blt lbl_8034DC84                         /* constant-address: 8034DC84, symbol: lbl_8034DC84 */
/* 8034DC78  38 00 FF FF */	li r0, -1                               
/* 8034DC7C  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DC80  48 00 00 D0 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DC84:
...
/* 8034DC94  48 00 00 BC */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DC98:
/* 8034DC98  28 07 00 02 */	cmplwi r7, 2                            
/* 8034DC9C  40 82 00 B4 */	bne lbl_8034DD50                         /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
/* 8034DCA0  A1 49 00 18 */	lhz r10, 0x18(r9)                       
/* 8034DCA4  7C 00 50 40 */	cmplw r0, r10                           
/* 8034DCA8  40 80 00 54 */	bge lbl_8034DCFC                         /* constant-address: 8034DCFC, symbol: lbl_8034DCFC */
...
/* 8034DCC0  40 80 00 10 */	bge lbl_8034DCD0                         /* constant-address: 8034DCD0, symbol: lbl_8034DCD0 */
/* 8034DCC4  38 00 FF FF */	li r0, -1                               
/* 8034DCC8  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DCCC  48 00 00 84 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DCD0:
/* 8034DCD0  A0 89 00 08 */	lhz r4, 8(r9)                           
/* 8034DCD4  7C 84 50 50 */	subf r4, r4, r10                        
/* 8034DCD8  7C 00 20 40 */	cmplw r0, r4                            
/* 8034DCDC  41 80 00 10 */	blt lbl_8034DCEC                         /* constant-address: 8034DCEC, symbol: lbl_8034DCEC */
/* 8034DCE0  38 00 FF FF */	li r0, -1                               
/* 8034DCE4  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DCE8  48 00 00 68 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DCEC:
/* 8034DCEC  7C 07 00 50 */	subf r0, r7, r0                         
/* 8034DCF0  7C 08 00 50 */	subf r0, r8, r0                         
/* 8034DCF4  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DCF8  48 00 00 58 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DCFC:
...
/* 8034DD14  40 80 00 10 */	bge lbl_8034DD24                         /* constant-address: 8034DD24, symbol: lbl_8034DD24 */
/* 8034DD18  38 00 FF FF */	li r0, -1                               
/* 8034DD1C  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DD20  48 00 00 30 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DD24:
/* 8034DD24  A0 89 00 0A */	lhz r4, 0xa(r9)                         
/* 8034DD28  7C 84 50 50 */	subf r4, r4, r10                        
/* 8034DD2C  7C 00 20 40 */	cmplw r0, r4                            
/* 8034DD30  41 80 00 10 */	blt lbl_8034DD40                         /* constant-address: 8034DD40, symbol: lbl_8034DD40 */
/* 8034DD34  38 00 FF FF */	li r0, -1                               
/* 8034DD38  B0 06 00 00 */	sth r0, 0(r6)                           
/* 8034DD3C  48 00 00 14 */	b lbl_8034DD50                           /* constant-address: 8034DD50, symbol: lbl_8034DD50 */
lbl_8034DD40:

...
/* 8034C5AC 00000030  A0 BD 01 C2 */	lhz r5, 0x1c2(r29)
/* 8034C5B0 00000034  A0 DD 01 C0 */	lhz r6, 0x1c0(r29)
...
/* 8034C5C0 00000044  A0 DD 01 C2 */	lhz r6, 0x1c2(r29)
/* 8034C5C4 00000048  A0 BD 01 C4 */	lhz r5, 0x1c4(r29)
...
/* 8034C5D8 0000005C  A0 BD 01 C8 */	lhz r5, 0x1c8(r29)
/* 8034C5DC 00000060  A0 DD 01 C6 */	lhz r6, 0x1c6(r29)
...
/* 8034C5EC 00000070  A0 DD 01 C8 */	lhz r6, 0x1c8(r29)
/* 8034C5F0 00000074  A0 BD 01 CA */	lhz r5, 0x1ca(r29)
...
/* 8034C604 00000088  A0 BD 01 CE */	lhz r5, 0x1ce(r29)
/* 8034C608 0000008C  A0 DD 01 CC */	lhz r6, 0x1cc(r29)
...
/* 8034C618 0000009C  A0 BD 01 CE */	lhz r5, 0x1ce(r29)
/* 8034C61C 000000A0  A0 9D 01 D0 */	lhz r4, 0x1d0(r29)
...
/* 8034C630 000000B4  A0 9D 01 D4 */	lhz r4, 0x1d4(r29)
/* 8034C634 000000B8  A0 BD 01 D2 */	lhz r5, 0x1d2(r29)
...
/* 8034C644 000000C8  A0 9D 01 D8 */	lhz r4, 0x1d8(r29)
/* 8034C648 000000CC  A0 BD 01 D6 */	lhz r5, 0x1d6(r29)
...
/* 8034C658 000000DC  A0 9D 01 DC */	lhz r4, 0x1dc(r29)
/* 8034C65C 000000E0  A0 BD 01 DA */	lhz r5, 0x1da(r29)
...
/* 8034C66C 000000F0  A0 9D 01 E0 */	lhz r4, 0x1e0(r29)
/* 8034C670 000000F4  A0 BD 01 DE */	lhz r5, 0x1de(r29)
...
/* 8034C680 00000104  A0 9D 01 E4 */	lhz r4, 0x1e4(r29)
/* 8034C684 00000108  A0 BD 01 E2 */	lhz r5, 0x1e2(r29)
...
/* 8034C694 00000118  A0 9D 01 E8 */	lhz r4, 0x1e8(r29)
/* 8034C698 0000011C  A0 BD 01 E6 */	lhz r5, 0x1e6(r29)
...
/* 8034C6A8 0000012C  A0 9D 01 EC */	lhz r4, 0x1ec(r29)
/* 8034C6AC 00000130  A0 BD 01 EA */	lhz r5, 0x1ea(r29)
...
/* 8034C6BC 00000140  A0 9D 01 F0 */	lhz r4, 0x1f0(r29)
/* 8034C6C0 00000144  A0 BD 01 EE */	lhz r5, 0x1ee(r29)
...
/* 8034C6D8 0000015C  88 03 00 10 */	lbz r0, 0x10(r3)
...
/* 8034C6F0 00000174  A3 BC 00 00 */	lhz r29, 0(r28)
...
/* 8034C72C 000001B0  90 1C 00 00 */	stw r0, 0(r28)
lbl_8034C730:
/* 8034C730 00000000  80 7C 00 00 */	lwz r3, 0(r28)
...
lbl_8034C740:
/* 8034C740 00000000  80 04 00 00 */	lwz r0, 0(r4)
...
/* 8034C78C 0000004C  B0 1E 00 F6 */	sth r0, 0xf6(r30)
/* 8034C790 00000050  A0 1E 00 F4 */	lhz r0, 0xf4(r30)
...
/* 8034C7A0 00000060  B0 1E 00 F0 */	sth r0, 0xf0(r30)
/* 8034C7A4 00000064  B1 1E 00 F2 */	sth r8, 0xf2(r30)
/* 8034C7A8 00000068  A0 1E 00 F4 */	lhz r0, 0xf4(r30)
/* 8034C7AC 0000006C  A8 FE 00 F0 */	lha r7, 0xf0(r30)
...
lbl_8034C7E0:
/* 8034C7E0 00000000  B0 1E 00 F8 */	sth r0, 0xf8(r30)
/* 8034C7E4 00000004  39 1E 01 10 */	addi r8, r30, 0x110
/* 8034C7E8 00000008  80 1E 01 10 */	lwz r0, 0x110(r30)
...
lbl_8034C800:
/* 8034C800 00000000  A0 03 00 00 */	lhz r0, 0(r3)
...
lbl_8034C824:
/* 8034C824 00000000  B0 FE 00 FA */	sth r7, 0xfa(r30)
/* 8034C828 00000004  7D 27 07 34 */	extsh r7, r9
/* 8034C82C 00000008  54 E7 08 3C */	slwi r7, r7, 1
/* 8034C830 0000000C  A3 86 00 00 */	lhz r28, 0(r6)
/* 8034C834 00000010  7D 80 38 50 */	subf r12, r0, r7
/* 8034C838 00000014  A9 43 00 00 */	lha r10, 0(r3)
...
/* 8034C87C 00000008  B0 FE 00 FC */	sth r7, 0xfc(r30)
/* 8034C880 0000000C  A8 E3 00 00 */	lha r7, 0(r3)
...
/* 8034C8A4 00000008  A1 3E 01 08 */	lhz r9, 0x108(r30)
/* 8034C8A8 0000000C  7D 2A 48 50 */	subf r9, r10, r9
/* 8034C8AC 00000010  B1 3E 00 FE */	sth r9, 0xfe(r30)
/* 8034C8B0 00000014  A8 C6 00 00 */	lha r6, 0(r6)
/* 8034C8B4 00000018  A9 23 00 00 */	lha r9, 0(r3)
...
/* 8034C8F0 00000004  A0 7E 01 0C */	lhz r3, 0x10c(r30)
...
/* 8034C900 00000014  B0 1E 01 00 */	sth r0, 0x100(r30)
/* 8034C904 00000018  39 20 02 80 */	li r9, 0x280
/* 8034C908 0000001C  3B 80 00 00 */	li r28, 0
/* 8034C90C 00000020  B1 3E 01 02 */	sth r9, 0x102(r30)
...
/* 8034C924 00000038  B0 DE 01 04 */	sth r6, 0x104(r30)
/* 8034C928 0000003C  B3 9E 01 06 */	sth r28, 0x106(r30)
/* 8034C92C 00000040  B3 87 00 00 */	sth r28, 0(r7)
/* 8034C930 00000044  B1 3E 01 0A */	sth r9, 0x10a(r30)
/* 8034C934 00000048  A0 84 00 00 */	lhz r4, 0(r4)
/* 8034C938 0000004C  54 84 0C 3C */	rlwinm r4, r4, 1, 0x10, 0x1e
/* 8034C93C 00000050  B0 9E 01 0C */	sth r4, 0x10c(r30)
/* 8034C940 00000054  93 88 00 00 */	stw r28, 0(r8)
/* 8034C944 00000058  98 BE 01 1C */	stb r5, 0x11c(r30)
/* 8034C948 0000005C  98 BE 01 1D */	stb r5, 0x11d(r30)
/* 8034C94C 00000060  98 BE 01 1E */	stb r5, 0x11e(r30)
/* 8034C950 00000064  9B 9E 01 2C */	stb r28, 0x12c(r30)
/* 8034C954 00000068  90 1E 01 30 */	stw r0, 0x130(r30)
/* 8034C958 0000006C  93 9E 01 34 */	stw r28, 0x134(r30)

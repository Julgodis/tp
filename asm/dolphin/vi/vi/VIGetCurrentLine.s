...
/* 8034DA18  83 ED 92 A8 */	lwz r31, CurrTiming(r13)                 /* constant-address: 80451828, symbol: CurrTiming */
/* 8034DA1C  4B FE FC D9 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8034DA20  3C 80 CC 00 */	lis r4, 0xCC00 /* 0xCC002000@ha */      
/* 8034DA24  39 04 20 00 */	addi r8, r4, 0x2000 /* 0xCC002000@l */   /* constant-address: CC002000 */
/* 8034DA28  A4 08 00 2C */	lhzu r0, 0x2c(r8)                        /* constant-address: CC00202C */
/* 8034DA2C  38 A4 20 00 */	addi r5, r4, 0x2000                      /* constant-address: CC002000 */
/* 8034DA30  54 06 05 7E */	clrlwi r6, r0, 0x15                     
lbl_8034DA34:
/* 8034DA34  A0 08 00 00 */	lhz r0, 0(r8)                            /* constant-address: CC00202C */
/* 8034DA38  7C C7 33 78 */	mr r7, r6                               
/* 8034DA3C  A0 85 00 2E */	lhz r4, 0x2e(r5)                         /* constant-address: CC00202E */
/* 8034DA40  54 06 05 7E */	clrlwi r6, r0, 0x15                     
/* 8034DA44  7C 07 30 40 */	cmplw r7, r6                            
/* 8034DA48  54 87 05 7E */	clrlwi r7, r4, 0x15                     
/* 8034DA4C  40 82 FF E8 */	bne lbl_8034DA34                         /* constant-address: 8034DA34, symbol: lbl_8034DA34 */
/* 8034DA50  80 8D 92 A8 */	lwz r4, CurrTiming(r13)                  /* constant-address: 80451828, symbol: CurrTiming */
...
/* 8034DA6C  4B FE FC B1 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8034DA70  A0 1F 00 18 */	lhz r0, 0x18(r31)                       
/* 8034DA74  7C 1E 00 40 */	cmplw r30, r0                           
/* 8034DA78  41 80 00 08 */	blt lbl_8034DA80                         /* constant-address: 8034DA80, symbol: lbl_8034DA80 */

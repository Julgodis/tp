...
/* 8034C334  90 04 00 CC */	stw r0, 0x00CC(r4)                       /* constant-address: 800000CC */
/* 8034C338  4B FF FF 31 */	bl getTiming                             /* constant-address: 8034C268, symbol: getTiming */
/* 8034C33C  3C 80 CC 00 */	lis r4, 0xCC00 /* 0xCC002000@ha */      
/* 8034C340  38 00 00 02 */	li r0, 2                                
/* 8034C344  38 A4 20 00 */	addi r5, r4, 0x2000 /* 0xCC002000@l */   /* constant-address: CC002000 */
/* 8034C348  B4 05 00 02 */	sthu r0, 2(r5)                           /* constant-address: CC002002 */
...
/* 8034C35C  40 80 00 20 */	bge lbl_8034C37C                         /* constant-address: 8034C37C, symbol: lbl_8034C37C */
/* 8034C360  48 00 00 10 */	b lbl_8034C370                           /* constant-address: 8034C370, symbol: lbl_8034C370 */
lbl_8034C364:
...
/* 8034C378  41 80 FF EC */	blt lbl_8034C364                         /* constant-address: 8034C364, symbol: lbl_8034C364 */
lbl_8034C37C:
/* 8034C37C  38 00 00 00 */	li r0, 0                                
/* 8034C380  B0 05 00 00 */	sth r0, 0(r5)                            /* constant-address: CC002002 */
...
/* 8034C398  B0 0B 20 06 */	sth r0, 0x2006(r11)                      /* constant-address: CC002006 */
...
/* 8034C3AC  B1 2B 20 04 */	sth r9, 0x2004(r11)                      /* constant-address: CC002004 */
...
/* 8034C3C0  B1 0B 20 0A */	sth r8, 0x200a(r11)                      /* constant-address: CC00200A */
/* 8034C3C4  A1 03 00 20 */	lhz r8, 0x20(r3)                        
/* 8034C3C8  55 08 0C 3C */	rlwinm r8, r8, 1, 0x10, 0x1e            
/* 8034C3CC  B1 0B 20 08 */	sth r8, 0x2008(r11)                      /* constant-address: CC002008 */
...
/* 8034C3E4  B1 4B 20 00 */	sth r10, 0x2000(r11)                     /* constant-address: CC002000 */
/* 8034C3E8  7D 09 42 14 */	add r8, r9, r8                          
/* 8034C3EC  B1 0B 20 0E */	sth r8, 0x200e(r11)                      /* constant-address: CC00200E */
/* 8034C3F0  A1 03 00 08 */	lhz r8, 8(r3)                           
/* 8034C3F4  39 08 00 02 */	addi r8, r8, 2                          
/* 8034C3F8  B1 0B 20 0C */	sth r8, 0x200c(r11)                      /* constant-address: CC00200C */
...
/* 8034C410  B1 0B 20 12 */	sth r8, 0x2012(r11)                      /* constant-address: CC002012 */
/* 8034C414  A1 03 00 0A */	lhz r8, 0xa(r3)                         
/* 8034C418  39 08 00 02 */	addi r8, r8, 2                          
/* 8034C41C  B1 0B 20 10 */	sth r8, 0x2010(r11)                      /* constant-address: CC002010 */
...
/* 8034C430  B1 0B 20 16 */	sth r8, 0x2016(r11)                      /* constant-address: CC002016 */
...
/* 8034C444  B1 0B 20 14 */	sth r8, 0x2014(r11)                      /* constant-address: CC002014 */
...
/* 8034C458  B1 0B 20 1A */	sth r8, 0x201a(r11)                      /* constant-address: CC00201A */
...
/* 8034C46C  B1 0B 20 18 */	sth r8, 0x2018(r11)                      /* constant-address: CC002018 */
/* 8034C470  B0 EB 20 48 */	sth r7, 0x2048(r11)                      /* constant-address: CC002048 */
/* 8034C474  B0 CB 20 36 */	sth r6, 0x2036(r11)                      /* constant-address: CC002036 */
/* 8034C478  B0 0B 20 34 */	sth r0, 0x2034(r11)                      /* constant-address: CC002034 */
...
/* 8034C490  B0 0B 20 32 */	sth r0, 0x2032(r11)                      /* constant-address: CC002032 */
/* 8034C494  38 66 00 01 */	addi r3, r6, 1                          
/* 8034C498  60 60 10 00 */	ori r0, r3, 0x1000                      
/* 8034C49C  B0 0B 20 30 */	sth r0, 0x2030(r11)                      /* constant-address: CC002030 */
/* 8034C4A0  40 80 00 18 */	bge lbl_8034C4B8                         /* constant-address: 8034C4B8, symbol: lbl_8034C4B8 */
/* 8034C4A4  2C 1E 00 01 */	cmpwi r30, 1                            
/* 8034C4A8  40 80 00 08 */	bge lbl_8034C4B0                         /* constant-address: 8034C4B0, symbol: lbl_8034C4B0 */
/* 8034C4AC  48 00 00 0C */	b lbl_8034C4B8                           /* constant-address: 8034C4B8, symbol: lbl_8034C4B8 */
lbl_8034C4B0:
/* 8034C4B0  7F C3 F3 78 */	mr r3, r30                              
/* 8034C4B4  48 00 00 08 */	b lbl_8034C4BC                           /* constant-address: 8034C4BC, symbol: lbl_8034C4BC */
lbl_8034C4B8:
/* 8034C4B8  38 60 00 00 */	li r3, 0                                
lbl_8034C4BC:
/* 8034C4BC  28 1F 00 01 */	cmplwi r31, 1                           
/* 8034C4C0  41 81 00 24 */	bgt lbl_8034C4E4                         /* constant-address: 8034C4E4, symbol: lbl_8034C4E4 */
/* 8034C4C4  57 E0 17 7A */	rlwinm r0, r31, 2, 0x1d, 0x1d           
/* 8034C4C8  60 00 00 01 */	ori r0, r0, 1                           
/* 8034C4CC  50 60 40 2E */	rlwimi r0, r3, 8, 0, 0x17               
/* 8034C4D0  B0 05 00 00 */	sth r0, 0(r5)                            /* constant-address: CC002002 */
/* 8034C4D4  3C 60 CC 00 */	lis r3, 0xCC00 /* 0xCC00206C@ha */      
/* 8034C4D8  38 00 00 00 */	li r0, 0                                
/* 8034C4DC  B0 03 20 6C */	sth r0, 0x206C(r3)                       /* constant-address: CC00206C */
/* 8034C4E0  48 00 00 1C */	b lbl_8034C4FC                           /* constant-address: 8034C4FC, symbol: lbl_8034C4FC */
lbl_8034C4E4:
/* 8034C4E4  54 60 40 2E */	slwi r0, r3, 8                          
/* 8034C4E8  60 00 00 05 */	ori r0, r0, 5                           
/* 8034C4EC  B0 05 00 00 */	sth r0, 0(r5)                            /* constant-address: CC002002 */
/* 8034C4F0  3C 60 CC 00 */	lis r3, 0xCC00 /* 0xCC00206C@ha */      
/* 8034C4F4  38 00 00 01 */	li r0, 1                                
/* 8034C4F8  B0 03 20 6C */	sth r0, 0x206C(r3)                       /* constant-address: CC00206C */
lbl_8034C4FC:

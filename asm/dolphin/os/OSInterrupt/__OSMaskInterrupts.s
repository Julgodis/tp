...
/* 8033DAD8  4B FF FC 1D */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8033DADC  3C 80 80 00 */	lis r4, 0x8000 /* 0x800000C4@ha */      
/* 8033DAE0  83 A4 00 C4 */	lwz r29, 0x00C4(r4)                      /* constant-address: 800000C4 */
/* 8033DAE4  7C 7E 1B 78 */	mr r30, r3                              
/* 8033DAE8  80 A4 00 C8 */	lwz r5, 0xc8(r4)                         /* constant-address: 800000C8 */
/* 8033DAEC  7F A0 2B 78 */	or r0, r29, r5                          
/* 8033DAF0  7F E3 00 78 */	andc r3, r31, r0                        
/* 8033DAF4  7F FF EB 78 */	or r31, r31, r29                        
/* 8033DAF8  93 E4 00 C4 */	stw r31, 0xc4(r4)                        /* constant-address: 800000C4 */
/* 8033DAFC  7F FF 2B 78 */	or r31, r31, r5                         
/* 8033DB00  48 00 00 04 */	b lbl_8033DB04                           /* constant-address: 8033DB04, symbol: lbl_8033DB04 */
lbl_8033DB04:
/* 8033DB04  48 00 00 04 */	b lbl_8033DB08                           /* constant-address: 8033DB08, symbol: lbl_8033DB08 */
lbl_8033DB08:
/* 8033DB08  48 00 00 0C */	b lbl_8033DB14                           /* constant-address: 8033DB14, symbol: lbl_8033DB14 */
lbl_8033DB0C:
/* 8033DB0C  7F E4 FB 78 */	mr r4, r31                              
/* 8033DB10  4B FF FC D5 */	bl SetInterruptMask                      /* constant-address: 8033D7E4, symbol: SetInterruptMask */
lbl_8033DB14:
/* 8033DB14  28 03 00 00 */	cmplwi r3, 0                            
/* 8033DB18  40 82 FF F4 */	bne lbl_8033DB0C                         /* constant-address: 8033DB0C, symbol: lbl_8033DB0C */
/* 8033DB1C  7F C3 F3 78 */	mr r3, r30                              
/* 8033DB20  4B FF FB FD */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

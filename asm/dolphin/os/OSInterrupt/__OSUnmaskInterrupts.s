...
/* 8033DB60  4B FF FB 95 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8033DB64  3C 80 80 00 */	lis r4, 0x8000 /* 0x800000C4@ha */      
/* 8033DB68  83 A4 00 C4 */	lwz r29, 0x00C4(r4)                      /* constant-address: 800000C4 */
/* 8033DB6C  7C 7E 1B 78 */	mr r30, r3                              
/* 8033DB70  80 A4 00 C8 */	lwz r5, 0xc8(r4)                         /* constant-address: 800000C8 */
/* 8033DB74  7F A0 2B 78 */	or r0, r29, r5                          
/* 8033DB78  7F E3 00 38 */	and r3, r31, r0                         
/* 8033DB7C  7F BF F8 78 */	andc r31, r29, r31                      
/* 8033DB80  93 E4 00 C4 */	stw r31, 0xc4(r4)                        /* constant-address: 800000C4 */
/* 8033DB84  7F FF 2B 78 */	or r31, r31, r5                         
/* 8033DB88  48 00 00 04 */	b lbl_8033DB8C                           /* constant-address: 8033DB8C, symbol: lbl_8033DB8C */
lbl_8033DB8C:
/* 8033DB8C  48 00 00 04 */	b lbl_8033DB90                           /* constant-address: 8033DB90, symbol: lbl_8033DB90 */
lbl_8033DB90:
/* 8033DB90  48 00 00 0C */	b lbl_8033DB9C                           /* constant-address: 8033DB9C, symbol: lbl_8033DB9C */
lbl_8033DB94:
/* 8033DB94  7F E4 FB 78 */	mr r4, r31                              
/* 8033DB98  4B FF FC 4D */	bl SetInterruptMask                      /* constant-address: 8033D7E4, symbol: SetInterruptMask */
lbl_8033DB9C:
/* 8033DB9C  28 03 00 00 */	cmplwi r3, 0                            
/* 8033DBA0  40 82 FF F4 */	bne lbl_8033DB94                         /* constant-address: 8033DB94, symbol: lbl_8033DB94 */
/* 8033DBA4  7F C3 F3 78 */	mr r3, r30                              
/* 8033DBA8  4B FF FB 75 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

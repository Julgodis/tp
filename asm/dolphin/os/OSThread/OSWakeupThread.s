...
/* 80341CB0  4B FF BA 45 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80341CB4  3C 80 80 45 */	lis r4, RunQueue@ha                     
/* 80341CB8  3B E3 00 00 */	addi r31, r3, 0                         
/* 80341CBC  38 A4 BB 78 */	addi r5, r4, RunQueue@l                  /* constant-address: 8044BB78, symbol: RunQueue */
/* 80341CC0  48 00 00 9C */	b lbl_80341D5C                           /* constant-address: 80341D5C, symbol: lbl_80341D5C */
lbl_80341CC4:
/* 80341CC4  80 66 02 E0 */	lwz r3, 0x2e0(r6)                       
/* 80341CC8  28 03 00 00 */	cmplwi r3, 0                            
/* 80341CCC  40 82 00 10 */	bne lbl_80341CDC                         /* constant-address: 80341CDC, symbol: lbl_80341CDC */
/* 80341CD0  38 00 00 00 */	li r0, 0                                
/* 80341CD4  90 1E 00 04 */	stw r0, 4(r30)                          
/* 80341CD8  48 00 00 0C */	b lbl_80341CE4                           /* constant-address: 80341CE4, symbol: lbl_80341CE4 */
lbl_80341CDC:
...
/* 80341CF8  41 81 00 64 */	bgt lbl_80341D5C                         /* constant-address: 80341D5C, symbol: lbl_80341D5C */
...
/* 80341D18  40 82 00 0C */	bne lbl_80341D24                         /* constant-address: 80341D24, symbol: lbl_80341D24 */
/* 80341D1C  90 C4 00 00 */	stw r6, 0(r4)                           
/* 80341D20  48 00 00 08 */	b lbl_80341D28                           /* constant-address: 80341D28, symbol: lbl_80341D28 */
lbl_80341D24:
...
/* 80341D44  80 8D 91 40 */	lwz r4, RunQueueBits(r13)                /* constant-address: 804516C0, symbol: RunQueueBits */
/* 80341D48  20 00 00 1F */	subfic r0, r0, 0x1f                     
/* 80341D4C  7C 60 00 30 */	slw r0, r3, r0                          
/* 80341D50  7C 80 03 78 */	or r0, r4, r0                           
/* 80341D54  90 0D 91 40 */	stw r0, RunQueueBits(r13)                /* constant-address: 804516C0, symbol: RunQueueBits */
/* 80341D58  90 6D 91 44 */	stw r3, RunQueueHint(r13)                /* constant-address: 804516C4, symbol: RunQueueHint */
lbl_80341D5C:
/* 80341D5C  80 DE 00 00 */	lwz r6, 0(r30)                          
/* 80341D60  28 06 00 00 */	cmplwi r6, 0                            
/* 80341D64  40 82 FF 60 */	bne lbl_80341CC4                         /* constant-address: 80341CC4, symbol: lbl_80341CC4 */
/* 80341D68  80 0D 91 44 */	lwz r0, RunQueueHint(r13)                /* constant-address: 804516C4, symbol: RunQueueHint */
/* 80341D6C  2C 00 00 00 */	cmpwi r0, 0                             
/* 80341D70  41 82 00 0C */	beq lbl_80341D7C                         /* constant-address: 80341D7C, symbol: lbl_80341D7C */
/* 80341D74  38 60 00 00 */	li r3, 0                                
/* 80341D78  4B FF F2 81 */	bl SelectThread                          /* constant-address: 80340FF8, symbol: SelectThread */
lbl_80341D7C:
/* 80341D7C  7F E3 FB 78 */	mr r3, r31                              
/* 80341D80  4B FF B9 9D */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

...
/* 803417D0  4B FF BF 25 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 803417F0  40 80 00 10 */	bge lbl_80341800                         /* constant-address: 80341800, symbol: lbl_80341800 */
/* 803417F4  38 00 00 00 */	li r0, 0                                
/* 803417F8  90 1D 02 CC */	stw r0, 0x2cc(r29)                      
/* 803417FC  48 00 02 18 */	b lbl_80341A14                           /* constant-address: 80341A14, symbol: lbl_80341A14 */
lbl_80341800:
/* 80341800  40 82 02 14 */	bne lbl_80341A14                         /* constant-address: 80341A14, symbol: lbl_80341A14 */
/* 80341804  A0 1D 02 C8 */	lhz r0, 0x2c8(r29)                      
/* 80341808  2C 00 00 04 */	cmpwi r0, 4                             
/* 8034180C  41 82 00 B8 */	beq lbl_803418C4                         /* constant-address: 803418C4, symbol: lbl_803418C4 */
/* 80341810  40 80 01 F0 */	bge lbl_80341A00                         /* constant-address: 80341A00, symbol: lbl_80341A00 */
/* 80341814  2C 00 00 01 */	cmpwi r0, 1                             
/* 80341818  41 82 00 08 */	beq lbl_80341820                         /* constant-address: 80341820, symbol: lbl_80341820 */
/* 8034181C  48 00 01 E4 */	b lbl_80341A00                           /* constant-address: 80341A00, symbol: lbl_80341A00 */
lbl_80341820:
/* 80341820  80 1D 02 D4 */	lwz r0, 0x2d4(r29)                      
/* 80341824  80 7D 02 F4 */	lwz r3, 0x2f4(r29)                      
/* 80341828  48 00 00 24 */	b lbl_8034184C                           /* constant-address: 8034184C, symbol: lbl_8034184C */
lbl_8034182C:
/* 8034182C  80 83 00 00 */	lwz r4, 0(r3)                           
/* 80341830  28 04 00 00 */	cmplwi r4, 0                            
/* 80341834  41 82 00 14 */	beq lbl_80341848                         /* constant-address: 80341848, symbol: lbl_80341848 */
/* 80341838  80 84 02 D0 */	lwz r4, 0x2d0(r4)                       
/* 8034183C  7C 04 00 00 */	cmpw r4, r0                             
/* 80341840  40 80 00 08 */	bge lbl_80341848                         /* constant-address: 80341848, symbol: lbl_80341848 */
/* 80341844  7C 80 23 78 */	mr r0, r4                               
lbl_80341848:
/* 80341848  80 63 00 10 */	lwz r3, 0x10(r3)                        
lbl_8034184C:
/* 8034184C  28 03 00 00 */	cmplwi r3, 0                            
/* 80341850  40 82 FF DC */	bne lbl_8034182C                         /* constant-address: 8034182C, symbol: lbl_8034182C */
/* 80341854  90 1D 02 D0 */	stw r0, 0x2d0(r29)                      
/* 80341858  3C 60 80 45 */	lis r3, RunQueue@ha                     
/* 8034185C  38 03 BB 78 */	addi r0, r3, RunQueue@l                  /* constant-address: 8044BB78, symbol: RunQueue */
...
/* 8034187C  40 82 00 0C */	bne lbl_80341888                         /* constant-address: 80341888, symbol: lbl_80341888 */
/* 80341880  93 A4 00 00 */	stw r29, 0(r4)                          
/* 80341884  48 00 00 08 */	b lbl_8034188C                           /* constant-address: 8034188C, symbol: lbl_8034188C */
lbl_80341888:
...
/* 803418A8  80 8D 91 40 */	lwz r4, RunQueueBits(r13)                /* constant-address: 804516C0, symbol: RunQueueBits */
/* 803418AC  20 00 00 1F */	subfic r0, r0, 0x1f                     
/* 803418B0  7C 60 00 30 */	slw r0, r3, r0                          
/* 803418B4  7C 80 03 78 */	or r0, r4, r0                           
/* 803418B8  90 0D 91 40 */	stw r0, RunQueueBits(r13)                /* constant-address: 804516C0, symbol: RunQueueBits */
/* 803418BC  90 6D 91 44 */	stw r3, RunQueueHint(r13)                /* constant-address: 804516C4, symbol: RunQueueHint */
/* 803418C0  48 00 01 40 */	b lbl_80341A00                           /* constant-address: 80341A00, symbol: lbl_80341A00 */
lbl_803418C4:
/* 803418C4  80 9D 02 E0 */	lwz r4, 0x2e0(r29)                      
/* 803418C8  80 BD 02 E4 */	lwz r5, 0x2e4(r29)                      
/* 803418CC  28 04 00 00 */	cmplwi r4, 0                            
/* 803418D0  40 82 00 10 */	bne lbl_803418E0                         /* constant-address: 803418E0, symbol: lbl_803418E0 */
/* 803418D4  80 7D 02 DC */	lwz r3, 0x2dc(r29)                      
/* 803418D8  90 A3 00 04 */	stw r5, 4(r3)                           
/* 803418DC  48 00 00 08 */	b lbl_803418E4                           /* constant-address: 803418E4, symbol: lbl_803418E4 */
lbl_803418E0:
/* 803418E0  90 A4 02 E4 */	stw r5, 0x2e4(r4)                       
lbl_803418E4:
/* 803418E4  28 05 00 00 */	cmplwi r5, 0                            
/* 803418E8  40 82 00 10 */	bne lbl_803418F8                         /* constant-address: 803418F8, symbol: lbl_803418F8 */
/* 803418EC  80 7D 02 DC */	lwz r3, 0x2dc(r29)                      
/* 803418F0  90 83 00 00 */	stw r4, 0(r3)                           
/* 803418F4  48 00 00 08 */	b lbl_803418FC                           /* constant-address: 803418FC, symbol: lbl_803418FC */
lbl_803418F8:
/* 803418F8  90 85 02 E0 */	stw r4, 0x2e0(r5)                       
lbl_803418FC:
/* 803418FC  80 1D 02 D4 */	lwz r0, 0x2d4(r29)                      
/* 80341900  80 7D 02 F4 */	lwz r3, 0x2f4(r29)                      
/* 80341904  48 00 00 24 */	b lbl_80341928                           /* constant-address: 80341928, symbol: lbl_80341928 */
lbl_80341908:
/* 80341908  80 83 00 00 */	lwz r4, 0(r3)                           
/* 8034190C  28 04 00 00 */	cmplwi r4, 0                            
/* 80341910  41 82 00 14 */	beq lbl_80341924                         /* constant-address: 80341924, symbol: lbl_80341924 */
/* 80341914  80 84 02 D0 */	lwz r4, 0x2d0(r4)                       
/* 80341918  7C 04 00 00 */	cmpw r4, r0                             
/* 8034191C  40 80 00 08 */	bge lbl_80341924                         /* constant-address: 80341924, symbol: lbl_80341924 */
/* 80341920  7C 80 23 78 */	mr r0, r4                               
lbl_80341924:
/* 80341924  80 63 00 10 */	lwz r3, 0x10(r3)                        
lbl_80341928:
/* 80341928  28 03 00 00 */	cmplwi r3, 0                            
/* 8034192C  40 82 FF DC */	bne lbl_80341908                         /* constant-address: 80341908, symbol: lbl_80341908 */
/* 80341930  90 1D 02 D0 */	stw r0, 0x2d0(r29)                      
/* 80341934  80 9D 02 DC */	lwz r4, 0x2dc(r29)                      
/* 80341938  80 A4 00 00 */	lwz r5, 0(r4)                           
/* 8034193C  48 00 00 08 */	b lbl_80341944                           /* constant-address: 80341944, symbol: lbl_80341944 */
lbl_80341940:
/* 80341940  80 A5 02 E0 */	lwz r5, 0x2e0(r5)                       
lbl_80341944:
/* 80341944  28 05 00 00 */	cmplwi r5, 0                            
/* 80341948  41 82 00 14 */	beq lbl_8034195C                         /* constant-address: 8034195C, symbol: lbl_8034195C */
/* 8034194C  80 65 02 D0 */	lwz r3, 0x2d0(r5)                       
/* 80341950  80 1D 02 D0 */	lwz r0, 0x2d0(r29)                      
/* 80341954  7C 03 00 00 */	cmpw r3, r0                             
/* 80341958  40 81 FF E8 */	ble lbl_80341940                         /* constant-address: 80341940, symbol: lbl_80341940 */
lbl_8034195C:
/* 8034195C  28 05 00 00 */	cmplwi r5, 0                            
/* 80341960  40 82 00 34 */	bne lbl_80341994                         /* constant-address: 80341994, symbol: lbl_80341994 */
/* 80341964  80 64 00 04 */	lwz r3, 4(r4)                           
/* 80341968  28 03 00 00 */	cmplwi r3, 0                            
/* 8034196C  40 82 00 0C */	bne lbl_80341978                         /* constant-address: 80341978, symbol: lbl_80341978 */
/* 80341970  93 A4 00 00 */	stw r29, 0(r4)                          
/* 80341974  48 00 00 08 */	b lbl_8034197C                           /* constant-address: 8034197C, symbol: lbl_8034197C */
lbl_80341978:
...
/* 80341990  48 00 00 2C */	b lbl_803419BC                           /* constant-address: 803419BC, symbol: lbl_803419BC */
lbl_80341994:
...
/* 803419A8  40 82 00 10 */	bne lbl_803419B8                         /* constant-address: 803419B8, symbol: lbl_803419B8 */
/* 803419AC  80 7D 02 DC */	lwz r3, 0x2dc(r29)                      
/* 803419B0  93 A3 00 00 */	stw r29, 0(r3)                          
/* 803419B4  48 00 00 08 */	b lbl_803419BC                           /* constant-address: 803419BC, symbol: lbl_803419BC */
lbl_803419B8:
/* 803419B8  93 A3 02 E0 */	stw r29, 0x2e0(r3)                      
lbl_803419BC:
/* 803419BC  80 7D 02 F0 */	lwz r3, 0x2f0(r29)                      
/* 803419C0  28 03 00 00 */	cmplwi r3, 0                            
/* 803419C4  41 82 00 3C */	beq lbl_80341A00                         /* constant-address: 80341A00, symbol: lbl_80341A00 */
/* 803419C8  83 A3 00 08 */	lwz r29, 8(r3)                          
lbl_803419CC:
/* 803419CC  80 1D 02 CC */	lwz r0, 0x2cc(r29)                      
/* 803419D0  2C 00 00 00 */	cmpwi r0, 0                             
/* 803419D4  41 81 00 2C */	bgt lbl_80341A00                         /* constant-address: 80341A00, symbol: lbl_80341A00 */
/* 803419D8  7F A3 EB 78 */	mr r3, r29                              
/* 803419DC  4B FF F3 D1 */	bl __OSGetEffectivePriority              /* constant-address: 80340DAC, symbol: __OSGetEffectivePriority */
/* 803419E0  80 1D 02 D0 */	lwz r0, 0x2d0(r29)                      
/* 803419E4  38 83 00 00 */	addi r4, r3, 0                          
/* 803419E8  7C 00 20 00 */	cmpw r0, r4                             
/* 803419EC  41 82 00 14 */	beq lbl_80341A00                         /* constant-address: 80341A00, symbol: lbl_80341A00 */
/* 803419F0  7F A3 EB 78 */	mr r3, r29                              
/* 803419F4  4B FF F3 F5 */	bl SetEffectivePriority                  /* constant-address: 80340DE8, symbol: SetEffectivePriority */
/* 803419F8  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 803419FC  40 82 FF D0 */	bne lbl_803419CC                         /* constant-address: 803419CC, symbol: lbl_803419CC */
lbl_80341A00:
/* 80341A00  80 0D 91 44 */	lwz r0, RunQueueHint(r13)                /* constant-address: 804516C4, symbol: RunQueueHint */
/* 80341A04  2C 00 00 00 */	cmpwi r0, 0                             
/* 80341A08  41 82 00 0C */	beq lbl_80341A14                         /* constant-address: 80341A14, symbol: lbl_80341A14 */
/* 80341A0C  38 60 00 00 */	li r3, 0                                
/* 80341A10  4B FF F5 E9 */	bl SelectThread                          /* constant-address: 80340FF8, symbol: SelectThread */
lbl_80341A14:
/* 80341A14  7F E3 FB 78 */	mr r3, r31                              
/* 80341A18  4B FF BD 05 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

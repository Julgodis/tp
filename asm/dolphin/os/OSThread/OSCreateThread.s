...
/* 803412B0  41 80 00 0C */	blt lbl_803412BC                         /* constant-address: 803412BC, symbol: lbl_803412BC */
/* 803412B4  2C 08 00 1F */	cmpwi r8, 0x1f                          
/* 803412B8  40 81 00 0C */	ble lbl_803412C4                         /* constant-address: 803412C4, symbol: lbl_803412C4 */
lbl_803412BC:
/* 803412BC  38 60 00 00 */	li r3, 0                                
/* 803412C0  48 00 01 A0 */	b lbl_80341460                           /* constant-address: 80341460, symbol: lbl_80341460 */
lbl_803412C4:
...
/* 80341314  4B FF AD 11 */	bl OSInitContext                         /* constant-address: 8033C024, symbol: OSInitContext */
/* 80341318  3C 60 80 34 */	lis r3, OSExitThread@ha                 
/* 8034131C  38 03 14 74 */	addi r0, r3, OSExitThread@l              /* constant-address: 80341474, symbol: OSExitThread */
...
/* 80341330  38 03 BA BE */	addi r0, r3, 0xBABE /* 0xDEADBABE@l */   /* constant-address: DEADBABE */
...
/* 80341350  4B FF C3 A5 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 80341354  3C 80 80 45 */	lis r4, __OSErrorTable@ha               
/* 80341358  38 84 BA D0 */	addi r4, r4, __OSErrorTable@l            /* constant-address: 8044BAD0, symbol: __OSErrorTable */
/* 8034135C  80 04 00 40 */	lwz r0, 0x40(r4)                         /* constant-address: 8044BB10, symbol: None */
/* 80341360  28 00 00 00 */	cmplwi r0, 0                            
/* 80341364  41 82 00 C4 */	beq lbl_80341428                         /* constant-address: 80341428, symbol: lbl_80341428 */
...
/* 8034138C  80 0D 84 20 */	lwz r0, __OSFpscrEnableBits(r13)         /* constant-address: 804509A0, symbol: __OSFpscrEnableBits */
...
/* 80341424  42 00 FF 78 */	bdnz lbl_8034139C                        /* constant-address: 8034139C, symbol: lbl_8034139C */
lbl_80341428:
/* 80341428  3C 80 80 00 */	lis r4, 0x8000 /* 0x800000DC@ha */      
/* 8034142C  38 A4 00 DC */	addi r5, r4, 0x00DC /* 0x800000DC@l */   /* constant-address: 800000DC */
/* 80341430  84 C5 00 04 */	lwzu r6, 4(r5)                           /* constant-address: 800000E0 */
/* 80341434  28 06 00 00 */	cmplwi r6, 0                            
/* 80341438  40 82 00 0C */	bne lbl_80341444                         /* constant-address: 80341444, symbol: lbl_80341444 */
/* 8034143C  93 E4 00 DC */	stw r31, 0xdc(r4)                        /* constant-address: 800000DC */
/* 80341440  48 00 00 08 */	b lbl_80341448                           /* constant-address: 80341448, symbol: lbl_80341448 */
lbl_80341444:
...
/* 80341454  93 E5 00 00 */	stw r31, 0(r5)                           /* constant-address: 800000E0 */
/* 80341458  4B FF C2 C5 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

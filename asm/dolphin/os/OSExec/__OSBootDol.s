...
/* 8033D270  48 00 23 DD */	bl OSGetSaveRegion                       /* constant-address: 8033F64C, symbol: OSGetSaveRegion */
/* 8033D274  7F E5 FB 78 */	mr r5, r31                              
/* 8033D278  4C C6 31 82 */	crclr 6                                 
/* 8033D27C  38 61 00 1C */	addi r3, r1, 0x1c                       
/* 8033D280  38 8D 84 28 */	la r4, lit_213(r13) /* 804509A8-_SDA_BASE_ */ /* constant-address: 804509A8, symbol: lit_213 */
/* 8033D284  48 02 92 59 */	bl sprintf                               /* constant-address: 803664DC, symbol: sprintf */
/* 8033D288  28 1E 00 00 */	cmplwi r30, 0                           
/* 8033D28C  3B E0 00 00 */	li r31, 0                               
/* 8033D290  41 82 00 28 */	beq lbl_8033D2B8                         /* constant-address: 8033D2B8, symbol: lbl_8033D2B8 */
/* 8033D294  7F C3 F3 78 */	mr r3, r30                              
/* 8033D298  48 00 00 04 */	b lbl_8033D29C                           /* constant-address: 8033D29C, symbol: lbl_8033D29C */
lbl_8033D29C:
/* 8033D29C  48 00 00 04 */	b lbl_8033D2A0                           /* constant-address: 8033D2A0, symbol: lbl_8033D2A0 */
lbl_8033D2A0:
/* 8033D2A0  48 00 00 0C */	b lbl_8033D2AC                           /* constant-address: 8033D2AC, symbol: lbl_8033D2AC */
lbl_8033D2A4:
/* 8033D2A4  38 63 00 04 */	addi r3, r3, 4                          
/* 8033D2A8  3B FF 00 01 */	addi r31, r31, 1                         /* constant-address: 00000001 */
lbl_8033D2AC:
/* 8033D2AC  80 03 00 00 */	lwz r0, 0(r3)                           
/* 8033D2B0  28 00 00 00 */	cmplwi r0, 0                            
/* 8033D2B4  40 82 FF F0 */	bne lbl_8033D2A4                         /* constant-address: 8033D2A4, symbol: lbl_8033D2A4 */
lbl_8033D2B8:
/* 8033D2B8  38 1F 00 02 */	addi r0, r31, 2                          /* constant-address: 00000002 */
/* 8033D2BC  54 03 10 3A */	slwi r3, r0, 2                          
/* 8033D2C0  38 80 00 01 */	li r4, 1                                
/* 8033D2C4  4B FF DF E9 */	bl OSAllocFromArenaLo                    /* constant-address: 8033B2AC, symbol: OSAllocFromArenaLo */
...
/* 8033D2D8  48 00 00 04 */	b lbl_8033D2DC                           /* constant-address: 8033D2DC, symbol: lbl_8033D2DC */
lbl_8033D2DC:
/* 8033D2DC  39 1F 00 01 */	addi r8, r31, 1                          /* constant-address: 00000001 */
/* 8033D2E0  2C 08 00 01 */	cmpwi r8, 1                             
/* 8033D2E4  38 88 FF FF */	addi r4, r8, -1                         
/* 8033D2E8  40 81 00 C0 */	ble lbl_8033D3A8                         /* constant-address: 8033D3A8, symbol: lbl_8033D3A8 */
/* 8033D2EC  54 80 E8 FE */	srwi r0, r4, 3                          
/* 8033D2F0  28 00 00 00 */	cmplwi r0, 0                            
/* 8033D2F4  7C 09 03 A6 */	mtctr r0                                
/* 8033D2F8  41 82 00 94 */	beq lbl_8033D38C                         /* constant-address: 8033D38C, symbol: lbl_8033D38C */
/* 8033D2FC  48 00 00 04 */	b lbl_8033D300                           /* constant-address: 8033D300, symbol: lbl_8033D300 */
lbl_8033D300:
...
/* 8033D380  42 00 FF 80 */	bdnz lbl_8033D300                        /* constant-address: 8033D300, symbol: lbl_8033D300 */
/* 8033D384  70 84 00 07 */	andi. r4, r4, 7                         
/* 8033D388  41 82 00 20 */	beq lbl_8033D3A8                         /* constant-address: 8033D3A8, symbol: lbl_8033D3A8 */
lbl_8033D38C:
/* 8033D38C  7C 89 03 A6 */	mtctr r4                                
/* 8033D390  48 00 00 04 */	b lbl_8033D394                           /* constant-address: 8033D394, symbol: lbl_8033D394 */
lbl_8033D394:
...
/* 8033D3A4  42 00 FF F0 */	bdnz lbl_8033D394                        /* constant-address: 8033D394, symbol: lbl_8033D394 */
lbl_8033D3A8:
...
/* 8033D3C0  4B FF FA 01 */	bl __OSBootDolSimple                     /* constant-address: 8033CDC0, symbol: __OSBootDolSimple */

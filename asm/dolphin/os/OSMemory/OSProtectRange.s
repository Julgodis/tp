...
/* 8033ED2C  40 80 00 98 */	bge lbl_8033EDC4                         /* constant-address: 8033EDC4, symbol: lbl_8033EDC4 */
...
/* 8033ED4C  4B FF C8 61 */	bl DCFlushRange                          /* constant-address: 8033B5AC, symbol: DCFlushRange */
/* 8033ED50  4B FF E9 A5 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8033ED64  4B FF ED 59 */	bl __OSMaskInterrupts                    /* constant-address: 8033DABC, symbol: __OSMaskInterrupts */
/* 8033ED68  3C 60 CC 00 */	lis r3, 0xCC00 /* 0xCC004000@ha */      
/* 8033ED6C  38 A3 40 00 */	addi r5, r3, 0x4000 /* 0xCC004000@l */   /* constant-address: CC004000 */
...
/* 8033ED88  38 85 00 10 */	addi r4, r5, 0x10                        /* constant-address: CC004010 */
/* 8033ED8C  57 46 08 3C */	slwi r6, r26, 1                         
/* 8033ED90  38 00 00 03 */	li r0, 3                                
/* 8033ED94  A0 A5 00 10 */	lhz r5, 0x10(r5)                         /* constant-address: CC004010 */
...
/* 8033EDAC  B0 A4 00 00 */	sth r5, 0(r4)                            /* constant-address: CC004010 */
/* 8033EDB0  41 82 00 0C */	beq lbl_8033EDBC                         /* constant-address: 8033EDBC, symbol: lbl_8033EDBC */
/* 8033EDB4  7F C3 F3 78 */	mr r3, r30                              
/* 8033EDB8  4B FF ED 8D */	bl __OSUnmaskInterrupts                  /* constant-address: 8033DB44, symbol: __OSUnmaskInterrupts */
lbl_8033EDBC:
/* 8033EDBC  7F 83 E3 78 */	mr r3, r28                              
/* 8033EDC0  4B FF E9 5D */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
lbl_8033EDC4:

...
/* 8033F138  4B FF E5 BD */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8033F13C  7C 7F 1B 78 */	mr r31, r3                              
/* 8033F140  48 00 1B 45 */	bl OSGetCurrentThread                    /* constant-address: 80340C84, symbol: OSGetCurrentThread */
/* 8033F144  80 1D 00 08 */	lwz r0, 8(r29)                          
/* 8033F148  3B C3 00 00 */	addi r30, r3, 0                         
/* 8033F14C  7C 00 F0 40 */	cmplw r0, r30                           
/* 8033F150  40 82 00 70 */	bne lbl_8033F1C0                         /* constant-address: 8033F1C0, symbol: lbl_8033F1C0 */
/* 8033F154  80 7D 00 0C */	lwz r3, 0xc(r29)                        
/* 8033F158  34 03 FF FF */	addic. r0, r3, -1                       
/* 8033F15C  90 1D 00 0C */	stw r0, 0xc(r29)                        
/* 8033F160  40 82 00 60 */	bne lbl_8033F1C0                         /* constant-address: 8033F1C0, symbol: lbl_8033F1C0 */
/* 8033F164  80 7D 00 10 */	lwz r3, 0x10(r29)                       
/* 8033F168  80 9D 00 14 */	lwz r4, 0x14(r29)                       
/* 8033F16C  28 03 00 00 */	cmplwi r3, 0                            
/* 8033F170  40 82 00 0C */	bne lbl_8033F17C                         /* constant-address: 8033F17C, symbol: lbl_8033F17C */
/* 8033F174  90 9E 02 F8 */	stw r4, 0x2f8(r30)                      
/* 8033F178  48 00 00 08 */	b lbl_8033F180                           /* constant-address: 8033F180, symbol: lbl_8033F180 */
lbl_8033F17C:
/* 8033F17C  90 83 00 14 */	stw r4, 0x14(r3)                        
lbl_8033F180:
/* 8033F180  28 04 00 00 */	cmplwi r4, 0                            
/* 8033F184  40 82 00 0C */	bne lbl_8033F190                         /* constant-address: 8033F190, symbol: lbl_8033F190 */
/* 8033F188  90 7E 02 F4 */	stw r3, 0x2f4(r30)                      
/* 8033F18C  48 00 00 08 */	b lbl_8033F194                           /* constant-address: 8033F194, symbol: lbl_8033F194 */
lbl_8033F190:
...
/* 8033F1A8  40 80 00 10 */	bge lbl_8033F1B8                         /* constant-address: 8033F1B8, symbol: lbl_8033F1B8 */
/* 8033F1AC  7F C3 F3 78 */	mr r3, r30                              
/* 8033F1B0  48 00 1B FD */	bl __OSGetEffectivePriority              /* constant-address: 80340DAC, symbol: __OSGetEffectivePriority */
/* 8033F1B4  90 7E 02 D0 */	stw r3, 0x2d0(r30)                      
lbl_8033F1B8:
/* 8033F1B8  7F A3 EB 78 */	mr r3, r29                              
/* 8033F1BC  48 00 2A DD */	bl OSWakeupThread                        /* constant-address: 80341C98, symbol: OSWakeupThread */
lbl_8033F1C0:
/* 8033F1C0  7F E3 FB 78 */	mr r3, r31                              
/* 8033F1C4  4B FF E5 59 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

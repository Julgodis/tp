...
/* 8033F060  4B FF E6 95 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8033F064  7C 7D 1B 78 */	mr r29, r3                              
/* 8033F068  48 00 1C 1D */	bl OSGetCurrentThread                    /* constant-address: 80340C84, symbol: OSGetCurrentThread */
...
/* 8033F07C  40 82 00 40 */	bne lbl_8033F0BC                         /* constant-address: 8033F0BC, symbol: lbl_8033F0BC */
...
/* 8033F098  40 82 00 0C */	bne lbl_8033F0A4                         /* constant-address: 8033F0A4, symbol: lbl_8033F0A4 */
/* 8033F09C  93 9E 02 F4 */	stw r28, 0x2f4(r30)                     
/* 8033F0A0  48 00 00 08 */	b lbl_8033F0A8                           /* constant-address: 8033F0A8, symbol: lbl_8033F0A8 */
lbl_8033F0A4:
...
/* 8033F0B8  48 00 00 3C */	b lbl_8033F0F4                           /* constant-address: 8033F0F4, symbol: lbl_8033F0F4 */
lbl_8033F0BC:
/* 8033F0BC  7C 00 F0 40 */	cmplw r0, r30                           
/* 8033F0C0  40 82 00 14 */	bne lbl_8033F0D4                         /* constant-address: 8033F0D4, symbol: lbl_8033F0D4 */
/* 8033F0C4  80 7C 00 0C */	lwz r3, 0xc(r28)                        
/* 8033F0C8  38 03 00 01 */	addi r0, r3, 1                          
/* 8033F0CC  90 1C 00 0C */	stw r0, 0xc(r28)                        
/* 8033F0D0  48 00 00 24 */	b lbl_8033F0F4                           /* constant-address: 8033F0F4, symbol: lbl_8033F0F4 */
lbl_8033F0D4:
/* 8033F0D4  93 9E 02 F0 */	stw r28, 0x2f0(r30)                     
/* 8033F0D8  80 7C 00 08 */	lwz r3, 8(r28)                          
/* 8033F0DC  80 9E 02 D0 */	lwz r4, 0x2d0(r30)                      
/* 8033F0E0  48 00 1E C9 */	bl __OSPromoteThread                     /* constant-address: 80340FA8, symbol: __OSPromoteThread */
/* 8033F0E4  7F 83 E3 78 */	mr r3, r28                              
/* 8033F0E8  48 00 2A C5 */	bl OSSleepThread                         /* constant-address: 80341BAC, symbol: OSSleepThread */
/* 8033F0EC  93 FE 02 F0 */	stw r31, 0x2f0(r30)                     
/* 8033F0F0  4B FF FF 84 */	b lbl_8033F074                           /* constant-address: 8033F074, symbol: lbl_8033F074 */
lbl_8033F0F4:
/* 8033F0F4  7F A3 EB 78 */	mr r3, r29                              
/* 8033F0F8  4B FF E6 25 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

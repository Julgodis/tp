...
/* 8033C5A4  48 00 11 51 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8033C5A8  3C 80 80 45 */	lis r4, __OSErrorTable@ha               
/* 8033C5AC  57 A5 13 BA */	rlwinm r5, r29, 2, 0xe, 0x1d            
/* 8033C5B0  38 04 BA D0 */	addi r0, r4, __OSErrorTable@l            /* constant-address: 8044BAD0, symbol: __OSErrorTable */
...
/* 8033C5CC  40 82 01 A0 */	bne lbl_8033C76C                         /* constant-address: 8033C76C, symbol: lbl_8033C76C */
/* 8033C5D0  4B FF D6 F1 */	bl PPCMfmsr                              /* constant-address: 80339CC0, symbol: PPCMfmsr */
/* 8033C5D4  3B E3 00 00 */	addi r31, r3, 0                         
/* 8033C5D8  63 E3 20 00 */	ori r3, r31, 0x2000                     
/* 8033C5DC  4B FF D6 ED */	bl PPCMtmsr                              /* constant-address: 80339CC8, symbol: PPCMtmsr */
/* 8033C5E0  4B FF D7 65 */	bl PPCMffpscr                            /* constant-address: 80339D44, symbol: PPCMffpscr */
/* 8033C5E4  28 1C 00 00 */	cmplwi r28, 0                           
/* 8033C5E8  41 82 01 18 */	beq lbl_8033C700                         /* constant-address: 8033C700, symbol: lbl_8033C700 */
/* 8033C5EC  3C A0 80 00 */	lis r5, 0x8000 /* 0x800000DC@ha */      
/* 8033C5F0  3C 80 60 06 */	lis r4, 0x6006 /* 0x6005F8FF@ha */      
/* 8033C5F4  80 C5 00 DC */	lwz r6, 0x00DC(r5)                       /* constant-address: 800000DC */
/* 8033C5F8  38 84 F8 FF */	addi r4, r4, 0xF8FF /* 0x6005F8FF@l */   /* constant-address: 6005F8FF */
/* 8033C5FC  48 00 00 E8 */	b lbl_8033C6E4                           /* constant-address: 8033C6E4, symbol: lbl_8033C6E4 */
lbl_8033C600:
...
/* 8033C614  40 82 00 AC */	bne lbl_8033C6C0                         /* constant-address: 8033C6C0, symbol: lbl_8033C6C0 */
...
/* 8033C6B4  42 00 FF 78 */	bdnz lbl_8033C62C                        /* constant-address: 8033C62C, symbol: lbl_8033C62C */
/* 8033C6B8  38 00 00 04 */	li r0, 4                                
/* 8033C6BC  90 06 01 94 */	stw r0, 0x194(r6)                       
lbl_8033C6C0:
/* 8033C6C0  80 0D 84 20 */	lwz r0, __OSFpscrEnableBits(r13)         /* constant-address: 804509A0, symbol: __OSFpscrEnableBits */
...
/* 8033C6E8  40 82 FF 18 */	bne lbl_8033C600                         /* constant-address: 8033C600, symbol: lbl_8033C600 */
/* 8033C6EC  80 0D 84 20 */	lwz r0, __OSFpscrEnableBits(r13)         /* constant-address: 804509A0, symbol: __OSFpscrEnableBits */
/* 8033C6F0  63 FF 09 00 */	ori r31, r31, 0x900                     
/* 8033C6F4  54 00 06 38 */	rlwinm r0, r0, 0, 0x18, 0x1c            
/* 8033C6F8  7C 63 03 78 */	or r3, r3, r0                           
/* 8033C6FC  48 00 00 58 */	b lbl_8033C754                           /* constant-address: 8033C754, symbol: lbl_8033C754 */
lbl_8033C700:
/* 8033C700  3C A0 80 00 */	lis r5, 0x8000 /* 0x800000DC@ha */      
/* 8033C704  3C 80 60 06 */	lis r4, 0x6006 /* 0x6005F8FF@ha */      
/* 8033C708  80 C5 00 DC */	lwz r6, 0x00DC(r5)                       /* constant-address: 800000DC */
/* 8033C70C  38 84 F8 FF */	addi r4, r4, 0xF8FF /* 0x6005F8FF@l */   /* constant-address: 6005F8FF */
/* 8033C710  38 A0 F6 FF */	li r5, -2305                            
/* 8033C714  48 00 00 2C */	b lbl_8033C740                           /* constant-address: 8033C740, symbol: lbl_8033C740 */
lbl_8033C718:
...
/* 8033C744  40 82 FF D4 */	bne lbl_8033C718                         /* constant-address: 8033C718, symbol: lbl_8033C718 */
...
/* 8033C758  38 04 F8 FF */	addi r0, r4, 0xF8FF /* 0x6005F8FF@l */   /* constant-address: 6005F8FF */
/* 8033C75C  7C 63 00 38 */	and r3, r3, r0                          
/* 8033C760  4B FF D6 05 */	bl PPCMtfpscr                            /* constant-address: 80339D64, symbol: PPCMtfpscr */
/* 8033C764  7F E3 FB 78 */	mr r3, r31                              
/* 8033C768  4B FF D5 61 */	bl PPCMtmsr                              /* constant-address: 80339CC8, symbol: PPCMtmsr */
lbl_8033C76C:
/* 8033C76C  7F A3 EB 78 */	mr r3, r29                              
/* 8033C770  48 00 0F AD */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */

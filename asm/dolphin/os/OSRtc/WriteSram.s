...
/* 8033FEFC  38 06 FE 90 */	addi r0, r6, WriteSramCallback@l         /* constant-address: 8033FE90, symbol: WriteSramCallback */
...
/* 8033FF28  48 00 41 01 */	bl EXILock                               /* constant-address: 80344028, symbol: EXILock */
/* 8033FF2C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8033FF30  40 82 00 0C */	bne lbl_8033FF3C                         /* constant-address: 8033FF3C, symbol: lbl_8033FF3C */
/* 8033FF34  38 60 00 00 */	li r3, 0                                
/* 8033FF38  48 00 00 B4 */	b lbl_8033FFEC                           /* constant-address: 8033FFEC, symbol: lbl_8033FFEC */
lbl_8033FF3C:
/* 8033FF3C  38 60 00 00 */	li r3, 0                                
/* 8033FF40  38 80 00 01 */	li r4, 1                                
/* 8033FF44  38 A0 00 03 */	li r5, 3                                
/* 8033FF48  48 00 39 21 */	bl EXISelect                             /* constant-address: 80343868, symbol: EXISelect */
/* 8033FF4C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8033FF50  40 82 00 14 */	bne lbl_8033FF64                         /* constant-address: 8033FF64, symbol: lbl_8033FF64 */
/* 8033FF54  38 60 00 00 */	li r3, 0                                
/* 8033FF58  48 00 41 C5 */	bl EXIUnlock                             /* constant-address: 8034411C, symbol: EXIUnlock */
/* 8033FF5C  38 60 00 00 */	li r3, 0                                
/* 8033FF60  48 00 00 8C */	b lbl_8033FFEC                           /* constant-address: 8033FFEC, symbol: lbl_8033FFEC */
lbl_8033FF64:
...
/* 8033FF88  48 00 2D 79 */	bl EXIImm                                /* constant-address: 80342D00, symbol: EXIImm */
/* 8033FF8C  7C 60 00 34 */	cntlzw r0, r3                           
/* 8033FF90  54 1F D9 7E */	srwi r31, r0, 5                         
/* 8033FF94  38 60 00 00 */	li r3, 0                                
/* 8033FF98  48 00 31 51 */	bl EXISync                               /* constant-address: 803430E8, symbol: EXISync */
...
/* 8033FFB8  48 00 2F A5 */	bl EXIImmEx                              /* constant-address: 80342F5C, symbol: EXIImmEx */
...
/* 8033FFCC  48 00 39 C9 */	bl EXIDeselect                           /* constant-address: 80343994, symbol: EXIDeselect */
...
/* 8033FFE0  48 00 41 3D */	bl EXIUnlock                             /* constant-address: 8034411C, symbol: EXIUnlock */

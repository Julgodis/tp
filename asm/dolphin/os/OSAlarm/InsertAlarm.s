...
/* 8033A94C  41 82 00 7C */	beq lbl_8033A9C8                         /* constant-address: 8033A9C8, symbol: lbl_8033A9C8 */
/* 8033A950  48 00 7D CD */	bl __OSGetSystemTime                     /* constant-address: 8034271C, symbol: __OSGetSystemTime */
...
/* 8033A97C  41 82 00 4C */	beq lbl_8033A9C8                         /* constant-address: 8033A9C8, symbol: lbl_8033A9C8 */
...
/* 8033A998  48 02 79 8D */	bl __div2i                               /* constant-address: 80362324, symbol: __div2i */
...
/* 8033A9D8  80 CD 90 B8 */	lwz r6, AlarmQueue(r13)                  /* constant-address: 80451638, symbol: AlarmQueue */
/* 8033A9DC  48 00 00 C4 */	b lbl_8033AAA0                           /* constant-address: 8033AAA0, symbol: lbl_8033AAA0 */
lbl_8033A9E0:
...
/* 8033A9FC  41 82 00 A0 */	beq lbl_8033AA9C                         /* constant-address: 8033AA9C, symbol: lbl_8033AA9C */
...
/* 8033AA18  41 82 00 0C */	beq lbl_8033AA24                         /* constant-address: 8033AA24, symbol: lbl_8033AA24 */
/* 8033AA1C  93 A3 00 14 */	stw r29, 0x14(r3)                       
/* 8033AA20  48 00 01 24 */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AA24:
/* 8033AA24  93 AD 90 B8 */	stw r29, AlarmQueue(r13)                 /* constant-address: 80451638, symbol: AlarmQueue */
/* 8033AA28  48 00 7C F5 */	bl __OSGetSystemTime                     /* constant-address: 8034271C, symbol: __OSGetSystemTime */
...
/* 8033AA58  41 82 00 10 */	beq lbl_8033AA68                         /* constant-address: 8033AA68, symbol: lbl_8033AA68 */
/* 8033AA5C  38 60 00 00 */	li r3, 0                                
/* 8033AA60  4B FF F2 91 */	bl PPCMtdec                              /* constant-address: 80339CF0, symbol: PPCMtdec */
/* 8033AA64  48 00 00 E0 */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AA68:
...
/* 8033AA80  41 82 00 10 */	beq lbl_8033AA90                         /* constant-address: 8033AA90, symbol: lbl_8033AA90 */
/* 8033AA84  7D 03 43 78 */	mr r3, r8                               
/* 8033AA88  4B FF F2 69 */	bl PPCMtdec                              /* constant-address: 80339CF0, symbol: PPCMtdec */
/* 8033AA8C  48 00 00 B8 */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AA90:
/* 8033AA90  38 64 FF FF */	addi r3, r4, -1                          /* constant-address: 7FFFFFFF */
/* 8033AA94  4B FF F2 5D */	bl PPCMtdec                              /* constant-address: 80339CF0, symbol: PPCMtdec */
/* 8033AA98  48 00 00 AC */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AA9C:
/* 8033AA9C  80 C6 00 14 */	lwz r6, 0x14(r6)                        
lbl_8033AAA0:
/* 8033AAA0  28 06 00 00 */	cmplwi r6, 0                            
/* 8033AAA4  40 82 FF 3C */	bne lbl_8033A9E0                         /* constant-address: 8033A9E0, symbol: lbl_8033A9E0 */
/* 8033AAA8  3B C0 00 00 */	li r30, 0                               
/* 8033AAAC  93 DD 00 14 */	stw r30, 0x14(r29)                      
/* 8033AAB0  38 6D 90 B8 */	la r3, AlarmQueue(r13) /* 80451638-_SDA_BASE_ */ /* constant-address: 80451638, symbol: AlarmQueue */
/* 8033AAB4  80 83 00 04 */	lwz r4, 4(r3)                            /* constant-address: 8045163C, symbol: None */
/* 8033AAB8  97 A3 00 04 */	stwu r29, 4(r3)                          /* constant-address: 8045163C, symbol: None */
/* 8033AABC  28 04 00 00 */	cmplwi r4, 0                            
/* 8033AAC0  90 9D 00 10 */	stw r4, 0x10(r29)                       
/* 8033AAC4  41 82 00 0C */	beq lbl_8033AAD0                         /* constant-address: 8033AAD0, symbol: lbl_8033AAD0 */
/* 8033AAC8  93 A4 00 14 */	stw r29, 0x14(r4)                       
/* 8033AACC  48 00 00 78 */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AAD0:
/* 8033AAD0  93 A3 00 00 */	stw r29, 0(r3)                           /* constant-address: 8045163C, symbol: None */
/* 8033AAD4  93 AD 90 B8 */	stw r29, AlarmQueue(r13)                 /* constant-address: 80451638, symbol: AlarmQueue */
/* 8033AAD8  48 00 7C 45 */	bl __OSGetSystemTime                     /* constant-address: 8034271C, symbol: __OSGetSystemTime */
...
/* 8033AB04  41 82 00 10 */	beq lbl_8033AB14                         /* constant-address: 8033AB14, symbol: lbl_8033AB14 */
/* 8033AB08  38 60 00 00 */	li r3, 0                                
/* 8033AB0C  4B FF F1 E5 */	bl PPCMtdec                              /* constant-address: 80339CF0, symbol: PPCMtdec */
/* 8033AB10  48 00 00 34 */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AB14:
...
/* 8033AB2C  41 82 00 10 */	beq lbl_8033AB3C                         /* constant-address: 8033AB3C, symbol: lbl_8033AB3C */
/* 8033AB30  7C E3 3B 78 */	mr r3, r7                               
/* 8033AB34  4B FF F1 BD */	bl PPCMtdec                              /* constant-address: 80339CF0, symbol: PPCMtdec */
/* 8033AB38  48 00 00 0C */	b lbl_8033AB44                           /* constant-address: 8033AB44, symbol: lbl_8033AB44 */
lbl_8033AB3C:
/* 8033AB3C  38 64 FF FF */	addi r3, r4, -1                          /* constant-address: 7FFFFFFF */
/* 8033AB40  4B FF F1 B1 */	bl PPCMtdec                              /* constant-address: 80339CF0, symbol: PPCMtdec */
lbl_8033AB44:

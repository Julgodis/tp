...
/* 80020BA0 0040 .text      fpcCtRq_Delete__FP14create_request fpcCtRq_Delete__FP14create_request */
...
/* 80020BC0 0001DB00  41 82 00 20 */	beq func_80020BE0
...
/* 80020BD4 0001DB14  40 82 00 0C */	bne func_80020BE0
/* 80020BD8 0001DB18  38 60 00 00 */	li r3, 0
/* 80020BDC 0001DB1C  48 00 00 24 */	b func_80020C00

/* 80020BE0 0014 .text      func_80020BE0                  func_80020BE0                  */
.global func_80020BE0
func_80020BE0:
/* 80020BE0 0001DB20  80 7F 00 40 */	lwz r3, 0x40(r31)
/* 80020BE4 0001DB24  28 03 00 00 */	cmplwi r3, 0
/* 80020BE8 0001DB28  41 82 00 0C */	beq func_80020BF4
/* 80020BEC 0001DB2C  38 00 00 00 */	li r0, 0
/* 80020BF0 0001DB30  90 03 00 14 */	stw r0, 0x14(r3)

/* 80020BF4 000C .text      func_80020BF4                  func_80020BF4                  */
.global func_80020BF4
func_80020BF4:
...
/* 80020C00 0014 .text      func_80020C00                  func_80020C00                  */
.global func_80020C00
func_80020C00:
...
/* 80020C14 004C .text      fpcCtRq_Cancel__FP14create_request fpcCtRq_Cancel__FP14create_request */
...
/* 80020C28 0001DB68  41 82 00 6C */	beq func_80020C94
/* 80020C2C 0001DB6C  88 1F 00 15 */	lbz r0, 0x15(r31)
/* 80020C30 0001DB70  7C 00 07 75 */	extsb. r0, r0
/* 80020C34 0001DB74  40 82 00 60 */	bne func_80020C94
...
/* 80020C48 0001DB88  41 82 00 18 */	beq func_80020C60
/* 80020C4C 0001DB8C  48 00 06 59 */	bl fpcDt_Delete__FPv
/* 80020C50 0001DB90  2C 03 00 00 */	cmpwi r3, 0
/* 80020C54 0001DB94  40 82 00 0C */	bne func_80020C60
/* 80020C58 0001DB98  38 60 00 00 */	li r3, 0
/* 80020C5C 0001DB9C  48 00 00 3C */	b func_80020C98

/* 80020C60 0028 .text      func_80020C60                  func_80020C60                  */
.global func_80020C60
func_80020C60:
/* 80020C60 0001DBA0  80 7F 00 34 */	lwz r3, 0x34(r31)
/* 80020C64 0001DBA4  28 03 00 00 */	cmplwi r3, 0
/* 80020C68 0001DBA8  41 82 00 20 */	beq func_80020C88
...
/* 80020C7C 0001DBBC  40 82 00 0C */	bne func_80020C88
/* 80020C80 0001DBC0  38 60 00 00 */	li r3, 0
/* 80020C84 0001DBC4  48 00 00 14 */	b func_80020C98

/* 80020C88 000C .text      func_80020C88                  func_80020C88                  */
.global func_80020C88
func_80020C88:
/* 80020C88 0001DBC8  7F E3 FB 78 */	mr r3, r31
/* 80020C8C 0001DBCC  4B FF FF 15 */	bl fpcCtRq_Delete__FP14create_request
/* 80020C90 0001DBD0  48 00 00 08 */	b func_80020C98

/* 80020C94 0004 .text      func_80020C94                  func_80020C94                  */
.global func_80020C94
func_80020C94:
/* 80020C94 0001DBD4  38 60 00 01 */	li r3, 1

/* 80020C98 0014 .text      func_80020C98                  func_80020C98                  */
.global func_80020C98
func_80020C98:
...
/* 80020CE8 0001DC28  41 82 00 2C */	beq func_80020D14
/* 80020CEC 0001DC2C  81 84 00 00 */	lwz r12, 0(r4)
/* 80020CF0 0001DC30  28 0C 00 00 */	cmplwi r12, 0
/* 80020CF4 0001DC34  41 82 00 20 */	beq func_80020D14
...
/* 80020D14 0018 .text      func_80020D14                  func_80020D14                  */
.global func_80020D14
func_80020D14:
/* 80020D14 0001DC54  2C 05 00 04 */	cmpwi r5, 4
/* 80020D18 0001DC58  41 82 00 20 */	beq func_80020D38
/* 80020D1C 0001DC5C  40 80 00 10 */	bge func_80020D2C
/* 80020D20 0001DC60  2C 05 00 03 */	cmpwi r5, 3
/* 80020D24 0001DC64  40 80 00 3C */	bge func_80020D60
/* 80020D28 0001DC68  48 00 00 44 */	b func_80020D6C

/* 80020D2C 000C .text      func_80020D2C                  func_80020D2C                  */
.global func_80020D2C
func_80020D2C:
/* 80020D2C 0001DC6C  2C 05 00 06 */	cmpwi r5, 6
/* 80020D30 0001DC70  40 80 00 3C */	bge func_80020D6C
/* 80020D34 0001DC74  48 00 00 2C */	b func_80020D60

/* 80020D38 001C .text      func_80020D38                  func_80020D38                  */
.global func_80020D38
func_80020D38:
...
/* 80020D44 0001DC84  40 82 00 10 */	bne func_80020D54
/* 80020D48 0001DC88  7F E3 FB 78 */	mr r3, r31
/* 80020D4C 0001DC8C  4B FF FE C9 */	bl fpcCtRq_Cancel__FP14create_request
/* 80020D50 0001DC90  48 00 00 20 */	b func_80020D70

/* 80020D54 000C .text      func_80020D54                  func_80020D54                  */
.global func_80020D54
func_80020D54:
/* 80020D54 0001DC94  7F E3 FB 78 */	mr r3, r31
/* 80020D58 0001DC98  4B FF FE 49 */	bl fpcCtRq_Delete__FP14create_request
/* 80020D5C 0001DC9C  48 00 00 14 */	b func_80020D70

/* 80020D60 000C .text      func_80020D60                  func_80020D60                  */
.global func_80020D60
func_80020D60:
/* 80020D60 0001DCA0  7F E3 FB 78 */	mr r3, r31
/* 80020D64 0001DCA4  4B FF FE B1 */	bl fpcCtRq_Cancel__FP14create_request
/* 80020D68 0001DCA8  48 00 00 08 */	b func_80020D70

/* 80020D6C 0004 .text      func_80020D6C                  func_80020D6C                  */
.global func_80020D6C
func_80020D6C:
/* 80020D6C 0001DCAC  38 60 00 01 */	li r3, 1

/* 80020D70 0014 .text      func_80020D70                  func_80020D70                  */
.global func_80020D70
func_80020D70:
...
/* 80020DB0 006C .text      fpcCtRq_Create__FP11layer_classUlP27create_request_method_class fpcCtRq_Create__FP11layer_classUlP27create_request_method_class */
...
/* 80020DD8 0001DD18  41 82 00 44 */	beq func_80020E1C
...
/* 80020E1C 001C .text      func_80020E1C                  func_80020E1C                  */
.global func_80020E1C
func_80020E1C:

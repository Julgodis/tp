...
/* 80020830  48 34 19 A1 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 80020834  7C 7A 1B 78 */	mr r26, r3                              
/* 80020838  7C 9B 23 78 */	mr r27, r4                              
/* 8002083C  7C BC 2B 78 */	mr r28, r5                              
/* 80020840  48 00 2D 25 */	bl fpcPf_Get__Fs                         /* constant-address: 80023564, symbol: fpcPf_Get__Fs */
...
/* 8002085C  48 24 29 CD */	bl memalignB__3cMlFiUl                   /* constant-address: 80263228, symbol: memalignB__3cMlFiUl */
/* 80020860  7C 7E 1B 79 */	or. r30, r3, r3                         
/* 80020864  40 82 00 0C */	bne lbl_80020870                         /* constant-address: 80020870, symbol: lbl_80020870 */
/* 80020868  38 60 00 00 */	li r3, 0                                
/* 8002086C  48 00 00 98 */	b lbl_80020904                           /* constant-address: 80020904, symbol: lbl_80020904 */
lbl_80020870:
/* 80020870  7F A4 EB 78 */	mr r4, r29                              
/* 80020874  48 25 14 39 */	bl sBs_ClearArea__FPvUl                  /* constant-address: 80271CAC, symbol: sBs_ClearArea__FPvUl */
/* 80020878  38 7E 00 18 */	addi r3, r30, 0x18                      
/* 8002087C  80 9F 00 00 */	lwz r4, 0(r31)                          
/* 80020880  7F C5 F3 78 */	mr r5, r30                              
/* 80020884  48 00 16 2D */	bl fpcLyTg_Init__FP26layer_management_tag_classUiPv /* constant-address: 80021EB0, symbol: fpcLyTg_Init__FP26layer_management_tag_classUiPv */
/* 80020888  38 7E 00 34 */	addi r3, r30, 0x34                      
/* 8002088C  7F C4 F3 78 */	mr r4, r30                              
/* 80020890  48 00 2D FD */	bl fpcLnTg_Init__FP8line_tagPv           /* constant-address: 8002368C, symbol: fpcLnTg_Init__FP8line_tagPv */
/* 80020894  38 7E 00 4C */	addi r3, r30, 0x4c                      
/* 80020898  7F C4 F3 78 */	mr r4, r30                              
/* 8002089C  48 00 07 81 */	bl fpcDtTg_Init__FP16delete_tag_classPv  /* constant-address: 8002101C, symbol: fpcDtTg_Init__FP16delete_tag_classPv */
...
/* 800208B4  48 00 2C 09 */	bl fpcPi_Init__FP22process_priority_classPvUiUsUs /* constant-address: 800234BC, symbol: fpcPi_Init__FP22process_priority_classPvUiUsUs */
...
/* 800208CC  38 6D 87 80 */	la r3, g_fpcBs_type(r13) /* 80450D00-_SDA_BASE_ */ /* constant-address: 80450D00, symbol: g_fpcBs_type */
/* 800208D0  4B FF FD 8D */	bl fpcBs_MakeOfType__FPi                 /* constant-address: 8002065C, symbol: fpcBs_MakeOfType__FPi */
...
/* 800208E4  48 00 30 65 */	bl fpcPause_Init__FPv                    /* constant-address: 80023948, symbol: fpcPause_Init__FPv */
...
/* 80020908  48 34 19 15 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

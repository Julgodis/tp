...
/* ###################################################################################### */
.section .text, "ax"
/* 80023844 0024 .text      fpcPause_IsEnable__FPvUc       fpcPause_IsEnable__FPvUc       */
.global fpcPause_IsEnable__FPvUc
fpcPause_IsEnable__FPvUc:
...
/* 80023868 0050 .text      fpcPause_Enable__FPvUc         fpcPause_Enable__FPvUc         */
.global fpcPause_Enable__FPvUc
fpcPause_Enable__FPvUc:
...
/* 80023890 000207D0  80 6D 87 C0 */	lwz r3, g_fpcNd_type-_SDA_BASE_(r13)
/* 80023894 000207D4  80 9E 00 B4 */	lwz r4, 0xb4(r30)
/* 80023898 000207D8  4B FF CD B5 */	bl fpcBs_Is_JustOfType__Fii
/* 8002389C 000207DC  2C 03 00 00 */	cmpwi r3, 0
/* 800238A0 000207E0  41 82 00 18 */	beq func_800238B8
/* 800238A4 000207E4  38 7E 00 BC */	addi r3, r30, 0xbc
/* 800238A8 000207E8  3C 80 80 02 */	lis r4, fpcPause_Enable__FPvUc@ha
/* 800238AC 000207EC  38 84 38 68 */	addi r4, r4, fpcPause_Enable__FPvUc@l
/* 800238B0 000207F0  57 E5 06 3E */	clrlwi r5, r31, 0x18
/* 800238B4 000207F4  4B FF E2 D5 */	bl fpcLyIt_OnlyHere__FP11layer_classPFPvPv_iPv

/* 800238B8 001C .text      func_800238B8                  func_800238B8                  */
.global func_800238B8
func_800238B8:
...
/* 800238D4 0058 .text      fpcPause_Disable__FPvUc        fpcPause_Disable__FPvUc        */
.global fpcPause_Disable__FPvUc
fpcPause_Disable__FPvUc:
...
/* 80023904 00020844  80 6D 87 C0 */	lwz r3, g_fpcNd_type-_SDA_BASE_(r13)
/* 80023908 00020848  80 9E 00 B4 */	lwz r4, 0xb4(r30)
/* 8002390C 0002084C  4B FF CD 41 */	bl fpcBs_Is_JustOfType__Fii
/* 80023910 00020850  2C 03 00 00 */	cmpwi r3, 0
/* 80023914 00020854  41 82 00 18 */	beq func_8002392C
/* 80023918 00020858  38 7E 00 BC */	addi r3, r30, 0xbc
/* 8002391C 0002085C  3C 80 80 02 */	lis r4, fpcPause_Disable__FPvUc@ha
/* 80023920 00020860  38 84 38 D4 */	addi r4, r4, fpcPause_Disable__FPvUc@l
/* 80023924 00020864  57 E5 06 3E */	clrlwi r5, r31, 0x18
/* 80023928 00020868  4B FF E2 61 */	bl fpcLyIt_OnlyHere__FP11layer_classPFPvPv_iPv

/* 8002392C 001C .text      func_8002392C                  func_8002392C                  */
...
/* 80023948 000C .text      fpcPause_Init__FPv             fpcPause_Init__FPv             */
.global fpcPause_Init__FPv
fpcPause_Init__FPv:

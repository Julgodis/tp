...
/* ###################################################################################### */
.section .text, "ax"
/* 80021FB8 0038 .text      fpcLd_Use__Fs                  fpcLd_Use__Fs                  */
.global fpcLd_Use__Fs
fpcLd_Use__Fs:
...
/* 80021FCC 0001EF0C  48 00 00 3D */	bl fpcLd_IsLoaded__Fs
/* 80021FD0 0001EF10  2C 03 00 01 */	cmpwi r3, 1
/* 80021FD4 0001EF14  40 82 00 1C */	bne func_80021FF0
/* 80021FD8 0001EF18  7F E3 FB 78 */	mr r3, r31
/* 80021FDC 0001EF1C  48 00 00 75 */	bl fpcLd_Load__Fs
/* 80021FE0 0001EF20  2C 03 00 04 */	cmpwi r3, 4
/* 80021FE4 0001EF24  40 82 00 0C */	bne func_80021FF0
/* 80021FE8 0001EF28  38 60 00 01 */	li r3, 1
/* 80021FEC 0001EF2C  48 00 00 08 */	b func_80021FF4

/* 80021FF0 0004 .text      func_80021FF0                  func_80021FF0                  */
.global func_80021FF0
func_80021FF0:
/* 80021FF0 0001EF30  38 60 00 00 */	li r3, 0

/* 80021FF4 0014 .text      func_80021FF4                  func_80021FF4                  */
.global func_80021FF4
func_80021FF4:
...
/* 80022008 0024 .text      fpcLd_IsLoaded__Fs             fpcLd_IsLoaded__Fs             */
.global fpcLd_IsLoaded__Fs
fpcLd_IsLoaded__Fs:
...
/* 80022018 0001EF58  4B FF 65 2D */	bl cDyl_IsLinked__Fs
...
/* 8002202C 0024 .text      fpcLd_Free__Fs                 fpcLd_Free__Fs                 */
.global fpcLd_Free__Fs
fpcLd_Free__Fs:
...
/* 8002203C 0001EF7C  4B FF 65 41 */	bl cDyl_Unlink__Fs
...
/* 80022050 002C .text      fpcLd_Load__Fs                 fpcLd_Load__Fs                 */
.global fpcLd_Load__Fs
fpcLd_Load__Fs:
...
/* 80022060 0001EFA0  4B FF 65 61 */	bl cDyl_LinkASync__Fs
/* 80022064 0001EFA4  2C 03 00 04 */	cmpwi r3, 4
/* 80022068 0001EFA8  41 82 00 14 */	beq func_8002207C
/* 8002206C 0001EFAC  40 80 00 20 */	bge func_8002208C
/* 80022070 0001EFB0  2C 03 00 00 */	cmpwi r3, 0
/* 80022074 0001EFB4  41 82 00 10 */	beq func_80022084
/* 80022078 0001EFB8  48 00 00 14 */	b func_8002208C

/* 8002207C 0008 .text      func_8002207C                  func_8002207C                  */
.global func_8002207C
func_8002207C:
/* 8002207C 0001EFBC  38 60 00 04 */	li r3, 4
/* 80022080 0001EFC0  48 00 00 10 */	b func_80022090

/* 80022084 0008 .text      func_80022084                  func_80022084                  */
.global func_80022084
func_80022084:
/* 80022084 0001EFC4  38 60 00 00 */	li r3, 0
/* 80022088 0001EFC8  48 00 00 08 */	b func_80022090

/* 8002208C 0004 .text      func_8002208C                  func_8002208C                  */
.global func_8002208C
func_8002208C:
/* 8002208C 0001EFCC  38 60 00 05 */	li r3, 5

/* 80022090 0010 .text      func_80022090                  func_80022090                  */
.global func_80022090
func_80022090:

...
/* 80023BDC  4B FF DB 11 */	bl fpcLy_SetCurrentLayer__FP11layer_class /* constant-address: 800216EC, symbol: fpcLy_SetCurrentLayer__FP11layer_class */
/* 80023BE0  A8 7F 00 50 */	lha r3, 0x50(r31)                       
/* 80023BE4  80 9F 00 3C */	lwz r4, 0x3c(r31)                       
/* 80023BE8  80 BF 00 54 */	lwz r5, 0x54(r31)                       
/* 80023BEC  4B FF CC 35 */	bl fpcBs_Create__FsUiPv                  /* constant-address: 80020820, symbol: fpcBs_Create__FsUiPv */
/* 80023BF0  90 7F 00 40 */	stw r3, 0x40(r31)                       
/* 80023BF4  80 7F 00 40 */	lwz r3, 0x40(r31)                       
/* 80023BF8  28 03 00 00 */	cmplwi r3, 0                            
/* 80023BFC  40 82 00 14 */	bne lbl_80023C10                         /* constant-address: 80023C10, symbol: lbl_80023C10 */
/* 80023C00  A8 7F 00 50 */	lha r3, 0x50(r31)                       
/* 80023C04  4B FF E4 29 */	bl fpcLd_Free__Fs                        /* constant-address: 8002202C, symbol: fpcLd_Free__Fs */
/* 80023C08  38 60 00 05 */	li r3, 5                                
/* 80023C0C  48 00 00 0C */	b lbl_80023C18                           /* constant-address: 80023C18, symbol: lbl_80023C18 */
lbl_80023C10:

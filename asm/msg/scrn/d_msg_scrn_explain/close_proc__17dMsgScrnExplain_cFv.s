...
/* 8023E460  48 12 3D 7D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 8023E464  7C 7D 1B 78 */	mr r29, r3                              
/* 8023E468  80 63 00 38 */	lwz r3, 0x38(r3)                        
/* 8023E46C  28 03 00 00 */	cmplwi r3, 0                            
/* 8023E470  41 82 00 0C */	beq lbl_8023E47C                         /* constant-address: 8023E47C, symbol: lbl_8023E47C */
/* 8023E474  4B FF C2 0D */	bl selAnimeEnd__17dMsgScrn3Select_cFv    /* constant-address: 8023A680, symbol: selAnimeEnd__17dMsgScrn3Select_cFv */
/* 8023E478  48 00 00 08 */	b lbl_8023E480                           /* constant-address: 8023E480, symbol: lbl_8023E480 */
lbl_8023E47C:
...
/* 8023E494  41 81 00 18 */	bgt lbl_8023E4AC                         /* constant-address: 8023E4AC, symbol: lbl_8023E4AC */
/* 8023E498  38 80 00 00 */	li r4, 0                                
/* 8023E49C  B0 9D 00 5A */	sth r4, 0x5a(r29)                       
/* 8023E4A0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8023E4A4  41 82 00 08 */	beq lbl_8023E4AC                         /* constant-address: 8023E4AC, symbol: lbl_8023E4AC */
/* 8023E4A8  98 9D 00 60 */	stb r4, 0x60(r29)                       
lbl_8023E4AC:
/* 8023E4AC  7F A3 EB 78 */	mr r3, r29                              
/* 8023E4B0  48 00 01 1D */	bl getAlphaRatio__17dMsgScrnExplain_cFv  /* constant-address: 8023E5CC, symbol: getAlphaRatio__17dMsgScrnExplain_cFv */
/* 8023E4B4  C0 02 B1 B8 */	lfs f0, lit_3978(r2)                     /* constant-address: 80454BB8, symbol: lit_3978 */
...
/* 8023E4C8  C3 E2 B1 E0 */	lfs f31, lit_4211(r2)                    /* constant-address: 80454BE0, symbol: lit_4211 */
lbl_8023E4CC:
/* 8023E4CC  7F A3 EB 78 */	mr r3, r29                              
/* 8023E4D0  48 00 00 FD */	bl getAlphaRatio__17dMsgScrnExplain_cFv  /* constant-address: 8023E5CC, symbol: getAlphaRatio__17dMsgScrnExplain_cFv */
/* 8023E4D4  EC 3F 08 28 */	fsubs f1, f31, f1                       
/* 8023E4D8  38 1F 00 20 */	addi r0, r31, 0x20                      
/* 8023E4DC  7C 7D 00 2E */	lwzx r3, r29, r0                        
/* 8023E4E0  48 01 72 F1 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 8023E4E4  3B DE 00 01 */	addi r30, r30, 1                        
/* 8023E4E8  2C 1E 00 02 */	cmpwi r30, 2                            
/* 8023E4EC  3B FF 00 04 */	addi r31, r31, 4                        
/* 8023E4F0  41 80 FF DC */	blt lbl_8023E4CC                         /* constant-address: 8023E4CC, symbol: lbl_8023E4CC */
/* 8023E4F4  80 1D 00 40 */	lwz r0, 0x40(r29)                       
/* 8023E4F8  28 00 00 00 */	cmplwi r0, 0                            
/* 8023E4FC  41 82 00 3C */	beq lbl_8023E538                         /* constant-address: 8023E538, symbol: lbl_8023E538 */
/* 8023E500  7F A3 EB 78 */	mr r3, r29                              
/* 8023E504  48 00 00 C9 */	bl getAlphaRatio__17dMsgScrnExplain_cFv  /* constant-address: 8023E5CC, symbol: getAlphaRatio__17dMsgScrnExplain_cFv */
/* 8023E508  C0 02 B1 E0 */	lfs f0, lit_4211(r2)                     /* constant-address: 80454BE0, symbol: lit_4211 */
/* 8023E50C  EC 20 08 28 */	fsubs f1, f0, f1                        
/* 8023E510  C0 02 B1 E4 */	lfs f0, lit_4230(r2)                     /* constant-address: 80454BE4, symbol: lit_4230 */
...
/* 8023E544  48 12 3C E5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

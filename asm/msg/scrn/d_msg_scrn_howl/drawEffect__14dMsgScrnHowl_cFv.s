...
/* 802435DC  48 11 EC 01 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802435E0  7C 7F 1B 78 */	mr r31, r3                              
/* 802435E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 802435E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 802435EC  83 C3 5F 50 */	lwz r30, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 80243624  C8 22 B2 80 */	lfd f1, lit_4587(r2)                     /* constant-address: 80454C80, symbol: lit_4587 */
...
/* 80243654  C0 02 B2 50 */	lfs f0, lit_4427(r2)                     /* constant-address: 80454C50, symbol: lit_4427 */
/* 80243658  EC 03 00 28 */	fsubs f0, f3, f0                        
/* 8024365C  C0 42 B2 60 */	lfs f2, lit_4431(r2)                     /* constant-address: 80454C60, symbol: lit_4431 */
/* 80243660  EC 80 10 24 */	fdivs f4, f0, f2                        
/* 80243664  D0 81 00 08 */	stfs f4, 8(r1)                          
/* 80243668  D0 A1 00 0C */	stfs f5, 0xc(r1)                        
/* 8024366C  C0 22 B2 A4 */	lfs f1, lit_5233(r2)                     /* constant-address: 80454CA4, symbol: lit_5233 */
...
/* 80243698  48 0A 5A 29 */	bl func_802E90C0                         /* constant-address: 802E90C0, symbol: func_802E90C0 */
...
/* 802436B4  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 802436B8  80 63 5D B4 */	lwz r3, 0x5db4(r3)                       /* constant-address: 8040BF74, symbol: None */
...
/* 802436D8  38 C4 30 30 */	addi r6, r4, 0x3030 /* 0x6E653030@l */   /* constant-address: 6E653030 */
...
/* 802436F8  48 01 21 31 */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 802436FC  57 C0 06 3E */	clrlwi r0, r30, 0x18                    
/* 80243700  C8 42 B2 80 */	lfd f2, lit_4587(r2)                     /* constant-address: 80454C80, symbol: lit_4587 */
...
/* 80243720  C8 22 B2 68 */	lfd f1, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
/* 80243738  C0 02 B2 88 */	lfs f0, lit_4824(r2)                     /* constant-address: 80454C88, symbol: lit_4824 */
...
/* 80243768  C8 22 B2 68 */	lfd f1, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
/* 80243790  48 01 0B 59 */	bl getGlobalPosX__8CPaneMgrFv            /* constant-address: 802542E8, symbol: getGlobalPosX__8CPaneMgrFv */
...
/* 802437BC  48 01 0B A9 */	bl getGlobalPosY__8CPaneMgrFv            /* constant-address: 80254364, symbol: getGlobalPosY__8CPaneMgrFv */
/* 802437C0  FF E0 08 90 */	fmr f31, f1                             
/* 802437C4  7F A3 EB 78 */	mr r3, r29                              
/* 802437C8  48 01 0B 9D */	bl getGlobalPosY__8CPaneMgrFv            /* constant-address: 80254364, symbol: getGlobalPosY__8CPaneMgrFv */
/* 802437CC  EC 01 F0 2A */	fadds f0, f1, f30                       
/* 802437D0  EF E0 F8 28 */	fsubs f31, f0, f31                      
/* 802437D4  80 7F 00 C4 */	lwz r3, 0xc4(r31)                       
/* 802437D8  48 01 0B 8D */	bl getGlobalPosY__8CPaneMgrFv            /* constant-address: 80254364, symbol: getGlobalPosY__8CPaneMgrFv */
/* 802437DC  FC 40 08 90 */	fmr f2, f1                              
/* 802437E0  80 7F 01 24 */	lwz r3, 0x124(r31)                      
/* 802437E4  C0 1F 19 9C */	lfs f0, 0x199c(r31)                     
/* 802437E8  C0 62 B2 A8 */	lfs f3, lit_5234(r2)                     /* constant-address: 80454CA8, symbol: lit_5234 */
...
/* 80243824  48 11 EA 05 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

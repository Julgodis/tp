...
/* 80241C4C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80241C50  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 80241C64  48 11 E8 E5 */	bl GXGetScissor                          /* constant-address: 80360548, symbol: GXGetScissor */
/* 80241C68  A0 1E 21 38 */	lhz r0, 0x2138(r30)                     
/* 80241C6C  28 00 00 00 */	cmplwi r0, 0                            
/* 80241C70  41 82 00 2C */	beq lbl_80241C9C                         /* constant-address: 80241C9C, symbol: lbl_80241C9C */
/* 80241C74  88 1E 27 98 */	lbz r0, 0x2798(r30)                     
/* 80241C78  28 00 00 00 */	cmplwi r0, 0                            
/* 80241C7C  41 82 00 0C */	beq lbl_80241C88                         /* constant-address: 80241C88, symbol: lbl_80241C88 */
/* 80241C80  28 00 00 04 */	cmplwi r0, 4                            
/* 80241C84  40 82 00 10 */	bne lbl_80241C94                         /* constant-address: 80241C94, symbol: lbl_80241C94 */
lbl_80241C88:
/* 80241C88  7F C3 F3 78 */	mr r3, r30                              
/* 80241C8C  48 00 0B 1D */	bl drawGuide__14dMsgScrnHowl_cFv         /* constant-address: 802427A8, symbol: drawGuide__14dMsgScrnHowl_cFv */
/* 80241C90  48 00 00 0C */	b lbl_80241C9C                           /* constant-address: 80241C9C, symbol: lbl_80241C9C */
lbl_80241C94:
/* 80241C94  7F C3 F3 78 */	mr r3, r30                              
/* 80241C98  48 00 13 4D */	bl drawGuide2__14dMsgScrnHowl_cFv        /* constant-address: 80242FE4, symbol: drawGuide2__14dMsgScrnHowl_cFv */
lbl_80241C9C:
/* 80241C9C  88 1E 27 98 */	lbz r0, 0x2798(r30)                     
/* 80241CA0  28 00 00 03 */	cmplwi r0, 3                            
/* 80241CA4  41 82 00 0C */	beq lbl_80241CB0                         /* constant-address: 80241CB0, symbol: lbl_80241CB0 */
/* 80241CA8  7F C3 F3 78 */	mr r3, r30                              
/* 80241CAC  48 00 04 ED */	bl drawWave__14dMsgScrnHowl_cFv          /* constant-address: 80242198, symbol: drawWave__14dMsgScrnHowl_cFv */
lbl_80241CB0:
/* 80241CB0  80 1E 21 20 */	lwz r0, 0x2120(r30)                     
/* 80241CB4  C8 22 B2 80 */	lfd f1, lit_4587(r2)                     /* constant-address: 80454C80, symbol: lit_4587 */
...
/* 80241D28  48 0A 73 99 */	bl func_802E90C0                         /* constant-address: 802E90C0, symbol: func_802E90C0 */

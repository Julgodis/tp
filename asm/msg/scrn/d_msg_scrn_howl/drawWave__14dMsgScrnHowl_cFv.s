...
/* 80242220  48 11 FF 9D */	bl _savegpr_21                           /* constant-address: 803621BC, symbol: _savegpr_21 */
/* 80242224  7C 79 1B 78 */	mr r25, r3                              
/* 80242228  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8024222C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80242230  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
/* 80242234  80 79 00 C4 */	lwz r3, 0xc4(r25)                       
/* 80242238  48 01 20 B1 */	bl getGlobalPosX__8CPaneMgrFv            /* constant-address: 802542E8, symbol: getGlobalPosX__8CPaneMgrFv */
/* 8024223C  FF C0 08 90 */	fmr f30, f1                             
/* 80242240  AB D9 21 24 */	lha r30, 0x2124(r25)                    
/* 80242244  C3 A2 B2 50 */	lfs f29, lit_4427(r2)                    /* constant-address: 80454C50, symbol: lit_4427 */
...
/* 80242264  38 63 02 8C */	addi r3, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 80242268  AB A3 04 0C */	lha r29, 0x40c(r3)                       /* constant-address: 80430698, symbol: None */
...
/* 8024227C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80242280  80 63 5D B4 */	lwz r3, 0x5db4(r3)                       /* constant-address: 8040BF74, symbol: None */
...
/* 8024229C  C8 22 B2 68 */	lfd f1, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
/* 802422B8  C0 02 B2 88 */	lfs f0, lit_4824(r2)                     /* constant-address: 80454C88, symbol: lit_4824 */
/* 802422BC  EF 01 00 24 */	fdivs f24, f1, f0                       
/* 802422C0  2C 1C 00 00 */	cmpwi r28, 0                            
/* 802422C4  40 80 00 08 */	bge lbl_802422CC                         /* constant-address: 802422CC, symbol: lbl_802422CC */
...
/* 80242304  C0 62 B2 60 */	lfs f3, lit_4431(r2)                     /* constant-address: 80454C60, symbol: lit_4431 */
/* 80242308  EC 06 18 24 */	fdivs f0, f6, f3                        
/* 8024230C  EC 00 18 24 */	fdivs f0, f0, f3                        
/* 80242310  C0 42 B2 8C */	lfs f2, lit_4825(r2)                     /* constant-address: 80454C8C, symbol: lit_4825 */
/* 80242314  EC A0 10 28 */	fsubs f5, f0, f2                        
/* 80242318  C0 21 00 24 */	lfs f1, 0x24(r1)                        
/* 8024231C  C0 02 B2 50 */	lfs f0, lit_4427(r2)                     /* constant-address: 80454C50, symbol: lit_4427 */
...
/* 80242334  C0 42 B2 90 */	lfs f2, lit_4826(r2)                     /* constant-address: 80454C90, symbol: lit_4826 */
...
/* 80242350  C0 22 B2 94 */	lfs f1, lit_4827(r2)                     /* constant-address: 80454C94, symbol: lit_4827 */
...
/* 80242374  48 0A 6D 4D */	bl func_802E90C0                         /* constant-address: 802E90C0, symbol: func_802E90C0 */
...
/* 80242398  40 82 00 20 */	bne lbl_802423B8                         /* constant-address: 802423B8, symbol: lbl_802423B8 */
/* 8024239C  A8 79 21 2A */	lha r3, 0x212a(r25)                     
/* 802423A0  A8 19 21 2C */	lha r0, 0x212c(r25)                     
/* 802423A4  7C 03 00 00 */	cmpw r3, r0                             
/* 802423A8  41 82 00 0C */	beq lbl_802423B4                         /* constant-address: 802423B4, symbol: lbl_802423B4 */
/* 802423AC  B0 79 21 2C */	sth r3, 0x212c(r25)                     
/* 802423B0  48 00 00 08 */	b lbl_802423B8                           /* constant-address: 802423B8, symbol: lbl_802423B8 */
lbl_802423B4:
/* 802423B4  38 80 00 00 */	li r4, 0                                
lbl_802423B8:
/* 802423B8  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 802423BC  41 82 03 5C */	beq lbl_80242718                         /* constant-address: 80242718, symbol: lbl_80242718 */
/* 802423C0  3B 40 00 00 */	li r26, 0                               
/* 802423C4  3C 60 80 43 */	lis r3, g_MsgObject_HIO_c@ha            
/* 802423C8  3B E3 02 8C */	addi r31, r3, g_MsgObject_HIO_c@l        /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 802423CC  C3 E2 B2 58 */	lfs f31, lit_4429(r2)                    /* constant-address: 80454C58, symbol: lit_4429 */
/* 802423D0  48 00 01 CC */	b lbl_8024259C                           /* constant-address: 8024259C, symbol: lbl_8024259C */
lbl_802423D4:
...
/* 80242408  40 81 00 08 */	ble lbl_80242410                         /* constant-address: 80242410, symbol: lbl_80242410 */
/* 8024240C  FF 60 F8 90 */	fmr f27, f31                            
lbl_80242410:
/* 80242410  7F 23 CB 78 */	mr r3, r25                              
/* 80242414  7F C4 F3 78 */	mr r4, r30                              
/* 80242418  48 00 1B 41 */	bl addCount__14dMsgScrnHowl_cFs          /* constant-address: 80243F58, symbol: addCount__14dMsgScrnHowl_cFs */
...
/* 80242448  40 82 00 10 */	bne lbl_80242458                         /* constant-address: 80242458, symbol: lbl_80242458 */
...
/* 80242460  41 80 01 38 */	blt lbl_80242598                         /* constant-address: 80242598, symbol: lbl_80242598 */
/* 80242464  7C 1A E0 00 */	cmpw r26, r28                           
/* 80242468  41 80 01 30 */	blt lbl_80242598                         /* constant-address: 80242598, symbol: lbl_80242598 */
/* 8024246C  2C 1A 00 1E */	cmpwi r26, 0x1e                         
/* 80242470  41 80 01 28 */	blt lbl_80242598                         /* constant-address: 80242598, symbol: lbl_80242598 */
/* 80242474  C0 82 B2 50 */	lfs f4, lit_4427(r2)                     /* constant-address: 80454C50, symbol: lit_4427 */
/* 80242478  2C 17 00 00 */	cmpwi r23, 0                            
/* 8024247C  40 81 00 38 */	ble lbl_802424B4                         /* constant-address: 802424B4, symbol: lbl_802424B4 */
/* 80242480  C8 62 B2 68 */	lfd f3, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
lbl_802424B4:
/* 802424B4  C0 22 B2 50 */	lfs f1, lit_4427(r2)                     /* constant-address: 80454C50, symbol: lit_4427 */
/* 802424B8  FC 18 08 40 */	fcmpo cr0, f24, f1                      
/* 802424BC  40 81 00 DC */	ble lbl_80242598                         /* constant-address: 80242598, symbol: lbl_80242598 */
/* 802424C0  FC 04 08 40 */	fcmpo cr0, f4, f1                       
/* 802424C4  40 81 00 D4 */	ble lbl_80242598                         /* constant-address: 80242598, symbol: lbl_80242598 */
/* 802424C8  C0 42 B2 78 */	lfs f2, lit_4563(r2)                     /* constant-address: 80454C78, symbol: lit_4563 */
/* 802424CC  C0 22 B2 74 */	lfs f1, lit_4562(r2)                     /* constant-address: 80454C74, symbol: lit_4562 */
/* 802424D0  EC 21 01 32 */	fmuls f1, f1, f4                        
/* 802424D4  EC 62 08 2A */	fadds f3, f2, f1                        
/* 802424D8  C0 42 B2 90 */	lfs f2, lit_4826(r2)                     /* constant-address: 80454C90, symbol: lit_4826 */
/* 802424DC  C0 3F 03 C4 */	lfs f1, 0x3c4(r31)                       /* constant-address: 80430650, symbol: None */
...
/* 802424F0  C0 22 B2 58 */	lfs f1, lit_4429(r2)                     /* constant-address: 80454C58, symbol: lit_4429 */
...
/* 8024250C  41 82 00 8C */	beq lbl_80242598                         /* constant-address: 80242598, symbol: lbl_80242598 */
/* 80242510  EC 5E B8 28 */	fsubs f2, f30, f23                      
/* 80242514  C0 22 B2 98 */	lfs f1, lit_4828(r2)                     /* constant-address: 80454C98, symbol: lit_4828 */
...
/* 8024252C  C0 02 B2 70 */	lfs f0, lit_4561(r2)                     /* constant-address: 80454C70, symbol: lit_4561 */
...
/* 80242594  41 80 FF A0 */	blt lbl_80242534                         /* constant-address: 80242534, symbol: lbl_80242534 */
lbl_80242598:
/* 80242598  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
lbl_8024259C:
/* 8024259C  A8 79 21 28 */	lha r3, 0x2128(r25)                     
/* 802425A0  38 03 FF FF */	addi r0, r3, -1                         
/* 802425A4  7C 1A 00 00 */	cmpw r26, r0                            
/* 802425A8  41 80 FE 2C */	blt lbl_802423D4                         /* constant-address: 802423D4, symbol: lbl_802423D4 */
/* 802425AC  C0 42 B2 50 */	lfs f2, lit_4427(r2)                     /* constant-address: 80454C50, symbol: lit_4427 */
/* 802425B0  FC 18 10 40 */	fcmpo cr0, f24, f2                      
/* 802425B4  40 81 01 64 */	ble lbl_80242718                         /* constant-address: 80242718, symbol: lbl_80242718 */
/* 802425B8  C0 22 B2 90 */	lfs f1, lit_4826(r2)                     /* constant-address: 80454C90, symbol: lit_4826 */
/* 802425BC  C0 1F 03 C4 */	lfs f0, 0x3c4(r31)                       /* constant-address: 80430650, symbol: None */
...
/* 802425D0  41 82 00 4C */	beq lbl_8024261C                         /* constant-address: 8024261C, symbol: lbl_8024261C */
/* 802425D4  2C 1B 00 00 */	cmpwi r27, 0                            
/* 802425D8  40 81 00 38 */	ble lbl_80242610                         /* constant-address: 80242610, symbol: lbl_80242610 */
/* 802425DC  C8 42 B2 68 */	lfd f2, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
/* 80242618  48 00 00 8C */	b lbl_802426A4                           /* constant-address: 802426A4, symbol: lbl_802426A4 */
lbl_8024261C:
...
/* 80242630  40 81 00 0C */	ble lbl_8024263C                         /* constant-address: 8024263C, symbol: lbl_8024263C */
...
/* 80242644  40 80 00 2C */	bge lbl_80242670                         /* constant-address: 80242670, symbol: lbl_80242670 */
/* 80242648  C8 22 B2 68 */	lfd f1, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
/* 80242664  C0 02 B2 9C */	lfs f0, lit_4829(r2)                     /* constant-address: 80454C9C, symbol: lit_4829 */
/* 80242668  EC 21 00 24 */	fdivs f1, f1, f0                        
/* 8024266C  48 00 00 30 */	b lbl_8024269C                           /* constant-address: 8024269C, symbol: lbl_8024269C */
lbl_80242670:
/* 80242670  C0 42 B2 88 */	lfs f2, lit_4824(r2)                     /* constant-address: 80454C88, symbol: lit_4824 */
/* 80242674  C8 22 B2 68 */	lfd f1, lit_4434(r2)                     /* constant-address: 80454C68, symbol: lit_4434 */
...
/* 80242694  C0 02 B2 9C */	lfs f0, lit_4829(r2)                     /* constant-address: 80454C9C, symbol: lit_4829 */
/* 80242698  EC 21 00 24 */	fdivs f1, f1, f0                        
lbl_8024269C:
/* 8024269C  FE 20 D0 90 */	fmr f17, f26                            
/* 802426A0  FE 40 C8 90 */	fmr f18, f25                            
lbl_802426A4:
/* 802426A4  C0 02 B2 50 */	lfs f0, lit_4427(r2)                     /* constant-address: 80454C50, symbol: lit_4427 */
/* 802426A8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802426AC  40 81 00 6C */	ble lbl_80242718                         /* constant-address: 80242718, symbol: lbl_80242718 */
/* 802426B0  80 79 01 04 */	lwz r3, 0x104(r25)                      
/* 802426B4  C0 02 B2 58 */	lfs f0, lit_4429(r2)                     /* constant-address: 80454C58, symbol: lit_4429 */
...
/* 802426E0  C0 42 B2 70 */	lfs f2, lit_4561(r2)                     /* constant-address: 80454C70, symbol: lit_4561 */
...
/* 80242794  48 11 FA 75 */	bl _restgpr_21                           /* constant-address: 80362208, symbol: _restgpr_21 */

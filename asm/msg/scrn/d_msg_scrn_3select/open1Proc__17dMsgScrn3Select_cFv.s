...
/* 8023AA1C  48 12 77 BD */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8023AA20  7C 7C 1B 78 */	mr r28, r3                              
/* 8023AA24  3C 60 80 3A */	lis r3, lit_4497@ha                     
/* 8023AA28  38 83 98 28 */	addi r4, r3, lit_4497@l                  /* constant-address: 80399828, symbol: lit_4497 */
/* 8023AA2C  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 80399828, symbol: lit_4497 */
/* 8023AA30  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 8039982C, symbol: None */
/* 8023AA34  90 61 00 08 */	stw r3, 8(r1)                           
/* 8023AA38  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 8023AA3C  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 80399830, symbol: None */
/* 8023AA40  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 8023AA44  88 1C 01 0E */	lbz r0, 0x10e(r28)                      
/* 8023AA48  28 00 00 FF */	cmplwi r0, 0xff                         
/* 8023AA4C  41 82 00 78 */	beq lbl_8023AAC4                         /* constant-address: 8023AAC4, symbol: lbl_8023AAC4 */
...
/* 8023AA74  48 0B C6 8D */	bl getBounds__7J2DPaneFv                 /* constant-address: 802F7100, symbol: getBounds__7J2DPaneFv */
/* 8023AA78  C3 E3 00 00 */	lfs f31, 0(r3)                          
/* 8023AA7C  7F 83 E3 78 */	mr r3, r28                              
/* 8023AA80  7F A4 EB 78 */	mr r4, r29                              
/* 8023AA84  48 00 0D ED */	bl selectAnimeTransform__17dMsgScrn3Select_cFi /* constant-address: 8023B870, symbol: selectAnimeTransform__17dMsgScrn3Select_cFi */
/* 8023AA88  7C 7C F0 2E */	lwzx r3, r28, r30                       
/* 8023AA8C  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8023AA90  48 0B C6 71 */	bl getBounds__7J2DPaneFv                 /* constant-address: 802F7100, symbol: getBounds__7J2DPaneFv */
...
/* 8023AAC0  41 80 FF A8 */	blt lbl_8023AA68                         /* constant-address: 8023AA68, symbol: lbl_8023AA68 */
lbl_8023AAC4:
/* 8023AAC4  C0 02 B1 5C */	lfs f0, lit_3910(r2)                     /* constant-address: 80454B5C, symbol: lit_3910 */
...
/* 8023AAE0  48 12 77 45 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

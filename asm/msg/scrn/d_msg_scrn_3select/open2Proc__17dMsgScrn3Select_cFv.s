...
/* 8023AB14  48 12 76 C5 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 8023AB18  7C 7F 1B 78 */	mr r31, r3                              
/* 8023AB1C  3C 60 80 3A */	lis r3, lit_4520@ha                     
/* 8023AB20  38 83 98 34 */	addi r4, r3, lit_4520@l                  /* constant-address: 80399834, symbol: lit_4520 */
/* 8023AB24  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 80399834, symbol: lit_4520 */
/* 8023AB28  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 80399838, symbol: None */
/* 8023AB2C  90 61 00 08 */	stw r3, 8(r1)                           
/* 8023AB30  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 8023AB34  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 8039983C, symbol: None */
/* 8023AB38  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 8023AB3C  C0 1F 00 F0 */	lfs f0, 0xf0(r31)                       
/* 8023AB40  C0 22 B1 60 */	lfs f1, lit_3911(r2)                     /* constant-address: 80454B60, symbol: lit_3911 */
/* 8023AB44  EC 00 08 2A */	fadds f0, f0, f1                        
/* 8023AB48  D0 1F 00 F0 */	stfs f0, 0xf0(r31)                      
/* 8023AB4C  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8023AB50  4B F5 A7 51 */	bl setAlphaRate__16dSelect_cursor_cFf    /* constant-address: 801952A0, symbol: setAlphaRate__16dSelect_cursor_cFf */
/* 8023AB54  C0 3F 00 F0 */	lfs f1, 0xf0(r31)                       
/* 8023AB58  C0 02 B1 80 */	lfs f0, lit_4434(r2)                     /* constant-address: 80454B80, symbol: lit_4434 */
/* 8023AB5C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8023AB60  4C 41 13 82 */	cror 2, 1, 2                            
/* 8023AB64  40 82 00 30 */	bne lbl_8023AB94                         /* constant-address: 8023AB94, symbol: lbl_8023AB94 */
/* 8023AB68  88 1F 01 0E */	lbz r0, 0x10e(r31)                      
/* 8023AB6C  28 00 00 FF */	cmplwi r0, 0xff                         
/* 8023AB70  41 82 00 14 */	beq lbl_8023AB84                         /* constant-address: 8023AB84, symbol: lbl_8023AB84 */
...
/* 8023ABB8  48 00 0C B9 */	bl selectAnimeTransform__17dMsgScrn3Select_cFi /* constant-address: 8023B870, symbol: selectAnimeTransform__17dMsgScrn3Select_cFi */
...
/* 8023ABE8  41 80 FF B4 */	blt lbl_8023AB9C                         /* constant-address: 8023AB9C, symbol: lbl_8023AB9C */
...
/* 8023AC00  48 12 76 25 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

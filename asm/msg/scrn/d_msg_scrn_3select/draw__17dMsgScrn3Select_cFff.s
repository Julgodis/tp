...
/* 80239DF4  48 12 83 E1 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 80239E08  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80239E0C  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 80239E2C  38 83 02 8C */	addi r4, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 80239E30  88 A4 01 88 */	lbz r5, 0x188(r4)                        /* constant-address: 80430414, symbol: None */
/* 80239E34  7C 00 28 40 */	cmplw r0, r5                            
/* 80239E38  40 82 00 24 */	bne lbl_80239E5C                         /* constant-address: 80239E5C, symbol: lbl_80239E5C */
/* 80239E3C  88 7D 00 C9 */	lbz r3, 0xc9(r29)                       
/* 80239E40  88 04 01 89 */	lbz r0, 0x189(r4)                        /* constant-address: 80430415, symbol: None */
/* 80239E44  7C 03 00 40 */	cmplw r3, r0                            
/* 80239E48  40 82 00 14 */	bne lbl_80239E5C                         /* constant-address: 80239E5C, symbol: lbl_80239E5C */
/* 80239E4C  88 7D 00 CA */	lbz r3, 0xca(r29)                       
/* 80239E50  88 04 01 8A */	lbz r0, 0x18a(r4)                        /* constant-address: 80430416, symbol: None */
/* 80239E54  7C 03 00 40 */	cmplw r3, r0                            
/* 80239E58  41 82 00 F8 */	beq lbl_80239F50                         /* constant-address: 80239F50, symbol: lbl_80239F50 */
lbl_80239E5C:
/* 80239E5C  98 BD 00 C8 */	stb r5, 0xc8(r29)                       
/* 80239E60  3C 60 80 43 */	lis r3, g_MsgObject_HIO_c@ha            
/* 80239E64  38 63 02 8C */	addi r3, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 80239E68  88 03 01 89 */	lbz r0, 0x189(r3)                        /* constant-address: 80430415, symbol: None */
/* 80239E6C  98 1D 00 C9 */	stb r0, 0xc9(r29)                       
/* 80239E70  88 03 01 8A */	lbz r0, 0x18a(r3)                        /* constant-address: 80430416, symbol: None */
...
/* 80239E88  40 82 00 60 */	bne lbl_80239EE8                         /* constant-address: 80239EE8, symbol: lbl_80239EE8 */
...
/* 80239EBC  41 82 00 84 */	beq lbl_80239F40                         /* constant-address: 80239F40, symbol: lbl_80239F40 */
...
/* 80239EE4  48 00 00 5C */	b lbl_80239F40                           /* constant-address: 80239F40, symbol: lbl_80239F40 */
lbl_80239EE8:
...
/* 80239F18  41 82 00 28 */	beq lbl_80239F40                         /* constant-address: 80239F40, symbol: lbl_80239F40 */
...
/* 80239F4C  41 80 FF 34 */	blt lbl_80239E80                         /* constant-address: 80239E80, symbol: lbl_80239E80 */
lbl_80239F50:
...
/* 80239F60  48 0B EF 75 */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
/* 80239F64  88 1D 01 10 */	lbz r0, 0x110(r29)                      
/* 80239F68  28 00 00 FF */	cmplwi r0, 0xff                         
/* 80239F6C  41 82 01 00 */	beq lbl_8023A06C                         /* constant-address: 8023A06C, symbol: lbl_8023A06C */
/* 80239F70  88 7D 01 0E */	lbz r3, 0x10e(r29)                      
/* 80239F74  28 03 00 FF */	cmplwi r3, 0xff                         
/* 80239F78  41 82 00 F4 */	beq lbl_8023A06C                         /* constant-address: 8023A06C, symbol: lbl_8023A06C */
/* 80239F7C  88 1D 01 17 */	lbz r0, 0x117(r29)                      
/* 80239F80  28 00 00 00 */	cmplwi r0, 0                            
/* 80239F84  41 82 00 E8 */	beq lbl_8023A06C                         /* constant-address: 8023A06C, symbol: lbl_8023A06C */
...
/* 80239F98  C0 22 B1 64 */	lfs f1, lit_4154(r2)                     /* constant-address: 80454B64, symbol: lit_4154 */
...
/* 80239FB4  C0 42 B1 60 */	lfs f2, lit_3911(r2)                     /* constant-address: 80454B60, symbol: lit_3911 */
...
/* 80239FC8  40 82 00 0C */	bne lbl_80239FD4                         /* constant-address: 80239FD4, symbol: lbl_80239FD4 */
/* 80239FCC  C0 02 B1 68 */	lfs f0, lit_4155(r2)                     /* constant-address: 80454B68, symbol: lit_4155 */
...
/* 80239FE4  48 01 AE D9 */	bl getGlobalVtxCenter__8CPaneMgrFP7J2DPanebs /* constant-address: 80254EBC, symbol: getGlobalVtxCenter__8CPaneMgrFP7J2DPanebs */
...
/* 8023A038  4B F5 B0 BD */	bl setPos__16dSelect_cursor_cFffP7J2DPaneb /* constant-address: 801950F4, symbol: setPos__16dSelect_cursor_cFffP7J2DPaneb */
/* 8023A03C  80 7D 00 14 */	lwz r3, 0x14(r29)                       
/* 8023A040  C0 22 B1 6C */	lfs f1, lit_4156(r2)                     /* constant-address: 80454B6C, symbol: lit_4156 */
/* 8023A044  C0 42 B1 70 */	lfs f2, lit_4157(r2)                     /* constant-address: 80454B70, symbol: lit_4157 */
/* 8023A048  C0 62 B1 74 */	lfs f3, lit_4158(r2)                     /* constant-address: 80454B74, symbol: lit_4158 */
/* 8023A04C  C0 82 B1 64 */	lfs f4, lit_4154(r2)                     /* constant-address: 80454B64, symbol: lit_4154 */
/* 8023A050  FC A0 20 90 */	fmr f5, f4                              
/* 8023A054  4B F5 B1 5D */	bl setParam__16dSelect_cursor_cFfffff    /* constant-address: 801951B0, symbol: setParam__16dSelect_cursor_cFfffff */
...
/* 8023A080  48 12 81 A1 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 8023F8B0  40 82 00 2C */	bne lbl_8023F8DC                         /* constant-address: 8023F8DC, symbol: lbl_8023F8DC */
/* 8023F8B4  80 9F 01 18 */	lwz r4, 0x118(r31)                      
/* 8023F8B8  48 00 0E 95 */	bl setBtk0Animation__14dMsgScrnItem_cFP19J2DAnmTextureSRTKey /* constant-address: 8024074C, symbol: setBtk0Animation__14dMsgScrnItem_cFP19J2DAnmTextureSRTKey */
/* 8023F8BC  7F E3 FB 78 */	mr r3, r31                              
/* 8023F8C0  80 9F 01 2C */	lwz r4, 0x12c(r31)                      
/* 8023F8C4  48 00 0F 25 */	bl setBpk0Animation__14dMsgScrnItem_cFP11J2DAnmColor /* constant-address: 802407E8, symbol: setBpk0Animation__14dMsgScrnItem_cFP11J2DAnmColor */
/* 8023F8C8  7F E3 FB 78 */	mr r3, r31                              
/* 8023F8CC  80 9F 01 30 */	lwz r4, 0x130(r31)                      
/* 8023F8D0  48 00 0F 75 */	bl setBpk1Animation__14dMsgScrnItem_cFP11J2DAnmColor /* constant-address: 80240844, symbol: setBpk1Animation__14dMsgScrnItem_cFP11J2DAnmColor */
/* 8023F8D4  38 00 00 01 */	li r0, 1                                
/* 8023F8D8  98 1F 01 9D */	stb r0, 0x19d(r31)                      
lbl_8023F8DC:
/* 8023F8DC  3C 60 80 43 */	lis r3, g_MsgObject_HIO_c@ha            
/* 8023F8E0  38 C3 02 8C */	addi r6, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 8023F8E4  C8 22 B2 18 */	lfd f1, lit_4388(r2)                     /* constant-address: 80454C18, symbol: lit_4388 */
/* 8023F8E8  3C 00 43 30 */	lis r0, 0x4330                          
/* 8023F8EC  C0 5F 01 40 */	lfs f2, 0x140(r31)                      
/* 8023F8F0  C0 06 00 48 */	lfs f0, 0x48(r6)                         /* constant-address: 804302D4, symbol: None */
...
/* 8023F924  40 82 00 1C */	bne lbl_8023F940                         /* constant-address: 8023F940, symbol: lbl_8023F940 */
...
/* 8023F950  C8 22 B2 18 */	lfd f1, lit_4388(r2)                     /* constant-address: 80454C18, symbol: lit_4388 */
...
/* 8023F968  C0 06 00 48 */	lfs f0, 0x48(r6)                         /* constant-address: 804302D4, symbol: None */
...
/* 8023F99C  40 82 00 20 */	bne lbl_8023F9BC                         /* constant-address: 8023F9BC, symbol: lbl_8023F9BC */
...
/* 8023F9C8  38 63 00 04 */	addi r3, r3, 4                           /* constant-address: 00000004 */
/* 8023F9CC  42 00 FF 94 */	bdnz lbl_8023F960                        /* constant-address: 8023F960, symbol: lbl_8023F960 */
/* 8023F9D0  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 8023F9D4  48 0B 9C BD */	bl animation__9J2DScreenFv               /* constant-address: 802F9690, symbol: animation__9J2DScreenFv */
/* 8023F9D8  7F E3 FB 78 */	mr r3, r31                              
/* 8023F9DC  4B FF CB 99 */	bl isTalkNow__14dMsgScrnBase_cFv         /* constant-address: 8023C574, symbol: isTalkNow__14dMsgScrnBase_cFv */
/* 8023F9E0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8023F9E4  41 82 00 20 */	beq lbl_8023FA04                         /* constant-address: 8023FA04, symbol: lbl_8023FA04 */
/* 8023F9E8  7F E3 FB 78 */	mr r3, r31                              
/* 8023F9EC  C0 22 B1 FC */	lfs f1, lit_4193(r2)                     /* constant-address: 80454BFC, symbol: lit_4193 */
...
/* 8023FA00  48 00 00 1C */	b lbl_8023FA1C                           /* constant-address: 8023FA1C, symbol: lbl_8023FA1C */
lbl_8023FA04:
...
/* 8023FA24  41 82 00 24 */	beq lbl_8023FA48                         /* constant-address: 8023FA48, symbol: lbl_8023FA48 */
/* 8023FA28  40 80 00 30 */	bge lbl_8023FA58                         /* constant-address: 8023FA58, symbol: lbl_8023FA58 */
/* 8023FA2C  2C 00 00 01 */	cmpwi r0, 1                             
/* 8023FA30  40 80 00 08 */	bge lbl_8023FA38                         /* constant-address: 8023FA38, symbol: lbl_8023FA38 */
/* 8023FA34  48 00 00 24 */	b lbl_8023FA58                           /* constant-address: 8023FA58, symbol: lbl_8023FA58 */
lbl_8023FA38:
/* 8023FA38  C0 3F 01 90 */	lfs f1, 0x190(r31)                      
/* 8023FA3C  C0 1F 01 84 */	lfs f0, 0x184(r31)                      
/* 8023FA40  EF E1 00 28 */	fsubs f31, f1, f0                       
/* 8023FA44  48 00 00 20 */	b lbl_8023FA64                           /* constant-address: 8023FA64, symbol: lbl_8023FA64 */
lbl_8023FA48:
/* 8023FA48  C0 3F 01 8C */	lfs f1, 0x18c(r31)                      
/* 8023FA4C  C0 1F 01 84 */	lfs f0, 0x184(r31)                      
/* 8023FA50  EF E1 00 28 */	fsubs f31, f1, f0                       
/* 8023FA54  48 00 00 10 */	b lbl_8023FA64                           /* constant-address: 8023FA64, symbol: lbl_8023FA64 */
lbl_8023FA58:
...
/* 8023FA68  38 83 02 8C */	addi r4, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 8023FA6C  C0 24 00 A8 */	lfs f1, 0xa8(r4)                         /* constant-address: 80430334, symbol: None */
/* 8023FA70  80 7F 00 08 */	lwz r3, 8(r31)                          
/* 8023FA74  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8023FA78  C0 04 00 7C */	lfs f0, 0x7c(r4)                         /* constant-address: 80430308, symbol: None */
...
/* 8023FA9C  38 83 02 8C */	addi r4, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 8023FAA0  C0 04 00 E4 */	lfs f0, 0xe4(r4)                         /* constant-address: 80430370, symbol: None */
...
/* 8023FAB8  C0 04 00 E0 */	lfs f0, 0xe0(r4)                         /* constant-address: 8043036C, symbol: None */
...
/* 8023FADC  38 83 02 8C */	addi r4, r3, g_MsgObject_HIO_c@l         /* constant-address: 8043028C, symbol: g_MsgObject_HIO_c */
/* 8023FAE0  C0 24 00 DC */	lfs f1, 0xdc(r4)                         /* constant-address: 80430368, symbol: None */
/* 8023FAE4  80 7F 01 10 */	lwz r3, 0x110(r31)                      
/* 8023FAE8  80 63 00 04 */	lwz r3, 4(r3)                           
/* 8023FAEC  C0 04 00 D8 */	lfs f0, 0xd8(r4)                         /* constant-address: 80430364, symbol: None */

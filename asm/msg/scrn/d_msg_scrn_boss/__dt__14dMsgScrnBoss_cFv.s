...
/* 8023C938  48 12 58 99 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 8023C93C  7C 7F 1B 79 */	or. r31, r3, r3                         
/* 8023C940  7C 9A 23 78 */	mr r26, r4                              
/* 8023C944  41 82 01 28 */	beq lbl_8023CA6C                         /* constant-address: 8023CA6C, symbol: lbl_8023CA6C */
/* 8023C948  3C 60 80 3C */	lis r3, __vt__14dMsgScrnBoss_c@ha       
/* 8023C94C  38 03 0D E8 */	addi r0, r3, __vt__14dMsgScrnBoss_c@l    /* constant-address: 803C0DE8, symbol: __vt__14dMsgScrnBoss_c */
/* 8023C950  90 1F 00 00 */	stw r0, 0(r31)                          
/* 8023C954  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 8023C958  28 03 00 00 */	cmplwi r3, 0                            
/* 8023C95C  41 82 00 18 */	beq lbl_8023C974                         /* constant-address: 8023C974, symbol: lbl_8023C974 */
...
/* 8023C984  41 82 00 18 */	beq lbl_8023C99C                         /* constant-address: 8023C99C, symbol: lbl_8023C99C */
...
/* 8023C9AC  41 82 00 18 */	beq lbl_8023C9C4                         /* constant-address: 8023C9C4, symbol: lbl_8023C9C4 */
...
/* 8023C9D4  41 82 00 18 */	beq lbl_8023C9EC                         /* constant-address: 8023C9EC, symbol: lbl_8023C9EC */
...
/* 8023CA08  41 82 00 18 */	beq lbl_8023CA20                         /* constant-address: 8023CA20, symbol: lbl_8023CA20 */
...
/* 8023CA30  41 80 FF CC */	blt lbl_8023C9FC                         /* constant-address: 8023C9FC, symbol: lbl_8023C9FC */
/* 8023CA34  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8023CA38  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8023CA3C  80 63 5C 7C */	lwz r3, 0x5c7c(r3)                       /* constant-address: 8040BE3C, symbol: None */
...
/* 8023CA58  4B FF F6 CD */	bl __dt__14dMsgScrnBase_cFv              /* constant-address: 8023C124, symbol: __dt__14dMsgScrnBase_cFv */
/* 8023CA5C  7F 40 07 35 */	extsh. r0, r26                          
/* 8023CA60  40 81 00 0C */	ble lbl_8023CA6C                         /* constant-address: 8023CA6C, symbol: lbl_8023CA6C */
/* 8023CA64  7F E3 FB 78 */	mr r3, r31                              
/* 8023CA68  48 09 22 D5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_8023CA6C:
/* 8023CA6C  7F E3 FB 78 */	mr r3, r31                              
/* 8023CA70  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8023CA74  48 12 57 A9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

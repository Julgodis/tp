...
/* 8023B9D0  38 04 0C F8 */	addi r0, r4, __vt__15dMsgScrnArrow_c@l   /* constant-address: 803C0CF8, symbol: __vt__15dMsgScrnArrow_c */
/* 8023B9D4  90 03 00 00 */	stw r0, 0(r3)                           
/* 8023B9D8  38 60 01 18 */	li r3, 0x118                            
/* 8023B9DC  48 09 32 71 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8023B9E0  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8023B9E4  41 82 00 0C */	beq lbl_8023B9F0                         /* constant-address: 8023B9F0, symbol: lbl_8023B9F0 */
/* 8023B9E8  48 0B CA B1 */	bl __ct__9J2DScreenFv                    /* constant-address: 802F8498, symbol: __ct__9J2DScreenFv */
...
/* 8023B9FC  38 84 98 A0 */	addi r4, r4, msg_scrn_d_msg_scrn_arrow__stringBase0@l /* constant-address: 803998A0, symbol: msg_scrn_d_msg_scrn_arrow__stringBase0 */
/* 8023BA00  3C A0 00 02 */	lis r5, 2                               
/* 8023BA04  3C C0 80 40 */	lis r6, g_dComIfG_gameInfo@ha           
/* 8023BA08  3B C6 61 C0 */	addi r30, r6, g_dComIfG_gameInfo@l       /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8023BA0C  80 DE 5C 6C */	lwz r6, 0x5c6c(r30)                      /* constant-address: 8040BE2C, symbol: None */
/* 8023BA10  48 0B CC 39 */	bl setPriority__9J2DScreenFPCcUlP10JKRArchive /* constant-address: 802F8648, symbol: setPriority__9J2DScreenFPCcUlP10JKRArchive */
/* 8023BA14  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 8023BA18  48 01 96 D1 */	bl dPaneClass_showNullPane__FP9J2DScreen /* constant-address: 802550E8, symbol: dPaneClass_showNullPane__FP9J2DScreen */
...
/* 8023BA50  38 84 98 A0 */	addi r4, r4, msg_scrn_d_msg_scrn_arrow__stringBase0@l /* constant-address: 803998A0, symbol: msg_scrn_d_msg_scrn_arrow__stringBase0 */
/* 8023BA54  38 64 00 1B */	addi r3, r4, 0x1b                        /* constant-address: 803998BB, symbol: None */
/* 8023BA58  80 9E 5C 6C */	lwz r4, 0x5c6c(r30)                      /* constant-address: 8040BE2C, symbol: None */
/* 8023BA5C  48 09 88 15 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8023BA60  48 0C D0 0D */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
/* 8023BA64  90 7F 00 08 */	stw r3, 8(r31)                          
/* 8023BA68  C0 02 B1 98 */	lfs f0, lit_3662(r2)                     /* constant-address: 80454B98, symbol: lit_3662 */
/* 8023BA6C  D0 1F 00 1C */	stfs f0, 0x1c(r31)                      
/* 8023BA70  3C 80 80 3A */	lis r4, msg_scrn_d_msg_scrn_arrow__stringBase0@ha
/* 8023BA74  38 84 98 A0 */	addi r4, r4, msg_scrn_d_msg_scrn_arrow__stringBase0@l /* constant-address: 803998A0, symbol: msg_scrn_d_msg_scrn_arrow__stringBase0 */
/* 8023BA78  38 64 00 36 */	addi r3, r4, 0x36                        /* constant-address: 803998D6, symbol: None */
/* 8023BA7C  80 9E 5C 6C */	lwz r4, 0x5c6c(r30)                      /* constant-address: 8040BE2C, symbol: None */
/* 8023BA80  48 09 87 F1 */	bl getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader /* constant-address: 802D4270, symbol: getGlbResource__13JKRFileLoaderFPCcP13JKRFileLoader */
/* 8023BA84  48 0C CF E9 */	bl load__20J2DAnmLoaderDataBaseFPCv      /* constant-address: 80308A6C, symbol: load__20J2DAnmLoaderDataBaseFPCv */
...
/* 8023BAA4  C0 02 B1 98 */	lfs f0, lit_3662(r2)                     /* constant-address: 80454B98, symbol: lit_3662 */
/* 8023BAA8  D0 1F 00 20 */	stfs f0, 0x20(r31)                      
/* 8023BAAC  38 60 00 6C */	li r3, 0x6c                             
/* 8023BAB0  48 09 31 9D */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8023BAB4  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8023BAB8  41 82 00 28 */	beq lbl_8023BAE0                         /* constant-address: 8023BAE0, symbol: lbl_8023BAE0 */
/* 8023BABC  80 9F 00 04 */	lwz r4, 4(r31)                          
/* 8023BAC0  3C A0 79 61 */	lis r5, 0x7961 /* 0x79615F6E@ha */      
/* 8023BAC4  38 C5 5F 6E */	addi r6, r5, 0x5F6E /* 0x79615F6E@l */   /* constant-address: 79615F6E */
/* 8023BAC8  3C A0 73 65 */	lis r5, 0x7365 /* 0x7365745F@ha */      
/* 8023BACC  38 A5 74 5F */	addi r5, r5, 0x745F /* 0x7365745F@l */   /* constant-address: 7365745F */
/* 8023BAD0  38 E0 00 00 */	li r7, 0                                
/* 8023BAD4  39 00 00 00 */	li r8, 0                                
/* 8023BAD8  48 01 7E AD */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
/* 8023BADC  7C 60 1B 78 */	mr r0, r3                               
lbl_8023BAE0:
/* 8023BAE0  90 1F 00 10 */	stw r0, 0x10(r31)                       
/* 8023BAE4  38 60 00 6C */	li r3, 0x6c                             
/* 8023BAE8  48 09 31 65 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8023BAEC  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8023BAF0  41 82 00 28 */	beq lbl_8023BB18                         /* constant-address: 8023BB18, symbol: lbl_8023BB18 */
/* 8023BAF4  80 9F 00 04 */	lwz r4, 4(r31)                          
/* 8023BAF8  3C A0 6E 65 */	lis r5, 0x6E65 /* 0x6E657874@ha */      
/* 8023BAFC  38 C5 78 74 */	addi r6, r5, 0x7874 /* 0x6E657874@l */   /* constant-address: 6E657874 */
/* 8023BB00  3C A0 00 79 */	lis r5, 0x0079 /* 0x0079615F@ha */      
/* 8023BB04  38 A5 61 5F */	addi r5, r5, 0x615F /* 0x0079615F@l */   /* constant-address: 0079615F */
/* 8023BB08  38 E0 00 00 */	li r7, 0                                
/* 8023BB0C  39 00 00 00 */	li r8, 0                                
/* 8023BB10  48 01 7E 75 */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
/* 8023BB14  7C 60 1B 78 */	mr r0, r3                               
lbl_8023BB18:
/* 8023BB18  90 1F 00 14 */	stw r0, 0x14(r31)                       
/* 8023BB1C  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8023BB20  48 01 9A E9 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
...
/* 8023BB48  38 C4 78 74 */	addi r6, r4, 0x7874 /* 0x6E657874@l */   /* constant-address: 6E657874 */
/* 8023BB4C  3C 80 00 79 */	lis r4, 0x0079 /* 0x0079616A@ha */      
/* 8023BB50  38 A4 61 6A */	addi r5, r4, 0x616A /* 0x0079616A@l */   /* constant-address: 0079616A */
...
/* 8023BB80  38 C4 78 6C */	addi r6, r4, 0x786C /* 0x6E65786C@l */   /* constant-address: 6E65786C */
/* 8023BB84  3C 80 79 61 */	lis r4, 0x7961 /* 0x79616A69@ha */      
/* 8023BB88  38 A4 6A 69 */	addi r5, r4, 0x6A69 /* 0x79616A69@l */   /* constant-address: 79616A69 */
...
/* 8023BBB4  48 09 30 99 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8023BBB8  7C 60 1B 79 */	or. r0, r3, r3                          
/* 8023BBBC  41 82 00 24 */	beq lbl_8023BBE0                         /* constant-address: 8023BBE0, symbol: lbl_8023BBE0 */
/* 8023BBC0  80 9F 00 04 */	lwz r4, 4(r31)                          
/* 8023BBC4  3C A0 5F 65 */	lis r5, 0x5F65 /* 0x5F656E64@ha */      
/* 8023BBC8  38 C5 6E 64 */	addi r6, r5, 0x6E64 /* 0x5F656E64@l */   /* constant-address: 5F656E64 */
/* 8023BBCC  38 A0 79 61 */	li r5, 0x7961                           
/* 8023BBD0  38 E0 00 00 */	li r7, 0                                
/* 8023BBD4  39 00 00 00 */	li r8, 0                                
/* 8023BBD8  48 01 7D AD */	bl __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap /* constant-address: 80253984, symbol: __ct__8CPaneMgrFP9J2DScreenUxUcP10JKRExpHeap */
/* 8023BBDC  7C 60 1B 78 */	mr r0, r3                               
lbl_8023BBE0:
/* 8023BBE0  90 1F 00 18 */	stw r0, 0x18(r31)                       
/* 8023BBE4  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 8023BBE8  48 01 9A 21 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
/* 8023BBEC  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 8023BBF0  3C 80 5F 65 */	lis r4, 0x5F65 /* 0x5F656E64@ha */      
/* 8023BBF4  38 C4 6E 64 */	addi r6, r4, 0x6E64 /* 0x5F656E64@l */   /* constant-address: 5F656E64 */
/* 8023BBF8  3C 80 00 79 */	lis r4, 0x0079 /* 0x0079616A@ha */      
/* 8023BBFC  38 A4 61 6A */	addi r5, r4, 0x616A /* 0x0079616A@l */   /* constant-address: 0079616A */
...
/* 8023BC2C  38 C4 64 6C */	addi r6, r4, 0x646C /* 0x656E646C@l */   /* constant-address: 656E646C */
/* 8023BC30  3C 80 79 61 */	lis r4, 0x7961 /* 0x79616A69@ha */      
/* 8023BC34  38 A4 6A 69 */	addi r5, r4, 0x6A69 /* 0x79616A69@l */   /* constant-address: 79616A69 */

...
/* 8023BEA8  48 01 97 A5 */	bl isVisible__13CPaneMgrAlphaFv          /* constant-address: 8025564C, symbol: isVisible__13CPaneMgrAlphaFv */
/* 8023BEAC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8023BEB0  40 82 00 0C */	bne lbl_8023BEBC                         /* constant-address: 8023BEBC, symbol: lbl_8023BEBC */
/* 8023BEB4  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8023BEB8  48 01 97 11 */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
lbl_8023BEBC:
/* 8023BEBC  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 8023BEC0  48 01 97 8D */	bl isVisible__13CPaneMgrAlphaFv          /* constant-address: 8025564C, symbol: isVisible__13CPaneMgrAlphaFv */
/* 8023BEC4  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8023BEC8  28 00 00 01 */	cmplwi r0, 1                            
/* 8023BECC  40 82 00 0C */	bne lbl_8023BED8                         /* constant-address: 8023BED8, symbol: lbl_8023BED8 */
/* 8023BED0  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 8023BED4  48 01 97 35 */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
lbl_8023BED8:
/* 8023BED8  C0 3F 00 1C */	lfs f1, 0x1c(r31)                       
/* 8023BEDC  C0 02 B1 9C */	lfs f0, lit_3761(r2)                     /* constant-address: 80454B9C, symbol: lit_3761 */
...
/* 8023BEF4  C8 22 B1 A0 */	lfd f1, lit_3763(r2)                     /* constant-address: 80454BA0, symbol: lit_3763 */
...
/* 8023BF18  40 82 00 1C */	bne lbl_8023BF34                         /* constant-address: 8023BF34, symbol: lbl_8023BF34 */
...
/* 8023BF44  C0 02 B1 9C */	lfs f0, lit_3761(r2)                     /* constant-address: 80454B9C, symbol: lit_3761 */
...
/* 8023BF5C  C8 22 B1 A0 */	lfd f1, lit_3763(r2)                     /* constant-address: 80454BA0, symbol: lit_3763 */
...
/* 8023BF80  40 82 00 1C */	bne lbl_8023BF9C                         /* constant-address: 8023BF9C, symbol: lbl_8023BF9C */
...
/* 8023BFAC  48 0B D6 E5 */	bl animation__9J2DScreenFv               /* constant-address: 802F9690, symbol: animation__9J2DScreenFv */

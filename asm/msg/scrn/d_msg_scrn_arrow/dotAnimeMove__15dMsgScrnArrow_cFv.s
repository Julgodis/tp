...
/* 8023C028  48 01 96 25 */	bl isVisible__13CPaneMgrAlphaFv          /* constant-address: 8025564C, symbol: isVisible__13CPaneMgrAlphaFv */
/* 8023C02C  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 8023C030  28 00 00 01 */	cmplwi r0, 1                            
/* 8023C034  40 82 00 0C */	bne lbl_8023C040                         /* constant-address: 8023C040, symbol: lbl_8023C040 */
/* 8023C038  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8023C03C  48 01 95 CD */	bl hide__13CPaneMgrAlphaFv               /* constant-address: 80255608, symbol: hide__13CPaneMgrAlphaFv */
lbl_8023C040:
/* 8023C040  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 8023C044  48 01 96 09 */	bl isVisible__13CPaneMgrAlphaFv          /* constant-address: 8025564C, symbol: isVisible__13CPaneMgrAlphaFv */
/* 8023C048  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8023C04C  40 82 00 0C */	bne lbl_8023C058                         /* constant-address: 8023C058, symbol: lbl_8023C058 */
/* 8023C050  80 7F 00 18 */	lwz r3, 0x18(r31)                       
/* 8023C054  48 01 95 75 */	bl show__13CPaneMgrAlphaFv               /* constant-address: 802555C8, symbol: show__13CPaneMgrAlphaFv */
lbl_8023C058:
/* 8023C058  C0 3F 00 20 */	lfs f1, 0x20(r31)                       
/* 8023C05C  C0 02 B1 9C */	lfs f0, lit_3761(r2)                     /* constant-address: 80454B9C, symbol: lit_3761 */
...
/* 8023C074  C8 22 B1 A0 */	lfd f1, lit_3763(r2)                     /* constant-address: 80454BA0, symbol: lit_3763 */
...
/* 8023C098  40 82 00 1C */	bne lbl_8023C0B4                         /* constant-address: 8023C0B4, symbol: lbl_8023C0B4 */
...
/* 8023C0C4  48 0B D5 CD */	bl animation__9J2DScreenFv               /* constant-address: 802F9690, symbol: animation__9J2DScreenFv */

...
/* 8024613C  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 80246140  83 E3 5F 50 */	lwz r31, 0x5f50(r3)                      /* constant-address: 8040C110, symbol: None */
...
/* 8024615C  48 00 F6 CD */	bl getAlphaRate__13CPaneMgrAlphaFv       /* constant-address: 80255828, symbol: getAlphaRate__13CPaneMgrAlphaFv */
/* 80246160  FF E0 08 90 */	fmr f31, f1                             
/* 80246164  88 1E 00 21 */	lbz r0, 0x21(r30)                       
/* 80246168  28 00 00 03 */	cmplwi r0, 3                            
/* 8024616C  41 82 00 0C */	beq lbl_80246178                         /* constant-address: 80246178, symbol: lbl_80246178 */
/* 80246170  28 00 00 05 */	cmplwi r0, 5                            
/* 80246174  40 82 00 10 */	bne lbl_80246184                         /* constant-address: 80246184, symbol: lbl_80246184 */
lbl_80246178:
/* 80246178  C0 1E 00 1C */	lfs f0, 0x1c(r30)                       
/* 8024617C  FC 1E 00 40 */	fcmpo cr0, f30, f0                      
/* 80246180  41 80 00 20 */	blt lbl_802461A0                         /* constant-address: 802461A0, symbol: lbl_802461A0 */
lbl_80246184:
/* 80246184  28 00 00 03 */	cmplwi r0, 3                            
/* 80246188  41 82 00 74 */	beq lbl_802461FC                         /* constant-address: 802461FC, symbol: lbl_802461FC */
/* 8024618C  28 00 00 05 */	cmplwi r0, 5                            
/* 80246190  41 82 00 6C */	beq lbl_802461FC                         /* constant-address: 802461FC, symbol: lbl_802461FC */
/* 80246194  C0 02 B2 DC */	lfs f0, lit_3869(r2)                     /* constant-address: 80454CDC, symbol: lit_3869 */
/* 80246198  FC 00 F0 00 */	fcmpu cr0, f0, f30                      
/* 8024619C  41 82 00 60 */	beq lbl_802461FC                         /* constant-address: 802461FC, symbol: lbl_802461FC */
lbl_802461A0:
/* 802461A0  88 1E 00 22 */	lbz r0, 0x22(r30)                       
/* 802461A4  28 00 00 00 */	cmplwi r0, 0                            
/* 802461A8  41 82 00 44 */	beq lbl_802461EC                         /* constant-address: 802461EC, symbol: lbl_802461EC */
...
/* 802461F4  48 00 F5 DD */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
/* 802461F8  48 00 00 50 */	b lbl_80246248                           /* constant-address: 80246248, symbol: lbl_80246248 */
lbl_802461FC:
/* 802461FC  88 1E 00 22 */	lbz r0, 0x22(r30)                       
/* 80246200  28 00 00 00 */	cmplwi r0, 0                            
/* 80246204  40 82 00 44 */	bne lbl_80246248                         /* constant-address: 80246248, symbol: lbl_80246248 */
...
/* 80246250  41 82 00 30 */	beq lbl_80246280                         /* constant-address: 80246280, symbol: lbl_80246280 */
...
/* 80246274  48 0B 1D 59 */	bl animationTransform__7J2DPaneFv        /* constant-address: 802F7FCC, symbol: animationTransform__7J2DPaneFv */
/* 80246278  80 7E 00 04 */	lwz r3, 4(r30)                          
/* 8024627C  48 0B 34 15 */	bl animation__9J2DScreenFv               /* constant-address: 802F9690, symbol: animation__9J2DScreenFv */
lbl_80246280:
...
/* 802462D4  C0 22 B2 D8 */	lfs f1, lit_3808(r2)                     /* constant-address: 80454CD8, symbol: lit_3808 */
/* 802462D8  FC 40 08 90 */	fmr f2, f1                              
/* 802462DC  7F E4 FB 78 */	mr r4, r31                              
/* 802462E0  48 0B 2B F5 */	bl draw__9J2DScreenFffPC14J2DGrafContext /* constant-address: 802F8ED4, symbol: draw__9J2DScreenFffPC14J2DGrafContext */
/* 802462E4  C0 02 B2 DC */	lfs f0, lit_3869(r2)                     /* constant-address: 80454CDC, symbol: lit_3869 */
/* 802462E8  FC 00 F0 00 */	fcmpu cr0, f0, f30                      
/* 802462EC  41 82 00 10 */	beq lbl_802462FC                         /* constant-address: 802462FC, symbol: lbl_802462FC */
/* 802462F0  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 802462F4  FC 20 F8 90 */	fmr f1, f31                             
/* 802462F8  48 00 F4 D9 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_802462FC:

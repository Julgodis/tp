...
/* 8023C508  48 12 5C D1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8023C528  41 82 00 0C */	beq lbl_8023C534                         /* constant-address: 8023C534, symbol: lbl_8023C534 */
/* 8023C52C  FC 20 F8 90 */	fmr f1, f31                             
/* 8023C530  48 01 92 A1 */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_8023C534:
/* 8023C534  80 7E 00 28 */	lwz r3, 0x28(r30)                       
/* 8023C538  28 03 00 00 */	cmplwi r3, 0                            
/* 8023C53C  41 82 00 0C */	beq lbl_8023C548                         /* constant-address: 8023C548, symbol: lbl_8023C548 */
/* 8023C540  FC 20 F8 90 */	fmr f1, f31                             
/* 8023C544  48 01 92 8D */	bl setAlphaRate__13CPaneMgrAlphaFf       /* constant-address: 802557D0, symbol: setAlphaRate__13CPaneMgrAlphaFf */
lbl_8023C548:
/* 8023C548  3B BD 00 01 */	addi r29, r29, 1                        
/* 8023C54C  2C 1D 00 07 */	cmpwi r29, 7                            
/* 8023C550  3B FF 00 04 */	addi r31, r31, 4                        
/* 8023C554  41 80 FF C8 */	blt lbl_8023C51C                         /* constant-address: 8023C51C, symbol: lbl_8023C51C */
/* 8023C558  CB E1 00 18 */	lfd f31, 0x18(r1)                       
/* 8023C55C  39 61 00 18 */	addi r11, r1, 0x18                      
/* 8023C560  48 12 5C C5 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

...
/* 8023C580  4B FF BC AD */	bl getStatus__12dMsgObject_cFv           /* constant-address: 8023822C, symbol: getStatus__12dMsgObject_cFv */
/* 8023C584  54 63 04 3E */	clrlwi r3, r3, 0x10                     
/* 8023C588  38 03 FF FB */	addi r0, r3, -5                         
/* 8023C58C  28 00 00 13 */	cmplwi r0, 0x13                         
/* 8023C590  41 81 00 24 */	bgt lbl_8023C5B4                         /* constant-address: 8023C5B4, symbol: lbl_8023C5B4 */
/* 8023C594  3C 60 80 3C */	lis r3, lit_3949@ha                     
/* 8023C598  38 63 0D 08 */	addi r3, r3, lit_3949@l                  /* constant-address: 803C0D08, symbol: lit_3949 */
...
/* 8023C5B0  48 00 00 08 */	b lbl_8023C5B8                           /* constant-address: 8023C5B8, symbol: lbl_8023C5B8 */
lbl_8023C5B4:

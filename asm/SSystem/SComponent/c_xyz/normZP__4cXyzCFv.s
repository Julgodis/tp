...
/* 80266D50  48 0E 03 E9 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 80266D54  C0 02 B6 74 */	lfs f0, lit_2288(r2)                     /* constant-address: 80455074, symbol: lit_2288 */
/* 80266D58  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80266D5C  7C 00 00 26 */	mfcr r0                                 
/* 80266D60  54 00 0F FF */	rlwinm. r0, r0, 1, 0x1f, 0x1f           
/* 80266D64  40 82 00 14 */	bne lbl_80266D78                         /* constant-address: 80266D78, symbol: lbl_80266D78 */
/* 80266D68  7F E3 FB 78 */	mr r3, r31                              
/* 80266D6C  38 81 00 08 */	addi r4, r1, 8                          
/* 80266D70  48 0E 03 85 */	bl PSVECNormalize                        /* constant-address: 803470F4, symbol: PSVECNormalize */
/* 80266D74  48 00 00 20 */	b lbl_80266D94                           /* constant-address: 80266D94, symbol: lbl_80266D94 */
lbl_80266D78:
/* 80266D78  3C 60 80 43 */	lis r3, Zero__4cXyz@ha                  
/* 80266D7C  C4 03 0C F4 */	lfsu f0, Zero__4cXyz@l(r3)               /* constant-address: 80430CF4, symbol: Zero__4cXyz */
/* 80266D80  D0 01 00 08 */	stfs f0, 8(r1)                          
/* 80266D84  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80430CF8, symbol: None */
/* 80266D88  D0 01 00 0C */	stfs f0, 0xc(r1)                        
/* 80266D8C  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80430CFC, symbol: None */

...
/* 80266DE4  48 0E 03 55 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 80266DE8  C0 02 B6 74 */	lfs f0, lit_2288(r2)                     /* constant-address: 80455074, symbol: lit_2288 */
/* 80266DEC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80266DF0  7C 00 00 26 */	mfcr r0                                 
/* 80266DF4  54 00 0F FF */	rlwinm. r0, r0, 1, 0x1f, 0x1f           
/* 80266DF8  40 82 00 14 */	bne lbl_80266E0C                         /* constant-address: 80266E0C, symbol: lbl_80266E0C */
/* 80266DFC  7F E3 FB 78 */	mr r3, r31                              
/* 80266E00  38 81 00 44 */	addi r4, r1, 0x44                       
/* 80266E04  48 0E 02 F1 */	bl PSVECNormalize                        /* constant-address: 803470F4, symbol: PSVECNormalize */
/* 80266E08  48 00 00 BC */	b lbl_80266EC4                           /* constant-address: 80266EC4, symbol: lbl_80266EC4 */
lbl_80266E0C:
/* 80266E0C  38 61 00 38 */	addi r3, r1, 0x38                       
/* 80266E10  7F E4 FB 78 */	mr r4, r31                              
/* 80266E14  C0 22 B6 78 */	lfs f1, lit_2325(r2)                     /* constant-address: 80455078, symbol: lit_2325 */
/* 80266E18  4B FF FD 6D */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
/* 80266E1C  38 61 00 2C */	addi r3, r1, 0x2c                       
/* 80266E20  38 81 00 38 */	addi r4, r1, 0x38                       
/* 80266E24  C0 22 B6 7C */	lfs f1, lit_2326(r2)                     /* constant-address: 8045507C, symbol: lit_2326 */
/* 80266E28  4B FF FD 5D */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
/* 80266E2C  38 61 00 20 */	addi r3, r1, 0x20                       
/* 80266E30  38 81 00 2C */	addi r4, r1, 0x2c                       
/* 80266E34  4B FF FE FD */	bl normZP__4cXyzCFv                      /* constant-address: 80266D30, symbol: normZP__4cXyzCFv */
...
/* 80266E60  48 0E 02 D9 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 80266E64  C0 02 B6 74 */	lfs f0, lit_2288(r2)                     /* constant-address: 80455074, symbol: lit_2288 */
/* 80266E68  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80266E6C  7C 00 00 26 */	mfcr r0                                 
/* 80266E70  54 00 0F FF */	rlwinm. r0, r0, 1, 0x1f, 0x1f           
/* 80266E74  41 82 00 50 */	beq lbl_80266EC4                         /* constant-address: 80266EC4, symbol: lbl_80266EC4 */
/* 80266E78  C0 02 B6 80 */	lfs f0, lit_2327(r2)                     /* constant-address: 80455080, symbol: lit_2327 */
/* 80266E7C  D0 01 00 44 */	stfs f0, 0x44(r1)                       
/* 80266E80  D0 01 00 48 */	stfs f0, 0x48(r1)                       
/* 80266E84  C0 02 B6 70 */	lfs f0, lit_2201(r2)                     /* constant-address: 80455070, symbol: lit_2201 */
/* 80266E88  D0 01 00 4C */	stfs f0, 0x4c(r1)                       
/* 80266E8C  3C 60 80 3A */	lis r3, lit_2299@ha                     
/* 80266E90  38 83 A8 68 */	addi r4, r3, lit_2299@l                  /* constant-address: 8039A868, symbol: lit_2299 */
/* 80266E94  80 64 00 00 */	lwz r3, 0(r4)                            /* constant-address: 8039A868, symbol: lit_2299 */
/* 80266E98  80 04 00 04 */	lwz r0, 4(r4)                            /* constant-address: 8039A86C, symbol: None */
/* 80266E9C  90 61 00 08 */	stw r3, 8(r1)                           
/* 80266EA0  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 80266EA4  80 04 00 08 */	lwz r0, 8(r4)                            /* constant-address: 8039A870, symbol: None */

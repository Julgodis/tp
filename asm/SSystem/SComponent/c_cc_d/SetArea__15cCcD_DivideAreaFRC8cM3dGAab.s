...
/* 802633C0  48 00 B8 95 */	bl Set__8cM3dGAabFPC4cXyzPC4cXyz         /* constant-address: 8026EC54, symbol: Set__8cM3dGAabFPC4cXyzPC4cXyz */
/* 802633C4  C0 42 B6 18 */	lfs f2, lit_2305(r2)                     /* constant-address: 80455018, symbol: lit_2305 */
...
/* 802633E8  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
...
/* 80263404  40 82 00 14 */	bne lbl_80263418                         /* constant-address: 80263418, symbol: lbl_80263418 */
/* 80263408  C0 22 B6 1C */	lfs f1, lit_2306(r2)                     /* constant-address: 8045501C, symbol: lit_2306 */
/* 8026340C  C0 1F 00 20 */	lfs f0, 0x20(r31)                       
/* 80263410  EC 01 00 24 */	fdivs f0, f1, f0                        
/* 80263414  D0 1F 00 24 */	stfs f0, 0x24(r31)                      
lbl_80263418:
/* 80263418  C0 42 B6 18 */	lfs f2, lit_2305(r2)                     /* constant-address: 80455018, symbol: lit_2305 */
...
/* 8026343C  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
...
/* 80263458  40 82 00 14 */	bne lbl_8026346C                         /* constant-address: 8026346C, symbol: lbl_8026346C */
/* 8026345C  C0 22 B6 1C */	lfs f1, lit_2306(r2)                     /* constant-address: 8045501C, symbol: lit_2306 */
/* 80263460  C0 1F 00 2C */	lfs f0, 0x2c(r31)                       
/* 80263464  EC 01 00 24 */	fdivs f0, f1, f0                        
/* 80263468  D0 1F 00 30 */	stfs f0, 0x30(r31)                      
lbl_8026346C:
/* 8026346C  C0 42 B6 18 */	lfs f2, lit_2305(r2)                     /* constant-address: 80455018, symbol: lit_2305 */
...
/* 80263490  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
...
/* 802634AC  40 82 00 14 */	bne lbl_802634C0                         /* constant-address: 802634C0, symbol: lbl_802634C0 */
/* 802634B0  C0 22 B6 1C */	lfs f1, lit_2306(r2)                     /* constant-address: 8045501C, symbol: lit_2306 */

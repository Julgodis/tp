...
/* 8027038C  40 82 00 14 */	bne lbl_802703A0                         /* constant-address: 802703A0, symbol: lbl_802703A0 */
/* 80270390  C0 3F 00 08 */	lfs f1, 8(r31)                          
/* 80270394  C0 05 00 08 */	lfs f0, 8(r5)                           
/* 80270398  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8027039C  41 82 01 80 */	beq lbl_8027051C                         /* constant-address: 8027051C, symbol: lbl_8027051C */
lbl_802703A0:
/* 802703A0  38 61 00 24 */	addi r3, r1, 0x24                       
/* 802703A4  7F E4 FB 78 */	mr r4, r31                              
/* 802703A8  4B FF 67 8D */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
/* 802703AC  38 61 00 18 */	addi r3, r1, 0x18                       
/* 802703B0  38 81 00 24 */	addi r4, r1, 0x24                       
/* 802703B4  FC 20 F0 90 */	fmr f1, f30                             
/* 802703B8  4B FF 67 CD */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 802703D8  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
/* 802703DC  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 802703E0  D0 21 00 14 */	stfs f1, 0x14(r1)                       
/* 802703E4  38 61 00 0C */	addi r3, r1, 0xc                        
/* 802703E8  48 0D 6D 51 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 802703EC  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
/* 802703F0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802703F4  40 81 00 58 */	ble lbl_8027044C                         /* constant-address: 8027044C, symbol: lbl_8027044C */
/* 802703F8  FC 00 08 34 */	frsqrte f0, f1                          
/* 802703FC  C8 82 B7 E8 */	lfd f4, lit_2379(r2)                     /* constant-address: 804551E8, symbol: lit_2379 */
/* 80270400  FC 44 00 32 */	fmul f2, f4, f0                         
/* 80270404  C8 62 B7 F0 */	lfd f3, lit_2380(r2)                     /* constant-address: 804551F0, symbol: lit_2380 */
...
/* 80270448  48 00 00 88 */	b lbl_802704D0                           /* constant-address: 802704D0, symbol: lbl_802704D0 */
lbl_8027044C:
/* 8027044C  C8 02 B7 F8 */	lfd f0, lit_2381(r2)                     /* constant-address: 804551F8, symbol: lit_2381 */
/* 80270450  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80270454  40 80 00 10 */	bge lbl_80270464                         /* constant-address: 80270464, symbol: lbl_80270464 */
/* 80270458  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8027045C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 80270460  48 00 00 70 */	b lbl_802704D0                           /* constant-address: 802704D0, symbol: lbl_802704D0 */
lbl_80270464:
...
/* 80270478  41 82 00 14 */	beq lbl_8027048C                         /* constant-address: 8027048C, symbol: lbl_8027048C */
/* 8027047C  40 80 00 40 */	bge lbl_802704BC                         /* constant-address: 802704BC, symbol: lbl_802704BC */
/* 80270480  2C 03 00 00 */	cmpwi r3, 0                             
/* 80270484  41 82 00 20 */	beq lbl_802704A4                         /* constant-address: 802704A4, symbol: lbl_802704A4 */
/* 80270488  48 00 00 34 */	b lbl_802704BC                           /* constant-address: 802704BC, symbol: lbl_802704BC */
lbl_8027048C:
/* 8027048C  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 80270490  41 82 00 0C */	beq lbl_8027049C                         /* constant-address: 8027049C, symbol: lbl_8027049C */
/* 80270494  38 00 00 01 */	li r0, 1                                
/* 80270498  48 00 00 28 */	b lbl_802704C0                           /* constant-address: 802704C0, symbol: lbl_802704C0 */
lbl_8027049C:
/* 8027049C  38 00 00 02 */	li r0, 2                                
/* 802704A0  48 00 00 20 */	b lbl_802704C0                           /* constant-address: 802704C0, symbol: lbl_802704C0 */
lbl_802704A4:
/* 802704A4  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 802704A8  41 82 00 0C */	beq lbl_802704B4                         /* constant-address: 802704B4, symbol: lbl_802704B4 */
/* 802704AC  38 00 00 05 */	li r0, 5                                
/* 802704B0  48 00 00 10 */	b lbl_802704C0                           /* constant-address: 802704C0, symbol: lbl_802704C0 */
lbl_802704B4:
/* 802704B4  38 00 00 03 */	li r0, 3                                
/* 802704B8  48 00 00 08 */	b lbl_802704C0                           /* constant-address: 802704C0, symbol: lbl_802704C0 */
lbl_802704BC:
/* 802704BC  38 00 00 04 */	li r0, 4                                
lbl_802704C0:
/* 802704C0  2C 00 00 01 */	cmpwi r0, 1                             
/* 802704C4  40 82 00 0C */	bne lbl_802704D0                         /* constant-address: 802704D0, symbol: lbl_802704D0 */
/* 802704C8  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 802704CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_802704D0:
/* 802704D0  FC 00 0A 10 */	fabs f0, f1                             
/* 802704D4  FC 40 00 18 */	frsp f2, f0                             
/* 802704D8  C0 02 B8 00 */	lfs f0, lit_2382(r2)                     /* constant-address: 80455200, symbol: lit_2382 */
/* 802704DC  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 802704E0  41 80 00 3C */	blt lbl_8027051C                         /* constant-address: 8027051C, symbol: lbl_8027051C */
/* 802704E4  FC 01 F8 40 */	fcmpo cr0, f1, f31                      
/* 802704E8  40 81 00 14 */	ble lbl_802704FC                         /* constant-address: 802704FC, symbol: lbl_802704FC */
/* 802704EC  38 61 00 30 */	addi r3, r1, 0x30                       
/* 802704F0  7C 64 1B 78 */	mr r4, r3                               
/* 802704F4  EC 3F 08 24 */	fdivs f1, f31, f1                       
/* 802704F8  48 0D 6B E1 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
lbl_802704FC:

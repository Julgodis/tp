...
/* 802701AC  4B FF 6E C1 */	bl __ne__4cXyzCFRC3Vec                   /* constant-address: 8026706C, symbol: __ne__4cXyzCFRC3Vec */
/* 802701B0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802701B4  41 82 01 74 */	beq lbl_80270328                         /* constant-address: 80270328, symbol: lbl_80270328 */
/* 802701B8  38 61 00 24 */	addi r3, r1, 0x24                       
/* 802701BC  7F C4 F3 78 */	mr r4, r30                              
/* 802701C0  7F E5 FB 78 */	mr r5, r31                              
/* 802701C4  4B FF 69 71 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
/* 802701C8  38 61 00 18 */	addi r3, r1, 0x18                       
/* 802701CC  38 81 00 24 */	addi r4, r1, 0x24                       
/* 802701D0  FC 20 F0 90 */	fmr f1, f30                             
/* 802701D4  4B FF 69 B1 */	bl __ml__4cXyzCFf                        /* constant-address: 80266B84, symbol: __ml__4cXyzCFf */
...
/* 802701F4  48 0D 6F 45 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 802701F8  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
/* 802701FC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80270200  40 81 00 58 */	ble lbl_80270258                         /* constant-address: 80270258, symbol: lbl_80270258 */
/* 80270204  FC 00 08 34 */	frsqrte f0, f1                          
/* 80270208  C8 82 B7 E8 */	lfd f4, lit_2379(r2)                     /* constant-address: 804551E8, symbol: lit_2379 */
/* 8027020C  FC 44 00 32 */	fmul f2, f4, f0                         
/* 80270210  C8 62 B7 F0 */	lfd f3, lit_2380(r2)                     /* constant-address: 804551F0, symbol: lit_2380 */
...
/* 80270254  48 00 00 88 */	b lbl_802702DC                           /* constant-address: 802702DC, symbol: lbl_802702DC */
lbl_80270258:
/* 80270258  C8 02 B7 F8 */	lfd f0, lit_2381(r2)                     /* constant-address: 804551F8, symbol: lit_2381 */
/* 8027025C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80270260  40 80 00 10 */	bge lbl_80270270                         /* constant-address: 80270270, symbol: lbl_80270270 */
/* 80270264  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 80270268  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8027026C  48 00 00 70 */	b lbl_802702DC                           /* constant-address: 802702DC, symbol: lbl_802702DC */
lbl_80270270:
...
/* 80270284  41 82 00 14 */	beq lbl_80270298                         /* constant-address: 80270298, symbol: lbl_80270298 */
/* 80270288  40 80 00 40 */	bge lbl_802702C8                         /* constant-address: 802702C8, symbol: lbl_802702C8 */
/* 8027028C  2C 03 00 00 */	cmpwi r3, 0                             
/* 80270290  41 82 00 20 */	beq lbl_802702B0                         /* constant-address: 802702B0, symbol: lbl_802702B0 */
/* 80270294  48 00 00 34 */	b lbl_802702C8                           /* constant-address: 802702C8, symbol: lbl_802702C8 */
lbl_80270298:
/* 80270298  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8027029C  41 82 00 0C */	beq lbl_802702A8                         /* constant-address: 802702A8, symbol: lbl_802702A8 */
/* 802702A0  38 00 00 01 */	li r0, 1                                
/* 802702A4  48 00 00 28 */	b lbl_802702CC                           /* constant-address: 802702CC, symbol: lbl_802702CC */
lbl_802702A8:
/* 802702A8  38 00 00 02 */	li r0, 2                                
/* 802702AC  48 00 00 20 */	b lbl_802702CC                           /* constant-address: 802702CC, symbol: lbl_802702CC */
lbl_802702B0:
/* 802702B0  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 802702B4  41 82 00 0C */	beq lbl_802702C0                         /* constant-address: 802702C0, symbol: lbl_802702C0 */
/* 802702B8  38 00 00 05 */	li r0, 5                                
/* 802702BC  48 00 00 10 */	b lbl_802702CC                           /* constant-address: 802702CC, symbol: lbl_802702CC */
lbl_802702C0:
/* 802702C0  38 00 00 03 */	li r0, 3                                
/* 802702C4  48 00 00 08 */	b lbl_802702CC                           /* constant-address: 802702CC, symbol: lbl_802702CC */
lbl_802702C8:
/* 802702C8  38 00 00 04 */	li r0, 4                                
lbl_802702CC:
/* 802702CC  2C 00 00 01 */	cmpwi r0, 1                             
/* 802702D0  40 82 00 0C */	bne lbl_802702DC                         /* constant-address: 802702DC, symbol: lbl_802702DC */
/* 802702D4  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 802702D8  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_802702DC:
/* 802702DC  FC 01 F8 40 */	fcmpo cr0, f1, f31                      
/* 802702E0  40 81 00 38 */	ble lbl_80270318                         /* constant-address: 80270318, symbol: lbl_80270318 */
/* 802702E4  38 61 00 0C */	addi r3, r1, 0xc                        
/* 802702E8  38 81 00 30 */	addi r4, r1, 0x30                       
/* 802702EC  4B FF 6A 45 */	bl normZP__4cXyzCFv                      /* constant-address: 80266D30, symbol: normZP__4cXyzCFv */
...
/* 80270314  48 0D 6D C5 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
lbl_80270318:
/* 80270318  7F C3 F3 78 */	mr r3, r30                              
/* 8027031C  38 81 00 30 */	addi r4, r1, 0x30                       
/* 80270320  7F C5 F3 78 */	mr r5, r30                              
/* 80270324  48 0D 6D 91 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
lbl_80270328:

...
/* 8026FE48  40 82 00 14 */	bne lbl_8026FE5C                         /* constant-address: 8026FE5C, symbol: lbl_8026FE5C */
/* 8026FE4C  C0 3E 00 08 */	lfs f1, 8(r30)                          
/* 8026FE50  C0 1F 00 08 */	lfs f0, 8(r31)                          
/* 8026FE54  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8026FE58  41 82 01 D4 */	beq lbl_8027002C                         /* constant-address: 8027002C, symbol: lbl_8027002C */
lbl_8026FE5C:
/* 8026FE5C  38 61 00 34 */	addi r3, r1, 0x34                       
/* 8026FE60  7F C4 F3 78 */	mr r4, r30                              
/* 8026FE64  7F E5 FB 78 */	mr r5, r31                              
/* 8026FE68  4B FF 6C CD */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 8026FE88  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
/* 8026FE8C  D0 01 00 20 */	stfs f0, 0x20(r1)                       
/* 8026FE90  D0 21 00 24 */	stfs f1, 0x24(r1)                       
/* 8026FE94  38 61 00 1C */	addi r3, r1, 0x1c                       
/* 8026FE98  48 0D 72 A1 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 8026FE9C  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
/* 8026FEA0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026FEA4  40 81 00 58 */	ble lbl_8026FEFC                         /* constant-address: 8026FEFC, symbol: lbl_8026FEFC */
/* 8026FEA8  FC 00 08 34 */	frsqrte f0, f1                          
/* 8026FEAC  C8 82 B7 E8 */	lfd f4, lit_2379(r2)                     /* constant-address: 804551E8, symbol: lit_2379 */
/* 8026FEB0  FC 44 00 32 */	fmul f2, f4, f0                         
/* 8026FEB4  C8 62 B7 F0 */	lfd f3, lit_2380(r2)                     /* constant-address: 804551F0, symbol: lit_2380 */
...
/* 8026FEF8  48 00 00 88 */	b lbl_8026FF80                           /* constant-address: 8026FF80, symbol: lbl_8026FF80 */
lbl_8026FEFC:
/* 8026FEFC  C8 02 B7 F8 */	lfd f0, lit_2381(r2)                     /* constant-address: 804551F8, symbol: lit_2381 */
/* 8026FF00  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026FF04  40 80 00 10 */	bge lbl_8026FF14                         /* constant-address: 8026FF14, symbol: lbl_8026FF14 */
/* 8026FF08  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8026FF0C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8026FF10  48 00 00 70 */	b lbl_8026FF80                           /* constant-address: 8026FF80, symbol: lbl_8026FF80 */
lbl_8026FF14:
...
/* 8026FF28  41 82 00 14 */	beq lbl_8026FF3C                         /* constant-address: 8026FF3C, symbol: lbl_8026FF3C */
/* 8026FF2C  40 80 00 40 */	bge lbl_8026FF6C                         /* constant-address: 8026FF6C, symbol: lbl_8026FF6C */
/* 8026FF30  2C 03 00 00 */	cmpwi r3, 0                             
/* 8026FF34  41 82 00 20 */	beq lbl_8026FF54                         /* constant-address: 8026FF54, symbol: lbl_8026FF54 */
/* 8026FF38  48 00 00 34 */	b lbl_8026FF6C                           /* constant-address: 8026FF6C, symbol: lbl_8026FF6C */
lbl_8026FF3C:
/* 8026FF3C  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8026FF40  41 82 00 0C */	beq lbl_8026FF4C                         /* constant-address: 8026FF4C, symbol: lbl_8026FF4C */
/* 8026FF44  38 00 00 01 */	li r0, 1                                
/* 8026FF48  48 00 00 28 */	b lbl_8026FF70                           /* constant-address: 8026FF70, symbol: lbl_8026FF70 */
lbl_8026FF4C:
/* 8026FF4C  38 00 00 02 */	li r0, 2                                
/* 8026FF50  48 00 00 20 */	b lbl_8026FF70                           /* constant-address: 8026FF70, symbol: lbl_8026FF70 */
lbl_8026FF54:
/* 8026FF54  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8026FF58  41 82 00 0C */	beq lbl_8026FF64                         /* constant-address: 8026FF64, symbol: lbl_8026FF64 */
/* 8026FF5C  38 00 00 05 */	li r0, 5                                
/* 8026FF60  48 00 00 10 */	b lbl_8026FF70                           /* constant-address: 8026FF70, symbol: lbl_8026FF70 */
lbl_8026FF64:
/* 8026FF64  38 00 00 03 */	li r0, 3                                
/* 8026FF68  48 00 00 08 */	b lbl_8026FF70                           /* constant-address: 8026FF70, symbol: lbl_8026FF70 */
lbl_8026FF6C:
/* 8026FF6C  38 00 00 04 */	li r0, 4                                
lbl_8026FF70:
/* 8026FF70  2C 00 00 01 */	cmpwi r0, 1                             
/* 8026FF74  40 82 00 0C */	bne lbl_8026FF80                         /* constant-address: 8026FF80, symbol: lbl_8026FF80 */
/* 8026FF78  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8026FF7C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_8026FF80:
/* 8026FF80  FC 01 F8 40 */	fcmpo cr0, f1, f31                      
/* 8026FF84  40 80 00 18 */	bge lbl_8026FF9C                         /* constant-address: 8026FF9C, symbol: lbl_8026FF9C */
...
/* 8026FF98  48 00 00 94 */	b lbl_8027002C                           /* constant-address: 8027002C, symbol: lbl_8027002C */
lbl_8026FF9C:
...
/* 8026FFAC  48 0D 71 2D */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8026FFB0  FC 00 E2 10 */	fabs f0, f28                            
/* 8026FFB4  FC 20 00 18 */	frsp f1, f0                             
/* 8026FFB8  C0 02 B8 00 */	lfs f0, lit_2382(r2)                     /* constant-address: 80455200, symbol: lit_2382 */
/* 8026FFBC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026FFC0  41 80 00 5C */	blt lbl_8027001C                         /* constant-address: 8027001C, symbol: lbl_8027001C */
/* 8026FFC4  FC 1C F0 40 */	fcmpo cr0, f28, f30                     
/* 8026FFC8  40 81 00 18 */	ble lbl_8026FFE0                         /* constant-address: 8026FFE0, symbol: lbl_8026FFE0 */
/* 8026FFCC  38 61 00 40 */	addi r3, r1, 0x40                       
/* 8026FFD0  7C 64 1B 78 */	mr r4, r3                               
/* 8026FFD4  EC 3E E0 24 */	fdivs f1, f30, f28                      
/* 8026FFD8  48 0D 71 01 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8026FFDC  48 00 00 1C */	b lbl_8026FFF8                           /* constant-address: 8026FFF8, symbol: lbl_8026FFF8 */
lbl_8026FFE0:
/* 8026FFE0  FC 1C F8 40 */	fcmpo cr0, f28, f31                     
/* 8026FFE4  40 80 00 14 */	bge lbl_8026FFF8                         /* constant-address: 8026FFF8, symbol: lbl_8026FFF8 */
/* 8026FFE8  38 61 00 40 */	addi r3, r1, 0x40                       
/* 8026FFEC  7C 64 1B 78 */	mr r4, r3                               
/* 8026FFF0  EC 3F E0 24 */	fdivs f1, f31, f28                      
/* 8026FFF4  48 0D 70 E5 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
lbl_8026FFF8:
...
/* 80270018  48 00 00 14 */	b lbl_8027002C                           /* constant-address: 8027002C, symbol: lbl_8027002C */
lbl_8027001C:
...
/* 80270038  4B FF 6A FD */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
/* 8027003C  C0 01 00 28 */	lfs f0, 0x28(r1)                        
/* 80270040  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 80270044  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
...
/* 80270058  48 0D 70 E1 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 8027005C  C0 02 B7 E0 */	lfs f0, lit_2262(r2)                     /* constant-address: 804551E0, symbol: lit_2262 */
/* 80270060  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80270064  40 81 00 58 */	ble lbl_802700BC                         /* constant-address: 802700BC, symbol: lbl_802700BC */
/* 80270068  FC 00 08 34 */	frsqrte f0, f1                          
/* 8027006C  C8 82 B7 E8 */	lfd f4, lit_2379(r2)                     /* constant-address: 804551E8, symbol: lit_2379 */
/* 80270070  FC 44 00 32 */	fmul f2, f4, f0                         
/* 80270074  C8 62 B7 F0 */	lfd f3, lit_2380(r2)                     /* constant-address: 804551F0, symbol: lit_2380 */
...
/* 802700B8  48 00 00 88 */	b lbl_80270140                           /* constant-address: 80270140, symbol: lbl_80270140 */
lbl_802700BC:
/* 802700BC  C8 02 B7 F8 */	lfd f0, lit_2381(r2)                     /* constant-address: 804551F8, symbol: lit_2381 */
/* 802700C0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802700C4  40 80 00 10 */	bge lbl_802700D4                         /* constant-address: 802700D4, symbol: lbl_802700D4 */
/* 802700C8  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 802700CC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 802700D0  48 00 00 70 */	b lbl_80270140                           /* constant-address: 80270140, symbol: lbl_80270140 */
lbl_802700D4:
...
/* 802700E8  41 82 00 14 */	beq lbl_802700FC                         /* constant-address: 802700FC, symbol: lbl_802700FC */
/* 802700EC  40 80 00 40 */	bge lbl_8027012C                         /* constant-address: 8027012C, symbol: lbl_8027012C */
/* 802700F0  2C 03 00 00 */	cmpwi r3, 0                             
/* 802700F4  41 82 00 20 */	beq lbl_80270114                         /* constant-address: 80270114, symbol: lbl_80270114 */
/* 802700F8  48 00 00 34 */	b lbl_8027012C                           /* constant-address: 8027012C, symbol: lbl_8027012C */
lbl_802700FC:
/* 802700FC  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 80270100  41 82 00 0C */	beq lbl_8027010C                         /* constant-address: 8027010C, symbol: lbl_8027010C */
/* 80270104  38 00 00 01 */	li r0, 1                                
/* 80270108  48 00 00 28 */	b lbl_80270130                           /* constant-address: 80270130, symbol: lbl_80270130 */
lbl_8027010C:
/* 8027010C  38 00 00 02 */	li r0, 2                                
/* 80270110  48 00 00 20 */	b lbl_80270130                           /* constant-address: 80270130, symbol: lbl_80270130 */
lbl_80270114:
/* 80270114  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 80270118  41 82 00 0C */	beq lbl_80270124                         /* constant-address: 80270124, symbol: lbl_80270124 */
/* 8027011C  38 00 00 05 */	li r0, 5                                
/* 80270120  48 00 00 10 */	b lbl_80270130                           /* constant-address: 80270130, symbol: lbl_80270130 */
lbl_80270124:
/* 80270124  38 00 00 03 */	li r0, 3                                
/* 80270128  48 00 00 08 */	b lbl_80270130                           /* constant-address: 80270130, symbol: lbl_80270130 */
lbl_8027012C:
/* 8027012C  38 00 00 04 */	li r0, 4                                
lbl_80270130:
/* 80270130  2C 00 00 01 */	cmpwi r0, 1                             
/* 80270134  40 82 00 0C */	bne lbl_80270140                         /* constant-address: 80270140, symbol: lbl_80270140 */
/* 80270138  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8027013C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_80270140:

...
/* 8026A184  C0 02 B7 AC */	lfs f0, lit_3205(r2)                     /* constant-address: 804551AC, symbol: lit_3205 */
...
/* 8026A1AC  4B FF FB B9 */	bl cM3d_InclusionCheckPosIn3PosBox2d__Ffffffffff /* constant-address: 80269D64, symbol: cM3d_InclusionCheckPosIn3PosBox2d__Ffffffffff */
/* 8026A1B0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8026A1B4  40 82 00 0C */	bne lbl_8026A1C0                         /* constant-address: 8026A1C0, symbol: lbl_8026A1C0 */
/* 8026A1B8  38 60 00 00 */	li r3, 0                                
/* 8026A1BC  48 00 01 08 */	b lbl_8026A2C4                           /* constant-address: 8026A2C4, symbol: lbl_8026A2C4 */
lbl_8026A1C0:
...
/* 8026A1D8  4B FF E6 BD */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026A1DC  FF E0 08 90 */	fmr f31, f1                             
/* 8026A1E0  C0 02 B7 B0 */	lfs f0, lit_3229(r2)                     /* constant-address: 804551B0, symbol: lit_3229 */
/* 8026A1E4  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8026A1E8  4C 40 13 82 */	cror 2, 0, 2                            
/* 8026A1EC  40 82 00 64 */	bne lbl_8026A250                         /* constant-address: 8026A250, symbol: lbl_8026A250 */
...
/* 8026A208  4B FF E6 8D */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026A20C  C0 02 B7 B0 */	lfs f0, lit_3229(r2)                     /* constant-address: 804551B0, symbol: lit_3229 */
/* 8026A210  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026A214  4C 40 13 82 */	cror 2, 0, 2                            
/* 8026A218  40 82 00 38 */	bne lbl_8026A250                         /* constant-address: 8026A250, symbol: lbl_8026A250 */
...
/* 8026A234  4B FF E6 61 */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026A238  C0 02 B7 B0 */	lfs f0, lit_3229(r2)                     /* constant-address: 804551B0, symbol: lit_3229 */
/* 8026A23C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026A240  4C 40 13 82 */	cror 2, 0, 2                            
/* 8026A244  40 82 00 0C */	bne lbl_8026A250                         /* constant-address: 8026A250, symbol: lbl_8026A250 */
/* 8026A248  38 60 00 01 */	li r3, 1                                
/* 8026A24C  48 00 00 78 */	b lbl_8026A2C4                           /* constant-address: 8026A2C4, symbol: lbl_8026A2C4 */
lbl_8026A250:
/* 8026A250  C0 02 B7 B4 */	lfs f0, lit_3230(r2)                     /* constant-address: 804551B4, symbol: lit_3230 */
/* 8026A254  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8026A258  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026A25C  40 82 00 64 */	bne lbl_8026A2C0                         /* constant-address: 8026A2C0, symbol: lbl_8026A2C0 */
...
/* 8026A278  4B FF E6 1D */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026A27C  C0 02 B7 B4 */	lfs f0, lit_3230(r2)                     /* constant-address: 804551B4, symbol: lit_3230 */
/* 8026A280  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026A284  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026A288  40 82 00 38 */	bne lbl_8026A2C0                         /* constant-address: 8026A2C0, symbol: lbl_8026A2C0 */
...
/* 8026A2A4  4B FF E5 F1 */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026A2A8  C0 02 B7 B4 */	lfs f0, lit_3230(r2)                     /* constant-address: 804551B4, symbol: lit_3230 */
/* 8026A2AC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026A2B0  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026A2B4  40 82 00 0C */	bne lbl_8026A2C0                         /* constant-address: 8026A2C0, symbol: lbl_8026A2C0 */
/* 8026A2B8  38 60 00 01 */	li r3, 1                                
/* 8026A2BC  48 00 00 08 */	b lbl_8026A2C4                           /* constant-address: 8026A2C4, symbol: lbl_8026A2C4 */
lbl_8026A2C0:

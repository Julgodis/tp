...
/* 8026C5F0  48 0F 5B ED */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8026C614  40 81 00 1C */	ble lbl_8026C630                         /* constant-address: 8026C630, symbol: lbl_8026C630 */
/* 8026C618  C0 1E 00 24 */	lfs f0, 0x24(r30)                       
/* 8026C61C  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026C620  40 81 00 10 */	ble lbl_8026C630                         /* constant-address: 8026C630, symbol: lbl_8026C630 */
/* 8026C624  C0 1E 00 30 */	lfs f0, 0x30(r30)                       
/* 8026C628  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026C62C  41 81 00 24 */	bgt lbl_8026C650                         /* constant-address: 8026C650, symbol: lbl_8026C650 */
lbl_8026C630:
/* 8026C630  FC 1F 10 40 */	fcmpo cr0, f31, f2                      
/* 8026C634  40 80 00 24 */	bge lbl_8026C658                         /* constant-address: 8026C658, symbol: lbl_8026C658 */
/* 8026C638  C0 1E 00 24 */	lfs f0, 0x24(r30)                       
/* 8026C63C  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8026C640  40 80 00 18 */	bge lbl_8026C658                         /* constant-address: 8026C658, symbol: lbl_8026C658 */
/* 8026C644  C0 1E 00 30 */	lfs f0, 0x30(r30)                       
/* 8026C648  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8026C64C  40 80 00 0C */	bge lbl_8026C658                         /* constant-address: 8026C658, symbol: lbl_8026C658 */
lbl_8026C650:
/* 8026C650  38 60 00 00 */	li r3, 0                                
/* 8026C654  48 00 02 C8 */	b lbl_8026C91C                           /* constant-address: 8026C91C, symbol: lbl_8026C91C */
lbl_8026C658:
/* 8026C658  C3 C2 B7 C8 */	lfs f30, lit_4255(r2)                    /* constant-address: 804551C8, symbol: lit_4255 */
...
/* 8026C670  48 00 09 D5 */	bl cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec /* constant-address: 8026D044, symbol: cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec */
/* 8026C674  2C 03 00 00 */	cmpwi r3, 0                             
/* 8026C678  41 82 00 2C */	beq lbl_8026C6A4                         /* constant-address: 8026C6A4, symbol: lbl_8026C6A4 */
/* 8026C67C  38 61 00 54 */	addi r3, r1, 0x54                       
/* 8026C680  38 9E 00 14 */	addi r4, r30, 0x14                      
/* 8026C684  48 0D AD 19 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
...
/* 8026C6B8  48 00 09 8D */	bl cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec /* constant-address: 8026D044, symbol: cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec */
/* 8026C6BC  2C 03 00 00 */	cmpwi r3, 0                             
/* 8026C6C0  41 82 00 34 */	beq lbl_8026C6F4                         /* constant-address: 8026C6F4, symbol: lbl_8026C6F4 */
/* 8026C6C4  38 61 00 54 */	addi r3, r1, 0x54                       
/* 8026C6C8  38 9E 00 2C */	addi r4, r30, 0x2c                      
/* 8026C6CC  48 0D AC D1 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 8026C6D0  FC 1E 08 40 */	fcmpo cr0, f30, f1                      
/* 8026C6D4  40 81 00 20 */	ble lbl_8026C6F4                         /* constant-address: 8026C6F4, symbol: lbl_8026C6F4 */
...
/* 8026C708  48 00 09 3D */	bl cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec /* constant-address: 8026D044, symbol: cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec */
/* 8026C70C  2C 03 00 00 */	cmpwi r3, 0                             
/* 8026C710  41 82 00 34 */	beq lbl_8026C744                         /* constant-address: 8026C744, symbol: lbl_8026C744 */
/* 8026C714  38 61 00 54 */	addi r3, r1, 0x54                       
/* 8026C718  38 9E 00 14 */	addi r4, r30, 0x14                      
/* 8026C71C  48 0D AC 81 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 8026C720  FC 1E 08 40 */	fcmpo cr0, f30, f1                      
/* 8026C724  40 81 00 20 */	ble lbl_8026C744                         /* constant-address: 8026C744, symbol: lbl_8026C744 */
...
lbl_8026C744:
/* 8026C744  C0 02 B7 C8 */	lfs f0, lit_4255(r2)                     /* constant-address: 804551C8, symbol: lit_4255 */
/* 8026C748  FC 00 F0 00 */	fcmpu cr0, f0, f30                      
/* 8026C74C  41 82 00 0C */	beq lbl_8026C758                         /* constant-address: 8026C758, symbol: lbl_8026C758 */
/* 8026C750  38 60 00 01 */	li r3, 1                                
/* 8026C754  48 00 01 C8 */	b lbl_8026C91C                           /* constant-address: 8026C91C, symbol: lbl_8026C91C */
lbl_8026C758:
...
/* 8026C774  4B FF E3 75 */	bl cM3d_CrossY_Tri__FPC8cM3dGTriPC3VecPC10cM3d_RangePf /* constant-address: 8026AAE8, symbol: cM3d_CrossY_Tri__FPC8cM3dGTriPC3VecPC10cM3d_RangePf */
/* 8026C778  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8026C77C  41 82 01 9C */	beq lbl_8026C918                         /* constant-address: 8026C918, symbol: lbl_8026C918 */
...
/* 8026C7AC  48 0D A8 E5 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
/* 8026C7B0  38 61 00 18 */	addi r3, r1, 0x18                       
/* 8026C7B4  38 81 00 30 */	addi r4, r1, 0x30                       
/* 8026C7B8  C0 22 B7 C4 */	lfs f1, lit_3892(r2)                     /* constant-address: 804551C4, symbol: lit_3892 */
/* 8026C7BC  48 0D A9 1D */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8026C7C0  38 61 00 30 */	addi r3, r1, 0x30                       
/* 8026C7C4  38 81 00 3C */	addi r4, r1, 0x3c                       
/* 8026C7C8  38 A1 00 24 */	addi r5, r1, 0x24                       
/* 8026C7CC  48 0D A8 E9 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
...
/* 8026C7E4  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026C7E8  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8026C7EC  40 81 00 58 */	ble lbl_8026C844                         /* constant-address: 8026C844, symbol: lbl_8026C844 */
/* 8026C7F0  FC 00 20 34 */	frsqrte f0, f4                          
/* 8026C7F4  C8 62 B7 20 */	lfd f3, lit_2257(r2)                     /* constant-address: 80455120, symbol: lit_2257 */
/* 8026C7F8  FC 23 00 32 */	fmul f1, f3, f0                         
/* 8026C7FC  C8 42 B7 28 */	lfd f2, lit_2258(r2)                     /* constant-address: 80455128, symbol: lit_2258 */
...
/* 8026C840  48 00 00 88 */	b lbl_8026C8C8                           /* constant-address: 8026C8C8, symbol: lbl_8026C8C8 */
lbl_8026C844:
/* 8026C844  C8 02 B7 30 */	lfd f0, lit_2259(r2)                     /* constant-address: 80455130, symbol: lit_2259 */
/* 8026C848  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8026C84C  40 80 00 10 */	bge lbl_8026C85C                         /* constant-address: 8026C85C, symbol: lbl_8026C85C */
/* 8026C850  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8026C854  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8026C858  48 00 00 70 */	b lbl_8026C8C8                           /* constant-address: 8026C8C8, symbol: lbl_8026C8C8 */
lbl_8026C85C:
...
/* 8026C870  41 82 00 14 */	beq lbl_8026C884                         /* constant-address: 8026C884, symbol: lbl_8026C884 */
/* 8026C874  40 80 00 40 */	bge lbl_8026C8B4                         /* constant-address: 8026C8B4, symbol: lbl_8026C8B4 */
/* 8026C878  2C 03 00 00 */	cmpwi r3, 0                             
/* 8026C87C  41 82 00 20 */	beq lbl_8026C89C                         /* constant-address: 8026C89C, symbol: lbl_8026C89C */
/* 8026C880  48 00 00 34 */	b lbl_8026C8B4                           /* constant-address: 8026C8B4, symbol: lbl_8026C8B4 */
lbl_8026C884:
/* 8026C884  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8026C888  41 82 00 0C */	beq lbl_8026C894                         /* constant-address: 8026C894, symbol: lbl_8026C894 */
/* 8026C88C  38 00 00 01 */	li r0, 1                                
/* 8026C890  48 00 00 28 */	b lbl_8026C8B8                           /* constant-address: 8026C8B8, symbol: lbl_8026C8B8 */
lbl_8026C894:
/* 8026C894  38 00 00 02 */	li r0, 2                                
/* 8026C898  48 00 00 20 */	b lbl_8026C8B8                           /* constant-address: 8026C8B8, symbol: lbl_8026C8B8 */
lbl_8026C89C:
/* 8026C89C  54 80 02 7F */	clrlwi. r0, r4, 9                       
/* 8026C8A0  41 82 00 0C */	beq lbl_8026C8AC                         /* constant-address: 8026C8AC, symbol: lbl_8026C8AC */
/* 8026C8A4  38 00 00 05 */	li r0, 5                                
/* 8026C8A8  48 00 00 10 */	b lbl_8026C8B8                           /* constant-address: 8026C8B8, symbol: lbl_8026C8B8 */
lbl_8026C8AC:
/* 8026C8AC  38 00 00 03 */	li r0, 3                                
/* 8026C8B0  48 00 00 08 */	b lbl_8026C8B8                           /* constant-address: 8026C8B8, symbol: lbl_8026C8B8 */
lbl_8026C8B4:
/* 8026C8B4  38 00 00 04 */	li r0, 4                                
lbl_8026C8B8:
/* 8026C8B8  2C 00 00 01 */	cmpwi r0, 1                             
/* 8026C8BC  40 82 00 0C */	bne lbl_8026C8C8                         /* constant-address: 8026C8C8, symbol: lbl_8026C8C8 */
/* 8026C8C0  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8026C8C4  C0 83 0A E0 */	lfs f4, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
lbl_8026C8C8:
/* 8026C8C8  FC 00 22 10 */	fabs f0, f4                             
/* 8026C8CC  FC 20 00 18 */	frsp f1, f0                             
/* 8026C8D0  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026C8D4  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026C8D8  40 80 00 20 */	bge lbl_8026C8F8                         /* constant-address: 8026C8F8, symbol: lbl_8026C8F8 */
...
/* 8026C8F4  48 00 00 1C */	b lbl_8026C910                           /* constant-address: 8026C910, symbol: lbl_8026C910 */
lbl_8026C8F8:
...
/* 8026C90C  4B FF BC 55 */	bl cM3d_InDivPos1__FPC3VecPC3VecfP3Vec   /* constant-address: 80268560, symbol: cM3d_InDivPos1__FPC3VecPC3VecfP3Vec */
lbl_8026C910:
/* 8026C910  38 60 00 01 */	li r3, 1                                
/* 8026C914  48 00 00 08 */	b lbl_8026C91C                           /* constant-address: 8026C91C, symbol: lbl_8026C91C */
lbl_8026C918:
...
/* 8026C930  48 0F 58 F9 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

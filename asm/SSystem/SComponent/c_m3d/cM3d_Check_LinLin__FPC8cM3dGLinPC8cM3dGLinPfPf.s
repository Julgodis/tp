...
/* 80268CAC  48 0F 95 2D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 80268CCC  48 0D E3 E9 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 80268CD0  38 7D 00 0C */	addi r3, r29, 0xc                       
/* 80268CD4  7F A4 EB 78 */	mr r4, r29                              
/* 80268CD8  38 A1 00 14 */	addi r5, r1, 0x14                       
/* 80268CDC  48 0D E3 D9 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 80268CE0  38 61 00 20 */	addi r3, r1, 0x20                       
/* 80268CE4  48 0D E4 6D */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
/* 80268CE8  FF E0 08 90 */	fmr f31, f1                             
/* 80268CEC  38 61 00 14 */	addi r3, r1, 0x14                       
/* 80268CF0  48 0D E4 61 */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
/* 80268CF4  FF C0 08 90 */	fmr f30, f1                             
/* 80268CF8  FC 00 FA 10 */	fabs f0, f31                            
/* 80268CFC  FC 00 00 18 */	frsp f0, f0                             
/* 80268D00  C0 2D 8C 00 */	lfs f1, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 80268D04  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 80268D08  41 80 00 14 */	blt lbl_80268D1C                         /* constant-address: 80268D1C, symbol: lbl_80268D1C */
/* 80268D0C  FC 00 F2 10 */	fabs f0, f30                            
/* 80268D10  FC 00 00 18 */	frsp f0, f0                             
/* 80268D14  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 80268D18  40 80 00 0C */	bge lbl_80268D24                         /* constant-address: 80268D24, symbol: lbl_80268D24 */
lbl_80268D1C:
/* 80268D1C  38 60 00 01 */	li r3, 1                                
/* 80268D20  48 00 01 5C */	b lbl_80268E7C                           /* constant-address: 80268E7C, symbol: lbl_80268E7C */
lbl_80268D24:
/* 80268D24  C0 02 B7 38 */	lfs f0, lit_2273(r2)                     /* constant-address: 80455138, symbol: lit_2273 */
...
/* 80268D3C  48 0D E3 9D */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 80268D40  38 61 00 14 */	addi r3, r1, 0x14                       
/* 80268D44  7C 64 1B 78 */	mr r4, r3                               
/* 80268D48  FC 20 E0 90 */	fmr f1, f28                             
/* 80268D4C  48 0D E3 8D */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 80268D50  7F 83 E3 78 */	mr r3, r28                              
/* 80268D54  7F A4 EB 78 */	mr r4, r29                              
/* 80268D58  38 A1 00 08 */	addi r5, r1, 8                          
/* 80268D5C  48 0D E3 59 */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 80268D60  38 61 00 20 */	addi r3, r1, 0x20                       
/* 80268D64  38 81 00 14 */	addi r4, r1, 0x14                       
/* 80268D68  48 0D E4 2D */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 80268D6C  FF 60 08 50 */	fneg f27, f1                            
/* 80268D70  38 61 00 08 */	addi r3, r1, 8                          
/* 80268D74  38 81 00 20 */	addi r4, r1, 0x20                       
/* 80268D78  48 0D E4 1D */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 80268D7C  FF 40 08 90 */	fmr f26, f1                             
/* 80268D80  38 61 00 08 */	addi r3, r1, 8                          
/* 80268D84  48 0D E3 B5 */	bl PSVECSquareMag                        /* constant-address: 80347138, symbol: PSVECSquareMag */
/* 80268D88  C0 22 B7 38 */	lfs f1, lit_2273(r2)                     /* constant-address: 80455138, symbol: lit_2273 */
...
/* 80268DA4  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 80268DA8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80268DAC  41 80 00 4C */	blt lbl_80268DF8                         /* constant-address: 80268DF8, symbol: lbl_80268DF8 */
/* 80268DB0  38 61 00 08 */	addi r3, r1, 8                          
/* 80268DB4  38 81 00 14 */	addi r4, r1, 0x14                       
/* 80268DB8  48 0D E3 DD */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 80268DBC  FC 20 08 50 */	fneg f1, f1                             
/* 80268DC0  C0 02 B7 38 */	lfs f0, lit_2273(r2)                     /* constant-address: 80455138, symbol: lit_2273 */
...
/* 80268DF4  48 00 00 88 */	b lbl_80268E7C                           /* constant-address: 80268E7C, symbol: lbl_80268E7C */
lbl_80268DF8:
/* 80268DF8  FF 20 D0 50 */	fneg f25, f26                           
/* 80268DFC  C3 02 B7 18 */	lfs f24, lit_2256(r2)                    /* constant-address: 80455118, symbol: lit_2256 */
/* 80268E00  FC 19 C0 40 */	fcmpo cr0, f25, f24                     
/* 80268E04  41 80 00 0C */	blt lbl_80268E10                         /* constant-address: 80268E10, symbol: lbl_80268E10 */
/* 80268E08  FC 19 F8 40 */	fcmpo cr0, f25, f31                     
/* 80268E0C  40 81 00 10 */	ble lbl_80268E1C                         /* constant-address: 80268E1C, symbol: lbl_80268E1C */
lbl_80268E10:
...
/* 80268E24  48 0D E3 71 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 80268E28  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 80268E2C  FC 19 00 40 */	fcmpo cr0, f25, f0                      
/* 80268E30  41 80 00 0C */	blt lbl_80268E3C                         /* constant-address: 80268E3C, symbol: lbl_80268E3C */
/* 80268E34  FC 19 F8 40 */	fcmpo cr0, f25, f31                     
/* 80268E38  40 81 00 0C */	ble lbl_80268E44                         /* constant-address: 80268E44, symbol: lbl_80268E44 */
lbl_80268E3C:
/* 80268E3C  C3 22 B7 18 */	lfs f25, lit_2256(r2)                    /* constant-address: 80455118, symbol: lit_2256 */
/* 80268E40  FF 00 08 90 */	fmr f24, f1                             
lbl_80268E44:
/* 80268E44  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 80268E48  FC 18 00 40 */	fcmpo cr0, f24, f0                      
/* 80268E4C  41 80 00 0C */	blt lbl_80268E58                         /* constant-address: 80268E58, symbol: lbl_80268E58 */
/* 80268E50  FC 18 F0 40 */	fcmpo cr0, f24, f30                     
/* 80268E54  40 81 00 14 */	ble lbl_80268E68                         /* constant-address: 80268E68, symbol: lbl_80268E68 */
lbl_80268E58:
...
/* 80268EC0  48 0F 93 65 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

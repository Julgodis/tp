...
/* 8026E700  48 0F 3A DD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8026E714  48 0D 8A A1 */	bl PSVECCrossProduct                     /* constant-address: 803471B4, symbol: PSVECCrossProduct */
/* 8026E718  C0 01 00 08 */	lfs f0, 8(r1)                           
/* 8026E71C  FC 00 02 10 */	fabs f0, f0                             
/* 8026E720  FC 00 00 18 */	frsp f0, f0                             
/* 8026E724  C0 2D 8C 00 */	lfs f1, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026E728  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8026E72C  40 80 00 34 */	bge lbl_8026E760                         /* constant-address: 8026E760, symbol: lbl_8026E760 */
...
/* 8026E740  40 80 00 20 */	bge lbl_8026E760                         /* constant-address: 8026E760, symbol: lbl_8026E760 */
...
/* 8026E754  40 80 00 0C */	bge lbl_8026E760                         /* constant-address: 8026E760, symbol: lbl_8026E760 */
/* 8026E758  38 60 00 00 */	li r3, 0                                
/* 8026E75C  48 00 01 2C */	b lbl_8026E888                           /* constant-address: 8026E888, symbol: lbl_8026E888 */
lbl_8026E760:
...
/* 8026E78C  40 82 00 40 */	bne lbl_8026E7CC                         /* constant-address: 8026E7CC, symbol: lbl_8026E7CC */
/* 8026E790  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026E794  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026E798  40 82 00 34 */	bne lbl_8026E7CC                         /* constant-address: 8026E7CC, symbol: lbl_8026E7CC */
...
/* 8026E7BC  4B FF FF 09 */	bl cM3d_PlaneCrossLineProcWork__FfffffffPfPf /* constant-address: 8026E6C4, symbol: cM3d_PlaneCrossLineProcWork__FfffffffPfPf */
/* 8026E7C0  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026E7C4  D0 1F 00 00 */	stfs f0, 0(r31)                         
/* 8026E7C8  48 00 00 80 */	b lbl_8026E848                           /* constant-address: 8026E848, symbol: lbl_8026E848 */
lbl_8026E7CC:
/* 8026E7CC  FC 02 08 40 */	fcmpo cr0, f2, f1                       
/* 8026E7D0  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026E7D4  40 82 00 44 */	bne lbl_8026E818                         /* constant-address: 8026E818, symbol: lbl_8026E818 */
/* 8026E7D8  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8026E7DC  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026E7E0  40 82 00 38 */	bne lbl_8026E818                         /* constant-address: 8026E818, symbol: lbl_8026E818 */
...
/* 8026E808  4B FF FE BD */	bl cM3d_PlaneCrossLineProcWork__FfffffffPfPf /* constant-address: 8026E6C4, symbol: cM3d_PlaneCrossLineProcWork__FfffffffPfPf */
/* 8026E80C  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026E810  D0 1F 00 04 */	stfs f0, 4(r31)                         
/* 8026E814  48 00 00 34 */	b lbl_8026E848                           /* constant-address: 8026E848, symbol: lbl_8026E848 */
lbl_8026E818:
...
/* 8026E83C  4B FF FE 89 */	bl cM3d_PlaneCrossLineProcWork__FfffffffPfPf /* constant-address: 8026E6C4, symbol: cM3d_PlaneCrossLineProcWork__FfffffffPfPf */
/* 8026E840  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026E844  D0 1F 00 08 */	stfs f0, 8(r31)                         
lbl_8026E848:
/* 8026E848  7F E3 FB 78 */	mr r3, r31                              
/* 8026E84C  48 0D 89 05 */	bl PSVECMag                              /* constant-address: 80347150, symbol: PSVECMag */
/* 8026E850  FC 00 0A 10 */	fabs f0, f1                             
/* 8026E854  FC 40 00 18 */	frsp f2, f0                             
/* 8026E858  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026E85C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8026E860  40 80 00 08 */	bge lbl_8026E868                         /* constant-address: 8026E868, symbol: lbl_8026E868 */
/* 8026E864  C0 22 B7 38 */	lfs f1, lit_2273(r2)                     /* constant-address: 80455138, symbol: lit_2273 */
lbl_8026E868:
/* 8026E868  38 61 00 08 */	addi r3, r1, 8                          
/* 8026E86C  7C 64 1B 78 */	mr r4, r3                               
/* 8026E870  48 0D 88 69 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8026E874  7F E3 FB 78 */	mr r3, r31                              
/* 8026E878  38 81 00 08 */	addi r4, r1, 8                          
/* 8026E87C  38 BF 00 0C */	addi r5, r31, 0xc                       
/* 8026E880  48 0D 88 11 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
/* 8026E884  38 60 00 01 */	li r3, 1                                
lbl_8026E888:
/* 8026E888  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8026E88C  48 0F 39 9D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

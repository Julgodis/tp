...
/* 8026AB00  48 0F 76 D9 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8026AB20  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026AB24  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026AB28  40 80 00 0C */	bge lbl_8026AB34                         /* constant-address: 8026AB34, symbol: lbl_8026AB34 */
/* 8026AB2C  38 60 00 00 */	li r3, 0                                
/* 8026AB30  48 00 00 88 */	b lbl_8026ABB8                           /* constant-address: 8026ABB8, symbol: lbl_8026ABB8 */
lbl_8026AB34:
...
/* 8026AB50  48 0D C6 45 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
...
/* 8026AB6C  48 0D C6 29 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
/* 8026AB70  C0 1C 00 0C */	lfs f0, 0xc(r28)                        
/* 8026AB74  EC 20 08 2A */	fadds f1, f0, f1                        
/* 8026AB78  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026AB7C  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8026AB80  40 81 00 0C */	ble lbl_8026AB8C                         /* constant-address: 8026AB8C, symbol: lbl_8026AB8C */
/* 8026AB84  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026AB88  41 81 00 18 */	bgt lbl_8026ABA0                         /* constant-address: 8026ABA0, symbol: lbl_8026ABA0 */
lbl_8026AB8C:
/* 8026AB8C  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026AB90  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8026AB94  40 80 00 14 */	bge lbl_8026ABA8                         /* constant-address: 8026ABA8, symbol: lbl_8026ABA8 */
/* 8026AB98  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026AB9C  40 80 00 0C */	bge lbl_8026ABA8                         /* constant-address: 8026ABA8, symbol: lbl_8026ABA8 */
lbl_8026ABA0:
/* 8026ABA0  38 60 00 00 */	li r3, 0                                
/* 8026ABA4  48 00 00 14 */	b lbl_8026ABB8                           /* constant-address: 8026ABB8, symbol: lbl_8026ABB8 */
lbl_8026ABA8:
/* 8026ABA8  7F 83 E3 78 */	mr r3, r28                              
/* 8026ABAC  7F A4 EB 78 */	mr r4, r29                              
/* 8026ABB0  7F E5 FB 78 */	mr r5, r31                              
/* 8026ABB4  4B FF FD 0D */	bl cM3d_CrossY_Tri__FPC8cM3dGTriPC3VecPf /* constant-address: 8026A8C0, symbol: cM3d_CrossY_Tri__FPC8cM3dGTriPC3VecPf */
lbl_8026ABB8:
/* 8026ABB8  E3 E1 00 38 */	psq_l f31, 56(r1), 0, 0 /* qr0 */       
/* 8026ABBC  CB E1 00 30 */	lfd f31, 0x30(r1)                       
/* 8026ABC0  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8026ABC4  48 0F 76 61 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

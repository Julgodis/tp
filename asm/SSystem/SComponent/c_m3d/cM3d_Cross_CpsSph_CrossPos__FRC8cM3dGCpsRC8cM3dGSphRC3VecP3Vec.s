...
/* 8026DAF8  48 0F 46 E1 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 8026DB1C  4B FF D9 CD */	bl cM3d_Cross_LinSph_CrossPos__FRC8cM3dGSphRC8cM3dGLinP3VecP3Vec /* constant-address: 8026B4E8, symbol: cM3d_Cross_LinSph_CrossPos__FRC8cM3dGSphRC8cM3dGLinP3VecP3Vec */
/* 8026DB20  2C 03 00 01 */	cmpwi r3, 1                             
/* 8026DB24  40 82 00 20 */	bne lbl_8026DB44                         /* constant-address: 8026DB44, symbol: lbl_8026DB44 */
...
/* 8026DB40  48 00 00 DC */	b lbl_8026DC1C                           /* constant-address: 8026DC1C, symbol: lbl_8026DC1C */
lbl_8026DB44:
/* 8026DB44  2C 03 00 02 */	cmpwi r3, 2                             
/* 8026DB48  40 82 00 60 */	bne lbl_8026DBA8                         /* constant-address: 8026DBA8, symbol: lbl_8026DBA8 */
/* 8026DB4C  38 61 00 20 */	addi r3, r1, 0x20                       
/* 8026DB50  7F 84 E3 78 */	mr r4, r28                              
/* 8026DB54  48 0D 98 49 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 8026DB58  FF E0 08 90 */	fmr f31, f1                             
/* 8026DB5C  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8026DB60  7F 84 E3 78 */	mr r4, r28                              
/* 8026DB64  48 0D 98 39 */	bl PSVECSquareDistance                   /* constant-address: 8034739C, symbol: PSVECSquareDistance */
/* 8026DB68  FC 1F 08 40 */	fcmpo cr0, f31, f1                      
/* 8026DB6C  40 80 00 20 */	bge lbl_8026DB8C                         /* constant-address: 8026DB8C, symbol: lbl_8026DB8C */
...
/* 8026DB88  48 00 00 94 */	b lbl_8026DC1C                           /* constant-address: 8026DC1C, symbol: lbl_8026DC1C */
lbl_8026DB8C:
...
/* 8026DBA4  48 00 00 78 */	b lbl_8026DC1C                           /* constant-address: 8026DC1C, symbol: lbl_8026DC1C */
lbl_8026DBA8:
...
/* 8026DBD4  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026DBD8  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026DBDC  40 80 00 10 */	bge lbl_8026DBEC                         /* constant-address: 8026DBEC, symbol: lbl_8026DBEC */
...
/* 8026DBF8  48 0D 94 BD */	bl PSVECSubtract                         /* constant-address: 803470B4, symbol: PSVECSubtract */
/* 8026DBFC  38 61 00 08 */	addi r3, r1, 8                          
/* 8026DC00  7C 64 1B 78 */	mr r4, r3                               
/* 8026DC04  C0 22 B7 C4 */	lfs f1, lit_3892(r2)                     /* constant-address: 804551C4, symbol: lit_3892 */
/* 8026DC08  48 0D 94 D1 */	bl PSVECScale                            /* constant-address: 803470D8, symbol: PSVECScale */
/* 8026DC0C  7F E3 FB 78 */	mr r3, r31                              
/* 8026DC10  38 81 00 08 */	addi r4, r1, 8                          
/* 8026DC14  7F E5 FB 78 */	mr r5, r31                              
/* 8026DC18  48 0D 94 79 */	bl PSVECAdd                              /* constant-address: 80347090, symbol: PSVECAdd */
lbl_8026DC1C:
/* 8026DC1C  E3 E1 00 48 */	psq_l f31, 72(r1), 0, 0 /* qr0 */       
/* 8026DC20  CB E1 00 40 */	lfd f31, 0x40(r1)                       
/* 8026DC24  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8026DC28  48 0F 45 FD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

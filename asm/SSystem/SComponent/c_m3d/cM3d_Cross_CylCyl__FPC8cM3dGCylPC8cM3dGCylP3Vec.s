...
/* 8026C3F0  40 81 00 0C */	ble lbl_8026C3FC                         /* constant-address: 8026C3FC, symbol: lbl_8026C3FC */
/* 8026C3F4  38 60 00 00 */	li r3, 0                                
/* 8026C3F8  48 00 01 D0 */	b lbl_8026C5C8                           /* constant-address: 8026C5C8, symbol: lbl_8026C5C8 */
lbl_8026C3FC:
...
/* 8026C410  41 80 00 14 */	blt lbl_8026C424                         /* constant-address: 8026C424, symbol: lbl_8026C424 */
/* 8026C414  C0 04 00 10 */	lfs f0, 0x10(r4)                        
/* 8026C418  EC 01 00 2A */	fadds f0, f1, f0                        
/* 8026C41C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8026C420  40 81 00 0C */	ble lbl_8026C42C                         /* constant-address: 8026C42C, symbol: lbl_8026C42C */
lbl_8026C424:
/* 8026C424  38 60 00 00 */	li r3, 0                                
/* 8026C428  48 00 01 A0 */	b lbl_8026C5C8                           /* constant-address: 8026C5C8, symbol: lbl_8026C5C8 */
lbl_8026C42C:
/* 8026C42C  C0 02 B7 18 */	lfs f0, lit_2256(r2)                     /* constant-address: 80455118, symbol: lit_2256 */
/* 8026C430  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8026C434  40 81 00 58 */	ble lbl_8026C48C                         /* constant-address: 8026C48C, symbol: lbl_8026C48C */
/* 8026C438  FC 00 20 34 */	frsqrte f0, f4                          
/* 8026C43C  C8 62 B7 20 */	lfd f3, lit_2257(r2)                     /* constant-address: 80455120, symbol: lit_2257 */
/* 8026C440  FC 23 00 32 */	fmul f1, f3, f0                         
/* 8026C444  C8 42 B7 28 */	lfd f2, lit_2258(r2)                     /* constant-address: 80455128, symbol: lit_2258 */
...
/* 8026C488  48 00 00 90 */	b lbl_8026C518                           /* constant-address: 8026C518, symbol: lbl_8026C518 */
lbl_8026C48C:
/* 8026C48C  C8 02 B7 30 */	lfd f0, lit_2259(r2)                     /* constant-address: 80455130, symbol: lit_2259 */
/* 8026C490  FC 04 00 40 */	fcmpo cr0, f4, f0                       
/* 8026C494  40 80 00 10 */	bge lbl_8026C4A4                         /* constant-address: 8026C4A4, symbol: lbl_8026C4A4 */
/* 8026C498  3C C0 80 45 */	lis r6, __float_nan@ha                  
/* 8026C49C  C0 46 0A E0 */	lfs f2, __float_nan@l(r6)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8026C4A0  48 00 00 78 */	b lbl_8026C518                           /* constant-address: 8026C518, symbol: lbl_8026C518 */
lbl_8026C4A4:
...
/* 8026C4B8  41 82 00 14 */	beq lbl_8026C4CC                         /* constant-address: 8026C4CC, symbol: lbl_8026C4CC */
/* 8026C4BC  40 80 00 40 */	bge lbl_8026C4FC                         /* constant-address: 8026C4FC, symbol: lbl_8026C4FC */
/* 8026C4C0  2C 06 00 00 */	cmpwi r6, 0                             
/* 8026C4C4  41 82 00 20 */	beq lbl_8026C4E4                         /* constant-address: 8026C4E4, symbol: lbl_8026C4E4 */
/* 8026C4C8  48 00 00 34 */	b lbl_8026C4FC                           /* constant-address: 8026C4FC, symbol: lbl_8026C4FC */
lbl_8026C4CC:
/* 8026C4CC  54 E0 02 7F */	clrlwi. r0, r7, 9                       
/* 8026C4D0  41 82 00 0C */	beq lbl_8026C4DC                         /* constant-address: 8026C4DC, symbol: lbl_8026C4DC */
/* 8026C4D4  38 00 00 01 */	li r0, 1                                
/* 8026C4D8  48 00 00 28 */	b lbl_8026C500                           /* constant-address: 8026C500, symbol: lbl_8026C500 */
lbl_8026C4DC:
/* 8026C4DC  38 00 00 02 */	li r0, 2                                
/* 8026C4E0  48 00 00 20 */	b lbl_8026C500                           /* constant-address: 8026C500, symbol: lbl_8026C500 */
lbl_8026C4E4:
/* 8026C4E4  54 E0 02 7F */	clrlwi. r0, r7, 9                       
/* 8026C4E8  41 82 00 0C */	beq lbl_8026C4F4                         /* constant-address: 8026C4F4, symbol: lbl_8026C4F4 */
/* 8026C4EC  38 00 00 05 */	li r0, 5                                
/* 8026C4F0  48 00 00 10 */	b lbl_8026C500                           /* constant-address: 8026C500, symbol: lbl_8026C500 */
lbl_8026C4F4:
/* 8026C4F4  38 00 00 03 */	li r0, 3                                
/* 8026C4F8  48 00 00 08 */	b lbl_8026C500                           /* constant-address: 8026C500, symbol: lbl_8026C500 */
lbl_8026C4FC:
/* 8026C4FC  38 00 00 04 */	li r0, 4                                
lbl_8026C500:
/* 8026C500  2C 00 00 01 */	cmpwi r0, 1                             
/* 8026C504  40 82 00 10 */	bne lbl_8026C514                         /* constant-address: 8026C514, symbol: lbl_8026C514 */
/* 8026C508  3C C0 80 45 */	lis r6, __float_nan@ha                  
/* 8026C50C  C0 46 0A E0 */	lfs f2, __float_nan@l(r6)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8026C510  48 00 00 08 */	b lbl_8026C518                           /* constant-address: 8026C518, symbol: lbl_8026C518 */
lbl_8026C514:
/* 8026C514  FC 40 20 90 */	fmr f2, f4                              
lbl_8026C518:
/* 8026C518  FC 00 12 10 */	fabs f0, f2                             
/* 8026C51C  FC 20 00 18 */	frsp f1, f0                             
/* 8026C520  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026C524  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026C528  41 80 00 84 */	blt lbl_8026C5AC                         /* constant-address: 8026C5AC, symbol: lbl_8026C5AC */
/* 8026C52C  C0 04 00 0C */	lfs f0, 0xc(r4)                         
/* 8026C530  EC 60 10 24 */	fdivs f3, f0, f2                        
/* 8026C534  C0 44 00 04 */	lfs f2, 4(r4)                           
/* 8026C538  C0 22 B7 C4 */	lfs f1, lit_3892(r2)                     /* constant-address: 804551C4, symbol: lit_3892 */
...
/* 8026C558  40 80 00 0C */	bge lbl_8026C564                         /* constant-address: 8026C564, symbol: lbl_8026C564 */
/* 8026C55C  D0 45 00 04 */	stfs f2, 4(r5)                          
/* 8026C560  48 00 00 18 */	b lbl_8026C578                           /* constant-address: 8026C578, symbol: lbl_8026C578 */
lbl_8026C564:
/* 8026C564  C0 03 00 10 */	lfs f0, 0x10(r3)                        
/* 8026C568  EC 42 00 2A */	fadds f2, f2, f0                        
/* 8026C56C  FC 01 10 40 */	fcmpo cr0, f1, f2                       
/* 8026C570  40 81 00 08 */	ble lbl_8026C578                         /* constant-address: 8026C578, symbol: lbl_8026C578 */
...
/* 8026C5A8  48 00 00 1C */	b lbl_8026C5C4                           /* constant-address: 8026C5C4, symbol: lbl_8026C5C4 */
lbl_8026C5AC:

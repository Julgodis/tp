...
/* 8026AC14  C0 0D 8C 00 */	lfs f0, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8026AC18  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 8026AC1C  40 80 00 0C */	bge lbl_8026AC28                         /* constant-address: 8026AC28, symbol: lbl_8026AC28 */
/* 8026AC20  38 60 00 00 */	li r3, 0                                
/* 8026AC24  48 00 01 30 */	b lbl_8026AD54                           /* constant-address: 8026AD54, symbol: lbl_8026AD54 */
lbl_8026AC28:
/* 8026AC28  C0 02 B7 AC */	lfs f0, lit_3205(r2)                     /* constant-address: 804551AC, symbol: lit_3205 */
...
/* 8026AC50  4B FF F1 15 */	bl cM3d_InclusionCheckPosIn3PosBox2d__Ffffffffff /* constant-address: 80269D64, symbol: cM3d_InclusionCheckPosIn3PosBox2d__Ffffffffff */
/* 8026AC54  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8026AC58  40 82 00 0C */	bne lbl_8026AC64                         /* constant-address: 8026AC64, symbol: lbl_8026AC64 */
/* 8026AC5C  38 60 00 00 */	li r3, 0                                
/* 8026AC60  48 00 00 F4 */	b lbl_8026AD54                           /* constant-address: 8026AD54, symbol: lbl_8026AD54 */
lbl_8026AC64:
...
/* 8026AC7C  4B FF DC 19 */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026AC80  FF E0 08 90 */	fmr f31, f1                             
/* 8026AC84  FC 1F F0 40 */	fcmpo cr0, f31, f30                     
/* 8026AC88  4C 40 13 82 */	cror 2, 0, 2                            
/* 8026AC8C  40 82 00 5C */	bne lbl_8026ACE8                         /* constant-address: 8026ACE8, symbol: lbl_8026ACE8 */
...
/* 8026ACA8  4B FF DB ED */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026ACAC  FC 01 F0 40 */	fcmpo cr0, f1, f30                      
/* 8026ACB0  4C 40 13 82 */	cror 2, 0, 2                            
/* 8026ACB4  40 82 00 34 */	bne lbl_8026ACE8                         /* constant-address: 8026ACE8, symbol: lbl_8026ACE8 */
...
/* 8026ACD0  4B FF DB C5 */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026ACD4  FC 01 F0 40 */	fcmpo cr0, f1, f30                      
/* 8026ACD8  4C 40 13 82 */	cror 2, 0, 2                            
/* 8026ACDC  40 82 00 0C */	bne lbl_8026ACE8                         /* constant-address: 8026ACE8, symbol: lbl_8026ACE8 */
/* 8026ACE0  38 60 00 01 */	li r3, 1                                
/* 8026ACE4  48 00 00 70 */	b lbl_8026AD54                           /* constant-address: 8026AD54, symbol: lbl_8026AD54 */
lbl_8026ACE8:
/* 8026ACE8  FF C0 F0 50 */	fneg f30, f30                           
/* 8026ACEC  FC 1F F0 40 */	fcmpo cr0, f31, f30                     
/* 8026ACF0  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026ACF4  40 82 00 5C */	bne lbl_8026AD50                         /* constant-address: 8026AD50, symbol: lbl_8026AD50 */
...
/* 8026AD10  4B FF DB 85 */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026AD14  FC 01 F0 40 */	fcmpo cr0, f1, f30                      
/* 8026AD18  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026AD1C  40 82 00 34 */	bne lbl_8026AD50                         /* constant-address: 8026AD50, symbol: lbl_8026AD50 */
...
/* 8026AD38  4B FF DB 5D */	bl cM3d_VectorProduct2d__Fffffff         /* constant-address: 80268894, symbol: cM3d_VectorProduct2d__Fffffff */
/* 8026AD3C  FC 01 F0 40 */	fcmpo cr0, f1, f30                      
/* 8026AD40  4C 41 13 82 */	cror 2, 1, 2                            
/* 8026AD44  40 82 00 0C */	bne lbl_8026AD50                         /* constant-address: 8026AD50, symbol: lbl_8026AD50 */
/* 8026AD48  38 60 00 01 */	li r3, 1                                
/* 8026AD4C  48 00 00 08 */	b lbl_8026AD54                           /* constant-address: 8026AD54, symbol: lbl_8026AD54 */
lbl_8026AD50:

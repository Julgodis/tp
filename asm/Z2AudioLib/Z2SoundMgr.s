...
/* 802A9C08 002A6B48  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802A9C28 002A6B68  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
/* 802A9C2C 002A6B6C  38 63 07 28 */	addi r3, r3, 0x728
/* 802A9C30 002A6B70  4B FF 80 61 */	bl calc__9JAISeqMgrFv
/* 802A9C34 002A6B74  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802A9C44 002A6B84  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
/* 802A9C48 002A6B88  48 00 BB 09 */	bl onFieldBgmJumpStart__8Z2SeqMgrFv
/* 802A9C4C 002A6B8C  48 00 01 4C */	b lbl_802A9D98
/* 802A9C50 002A6B90  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
/* 802A9C54 002A6B94  48 00 BB 49 */	bl onFieldBgmJumpEnd__8Z2SeqMgrFv
/* 802A9C58 002A6B98  48 00 01 40 */	b lbl_802A9D98
/* 802A9C5C 002A6B9C  80 6D 85 F0 */	lwz r3, "sInstance__33JASGlobalInstance<12Z2SpeechMgr2>"-_SDA_BASE_(r13)
...
/* 802A9C6C 002A6BAC  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802A9C7C 002A6BBC  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802A9C8C 002A6BCC  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802A9D10 002A6C50  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802A9D74 002A6CB4  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802A9D84 002A6CC4  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
lbl_802A9E14:
/* 802A9E14 002A6D54  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802A9E94 002A6DD4  93 ED 85 E0 */	stw r31, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802A9F14 002A6E54  80 6D 85 CC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2SoundInfo>"-_SDA_BASE_(r13)
...
/* 802A9F58 002A6E98  80 6D 85 CC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2SoundInfo>"-_SDA_BASE_(r13)
...
/* 802A9F6C 002A6EAC  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802A9FCC 002A6F0C  4B FF 67 9D */	bl "startSound__8JAISeMgrF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f>"
...
/* 802A9FE4 002A6F24  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802A9FFC 002A6F3C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802AA02C 002A6F6C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802AA050 002A6F90  4B FF 67 19 */	bl "startSound__8JAISeMgrF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f>"
/* 802AA054 002A6F94  48 00 01 44 */	b lbl_802AA198
lbl_802AA058:
/* 802AA058 002A6F98  38 A0 00 00 */	li r5, 0
/* 802AA05C 002A6F9C  83 6D 87 40 */	lwz r27, "sInstance__35JASGlobalInstance<14JAUSectionHeap>"-_SDA_BASE_(r13)
...
/* 802AA0E8 002A7028  4B FF 7A 61 */	bl "startSound__9JAISeqMgrF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f>"
...
/* 802AA12C 002A706C  4B FF 66 3D */	bl "startSound__8JAISeMgrF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f>"
...
/* 802AA174 002A70B4  4B FF 9A C9 */	bl "startSound__12JAIStreamMgrF10JAISoundIDP14JAISoundHandlePCQ29JGeometry8TVec3<f>"
...
/* 802AA1F4 002A7134  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802AA204 002A7144  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802AA54C 002A748C  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802AA760 002A76A0  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
lbl_802AA794:
/* 802AA794 002A76D4  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802AAA24 002A7964  80 6D 85 CC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2SoundInfo>"-_SDA_BASE_(r13)
...
/* 802AAA4C 002A798C  80 6D 85 CC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2SoundInfo>"-_SDA_BASE_(r13)
...
/* 802AAAFC 002A7A3C  80 6D 85 CC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2SoundInfo>"-_SDA_BASE_(r13)
...
/* 802AAB24 002A7A64  80 6D 85 CC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2SoundInfo>"-_SDA_BASE_(r13)
...
/* 8039B9D0 001D .rodata lbl_8039B9D0 @stringBase0 */
.global lbl_8039B9D0
lbl_8039B9D0:
...
.section .data, "aw"
/* 803C9D18 0058 .data lbl_803C9D18 @3690 */
.global lbl_803C9D18
lbl_803C9D18:

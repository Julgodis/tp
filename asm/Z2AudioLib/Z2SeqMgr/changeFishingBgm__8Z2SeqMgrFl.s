...
/* 802B2AA0  41 82 01 38 */	beq lbl_802B2BD8                         /* constant-address: 802B2BD8, symbol: lbl_802B2BD8 */
/* 802B2AA4  40 80 00 14 */	bge lbl_802B2AB8                         /* constant-address: 802B2AB8, symbol: lbl_802B2AB8 */
/* 802B2AA8  2C 04 00 00 */	cmpwi r4, 0                             
/* 802B2AAC  41 82 00 18 */	beq lbl_802B2AC4                         /* constant-address: 802B2AC4, symbol: lbl_802B2AC4 */
/* 802B2AB0  40 80 00 B8 */	bge lbl_802B2B68                         /* constant-address: 802B2B68, symbol: lbl_802B2B68 */
/* 802B2AB4  48 00 01 DC */	b lbl_802B2C90                           /* constant-address: 802B2C90, symbol: lbl_802B2C90 */
lbl_802B2AB8:
/* 802B2AB8  2C 04 00 04 */	cmpwi r4, 4                             
/* 802B2ABC  41 82 01 68 */	beq lbl_802B2C24                         /* constant-address: 802B2C24, symbol: lbl_802B2C24 */
/* 802B2AC0  48 00 01 D0 */	b lbl_802B2C90                           /* constant-address: 802B2C90, symbol: lbl_802B2C90 */
lbl_802B2AC4:
/* 802B2AC4  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802B2AC8  28 03 00 00 */	cmplwi r3, 0                            
/* 802B2ACC  41 82 00 10 */	beq lbl_802B2ADC                         /* constant-address: 802B2ADC, symbol: lbl_802B2ADC */
/* 802B2AD0  80 63 00 18 */	lwz r3, 0x18(r3)                        
/* 802B2AD4  90 61 00 10 */	stw r3, 0x10(r1)                        
/* 802B2AD8  48 00 00 08 */	b lbl_802B2AE0                           /* constant-address: 802B2AE0, symbol: lbl_802B2AE0 */
lbl_802B2ADC:
/* 802B2ADC  38 60 FF FF */	li r3, -1                               
lbl_802B2AE0:
/* 802B2AE0  3C 03 FF 00 */	addis r0, r3, 0xff00                    
/* 802B2AE4  28 00 00 49 */	cmplwi r0, 0x49                         
/* 802B2AE8  40 82 00 0C */	bne lbl_802B2AF4                         /* constant-address: 802B2AF4, symbol: lbl_802B2AF4 */
/* 802B2AEC  7F E3 FB 78 */	mr r3, r31                              
/* 802B2AF0  4B FF CD 95 */	bl subBgmStop__8Z2SeqMgrFv               /* constant-address: 802AF884, symbol: subBgmStop__8Z2SeqMgrFv */
lbl_802B2AF4:
/* 802B2AF4  88 6D 82 E2 */	lbz r3, struct_80450860+0x2(r13)         /* constant-address: 80450862, symbol: struct_80450860+0x2 */
/* 802B2AF8  C0 62 BF 98 */	lfs f3, lit_3372(r2)                     /* constant-address: 80455998, symbol: lit_3372 */
/* 802B2AFC  D0 7F 00 34 */	stfs f3, 0x34(r31)                      
/* 802B2B00  C0 02 BF 9C */	lfs f0, lit_3373(r2)                     /* constant-address: 8045599C, symbol: lit_3373 */
...
/* 802B2B18  41 82 00 3C */	beq lbl_802B2B54                         /* constant-address: 802B2B54, symbol: lbl_802B2B54 */
...
/* 802B2B2C  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */
...
/* 802B2B50  48 00 01 40 */	b lbl_802B2C90                           /* constant-address: 802B2C90, symbol: lbl_802B2C90 */
lbl_802B2B54:
...
/* 802B2B64  48 00 01 2C */	b lbl_802B2C90                           /* constant-address: 802B2C90, symbol: lbl_802B2C90 */
lbl_802B2B68:
/* 802B2B68  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802B2B6C  28 03 00 00 */	cmplwi r3, 0                            
/* 802B2B70  41 82 00 10 */	beq lbl_802B2B80                         /* constant-address: 802B2B80, symbol: lbl_802B2B80 */
/* 802B2B74  80 63 00 18 */	lwz r3, 0x18(r3)                        
/* 802B2B78  90 61 00 0C */	stw r3, 0xc(r1)                         
/* 802B2B7C  48 00 00 08 */	b lbl_802B2B84                           /* constant-address: 802B2B84, symbol: lbl_802B2B84 */
lbl_802B2B80:
/* 802B2B80  38 60 FF FF */	li r3, -1                               
lbl_802B2B84:
/* 802B2B84  3C 03 FF 00 */	addis r0, r3, 0xff00                    
/* 802B2B88  28 00 00 49 */	cmplwi r0, 0x49                         
/* 802B2B8C  40 82 00 0C */	bne lbl_802B2B98                         /* constant-address: 802B2B98, symbol: lbl_802B2B98 */
/* 802B2B90  7F E3 FB 78 */	mr r3, r31                              
/* 802B2B94  4B FF CC F1 */	bl subBgmStop__8Z2SeqMgrFv               /* constant-address: 802AF884, symbol: subBgmStop__8Z2SeqMgrFv */
lbl_802B2B98:
/* 802B2B98  C0 1F 00 44 */	lfs f0, 0x44(r31)                       
/* 802B2B9C  38 00 00 02 */	li r0, 2                                
/* 802B2BA0  90 1F 00 50 */	stw r0, 0x50(r31)                       
/* 802B2BA4  C0 62 BF C4 */	lfs f3, lit_4731(r2)                     /* constant-address: 804559C4, symbol: lit_4731 */
/* 802B2BA8  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 802B2BAC  80 1F 00 50 */	lwz r0, 0x50(r31)                       
/* 802B2BB0  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */
...
/* 802B2BD4  48 00 00 BC */	b lbl_802B2C90                           /* constant-address: 802B2C90, symbol: lbl_802B2C90 */
lbl_802B2BD8:
/* 802B2BD8  3C 80 01 00 */	lis r4, 0x0100 /* 0x01000049@ha */      
/* 802B2BDC  38 84 00 49 */	addi r4, r4, 0x0049 /* 0x01000049@l */   /* constant-address: 01000049 */
/* 802B2BE0  4B FF C8 BD */	bl subBgmStart__8Z2SeqMgrFUl             /* constant-address: 802AF49C, symbol: subBgmStart__8Z2SeqMgrFUl */
/* 802B2BE4  C0 1F 00 44 */	lfs f0, 0x44(r31)                       
/* 802B2BE8  38 00 00 01 */	li r0, 1                                
/* 802B2BEC  90 1F 00 50 */	stw r0, 0x50(r31)                       
/* 802B2BF0  C0 62 BF 9C */	lfs f3, lit_3373(r2)                     /* constant-address: 8045599C, symbol: lit_3373 */
/* 802B2BF4  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 802B2BF8  80 1F 00 50 */	lwz r0, 0x50(r31)                       
/* 802B2BFC  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */
...
/* 802B2C20  48 00 00 70 */	b lbl_802B2C90                           /* constant-address: 802B2C90, symbol: lbl_802B2C90 */
lbl_802B2C24:
/* 802B2C24  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802B2C28  28 03 00 00 */	cmplwi r3, 0                            
/* 802B2C2C  41 82 00 10 */	beq lbl_802B2C3C                         /* constant-address: 802B2C3C, symbol: lbl_802B2C3C */
/* 802B2C30  80 63 00 18 */	lwz r3, 0x18(r3)                        
/* 802B2C34  90 61 00 08 */	stw r3, 8(r1)                           
/* 802B2C38  48 00 00 08 */	b lbl_802B2C40                           /* constant-address: 802B2C40, symbol: lbl_802B2C40 */
lbl_802B2C3C:
/* 802B2C3C  38 60 FF FF */	li r3, -1                               
lbl_802B2C40:
/* 802B2C40  3C 03 FF 00 */	addis r0, r3, 0xff00                    
/* 802B2C44  28 00 00 49 */	cmplwi r0, 0x49                         
/* 802B2C48  40 82 00 0C */	bne lbl_802B2C54                         /* constant-address: 802B2C54, symbol: lbl_802B2C54 */
/* 802B2C4C  7F E3 FB 78 */	mr r3, r31                              
/* 802B2C50  4B FF CC 35 */	bl subBgmStop__8Z2SeqMgrFv               /* constant-address: 802AF884, symbol: subBgmStop__8Z2SeqMgrFv */
lbl_802B2C54:
/* 802B2C54  C0 1F 00 44 */	lfs f0, 0x44(r31)                       
/* 802B2C58  38 00 00 01 */	li r0, 1                                
/* 802B2C5C  90 1F 00 50 */	stw r0, 0x50(r31)                       
/* 802B2C60  C0 62 BF 9C */	lfs f3, lit_3373(r2)                     /* constant-address: 8045599C, symbol: lit_3373 */
/* 802B2C64  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 802B2C68  80 1F 00 50 */	lwz r0, 0x50(r31)                       
/* 802B2C6C  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */

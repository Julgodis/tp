...
/* 802B2CB0  41 82 00 10 */	beq lbl_802B2CC0                         /* constant-address: 802B2CC0, symbol: lbl_802B2CC0 */
/* 802B2CB4  80 85 00 18 */	lwz r4, 0x18(r5)                        
/* 802B2CB8  90 81 00 10 */	stw r4, 0x10(r1)                        
/* 802B2CBC  48 00 00 08 */	b lbl_802B2CC4                           /* constant-address: 802B2CC4, symbol: lbl_802B2CC4 */
lbl_802B2CC0:
/* 802B2CC0  38 80 FF FF */	li r4, -1                               
lbl_802B2CC4:
/* 802B2CC4  3C 04 FE 00 */	addis r0, r4, 0xfe00                    
/* 802B2CC8  28 00 00 38 */	cmplwi r0, 0x38                         
/* 802B2CCC  41 82 00 90 */	beq lbl_802B2D5C                         /* constant-address: 802B2D5C, symbol: lbl_802B2D5C */
/* 802B2CD0  28 05 00 00 */	cmplwi r5, 0                            
/* 802B2CD4  41 82 00 10 */	beq lbl_802B2CE4                         /* constant-address: 802B2CE4, symbol: lbl_802B2CE4 */
/* 802B2CD8  80 85 00 18 */	lwz r4, 0x18(r5)                        
/* 802B2CDC  90 81 00 0C */	stw r4, 0xc(r1)                         
/* 802B2CE0  48 00 00 08 */	b lbl_802B2CE8                           /* constant-address: 802B2CE8, symbol: lbl_802B2CE8 */
lbl_802B2CE4:
/* 802B2CE4  38 80 FF FF */	li r4, -1                               
lbl_802B2CE8:
/* 802B2CE8  3C 04 FE 00 */	addis r0, r4, 0xfe00                    
/* 802B2CEC  28 00 00 7C */	cmplwi r0, 0x7c                         
/* 802B2CF0  41 82 00 6C */	beq lbl_802B2D5C                         /* constant-address: 802B2D5C, symbol: lbl_802B2D5C */
/* 802B2CF4  80 83 00 00 */	lwz r4, 0(r3)                           
/* 802B2CF8  28 04 00 00 */	cmplwi r4, 0                            
/* 802B2CFC  41 82 00 10 */	beq lbl_802B2D0C                         /* constant-address: 802B2D0C, symbol: lbl_802B2D0C */
/* 802B2D00  80 84 00 18 */	lwz r4, 0x18(r4)                        
/* 802B2D04  90 81 00 08 */	stw r4, 8(r1)                           
/* 802B2D08  48 00 00 08 */	b lbl_802B2D10                           /* constant-address: 802B2D10, symbol: lbl_802B2D10 */
lbl_802B2D0C:
/* 802B2D0C  38 80 FF FF */	li r4, -1                               
lbl_802B2D10:
/* 802B2D10  3C 04 FF 00 */	addis r0, r4, 0xff00                    
/* 802B2D14  28 00 00 79 */	cmplwi r0, 0x79                         
/* 802B2D18  40 82 00 08 */	bne lbl_802B2D20                         /* constant-address: 802B2D20, symbol: lbl_802B2D20 */
/* 802B2D1C  48 00 00 40 */	b lbl_802B2D5C                           /* constant-address: 802B2D5C, symbol: lbl_802B2D5C */
lbl_802B2D20:
/* 802B2D20  C0 6D 82 98 */	lfs f3, VOL_BGM_TALKING__7Z2Param(r13)   /* constant-address: 80450818, symbol: VOL_BGM_TALKING__7Z2Param */
...
/* 802B2D38  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */

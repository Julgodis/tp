...
/* 802B43EC  41 82 00 10 */	beq lbl_802B43FC                         /* constant-address: 802B43FC, symbol: lbl_802B43FC */
/* 802B43F0  80 A5 00 18 */	lwz r5, 0x18(r5)                        
/* 802B43F4  90 A1 00 08 */	stw r5, 8(r1)                           
/* 802B43F8  48 00 00 08 */	b lbl_802B4400                           /* constant-address: 802B4400, symbol: lbl_802B4400 */
lbl_802B43FC:
/* 802B43FC  38 A0 FF FF */	li r5, -1                               
lbl_802B4400:
/* 802B4400  3C 05 FF 00 */	addis r0, r5, 0xff00                    
/* 802B4404  28 00 00 0F */	cmplwi r0, 0xf                          
/* 802B4408  40 82 00 88 */	bne lbl_802B4490                         /* constant-address: 802B4490, symbol: lbl_802B4490 */
/* 802B440C  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 802B4410  41 82 00 44 */	beq lbl_802B4454                         /* constant-address: 802B4454, symbol: lbl_802B4454 */
/* 802B4414  C0 03 00 24 */	lfs f0, 0x24(r3)                        
/* 802B4418  38 00 00 05 */	li r0, 5                                
/* 802B441C  90 03 00 30 */	stw r0, 0x30(r3)                        
/* 802B4420  C0 62 BF 98 */	lfs f3, lit_3372(r2)                     /* constant-address: 80455998, symbol: lit_3372 */
/* 802B4424  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 802B4428  80 03 00 30 */	lwz r0, 0x30(r3)                        
/* 802B442C  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */
...
/* 802B4450  48 00 00 40 */	b lbl_802B4490                           /* constant-address: 802B4490, symbol: lbl_802B4490 */
lbl_802B4454:
/* 802B4454  C0 03 00 24 */	lfs f0, 0x24(r3)                        
/* 802B4458  38 00 00 05 */	li r0, 5                                
/* 802B445C  90 03 00 30 */	stw r0, 0x30(r3)                        
/* 802B4460  C0 62 C0 14 */	lfs f3, lit_5913(r2)                     /* constant-address: 80455A14, symbol: lit_5913 */
/* 802B4464  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 802B4468  80 03 00 30 */	lwz r0, 0x30(r3)                        
/* 802B446C  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */

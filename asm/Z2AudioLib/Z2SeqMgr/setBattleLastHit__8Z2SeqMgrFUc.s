...
/* 802B4B20  41 82 00 10 */	beq lbl_802B4B30                         /* constant-address: 802B4B30, symbol: lbl_802B4B30 */
/* 802B4B24  80 63 00 18 */	lwz r3, 0x18(r3)                        
/* 802B4B28  90 61 00 08 */	stw r3, 8(r1)                           
/* 802B4B2C  48 00 00 08 */	b lbl_802B4B34                           /* constant-address: 802B4B34, symbol: lbl_802B4B34 */
lbl_802B4B30:
/* 802B4B30  38 60 FF FF */	li r3, -1                               
lbl_802B4B34:
/* 802B4B34  3C 03 FF 00 */	addis r0, r3, 0xff00                    
/* 802B4B38  28 00 00 0F */	cmplwi r0, 0xf                          
/* 802B4B3C  40 82 00 7C */	bne lbl_802B4BB8                         /* constant-address: 802B4BB8, symbol: lbl_802B4BB8 */
/* 802B4B40  7F C3 F3 78 */	mr r3, r30                              
/* 802B4B44  38 80 00 01 */	li r4, 1                                
/* 802B4B48  4B FF F8 89 */	bl setBattleDistIgnore__8Z2SeqMgrFb      /* constant-address: 802B43D0, symbol: setBattleDistIgnore__8Z2SeqMgrFb */
/* 802B4B4C  88 0D 82 E8 */	lbz r0, struct_80450868+0x0(r13)         /* constant-address: 80450868, symbol: struct_80450868+0x0 */
/* 802B4B50  C0 6D 8D BC */	lfs f3, ENEMY_LASTHIT_MUTE_VOLUME__7Z2Param(r13) /* constant-address: 8045133C, symbol: ENEMY_LASTHIT_MUTE_VOLUME__7Z2Param */
/* 802B4B54  28 00 00 00 */	cmplwi r0, 0                            
/* 802B4B58  41 82 00 3C */	beq lbl_802B4B94                         /* constant-address: 802B4B94, symbol: lbl_802B4B94 */
...
/* 802B4B6C  C8 22 BF A8 */	lfd f1, lit_3561(r2)                     /* constant-address: 804559A8, symbol: lit_3561 */
...
/* 802B4B90  48 00 00 1C */	b lbl_802B4BAC                           /* constant-address: 802B4BAC, symbol: lbl_802B4BAC */
lbl_802B4B94:
/* 802B4B94  D0 7E 00 24 */	stfs f3, 0x24(r30)                      
/* 802B4B98  C0 02 BF 9C */	lfs f0, lit_3373(r2)                     /* constant-address: 8045599C, symbol: lit_3373 */
...
lbl_802B4BAC:
/* 802B4BAC  88 0D 82 EB */	lbz r0, struct_80450868+0x3(r13)         /* constant-address: 8045086B, symbol: struct_80450868+0x3 */

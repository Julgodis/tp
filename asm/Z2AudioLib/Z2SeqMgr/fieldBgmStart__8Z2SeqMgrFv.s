...
/* 802B5470  80 6D 86 00 */	lwz r3, data_80450B80(r13)               /* constant-address: 80450B80, symbol: data_80450B80 */
/* 802B5474  88 03 00 1D */	lbz r0, 0x1d(r3)                        
/* 802B5478  28 00 00 00 */	cmplwi r0, 0                            
/* 802B547C  41 82 00 DC */	beq lbl_802B5558                         /* constant-address: 802B5558, symbol: lbl_802B5558 */
/* 802B5480  88 1F 00 D0 */	lbz r0, 0xd0(r31)                       
/* 802B5484  54 00 F7 FF */	rlwinm. r0, r0, 0x1e, 0x1f, 0x1f        
/* 802B5488  41 82 00 D0 */	beq lbl_802B5558                         /* constant-address: 802B5558, symbol: lbl_802B5558 */
/* 802B548C  80 6D 85 FC */	lwz r3, data_80450B7C(r13)               /* constant-address: 80450B7C, symbol: data_80450B7C */
/* 802B5490  48 00 12 A5 */	bl checkDayTime__11Z2StatusMgrFv         /* constant-address: 802B6734, symbol: checkDayTime__11Z2StatusMgrFv */
/* 802B5494  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802B5498  41 82 00 8C */	beq lbl_802B5524                         /* constant-address: 802B5524, symbol: lbl_802B5524 */
/* 802B549C  3C 00 01 00 */	lis r0, 0x100                           
/* 802B54A0  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 802B54A4  80 6D 85 E0 */	lwz r3, data_80450B60(r13)               /* constant-address: 80450B60, symbol: data_80450B60 */
...
/* 802B54CC  4B FF AA C1 */	bl changeBgmStatus__8Z2SeqMgrFl          /* constant-address: 802AFF8C, symbol: changeBgmStatus__8Z2SeqMgrFl */
/* 802B54D0  38 80 00 00 */	li r4, 0                                
/* 802B54D4  98 9F 00 C4 */	stb r4, 0xc4(r31)                       
/* 802B54D8  80 6D 8D E0 */	lwz r3, mLinkPtr__14Z2CreatureLink(r13)  /* constant-address: 80451360, symbol: mLinkPtr__14Z2CreatureLink */
/* 802B54DC  88 03 00 CB */	lbz r0, 0xcb(r3)                        
/* 802B54E0  54 00 FF FF */	rlwinm. r0, r0, 0x1f, 0x1f, 0x1f        
/* 802B54E4  41 82 00 24 */	beq lbl_802B5508                         /* constant-address: 802B5508, symbol: lbl_802B5508 */
...
/* 802B5500  48 00 00 6D */	bl fieldRidingMute__8Z2SeqMgrFv          /* constant-address: 802B556C, symbol: fieldRidingMute__8Z2SeqMgrFv */
/* 802B5504  48 00 00 54 */	b lbl_802B5558                           /* constant-address: 802B5558, symbol: lbl_802B5558 */
lbl_802B5508:
...
/* 802B551C  48 00 00 51 */	bl fieldRidingMute__8Z2SeqMgrFv          /* constant-address: 802B556C, symbol: fieldRidingMute__8Z2SeqMgrFv */
/* 802B5520  48 00 00 38 */	b lbl_802B5558                           /* constant-address: 802B5558, symbol: lbl_802B5558 */
lbl_802B5524:
/* 802B5524  3C 60 01 00 */	lis r3, 0x0100 /* 0x01000001@ha */      
/* 802B5528  38 03 00 01 */	addi r0, r3, 0x0001 /* 0x01000001@l */   /* constant-address: 01000001 */
/* 802B552C  90 01 00 08 */	stw r0, 8(r1)                           
/* 802B5530  80 6D 85 E0 */	lwz r3, data_80450B60(r13)               /* constant-address: 80450B60, symbol: data_80450B60 */

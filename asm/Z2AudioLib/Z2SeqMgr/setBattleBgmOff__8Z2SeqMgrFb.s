...
/* 802B4190  41 82 00 68 */	beq lbl_802B41F8                         /* constant-address: 802B41F8, symbol: lbl_802B41F8 */
/* 802B4194  28 00 00 00 */	cmplwi r0, 0                            
/* 802B4198  41 82 00 60 */	beq lbl_802B41F8                         /* constant-address: 802B41F8, symbol: lbl_802B41F8 */
/* 802B419C  80 9E 00 04 */	lwz r4, 4(r30)                          
/* 802B41A0  28 04 00 00 */	cmplwi r4, 0                            
/* 802B41A4  41 82 00 10 */	beq lbl_802B41B4                         /* constant-address: 802B41B4, symbol: lbl_802B41B4 */
/* 802B41A8  80 64 00 18 */	lwz r3, 0x18(r4)                        
/* 802B41AC  90 61 00 0C */	stw r3, 0xc(r1)                         
/* 802B41B0  48 00 00 08 */	b lbl_802B41B8                           /* constant-address: 802B41B8, symbol: lbl_802B41B8 */
lbl_802B41B4:
/* 802B41B4  38 60 FF FF */	li r3, -1                               
lbl_802B41B8:
/* 802B41B8  3C 03 FF 00 */	addis r0, r3, 0xff00                    
/* 802B41BC  28 00 00 0F */	cmplwi r0, 0xf                          
/* 802B41C0  41 82 00 28 */	beq lbl_802B41E8                         /* constant-address: 802B41E8, symbol: lbl_802B41E8 */
/* 802B41C4  28 04 00 00 */	cmplwi r4, 0                            
/* 802B41C8  41 82 00 10 */	beq lbl_802B41D8                         /* constant-address: 802B41D8, symbol: lbl_802B41D8 */
/* 802B41CC  80 64 00 18 */	lwz r3, 0x18(r4)                        
/* 802B41D0  90 61 00 08 */	stw r3, 8(r1)                           
/* 802B41D4  48 00 00 08 */	b lbl_802B41DC                           /* constant-address: 802B41DC, symbol: lbl_802B41DC */
lbl_802B41D8:
/* 802B41D8  38 60 FF FF */	li r3, -1                               
lbl_802B41DC:
/* 802B41DC  3C 03 FF 00 */	addis r0, r3, 0xff00                    
/* 802B41E0  28 00 00 1B */	cmplwi r0, 0x1b                         
/* 802B41E4  40 82 00 14 */	bne lbl_802B41F8                         /* constant-address: 802B41F8, symbol: lbl_802B41F8 */
lbl_802B41E8:
/* 802B41E8  7F C3 F3 78 */	mr r3, r30                              
/* 802B41EC  88 8D 82 E2 */	lbz r4, struct_80450860+0x2(r13)         /* constant-address: 80450862, symbol: struct_80450860+0x2 */
/* 802B41F0  88 AD 82 E1 */	lbz r5, struct_80450860+0x1(r13)         /* constant-address: 80450861, symbol: struct_80450860+0x1 */
/* 802B41F4  48 00 10 11 */	bl stopBattleBgm__8Z2SeqMgrFUcUc         /* constant-address: 802B5204, symbol: stopBattleBgm__8Z2SeqMgrFUcUc */
lbl_802B41F8:

...
/* 802CBF7C  41 82 02 00 */	beq lbl_802CC17C                         /* constant-address: 802CC17C, symbol: lbl_802CC17C */
...
/* 802CBFAC  40 82 00 14 */	bne lbl_802CBFC0                         /* constant-address: 802CBFC0, symbol: lbl_802CBFC0 */
/* 802CBFB0  A8 1F 03 F8 */	lha r0, 0x3f8(r31)                      
/* 802CBFB4  7C 03 00 00 */	cmpw r3, r0                             
/* 802CBFB8  41 80 00 08 */	blt lbl_802CBFC0                         /* constant-address: 802CBFC0, symbol: lbl_802CBFC0 */
...
/* 802CBFD0  41 80 00 08 */	blt lbl_802CBFD8                         /* constant-address: 802CBFD8, symbol: lbl_802CBFD8 */
/* 802CBFD4  B0 7F 03 FA */	sth r3, 0x3fa(r31)                      
lbl_802CBFD8:
/* 802CBFD8  88 1F 03 FE */	lbz r0, 0x3fe(r31)                      
/* 802CBFDC  28 00 00 01 */	cmplwi r0, 1                            
/* 802CBFE0  41 82 00 0C */	beq lbl_802CBFEC                         /* constant-address: 802CBFEC, symbol: lbl_802CBFEC */
/* 802CBFE4  28 00 00 02 */	cmplwi r0, 2                            
/* 802CBFE8  40 82 00 20 */	bne lbl_802CC008                         /* constant-address: 802CC008, symbol: lbl_802CC008 */
lbl_802CBFEC:
/* 802CBFEC  80 1F 00 00 */	lwz r0, 0(r31)                          
/* 802CBFF0  28 00 00 00 */	cmplwi r0, 0                            
/* 802CBFF4  40 82 01 88 */	bne lbl_802CC17C                         /* constant-address: 802CC17C, symbol: lbl_802CC17C */
/* 802CBFF8  7F E3 FB 78 */	mr r3, r31                              
/* 802CBFFC  38 80 00 00 */	li r4, 0                                
/* 802CC000  48 00 01 91 */	bl speakOneWord__12Z2SpeechMgr2Fb        /* constant-address: 802CC190, symbol: speakOneWord__12Z2SpeechMgr2Fb */
/* 802CC004  48 00 01 78 */	b lbl_802CC17C                           /* constant-address: 802CC17C, symbol: lbl_802CC17C */
lbl_802CC008:
/* 802CC008  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 802CC00C  41 82 00 58 */	beq lbl_802CC064                         /* constant-address: 802CC064, symbol: lbl_802CC064 */
/* 802CC010  A0 1F 03 FC */	lhz r0, 0x3fc(r31)                      
/* 802CC014  28 00 00 00 */	cmplwi r0, 0                            
/* 802CC018  40 82 01 64 */	bne lbl_802CC17C                         /* constant-address: 802CC17C, symbol: lbl_802CC17C */
...
/* 802CC038  C0 22 C5 30 */	lfs f1, lit_3836(r2)                     /* constant-address: 80455F30, symbol: lit_3836 */
/* 802CC03C  C0 42 C5 34 */	lfs f2, lit_3837(r2)                     /* constant-address: 80455F34, symbol: lit_3837 */
/* 802CC040  FC 60 10 90 */	fmr f3, f2                              
/* 802CC044  C0 82 C5 38 */	lfs f4, lit_3838(r2)                     /* constant-address: 80455F38, symbol: lit_3838 */
...
/* 802CC060  48 00 01 1C */	b lbl_802CC17C                           /* constant-address: 802CC17C, symbol: lbl_802CC17C */
lbl_802CC064:
/* 802CC064  7F E3 FB 78 */	mr r3, r31                              
/* 802CC068  48 00 02 95 */	bl isNonVerbal__12Z2SpeechMgr2Fv         /* constant-address: 802CC2FC, symbol: isNonVerbal__12Z2SpeechMgr2Fv */
/* 802CC06C  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802CC070  40 82 01 0C */	bne lbl_802CC17C                         /* constant-address: 802CC17C, symbol: lbl_802CC17C */
/* 802CC074  88 7F 03 FE */	lbz r3, 0x3fe(r31)                      
/* 802CC078  38 03 FF F5 */	addi r0, r3, -11                        
/* 802CC07C  28 00 00 14 */	cmplwi r0, 0x14                         
/* 802CC080  41 81 00 B8 */	bgt lbl_802CC138                         /* constant-address: 802CC138, symbol: lbl_802CC138 */
/* 802CC084  3C 60 80 3D */	lis r3, lit_3839@ha                     
/* 802CC088  38 63 BE D0 */	addi r3, r3, lit_3839@l                  /* constant-address: 803CBED0, symbol: lit_3839 */
...
/* 802CC154  C0 22 C5 30 */	lfs f1, lit_3836(r2)                     /* constant-address: 80455F30, symbol: lit_3836 */
/* 802CC158  C0 42 C5 34 */	lfs f2, lit_3837(r2)                     /* constant-address: 80455F34, symbol: lit_3837 */
/* 802CC15C  FC 60 10 90 */	fmr f3, f2                              
/* 802CC160  C0 82 C5 38 */	lfs f4, lit_3838(r2)                     /* constant-address: 80455F38, symbol: lit_3838 */

...
/* 802CC1A0  48 09 60 3D */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
/* 802CC1A4  7C 7E 1B 78 */	mr r30, r3                              
/* 802CC1A8  7C 9F 23 78 */	mr r31, r4                              
/* 802CC1AC  80 6D 86 00 */	lwz r3, data_80450B80(r13)               /* constant-address: 80450B80, symbol: data_80450B80 */
/* 802CC1B0  88 03 00 1D */	lbz r0, 0x1d(r3)                        
/* 802CC1B4  28 00 00 00 */	cmplwi r0, 0                            
/* 802CC1B8  41 82 01 2C */	beq lbl_802CC2E4                         /* constant-address: 802CC2E4, symbol: lbl_802CC2E4 */
/* 802CC1BC  88 1E 03 FE */	lbz r0, 0x3fe(r30)                      
/* 802CC1C0  28 00 00 01 */	cmplwi r0, 1                            
/* 802CC1C4  41 82 00 0C */	beq lbl_802CC1D0                         /* constant-address: 802CC1D0, symbol: lbl_802CC1D0 */
/* 802CC1C8  28 00 00 02 */	cmplwi r0, 2                            
/* 802CC1CC  40 82 01 18 */	bne lbl_802CC2E4                         /* constant-address: 802CC2E4, symbol: lbl_802CC2E4 */
lbl_802CC1D0:
/* 802CC1D0  88 1E 04 00 */	lbz r0, 0x400(r30)                      
/* 802CC1D4  28 00 00 00 */	cmplwi r0, 0                            
/* 802CC1D8  40 82 01 0C */	bne lbl_802CC2E4                         /* constant-address: 802CC2E4, symbol: lbl_802CC2E4 */
/* 802CC1DC  88 1E 03 FF */	lbz r0, 0x3ff(r30)                      
/* 802CC1E0  28 00 00 1E */	cmplwi r0, 0x1e                         
/* 802CC1E4  41 81 01 00 */	bgt lbl_802CC2E4                         /* constant-address: 802CC2E4, symbol: lbl_802CC2E4 */
/* 802CC1E8  A8 7E 03 FA */	lha r3, 0x3fa(r30)                      
/* 802CC1EC  A8 1E 03 F8 */	lha r0, 0x3f8(r30)                      
/* 802CC1F0  7C 03 00 00 */	cmpw r3, r0                             
/* 802CC1F4  41 80 00 18 */	blt lbl_802CC20C                         /* constant-address: 802CC20C, symbol: lbl_802CC20C */
/* 802CC1F8  7F C3 F3 78 */	mr r3, r30                              
/* 802CC1FC  48 00 05 3D */	bl selectTail__12Z2SpeechMgr2Fv          /* constant-address: 802CC738, symbol: selectTail__12Z2SpeechMgr2Fv */
/* 802CC200  38 00 00 01 */	li r0, 1                                
/* 802CC204  98 1E 04 00 */	stb r0, 0x400(r30)                      
/* 802CC208  48 00 00 14 */	b lbl_802CC21C                           /* constant-address: 802CC21C, symbol: lbl_802CC21C */
lbl_802CC20C:
/* 802CC20C  7F C3 F3 78 */	mr r3, r30                              
/* 802CC210  48 00 00 ED */	bl isNonVerbal__12Z2SpeechMgr2Fv         /* constant-address: 802CC2FC, symbol: isNonVerbal__12Z2SpeechMgr2Fv */
/* 802CC214  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802CC218  40 82 00 CC */	bne lbl_802CC2E4                         /* constant-address: 802CC2E4, symbol: lbl_802CC2E4 */
lbl_802CC21C:
/* 802CC21C  A0 7E 03 FC */	lhz r3, 0x3fc(r30)                      
/* 802CC220  3F A3 00 05 */	addis r29, r3, 5                        
/* 802CC224  80 6D 86 00 */	lwz r3, data_80450B80(r13)               /* constant-address: 80450B80, symbol: data_80450B80 */
/* 802CC228  88 63 00 0C */	lbz r3, 0xc(r3)                         
/* 802CC22C  7C 63 07 74 */	extsb r3, r3                            
/* 802CC230  3B BD 00 A1 */	addi r29, r29, 0xa1                     
/* 802CC234  4B D6 0E 39 */	bl dComIfGp_getReverb__Fi                /* constant-address: 8002D06C, symbol: dComIfGp_getReverb__Fi */
...
/* 802CC258  C8 22 C5 40 */	lfd f1, lit_3887(r2)                     /* constant-address: 80455F40, symbol: lit_3887 */
...
/* 802CC274  C0 02 C5 3C */	lfs f0, lit_3885(r2)                     /* constant-address: 80455F3C, symbol: lit_3885 */
/* 802CC278  EC 21 00 24 */	fdivs f1, f1, f0                        
/* 802CC27C  C0 42 C5 34 */	lfs f2, lit_3837(r2)                     /* constant-address: 80455F34, symbol: lit_3837 */
/* 802CC280  FC 60 10 90 */	fmr f3, f2                              
/* 802CC284  C0 82 C5 38 */	lfs f4, lit_3838(r2)                     /* constant-address: 80455F38, symbol: lit_3838 */
...
/* 802CC2C8  4B FD EC 15 */	bl setPortData__14Z2SoundStarterFP14JAISoundHandleUlUsSc /* constant-address: 802AAEDC, symbol: setPortData__14Z2SoundStarterFP14JAISoundHandleUlUsSc */
/* 802CC2CC  88 1E 04 00 */	lbz r0, 0x400(r30)                      
/* 802CC2D0  28 00 00 00 */	cmplwi r0, 0                            
/* 802CC2D4  40 82 00 10 */	bne lbl_802CC2E4                         /* constant-address: 802CC2E4, symbol: lbl_802CC2E4 */
/* 802CC2D8  7F C3 F3 78 */	mr r3, r30                              
/* 802CC2DC  7F E4 FB 78 */	mr r4, r31                              
/* 802CC2E0  48 00 01 E1 */	bl selectUnit__12Z2SpeechMgr2Fb          /* constant-address: 802CC4C0, symbol: selectUnit__12Z2SpeechMgr2Fb */
lbl_802CC2E4:
/* 802CC2E4  39 61 00 30 */	addi r11, r1, 0x30                      
/* 802CC2E8  48 09 5F 41 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

...
/* 802CC764  41 82 00 14 */	beq lbl_802CC778                         /* constant-address: 802CC778, symbol: lbl_802CC778 */
/* 802CC768  40 80 02 60 */	bge lbl_802CC9C8                         /* constant-address: 802CC9C8, symbol: lbl_802CC9C8 */
/* 802CC76C  2C 00 00 01 */	cmpwi r0, 1                             
/* 802CC770  40 80 00 88 */	bge lbl_802CC7F8                         /* constant-address: 802CC7F8, symbol: lbl_802CC7F8 */
/* 802CC774  48 00 02 54 */	b lbl_802CC9C8                           /* constant-address: 802CC9C8, symbol: lbl_802CC9C8 */
lbl_802CC778:
/* 802CC778  A0 03 03 FC */	lhz r0, 0x3fc(r3)                       
/* 802CC77C  1D 00 00 0C */	mulli r8, r0, 0xc                       
/* 802CC780  3C C0 80 3A */	lis r6, sPrm__8Z2MdnPrm@ha              
/* 802CC784  38 06 C9 8C */	addi r0, r6, sPrm__8Z2MdnPrm@l           /* constant-address: 8039C98C, symbol: sPrm__8Z2MdnPrm */
...
/* 802CC798  38 08 66 0D */	addi r0, r8, 0x660D /* 0x0019660D@l */   /* constant-address: 0019660D */
...
/* 802CC7C0  C0 02 C5 34 */	lfs f0, lit_3837(r2)                     /* constant-address: 80455F34, symbol: lit_3837 */
/* 802CC7C4  EC 41 00 28 */	fsubs f2, f1, f0                        
/* 802CC7C8  C8 22 C5 48 */	lfd f1, lit_4083(r2)                     /* constant-address: 80455F48, symbol: lit_4083 */
...
/* 802CC7F4  48 00 00 9C */	b lbl_802CC890                           /* constant-address: 802CC890, symbol: lbl_802CC890 */
lbl_802CC7F8:
/* 802CC7F8  A0 03 03 FC */	lhz r0, 0x3fc(r3)                       
/* 802CC7FC  1C 00 00 0C */	mulli r0, r0, 0xc                       
/* 802CC800  3C C0 80 3A */	lis r6, sPrm__8Z2MdnPrm@ha              
/* 802CC804  39 66 C9 8C */	addi r11, r6, sPrm__8Z2MdnPrm@l          /* constant-address: 8039C98C, symbol: sPrm__8Z2MdnPrm */
...
/* 802CC818  38 08 66 0D */	addi r0, r8, 0x660D /* 0x0019660D@l */   /* constant-address: 0019660D */
...
/* 802CC840  C0 02 C5 34 */	lfs f0, lit_3837(r2)                     /* constant-address: 80455F34, symbol: lit_3837 */
...
/* 802CC858  C8 22 C5 48 */	lfd f1, lit_4083(r2)                     /* constant-address: 80455F48, symbol: lit_4083 */
...
/* 802CC888  48 00 00 08 */	b lbl_802CC890                           /* constant-address: 802CC890, symbol: lbl_802CC890 */
/* 802CC88C  48 00 01 3C */	b lbl_802CC9C8                           /* constant-address: 802CC9C8, symbol: lbl_802CC9C8 */
lbl_802CC890:
...
/* 802CC8A0  40 81 00 24 */	ble lbl_802CC8C4                         /* constant-address: 802CC8C4, symbol: lbl_802CC8C4 */
lbl_802CC8A4:
/* 802CC8A4  7D 2A 40 AE */	lbzx r9, r10, r8                        
/* 802CC8A8  7D 29 07 74 */	extsb r9, r9                            
/* 802CC8AC  7C 0B 48 00 */	cmpw r11, r9                            
/* 802CC8B0  40 82 00 0C */	bne lbl_802CC8BC                         /* constant-address: 802CC8BC, symbol: lbl_802CC8BC */
/* 802CC8B4  38 E0 00 01 */	li r7, 1                                
/* 802CC8B8  48 00 00 0C */	b lbl_802CC8C4                           /* constant-address: 802CC8C4, symbol: lbl_802CC8C4 */
lbl_802CC8BC:
/* 802CC8BC  39 08 00 02 */	addi r8, r8, 2                           /* constant-address: 00000002 */
/* 802CC8C0  42 00 FF E4 */	bdnz lbl_802CC8A4                        /* constant-address: 802CC8A4, symbol: lbl_802CC8A4 */
lbl_802CC8C4:
/* 802CC8C4  54 E7 06 3F */	clrlwi. r7, r7, 0x18                    
/* 802CC8C8  40 82 FE 90 */	bne lbl_802CC758                         /* constant-address: 802CC758, symbol: lbl_802CC758 */
/* 802CC8CC  A0 E3 03 FC */	lhz r7, 0x3fc(r3)                       
/* 802CC8D0  1D 07 00 0C */	mulli r8, r7, 0xc                       
/* 802CC8D4  3C E0 80 3A */	lis r7, sPrm__8Z2MdnPrm@ha              
/* 802CC8D8  38 E7 C9 8C */	addi r7, r7, sPrm__8Z2MdnPrm@l           /* constant-address: 8039C98C, symbol: sPrm__8Z2MdnPrm */
...
/* 802CC908  A0 E2 D1 AC */	lhz r7, lit_4104(r2)                     /* constant-address: 80456BAC, symbol: lit_4104 */
...
/* 802CC930  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
/* 802CC934  7C A0 07 74 */	extsb r0, r5                            
/* 802CC938  54 C7 06 3E */	clrlwi r7, r6, 0x18                     
/* 802CC93C  7C 00 38 00 */	cmpw r0, r7                             
/* 802CC940  41 82 00 0C */	beq lbl_802CC94C                         /* constant-address: 802CC94C, symbol: lbl_802CC94C */
/* 802CC944  2C 00 00 05 */	cmpwi r0, 5                             
/* 802CC948  40 82 FE 10 */	bne lbl_802CC758                         /* constant-address: 802CC758, symbol: lbl_802CC758 */
lbl_802CC94C:
...
/* 802CC960  40 80 00 08 */	bge lbl_802CC968                         /* constant-address: 802CC968, symbol: lbl_802CC968 */
/* 802CC964  7C E0 3B 78 */	mr r0, r7                               
lbl_802CC968:
/* 802CC968  38 80 00 00 */	li r4, 0                                
/* 802CC96C  7C 09 03 A6 */	mtctr r0                                
/* 802CC970  2C 00 00 00 */	cmpwi r0, 0                             
/* 802CC974  40 81 00 2C */	ble lbl_802CC9A0                         /* constant-address: 802CC9A0, symbol: lbl_802CC9A0 */
lbl_802CC978:
...
/* 802CC98C  40 80 00 0C */	bge lbl_802CC998                         /* constant-address: 802CC998, symbol: lbl_802CC998 */
/* 802CC990  7C A9 2B 78 */	mr r9, r5                               
/* 802CC994  89 06 00 00 */	lbz r8, 0(r6)                           
lbl_802CC998:
/* 802CC998  38 84 00 02 */	addi r4, r4, 2                          
/* 802CC99C  42 00 FF DC */	bdnz lbl_802CC978                        /* constant-address: 802CC978, symbol: lbl_802CC978 */
lbl_802CC9A0:
/* 802CC9A0  3C 80 80 3A */	lis r4, sPrm__8Z2MdnPrm@ha              
/* 802CC9A4  38 84 C9 8C */	addi r4, r4, sPrm__8Z2MdnPrm@l           /* constant-address: 8039C98C, symbol: sPrm__8Z2MdnPrm */

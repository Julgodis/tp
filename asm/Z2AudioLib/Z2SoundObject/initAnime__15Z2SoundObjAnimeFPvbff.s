...
/* 802BEC1C  48 0A 35 C1 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802BEC34  48 00 01 35 */	bl ageSounds___15Z2SoundObjAnimeFv       /* constant-address: 802BED68, symbol: ageSounds___15Z2SoundObjAnimeFv */
/* 802BEC38  93 BF 00 20 */	stw r29, 0x20(r31)                      
/* 802BEC3C  80 1F 00 20 */	lwz r0, 0x20(r31)                       
/* 802BEC40  28 00 00 00 */	cmplwi r0, 0                            
/* 802BEC44  41 82 00 FC */	beq lbl_802BED40                         /* constant-address: 802BED40, symbol: lbl_802BED40 */
...
/* 802BEC68  41 82 00 70 */	beq lbl_802BECD8                         /* constant-address: 802BECD8, symbol: lbl_802BECD8 */
/* 802BEC6C  80 9F 00 20 */	lwz r4, 0x20(r31)                       
/* 802BEC70  80 64 00 04 */	lwz r3, 4(r4)                           
/* 802BEC74  28 03 00 00 */	cmplwi r3, 0                            
/* 802BEC78  41 82 00 18 */	beq lbl_802BEC90                         /* constant-address: 802BEC90, symbol: lbl_802BEC90 */
...
/* 802BEC8C  48 00 00 08 */	b lbl_802BEC94                           /* constant-address: 802BEC94, symbol: lbl_802BEC94 */
lbl_802BEC90:
...
/* 802BECA4  C0 03 0A E8 */	lfs f0, __float_max@l(r3)                /* constant-address: 80450AE8, symbol: __float_max */
/* 802BECA8  D0 1F 00 28 */	stfs f0, 0x28(r31)                      
/* 802BECAC  C0 22 C1 50 */	lfs f1, lit_3821(r2)                     /* constant-address: 80455B50, symbol: lit_3821 */
/* 802BECB0  D0 3F 00 2C */	stfs f1, 0x2c(r31)                      
/* 802BECB4  80 7F 00 20 */	lwz r3, 0x20(r31)                       
/* 802BECB8  4B FE 82 B9 */	bl getStartSoundIndex__17JAUSoundAnimationCFf /* constant-address: 802A6F70, symbol: getStartSoundIndex__17JAUSoundAnimationCFf */
...
/* 802BECCC  4B FE 83 79 */	bl getEndSoundIndex__17JAUSoundAnimationCFf /* constant-address: 802A7044, symbol: getEndSoundIndex__17JAUSoundAnimationCFf */
/* 802BECD0  90 7F 00 38 */	stw r3, 0x38(r31)                       
/* 802BECD4  48 00 00 38 */	b lbl_802BED0C                           /* constant-address: 802BED0C, symbol: lbl_802BED0C */
lbl_802BECD8:
/* 802BECD8  90 7F 00 40 */	stw r3, 0x40(r31)                       
/* 802BECDC  C0 02 C1 50 */	lfs f0, lit_3821(r2)                     /* constant-address: 80455B50, symbol: lit_3821 */
...
/* 802BECF0  4B FE 82 81 */	bl getStartSoundIndex__17JAUSoundAnimationCFf /* constant-address: 802A6F70, symbol: getStartSoundIndex__17JAUSoundAnimationCFf */
/* 802BECF4  90 7F 00 34 */	stw r3, 0x34(r31)                       
/* 802BECF8  C0 22 C1 50 */	lfs f1, lit_3821(r2)                     /* constant-address: 80455B50, symbol: lit_3821 */
/* 802BECFC  D0 3F 00 30 */	stfs f1, 0x30(r31)                      
/* 802BED00  80 7F 00 20 */	lwz r3, 0x20(r31)                       
/* 802BED04  4B FE 83 41 */	bl getEndSoundIndex__17JAUSoundAnimationCFf /* constant-address: 802A7044, symbol: getEndSoundIndex__17JAUSoundAnimationCFf */
...
/* 802BED18  4B FE 82 59 */	bl getStartSoundIndex__17JAUSoundAnimationCFf /* constant-address: 802A6F70, symbol: getStartSoundIndex__17JAUSoundAnimationCFf */
/* 802BED1C  90 7F 00 40 */	stw r3, 0x40(r31)                       
/* 802BED20  88 1F 00 44 */	lbz r0, 0x44(r31)                       
/* 802BED24  28 00 00 00 */	cmplwi r0, 0                            
/* 802BED28  41 82 00 18 */	beq lbl_802BED40                         /* constant-address: 802BED40, symbol: lbl_802BED40 */
/* 802BED2C  80 7F 00 40 */	lwz r3, 0x40(r31)                       
/* 802BED30  2C 03 00 00 */	cmpwi r3, 0                             
/* 802BED34  40 81 00 0C */	ble lbl_802BED40                         /* constant-address: 802BED40, symbol: lbl_802BED40 */
...
/* 802BED54  48 0A 34 D5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

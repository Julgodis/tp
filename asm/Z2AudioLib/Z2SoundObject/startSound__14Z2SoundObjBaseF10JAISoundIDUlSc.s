...
/* 802BE15C  48 0A 40 7D */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
...
/* 802BE178  40 82 00 0C */	bne lbl_802BE184                         /* constant-address: 802BE184, symbol: lbl_802BE184 */
/* 802BE17C  38 60 00 00 */	li r3, 0                                
/* 802BE180  48 00 01 34 */	b lbl_802BE2B4                           /* constant-address: 802BE2B4, symbol: lbl_802BE2B4 */
lbl_802BE184:
/* 802BE184  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 802BE188  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 802BE18C  80 6D 86 08 */	lwz r3, data_80450B88(r13)               /* constant-address: 80450B88, symbol: data_80450B88 */
/* 802BE190  38 81 00 18 */	addi r4, r1, 0x18                       
/* 802BE194  4B FF 04 1D */	bl isSoundCulling__7Z2SeMgrF10JAISoundID /* constant-address: 802AE5B0, symbol: isSoundCulling__7Z2SeMgrF10JAISoundID */
/* 802BE198  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802BE19C  41 82 00 0C */	beq lbl_802BE1A8                         /* constant-address: 802BE1A8, symbol: lbl_802BE1A8 */
/* 802BE1A0  38 60 00 00 */	li r3, 0                                
/* 802BE1A4  48 00 01 10 */	b lbl_802BE2B4                           /* constant-address: 802BE2B4, symbol: lbl_802BE2B4 */
lbl_802BE1A8:
/* 802BE1A8  28 1F 00 00 */	cmplwi r31, 0                           
/* 802BE1AC  40 82 00 08 */	bne lbl_802BE1B4                         /* constant-address: 802BE1B4, symbol: lbl_802BE1B4 */
/* 802BE1B0  A3 FD 00 1C */	lhz r31, 0x1c(r29)                      
lbl_802BE1B4:
/* 802BE1B4  7F 80 07 75 */	extsb. r0, r28                          
/* 802BE1B8  40 80 00 08 */	bge lbl_802BE1C0                         /* constant-address: 802BE1C0, symbol: lbl_802BE1C0 */
/* 802BE1BC  8B 9D 00 1E */	lbz r28, 0x1e(r29)                      
lbl_802BE1C0:
/* 802BE1C0  7F 80 07 74 */	extsb r0, r28                           
/* 802BE1C4  C8 22 C1 48 */	lfd f1, lit_3564(r2)                     /* constant-address: 80455B48, symbol: lit_3564 */
...
/* 802BE1E0  C0 02 C1 38 */	lfs f0, lit_3559(r2)                     /* constant-address: 80455B38, symbol: lit_3559 */
...
/* 802BE1F8  4B FE D0 5D */	bl getHandleSoundID__14Z2SoundHandlesF10JAISoundID /* constant-address: 802AB254, symbol: getHandleSoundID__14Z2SoundHandlesF10JAISoundID */
/* 802BE1FC  7C 7C 1B 79 */	or. r28, r3, r3                         
/* 802BE200  41 82 00 30 */	beq lbl_802BE230                         /* constant-address: 802BE230, symbol: lbl_802BE230 */
/* 802BE204  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 802BE208  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 802BE20C  80 6D 85 CC */	lwz r3, data_80450B4C(r13)               /* constant-address: 80450B4C, symbol: data_80450B4C */
/* 802BE210  38 81 00 10 */	addi r4, r1, 0x10                       
/* 802BE214  4B FF D8 B5 */	bl getSwBit__11Z2SoundInfoCF10JAISoundID /* constant-address: 802BBAC8, symbol: getSwBit__11Z2SoundInfoCF10JAISoundID */
/* 802BE218  54 60 04 63 */	rlwinm. r0, r3, 0, 0x11, 0x11           
/* 802BE21C  41 82 00 0C */	beq lbl_802BE228                         /* constant-address: 802BE228, symbol: lbl_802BE228 */
/* 802BE220  3B 80 00 00 */	li r28, 0                               
/* 802BE224  48 00 00 0C */	b lbl_802BE230                           /* constant-address: 802BE230, symbol: lbl_802BE230 */
lbl_802BE228:
/* 802BE228  38 60 00 00 */	li r3, 0                                
/* 802BE22C  48 00 00 88 */	b lbl_802BE2B4                           /* constant-address: 802BE2B4, symbol: lbl_802BE2B4 */
lbl_802BE230:
/* 802BE230  28 1C 00 00 */	cmplwi r28, 0                           
/* 802BE234  40 82 00 10 */	bne lbl_802BE244                         /* constant-address: 802BE244, symbol: lbl_802BE244 */
/* 802BE238  7F A3 EB 78 */	mr r3, r29                              
/* 802BE23C  4B FE D0 9D */	bl getFreeHandle__14Z2SoundHandlesFv     /* constant-address: 802AB2D8, symbol: getFreeHandle__14Z2SoundHandlesFv */
/* 802BE240  7C 7C 1B 78 */	mr r28, r3                              
lbl_802BE244:
/* 802BE244  28 1C 00 00 */	cmplwi r28, 0                           
/* 802BE248  40 82 00 1C */	bne lbl_802BE264                         /* constant-address: 802BE264, symbol: lbl_802BE264 */
...
/* 802BE25C  4B FE D1 75 */	bl getLowPrioSound__14Z2SoundHandlesF10JAISoundID /* constant-address: 802AB3D0, symbol: getLowPrioSound__14Z2SoundHandlesF10JAISoundID */
/* 802BE260  7C 7C 1B 78 */	mr r28, r3                              
lbl_802BE264:
/* 802BE264  28 1C 00 00 */	cmplwi r28, 0                           
/* 802BE268  41 82 00 48 */	beq lbl_802BE2B0                         /* constant-address: 802BE2B0, symbol: lbl_802BE2B0 */
...
/* 802BE28C  C0 42 C1 3C */	lfs f2, lit_3560(r2)                     /* constant-address: 80455B3C, symbol: lit_3560 */
/* 802BE290  FC 60 10 90 */	fmr f3, f2                              
/* 802BE294  C0 82 C1 40 */	lfs f4, lit_3561(r2)                     /* constant-address: 80455B40, symbol: lit_3561 */
...
/* 802BE2C0  48 0A 3F 65 */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

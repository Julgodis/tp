...
/* 802B5F1C 002B2E5C  90 6D 85 FC */	stw r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802B5FD4 002B2F14  80 AD 86 04 */	lwz r5, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B6010 002B2F50  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B6050 002B2F90  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B6090 002B2FD0  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B60E4 002B3024  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
/* 802B60E8 002B3028  4B FF CB BD */	bl talkInBgm__8Z2SeqMgrFv
/* 802B60EC 002B302C  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B611C 002B305C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
/* 802B6120 002B3060  4B FF CC 45 */	bl talkOutBgm__8Z2SeqMgrFv
/* 802B6124 002B3064  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B6150 002B3090  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
/* 802B6154 002B3094  4B FF CC 59 */	bl menuInBgm__8Z2SeqMgrFv
/* 802B6158 002B3098  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B6190 002B30D0  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
/* 802B6194 002B30D4  4B FF CC 61 */	bl menuOutBgm__8Z2SeqMgrFv
/* 802B6198 002B30D8  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802B6218 002B3158  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802B6240 002B3180  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B625C 002B319C  80 8D 86 04 */	lwz r4, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B62D8 002B3218  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B62EC 002B322C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B63CC 002B330C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B6434 002B3374  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802B6474 002B33B4  80 6D 86 08 */	lwz r3, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
lbl_802B657C:
/* 802B657C 002B34BC  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802B65CC 002B350C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B65FC 002B353C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B660C 002B354C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B66D8 002B3618  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802B67B8 002B36F8  80 6D 85 C0 */	lwz r3, "sInstance__32JASGlobalInstance<11Z2FxLineMgr>"-_SDA_BASE_(r13)
...
lbl_802B6814:
/* 802B6814 002B3754  80 6D 85 C0 */	lwz r3, "sInstance__32JASGlobalInstance<11Z2FxLineMgr>"-_SDA_BASE_(r13)
...
.section .rodata, "a"
/* 8039BC88 0319 .rodata lbl_8039BC88 @stringBase0 */
.global lbl_8039BC88
lbl_8039BC88:
...
.section .data, "aw"
/* 803CA508 00B8 .data lbl_803CA508 @3732 */
.global lbl_803CA508
lbl_803CA508:

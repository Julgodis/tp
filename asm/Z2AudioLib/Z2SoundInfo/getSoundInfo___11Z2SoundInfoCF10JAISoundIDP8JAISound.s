...
/* 802BBB58  48 0A 66 85 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802BBB6C  80 6D 85 D8 */	lwz r3, data_80450B58(r13)               /* constant-address: 80450B58, symbol: data_80450B58 */
/* 802BBB70  38 81 00 0C */	addi r4, r1, 0xc                        
/* 802BBB74  4B FE B7 19 */	bl getData__13JAUSoundTableCF10JAISoundID /* constant-address: 802A728C, symbol: getData__13JAUSoundTableCF10JAISoundID */
/* 802BBB78  7C 7F 1B 78 */	mr r31, r3                              
/* 802BBB7C  80 1D 00 00 */	lwz r0, 0(r29)                          
/* 802BBB80  90 01 00 08 */	stw r0, 8(r1)                           
/* 802BBB84  80 6D 85 D8 */	lwz r3, data_80450B58(r13)               /* constant-address: 80450B58, symbol: data_80450B58 */
/* 802BBB88  38 81 00 08 */	addi r4, r1, 8                          
/* 802BBB8C  4B FE B5 D5 */	bl getTypeID__13JAUSoundTableCF10JAISoundID /* constant-address: 802A7160, symbol: getTypeID__13JAUSoundTableCF10JAISoundID */
/* 802BBB90  28 1F 00 00 */	cmplwi r31, 0                           
/* 802BBB94  41 82 00 34 */	beq lbl_802BBBC8                         /* constant-address: 802BBBC8, symbol: lbl_802BBBC8 */
/* 802BBB98  54 60 06 73 */	rlwinm. r0, r3, 0, 0x19, 0x19           
/* 802BBB9C  41 82 00 2C */	beq lbl_802BBBC8                         /* constant-address: 802BBBC8, symbol: lbl_802BBBC8 */
/* 802BBBA0  C0 42 C0 98 */	lfs f2, lit_1070(r2)                     /* constant-address: 80455A98, symbol: lit_1070 */
/* 802BBBA4  88 1F 00 01 */	lbz r0, 1(r31)                          
/* 802BBBA8  C8 22 C0 88 */	lfd f1, lit_973(r2)                      /* constant-address: 80455A88, symbol: lit_973 */
...
/* 802BBBCC  48 0A 66 5D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

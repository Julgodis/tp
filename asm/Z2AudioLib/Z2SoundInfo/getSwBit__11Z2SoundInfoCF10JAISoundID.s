...
/* 802BBAE8  80 6D 85 D8 */	lwz r3, data_80450B58(r13)               /* constant-address: 80450B58, symbol: data_80450B58 */
/* 802BBAEC  38 81 00 0C */	addi r4, r1, 0xc                        
/* 802BBAF0  4B FE B7 9D */	bl getData__13JAUSoundTableCF10JAISoundID /* constant-address: 802A728C, symbol: getData__13JAUSoundTableCF10JAISoundID */
/* 802BBAF4  7C 7F 1B 78 */	mr r31, r3                              
/* 802BBAF8  80 1E 00 00 */	lwz r0, 0(r30)                          
/* 802BBAFC  90 01 00 08 */	stw r0, 8(r1)                           
/* 802BBB00  80 6D 85 D8 */	lwz r3, data_80450B58(r13)               /* constant-address: 80450B58, symbol: data_80450B58 */
/* 802BBB04  38 81 00 08 */	addi r4, r1, 8                          
/* 802BBB08  4B FE B6 59 */	bl getTypeID__13JAUSoundTableCF10JAISoundID /* constant-address: 802A7160, symbol: getTypeID__13JAUSoundTableCF10JAISoundID */
/* 802BBB0C  28 1F 00 00 */	cmplwi r31, 0                           
/* 802BBB10  41 82 00 1C */	beq lbl_802BBB2C                         /* constant-address: 802BBB2C, symbol: lbl_802BBB2C */
/* 802BBB14  54 60 06 3E */	clrlwi r0, r3, 0x18                     
/* 802BBB18  2C 00 00 51 */	cmpwi r0, 0x51                          
/* 802BBB1C  41 82 00 08 */	beq lbl_802BBB24                         /* constant-address: 802BBB24, symbol: lbl_802BBB24 */
/* 802BBB20  48 00 00 0C */	b lbl_802BBB2C                           /* constant-address: 802BBB2C, symbol: lbl_802BBB2C */
lbl_802BBB24:
/* 802BBB24  80 7F 00 04 */	lwz r3, 4(r31)                          
/* 802BBB28  48 00 00 08 */	b lbl_802BBB30                           /* constant-address: 802BBB30, symbol: lbl_802BBB30 */
lbl_802BBB2C:

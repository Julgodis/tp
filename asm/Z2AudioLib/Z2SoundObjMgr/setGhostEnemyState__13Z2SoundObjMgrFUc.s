...
/* 802C0010  40 82 00 24 */	bne lbl_802C0034                         /* constant-address: 802C0034, symbol: lbl_802C0034 */
/* 802C0014  88 7E 00 1A */	lbz r3, 0x1a(r30)                       
/* 802C0018  88 1E 00 16 */	lbz r0, 0x16(r30)                       
/* 802C001C  7C 03 00 40 */	cmplw r3, r0                            
/* 802C0020  41 80 00 2C */	blt lbl_802C004C                         /* constant-address: 802C004C, symbol: lbl_802C004C */
/* 802C0024  80 6D 86 04 */	lwz r3, data_80450B84(r13)               /* constant-address: 80450B84, symbol: data_80450B84 */
/* 802C0028  38 80 00 01 */	li r4, 1                                
/* 802C002C  4B FF 43 B5 */	bl setBattleGhostMute__8Z2SeqMgrFb       /* constant-address: 802B43E0, symbol: setBattleGhostMute__8Z2SeqMgrFb */
/* 802C0030  48 00 00 1C */	b lbl_802C004C                           /* constant-address: 802C004C, symbol: lbl_802C004C */
lbl_802C0034:
/* 802C0034  88 1E 00 1A */	lbz r0, 0x1a(r30)                       
/* 802C0038  28 00 00 00 */	cmplwi r0, 0                            
/* 802C003C  40 82 00 10 */	bne lbl_802C004C                         /* constant-address: 802C004C, symbol: lbl_802C004C */
/* 802C0040  38 00 00 00 */	li r0, 0                                
/* 802C0044  98 1E 00 19 */	stb r0, 0x19(r30)                       
/* 802C0048  48 00 00 14 */	b lbl_802C005C                           /* constant-address: 802C005C, symbol: lbl_802C005C */
lbl_802C004C:

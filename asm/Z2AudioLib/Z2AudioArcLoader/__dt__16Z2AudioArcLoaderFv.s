...
/* 802A9B74  41 82 00 38 */	beq lbl_802A9BAC                         /* constant-address: 802A9BAC, symbol: lbl_802A9BAC */
/* 802A9B78  3C 80 80 3D */	lis r4, __vt__16Z2AudioArcLoader@ha     
/* 802A9B7C  38 04 9C D0 */	addi r0, r4, __vt__16Z2AudioArcLoader@l  /* constant-address: 803C9CD0, symbol: __vt__16Z2AudioArcLoader */
/* 802A9B80  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802A9B84  41 82 00 18 */	beq lbl_802A9B9C                         /* constant-address: 802A9B9C, symbol: lbl_802A9B9C */
/* 802A9B88  3C 80 80 3D */	lis r4, __vt__17JAUAudioArcLoader@ha    
/* 802A9B8C  38 04 9A 78 */	addi r0, r4, __vt__17JAUAudioArcLoader@l /* constant-address: 803C9A78, symbol: __vt__17JAUAudioArcLoader */
/* 802A9B90  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802A9B94  38 80 00 00 */	li r4, 0                                
/* 802A9B98  4B FF A6 C9 */	bl __dt__22JAUAudioArcInterpreterFv      /* constant-address: 802A4260, symbol: __dt__22JAUAudioArcInterpreterFv */
lbl_802A9B9C:
/* 802A9B9C  7F E0 07 35 */	extsh. r0, r31                          
/* 802A9BA0  40 81 00 0C */	ble lbl_802A9BAC                         /* constant-address: 802A9BAC, symbol: lbl_802A9BAC */
/* 802A9BA4  7F C3 F3 78 */	mr r3, r30                              
/* 802A9BA8  48 02 51 95 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802A9BAC:

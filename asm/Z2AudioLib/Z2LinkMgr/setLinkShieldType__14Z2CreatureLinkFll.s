...
/* 802C32B0  41 82 00 2C */	beq lbl_802C32DC                         /* constant-address: 802C32DC, symbol: lbl_802C32DC */
/* 802C32B4  88 03 00 C7 */	lbz r0, 0xc7(r3)                        
/* 802C32B8  28 00 00 00 */	cmplwi r0, 0                            
/* 802C32BC  41 82 00 20 */	beq lbl_802C32DC                         /* constant-address: 802C32DC, symbol: lbl_802C32DC */
/* 802C32C0  88 83 00 CB */	lbz r4, 0xcb(r3)                        
/* 802C32C4  54 80 EF FF */	rlwinm. r0, r4, 0x1d, 0x1f, 0x1f        
/* 802C32C8  40 82 00 14 */	bne lbl_802C32DC                         /* constant-address: 802C32DC, symbol: lbl_802C32DC */

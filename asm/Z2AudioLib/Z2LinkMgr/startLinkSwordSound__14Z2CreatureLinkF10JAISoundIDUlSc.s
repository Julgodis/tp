...
/* 802C4704  38 04 00 44 */	addi r0, r4, 0x0044 /* 0x00020044@l */   /* constant-address: 00020044 */
/* 802C4708  7C 07 00 00 */	cmpw r7, r0                             
/* 802C470C  41 82 00 34 */	beq lbl_802C4740                         /* constant-address: 802C4740, symbol: lbl_802C4740 */
/* 802C4710  40 80 00 4C */	bge lbl_802C475C                         /* constant-address: 802C475C, symbol: lbl_802C475C */
/* 802C4714  38 04 00 25 */	addi r0, r4, 0x25                        /* constant-address: 00020025 */
/* 802C4718  7C 07 00 00 */	cmpw r7, r0                             
/* 802C471C  41 82 00 08 */	beq lbl_802C4724                         /* constant-address: 802C4724, symbol: lbl_802C4724 */
/* 802C4720  48 00 00 3C */	b lbl_802C475C                           /* constant-address: 802C475C, symbol: lbl_802C475C */
lbl_802C4724:
...
/* 802C473C  48 00 00 38 */	b lbl_802C4774                           /* constant-address: 802C4774, symbol: lbl_802C4774 */
lbl_802C4740:
...
/* 802C4758  48 00 00 1C */	b lbl_802C4774                           /* constant-address: 802C4774, symbol: lbl_802C4774 */
lbl_802C475C:

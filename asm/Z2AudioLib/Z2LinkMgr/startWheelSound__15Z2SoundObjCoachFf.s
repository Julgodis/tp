...
/* 802C5544 00000014  C0 02 C3 20 */	lfs f0, lit_4621(r2)
/* 802C5548 0000002C  FC 1F 00 40 */	fcmpo cr0, f31, f0
/* 802C554C 00000000  41 80 01 4C */	blt lbl_802C5698
/* 802C5550 00000004  C0 02 C3 24 */	lfs f0, lit_4622(r2)
...
/* 802C55A0 00000048  C0 62 C3 24 */	lfs f3, lit_4622(r2)
/* 802C55A4 0000004C  C0 82 C3 08 */	lfs f4, lit_3949(r2)
/* 802C55A8 00000050  C0 A2 C3 28 */	lfs f5, lit_4623(r2)
/* 802C55AC 00000054  C0 C2 C3 2C */	lfs f6, lit_4624(r2)
...
/* 802C55D0 00000078  C0 62 C3 24 */	lfs f3, lit_4622(r2)
/* 802C55D4 0000007C  C0 82 C2 EC */	lfs f4, lit_3942(r2)
/* 802C55D8 00000080  C0 A2 C2 D0 */	lfs f5, lit_3837(r2)
/* 802C55DC 00000084  C0 C2 C2 98 */	lfs f6, lit_3721(r2)
...
/* 802C563C 00000040  C0 42 C3 24 */	lfs f2, lit_4622(r2)
/* 802C5640 00000044  C0 62 C3 30 */	lfs f3, lit_4625(r2)
/* 802C5644 00000048  C0 82 C3 08 */	lfs f4, lit_3949(r2)
/* 802C5648 0000004C  C0 A2 C3 28 */	lfs f5, lit_4623(r2)
/* 802C564C 00000050  C0 C2 C3 2C */	lfs f6, lit_4624(r2)
...
/* 802C566C 00000070  C0 42 C3 24 */	lfs f2, lit_4622(r2)
/* 802C5670 00000074  C0 62 C3 30 */	lfs f3, lit_4625(r2)
/* 802C5674 00000078  C0 82 C2 EC */	lfs f4, lit_3942(r2)
/* 802C5678 0000007C  C0 A2 C2 F0 */	lfs f5, lit_3943(r2)
/* 802C567C 00000080  C0 C2 C2 98 */	lfs f6, lit_3721(r2)

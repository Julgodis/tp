...
/* 802C0C88  41 82 00 40 */	beq lbl_802C0CC8                         /* constant-address: 802C0CC8, symbol: lbl_802C0CC8 */
/* 802C0C8C  3C 60 80 3D */	lis r3, __vt__17Z2CreatureCitizen@ha    
/* 802C0C90  38 03 B8 90 */	addi r0, r3, __vt__17Z2CreatureCitizen@l /* constant-address: 803CB890, symbol: __vt__17Z2CreatureCitizen */
/* 802C0C94  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802C0C98  34 1E 00 90 */	addic. r0, r30, 0x90                    
/* 802C0C9C  41 82 00 10 */	beq lbl_802C0CAC                         /* constant-address: 802C0CAC, symbol: lbl_802C0CAC */
/* 802C0CA0  38 7E 00 90 */	addi r3, r30, 0x90                      
/* 802C0CA4  38 80 00 00 */	li r4, 0                                
/* 802C0CA8  48 01 B1 6D */	bl __dt__10JSUPtrLinkFv                  /* constant-address: 802DBE14, symbol: __dt__10JSUPtrLinkFv */
lbl_802C0CAC:
/* 802C0CAC  7F C3 F3 78 */	mr r3, r30                              
/* 802C0CB0  38 80 00 00 */	li r4, 0                                
/* 802C0CB4  4B FF F7 6D */	bl __dt__10Z2CreatureFv                  /* constant-address: 802C0420, symbol: __dt__10Z2CreatureFv */
/* 802C0CB8  7F E0 07 35 */	extsh. r0, r31                          
/* 802C0CBC  40 81 00 0C */	ble lbl_802C0CC8                         /* constant-address: 802C0CC8, symbol: lbl_802C0CC8 */
/* 802C0CC0  7F C3 F3 78 */	mr r3, r30                              
/* 802C0CC4  48 00 E0 79 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802C0CC8:

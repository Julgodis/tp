...
/* 802C21A8  41 82 00 7C */	beq lbl_802C2224                         /* constant-address: 802C2224, symbol: lbl_802C2224 */
/* 802C21AC  40 80 00 14 */	bge lbl_802C21C0                         /* constant-address: 802C21C0, symbol: lbl_802C21C0 */
/* 802C21B0  2C 00 00 00 */	cmpwi r0, 0                             
/* 802C21B4  41 82 00 18 */	beq lbl_802C21CC                         /* constant-address: 802C21CC, symbol: lbl_802C21CC */
/* 802C21B8  40 80 00 40 */	bge lbl_802C21F8                         /* constant-address: 802C21F8, symbol: lbl_802C21F8 */
/* 802C21BC  48 00 00 C0 */	b lbl_802C227C                           /* constant-address: 802C227C, symbol: lbl_802C227C */
lbl_802C21C0:
/* 802C21C0  2C 00 00 04 */	cmpwi r0, 4                             
/* 802C21C4  40 80 00 B8 */	bge lbl_802C227C                         /* constant-address: 802C227C, symbol: lbl_802C227C */
/* 802C21C8  48 00 00 88 */	b lbl_802C2250                           /* constant-address: 802C2250, symbol: lbl_802C2250 */
lbl_802C21CC:
...
/* 802C21F4  48 00 00 8C */	b lbl_802C2280                           /* constant-address: 802C2280, symbol: lbl_802C2280 */
lbl_802C21F8:
...
/* 802C2220  48 00 00 60 */	b lbl_802C2280                           /* constant-address: 802C2280, symbol: lbl_802C2280 */
lbl_802C2224:
...
/* 802C224C  48 00 00 34 */	b lbl_802C2280                           /* constant-address: 802C2280, symbol: lbl_802C2280 */
lbl_802C2250:
...
/* 802C2278  48 00 00 08 */	b lbl_802C2280                           /* constant-address: 802C2280, symbol: lbl_802C2280 */
lbl_802C227C:

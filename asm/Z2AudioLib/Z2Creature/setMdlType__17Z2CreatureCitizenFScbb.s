...
/* 802C0DA4  40 82 00 0C */	bne lbl_802C0DB0                         /* constant-address: 802C0DB0, symbol: lbl_802C0DB0 */
/* 802C0DA8  80 6D 86 08 */	lwz r3, data_80450B88(r13)               /* constant-address: 80450B88, symbol: data_80450B88 */
/* 802C0DAC  4B FE AB 91 */	bl incrCrowdSize__7Z2SeMgrFv             /* constant-address: 802AB93C, symbol: incrCrowdSize__7Z2SeMgrFv */
lbl_802C0DB0:
/* 802C0DB0  7F C0 07 75 */	extsb. r0, r30                          
/* 802C0DB4  40 82 00 24 */	bne lbl_802C0DD8                         /* constant-address: 802C0DD8, symbol: lbl_802C0DD8 */
/* 802C0DB8  88 0D 8D D8 */	lbz r0, struct_80451358+0x0(r13)         /* constant-address: 80451358, symbol: struct_80451358+0x0 */
/* 802C0DBC  98 1F 00 A1 */	stb r0, 0xa1(r31)                       
/* 802C0DC0  88 0D 8D D8 */	lbz r0, struct_80451358+0x0(r13)         /* constant-address: 80451358, symbol: struct_80451358+0x0 */
/* 802C0DC4  7C 00 07 74 */	extsb r0, r0                            
/* 802C0DC8  7C 00 00 34 */	cntlzw r0, r0                           
/* 802C0DCC  54 00 D9 7E */	srwi r0, r0, 5                          
/* 802C0DD0  98 0D 8D D8 */	stb r0, struct_80451358+0x0(r13)         /* constant-address: 80451358, symbol: struct_80451358+0x0 */
/* 802C0DD4  48 00 00 2C */	b lbl_802C0E00                           /* constant-address: 802C0E00, symbol: lbl_802C0E00 */
lbl_802C0DD8:
/* 802C0DD8  7F C0 07 74 */	extsb r0, r30                           
/* 802C0DDC  2C 00 00 01 */	cmpwi r0, 1                             
/* 802C0DE0  40 82 00 20 */	bne lbl_802C0E00                         /* constant-address: 802C0E00, symbol: lbl_802C0E00 */
/* 802C0DE4  88 0D 8D D9 */	lbz r0, struct_80451358+0x1(r13)         /* constant-address: 80451359, symbol: struct_80451358+0x1 */
/* 802C0DE8  98 1F 00 A1 */	stb r0, 0xa1(r31)                       
/* 802C0DEC  88 0D 8D D9 */	lbz r0, struct_80451358+0x1(r13)         /* constant-address: 80451359, symbol: struct_80451358+0x1 */
/* 802C0DF0  7C 00 07 74 */	extsb r0, r0                            
/* 802C0DF4  7C 00 00 34 */	cntlzw r0, r0                           
/* 802C0DF8  54 00 D9 7E */	srwi r0, r0, 5                          
/* 802C0DFC  98 0D 8D D9 */	stb r0, struct_80451358+0x1(r13)         /* constant-address: 80451359, symbol: struct_80451358+0x1 */
lbl_802C0E00:

...
/* 802C0E50  40 80 00 20 */	bge lbl_802C0E70                         /* constant-address: 802C0E70, symbol: lbl_802C0E70 */
/* 802C0E54  2C 04 00 00 */	cmpwi r4, 0                             
/* 802C0E58  40 80 00 08 */	bge lbl_802C0E60                         /* constant-address: 802C0E60, symbol: lbl_802C0E60 */
/* 802C0E5C  48 00 00 14 */	b lbl_802C0E70                           /* constant-address: 802C0E70, symbol: lbl_802C0E70 */
lbl_802C0E60:
/* 802C0E60  88 1E 00 A1 */	lbz r0, 0xa1(r30)                       
/* 802C0E64  2C 00 00 01 */	cmpwi r0, 1                             
/* 802C0E68  40 82 00 08 */	bne lbl_802C0E70                         /* constant-address: 802C0E70, symbol: lbl_802C0E70 */
...
/* 802C0E98  41 82 00 0C */	beq lbl_802C0EA4                         /* constant-address: 802C0EA4, symbol: lbl_802C0EA4 */
/* 802C0E9C  2C 1F 00 02 */	cmpwi r31, 2                            
/* 802C0EA0  40 82 00 20 */	bne lbl_802C0EC0                         /* constant-address: 802C0EC0, symbol: lbl_802C0EC0 */
lbl_802C0EA4:
/* 802C0EA4  88 1E 00 A2 */	lbz r0, 0xa2(r30)                       
/* 802C0EA8  28 00 00 00 */	cmplwi r0, 0                            
/* 802C0EAC  40 82 00 14 */	bne lbl_802C0EC0                         /* constant-address: 802C0EC0, symbol: lbl_802C0EC0 */
/* 802C0EB0  80 6D 86 08 */	lwz r3, data_80450B88(r13)               /* constant-address: 80450B88, symbol: data_80450B88 */
/* 802C0EB4  4B FE AA AD */	bl decrCrowdSize__7Z2SeMgrFv             /* constant-address: 802AB960, symbol: decrCrowdSize__7Z2SeMgrFv */

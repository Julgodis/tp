...
/* 802C0FE0  40 82 00 5C */	bne lbl_802C103C                         /* constant-address: 802C103C, symbol: lbl_802C103C */
/* 802C0FE4  80 6D 86 04 */	lwz r3, data_80450B84(r13)               /* constant-address: 80450B84, symbol: data_80450B84 */
/* 802C0FE8  C0 62 C2 20 */	lfs f3, lit_3669(r2)                     /* constant-address: 80455C20, symbol: lit_3669 */
/* 802C0FEC  D0 63 00 34 */	stfs f3, 0x34(r3)                       
/* 802C0FF0  C0 02 C2 34 */	lfs f0, lit_3717(r2)                     /* constant-address: 80455C34, symbol: lit_3717 */
...
/* 802C1018  C8 22 C2 28 */	lfd f1, lit_3672(r2)                     /* constant-address: 80455C28, symbol: lit_3672 */
...
/* 802C1044  41 82 00 1C */	beq lbl_802C1060                         /* constant-address: 802C1060, symbol: lbl_802C1060 */
/* 802C1048  7F E4 FB 78 */	mr r4, r31                              
/* 802C104C  28 1F 00 00 */	cmplwi r31, 0                           
/* 802C1050  41 82 00 08 */	beq lbl_802C1058                         /* constant-address: 802C1058, symbol: lbl_802C1058 */
/* 802C1054  38 9F 00 90 */	addi r4, r31, 0x90                      
lbl_802C1058:
/* 802C1058  80 6D 85 C8 */	lwz r3, data_80450B48(r13)               /* constant-address: 80450B48, symbol: data_80450B48 */
/* 802C105C  4B FF F1 35 */	bl func_802C0190                         /* constant-address: 802C0190, symbol: func_802C0190 */
lbl_802C1060:
/* 802C1060  38 00 00 00 */	li r0, 0                                
/* 802C1064  90 1F 00 28 */	stw r0, 0x28(r31)                       
/* 802C1068  38 7F 00 08 */	addi r3, r31, 8                         
/* 802C106C  4B FF CF 8D */	bl deleteObject__14Z2SoundObjBaseFv      /* constant-address: 802BDFF8, symbol: deleteObject__14Z2SoundObjBaseFv */
/* 802C1070  38 7F 00 50 */	addi r3, r31, 0x50                      
/* 802C1074  4B FF CF 85 */	bl deleteObject__14Z2SoundObjBaseFv      /* constant-address: 802BDFF8, symbol: deleteObject__14Z2SoundObjBaseFv */
/* 802C1078  38 7F 00 70 */	addi r3, r31, 0x70                      
/* 802C107C  4B FF CF 7D */	bl deleteObject__14Z2SoundObjBaseFv      /* constant-address: 802BDFF8, symbol: deleteObject__14Z2SoundObjBaseFv */

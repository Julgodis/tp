...
/* 802C2D30  41 82 00 88 */	beq lbl_802C2DB8                         /* constant-address: 802C2DB8, symbol: lbl_802C2DB8 */
/* 802C2D34  80 1F 00 00 */	lwz r0, 0(r31)                          
/* 802C2D38  28 00 00 00 */	cmplwi r0, 0                            
/* 802C2D3C  41 82 00 7C */	beq lbl_802C2DB8                         /* constant-address: 802C2DB8, symbol: lbl_802C2DB8 */
/* 802C2D40  FC 20 F0 90 */	fmr f1, f30                             
/* 802C2D44  C0 42 C2 34 */	lfs f2, lit_3717(r2)                     /* constant-address: 80455C34, symbol: lit_3717 */
/* 802C2D48  C0 62 C2 88 */	lfs f3, lit_4875(r2)                     /* constant-address: 80455C88, symbol: lit_4875 */
/* 802C2D4C  C0 82 C2 40 */	lfs f4, lit_3720(r2)                     /* constant-address: 80455C40, symbol: lit_3720 */
/* 802C2D50  FC A0 10 90 */	fmr f5, f2                              
/* 802C2D54  C0 C2 C2 20 */	lfs f6, lit_3669(r2)                     /* constant-address: 80455C20, symbol: lit_3669 */
/* 802C2D58  38 60 00 01 */	li r3, 1                                
/* 802C2D5C  4B FE 69 99 */	bl getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign /* constant-address: 802A96F4, symbol: getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign */
/* 802C2D60  FF E0 08 90 */	fmr f31, f1                             
/* 802C2D64  FC 20 F0 90 */	fmr f1, f30                             
/* 802C2D68  C0 42 C2 34 */	lfs f2, lit_3717(r2)                     /* constant-address: 80455C34, symbol: lit_3717 */
/* 802C2D6C  C0 62 C2 88 */	lfs f3, lit_4875(r2)                     /* constant-address: 80455C88, symbol: lit_4875 */
/* 802C2D70  C0 82 C2 40 */	lfs f4, lit_3720(r2)                     /* constant-address: 80455C40, symbol: lit_3720 */
/* 802C2D74  C0 A2 C2 84 */	lfs f5, lit_4838(r2)                     /* constant-address: 80455C84, symbol: lit_4838 */
/* 802C2D78  C0 C2 C2 54 */	lfs f6, lit_4188(r2)                     /* constant-address: 80455C54, symbol: lit_4188 */
/* 802C2D7C  38 60 00 01 */	li r3, 1                                
/* 802C2D80  4B FE 69 75 */	bl getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign /* constant-address: 802A96F4, symbol: getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign */
...
/* 802C2D98  4B FE 00 1D */	bl moveVolume__18JAISoundParamsMoveFfUl  /* constant-address: 802A2DB4, symbol: moveVolume__18JAISoundParamsMoveFfUl */
...
/* 802C2DAC  4B FE 00 61 */	bl movePitch__18JAISoundParamsMoveFfUl   /* constant-address: 802A2E0C, symbol: movePitch__18JAISoundParamsMoveFfUl */
/* 802C2DB0  7F E3 FB 78 */	mr r3, r31                              
/* 802C2DB4  48 00 00 08 */	b lbl_802C2DBC                           /* constant-address: 802C2DBC, symbol: lbl_802C2DBC */
lbl_802C2DB8:

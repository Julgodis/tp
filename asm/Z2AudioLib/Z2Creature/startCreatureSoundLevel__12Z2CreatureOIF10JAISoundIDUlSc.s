...
/* 802C29F4  48 09 F7 D9 */	bl _savegpr_25                           /* constant-address: 803621CC, symbol: _savegpr_25 */
...
/* 802C2A14  40 82 02 2C */	bne lbl_802C2C40                         /* constant-address: 802C2C40, symbol: lbl_802C2C40 */
...
/* 802C2ABC  C8 22 C2 28 */	lfd f1, lit_3672(r2)                     /* constant-address: 80455C28, symbol: lit_3672 */
...
/* 802C2AD4  C0 42 C2 34 */	lfs f2, lit_3717(r2)                     /* constant-address: 80455C34, symbol: lit_3717 */
/* 802C2AD8  C0 62 C2 80 */	lfs f3, lit_4837(r2)                     /* constant-address: 80455C80, symbol: lit_4837 */
/* 802C2ADC  C0 82 C2 40 */	lfs f4, lit_3720(r2)                     /* constant-address: 80455C40, symbol: lit_3720 */
/* 802C2AE0  FC A0 10 90 */	fmr f5, f2                              
/* 802C2AE4  C0 C2 C2 20 */	lfs f6, lit_3669(r2)                     /* constant-address: 80455C20, symbol: lit_3669 */
/* 802C2AE8  38 60 00 01 */	li r3, 1                                
/* 802C2AEC  4B FE 6C 09 */	bl getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign /* constant-address: 802A96F4, symbol: getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign */
/* 802C2AF0  FF E0 08 90 */	fmr f31, f1                             
/* 802C2AF4  C8 22 C2 28 */	lfd f1, lit_3672(r2)                     /* constant-address: 80455C28, symbol: lit_3672 */
...
/* 802C2B0C  C0 42 C2 34 */	lfs f2, lit_3717(r2)                     /* constant-address: 80455C34, symbol: lit_3717 */
/* 802C2B10  C0 62 C2 80 */	lfs f3, lit_4837(r2)                     /* constant-address: 80455C80, symbol: lit_4837 */
/* 802C2B14  C0 82 C2 40 */	lfs f4, lit_3720(r2)                     /* constant-address: 80455C40, symbol: lit_3720 */
/* 802C2B18  C0 A2 C2 84 */	lfs f5, lit_4838(r2)                     /* constant-address: 80455C84, symbol: lit_4838 */
/* 802C2B1C  C0 C2 C2 54 */	lfs f6, lit_4188(r2)                     /* constant-address: 80455C54, symbol: lit_4188 */
/* 802C2B20  38 60 00 01 */	li r3, 1                                
/* 802C2B24  4B FE 6B D1 */	bl getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign /* constant-address: 802A96F4, symbol: getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign */
/* 802C2B28  FF C0 08 90 */	fmr f30, f1                             
/* 802C2B2C  28 1C 00 00 */	cmplwi r28, 0                           
/* 802C2B30  41 82 00 38 */	beq lbl_802C2B68                         /* constant-address: 802C2B68, symbol: lbl_802C2B68 */
/* 802C2B34  80 7C 00 00 */	lwz r3, 0(r28)                          
/* 802C2B38  28 03 00 00 */	cmplwi r3, 0                            
/* 802C2B3C  41 82 00 2C */	beq lbl_802C2B68                         /* constant-address: 802C2B68, symbol: lbl_802C2B68 */
/* 802C2B40  38 63 00 48 */	addi r3, r3, 0x48                       
/* 802C2B44  FC 20 F8 90 */	fmr f1, f31                             
/* 802C2B48  38 80 00 00 */	li r4, 0                                
/* 802C2B4C  4B FE 02 69 */	bl moveVolume__18JAISoundParamsMoveFfUl  /* constant-address: 802A2DB4, symbol: moveVolume__18JAISoundParamsMoveFfUl */
...
/* 802C2B60  4B FE 02 AD */	bl movePitch__18JAISoundParamsMoveFfUl   /* constant-address: 802A2E0C, symbol: movePitch__18JAISoundParamsMoveFfUl */
/* 802C2B64  48 00 00 0C */	b lbl_802C2B70                           /* constant-address: 802C2B70, symbol: lbl_802C2B70 */
lbl_802C2B68:
/* 802C2B68  38 60 00 00 */	li r3, 0                                
/* 802C2B6C  48 00 00 F0 */	b lbl_802C2C5C                           /* constant-address: 802C2C5C, symbol: lbl_802C2C5C */
lbl_802C2B70:
/* 802C2B70  28 1D 00 00 */	cmplwi r29, 0                           
/* 802C2B74  41 82 00 38 */	beq lbl_802C2BAC                         /* constant-address: 802C2BAC, symbol: lbl_802C2BAC */
/* 802C2B78  80 7D 00 00 */	lwz r3, 0(r29)                          
/* 802C2B7C  28 03 00 00 */	cmplwi r3, 0                            
/* 802C2B80  41 82 00 2C */	beq lbl_802C2BAC                         /* constant-address: 802C2BAC, symbol: lbl_802C2BAC */
/* 802C2B84  38 63 00 48 */	addi r3, r3, 0x48                       
/* 802C2B88  FC 20 F8 90 */	fmr f1, f31                             
/* 802C2B8C  38 80 00 00 */	li r4, 0                                
/* 802C2B90  4B FE 02 25 */	bl moveVolume__18JAISoundParamsMoveFfUl  /* constant-address: 802A2DB4, symbol: moveVolume__18JAISoundParamsMoveFfUl */
...
/* 802C2BA4  4B FE 02 69 */	bl movePitch__18JAISoundParamsMoveFfUl   /* constant-address: 802A2E0C, symbol: movePitch__18JAISoundParamsMoveFfUl */
/* 802C2BA8  48 00 00 0C */	b lbl_802C2BB4                           /* constant-address: 802C2BB4, symbol: lbl_802C2BB4 */
lbl_802C2BAC:
/* 802C2BAC  38 60 00 00 */	li r3, 0                                
/* 802C2BB0  48 00 00 AC */	b lbl_802C2C5C                           /* constant-address: 802C2C5C, symbol: lbl_802C2C5C */
lbl_802C2BB4:
/* 802C2BB4  28 1E 00 00 */	cmplwi r30, 0                           
/* 802C2BB8  41 82 00 38 */	beq lbl_802C2BF0                         /* constant-address: 802C2BF0, symbol: lbl_802C2BF0 */
/* 802C2BBC  80 7E 00 00 */	lwz r3, 0(r30)                          
/* 802C2BC0  28 03 00 00 */	cmplwi r3, 0                            
/* 802C2BC4  41 82 00 2C */	beq lbl_802C2BF0                         /* constant-address: 802C2BF0, symbol: lbl_802C2BF0 */
/* 802C2BC8  38 63 00 48 */	addi r3, r3, 0x48                       
/* 802C2BCC  FC 20 F8 90 */	fmr f1, f31                             
/* 802C2BD0  38 80 00 00 */	li r4, 0                                
/* 802C2BD4  4B FE 01 E1 */	bl moveVolume__18JAISoundParamsMoveFfUl  /* constant-address: 802A2DB4, symbol: moveVolume__18JAISoundParamsMoveFfUl */
...
/* 802C2BE8  4B FE 02 25 */	bl movePitch__18JAISoundParamsMoveFfUl   /* constant-address: 802A2E0C, symbol: movePitch__18JAISoundParamsMoveFfUl */
/* 802C2BEC  48 00 00 0C */	b lbl_802C2BF8                           /* constant-address: 802C2BF8, symbol: lbl_802C2BF8 */
lbl_802C2BF0:
/* 802C2BF0  38 60 00 00 */	li r3, 0                                
/* 802C2BF4  48 00 00 68 */	b lbl_802C2C5C                           /* constant-address: 802C2C5C, symbol: lbl_802C2C5C */
lbl_802C2BF8:
/* 802C2BF8  28 1F 00 00 */	cmplwi r31, 0                           
/* 802C2BFC  41 82 00 3C */	beq lbl_802C2C38                         /* constant-address: 802C2C38, symbol: lbl_802C2C38 */
/* 802C2C00  80 7F 00 00 */	lwz r3, 0(r31)                          
/* 802C2C04  28 03 00 00 */	cmplwi r3, 0                            
/* 802C2C08  41 82 00 30 */	beq lbl_802C2C38                         /* constant-address: 802C2C38, symbol: lbl_802C2C38 */
/* 802C2C0C  38 63 00 48 */	addi r3, r3, 0x48                       
/* 802C2C10  FC 20 F8 90 */	fmr f1, f31                             
/* 802C2C14  38 80 00 00 */	li r4, 0                                
/* 802C2C18  4B FE 01 9D */	bl moveVolume__18JAISoundParamsMoveFfUl  /* constant-address: 802A2DB4, symbol: moveVolume__18JAISoundParamsMoveFfUl */
...
/* 802C2C2C  4B FE 01 E1 */	bl movePitch__18JAISoundParamsMoveFfUl   /* constant-address: 802A2E0C, symbol: movePitch__18JAISoundParamsMoveFfUl */
/* 802C2C30  7F E3 FB 78 */	mr r3, r31                              
/* 802C2C34  48 00 00 28 */	b lbl_802C2C5C                           /* constant-address: 802C2C5C, symbol: lbl_802C2C5C */
lbl_802C2C38:
/* 802C2C38  38 60 00 00 */	li r3, 0                                
/* 802C2C3C  48 00 00 20 */	b lbl_802C2C5C                           /* constant-address: 802C2C5C, symbol: lbl_802C2C5C */
lbl_802C2C40:
...
/* 802C2C70  48 09 F5 A9 */	bl _restgpr_25                           /* constant-address: 80362218, symbol: _restgpr_25 */

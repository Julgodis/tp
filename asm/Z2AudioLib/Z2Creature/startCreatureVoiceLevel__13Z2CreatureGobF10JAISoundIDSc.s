...
/* 802C24E0  48 09 FC FD */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802C24F4  38 03 01 F6 */	addi r0, r3, 0x01F6 /* 0x000701F6@l */   /* constant-address: 000701F6 */
/* 802C24F8  90 01 00 10 */	stw r0, 0x10(r1)                        
/* 802C24FC  38 7D 00 50 */	addi r3, r29, 0x50                      
/* 802C2500  38 81 00 10 */	addi r4, r1, 0x10                       
/* 802C2504  4B FE 8D 51 */	bl getHandleSoundID__14Z2SoundHandlesF10JAISoundID /* constant-address: 802AB254, symbol: getHandleSoundID__14Z2SoundHandlesF10JAISoundID */
/* 802C2508  28 03 00 00 */	cmplwi r3, 0                            
/* 802C250C  40 82 00 24 */	bne lbl_802C2530                         /* constant-address: 802C2530, symbol: lbl_802C2530 */
/* 802C2510  3C 60 00 07 */	lis r3, 0x0007 /* 0x000701F7@ha */      
/* 802C2514  38 03 01 F7 */	addi r0, r3, 0x01F7 /* 0x000701F7@l */   /* constant-address: 000701F7 */
/* 802C2518  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 802C251C  38 7D 00 50 */	addi r3, r29, 0x50                      
/* 802C2520  38 81 00 0C */	addi r4, r1, 0xc                        
/* 802C2524  4B FE 8D 31 */	bl getHandleSoundID__14Z2SoundHandlesF10JAISoundID /* constant-address: 802AB254, symbol: getHandleSoundID__14Z2SoundHandlesF10JAISoundID */
/* 802C2528  28 03 00 00 */	cmplwi r3, 0                            
/* 802C252C  41 82 00 0C */	beq lbl_802C2538                         /* constant-address: 802C2538, symbol: lbl_802C2538 */
lbl_802C2530:
/* 802C2530  38 60 00 00 */	li r3, 0                                
/* 802C2534  48 00 00 2C */	b lbl_802C2560                           /* constant-address: 802C2560, symbol: lbl_802C2560 */
lbl_802C2538:
...
/* 802C2564  48 09 FC C5 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

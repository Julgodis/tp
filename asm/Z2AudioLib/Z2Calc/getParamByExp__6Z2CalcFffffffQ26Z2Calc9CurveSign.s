...
/* 802A9730  40 82 00 44 */	bne lbl_802A9774                         /* constant-address: 802A9774, symbol: lbl_802A9774 */
/* 802A9734  C0 82 BE 28 */	lfs f4, lit_380(r2)                      /* constant-address: 80455828, symbol: lit_380 */
/* 802A9738  FC A0 E0 90 */	fmr f5, f28                             
/* 802A973C  38 60 00 01 */	li r3, 1                                
/* 802A9740  4B FF FF 4D */	bl linearTransform__6Z2CalcFfffffb       /* constant-address: 802A968C, symbol: linearTransform__6Z2CalcFfffffb */
/* 802A9744  48 0C 2F FD */	bl exp                                   /* constant-address: 8036C740, symbol: exp */
/* 802A9748  FF E0 08 18 */	frsp f31, f1                            
/* 802A974C  FC 20 E0 90 */	fmr f1, f28                             
/* 802A9750  48 0C 2F F1 */	bl exp                                   /* constant-address: 8036C740, symbol: exp */
/* 802A9754  FC 60 08 18 */	frsp f3, f1                             
/* 802A9758  FC 20 F8 90 */	fmr f1, f31                             
/* 802A975C  C0 42 BE 2C */	lfs f2, lit_381(r2)                      /* constant-address: 8045582C, symbol: lit_381 */
/* 802A9760  FC 80 E8 90 */	fmr f4, f29                             
/* 802A9764  FC A0 F0 90 */	fmr f5, f30                             
/* 802A9768  38 60 00 01 */	li r3, 1                                
/* 802A976C  4B FF FF 21 */	bl linearTransform__6Z2CalcFfffffb       /* constant-address: 802A968C, symbol: linearTransform__6Z2CalcFfffffb */
/* 802A9770  48 00 00 58 */	b lbl_802A97C8                           /* constant-address: 802A97C8, symbol: lbl_802A97C8 */
lbl_802A9774:
/* 802A9774  2C 03 00 00 */	cmpwi r3, 0                             
/* 802A9778  40 82 00 40 */	bne lbl_802A97B8                         /* constant-address: 802A97B8, symbol: lbl_802A97B8 */
/* 802A977C  C0 A2 BE 28 */	lfs f5, lit_380(r2)                      /* constant-address: 80455828, symbol: lit_380 */
/* 802A9780  38 60 00 01 */	li r3, 1                                
/* 802A9784  4B FF FF 09 */	bl linearTransform__6Z2CalcFfffffb       /* constant-address: 802A968C, symbol: linearTransform__6Z2CalcFfffffb */
/* 802A9788  48 0C 2F B9 */	bl exp                                   /* constant-address: 8036C740, symbol: exp */
/* 802A978C  FF E0 08 18 */	frsp f31, f1                            
/* 802A9790  FC 20 E0 90 */	fmr f1, f28                             
/* 802A9794  48 0C 2F AD */	bl exp                                   /* constant-address: 8036C740, symbol: exp */
/* 802A9798  FC 40 08 18 */	frsp f2, f1                             
/* 802A979C  FC 20 F8 90 */	fmr f1, f31                             
/* 802A97A0  C0 62 BE 2C */	lfs f3, lit_381(r2)                      /* constant-address: 8045582C, symbol: lit_381 */
/* 802A97A4  FC 80 E8 90 */	fmr f4, f29                             
/* 802A97A8  FC A0 F0 90 */	fmr f5, f30                             
/* 802A97AC  38 60 00 01 */	li r3, 1                                
/* 802A97B0  4B FF FE DD */	bl linearTransform__6Z2CalcFfffffb       /* constant-address: 802A968C, symbol: linearTransform__6Z2CalcFfffffb */
/* 802A97B4  48 00 00 14 */	b lbl_802A97C8                           /* constant-address: 802A97C8, symbol: lbl_802A97C8 */
lbl_802A97B8:
/* 802A97B8  FC 80 E8 90 */	fmr f4, f29                             
/* 802A97BC  FC A0 F0 90 */	fmr f5, f30                             
/* 802A97C0  38 60 00 00 */	li r3, 0                                
/* 802A97C4  4B FF FE C9 */	bl linearTransform__6Z2CalcFfffffb       /* constant-address: 802A968C, symbol: linearTransform__6Z2CalcFfffffb */
lbl_802A97C8:
/* 802A97C8  FC 01 F0 40 */	fcmpo cr0, f1, f30                      
/* 802A97CC  40 81 00 0C */	ble lbl_802A97D8                         /* constant-address: 802A97D8, symbol: lbl_802A97D8 */
/* 802A97D0  FC 20 F0 90 */	fmr f1, f30                             
/* 802A97D4  48 00 00 10 */	b lbl_802A97E4                           /* constant-address: 802A97E4, symbol: lbl_802A97E4 */
lbl_802A97D8:
/* 802A97D8  FC 01 E8 40 */	fcmpo cr0, f1, f29                      
/* 802A97DC  40 80 00 08 */	bge lbl_802A97E4                         /* constant-address: 802A97E4, symbol: lbl_802A97E4 */

...
/* 802AB660 002A85A0  93 ED 86 08 */	stw r31, "sInstance__27JASGlobalInstance<7Z2SeMgr>"-_SDA_BASE_(r13)
...
/* 802AB8E8 002A8828  80 AD 85 C4 */	lwz r5, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
lbl_802ABCB8:
/* 802ABCB8 002A8BF8  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ABF98:
/* 802ABF98 002A8ED8  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
/* 802ABF9C 002A8EDC  48 00 A1 A1 */	bl menuIn__11Z2StatusMgrFv
/* 802ABFA0 002A8EE0  48 00 04 40 */	b lbl_802AC3E0
lbl_802ABFA4:
/* 802ABFA4 002A8EE4  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ABFD8:
/* 802ABFD8 002A8F18  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ABFF0:
/* 802ABFF0 002A8F30  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802AC010:
/* 802AC010 002A8F50  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802AC04C:
/* 802AC04C 002A8F8C  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802AC05C 002A8F9C  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
lbl_802AC074:
/* 802AC074 002A8FB4  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
lbl_802AC1B8:
/* 802AC1B8 002A90F8  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
lbl_802AC3A0:
/* 802AC3A0 002A92E0  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802AC478 002A93B8  80 6D 85 F4 */	lwz r3, "sInstance__35JASGlobalInstance<14Z2SoundStarter>"-_SDA_BASE_(r13)
...
lbl_802AC5E4:
/* 802AC5E4 002A9524  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802AC5F4 002A9534  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
lbl_802AD24C:
/* 802AD24C 002AA18C  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
lbl_802AD25C:
/* 802AD25C 002AA19C  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
lbl_802AD3B4:
/* 802AD3B4 002AA2F4  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802AD424 002AA364  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
lbl_802AD45C:
/* 802AD45C 002AA39C  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802AD5C8 002AA508  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
/* 802AD648 002AA588  80 6D 85 F4 */	lwz r3, "sInstance__35JASGlobalInstance<14Z2SoundStarter>"-_SDA_BASE_(r13)
...
/* 802AD784 002AA6C4  80 6D 85 F4 */	lwz r3, "sInstance__35JASGlobalInstance<14Z2SoundStarter>"-_SDA_BASE_(r13)
...
/* 802AD80C 002AA74C  80 6D 86 04 */	lwz r3, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
/* 802AD830 002AA770  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
/* 802AD964 002AA8A4  83 ED 85 E0 */	lwz r31, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802ADA18 002AA958  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ADA2C:
/* 802ADA2C 002AA96C  83 ED 85 E0 */	lwz r31, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802ADAD0 002AAA10  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802ADB2C 002AAA6C  80 6D 85 F0 */	lwz r3, "sInstance__33JASGlobalInstance<12Z2SpeechMgr2>"-_SDA_BASE_(r13)
...
/* 802ADB60 002AAAA0  80 8D 86 00 */	lwz r4, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802ADB70 002AAAB0  80 8D 85 FC */	lwz r4, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ADB8C:
/* 802ADB8C 002AAACC  83 ED 85 E0 */	lwz r31, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802ADC20 002AAB60  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802ADC64 002AABA4  80 8D 86 00 */	lwz r4, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802ADC74 002AABB4  80 8D 85 FC */	lwz r4, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ADC90:
/* 802ADC90 002AABD0  83 ED 85 E0 */	lwz r31, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802ADD24 002AAC64  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
/* 802ADD68 002AACA8  80 8D 86 00 */	lwz r4, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802ADD78 002AACB8  80 8D 85 FC */	lwz r4, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ADD94:
/* 802ADD94 002AACD4  83 ED 85 E0 */	lwz r31, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802ADE28 002AAD68  80 6D 85 FC */	lwz r3, "sInstance__32JASGlobalInstance<11Z2StatusMgr>"-_SDA_BASE_(r13)
...
lbl_802ADF20:
/* 802ADF20 002AAE60  80 AD 85 C4 */	lwz r5, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
lbl_802AE0B8:
/* 802AE0B8 002AAFF8  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
/* 802AE1B4 002AB0F4  80 8D 86 00 */	lwz r4, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802AE5C4 002AB504  80 AD 86 04 */	lwz r5, "sInstance__28JASGlobalInstance<8Z2SeqMgr>"-_SDA_BASE_(r13)
...
lbl_802AE89C:
/* 802AE89C 002AB7DC  80 6D 86 00 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SceneMgr>"-_SDA_BASE_(r13)
...
/* 802AE9B4 002AB8F4  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802AE9E8 002AB928  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
/* 802AE9FC 002AB93C  80 6D 85 E0 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2SoundMgr>"-_SDA_BASE_(r13)
...
lbl_802AEBB8:
/* 802AEBB8 002ABAF8  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
/* 802AEBC8 002ABB08  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
lbl_802AEBF8:
/* 802AEBF8 002ABB38  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
/* 802AEC0C 002ABB4C  80 6D 85 C4 */	lwz r3, "sInstance__31JASGlobalInstance<10Z2Audience>"-_SDA_BASE_(r13)
...
.section .data, "aw"
/* 803C9D98 0060 .data lbl_803C9D98 @4619 */
.global lbl_803C9D98
lbl_803C9D98:

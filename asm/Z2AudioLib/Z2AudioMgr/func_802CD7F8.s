...
/* 802CD814  41 82 00 58 */	beq lbl_802CD86C                         /* constant-address: 802CD86C, symbol: lbl_802CD86C */
/* 802CD818  3C 60 80 3D */	lis r3, data_803CBF58@ha                
/* 802CD81C  38 03 BF 58 */	addi r0, r3, data_803CBF58@l             /* constant-address: 803CBF58, symbol: data_803CBF58 */
/* 802CD820  90 1E 00 00 */	stw r0, 0(r30)                          
/* 802CD824  80 1E 00 40 */	lwz r0, 0x40(r30)                       
/* 802CD828  28 00 00 00 */	cmplwi r0, 0                            
/* 802CD82C  41 82 00 0C */	beq lbl_802CD838                         /* constant-address: 802CD838, symbol: lbl_802CD838 */
/* 802CD830  38 7E 00 08 */	addi r3, r30, 8                         
/* 802CD834  4B FC 2C B1 */	bl free__7JASHeapFv                      /* constant-address: 802904E4, symbol: free__7JASHeapFv */
lbl_802CD838:
/* 802CD838  38 7E 00 08 */	addi r3, r30, 8                         
/* 802CD83C  3C 80 80 29 */	lis r4, __dt__7JASHeapFv@ha             
/* 802CD840  38 84 0B 54 */	addi r4, r4, __dt__7JASHeapFv@l          /* constant-address: 80290B54, symbol: __dt__7JASHeapFv */
/* 802CD844  38 A0 00 44 */	li r5, 0x44                             
/* 802CD848  38 C0 00 01 */	li r6, 1                                
/* 802CD84C  48 09 44 9D */	bl __destroy_arr                         /* constant-address: 80361CE8, symbol: __destroy_arr */
/* 802CD850  7F C3 F3 78 */	mr r3, r30                              
/* 802CD854  38 80 00 00 */	li r4, 0                                
/* 802CD858  4B FD 62 C9 */	bl __dt__16JAIStreamAramMgrFv            /* constant-address: 802A3B20, symbol: __dt__16JAIStreamAramMgrFv */
/* 802CD85C  7F E0 07 35 */	extsh. r0, r31                          
/* 802CD860  40 81 00 0C */	ble lbl_802CD86C                         /* constant-address: 802CD86C, symbol: lbl_802CD86C */
/* 802CD864  7F C3 F3 78 */	mr r3, r30                              
/* 802CD868  48 00 14 D5 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802CD86C:

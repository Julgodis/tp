...
/* 802AAAEC  40 82 00 0C */	bne lbl_802AAAF8                         /* constant-address: 802AAAF8, symbol: lbl_802AAAF8 */
/* 802AAAF0  38 60 00 00 */	li r3, 0                                
/* 802AAAF4  48 00 00 88 */	b lbl_802AAB7C                           /* constant-address: 802AAB7C, symbol: lbl_802AAB7C */
lbl_802AAAF8:
/* 802AAAF8  90 61 00 10 */	stw r3, 0x10(r1)                        
/* 802AAAFC  80 6D 85 CC */	lwz r3, data_80450B4C(r13)               /* constant-address: 80450B4C, symbol: data_80450B4C */
...
/* 802AAB18  40 82 00 60 */	bne lbl_802AAB78                         /* constant-address: 802AAB78, symbol: lbl_802AAB78 */
/* 802AAB1C  80 1F 00 00 */	lwz r0, 0(r31)                          
/* 802AAB20  90 01 00 0C */	stw r0, 0xc(r1)                         
/* 802AAB24  80 6D 85 CC */	lwz r3, data_80450B4C(r13)               /* constant-address: 80450B4C, symbol: data_80450B4C */
...
/* 802AAB4C  48 00 00 24 */	b lbl_802AAB70                           /* constant-address: 802AAB70, symbol: lbl_802AAB70 */
lbl_802AAB50:
...
/* 802AAB60  40 82 00 0C */	bne lbl_802AAB6C                         /* constant-address: 802AAB6C, symbol: lbl_802AAB6C */
/* 802AAB64  38 60 00 01 */	li r3, 1                                
/* 802AAB68  48 00 00 14 */	b lbl_802AAB7C                           /* constant-address: 802AAB7C, symbol: lbl_802AAB7C */
lbl_802AAB6C:
/* 802AAB6C  80 84 00 0C */	lwz r4, 0xc(r4)                         
lbl_802AAB70:
/* 802AAB70  28 04 00 00 */	cmplwi r4, 0                            
/* 802AAB74  40 82 FF DC */	bne lbl_802AAB50                         /* constant-address: 802AAB50, symbol: lbl_802AAB50 */
lbl_802AAB78:

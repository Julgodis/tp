...
/* 802AA1C8  4B FF 63 AD */	bl calc__8JAISeMgrFv                     /* constant-address: 802A0574, symbol: calc__8JAISeMgrFv */
/* 802AA1CC  80 7F 08 0C */	lwz r3, 0x80c(r31)                      
/* 802AA1D0  3C 03 00 01 */	addis r0, r3, 1                         
/* 802AA1D4  28 00 FF FF */	cmplwi r0, 0xffff                       
/* 802AA1D8  41 82 00 74 */	beq lbl_802AA24C                         /* constant-address: 802AA24C, symbol: lbl_802AA24C */
/* 802AA1DC  90 61 00 08 */	stw r3, 8(r1)                           
/* 802AA1E0  7F E3 FB 78 */	mr r3, r31                              
/* 802AA1E4  38 81 00 08 */	addi r4, r1, 8                          
/* 802AA1E8  48 00 08 DD */	bl isPlayingSoundID__10Z2SoundMgrF10JAISoundID /* constant-address: 802AAAC4, symbol: isPlayingSoundID__10Z2SoundMgrF10JAISoundID */
/* 802AA1EC  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 802AA1F0  40 82 00 5C */	bne lbl_802AA24C                         /* constant-address: 802AA24C, symbol: lbl_802AA24C */
/* 802AA1F4  80 6D 86 00 */	lwz r3, data_80450B80(r13)               /* constant-address: 80450B80, symbol: data_80450B80 */
/* 802AA1F8  88 03 00 1D */	lbz r0, 0x1d(r3)                        
/* 802AA1FC  28 00 00 00 */	cmplwi r0, 0                            
/* 802AA200  41 82 00 44 */	beq lbl_802AA244                         /* constant-address: 802AA244, symbol: lbl_802AA244 */
/* 802AA204  80 6D 86 04 */	lwz r3, data_80450B84(r13)               /* constant-address: 80450B84, symbol: data_80450B84 */
/* 802AA208  C0 03 00 74 */	lfs f0, 0x74(r3)                        
/* 802AA20C  38 00 00 03 */	li r0, 3                                
/* 802AA210  90 03 00 80 */	stw r0, 0x80(r3)                        
/* 802AA214  C0 62 BE 38 */	lfs f3, lit_3688(r2)                     /* constant-address: 80455838, symbol: lit_3688 */
/* 802AA218  EC 43 00 28 */	fsubs f2, f3, f0                        
/* 802AA21C  80 03 00 80 */	lwz r0, 0x80(r3)                        
/* 802AA220  C8 22 BE 48 */	lfd f1, lit_3909(r2)                     /* constant-address: 80455848, symbol: lit_3909 */
...
/* 802AA250  4B FF 7A 41 */	bl calc__9JAISeqMgrFv                    /* constant-address: 802A1C90, symbol: calc__9JAISeqMgrFv */
/* 802AA254  38 7F 07 9C */	addi r3, r31, 0x79c                     
/* 802AA258  4B FF 9C 65 */	bl calc__12JAIStreamMgrFv                /* constant-address: 802A3EBC, symbol: calc__12JAIStreamMgrFv */

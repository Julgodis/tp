...
/* 802BC4D8  C0 0D 82 58 */	lfs f0, DISTANCE_MAX__7Z2Param(r13)      /* constant-address: 804507D8, symbol: DISTANCE_MAX__7Z2Param */
/* 802BC4DC  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802BC4E0  40 81 00 14 */	ble lbl_802BC4F4                         /* constant-address: 802BC4F4, symbol: lbl_802BC4F4 */
/* 802BC4E4  C0 0D 8D D0 */	lfs f0, cNearFarRatio(r13)               /* constant-address: 80451350, symbol: cNearFarRatio */
/* 802BC4E8  EC 00 00 72 */	fmuls f0, f0, f1                        
/* 802BC4EC  D0 03 00 3C */	stfs f0, 0x3c(r3)                       
/* 802BC4F0  48 00 00 0C */	b lbl_802BC4FC                           /* constant-address: 802BC4FC, symbol: lbl_802BC4FC */
lbl_802BC4F4:
/* 802BC4F4  C0 0D 82 5C */	lfs f0, MAX_VOLUME_DISTANCE__7Z2Param(r13) /* constant-address: 804507DC, symbol: MAX_VOLUME_DISTANCE__7Z2Param */
/* 802BC4F8  D0 03 00 3C */	stfs f0, 0x3c(r3)                       
lbl_802BC4FC:
/* 802BC4FC  C0 22 C0 DC */	lfs f1, lit_1058(r2)                     /* constant-address: 80455ADC, symbol: lit_1058 */
/* 802BC500  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC504  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC508  D0 03 00 04 */	stfs f0, 4(r3)                          
/* 802BC50C  C0 22 C0 D8 */	lfs f1, lit_1036(r2)                     /* constant-address: 80455AD8, symbol: lit_1036 */
/* 802BC510  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC514  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC518  D0 03 00 08 */	stfs f0, 8(r3)                          
/* 802BC51C  C0 22 C0 E0 */	lfs f1, lit_1059(r2)                     /* constant-address: 80455AE0, symbol: lit_1059 */
/* 802BC520  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC524  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC528  D0 03 00 0C */	stfs f0, 0xc(r3)                        
/* 802BC52C  C0 22 C0 B0 */	lfs f1, lit_998(r2)                      /* constant-address: 80455AB0, symbol: lit_998 */
/* 802BC530  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC534  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC538  D0 03 00 10 */	stfs f0, 0x10(r3)                       
/* 802BC53C  C0 22 C0 E4 */	lfs f1, lit_1060(r2)                     /* constant-address: 80455AE4, symbol: lit_1060 */
/* 802BC540  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC544  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC548  D0 03 00 14 */	stfs f0, 0x14(r3)                       
/* 802BC54C  C0 22 C0 E8 */	lfs f1, lit_1061(r2)                     /* constant-address: 80455AE8, symbol: lit_1061 */
/* 802BC550  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC554  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC558  D0 03 00 18 */	stfs f0, 0x18(r3)                       
/* 802BC55C  C0 22 C0 EC */	lfs f1, lit_1062(r2)                     /* constant-address: 80455AEC, symbol: lit_1062 */
/* 802BC560  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC564  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC568  D0 03 00 1C */	stfs f0, 0x1c(r3)                       
/* 802BC56C  C0 22 C0 F0 */	lfs f1, lit_1063(r2)                     /* constant-address: 80455AF0, symbol: lit_1063 */
/* 802BC570  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC574  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC578  D0 03 00 20 */	stfs f0, 0x20(r3)                       
/* 802BC57C  C0 22 C0 F4 */	lfs f1, lit_1064(r2)                     /* constant-address: 80455AF4, symbol: lit_1064 */
/* 802BC580  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC584  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC588  D0 03 00 24 */	stfs f0, 0x24(r3)                       
/* 802BC58C  C0 22 C0 F8 */	lfs f1, lit_1065(r2)                     /* constant-address: 80455AF8, symbol: lit_1065 */
/* 802BC590  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC594  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC598  D0 03 00 28 */	stfs f0, 0x28(r3)                       
/* 802BC59C  C0 22 C0 FC */	lfs f1, lit_1066(r2)                     /* constant-address: 80455AFC, symbol: lit_1066 */
/* 802BC5A0  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC5A4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC5A8  D0 03 00 2C */	stfs f0, 0x2c(r3)                       
/* 802BC5AC  C0 22 C0 A8 */	lfs f1, lit_895(r2)                      /* constant-address: 80455AA8, symbol: lit_895 */
/* 802BC5B0  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC5B4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC5B8  D0 03 00 30 */	stfs f0, 0x30(r3)                       
/* 802BC5BC  C0 22 C1 00 */	lfs f1, lit_1067(r2)                     /* constant-address: 80455B00, symbol: lit_1067 */
/* 802BC5C0  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC5C4  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC5C8  D0 03 00 34 */	stfs f0, 0x34(r3)                       
/* 802BC5CC  C0 22 C0 B8 */	lfs f1, lit_1000(r2)                     /* constant-address: 80455AB8, symbol: lit_1000 */
...
/* 802BC5E0  C0 62 C0 A4 */	lfs f3, lit_894(r2)                      /* constant-address: 80455AA4, symbol: lit_894 */
...
/* 802BC610  42 00 FF DC */	bdnz lbl_802BC5EC                        /* constant-address: 802BC5EC, symbol: lbl_802BC5EC */
/* 802BC614  38 80 00 00 */	li r4, 0                                
/* 802BC618  C8 62 C0 D0 */	lfd f3, lit_1008(r2)                     /* constant-address: 80455AD0, symbol: lit_1008 */
...
/* 802BC658  42 00 FF D0 */	bdnz lbl_802BC628                        /* constant-address: 802BC628, symbol: lbl_802BC628 */
...
/* 802BC690  42 00 FF D8 */	bdnz lbl_802BC668                        /* constant-address: 802BC668, symbol: lbl_802BC668 */

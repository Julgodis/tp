...
/* 802BDB6C 00000000  40 81 00 0C */	ble lbl_802BDB78
/* 802BDB70 00000004  C0 22 C0 A4 */	lfs f1, lit_894(r2)
/* 802BDB74 00000008  48 00 00 58 */	b lbl_802BDBCC
lbl_802BDB78:
/* 802BDB78 00000000  C0 43 00 50 */	lfs f2, 0x50(r3)
/* 802BDB7C 00000004  FC 01 10 40 */	fcmpo cr0, f1, f2
/* 802BDB80 00000000  40 80 00 0C */	bge lbl_802BDB8C
/* 802BDB84 00000004  C0 22 C0 A0 */	lfs f1, lit_848(r2)
/* 802BDB88 00000008  48 00 00 44 */	b lbl_802BDBCC
lbl_802BDB8C:
/* 802BDB8C 00000000  C0 62 C0 A0 */	lfs f3, lit_848(r2)
/* 802BDB90 00000004  FC 01 18 40 */	fcmpo cr0, f1, f3
/* 802BDB94 00000000  40 80 00 1C */	bge lbl_802BDBB0
/* 802BDB98 00000004  C0 82 C0 B8 */	lfs f4, lit_1000(r2)
/* 802BDB9C 00000008  FC A0 18 90 */	fmr f5, f3
/* 802BDBA0 0000000C  C0 C3 00 58 */	lfs f6, 0x58(r3)
/* 802BDBA4 00000010  38 60 00 01 */	li r3, 1
/* 802BDBA8 00000014  4B FE BB 4D */	bl getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign
/* 802BDBAC 00000018  48 00 00 20 */	b lbl_802BDBCC
lbl_802BDBB0:
...
/* 802BDBC0 00000010  C0 C2 C0 A4 */	lfs f6, lit_894(r2)

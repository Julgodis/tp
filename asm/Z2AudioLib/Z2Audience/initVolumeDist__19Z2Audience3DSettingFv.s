...
/* 802BC314  40 82 01 B4 */	bne lbl_802BC4C8                         /* constant-address: 802BC4C8, symbol: lbl_802BC4C8 */
/* 802BC318  C0 0D 82 58 */	lfs f0, DISTANCE_MAX__7Z2Param(r13)      /* constant-address: 804507D8, symbol: DISTANCE_MAX__7Z2Param */
/* 802BC31C  D0 03 00 00 */	stfs f0, 0(r3)                          
/* 802BC320  C0 0D 82 5C */	lfs f0, MAX_VOLUME_DISTANCE__7Z2Param(r13) /* constant-address: 804507DC, symbol: MAX_VOLUME_DISTANCE__7Z2Param */
/* 802BC324  D0 03 00 3C */	stfs f0, 0x3c(r3)                       
/* 802BC328  C0 22 C0 DC */	lfs f1, lit_1058(r2)                     /* constant-address: 80455ADC, symbol: lit_1058 */
/* 802BC32C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC330  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC334  D0 03 00 04 */	stfs f0, 4(r3)                          
/* 802BC338  C0 22 C0 D8 */	lfs f1, lit_1036(r2)                     /* constant-address: 80455AD8, symbol: lit_1036 */
/* 802BC33C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC340  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC344  D0 03 00 08 */	stfs f0, 8(r3)                          
/* 802BC348  C0 22 C0 E0 */	lfs f1, lit_1059(r2)                     /* constant-address: 80455AE0, symbol: lit_1059 */
/* 802BC34C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC350  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC354  D0 03 00 0C */	stfs f0, 0xc(r3)                        
/* 802BC358  C0 22 C0 B0 */	lfs f1, lit_998(r2)                      /* constant-address: 80455AB0, symbol: lit_998 */
/* 802BC35C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC360  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC364  D0 03 00 10 */	stfs f0, 0x10(r3)                       
/* 802BC368  C0 22 C0 E4 */	lfs f1, lit_1060(r2)                     /* constant-address: 80455AE4, symbol: lit_1060 */
/* 802BC36C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC370  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC374  D0 03 00 14 */	stfs f0, 0x14(r3)                       
/* 802BC378  C0 22 C0 E8 */	lfs f1, lit_1061(r2)                     /* constant-address: 80455AE8, symbol: lit_1061 */
/* 802BC37C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC380  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC384  D0 03 00 18 */	stfs f0, 0x18(r3)                       
/* 802BC388  C0 22 C0 EC */	lfs f1, lit_1062(r2)                     /* constant-address: 80455AEC, symbol: lit_1062 */
/* 802BC38C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC390  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC394  D0 03 00 1C */	stfs f0, 0x1c(r3)                       
/* 802BC398  C0 22 C0 F0 */	lfs f1, lit_1063(r2)                     /* constant-address: 80455AF0, symbol: lit_1063 */
/* 802BC39C  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC3A0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC3A4  D0 03 00 20 */	stfs f0, 0x20(r3)                       
/* 802BC3A8  C0 22 C0 F4 */	lfs f1, lit_1064(r2)                     /* constant-address: 80455AF4, symbol: lit_1064 */
/* 802BC3AC  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC3B0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC3B4  D0 03 00 24 */	stfs f0, 0x24(r3)                       
/* 802BC3B8  C0 22 C0 F8 */	lfs f1, lit_1065(r2)                     /* constant-address: 80455AF8, symbol: lit_1065 */
/* 802BC3BC  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC3C0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC3C4  D0 03 00 28 */	stfs f0, 0x28(r3)                       
/* 802BC3C8  C0 22 C0 FC */	lfs f1, lit_1066(r2)                     /* constant-address: 80455AFC, symbol: lit_1066 */
/* 802BC3CC  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC3D0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC3D4  D0 03 00 2C */	stfs f0, 0x2c(r3)                       
/* 802BC3D8  C0 22 C0 A8 */	lfs f1, lit_895(r2)                      /* constant-address: 80455AA8, symbol: lit_895 */
/* 802BC3DC  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC3E0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC3E4  D0 03 00 30 */	stfs f0, 0x30(r3)                       
/* 802BC3E8  C0 22 C1 00 */	lfs f1, lit_1067(r2)                     /* constant-address: 80455B00, symbol: lit_1067 */
/* 802BC3EC  C0 03 00 00 */	lfs f0, 0(r3)                           
/* 802BC3F0  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BC3F4  D0 03 00 34 */	stfs f0, 0x34(r3)                       
/* 802BC3F8  C0 22 C0 B8 */	lfs f1, lit_1000(r2)                     /* constant-address: 80455AB8, symbol: lit_1000 */
...
/* 802BC40C  C0 62 C0 A4 */	lfs f3, lit_894(r2)                      /* constant-address: 80455AA4, symbol: lit_894 */
...
/* 802BC43C  42 00 FF DC */	bdnz lbl_802BC418                        /* constant-address: 802BC418, symbol: lbl_802BC418 */
/* 802BC440  38 80 00 00 */	li r4, 0                                
/* 802BC444  C8 62 C0 D0 */	lfd f3, lit_1008(r2)                     /* constant-address: 80455AD0, symbol: lit_1008 */
...
/* 802BC484  42 00 FF D0 */	bdnz lbl_802BC454                        /* constant-address: 802BC454, symbol: lbl_802BC454 */
...
/* 802BC4BC  42 00 FF D8 */	bdnz lbl_802BC494                        /* constant-address: 802BC494, symbol: lbl_802BC494 */

...
/* 802BDD78  41 82 01 40 */	beq lbl_802BDEB8                         /* constant-address: 802BDEB8, symbol: lbl_802BDEB8 */
...
/* 802BDD90  C0 22 C1 18 */	lfs f1, lit_1271(r2)                     /* constant-address: 80455B18, symbol: lit_1271 */
/* 802BDD94  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 802BDD98  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 802BDD9C  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 802BDDA0  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 802BDDA4  4C 40 13 82 */	cror 2, 0, 2                            
/* 802BDDA8  40 82 00 18 */	bne lbl_802BDDC0                         /* constant-address: 802BDDC0, symbol: lbl_802BDDC0 */
/* 802BDDAC  C0 02 C0 A0 */	lfs f0, lit_848(r2)                      /* constant-address: 80455AA0, symbol: lit_848 */
/* 802BDDB0  D0 01 00 18 */	stfs f0, 0x18(r1)                       
/* 802BDDB4  D0 01 00 14 */	stfs f0, 0x14(r1)                       
/* 802BDDB8  D0 01 00 10 */	stfs f0, 0x10(r1)                       
/* 802BDDBC  48 00 00 5C */	b lbl_802BDE18                           /* constant-address: 802BDE18, symbol: lbl_802BDE18 */
lbl_802BDDC0:
/* 802BDDC0  C0 02 C0 A0 */	lfs f0, lit_848(r2)                      /* constant-address: 80455AA0, symbol: lit_848 */
/* 802BDDC4  FC 05 00 40 */	fcmpo cr0, f5, f0                       
/* 802BDDC8  4C 40 13 82 */	cror 2, 0, 2                            
/* 802BDDCC  40 82 00 0C */	bne lbl_802BDDD8                         /* constant-address: 802BDDD8, symbol: lbl_802BDDD8 */
/* 802BDDD0  FC 60 28 90 */	fmr f3, f5                              
/* 802BDDD4  48 00 00 2C */	b lbl_802BDE00                           /* constant-address: 802BDE00, symbol: lbl_802BDE00 */
lbl_802BDDD8:
/* 802BDDD8  FC 80 28 34 */	frsqrte f4, f5                          
/* 802BDDDC  FC 80 20 18 */	frsp f4, f4                             
/* 802BDDE0  C0 02 C0 A8 */	lfs f0, lit_895(r2)                      /* constant-address: 80455AA8, symbol: lit_895 */
/* 802BDDE4  EC 40 01 32 */	fmuls f2, f0, f4                        
/* 802BDDE8  C0 22 C0 B0 */	lfs f1, lit_998(r2)                      /* constant-address: 80455AB0, symbol: lit_998 */
...
/* 802BDE20  C0 42 C1 34 */	lfs f2, lit_1988(r2)                     /* constant-address: 80455B34, symbol: lit_1988 */
/* 802BDE24  88 01 00 08 */	lbz r0, 8(r1)                           
/* 802BDE28  54 00 E7 3E */	rlwinm r0, r0, 0x1c, 0x1c, 0x1f         
/* 802BDE2C  C8 22 C0 D0 */	lfd f1, lit_1008(r2)                     /* constant-address: 80455AD0, symbol: lit_1008 */
...
/* 802BDE58  4B FF FE 59 */	bl func_802BDCB0                         /* constant-address: 802BDCB0, symbol: func_802BDCB0 */
/* 802BDE5C  C0 5F 00 34 */	lfs f2, 0x34(r31)                       
/* 802BDE60  C0 02 C0 A0 */	lfs f0, lit_848(r2)                      /* constant-address: 80455AA0, symbol: lit_848 */
/* 802BDE64  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 802BDE68  40 81 00 38 */	ble lbl_802BDEA0                         /* constant-address: 802BDEA0, symbol: lbl_802BDEA0 */
/* 802BDE6C  C0 7E 00 6C */	lfs f3, 0x6c(r30)                       
/* 802BDE70  EC 01 00 F2 */	fmuls f0, f1, f3                        
/* 802BDE74  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 802BDE78  40 81 00 0C */	ble lbl_802BDE84                         /* constant-address: 802BDE84, symbol: lbl_802BDE84 */
/* 802BDE7C  FC 20 10 90 */	fmr f1, f2                              
/* 802BDE80  48 00 00 3C */	b lbl_802BDEBC                           /* constant-address: 802BDEBC, symbol: lbl_802BDEBC */
lbl_802BDE84:
/* 802BDE84  EC 02 00 F2 */	fmuls f0, f2, f3                        
/* 802BDE88  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802BDE8C  40 81 00 0C */	ble lbl_802BDE98                         /* constant-address: 802BDE98, symbol: lbl_802BDE98 */
/* 802BDE90  FC 20 10 90 */	fmr f1, f2                              
/* 802BDE94  48 00 00 28 */	b lbl_802BDEBC                           /* constant-address: 802BDEBC, symbol: lbl_802BDEBC */
lbl_802BDE98:
/* 802BDE98  D0 3F 00 34 */	stfs f1, 0x34(r31)                      
/* 802BDE9C  48 00 00 20 */	b lbl_802BDEBC                           /* constant-address: 802BDEBC, symbol: lbl_802BDEBC */
lbl_802BDEA0:
/* 802BDEA0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802BDEA4  40 81 00 0C */	ble lbl_802BDEB0                         /* constant-address: 802BDEB0, symbol: lbl_802BDEB0 */
/* 802BDEA8  D0 3F 00 34 */	stfs f1, 0x34(r31)                      
/* 802BDEAC  48 00 00 10 */	b lbl_802BDEBC                           /* constant-address: 802BDEBC, symbol: lbl_802BDEBC */
lbl_802BDEB0:
/* 802BDEB0  C0 22 C0 A4 */	lfs f1, lit_894(r2)                      /* constant-address: 80455AA4, symbol: lit_894 */
/* 802BDEB4  48 00 00 08 */	b lbl_802BDEBC                           /* constant-address: 802BDEBC, symbol: lbl_802BDEBC */
lbl_802BDEB8:
/* 802BDEB8  C0 22 C0 A4 */	lfs f1, lit_894(r2)                      /* constant-address: 80455AA4, symbol: lit_894 */
lbl_802BDEBC:

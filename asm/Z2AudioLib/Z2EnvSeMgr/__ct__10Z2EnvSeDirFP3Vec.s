...
/* 802C5CBC  4B FF FB E1 */	bl __ct__11Z2EnvSeBaseFP3Vec             /* constant-address: 802C589C, symbol: __ct__11Z2EnvSeBaseFP3Vec */
/* 802C5CC0  C0 02 C3 60 */	lfs f0, lit_3574(r2)                     /* constant-address: 80455D60, symbol: lit_3574 */
/* 802C5CC4  D0 1E 00 08 */	stfs f0, 8(r30)                         
/* 802C5CC8  D0 1E 00 0C */	stfs f0, 0xc(r30)                       
/* 802C5CCC  28 1F 00 00 */	cmplwi r31, 0                           
/* 802C5CD0  41 82 00 14 */	beq lbl_802C5CE4                         /* constant-address: 802C5CE4, symbol: lbl_802C5CE4 */
/* 802C5CD4  7F C3 F3 78 */	mr r3, r30                              
/* 802C5CD8  7F E4 FB 78 */	mr r4, r31                              
/* 802C5CDC  48 00 00 95 */	bl setPanDir__10Z2EnvSeDirFP3Vec         /* constant-address: 802C5D70, symbol: setPanDir__10Z2EnvSeDirFP3Vec */
/* 802C5CE0  48 00 00 20 */	b lbl_802C5D00                           /* constant-address: 802C5D00, symbol: lbl_802C5D00 */
lbl_802C5CE4:
/* 802C5CE4  3C 60 80 3A */	lis r3, cNullVec__6Z2Calc@ha            
/* 802C5CE8  C4 03 C2 50 */	lfsu f0, cNullVec__6Z2Calc@l(r3)         /* constant-address: 8039C250, symbol: cNullVec__6Z2Calc */
/* 802C5CEC  D0 1E 00 10 */	stfs f0, 0x10(r30)                      
/* 802C5CF0  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 8039C254, symbol: None */
/* 802C5CF4  D0 1E 00 14 */	stfs f0, 0x14(r30)                      
/* 802C5CF8  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 8039C258, symbol: None */

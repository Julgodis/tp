...
/* 802C5948  48 09 C8 95 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 802C596C  80 6D 85 FC */	lwz r3, data_80450B7C(r13)               /* constant-address: 80450B7C, symbol: data_80450B7C */
/* 802C5970  88 03 00 0C */	lbz r0, 0xc(r3)                         
/* 802C5974  28 00 00 00 */	cmplwi r0, 0                            
/* 802C5978  41 82 00 0C */	beq lbl_802C5984                         /* constant-address: 802C5984, symbol: lbl_802C5984 */
/* 802C597C  C0 02 C3 40 */	lfs f0, lit_3501(r2)                     /* constant-address: 80455D40, symbol: lit_3501 */
/* 802C5980  EF 7B 00 32 */	fmuls f27, f27, f0                      
lbl_802C5984:
/* 802C5984  C3 E2 C3 44 */	lfs f31, lit_3502(r2)                    /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C5988  C0 03 00 18 */	lfs f0, 0x18(r3)                        
/* 802C598C  C0 62 C3 48 */	lfs f3, lit_3503(r2)                     /* constant-address: 80455D48, symbol: lit_3503 */
/* 802C5990  FC 00 18 40 */	fcmpo cr0, f0, f3                       
/* 802C5994  7C 00 00 26 */	mfcr r0                                 
/* 802C5998  54 00 17 FE */	rlwinm r0, r0, 2, 0x1f, 0x1f            
/* 802C599C  C8 22 C3 58 */	lfd f1, lit_3508(r2)                     /* constant-address: 80455D58, symbol: lit_3508 */
...
/* 802C59B8  41 82 00 24 */	beq lbl_802C59DC                         /* constant-address: 802C59DC, symbol: lbl_802C59DC */
/* 802C59BC  C0 42 C3 4C */	lfs f2, lit_3504(r2)                     /* constant-address: 80455D4C, symbol: lit_3504 */
/* 802C59C0  C0 82 C3 50 */	lfs f4, lit_3505(r2)                     /* constant-address: 80455D50, symbol: lit_3505 */
/* 802C59C4  FC A0 18 90 */	fmr f5, f3                              
/* 802C59C8  FC C0 F8 90 */	fmr f6, f31                             
/* 802C59CC  38 60 00 00 */	li r3, 0                                
/* 802C59D0  4B FE 3D 25 */	bl getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign /* constant-address: 802A96F4, symbol: getParamByExp__6Z2CalcFffffffQ26Z2Calc9CurveSign */
...
/* 802C59E4  80 6D 85 F4 */	lwz r3, data_80450B74(r13)               /* constant-address: 80450B74, symbol: data_80450B74 */
...
/* 802C5A2C  41 82 00 3C */	beq lbl_802C5A68                         /* constant-address: 802C5A68, symbol: lbl_802C5A68 */
/* 802C5A30  C0 02 C3 44 */	lfs f0, lit_3502(r2)                     /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C5A34  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 802C5A38  40 80 00 1C */	bge lbl_802C5A54                         /* constant-address: 802C5A54, symbol: lbl_802C5A54 */
/* 802C5A3C  80 6D 85 E0 */	lwz r3, data_80450B60(r13)               /* constant-address: 80450B60, symbol: data_80450B60 */
/* 802C5A40  3C A0 80 3A */	lis r5, CUTOFF_TO_IIR_TABLE__7JASCalc@ha
/* 802C5A44  38 A5 AB B8 */	addi r5, r5, CUTOFF_TO_IIR_TABLE__7JASCalc@l /* constant-address: 8039ABB8, symbol: CUTOFF_TO_IIR_TABLE__7JASCalc */
/* 802C5A48  38 A5 02 00 */	addi r5, r5, 0x200                       /* constant-address: 8039ADB8, symbol: None */
/* 802C5A4C  4B FE 48 25 */	bl setIIR__10Z2SoundMgrFP8JAISoundPCs    /* constant-address: 802AA270, symbol: setIIR__10Z2SoundMgrFP8JAISoundPCs */
/* 802C5A50  48 00 00 18 */	b lbl_802C5A68                           /* constant-address: 802C5A68, symbol: lbl_802C5A68 */
lbl_802C5A54:
/* 802C5A54  80 6D 85 E0 */	lwz r3, data_80450B60(r13)               /* constant-address: 80450B60, symbol: data_80450B60 */
/* 802C5A58  3C A0 80 3A */	lis r5, CUTOFF_TO_IIR_TABLE__7JASCalc@ha
/* 802C5A5C  38 A5 AB B8 */	addi r5, r5, CUTOFF_TO_IIR_TABLE__7JASCalc@l /* constant-address: 8039ABB8, symbol: CUTOFF_TO_IIR_TABLE__7JASCalc */
/* 802C5A60  38 A5 03 F8 */	addi r5, r5, 0x3f8                       /* constant-address: 8039AFB0, symbol: None */
/* 802C5A64  4B FE 48 0D */	bl setIIR__10Z2SoundMgrFP8JAISoundPCs    /* constant-address: 802AA270, symbol: setIIR__10Z2SoundMgrFP8JAISoundPCs */
lbl_802C5A68:
...
/* 802C5AA0  48 09 C7 89 */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

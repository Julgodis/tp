...
/* 802C58C8  41 82 00 24 */	beq lbl_802C58EC                         /* constant-address: 802C58EC, symbol: lbl_802C58EC */
/* 802C58CC  34 1E 00 04 */	addic. r0, r30, 4                       
/* 802C58D0  41 82 00 0C */	beq lbl_802C58DC                         /* constant-address: 802C58DC, symbol: lbl_802C58DC */
/* 802C58D4  38 7E 00 04 */	addi r3, r30, 4                         
/* 802C58D8  4B FD C8 AD */	bl releaseSound__14JAISoundHandleFv      /* constant-address: 802A2184, symbol: releaseSound__14JAISoundHandleFv */
lbl_802C58DC:
/* 802C58DC  7F E0 07 35 */	extsh. r0, r31                          
/* 802C58E0  40 81 00 0C */	ble lbl_802C58EC                         /* constant-address: 802C58EC, symbol: lbl_802C58EC */
/* 802C58E4  7F C3 F3 78 */	mr r3, r30                              
/* 802C58E8  48 00 94 55 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_802C58EC:

...
/* 802C7E9C  40 80 00 60 */	bge lbl_802C7EFC                         /* constant-address: 802C7EFC, symbol: lbl_802C7EFC */
/* 802C7EA0  90 9E 01 10 */	stw r4, 0x110(r30)                      
/* 802C7EA4  3C 60 00 09 */	lis r3, 0x0009 /* 0x00090029@ha */      
/* 802C7EA8  38 03 00 29 */	addi r0, r3, 0x0029 /* 0x00090029@l */   /* constant-address: 00090029 */
...
/* 802C7EBC  C8 22 C4 20 */	lfd f1, lit_4271(r2)                     /* constant-address: 80455E20, symbol: lit_4271 */
...
/* 802C7ED8  C0 02 C3 F4 */	lfs f0, lit_4260(r2)                     /* constant-address: 80455DF4, symbol: lit_4260 */
/* 802C7EDC  EC 21 00 24 */	fdivs f1, f1, f0                        
/* 802C7EE0  C0 42 C3 44 */	lfs f2, lit_3502(r2)                     /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C7EE4  C0 62 C3 60 */	lfs f3, lit_3574(r2)                     /* constant-address: 80455D60, symbol: lit_3574 */
/* 802C7EE8  C0 82 C3 48 */	lfs f4, lit_3503(r2)                     /* constant-address: 80455D48, symbol: lit_3503 */
/* 802C7EEC  FC A0 10 90 */	fmr f5, f2                              
/* 802C7EF0  38 A0 00 00 */	li r5, 0                                
/* 802C7EF4  4B FF DA 15 */	bl startEnvSe__11Z2EnvSeBaseF10JAISoundIDfffffUl /* constant-address: 802C5908, symbol: startEnvSe__11Z2EnvSeBaseF10JAISoundIDfffffUl */
/* 802C7EF8  48 00 00 94 */	b lbl_802C7F8C                           /* constant-address: 802C7F8C, symbol: lbl_802C7F8C */
lbl_802C7EFC:
/* 802C7EFC  C0 1E 00 68 */	lfs f0, 0x68(r30)                       
/* 802C7F00  C3 C2 C3 44 */	lfs f30, lit_3502(r2)                    /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C7F04  FC 00 F0 40 */	fcmpo cr0, f0, f30                      
/* 802C7F08  40 81 00 08 */	ble lbl_802C7F10                         /* constant-address: 802C7F10, symbol: lbl_802C7F10 */
/* 802C7F0C  48 00 00 18 */	b lbl_802C7F24                           /* constant-address: 802C7F24, symbol: lbl_802C7F24 */
lbl_802C7F10:
/* 802C7F10  C3 C2 C3 48 */	lfs f30, lit_3503(r2)                    /* constant-address: 80455D48, symbol: lit_3503 */
/* 802C7F14  FC 00 F0 40 */	fcmpo cr0, f0, f30                      
/* 802C7F18  40 80 00 08 */	bge lbl_802C7F20                         /* constant-address: 802C7F20, symbol: lbl_802C7F20 */
/* 802C7F1C  48 00 00 08 */	b lbl_802C7F24                           /* constant-address: 802C7F24, symbol: lbl_802C7F24 */
lbl_802C7F20:
/* 802C7F20  FF C0 00 90 */	fmr f30, f0                             
lbl_802C7F24:
/* 802C7F24  3C 60 00 09 */	lis r3, 0x0009 /* 0x0009002B@ha */      
/* 802C7F28  38 03 00 2B */	addi r0, r3, 0x002B /* 0x0009002B@l */   /* constant-address: 0009002B */
/* 802C7F2C  90 01 00 08 */	stw r0, 8(r1)                           
/* 802C7F30  38 7E 00 64 */	addi r3, r30, 0x64                      
/* 802C7F34  4B FE 6E 8D */	bl getDolbyPower__12Z2MultiSeMgrFv       /* constant-address: 802AEDC0, symbol: getDolbyPower__12Z2MultiSeMgrFv */
/* 802C7F38  FF E0 08 90 */	fmr f31, f1                             
/* 802C7F3C  38 7E 00 64 */	addi r3, r30, 0x64                      
/* 802C7F40  4B FE 6D A1 */	bl getPanPower__12Z2MultiSeMgrFv         /* constant-address: 802AECE0, symbol: getPanPower__12Z2MultiSeMgrFv */
...
/* 802C7F54  C8 22 C4 20 */	lfd f1, lit_4271(r2)                     /* constant-address: 80455E20, symbol: lit_4271 */
...
/* 802C7F70  C0 02 C3 F4 */	lfs f0, lit_4260(r2)                     /* constant-address: 80455DF4, symbol: lit_4260 */
/* 802C7F74  EC 21 00 24 */	fdivs f1, f1, f0                        
/* 802C7F78  FC 40 F0 90 */	fmr f2, f30                             
/* 802C7F7C  FC 80 F8 90 */	fmr f4, f31                             
/* 802C7F80  C0 A2 C3 44 */	lfs f5, lit_3502(r2)                     /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C7F84  38 A0 00 00 */	li r5, 0                                
/* 802C7F88  4B FF D9 81 */	bl startEnvSe__11Z2EnvSeBaseF10JAISoundIDfffffUl /* constant-address: 802C5908, symbol: startEnvSe__11Z2EnvSeBaseF10JAISoundIDfffffUl */
lbl_802C7F8C:

...
/* 802C5FB4  41 82 00 3C */	beq lbl_802C5FF0                         /* constant-address: 802C5FF0, symbol: lbl_802C5FF0 */
...
/* 802C5FCC  C0 02 C3 44 */	lfs f0, lit_3502(r2)                     /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C5FD0  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802C5FD4  40 81 00 50 */	ble lbl_802C6024                         /* constant-address: 802C6024, symbol: lbl_802C6024 */
/* 802C5FD8  C0 02 C3 70 */	lfs f0, lit_3704(r2)                     /* constant-address: 80455D70, symbol: lit_3704 */
...
/* 802C5FEC  48 00 00 38 */	b lbl_802C6024                           /* constant-address: 802C6024, symbol: lbl_802C6024 */
lbl_802C5FF0:
...
/* 802C6004  C0 02 C3 48 */	lfs f0, lit_3503(r2)                     /* constant-address: 80455D48, symbol: lit_3503 */
/* 802C6008  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802C600C  40 80 00 18 */	bge lbl_802C6024                         /* constant-address: 802C6024, symbol: lbl_802C6024 */
/* 802C6010  C0 02 C3 74 */	lfs f0, lit_3705(r2)                     /* constant-address: 80455D74, symbol: lit_3705 */
...
/* 802C602C  41 82 00 3C */	beq lbl_802C6068                         /* constant-address: 802C6068, symbol: lbl_802C6068 */
...
/* 802C6044  C0 02 C3 44 */	lfs f0, lit_3502(r2)                     /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C6048  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802C604C  40 81 00 50 */	ble lbl_802C609C                         /* constant-address: 802C609C, symbol: lbl_802C609C */
/* 802C6050  C0 02 C3 70 */	lfs f0, lit_3704(r2)                     /* constant-address: 80455D70, symbol: lit_3704 */
...
/* 802C6064  48 00 00 38 */	b lbl_802C609C                           /* constant-address: 802C609C, symbol: lbl_802C609C */
lbl_802C6068:
...
/* 802C607C  C0 02 C3 48 */	lfs f0, lit_3503(r2)                     /* constant-address: 80455D48, symbol: lit_3503 */
/* 802C6080  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 802C6084  40 80 00 18 */	bge lbl_802C609C                         /* constant-address: 802C609C, symbol: lbl_802C609C */
/* 802C6088  C0 02 C3 74 */	lfs f0, lit_3705(r2)                     /* constant-address: 80455D74, symbol: lit_3705 */
...
/* 802C60A4  41 82 00 28 */	beq lbl_802C60CC                         /* constant-address: 802C60CC, symbol: lbl_802C60CC */
/* 802C60A8  38 63 00 48 */	addi r3, r3, 0x48                       
/* 802C60AC  C0 3F 00 08 */	lfs f1, 8(r31)                          
/* 802C60B0  38 80 00 00 */	li r4, 0                                
/* 802C60B4  4B FD CE 09 */	bl movePan__18JAISoundParamsMoveFfUl     /* constant-address: 802A2EBC, symbol: movePan__18JAISoundParamsMoveFfUl */
...
/* 802C60C8  4B FD CE 4D */	bl moveDolby__18JAISoundParamsMoveFfUl   /* constant-address: 802A2F14, symbol: moveDolby__18JAISoundParamsMoveFfUl */
lbl_802C60CC:

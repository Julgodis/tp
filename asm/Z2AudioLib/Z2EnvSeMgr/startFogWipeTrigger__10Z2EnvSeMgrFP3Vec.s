...
/* 802C9318  41 82 00 68 */	beq lbl_802C9380                         /* constant-address: 802C9380, symbol: lbl_802C9380 */
/* 802C931C  48 00 00 C9 */	bl getFogDensity__10Z2EnvSeMgrFv         /* constant-address: 802C93E4, symbol: getFogDensity__10Z2EnvSeMgrFv */
/* 802C9320  FF E0 08 90 */	fmr f31, f1                             
/* 802C9324  7F C3 F3 78 */	mr r3, r30                              
/* 802C9328  48 00 00 BD */	bl getFogDensity__10Z2EnvSeMgrFv         /* constant-address: 802C93E4, symbol: getFogDensity__10Z2EnvSeMgrFv */
/* 802C932C  C0 02 C4 58 */	lfs f0, lit_4856(r2)                     /* constant-address: 80455E58, symbol: lit_4856 */
/* 802C9330  EC 20 00 72 */	fmuls f1, f0, f1                        
/* 802C9334  48 09 8D 79 */	bl __cvt_fp2unsigned                     /* constant-address: 803620AC, symbol: __cvt_fp2unsigned */
/* 802C9338  7C 67 1B 78 */	mr r7, r3                               
/* 802C933C  3C 60 00 09 */	lis r3, 0x0009 /* 0x00090035@ha */      
/* 802C9340  38 03 00 35 */	addi r0, r3, 0x0035 /* 0x00090035@l */   /* constant-address: 00090035 */
/* 802C9344  90 01 00 08 */	stw r0, 8(r1)                           
/* 802C9348  80 6D 85 F4 */	lwz r3, data_80450B74(r13)               /* constant-address: 80450B74, symbol: data_80450B74 */
/* 802C934C  38 81 00 08 */	addi r4, r1, 8                          
/* 802C9350  38 BE 02 10 */	addi r5, r30, 0x210                     
/* 802C9354  7F E6 FB 78 */	mr r6, r31                              
/* 802C9358  C0 22 C3 B0 */	lfs f1, lit_3763(r2)                     /* constant-address: 80455DB0, symbol: lit_3763 */
/* 802C935C  C0 42 C3 44 */	lfs f2, lit_3502(r2)                     /* constant-address: 80455D44, symbol: lit_3502 */
/* 802C9360  FC 60 F8 90 */	fmr f3, f31                             
/* 802C9364  C0 82 C3 74 */	lfs f4, lit_3705(r2)                     /* constant-address: 80455D74, symbol: lit_3705 */

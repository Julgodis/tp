...
/* 802AB0B4 0064 .text      __dt__14Z2SoundHandlesFv       __dt__14Z2SoundHandlesFv       */
...
/* 802AB120 00E0 .text      deleteHandlesPool__14Z2SoundHandlesFv deleteHandlesPool__14Z2SoundHandlesFv */
...
lbl_802AB184:
/* 802AB184 002A80C4  88 0D 8D C8 */	lbz r0, data_80451348-_SDA_BASE_(r13)
/* 802AB188 002A80C8  7C 00 07 75 */	extsb. r0, r0
/* 802AB18C 002A80CC  40 82 00 34 */	bne lbl_802AB1C0
/* 802AB190 002A80D0  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB194 002A80D4  38 63 41 C4 */	addi r3, r3, data_804341C4@l
/* 802AB198 002A80D8  4B FE 56 B1 */	bl __ct__17JASGenericMemPoolFv
/* 802AB19C 002A80DC  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB1A0 002A80E0  38 63 41 C4 */	addi r3, r3, data_804341C4@l
...
/* 802AB1BC 002A80FC  98 0D 8D C8 */	stb r0, data_80451348-_SDA_BASE_(r13)
lbl_802AB1C0:
/* 802AB1C0 002A8100  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB1C4 002A8104  38 63 41 C4 */	addi r3, r3, data_804341C4@l
...
/* 802AB254 004C .text      getHandleSoundID__14Z2SoundHandlesF10JAISoundID getHandleSoundID__14Z2SoundHandlesF10JAISoundID */
...
/* 802AB2A0 0038 .text      getHandleUserData__14Z2SoundHandlesFUl getHandleUserData__14Z2SoundHandlesFUl */
...
/* 802AB2D8 00F8 .text      getFreeHandle__14Z2SoundHandlesFv getFreeHandle__14Z2SoundHandlesFv */
...
/* 802AB328 002A8268  88 0D 8D C8 */	lbz r0, data_80451348-_SDA_BASE_(r13)
/* 802AB32C 002A826C  7C 00 07 75 */	extsb. r0, r0
/* 802AB330 002A8270  40 82 00 34 */	bne lbl_802AB364
/* 802AB334 002A8274  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB338 002A8278  38 63 41 C4 */	addi r3, r3, data_804341C4@l
/* 802AB33C 002A827C  4B FE 55 0D */	bl __ct__17JASGenericMemPoolFv
/* 802AB340 002A8280  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB344 002A8284  38 63 41 C4 */	addi r3, r3, data_804341C4@l
...
/* 802AB360 002A82A0  98 0D 8D C8 */	stb r0, data_80451348-_SDA_BASE_(r13)
lbl_802AB364:
/* 802AB364 002A82A4  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB368 002A82A8  38 63 41 C4 */	addi r3, r3, data_804341C4@l
...
/* 802AB3D0 00D0 .text      getLowPrioSound__14Z2SoundHandlesF10JAISoundID getLowPrioSound__14Z2SoundHandlesF10JAISoundID */
...
/* 802AB4A0 0064 .text      stopAllSounds__14Z2SoundHandlesFUl stopAllSounds__14Z2SoundHandlesFUl */
...
/* 802AB504 0034 .text      isActive__14Z2SoundHandlesCFv  isActive__14Z2SoundHandlesCFv  */
...
lbl_802AB5D8:
/* 802AB5D8 002A8518  88 0D 8D C8 */	lbz r0, data_80451348-_SDA_BASE_(r13)
/* 802AB5DC 002A851C  7C 00 07 75 */	extsb. r0, r0
/* 802AB5E0 002A8520  40 82 00 34 */	bne lbl_802AB614
/* 802AB5E4 002A8524  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB5E8 002A8528  38 63 41 C4 */	addi r3, r3, data_804341C4@l
/* 802AB5EC 002A852C  4B FE 52 5D */	bl __ct__17JASGenericMemPoolFv
/* 802AB5F0 002A8530  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB5F4 002A8534  38 63 41 C4 */	addi r3, r3, data_804341C4@l
...
/* 802AB610 002A8550  98 0D 8D C8 */	stb r0, data_80451348-_SDA_BASE_(r13)
lbl_802AB614:
/* 802AB614 002A8554  3C 60 80 43 */	lis r3, data_804341C4@ha
/* 802AB618 002A8558  38 63 41 C4 */	addi r3, r3, data_804341C4@l

...
/* 80262B18  40 82 00 50 */	bne lbl_80262B68                         /* constant-address: 80262B68, symbol: lbl_80262B68 */
/* 80262B1C  80 1F 00 10 */	lwz r0, 0x10(r31)                       
/* 80262B20  28 00 00 00 */	cmplwi r0, 0                            
/* 80262B24  41 82 00 0C */	beq lbl_80262B30                         /* constant-address: 80262B30, symbol: lbl_80262B30 */
/* 80262B28  38 60 00 01 */	li r3, 1                                
/* 80262B2C  48 00 00 84 */	b lbl_80262BB0                           /* constant-address: 80262BB0, symbol: lbl_80262BB0 */
lbl_80262B30:
/* 80262B30  3C 60 80 26 */	lis r3, callback__20DynamicModuleControlFPv@ha
/* 80262B34  38 63 27 94 */	addi r3, r3, callback__20DynamicModuleControlFPv@l /* constant-address: 80262794, symbol: callback__20DynamicModuleControlFPv */
/* 80262B38  7F E4 FB 78 */	mr r4, r31                              
/* 80262B3C  4B DB 31 39 */	bl create__20mDoDvdThd_callback_cFPFPv_PvPv /* constant-address: 80015C74, symbol: create__20mDoDvdThd_callback_cFPFPv_PvPv */
/* 80262B40  90 7F 00 28 */	stw r3, 0x28(r31)                       
/* 80262B44  80 1F 00 28 */	lwz r0, 0x28(r31)                       
/* 80262B48  28 00 00 00 */	cmplwi r0, 0                            
/* 80262B4C  40 82 00 1C */	bne lbl_80262B68                         /* constant-address: 80262B68, symbol: lbl_80262B68 */
/* 80262B50  3C 60 80 3A */	lis r3, DynamicLink__stringBase0@ha     
/* 80262B54  38 63 A4 A0 */	addi r3, r3, DynamicLink__stringBase0@l  /* constant-address: 8039A4A0, symbol: DynamicLink__stringBase0 */
/* 80262B58  38 63 01 DF */	addi r3, r3, 0x1df                       /* constant-address: 8039A67F, symbol: None */
/* 80262B5C  80 9F 00 1C */	lwz r4, 0x1c(r31)                       
/* 80262B60  4C C6 31 82 */	crclr 6                                 
/* 80262B64  4B DA 40 A9 */	bl OSReport_Error                        /* constant-address: 80006C0C, symbol: OSReport_Error */
lbl_80262B68:
/* 80262B68  80 7F 00 28 */	lwz r3, 0x28(r31)                       
/* 80262B6C  28 03 00 00 */	cmplwi r3, 0                            
/* 80262B70  41 82 00 3C */	beq lbl_80262BAC                         /* constant-address: 80262BAC, symbol: lbl_80262BAC */
/* 80262B74  88 03 00 0C */	lbz r0, 0xc(r3)                         
/* 80262B78  2C 00 00 00 */	cmpwi r0, 0                             
/* 80262B7C  41 82 00 30 */	beq lbl_80262BAC                         /* constant-address: 80262BAC, symbol: lbl_80262BAC */
/* 80262B80  28 03 00 00 */	cmplwi r3, 0                            
/* 80262B84  41 82 00 18 */	beq lbl_80262B9C                         /* constant-address: 80262B9C, symbol: lbl_80262B9C */
...
/* 80262BA8  48 00 00 08 */	b lbl_80262BB0                           /* constant-address: 80262BB0, symbol: lbl_80262BB0 */
lbl_80262BAC:

...
/* 80262F40  48 0D F7 BD */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
...
/* 80262F54  48 0D F7 A9 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
/* 80262F58  80 7E 00 10 */	lwz r3, 0x10(r30)                       
/* 80262F5C  48 0D B8 4D */	bl OSUnlink                              /* constant-address: 8033E7A8, symbol: OSUnlink */
/* 80262F60  7C 7F 1B 78 */	mr r31, r3                              
/* 80262F64  48 0D F7 99 */	bl OSGetTime                             /* constant-address: 803426FC, symbol: OSGetTime */
/* 80262F68  2C 1F 00 00 */	cmpwi r31, 0                            
/* 80262F6C  40 82 00 28 */	bne lbl_80262F94                         /* constant-address: 80262F94, symbol: lbl_80262F94 */
/* 80262F70  3C 60 80 3A */	lis r3, DynamicLink__stringBase0@ha     
/* 80262F74  38 63 A4 A0 */	addi r3, r3, DynamicLink__stringBase0@l  /* constant-address: 8039A4A0, symbol: DynamicLink__stringBase0 */
/* 80262F78  38 63 02 97 */	addi r3, r3, 0x297                       /* constant-address: 8039A737, symbol: None */
/* 80262F7C  80 9E 00 10 */	lwz r4, 0x10(r30)                       
/* 80262F80  80 BE 00 14 */	lwz r5, 0x14(r30)                       
/* 80262F84  4C C6 31 82 */	crclr 6                                 
/* 80262F88  4B DA 3C 85 */	bl OSReport_Error                        /* constant-address: 80006C0C, symbol: OSReport_Error */
/* 80262F8C  38 60 00 00 */	li r3, 0                                
/* 80262F90  48 00 00 58 */	b lbl_80262FE8                           /* constant-address: 80262FE8, symbol: lbl_80262FE8 */
lbl_80262F94:
...
/* 80262FA8  80 0D 8B C0 */	lwz r0, sAllocBytes__20DynamicModuleControl(r13) /* constant-address: 80451140, symbol: sAllocBytes__20DynamicModuleControl */
/* 80262FAC  7C 03 00 50 */	subf r0, r3, r0                         
/* 80262FB0  90 0D 8B C0 */	stw r0, sAllocBytes__20DynamicModuleControl(r13) /* constant-address: 80451140, symbol: sAllocBytes__20DynamicModuleControl */
/* 80262FB4  80 7E 00 14 */	lwz r3, 0x14(r30)                       
/* 80262FB8  28 03 00 00 */	cmplwi r3, 0                            
/* 80262FBC  41 82 00 14 */	beq lbl_80262FD0                         /* constant-address: 80262FD0, symbol: lbl_80262FD0 */
/* 80262FC0  38 80 00 00 */	li r4, 0                                
/* 80262FC4  48 06 B5 3D */	bl free__7JKRHeapFPvP7JKRHeap            /* constant-address: 802CE500, symbol: free__7JKRHeapFPvP7JKRHeap */

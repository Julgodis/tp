...
/* 80262C20  41 82 00 2C */	beq lbl_80262C4C                         /* constant-address: 80262C4C, symbol: lbl_80262C4C */
...
/* 80262C34  38 63 A4 A0 */	addi r3, r3, DynamicLink__stringBase0@l  /* constant-address: 8039A4A0, symbol: DynamicLink__stringBase0 */
/* 80262C38  38 63 02 2E */	addi r3, r3, 0x22e                       /* constant-address: 8039A6CE, symbol: None */
/* 80262C3C  80 06 00 0C */	lwz r0, 0xc(r6)                         
/* 80262C40  7C C5 02 14 */	add r6, r5, r0                          
/* 80262C44  4C C6 31 82 */	crclr 6                                 
/* 80262C48  4B DA 3E 75 */	bl OSReport                              /* constant-address: 80006ABC, symbol: OSReport */
lbl_80262C4C:

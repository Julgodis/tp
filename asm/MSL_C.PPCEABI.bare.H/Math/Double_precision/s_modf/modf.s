...
/* 8036C4B0  40 80 00 70 */	bge lbl_8036C520                         /* constant-address: 8036C520, symbol: lbl_8036C520 */
/* 8036C4B4  2C 07 00 00 */	cmpwi r7, 0                             
/* 8036C4B8  40 80 00 18 */	bge lbl_8036C4D0                         /* constant-address: 8036C4D0, symbol: lbl_8036C4D0 */
...
/* 8036C4CC  48 00 00 BC */	b lbl_8036C588                           /* constant-address: 8036C588, symbol: lbl_8036C588 */
lbl_8036C4D0:
/* 8036C4D0  3C 80 00 10 */	lis r4, 0x0010 /* 0x000FFFFF@ha */      
/* 8036C4D4  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x000FFFFF@l */   /* constant-address: 000FFFFF */
/* 8036C4D8  7C 04 3E 30 */	sraw r4, r0, r7                         
/* 8036C4DC  7C A0 20 38 */	and r0, r5, r4                          
/* 8036C4E0  7C C0 03 79 */	or. r0, r6, r0                          
/* 8036C4E4  40 82 00 20 */	bne lbl_8036C504                         /* constant-address: 8036C504, symbol: lbl_8036C504 */
...
/* 8036C500  48 00 00 88 */	b lbl_8036C588                           /* constant-address: 8036C588, symbol: lbl_8036C588 */
lbl_8036C504:
...
/* 8036C51C  48 00 00 6C */	b lbl_8036C588                           /* constant-address: 8036C588, symbol: lbl_8036C588 */
lbl_8036C520:
/* 8036C520  2C 07 00 33 */	cmpwi r7, 0x33                          
/* 8036C524  40 81 00 20 */	ble lbl_8036C544                         /* constant-address: 8036C544, symbol: lbl_8036C544 */
...
/* 8036C540  48 00 00 48 */	b lbl_8036C588                           /* constant-address: 8036C588, symbol: lbl_8036C588 */
lbl_8036C544:
...
/* 8036C554  40 82 00 20 */	bne lbl_8036C574                         /* constant-address: 8036C574, symbol: lbl_8036C574 */
...
/* 8036C570  48 00 00 18 */	b lbl_8036C588                           /* constant-address: 8036C588, symbol: lbl_8036C588 */
lbl_8036C574:

...
/* 8036A718  38 04 21 FB */	addi r0, r4, 0x21FB /* 0x3FE921FB@l */   /* constant-address: 3FE921FB */
...
/* 8036A738  41 81 00 18 */	bgt lbl_8036A750                         /* constant-address: 8036A750, symbol: lbl_8036A750 */
/* 8036A73C  D8 3E 00 00 */	stfd f1, 0(r30)                         
/* 8036A740  38 60 00 00 */	li r3, 0                                
/* 8036A744  C8 02 CF 68 */	lfd f0, lit_145(r2)                      /* constant-address: 80456968, symbol: lit_145 */
/* 8036A748  D8 1E 00 08 */	stfd f0, 8(r30)                         
/* 8036A74C  48 00 03 44 */	b lbl_8036AA90                           /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
lbl_8036A750:
/* 8036A750  3C 60 40 03 */	lis r3, 0x4003 /* 0x4002D97C@ha */      
/* 8036A754  38 03 D9 7C */	addi r0, r3, 0xD97C /* 0x4002D97C@l */   /* constant-address: 4002D97C */
/* 8036A758  7C 06 00 00 */	cmpw r6, r0                             
/* 8036A75C  40 80 00 DC */	bge lbl_8036A838                         /* constant-address: 8036A838, symbol: lbl_8036A838 */
/* 8036A760  2C 1F 00 00 */	cmpwi r31, 0                            
/* 8036A764  40 81 00 6C */	ble lbl_8036A7D0                         /* constant-address: 8036A7D0, symbol: lbl_8036A7D0 */
/* 8036A768  C8 02 CF 70 */	lfd f0, lit_146(r2)                      /* constant-address: 80456970, symbol: lit_146 */
...
/* 8036A77C  41 82 00 24 */	beq lbl_8036A7A0                         /* constant-address: 8036A7A0, symbol: lbl_8036A7A0 */
/* 8036A780  C8 22 CF 78 */	lfd f1, lit_147(r2)                      /* constant-address: 80456978, symbol: lit_147 */
...
/* 8036A79C  48 00 00 2C */	b lbl_8036A7C8                           /* constant-address: 8036A7C8, symbol: lbl_8036A7C8 */
lbl_8036A7A0:
/* 8036A7A0  C8 02 CF 80 */	lfd f0, lit_148(r2)                      /* constant-address: 80456980, symbol: lit_148 */
/* 8036A7A4  C8 22 CF 88 */	lfd f1, lit_149(r2)                      /* constant-address: 80456988, symbol: lit_149 */
...
/* 8036A7CC  48 00 02 C4 */	b lbl_8036AA90                           /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
lbl_8036A7D0:
/* 8036A7D0  C8 02 CF 70 */	lfd f0, lit_146(r2)                      /* constant-address: 80456970, symbol: lit_146 */
...
/* 8036A7E4  41 82 00 24 */	beq lbl_8036A808                         /* constant-address: 8036A808, symbol: lbl_8036A808 */
/* 8036A7E8  C8 22 CF 78 */	lfd f1, lit_147(r2)                      /* constant-address: 80456978, symbol: lit_147 */
...
/* 8036A804  48 00 00 2C */	b lbl_8036A830                           /* constant-address: 8036A830, symbol: lbl_8036A830 */
lbl_8036A808:
/* 8036A808  C8 02 CF 80 */	lfd f0, lit_148(r2)                      /* constant-address: 80456980, symbol: lit_148 */
/* 8036A80C  C8 22 CF 88 */	lfd f1, lit_149(r2)                      /* constant-address: 80456988, symbol: lit_149 */
...
/* 8036A834  48 00 02 5C */	b lbl_8036AA90                           /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
lbl_8036A838:
/* 8036A838  3C 60 41 39 */	lis r3, 0x4139 /* 0x413921FB@ha */      
/* 8036A83C  38 03 21 FB */	addi r0, r3, 0x21FB /* 0x413921FB@l */   /* constant-address: 413921FB */
/* 8036A840  7C 06 00 00 */	cmpw r6, r0                             
/* 8036A844  41 81 01 3C */	bgt lbl_8036A980                         /* constant-address: 8036A980, symbol: lbl_8036A980 */
/* 8036A848  FC 80 0A 10 */	fabs f4, f1                             
/* 8036A84C  3C 00 43 30 */	lis r0, 0x4330                          
/* 8036A850  C8 22 CF 98 */	lfd f1, lit_151(r2)                      /* constant-address: 80456998, symbol: lit_151 */
/* 8036A854  C8 02 CF 90 */	lfd f0, lit_150(r2)                      /* constant-address: 80456990, symbol: lit_150 */
/* 8036A858  90 01 00 38 */	stw r0, 0x38(r1)                        
/* 8036A85C  FC 41 01 3A */	fmadd f2, f1, f4, f0                    
/* 8036A860  C8 62 CF B8 */	lfd f3, lit_157(r2)                      /* constant-address: 804569B8, symbol: lit_157 */
/* 8036A864  C8 22 CF 70 */	lfd f1, lit_146(r2)                      /* constant-address: 80456970, symbol: lit_146 */
/* 8036A868  C8 02 CF 78 */	lfd f0, lit_147(r2)                      /* constant-address: 80456978, symbol: lit_147 */
...
/* 8036A894  40 80 00 2C */	bge lbl_8036A8C0                         /* constant-address: 8036A8C0, symbol: lbl_8036A8C0 */
/* 8036A898  3C 80 80 3A */	lis r4, npio2_hw@ha                     
/* 8036A89C  54 60 10 3A */	slwi r0, r3, 2                          
/* 8036A8A0  38 84 24 B8 */	addi r4, r4, npio2_hw@l                  /* constant-address: 803A24B8, symbol: npio2_hw */
/* 8036A8A4  7C 84 02 14 */	add r4, r4, r0                          
/* 8036A8A8  80 04 FF FC */	lwz r0, -4(r4)                          
/* 8036A8AC  7C 06 00 00 */	cmpw r6, r0                             
/* 8036A8B0  41 82 00 10 */	beq lbl_8036A8C0                         /* constant-address: 8036A8C0, symbol: lbl_8036A8C0 */
/* 8036A8B4  FC 04 08 28 */	fsub f0, f4, f1                         
/* 8036A8B8  D8 1E 00 00 */	stfd f0, 0(r30)                         
/* 8036A8BC  48 00 00 88 */	b lbl_8036A944                           /* constant-address: 8036A944, symbol: lbl_8036A944 */
lbl_8036A8C0:
...
/* 8036A8DC  40 81 00 68 */	ble lbl_8036A944                         /* constant-address: 8036A944, symbol: lbl_8036A944 */
/* 8036A8E0  C8 02 CF 80 */	lfd f0, lit_148(r2)                      /* constant-address: 80456980, symbol: lit_148 */
/* 8036A8E4  FC 60 20 90 */	fmr f3, f4                              
/* 8036A8E8  C8 22 CF 88 */	lfd f1, lit_149(r2)                      /* constant-address: 80456988, symbol: lit_149 */
...
/* 8036A918  40 81 00 2C */	ble lbl_8036A944                         /* constant-address: 8036A944, symbol: lbl_8036A944 */
/* 8036A91C  C8 02 CF A0 */	lfd f0, lit_152(r2)                      /* constant-address: 804569A0, symbol: lit_152 */
/* 8036A920  FC 40 20 90 */	fmr f2, f4                              
/* 8036A924  C8 22 CF A8 */	lfd f1, lit_153(r2)                      /* constant-address: 804569A8, symbol: lit_153 */
...
/* 8036A958  40 80 01 38 */	bge lbl_8036AA90                         /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
...
/* 8036A978  48 00 01 18 */	b lbl_8036AA90                           /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
/* 8036A97C  48 00 01 14 */	b lbl_8036AA90                           /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
lbl_8036A980:
/* 8036A980  3C 00 7F F0 */	lis r0, 0x7ff0                          
/* 8036A984  7C 06 00 00 */	cmpw r6, r0                             
/* 8036A988  41 80 00 18 */	blt lbl_8036A9A0                         /* constant-address: 8036A9A0, symbol: lbl_8036A9A0 */
...
/* 8036A99C  48 00 00 F4 */	b lbl_8036AA90                           /* constant-address: 8036AA90, symbol: lbl_8036AA90 */
lbl_8036A9A0:
...
/* 8036A9BC  C8 A2 CF B8 */	lfd f5, lit_157(r2)                      /* constant-address: 804569B8, symbol: lit_157 */
/* 8036A9C0  90 81 00 14 */	stw r4, 0x14(r1)                        
/* 8036A9C4  38 81 00 30 */	addi r4, r1, 0x30                       
/* 8036A9C8  C8 82 CF B0 */	lfd f4, lit_154(r2)                      /* constant-address: 804569B0, symbol: lit_154 */
/* 8036A9CC  38 C0 00 03 */	li r6, 3                                
/* 8036A9D0  90 61 00 10 */	stw r3, 0x10(r1)                        
/* 8036A9D4  C8 22 CF 68 */	lfd f1, lit_145(r2)                      /* constant-address: 80456968, symbol: lit_145 */
...
/* 8036AA3C  48 00 00 0C */	b lbl_8036AA48                           /* constant-address: 8036AA48, symbol: lbl_8036AA48 */
lbl_8036AA40:
/* 8036AA40  38 84 FF F8 */	addi r4, r4, -8                         
/* 8036AA44  38 C6 FF FF */	addi r6, r6, -1                          /* constant-address: 00000002 */
lbl_8036AA48:
/* 8036AA48  C8 04 FF F8 */	lfd f0, -8(r4)                          
/* 8036AA4C  FC 01 00 00 */	fcmpu cr0, f1, f0                       
/* 8036AA50  41 82 FF F0 */	beq lbl_8036AA40                         /* constant-address: 8036AA40, symbol: lbl_8036AA40 */
/* 8036AA54  3C 60 80 3A */	lis r3, two_over_pi@ha                  
/* 8036AA58  7F C4 F3 78 */	mr r4, r30                              
/* 8036AA5C  39 03 23 B0 */	addi r8, r3, two_over_pi@l               /* constant-address: 803A23B0, symbol: two_over_pi */
/* 8036AA60  38 E0 00 02 */	li r7, 2                                
/* 8036AA64  38 61 00 18 */	addi r3, r1, 0x18                       
/* 8036AA68  48 00 01 35 */	bl __kernel_rem_pio2                     /* constant-address: 8036AB9C, symbol: __kernel_rem_pio2 */
/* 8036AA6C  2C 1F 00 00 */	cmpwi r31, 0                            
/* 8036AA70  40 80 00 20 */	bge lbl_8036AA90                         /* constant-address: 8036AA90, symbol: lbl_8036AA90 */

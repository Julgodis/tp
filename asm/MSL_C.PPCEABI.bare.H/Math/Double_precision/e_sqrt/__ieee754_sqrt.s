...
/* 8036C7BC  40 82 00 14 */	bne lbl_8036C7D0                         /* constant-address: 8036C7D0, symbol: lbl_8036C7D0 */
/* 8036C7C0  FC 21 08 7A */	fmadd f1, f1, f1, f1                    
/* 8036C7C4  38 00 00 21 */	li r0, 0x21                             
/* 8036C7C8  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 8036C7CC  48 00 01 F0 */	b lbl_8036C9BC                           /* constant-address: 8036C9BC, symbol: lbl_8036C9BC */
lbl_8036C7D0:
/* 8036C7D0  2C 06 00 00 */	cmpwi r6, 0                             
/* 8036C7D4  41 81 00 30 */	bgt lbl_8036C804                         /* constant-address: 8036C804, symbol: lbl_8036C804 */
/* 8036C7D8  54 C3 00 7E */	clrlwi r3, r6, 1                        
/* 8036C7DC  7C 03 1B 79 */	or. r3, r0, r3                          
/* 8036C7E0  40 82 00 08 */	bne lbl_8036C7E8                         /* constant-address: 8036C7E8, symbol: lbl_8036C7E8 */
/* 8036C7E4  48 00 01 D8 */	b lbl_8036C9BC                           /* constant-address: 8036C9BC, symbol: lbl_8036C9BC */
lbl_8036C7E8:
/* 8036C7E8  2C 06 00 00 */	cmpwi r6, 0                             
/* 8036C7EC  40 80 00 18 */	bge lbl_8036C804                         /* constant-address: 8036C804, symbol: lbl_8036C804 */
/* 8036C7F0  3C 60 80 45 */	lis r3, __float_nan@ha                  
/* 8036C7F4  38 00 00 21 */	li r0, 0x21                             
/* 8036C7F8  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 8036C7FC  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)                /* constant-address: 80450AE0, symbol: __float_nan */
/* 8036C800  48 00 01 BC */	b lbl_8036C9BC                           /* constant-address: 8036C9BC, symbol: lbl_8036C9BC */
lbl_8036C804:
/* 8036C804  7C C3 A6 71 */	srawi. r3, r6, 0x14                     
/* 8036C808  40 82 00 50 */	bne lbl_8036C858                         /* constant-address: 8036C858, symbol: lbl_8036C858 */
/* 8036C80C  48 00 00 14 */	b lbl_8036C820                           /* constant-address: 8036C820, symbol: lbl_8036C820 */
lbl_8036C810:
...
/* 8036C824  41 82 FF EC */	beq lbl_8036C810                         /* constant-address: 8036C810, symbol: lbl_8036C810 */
/* 8036C828  38 E0 00 00 */	li r7, 0                                
/* 8036C82C  48 00 00 0C */	b lbl_8036C838                           /* constant-address: 8036C838, symbol: lbl_8036C838 */
lbl_8036C830:
/* 8036C830  54 C6 08 3C */	slwi r6, r6, 1                          
/* 8036C834  38 E7 00 01 */	addi r7, r7, 1                           /* constant-address: 00000001 */
lbl_8036C838:
/* 8036C838  54 C4 02 D7 */	rlwinm. r4, r6, 0, 0xb, 0xb             
/* 8036C83C  41 82 FF F4 */	beq lbl_8036C830                         /* constant-address: 8036C830, symbol: lbl_8036C830 */
...
/* 8036C868  41 82 00 14 */	beq lbl_8036C87C                         /* constant-address: 8036C87C, symbol: lbl_8036C87C */
...
/* 8036C8A0  48 00 00 30 */	b lbl_8036C8D0                           /* constant-address: 8036C8D0, symbol: lbl_8036C8D0 */
lbl_8036C8A4:
/* 8036C8A4  7C 8B 32 14 */	add r4, r11, r6                         
/* 8036C8A8  7C 04 28 00 */	cmpw r4, r5                             
/* 8036C8AC  41 81 00 10 */	bgt lbl_8036C8BC                         /* constant-address: 8036C8BC, symbol: lbl_8036C8BC */
...
/* 8036C8D4  40 82 FF D0 */	bne lbl_8036C8A4                         /* constant-address: 8036C8A4, symbol: lbl_8036C8A4 */
/* 8036C8D8  3C C0 80 00 */	lis r6, 0x8000                          
/* 8036C8DC  48 00 00 6C */	b lbl_8036C948                           /* constant-address: 8036C948, symbol: lbl_8036C948 */
lbl_8036C8E0:
/* 8036C8E0  7C 0B 28 00 */	cmpw r11, r5                            
/* 8036C8E4  7D 67 5B 78 */	mr r7, r11                              
/* 8036C8E8  7D 09 32 14 */	add r8, r9, r6                          
/* 8036C8EC  41 80 00 10 */	blt lbl_8036C8FC                         /* constant-address: 8036C8FC, symbol: lbl_8036C8FC */
/* 8036C8F0  40 82 00 44 */	bne lbl_8036C934                         /* constant-address: 8036C934, symbol: lbl_8036C934 */
/* 8036C8F4  7C 08 00 40 */	cmplw r8, r0                            
/* 8036C8F8  41 81 00 3C */	bgt lbl_8036C934                         /* constant-address: 8036C934, symbol: lbl_8036C934 */
lbl_8036C8FC:
...
/* 8036C90C  40 82 00 10 */	bne lbl_8036C91C                         /* constant-address: 8036C91C, symbol: lbl_8036C91C */
/* 8036C910  55 24 00 01 */	rlwinm. r4, r9, 0, 0, 0                 
/* 8036C914  40 82 00 08 */	bne lbl_8036C91C                         /* constant-address: 8036C91C, symbol: lbl_8036C91C */
/* 8036C918  39 6B 00 01 */	addi r11, r11, 1                         /* constant-address: 00000001 */
lbl_8036C91C:
/* 8036C91C  7C 00 40 40 */	cmplw r0, r8                            
/* 8036C920  7C A7 28 50 */	subf r5, r7, r5                         
/* 8036C924  40 80 00 08 */	bge lbl_8036C92C                         /* constant-address: 8036C92C, symbol: lbl_8036C92C */
...
/* 8036C94C  40 82 FF 94 */	bne lbl_8036C8E0                         /* constant-address: 8036C8E0, symbol: lbl_8036C8E0 */
/* 8036C950  7C A0 03 79 */	or. r0, r5, r0                          
/* 8036C954  41 82 00 30 */	beq lbl_8036C984                         /* constant-address: 8036C984, symbol: lbl_8036C984 */
/* 8036C958  C8 02 D1 48 */	lfd f0, lit_164(r2)                      /* constant-address: 80456B48, symbol: lit_164 */
...
/* 8036C96C  40 82 00 10 */	bne lbl_8036C97C                         /* constant-address: 8036C97C, symbol: lbl_8036C97C */
/* 8036C970  39 40 00 00 */	li r10, 0                               
/* 8036C974  39 8C 00 01 */	addi r12, r12, 1                         /* constant-address: 00000001 */
/* 8036C978  48 00 00 0C */	b lbl_8036C984                           /* constant-address: 8036C984, symbol: lbl_8036C984 */
lbl_8036C97C:
...
/* 8036C998  40 82 00 08 */	bne lbl_8036C9A0                         /* constant-address: 8036C9A0, symbol: lbl_8036C9A0 */

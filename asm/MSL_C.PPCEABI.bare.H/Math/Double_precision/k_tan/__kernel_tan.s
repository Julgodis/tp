...
/* 8036BAB0  40 80 00 54 */	bge lbl_8036BB04                         /* constant-address: 8036BB04, symbol: lbl_8036BB04 */
...
/* 8036BAC4  40 82 00 40 */	bne lbl_8036BB04                         /* constant-address: 8036BB04, symbol: lbl_8036BB04 */
...
/* 8036BAD8  40 82 00 14 */	bne lbl_8036BAEC                         /* constant-address: 8036BAEC, symbol: lbl_8036BAEC */
/* 8036BADC  FC 20 0A 10 */	fabs f1, f1                             
/* 8036BAE0  C8 02 D0 80 */	lfd f0, lit_94(r2)                       /* constant-address: 80456A80, symbol: lit_94 */
/* 8036BAE4  FC 20 08 24 */	fdiv f1, f0, f1                         
/* 8036BAE8  48 00 01 AC */	b lbl_8036BC94                           /* constant-address: 8036BC94, symbol: lbl_8036BC94 */
lbl_8036BAEC:
/* 8036BAEC  2C 03 00 01 */	cmpwi r3, 1                             
/* 8036BAF0  40 82 00 08 */	bne lbl_8036BAF8                         /* constant-address: 8036BAF8, symbol: lbl_8036BAF8 */
/* 8036BAF4  48 00 01 A0 */	b lbl_8036BC94                           /* constant-address: 8036BC94, symbol: lbl_8036BC94 */
lbl_8036BAF8:
/* 8036BAF8  C8 02 D0 88 */	lfd f0, lit_95(r2)                       /* constant-address: 80456A88, symbol: lit_95 */
/* 8036BAFC  FC 20 08 24 */	fdiv f1, f0, f1                         
/* 8036BB00  48 00 01 94 */	b lbl_8036BC94                           /* constant-address: 8036BC94, symbol: lbl_8036BC94 */
lbl_8036BB04:
/* 8036BB04  3C 80 3F E6 */	lis r4, 0x3FE6 /* 0x3FE59428@ha */      
/* 8036BB08  38 04 94 28 */	addi r0, r4, 0x9428 /* 0x3FE59428@l */   /* constant-address: 3FE59428 */
/* 8036BB0C  7C 06 00 00 */	cmpw r6, r0                             
/* 8036BB10  41 80 00 40 */	blt lbl_8036BB50                         /* constant-address: 8036BB50, symbol: lbl_8036BB50 */
/* 8036BB14  2C 07 00 00 */	cmpwi r7, 0                             
/* 8036BB18  40 80 00 14 */	bge lbl_8036BB2C                         /* constant-address: 8036BB2C, symbol: lbl_8036BB2C */
...
lbl_8036BB2C:
/* 8036BB2C  C8 02 D0 98 */	lfd f0, lit_97(r2)                       /* constant-address: 80456A98, symbol: lit_97 */
/* 8036BB30  C8 62 D0 90 */	lfd f3, lit_96(r2)                       /* constant-address: 80456A90, symbol: lit_96 */
/* 8036BB34  C8 21 00 08 */	lfd f1, 8(r1)                           
/* 8036BB38  FC 00 10 28 */	fsub f0, f0, f2                         
/* 8036BB3C  C8 42 D0 A0 */	lfd f2, lit_98(r2)                       /* constant-address: 80456AA0, symbol: lit_98 */
...
/* 8036BB58  38 A4 25 88 */	addi r5, r4, T@l                         /* constant-address: 803A2588, symbol: T */
/* 8036BB5C  3C 80 3F E6 */	lis r4, 0x3FE6 /* 0x3FE59428@ha */      
/* 8036BB60  FD A0 00 32 */	fmul f13, f0, f0                        
/* 8036BB64  38 04 94 28 */	addi r0, r4, 0x9428 /* 0x3FE59428@l */   /* constant-address: 3FE59428 */
/* 8036BB68  C8 A5 00 60 */	lfd f5, 0x60(r5)                         /* constant-address: 803A25E8, symbol: None */
/* 8036BB6C  7C 06 00 00 */	cmpw r6, r0                             
/* 8036BB70  C8 85 00 50 */	lfd f4, 0x50(r5)                         /* constant-address: 803A25D8, symbol: None */
/* 8036BB74  C9 25 00 58 */	lfd f9, 0x58(r5)                         /* constant-address: 803A25E0, symbol: None */
/* 8036BB78  FF ED 03 72 */	fmul f31, f13, f13                      
/* 8036BB7C  C9 05 00 48 */	lfd f8, 0x48(r5)                         /* constant-address: 803A25D0, symbol: None */
/* 8036BB80  C8 65 00 40 */	lfd f3, 0x40(r5)                         /* constant-address: 803A25C8, symbol: None */
/* 8036BB84  C9 65 00 38 */	lfd f11, 0x38(r5)                        /* constant-address: 803A25C0, symbol: None */
/* 8036BB88  FC 2D 00 32 */	fmul f1, f13, f0                        
/* 8036BB8C  C8 C5 00 30 */	lfd f6, 0x30(r5)                         /* constant-address: 803A25B8, symbol: None */
/* 8036BB90  FC FF 21 7A */	fmadd f7, f31, f5, f4                   
/* 8036BB94  C9 45 00 28 */	lfd f10, 0x28(r5)                        /* constant-address: 803A25B0, symbol: None */
/* 8036BB98  C8 A5 00 20 */	lfd f5, 0x20(r5)                         /* constant-address: 803A25A8, symbol: None */
/* 8036BB9C  FD 9F 42 7A */	fmadd f12, f31, f9, f8                  
/* 8036BBA0  C9 25 00 18 */	lfd f9, 0x18(r5)                         /* constant-address: 803A25A0, symbol: None */
/* 8036BBA4  C8 85 00 10 */	lfd f4, 0x10(r5)                         /* constant-address: 803A2598, symbol: None */
/* 8036BBA8  FC FF 19 FA */	fmadd f7, f31, f7, f3                   
/* 8036BBAC  C9 05 00 08 */	lfd f8, 8(r5)                            /* constant-address: 803A2590, symbol: None */
/* 8036BBB0  C8 65 00 00 */	lfd f3, 0(r5)                            /* constant-address: 803A2588, symbol: T */
...
/* 8036BBEC  41 80 00 60 */	blt lbl_8036BC4C                         /* constant-address: 8036BC4C, symbol: lbl_8036BC4C */
...
/* 8036BC04  C8 A2 D0 B0 */	lfd f5, lit_101(r2)                      /* constant-address: 80456AB0, symbol: lit_101 */
/* 8036BC08  90 81 00 20 */	stw r4, 0x20(r1)                        
/* 8036BC0C  6C 00 80 00 */	xoris r0, r0, 0x8000                    
/* 8036BC10  FC 41 00 72 */	fmul f2, f1, f1                         
/* 8036BC14  C8 62 D0 A8 */	lfd f3, lit_99(r2)                       /* constant-address: 80456AA8, symbol: lit_99 */
...
/* 8036BC48  48 00 00 4C */	b lbl_8036BC94                           /* constant-address: 8036BC94, symbol: lbl_8036BC94 */
lbl_8036BC4C:
/* 8036BC4C  2C 03 00 01 */	cmpwi r3, 1                             
/* 8036BC50  40 82 00 08 */	bne lbl_8036BC58                         /* constant-address: 8036BC58, symbol: lbl_8036BC58 */
/* 8036BC54  48 00 00 40 */	b lbl_8036BC94                           /* constant-address: 8036BC94, symbol: lbl_8036BC94 */
lbl_8036BC58:
/* 8036BC58  C8 42 D0 88 */	lfd f2, lit_95(r2)                       /* constant-address: 80456A88, symbol: lit_95 */
/* 8036BC5C  38 00 00 00 */	li r0, 0                                
/* 8036BC60  D8 21 00 18 */	stfd f1, 0x18(r1)                       
/* 8036BC64  FC 82 08 24 */	fdiv f4, f2, f1                         
/* 8036BC68  C8 22 D0 80 */	lfd f1, lit_94(r2)                       /* constant-address: 80456A80, symbol: lit_94 */

...
/* 8036C268  40 80 00 0C */	bge lbl_8036C274                         /* constant-address: 8036C274, symbol: lbl_8036C274 */
/* 8036C26C  7C 80 33 79 */	or. r0, r4, r6                          
/* 8036C270  40 82 00 0C */	bne lbl_8036C27C                         /* constant-address: 8036C27C, symbol: lbl_8036C27C */
lbl_8036C274:
/* 8036C274  C8 21 00 08 */	lfd f1, 8(r1)                           
/* 8036C278  48 00 00 50 */	b lbl_8036C2C8                           /* constant-address: 8036C2C8, symbol: lbl_8036C2C8 */
lbl_8036C27C:
/* 8036C27C  3C 00 00 10 */	lis r0, 0x10                            
/* 8036C280  7C 04 00 00 */	cmpw r4, r0                             
/* 8036C284  40 80 00 20 */	bge lbl_8036C2A4                         /* constant-address: 8036C2A4, symbol: lbl_8036C2A4 */
/* 8036C288  C8 02 D1 08 */	lfd f0, lit_57(r2)                       /* constant-address: 80456B08, symbol: lit_57 */

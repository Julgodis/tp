...
/* ###################################################################################### */
.section .text, "ax"
/* 8036C244 0030 .text      frexp                          frexp                          */
.global frexp
frexp:
...
/* 8036C268 003691A8  40 80 00 0C */	bge func_8036C274
/* 8036C26C 003691AC  7C 80 33 79 */	or. r0, r4, r6
/* 8036C270 003691B0  40 82 00 0C */	bne func_8036C27C

/* 8036C274 0008 .text      func_8036C274                  func_8036C274                  */
.global func_8036C274
func_8036C274:
/* 8036C274 003691B4  C8 21 00 08 */	lfd f1, 8(r1)
/* 8036C278 003691B8  48 00 00 50 */	b func_8036C2C8

/* 8036C27C 0028 .text      func_8036C27C                  func_8036C27C                  */
.global func_8036C27C
func_8036C27C:
/* 8036C27C 003691BC  3C 00 00 10 */	lis r0, 0x10
/* 8036C280 003691C0  7C 04 00 00 */	cmpw r4, r0
/* 8036C284 003691C4  40 80 00 20 */	bge func_8036C2A4
/* 8036C288 003691C8  C8 02 D1 08 */	lfd f0, LIT_57-_SDA2_BASE_(r2)
...
/* 8036C2A4 0024 .text      func_8036C2A4                  func_8036C2A4                  */
.global func_8036C2A4
func_8036C2A4:
...
/* 8036C2C8 0008 .text      func_8036C2C8                  func_8036C2C8                  */
.global func_8036C2C8
func_8036C2C8:
...
/* ###################################################################################### */
.section .sdata2, "a"
/* 80456B08 0008 .sdata2    LIT_57                         @57                            */
.global LIT_57
LIT_57:
.byte 0x43, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3d5968 */

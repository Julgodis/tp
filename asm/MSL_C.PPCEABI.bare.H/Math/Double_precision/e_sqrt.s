...
/* ###################################################################################### */
.section .text, "ax"
/* 8036C7A0 0030 .text      __ieee754_sqrt                 __ieee754_sqrt                 */
...
/* 8036C7BC 003696FC  40 82 00 14 */	bne func_8036C7D0
/* 8036C7C0 00369700  FC 21 08 7A */	fmadd f1, f1, f1, f1
/* 8036C7C4 00369704  38 00 00 21 */	li r0, 0x21
/* 8036C7C8 00369708  90 0D 94 28 */	stw r0, errno-_SDA_BASE_(r13)
/* 8036C7CC 0036970C  48 00 01 F0 */	b func_8036C9BC

/* 8036C7D0 0018 .text      func_8036C7D0                  func_8036C7D0                  */
.global func_8036C7D0
func_8036C7D0:
/* 8036C7D0 00369710  2C 06 00 00 */	cmpwi r6, 0
/* 8036C7D4 00369714  41 81 00 30 */	bgt func_8036C804
/* 8036C7D8 00369718  54 C3 00 7E */	clrlwi r3, r6, 1
/* 8036C7DC 0036971C  7C 03 1B 79 */	or. r3, r0, r3
/* 8036C7E0 00369720  40 82 00 08 */	bne func_8036C7E8
/* 8036C7E4 00369724  48 00 01 D8 */	b func_8036C9BC

/* 8036C7E8 001C .text      func_8036C7E8                  func_8036C7E8                  */
.global func_8036C7E8
func_8036C7E8:
/* 8036C7E8 00369728  2C 06 00 00 */	cmpwi r6, 0
/* 8036C7EC 0036972C  40 80 00 18 */	bge func_8036C804
/* 8036C7F0 00369730  3C 60 80 45 */	lis r3, __float_nan@ha
/* 8036C7F4 00369734  38 00 00 21 */	li r0, 0x21
/* 8036C7F8 00369738  90 0D 94 28 */	stw r0, errno-_SDA_BASE_(r13)
/* 8036C7FC 0036973C  C0 23 0A E0 */	lfs f1, __float_nan@l(r3)
/* 8036C800 00369740  48 00 01 BC */	b func_8036C9BC

/* 8036C804 000C .text      func_8036C804                  func_8036C804                  */
.global func_8036C804
func_8036C804:
/* 8036C804 00369744  7C C3 A6 71 */	srawi. r3, r6, 0x14
/* 8036C808 00369748  40 82 00 50 */	bne func_8036C858
/* 8036C80C 0036974C  48 00 00 14 */	b func_8036C820

/* 8036C810 0010 .text      func_8036C810                  func_8036C810                  */
.global func_8036C810
func_8036C810:
...
/* 8036C820 0010 .text      func_8036C820                  func_8036C820                  */
.global func_8036C820
func_8036C820:
/* 8036C820 00369760  2C 06 00 00 */	cmpwi r6, 0
/* 8036C824 00369764  41 82 FF EC */	beq func_8036C810
/* 8036C828 00369768  38 E0 00 00 */	li r7, 0
/* 8036C82C 0036976C  48 00 00 0C */	b func_8036C838

/* 8036C830 0008 .text      func_8036C830                  func_8036C830                  */
.global func_8036C830
func_8036C830:
/* 8036C830 00369770  54 C6 08 3C */	slwi r6, r6, 1
/* 8036C834 00369774  38 E7 00 01 */	addi r7, r7, 1

/* 8036C838 0020 .text      func_8036C838                  func_8036C838                  */
.global func_8036C838
func_8036C838:
/* 8036C838 00369778  54 C4 02 D7 */	rlwinm. r4, r6, 0, 0xb, 0xb
/* 8036C83C 0036977C  41 82 FF F4 */	beq func_8036C830
...
/* 8036C858 0024 .text      func_8036C858                  func_8036C858                  */
.global func_8036C858
func_8036C858:
...
/* 8036C868 003697A8  41 82 00 14 */	beq func_8036C87C
...
/* 8036C87C 0028 .text      func_8036C87C                  func_8036C87C                  */
.global func_8036C87C
func_8036C87C:
...
/* 8036C8A0 003697E0  48 00 00 30 */	b func_8036C8D0

/* 8036C8A4 0018 .text      func_8036C8A4                  func_8036C8A4                  */
.global func_8036C8A4
func_8036C8A4:
/* 8036C8A4 003697E4  7C 8B 32 14 */	add r4, r11, r6
/* 8036C8A8 003697E8  7C 04 28 00 */	cmpw r4, r5
/* 8036C8AC 003697EC  41 81 00 10 */	bgt func_8036C8BC
...
/* 8036C8BC 0014 .text      func_8036C8BC                  func_8036C8BC                  */
.global func_8036C8BC
func_8036C8BC:
...
/* 8036C8D0 0010 .text      func_8036C8D0                  func_8036C8D0                  */
.global func_8036C8D0
func_8036C8D0:
/* 8036C8D0 00369810  28 06 00 00 */	cmplwi r6, 0
/* 8036C8D4 00369814  40 82 FF D0 */	bne func_8036C8A4
/* 8036C8D8 00369818  3C C0 80 00 */	lis r6, 0x8000
/* 8036C8DC 0036981C  48 00 00 6C */	b func_8036C948

/* 8036C8E0 001C .text      func_8036C8E0                  func_8036C8E0                  */
.global func_8036C8E0
func_8036C8E0:
...
/* 8036C8EC 0036982C  41 80 00 10 */	blt func_8036C8FC
/* 8036C8F0 00369830  40 82 00 44 */	bne func_8036C934
/* 8036C8F4 00369834  7C 08 00 40 */	cmplw r8, r0
/* 8036C8F8 00369838  41 81 00 3C */	bgt func_8036C934

/* 8036C8FC 0020 .text      func_8036C8FC                  func_8036C8FC                  */
.global func_8036C8FC
func_8036C8FC:
...
/* 8036C90C 0036984C  40 82 00 10 */	bne func_8036C91C
/* 8036C910 00369850  55 24 00 01 */	rlwinm. r4, r9, 0, 0, 0
/* 8036C914 00369854  40 82 00 08 */	bne func_8036C91C
/* 8036C918 00369858  39 6B 00 01 */	addi r11, r11, 1

/* 8036C91C 0010 .text      func_8036C91C                  func_8036C91C                  */
.global func_8036C91C
func_8036C91C:
/* 8036C91C 0036985C  7C 00 40 40 */	cmplw r0, r8
/* 8036C920 00369860  7C A7 28 50 */	subf r5, r7, r5
/* 8036C924 00369864  40 80 00 08 */	bge func_8036C92C
/* 8036C928 00369868  38 A5 FF FF */	addi r5, r5, -1

/* 8036C92C 0008 .text      func_8036C92C                  func_8036C92C                  */
.global func_8036C92C
func_8036C92C:
/* 8036C92C 0036986C  7C 08 00 50 */	subf r0, r8, r0
/* 8036C930 00369870  7D 4A 32 14 */	add r10, r10, r6

/* 8036C934 0014 .text      func_8036C934                  func_8036C934                  */
.global func_8036C934
func_8036C934:
...
/* 8036C948 0034 .text      func_8036C948                  func_8036C948                  */
.global func_8036C948
func_8036C948:
/* 8036C948 00369888  28 06 00 00 */	cmplwi r6, 0
/* 8036C94C 0036988C  40 82 FF 94 */	bne func_8036C8E0
/* 8036C950 00369890  7C A0 03 79 */	or. r0, r5, r0
/* 8036C954 00369894  41 82 00 30 */	beq func_8036C984
/* 8036C958 00369898  C8 02 D1 48 */	lfd f0, Math_Double_precision_e_sqrt__LIT_164-_SDA2_BASE_(r2)
...
/* 8036C96C 003698AC  40 82 00 10 */	bne func_8036C97C
/* 8036C970 003698B0  39 40 00 00 */	li r10, 0
/* 8036C974 003698B4  39 8C 00 01 */	addi r12, r12, 1
/* 8036C978 003698B8  48 00 00 0C */	b func_8036C984

/* 8036C97C 0008 .text      func_8036C97C                  func_8036C97C                  */
.global func_8036C97C
func_8036C97C:
/* 8036C97C 003698BC  55 40 07 FE */	clrlwi r0, r10, 0x1f
/* 8036C980 003698C0  7D 4A 02 14 */	add r10, r10, r0

/* 8036C984 001C .text      func_8036C984                  func_8036C984                  */
.global func_8036C984
func_8036C984:
...
/* 8036C998 003698D8  40 82 00 08 */	bne func_8036C9A0
/* 8036C99C 003698DC  64 A5 80 00 */	oris r5, r5, 0x8000

/* 8036C9A0 001C .text      func_8036C9A0                  func_8036C9A0                  */
.global func_8036C9A0
func_8036C9A0:
...
/* 8036C9BC 0008 .text      func_8036C9BC                  func_8036C9BC                  */
.global func_8036C9BC
func_8036C9BC:
...
/* ###################################################################################### */
.section .sdata2, "a"
/* 80456B48 0008 .sdata2    Math_Double_precision_e_sqrt__LIT_164 @164                           */
.global Math_Double_precision_e_sqrt__LIT_164
Math_Double_precision_e_sqrt__LIT_164:
.byte 0x3f, 0xf0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3d59a8 */
.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 /* baserom.dol+0x3d59b0 */

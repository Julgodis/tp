...
/* 8036CAA4  40 82 00 0C */	bne lbl_8036CAB0                         /* constant-address: 8036CAB0, symbol: lbl_8036CAB0 */
/* 8036CAA8  38 A0 FF FF */	li r5, -1                               
/* 8036CAAC  48 00 00 14 */	b lbl_8036CAC0                           /* constant-address: 8036CAC0, symbol: lbl_8036CAC0 */
lbl_8036CAB0:
/* 8036CAB0  3C A0 80 3D */	lis r5, __lower_map@ha                  
/* 8036CAB4  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 8036CAB8  38 A5 2D 18 */	addi r5, r5, __lower_map@l               /* constant-address: 803D2D18, symbol: __lower_map */
...
/* 8036CAD4  40 82 00 0C */	bne lbl_8036CAE0                         /* constant-address: 8036CAE0, symbol: lbl_8036CAE0 */
/* 8036CAD8  38 00 FF FF */	li r0, -1                               
/* 8036CADC  48 00 00 14 */	b lbl_8036CAF0                           /* constant-address: 8036CAF0, symbol: lbl_8036CAF0 */
lbl_8036CAE0:
/* 8036CAE0  3C A0 80 3D */	lis r5, __lower_map@ha                  
/* 8036CAE4  54 00 06 3E */	clrlwi r0, r0, 0x18                     
/* 8036CAE8  38 A5 2D 18 */	addi r5, r5, __lower_map@l               /* constant-address: 803D2D18, symbol: __lower_map */
/* 8036CAEC  7C 05 00 AE */	lbzx r0, r5, r0                         
lbl_8036CAF0:
/* 8036CAF0  7C 00 07 74 */	extsb r0, r0                            
/* 8036CAF4  7C 06 00 00 */	cmpw r6, r0                             
/* 8036CAF8  40 80 00 0C */	bge lbl_8036CB04                         /* constant-address: 8036CB04, symbol: lbl_8036CB04 */
/* 8036CAFC  38 60 FF FF */	li r3, -1                               
/* 8036CB00  4E 80 00 20 */	blr                                     
lbl_8036CB04:
/* 8036CB04  40 81 00 0C */	ble lbl_8036CB10                         /* constant-address: 8036CB10, symbol: lbl_8036CB10 */
/* 8036CB08  38 60 00 01 */	li r3, 1                                
/* 8036CB0C  4E 80 00 20 */	blr                                     
lbl_8036CB10:
/* 8036CB10  7C C0 07 75 */	extsb. r0, r6                           
/* 8036CB14  40 82 FF 80 */	bne stricmp                              /* constant-address: 8036CA94, symbol: stricmp */

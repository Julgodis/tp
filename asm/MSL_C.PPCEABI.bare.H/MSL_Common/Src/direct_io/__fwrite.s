...
/* 803654BC  48 00 3C 59 */	bl fwide                                 /* constant-address: 80369114, symbol: fwide */
/* 803654C0  2C 03 00 00 */	cmpwi r3, 0                             
/* 803654C4  40 82 00 10 */	bne lbl_803654D4                         /* constant-address: 803654D4, symbol: lbl_803654D4 */
/* 803654C8  7F 43 D3 78 */	mr r3, r26                              
/* 803654CC  38 80 FF FF */	li r4, -1                               
/* 803654D0  48 00 3C 45 */	bl fwide                                 /* constant-address: 80369114, symbol: fwide */
lbl_803654D4:
/* 803654D4  7F B9 E1 D7 */	mullw. r29, r25, r28                    
/* 803654D8  41 82 00 1C */	beq lbl_803654F4                         /* constant-address: 803654F4, symbol: lbl_803654F4 */
/* 803654DC  88 1A 00 0A */	lbz r0, 0xa(r26)                        
/* 803654E0  28 00 00 00 */	cmplwi r0, 0                            
/* 803654E4  40 82 00 10 */	bne lbl_803654F4                         /* constant-address: 803654F4, symbol: lbl_803654F4 */
/* 803654E8  A0 1A 00 04 */	lhz r0, 4(r26)                          
/* 803654EC  54 00 D7 7F */	rlwinm. r0, r0, 0x1a, 0x1d, 0x1f        
/* 803654F0  40 82 00 0C */	bne lbl_803654FC                         /* constant-address: 803654FC, symbol: lbl_803654FC */
lbl_803654F4:
/* 803654F4  38 60 00 00 */	li r3, 0                                
/* 803654F8  48 00 02 94 */	b lbl_8036578C                           /* constant-address: 8036578C, symbol: lbl_8036578C */
lbl_803654FC:
/* 803654FC  28 00 00 02 */	cmplwi r0, 2                            
/* 80365500  40 82 00 08 */	bne lbl_80365508                         /* constant-address: 80365508, symbol: lbl_80365508 */
/* 80365504  48 00 0F C9 */	bl __stdio_atexit                        /* constant-address: 803664CC, symbol: __stdio_atexit */
lbl_80365508:
...
/* 80365518  41 82 00 14 */	beq lbl_8036552C                         /* constant-address: 8036552C, symbol: lbl_8036552C */
/* 8036551C  88 1A 00 04 */	lbz r0, 4(r26)                          
/* 80365520  54 00 FF BE */	rlwinm r0, r0, 0x1f, 0x1e, 0x1f         
/* 80365524  28 00 00 02 */	cmplwi r0, 2                            
/* 80365528  40 82 00 08 */	bne lbl_80365530                         /* constant-address: 80365530, symbol: lbl_80365530 */
lbl_8036552C:
/* 8036552C  38 60 00 01 */	li r3, 1                                
lbl_80365530:
/* 80365530  2C 03 00 00 */	cmpwi r3, 0                             
/* 80365534  40 82 00 18 */	bne lbl_8036554C                         /* constant-address: 8036554C, symbol: lbl_8036554C */
/* 80365538  88 1A 00 04 */	lbz r0, 4(r26)                          
/* 8036553C  54 00 FF BE */	rlwinm r0, r0, 0x1f, 0x1e, 0x1f         
/* 80365540  28 00 00 01 */	cmplwi r0, 1                            
/* 80365544  41 82 00 08 */	beq lbl_8036554C                         /* constant-address: 8036554C, symbol: lbl_8036554C */
/* 80365548  3B E0 00 00 */	li r31, 0                               
lbl_8036554C:
/* 8036554C  88 1A 00 08 */	lbz r0, 8(r26)                          
/* 80365550  54 00 DF 7F */	rlwinm. r0, r0, 0x1b, 0x1d, 0x1f        
/* 80365554  40 82 00 54 */	bne lbl_803655A8                         /* constant-address: 803655A8, symbol: lbl_803655A8 */
...
/* 80365564  41 82 00 44 */	beq lbl_803655A8                         /* constant-address: 803655A8, symbol: lbl_803655A8 */
/* 80365568  54 60 07 7B */	rlwinm. r0, r3, 0, 0x1d, 0x1d           
/* 8036556C  41 82 00 24 */	beq lbl_80365590                         /* constant-address: 80365590, symbol: lbl_80365590 */
/* 80365570  7F 43 D3 78 */	mr r3, r26                              
/* 80365574  38 80 00 00 */	li r4, 0                                
/* 80365578  38 A0 00 02 */	li r5, 2                                
/* 8036557C  48 00 06 39 */	bl fseek                                 /* constant-address: 80365BB4, symbol: fseek */
/* 80365580  2C 03 00 00 */	cmpwi r3, 0                             
/* 80365584  41 82 00 0C */	beq lbl_80365590                         /* constant-address: 80365590, symbol: lbl_80365590 */
/* 80365588  38 60 00 00 */	li r3, 0                                
/* 8036558C  48 00 02 00 */	b lbl_8036578C                           /* constant-address: 8036578C, symbol: lbl_8036578C */
lbl_80365590:
...
/* 803655A4  4B FF FC 01 */	bl __prep_buffer                         /* constant-address: 803651A4, symbol: __prep_buffer */
lbl_803655A8:
/* 803655A8  88 1A 00 08 */	lbz r0, 8(r26)                          
/* 803655AC  54 00 DF 7E */	rlwinm r0, r0, 0x1b, 0x1d, 0x1f         
/* 803655B0  28 00 00 01 */	cmplwi r0, 1                            
/* 803655B4  41 82 00 1C */	beq lbl_803655D0                         /* constant-address: 803655D0, symbol: lbl_803655D0 */
...
/* 803655CC  48 00 01 C0 */	b lbl_8036578C                           /* constant-address: 8036578C, symbol: lbl_8036578C */
lbl_803655D0:
/* 803655D0  28 1D 00 00 */	cmplwi r29, 0                           
/* 803655D4  7F 7E DB 78 */	mr r30, r27                             
/* 803655D8  3B 80 00 00 */	li r28, 0                               
/* 803655DC  41 82 01 20 */	beq lbl_803656FC                         /* constant-address: 803656FC, symbol: lbl_803656FC */
/* 803655E0  80 9A 00 24 */	lwz r4, 0x24(r26)                       
/* 803655E4  80 7A 00 1C */	lwz r3, 0x1c(r26)                       
/* 803655E8  7C 04 18 40 */	cmplw r4, r3                            
/* 803655EC  40 82 00 0C */	bne lbl_803655F8                         /* constant-address: 803655F8, symbol: lbl_803655F8 */
/* 803655F0  2C 1F 00 00 */	cmpwi r31, 0                            
/* 803655F4  41 82 01 08 */	beq lbl_803656FC                         /* constant-address: 803656FC, symbol: lbl_803656FC */
lbl_803655F8:
...
/* 80365618  40 81 00 08 */	ble lbl_80365620                         /* constant-address: 80365620, symbol: lbl_80365620 */
...
/* 8036562C  40 82 00 30 */	bne lbl_8036565C                         /* constant-address: 8036565C, symbol: lbl_8036565C */
/* 80365630  80 A1 00 08 */	lwz r5, 8(r1)                           
/* 80365634  28 05 00 00 */	cmplwi r5, 0                            
/* 80365638  41 82 00 24 */	beq lbl_8036565C                         /* constant-address: 8036565C, symbol: lbl_8036565C */
/* 8036563C  7F C3 F3 78 */	mr r3, r30                              
/* 80365640  38 80 00 0A */	li r4, 0xa                              
/* 80365644  48 00 0A 95 */	bl __memrchr                             /* constant-address: 803660D8, symbol: __memrchr */
/* 80365648  7C 7B 1B 79 */	or. r27, r3, r3                         
/* 8036564C  41 82 00 10 */	beq lbl_8036565C                         /* constant-address: 8036565C, symbol: lbl_8036565C */
...
/* 80365664  41 82 00 3C */	beq lbl_803656A0                         /* constant-address: 803656A0, symbol: lbl_803656A0 */
/* 80365668  80 7A 00 24 */	lwz r3, 0x24(r26)                       
/* 8036566C  7F C4 F3 78 */	mr r4, r30                              
/* 80365670  4B C9 DE D1 */	bl memcpy                                /* constant-address: 80003540, symbol: memcpy */
...
/* 803656A8  41 82 00 18 */	beq lbl_803656C0                         /* constant-address: 803656C0, symbol: lbl_803656C0 */
/* 803656AC  28 1B 00 00 */	cmplwi r27, 0                           
/* 803656B0  40 82 00 10 */	bne lbl_803656C0                         /* constant-address: 803656C0, symbol: lbl_803656C0 */
/* 803656B4  88 1A 00 04 */	lbz r0, 4(r26)                          
/* 803656B8  54 00 FF BF */	rlwinm. r0, r0, 0x1f, 0x1e, 0x1f        
/* 803656BC  40 82 00 30 */	bne lbl_803656EC                         /* constant-address: 803656EC, symbol: lbl_803656EC */
lbl_803656C0:
/* 803656C0  7F 43 D3 78 */	mr r3, r26                              
/* 803656C4  38 80 00 00 */	li r4, 0                                
/* 803656C8  4B FF FA 19 */	bl __flush_buffer                        /* constant-address: 803650E0, symbol: __flush_buffer */
/* 803656CC  2C 03 00 00 */	cmpwi r3, 0                             
/* 803656D0  41 82 00 1C */	beq lbl_803656EC                         /* constant-address: 803656EC, symbol: lbl_803656EC */
...
/* 803656E8  48 00 00 14 */	b lbl_803656FC                           /* constant-address: 803656FC, symbol: lbl_803656FC */
lbl_803656EC:
/* 803656EC  28 1D 00 00 */	cmplwi r29, 0                           
/* 803656F0  41 82 00 0C */	beq lbl_803656FC                         /* constant-address: 803656FC, symbol: lbl_803656FC */
/* 803656F4  2C 1F 00 00 */	cmpwi r31, 0                            
/* 803656F8  40 82 FF 10 */	bne lbl_80365608                         /* constant-address: 80365608, symbol: lbl_80365608 */
lbl_803656FC:
/* 803656FC  28 1D 00 00 */	cmplwi r29, 0                           
/* 80365700  41 82 00 68 */	beq lbl_80365768                         /* constant-address: 80365768, symbol: lbl_80365768 */
/* 80365704  2C 1F 00 00 */	cmpwi r31, 0                            
/* 80365708  40 82 00 60 */	bne lbl_80365768                         /* constant-address: 80365768, symbol: lbl_80365768 */
...
/* 8036572C  4B FF F9 B5 */	bl __flush_buffer                        /* constant-address: 803650E0, symbol: __flush_buffer */
/* 80365730  2C 03 00 00 */	cmpwi r3, 0                             
/* 80365734  41 82 00 14 */	beq lbl_80365748                         /* constant-address: 80365748, symbol: lbl_80365748 */
...
/* 8036575C  4B FF FA 49 */	bl __prep_buffer                         /* constant-address: 803651A4, symbol: __prep_buffer */
...
/* 80365774  41 82 00 0C */	beq lbl_80365780                         /* constant-address: 80365780, symbol: lbl_80365780 */

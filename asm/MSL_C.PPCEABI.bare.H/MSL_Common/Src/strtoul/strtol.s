...
/* 80368C24  38 86 FF FF */	addi r4, r6, 0xFFFF /* 0x7FFFFFFF@l */   /* constant-address: 7FFFFFFF */
...
/* 80368C38  38 03 87 8C */	addi r0, r3, __StringRead@l              /* constant-address: 8036878C, symbol: __StringRead */
...
/* 80368C50  48 00 01 4D */	bl __strtoul                             /* constant-address: 80368D9C, symbol: __strtoul */
/* 80368C54  28 1F 00 00 */	cmplwi r31, 0                           
/* 80368C58  41 82 00 10 */	beq lbl_80368C68                         /* constant-address: 80368C68, symbol: lbl_80368C68 */
...
/* 80368C70  40 82 00 34 */	bne lbl_80368CA4                         /* constant-address: 80368CA4, symbol: lbl_80368CA4 */
/* 80368C74  80 A1 00 0C */	lwz r5, 0xc(r1)                         
/* 80368C78  2C 05 00 00 */	cmpwi r5, 0                             
/* 80368C7C  40 82 00 14 */	bne lbl_80368C90                         /* constant-address: 80368C90, symbol: lbl_80368C90 */
/* 80368C80  3C 80 80 00 */	lis r4, 0x8000 /* 0x7FFFFFFF@ha */      
/* 80368C84  38 04 FF FF */	addi r0, r4, 0xFFFF /* 0x7FFFFFFF@l */   /* constant-address: 7FFFFFFF */
/* 80368C88  7C 03 00 40 */	cmplw r3, r0                            
/* 80368C8C  41 81 00 18 */	bgt lbl_80368CA4                         /* constant-address: 80368CA4, symbol: lbl_80368CA4 */
lbl_80368C90:
/* 80368C90  2C 05 00 00 */	cmpwi r5, 0                             
/* 80368C94  41 82 00 38 */	beq lbl_80368CCC                         /* constant-address: 80368CCC, symbol: lbl_80368CCC */
/* 80368C98  3C 00 80 00 */	lis r0, 0x8000                          
/* 80368C9C  7C 03 00 40 */	cmplw r3, r0                            
/* 80368CA0  40 81 00 2C */	ble lbl_80368CCC                         /* constant-address: 80368CCC, symbol: lbl_80368CCC */
lbl_80368CA4:
...
/* 80368CB4  38 63 FF FF */	addi r3, r3, 0xFFFF /* 0x7FFFFFFF@l */   /* constant-address: 7FFFFFFF */
/* 80368CB8  7C 84 2B 78 */	or r4, r4, r5                           
/* 80368CBC  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 80368CC0  54 80 0F FE */	srwi r0, r4, 0x1f                       
/* 80368CC4  7C 60 1A 14 */	add r3, r0, r3                          
/* 80368CC8  48 00 00 10 */	b lbl_80368CD8                           /* constant-address: 80368CD8, symbol: lbl_80368CD8 */
lbl_80368CCC:
/* 80368CCC  2C 05 00 00 */	cmpwi r5, 0                             
/* 80368CD0  41 82 00 08 */	beq lbl_80368CD8                         /* constant-address: 80368CD8, symbol: lbl_80368CD8 */

...
/* 80368838  41 80 00 0C */	blt lbl_80368844                         /* constant-address: 80368844, symbol: lbl_80368844 */
/* 8036883C  2C 1E 00 06 */	cmpwi r30, 6                            
/* 80368840  40 81 00 0C */	ble lbl_8036884C                         /* constant-address: 8036884C, symbol: lbl_8036884C */
lbl_80368844:
/* 80368844  38 60 FF FF */	li r3, -1                               
/* 80368848  48 00 00 7C */	b lbl_803688C4                           /* constant-address: 803688C4, symbol: lbl_803688C4 */
lbl_8036884C:
/* 8036884C  38 60 00 04 */	li r3, 4                                
/* 80368850  4B FF CC 19 */	bl __begin_critical_region               /* constant-address: 80365468, symbol: __begin_critical_region */
/* 80368854  3C 60 80 45 */	lis r3, signal_funcs@ha                 
/* 80368858  57 C0 10 3A */	slwi r0, r30, 2                         
/* 8036885C  38 63 D8 78 */	addi r3, r3, signal_funcs@l              /* constant-address: 8044D878, symbol: signal_funcs */
/* 80368860  7C 63 02 14 */	add r3, r3, r0                          
/* 80368864  87 E3 FF FC */	lwzu r31, -4(r3)                        
/* 80368868  28 1F 00 01 */	cmplwi r31, 1                           
/* 8036886C  41 82 00 0C */	beq lbl_80368878                         /* constant-address: 80368878, symbol: lbl_80368878 */
/* 80368870  38 00 00 00 */	li r0, 0                                
/* 80368874  90 03 00 00 */	stw r0, 0(r3)                           
lbl_80368878:
/* 80368878  38 60 00 04 */	li r3, 4                                
/* 8036887C  4B FF CB E9 */	bl __end_critical_region                 /* constant-address: 80365464, symbol: __end_critical_region */
/* 80368880  28 1F 00 01 */	cmplwi r31, 1                           
/* 80368884  41 82 00 14 */	beq lbl_80368898                         /* constant-address: 80368898, symbol: lbl_80368898 */
/* 80368888  28 1F 00 00 */	cmplwi r31, 0                           
/* 8036888C  40 82 00 14 */	bne lbl_803688A0                         /* constant-address: 803688A0, symbol: lbl_803688A0 */
/* 80368890  2C 1E 00 01 */	cmpwi r30, 1                            
/* 80368894  40 82 00 0C */	bne lbl_803688A0                         /* constant-address: 803688A0, symbol: lbl_803688A0 */
lbl_80368898:
/* 80368898  38 60 00 00 */	li r3, 0                                
/* 8036889C  48 00 00 28 */	b lbl_803688C4                           /* constant-address: 803688C4, symbol: lbl_803688C4 */
lbl_803688A0:
/* 803688A0  28 1F 00 00 */	cmplwi r31, 0                           
/* 803688A4  40 82 00 0C */	bne lbl_803688B0                         /* constant-address: 803688B0, symbol: lbl_803688B0 */
/* 803688A8  38 60 00 00 */	li r3, 0                                
/* 803688AC  4B FF A1 21 */	bl exit                                  /* constant-address: 803629CC, symbol: exit */
lbl_803688B0:

...
/* 80365C4C  40 82 00 10 */	bne lbl_80365C5C                         /* constant-address: 80365C5C, symbol: lbl_80365C5C */
/* 80365C50  88 1E 00 0A */	lbz r0, 0xa(r30)                        
/* 80365C54  28 00 00 00 */	cmplwi r0, 0                            
/* 80365C58  41 82 00 14 */	beq lbl_80365C6C                         /* constant-address: 80365C6C, symbol: lbl_80365C6C */
lbl_80365C5C:
/* 80365C5C  38 00 00 28 */	li r0, 0x28                             
/* 80365C60  38 60 FF FF */	li r3, -1                               
/* 80365C64  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 80365C68  48 00 02 10 */	b lbl_80365E78                           /* constant-address: 80365E78, symbol: lbl_80365E78 */
lbl_80365C6C:
/* 80365C6C  88 1E 00 08 */	lbz r0, 8(r30)                          
/* 80365C70  54 00 DF 7E */	rlwinm r0, r0, 0x1b, 0x1d, 0x1f         
/* 80365C74  28 00 00 01 */	cmplwi r0, 1                            
/* 80365C78  40 82 00 34 */	bne lbl_80365CAC                         /* constant-address: 80365CAC, symbol: lbl_80365CAC */
/* 80365C7C  38 80 00 00 */	li r4, 0                                
/* 80365C80  4B FF F4 61 */	bl __flush_buffer                        /* constant-address: 803650E0, symbol: __flush_buffer */
/* 80365C84  2C 03 00 00 */	cmpwi r3, 0                             
/* 80365C88  41 82 00 24 */	beq lbl_80365CAC                         /* constant-address: 80365CAC, symbol: lbl_80365CAC */
...
/* 80365CA4  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 80365CA8  48 00 01 D0 */	b lbl_80365E78                           /* constant-address: 80365E78, symbol: lbl_80365E78 */
lbl_80365CAC:
/* 80365CAC  2C 1F 00 01 */	cmpwi r31, 1                            
/* 80365CB0  40 82 00 B4 */	bne lbl_80365D64                         /* constant-address: 80365D64, symbol: lbl_80365D64 */
...
/* 80365CC8  41 82 00 0C */	beq lbl_80365CD4                         /* constant-address: 80365CD4, symbol: lbl_80365CD4 */
/* 80365CCC  28 00 00 02 */	cmplwi r0, 2                            
/* 80365CD0  40 82 00 10 */	bne lbl_80365CE0                         /* constant-address: 80365CE0, symbol: lbl_80365CE0 */
lbl_80365CD4:
/* 80365CD4  88 1E 00 0A */	lbz r0, 0xa(r30)                        
/* 80365CD8  28 00 00 00 */	cmplwi r0, 0                            
/* 80365CDC  41 82 00 14 */	beq lbl_80365CF0                         /* constant-address: 80365CF0, symbol: lbl_80365CF0 */
lbl_80365CE0:
/* 80365CE0  38 00 00 28 */	li r0, 0x28                             
/* 80365CE4  38 60 FF FF */	li r3, -1                               
/* 80365CE8  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 80365CEC  48 00 00 6C */	b lbl_80365D58                           /* constant-address: 80365D58, symbol: lbl_80365D58 */
lbl_80365CF0:
/* 80365CF0  88 1E 00 08 */	lbz r0, 8(r30)                          
/* 80365CF4  54 05 DF 7F */	rlwinm. r5, r0, 0x1b, 0x1d, 0x1f        
/* 80365CF8  40 82 00 0C */	bne lbl_80365D04                         /* constant-address: 80365D04, symbol: lbl_80365D04 */
/* 80365CFC  80 7E 00 18 */	lwz r3, 0x18(r30)                       
/* 80365D00  48 00 00 58 */	b lbl_80365D58                           /* constant-address: 80365D58, symbol: lbl_80365D58 */
lbl_80365D04:
...
/* 80365D1C  41 80 00 0C */	blt lbl_80365D28                         /* constant-address: 80365D28, symbol: lbl_80365D28 */
...
/* 80365D30  40 82 00 28 */	bne lbl_80365D58                         /* constant-address: 80365D58, symbol: lbl_80365D58 */
/* 80365D34  7C 04 30 51 */	subf. r0, r4, r6                        
/* 80365D38  7C 09 03 A6 */	mtctr r0                                
/* 80365D3C  41 82 00 1C */	beq lbl_80365D58                         /* constant-address: 80365D58, symbol: lbl_80365D58 */
lbl_80365D40:
/* 80365D40  88 07 00 00 */	lbz r0, 0(r7)                           
/* 80365D44  38 E7 00 01 */	addi r7, r7, 1                          
/* 80365D48  28 00 00 0A */	cmplwi r0, 0xa                          
/* 80365D4C  40 82 00 08 */	bne lbl_80365D54                         /* constant-address: 80365D54, symbol: lbl_80365D54 */
/* 80365D50  38 63 00 01 */	addi r3, r3, 1                          
lbl_80365D54:
/* 80365D54  42 00 FF EC */	bdnz lbl_80365D40                        /* constant-address: 80365D40, symbol: lbl_80365D40 */
lbl_80365D58:
...
/* 80365D68  41 82 00 90 */	beq lbl_80365DF8                         /* constant-address: 80365DF8, symbol: lbl_80365DF8 */
/* 80365D6C  88 1E 00 04 */	lbz r0, 4(r30)                          
/* 80365D70  54 00 EF 7E */	rlwinm r0, r0, 0x1d, 0x1d, 0x1f         
/* 80365D74  28 00 00 03 */	cmplwi r0, 3                            
/* 80365D78  41 82 00 80 */	beq lbl_80365DF8                         /* constant-address: 80365DF8, symbol: lbl_80365DF8 */
/* 80365D7C  88 1E 00 08 */	lbz r0, 8(r30)                          
/* 80365D80  54 00 DF 7E */	rlwinm r0, r0, 0x1b, 0x1d, 0x1f         
/* 80365D84  28 00 00 02 */	cmplwi r0, 2                            
/* 80365D88  41 82 00 0C */	beq lbl_80365D94                         /* constant-address: 80365D94, symbol: lbl_80365D94 */
/* 80365D8C  28 00 00 03 */	cmplwi r0, 3                            
/* 80365D90  40 82 00 68 */	bne lbl_80365DF8                         /* constant-address: 80365DF8, symbol: lbl_80365DF8 */
lbl_80365D94:
/* 80365D94  80 61 00 08 */	lwz r3, 8(r1)                           
/* 80365D98  80 1E 00 18 */	lwz r0, 0x18(r30)                       
/* 80365D9C  7C 03 00 40 */	cmplw r3, r0                            
/* 80365DA0  40 80 00 10 */	bge lbl_80365DB0                         /* constant-address: 80365DB0, symbol: lbl_80365DB0 */
/* 80365DA4  80 1E 00 34 */	lwz r0, 0x34(r30)                       
/* 80365DA8  7C 03 00 40 */	cmplw r3, r0                            
/* 80365DAC  40 80 00 18 */	bge lbl_80365DC4                         /* constant-address: 80365DC4, symbol: lbl_80365DC4 */
lbl_80365DB0:
...
/* 80365DC0  48 00 00 48 */	b lbl_80365E08                           /* constant-address: 80365E08, symbol: lbl_80365E08 */
lbl_80365DC4:
...
/* 80365DF4  48 00 00 14 */	b lbl_80365E08                           /* constant-address: 80365E08, symbol: lbl_80365E08 */
lbl_80365DF8:
...
/* 80365E10  40 82 00 64 */	bne lbl_80365E74                         /* constant-address: 80365E74, symbol: lbl_80365E74 */
/* 80365E14  81 9E 00 38 */	lwz r12, 0x38(r30)                      
/* 80365E18  28 0C 00 00 */	cmplwi r12, 0                           
/* 80365E1C  41 82 00 44 */	beq lbl_80365E60                         /* constant-address: 80365E60, symbol: lbl_80365E60 */
...
/* 80365E3C  41 82 00 24 */	beq lbl_80365E60                         /* constant-address: 80365E60, symbol: lbl_80365E60 */
...
/* 80365E58  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 80365E5C  48 00 00 1C */	b lbl_80365E78                           /* constant-address: 80365E78, symbol: lbl_80365E78 */
lbl_80365E60:

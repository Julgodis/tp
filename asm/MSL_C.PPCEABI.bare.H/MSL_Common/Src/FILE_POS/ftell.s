...
/* 80365EAC  4B FF F5 BD */	bl __begin_critical_region               /* constant-address: 80365468, symbol: __begin_critical_region */
...
/* 80365EC0  41 82 00 0C */	beq lbl_80365ECC                         /* constant-address: 80365ECC, symbol: lbl_80365ECC */
/* 80365EC4  28 00 00 02 */	cmplwi r0, 2                            
/* 80365EC8  40 82 00 10 */	bne lbl_80365ED8                         /* constant-address: 80365ED8, symbol: lbl_80365ED8 */
lbl_80365ECC:
/* 80365ECC  88 1E 00 0A */	lbz r0, 0xa(r30)                        
/* 80365ED0  28 00 00 00 */	cmplwi r0, 0                            
/* 80365ED4  41 82 00 14 */	beq lbl_80365EE8                         /* constant-address: 80365EE8, symbol: lbl_80365EE8 */
lbl_80365ED8:
/* 80365ED8  38 00 00 28 */	li r0, 0x28                             
/* 80365EDC  3B E0 FF FF */	li r31, -1                              
/* 80365EE0  90 0D 94 28 */	stw r0, errno(r13)                       /* constant-address: 804519A8, symbol: errno */
/* 80365EE4  48 00 00 6C */	b lbl_80365F50                           /* constant-address: 80365F50, symbol: lbl_80365F50 */
lbl_80365EE8:
/* 80365EE8  88 1E 00 08 */	lbz r0, 8(r30)                          
/* 80365EEC  54 05 DF 7F */	rlwinm. r5, r0, 0x1b, 0x1d, 0x1f        
/* 80365EF0  40 82 00 0C */	bne lbl_80365EFC                         /* constant-address: 80365EFC, symbol: lbl_80365EFC */
/* 80365EF4  83 FE 00 18 */	lwz r31, 0x18(r30)                      
/* 80365EF8  48 00 00 58 */	b lbl_80365F50                           /* constant-address: 80365F50, symbol: lbl_80365F50 */
lbl_80365EFC:
...
/* 80365F14  41 80 00 0C */	blt lbl_80365F20                         /* constant-address: 80365F20, symbol: lbl_80365F20 */
...
/* 80365F28  40 82 00 28 */	bne lbl_80365F50                         /* constant-address: 80365F50, symbol: lbl_80365F50 */
/* 80365F2C  7C 04 30 51 */	subf. r0, r4, r6                        
/* 80365F30  7C 09 03 A6 */	mtctr r0                                
/* 80365F34  41 82 00 1C */	beq lbl_80365F50                         /* constant-address: 80365F50, symbol: lbl_80365F50 */
lbl_80365F38:
/* 80365F38  88 07 00 00 */	lbz r0, 0(r7)                           
/* 80365F3C  38 E7 00 01 */	addi r7, r7, 1                          
/* 80365F40  28 00 00 0A */	cmplwi r0, 0xa                          
/* 80365F44  40 82 00 08 */	bne lbl_80365F4C                         /* constant-address: 80365F4C, symbol: lbl_80365F4C */
/* 80365F48  3B FF 00 01 */	addi r31, r31, 1                        
lbl_80365F4C:
/* 80365F4C  42 00 FF EC */	bdnz lbl_80365F38                        /* constant-address: 80365F38, symbol: lbl_80365F38 */
lbl_80365F50:
/* 80365F50  38 60 00 02 */	li r3, 2                                
/* 80365F54  4B FF F5 11 */	bl __end_critical_region                 /* constant-address: 80365464, symbol: __end_critical_region */

...
/* 803652E0  40 82 00 0C */	bne lbl_803652EC                         /* constant-address: 803652EC, symbol: lbl_803652EC */
/* 803652E4  2C 03 00 00 */	cmpwi r3, 0                             
/* 803652E8  40 82 00 0C */	bne lbl_803652F4                         /* constant-address: 803652F4, symbol: lbl_803652F4 */
lbl_803652EC:
/* 803652EC  38 60 FF FF */	li r3, -1                               
/* 803652F0  48 00 01 5C */	b lbl_8036544C                           /* constant-address: 8036544C, symbol: lbl_8036544C */
lbl_803652F4:
/* 803652F4  2C 03 00 02 */	cmpwi r3, 2                             
/* 803652F8  40 82 00 08 */	bne lbl_80365300                         /* constant-address: 80365300, symbol: lbl_80365300 */
/* 803652FC  48 00 11 D1 */	bl __stdio_atexit                        /* constant-address: 803664CC, symbol: __stdio_atexit */
lbl_80365300:
/* 80365300  88 1F 00 08 */	lbz r0, 8(r31)                          
/* 80365304  54 00 DF 7F */	rlwinm. r0, r0, 0x1b, 0x1d, 0x1f        
/* 80365308  40 82 00 54 */	bne lbl_8036535C                         /* constant-address: 8036535C, symbol: lbl_8036535C */
...
/* 80365318  41 82 00 44 */	beq lbl_8036535C                         /* constant-address: 8036535C, symbol: lbl_8036535C */
/* 8036531C  54 60 07 7B */	rlwinm. r0, r3, 0, 0x1d, 0x1d           
/* 80365320  41 82 00 24 */	beq lbl_80365344                         /* constant-address: 80365344, symbol: lbl_80365344 */
/* 80365324  7F E3 FB 78 */	mr r3, r31                              
/* 80365328  38 80 00 00 */	li r4, 0                                
/* 8036532C  38 A0 00 02 */	li r5, 2                                
/* 80365330  48 00 08 85 */	bl fseek                                 /* constant-address: 80365BB4, symbol: fseek */
/* 80365334  2C 03 00 00 */	cmpwi r3, 0                             
/* 80365338  41 82 00 0C */	beq lbl_80365344                         /* constant-address: 80365344, symbol: lbl_80365344 */
/* 8036533C  38 60 00 00 */	li r3, 0                                
/* 80365340  48 00 01 0C */	b lbl_8036544C                           /* constant-address: 8036544C, symbol: lbl_8036544C */
lbl_80365344:
...
/* 80365358  4B FF FE 4D */	bl __prep_buffer                         /* constant-address: 803651A4, symbol: __prep_buffer */
lbl_8036535C:
/* 8036535C  88 1F 00 08 */	lbz r0, 8(r31)                          
/* 80365360  54 00 DF 7E */	rlwinm r0, r0, 0x1b, 0x1d, 0x1f         
/* 80365364  28 00 00 01 */	cmplwi r0, 1                            
/* 80365368  41 82 00 1C */	beq lbl_80365384                         /* constant-address: 80365384, symbol: lbl_80365384 */
...
/* 80365380  48 00 00 CC */	b lbl_8036544C                           /* constant-address: 8036544C, symbol: lbl_8036544C */
lbl_80365384:
/* 80365384  88 1F 00 04 */	lbz r0, 4(r31)                          
/* 80365388  54 00 FF BE */	rlwinm r0, r0, 0x1f, 0x1e, 0x1f         
/* 8036538C  28 00 00 02 */	cmplwi r0, 2                            
/* 80365390  41 82 00 1C */	beq lbl_803653AC                         /* constant-address: 803653AC, symbol: lbl_803653AC */
...
/* 803653A8  40 82 00 30 */	bne lbl_803653D8                         /* constant-address: 803653D8, symbol: lbl_803653D8 */
lbl_803653AC:
/* 803653AC  7F E3 FB 78 */	mr r3, r31                              
/* 803653B0  38 80 00 00 */	li r4, 0                                
/* 803653B4  4B FF FD 2D */	bl __flush_buffer                        /* constant-address: 803650E0, symbol: __flush_buffer */
/* 803653B8  2C 03 00 00 */	cmpwi r3, 0                             
/* 803653BC  41 82 00 1C */	beq lbl_803653D8                         /* constant-address: 803653D8, symbol: lbl_803653D8 */
...
/* 803653D4  48 00 00 78 */	b lbl_8036544C                           /* constant-address: 8036544C, symbol: lbl_8036544C */
lbl_803653D8:
...
/* 80365400  41 82 00 48 */	beq lbl_80365448                         /* constant-address: 80365448, symbol: lbl_80365448 */
/* 80365404  28 00 00 00 */	cmplwi r0, 0                            
/* 80365408  41 82 00 0C */	beq lbl_80365414                         /* constant-address: 80365414, symbol: lbl_80365414 */
/* 8036540C  2C 1E 00 0A */	cmpwi r30, 0xa                          
/* 80365410  40 82 00 30 */	bne lbl_80365440                         /* constant-address: 80365440, symbol: lbl_80365440 */
lbl_80365414:
/* 80365414  7F E3 FB 78 */	mr r3, r31                              
/* 80365418  38 80 00 00 */	li r4, 0                                
/* 8036541C  4B FF FC C5 */	bl __flush_buffer                        /* constant-address: 803650E0, symbol: __flush_buffer */
/* 80365420  2C 03 00 00 */	cmpwi r3, 0                             
/* 80365424  41 82 00 1C */	beq lbl_80365440                         /* constant-address: 80365440, symbol: lbl_80365440 */
...
/* 8036543C  48 00 00 10 */	b lbl_8036544C                           /* constant-address: 8036544C, symbol: lbl_8036544C */
lbl_80365440:

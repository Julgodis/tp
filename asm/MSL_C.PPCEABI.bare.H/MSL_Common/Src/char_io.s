...
/* ###################################################################################### */
.section .text, "ax"
/* 803651D8 0034 .text      fputs                          fputs                          */
.global fputs
fputs:
...
/* 80365204 00362144  48 00 02 65 */	bl __begin_critical_region
/* 80365208 00362148  48 00 00 68 */	b func_80365270

/* 8036520C 001C .text      func_8036520C                  func_8036520C                  */
.global func_8036520C
func_8036520C:
/* 8036520C 0036214C  7F A3 EB 78 */	mr r3, r29
/* 80365210 00362150  38 80 FF FF */	li r4, -1
/* 80365214 00362154  48 00 3F 01 */	bl fwide
/* 80365218 00362158  2C 03 00 00 */	cmpwi r3, 0
/* 8036521C 0036215C  41 80 00 0C */	blt func_80365228
/* 80365220 00362160  38 60 FF FF */	li r3, -1
/* 80365224 00362164  48 00 00 3C */	b func_80365260

/* 80365228 002C .text      func_80365228                  func_80365228                  */
.global func_80365228
func_80365228:
...
/* 80365238 00362178  41 82 00 1C */	beq func_80365254
...
/* 80365250 00362190  48 00 00 10 */	b func_80365260

/* 80365254 000C .text      func_80365254                  func_80365254                  */
.global func_80365254
func_80365254:
/* 80365254 00362194  7F E3 FB 78 */	mr r3, r31
/* 80365258 00362198  7F A4 EB 78 */	mr r4, r29
/* 8036525C 0036219C  48 00 00 51 */	bl __put_char

/* 80365260 0010 .text      func_80365260                  func_80365260                  */
.global func_80365260
func_80365260:
/* 80365260 003621A0  2C 03 FF FF */	cmpwi r3, -1
/* 80365264 003621A4  40 82 00 0C */	bne func_80365270
/* 80365268 003621A8  3B C0 FF FF */	li r30, -1
/* 8036526C 003621AC  48 00 00 14 */	b func_80365280

/* 80365270 0010 .text      func_80365270                  func_80365270                  */
.global func_80365270
func_80365270:
...
/* 8036527C 003621BC  40 82 FF 90 */	bne func_8036520C

/* 80365280 002C .text      func_80365280                  func_80365280                  */
.global func_80365280
func_80365280:
/* 80365280 003621C0  38 60 00 02 */	li r3, 2
/* 80365284 003621C4  48 00 01 E1 */	bl __end_critical_region
...
/* 803652AC 0040 .text      __put_char                     __put_char                     */
.global __put_char
__put_char:
...
/* 803652E0 00362220  40 82 00 0C */	bne func_803652EC
/* 803652E4 00362224  2C 03 00 00 */	cmpwi r3, 0
/* 803652E8 00362228  40 82 00 0C */	bne func_803652F4

/* 803652EC 0008 .text      func_803652EC                  func_803652EC                  */
.global func_803652EC
func_803652EC:
/* 803652EC 0036222C  38 60 FF FF */	li r3, -1
/* 803652F0 00362230  48 00 01 5C */	b func_8036544C

/* 803652F4 000C .text      func_803652F4                  func_803652F4                  */
.global func_803652F4
func_803652F4:
/* 803652F4 00362234  2C 03 00 02 */	cmpwi r3, 2
/* 803652F8 00362238  40 82 00 08 */	bne func_80365300
/* 803652FC 0036223C  48 00 11 D1 */	bl __stdio_atexit

/* 80365300 0044 .text      func_80365300                  func_80365300                  */
.global func_80365300
func_80365300:
/* 80365300 00362240  88 1F 00 08 */	lbz r0, 8(r31)
/* 80365304 00362244  54 00 DF 7F */	rlwinm. r0, r0, 0x1b, 0x1d, 0x1f
/* 80365308 00362248  40 82 00 54 */	bne func_8036535C
...
/* 80365318 00362258  41 82 00 44 */	beq func_8036535C
/* 8036531C 0036225C  54 60 07 7B */	rlwinm. r0, r3, 0, 0x1d, 0x1d
/* 80365320 00362260  41 82 00 24 */	beq func_80365344
/* 80365324 00362264  7F E3 FB 78 */	mr r3, r31
/* 80365328 00362268  38 80 00 00 */	li r4, 0
/* 8036532C 0036226C  38 A0 00 02 */	li r5, 2
/* 80365330 00362270  48 00 08 85 */	bl fseek
/* 80365334 00362274  2C 03 00 00 */	cmpwi r3, 0
/* 80365338 00362278  41 82 00 0C */	beq func_80365344
/* 8036533C 0036227C  38 60 00 00 */	li r3, 0
/* 80365340 00362280  48 00 01 0C */	b func_8036544C

/* 80365344 0018 .text      func_80365344                  func_80365344                  */
.global func_80365344
func_80365344:
...
/* 80365358 00362298  4B FF FE 4D */	bl __prep_buffer

/* 8036535C 0028 .text      func_8036535C                  func_8036535C                  */
.global func_8036535C
func_8036535C:
...
/* 80365368 003622A8  41 82 00 1C */	beq func_80365384
...
/* 80365380 003622C0  48 00 00 CC */	b func_8036544C

/* 80365384 0028 .text      func_80365384                  func_80365384                  */
.global func_80365384
func_80365384:
...
/* 80365390 003622D0  41 82 00 1C */	beq func_803653AC
...
/* 803653A8 003622E8  40 82 00 30 */	bne func_803653D8

/* 803653AC 002C .text      func_803653AC                  func_803653AC                  */
.global func_803653AC
func_803653AC:
/* 803653AC 003622EC  7F E3 FB 78 */	mr r3, r31
/* 803653B0 003622F0  38 80 00 00 */	li r4, 0
/* 803653B4 003622F4  4B FF FD 2D */	bl __flush_buffer
/* 803653B8 003622F8  2C 03 00 00 */	cmpwi r3, 0
/* 803653BC 003622FC  41 82 00 1C */	beq func_803653D8
...
/* 803653D4 00362314  48 00 00 78 */	b func_8036544C

/* 803653D8 003C .text      func_803653D8                  func_803653D8                  */
.global func_803653D8
func_803653D8:
...
/* 80365400 00362340  41 82 00 48 */	beq func_80365448
/* 80365404 00362344  28 00 00 00 */	cmplwi r0, 0
/* 80365408 00362348  41 82 00 0C */	beq func_80365414
/* 8036540C 0036234C  2C 1E 00 0A */	cmpwi r30, 0xa
/* 80365410 00362350  40 82 00 30 */	bne func_80365440

/* 80365414 002C .text      func_80365414                  func_80365414                  */
.global func_80365414
func_80365414:
/* 80365414 00362354  7F E3 FB 78 */	mr r3, r31
/* 80365418 00362358  38 80 00 00 */	li r4, 0
/* 8036541C 0036235C  4B FF FC C5 */	bl __flush_buffer
/* 80365420 00362360  2C 03 00 00 */	cmpwi r3, 0
/* 80365424 00362364  41 82 00 1C */	beq func_80365440
...
/* 8036543C 0036237C  48 00 00 10 */	b func_8036544C

/* 80365440 0008 .text      func_80365440                  func_80365440                  */
.global func_80365440
func_80365440:
/* 80365440 00362380  38 00 00 00 */	li r0, 0
/* 80365444 00362384  90 1F 00 28 */	stw r0, 0x28(r31)

/* 80365448 0004 .text      func_80365448                  func_80365448                  */
.global func_80365448
func_80365448:
/* 80365448 00362388  57 C3 06 3E */	clrlwi r3, r30, 0x18

/* 8036544C 0018 .text      func_8036544C                  func_8036544C                  */
.global func_8036544C
func_8036544C:

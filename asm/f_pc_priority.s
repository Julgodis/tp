...
.section .text, "ax"
/* 80023130 0020 .text fpcPi_IsInQueue__FP22process_priority_class fpcPi_IsInQueue__FP22process_priority_class */
.global fpcPi_IsInQueue__FP22process_priority_class
fpcPi_IsInQueue__FP22process_priority_class:
...
/* 8002313C 0002007C  48 24 37 45 */	bl cTg_IsUse__FP16create_tag_class
...
/* 80023150 0038 .text fpcPi_QueueTo__FP22process_priority_class fpcPi_QueueTo__FP22process_priority_class */
.global fpcPi_QueueTo__FP22process_priority_class
fpcPi_QueueTo__FP22process_priority_class:
...
/* 80023164 000200A4  48 24 38 41 */	bl cTg_SingleCut__FP16create_tag_class
/* 80023168 000200A8  38 7F 00 14 */	addi r3, r31, 0x14
/* 8002316C 000200AC  4B FF E4 1D */	bl fpcLy_CancelQTo__FP24process_method_tag_class
...
/* 80023188 008C .text fpcPi_ToQueue__FP22process_priority_class fpcPi_ToQueue__FP22process_priority_class */
.global fpcPi_ToQueue__FP22process_priority_class
fpcPi_ToQueue__FP22process_priority_class:
...
/* 800231A4 000200E4  3C 60 80 3F */	lis r3, l_fpcPi_Queue@ha
/* 800231A8 000200E8  38 63 4E 58 */	addi r3, r3, l_fpcPi_Queue@l
/* 800231AC 000200EC  7F C4 F3 78 */	mr r4, r30
/* 800231B0 000200F0  48 24 38 35 */	bl cTg_Addition__FP15node_list_classP16create_tag_class
...
/* 800231CC 0002010C  4B FF E5 81 */	bl fpcLy_Layer__FUi
/* 800231D0 00020110  38 9E 00 14 */	addi r4, r30, 0x14
/* 800231D4 00020114  4B FF E3 D5 */	bl fpcLy_ToCancelQ__FP11layer_classP24process_method_tag_class
...
/* 800231E4 00020124  48 24 37 C1 */	bl cTg_SingleCut__FP16create_tag_class
...
/* 80023214 0054 .text fpcPi_GetFromQueue__Fv fpcPi_GetFromQueue__Fv */
.global fpcPi_GetFromQueue__Fv
fpcPi_GetFromQueue__Fv:
...
/* 80023224 00020164  3C 60 80 3F */	lis r3, l_fpcPi_Queue@ha
/* 80023228 00020168  38 63 4E 58 */	addi r3, r3, l_fpcPi_Queue@l
/* 8002322C 0002016C  48 24 37 41 */	bl cTg_GetFirst__FP15node_list_class
...
/* 80023244 00020184  4B FF E3 45 */	bl fpcLy_CancelQTo__FP24process_method_tag_class
...
/* 80023268 004C .text fpcPi_Delete__FP22process_priority_class fpcPi_Delete__FP22process_priority_class */
.global fpcPi_Delete__FP22process_priority_class
fpcPi_Delete__FP22process_priority_class:
...
/* 8002327C 000201BC  4B FF FE D5 */	bl fpcPi_QueueTo__FP22process_priority_class
...
/* 800232B4 0034 .text fpcPi_IsNormal__FUiUsUs fpcPi_IsNormal__FUiUsUs */
.global fpcPi_IsNormal__FUiUsUs
fpcPi_IsNormal__FUiUsUs:
...
/* 800232E8 0140 .text fpcPi_Change__FP22process_priority_classUiUsUs fpcPi_Change__FP22process_priority_classUiUsUs */
.global fpcPi_Change__FP22process_priority_classUiUsUs
...
/* 80023334 00020274  4B FF FF 81 */	bl fpcPi_IsNormal__FUiUsUs
...
/* 80023404 00020344  4B FF FD 85 */	bl fpcPi_ToQueue__FP22process_priority_class
...
/* 80023428 0094 .text fpcPi_Handler__Fv fpcPi_Handler__Fv */
.global fpcPi_Handler__Fv
fpcPi_Handler__Fv:
...
/* 80023458 00020398  4B FF E9 D5 */	bl fpcLyTg_Move__FP26layer_management_tag_classUiUsUs
...
/* 8002346C 000203AC  48 00 01 3D */	bl fpcLnTg_Move__FP8line_tagi
...
lbl_80023494:
/* 80023494 000203D4  4B FF FD 81 */	bl fpcPi_GetFromQueue__Fv
...
/* 800234BC 00A8 .text fpcPi_Init__FP22process_priority_classPvUiUsUs fpcPi_Init__FP22process_priority_classPvUiUsUs */
.global fpcPi_Init__FP22process_priority_classPvUiUsUs
...
/* 800234F0 00020430  4B FF FD C5 */	bl fpcPi_IsNormal__FUiUsUs
...
/* 80023530 00020470  48 24 35 05 */	bl cTg_Create__FP16create_tag_classPv
/* 80023534 00020474  38 7B 00 14 */	addi r3, r27, 0x14
/* 80023538 00020478  3C 80 80 02 */	lis r4, fpcPi_Delete__FP22process_priority_class@ha
/* 8002353C 0002047C  38 84 32 68 */	addi r4, r4, fpcPi_Delete__FP22process_priority_class@l
/* 80023540 00020480  7F 65 DB 78 */	mr r5, r27
/* 80023544 00020484  48 00 02 B5 */	bl fpcMtdTg_Init__FP24process_method_tag_classPFPv_iPv
...
.section .bss, "aw"
/* 803F4E58 000C .bss l_fpcPi_Queue l_fpcPi_Queue */
.global l_fpcPi_Queue
l_fpcPi_Queue:
.skip 0xc
.skip 0x4 /* padding */
...
.section .sdata, "a"
/* 804505E8 0008 .sdata lbl_804505E8 crear$2224 */
.global lbl_804505E8
lbl_804505E8:
.byte 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff /* baserom.dol+0x3d0348 */

/* 804505F0 0008 .sdata lbl_804505F0 lbl_804505F0 */
.global lbl_804505F0
lbl_804505F0:

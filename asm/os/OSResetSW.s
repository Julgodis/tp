...
/* ###################################################################################### */
.section .text, "ax"
/* 8033FAE4 0050 .text      __OSResetSWInterruptHandler    __OSResetSWInterruptHandler    */
...
/* 8033FB04 0033CA44  90 8D 91 3C */	stw r4, sym_804516BC-_SDA_BASE_(r13)
...
/* 8033FB14 0033CA54  90 6D 91 38 */	stw r3, HoldDown-_SDA_BASE_(r13)
...
/* 8033FB34 003C .text      func_8033FB34                  func_8033FB34                  */
.global func_8033FB34
func_8033FB34:
/* 8033FB34 0033CA74  48 00 2B E9 */	bl __OSGetSystemTime
/* 8033FB38 0033CA78  80 CD 91 3C */	lwz r6, sym_804516BC-_SDA_BASE_(r13)
/* 8033FB3C 0033CA7C  6F C5 80 00 */	xoris r5, r30, 0x8000
/* 8033FB40 0033CA80  80 0D 91 38 */	lwz r0, HoldDown-_SDA_BASE_(r13)
...
/* 8033FB60 0033CAA0  41 82 00 10 */	beq func_8033FB70
/* 8033FB64 0033CAA4  80 1F 30 00 */	lwz r0, 0x3000(r31)
/* 8033FB68 0033CAA8  54 00 03 DF */	rlwinm. r0, r0, 0, 0xf, 0xf
/* 8033FB6C 0033CAAC  41 82 FF C8 */	beq func_8033FB34

/* 8033FB70 0040 .text      func_8033FB70                  func_8033FB70                  */
.global func_8033FB70
func_8033FB70:
...
/* 8033FB7C 0033CABC  40 82 00 34 */	bne func_8033FBB0
/* 8033FB80 0033CAC0  38 00 00 01 */	li r0, 1
/* 8033FB84 0033CAC4  90 0D 91 24 */	stw r0, Down-_SDA_BASE_(r13)
/* 8033FB88 0033CAC8  38 60 02 00 */	li r3, 0x200
/* 8033FB8C 0033CACC  90 0D 91 28 */	stw r0, OSResetSW__LastState-_SDA_BASE_(r13)
/* 8033FB90 0033CAD0  4B FF DF 2D */	bl __OSMaskInterrupts
/* 8033FB94 0033CAD4  81 8D 91 20 */	lwz r12, ResetCallback-_SDA_BASE_(r13)
/* 8033FB98 0033CAD8  28 0C 00 00 */	cmplwi r12, 0
/* 8033FB9C 0033CADC  41 82 00 14 */	beq func_8033FBB0
/* 8033FBA0 0033CAE0  38 00 00 00 */	li r0, 0
/* 8033FBA4 0033CAE4  7D 88 03 A6 */	mtlr r12
/* 8033FBA8 0033CAE8  90 0D 91 20 */	stw r0, ResetCallback-_SDA_BASE_(r13)
/* 8033FBAC 0033CAEC  4E 80 00 21 */	blrl 

/* 8033FBB0 0028 .text      func_8033FBB0                  func_8033FBB0                  */
.global func_8033FBB0
func_8033FBB0:
...
/* 8033FBD8 0068 .text      OSGetResetButtonState          OSGetResetButtonState          */
...
/* 8033FBF0 0033CB30  4B FF DB 05 */	bl OSDisableInterrupts
...
/* 8033FC08 0033CB48  40 82 00 DC */	bne func_8033FCE4
/* 8033FC0C 0033CB4C  80 0D 91 24 */	lwz r0, Down-_SDA_BASE_(r13)
/* 8033FC10 0033CB50  2C 00 00 00 */	cmpwi r0, 0
/* 8033FC14 0033CB54  40 82 00 40 */	bne func_8033FC54
/* 8033FC18 0033CB58  80 0D 91 30 */	lwz r0, HoldUp-_SDA_BASE_(r13)
/* 8033FC1C 0033CB5C  38 C0 00 00 */	li r6, 0
/* 8033FC20 0033CB60  80 AD 91 34 */	lwz r5, sym_804516B4-_SDA_BASE_(r13)
...
/* 8033FC30 0033CB70  90 ED 91 24 */	stw r7, Down-_SDA_BASE_(r13)
/* 8033FC34 0033CB74  7C A0 03 79 */	or. r0, r5, r0
/* 8033FC38 0033CB78  41 82 00 08 */	beq func_8033FC40
/* 8033FC3C 0033CB7C  48 00 00 08 */	b func_8033FC44

/* 8033FC40 0004 .text      func_8033FC40                  func_8033FC40                  */
.global func_8033FC40
func_8033FC40:
/* 8033FC40 0033CB80  7C C7 33 78 */	mr r7, r6

/* 8033FC44 0010 .text      func_8033FC44                  func_8033FC44                  */
.global func_8033FC44
func_8033FC44:
/* 8033FC44 0033CB84  90 8D 91 3C */	stw r4, sym_804516BC-_SDA_BASE_(r13)
/* 8033FC48 0033CB88  7C FD 3B 78 */	mr r29, r7
/* 8033FC4C 0033CB8C  90 6D 91 38 */	stw r3, HoldDown-_SDA_BASE_(r13)
/* 8033FC50 0033CB90  48 00 01 48 */	b func_8033FD98

/* 8033FC54 0074 .text      func_8033FC54                  func_8033FC54                  */
.global func_8033FC54
func_8033FC54:
/* 8033FC54 0033CB94  80 0D 91 30 */	lwz r0, HoldUp-_SDA_BASE_(r13)
/* 8033FC58 0033CB98  39 20 00 00 */	li r9, 0
/* 8033FC5C 0033CB9C  80 AD 91 34 */	lwz r5, sym_804516B4-_SDA_BASE_(r13)
...
/* 8033FC70 0033CBB0  40 82 00 58 */	bne func_8033FCC8
/* 8033FC74 0033CBB4  3C C0 80 00 */	lis r6, 0x800000F8@ha
/* 8033FC78 0033CBB8  80 AD 91 3C */	lwz r5, sym_804516BC-_SDA_BASE_(r13)
...
/* 8033FC88 0033CBC8  80 0D 91 38 */	lwz r0, HoldDown-_SDA_BASE_(r13)
...
/* 8033FCC0 0033CC00  40 82 00 08 */	bne func_8033FCC8
/* 8033FCC4 0033CC04  7D 2A 4B 78 */	mr r10, r9

/* 8033FCC8 0010 .text      func_8033FCC8                  func_8033FCC8                  */
.global func_8033FCC8
func_8033FCC8:
/* 8033FCC8 0033CC08  2C 0A 00 00 */	cmpwi r10, 0
/* 8033FCCC 0033CC0C  41 82 00 0C */	beq func_8033FCD8
/* 8033FCD0 0033CC10  38 00 00 01 */	li r0, 1
/* 8033FCD4 0033CC14  48 00 00 08 */	b func_8033FCDC

/* 8033FCD8 0004 .text      func_8033FCD8                  func_8033FCD8                  */
.global func_8033FCD8
func_8033FCD8:
/* 8033FCD8 0033CC18  38 00 00 00 */	li r0, 0

/* 8033FCDC 0008 .text      func_8033FCDC                  func_8033FCDC                  */
.global func_8033FCDC
func_8033FCDC:
/* 8033FCDC 0033CC1C  7C 1D 03 78 */	mr r29, r0
/* 8033FCE0 0033CC20  48 00 00 B8 */	b func_8033FD98

/* 8033FCE4 0030 .text      func_8033FCE4                  func_8033FCE4                  */
.global func_8033FCE4
func_8033FCE4:
/* 8033FCE4 0033CC24  80 0D 91 24 */	lwz r0, Down-_SDA_BASE_(r13)
/* 8033FCE8 0033CC28  2C 00 00 00 */	cmpwi r0, 0
/* 8033FCEC 0033CC2C  41 82 00 34 */	beq func_8033FD20
/* 8033FCF0 0033CC30  80 AD 91 28 */	lwz r5, OSResetSW__LastState-_SDA_BASE_(r13)
/* 8033FCF4 0033CC34  38 00 00 00 */	li r0, 0
/* 8033FCF8 0033CC38  90 0D 91 24 */	stw r0, Down-_SDA_BASE_(r13)
/* 8033FCFC 0033CC3C  2C 05 00 00 */	cmpwi r5, 0
/* 8033FD00 0033CC40  3B A5 00 00 */	addi r29, r5, 0
/* 8033FD04 0033CC44  41 82 00 10 */	beq func_8033FD14
/* 8033FD08 0033CC48  90 8D 91 34 */	stw r4, sym_804516B4-_SDA_BASE_(r13)
/* 8033FD0C 0033CC4C  90 6D 91 30 */	stw r3, HoldUp-_SDA_BASE_(r13)
/* 8033FD10 0033CC50  48 00 00 88 */	b func_8033FD98

/* 8033FD14 000C .text      func_8033FD14                  func_8033FD14                  */
.global func_8033FD14
func_8033FD14:
/* 8033FD14 0033CC54  90 0D 91 34 */	stw r0, sym_804516B4-_SDA_BASE_(r13)
/* 8033FD18 0033CC58  90 0D 91 30 */	stw r0, HoldUp-_SDA_BASE_(r13)
/* 8033FD1C 0033CC5C  48 00 00 7C */	b func_8033FD98

/* 8033FD20 0068 .text      func_8033FD20                  func_8033FD20                  */
.global func_8033FD20
func_8033FD20:
/* 8033FD20 0033CC60  80 CD 91 30 */	lwz r6, HoldUp-_SDA_BASE_(r13)
/* 8033FD24 0033CC64  39 00 00 00 */	li r8, 0
/* 8033FD28 0033CC68  80 ED 91 34 */	lwz r7, sym_804516B4-_SDA_BASE_(r13)
...
/* 8033FD38 0033CC78  41 82 00 50 */	beq func_8033FD88
...
/* 8033FD7C 0033CCBC  41 82 00 0C */	beq func_8033FD88
/* 8033FD80 0033CCC0  3B A0 00 01 */	li r29, 1
/* 8033FD84 0033CCC4  48 00 00 14 */	b func_8033FD98

/* 8033FD88 0010 .text      func_8033FD88                  func_8033FD88                  */
.global func_8033FD88
func_8033FD88:
/* 8033FD88 0033CCC8  38 00 00 00 */	li r0, 0
/* 8033FD8C 0033CCCC  90 0D 91 34 */	stw r0, sym_804516B4-_SDA_BASE_(r13)
/* 8033FD90 0033CCD0  3B A0 00 00 */	li r29, 0
/* 8033FD94 0033CCD4  90 0D 91 30 */	stw r0, HoldUp-_SDA_BASE_(r13)

/* 8033FD98 00AC .text      func_8033FD98                  func_8033FD98                  */
.global func_8033FD98
func_8033FD98:
/* 8033FD98 0033CCD8  3C A0 80 00 */	lis r5, 0x800030E3@ha
/* 8033FD9C 0033CCDC  93 AD 91 28 */	stw r29, OSResetSW__LastState-_SDA_BASE_(r13)
/* 8033FDA0 0033CCE0  88 05 30 E3 */	lbz r0, 0x800030E3@l(r5)
/* 8033FDA4 0033CCE4  54 00 06 FF */	clrlwi. r0, r0, 0x1b
/* 8033FDA8 0033CCE8  41 82 00 A0 */	beq func_8033FE48
/* 8033FDAC 0033CCEC  1D 40 00 3C */	mulli r10, r0, 0x3c
/* 8033FDB0 0033CCF0  80 05 00 F8 */	lwz r0, 0xf8(r5)
/* 8033FDB4 0033CCF4  81 2D 90 B4 */	lwz r9, sym_80451634-_SDA_BASE_(r13)
/* 8033FDB8 0033CCF8  81 0D 90 B0 */	lwz r8, __OSStartTime-_SDA_BASE_(r13)
...
/* 8033FE00 0033CD40  41 82 00 48 */	beq func_8033FE48
...
/* 8033FE38 0033CD78  40 82 00 0C */	bne func_8033FE44
/* 8033FE3C 0033CD7C  3B A0 00 01 */	li r29, 1
/* 8033FE40 0033CD80  48 00 00 08 */	b func_8033FE48

/* 8033FE44 0004 .text      func_8033FE44                  func_8033FE44                  */
.global func_8033FE44
func_8033FE44:
/* 8033FE44 0033CD84  3B A0 00 00 */	li r29, 0

/* 8033FE48 0028 .text      func_8033FE48                  func_8033FE48                  */
.global func_8033FE48
func_8033FE48:
...
/* 804516A8 0004 .sbss      OSResetSW__LastState           LastState                      */
...
/* 804516B4 0004 .sbss      sym_804516B4                   sym_804516B4                   */
.global sym_804516B4
sym_804516B4:
.skip 0x4
...
/* 804516BC 0004 .sbss      sym_804516BC                   sym_804516BC                   */
.global sym_804516BC
sym_804516BC:
.skip 0x4

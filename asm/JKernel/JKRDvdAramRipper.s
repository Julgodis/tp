...
/* 802DB04C 002D7F8C  38 63 43 C0 */	addi r3, r3, JKRDvdAramRipper__decompMutex@l
/* 802DB050 002D7F90  48 06 3F F1 */	bl OSLockMutex
/* 802DB054 002D7F94  83 0D 83 54 */	lwz r24, sSZSBufferSize__16JKRDvdAramRipper-_SDA_BASE_(r13)
...
/* 802DB068 002D7FA8  90 6D 8E E8 */	stw r3, JKRDvdAramRipper__szpBuf-_SDA_BASE_(r13)
/* 802DB06C 002D7FAC  7C 03 C2 14 */	add r0, r3, r24
/* 802DB070 002D7FB0  90 0D 8E EC */	stw r0, JKRDvdAramRipper__szpEnd-_SDA_BASE_(r13)
...
/* 802DB084 002D7FC4  90 6D 8E F0 */	stw r3, JKRDvdAramRipper__refBuf-_SDA_BASE_(r13)
/* 802DB088 002D7FC8  38 03 11 20 */	addi r0, r3, 0x1120
/* 802DB08C 002D7FCC  90 0D 8E F4 */	stw r0, JKRDvdAramRipper__refEnd-_SDA_BASE_(r13)
/* 802DB090 002D7FD0  90 6D 8E F8 */	stw r3, JKRDvdAramRipper__refCurrent-_SDA_BASE_(r13)
...
/* 802DB0A4 002D7FE4  90 6D 8E FC */	stw r3, dmaBuf-_SDA_BASE_(r13)
/* 802DB0A8 002D7FE8  38 03 01 00 */	addi r0, r3, 0x100
/* 802DB0AC 002D7FEC  90 0D 8F 00 */	stw r0, dmaEnd-_SDA_BASE_(r13)
/* 802DB0B0 002D7FF0  90 6D 8F 04 */	stw r3, dmaCurrent-_SDA_BASE_(r13)
/* 802DB0B4 002D7FF4  93 2D 8F 14 */	stw r25, JKRDvdAramRipper__srcFile-_SDA_BASE_(r13)
/* 802DB0B8 002D7FF8  93 CD 8F 08 */	stw r30, JKRDvdAramRipper__srcOffset-_SDA_BASE_(r13)
/* 802DB0BC 002D7FFC  7C 1E D8 50 */	subf r0, r30, r27
/* 802DB0C0 002D8000  90 0D 8F 0C */	stw r0, JKRDvdAramRipper__transLeft-_SDA_BASE_(r13)
/* 802DB0C4 002D8004  93 AD 8F 18 */	stw r29, JKRDvdAramRipper__fileOffset-_SDA_BASE_(r13)
...
/* 802DB120 002D8060  80 6D 8E F0 */	lwz r3, JKRDvdAramRipper__refBuf-_SDA_BASE_(r13)
/* 802DB124 002D8064  38 80 00 00 */	li r4, 0
/* 802DB128 002D8068  4B FF 33 D9 */	bl free__7JKRHeapFPvP7JKRHeap
/* 802DB12C 002D806C  80 6D 8E FC */	lwz r3, dmaBuf-_SDA_BASE_(r13)
/* 802DB130 002D8070  38 80 00 00 */	li r4, 0
/* 802DB134 002D8074  4B FF 33 CD */	bl free__7JKRHeapFPvP7JKRHeap
/* 802DB138 002D8078  3C 60 80 43 */	lis r3, JKRDvdAramRipper__decompMutex@ha
/* 802DB13C 002D807C  38 63 43 C0 */	addi r3, r3, JKRDvdAramRipper__decompMutex@l
...
/* 802DB244 002D8184  90 0D 8F 04 */	stw r0, dmaCurrent-_SDA_BASE_(r13)
/* 802DB248 002D8188  98 83 00 00 */	stb r4, 0(r3)
/* 802DB24C 002D818C  80 6D 8F 04 */	lwz r3, dmaCurrent-_SDA_BASE_(r13)
/* 802DB250 002D8190  80 0D 8F 00 */	lwz r0, dmaEnd-_SDA_BASE_(r13)
...
/* 802DB284 002D81C4  90 0D 8E F8 */	stw r0, JKRDvdAramRipper__refCurrent-_SDA_BASE_(r13)
...
/* 802DB2C8 002D8208  80 0D 8E F8 */	lwz r0, JKRDvdAramRipper__refCurrent-_SDA_BASE_(r13)
...
/* 802DB328 002D8268  90 0D 8F 04 */	stw r0, dmaCurrent-_SDA_BASE_(r13)
/* 802DB32C 002D826C  98 83 00 00 */	stb r4, 0(r3)
/* 802DB330 002D8270  80 6D 8F 04 */	lwz r3, dmaCurrent-_SDA_BASE_(r13)
/* 802DB334 002D8274  80 0D 8F 00 */	lwz r0, dmaEnd-_SDA_BASE_(r13)
...
/* 802DB368 002D82A8  90 0D 8E F8 */	stw r0, JKRDvdAramRipper__refCurrent-_SDA_BASE_(r13)
...
/* 802DB3FC 002D833C  80 6D 8E EC */	lwz r3, JKRDvdAramRipper__szpEnd-_SDA_BASE_(r13)
/* 802DB400 002D8340  38 03 FF E7 */	addi r0, r3, -25
/* 802DB404 002D8344  90 0D 8F 10 */	stw r0, JKRDvdAramRipper__srcLimit-_SDA_BASE_(r13)
/* 802DB408 002D8348  80 0D 8E E8 */	lwz r0, JKRDvdAramRipper__szpBuf-_SDA_BASE_(r13)
...
/* 802DB474 002D83B4  80 0D 8F 0C */	lwz r0, JKRDvdAramRipper__transLeft-_SDA_BASE_(r13)
...
/* 802DB4E8 002D8428  80 0D 8E EC */	lwz r0, JKRDvdAramRipper__szpEnd-_SDA_BASE_(r13)
...
/* 802DB510 002D8450  80 CD 8F 08 */	lwz r6, JKRDvdAramRipper__srcOffset-_SDA_BASE_(r13)
...
/* 802DB5F4 002D8534  3C 60 80 43 */	lis r3, sDvdAramAsyncList__16JKRDvdAramRipper@ha
/* 802DB5F8 002D8538  38 63 43 B4 */	addi r3, r3, sDvdAramAsyncList__16JKRDvdAramRipper@l
...
/* 802DB608 002D8548  3C 80 80 2E */	lis r4, __dt__23JSUList_SUB_012JKRADCommand_SUB_1Fv@ha
/* 802DB60C 002D854C  38 84 B6 2C */	addi r4, r4, __dt__23JSUList_SUB_012JKRADCommand_SUB_1Fv@l
/* 802DB610 002D8550  3C A0 80 43 */	lis r5, JKRDvdAramRipper__LIT_301@ha
/* 802DB614 002D8554  38 A5 43 A8 */	addi r5, r5, JKRDvdAramRipper__LIT_301@l

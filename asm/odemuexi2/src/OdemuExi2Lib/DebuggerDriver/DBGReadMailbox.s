...
/* 80373488  3B BE 68 00 */	addi r29, r30, 0x6800 /* 0xCC006800@l */ /* constant-address: CC006800 */
/* 8037348C  38 61 00 18 */	addi r3, r1, 0x18                       
/* 80373490  80 BE 68 28 */	lwz r5, 0x6828(r30)                      /* constant-address: CC006828 */
/* 80373494  70 A5 04 05 */	andi. r5, r5, 0x405                     
/* 80373498  60 A5 00 C0 */	ori r5, r5, 0xc0                        
/* 8037349C  94 BD 00 28 */	stwu r5, 0x28(r29)                       /* constant-address: CC006828 */
/* 803734A0  38 A0 00 01 */	li r5, 1                                
/* 803734A4  90 01 00 18 */	stw r0, 0x18(r1)                        
/* 803734A8  48 00 00 6D */	bl DBGEXIImm                             /* constant-address: 80373514, symbol: DBGEXIImm */
/* 803734AC  7C 60 00 34 */	cntlzw r0, r3                           
/* 803734B0  54 1F D9 7E */	srwi r31, r0, 5                         
lbl_803734B4:
/* 803734B4  3B 9E 68 00 */	addi r28, r30, 0x6800                    /* constant-address: CC006800 */
/* 803734B8  84 1C 00 34 */	lwzu r0, 0x34(r28)                       /* constant-address: CC006834 */
/* 803734BC  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 803734C0  40 82 FF F4 */	bne lbl_803734B4                         /* constant-address: 803734B4, symbol: lbl_803734B4 */
/* 803734C4  38 7B 00 00 */	addi r3, r27, 0                         
/* 803734C8  38 80 00 04 */	li r4, 4                                
/* 803734CC  38 A0 00 00 */	li r5, 0                                
/* 803734D0  48 00 00 45 */	bl DBGEXIImm                             /* constant-address: 80373514, symbol: DBGEXIImm */
/* 803734D4  7C 60 00 34 */	cntlzw r0, r3                           
/* 803734D8  54 00 D9 7E */	srwi r0, r0, 5                          
/* 803734DC  7F E3 03 78 */	or r3, r31, r0                          
lbl_803734E0:
/* 803734E0  80 1C 00 00 */	lwz r0, 0(r28)                           /* constant-address: CC006834 */
/* 803734E4  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 803734E8  40 82 FF F8 */	bne lbl_803734E0                         /* constant-address: 803734E0, symbol: lbl_803734E0 */
/* 803734EC  80 9D 00 00 */	lwz r4, 0(r29)                           /* constant-address: CC006828 */
/* 803734F0  7C 60 00 34 */	cntlzw r0, r3                           
/* 803734F4  54 03 D9 7E */	srwi r3, r0, 5                          
/* 803734F8  70 80 04 05 */	andi. r0, r4, 0x405                     
/* 803734FC  90 1D 00 00 */	stw r0, 0(r29)                           /* constant-address: CC006828 */

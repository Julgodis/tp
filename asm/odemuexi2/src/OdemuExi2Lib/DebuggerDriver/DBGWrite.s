...
/* 803732D4  3B FD 68 00 */	addi r31, r29, 0x6800 /* 0xCC006800@l */ /* constant-address: CC006800 */
/* 803732D8  38 61 00 24 */	addi r3, r1, 0x24                       
/* 803732DC  38 80 00 04 */	li r4, 4                                
/* 803732E0  38 A0 00 01 */	li r5, 1                                
/* 803732E4  80 DD 68 28 */	lwz r6, 0x6828(r29)                      /* constant-address: CC006828 */
/* 803732E8  70 C6 04 05 */	andi. r6, r6, 0x405                     
/* 803732EC  60 C6 00 C0 */	ori r6, r6, 0xc0                        
/* 803732F0  94 DF 00 28 */	stwu r6, 0x28(r31)                       /* constant-address: CC006828 */
/* 803732F4  90 01 00 24 */	stw r0, 0x24(r1)                        
/* 803732F8  48 00 02 1D */	bl DBGEXIImm                             /* constant-address: 80373514, symbol: DBGEXIImm */
/* 803732FC  7C 60 00 34 */	cntlzw r0, r3                           
/* 80373300  54 00 D9 7E */	srwi r0, r0, 5                          
/* 80373304  7C 1B 03 78 */	mr r27, r0                              
lbl_80373308:
/* 80373308  3B 9D 68 00 */	addi r28, r29, 0x6800                    /* constant-address: CC006800 */
/* 8037330C  84 1C 00 34 */	lwzu r0, 0x34(r28)                       /* constant-address: CC006834 */
/* 80373310  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 80373314  40 82 FF F4 */	bne lbl_80373308                         /* constant-address: 80373308, symbol: lbl_80373308 */
/* 80373318  48 00 00 44 */	b lbl_8037335C                           /* constant-address: 8037335C, symbol: lbl_8037335C */
lbl_8037331C:
...
/* 80373334  48 00 01 E1 */	bl DBGEXIImm                             /* constant-address: 80373514, symbol: DBGEXIImm */
/* 80373338  7C 60 00 34 */	cntlzw r0, r3                           
/* 8037333C  54 00 D9 7E */	srwi r0, r0, 5                          
/* 80373340  7F 7B 03 78 */	or r27, r27, r0                         
lbl_80373344:
/* 80373344  80 1C 00 00 */	lwz r0, 0(r28)                           /* constant-address: CC006834 */
/* 80373348  54 00 07 FF */	clrlwi. r0, r0, 0x1f                    
/* 8037334C  40 82 FF F8 */	bne lbl_80373344                         /* constant-address: 80373344, symbol: lbl_80373344 */
/* 80373350  37 DE FF FC */	addic. r30, r30, -4                     
/* 80373354  40 80 00 08 */	bge lbl_8037335C                         /* constant-address: 8037335C, symbol: lbl_8037335C */
/* 80373358  3B C0 00 00 */	li r30, 0                               
lbl_8037335C:
/* 8037335C  2C 1E 00 00 */	cmpwi r30, 0                            
/* 80373360  40 82 FF BC */	bne lbl_8037331C                         /* constant-address: 8037331C, symbol: lbl_8037331C */
/* 80373364  80 9F 00 00 */	lwz r4, 0(r31)                           /* constant-address: CC006828 */
/* 80373368  7F 60 00 34 */	cntlzw r0, r27                          
/* 8037336C  54 03 D9 7E */	srwi r3, r0, 5                          
/* 80373370  70 80 04 05 */	andi. r0, r4, 0x405                     
/* 80373374  90 1F 00 00 */	stw r0, 0(r31)                           /* constant-address: CC006828 */

lbl_8000B1EC:
/* 8000B1EC 00000000  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 8000B1F0 00000004  7C 08 02 A6 */	mflr r0
/* 8000B1F4 00000008  90 01 00 24 */	stw r0, 0x24(r1)
/* 8000B1F8 0000000C  93 E1 00 1C */	stw r31, 0x1c(r1)
/* 8000B1FC 00000010  7C 7F 1B 78 */	mr r31, r3
...
lbl_8000B2C0:
/* 8000B2C0 00000000  7F E3 FB 78 */	mr r3, r31
/* 8000B2C4 00000004  81 9F 00 00 */	lwz r12, 0(r31)
/* 8000B2C8 00000008  81 8C 00 10 */	lwz r12, 0x10(r12)
/* 8000B2CC 0000000C  7D 89 03 A6 */	mtctr r12
/* 8000B2D0 00000010  4E 80 04 21 */	bctrl 
/* 8000B2D4 00000014  3C 80 53 4C */	lis r4, 0x534C /* 0x534C4944@ha */
/* 8000B2D8 00000018  38 04 49 44 */	addi r0, r4, 0x4944 /* 0x534C4944@l */
/* 8000B2DC 0000001C  7C 03 00 00 */	cmpw r3, r0
/* 8000B2E0 00000020  41 82 00 84 */	beq lbl_8000B364
/* 8000B2E4 00000024  40 80 00 38 */	bge lbl_8000B31C
/* 8000B2E8 00000028  3C 80 41 53 */	lis r4, 0x4153 /* 0x41535448@ha */
/* 8000B2EC 0000002C  38 04 54 48 */	addi r0, r4, 0x5448 /* 0x41535448@l */
/* 8000B2F0 00000030  7C 03 00 00 */	cmpw r3, r0
/* 8000B2F4 00000034  41 82 00 50 */	beq lbl_8000B344
/* 8000B2F8 00000038  40 80 00 10 */	bge lbl_8000B308
/* 8000B2FC 0000003C  2C 03 00 00 */	cmpwi r3, 0
/* 8000B300 00000040  41 82 00 94 */	beq lbl_8000B394
/* 8000B304 00000044  48 00 00 A0 */	b lbl_8000B3A4
lbl_8000B308:
/* 8000B308 00000000  3C 80 45 58 */	lis r4, 0x4558 /* 0x45585048@ha */
/* 8000B30C 00000004  38 04 50 48 */	addi r0, r4, 0x5048 /* 0x45585048@l */
/* 8000B310 00000008  7C 03 00 00 */	cmpw r3, r0
/* 8000B314 0000000C  41 82 00 40 */	beq lbl_8000B354
/* 8000B318 00000010  48 00 00 8C */	b lbl_8000B3A4
lbl_8000B31C:
/* 8000B31C 00000000  3C 80 55 4E */	lis r4, 0x554E /* 0x554E4954@ha */
/* 8000B320 00000004  38 04 49 54 */	addi r0, r4, 0x4954 /* 0x554E4954@l */
/* 8000B324 00000008  7C 03 00 00 */	cmpw r3, r0
/* 8000B328 0000000C  41 82 00 5C */	beq lbl_8000B384
/* 8000B32C 00000010  40 80 00 78 */	bge lbl_8000B3A4
/* 8000B330 00000014  3C 80 53 54 */	lis r4, 0x5354 /* 0x53544448@ha */
/* 8000B334 00000018  38 04 44 48 */	addi r0, r4, 0x4448 /* 0x53544448@l */
/* 8000B338 0000001C  7C 03 00 00 */	cmpw r3, r0
...
lbl_8000B3A4:
/* 8000B3A4 00000000  90 61 00 08 */	stw r3, 8(r1)
/* 8000B3A8 00000004  88 01 00 08 */	lbz r0, 8(r1)
/* 8000B3AC 00000008  98 0D 86 90 */	stb r0, struct_80450C10+0x0(r13)
/* 8000B3B0 0000000C  88 01 00 09 */	lbz r0, 9(r1)
/* 8000B3B4 00000010  38 6D 86 90 */	addi r3, r13, 0x80450C10-0x80458580 /* struct_80450C10+0x0-_SDA_BASE_ */
/* 8000B3B8 00000014  98 03 00 01 */	stb r0, 1(r3)
/* 8000B3BC 00000018  88 01 00 0A */	lbz r0, 0xa(r1)
/* 8000B3C0 0000001C  98 03 00 02 */	stb r0, 2(r3)
/* 8000B3C4 00000020  88 01 00 0B */	lbz r0, 0xb(r1)
/* 8000B3C8 00000024  98 03 00 03 */	stb r0, 3(r3)
/* 8000B3CC 00000028  38 00 00 00 */	li r0, 0
/* 8000B3D0 0000002C  98 03 00 04 */	stb r0, 4(r3)
/* 8000B3D4 00000030  38 6D 86 90 */	addi r3, r13, 0x80450C10-0x80458580 /* struct_80450C10+0x0-_SDA_BASE_ */
lbl_8000B3D8:
/* 8000B3D8 00000000  83 E1 00 1C */	lwz r31, 0x1c(r1)
/* 8000B3DC 00000004  80 01 00 24 */	lwz r0, 0x24(r1)
/* 8000B3E0 00000008  7C 08 03 A6 */	mtlr r0
/* 8000B3E4 0000000C  38 21 00 20 */	addi r1, r1, 0x20
/* 8000B3E8 00000010  4E 80 00 20 */	blr 

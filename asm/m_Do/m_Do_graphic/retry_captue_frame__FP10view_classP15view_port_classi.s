...
/* 8000A170  48 35 80 65 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8000A1E0  83 6D 86 50 */	lwz r27, mFrameBufferTex__13mDoGph_gInf_c(r13) /* constant-address: 80450BD0, symbol: mFrameBufferTex__13mDoGph_gInf_c */
/* 8000A1E4  3C 60 80 40 */	lis r3, g_dComIfG_gameInfo@ha           
/* 8000A1E8  38 63 61 C0 */	addi r3, r3, g_dComIfG_gameInfo@l        /* constant-address: 804061C0, symbol: g_dComIfG_gameInfo */
/* 8000A1EC  88 03 5E B5 */	lbz r0, 0x5eb5(r3)                       /* constant-address: 8040C075, symbol: None */
/* 8000A1F0  28 00 00 00 */	cmplwi r0, 0                            
/* 8000A1F4  40 82 00 84 */	bne lbl_8000A278                         /* constant-address: 8000A278, symbol: lbl_8000A278 */
/* 8000A1F8  7C A0 07 35 */	extsh. r0, r5                           
/* 8000A1FC  40 80 00 30 */	bge lbl_8000A22C                         /* constant-address: 8000A22C, symbol: lbl_8000A22C */
...
/* 8000A214  80 AD 86 4C */	lwz r5, mFrameBufferTimg__13mDoGph_gInf_c(r13) /* constant-address: 80450BCC, symbol: mFrameBufferTimg__13mDoGph_gInf_c */
/* 8000A218  88 A5 00 00 */	lbz r5, 0(r5)                           
/* 8000A21C  38 C0 00 00 */	li r6, 0                                
/* 8000A220  38 E0 00 00 */	li r7, 0                                
/* 8000A224  48 35 39 F9 */	bl GXGetTexBufferSize                    /* constant-address: 8035DC1C, symbol: GXGetTexBufferSize */
...
/* 8000A23C  48 35 28 45 */	bl GXSetTexCopySrc                       /* constant-address: 8035CA80, symbol: GXSetTexCopySrc */
...
/* 8000A254  80 AD 86 4C */	lwz r5, mFrameBufferTimg__13mDoGph_gInf_c(r13) /* constant-address: 80450BCC, symbol: mFrameBufferTimg__13mDoGph_gInf_c */
/* 8000A258  88 A5 00 00 */	lbz r5, 0(r5)                           
/* 8000A25C  38 C0 00 01 */	li r6, 1                                
/* 8000A260  48 35 28 D1 */	bl GXSetTexCopyDst                       /* constant-address: 8035CB30, symbol: GXSetTexCopyDst */
/* 8000A264  7F 63 DB 78 */	mr r3, r27                              
/* 8000A268  38 80 00 00 */	li r4, 0                                
/* 8000A26C  48 35 32 01 */	bl GXCopyTex                             /* constant-address: 8035D46C, symbol: GXCopyTex */
/* 8000A270  48 35 21 05 */	bl GXPixModeSync                         /* constant-address: 8035C374, symbol: GXPixModeSync */
/* 8000A274  48 35 43 F1 */	bl GXInvalidateTexAll                    /* constant-address: 8035E664, symbol: GXInvalidateTexAll */
lbl_8000A278:
/* 8000A278  39 61 00 40 */	addi r11, r1, 0x40                      
/* 8000A27C  48 35 7F A5 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

...
/* 8000C564  48 25 A5 D1 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 8000C588  48 25 A9 6D */	bl normalize__4cXyzFv                    /* constant-address: 80266EF4, symbol: normalize__4cXyzFv */
/* 8000C58C  C0 22 81 0C */	lfs f1, lit_3677(r2)                     /* constant-address: 80451B0C, symbol: lit_3677 */
/* 8000C590  D0 21 00 80 */	stfs f1, 0x80(r1)                       
/* 8000C594  C0 02 81 08 */	lfs f0, lit_3676(r2)                     /* constant-address: 80451B08, symbol: lit_3676 */
...
/* 8000C5AC  48 25 A7 11 */	bl outprod__4cXyzCFRC3Vec                /* constant-address: 80266CBC, symbol: outprod__4cXyzCFRC3Vec */
...
/* 8000C5CC  48 25 AA 11 */	bl normalizeRS__4cXyzFv                  /* constant-address: 80266FDC, symbol: normalizeRS__4cXyzFv */
/* 8000C5D0  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8000C5D4  40 82 00 50 */	bne lbl_8000C624                         /* constant-address: 8000C624, symbol: lbl_8000C624 */
/* 8000C5D8  C0 01 00 6C */	lfs f0, 0x6c(r1)                        
/* 8000C5DC  FC 00 00 50 */	fneg f0, f0                             
/* 8000C5E0  D0 01 00 80 */	stfs f0, 0x80(r1)                       
/* 8000C5E4  C0 02 81 0C */	lfs f0, lit_3677(r2)                     /* constant-address: 80451B0C, symbol: lit_3677 */
...
/* 8000C5FC  48 25 A6 C1 */	bl outprod__4cXyzCFRC3Vec                /* constant-address: 80266CBC, symbol: outprod__4cXyzCFRC3Vec */
...
/* 8000C620  48 25 A8 D5 */	bl normalize__4cXyzFv                    /* constant-address: 80266EF4, symbol: normalize__4cXyzFv */
lbl_8000C624:
/* 8000C624  38 61 00 14 */	addi r3, r1, 0x14                       
/* 8000C628  38 81 00 68 */	addi r4, r1, 0x68                       
/* 8000C62C  38 A1 00 80 */	addi r5, r1, 0x80                       
/* 8000C630  48 25 A6 8D */	bl outprod__4cXyzCFRC3Vec                /* constant-address: 80266CBC, symbol: outprod__4cXyzCFRC3Vec */
...
/* 8000C654  48 25 A8 A1 */	bl normalize__4cXyzFv                    /* constant-address: 80266EF4, symbol: normalize__4cXyzFv */
...
/* 8000C678  48 33 AB 1D */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
...
/* 8000C6A4  48 33 AA F1 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
...
/* 8000C6D0  48 33 AA C5 */	bl PSVECDotProduct                       /* constant-address: 80347194, symbol: PSVECDotProduct */
...
/* 8000C6E4  4B FF FD 91 */	bl mDoMtx_ZrotS__FPA4_fs                 /* constant-address: 8000C474, symbol: mDoMtx_ZrotS__FPA4_fs */
/* 8000C6E8  38 61 00 98 */	addi r3, r1, 0x98                       
/* 8000C6EC  7F C4 F3 78 */	mr r4, r30                              
/* 8000C6F0  7F C5 F3 78 */	mr r5, r30                              
/* 8000C6F4  48 33 9D F1 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */

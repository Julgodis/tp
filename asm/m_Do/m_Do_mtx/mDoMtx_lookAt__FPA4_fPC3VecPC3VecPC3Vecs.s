...
/* 8000C780  48 25 A3 B5 */	bl __mi__4cXyzCFRC3Vec                   /* constant-address: 80266B34, symbol: __mi__4cXyzCFRC3Vec */
...
/* 8000C7A0  48 25 A8 3D */	bl normalizeRS__4cXyzFv                  /* constant-address: 80266FDC, symbol: normalizeRS__4cXyzFv */
/* 8000C7A4  54 60 06 3F */	clrlwi. r0, r3, 0x18                    
/* 8000C7A8  40 82 00 14 */	bne lbl_8000C7BC                         /* constant-address: 8000C7BC, symbol: lbl_8000C7BC */
/* 8000C7AC  C0 21 00 40 */	lfs f1, 0x40(r1)                        
/* 8000C7B0  C0 02 81 08 */	lfs f0, lit_3676(r2)                     /* constant-address: 80451B08, symbol: lit_3676 */
...
/* 8000C7C8  C0 2D 8C 00 */	lfs f1, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8000C7CC  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8000C7D0  40 80 00 34 */	bge lbl_8000C804                         /* constant-address: 8000C804, symbol: lbl_8000C804 */
...
/* 8000C7E4  40 80 00 20 */	bge lbl_8000C804                         /* constant-address: 8000C804, symbol: lbl_8000C804 */
...
/* 8000C7F8  40 80 00 0C */	bge lbl_8000C804                         /* constant-address: 8000C804, symbol: lbl_8000C804 */
/* 8000C7FC  C0 02 81 08 */	lfs f0, lit_3676(r2)                     /* constant-address: 80451B08, symbol: lit_3676 */
...
/* 8000C814  48 33 A2 79 */	bl C_MTXLookAt                           /* constant-address: 80346A8C, symbol: C_MTXLookAt */
/* 8000C818  38 61 00 50 */	addi r3, r1, 0x50                       
/* 8000C81C  7F E4 FB 78 */	mr r4, r31                              
/* 8000C820  4B FF FC 55 */	bl mDoMtx_ZrotS__FPA4_fs                 /* constant-address: 8000C474, symbol: mDoMtx_ZrotS__FPA4_fs */
/* 8000C824  38 61 00 50 */	addi r3, r1, 0x50                       
/* 8000C828  7F C4 F3 78 */	mr r4, r30                              
/* 8000C82C  7F C5 F3 78 */	mr r5, r30                              
/* 8000C830  48 33 9C B5 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 8000C834  C0 5E 00 24 */	lfs f2, 0x24(r30)                       
/* 8000C838  C0 3E 00 14 */	lfs f1, 0x14(r30)                       
/* 8000C83C  C0 02 81 0C */	lfs f0, lit_3677(r2)                     /* constant-address: 80451B0C, symbol: lit_3677 */
...
/* 8000C85C  C0 22 81 10 */	lfs f1, lit_3840(r2)                     /* constant-address: 80451B10, symbol: lit_3840 */
/* 8000C860  3C 60 80 45 */	lis r3, __float_epsilon@ha              
/* 8000C864  C0 03 0A EC */	lfs f0, __float_epsilon@l(r3)            /* constant-address: 80450AEC, symbol: __float_epsilon */
/* 8000C868  EC 01 00 32 */	fmuls f0, f1, f0                        
/* 8000C86C  FC 02 00 40 */	fcmpo cr0, f2, f0                       
/* 8000C870  4C 40 13 82 */	cror 2, 0, 2                            
/* 8000C874  40 82 00 44 */	bne lbl_8000C8B8                         /* constant-address: 8000C8B8, symbol: lbl_8000C8B8 */
/* 8000C878  C0 21 00 3C */	lfs f1, 0x3c(r1)                        
/* 8000C87C  C0 02 81 08 */	lfs f0, lit_3676(r2)                     /* constant-address: 80451B08, symbol: lit_3676 */
...
/* 8000C898  48 33 A1 F5 */	bl C_MTXLookAt                           /* constant-address: 80346A8C, symbol: C_MTXLookAt */
/* 8000C89C  38 61 00 50 */	addi r3, r1, 0x50                       
/* 8000C8A0  7F E4 FB 78 */	mr r4, r31                              
/* 8000C8A4  4B FF FB D1 */	bl mDoMtx_ZrotS__FPA4_fs                 /* constant-address: 8000C474, symbol: mDoMtx_ZrotS__FPA4_fs */
/* 8000C8A8  38 61 00 50 */	addi r3, r1, 0x50                       
/* 8000C8AC  7F C4 F3 78 */	mr r4, r30                              
/* 8000C8B0  7F C5 F3 78 */	mr r5, r30                              
/* 8000C8B4  48 33 9C 31 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
lbl_8000C8B8:

...
/* 8000F4D0  48 35 2D 01 */	bl _savegpr_26                           /* constant-address: 803621D0, symbol: _savegpr_26 */
/* 8000F4D4  7C 7C 1B 78 */	mr r28, r3                              
/* 8000F4D8  80 6D 90 74 */	lwz r3, mJoint__10J3DMtxCalc(r13)        /* constant-address: 804515F4, symbol: mJoint__10J3DMtxCalc */
/* 8000F4DC  A3 E3 00 14 */	lhz r31, 0x14(r3)                       
/* 8000F4E0  7F FB FB 78 */	mr r27, r31                             
/* 8000F4E4  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8000F4E8  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000F4EC  93 83 00 30 */	stw r28, 0x30(r3)                        /* constant-address: 80434AF8, symbol: None */
/* 8000F4F0  80 63 00 38 */	lwz r3, 0x38(r3)                         /* constant-address: 80434B00, symbol: None */
...
/* 8000F528  48 32 A3 51 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
...
/* 8000F554  48 00 01 20 */	b lbl_8000F674                           /* constant-address: 8000F674, symbol: lbl_8000F674 */
lbl_8000F558:
/* 8000F558  80 7C 00 08 */	lwz r3, 8(r28)                          
/* 8000F55C  38 1D 00 04 */	addi r0, r29, 4                          /* constant-address: 0000000C */
/* 8000F560  7C 63 00 2E */	lwzx r3, r3, r0                         
/* 8000F564  28 03 00 00 */	cmplwi r3, 0                            
/* 8000F568  41 82 01 04 */	beq lbl_8000F66C                         /* constant-address: 8000F66C, symbol: lbl_8000F66C */
...
/* 8000F58C  C0 02 81 18 */	lfs f0, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
...
/* 8000F5A4  48 32 A2 D5 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
...
/* 8000F5B8  48 32 A3 81 */	bl JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion /* constant-address: 80339938, symbol: JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion */
...
lbl_8000F66C:
/* 8000F66C  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000002 */
/* 8000F670  3B BD 00 08 */	addi r29, r29, 8                         /* constant-address: 00000010 */
lbl_8000F674:
/* 8000F674  80 1C 00 04 */	lwz r0, 4(r28)                          
/* 8000F678  7C 1A 00 00 */	cmpw r26, r0                            
/* 8000F67C  41 80 FE DC */	blt lbl_8000F558                         /* constant-address: 8000F558, symbol: lbl_8000F558 */
...
/* 8000F6A8  41 82 00 DC */	beq lbl_8000F784                         /* constant-address: 8000F784, symbol: lbl_8000F784 */
/* 8000F6AC  C3 E4 00 0C */	lfs f31, 0xc(r4)                        
/* 8000F6B0  C0 02 81 1C */	lfs f0, lit_3876(r2)                     /* constant-address: 80451B1C, symbol: lit_3876 */
/* 8000F6B4  FC 1F 00 40 */	fcmpo cr0, f31, f0                      
/* 8000F6B8  40 81 00 E4 */	ble lbl_8000F79C                         /* constant-address: 8000F79C, symbol: lbl_8000F79C */
/* 8000F6BC  A0 04 00 18 */	lhz r0, 0x18(r4)                        
/* 8000F6C0  7C 00 E8 40 */	cmplw r0, r29                           
/* 8000F6C4  41 81 00 D8 */	bgt lbl_8000F79C                         /* constant-address: 8000F79C, symbol: lbl_8000F79C */
/* 8000F6C8  A0 04 00 1A */	lhz r0, 0x1a(r4)                        
/* 8000F6CC  7C 00 E8 40 */	cmplw r0, r29                           
/* 8000F6D0  40 81 00 CC */	ble lbl_8000F79C                         /* constant-address: 8000F79C, symbol: lbl_8000F79C */
/* 8000F6D4  C0 02 81 18 */	lfs f0, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
...
/* 8000F6EC  48 32 A2 4D */	bl JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion /* constant-address: 80339938, symbol: JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion */
...
/* 8000F780  48 00 00 1C */	b lbl_8000F79C                           /* constant-address: 8000F79C, symbol: lbl_8000F79C */
lbl_8000F784:
/* 8000F784  A0 7E 00 2C */	lhz r3, 0x2c(r30)                       
/* 8000F788  38 03 FF FF */	addi r0, r3, -1                         
/* 8000F78C  7C 1D 00 00 */	cmpw r29, r0                            
/* 8000F790  40 82 00 0C */	bne lbl_8000F79C                         /* constant-address: 8000F79C, symbol: lbl_8000F79C */
...
/* 8000F7A4  48 33 72 45 */	bl PSMTXQuat                             /* constant-address: 803469E8, symbol: PSMTXQuat */
/* 8000F7A8  38 61 00 78 */	addi r3, r1, 0x78                       
/* 8000F7AC  38 81 00 58 */	addi r4, r1, 0x58                       
/* 8000F7B0  7F E5 FB 78 */	mr r5, r31                              
/* 8000F7B4  4B FF D8 F9 */	bl mDoExt_setJ3DData__FPA4_fPC16J3DTransformInfoUs /* constant-address: 8000D0AC, symbol: mDoExt_setJ3DData__FPA4_fPC16J3DTransformInfoUs */
...
/* 8000F814  40 82 00 0C */	bne lbl_8000F820                         /* constant-address: 8000F820, symbol: lbl_8000F820 */
/* 8000F818  80 7C 00 0C */	lwz r3, 0xc(r28)                        
/* 8000F81C  48 00 00 B1 */	bl decOldFrameMorfCounter__22mDoExt_MtxCalcOldFrameFv /* constant-address: 8000F8CC, symbol: decOldFrameMorfCounter__22mDoExt_MtxCalcOldFrameFv */
lbl_8000F820:
...
/* 8000F834  48 35 29 E9 */	bl _restgpr_26                           /* constant-address: 8036221C, symbol: _restgpr_26 */

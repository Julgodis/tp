...
/* 80010094  48 35 21 45 */	bl _savegpr_28                           /* constant-address: 803621D8, symbol: _savegpr_28 */
/* 80010098  7C 7C 1B 78 */	mr r28, r3                              
/* 8001009C  80 03 00 04 */	lwz r0, 4(r3)                           
/* 800100A0  28 00 00 00 */	cmplwi r0, 0                            
/* 800100A4  41 82 02 B0 */	beq lbl_80010354                         /* constant-address: 80010354, symbol: lbl_80010354 */
/* 800100A8  80 6D 90 74 */	lwz r3, mJoint__10J3DMtxCalc(r13)        /* constant-address: 804515F4, symbol: mJoint__10J3DMtxCalc */
/* 800100AC  A3 E3 00 14 */	lhz r31, 0x14(r3)                       
/* 800100B0  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 800100B4  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 800100B8  93 83 00 30 */	stw r28, 0x30(r3)                        /* constant-address: 80434AF8, symbol: None */
/* 800100BC  80 7C 00 20 */	lwz r3, 0x20(r28)                       
/* 800100C0  28 03 00 00 */	cmplwi r3, 0                            
/* 800100C4  40 82 00 0C */	bne lbl_800100D0                         /* constant-address: 800100D0, symbol: lbl_800100D0 */
/* 800100C8  3B C1 00 48 */	addi r30, r1, 0x48                      
/* 800100CC  48 00 00 0C */	b lbl_800100D8                           /* constant-address: 800100D8, symbol: lbl_800100D8 */
lbl_800100D0:
...
/* 800100E0  40 82 00 0C */	bne lbl_800100EC                         /* constant-address: 800100EC, symbol: lbl_800100EC */
/* 800100E4  3B A1 00 18 */	addi r29, r1, 0x18                      
/* 800100E8  48 00 00 0C */	b lbl_800100F4                           /* constant-address: 800100F4, symbol: lbl_800100F4 */
lbl_800100EC:
...
/* 800100FC  40 82 00 8C */	bne lbl_80010188                         /* constant-address: 80010188, symbol: lbl_80010188 */
...
/* 8001014C  41 82 00 1C */	beq lbl_80010168                         /* constant-address: 80010168, symbol: lbl_80010168 */
...
/* 80010178  48 32 97 01 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
/* 8001017C  7F C3 F3 78 */	mr r3, r30                              
/* 80010180  48 31 EE 3D */	bl calcTransform__27J3DMtxCalcCalcTransformMayaFRC16J3DTransformInfo /* constant-address: 8032EFBC, symbol: calcTransform__27J3DMtxCalcCalcTransformMayaFRC16J3DTransformInfo */
/* 80010184  48 00 01 B0 */	b lbl_80010334                           /* constant-address: 80010334, symbol: lbl_80010334 */
lbl_80010188:
/* 80010188  C0 3C 00 28 */	lfs f1, 0x28(r28)                       
/* 8001018C  C0 02 81 18 */	lfs f0, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
/* 80010190  FC 01 00 40 */	fcmpo cr0, f1, f0                       
/* 80010194  4C 41 13 82 */	cror 2, 1, 2                            
/* 80010198  41 82 00 14 */	beq lbl_800101AC                         /* constant-address: 800101AC, symbol: lbl_800101AC */
/* 8001019C  28 03 00 00 */	cmplwi r3, 0                            
/* 800101A0  41 82 00 0C */	beq lbl_800101AC                         /* constant-address: 800101AC, symbol: lbl_800101AC */
/* 800101A4  28 04 00 00 */	cmplwi r4, 0                            
/* 800101A8  40 82 00 58 */	bne lbl_80010200                         /* constant-address: 80010200, symbol: lbl_80010200 */
lbl_800101AC:
/* 800101AC  7F 83 E3 78 */	mr r3, r28                              
/* 800101B0  7F E4 FB 78 */	mr r4, r31                              
/* 800101B4  7F C5 F3 78 */	mr r5, r30                              
/* 800101B8  48 00 05 59 */	bl getTransform__14mDoExt_McaMorfFUsP16J3DTransformInfo /* constant-address: 80010710, symbol: getTransform__14mDoExt_McaMorfFUsP16J3DTransformInfo */
/* 800101BC  80 7C 00 38 */	lwz r3, 0x38(r28)                       
/* 800101C0  28 03 00 00 */	cmplwi r3, 0                            
/* 800101C4  41 82 00 1C */	beq lbl_800101E0                         /* constant-address: 800101E0, symbol: lbl_800101E0 */
...
/* 800101F0  48 32 96 89 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
/* 800101F4  7F C3 F3 78 */	mr r3, r30                              
/* 800101F8  48 31 ED C5 */	bl calcTransform__27J3DMtxCalcCalcTransformMayaFRC16J3DTransformInfo /* constant-address: 8032EFBC, symbol: calcTransform__27J3DMtxCalcCalcTransformMayaFRC16J3DTransformInfo */
/* 800101FC  48 00 01 38 */	b lbl_80010334                           /* constant-address: 80010334, symbol: lbl_80010334 */
lbl_80010200:
/* 80010200  88 1C 00 52 */	lbz r0, 0x52(r28)                       
/* 80010204  28 00 00 00 */	cmplwi r0, 0                            
/* 80010208  41 82 00 0C */	beq lbl_80010214                         /* constant-address: 80010214, symbol: lbl_80010214 */
/* 8001020C  FF E0 00 90 */	fmr f31, f0                             
/* 80010210  48 00 00 14 */	b lbl_80010224                           /* constant-address: 80010224, symbol: lbl_80010224 */
lbl_80010214:
...
lbl_80010224:
/* 80010224  C0 02 81 18 */	lfs f0, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
...
/* 80010238  48 00 04 D9 */	bl getTransform__14mDoExt_McaMorfFUsP16J3DTransformInfo /* constant-address: 80010710, symbol: getTransform__14mDoExt_McaMorfFUsP16J3DTransformInfo */
/* 8001023C  80 7C 00 38 */	lwz r3, 0x38(r28)                       
/* 80010240  28 03 00 00 */	cmplwi r3, 0                            
/* 80010244  41 82 00 1C */	beq lbl_80010260                         /* constant-address: 80010260, symbol: lbl_80010260 */
...
/* 80010270  48 32 96 09 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
...
/* 80010284  48 32 96 B5 */	bl JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion /* constant-address: 80339938, symbol: JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion */
/* 80010288  38 61 00 68 */	addi r3, r1, 0x68                       
/* 8001028C  7F A4 EB 78 */	mr r4, r29                              
/* 80010290  48 33 67 59 */	bl PSMTXQuat                             /* constant-address: 803469E8, symbol: PSMTXQuat */
...
/* 80010330  4B FF CD 7D */	bl mDoExt_setJ3DData__FPA4_fPC16J3DTransformInfoUs /* constant-address: 8000D0AC, symbol: mDoExt_setJ3DData__FPA4_fPC16J3DTransformInfoUs */
lbl_80010334:
/* 80010334  80 7C 00 3C */	lwz r3, 0x3c(r28)                       
/* 80010338  28 03 00 00 */	cmplwi r3, 0                            
/* 8001033C  41 82 00 18 */	beq lbl_80010354                         /* constant-address: 80010354, symbol: lbl_80010354 */
...
/* 80010368  48 35 1E BD */	bl _restgpr_28                           /* constant-address: 80362224, symbol: _restgpr_28 */

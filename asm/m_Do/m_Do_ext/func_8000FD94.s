...
/* 8000FDAC  48 35 24 11 */	bl _savegpr_21                           /* constant-address: 803621BC, symbol: _savegpr_21 */
...
/* 8000FDF8  40 82 00 0C */	bne lbl_8000FE04                         /* constant-address: 8000FE04, symbol: lbl_8000FE04 */
/* 8000FDFC  38 60 00 00 */	li r3, 0                                
/* 8000FE00  48 00 02 54 */	b lbl_80010054                           /* constant-address: 80010054, symbol: lbl_80010054 */
lbl_8000FE04:
...
/* 8000FE14  41 82 00 24 */	beq lbl_8000FE38                         /* constant-address: 8000FE38, symbol: lbl_8000FE38 */
/* 8000FE18  28 1F 00 00 */	cmplwi r31, 0                           
/* 8000FE1C  40 82 00 1C */	bne lbl_8000FE38                         /* constant-address: 8000FE38, symbol: lbl_8000FE38 */
/* 8000FE20  A0 16 00 74 */	lhz r0, 0x74(r22)                       
/* 8000FE24  28 00 00 01 */	cmplwi r0, 1                            
/* 8000FE28  40 82 00 0C */	bne lbl_8000FE34                         /* constant-address: 8000FE34, symbol: lbl_8000FE34 */
/* 8000FE2C  3F E0 00 02 */	lis r31, 2                              
/* 8000FE30  48 00 00 08 */	b lbl_8000FE38                           /* constant-address: 8000FE38, symbol: lbl_8000FE38 */
lbl_8000FE34:
/* 8000FE34  3F E0 00 08 */	lis r31, 8                              
lbl_8000FE38:
/* 8000FE38  7E C3 B3 78 */	mr r3, r22                              
/* 8000FE3C  7F E4 FB 78 */	mr r4, r31                              
/* 8000FE40  48 00 4E 15 */	bl mDoExt_J3DModel__create__FP12J3DModelDataUlUl /* constant-address: 80014C54, symbol: mDoExt_J3DModel__create__FP12J3DModelDataUlUl */
/* 8000FE44  90 75 00 04 */	stw r3, 4(r21)                          
/* 8000FE48  80 75 00 04 */	lwz r3, 4(r21)                          
/* 8000FE4C  28 03 00 00 */	cmplwi r3, 0                            
/* 8000FE50  40 82 00 0C */	bne lbl_8000FE5C                         /* constant-address: 8000FE5C, symbol: lbl_8000FE5C */
/* 8000FE54  38 60 00 00 */	li r3, 0                                
/* 8000FE58  48 00 01 FC */	b lbl_80010054                           /* constant-address: 80010054, symbol: lbl_80010054 */
lbl_8000FE5C:
/* 8000FE5C  3C 1F FF F8 */	addis r0, r31, 0xfff8                   
/* 8000FE60  28 00 00 00 */	cmplwi r0, 0                            
/* 8000FE64  41 82 00 08 */	beq lbl_8000FE6C                         /* constant-address: 8000FE6C, symbol: lbl_8000FE6C */
/* 8000FE68  4B FF DC 41 */	bl mDoExt_changeMaterial__FP8J3DModel    /* constant-address: 8000DAA8, symbol: mDoExt_changeMaterial__FP8J3DModel */
lbl_8000FE6C:
/* 8000FE6C  28 1E 00 00 */	cmplwi r30, 0                           
/* 8000FE70  40 82 00 20 */	bne lbl_8000FE90                         /* constant-address: 8000FE90, symbol: lbl_8000FE90 */
/* 8000FE74  28 19 00 00 */	cmplwi r25, 0                           
/* 8000FE78  41 82 00 18 */	beq lbl_8000FE90                         /* constant-address: 8000FE90, symbol: lbl_8000FE90 */
/* 8000FE7C  80 19 00 28 */	lwz r0, 0x28(r25)                       
/* 8000FE80  7C 1E 03 78 */	mr r30, r0                              
/* 8000FE84  28 00 00 00 */	cmplwi r0, 0                            
/* 8000FE88  41 82 00 08 */	beq lbl_8000FE90                         /* constant-address: 8000FE90, symbol: lbl_8000FE90 */
/* 8000FE8C  3B A0 00 01 */	li r29, 1                               
lbl_8000FE90:
/* 8000FE90  2C 1D 00 00 */	cmpwi r29, 0                            
/* 8000FE94  41 82 00 34 */	beq lbl_8000FEC8                         /* constant-address: 8000FEC8, symbol: lbl_8000FEC8 */
/* 8000FE98  38 60 00 4C */	li r3, 0x4c                             
/* 8000FE9C  48 2B ED B1 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8000FEA0  7C 7D 1B 79 */	or. r29, r3, r3                         
/* 8000FEA4  41 82 00 14 */	beq lbl_8000FEB8                         /* constant-address: 8000FEB8, symbol: lbl_8000FEB8 */
/* 8000FEA8  48 2A EC ED */	bl __ct__15Z2SoundObjAnimeFv             /* constant-address: 802BEB94, symbol: __ct__15Z2SoundObjAnimeFv */
/* 8000FEAC  3C 60 80 3A */	lis r3, __vt__15mDoExt_zelAnime@ha      
/* 8000FEB0  38 03 32 DC */	addi r0, r3, __vt__15mDoExt_zelAnime@l   /* constant-address: 803A32DC, symbol: __vt__15mDoExt_zelAnime */
...
/* 8000FEC4  41 82 01 38 */	beq lbl_8000FFFC                         /* constant-address: 8000FFFC, symbol: lbl_8000FFFC */
lbl_8000FEC8:
/* 8000FEC8  7E A3 AB 78 */	mr r3, r21                              
/* 8000FECC  7F 24 CB 78 */	mr r4, r25                              
/* 8000FED0  7F 45 D3 78 */	mr r5, r26                              
/* 8000FED4  C0 22 81 1C */	lfs f1, lit_3876(r2)                     /* constant-address: 80451B1C, symbol: lit_3876 */
/* 8000FED8  FC 40 F8 90 */	fmr f2, f31                             
/* 8000FEDC  C8 82 81 20 */	lfd f4, lit_3878(r2)                     /* constant-address: 80451B20, symbol: lit_3878 */
...
/* 8000FF10  48 00 04 6D */	bl setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv /* constant-address: 8001037C, symbol: setAnm__14mDoExt_McaMorfFP15J3DAnmTransformiffffPv */
/* 8000FF14  C0 02 81 28 */	lfs f0, lit_5939(r2)                     /* constant-address: 80451B28, symbol: lit_5939 */
...
/* 8000FF28  48 2B ED 9D */	bl __nwa__FUl                            /* constant-address: 802CECC4, symbol: __nwa__FUl */
/* 8000FF2C  38 80 00 00 */	li r4, 0                                
/* 8000FF30  38 A0 00 00 */	li r5, 0                                
/* 8000FF34  38 C0 00 20 */	li r6, 0x20                             
/* 8000FF38  7F 27 CB 78 */	mr r7, r25                              
/* 8000FF3C  48 35 1F D9 */	bl __construct_new_array                 /* constant-address: 80361F14, symbol: __construct_new_array */
/* 8000FF40  90 75 00 20 */	stw r3, 0x20(r21)                       
/* 8000FF44  80 15 00 20 */	lwz r0, 0x20(r21)                       
/* 8000FF48  28 00 00 00 */	cmplwi r0, 0                            
/* 8000FF4C  41 82 00 B0 */	beq lbl_8000FFFC                         /* constant-address: 8000FFFC, symbol: lbl_8000FFFC */
/* 8000FF50  A0 16 00 2C */	lhz r0, 0x2c(r22)                       
/* 8000FF54  54 03 23 36 */	rlwinm r3, r0, 4, 0xc, 0x1b             
/* 8000FF58  48 2B ED 6D */	bl __nwa__FUl                            /* constant-address: 802CECC4, symbol: __nwa__FUl */
/* 8000FF5C  90 75 00 24 */	stw r3, 0x24(r21)                       
/* 8000FF60  80 15 00 24 */	lwz r0, 0x24(r21)                       
/* 8000FF64  28 00 00 00 */	cmplwi r0, 0                            
/* 8000FF68  41 82 00 94 */	beq lbl_8000FFFC                         /* constant-address: 8000FFFC, symbol: lbl_8000FFFC */
...
/* 8000FF84  48 00 00 60 */	b lbl_8000FFE4                           /* constant-address: 8000FFE4, symbol: lbl_8000FFE4 */
lbl_8000FF88:
...
/* 8000FFD4  48 32 98 A5 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
/* 8000FFD8  3B 5A 00 20 */	addi r26, r26, 0x20                     
/* 8000FFDC  3B 7B 00 10 */	addi r27, r27, 0x10                     
/* 8000FFE0  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
lbl_8000FFE4:
/* 8000FFE4  7C 1C B0 00 */	cmpw r28, r22                           
/* 8000FFE8  41 80 FF A0 */	blt lbl_8000FF88                         /* constant-address: 8000FF88, symbol: lbl_8000FF88 */
/* 8000FFEC  92 F5 00 38 */	stw r23, 0x38(r21)                      
/* 8000FFF0  93 15 00 3C */	stw r24, 0x3c(r21)                      
/* 8000FFF4  38 60 00 01 */	li r3, 1                                
/* 8000FFF8  48 00 00 5C */	b lbl_80010054                           /* constant-address: 80010054, symbol: lbl_80010054 */
lbl_8000FFFC:
/* 8000FFFC  80 75 00 4C */	lwz r3, 0x4c(r21)                       
/* 80010000  28 03 00 00 */	cmplwi r3, 0                            
/* 80010004  41 82 00 10 */	beq lbl_80010014                         /* constant-address: 80010014, symbol: lbl_80010014 */
...
/* 8001001C  41 82 00 0C */	beq lbl_80010028                         /* constant-address: 80010028, symbol: lbl_80010028 */
...
/* 80010030  41 82 00 0C */	beq lbl_8001003C                         /* constant-address: 8001003C, symbol: lbl_8001003C */
...
/* 80010044  41 82 00 0C */	beq lbl_80010050                         /* constant-address: 80010050, symbol: lbl_80010050 */
...
/* 80010060  48 35 21 A9 */	bl _restgpr_21                           /* constant-address: 80362208, symbol: _restgpr_21 */

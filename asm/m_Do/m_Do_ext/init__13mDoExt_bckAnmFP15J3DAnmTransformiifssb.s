...
/* 8000D7F0  48 35 49 E5 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8000D814  40 82 00 58 */	bne lbl_8000D86C                         /* constant-address: 8000D86C, symbol: lbl_8000D86C */
/* 8000D818  38 60 00 0C */	li r3, 0xc                              
/* 8000D81C  48 2C 14 31 */	bl __nw__FUl                             /* constant-address: 802CEC4C, symbol: __nw__FUl */
/* 8000D820  28 03 00 00 */	cmplwi r3, 0                            
/* 8000D824  41 82 00 30 */	beq lbl_8000D854                         /* constant-address: 8000D854, symbol: lbl_8000D854 */
/* 8000D828  80 BF 00 14 */	lwz r5, 0x14(r31)                       
/* 8000D82C  3C 80 80 3A */	lis r4, __vt__10J3DMtxCalc@ha           
/* 8000D830  38 04 34 68 */	addi r0, r4, __vt__10J3DMtxCalc@l        /* constant-address: 803A3468, symbol: __vt__10J3DMtxCalc */
/* 8000D834  90 03 00 00 */	stw r0, 0(r3)                            /* constant-address: 0000000C */
/* 8000D838  3C 80 80 3A */	lis r4, __vt__17J3DMtxCalcAnmBase@ha    
/* 8000D83C  38 04 34 3C */	addi r0, r4, __vt__17J3DMtxCalcAnmBase@l /* constant-address: 803A343C, symbol: __vt__17J3DMtxCalcAnmBase */
/* 8000D840  90 03 00 00 */	stw r0, 0(r3)                            /* constant-address: 0000000C */
/* 8000D844  90 A3 00 04 */	stw r5, 4(r3)                            /* constant-address: 00000010 */
/* 8000D848  3C 80 80 3A */	lis r4, data_803A3410@ha                
/* 8000D84C  38 04 34 10 */	addi r0, r4, data_803A3410@l             /* constant-address: 803A3410, symbol: data_803A3410 */
/* 8000D850  90 03 00 00 */	stw r0, 0(r3)                            /* constant-address: 0000000C */
lbl_8000D854:
/* 8000D854  90 7F 00 18 */	stw r3, 0x18(r31)                       
/* 8000D858  80 1F 00 18 */	lwz r0, 0x18(r31)                       
/* 8000D85C  28 00 00 00 */	cmplwi r0, 0                            
/* 8000D860  40 82 00 24 */	bne lbl_8000D884                         /* constant-address: 8000D884, symbol: lbl_8000D884 */
/* 8000D864  38 60 00 00 */	li r3, 0                                
/* 8000D868  48 00 00 60 */	b lbl_8000D8C8                           /* constant-address: 8000D8C8, symbol: lbl_8000D8C8 */
lbl_8000D86C:
...
/* 8000D888  41 82 00 3C */	beq lbl_8000D8C4                         /* constant-address: 8000D8C4, symbol: lbl_8000D8C4 */
/* 8000D88C  2C 1C 00 00 */	cmpwi r28, 0                            
/* 8000D890  40 80 00 10 */	bge lbl_8000D8A0                         /* constant-address: 8000D8A0, symbol: lbl_8000D8A0 */
/* 8000D894  80 7F 00 14 */	lwz r3, 0x14(r31)                       
/* 8000D898  88 A3 00 04 */	lbz r5, 4(r3)                           
/* 8000D89C  48 00 00 08 */	b lbl_8000D8A4                           /* constant-address: 8000D8A4, symbol: lbl_8000D8A4 */
lbl_8000D8A0:
...
/* 8000D8BC  4B FF FA 65 */	bl initPlay__14mDoExt_baseAnmFsifss      /* constant-address: 8000D320, symbol: initPlay__14mDoExt_baseAnmFsifss */
/* 8000D8C0  48 00 00 08 */	b lbl_8000D8C8                           /* constant-address: 8000D8C8, symbol: lbl_8000D8C8 */
lbl_8000D8C4:
/* 8000D8C4  38 60 00 01 */	li r3, 1                                
lbl_8000D8C8:
/* 8000D8C8  CB E1 00 28 */	lfd f31, 0x28(r1)                       
/* 8000D8CC  39 61 00 28 */	addi r11, r1, 0x28                      
/* 8000D8D0  48 35 49 51 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

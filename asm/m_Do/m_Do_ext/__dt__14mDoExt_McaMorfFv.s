...
/* 8000FD2C  41 82 00 4C */	beq lbl_8000FD78                         /* constant-address: 8000FD78, symbol: lbl_8000FD78 */
/* 8000FD30  3C 60 80 3A */	lis r3, __vt__14mDoExt_McaMorf@ha       
/* 8000FD34  38 03 32 FC */	addi r0, r3, __vt__14mDoExt_McaMorf@l    /* constant-address: 803A32FC, symbol: __vt__14mDoExt_McaMorf */
/* 8000FD38  90 1E 00 00 */	stw r0, 0(r30)                          
/* 8000FD3C  88 1E 00 50 */	lbz r0, 0x50(r30)                       
/* 8000FD40  28 00 00 00 */	cmplwi r0, 0                            
/* 8000FD44  41 82 00 18 */	beq lbl_8000FD5C                         /* constant-address: 8000FD5C, symbol: lbl_8000FD5C */
/* 8000FD48  80 7E 00 4C */	lwz r3, 0x4c(r30)                       
/* 8000FD4C  28 03 00 00 */	cmplwi r3, 0                            
/* 8000FD50  41 82 00 0C */	beq lbl_8000FD5C                         /* constant-address: 8000FD5C, symbol: lbl_8000FD5C */
...
/* 8000FD64  4B FF FD 85 */	bl __dt__13mDoExt_morf_cFv               /* constant-address: 8000FAE8, symbol: __dt__13mDoExt_morf_cFv */
/* 8000FD68  7F E0 07 35 */	extsh. r0, r31                          
/* 8000FD6C  40 81 00 0C */	ble lbl_8000FD78                         /* constant-address: 8000FD78, symbol: lbl_8000FD78 */
/* 8000FD70  7F C3 F3 78 */	mr r3, r30                              
/* 8000FD74  48 2B EF C9 */	bl __dl__FPv                             /* constant-address: 802CED3C, symbol: __dl__FPv */
lbl_8000FD78:

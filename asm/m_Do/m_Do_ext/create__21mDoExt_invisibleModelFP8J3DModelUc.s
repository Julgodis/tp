...
/* 8000E54C  48 35 3C 89 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
...
/* 8000E56C  48 2C 07 59 */	bl __nwa__FUl                            /* constant-address: 802CECC4, symbol: __nwa__FUl */
/* 8000E570  3C 80 80 01 */	lis r4, __ct__19mDoExt_invJntPacketFv@ha
/* 8000E574  38 84 E6 54 */	addi r4, r4, __ct__19mDoExt_invJntPacketFv@l /* constant-address: 8000E654, symbol: __ct__19mDoExt_invJntPacketFv */
/* 8000E578  3C A0 80 01 */	lis r5, __dt__19mDoExt_invJntPacketFv@ha
/* 8000E57C  38 A5 E5 F8 */	addi r5, r5, __dt__19mDoExt_invJntPacketFv@l /* constant-address: 8000E5F8, symbol: __dt__19mDoExt_invJntPacketFv */
/* 8000E580  38 C0 00 18 */	li r6, 0x18                             
/* 8000E584  7F E7 FB 78 */	mr r7, r31                              
/* 8000E588  48 35 39 8D */	bl __construct_new_array                 /* constant-address: 80361F14, symbol: __construct_new_array */
/* 8000E58C  90 7B 00 04 */	stw r3, 4(r27)                          
/* 8000E590  80 1B 00 04 */	lwz r0, 4(r27)                          
/* 8000E594  28 00 00 00 */	cmplwi r0, 0                            
/* 8000E598  40 82 00 0C */	bne lbl_8000E5A4                         /* constant-address: 8000E5A4, symbol: lbl_8000E5A4 */
/* 8000E59C  38 60 00 00 */	li r3, 0                                
/* 8000E5A0  48 00 00 40 */	b lbl_8000E5E0                           /* constant-address: 8000E5E0, symbol: lbl_8000E5E0 */
lbl_8000E5A4:
/* 8000E5A4  93 9B 00 00 */	stw r28, 0(r27)                         
/* 8000E5A8  80 9B 00 04 */	lwz r4, 4(r27)                          
/* 8000E5AC  38 A0 00 00 */	li r5, 0                                
/* 8000E5B0  48 00 00 1C */	b lbl_8000E5CC                           /* constant-address: 8000E5CC, symbol: lbl_8000E5CC */
lbl_8000E5B4:
...
/* 8000E5C8  38 A5 00 01 */	addi r5, r5, 1                           /* constant-address: 00000001 */
lbl_8000E5CC:
/* 8000E5CC  54 A3 04 3E */	clrlwi r3, r5, 0x10                     
/* 8000E5D0  A0 1E 00 2C */	lhz r0, 0x2c(r30)                       
/* 8000E5D4  7C 03 00 40 */	cmplw r3, r0                            
/* 8000E5D8  41 80 FF DC */	blt lbl_8000E5B4                         /* constant-address: 8000E5B4, symbol: lbl_8000E5B4 */
/* 8000E5DC  38 60 00 01 */	li r3, 1                                
lbl_8000E5E0:
/* 8000E5E0  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8000E5E4  48 35 3C 3D */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

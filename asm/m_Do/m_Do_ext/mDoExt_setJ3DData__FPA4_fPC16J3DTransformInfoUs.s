...
/* 8000D0BC  48 35 51 21 */	bl _savegpr_29                           /* constant-address: 803621DC, symbol: _savegpr_29 */
...
/* 8000D0D0  C0 42 81 18 */	lfs f2, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
/* 8000D0D4  EC 00 10 28 */	fsubs f0, f0, f2                        
/* 8000D0D8  FC 00 02 10 */	fabs f0, f0                             
/* 8000D0DC  FC 00 00 18 */	frsp f0, f0                             
/* 8000D0E0  C0 2D 8C 00 */	lfs f1, G_CM3D_F_ABS_MIN(r13)            /* constant-address: 80451180, symbol: G_CM3D_F_ABS_MIN */
/* 8000D0E4  FC 00 08 40 */	fcmpo cr0, f0, f1                       
/* 8000D0E8  40 80 00 5C */	bge lbl_8000D144                         /* constant-address: 8000D144, symbol: lbl_8000D144 */
...
/* 8000D100  40 80 00 44 */	bge lbl_8000D144                         /* constant-address: 8000D144, symbol: lbl_8000D144 */
...
/* 8000D118  40 80 00 2C */	bge lbl_8000D144                         /* constant-address: 8000D144, symbol: lbl_8000D144 */
/* 8000D11C  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8000D120  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000D124  80 63 00 38 */	lwz r3, 0x38(r3)                         /* constant-address: 80434B00, symbol: None */
...
/* 8000D140  48 00 00 28 */	b lbl_8000D168                           /* constant-address: 8000D168, symbol: lbl_8000D168 */
lbl_8000D144:
/* 8000D144  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8000D148  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000D14C  80 63 00 38 */	lwz r3, 0x38(r3)                         /* constant-address: 80434B00, symbol: None */
...
/* 8000D184  40 82 00 7C */	bne lbl_8000D200                         /* constant-address: 8000D200, symbol: lbl_8000D200 */
...
/* 8000D204  3B A3 4A C8 */	addi r29, r3, j3dSys@l                   /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000D208  80 7D 00 38 */	lwz r3, 0x38(r29)                        /* constant-address: 80434B00, symbol: None */
...
/* 8000D224  40 82 00 90 */	bne lbl_8000D2B4                         /* constant-address: 8000D2B4, symbol: lbl_8000D2B4 */
/* 8000D228  C0 22 81 18 */	lfs f1, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
/* 8000D22C  3C 60 80 43 */	lis r3, mParentS__6J3DSys@ha            
/* 8000D230  C4 03 4C 20 */	lfsu f0, mParentS__6J3DSys@l(r3)         /* constant-address: 80434C20, symbol: mParentS__6J3DSys */
/* 8000D234  EC 41 00 24 */	fdivs f2, f1, f0                        
/* 8000D238  C0 03 00 04 */	lfs f0, 4(r3)                            /* constant-address: 80434C24, symbol: None */
/* 8000D23C  EC 61 00 24 */	fdivs f3, f1, f0                        
/* 8000D240  C0 03 00 08 */	lfs f0, 8(r3)                            /* constant-address: 80434C28, symbol: None */
...
/* 8000D2B8  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l      /* constant-address: 80434BE4, symbol: mCurrentMtx__6J3DSys */
/* 8000D2BC  7C C4 33 78 */	mr r4, r6                               
/* 8000D2C0  7C 65 1B 78 */	mr r5, r3                               
/* 8000D2C4  48 33 92 21 */	bl PSMTXConcat                           /* constant-address: 803464E4, symbol: PSMTXConcat */
/* 8000D2C8  80 9D 00 38 */	lwz r4, 0x38(r29)                        /* constant-address: 80434B00, symbol: None */
/* 8000D2CC  3C 60 80 43 */	lis r3, mCurrentMtx__6J3DSys@ha         
/* 8000D2D0  38 63 4B E4 */	addi r3, r3, mCurrentMtx__6J3DSys@l      /* constant-address: 80434BE4, symbol: mCurrentMtx__6J3DSys */
...
/* 8000D2E8  48 33 91 C9 */	bl PSMTXCopy                             /* constant-address: 803464B0, symbol: PSMTXCopy */
/* 8000D2EC  C0 1E 00 00 */	lfs f0, 0(r30)                          
/* 8000D2F0  3C 60 80 43 */	lis r3, mParentS__6J3DSys@ha            
/* 8000D2F4  D4 03 4C 20 */	stfsu f0, mParentS__6J3DSys@l(r3)        /* constant-address: 80434C20, symbol: mParentS__6J3DSys */
/* 8000D2F8  C0 1E 00 04 */	lfs f0, 4(r30)                          
/* 8000D2FC  D0 03 00 04 */	stfs f0, 4(r3)                           /* constant-address: 80434C24, symbol: None */
/* 8000D300  C0 1E 00 08 */	lfs f0, 8(r30)                          
/* 8000D304  D0 03 00 08 */	stfs f0, 8(r3)                           /* constant-address: 80434C28, symbol: None */
/* 8000D308  39 61 00 20 */	addi r11, r1, 0x20                      
/* 8000D30C  48 35 4F 1D */	bl _restgpr_29                           /* constant-address: 80362228, symbol: _restgpr_29 */

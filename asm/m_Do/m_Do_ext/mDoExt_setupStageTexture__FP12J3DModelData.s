...
/* 8000EA90  48 35 37 45 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 8000EA94  7C 7B 1B 78 */	mr r27, r3                              
/* 8000EA98  83 E3 00 6C */	lwz r31, 0x6c(r3)                       
/* 8000EA9C  28 1F 00 00 */	cmplwi r31, 0                           
/* 8000EAA0  41 82 02 08 */	beq lbl_8000ECA8                         /* constant-address: 8000ECA8, symbol: lbl_8000ECA8 */
/* 8000EAA4  83 DB 00 70 */	lwz r30, 0x70(r27)                      
/* 8000EAA8  28 1E 00 00 */	cmplwi r30, 0                           
/* 8000EAAC  41 82 01 FC */	beq lbl_8000ECA8                         /* constant-address: 8000ECA8, symbol: lbl_8000ECA8 */
/* 8000EAB0  38 80 00 00 */	li r4, 0                                
/* 8000EAB4  3B 80 00 00 */	li r28, 0                               
/* 8000EAB8  48 00 01 40 */	b lbl_8000EBF8                           /* constant-address: 8000EBF8, symbol: lbl_8000EBF8 */
lbl_8000EABC:
...
/* 8000EAD0  40 82 01 24 */	bne lbl_8000EBF4                         /* constant-address: 8000EBF4, symbol: lbl_8000EBF4 */
/* 8000EAD4  7F C3 F3 78 */	mr r3, r30                              
/* 8000EAD8  7F 84 E3 78 */	mr r4, r28                              
/* 8000EADC  48 2D 00 1D */	bl getName__10JUTNameTabCFUs             /* constant-address: 802DEAF8, symbol: getName__10JUTNameTabCFUs */
...
/* 8000EAF0  38 A5 40 FC */	addi r5, r5, m_Do_m_Do_ext__stringBase0@l /* constant-address: 803740FC, symbol: m_Do_m_Do_ext__stringBase0 */
/* 8000EAF4  38 A5 00 1C */	addi r5, r5, 0x1c                        /* constant-address: 80374118, symbol: None */
/* 8000EAF8  4C C6 31 82 */	crclr 6                                 
/* 8000EAFC  48 35 7A C1 */	bl snprintf                              /* constant-address: 803665BC, symbol: snprintf */
/* 8000EB00  38 61 00 08 */	addi r3, r1, 8                          
/* 8000EB04  48 02 09 31 */	bl dComIfG_getStageRes__FPCc             /* constant-address: 8002F434, symbol: dComIfG_getStageRes__FPCc */
...
lbl_8000EBF4:
/* 8000EBF4  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000001 */
lbl_8000EBF8:
/* 8000EBF8  57 83 04 3E */	clrlwi r3, r28, 0x10                    
/* 8000EBFC  A0 1F 00 00 */	lhz r0, 0(r31)                          
/* 8000EC00  7C 03 00 40 */	cmplw r3, r0                            
/* 8000EC04  41 80 FE B8 */	blt lbl_8000EABC                         /* constant-address: 8000EABC, symbol: lbl_8000EABC */
/* 8000EC08  54 80 06 3F */	clrlwi. r0, r4, 0x18                    
/* 8000EC0C  41 82 00 9C */	beq lbl_8000ECA8                         /* constant-address: 8000ECA8, symbol: lbl_8000ECA8 */
/* 8000EC10  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8000EC14  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000EC18  93 E3 00 58 */	stw r31, 0x58(r3)                        /* constant-address: 80434B20, symbol: None */
/* 8000EC1C  3B C0 00 00 */	li r30, 0                               
/* 8000EC20  48 00 00 78 */	b lbl_8000EC98                           /* constant-address: 8000EC98, symbol: lbl_8000EC98 */
lbl_8000EC24:
...
/* 8000EC38  41 82 00 5C */	beq lbl_8000EC94                         /* constant-address: 8000EC94, symbol: lbl_8000EC94 */
/* 8000EC3C  83 A3 00 48 */	lwz r29, 0x48(r3)                       
/* 8000EC40  28 1D 00 00 */	cmplwi r29, 0                           
/* 8000EC44  41 82 00 50 */	beq lbl_8000EC94                         /* constant-address: 8000EC94, symbol: lbl_8000EC94 */
/* 8000EC48  48 32 EA AD */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
/* 8000EC4C  7C 7F 1B 78 */	mr r31, r3                              
/* 8000EC50  3C 60 80 43 */	lis r3, sGDLObj__17J3DDisplayListObj@ha 
/* 8000EC54  38 63 4C 70 */	addi r3, r3, sGDLObj__17J3DDisplayListObj@l /* constant-address: 80434C70, symbol: sGDLObj__17J3DDisplayListObj */
/* 8000EC58  80 9D 00 00 */	lwz r4, 0(r29)                          
/* 8000EC5C  80 BD 00 08 */	lwz r5, 8(r29)                          
/* 8000EC60  48 35 23 39 */	bl GDInitGDLObj                          /* constant-address: 80360F98, symbol: GDInitGDLObj */
/* 8000EC64  3C 60 80 43 */	lis r3, sGDLObj__17J3DDisplayListObj@ha 
/* 8000EC68  38 03 4C 70 */	addi r0, r3, sGDLObj__17J3DDisplayListObj@l /* constant-address: 80434C70, symbol: sGDLObj__17J3DDisplayListObj */
/* 8000EC6C  90 0D 94 00 */	stw r0, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8000EC88  48 32 EA 95 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8000EC8C  38 00 00 00 */	li r0, 0                                
/* 8000EC90  90 0D 94 00 */	stw r0, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
lbl_8000EC94:
/* 8000EC94  3B DE 00 01 */	addi r30, r30, 1                         /* constant-address: 00000001 */
lbl_8000EC98:
/* 8000EC98  57 C3 04 3E */	clrlwi r3, r30, 0x10                    
/* 8000EC9C  A0 1B 00 5C */	lhz r0, 0x5c(r27)                       
/* 8000ECA0  7C 03 00 40 */	cmplw r3, r0                            
/* 8000ECA4  41 80 FF 80 */	blt lbl_8000EC24                         /* constant-address: 8000EC24, symbol: lbl_8000EC24 */
lbl_8000ECA8:
/* 8000ECA8  39 61 00 60 */	addi r11, r1, 0x60                      
/* 8000ECAC  48 35 35 75 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

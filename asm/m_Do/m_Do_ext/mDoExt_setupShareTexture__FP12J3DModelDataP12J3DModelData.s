...
/* 8000E844  48 35 39 7D */	bl _savegpr_22                           /* constant-address: 803621C0, symbol: _savegpr_22 */
...
/* 8000E864  48 00 01 68 */	b lbl_8000E9CC                           /* constant-address: 8000E9CC, symbol: lbl_8000E9CC */
lbl_8000E868:
...
/* 8000E87C  40 82 01 4C */	bne lbl_8000E9C8                         /* constant-address: 8000E9C8, symbol: lbl_8000E9C8 */
/* 8000E880  3B 20 00 00 */	li r25, 0                               
/* 8000E884  48 00 01 34 */	b lbl_8000E9B8                           /* constant-address: 8000E9B8, symbol: lbl_8000E9B8 */
lbl_8000E888:
/* 8000E888  7F 83 E3 78 */	mr r3, r28                              
/* 8000E88C  7F 24 CB 78 */	mr r4, r25                              
/* 8000E890  48 2D 02 69 */	bl getName__10JUTNameTabCFUs             /* constant-address: 802DEAF8, symbol: getName__10JUTNameTabCFUs */
/* 8000E894  7C 77 1B 78 */	mr r23, r3                              
/* 8000E898  7F C3 F3 78 */	mr r3, r30                              
/* 8000E89C  7F 44 D3 78 */	mr r4, r26                              
/* 8000E8A0  48 2D 02 59 */	bl getName__10JUTNameTabCFUs             /* constant-address: 802DEAF8, symbol: getName__10JUTNameTabCFUs */
/* 8000E8A4  7E E4 BB 78 */	mr r4, r23                              
/* 8000E8A8  48 35 A0 ED */	bl strcmp                                /* constant-address: 80368994, symbol: strcmp */
/* 8000E8AC  2C 03 00 00 */	cmpwi r3, 0                             
/* 8000E8B0  40 82 01 04 */	bne lbl_8000E9B4                         /* constant-address: 8000E9B4, symbol: lbl_8000E9B4 */
...
lbl_8000E9B4:
/* 8000E9B4  3B 39 00 01 */	addi r25, r25, 1                         /* constant-address: 00000001 */
lbl_8000E9B8:
/* 8000E9B8  57 23 04 3E */	clrlwi r3, r25, 0x10                    
/* 8000E9BC  A0 1D 00 00 */	lhz r0, 0(r29)                          
/* 8000E9C0  7C 03 00 40 */	cmplw r3, r0                            
/* 8000E9C4  41 80 FE C4 */	blt lbl_8000E888                         /* constant-address: 8000E888, symbol: lbl_8000E888 */
lbl_8000E9C8:
/* 8000E9C8  3B 5A 00 01 */	addi r26, r26, 1                         /* constant-address: 00000001 */
lbl_8000E9CC:
/* 8000E9CC  57 43 04 3E */	clrlwi r3, r26, 0x10                    
/* 8000E9D0  A0 1F 00 00 */	lhz r0, 0(r31)                          
/* 8000E9D4  7C 03 00 40 */	cmplw r3, r0                            
/* 8000E9D8  41 80 FE 90 */	blt lbl_8000E868                         /* constant-address: 8000E868, symbol: lbl_8000E868 */
/* 8000E9DC  56 C0 06 3F */	clrlwi. r0, r22, 0x18                   
/* 8000E9E0  41 82 00 88 */	beq lbl_8000EA68                         /* constant-address: 8000EA68, symbol: lbl_8000EA68 */
/* 8000E9E4  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8000E9E8  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000E9EC  93 E3 00 58 */	stw r31, 0x58(r3)                        /* constant-address: 80434B20, symbol: None */
/* 8000E9F0  3A C0 00 00 */	li r22, 0                               
/* 8000E9F4  3C 60 80 43 */	lis r3, sGDLObj__17J3DDisplayListObj@ha 
/* 8000E9F8  3B 23 4C 70 */	addi r25, r3, sGDLObj__17J3DDisplayListObj@l /* constant-address: 80434C70, symbol: sGDLObj__17J3DDisplayListObj */
/* 8000E9FC  48 00 00 5C */	b lbl_8000EA58                           /* constant-address: 8000EA58, symbol: lbl_8000EA58 */
lbl_8000EA00:
...
/* 8000EA14  48 32 EC E1 */	bl OSDisableInterrupts                   /* constant-address: 8033D6F4, symbol: OSDisableInterrupts */
...
/* 8000EA28  48 35 25 71 */	bl GDInitGDLObj                          /* constant-address: 80360F98, symbol: GDInitGDLObj */
/* 8000EA2C  93 2D 94 00 */	stw r25, __GDCurrentDL(r13)              /* constant-address: 80451980, symbol: __GDCurrentDL */
...
/* 8000EA48  48 32 EC D5 */	bl OSRestoreInterrupts                   /* constant-address: 8033D71C, symbol: OSRestoreInterrupts */
/* 8000EA4C  38 00 00 00 */	li r0, 0                                
/* 8000EA50  90 0D 94 00 */	stw r0, __GDCurrentDL(r13)               /* constant-address: 80451980, symbol: __GDCurrentDL */
/* 8000EA54  3A D6 00 01 */	addi r22, r22, 1                         /* constant-address: 00000001 */
lbl_8000EA58:
/* 8000EA58  56 C3 04 3E */	clrlwi r3, r22, 0x10                    
/* 8000EA5C  A0 18 00 5C */	lhz r0, 0x5c(r24)                       
/* 8000EA60  7C 03 00 40 */	cmplw r3, r0                            
/* 8000EA64  41 80 FF 9C */	blt lbl_8000EA00                         /* constant-address: 8000EA00, symbol: lbl_8000EA00 */
lbl_8000EA68:
/* 8000EA68  39 61 00 30 */	addi r11, r1, 0x30                      
/* 8000EA6C  48 35 37 A1 */	bl _restgpr_22                           /* constant-address: 8036220C, symbol: _restgpr_22 */

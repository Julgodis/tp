...
/* 8000F28C  48 35 2F 49 */	bl _savegpr_27                           /* constant-address: 803621D4, symbol: _savegpr_27 */
/* 8000F290  7C 7B 1B 78 */	mr r27, r3                              
/* 8000F294  80 6D 90 74 */	lwz r3, mJoint__10J3DMtxCalc(r13)        /* constant-address: 804515F4, symbol: mJoint__10J3DMtxCalc */
/* 8000F298  A3 C3 00 14 */	lhz r30, 0x14(r3)                       
/* 8000F29C  7F DD F3 78 */	mr r29, r30                             
/* 8000F2A0  3C 60 80 43 */	lis r3, j3dSys@ha                       
/* 8000F2A4  38 63 4A C8 */	addi r3, r3, j3dSys@l                    /* constant-address: 80434AC8, symbol: j3dSys */
/* 8000F2A8  93 63 00 30 */	stw r27, 0x30(r3)                        /* constant-address: 80434AF8, symbol: None */
/* 8000F2AC  80 1B 00 04 */	lwz r0, 4(r27)                          
/* 8000F2B0  2C 00 00 01 */	cmpwi r0, 1                             
/* 8000F2B4  40 82 00 30 */	bne lbl_8000F2E4                         /* constant-address: 8000F2E4, symbol: lbl_8000F2E4 */
...
/* 8000F2DC  48 31 FC E1 */	bl calcTransform__27J3DMtxCalcCalcTransformMayaFRC16J3DTransformInfo /* constant-address: 8032EFBC, symbol: calcTransform__27J3DMtxCalcCalcTransformMayaFRC16J3DTransformInfo */
/* 8000F2E0  48 00 01 A8 */	b lbl_8000F488                           /* constant-address: 8000F488, symbol: lbl_8000F488 */
lbl_8000F2E4:
...
/* 8000F314  48 32 A5 65 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
...
/* 8000F340  48 00 01 20 */	b lbl_8000F460                           /* constant-address: 8000F460, symbol: lbl_8000F460 */
lbl_8000F344:
/* 8000F344  80 7B 00 08 */	lwz r3, 8(r27)                          
/* 8000F348  38 1F 00 04 */	addi r0, r31, 4                          /* constant-address: 0000000C */
/* 8000F34C  7C 63 00 2E */	lwzx r3, r3, r0                         
/* 8000F350  28 03 00 00 */	cmplwi r3, 0                            
/* 8000F354  41 82 01 04 */	beq lbl_8000F458                         /* constant-address: 8000F458, symbol: lbl_8000F458 */
...
/* 8000F378  C0 02 81 18 */	lfs f0, lit_3847(r2)                     /* constant-address: 80451B18, symbol: lit_3847 */
...
/* 8000F390  48 32 A4 E9 */	bl JMAEulerToQuat__FsssP10Quaternion     /* constant-address: 80339878, symbol: JMAEulerToQuat__FsssP10Quaternion */
...
/* 8000F3A4  48 32 A5 95 */	bl JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion /* constant-address: 80339938, symbol: JMAQuatLerp__FPC10QuaternionPC10QuaternionfP10Quaternion */
...
lbl_8000F458:
/* 8000F458  3B 9C 00 01 */	addi r28, r28, 1                         /* constant-address: 00000002 */
/* 8000F45C  3B FF 00 08 */	addi r31, r31, 8                         /* constant-address: 00000010 */
lbl_8000F460:
/* 8000F460  80 1B 00 04 */	lwz r0, 4(r27)                          
/* 8000F464  7C 1C 00 00 */	cmpw r28, r0                            
/* 8000F468  41 80 FE DC */	blt lbl_8000F344                         /* constant-address: 8000F344, symbol: lbl_8000F344 */
/* 8000F46C  38 61 00 98 */	addi r3, r1, 0x98                       
/* 8000F470  38 81 00 08 */	addi r4, r1, 8                          
/* 8000F474  48 33 75 75 */	bl PSMTXQuat                             /* constant-address: 803469E8, symbol: PSMTXQuat */
/* 8000F478  38 61 00 98 */	addi r3, r1, 0x98                       
/* 8000F47C  38 81 00 58 */	addi r4, r1, 0x58                       
/* 8000F480  7F C5 F3 78 */	mr r5, r30                              
/* 8000F484  4B FF DC 29 */	bl mDoExt_setJ3DData__FPA4_fPC16J3DTransformInfoUs /* constant-address: 8000D0AC, symbol: mDoExt_setJ3DData__FPA4_fPC16J3DTransformInfoUs */
lbl_8000F488:
...
/* 8000F49C  48 35 2D 85 */	bl _restgpr_27                           /* constant-address: 80362220, symbol: _restgpr_27 */

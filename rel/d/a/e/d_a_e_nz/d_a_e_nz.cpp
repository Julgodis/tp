...
static void anm_init(e_nz_class*, int, f32, u8, f32); // 2
static void pl_check(e_nz_class*, f32); // 2
static void daE_NZ_Draw(e_nz_class*); // 2
static void e_nz_normal(e_nz_class*); // 2
static void e_nz_attack(e_nz_class*); // 2
static void e_nz_stick(e_nz_class*); // 2
static void damage_check(e_nz_class*); // 2
static void e_nz_damage(e_nz_class*); // 2
...
extern "C" void __ct__12daE_NZ_HIO_cFv(); // 1
extern "C" static void anm_init__FP10e_nz_classifUcf(); // 1
extern "C" static void pl_check__FP10e_nz_classf(); // 1
extern "C" static void daE_NZ_Draw__FP10e_nz_class(); // 1
extern "C" static void e_nz_normal__FP10e_nz_class(); // 1
extern "C" static void e_nz_attack__FP10e_nz_class(); // 1
extern "C" static void e_nz_stick__FP10e_nz_class(); // 1
extern "C" static void damage_check__FP10e_nz_class(); // 1
extern "C" static void e_nz_damage__FP10e_nz_class(); // 1
...
extern "C" void __dt__12daE_NZ_HIO_cFv(); // 1
extern "C" void __sinit_d_a_e_nz_cpp(); // 1
extern "C" static void func_8072BD0C(); // 1
extern "C" static void func_8072BD14(); // 1
...
/* ############################################################################################## */
/* 8072C180-8072C184 0004+00 r=8 e=0 z=0  None .rodata    @3789                                                        */
SECTION_RODATA static u32 const lit_3789 = 0x42C80000;

/* 8072C24C-8072C258 000C+00 r=1 e=0 z=0  None .data      cNullVec__6Z2Calc                                            */
SECTION_DATA static u8 cNullVec__6Z2Calc[12] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8072C258-8072C26C 0004+10 r=0 e=0 z=0  None .data      @1787                                                        */
...
/* 8072C26C-8072C274 0008+00 r=0 e=0 z=0  None .data      e_prim$3668                                                  */
SECTION_DATA u8 data_8072C26C[8] = {
	0xFF, 0x78, 0x00, 0x00, 0xFF, 0x64, 0x78, 0x00,
};

/* 8072C274-8072C27C 0008+00 r=0 e=0 z=0  None .data      e_env$3669                                                   */
SECTION_DATA u8 data_8072C274[8] = {
	0x5A, 0x2D, 0x2D, 0x00, 0x3C, 0x1E, 0x1E, 0x00,
};

/* 8072C27C-8072C284 0006+02 r=0 e=0 z=0  None .data      eff_id$3677                                                  */
...
/* 8072C284-8072C28C 0008+00 r=5 e=0 z=0  None .data      stick_bit                                                    */
SECTION_DATA static u8 stick_bit[8] = {
	0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80,
};

/* 8072C28C-8072C2DC 0050+00 r=1 e=0 z=0  None .data      stick_d                                                      */
...
/* 8072C2DC-8072C2E4 0008+00 r=1 e=0 z=0  None .data      eff_id$4227                                                  */
SECTION_DATA static u8 data_8072C2DC[8] = {
	0x01, 0xB8, 0x01, 0xB9, 0x01, 0xBA, 0x01, 0xBB,
};

/* 8072C2E4-8072C324 0040+00 r=1 e=0 z=0  None .data      cc_sph_src$4510                                              */
...
/* 8072C324-8072C344 0020+00 r=1 e=0 z=0  None .data      l_daE_NZ_Method                                              */
SECTION_DATA static void* l_daE_NZ_Method[8] = {
	/* 0    */ (void*)daE_NZ_Create__FP10fopAc_ac_c,
	/* 1    */ (void*)daE_NZ_Delete__FP10e_nz_class,
	/* 2    */ (void*)daE_NZ_Execute__FP10e_nz_class,
	/* 3    */ (void*)daE_NZ_IsDelete__FP10e_nz_class,
	/* 4    */ (void*)daE_NZ_Draw__FP10e_nz_class,
	/* 5    */ (void*)NULL,
	/* 6    */ (void*)NULL,
	/* 7    */ (void*)NULL,
};

/* 8072C344-8072C374 0030+00 r=1 e=0 z=1  None .data      g_profile_E_NZ                                               */
SECTION_DATA void* g_profile_E_NZ[12] = {
	...
	/* 8    */ (void*)0x00B30000,
	/* 9    */ (void*)&l_daE_NZ_Method,
	/* 10   */ (void*)0x10044120,
	/* 11   */ (void*)0x02000000,
};

/* 8072C374-8072C380 000C+00 r=1 e=0 z=0  None .data      __vt__12dBgS_AcchCir                                         */
...
/* 8072C380-8072C38C 000C+00 r=2 e=0 z=0  None .data      __vt__10cCcD_GStts                                           */
...
/* 8072C38C-8072C398 000C+00 r=1 e=0 z=0  None .data      __vt__10dCcD_GStts                                           */
...
/* 8072C398-8072C3A4 000C+00 r=2 e=0 z=0  None .data      __vt__8cM3dGSph                                              */
...
/* 8072C3A4-8072C3B0 000C+00 r=2 e=0 z=0  None .data      __vt__8cM3dGAab                                              */
...
/* 8072C3B0-8072C3D4 0024+00 r=2 e=0 z=0  None .data      __vt__12dBgS_ObjAcch                                         */
SECTION_DATA static void* __vt__12dBgS_ObjAcch[9] = {
	...
	/* 3    */ (void*)NULL,
	/* 4    */ (void*)NULL,
	/* 5    */ (void*)func_8072BD14,
	/* 6    */ (void*)NULL,
	/* 7    */ (void*)NULL,
	/* 8    */ (void*)func_8072BD0C,
};

/* 8072C3D4-8072C3E0 000C+00 r=2 e=0 z=0  None .data      __vt__12daE_NZ_HIO_c                                         */
SECTION_DATA static void* __vt__12daE_NZ_HIO_c[3] = {
	/* 0    */ (void*)NULL /* RTTI */,
	/* 1    */ (void*)NULL,
	/* 2    */ (void*)__dt__12daE_NZ_HIO_cFv,
};

/* 807299EC-80729A3C 0050+00 r=1 e=0 z=0  None .text      __ct__12daE_NZ_HIO_cFv                                       */
#pragma push
...
/* ############################################################################################## */
/* 8072C184-8072C188 0004+00 r=2 e=0 z=0  None .rodata    @3790                                                        */
SECTION_RODATA static u8 const lit_3790[4] = {
	0x00, 0x00, 0x00, 0x00,
};

/* 8072C188-8072C190 0004+04 r=2 e=0 z=0  None .rodata    @3791                                                        */
...
/* 8072C190-8072C198 0008+00 r=0 e=0 z=0  None .rodata    @3792                                                        */
SECTION_RODATA u8 const lit_3792[8] = {
	0x3F, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8072C198-8072C1A0 0008+00 r=0 e=0 z=0  None .rodata    @3793                                                        */
SECTION_RODATA u8 const lit_3793[8] = {
	0x40, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8072C1A0-8072C1A8 0008+00 r=0 e=0 z=0  None .rodata    @3794                                                        */
SECTION_RODATA u8 const lit_3794[8] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8072C1A8-8072C1AC 0004+00 r=0 e=0 z=0  None .rodata    @3795                                                        */
SECTION_RODATA u32 const lit_3795 = 0x3C23D70A;

/* 8072C1AC-8072C1B0 0004+00 r=0 e=0 z=0  None .rodata    @3810                                                        */
SECTION_RODATA u32 const lit_3810 = 0x3F99999A;

/* 8072C1B0-8072C1B4 0004+00 r=0 e=0 z=0  None .rodata    @3811                                                        */
SECTION_RODATA u32 const lit_3811 = 0x41C80000;

/* 8072C1B4-8072C1B8 0004+00 r=0 e=0 z=0  None .rodata    @3812                                                        */
SECTION_RODATA u32 const lit_3812 = 0x42340000;

/* 8072C1B8-8072C1BC 0004+00 r=0 e=0 z=0  None .rodata    @3813                                                        */
SECTION_RODATA u32 const lit_3813 = 0x42700000;

/* 8072C1BC-8072C1C0 0004+00 r=1 e=0 z=0  None .rodata    @3814                                                        */
SECTION_RODATA static u32 const lit_3814 = 0x41F00000;

/* 8072C1C0-8072C1C4 0004+00 r=1 e=0 z=0  None .rodata    @3828                                                        */
SECTION_RODATA static u32 const lit_3828 = 0xBF800000;

/* 8072C1C4-8072C1C8 0004+00 r=0 e=0 z=0  None .rodata    @3935                                                        */
SECTION_RODATA u32 const lit_3935 = 0x3F000000;

/* 8072C1C8-8072C1CC 0004+00 r=0 e=0 z=0  None .rodata    @3936                                                        */
SECTION_RODATA u32 const lit_3936 = 0x40400000;

/* 8072C1CC-8072C1D0 0004+00 r=1 e=0 z=0  None .rodata    @3937                                                        */
SECTION_RODATA static u32 const lit_3937 = 0x477FFF00;

/* 8072C1D0-8072C1D4 0004+00 r=0 e=0 z=0  None .rodata    @3938                                                        */
SECTION_RODATA u32 const lit_3938 = 0x40E00000;

/* 8072C1D4-8072C1D8 0004+00 r=0 e=0 z=0  None .rodata    @3939                                                        */
SECTION_RODATA u32 const lit_3939 = 0x453B8000;

/* 8072C1D8-8072C1DC 0004+00 r=0 e=0 z=0  None .rodata    @3940                                                        */
SECTION_RODATA u32 const lit_3940 = 0x41A00000;

/* 8072C1DC-8072C1E0 0004+00 r=0 e=0 z=0  None .rodata    @3941                                                        */
SECTION_RODATA u32 const lit_3941 = 0x41100000;

/* 8072C1E0-8072C1E4 0004+00 r=0 e=0 z=0  None .rodata    @3942                                                        */
SECTION_RODATA u32 const lit_3942 = 0x41200000;

/* 8072C1E4-8072C1E8 0004+00 r=0 e=0 z=0  None .rodata    @3943                                                        */
SECTION_RODATA u32 const lit_3943 = 0x43480000;

/* 8072C1E8-8072C1EC 0004+00 r=0 e=0 z=0  None .rodata    @3944                                                        */
SECTION_RODATA u32 const lit_3944 = 0x42480000;

/* 8072C1EC-8072C1F0 0004+00 r=0 e=0 z=0  None .rodata    @3945                                                        */
SECTION_RODATA u32 const lit_3945 = 0x43FA0000;

/* 8072C1F0-8072C1F4 0004+00 r=0 e=0 z=0  None .rodata    @3946                                                        */
SECTION_RODATA u32 const lit_3946 = 0x442F0000;

/* 8072C1F4-8072C1F8 0004+00 r=0 e=0 z=0  None .rodata    @3947                                                        */
SECTION_RODATA u32 const lit_3947 = 0x43C80000;

/* 8072C1F8-8072C1FC 0004+00 r=0 e=0 z=0  None .rodata    @3948                                                        */
SECTION_RODATA u32 const lit_3948 = 0x3E800000;

/* 8072C1FC-8072C200 0004+00 r=0 e=0 z=0  None .rodata    @4088                                                        */
SECTION_RODATA u32 const lit_4088 = 0x40A00000;

/* 8072C200-8072C204 0004+00 r=0 e=0 z=0  None .rodata    @4089                                                        */
SECTION_RODATA u32 const lit_4089 = 0x40000000;

/* 8072C204-8072C208 0004+00 r=0 e=0 z=0  None .rodata    @4180                                                        */
SECTION_RODATA u32 const lit_4180 = 0x42200000;

/* 8072C208-8072C20C 0004+00 r=0 e=0 z=0  None .rodata    @4181                                                        */
SECTION_RODATA u32 const lit_4181 = 0xC1F00000;

/* 8072C20C-8072C210 0004+00 r=0 e=0 z=0  None .rodata    @4182                                                        */
SECTION_RODATA u32 const lit_4182 = 0x41700000;

/* 8072C210-8072C214 0004+00 r=0 e=0 z=0  None .rodata    @4318                                                        */
SECTION_RODATA u32 const lit_4318 = 0xC1000000;

/* 8072C214-8072C218 0004+00 r=0 e=0 z=0  None .rodata    @4319                                                        */
SECTION_RODATA u32 const lit_4319 = 0xC2F00000;

/* 8072C218-8072C21C 0004+00 r=0 e=0 z=0  None .rodata    @4320                                                        */
SECTION_RODATA u32 const lit_4320 = 0x459C4000;

/* 8072C21C-8072C220 0004+00 r=0 e=0 z=0  None .rodata    @4321                                                        */
SECTION_RODATA u32 const lit_4321 = 0x3EB33333;

/* 8072C220-8072C224 0004+00 r=0 e=0 z=0  None .rodata    @4444                                                        */
SECTION_RODATA u32 const lit_4444 = 0x437F0000;

/* 8072C224-8072C228 0004+00 r=0 e=0 z=0  None .rodata    @4445                                                        */
SECTION_RODATA u32 const lit_4445 = 0x41000000;

/* 8072C228-8072C22C 0004+00 r=0 e=0 z=0  None .rodata    @4446                                                        */
SECTION_RODATA u32 const lit_4446 = 0x461C4000;

/* 8072C22C-8072C230 0004+00 r=0 e=0 z=0  None .rodata    @4447                                                        */
SECTION_RODATA u32 const lit_4447 = 0x43960000;

/* 8072C230-8072C238 0004+04 r=0 e=0 z=0  None .rodata    @4448                                                        */
...
/* 8072C238-8072C240 0008+00 r=0 e=0 z=0  None .rodata    @4450                                                        */
SECTION_RODATA u8 const lit_4450[8] = {
	0x43, 0x30, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00,
};

/* 8072C240-8072C24A 000A+00 r=4 e=0 z=0  None .rodata    @stringBase0                                                 */
#pragma push
...
/* 80729A3C-80729AE8 00AC+00 r=4 e=0 z=0  None .text      anm_init__FP10e_nz_classifUcf                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80729AE8-80729B24 003C+00 r=1 e=0 z=0  None .text      pl_check__FP10e_nz_classf                                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80729B24-80729C24 0100+00 r=1 e=0 z=0  None .text      daE_NZ_Draw__FP10e_nz_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 8072C3E8-8072C3EC 0001+03 r=1 e=0 z=0  None .bss       @1109                                                        */
static u8 lit_1109[1 + 3 /* padding */];

/* 8072C3EC-8072C3F0 0001+03 r=0 e=0 z=0  None .bss       @1107                                                        */
u8 lit_1107[1 + 3 /* padding */];

/* 8072C3F0-8072C3F4 0001+03 r=0 e=0 z=0  None .bss       @1105                                                        */
u8 lit_1105[1 + 3 /* padding */];

/* 8072C3F4-8072C3F8 0001+03 r=0 e=0 z=0  None .bss       @1104                                                        */
u8 lit_1104[1 + 3 /* padding */];

/* 8072C3F8-8072C3FC 0001+03 r=0 e=0 z=0  None .bss       @1099                                                        */
u8 lit_1099[1 + 3 /* padding */];

/* 8072C3FC-8072C400 0001+03 r=0 e=0 z=0  None .bss       @1097                                                        */
u8 lit_1097[1 + 3 /* padding */];

/* 8072C400-8072C404 0001+03 r=0 e=0 z=0  None .bss       @1095                                                        */
u8 lit_1095[1 + 3 /* padding */];

/* 8072C404-8072C408 0001+03 r=0 e=0 z=0  None .bss       @1094                                                        */
u8 lit_1094[1 + 3 /* padding */];

/* 8072C408-8072C40C 0001+03 r=0 e=0 z=0  None .bss       @1057                                                        */
u8 lit_1057[1 + 3 /* padding */];

/* 8072C40C-8072C410 0001+03 r=0 e=0 z=0  None .bss       @1055                                                        */
u8 lit_1055[1 + 3 /* padding */];

/* 8072C410-8072C414 0001+03 r=0 e=0 z=0  None .bss       @1053                                                        */
u8 lit_1053[1 + 3 /* padding */];

/* 8072C414-8072C418 0001+03 r=0 e=0 z=0  None .bss       @1052                                                        */
u8 lit_1052[1 + 3 /* padding */];

/* 8072C418-8072C41C 0001+03 r=0 e=0 z=0  None .bss       @1014                                                        */
u8 lit_1014[1 + 3 /* padding */];

/* 8072C41C-8072C420 0001+03 r=0 e=0 z=0  None .bss       @1012                                                        */
u8 lit_1012[1 + 3 /* padding */];

/* 8072C420-8072C424 0001+03 r=0 e=0 z=0  None .bss       @1010                                                        */
u8 lit_1010[1 + 3 /* padding */];

/* 8072C424-8072C428 0004+00 r=2 e=0 z=0  None .bss       None                                                         */
static u8 struct_8072C424[4];

/* 8072C428-8072C434 000C+00 r=1 e=0 z=0  None .bss       @3805                                                        */
static u8 lit_3805[12];

/* 8072C434-8072C454 0020+00 r=5 e=0 z=0  None .bss       l_HIO                                                        */
static u8 l_HIO[32];

/* 8072C454-8072C458 0004+00 r=5 e=0 z=0  None .bss       None                                                         */
static u8 data_8072C454[4];

/* 80729C24-8072A044 0420+00 r=1 e=0 z=0  None .text      e_nz_normal__FP10e_nz_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072A044-8072A680 063C+00 r=1 e=0 z=0  None .text      e_nz_attack__FP10e_nz_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072A680-8072A7C4 0144+00 r=1 e=0 z=0  None .text      e_nz_stick__FP10e_nz_class                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072A7C4-8072A8CC 0108+00 r=1 e=0 z=0  None .text      damage_check__FP10e_nz_class                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072A8CC-8072AA90 01C4+00 r=1 e=0 z=0  None .text      e_nz_damage__FP10e_nz_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072AA90-8072AB68 00D8+00 r=1 e=0 z=0  None .text      getPolyColor__FR13cBgS_PolyInfoiP8_GXColorP8_GXColorPUcPf    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072AB68-8072B09C 0534+00 r=1 e=0 z=0  None .text      action__FP10e_nz_class                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072B09C-8072B5D4 0538+00 r=2 e=0 z=0  None .text      daE_NZ_Execute__FP10e_nz_class                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072B5D4-8072B5DC 0008+00 r=1 e=0 z=0  None .text      daE_NZ_IsDelete__FP10e_nz_class                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072B5DC-8072B680 00A4+00 r=1 e=0 z=0  None .text      daE_NZ_Delete__FP10e_nz_class                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072B680-8072B7C4 0144+00 r=1 e=0 z=0  None .text      useHeapInit__FP10fopAc_ac_c                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072B7C4-8072BA74 02B0+00 r=1 e=0 z=0  None .text      daE_NZ_Create__FP10fopAc_ac_c                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BA74-8072BABC 0048+00 r=1 e=0 z=0  None .text      __dt__8cM3dGSphFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BABC-8072BB04 0048+00 r=1 e=0 z=0  None .text      __dt__8cM3dGAabFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BB04-8072BB60 005C+00 r=1 e=0 z=0  None .text      __dt__10dCcD_GSttsFv                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BB60-8072BBD0 0070+00 r=3 e=0 z=0  None .text      __dt__12dBgS_ObjAcchFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BBD0-8072BC40 0070+00 r=1 e=0 z=0  None .text      __dt__12dBgS_AcchCirFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BC40-8072BC88 0048+00 r=1 e=0 z=0  None .text      __dt__10cCcD_GSttsFv                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BC88-8072BCD0 0048+00 r=2 e=0 z=0  None .text      __dt__12daE_NZ_HIO_cFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm daE_NZ_HIO_c::~daE_NZ_HIO_c() {
...
/* 8072BCD0-8072BD0C 003C+00 r=1 e=1 z=0  None .text      __sinit_d_a_e_nz_cpp                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BD0C-8072BD14 0008+00 r=1 e=0 z=0  None .text      @36@__dt__12dBgS_ObjAcchFv                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BD14-8072BD1C 0008+00 r=1 e=0 z=0  None .text      @20@__dt__12dBgS_ObjAcchFv                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072BD1C-8072C130 0414+00 r=1 e=0 z=0  None .text      setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8072C130-8072C16C 003C+00 r=1 e=0 z=0  None .text      __dt__4cXyzFv                                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm cXyz::~cXyz() {
...
/* ############################################################################################## */
/* 8072C458-8072C468 000C+04 r=0 e=0 z=0  None .bss       @4220                                                        */
u8 lit_4220[12 + 4 /* padding */];

/* 8072C468-8072C474 000C+00 r=0 e=0 z=0  None .bss       sc$4219                                                      */
u8 data_8072C468[12];

/* 8072C474-8072C478 0004+00 r=0 e=0 z=0  None .bss       sInstance__40JASGlobalInstance<19JASDefaultBankTable>        */
u8 data_8072C474[4];

/* 8072C478-8072C47C 0004+00 r=0 e=0 z=0  None .bss       sInstance__35JASGlobalInstance<14JASAudioThread>             */
u8 data_8072C478[4];

/* 8072C47C-8072C480 0004+00 r=0 e=0 z=0  None .bss       sInstance__27JASGlobalInstance<7Z2SeMgr>                     */
u8 data_8072C47C[4];

/* 8072C480-8072C484 0004+00 r=0 e=0 z=0  None .bss       sInstance__28JASGlobalInstance<8Z2SeqMgr>                    */
u8 data_8072C480[4];

/* 8072C484-8072C488 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2SceneMgr>                 */
u8 data_8072C484[4];

/* 8072C488-8072C48C 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2StatusMgr>                */
u8 data_8072C488[4];

/* 8072C48C-8072C490 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2DebugSys>                 */
u8 data_8072C48C[4];

/* 8072C490-8072C494 0004+00 r=0 e=0 z=0  None .bss       sInstance__36JASGlobalInstance<15JAISoundStarter>            */
u8 data_8072C490[4];

/* 8072C494-8072C498 0004+00 r=0 e=0 z=0  None .bss       sInstance__35JASGlobalInstance<14Z2SoundStarter>             */
u8 data_8072C494[4];

/* 8072C498-8072C49C 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12Z2SpeechMgr2>               */
u8 data_8072C498[4];

/* 8072C49C-8072C4A0 0004+00 r=0 e=0 z=0  None .bss       sInstance__28JASGlobalInstance<8JAISeMgr>                    */
u8 data_8072C49C[4];

/* 8072C4A0-8072C4A4 0004+00 r=0 e=0 z=0  None .bss       sInstance__29JASGlobalInstance<9JAISeqMgr>                   */
u8 data_8072C4A0[4];

/* 8072C4A4-8072C4A8 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAIStreamMgr>               */
u8 data_8072C4A4[4];

/* 8072C4A8-8072C4AC 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2SoundMgr>                 */
u8 data_8072C4A8[4];

/* 8072C4AC-8072C4B0 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAISoundInfo>               */
u8 data_8072C4AC[4];

/* 8072C4B0-8072C4B4 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13JAUSoundTable>              */
u8 data_8072C4B0[4];

/* 8072C4B4-8072C4B8 0004+00 r=0 e=0 z=0  None .bss       sInstance__38JASGlobalInstance<17JAUSoundNameTable>          */
u8 data_8072C4B4[4];

/* 8072C4B8-8072C4BC 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAUSoundInfo>               */
u8 data_8072C4B8[4];

/* 8072C4BC-8072C4C0 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2SoundInfo>                */
u8 data_8072C4BC[4];

/* 8072C4C0-8072C4C4 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13Z2SoundObjMgr>              */
u8 data_8072C4C0[4];

/* 8072C4C4-8072C4C8 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2Audience>                 */
u8 data_8072C4C4[4];

/* 8072C4C8-8072C4CC 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2FxLineMgr>                */
u8 data_8072C4C8[4];

/* 8072C4CC-8072C4D0 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2EnvSeMgr>                 */
u8 data_8072C4CC[4];

/* 8072C4D0-8072C4D4 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2SpeechMgr>                */
u8 data_8072C4D0[4];

/* 8072C4D4-8072C4D8 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13Z2WolfHowlMgr>              */
u8 data_8072C4D4[4];

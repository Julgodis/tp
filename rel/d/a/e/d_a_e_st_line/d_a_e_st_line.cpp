...
static void daE_ST_LINE_Draw(e_st_line_class*); // 2
static void daE_ST_LINE_Execute(e_st_line_class*); // 2
static void daE_ST_LINE_IsDelete(e_st_line_class*); // 2
static void daE_ST_LINE_Delete(e_st_line_class*); // 2
static void useHeapInit(fopAc_ac_c*); // 2
static void daE_ST_LINE_Create(fopAc_ac_c*); // 2

extern "C" static void daE_ST_LINE_Draw__FP15e_st_line_class(); // 1
extern "C" void __dt__4cXyzFv(); // 1
extern "C" static void daE_ST_LINE_Execute__FP15e_st_line_class(); // 1
extern "C" static void daE_ST_LINE_IsDelete__FP15e_st_line_class(); // 1
...
/* 807A6F58-807A6F60 0008+00 r=1 e=0 z=0  None .text      daE_ST_LINE_Draw__FP15e_st_line_class                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void daE_ST_LINE_Draw(e_st_line_class* param_0) {
	nofralloc
...
/* 807A6F60-807A6F9C 003C+00 r=1 e=0 z=0  None .text      __dt__4cXyzFv                                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm cXyz::~cXyz() {
...
/* 807A6F9C-807A6FA4 0008+00 r=2 e=0 z=0  None .text      daE_ST_LINE_Execute__FP15e_st_line_class                     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void daE_ST_LINE_Execute(e_st_line_class* param_0) {
	nofralloc
...
/* 807A6FA4-807A6FAC 0008+00 r=1 e=0 z=0  None .text      daE_ST_LINE_IsDelete__FP15e_st_line_class                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void daE_ST_LINE_IsDelete(e_st_line_class* param_0) {
	nofralloc
...
/* ############################################################################################## */
/* 807A722C-807A7230 0004+00 r=1 e=0 z=0  None .rodata    @3704                                                        */
SECTION_RODATA static u32 const lit_3704 = 0x428C0000;

/* 807A7230-807A7234 0004+00 r=0 e=0 z=0  None .rodata    @3705                                                        */
SECTION_RODATA u8 const lit_3705[4] = {
	0x00, 0x00, 0x00, 0x00,
};

/* 807A7234-807A7238 0004+00 r=0 e=0 z=0  None .rodata    @3706                                                        */
SECTION_RODATA u32 const lit_3706 = 0x42C80000;

/* 807A7238-807A723C 0004+00 r=0 e=0 z=0  None .rodata    @3735                                                        */
SECTION_RODATA u32 const lit_3735 = 0x41200000;

/* 807A723C-807A7244 0004+04 r=0 e=0 z=0  None .rodata    @3759                                                        */
...
/* 807A7244-807A724C 0008+00 r=0 e=0 z=0  None .rodata    @3938                                                        */
SECTION_RODATA u8 const lit_3938[8] = {
	0x3F, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 807A724C-807A7254 0008+00 r=0 e=0 z=0  None .rodata    @3939                                                        */
SECTION_RODATA u8 const lit_3939[8] = {
	0x40, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 807A7254-807A725C 0008+00 r=0 e=0 z=0  None .rodata    @3940                                                        */
SECTION_RODATA u8 const lit_3940[8] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 807A725C-807A7260 0004+00 r=0 e=0 z=0  None .rodata    @3941                                                        */
SECTION_RODATA u32 const lit_3941 = 0x41A00000;

/* 807A7260-807A7264 0004+00 r=0 e=0 z=0  None .rodata    @3942                                                        */
SECTION_RODATA u32 const lit_3942 = 0x40A00000;

/* 807A7264-807A7268 0004+00 r=0 e=0 z=0  None .rodata    @3943                                                        */
SECTION_RODATA u32 const lit_3943 = 0x40800000;

/* 807A7268-807A726C 0004+00 r=0 e=0 z=0  None .rodata    @3944                                                        */
SECTION_RODATA u32 const lit_3944 = 0x42200000;

/* 807A726C-807A7270 0004+00 r=0 e=0 z=0  None .rodata    @3945                                                        */
SECTION_RODATA u32 const lit_3945 = 0x42480000;

/* 807A7270-807A7274 0004+00 r=0 e=0 z=0  None .rodata    @3946                                                        */
SECTION_RODATA u32 const lit_3946 = 0x459C4000;

/* 807A7274-807A7278 0004+00 r=0 e=0 z=0  None .rodata    @3947                                                        */
SECTION_RODATA u32 const lit_3947 = 0x3F800000;

/* 807A7278-807A727C 0004+00 r=0 e=0 z=0  None .rodata    @4003                                                        */
SECTION_RODATA u32 const lit_4003 = 0x3C75C28F;

/* 807A727C-807A7280 0004+00 r=0 e=0 z=0  None .rodata    @4004                                                        */
SECTION_RODATA u32 const lit_4004 = 0x3BA3D70A;

/* 807A7280-807A7284 0004+00 r=1 e=0 z=0  None .rodata    @4069                                                        */
SECTION_RODATA static u32 const lit_4069 = 0x3E99999A;

/* 807A7284-807A7288 0004+00 r=0 e=0 z=0  None .rodata    @4070                                                        */
SECTION_RODATA u32 const lit_4070 = 0x447A0000;

/* 807A7288-807A728C 0004+00 r=0 e=0 z=0  None .rodata    @4071                                                        */
SECTION_RODATA u32 const lit_4071 = 0x3E4CCCCD;

/* 807A728C-807A7290 0004+00 r=0 e=0 z=0  None .rodata    @4072                                                        */
SECTION_RODATA u32 const lit_4072 = 0x42700000;

/* 807A7290-807A7294 0004+00 r=0 e=0 z=0  None .rodata    @4073                                                        */
SECTION_RODATA u32 const lit_4073 = 0x3F000000;

/* 807A7294-807A7298 0004+00 r=0 e=0 z=0  None .rodata    @4169                                                        */
SECTION_RODATA u32 const lit_4169 = 0x477FFF00;

/* 807A7298-807A729C 0004+00 r=0 e=0 z=0  None .rodata    @4170                                                        */
SECTION_RODATA u32 const lit_4170 = 0x432A0000;

/* 807A729C-807A72A1 0005+00 r=2 e=0 z=0  None .rodata    @stringBase0                                                 */
#pragma push
...
/* 807A6FAC-807A7008 005C+00 r=1 e=0 z=0  None .text      daE_ST_LINE_Delete__FP15e_st_line_class                      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 807A7008-807A707C 0074+00 r=1 e=0 z=0  None .text      useHeapInit__FP10fopAc_ac_c                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 807A72A4-807A72C4 0020+00 r=1 e=0 z=0  None .data      l_daE_ST_LINE_Method                                         */
...
/* 807A72C4-807A72F4 0030+00 r=1 e=0 z=1  None .data      g_profile_E_ST_LINE                                          */
...
/* 807A72F4-807A7308 0014+00 r=1 e=0 z=0  None .data      __vt__18mDoExt_3DlineMat_c                                   */
...
/* 807A707C-807A7220 01A4+00 r=1 e=0 z=0  None .text      daE_ST_LINE_Create__FP10fopAc_ac_c                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 807A7220-807A7224 0004+00 r=1 e=0 z=0  None .text      __ct__4cXyzFv                                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm cXyz::cXyz() {

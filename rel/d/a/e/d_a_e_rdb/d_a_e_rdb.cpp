...
static void anm_init(e_rdb_class*, int, f32, u8, f32); // 2
static void nodeCallBack(J3DJoint*, int); // 2
static void daE_RDB_Draw(e_rdb_class*); // 2
static void mtx_to_posAngle(f32 (* )[4], cXyz*, csXyz*); // 2
static void player_way_check(e_rdb_class*); // 2
static void e_rdb_wait(e_rdb_class*); // 2
static void e_rdb_fight(e_rdb_class*); // 2
static void getPolyColor(cBgS_PolyInfo&, int, _GXColor*, _GXColor*, u8*, f32*); // 2
static void e_rdb_attack(e_rdb_class*); // 2
static void e_rdb_spin_attack(e_rdb_class*); // 2
static void e_rdb_defence(e_rdb_class*); // 2
static void e_rdb_damage(e_rdb_class*); // 2
static void e_rdb_end(e_rdb_class*); // 2
static void e_rdb_start(e_rdb_class*); // 2
static void damage_check(e_rdb_class*); // 2
static void shot_s_sub(void*, void*); // 2
static void action(e_rdb_class*); // 2
static void cam_3d_morf(e_rdb_class*, f32); // 2
static void cam_spd_set(e_rdb_class*); // 2
static void demo_camera(e_rdb_class*); // 2
static void anm_se_set(e_rdb_class*); // 2
static void daE_RDB_Execute(e_rdb_class*); // 2
static void daE_RDB_IsDelete(e_rdb_class*); // 2
static void daE_RDB_Delete(e_rdb_class*); // 2
static void useHeapInit(fopAc_ac_c*); // 2
static void daE_RDB_Create(fopAc_ac_c*); // 2
static void setMidnaBindEffect(fopEn_enemy_c*, Z2CreatureEnemy*, cXyz*, cXyz*); // 2

extern "C" void __ct__13daE_RDB_HIO_cFv(); // 1
extern "C" static void anm_init__FP11e_rdb_classifUcf(); // 1
extern "C" static void nodeCallBack__FP8J3DJointi(); // 1
extern "C" static void daE_RDB_Draw__FP11e_rdb_class(); // 1
extern "C" static void mtx_to_posAngle__FPA4_fP4cXyzP5csXyz(); // 1
extern "C" static void player_way_check__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_wait__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_fight__FP11e_rdb_class(); // 1
extern "C" static void getPolyColor__FR13cBgS_PolyInfoiP8_GXColorP8_GXColorPUcPf(); // 1
extern "C" static void e_rdb_attack__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_spin_attack__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_defence__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_damage__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_end__FP11e_rdb_class(); // 1
extern "C" static void e_rdb_start__FP11e_rdb_class(); // 1
extern "C" static void damage_check__FP11e_rdb_class(); // 1
extern "C" static void shot_s_sub__FPvPv(); // 1
extern "C" static void action__FP11e_rdb_class(); // 1
extern "C" static void cam_3d_morf__FP11e_rdb_classf(); // 1
extern "C" static void cam_spd_set__FP11e_rdb_class(); // 1
extern "C" static void demo_camera__FP11e_rdb_class(); // 1
extern "C" static void anm_se_set__FP11e_rdb_class(); // 1
extern "C" static void daE_RDB_Execute__FP11e_rdb_class(); // 1
extern "C" static void daE_RDB_IsDelete__FP11e_rdb_class(); // 1
extern "C" static void daE_RDB_Delete__FP11e_rdb_class(); // 1
extern "C" static void useHeapInit__FP10fopAc_ac_c(); // 1
extern "C" static void daE_RDB_Create__FP10fopAc_ac_c(); // 1
extern "C" void __ct__11e_rdb_classFv(); // 1
...
extern "C" void __dt__13daE_RDB_HIO_cFv(); // 1
extern "C" void __sinit_d_a_e_rdb_cpp(); // 1
extern "C" static void func_8076AFE8(); // 1
extern "C" static void func_8076AFF0(); // 1
...
/* ############################################################################################## */
/* 8076B45C-8076B460 0004+00 r=17 e=0 z=0  None .rodata    @4007                                                        */
SECTION_RODATA static u32 const lit_4007 = 0x42C80000;

/* 8076B460-8076B464 0004+00 r=2 e=0 z=0  None .rodata    @4008                                                        */
SECTION_RODATA static u8 const lit_4008[4] = {
	0x00, 0x00, 0x00, 0x00,
};

/* 8076B464-8076B46C 0004+04 r=1 e=0 z=0  None .rodata    @4009                                                        */
...
/* 8076B46C-8076B474 0008+00 r=0 e=0 z=0  None .rodata    @4010                                                        */
SECTION_RODATA u8 const lit_4010[8] = {
	0x3F, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8076B474-8076B47C 0008+00 r=0 e=0 z=0  None .rodata    @4011                                                        */
SECTION_RODATA u8 const lit_4011[8] = {
	0x40, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8076B47C-8076B484 0008+00 r=0 e=0 z=0  None .rodata    @4012                                                        */
SECTION_RODATA u8 const lit_4012[8] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8076B484-8076B488 0004+00 r=0 e=0 z=0  None .rodata    @4013                                                        */
SECTION_RODATA u32 const lit_4013 = 0x3C23D70A;

/* 8076B488-8076B48C 0004+00 r=1 e=0 z=0  None .rodata    @4028                                                        */
SECTION_RODATA static u32 const lit_4028 = 0x3FC66666;

/* 8076B6F8-8076B704 000C+00 r=2 e=0 z=0  None .data      cNullVec__6Z2Calc                                            */
SECTION_DATA static u8 cNullVec__6Z2Calc[12] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 8076B704-8076B718 0004+10 r=0 e=0 z=0  None .data      @1787                                                        */
...
/* 8076B718-8076B720 0008+00 r=0 e=0 z=0  None .data      e_prim$3886                                                  */
SECTION_DATA u8 data_8076B718[8] = {
	0xFF, 0x78, 0x00, 0x00, 0xFF, 0x64, 0x78, 0x00,
};

/* 8076B720-8076B728 0008+00 r=0 e=0 z=0  None .data      e_env$3887                                                   */
SECTION_DATA u8 data_8076B720[8] = {
	0x5A, 0x2D, 0x2D, 0x00, 0x3C, 0x1E, 0x1E, 0x00,
};

/* 8076B728-8076B730 0006+02 r=0 e=0 z=0  None .data      eff_id$3895                                                  */
...
/* 8076B730-8076B738 0006+02 r=1 e=0 z=0  None .data      ap_name$4291                                                 */
SECTION_DATA static u8 data_8076B730[6 + 2 /* padding */] = {
	0x8A, 0x5C, 0x8A, 0x5D, 0x8A, 0x5E,
	/* padding */
	0x00, 0x00,
};

/* 8076B738-8076B73C 0004+00 r=1 e=0 z=0  None .data      ap_name$4373                                                 */
SECTION_DATA static u8 data_8076B738[4] = {
	0x8A, 0x5F, 0x8A, 0x60,
};

/* 8076B73C-8076B798 005C+00 r=1 e=0 z=0  None .data      @4656                                                        */
SECTION_DATA static void* lit_4656[23] = {
	/* 0    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x8C),
	/* 1    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0xC0),
	/* 2    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 3    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x228),
	/* 4    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x24C),
	/* 5    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x298),
	/* 6    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 7    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 8    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 9    */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 10   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x2A0),
	/* 11   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x30C),
	/* 12   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 13   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 14   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 15   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 16   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 17   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 18   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 19   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x434),
	/* 20   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x344),
	/* 21   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x398),
	/* 22   */ (void*)(((char*)e_rdb_end__FP11e_rdb_class)+0x424),
};

/* 8076B798-8076B7D0 0038+00 r=1 e=0 z=0  None .data      @4730                                                        */
SECTION_DATA static void* lit_4730[14] = {
	/* 0    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x6C),
	/* 1    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x374),
	/* 2    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x8C),
	/* 3    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0xC0),
	/* 4    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0xC8),
	/* 5    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0xF0),
	/* 6    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x374),
	/* 7    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x168),
	/* 8    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x374),
	/* 9    */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x374),
	/* 10   */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x17C),
	/* 11   */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x188),
	/* 12   */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x220),
	/* 13   */ (void*)(((char*)e_rdb_start__FP11e_rdb_class)+0x330),
};

/* 8076B7D0-8076B7F0 0020+00 r=1 e=0 z=0  None .data      @5169                                                        */
SECTION_DATA static void* lit_5169[8] = {
	/* 0    */ (void*)(((char*)action__FP11e_rdb_class)+0x88),
	/* 1    */ (void*)(((char*)action__FP11e_rdb_class)+0x9C),
	/* 2    */ (void*)(((char*)action__FP11e_rdb_class)+0xAC),
	/* 3    */ (void*)(((char*)action__FP11e_rdb_class)+0xBC),
	/* 4    */ (void*)(((char*)action__FP11e_rdb_class)+0xD0),
	/* 5    */ (void*)(((char*)action__FP11e_rdb_class)+0xE4),
	/* 6    */ (void*)(((char*)action__FP11e_rdb_class)+0xF8),
	/* 7    */ (void*)(((char*)action__FP11e_rdb_class)+0x108),
};

/* 8076B7F0-8076B830 0040+00 r=1 e=0 z=0  None .data      @5653                                                        */
SECTION_DATA static void* lit_5653[16] = {
	/* 0    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 1    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x68),
	/* 2    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x114),
	/* 3    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x340),
	/* 4    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 5    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 6    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 7    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 8    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 9    */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xB98),
	/* 10   */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x3D4),
	/* 11   */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x4B8),
	/* 12   */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x774),
	/* 13   */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0x854),
	/* 14   */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xA58),
	/* 15   */ (void*)(((char*)demo_camera__FP11e_rdb_class)+0xAA8),
};

/* 8076B830-8076B870 0040+00 r=0 e=0 z=0  None .data      cc_sph_src$6434                                              */
...
/* 8076B870-8076B8B0 0040+00 r=0 e=0 z=0  None .data      at_sph_src$6435                                              */
...
/* 8076B8B0-8076B8F4 0044+00 r=0 e=0 z=0  None .data      co_cyl_src$6444                                              */
...
/* 8076B8F4-8076B914 0020+00 r=1 e=0 z=0  None .data      l_daE_RDB_Method                                             */
SECTION_DATA static void* l_daE_RDB_Method[8] = {
	/* 0    */ (void*)daE_RDB_Create__FP10fopAc_ac_c,
	/* 1    */ (void*)daE_RDB_Delete__FP11e_rdb_class,
	/* 2    */ (void*)daE_RDB_Execute__FP11e_rdb_class,
	/* 3    */ (void*)daE_RDB_IsDelete__FP11e_rdb_class,
	/* 4    */ (void*)daE_RDB_Draw__FP11e_rdb_class,
	/* 5    */ (void*)NULL,
	/* 6    */ (void*)NULL,
	/* 7    */ (void*)NULL,
};

/* 8076B914-8076B944 0030+00 r=1 e=0 z=1  None .data      g_profile_E_RDB                                              */
SECTION_DATA void* g_profile_E_RDB[12] = {
	...
	/* 8    */ (void*)0x009C0000,
	/* 9    */ (void*)&l_daE_RDB_Method,
	/* 10   */ (void*)0x00044100,
	/* 11   */ (void*)0x020E0000,
};

/* 8076B944-8076B950 000C+00 r=1 e=0 z=0  None .data      __vt__12dBgS_AcchCir                                         */
...
/* 8076B950-8076B95C 000C+00 r=2 e=0 z=0  None .data      __vt__10cCcD_GStts                                           */
...
/* 8076B95C-8076B968 000C+00 r=1 e=0 z=0  None .data      __vt__10dCcD_GStts                                           */
...
/* 8076B968-8076B974 000C+00 r=4 e=0 z=0  None .data      __vt__8cM3dGSph                                              */
...
/* 8076B974-8076B980 000C+00 r=2 e=0 z=0  None .data      __vt__8cM3dGCyl                                              */
...
/* 8076B980-8076B98C 000C+00 r=4 e=0 z=0  None .data      __vt__8cM3dGAab                                              */
...
/* 8076B98C-8076B9B0 0024+00 r=2 e=0 z=0  None .data      __vt__12dBgS_ObjAcch                                         */
SECTION_DATA static void* __vt__12dBgS_ObjAcch[9] = {
	...
	/* 3    */ (void*)NULL,
	/* 4    */ (void*)NULL,
	/* 5    */ (void*)func_8076AFF0,
	/* 6    */ (void*)NULL,
	/* 7    */ (void*)NULL,
	/* 8    */ (void*)func_8076AFE8,
};

/* 8076B9B0-8076B9BC 000C+00 r=2 e=0 z=0  None .data      __vt__13daE_RDB_HIO_c                                        */
SECTION_DATA static void* __vt__13daE_RDB_HIO_c[3] = {
	/* 0    */ (void*)NULL /* RTTI */,
	/* 1    */ (void*)NULL,
	/* 2    */ (void*)__dt__13daE_RDB_HIO_cFv,
};

/* 807650CC-807650F0 0024+00 r=1 e=0 z=0  None .text      __ct__13daE_RDB_HIO_cFv                                      */
#pragma push
...
/* ############################################################################################## */
/* 8076B48C-8076B490 0004+00 r=1 e=0 z=0  None .rodata    @4042                                                        */
SECTION_RODATA static u32 const lit_4042 = 0xBF800000;

/* 8076B490-8076B494 0004+00 r=0 e=0 z=0  None .rodata    @4169                                                        */
SECTION_RODATA u32 const lit_4169 = 0x44D48000;

/* 8076B494-8076B498 0004+00 r=0 e=0 z=0  None .rodata    @4170                                                        */
SECTION_RODATA u32 const lit_4170 = 0x4528C000;

/* 8076B498-8076B49C 0004+00 r=0 e=0 z=0  None .rodata    @4228                                                        */
SECTION_RODATA u32 const lit_4228 = 0x41200000;

/* 8076B49C-8076B4A0 0004+00 r=0 e=0 z=0  None .rodata    @4229                                                        */
SECTION_RODATA u32 const lit_4229 = 0x41A00000;

/* 8076B4A0-8076B4A4 0004+00 r=0 e=0 z=0  None .rodata    @4230                                                        */
SECTION_RODATA u32 const lit_4230 = 0x40A00000;

/* 8076B4A4-8076B4A8 0004+00 r=0 e=0 z=0  None .rodata    @4231                                                        */
SECTION_RODATA u32 const lit_4231 = 0x43AF0000;

/* 8076B4A8-8076B4AC 0004+00 r=0 e=0 z=0  None .rodata    @4232                                                        */
SECTION_RODATA u32 const lit_4232 = 0xC0000000;

/* 8076B4AC-8076B4B0 0004+00 r=0 e=0 z=0  None .rodata    @4233                                                        */
SECTION_RODATA u32 const lit_4233 = 0x43C80000;

/* 8076B4B0-8076B4B4 0004+00 r=0 e=0 z=0  None .rodata    @4234                                                        */
SECTION_RODATA u32 const lit_4234 = 0x40400000;

/* 8076B4B4-8076B4B8 0004+00 r=0 e=0 z=0  None .rodata    @4235                                                        */
SECTION_RODATA u32 const lit_4235 = 0x43D20000;

/* 8076B4B8-8076B4BC 0004+00 r=0 e=0 z=0  None .rodata    @4236                                                        */
SECTION_RODATA u32 const lit_4236 = 0x444D0000;

/* 8076B4BC-8076B4C0 0004+00 r=0 e=0 z=0  None .rodata    @4263                                                        */
SECTION_RODATA u32 const lit_4263 = 0x442F0000;

/* 8076B4C0-8076B4C4 0004+00 r=0 e=0 z=0  None .rodata    @4264                                                        */
SECTION_RODATA u32 const lit_4264 = 0x44160000;

/* 8076B4C4-8076B4C8 0004+00 r=0 e=0 z=0  None .rodata    @4265                                                        */
SECTION_RODATA u32 const lit_4265 = 0x3DCCCCCD;

/* 8076B4C8-8076B4CC 0004+00 r=0 e=0 z=0  None .rodata    @4352                                                        */
SECTION_RODATA u32 const lit_4352 = 0x3F000000;

/* 8076B4CC-8076B4D0 0004+00 r=0 e=0 z=0  None .rodata    @4540                                                        */
SECTION_RODATA u32 const lit_4540 = 0x409FAE14;

/* 8076B4D0-8076B4D4 0004+00 r=0 e=0 z=0  None .rodata    @4541                                                        */
SECTION_RODATA u32 const lit_4541 = 0x40000000;

/* 8076B4D4-8076B4D8 0004+00 r=0 e=0 z=0  None .rodata    @4647                                                        */
SECTION_RODATA u32 const lit_4647 = 0x41C80000;

/* 8076B4D8-8076B4DC 0004+00 r=0 e=0 z=0  None .rodata    @4648                                                        */
SECTION_RODATA u32 const lit_4648 = 0xC1200000;

/* 8076B4DC-8076B4E0 0004+00 r=0 e=0 z=0  None .rodata    @4649                                                        */
SECTION_RODATA u32 const lit_4649 = 0x40200000;

/* 8076B4E0-8076B4E4 0004+00 r=0 e=0 z=0  None .rodata    @4650                                                        */
SECTION_RODATA u32 const lit_4650 = 0x42200000;

/* 8076B4E4-8076B4E8 0004+00 r=0 e=0 z=0  None .rodata    @4651                                                        */
SECTION_RODATA u32 const lit_4651 = 0x44B7C000;

/* 8076B4E8-8076B4EC 0004+00 r=0 e=0 z=0  None .rodata    @4652                                                        */
SECTION_RODATA u32 const lit_4652 = 0x45052000;

/* 8076B4EC-8076B4F0 0004+00 r=0 e=0 z=0  None .rodata    @4653                                                        */
SECTION_RODATA u32 const lit_4653 = 0x43480000;

/* 8076B4F0-8076B4F4 0004+00 r=0 e=0 z=0  None .rodata    @4654                                                        */
SECTION_RODATA u32 const lit_4654 = 0x459C4000;

/* 8076B4F4-8076B4F8 0004+00 r=0 e=0 z=0  None .rodata    @4725                                                        */
SECTION_RODATA u32 const lit_4725 = 0x469C4000;

/* 8076B4F8-8076B4FC 0004+00 r=0 e=0 z=0  None .rodata    @4726                                                        */
SECTION_RODATA u32 const lit_4726 = 0x43FA0000;

/* 8076B4FC-8076B500 0004+00 r=0 e=0 z=0  None .rodata    @4727                                                        */
SECTION_RODATA u32 const lit_4727 = 0x44FA0000;

/* 8076B500-8076B504 0004+00 r=0 e=0 z=0  None .rodata    @4728                                                        */
SECTION_RODATA u32 const lit_4728 = 0x40600000;

/* 8076B504-8076B508 0004+00 r=0 e=0 z=0  None .rodata    @4853                                                        */
SECTION_RODATA u32 const lit_4853 = 0x41400000;

/* 8076B508-8076B50C 0004+00 r=0 e=0 z=0  None .rodata    @4854                                                        */
SECTION_RODATA u32 const lit_4854 = 0x42F00000;

/* 8076B50C-8076B510 0004+00 r=0 e=0 z=0  None .rodata    @4855                                                        */
SECTION_RODATA u32 const lit_4855 = 0x433E0000;

/* 8076B510-8076B514 0004+00 r=0 e=0 z=0  None .rodata    @4856                                                        */
SECTION_RODATA u32 const lit_4856 = 0x43160000;

/* 8076B514-8076B518 0004+00 r=0 e=0 z=0  None .rodata    @4904                                                        */
SECTION_RODATA u32 const lit_4904 = 0x447A0000;

/* 8076B518-8076B51C 0004+00 r=0 e=0 z=0  None .rodata    @5163                                                        */
SECTION_RODATA u32 const lit_5163 = 0xC0A00000;

/* 8076B51C-8076B520 0004+00 r=0 e=0 z=0  None .rodata    @5164                                                        */
SECTION_RODATA u32 const lit_5164 = 0x3FB851EC;

/* 8076B520-8076B524 0004+00 r=0 e=0 z=0  None .rodata    @5165                                                        */
SECTION_RODATA u32 const lit_5165 = 0xC2A00000;

/* 8076B524-8076B528 0004+00 r=0 e=0 z=0  None .rodata    @5166                                                        */
SECTION_RODATA u32 const lit_5166 = 0xC3160000;

/* 8076B528-8076B52C 0004+00 r=0 e=0 z=0  None .rodata    @5167                                                        */
SECTION_RODATA u32 const lit_5167 = 0x42480000;

/* 8076B52C-8076B534 0004+04 r=0 e=0 z=0  None .rodata    @5168                                                        */
...
/* 8076B534-8076B53C 0008+00 r=0 e=0 z=0  None .rodata    @5171                                                        */
SECTION_RODATA u8 const lit_5171[8] = {
	0x43, 0x30, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00,
};

/* 8076B53C-8076B540 0004+00 r=0 e=0 z=0  None .rodata    @5616                                                        */
SECTION_RODATA u32 const lit_5616 = 0x425C0000;

/* 8076B540-8076B544 0004+00 r=0 e=0 z=0  None .rodata    @5617                                                        */
SECTION_RODATA u32 const lit_5617 = 0x43A50000;

/* 8076B544-8076B548 0004+00 r=0 e=0 z=0  None .rodata    @5618                                                        */
SECTION_RODATA u32 const lit_5618 = 0x430C0000;

/* 8076B548-8076B54C 0004+00 r=0 e=0 z=0  None .rodata    @5619                                                        */
SECTION_RODATA u32 const lit_5619 = 0x3E4CCCCD;

/* 8076B54C-8076B550 0004+00 r=0 e=0 z=0  None .rodata    @5620                                                        */
SECTION_RODATA u32 const lit_5620 = 0xC5EE5800;

/* 8076B550-8076B554 0004+00 r=0 e=0 z=0  None .rodata    @5621                                                        */
SECTION_RODATA u32 const lit_5621 = 0x43190000;

/* 8076B554-8076B558 0004+00 r=0 e=0 z=0  None .rodata    @5622                                                        */
SECTION_RODATA u32 const lit_5622 = 0xC5A7D800;

/* 8076B558-8076B55C 0004+00 r=0 e=0 z=0  None .rodata    @5623                                                        */
SECTION_RODATA u32 const lit_5623 = 0xC5E97000;

/* 8076B55C-8076B560 0004+00 r=0 e=0 z=0  None .rodata    @5624                                                        */
SECTION_RODATA u32 const lit_5624 = 0x43100000;

/* 8076B560-8076B564 0004+00 r=0 e=0 z=0  None .rodata    @5625                                                        */
SECTION_RODATA u32 const lit_5625 = 0xC59E7800;

/* 8076B564-8076B568 0004+00 r=0 e=0 z=0  None .rodata    @5626                                                        */
SECTION_RODATA u32 const lit_5626 = 0x3CF5C28F;

/* 8076B568-8076B56C 0004+00 r=0 e=0 z=0  None .rodata    @5627                                                        */
SECTION_RODATA u32 const lit_5627 = 0x3B449BA6;

/* 8076B56C-8076B570 0004+00 r=0 e=0 z=0  None .rodata    @5628                                                        */
SECTION_RODATA u32 const lit_5628 = 0x43660000;

/* 8076B570-8076B574 0004+00 r=0 e=0 z=0  None .rodata    @5629                                                        */
SECTION_RODATA u32 const lit_5629 = 0x435C0000;

/* 8076B574-8076B578 0004+00 r=0 e=0 z=0  None .rodata    @5630                                                        */
SECTION_RODATA u32 const lit_5630 = 0x41F00000;

/* 8076B578-8076B57C 0004+00 r=0 e=0 z=0  None .rodata    @5631                                                        */
SECTION_RODATA u32 const lit_5631 = 0x43960000;

/* 8076B57C-8076B580 0004+00 r=0 e=0 z=0  None .rodata    @5632                                                        */
SECTION_RODATA u32 const lit_5632 = 0x43110000;

/* 8076B580-8076B584 0004+00 r=0 e=0 z=0  None .rodata    @5633                                                        */
SECTION_RODATA u32 const lit_5633 = 0x432A0000;

/* 8076B584-8076B588 0004+00 r=0 e=0 z=0  None .rodata    @5634                                                        */
SECTION_RODATA u32 const lit_5634 = 0x428C0000;

/* 8076B588-8076B58C 0004+00 r=0 e=0 z=0  None .rodata    @5635                                                        */
SECTION_RODATA u32 const lit_5635 = 0x3D4CCCCD;

/* 8076B58C-8076B590 0004+00 r=0 e=0 z=0  None .rodata    @5636                                                        */
SECTION_RODATA u32 const lit_5636 = 0x3E800000;

/* 8076B590-8076B594 0004+00 r=0 e=0 z=0  None .rodata    @5637                                                        */
SECTION_RODATA u32 const lit_5637 = 0xC5DD4000;

/* 8076B594-8076B598 0004+00 r=0 e=0 z=0  None .rodata    @5638                                                        */
SECTION_RODATA u32 const lit_5638 = 0xC5CF5000;

/* 8076B598-8076B59C 0004+00 r=0 e=0 z=0  None .rodata    @5639                                                        */
SECTION_RODATA u32 const lit_5639 = 0xC61C6000;

/* 8076B59C-8076B5A0 0004+00 r=0 e=0 z=0  None .rodata    @5640                                                        */
SECTION_RODATA u32 const lit_5640 = 0xC52A9000;

/* 8076B5A0-8076B5A4 0004+00 r=0 e=0 z=0  None .rodata    @5641                                                        */
SECTION_RODATA u32 const lit_5641 = 0xC5EB5000;

/* 8076B5A4-8076B5A8 0004+00 r=0 e=0 z=0  None .rodata    @5642                                                        */
SECTION_RODATA u32 const lit_5642 = 0xC5AA5800;

/* 8076B5A8-8076B5AC 0004+00 r=0 e=0 z=0  None .rodata    @5643                                                        */
SECTION_RODATA u32 const lit_5643 = 0xC5EF6800;

/* 8076B5AC-8076B5B0 0004+00 r=0 e=0 z=0  None .rodata    @5644                                                        */
SECTION_RODATA u32 const lit_5644 = 0x43A18000;

/* 8076B5B0-8076B5B4 0004+00 r=0 e=0 z=0  None .rodata    @5645                                                        */
SECTION_RODATA u32 const lit_5645 = 0xC5B1A000;

/* 8076B5B4-8076B5B8 0004+00 r=0 e=0 z=0  None .rodata    @5646                                                        */
SECTION_RODATA u32 const lit_5646 = 0xC5E6B000;

/* 8076B5B8-8076B5BC 0004+00 r=0 e=0 z=0  None .rodata    @5647                                                        */
SECTION_RODATA u32 const lit_5647 = 0x43390000;

/* 8076B5BC-8076B5C0 0004+00 r=0 e=0 z=0  None .rodata    @5648                                                        */
SECTION_RODATA u32 const lit_5648 = 0xC5A78000;

/* 8076B5C0-8076B5C4 0004+00 r=0 e=0 z=0  None .rodata    @5649                                                        */
SECTION_RODATA u32 const lit_5649 = 0xBD4CCCCD;

/* 8076B5C4-8076B5C8 0004+00 r=0 e=0 z=0  None .rodata    @5650                                                        */
SECTION_RODATA u32 const lit_5650 = 0xC5F1D000;

/* 8076B5C8-8076B5CC 0004+00 r=0 e=0 z=0  None .rodata    @5651                                                        */
SECTION_RODATA u32 const lit_5651 = 0xC59EF000;

/* 8076B5CC-8076B5D0 0004+00 r=0 e=0 z=0  None .rodata    @5652                                                        */
SECTION_RODATA u32 const lit_5652 = 0x3BA3D70A;

/* 8076B5D0-8076B5D4 0004+00 r=0 e=0 z=0  None .rodata    @5833                                                        */
SECTION_RODATA u32 const lit_5833 = 0x41E80000;

/* 8076B5D4-8076B5D8 0004+00 r=0 e=0 z=0  None .rodata    @5834                                                        */
SECTION_RODATA u32 const lit_5834 = 0x426C0000;

/* 8076B5D8-8076B5DC 0004+00 r=0 e=0 z=0  None .rodata    @5835                                                        */
SECTION_RODATA u32 const lit_5835 = 0x41880000;

/* 8076B5DC-8076B5E0 0004+00 r=0 e=0 z=0  None .rodata    @5836                                                        */
SECTION_RODATA u32 const lit_5836 = 0x41700000;

/* 8076B5E0-8076B5E4 0004+00 r=0 e=0 z=0  None .rodata    @5837                                                        */
SECTION_RODATA u32 const lit_5837 = 0x420C0000;

/* 8076B5E4-8076B5E8 0004+00 r=0 e=0 z=0  None .rodata    @5838                                                        */
SECTION_RODATA u32 const lit_5838 = 0x42680000;

/* 8076B5E8-8076B5EC 0004+00 r=0 e=0 z=0  None .rodata    @5839                                                        */
SECTION_RODATA u32 const lit_5839 = 0x42740000;

/* 8076B5EC-8076B5F0 0004+00 r=0 e=0 z=0  None .rodata    @5840                                                        */
SECTION_RODATA u32 const lit_5840 = 0x42DC0000;

/* 8076B5F0-8076B5F4 0004+00 r=0 e=0 z=0  None .rodata    @5841                                                        */
SECTION_RODATA u32 const lit_5841 = 0x40800000;

/* 8076B5F4-8076B5F8 0004+00 r=0 e=0 z=0  None .rodata    @5842                                                        */
SECTION_RODATA u32 const lit_5842 = 0x424A0000;

/* 8076B5F8-8076B5FC 0004+00 r=0 e=0 z=0  None .rodata    @5843                                                        */
SECTION_RODATA u32 const lit_5843 = 0x41F80000;

/* 8076B5FC-8076B600 0004+00 r=0 e=0 z=0  None .rodata    @5844                                                        */
SECTION_RODATA u32 const lit_5844 = 0x42500000;

/* 8076B600-8076B604 0004+00 r=0 e=0 z=0  None .rodata    @5845                                                        */
SECTION_RODATA u32 const lit_5845 = 0x429A0000;

/* 8076B604-8076B608 0004+00 r=0 e=0 z=0  None .rodata    @5846                                                        */
SECTION_RODATA u32 const lit_5846 = 0x41300000;

/* 8076B608-8076B60C 0004+00 r=0 e=0 z=0  None .rodata    @5847                                                        */
SECTION_RODATA u32 const lit_5847 = 0x42A60000;

/* 8076B60C-8076B610 0004+00 r=0 e=0 z=0  None .rodata    @5848                                                        */
SECTION_RODATA u32 const lit_5848 = 0x42F80000;

/* 8076B610-8076B614 0004+00 r=0 e=0 z=0  None .rodata    @5849                                                        */
SECTION_RODATA u32 const lit_5849 = 0x430E0000;

/* 8076B614-8076B618 0004+00 r=0 e=0 z=0  None .rodata    @5850                                                        */
SECTION_RODATA u32 const lit_5850 = 0x43300000;

/* 8076B618-8076B61C 0004+00 r=0 e=0 z=0  None .rodata    @5851                                                        */
SECTION_RODATA u32 const lit_5851 = 0x41500000;

/* 8076B61C-8076B620 0004+00 r=0 e=0 z=0  None .rodata    @5852                                                        */
SECTION_RODATA u32 const lit_5852 = 0x421C0000;

/* 8076B620-8076B624 0004+00 r=0 e=0 z=0  None .rodata    @5853                                                        */
SECTION_RODATA u32 const lit_5853 = 0x41900000;

/* 8076B624-8076B628 0004+00 r=0 e=0 z=0  None .rodata    @5854                                                        */
SECTION_RODATA u32 const lit_5854 = 0x42100000;

/* 8076B628-8076B62C 0004+00 r=0 e=0 z=0  None .rodata    @5855                                                        */
SECTION_RODATA u32 const lit_5855 = 0x422C0000;

/* 8076B62C-8076B630 0004+00 r=0 e=0 z=0  None .rodata    @6322                                                        */
SECTION_RODATA u32 const lit_6322 = 0xC69C4000;

/* 8076B630-8076B634 0004+00 r=0 e=0 z=0  None .rodata    @6323                                                        */
SECTION_RODATA u32 const lit_6323 = 0x463B8000;

/* 8076B634-8076B638 0004+00 r=0 e=0 z=0  None .rodata    @6324                                                        */
SECTION_RODATA u32 const lit_6324 = 0x46EA6000;

/* 8076B638-8076B63C 0004+00 r=0 e=0 z=0  None .rodata    @6325                                                        */
SECTION_RODATA u32 const lit_6325 = 0x45312000;

/* 8076B63C-8076B640 0004+00 r=0 e=0 z=0  None .rodata    @6326                                                        */
SECTION_RODATA u32 const lit_6326 = 0x44784000;

/* 8076B640-8076B644 0004+00 r=0 e=0 z=0  None .rodata    @6327                                                        */
SECTION_RODATA u32 const lit_6327 = 0xC2700000;

/* 8076B644-8076B648 0004+00 r=0 e=0 z=0  None .rodata    @6328                                                        */
SECTION_RODATA u32 const lit_6328 = 0xC61C4000;

/* 8076B648-8076B64C 0004+00 r=0 e=0 z=0  None .rodata    @6329                                                        */
SECTION_RODATA u32 const lit_6329 = 0x3CA3D70A;

/* 8076B64C-8076B650 0004+00 r=0 e=0 z=0  None .rodata    @6330                                                        */
SECTION_RODATA u32 const lit_6330 = 0x4520D000;

/* 8076B650-8076B654 0004+00 r=0 e=0 z=0  None .rodata    @6331                                                        */
SECTION_RODATA u32 const lit_6331 = 0x43B90000;

/* 8076B654-8076B658 0004+00 r=0 e=0 z=0  None .rodata    @6332                                                        */
SECTION_RODATA u32 const lit_6332 = 0x45098000;

/* 8076B658-8076B65C 0004+00 r=0 e=0 z=0  None .rodata    @6333                                                        */
SECTION_RODATA u32 const lit_6333 = 0x45355000;

/* 8076B65C-8076B660 0004+00 r=0 e=0 z=0  None .rodata    @6334                                                        */
SECTION_RODATA u32 const lit_6334 = 0x4541C000;

/* 8076B660-8076B664 0004+00 r=0 e=0 z=0  None .rodata    @6335                                                        */
SECTION_RODATA u32 const lit_6335 = 0x435E0000;

/* 8076B664-8076B668 0004+00 r=0 e=0 z=0  None .rodata    @6336                                                        */
SECTION_RODATA u32 const lit_6336 = 0x44EC0000;

/* 8076B668-8076B66C 0004+00 r=0 e=0 z=0  None .rodata    @6337                                                        */
SECTION_RODATA u32 const lit_6337 = 0x44ED8000;

/* 8076B66C-8076B670 0004+00 r=0 e=0 z=0  None .rodata    @6338                                                        */
SECTION_RODATA u32 const lit_6338 = 0x440AC000;

/* 8076B670-8076B674 0004+00 r=0 e=0 z=0  None .rodata    @6339                                                        */
SECTION_RODATA u32 const lit_6339 = 0x44C80000;

/* 8076B674-8076B678 0004+00 r=0 e=0 z=0  None .rodata    @6340                                                        */
SECTION_RODATA u32 const lit_6340 = 0x44DEE000;

/* 8076B678-8076B67C 0004+00 r=0 e=0 z=0  None .rodata    @6341                                                        */
SECTION_RODATA u32 const lit_6341 = 0x43B18000;

/* 8076B67C-8076B680 0004+00 r=0 e=0 z=0  None .rodata    @6342                                                        */
SECTION_RODATA u32 const lit_6342 = 0x44C26000;

/* 8076B680-8076B684 0004+00 r=0 e=0 z=0  None .rodata    @6343                                                        */
SECTION_RODATA u32 const lit_6343 = 0x44A68000;

/* 8076B684-8076B688 0004+00 r=0 e=0 z=0  None .rodata    @6344                                                        */
SECTION_RODATA u32 const lit_6344 = 0x44098000;

/* 8076B688-8076B68C 0004+00 r=0 e=0 z=0  None .rodata    @6345                                                        */
SECTION_RODATA u32 const lit_6345 = 0x4485C000;

/* 8076B68C-8076B690 0004+00 r=0 e=0 z=0  None .rodata    @6346                                                        */
SECTION_RODATA u32 const lit_6346 = 0x44ABE000;

/* 8076B690-8076B694 0004+00 r=0 e=0 z=0  None .rodata    @6347                                                        */
SECTION_RODATA u32 const lit_6347 = 0x437A0000;

/* 8076B694-8076B698 0004+00 r=0 e=0 z=0  None .rodata    @6348                                                        */
SECTION_RODATA u32 const lit_6348 = 0x44548000;

/* 8076B698-8076B69C 0004+00 r=0 e=0 z=0  None .rodata    @6349                                                        */
SECTION_RODATA u32 const lit_6349 = 0x4491A000;

/* 8076B69C-8076B6A0 0004+00 r=0 e=0 z=0  None .rodata    @6350                                                        */
SECTION_RODATA u32 const lit_6350 = 0x43D70000;

/* 8076B6A0-8076B6A4 0004+00 r=0 e=0 z=0  None .rodata    @6351                                                        */
SECTION_RODATA u32 const lit_6351 = 0x43E10000;

/* 8076B6A4-8076B6A8 0004+00 r=0 e=0 z=0  None .rodata    @6352                                                        */
SECTION_RODATA u32 const lit_6352 = 0x43820000;

/* 8076B6A8-8076B6AC 0004+00 r=0 e=0 z=0  None .rodata    @6353                                                        */
SECTION_RODATA u32 const lit_6353 = 0x44028000;

/* 8076B6AC-8076B6B0 0004+00 r=0 e=0 z=0  None .rodata    @6354                                                        */
SECTION_RODATA u32 const lit_6354 = 0x44CC0000;

/* 8076B6B0-8076B6B4 0004+00 r=0 e=0 z=0  None .rodata    @6355                                                        */
SECTION_RODATA u32 const lit_6355 = 0x43340000;

/* 8076B6B4-8076B6B8 0004+00 r=0 e=0 z=0  None .rodata    @6539                                                        */
SECTION_RODATA u32 const lit_6539 = 0xC3480000;

/* 8076B6B8-8076B6BC 0004+00 r=0 e=0 z=0  None .rodata    @6540                                                        */
SECTION_RODATA u32 const lit_6540 = 0xC5EE4800;

/* 8076B6BC-8076B6C0 0004+00 r=0 e=0 z=0  None .rodata    @6541                                                        */
SECTION_RODATA u32 const lit_6541 = 0xC5B60800;

/* 8076B6C0-8076B6C4 0004+00 r=0 e=0 z=0  None .rodata    @6542                                                        */
SECTION_RODATA u32 const lit_6542 = 0xC2480000;

/* 8076B6C4-8076B6F7 0033+00 r=11 e=0 z=0  None .rodata    @stringBase0                                                 */
#pragma push
...
/* 807650F0-8076519C 00AC+00 r=9 e=0 z=0  None .text      anm_init__FP11e_rdb_classifUcf                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076519C-80765314 0178+00 r=1 e=0 z=0  None .text      nodeCallBack__FP8J3DJointi                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80765314-80765600 02EC+00 r=1 e=0 z=0  None .text      daE_RDB_Draw__FP11e_rdb_class                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80765600-8076563C 003C+00 r=1 e=0 z=0  None .text      mtx_to_posAngle__FPA4_fP4cXyzP5csXyz                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076563C-80765678 003C+00 r=1 e=0 z=0  None .text      player_way_check__FP11e_rdb_class                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80765678-807658E0 0268+00 r=1 e=0 z=0  None .text      e_rdb_wait__FP11e_rdb_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 807658E0-80765A98 01B8+00 r=1 e=0 z=0  None .text      e_rdb_fight__FP11e_rdb_class                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80765A98-80765B70 00D8+00 r=2 e=0 z=0  None .text      getPolyColor__FR13cBgS_PolyInfoiP8_GXColorP8_GXColorPUcPf    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80765B70-80765E70 0300+00 r=1 e=0 z=0  None .text      e_rdb_attack__FP11e_rdb_class                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80765E70-80766188 0318+00 r=1 e=0 z=0  None .text      e_rdb_spin_attack__FP11e_rdb_class                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80766188-80766294 010C+00 r=1 e=0 z=0  None .text      e_rdb_defence__FP11e_rdb_class                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80766294-807665B4 0320+00 r=1 e=0 z=0  None .text      e_rdb_damage__FP11e_rdb_class                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 807665B4-80766A1C 0468+00 r=2 e=0 z=0  None .text      e_rdb_end__FP11e_rdb_class                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80766A1C-80766DB4 0398+00 r=2 e=0 z=0  None .text      e_rdb_start__FP11e_rdb_class                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80766DB4-80767294 04E0+00 r=1 e=0 z=0  None .text      damage_check__FP11e_rdb_class                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80767294-80767428 0194+00 r=1 e=0 z=0  None .text      shot_s_sub__FPvPv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 8076B9C8-8076B9CC 0001+03 r=1 e=0 z=0  None .bss       @1109                                                        */
static u8 lit_1109[1 + 3 /* padding */];

/* 8076B9CC-8076B9D0 0001+03 r=0 e=0 z=0  None .bss       @1107                                                        */
u8 lit_1107[1 + 3 /* padding */];

/* 8076B9D0-8076B9D4 0001+03 r=0 e=0 z=0  None .bss       @1105                                                        */
u8 lit_1105[1 + 3 /* padding */];

/* 8076B9D4-8076B9D8 0001+03 r=0 e=0 z=0  None .bss       @1104                                                        */
u8 lit_1104[1 + 3 /* padding */];

/* 8076B9D8-8076B9DC 0001+03 r=0 e=0 z=0  None .bss       @1099                                                        */
u8 lit_1099[1 + 3 /* padding */];

/* 8076B9DC-8076B9E0 0001+03 r=0 e=0 z=0  None .bss       @1097                                                        */
u8 lit_1097[1 + 3 /* padding */];

/* 8076B9E0-8076B9E4 0001+03 r=0 e=0 z=0  None .bss       @1095                                                        */
u8 lit_1095[1 + 3 /* padding */];

/* 8076B9E4-8076B9E8 0001+03 r=0 e=0 z=0  None .bss       @1094                                                        */
u8 lit_1094[1 + 3 /* padding */];

/* 8076B9E8-8076B9EC 0001+03 r=0 e=0 z=0  None .bss       @1057                                                        */
u8 lit_1057[1 + 3 /* padding */];

/* 8076B9EC-8076B9F0 0001+03 r=0 e=0 z=0  None .bss       @1055                                                        */
u8 lit_1055[1 + 3 /* padding */];

/* 8076B9F0-8076B9F4 0001+03 r=0 e=0 z=0  None .bss       @1053                                                        */
u8 lit_1053[1 + 3 /* padding */];

/* 8076B9F4-8076B9F8 0001+03 r=0 e=0 z=0  None .bss       @1052                                                        */
u8 lit_1052[1 + 3 /* padding */];

/* 8076B9F8-8076B9FC 0001+03 r=0 e=0 z=0  None .bss       @1014                                                        */
u8 lit_1014[1 + 3 /* padding */];

/* 8076B9FC-8076BA00 0001+03 r=0 e=0 z=0  None .bss       @1012                                                        */
u8 lit_1012[1 + 3 /* padding */];

/* 8076BA00-8076BA04 0001+03 r=0 e=0 z=0  None .bss       @1010                                                        */
u8 lit_1010[1 + 3 /* padding */];

/* 8076BA04-8076BA08 0004+00 r=2 e=0 z=0  None .bss       None                                                         */
static u8 struct_8076BA04[4];

/* 8076BA08-8076BA14 000C+00 r=1 e=0 z=0  None .bss       @4023                                                        */
static u8 lit_4023[12];

/* 8076BA14-8076BA20 000C+00 r=3 e=0 z=0  None .bss       l_HIO                                                        */
static u8 l_HIO[12];

/* 80767428-80767CD0 08A8+00 r=2 e=0 z=0  None .text      action__FP11e_rdb_class                                      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80767CD0-80767DB4 00E4+00 r=1 e=0 z=0  None .text      cam_3d_morf__FP11e_rdb_classf                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80767DB4-80767E54 00A0+00 r=1 e=0 z=0  None .text      cam_spd_set__FP11e_rdb_class                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80767E54-80768B90 0D3C+00 r=2 e=0 z=0  None .text      demo_camera__FP11e_rdb_class                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80768B90-80769324 0794+00 r=1 e=0 z=0  None .text      anm_se_set__FP11e_rdb_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80769324-8076A418 10F4+00 r=2 e=0 z=0  None .text      daE_RDB_Execute__FP11e_rdb_class                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076A418-8076A420 0008+00 r=1 e=0 z=0  None .text      daE_RDB_IsDelete__FP11e_rdb_class                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void daE_RDB_IsDelete(e_rdb_class* param_0) {
	nofralloc
...
/* 8076A420-8076A488 0068+00 r=1 e=0 z=0  None .text      daE_RDB_Delete__FP11e_rdb_class                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076A488-8076A5FC 0174+00 r=1 e=0 z=0  None .text      useHeapInit__FP10fopAc_ac_c                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076A5FC-8076AA0C 0410+00 r=1 e=0 z=0  None .text      daE_RDB_Create__FP10fopAc_ac_c                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AA0C-8076ABB8 01AC+00 r=1 e=0 z=0  None .text      __ct__11e_rdb_classFv                                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076ABB8-8076AC00 0048+00 r=1 e=0 z=0  None .text      __dt__8cM3dGSphFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AC00-8076AC48 0048+00 r=1 e=0 z=0  None .text      __dt__8cM3dGCylFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AC48-8076AC90 0048+00 r=1 e=0 z=0  None .text      __dt__8cM3dGAabFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AC90-8076AD5C 00CC+00 r=1 e=0 z=0  None .text      __dt__8dCcD_SphFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AD5C-8076ADE0 0084+00 r=1 e=0 z=0  None .text      __ct__8dCcD_SphFv                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm dCcD_Sph::dCcD_Sph() {
...
/* 8076ADE0-8076AE3C 005C+00 r=1 e=0 z=0  None .text      __dt__10dCcD_GSttsFv                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AE3C-8076AEAC 0070+00 r=3 e=0 z=0  None .text      __dt__12dBgS_ObjAcchFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AEAC-8076AF1C 0070+00 r=1 e=0 z=0  None .text      __dt__12dBgS_AcchCirFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AF1C-8076AF64 0048+00 r=1 e=0 z=0  None .text      __dt__10cCcD_GSttsFv                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AF64-8076AFAC 0048+00 r=2 e=0 z=0  None .text      __dt__13daE_RDB_HIO_cFv                                      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm daE_RDB_HIO_c::~daE_RDB_HIO_c() {
...
/* 8076AFAC-8076AFE8 003C+00 r=1 e=1 z=0  None .text      __sinit_d_a_e_rdb_cpp                                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AFE8-8076AFF0 0008+00 r=1 e=0 z=0  None .text      @36@__dt__12dBgS_ObjAcchFv                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AFF0-8076AFF8 0008+00 r=1 e=0 z=0  None .text      @20@__dt__12dBgS_ObjAcchFv                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076AFF8-8076B40C 0414+00 r=1 e=0 z=0  None .text      setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8076B40C-8076B448 003C+00 r=1 e=0 z=0  None .text      __dt__4cXyzFv                                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm cXyz::~cXyz() {
...
/* ############################################################################################## */
/* 8076BA20-8076BA30 000C+04 r=0 e=0 z=0  None .bss       @5932                                                        */
u8 lit_5932[12 + 4 /* padding */];

/* 8076BA30-8076BA3C 000C+00 r=0 e=0 z=0  None .bss       @5935                                                        */
u8 lit_5935[12];

/* 8076BA3C-8076BA48 000C+00 r=0 e=0 z=0  None .bss       @5936                                                        */
u8 lit_5936[12];

/* 8076BA48-8076BA54 000C+00 r=0 e=0 z=0  None .bss       @5937                                                        */
u8 lit_5937[12];

/* 8076BA54-8076BA60 000C+00 r=0 e=0 z=0  None .bss       @5938                                                        */
u8 lit_5938[12];

/* 8076BA60-8076BA6C 000C+00 r=0 e=0 z=0  None .bss       @5939                                                        */
u8 lit_5939[12];

/* 8076BA6C-8076BA78 000C+00 r=0 e=0 z=0  None .bss       @5940                                                        */
u8 lit_5940[12];

/* 8076BA78-8076BA84 000C+00 r=0 e=0 z=0  None .bss       @5941                                                        */
u8 lit_5941[12];

/* 8076BA84-8076BA90 000C+00 r=0 e=0 z=0  None .bss       @5942                                                        */
u8 lit_5942[12];

/* 8076BA90-8076BA9C 000C+00 r=0 e=0 z=0  None .bss       @5943                                                        */
u8 lit_5943[12];

/* 8076BA9C-8076BAA8 000C+00 r=0 e=0 z=0  None .bss       @5944                                                        */
u8 lit_5944[12];

/* 8076BAA8-8076BAB4 000C+00 r=0 e=0 z=0  None .bss       @5945                                                        */
u8 lit_5945[12];

/* 8076BAB4-8076BAC0 000C+00 r=0 e=0 z=0  None .bss       @5946                                                        */
u8 lit_5946[12];

/* 8076BAC0-8076BACC 000C+00 r=0 e=0 z=0  None .bss       @5947                                                        */
u8 lit_5947[12];

/* 8076BACC-8076BAD8 000C+00 r=0 e=0 z=0  None .bss       @5948                                                        */
u8 lit_5948[12];

/* 8076BAD8-8076BAE4 000C+00 r=0 e=0 z=0  None .bss       @5949                                                        */
u8 lit_5949[12];

/* 8076BAE4-8076BAF0 000C+00 r=0 e=0 z=0  None .bss       @5950                                                        */
u8 lit_5950[12];

/* 8076BAF0-8076BAFC 000C+00 r=0 e=0 z=0  None .bss       @5951                                                        */
u8 lit_5951[12];

/* 8076BAFC-8076BB08 000C+00 r=0 e=0 z=0  None .bss       @5952                                                        */
u8 lit_5952[12];

/* 8076BB08-8076BB14 000C+00 r=0 e=0 z=0  None .bss       @5953                                                        */
u8 lit_5953[12];

/* 8076BB14-8076BB20 000C+00 r=0 e=0 z=0  None .bss       @5954                                                        */
u8 lit_5954[12];

/* 8076BB20-8076BB2C 000C+00 r=0 e=0 z=0  None .bss       @5955                                                        */
u8 lit_5955[12];

/* 8076BB2C-8076BB38 000C+00 r=0 e=0 z=0  None .bss       @5956                                                        */
u8 lit_5956[12];

/* 8076BB38-8076BB44 000C+00 r=0 e=0 z=0  None .bss       @5957                                                        */
u8 lit_5957[12];

/* 8076BB44-8076BC68 0120+04 r=0 e=0 z=0  None .bss       fire_eff_pos$5931                                            */
u8 data_8076BB44[288 + 4 /* padding */];

/* 8076BC68-8076BC6C 0004+00 r=0 e=0 z=0  None .bss       sInstance__40JASGlobalInstance<19JASDefaultBankTable>        */
u8 data_8076BC68[4];

/* 8076BC6C-8076BC70 0004+00 r=0 e=0 z=0  None .bss       sInstance__35JASGlobalInstance<14JASAudioThread>             */
u8 data_8076BC6C[4];

/* 8076BC70-8076BC74 0004+00 r=0 e=0 z=0  None .bss       sInstance__27JASGlobalInstance<7Z2SeMgr>                     */
u8 data_8076BC70[4];

/* 8076BC74-8076BC78 0004+00 r=0 e=0 z=0  None .bss       sInstance__28JASGlobalInstance<8Z2SeqMgr>                    */
u8 data_8076BC74[4];

/* 8076BC78-8076BC7C 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2SceneMgr>                 */
u8 data_8076BC78[4];

/* 8076BC7C-8076BC80 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2StatusMgr>                */
u8 data_8076BC7C[4];

/* 8076BC80-8076BC84 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2DebugSys>                 */
u8 data_8076BC80[4];

/* 8076BC84-8076BC88 0004+00 r=0 e=0 z=0  None .bss       sInstance__36JASGlobalInstance<15JAISoundStarter>            */
u8 data_8076BC84[4];

/* 8076BC88-8076BC8C 0004+00 r=0 e=0 z=0  None .bss       sInstance__35JASGlobalInstance<14Z2SoundStarter>             */
u8 data_8076BC88[4];

/* 8076BC8C-8076BC90 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12Z2SpeechMgr2>               */
u8 data_8076BC8C[4];

/* 8076BC90-8076BC94 0004+00 r=0 e=0 z=0  None .bss       sInstance__28JASGlobalInstance<8JAISeMgr>                    */
u8 data_8076BC90[4];

/* 8076BC94-8076BC98 0004+00 r=0 e=0 z=0  None .bss       sInstance__29JASGlobalInstance<9JAISeqMgr>                   */
u8 data_8076BC94[4];

/* 8076BC98-8076BC9C 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAIStreamMgr>               */
u8 data_8076BC98[4];

/* 8076BC9C-8076BCA0 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2SoundMgr>                 */
u8 data_8076BC9C[4];

/* 8076BCA0-8076BCA4 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAISoundInfo>               */
u8 data_8076BCA0[4];

/* 8076BCA4-8076BCA8 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13JAUSoundTable>              */
u8 data_8076BCA4[4];

/* 8076BCA8-8076BCAC 0004+00 r=0 e=0 z=0  None .bss       sInstance__38JASGlobalInstance<17JAUSoundNameTable>          */
u8 data_8076BCA8[4];

/* 8076BCAC-8076BCB0 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAUSoundInfo>               */
u8 data_8076BCAC[4];

/* 8076BCB0-8076BCB4 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2SoundInfo>                */
u8 data_8076BCB0[4];

/* 8076BCB4-8076BCB8 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13Z2SoundObjMgr>              */
u8 data_8076BCB4[4];

/* 8076BCB8-8076BCBC 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2Audience>                 */
u8 data_8076BCB8[4];

/* 8076BCBC-8076BCC0 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2FxLineMgr>                */
u8 data_8076BCBC[4];

/* 8076BCC0-8076BCC4 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2EnvSeMgr>                 */
u8 data_8076BCC0[4];

/* 8076BCC4-8076BCC8 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2SpeechMgr>                */
u8 data_8076BCC4[4];

/* 8076BCC8-8076BCCC 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13Z2WolfHowlMgr>              */
u8 data_8076BCC8[4];

...
/* ############################################################################################## */
/* 80C9CD4C-80C9CD50 0004+00 r=9 e=0 z=0  None .rodata    @3863                                                        */
SECTION_RODATA static u32 const lit_3863 = 0x3F800000;

/* 80C9CD50-80C9CD54 0004+00 r=1 e=0 z=0  None .rodata    @3864                                                        */
SECTION_RODATA static u32 const lit_3864 = 0x44480000;

/* 80C9CDF8-80C9CE18 0020+00 r=1 e=0 z=0  None .data      l_daObj_Msima_Method                                         */
...
/* 80C9CE18-80C9CE48 0030+00 r=1 e=0 z=1  None .data      g_profile_OBJ_MSIMA                                          */
...
/* 80C9CE48-80C9CE54 000C+00 r=2 e=0 z=0  None .data      __vt__12J3DFrameCtrl                                         */
...
/* 80C9CE54-80C9CE60 000C+00 r=2 e=0 z=0  None .data      __vt__17daObj_Msima_HIO_c                                    */
...
/* 80C9B40C-80C9B44C 0040+00 r=1 e=0 z=0  None .text      __ct__17daObj_Msima_HIO_cFv                                  */
#pragma push
...
/* 80C9B44C-80C9B4A8 005C+00 r=1 e=0 z=0  None .text      ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9B4A8-80C9B5F8 0150+00 r=1 e=0 z=0  None .text      daObj_Msima_Draw__FP15obj_msima_class                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9B5F8-80C9B60C 0014+00 r=1 e=0 z=0  None .text      msima_start__FP15obj_msima_class                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80C9CE68-80C9CE6C 0001+03 r=1 e=0 z=0  None .bss       @1109                                                        */
static u8 lit_1109[1 + 3 /* padding */];

/* 80C9CE6C-80C9CE70 0001+03 r=0 e=0 z=0  None .bss       @1107                                                        */
u8 lit_1107[1 + 3 /* padding */];

/* 80C9CE70-80C9CE74 0001+03 r=0 e=0 z=0  None .bss       @1105                                                        */
u8 lit_1105[1 + 3 /* padding */];

/* 80C9CE74-80C9CE78 0001+03 r=0 e=0 z=0  None .bss       @1104                                                        */
u8 lit_1104[1 + 3 /* padding */];

/* 80C9CE78-80C9CE7C 0001+03 r=0 e=0 z=0  None .bss       @1099                                                        */
u8 lit_1099[1 + 3 /* padding */];

/* 80C9CE7C-80C9CE80 0001+03 r=0 e=0 z=0  None .bss       @1097                                                        */
u8 lit_1097[1 + 3 /* padding */];

/* 80C9CE80-80C9CE84 0001+03 r=0 e=0 z=0  None .bss       @1095                                                        */
u8 lit_1095[1 + 3 /* padding */];

/* 80C9CE84-80C9CE88 0001+03 r=0 e=0 z=0  None .bss       @1094                                                        */
u8 lit_1094[1 + 3 /* padding */];

/* 80C9CE88-80C9CE8C 0001+03 r=0 e=0 z=0  None .bss       @1057                                                        */
u8 lit_1057[1 + 3 /* padding */];

/* 80C9CE8C-80C9CE90 0001+03 r=0 e=0 z=0  None .bss       @1055                                                        */
u8 lit_1055[1 + 3 /* padding */];

/* 80C9CE90-80C9CE94 0001+03 r=0 e=0 z=0  None .bss       @1053                                                        */
u8 lit_1053[1 + 3 /* padding */];

/* 80C9CE94-80C9CE98 0001+03 r=0 e=0 z=0  None .bss       @1052                                                        */
u8 lit_1052[1 + 3 /* padding */];

/* 80C9CE98-80C9CE9C 0001+03 r=0 e=0 z=0  None .bss       @1014                                                        */
u8 lit_1014[1 + 3 /* padding */];

/* 80C9CE9C-80C9CEA0 0001+03 r=0 e=0 z=0  None .bss       @1012                                                        */
u8 lit_1012[1 + 3 /* padding */];

/* 80C9CEA0-80C9CEA4 0001+03 r=0 e=0 z=0  None .bss       @1010                                                        */
u8 lit_1010[1 + 3 /* padding */];

/* 80C9CEA4-80C9CEA8 0004+00 r=2 e=0 z=0  None .bss       None                                                         */
static u8 struct_80C9CEA4[4];

/* 80C9CEA8-80C9CEB4 000C+00 r=0 e=0 z=0  None .bss       @3858                                                        */
u8 lit_3858[12];

/* 80C9CEB4-80C9CEC8 0014+00 r=4 e=0 z=0  None .bss       l_HIO                                                        */
static u8 l_HIO[20];

/* 80C9CEC8-80C9CED4 000C+00 r=0 e=0 z=0  None .bss       @3958                                                        */
u8 lit_3958[12];

/* 80C9CED4-80C9CEE0 000C+00 r=1 e=0 z=0  None .bss       c_pos                                                        */
static u8 c_pos[12];

/* 80C9B60C-80C9B890 0284+00 r=1 e=0 z=0  None .text      msima_drop__FP15obj_msima_class                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9B890-80C9B8CC 003C+00 r=1 e=0 z=0  None .text      __dt__4cXyzFv                                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm cXyz::~cXyz() {
...
/* 80C9B8CC-80C9BA30 0164+00 r=1 e=0 z=0  None .text      msima_float__FP15obj_msima_class                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9BA30-80C9BEB0 0480+00 r=1 e=0 z=0  None .text      action__FP15obj_msima_class                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80C9CEE0-80C9CEEC 000C+00 r=0 e=0 z=0  None .bss       @4179                                                        */
u8 lit_4179[12];

/* 80C9CEEC-80C9CEF8 000C+00 r=0 e=0 z=0  None .bss       @4180                                                        */
u8 lit_4180[12];

/* 80C9CEF8-80C9CF04 000C+00 r=0 e=0 z=0  None .bss       @4181                                                        */
u8 lit_4181[12];

/* 80C9CF04-80C9CF10 000C+00 r=0 e=0 z=0  None .bss       @4182                                                        */
u8 lit_4182[12];

/* 80C9CF10-80C9CF40 0030+00 r=1 e=0 z=0  None .bss       chain_p                                                      */
static u8 chain_p[48];

/* 80C9BEB0-80C9C00C 015C+00 r=1 e=0 z=0  None .text      chain_move__FP15obj_msima_classP10ms_chain_si                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80C9CF40-80C9CF4C 000C+00 r=0 e=0 z=0  None .bss       @4218                                                        */
u8 lit_4218[12];

/* 80C9CF4C-80C9CF58 000C+00 r=0 e=0 z=0  None .bss       @4219                                                        */
u8 lit_4219[12];

/* 80C9CF58-80C9CF64 000C+00 r=0 e=0 z=0  None .bss       @4220                                                        */
u8 lit_4220[12];

/* 80C9CF64-80C9CF70 000C+00 r=0 e=0 z=0  None .bss       @4221                                                        */
u8 lit_4221[12];

/* 80C9CF70-80C9CFA0 0030+00 r=1 e=0 z=0  None .bss       chain_p2                                                     */
static u8 chain_p2[48];

/* 80C9C00C-80C9C25C 0250+00 r=1 e=0 z=0  None .text      chain_move2__FP15obj_msima_classP10ms_chain_si               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9C25C-80C9C3A8 014C+00 r=2 e=0 z=0  None .text      daObj_Msima_Execute__FP15obj_msima_class                     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9C3A8-80C9C3B0 0008+00 r=1 e=0 z=0  None .text      daObj_Msima_IsDelete__FP15obj_msima_class                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80C9CD54-80C9CD58 0004+00 r=0 e=0 z=0  None .rodata    @4013                                                        */
SECTION_RODATA u32 const lit_4013 = 0x43960000;

/* 80C9CD58-80C9CD5C 0004+00 r=0 e=0 z=0  None .rodata    @4014                                                        */
SECTION_RODATA u32 const lit_4014 = 0x3DCCCCCD;

/* 80C9CD5C-80C9CD60 0004+00 r=0 e=0 z=0  None .rodata    @4015                                                        */
SECTION_RODATA u32 const lit_4015 = 0x41F00000;

/* 80C9CD60-80C9CD64 0004+00 r=0 e=0 z=0  None .rodata    @4016                                                        */
SECTION_RODATA u32 const lit_4016 = 0x40A00000;

/* 80C9CD64-80C9CD68 0004+00 r=0 e=0 z=0  None .rodata    @4017                                                        */
SECTION_RODATA u32 const lit_4017 = 0xC2A00000;

/* 80C9CD68-80C9CD6C 0004+00 r=0 e=0 z=0  None .rodata    @4018                                                        */
SECTION_RODATA u32 const lit_4018 = 0x44FA0000;

/* 80C9CD6C-80C9CD70 0004+00 r=0 e=0 z=0  None .rodata    @4019                                                        */
SECTION_RODATA u8 const lit_4019[4] = {
	0x00, 0x00, 0x00, 0x00,
};

/* 80C9CD70-80C9CD74 0004+00 r=0 e=0 z=0  None .rodata    @4020                                                        */
SECTION_RODATA u32 const lit_4020 = 0xBF800000;

/* 80C9CD74-80C9CD78 0004+00 r=0 e=0 z=0  None .rodata    @4043                                                        */
SECTION_RODATA u32 const lit_4043 = 0x3B83126F;

/* 80C9CD78-80C9CD7C 0004+00 r=0 e=0 z=0  None .rodata    @4044                                                        */
SECTION_RODATA u32 const lit_4044 = 0x3E4CCCCD;

/* 80C9CD7C-80C9CD80 0004+00 r=0 e=0 z=0  None .rodata    @4045                                                        */
SECTION_RODATA u32 const lit_4045 = 0x41A00000;

/* 80C9CD80-80C9CD84 0004+00 r=0 e=0 z=0  None .rodata    @4046                                                        */
SECTION_RODATA u32 const lit_4046 = 0xC1A00000;

/* 80C9CD84-80C9CD88 0004+00 r=0 e=0 z=0  None .rodata    @4168                                                        */
SECTION_RODATA u32 const lit_4168 = 0xC1F00000;

/* 80C9CD88-80C9CD8C 0004+00 r=0 e=0 z=0  None .rodata    @4169                                                        */
SECTION_RODATA u32 const lit_4169 = 0x41700000;

/* 80C9CD8C-80C9CD90 0004+00 r=0 e=0 z=0  None .rodata    @4170                                                        */
SECTION_RODATA u32 const lit_4170 = 0xC2480000;

/* 80C9CD90-80C9CD94 0004+00 r=0 e=0 z=0  None .rodata    @4171                                                        */
SECTION_RODATA u32 const lit_4171 = 0x3F000000;

/* 80C9CD94-80C9CD98 0004+00 r=0 e=0 z=0  None .rodata    @4172                                                        */
SECTION_RODATA u32 const lit_4172 = 0x43C80000;

/* 80C9CD98-80C9CD9C 0004+00 r=0 e=0 z=0  None .rodata    @4173                                                        */
SECTION_RODATA u32 const lit_4173 = 0x3FC00000;

/* 80C9CD9C-80C9CDA4 0004+04 r=0 e=0 z=0  None .rodata    @4174                                                        */
...
/* 80C9CDA4-80C9CDAC 0008+00 r=0 e=0 z=0  None .rodata    @4177                                                        */
SECTION_RODATA u8 const lit_4177[8] = {
	0x43, 0x30, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00,
};

/* 80C9CDAC-80C9CDB0 0004+00 r=0 e=0 z=0  None .rodata    @4214                                                        */
SECTION_RODATA u32 const lit_4214 = 0x453B8000;

/* 80C9CDB0-80C9CDB4 0004+00 r=0 e=0 z=0  None .rodata    @4215                                                        */
SECTION_RODATA u32 const lit_4215 = 0x403CCCCD;

/* 80C9CDB4-80C9CDB8 0004+00 r=0 e=0 z=0  None .rodata    @4216                                                        */
SECTION_RODATA u32 const lit_4216 = 0x425C0000;

/* 80C9CDB8-80C9CDBC 0004+00 r=0 e=0 z=0  None .rodata    @4265                                                        */
SECTION_RODATA u32 const lit_4265 = 0x437A0000;

/* 80C9CDBC-80C9CDC0 0004+00 r=0 e=0 z=0  None .rodata    @4266                                                        */
SECTION_RODATA u32 const lit_4266 = 0x3F4CCCCD;

/* 80C9CDC0-80C9CDC4 0004+00 r=0 e=0 z=0  None .rodata    @4267                                                        */
SECTION_RODATA u32 const lit_4267 = 0x3E99999A;

/* 80C9CDC4-80C9CDC8 0004+00 r=0 e=0 z=0  None .rodata    @4268                                                        */
SECTION_RODATA u32 const lit_4268 = 0xC25C0000;

/* 80C9CDC8-80C9CDCC 0004+00 r=0 e=0 z=0  None .rodata    @4269                                                        */
SECTION_RODATA u32 const lit_4269 = 0x3CF5C28F;

/* 80C9CDCC-80C9CDD0 0004+00 r=1 e=0 z=0  None .rodata    @4412                                                        */
SECTION_RODATA static u32 const lit_4412 = 0x47800000;

/* 80C9CDD0-80C9CDD4 0004+00 r=0 e=0 z=0  None .rodata    @4524                                                        */
SECTION_RODATA u32 const lit_4524 = 0x448FC000;

/* 80C9CDD4-80C9CDD8 0004+00 r=0 e=0 z=0  None .rodata    @4525                                                        */
SECTION_RODATA u32 const lit_4525 = 0x44484000;

/* 80C9CDD8-80C9CDDC 0004+00 r=0 e=0 z=0  None .rodata    @4526                                                        */
SECTION_RODATA u32 const lit_4526 = 0x44ED8000;

/* 80C9CDDC-80C9CDE0 0004+00 r=0 e=0 z=0  None .rodata    @4602                                                        */
SECTION_RODATA u32 const lit_4602 = 0x43480000;

/* 80C9CDE0-80C9CDE4 0004+00 r=0 e=0 z=0  None .rodata    @4603                                                        */
SECTION_RODATA u32 const lit_4603 = 0x44898000;

/* 80C9CDE4-80C9CDE8 0004+00 r=0 e=0 z=0  None .rodata    @4604                                                        */
SECTION_RODATA u32 const lit_4604 = 0xC4898000;

/* 80C9CDE8-80C9CDEC 0004+00 r=0 e=0 z=0  None .rodata    @4605                                                        */
SECTION_RODATA u32 const lit_4605 = 0x457A0000;

/* 80C9CDEC-80C9CDF6 000A+00 r=3 e=0 z=0  None .rodata    @stringBase0                                                 */
#pragma push
...
/* 80C9C3B0-80C9C42C 007C+00 r=1 e=0 z=0  None .text      daObj_Msima_Delete__FP15obj_msima_class                      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9C42C-80C9C720 02F4+00 r=1 e=0 z=0  None .text      useHeapInit__FP10fopAc_ac_c                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9C720-80C9C768 0048+00 r=1 e=0 z=0  None .text      __dt__12J3DFrameCtrlFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9C768-80C9CA60 02F8+00 r=1 e=0 z=0  None .text      daObj_Msima_Create__FP10fopAc_ac_c                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9CA60-80C9CA9C 003C+00 r=1 e=0 z=0  None .text      __dt__10ms_chain_sFv                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C9CA9C-80C9CAA0 0004+00 r=1 e=0 z=0  None .text      __ct__10ms_chain_sFv                                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm ms_chain_s::ms_chain_s() {
...
/* 80C9CAA0-80C9CAE8 0048+00 r=2 e=0 z=0  None .text      __dt__17daObj_Msima_HIO_cFv                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm daObj_Msima_HIO_c::~daObj_Msima_HIO_c() {
...
/* 80C9CAE8-80C9CD38 0250+00 r=1 e=1 z=0  None .text      __sinit_d_a_obj_msima_cpp                                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80C9CFA0-80C9CFA4 0004+00 r=0 e=0 z=0  None .bss       sInstance__40JASGlobalInstance<19JASDefaultBankTable>        */
u8 data_80C9CFA0[4];

/* 80C9CFA4-80C9CFA8 0004+00 r=0 e=0 z=0  None .bss       sInstance__35JASGlobalInstance<14JASAudioThread>             */
u8 data_80C9CFA4[4];

/* 80C9CFA8-80C9CFAC 0004+00 r=0 e=0 z=0  None .bss       sInstance__27JASGlobalInstance<7Z2SeMgr>                     */
u8 data_80C9CFA8[4];

/* 80C9CFAC-80C9CFB0 0004+00 r=0 e=0 z=0  None .bss       sInstance__28JASGlobalInstance<8Z2SeqMgr>                    */
u8 data_80C9CFAC[4];

/* 80C9CFB0-80C9CFB4 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2SceneMgr>                 */
u8 data_80C9CFB0[4];

/* 80C9CFB4-80C9CFB8 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2StatusMgr>                */
u8 data_80C9CFB4[4];

/* 80C9CFB8-80C9CFBC 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2DebugSys>                 */
u8 data_80C9CFB8[4];

/* 80C9CFBC-80C9CFC0 0004+00 r=0 e=0 z=0  None .bss       sInstance__36JASGlobalInstance<15JAISoundStarter>            */
u8 data_80C9CFBC[4];

/* 80C9CFC0-80C9CFC4 0004+00 r=0 e=0 z=0  None .bss       sInstance__35JASGlobalInstance<14Z2SoundStarter>             */
u8 data_80C9CFC0[4];

/* 80C9CFC4-80C9CFC8 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12Z2SpeechMgr2>               */
u8 data_80C9CFC4[4];

/* 80C9CFC8-80C9CFCC 0004+00 r=0 e=0 z=0  None .bss       sInstance__28JASGlobalInstance<8JAISeMgr>                    */
u8 data_80C9CFC8[4];

/* 80C9CFCC-80C9CFD0 0004+00 r=0 e=0 z=0  None .bss       sInstance__29JASGlobalInstance<9JAISeqMgr>                   */
u8 data_80C9CFCC[4];

/* 80C9CFD0-80C9CFD4 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAIStreamMgr>               */
u8 data_80C9CFD0[4];

/* 80C9CFD4-80C9CFD8 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2SoundMgr>                 */
u8 data_80C9CFD4[4];

/* 80C9CFD8-80C9CFDC 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAISoundInfo>               */
u8 data_80C9CFD8[4];

/* 80C9CFDC-80C9CFE0 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13JAUSoundTable>              */
u8 data_80C9CFDC[4];

/* 80C9CFE0-80C9CFE4 0004+00 r=0 e=0 z=0  None .bss       sInstance__38JASGlobalInstance<17JAUSoundNameTable>          */
u8 data_80C9CFE0[4];

/* 80C9CFE4-80C9CFE8 0004+00 r=0 e=0 z=0  None .bss       sInstance__33JASGlobalInstance<12JAUSoundInfo>               */
u8 data_80C9CFE4[4];

/* 80C9CFE8-80C9CFEC 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2SoundInfo>                */
u8 data_80C9CFE8[4];

/* 80C9CFEC-80C9CFF0 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13Z2SoundObjMgr>              */
u8 data_80C9CFEC[4];

/* 80C9CFF0-80C9CFF4 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2Audience>                 */
u8 data_80C9CFF0[4];

/* 80C9CFF4-80C9CFF8 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2FxLineMgr>                */
u8 data_80C9CFF4[4];

/* 80C9CFF8-80C9CFFC 0004+00 r=0 e=0 z=0  None .bss       sInstance__31JASGlobalInstance<10Z2EnvSeMgr>                 */
u8 data_80C9CFF8[4];

/* 80C9CFFC-80C9D000 0004+00 r=0 e=0 z=0  None .bss       sInstance__32JASGlobalInstance<11Z2SpeechMgr>                */
u8 data_80C9CFFC[4];

/* 80C9D000-80C9D004 0004+00 r=0 e=0 z=0  None .bss       sInstance__34JASGlobalInstance<13Z2WolfHowlMgr>              */
u8 data_80C9D000[4];

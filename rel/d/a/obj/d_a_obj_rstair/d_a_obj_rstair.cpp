...
static void daObjRotStair_create1st(daObjRotStair_c*); // 2
static void daObjRotStair_MoveBGDelete(daObjRotStair_c*); // 2
static void daObjRotStair_MoveBGExecute(daObjRotStair_c*); // 2
static void daObjRotStair_MoveBGDraw(daObjRotStair_c*); // 2
...
extern "C" static void daObjRotStair_create1st__FP15daObjRotStair_c(); // 1
extern "C" static void daObjRotStair_MoveBGDelete__FP15daObjRotStair_c(); // 1
extern "C" static void daObjRotStair_MoveBGExecute__FP15daObjRotStair_c(); // 1
extern "C" static void daObjRotStair_MoveBGDraw__FP15daObjRotStair_c(); // 1
...
/* 80CC1558-80CC1614 00BC+00 r=1 e=0 z=0  None .text      initBaseMtx__15daObjRotStair_cFv                             */
#pragma push
...
/* 80CC1614-80CC16B0 009C+00 r=2 e=0 z=0  None .text      setBaseMtx__15daObjRotStair_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80CC2700-80CC2708 0008+00 r=3 e=0 z=0  None .rodata    l_wtr_bmd                                                    */
SECTION_RODATA static u8 const l_wtr_bmd[8] = {
	0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x07,
};

/* 80CC2708-80CC2710 0008+00 r=0 e=0 z=0  None .rodata    l_wtr_btk                                                    */
SECTION_RODATA u8 const l_wtr_btk[8] = {
	0x00, 0x00, 0x00, 0x0A, 0x00, 0x00, 0x00, 0x0B,
};

/* 80CC2710-80CC2720 0010+00 r=2 e=0 z=0  None .rodata    l_target_angleY                                              */
...
/* 80CC16B0-80CC17F0 0140+00 r=1 e=0 z=0  None .text      Create__15daObjRotStair_cFv                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80CC2720-80CC2724 0004+00 r=0 e=0 z=0  None .rodata    @3770                                                        */
SECTION_RODATA u32 const lit_3770 = 0x3F800000;

/* 80CC2724-80CC2728 0004+00 r=0 e=0 z=0  None .rodata    @3911                                                        */
SECTION_RODATA u8 const lit_3911[4] = {
	0x00, 0x00, 0x00, 0x00,
};

/* 80CC2728-80CC272C 0004+00 r=0 e=0 z=0  None .rodata    @3912                                                        */
SECTION_RODATA u32 const lit_3912 = 0xBF800000;

/* 80CC272C-80CC2730 0004+00 r=0 e=0 z=0  None .rodata    @4107                                                        */
SECTION_RODATA u32 const lit_4107 = 0xBC23D70A;

/* 80CC2730-80CC273A 000A+00 r=1 e=0 z=0  None .rodata    @stringBase0                                                 */
#pragma push
...
/* 80CC273C-80CC2748 000C+00 r=2 e=0 z=0  None .data      cNullVec__6Z2Calc                                            */
SECTION_DATA static u8 cNullVec__6Z2Calc[12] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 80CC2748-80CC275C 0004+10 r=0 e=0 z=0  None .data      @1787                                                        */
...
/* 80CC275C-80CC2760 0004+00 r=3 e=0 z=0  None .data      l_arcName                                                    */
SECTION_DATA static void* l_arcName = (void*)&stringBase0;

/* 80CC2760-80CC276C 000C+00 r=0 e=0 z=0  None .data      l_water_check_offset                                         */
SECTION_DATA u8 l_water_check_offset[12] = {
	0x00, 0x00, 0x00, 0x00, 0x44, 0xFA, 0x00, 0x00, 0xC4, 0xFA, 0x00, 0x00,
};

/* 80CC276C-80CC2778 000C+00 r=0 e=0 z=0  None .data      @3811                                                        */
SECTION_DATA void* lit_3811[3] = {
	/* 0    */ (void*)NULL,
	/* 1    */ (void*)0xFFFFFFFF,
	/* 2    */ (void*)modeWait__15daObjRotStair_cFv,
};

/* 80CC2778-80CC2784 000C+00 r=0 e=0 z=0  None .data      @3812                                                        */
SECTION_DATA void* lit_3812[3] = {
	/* 0    */ (void*)NULL,
	/* 1    */ (void*)0xFFFFFFFF,
	/* 2    */ (void*)modeRotate__15daObjRotStair_cFv,
};

/* 80CC2784-80CC279C 0018+00 r=0 e=0 z=0  None .data      l_func$3810                                                  */
SECTION_DATA u8 data_80CC2784[24] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 80CC279C-80CC27A8 000C+00 r=0 e=0 z=0  None .data      @3919                                                        */
SECTION_DATA void* lit_3919[3] = {
	/* 0    */ (void*)NULL,
	/* 1    */ (void*)0xFFFFFFFF,
	/* 2    */ (void*)actionWait__15daObjRotStair_cFv,
};

/* 80CC27A8-80CC27B4 000C+00 r=0 e=0 z=0  None .data      @3920                                                        */
SECTION_DATA void* lit_3920[3] = {
	/* 0    */ (void*)NULL,
	/* 1    */ (void*)0xFFFFFFFF,
	/* 2    */ (void*)actionOrderEvent__15daObjRotStair_cFv,
};

/* 80CC27B4-80CC27C0 000C+00 r=0 e=0 z=0  None .data      @3921                                                        */
SECTION_DATA void* lit_3921[3] = {
	/* 0    */ (void*)NULL,
	/* 1    */ (void*)0xFFFFFFFF,
	/* 2    */ (void*)actionEvent__15daObjRotStair_cFv,
};

/* 80CC27C0-80CC27CC 000C+00 r=0 e=0 z=0  None .data      @3922                                                        */
SECTION_DATA void* lit_3922[3] = {
	/* 0    */ (void*)NULL,
	/* 1    */ (void*)0xFFFFFFFF,
	/* 2    */ (void*)actionDead__15daObjRotStair_cFv,
};

/* 80CC27CC-80CC27FC 0030+00 r=0 e=0 z=0  None .data      l_func$3918                                                  */
...
/* 80CC27FC-80CC281C 0020+00 r=1 e=0 z=0  None .data      daObjRotStair_METHODS                                        */
SECTION_DATA static void* daObjRotStair_METHODS[8] = {
	/* 0    */ (void*)daObjRotStair_create1st__FP15daObjRotStair_c,
	/* 1    */ (void*)daObjRotStair_MoveBGDelete__FP15daObjRotStair_c,
	/* 2    */ (void*)daObjRotStair_MoveBGExecute__FP15daObjRotStair_c,
	/* 3    */ (void*)NULL,
	/* 4    */ (void*)daObjRotStair_MoveBGDraw__FP15daObjRotStair_c,
	/* 5    */ (void*)NULL,
	/* 6    */ (void*)NULL,
	/* 7    */ (void*)NULL,
};

/* 80CC281C-80CC284C 0030+00 r=1 e=0 z=1  None .data      g_profile_Obj_RotStair                                       */
SECTION_DATA void* g_profile_Obj_RotStair[12] = {
	...
	/* 8    */ (void*)0x02650000,
	/* 9    */ (void*)&daObjRotStair_METHODS,
	/* 10   */ (void*)0x00040100,
	/* 11   */ (void*)0x000E0000,
};

/* 80CC284C-80CC2858 000C+00 r=2 e=0 z=0  None .data      __vt__12J3DFrameCtrl                                         */
...
/* 80CC17F0-80CC19E0 01F0+00 r=1 e=0 z=0  None .text      CreateHeap__15daObjRotStair_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC19E0-80CC1A28 0048+00 r=1 e=0 z=0  None .text      __dt__12J3DFrameCtrlFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1A28-80CC1AF0 00C8+00 r=1 e=0 z=0  None .text      create1st__15daObjRotStair_cFv                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1AF0-80CC1BA4 00B4+00 r=1 e=0 z=0  None .text      Execute__15daObjRotStair_cFPPA3_A4_f                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1BA4-80CC1C30 008C+00 r=1 e=0 z=0  None .text      move_proc_call__15daObjRotStair_cFv                          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1C30-80CC1CF0 00C0+00 r=2 e=0 z=0  None .text      init_modeWait__15daObjRotStair_cFv                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1CF0-80CC1DF8 0108+00 r=1 e=0 z=0  None .text      modeWait__15daObjRotStair_cFv                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1DF8-80CC1EC8 00D0+00 r=1 e=0 z=0  None .text      init_modeRotate__15daObjRotStair_cFv                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC1EC8-80CC2024 015C+00 r=1 e=0 z=0  None .text      modeRotate__15daObjRotStair_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC2024-80CC20E0 00BC+00 r=1 e=0 z=0  None .text      event_proc_call__15daObjRotStair_cFv                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC20E0-80CC2158 0078+00 r=1 e=0 z=0  None .text      actionWait__15daObjRotStair_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC2158-80CC21C0 0068+00 r=1 e=0 z=0  None .text      actionOrderEvent__15daObjRotStair_cFv                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC21C0-80CC221C 005C+00 r=1 e=0 z=0  None .text      actionEvent__15daObjRotStair_cFv                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC221C-80CC2220 0004+00 r=1 e=0 z=0  None .text      actionDead__15daObjRotStair_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC2220-80CC22A0 0080+00 r=1 e=0 z=0  None .text      checkChangeSw__15daObjRotStair_cFv                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC22A0-80CC2310 0070+00 r=1 e=0 z=0  None .text      offSwitch__15daObjRotStair_cFi                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC2310-80CC2364 0054+00 r=3 e=0 z=0  None .text      onWaterModel__15daObjRotStair_cFv                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC2364-80CC23C4 0060+00 r=3 e=0 z=0  None .text      offWaterModel__15daObjRotStair_cFv                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC23C4-80CC25C0 01FC+00 r=1 e=0 z=0  None .text      Draw__15daObjRotStair_cFv                                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC25C0-80CC262C 006C+00 r=1 e=0 z=0  None .text      Delete__15daObjRotStair_cFv                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80CC2858-80CC2880 0028+00 r=1 e=0 z=0  None .data      __vt__15daObjRotStair_c                                      */
SECTION_DATA static void* __vt__15daObjRotStair_c[10] = {
	/* 0    */ (void*)NULL /* RTTI */,
	/* 1    */ (void*)NULL,
	/* 2    */ (void*)CreateHeap__15daObjRotStair_cFv,
	/* 3    */ (void*)Create__15daObjRotStair_cFv,
	/* 4    */ (void*)Execute__15daObjRotStair_cFPPA3_A4_f,
	/* 5    */ (void*)Draw__15daObjRotStair_cFv,
	/* 6    */ (void*)Delete__15daObjRotStair_cFv,
	/* 7    */ (void*)IsDelete__16dBgS_MoveBgActorFv,
	/* 8    */ (void*)ToFore__16dBgS_MoveBgActorFv,
	/* 9    */ (void*)ToBack__16dBgS_MoveBgActorFv,
};

/* 80CC262C-80CC268C 0060+00 r=1 e=0 z=0  None .text      daObjRotStair_create1st__FP15daObjRotStair_c                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC268C-80CC26AC 0020+00 r=1 e=0 z=0  None .text      daObjRotStair_MoveBGDelete__FP15daObjRotStair_c              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC26AC-80CC26CC 0020+00 r=1 e=0 z=0  None .text      daObjRotStair_MoveBGExecute__FP15daObjRotStair_c             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80CC26CC-80CC26F8 002C+00 r=1 e=0 z=0  None .text      daObjRotStair_MoveBGDraw__FP15daObjRotStair_c                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off

...
/* ############################################################################################## */
/* 80C59E70-80C59EC4 0054+00 r=2 e=0 z=0  None .rodata    l_bmdIdx                                                     */
...
/* 80C59EC4-80C59F18 0054+00 r=1 e=0 z=0  None .rodata    l_dzbIdx                                                     */
...
/* 80C59F18-80C59F6C 0054+00 r=0 e=0 z=0  None .rodata    l_btkIdx                                                     */
...
/* 80C59F6C-80C59FC0 0054+00 r=0 e=0 z=0  None .rodata    l_bmdIdrIdx                                                  */
...
/* 80C59FC0-80C5A014 0054+00 r=0 e=0 z=0  None .rodata    l_btkIdrIdx                                                  */
...
/* 80C5A014-80C5A018 0004+00 r=3 e=0 z=0  None .rodata    @3737                                                        */
SECTION_RODATA static u32 const lit_3737 = 0x3F800000;

/* 80C5A018-80C5A048 002A+06 r=1 e=0 z=0  None .rodata    estimateSizeTbl$3746                                         */
...
/* 80C5A048-80C5A050 0008+00 r=1 e=0 z=0  None .rodata    @3812                                                        */
SECTION_RODATA static u8 const lit_3812[8] = {
	0x43, 0x30, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00,
};

/* 80C5A050-80C5A058 0004+04 r=1 e=0 z=0  None .rodata    @4068                                                        */
...
/* 80C5A058-80C5A060 0008+00 r=1 e=0 z=0  None .rodata    @4080                                                        */
SECTION_RODATA static u8 const lit_4080[8] = {
	0x43, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 80C5A060-80C5A064 0004+00 r=0 e=0 z=0  None .rodata    @4173                                                        */
SECTION_RODATA u32 const lit_4173 = 0xBC23D70A;

/* 80C5A064-80C5A068 0004+00 r=0 e=0 z=0  None .rodata    @4174                                                        */
SECTION_RODATA u8 const lit_4174[4] = {
	0x00, 0x00, 0x00, 0x00,
};

/* 80C5A068-80C5A07C 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A07C-80C5A090 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A090-80C5A0A4 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A0A4-80C5A0B8 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A0B8-80C5A0CC 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A0CC-80C5A0E0 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A0E0-80C5A0F4 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A0F4-80C5A108 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A108-80C5A11C 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A11C-80C5A130 0014+00 r=1 e=0 z=0  None .rodata    None                                                         */
...
/* 80C5A130-80C5A13C 000C+00 r=1 e=0 z=0  None .rodata    None                                                         */
SECTION_RODATA static u8 const data_80C5A130[12] = {
	0x4B, 0x72, 0x30, 0x33, 0x77, 0x61, 0x74, 0x30, 0x36, 0x00, 0x00, 0x00,
};

/* 80C5A13C-80C5A148 000C+00 r=1 e=0 z=0  None .data      cNullVec__6Z2Calc                                            */
SECTION_DATA static u8 cNullVec__6Z2Calc[12] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 80C5A148-80C5A15C 0004+10 r=0 e=0 z=0  None .data      @1787                                                        */
...
/* 80C5A15C-80C5A1B0 0054+00 r=3 e=0 z=0  None .data      l_resNameIdx                                                 */
...
/* 80C5A1B0-80C5A1BC 000C+00 r=0 e=0 z=0  None .data      @3830                                                        */
...
/* 80C5A1BC-80C5A1C8 000C+00 r=0 e=0 z=0  None .data      @3831                                                        */
...
/* 80C5A1C8-80C5A1E0 0018+00 r=1 e=0 z=0  None .data      l_mode_func                                                  */
SECTION_DATA static u8 l_mode_func[24] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
};

/* 80C5A1E0-80C5A228 0048+00 r=1 e=0 z=0  None .data      @4043                                                        */
...
/* 80C5A228-80C5A248 0020+00 r=1 e=0 z=0  None .data      l_daLv3Water_Method                                          */
...
/* 80C5A248-80C5A278 0030+00 r=1 e=0 z=1  None .data      g_profile_Obj_Lv3Water                                       */
...
/* 80C5A278-80C5A284 000C+00 r=3 e=0 z=0  None .data      __vt__12J3DFrameCtrl                                         */
...
/* 80C5A284-80C5A29C 0018+00 r=3 e=0 z=0  None .data      __vt__17dEvLib_callback_c                                    */
...
/* 80C5A29C-80C5A2E4 0048+00 r=2 e=0 z=0  None .data      __vt__12daLv3Water_c                                         */
...
/* 80C5A2E4-80C5A2F0 000C+00 r=2 e=0 z=0  None .data      __vt__16daLv3Water_HIO_c                                     */
...
/* 80C5A2F0-80C5A2FC 000C+00 r=3 e=0 z=0  None .data      __vt__14mDoHIO_entry_c                                       */
...
/* 80C587CC-80C587F0 0024+00 r=1 e=0 z=0  None .text      __ct__16daLv3Water_HIO_cFv                                   */
#pragma push
...
/* 80C587F0-80C58838 0048+00 r=1 e=0 z=0  None .text      __dt__14mDoHIO_entry_cFv                                     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C58838-80C5891C 00E4+00 r=2 e=0 z=0  None .text      setBaseMtx__12daLv3Water_cFv                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C5891C-80C58ABC 01A0+00 r=1 e=0 z=0  None .text      CreateHeap__12daLv3Water_cFv                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C58ABC-80C58D20 0264+00 r=1 e=0 z=0  None .text      create__12daLv3Water_cFv                                     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C58D20-80C58D68 0048+00 r=1 e=0 z=0  None .text      __dt__12J3DFrameCtrlFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C58D68-80C58E20 00B8+00 r=1 e=0 z=0  None .text      Execute__12daLv3Water_cFPPA3_A4_f                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C58E20-80C596F4 08D4+00 r=2 e=0 z=0  None .text      effectSet__12daLv3Water_cFv                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C596F4-80C59754 0060+00 r=1 e=0 z=0  None .text      mode_proc_wait__12daLv3Water_cFv                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80C5A308-80C5A314 000C+00 r=1 e=0 z=0  None .bss       @3657                                                        */
static u8 lit_3657[12];

/* 80C5A314-80C5A31C 0008+00 r=2 e=0 z=0  None .bss       l_HIO                                                        */
static u8 l_HIO[8];

/* 80C59754-80C597FC 00A8+00 r=1 e=0 z=0  None .text      mode_init_levelCtrl__12daLv3Water_cFv                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C597FC-80C598BC 00C0+00 r=1 e=0 z=0  None .text      mode_proc_levelCtrl__12daLv3Water_cFv                        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C598BC-80C59AA0 01E4+00 r=1 e=0 z=0  None .text      Draw__12daLv3Water_cFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59AA0-80C59AE0 0040+00 r=1 e=0 z=0  None .text      Delete__12daLv3Water_cFv                                     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59AE0-80C59BA8 00C8+00 r=2 e=0 z=0  None .text      eventStart__12daLv3Water_cFv                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59BA8-80C59BD4 002C+00 r=1 e=0 z=0  None .text      daLv3Water_Draw__FP12daLv3Water_c                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59BD4-80C59BF4 0020+00 r=1 e=0 z=0  None .text      daLv3Water_Execute__FP12daLv3Water_c                         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59BF4-80C59C14 0020+00 r=1 e=0 z=0  None .text      daLv3Water_Delete__FP12daLv3Water_c                          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59C14-80C59C34 0020+00 r=1 e=0 z=0  None .text      daLv3Water_Create__FP10fopAc_ac_c                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59C34-80C59C90 005C+00 r=2 e=0 z=0  None .text      __dt__16daLv3Water_HIO_cFv                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm daLv3Water_HIO_c::~daLv3Water_HIO_c() {
...
/* 80C59C90-80C59D10 0080+00 r=1 e=1 z=0  None .text      __sinit_d_a_obj_lv3Water_cpp                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D10-80C59D18 0008+00 r=1 e=0 z=0  None .text      @1448@eventStart__12daLv3Water_cFv                           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D18-80C59D20 0008+00 r=1 e=0 z=0  None .text      @1448@__dt__12daLv3Water_cFv                                 */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D20-80C59D68 0048+00 r=1 e=0 z=0  None .text      __dt__17dEvLib_callback_cFv                                  */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D68-80C59D70 0008+00 r=1 e=0 z=0  None .text      eventStart__17dEvLib_callback_cFv                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D70-80C59D78 0008+00 r=2 e=0 z=0  None .text      eventRun__17dEvLib_callback_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D78-80C59D80 0008+00 r=2 e=0 z=0  None .text      eventEnd__17dEvLib_callback_cFv                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 80C59D80-80C59E5C 00DC+00 r=2 e=0 z=0  None .text      __dt__12daLv3Water_cFv                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off

...
extern const u8 pad_805B3138[8];
...
__declspec(section ".dtors$10") const void* const __destroy_global_chain_reference = (void*)__global_destructor_chain;
...
asm void __register_global_object() {
	nofralloc
#include "asm/rel/d_a_b_bh/libs/Runtime.PPCEABI.H/global_destructor_chain/__register_global_object.s"
}
#pragma pop
...
asm void __destroy_global_chain() {
	nofralloc
#include "asm/rel/d_a_b_bh/libs/Runtime.PPCEABI.H/global_destructor_chain/__destroy_global_chain.s"
}
#pragma pop

...
# Symbols
SYMBOLS = [
	{'addr':0x80C45260,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C4528C,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C452B8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':10,'type':"ASMFunction"},
	{'addr':0x80C452D8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80C452F4,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C4534C,'size':64,'pad':0,'label':"__ct__16daObj_Kita_HIO_cFv",'name':"__ct__16daObj_Kita_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80C4538C,'size':152,'pad':0,'label':"daObj_Kita_Draw__FP14obj_kita_class",'name':"daObj_Kita_Draw__FP14obj_kita_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45424,'size':12,'pad':0,'label':"ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c",'name':"ride_call_back__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45430,'size':1192,'pad':0,'label':"ita_control__FP14obj_kita_class",'name':"ita_control__FP14obj_kita_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80C458D8,'size':312,'pad':0,'label':"action__FP14obj_kita_class",'name':"action__FP14obj_kita_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80C45A10,'size':92,'pad':0,'label':"daObj_Kita_Execute__FP14obj_kita_class",'name':"daObj_Kita_Execute__FP14obj_kita_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80C45A6C,'size':8,'pad':0,'label':"daObj_Kita_IsDelete__FP14obj_kita_class",'name':"daObj_Kita_IsDelete__FP14obj_kita_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x80C45A74,'size':156,'pad':0,'label':"daObj_Kita_Delete__FP14obj_kita_class",'name':"daObj_Kita_Delete__FP14obj_kita_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45B10,'size':316,'pad':0,'label':"useHeapInit__FP10fopAc_ac_c",'name':"useHeapInit__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45C4C,'size':504,'pad':0,'label':"daObj_Kita_Create__FP10fopAc_ac_c",'name':"daObj_Kita_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45E44,'size':60,'pad':0,'label':"__dt__6kita_sFv",'name':"__dt__6kita_sFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45E80,'size':4,'pad':0,'label':"__ct__6kita_sFv",'name':"__ct__6kita_sFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x80C45E84,'size':72,'pad':0,'label':"__dt__16daObj_Kita_HIO_cFv",'name':"__dt__16daObj_Kita_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80C45ECC,'size':60,'pad':0,'label':"__sinit_d_a_obj_kita_cpp",'name':"__sinit_d_a_obj_kita_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},

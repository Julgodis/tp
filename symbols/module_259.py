...
# Symbols
SYMBOLS = [
	{'addr':0x80832FC0,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80832FEC,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80833018,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':25,'type':"ASMFunction"},
	{'addr':0x80833038,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80833054,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x808330AC,'size':48,'pad':0,'label':"__ct__12daE_ZS_HIO_cFv",'name':"__ct__12daE_ZS_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x808330DC,'size':232,'pad':0,'label':"draw__8daE_ZS_cFv",'name':"draw__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x808331C4,'size':32,'pad':0,'label':"daE_ZS_Draw__FP8daE_ZS_c",'name':"daE_ZS_Draw__FP8daE_ZS_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x808331E4,'size':172,'pad':0,'label':"setBck__8daE_ZS_cFiUcff",'name':"setBck__8daE_ZS_cFiUcff",'lib':-1,'tu':3,'section':0,'rc':4,'type':"ASMFunction"},
	{'addr':0x80833290,'size':12,'pad':0,'label':"setActionMode__8daE_ZS_cFii",'name':"setActionMode__8daE_ZS_cFii",'lib':-1,'tu':3,'section':0,'rc':7,'type':"ASMFunction"},
	{'addr':0x8083329C,'size':944,'pad':0,'label':"damage_check__8daE_ZS_cFv",'name':"damage_check__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x8083364C,'size':76,'pad':0,'label':"s_BossSearch__FPvPv",'name':"s_BossSearch__FPvPv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80833698,'size':716,'pad':0,'label':"mBossHandCheck__8daE_ZS_cFv",'name':"mBossHandCheck__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"ASMFunction"},
	{'addr':0x80833964,'size':972,'pad':0,'label':"executeAppear__8daE_ZS_cFv",'name':"executeAppear__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80833D30,'size':492,'pad':0,'label':"executeWait__8daE_ZS_cFv",'name':"executeWait__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80833F1C,'size':492,'pad':0,'label':"executeDamage__8daE_ZS_cFv",'name':"executeDamage__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834108,'size':448,'pad':0,'label':"executeDrive__8daE_ZS_cFv",'name':"executeDrive__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x808342C8,'size':432,'pad':0,'label':"action__8daE_ZS_cFv",'name':"action__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834478,'size':160,'pad':0,'label':"mtx_set__8daE_ZS_cFv",'name':"mtx_set__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834518,'size':312,'pad':0,'label':"cc_set__8daE_ZS_cFv",'name':"cc_set__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834650,'size':108,'pad':0,'label':"execute__8daE_ZS_cFv",'name':"execute__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x808346BC,'size':32,'pad':0,'label':"daE_ZS_Execute__FP8daE_ZS_c",'name':"daE_ZS_Execute__FP8daE_ZS_c",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x808346DC,'size':8,'pad':0,'label':"daE_ZS_IsDelete__FP8daE_ZS_c",'name':"daE_ZS_IsDelete__FP8daE_ZS_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x808346E4,'size':116,'pad':0,'label':"_delete__8daE_ZS_cFv",'name':"_delete__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834758,'size':32,'pad':0,'label':"daE_ZS_Delete__FP8daE_ZS_c",'name':"daE_ZS_Delete__FP8daE_ZS_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834778,'size':236,'pad':0,'label':"CreateHeap__8daE_ZS_cFv",'name':"CreateHeap__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834864,'size':32,'pad':0,'label':"useHeapInit__FP10fopAc_ac_c",'name':"useHeapInit__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834884,'size':804,'pad':0,'label':"create__8daE_ZS_cFv",'name':"create__8daE_ZS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80834BA8,'size':72,'pad':0,'label':"__dt__8cM3dGCylFv",'name':"__dt__8cM3dGCylFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834BF0,'size':72,'pad':0,'label':"__dt__8cM3dGAabFv",'name':"__dt__8cM3dGAabFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834C38,'size':92,'pad':0,'label':"__dt__10dCcD_GSttsFv",'name':"__dt__10dCcD_GSttsFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834C94,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"ASMFunction"},
	{'addr':0x80834D04,'size':112,'pad':0,'label':"__dt__12dBgS_AcchCirFv",'name':"__dt__12dBgS_AcchCirFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834D74,'size':32,'pad':0,'label':"daE_ZS_Create__FP8daE_ZS_c",'name':"daE_ZS_Create__FP8daE_ZS_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834D94,'size':72,'pad':0,'label':"__dt__10cCcD_GSttsFv",'name':"__dt__10cCcD_GSttsFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834DDC,'size':72,'pad':0,'label':"__dt__12daE_ZS_HIO_cFv",'name':"__dt__12daE_ZS_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834E24,'size':60,'pad':0,'label':"__sinit_d_a_e_zs_cpp",'name':"__sinit_d_a_e_zs_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834E60,'size':8,'pad':0,'label':"func_80834E60",'name':"@36@__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834E68,'size':8,'pad':0,'label':"func_80834E68",'name':"@20@__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80834E70,'size':1044,'pad':0,'label':"setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz",'name':"setMidnaBindEffect__FP13fopEn_enemy_cP15Z2CreatureEnemyP4cXyzP4cXyz",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80835284,'size':28,'pad':0,'label':"getHandPosR__8daB_DS_cFv",'name':"getHandPosR__8daB_DS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x808352A0,'size':28,'pad':0,'label':"getHandPosL__8daB_DS_cFv",'name':"getHandPosL__8daB_DS_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},

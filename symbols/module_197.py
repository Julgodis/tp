...
# Symbols
SYMBOLS = [
	{'addr':0x806DF380,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DF3AC,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DF3D8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':11,'type':"ASMFunction"},
	{'addr':0x806DF3F8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x806DF414,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DF46C,'size':72,'pad':0,'label':"__ct__12daE_GS_HIO_cFv",'name':"__ct__12daE_GS_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x806DF4B4,'size':172,'pad':0,'label':"anm_init__FP10e_gs_classifUcf",'name':"anm_init__FP10e_gs_classifUcf",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x806DF560,'size':256,'pad':0,'label':"daE_GS_Draw__FP10e_gs_class",'name':"daE_GS_Draw__FP10e_gs_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DF660,'size':364,'pad':0,'label':"e_gs_wait__FP10e_gs_class",'name':"e_gs_wait__FP10e_gs_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x806DF7CC,'size':168,'pad':0,'label':"action__FP10e_gs_class",'name':"action__FP10e_gs_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x806DF874,'size':468,'pad':0,'label':"daE_GS_Execute__FP10e_gs_class",'name':"daE_GS_Execute__FP10e_gs_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x806DFA48,'size':8,'pad':0,'label':"daE_GS_IsDelete__FP10e_gs_class",'name':"daE_GS_IsDelete__FP10e_gs_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x806DFA50,'size':104,'pad':0,'label':"daE_GS_Delete__FP10e_gs_class",'name':"daE_GS_Delete__FP10e_gs_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DFAB8,'size':328,'pad':0,'label':"useHeapInit__FP10fopAc_ac_c",'name':"useHeapInit__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DFC00,'size':348,'pad':0,'label':"daE_GS_Create__FP10fopAc_ac_c",'name':"daE_GS_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DFD5C,'size':72,'pad':0,'label':"__dt__12daE_GS_HIO_cFv",'name':"__dt__12daE_GS_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x806DFDA4,'size':60,'pad':0,'label':"__sinit_d_a_e_gs_cpp",'name':"__sinit_d_a_e_gs_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},

...
# Symbols
SYMBOLS = [
	{'addr':0x80CAF240,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF26C,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF298,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':24,'type':"ASMFunction"},
	{'addr':0x80CAF2B8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CAF2D4,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF32C,'size':132,'pad':0,'label':"__ct__14daPillar_HIO_cFv",'name':"__ct__14daPillar_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CAF3B0,'size':72,'pad':0,'label':"__dt__14mDoHIO_entry_cFv",'name':"__dt__14mDoHIO_entry_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF3F8,'size':188,'pad':0,'label':"rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c",'name':"rideCallBack__FP4dBgWP10fopAc_ac_cP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF4B4,'size':312,'pad':0,'label':"setBaseMtx__10daPillar_cFv",'name':"setBaseMtx__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"ASMFunction"},
	{'addr':0x80CAF5EC,'size':444,'pad':0,'label':"Create__10daPillar_cFv",'name':"Create__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF7A8,'size':252,'pad':0,'label':"CreateHeap__10daPillar_cFv",'name':"CreateHeap__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAF8A4,'size':436,'pad':0,'label':"create1st__10daPillar_cFv",'name':"create1st__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CAFA58,'size':72,'pad':0,'label':"__dt__8cM3dGCylFv",'name':"__dt__8cM3dGCylFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAFAA0,'size':72,'pad':0,'label':"__dt__8cM3dGAabFv",'name':"__dt__8cM3dGAabFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAFAE8,'size':92,'pad':0,'label':"__dt__10dCcD_GSttsFv",'name':"__dt__10dCcD_GSttsFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CAFB44,'size':196,'pad':0,'label':"checkAttacked__10daPillar_cFv",'name':"checkAttacked__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"ASMFunction"},
	{'addr':0x80CAFC08,'size':348,'pad':0,'label':"on_switch__10daPillar_cFv",'name':"on_switch__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CAFD64,'size':508,'pad':0,'label':"checkShake__10daPillar_cFv",'name':"checkShake__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CAFF60,'size':640,'pad':0,'label':"setShake_rcrash__10daPillar_cFv",'name':"setShake_rcrash__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CB01E0,'size':76,'pad':0,'label':"setShake_strong__10daPillar_cFv",'name':"setShake_strong__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CB022C,'size':76,'pad':0,'label':"setShake_weak__10daPillar_cFv",'name':"setShake_weak__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CB0278,'size':164,'pad':0,'label':"switch_proc_call__10daPillar_cFv",'name':"switch_proc_call__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CB031C,'size':92,'pad':0,'label':"actionSwOnWait__10daPillar_cFv",'name':"actionSwOnWait__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0378,'size':84,'pad':0,'label':"actionSwOn__10daPillar_cFv",'name':"actionSwOn__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80CB03CC,'size':4,'pad':0,'label':"actionEnd__10daPillar_cFv",'name':"actionEnd__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x80CB03D0,'size':648,'pad':0,'label':"Execute__10daPillar_cFPPA3_A4_f",'name':"Execute__10daPillar_cFPPA3_A4_f",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0658,'size':232,'pad':0,'label':"Draw__10daPillar_cFv",'name':"Draw__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0740,'size':64,'pad':0,'label':"Delete__10daPillar_cFv",'name':"Delete__10daPillar_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0780,'size':244,'pad':0,'label':"daPillar_create1st__FP10daPillar_c",'name':"daPillar_create1st__FP10daPillar_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0874,'size':32,'pad':0,'label':"daPillar_MoveBGDelete__FP10daPillar_c",'name':"daPillar_MoveBGDelete__FP10daPillar_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0894,'size':32,'pad':0,'label':"daPillar_MoveBGExecute__FP10daPillar_c",'name':"daPillar_MoveBGExecute__FP10daPillar_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB08B4,'size':44,'pad':0,'label':"daPillar_MoveBGDraw__FP10daPillar_c",'name':"daPillar_MoveBGDraw__FP10daPillar_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB08E0,'size':72,'pad':0,'label':"__dt__10cCcD_GSttsFv",'name':"__dt__10cCcD_GSttsFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0928,'size':92,'pad':0,'label':"__dt__14daPillar_HIO_cFv",'name':"__dt__14daPillar_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80CB0984,'size':60,'pad':0,'label':"__sinit_d_a_obj_pillar_cpp",'name':"__sinit_d_a_obj_pillar_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},

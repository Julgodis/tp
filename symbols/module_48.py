...
# Symbols
SYMBOLS = [
	{'addr':0x804A4220,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A424C,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A4278,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':29,'type':"ASMFunction"},
	{'addr':0x804A4298,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A42B4,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A430C,'size':44,'pad':0,'label':"reset__16daDemo00_resID_cFv",'name':"reset__16daDemo00_resID_cFv",'lib':-1,'tu':3,'section':0,'rc':3,'type':"ASMFunction"},
	{'addr':0x804A4338,'size':80,'pad':0,'label':"reset__16daDemo00_model_cFv",'name':"reset__16daDemo00_model_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A4388,'size':152,'pad':0,'label':"__dt__10daDemo00_cFv",'name':"__dt__10daDemo00_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A4420,'size':124,'pad':0,'label':"__dt__12demo_s1_ke_sFv",'name':"__dt__12demo_s1_ke_sFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A449C,'size':60,'pad':0,'label':"__dt__4cXyzFv",'name':"__dt__4cXyzFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A44D8,'size':72,'pad':0,'label':"__dt__8cM3dGPlaFv",'name':"__dt__8cM3dGPlaFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A4520,'size':128,'pad':0,'label':"get_foward_angle__FP4cXyzP4cXyzPsPs",'name':"get_foward_angle__FP4cXyzP4cXyzPsPs",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A45A0,'size':936,'pad':0,'label':"setBaseMtx__10daDemo00_cFv",'name':"setBaseMtx__10daDemo00_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"ASMFunction"},
	{'addr':0x804A4948,'size':1024,'pad':0,'label':"setShadowSize__10daDemo00_cFv",'name':"setShadowSize__10daDemo00_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A4D48,'size':524,'pad':0,'label':"awaCheck__FP8J3DModel",'name':"awaCheck__FP8J3DModel",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A4F54,'size':32,'pad':0,'label':"createHeapCallBack__FP10fopAc_ac_c",'name':"createHeapCallBack__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A4F74,'size':2012,'pad':0,'label':"createHeap__10daDemo00_cFv",'name':"createHeap__10daDemo00_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A5750,'size':72,'pad':0,'label':"__dt__12J3DFrameCtrlFv",'name':"__dt__12J3DFrameCtrlFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A5798,'size':436,'pad':0,'label':"actStandby__10daDemo00_cFP13dDemo_actor_c",'name':"actStandby__10daDemo00_cFP13dDemo_actor_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A594C,'size':1792,'pad':0,'label':"actPerformance__10daDemo00_cFP13dDemo_actor_c",'name':"actPerformance__10daDemo00_cFP13dDemo_actor_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A604C,'size':100,'pad':0,'label':"actLeaving__10daDemo00_cFP13dDemo_actor_c",'name':"actLeaving__10daDemo00_cFP13dDemo_actor_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A60B0,'size':320,'pad':0,'label':"mDad00_changeXluMaterial__FP11J3DMateriali",'name':"mDad00_changeXluMaterial__FP11J3DMateriali",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A61F0,'size':568,'pad':0,'label':"teduna_calc__FP4cXyzP4cXyzP4cXyzsi",'name':"teduna_calc__FP4cXyzP4cXyzP4cXyzsi",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A6428,'size':1088,'pad':0,'label':"teduna_draw__FP8J3DModelP19mDoExt_3DlineMat1_cP12dKy_tevstr_ciiii",'name':"teduna_draw__FP8J3DModelP19mDoExt_3DlineMat1_cP12dKy_tevstr_ciiii",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A6868,'size':196,'pad':0,'label':"teduna_ganon_hand_set__FP8J3DModelii",'name':"teduna_ganon_hand_set__FP8J3DModelii",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A692C,'size':796,'pad':0,'label':"ke_control__FP10daDemo00_cP12demo_s1_ke_sif",'name':"ke_control__FP10daDemo00_cP12demo_s1_ke_sif",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A6C48,'size':216,'pad':0,'label':"ke_move__FP10daDemo00_cP19mDoExt_3DlineMat0_cP12demo_s1_ke_sif",'name':"ke_move__FP10daDemo00_cP19mDoExt_3DlineMat0_cP12demo_s1_ke_sif",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A6D20,'size':596,'pad':0,'label':"ke_set__FP10daDemo00_c",'name':"ke_set__FP10daDemo00_c",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A6F74,'size':32,'pad':0,'label':"daDemo00_Draw__FP10daDemo00_c",'name':"daDemo00_Draw__FP10daDemo00_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A6F94,'size':3060,'pad':0,'label':"draw__10daDemo00_cFv",'name':"draw__10daDemo00_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A7B88,'size':32,'pad':0,'label':"daDemo00_Execute__FP10daDemo00_c",'name':"daDemo00_Execute__FP10daDemo00_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A7BA8,'size':2308,'pad':0,'label':"execute__10daDemo00_cFv",'name':"execute__10daDemo00_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x804A84AC,'size':8,'pad':0,'label':"daDemo00_IsDelete__FP10daDemo00_c",'name':"daDemo00_IsDelete__FP10daDemo00_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x804A84B4,'size':40,'pad':0,'label':"daDemo00_Delete__FP10daDemo00_c",'name':"daDemo00_Delete__FP10daDemo00_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A84DC,'size':472,'pad':0,'label':"daDemo00_Create__FP10fopAc_ac_c",'name':"daDemo00_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A86B4,'size':104,'pad':0,'label':"__ct__12demo_s1_ke_sFv",'name':"__ct__12demo_s1_ke_sFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A871C,'size':4,'pad':0,'label':"__ct__4cXyzFv",'name':"__ct__4cXyzFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x804A8720,'size':188,'pad':0,'label':"__sinit_d_a_demo00_cpp",'name':"__sinit_d_a_demo00_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A87DC,'size':56,'pad':0,'label':"func_804A87DC",'name':"__arraydtor$5213",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x804A8814,'size':56,'pad':0,'label':"func_804A8814",'name':"__arraydtor$5211",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},

...
# Symbols
SYMBOLS = [
	{'addr':0x80C5EA80,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5EAAC,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5EAD8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':15,'type':"Function"},
	{'addr':0x80C5EAF8,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C5EB14,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5EB6C,'size':48,'pad':0,'label':"__ct__15daLv4Gate_HIO_cFv",'name':"__ct__15daLv4Gate_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C5EB9C,'size':72,'pad':0,'label':"__dt__14mDoHIO_entry_cFv",'name':"__dt__14mDoHIO_entry_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5EBE4,'size':156,'pad':0,'label':"setBaseMtx__11daLv4Gate_cFv",'name':"setBaseMtx__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"Function"},
	{'addr':0x80C5EC80,'size':108,'pad':0,'label':"CreateHeap__11daLv4Gate_cFv",'name':"CreateHeap__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5ECEC,'size':360,'pad':0,'label':"create__11daLv4Gate_cFv",'name':"create__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C5EE54,'size':80,'pad':0,'label':"Execute__11daLv4Gate_cFPPA3_A4_f",'name':"Execute__11daLv4Gate_cFPPA3_A4_f",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5EEA4,'size':164,'pad':0,'label':"moveGate__11daLv4Gate_cFv",'name':"moveGate__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C5EF48,'size':12,'pad':0,'label':"init_modeWait__11daLv4Gate_cFv",'name':"init_modeWait__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C5EF54,'size':92,'pad':0,'label':"modeWait__11daLv4Gate_cFv",'name':"modeWait__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5EFB0,'size':12,'pad':0,'label':"init_modeMove__11daLv4Gate_cFv",'name':"init_modeMove__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C5EFBC,'size':264,'pad':0,'label':"modeMove__11daLv4Gate_cFv",'name':"modeMove__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F0C4,'size':288,'pad':0,'label':"init_modeMoveEnd__11daLv4Gate_cFv",'name':"init_modeMoveEnd__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"Function"},
	{'addr':0x80C5F1E4,'size':4,'pad':0,'label':"modeMoveEnd__11daLv4Gate_cFv",'name':"modeMoveEnd__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F1E8,'size':164,'pad':0,'label':"Draw__11daLv4Gate_cFv",'name':"Draw__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F28C,'size':48,'pad':0,'label':"Delete__11daLv4Gate_cFv",'name':"Delete__11daLv4Gate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F2BC,'size':44,'pad':0,'label':"daLv4Gate_Draw__FP11daLv4Gate_c",'name':"daLv4Gate_Draw__FP11daLv4Gate_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F2E8,'size':32,'pad':0,'label':"daLv4Gate_Execute__FP11daLv4Gate_c",'name':"daLv4Gate_Execute__FP11daLv4Gate_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F308,'size':32,'pad':0,'label':"daLv4Gate_Delete__FP11daLv4Gate_c",'name':"daLv4Gate_Delete__FP11daLv4Gate_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F328,'size':32,'pad':0,'label':"daLv4Gate_Create__FP10fopAc_ac_c",'name':"daLv4Gate_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F348,'size':92,'pad':0,'label':"__dt__15daLv4Gate_HIO_cFv",'name':"__dt__15daLv4Gate_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C5F3A4,'size':60,'pad':0,'label':"__sinit_d_a_obj_lv4Gate_cpp",'name':"__sinit_d_a_obj_lv4Gate_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},

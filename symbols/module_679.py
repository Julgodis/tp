...
# Symbols
SYMBOLS = [
	{'addr':0x80D2BAA0,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2BACC,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2BAF8,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':15,'type':"ASMFunction"},
	{'addr':0x80D2BB18,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2BB34,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2BB8C,'size':56,'pad':0,'label':"__ct__14daWtGate_HIO_cFv",'name':"__ct__14daWtGate_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2BBC4,'size':72,'pad':0,'label':"__dt__14mDoHIO_entry_cFv",'name':"__dt__14mDoHIO_entry_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2BC0C,'size':136,'pad':0,'label':"setBaseMtx__10daWtGate_cFv",'name':"setBaseMtx__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"ASMFunction"},
	{'addr':0x80D2BC94,'size':108,'pad':0,'label':"CreateHeap__10daWtGate_cFv",'name':"CreateHeap__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2BD00,'size':380,'pad':0,'label':"create__10daWtGate_cFv",'name':"create__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2BE7C,'size':80,'pad':0,'label':"Execute__10daWtGate_cFPPA3_A4_f",'name':"Execute__10daWtGate_cFPPA3_A4_f",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2BECC,'size':188,'pad':0,'label':"move__10daWtGate_cFv",'name':"move__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2BF88,'size':12,'pad':0,'label':"init_modeWait__10daWtGate_cFv",'name':"init_modeWait__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':3,'type':"ASMFunction"},
	{'addr':0x80D2BF94,'size':124,'pad':0,'label':"modeWait__10daWtGate_cFv",'name':"modeWait__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C010,'size':28,'pad':0,'label':"init_modeOpen__10daWtGate_cFv",'name':"init_modeOpen__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2C02C,'size':264,'pad':0,'label':"modeOpen__10daWtGate_cFv",'name':"modeOpen__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C134,'size':28,'pad':0,'label':"init_modeClose__10daWtGate_cFv",'name':"init_modeClose__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2C150,'size':256,'pad':0,'label':"modeClose__10daWtGate_cFv",'name':"modeClose__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C250,'size':12,'pad':0,'label':"init_modeEnd__10daWtGate_cFv",'name':"init_modeEnd__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"ASMFunction"},
	{'addr':0x80D2C25C,'size':4,'pad':0,'label':"modeEnd__10daWtGate_cFv",'name':"modeEnd__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ReturnFunction"},
	{'addr':0x80D2C260,'size':164,'pad':0,'label':"Draw__10daWtGate_cFv",'name':"Draw__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C304,'size':48,'pad':0,'label':"Delete__10daWtGate_cFv",'name':"Delete__10daWtGate_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C334,'size':44,'pad':0,'label':"daWtGate_Draw__FP10daWtGate_c",'name':"daWtGate_Draw__FP10daWtGate_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C360,'size':32,'pad':0,'label':"daWtGate_Execute__FP10daWtGate_c",'name':"daWtGate_Execute__FP10daWtGate_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C380,'size':32,'pad':0,'label':"daWtGate_Delete__FP10daWtGate_c",'name':"daWtGate_Delete__FP10daWtGate_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C3A0,'size':32,'pad':0,'label':"daWtGate_Create__FP10fopAc_ac_c",'name':"daWtGate_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C3C0,'size':92,'pad':0,'label':"__dt__14daWtGate_HIO_cFv",'name':"__dt__14daWtGate_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},
	{'addr':0x80D2C41C,'size':60,'pad':0,'label':"__sinit_d_a_obj_waterGate_cpp",'name':"__sinit_d_a_obj_waterGate_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"ASMFunction"},

...
# Symbols
SYMBOLS = [
	{'addr':0x80C3F320,'size':44,'pad':0,'label':"_prolog",'name':"_prolog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3F34C,'size':44,'pad':0,'label':"_epilog",'name':"_epilog",'lib':-1,'tu':1,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3F378,'size':32,'pad':0,'label':"_unresolved",'name':"_unresolved",'lib':-1,'tu':1,'section':0,'rc':20,'type':"Function"},
	{'addr':0x80C3F398,'size':28,'pad':0,'label':"__register_global_object",'name':"__register_global_object",'lib':1,'tu':4,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C3F3B4,'size':88,'pad':0,'label':"__destroy_global_chain",'name':"__destroy_global_chain",'lib':1,'tu':4,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3F40C,'size':48,'pad':0,'label':"__ct__15daObj_Key_HIO_cFv",'name':"__ct__15daObj_Key_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C3F43C,'size':152,'pad':0,'label':"daObj_Key_Draw__FP13obj_key_class",'name':"daObj_Key_Draw__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3F4D4,'size':108,'pad':0,'label':"s_count_sub__FPvPv",'name':"s_count_sub__FPvPv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3F540,'size':192,'pad':0,'label':"s_master_sub__FPvPv",'name':"s_master_sub__FPvPv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3F600,'size':180,'pad':0,'label':"masterkey_check__FP13obj_key_class",'name':"masterkey_check__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C3F6B4,'size':116,'pad':0,'label':"action_check__FP13obj_key_class",'name':"action_check__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C3F728,'size':1116,'pad':0,'label':"chain_control_00__FP13obj_key_class",'name':"chain_control_00__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C3FB84,'size':60,'pad':0,'label':"__dt__4cXyzFv",'name':"__dt__4cXyzFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C3FBC0,'size':2860,'pad':0,'label':"chain_control_01__FP13obj_key_class",'name':"chain_control_01__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C406EC,'size':456,'pad':0,'label':"action__FP13obj_key_class",'name':"action__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C408B4,'size':136,'pad':0,'label':"daObj_Key_Execute__FP13obj_key_class",'name':"daObj_Key_Execute__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},
	{'addr':0x80C4093C,'size':8,'pad':0,'label':"daObj_Key_IsDelete__FP13obj_key_class",'name':"daObj_Key_IsDelete__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40944,'size':104,'pad':0,'label':"daObj_Key_Delete__FP13obj_key_class",'name':"daObj_Key_Delete__FP13obj_key_class",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C409AC,'size':268,'pad':0,'label':"useHeapInit__FP10fopAc_ac_c",'name':"useHeapInit__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40AB8,'size':812,'pad':0,'label':"daObj_Key_Create__FP10fopAc_ac_c",'name':"daObj_Key_Create__FP10fopAc_ac_c",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40DE4,'size':72,'pad':0,'label':"__dt__8cM3dGSphFv",'name':"__dt__8cM3dGSphFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40E2C,'size':72,'pad':0,'label':"__dt__8cM3dGAabFv",'name':"__dt__8cM3dGAabFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40E74,'size':112,'pad':0,'label':"__dt__12dBgS_ObjAcchFv",'name':"__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':3,'section':0,'rc':2,'type':"Function"},
	{'addr':0x80C40EE4,'size':60,'pad':0,'label':"__dt__5csXyzFv",'name':"__dt__5csXyzFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40F20,'size':4,'pad':0,'label':"__ct__5csXyzFv",'name':"__ct__5csXyzFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40F24,'size':4,'pad':0,'label':"__ct__4cXyzFv",'name':"__ct__4cXyzFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40F28,'size':72,'pad':0,'label':"__dt__15daObj_Key_HIO_cFv",'name':"__dt__15daObj_Key_HIO_cFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40F70,'size':60,'pad':0,'label':"__sinit_d_a_obj_key_cpp",'name':"__sinit_d_a_obj_key_cpp",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40FAC,'size':8,'pad':0,'label':"func_80C40FAC",'name':"@36@__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40FB4,'size':8,'pad':0,'label':"func_80C40FB4",'name':"@20@__dt__12dBgS_ObjAcchFv",'lib':-1,'tu':3,'section':0,'rc':0,'type':"Function"},
	{'addr':0x80C40FBC,'size':28,'pad':0,'label':"setPos__7daKey_cF4cXyz",'name':"setPos__7daKey_cF4cXyz",'lib':-1,'tu':3,'section':0,'rc':1,'type':"Function"},

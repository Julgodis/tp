...
/* 802685B0-80268614 0064+00 s=2 e=1 z=0  None .text      cM3d_InDivPos2__FPC3VecPC3VecfP3Vec                          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 80451180-80451188 0004+04 s=29 e=44 z=0  None .sbss      G_CM3D_F_ABS_MIN                                             */
...
/* 8026862C-80268710 00E4+00 s=0 e=10 z=0  None .text      cM3d_Len2dSqPntAndSegLine__FffffffPfPfPf                     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Len2dSqPntAndSegLine(f32 param_0, f32 param_1, f32 param_2, f32 param_3, f32 param_4, f32 param_5, f32* param_6, f32* param_7, f32* param_8) {
	nofralloc
...
/* 80268710-80268814 0104+00 s=2 e=8 z=0  None .text      cM3d_Len3dSqPntAndSegLine__FPC8cM3dGLinPC3VecP3VecPf         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Len3dSqPntAndSegLine(cM3dGLin const* param_0, Vec const* param_1, Vec* param_2, f32* param_3) {
	nofralloc
...
/* 80268894-802688B4 0020+00 s=11 e=2 z=0  None .text      cM3d_VectorProduct2d__Fffffff                                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_VectorProduct2d(f32 param_0, f32 param_1, f32 param_2, f32 param_3, f32 param_4, f32 param_5) {
	nofralloc
...
/* 802688B4-8026891C 0068+00 s=0 e=0 z=0  None .text      cM3d_VectorProduct__FPC4cXyzPC4cXyzPC4cXyzP4cXyz             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_VectorProduct(cXyz const* param_0, cXyz const* param_1, cXyz const* param_2, cXyz* param_3) {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_CalcPla(Vec const* param_0, Vec const* param_1, Vec const* param_2, Vec* param_3, f32* param_4) {
	nofralloc
...
/* 80268C5C-80268ED4 0278+00 s=3 e=0 z=0  None .text      cM3d_Check_LinLin__FPC8cM3dGLinPC8cM3dGLinPfPf               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_Check_LinLin(cM3dGLin const* param_0, cM3dGLin const* param_1, f32* param_2, f32* param_3) {
	nofralloc
...
/* 80268ED4-80268F34 0060+00 s=2 e=0 z=0  None .text      cM3d_CrossInfLineVsInfPlane_proc__FffPC3VecPC3VecP3Vec       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_CrossInfLineVsInfPlane_proc(f32 param_0, f32 param_1, Vec const* param_2, Vec const* param_3, Vec* param_4) {
	nofralloc
...
/* 80268F34-80269050 011C+00 s=3 e=1 z=0  None .text      cM3d_Cross_LinPla__FPC8cM3dGLinPC8cM3dGPlaP3Vecbb            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Cross_LinPla(cM3dGLin const* param_0, cM3dGPla const* param_1, Vec* param_2, bool param_3, bool param_4) {
	nofralloc
...
/* 80269050-80269C2C 0BDC+00 s=0 e=2 z=0  None .text      cM3d_Cross_MinMaxBoxLine__FPC3VecPC3VecPC3VecPC3Vec          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Cross_MinMaxBoxLine(Vec const* param_0, Vec const* param_1, Vec const* param_2, Vec const* param_3) {
	nofralloc
...
/* 80269C2C-80269D64 0138+00 s=1 e=0 z=0  None .text      cM3d_InclusionCheckPosIn3PosBox3d__FPC3VecPC3VecPC3VecPC3Vecf */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_InclusionCheckPosIn3PosBox3d(Vec const* param_0, Vec const* param_1, Vec const* param_2, Vec const* param_3, f32 param_4) {
	nofralloc
...
/* 80269D64-80269E18 00B4+00 s=11 e=0 z=0  None .text      cM3d_InclusionCheckPosIn3PosBox2d__Ffffffffff                */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_InclusionCheckPosIn3PosBox2d(f32 param_0, f32 param_1, f32 param_2, f32 param_3, f32 param_4, f32 param_5, f32 param_6, f32 param_7, f32 param_8) {
	nofralloc
...
/* 8026A2E4-8026A488 01A4+00 s=2 e=0 z=0  None .text      cM3d_CrossY_Tri__FPC8cM3dGTriPC3Vec                          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026A60C-8026A7B8 01AC+00 s=0 e=2 z=0  None .text      cM3d_CrossY_Tri__FRC3VecRC3VecRC3VecRC8cM3dGPlaPC3Vec        */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_CrossY_Tri(Vec const& param_0, Vec const& param_1, Vec const& param_2, cM3dGPla const& param_3, Vec const* param_4) {
	nofralloc
...
/* 8026A7B8-8026A8C0 0108+00 s=0 e=1 z=0  None .text      cM3d_CrossY_Tri_Front__FRC3VecRC3VecRC3VecPC3Vec             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_CrossY_Tri_Front(Vec const& param_0, Vec const& param_1, Vec const& param_2, Vec const* param_3) {
	nofralloc
...
/* 8026AAE8-8026ABD8 00F0+00 s=1 e=0 z=0  None .text      cM3d_CrossY_Tri__FPC8cM3dGTriPC3VecPC10cM3d_RangePf          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_CrossY_Tri(cM3dGTri const* param_0, Vec const* param_1, cM3d_Range const* param_2, f32* param_3) {
	nofralloc
...
/* 8026B0A4-8026B17C 00D8+00 s=1 e=1 z=0  None .text      cM3d_Cross_LinTri__FPC8cM3dGLinPC8cM3dGTriP3Vecbb            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Cross_LinTri(cM3dGLin const* param_0, cM3dGTri const* param_1, Vec* param_2, bool param_3, bool param_4) {
	nofralloc
...
/* 8026B280-8026B4E8 0268+00 s=1 e=0 z=0  None .text      cM3d_Cross_LinSph__FPC8cM3dGLinPC8cM3dGSphP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Cross_LinSph_CrossPos(cM3dGSph const& param_0, cM3dGLin const& param_1, Vec* param_2, Vec* param_3) {
	nofralloc
...
/* 8026BA48-8026BC7C 0234+00 s=1 e=2 z=0  None .text      cM3d_Cross_CylSph__FPC8cM3dGCylPC8cM3dGSphP3VecPf            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Cross_CylSph(cM3dGCyl const* param_0, cM3dGSph const* param_1, Vec* param_2, f32* param_3) {
	nofralloc
...
/* 8026BCFC-8026BD88 008C+00 s=1 e=0 z=0  None .text      cM3d_Cross_SphSph__FPC8cM3dGSphPC8cM3dGSphPfPf               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_Cross_SphSph(cM3dGSph const* param_0, cM3dGSph const* param_1, f32* param_2, f32* param_3) {
	nofralloc
...
/* 8026BD88-8026BE5C 00D4+00 s=0 e=1 z=0  None .text      cM3d_Cross_SphSph__FPC8cM3dGSphPC8cM3dGSphP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_CalcSphVsTriCrossPoint(cM3dGSph const* param_0, cM3dGTri const* param_1, Vec* param_2) {
	nofralloc
...
/* 8026BF04-8026C22C 0328+00 s=1 e=4 z=0  None .text      cM3d_Cross_SphTri__FPC8cM3dGSphPC8cM3dGTriP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026C3B4-8026C5D0 021C+00 s=0 e=1 z=0  None .text      cM3d_Cross_CylCyl__FPC8cM3dGCylPC8cM3dGCylP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026C5D0-8026C944 0374+00 s=0 e=2 z=0  None .text      cM3d_Cross_CylTri__FPC8cM3dGCylPC8cM3dGTriP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026C944-8026D044 0700+00 s=1 e=2 z=0  None .text      cM3d_Cross_CylLin__FPC8cM3dGCylPC8cM3dGLinP3VecP3Vec         */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_Cross_CylLin(cM3dGCyl const* param_0, cM3dGLin const* param_1, Vec* param_2, Vec* param_3) {
	nofralloc
...
/* 8026D044-8026D0B0 006C+00 s=1 e=0 z=0  None .text      cM3d_Cross_CylPntPnt__FPC8cM3dGCylPC3VecPC3VecP3VecP3Vec     */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_Cross_CylPntPnt(cM3dGCyl const* param_0, Vec const* param_1, Vec const* param_2, Vec* param_3, Vec* param_4) {
	nofralloc
...
/* 8026D114-8026D3D4 02C0+00 s=0 e=2 z=0  None .text      cM3d_Cross_CpsCps__FRC8cM3dGCpsRC8cM3dGCpsP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026D3D4-8026DAE0 070C+00 s=0 e=4 z=0  None .text      cM3d_Cross_CpsCyl__FRC8cM3dGCpsRC8cM3dGCylP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026DAE0-8026DC3C 015C+00 s=1 e=0 z=0  None .text      cM3d_Cross_CpsSph_CrossPos__FRC8cM3dGCpsRC8cM3dGSphRC3VecP3Vec */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_Cross_CpsSph_CrossPos(cM3dGCps const& param_0, cM3dGSph const& param_1, Vec const& param_2, Vec* param_3) {
	nofralloc
...
/* 8026DC3C-8026DE2C 01F0+00 s=0 e=4 z=0  None .text      cM3d_Cross_CpsSph__FRC8cM3dGCpsRC8cM3dGSphP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026DE2C-8026E12C 0300+00 s=0 e=1 z=0  None .text      cM3d_Cross_TriTri__FRC8cM3dGTriRC8cM3dGTriP3Vec              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026E4FC-8026E570 0074+00 s=0 e=0 z=0  None .text      cM3d_CalcVecAngle__FRC3VecPsPs                               */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_PlaneCrossLineProcWork(f32 param_0, f32 param_1, f32 param_2, f32 param_3, f32 param_4, f32 param_5, f32 param_6, f32* param_7, f32* param_8) {
	nofralloc
...
/* 8026E6F0-8026E8A0 01B0+00 s=2 e=0 z=0  None .text      cM3d_2PlaneCrossLine__FRC8cM3dGPlaRC8cM3dGPlaP8cM3dGLin      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm static void cM3d_2PlaneCrossLine(cM3dGPla const& param_0, cM3dGPla const& param_1, cM3dGLin* param_2) {
	nofralloc
...
/* 8026E8A0-8026E980 00E0+00 s=0 e=1 z=0  None .text      cM3d_3PlaneCrossPos__FRC8cM3dGPlaRC8cM3dGPlaRC8cM3dGPlaP3Vec */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_3PlaneCrossPos(cM3dGPla const& param_0, cM3dGPla const& param_1, cM3dGPla const& param_2, Vec* param_3) {
	nofralloc
...
/* 8026E980-8026EA5C 00DC+00 s=1 e=1 z=0  None .text      cM3d_lineVsPosSuisenCross__FPC8cM3dGLinPC3VecP3Vec           */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8026EA5C-8026EB38 00DC+00 s=0 e=1 z=0  None .text      cM3d_lineVsPosSuisenCross__FRC3VecRC3VecRC3VecP3Vec          */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_lineVsPosSuisenCross(Vec const& param_0, Vec const& param_1, Vec const& param_2, Vec* param_3) {
	nofralloc
...
/* 8026EB38-8026EBBC 0084+00 s=0 e=1 z=0  None .text      cM3d_2PlaneLinePosNearPos__FRC8cM3dGPlaRC8cM3dGPlaPC3VecP3Vec */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
asm void cM3d_2PlaneLinePosNearPos(cM3dGPla const& param_0, cM3dGPla const& param_1, Vec const* param_2, Vec* param_3) {
	nofralloc

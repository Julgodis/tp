...
JKRHeap::JKRHeap(void* data, u32 size, JKRHeap* parent, bool errorFlag)
    ...
    if ((mErrorFlag == true) && (mErrorHandler == NULL)) {
        void JKRDefaultMemoryErrorRoutine(void* param_0, u32 param_1, int param_2);
        mErrorHandler = JKRDefaultMemoryErrorRoutine;
    }

    mDebugFill = data_804508B0;
    mCheckMemoryFilled = debugCheckMemoryFilled;
    mInitFlag = false;
}
...
u8 JKRHeap::changeGroupID(u8 id) {
    return do_changeGroupID(id);
}
...
static void JKRDefaultMemoryErrorRoutine(void* param_0, u32 param_1, int param_2) {
...
JKRErrorHandler JKRHeap::setErrorHandler(JKRErrorHandler errorHandler) {
    ...
    if (!errorHandler) {
        errorHandler = (JKRErrorHandler)JKRDefaultMemoryErrorRoutine;
    }

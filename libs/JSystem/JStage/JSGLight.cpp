...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGSetLightType(JStage::TELight param_0) {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGSetColor(_GXColor param_0) {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGGetDistanceAttenuation(f32* param_0, f32* param_1, _GXDistAttnFn* param_2) const {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGSetDistanceAttenuation(f32 param_0, f32 param_1, _GXDistAttnFn param_2) {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGGetAngleAttenuation(f32* param_0, _GXSpotFn* param_1) const {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGSetAngleAttenuation(f32 param_0, _GXSpotFn param_1) {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGGetPosition(Vec* param_0) const {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGSetPosition(Vec const& param_0) {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGGetDirection(Vec* param_0) const {
	nofralloc
...
#pragma optimization_level 0
#pragma optimizewithasm off
asm void JStage::TLight::JSGSetDirection(Vec const& param_0) {
	nofralloc

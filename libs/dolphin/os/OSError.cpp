...
extern "C" extern u8 OSError__lit_74[29 + 3 /* padding */];
extern "C" extern u8 lit_75[23 + 1 /* padding */];
extern "C" extern u8 OSError__lit_77[49 + 3 /* padding */];
extern "C" extern u8 lit_78[16];
extern "C" extern u8 lit_79[96];
extern "C" extern u8 OSError__lit_80[76];
extern "C" extern u8 OSError__lit_81[98 + 2 /* padding */];
extern "C" extern u8 OSError__lit_82[96];
extern "C" extern u8 OSError__lit_83[31 + 1 /* padding */];
...
/* ############################################################################################## */
/* 8044BAD0-8044BB20 0044+0C rc=4 efc=2 rfr=False None .bss       __OSErrorTable                                               */
u8 __OSErrorTable[68 + 12 /* padding */];

/* 804509A0-804509A4 0004+00 rc=3 efc=2 rfr=False None .sdata     __OSFpscrEnableBits                                          */
SECTION_SDATA u32 __OSFpscrEnableBits = 0x000000F8;

/* 8033C580-8033C798 0218+00 rc=4 efc=4 rfr=False None .text      OSSetErrorHandler                                            */
#pragma push
...
/* ############################################################################################## */
/* 803CF918-803CF930 0016+02 rc=1 efc=0 rfr=False None .data      @13                                                          */
...
/* 803CF930-803CF958 0026+02 rc=0 efc=0 rfr=False None .data      @14                                                          */
...
/* 803CF958-803CF974 001C+00 rc=0 efc=0 rfr=False None .data      @15                                                          */
...
/* 803CF974-803CF994 001D+03 rc=0 efc=0 rfr=False None .data      @74                                                          */
SECTION_DATA u8 OSError__lit_74[29 + 3 /* padding */] = {
...
/* 803CF994-803CF9AC 0017+01 rc=0 efc=0 rfr=False None .data      @75                                                          */
...
/* 803CF9AC-803CF9E0 0031+03 rc=0 efc=0 rfr=False None .data      @77                                                          */
SECTION_DATA u8 OSError__lit_77[49 + 3 /* padding */] = {
...
/* 803CF9E0-803CF9F0 0010+00 rc=0 efc=0 rfr=False None .data      @78                                                          */
SECTION_DATA u8 lit_78[16] = {
	0x54, 0x42, 0x20, 0x3D, 0x20, 0x30, 0x78, 0x25, 0x30, 0x31, 0x36, 0x6C, 0x6C, 0x78, 0x0A, 0x00,
};

/* 803CF9F0-803CFA50 0060+00 rc=0 efc=0 rfr=False None .data      @79                                                          */
...
/* 803CFA50-803CFA9C 004C+00 rc=0 efc=0 rfr=False None .data      @80                                                          */
...
/* 803CFA9C-803CFB00 0062+02 rc=0 efc=0 rfr=False None .data      @81                                                          */
SECTION_DATA u8 OSError__lit_81[98 + 2 /* padding */] = {
	0x0A, 0x49, 0x6E, 0x73, 0x74, 0x72, 0x75, 0x63, 0x74, 0x69, 0x6F, 0x6E, 0x20, 0x61, 0x74, 0x20,
	0x30, 0x78, 0x25, 0x78, 0x20, 0x28, 0x72, 0x65, 0x61, 0x64, 0x20, 0x66, 0x72, 0x6F, 0x6D, 0x20,
	0x53, 0x52, 0x52, 0x30, 0x29, 0x20, 0x61, 0x74, 0x74, 0x65, 0x6D, 0x70, 0x74, 0x65, 0x64, 0x20,
...
/* 803CFB00-803CFB60 0060+00 rc=0 efc=0 rfr=False None .data      @82                                                          */
...
/* 803CFB60-803CFB80 001F+01 rc=0 efc=0 rfr=False None .data      @83                                                          */
SECTION_DATA u8 OSError__lit_83[31 + 1 /* padding */] = {
...
/* 803CFB80-803CFBA0 001F+01 rc=0 efc=0 rfr=False None .data      @84                                                          */
...
/* 803CFBA0-803CFBBC 001B+01 rc=0 efc=0 rfr=False None .data      @85                                                          */
...
/* 803CFBBC-803CFBF4 0035+03 rc=0 efc=0 rfr=False None .data      @86                                                          */
...
/* 803CFBF4-803CFC38 0040+04 rc=1 efc=0 rfr=False None .data      @87                                                          */
SECTION_DATA static void* OSError__lit_87[16 + 1 /* padding */] = {
	/* 0    */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 1    */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 2    */ (void*)(((char*)__OSUnhandledException)+0x20C),
	/* 3    */ (void*)(((char*)__OSUnhandledException)+0x224),
	/* 4    */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 5    */ (void*)(((char*)__OSUnhandledException)+0x238),
	/* 6    */ (void*)(((char*)__OSUnhandledException)+0x250),
	/* 7    */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 8    */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 9    */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 10   */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 11   */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 12   */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 13   */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 14   */ (void*)(((char*)__OSUnhandledException)+0x2B4),
	/* 15   */ (void*)(((char*)__OSUnhandledException)+0x268),
	/* padding */
	NULL,
};

/* 804509A4-804509A8 0002+02 rc=1 efc=0 rfr=False None .sdata     @76                                                          */
SECTION_SDATA static u16 OSError__lit_76[1 + 1 /* padding */] = {
	0x0A00,
	/* padding */
	0x0000,
};

/* 8033C798-8033CA80 02E8+00 rc=3 efc=2 rfr=False None .text      __OSUnhandledException                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off

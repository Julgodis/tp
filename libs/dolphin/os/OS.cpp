...
extern "C" void InquiryCallback(); // 1
extern "C" void OSInit(); // 1
extern "C" void OSExceptionInit(); // 1
extern "C" void __OSDBIntegrator(); // 1
extern "C" void __OSDBJump(); // 1
extern "C" void __OSSetExceptionHandler(); // 1
extern "C" void __OSGetExceptionHandler(); // 1
extern "C" void OSExceptionVector(); // 1
extern "C" void __DBVECTOR(); // 1
extern "C" void __OSEVSetNumber(); // 1
extern "C" void __OSEVEnd(); // 1
extern "C" void OSDefaultExceptionHandler(); // 1
...
SECTION_DATA extern u8 OS__lit_105[13 + 3 /* padding */];
SECTION_DATA extern u8 OS__lit_106[22 + 2 /* padding */];
SECTION_DATA extern u8 OS__lit_107[12];
SECTION_DATA extern u8 OS__lit_108[9 + 3 /* padding */];
SECTION_DATA extern u8 OS__lit_109[16];
SECTION_DATA extern u8 OS__lit_110[11 + 1 /* padding */];
SECTION_DATA extern u8 lit_111[14 + 2 /* padding */];
SECTION_DATA extern u8 lit_112[13 + 3 /* padding */];
SECTION_DATA extern u8 OS__lit_113[13 + 3 /* padding */];
SECTION_DATA extern u8 lit_114[13 + 3 /* padding */];
SECTION_DATA extern u8 OS__lit_115[25 + 3 /* padding */];
SECTION_DATA extern u8 OS__lit_117[14 + 2 /* padding */];
SECTION_DATA extern u8 OS__lit_118[21 + 3 /* padding */];
SECTION_DATA extern u8 __OSExceptionLocations[60];
SECTION_DATA extern u8 OS__lit_152[27 + 1 /* padding */];
SECTION_DATA extern u8 OS__lit_153[46 + 2 /* padding */];
SECTION_DATA extern u8 OS__lit_154[47 + 1 /* padding */];
SECTION_DATA extern u8 OS__lit_155[27 + 1 /* padding */];
...
SECTION_SDATA extern u8 OS__lit_116[6 + 2 /* padding */];
...
/* ############################################################################################## */
/* 80451600-80451604 0004+00 rc=0 efc=0 .sbss      BootInfo                                                     */
u8 OS__BootInfo[4];

/* 80451604-80451608 0004+00 rc=0 efc=0 .sbss      BI2DebugFlag                                                 */
u8 BI2DebugFlag[4];

/* 80451608-8045160C 0004+00 rc=0 efc=0 .sbss      BI2DebugFlagHolder                                           */
u8 BI2DebugFlagHolder[4];

/* 8045160C-80451610 0004+00 rc=0 efc=0 .sbss      __OSIsGcam                                                   */
u8 __OSIsGcam[4];

/* 80451610-80451618 0008+00 rc=0 efc=0 .sbss      ZeroF                                                        */
f64 ZeroF;

/* 80451618-80451620 0008+00 rc=0 efc=0 .sbss      ZeroPS                                                       */
u8 ZeroPS[8];

/* 80339DD4-80339EFC 0128+00 rc=0 efc=0 .text      __OSFPRInit                                                  */
#pragma push
...
/* 80339EFC-80339F24 0028+00 rc=0 efc=0 .text      OSGetConsoleType                                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 8044BA60-8044BA80 0020+00 rc=0 efc=0 .bss       DriveInfo                                                    */
u8 DriveInfo[32];

/* 80339F24-80339F60 003C+00 rc=0 efc=0 .text      InquiryCallback                                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 803CF288-803CF2CC 0044+00 rc=0 efc=0 .data      @1                                                           */
u8 OS__lit_1[68] = {
...
/* 80450980-80450984 0004+00 rc=0 efc=0 .sdata     __OSVersion                                                  */
void* __OSVersion = (void*)&OS__lit_1;

/* 80450984-8045098C 0006+02 rc=0 efc=0 .sdata     @116                                                         */
u8 OS__lit_116[6 + 2 /* padding */] = {
	0x25, 0x30, 0x38, 0x78, 0x0A, 0x00,
	/* padding */
	0x00, 0x00,
};

/* 80451620-80451624 0004+00 rc=0 efc=0 .sbss      AreWeInitialized                                             */
u8 AreWeInitialized[4];

/* 80451624-80451628 0004+00 rc=0 efc=0 .sbss      OSExceptionTable                                             */
u8 OSExceptionTable[4];

/* 80451628-80451630 0004+04 rc=0 efc=0 .sbss      __OSInIPL                                                    */
u8 __OSInIPL[4 + 4 /* padding */];

/* 80451630-80451634 0004+00 rc=0 efc=0 .sbss      __OSStartTime                                                */
u8 __OSStartTime[4];

/* 80451634-80451638 0004+00 rc=0 efc=0 .sbss      None                                                         */
u8 data_80451634[4];

/* 80339F60-8033A440 04E0+00 rc=0 efc=0 .text      OSInit                                                       */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A440-8033A6C0 0280+00 rc=0 efc=0 .text      OSExceptionInit                                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A6C0-8033A6E4 0024+00 rc=0 efc=0 .text      __OSDBIntegrator                                             */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A6E4-8033A6E8 0004+00 rc=0 efc=0 .text      __OSDBJump                                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A6E8-8033A704 001C+00 rc=0 efc=0 .text      __OSSetExceptionHandler                                      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A704-8033A718 0014+00 rc=0 efc=0 .text      __OSGetExceptionHandler                                      */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A718-8033A770 0058+00 rc=0 efc=0 .text      OSExceptionVector                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A770-8033A780 0010+00 rc=0 efc=0 .text      __DBVECTOR                                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A780-8033A7B0 0030+00 rc=0 efc=0 .text      __OSEVSetNumber                                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A7B0-8033A7B4 0004+00 rc=0 efc=0 .text      __OSEVEnd                                                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A7B4-8033A80C 0058+00 rc=0 efc=0 .text      OSDefaultExceptionHandler                                    */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A80C-8033A860 0054+00 rc=0 efc=0 .text      __OSPSInit                                                   */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* 8033A860-8033A874 0014+00 rc=0 efc=0 .text      __OSGetDIConfig                                              */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 8045098C-80450990 0004+00 rc=0 efc=0 .sdata     @163                                                         */
u32 lit_163 = 0x25730A00;

/* 8033A874-8033A8A0 002C+00 rc=0 efc=0 .text      OSRegisterVersion                                            */
#pragma push
#pragma optimization_level 0
#pragma optimizewithasm off
...
/* ############################################################################################## */
/* 803CF2CC-803CF2DC 000D+03 rc=0 efc=0 .data      @105                                                         */
u8 OS__lit_105[13 + 3 /* padding */] = {
	0x0A, 0x44, 0x6F, 0x6C, 0x70, 0x68, 0x69, 0x6E, 0x20, 0x4F, 0x53, 0x0A, 0x00,
	/* padding */
	0x00, 0x00, 0x00,
};

/* 803CF2DC-803CF2F4 0016+02 rc=0 efc=0 .data      @106                                                         */
u8 OS__lit_106[22 + 2 /* padding */] = {
...
/* 803CF2F4-803CF300 000C+00 rc=0 efc=0 .data      @107                                                         */
u8 OS__lit_107[12] = {
	0x4E, 0x6F, 0x76, 0x20, 0x31, 0x30, 0x20, 0x32, 0x30, 0x30, 0x34, 0x00,
};

/* 803CF300-803CF30C 0009+03 rc=0 efc=0 .data      @108                                                         */
u8 OS__lit_108[9 + 3 /* padding */] = {
	0x30, 0x36, 0x3A, 0x32, 0x36, 0x3A, 0x34, 0x31, 0x00,
	/* padding */
	0x00, 0x00, 0x00,
};

/* 803CF30C-803CF31C 0010+00 rc=0 efc=0 .data      @109                                                         */
u8 OS__lit_109[16] = {
	0x43, 0x6F, 0x6E, 0x73, 0x6F, 0x6C, 0x65, 0x20, 0x54, 0x79, 0x70, 0x65, 0x20, 0x3A, 0x20, 0x00,
};

/* 803CF31C-803CF328 000B+01 rc=0 efc=0 .data      @110                                                         */
u8 OS__lit_110[11 + 1 /* padding */] = {
	0x52, 0x65, 0x74, 0x61, 0x69, 0x6C, 0x20, 0x25, 0x64, 0x0A, 0x00,
	/* padding */
	0x00,
};

/* 803CF328-803CF338 000E+02 rc=0 efc=0 .data      @111                                                         */
u8 lit_111[14 + 2 /* padding */] = {
	0x4D, 0x61, 0x63, 0x20, 0x45, 0x6D, 0x75, 0x6C, 0x61, 0x74, 0x6F, 0x72, 0x0A, 0x00,
	/* padding */
	0x00, 0x00,
};

/* 803CF338-803CF348 000D+03 rc=0 efc=0 .data      @112                                                         */
u8 lit_112[13 + 3 /* padding */] = {
	0x50, 0x43, 0x20, 0x45, 0x6D, 0x75, 0x6C, 0x61, 0x74, 0x6F, 0x72, 0x0A, 0x00,
	/* padding */
	0x00, 0x00, 0x00,
};

/* 803CF348-803CF358 000D+03 rc=0 efc=0 .data      @113                                                         */
u8 OS__lit_113[13 + 3 /* padding */] = {
	0x45, 0x50, 0x50, 0x43, 0x20, 0x41, 0x72, 0x74, 0x68, 0x75, 0x72, 0x0A, 0x00,
	/* padding */
	0x00, 0x00, 0x00,
};

/* 803CF358-803CF368 000D+03 rc=0 efc=0 .data      @114                                                         */
u8 lit_114[13 + 3 /* padding */] = {
	0x45, 0x50, 0x50, 0x43, 0x20, 0x4D, 0x69, 0x6E, 0x6E, 0x6F, 0x77, 0x0A, 0x00,
	/* padding */
	0x00, 0x00, 0x00,
};

/* 803CF368-803CF384 0019+03 rc=0 efc=0 .data      @115                                                         */
u8 OS__lit_115[25 + 3 /* padding */] = {
...
/* 803CF384-803CF394 000E+02 rc=0 efc=0 .data      @117                                                         */
u8 OS__lit_117[14 + 2 /* padding */] = {
	0x4D, 0x65, 0x6D, 0x6F, 0x72, 0x79, 0x20, 0x25, 0x64, 0x20, 0x4D, 0x42, 0x0A, 0x00,
	/* padding */
	0x00, 0x00,
};

/* 803CF394-803CF3AC 0015+03 rc=0 efc=0 .data      @118                                                         */
u8 OS__lit_118[21 + 3 /* padding */] = {
...
/* 803CF3AC-803CF3E8 003C+00 rc=0 efc=0 .data      __OSExceptionLocations                                       */
...
/* 803CF3E8-803CF404 001B+01 rc=0 efc=0 .data      @152                                                         */
u8 OS__lit_152[27 + 1 /* padding */] = {
...
/* 803CF404-803CF434 002E+02 rc=0 efc=0 .data      @153                                                         */
u8 OS__lit_153[46 + 2 /* padding */] = {
...
/* 803CF434-803CF464 002F+01 rc=0 efc=0 .data      @154                                                         */
u8 OS__lit_154[47 + 1 /* padding */] = {
	0x3E, 0x3E, 0x3E, 0x20, 0x4F, 0x53, 0x49, 0x4E, 0x49, 0x54, 0x3A, 0x20, 0x65, 0x78, 0x63, 0x65,
...
/* 803CF464-803CF480 001B+01 rc=0 efc=0 .data      @155                                                         */
u8 OS__lit_155[27 + 1 /* padding */] = {
...
/* 8044BA80-8044BAB0 0030+00 rc=0 efc=0 .bss       DriveBlock                                                   */
u8 DriveBlock[48];

/* 8044BAB0-8044BAD0 001C+04 rc=0 efc=0 .bss       __OSRebootParams                                             */
